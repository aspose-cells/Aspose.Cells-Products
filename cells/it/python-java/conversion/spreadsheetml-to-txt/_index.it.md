---
title: Converti SPREADSHEETML in TXT tramite Python
url: /it/python-java/conversion/spreadsheetml-to-txt/
description: Codice di esempio per la conversione da foglio di calcoloml a txt Python. Usa API codice di esempio per la conversione batch di file da fogli di lavoro ml in txt all'interno dell'applicazione Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti SPREADSHEETML in TXT tramite Python" h2="Esporta fogli di lavoro Excel® in formato TXT utilizzando Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire SPREADSHEETML in TXT usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire SPREADSHEETML in TXT tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python gli sviluppatori possono caricare e convertire facilmente file SPREADSHEETML in TXT in poche righe di codice.
