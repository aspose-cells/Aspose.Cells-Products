...
description: Aspose Excel. Konvertieren Sie XLSB schnell und einfach in OTS mit Aspose.Cells. PHP XLSB in OTS. PHP Speichern Sie XLSB in OTS. Speichern Sie XLSB als OTS mit PHP.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLSB über PHP in OTS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLSB-Dateien programmgesteuert in OTS konvertieren? PHP-Entwickler können XLSB in nur wenigen Codezeilen problemlos laden und in OTS konvertieren.
...
1.  Konvertieren Sie XLSB in OTS, indem Sie die Speichermethode von Workbook aufrufen.
