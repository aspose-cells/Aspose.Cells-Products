...
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 加密 XLSX 文件" h2="使用 .NET 庫對包括 XLSX 格式的 Excel 電子表格進行密碼保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. 使用 XLSX 文件的路徑實例化工作簿類1. 獲取默認或任何工作表以添加保護1. 使用 Worksheet.Protect 方法保護工作表1. 使用 Workbook.Protect 方法保護工作簿1. 以 XLSX 格式保存結果
