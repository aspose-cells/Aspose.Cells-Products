...
description: Aspose Excel. Python Aspose.Cells. Merge SXC to TSV saveformat. Python Combine SXC to TSV format. Merge SXC to TSV in Python. SXC Merge.
...
{{% blocks/products/pf/agp/content h2="Merge SXC to TSV in Python" %}}
...
{{% cells-merger title="Sample Code to Merge SXC to TSV in Python" InputFormat="sxc" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
