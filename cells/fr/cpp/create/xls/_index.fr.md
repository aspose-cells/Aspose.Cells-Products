---
title: Créer XLS - Créer un fichier XLS dans C++
description: Aspose Excel. C++ Créer un fichier XLS. Créer XLS C++. C++ XLS Créateur. Créez XLS dans C++. Générez le fichier XLS en utilisant C++.
keywords: [Aspose Excel., C++ Aspose.Cells., Create XLS C++., C++ XLS Creater., Create XLS file in C++., Generate XLS file in C++]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier XLS dans C++" h2="Création de fichiers natifs et hautes performances XLS par programmation sans Micorsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer XLS dans C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers XLS dans des applications de création de rapports en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
1.  Enregistrez le classeur en tant que fichier .xls à l'aide de la méthode Save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier XLS dans C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="bibliothèque C++ pour créer le fichier XLS" %}}
