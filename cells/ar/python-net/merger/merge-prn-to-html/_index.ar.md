---
title:  ادمج PRN في HTML عبر Python
...
يوضح المثال التالي كيفية دمج PRN مع HTML في Python.
...
{{% cells-merger title="تطبيق مجاني لدمج PRN في HTML عبر الإنترنت" InputFormat="prn" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
