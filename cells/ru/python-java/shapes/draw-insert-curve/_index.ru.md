---
title: Как нарисовать или вставить изогнутую форму в Excel, используя Python via Java
weight: 10
...
{{% blocks/products/pf/agp/content h2="Как вставить изогнутую форму в файл Excel, используя Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке изогнутой формы в файл Excel с использованием Python via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить изогнутую форму на выбранный лист.
