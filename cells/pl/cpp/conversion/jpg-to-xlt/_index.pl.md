...
Trzeba programowo przekonwertować pliki JPG do formatu XLT? Programiści C++ mogą łatwo przekonwertować pliki JPG do formatu XLT za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JPG do XLT wywołując metodę Save().
