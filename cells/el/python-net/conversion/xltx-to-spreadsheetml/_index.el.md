...
description: Aspose Excel. Μετατρέψτε το XLTX σε SPREADSHEETML γρήγορα και εύκολα με το Aspose.Cells. Python XLTX σε SPREADSHEETML. Python Αποθήκευση XLTX στο SPREADSHEETML. Αποθηκεύστε το XLTX ως SPREADSHEETML χρησιμοποιώντας το Python.
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση XLTX στο SPREADSHEETML στο Python" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή XLTX σε SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xml" IsLandingPage="true" language="pythonnet" %}}
