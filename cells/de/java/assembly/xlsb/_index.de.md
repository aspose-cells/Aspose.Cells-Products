...
{{% blocks/products/pf/agp/content h2="So erstellen Sie XLSB-Berichte mit Java" %}}

 Um XLSB-Dateiberichte zu erstellen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren von XLSB-Berichten über Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Instanziieren Sie die WorkbookDesigner-Klasse1. Fügen Sie Datasource-Objekte in einer ArrayList hinzu1. Legen Sie Datenquelle und Prozess für das WorkbookDesigner-Objekt fest1. Speichern Sie das Ergebnis im XLSB-Format über die Worbook.save-Methode
...
{{% blocks/products/pf/agp/code-block title="Excel-Berichte im XLSB-Format generieren – C#" offSpacer="" %}}
