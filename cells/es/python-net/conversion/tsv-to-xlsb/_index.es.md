...
description: Aspose Excel. Convierta TSV a XLSB rápida y fácilmente con Aspose.Cells. Python TSV a XLSB. Python Guarde TSV en XLSB. Guarde TSV como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar TSV al XLSB en Python" %}}

El siguiente ejemplo demuestra cómo convertir TSV a XLSB en Python via NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir TSV a XLSB. Cargue su archivo TSV y luego simplemente guárdelo como archivo XLSB. Tanto para lectura TSV como para escritura XLSB puede utilizar nombres de archivo completos. El contenido y el formato de salida XLSB serán idénticos al documento TSV original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir TSV a XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlsb" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir TSV en XLSB" %}}
