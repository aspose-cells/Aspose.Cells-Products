---
title:  Python Таблица Excel API - Aspose
weight: 2820
description: Python библиотека электронных таблиц для создания файлов Excel для чтения, записи и анализа.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python API-интерфейсы анализа таблиц Excel" h2="Создавайте, читайте, записывайте и управляйте электронными таблицами, а также экспортируйте файлы Excel в различные форматы в приложениях Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-python-java.svg" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="https://releases.aspose.com/cells/python-java/" >}}
...
<p>
Aspose.Cells for Python — это быстрый и надежный API для задач обработки электронных таблиц. Разработчики могут создавать простые или сложные электронные таблицы, манипулировать ими и извлекать информацию из файлов Excel. API читает несколько форматов Excel и может отображать листы в XPS, PDF, MHTML, HTML, обычный текст, изображения и многое другое. Это лучшее решение для автоматизации отчетов Excel с использованием Python.
</p>
...
<div class="diagram1 d1-python">
 ...
 Импортировать и усилить; Экспорт
   </header>
   <ul>
    <li>
 Массивы
...
{{< blocks/products/pf/carousel-item h3="Независимость платформы" description="Aspose.Cells for Python доступен для." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Расширенные возможности Python Excel API
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
 ...
 Чтение таблиц Excel
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Рендеринг электронных таблиц в PDF, EMF и изображений
    </p>
   </div>
   <div class="col-lg-4">
 ...
 Защитить/снять защиту листов
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Добавляйте изображения, а также создавайте диаграммы
    </p>
   </div>
   <div class="col-lg-4">
...
Добавить или удалить группировку в строках и столбцах
 ...
 Отрегулируйте ориентацию страницы, масштабирование, размер бумаги.
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Прочтите &amp; написать условное форматирование
    </p>
   </div>
   <!--
...
<p>Python sheets API provides a powerful Formula Calculation Engine that supports almost all of the standard and advanced Microsoft Excel formulas and functions. Formula calculation engine makes it easy to read, set and calculate the results of the built-in or add-in type, array and R1C1 reference style formulas.</p>
 ...
 Гибкие параметры отображения
    ...
    <p>
 Aspose.Cells for Python обеспечивает полный контроль над настройкой страницы, позволяя управлять несколькими параметрами отображения, такими как предварительный просмотр разрывов страниц, установка уровня масштабирования, установка ориентации страницы, управление видимостью данных с помощью стоп-панелей, размер бумаги, масштабирование, заголовки и т. д. нижние колонтитулы и область печати.
    </p>
   </div>
   <!--<div class="col-lg-12">
...
<p>Aspose.Cells for Android via Java API allows you to manipulate rows and columns in many different ways. You can easily adjust row height and column width, auto size the width & height of cells according to the contents, insert or delete, hide or show and group or ungroup rows & columns.</p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
 Управление данными в таблицах Excel
    </h2>
    <p>
 Aspose.Cells for Python API обеспечивает обширную поддержку для управления данными рабочих листов. Можно легко манипулировать любой ячейкой на листе во время выполнения или импортировать данные на листы из различных источников данных.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
Настройка графиков
    ...
    <p>
 Aspose.Cells for Python обеспечивает полную поддержку построения графиков. Можно легко добавлять стандартные и настраиваемые диаграммы или динамически устанавливать данные диаграммы, чтобы обновить диаграмму с помощью этой библиотеки Python.
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="Aspose.Cells API Рекомендации" href="https://reference.aspose.com/cells/python-java" >}}
