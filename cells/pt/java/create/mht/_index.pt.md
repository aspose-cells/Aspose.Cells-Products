...
description:  Aspose Excel. Java Crie arquivo MHT de forma rápida e fácil com Aspose.Cells. Gere arquivo MHT usando Java. Crie MHT em Java. Java MHT Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo MHT em Java" h2="Biblioteca Java de alta velocidade para criação de arquivo MHT. Esta é uma solução de software profissional para importar e exportar XLSX, PDF e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  Salve a pasta de trabalho no formato MHT usando o método save().

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo MHT em Java." offSpacer="" %}}
