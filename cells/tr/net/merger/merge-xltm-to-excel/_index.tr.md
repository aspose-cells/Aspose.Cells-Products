...
url: /tr/net/merger/merge-xltm-to-excel/ 
...
Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'de EXCEL ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLTM'i programlı olarak EXCEL ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i EXCEL ile birleştirmek için .NET kitaplığı" %}}
