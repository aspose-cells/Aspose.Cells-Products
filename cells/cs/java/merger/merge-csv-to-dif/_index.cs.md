---
title: Sloučit CSV až DIF - Sloučit CSV až DIF v Java
url: /cs/java/merger/merge-csv-to-dif/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma CSV do formátu uložení DIF. Java Kombinujte formát CSV až DIF. Sloučit CSV až DIF v Java. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV až DIF v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit CSV až DIF v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení CSV do DIF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru DIF. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí CSV do DIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení CSV až DIF v Java" InputFormat="csv" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV do DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit CSV až DIF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení CSV až DIF" %}}
