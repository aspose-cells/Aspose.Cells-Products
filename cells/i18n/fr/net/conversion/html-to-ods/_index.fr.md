---
title: Convertir HTML en ODS via C#
url: /fr/net/conversion/html-to-ods/
description: Exemple de code pour la conversion html en ods C#. Utilisez API exemple de code pour la conversion de fichiers html par lots en ods dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir HTML en ODS à l\'aide de C#" %}}

 Afin de convertir HTML en ODS, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir HTML en ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers HTML en ODS en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier HTML avec une instance de Workbook1. Appelez la méthode Workbook.Save1. Passer le chemin de sortie avec l'extension ODS comme paramètre1. Vérifier le chemin spécifié pour le fichier ODS résultant
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir HTML en ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="ods" IsLandingPage="true" %}}
