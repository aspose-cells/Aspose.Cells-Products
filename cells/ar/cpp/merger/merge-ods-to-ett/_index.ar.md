...
url: /ar/cpp/merger/merge-ods-to-ett/ 
...
يوضح المثال التالي كيفية دمج ODS مع ETT في Aspose.Cells for C++.
...
{{% cells-merger title="نموذج التعليمات البرمجية لدمج ODS إلى ETT في C++" InputFormat="ods" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج ODS إلى ETT عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج ODS في ETT برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لدمج ODS في ETT" %}}
