---
title: C++ XLS a WORD-hoz – Online XLS a WORD konverterhez
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Ingyenes online C++ A XLS konvertálása WORD mentési formátumba. C++ XLS WORD formátumba. Mentse el a XLS számot a C++ WORD-ba.
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLS-et a WORD-ba a C++-ben online ingyen" %}}

A következő példa bemutatja, hogyan lehet a XLS-et WORD-ra konvertálni a C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS WORD-ra konvertálásához. Töltse fel a XLS fájlt, majd egyszerűen mentse el WORD fájlként. Mind a XLS olvasáshoz, mind a WORD-íráshoz használhat teljesen minősített fájlneveket. A kimenet WORD tartalma és formázása megegyezik az eredeti XLS számú dokumentuméval.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ingyenes alkalmazás és mintakód a XLS WORD Online konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="docx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A XLS konvertálása WORD-ra a C++-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLS fájlt programozottan WORD-ba kell konvertálni? A C++ fejlesztők könnyedén konvertálhatják a XLS-et WORD-ra, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a XLS-et WORD-ra a Save() metódus meghívásával.
1.  Szerezze meg a XLS konvertálási eredményt WORD-ra.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ könyvtár a XLS konvertálásához WORD-ba" %}}
