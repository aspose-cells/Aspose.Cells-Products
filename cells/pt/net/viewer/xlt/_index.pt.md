---
title:  Ver formatos de arquivo XLT via .NET
weight: 3610
description: Código-fonte C# para carregar, renderizar e exibir documentos XLT em plataformas .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells torna mais fácil para os desenvolvedores visualizarem o arquivo XLT com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código de exemplo C# para visualizar o arquivo XLT" offSpacer="" %}}
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos Excel Microsoft em diferentes formatos. Além disso, pode ser usado para gráficos abrangentes, relatórios escalonáveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API independente e não requer nenhum software como Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para visualizar XLT" sectionDescription=" Confira nossas demonstrações ao vivo para[Ver XLT](https://products.aspose.app/cells/viewer/xlt) com os seguintes benefícios." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer upload do arquivo XLT e clicar no botão \"Visualizar\"" >}}
