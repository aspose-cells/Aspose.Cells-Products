---
title: C# JPG en XLSM - Convertisseur JPG en XLSM
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG au format XLSM, permettant un enregistrement transparent des données JPG au format XLSM à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG sous XLSM dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en XLSM en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir JPG en XLSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en XLSM par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en XLSM en quelques lignes de code.
...
1.  Convertissez le JPG au format XLSM en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en XLSM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en XLSM" %}}
