...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers XLSM dans C#" %}}
...
Chargez tous les fichiers XLSM avec le chemin complet.
+ Créer un document comme fichier de base
+ Appelez la méthode appropriée pour concaténer et fusionner les fichiers un par un.
+ Appelez la méthode Save() et passez le nom du fichier (chemin complet) et le format (XLSM) en paramètre.
+ Vous pouvez maintenant ouvrir et utiliser le fichier XLSM dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers XLSM - C#" offSpacer="" %}}
