---
title: Convierta XLTM a BMP a través de la aplicación C++ 
url: /es/cpp/conversion/xltm-to-bmp/ 
description: Ejemplo de código de conversión C++ para documento XLTM a formato BMP. Los programadores pueden usar este código fuente para la conversión por lotes de XLTM a BMP dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta XLTM a BMP a través de C++" h2="Conversión de XLTM a BMP de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo XLTM a BMP con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLTM usando Factory::CreateIWorkbook.1. Seleccione la primera hoja de trabajo.1. Establecer (BMP) opciones.1. Iterar a través de cada página de la hoja y renderizar.1. Abra el archivo BMP en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLTM a BMP C++" offSpacer="" %}}
