---
title: دمج TXT في SPREADSHEETML - اجمع TXT إلى SPREADSHEETML في Java
url: /ar/java/merger/merge-txt-to-spreadsheetml/ 
description: Aspose إكسل. Java Aspose.Cells. الدمج المجاني عبر الإنترنت TXT إلى تنسيق حفظ SPREADSHEETML. Java اجمع TXT إلى تنسيق SPREADSHEETML. دمج TXT إلى SPREADSHEETML في Java. دمج TXT.
...
{{% blocks/products/pf/agp/content h2="دمج TXT في SPREADSHEETML في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج TXT مع SPREADSHEETML في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج TXT في SPREADSHEETML. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف SPREADSHEETML. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج TXT إلى SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني عبر الإنترنت لدمج TXT في SPREADSHEETML في Java" InputFormat="txt" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج TXT في SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج TXT مع SPREADSHEETML برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Java مكتبة لدمج TXT إلى SPREADSHEETML" %}}
