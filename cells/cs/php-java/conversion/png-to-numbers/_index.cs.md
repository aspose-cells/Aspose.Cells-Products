---
title: PHP PNG na ČÍSLA - PNG na ČÍSLA Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům PHP plně integrovaný přístup k převodu dat PNG do formátu NUMBERS, což umožňuje bezproblémové ukládání dat PNG do formátu NUMBERS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na ČÍSLA pomocí PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory PNG na ČÍSLA? Vývojáři v PHP mohou snadno načíst a převést PNG na ČÍSLA pomocí několika řádků kódu.
...
1.  Převeďte číslo PNG na ČÍSLA voláním metody save v sešitu.
1.  Získejte výsledek převodu PNG na ČÍSLA.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP knihovna pro převod čísla PNG na čísla" %}}
