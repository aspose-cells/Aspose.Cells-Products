---
title:  ดู ODS รูปแบบไฟล์ via .NET
weight: 130
description: ซอร์สโค้ด C# สำหรับโหลด เรนเดอร์ และแสดงเอกสาร ODS บน .NET Framework, .NET Core, Mono หรือแพลตฟอร์ม Xamarin
...
{{< blocks/products/pf/i18n/upper-banner h1="ODS โปรแกรมดูไฟล์ for .NET" h2="ดูสเปรดชีต Excel และ OpenOffice เช่น ODS โดยไม่ต้องใช้ Microsoft Excel หรือ Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการดู ODS ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells ช่วยให้นักพัฒนาสามารถดูไฟล์ ODS ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1.  โหลดไฟล์ ODS ในอินสแตนซ์ของสมุดงาน
1.  สร้างอินสแตนซ์ของ HtmlSaveOptions และตั้งค่าคุณสมบัติ ExportHeadings เป็นจริง
1. บันทึกไฟล์ ODS ในรูปแบบ HTML โดยใช้วิธี Workbook.Save
...
{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่าง C# เพื่อดูไฟล์ ODS" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API สามารถใช้สร้าง แก้ไข แปลง และเรนเดอร์รูปแบบ Excel Microsoft เป็นรูปแบบต่างๆ นอกจากนี้ยังสามารถใช้สำหรับการสร้างแผนภูมิที่ครอบคลุม การรายงานที่ปรับขนาดได้ และการคำนวณที่เชื่อถือได้ภายในแอปพลิเคชันซอฟต์แวร์ Aspose.Cells เป็น API แบบสแตนด์อโลน และไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ OpenOffice
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="แอพดูฟรี ODS" sectionDescription=" ตรวจสอบการสาธิตสดของเราไปที่[โทร.ODS](https://products.aspose.app/cells/viewer/ods) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" ดาวน์โหลดไฟล์ ODS จากลิงก์ หากจำเป็น" >}}
