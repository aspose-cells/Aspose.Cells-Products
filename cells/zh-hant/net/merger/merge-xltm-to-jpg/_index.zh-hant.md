...
description: Aspose Excel。 C# Aspose.Cells。免費在線合併XLTM到JPG保存格式。 C# 將XLTM合併為JPG格式。將 XLTM 合併為 C# 中的 JPG。 XLTM 合併。
...
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 XLTM 合併為 JPG" h2="高速 C# 庫，用於將 XLTM 合併為 JPG。使用我們的Excel轉換API在C#中開發高級、平台無關的軟件。這是導入和導出Excel, CSV, OpenOffice, PDF, HTML, image以及許多其他Excel格式的專業軟件解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="XLTM" additionalConversionTag="JPG" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線將 XLTM 合併為 C# 中的 JPG" %}}

下面的例子演示瞭如何將XLTM合併為JPG Aspose.Cells for .NET。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLTM 合併到 JPG。上傳文件，調用Workbook.Combine方法合併文件，然後保存為JPG文件。如果您在 C# 中開發代碼，這會比聽起來更簡單。請參閱 C# 將 XLTM 合併到 JPG 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將 XLTM 合併為 C# 中的 JPG" InputFormat="xltm" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 XLTM 合併為 JPG" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 XLTM 合併到 JPG 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將XLTM合併到JPG" %}}
