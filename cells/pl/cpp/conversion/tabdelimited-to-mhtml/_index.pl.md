---
title: Konwertuj TABDELIMITED na MHTML za pomocą aplikacji C++ 
url: /pl/cpp/conversion/tabdelimited-to-mhtml/ 
description: Przykładowy kod konwersji C++ dla dokumentu TABDELIMITED na format MHTML. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TABDELIMITED do MHTML w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TABDELIMITED na MHTML przez C++" h2="Wysoka wydajność konwersji TABDELIMITED do MHTML przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TABDELIMITED na MHTML za pomocą C++" %}}

 Aby przekonwertować TABDELIMITED na MHTML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TABDELIMITED na MHTML przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik TABDELIMITED na MHTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TABDELIMITED przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (MHTML).1. Plik MHTML zostanie zapisany pod określoną ścieżką.1. Otwórz plik MHTML w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED do kodu źródłowego konwersji MHTML C++" offSpacer="" %}}
