---
title: تحويل SPREADSHEETML إلى XLTX عبر تطبيق C++ 
url: /ar/cpp/conversion/spreadsheetml-to-xltx/ 
description: نموذج رمز تحويل C++ لمستند SPREADSHEETML إلى تنسيق XLTX. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل SPREADSHEETML دفعة واحدة إلى XLTX داخل أي تطبيق C++.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل SPREADSHEETML إلى XLTX باستخدام C++" %}}
 ...
 من أجل تحويل SPREADSHEETML إلى XLTX ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف SPREADSHEETML إلى XLTX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف SPREADSHEETML باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLTX).1. سيتم حفظ ملف XLTX في المسار المحدد.1. افتح ملف XLTX في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML إلى شفرة مصدر تحويل XLTX C++" offSpacer="" %}}
