...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak Excel Dosyası Nasıl Birleştirilir" %}}

 Excel dosyasını birleştirmek için kullanacağız[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Zengin özelliklere sahip, güçlü ve kullanımı kolay bir belge işleme ve birleştirme platformu olan API API for C++.
 
 En son sürümünü doğrudan indirebilirsiniz, sadece açın[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/) paket yöneticisi, Aspose.Cells.Cpp'yi arayın ve yükleyin. Aşağıdaki komutu Paket Yönetici Konsolundan da kullanabilirsiniz.
...
{{% blocks/products/pf/agp/feature-section-col title="C++\'deki Excel Dosyasını Birleştirme Adımları" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-xlsx-to-xls/" name="XLS" description="Excel İkili Formatı" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-xlsx-to-xltm/" name="XLTM" description="Excel Makro Etkin Şablonu" >}}
