---
title: Comment dessiner ou insérer une forme de coude dans Excel à l'aide de Python via .Net
weight: 10
description: Python via Code source .Net pour insérer la forme du coude dans Excel.
...
{{% blocks/products/pf/agp/content h2="Comment insérer la forme du coude dans un fichier Excel à l\'aide de Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer la forme du coude dans un fichier Excel à l\'aide de Python via .Net" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) pour insérer une forme de coude dans la feuille de calcul sélectionnée.
