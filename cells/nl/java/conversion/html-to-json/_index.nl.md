...
{{% blocks/products/pf/agp/content h2="Sla HTML op in JSON in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar JSON in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar JSON of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar JSON? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar JSON met slechts een paar regels code.
