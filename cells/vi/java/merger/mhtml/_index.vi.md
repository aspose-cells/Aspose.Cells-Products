---
title:  Hợp nhất MHTML Tệp via Java
weight: 4420
description: Mã mẫu Java để kết hợp các tài liệu MHTML trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng MHTML trong Java" h2="Hợp nhất tài liệu gốc MHTML bằng cách sử dụng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước gộp file MHTML vào Java" %}}
...
+ Tải file MHTML đầu tiên với instance của lớp Workbook.
+ Tải tài liệu MHTML thứ hai với một thể hiện của lớp Workbook.
+ Gộp file bằng phương thức Combine().
+ lưu file MHTML đã merge vào đường dẫn xác định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tập tin MHTML - Java" offSpacer="" %}}
