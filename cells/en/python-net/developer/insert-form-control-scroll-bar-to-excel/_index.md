---
title: Insert ScrollBar(Form control) into Excel using Python via .Net 
weight: 90
...
{{% blocks/products/pf/agp/content h2="How to Insert ScrollBar(Form control) into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert ScrollBar(Form control) to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_scroll_bar/#int-int-int-int-int-int) to insert a ScrollBar(Form control) in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert ScrollBar(Form control) - Python via .Net" offSpacer="" %}}
