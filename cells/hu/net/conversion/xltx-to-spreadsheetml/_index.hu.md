---
title: C# XLTX SPREADSHEETML - XLTX SPREADSHEETML konverter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára a XLTX adatok SPREADSHEETML formátumba konvertálásához, lehetővé téve a XLTX adatok zökkenőmentes mentését SPREADSHEETML formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLTX-es számot a SPREADSHEETML-be a C#-es táblázatban." %}}

A következő példa bemutatja, hogyan lehet a XLTX számot SPREADSHEETML formátumba konvertálni a C#-ben.
...
A XLTX fájlokat programozottan SPREADSHEETML-be kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal SPREADSHEETML-re konvertálhatják a XLTX-et.
...
1.  Alakítsa át a XLTX-et SPREADSHEETML formátumra a Workbook.Save metódus meghívásával.
1.  Szerezze meg a XLTX konverziós eredményt SPREADSHEETML-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX SPREADSHEETML formátumra konvertálásához" %}}
