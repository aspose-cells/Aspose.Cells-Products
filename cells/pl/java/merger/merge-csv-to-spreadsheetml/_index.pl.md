---
title: Scal CSV do SPREADSHEETML - Połącz CSV do SPREADSHEETML w Java
url: /pl/java/merger/merge-csv-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online numeru CSV do formatu zapisu SPREADSHEETML. Java Połącz CSV do formatu SPREADSHEETML. Scal CSV do SPREADSHEETML w Java. CSV Scal.
...
{{% blocks/products/pf/agp/content h2="Scal CSV w SPREADSHEETML w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć CSV z SPREADSHEETML w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć CSV z SPREADSHEETML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SPREADSHEETML. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy CSV z SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z SPREADSHEETML w Java" InputFormat="csv" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić CSV z SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić numer CSV ze SPREADSHEETML? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do połączenia CSV z SPREADSHEETML" %}}
