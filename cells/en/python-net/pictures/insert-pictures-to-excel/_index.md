---
title: Insert picture into Excel using Python via .Net 
weight: 200

description: Python via .Net source code to insert picture into Excel.
...
{{% blocks/products/pf/agp/content h2="How to Insert picture into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert picture to Excel file using Python via .Net" %}}
...
+  Use the picturecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/) to insert a picture in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert picture - Python via .Net" offSpacer="" %}}
