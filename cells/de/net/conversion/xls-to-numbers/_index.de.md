---
title: C# XLS in ZAHLEN - Online-Konverter von XLS in ZAHLEN
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das NUMBERS-Speicherformat. C# XLS in das Zahlenformat. Speichern Sie XLS unter den Nummern C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS kostenlos in NUMBERS in C# online" %}}

Das folgende Beispiel zeigt, wie XLS in NUMBERS in C# konvertiert wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um XLS in ZAHLEN umzuwandeln. Laden Sie Ihre XLS-Datei hoch und speichern Sie sie dann einfach als NUMBERS-Datei. Sowohl zum Lesen von XLS als auch zum Schreiben von NUMBERS können Sie vollständig qualifizierte Dateinamen verwenden. Der Inhalt und die Formatierung der NUMBERS-Ausgabe sind identisch mit dem Originaldokument XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von XLS in NUMBERS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="numbers" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in ZAHLEN" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in NUMBERS konvertieren? .NET-Entwickler können XLS in nur wenigen Codezeilen problemlos laden und in NUMBERS konvertieren.
...
1.  Konvertieren Sie XLS in NUMBERS, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in ZAHLEN" %}}
