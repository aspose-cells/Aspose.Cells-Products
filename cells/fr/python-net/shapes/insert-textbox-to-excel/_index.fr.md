...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_text_box/#int-int-int-int-int-int) pour insérer une TextBox dans la feuille de calcul sélectionnée.
