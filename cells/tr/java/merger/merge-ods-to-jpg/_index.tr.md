---
title: ODS'i JPG ile birleştir - ODS'i Java'de JPG ile birleştir
url: /tr/java/merger/merge-ods-to-jpg/ 
description: Aspose Excel'de. Java Aspose.Cells. ODS'i JPG kaydetme biçimiyle birleştirin. Java ODS'i JPG formatında birleştirin. ODS'i Java'deki JPG ile birleştirin. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'deki JPG ile birleştir" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'deki JPG ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="ODS\'i Java\'de JPG ile Birleştirmek için Örnek Kod" InputFormat="ods" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i JPG via Java\'e Nasıl Birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

ODS'i JPG ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesi, ODS\'i JPG ile birleştirmek için" %}}
