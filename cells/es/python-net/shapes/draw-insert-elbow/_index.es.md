---
title: Cómo dibujar o insertar la forma de un codo en Excel usando Python via .Net
weight: 10
description: Python via Código fuente .Net para insertar forma de codo en Excel.
...
{{% blocks/products/pf/agp/content h2="Cómo insertar la forma de un codo en un archivo de Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar la forma del codo en un archivo Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el complemento de la colección de formas.[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) para insertar una forma de codo en la hoja de trabajo seleccionada.
...
-  Cualquier sistema operativo que pueda ejecutar scripts .Net Python via, como Windows y Linux
