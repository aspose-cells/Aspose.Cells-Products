---
title: OTS'yi ETT'ye Birleştir - Java'de OTS'yi ETT'ye birleştir
url: /tr/java/merger/merge-ots-to-ett/ 
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi OTS'yi ETT kaydetme biçimiyle birleştirme. Java OTS'yi ETT biçimiyle birleştirin. Java'de OTS'yi ETT ile birleştirin. OTS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="OTS ile ETT\'yi Java Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de OTS ile ETT'nin nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

OTS'yi ETT ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından ETT dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. OTS'yi ETT ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java\'de OTS\'yi ETT ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="ots" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi ETT via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

OTS'yi programlı olarak ETT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi ETT ile birleştirmek için Java kitaplığı" %}}
