---
title: Fusionner PRN à DIF - Combiner PRN à DIF dans Java
url: /fr/java/merger/merge-prn-to-dif/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite PRN au format de sauvegarde DIF. Java Combine PRN au format DIF. Fusionner PRN à DIF dans Java. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à DIF en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN avec DIF dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN en DIF. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier DIF. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne PRN en DIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner PRN à DIF en Java" InputFormat="prn" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner PRN avec DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner PRN avec DIF par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
