---
title: تحويل JSON إلى XLT عبر تطبيق C++ 
url: /ar/cpp/conversion/json-to-xlt/ 
description: نموذج رمز تحويل C++ لمستند JSON إلى تنسيق XLT. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل دفعة JSON إلى XLT داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل JSON إلى XLT عبر C++" h2="أداء عالي لتحويل JSON إلى XLT باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JSON إلى XLT باستخدام C++" %}}
 ...
 من أجل تحويل JSON إلى XLT ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف JSON إلى XLT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف JSON باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLT).1. سيتم حفظ ملف XLT في المسار المحدد.1. افتح ملف XLT في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="JSON إلى شفرة مصدر تحويل XLT C++" offSpacer="" %}}
