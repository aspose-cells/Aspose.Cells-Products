---
title: C# XLSB à ODS - Convertisseur en ligne XLSB à ODS
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir XLSB en format de sauvegarde ODS. Format C# XLSB à ODS. Enregistrez XLSB à ODS C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à ODS dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en ODS en C#.
...
Besoin de convertir les fichiers XLSB en ODS par programmation ? Les développeurs .NET peuvent facilement charger et convertir XLSB en ODS en quelques lignes de code.
