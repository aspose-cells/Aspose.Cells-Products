...
url: /tr/net/merger/merge-mht-to-xlam/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin XLAM ile nasıl birleştirileceğini gösterir.
...
MHT'yi programlı olarak XLAM ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi XLAM ile birleştirmek için .NET kitaplığı" %}}
