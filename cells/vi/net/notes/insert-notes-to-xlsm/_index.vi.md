---
title: Chèn ghi chú vào file XLSM via .NET
url: /vi/net/notes/insert-notes-to-xlsm/ 
description: Chèn ghi chú vào XLSM sử dụng C#. Sử dụng mã ví dụ API để chèn ghi chú trong ứng dụng .NET.
...
Trong Office 365, ghi chú là để chú thích, bạn có thể sử dụng mã C# sau để chèn và xóa ghi chú trong file XLSM.

{{% blocks/products/pf/agp/code-block title="Mã mẫu C# Chèn và xóa ghi chú trong file XLSM" offSpacer="" %}}
