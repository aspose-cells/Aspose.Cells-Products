...
description: Aspose エクセル。 C++ Aspose.Cells。XLS を SXC の保存形式にマージします。 C++ XLS と SXC の形式を結合します。 XLS から SXC を C++ に結合します。XLS を結合します。
