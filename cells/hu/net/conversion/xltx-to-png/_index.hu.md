...
description: Aspose Excel. A XLTX-es számot PNG-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# XLTX-PNG-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTX-PNG számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a XLTX-et PNG-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a XLTX PNG-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTX konvertálása PNG-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLTX fájlt programozottan PNG-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a XLTX-et PNG-re.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX konvertálásához PNG-re" %}}
