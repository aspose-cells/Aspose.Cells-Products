...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Python peuvent facilement charger et convertir XLS en PRN en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier XLS avec une instance de Workbook
1.  Convertir XLS en PRN en appelant la méthode Workbook.save
