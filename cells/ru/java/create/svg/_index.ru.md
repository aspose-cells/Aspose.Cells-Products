...
description: Aspose Excel. Java Создать файл SVG. Создать SVG Java. Java SVG Создатель. Создайте SVG в Java. Создайте файл SVG, используя Java.
...
1.  Сохраните книгу в формате SVG, используя метод save().
