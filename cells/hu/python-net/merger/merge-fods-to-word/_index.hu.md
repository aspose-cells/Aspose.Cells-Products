---
title: A FODS-WORD-es számok egyesítése – a FODS-es és a WORD-es számok egyesítése a Python-ben
url: /hu/python-net/merger/merge-fods-to-word/ 
description: Aspose Excel. Python Aspose.Cells. A FODS és a WORD mentési formátum egyesítése. Python A FODS és a WORD formátum kombinálása. Egyesítse a FODS-WORD-et a Python-ben. FODS Egyesítse.
...
{{< blocks/products/pf/i18n/upper-banner h1="A FODS-es szám egyesítése a WORD-es számmal a Python-es számon keresztül" h2="Nagysebességű Python könyvtár a FODS és WORD egyesítéséhez. Használja a API-es excel konverziónkat magas szintű, platformfüggetlen szoftver fejlesztésére a Python-ben. Ez egy professzionális szoftvermegoldás Excel, CSV, OpenOffice, PDF, HTML, image és sok más excel formátum importálásához és exportálásához." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="FODS" additionalConversionTag="WORD" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="A FODS és a WORD egyesítése a Python használatával" %}}

Hogyan egyesíthetem a FODS és a WORD számokat? A Aspose.Cells for Python via .NET könyvtárral könnyedén egyesítheti a FODS-et a WORD-es számokkal programozottan néhány sornyi kóddal.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez. Telepítheti a Aspose.Cells for Python via .NET számot innen<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , használja a parancsot a következőképpen:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="A FODS és a WORD egyesítése a Python-ben" %}}

A következő példa bemutatja a FODS és WORD egyesítését a Aspose.Cells for Python via .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a FODS-es és a WORD-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a WORD fájlba. Ha kódot fejleszt a Python-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Python-es példát, amely egyesíti a FODS és WORD számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a FODS és WORD közötti egyesítéshez a Python-ben" InputFormat="fods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A FODS és a WORD egyesítése a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a FODS-et a WORD-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Python könyvtár a FODS és WORD egyesítéséhez" %}}
