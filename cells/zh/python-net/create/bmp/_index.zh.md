...
{{% blocks/products/pf/agp/content h2="如何在Python中创建BMP" %}}
...
{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 Python 中创建 BMP 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python库创建BMP文件" %}}
