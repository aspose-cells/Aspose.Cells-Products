---
title: C++ MHT إلى DOCX - محول MHT عبر الإنترنت إلى DOCX
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل MHT إلى DOCX saveformat. C++ MHT إلى تنسيق DOCX. احفظ MHT في DOCX C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHT إلى DOCX في C++" h2="تحويل MHT عالي الأداء إلى DOCX باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT في DOCX في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى DOCX برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى DOCX في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى DOCX باستدعاء طريقة Save ().
