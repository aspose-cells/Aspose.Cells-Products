---
title: "NUMBERS konvertálása FODS-re a következőn keresztül: Java "
url: /hu/java/conversion/numbers-to-fods/ 
description: Minta Java konverziós kód NUMBERS formátumhoz FODS-fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására FODS-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="NUMBERS konvertálása FODS-re a következőn keresztül: Java" h2="NUMBERS FODS Java konverzió egyetlen vagy több oldal FODS formátumba konvertálásához a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="NUMBERS konvertálása FODS-re a következővel: Java" %}}

 A SZÁMOK FODS-ba való rendereléséhez ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a NUMBERS FODS-re konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A(z) Java fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatnak NUMBERS fájlt FODS-re.

{{% /blocks/products/pf/agp/text %}}

1. NUMBERS fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat FODS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott FODS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="NUMBERS to FODS Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a NUMBERS fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.numbers");
// SZÁMOK mentése FODS-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS FODS átalakítás élő bemutatók" sectionDescription="[NUMBERS konvertálása FODS-re](https://products.aspose.app/cells/conversion/numbers-to-fods) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel NUMBERS fájlját, és azonnal FODS-re konvertálódik." >}}
