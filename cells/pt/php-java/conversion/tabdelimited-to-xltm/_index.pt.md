...
description: Aspose Excel. Converta TABDELIMITED em XLTM de forma rápida e fácil com Aspose.Cells. PHP TABDELIMITED em XLTM. PHP Salve TABDELIMITED em XLTM. Salve TABDELIMITED como XLTM usando PHP.
...
Precisa converter arquivos TABDELIMITED para XLTM programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TABDELIMITED em XLTM em apenas algumas linhas de código.
...
1.  Converta TABDELIMITED em XLTM chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TABDELIMITED para XLTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED para XLTM" %}}
