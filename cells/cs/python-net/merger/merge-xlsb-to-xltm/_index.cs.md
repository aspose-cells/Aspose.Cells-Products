---
title:  Sloučit XLSB na XLTM přes Python
url: /cs/python-net/merger/merge-xlsb-to-xltm/ 
description: Sloučit XLSB až XLTM online zdarma. Online zdarma XLSB až XLTM Fúze. Sloučit XLSB do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSB až XLTM v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSB až XLTM online" InputFormat="xlsb" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
