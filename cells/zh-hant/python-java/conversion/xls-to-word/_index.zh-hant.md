...
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 XLS 轉換為 WORD 格式，從而能夠使用 Aspose.Cells 庫將 XLS 數據無縫保存為 0761533681533676136481 資料無縫代碼實現。
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將 XLS 轉換為 WORD" %}}
...
{{% blocks/products/pf/agp/content h2="將 XLS 儲存到 Python Excel 庫中 WORD" %}}

下面的範例示範如何在Python Excel庫中將XLS轉換為WORD。
...
{{% cells-convert title="透過 Python Excel 函式庫將 XLS 轉換為 WORD 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="docx" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 XLS 轉換為 WORD" %}}
