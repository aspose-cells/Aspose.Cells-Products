---
title: Microsoft Excel文件转换使用Python via NET
...
使用时可以加载任何电子表格并将其转换为 Word DOCX & PowerPoint PPTX 文件[DocxSave选项](https://reference.aspose.com/cells/python-net/aspose.cells/docxsaveoptions/) & [PptxSave选项](https://reference.aspose.com/cells/python-net/aspose.cells/pptxsaveoptions/)类如下所示。
