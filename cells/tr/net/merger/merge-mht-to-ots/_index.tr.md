---
title: MHT'yi OTS'ye Birleştir - C#'de MHT'yi OTS'ye birleştirin
url: /tr/net/merger/merge-mht-to-ots/ 
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi MHT'yi OTS kaydetme biçimine birleştirme. C# MHT'yi OTS biçimiyle birleştirin. C#'de MHT'yi OTS ile birleştirin. MHT Birleştirin.
...
{{% blocks/products/pf/agp/content h2="C# Online\'da MHT\'yi OTS\'ye Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin OTS ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

MHT'yi OTS'ye birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından OTS dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. MHT'yi OTS ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de MHT\'yi OTS ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="mht" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C# aracılığıyla MHT\'yi OTS\'ye Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

MHT'yi programlı olarak OTS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi OTS ile birleştirmek için .NET kitaplığı" %}}
