---
title:  Rechercher et remplacer le texte dans le document XLS via .NET
weight: 7280
description: Code source C# pour supprimer les informations sensibles dans le fichier XLS sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
