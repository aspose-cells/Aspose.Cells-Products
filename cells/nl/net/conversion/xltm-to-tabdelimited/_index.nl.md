...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLTM naar TABDELIMITED in C#" h2="Snelle C#-bibliotheek voor het converteren van XLTM naar TABDELIMITED. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLTM, TABDELIMITED en vele andere formaten op .NET Framework, .NET Core of Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in TABDELIMITED in C#" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar TABDELIMITED in C#.
...
1.  Converteer XLTM naar TABDELIMITED door de Workbook.Save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van XLTM naar TABDELLIMITED.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliotheek om XLTM naar TABDELIMITED te converteren" %}}
