---
title: C# MHT 到 WORD - 在線 MHT 到 WORD 轉換器
description: Aspose Excel。 C# Aspose.Cells. C# Aspose Cells. 免費在線 C# 將 MHT 轉換為 WORD 保存格式。 C# MHT 到 WORD 格式。將 MHT 保存到 WORD C#。
...
{{% blocks/products/pf/agp/content h2="免費在線將 C# 中的 MHT 保存為 WORD" %}}

下面的例子演示瞭如何將C#中的MHT轉換為WORD。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 轉換為 WORD。上傳您的 MHT 文件，然後將其保存為 WORD 文件。對於 MHT 讀取和 WORD 寫入，您可以使用完全限定的文件名。輸出的 WORD 內容和格式將與原始 MHT 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="在線將 MHT 轉換為 WORD 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 轉換為 WORD" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 WORD？ .NET 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 WORD。
...
1. 通過調用 Workbook.Save 方法將 MHT 轉換為 WORD。
1. 獲取MHT到WORD的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 將 MHT 轉換為 WORD 的庫" %}}
