---
title:  मर्ज XLSM फ़ाइलें via Java
weight: 1270
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरनमेंट पर XLSM दस्तावेज़ों को संयोजित करने के लिए Java नमूना कोड।
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM फ़ाइलों को Java में मर्ज करने के चरण" %}}
...
+ कार्यपुस्तिका वर्ग के उदाहरण के साथ पहली XLSM फ़ाइल लोड करें।
+ कार्यपुस्तिका वर्ग के उदाहरण के साथ दूसरा XLSM दस्तावेज़ लोड करें।
+ कंबाइन () विधि का उपयोग करके फ़ाइलों को मर्ज करें।
मर्ज किए गए XLSM फ़ाइल को निर्दिष्ट पथ पर सहेजें
...
{{% blocks/products/pf/agp/code-block title="मर्ज XLSM फ़ाइलें - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="ऑनलाइन XLSM मर्जर लाइव डेमो" sectionDescription=" हमारी वेबसाइट पर जाकर XLSM दस्तावेज़ अभी मर्ज करें[लाइव डेमो वेबसाइट](https://products.aspose.app/cells/merger). लाइव डेमो के निम्नलिखित लाभ हैं" >}}
