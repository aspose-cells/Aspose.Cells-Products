...
description: Aspose Excel. Converteer SPREADSHEETML snel en eenvoudig naar FODS met Aspose.Cells. Python SPREADSHEETML naar FODS. Python Sla SPREADSHEETML op naar FODS. Sla SPREADSHEETML op als FODS met Python.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML converteren naar FODS in Python" %}}
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML opslaan op FODS in Python" %}}

In het volgende voorbeeld ziet u hoe u SPREADSHEETML converteert naar FODS in Python via NET.
...
{{% cells-convert title="Voorbeeldcode om SPREADSHEETML naar FODS te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="fods" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om SPREADSHEETML te converteren naar FODS" %}}
