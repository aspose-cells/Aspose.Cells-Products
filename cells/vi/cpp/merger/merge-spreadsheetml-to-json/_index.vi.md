---
title: Hợp nhất SPREADSHEETML thành JSON - Hợp nhất SPREADSHEETML thành JSON trong C++
url: /vi/cpp/merger/merge-spreadsheetml-to-json/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất trực tuyến miễn phí SPREADSHEETML thành JSON saveformat. C++ Kết hợp định dạng SPREADSHEETML thành JSON. Hợp nhất SPREADSHEETML thành JSON trong C++. Hợp nhất SPREADSHEETML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất SPREADSHEETML với JSON trong C++ Trực tuyến miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất SPREADSHEETML thành JSON trong Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất SPREADSHEETML thành JSON. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp rồi lưu vào tệp JSON. Nếu bạn phát triển mã trong C++, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C++ hợp nhất SPREADSHEETML thành JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất SPREADSHEETML thành JSON trong C++" InputFormat="xml" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất SPREADSHEETML thành JSON qua C++" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất SPREADSHEETML với JSON theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ để hợp nhất SPREADSHEETML thành JSON" %}}
