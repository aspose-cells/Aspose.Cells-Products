...
{{% blocks/products/pf/agp/content h2="Преобразование HTML в XML с использованием кода Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохранение HTML в XML в Java" %}}

В следующем примере показано, как преобразовать HTML в XML в файле Java.
...
Нужно программно преобразовать HTML-файлы в XML? Разработчики, использующие код Java, могут легко преобразовать HTML в XML всего за несколько строк кода.
