...
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 创建 PDF 文档" h2="使用 Java 库以编程方式创建本机和高性能 PDF（便携式文档格式）。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 Java 创建 PDF" %}}
...
1. 创建一个实例 [工作簿类](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook).1. 使用 getWorksheets.get() 方法访问相关工作表。1. 选择相关单元格，使用单元格名称将值输入所需的单元格，如 A1、B3 等。1. 使用 save() 方法将工作簿保存为 PDF 格式。
...
{{% blocks/products/pf/agp/code-block title="以下源代码显示了如何使用 Java 创建 PDF 文件。" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 一个 Excel 电子表格编程库，能够构建跨平台应用程序，能够生成、修改、转换、呈现和打印 PDF 文件。 Java Excel API 不仅可以在电子表格格式之间进行转换，它还可以将 Excel 文件呈现为图像、PDF、HTML、ODS 等，从而使其成为以行业标准格式交换文档的完美选择。
