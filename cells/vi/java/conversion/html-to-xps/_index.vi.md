---
title: Chuyển đổi HTML sang XPS qua Java 
weight: 7630
url: /vi/java/conversion/html-to-xps/ 
description: Mã chuyển đổi Java mẫu cho định dạng HTML sang tệp XPS. Người lập trình có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang XPS trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi HTML sang XPS qua Java" h2="Chuyển đổi HTML sang XPS Java để chuyển đổi một hoặc nhiều trang sang XPS bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi HTML sang XPS bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi HTML sang XPS qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi HTML sang XPS Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi HTML sang XPS" sectionDescription="[Chuyển đổi HTML sang XPS](https://products.aspose.app/cells/conversion/html-to-xps) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp HTML của bạn, nó sẽ được chuyển đổi ngay lập tức sang XPS." >}}
