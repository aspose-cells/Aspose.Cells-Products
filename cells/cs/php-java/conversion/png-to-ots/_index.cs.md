---
title: Převodník PHP PNG na OTS – PNG na OTS
description: Aspose Excel. Převeďte PNG na OTS rychle a snadno pomocí Aspose.Cells. PHP PNG na OTS. PHP Uložit PNG do OTS. Uložte PNG jako OTS pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na OTS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést PNG soubory na OTS programově? Vývojáři PHP mohou snadno načíst a převést PNG na OTS v několika řádcích kódu.
...
1.  Převeďte PNG na OTS voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na OTS" %}}
