---
title: Inserte notas en Excel usando Python via .Net
weight: 360
description: Python via Código fuente .Net para insertar llamadas en Excel.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar llamadas en un archivo de Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el complemento de la colección de formas.[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) para insertar llamadas en la hoja de trabajo seleccionada.
...
<div class="container-fluid features-section bg-gray">
 ...
 Tipo de autoforma.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12" style="font-size:0.8rem !important;">
 Tipo de autoforma.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR3
    </p>
   </div>
  </div>
 </div>
