---
title: แปลง XLS เป็น TABDELIMITED ผ่าน Python
url: /th/python-java/conversion/xls-to-tabdelimited/
description: โค้ดตัวอย่างสำหรับการแปลง xls เป็น tabdelimited Python ใช้โค้ดตัวอย่าง API สำหรับไฟล์แบตช์ xls เป็นการแปลงแบบคั่นด้วยแท็บภายในแอปพลิเคชัน Python
---
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง XLS เป็น TABDELIMITED โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง XLS เป็น TABDELIMITED ผ่าน Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python นักพัฒนาสามารถโหลดและแปลงไฟล์ XLS เป็น TABDELIMITED ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
