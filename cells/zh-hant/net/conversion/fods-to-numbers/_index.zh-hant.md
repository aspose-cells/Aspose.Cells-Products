---
title: 將 C# 和 FODS 轉換為數字 - 將 FODS 轉換為數位轉換器
description: Aspose Excel。此綜合解決方案為 C# 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 NUMBERS 格式，從而能夠使用 Aspose.Cells 庫將 FODS 資料無縫保存為 NUMBERS 格式，所有這些程式庫將 FODS 資料無縫保存為 NUMBERS 格式，所有這些程式碼都透過高效且可客製化且可自訂153 15386153 1386153。
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 C# 的數字中" %}}

以下範例示範如何將 FODS 轉換為 C# 中的數字。
...
{{% cells-convert title="將 FODS 轉換為數字的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="numbers" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為數字（透過 C#）" %}}

{{% blocks/products/pf/agp/text %}}

需要透過程式將 FODS 檔案轉換為 NUMBERS 格式嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入 FODS 檔案並將其轉換為 NUMBERS 格式。
...
1. 使用工作簿實例載入 FODS 檔案。
1. 呼叫 Workbook.Save 方法將 FODS 轉換為 NUMBERS。
1. 將 FODS 轉換為數字的結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 庫用於將 FODS 轉換為數字" %}}
