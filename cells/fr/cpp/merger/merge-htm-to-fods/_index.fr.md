---
title: Fusionner HTM avec FODS - Combiner HTM avec FODS dans C++
url: /fr/cpp/merger/merge-htm-to-fods/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion en ligne gratuite HTM au format de sauvegarde FODS. C++ Combinez HTM au format FODS. Fusionner HTM avec FODS dans C++. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec FODS en C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner HTM avec FODS dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner HTM avec FODS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier FODS. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne HTM avec FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner HTM avec FODS en C++" InputFormat="htm" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec FODS via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner HTM avec FODS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour fusionner HTM avec FODS" %}}
