...
{{% blocks/products/pf/agp/content h2="How to Create ODS File Charts Using Java" %}}

 In order to create ODS file charts, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to CreateВ ODS Files Charts in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="CreateВ ODS Files Chart - Java" offSpacer="" %}}
