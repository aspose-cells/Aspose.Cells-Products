---
title:  Gabungkan XLTM File via Java
weight: 8210
description: Kode contoh Java untuk menggabungkan dokumen XLTM pada Runtime Environment Java untuk Aplikasi JSP/JSF dan Aplikasi Desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan Format XLTM di Java" h2="Penggabungan dokumen asli XLTM menggunakan API Java sisi server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Penggabungan File XLTM di Java" %}}
...
+ Muat file XLTM pertama dengan instance kelas Buku Kerja.
+ Muat dokumen XLTM kedua dengan instance kelas Buku Kerja.
+ Gabungkan file menggunakan metode gabungan().
+ simpan file gabungan XLTM di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Gabungkan XLTM File - Java" offSpacer="" %}}
