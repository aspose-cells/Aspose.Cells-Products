---
title: Převeďte SPREADSHEETML na CSV pomocí aplikace C++ 
url: /cs/cpp/conversion/spreadsheetml-to-csv/ 
description: Ukázka převodního kódu C++ pro dokument SPREADSHEETML do formátu CSV. Programátoři mohou tento zdrojový kód použít pro dávkový převod SPREADSHEETML do CSV v jakékoli aplikaci C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SPREADSHEETML na CSV prostřednictvím C++" h2="Vysoce výkonný převod SPREADSHEETML do CSV pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor SPREADSHEETML na CSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SPREADSHEETML pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou souboru (CSV).1. Soubor CSV bude uložen do zadané cesty.1. Otevřete soubor CSV v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SPREADSHEETML na CSV C++" offSpacer="" %}}
