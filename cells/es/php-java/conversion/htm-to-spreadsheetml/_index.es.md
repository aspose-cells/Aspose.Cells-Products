---
title: PHP HTM a SPREADSHEETML - Convertidor HTM a SPREADSHEETML
description: Aspose Excel. Convierta HTM a SPREADSHEETML rápida y fácilmente con Aspose.Cells. PHP HTM a SPREADSHEETML. PHP Guarde HTM en SPREADSHEETML. Guarde HTM como SPREADSHEETML usando PHP.
keywords: [Aspose Excel., PHP Aspose.Cells., Convert HTM to SPREADSHEETML in PHP., Save HTM to SPREADSHEETML using PHP., PHP HTM to SPREADSHEETML saveformat., HTM to SPREADSHEETML Converter., PHP Save HTM as SPREADSHEETML]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM a SPREADSHEETML en PHP" h2="Biblioteca PHP de alta velocidad para convertir HTM a SPREADSHEETML. Esta es una solución de software profesional para importar y exportar HTM, SPREADSHEETML y muchos otros formatos usando PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for PHP" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/php-java" installationsDocsLink="https://docs.aspose.com/cells/php-java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/php/" learnAsLink="https://docs.aspose.com/cells/php-java" apiReference="" mavenRepoLink="" >}}


{{% blocks/products/pf/agp/content h2="Convierta HTM a SPREADSHEETML usando PHP" %}}

 ¿Cómo convierto HTM a SPREADSHEETML? Con la biblioteca Aspose.Cells for PHP via Java, puede convertir fácilmente HTM a SPREADSHEETML mediante programación con unas pocas líneas de código.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. PHP Excel API no sólo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Guarde HTM en SPREADSHEETML en PHP" %}}

El siguiente ejemplo demuestra cómo convertir HTM a SPREADSHEETML en PHP.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir HTM a SPREADSHEETML. Cargue su archivo HTM y luego simplemente guárdelo como archivo SPREADSHEETML. Tanto para la lectura HTM como para la escritura SPREADSHEETML, puede utilizar nombres de archivos completos. El contenido y el formato de SPREADSHEETML de salida serán idénticos al documento HTM original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir HTM a SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xml" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a SPREADSHEETML mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a SPREADSHEETML mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a SPREADSHEETML en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a SPREADSHEETML llamando al método de guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de HTM a SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir HTM a SPREADSHEETML" %}}
