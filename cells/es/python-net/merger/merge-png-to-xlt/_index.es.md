...
url: /es/python-net/merger/merge-png-to-xlt/ 
...
El siguiente ejemplo demuestra cómo fusionar PNG con XLT en Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 ¿Necesita fusionar PNG con XLT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Las API se pueden crear con solo unas pocas líneas de código.
