---
title: C++ ODS เป็น EXCEL - ODS เป็น EXCEL แปลง
description: Aspose เอ็กเซล. แปลง ODS เป็น EXCEL อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ ODS เป็น EXCEL C++ บันทึก ODS ลง EXCEL. บันทึก ODS เป็น EXCEL โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก ODS ลงใน EXCEL ใน C++" %}}
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง ODS เป็น EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xlsx" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง ODS เป็น EXCEL โดยการเรียกเมธอด Save()
