---
title: Gộp XLSX thành ET - Gộp XLSX thành ET thành C#
url: /vi/net/merger/merge-xlsx-to-et/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí XLSX sang định dạng lưu ET. C# Kết hợp XLSX sang định dạng ET. Hợp nhất XLSX thành ET vào C#. Hợp nhất XLSX.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLSX với ET trong C# Trực tuyến miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất XLSX thành ET trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất XLSX với ET. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp ET. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất XLSX thành ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Hợp nhất trực tuyến miễn phí XLSX với ET vào C#" InputFormat="xlsx" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XLSX với ET qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất XLSX với ET theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="thư viện .NET để hợp nhất XLSX với ET" %}}
