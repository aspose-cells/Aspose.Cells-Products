...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLAM na XML za pomocą Aspose.Cells. C++ XLAM na XML. C++ Zapisz XLAM w formacie XML. Zapisz XLAM jako XML, używając C++.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLAM na XML za pomocą C++" %}}
...
Poniższy przykład ilustruje, jak przekonwertować XLAM na XML w C++.
...
{{% cells-convert title="Przykładowy kod do konwersji XLAM na XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLAM na XML za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLAM na XML? Programiści C++ mogą łatwo przekonwertować XLAM na XML w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLAM na XML, wywołując metodę Save().
1.  Uzyskaj wynik konwersji XLAM na XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C++ do konwersji XLAM na XML" %}}
