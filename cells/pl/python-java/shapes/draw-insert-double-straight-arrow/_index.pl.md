---
title:  Jak narysować lub wstawić podwójną prostą strzałkę do Excela przy użyciu Python via Java
weight: 10
description: Python via Kod źródłowy Java do rysowania lub wstawiania podwójnej prostej strzałki do programu Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw podwójną prostą strzałkę do Excela, używając Python via Java" h2="Wstaw podwójną prostą strzałkę za pomocą Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić podwójną prostą strzałkę do pliku Excel przy użyciu Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić podwójną prostą strzałkę do pliku Excel przy użyciu Python via Java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić podwójną prostą strzałkę w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw podwójną prostą strzałkę - Python via java" offSpacer="" %}}
