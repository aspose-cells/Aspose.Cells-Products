---
title: XLAM až EMF - Převést soubory XLAM na EMF Python via Python
...
{{% blocks/products/pf/agp/content h2="Převést XLAM na EMF na Python" %}}
...
Následující příklad ukazuje, jak převést XLAM na EMF v Python via NET.
