---
title: TXT'i EXCEL ile birleştir - TXT'i Java'de EXCEL ile birleştir
url: /tr/java/merger/merge-txt-to-excel/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i EXCEL kaydetme biçimiyle birleştirin. Java TXT'i EXCEL formatıyla birleştirin. TXT'i Java'de EXCEL ile birleştirin. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'deki EXCEL ile birleştir" %}}

Aşağıdaki örnek, TXT'in Aspose.Cells for Java'deki EXCEL ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT'i EXCEL ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından EXCEL dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT'i EXCEL ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT\'i Java\'de EXCEL ile Birleştirmek için Örnek Kod" InputFormat="txt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT\'i EXCEL via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TXT'i EXCEL ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesi TXT\'i EXCEL ile birleştirecek" %}}
