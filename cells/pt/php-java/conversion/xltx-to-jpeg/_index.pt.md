---
title: Conversor PHP XLTX para JPEG - XLTX para JPEG
description: Aspose Excel. Converta XLTX em JPEG de forma rápida e fácil com Aspose.Cells. PHP XLTX em JPEG. PHP Salve XLTX em JPEG. Salve XLTX como JPEG usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em JPEG via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em JPEG programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em JPEG em apenas algumas linhas de código.
...
1.  Converta XLTX em JPEG chamando o método save da pasta de trabalho.
