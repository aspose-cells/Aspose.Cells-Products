...
url: /cs/cpp/merger/merge-htm-to-htm/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit formát uložení HTM do HTM. C++ Zkombinujte formát HTM do formátu HTM. Sloučit HTM do HTM v C++. HTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM do HTM v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit HTM do HTM v Aspose.Cells for C++.
...
{{% cells-merger title="Online zdarma ke sloučení HTM do HTM na čísle C++" InputFormat="htm" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM do HTM přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit HTM do HTM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení HTM do HTM" %}}
