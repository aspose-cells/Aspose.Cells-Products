...
{{% blocks/products/pf/agp/content h2="How to Create GIF in Java" %}}
...
1.  Save the workbook as GIF format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create GIF file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create GIF file" %}}
{{% blocks/products/pf/agp/text %}}
