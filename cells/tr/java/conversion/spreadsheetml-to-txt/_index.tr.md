---
title: SPREADSHEETML'yi Java aracılığıyla TXT'ye dönüştürün 
url: /tr/java/conversion/spreadsheetml-to-txt/ 
description: SPREADSHEETML biçimi için TXT dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada TXT'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML\'yi Java aracılığıyla TXT\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı TXT\'ye dönüştürmek için SPREADSHEETML\'den TXT\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak SPREADSHEETML\'yi TXT\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="SPREADSHEETML\'yi Java aracılığıyla TXT\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla SPREADSHEETML dosyasını kolayca TXT'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. SPREADSHEETML dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. Çıktı yolunu TXT uzantısı ve SaveFormat ile parametre olarak iletin1. Ortaya çıkan TXT dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML\'den TXT\'ye Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// SPREADSHEETML dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.spreadsheetml");
// SPREADSHETML'yi TXT olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML\'den TXT\'ye Dönüşüm Canlı Demoları" sectionDescription="[SPREADSHETML\'yi TXT\'ye dönüştür](https://products.aspose.app/cells/conversion/spreadsheetml-to-txt) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece SPREADSHEETML dosyanızı yükleyin, anında TXT\'ye dönüştürülecektir." >}}
