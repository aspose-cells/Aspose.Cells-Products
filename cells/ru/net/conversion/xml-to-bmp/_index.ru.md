...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в BMP в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат BMP в формате C#.
...
Вам нужно программно преобразовать XML-файлы в BMP? Разработчики .NET могут легко загружать и конвертировать XML в BMP всего за несколько строк кода.
...
1.  Преобразовать XML в формат BMP, вызвав метод Workbook.Save.
