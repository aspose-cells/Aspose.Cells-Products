...
Hai bisogno di convertire i file MHT in PNG tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in PNG in poche righe di codice.
...
1.  Convertire MHT in PNG chiamando il metodo Save().
