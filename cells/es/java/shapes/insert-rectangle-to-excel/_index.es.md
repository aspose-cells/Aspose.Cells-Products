...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar Rectángulo al archivo de Excel via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addRectangle-int-int-int-int-int-int-) para insertar Rectángulo en la hoja de trabajo seleccionada
