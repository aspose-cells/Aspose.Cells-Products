---
title: Převést TSV na FODS prostřednictvím C#
url: /cs/net/conversion/tsv-to-fods/
description: Ukázkový kód pro konverzi tsv na fods C#. Použijte API ukázkový kód pro dávkový převod souborů tsv na fods v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na FODS pomocí C#" %}}

 Abychom převedli TSV na FODS, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TSV na FODS prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory TSV na FODS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí sešitu1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s příponou FODS jako parametr1. Zkontrolujte zadanou cestu pro výsledný soubor FODS
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod TSV na FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="fods" IsLandingPage="true" %}}
