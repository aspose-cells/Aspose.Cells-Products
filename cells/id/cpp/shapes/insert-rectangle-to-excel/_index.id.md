...
weight: 50
description: Contoh kode C++ untuk menyisipkan Rectangle pada file Excel pada C++ Runtime Environment untuk Windows 32 bit, Windows 64 bit dan Linux 64 bit.
keywords: [C++ Aspose.Cells., C++ add Rectangle., C++ insert Rectangle., C++ create Rectangle]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan Rectangle ke Excel melalui C++" h2="Masukkan objek menggunakan sisi server asli dan berkinerja tinggi Aspose.Cells for C++ API tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan Persegi Panjang ke File Excel Menggunakan C++" %}}
 ...
 Untuk memasukkan Rectangle ke dalam file excel, kami akan menggunakan
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[tambahkan metode](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addrectangle/) untuk menyisipkan Bentuk Persamaan di lembar kerja yang dipilih
