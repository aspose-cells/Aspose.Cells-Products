...
weight: 4860
description: C++ exempelkod för att låsa XLSB fil med lösenord på C++ Runtime Environment för Windows 32 bitar, Windows 64 bitar och Linux 64 bitar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Kryptera XLSB filer via C++" h2="Lösenordsskydda Excel-kalkylblad inklusive XLSB-format med .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man säkrar XLSB-filen med C++" %}}
...
1.  Ladda XLSB-filen med IWorkbook-klassen
1.  Använd Protect(..)-metoden med ProtectionType och Password
1.  Spara den skyddade XLSB-filen med metoden Save().
