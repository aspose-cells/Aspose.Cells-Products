---
title: MHT を XLSX に結合 - MHT を Python に XLSX に結合
url: /ja/python-net/merger/merge-mht-to-xlsx/ 
description: Aspose エクセル。 Python Aspose.Cells。無料オンライン MHT を XLSX 保存形式にマージします。 Python MHT を XLSX 形式に結合します。 Python で MHT を XLSX にマージします。MHT をマージします。
...
次の例は、MHT を Aspose.Cells for Python via .NET の XLSX にマージする方法を示しています。
...
{{% cells-merger title="オンラインで MHT を Python の XLSX にマージする無料" InputFormat="mht" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Python 経由で MHT を XLSX にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで MHT を XLSX にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
