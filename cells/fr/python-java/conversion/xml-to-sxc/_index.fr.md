...
description: Aspose Exceller. Convertissez XML en SXC rapidement et facilement avec Aspose.Cells. Python XML en SXC. Python Enregistrez XML en SXC. Enregistrez XML sous SXC en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en SXC à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au SXC dans Python" %}}

L'exemple suivant montre comment convertir XML en SXC en Python.
