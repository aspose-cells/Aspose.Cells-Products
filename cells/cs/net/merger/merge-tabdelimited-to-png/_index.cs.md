...
url: /cs/net/merger/merge-tabdelimited-to-png/ 
...
Následující příklad ukazuje, jak sloučit TABDELIMITED do PNG v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TABDELIMITED do PNG. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PNG. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí TABDELIMITED do PNG.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit TABDELIMITED na PNG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení TABDELIMITED do PNG" %}}
