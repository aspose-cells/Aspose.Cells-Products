---
title: Konversikan XLT ke MARKDOWN melalui Java 
url: /id/java/conversion/xlt-to-markdown/ 
description: Contoh Java kode konversi untuk format XLT ke file MARKDOWN. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke MARKDOWN dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLT ke MARKDOWN melalui Java" h2="XLT ke MARKDOWN Java konversi untuk mengonversi satu atau beberapa halaman menjadi MARKDOWN menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLT ke MARKDOWN Menggunakan Java" %}}

 Untuk merender XLT ke MARKDOWN, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi XLT ke MARKDOWN melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file XLT ke MARKDOWN hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLT dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi MARKDOWN & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file MARKDOWN yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="XLT ke MARKDOWN Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file XLT dalam contoh Workbook
Workbook book = new Workbook("template.xlt");
// simpan XLT sebagai MARKDOWN
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi XLT ke MARKDOWN" sectionDescription="[Konversikan XLT ke MARKDOWN](https://products.aspose.app/cells/conversion/xlt-to-markdown) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file XLT Anda, itu akan langsung dikonversi ke MARKDOWN." >}}
