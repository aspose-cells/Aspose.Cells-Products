...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in FODS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar FODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar FODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar FODS? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar FODS met slechts een paar regels code.
