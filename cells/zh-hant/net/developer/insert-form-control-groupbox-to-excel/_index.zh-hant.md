---
title: 將 GroupBox 插入 Excel via .NET
weight: 40
description: C# 將 GroupBox 插入 .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 Excel 的原始碼。
keywords: [C# Aspose.Cells., c# add GroupBox into Excel., c# insert GroupBox into Excel., c# create GroupBox in Excel]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="將 GroupBox 插入 Excel via .NET" h2="使用 Aspose.Cells\' API 插入 GroupBox，無需任何軟體，如 Microsoft 或 Open Office、Adobe PDF 等。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="如何使用 C# 將 GroupBox 插入 Excel 文件" %}}

為了將 GroupBox 插入到 Excel 檔案中，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="透過C#將GroupBox插入Excel檔案的步驟" %}}
...
+ 透過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addgroupbox)在選定的工作表中插入 GroupBox
以 XLSX 格式儲存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入分組框 - C#" offSpacer="" %}}
