---
title: Python OTSからMHTへ - OTSからMHTへのコンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、OTS を MHT にすばやく簡単に変換します。 Python OTS から MHT。 Python OTS を MHT に保存します。 Python を使用して OTS を MHT として保存します。
...
{{< blocks/products/pf/i18n/upper-banner h1="PythonでOTSをMHTに変換します" h2="OTS を MHT に変換するための高速 Python ライブラリ。これは、Python を使用して OTS、MHT、およびその他の多くの形式をインポートおよびエクスポートするためのプロフェッショナル ソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Pythonを使用してOTSをMHTに変換します" %}}
...
{{% blocks/products/pf/agp/content h2="OTS を Python の MHT に保存" %}}

次の例は、Python で OTS を MHT に変換する方法を示しています。
...
{{% cells-convert title="OTS を MHT に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でOTSをMHTに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

OTS ファイルをプログラムで MHT に変換する必要がありますか? Python 開発者は、わずか数行のコードで OTS を簡単にロードして MHT に変換できます。
...
{{% blocks/products/pf/agp/content h2="Python OTS を MHT に変換するライブラリ" %}}
