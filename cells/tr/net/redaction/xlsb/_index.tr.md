---
title:  XLSB belgesindeki metni arayın ve değiştirin via .NET
weight: 3890
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarındaki XLSB dosyasındaki hassas bilgileri düzenlemek için C# kaynak kodu.
