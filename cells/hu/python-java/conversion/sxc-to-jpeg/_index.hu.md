---
title: "SXC konvertálása JPEG formátumba a következőn keresztül: Python"
url: /hu/python-java/conversion/sxc-to-jpeg/
description: Mintakód az sxc-ből jpeg-be Python konvertáláshoz. Használjon API példakódot a kötegelt sxc fájlok jpeg konvertálásához a Python alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása JPEG formátumba a következőn keresztül: Python" h2="Exportálja az Excel® táblázatokat JPEG formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása JPEG formátumba a következővel: Python" %}}

 Az SXC JPEG formátumba konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása JPEG formátumba a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői könnyedén betölthetnek és konvertálhatnak SXC fájlokat JPEG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal megadása JPG kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott JPEG fájl megadott elérési útját
