...
{{% blocks/products/pf/agp/content h2="Преобразование XML в ETT с использованием C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохранение XML в ETT в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в ETT в коде C#.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XML в ETT" %}}
