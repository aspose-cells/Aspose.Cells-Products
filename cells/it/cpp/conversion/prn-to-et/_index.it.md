...
Hai bisogno di convertire i file PRN in ET tramite codice? Gli sviluppatori di C++ possono facilmente convertire i file PRN in ET in poche righe di codice.
...
1.  Convertire PRN in ET chiamando il metodo Save().
