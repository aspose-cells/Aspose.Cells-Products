---
title: TXT'i IMAGE ile birleştir - TXT'i Java'deki IMAGE ile birleştir
url: /tr/java/merger/merge-txt-to-image/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i IMAGE kaydetme biçimiyle birleştirin. Java TXT'i GÖRÜNTÜ formatıyla birleştirin. TXT'i Java'deki IMAGE ile birleştir. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'deki IMAGE ile birleştir" %}}

Aşağıdaki örnek, TXT'in Aspose.Cells for Java'deki IMAGE ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT'i IMAGE ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından IMAGE dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT'i IMAGE ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT\'i Java\'deki IMAGE ile Birleştirmek için Örnek Kod" InputFormat="txt" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT\'i GÖRÜNTÜ via Java\'e Nasıl Birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

 TXT'i IMAGE ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, TXT\'i IMAGE ile birleştirecek" %}}
