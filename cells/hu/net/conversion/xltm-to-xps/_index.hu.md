...
description: Aspose Excel. A XLTM-es számot XPS-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# XLTM-XPS-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTM-XPS számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a XLTM-et XPS-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a XLTM XPS-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="xps" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTM konvertálása XPS-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLTM fájlt programozottan XPS-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a XLTM-et XPS-re.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTM konvertálásához XPS-re" %}}
