---
title: PHP XLSM ～ DOCX - XLSM ～ DOCX コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XLSM を DOCX にすばやく簡単に変換します。PHP XLSM から DOCX。PHP XLSM から DOCX に保存します。PHP を使用して、XLSM を DOCX として保存します。
...
{{% blocks/products/pf/agp/content h2="PHP 経由で XLSM を DOCX に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSM ファイルをプログラムで DOCX に変換する必要がありますか? PHP 開発者は、わずか数行のコードで XLSM を簡単にロードして DOCX に変換できます。
