---
title:  .NET Java Python C++ PHP a Android Excel Spreadsheet Parsing API
weight: 10
description: Knihovny pro čtení, zápis a manipulaci se Microsoft soubory Excel v .NET Java C++ aplikacích pro Android a SharePoint. Exportujte pracovní listy do SSRS a JasperReports
---
...
Cíl .NET Framework, .NET platforma Core & Xamarin pro vývoj aplikací pro Windows, iOS, macOS a Android.
...
Vytvářejte, čtěte, upravujte, převádějte nebo vykreslujte formáty tabulek Excelu z C++ aplikací.
{{< /blocks/products/pf/product >}}
...
Export sestav do formátů souborů aplikace Excel a PDF z JasperReports nebo JasperServer.
{{< /blocks/products/pf/product >}}
...
Vytvářejte, upravujte, převádějte a vykreslujte tabulky Excel v aplikacích PHP prostřednictvím JavaBridge.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.Cells Produktová řada?" tabId="success-stories" >}}
