...
{{% blocks/products/pf/agp/content h2="Sla TSV op in HTML in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar HTML in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar HTML of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TSV programmatisch converteren naar HTML? Ontwikkelaars van Java kunnen bestanden met de extensie TSV eenvoudig converteren naar HTML met slechts een paar regels code.
