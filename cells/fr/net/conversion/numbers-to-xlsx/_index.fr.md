---
title: C# NOMBRES en XLSX - Convertisseur NOMBRES en XLSX
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les NUMBERS au format XLSX, permettant un enregistrement transparent des données NUMBERS au format XLSX à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros XLSX dans C#" %}}

L'exemple suivant montre comment convertir les NOMBRES de XLSX en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en XLSX par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en XLSX en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en XLSX en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en XLSX" %}}
