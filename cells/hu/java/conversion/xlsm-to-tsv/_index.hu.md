---
title: "XLSM konvertálása TSV-vé a következőn keresztül: Java "
weight: 4380
url: /hu/java/conversion/xlsm-to-tsv/ 
description: Minta Java konverziós kód az XLSM formátumhoz TSV-fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok exportálására TSV-be bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSM konvertálása TSV-vé a következőn keresztül: Java" h2="XLSM-től TSV-vé Java konverzió egyetlen vagy több oldal konvertálásához TSV-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="XLSM konvertálása TSV-vé a következővel: Java" %}}

 Ahhoz, hogy az XLSM-et TSV-re rendereljük, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM TSV-vé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak XLSM fájlt TSV-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSM-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TSV kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TSV-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLSM-ből TSV-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLSM fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xlsm");
// mentse az XLSM-et TSV-ként
