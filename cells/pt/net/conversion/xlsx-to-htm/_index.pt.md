---
title: C# XLSX para HTM - Conversor Online XLSX para HTM
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter XLSX para HTM saveformat. C# XLSX para o formato HTM. Salve XLSX para HTM C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSX para HTM em C#" h2="Biblioteca C# de alta velocidade para converter XLSX em HTM. Esta é uma solução de software profissional para importar e exportar XLSX, HTM e muitos outros formatos em .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Salve XLSX em HTM em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter XLSX para HTM em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX para HTM. Carregue seu arquivo XLSX e simplesmente salve-o como arquivo HTM. Para leitura XLSX e gravação HTM, você pode usar nomes de arquivo totalmente qualificados. O conteúdo HTM de saída e a formatação serão idênticos ao documento original XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter XLSX para HTM online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para HTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para HTM programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter XLSX para HTM em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para converter XLSX para HTM" %}}
