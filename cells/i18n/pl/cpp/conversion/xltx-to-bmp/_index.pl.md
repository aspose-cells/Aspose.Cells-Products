---
title: Konwertuj XLTX na BMP za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltx-to-bmp/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTX do formatu BMP. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTX na BMP w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLTX na BMP przez C++" h2="Wysokowydajna konwersja XLTX do BMP przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTX na BMP za pomocą C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLTX na BMP za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLTX na BMP w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTX przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (BMP).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik BMP w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLTX na BMP C++" offSpacer="" %}}
