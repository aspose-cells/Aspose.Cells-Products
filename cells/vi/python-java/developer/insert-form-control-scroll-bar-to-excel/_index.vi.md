...
weight: 90
description: Python via mã nguồn java để chèn ScrollBar(Form control) vào Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chèn ScrollBar(Điều khiển biểu mẫu) vào Excel bằng Python via java" h2="Chèn đối tượng bằng API phía máy chủ mà không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chèn ScrollBar(Điều khiển biểu mẫu) vào tệp Excel bằng Python via java" %}}

 Để chèn ScrollBar(Form control) vào tệp excel, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn ScrollBar(Form control) vào file Excel bằng Python via java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addScrollBar(int,%20int,%20int,%20int,%20int,%20int)) để chèn ScrollBar(Điều khiển biểu mẫu) vào bảng tính đã chọn.
