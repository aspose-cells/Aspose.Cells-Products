...
{{% blocks/products/pf/agp/content h2="How to Insert Line into Excel File Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Line to Excel file using Python via Java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) to insert a Line in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert Line - Python via Java" offSpacer="" %}}
