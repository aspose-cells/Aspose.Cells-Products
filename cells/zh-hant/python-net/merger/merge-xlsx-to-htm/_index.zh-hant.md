...
description: Aspose Excel。 Python Aspose.Cells。免費在線合併 XLSX 到 HTM 保存格式。 Python 將 XLSX 合併為 HTM 格式。將 XLSX 合併到 Python 中的 HTM。 XLSX 合併。
...
以下示例演示如何將 XLSX 合併到 Aspose.Cells for Python via .NET 中的 HTM。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLSX 合併到 HTM。上傳文件，調用Workbook.Combine方法合併文件，然後保存為HTM文件。如果您在 Python 中開發代碼，這會比聽起來更簡單。請參閱將 XLSX 合併到 HTM 的 Python 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將 XLSX 合併到 Python 中的 HTM" InputFormat="xlsx" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何通過 Python 將 XLSX 合併到 HTM" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 XLSX 合併到 HTM 嗎？基本文檔合併和連接[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)只需幾行代碼即可完成 API。
