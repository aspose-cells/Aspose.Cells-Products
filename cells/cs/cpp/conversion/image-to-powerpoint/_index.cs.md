...
Potřebujete převést IMAGE soubory do POWERPOINT programově? C++ vývojáři mohou snadno převést IMAGE na POWERPOINT v několika řádcích kódu.
...
1.  Převeďte IMAGE na POWERPOINT voláním metody Save().
