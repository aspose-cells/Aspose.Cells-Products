...
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してXLSをTABDELIMITEDに変換します" h2="オンプレミスJavaライブラリを使用して単一または複数のページをTABDELIMITEDに変換するためのXLSからTABDELIMITEDJavaへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してXLSをTABDELIMITEDに変換する方法" %}}

 XLSをTABDELIMITEDにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してXLSをTABDELIMITEDに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでXLSファイルをTABDELIMITEDに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookクラスのインスタンスを含むXLSファイルをロードします1. Workbook.saveメソッドを呼び出す1. TABDELIMITED拡張子とSaveFormatをパラメータとして出力パスを渡します1. 結果のTABDELIMITEDファイルの指定されたパスを確認します
...
{{% blocks/products/pf/agp/code-block title="XLSからTABDELIMITEDJavaへの変換ソースコード" offSpacer="" %}}

```cs
// WorkbookのインスタンスにXLSファイルをロードします
Workbook book = new Workbook("template.xls");
// XLSをTABDELIMITEDとして保存します
