...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SPREADSHEETML in TXT mit Java" %}}

 Um SPREADSHEETML in TXT zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von SPREADSHEETML in TXT über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können SPREADSHEETML-Dateien in nur wenigen Codezeilen ganz einfach in TXT konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die SPREADSHEETML-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit der TXT-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende TXT-Datei
...
{{% blocks/products/pf/agp/code-block title="Quellcode für die Umwandlung von SPREADSHEETML in TXT Java" offSpacer="" %}}

```cs
// Laden Sie die SPREADSHEETML-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.spreadsheetml");
// SPREADSHEETML als TXT speichern
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos für die Umwandlung von SPREADSHEETML in TXT" sectionDescription="[Wandeln Sie SPREADSHEETML in TXT um](https://products.aspose.app/cells/conversion/spreadsheetml-to-txt) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre SPREADSHEETML-Datei hoch, sie wird sofort in TXT konvertiert." >}}
