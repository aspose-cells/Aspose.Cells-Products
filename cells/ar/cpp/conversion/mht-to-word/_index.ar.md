...
هل تحتاج إلى تحويل ملفات MHT إلى WORD برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى WORD بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى WORD عن طريق استدعاء دالة Save().
