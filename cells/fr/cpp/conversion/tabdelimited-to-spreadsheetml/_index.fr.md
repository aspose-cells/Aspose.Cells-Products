---
title: Convertir TABDELIMITED en SPREADSHEETML via l'application C++ 

description: Exemple de code de conversion C++ pour le document TABDELIMITED au format SPREADSHEETML. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de TABDELIMITED en SPREADSHEETML dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TABDELIMITED en SPREADSHEETML via C++" h2="Conversion TABDELIMITED à SPREADSHEETML haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TABDELIMITED en SPREADSHEETML à l\'aide de C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TABDELIMITED en SPREADSHEETML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir le fichier TABDELIMITED en SPREADSHEETML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier TABDELIMITED à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (SPREADSHEETML).1. Le fichier SPREADSHEETML sera enregistré dans le chemin spécifié.1. Ouvrez le fichier SPREADSHEETML dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED à SPREADSHEETML C++ code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion de TABDELIMITED à SPREADSHEETML" sectionDescription="[Convertir TABDELIMITED en SPREADSHEETML](https://products.aspose.app/cells/conversion/tabdelimited-to-spreadsheetml) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier TABDELIMITED, il sera converti instantanément en SPREADSHEETML." >}}
