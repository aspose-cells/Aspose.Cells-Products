---
title: Объединить XLSM в XML — объединить XLSM в XML в C#
url: /ru/net/merger/merge-xlsm-to-xml/ 
description: Aspose Эксель. C# Aspose.Cells. Объедините XLSM в формат сохранения XML. C# Объединить XLSM в формат XML. Объедините XLSM с XML в C#. XLSM Объедините.
...
{{% blocks/products/pf/agp/content h2="Объединить XLSM в XML в C#" %}}

В следующем примере показано, как объединить XLSM с XML в Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить XLSM с XML. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл XML. Если вы разработаете код C#, это будет проще, чем кажется. См. пример C#, в котором XLSM объединяется с XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для слияния XLSM с XML в C#" InputFormat="xlsm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Как объединить XLSM с XML через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно объединить XLSM с XML? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2=".NET библиотека для объединения XLSM в XML" %}}
