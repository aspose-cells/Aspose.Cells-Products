...
{{% cells-convert title="Exemplo de código para converter XLS em TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="tiff" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em TIFF por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em TIFF programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em TIFF em apenas algumas linhas de código.
...
1.  Converta XLS em TIFF chamando o método Save().
