...
HTML dosyalarını program aracılığıyla MARKDOWN'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyebilir ve MARKDOWN'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak HTML değerini MARKDOWN değerine dönüştürün.
