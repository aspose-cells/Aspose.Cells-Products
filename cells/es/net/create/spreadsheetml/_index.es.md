---
title: Crear SPREADSHEETML - Crear archivo SPREADSHEETML en C#
description: Aspose Excel. Genere y manipule fácilmente archivos SPREADSHEETML con la biblioteca Aspose.Cells for .NET. Esta potente biblioteca API ofrece una solución optimizada y eficiente para crear, editar y administrar archivos SPREADSHEETML directamente en sus aplicaciones C#, satisfaciendo las necesidades específicas de los desarrolladores con alta precisión.
...
{{% blocks/products/pf/agp/content h2="Cómo crear una hoja de cálculo en C#" %}}
...
1.  Utilice el método Guardar para guardar el libro como archivo SPREADSHEETML.

{{% blocks/products/pf/agp/code-block title="El código de muestra muestra cómo crear un archivo SPREADSHEETML en C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para crear archivo SPREADSHEETML" %}}
