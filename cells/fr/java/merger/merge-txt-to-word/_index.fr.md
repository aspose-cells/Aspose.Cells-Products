---
title: Fusionner TXT à WORD via Java
...
L'exemple suivant montre comment fusionner TXT en WORD dans Java.
...
{{% cells-merger title="Application gratuite pour fusionner TXT à WORD en ligne" InputFormat="txt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
