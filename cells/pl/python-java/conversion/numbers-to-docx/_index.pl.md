...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować NUMBERS na DOCX za pomocą Python" %}}

 Aby przekonwertować NUMBERS na DOCX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować NUMBERS na DOCX przez Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki NUMBERS do formatu DOCX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik NUMBERS z wystąpieniem skoroszytu1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem DOCX jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku DOCX
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji NUMBERS na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="docx" IsLandingPage="true" language="python" %}}
