---
title:  Fusionner TXT à XLSX via Java
...
L'exemple suivant montre comment fusionner TXT à XLSX dans Java.
...
{{% cells-merger title="Application gratuite pour fusionner TXT à XLSX en ligne" InputFormat="txt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
