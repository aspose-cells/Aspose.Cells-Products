---
title:  Συγχώνευση SXC στο MHT via Java
url: /el/java/merger/merge-sxc-to-mht/ 
description: Συγχώνευση SXC στο MHT Online δωρεάν. Δωρεάν Online SXC to MHT Merger. Συγχώνευση SXC σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SXC με το MHT στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση SXC με MHT σε απευθείας σύνδεση" InputFormat="sxc" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
