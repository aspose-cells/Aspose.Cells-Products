...
description: Aspose Exceller. Convertissez HTM en HTML rapidement et facilement avec Aspose.Cells. C++ HTM en HTML. C++ Enregistrez HTM en HTML. Enregistrez HTM sous HTML en utilisant C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en HTML dans C++" h2="Conversion HTM vers HTML haute performance à l\'aide de la bibliothèque C++ sans avoir besoin d\'installation Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au HTML dans C++" %}}
...
{{% cells-convert title="Exemple de code pour convertir HTM en HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="html" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en HTML via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en HTML par programme ? Les développeurs C++ peuvent facilement convertir HTM en HTML en quelques lignes de code seulement.
...
1.  Convertissez HTM en HTML en appelant la méthode Save().
