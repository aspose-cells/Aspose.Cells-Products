---
title: PHP EXCEL en BMP - Convertisseur EXCEL en BMP
description: Aspose Exceller. Convertissez EXCEL en BMP rapidement et facilement avec Aspose.Cells. PHP EXCEL en BMP. PHP Enregistrez EXCEL en BMP. Enregistrez EXCEL sous BMP en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en BMP via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en BMP par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en BMP en quelques lignes de code.
...
1.  Convertissez EXCEL en BMP en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en BMP" %}}
