---
title: Sloučit XLSB na HTM – Sloučit XLSB na HTM v Python
url: /cs/python-java/merger/merge-xlsb-to-htm/ 
description: Aspose Excel. Python Aspose.Cells. Sloučit XLSB do formátu uložení HTM. Python Zkombinujte XLSB do formátu HTM. Sloučit XLSB na HTM v Python. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB do HTM pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB na HTM v Python" %}}

Následující příklad ukazuje, jak sloučit XLSB do HTM v Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLSB s HTM. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru HTM. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí XLSB do HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení XLSB do HTM v Python" InputFormat="xlsb" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB do HTM přes Python" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit XLSB do HTM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Python knihovna ke sloučení XLSB do HTM" %}}
