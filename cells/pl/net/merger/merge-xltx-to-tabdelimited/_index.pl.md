...
Poniższy przykład pokazuje, jak scalić XLTX z TABDELIMITED w Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić XLTX z TABDELIMITED? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
