---
title: Konvertieren Sie XLTX in ODS über die Anwendung C++ 
url: /de/cpp/conversion/xltx-to-ods/ 
description: Beispiel-Umwandlungscode C++ für das XLTX-Dokument in das ODS-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von XLTX in ODS in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLTX in ODS über C++" h2="Leistungsstarke XLTX-zu-ODS-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLTX in ODS mit C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von XLTX in ODS über C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-Entwickler können XLTX-Dateien in nur wenigen Codezeilen problemlos in ODS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die XLTX-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (ODS).1. ODS-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die ODS-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="XLTX-zu-ODS-C++-Umwandlungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLTX-zu-ODS-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie XLTX in ODS](https://products.aspose.app/cells/conversion/xltx-to-ods) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre XLTX-Datei hoch, sie wird sofort in ODS konvertiert." >}}
