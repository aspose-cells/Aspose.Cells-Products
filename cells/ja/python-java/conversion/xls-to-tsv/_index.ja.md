---
title: Python XLS ～ TSV - XLS ～ TSV コンバータ
description: Aspose エクセル。 XLS を Aspose.Cells ですばやく簡単に TSV に変換します。 Python XLS から TSV に変換します。 Python XLS を TSV に保存します。 XLS を 07611134 として保存しますPythonを使用して81。
...
{{% blocks/products/pf/agp/content h2="Python を使用して XLS を TSV に変換します" %}}
...
次の例は、XLS を Python の TSV に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、XLS を TSV に変換します。XLS ファイルをアップロードし、TSV ファイルとして保存するだけです。 XLS 読み取りと TSV 書き込みの両方で、完全修飾ファイル名を使用できます。出力 TSV のコンテンツと形式は、元の XLS ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="XLS を TSV に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="tsv" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でXLSをTSVに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLS ファイルをプログラムで TSV に変換する必要がありますか? Python 開発者は、わずか数行のコードで XLS を簡単にロードして TSV に変換できます。
