---
title: 将 JPG 合并到 PNG - 在 Java 中将 JPG 合并到 PNG
url: /zh/java/merger/merge-jpg-to-png/ 
description: Aspose Excel。 Java Aspose.Cells。合并JPG到PNG保存格式。 Java 将JPG合并为PNG格式。将 JPG 合并到 Java.JPG 中的 PNG。
...
{{< blocks/products/pf/i18n/upper-banner h1="合并 JPG 为 PNG via Java" h2="高速 Java 库，用于将 JPG 合并为 PNG。使用我们的 Excel 转换 API 在 Java 中开发高级、平台独立的软件。这是导入和导出 Excel, CSV, OpenOffice, PDF, HTML, image 和许多其他 Excel 格式的专业软件解决方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="JPG" additionalConversionTag="PNG" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Java 将 JPG 合并到 PNG" %}}

如何将 JPG 合并到 PNG？借助 Aspose.Cells for Java 库，您可以通过几行代码以编程方式轻松将 JPG 合并到 PNG。[Aspose.Cells for Java](https://products.aspose.com/cells/java)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Java Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。您可以直接从以下位置下载其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)并通过将以下配置添加到 pom.xml 将其安装在基于 Maven 的项目中。
...
{{% blocks/products/pf/agp/content h2="将JPG合并到Java中的PNG" %}}

下面的例子演示了如何将JPG合并到Aspose.Cells for Java中的PNG。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 JPG 合并到 PNG。上传文件，调用 Workbook.Combine 方法合并文件，然后将其保存到 PNG 文件。如果您在 Java 中开发代码，这会比听起来更简单。请参阅 Java 将 JPG 合并到 PNG 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="将 JPG 合并到 Java 中的 PNG 的示例代码" InputFormat="jpg" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何将 JPG 合并为 PNG via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 JPG 合并到 PNG 吗？基本文档合并和连接[Aspose.Cells for Java](https://products.aspose.com/cells/java)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Java库将JPG合并到PNG" %}}
