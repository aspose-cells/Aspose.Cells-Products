...
url: /de/python-net/merger/merge-excel-to-spreadsheetml/ 
...
Das folgende Beispiel zeigt, wie EXCEL in Aspose.Cells for Python via .NET mit SPREADSHEETML zusammengeführt wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie EXCEL programmgesteuert in SPREADSHEETML zusammenführen? Ein grundlegendes Dokument, das zusammengeführt und verknüpft wird mit[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs können mit nur wenigen Codezeilen erstellt werden.
