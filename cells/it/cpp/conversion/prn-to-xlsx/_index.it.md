...
description: Aspose Excel. Converti il PRN in XLSX in modo rapido e semplice con Aspose.Cells. C++ PRN in XLSX. C++ Salva PRN in XLSX. Salva PRN come XLSX utilizzando C++.
...
{{% blocks/products/pf/agp/content h2="Salva il PRN allo XLSX in C++" %}}

L'esempio seguente mostra come convertire il PRN in XLSX in C++.
...
È necessario convertire i file PRN in XLSX a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in XLSX in poche righe di codice.
...
1.  Converti PRN in XLSX chiamando il metodo Save().
1.  Ottieni il risultato della conversione da PRN a XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C++ per convertire il PRN in XLSX" %}}
