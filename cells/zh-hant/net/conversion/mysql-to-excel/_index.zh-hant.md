---
title: C# MYSQL 到 EXCEL - MYSQL 到 EXCEL 轉換器
description: Aspose Excel。使用Aspose.Cells快速輕鬆地將MYSQL轉換為EXCEL。C# MYSQL到EXCEL。 C# 將MYSQL儲存到EXCEL。使用 C# 將 MYSQL 儲存為 EXCEL。
...
{{% blocks/products/pf/agp/content h2="如何將MYSQL轉換為EXCEL通過C#" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 MYSQL 資料轉換為 EXCEL 嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入 MYSQL 並將其轉換為 EXCEL。

{{% /blocks/products/pf/agp/text %}}

1. 安裝“Aspose.Cells for .NET”。
1. 將庫引用（導入庫）新增至您的 C# 專案中。
1. 從MYSQL資料庫中查詢數據，得到DataTable物件。
1. 建立一個新的工作簿並從 DataTable 物件匯入資料。
1. 透過呼叫Workbook.Save方法將資料儲存為xlsx格式。

{{% blocks/products/pf/agp/code-block title="將 MYSQL 轉換為 EXCEL 的範例程式碼 - C#" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# 將MYSQL轉換為EXCEL的函式庫" %}}
