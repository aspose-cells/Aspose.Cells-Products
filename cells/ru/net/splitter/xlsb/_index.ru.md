---
title:  Сплит XLSB Файлы via .NET
weight: 7370
description: C# исходный код для разделения XLSB документов на .NET Framework, .NET Core, Mono или Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Разделить XLSB Форматы в C#" h2="Встроенный высокопроизводительный сплиттер XLSB с использованием серверных API без использования какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
+ Вызовите метод Save() и передайте имя файла (полный путь) и SaveFormat.Xlsb в качестве параметра.
