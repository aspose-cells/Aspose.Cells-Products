---
title: SPREADSHEETML を XLSM に結合 - SPREADSHEETML を Java に XLSM に結合
url: /ja/java/merger/merge-spreadsheetml-to-xlsm/ 
description: Aspose エクセル。 Java Aspose.Cells。無料オンライン SPREADSHEETML を XLSM 保存形式にマージします。 Java SPREADSHEETML を XLSM 形式に結合します。 SPREADSHEETML を Java の XLSM にマージします。SPREADSHEETML をマージします。
...
次の例は、SPREADSHEETML を Aspose.Cells for Java の XLSM にマージする方法を示しています。
...
{{% cells-merger title="SPREADSHEETML を Java にオンラインで無料でマージ" InputFormat="xml" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML を XLSM via Java にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで SPREADSHEETML を XLSM にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Java](https://products.aspose.com/cells/java)API はわずか数行のコードで実行できます。
