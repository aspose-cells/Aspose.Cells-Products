...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TXT na XPS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TXT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XPS).1. Plik XPS zostanie zapisany pod określoną ścieżką.1. Otwórz plik XPS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TXT do XPS C++ Kod źródłowy konwersji" offSpacer="" %}}
