---
title: Wstaw schemat blokowy do programu Excel via Java
weight: 360
...
{{% blocks/products/pf/agp/content h2="Jak wstawić schemat blokowy do pliku programu Excel za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić schemat blokowy do pliku programu Excel via Java" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj[dodaj metodę](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) aby wstawić FlowChart w wybranym arkuszu
...
{{% blocks/products/pf/agp/code-block title="Wstaw schemat blokowy - Java" offSpacer="" %}}
