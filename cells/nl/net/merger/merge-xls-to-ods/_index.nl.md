...
url: /nl/net/merger/merge-xls-to-ods/ 
...
Het volgende voorbeeld laat zien hoe u XLS samenvoegt met ODS in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLS programmatisch samenvoegen met ODS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLS samen te voegen met ODS" %}}
