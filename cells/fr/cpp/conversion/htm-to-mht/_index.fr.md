---
title: C++ HTM en MHT - Convertisseur HTM en MHT
description: Aspose Exceller. Convertissez HTM en MHT rapidement et facilement avec Aspose.Cells. C++ HTM en MHT. C++ Enregistrer HTM dans MHT. Enregistrez HTM en tant que MHT en utilisant le C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en MHT en C++" h2="Conversion HTM en MHT haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation Microsoft d\'Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM en MHT au C++" %}}

L'exemple suivant montre comment convertir HTM en MHT dans C++.
...
{{% cells-convert title="Exemple de code pour convertir HTM en MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="mht" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en MHT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en MHT par programme ? Les développeurs C++ peuvent facilement convertir HTM en MHT en quelques lignes de code seulement.
...
1.  Convertissez HTM en MHT en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de HTM en MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir HTM en MHT" %}}
