...
Besoin de convertir les fichiers XLS en XLSX par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en XLSX en quelques lignes de code seulement.
...
1.  Convertissez XLS en XLSX en appelant la méthode Workbook.Save.
