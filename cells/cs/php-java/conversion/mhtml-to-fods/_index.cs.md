---
title: Konvertor PHP MHTML až FODS - MHTML až FODS
description: Aspose Excel. Převeďte MHTML na FODS rychle a snadno pomocí Aspose.Cells. PHP MHTML na FODS. PHP Uložte MHTML na FODS. Uložte FODS jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na FODS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na FODS programově? Vývojáři PHP mohou snadno načíst a převést MHTML na FODS v několika řádcích kódu.
...
1.  Převeďte MHTML na FODS voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na FODS" %}}
