---
title: Sloučit TXT do POWERPOINT - Sloučit TXT do POWERPOINT v Java
url: /cs/java/merger/merge-txt-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. Bezplatné online sloučení TXT do formátu uložení POWERPOINT. Java Spojte TXT do formátu POWERPOINT. Sloučit TXT do POWERPOINT v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT do POWERPOINT v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit TXT do POWERPOINT v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TXT do POWERPOINT. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru POWERPOINT. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí TXT do POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení TXT do POWERPOINT v Java" InputFormat="txt" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit TXT do POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit TXT do POWERPOINT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovnu ke sloučení TXT do POWERPOINT" %}}
