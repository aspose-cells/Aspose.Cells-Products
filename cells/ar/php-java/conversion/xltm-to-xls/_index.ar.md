---
title: PHP XLTM إلى XLS - XLTM إلى XLS محول
description: Aspose اكسل. قم بتحويل XLTM إلى XLS بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى XLS. PHP احفظ XLTM إلى XLS. احفظ XLTM كـ XLS باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى XLS عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى XLS برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى XLS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى XLS عن طريق استدعاء طريقة حفظ المصنف.
