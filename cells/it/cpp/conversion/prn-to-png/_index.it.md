---
title: C++ PRN a PNG - PRN a PNG Convertitore
description: Aspose Excel. Converti il PRN in PNG in modo rapido e semplice con Aspose.Cells. C++ PRN in PNG. C++ Salva PRN in PNG. Salva PRN come PNG utilizzando C++.
...
{{% blocks/products/pf/agp/content h2="Salva il PRN allo PNG in C++" %}}

L'esempio seguente mostra come convertire il PRN in PNG in C++.
...
{{% blocks/products/pf/agp/content h2="Come convertire il PRN in PNG tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file PRN in PNG a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in PNG in poche righe di codice.
...
1.  Converti PRN in PNG chiamando il metodo Save().
1.  Ottieni il risultato della conversione da PRN a PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C++ per convertire il PRN in PNG" %}}
