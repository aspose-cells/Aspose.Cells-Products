...
description: Aspose Excel. A TSV-es számot BMP-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# TSV-BMP-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a TSV-BMP számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a TSV-et BMP-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a TSV BMP-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="bmp" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A TSV konvertálása BMP-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A TSV fájlt programozottan BMP-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a TSV-et BMP-re.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a TSV konvertálásához BMP-re" %}}
