...
{{% blocks/products/pf/agp/content h2="Převeďte HTM na DOCX v Python" %}}
...
Následující příklad ukazuje, jak převést HTM na DOCX v Python via NET.
