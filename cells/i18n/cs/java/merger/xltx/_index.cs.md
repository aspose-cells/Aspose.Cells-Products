...
{{< blocks/products/pf/i18n/upper-banner h1="Sloučit formáty XLTX v Java" h2="Nativní slučování dokumentů XLTX pomocí rozhraní API Java na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak sloučit soubory XLTX pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro sloučení souborů XLTX v Java" %}}
...
+ uložte sloučený soubor XLTX do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Sloučit soubory XLTX – Java" offSpacer="" %}}

```cs
// Otevřete první soubor XLTX.
Workbook xltxFile1 = new Workbook("chartsFileWithPath.xltx");

// Definujte druhou zdrojovou knihu.
// Otevřete druhý soubor XLTX.
