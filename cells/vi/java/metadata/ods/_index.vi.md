...
weight: 2080
description: Mã mẫu Java để chỉnh sửa hoặc xem siêu dữ liệu định dạng ODS trên Môi trường thời gian chạy Java cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất ODS Siêu dữ liệu via Java" h2="Xây dựng ứng dụng Java của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ các tệp ODS bằng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước trích xuất siêu dữ liệu của ODS via Java" %}}
...
+ Tải file ODS trong WorkbookMetadata
