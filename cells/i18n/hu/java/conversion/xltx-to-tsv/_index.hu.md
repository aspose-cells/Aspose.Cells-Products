---
title: "XLTX konvertálása TSV-vé a következőn keresztül: Java "
weight: 3420
url: /hu/java/conversion/xltx-to-tsv/ 
description: Minta Java konverziós kód az XLTX formátumhoz TSV-fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok exportálására TSV-be bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLTX konvertálása TSV-vé a következőn keresztül: Java" h2="XLTX-től TSV-vé Java konverzió egyetlen vagy több oldal konvertálásához TSV-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Az XLTX konvertálása TSV-vé a következővel: Java" %}}

 Ahhoz, hogy az XLTX-et TSV-re rendereljük, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLTX konvertálása TSV-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak XLTX fájlt TSV-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTX fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TSV kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TSV-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLTX-től TSV-vé Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLTX fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xltx");
// mentse az XLTX-et TSV-ként
