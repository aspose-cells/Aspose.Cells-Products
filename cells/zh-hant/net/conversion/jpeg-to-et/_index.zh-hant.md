...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 JPEG 轉換為 ET。C# JPEG 轉換為 ET。 C# 將 JPEG 儲存到 ET。使用 C# 將 JPEG 儲存為 ET。
...
{{% blocks/products/pf/agp/content h2="將 JPEG 儲存到 C# 中的 ET" %}}
...
{{% cells-convert title="將 JPEG 轉換為 ET 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="et" IsLandingPage="true" %}}
