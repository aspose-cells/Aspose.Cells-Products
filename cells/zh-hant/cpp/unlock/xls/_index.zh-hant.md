...
title: 透過C++解鎖XLS文檔
weight: 2380
description: C++ 用於解鎖 C++ 運行時環境中受密碼保護的 XLS 檔案的範例代碼，適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 解鎖 XLS 文件" h2="使用 C++ 庫刪除 Excel 電子表格（包括 XLS 檔案）的保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 刪除 XLS 檔案的保護" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 解鎖 XLS" %}}
