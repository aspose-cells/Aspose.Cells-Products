...
description: Aspose Excel. Konvertieren Sie XLSB schnell und einfach in FODS mit Aspose.Cells. PHP XLSB in FODS. PHP Speichern Sie XLSB in FODS. Speichern Sie XLSB als FODS mit PHP.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLSB über PHP in FODS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLSB-Dateien programmgesteuert in FODS konvertieren? PHP-Entwickler können XLSB in nur wenigen Codezeilen problemlos laden und in FODS konvertieren.
...
1.  Konvertieren Sie XLSB in FODS, indem Sie die Speichermethode der Arbeitsmappe aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLSB in FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von XLSB in FODS" %}}
