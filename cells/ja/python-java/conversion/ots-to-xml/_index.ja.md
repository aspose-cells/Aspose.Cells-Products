...
{{% blocks/products/pf/agp/content h2="オンラインで無料でOTSをPythonにXMLに保存します" %}}
...
{{% cells-convert title="OTS をオンラインで XML に変換するための無料アプリとサンプル コード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xml" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python 経由で OTS を XML に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

 Python 開発者は、わずか数行のコードで OTS を簡単にロードして XML に変換できます。

{{% /blocks/products/pf/agp/text %}}

1.  Workbook のインスタンスを使用して OTS ファイルをロードします
1.  Workbook.save メソッドを呼び出して OTS を XML に変換する
