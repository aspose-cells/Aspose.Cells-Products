---
title: Sloučit XML s PPTX – Zkombinovat XML s PPTX v Java
url: /cs/java/merger/merge-xml-to-pptx/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit XML do formátu uložení PPTX. Java Zkombinujte XML do formátu PPTX. Sloučit XML na PPTX v Java. Sloučit XML.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML na PPTX v Java" %}}

Následující příklad ukazuje, jak sloučit XML do PPTX v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XML do PPTX. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PPTX. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí XML do PPTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení XML do PPTX v Java" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XML na PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit XML s PPTX? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro sloučení XML do PPTX" %}}
