---
title: HTM を XLT に結合 - HTM を Java に XLT に結合
url: /ja/java/merger/merge-htm-to-xlt/ 
description: Aspose エクセル。 Java Aspose.Cells。HTM を XLT 保存形式にマージします。 Java HTM を XLT 形式に結合します。 HTM を Java の XLT にマージします。HTM をマージします。
...
{{% blocks/products/pf/agp/content h2="HTM を Java の XLT に結合" %}}

次の例は、HTM を Aspose.Cells for Java の XLT にマージする方法を示しています。
...
{{% cells-merger title="Java に HTM を XLT にマージするサンプルコード" InputFormat="htm" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM を XLT via Java にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

HTM をプログラムで XLT にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Java](https://products.aspose.com/cells/java)API はわずか数行のコードで実行できます。
