---
title: Java Naprawa ods — odzyskaj i napraw uszkodzony plik ods
url: /pl/java/recovery/repair-ods/ 
description: Java Aspose.Cells. Kody napraw. Napraw plik ods. narzędzie do odzyskiwania danych. korupcja. Przywróć dane transakcji. odzyskiwanie plików ods. Odzyskaj uszkodzony plik ods.
...
Chcesz programowo naprawić plik ods? Programiści Java mogą łatwo załadować i naprawić plik ods w zaledwie kilku linijkach kodu.
...
{{% cells-recovery title="Przykładowy kod do naprawy pliku ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="java" %}}    
