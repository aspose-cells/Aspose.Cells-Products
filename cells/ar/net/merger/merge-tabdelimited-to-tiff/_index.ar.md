---
title: دمج TABDELIMITED إلى TIFF - دمج TABDELIMITED إلى TIFF في C#
url: /ar/net/merger/merge-tabdelimited-to-tiff/ 
description: Aspose اكسل. C# Aspose.Cells. قم بدمج TABDELIMITED في TIFF saveformat. C# قم بدمج TABDELIMITED إلى تنسيق TIFF. دمج TABDELIMITED إلى TIFF في C#. TABDELIMITED دمج.
...
{{% blocks/products/pf/agp/content h2="دمج TABDELIMITED إلى TIFF في C#" %}}

يوضح المثال التالي كيفية دمج TABDELIMITED إلى TIFF في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج TABDELIMITED إلى TIFF. قم بتحميل ملفاتك، واتصل بطريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف TIFF. إذا قمت بتطوير التعليمات البرمجية في C#، فسيكون هذا أبسط مما يبدو. راجع مثال C# الذي يدمج TABDELIMITED إلى TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج التعليمات البرمجية لدمج TABDELIMITED إلى TIFF في C#" InputFormat="tsv" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج TABDELIMITED إلى TIFF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج TABDELIMITED مع TIFF برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة .NET لدمج TABDELIMITED إلى TIFF" %}}
