---
title: ใส่หมายเหตุไปที่ XLS ไฟล์ via .NET
url: /th/net/notes/insert-notes-to-xls/ 
description: ใส่บันทึกไปที่ XLS โดยใช้ C# ใช้โค้ดตัวอย่าง API เพื่อแทรกบันทึกภายในแอปพลิเคชัน .NET
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกบันทึกย่อในไฟล์ XLS ผ่าน C#" %}}
...
ใน Office 365 บันทึกย่อมีไว้สำหรับคำอธิบายประกอบ คุณสามารถใช้รหัส C# ต่อไปนี้เพื่อแทรกและลบบันทึกย่อในไฟล์ XLS

{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่าง C# สำหรับแทรกและลบบันทึกย่อในไฟล์ XLS" offSpacer="" %}}
