...
url: /hu/cpp/merger/merge-xlsb-to-ett/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a XLSB-es számot az ETT-vel a Aspose.Cells-es for C++-ben.
...
Programozottan egyesítenie kell a XLSB-et az ETT-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a XLSB ETT-vel való egyesítéséhez" %}}
