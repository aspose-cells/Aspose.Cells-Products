...
description: Aspose Excel. Convierta XLSB a EXCEL rápida y fácilmente con Aspose.Cells. Python XLSB a EXCEL. Python Guardar XLSB en EXCEL. Guarde XLSB como EXCEL usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB en EXCEL en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a EXCEL en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB a EXCEL" %}}
