...
The following example demonstrates how to convert CSV to GIF document format in Java.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert CSV file into GIF format. Upload your CSV file, then simply save it as GIF file. For both CSV reading and GIF writing you can use fully qualified filenames. The output GIF content and formatting will be identical to the original CSV document.
...
{{% blocks/products/pf/agp/content h2="Java library to convert CSV to GIF" %}}
{{% blocks/products/pf/agp/text %}}
