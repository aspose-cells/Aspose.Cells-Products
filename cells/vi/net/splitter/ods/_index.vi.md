...
weight: 140
description: Mã nguồn C# để phân chia ODS tài liệu trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chia ODS Định dạng C#" h2="Bộ chia ODS gốc và hiệu suất cao sử dụng API phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tách file ODS trong C#" %}}
...
+ Load file ODS đầy đủ đường dẫn chia tách.
...
+ Tạo đối tượng lớp Workbook mới
 ...
 Gọi phương thức Save() và truyền tên file (đường dẫn đầy đủ) và tham số SaveFormat.Ods.
...
{{% blocks/products/pf/agp/code-block title="Tách ODS File - C#" offSpacer="" %}}
