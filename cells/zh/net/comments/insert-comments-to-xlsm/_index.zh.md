...
在 Office 365 中，注释用于对话，您可以使用以下 C# 代码在 XLSM 文件中插入和删除注释。
...
{{% cells-annotation title="免费应用程序可从 XLSM 文件中删除注释" InputFormat="xlsm" IsLandingPage="true" language="net" %}}
