---
title:  Połącz ODS z MHTML przez Python
url: /pl/python-net/merger/merge-ods-to-mhtml/ 
description: Połącz ODS z MHTML Online za darmo. Bezpłatnie online ODS do MHTML Fuzja. Połącz ODS z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć ODS z MHTML w Python.
...
{{% cells-merger title="Darmowa aplikacja do łączenia ODS z MHTML on-line" InputFormat="ods" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
