...
{{% blocks/products/pf/agp/content h2="Konwertuj EXCEL na HTML używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL do HTML w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę z programu EXCEL na HTML w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu HTML? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu HTML za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA na HTML" %}}
{{% blocks/products/pf/agp/text %}}
