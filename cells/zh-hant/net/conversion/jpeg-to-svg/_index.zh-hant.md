...
{{< blocks/products/pf/i18n/upper-banner h1="將 JPEG 轉換為 SVG，其中 C#" h2="高速 C# 庫，用於將 JPEG 轉換為 SVG。這是一個專業的軟體解決方案，可在 .NET 框架、.NET 核心或 Mono 平台上匯入和匯出 JPEG、SVG 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% cells-convert title="將 JPEG 轉換為 SVG 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 JPEG 轉換為 SVG" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 JPEG 檔案轉換為 SVG 嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入和轉換 JPEG 到 SVG。
...
1. 使用工作簿實例載入 JPEG 檔案。
1. 透過呼叫 Workbook.Save 方法將 JPEG 轉換為 SVG。
1. 取得JPEG到SVG的轉換結果。
