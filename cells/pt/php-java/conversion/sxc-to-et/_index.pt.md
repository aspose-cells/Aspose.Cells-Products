---
title: Conversor de PHP SXC para ET - SXC para ET
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores PHP uma abordagem totalmente integrada para converter o formato SXC para o formato ET, permitindo o salvamento perfeito de dados SXC no formato ET usando a biblioteca Aspose.Cells, tudo por meio de código PHP eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC para ET via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC para ET programaticamente? Desenvolvedores PHP podem facilmente carregar e converter arquivos SXC para ET com apenas algumas linhas de código.
...
1. Converta SXC para ET chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de SXC para ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter SXC em ET" %}}
