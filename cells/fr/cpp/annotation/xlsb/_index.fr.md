---
title:  Ajouter ou supprimer un fichier Excel XLSB Annotation via C++
weight: 860
description: Exemple de code C++ pour supprimer les annotations au format XLSB sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
...
1.  Chargez le fichier Excel XLSB à l'aide de l'objet de classe IWorkbook.
1.  Sélectionnez la fiche concernée
1.  Ajoutez le commentaire à l'aide de la méthode Add
1.  Définissez la note du commentaire à l'aide de la méthode SetNote.
1.  Enregistrez le classeur en utilisant[Sauvegarder](https://reference.aspose.com/cells/cpp/aspose.cells/workbook/save/) méthode
