---
title: Converter SXC para XLTM via Python
url: /pt/python-java/conversion/sxc-to-xltm/
description: Código de exemplo para conversão de sxc para xltm Python. Use API código de exemplo para arquivos sxc em lote para conversão xltm no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter SXC para XLTM usando Python" %}}

 Para converter SXC para XLTM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC para XLTM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para XLTM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo SXC com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão XLTM como parâmetro1. Verifique o caminho especificado para o arquivo XLTM resultante
...
{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter SXC para XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xltm" IsLandingPage="true" language="python" %}}
