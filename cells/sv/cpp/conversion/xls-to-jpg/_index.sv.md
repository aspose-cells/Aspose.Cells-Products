...
description: Aspose Excel. Konvertera XLS till JPG snabbt och enkelt med Aspose.Cells. C++ XLS till JPG. C++ Spara XLS till JPG. Spara XLS som JPG med C++.
...
{{% cells-convert title="Exempelkod för att konvertera XLS till JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till JPG via C++" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till JPG programmatiskt? C++-utvecklare kan enkelt konvertera XLS till JPG på bara några rader kod.
...
1.  Konvertera XLS till JPG genom att anropa metoden Save().
