...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке изображения в файл Excel по номеру C#" %}}
...
+ Есть два способа вставить изображение на выбранный лист.
 + Используйте коллекцию фигур[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addpicture/index) чтобы вставить изображение на выбранный лист.
 + Используйте коллекцию изображений[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/picturecollection/methods/add/index) чтобы вставить изображение на выбранный лист.
