...
weight: 10010
description: C++ رمز المثال لقفل ملف ODS باستخدام كلمة المرور على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات حماية الملفات ODS عبر C++" %}}
