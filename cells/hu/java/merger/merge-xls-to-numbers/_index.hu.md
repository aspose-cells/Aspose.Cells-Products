---
title: A XLS egyesítése a NUMBERS-szel – a XLS-es szám egyesítése a NUMBERS-szel a Java-ben
url: /hu/java/merger/merge-xls-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés XLS NUMBERS mentési formátumba. Java Kombinálja a XLS számot NUMBERS formátumba. A XLS egyesítése a NUMBERS számmal a Java-ben. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a XLS-et a NUMBERS-szel a Java-es szám használatával" %}}
 ...
 Hogyan egyesíthetem a XLS számot a NUMBERS számmal? A Aspose.Cells for Java könyvtárral egyszerűen egyesítheti a XLS számot a NUMBERS számmal néhány sornyi kóddal.[Aspose.Cells for Java](https://products.aspose.com/cells/java) képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Java Excel API nem csak a táblázatformátumok között konvertál, hanem Excel fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, CSV, CSV, CSV, CSV, CSV, SVG, és így tovább, SVG P, 8 PT a választás,3,8 ipari szabvány szerinti dokumentumok cseréjére formátumok. A legújabb verziót közvetlenül a webhelyről töltheti le[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) és telepítse a Maven alapú projekten belül a következő konfigurációk hozzáadásával a pom.xml fájlhoz.
...
következő példa bemutatja, hogyan lehet egyesíteni a XLS-et a NUMBERS-szel a Aspose.Cells-es for Java-ben.
...
{{% cells-merger title="Ingyenes online összevonás a XLS számmal a NUMBERS számmal a Java-ben" InputFormat="xls" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLS és a NUMBERS via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-es számot a NUMBERS számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
