...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XML do formatu ET, umożliwiając bezproblemowe zapisywanie danych XML w formacie ET za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML do ET w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na ET w formacie C#.
...
Chcesz programowo przekonwertować pliki XML na ET? Programiści .NET mogą łatwo załadować i przekonwertować XML na ET w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XML do ET wywołując metodę Workbook.Save.
1.  Pobierz wynik konwersji XML do ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XML do ET" %}}
