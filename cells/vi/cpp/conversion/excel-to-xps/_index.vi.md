...
description: Aspose Excel. Chuyển EXCEL sang XPS nhanh chóng và dễ dàng với Aspose.Cells. C++ EXCEL sang XPS. C++ Lưu EXCEL thành XPS. Lưu EXCEL thành XPS sử dụng C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển EXCEL thành XPS trong C++" h2="Chuyển đổi EXCEL sang XPS hiệu suất cao bằng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi EXCEL thành XPS Sử dụng C++" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu EXCEL vào XPS trong C++" %}}

Ví dụ sau đây minh họa cách chuyển đổi EXCEL thành XPS trong C++.
...
{{% cells-convert title="Code mẫu chuyển EXCEL thành XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi EXCEL sang XPS qua C++" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển file EXCEL sang XPS theo chương trình? Các nhà phát triển C++ có thể dễ dàng chuyển đổi EXCEL thành XPS chỉ bằng vài dòng mã.
...
1.  Chuyển đổi EXCEL thành XPS bằng cách gọi phương thức Save().
1.  Nhận kết quả chuyển đổi EXCEL thành XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C++ chuyển EXCEL thành XPS" %}}
