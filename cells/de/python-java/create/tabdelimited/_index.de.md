...
{{% blocks/products/pf/agp/content h2="So erstellen Sie TABDELIMITED in Python" %}}
...
1.  Verwenden Sie die Save-Methode, um die Arbeitsmappe als TABDELIMITED-Datei zu speichern.

{{% blocks/products/pf/agp/code-block title="Beispielcode zeigt, wie eine TABDELIMITED-Datei in Python erstellt wird." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python-Bibliothek zum Erstellen einer TABDELIMITED-Datei" %}}
