---
title: Voeg XLSM samen met XLSB - Combineer XLSM met XLSB in Java
url: /nl/java/merger/merge-xlsm-to-xlsb/ 
description: Aspose Excel. Java Aspose.Cells. Voeg XLSM samen met het opslagformaat XLSB. Java Combineer het formaat XLSM met XLSB. Voeg XLSM samen met XLSB in Java. XLSM Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u XLSM samenvoegt met XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen met XLSB? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSM samen te voegen met XLSB" %}}
