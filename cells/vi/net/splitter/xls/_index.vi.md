...
weight: 1340
description: Mã nguồn C# để phân chia XLS tài liệu trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chia XLS Định dạng C#" h2="Bộ chia XLS gốc và hiệu suất cao sử dụng API phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tách file XLS trong C#" %}}
...
+ Load file XLS đầy đủ đường dẫn chia tách.
...
+ Gọi phương thức Save() và truyền tên file (đường dẫn đầy đủ) và tham số SaveFormat.Xls.
...
{{% blocks/products/pf/agp/code-block title="Tách XLS File - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Các định dạng chia tách được hỗ trợ khác" subTitle="Sử dụng C#, Người ta cũng có thể chia tệp lớn thành nhiều phần của nhiều định dạng tệp khác, bao gồm cả." >}}
