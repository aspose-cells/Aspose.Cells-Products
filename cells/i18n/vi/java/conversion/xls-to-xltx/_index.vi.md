---
title: Chuyển đổi XLS sang XLTX qua Java 
weight: 4100
url: /vi/java/conversion/xls-to-xltx/ 
description: Mã chuyển đổi Java mẫu cho định dạng XLS thành tệp XLTX. Lập trình viên có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang XLTX trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS sang XLTX qua Java" h2="Chuyển đổi XLS sang XLTX Java để chuyển đổi một hoặc nhiều trang sang XLTX bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS sang XLTX bằng cách sử dụng Java" %}}

 Để kết xuất XLS thành XLTX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLS sang XLTX qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp XLS sang XLTX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLS với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Truyền đường dẫn đầu ra với phần mở rộng XLTX & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp XLTX kết quả
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi XLS sang XLTX Java" offSpacer="" %}}

```cs
// tải tệp XLS trong một phiên bản của Workbook
Workbook book = new Workbook("template.xls");
// lưu XLS dưới dạng XLTX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi XLS sang XLTX" sectionDescription="[Chuyển đổi XLS sang XLTX](https://products.aspose.app/cells/conversion/xls-to-xltx) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp XLS của bạn, tệp sẽ được chuyển đổi ngay lập tức thành XLTX." >}}
