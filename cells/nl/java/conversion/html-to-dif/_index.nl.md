...
{{% blocks/products/pf/agp/content h2="Sla HTML op in DIF in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar DIF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar DIF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar DIF? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar DIF met slechts een paar regels code.
