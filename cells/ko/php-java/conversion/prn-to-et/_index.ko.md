---
title: PHP PRN에서 ET로 - PRN에서 ET로 변환기
description: Aspose 엑셀. Aspose.Cells을 사용하여 PRN을 ET로 빠르고 쉽게 변환하세요. PHP PRN을 ET로 변환하세요. PHP PRN을 ET에 저장합니다. PHP를 사용하여 PRN을 ET로 저장합니다.
...
{{% cells-convert title="PRN을 ET로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="et" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP를 통해 PRN을 ET로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 PRN 파일을 ET로 변환해야 합니까? PHP 개발자는 단 몇 줄의 코드만으로 PRN을 ET로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook의 save 메소드를 호출하여 PRN을 ET로 변환합니다.
1.  PRN을 ET로 변환한 결과를 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PRN을 ET로 변환하는 PHP 라이브러리" %}}
