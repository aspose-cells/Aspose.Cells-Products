---
title:  Generar Informes en Archivos XLSM via .NET
weight: 4400
description: Código fuente C# para generar informes en formato XLSM en .NET Framework, .NET Core, Mono o plataformas Xamarin.
...
{{% blocks/products/pf/agp/content h2="Cómo generar informes basados en XLSM utilizando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Armar XLSM vía C#" %}}
...
1. Guarde el resultado en formato XLSM mediante el método WorkbookDesigner.Worbook.Save
