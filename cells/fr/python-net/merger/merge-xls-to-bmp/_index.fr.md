...
url: /fr/python-net/merger/merge-xls-to-bmp/ 
...
L'exemple suivant montre comment fusionner XLS à BMP dans Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Besoin de fusionner XLS à BMP par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
