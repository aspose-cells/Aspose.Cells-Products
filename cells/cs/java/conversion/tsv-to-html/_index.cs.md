---
title: Převést TSV na HTML pomocí Java 
weight: 3880

description: Ukázka převodního kódu Java pro formát TSV na soubor HTML. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do HTML v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést TSV na HTML pomocí Java" h2="Převod TSV na HTML Java pro převod jedné nebo více stránek do HTML pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na HTML pomocí Java" %}}

 K vykreslení TSV do HTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postup převodu TSV na HTML prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor TSV na HTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Jako parametry předejte výstupní cestu s rozšířením HTML a SaveFormat1. Zkontrolujte zadanou cestu pro výsledný soubor HTML
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TSV na HTML Java" offSpacer="" %}}

```cs
// načíst soubor TSV v instanci sešitu
Workbook book = new Workbook("template.tsv");
// uložit TSV jako HTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze TSV do HTML" sectionDescription="[Převést TSV na HTML](https://products.aspose.app/cells/conversion/tsv-to-html) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor TSV, bude okamžitě převeden do HTML." >}}
