---
title: JSON'i XLSX'e birleştir - JSON'i C#'de XLSX'e birleştir
url: /tr/net/merger/merge-json-to-xlsx/ 
description: Aspose Excel'de. C# Aspose.Cells. JSON'i XLSX kaydetme biçimiyle birleştirin. C# JSON'i XLSX biçimiyle birleştirin. C#'de JSON'i XLSX ile birleştirin. JSON Birleştir.
...
{{% blocks/products/pf/agp/content h2="JSON\'i C#\'de XLSX ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de JSON ile XLSX'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

JSON ile XLSX'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLSX dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. JSON ile XLSX'i birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="JSON ile XLSX\'i C#\'de Birleştirmek için Örnek Kod" InputFormat="json" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="JSON\'i C# aracılığıyla XLSX\'e Nasıl Birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

 JSON ile XLSX'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kitaplığı, JSON ile XLSX arasında birleştirilecek" %}}
