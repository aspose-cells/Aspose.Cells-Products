...
{{% blocks/products/pf/agp/content h2="Jak převést FODS na EMF pomocí Java" %}}

 Abychom vykreslili FODS na EMF, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu FODS na EMF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor FODS na EMF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor FODS s instancí Workbooku1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Chcete-li uložit výsledek ve formátu EMF, zavolejte metodu SheetRender.toImage
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze FODS na EMF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze FODS na EMF" sectionDescription="[Převést FODS na EMF](https://products.aspose.app/cells/conversion/fods-to-emf) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor FODS, bude okamžitě převeden na EMF." >}}
