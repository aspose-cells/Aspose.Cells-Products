---
title: C++ XLS a XLS - XLS a XLS Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato XLS, permitindo o salvamento perfeito de dados XLS no formato XLS usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLS a XLS em C++" %}}

exemplo a seguir demonstra como converter XLS em XLS em C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLS em XLS. Carregue seu arquivo XLS e simplesmente salve-o como arquivo XLS. Para leitura de XLS e gravação de XLS, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída XLS serão idênticos ao documento XLS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter XLS em XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em XLS por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para XLS programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para XLS com apenas algumas linhas de código.
...
1.  Converta XLS para XLS chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em XLS" %}}
