---
title: EXCEL を Python 経由で PPTX に結合
...
次の例は、EXCEL を Python の PPTX にマージする方法を示しています。
...
{{% cells-merger title="オンラインでEXCELをPPTXにマージする無料アプリ" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
