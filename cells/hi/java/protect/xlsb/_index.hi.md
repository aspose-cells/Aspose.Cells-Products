---
title:  XLSB दस्तावेज़ via Java को सुरक्षित और लॉक करें
weight: 6590
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरनमेंट पर पासवर्ड का उपयोग करके XLSB फ़ाइल को लॉक करने के लिए Java नमूना कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="एन्क्रिप्ट XLSB फ़ाइलें via Java" h2=".NET लाइब्रेरी का उपयोग करके XLSB प्रारूप सहित एक्सेल स्प्रेडशीट को पासवर्ड से सुरक्षित रखें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB फाइलों की सुरक्षा के लिए कदम via Java" %}}
...
1.  वर्कबुक क्लास को इंस्टैंट करके XLSB फाइल लोड करें
1.  प्रोटेक्शन टाइप और पासवर्ड के साथ प्रोटेक्ट (..) मेथड का इस्तेमाल करें
1.  सुरक्षित XLSB फ़ाइल को सेव () विधि से सहेजें
