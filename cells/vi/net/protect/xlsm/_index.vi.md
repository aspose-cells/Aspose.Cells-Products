---
title:  Bảo vệ và khóa XLSM tài liệu via .NET
weight: 7530
description: Mã nguồn C# khóa file XLSM bằng mật khẩu trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa XLSM Tệp qua C#" h2="Bảng tính Excel được bảo vệ bằng mật khẩu bao gồm định dạng XLSM sử dụng Thư viện .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
