---
title: C# XLSB เป็น SQL - XLSB เป็น SQL Converter
description: Aspose เอ็กเซล. แปลง XLSB เป็น SQL อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C# XLSB เป็น SQL C# บันทึก XLSB ลงใน SQL บันทึก XLSB เป็น SQL โดยใช้ C#
...
{{% blocks/products/pf/agp/content h2="บันทึก XLSB ลงใน SQL ใน C#" %}}
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง XLSB เป็น SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="sql" IsLandingPage="true" %}}
