---
title: C# EXCEL ke ODS - Konversi EXCEL ke ODS Online
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Online Gratis C# Convert EXCEL to ODS saveformat. Format C# EXCEL ke ODS. Simpan EXCEL ke ODS C#.
...
{{% blocks/products/pf/agp/content h2="Simpan EXCEL ke ODS di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi EXCEL ke ODS di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengonversi EXCEL ke ODS. Unggah file EXCEL Anda, lalu simpan sebagai file ODS. Untuk pembacaan EXCEL dan penulisan ODS Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format output ODS akan identik dengan dokumen EXCEL asli.
...
{{% blocks/products/pf/agp/content h2="Cara Konversi EXCEL ke ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke ODS secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengubah EXCEL menjadi ODS hanya dalam beberapa baris kode.
...
1.  Ubah EXCEL menjadi ODS dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi EXCEL ke ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengonversi EXCEL ke ODS" %}}
