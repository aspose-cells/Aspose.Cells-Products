---
title:  Преобразование ODS в байтовый массив с помощью C#
weight: 7690
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Байтовый массив полезен для обработки или хранения данных. Вы можете преобразовать файл ODS в массив байтов, а также в**Массив байтов до ODS**документ на языке C#. Чтобы преобразовать ODS в массив байтов, мы будем использовать
...
1.  Загрузить ввод ODS Файл с помощью рабочей книги
...
{{% blocks/products/pf/agp/code-block title="Этот пример кода показывает ODS в массив байтов C# Преобразование" offSpacer="" %}}
