...
Het volgende voorbeeld laat zien hoe u MHT converteert naar DIF in Python via NET.
...
{{% blocks/products/pf/agp/content h2="MHT converteren naar DIF" %}}
