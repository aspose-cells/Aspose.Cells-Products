---
title: Javaを介してSXCをTXTに変換します 
url: /ja/java/conversion/sxc-to-txt/ 
description: SXC形式からTXTファイルへのサンプルJava変換コード。プログラマーは、このサンプルコードを使用して、ExcelおよびOpenOfficeスプレッドシートを任意のWebまたはデスクトップJavaベースのアプリケーション内のTXTにエクスポートできます。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してSXCをTXTに変換します" h2="オンプレミスJavaライブラリを使用して単一または複数のページをTXTに変換するためのSXCからTXTJavaへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してSXCをTXTに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してSXCをTXTに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでSXCファイルをTXTに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookクラスのインスタンスを含むSXCファイルをロードします1. Workbook.saveメソッドを呼び出す1. TXT拡張子とSaveFormatをパラメーターとして使用して出力パスを渡します1. 結果のTXTファイルの指定されたパスを確認します
...
{{% blocks/products/pf/agp/code-block title="SXCからTXTJavaへの変換ソースコード" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXCからTXTへの変換ライブデモ" sectionDescription="[SXCをTXTに変換する](https://products.aspose.app/cells/conversion/sxc-to-txt) 今すぐライブデモのウェブサイトにアクセスしてください。ライブデモには次の利点があります。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" AsposeAPIをダウンロードする必要はありません。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" コードを書く必要はありません。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" SXCファイルをアップロードするだけで、すぐにTXTに変換されます。" >}}
