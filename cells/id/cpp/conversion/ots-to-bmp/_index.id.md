...
description: Aspose Unggul. Ubah OTS menjadi BMP dengan cepat dan mudah menggunakan Aspose.Cells. C++ OTS menjadi BMP. C++ Simpan OTS ke BMP. Simpan OTS sebagai BMP menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah OTS menjadi BMP Menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengonversi OTS ke BMP di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi OTS ke BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="bmp" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert OTS ke BMP lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file OTS ke BMP secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke BMP hanya dalam beberapa baris kode.
...
1.  Ubah OTS menjadi BMP dengan memanggil metode Save().
1.  Dapatkan hasil konversi OTS menjadi BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah OTS menjadi BMP" %}}
