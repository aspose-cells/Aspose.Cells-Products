...
{{% blocks/products/pf/agp/content h2="Save ODS to PPTX in C#" %}}

The following example demonstrates how to convert ODS to PPTX in C#.
...
{{% cells-convert title="Sample Code to Convert ODS to PPTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert ODS to PPTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert ODS files to PPTX programmatically? .NET developers can easily load & convert ODS to PPTX in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert ODS to PPTX" %}}
