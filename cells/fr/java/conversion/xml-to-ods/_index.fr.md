...
description: Aspose Exceller. Convertissez XML en ODS rapidement et facilement avec Aspose.Cells. Java XML en ODS. Java Enregistrez XML en ODS. Enregistrez XML sous ODS en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en ODS à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au ODS dans Java" %}}

L'exemple suivant montre comment convertir XML en ODS en Java.
...
{{% cells-convert title="Exemple de code pour convertir XML en ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XML en ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en ODS par programme ? Les développeurs Java peuvent facilement convertir XML en ODS en quelques lignes de code seulement.
