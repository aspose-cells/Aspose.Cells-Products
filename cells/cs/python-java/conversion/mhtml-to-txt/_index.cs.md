...
{{% blocks/products/pf/agp/content h2="Převeďte MHTML na TXT pomocí Python" %}}
...
Následující příklad ukazuje, jak převést MHTML na TXT v Python.
