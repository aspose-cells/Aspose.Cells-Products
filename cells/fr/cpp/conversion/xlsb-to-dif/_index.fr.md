---
title: C++ XLSB à DIF - Convertisseur en ligne XLSB à DIF
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde DIF. Format C++ XLSB à DIF. Enregistrez XLSB à DIF C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à DIF dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en DIF en C++.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en DIF via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en DIF par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en DIF en seulement quelques lignes de code.
...
1.  Convertissez XLSB en DIF en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de XLSB en DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir XLSB en DIF" %}}
