---
title: A XLSB-XPS-es számok egyesítése – a XLSB-es és a XPS-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-xlsb-to-xps/ 
description: Aspose Excel. C# Aspose.Cells. A XLSB és a XPS mentési formátum egyesítése. C# A XLSB és a XPS formátum kombinálása. Egyesítse a XLSB-XPS-et a C#-ben. XLSB Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A XLSB és a XPS egyesítése a C#-ben" %}}

A következő példa bemutatja a XLSB és a XPS egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLSB-es és a XPS-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a XPS fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a XLSB és XPS számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a XLSB és XPS közötti egyesítéshez a C#-ben" InputFormat="xlsb" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLSB és a XPS egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLSB-et a XPS-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB és XPS egyesítéséhez" %}}
