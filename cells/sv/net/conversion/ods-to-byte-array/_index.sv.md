...
weight: 7690
description: C# Exempelkod för konvertering från ODS till Byte Array. Använd den här koden för konvertering av Excel ODS till Byte Array inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array är till hjälp för databearbetning eller lagring. Du kan konvertera filen ODS till Byte Array samt en**Byte Array till ODS** dokument med C# språk. För att konvertera ODS till byte array kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Hur man konverterar ODS till Byte Array via C#" %}}
...
1.  Ladda indata ODS Fil med arbetsbok
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar ODS till byte array C# konvertering" offSpacer="" %}}
...
Ett Excel-kalkylbladsprogrammeringsbibliotek som kan bygga plattformsoberoende applikationer med förmågan att generera, modifiera, konvertera, rendera och skriva ut alla Excel-filer. .NET Excel API konverterar inte bara mellan kalkylarksformat, det kan också återge Excel-filer inklusive ODS som bilder, PDF, HTML, ODS och mer, vilket gör det till ett perfekt val för att utbyta dokument i branschstandard.
