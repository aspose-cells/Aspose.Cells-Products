---
title: Convertir TABDELIMITED en XLTM via Java 
url: /fr/java/conversion/tabdelimited-to-xltm/ 
description: Exemple de code de conversion Java pour le format TABDELIMITED en fichier XLTM. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers XLTM dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TABDELIMITED en XLTM via Java" h2="Conversion TABDELIMITED vers XLTM Java pour convertir une ou plusieurs pages en XLTM à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TABDELIMITED en XLTM en utilisant Java" %}}

 Afin de rendre TABDELIMITED en XLTM, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TABDELIMITED en XLTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier TABDELIMITED en XLTM en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier TABDELIMITED avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension XLTM et SaveFormat comme paramètres1. Vérifiez le chemin spécifié pour le fichier XLTM résultant
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED vers XLTM Java code source de conversion" offSpacer="" %}}

```cs
// charger le fichier TABDELIMITED dans une instance de Workbook
Workbook book = new Workbook("template.tabdelimited");
// enregistrer TABDELIMITED sous XLTM
