---
title:  Come faccio a disegnare o inserire la doppia freccia dritta in Excel utilizzando Python via java
weight: 10
description: Python via codice sorgente Java per disegnare o inserire doppia freccia dritta in Excel.
...
{{% blocks/products/pf/agp/content h2="Come inserire la doppia freccia dritta nel file Excel utilizzando Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire la doppia freccia dritta nel file Excel utilizzando Python via java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa le collezioni di forme[aggiungi metodo](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) per inserire una doppia freccia dritta nel foglio di lavoro selezionato.
...
{{% blocks/products/pf/agp/code-block title="Inserisci doppia freccia dritta - Python via java" offSpacer="" %}}
