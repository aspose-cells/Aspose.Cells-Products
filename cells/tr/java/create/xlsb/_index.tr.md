...
description: Aspose excel. Java XLSB Dosyası Oluştur. Oluştur XLSB Java. Java XLSB Oluşturan. Java'de XLSB oluşturun. Java'i kullanarak XLSB dosyasını oluşturun.
...
1.  Çalışma kitabını save() yöntemini kullanarak XLSB biçiminde kaydedin.
...
{{% blocks/products/pf/agp/content h2="XLSB dosyası oluşturmak için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
