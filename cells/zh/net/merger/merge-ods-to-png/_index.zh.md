...
url: /zh/net/merger/merge-ods-to-png/ 
...
以下示例演示如何将 ODS 合并到 Aspose.Cells for .NET 中的 PNG。
...
需要以编程方式将 ODS 合并到 PNG 吗？基本文档合并和连接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET库将ODS合并到PNG" %}}
