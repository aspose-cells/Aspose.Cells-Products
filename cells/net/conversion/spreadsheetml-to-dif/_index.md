...
1.  Pass output path with DIF extension as parameters
...
{{% blocks/products/pf/agp/code-block title="This sample code shows spreadsheetml to dif C# Conversion" offSpacer="" %}}

{{< gist "aspose-cells-gists" "88c9872508ec3150c552eb5155edf06e" "Convert-spreadsheetml-to-dif.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert SPREADSHEETML to DIF" sectionDescription="Check our live demos for [SPREADSHEETML to DIF conversion](https://products.aspose.app/cells/conversion/spreadsheetml-to-dif) with following benefits." >}}
