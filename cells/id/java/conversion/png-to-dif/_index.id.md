...
{{% blocks/products/pf/agp/content h2="Konversikan PNG ke DIF menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan PNG ke DIF di Java" %}}

Contoh berikut menunjukkan cara mengkonversi PNG menjadi DIF di Java.
...
Perlu mengkonversi file PNG ke DIF secara terprogram? Pengembang Java dapat dengan mudah mengkonversi PNG ke DIF hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi PNG menjadi DIF" %}}
{{% blocks/products/pf/agp/text %}}
