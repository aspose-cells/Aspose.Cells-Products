---
title:  แทรก GroupBox(การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 40
description: Python via .Net ซอร์สโค้ดเพื่อแทรก GroupBox(Form control) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก GroupBox(Form control) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}

 เพื่อที่จะแทรก GroupBox(Form control) ลงในไฟล์ Excel เราจะใช้
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ Shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_group_box/#int-int-int-int-int-int) เพื่อแทรก GroupBox (การควบคุมแบบฟอร์ม) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก GroupBox(การควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
