---
title: Konvertera XLTM till JPG via Java 
url: /sv/java/conversion/xltm-to-jpg/ 
description: Exempel på Java-konverteringskod för XLTM-format till JPG-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till JPG inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLTM till JPG med Java" %}}

 För att rendera XLTM till JPG kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLTM till JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLTM-fil till JPG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTM-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med JPG-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande JPG-filen
...
{{% blocks/products/pf/agp/code-block title="XLTM till JPG Java omvandlingskällkod" offSpacer="" %}}
