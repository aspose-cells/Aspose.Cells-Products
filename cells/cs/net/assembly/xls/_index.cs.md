...
{{< blocks/products/pf/i18n/upper-banner h1="Generování hromadného přehledu ve formátu XLS prostřednictvím C#" h2="Generujte zprávy ve formátu XLS pomocí zdroje dat a šablony." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak generovat sestavy založené na XLS pomocí C#" %}}
 ...
 Abychom mohli vytvářet sestavy XLS, použijeme
...
1. Instantiate WorkbookDesigner třídy1. Nastavte značku do libovolné buňky libovolného listu1. Nastavte zdroj dat pro objekt WorkbookDesigner1. Zavolejte metodu WorkbookDesigner.Process k naplnění šablony daty1. Uložte výsledek ve formátu XLS pomocí metody WorkbookDesigner.Worbook.Save
...
{{% blocks/products/pf/agp/code-block title="Vytvářejte zprávy XLS" offSpacer="" %}}
