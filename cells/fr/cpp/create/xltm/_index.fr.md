...
description: XLTM créateur. Créez des fichiers XLTM dans le code C++. Générez des fichiers MS Excel XLTM à l'aide de l'application C++.
---
...
{{% blocks/products/pf/agp/content h2="Comment créer XLTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers XLTM dans des applications de création de rapports en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
