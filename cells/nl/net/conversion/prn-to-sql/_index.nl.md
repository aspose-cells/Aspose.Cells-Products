...
description: Aspose Excel. Deze complete oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van PRN-bestanden naar SQL-formaat. Hierdoor kunnen PRN-gegevens naadloos worden opgeslagen in SQL-formaat met behulp van de bibliotheek, en dat alles via efficiënte en aanpasbare code.
...
{{% blocks/products/pf/agp/content h2="PRN converteren naar SQL met behulp van C#" %}}
...
Het volgende voorbeeld laat zien hoe u PRN naar SQL kunt converteren in C#.
...
{{% blocks/products/pf/agp/content h2="C# bibliotheek voor het converteren van PRN naar SQL" %}}
