---
title:  HTML を C# 経由で HTM にマージします
...
次の例は、HTML を C# の HTM にマージする方法を示しています。
...
{{% cells-merger title="HTMLをオンラインでHTMにマージする無料アプリ" InputFormat="html" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
