---
title:  Rechthoek invoegen in Excel via Java
weight: 50
...
{{< blocks/products/pf/i18n/upper-banner h1="Rechthoek invoegen in Excel via Java" h2="Voeg een rechthoek in met Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een rechthoek in een Excel-bestand kunt invoegen met behulp van Java" %}}

 Om rechthoek in Excel-bestand in te voegen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om rechthoek in te voegen in Excel-bestand via Java" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de[methode toevoegen](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addRectangle-int-int-int-int-int-int-)om rechthoek in het geselecteerde werkblad in te voegen
...
{{% blocks/products/pf/agp/code-block title="Rechthoek invoegen - Java" offSpacer="" %}}
