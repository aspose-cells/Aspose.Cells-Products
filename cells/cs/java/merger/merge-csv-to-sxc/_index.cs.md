---
title: Sloučit CSV až SXC - Sloučit CSV až SXC v Java
url: /cs/java/merger/merge-csv-to-sxc/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma CSV do formátu uložení SXC. Java Kombinujte formát CSV až SXC. Sloučit CSV až SXC v Java. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV až SXC v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit CSV až SXC v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení CSV do SXC. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru SXC. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí CSV do SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení CSV až SXC v Java" InputFormat="csv" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV do SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit CSV až SXC? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení CSV až SXC" %}}
