---
title: Insert TextBox into Excel via Java 
weight: 60
...
{{% blocks/products/pf/agp/content h2="How to Insert TextBox into Excel File Using Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert TextBox to Excel file via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addTextBox-int-int-int-int-int-int-) to insert TextBox in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert TextBox - Java" offSpacer="" %}}
