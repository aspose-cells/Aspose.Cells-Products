...
{{% blocks/products/pf/agp/content h2="وفر TSV في ET في C# عبر الإنترنت مجانًا" %}}
...
{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل TSV إلى ET عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل TSV إلى ET عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمطورين .NET تحميل وتحويل TSV إلى ET بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1.  قم بتحميل ملف TSV بنسخة المصنف
1.  قم بتحويل TSV إلى ET عن طريق استدعاء Workbook.Save method

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# مكتبة لتحويل TSV إلى ET" %}}
