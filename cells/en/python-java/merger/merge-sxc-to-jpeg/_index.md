...
url: /python-java/merger/merge-sxc-to-jpeg/ 
...
The following example demonstrates how to merge SXC to JPEG in Aspose.Cells for Python via Java.
...
Need to merge SXC to JPEG programmatically? A basic document merging and concatenating with [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs can be done with just few lines of code.
