---
title: Converteer FODS naar TIFF via Python
url: /nl/python-java/conversion/fods-to-tiff/
description: Voorbeeldcode voor conversie van fods naar tiff Python. Gebruik API voorbeeldcode voor batch-fods-bestanden naar tiff-conversie binnen de Python-toepassing.
---
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar TIFF te converteren met Python" %}}

 Om FODS naar TIFF te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om FODS naar TIFF te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen FODS-bestanden gemakkelijk laden en converteren naar TIFF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad FODS-bestand met een exemplaar van Workbook1. Roep de methode Workbook.Save aan1. Geef uitvoerpad door met TIFF-extensie als parameter1. Controleer het opgegeven pad voor het resulterende TIFF-bestand
...
{{% cells-convert title="Gratis app en voorbeeldcode om FODS naar TIFF te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="tiff" IsLandingPage="true" language="python" %}}
