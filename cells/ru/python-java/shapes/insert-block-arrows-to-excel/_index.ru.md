...
{{% blocks/products/pf/agp/content h2="Как вставить блок-стрелки в файл Excel, используя Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке блочных стрелок в файл Excel с использованием Python via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить блок-стрелки в выбранный рабочий лист
...
{{% blocks/products/pf/agp/code-block title="Вставьте стрелки блока - Python via Java" offSpacer="" %}}
