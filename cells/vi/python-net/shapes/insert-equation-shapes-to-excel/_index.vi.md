---
title:  Chèn các hình dạng phương trình vào Excel Python via .NET
weight: 360
description: Python via .NET mã nguồn để chèn Equation Shapes vào Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn các hình dạng phương trình vào Excel Python via .NET" h2="Chèn các đối tượng bằng API phía máy chủ mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn Hình Dạng Phương Trình Vào Tệp Excel Sử Dụng Python via .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn Equation Shapes vào file Excel qua Python" %}}
