---
title:  Estrai testo e immagini dal documento XLSX via Java
weight: 3260
description: Codice di esempio Java per estrarre testo e immagini dal file XLSX sull'ambiente runtime Java per applicazioni JSP/JSF e applicazioni desktop.
...
{{< blocks/products/pf/i18n/upper-banner h1="Analizza i formati XLSX in Java" h2="Analisi dei documenti XLSX nativa e ad alte prestazioni utilizzando le API Aspose.Cells for Java lato server, senza l\'uso di software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come analizzare il file XLSX utilizzando Java" %}}

 Per analizzare il file XLSX, utilizzeremo[Aspose.Cells for Java](https://products.aspose.com/cells/java) API che è una piattaforma di analisi API for Java ricca di funzionalità, potente e facile da usare. Puoi scaricare la versione più recente direttamente da[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) e installalo nel tuo progetto basato su Maven aggiungendo le seguenti configurazioni a pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per analizzare i file XLSX in Java" %}}
...
+ Carica il documento XLSX utilizzando la classe Workbook.
...
{{% blocks/products/pf/agp/code-block title="Analizza i file XLSX - Java" offSpacer="" %}}
