...
{{< blocks/products/pf/i18n/upper-banner h1="XLSB formátumok egyesítése itt: Java" h2="Natív XLSB-dokumentumok egyesítése szerveroldali Java API-kkal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB fájlok egyesítése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSB-fájlok egyesítésének lépései a következőben: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSB fájlok egyesítése – Java" offSpacer="" %}}

```cs
// Nyissa meg az első XLSB fájlt.
Workbook xlsbFile1 = new Workbook("chartsFileWithPath.xlsb");

// Határozza meg a második forráskönyvet.
// Nyissa meg a második XLSB fájlt.
