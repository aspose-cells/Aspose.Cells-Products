...
description: Aspose Excel. Python Aspose.Cells. Voeg XLS samen met het opslagformaat XLTM. Python Combineer het formaat XLS met XLTM. Voeg XLS samen met XLTM in Python. XLS Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met XLTM met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met XLTM in Python" %}}
...
{{% cells-merger title="Voorbeeldcode om XLS samen te voegen met XLTM in Python" InputFormat="xls" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLS samenvoegt met XLTM via Python" %}}
