---
title:  Masukkan gambar ke Excel menggunakan Python via .Net
weight: 200
description: Python via .Kode sumber bersih untuk menyisipkan gambar ke dalam Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan gambar ke Excel menggunakan Python via .Net" h2="Sisipkan gambar menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan penambahan koleksi gambar[metode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/)untuk menyisipkan gambar di lembar kerja yang dipilih.
