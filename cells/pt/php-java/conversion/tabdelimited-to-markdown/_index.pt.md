---
title: PHP TABDELIMITED para MARKDOWN - Conversor TABDELIMITED para MARKDOWN
...
{{% blocks/products/pf/agp/content h2="Como converter TABDELIMITED para MARKDOWN via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TABDELIMITED para MARKDOWN programaticamente? Desenvolvedores PHP podem facilmente carregar e converter arquivos TABDELIMITED para MARKDOWN com apenas algumas linhas de código.
...
1.  Converta TABDELIMITED para MARKDOWN chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de TABDELIMITED para MARKDOWN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED em MARKDOWN" %}}
