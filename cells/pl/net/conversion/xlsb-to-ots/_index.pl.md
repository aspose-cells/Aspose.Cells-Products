---
title: C# XLSB na OTS - XLSB na konwerter OTS
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLSB do formatu OTS, umożliwiając bezproblemowe zapisywanie danych XLSB w formacie OTS przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB do OTS w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSB na OTS w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLSB na OTS. Prześlij plik XLSB, a następnie po prostu zapisz go jako plik OTS. Zarówno do odczytu XLSB, jak i do zapisu OTS, możesz używać w pełni kwalifikowanych nazw plików. Wyjściowa treść i formatowanie OTS będą identyczne z oryginalnym dokumentem XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLSB na OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsb" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na OTS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSB na OTS? Programiści .NET mogą łatwo załadować i przekonwertować XLSB na OTS w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj XLSB na OTS wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLSB na OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XLSB na OTS" %}}
