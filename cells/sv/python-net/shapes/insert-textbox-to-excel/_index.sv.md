...
{{% blocks/products/pf/agp/content h2="Hur man infogar textruta i Excel-fil med Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga TextBox till Excel-fil med Python via .Net" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens tillägg[metod](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_text_box/#int-int-int-int-int-int) för att infoga en textruta i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga TextBox - Python via .Net" offSpacer="" %}}
