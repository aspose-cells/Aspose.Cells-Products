---
title: PHP HTM a HTML - Convertidor HTM a HTML
description: Aspose Excel. Convierta HTM a HTML rápida y fácilmente con Aspose.Cells. PHP HTM a HTML. PHP Guarde HTM en HTML. Guarde HTM como HTML usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a HTML mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a HTML mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a HTML en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a HTML llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de HTM a HTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir HTM a HTML" %}}
