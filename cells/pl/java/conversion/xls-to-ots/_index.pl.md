---
title: Java XLS do OTS - Online XLS do konwertera OTS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwersja XLS do formatu zapisu OTS. Java XLS do formatu OTS. Zapisz XLS do OTS Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do OTS w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na OTS w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na OTS. Prześlij swój plik XLS, a następnie po prostu zapisz go jako plik OTS. Zarówno do odczytu XLS, jak i zapisu OTS można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie OTS będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLS na OTS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="ots" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na OTS? Deweloperzy Java mogą łatwo przekonwertować XLS na OTS w zaledwie kilku wierszach kodu.
...
1.  Konwertuj XLS na OTS, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLS do OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java do konwersji biblioteki XLS na OTS" %}}
{{% blocks/products/pf/agp/text %}}
