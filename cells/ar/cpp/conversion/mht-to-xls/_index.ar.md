---
title: C++ MHT إلى XLS - محول MHT عبر الإنترنت إلى XLS
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل MHT إلى XLS saveformat. C++ MHT إلى تنسيق XLS. احفظ MHT في XLS C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT في XLS في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى XLS برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى XLS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLS باستدعاء طريقة Save ().
