---
title: Converter ODS para XML por meio do aplicativo C++ 
url: /pt/cpp/conversion/ods-to-xml/ 
description: Exemplo de código de conversão C++ para documento ODS para formato XML. Os programadores podem usar esse código-fonte para conversão em lote de ODS para XML em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem converter facilmente o arquivo ODS para XML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo ODS usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (XML).1. O arquivo XML será salvo no caminho especificado.1. Abra o arquivo XML em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de ODS para XML C++" offSpacer="" %}}
