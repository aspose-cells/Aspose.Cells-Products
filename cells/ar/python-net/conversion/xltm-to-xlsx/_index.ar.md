---
title: Python XLTM إلى XLSX - عبر الإنترنت من XLTM إلى XLSX
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل XLTM إلى XLSX saveformat. Python XLTM إلى تنسيق XLSX. وفر XLTM إلى XLSX Python.
...
{{% blocks/products/pf/agp/content h2="حوّل XLTM إلى XLSX في Python" %}}
...
{{% blocks/products/pf/agp/content h2="وفر XLTM إلى XLSX في Python عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل XLTM إلى XLSX في Python via NET.
...
تحتاج إلى تحويل XLTM ملفات إلى XLSX برمجيا؟ يمكن للمطورين Python تحميل وتحويل XLTM إلى XLSX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول XLTM إلى XLSX باستدعاء طريقة Workbook.save.
1.  احصل على نتيجة التحويل من XLTM إلى XLSX.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل XLTM إلى XLSX" %}}
