---
title: Sloučit CSV až XLTX - Sloučit CSV až XLTX v Java
url: /cs/java/merger/merge-csv-to-xltx/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma CSV do formátu uložení XLTX. Java Kombinujte formát CSV až XLTX. Sloučit CSV až XLTX v Java. CSV Sloučit.
...
Následující příklad ukazuje, jak sloučit CSV až XLTX v Aspose.Cells for Java.
...
{{% cells-merger title="Online zdarma ke sloučení CSV až XLTX v Java" InputFormat="csv" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV do XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit CSV až XLTX? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
