...
{{% blocks/products/pf/agp/content h2="Convertir FODS en TIFF en utilisant Python" %}}
...
L'exemple suivant montre comment convertir FODS en TIFF dans Python.
