...
description: Go via C++ example code to search words with pattern in XLS file on Go via C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
