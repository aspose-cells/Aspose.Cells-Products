---
title: Python 経由で MS Excel XLSB ファイルを作成
description: XLSB クリエイター。 Python コードで XLSB ファイルを作成します。 Python アプリケーションを使用して MS Excel XLSB ファイルを生成します。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python経由でXLSBファイルを作成" h2="Python API を使用してプログラムでネイティブかつ高性能の MS Excel XLSB スプレッドシートを作成します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python経由でXLSBを作成する方法" %}}
...
{{% blocks/products/pf/agp/code-block title="次のソース コードは、Python を使用して MS Excel XLSB ファイルを作成する方法を示しています。" offSpacer="" %}}
