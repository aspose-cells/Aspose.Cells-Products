---
title: إنشاء ملفات MS Excel XLS via Java
description: XLS مبتكر. إنشاء XLS ملفات في Java كود. قم بإنشاء ملفات MS Excel XLS باستخدام تطبيق ويب أو سطح مكتب يستند إلى Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء XLS ملف via Java" h2="إنشاء جداول بيانات MS Excel XLS أصلي وعالي الأداء برمجيًا باستخدام مكتبة Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء XLS via Java" %}}
