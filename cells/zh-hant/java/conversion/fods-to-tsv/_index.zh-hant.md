---
title: Java FODS 至 TSV - FODS 至 TSV 轉換器
description: Aspose Excel。此綜合解決方案為 Java 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 TSV 格式，從而能夠使用 Aspose.Cells 庫將 FODS 數據無縫保存為 0761533681533676136481 資料無縫代碼實現。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 TSV，其中 Java" h2="高速 Java 庫，用於將 FODS 轉換為 TSV。這是一個專業的軟體解決方案，可使用 Java 匯入和匯出 FODS、TSV 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 TSV，即 Java" %}}

以下範例示範如何在 Java 中將 FODS 轉換為 TSV。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 轉換為 TSV。對於 FODS 讀取和 TSV 寫入，您可以使用完全限定的檔案名稱。輸出 TSV 內容和格式將與原始 FODS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 FODS 轉換為 TSV 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為 TSV 和 via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要透過程式將 FODS 檔案轉換為 TSV 檔案嗎？ Java 開發人員只需幾行程式碼即可輕鬆將 FODS 轉換為 TSV。
...
1. 透過呼叫Workbook.save方法將FODS轉換為TSV。
1. 取得FODS到TSV的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="使用 Java 庫將 FODS 轉換為 TSV" %}}
{{% blocks/products/pf/agp/text %}}
