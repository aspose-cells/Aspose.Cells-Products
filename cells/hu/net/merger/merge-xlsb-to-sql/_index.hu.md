...
url: /hu/net/merger/merge-xlsb-to-sql/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLSB-et az SQL-lel a Aspose.Cells for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLSB-et az SQL-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB SQL-be olvasztásához" %}}
