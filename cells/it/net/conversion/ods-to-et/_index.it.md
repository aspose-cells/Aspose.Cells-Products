---
title: C# ODS a ET - ODS a ET Convertitore
description: Aspose Excel. Converti ODS in ET in modo rapido e semplice con Aspose.Cells. C# ODS in ET. C# Salva ODS su ET. Salva ODS come ET utilizzando C#.
...
{{% blocks/products/pf/agp/content h2="Salva ODS su ET in C#" %}}

L'esempio seguente mostra come convertire ODS in ET in C#.
...
{{% cells-convert title="Codice di esempio per convertire ODS in ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Come convertire ODS in ET tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file ODS in ET a livello di codice? Gli sviluppatori .NET possono caricare e convertire facilmente ODS in ET in poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria C# per convertire ODS in ET" %}}
