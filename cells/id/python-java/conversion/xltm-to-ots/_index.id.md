...
description: Aspose Unggul. Ubah XLTM menjadi OTS dengan cepat dan mudah dengan Aspose.Cells. Python XLTM menjadi OTS. Python Simpan XLTM ke OTS. Simpan XLTM sebagai OTS menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Simpan XLTM ke OTS di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLTM ke OTS di Python.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengkonversi XLTM ke OTS" %}}
