...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в EMF в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат EMF в формате C#.
...
Вам нужно программно преобразовать XML-файлы в EMF? Разработчики .NET могут легко загружать и конвертировать XML в EMF всего за несколько строк кода.
...
1.  Преобразовать XML в формат EMF, вызвав метод Workbook.Save.
