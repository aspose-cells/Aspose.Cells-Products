...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSM na OTS za pomocą Aspose.Cells. PHP XLSM na OTS. PHP Zapisz XLSM w OTS. Zapisz XLSM jako OTS przy użyciu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSM na OTS przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSM na OTS? Programiści PHP mogą łatwo załadować i przekonwertować XLSM na OTS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSM na OTS, wywołując metodę zapisu skoroszytu.
