---
title: Sloučit HTM s XLSM - Sloučit HTM s XLSM v C++
url: /cs/cpp/merger/merge-htm-to-xlsm/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma sloučit HTM do XLSM saveformat. C++ Zkombinujte HTM do formátu XLSM. Sloučit HTM na XLSM v C++. HTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM na XLSM v C++ online zdarma" %}}

Následující příklad ukazuje, jak sloučit HTM s XLSM v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení HTM do XLSM. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLSM. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí HTM do XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení HTM na XLSM v C++" InputFormat="htm" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM na XLSM přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit HTM na XLSM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení HTM s XLSM" %}}
