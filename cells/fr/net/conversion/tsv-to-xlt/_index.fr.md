---
title: Convertir TSV en XLT C#
description: Convertissez TSV en XLT en ligne gratuitement. Convertisseur en ligne gratuit TSV à XLT. C# TSV à XLT. TSV à XLT via C#.
keywords: Convert TSV, TSV Converter, TSV to PDF, TSV to Word, TSV to PPT, TSV to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TSV en XLT via C#" h2="Bibliothèque C# haute vitesse pour convertir TSV en XLT. Exportez des feuilles de calcul Excel au format XLT sur .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrez TSV à XLT dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir TSV en XLT en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir TSV en XLT. Téléchargez votre fichier TSV, puis enregistrez-le simplement en tant que fichier XLT. Pour la lecture TSV et l'écriture XLT, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie XLT seront identiques au document TSV d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir TSV en XLT en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir TSV en XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir TSV en XLT en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier TSV avec une instance de Workbook
1.  Convertir TSV en XLT en appelant la méthode Workbook.Save
