...
description: Aspose اكسل. قم بتحويل XLTX إلى ET بسرعة وسهولة باستخدام Aspose.Cells. Python XLTX إلى ET. Python حفظ XLTX إلى ET. احفظ XLTX كـ ET باستخدام Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTX إلى ET في Python" h2="مكتبة Python عالية السرعة لتحويل XLTX إلى ET. يعد هذا حلاً برمجيًا احترافيًا لاستيراد وتصدير XLTX وET والعديد من التنسيقات الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل XLTX إلى ET باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ XLTX إلى ET في Python" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLTX إلى ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="et" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل XLTX إلى ET" %}}
