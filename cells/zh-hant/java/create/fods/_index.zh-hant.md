---
title: 創建FODS - 在Java中創建FODS文件
description: Aspose Excel。 Java 創建 FODS 文件。創建FODS Java。Java FODS創建者。在Java中創建FODS。使用Java生成FODS文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建FODS" %}}
...
1. 使用 save() 方法將工作簿保存為 FODS 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 FODS 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建FODS文件" %}}
{{% blocks/products/pf/agp/text %}}
