...
Нужно программно конвертировать файлы PNG в SXC? Разработчики C++ могут легко преобразовать PNG в SXC всего за несколько строк кода.
...
1.  Преобразуйте PNG в SXC, вызвав метод Save().
