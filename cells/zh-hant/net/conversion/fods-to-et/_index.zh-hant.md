...
{{% cells-convert title="將 FODS 轉換為 ET 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 ET" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 檔案轉換為 ET？ .NET 開發人員只需幾行程式碼即可輕鬆載入 FODS 並將其轉換為 ET。
