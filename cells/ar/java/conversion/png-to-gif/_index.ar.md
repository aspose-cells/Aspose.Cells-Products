---
title: Java PNG إلى GIF - عبر الإنترنت من PNG إلى GIF
description: Aspose إكسل. Java Aspose.Cells. Java Aspose Cells. مجاني على الإنترنت Java تحويل PNG إلى GIF saveformat. Java PNG إلى تنسيق GIF. وفر PNG إلى GIF Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل PNG إلى GIF في Java" h2="مكتبة Java عالية السرعة لتحويل PNG إلى GIF. هذا حل برمجي احترافي لاستيراد وتصدير PNG و GIF والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="وفر PNG إلى GIF في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل PNG إلى GIF في Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل PNG إلى GIF. قم بتحميل ملف PNG الخاص بك ، ثم احفظه كملف GIF. لكل من قراءة PNG وكتابة GIF ، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون المحتوى والتنسيق الناتج GIF متطابقين مع المستند PNG الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل PNG إلى GIF عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="gif" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل PNG إلى GIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

تحتاج إلى تحويل PNG ملفات إلى GIF برمجيا؟ يمكن للمطورين Java تحويل PNG إلى GIF بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول PNG إلى GIF باستدعاء طريقة Workbook.save.
