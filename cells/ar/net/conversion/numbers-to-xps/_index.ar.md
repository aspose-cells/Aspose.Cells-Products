---
title: تحويل C# الى XPS - تحويل الارقام الى XPS
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل الأرقام إلى تنسيق XPS، مما يتيح حفظ بيانات الأرقام بسلاسة بتنسيق XPS باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في XPS في C#" %}}

يوضح المثال التالي كيفية تحويل الأرقام إلى XPS في C#.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل NUMBERS إلى XPS. قم بتحميل ملف NUMBERS الخاص بك، ثم احفظه ببساطة كملف XPS. لكل من قراءة الأرقام وكتابة XPS، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق الإخراج XPS مطابقًا لمستند NUMBERS الأصلي.
...
هل تحتاج إلى تحويل ملفات NUMBERS إلى XPS برمجيًا؟ يمكن لمطوري .NET تحميل الأرقام وتحويلها بسهولة إلى XPS في بضعة أسطر من التعليمات البرمجية.
