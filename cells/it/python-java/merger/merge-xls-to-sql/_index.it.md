...
url: /it/python-java/merger/merge-xls-to-sql/ 
...
L'esempio seguente mostra come unire XLS a SQL in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Hai bisogno di unire XLS a SQL a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Le API possono essere eseguite con poche righe di codice.
