---
title: Combine SPREADSHEETML to SQL - Combine SPREADSHEETML to SQL en C++
url: /es/cpp/merger/merge-spreadsheetml-to-sql/ 
description: AsposeExcel. C++ Aspose.Cells. Combinación en línea gratuita de SPREADSHEETML a SQL saveformat. C++ Combine SPREADSHEETML con formato SQL. Combina SPREADSHEETML con SQL en C++. Combina SPREADSHEETML.
...
{{% blocks/products/pf/agp/content h2="Combine SPREADSHEETML a SQL en C++ en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar SPREADSHEETML con SQL en Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar SPREADSHEETML con SQL. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo SQL. Si desarrolla código en C++, esto será más simple de lo que parece. Consulte el ejemplo C++ que fusiona SPREADSHEETML con SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar SPREADSHEETML a SQL en C++" InputFormat="xml" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar SPREADSHEETML a SQL a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar SPREADSHEETML con SQL mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para fusionar SPREADSHEETML a SQL" %}}
