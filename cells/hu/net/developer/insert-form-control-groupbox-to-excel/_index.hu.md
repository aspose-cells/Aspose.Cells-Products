...
{{% blocks/products/pf/agp/content h2="A GroupBox beszúrása Excel fájlba a C# használatával" %}}

 A GroupBox excel fájlba történő beszúrásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A GroupBox Excel-fájlba való beszúrásának lépései a C#-es számon keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="GroupBox beszúrása - C#" offSpacer="" %}}
