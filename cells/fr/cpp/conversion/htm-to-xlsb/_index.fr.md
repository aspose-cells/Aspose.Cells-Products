---
title: C++ HTM à XLSB - Convertisseur HTM à XLSB
description: Aspose Exceller. Convertissez HTM en XLSB rapidement et facilement avec Aspose.Cells. C++ HTM en XLSB. C++ Enregistrez HTM en XLSB. Enregistrez HTM sous XLSB en utilisant C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au XLSB dans C++" %}}

L'exemple suivant montre comment convertir HTM en XLSB en C++.
...
{{% cells-convert title="Exemple de code pour convertir HTM en XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlsb" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en XLSB via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en XLSB par programme ? Les développeurs C++ peuvent facilement convertir HTM en XLSB en quelques lignes de code seulement.
...
1.  Convertissez HTM en XLSB en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de HTM en XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir HTM en XLSB" %}}
