---
title: Chroń i blokuj dokument XLSM za pomocą .NET 
weight: 7530
url: /pl/net/protect/xlsm/ 
description: C# kod źródłowy do blokowania pliku XLSM przy użyciu hasła na platformach .NET Framework, .NET Core, Mono lub Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Szyfruj pliki XLSM przez C#" h2="Zabezpiecz hasłem arkusze kalkulacyjne programu Excel, w tym format XLSM, korzystając z .NETBiblioteki." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Chroń XLSM przez C#" %}}
...
1. Utwórz wystąpienie klasy Workbook ze ścieżką do pliku XLSM1. Uzyskaj domyślny lub dowolny arkusz roboczy, aby dodać ochronę1. Chroń arkusz za pomocą metody Arkusz.Chroń1. Chroń skoroszyt za pomocą metody Workbook.Protect1. Zapisz wynik w formacie XLSM
