---
title: C# TXT hingga XPS - TXT hingga XPS Konverter
description: Aspose Unggul. Ubah TXT menjadi XPS dengan cepat dan mudah dengan Aspose.Cells. C# TXT menjadi XPS. C# Simpan TXT menjadi XPS. Simpan TXT sebagai 07611134 81 menggunakan C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah TXT menjadi XPS di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi TXT menjadi XPS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor TXT, XPS, dan banyak format lainnya pada Platform .NET Framework, .NET Core, atau Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan TXT hingga XPS di C#" %}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah TXT menjadi XPS melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file TXT ke XPS secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi TXT menjadi XPS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengubah TXT menjadi XPS" %}}
