...
url: /cs/python-java/merger/merge-spreadsheetml-to-image/ 
...
Následující příklad ukazuje, jak sloučit SPREADSHEETML do IMAGE v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit SPREADSHEETML s IMAGE? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
