---
title:  Dokument TXT suchen, ohne es über C++ zu öffnen
weight: 5090
description: C++ Beispielcode zum Suchen von Wörtern mit einem Muster in der Datei TXT auf der Laufzeitumgebung C++ für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
...
{{% blocks/products/pf/agp/content h2="So suchen Sie die Datei TXT mithilfe der Nummer C++" %}}

 Um die Datei TXT zu suchen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Suchen von Dateien mit der Kennung TXT in C++" %}}
...
+ Datei TXT mithilfe der Workbook-Klasse laden.
...
{{% blocks/products/pf/agp/code-block title="Suche nach Dateien mit der Nummer TXT - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online TXT Live-Demos suchen" sectionDescription=" Durchsuchen Sie jetzt Texte, Wörter und Phrasen in den Dokumenten mit der Nummer TXT, indem Sie unsere Website besuchen.[Live-Demos-Website](https://products.aspose.app/cells/search)Die Live-Demo bietet folgende Vorteile" >}}
...
Eine Datei mit der Endung .TXT ist ein Textdokument, das reinen Text in Zeilenform enthält. Absätze werden durch Zeilenumbrüche gekennzeichnet und dienen der besseren Strukturierung des Dateiinhalts. Ein solches Dokument lässt sich mit jedem Texteditor oder jeder Textverarbeitungsanwendung auf verschiedenen Betriebssystemen öffnen. Der gesamte Text in dieser Datei ist lesbar und wird als Zeichenfolge dargestellt.
