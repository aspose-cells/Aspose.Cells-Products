---
title: Fusionner PRN vers POWERPOINT - Combiner PRN vers POWERPOINT en Java
url: /fr/java/merger/merge-prn-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. Fusion gratuite en ligne PRN au format de sauvegarde POWERPOINT. Java Combinez le format PRN au format POWERPOINT. Fusionner PRN à POWERPOINT en Java. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN vers POWERPOINT en utilisant Java" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à POWERPOINT en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN vers POWERPOINT dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN vers POWERPOINT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier POWERPOINT. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne PRN à POWERPOINT.
...
{{% blocks/products/pf/agp/content h2="Comment fusionner PRN vers POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner PRN vers POWERPOINT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner PRN vers POWERPOINT" %}}
