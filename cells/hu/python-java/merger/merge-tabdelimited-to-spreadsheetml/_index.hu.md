...
url: /hu/python-java/merger/merge-tabdelimited-to-spreadsheetml/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a TABDELIMITED fájlt a SPREADSHEETML-lel a Aspose.Cells for Python via Java számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a TABDELIMITED-t a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
