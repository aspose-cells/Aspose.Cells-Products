...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert ScrollBar to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addscrollbar) to insert a ScrollBar in the selected worksheet
