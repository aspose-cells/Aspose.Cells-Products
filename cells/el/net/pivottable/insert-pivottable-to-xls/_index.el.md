...
weight: 7690
description: C# Δείγμα κώδικα για την προσθήκη Συγκεντρωτικού Πίνακα στο XLS χρησιμοποιώντας τη Βιβλιοθήκη .NET. Χρησιμοποιήστε αυτόν τον κωδικό για την εισαγωγή του αρχείου Συγκεντρωτικού Πίνακα στο XLS σε VB.NET, Asp.NET ή σε οποιαδήποτε εφαρμογή που βασίζεται στο .NET.
