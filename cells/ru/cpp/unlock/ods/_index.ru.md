---
title:  Разблокируйте документ ODS через C++.
weight: 1190
description: C++ пример кода для разблокировки защищенного паролем файла ODS в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
...
1.  Создать экземпляр класса рабочей книги с путем к защищенному файлу ODS.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API можно использовать для создания, редактирования, преобразования и преобразования Microsoft форматов Excel в различные форматы. Более того, его можно использовать для составления комплексных диаграмм, масштабируемых отчетов и надежных расчетов в программных приложениях. Aspose.Cells — это автономный номер API, который не требует какого-либо программного обеспечения, такого как Microsoft или OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для разблокировки ODS" sectionDescription=" Посмотрите наши живые демонстрации, чтобы[разблокировать ODS файлы](https://products.aspose.app/cells/unlock/ods) со следующими преимуществами." >}}
