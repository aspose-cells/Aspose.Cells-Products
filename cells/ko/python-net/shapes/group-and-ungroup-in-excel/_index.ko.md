...
{{% blocks/products/pf/agp/feature-section-col title="Python을 통해 Excel 파일에서 도형을 그룹화 및 그룹 해제하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="도형 그룹화 및 그룹 해제 - Python via .NET" offSpacer="" %}}
