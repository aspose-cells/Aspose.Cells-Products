---
title: สร้างไฟล์ MS Excel XLTM ผ่าน Java 
url: /th/java/create-xltm/ 
description: Java โค้ดตัวอย่างสำหรับสร้างเอกสาร XLTM ใช้รหัสนี้เพื่อสร้างไฟล์ MS Excel XLTM ภายในเดสก์ท็อปหรือแอปพลิเคชันบนเว็บที่ใช้ Java
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="สร้างเอกสาร XLTM ผ่าน Java" h2="การสร้างสเปรดชีต MS Excel XLTM ดั้งเดิมและประสิทธิภาพสูงโดยทางโปรแกรมโดยใช้ไลบรารี Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="วิธีสร้าง XLTM ผ่าน Java" %}}
...
1. สร้างอินสแตนซ์ของ [คลาสเวิร์กบุค](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook).1. เข้าถึงแผ่นงานที่เกี่ยวข้องโดยใช้เมธอด getWorksheets.get()1. เลือกเซลล์ที่เกี่ยวข้อง ป้อนค่าลงในเซลล์ที่ต้องการโดยใช้ชื่อเซลล์ เช่น A1, B3 เป็นต้น1. บันทึกเวิร์กบุ๊กเป็นรูปแบบ XLTM โดยใช้วิธีบันทึก ()
...
<!-- aboutfile Starts -->
 ...
 ไลบรารีการเขียนโปรแกรมสเปรดชีต Excel ที่สามารถสร้างแอปพลิเคชันข้ามแพลตฟอร์มด้วยความสามารถในการสร้าง แก้ไข แปลง แสดงผล และพิมพ์ไฟล์ MS Excel XLTM Java Excel API ไม่เพียงแต่แปลงระหว่างรูปแบบสเปรดชีตเท่านั้น แต่ยังสามารถแสดงไฟล์ Excel เป็นรูปภาพ, PDF, HTML, ODS และอื่นๆ ได้ จึงทำให้เป็นตัวเลือกที่สมบูรณ์แบบในการแลกเปลี่ยนเอกสารในรูปแบบมาตรฐานอุตสาหกรรม
