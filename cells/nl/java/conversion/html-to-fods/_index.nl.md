...
{{% blocks/products/pf/agp/content h2="Sla HTML op in FODS in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar FODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar FODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar FODS? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar FODS met slechts een paar regels code.
