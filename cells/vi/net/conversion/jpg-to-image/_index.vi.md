---
title: C# JPG sang HÌNH ẢNH - Chuyển đổi JPG sang HÌNH ẢNH
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển C# một phương pháp tích hợp đầy đủ để chuyển đổi định dạng JPG sang định dạng IMAGE, cho phép lưu dữ liệu JPG liền mạch vào định dạng IMAGE bằng thư viện Aspose.Cells, tất cả thông qua mã C# hiệu quả và có thể tùy chỉnh.
...
{{% blocks/products/pf/agp/content h2="Lưu ảnh JPG vào thư mục IMAGE trong C#" %}}

Ví dụ sau đây minh họa cách chuyển đổi JPG sang IMAGE trong C#.
...
{{% cells-convert title="Ví dụ mã lệnh chuyển đổi JPG sang IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển JPG sang HÌNH ẢNH qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tệp JPG thành HÌNH ẢNH theo chương trình? .NET nhà phát triển có thể dễ dàng tải và chuyển đổi JPG sang HÌNH ẢNH chỉ bằng vài dòng mã.
...
1.  Chuyển đổi định dạng JPG sang IMAGE bằng cách gọi phương thức Workbook.Save.
1.  Nhận kết quả chuyển đổi JPG sang HÌNH ẢNH.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C# để chuyển đổi JPG sang IMAGE" %}}
