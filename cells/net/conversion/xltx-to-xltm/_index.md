...
description: Sample code for xltx to xltm C# conversion. Use API example code for batch xltx files to xltm conversion within VB.NET, Asp.NET or any .NET based application.
---
