---
title: Python XLSX ke FODS - Online XLSX ke FODS Konverter
description: Aspose Unggul. Python Aspose.Cells. Python Aspose Cells. Gratis Online Python Ubah XLSX menjadi FODS saveformat. Python XLSX ke format FODS. Simpan XLSX ke FODS Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi FODS di Python" h2="Pustaka Python berkecepatan tinggi untuk mengonversi XLSX menjadi FODS. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Ubah XLSX menjadi FODS di Python" %}}

 Bagaimana cara mengubah XLSX menjadi FODS? Dengan perpustakaan Aspose.Cells for Python melalui NET, Anda dapat dengan mudah mengubah XLSX menjadi FODS secara terprogram dengan beberapa baris kode.[Aspose.Cells for Python via NET](https://pypi.org/project/aspose-cells-python/)mampu membangun aplikasi lintas platform dengan kemampuan untuk menghasilkan, memodifikasi, mengonversi, merender, dan mencetak semua file Excel. Python Excel API tidak hanya mengkonversi antara format spreadsheet, tetapi juga dapat membuat file Excel sebagai gambar, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT dan lainnya, sehingga menjadikannya pilihan yang sempurna untuk bertukar dokumen dalam industri -standar format.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Simpan XLSX ke FODS di Python Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi FODS di Python via NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi XLSX menjadi FODS. Unggah file XLSX Anda, lalu simpan sebagai file FODS. Untuk membaca XLSX dan menulis FODS Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format keluaran FODS akan identik dengan dokumen asli XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX menjadi FODS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="fods" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah XLSX menjadi FODS" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX menjadi FODS secara terprogram? Pengembang Python dapat dengan mudah memuat & mengonversi XLSX menjadi FODS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengonversi XLSX menjadi FODS" %}}
