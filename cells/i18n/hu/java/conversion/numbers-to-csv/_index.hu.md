---
title: "NUMBERS konvertálása CSV-vé a következőn keresztül: Java "
url: /hu/java/conversion/numbers-to-csv/ 
description: Minta Java konverziós kód NUMBERS formátumhoz CSV-fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására CSV-fájlba bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="NUMBERS konvertálása CSV-vé a következőn keresztül: Java" h2="NUMBERS CSV Java konvertálása egyetlen vagy több oldal CSV formátumba konvertálásához a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="NUMBERS konvertálása CSV-vé a következővel: Java" %}}

 A NUMBERS CSV formátumban való megjelenítéséhez ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a NUMBERS szám CSV-vé konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak NUMBERS fájlt CSV-formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. NUMBERS fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat CSV kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott CSV-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="NUMBERS CSV-be Java Konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a NUMBERS fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.numbers");
// NUMBERS mentése CSV-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS CSV konvertálás élő bemutatók" sectionDescription="[NUMBERS konvertálása CSV formátumba](https://products.aspose.app/cells/conversion/numbers-to-csv) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel NUMBERS fájlját, amely azonnal CSV formátumba konvertálódik." >}}
