---
title: PRN'yi MD'ye Birleştir - C#'de PRN'yi MD'ye birleştirin
url: /tr/net/merger/merge-prn-to-md/ 
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi PRN'yi MD kaydetme biçimine birleştirme. C# PRN'yi MD biçimiyle birleştirin. C#'de PRN'yi MD ile birleştirin. PRN Birleştirin.
...
{{% blocks/products/pf/agp/content h2="C#\'de PRN ile MD\'yi Çevrimiçi Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin MD ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi MD'ye birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından MD dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. PRN'yi MD ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de PRN\'yi MD ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="prn" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C# aracılığıyla PRN\'yi MD ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 Programlı olarak PRN'yi MD ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
