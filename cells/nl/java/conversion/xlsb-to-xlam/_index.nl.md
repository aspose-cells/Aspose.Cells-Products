...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in XLAM in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar XLAM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar XLAM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar XLAM? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar XLAM met slechts een paar regels code.
