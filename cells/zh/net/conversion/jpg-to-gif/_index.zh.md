---
title: C# JPG 到 GIF - JPG 到 GIF 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 JPG 转换为 GIF。 C# JPG 到 GIF。 C# 将 JPG 保存到 GIF。 使用 C# 将 JPG 保存为 GIF。
...
{{% blocks/products/pf/agp/content h2="将JPG保存到C#中的GIF" %}}
...
{{% cells-convert title="将 JPG 转换为 GIF 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="gif" IsLandingPage="true" %}}
