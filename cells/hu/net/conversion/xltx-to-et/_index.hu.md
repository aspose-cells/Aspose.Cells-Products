---
title: C# XLTX ET - XLTX ET Converter
description: Aspose Excel. A XLTX-es számot gyorsan és egyszerűen konvertálja ET-re a Aspose.Cells-es számmal. C# XLTX ET-re. C# Takarítson meg XLTX-et az ET-nek. Mentse el a XLTX számot ET néven a C# használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTX számot ET-nek a C# számon" %}}

A következő példa bemutatja, hogyan lehet átalakítani a XLTX-et ET-re a C#-ben.
...
{{% cells-convert title="Mintakód a XLTX ET-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTX konvertálása ET-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia a XLTX fájlokat ET-re? A .NET fejlesztők egyszerűen betölthetik és átalakíthatják a XLTX-et ET-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX ET átalakításához" %}}
