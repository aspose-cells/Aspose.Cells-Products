...
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do ETT saveformat. Java Kombinujte formát MHT s ETT. Sloučit MHT do ETT v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do ETT v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT do ETT v Java" InputFormat="mht" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
