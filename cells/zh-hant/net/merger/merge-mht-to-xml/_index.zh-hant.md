...
以下範例示範如何將 Aspose.Cells for .NET 中的 MHT 合併為 XML。
...
{{% cells-merger title="將 MHT 合併到 C# 中的 XML 的範例程式碼" InputFormat="mht" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 MHT 合併為 XML" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 MHT 合併到 XML？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 將 MHT 合併到 XML 的函式庫" %}}
