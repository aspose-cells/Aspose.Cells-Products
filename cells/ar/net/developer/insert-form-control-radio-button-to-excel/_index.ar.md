...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج RadioButton (التحكم في النموذج) في ملف Excel عبر C#" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addradiobutton) لإدراج RadioButton (عنصر تحكم النموذج) في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل RadioButton (التحكم في النموذج) - C#" offSpacer="" %}}
