---
title:  Sloučit TXT až JSON via Java
...
Následující příklad ukazuje, jak sloučit TXT až JSON v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až JSON online" InputFormat="txt" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
