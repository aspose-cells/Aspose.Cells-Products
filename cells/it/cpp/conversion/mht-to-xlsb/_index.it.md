...
Hai bisogno di convertire i file MHT in XLSB a livello di programmazione? Gli sviluppatori C++ possono facilmente convertire MHT in XLSB in poche righe di codice.
...
1.  Converti MHT in XLSB chiamando il metodo Save().
