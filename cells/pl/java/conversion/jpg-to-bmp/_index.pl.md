---
title: Java JPG do BMP - JPG do BMP Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji JPG do formatu BMP, umożliwiając bezproblemowe zapisywanie danych JPG do formatu BMP za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz JPG do BMP w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować JPG na BMP w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować plik JPG na BMP. Prześlij plik JPG, a następnie po prostu zapisz go jako plik BMP. Zarówno do odczytu JPG, jak i do zapisu BMP, możesz używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego BMP będą identyczne z oryginalnym dokumentem JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod konwersji JPG na BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="bmp" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować JPG na BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki JPG do formatu BMP? Programiści Java mogą łatwo przekonwertować pliki JPG do formatu BMP za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

1.  Zainstaluj 'Aspose.Cells for Java'.
1.  Dodaj odniesienie do biblioteki (zaimportuj bibliotekę) do swojego projektu Java.
1.  Załaduj plik JPG zawierający wystąpienie klasy Workbook.
1.  Konwertuj JPG na BMP, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji JPG na BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji JPG na BMP" %}}
{{% blocks/products/pf/agp/text %}}
