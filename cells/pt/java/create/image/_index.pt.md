---
title: Criar IMAGEM - Criar arquivo de IMAGEM em Java
description: Aspose Excel. Java Criar arquivo de IMAGEM. Criar IMAGEM Java. Java Criador de IMAGENS. Crie IMAGE em Java. Gere o arquivo IMAGE usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo de IMAGEM em Java" h2="Biblioteca Java de alta velocidade para criar arquivo IMAGE. Esta é uma solução de software profissional para importar e exportar XLSX, PDF e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como criar IMAGEM em Java" %}}

{{% blocks/products/pf/agp/text %}}

 É fácil para os desenvolvedores criar, carregar, modificar e converter arquivos IMAGE executando diferentes aplicativos de relatórios para processamento de dados em apenas algumas linhas de código.
...
1.  Salve a pasta de trabalho no formato IMAGE usando o método save().

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo IMAGE em Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para criar arquivo de IMAGEM" %}}
{{% blocks/products/pf/agp/text %}}
