...
url: /hu/python-java/merger/merge-xml-to-ots/ 
...
következő példa bemutatja, hogyan egyesítheti az XML-t OTS-szel a Aspose.Cells for Python via Java számon.
...
Programozottan egyesítenie kell az XML-t az OTS-hez? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
