---
title: PHP HTM-JSON - HTM-JSON konvertáló
description: Aspose Excel. A HTM-et gyorsan és egyszerűen konvertálja JSON-re a Aspose.Cells-gyel. PHP HTM-et JSON-re. PHP HTM mentése JSON-re. HTM mentése JSON-re PHP használatával.
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet HTM-et konvertálni JSON-re PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A HTM-fájlokat programozottan JSON-re kell konvertálni? A PHP fejlesztői könnyedén betölthetik és konvertálhatják a HTM-et JSON-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a HTM-et JSON-re a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a HTM konverziós eredményét JSON-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a HTM konvertálásához JSON-re" %}}
