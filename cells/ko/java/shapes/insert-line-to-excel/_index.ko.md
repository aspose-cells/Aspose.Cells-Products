---
title:  Excel via Java에 라인 삽입
weight: 30
description: Microsoft이나 Open Office, Adobe PDF 등의 소프트웨어 없이 Aspose.Cells' Java API을 사용하여 개체를 삽입합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Excel via Java에 라인 삽입" h2="Microsoft이나 Open Office, Adobe PDF 등의 소프트웨어 없이 Aspose.Cells\' API을 사용하여 줄을 삽입합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 Excel 파일에 라인을 삽입하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Excel 파일 via Java에 라인을 삽입하는 단계" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 + 사용[메소드 추가](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) 선택한 워크시트에 선을 삽입하려면
...
{{% blocks/products/pf/agp/code-block title="라인 삽입 - Java" offSpacer="" %}}
