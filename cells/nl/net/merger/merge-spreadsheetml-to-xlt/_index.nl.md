...
Het volgende voorbeeld laat zien hoe SPREADSHEETML kan worden samengevoegd tot XLT in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u SPREADSHEETML programmatisch samenvoegen met XLT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om SPREADSHEETML samen te voegen tot XLT" %}}
