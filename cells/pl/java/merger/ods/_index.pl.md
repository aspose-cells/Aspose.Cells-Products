---
title:  Połącz ODS Pliki via Java
weight: 6270
description: Java przykładowy kod do łączenia dokumentów ODS w środowisku wykonawczym Java dla aplikacji JSP/JSF i aplikacji komputerowych.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Połącz formaty ODS w Java" h2="Natywne połączenie dokumentów ODS przy użyciu interfejsów API Java po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak scalić pliki ODS za pomocą Java" %}}
 ...
 Aby scalić plik ODS, użyjemy[Aspose.Cells for Java](https://products.aspose.com/cells/java) API, która jest bogatą w funkcje, wydajną i łatwą w obsłudze platformą łączącą API for Java. Możesz pobrać jego najnowszą wersję bezpośrednio z[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) i zainstaluj go w swoim projekcie opartym na Maven, dodając następujące konfiguracje do pliku pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki łączenia plików ODS w Java" %}}
...
+ zapisz połączony plik ODS w określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="Połącz pliki ODS - Java" offSpacer="" %}}
