---
title: Converter XLSB para XLTX via Java 
weight: 3970
url: /pt/java/conversion/xlsb-to-xltx/ 
description: Exemplo de código de conversão Java para formato XLSB para arquivo XLTX. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para XLTX em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSB para XLTX via Java" h2="Conversão de XLSB para XLTX Java para converter uma ou várias páginas em XLTX usando a biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter XLSB para XLTX usando Java" %}}

 Para renderizar XLSB para XLTX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter XLSB para XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem facilmente converter arquivos XLSB para XLTX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo XLSB com uma instância da classe Workbook1. Chame o método Workbook.save1. Passe o caminho de saída com a extensão XLTX e SaveFormat como parâmetros1. Verifique o caminho especificado para o arquivo XLTX resultante
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLSB para XLTX Java" offSpacer="" %}}

```cs
// carregar o arquivo XLSB em uma instância do Workbook
Workbook book = new Workbook("template.xlsb");
// salve XLSB como XLTX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de XLSB para XLTX" sectionDescription="[Converter XLSB para XLTX](https://products.aspose.app/cells/conversion/xlsb-to-xltx) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo XLSB, ele será convertido instantaneamente para XLTX." >}}
