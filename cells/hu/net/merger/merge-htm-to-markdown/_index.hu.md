---
title: HTM egyesítése a MARKDOWN számmal – HTM összevonása MARKDOWN számmal a C#-ben
url: /hu/net/merger/merge-htm-to-markdown/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés a HTM-mel a MARKDOWN mentési formátumba. C# HTM kombinálása MARKDOWN formátummal. HTM egyesítése a MARKDOWN-es számmal a C#-ben. HTM-egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a HTM-et a MARKDOWN-es számmal a C#-ben online" %}}

A következő példa bemutatja, hogyan egyesítheti a HTM-et a MARKDOWN-es számmal a Aspose.Cells for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTM és a MARKDOWN egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a MARKDOWN fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTM-et a MARKDOWN-gyel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTM összevonása a MARKDOWN-es számmal a C#-ben" InputFormat="htm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTM egyesítése a MARKDOWN-es számmal a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a HTM-et a MARKDOWN-es számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és a MARKDOWN egyesítéséhez" %}}
