...
url: /tr/python-java/merger/merge-jpeg-to-spreadsheetml/ 
...
Aşağıdaki örnek, JPEG'in SPREADSHEETML ile Aspose.Cells for Python via Java'de nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 JPEG'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
