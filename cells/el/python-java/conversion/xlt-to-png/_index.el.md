...
{{% blocks/products/pf/agp/content h2="Μετατροπή XLT σε PNG χρησιμοποιώντας Python" %}}
...
Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το XLT σε PNG στο Python.
