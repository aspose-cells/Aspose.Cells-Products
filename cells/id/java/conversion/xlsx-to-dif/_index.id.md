---
title: Java XLSX ke DIF - Online XLSX ke DIF Konverter
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Gratis Online Java Ubah XLSX menjadi DIF saveformat. Java XLSX ke format DIF. Simpan XLSX ke DIF Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi DIF di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi XLSX menjadi DIF. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, DIF, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke DIF di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi DIF di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi XLSX menjadi DIF. Unggah file XLSX Anda, lalu simpan sebagai file DIF. Untuk membaca XLSX dan menulis DIF Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format keluaran DIF akan identik dengan dokumen asli XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX menjadi DIF Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="dif" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah XLSX menjadi DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX menjadi DIF secara terprogram? Pengembang Java dapat dengan mudah mengonversi XLSX menjadi DIF hanya dalam beberapa baris kode.
...
1.  Ubah XLSX menjadi DIF dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari XLSX menjadi DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi XLSX menjadi DIF" %}}
{{% blocks/products/pf/agp/text %}}
