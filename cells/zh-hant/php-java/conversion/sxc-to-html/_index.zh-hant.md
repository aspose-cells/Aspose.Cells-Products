---
title: PHP SXC 至 HTML - SXC 至 HTML 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 SXC 轉換為 HTML。PHP SXC 轉換為 HTML。PHP 將 SXC 儲存為 07617481。PHP 將 SXC 儲存為 0761741818317481761741818761748181761748183。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 PHP 中將 SXC 轉換為 HTML" h2="用於將 SXC 轉換為 HTML 的高速 PHP 函式庫。這是使用 PHP 匯入和匯出 SXC、HTML 和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何將 SXC 轉換為 HTML？使用 Aspose.Cells for PHP via Java 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 SXC 轉換為 HTML。[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 PHP Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 SXC 儲存為 PHP 中的 HTML" %}}
...
{{% cells-convert title="將 SXC 轉換為 HTML 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="html" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 PHP 將 SXC 轉換為 HTML" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 SXC 檔案轉換為 HTML 嗎？ PHP 開發人員只需幾行程式碼即可輕鬆載入 SXC 並將其轉換為 HTML。
...
1. 使用工作簿實例載入 SXC 檔案。
1. 透過呼叫Workbook的save方法將SXC轉換為HTML。
1. 取得SXC到HTML的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP函式庫將SXC轉換為HTML" %}}
