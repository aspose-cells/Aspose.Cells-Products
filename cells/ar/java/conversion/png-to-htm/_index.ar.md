---
title: Java PNG إلى HTM - عبر الإنترنت من PNG لتحويل HTM
description: Aspose إكسل. Java Aspose.Cells. Java Aspose Cells. مجاني على الإنترنت Java تحويل PNG إلى HTM saveformat. Java PNG إلى تنسيق HTM. وفر PNG إلى HTM Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل PNG إلى HTM في Java" h2="مكتبة Java عالية السرعة لتحويل PNG إلى HTM. هذا حل برمجي احترافي لاستيراد وتصدير PNG و HTM والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="وفر PNG إلى HTM في Java عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل PNG ملفات إلى HTM برمجيًا؟ يمكن للمطورين Java بسهولة تحويل PNG إلى HTM في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل PNG إلى HTM باستدعاء طريقة Workbook.save.
1.  احصل على نتيجة تحويل PNG إلى HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java مكتبة لتحويل PNG إلى HTM" %}}
{{% blocks/products/pf/agp/text %}}
