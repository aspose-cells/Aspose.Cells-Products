...
url: /it/cpp/create-xlsb/ 
description: C++ Codice di esempio per la generazione di file XLSB di MS Excel. Utilizzare questo codice per creare file XLSB di MS Excel all'interno di un'applicazione basata su C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crea file XLSB tramite C++" h2="Creazione di fogli di lavoro MS Excel XLSB nativi e ad alte prestazioni in modo programmatico senza Micorsoft Office utilizzando la libreria C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
