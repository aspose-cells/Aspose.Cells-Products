---
title:  XLS Anmerkung via .NET hinzufügen oder entfernen
weight: 9270
description: C#-Quellcode zum Hinzufügen und Löschen von XLS-Formatanmerkungen auf .NET Framework, .NET Core, Mono oder Xamarin-Plattformen.
...
{{% blocks/products/pf/agp/feature-section-col title="Anmerkung von XLS über C# hinzufügen oder löschen" %}}
...
{{% blocks/products/pf/agp/code-block title="Anmerkungen von XLS - C# löschen" offSpacer="" %}}
