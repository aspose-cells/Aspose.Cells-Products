...
Hai bisogno di convertire i file MHT in FODS tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in FODS in poche righe di codice.
...
1.  Convertire MHT in FODS chiamando il metodo Save().
