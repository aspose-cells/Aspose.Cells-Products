...
description: Aspose Unggul. Konversikan EXCEL ke ODS dengan cepat dan mudah dengan Aspose.Cells. C# EXCEL ke ODS. C# Simpan EXCEL ke ODS. Simpan EXCEL sebagai ODS menggunakan C#.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi EXCEL menjadi ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ods" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengubah EXCEL menjadi ODS" %}}
