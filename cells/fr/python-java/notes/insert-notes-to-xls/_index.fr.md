...
{{% blocks/products/pf/agp/content h2="Insérer des notes dans le fichier XLS en utilisant Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code Python pour insérer et supprimer des notes dans le fichier XLS" offSpacer="" %}}
