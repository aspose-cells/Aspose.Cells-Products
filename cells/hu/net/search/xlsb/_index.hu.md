...
{{% blocks/products/pf/agp/content h2="XLSB fájl keresése a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A XLSB fájlok keresésének lépései a C#-ben" %}}
...
+ Töltsön be XLSB fájlt a Workbook osztály segítségével.
...
{{% blocks/products/pf/agp/code-block title="Keresés: XLSB Fájlok - C#" offSpacer="" %}}
