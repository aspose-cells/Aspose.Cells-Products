---
title: A JPEG egyesítése PRN-nel - A JPEG-es szám egyesítése PRN-vel a Java-ben
url: /hu/java/merger/merge-jpeg-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés JPEG PRN mentési formátumba. Java Kombinálja a JPEG-et PRN formátumba. Egyesítse a JPEG-et a PRN-vel a Java-es számon. JPEG Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a JPEG-es számot a PRN-hez a Java-es online számmal ingyen" %}}

A következő példa bemutatja, hogyan egyesítheti a JPEG-et a PRN-vel a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a JPEG és a PRN egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el PRN fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a JPEG-et a PRN-be.
...
{{% blocks/products/pf/agp/content h2="A JPEG és a via Java PRN egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a JPEG-et a PRN-nel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a JPEG és a PRN egyesítéséhez" %}}
