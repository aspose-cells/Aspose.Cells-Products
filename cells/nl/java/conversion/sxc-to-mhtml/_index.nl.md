---
title: Converteer SXC naar MHTML via Java 
url: /nl/java/conversion/sxc-to-mhtml/ 
description: Voorbeeld Java conversiecode voor SXC-indeling naar MHTML-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar MHTML te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer SXC naar MHTML via Java" h2="SXC naar MHTML Java-conversie om enkele of meerdere pagina\'s naar MHTML te converteren met behulp van een lokale bibliotheek Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe SXC naar MHTML te converteren met Java" %}}

 Om SXC naar MHTML te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om SXC naar MHTML te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het SXC-bestand gemakkelijk converteren naar MHTML in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het SXC-bestand met een instantie van de Workbook-klasse1. Bel de methode Workbook.save1. Geef het uitvoerpad door met de MHTML-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende MHTML-bestand
...
{{% blocks/products/pf/agp/code-block title="SXC naar MHTML Java Conversiebroncode" offSpacer="" %}}

```cs
// laad het SXC-bestand in een instantie van Workbook
Workbook book = new Workbook("template.sxc");
// sla SXC op als MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC naar MHTML conversie live demo\'s" sectionDescription="[Converteer SXC naar MHTML](https://products.aspose.app/cells/conversion/sxc-to-mhtml) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw SXC-bestand, het wordt onmiddellijk geconverteerd naar MHTML." >}}
