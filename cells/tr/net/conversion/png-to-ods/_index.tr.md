---
title: C# PNG ila ODS - PNG ila ODS Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde PNG'i ODS'e dönüştürün. C# PNG'i ODS'e dönüştürün. C# PNG'i ODS'e kaydedin. PNG'i 07611134 olarak kaydedin 81, C#'i kullanarak.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C#\'e ODS\'e kaydedin" %}}

Aşağıdaki örnek, PNG'in C#'de ODS'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="PNG\'i ODS\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG\'i C# aracılığıyla ODS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını program aracılığıyla ODS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve ODS'e dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="PNG\'i ODS\'e dönüştürmek için C# kitaplığı" %}}
