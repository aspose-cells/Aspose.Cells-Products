---
title: Konwertuj TXT na JPG za pomocą aplikacji C++ 
url: /pl/cpp/conversion/txt-to-jpg/ 
description: Przykładowy kod konwersji C++ dla dokumentu TXT do formatu JPG. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TXT na JPG w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TXT na JPG przez C++" h2="Wydajna konwersja plików TXT do JPG przy użyciu biblioteki C++ bez konieczności instalowania programu Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TXT na JPG za pomocą C++" %}}

 Aby przekonwertować TXT na JPG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TXT na JPG za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik TXT na JPG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TXT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (JPG).1. Plik JPG zostanie zapisany pod określoną ścieżką.1. Otwórz plik JPG w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TXT do JPG C++ Kod źródłowy konwersji" offSpacer="" %}}
