...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SPREADSHEETML in MHTML mit Java" %}}

 Um SPREADSHEETML in MHTML zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von SPREADSHEETML in MHTML über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können die SPREADSHEETML-Datei in nur wenigen Codezeilen ganz einfach in MHTML konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die SPREADSHEETML-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit MHTML-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende MHTML-Datei
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML-zu-MHTML-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die SPREADSHEETML-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.spreadsheetml");
// SPREADSHEETML als MHTML speichern
