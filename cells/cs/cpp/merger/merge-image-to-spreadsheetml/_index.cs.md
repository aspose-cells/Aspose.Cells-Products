...
url: /cs/cpp/merger/merge-image-to-spreadsheetml/ 
...
Následující příklad ukazuje, jak sloučit IMAGE do SPREADSHEETML v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit IMAGE do SPREADSHEETML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení IMAGE do SPREADSHEETML" %}}
