...
url: /nl/python-java/merger/merge-xlt-to-xlsx/ 
...
Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met XLSX in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLT programmatisch samenvoegen tot XLSX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
