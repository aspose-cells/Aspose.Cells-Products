---
title:  حماية وإغلاق XLSM المستند عبر C++
weight: 8770
description: C++ رمز مثال لقفل ملف XLSM باستخدام كلمة مرور على C++ بيئة وقت التشغيل لـ Windows 32 بت و Windows 64 بت و Linux 64 بت.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تشفير XLSM الملفات عبر C++" h2="تحمي جداول بيانات Excel بكلمة مرور بما في ذلك تنسيق XLSM باستخدام مكتبة .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تأمين ملف XLSM باستخدام C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات حماية ملفات XLSM عبر C++" %}}
...
1.  قم بتحميل ملف XLSM باستخدام فئة IWorkbook
