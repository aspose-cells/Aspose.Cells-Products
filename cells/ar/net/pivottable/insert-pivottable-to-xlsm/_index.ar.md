---
title:  أدخل PivotTable في ملفات Micorsoft Excel XLSM عبر C#
weight: 7690
description: C# نموذج كود لتكوين وثائق XLSM باستخدام PivotTable. استخدم هذا الرمز لإنشاء ملفات Micorsoft Excel XLSM باستخدام PivotTable ضمن VB.NET أو Asp.NET أو أي تطبيق يستند إلى .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل PivotTable في مستندات XLSM عبر C#" h2="جدول بيانات Microsoft أصلي وعالي الأداء في Excel XLSM مع إنشاء PivotTable برمجيًا باستخدام واجهات برمجة تطبيقات .NET من جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 يعد إنشاء ملف MS Excel XLSM باستخدام PivotTable ديناميكيًا داخل التطبيق قيد التشغيل أمرًا سهلاً. من أجل إنشاء مستندات XLSM باستخدام PivotTable من البداية دون الحاجة إلى MS Office ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية إدراج PivotTable في XLSM عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

من السهل على المطورين إدخال PivotTable في جدول بيانات بتنسيق XLSM ضمن تشغيل تطبيقات تقارير مختلفة لمعالجة البيانات في بضعة أسطر من التعليمات البرمجية.
...
1. استخدم طريقة Save لحفظ المصنف كملف XLSM.
...
{{% blocks/products/pf/agp/code-block title="أدخل PivotTable في XLSM-C#" offSpacer="" %}}
...
مكتبة برمجة جداول بيانات Excel قادرة على إنشاء تطبيقات عبر الأنظمة الأساسية مع القدرة على إنشاء ملفات Excel XLSM وتعديلها وتحويلها وتقديمها وطباعتها. .NET Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات ، بل يمكنه أيضًا تحويل ملفات Excel كصور ، PDF ، HTML ، ODS وأكثر ، مما يجعله خيارًا مثاليًا لتبادل المستندات بتنسيقات قياسية في الصناعة.
