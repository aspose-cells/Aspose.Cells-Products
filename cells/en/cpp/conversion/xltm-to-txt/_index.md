...
description: Sample C++ conversion code for XLTM document to TXT format. Programmers can use this source code for batch XLTM to TXT conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLTM to TXT C++ Conversion Source Code" offSpacer="" %}}
