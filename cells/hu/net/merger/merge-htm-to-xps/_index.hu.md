---
title: HTM egyesítése a XPS számmal – HTM összevonása XPS számmal a C#-ben
url: /hu/net/merger/merge-htm-to-xps/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés a HTM-mel a XPS mentési formátumba. C# HTM kombinálása XPS formátummal. HTM egyesítése a XPS-es számmal a C#-ben. HTM-egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a HTM-et a XPS-es számmal a C#-ben online" %}}

A következő példa bemutatja, hogyan egyesítheti a HTM-et a XPS-es számmal a Aspose.Cells for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTM és a XPS egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a XPS fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTM-et a XPS-gyel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTM összevonása a XPS-es számmal a C#-ben" InputFormat="htm" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTM egyesítése a XPS-es számmal a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a HTM-et a XPS-es számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és a XPS egyesítéséhez" %}}
