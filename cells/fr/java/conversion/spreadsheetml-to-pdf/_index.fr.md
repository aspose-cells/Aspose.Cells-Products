---
title: Convertir SPREADSHEETML en PDF via Java 
url: /fr/java/conversion/spreadsheetml-to-pdf/ 
description: Exemple de code de conversion Java pour le format SPREADSHEETML en fichier PDF. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice au format PDF dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir SPREADSHEETML en PDF via Java" h2="Conversion SPREADSHEETML en PDF Java pour convertir une ou plusieurs pages en PDF à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir SPREADSHEETML en PDF à l\'aide de Java" %}}

 Afin de rendre SPREADSHEETML en PDF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SPREADSHEETML en PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier SPREADSHEETML en PDF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier SPREADSHEETML avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension PDF et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier PDF résultant
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion SPREADSHEETML en PDF Java" offSpacer="" %}}

```cs
// charger le fichier SPREADSHEETML dans une instance de Workbook
Workbook book = new Workbook("template.spreadsheetml");
// enregistrer SPREADSHEETML au format PDF
