---
title: Chuyển XLS sang PDF qua Java 
weight: 600
url: /vi/java/conversion/xls-to-pdf/ 
description: Mã chuyển đổi Java mẫu cho định dạng XLS sang tệp PDF. Lập trình viên có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang PDF trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển XLS sang PDF qua Java" h2="Chuyển đổi XLS sang PDF Java để chuyển đổi một hoặc nhiều trang sang PDF bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển XLS sang PDF bằng Java" %}}

 Để hiển thị XLS sang PDF, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLS sang PDF qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp XLS sang PDF chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLS với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Chuyển đường dẫn đầu ra với phần mở rộng PDF & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp PDF kết quả
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi XLS sang PDF Java" offSpacer="" %}}

```cs
// tải tệp XLS trong một phiên bản của Workbook
Workbook book = new Workbook("template.xls");
// lưu XLS dưới dạng PDF
