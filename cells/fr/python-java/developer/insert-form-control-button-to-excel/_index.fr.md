---
title: Insérer un bouton (contrôle de formulaire) dans Excel à l'aide de Java Python via
weight: 200
description: Python via code source Java pour insérer un bouton (contrôle de formulaire) dans Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insérer un bouton (contrôle de formulaire) dans Excel à l\'aide de Java Python via" h2="Insérez des objets à l\'aide d\'API côté serveur sans aucun logiciel comme Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment insérer un bouton (contrôle de formulaire) dans un fichier Excel à l\'aide de Python via java" %}}
...
Afin d'insérer un bouton (contrôle de formulaire) dans un fichier Excel, nous utiliserons
 ...
 API qui est un API de manipulation de documents riche en fonctionnalités, puissant et facile à utiliser pour Python via la plate-forme Java. Le API permet la création, la manipulation, la conversion et le rendu de fichiers Excel. Le tout sans compter sur les applications Office ou Excel Microsoft. Vous pouvez installer à partir de la console à l'aide de la commande suivante.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer un bouton (contrôle de formulaire) dans un fichier Excel à l\'aide de Python via java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)) pour insérer un Bouton (contrôle Formulaire) dans la feuille de calcul sélectionnée.
...
-  Tout système d'exploitation pouvant exécuter Python via des scripts Java, tel que Windows, Linux et MacOS
...
{{% blocks/products/pf/agp/code-block title="Bouton Insérer (contrôle de formulaire) - Python via java" offSpacer="" %}}
