---
title: Fusionner MHT vers POWERPOINT - Combiner MHT vers POWERPOINT en Java
url: /fr/java/merger/merge-mht-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde POWERPOINT. Java Combinez MHT au format POWERPOINT. Fusionnez MHT avec POWERPOINT en Java. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT à POWERPOINT en Java en ligne gratuitement" %}}
...
{{% cells-merger title="Gratuit en ligne pour fusionner MHT à POWERPOINT en Java" InputFormat="mht" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT vers POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner MHT vers POWERPOINT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
