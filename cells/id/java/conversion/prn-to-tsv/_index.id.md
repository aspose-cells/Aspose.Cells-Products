---
title: Java PRN ke TSV - Konverter PRN ke TSV
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi PRN ke format TSV, memungkinkan penyimpanan data PRN ke format TSV dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan PRN ke TSV di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi PRN ke TSV. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, TSV, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan PRN ke TSV di Java" %}}

Contoh berikut menunjukkan cara mengkonversi PRN ke TSV di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi PRN ke TSV. Unggah file PRN Anda, lalu simpan sebagai file TSV. Untuk pembacaan PRN dan penulisan TSV Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran TSV akan sama dengan dokumen PRN asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi PRN ke TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="prn" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi PRN ke TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file PRN ke TSV secara terprogram? Pengembang Java dapat dengan mudah mengkonversi PRN ke TSV hanya dengan beberapa baris kode.
...
1.  Ubah PRN menjadi TSV dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi PRN menjadi TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi PRN ke TSV" %}}
{{% blocks/products/pf/agp/text %}}
