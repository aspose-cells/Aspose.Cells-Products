...
description: Aspose เอ็กเซล. แปลง XLSB เป็น TABDELIMITED อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C# XLSB เป็น TABDELIMITED C# บันทึก XLSB ไปที่ TABDELIMITED บันทึก XLSB เป็น TABDELIMITED โดยใช้ C#
...
{{% blocks/products/pf/agp/content h2="บันทึก XLSB ไปที่ TABDELIMITED ใน C#" %}}
...
1.  แปลง XLSB เป็น TABDELIMITED โดยการเรียกเมธอด Workbook.Save
