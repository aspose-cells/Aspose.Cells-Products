---
title:  Combinar XLS a XLSM via Java
...
El siguiente ejemplo muestra cómo combinar XLS con XLSM en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a XLSM en línea" InputFormat="xls" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
