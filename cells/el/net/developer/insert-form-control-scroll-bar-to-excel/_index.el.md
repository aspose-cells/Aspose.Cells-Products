---
title:  Εισαγάγετε το ScrollBar (Στοιχείο ελέγχου φόρμας) στο Excel via .NET
weight: 90
description: C# πηγαίος κώδικας για εισαγωγή ScrollBar (Έλεγχος φόρμας) στο Excel σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Εισαγάγετε το ScrollBar (Στοιχείο ελέγχου φόρμας) στο Excel via .NET" h2="Εισαγάγετε αντικείμενα χρησιμοποιώντας API από την πλευρά του διακομιστή χωρίς λογισμικό όπως Microsoft ή Open Office, Adobe PDF κ.λπ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Τρόπος εισαγωγής ScrollBar (Έλεγχος φόρμας) σε αρχείο Excel χρησιμοποιώντας C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την εισαγωγή ScrollBar (Έλεγχος φόρμας) στο αρχείο Excel μέσω C#" %}}
...
+ Επιλέξτε Φύλλο εργασίας μέσω του ευρετηρίου του.
 + Χρησιμοποιήστε το[μέθοδος προσθήκης](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addscrollbar) για να εισαγάγετε ένα ScrollBar (Στοιχείο ελέγχου φόρμας) στο επιλεγμένο φύλλο εργασίας
...
{{% blocks/products/pf/agp/code-block title="Εισαγωγή ScrollBar (Έλεγχος φόρμας) - C#" offSpacer="" %}}
