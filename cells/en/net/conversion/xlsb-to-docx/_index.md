...
description: Sample code for xlsb to docx C# conversion. Use API example code for batch xlsb files to docx conversion within VB.NET, Asp.NET or any .NET based application.
---
