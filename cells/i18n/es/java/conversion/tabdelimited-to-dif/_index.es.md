...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TABDELIMITED a DIF a través de Java" h2="Conversión TABDELIMITED a DIF Java para convertir una o varias páginas a DIF utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir TABDELIMITED a DIF usando Java" %}}

 Para convertir TABDELIMITED en DIF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir TABDELIMITED a DIF a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente el archivo TABDELIMITED a DIF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo TABDELIMITED con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con extensión DIF y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo DIF resultante
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED a DIF Java Código fuente de conversión" offSpacer="" %}}

```cs
// cargue el archivo TABDELIMITED en una instancia de Workbook
Workbook book = new Workbook("template.tabdelimited");
// guardar TABDELIMITED como DIF
