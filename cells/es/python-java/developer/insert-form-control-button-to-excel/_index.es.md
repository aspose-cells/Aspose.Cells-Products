---
title: Insertar botón (control de formulario) en Excel usando Python via java
weight: 200
description: Python via código fuente de Java para insertar un botón (control de formulario) en Excel.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar un botón (control de formulario) en un archivo de Excel usando Python via java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa la colección de formas[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)) para insertar un botón (control de formulario) en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Botón Insertar (control de formulario) - Python via java" offSpacer="" %}}
