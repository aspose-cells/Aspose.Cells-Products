---
title: Převeďte XLS na EMF pomocí aplikace C++ 
weight: 6870
url: /cs/cpp/conversion/xls-to-emf/ 
description: Ukázka převodního kódu C++ pro dokument XLS do formátu EMF. Programátoři mohou použít tento zdrojový kód pro dávkový převod XLS na EMF v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLS na EMF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLS pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavení možností (EMF).1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor EMF v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLS na EMF C++" offSpacer="" %}}
