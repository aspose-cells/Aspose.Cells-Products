...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar ETT met Aspose.Cells. PHP MHTML naar ETT. PHP Sla MHTML op in ETT. Sla MHTML op als ETT met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar ETT te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar ETT converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar ETT.
...
1.  Converteer MHTML naar ETT door de opslagmethode van Workbook aan te roepen.
