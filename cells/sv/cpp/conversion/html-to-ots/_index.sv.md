...
description: Aspose Excel. Denna omfattande lösning ger C++-utvecklare en helt integrerad metod för att konvertera HTML till OTS-format, vilket möjliggör sömlös sparning av HTML-data till OTS-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C++-kod.
...
{{% blocks/products/pf/agp/content h2="Konvertera HTML till OTS med hjälp av C++" %}}
...
{{% blocks/products/pf/agp/content h2="Spara HTML till OTS i C++" %}}
...
Behöver du konvertera HTML-filer till OTS programmatiskt? C++-utvecklare kan enkelt konvertera HTML till OTS med bara några få rader kod.
...
1.  Konvertera HTML till OTS genom att anropa Save()-metoden.
