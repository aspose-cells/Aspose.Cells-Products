...
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen XLS naar SVG saveformat. C# Combineer het formaat XLS tot SVG. Samenvoegen XLS tot SVG in C#. XLS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met SVG in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLS samenvoegt met SVG in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLS samen te voegen met SVG. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand SVG. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat XLS samenvoegt met SVG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om XLS samen te voegen tot SVG in C#" InputFormat="xls" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLS samen te voegen met SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLS programmatisch samenvoegen tot SVG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLS samen te voegen tot SVG" %}}
