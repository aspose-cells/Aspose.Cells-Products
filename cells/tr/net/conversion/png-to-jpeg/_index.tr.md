...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde PNG'i JPEG'e dönüştürün. C# PNG'i JPEG'e dönüştürün. C# PNG'i JPEG'e kaydedin. PNG'i 07611134 olarak kaydedin 81, C#'i kullanarak.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C#\'e JPEG\'e kaydedin" %}}

Aşağıdaki örnek, PNG'in C#'de JPEG'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="PNG\'i JPEG\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="jpg" IsLandingPage="true" %}}
...
1.  Workbook.Save yöntemini çağırarak PNG'i JPEG'e dönüştürün.
1.  PNG'den JPEG'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PNG\'i JPEG\'e dönüştürmek için C# kitaplığı" %}}
