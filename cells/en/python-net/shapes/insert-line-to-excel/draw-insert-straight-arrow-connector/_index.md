...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) to insert a straight arrow connector in the selected worksheet.
