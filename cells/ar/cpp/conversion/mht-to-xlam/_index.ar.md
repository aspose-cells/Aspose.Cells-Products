...
هل تحتاج إلى تحويل ملفات MHT إلى XLAM برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى XLAM في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLAM باستدعاء طريقة Save ().
