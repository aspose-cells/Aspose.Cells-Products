...
description: Przykładowy kod do konwersji xlsx na pdf Python. Użyj przykładowego kodu API do konwersji wsadowych plików xlsx na pdf w aplikacji Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSX na PDF przez Python" h2="Eksportuj arkusze kalkulacyjne programu Excel do formatu PDF za pomocą interfejsów API Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na PDF za pomocą Python" %}}
 ...
 Aby zamienić XLSX na PDF, użyjemy
 [Aspose.Cells for Python](https://pypi.org/project/aspose-cells-python) 
 API, która jest bogatą w funkcje, wydajną i łatwą w użyciu platformą do manipulacji i konwersji dokumentów API for Python.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programiści Python mogą łatwo ładować i konwertować pliki XLSX na PDF w zaledwie kilku wierszach kodu.
...
1.  Sprawdź określoną ścieżkę dla wynikowego pliku PDF
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-net/conversion/xlsx-to-xlsx/" name="XLSX DO XLSX" description="Plik Excela OOXML" >}}
