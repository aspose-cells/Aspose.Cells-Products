---
title:  XLSX 파일 via .NET에서 보고서 생성
weight: 6740
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼에 대한 XLSX 형식 보고서를 생성합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 XLSX 형식으로 대량 보고서 생성" h2="데이터 소스 및 템플릿을 사용하여 XLSX 형식으로 보고서를 생성합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 XLSX을 조립하는 단계" %}}
...
1. WorkbookDesigner.Worbook.Save 메서드를 통해 결과를 XLSX 형식으로 저장합니다.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/assembly/xlsb/" name="XLSB" description="바이너리 Excel 통합 문서 파일" >}}
