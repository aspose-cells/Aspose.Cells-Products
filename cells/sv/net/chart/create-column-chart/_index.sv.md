...
{{% blocks/products/pf/agp/feature-section-col title="Hur man skapar kolumndiagram via C#" %}}
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Följande källkod visar hur man skapar ett kolumndiagram till MS Excel XLSX-fil med C#." offSpacer="" %}}
