...
url: /ru/cpp/merger/merge-excel-to-sxc/ 
...
В следующем примере показано, как объединить EXCEL с SXC в Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Нужно программно объединить EXCEL с SXC? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для объединения EXCEL с SXC" %}}
