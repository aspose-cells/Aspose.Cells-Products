---
title: Convertisseur PHP SXC vers ET - SXC vers ET
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir SXC au format ET, permettant un enregistrement transparent des données SXC au format ET à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code PHP efficace et personnalisable.
...
Besoin de convertir des fichiers SXC au format ET par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers SXC au format ET en quelques lignes de code seulement.
...
1. Convertissez SXC en ET en appelant la méthode save de Workbook.
