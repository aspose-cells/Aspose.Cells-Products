...
以下範例示範如何將 Aspose.Cells for .NET 中的 MHT 合併到 SQL。
...
需要以程式設計方式將 MHT 合併到 SQL？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 將 MHT 合併到 SQL 的函式庫" %}}
