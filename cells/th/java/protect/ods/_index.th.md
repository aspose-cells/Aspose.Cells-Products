...
{{< blocks/products/pf/i18n/upper-banner h1="เข้ารหัสไฟล์ ODS ผ่าน Java" h2="สเปรดชีต Excel ที่ป้องกันด้วยรหัสผ่านรวมถึงรูปแบบ ODS โดยใช้ .NET Library" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการปกป้องไฟล์ ODS ผ่าน Java" %}}
...
1. โหลดไฟล์ ODS โดยสร้างอินสแตนซ์ของคลาสเวิร์กบุ๊ก1. ใช้วิธีป้องกัน (..) กับ ProtectionType และ Password1. บันทึกไฟล์ ODS ที่ได้รับการป้องกันโดย save() method
