---
title: Gabungkan FODS menjadi XLSB - Gabungkan FODS menjadi XLSB menjadi Java
url: /id/java/merger/merge-fods-to-xlsb/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS menjadi XLSB format simpan. Java Gabungkan format FODS menjadi XLSB. Gabungkan FODS menjadi XLSB di Java. FODS Gabungkan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan FODS menjadi XLSB via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan FODS menjadi XLSB. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="FODS" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS menjadi XLSB di Java" %}}

Contoh berikut menunjukkan cara menggabungkan FODS menjadi XLSB di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan FODS ke XLSB. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file XLSB. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan FODS menjadi XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan FODS menjadi XLSB di Java" InputFormat="fods" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS menjadi XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke XLSB secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan FODS menjadi XLSB" %}}
