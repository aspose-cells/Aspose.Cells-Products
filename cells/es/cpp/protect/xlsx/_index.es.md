...
1. Cargue el archivo XLSX usando la clase IWorkbook1. Utilice el método Protect(..) con ProtectionType y Password1. Guarde el archivo XLSX protegido con el método Save()
