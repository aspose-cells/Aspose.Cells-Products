---
title:  Keresés a XLS dokumentumban a via Java megnyitása nélkül
weight: 9430
description: Java mintakód a XLS fájlban a Java futásidejű környezet JSP/JSF-alkalmazásokhoz és asztali alkalmazásokhoz.
...
{{% blocks/products/pf/agp/content h2="XLS fájl keresése a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A XLS fájlok keresésének lépései a Java-ben" %}}
...
+ A XLS fájl betöltése munkafüzet objektum létrehozásával.
+ A XLS fájl első munkalapjának elérése.
...
{{% blocks/products/pf/agp/code-block title="Keresés: XLS Fájlok - Java" offSpacer="" %}}
