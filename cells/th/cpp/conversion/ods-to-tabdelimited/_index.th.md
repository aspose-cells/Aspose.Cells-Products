...
ต้องการแปลงไฟล์ ODS เป็น TABDELIMITED โดยใช้โปรแกรมหรือไม่? นักพัฒนา C++ สามารถแปลง ODS เป็น TABDELIMITED ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1. แปลง ODS เป็นรูปแบบ TABDELIMITED โดยเรียกใช้เมธอด Save()
