...
description: Aspose إكسل. Python قم بإنشاء ملف SXC. أنشئ SXC Python. Python SXC Cather. قم بإنشاء SXC في Python. قم بإنشاء ملف SXC باستخدام Python.
...
{{% blocks/products/pf/agp/text %}}
 ...
 من السهل على المطورين إنشاء ملفات SXC وتحميلها وتعديلها وتحويلها من خلال تشغيل تطبيقات تقارير مختلفة لمعالجة البيانات في بضعة أسطر من التعليمات البرمجية.
...
1. استخدم طريقة Save لحفظ المصنف كملف SXC.
