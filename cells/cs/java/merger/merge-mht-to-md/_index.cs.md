---
title: Sloučit MHT s MD – Zkombinujte MHT s MD v Java
url: /cs/java/merger/merge-mht-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení MD. Java Zkombinujte formát MHT s MD. Sloučit MHT do MD v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do MD v Java" %}}

Následující příklad ukazuje, jak sloučit MHT s MD v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT s MD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MD. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT do MD v Java" InputFormat="mht" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT s MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit MHT s MD? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna pro sloučení MHT s MD" %}}
