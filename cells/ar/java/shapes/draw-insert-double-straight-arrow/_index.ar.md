...
weight: 20
description: ارسم أو أدخل كائنات سهم مستقيم مزدوج باستخدام Aspose.Cells 'Java API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF ، إلخ.
---
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) لإدراج سهم مستقيم مزدوج في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل سهم مستقيم مزدوج - Java" offSpacer="" %}}
