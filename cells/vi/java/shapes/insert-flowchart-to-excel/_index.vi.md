---
title: Chèn Lưu đồ vào Excel via Java
weight: 360
...
{{% blocks/products/pf/agp/content h2="Cách Chèn Lưu đồ vào Tệp Excel bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn Lưu đồ vào file Excel via Java" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng các[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) để chèn Lưu đồ trong trang tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn lưu đồ - Java" offSpacer="" %}}
