---
title: Gabung SXC ke ETT - Gabungkan SXC ke ETT di Java
url: /id/java/merger/merge-sxc-to-ett/ 
description: Aspose Unggul. Java Aspose.Cells. Gabung Online Gratis SXC ke ETT saveformat. Java Gabungkan SXC ke format ETT. Gabung SXC ke ETT di Java. SXC Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan SXC ke ETT di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan SXC ke ETT di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan SXC ke ETT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ETT. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan SXC ke ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis Menggabungkan SXC ke ETT di Java" InputFormat="sxc" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC ke ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan SXC ke ETT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
