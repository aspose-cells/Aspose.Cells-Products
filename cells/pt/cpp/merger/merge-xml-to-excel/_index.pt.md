...
url: /pt/cpp/merger/merge-xml-to-excel/ 
...
O exemplo a seguir demonstra como mesclar XML com EXCEL em Aspose.Cells for C++.
...
{{% cells-merger title="Exemplo de código para mesclar XML com EXCEL em C++" InputFormat="xml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XML com EXCEL via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XML com EXCEL programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para mesclar XML com EXCEL" %}}
