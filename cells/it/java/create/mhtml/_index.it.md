---
title: Crea MHTML - Crea file MHTML in Java
description: Aspose Excel. Genera e manipola senza sforzo i file MHTML con la libreria Aspose.Cells for Java. Questa potente libreria API offre una soluzione semplificata ed efficiente per creare, modificare e gestire i file MHTML direttamente all'interno delle tue applicazioni Java, soddisfacendo le esigenze specifiche degli sviluppatori con elevata precisione.
...
{{% blocks/products/pf/agp/content h2="Come creare MHTML in Java" %}}
...
1.  Salvare la cartella di lavoro nel formato MHTML utilizzando il metodo save().

{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare il file MHTML in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria Java per creare il file MHTML" %}}
{{% blocks/products/pf/agp/text %}}
