...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLSB do FODS uložit formát. C# Kombinujte formát XLSB až FODS. Sloučit XLSB až FODS v C#. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až FODS v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLSB až FODS v C#" InputFormat="xlsb" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
