...
{{% blocks/products/pf/agp/content h2="Python Excel Kitaplığını Kullanarak MHTML\'i IMAGE\'a Dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="MHTML\'i Python Excel Kitaplığı\'ndaki IMAGE\'a kaydedin" %}}

Aşağıdaki örnek, MHTML excel kitaplığında MHTML'in IMAGE'a nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="Python MHTML\'i IMAGE\'a Dönüştürmek için Excel Kitaplığı" %}}
