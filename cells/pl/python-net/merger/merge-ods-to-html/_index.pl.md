---
title:  Połącz ODS z HTML przez Python
url: /pl/python-net/merger/merge-ods-to-html/ 
description: Połącz ODS z HTML Online za darmo. Bezpłatnie online ODS do HTML Fuzja. Połącz ODS z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć ODS z HTML w Python.
...
{{% cells-merger title="Darmowa aplikacja do łączenia ODS z HTML on-line" InputFormat="ods" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
