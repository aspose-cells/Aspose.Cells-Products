---
title: แทรก ComboBox (การควบคุมฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 20
description: Python via ซอร์สโค้ด .Net เพื่อแทรก ComboBox (การควบคุมฟอร์ม) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก ComboBox (การควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก ComboBox (Form control) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_combo_box/#int-int-int-int-int-int) เพื่อแทรก ComboBox (การควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก ComboBox(การควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
