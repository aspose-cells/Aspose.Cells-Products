---
title:  Birleştirme HTML Dosyalar via .NET
weight: 9440
description: C# HTML belgelerini .NET Framework, .NET Core, Mono veya Xamarin Platformlarında birleştirmek için kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="HTML Biçimlerini C#\'de birleştir" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Cells for .NET API\'leri kullanılarak yerel ve yüksek performanslı HTML belge birleştirme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="HTML" >}}
...
+ Save() yöntemini çağırın ve dosya adını (tam yol) ve formatı (HTML) parametre olarak iletin.
