---
title:  أدخل Arc في Excel عبر C++
weight: 10
description: C++ رمز مثال لإدراج Arc في ملف Excel على C++ Runtime Environment لـ Windows 32 بت و Windows 64 بت و Linux 64 بت.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل Arc في Excel عبر C++" h2="أدخل كائنات باستخدام الأداء الأصلي والعالي من جانب الخادم Aspose.Cells for C++ API دون استخدام أي برنامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#a4942e79c088d2fd459beeda50006b4c4) لإدراج أشكال المعادلات في ورقة العمل المحددة
