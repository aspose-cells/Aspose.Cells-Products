---
title: C++ XML в PDF - Конвертер XML в PDF
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в PDF в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат PDF в формате C++.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XML в PDF через C++" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать XML-файлы в формат PDF? Разработчики, использующие формат C++, могут легко преобразовать XML в формат PDF всего несколькими строками кода.
...
1.  Преобразовать XML в формат PDF, вызвав метод Save().
1.  Получите результат преобразования XML в PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C++ для преобразования XML в PDF" %}}
