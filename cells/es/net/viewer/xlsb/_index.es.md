---
title:  Ver XLSB Formatos de archivo via .NET
weight: 6260
description: C# código fuente para cargar, renderizar y mostrar documentos XLSB en plataformas .NET Framework, .NET Core, Mono o Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Ver XLSB vía C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells facilita a los desarrolladores ver el archivo XLSB con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Cargue el archivo XLSB en una instancia de Workbook
1.  Cree una instancia de HtmlSaveOptions y establezca la propiedad ExportHeadings en verdadero
1. Guarde el archivo XLSB en formato HTML usando el método Workbook.Save
