---
title: Konversi XLTM ke XPS melalui C++ aplikasi 
url: /id/cpp/conversion/xltm-to-xps/ 
description: Contoh C++ kode konversi untuk dokumen XLTM ke format XPS. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLTM ke XPS dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLTM ke XPS melalui C++" h2="Konversi XLTM ke XPS berperforma tinggi menggunakan pustaka C++ tanpa memerlukan penginstalan Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLTM ke XPS Menggunakan C++" %}}

 Untuk mengonversi XLTM ke XPS, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi XLTM ke XPS melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ pengembang dapat dengan mudah mengonversi file XLTM ke XPS hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLTM menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file keluaran dengan ekstensi file (XPS).1. File XPS akan disimpan di jalur yang ditentukan.1. Buka file XPS di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLTM ke XPS C++ Kode Sumber Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi XLTM ke XPS" sectionDescription="[Mengonversi XLTM ke XPS](https://products.aspose.app/cells/conversion/xltm-to-xps) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file XLTM Anda, itu akan langsung dikonversi ke XPS." >}}
