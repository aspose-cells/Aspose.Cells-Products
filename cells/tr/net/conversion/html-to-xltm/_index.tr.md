...
HTML dosyalarını program aracılığıyla XLTM'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyebilir ve XLTM'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak HTML değerini XLTM değerine dönüştürün.
