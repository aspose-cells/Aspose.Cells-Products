---
title: Voeg SPREADSHEETML samen met SQL - Combineer SPREADSHEETML met SQL in C#
url: /nl/net/merger/merge-spreadsheetml-to-sql/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online SPREADSHEETML samenvoegen naar SQL-opslagindeling. C# Combineer SPREADSHEETML naar SQL-indeling. Voeg SPREADSHEETML samen met SQL in C#. SPREADSHEETML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg SPREADSHEETML samen met SQL in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u SPREADSHEETML kunt samenvoegen met SQL in Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis online om SPREADSHEETML samen te voegen met SQL in C#" InputFormat="xml" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML samen te voegen met SQL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SPREADSHEETML programmatisch samenvoegen met SQL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
