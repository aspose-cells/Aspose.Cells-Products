---
title: Συγχώνευση XLT σε NUMBERS - Συνδυάστε XLT σε NUMBERS στο Java
url: /el/java/merger/merge-xlt-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Δωρεάν διαδικτυακή συγχώνευση XLT σε μορφή αποθήκευσης NUMBERS. Java Συνδυάστε το XLT σε μορφή NUMBERS. Συγχώνευση XLT σε NUMBERS στο Java. XLT Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLT σε NUMBERS στο Java Δωρεάν Online" %}}

Το παρακάτω παράδειγμα δείχνει πώς να συγχωνεύσετε το XLT με το NUMBERS στο Aspose.Cells for Java.
...
{{% cells-merger title="Δωρεάν online για συγχώνευση XLT σε NUMBERS στο Java" InputFormat="xlt" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Τρόπος συγχώνευσης XLT με NUMBERS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε το XLT στο NUMBERS μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for Java](https://products.aspose.com/cells/java) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="Java βιβλιοθήκη για συγχώνευση XLT σε NUMBERS" %}}
