---
title: PHP PRN - JSON - PRN - JSON konvertáló
description: Aspose Excel. A PRN-t gyorsan és egyszerűen konvertálja JSON-re a Aspose.Cells-gyel. PHP PRN-t JSON-re. PHP PRN mentése JSON-re. PRN mentése JSON-re PHP használatával.
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet a PRN-t JSON-re konvertálni PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A PRN-fájlokat programozottan JSON-re kell konvertálni? A PHP fejlesztői könnyedén betölthetik és konvertálhatják a PRN-t JSON-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a PRN-t JSON-re a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a PRN JSON számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a PRN JSON-re való konvertálásához" %}}
