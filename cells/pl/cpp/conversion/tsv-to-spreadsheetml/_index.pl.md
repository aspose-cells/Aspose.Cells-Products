...
Trzeba programowo przekonwertować pliki TSV do formatu SPREADSHEETML? Programiści C++ mogą łatwo przekonwertować pliki TSV do formatu SPREADSHEETML za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj TSV do formatu SPREADSHEETML, wywołując metodę Save().
