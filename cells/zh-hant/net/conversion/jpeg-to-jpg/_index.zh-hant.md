---
title: C# JPEG 轉 JPG - 在線 JPEG 轉 JPG 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 JPEG 轉換為 JPG 保存格式。 C# JPEG 為 JPG 格式。將 JPEG 保存為 JPG C#。
...
{{% cells-convert title="免費應用程序和示例代碼在線將 JPEG 轉換為 JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 JPEG 轉換為 JPG" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 JPEG 文件轉換為 JPG？ .NET 開發人員只需幾行代碼即可輕鬆加載 JPEG 並將其轉換為 JPG。
