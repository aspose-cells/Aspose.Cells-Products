---
title: Convertisseur C# XLS à HTML - XLS à HTML
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format XLS au format HTML, permettant un enregistrement transparent des données XLS au format HTML à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS au lieu de HTML dans C#" %}}

L'exemple suivant montre comment convertir XLS en HTML dans C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en HTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en HTML par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en HTML en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en HTML" %}}
