...
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení HTML. Java Zkombinujte MHT do formátu HTML. Sloučit MHT na HTML v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na HTML v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT s HTML v Java" InputFormat="mht" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
