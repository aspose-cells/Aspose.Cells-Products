...
description: Sample code for xlsx to xlsb C# conversion. Use API example code for batch xlsx files to xlsb conversion within VB.NET, Asp.NET or any .NET based application.
---
