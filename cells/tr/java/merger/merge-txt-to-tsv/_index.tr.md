---
title: TXT'i TSV'e birleştir - TXT'i Java'de TSV'e birleştir
url: /tr/java/merger/merge-txt-to-tsv/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i TSV kaydetme biçimiyle birleştirin. Java TXT'i TSV biçimiyle birleştirin. Java'de TXT'i TSV ile birleştirin. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'de TSV ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de TXT ile TSV'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT ile TSV'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından TSV dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT ile TSV'i birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT ile TSV\'i Java\'de Birleştirmek için Örnek Kod" InputFormat="txt" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT ile TSV via Java Nasıl Birleştirilir?" %}}

{{% blocks/products/pf/agp/text %}}

 TXT ile TSV'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, TXT ile TSV arasında birleştirilecek" %}}
