---
title:  Converter XLT para Byte Array via C#
weight: 7690
description: C# Código de amostra para conversão de XLT para matriz de bytes. Use este código para Excel XLT para conversão de Byte Array dentro de VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLT para matriz de bytes via C#" h2="Nativo e de alto desempenho Microsoft Excel XLT para conversão de matriz de bytes ou vice-versa para processamento de dados de planilhas usando APIs do lado do servidor .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array é útil para processamento ou armazenamento de dados. Você pode converter o arquivo XLT para Byte Array, bem como um**Matriz de bytes para XLT**documento usando o idioma C#. Para converter XLT em array de bytes, usaremos
...
1.  Carregar arquivo de entrada XLT usando pasta de trabalho
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra XLT para a matriz de bytes C# Conversão" offSpacer="" %}}
