---
title:  Callouts in Excel einfügen via .NET
weight: 360
description: C# Beispielcode zum Hinzufügen oder Einfügen von Callouts in Excel mithilfe der Bibliothek .NET. Verwenden Sie diesen Code, um Callouts in MS Excel in VB.NET, Asp.NET oder einer anderen .NET-basierten Anwendung zu erstellen.
keywords: [C# Aspose.Cells., c# add Callouts shape., c# insert Callouts shape., c# create Callouts shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Callouts in Excel einfügen via .NET" h2="Fügen Sie Callouts mit Aspose.Cells\' API ohne Software wie Microsoft oder Open Office, Adobe PDF usw. ein." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Wählen Sie Arbeitsblatt über seinen Index aus.
 + Benutzen Sie die[Methode hinzufügen](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) , um Callouts in das ausgewählte Arbeitsblatt einzufügen
