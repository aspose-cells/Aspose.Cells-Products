---
title: دمج MHT في TIFF - ادمج MHT مع TIFF في C++
url: /ar/cpp/merger/merge-mht-to-tiff/ 
description: Aspose إكسل. C++ Aspose.Cells. دمج MHT عبر الإنترنت مجانًا إلى تنسيق حفظ TIFF. C++ ادمج MHT مع تنسيق TIFF. دمج MHT في TIFF في C++. MHT Merge.
...
{{% blocks/products/pf/agp/content h2="قم بدمج MHT في TIFF في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج MHT مع TIFF في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج MHT في TIFF. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف TIFF. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج MHT مع TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج MHT في TIFF في C++" InputFormat="mht" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج MHT مع TIFF عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج MHT في TIFF برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج MHT إلى TIFF" %}}
