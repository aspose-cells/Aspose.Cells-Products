---
title: C++ uygulaması aracılığıyla JSON'u DOCX'e dönüştürün 
url: /tr/cpp/conversion/json-to-docx/ 
description: JSON belgesi için DOCX biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu JSON'dan DOCX'e dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla JSON\'u DOCX\'e dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı JSON\'dan DOCX\'e dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, JSON dosyasını yalnızca birkaç satır kodla kolayca DOCX'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak JSON dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (DOCX) dosya uzantısıyla iletin.1. DOCX dosyası belirtilen yola kaydedilecektir.1. DOCX dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="JSON\'dan DOCX\'e C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
