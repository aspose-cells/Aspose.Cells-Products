...
{{% blocks/products/pf/agp/content h2="Сохраните TABDELIMITED в MHT по коду Java" %}}

Следующий пример демонстрирует, как преобразовать TABDELIMITED в MHT в коде Java.
...
Нужно программно преобразовать файлы с ограничением по вкладкам (TABDELIMITED) в формат MHT? Разработчики, использующие код Java, могут легко преобразовать файлы TABDELIMITED в MHT всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования TABDELIMITED в MHT" %}}
{{% blocks/products/pf/agp/text %}}
