...
description: Python Código de exemplo para criação de gráficos de linhas para Excel usando a Biblioteca Python. Use este código para criar um gráfico de linhas para MS Excel em um aplicativo baseado em Python.
...
1. Adicione um gráfico de linhas à planilha
