---
title: Konvertieren Sie XLSX in MHTML über die Anwendung C++ 
weight: 4120
url: /de/cpp/conversion/xlsx-to-mhtml/ 
description: Beispiel-Umwandlungscode C++ für das XLSX-Dokument in das MHTML-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von XLSX in MHTML in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLSX in MHTML über C++" h2="Leistungsstarke XLSX-zu-MHTML-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLSX in MHTML mit C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von XLSX in MHTML über C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-Entwickler können XLSX-Dateien in nur wenigen Codezeilen ganz einfach in MHTML konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die XLSX-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (MHTML).1. Die MHTML-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die MHTML-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="XLSX-zu-MHTML-C++-Umwandlungsquellcode" offSpacer="" %}}
