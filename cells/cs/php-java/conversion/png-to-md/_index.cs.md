---
title: PHP PNG na MD - PNG na MD převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům PHP plně integrovaný přístup k převodu dat PNG do formátu MD, což umožňuje bezproblémové ukládání dat PNG do formátu MD pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na MD pomocí PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory PNG do formátu MD? Vývojáři v PHP mohou snadno načíst a převést soubor PNG do formátu MD pomocí několika řádků kódu.
...
1.  Převeďte číslo PNG na MD voláním metody save v sešitu Workbook.
1.  Získejte výsledek převodu PNG na MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP knihovna pro převod PNG na MD" %}}
