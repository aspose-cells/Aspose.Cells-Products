...
¿Necesitas convertir archivos de Excel a MHT mediante programación? Los desarrolladores de C++ pueden convertir fácilmente Excel a MHT con solo unas pocas líneas de código.
...
1.  Convierta EXCEL a MHT llamando al método Save().
