---
title: C# XLSB เป็น XML - XLSB เป็น XML Converter
description: Aspose Excel โซลูชันที่ครอบคลุมนี้มอบแนวทางแบบบูรณาการอย่างสมบูรณ์ให้กับนักพัฒนา C# ในการแปลง XLSB เป็นรูปแบบ XML ทำให้สามารถบันทึกข้อมูล XLSB ลงในรูปแบบ XML ได้อย่างราบรื่นโดยใช้ไลบรารี Aspose.Cells ทั้งหมดนี้ผ่านโค้ด C# ที่มีประสิทธิภาพและปรับแต่งได้
...
{{% blocks/products/pf/agp/content h2="บันทึก XLSB ลงใน XML ใน C#" %}}

ตัวอย่างต่อไปนี้แสดงวิธีการแปลง XLSB เป็น XML ใน C#
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง XLSB เป็น XML ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการแปลงไฟล์ XLSB เป็น XML โดยทางโปรแกรมหรือไม่ นักพัฒนา .NET สามารถโหลดและแปลง XLSB เป็น XML ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง XLSB เป็น XML โดยเรียกใช้เมธอด Workbook.Save
1.  รับผลลัพธ์การแปลง XLSB เป็น XML

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# ไลบรารีเพื่อแปลง XLSB เป็น XML" %}}
