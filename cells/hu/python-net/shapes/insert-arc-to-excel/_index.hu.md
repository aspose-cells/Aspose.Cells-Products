...
{{% blocks/products/pf/agp/content h2="Hogyan lehet ívet beszúrni Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az Arc Excel-fájlba való beszúrásának lépései a Python számon keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Ív beszúrása - Python" offSpacer="" %}}
