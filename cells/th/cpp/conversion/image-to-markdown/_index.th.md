---
title: C++ รูปภาพเป็น MARKDOWN - ตัวแปลงรูปภาพเป็น MARKDOWN
description: Aspose เอ็กเซล. แปลง IMAGE เป็น MARKDOWN อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ IMAGE เป็น MARKDOWN C++ บันทึก IMAGE เป็น MARKDOWN บันทึก IMAGE เป็น MARKDOWN โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึกภาพไปที่ MARKDOWN ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง IMAGE เป็น MARKDOWN ใน C++
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง IMAGE เป็น MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="md" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง IMAGE เป็น MARKDOWN โดยการเรียกเมธอด Save()
