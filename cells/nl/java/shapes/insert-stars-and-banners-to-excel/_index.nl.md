---
title:  Invoegen Sterren en banners invoegen in Excel via .NET
weight: 381
...
{{< blocks/products/pf/i18n/upper-banner h1="Invoegen Sterren en banners invoegen in Excel via Java" h2="Voeg objecten in met behulp van server-side API\'s zonder enige software zoals Microsoft of Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u sterren en banners invoegt in een Excel-bestand met behulp van Java" %}}

 Om Insert Stars And Banners in Excel-bestand in te voegen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om sterren en banners in te voegen in Excel-bestand via Java" %}}
...
+ Selecteer werkblad via de index.
 + Gebruik de[methode toevoegen](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)om Sterren en banners invoegen in het geselecteerde werkblad in te voegen
...
{{% blocks/products/pf/agp/code-block title="Invoegen Invoegen Sterren En Banners - Java" offSpacer="" %}}
