---
title: Java EXCEL'den PRN'ye - Çevrimiçi EXCEL'den PRN'ye Dönüştürücü
description: Aspose excel. Java Aspose.Cells. Java Aspose Cells. Ücretsiz Çevrimiçi Java EXCEL'i PRN kaydetme biçimine dönüştürün. Java EXCEL'den PRN biçimine. EXCEL'i PRN Java'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i PRN\'ye Ücretsiz Çevrimiçi Kaydet" %}}

Aşağıdaki örnek, EXCEL'in Java'de PRN'ye nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i PRN'ye dönüştürmek için kolay adımları izleyin. EXCEL dosyanızı yükleyin, ardından PRN dosyası olarak kaydedin. Hem EXCEL okuma hem de PRN yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı PRN içeriği ve biçimlendirmesi, orijinal EXCEL belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="EXCEL\'i Çevrimiçi PRN\'ye Dönüştürmek için Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i PRN via Java\'e Dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını programlı olarak PRN'ye dönüştürmeniz mi gerekiyor? Java geliştiricileri, EXCEL'i yalnızca birkaç satır kodla kolayca PRN'ye dönüştürebilir.
...
1.  EXCEL'in PRN'ye dönüştürme sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i PRN\'ye dönüştürmek için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
