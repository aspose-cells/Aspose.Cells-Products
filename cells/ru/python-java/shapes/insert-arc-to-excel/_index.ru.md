...
{{% blocks/products/pf/agp/content h2="Как вставить дугу в файл Excel с помощью Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке файла Arc в Excel с использованием Python via java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addArc(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить дугу в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить дугу — Python via java" offSpacer="" %}}
