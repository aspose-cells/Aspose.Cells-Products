...
url: /tr/net/merger/merge-xltm-to-jpg/ 
...
Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'deki JPG ile nasıl birleştirileceğini gösterir.
...
XLTM'i JPG ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kütüphanesi, XLTM\'i JPG ile birleştirmek için" %}}
