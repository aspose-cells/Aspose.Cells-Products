---
title:  Odblokuj dokument XLSB za pośrednictwem C++
weight: 7420
description: C++ przykładowy kod do odblokowania chronionego hasłem pliku XLSB w C++ Runtime Environment dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj pliki XLSB przez C++" h2="Usuń ochronę z arkuszy kalkulacyjnych Excel, w tym pliku XLSB, używając biblioteki C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak usunąć ochronę pliku XLSB za pomocą C++" %}}
...
1.  Załaduj zablokowany plik XLSB za pomocą CreateIWorkbook.
1.  Wywołaj funkcję Unprotect(), aby odblokować.
1.  Ustaw hasło na NULL za pomocą SetPassword.
1.  Zapisz plik XLSB w określonej lokalizacji.
