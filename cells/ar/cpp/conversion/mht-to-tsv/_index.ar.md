...
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل MHT إلى تنسيق TSV، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق TSV باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="حوّل MHT إلى TSV باستخدام C++" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى TSV في C++" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى TSV برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى TSV بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى TSV عن طريق استدعاء دالة Save().
