---
title: Convertir SPREADSHEETML en XLTM via Java 
url: /fr/java/conversion/spreadsheetml-to-xltm/ 
description: Exemple de code de conversion Java pour le format SPREADSHEETML en fichier XLTM. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers XLTM dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir SPREADSHEETML en XLTM à l\'aide de Java" %}}

 Afin de rendre SPREADSHEETML en XLTM, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SPREADSHEETML en XLTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier SPREADSHEETML en XLTM en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier SPREADSHEETML avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension XLTM et SaveFormat comme paramètres1. Vérifiez le chemin spécifié pour le fichier XLTM résultant
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion SPREADSHEETML vers XLTM Java" offSpacer="" %}}

```cs
// charger le fichier SPREADSHEETML dans une instance de Workbook
Workbook book = new Workbook("template.spreadsheetml");
// enregistrer SPREADSHEETML au format XLTM
