...
description: Aspose Excel. Convert JPEG to PDF quickly and easily with Aspose.Cells. C++ JPEG to PDF. C++ Save JPEG to PDF. Save JPEG as PDF using C++.
...
{{% cells-convert title="Sample Code to Convert JPEG to PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="pdf" IsLandingPage="true" language="cpp" %}}
