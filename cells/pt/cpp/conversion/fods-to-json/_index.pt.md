---
title: Converter FODS para JSON por meio do aplicativo C++ 
url: /pt/cpp/conversion/fods-to-json/ 
description: Exemplo de código de conversão C++ do documento FODS para o formato JSON. Os programadores podem usar esse código-fonte para conversão em lote de FODS para JSON em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter FODS para JSON via C++" h2="Conversão de FODS para JSON de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem converter facilmente o arquivo FODS para JSON em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo FODS usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (JSON).1. O arquivo JSON será salvo no caminho especificado.1. Abra o arquivo JSON em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de FODS para JSON C++" offSpacer="" %}}
