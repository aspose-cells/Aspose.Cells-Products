...
{{% blocks/products/pf/agp/content h2="Jak vložit poznámky do souboru XLSX přes Python" %}}
...
V Office 365 jsou poznámky pro anotace, můžete použít následující kód Python pro vkládání a odebírání poznámek v souboru XLSX.

{{% blocks/products/pf/agp/code-block title="Python ukázkový kód pro vložení a odstranění poznámek v souboru XLSX" offSpacer="" %}}
