---
title: Gabungkan JPEG ke POWERPOINT - Gabungkan JPEG ke POWERPOINT di C#
url: /id/net/merger/merge-jpeg-to-powerpoint/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan JPEG ke format penyimpanan POWERPOINT. C# Gabungkan JPEG ke format POWERPOINT. Gabungkan JPEG menjadi POWERPOINT di C#. JPEG Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPEG ke POWERPOINT Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPEG ke POWERPOINT di C#" %}}

Contoh berikut menunjukkan cara menggabungkan JPEG ke POWERPOINT di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan JPEG ke POWERPOINT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file POWERPOINT. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan JPEG menjadi POWERPOINT.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan JPEG ke POWERPOINT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk digabungkan JPEG ke POWERPOINT" %}}
