---
title: "Konvertálja az XLS-t SXC-vé a következőn keresztül: Python"
url: /hu/python-java/conversion/xls-to-sxc/
description: Mintakód az xls–sxc Python konverzióhoz. Használjon API példakódot a kötegelt xls fájlok sxc konvertálásához a Python alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja az XLS-t SXC-vé a következőn keresztül: Python" h2="Exportálja az Excel® táblázatokat SXC formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLS konvertálása SXC-vé a következővel: Python" %}}

 Az XLS SXC-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS-ből SXC-vé konvertálás lépései a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői könnyedén betölthetnek és konvertálhatnak XLS-fájlokat SXC-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal SXC kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott SXC fájl megadott elérési útját
