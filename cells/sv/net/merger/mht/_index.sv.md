...
1. Ladda alla MHT-filer med fullständig sökväg.1. Gör ett dokument som basfil1. Anropa den relevanta metoden för att sammanfoga och sammanfoga filer en efter en.1. Anropa metoden Save() och skicka filnamnet (fullständig sökväg) och formatet (MHT) som en parameter.1. Nu kan du öppna och använda MHT-filen i Microsoft Office, Adobe PDF eller något annat kompatibelt program.
