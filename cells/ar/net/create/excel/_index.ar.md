---
title: إنشاء EXCEL - إنشاء ملف EXCEL في C#
description: Aspose إكسل. أنشئ ملفات إكسل وتعامل معها بسهولة تامة باستخدام مكتبة Aspose.Cells for .NET. توفر هذه المكتبة القوية API حلاً مبسطاً وفعالاً لإنشاء ملفات إكسل وتعديلها وإدارتها مباشرةً ضمن تطبيقاتك C#، مما يلبي احتياجات المطورين بدقة عالية.
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء ملف إكسل في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف إكسل في C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة رقم C# لإنشاء ملف إكسل" %}}
