...
Segui i semplici passaggi per convertire MHTML in ET. Carica il tuo file MHTML, quindi salvalo semplicemente come file ET. Sia per la lettura MHTML che per la scrittura ET è possibile utilizzare nomi di file completi. Il contenuto e la formattazione dell'ET in uscita saranno identici al documento originale MHTML.
...
{{% blocks/products/pf/agp/content h2="Libreria PHP per convertire MHTML in ET" %}}
