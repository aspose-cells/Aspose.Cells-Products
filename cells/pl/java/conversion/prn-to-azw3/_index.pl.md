---
title: Java PRN do AZW3 - Konwerter PRN do AZW3
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji PRN do formatu AZW3, umożliwiając bezproblemowe zapisywanie danych PRN w formacie AZW3 za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN do AZW3 w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować PRN na AZW3 w kodzie Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować PRN do AZW3. Prześlij plik PRN, a następnie zapisz go jako plik AZW3. Zarówno do odczytu PRN, jak i zapisu AZW3 możesz używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie AZW3 będą identyczne z oryginalnym dokumentem PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji PRN na AZW3" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="prn" outformat="azw3" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować PRN na AZW3 via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki PRN do AZW3? Programiści Java mogą łatwo przekonwertować pliki PRN do AZW3 za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

1.  Zainstaluj 'Aspose.Cells for Java'.
1.  Dodaj odniesienie do biblioteki (zaimportuj bibliotekę) do swojego projektu Java.
1.  Załaduj plik PRN z wystąpieniem klasy Workbook.
1. Konwertuj PRN do AZW3 wywołując metodę Workbook.save.
1.  Pobierz wynik konwersji PRN na AZW3.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji PRN na AZW3" %}}
{{% blocks/products/pf/agp/text %}}
