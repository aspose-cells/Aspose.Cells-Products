---
title: C++ uygulaması aracılığıyla XLSX'i SPREADSHEETML'ye dönüştürün 
url: /tr/cpp/conversion/xlsx-to-spreadsheetml/ 
description: XLSX belgesi için SPREADSHEETML biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu XLSX'ten SPREADSHEETML'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla XLSX\'i SPREADSHEETML\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna gerek kalmadan C++ kitaplığını kullanarak yüksek performanslı XLSX\'ten SPREADSHEETML\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, yalnızca birkaç satır kodla XLSX dosyasını SPREADSHEETML'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak XLSX dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (SPREADSHEETML) dosya uzantısıyla iletin.1. SPREADSHEETML dosyası belirtilen yola kaydedilecektir.1. SPREADSHETML dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="XLSX - SPREADSHETML C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLSX\'ten SPREADSHEETML\'ye Dönüştürme Canlı Demoları" sectionDescription="[XLSX\'i SPREADSHETML\'ye dönüştür](https://products.aspose.app/cells/conversion/xlsx-to-spreadsheetml) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece XLSX dosyanızı yükleyin, anında SPREADSHEETML\'e dönüştürülecektir." >}}
