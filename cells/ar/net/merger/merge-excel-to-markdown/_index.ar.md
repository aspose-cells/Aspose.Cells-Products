---
title: دمج EXCEL في MARKDOWN - ادمج EXCEL في MARKDOWN في C#
url: /ar/net/merger/merge-excel-to-markdown/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني عبر الإنترنت EXCEL إلى تنسيق حفظ MARKDOWN. C# ادمج EXCEL بتنسيق MARKDOWN. دمج EXCEL في MARKDOWN في C#. EXCEL Merge.
...
{{% blocks/products/pf/agp/content h2="قم بدمج EXCEL في MARKDOWN في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج EXCEL مع MARKDOWN في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج EXCEL في MARKDOWN. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف MARKDOWN. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج EXCEL مع MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج EXCEL في MARKDOWN في C#" InputFormat="xlsx" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج EXCEL في MARKDOWN عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج EXCEL مع MARKDOWN برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة .NET لدمج EXCEL إلى MARKDOWN" %}}
