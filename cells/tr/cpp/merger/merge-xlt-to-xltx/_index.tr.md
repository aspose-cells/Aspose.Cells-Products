...
description: Aspose Excel'de. C++ Aspose.Cells. XLT'i XLTX kaydetme biçimiyle birleştirin. C++ XLT'i XLTX biçimiyle birleştirin. C++'de XLT'i XLTX ile birleştirin. XLT Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLT\'i C++\'de XLTX ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for C++'de XLT ile XLTX'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

XLT ile XLTX'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLTX dosyasına kaydedin. C++'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. XLT ile XLTX'i birleştiren C++ örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="XLT ile XLTX\'i C++\'de Birleştirmek için Örnek Kod" InputFormat="xlt" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLT\'i C++ aracılığıyla XLTX\'e Nasıl Birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

 XLT ile XLTX'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="C++ kitaplığı, XLT ile XLTX arasında birleştirilecek" %}}
