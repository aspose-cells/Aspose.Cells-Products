---
title: C++ uygulaması aracılığıyla MHTML'yi TXT'ye dönüştürün 

description: MHTML belgesi için TXT biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu MHTML'den TXT'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla MHTML\'yi TXT\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı MHTML\'den TXT\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak MHTML\'yi TXT\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ aracılığıyla MHTML\'yi TXT\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 C++ geliştiricileri, yalnızca birkaç satır kodla MHTML dosyasını kolayca TXT'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak MHTML dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (TXT) dosya uzantısıyla iletin.1. TXT dosyası belirtilen yola kaydedilecektir.1. TXT dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="MHTML\'den TXT\'ye C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="MHTML\'den TXT\'ye Dönüşüm Canlı Demoları" sectionDescription="[MHTML\'yi TXT\'ye Dönüştür](https://products.aspose.app/cells/conversion/mhtml-to-txt) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece MHTML dosyanızı yükleyin, anında TXT\'ye dönüştürülecektir." >}}
