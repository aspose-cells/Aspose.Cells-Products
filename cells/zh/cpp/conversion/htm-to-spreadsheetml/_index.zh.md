---
title: C++ HTM 到 SPREADSHEETML - HTM 到 SPREADSHEETML 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 HTM 转换为 SPREADSHEETML。C++ HTM 到 SPREADSHEETML。 C++ 将 HTM 保存到 SPREADSHEETML。使用 C++ 将 HTM 保存为 SPREADSHEETML。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 HTM 转换为 C++ 中的 SPREADSHEETML" h2="使用 C++ 库进行高性能 HTM 到 SPREADSHEETML 转换，无需安装 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何将 HTM 转换为 SPREADSHEETML？借助 Aspose.Cells for C++ 库，您可以通过几行代码以编程方式轻松将 HTM 转换为 SPREADSHEETML。[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 C++ Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。您可以直接下载最新版本，打开即可[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/)包管理器，搜索Aspose.Cells.cpp并安装。您还可以从包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/content h2="将 HTM 保存到 SPREADSHEETML 中的 C++" %}}

以下示例演示如何将 C++ 中的 HTM 转换为 SPREADSHEETML。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 HTM 转换为 SPREADSHEETML。上传您的 HTM 文件，然后将其保存为 SPREADSHEETML 文件。对于 HTM 读取和 SPREADSHEETML 写入，您可以使用完全限定的文件名。输出的 SPREADSHEETML 内容和格式将与原始 HTM 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 HTM 转换为 SPREADSHEETML 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C++ 将 HTM 转换为 SPREADSHEETML" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 HTM 文件转换为 SPREADSHEETML？ C++ 开发人员只需几行代码即可轻松将 HTM 转换为 SPREADSHEETML。
