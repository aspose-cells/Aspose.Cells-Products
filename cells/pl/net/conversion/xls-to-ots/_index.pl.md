---
title: C# XLS na OTS - XLS na konwerter OTS
description: Aspose Excel. Szybko i łatwo przekonwertuj numer XLS na OTS za pomocą Aspose.Cells. C# XLS na OTS. C# Zapisz XLS w OTS. Zapisz XLS jako OTS, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS w OTS w C#" %}}
...
{{% cells-convert title="Przykładowy kod do konwersji XLS na OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na OTS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na OTS? Programiści .NET mogą łatwo załadować i przekonwertować XLS na OTS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na OTS" %}}
