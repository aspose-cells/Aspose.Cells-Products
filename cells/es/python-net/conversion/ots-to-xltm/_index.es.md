...
description: Aspose Excel. Convierta OTS a XLTM rápida y fácilmente con Aspose.Cells. Python OTS a XLTM. Python Guarde OTS en XLTM. Guarde OTS como XLTM usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar OTS al XLTM en Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a XLTM en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir OTS a XLTM" %}}
