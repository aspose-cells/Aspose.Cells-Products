---
title: Sloučit XML do OTS – Kombinujte XML s OTS v Java
url: /cs/java/merger/merge-xml-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit XML do formátu OTS. Java Zkombinujte XML s formátem OTS. Sloučit XML do OTS v Java. XML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML do OTS v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XML do OTS v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XML do OTS. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru OTS. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí XML do OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XML do OTS na čísle Java" InputFormat="xml" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XML do OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit XML do OTS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna pro sloučení XML do OTS" %}}
