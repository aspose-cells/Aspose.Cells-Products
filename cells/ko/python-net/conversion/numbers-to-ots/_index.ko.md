---
title: 숫자를 OTS로 변환 Python via Python
description: 무료로 NUMBERS를 OTS 온라인으로 변환하세요. 무료 온라인 NUMBERS로 OTS 변환기. OTS에 Python 숫자. Python을 통해 OTS로 NUMBERS.
...
{{% cells-convert title="NUMBERS를 온라인에서 OTS로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="ots" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="NUMBERS를 OTS로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 Python 개발자는 단 몇 줄의 코드로 NUMBERS를 OTS로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook.save 메서드를 호출하여 NUMBERS를 OTS로 변환
