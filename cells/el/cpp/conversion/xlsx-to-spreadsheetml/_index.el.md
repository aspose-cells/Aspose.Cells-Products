...
description: Aspose Excel. Μετατρέψτε το XLSX σε SPREADSHEETML γρήγορα και εύκολα με το Aspose.Cells. C++ XLSX σε SPREADSHEETML. C++ Αποθήκευση XLSX στο SPREADSHEETML. Αποθηκεύστε το XLSX ως SPREADSHEETML χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση XLSX στο SPREADSHEETML στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή XLSX σε SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xml" IsLandingPage="true" language="cpp" %}}
