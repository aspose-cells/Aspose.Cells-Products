...
description: Sample code for CSV to XLSB C# conversion. Use API example code for batch CSV files to XLSB conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows CSV to XLSB C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e4585d48ff965fe72ca6c6c869efad7" "convert-csv-to-xlsb.cs" >}}
