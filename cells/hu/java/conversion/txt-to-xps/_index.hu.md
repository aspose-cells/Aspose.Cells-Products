...
{{% blocks/products/pf/agp/content h2="TXT konvertálása XPS-re a következővel: Java" %}}

 Ahhoz, hogy a TXT-t XPS-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TXT konvertálása XPS-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a TXT fájlt XPS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XPS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XPS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT-ből XPS-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése XPS-ként
