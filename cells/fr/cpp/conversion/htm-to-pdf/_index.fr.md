---
title: C++ HTM à PDF - Convertisseur HTM à PDF
description: Aspose Excel. Cette solution complète offre aux développeurs C++ une approche entièrement intégrée pour convertir le format HTM au format PDF, permettant un enregistrement transparent des données HTM au format PDF à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C++ efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en PDF dans C++" h2="Conversion HTM haute performance vers PDF utilisant la bibliothèque C++ sans avoir besoin de l\'installation d\'Excel, d\'OpenOffice ou d\'Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM à PDF dans C++" %}}
...
{{% cells-convert title="Exemple de code pour convertir du HTM en PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="pdf" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en PDF via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM au format PDF par programmation ? Les développeurs spécialisés en C++ peuvent facilement convertir des fichiers HTM au format PDF en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en PDF en appelant la méthode Save().
