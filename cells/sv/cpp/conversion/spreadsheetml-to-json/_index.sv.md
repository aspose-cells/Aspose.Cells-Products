...
Behöver du konvertera SPREADSHEETML-filer till JSON programmatiskt? C++-utvecklare kan enkelt konvertera SPREADSHEETML till JSON med bara några få rader kod.
...
1.  Konvertera SPREADSHEETML till JSON genom att anropa Save()-metoden.
