---
title: Gộp EXCEL vào ET - Gộp EXCEL sang ET theo số C#
url: /vi/net/merger/merge-excel-to-et/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất định dạng lưu EXCEL sang ET. C# Kết hợp định dạng EXCEL sang ET. Hợp nhất EXCEL với ET theo số C#. Hợp nhất EXCEL.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất EXCEL với ET theo số C#" %}}

Ví dụ sau đây minh họa cách hợp nhất EXCEL với ET trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất EXCEL với ET. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp ET. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất EXCEL với ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp EXCEL với ET số C#" InputFormat="xlsx" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất EXCEL với ET" %}}
