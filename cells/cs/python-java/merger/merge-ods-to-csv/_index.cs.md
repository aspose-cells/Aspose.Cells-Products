...
url: /cs/python-java/merger/merge-ods-to-csv/ 
...
Následující příklad ukazuje, jak sloučit ODS až CSV v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit ODS až CSV? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
