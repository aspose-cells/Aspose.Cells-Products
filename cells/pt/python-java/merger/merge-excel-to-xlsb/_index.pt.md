---
title:  Mesclar EXCEL para XLSB via Python
url: /pt/python-java/merger/merge-excel-to-xlsb/ 
description: Mesclar EXCEL para XLSB Online gratuitamente. Free Online EXCEL para XLSB Fusão. Mescle EXCEL para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar EXCEL para XLSB em Python.
...
{{% cells-merger title="Aplicativo gratuito para mesclar EXCEL para XLSB online" InputFormat="xlsx" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
