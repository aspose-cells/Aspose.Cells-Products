---
title: Gộp PRN thành MD - Gộp PRN thành MD trong Java
url: /vi/java/merger/merge-prn-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu PRN thành MD. Java Kết hợp định dạng PRN sang MD. Hợp nhất PRN thành MD theo số Java. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN vào MD theo số Java" %}}

Ví dụ sau đây minh họa cách hợp nhất PRN với MD trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất PRN với MD. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu nó vào tệp MD. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất PRN với MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp PRN vào MD số Java" InputFormat="prn" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất PRN vào MD via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất PRN vào MD" %}}
