---
title: Convertir XLSB en TIFF via C#
url: /fr/net/conversion/xlsb-to-tiff/
description: Exemple de code pour la conversion xlsb vers tiff C#. Utilisez l'exemple de code API pour les fichiers batch xlsb en conversion tiff dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers XLSB au format TIFF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier XLSB avec une instance de Workbook1. Appelez la méthode Workbook.Save1. Passer le chemin de sortie avec l'extension TIFF comme paramètre1. Vérifier le chemin spécifié pour le fichier TIFF résultant
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="tiff" IsLandingPage="true" %}}
