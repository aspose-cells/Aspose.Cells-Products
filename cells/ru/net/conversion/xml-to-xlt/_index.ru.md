...
Нужно программно преобразовать файлы XML в XLT? Разработчики .NET могут легко загружать и преобразовывать XML в XLT всего за несколько строк кода.
