---
title: Hợp nhất SPREADSHEETML thành SXC - Hợp nhất SPREADSHEETML thành SXC trong Java
url: /vi/java/merger/merge-spreadsheetml-to-sxc/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí SPREADSHEETML thành SXC saveformat. Java Kết hợp định dạng SPREADSHEETML thành SXC. Hợp nhất SPREADSHEETML thành SXC trong Java. Hợp nhất SPREADSHEETML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất SPREADSHEETML với SXC trong Java Trực tuyến miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất SPREADSHEETML thành SXC trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất SPREADSHEETML thành SXC. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp rồi lưu vào tệp SXC. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất SPREADSHEETML thành SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất SPREADSHEETML thành SXC trong Java" InputFormat="xml" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất SPREADSHEETML thành SXC via Java" %}}
