---
title: Konvertera XLS till PDF via Java 
weight: 600

description: Exempel Java-konverteringskod för XLS-format till PDF-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till PDF inom alla webb- eller skrivbordsbaserade program Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLS till PDF via Java" h2="XLS till PDF Java-konvertering för att konvertera enstaka eller flera sidor till PDF med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLS till PDF med Java" %}}

 För att rendera XLS till PDF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLS till PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLS-fil till PDF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLS-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med PDF-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande PDF-filen
...
{{% blocks/products/pf/agp/code-block title="XLS till PDF Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS till PDF-konvertering Live Demos" sectionDescription="[Konvertera XLS till PDF](https://products.aspose.app/cells/conversion/xls-to-pdf) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din XLS-fil, den konverteras omedelbart till PDF." >}}
