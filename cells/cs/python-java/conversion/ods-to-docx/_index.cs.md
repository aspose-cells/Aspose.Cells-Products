...
{{% blocks/products/pf/agp/content h2="Převeďte ODS na DOCX pomocí Python" %}}
...
Následující příklad ukazuje, jak převést ODS na DOCX v Python.
