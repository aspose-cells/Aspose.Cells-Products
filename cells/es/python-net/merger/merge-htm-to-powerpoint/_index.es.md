---
title: Combinar HTM con POWERPOINT - Combinar HTM con POWERPOINT en Python
url: /es/python-net/merger/merge-htm-to-powerpoint/ 
description: AsposeExcel. Python Aspose.Cells. Gratuito en línea Merge HTM to POWERPOINT saveformat. Python Combinar formato HTM a POWERPOINT. Combinar HTM con POWERPOINT en Python. Combinar HTM.
...
El siguiente ejemplo muestra cómo combinar HTM con POWERPOINT en Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Gratis en línea para fusionar HTM a POWERPOINT en Python" InputFormat="htm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar HTM a POWERPOINT a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar HTM con POWERPOINT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Las API se pueden hacer con solo unas pocas líneas de código.
