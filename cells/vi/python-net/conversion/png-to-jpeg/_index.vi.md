...
description: Aspose Excel. Chuyển đổi PNG sang JPEG nhanh chóng và dễ dàng với Aspose.Cells. Python PNG sang JPEG. Python Lưu PNG thành JPEG. Lưu PNG thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi PNG thành JPEG thành Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu PNG vào JPEG trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi PNG thành JPEG trong Python via NET.
...
{{% cells-convert title="Mã mẫu chuyển đổi PNG thành JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi PNG thành JPEG" %}}
