---
title:  Dodaj lub usuń XLSM Adnotacja via .NET
weight: 9890
description: Kod źródłowy C# do dodawania i usuwania adnotacji w formacie XLSM na platformach .NET Framework, .NET Core, Mono lub platformach Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Dodaj lub usuń adnotację od XLSM do C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń adnotacje z numerów XLSM–C#" offSpacer="" %}}
