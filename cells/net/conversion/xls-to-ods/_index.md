...
description: Sample code for xls to ods C# conversion. Use API example code for batch xls files to ods conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% cells-convert title="Free App and Sample Code to Convert XLS to ODS" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et InputFormat=xls outformat=ods IsLandingPage=true %}}
