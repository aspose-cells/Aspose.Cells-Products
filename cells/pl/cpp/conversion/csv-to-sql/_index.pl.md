...
Chcesz programowo przekonwertować pliki CSV na SQL? Programiści C++ mogą łatwo przekonwertować CSV na SQL w zaledwie kilku wierszach kodu.
...
1.  Przekonwertuj CSV na SQL, wywołując metodę Save().
