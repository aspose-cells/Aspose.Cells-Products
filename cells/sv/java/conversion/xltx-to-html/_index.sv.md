...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLTX till HTML med Java" %}}

 För att rendera XLTX till HTML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLTX till HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLTX-fil till HTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTX-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Skicka utdatasökväg med HTML-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande HTML-filen
...
{{% blocks/products/pf/agp/code-block title="XLTX till HTML Java omvandlingskällkod" offSpacer="" %}}
