...
url: /hu/net/merger/merge-htm-to-md/ 
...
A következő példa bemutatja, hogyan egyesítheti a HTM-et az MD-vel a Aspose.Cells for .NET számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a HTM-et az MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és az MD egyesítéséhez" %}}
