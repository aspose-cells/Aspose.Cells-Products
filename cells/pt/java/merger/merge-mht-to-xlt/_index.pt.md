---
title:  Mesclar MHT para XLT via Java
...
O exemplo a seguir demonstra como mesclar MHT para XLT em Java.
...
{{% cells-merger title="Aplicativo gratuito para mesclar MHT para XLT on-line" InputFormat="mht" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
