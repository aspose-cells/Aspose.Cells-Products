...
{{% blocks/products/pf/agp/content h2="如何使用 Python via Java 将流程图插入/创建到 Excel 文件中" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via Java 将流程图插入/创建到 Excel 文件的步骤" %}}
...
+ 通过索引选择工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)在选定的工作表中插入/创建流程图
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入/创建流程图 - Python via Java" offSpacer="" %}}
