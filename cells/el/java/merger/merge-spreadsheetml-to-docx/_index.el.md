---
title:  Συγχώνευση SPREADSHEETML στο DOCX via Java
url: /el/java/merger/merge-spreadsheetml-to-docx/ 
description: Συγχώνευση SPREADSHEETML στο DOCX Online δωρεάν. Δωρεάν Online SPREADSHEETML to DOCX Merger. Συγχώνευση SPREADSHEETML σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SPREADSHEETML στο DOCX στο Java.
