---
title: C# PNG až WORD - PNG až WORD Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu formátu PNG do formátu WORD, což umožňuje bezproblémové ukládání dat PNG do formátu WORD pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Uložte PNG na WORD v C#" %}}

Následující příklad ukazuje, jak převést číslo PNG na WORD v kódu C#.
...
{{% cells-convert title="Ukázkový kód pro převod čísla PNG na WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést PNG na WORD přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na WORD programově? Vývojáři .NET mohou snadno načíst a převést PNG na WORD v několika řádcích kódu.
...
1.  Převeďte číslo PNG na WORD voláním metody Workbook.Save.
1.  Získejte výsledek převodu PNG na WORD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod PNG na WORD" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/png-to-html/" name="PNG DO HTML" description="Hypertextový značkovací jazyk" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/png-to-md/" name="PNG MD" description="Jazyk Markdown" >}}
