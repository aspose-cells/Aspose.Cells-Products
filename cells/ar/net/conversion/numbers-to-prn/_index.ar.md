...
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل الأرقام إلى تنسيق PRN، مما يتيح حفظ بيانات الأرقام بسلاسة بتنسيق PRN باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في PRN في C#" %}}
...
هل تحتاج إلى تحويل ملفات NUMBERS إلى PRN برمجيًا؟ يمكن لمطوري .NET تحميل وتحويل الأرقام إلى PRN بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الأرقام إلى أرقام مرجعية عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل NUMBERS إلى PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الأرقام إلى PRN" %}}
