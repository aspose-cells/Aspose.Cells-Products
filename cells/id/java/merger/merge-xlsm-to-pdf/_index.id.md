---
title: Gabungkan XLSM menjadi PDF - Gabungkan XLSM menjadi PDF menjadi Java
url: /id/java/merger/merge-xlsm-to-pdf/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLSM menjadi PDF format simpan. Java Gabungkan format XLSM menjadi PDF. Gabungkan XLSM menjadi PDF di Java. XLSM Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSM menjadi PDF di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLSM menjadi PDF di Aspose.Cells for Java.
...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSM menjadi PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSM ke PDF secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan XLSM menjadi PDF" %}}
