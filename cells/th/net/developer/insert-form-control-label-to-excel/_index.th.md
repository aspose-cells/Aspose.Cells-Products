---
title: แทรกป้ายกำกับ (ตัวควบคุมฟอร์ม) ลงใน Excel via .NET
weight: 80
description: ซอร์สโค้ด C# เพื่อแทรก Label (Form control) ลงใน Excel บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกป้ายกำกับ (ตัวควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก Label (Form control) ลงในไฟล์ Excel ผ่าน C#" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addlabel) เพื่อแทรกป้ายกำกับ (ตัวควบคุมฟอร์ม) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกป้ายกำกับ(ตัวควบคุมแบบฟอร์ม) - C#" offSpacer="" %}}
