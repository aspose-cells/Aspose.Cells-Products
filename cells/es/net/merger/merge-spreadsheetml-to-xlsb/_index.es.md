---
title: Combine SPREADSHEETML con XLSB - Combine SPREADSHEETML con XLSB en C#
url: /es/net/merger/merge-spreadsheetml-to-xlsb/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea SPREADSHEETML a XLSB guardar formato. C# Combine SPREADSHEETML al formato XLSB. Combinar HOJA DE CALCULO a XLSB en C#. Combinar HOJA DE CALCULO.
...
El siguiente ejemplo muestra cómo fusionar SPREADSHEETML a XLSB en Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis en línea para fusionar SPREADSHEETML a XLSB en C#" InputFormat="xml" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar SPREADSHEETML a XLSB a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar SPREADSHEETML con XLSB mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
