---
title:  Combinar XLS a PDF via Java
...
El siguiente ejemplo muestra cómo combinar XLS con PDF en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a PDF en línea" InputFormat="xls" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
