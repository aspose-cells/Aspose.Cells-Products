...
Aşağıdaki örnek, XLSX'in Aspose.Cells for C++'de MHT ile nasıl birleştirileceğini gösterir.
...
XLSX'i programlı olarak MHT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
