...
description: Aspose Excel。 C++ Aspose.Cells。合并EXCEL为XLTM保存格式。 C++ 将EXCEL合并为XLTM格式。将EXCEL合并到C++中的XLTM。EXCEL合并。
...
{{% blocks/products/pf/agp/content h2="将EXCEL合并到C++中的XLTM" %}}
...
{{% cells-merger title="将 EXCEL 合并到 C++ 中的 XLTM 的示例代码" InputFormat="xlsx" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
