---
title:  Unisci i file CSV via .NET
weight: 6450
description: Codice sorgente C# per combinare i documenti CSV sulle piattaforme .NET Framework, .NET Core, Mono o Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci i formati CSV in C#" h2="Fusione di documenti CSV nativa e ad alte prestazioni utilizzando le API lato server Aspose.Cells for .NET, senza l\'uso di software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
+ Carica tutti i file CSV con percorso completo.
...
{{% blocks/products/pf/agp/code-block title="Unisci i file CSV - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "d7c757e7471bd38006ac0d35d221b2e2" "merge-csv-files.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{< blocks/products/pf/agp/demobox sectionTitle="Online CSV Fusione Demo Live" sectionDescription=" Unisci i documenti CSV adesso visitando il nostro[Sito web delle demo dal vivo](https://products.aspose.app/cells/merger). La demo live presenta i seguenti vantaggi" >}}
