---
title: Crie arquivos TSV por meio de Python 
url: /pt/python-java/create-tsv/ 
description: Python Código de amostra para gerar documentos TSV. Use este código para criar arquivos TSV no aplicativo Python.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Como criar TSV por meio de Python" %}}
...
1. Importe asposecells em seu arquivo de código.1. Crie a instância da classe Workbook.1. Acesse a primeira planilha da pasta de trabalho.1. Obtenha a(s) célula(s) desejada(s) da planilha e insira o valor na(s) célula(s).1. Use o método Save para salvar a pasta de trabalho como arquivo TSV.
