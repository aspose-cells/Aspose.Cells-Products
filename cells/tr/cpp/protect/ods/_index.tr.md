...
{{< blocks/products/pf/i18n/upper-banner h1="ODS Dosyalarını C++ aracılığıyla şifreleyin" h2=".NET Kitaplığı\'nı kullanarak ODS biçimi dahil Excel elektronik tablolarını parolayla koruyun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak ODS Dosyasını Nasıl Güvenli Hale Getirirsiniz?" %}}
...
1. IWorkbook sınıfını kullanarak ODS dosyasını yükleyin1. ProtectionType ve Password ile Protect(..) yöntemini kullanın1. Korumalı ODS dosyasını Save() yöntemiyle kaydedin
