...
url: /cs/net/merger/merge-prn-to-jpg/ 
...
Následující příklad ukazuje, jak sloučit PRN do JPG v Aspose.Cells for .NET.
...
Potřebujete sloučit PRN do JPG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna pro sloučení PRN do JPG" %}}
