...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) para insertar llamadas en la hoja de trabajo seleccionada
...
El siguiente código de ejemplo muestra cómo insertar una "burbuja de pensamiento: nube". Para obtener más tipos, consulte "Resumen de tipos de llamadas en bloque" a continuación.
