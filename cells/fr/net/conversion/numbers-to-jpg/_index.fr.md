---
title: C# NOMBRES en JPG - Convertisseur NOMBRES en JPG
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les nombres au format JPG, permettant un enregistrement transparent des données numériques au format JPG à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer les NUMÉROS au format JPG dans C#" %}}

L'exemple suivant montre comment convertir des NOMBRES en JPG dans C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en JPG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en JPG par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en JPG en quelques lignes de code.
...
1.  Convertissez les NOMBRES en JPG en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir des nombres en JPG" %}}
