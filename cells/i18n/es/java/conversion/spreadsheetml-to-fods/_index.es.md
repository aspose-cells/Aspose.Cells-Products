---
title: Convierta SPREADSHEETML a FODS a través de Java 
url: /es/java/conversion/spreadsheetml-to-fods/ 
description: Ejemplo de código de conversión Java para formato SPREADSHEETML a archivo FODS. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a FODS dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta SPREADSHEETML a FODS a través de Java" h2="Conversión de SPREADSHEETML a FODS Java para convertir páginas únicas o múltiples a FODS usando la biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SPREADSHEETML a FODS usando Java" %}}

 Para convertir SPREADSHEETML en FODS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SPREADSHEETML a FODS a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo SPREADSHEETML a FODS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo SPREADSHEETML con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión FODS y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo FODS resultante
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML a FODS Java Código fuente de conversión" offSpacer="" %}}

```cs
// cargue el archivo SPREADSHEETML en una instancia de Workbook
Workbook book = new Workbook("template.spreadsheetml");
// guardar HOJA DE CALCULO como FODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de SPREADSHEETML a FODS" sectionDescription="[Convertir HOJA DE CALCULO a FODS](https://products.aspose.app/cells/conversion/spreadsheetml-to-fods) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo SPREADSHEETML, se convertirá instantáneamente a FODS." >}}
