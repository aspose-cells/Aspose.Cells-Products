---
title: Połącz XLTX z NUMERAMI - Połącz XLTX z NUMERAMI w C++
url: /pl/cpp/merger/merge-xltx-to-numbers/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online XLTX do formatu zapisu NUMBERS. C++ Połącz XLTX w formacie NUMERY. Połącz XLTX z NUMBERS w C++. XLTX Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTX z NUMBERS w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić XLTX z NUMBERS w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić numer XLTX z NUMBERS. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku NUMBERS. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy XLTX z NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTX z NUMBERS w C++" InputFormat="xltx" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTX z NUMBERS za pośrednictwem C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić numer XLTX z NUMBERS? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLTX z NUMBERS" %}}
