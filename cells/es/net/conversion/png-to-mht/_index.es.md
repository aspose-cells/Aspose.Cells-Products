...
description: Aspose Excel. Convierta PNG a MHT rápida y fácilmente con Aspose.Cells. C# PNG a MHT. C# Guardar PNG en MHT. Guarde PNG como MHT usando C#.
...
{{% blocks/products/pf/agp/content h2="Guarde PNG en MHT en C#" %}}
...
{{% cells-convert title="Código de muestra para convertir PNG a MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a MHT a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PNG a MHT mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente PNG a MHT en solo unas pocas líneas de código.
