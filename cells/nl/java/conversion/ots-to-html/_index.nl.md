...
{{% blocks/products/pf/agp/content h2="Sla OTS op in HTML in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar HTML converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar HTML via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar HTML? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar HTML met slechts een paar regels code.
