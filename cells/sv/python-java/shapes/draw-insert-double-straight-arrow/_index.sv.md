...
{{% blocks/products/pf/agp/content h2="Hur man infogar dubbel rak pil i Excel-fil med Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga dubbel rak pil till Excel-fil med Python via java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) för att infoga en dubbel rak pil i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga dubbel rak pil - Python via java" offSpacer="" %}}
