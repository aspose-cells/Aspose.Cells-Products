---
title: OTS'yi MHT'ye Birleştir - OTS'yi MHT'ye Java'de birleştirin
url: /tr/java/merger/merge-ots-to-mht/ 
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi OTS'yi MHT kaydetme biçimine birleştirme. Java OTS'yi MHT biçimiyle birleştirin. Java'de OTS'yi MHT ile birleştirin. OTS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="Java Online\'da OTS\'yi MHT ile Ücretsiz Olarak Birleştirin" %}}
...
{{% cells-merger title="Java\'de OTS\'yi MHT ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="ots" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi MHT via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 OTS'yi MHT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
