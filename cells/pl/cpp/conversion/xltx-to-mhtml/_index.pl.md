---
title: Konwertuj XLTX na MHTML za pomocą aplikacji C++ 

description: Przykładowy kod konwersji C++ dla dokumentu XLTX do formatu MHTML. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTX na MHTML w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTX na MHTML za pomocą C++" %}}
 ...
 Aby przekonwertować XLTX na MHTML, użyjemy
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLTX na MHTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTX przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (MHTML).1. Plik MHTML zostanie zapisany pod określoną ścieżką.1. Otwórz plik MHTML w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLTX do MHTML C++" offSpacer="" %}}
