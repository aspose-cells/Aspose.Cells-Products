---
title: Sloučit TXT až EMF - Sloučit TXT až EMF v Java
url: /cs/java/merger/merge-txt-to-emf/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit TXT do EMF uložit formát. Java Kombinujte formát TXT až EMF. Sloučit TXT až EMF v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT až EMF v Java" %}}

Následující příklad ukazuje, jak sloučit TXT až EMF v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TXT do EMF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru EMF. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí TXT do EMF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení TXT až EMF v Java" InputFormat="txt" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit TXT do EMF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit TXT až EMF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení TXT až EMF" %}}
