...
url: /hu/net/merger/merge-xlsb-to-spreadsheetml/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLSB-et a SPREADSHEETML-be a Aspose.Cells-es for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLSB-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB és a SPREADSHEETML egyesítéséhez" %}}
