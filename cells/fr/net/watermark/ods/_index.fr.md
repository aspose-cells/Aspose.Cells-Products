...
weight: 4190
description: Code source C# pour ajouter ou supprimer un filigrane au fichier ODS sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter un filigrane au ODS via C#" %}}
