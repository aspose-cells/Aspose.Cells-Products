---
title: Folyamatábra beszúrása az Excelbe Python via Java
weight: 371
description: Python via Java forráskód a folyamatábra Excelbe való beillesztéséhez.
---
...
{{% blocks/products/pf/agp/content h2="Folyamatábra beszúrása Excel fájlba a Python via Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A folyamatábra beszúrásának lépései a Python via Java számú Excel-fájlba" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja a[módszer hozzáadása](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) a folyamatábra beszúrásához a kiválasztott munkalapba
...
{{% blocks/products/pf/agp/code-block title="Folyamatábra beszúrása - Python via Java" offSpacer="" %}}
