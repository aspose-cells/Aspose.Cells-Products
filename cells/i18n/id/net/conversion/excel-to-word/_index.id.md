...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi EXCEL ke WORD melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file EXCEL ke WORD hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file EXCEL dengan instance Workbook1. Panggil metode Workbook.Save1. Lewati jalur keluaran dengan ekstensi DOCX sebagai parameter1. Periksa jalur yang ditentukan untuk file WORD yang dihasilkan
...
{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi EXCEL ke WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="docx" IsLandingPage="true" %}}
