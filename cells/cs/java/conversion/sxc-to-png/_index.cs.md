...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na PNG pomocí Java" %}}

 K vykreslení SXC do PNG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na PNG prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SXC na PNG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí Workbook1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Chcete-li uložit výsledek ve formátu PNG, zavolejte metodu SheetRender.toImage
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu SXC na PNG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka převodu SXC na PNG" sectionDescription="[Převést SXC na PNG](https://products.aspose.app/cells/conversion/sxc-to-png) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor SXC, bude okamžitě převeden na PNG." >}}
