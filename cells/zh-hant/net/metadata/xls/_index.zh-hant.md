---
title: 檢視或編輯 XLS 檔案元資料 via .NET
weight: 1410
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上編輯或檢視 XLS 格式元資料。
