---
title: تحويل NUMBERS إلى XLSB عبر Java 
url: /ar/java/conversion/numbers-to-xlsb/ 
description: نموذج Java رمز تحويل لتنسيق NUMBERS إلى ملف XLSB. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى XLSB داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل NUMBERS إلى XLSB عبر Java" h2="تحويل NUMBERS إلى XLSB Java لتحويل صفحات مفردة أو صفحات متعددة إلى XLSB باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الأرقام إلى XLSB باستخدام Java" %}}

 من أجل تقديم NUMBERS إلى XLSB ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل الأرقام إلى XLSB عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java يمكن للمطورين بسهولة تحويل NUMBERS ملف إلى XLSB في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف NUMBERS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XLSB & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XLSB الناتج
...
{{% blocks/products/pf/agp/code-block title="NUMBERS إلى XLSB Java شفرة مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف NUMBERS في مثيل مصنف
Workbook book = new Workbook("template.numbers");
// احفظ الأرقام كـ XLSB
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS إلى XLSB عروض توضيحية مباشرة" sectionDescription="[تحويل الأرقام إلى XLSB](https://products.aspose.app/cells/conversion/numbers-to-xlsb) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف NUMBERS الخاص بك ، وسيتم تحويله على الفور إلى XLSB." >}}
