---
title: Python تحويل من TABDELIMITED إلى أرقام - محول من TABDELIMITED إلى أرقام
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين Python نهجًا متكاملًا تمامًا لتحويل تنسيق TABDELIMITED إلى تنسيق NUMBERS، مما يتيح حفظ بيانات TABDELIMITED بسلاسة في تنسيق NUMBERS باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود Python فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى أرقام في مكتبة Excel Python" h2="مكتبة Excel عالية السرعة Python لتحويل صيغ TABDELIMITED إلى NUMBERS. هذا حل برمجي احترافي لاستيراد وتصدير صيغ TABDELIMITED وNUMBERS والعديد من الصيغ الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل جدول TABDELIMITED إلى أرقام باستخدام مكتبة Excel رقم Python" %}}

 كيف يمكنني تحويل TABDELIMITED إلى أرقام؟ باستخدام مكتبة Aspose.Cells for Python، يمكنك بسهولة تحويل TABDELIMITED إلى أرقام برمجياً ببضعة أسطر من التعليمات البرمجية.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)قادر على إنشاء تطبيقات مشتركة بين الأنظمة الأساسية مع القدرة على إنشاء جميع ملفات Excel وتعديلها وتحويلها وعرضها وطباعتها. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات، بل يمكنه أيضًا عرض ملفات Excel كصور، وPDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT والمزيد، مما يجعله خيارًا مثاليًا لتبادل المستندات بتنسيقات متوافقة مع معايير الصناعة.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="احفظ ملف TABDELIMITED إلى أرقام في مكتبة Excel رقم Python" %}}

يوضح المثال التالي كيفية تحويل TABDELIMITED إلى NUMBERS في مكتبة Excel Python.
...
{{% cells-convert title="نموذج كود لتحويل TABDELIMITED إلى أرقام باستخدام مكتبة Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="tsv" outformat="numbers" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل الأرقام المفصولة بعلامات الجدولة إلى أرقام عبر الرقم Python" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات TABDELIMITED إلى أرقام برمجياً؟ يمكن للمطورين (Python) تحميل ملفات TABDELIMITED وتحويلها إلى أرقام بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
{{% blocks/products/pf/agp/content h2="Python مكتبة إكسل لتحويل TABDELIMITED إلى أرقام" %}}
