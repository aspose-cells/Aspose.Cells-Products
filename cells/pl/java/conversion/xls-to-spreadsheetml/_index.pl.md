...
{{% blocks/products/pf/agp/content h2="Konwertuj XLS na SPREADSHEETML używając Java" %}}
...
Poniższy przykład pokazuje, jak przekonwertować liczbę XLS na format SPREADSHEETML w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS do formatu SPREADSHEETML? Programiści Java mogą łatwo przekonwertować pliki XLS do formatu SPREADSHEETML za pomocą zaledwie kilku linijek kodu.
