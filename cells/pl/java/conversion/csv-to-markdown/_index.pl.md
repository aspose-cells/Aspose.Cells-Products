---
title: Konwertuj CSV na MARKDOWN za pomocą Java 
url: /pl/java/conversion/csv-to-markdown/ 
description: Przykładowy kod konwersji Java dla formatu CSV do pliku MARKDOWN. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do MARKDOWN w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj CSV na MARKDOWN za pomocą Java" h2="Konwersja CSV do MARKDOWN Java w celu konwersji jednej lub wielu stron do MARKDOWN przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować CSV na MARKDOWN za pomocą Java" %}}

 Aby wyrenderować CSV do MARKDOWN, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować CSV na MARKDOWN za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik CSV na MARKDOWN w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem MARKDOWN i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku MARKDOWN
...
{{% blocks/products/pf/agp/code-block title="CSV do MARKDOWN Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik CSV w instancji Workbook
Workbook book = new Workbook("template.csv");
// zapisz CSV jako MARKDOWN
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo konwersji CSV do MARKDOWN" sectionDescription="[Konwertuj CSV na MARKDOWN](https://products.aspose.app/cells/conversion/csv-to-markdown) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik CSV, zostanie on natychmiast przekonwertowany do MARKDOWN." >}}
