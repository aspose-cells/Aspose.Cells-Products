...
Hai bisogno di convertire i file OTS in MHT tramite codice? Gli sviluppatori di C++ possono facilmente convertire OTS in MHT in poche righe di codice.
...
1.  Convertire OTS in MHT chiamando il metodo Save().
