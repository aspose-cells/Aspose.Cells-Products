...
description: XLTM 創建者。在 C# 代碼中創建 XLTM 個文件。使用 VB.NET、Asp.NET 或任何基於 .NET 的應用程序生成 MS Excel XLTM 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 創建 XLTM 文件" h2="本機和高性能 MS Excel XLTM 使用服務器端 .NET API 以編程方式創建電子表格。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何通過 C# 創建 XLTM" %}}

{{% blocks/products/pf/agp/text %}}

開發人員可以很容易地創建、加載、修改和轉換 MS Excel XLTM 電子表格，只需幾行代碼即可運行不同的報告應用程序進行數據處理。
...
1. 使用 Save 方法將工作簿保存為 XLTM 文件。

{{% blocks/products/pf/agp/code-block title="使用 C# 創建 MS Excel XLTM 文件的示例代碼。" offSpacer="" %}}
