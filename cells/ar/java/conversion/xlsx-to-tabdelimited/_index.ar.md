---
title: تحويل XLSX إلى TABDELIMITED عبر Java 
url: /ar/java/conversion/xlsx-to-tabdelimited/ 
description: نموذج رمز تحويل Java لتنسيق XLSX إلى ملف TABDELIMITED. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel و OpenOffice إلى TABDELIMITED داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLSX إلى TABDELIMITED عبر Java" h2="XLSX إلى TABDELIMITED Java تحويل لتحويل صفحات مفردة أو صفحات متعددة إلى TABDELIMITED باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSX إلى TABDELIMITED باستخدام Java" %}}

 من أجل تقديم XLSX إلى TABDELIMITED ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLSX إلى TABDELIMITED عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل ملف XLSX بسهولة إلى TABDELIMITED في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف XLSX مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. تمرير مسار الإخراج مع امتداد TABDELIMITED & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف TABDELIMITED الناتج
...
{{% blocks/products/pf/agp/code-block title="XLSX إلى TABDELIMITED Java رمز مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف XLSX في مثيل مصنف
Workbook book = new Workbook("template.xlsx");
// احفظ XLSX كـ TABDELIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLSX إلى TABDELIMITED تحويل العروض الحية" sectionDescription="[تحويل XLSX إلى TABDELIMITED](https://products.aspose.app/cells/conversion/xlsx-to-tabdelimited) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف XLSX الخاص بك ، وسيتم تحويله على الفور إلى TABDELIMITED." >}}
