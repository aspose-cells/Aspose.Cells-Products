...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Extrahieren von Metadaten von XLSB über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Metadaten von XLSB extrahieren - Java" offSpacer="" %}}
