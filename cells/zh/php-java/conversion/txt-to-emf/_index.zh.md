---
title: PHP TXT 至 EMF - TXT 至 EMF 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 TXT 转换为 EMF。PHP TXT 转换为 EMF。PHP 将 TXT 保存为 EMF。使用 PHP 将 TXT 保存为 EMF。
...
{{% cells-convert title="将 TXT 转换为 EMF 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="emf" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 PHP 将 TXT 转换为 EMF" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 TXT 文件转换为 EMF 吗？ PHP 开发人员只需几行代码即可轻松加载 TXT 并将其转换为 EMF。
...
1. 使用工作簿实例加载 TXT 文件。
1. 通过调用Workbook的save方法将TXT转换为EMF。
1. 获取TXT到EMF的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP库将TXT转换为EMF" %}}
