...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 開發人員只需幾行代碼即可輕鬆地將 MHTML 文件轉換為 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加載 MHTML 文件。1. 調用 Save() 方法。1. 傳遞帶有 (PDF) 文件擴展名的輸出文件路徑。1. PDF 文件將保存在指定的路徑。1. 在兼容程序中打開 PDF 文件。
...
{{% blocks/products/pf/agp/code-block title="MHTML 到 PDF C++ 轉換源代碼" offSpacer="" %}}
