---
title: Java XML vers FODS - Convertisseur XML vers FODS en ligne
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XML en format de sauvegarde FODS. Java XML au format FODS. Enregistrez XML dans FODS Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XML au format FODS dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XML en FODS dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XML en FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en FODS par programmation ? Les développeurs Java peuvent facilement convertir XML en FODS en seulement quelques lignes de code.
...
1.  Convertissez XML en FODS en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de XML en FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="bibliothèque Java pour convertir XML en FODS" %}}
{{% blocks/products/pf/agp/text %}}
