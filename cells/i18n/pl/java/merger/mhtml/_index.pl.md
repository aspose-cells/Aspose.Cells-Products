...
{{< blocks/products/pf/i18n/upper-banner h1="Scal formaty MHTML w Java" h2="Natywne scalanie dokumentów MHTML przy użyciu interfejsów API Java po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki scalania plików MHTML w Java" %}}
...
+ zapisz scalony plik MHTML pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Scal pliki MHTML — Java" offSpacer="" %}}

```cs
// Otwórz pierwszy plik MHTML.
Workbook mhtmlFile1 = new Workbook("chartsFileWithPath.mhtml");

// Zdefiniuj drugą książkę źródłową.
// Otwórz drugi plik MHTML.
