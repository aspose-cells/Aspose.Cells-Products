---
title: تحويل الأرقام إلى ODS عبر Java 

description: نموذج Java رمز تحويل لتنسيق NUMBERS إلى ملف ODS. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى ODS من خلال أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الأرقام إلى ODS عبر Java" h2="تحويل الأرقام إلى ODS Java لتحويل صفحة واحدة أو صفحات متعددة إلى ODS باستخدام مكتبة Java داخل الشركة." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الأرقام إلى ODS باستخدام Java" %}}

 من أجل تحويل الأرقام إلى ODS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل الأرقام إلى ODS عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج Java تحويل ملفات NUMBERS بسهولة إلى ODS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف NUMBERS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد ODS & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف ODS الناتج
...
{{% blocks/products/pf/agp/code-block title="الأرقام إلى شفرة مصدر تحويل Java ODS" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS to ODS Conversion Live Demos" sectionDescription="[تحويل الأرقام إلى ODS](https://products.aspose.app/cells/conversion/numbers-to-ods) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف NUMBERS الخاص بك ، وسيتم تحويله على الفور إلى ODS." >}}
