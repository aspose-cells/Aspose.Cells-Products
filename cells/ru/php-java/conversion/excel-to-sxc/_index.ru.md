...
{{% blocks/products/pf/agp/content h2="Как преобразовать EXCEL в SXC с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы EXCEL в формат SXC? PHP-разработчики могут легко загрузить и преобразовать файлы EXCEL в формат SXC всего несколькими строками кода.
...
1.  Преобразуйте файл EXCEL в формат SXC, вызвав метод сохранения рабочей книги.
1.  Получите результат преобразования EXCEL в SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-библиотека для преобразования EXCEL в SXC" %}}
