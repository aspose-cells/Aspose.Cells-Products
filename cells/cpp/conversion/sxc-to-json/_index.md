...
description: Sample C++ conversion code for SXC document to JSON format. Programmers can use this source code for batch SXC to JSON conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="SXC to JSON C++ Conversion Source Code" offSpacer="" %}}
