---
title: 解鎖ODS文檔via .NET
weight: 3110
description: 用於解鎖 .NET Framework、.NET Core、Mono 或 Xamarin 平台上受密碼保護的 ODS 檔案的 C# 原始碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C# 解鎖 ODS 電子表格" h2="使用 .NET 庫刪除 ODS 的保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 解鎖 ODS" %}}
