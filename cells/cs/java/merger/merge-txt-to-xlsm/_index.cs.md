---
title:  Sloučit TXT až XLSM via Java
...
Následující příklad ukazuje, jak sloučit TXT až XLSM v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až XLSM online" InputFormat="txt" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
