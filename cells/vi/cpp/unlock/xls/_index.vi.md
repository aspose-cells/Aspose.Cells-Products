...
{{< blocks/products/pf/i18n/upper-banner h1="Mở khóa tệp XLS qua C++" h2="Xóa bảo vệ khỏi bảng tính Excel bao gồm cả tệp XLS bằng cách sử dụng C++ Thư viện." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách xóa bảo vệ tệp XLS bằng cách sử dụng C++" %}}
...
1. Tải tệp bị khóa XLS bằng CreateIWorkbook.1. Gọi hàm Unprotect () để mở khóa.1. Đặt mật khẩu thành NULL bằng SetPassword.1. Lưu tệp XLS tại một vị trí được chỉ định.
