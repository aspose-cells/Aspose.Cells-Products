...
{{% blocks/products/pf/agp/content h2="Как вставить изображение в файл Excel с помощью Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке изображения в файл Excel через Python" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию изображений[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)), чтобы вставить изображение на выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить изображение - Python" offSpacer="" %}}
