---
title: TXT'i OTS ile birleştir - TXT'i Java'de OTS ile birleştir
url: /tr/java/merger/merge-txt-to-ots/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i OTS kaydetme biçimiyle birleştirin. Java TXT'i OTS formatıyla birleştirin. TXT'i Java'deki OTS ile birleştirin. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'deki OTS ile birleştir" %}}

Aşağıdaki örnek, TXT'in Aspose.Cells for Java'deki OTS ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT'i OTS ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından OTS dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT'i OTS ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT\'i Java\'deki OTS ile Birleştirmek için Örnek Kod" InputFormat="txt" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT\'i OTS via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TXT'i OTS ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesi, TXT\'i OTS ile birleştirecek" %}}
