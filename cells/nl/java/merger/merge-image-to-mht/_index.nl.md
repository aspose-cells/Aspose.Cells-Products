---
title: IMAGE samenvoegen met MHT - Combineer IMAGE met MHT in Java
url: /nl/java/merger/merge-image-to-mht/ 
description: Aspose Excel. Java Aspose.Cells. IMAGE samenvoegen naar MHT-opslagformaat. Java Combineer IMAGE naar MHT-formaat. IMAGE samenvoegen met MHT in Java. IMAGE samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg AFBEELDING samen met MHT in Java" %}}

Het volgende voorbeeld laat zien hoe u IMAGE kunt samenvoegen met MHT in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om IMAGE samen te voegen met MHT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een MHT-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java waarin IMAGE wordt samengevoegd met MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om IMAGE samen te voegen met MHT in Java" InputFormat="png" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe IMAGE samen te voegen met MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u IMAGE programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java-bibliotheek om IMAGE samen te voegen met MHT" %}}
