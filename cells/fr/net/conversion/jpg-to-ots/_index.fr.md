---
title: C# JPG en OTS - Convertisseur JPG en OTS
description: Aspose Exceller. Convertissez JPG en OTS rapidement et facilement avec Aspose.Cells. C# JPG en OTS. C# Enregistrez JPG sur OTS. Enregistrez JPG au format OTS en utilisant le C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer JPG sur OTS dans C#" %}}
...
{{% cells-convert title="Exemple de code pour convertir JPG en OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en OTS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en OTS par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en OTS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en OTS" %}}
