...
description: Aspose Exceller. Convertissez XLSM en CSV rapidement et facilement avec Aspose.Cells. Python XLSM en CSV. Python Enregistrez XLSM en CSV. Enregistrez XLSM sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLSM au CSV au Python" %}}

L'exemple suivant montre comment convertir XLSM en CSV dans Python.
...
{{% cells-convert title="Exemple de code pour convertir XLSM en CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="csv" IsLandingPage="true" language="pythonjava" %}}
