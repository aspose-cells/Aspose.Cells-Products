---
title:  Ubah PNG menjadi PRN Java
description: Ubah PNG menjadi PRN Online Gratis. Gratis Online PNG ke Konverter PRN. Java PNG ke PRN. PNG ke PRN via Java.
keywords: Convert PNG, PNG Converter, PNG to PDF, PNG to Word, PNG to PPT, PNG to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah PNG menjadi PRN via Java" h2="PNG ke konversi PRN Java untuk mengonversi satu atau beberapa halaman ke PRN menggunakan pustaka Java lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
Ikuti langkah-langkah mudah untuk mengonversi PNG ke PRN. Unggah file PNG Anda, lalu simpan sebagai file PRN. Untuk membaca PNG dan menulis PRN, Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan pemformatan PRN keluaran akan identik dengan dokumen asli PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi PNG ke PRN Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah PNG menjadi PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Pengembang Java dapat dengan mudah mengubah PNG menjadi PRN hanya dalam beberapa baris kode.
