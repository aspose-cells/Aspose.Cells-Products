...
<p>Aspose.Cells for .NET includes the following features:</p> -->
 ...
 Импорт формул из таблицы дизайнера
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Усечь длинное имя листа &amp; заменять недопустимые символы во время выполнения
    </p>
   </div>
   <div class="col-lg-4">
...
Поддержка CSV (значения, разделенные запятыми) &amp; TSV (значения разделены табуляцией)
 ...
 Преобразование электронных таблиц в PDF, XPS и amp; HTML Форматы
    ...
    <p>
 Aspose.Cells for .NET способен конвертировать электронные таблицы в PDF, XPS и amp; HTML при сохранении высочайшей визуальной точности. Процесс преобразования прост, но надежен, что делает API идеальным выбором для организаций, которым требуется обмениваться документами в любом из стандартных отраслевых форматов.
    </p>
