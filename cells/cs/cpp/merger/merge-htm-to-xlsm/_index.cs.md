---
title:  Sloučit HTM na XLSM přes C++
url: /cs/cpp/merger/merge-htm-to-xlsm/ 
description: Sloučit HTM na XLSM Online zdarma. Bezplatné online spojení HTM na XLSM. Sloučit HTM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit HTM s XLSM v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení HTM na XLSM online" InputFormat="htm" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
