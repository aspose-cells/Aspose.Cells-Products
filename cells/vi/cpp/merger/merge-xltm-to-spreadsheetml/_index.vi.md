---
title: Gộp XLTM vào SPREADSHEETML - Gộp XLTM vào SPREADSHEETML trong C++
url: /vi/cpp/merger/merge-xltm-to-spreadsheetml/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất XLTM thành định dạng lưu SPREADSHEETML. C++ Kết hợp XLTM thành định dạng SPREADSHEETML. Hợp nhất XLTM vào SPREADSHEETML trong C++. XLTM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLTM vào SPREADSHEETML trong C++" %}}

Ví dụ sau đây minh họa cách hợp nhất XLTM với SPREADSHEETML trong Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất XLTM vào SPREADSHEETML. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SPREADSHEETML. Nếu bạn phát triển mã theo số C++, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C++ hợp nhất XLTM với SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất XLTM vào SPREADSHEETML trong C++" InputFormat="xltm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XLTM vào SPREADSHEETML qua C++" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất XLTM vào SPREADSHEETML theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ để hợp nhất XLTM vào SPREADSHEETML" %}}
