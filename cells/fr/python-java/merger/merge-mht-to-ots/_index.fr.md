---
title: Fusionner MHT à OTS - Combiner MHT à OTS en Python
url: /fr/python-java/merger/merge-mht-to-ots/ 
description: Aspose Excel. Python Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde OTS. Python Combinez le format MHT au format OTS. Fusionner MHT à OTS en Python. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT à OTS en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT à OTS en Python en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT à OTS dans Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT à OTS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier OTS. Si vous développez du code en Python, ce sera plus simple qu'il n'y paraît. Voir l'exemple Python qui fusionne MHT à OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner MHT à OTS en Python" InputFormat="mht" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT à OTS via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner MHT à OTS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Python bibliothèque pour fusionner MHT à OTS" %}}
