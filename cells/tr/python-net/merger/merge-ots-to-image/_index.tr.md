---
title: OTS'yi IMAGE ile Birleştir - Python'de OTS'yi IMAGE ile birleştirin
url: /tr/python-net/merger/merge-ots-to-image/ 
description: Aspose excel. Python Aspose.Cells. Ücretsiz Çevrimiçi OTS'yi IMAGE kaydetme biçimine birleştirme. Python OTS'yi IMAGE formatına birleştirin. Python'de OTS'yi IMAGE ile birleştirin. OTS Birleştirin.
...
{{% cells-merger title="Python\'de OTS\'yi IMAGE ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="ots" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Python aracılığıyla OTS\'yi IMAGE ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 OTS'yi IMAGE ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
