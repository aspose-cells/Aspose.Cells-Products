...
url: /cs/cpp/merger/merge-prn-to-xltx/ 
...
Následující příklad ukazuje, jak sloučit PRN s XLTX v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení PRN s XLTX v C++" InputFormat="prn" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na XLTX přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s XLTX programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení PRN s XLTX" %}}
