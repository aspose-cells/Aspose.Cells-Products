---
title: Java Réparer le fichier ods - Réparer le fichier ods en ligne gratuitement
url: /fr/java/recovery/repair-ods/ 
description: Aspose Excel. Java Aspose.Cells. Java Réparer le fichier ods. Outil de réparation d'ods en ligne gratuit. Réparez un fichier ods corrompu. Récupérez un fichier ods corrompu dans l'application Java.
...
{{% blocks/products/pf/agp/content h2="Comment réparer le fichier ods dans Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de réparer le fichier ods par programmation ? Les développeurs Java peuvent facilement charger et réparer le fichier ods en seulement quelques lignes de code.
...
{{% cells-recovery title="Application gratuite et exemple de code pour réparer le fichier ODS en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="java" %}}    
    
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour réparer le fichier ODS" %}}
