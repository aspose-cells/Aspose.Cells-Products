...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML para SXC via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos HTML para SXC em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo HTML com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão SXC como parâmetro1. Verifique o caminho especificado para o arquivo SXC resultante
