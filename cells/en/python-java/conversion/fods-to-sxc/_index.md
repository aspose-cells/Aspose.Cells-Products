...
description: Sample code for fods to sxc Python conversion. Use API example code for batch fods files to sxc conversion within Python application.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert FODS to SXC via Python" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert FODS to SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="sxc" IsLandingPage="true" language="python" %}}
