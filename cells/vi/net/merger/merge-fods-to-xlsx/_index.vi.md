---
title: Hợp nhất FODS thành XLSX - Hợp nhất FODS thành XLSX thành C#
url: /vi/net/merger/merge-fods-to-xlsx/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí FODS thành XLSX saveformat. C# Kết hợp định dạng FODS thành XLSX. Hợp nhất FODS thành XLSX thành C#. FODS Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất FODS thành XLSX trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất FODS thành XLSX trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất FODS thành XLSX. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp XLSX. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất FODS thành XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Hợp nhất trực tuyến miễn phí FODS thành XLSX trong C#" InputFormat="fods" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất FODS thành XLSX qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất FODS thành XLSX theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất FODS thành XLSX" %}}
