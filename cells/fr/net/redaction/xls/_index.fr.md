---
title:  Rechercher et remplacer du texte dans le document XLS via .NET
weight: 7280
description: C# code source pour supprimer les informations sensibles dans le fichier XLS sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
