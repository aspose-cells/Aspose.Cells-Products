...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können XLSM-Dateien in nur wenigen Codezeilen einfach in XPS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die XLSM-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (XPS).1. Die XPS-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die XPS-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="XLSM-zu-XPS-C++-Umwandlungsquellcode" offSpacer="" %}}
