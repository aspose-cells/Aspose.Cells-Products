---
title: PHP PRN to NUMBERS - Конвертер PRN в числа
description: Aspose Excel. Это комплексное решение предоставляет PHP-разработчикам полностью интегрированный подход к преобразованию PRN-данных в числовой формат, обеспечивая беспрепятственное сохранение PRN-данных в числовой формат с помощью библиотеки Aspose.Cells, и все это посредством эффективного и настраиваемого PHP-кода.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать PRN в числа с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать PRN-файлы в числа? PHP-разработчики могут легко загрузить и преобразовать PRN-файлы в числа всего несколькими строками кода.
...
1.  Преобразуйте PRN в числа, вызвав метод save объекта Workbook.
1.  Получите результат преобразования PRN в NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-библиотека для преобразования PRN в числа." %}}
