---
title: Python XLS - XLT - XLS - XLT Átalakító
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a Python fejlesztők számára a XLS formátum XLT formátumba konvertálásához, lehetővé téve a XLS adatok zökkenőmentes mentését XLT formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható Python kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="A XLS konvertálása XLT-re a Python Excel könyvtárban" h2="Nagy sebességű Python excel könyvtár a XLS XLT-re konvertálásához. Ez egy professzionális szoftvermegoldás a XLS, XLT és sok más formátum importálásához és exportálásához a Python szám használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="A XLS konvertálása XLT-re a Python Excel könyvtár használatával" %}}

 Hogyan alakíthatom át a XLS-et XLT-re? A Aspose.Cells for Python könyvtárral könnyedén konvertálhatja a XLS-et programozottan XLT-re néhány sor kóddal.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)képes többplatformos alkalmazások létrehozására, amelyek képesek az összes Excel fájl generálására, módosítására, konvertálására, renderelésére és nyomtatására. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mentse a XLS-XLT számot a Python Excel könyvtárban" %}}

A következő példa bemutatja, hogyan lehet a XLS-et XLT-re konvertálni a Python Excel könyvtárban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS XLT-re konvertálásához. Töltse fel a XLS fájlt, majd egyszerűen mentse el XLT fájlként. Mind a XLS olvasáshoz, mind a XLT íráshoz használhat teljesen minősített fájlneveket. A XLT kimeneti tartalom és formázás megegyezik az eredeti XLS dokumentummal.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mintakód a XLS XLT-es konvertálásához a Python Excel könyvtáron keresztül" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="xlt" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="A XLS konvertálása XLT-re a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

XLS fájlt programozottan XLT-re kell konvertálni? A Python fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a XLS-et XLT-re.
...
1.  Konvertálja a XLS-et XLT-re a Workbook.save metódus meghívásával.
1.  Szerezze meg a XLS-es konverziós eredményt XLT-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel-könyvtár a XLS konvertálásához XLT-re" %}}
