...
url: /cs/python-java/merger/merge-spreadsheetml-to-ots/ 
...
Následující příklad ukazuje, jak sloučit SPREADSHEETML do OTS v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit SPREADSHEETML do OTS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
