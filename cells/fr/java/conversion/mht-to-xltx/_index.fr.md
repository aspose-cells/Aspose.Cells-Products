---
title: Java MHT à XLTX - Convertisseur en ligne MHT à XLTX
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertissez MHT en format de sauvegarde XLTX. Java MHT au format XLTX. Enregistrez MHT au XLTX Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez MHT au XLTX en Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir MHT en XLTX en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir MHT en XLTX. Téléchargez votre fichier MHT, puis enregistrez-le simplement en tant que fichier XLTX. Pour la lecture MHT et l'écriture XLTX, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie XLTX seront identiques au document MHT d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir MHT en XLTX en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHT en XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en XLTX par programmation ? Les développeurs Java peuvent facilement convertir MHT en XLTX en quelques lignes de code seulement.
...
1.  Convertissez MHT en XLTX en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de MHT en XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="bibliothèque Java pour convertir MHT en XLTX" %}}
{{% blocks/products/pf/agp/text %}}
