...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert button to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addbutton) to insert a button in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert Button - C#" offSpacer="" %}}
