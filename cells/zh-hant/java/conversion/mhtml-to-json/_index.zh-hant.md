...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 MHTML 轉換為 JSON" %}}

 為了將 MHTML 呈現為 JSON，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 MHTML 轉換為 JSON 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 MHTML 文件轉換為 JSON。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 類的實例加載 MHTML 文件1. 使用 Cells.createRange 方法創建要導出的數據范圍1. 使用 Range 和 ExportRangeToJsonOptions 的引用調用 JsonUtility.exportRangeToJson 方法1. 通過 BufferedWriter.write 方法將字符串 JSON 數據寫入文件
...
{{% blocks/products/pf/agp/code-block title="MHTML 到 JSON Java 轉換源代碼" offSpacer="" %}}
