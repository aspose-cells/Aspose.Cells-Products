...
weight: 1410
description: Mã nguồn C# để chỉnh sửa hoặc xem siêu dữ liệu định dạng XLS trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất XLS Siêu dữ liệu via .NET" h2="Xây dựng ứng dụng .NET của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ các tệp XLS bằng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
+ Load XLS bằng instance Workbook
