...
Potřebujete převést soubory IMAGE na HTM programově? C++ vývojáři mohou snadno převést IMAGE na HTM v několika řádcích kódu.
...
1. Převeďte IMAGE na HTM voláním metody Save().
