---
title: XLS दस्तावेज़ को .NET के माध्यम से सुरक्षित और लॉक करें 
weight: 7010
url: /hi/net/protect/xls/ 
description: .NET Framework, .NET Core, Mono या Xamarin Platforms पर पासवर्ड का उपयोग करके XLS फ़ाइल को लॉक करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# के माध्यम से XLS फ़ाइलें एन्क्रिप्ट करें" h2=".NET लाइब्रेरी का उपयोग करके एक्सएलएस प्रारूप सहित एक्सेल स्प्रेडशीट को पासवर्ड से सुरक्षित रखें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से XLS को सुरक्षित रखें" %}}
...
1. XLS फ़ाइल के पथ के साथ कार्यपुस्तिका वर्ग को त्वरित करें1. सुरक्षा जोड़ने के लिए डिफ़ॉल्ट या कोई वर्कशीट प्राप्त करें1. वर्कशीट के साथ वर्कशीट को सुरक्षित रखें। प्रोटेक्ट मेथड1. कार्यपुस्तिका के साथ कार्यपुस्तिका को सुरक्षित रखें। विधि को सुरक्षित रखें1. परिणाम को XLS प्रारूप में सहेजें
