...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in XLSB in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar XLSB in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar XLSB of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar XLSB? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar XLSB met slechts een paar regels code.
