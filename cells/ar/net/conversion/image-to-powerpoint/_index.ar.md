---
title: C# صورة إلى POWERPOINT - صورة لتحويل POWERPOINT
description: Aspose اكسل. قم بتحويل IMAGE إلى POWERPOINT بسرعة وسهولة باستخدام Aspose.Cells. C# IMAGE إلى POWERPOINT. C# حفظ الصورة في برنامج Powerpoint. احفظ الصورة كـ POWERPOINT باستخدام C#.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في POWERPOINT في C#" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى POWERPOINT في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الصورة إلى POWERPOINT عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى POWERPOINT برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى POWERPOINT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل IMAGE إلى POWERPOINT عن طريق استدعاء أسلوب Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى POWERPOINT" %}}
