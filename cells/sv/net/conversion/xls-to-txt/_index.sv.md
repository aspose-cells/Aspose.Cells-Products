---
title: C# XLS till TXT - XLS till TXT Omvandlare
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till TXT-format, vilket möjliggör sömlös sparning av XLS-data till TXT-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till TXT i C#" %}}

Följande exempel visar hur man konverterar XLS till TXT i C#.
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till TXT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till TXT programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till TXT på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C#-biblioteket för att konvertera XLS till TXT" %}}
