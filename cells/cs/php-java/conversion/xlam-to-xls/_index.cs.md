---
title: Konvertor PHP XLAM až XLS - XLAM až XLS
description: Aspose Excel. Převeďte XLAM na XLS rychle a snadno pomocí Aspose.Cells. PHP XLAM na XLS. PHP Uložte XLAM na XLS. Uložte XLS jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xls" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na XLS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na XLS programově? Vývojáři PHP mohou snadno načíst a převést XLAM na XLS v několika řádcích kódu.
...
1.  Převeďte XLAM na XLS voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na XLS" %}}
