...
description: Aspose エクセル。 C# Aspose.Cells。ODS を XLT の保存形式にマージします。 C# ODS と XLT の形式を結合します。 ODS から XLT を C# に結合します。ODS を結合します。
...
{{% cells-merger title="ODS から XLT を C# にマージするサンプルコード" InputFormat="ods" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
