...
{{% blocks/products/pf/agp/content h2="How to Merge NUMBERS to CSV File Using C#" %}}
 ...
 In order to merge NUMBERS to CSV file, we will use [Aspose.Cells for .NET](https://products.aspose.com/cells/net) API which is a feature-rich, powerful and easy to use document manipulation and merging API for C# platform. 
