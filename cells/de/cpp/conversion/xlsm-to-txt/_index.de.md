---
title: Konvertieren Sie XLSM in TXT über die Anwendung C++ 
url: /de/cpp/conversion/xlsm-to-txt/ 
description: Beispiel-Umwandlungscode C++ für das XLSM-Dokument in das TXT-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von XLSM in TXT in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLSM in TXT über C++" h2="Leistungsstarke XLSM-zu-TXT-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können XLSM-Dateien in nur wenigen Codezeilen einfach in TXT konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die XLSM-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (TXT).1. TXT-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die TXT-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="XLSM-zu-TXT-C++-Umwandlungsquellcode" offSpacer="" %}}
