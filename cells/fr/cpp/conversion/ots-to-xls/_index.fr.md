...
description: Aspose Exceller. Convertissez OTS en XLS rapidement et facilement avec Aspose.Cells. C++ OTS en XLS. C++ Enregistrez OTS en XLS. Enregistrez OTS sous XLS en utilisant C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez OTS au XLS dans C++" %}}
...
{{% cells-convert title="Exemple de code pour convertir OTS en XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir OTS en XLS via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers OTS en XLS par programme ? Les développeurs C++ peuvent facilement convertir OTS en XLS en quelques lignes de code seulement.
