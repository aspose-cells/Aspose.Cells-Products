...
{{% blocks/products/pf/agp/code-block title="Örnek kod, C#\'de MD dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="MD dosyası oluşturmak için C# kitaplığı" %}}
