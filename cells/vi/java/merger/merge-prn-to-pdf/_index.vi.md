---
title:  Hợp nhất PRN thành PDF via Java
...
Ví dụ sau minh họa cách hợp nhất PRN thành PDF trong Java.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất PRN thành PDF trực tuyến" InputFormat="prn" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
