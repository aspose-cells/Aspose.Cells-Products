...
{{% blocks/products/pf/agp/content h2="Converta CSV em DIF usando a biblioteca Python do Excel" %}}
...
{{% blocks/products/pf/agp/content h2="Salve CSV em DIF na Biblioteca Excel Python" %}}

O exemplo a seguir demonstra como converter CSV em DIF na biblioteca Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca Excel para converter CSV em DIF" %}}
