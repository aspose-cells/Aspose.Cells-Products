...
Нужно программно преобразовать файлы XML в SXC? Разработчики C++ могут легко преобразовать XML в SXC всего за несколько строк кода.
