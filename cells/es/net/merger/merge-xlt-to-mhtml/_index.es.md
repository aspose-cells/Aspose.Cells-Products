---
title: Combinar XLT a MHTML - Combinar XLT a MHTML en C#
url: /es/net/merger/merge-xlt-to-mhtml/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea XLT a MHTML guardar formato. C# Combina el formato XLT con el MHTML. Combinar XLT a MHTML en C#. XLT Combinar.
...
El siguiente ejemplo muestra cómo combinar XLT con MHTML en Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis en línea para fusionar XLT a MHTML en C#" InputFormat="xlt" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLT a MHTML a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLT con MHTML mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
