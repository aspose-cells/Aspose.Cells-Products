---
title: Konvertera NUMBERS till SXC via Java 

description: Exempel Java-konverteringskod för NUMBERS-format till SXC-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till SXC inom alla webb- eller skrivbordsbaserade Javaapplikationer.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar TAL till SXC med Java" %}}

 För att rendera NUMBERS till SXC kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera NUMBERS till SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera NUMBERS-filen till SXC på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda NUMBERS-filen med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med SXC-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande SXC-filen
...
{{% blocks/products/pf/agp/code-block title="NUMBERS till SXC Java omvandlingskällkod" offSpacer="" %}}

```cs
// ladda NUMBERS-filen i en instans av Workbook
Workbook book = new Workbook("template.numbers");
// spara NUMBERS som SXC
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS till SXC Conversion Live Demos" sectionDescription="[Konvertera NUMBERS till SXC](https://products.aspose.app/cells/conversion/numbers-to-sxc) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din NUMBERS-fil, den kommer omedelbart att konverteras till SXC." >}}
