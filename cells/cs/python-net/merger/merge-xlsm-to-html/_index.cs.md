---
title:  Sloučit XLSM na HTML přes Python
url: /cs/python-net/merger/merge-xlsm-to-html/ 
description: Sloučit XLSM až HTML online zdarma. Online zdarma XLSM až HTML Fúze. Sloučit XLSM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSM až HTML v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až HTML online" InputFormat="xlsm" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
