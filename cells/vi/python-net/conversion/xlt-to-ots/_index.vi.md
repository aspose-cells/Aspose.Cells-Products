...
description: Aspose Excel. Chuyển đổi XLT sang OTS nhanh chóng và dễ dàng với Aspose.Cells. Python XLT sang OTS. Python Lưu XLT vào OTS. Lưu XLT dưới dạng OTS bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLT sang OTS trong Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLT vào OTS ở Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLT sang OTS trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLT sang OTS" %}}
