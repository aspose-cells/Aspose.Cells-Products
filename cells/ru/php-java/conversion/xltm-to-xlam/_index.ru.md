...
description: Aspose Эксель. Преобразуйте XLTM в XLAM быстро и легко с помощью Aspose.Cells. PHP XLTM в XLAM. PHP Сохраните XLTM в XLAM. Сохраните XLTM как XLAM с помощью PHP.
...
Нужно программно преобразовать файлы XLTM в XLAM? Разработчики PHP могут легко загрузить и преобразовать XLTM в XLAM всего за несколько строк кода.
...
1.  Преобразуйте XLTM в XLAM, вызвав метод сохранения книги.
1.  Получите результат преобразования XLTM в XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования XLTM в XLAM" %}}
