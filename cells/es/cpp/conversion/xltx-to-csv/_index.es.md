---
title: Convierta XLTX a CSV a través de la aplicación C++ 

description: Ejemplo de código de conversión C++ para documento XLTX a formato CSV. Los programadores pueden usar este código fuente para la conversión por lotes de XLTX a CSV dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte XLTX a CSV a través de C++" h2="Conversión de XLTX a CSV de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLTX a CSV usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLTX a CSV a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de C++ pueden convertir fácilmente un archivo XLTX a CSV con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLTX usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (CSV).1. El archivo CSV se guardará en la ruta especificada.1. Abra el archivo CSV en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLTX a CSV C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de XLTX a CSV" sectionDescription="[Convertir XLTX a CSV](https://products.aspose.app/cells/conversion/xltx-to-csv) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo XLTX, se convertirá instantáneamente a CSV." >}}
