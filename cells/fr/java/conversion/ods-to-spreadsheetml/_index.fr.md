---
title: Convertir ODS en SPREADSHEETML via Java 
url: /fr/java/conversion/ods-to-spreadsheetml/ 
description: Exemple de code de conversion Java pour le format ODS en fichier SPREADSHEETML. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers SPREADSHEETML dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ODS en SPREADSHEETML via Java" h2="Conversion ODS en SPREADSHEETML Java pour convertir une ou plusieurs pages en SPREADSHEETML à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir ODS en SPREADSHEETML à l\'aide de Java" %}}

 Afin de rendre ODS à SPREADSHEETML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ODS en SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier ODS en SPREADSHEETML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ODS avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension SPREADSHEETML et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier SPREADSHEETML résultant
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion ODS vers SPREADSHEETML Java" offSpacer="" %}}

```cs
// charger le fichier ODS dans une instance de Workbook
Workbook book = new Workbook("template.ods");
// enregistrer ODS sous SPREADSHEETML
