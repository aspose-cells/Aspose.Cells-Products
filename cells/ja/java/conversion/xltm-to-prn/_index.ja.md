---
title: Java XLTM から PRN - XLTM から PRN コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLTMをPRNにすばやく簡単に変換します。Java XLTMをPRNに変換します。 Java XLTM を PRN に保存します。 Java を使用して、XLTM を PRN として保存します。
...
{{% cells-convert title="XLTMをPRNに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="prn" IsLandingPage="true" language="java" %}}
