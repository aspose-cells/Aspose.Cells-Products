---
title: C++ XLS から SQL - XLS から SQL コンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、XLS を SQL にすばやく簡単に変換します。C++ XLS を SQL に変換します。 C++ XLS を SQL に保存します。 C++ を使用して XLS を SQL として保存します。
...
{{< blocks/products/pf/i18n/upper-banner h1="XLS を C++ の SQL に変換します" h2="Microsoft Excel、OpenOffice、または Adobe Acrobat のインストールを必要とせずに、C++ ライブラリを使用した高性能の XLS から SQL への変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLS を C++ の SQL に保存" %}}

次の例は、XLS を C++ の SQL に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、XLS を SQL に変換します。 XLS ファイルをアップロードし、SQL ファイルとして保存するだけです。 XLS の読み取りと SQL 書き込みの両方で、完全修飾ファイル名を使用できます。出力される SQL の内容と形式は、元の XLS ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="XLSをSQLに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="sql" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLS を経由して XLS を SQL に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLS ファイルをプログラムで SQL に変換する必要がありますか? C++ 開発者は、わずか数行のコードで XLS を SQL に簡単に変換できます。
