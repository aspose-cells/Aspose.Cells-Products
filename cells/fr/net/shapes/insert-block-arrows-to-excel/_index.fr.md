---
title:  Insérer des flèches de bloc dans Excel via .NET
weight: 338
description: C# Exemple de code pour ajouter ou insérer des flèches de bloc dans Excel à l'aide de la bibliothèque .NET. Utilisez ce code pour créer des flèches de bloc dans MS Excel dans VB.NET, Asp.NET ou toute application basée sur .NET.
keywords: [C# Aspose.Cells., c# add block arrows., c# insert block arrows., c# create block arrows]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérer des flèches de bloc dans Excel via .NET" h2="Insérez des flèches de bloc en utilisant Aspose.Cells\' API sans aucun logiciel comme Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) pour insérer des flèches de bloc dans la feuille de calcul sélectionnée
...
L'exemple de code ci-dessous montre comment insérer une « flèche droite ». Pour plus de types, veuillez vous référer à « Présentation des types de formes de flèches de bloc » ci-dessous.

{{% blocks/products/pf/agp/code-block title="Insérer des flèches de bloc - C#" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Présentation des types de forme de flèche de bloc
   </h2>
   <div class="col-lg-4">
