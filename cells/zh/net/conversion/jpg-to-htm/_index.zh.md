---
title: C# JPG 转 HTM - 在线 JPG 转 HTM 转换器
description: Aspose Excel。 C# Aspose.Cells. C# Aspose Cells. 免费在线 C# 将 JPG 转换为 HTM 保存格式。 C# JPG 转 HTM 格式。将 JPG 保存到 HTM C#。
...
{{% blocks/products/pf/agp/content h2="免费在线将 C# 中的 JPG 保存为 HTM" %}}

下面的例子演示了如何将C#中的JPG转换为HTM。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 JPG 转换为 HTM。上传 JPG 文件，然后将其保存为 HTM 文件。对于 JPG 读取和 HTM 写入，您可以使用完全限定的文件名。输出的 HTM 内容和格式将与原始 JPG 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="在线将 JPG 转换为 HTM 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 JPG 转换为 HTM" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 JPG 文件转换为 HTM？ .NET 开发人员只需几行代码即可轻松加载 JPG 并将其转换为 HTM。
...
1. 通过调用 Workbook.Save 方法将 JPG 转换为 HTM。
1. 获取 JPG 到 HTM 的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 将 JPG 转换为 HTM 的库" %}}
