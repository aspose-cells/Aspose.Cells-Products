...
description: Aspose Excel. Java Aspose.Cells. Voeg TXT samen met het opslagformaat DIF. Java Combineer het formaat TXT met DIF. Voeg TXT samen met DIF in Java. TXT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met DIF in Java" %}}
...
{{% cells-merger title="Voorbeeldcode om TXT samen te voegen met DIF in Java" InputFormat="txt" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u TXT samenvoegt met DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met DIF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om TXT samen te voegen met DIF" %}}
