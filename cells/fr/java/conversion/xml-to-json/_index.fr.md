---
title: Java XML vers JSON - Convertisseur XML vers JSON
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le XML au format JSON, permettant un enregistrement transparent des données XML au format JSON à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XML sous JSON dans Java" %}}

L'exemple suivant montre comment convertir du XML en JSON en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir du XML en JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML au format JSON par programmation ? Les développeurs Java peuvent facilement convertir un fichier XML au format JSON en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir XML en JSON" %}}
{{% blocks/products/pf/agp/text %}}
