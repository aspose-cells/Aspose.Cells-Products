---
title: Convierta XLT a XLTX a través de Python
url: /es/python-java/conversion/xlt-to-xltx/
description: Ejemplo de código para la conversión de xlt a xltx Python. Use el código de ejemplo API para la conversión de archivos xlt a xltx dentro de la aplicación Python.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a XLTX usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLT a XLTX a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden cargar y convertir fácilmente archivos XLT a XLTX con solo unas pocas líneas de código.
...
{{% cells-convert title="Aplicación gratuita y código de muestra para convertir XLT a XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xltx" IsLandingPage="true" language="python" %}}
