---
title: A MHTML egyesítése a POWERPOINT-hoz – a MHTML-es szám egyesítése a POWERPOINT-hez a C#-es helyen
url: /hu/net/merger/merge-mhtml-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés MHTML POWERPOINT mentési formátumba. C# A MHTML kombinálása POWERPOINT formátumba. A MHTML egyesítése a C#-es POWERPOINT-tal. MHTML Egyesítés.
...
A következő példa bemutatja, hogyan egyesítheti a MHTML-es számot a POWERPOINT-tal a Aspose.Cells-es for .NET-ben.
...
{{% cells-merger title="Ingyenes online a MHTML egyesítéséhez POWERPOINT a C#-ben" InputFormat="mhtml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML és a POWERPOINT egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
