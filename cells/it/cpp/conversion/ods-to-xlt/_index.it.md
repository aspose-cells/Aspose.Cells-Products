---
title: Converti ODS in XLT tramite l'applicazione C++ 
url: /it/cpp/conversion/ods-to-xlt/ 
description: Esempio di codice di conversione C++ per documento ODS in formato XLT. I programmatori possono utilizzare questo codice sorgente per la conversione batch da ODS a XLT all'interno di qualsiasi C++ Applicazione.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti ODS in XLT tramite C++" h2="Conversione da ODS a XLT ad alte prestazioni utilizzando la libreria C++ senza la necessità di installare Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente i file ODS in XLT in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file ODS usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XLT).1. Il file XLT verrà salvato nel percorso specificato.1. Apri il file XLT nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da ODS a XLT C++" offSpacer="" %}}
