---
title: تحويل C++ MHT إلى TSV - تحويل MHT إلى TSV
description: Aspose اكسل. قم بتحويل MHT إلى TSV بسرعة وسهولة باستخدام Aspose.Cells. C++ MHT إلى TSV. C++ احفظ MHT إلى TSV. احفظ MHT كـ TSV باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على TSV في C++" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="tsv" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى TSV عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى TSV برمجياً؟ يمكن لمطوري C++ تحويل MHT بسهولة إلى TSV في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى TSV عن طريق استدعاء طريقة Save ().
