---
title: PNG を SPREADSHEETML に結合 - PNG を Java の SPREADSHEETML に結合
url: /ja/java/merger/merge-png-to-spreadsheetml/ 
description: Aspose エクセル。 Java Aspose.Cells。無料オンライン PNG を SPREADSHEETML 保存形式にマージします。 Java PNG を SPREADSHEETML 形式に結合します。 PNG を Java の SPREADSHEETML にマージします。 PNG をマージします。
keywords: [Aspose Excel., Java Aspose.Cells., Merge PNG to SPREADSHEETML in Java., Free Online Java Merge PNG to spreadsheetml., Java Combine PNG to SPREADSHEETML Online for Free., PNG Merge]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="PNG を SPREADSHEETML via Java にマージ" h2="PNG を SPREADSHEETML にマージするための高速 Java ライブラリ。 Excel 変換 API を使用して、Java でプラットフォームに依存しない高レベルのソフトウェアを開発します。これは、Excel, CSV, OpenOffice, PDF, HTML, image および他の多くの Excel 形式をインポートおよびエクスポートするためのプロフェッショナル ソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="PNG" additionalConversionTag="SPREADSHEETML" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="PNG をオンラインで無料で Java の SPREADSHEETML にマージします" %}}

次の例は、PNG を Aspose.Cells for Java の SPREADSHEETML にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、PNG を SPREADSHEETML にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルを結合し、SPREADSHEETML ファイルに保存します。 Java でコードを開発する場合、これは思っているより簡単です。 PNG を SPREADSHEETML にマージする Java の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="PNG をオンラインで Java の SPREADSHEETML に無料でマージ" InputFormat="png" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="PNG を SPREADSHEETML via Java にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

PNG をプログラムで SPREADSHEETML にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Java](https://products.aspose.com/cells/java)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="Java PNG を SPREADSHEETML にマージするライブラリ" %}}
