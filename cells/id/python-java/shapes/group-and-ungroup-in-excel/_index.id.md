---
title: Mengelompokkan Dan Memisahkan Bentuk di Excel Menggunakan Python via Java
weight: 371
description: Group Dan Ungroup objek menggunakan Aspose.Cells' Python via Java API tanpa software apapun seperti Microsoft atau Open Office, Adobe PDF, dll.
...
{{< blocks/products/pf/i18n/upper-banner h1="Mengelompokkan Dan Memisahkan Bentuk di Excel menggunakan Python via Java" h2="Menggunakan Aspose.Cells\' API untuk bekerja dengan berbagai objek tanpa software apapun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengelompokkan Dan Memisahkan Bentuk Pada File Excel Menggunakan Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengelompokkan dan Memisahkan Bentuk pada file Excel menggunakan Python via Java" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[metode kelompok](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#group(com.aspose.cells.Shape[])) untuk mengelompokkan bentuk di lembar kerja yang dipilih
 + Gunakan[metode ungroup](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#ungroup(com.aspose.cells.GroupShape)) untuk memisahkan bentuk-bentuk pada lembar kerja yang dipilih
...
{{% blocks/products/pf/agp/code-block title="Bentuk Kelompok Dan Pisahkan - Python via Java" offSpacer="" %}}
