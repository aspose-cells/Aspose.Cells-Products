---
title:  Sloučit XLSM na PPTX přes Python
...
Následující příklad ukazuje, jak sloučit XLSM až PPTX v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až PPTX online" InputFormat="xlsm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
