...
{{% blocks/products/pf/agp/content h2="Konwertuj OBRAZ do JPG za pomocą C++" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz OBRAZ w formacie JPG w C++" %}}

Poniższy przykład pokazuje, jak przekonwertować OBRAZ na JPG w formacie C++.
...
Trzeba programowo przekonwertować pliki OBRAZÓW do formatu JPG? Programiści C++ mogą łatwo przekonwertować pliki OBRAZÓW do formatu JPG za pomocą zaledwie kilku linijek kodu.
