---
title: Převést TSV na SPREADSHEETML prostřednictvím C#
url: /cs/net/conversion/tsv-to-spreadsheetml/
description: Ukázkový kód pro převod tsv na tabulkuml C#. Použijte API ukázkový kód pro dávkový převod souborů tsv do tabulkyml v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést TSV na SPREADSHEETML prostřednictvím C#" h2="Exportujte tabulky Excel® do formátu SPREADSHEETML na platformách .NET Framework, .NET Core, Mono nebo Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Jak převést TSV na SPREADSHEETML pomocí C#" %}}

 Abychom převedli TSV na SPREADSHEETML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TSV na SPREADSHEETML prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory TSV do formátu SPREADSHEETML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí sešitu1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s příponou XML jako parametr1. Zkontrolujte zadanou cestu pro výsledný soubor SPREADSHEETML
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod TSV na SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xml" IsLandingPage="true" %}}
