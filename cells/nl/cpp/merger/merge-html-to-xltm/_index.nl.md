...
url: /nl/cpp/merger/merge-html-to-xltm/ 
...
Het volgende voorbeeld laat zien hoe u HTML samenvoegt met XLTM in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u HTML programmatisch samenvoegen met XLTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om HTML samen te voegen met XLTM" %}}
