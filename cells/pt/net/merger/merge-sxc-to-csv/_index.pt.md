---
title: Mesclar SXC a CSV - Combinar SXC a CSV em C#
url: /pt/net/merger/merge-sxc-to-csv/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita SXC para CSV saveformat. C# Combine o formato SXC a CSV. Mesclar SXC a CSV em C#. SXC Mesclar.
...
O exemplo a seguir demonstra como mesclar SXC a CSV em Aspose.Cells for .NET.
...
{{% cells-merger title="Online grátis para mesclar SXC a CSV em C#" InputFormat="sxc" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC a CSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SXC a CSV programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
