...
{{% blocks/products/pf/agp/content h2="How to Create GIF in PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create GIF file in PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PHP library to create GIF file" %}}
