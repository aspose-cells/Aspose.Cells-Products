...
description: Aspose Excel. Converteer XLTX snel en eenvoudig naar SQL met Aspose.Cells. C# XLTX naar SQL. C# Sla XLTX op in SQL. Sla XLTX op als SQL met behulp van C#.
...
In het volgende voorbeeld ziet u hoe u XLTX naar SQL converteert in C#.
