...
description: Aspose اكسل. قم بتحويل IMAGE إلى XLSX بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى XLSX. C++ احفظ IMAGE إلى XLSX. احفظ IMAGE كـ XLSX باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="تحويل الصورة إلى XLSX باستخدام C++" %}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى XLSX برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى XLSX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى XLSX عن طريق استدعاء طريقة Save().
