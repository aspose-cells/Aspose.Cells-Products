---
title: Объединить TABDELIMITED с SPREADSHEETML — объединить TABDELIMITED с SPREADSHEETML в C#.
url: /ru/net/merger/merge-tabdelimited-to-spreadsheetml/ 
description: Aspose Эксель. C# Aspose.Cells. Объединить TABDELIMITED с форматом сохранения SPREADSHEETML. C# Объедините TABDELIMITED в формат SPREADSHEETML. Объединить TABDELIMITED с SPREADSHEETML в C#. TABDELIMITED Объединить.
...
{{% blocks/products/pf/agp/content h2="Объединить TABDELIMITED с SPREADSHEETML в C#." %}}

В следующем примере показано, как объединить TABDELIMITED с SPREADSHEETML в Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить TABDELIMITED с SPREADSHEETML. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл SPREADSHEETML. Если вы разработаете код C#, это будет проще, чем кажется. См. пример C#, в котором TABDELIMITED объединяется с SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения TABDELIMITED с SPREADSHEETML в номере C#" InputFormat="tsv" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Как объединить TABDELIMITED с SPREADSHEETML через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить TABDELIMITED и SPREADSHEETML? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2=".NET библиотека для объединения TABDELIMITED с SPREADSHEETML" %}}
