...
Potřebujete převést soubory TSV na XLTX programově? Vývojáři C++ mohou snadno převést TSV na XLTX v několika řádcích kódu.
...
1.  Převeďte TSV na XLTX voláním metody Save().
