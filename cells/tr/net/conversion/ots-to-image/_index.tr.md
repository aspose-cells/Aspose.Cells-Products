---
title: C# OTS'den IMAGE'ye - Çevrimiçi OTS'den IMAGE'ye Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# OTS'yi IMAGE kaydetme biçimine dönüştürün. C# OTS'den IMAGE formatına. OTS'yi IMAGE C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi C#\'de IMAGE\'e Çevrimiçi Olarak Ücretsiz Olarak Kaydetme" %}}

Aşağıdaki örnek, OTS'nin C#'de IMAGE'ye nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

OTS'yi IMAGE'ye dönüştürmek için kolay adımları izleyin. OTS dosyanızı yükleyin, ardından IMAGE dosyası olarak kaydedin. Hem OTS okuma hem de GÖRÜNTÜ yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı IMAGE içeriği ve biçimlendirmesi, orijinal OTS belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="OTS\'yi IMAGE Online\'a Dönüştürmek için Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# aracılığıyla OTS\'yi IMAGE\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

OTS dosyalarını programlı olarak IMAGE'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, OTS'yi yalnızca birkaç satır kodla kolayca yükleyebilir ve IMAGE'ye dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak OTS'yi IMAGE'ye dönüştürün.
1.  OTS'nin IMAGE'e dönüştürme sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi IMAGE\'ye dönüştürmek için C# kitaplığı" %}}
