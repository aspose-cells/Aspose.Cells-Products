...
weight: 7370
description: C# 源代码在 .NET 框架、.NET 核心、Mono 或 Xamarin 平台上拆分 XLSB 文档。
---
...
{{% blocks/products/pf/agp/feature-section-col title="拆分C#中的XLSB文件的步骤" %}}
