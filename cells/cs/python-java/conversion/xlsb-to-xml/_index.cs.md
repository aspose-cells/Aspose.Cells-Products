...
{{% blocks/products/pf/agp/content h2="Převeďte XLSB na XML pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XLSB na XML v Python.
