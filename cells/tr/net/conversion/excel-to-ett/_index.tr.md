...
{{% cells-convert title="EXCEL\'i ETT\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ett" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# aracılığıyla EXCEL\'i ETT\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını program aracılığıyla ETT'ye dönüştürmeniz mi gerekiyor? .NET geliştiriciler yalnızca birkaç satır kodla kolayca EXCEL'i ETT'ye yükleyebilir ve dönüştürebilir.
