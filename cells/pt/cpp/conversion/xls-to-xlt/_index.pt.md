...
description: Aspose Excel. Converta XLS em XLT de forma rápida e fácil com Aspose.Cells. C++ XLS em XLT. C++ Salve XLS em XLT. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em XLT usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para XLT em C++" %}}

O exemplo a seguir demonstra como converter XLS em XLT em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlt" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em XLT por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em XLT programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em XLT em apenas algumas linhas de código.
...
1.  Converta XLS em XLT chamando o método Save().
