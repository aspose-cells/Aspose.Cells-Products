---
title: Konvertor PHP PNG až XLS - PNG až XLS
description: Aspose Excel. Převeďte PNG na XLS rychle a snadno pomocí Aspose.Cells. PHP PNG na XLS. PHP Uložte PNG na XLS. Uložte XLS jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na XLS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na XLS programově? Vývojáři PHP mohou snadno načíst a převést PNG na XLS v několika řádcích kódu.
...
1.  Převeďte PNG na XLS voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na XLS" %}}
