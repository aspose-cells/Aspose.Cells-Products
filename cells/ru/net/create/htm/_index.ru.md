...
{{% blocks/products/pf/agp/content h2="Как создать HTM в C#" %}}
...
1.  Используйте метод Сохранить, чтобы сохранить книгу как файл HTM.

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл HTM в C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# библиотека для создания файла HTM" %}}
