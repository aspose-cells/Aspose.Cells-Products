...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir FODS en TABDELIMITED via Java" h2="Conversion FODS en TABDELIMITED Java pour convertir une ou plusieurs pages en TABDELIMITED à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir FODS en TABDELIMITED en utilisant Java" %}}

 Afin de rendre FODS à TABDELIMITED, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir FODS en TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier FODS en TABDELIMITED en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier FODS avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension TABDELIMITED et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier TABDELIMITED résultant
...
{{% blocks/products/pf/agp/code-block title="FODS à TABDELIMITED Java Code source de conversion" offSpacer="" %}}

```cs
// charger le fichier FODS dans une instance de Workbook
Workbook book = new Workbook("template.fods");
// enregistrer FODS sous TABDELIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion FODS en TABDELIMITED" sectionDescription="[Convertir FODS en TABDELIMITED](https://products.aspose.app/cells/conversion/fods-to-tabdelimited) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier FODS, il sera converti instantanément en TABDELIMITED." >}}
