...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 将 XLTX 转换为 XLS" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C++ 将 XLTX 转换为 XLS 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 C++ 开发人员只需几行代码即可轻松地将 XLTX 文件转换为 XLS。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 XLTX 文件。1. 调用 Save() 方法。1. 使用 (XLS) 文件扩展名传递输出文件路径。1. XLS 文件将保存在指定路径。1. 在兼容程序中打开 XLS 文件。
...
{{% blocks/products/pf/agp/code-block title="XLTX 到 XLS C++ 转换源代码" offSpacer="" %}}
