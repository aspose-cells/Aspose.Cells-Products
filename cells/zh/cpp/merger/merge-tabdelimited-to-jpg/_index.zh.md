...
url: /zh/cpp/merger/merge-tabdelimited-to-jpg/ 
...
以下示例演示如何将 Aspose.Cells for C++ 中的 TABDELIMITED 合并为 JPG。
...
需要以编程方式将 TABDELIMITED 合并到 JPG 吗？基本文档合并和连接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++ 库将 TABDELIMITED 合并到 JPG" %}}
