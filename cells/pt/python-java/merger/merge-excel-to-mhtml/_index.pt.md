---
title:  Mesclar EXCEL para MHTML via Python
url: /pt/python-java/merger/merge-excel-to-mhtml/ 
description: Mesclar EXCEL para MHTML Online gratuitamente. Free Online EXCEL para MHTML Fusão. Mescle EXCEL para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar EXCEL para MHTML em Python.
...
{{% cells-merger title="Aplicativo gratuito para mesclar EXCEL para MHTML online" InputFormat="xlsx" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
