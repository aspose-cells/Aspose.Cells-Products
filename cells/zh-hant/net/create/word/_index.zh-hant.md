---
title: 創建WORD - 在C#中創建WORD文件
description: Aspose Excel。 C# 創建WORD文件。創建 WORD C#。C# WORD 創建者。在C#中創建WORD。使用C#生成WORD文件。
...
{{% blocks/products/pf/agp/content h2="如何在C#中創建WORD" %}}

{{% blocks/products/pf/agp/text %}}

開發人員只需幾行代碼即可輕鬆地在運行不同的報告應用程序中創建、加載、修改和轉換 WORD 文件以進行數據處理。
...
1. 使用Save方法將工作簿另存為WORD文件。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在C#中創建WORD文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#庫創建WORD文件" %}}
