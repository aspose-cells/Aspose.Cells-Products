...
url: /ar/cpp/merger/merge-ots-to-emf/ 
...
يوضح المثال التالي كيفية دمج OTS مع EMF في Aspose.Cells for C++.
...
هل تحتاج إلى دمج OTS في EMF برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لدمج OTS إلى EMF" %}}
