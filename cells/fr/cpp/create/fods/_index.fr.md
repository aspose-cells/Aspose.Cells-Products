---
title: Créer FODS - Créer un fichier FODS dans C++
description: Aspose Excel. C++ Créer un fichier FODS. Créer FODS C++. C++ FODS Créateur. Créez FODS dans C++. Générez le fichier FODS en utilisant C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier FODS dans C++" h2="Création de fichiers natifs et hautes performances FODS par programmation sans Micorsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer FODS dans C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers FODS dans des applications de création de rapports en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
1.  Enregistrez le classeur en tant que fichier .fods à l'aide de la méthode Save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier FODS dans C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="bibliothèque C++ pour créer le fichier FODS" %}}
