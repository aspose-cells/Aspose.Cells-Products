...
description: Convert SXC to DOCX format in C# code. Save SXC as DOCX using VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert SXC to DOCX via C#" h2="Export Excel spreadsheets to DOCX format on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
The following example demonstrates how to convert SXC to DOCX document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert SXC file into DOCX format. Upload your SXC file, then simply save it as DOCX file. For both SXC reading and DOCX writing you can use fully qualified filenames. The output DOCX content and formatting will be identical to the original SXC document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert SXC to DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert SXC to DOCX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert SXC files to DOCX in just a few lines of code.
