...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση XLS σε μορφή αποθήκευσης XLTM. Java Συνδυάστε τη μορφή XLS με XLTM. Συγχώνευση XLS σε XLTM στο Java. XLS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLS με XLTM στο Java" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLS έως XLTM στο Java" InputFormat="xls" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
