...
description: Aspose Excel. Python Excel. A SXC számot gyorsan és egyszerűen ETT-re alakíthatja át a Aspose.Cells-es számmal. Python SXC ETT-vé. Python Mentse a SXC-et az ETT-nek. Mentse el a SXC számot ETT-ként a Python Excel Library használatával.
