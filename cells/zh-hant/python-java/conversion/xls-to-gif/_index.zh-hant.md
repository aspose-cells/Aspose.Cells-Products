...
description: Aspose Excel。 Python Excel。使用 Aspose.Cells 快速輕鬆地將 XLS 轉換為 GIF。Python XLS 轉換為 GIF。Python 將 076193417619301 將存 076112第3481章 使用Python Excel庫。
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將 XLS 轉換為 GIF" %}}
...
{{% blocks/products/pf/agp/content h2="將 XLS 儲存到 Python Excel 庫中 GIF" %}}

下面的範例示範如何在Python Excel庫中將XLS轉換為GIF。
...
{{% cells-convert title="透過 Python Excel 函式庫將 XLS 轉換為 GIF 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="gif" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 XLS 轉換為 GIF" %}}
