---
title: รวม NUMBERS เป็น ET - รวม NUMBERS เป็น ET ใน Java
url: /th/java/merger/merge-numbers-to-et/ 
description: Aspose เก่ง. Java Aspose.Cells รวม NUMBERS เป็น ET ในรูปแบบบันทึกออนไลน์ฟรี Java รวม NUMBERS เป็นรูปแบบ ET รวม NUMBERS เป็น ET ใน Java ผสาน NUMBERS
...
{{% blocks/products/pf/agp/content h2="รวม NUMBERS เป็น ET ใน Java ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีผสาน NUMBERS กับ ET ใน Aspose.Cells for Java
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม NUMBERS เข้ากับ ET อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ ET หากคุณพัฒนาโค้ดใน Java สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง Java ที่รวม NUMBERS เข้ากับ ET

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ออนไลน์ฟรีเพื่อรวม NUMBERS เป็น ET ใน Java" InputFormat="numbers" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="วิธีผสานตัวเลขเป็น ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม NUMBERS เข้ากับ ET โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for Java](https://products.aspose.com/cells/java) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี Java เพื่อรวม NUMBERS เป็น ET" %}}
