---
title: C# OTS'den XLS'e - Çevrimiçi OTS'den XLS'e Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# OTS'yi XLS saveformat'a dönüştürün. C# OTS'den XLS formatına. OTS'yi XLS C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi C# içinde XLS\'e Çevrimiçi olarak Ücretsiz olarak kaydedin" %}}

Aşağıdaki örnek, OTS'nin C#'de XLS'e nasıl dönüştürüleceğini gösterir.
...
OTS dosyalarını programlı olarak XLS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, OTS'yi yalnızca birkaç satır kodla kolayca yükleyebilir ve XLS'e dönüştürebilir.
...
1.  OTS'nin XLS'e dönüştürme sonucunu alın.
