...
description: Aspose Excel. Converteer XLTM snel en eenvoudig naar ODS met Aspose.Cells. Python XLTM naar ODS. Python Bewaar XLTM in ODS. Bewaar XLTM als 07611134 81 via Python.
...
{{% blocks/products/pf/agp/content h2="Converteer XLTM naar ODS in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLTM t/m ODS in Python" %}}

Het volgende voorbeeld laat zien hoe u XLTM converteert naar ODS in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLTM naar ODS te converteren" %}}
