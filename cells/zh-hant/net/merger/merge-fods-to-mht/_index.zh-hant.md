...
description: Aspose Excel。 C# Aspose.Cells。將 FODS 合併到 MHT 儲存格式。 C# 將 FODS 合併為 MHT 格式。將 FODS 合併到 C# 中的 MHT。FODS 合併。
...
{{% blocks/products/pf/agp/content h2="將 FODS 合併到 C# 中的 MHT" %}}

以下範例示範如何將 FODS 合併到 Aspose.Cells for .NET 中的 MHT。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 合併到 MHT。上傳文件，呼叫Workbook.Combine方法合併文件，然後儲存到MHT文件。如果您在 C# 中開發程式碼，這會比聽起來更簡單。請參閱將 FODS 合併到 MHT 的 C# 範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 FODS 合併到 C# 中的 MHT 的範例程式碼" InputFormat="fods" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 合併到 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 合併到 MHT 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將FODS合併至MHT" %}}
