...
description: Aspose Unggul. Ubah PNG menjadi IMAGE dengan cepat dan mudah menggunakan Aspose.Cells. Java PNG menjadi IMAGE. Java Simpan PNG ke GAMBAR. Simpan PNG sebagai GAMBAR menggunakan Java.
...
{{% blocks/products/pf/agp/content h2="Ubah PNG menjadi GAMBAR Menggunakan Java" %}}
...
Contoh berikut menunjukkan cara mengonversi PNG menjadi IMAGE di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah PNG menjadi GAMBAR via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PNG ke IMAGE secara terprogram? Pengembang Java dapat dengan mudah mengonversi PNG menjadi IMAGE hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi PNG menjadi IMAGE" %}}
{{% blocks/products/pf/agp/text %}}
