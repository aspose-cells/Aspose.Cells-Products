---
title: C# OTS'den ODS'e - Çevrimiçi OTS'den ODS'e Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# OTS'yi ODS saveformat'a dönüştürün. C# OTS'den ODS formatına. OTS'yi ODS C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi C# içinde ODS\'e Çevrimiçi olarak Ücretsiz olarak kaydedin" %}}

Aşağıdaki örnek, OTS'nin C#'de ODS'e nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

OTS'yi ODS'e dönüştürmek için kolay adımları izleyin. OTS dosyanızı yükleyin, ardından ODS dosyası olarak kaydedin. Hem OTS okuması hem de ODS yazması için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı ODS içeriği ve biçimlendirmesi, orijinal OTS belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="OTS\'yi Çevrimiçi ODS\'e Dönüştürmek için Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi C# aracılığıyla ODS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

OTS dosyalarını programlı olarak ODS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, OTS'yi yalnızca birkaç satır kodla kolayca yükleyebilir ve ODS'e dönüştürebilir.
...
1.  OTS'nin ODS'e dönüştürme sonucunu alın.
