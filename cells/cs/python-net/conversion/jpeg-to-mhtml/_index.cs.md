...
{{% blocks/products/pf/agp/content h2="Převést JPEG na MHTML na Python" %}}
...
Následující příklad ukazuje, jak převést JPEG na MHTML v Python via NET.
