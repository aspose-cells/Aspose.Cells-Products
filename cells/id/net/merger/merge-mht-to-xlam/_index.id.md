...
description: Aspose Unggul. C# Aspose.Cells. Gabungkan MHT ke format simpan XLAM. C# Gabungkan MHT ke format XLAM. Gabungkan MHT ke XLAM di C#. Gabungkan MHT.
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHT ke XLAM di C#" %}}

Contoh berikut menunjukkan cara menggabungkan MHT ke XLAM di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan MHT ke XLAM. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file XLAM. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan MHT menjadi XLAM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan MHT ke XLAM di C#" InputFormat="mht" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHT ke XLAM lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan MHT ke XLAM secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Library .NET untuk menggabungkan MHT menjadi XLAM" %}}
