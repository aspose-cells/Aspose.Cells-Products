...
description: ODS criador. Crie arquivos ODS no código Python. Gere arquivos ODS (Openoffice / Lbreoffice) usando o aplicativo Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo ODS via Python" h2="Criação de planilha ODS (Openoffice / Lbreoffice) nativa e de alto desempenho programaticamente usando APIs Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como criar ODS via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="O código-fonte a seguir mostra como criar um arquivo ODS (Openoffice / Lbreoffice) usando Python." offSpacer="" %}}
