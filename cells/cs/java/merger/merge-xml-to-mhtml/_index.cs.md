---
title:  Sloučit XML na MHTML via Java
...
Následující příklad ukazuje, jak sloučit XML do MHTML v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XML na MHTML online" InputFormat="xml" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
