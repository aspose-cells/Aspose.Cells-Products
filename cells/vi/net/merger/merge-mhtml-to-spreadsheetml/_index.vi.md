---
title: Gộp MHTML vào SPREADSHEETML - Gộp MHTML vào SPREADSHEETML trong C#
url: /vi/net/merger/merge-mhtml-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất MHTML thành định dạng lưu SPREADSHEETML. C# Kết hợp MHTML thành định dạng SPREADSHEETML. Hợp nhất MHTML vào SPREADSHEETML trong C#. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML vào SPREADSHEETML trong C#" %}}

Ví dụ sau đây minh họa cách hợp nhất MHTML với SPREADSHEETML trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất MHTML vào SPREADSHEETML. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SPREADSHEETML. Nếu bạn phát triển mã theo số C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất MHTML với SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất MHTML vào SPREADSHEETML trong C#" InputFormat="mhtml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất MHTML vào SPREADSHEETML qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất MHTML vào SPREADSHEETML theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất MHTML vào SPREADSHEETML" %}}
