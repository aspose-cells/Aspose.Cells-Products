---
title:  Cari dan ganti teks di dokumen XLS via .NET
weight: 7280
description: Kode sumber C# untuk menyunting informasi sensitif dalam file XLS pada Framework .NET, .NET Core, Mono atau Platform Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Redact XLS Format di C#" h2="Asli dan berkinerja tinggi XLS mendokumentasikan informasi redaksi sensitif menggunakan sisi server Aspose.Cells for .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{< blocks/products/pf/agp/other-supported-section title="Format Redaksi Lain yang Didukung" subTitle="Menggunakan C#, seseorang dapat dengan mudah menyunting berbagai format termasuk." >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/redaction/ods/" name="ODS" description="Buka File Spreadsheet Dokumen" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/redaction/xlsm/" name="XLSM" description="File lembar bentang" >}}
