---
title:  Hợp nhất SPREADSHEETML thành ODS via Java
...
Ví dụ sau minh họa cách hợp nhất SPREADSHEETML thành ODS trong Java.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất SPREADSHEETML thành ODS trực tuyến" InputFormat="xml" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
