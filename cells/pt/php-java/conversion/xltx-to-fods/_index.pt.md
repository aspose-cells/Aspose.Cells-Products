---
title: Conversor PHP XLTX para FODS - XLTX para FODS
description: Aspose Excel. Converta XLTX em FODS de forma rápida e fácil com Aspose.Cells. PHP XLTX em FODS. PHP Salve XLTX em FODS. Salve XLTX como FODS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em FODS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em FODS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em FODS em apenas algumas linhas de código.
...
1.  Converta XLTX em FODS chamando o método save da pasta de trabalho.
