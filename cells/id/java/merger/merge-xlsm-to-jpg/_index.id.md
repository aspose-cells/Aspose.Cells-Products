---
title: Gabungkan XLSM ke JPG - Gabungkan XLSM ke JPG di Java
url: /id/java/merger/merge-xlsm-to-jpg/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLSM ke format simpan JPG. Java Gabungkan XLSM ke format JPG. Gabungkan XLSM ke JPG di Java. XLSM Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSM ke JPG di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLSM ke JPG di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSM ke JPG. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file JPG. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan XLSM ke JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLSM ke JPG di Java" InputFormat="xlsm" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSM ke JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan XLSM ke JPG secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk menggabungkan XLSM ke JPG" %}}
