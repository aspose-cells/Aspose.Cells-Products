---
title: Mesclar TABDELIMITED para NUMBERS - Combinar TABDELIMITED para NUMBERS em C#
url: /pt/net/merger/merge-tabdelimited-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita TABDELIMITED para NUMBERS saveformat. C# Combine TABDELIMITED para o formato NUMBERS. Mesclar TABDELIMITED para NUMBERS em C#. TABDELIMITED Mesclar.
...
O exemplo a seguir demonstra como mesclar TABDELIMITED com NUMBERS em Aspose.Cells for .NET.
...
{{% cells-merger title="Online grátis para mesclar TABDELIMITED para NUMBERS em C#" InputFormat="tsv" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar TABDELIMITED para NUMBERS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar TABDELIMITED com NUMBERS programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
