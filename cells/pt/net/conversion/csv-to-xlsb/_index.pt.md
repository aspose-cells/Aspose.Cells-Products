---
title: C# CSV a XLSB - CSV a XLSB Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter CSV para o formato XLSB, permitindo o salvamento perfeito de dados CSV no formato XLSB usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve CSV a XLSB em C#" %}}

exemplo a seguir demonstra como converter CSV em XLSB em C#.
...
{{% cells-convert title="Código de exemplo para converter CSV em XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="csv" outformat="xlsb" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter CSV em XLSB por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos CSV em XLSB programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter CSV em XLSB em apenas algumas linhas de código.
...
1.  Converta CSV para XLSB chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de CSV para XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter CSV em XLSB" %}}
