---
title: Konvertera MHTML till CSV via Python

description: Exempelkod för konvertering från mhtml till csv Python. Använd API exempelkod för batch-mhtml-filer till csv-konvertering i Python-applikationen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera MHTML till CSV via Python" h2="Exportera Excel®-kalkylark till CSV-format med Python API:er." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du MHTML till CSV med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera MHTML till CSV via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera MHTML-filer till CSV på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda MHTML-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utdatasökväg med CSV-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande CSV-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera MHTML till CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="csv" IsLandingPage="true" language="python" %}}
