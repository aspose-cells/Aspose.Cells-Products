...
url: /vi/net/merger/merge-prn-to-markdown/ 
...
Ví dụ sau đây minh họa cách hợp nhất PRN thành MARKDOWN trong Aspose.Cells for .NET.
...
{{% cells-merger title="Mã mẫu gộp PRN về MARKDOWN trong C#" InputFormat="prn" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp PRN về MARKDOWN qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất PRN thành MARKDOWN theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để ghép PRN thành MARKDOWN" %}}
