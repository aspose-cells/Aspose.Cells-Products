---
title: Converti SPREADSHEETML in TSV tramite Java 
url: /it/java/conversion/spreadsheetml-to-tsv/ 
description: Esempio di codice di conversione Java per il formato SPREADSHEETML in file TSV. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in TSV all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti SPREADSHEETML in TSV tramite Java" h2="Conversione da SPREADSHEETML a TSV Java per convertire pagine singole o multiple in TSV utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire SPREADSHEETML in TSV utilizzando Java" %}}

 Per eseguire il rendering di SPREADSHEETML in TSV, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire SPREADSHEETML in TSV tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente il file SPREADSHEETML in TSV in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file SPREADSHEETML con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione TSV e SaveFormat come parametri1. Controllare il percorso specificato per il file TSV risultante
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML in TSV Java codice sorgente di conversione" offSpacer="" %}}

```cs
// caricare il file SPREADSHEETML in un'istanza di Workbook
Workbook book = new Workbook("template.spreadsheetml");
// salva SPREADSHEETML come TSV
