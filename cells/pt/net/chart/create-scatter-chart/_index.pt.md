...
description: C# Código de amostra para criar gráficos de dispersão para o Excel usando a Biblioteca .NET. Use este código para criar um gráfico de dispersão para MS Excel em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
