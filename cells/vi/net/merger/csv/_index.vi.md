...
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng CSV trong C#" h2="Hợp nhất tài liệu CSV gốc và hiệu suất cao bằng cách sử dụng API Aspose.Cells for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
+ Tải tất cả các tệp CSV với đường dẫn đầy đủ.
+ Tạo một tài liệu làm tệp cơ sở
+ Gọi phương thức liên quan để nối và hợp nhất từng tệp một.
+ Gọi phương thức Save () và truyền tên tệp (đường dẫn đầy đủ) và định dạng (CSV) làm tham số.
+ Bây giờ bạn có thể mở và sử dụng tệp CSV trong Microsoft Office, Adobe PDF hoặc bất kỳ chương trình tương thích nào khác.
