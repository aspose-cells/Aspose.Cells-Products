---
title: TSV mit XPS zusammenführen - TSV mit XPS in C++ kombinieren
url: /de/cpp/merger/merge-tsv-to-xps/ 
description: Aspose Excel. C++ Aspose.Cells. TSV mit XPS Saveformat zusammenführen. C++ Kombinieren Sie das Format TSV mit dem Format XPS. TSV zu XPS in C++ zusammenführen. TSV Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="TSV mit XPS in C++ zusammenführen" %}}

Das folgende Beispiel zeigt, wie TSV mit XPS in Aspose.Cells for C++ zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von TSV mit XPS in C++" InputFormat="tsv" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie TSV über C++ mit XPS zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie TSV programmgesteuert mit XPS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
