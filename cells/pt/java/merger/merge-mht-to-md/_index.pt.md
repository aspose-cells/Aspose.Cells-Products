---
title: Mesclar MHT para MD - Combine MHT para MD em Java
url: /pt/java/merger/merge-mht-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Free Online Merge MHT para MD saveformat. Java Combine o formato MHT para MD. Mesclar MHT para MD em Java. Mesclar MHT.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHT para MD em Java online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar MHT para MD em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHT para MD. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e, em seguida, salve-o no arquivo MD. Se você desenvolver código em Java, isso será mais simples do que parece. Veja o exemplo Java que mescla MHT com MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar MHT para MD em Java" InputFormat="mht" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHT para MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar MHT para MD programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHT para MD" %}}
