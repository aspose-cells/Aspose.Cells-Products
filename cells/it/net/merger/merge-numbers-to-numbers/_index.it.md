---
title: Unisci NUMBERS a NUMBERS - Combina NUMBERS a NUMBERS in C#
url: /it/net/merger/merge-numbers-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Unisci NUMBERS in NUMBERS online gratis in saveformat. C# Combina NUMBERS in formato NUMBERS. Unisci NUMBERS a NUMBERS in C#. NUMBERS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci NUMBERS a NUMBERS in C# online gratuitamente" %}}

L'esempio seguente mostra come unire NUMBERS a NUMBERS in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire NUMBERS a NUMBERS. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file NUMBERS. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce NUMBERS a NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire NUMBERS a NUMBERS in C#" InputFormat="numbers" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire NUMBERS a NUMBERS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di unire NUMBERS a NUMBERS in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria per unire NUMBERS a NUMBERS" %}}
