---
title: Python ODS ila PDF - ODS ila PDF Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde ODS'i PDF'e dönüştürün. Python ODS'i PDF'e dönüştürün. Python ODS'i PDF'e kaydedin. ODS'i 07611134 olarak kaydedin 81, Python'i kullanarak.
...
{{% cells-convert title="ODS\'i PDF\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="pdf" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i Python aracılığıyla PDF\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

ODS dosyalarını program aracılığıyla PDF'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla ODS'i kolayca yükleyebilir ve PDF'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak ODS'i PDF'e dönüştürün.
1.  ODS'den PDF'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ODS\'i PDF\'e dönüştürmek için Python kitaplığı" %}}
