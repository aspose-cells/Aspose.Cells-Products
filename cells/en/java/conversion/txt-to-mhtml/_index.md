...
description: Convert TXT to MHTML format in Java code. Save TXT as MHTML using Java.
---
...
The following example demonstrates how to convert TXT to MHTML document format in Java.
...
{{% cells-convert title="Free App and Sample Code to Convert TXT to MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="mhtml" IsLandingPage="true" language="java" %}}
