---
title: Tìm kiếm và thay thế văn bản trong tài liệu XLSB qua C++ 
weight: 6660
url: /vi/cpp/redaction/xlsb/ 
description: C++ mã ví dụ để biên tập lại thông tin nhạy cảm trong tệp XLSB trên C++ Môi trường thời gian chạy cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Redact XLSB Định dạng trong C++" h2="Thông tin phản hồi nhạy cảm về tài liệu XLSB gốc và hiệu suất cao bằng cách sử dụng Aspose.Cells phía máy chủ cho C++ API mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chỉnh sửa tệp XLSB bằng cách sử dụng C++" %}}

 Để biên tập lại tệp XLSB, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/code-block title="Redact tệp XLSB - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến XLSB Redaction Live Demos" sectionDescription="Tìm kiếm và thay thế văn bản trong nội dung, nhận xét hoặc siêu dữ liệu trong tài liệu XLSB ngay bây giờ bằng cách truy cập [Trang web Demos Trực tiếp](https://products.aspose.app/cells/redaction). Bản demo trực tiếp có những lợi ích sau" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/redaction/xlsm/" name="XLSM" description="Tệp Spreasheet" >}}
