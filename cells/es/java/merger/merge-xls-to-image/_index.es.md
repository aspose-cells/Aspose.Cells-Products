---
title: Combinar XLS con IMAGEN - Combinar XLS con IMAGEN en Java
url: /es/java/merger/merge-xls-to-image/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLS para guardar formato de IMAGEN. Java Combine XLS en formato de IMAGEN. Combinar XLS a IMAGEN en Java. XLS Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLS con IMAGEN en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLS con IMAGE en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar XLS con IMAGE. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo IMAGE. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona XLS con IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLS a IMAGEN en Java" InputFormat="xls" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLS a IMAGEN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLS con IMAGE mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar XLS a IMAGEN" %}}
