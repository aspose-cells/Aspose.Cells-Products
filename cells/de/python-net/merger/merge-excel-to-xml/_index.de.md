...
url: /de/python-net/merger/merge-excel-to-xml/ 
...
Das folgende Beispiel zeigt, wie EXCEL in Aspose.Cells for Python via .NET mit XML zusammengeführt wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie EXCEL programmgesteuert in XML umwandeln? Ein grundlegendes Dokument, das zusammengeführt und verknüpft wird mit[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs können mit nur wenigen Codezeilen erstellt werden.
