...
Hai bisogno di convertire i file PRN in XLTM tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in XLTM in poche righe di codice.
...
1.  Convertire PRN in XLTM chiamando il metodo Save().
