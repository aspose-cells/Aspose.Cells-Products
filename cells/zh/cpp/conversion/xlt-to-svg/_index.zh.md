---
title: 通过 C++ 应用程序将 XLT 转换为 SVG 
url: /zh/cpp/conversion/xlt-to-svg/ 
description: XLT 文档到 SVG 格式的示例 C++ 转换代码。程序员可以使用此源代码在任何 C++ 应用程序中进行批量 XLT 到 SVG 的转换。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将 XLT 转换为 SVG" h2="使用 C++ 库的高性能 XLT 到 SVG 转换，无需安装 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 开发人员只需几行代码即可轻松地将 XLT 文件转换为 SVG。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 XLT 文件。1. 选择第一个工作表。1. 设置 (SVG) 选项。1. 遍历工作表的每一页并进行渲染。1. 在兼容程序中打开 SVG 文件。
...
{{% blocks/products/pf/agp/code-block title="XLT 到 SVG C++ 转换源代码" offSpacer="" %}}
