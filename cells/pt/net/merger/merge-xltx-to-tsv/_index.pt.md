---
title:  Mesclar XLTX para TSV via C#
url: /pt/net/merger/merge-xltx-to-tsv/ 
description: Mesclar XLTX para TSV Online gratuitamente. Online Grátis XLTX a TSV Fusão. Mesclar XLTX para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar XLTX a TSV em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar XLTX a TSV on-line" InputFormat="xltx" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
