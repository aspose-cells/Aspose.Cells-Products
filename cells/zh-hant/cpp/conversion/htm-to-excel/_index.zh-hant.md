---
title: C++ HTM 到 EXCEL - HTM 到 EXCEL 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 HTM 轉換為 EXCEL。C++ HTM 到 EXCEL。 C++ 將 HTM 儲存到 EXCEL。使用 C++ 將 HTM 儲存為 EXCEL。
...
{{% blocks/products/pf/agp/content h2="將HTM儲存到EXCEL中C++" %}}

下面的範例示範如何將C++中的HTM轉換為EXCEL。
...
{{% cells-convert title="將 HTM 轉換為 EXCEL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlsx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何將 HTM 轉換為 EXCEL 通過 C++" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 HTM 檔案轉換為 EXCEL？ C++ 開發人員只需幾行程式碼即可輕鬆將HTM轉換為EXCEL。
...
1. 使用工作簿載入 HTM 檔案。
1. 透過呼叫 Save() 方法將 HTM 轉換為 EXCEL。
1. 取得HTM到EXCEL的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ 將 HTM 轉換為 EXCEL 的庫" %}}
