...
description: Sample C++ conversion code for XLS document to ODS format. Programmers can use this source code for batch XLS to ODS conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLS to ODS C++ Conversion Source Code" offSpacer="" %}}
