...
description: Sample C++ conversion code for XLSX document to XLS format. Programmers can use this source code for batch XLSX to XLS conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLSX to XLS C++ Conversion Source Code" offSpacer="" %}}
