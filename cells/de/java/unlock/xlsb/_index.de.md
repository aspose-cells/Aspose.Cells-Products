...
{{% blocks/products/pf/agp/content h2="So entfernen Sie die Schutz-XLSB-Datei mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Entsperren von XLSB über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Entsperren Sie XLSB-Dateien über C#" offSpacer="" %}}
