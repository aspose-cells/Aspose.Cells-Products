---
title: Converter HTML para PNG por meio do aplicativo C++ 
weight: 4280
url: /pt/cpp/conversion/html-to-png/ 
description: Exemplo de código de conversão C++ de documento HTML para formato PNG. Os programadores podem usar esse código-fonte para conversão em lote de HTML para PNG em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter HTML para PNG via C++" h2="Conversão de HTML para PNG de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem converter facilmente arquivos HTML em PNG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo HTML usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (PNG).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo PNG em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de HTML para PNG C++" offSpacer="" %}}
