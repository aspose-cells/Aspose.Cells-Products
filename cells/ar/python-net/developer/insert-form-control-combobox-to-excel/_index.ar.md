---
title: قم بإدراج ComboBox (التحكم في النموذج) في Excel باستخدام Python via .Net
weight: 20
description: Python via. صافي كود المصدر لإدراج ComboBox (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج ComboBox (التحكم في النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج ComboBox (تحكم النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_combo_box/#int-int-int-int-int-int) لإدراج ComboBox (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل ComboBox (التحكم في النموذج) - Python via .Net" offSpacer="" %}}
