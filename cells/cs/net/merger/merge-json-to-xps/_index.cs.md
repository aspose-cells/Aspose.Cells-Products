...
description: Aspose Excel. C# Aspose.Cells. Sloučit JSON do XPS uložit formát. C# Kombinujte formát JSON až XPS. Sloučit JSON až XPS v C#. JSON Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JSON až XPS v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení JSON až XPS v C#" InputFormat="json" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
