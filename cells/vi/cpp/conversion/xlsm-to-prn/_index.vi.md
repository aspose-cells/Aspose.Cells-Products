...
Cần chuyển đổi các tệp XLSM sang PRN theo chương trình? Các nhà phát triển C++ có thể dễ dàng chuyển đổi XLSM thành PRN chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLSM thành PRN bằng cách gọi phương thức Save().
