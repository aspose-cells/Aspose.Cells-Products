---
title:  แทรก RadioButton (การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 60
description: Python via .Net ซอร์สโค้ดเพื่อแทรก RadioButton(Form control) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก RadioButton (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}

 เพื่อที่จะแทรก RadioButton(Form control) ลงในไฟล์ Excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก RadioButton (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ Shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) เพื่อแทรก RadioButton (ตัวควบคุมฟอร์ม) ในแผ่นงานที่เลือก
