---
title: Konwertuj XLSB na PDF za pomocą aplikacji C++ 
weight: 5360
url: /pl/cpp/conversion/xlsb-to-pdf/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSB do formatu PDF. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji plików XLSB na PDF w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na PDF przez C++" h2="Wysokowydajna konwersja XLSB do PDF przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na PDF za pomocą C++" %}}

 Aby przekonwertować XLSB na PDF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSB na PDF za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLSB na PDF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (PDF).1. Plik PDF zostanie zapisany pod określoną ścieżką.1. Otwórz plik PDF w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSB do PDF C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją XLSB do PDF" sectionDescription="[Konwertuj XLSB na PDF](https://products.aspose.app/cells/conversion/xlsb-to-pdf) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLSB, zostanie on natychmiast przekonwertowany do formatu PDF." >}}
