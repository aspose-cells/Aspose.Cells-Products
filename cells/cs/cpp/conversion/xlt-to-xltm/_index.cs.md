---
title: Převeďte XLT na XLTM pomocí aplikace C++ 

description: Ukázka převodního kódu C++ pro dokument XLT na formát XLTM. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLT na XLTM v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLT na XLTM pomocí C++" %}}

 Abychom převedli XLT na XLTM, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod XLT na XLTM přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLT na XLTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLTM).1. Soubor XLTM bude uložen do zadané cesty.1. Otevřete soubor XLTM v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLT na XLTM C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze XLT na XLTM" sectionDescription="[Převést XLT na XLTM](https://products.aspose.app/cells/conversion/xlt-to-xltm) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor XLT, bude okamžitě převeden na XLTM." >}}
