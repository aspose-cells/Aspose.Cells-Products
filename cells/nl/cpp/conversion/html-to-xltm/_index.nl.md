...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen HTML-bestanden eenvoudig in slechts een paar regels code naar XLTM converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad HTML-bestand met behulp van Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (XLTM) bestandsextensie.1. XLTM-bestand wordt opgeslagen op het opgegeven pad.1. Open het XLTM-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="HTML naar XLTM C++ Broncode voor conversie" offSpacer="" %}}
