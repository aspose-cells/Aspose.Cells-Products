---
title: MHT'yi TSV ile birleştir - MHT'yi C#'de TSV ile birleştir
url: /tr/net/merger/merge-mht-to-tsv/ 
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi MHT'yi TSV kaydetme biçimine birleştirme. C# MHT'yi TSV biçiminde birleştirin. MHT'yi C#'de TSV olarak birleştirin. MHT Birleştirin.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi TSV\'de C# Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin TSV ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

MHT'yi TSV'de birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından TSV dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. MHT'yi TSV ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="MHT\'yi C#\'de TSV ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="mht" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="MHT\'yi C# aracılığıyla TSV ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

MHT'yi programlı olarak TSV ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi TSV ile birleştirmek için .NET kitaplığı" %}}
