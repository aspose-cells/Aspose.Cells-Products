...
description: Aspose Unggul. Ubah XLSX ke JPG dengan cepat dan mudah dengan Aspose.Cells. Python XLSX ke JPG. Python Simpan XLSX ke JPG. Simpan XLSX sebagai JPG menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah XLSX menjadi JPG di Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke JPG di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLSX ke JPG di Python via NET.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengkonversi XLSX ke JPG" %}}
