...
{{% blocks/products/pf/agp/content h2="Converteer XLTM naar XPS in Python" %}}
...
Het volgende voorbeeld laat zien hoe u XLTM converteert naar XPS in Python via NET.
