---
title: Insert Button(Form control) into Excel using Python via java
weight: 200
...
{{% blocks/products/pf/agp/content h2="How to Insert Button(Form control) into Excel File Using Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Button(Form control) to Excel file using Python via java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)) to insert a Button(Form control) in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert Button(Form control) - Python via java" offSpacer="" %}}
