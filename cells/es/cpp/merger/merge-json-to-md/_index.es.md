...
{{% blocks/products/pf/agp/content h2="Fusionar JSON con MD en C++" %}}

El siguiente ejemplo demuestra cómo fusionar JSON con MD en Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar JSON con MD. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo MD. Si desarrolla código en C++, esto será más simple de lo que parece. Vea el ejemplo de C++ que fusiona JSON con MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar JSON con MD en C++" InputFormat="json" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar JSON con MD a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar JSON con MD mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para fusionar JSON con MD" %}}
