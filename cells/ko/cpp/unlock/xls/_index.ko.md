...
{{% blocks/products/pf/agp/content h2="C++을 사용하여 XLS 파일 보호를 제거하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++을(를) 통해 XLS 잠금 해제" %}}
...
1. CreateIWorkbook을 사용하여 XLS 잠금 파일을 로드합니다.1. Unprotect() 함수를 호출하여 잠금을 해제합니다.1. SetPassword를 사용하여 암호를 NULL로 설정합니다.1. 지정된 위치에 XLS 파일을 저장합니다.
