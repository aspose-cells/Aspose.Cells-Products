...
description: Aspose Excel'de. Aspose.Cells ile SXC'i hızlı ve kolay bir şekilde PRN'ye dönüştürün. Python SXC'i PRN'ye dönüştürün. Python SXC'i PRN'ye kaydedin. SXC'i Python'i kullanarak PRN olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="SXC\'i Python\'de PRN\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="SXC\'i Python\'deki PRN\'ye kaydedin" %}}

Aşağıdaki örnek, SXC'in Python via NET'de PRN'ye nasıl dönüştürüleceğini gösterir.
