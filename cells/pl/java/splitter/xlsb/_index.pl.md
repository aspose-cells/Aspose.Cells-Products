---
title:  Podziel XLSB Pliki via Java
weight: 7880
description: Java przykładowy kod do podziału dokumentów XLSB na Java środowisko wykonawcze dla aplikacji JSP/JSF i aplikacji komputerowych.
...
{{% blocks/products/pf/agp/content h2="Jak podzielić plik XLSB za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki podziału plików XLSB w Java" %}}
...
+ Wywołaj metodę zapisu z nową ścieżką pliku XLSB.
...
{{% blocks/products/pf/agp/code-block title="Podziel plik XLSB - Java" offSpacer="" %}}
