---
title:  Combinar XLS a MHT via Java
...
El siguiente ejemplo muestra cómo combinar XLS con MHT en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a MHT en línea" InputFormat="xls" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
