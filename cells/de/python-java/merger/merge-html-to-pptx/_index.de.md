...
url: /de/python-java/merger/merge-html-to-pptx/ 
...
Das folgende Beispiel zeigt, wie HTML mit PPTX in Aspose.Cells for Python via Java zusammengeführt werden.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie HTML mit PPTX programmgesteuert zusammenführen? Ein grundlegendes Dokument, das zusammengeführt und verknüpft wird mit[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs können mit nur wenigen Codezeilen erstellt werden.
