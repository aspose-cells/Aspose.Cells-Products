---
title: XLSX दस्तावेज़ को .NET के माध्यम से अनलॉक करें 
weight: 2040
url: /hi/net/unlock/xlsx/ 
description: .NET Framework, .NET Core, Mono या Xamarin Platforms पर पासवर्ड से सुरक्षित XLSX फ़ाइल को अनलॉक करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSX स्प्रेडशीट को C# के माध्यम से अनलॉक करें" h2=".NET लाइब्रेरी का उपयोग करके XLSX से सुरक्षा निकालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. संरक्षित XLSX फ़ाइल के पथ के साथ कार्यपुस्तिका वर्ग को त्वरित करें1. सुरक्षा हटाने के लिए डिफ़ॉल्ट या कोई वर्कशीट प्राप्त करें1. वर्कशीट के साथ वर्कशीट सुरक्षा निकालें। असुरक्षित विधि1. कार्यपुस्तिका के साथ कार्यपुस्तिका सुरक्षा निकालें। असुरक्षित विधि1. XLSX प्रारूप में परिणाम सहेजें
...
// सुरक्षित XLSX फ़ाइल के साथ कार्यपुस्तिका ऑब्जेक्ट को इंस्टेंट करें
var workbook = new Aspose.Cells.Workbook("protected.xlsx");

// एक्सेल फ़ाइल में डिफ़ॉल्ट वर्कशीट तक पहुँचें
var worksheet = workbook.Worksheets[0];

// पासवर्ड के बिना असुरक्षित कार्यपत्रक
worksheet.Unprotect();

// पासवर्ड के साथ असुरक्षित कार्यपुस्तिका
workbook.Unprotect("password");

// परिणाम को वापस XLSX प्रारूप में सहेजें
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/unlock/ods/" name="ओडीएस" description="OpenDocument स्प्रेडशीट फ़ाइल" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/unlock/xls/" name="एक्सएलएस" description="एक्सेल बाइनरी प्रारूप" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/unlock/xlsb/" name="एक्सएलएसबी" description="बाइनरी एक्सेल वर्कबुक फाइल" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/unlock/xlsm/" name="एक्सएलएसएम" description="स्प्रेडशीट फ़ाइल" >}}
