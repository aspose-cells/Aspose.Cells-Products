---
title:  Inserisci Oval in Excel tramite C++
weight: 40
description: C++ codice di esempio per inserire Oval nel file Excel su C++ Runtime Environment per Windows 32 bit, Windows 64 bit e Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci Oval in Excel tramite C++" h2="Inserisci oggetti utilizzando il nativo e ad alte prestazioni del lato server Aspose.Cells for C++ API senza utilizzare alcun software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire ovale in un file Excel utilizzando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire il file Oval in Excel tramite C++" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#a90bc960de1b4a6d6beaf6c7cc4651bc2) per inserire Equation Shapes nel foglio di lavoro selezionato
...
{{% blocks/products/pf/agp/code-block title="Inserto Ovale - C++" offSpacer="" %}}
