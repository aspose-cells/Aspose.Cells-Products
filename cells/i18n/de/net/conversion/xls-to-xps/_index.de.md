---
title: Konvertieren Sie XLS in XPS über C#
url: /de/net/conversion/xls-to-xps/
description: Beispielcode für die Umwandlung von xls in xps C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von xls-Dateien in xps innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS in XPS mit C#" %}}

 Um XLS in XPS zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von XLS in XPS über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können XLS-Dateien in nur wenigen Codezeilen einfach laden und in XPS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. XLS-Datei mit einer Instanz von Workbook laden1. Rufen Sie die Workbook.Save-Methode auf1. Übergeben Sie den Ausgabepfad mit der XPS-Erweiterung als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende XPS-Datei
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von XLS in XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xps" IsLandingPage="true" %}}
