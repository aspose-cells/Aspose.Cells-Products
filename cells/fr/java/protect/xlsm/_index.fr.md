---
title:  Protéger et verrouiller le document XLSM via Java
weight: 9620
description: Exemple de code Java pour verrouiller le fichier XLSM à l'aide d'un mot de passe sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chiffrer les fichiers XLSM via Java" h2="Protégez par mot de passe les feuilles de calcul Excel, y compris le format XLSM, à l\'aide de la bibliothèque .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
1.  Chargez le fichier XLSM en instanciant la classe Workbook
