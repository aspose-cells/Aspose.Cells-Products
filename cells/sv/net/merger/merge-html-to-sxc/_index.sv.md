...
url: /sv/net/merger/merge-html-to-sxc/ 
...
Följande exempel visar hur man slår samman HTML till SXC i Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Behöver du slå samman HTML till SXC programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman HTML till SXC" %}}
