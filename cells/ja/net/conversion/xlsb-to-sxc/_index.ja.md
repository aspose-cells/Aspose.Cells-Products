---
title: XLSB を SXC C# に変換します
description: オンラインで無料でXLSBをSXCに変換します。無料のオンラインXLSBからSXCへのコンバーター。 C# XLSB から SXC まで。C# 経由で XLSB から SXC まで。
keywords: Convert XLSB, XLSB Converter, XLSB to PDF, XLSB to Word, XLSB to PPT, XLSB to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB を C# 経由で SXC に変換します" h2="XLSB を SXC に変換するための高速 C# ライブラリ。.NET フレームワーク、.NET コアまたは Mono プラットフォームで Excel スプレッドシートを SXC 形式にエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% cells-convert title="オンラインでXLSBをSXCに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でXLSBをSXCに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開発者は、わずか数行のコードで XLSB を簡単にロードして SXC に変換できます。
