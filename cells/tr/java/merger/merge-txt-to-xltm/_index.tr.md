---
title: TXT'i XLTM'e birleştir - TXT'i Java'de XLTM'e birleştir
url: /tr/java/merger/merge-txt-to-xltm/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i XLTM kaydetme biçimiyle birleştirin. Java TXT'i XLTM biçimiyle birleştirin. Java'de TXT'i XLTM ile birleştirin. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'de XLTM ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de TXT ile XLTM'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT ile XLTM'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLTM dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT ile XLTM'i birleştiren Java örneğine bakın.
...
{{% blocks/products/pf/agp/content h2="TXT ile XLTM via Java Nasıl Birleştirilir?" %}}

{{% blocks/products/pf/agp/text %}}

 TXT ile XLTM'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, TXT ile XLTM arasında birleştirilecek" %}}
