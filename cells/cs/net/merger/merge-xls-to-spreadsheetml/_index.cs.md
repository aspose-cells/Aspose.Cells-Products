---
title: Sloučit XLS do SPREADSHEETML - Sloučit XLS do SPREADSHEETML v C#
url: /cs/net/merger/merge-xls-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Zdarma online sloučení XLS do formátu uložení SPREADSHEETML. C# Zkombinujte XLS do formátu SPREADSHEETML. Sloučit XLS do SPREADSHEETML v C#. XLS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLS do SPREADSHEETML v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLS do SPREADSHEETML v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLS do SPREADSHEETML. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru SPREADSHEETML. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí XLS do SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XLS do SPREADSHEETML v C#" InputFormat="xls" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLS do SPREADSHEETML přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit XLS do SPREADSHEETML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení XLS do SPREADSHEETML" %}}
