...
description: Aspose Эксель. Java Создайте файл XLT быстро и легко с помощью Aspose.Cells. Создайте файл XLT с помощью Java. Создайте XLT в Java. Java XLT Creater.
...
1. Сохраните книгу в формате XLT, используя метод save().
