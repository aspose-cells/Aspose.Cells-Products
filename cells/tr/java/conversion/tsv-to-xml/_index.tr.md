...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TSV\'yi XML\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla TSV\'yi XML\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, TSV dosyasını yalnızca birkaç kod satırıyla kolayca XML'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TSV dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. Çıktı yolunu XML uzantısı ve SaveFormat ile parametre olarak iletin1. Sonuç XML dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="TSV\'den XML\'e Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TSV dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.tsv");
// TSV'yi XML olarak kaydet
