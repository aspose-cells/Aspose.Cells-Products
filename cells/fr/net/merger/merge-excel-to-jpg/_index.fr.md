...
url: /fr/net/merger/merge-excel-to-jpg/ 
...
L'exemple suivant montre comment fusionner EXCEL en JPG dans Aspose.Cells for .NET.
...
Besoin de fusionner EXCEL en JPG par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner EXCEL en JPG" %}}
