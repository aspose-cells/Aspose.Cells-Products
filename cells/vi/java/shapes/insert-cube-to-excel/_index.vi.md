---
title:  Chèn khối lập phương vào Excel via Java
weight: 20
...
{{% blocks/products/pf/agp/content h2="Cách Chèn Cube Vào File Excel Bằng Sử Dụng Java" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng các[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) để chèn Cube vào trang tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn Cube - Java" offSpacer="" %}}
