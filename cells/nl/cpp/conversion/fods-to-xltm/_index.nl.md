...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-ontwikkelaars kunnen eenvoudig FODS converteren naar XLTM in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het bestand FODS met Factory::CreateIWorkbook.
1. Converteer FODS naar XLTM door de methode Save() aan te roepen.
