---
title: "TSV konvertálása XPS-re a következőn keresztül: C#"
url: /hu/net/conversion/tsv-to-xps/
description: Mintakód a tsv–xps C# konverzióhoz. Használjon API példakódot a tsv fájlok kötegelt xps-re konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása XPS-re a következővel: C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV XPS-re konvertálásához a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen betölthetik és konvertálhatják a TSV-fájlokat XPS-re, mindössze néhány sornyi kóddal.
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód a TSV XPS-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xps" IsLandingPage="true" %}}
