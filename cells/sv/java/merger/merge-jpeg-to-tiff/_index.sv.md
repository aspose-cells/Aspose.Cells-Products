---
title: Slå samman JPEG till TIFF - Kombinera JPEG till TIFF i Java
url: /sv/java/merger/merge-jpeg-to-tiff/ 
description: Aspose Excel. Java Aspose.Cells. Slå samman JPEG till TIFF sparaformat. Java Kombinera JPEG till TIFF format. Slå samman JPEG till TIFF i Java. JPEG Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman JPEG till TIFF i Java" %}}

Följande exempel visar hur man slår samman JPEG till TIFF i Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman JPEG till TIFF. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen TIFF. Om du utvecklar kod i Java blir detta enklare än det låter. Se Java exempel som slår samman JPEG till TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exempelkod för att slå samman JPEG till TIFF i Java" InputFormat="jpg" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman JPEG till TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman JPEG till TIFF programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for Java](https://products.aspose.com/cells/java) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="Java bibliotek för att slå samman JPEG till TIFF" %}}
