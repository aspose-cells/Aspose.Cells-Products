...
description: Aspose Excel。 Python Excel。使用 Aspose.Cells. Python FODS 到 XML 快速輕鬆地將 FODS 轉換為 XML。 Python 將 FODS 儲存到 XML。使用 Python Excel 庫將 FODS 儲存為 XML。
...
{{% blocks/products/pf/agp/content h2="將 FODS 轉換為 Python Excel 庫中的 XML" %}}
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 Python Excel 庫中的 XML" %}}

以下範例示範如何將 Python excel 庫中的 FODS 轉換為 XML。
...
{{% cells-convert title="透過 Python Excel 庫將 FODS 轉換為 XML 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xml" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 函式庫將 FODS 轉換為 XML" %}}
