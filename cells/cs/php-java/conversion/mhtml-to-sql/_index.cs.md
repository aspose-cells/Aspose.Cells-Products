---
title: PHP MHTML na SQL - MHTML na SQL Converter
description: Aspose Excel. Převeďte MHTML na SQL rychle a snadno pomocí Aspose.Cells. PHP MHTML na SQL. PHP Uložit MHTML do SQL. Uložte MHTML jako SQL pomocí PHP.
...
{{% cells-convert title="Ukázkový kód pro převod MHTML na SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="sql" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést MHTML na SQL přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory na SQL programově? Vývojáři PHP mohou snadno načíst a převést MHTML na SQL v několika řádcích kódu.
...
1.  Převeďte MHTML na SQL voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na SQL" %}}
