...
{{% blocks/products/pf/agp/content h2="كيفية دمج ملفات XLSX باستخدام Java" %}}

 لدمج ملف XLSX ، سنستخدم
...
+ قم بتحميل مستند XLSX الثاني بنسخة من فئة المصنف.
...
{{% blocks/products/pf/agp/code-block title="دمج ملفات XLSX - Java" offSpacer="" %}}
