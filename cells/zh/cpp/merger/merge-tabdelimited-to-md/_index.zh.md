---
title: 将 TABDELIMITED 合并到 MD - 将 TABDELIMITED 合并到 C++ 中的 MD
url: /zh/cpp/merger/merge-tabdelimited-to-md/ 
description: Aspose Excel。 C++ Aspose.Cells。将 TABDELIMITED 合并为 MD 保存格式。 C++ 将TABDELIMITED合并为MD格式。将 TABDELIMITED 合并到 C++ 中的 MD。 TABDELIMITED 合并。
...
{{% blocks/products/pf/agp/content h2="使用 C++ 将 TABDELIMITED 合并到 MD" %}}

如何将 TABDELIMITED 合并到 MD？借助 Aspose.Cells for C++ 库，您可以通过几行代码以编程方式轻松将 TABDELIMITED 合并到 MD。[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 C++ Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。您可以直接下载最新版本，打开即可[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/)包管理器，搜索Aspose.Cells.cpp并安装。您还可以从包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/content h2="将 TABDELIMITED 合并到 C++ 中的 MD" %}}

以下示例演示如何将 TABDELIMITED 合并到 Aspose.Cells for C++ 中的 MD。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 TABDELIMITED 合并到 MD。上传文件，调用Workbook.Combine方法合并文件，然后保存到MD文件。如果您在 C++ 中开发代码，这会比听起来更简单。请参阅 C++ 将 TABDELIMITED 合并到 MD 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="将 TABDELIMITED 合并到 C++ 中的 MD 的示例代码" InputFormat="tsv" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C++ 将 TABDELIMITED 合并到 MD" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 TABDELIMITED 合并到 MD 吗？基本文档合并和连接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++ 库将 TABDELIMITED 合并到 MD" %}}
