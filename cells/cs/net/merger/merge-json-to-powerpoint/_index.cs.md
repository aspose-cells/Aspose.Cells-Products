---
title: Sloučit JSON do POWERPOINT - Sloučit JSON do POWERPOINT v C#
url: /cs/net/merger/merge-json-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Bezplatné online sloučení JSON do formátu uložení POWERPOINT. C# Spojte JSON do formátu POWERPOINT. Sloučit JSON do POWERPOINT v C#. JSON Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JSON do POWERPOINT v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JSON do POWERPOINT v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JSON do POWERPOINT. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru POWERPOINT. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí JSON do POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JSON do POWERPOINT v C#" InputFormat="json" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON do POWERPOINT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit JSON do POWERPOINT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu ke sloučení JSON do POWERPOINT" %}}
