...
description: Aspose Exceller. Convertissez FODS en GIF rapidement et facilement avec Aspose.Cells. Python FODS en GIF. Python Enregistrez FODS en GIF. Enregistrez FODS sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le FODS au GIF au Python" %}}

L'exemple suivant montre comment convertir FODS en GIF dans Python.
...
{{% cells-convert title="Exemple de code pour convertir FODS en GIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="gif" IsLandingPage="true" language="pythonjava" %}}
