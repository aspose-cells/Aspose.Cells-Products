---
title: Объединить NUMBERS в ODS - Объединить NUMBERS в ODS в C#
url: /ru/net/merger/merge-numbers-to-ods/ 
description: Aspose Excel. C# Aspose.Cells. Бесплатное онлайн-слияние NUMBERS в формат сохранения ODS. C# Объединить ЧИСЛА в формат ODS. Объединить НОМЕРА в ODS в C#. Объединить НОМЕРА.
...
{{% blocks/products/pf/agp/content h2="Объедините NUMBERS в ODS в C# онлайн бесплатно" %}}

В следующем примере показано, как объединить NUMBERS с ODS в Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Выполните простые шаги, чтобы объединить NUMBERS в ODS. Загрузите свои файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл ODS. Если вы разрабатываете код в C#, это будет проще, чем кажется. См. пример C#, в котором NUMBERS объединяется с ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Бесплатно онлайн объединить НОМЕРА в ODS в C#" InputFormat="numbers" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Как объединить NUMBERS с ODS через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить NUMBERS в ODS? Базовый документ сливается и объединяется с[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="библиотека .NET для объединения NUMBERS с ODS" %}}
