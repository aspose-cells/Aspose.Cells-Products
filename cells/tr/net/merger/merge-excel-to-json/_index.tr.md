...
url: /tr/net/merger/merge-excel-to-json/ 
...
Aşağıdaki örnek, EXCEL'in Aspose.Cells for .NET'deki JSON ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 EXCEL'i programlı olarak JSON ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i JSON ile birleştirmek için .NET kitaplığı" %}}
