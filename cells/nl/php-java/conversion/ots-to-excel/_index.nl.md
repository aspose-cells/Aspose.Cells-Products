...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar EXCEL met Aspose.Cells. PHP OTS naar EXCEL. PHP Bewaar OTS naar EXCEL. Bewaar OTS als EXCEL met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar EXCEL te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar EXCEL converteren? PHP-ontwikkelaars kunnen OTS eenvoudig in slechts een paar regels code laden en converteren naar EXCEL.
...
1.  Converteer OTS naar EXCEL door de opslagmethode van Workbook aan te roepen.
