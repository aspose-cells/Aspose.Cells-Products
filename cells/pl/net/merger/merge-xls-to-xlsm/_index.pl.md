---
title: Połącz XLS z XLSM - Połącz XLS z XLSM w C#
url: /pl/net/merger/merge-xls-to-xlsm/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLS do XLSM w formacie zapisu. C# Połącz format XLS z XLSM. Połącz XLS z XLSM w C#. XLS Połącz.
...
Poniższy przykład pokazuje, jak połączyć XLS z XLSM w Aspose.Cells for .NET.
...
{{% cells-merger title="Bezpłatne połączenie online XLS z XLSM w C#" InputFormat="xls" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLS z XLSM za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLS z XLSM programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
