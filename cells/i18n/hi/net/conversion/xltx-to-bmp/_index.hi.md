---
title: XLTX को BMP के माध्यम से C# में बदलें
url: /hi/net/conversion/xltx-to-bmp/
description: xltx से bmp C# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर बैच xltx फ़ाइलों को bmp रूपांतरण के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET डेवलपर कोड की कुछ ही पंक्तियों में आसानी से XLTX फ़ाइलों को BMP में लोड और परिवर्तित कर सकते हैं।
...
{{% cells-convert title="XLTX को BMP में बदलने के लिए फ्री ऐप और सैंपल कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="bmp" IsLandingPage="true" %}}
