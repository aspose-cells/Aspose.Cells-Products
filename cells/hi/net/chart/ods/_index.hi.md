---
title:  छवियों के लिए ODS दस्तावेज़ चार्ट via .NET
weight: 4360
description: .NET फ्रेमवर्क, .NET कोर, Mono या Xamarin प्लेटफार्मों पर ODS फ़ाइल में चार्ट या आरेख को आकर्षित करने और परिवर्तित करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# में छवियों के लिए ODS फ़ाइल चार्ट" h2="Microsoft या Adobe PDF जैसे किसी भी सॉफ़्टवेयर के उपयोग के बिना सर्वर-साइड API का उपयोग करके छवि रूपांतरण के लिए मूल और उच्च प्रदर्शन ODS दस्तावेज़ चार्ट।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके ODS चार्ट को छवियों में कैसे बदलें" %}}
 ...
 ODS चार्ट कन्वर्ट करने के लिए, हम उपयोग करेंगे
