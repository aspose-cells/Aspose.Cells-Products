...
{{% blocks/products/pf/agp/content h2="Převeďte XML na MARKDOWN pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XML na MARKDOWN v Python.
