...
Töltse be az összes XLSM fájlt teljes elérési úttal.
+ Készítsen egy dokumentumot alapfájlként
+ Hívja meg a megfelelő metódust a fájlok egyenkénti összefűzésére és egyesítésére.
+ Hívja meg a Save() metódust, és adja meg a fájlnevet (teljes elérési út) és a formátumot (XLSM) paraméterként.
+ Most már megnyithatja és használhatja az XLSM fájlt a Microsoft Office-ban, az Adobe PDF-ben vagy bármely más kompatibilis programban.
