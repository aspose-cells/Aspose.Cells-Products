---
title: Gabung XLT ke XLTM - Gabungkan XLT ke XLTM di Java
url: /id/java/merger/merge-xlt-to-xltm/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge XLT to XLTM saveformat. Java Gabungkan format XLT menjadi XLTM. Gabung XLT ke XLTM di Java. XLT Gabung.
...
Contoh berikut menunjukkan cara menggabungkan XLT ke XLTM di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan XLT ke XLTM di Java" InputFormat="xlt" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLT ke XLTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLT menjadi XLTM secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
