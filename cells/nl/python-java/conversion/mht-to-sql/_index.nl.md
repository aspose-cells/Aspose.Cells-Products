...
{{% blocks/products/pf/agp/content h2="Converteer MHT naar SQL met behulp van de Excel-bibliotheek Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sla MHT op in SQL in Python Excel-bibliotheek" %}}

In het volgende voorbeeld ziet u hoe u MHT naar SQL converteert in de Excel-bibliotheek Python.
...
{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om MHT naar SQL te converteren" %}}
