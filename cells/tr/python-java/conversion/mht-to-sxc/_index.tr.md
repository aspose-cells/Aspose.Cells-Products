...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde MHT'yi SXC'e dönüştürün. Python MHT'yi SXC'e dönüştürün. Python MHT'yi SXC'e kaydedin. Python'i kullanarak MHT'yi SXC olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'i kullanarak MHT\'yi SXC\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="MHT\'yi Python\'de SXC\'e kaydedin" %}}

Aşağıdaki örnekte MHT'nin Python'de SXC'e nasıl dönüştürüleceği gösterilmektedir.
...
{{% cells-convert title="MHT\'yi SXC\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="sxc" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="MHT\'yi SXC\'e dönüştürmek için Python kitaplığı" %}}
