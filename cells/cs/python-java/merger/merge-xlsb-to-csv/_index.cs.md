---
title: Sloučit XLSB až CSV - Sloučit XLSB až CSV v Python
url: /cs/python-java/merger/merge-xlsb-to-csv/ 
description: Aspose Excel. Python Aspose.Cells. Sloučit XLSB do CSV uložit formát. Python Kombinujte formát XLSB až CSV. Sloučit XLSB až CSV v Python. XLSB Sloučit.
...
{{% cells-merger title="Ukázkový kód pro sloučení XLSB až CSV v Python" InputFormat="xlsb" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB na CSV přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLSB až CSV? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
