...
description: Aspose.Cells för SharePoint-appen är en SharePoint Excel-kalkylarksomvandlare. Exportera XLS XLSX XML CSV PDF ODS &amp; HTML-format i MOSS WSS
---
...
{{< blocks/products/pf/carousel-item h3="En överblick" description="En översikt över Aspose.Cells för SharePoint." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Aspose.Cells för SharePoint stöder Windows SharePoint Services, SharePoint Foundation och Microsoft SharePoint Server." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.Cells för SharePoint stöder många populära kalkylarksformat, PDF, HTML och andra [filformat](https://docs.aspose.com/cells/sharepoint/supported-file-formats/)." >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Cells för SharePoint?" tabId="success-stories" >}}
