...
Trzeba programowo przekonwertować pliki JPG do formatu DIF? Programiści C++ mogą łatwo przekonwertować pliki JPG do formatu DIF za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JPG do DIF wywołując metodę Save().
