...
description: Aspose 엑셀. Aspose.Cells을 사용하여 JPG를 EXCEL로 빠르고 쉽게 변환하세요. Python JPG를 EXCEL로 변환하세요. Python JPG를 EXCEL에 저장합니다. Python을 사용하여 JPG를 EXCEL로 저장합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python에서 JPG를 EXCEL로 변환하세요." h2="JPG를 EXCEL로 변환하기 위한 고속 Python 라이브러리. 이것은 Python을 사용하여 JPG, EXCEL 및 기타 여러 형식을 가져오고 내보내는 전문 소프트웨어 솔루션입니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python에서 JPG를 EXCEL로 저장하세요." %}}

다음 예에서는 Python에서 JPG를 EXCEL로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="JPG를 EXCEL로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}
