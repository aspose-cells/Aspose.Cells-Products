---
title: دمج XLSB في SPREADSHEETML - دمج XLSB في SPREADSHEETML في C++
url: /ar/cpp/merger/merge-xlsb-to-spreadsheetml/ 
description: Aspose اكسل. C++ Aspose.Cells. دمج XLSB في تنسيق حفظ SPREADSHEETML. C++ قم بدمج XLSB إلى تنسيق SPREADSHEETML. دمج XLSB في جدول البيانات C++. XLSB دمج.
...
{{% blocks/products/pf/agp/content h2="دمج XLSB في جدول البيانات في C++" %}}

يوضح المثال التالي كيفية دمج XLSB في SPREADSHEETML في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج XLSB في SPREADSHEETML. قم بتحميل ملفاتك، واستدعاء طريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف SPREADSHEETML. إذا قمت بتطوير التعليمات البرمجية في C++، فسيكون هذا أبسط مما يبدو. راجع مثال C++ الذي يدمج XLSB في SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج التعليمات البرمجية لدمج XLSB في SPREADSHEETML في C++" InputFormat="xlsb" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLSB في جدول البيانات عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج XLSB في SPREADSHEETML برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لدمج XLSB في SPREADSHEETML" %}}
