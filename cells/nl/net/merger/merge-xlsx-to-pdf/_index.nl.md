...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLSX programmatisch samenvoegen tot PDF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLSX samen te voegen tot PDF" %}}
