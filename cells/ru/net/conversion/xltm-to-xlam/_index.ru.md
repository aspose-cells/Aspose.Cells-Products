...
{{% blocks/products/pf/agp/content h2="Преобразовать XLTM в XLAM, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в XLAM в C#" %}}
...
1.  Преобразуйте значение XLTM в XLAM, вызвав метод Workbook.Save.
