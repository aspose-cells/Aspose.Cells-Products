---
title: دمج TXT في IMAGE - اجمع TXT إلى IMAGE في Java
url: /ar/java/merger/merge-txt-to-image/ 
description: Aspose إكسل. Java Aspose.Cells. الدمج المجاني عبر الإنترنت TXT إلى IMAGE saveformat. Java اجمع TXT إلى تنسيق IMAGE. دمج TXT إلى IMAGE في Java. TXT دمج.
...
{{% blocks/products/pf/agp/content h2="دمج TXT في IMAGE في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج TXT في IMAGE في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج TXT في IMAGE. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف IMAGE. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج TXT إلى IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني عبر الإنترنت لدمج TXT مع IMAGE في Java" InputFormat="txt" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج TXT مع IMAGE via Java" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج TXT في IMAGE برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لدمج TXT إلى IMAGE" %}}
