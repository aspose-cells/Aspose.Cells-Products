...
{{% blocks/products/pf/agp/content h2="Cómo anotar un archivo XLSX usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar comentarios en XLSX a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLSX Excel usando el objeto de clase IWorkbook.1. Seleccione la hoja correspondiente1. Agregue el comentario usando el método Agregar1. Establece la nota del comentario usando el método SetNote.1. Guarde el libro de trabajo usando [Guardar](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a77072cfb929787df9ad1f38b02f58349) método
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API se puede usar para crear, editar, convertir y representar formatos de Microsoft Excel en diferentes formatos. Además, se puede usar para gráficos completos, informes escalables y cálculos confiables dentro de las aplicaciones de software. Aspose.Cells es un API independiente y no requiere ningún software como Microsoft u OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Agregar o quitar anotaciones de XLSX a través de la aplicación en línea" sectionDescription="Elimine las anotaciones de documentos XLSX ahora mismo visitando nuestro [Sitio web de demostraciones en vivo](https://products.aspose.app/cells/annotation). La demostración en vivo tiene los siguientes beneficios" >}}
