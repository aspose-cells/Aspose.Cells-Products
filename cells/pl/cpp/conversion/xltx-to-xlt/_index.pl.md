---
title: Konwertuj XLTX na XLT za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltx-to-xlt/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTX do formatu XLT. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTX na XLT w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLTX na XLT przez C++" h2="Wysokowydajna konwersja XLTX do XLT przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLTX na XLT w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTX przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLT).1. Plik XLT zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLT w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLTX do XLT C++" offSpacer="" %}}
