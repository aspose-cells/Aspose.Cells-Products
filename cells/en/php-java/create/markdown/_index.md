...
{{% blocks/products/pf/agp/content h2="How to Create MARKDOWN in PHP" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to create, load, modify and convert MARKDOWN files within running different reporting applications for data processing in just a few lines of code.
...
1.  Save the workbook as MARKDOWN format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create MARKDOWN file in PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PHP library to create MARKDOWN file" %}}
