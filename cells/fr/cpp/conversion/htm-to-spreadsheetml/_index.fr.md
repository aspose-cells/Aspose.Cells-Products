...
Besoin de convertir des fichiers HTM en SPREADSHEETML par programmation ? Les développeurs C++ peuvent facilement effectuer cette conversion en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en SPREADSHEETML en appelant la méthode Save().
