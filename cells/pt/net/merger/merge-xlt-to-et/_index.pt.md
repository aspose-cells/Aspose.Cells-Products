---
title: Mescle XLT para ET - Combine XLT para ET em C#
url: /pt/net/merger/merge-xlt-to-et/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita XLT para ET saveformat. C# Combine XLT para o formato ET. Mesclar XLT para ET em C#. XLT Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLT para ET em C# Online Gratuitamente" %}}

exemplo a seguir demonstra como mesclar XLT com ET em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLT com ET. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo ET. Se você desenvolver código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla XLT com ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLT para ET em C#" InputFormat="xlt" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLT para ET via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLT para ET programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLT para ET" %}}
