...
description: Aspose Excel. Convierta XLTM a XLSM rápida y fácilmente con Aspose.Cells. Python XLTM a XLSM. Python Guarde XLTM en XLSM. Guarde XLTM como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLTM al XLSM en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLTM a XLSM en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLTM en XLSM" %}}
