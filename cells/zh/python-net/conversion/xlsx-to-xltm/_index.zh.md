---
title: Python XLSX 至 XLTM - XLSX 至 XLTM 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLSX 转换为 XLTM。 Python XLSX 为 XLTM。 Python 将 XLSX 保存为 XLTM。 将 XLSX 另存为 07611134 81 使用 Python。
...
{{% cells-convert title="将 XLSX 转换为 XLTM 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xltm" IsLandingPage="true" language="pythonnet" %}}
