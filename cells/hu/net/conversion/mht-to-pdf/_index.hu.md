---
title: C# MHT - PDF - MHT - PDF konverter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az MHT PDF formátumba konvertálásához, lehetővé téve az MHT adatok zökkenőmentes mentését PDF formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentsd el az MHT-t a PDF-es számra a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet az MHT-t PDF-re konvertálni a C#-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket az MHT PDF-re konvertálásához. Töltse fel MHT-fájlját, majd egyszerűen mentse el PDF fájlként. Mind az MHT-olvasáshoz, mind a PDF íráshoz használhat teljesen minősített fájlneveket. A PDF kimeneti tartalom és formázás megegyezik az eredeti MHT dokumentuméval.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mintakód az MHT PDF-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Az MHT konvertálása PDF-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Az MHT-fájlokat programozottan PDF-re kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és konvertálhatják az MHT-t PDF-re, mindössze néhány sornyi kóddal.
...
1.  Alakítsa át az MHT-t PDF-re a Workbook.Save metódus meghívásával.
1. Szerezd meg az MHT PDF számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT PDF-re konvertálásához" %}}
