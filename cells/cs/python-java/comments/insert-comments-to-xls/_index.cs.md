---
title: Vložte komentáře do souboru XLS přes Python
url: /cs/python-java/comments/insert-comments-to-xls/ 
description: Vložte komentáře do XLS pomocí Python. Pro vložení komentářů do aplikace Python použijte ukázkový kód API.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vložte komentáře do souboru XLS přes Python" h2="Vytvořte si vlastní aplikaci Python pro manipulaci s komentáři a autory v souborech dokumentů pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit komentáře do souboru XLS přes Python" %}}
...
Office 365 jsou komentáře pro konverzace, můžete použít následující kód Python pro vkládání a odstraňování komentářů v souboru XLS.

{{% blocks/products/pf/agp/code-block title="Python ukázkový kód pro vložení a odstranění komentářů v souboru XLS" offSpacer="" %}}
...
{{% cells-annotation title="Bezplatná aplikace pro odstranění anotací ze souboru XLS" InputFormat="xls" IsLandingPage="true" language="python" %}}
