---
title: C# XLSX hingga DIF - XLSX hingga DIF Konverter
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi XLSX ke format DIF, memungkinkan penyimpanan data XLSX ke format DIF dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke DIF di C#" %}}

Contoh berikut menunjukkan cara mengkonversi XLSX menjadi DIF di C#.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah XLSX menjadi DIF melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke DIF secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX menjadi DIF hanya dalam beberapa baris kode.
...
1.  Konversikan XLSX menjadi DIF dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi dari XLSX menjadi DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# perpustakaan untuk mengkonversi XLSX menjadi DIF" %}}
