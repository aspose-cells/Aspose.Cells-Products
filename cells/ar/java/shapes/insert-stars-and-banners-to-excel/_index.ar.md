---
title:  أدخل نجمة / لافتة في Excel via Java
weight: 381
description: أدخل نجمة / لافتة باستخدام Aspose.Cells 'Java API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF ، إلخ.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل نجمة / لافتة في Excel via Java" h2="أدخل نجمة / لافتة باستخدام Aspose.Cells \'API بدون أي برنامج مثل Microsoft أو Open Office أو Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج نجمة / لافتة في ملف Excel باستخدام Java" %}}

 من أجل إدراج إدراج Star / Banner في ملف Excel ، سنستخدمه
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج نجمة / لافتة في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) لإدراج إدراج نجمة / شعار في ورقة العمل المحددة
...
يوضح نموذج التعليمة البرمجية أدناه كيفية إدراج "Ribbon: Curved and Tilted Up" و "Explosion: 8 Points". لمزيد من الأنواع ، يرجى الرجوع إلى "نظرة عامة على إدراج أنواع Star And Banner" أدناه.

{{% blocks/products/pf/agp/code-block title="أدخل إدراج نجمة / لافتة - Java" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 نظرة عامة على إدراج أنواع Star And Banner
   </h2>
   <div class="col-lg-4">
