---
title: PHP IMAGE'dan SXC'e - IMAGE'den SXC'e dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile IMAGE'ı hızlı ve kolay bir şekilde SXC'e dönüştürün. PHP IMAGE'ı SXC'e dönüştürün. PHP IMAGE'ı SXC'e kaydedin. PHP kullanarak IMAGE'ı SXC olarak kaydedin.
...
{{% cells-convert title="IMAGE\'ı SXC\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="sxc" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="IMAGE\'ı PHP aracılığıyla SXC\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

IMAGE dosyalarını programlı olarak SXC'e dönüştürmeniz mi gerekiyor? PHP geliştiricileri IMAGE'ı yalnızca birkaç satır kodla kolayca yükleyebilir ve SXC'e dönüştürebilir.
...
1. Çalışma Kitabının kaydetme yöntemini çağırarak IMAGE'ı SXC'e dönüştürün.
1.  IMAGE dönüşüm sonucunu SXC'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="IMAGE\'ı SXC\'e dönüştürmek için PHP kütüphanesi" %}}
