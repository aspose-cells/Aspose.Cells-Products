---
title: Konvertera JSON till DIF via Python
url: /sv/python-java/conversion/json-to-dif/
description: Exempelkod för json till dif Python-konvertering. Använd API exempelkod för batch-json-filer för att differentiera konvertering inom Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du JSON till DIF med Python" %}}

 För att konvertera JSON till DIF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera JSON till DIF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera JSON-filer till DIF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda JSON-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med DIF-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande DIF-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera JSON till DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="dif" IsLandingPage="true" language="python" %}}
