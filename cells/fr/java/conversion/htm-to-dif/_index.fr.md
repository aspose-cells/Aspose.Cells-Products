---
title: Java HTM à DIF - Convertisseur HTM à DIF
description: Aspose Exceller. Convertissez HTM en DIF rapidement et facilement avec Aspose.Cells. Java HTM en DIF. Java Enregistrez HTM en DIF. Enregistrez HTM sous DIF en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au DIF dans Java" %}}

L'exemple suivant montre comment convertir HTM en DIF en Java.
...
{{% cells-convert title="Exemple de code pour convertir HTM en DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="dif" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en DIF par programme ? Les développeurs Java peuvent facilement convertir HTM en DIF en quelques lignes de code seulement.
...
1.  Convertissez HTM en DIF en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de HTM en DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir HTM en DIF" %}}
{{% blocks/products/pf/agp/text %}}
