---
title: Sloučit JPG s PPTX - Sloučit JPG s PPTX v C++
url: /cs/cpp/merger/merge-jpg-to-pptx/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit JPG do formátu uložení PPTX. C++ Zkombinujte JPG do formátu PPTX. Sloučit JPG na PPTX v C++. Sloučit JPG.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG na PPTX v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JPG s PPTX v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do PPTX. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PPTX. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do PPTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JPG na PPTX v C++" InputFormat="jpg" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPG na PPTX přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit JPG na PPTX programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do PPTX" %}}
