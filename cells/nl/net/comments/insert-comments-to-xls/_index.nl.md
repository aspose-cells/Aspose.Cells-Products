...
{{% blocks/products/pf/agp/content h2="Opmerkingen invoegen in XLS-bestand via C#" %}}
...
In Office 365 zijn opmerkingen voor gesprekken. U kunt de volgende code C# gebruiken om opmerkingen in het bestand XLS in te voegen en te verwijderen.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode C# voor het invoegen en verwijderen van opmerkingen in het bestand XLS" offSpacer="" %}}
