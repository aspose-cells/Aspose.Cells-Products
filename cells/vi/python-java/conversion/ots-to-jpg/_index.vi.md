---
title: Python OTS sang JPG - Chuyển đổi OTS sang JPG
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển Python một phương pháp tích hợp đầy đủ để chuyển đổi định dạng OTS sang JPG, cho phép lưu dữ liệu OTS liền mạch vào định dạng JPG bằng thư viện Aspose.Cells, tất cả thông qua mã Python hiệu quả và có thể tùy chỉnh.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi OTS sang JPG trong Thư viện Excel Python" h2="Thư viện excel Python tốc độ cao để chuyển đổi OTS sang JPG. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất OTS, JPG và nhiều định dạng khác bằng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi OTS sang JPG bằng Thư viện Excel Python" %}}

 Làm cách nào để chuyển đổi OTS sang JPG? Với thư viện Aspose.Cells for Python, bạn có thể dễ dàng chuyển đổi OTS sang JPG theo chương trình chỉ với một vài dòng mã.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, hiển thị và in tất cả các tệp Excel. Python Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó biến nó thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Lưu OTS sang JPG trong Thư viện Excel Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi OTS sang JPG trong thư viện excel Python.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để chuyển đổi OTS sang JPG. Tải lên tệp OTS của bạn, sau đó chỉ cần lưu nó dưới dạng tệp JPG. Đối với cả đọc OTS và ghi JPG, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng JPG đầu ra sẽ giống hệt với tài liệu OTS gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mã mẫu chuyển đổi OTS sang JPG qua Python Thư viện Excel" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="jpg" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển OTS sang JPG qua Python" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin OTS sang JPG theo chương trình? Các nhà phát triển Python có thể dễ dàng tải và chuyển đổi OTS sang JPG chỉ bằng vài dòng mã.
...
1.  Chuyển đổi OTS sang JPG bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi OTS sang JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Thư viện Excel để chuyển đổi OTS sang JPG" %}}
