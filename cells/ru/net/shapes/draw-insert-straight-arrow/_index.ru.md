...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке прямой стрелки в файл Excel по номеру C#" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) вставить прямую стрелку на выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставка прямая стрелка - C#" offSpacer="" %}}
