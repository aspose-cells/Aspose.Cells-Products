---
title:  Вставить дугу в Excel via Java
weight: 10
...
{{% blocks/products/pf/agp/content h2="Как вставить дугу в файл Excel с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке файла Arc в Excel via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addArc-int-int-int-int-int-int-) чтобы вставить дугу в выбранный рабочий лист
...
{{% blocks/products/pf/agp/code-block title="Вставить дугу - Java" offSpacer="" %}}
