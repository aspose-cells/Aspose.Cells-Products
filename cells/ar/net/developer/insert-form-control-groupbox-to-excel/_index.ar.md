---
title: أدخل GroupBox في Excel via .NET
weight: 40
description: C# كود المصدر لإدراج GroupBox في Excel على .NET Framework أو .NET Core أو Mono أو الأنظمة الأساسية Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل GroupBox في Excel via .NET" h2="أدخل GroupBoxs باستخدام Aspose.Cells \'API دون أي برامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="كيفية إدراج GroupBox في ملف Excel باستخدام C#" %}}

 من أجل إدراج GroupBox في ملف excel ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج GroupBox في ملف Excel عبر C#" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addgroupbox) لإدراج GroupBox في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل GroupBox - C#" offSpacer="" %}}
