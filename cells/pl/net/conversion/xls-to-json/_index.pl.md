---
title: C# XLS do JSON - Konwerter online XLS do JSON
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Bezpłatnie online C# Konwertuj XLS na JSON saveformat. C# XLS do JSON w formacie. Zapisz XLS do JSON C#.
...
{{% blocks/products/pf/agp/content h2="Zaoszczędź XLS do JSON w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na JSON w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na JSON. Prześlij swój plik XLS, a następnie po prostu zapisz go jako plik JSON. Zarówno do odczytu XLS, jak i zapisu JSON można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie JSON będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLS na JSON online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na JSON przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na JSON? Programiści .NET mogą łatwo załadować i przekonwertować XLS na JSON w zaledwie kilku wierszach kodu.
