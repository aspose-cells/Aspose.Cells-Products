...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na JPEG pomocí Java" %}}

 K vykreslení CSV do JPEG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postup převodu CSV na JPEG prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na JPEG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí sešitu1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Voláním metody SheetRender.toImage uložíte výsledek ve formátu JPEG
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu CSV na JPEG Java" offSpacer="" %}}
