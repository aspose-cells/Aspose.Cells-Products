...
weight: 2150
description: Mã ví dụ C++ để chỉnh sửa hoặc xem siêu dữ liệu tệp XLS trên C++ Môi trường thời gian chạy cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất siêu dữ liệu XLS qua C++" h2="Xây dựng ứng dụng C++ của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ các tệp XLS bằng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách nhận siêu dữ liệu XLS bằng C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước trích xuất siêu dữ liệu của XLS qua C++" %}}
...
+ Load file XLS bằng WorkbookMetadata
