---
title: Sloučit JPG do EXCELu – Sloučit JPG do EXCELu v C++
url: /cs/cpp/merger/merge-jpg-to-excel/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit JPG do formátu uložení EXCEL. C++ Zkombinujte JPG s formátem EXCEL. Sloučit JPG do EXCELu v C++. Sloučit JPG.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG do EXCELu v C++" %}}

Následující příklad ukazuje, jak sloučit JPG do EXCELu v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do EXCELu. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru EXCEL. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do EXCELu.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení JPG do EXCELu v C++" InputFormat="jpg" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPG do EXCELu přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JPG do EXCELu? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení JPG do EXCELu" %}}
