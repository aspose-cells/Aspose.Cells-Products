...
url: /pl/python-net/merger/merge-image-to-tiff/ 
...
Poniższy przykład pokazuje, jak połączyć IMAGE z TIFF w Aspose.Cells for Python via .NET.
...
Chcesz programowo scalić IMAGE z TIFF? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
