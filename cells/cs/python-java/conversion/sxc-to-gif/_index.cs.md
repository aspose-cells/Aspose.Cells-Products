---
title: Převést SXC na GIF přes Python

description: Ukázkový kód pro převod sxc na gif Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na gif v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na GIF pomocí Python" %}}

 K převodu SXC na GIF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na GIF prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na GIF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí Workbook1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s příponou GIF jako parametr1. Zkontrolujte zadanou cestu pro výsledný soubor GIF
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na GIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="gif" IsLandingPage="true" language="python" %}}
