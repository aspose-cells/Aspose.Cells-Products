...
description: Sample code for xls to emf C# conversion. Use API example code for batch xls files to emf conversion within VB.NET, Asp.NET or any .NET based application.
---
