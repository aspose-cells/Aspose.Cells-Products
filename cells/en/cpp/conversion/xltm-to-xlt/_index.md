...
description: Sample C++ conversion code for XLTM document to XLT format. Programmers can use this source code for batch XLTM to XLT conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLTM to XLT C++ Conversion Source Code" offSpacer="" %}}
