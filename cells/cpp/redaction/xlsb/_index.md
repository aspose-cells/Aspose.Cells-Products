...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to Redact XLSB Files in C++" %}}
...
{{% blocks/products/pf/agp/code-block title="RedactВ XLSB Files - C++" offSpacer="" %}}
