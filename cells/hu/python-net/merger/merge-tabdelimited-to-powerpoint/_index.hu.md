...
url: /hu/python-net/merger/merge-tabdelimited-to-powerpoint/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a TABDELIMITED-et a POWERPOINT-szal a Aspose.Cells for Python via .NET számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a TABDELIMITED-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
