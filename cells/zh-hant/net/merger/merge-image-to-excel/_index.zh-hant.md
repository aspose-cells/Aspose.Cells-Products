...
下面的範例示範如何將Aspose.Cells for .NET中的IMAGE合併到EXCEL。
...
需要以程式設計方式將 IMAGE 合併到 EXCEL 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 將IMAGE合併到EXCEL的函式庫" %}}
