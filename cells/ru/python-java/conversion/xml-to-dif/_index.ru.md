...
{{% blocks/products/pf/agp/content h2="Преобразование XML в DIF с использованием библиотеки Excel Python" %}}
