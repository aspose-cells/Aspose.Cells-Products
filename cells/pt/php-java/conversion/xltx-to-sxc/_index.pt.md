---
title: Conversor PHP XLTX para SXC - XLTX para SXC
description: Aspose Excel. Converta XLTX em SXC de forma rápida e fácil com Aspose.Cells. PHP XLTX em SXC. PHP Salve XLTX em SXC. Salve XLTX como SXC usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em SXC via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em SXC programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em SXC em apenas algumas linhas de código.
...
1.  Converta XLTX em SXC chamando o método save da pasta de trabalho.
