...
description: Aspose Excel. C++ Aspose.Cells. Zdarma online sloučení XLTX do formátu uložení ETT. C++ Zkombinujte XLTX do formátu ETT. Sloučit XLTX do ETT v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX do ETT v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLTX do ETT v Aspose.Cells for C++.
...
{{% cells-merger title="Online zdarma ke sloučení XLTX do ETT v C++" InputFormat="xltx" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
