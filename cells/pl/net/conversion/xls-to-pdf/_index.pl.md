---
title: C# XLS do PDF - Konwerter online XLS do PDF
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Bezpłatnie online C# Konwertuj XLS na PDF saveformat. C# XLS do PDF w formacie. Zapisz XLS do PDF C#.
...
{{% blocks/products/pf/agp/content h2="Zaoszczędź XLS do PDF w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na PDF w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na PDF. Prześlij swój plik XLS, a następnie po prostu zapisz go jako plik PDF. Zarówno do odczytu XLS, jak i zapisu PDF można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie PDF będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLS na PDF online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na PDF przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na PDF? Programiści .NET mogą łatwo załadować i przekonwertować XLS na PDF w zaledwie kilku wierszach kodu.
...
1.  Konwertuj XLS na PDF, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLS na PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XLS na PDF" %}}
