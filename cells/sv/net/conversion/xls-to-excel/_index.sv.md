---
title: C# XLS till EXCEL - XLS till EXCEL-omvandlare
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till EXCEL-format, vilket möjliggör sömlös sparning av XLS-data till EXCEL-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till EXCEL i C#" %}}

Följande exempel visar hur man konverterar XLS till EXCEL i C#.
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till EXCEL programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till EXCEL på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C#-bibliotek för att konvertera XLS till EXCEL" %}}
