...
description: Aspose Exceller. Python Exceller. Fusionnez le format de sauvegarde JPEG vers SVG. Python Combinez les formats JPEG à SVG. Fusionnez JPEG à SVG dans la bibliothèque Excel Python. JPEG Fusionner.
...
{{% cells-merger title="Exemple de code pour fusionner JPEG à SVG dans la bibliothèque Excel Python" InputFormat="jpg" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner JPEG à SVG via la bibliothèque Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner JPEG à SVG par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner JPEG à SVG" %}}
