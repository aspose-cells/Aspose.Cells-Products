---
title: 搜尋XLSB文檔，無需開啟via Java
weight: 9420
description: Java 範例程式碼，用於在 JSP/JSF 應用程式和桌面應用程式的 Java 執行時間環境中搜尋 XLSB 檔案中具有模式的單字。
...
{{< blocks/products/pf/i18n/upper-banner h1="搜尋 XLSB Java 中的格式" h2="使用伺服器端 Aspose.Cells for Java API 進行本機高效能 XLSB 文件搜索，無需使用 Microsoft 或 Adobe PDF 等任何軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 搜尋 XLSB 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="搜尋 Java 中的 XLSB 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="搜尋 XLSB 文件 - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="線上 XLSB 搜尋現場演示" sectionDescription="立即造訪我們的 XLSB 文件中搜尋文字、單字、片語[現場示範網站](https://products.aspose.app/cells/search)。現場演示有以下好處" >}}
