---
title: EXCEL'i PRN'ye Birleştirme - EXCEL'i PRN'ye C++'de birleştirin
url: /tr/cpp/merger/merge-excel-to-prn/ 
description: Aspose excel. C++ Aspose.Cells. EXCEL'i PRN kaydetme biçimine Ücretsiz Çevrimiçi Birleştirme. C++ EXCEL'i PRN biçimiyle birleştirin. C++'de EXCEL'i PRN ile birleştirin. EXCEL Birleştirin.
...
{{% blocks/products/pf/agp/content h2="EXCEL ile PRN\'yi C++ Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, EXCEL'in Aspose.Cells for C++'de PRN ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i PRN ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından PRN dosyasına kaydedin. C++'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. EXCEL'i PRN ile birleştiren C++ örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C++\'de EXCEL\'i PRN ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="xlsx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C++ aracılığıyla PRN ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL'i programlı olarak PRN ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i PRN ile birleştirmek için C++ kitaplığı" %}}
