...
description: Aspose Excel. C++ Aspose.Cells. Merge HTM to NUMBERS saveformat. C++ Combine HTM to NUMBERS format. Merge HTM to NUMBERS in C++. HTM Merge.
keywords: [Aspose Excel., C++ Aspose.Cells., Merge HTM to NUMBERS in C++., C++ Merge HTM to numbers., C++ Combine HTM to NUMBERS., HTM Merge]
---
...
{{% blocks/products/pf/agp/content h2="Merge HTM to NUMBERS in C++" %}}
...
{{% cells-merger title="Sample Code to Merge HTM to NUMBERS in C++" InputFormat="htm" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
