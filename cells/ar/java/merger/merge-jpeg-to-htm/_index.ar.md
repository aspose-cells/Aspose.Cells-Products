---
title: دمج JPEG إلى HTM - اجمع JPEG إلى HTM في Java
url: /ar/java/merger/merge-jpeg-to-htm/ 
description: Aspose إكسل. Java Aspose.Cells. الدمج المجاني عبر الإنترنت JPEG إلى HTM saveformat. Java ادمج JPEG بتنسيق HTM. دمج JPEG إلى HTM في Java. JPEG دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج JPEG إلى HTM في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج JPEG إلى HTM في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج JPEG في HTM. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف HTM. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج JPEG إلى HTM.
...
{{% blocks/products/pf/agp/content h2="كيفية دمج JPEG مع HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج JPEG مع HTM برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Java مكتبة لدمج JPEG إلى HTM" %}}
