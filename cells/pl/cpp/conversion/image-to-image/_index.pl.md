...
Trzeba programowo przekonwertować pliki IMAGE do formatu IMAGE? Programiści C++ mogą łatwo przekonwertować pliki IMAGE do formatu IMAGE za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj OBRAZ na OBRAZ wywołując metodę Save().
