...
url: /de/cpp/merger/merge-tsv-to-et/ 
...
Das folgende Beispiel zeigt, wie TSV mit ET in Aspose.Cells for C++ zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von TSV mit ET in C++" InputFormat="tsv" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie TSV über C++ mit ET zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie TSV programmgesteuert mit ET zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="C++-Bibliothek zum Zusammenführen von TSV mit ET" %}}
