...
description: Aspose Excel. Python Excel. Voeg XLS samen met het opslagformaat XLSX. Python Combineer het formaat XLS met XLSX. Voeg XLS samen met XLSX in de Excel-bibliotheek Python. XLS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met XLSX met behulp van de Excel-bibliotheek Python" %}}
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met XLSX in de Excel-bibliotheek Python" %}}
...
{{% cells-merger title="Voorbeeldcode om XLS samen te voegen met XLSX in de Excel-bibliotheek Python" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLS samenvoegt met XLSX via de Excel-bibliotheek Python" %}}
