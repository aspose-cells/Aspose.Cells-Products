---
title: Konvertera NUMBERS till XLSM via Java 
url: /sv/java/conversion/numbers-to-xlsm/ 
description: Exempel Java-konverteringskod för NUMBERS-format till XLSM-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLSM inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar TAL till XLSM med Java" %}}

 För att rendera NUMBERS till XLSM kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera TAL till XLSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera NUMBERS-filen till XLSM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda NUMBERS-filen med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLSM-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLSM-filen
...
{{% blocks/products/pf/agp/code-block title="NUMBERS till XLSM Java omvandlingskällkod" offSpacer="" %}}

```cs
// ladda NUMBERS-filen i en instans av Workbook
Workbook book = new Workbook("template.numbers");
// spara NUMBERS som XLSM
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS till XLSM Live Demos" sectionDescription="[Konvertera NUMBERS till XLSM](https://products.aspose.app/cells/conversion/numbers-to-xlsm) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din NUMBERS-fil, den konverteras omedelbart till XLSM." >}}
