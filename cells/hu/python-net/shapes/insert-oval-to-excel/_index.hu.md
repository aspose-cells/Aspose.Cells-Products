---
title:  Illessze be az Oválist az Excelbe a Python számon keresztül
weight: 10
description: Python forráskód az Oval Excelbe való beillesztéséhez.
---
...
{{% blocks/products/pf/agp/content h2="Ovális beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az ovális fájl Excelbe való beszúrásának lépései a Python számon keresztül" %}}
...
+ Használja a shapecollection hozzáadási módszerét egy ovális beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Ovális betét - Python" offSpacer="" %}}
