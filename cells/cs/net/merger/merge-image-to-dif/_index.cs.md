---
title: Sloučit IMAGE s DIF – Sloučit IMAGE s DIF v C#
url: /cs/net/merger/merge-image-to-dif/ 
description: Aspose Excel. C# Aspose.Cells. Online zdarma Sloučit IMAGE do formátu uložení DIF. C# Zkombinujte IMAGE do formátu DIF. Sloučit IMAGE na DIF v C#. IMAGE Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit IMAGE na DIF v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit IMAGE s DIF v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení IMAGE do DIF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté jej uložte do souboru DIF. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí IMAGE do DIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení IMAGE na DIF v C#" InputFormat="png" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit IMAGE na DIF přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit IMAGE s DIF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení IMAGE do DIF" %}}
