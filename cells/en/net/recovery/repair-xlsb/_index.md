---
title: How to repair a corrupt xlsb file via .NET
...
{{% blocks/products/pf/agp/content h2="How to repair XLSB File Using .NET" %}}
...
{{% cells-annotation title="Free App to repair XLSB file using .NET" InputFormat="xlsb" IsLandingPage="true" language="net" %}}
...
+  Load XLSB file by creating an instance of Workbook, using the inheritance class above, refer to the following code 
+  Save the workbook, the corrupted xlsb file will be repaired.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="C# library to repair xlsb file" %}}
