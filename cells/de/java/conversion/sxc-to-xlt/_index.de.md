...
Das folgende Beispiel zeigt, wie man SXC in Java in XLT umwandelt.
...
{{% blocks/products/pf/agp/content h2="Wie wandelt man SXC in XLT und via Java um?" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie SXC-Dateien programmatisch in XLT konvertieren? Entwickler können Java-Dateien problemlos mit nur wenigen Codezeilen in XLT konvertieren.
...
{{% blocks/products/pf/agp/content h2="Bibliothek Java zur Konvertierung von SXC in XLT" %}}
{{% blocks/products/pf/agp/text %}}
