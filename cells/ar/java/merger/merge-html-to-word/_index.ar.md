---
title: ادمج HTML في كلمة via Java
...
يوضح المثال التالي كيفية دمج HTML في WORD في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج HTML إلى WORD عبر الإنترنت" InputFormat="html" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
