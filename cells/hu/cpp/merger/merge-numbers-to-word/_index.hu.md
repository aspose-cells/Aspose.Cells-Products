---
title: A NUMBERS egyesítése a WORD-hoz – a NUMBERS egyesítése a WORD-hoz a C++-ben
url: /hu/cpp/merger/merge-numbers-to-word/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítése NUMBERS WORD mentési formátumba. C++ SZÁMOK kombinálása WORD formátumba. A NUMBERS egyesítése a WORD-hoz a C++-ben. NUMBERS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a NUMBERS-t a WORD-dal a C++-es számban" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a NUMBERS-t a WORD-dal a Aspose.Cells for C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a NUMBERS és a WORD egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el WORD fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++-es példát, amely a NUMBERS-t a WORD-ba egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a NUMBERS és a WORD egyesítéséhez a C++ számon" InputFormat="numbers" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="NUMBERS egyesítése a WORD-ba a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell NUMBERS-t a WORD-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
