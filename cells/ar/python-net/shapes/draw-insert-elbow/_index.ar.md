...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شكل الكوع في ملف إكسل باستخدام Python via.نت" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج شكل المرفق في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) لإدراج شكل مرفق في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج شكل الكوع - Python via .نت" offSpacer="" %}}
