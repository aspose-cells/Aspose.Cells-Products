---
title: Java ODS ke JSON - Online ODS ke JSON Konverter
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Gratis Online Java Ubah ODS menjadi JSON saveformat. Java ODS ke format JSON. Simpan ODS ke JSON Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ODS menjadi JSON di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi ODS menjadi JSON. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, JSON, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke JSON di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi ODS menjadi JSON di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi ODS menjadi JSON. Unggah file ODS Anda, lalu simpan sebagai file JSON. Untuk membaca ODS dan menulis JSON Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format keluaran JSON akan identik dengan dokumen asli ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi ODS menjadi JSON Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah ODS menjadi JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file ODS menjadi JSON secara terprogram? Pengembang Java dapat dengan mudah mengonversi ODS menjadi JSON hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi ODS menjadi JSON" %}}
{{% blocks/products/pf/agp/text %}}
