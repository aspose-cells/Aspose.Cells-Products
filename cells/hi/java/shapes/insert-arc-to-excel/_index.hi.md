---
title:  एक्सेल via Java में आर्क डालें
weight: 10
...
{{< blocks/products/pf/i18n/upper-banner h1="एक्सेल via Java में आर्क डालें" h2="Microsoft या ओपन ऑफिस, एडोब PDF आदि जैसे किसी सॉफ्टवेयर के बिना Aspose.Cells\' API का उपयोग करके आर्क डालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके एक्सेल फ़ाइल में आर्क कैसे डालें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Excel फ़ाइल via Java में आर्क सम्मिलित करने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से वर्कशीट का चयन करें।
 + का प्रयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addArc-int-int-int-int-int-int-) चयनित वर्कशीट में आर्क सम्मिलित करने के लिए
...
{{% blocks/products/pf/agp/code-block title="आर्क डालें - Java" offSpacer="" %}}
