---
title: Gabungkan XLSM ke PRN - Gabungkan XLSM ke PRN di Java
url: /id/java/merger/merge-xlsm-to-prn/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLSM ke format simpan PRN. Java Gabungkan XLSM ke format PRN. Gabungkan XLSM ke PRN di Java. XLSM Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSM ke PRN di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLSM ke PRN di Java" InputFormat="xlsm" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSM menjadi PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSM ke PRN secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
