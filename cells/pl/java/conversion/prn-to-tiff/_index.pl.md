...
{{% blocks/products/pf/agp/content h2="Konwertuj PRN na TIFF używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN do TIFF w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować PRN na TIFF w Java.
...
Trzeba programowo przekonwertować pliki PRN na TIFF? Programiści Java mogą łatwo przekonwertować pliki PRN na TIFF za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji PRN na TIFF" %}}
{{% blocks/products/pf/agp/text %}}
