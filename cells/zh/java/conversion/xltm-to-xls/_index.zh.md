...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLTM 转换为 XLS。 Java XLTM 为 XLS。 Java 将 XLTM 保存为 XLS。 将 XLTM 另存为 07611134 81 使用 Java。
...
如何将 XLTM 转换为 XLS？使用 Aspose.Cells for Java 库，您可以通过几行代码以编程方式轻松将 XLTM 转换为 XLS。[Aspose.Cells for Java](https://products.aspose.com/cells/java)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Java Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。您可以直接从以下位置下载其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)并通过将以下配置添加到 pom.xml 将其安装在基于 Maven 的项目中。
...
以下示例演示如何将 Java 中的 XLTM 转换为 XLS。
...
{{% cells-convert title="将 XLTM 转换为 XLS 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何转换 XLTM 为 XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLTM 文件转换为 XLS 吗？ Java开发人员只需几行代码即可轻松将XLTM转换为XLS。
...
{{% blocks/products/pf/agp/content h2="Java库将XLTM转换为XLS" %}}
{{% blocks/products/pf/agp/text %}}
