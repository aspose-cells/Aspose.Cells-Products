...
url: /cs/cpp/merger/merge-json-to-image/ 
...
Následující příklad ukazuje, jak sloučit JSON do IMAGE v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit JSON s IMAGE programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení JSON do IMAGE" %}}
