...
{{% blocks/products/pf/agp/content h2="Převeďte XLSB na XLS pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XLSB na XLS v Python.
