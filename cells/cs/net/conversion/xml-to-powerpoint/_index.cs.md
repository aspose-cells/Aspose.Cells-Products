...
Potřebujete programově převést soubory XML do aplikace POWERPOINT? Vývojáři na webu .NET mohou snadno načíst a převést soubory XML do aplikace POWERPOINT pomocí několika řádků kódu.
...
1.  Převeďte XML do formátu POWERPOINT voláním metody Workbook.Save.
