---
title: Java IMAGE en OTS - Convertisseur IMAGE en OTS
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE dans OTS dans Java" %}}

L'exemple suivant montre comment convertir une IMAGE en OTS dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir une IMAGE en OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE en OTS par programmation ? Les développeurs Java peuvent facilement convertir des fichiers IMAGE en OTS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en OTS" %}}
{{% blocks/products/pf/agp/text %}}
