...
Besoin de convertir des fichiers EXCEL en IMAGE par programme ? .NET peuvent facilement charger et convertir EXCEL en IMAGE en quelques lignes de code.
...
1.  Convertissez un fichier EXCEL en image en appelant la méthode Workbook.Save.
