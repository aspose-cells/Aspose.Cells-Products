...
يوضح المثال التالي كيفية تحويل HTML إلى WORD في Python via NET.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل HTML إلى WORD" %}}
