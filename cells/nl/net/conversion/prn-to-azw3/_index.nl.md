---
title: C# PRN naar AZW3 - PRN naar AZW3-omzetter
...
{{% blocks/products/pf/agp/content h2="Sla PRN op in AZW3 in C#" %}}

Het volgende voorbeeld laat zien hoe PRN naar AZW3 wordt geconverteerd in C#.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer ik PRN naar AZW3 via C#?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u PRN-bestanden programmatisch converteren naar AZW3? Ontwikkelaars van .NET kunnen PRN-bestanden eenvoudig laden en converteren naar AZW3 met slechts een paar regels code.
...
1.  Converteer PRN naar AZW3 door de Workbook.Save-methode aan te roepen.
1.  Bekijk het conversieresultaat van PRN naar AZW3.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliotheek om PRN naar AZW3 te converteren" %}}
