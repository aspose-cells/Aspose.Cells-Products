---
title: قم بتحويل XLTX إلى CSV عبر تطبيق C++ 
url: /ar/cpp/conversion/xltx-to-csv/ 
description: نموذج C++ رمز التحويل لمستند XLTX إلى تنسيق CSV. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLTX إلى CSV دفعة داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTX إلى CSV عبر C++" h2="تحويل XLTX عالي الأداء إلى CSV باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTX إلى CSV باستخدام C++" %}}

 من أجل تحويل XLTX إلى CSV ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLTX إلى CSV عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ بسهولة تحويل ملف XLTX إلى CSV في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLTX باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (CSV).1. سيتم حفظ ملف CSV في المسار المحدد.1. افتح ملف CSV في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLTX إلى CSV C++ شفرة مصدر التحويل" offSpacer="" %}}
