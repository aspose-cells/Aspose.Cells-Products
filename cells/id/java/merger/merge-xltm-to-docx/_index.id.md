---
title: Gabungkan XLTM menjadi DOCX - Gabungkan XLTM menjadi DOCX menjadi Java
url: /id/java/merger/merge-xltm-to-docx/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLTM menjadi DOCX format simpan. Java Gabungkan format XLTM menjadi DOCX. Gabungkan XLTM menjadi DOCX di Java. XLTM Gabungkan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan XLTM menjadi DOCX via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan XLTM menjadi DOCX. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="XLTM" additionalConversionTag="DOCX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLTM menjadi DOCX di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLTM menjadi DOCX di Aspose.Cells for Java.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLTM menjadi DOCX di Java" InputFormat="xltm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLTM menjadi DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLTM ke DOCX secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan XLTM menjadi DOCX" %}}
