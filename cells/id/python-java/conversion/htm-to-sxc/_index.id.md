---
title: Python HTM ke SXC - Konverter HTM ke SXC
description: Aspose Unggul. Python Unggul. Konversi HTM ke SXC dengan cepat dan mudah dengan Aspose.Cells. Python HTM menjadi SXC. Python Simpan HTM ke SXC. Simpan HTM sebagai SXC menggunakan Python Perpustakaan Excel.
...
{{% blocks/products/pf/agp/content h2="Ubah HTM menjadi SXC Menggunakan Perpustakaan Excel Python" %}}

 Bagaimana cara mengubah HTM ke SXC? Dengan pustaka Aspose.Cells for Python, Anda dapat dengan mudah mengonversi HTM ke SXC secara terprogram dengan beberapa baris kode.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)mampu membangun aplikasi lintas platform dengan kemampuan untuk menghasilkan, memodifikasi, mengkonversi, merender dan mencetak semua file Excel. Python Excel API tidak hanya mengkonversi antar format spreadsheet, tetapi juga dapat merender file Excel sebagai gambar, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT dan banyak lagi, sehingga menjadikannya pilihan sempurna untuk bertukar dokumen dalam format standar industri.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Simpan HTM ke SXC di Perpustakaan Excel Python" %}}

Contoh berikut menunjukkan cara mengonversi HTM ke SXC di perpustakaan excel Python.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi HTM ke SXC. Unggah file HTM Anda, lalu simpan saja sebagai file SXC. Untuk pembacaan HTM dan penulisan SXC Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran SXC akan identik dengan dokumen HTM asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi HTM ke SXC melalui Perpustakaan Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="sxc" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert HTM ke SXC lewat Python" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file HTM ke SXC secara terprogram? Pengembang Python dapat dengan mudah memuat & mengonversi HTM ke SXC hanya dalam beberapa baris kode.
...
1.  Ubah HTM menjadi SXC dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi HTM ke SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Perpustakaan Excel untuk Mengonversi HTM menjadi SXC" %}}
