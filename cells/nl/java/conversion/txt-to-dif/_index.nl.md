...
{{% blocks/products/pf/agp/content h2="Sla TXT op in DIF in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar DIF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar DIF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar DIF? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar DIF met slechts een paar regels code.
