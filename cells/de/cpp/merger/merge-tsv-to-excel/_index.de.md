...
url: /de/cpp/merger/merge-tsv-to-excel/ 
...
Das folgende Beispiel zeigt, wie TSV mit Excel in Aspose.Cells for C++ zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von TSV mit Excel in C++" InputFormat="tsv" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie TSV über C++ mit Excel zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie TSV programmgesteuert mit Excel zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="C++-Bibliothek zum Zusammenführen von TSV mit Excel" %}}
