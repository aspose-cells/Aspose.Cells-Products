...
weight: 60
url: /python-java/developer/insert-form-control-radio-button-to-excel/ 
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) to insert a RadioButton(Form control) in the selected worksheet.
