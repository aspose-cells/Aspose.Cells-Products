---
title: Java XLTX hingga XLS - XLTX hingga XLS Konverter
description: Aspose Unggul. Ubah XLTX menjadi XLS dengan cepat dan mudah dengan Aspose.Cells. Java XLTX menjadi XLS. Java Simpan XLTX menjadi XLS. Simpan XLTX sebagai 07611134 81 menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLTX menjadi XLS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi XLTX menjadi XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLTX, XLS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX hingga XLS di Java" %}}

Contoh berikut menunjukkan cara mengonversi XLTX menjadi XLS di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLTX menjadi XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLTX ke XLS secara terprogram? Pengembang Java dapat dengan mudah mengonversi XLTX menjadi XLS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah XLTX menjadi XLS" %}}
{{% blocks/products/pf/agp/text %}}
