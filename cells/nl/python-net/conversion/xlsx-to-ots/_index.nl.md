...
description: Aspose Excel. Converteer XLSX snel en eenvoudig naar OTS met Aspose.Cells. Python XLSX naar OTS. Python Bewaar XLSX in OTS. Sla XLSX op als OTS met behulp van Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLSX naar OTS in Python" h2="Snelle Python-bibliotheek voor het converteren van XLSX naar OTS. Gebruik onze Excel-conversie API om hoogwaardige, platformonafhankelijke software te ontwikkelen in Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer XLSX naar OTS in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in OTS in Python" %}}

Het volgende voorbeeld laat zien hoe u XLSX naar OTS converteert in Python via NET.
...
{{% cells-convert title="Voorbeeldcode om XLSX naar OTS te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ots" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om XLSX naar OTS te converteren" %}}
