---
title: C# EXCEL을 MD로 변환 - EXCEL을 MD로 변환
description: Aspose Excel. 이 포괄적인 솔루션은 C# 개발자에게 Excel을 MD 형식으로 변환하는 완벽하게 통합된 접근 방식을 제공하여 Aspose.Cells 라이브러리를 사용하여 Excel 데이터를 MD 형식으로 원활하게 저장할 수 있도록 하며, 이 모든 작업은 효율적이고 사용자 정의 가능한 C# 코드를 통해 이루어집니다.
...
{{% blocks/products/pf/agp/content h2="C#의 MD에 EXCEL을 저장하세요" %}}

다음 예시는 C# 형식으로 EXCEL 파일을 MD 파일로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="엑셀 파일을 MD 파일로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 엑셀 파일을 MD 파일로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

엑셀 파일을 MD 형식으로 프로그램적으로 변환해야 하시나요? .NET 개발자는 단 몇 줄의 코드로 엑셀 파일을 MD 형식으로 쉽게 불러오고 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2="C# 엑셀 파일을 MD 파일로 변환하는 라이브러리" %}}
