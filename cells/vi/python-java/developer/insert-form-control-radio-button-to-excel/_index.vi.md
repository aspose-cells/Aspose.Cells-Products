---
title:  Chèn RadioButton (Điều khiển biểu mẫu) vào Excel bằng Python via java
weight: 60
description: Python via mã nguồn java để chèn RadioButton (Điều khiển biểu mẫu) vào Excel.
---
...
{{% blocks/products/pf/agp/content h2="Cách Chèn RadioButton (Điều khiển biểu mẫu) vào Tệp Excel bằng Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn RadioButton(Form control) vào file Excel sử dụng Python via java" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) để chèn một RadioButton(Điều khiển biểu mẫu) trong trang tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn RadioButton(Điều khiển biểu mẫu) - Python via java" offSpacer="" %}}
