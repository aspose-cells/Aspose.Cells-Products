---
title: 創建JSON - 在Java中創建JSON文件
description: Aspose Excel。 Java 創建 JSON 文件。創建JSON Java。Java JSON創建者。在Java中創建JSON。使用Java生成JSON文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建JSON" %}}
...
1. 使用 save() 方法將工作簿保存為 JSON 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 JSON 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建JSON文件" %}}
{{% blocks/products/pf/agp/text %}}
