---
title:  SPREADSHEETML'yi PDF via Java ile birleştirin
...
Aşağıdaki örnek, SPREADSHEETML'nin Java'de PDF ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="SPREADSHEETML\'yi hatta PDF ile birleştirmek için Ücretsiz Uygulama" InputFormat="xml" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
