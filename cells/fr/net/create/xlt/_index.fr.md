---
title: Créer XLT - Créer un fichier XLT dans C#
description: Aspose Excel. Générez et manipulez facilement des fichiers XLT grâce à la bibliothèque Aspose.Cells for .NET. Cette puissante bibliothèque API offre une solution simplifiée et efficace pour créer, modifier et gérer des fichiers XLT directement dans vos applications C#, répondant ainsi avec une grande précision aux besoins spécifiques des développeurs.
...
{{% blocks/products/pf/agp/content h2="Comment créer XLT dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="L\'exemple de code montre comment créer le fichier XLT dans C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour créer le fichier XLT" %}}
