...
weight: 7690
description: C# Ukázkový kód pro konverzi XLSX na Byte Array. Tento kód použijte pro převod Excel XLSX na Byte Array v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte XLSX na bajtové pole přes C#" h2="Nativní a vysoce výkonné Microsoft Excel XLSX na konverzi bajtového pole nebo naopak pro zpracování dat tabulkových procesorů pomocí .NET API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array je užitečné pro zpracování nebo ukládání dat. Můžete převést soubor XLSX na Byte Array, stejně jako a**Byte Array na XLSX**dokument pomocí jazyka C#. Abychom převedli XLSX na bajtové pole, použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Pro vývojáře je snadné načíst a převést soubory XLSX na bajtové pole pro další manipulační úkoly v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1.  Zahrňte jmenný prostor do souboru třídy
1.  Načíst vstup XLSX Soubor pomocí sešitu
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod XLSX na bajtové pole C#" offSpacer="" %}}
