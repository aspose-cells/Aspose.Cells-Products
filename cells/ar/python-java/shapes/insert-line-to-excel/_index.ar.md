---
title:  أدخل السطر في Excel باستخدام Python via Java
weight: 10
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج سطر في ملف إكسل باستخدام Python via Java" %}}

 لإدراج Line في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج ملف Line to Excel باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) لإدراج سطر في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل السطر - Python via Java" offSpacer="" %}}
