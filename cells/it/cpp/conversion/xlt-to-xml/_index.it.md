---
title: Converti XLT in XML tramite l'applicazione C++ 
url: /it/cpp/conversion/xlt-to-xml/ 
description: Esempio di codice di conversione C++ per un documento XLT in formato XML. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLT a XML all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire XLT in XML utilizzando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire XLT in XML tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente file XLT in XML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLT usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XML).1. Il file XML verrà salvato nel percorso specificato.1. Apri il file XML in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLT a XML C++" offSpacer="" %}}
