...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar SVG met Aspose.Cells. PHP OTS naar SVG. PHP Bewaar OTS naar SVG. Sla OTS op als SVG met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar SVG te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar SVG converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar SVG in slechts een paar regels code.
...
1.  Converteer OTS naar SVG door de opslagmethode van Workbook aan te roepen.
