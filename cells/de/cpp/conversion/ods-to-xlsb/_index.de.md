---
title: Konvertieren Sie ODS in XLSB über die Anwendung C++ 
weight: 4080
url: /de/cpp/conversion/ods-to-xlsb/ 
description: Beispiel-Umwandlungscode C++ für das ODS-Dokument in das XLSB-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von ODS in XLSB in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie ODS in XLSB über C++" h2="Leistungsstarke ODS-zu-XLSB-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können ODS-Dateien in nur wenigen Codezeilen problemlos in XLSB konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die ODS-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (XLSB).1. Die XLSB-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die XLSB-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="Konvertierungsquellcode von ODS in XLSB C++" offSpacer="" %}}
