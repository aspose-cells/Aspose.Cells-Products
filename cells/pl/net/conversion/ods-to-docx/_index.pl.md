---
title: Konwertuj ODS na DOCX przez C#
url: /pl/net/conversion/ods-to-docx/
description: Przykładowy kod konwersji ods do docx C#. Użyj przykładowego kodu API dla wsadowych plików ods do konwersji docx w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować ODS na DOCX za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować ODS na DOCX za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki ODS do formatu DOCX w zaledwie kilku linijkach kodu.
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji ODS na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="docx" IsLandingPage="true" %}}
