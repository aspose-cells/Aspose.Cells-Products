---
title: دمج EXCEL إلى NUMBERS - ادمج EXCEL مع NUMBERS في C#
url: /ar/net/merger/merge-excel-to-numbers/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني عبر الإنترنت EXCEL إلى NUMBERS saveformat. C# قم بدمج EXCEL بتنسيق NUMBERS. دمج EXCEL إلى NUMBERS في C#. EXCEL Merge.
...
{{% blocks/products/pf/agp/content h2="دمج EXCEL إلى NUMBERS في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج EXCEL مع NUMBERS في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج EXCEL في NUMBERS. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف NUMBERS. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج EXCEL مع NUMBERS.
...
{{% blocks/products/pf/agp/content h2="كيفية دمج EXCEL مع أرقام عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج EXCEL في NUMBERS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج EXCEL إلى NUMBERS" %}}
