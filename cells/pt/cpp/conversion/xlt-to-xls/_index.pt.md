...
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLT para o formato XLS, permitindo o salvamento perfeito de dados XLT no formato XLS usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLT a XLS em C++" %}}

exemplo a seguir demonstra como converter XLT em XLS em C++.
...
{{% cells-convert title="Código de exemplo para converter XLT em XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlt" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLT em XLS por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLT para XLS programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLT para XLS com apenas algumas linhas de código.
...
1.  Converta XLT para XLS chamando o método Save().
