...
weight: 4190
description: C#-broncode om watermerk toe te voegen of te verwijderen aan het ODS-bestand op .NET Framework, .NET Core, Mono of Xamarin-platforms.
...
{{% blocks/products/pf/agp/content h2="Hoe u het ODS-bestand van een watermerk kunt voorzien met behulp van C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Voeg watermerk toe aan ODS - C#" offSpacer="" %}}
