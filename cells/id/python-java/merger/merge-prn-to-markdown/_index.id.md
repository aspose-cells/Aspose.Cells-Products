...
url: /id/python-java/merger/merge-prn-to-markdown/ 
...
Contoh berikut menunjukkan cara menggabungkan PRN ke MARKDOWN di Aspose.Cells for Python via Java.
...
Perlu menggabungkan PRN ke MARKDOWN secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API dapat dilakukan hanya dengan beberapa baris kode.
