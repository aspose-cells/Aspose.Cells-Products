...
url: /cs/python-net/merger/merge-tsv-to-et/ 
...
Následující příklad ukazuje, jak sloučit TSV do ET v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit TSV do ET programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
