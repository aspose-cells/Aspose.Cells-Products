...
هل تحتاج إلى تحويل ملفات HTM إلى XLS برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى XLS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى XLS باستدعاء طريقة Save ().
