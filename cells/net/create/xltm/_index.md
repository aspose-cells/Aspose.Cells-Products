...
url: /net/create-xltm/ 
description: C# Sample code for generating XLTM documents. Use this code for creating MS Excel XLTM files within VB.NET, Asp.NET or any .NET based application.
---
