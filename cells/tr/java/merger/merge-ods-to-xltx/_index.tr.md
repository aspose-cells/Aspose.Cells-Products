---
title: ODS'i XLTX'e birleştir - ODS'i Java'de XLTX'e birleştir
url: /tr/java/merger/merge-ods-to-xltx/ 
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme ODS ile XLTX kaydetme biçimi. Java ODS ile XLTX formatını birleştirin. Java içinde ODS'i XLTX ile birleştir. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS ile XLTX\'i Java Çevrimiçinde Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de XLTX ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS ile XLTX'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLTX dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. ODS'i XLTX ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'de XLTX ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS ile XLTX via Java Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 ODS ile XLTX'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i XLTX ile birleştirmek için Java kitaplığı" %}}
