---
title:  Pesquise o documento TXT sem abrir via .NET
weight: 8410
description: Código-fonte C# para pesquisar palavras com padrão no arquivo TXT em .NET Framework, .NET Core, Mono ou plataformas Xamarin.
