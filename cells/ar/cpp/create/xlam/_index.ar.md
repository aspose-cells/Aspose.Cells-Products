...
description: Aspose اكسل. C++ أنشئ ملف XLAM بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف XLAM باستخدام C++. أنشئ XLAM في C++. C++ XLAM Creator.
...
1.  احفظ المصنف كملف .xlam باستخدام أسلوب Save().
