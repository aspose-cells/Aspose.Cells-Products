---
title: C# CSV a JSON - Online CSV a JSON Convertitore
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Free Online C# Converti CSV in JSON saveformat. C# CSV al formato JSON. Salva CSV al JSON C#.
...
{{% blocks/products/pf/agp/content h2="Salva da CSV a JSON in C# online gratuitamente" %}}

L'esempio seguente mostra come convertire CSV in JSON in C#.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire CSV in JSON. Carica il tuo file CSV, quindi salvalo semplicemente come file JSON. Sia per la lettura CSV che per la scrittura JSON è possibile utilizzare nomi di file completi. Il contenuto e la formattazione dell'output JSON saranno identici al documento CSV originale.
...
{{% blocks/products/pf/agp/content h2="Come convertire CSV in JSON tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Devi convertire i file CSV in JSON a livello di codice? Gli sviluppatori di .NET possono facilmente caricare e convertire CSV in JSON in poche righe di codice.
...
1.  Converti CSV in JSON chiamando il metodo Workbook.Save.
1.  Ottieni il risultato della conversione da CSV a JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# libreria per convertire CSV in JSON" %}}
