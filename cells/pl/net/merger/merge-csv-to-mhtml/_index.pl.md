---
title:  Połącz CSV z MHTML przez C#
url: /pl/net/merger/merge-csv-to-mhtml/ 
description: Połącz CSV z MHTML Online za darmo. Bezpłatnie online CSV do MHTML Fuzja. Połącz CSV z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć CSV z MHTML w C#.
...
{{% cells-merger title="Darmowa aplikacja do łączenia CSV z MHTML on-line" InputFormat="csv" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
