...
{{% blocks/products/pf/agp/content h2="Cách chèn TextBox vào file Excel bằng Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn TextBox vào file Excel dùng Python via .Net" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng phần bổ sung của bộ sưu tập hình dạng[phương pháp](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_text_box/#int-int-int-int-int-int) để chèn TextBox vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn TextBox - Python via .Net" offSpacer="" %}}
