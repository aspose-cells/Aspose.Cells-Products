---
title: Gabung ODS ke XPS - Gabungkan ODS ke XPS di Python
url: /id/python-java/merger/merge-ods-to-xps/ 
description: Aspose Unggul. Python Aspose.Cells. Free Online Merge ODS to XPS saveformat. Python Gabungkan format ODS menjadi XPS. Gabung ODS ke XPS di Python. ODS Gabung.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan ODS ke XPS di Python" InputFormat="ods" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan ODS ke XPS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan ODS menjadi XPS secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk menggabungkan ODS ke XPS" %}}
