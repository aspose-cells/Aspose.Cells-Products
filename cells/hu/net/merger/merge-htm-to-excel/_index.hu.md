...
url: /hu/net/merger/merge-htm-to-excel/ 
...
A következő példa bemutatja, hogyan egyesítheti a HTM-et az EXCEL-lel a Aspose.Cells for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a HTM-et az EXCEL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és az EXCEL egyesítéséhez" %}}
