---
title: Αναζήτηση και αντικατάσταση κειμένου στο έγγραφο XLSX μέσω του C++
weight: 9570
description: C++ παράδειγμα κώδικα για τη διόρθωση ευαίσθητων πληροφοριών στο αρχείο XLSX στο C++ Runtime Environment για Windows 32 bit, Windows 64 bit και Linux 64 bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Redact XLSX Μορφές στο C++" h2="Το εγγενές και υψηλής απόδοσης XLSX τεκμηριώνει ευαίσθητες πληροφορίες επεξεργασίας χρησιμοποιώντας API Aspose.Cells for C++ από την πλευρά του διακομιστή, χωρίς τη χρήση λογισμικού όπως το Microsoft ή το Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
