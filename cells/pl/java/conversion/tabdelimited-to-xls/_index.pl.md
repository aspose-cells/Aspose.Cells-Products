---
title: Konwertuj TABDELIMITED na XLS przez Java 
url: /pl/java/conversion/tabdelimited-to-xls/ 
description: Przykładowy kod konwersji Java dla formatu TABDELIMITED do pliku XLS. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do XLS w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TABDELIMITED na XLS przez Java" h2="Konwersja TABDELIMITED do XLS Java w celu konwersji jednej lub wielu stron do formatu XLS przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TABDELIMITED na XLS za pomocą Java" %}}

 Aby wyrenderować TABDELIMITED do XLS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TABDELIMITED na XLS przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik TABDELIMITED na XLS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TABDELIMITED z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLS i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLS
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED do XLS Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik TABDELIMITED w instancji Workbook
Workbook book = new Workbook("template.tabdelimited");
// zapisz TABDELIMITED jako XLS
