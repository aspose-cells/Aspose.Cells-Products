...
{{% blocks/products/pf/agp/content h2="Så här säkrar du ODS-fil med Java" %}}
...
1. Ladda ODS-fil genom att instansiera Workbook-klassen1. Använd protect(..)-metoden med ProtectionType och Password1. Spara den skyddade ODS-filen med save()-metoden
