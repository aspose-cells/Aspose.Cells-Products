---
title: Sloučit PRN do SPREADSHEETML – Sloučit PRN do SPREADSHEETML v C#
url: /cs/net/merger/merge-prn-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit PRN do formátu uložení SPREADSHEETML. C# Zkombinujte PRN s formátem SPREADSHEETML. Sloučit PRN do SPREADSHEETML v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN do SPREADSHEETML v C#" %}}

Následující příklad ukazuje, jak sloučit PRN do SPREADSHEETML v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do SPREADSHEETML. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru SPREADSHEETML. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí PRN do SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení PRN do SPREADSHEETML v C#" InputFormat="prn" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN do SPREADSHEETML přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit PRN do SPREADSHEETML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu pro sloučení PRN do SPREADSHEETML" %}}
