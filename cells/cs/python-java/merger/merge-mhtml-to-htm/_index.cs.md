...
url: /cs/python-java/merger/merge-mhtml-to-htm/ 
...
Následující příklad ukazuje, jak sloučit MHTML do HTM v Aspose.Cells for Python via Java.
...
Potřebujete sloučit MHTML do HTM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
