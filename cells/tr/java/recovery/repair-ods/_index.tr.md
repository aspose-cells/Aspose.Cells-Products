...
{{% blocks/products/pf/agp/content h2="Java kullanarak ods dosyası nasıl onarılır" %}}
...
{{% cells-recovery title="ODS dosyasını Java kullanarak onarmak için Ücretsiz Uygulama" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="java" %}}    
