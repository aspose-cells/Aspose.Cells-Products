...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 开发人员只需几行代码即可轻松地将 ODS 文件转换为 XLTX。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 ODS 文件。1. 调用 Save() 方法。1. 传递带有 (XLTX) 文件扩展名的输出文件路径。1. XLTX 文件将保存在指定路径。1. 在兼容程序中打开 XLTX 文件。
...
{{% blocks/products/pf/agp/code-block title="ODS 到 XLTX C++ 转换源代码" offSpacer="" %}}
