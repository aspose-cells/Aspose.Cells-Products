---
title: Diviser les fichiers ODS via .NET 
weight: 140
url: /fr/net/splitter/ods/ 
description: Code source C# pour diviser les documents ODS sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Diviser les formats ODS en C#" h2="Séparateur ODS natif et hautes performances utilisant des API côté serveur, sans l\'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fractionner les fichiers ODS dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fichier ODS fractionné - C#" offSpacer="" %}}
