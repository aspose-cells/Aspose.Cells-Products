---
title:  MHT Dosya Formatlarını Görüntüleyin via .NET
description: .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında MHT belgelerini yüklemek, işlemek ve görüntülemek için C# kaynak kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="MHT\'yi C# aracılığıyla Görüntüleme Adımları" %}}
...
1. MHT dosyasını bir Çalışma Kitabı örneğine yükleyin
1. Bir HtmlSaveOptions örneği oluşturun ve ExportHeadings özelliğini true olarak ayarlayın
1. MHT dosyasını Workbook.Save yöntemini kullanarak HTML formatında kaydedin.
...
{{% blocks/products/pf/agp/code-block title="C# MHT dosyasını görüntülemek için örnek kod" offSpacer="" %}}
...
Aspose.Cells API, Microsoft Excel formatlarını oluşturmak, düzenlemek, dönüştürmek ve farklı formatlara dönüştürmek için kullanılabilir. Ayrıca yazılım uygulamalarında kapsamlı grafik oluşturma, ölçeklenebilir raporlama ve güvenilir hesaplamalar için de kullanılabilir. Aspose.Cells bağımsız bir API'dir ve Microsoft veya OpenOffice gibi herhangi bir yazılım gerektirmez.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="MHT\'yi Görüntülemek İçin Ücretsiz Uygulama" sectionDescription=" Canlı demolarımızı kontrol edin[MHT\'yi görüntüle](https://products.aspose.app/cells/viewer/mht) aşağıdaki avantajlarla." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Gerekirse MHT dosyasını bağlantıdan indirin" >}}
