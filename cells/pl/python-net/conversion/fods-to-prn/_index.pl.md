...
description: Aspose Excel. Szybko i łatwo przekonwertuj numer FODS na PRN za pomocą Aspose.Cells. Python FODS na PRN. Python Zapisz FODS w PRN. Zapisz FODS jako PRN, używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj FODS na PRN w Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz FODS w PRN w Python" %}}

Poniższy przykład pokazuje, jak przekonwertować FODS na PRN w Python via NET.
...
{{% cells-convert title="Przykładowy kod do konwersji FODS na PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="prn" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji FODS na PRN" %}}
