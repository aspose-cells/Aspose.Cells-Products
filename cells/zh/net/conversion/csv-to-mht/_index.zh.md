---
title: C# CSV 转 MHT - CSV 转 MHT 转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 CSV 转换为 MHT 格式，从而能够使用 Aspose.Cells 库将 CSV 数据无缝保存为 MHT 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 CSV 保存到 MHT，即 C#" %}}

以下示例演示如何将 CSV 转换为 C# 中的 MHT。
{{% blocks/products/pf/agp/text %}}

按照以下简单步骤将 CSV 文件转换为 MHT 文件。上传您的 CSV 文件，然后将其另存为 MHT 文件。读取 CSV 文件和写入 MHT 文件时，均可使用完整路径的文件名。输出的 MHT 文件内容和格式将与原始 CSV 文档完全相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 CSV 转换为 MHT 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="csv" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 CSV 转换为 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 CSV 文件转换为 MHT 格式吗？.NET 开发人员只需几行代码即可轻松加载 CSV 文件并将其转换为 MHT 格式。
...
1. 向您的 C# 项目添加库引用（导入库）。
1. 使用工作簿实例加载 CSV 文件。
1. 调用 Workbook.Save 方法将 CSV 转换为 MHT。
1. 获取 CSV 到 MHT 的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 库用于将 CSV 转换为 MHT" %}}
