...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ разработчики могут легко преобразовать XML в TABDELIMITED, написав всего несколько строк кода.
