...
description: Aspose Excel. C# Aspose.Cells. Συγχώνευση XLSX σε μορφή αποθήκευσης PPTX. C# Συνδυάστε τη μορφή XLSX με PPTX. Συγχώνευση XLSX σε PPTX στο C#. XLSX Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLSX με PPTX στο C#" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLSX έως PPTX στο C#" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
