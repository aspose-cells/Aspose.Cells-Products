...
{{< blocks/products/pf/i18n/upper-banner h1="Visualizador de arquivos XLSM for .NET" h2="Visualize planilhas do Excel e do OpenOffice, como XLSM, sem precisar do Microsoft Excel ou do Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para visualizar o XLSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells facilita para os desenvolvedores a visualização do arquivo XLSM com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo XLSM em uma instância da pasta de trabalho1. Crie uma instância de HtmlSaveOptions e defina a propriedade ExportHeadings como true1. Salve o arquivo XLSM no formato HTML usando o método Workbook.Save1. Carregar HTML resultante no navegador padrão com Process.Start
...
// salve o arquivo XLSM no formato HTML
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos do Microsoft Excel para diferentes formatos. Além disso, ele pode ser usado para gráficos abrangentes, relatórios escaláveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API autônomo e não requer nenhum software como Microsoft ou OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para visualizar XLSM" sectionDescription="Confira nossas demonstrações ao vivo para [Ver XLSM](https://products.aspose.app/cells/viewer/xlsm) com os seguintes benefícios." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do arquivo XLSM e clicar no botão \"Visualizar\"" >}}
