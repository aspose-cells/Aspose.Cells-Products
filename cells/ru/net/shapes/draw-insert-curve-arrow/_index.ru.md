...
weight: 101
description: C# исходный код для рисования или вставки изогнутой формы стрелки в Excel на платформах .NET Framework, .NET Core, Mono или Xamarin.
---
...
{{% blocks/products/pf/agp/content h2="Как вставить изогнутую стрелку в файл Excel, используя C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке формы изогнутой стрелки в файл Excel через C#" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) чтобы вставить изогнутую стрелку в выбранный рабочий лист
...
{{% blocks/products/pf/agp/code-block title="Вставка изогнутой стреловидной формы - C#" offSpacer="" %}}
