...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga ScrollBar till Excel-fil via C#" %}}
...
+ Välj kalkylblad via dess index.
 + Använd[lägga till metod](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addscrollbar)för att infoga en rullningslist i det valda kalkylbladet
...
{{% blocks/products/pf/agp/code-block title="Infoga ScrollBar - C#" offSpacer="" %}}
