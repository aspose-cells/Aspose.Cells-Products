...
weight: 3430
description: Code source C# pour modifier ou afficher les métadonnées au format XLSX sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Extraire XLSX Métadonnées via .NET" h2="Créez vos propres applications .NET pour ajouter, modifier, supprimer ou extraire des métadonnées des fichiers XLSX à l\'aide d\'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
+ Chargez XLSX avec une instance de Workbook
