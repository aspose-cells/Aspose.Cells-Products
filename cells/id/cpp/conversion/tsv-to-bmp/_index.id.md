...
{{% cells-convert title="Contoh Kode untuk Mengonversi TSV menjadi BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="bmp" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah TSV menjadi BMP melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file TSV ke BMP secara terprogram? Pengembang C++ dapat dengan mudah mengonversi TSV menjadi BMP hanya dalam beberapa baris kode.
...
1.  Ubah TSV menjadi BMP dengan memanggil metode Save().
