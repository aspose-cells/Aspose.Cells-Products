...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in XLT in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar XLT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar XLT of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar XLT? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar XLT met slechts een paar regels code.
