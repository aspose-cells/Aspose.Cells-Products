---
title: Fusionar XLSM con OTS - Combinar XLSM con OTS en Java
url: /es/java/merger/merge-xlsm-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Fusionar XLSM con el formato guardado de OTS. Java Combina XLSM al formato OTS. Fusionar XLSM con OTS en Java. XLSM Fusionar.
...
{{% blocks/products/pf/agp/content h2="Fusionar XLSM con OTS en Java" %}}

El siguiente ejemplo demuestra cómo fusionar XLSM con OTS en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLSM con OTS. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo OTS. Si desarrolla código en Java, esto será más simple de lo que parece. Vea el ejemplo de Java que fusiona XLSM con OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar XLSM con OTS en Java" InputFormat="xlsm" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM con OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLSM con OTS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Java para fusionar XLSM con OTS" %}}
