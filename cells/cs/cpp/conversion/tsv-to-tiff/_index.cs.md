...
Potřebujete převést soubory TSV na TIFF programově? Vývojáři C++ mohou snadno převést TSV na TIFF v několika řádcích kódu.
...
1.  Převeďte TSV na TIFF voláním metody Save().
