...
description: Aspose Excel. Convierta JPG a XLSB rápida y fácilmente con Aspose.Cells. C++ JPG a XLSB. C++ Guarde JPG en XLSB. Guarde JPG como XLSB usando C++.
...
{{% blocks/products/pf/agp/content h2="Guarde JPG en XLSB en C++" %}}
...
{{% cells-convert title="Código de muestra para convertir JPG a XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xlsb" IsLandingPage="true" language="cpp" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para convertir JPG a XLSB" %}}
