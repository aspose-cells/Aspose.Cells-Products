...
description: Aspose اكسل. C# Aspose.Cells. قم بدمج TABDELIMITED في MHTML saveformat. C# قم بدمج TABDELIMITED إلى تنسيق MHTML. دمج TABDELIMITED إلى MHTML في C#. TABDELIMITED دمج.
...
{{< blocks/products/pf/i18n/upper-banner h1="دمج TABDELIMITED إلى MHTML عبر C#" h2="مكتبة C# عالية السرعة لدمج TABDELIMITED إلى MHTML. استخدم تحويل Excel API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في C#. هذا حل برمجي احترافي لاستيراد وتصدير Excel, CSV, OpenOffice, PDF, HTML, image والعديد من تنسيقات Excel الأخرى." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="TABDELIMITED" additionalConversionTag="MHTML" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="دمج TABDELIMITED إلى MHTML في C#" %}}

يوضح المثال التالي كيفية دمج TABDELIMITED إلى MHTML في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج TABDELIMITED إلى MHTML. قم بتحميل ملفاتك، واتصل بطريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف MHTML. إذا قمت بتطوير التعليمات البرمجية في C#، فسيكون هذا أبسط مما يبدو. راجع مثال C# الذي يدمج TABDELIMITED إلى MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج التعليمات البرمجية لدمج TABDELIMITED إلى MHTML في C#" InputFormat="tsv" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج TABDELIMITED إلى MHTML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج TABDELIMITED مع MHTML برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة .NET لدمج TABDELIMITED إلى MHTML" %}}
