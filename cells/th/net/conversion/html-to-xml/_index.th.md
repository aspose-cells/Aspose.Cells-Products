---
title: C# HTML เป็น XML - HTML เป็น XML Converter
description: Aspose เอ็กเซล. แปลง HTML เป็น XML อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C# HTML เป็น XML C# บันทึก HTML ลงใน XML บันทึก HTML เป็น XML โดยใช้ C#
...
{{% blocks/products/pf/agp/content h2="บันทึก HTML ลงใน XML ใน C#" %}}
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง HTML เป็น XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xml" IsLandingPage="true" %}}
