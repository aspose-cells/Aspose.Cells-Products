---
title: Sloučit EXCEL s OTS – Kombinujte EXCEL s OTS v C#
url: /cs/net/merger/merge-excel-to-ots/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit EXCEL do OTS saveformat. C# Kombinujte EXCEL s formátem OTS. Sloučit EXCEL s OTS v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL s OTS v C#" %}}

Následující příklad ukazuje, jak sloučit EXCEL s OTS v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení EXCELu s OTS. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru OTS. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který spojuje EXCEL s OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení EXCEL do OTS v C#" InputFormat="xlsx" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL do OTS přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit EXCEL s OTS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu pro sloučení EXCELu s OTS" %}}
