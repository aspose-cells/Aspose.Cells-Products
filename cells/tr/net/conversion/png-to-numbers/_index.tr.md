---
title: C# PNG - PNG - NUMARALAR Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilerine PNG'i NUMBERS formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak PNG verilerinin NUMBERS formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C#\'deki NUMARALARA kaydedin" %}}

Aşağıdaki örnek, PNG sayısını C# şeklinde sayılara nasıl dönüştüreceğinizi göstermektedir.
{{% blocks/products/pf/agp/text %}}

PNG dosyasını NUMBERS formatına dönüştürmek için aşağıdaki kolay adımları izleyin. PNG dosyanızı yükleyin ve ardından NUMBERS dosyası olarak kaydedin. Hem PNG okuma hem de NUMBERS yazma işlemleri için tam nitelikli dosya adları kullanabilirsiniz. Çıktı NUMBERS içeriği ve biçimlendirmesi, orijinal PNG belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="PNG\'i Sayılara Dönüştürmek İçin Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="numbers" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG numarasını C# üzerinden sayılara nasıl dönüştürebilirsiniz?" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını programatik olarak NUMBERS'a dönüştürmeniz mi gerekiyor? .NET geliştiricileri, PNG dosyalarını birkaç satır kodla kolayca yükleyip NUMBERS'a dönüştürebilirler.
...
1.  Workbook.Save yöntemini çağırarak PNG sayısını NUMARA'ya dönüştürün.
1.  PNG sayısının rakamlara dönüştürme sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# kütüphanesi, PNG\'i sayılara dönüştürüyor." %}}
