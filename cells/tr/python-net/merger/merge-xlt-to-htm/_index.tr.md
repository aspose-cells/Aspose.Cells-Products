...
url: /tr/python-net/merger/merge-xlt-to-htm/ 
...
Aşağıdaki örnek, XLT'in Aspose.Cells for Python via .NET'deki HTM ile nasıl birleştirileceğini gösterir.
...
XLT'i HTM ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
