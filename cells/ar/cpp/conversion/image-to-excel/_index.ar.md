...
هل تحتاج إلى تحويل ملفات الصور إلى ملفات إكسل برمجيًا؟ يمكن للمطورين (C++) تحويل الصور إلى ملفات إكسل بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل الصورة إلى ملف إكسل عن طريق استدعاء دالة Save().
