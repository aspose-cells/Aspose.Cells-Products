...
description: Sample code for xlsx to fods C# conversion. Use API example code for batch xlsx files to fods conversion within VB.NET, Asp.NET or any .NET based application.
---
