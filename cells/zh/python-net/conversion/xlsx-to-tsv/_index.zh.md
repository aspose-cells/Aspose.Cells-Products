...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLSX 转换为 TSV。 Python XLSX 为 TSV。 Python 将 XLSX 保存为 TSV。 将 XLSX 另存为 07611134 81 使用 Python。
...
{{% cells-convert title="将 XLSX 转换为 TSV 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="tsv" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLSX 转换为 TSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSX 文件转换为 TSV 吗？ Python 开发人员只需几行代码即可轻松加载和转换 XLSX 到 TSV。
...
1. 使用工作簿实例加载 XLSX 文件。
1. 通过调用Workbook.save方法将XLSX转换为TSV。
1. 获取XLSX到TSV的转换结果。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python库将XLSX转换为TSV" %}}
