...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar DIF met Aspose.Cells. PHP MHTML naar DIF. PHP Bewaar MHTML naar DIF. Sla MHTML op als DIF met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar DIF te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar DIF converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar DIF.
...
1.  Converteer MHTML naar DIF door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van MHTML naar DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om MHTML naar DIF te converteren" %}}
