...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na FODS używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM do FODS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować HTM na FODS w Java.
...
Trzeba programowo przekonwertować pliki HTM do formatu FODS? Programiści Java mogą łatwo przekonwertować pliki HTM do formatu FODS za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji HTM na FODS" %}}
{{% blocks/products/pf/agp/text %}}
