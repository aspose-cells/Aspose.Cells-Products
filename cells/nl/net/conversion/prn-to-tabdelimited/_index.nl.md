---
title: C# PRN naar TABDELLIMITED - PRN naar TABDELLIMITED-omzetter
...
{{% blocks/products/pf/agp/content h2="Sla PRN op in TABDELIMITED in C#" %}}

Het volgende voorbeeld laat zien hoe PRN naar TABDELIMITED kan worden geconverteerd in C#.
...
{{% blocks/products/pf/agp/content h2="Hoe PRN naar TABDELLIMITED te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u PRN-bestanden programmatisch naar TABDELLIMITED converteren? .NET-ontwikkelaars kunnen PRN eenvoudig laden en converteren naar TABDELLIMITED in slechts een paar regels code.
...
1.  Converteer PRN naar TABDELIMITED door de Workbook.Save-methode aan te roepen.
