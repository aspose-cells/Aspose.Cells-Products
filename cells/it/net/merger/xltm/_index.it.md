...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per unire i file XLTM in C#" %}}
...
+ Carica tutti i file XLTM con percorso completo.
+ Crea un documento come file di base
+ Chiama il metodo pertinente per concatenare e unire i file uno per uno.
+ Chiama il metodo Save() e passa il nome del file (percorso completo) e il formato (XLTM) come parametro.
+ Ora puoi aprire e utilizzare il file XLTM in Microsoft Office, Adobe PDF o qualsiasi altro programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Unisci i file XLTM - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "d7c757e7471bd38006ac0d35d221b2e2" "merge-xltm-files.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{< blocks/products/pf/agp/demobox sectionTitle="Online XLTM Fusione Demo Live" sectionDescription=" Unisci i documenti XLTM adesso visitando il nostro[Sito web delle demo dal vivo](https://products.aspose.app/cells/merger). La demo live presenta i seguenti vantaggi" >}}
