---
title: Konvertor PHP PNG až SXC - PNG až SXC
description: Aspose Excel. Převeďte PNG na SXC rychle a snadno pomocí Aspose.Cells. PHP PNG na SXC. PHP Uložte PNG na SXC. Uložte SXC jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na SXC přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na SXC programově? Vývojáři PHP mohou snadno načíst a převést PNG na SXC v několika řádcích kódu.
...
1.  Převeďte PNG na SXC voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na SXC" %}}
