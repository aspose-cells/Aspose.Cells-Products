...
url: /nl/python-net/merger/merge-json-to-pptx/ 
...
Het volgende voorbeeld laat zien hoe u JSON samenvoegt met PPTX in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u JSON programmatisch samenvoegen met PPTX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
