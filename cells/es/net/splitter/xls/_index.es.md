---
title:  Dividir XLS Archivos via .NET
weight: 1340
description: Código fuente C# para dividir documentos XLS en plataformas .NET Framework, .NET Core, Mono o Xamarin.
...
{{% blocks/products/pf/agp/content h2="Cómo dividir el archivo XLS usando C#" %}}
...
+ Cargue el archivo XLS con la ruta completa para dividirlo.
...
{{% blocks/products/pf/agp/code-block title="Dividir XLS Archivo - C#" offSpacer="" %}}
