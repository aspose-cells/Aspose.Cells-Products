---
title: Chuyển đổi TABDELIMITED thành SXC qua Java 
url: /vi/java/conversion/tabdelimited-to-sxc/ 
description: Mã chuyển đổi Java mẫu cho định dạng TABDELIMITED thành tệp SXC. Lập trình viên có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang SXC trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn nào Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi TABDELIMITED thành SXC qua Java" h2="Chuyển đổi TABDELIMITED sang SXC Java để chuyển đổi một hoặc nhiều trang sang SXC bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi TABDELIMITED thành SXC bằng cách sử dụng Java" %}}

 Để hiển thị TABDELIMITED thành SXC, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi TABDELIMITED thành SXC qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp TABDELIMITED thành SXC chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp TABDELIMITED với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Truyền đường dẫn đầu ra với phần mở rộng SXC & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp SXC kết quả
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED thành SXC Java Mã nguồn chuyển đổi" offSpacer="" %}}

```cs
// tải tệp TABDELIMITED trong một phiên bản của Workbook
Workbook book = new Workbook("template.tabdelimited");
// lưu TABDELIMITED dưới dạng SXC
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED cho Bản trình diễn Trực tiếp Chuyển đổi SXC" sectionDescription="[Chuyển đổi TABDELIMITED thành SXC](https://products.aspose.app/cells/conversion/tabdelimited-to-sxc) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp TABDELIMITED của bạn, tệp sẽ được chuyển đổi ngay lập tức sang SXC." >}}
