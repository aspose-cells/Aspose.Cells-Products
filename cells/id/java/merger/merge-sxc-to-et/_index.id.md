---
title: Gabungkan SXC ke ET - Gabungkan SXC ke ET di Java
url: /id/java/merger/merge-sxc-to-et/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan SXC ke format penyimpanan ET. Java Gabungkan SXC ke format ET. Gabung SXC ke ET di Java. SXC Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan SXC ke ET di Java" %}}

Contoh berikut menunjukkan cara menggabungkan SXC ke ET di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan SXC ke ET. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ET. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan SXC dengan ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan SXC ke ET di Java" InputFormat="sxc" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC menjadi ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SXC ke ET secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan SXC ke ET" %}}
