---
title: Konwertuj XLSB na XLSM za pomocą aplikacji C++ 
weight: 2360
url: /pl/cpp/conversion/xlsb-to-xlsm/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSB do formatu XLSM. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSB do XLSM w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na XLSM przez C++" h2="Wysokowydajna konwersja XLSB do XLSM przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSB na XLSM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSM).1. Plik XLSM zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSM w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSB do XLSM C++ Kod źródłowy konwersji" offSpacer="" %}}
