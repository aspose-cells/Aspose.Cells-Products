...
url: /zh-hant/net/merger/merge-mht-to-png/ 
...
以下示例演示如何將MHT合併到Aspose.Cells for .NET中的PNG。
...
需要以編程方式將 MHT 合併到 PNG 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 庫將 MHT 合併到 PNG" %}}
