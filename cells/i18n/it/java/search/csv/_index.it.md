---
title: Cerca il documento CSV senza aprire tramite Java 
weight: 390
url: /it/java/search/csv/ 
description: Java codice di esempio per cercare parole con pattern nel file CSV su Java Runtime Environment per applicazioni JSP/JSF e applicazioni desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cerca formati CSV in Java" h2="Ricerca di documenti CSV nativi e ad alte prestazioni utilizzando API Aspose.Cells for Java lato server, senza l\'uso di software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Come cercare file CSV utilizzando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per cercare file CSV in Java" %}}
...
+ Carica il file CSV creando un'istanza di un oggetto cartella di lavoro.
...
// Accesso al primo foglio di lavoro nel file CSV
