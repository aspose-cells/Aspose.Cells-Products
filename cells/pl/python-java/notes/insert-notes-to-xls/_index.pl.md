...
{{% blocks/products/pf/agp/content h2="Wstaw notatki do XLS Plik używając Python" %}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić notatki w pliku XLS za pośrednictwem Python" %}}
...
{{% cells-annotation title="Darmowa aplikacja do usuwania adnotacji z pliku XLS" InputFormat="xls" IsLandingPage="true" language="python" %}}
