---
title: 通过 Java 将 SPREADSHEETML 转换为 JSON 

description: SPREADSHEETML 格式到 JSON 文件的示例 Java 转换代码。程序员可以使用此示例代码在任何基于 Web 或桌面 Java 的应用程序中将 Excel 和 OpenOffice 电子表格导出为 JSON。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 SPREADSHEETML 转换为 JSON" h2="SPREADSHEETML 到 JSON Java 的转换，以使用内部部署 Java 库将单个或多个页面转换为 JSON。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 SPREADSHEETML 转换为 JSON" %}}

 为了将 SPREADSHEETML 呈现为 JSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 SPREADSHEETML 转换为 JSON 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Java 开发人员只需几行代码即可轻松地将 SPREADSHEETML 文件转换为 JSON。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 类的实例加载 SPREADSHEETML 文件1. 使用 Cells.createRange 方法创建要导出的数据范围1. 使用 Range 和 ExportRangeToJsonOptions 的引用调用 JsonUtility.exportRangeToJson 方法1. 通过 BufferedWriter.write 方法将字符串 JSON 数据写入文件
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML 到 JSON Java 转换源代码" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML 到 JSON 转换现场演示" sectionDescription="[将 SPREADSHEETML 转换为 JSON](https://products.aspose.app/cells/conversion/spreadsheetml-to-json) 立即访问我们的现场演示网站。现场演示具有以下好处" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 无需编写任何代码。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上传您的 SPREADSHEETML 文件，它就会立即转换为 JSON。" >}}
