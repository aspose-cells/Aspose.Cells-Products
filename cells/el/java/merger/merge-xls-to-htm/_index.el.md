...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση XLS σε μορφή αποθήκευσης HTM. Java Συνδυάστε το XLS σε μορφή HTM. Συγχώνευση XLS στο HTM στο Java. XLS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLS στο HTM στο Java" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση XLS στο HTM στο Java" InputFormat="xls" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
