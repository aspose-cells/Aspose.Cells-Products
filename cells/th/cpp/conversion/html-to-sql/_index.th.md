...
description: Aspose เอ็กเซล. แปลง HTML เป็น SQL อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ HTML เป็น SQL C++ บันทึก HTML ลงใน SQL บันทึก HTML เป็น SQL โดยใช้ C++
...
1.  แปลง HTML เป็น SQL โดยการเรียกเมธอด Save()
