...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie OTS online z formatem zapisu DIF. C# Połącz OTS z formatem DIF. Połącz OTS z DIF w C#. Połącz OTS.
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z DIF za pomocą C#" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z DIF w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić OTS z DIF w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić OTS z DIF. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku DIF. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z DIF.
...
{{% blocks/products/pf/agp/content h2="Jak połączyć OTS z DIF przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć OTS z numerem DIF? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia OTS z DIF" %}}
