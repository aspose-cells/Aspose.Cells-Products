---
title: Protégez et verrouillez le document XLSM via Java 
weight: 9620
url: /fr/java/protect/xlsm/ 
description: Java Exemple de code pour verrouiller le fichier XLSM à l'aide d'un mot de passe sur Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
...
{{% blocks/products/pf/agp/content h2="Comment sécuriser un fichier XLSM à l\'aide de Java" %}}
...
1. Charger le fichier XLSM en instanciant la classe Workbook1. Utiliser la méthode protect(..) avec ProtectionType et Password1. Enregistrez le fichier XLSM protégé par la méthode save()
