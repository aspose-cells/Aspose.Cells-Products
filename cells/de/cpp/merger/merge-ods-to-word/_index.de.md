---
title: ODS mit WORD zusammenführen - ODS mit WORD in C++ kombinieren
url: /de/cpp/merger/merge-ods-to-word/ 
description: Aspose Excel. C++ Aspose.Cells. ODS mit WORD Saveformat zusammenführen. C++ Kombinieren Sie das Format ODS mit dem Format WORD. ODS zu WORD in C++ zusammenführen. ODS Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="ODS mit WORD in C++ zusammenführen" %}}

Das folgende Beispiel zeigt, wie ODS mit WORD in Aspose.Cells for C++ zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um ODS mit WORD zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei WORD. Wenn Sie Code in C++ entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C++, das ODS mit WORD zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Beispielcode zum Zusammenführen von ODS mit WORD in C++" InputFormat="ods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
