---
title: Convertisseur C# XLS à XLS - XLS à XLS
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format XLS au format XLS, permettant un enregistrement transparent des données XLS au format XLS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS au lieu de XLS dans C#" %}}

L'exemple suivant montre comment convertir XLS en XLS dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en XLS. Téléchargez votre fichier XLS, puis enregistrez-le simplement sous le nom de fichier XLS. Pour la lecture XLS et l'écriture XLS, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie XLS seront identiques au document XLS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir XLS en XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en XLS par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en XLS en quelques lignes de code seulement.
...
1.  Convertissez XLS en XLS en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de XLS en XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en XLS" %}}
