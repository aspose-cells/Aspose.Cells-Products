...
description: Aspose エクセル。 Java Aspose.Cells. EXCEL を OTS 保存形式にマージします。 Java EXCELをOTS形式に結合します。 EXCEL を Java の OTS にマージします。EXCEL をマージします。
...
{{% blocks/products/pf/agp/content h2="Java で EXCEL を OTS にマージ" %}}
...
{{% cells-merger title="Java で EXCEL を OTS にマージするサンプル コード" InputFormat="xlsx" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
