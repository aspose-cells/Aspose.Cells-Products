...
description: Aspose Exceller. Convertissez HTM en TXT rapidement et facilement avec Aspose.Cells. Python HTM en TXT. Python Enregistrez HTM en TXT. Enregistrez HTM sous TXT en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir HTM en TXT en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au TXT dans Python" %}}

L'exemple suivant montre comment convertir HTM en TXT en Python.
...
{{% cells-convert title="Exemple de code pour convertir HTM en TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="txt" IsLandingPage="true" language="pythonjava" %}}
