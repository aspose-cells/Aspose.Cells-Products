---
title: Java NUMBERS - MHT - Online NUMBERS - MHT Dönüştürücü
description: Aspose excel. Java Aspose.Cells. Java Aspose Cells. Ücretsiz Çevrimiçi Java NUMBERS'ı MHT saveformat'a dönüştürün. Java NUMBERS'tan MHT formatına. NUMARALARI MHT Java'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="NUMBERS\'ı Java Online\'da MHT\'ye Ücretsiz Kaydet" %}}

Aşağıdaki örnek, NUMBERS'in Java'de MHT'ye nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

NUMBERS'ı MHT'ye dönüştürmek için kolay adımları izleyin. NUMBERS dosyanızı yükleyin, ardından MHT dosyası olarak kaydedin. Hem NUMBERS okuma hem de MHT yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı MHT içeriği ve biçimlendirmesi, orijinal NUMBERS belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="NUMARALARI Çevrimiçi MHT\'ye Dönüştürmek için Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="mht" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="SAYILARI MHT via Java\'e Dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyalarını programlı olarak MHT'ye dönüştürmeniz mi gerekiyor? Java geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca MHT'ye dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak SAYILARI MHT'ye dönüştürün.
1.  NUMBERS'in MHT'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'i MHT\'ye dönüştürmek için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
