---
title: Konwertuj TABDELIMITED na XLTX za pomocą aplikacji C++ 
url: /pl/cpp/conversion/tabdelimited-to-xltx/ 
description: Przykładowy kod konwersji C++ dla dokumentu TABDELIMITED do formatu XLTX. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TABDELIMITED na XLTX w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TABDELIMITED na XLTX przez C++" h2="Wysoka wydajność konwersji TABDELIMITED do XLTX przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TABDELIMITED na XLTX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TABDELIMITED przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLTX).1. Plik XLTX zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLTX w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED do kodu źródłowego konwersji XLTX C++" offSpacer="" %}}
