...
description: Aspose اكسل. قم بتحويل NUMBERS إلى XPS بسرعة وسهولة باستخدام Aspose.Cells. C# NUMBERS إلى XPS. C# احفظ NUMBERS في XPS. احفظ NUMBERS كـ XPS باستخدام C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الأرقام إلى XPS في C#" h2="مكتبة C# عالية السرعة لتحويل الأرقام إلى XPS. هذا حل برمجي احترافي لاستيراد وتصدير الأرقام وXPS والعديد من التنسيقات الأخرى على منصات .NET Framework أو .NET Core أو Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام إلى XPS في C#" %}}
...
1.  تحويل الأرقام إلى XPS عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل الأرقام إلى XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الارقام الى XPS" %}}
