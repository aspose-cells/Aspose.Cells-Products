...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке формы локтя в файл Excel с помощью Python via.Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) чтобы вставить форму локтя в выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка формы колена - Python via .Net" offSpacer="" %}}
