---
title:  Wyszukaj dokument XLSM bez otwierania za pomocą C++
weight: 9280
description: C++ przykładowy kod do wyszukiwania słów z wzorcem w pliku XLSM w środowisku wykonawczym C++ dla Windows 32-bit, Windows 64-bit i Linux 64-bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Wyszukaj formaty XLSM w C++" h2="Natywne i wydajne wyszukiwanie dokumentów XLSM przy użyciu interfejsów API po stronie serwera Aspose.Cells for C++, bez użycia żadnego oprogramowania, takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSM Wyszukaj demonstracje na żywo" sectionDescription=" Wyszukaj tekst, słowa, frazy w dokumentach XLSM już teraz, odwiedzając naszą stronę[Witryna internetowa z prezentacjami na żywo](https://products.aspose.app/cells/search). Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie trzeba pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Wystarczy, że prześlesz pliki XLSM." >}}
