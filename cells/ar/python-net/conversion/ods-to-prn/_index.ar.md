...
description: Aspose اكسل. قم بتحويل ODS إلى PRN بسرعة وسهولة باستخدام Aspose.Cells. Python ODS إلى PRN. Python احفظ ODS في PRN. احفظ ODS كـ PRN باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="تحويل ODS إلى PRN في Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ ODS إلى PRN في Python" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل ODS إلى PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="prn" IsLandingPage="true" language="pythonnet" %}}
