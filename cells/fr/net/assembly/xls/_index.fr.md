---
title: Générer des rapports dans des fichiers XLS via .NET 
weight: 1700

description: Code source C# pour générer des rapports au format XLS sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin.
---
