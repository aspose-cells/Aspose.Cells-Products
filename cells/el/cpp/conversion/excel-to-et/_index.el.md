...
description: Aspose Excel. Μετατρέψτε το EXCEL σε ET γρήγορα και εύκολα με το Aspose.Cells. C++ EXCEL σε ET. C++ Αποθήκευση EXCEL στο ET. Αποθηκεύστε το EXCEL ως ET χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το EXCEL στο ET στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή EXCEL σε ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="et" IsLandingPage="true" language="cpp" %}}
