---
title: Convertir SPREADSHEETML en XLSB via l'application C++ 
url: /fr/cpp/conversion/spreadsheetml-to-xlsb/ 
description: Exemple de code de conversion C++ pour le document SPREADSHEETML au format XLSB. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de SPREADSHEETML en XLSB dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir SPREADSHEETML en XLSB via C++" h2="Conversion SPREADSHEETML vers XLSB haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir SPREADSHEETML en XLSB à l\'aide de C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SPREADSHEETML en XLSB via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir le fichier SPREADSHEETML en XLSB en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier SPREADSHEETML à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (XLSB).1. Le fichier XLSB sera enregistré dans le chemin spécifié.1. Ouvrez le fichier XLSB dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML vers XLSB C++ Code source de conversion" offSpacer="" %}}
