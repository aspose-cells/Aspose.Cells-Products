...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج/إنشاء مخطط انسيابي لملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) لإدراج/إنشاء مخطط انسيابي في ورقة العمل المحددة
...
يوضح نموذج التعليمات البرمجية أدناه كيفية إدراج "Multidocument". لمزيد من الأنواع، يرجى الرجوع إلى "نظرة عامة على أنواع أشكال أسهم الكتلة" أدناه.

{{% blocks/products/pf/agp/code-block title="إدراج/إنشاء مخطط انسيابي - Java" offSpacer="" %}}
