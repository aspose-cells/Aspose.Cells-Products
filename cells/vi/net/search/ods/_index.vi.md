---
title:  Tìm kiếm tài liệu ODS không cần mở via .NET
weight: 160
description: Mã nguồn C# để tìm kiếm các từ có mẫu trong tệp ODS trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm định dạng ODS trong C#" h2="Tìm kiếm tài liệu ODS gốc và hiệu suất cao bằng API Aspose.Cells for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
+ Load file ODS sử dụng lớp Workbook.
