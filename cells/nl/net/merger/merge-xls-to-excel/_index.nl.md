---
title: Voeg XLS samen met EXCEL - Combineer XLS naar EXCEL in C#
url: /nl/net/merger/merge-xls-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Voeg XLS samen naar het Excel-opslagformaat. C# Combineer XLS naar EXCEL-formaat. Voeg XLS samen met EXCEL in C#. XLS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met EXCEL in C#" %}}

Het volgende voorbeeld laat zien hoe u XLS samenvoegt met EXCEL in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLS samen te voegen naar EXCEL. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een EXCEL-bestand. Als u code ontwikkelt in C#, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld C# waarin XLS wordt samengevoegd met EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLS samen te voegen met EXCEL in C#" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLS samenvoegt met EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLS programmatisch samenvoegen met EXCEL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLS samen te voegen naar EXCEL" %}}
