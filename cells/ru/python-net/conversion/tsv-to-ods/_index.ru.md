...
description: Aspose Эксель. Преобразуйте TSV в ODS быстро и легко с помощью Aspose.Cells. Python TSV в ODS. Python Сохранить TSV в ODS. Сохранить TSV как 07611134 81, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразовать TSV в ODS в Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните с TSV по ODS в Python." %}}

В следующем примере показано, как преобразовать TSV в ODS в Python via NET.
...
{{% cells-convert title="Пример кода для преобразования TSV в ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="ods" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека Python для преобразования TSV в ODS" %}}
