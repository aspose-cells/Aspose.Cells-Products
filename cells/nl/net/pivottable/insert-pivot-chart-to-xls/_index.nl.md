...
weight: 7690
description: C# Voorbeeldcode voor het genereren van XLS-documenten met draaigrafiek. Gebruik deze code voor het maken van Micorsoft Excel XLS-bestanden met draaigrafiek binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pivot Chart invoegen in XLS Documenten via C#" h2="Native en krachtige Microsoft Excel XLS-spreadsheet met programmatisch maken van draaigrafieken met behulp van server-side .NET API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Het genereren van een MS Excel XLS-bestand met draaitabel dynamisch binnen een actieve toepassing is eenvoudig. Om XLS-documenten met draaitabel helemaal opnieuw te maken zonder dat MS Office nodig is, gebruiken we
...
Het is gemakkelijk voor de ontwikkelaars om een draaigrafiek in een spreadsheet met de indeling XLS in te voegen in verschillende rapportagetoepassingen voor gegevensverwerking in slechts een paar regels code.
...
1.  Gebruik de methode Save om de werkmap op te slaan als XLS-bestand.
...
Een Excel-spreadsheet-programmeerbibliotheek die platformonafhankelijke applicaties kan bouwen met de mogelijkheid om Excel XLS-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. .NET Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS en meer, waardoor het een perfecte keuze is om documenten in industriestandaard formaten uit te wisselen.
