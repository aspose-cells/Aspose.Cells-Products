---
title: Объединить OTS с FODS — Объединить OTS с FODS в Java.
url: /ru/java/merger/merge-ots-to-fods/ 
description: Aspose Эксель. Java Aspose.Cells. Объедините OTS с форматом сохранения FODS. Java Объединить OTS в формат FODS. Объедините OTS с FODS в Java. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="Объединить OTS с FODS в Java" %}}

В следующем примере показано, как объединить OTS с FODS в Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить OTS с FODS. Загрузите свои файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле FODS. Если вы разработаете код Java, это будет проще, чем кажется. См. пример Java, в котором OTS объединяется с FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения OTS с FODS в Java" InputFormat="ots" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Как объединить OTS с номером FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить OTS с FODS? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for Java](https://products.aspose.com/cells/java) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для объединения OTS с FODS" %}}
