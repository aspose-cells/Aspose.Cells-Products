...
url: /cs/net/merger/merge-excel-to-txt/ 
...
Následující příklad ukazuje, jak sloučit EXCEL s TXT v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit EXCEL s TXT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení EXCELu s TXT" %}}
