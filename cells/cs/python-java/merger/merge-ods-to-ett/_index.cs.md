---
title: Sloučit ODS na ETT – Sloučit ODS na ETT v Python
url: /cs/python-java/merger/merge-ods-to-ett/ 
description: Aspose Excel. Python Aspose.Cells. Zdarma online sloučení ODS do formátu uložení ETT. Python Zkombinujte ODS do formátu ETT. Sloučit ODS do ETT v Python. ODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS do ETT pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS do ETT v Python Online zdarma" %}}

Následující příklad ukazuje, jak sloučit ODS do ETT v Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení ODS s ETT. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru ETT. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí ODS do ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení ODS do ETT v Python" InputFormat="ods" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit ODS do ETT přes Python" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit ODS do ETT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Python knihovna ke sloučení ODS do ETT" %}}
