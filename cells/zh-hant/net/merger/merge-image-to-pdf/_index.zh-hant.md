...
以下範例示範如何將 IMAGE 合併到 Aspose.Cells for .NET 中的 PDF。
...
需要以程式設計方式將 IMAGE 合併到 PDF 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
