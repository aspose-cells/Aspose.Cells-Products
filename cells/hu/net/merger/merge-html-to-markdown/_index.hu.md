---
title: A HTML-MARKDOWN-es számok egyesítése – a HTML-es és a MARKDOWN-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-html-to-markdown/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés HTML MARKDOWN mentési formátumba. C# A HTML és a MARKDOWN formátum kombinálása. Egyesítse a HTML-MARKDOWN-et a C#-ben. HTML Egyesítse.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a HTML-es számokat a MARKDOWN-es számokhoz a C#-ben online ingyen" %}}

A következő példa bemutatja a HTML és a MARKDOWN egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML-es és a MARKDOWN-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a MARKDOWN fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTML és MARKDOWN számokat.
...
{{% blocks/products/pf/agp/content h2="A HTML és a MARKDOWN egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTML-et a MARKDOWN-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML és MARKDOWN egyesítéséhez" %}}
