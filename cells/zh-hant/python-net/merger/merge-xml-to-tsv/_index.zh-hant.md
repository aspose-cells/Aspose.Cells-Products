...
url: /zh-hant/python-net/merger/merge-xml-to-tsv/ 
...
以下範例示範如何將 XML 合併到 Aspose.Cells for Python via .NET 中的 TSV。
...
需要以程式設計方式將 XML 合併到 TSV 嗎？基本文檔合併和連接[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)只需幾行程式碼即可完成 API。
