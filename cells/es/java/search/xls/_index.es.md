---
title: Buscar documento XLS sin abrir a través de Java 
weight: 9430
url: /es/java/search/xls/ 
description: Java código de muestra para buscar palabras con patrón en un archivo XLS en Java entorno de tiempo de ejecución para aplicaciones de escritorio y aplicaciones JSP/JSF.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Buscar formatos XLS en Java" h2="Búsqueda de documentos XLS nativa y de alto rendimiento mediante API Aspose.Cells for Java del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo buscar archivos XLS usando Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Buscar archivos XLS - Java" offSpacer="" %}}

```cs
// Crear una instancia de un objeto Workbook
Workbook workbook = new Workbook(dataDir + "book1.xls");

// Acceso a la primera hoja de trabajo en el archivo XLS
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Búsqueda XLS en línea Demostraciones en vivo" sectionDescription="Busque texto, palabras, frases dentro de documentos XLS ahora mismo visitando nuestro [Sitio web de demostraciones en vivo](https://products.aspose.app/cells/search). La demostración en vivo tiene los siguientes beneficios" >}}
