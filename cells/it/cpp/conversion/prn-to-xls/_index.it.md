...
È necessario convertire i file PRN in XLS a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in XLS in poche righe di codice.
...
1.  Converti PRN in XLS chiamando il metodo Save().
