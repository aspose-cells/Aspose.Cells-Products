...
Das folgende Beispiel zeigt, wie SPREADSHEETML in Python via NET in MHT konvertiert wird.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SPREADSHEETML in MHT" %}}
