---
title:  XLSM 파일 via Java에서 보고서 생성
weight: 270
description: JSP/JSF 애플리케이션 및 데스크탑 애플리케이션용 Java 런타임 환경에 대한 XLSM 형식 보고서를 생성하기 위한 Java 샘플 코드입니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="XLSM 형식의 대량 보고서 생성 via Java" h2="데이터 소스 및 템플릿을 사용하여 XLSM 형식으로 보고서를 생성합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM 보고서 via Java 생성 단계" %}}
...
1.  Worbook.save 메소드를 통해 결과를 XLSM 형식으로 저장합니다.
...
{{% blocks/products/pf/agp/code-block title="XLSM 형식 - Java로 Excel 보고서 생성" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API은 Microsoft Excel 형식을 다른 형식으로 생성, 편집, 변환 및 렌더링하는 데 사용할 수 있습니다. 또한 소프트웨어 애플리케이션 내에서 포괄적인 차트 작성, 확장 가능한 보고 및 신뢰할 수 있는 계산에 사용할 수 있습니다. Aspose.Cells은 독립형 API이며 Microsoft 또는 OpenOffice와 같은 소프트웨어가 필요하지 않습니다.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="무료 조립 앱 XLSM" sectionDescription=" 라이브 데모를 확인해보세요[XLSM 파일 생성](https://products.aspose.app/cells/assembly/xlsm) 다음과 같은 이점이 있습니다." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 아무것도 다운로드하거나 설정할 필요가 없습니다." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 코드를 작성하거나 컴파일할 필요가 없습니다." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" XLSM 파일을 업로드하고 \"조립\" 버튼을 누르세요." >}}
