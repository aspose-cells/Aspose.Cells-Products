...
description: Aspose Excel. Convierta XLTM a DIF rápida y fácilmente con Aspose.Cells. Python XLTM a DIF. Python Guarde XLTM en DIF. Guarde XLTM como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLTM al DIF en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLTM a DIF en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLTM en DIF" %}}
