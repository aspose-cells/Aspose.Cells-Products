...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSM إلى XLT باستخدام C++" %}}
 ...
 من أجل تحويل XLSM إلى XLT ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف XLSM إلى XLT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLSM باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLT).1. سيتم حفظ ملف XLT في المسار المحدد.1. افتح ملف XLT في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLSM إلى XLT C++ شفرة مصدر التحويل" offSpacer="" %}}
