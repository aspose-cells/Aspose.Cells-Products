...
{{% blocks/products/pf/agp/content h2="Enregistrer OTS au format SPREADSHEETML dans C++" %}}
...
Besoin de convertir des fichiers OTS en SPREADSHEETML par programmation ? Les développeurs C++ peuvent facilement convertir des fichiers OTS en SPREADSHEETML en quelques lignes de code seulement.
...
1.  Convertissez le fichier OTS en SPREADSHEETML en appelant la méthode Save().
