...
{{% blocks/products/pf/agp/content h2="Как вставить элемент управления ActiveX в файл Excel с помощью Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке элемента управления ActiveX в файл Excel с помощью Java Python via" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте коллекцию фигур[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить элемент управления ActiveX на выбранный лист.
