...
weight: 7690
description: C# Mã mẫu để chuyển đổi XLSX thành Byte Array. Sử dụng mã này để chuyển đổi Excel XLSX sang Byte Array trong VB.NET, Asp.NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLSX thành mảng byte qua C#" h2="Bản gốc và hiệu suất cao Microsoft Excel XLSX để chuyển đổi mảng byte hoặc ngược lại để xử lý dữ liệu bảng tính bằng API .NET phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi XLSX thành Byte Array qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp XLSX thành mảng byte cho các tác vụ thao tác tiếp theo chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1.  Bao gồm không gian tên trong tệp lớp học của bạn
1.  Tải đầu vào XLSX Tệp bằng Sổ làm việc
