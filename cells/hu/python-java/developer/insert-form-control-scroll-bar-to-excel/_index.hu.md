---
title:  Illessze be a görgetősávot (Űrlapvezérlő) az Excelbe a Python számon keresztül
weight: 90
description: Python forráskód a ScrollBar (Űrlapvezérlő) Excelbe való beillesztéséhez.
---
...
{{% blocks/products/pf/agp/content h2="A görgetősáv (űrlapvezérlő) beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A ScrollBar (Űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python-es számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addScrollBar(int,%20int,%20int,%20int,%20int,%20int)) egy ScrollBar (Űrlapvezérlő) beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Görgetősáv beszúrása (Űrlapvezérlő) - Python" offSpacer="" %}}
