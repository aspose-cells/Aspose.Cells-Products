---
title: Połącz XLTM z BMP - Połącz XLTM z BMP w C#
url: /pl/net/merger/merge-xltm-to-bmp/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLTM do BMP w formacie zapisu. C# Połącz format XLTM z BMP. Połącz XLTM z BMP w C#. XLTM Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTM z BMP w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLTM z BMP w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLTM z BMP. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku BMP. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy numery XLTM z BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTM z BMP w C#" InputFormat="xltm" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTM z BMP za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLTM z BMP programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
