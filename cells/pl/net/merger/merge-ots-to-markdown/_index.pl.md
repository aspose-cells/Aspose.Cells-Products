...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie OTS online z formatem zapisu MARKDOWN. C# Połącz OTS z formatem MARKDOWN. Połącz OTS z MARKDOWN w C#. Połącz OTS.
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z MARKDOWN za pomocą C#" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z MARKDOWN w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić OTS z MARKDOWN w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić OTS z MARKDOWN. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku MARKDOWN. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z MARKDOWN.
...
{{% blocks/products/pf/agp/content h2="Jak połączyć OTS z MARKDOWN przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć OTS z numerem MARKDOWN? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia OTS z MARKDOWN" %}}
