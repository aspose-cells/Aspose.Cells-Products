---
title: Scal CSV z DOCX - Połącz CSV z DOCX w C++
url: /pl/cpp/merger/merge-csv-to-docx/ 
description: Aspose Excel. C++ Aspose.Cells. Scal CSV z DOCX w formacie zapisu. C++ Połącz format CSV z DOCX. Scal CSV z DOCX w C++. CSV Scal.
...
{{% blocks/products/pf/agp/content h2="Scal CSV z DOCX w C++" %}}

Poniższy przykład pokazuje, jak połączyć CSV z DOCX w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć CSV z DOCX. Prześlij swoje pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku DOCX. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy CSV z DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia CSV z DOCX w C++" InputFormat="csv" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z DOCX przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć CSV z DOCX? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
