...
url: /de/net/merger/merge-spreadsheetml-to-mht/ 
...
Das folgende Beispiel zeigt, wie SPREADSHEETML in Aspose.Cells for .NET mit MHT zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von SPREADSHEETML mit MHT in C#" InputFormat="xml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie SPREADSHEETML über C# mit MHT zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie SPREADSHEETML programmgesteuert mit MHT zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von SPREADSHEETML mit MHT" %}}
