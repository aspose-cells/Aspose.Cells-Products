...
description: C# Exemple de code pour créer des graphiques à bulles vers Excel à l’aide de la bibliothèque .NET. Utilisez ce code pour créer un graphique {chart} sur MS Excel dans VB.NET, Asp.NET ou toute application basée sur .NET.
...
1.  Utiliser[**Chart.SetChartDataRange**](https://https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/setchartdatarange)méthode pour spécifier la source de données du graphique.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Le code source suivant montre comment créer un graphique à bulles dans le fichier MS Excel XLSX à l\'aide de C#." offSpacer="" %}}
