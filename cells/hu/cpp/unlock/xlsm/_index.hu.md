...
{{< blocks/products/pf/i18n/upper-banner h1="XLSM-fájlok feloldása a következőn keresztül: C++" h2="Távolítsa el a védelmet az Excel-táblázatokról, beleértve az XLSM-fájlt is a C++ Library használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Az XLSM-fájlok védelmének eltávolítása a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM feloldása a következőn keresztül: C++" %}}
...
1. Töltse be az XLSM zárolt fájlt a CreateIWorkbook segítségével.1. A feloldáshoz hívja az Unprotect() függvényt.1. Állítsa a jelszót NULL-ra a SetPassword segítségével.1. Mentse az XLSM fájlt egy megadott helyre.
