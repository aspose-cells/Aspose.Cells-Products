---
title: Convertir CSV a DIF a través de Java 
weight: 8250
url: /es/java/conversion/csv-to-dif/ 
description: Ejemplo de código de conversión Java de formato CSV a archivo DIF. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a DIF dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir CSV a DIF a través de Java" h2="Conversión de CSV a DIF Java para convertir una o varias páginas a DIF mediante la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir CSV a DIF usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir CSV a DIF a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo CSV a DIF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo CSV con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con extensión DIF y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo DIF resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de CSV a DIF Java" offSpacer="" %}}

```cs
// cargar el archivo CSV en una instancia de Workbook
Workbook book = new Workbook("template.csv");
// guardar CSV como DIF
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de CSV a DIF" sectionDescription="[Convertir CSV a DIF](https://products.aspose.app/cells/conversion/csv-to-dif) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo CSV, se convertirá instantáneamente a DIF." >}}
