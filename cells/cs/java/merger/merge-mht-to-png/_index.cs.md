---
title: Sloučit MHT s PNG - Sloučit MHT s PNG v Java
url: /cs/java/merger/merge-mht-to-png/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit MHT do PNG saveformat. Java Zkombinujte MHT do formátu PNG. Sloučit MHT na PNG v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na PNG v Java online zdarma" %}}

Následující příklad ukazuje, jak sloučit MHT s PNG v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT do PNG. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PNG. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení MHT na PNG v Java" InputFormat="mht" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT na PNG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit MHT na PNG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro sloučení MHT s PNG" %}}
