...
weight: 5670
description: Java mã mẫu để tách các tài liệu XLSM trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tách XLSM Tệp via Java" h2="XLSM tách với sự trợ giúp của thư viện Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tách tệp XLSM trong Java" %}}
...
+ Nạp tệp XLSM bằng lớp Workbook.
+ Lặp qua từng sheet
+ Tạo đối tượng lớp Workbook mới
+ Sao chép trang tính đã chọn sang đối tượng mới
+ Gọi phương thức lưu với đường dẫn tệp XLSM mới.
...
{{% blocks/products/pf/agp/code-block title="Tách File XLSM - Java" offSpacer="" %}}
