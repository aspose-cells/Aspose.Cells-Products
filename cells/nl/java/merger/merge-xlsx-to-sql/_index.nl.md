...
description: Aspose Excel. Java Aspose.Cells. Gratis online samenvoegen XLSX naar SQL-opslagformaat. Java Combineer XLSX naar SQL-indeling. Voeg XLSX samen met SQL in Java. XLSX Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLSX samen met SQL in Java online" %}}

Het volgende voorbeeld laat zien hoe u XLSX kunt samenvoegen met SQL in Aspose.Cells for Java.
...
{{% cells-merger title="Gratis online om XLSX samen te voegen met SQL in Java" InputFormat="xlsx" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSX samen te voegen met SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met SQL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
