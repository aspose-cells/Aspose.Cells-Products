...
description: Aspose اكسل. Java قم بإنشاء ملف IMAGE بسرعة وسهولة باستخدام Aspose.Cells. قم بإنشاء ملف IMAGE باستخدام Java. قم بإنشاء IMAGE في Java. Java IMAGE Creator.
...
{{< blocks/products/pf/i18n/upper-banner h1="قم بإنشاء ملف IMAGE في Java" h2="مكتبة Java عالية السرعة لإنشاء ملف IMAGE. هذا حل برمجي احترافي لاستيراد وتصدير XLSX وPDF والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  احفظ المصنف بتنسيق IMAGE باستخدام طريقة save().

{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف IMAGE في Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لإنشاء ملف IMAGE" %}}
{{% blocks/products/pf/agp/text %}}
