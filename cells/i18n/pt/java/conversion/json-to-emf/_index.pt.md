---
title: Converter JSON para EMF via Java 
weight: 2020
url: /pt/java/conversion/json-to-emf/ 
description: Exemplo de código de conversão Java para formato JSON em arquivo EMF. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para EMF em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter JSON para EMF via Java" h2="Exporte JSON para o formato EMF via Java sem precisar de ferramentas ou bibliotecas adicionais." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter JSON para EMF usando Java" %}}

 Para renderizar JSON para EMF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter JSON em EMF por meio de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente arquivos JSON em EMF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Criar uma nova instância da classe Workbook1. Selecione o padrão ou qualquer planilha da coleção1. Carregar dados JSON do arquivo1. Crie uma instância de JsonLayoutOptions e defina opções1. Chame o método JsonUtility.importData para importar dados JSON1. Crie e defina o objeto de ImageOrPrintOptions para renderização EMF1. Criar SheetRender para renderização1. Chame o método SheetRender.toImage para salvar o resultado no formato EMF
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão JSON para EMF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de JSON para EMF" sectionDescription="[Converter JSON para EMF](https://products.aspose.app/cells/conversion/json-to-emf) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo JSON, ele será convertido instantaneamente para EMF." >}}
