---
title: C# XLS na MD - XLS na konwerter MD
description: Aspose Excel. Szybko i łatwo przekonwertuj XLS na MD za pomocą Aspose.Cells. C# XLS na MD. C# Zapisz XLS w MD. Zapisz XLS jako MD, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS na MD w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na MD w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLS na MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na MD przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na MD? Programiści .NET mogą z łatwością załadować i przekonwertować XLS na MD w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na MD" %}}
