---
title: "TXT konvertálása XLSM-re a következőn keresztül: Java "
url: /hu/java/conversion/txt-to-xlsm/ 
description: Minta Java konverziós kód TXT formátumhoz XLSM fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok XLSM-be exportálására bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TXT konvertálása XLSM-re a következőn keresztül: Java" h2="TXT-ből XLSM-be Java konverzió egyetlen vagy több oldal konvertálásához XLSM-má a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="TXT konvertálása XLSM-re a következővel: Java" %}}

 Ahhoz, hogy a TXT-t XLSM-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TXT XLSM-re konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a TXT fájlt XLSM-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLSM kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLSM-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT-ből XLSM-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése XLSM-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT-ből XLSM-be konvertáló élő bemutatók" sectionDescription="[TXT konvertálása XLSM-re](https://products.aspose.app/cells/conversion/txt-to-xlsm) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel TXT fájlját, és azonnal XLSM formátumba konvertálódik." >}}
