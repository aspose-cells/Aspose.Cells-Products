---
title: Konvertera XLT till SXC via Python
url: /sv/python-java/conversion/xlt-to-sxc/
description: Exempelkod för konvertering av xlt till sxc Python. Använd API exempelkod för batch-xlt-filer till sxc-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLT till SXC med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLT till SXC via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLT-filer till SXC på bara några rader kod.
