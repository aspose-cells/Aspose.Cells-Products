---
title:  Вставьте SVG изображения/значки в Excel, используя Java Python via.
weight: 200
...
{{% blocks/products/pf/agp/content h2="Как вставить изображения/значки SVG в файл Excel с помощью Java Python via" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке изображений/значков SVG в файл Excel с помощью Java Python via" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте коллекцию фигур[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addIcons(int,%20int,%20int,%20int,%20int,%20int,%20byte[],%20byte[])), чтобы вставить значок на выбранный лист.
