...
description: Aspose Excel. Python Aspose.Cells. Merge HTML to PDF saveformat. Python Combine HTML to PDF format. Merge HTML to PDF in Python. HTML Merge.
...
{{% blocks/products/pf/agp/content h2="Merge HTML to PDF in Python" %}}
...
{{% cells-merger title="Sample Code to Merge HTML to PDF in Python" InputFormat="html" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
