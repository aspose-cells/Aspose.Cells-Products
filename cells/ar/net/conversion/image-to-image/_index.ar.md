---
title: C# IMAGE to IMAGE - محول من IMAGE إلى IMAGE عبر الإنترنت
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل IMAGE إلى IMAGE saveformat. C# IMAGE إلى تنسيق IMAGE. احفظ الصورة في IMAGE C#.
...
{{% blocks/products/pf/agp/content h2="احفظ IMAGE في IMAGE في C# عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى IMAGE برمجيًا؟ يمكن للمطورين .NET بسهولة تحميل وتحويل IMAGE إلى IMAGE في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى IMAGE عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# مكتبة لتحويل IMAGE إلى IMAGE" %}}
