---
title:  Grupuj i rozgrupuj kształty w programie Excel via .NET
weight: 340
description: C# Przykładowy kod do grupowania i rozgrupowywania kształtów w programie Excel przy użyciu biblioteki .NET. Użyj tego kodu, aby grupować lub rozgrupowywać kształty w programie MS Excel w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
keywords: [C# Aspose.Cells., c# group shapes., c# ungroup shapes., c# group and ungroup shapes., c# group or ungroup shapes]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Grupuj i rozgrupuj kształty w programie Excel via .NET" h2="Używanie numeru Aspose.Cells\' API do pracy z różnymi obiektami bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Jak grupować i rozgrupowywać kształty w pliku Excel za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki grupowania i rozgrupowywania kształtów w pliku Excel pod numerem C#" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj[metoda grupowa](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/group/) aby pogrupować kształty w wybranym arkuszu
 + Użyj[metoda rozgrupowania](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/) aby rozgrupować kształty w wybranym arkuszu
...
{{% blocks/products/pf/agp/code-block title="Grupuj i rozgrupuj kształty — C#" offSpacer="" %}}
