---
title:  XLSB 문서 via Java에서 텍스트 검색 및 바꾸기
weight: 4590
description: Java JSP/JSF 애플리케이션 및 데스크탑 애플리케이션용 Java 런타임 환경의 XLSB 파일에 있는 민감한 정보를 수정하기 위한 샘플 코드입니다.
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 XLSB 파일을 수정하는 방법" %}}
 ...
 XLSB 파일을 수정하기 위해 다음을 사용합니다.[Aspose.Cells for Java](https://products.aspose.com/cells/java) API은 기능이 풍부하고 강력하며 사용하기 쉬운 편집 API for Java 플랫폼입니다. 최신 버전은 다음에서 직접 다운로드할 수 있습니다.[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) pom.xml에 다음 구성을 추가하여 Maven 기반 프로젝트 내에 설치하세요.
...
{{% blocks/products/pf/agp/feature-section-col title="Java의 XLSB 파일을 수정하는 단계" %}}
