...
Poniższy przykład pokazuje, jak scalić JPG z MHT w Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić JPG z MHT? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia JPG z MHT" %}}
