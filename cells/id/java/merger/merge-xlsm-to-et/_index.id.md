---
title: Gabungkan XLSM ke ET - Gabungkan XLSM ke ET di Java
url: /id/java/merger/merge-xlsm-to-et/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLSM ke format penyimpanan ET. Java Gabungkan XLSM ke format ET. Gabung XLSM ke ET di Java. XLSM Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSM ke ET di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLSM ke ET di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLSM ke ET. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ET. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan XLSM dengan ET.
...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSM menjadi ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSM ke ET secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan XLSM ke ET" %}}
