...
{{% blocks/products/pf/agp/content h2="Sla HTML op in PPTX in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar PPTX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar PPTX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar PPTX? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar PPTX met slechts een paar regels code.
