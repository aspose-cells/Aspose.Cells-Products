---
title: تكوين XML - تكوين ملف XML في Java
description: Aspose إكسل. Java تكوين ملف XML. قم بإنشاء XML Java. Java XML Craduate. تكوين XML في Java. إنشاء ملف XML باستخدام Java.
...
1.  احفظ المصنف بتنسيق XML باستخدام طريقة الحفظ ().
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتكوين ملف XML" %}}
{{% blocks/products/pf/agp/text %}}
