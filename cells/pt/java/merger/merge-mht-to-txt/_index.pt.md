---
title: Mesclar MHT para TXT - Combine MHT para TXT em Java
url: /pt/java/merger/merge-mht-to-txt/ 
description: Aspose Excel. Java Aspose.Cells. Free Online Mesclar MHT para TXT saveformat. Java Combine MHT para o formato TXT. Mesclar MHT para TXT em Java. Mesclar MHT.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHT para TXT em Java online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar MHT para TXT em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHT para TXT. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo TXT. Se você desenvolver o código em Java, isso será mais simples do que parece. Consulte o exemplo Java que mescla MHT com TXT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar MHT para TXT em Java" InputFormat="mht" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHT para TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar MHT para TXT programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHT com TXT" %}}
