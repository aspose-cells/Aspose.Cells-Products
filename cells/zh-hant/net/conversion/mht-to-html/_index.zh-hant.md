...
{{% cells-convert title="免費應用程序和示例代碼可在線將 MHT 轉換為 HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="html" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 轉換為 HTML" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 HTML？ .NET 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 HTML。
...
1. 通過調用 Workbook.Save 方法將 MHT 轉換為 HTML。
1. 獲取MHT到HTML的轉換結果。
