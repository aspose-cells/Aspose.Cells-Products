---
title: Konversi TXT ke XLT melalui C++ aplikasi 
url: /id/cpp/conversion/txt-to-xlt/ 
description: Contoh C++ kode konversi untuk dokumen TXT ke format XLT. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch TXT ke XLT dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan TXT ke XLT melalui C++" h2="Konversi TXT ke XLT berkinerja tinggi menggunakan C++ library tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TXT ke XLT Menggunakan C++" %}}

 Untuk mengonversi TXT ke XLT, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi TXT ke XLT melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ pengembang dapat dengan mudah mengonversi file TXT ke XLT hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file TXT menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file keluaran dengan ekstensi file (XLT).1. File XLT akan disimpan di jalur yang ditentukan.1. Buka file XLT di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="TXT ke XLT C++ Kode Sumber Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi TXT ke XLT" sectionDescription="[Konversikan TXT ke XLT](https://products.aspose.app/cells/conversion/txt-to-xlt) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file TXT Anda, itu akan langsung dikonversi ke XLT." >}}
