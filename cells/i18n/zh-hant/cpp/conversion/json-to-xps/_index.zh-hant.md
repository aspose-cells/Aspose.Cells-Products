...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 將 JSON 轉換為 XPS" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C++ 將 JSON 轉換為 XPS 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 C++ 開發人員只需幾行代碼即可輕鬆地將 JSON 文件轉換為 XPS。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加載 JSON 文件。1. 調用 Save() 方法。1. 傳遞帶有 (XPS) 文件擴展名的輸出文件路徑。1. XPS 文件將保存在指定路徑。1. 在兼容程序中打開 XPS 文件。
...
{{% blocks/products/pf/agp/code-block title="JSON 到 XPS C++ 轉換源代碼" offSpacer="" %}}
