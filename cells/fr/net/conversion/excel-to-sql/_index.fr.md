---
title: C# EXCEL en SQL - Convertisseur EXCEL en SQL
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format SQL, permettant un enregistrement transparent des données EXCEL au format SQL à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Sauvegarder un fichier Excel au format SQL (C#)" %}}

L'exemple suivant montre comment convertir EXCEL en SQL dans C#.
...
{{% cells-convert title="Exemple de code pour convertir un fichier Excel en SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en SQL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en SQL par programme ? .NET peuvent facilement charger et convertir EXCEL en SQL en quelques lignes de code seulement.
...
1.  Convertissez un fichier EXCEL en SQL en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion d’EXCEL en SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir Excel en SQL" %}}
