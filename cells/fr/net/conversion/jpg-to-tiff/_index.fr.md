...
Besoin de convertir des fichiers JPG en TIFF par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en TIFF en quelques lignes de code.
...
1.  Convertissez le JPG au format TIFF en appelant la méthode Workbook.Save.
