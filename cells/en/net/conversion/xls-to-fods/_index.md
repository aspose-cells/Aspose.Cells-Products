...
description: Sample code for xls to fods C# conversion. Use API example code for batch xls files to fods conversion within VB.NET, Asp.NET or any .NET based application.
---
