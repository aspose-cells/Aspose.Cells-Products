---
title: Chuyển đổi JSON sang DOCX qua ứng dụng C++ 
url: /vi/cpp/conversion/json-to-docx/ 
description: Mã chuyển đổi C++ mẫu cho tài liệu JSON sang định dạng DOCX. Các lập trình viên có thể sử dụng mã nguồn này để chuyển đổi hàng loạt JSON sang DOCX trong bất kỳ Ứng dụng C++ nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi JSON sang DOCX qua C++" h2="Chuyển đổi JSON sang DOCX hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi JSON sang DOCX bằng cách sử dụng C++" %}}
 ...
 Để chuyển đổi JSON thành DOCX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp JSON sang DOCX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp JSON bằng Factory :: CreateIWorkbook.1. Gọi phương thức Save ().1. Chuyển đường dẫn tệp đầu ra với phần mở rộng tệp (DOCX).1. Tập tin DOCX sẽ được lưu theo đường dẫn đã chỉ định.1. Mở tệp DOCX trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi JSON sang DOCX C++" offSpacer="" %}}

```cs
// Tải JSON.
intrusive_ptr<Aspose::Cells::IWorkbook> wkb = Factory::CreateIWorkbook(u"sourceFile.json");

// Lưu ở định dạng DOCX.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi JSON sang DOCX" sectionDescription="[Chuyển đổi JSON sang DOCX](https://products.aspose.app/cells/conversion/json-to-docx) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp JSON của bạn, tệp sẽ được chuyển đổi ngay lập tức sang DOCX." >}}
