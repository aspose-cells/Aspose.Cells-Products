...
description: Aspose Excel. Converteer XLSX snel en eenvoudig naar EXCEL met Aspose.Cells. Python XLSX naar EXCEL. Python Bewaar XLSX in EXCEL. Sla XLSX op als EXCEL met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLSX naar EXCEL in Python" h2="Snelle bibliotheek Python voor het converteren van XLSX naar EXCEL. Gebruik onze Excel-conversie API om hoogwaardige, platformonafhankelijke software te ontwikkelen in Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in EXCEL in Python" %}}

Het volgende voorbeeld laat zien hoe u XLSX naar EXCEL converteert in Python via NET.
