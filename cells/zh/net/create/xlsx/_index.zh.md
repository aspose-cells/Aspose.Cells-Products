---
title: 创建XLSX - 在C#中创建XLSX文件
description: Aspose Excel。 C# 使用 Aspose.Cells 快速轻松地创建 XLSX 文件。使用 C# 生成 XLSX 文件。在 C# 中创建 XLSX。C# XLSX 创建者。
...
{{< blocks/products/pf/i18n/upper-banner h1="在C#中创建XLSX文件" h2="用于创建XLSX的高速C#库。这是一个专业的软件解决方案，可在.NET Framework、.NET Core或Mono平台上导入和导出XLSX、PDF和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何在C#中创建XLSX" %}}
...
{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 C# 中创建 XLSX 文件。" offSpacer="" %}}
