...
description: Aspose excel. Java Aspose.Cells. TSV'i OTS saveformat'a Ücretsiz Çevrimiçi Birleştirme. Java TSV'i OTS biçimiyle birleştirin. TSV'i Java'de OTS ile birleştir. TSV Birleştir.
...
{{% blocks/products/pf/agp/content h2="TSV\'i Java Online\'da OTS ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, TSV'in Aspose.Cells for Java'de OTS ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="TSV\'i Java\'de OTS ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="tsv" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TSV OTS via Java ile Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

TSV'i programlı olarak OTS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="TSV\'i OTS ile birleştirmek için Java kitaplığı" %}}
