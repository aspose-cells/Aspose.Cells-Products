---
title: Chuyển đổi SPREADSHEETML sang TSV qua Java 

description: Mã chuyển đổi Java mẫu cho định dạng SPREADSHEETML thành tệp TSV. Người lập trình có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang TSV trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi SPREADSHEETML sang TSV qua Java" h2="Chuyển đổi SPREADSHEETML sang TSV Java để chuyển đổi một hoặc nhiều trang thành TSV bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi SPREADSHEETML sang TSV bằng cách sử dụng Java" %}}

 Để hiển thị SPREADSHEETML thành TSV, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi SPREADSHEETML sang TSV qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp SPREADSHEETML thành TSV chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp SPREADSHEETML với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Chuyển đường dẫn đầu ra với phần mở rộng TSV & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp TSV kết quả
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML sang TSV Java Mã nguồn chuyển đổi" offSpacer="" %}}

```cs
// tải tệp SPREADSHEETML trong một phiên bản của Workbook
Workbook book = new Workbook("template.spreadsheetml");
// lưu SPREADSHEETML dưới dạng TSV
