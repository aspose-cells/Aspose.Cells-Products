...
{{% blocks/products/pf/agp/content h2="Jak vložit/vytvořit vývojový diagram do souboru aplikace Excel pomocí Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení/vytvoření vývojového diagramu do souboru Excel pomocí Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Vložit/vytvořit vývojový diagram - Python via .Net" offSpacer="" %}}
