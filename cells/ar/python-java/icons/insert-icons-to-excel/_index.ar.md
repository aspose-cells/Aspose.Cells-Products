...
{{% blocks/products/pf/agp/content h2="كيفية إدراج SVG صور / أيقونات في ملف Excel باستخدام Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج SVG صور / أيقونات في ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم الشكل[طريقة الإضافة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addIcons(int,%20int,%20int,%20int,%20int,%20int,%20byte[],%20byte[])) لإدراج رمز في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج SVG صور / أيقونات - Python via جافا" offSpacer="" %}}
