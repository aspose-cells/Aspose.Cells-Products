...
weight: 90
description: ซอร์สโค้ด C# เพื่อแทรก ScrollBar ลงใน Excel บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกแถบเลื่อนลงในไฟล์ Excel โดยใช้ C#" %}}
 ...
 ในการแทรก ScrollBar ลงในไฟล์ excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก ScrollBar เข้าไฟล์ Excel ผ่าน C#" %}}
