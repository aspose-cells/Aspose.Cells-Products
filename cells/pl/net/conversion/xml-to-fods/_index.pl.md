...
{{% cells-convert title="Przykładowy kod do konwersji XML na FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na FODS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XML na FODS? Programiści .NET mogą łatwo załadować i przekonwertować XML na FODS w zaledwie kilku linijkach kodu.
