---
title: C# IMAGE إلى BMP - محول IMAGE عبر الإنترنت إلى BMP
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل الصورة إلى BMP saveformat. C# IMAGE إلى تنسيق BMP. احفظ الصورة في BMP C#.
...
{{% blocks/products/pf/agp/content h2="احفظ IMAGE في BMP في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى BMP في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى BMP عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى BMP برمجيًا؟ يمكن للمطورين .NET تحميل وتحويل IMAGE إلى BMP بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى BMP" %}}
