---
title: Java FODS 轉 MHT - 在線 FODS 轉 MHT 轉換器
description: Aspose Excel。 Java Aspose.Cells。Java Aspose Cells。免費在線 Java 將 FODS 轉換為 MHT 保存格式。 Java FODS 為 MHT 格式。將 FODS 保存到 MHT Java。
...
{{% blocks/products/pf/agp/content h2="免費在線將 FODS 保存到 Java 中的 MHT" %}}

以下示例演示如何將 FODS 轉換為 Java 中的 MHT。
...
需要以編程方式將 FODS 文件轉換為 MHT？ Java開發人員只需幾行代碼即可輕鬆將FODS轉換為MHT。
