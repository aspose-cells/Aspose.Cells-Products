---
title: Konwertuj NUMBERS na XLTM przez Java 
url: /pl/java/conversion/numbers-to-xltm/ 
description: Przykładowy kod konwersji Java dla formatu NUMBERS do pliku XLTM. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do XLTM w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj NUMBERS na XLTM przez Java" h2="Konwersja NUMBERS do XLTM Java w celu konwersji jednej lub wielu stron do formatu XLTM przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować NUMBERS na XLTM za pomocą Java" %}}

 Aby renderować NUMBERS do XLTM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować NUMBERS na XLTM za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik NUMBERS na XLTM w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik NUMBERS z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLTM i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLTM
...
{{% blocks/products/pf/agp/code-block title="NUMBERS do XLTM Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik NUMBERS w instancji Workbook
Workbook book = new Workbook("template.numbers");
// zapisz NUMBERS jako XLTM
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją NUMBERS na XLTM" sectionDescription="[Konwertuj NUMBERS na XLTM](https://products.aspose.app/cells/conversion/numbers-to-xltm) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik NUMBERS, zostanie on natychmiast przekonwertowany do formatu XLTM." >}}
