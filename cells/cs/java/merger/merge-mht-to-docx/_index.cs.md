---
title:  Sloučit MHT na DOCX via Java
...
Následující příklad ukazuje, jak sloučit MHT s DOCX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHT na DOCX online" InputFormat="mht" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
