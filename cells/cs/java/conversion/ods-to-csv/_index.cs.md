...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na CSV pomocí Java" %}}

 vykreslení ODS do CSV použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na CSV prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na CSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením CSV a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor CSV
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODS na CSV Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze ODS na CSV" sectionDescription="[Převést ODS na CSV](https://products.aspose.app/cells/conversion/ods-to-csv) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor ODS, bude okamžitě převeden na CSV." >}}
