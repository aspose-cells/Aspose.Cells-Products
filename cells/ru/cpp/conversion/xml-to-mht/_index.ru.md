...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ разработчики могут легко преобразовать XML в MHT, написав всего несколько строк кода.
