...
description: Aspose Excel. Converteer XLS snel en eenvoudig naar ET met Aspose.Cells. Python XLS naar ET. Python Bewaar XLS naar ET. Bewaar XLS als ET met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLS naar ET in Python" h2="Snelle bibliotheek Python voor het converteren van XLS naar ET. Gebruik onze Excel-conversie API om hoogwaardige, platformonafhankelijke software te ontwikkelen in Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer XLS naar ET in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLS naar ET in Python" %}}

Het volgende voorbeeld laat zien hoe u XLS naar ET in Python via NET converteert.
...
{{% cells-convert title="Voorbeeldcode om XLS naar ET te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="et" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLS naar ET te converteren" %}}
