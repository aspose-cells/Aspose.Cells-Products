---
title: Konversi XLSB ke TSV melalui C++ aplikasi 
weight: 720
url: /id/cpp/conversion/xlsb-to-tsv/ 
description: Contoh C++ kode konversi untuk dokumen XLSB ke format TSV. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLSB ke TSV dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLSB ke TSV melalui C++" h2="Konversi XLSB ke TSV berperforma tinggi menggunakan pustaka C++ tanpa memerlukan penginstalan Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLSB ke TSV Menggunakan C++" %}}

 Untuk mengonversi XLSB ke TSV, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi XLSB ke TSV melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ pengembang dapat dengan mudah mengonversi file XLSB ke TSV hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLSB menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file keluaran dengan ekstensi file (TSV).1. File TSV akan disimpan di jalur yang ditentukan.1. Buka file TSV di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLSB ke TSV C++ Kode Sumber Konversi" offSpacer="" %}}
