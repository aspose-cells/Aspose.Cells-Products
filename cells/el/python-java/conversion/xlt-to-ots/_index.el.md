...
description: Aspose Excel. Μετατρέψτε το XLT σε OTS γρήγορα και εύκολα με το Aspose.Cells. Python XLT σε OTS. Python Αποθήκευση XLT στο OTS. Αποθηκεύστε το XLT ως OTS χρησιμοποιώντας το Python.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το XLT στο OTS στο Python" %}}
