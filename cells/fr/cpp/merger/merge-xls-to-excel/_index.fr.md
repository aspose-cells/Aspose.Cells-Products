---
title: Fusionner XLS avec EXCEL - Combiner XLS avec EXCEL dans C++
url: /fr/cpp/merger/merge-xls-to-excel/ 
description: Aspose Exceller. C++ Aspose.Cells. Fusionner XLS au format de sauvegarde EXCEL. C++ Combinez XLS au format EXCEL. Fusionner XLS avec EXCEL dans C++. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS avec EXCEL dans C++" %}}

L'exemple suivant montre comment fusionner XLS vers EXCEL dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLS avec EXCEL. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier EXCEL. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne XLS avec EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner XLS avec EXCEL dans C++" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS vers EXCEL via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLS avec EXCEL par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour fusionner XLS avec EXCEL" %}}
