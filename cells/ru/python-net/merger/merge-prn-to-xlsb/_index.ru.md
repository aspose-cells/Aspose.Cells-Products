...
description: Aspose Excel. Python Aspose.Cells. Бесплатное онлайн объединение PRN в XLSB в сохраненном формате. Python Объедините PRN в формат XLSB. Объединить PRN с XLSB в Python. Объединить PRN.
...
{{% cells-merger title="Бесплатно онлайн объединить PRN с XLSB в Python" InputFormat="prn" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Как объединить PRN с XLSB через Python" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно объединить PRN с XLSB? Базовый документ сливается и объединяется с[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API можно реализовать всего несколькими строками кода.
