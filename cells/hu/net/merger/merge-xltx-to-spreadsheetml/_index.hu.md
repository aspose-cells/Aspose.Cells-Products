...
url: /hu/net/merger/merge-xltx-to-spreadsheetml/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLTX-et a SPREADSHEETML-be a Aspose.Cells-es for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLTX-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLTX és a SPREADSHEETML egyesítéséhez" %}}
