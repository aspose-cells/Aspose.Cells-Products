---
title: Java ODS to IMAGE - Online ODS to IMAGE Converter
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Online Gratis Java Ubah ODS menjadi format penyimpanan GAMBAR. Java ODS ke format GAMBAR. Simpan ODS ke GAMBAR Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ODS menjadi GAMBAR di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi ODS menjadi GAMBAR. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, IMAGE, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke GAMBAR di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi ODS menjadi GAMBAR di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengubah ODS menjadi IMAGE. Unggah file ODS Anda, lalu simpan sebagai file IMAGE. Untuk membaca ODS dan menulis GAMBAR, Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan pemformatan GAMBAR keluaran akan identik dengan dokumen ODS asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi ODS menjadi IMAGE Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="png" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah ODS menjadi GAMBAR via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file ODS ke IMAGE secara terprogram? Pengembang Java dapat dengan mudah mengonversi ODS menjadi GAMBAR hanya dalam beberapa baris kode.
...
1.  Ubah ODS menjadi GAMBAR dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi ODS ke IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi ODS menjadi GAMBAR" %}}
{{% blocks/products/pf/agp/text %}}
