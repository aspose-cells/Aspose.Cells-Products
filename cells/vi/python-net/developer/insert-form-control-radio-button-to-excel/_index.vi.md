...
weight: 60
description: Python via Mã nguồn .Net chèn RadioButton(Form control) vào Excel.
...
{{% blocks/products/pf/agp/content h2="Cách chèn RadioButton(Form control) vào tệp Excel bằng Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn RadioButton(Form control) vào file Excel sử dụng Python via .Net" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng phần bổ sung của bộ sưu tập hình dạng[phương pháp](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) để chèn RadioButton(Điều khiển biểu mẫu) vào bảng tính đã chọn.
