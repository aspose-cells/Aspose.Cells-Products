...
{{% blocks/products/pf/agp/feature-section-col title="حماية XLSX عبر C#" %}}
...
1. إنشاء فئة المصنف بمسار إلى ملف XLSX1. احصل على ورقة العمل الافتراضية أو أي ورقة عمل لإضافة الحماية1. حماية ورقة العمل باستخدام طريقة Worksheet.Protect1. حماية المصنف باستخدام طريقة Workbook.Protect1. حفظ النتيجة بتنسيق XLSX
