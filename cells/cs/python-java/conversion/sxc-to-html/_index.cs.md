---
title: Převést SXC na HTML pomocí Python
url: /cs/python-java/conversion/sxc-to-html/
description: Ukázkový kód pro převod sxc na html Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na html v aplikaci Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SXC na HTML pomocí Python" h2="Exportujte tabulky Excel® do formátu HTML pomocí rozhraní API Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC do HTML pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na HTML prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC do HTML pomocí několika řádků kódu.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC do HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="html" IsLandingPage="true" language="python" %}}
