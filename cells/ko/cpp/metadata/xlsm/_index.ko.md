---
title:  C++을 통해 XLSM 문서 메타데이터 편집 또는 보기
weight: 1300
description: C++ C++ 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경에서 XLSM 파일 메타데이터를 편집하거나 보기 위한 C++ 예제 코드입니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C++을 통해 XLSM 메타데이터 추출" h2="서버 측 API를 사용하여 XLSM 파일에서 메타데이터를 추가, 편집, 제거 또는 추출하려면 자체 C++ 앱을 빌드하세요." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="C++을 사용하여 XLSM 메타데이터를 얻는 방법" %}}

XLSM 메타데이터를 추출하기 위해 다음을 사용합니다.
...
+ WorkbookMetadata를 사용하여 XLSM 파일 로드
...
{{% blocks/products/pf/agp/code-block title="XLSM - C++의 메타데이터 추출" offSpacer="" %}}
