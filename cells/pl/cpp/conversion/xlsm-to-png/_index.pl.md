---
title: Konwertuj XLSM na PNG za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlsm-to-png/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSM do formatu PNG. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSM do PNG w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSM na PNG za pomocą C++" h2="Wysoce wydajna konwersja plików XLSM do PNG przy użyciu biblioteki C++ bez konieczności instalowania programu Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSM na PNG za pomocą C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSM na PNG za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLSM na PNG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSM przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (PNG).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik PNG w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSM do PNG C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją XLSM do PNG" sectionDescription="[Konwertuj XLSM na PNG](https://products.aspose.app/cells/conversion/xlsm-to-png) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLSM, zostanie on natychmiast przekonwertowany do formatu PNG." >}}
