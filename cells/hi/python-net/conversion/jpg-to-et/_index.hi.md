---
title: Python जेपीजी से ईटी - जेपीजी से ईटी कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ जेपीजी को ईटी में जल्दी और आसानी से बदलें। Python जेपीजी से ईटी में। Python जेपीजी को ईटी में सहेजें। Python का उपयोग करके JPG को ET के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="Python पर JPG को ET में सेव करें" %}}
...
{{% cells-convert title="JPG को ET में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="et" IsLandingPage="true" language="pythonnet" %}}
