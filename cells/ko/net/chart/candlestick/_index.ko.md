...
OHLC(시가-고가-저가-종가) 차트는 카테고리, 시가, 고가, 저가, 종가의 5개 데이터 열을 순서대로 사용합니다. 각 카테고리의 가격 범위는 다시 수직선으로 표시되며, 시가와 종가 사이의 범위는 더 넓은 부동 막대로 표시됩니다. 해당 범주의 가격이 상승하면(종가가 시가보다 높음) 막대가 한 가지 색상으로 채워지고, 가격이 하락하면 막대가 다른 색상으로 채워집니다. 이러한 유형의 차트를 흔히 캔들스틱 차트라고 합니다.
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 캔들스틱(시가-고가-저가-종가) 차트를 만드는 방법" %}}

{{% blocks/products/pf/agp/text %}}

개발자는 단 몇 줄의 코드만으로 데이터 처리를 위해 다양한 보고 애플리케이션을 실행하면서 촛대 차트를 쉽게 만들 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. 클래스 파일에 네임스페이스를 포함합니다.
1.  만들다[**학습장**](https://reference.aspose.com/cells/net/aspose.cells/workbook) 클래스 인스턴스[샘플 엑셀 파일](Open-High-Low-Close.xlsx).
1.  을 추가하다[**시가-고가-저가-종가 주식**](https://reference.aspose.com/cells/net/aspose.cells.charts/charttype) 호출하여 워크시트에 차트를 추가합니다.[**차트**](https://reference.aspose.com/cells/net/aspose.cells.charts/chartcollection) 컬렉션의[**추가하다**](https://reference.aspose.com/cells/net/aspose.cells.charts/chartcollection/methods/add) 메서드에 캡슐화되어 있습니다.[**워크시트**](https://reference.aspose.com/cells/net/aspose.cells/worksheet)물체.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="다음 소스 코드는 C#을 사용하여 MS Excel XLSX 파일에 캔들스틱(시가-고가-저가-종가) 차트를 생성하는 방법을 보여줍니다." offSpacer="" %}}
