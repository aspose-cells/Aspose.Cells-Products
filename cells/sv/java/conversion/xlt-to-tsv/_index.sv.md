---
title: Konvertera XLT till TSV via Java 
weight: 8690
url: /sv/java/conversion/xlt-to-tsv/ 
description: Exempel Java-konverteringskod för XLT-format till TSV-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till TSV inom alla webb- eller skrivbordsbaserade Javaapplikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLT till TSV med Java" %}}

 För att rendera XLT till TSV kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLT till TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLT-fil till TSV på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLT-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med TSV-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande TSV-filen
...
{{% blocks/products/pf/agp/code-block title="XLT till TSV Java omvandlingskällkod" offSpacer="" %}}
