...
{{% blocks/products/pf/agp/content h2="如何使用 Python via .Net 将星形/横幅插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via .Net 将星形/横幅插入 Excel 文件的步骤" %}}
...
+ 通过索引选择工作表。
 使用形状集合的添加[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)在选定的工作表中插入星形/横幅。
以 XLSX 格式保存工作簿。
...
下面的示例代码演示了如何插入“丝带：弯曲和向上倾斜”和“爆炸：8 点”。更多类型请参阅下面的“星星和横幅类型概述”。

{{% blocks/products/pf/agp/code-block title="插入星形/横幅 - Python via .Net" offSpacer="" %}}
