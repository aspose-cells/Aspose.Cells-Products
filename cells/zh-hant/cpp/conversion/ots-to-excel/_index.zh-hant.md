---
title: C++ OTS 轉 EXCEL - OTS 轉 EXCEL 轉換器
description: Aspose Excel。此綜合解決方案為 C++ 開發人員提供了一種完全整合的方法，可將 OTS 轉換為 EXCEL 格式，從而能夠使用 Aspose.Cells 庫將 OTS 資料無縫保存為 EXCEL 格式，所有這些都透過高效且可自訂的 C++ 程式碼實現。
...
{{% blocks/products/pf/agp/content h2="將 OTS 儲存到 EXCEL（C++）" %}}

以下範例示範如何在 C++ 中將 OTS 轉換為 EXCEL。
...
{{% blocks/products/pf/agp/content h2="如何將 OTS 轉換為 EXCEL 通過 C++" %}}

{{% blocks/products/pf/agp/text %}}

需要透過程式將 OTS 檔案轉換為 EXCEL 檔案嗎？ C++ 開發人員只需幾行程式碼即可輕鬆將 OTS 檔案轉換為 EXCEL 檔案。
...
1. 使用工作簿載入OTS檔案。
1. 透過呼叫 Save() 方法將 OTS 轉換為 EXCEL。
1. 取得OTS到EXCEL的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ 庫用於將 OTS 轉換為 EXCEL" %}}
