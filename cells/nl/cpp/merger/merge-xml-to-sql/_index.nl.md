...
url: /nl/cpp/merger/merge-xml-to-sql/ 
...
Het volgende voorbeeld laat zien hoe u XML kunt samenvoegen met SQL in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XML programmatisch samenvoegen met SQL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om XML samen te voegen met SQL" %}}
