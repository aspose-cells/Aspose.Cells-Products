---
title:  Insérer un tableau croisé dynamique dans les fichiers Microsoft Excel XLSM via C#
weight: 7690
description: C# Exemple de code pour ajouter un tableau croisé dynamique à XLSM à l'aide de la bibliothèque .NET. Utilisez ce code pour insérer un tableau croisé dynamique dans le fichier XLSM dans VB.NET, Asp.NET ou toute application basée sur .NET.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insérer un tableau croisé dynamique dans les documents XLSM via C#" h2="Feuille de calcul Excel XLSM native et hautes performances avec création de tableau croisé dynamique par programme à l\'aide des API .NET côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Il est facile de générer dynamiquement un fichier MS Excel XLSM avec un tableau croisé dynamique dans l'application en cours d'exécution. Afin de créer des documents XLSM avec un tableau croisé dynamique à partir de zéro sans nécessiter MS Office, nous utiliserons[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API qui offre différentes fonctionnalités pour la création, la manipulation et la conversion de feuilles de calcul à l'aide de la plateforme .NET. Les développeurs peuvent facilement améliorer le code pour écrire des données, générer des tableaux ou des graphiques ainsi que créer des tableaux dans des feuilles de calcul.
{{% /blocks/products/pf/agp/content %}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Comment insérer un tableau croisé dynamique dans XLSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs d'insérer un tableau croisé dynamique au format XLSM dans une feuille de calcul exécutant différentes applications de reporting pour le traitement des données en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Insérer un tableau croisé dynamique dans XLSM - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/pivottable/insert-pivottable-to-xls/" name="XLS" description="Microsoft Feuille de calcul Excel (ancienne version)" >}} 
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/pivottable/insert-pivottable-to-xlsx/" name="XLSX" description="Classeur XML ouvert" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/pivottable/insert-pivottable-to-xlsb/" name="XLSB" description="Classeur binaire Excel" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/pivottable/insert-pivottable-to-xlsm/" name="XLSM" description="Feuille de calcul prenant en charge les macros" >}} 
