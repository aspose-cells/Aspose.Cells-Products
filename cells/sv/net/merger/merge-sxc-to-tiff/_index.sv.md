---
title: Slå samman SXC till TIFF - Kombinera SXC till TIFF i C#
url: /sv/net/merger/merge-sxc-to-tiff/ 
description: Aspose Excel. C# Aspose.Cells. Slå samman SXC till TIFF sparaformat. C# Kombinera SXC till TIFF format. Slå samman SXC till TIFF i C#. SXC Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman SXC till TIFF i C#" %}}

Följande exempel visar hur man slår samman SXC till TIFF i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman SXC till TIFF. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen TIFF. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman SXC till TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exempelkod för att slå samman SXC till TIFF i C#" InputFormat="sxc" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman SXC till TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman SXC till TIFF programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman SXC till TIFF" %}}
