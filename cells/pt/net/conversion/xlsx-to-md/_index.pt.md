---
title: C# XLSX para MD - Conversor XLSX para MD
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato MD, permitindo o salvamento perfeito de dados XLSX no formato MD usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX para MD em C#" %}}

O exemplo a seguir demonstra como converter XLSX para MD em C#.
{{% blocks/products/pf/agp/text %}}

Siga os passos simples para converter o arquivo XLSX para MD. Carregue o seu arquivo XLSX e salve-o como um arquivo MD. Tanto para leitura do arquivo XLSX quanto para gravação do arquivo MD, você pode usar nomes de arquivo totalmente qualificados. O conteúdo e a formatação do arquivo MD resultante serão idênticos ao documento original XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter XLSX em MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para MD através de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para MD programaticamente? Desenvolvedores que trabalham com .NET podem facilmente carregar e converter arquivos XLSX para MD com apenas algumas linhas de código.
...
1.  Converta XLSX para MD chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em MD" %}}
