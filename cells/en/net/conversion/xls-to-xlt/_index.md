---
title: C# XLS to XLT - XLS to XLT Converter
description: Aspose Excel. C# Aspose.Cells. XLS to XLT in C#. C# Convert XLS to XLT saveformat. C# XLS to XLT format. Save XLS to XLT C#.
keywords: [Aspose Excel., C# Aspose.Cells., XLS to XLT in C#., C# XLS to XLT saveformat., XLS to XLT C#., C# Convert XLS to XLT]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLS to XLT in C#" h2="High-speed C# library for converting XLS to XLT. This is a professional software solution to import and export XLS, XLT, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Save XLS to XLT in C#" %}}
...
{{% cells-convert title="Sample Code to Convert XLS to XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLS to XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert XLS files to XLT programmatically? .NET developers can easily load & convert XLS to XLT in just a few lines of code.
