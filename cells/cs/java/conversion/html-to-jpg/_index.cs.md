...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu HTML do formátu JPG, což umožňuje bezproblémové ukládání dat HTML do formátu JPG pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{% blocks/products/pf/agp/content h2="Převést HTML na JPG pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit HTML do JPG v Java" %}}

Následující příklad ukazuje, jak převést soubor HTML na JPG v souboru Java.
...
Potřebujete programově převést soubory HTML do formátu JPG? Vývojáři Java mohou snadno převést soubory HTML do formátu JPG pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod souboru HTML do formátu JPG" %}}
{{% blocks/products/pf/agp/text %}}
