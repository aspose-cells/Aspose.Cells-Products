---
title: Visualize Formatos de Arquivo ODS via .NET 
weight: 130

description: C# código-fonte para carregar, renderizar e exibir documentos ODS em plataformas .NET Framework, .NET Core, Mono ou Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Visualizador de arquivos ODS for .NET" h2="Visualize planilhas do Excel e do OpenOffice, como ODS, sem precisar do Microsoft Excel ou do Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells facilita para os desenvolvedores a visualização do arquivo ODS com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo ODS em uma instância da pasta de trabalho1. Crie uma instância de HtmlSaveOptions e defina a propriedade ExportHeadings como true1. Salve o arquivo ODS no formato HTML usando o método Workbook.Save1. Carregar HTML resultante no navegador padrão com Process.Start
...
// salve o arquivo ODS no formato HTML
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos do Microsoft Excel para diferentes formatos. Além disso, ele pode ser usado para gráficos abrangentes, relatórios escaláveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API autônomo e não requer nenhum software como Microsoft ou OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para visualizar ODS" sectionDescription="Confira nossas demonstrações ao vivo para [Ver ODS](https://products.aspose.app/cells/viewer/ods) com os seguintes benefícios." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do arquivo ODS e clicar no botão \"Visualizar\"" >}}
