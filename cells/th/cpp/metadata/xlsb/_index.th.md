---
title:  แก้ไขหรือดู XLSB เอกสาร Metadata ทาง C++
weight: 4820
description: โค้ดตัวอย่าง C++ เพื่อแก้ไขหรือดูข้อมูลเมตาของไฟล์ XLSB บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิตและ Linux 64 บิต
...
เพื่อแยกข้อมูลเมตา XLSB เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแยก Metadata ของ XLSB ผ่าน C++" %}}
...
+ โหลดไฟล์ XLSB โดยใช้ WorkbookMetadata
