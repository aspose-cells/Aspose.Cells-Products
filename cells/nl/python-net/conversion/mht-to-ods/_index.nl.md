...
{{% blocks/products/pf/agp/content h2="Converteer MHT naar ODS in Python" %}}
...
Het volgende voorbeeld laat zien hoe u MHT converteert naar ODS in Python via NET.
