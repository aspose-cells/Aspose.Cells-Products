...
<div class="container-fluid features-section bg-gray">
 ...
 نوع الشكل التلقائي::<br>AutoShapeType_RectangularCallout
    </p>
   </div>
   <div class="col-lg-4">
 ...
 نوع الشكل التلقائي::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 نوع الشكل التلقائي::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar3
    </p>
   </div>
  </div>
 </div>
