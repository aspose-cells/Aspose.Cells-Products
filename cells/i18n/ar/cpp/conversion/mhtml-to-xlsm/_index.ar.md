---
title: تحويل MHTML إلى XLSM عبر تطبيق C++ 
weight: 6120
url: /ar/cpp/conversion/mhtml-to-xlsm/ 
description: نموذج لشفرة تحويل C++ لمستند MHTML إلى تنسيق XLSM. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل MHTML إلى XLSM دفعة داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHTML إلى XLSM عبر C++" h2="تحويل MHTML إلى XLSM عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MHTML إلى XLSM باستخدام C++" %}}
 ...
 من أجل تحويل MHTML إلى XLSM ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف MHTML إلى XLSM في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف MHTML باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLSM).1. سيتم حفظ ملف XLSM في المسار المحدد.1. افتح ملف XLSM في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="MHTML إلى XLSM C++ شفرة مصدر التحويل" offSpacer="" %}}
