...
description: Aspose 엑셀. Aspose.Cells을 사용하여 XLSM을 XML로 빠르고 쉽게 변환하세요. Python XLSM을 XML로. Python XLSM을 XML에 저장합니다. Python을 사용하여 XLSM을 XML로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="Python에서 XLSM을 XML로 변환" %}}
...
{{% blocks/products/pf/agp/content h2="XLSM을 Python의 XML로 저장합니다." %}}

다음 예에서는 Python via NET에서 XLSM을 XML로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="XLSM을 XML로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xml" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python XLSM을 XML로 변환하는 라이브러리" %}}
