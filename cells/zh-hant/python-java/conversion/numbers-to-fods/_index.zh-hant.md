---
title: Python 數字到 FODS - 數字到 FODS 轉換器
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 NUMBERS 轉換為 FODS 格式，從而能夠使用 Aspose.Cells 庫將 NUMBERS 資料無縫保存為 FODS 格式，所有這些程式碼都透過高效且可客製化且可自訂 1538153 1538153 153。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Python Excel 庫中將 NUMBERS 轉換為 FODS" h2="高速Python excel庫，用於將數字轉換為FODS。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將數字轉換為 FODS" %}}

如何將 NUMBERS 轉換為 FODS？借助 Aspose.Cells for Python 庫，您可以透過幾行程式碼以程式設計方式輕鬆將 NUMBERS 轉換為 FODS。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將數字儲存到 Python Excel 庫中的 FODS" %}}

以下範例示範如何將 Python excel 庫中的 NUMBERS 轉換為 FODS。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 NUMBERS 轉換為 FODS。對於 NUMBERS 讀取和 FODS 寫入，您可以使用完全限定的檔案名稱。輸出 FODS 內容和格式將與原始 NUMBERS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="透過 Python Excel 庫將數字轉換為 FODS 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="fods" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python 將數字轉換為 FODS" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 NUMBERS 檔案轉換為 FODS？ Python 開發人員只需幾行程式碼即可輕鬆載入 NUMBERS 並將其轉換為 FODS。
...
1. 透過呼叫 Workbook.save 方法將 NUMBERS 轉換為 FODS。
1. 取得NUMBERS到FODS的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel 庫將數字轉換為 FODS" %}}
