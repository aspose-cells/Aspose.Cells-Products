...
description: Sample C++ conversion code for JSON document to EMF format. Programmers can use this source code for batch JSON to EMF conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="JSON to EMF C++ Conversion Source Code" offSpacer="" %}}
