---
title:  MHTML を C++ 経由で HTM にマージします
url: /ja/cpp/merger/merge-mhtml-to-htm/ 
description: MHTML を HTM オンラインに無料でマージします。 HTM Merger への無料オンライン MHTML。 MHTML を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
{{% blocks/products/pf/agp/content h2="MHTML をオンラインで無料で C++ の HTM にマージします" %}}

次の例は、MHTML を C++ の HTM にマージする方法を示しています。
...
{{% cells-merger title="MHTMLをオンラインでHTMにマージする無料アプリ" InputFormat="mhtml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
