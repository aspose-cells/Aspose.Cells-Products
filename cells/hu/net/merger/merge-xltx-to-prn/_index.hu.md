---
title: A XLTX egyesítése PRN-nel - A XLTX-es szám egyesítése PRN-vel a C#-ben
url: /hu/net/merger/merge-xltx-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. A XLTX egyesítése PRN mentési formátumba. C# Kombinálja a XLTX-et PRN formátumba. Egyesítse a XLTX-et a PRN-vel a C#-es számon. XLTX Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a XLTX-es számot a PRN-vel a C#-ben" %}}

következő példa bemutatja, hogyan egyesítheti a XLTX-et a PRN-vel a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLTX és a PRN egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el PRN fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a XLTX-et a PRN-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a XLTX és a PRN egyesítéséhez a C#-ben" InputFormat="xltx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLTX és a PRN egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLTX-et a PRN-nel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLTX és a PRN egyesítéséhez" %}}
