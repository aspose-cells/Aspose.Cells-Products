---
title:  Tìm kiếm và thay thế văn bản trong tài liệu XLSB via Java
weight: 4590
...
{{< blocks/products/pf/i18n/upper-banner h1="Viết lại XLSB Định dạng trong Java" h2="Bản gốc và hiệu suất cao XLSB ghi lại thông tin biên tập nhạy cảm bằng cách sử dụng API Aspose.Cells for Java phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cách xác định lại tệp XLSB bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để xác định lại tệp XLSB trong Java" %}}
