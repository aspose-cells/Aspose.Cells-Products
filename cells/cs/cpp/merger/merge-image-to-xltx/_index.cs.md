...
url: /cs/cpp/merger/merge-image-to-xltx/ 
...
Následující příklad ukazuje, jak sloučit IMAGE s XLTX v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit IMAGE s XLTX programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení IMAGE do XLTX" %}}
