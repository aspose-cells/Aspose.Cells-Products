...
description: Sample code for spreadsheetml to dif C# conversion. Use API example code for batch spreadsheetml files to dif conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert SPREADSHEETML to DIF Using C#" %}}
 ...
 In order to convert SPREADSHEETML to DIF, we will use
