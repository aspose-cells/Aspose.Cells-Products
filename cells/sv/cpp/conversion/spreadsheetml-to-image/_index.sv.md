...
description: Aspose Excel. Konvertera SPREADSHEETML till IMAGE snabbt och enkelt med Aspose.Cells. C++ SPREADSHEETML till IMAGE. C++ Spara Kalkylblad till IMAGE. Spara SPREADSHEETML som BILD med C++.
...
{{% blocks/products/pf/agp/content h2="Konvertera SPREADSHEETML till IMAGE med C++" %}}

 Hur konverterar jag SPREADSHEETML till IMAGE? Med Aspose.Cells for C++-biblioteket kan du enkelt konvertera SPREADSHEETML till IMAGE programmatiskt med några rader kod.[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) kan bygga plattformsoberoende applikationer med förmågan att generera, modifiera, konvertera, rendera och skriva ut alla Excel-filer. C++ Excel API konverterar inte bara mellan kalkylarksformat, den kan också rendera Excel-filer som bilder, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT och mer, vilket gör det till ett perfekt val att utbyta dokument i industristandardformat. Du kan ladda ner den senaste versionen direkt, bara öppna[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/) pakethanteraren, sök efter Aspose.Cells.Cpp och installera. Du kan också använda följande kommando från Package Manager Console.
...
{{% blocks/products/pf/agp/content h2="Spara SPREADSHEETML till IMAGE på C++" %}}

Följande exempel visar hur man konverterar SPREADSHEETML till IMAGE i C++.
...
{{% cells-convert title="Exempelkod för att konvertera SPREADSHEETML till IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="png" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar SPREADSHEETML till IMAGE via C++" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera SPREADSHEETML-filer till IMAGE programmatiskt? C++-utvecklare kan enkelt konvertera SPREADSHEETML till IMAGE på bara några rader kod.
...
1.  Konvertera SPREADSHEETML till IMAGE genom att anropa metoden Save().
1.  Få konverteringsresultatet från SPREADSHEETML till IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ bibliotek för att konvertera Kalkylblad till IMAGE" %}}
