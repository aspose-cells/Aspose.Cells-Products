---
title:  Rozdělit XLSM Soubory via .NET
weight: 8890
description: C# zdrojový kód pro rozdělení XLSM dokumentů na platformách .NET, .NET Core, Mono nebo Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Rozdělit XLSM Formáty v C#" h2="Nativní a vysoce výkonný rozbočovač XLSM využívající rozhraní API na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/code-block title="Rozdělit XLSM Soubor - C#" offSpacer="" %}}
