---
title: Java HTM 到 SQL - 在線 HTM 到 SQL 轉換器
description: Aspose Excel。 Java Aspose.Cells. Java Aspose Cells. 免費在線 Java 將 HTM 轉換為 SQL 保存格式。 Java HTM 轉 SQL 格式。將 HTM 保存到 SQL Java。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Java 中的 HTM 轉換為 SQL" h2="用於將 HTM 轉換為 SQL 的高速 Java 庫。這是一個使用 Java 導入和導出 HTM、SQL 和許多其他格式的專業軟件解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Java 將 HTM 轉換為 SQL" %}}

如何將 HTM 轉換為 SQL？借助 Aspose.Cells for Java 庫，您可以通過幾行代碼以編程方式輕鬆將 HTM 轉換為 SQL。[Aspose.Cells for Java](https://products.aspose.com/cells/java)能夠構建跨平台應用程序，能夠生成、修改、轉換、渲染和打印所有 Excel 文件。 Java Excel API不僅可以在電子表格格式之間進行轉換，還可以將Excel文件渲染為圖像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，從而使其成為行業交換文檔的完美選擇-標準格式。您可以直接從以下位置下載其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)並通過將以下配置添加到 pom.xml 將其安裝在基於 Maven 的項目中。
...
{{% blocks/products/pf/agp/content h2="Java在線免費將HTM保存為SQL" %}}

以下示例演示瞭如何將 Java 中的 HTM 轉換為 SQL。
...
{{% cells-convert title="將 HTM 在線轉換為 SQL 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="sql" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 HTM 轉換為 SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 HTM 文件轉換為 SQL？ Java 開發人員只需幾行代碼即可輕鬆將 HTM 轉換為 SQL。
...
{{% blocks/products/pf/agp/content h2="Java 將 HTM 轉換為 SQL 的庫" %}}
{{% blocks/products/pf/agp/text %}}
