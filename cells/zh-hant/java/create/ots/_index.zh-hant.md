---
title: 創建OTS - 在Java中創建OTS文件
description: Aspose Excel。 Java 創建 OTS 文件。創建 OTS Java。Java OTS 創建者。在Java中創建OTS。使用Java生成OTS文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建OTS" %}}
...
1. 使用 save() 方法將工作簿保存為 OTS 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 OTS 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建OTS文件" %}}
{{% blocks/products/pf/agp/text %}}
