...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení dvojité přímé šipky do souboru Excel pomocí Python via java" %}}
...
{{% blocks/products/pf/agp/code-block title="Vložte dvojitou rovnou šipku - Python via java" offSpacer="" %}}
