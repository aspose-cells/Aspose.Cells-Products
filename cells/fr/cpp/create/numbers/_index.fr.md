---
title: Créer des NUMÉROS - Créer un fichier NUMÉROS dans C++
description:  Aspose Exceller. C++ Créez un fichier NUMBERS rapidement et facilement avec Aspose.Cells. Générez un fichier NUMBERS en utilisant C++. Créez des NUMBERS dans C++. C++ NUMBERS Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier NUMBERS dans C++" h2="Création de fichiers NUMBERS natifs et hautes performances par programme sans Microsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer des numéros dans C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers NUMBERS dans des applications de reporting en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
1.  Enregistrez le classeur en tant que fichier .numbers à l’aide de la méthode Save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier NUMBERS dans C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour créer un fichier NUMBERS" %}}
