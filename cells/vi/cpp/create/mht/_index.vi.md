---
title: Tạo MHT - Tạo file MHT số C++
description: Aspose Excel. Dễ dàng tạo và thao tác các tệp MHT với thư viện Aspose.Cells for C++. Thư viện mạnh mẽ API này cung cấp một giải pháp hợp lý và hiệu quả để tạo, chỉnh sửa và quản lý các tệp MHT trực tiếp trong ứng dụng C++ của bạn, đáp ứng các nhu cầu cụ thể của nhà phát triển với độ chính xác cao.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tạo tệp MHT trong C++" h2="Tạo tệp MHT gốc và hiệu suất cao bằng lập trình mà không cần Microsoft Office bằng cách sử dụng thư viện C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hướng dẫn tạo MHT trong C++" %}}

{{% blocks/products/pf/agp/text %}}

 Với vài dòng mã, các nhà phát triển có thể dễ dàng tạo, tải, chỉnh sửa và chuyển đổi các tệp MHT trong các ứng dụng báo cáo đang chạy để xử lý dữ liệu.
...
1.  Lưu tập tin làm việc dưới dạng tệp .mht bằng phương thức Save().

{{% blocks/products/pf/agp/code-block title="Đoạn mã mẫu minh họa cách tạo tệp MHT trong C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ để tạo tệp MHT" %}}
