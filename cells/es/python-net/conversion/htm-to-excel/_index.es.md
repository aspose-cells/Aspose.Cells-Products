...
description: Aspose Excel. Convierta HTM a EXCEL rápida y fácilmente con Aspose.Cells. Python HTM a EXCEL. Python Guardar HTM en EXCEL. Guarde HTM como EXCEL usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar HTM en EXCEL en Python" %}}

El siguiente ejemplo demuestra cómo convertir HTM a EXCEL en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir HTM a EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir HTM a EXCEL" %}}
