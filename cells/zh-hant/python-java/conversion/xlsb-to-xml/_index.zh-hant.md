---
title: 將 XLSB 轉換為 XML Python via Python
description: 免費將 XLSB 轉換為 XML。免費在線 XLSB 到 XML 轉換器。 Python XLSB 到 XML。 XLSB 通過 Python 到 XML。
...
如何將 XLSB 轉換為 XML？使用 Aspose.Cells for Python 庫，您可以使用幾行代碼以編程方式輕鬆地將 XLSB 轉換為 XML。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能夠構建跨平台應用程序，能夠生成、修改、轉換、呈現和打印所有 Excel 文件。 Python Excel API 不僅可以在電子表格格式之間相互轉換，還可以將Excel文件渲染為圖片，PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等，是行業文檔交換的完美選擇-標準格式。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="免費在線將 XLSB 保存到 Python 中的 XML" %}}

以下示例演示如何將 XLSB 轉換為 Python 中的 XML。
...
{{% cells-convert title="將 XLSB 在線轉換為 XML 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xml" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通過 Python 將 XLSB 轉換為 XML" %}}

{{% blocks/products/pf/agp/text %}}

Python 開發人員只需幾行代碼即可輕鬆加載 XLSB 並將其轉換為 XML。

{{% /blocks/products/pf/agp/text %}}

1. 使用工作簿實例加載 XLSB 文件
1. 通過調用 Workbook.save 方法將 XLSB 轉換為 XML

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python 將 XLSB 轉換為 XML 的庫" %}}
