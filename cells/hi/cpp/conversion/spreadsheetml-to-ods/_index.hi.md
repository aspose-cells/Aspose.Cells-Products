---
title: C++ स्प्रेडशीटएमएल से ODS - स्प्रेडशीटएमएल से ODS कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ Aspose.Cells के साथ ODS को जल्दी और आसानी से कन्वर्ट करें।
...
{{% blocks/products/pf/agp/content h2="C++ में स्प्रेडशीटएमएल को ODS पर सेव करें" %}}
...
{{% cells-convert title="स्प्रेडशीटएमएल को ODS में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="ods" IsLandingPage="true" language="cpp" %}}
