---
title: Convertidor PHP MHTML a XLS - MHTML a XLS
description: Aspose Excel. Convierta MHTML a XLS rápida y fácilmente con Aspose.Cells. PHP MHTML a XLS. PHP Guarde MHTML a XLS. Guarde MHTML como XLS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MHTML a XLS mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos MHTML a XLS mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente MHTML a XLS en tan solo unas pocas líneas de código.
...
1.  Convierta MHTML a XLS llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de MHTML a XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir MHTML a XLS" %}}
