...
url: /fr/python-java/merger/merge-mht-to-xlsb/ 
...
L'exemple suivant montre comment fusionner MHT avec XLSB dans Aspose.Cells for Python via Java.
...
Besoin de fusionner MHT avec XLSB par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
