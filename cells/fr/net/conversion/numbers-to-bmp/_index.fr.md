---
title: C# NOMBRES en BMP - Convertisseur NOMBRES en BMP
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les NUMBERS au format BMP, permettant un enregistrement transparent des données NUMBERS au format BMP à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros BMP dans C#" %}}

L'exemple suivant montre comment convertir les NOMBRES de BMP en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en BMP par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en BMP en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en BMP en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en BMP" %}}
