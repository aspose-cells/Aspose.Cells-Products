...
description: Aspose Эксель. Python Aspose.Cells. Объедините HTML и BMP в формате сохранения. Python Объедините форматы HTML и BMP. Объедините HTML и BMP в Python. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML с BMP, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и BMP в Python." %}}

В следующем примере показано, как объединить HTML и BMP в Aspose.Cells for Python via Java.
