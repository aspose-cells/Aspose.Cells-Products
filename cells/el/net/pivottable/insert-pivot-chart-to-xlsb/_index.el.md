...
weight: 7690
description: C# Δείγμα κωδικού για τη δημιουργία εγγράφων XLSB με γράφημα περιστροφής. Χρησιμοποιήστε αυτόν τον κώδικα για τη δημιουργία αρχείων Micorsoft Excel XLSB με γράφημα περιστροφής εντός των VB.NET, Asp.NET ή οποιασδήποτε εφαρμογής που βασίζεται στο .NET.
---
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Η δυναμική δημιουργία αρχείου MS Excel XLSB με το Pivot Chart εντός της εκτελούμενης εφαρμογής είναι εύκολη. Για να δημιουργήσουμε XLSB έγγραφα με το Pivot Chart από την αρχή χωρίς να απαιτείται MS Office, θα χρησιμοποιήσουμε
