...
{{< blocks/products/pf/i18n/upper-banner h1="将 FODS 转换为 XML，在 C# 中。" h2="高速库 C# 用于将 FODS 转换为 XML。这是一个专业的软件解决方案，可在 .NET Framework、.NET Core 或 Mono 平台上导入和导出 FODS、XML 和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% cells-convert title="将 FODS 转换为 XML 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 FODS 转换为 XML" %}}

{{% blocks/products/pf/agp/text %}}

是否需要以编程方式将 FODS 文件转换为 XML？.NET 开发人员只需几行代码即可轻松加载 FODS 并将其转换为 XML。
...
1. 向您的 C# 项目添加库引用（导入库）。
1. 使用工作簿实例加载 FODS 文件。
1. 调用 Workbook.Save 方法将 FODS 转换为 XML。
1. 获取FODS到XML的转换结果。
