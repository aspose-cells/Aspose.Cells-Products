...
{{% blocks/products/pf/agp/content h2="Πώς να χωρίσετε το αρχείο XLSB χρησιμοποιώντας το Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τον διαχωρισμό αρχείων XLSB στο Java" %}}
...
+ Καλέστε τη μέθοδο αποθήκευσης με νέα διαδρομή αρχείου XLSB.
...
{{% blocks/products/pf/agp/code-block title="Διαχωρισμός αρχείου XLSB - Java" offSpacer="" %}}
