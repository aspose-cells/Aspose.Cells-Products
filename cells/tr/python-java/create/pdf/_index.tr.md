...
1. Asposecell'leri kod dosyanıza aktarın.1. Workbook sınıfı örneği oluşturun.1. Çalışma kitabının ilk çalışma sayfasına erişin.1. Çalışma sayfasının istediğiniz hücresini/hücrelerini alın ve değeri hücreye/hücrelere girin.1. Çalışma kitabını PDF dosyası olarak kaydetmek için Kaydet yöntemini kullanın.
...
{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kodu, Python kullanarak bir PDF dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
