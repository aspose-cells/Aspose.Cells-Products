...
weight: 7880
description: Java voorbeeldcode om XLSB documenten te splitsen op Java Runtime Environment voor JSP/JSF-applicatie en desktopapplicaties.
---
...
{{% blocks/products/pf/agp/content h2="Hoe XLSB-bestanden te splitsen met behulp van Java" %}}
...
+ Roep de opslagmethode aan met het nieuwe bestandspad XLSB.
...
{{% blocks/products/pf/agp/code-block title="Split XLSB Bestand - Java" offSpacer="" %}}
