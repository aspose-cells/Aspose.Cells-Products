---
title: Convert XLSX to XLSM via C#
url: /net/conversion/xlsx-to-xlsm/
description: Sample code for xlsx to xlsm C# conversion. Use API example code for batch xlsx files to xlsm conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% cells-convert title="Free App and Sample Code to Convert XLSX to XLSM" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx InputFormat=xlsx outformat=xlsm IsLandingPage=true %}}
