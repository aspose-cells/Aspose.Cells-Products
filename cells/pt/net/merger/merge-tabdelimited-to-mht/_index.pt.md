---
title: Mesclar TABDELIMITED para MHT - Combinar TABDELIMITED para MHT em C#
url: /pt/net/merger/merge-tabdelimited-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita TABDELIMITED para MHT saveformat. C# Combine TABDELIMITED para o formato MHT. Mesclar TABDELIMITED para MHT em C#. TABDELIMITED Mesclar.
...
exemplo a seguir demonstra como mesclar TABDELIMITED com MHT em Aspose.Cells for .NET.
...
{{% cells-merger title="Online grátis para mesclar TABDELIMITED para MHT em C#" InputFormat="tsv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar TABDELIMITED para MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar TABDELIMITED para MHT programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
