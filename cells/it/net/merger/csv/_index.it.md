---
title: Unisci file CSV tramite .NET 
weight: 6450
url: /it/net/merger/csv/ 
description: C# codice sorgente per combinare documenti CSV su piattaforme .NET Framework, .NET Core, Mono o Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci formati CSV in C#" h2="Fusione di documenti CSV nativi e ad alte prestazioni utilizzando API Aspose.Cells for .NET lato server, senza l\'uso di software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
+ Carica tutti i file CSV con il percorso completo.
+ Crea un documento come file di base
+ Chiama il metodo pertinente per concatenare e unire i file uno per uno.
+ Chiama il metodo Save() e passa il nome del file (percorso completo) e il formato (CSV) come parametro.
+ Ora puoi aprire e utilizzare il file CSV in Microsoft Office, Adobe PDF o qualsiasi altro programma compatibile.
