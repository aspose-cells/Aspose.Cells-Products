...
Hai bisogno di convertire i file PRN in HTML tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in HTML in poche righe di codice.
...
1.  Convertire PRN in HTML chiamando il metodo Save().
