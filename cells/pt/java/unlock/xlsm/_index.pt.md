---
title:  Desbloquear documento XLSM via Java
weight: 7700
description: Código de exemplo Java para desbloquear o arquivo XLSM protegido por senha no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
...
{{% blocks/products/pf/agp/content h2="Como remover a proteção do arquivo XLSM usando Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Desbloquear XLSM Arquivos via Java" offSpacer="" %}}
