...
{{% blocks/products/pf/agp/content h2="Save SXC to XLAM in C# Online for Free" %}}

The following example demonstrates how to convert SXC to XLAM document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert SXC file into XLAM format. Upload your SXC file, then simply save it as XLAM file. For both SXC reading and XLAM writing you can use fully qualified filenames. The output XLAM content and formatting will be identical to the original SXC document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert SXC to XLAM Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlam" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert SXC to XLAM via C#" %}}
...
1.  Convert SXC to XLAM by calling Workbook.Save method

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# library to convert SXC to XLAM" %}}
