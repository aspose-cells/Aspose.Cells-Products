---
title: Gabungkan MHTML ke MD - Gabungkan MHTML ke MD di Java
url: /id/java/merger/merge-mhtml-to-md/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan MHTML ke format simpan MD. Java Gabungkan MHTML ke format MD. Gabung MHTML menjadi MD di Java. MHTML Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHTML menjadi MD di Java" %}}

Contoh berikut menunjukkan cara menggabungkan MHTML ke MD di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan MHTML ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan MHTML ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan MHTML ke MD secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
