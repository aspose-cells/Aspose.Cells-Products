---
title: PHP HTML ～ XLT - HTML ～ XLT コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、HTML を XLT にすばやく簡単に変換します。PHP HTML から XLT。PHP HTML から XLT に保存します。PHP を使用して、HTML を XLT として保存します。
...
{{% cells-convert title="HTML を XLT に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlt" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP 経由で HTML を XLT に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで XLT に変換する必要がありますか? PHP 開発者は、わずか数行のコードで HTML を簡単にロードして XLT に変換できます。
