---
title: Konvertor PHP PNG až XPS - PNG až XPS
description: Aspose Excel. Převeďte PNG na XPS rychle a snadno pomocí Aspose.Cells. PHP PNG na XPS. PHP Uložte PNG na XPS. Uložte XPS jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na XPS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na XPS programově? Vývojáři PHP mohou snadno načíst a převést PNG na XPS v několika řádcích kódu.
...
1.  Převeďte PNG na XPS voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na XPS" %}}
