...
url: /cs/cpp/merger/merge-excel-to-xltm/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit EXCEL do XLTM saveformat. C++ Kombinujte EXCEL do formátu XLTM. Sloučit EXCEL na XLTM v C++. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL na XLTM v C++" %}}

Následující příklad ukazuje, jak sloučit EXCEL s XLTM v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení EXCELu s XLTM v C++" InputFormat="xlsx" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL s XLTM přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit EXCEL s XLTM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení EXCELu s XLTM" %}}
