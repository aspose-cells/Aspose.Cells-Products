...
Hai bisogno di convertire i file MHT in MHTML tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in MHTML in poche righe di codice.
...
1.  Convertire MHT in MHTML chiamando il metodo Save().
