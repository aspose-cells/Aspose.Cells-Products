...
description: Aspose Excel. Convierta FODS a OTS rápida y fácilmente con Aspose.Cells. Python FODS a OTS. Python Guardar FODS en OTS. Guarde FODS como OTS usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar FODS en OTS en Python" %}}

El siguiente ejemplo demuestra cómo convertir FODS a OTS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir FODS a OTS" %}}
