...
description: Aspose Excel. Converteer EXCEL snel en eenvoudig naar BMP met Aspose.Cells. Python EXCEL naar BMP. Python Bewaar EXCEL naar BMP. Sla EXCEL op als BMP met Python.
...
{{% blocks/products/pf/agp/content h2="Converteer Excel naar BMP in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar EXCEL op BMP in Python" %}}

Het volgende voorbeeld laat zien hoe u EXCEL converteert naar BMP in Python via NET.
...
{{% cells-convert title="Voorbeeldcode om EXCEL naar BMP te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="bmp" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om EXCEL naar BMP te converteren" %}}
