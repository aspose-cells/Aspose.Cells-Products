---
title: Crea EPUB - Crea file EPUB in C#
description: Aspose Excel. Genera e manipola senza sforzo file EPUB con la libreria Aspose.Cells for .NET. Questa potente libreria API offre una soluzione semplificata ed efficiente per creare, modificare e gestire file EPUB direttamente all'interno delle tue applicazioni C#, soddisfacendo le esigenze specifiche degli sviluppatori con elevata precisione.
...
{{% blocks/products/pf/agp/content h2="Come creare EPUB in C#" %}}
...
1.  Utilizzare il metodo Save per salvare la cartella di lavoro come file EPUB.

{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare un file EPUB in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria C# per creare file EPUB" %}}
