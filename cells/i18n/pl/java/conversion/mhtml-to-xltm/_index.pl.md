---
title: Konwertuj MHTML na XLTM przez Java 
weight: 1230
url: /pl/java/conversion/mhtml-to-xltm/ 
description: Przykładowy kod konwersji Java dla formatu MHTML do pliku XLTM. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do XLTM w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MHTML na XLTM przez Java" h2="Konwersja MHTML do XLTM Java w celu konwersji jednej lub wielu stron do formatu XLTM przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na XLTM za pomocą Java" %}}

 Aby wyrenderować MHTML do XLTM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MHTML na XLTM za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik MHTML na XLTM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik MHTML z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLTM i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLTM
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji MHTML do XLTM Java" offSpacer="" %}}

```cs
// załaduj plik MHTML w instancji Workbook
Workbook book = new Workbook("template.mhtml");
// zapisz MHTML jako XLTM
