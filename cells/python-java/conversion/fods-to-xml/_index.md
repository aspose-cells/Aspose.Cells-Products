...
url: /python-java/conversion/fods-to-xml/
description: Sample code for fods to xml Python conversion. Use API example code for batch fods files to xml conversion within Python application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert FODS to XML Using Python" %}}

 In order to convert FODS to XML, we will use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert FODS to XML via Python" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert FODS to XML" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx InputFormat=fods outformat=xml IsLandingPage=true language=python %}}
