...
description: Aspose Excel. Převeďte TSV na JPEG rychle a snadno pomocí Aspose.Cells. C++ TSV na JPEG. C++ Ušetřete TSV na 197 3481761 jako 197 348161 C++ 481 pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Uložit TSV až JPEG v C++" %}}

Následující příklad ukazuje, jak převést TSV na JPEG v C++.
...
Potřebujete převést soubory TSV na JPEG programově? Vývojáři C++ mohou snadno převést TSV na JPEG v několika řádcích kódu.
...
1.  Převeďte TSV na JPEG voláním metody Save().
