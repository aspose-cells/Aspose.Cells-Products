...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSM إلى XLSB باستخدام C++" %}}
 ...
 من أجل تحويل XLSM إلى XLSB ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف XLSM إلى XLSB في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLSM باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLSB).1. سيتم حفظ ملف XLSB في المسار المحدد.1. افتح ملف XLSB في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLSM إلى XLSB C++ شفرة مصدر التحويل" offSpacer="" %}}
