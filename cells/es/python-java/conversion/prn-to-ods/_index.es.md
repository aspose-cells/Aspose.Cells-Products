...
description: Aspose Excel. Convierta PRN a ODS rápida y fácilmente con Aspose.Cells. Python PRN a ODS. Python Guarde PRN en ODS. Guarde PRN como ODS usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PRN a ODS en Python" h2="Biblioteca Python de alta velocidad para convertir PRN a ODS. Esta es una solución de software profesional para importar y exportar PRN, ODS y muchos otros formatos utilizando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Guardar PRN al ODS en Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a ODS en Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir PRN a ODS" %}}
