...
{{% blocks/products/pf/agp/content h2="Sla FODS op in HTML in C++" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar HTML in C++.
...
Moet je bestanden met de extensie FODS programmatisch converteren naar HTML? Ontwikkelaars van C++ kunnen bestanden met de extensie FODS eenvoudig converteren naar HTML met slechts een paar regels code.
