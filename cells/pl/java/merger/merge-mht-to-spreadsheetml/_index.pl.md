---
title: Scal MHT z SPREADSHEETML - Połącz MHT z SPREADSHEETML w Java
url: /pl/java/merger/merge-mht-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Połącz MHT z formatem zapisu SPREADSHEETML. Java Połącz format MHT z formatem SPREADSHEETML. Scal MHT z SPREADSHEETML w Java. Scal MHT.
...
{{% blocks/products/pf/agp/content h2="Połącz MHT z SPREADSHEETML w Java" %}}

Poniższy przykład pokazuje, jak połączyć MHT z SPREADSHEETML w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć MHT z arkuszem kalkulacyjnym. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku SPREADSHEETML. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy MHT z SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod umożliwiający połączenie MHT z arkuszem kalkulacyjnym w Java" InputFormat="mht" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć MHT z arkuszem kalkulacyjnym via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć MHT z SPREADSHEETML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do łączenia MHT z SPREADSHEETML" %}}
