---
title: Python Excel电子表格 API - Aspose.Cells for Python via Java
weight: 2820
description: Aspose.Cells for Python via Java 库用于创建、修复、合并、解析和转换 Excel 文件。使用 Aspose.Cells for Python via Java API 将 Excel 文件转换为 PDF、JSON、HTML、TXT 和其他常用格式。
...
<p>
 Aspose.Cells for Python via Java 是一种快速可靠的 API，用于电子表格处理任务。开发人员可以创建简单或复杂的电子表格，操作以及从 excel 文件中提取信息。API 读取多种 excel 格式，并可以将工作表呈现为 XPS、PDF、MHTML、HTML、纯文本、图像等。它是使用 python 自动生成 excel 报告的最佳解决方案。
</p>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="Aspose.Cells for Python via Java 可供使用。" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Python excel 库支持流行的 Microsoft Excel 格式、固定布局格式和图像。" >}}
...
多种格式转换
    ...
    <p>
Python Excel 库提供将 Excel 文件转换为 PDF、XPS 和 HTML 格式的功能。API 的可靠转换使其成为需要以行业标准格式交换文件的公司的完美解决方案。
    </p>
...
灵活的显示选项
    ...
    <p>
 Aspose.Cells for Python via Java 提供对页面设置的完全控制，允许操作多个显示选项，如预览分页符、设置缩放级别、设置页面方向、使用冻结窗格控制数据可见性、纸张尺寸、缩放、页眉和页脚以及打印区域。
    </p>
   </div>
   <!--<div class="col-lg-12">
...
<p>Aspose.Cells for Android via Java API allows you to manipulate rows and columns in many different ways. You can easily adjust row height and column width, auto size the width & height of cells according to the contents, insert or delete, hide or show and group or ungroup rows & columns.</p>
 ...
 Excel 表格数据管理
    ...
    <p>
Aspose.Cells for Python via Java API 为工作表数据管理提供广泛的支持。用户可在运行时轻松操作工作表中的任何单元格，或将数据从各种数据源导入工作表。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/cells/pythonjava/" >}}
{{< blocks/products/pf/slr-element name="源代码" href="https://github.com/aspose-cells/Aspose.Cells-for-Java" >}}
{{< blocks/products/pf/slr-element name="Aspose.Cells API 参考文献" href="https://reference.aspose.com/cells/python-java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么是 Aspose.Cells for Python via Java？" tabId="success-stories" >}}
