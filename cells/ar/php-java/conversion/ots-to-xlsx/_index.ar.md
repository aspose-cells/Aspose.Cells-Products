---
title: PHP OTS إلى XLSX - OTS إلى XLSX محول
description: Aspose اكسل. قم بتحويل OTS إلى XLSX بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى XLSX. PHP احفظ OTS إلى XLSX. احفظ OTS كـ XLSX باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى XLSX في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى XLSX. هذا حل برمجي احترافي لاستيراد وتصدير OTS وXLSX والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ OTS إلى XLSX في PHP" %}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى XLSX عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى XLSX برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى XLSX في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى XLSX عن طريق استدعاء طريقة حفظ المصنف.
