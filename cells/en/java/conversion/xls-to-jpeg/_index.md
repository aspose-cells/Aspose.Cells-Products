...
{{% blocks/products/pf/agp/content h2="How to Convert XLS to JPEG Using Java" %}}

 In order to render XLS to JPEG, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLS to JPEG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert XLS file to JPEG in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="XLS to JPEG Java Conversion Source Code" offSpacer="" %}}
