...
description: Aspose Excel. Szybko i łatwo przekonwertuj numer XLSX na PRN za pomocą numeru Aspose.Cells. PHP XLSX na PRN. PHP Zapisz XLSX w PRN. Zapisz XLSX jako PRN, używając PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na PRN przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSX na PRN? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na PRN w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSX na PRN, wywołując metodę zapisu skoroszytu.
