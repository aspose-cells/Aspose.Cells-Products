---
title:  Sloučit MHT na HTML přes Python
url: /cs/python-java/merger/merge-mht-to-html/ 
description: Sloučit MHT na HTML Online zdarma. Bezplatné online spojení MHT na HTML. Sloučit MHT do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit MHT s HTML v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHT na HTML online" InputFormat="mht" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
