---
title: C# XLSB から PRN - XLSB から PRN コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLSBをPRNにすばやく簡単に変換します。C# XLSBをPRNに変換します。 C# XLSB を PRN に保存します。 C# を使用して、XLSB を PRN として保存します。
...
{{% blocks/products/pf/agp/content h2="XLSB の PRN に XLSB を保存" %}}
...
{{% cells-convert title="XLSBをPRNに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="prn" IsLandingPage="true" %}}
