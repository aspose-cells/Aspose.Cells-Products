---
title: Python JPG a TSV - Convertidor JPG a TSV
description: Aspose Excel. Python Aspose.Cells. JPG a TSV en Python. Python Convertir JPG a TSV guardar formato. Formato Python JPG a TSV. Guarde JPG en TSV Python.
...
{{% blocks/products/pf/agp/content h2="Guarde JPG en TSV en Python" %}}

El siguiente ejemplo demuestra cómo convertir JPG a TSV en Python via NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir JPG a TSV. Cargue su archivo JPG y luego simplemente guárdelo como archivo TSV. Tanto para la lectura de JPG como para la escritura TSV, puede utilizar nombres de archivo completos. El contenido y el formato de salida TSV serán idénticos al documento JPG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir JPG a TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="tsv" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir JPG a TSV" %}}
