...
description: C# .NET Kitaplığını kullanarak Excel'de Pasta grafikleri oluşturmak için örnek kod. VB.NET, Asp.NET veya .NET tabanlı herhangi bir uygulama içinde MS Excel'e Pasta grafiği oluşturmak için bu kodu kullanın.
...
{{% blocks/products/pf/agp/feature-section-col title="C# ile Pasta Grafikleri Nasıl Oluşturulur" %}}
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kodu, C#\'i kullanarak MS Excel XLSX dosyasına Pasta Grafiğinin nasıl oluşturulacağını gösterir." offSpacer="" %}}
