...
description: Aspose Excel. C++ Aspose.Cells. Gratis online samenvoegen TSV naar PRN-opslagformaat. C++ Combineer TSV naar PRN-formaat. Samenvoegen TSV naar PRN in C++. TSV Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis TSV samen met PRN in C++ online" %}}

Het volgende voorbeeld laat zien hoe u TSV kunt samenvoegen met PRN in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TSV samen te voegen met PRN. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het PRN-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat TSV samenvoegt met PRN.
...
{{% blocks/products/pf/agp/content h2="Hoe TSV samen te voegen met PRN via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TSV programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
