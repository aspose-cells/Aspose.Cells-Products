...
{{% cells-convert title="Codice di esempio per convertire OTS in ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="ods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Come convertire OTS in ODS tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file OTS in ODS a livello di codice? Gli sviluppatori C++ possono convertire facilmente OTS in ODS in poche righe di codice.
...
1.  Converti OTS in ODS chiamando il metodo Save().
