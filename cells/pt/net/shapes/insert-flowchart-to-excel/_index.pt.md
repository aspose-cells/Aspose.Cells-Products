...
weight: 371
description: C# código-fonte para inserir/criar um FlowChart no Excel em .NET Framework, .NET Core, Mono ou plataformas Xamarin.
---
...
{{% blocks/products/pf/agp/content h2="Como inserir/criar um FlowChart no arquivo Excel usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir/criar um arquivo FlowChart para Excel via C#" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o[adicionar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) inserir/criar um FlowChart na planilha selecionada
