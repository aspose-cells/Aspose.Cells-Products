---
title: C# HTML a DOCX - HTML a DOCX Convertidor
description: Aspose Excel. Esta solución integral ofrece a los desarrolladores de Excel C# un enfoque totalmente integrado para convertir el formato HTML al DOCX, lo que permite guardar sin problemas los datos de Excel HTML al formato DOCX mediante la biblioteca Aspose.Cells, todo mediante código C# eficiente y personalizable.
...
{{% blocks/products/pf/agp/content h2="Guardar HTML a DOCX en C#" %}}

El siguiente ejemplo demuestra cómo convertir HTML a DOCX en C#.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir HTML a DOCX. Cargue su archivo HTML y luego simplemente guárdelo como archivo DOCX. Tanto para lectura HTML como para escritura DOCX puede utilizar nombres de archivo completos. El contenido y el formato de salida DOCX serán idénticos al documento HTML original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir HTML a DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir HTML a DOCX a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTML a DOCX mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente HTML en DOCX en tan solo unas pocas líneas de código.
...
1.  Convierta HTML a DOCX llamando al método Workbook.Save.
1.  Obtenga el resultado de la conversión de HTML a DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para convertir HTML a DOCX" %}}
