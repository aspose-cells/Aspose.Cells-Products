---
title: SXC을 TXT로 병합 - C#에서 SXC을 TXT로 결합
url: /ko/net/merger/merge-sxc-to-txt/ 
description: Aspose 엑셀. C# Aspose.Cells. SXC을 TXT 저장 형식으로 병합합니다. C# SXC을 TXT 형식으로 결합합니다. C#에서 SXC을 TXT로 병합합니다. SXC 병합.
keywords: [Aspose Excel., C# Aspose.Cells., Merge SXC to TXT in C#., C# Merge SXC to txt., C# Combine SXC to TXT., SXC Merge]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 SXC을 TXT에 병합" h2="SXC을 TXT에 병합하기 위한 고속 C# 라이브러리. Excel 변환 API을 사용하여 C#에서 높은 수준의 플랫폼 독립적 소프트웨어를 개발합니다. 이는 Excel, CSV, OpenOffice, PDF, HTML, image 및 기타 여러 Excel 형식을 가져오고 내보낼 수 있는 전문 소프트웨어 솔루션입니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="SXC" additionalConversionTag="TXT" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="C#에서 SXC을 TXT로 병합" %}}

다음 예에서는 Aspose.Cells for .NET에서 SXC을 TXT로 병합하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

간단한 단계에 따라 SXC을 TXT로 병합하세요. 파일을 업로드하고 파일 병합을 위해 Workbook.Combine 메서드를 호출한 다음 TXT 파일에 저장하세요. C#에서 코드를 개발하면 생각보다 간단해질 것입니다. SXC을 TXT에 병합하는 C# 예를 참조하세요.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#에서 SXC을 TXT로 병합하는 샘플 코드" InputFormat="sxc" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 SXC을 TXT에 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 프로그래밍 방식으로 SXC을 TXT에 병합해야 합니까? 병합하고 연결하는 기본 문서[Aspose.Cells for .NET](https://products.aspose.com/cells/net) 단 몇 줄의 코드만으로 API를 구현할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2=".NET 라이브러리를 SXC에서 TXT로 병합" %}}
