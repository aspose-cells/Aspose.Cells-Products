---
title: C# XLSX para ET - Online XLSX para ET Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter XLSX para ET saveformat. C# XLSX para o formato ET. Salve XLSX para ET C#.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX em ET em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter XLSX para ET em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX para ET. Carregue seu arquivo XLSX e simplesmente salve-o como arquivo ET. Para leitura XLSX e gravação ET, você pode usar nomes de arquivo totalmente qualificados. O conteúdo e a formatação do ET de saída serão idênticos ao documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter XLSX para ET Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para ET via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para ET programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter XLSX para ET em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para converter XLSX para ET" %}}
