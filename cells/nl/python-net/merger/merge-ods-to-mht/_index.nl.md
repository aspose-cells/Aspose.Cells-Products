...
url: /nl/python-net/merger/merge-ods-to-mht/ 
...
Het volgende voorbeeld laat zien hoe u ODS kunt samenvoegen met MHT in Aspose.Cells for Python via .NET.
...
Wilt u ODS programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
