...
スプレッドシート オブジェクトを別の形式に変換する
    ...
    <p>
Aspose.Cells for Android via Java は、ワークシートから画像への変換、グラフから画像への変換など、いくつかの特徴的な機能を提供します。 PDF とスプレッドシートから PDF ドキュメント形式への変換。柔軟なプロセスには、スプレッドシート中に画像を PDF に再サンプリングしたり、ワークシートやワークシートをレンダリングするときに結果の画像の寸法を設定したりするなど、変換に関する多くの選択肢があります。チャートを画像形式に変換します。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
