---
title: Sloučit ODS do JPG – Sloučit ODS do JPG v Python
url: /cs/python-java/merger/merge-ods-to-jpg/ 
description: Aspose Excel. Python Excel. Sloučit ODS do formátu uložení JPG. Python Zkombinujte ODS do formátu JPG. Sloučit ODS do JPG v knihovně Excel Python. ODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS do JPG pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS do JPG v knihovně Excel Python" %}}

Následující příklad ukazuje, jak sloučit ODS do JPG v Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení ODS do JPG. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru JPG. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí ODS do JPG.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit ODS do JPG prostřednictvím knihovny Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit ODS do JPG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python ke sloučení ODS do JPG" %}}
