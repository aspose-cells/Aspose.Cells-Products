---
title: استخراج النص والصور من مستند XLSX عبر C++
weight: 570
description: C++ رمز المثال لاستخراج النص والصور من ملف XLSX على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
{{% blocks/products/pf/agp/content h2="كيفية تحليل ملف XLSX باستخدام C++" %}}

 من أجل تحليل الملف XLSX، سنستخدم[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API وهي منصة تحليل مستندات غنية بالميزات وقوية وسهلة الاستخدام API for C++. يمكنك تنزيل أحدث إصدار له مباشرة، فقط قم بفتحه[NuGet](https://www.nuget.org/packages/aspose.cells) مدير الحزم، ابحث عن**Aspose.Cells.Cpp** وتثبيت. يمكنك أيضًا استخدام الأمر التالي من وحدة تحكم إدارة الحزم.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحليل XLSX الملفات في C++" %}}
...
{{% blocks/products/pf/agp/code-block title="تحليل XLSX الملفات - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="العروض التوضيحية المباشرة للمحلل عبر الإنترنت XLSX" sectionDescription="قم باستخراج النصوص والصور من مستندات XLSX الآن من خلال زيارة موقعنا[موقع العروض الحية](https://products.aspose.app/cells/parser). يتمتع العرض التجريبي المباشر بالمزايا التالية" >}}
