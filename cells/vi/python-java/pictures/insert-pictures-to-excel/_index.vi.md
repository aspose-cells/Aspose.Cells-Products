...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng bộ sưu tập tranh[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) để chèn Ảnh vào trang tính đã chọn.
