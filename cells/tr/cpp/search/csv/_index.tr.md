---
title:  CSV belgesini C++ üzerinden açmadan ara
weight: 5540
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı'ndaki CSV dosyasındaki desenli kelimeleri aramak için örnek kod.
...
{{< blocks/products/pf/i18n/upper-banner h1="CSV Formatlarını C++\'de arayın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan, sunucu tarafı Aspose.Cells for C++ API\'lerini kullanarak yerel ve yüksek performanslı CSV belge arama." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanılarak CSV Dosyası Nasıl Aranır?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="CSV Dosyalarını C++\'de Arama Adımları" %}}
...
+ Bir Çalışma Kitabı sınıfını başlatarak CSV dosyasını yükleyin.
...
+ Workbook::Save(...) yöntemini kullanarak CSV dosyasını kaydedin.
...
{{% blocks/products/pf/agp/code-block title="CSV Dosyalarını Ara - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi CSV Canlı Demoları Arayın" sectionDescription=" Hemen şimdi sitemizi ziyaret ederek CSV doküman içerisinde metin, kelime, kelime öbeği arayın.[Canlı Demolar web sitesi](https://products.aspose.app/cells/search). Canlı demo aşağıdaki avantajlara sahiptir" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API\'i indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="CSV dosyalarınızı yüklemeniz yeterli." >}}
