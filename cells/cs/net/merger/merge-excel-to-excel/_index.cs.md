---
title: Sloučit EXCEL do EXCELu - Kombinovat EXCEL s EXCELem v C#
url: /cs/net/merger/merge-excel-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit EXCEL do formátu uložení EXCEL. C# Kombinujte EXCEL s formátem EXCEL. Sloučit EXCEL do EXCELu v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL do EXCEL v C#" %}}

Následující příklad ukazuje, jak sloučit EXCEL do EXCELu v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení EXCELu s EXCELem. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru EXCEL. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí EXCEL do EXCELu.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení EXCEL do EXCEL v C#" InputFormat="xlsx" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL do EXCELu přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit EXCEL s EXCELem? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu pro sloučení EXCEL do EXCELu" %}}
