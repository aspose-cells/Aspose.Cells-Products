---
title: C# XML na MHTML - Převodník XML na MHTML
description: Aspose Excel. Převeďte XML na MHTML rychle a snadno pomocí Aspose.Cells. C# XML na MHTML. C# Uložte XML na MHTML. Uložte XML jako MHTML pomocí 0716183
...
{{% blocks/products/pf/agp/content h2="Uložte XML na MHTML v C#" %}}

Následující příklad ukazuje, jak převést XML na MHTML v C#.
...
{{% cells-convert title="Ukázkový kód pro převod XML na MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="mhtml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na MHTML přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XML na MHTML programově? Vývojáři .NET mohou snadno načíst a převést XML na MHTML v několika řádcích kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML na MHTML" %}}
