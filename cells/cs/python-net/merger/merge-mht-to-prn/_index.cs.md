...
url: /cs/python-net/merger/merge-mht-to-prn/ 
...
Následující příklad ukazuje, jak sloučit MHT do PRN v Aspose.Cells for Python via .NET.
...
Potřebujete programově sloučit MHT s PRN? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
