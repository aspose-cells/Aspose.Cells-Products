---
title: Konvertera XLS till TIFF via C#

description: Exempelkod för konvertering från xls till tiff C#. Använd API exempelkod för batch-xls-filer för att tiff-konvertera inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLS till TIFF med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLS till TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera XLS-filer till TIFF på bara några rader kod.
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLS till TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="tiff" IsLandingPage="true" %}}
