---
title: دمج ODS في TABDELIMITED - اجمع ODS إلى TABDELIMITED في C#
url: /ar/net/merger/merge-ods-to-tabdelimited/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني على الإنترنت ODS إلى TABDELIMITED saveformat. C# اجمع ODS إلى تنسيق TABDELIMITED. دمج ODS إلى TABDELIMITED في C#. ODS دمج.
...
{{% blocks/products/pf/agp/content h2="دمج ODS في TABDELIMITED في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج ODS إلى TABDELIMITED في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج ODS في TABDELIMITED. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف TABDELIMITED. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج ODS إلى TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج ODS في TABDELIMITED في C#" InputFormat="ods" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج ODS في TABDELIMITED عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج ODS في TABDELIMITED برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج ODS إلى TABDELIMITED" %}}
