---
title: Converteer FODS naar XLT via Python
url: /nl/python-java/conversion/fods-to-xlt/
description: Voorbeeldcode voor conversie van fods naar xlt Python. Gebruik API voorbeeldcode voor batch-fods-bestanden naar xlt-conversie binnen de Python-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer FODS naar XLT via Python" h2="Exporteer Excel®-spreadsheets naar XLT-indeling met Python API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar XLT te converteren met Python" %}}

 Om FODS naar XLT te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om FODS naar XLT te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen FODS-bestanden gemakkelijk laden en converteren naar XLT in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad FODS-bestand met een exemplaar van Workbook1. Roep de methode Workbook.Save aan1. Geef uitvoerpad door met XLT-extensie als parameter1. Controleer het opgegeven pad voor het resulterende XLT-bestand
...
{{% cells-convert title="Gratis app en voorbeeldcode om FODS naar XLT te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xlt" IsLandingPage="true" language="python" %}}
