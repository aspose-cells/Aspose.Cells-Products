---
title: دمج الأرقام في JPEG - اجمع الأرقام في JPEG في Java
url: /ar/java/merger/merge-numbers-to-jpeg/ 
description: Aspose إكسل. Java Aspose.Cells. دمج الأرقام مجانًا عبر الإنترنت في تنسيق حفظ JPEG. Java قم بدمج الأرقام بالشكل JPEG. دمج الأرقام في JPEG في Java. دمج الأرقام.
...
{{% blocks/products/pf/agp/content h2="دمج الأرقام مع JPEG باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="قم بدمج الأرقام في JPEG في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج الأرقام مع JPEG في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج NUMBERS في JPEG. قم بتحميل ملفاتك ، واستدع طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف JPEG. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج الأرقام مع JPEG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني عبر الإنترنت لدمج الأرقام في JPEG في Java" InputFormat="numbers" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج الأرقام مع JPEG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج الأرقام في JPEG برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Java مكتبة لدمج الأرقام إلى JPEG" %}}
