---
title: Insira o controle ActiveX no Excel usando Python via Java
weight: 10
description: Python via Java código-fonte para inserir o controle ActiveX no Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserir controle ActiveX no Excel usando Python via java" h2="Insira objetos usando APIs do lado do servidor sem nenhum software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir o controle ActiveX no arquivo do Excel usando Python via Java" %}}

 Para inserir o controle ActiveX no arquivo Excel, usaremos
 [Aspose.Cells for Python via java](https://pypi.org/project/aspose-cells/) 
API, que é uma manipulação de documentos rica em recursos, poderosa e fácil de usar API para python via plataforma java. O API fornece criação, manipulação, conversão e renderização de arquivos Excel. Tudo sem depender de aplicativos Office ou Excel Microsoft. Você pode instalar a partir do console usando o seguinte comando.
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir o controle ActiveX no arquivo Excel usando Python via java" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use a coleção de formas[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)) para inserir um Controle ActiveX na planilha selecionada.
...
-  Qualquer sistema operacional que possa executar python por meio de scripts java, como Windows, Linux e MacOS
...
{{% blocks/products/pf/agp/code-block title="Inserir controle ActiveX - Python via java" offSpacer="" %}}
