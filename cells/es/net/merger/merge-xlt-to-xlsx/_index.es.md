---
title: Combinar XLT a XLSX - Combinar XLT a XLSX en C#
url: /es/net/merger/merge-xlt-to-xlsx/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea XLT a XLSX guardar formato. C# Combina el formato XLT con el XLSX. Combinar XLT a XLSX en C#. XLT Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLT a XLSX en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLT con XLSX en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLT a XLSX. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo XLSX. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina XLT con XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLT a XLSX en C#" InputFormat="xlt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLT a XLSX a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLT con XLSX mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar XLT a XLSX" %}}
