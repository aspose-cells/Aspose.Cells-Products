---
title:  HTM über C# mit XLS zusammenführen
url: /de/net/merger/merge-htm-to-xls/ 
description: Führen Sie HTM kostenlos online mit XLS zusammen. Kostenlose Online-HTM zur XLS-Fusion. Führen Sie HTM mit Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS und mehr zusammen.
---
...
Das folgende Beispiel zeigt, wie HTM in C# mit XLS zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um HTM mit XLS zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei XLS. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das HTM mit XLS zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlose App zum Online-Zusammenführen von HTM mit XLS" InputFormat="htm" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von HTM mit XLS" %}}
