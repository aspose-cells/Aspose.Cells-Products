...
Ví dụ sau đây minh họa cách hợp nhất MHTML thành JPG trong Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để ghép MHTML sang JPG" %}}
