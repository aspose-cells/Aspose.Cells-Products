---
title:  Объединить JSON с HTM via Java
...
В следующем примере показано, как объединить JSON с HTM в Java.
...
{{% cells-merger title="Бесплатное приложение для объединения JSON с HTM онлайн" InputFormat="json" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
