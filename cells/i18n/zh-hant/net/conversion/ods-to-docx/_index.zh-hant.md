...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 將 ODS 轉換為 DOCX 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開發人員只需幾行代碼即可輕鬆加載 ODS 文件並將其轉換為 DOCX。
...
{{% cells-convert title="將 ODS 轉換為 DOCX 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="docx" IsLandingPage="true" %}}
