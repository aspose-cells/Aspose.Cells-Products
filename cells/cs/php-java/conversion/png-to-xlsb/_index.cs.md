---
title: Konvertor PHP PNG až XLSB - PNG až XLSB
description: Aspose Excel. Převeďte PNG na XLSB rychle a snadno pomocí Aspose.Cells. PHP PNG na XLSB. PHP Uložte PNG na XLSB. Uložte XLSB jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na XLSB přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na XLSB programově? Vývojáři PHP mohou snadno načíst a převést PNG na XLSB v několika řádcích kódu.
...
1.  Převeďte PNG na XLSB voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na XLSB" %}}
