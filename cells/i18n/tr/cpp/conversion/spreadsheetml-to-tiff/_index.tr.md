---
title: C++ uygulaması aracılığıyla SPREADSHEETML'yi TIFF'ye dönüştürün 
url: /tr/cpp/conversion/spreadsheetml-to-tiff/ 
description: SPREADSHEETML belgesi için TIFF biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu SPREADSHEETML'den TIFF'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML\'yi C++ aracılığıyla TIFF\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna gerek kalmadan C++ kitaplığını kullanarak yüksek performanslı SPREADSHEETML\'den TIFF\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, yalnızca birkaç satır kodla SPREADSHEETML dosyasını TIFF'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook'u kullanarak SPREADSHETML dosyasını yükleyin.1. İlk çalışma sayfasını seçin.1. (TIFF) seçeneklerini ayarlayın.1. Sayfanın her sayfasını yineleyin ve oluşturun.1. TIFF dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML - TIFF C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
