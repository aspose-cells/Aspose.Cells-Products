---
title: C++ MHTML na ČÍSLA – Online převodník MHTML na ČÍSLA
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Online zdarma C++ Převeďte MHTML na uložený formát ČÍSLA. C++ MHTML do formátu ČÍSLA. Uložte MHTML na ČÍSLA C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na ČÍSLA v C++" h2="Vysoce výkonný převod MHTML na NUMBERS pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete MHTML na NUMBERS v C++ Online zdarma" %}}

Následující příklad ukazuje, jak převést MHTML na ČÍSLA v C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na ČÍSLA přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory na NUMBERS programově? Vývojáři C++ mohou snadno převést MHTML na ČÍSLA v několika řádcích kódu.
...
1.  Převeďte MHTML na NUMBERS voláním metody Save().
