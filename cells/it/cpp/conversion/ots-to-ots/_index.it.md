...
Hai bisogno di convertire i file OTS in OTS tramite codice? Gli sviluppatori C++ possono facilmente convertire OTS in OTS in poche righe di codice.
...
1.  Convertire OTS in OTS chiamando il metodo Save().
