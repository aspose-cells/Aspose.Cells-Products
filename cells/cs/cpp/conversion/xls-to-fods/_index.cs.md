---
title: C++ XLS až FODS - XLS až FODS Převodník
description: Aspose Excel. Převeďte XLS na FODS rychle a snadno pomocí Aspose.Cells. C++ XLS na FODS. C++ Ušetřete XLS na 197 3481761 jako 197 348161 C++ 481 pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Uložit XLS až FODS v C++" %}}

Následující příklad ukazuje, jak převést XLS na FODS v C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod XLS na FODS. Nahrajte svůj soubor XLS a poté jej jednoduše uložte jako soubor FODS. Pro čtení XLS i zápis FODS můžete použít plně kvalifikované názvy souborů. Výstupní FODS obsah a formátování bude shodné s původním dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod XLS na FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="fods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLS na FODS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLS na FODS programově? Vývojáři C++ mohou snadno převést XLS na FODS v několika řádcích kódu.
...
1.  Převeďte XLS na FODS voláním metody Save().
1.  Získejte výsledek převodu XLS na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod XLS na FODS" %}}
