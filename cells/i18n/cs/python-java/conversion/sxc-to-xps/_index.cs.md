---
title: Převést SXC na XPS přes Python
url: /cs/python-java/conversion/sxc-to-xps/
description: Ukázkový kód pro převod sxc na xps Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na xps v aplikaci Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SXC na XPS přes Python" h2="Exportujte tabulky Excel® do formátu XPS pomocí rozhraní API Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na XPS pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na XPS prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na XPS pomocí několika řádků kódu.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xps" IsLandingPage="true" language="python" %}}
