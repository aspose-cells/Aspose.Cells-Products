---
title: Gabungkan XLSX ke EXCEL - Gabungkan XLSX ke EXCEL di C#
url: /id/net/merger/merge-xlsx-to-excel/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSX ke format simpan EXCEL. C# Gabungkan XLSX ke format EXCEL. Gabungkan XLSX menjadi EXCEL di C#. XLSX Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSX ke EXCEL di C#" %}}

Contoh berikut menunjukkan cara menggabungkan XLSX ke EXCEL di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSX ke EXCEL. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file EXCEL. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSX ke EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLSX ke EXCEL di C#" InputFormat="xlsx" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSX ke EXCEL lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSX ke EXCEL secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan XLSX ke EXCEL" %}}
