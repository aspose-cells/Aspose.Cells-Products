---
title: C++アプリケーションを介してXLSBをCSVに変換する 
weight: 6060
url: /ja/cpp/conversion/xlsb-to-csv/ 
description: XLSBドキュメントからCSV形式へのサンプルC++変換コード。プログラマーは、このソースコードを使用して、任意のC++アプリケーション内でXLSBからCSVへのバッチ変換を行うことができます。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++を介してXLSBをCSVに変換する" h2="Microsoft Excel、OpenOffice、AdobeAcrobatをインストールせずにC++ライブラリを使用した高性能XLSBからCSVへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++開発者は、わずか数行のコードでXLSBファイルをCSVに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbookを使用してXLSBファイルをロードします。1. Save（）メソッドを呼び出します。1. （CSV）ファイル拡張子を持つ出力ファイルパスを渡します。1. 指定したパスにCSVファイルが保存されます。1. 互換性のあるプログラムでCSVファイルを開きます。
