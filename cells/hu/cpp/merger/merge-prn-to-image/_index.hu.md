...
url: /hu/cpp/merger/merge-prn-to-image/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítése PRN IMAGE mentési formátumba. C++ Kombinálja a PRN-t IMAGE formátumba. PRN egyesítése az IMAGE-val a C++-ben. PRN egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a PRN-t az IMAGE-val a C++-es számon" %}}

A következő példa bemutatja, hogyan egyesítheti a PRN-t az IMAGE-val a Aspose.Cells for C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a PRN és az IMAGE egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el az IMAGE fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++ példát, amely egyesíti a PRN-t az IMAGE-val.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a PRN és az IMAGE egyesítéséhez a C++ számon" InputFormat="prn" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A PRN és az IMAGE egyesítése a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a PRN-t az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a PRN és az IMAGE egyesítéséhez" %}}
