---
title: PREADSHEETML को C++ एप्लिकेशन के माध्यम से PNG में बदलें 
url: /hi/cpp/conversion/spreadsheetml-to-png/ 
description: स्प्रैडशीटएमएल दस्तावेज़ के लिए पीएनजी प्रारूप में नमूना C++ रूपांतरण कोड। प्रोग्रामर इस स्रोत कोड का उपयोग किसी भी C++ एप्लिकेशन के भीतर PREADSHEETML से PNG रूपांतरण के बैच के लिए कर सकते हैं।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="PREADSHEETML को C++ के माध्यम से PNG में बदलें" h2="Microsoft Excel, OpenOffice या Adobe Acrobat स्थापना की आवश्यकता के बिना C++ लाइब्रेरी का उपयोग करके उच्च प्रदर्शन PREADSHEETML से PNG रूपांतरण।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="C++ का उपयोग करके स्प्रेडशीटएमएल को पीएनजी में कैसे बदलें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PREADSHEETML को C++ के माध्यम से PNG में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 C++ डेवलपर स्प्रैडशीटएमएल फ़ाइल को कोड की कुछ ही पंक्तियों में आसानी से पीएनजी में बदल सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. फ़ैक्टरी :: CreateIWorkbook का उपयोग करके SPREADSHEETML फ़ाइल लोड करें।1. पहली वर्कशीट का चयन करें।1. सेट (पीएनजी) विकल्प।1. शीट के प्रत्येक पृष्ठ के माध्यम से पुनरावृति करें और प्रस्तुत करें।1. संगत प्रोग्राम में पीएनजी फ़ाइल खोलें।
...
{{% blocks/products/pf/agp/code-block title="स्प्रैडशीटएमएल से पीएनजी C++ रूपांतरण स्रोत कोड" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="स्प्रैडशीटएमएल से पीएनजी रूपांतरण लाइव डेमो" sectionDescription="[स्प्रेडशीटएमएल को पीएनजी में बदलें](https://products.aspose.app/cells/conversion/spreadsheetml-to-png) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API डाउनलोड करने की आवश्यकता नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" कोई कोड लिखने की जरूरत नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी स्प्रेडशीटएमएल फ़ाइल अपलोड करें, यह तुरंत पीएनजी में परिवर्तित हो जाएगी।" >}}
