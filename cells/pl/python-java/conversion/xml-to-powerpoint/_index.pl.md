...
Poniższy przykład ilustruje, jak przekonwertować XML na POWERPOINT w Python.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na POWERPOINT za pomocą Python" %}}
