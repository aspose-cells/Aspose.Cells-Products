---
title: تحويل XLS إلى DIF عبر Java 
weight: 7820
url: /ar/java/conversion/xls-to-dif/ 
description: نموذج رمز تحويل Java لتنسيق XLS إلى ملف DIF. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى DIF داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLS إلى DIF عبر Java" h2="XLS إلى DIF Java لتحويل صفحات مفردة أو متعددة إلى DIF باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى DIF باستخدام Java" %}}

 من أجل تقديم XLS إلى DIF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLS إلى DIF عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف XLS إلى DIF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف XLS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد DIF & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف DIF الناتج
...
{{% blocks/products/pf/agp/code-block title="XLS إلى DIF Java شفرة مصدر التحويل" offSpacer="" %}}
