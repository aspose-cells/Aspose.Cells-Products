...
El siguiente ejemplo muestra cómo combinar HTM con MARKDOWN en Aspose.Cells for Python via Java.
...
¿Necesita fusionar HTM con MARKDOWN mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Las API se pueden hacer con solo unas pocas líneas de código.
