---
title: Titkosított pdf-fájlok mentése a C++-es számon keresztül
weight: 10010
description: C++ példakód a fájl titkosítására jelszóval a C++ futásidejű környezet Windows 32 bites, Windows 64 bites és Linux 64 bites esetén.
...
{{< blocks/products/pf/i18n/upper-banner h1="PDF fájlok titkosítása a C++ számon keresztül" h2="Konvertálja az Excel-táblázatokat PDF-es fájlokká, és védje jelszóval őket a Aspose.Cells C++ könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="A PDF fájl titkosítása a C++ használatával" %}}

 A PDF fájl titkosításához a következőt használjuk:
 [Aspose.Cells for C++](https://products.aspose.com/cells/cpp) 
 API, amely funkciókban gazdag, hatékony és könnyen használható dokumentumtitkosítási API for C++ platform. A legújabb verziót közvetlenül letöltheti, csak nyissa meg
...
{{% blocks/products/pf/agp/feature-section-col title="A PDF-es fájlok titkosításának lépései a C++-en keresztül" %}}
...
1.  Használja a Munkafüzet osztályt új Excel-fájl betöltéséhez vagy létrehozásához
1.  Állítsa be a biztonsági beállításokat a PdfSecurityOptions osztály segítségével
1.  Mentse el a titkosított PDF fájlt a Mentés() metódussal
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a védelemhez PDF" sectionDescription=" Tekintse meg élő bemutatóinkat[PDF fájl titkosítása](https://products.aspose.app/cells/protect/pdf) a következő előnyökkel." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nem kell letölteni vagy beállítani semmit" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni vagy fordítani" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a PDF fájlt, és nyomja meg a \"Feloldás\" gombot" >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" Töltse le a kapott PDF fájlt a hivatkozásról" >}}
