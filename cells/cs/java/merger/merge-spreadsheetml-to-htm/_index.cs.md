---
title:  Sloučit SPREADSHEETML do HTM via Java
...
Následující příklad ukazuje, jak sloučit SPREADSHEETML do HTM v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení SPREADSHEETML do HTM online" InputFormat="xml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
