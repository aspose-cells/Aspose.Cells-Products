---
title: C# XLT sang HTM - XLT sang HTM Chuyển đổi
description: Aspose Excel. Chuyển đổi XLT sang HTM nhanh chóng và dễ dàng với Aspose.Cells. C# XLT sang HTM. C# Lưu XLT vào HTM. Lưu XLT dưới dạng HTM bằng C#.
...
{{% blocks/products/pf/agp/content h2="Lưu XLT vào HTM vào C#" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLT sang HTM trong C#.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để chuyển đổi XLT sang HTM. Tải lên tệp XLT của bạn, sau đó chỉ cần lưu nó dưới dạng tệp HTM. Đối với cả việc đọc XLT và ghi HTM, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng HTM đầu ra sẽ giống hệt với tài liệu XLT gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mã mẫu chuyển đổi XLT sang HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLT sang HTM qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi file XLT sang HTM theo chương trình? Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi XLT sang HTM chỉ bằng vài dòng mã.
...
1.  Chuyển đổi XLT sang HTM bằng cách gọi phương thức Workbook.Save.
1.  Nhận kết quả chuyển đổi XLT sang HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C# chuyển đổi XLT sang HTM" %}}
