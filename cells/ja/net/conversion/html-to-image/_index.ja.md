---
title: C# HTML から画像 - HTML から画像コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、HTMLをIMAGEにすばやく簡単に変換します。C# HTMLをIMAGEに変換します。 C# HTMLを画像に保存してください。 C# を使用して、HTML を画像として保存します。
...
{{% cells-convert title="HTMLをIMAGEに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML経由でHTMLをIMAGEに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで IMAGE に変換する必要がありますか? .NET 開発者は、わずか数行のコードで HTML を簡単にロードして IMAGE に変換できます。
