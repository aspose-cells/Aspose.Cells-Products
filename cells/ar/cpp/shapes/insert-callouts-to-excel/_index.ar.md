...
{{% blocks/products/pf/agp/content h2="كيفية إدراج التسميات التوضيحية في ملف إكسل باستخدام C++" %}}

 لإدراج التعليقات التوضيحية في ملف إكسل، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج التسميات التوضيحية في ملف إكسل عبر الرقم C++" %}}

+ إنشاء كائن Workbook. (أو -> تحميل الملف XLSX مع المسار الكامل.)
+ حدد ورقة العمل عبر فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/) لإدراج التسميات التوضيحية في ورقة العمل المحددة
...
يوضح نموذج التعليمات البرمجية أدناه كيفية إدراج "فقاعة فكرية: سحابة". لمزيد من الأنواع، يرجى الرجوع إلى "نظرة عامة على أنواع التسميات التوضيحية" أدناه.

{{% /blocks/products/pf/agp/text %}}

{{% blocks/products/pf/agp/code-block title="إدخال المكالمات - C++" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 نظرة عامة على أنواع التسميات التوضيحية
   </h2>
   <div class="col-lg-4">
