---
title: C# XLSM 至 SPREADSHEETML - XLSM 至 SPREADSHEETML 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLSM 转换为 SPREADSHEETML。 C# XLSM 到 SPREADSHEETML。 C# 将 XLSM 保存到 SPREADSHEETML。使用 C# 将 XLSM 保存为 SPREADSHEETML。
...
{{% blocks/products/pf/agp/content h2="将 XLSM 保存到 C# 中的 SPREADSHEETML" %}}
...
{{% cells-convert title="将 XLSM 转换为 SPREADSHEETML 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xml" IsLandingPage="true" %}}
