---
title: HTM to DIF - Convert HTM to DIF files Python via Python
...
{{% blocks/products/pf/agp/content h2="Convert HTM to DIF in Python" %}}
...
The following example demonstrates how to convert HTM to DIF in Python via NET.
