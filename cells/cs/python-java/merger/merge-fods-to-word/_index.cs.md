...
Následující příklad ukazuje, jak sloučit FODS do WORD v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit FODS do WORDu? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
