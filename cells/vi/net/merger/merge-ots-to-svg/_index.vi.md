---
title: Gộp OTS thành SVG - Gộp OTS thành SVG trong C#
url: /vi/net/merger/merge-ots-to-svg/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí OTS thành SVG định dạng lưu. C# Kết hợp định dạng OTS thành SVG. Hợp nhất OTS thành SVG trong C#. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS với SVG trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất OTS thành SVG trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất OTS thành SVG. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp, sau đó lưu vào tệp SVG. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất OTS thành SVG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất OTS thành SVG trong C#" InputFormat="ots" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS thành SVG qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất OTS với SVG theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất OTS thành SVG" %}}
