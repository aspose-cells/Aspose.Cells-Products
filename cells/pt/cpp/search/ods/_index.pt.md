---
title:  Procurar documento ODS sem abrir via C++
weight: 3300
description: C++ código de exemplo para pesquisar palavras com padrão no arquivo ODS no ambiente de tempo de execução C++ para Windows 32 bits, Windows 64 bits e Linux 64 bits.
---
