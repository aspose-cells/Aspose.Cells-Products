...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása MHTML-re a következővel: Python" %}}

 Az SXC MHTML-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása MHTML-re a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen betölthetnek és konvertálhatnak SXC fájlokat MHTML-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Adja meg a kimeneti útvonalat MHTML kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott MHTML-fájl megadott elérési útját
