...
description: Aspose Exceller. Convertissez des NUMÉROS en TIFF rapidement et facilement avec Aspose.Cells. C# NUMÉROS en TIFF. C# Enregistrez des NUMÉROS en TIFF. Enregistrez des NUMÉROS sous TIFF en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer les numéros au TIFF dans C#" %}}

L'exemple suivant montre comment convertir NUMBERS en TIFF en C#.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir des NUMBERS en TIFF" %}}
