---
title: PHP XLT إلى MD - XLT إلى MD محول
description: Aspose اكسل. قم بتحويل XLT إلى MD بسرعة وسهولة باستخدام Aspose.Cells. PHP XLT إلى MD. PHP احفظ XLT في MD. احفظ XLT كـ MD باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLT إلى MD في PHP" h2="مكتبة PHP عالية السرعة لتحويل XLT إلى MD. يعد هذا حلاً برمجيًا احترافيًا لاستيراد وتصدير XLT وMD والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLT إلى MD عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLT إلى MD برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLT إلى MD بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLT إلى MD عن طريق استدعاء طريقة حفظ المصنف.
