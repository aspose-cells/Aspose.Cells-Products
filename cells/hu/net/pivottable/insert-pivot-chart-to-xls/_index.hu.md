...
{{% blocks/products/pf/agp/feature-section-col title="Pivot diagram beillesztése a XLS-be a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 A fejlesztők könnyen beilleszthetik a Pivot Chart-ot a XLS formátumú táblázatba a különböző jelentéskészítő alkalmazásokba, amelyek adatfeldolgozás céljából mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="Pivot diagram beszúrása a XLS - C# számokhoz" offSpacer="" %}}
