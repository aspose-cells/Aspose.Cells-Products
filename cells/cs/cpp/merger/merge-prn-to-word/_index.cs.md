...
Následující příklad ukazuje, jak sloučit PRN do WORD v Aspose.Cells for C++.
...
Potřebujete sloučit PRN do WORD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
