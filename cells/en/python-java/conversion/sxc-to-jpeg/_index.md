...
{{% blocks/products/pf/agp/content h2="Convert SXC to JPEG Using Python Excel Library" %}}
...
{{% blocks/products/pf/agp/content h2="Save SXC to JPEG in Python Excel Library" %}}

The following example demonstrates how to convert SXC to JPEG in Python excel library.
...
{{% blocks/products/pf/agp/content h2="Python Excel Library to Convert SXC to JPEG" %}}
