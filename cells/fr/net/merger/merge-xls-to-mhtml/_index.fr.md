---
title: Fusionner XLS à MHTML - Combiner XLS à MHTML dans C#
url: /fr/net/merger/merge-xls-to-mhtml/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite XLS au format de sauvegarde MHTML. C# Combinez le format XLS au format MHTML. Fusionner XLS à MHTML dans C#. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS à MHTML en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner XLS à MHTML dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLS à MHTML. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier MHTML. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne XLS à MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner XLS à MHTML en C#" InputFormat="xls" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS à MHTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLS à MHTML par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner XLS à MHTML" %}}
