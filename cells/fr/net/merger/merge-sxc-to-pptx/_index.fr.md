...
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite SXC au format de sauvegarde PPTX. C# Combinez le format SXC au format PPTX. Fusionner SXC à PPTX dans C#. SXC Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner SXC à PPTX en C# en ligne gratuitement" %}}
...
{{% cells-merger title="Gratuit en ligne pour fusionner SXC à PPTX en C#" InputFormat="sxc" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner SXC à PPTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner SXC à PPTX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner SXC à PPTX" %}}
