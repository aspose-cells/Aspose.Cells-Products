...
weight: 2040
description: C# kod źródłowy do odblokowania chronionego hasłem pliku XLSX na platformach .NET Framework, .NET Core, Mono lub Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj arkusz kalkulacyjny XLSX pod numerem C#" h2="Usuń ochronę z XLSX, używając biblioteki .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
