---
title: Converter SPREADSHEETML para JPEG por meio do aplicativo C++ 
url: /pt/cpp/conversion/spreadsheetml-to-jpeg/ 
description: Exemplo de código de conversão C++ para documento SPREADSHEETML para formato JPEG. Os programadores podem usar esse código-fonte para conversão em lote de SPREADSHEETML para JPEG em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter SPREADSHEETML para JPEG via C++" h2="Conversão de SPREADSHEETML para JPEG de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter SPREADSHEETML para JPEG usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SPREADSHEETML em JPEG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem converter facilmente o arquivo SPREADSHEETML para JPEG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo SPREADSHEETML usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (JPEG).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo JPEG em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML para JPEG C++ Código-fonte de conversão" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de SPREADSHEETML para JPEG" sectionDescription="[Converter SPREADSHEETML para JPEG](https://products.aspose.app/cells/conversion/spreadsheetml-to-jpeg) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo SPREADSHEETML, ele será convertido instantaneamente para JPEG." >}}
