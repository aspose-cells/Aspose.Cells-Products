...
description: Aspose Excel. Python Aspose.Cells. Sloučit XLSM do FODS uložit formát. Python Kombinujte formát XLSM až FODS. Sloučit XLSM až FODS v Python. XLSM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSM až FODS v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLSM až FODS v Python" InputFormat="xlsm" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
