...
url: /nl/python-java/merger/merge-numbers-to-docx/ 
...
Het volgende voorbeeld laat zien hoe u NUMBERS kunt samenvoegen tot DOCX in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u NUMBERS programmatisch samenvoegen tot DOCX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
