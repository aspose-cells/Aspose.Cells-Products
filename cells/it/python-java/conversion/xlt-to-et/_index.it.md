...
description: Aspose Excel. Converti XLT in ET in modo rapido e semplice con Aspose.Cells. Python XLT in ET. Python Salva XLT su ET. Salva XLT come ET utilizzando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertire XLT in ET in Python" h2="Libreria Python ad alta velocità per la conversione di XLT in ET. Questa è una soluzione software professionale per importare ed esportare XLT, ET e molti altri formati utilizzando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converti XLT in ET utilizzando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Salva XLT su ET in Python" %}}

L'esempio seguente mostra come convertire XLT in ET in Python.
...
{{% blocks/products/pf/agp/content h2="Libreria Python per convertire XLT in ET" %}}
