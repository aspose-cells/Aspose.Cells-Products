...
description: Aspose Excel. Konvertieren Sie XLSX schnell und einfach in XPS mit Aspose.Cells. PHP XLSX in XPS. PHP Speichern Sie XLSX in XPS. Speichern Sie XLSX als XPS mit PHP.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLSX über PHP in XPS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLSX-Dateien programmgesteuert in XPS konvertieren? PHP-Entwickler können XLSX in nur wenigen Codezeilen problemlos laden und in XPS konvertieren.
...
1.  Konvertieren Sie XLSX in XPS, indem Sie die Speichermethode der Arbeitsmappe aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLSX in XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von XLSX in XPS" %}}
