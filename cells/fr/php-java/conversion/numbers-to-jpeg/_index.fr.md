---
title: Convertisseur de numéros PHP vers JPEG
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir les nombres au format JPEG, permettant un enregistrement transparent des données numériques au format JPEG grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{% cells-convert title="Exemple de code pour convertir des NOMBRES en JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="jpg" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des nombres en JPEG via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS au format JPEG par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers NUMBERS au format JPEG en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en JPEG en appelant la méthode save de Workbook.
1.  Obtenez le résultat de la conversion de NUMBERS en JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir les nombres en JPEG" %}}
