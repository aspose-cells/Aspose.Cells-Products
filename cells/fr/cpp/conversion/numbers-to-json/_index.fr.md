---
title: Convertir NUMBERS en JSON via l'application C++ 

description: Exemple de code de conversion C++ pour le document NUMBERS au format JSON. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de NUMBERS en JSON dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir NUMBERS en JSON via C++" h2="Conversion NUMBERS en JSON haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir des NUMBERS en JSON en utilisant C++" %}}

 Afin de convertir NUMBERS en JSON, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir des NUMBERS en JSON via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir le fichier NUMBERS en JSON en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier NUMBERS à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (JSON).1. Le fichier JSON sera enregistré dans le chemin spécifié.1. Ouvrez le fichier JSON dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="NUMBERS en JSON C++ code source de conversion" offSpacer="" %}}

```cs
// Chargez les CHIFFRES.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion de NUMBERS en JSON" sectionDescription="[Convertir des NUMBERS en JSON](https://products.aspose.app/cells/conversion/numbers-to-json) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier NUMBERS, il sera converti instantanément en JSON." >}}
