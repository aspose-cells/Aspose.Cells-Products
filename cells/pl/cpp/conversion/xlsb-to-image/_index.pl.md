...
Poniższy przykład pokazuje, jak przekonwertować liczbę XLSB na obraz w formacie C++.
...
Trzeba programowo przekonwertować pliki XLSB na IMAGE? Programiści C++ mogą łatwo przekonwertować pliki XLSB na IMAGE za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLSB na OBRAZ wywołując metodę Save().
