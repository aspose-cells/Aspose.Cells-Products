...
Нужно программно преобразовать файлы XLTM в ET? Разработчики C++ могут легко преобразовать XLTM в ET всего за несколько строк кода.
