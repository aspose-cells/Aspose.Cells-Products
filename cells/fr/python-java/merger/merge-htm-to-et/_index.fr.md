---
title: Fusionner HTM avec ET - Combiner HTM avec ET dans Python
url: /fr/python-java/merger/merge-htm-to-et/ 
description: Aspose Exceller. Python Exceller. Fusionnez HTM avec le format de sauvegarde ET. Python Combinez le format HTM au format ET. Fusionnez HTM avec ET dans la bibliothèque Excel Python. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec ET à l\'aide de la bibliothèque Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec ET dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment fusionner HTM avec ET dans Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner HTM avec ET. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier ET. Si vous développez du code en Python, ce sera plus simple qu'il n'y paraît. Voir l'exemple Python qui fusionne HTM avec ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner HTM avec ET dans la bibliothèque Excel Python" InputFormat="htm" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec ET via la bibliothèque Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTM avec ET par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner HTM avec ET" %}}
