...
Trzeba programowo przekonwertować pliki XML do formatu JSON? Programiści C++ mogą łatwo przekonwertować pliki XML do formatu JSON za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XML do JSON wywołując metodę Save().
