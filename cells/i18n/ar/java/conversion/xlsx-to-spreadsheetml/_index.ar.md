---
title: تحويل XLSX إلى SPREADSHEETML عبر Java 
url: /ar/java/conversion/xlsx-to-spreadsheetml/ 
description: نموذج رمز تحويل Java لتنسيق XLSX إلى ملف SPREADSHEETML. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel و OpenOffice إلى SPREADSHEETML داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLSX إلى SPREADSHEETML عبر Java" h2="XLSX إلى SPREADSHEETML Java لتحويل صفحات مفردة أو صفحات متعددة إلى SPREADSHEETML باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSX إلى SPREADSHEETML باستخدام Java" %}}

 من أجل تقديم XLSX إلى SPREADSHEETML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLSX إلى SPREADSHEETML عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف XLSX إلى SPREADSHEETML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف XLSX مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد SPREADSHEETML و SaveFormat كمعلمات1. تحقق من المسار المحدد لملف SPREADSHEETML الناتج
...
{{% blocks/products/pf/agp/code-block title="XLSX إلى شفرة مصدر التحويل SPREADSHEETML Java" offSpacer="" %}}

```cs
// تحميل ملف XLSX في مثيل مصنف
Workbook book = new Workbook("template.xlsx");
// احفظ XLSX كـ SPREADSHEETML
