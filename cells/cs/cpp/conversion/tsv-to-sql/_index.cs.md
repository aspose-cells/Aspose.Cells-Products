---
title: C++ TSV na SQL - TSV na SQL Converter
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu TSV do formátu SQL, což umožňuje bezproblémové ukládání dat TSV do formátu SQL pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převést TSV na SQL v kódu C++" h2="Vysoce výkonná konverze TSV do SQL s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložit TSV do SQL v C++" %}}

Následující příklad ukazuje, jak převést kód TSV na kód SQL s kódem C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na SQL přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory TSV do SQL? Vývojáři C++ mohou snadno převést TSV do SQL pomocí několika řádků kódu.
...
1.  Převeďte číslo TSV do SQL voláním metody Save().
1.  Získejte výsledek převodu TSV na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod kódu TSV do SQL" %}}
