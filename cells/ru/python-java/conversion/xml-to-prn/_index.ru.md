...
{{% blocks/products/pf/agp/text %}}
 ...
 Python разработчики могут легко загружать и преобразовывать XML в PRN, написав всего несколько строк кода.
