---
title: A ODS egyesítése SPREADSHEETML-be – a ODS egyesítése SPREADSHEETML-be a C++-ben
url: /hu/cpp/merger/merge-ods-to-spreadsheetml/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítés ODS SPREADSHEETML mentési formátumba. C++ A ODS kombinálása SPREADSHEETML formátumba. A ODS egyesítése SPREADSHEETML-be a C++-ben. ODS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a ODS-et a SPREADSHEETML-be a C++-ben online" %}}

A következő példa bemutatja, hogyan egyesítheti a ODS-et a SPREADSHEETML-be a Aspose.Cells-es for C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a ODS és a SPREADSHEETML egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SPREADSHEETML fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++ példát, amely egyesíti a ODS-et a SPREADSHEETML-lel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a ODS SPREADSHEETML-be a C++-ben" InputFormat="ods" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A ODS egyesítése SPREADSHEETML-be a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a ODS-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a ODS és a SPREADSHEETML egyesítéséhez" %}}
