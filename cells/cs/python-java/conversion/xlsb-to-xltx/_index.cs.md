---
title: Python XLSB až XLTX - Online konvertor XLSB až XLTX
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Online zdarma Python Převést XLSB na XLTX uložit formát. Python XLSB až XLTX formát. Uložte si XLSB až XLTX Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte XLSB na XLTX pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLSB až XLTX v Python online zdarma" %}}

Následující příklad ukazuje, jak převést XLSB na XLTX v Python.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod XLSB na XLTX online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xltx" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLSB na XLTX" %}}
