...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na DIF za pomocą Aspose.Cells. Java MHT na DIF. Java Zapisz MHT na DIF. Zapisz MHT jako DIF, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem DIF w Java" %}}

Poniższy przykład ilustruje sposób konwersji MHT na DIF w Java.
...
Chcesz programowo przekonwertować pliki MHT na DIF? Programiści Java mogą łatwo przekonwertować MHT na DIF w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji MHT na DIF" %}}
{{% blocks/products/pf/agp/text %}}
