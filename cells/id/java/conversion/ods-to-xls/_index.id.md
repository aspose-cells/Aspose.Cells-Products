---
title: Java ODS hingga XLS - ODS hingga XLS Konverter
description: Aspose Unggul. Ubah ODS menjadi XLS dengan cepat dan mudah dengan Aspose.Cells. Java ODS menjadi XLS. Java Simpan ODS menjadi XLS. Simpan ODS sebagai 07611134 81 menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ODS menjadi XLS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi ODS menjadi XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, XLS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS hingga XLS di Java" %}}

Contoh berikut menunjukkan cara mengonversi ODS menjadi XLS di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODS menjadi XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file ODS ke XLS secara terprogram? Pengembang Java dapat dengan mudah mengonversi ODS menjadi XLS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah ODS menjadi XLS" %}}
{{% blocks/products/pf/agp/text %}}
