---
title:  ใส่ช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ลงใน Excel via .NET
weight: 30
description: ซอร์สโค้ด C# เพื่อแทรก CheckBox (Form control) ลงใน Excel บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก CheckBox (Form control) ลงในไฟล์ Excel ผ่าน C#" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) เพื่อแทรกช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกช่องทำเครื่องหมาย(ตัวควบคุมแบบฟอร์ม) - C#" offSpacer="" %}}
