...
url: /id/python-java/merger/merge-xltx-to-markdown/ 
...
Contoh berikut menunjukkan cara menggabungkan XLTX ke MARKDOWN di Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLTX menjadi MARKDOWN secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API dapat dilakukan hanya dengan beberapa baris kode.
