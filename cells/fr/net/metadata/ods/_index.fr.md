...
weight: 320
description: Code source C# pour modifier ou afficher les métadonnées au format ODS sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
+ Chargez ODS avec une instance de Workbook
