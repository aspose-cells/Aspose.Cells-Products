---
title: C++ XLTX hingga XLS - XLTX hingga XLS Konverter
description: Aspose Unggul. Ubah XLTX menjadi XLS dengan cepat dan mudah dengan Aspose.Cells. C++ XLTX menjadi XLS. C++ Simpan XLTX menjadi XLS. Simpan XLTX sebagai 07611134 81 menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX hingga XLS di C++" %}}

Contoh berikut menunjukkan cara mengonversi XLTX menjadi XLS di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLTX menjadi XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah XLTX menjadi XLS melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLTX ke XLS secara terprogram? Pengembang C++ dapat dengan mudah mengonversi XLTX menjadi XLS hanya dalam beberapa baris kode.
...
1.  Ubah XLTX menjadi XLS dengan memanggil metode Save().
1.  Dapatkan hasil konversi dari XLTX menjadi XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah XLTX menjadi XLS" %}}
