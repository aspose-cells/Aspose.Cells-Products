---
title: TABDELIMITED'ı PPTX ile birleştir - TABDELIMITED'ı C#'de PPTX ile birleştir
url: /tr/net/merger/merge-tabdelimited-to-pptx/ 
description: Aspose Excel'de. C# Aspose.Cells. TABDELIMITED'ı PPTX kaydetme biçimiyle birleştir. C# TABDELIMITED'ı PPTX biçimiyle birleştirin. TABDELIMITED'ı C#'de PPTX ile birleştir. TABDELIMITED Birleştir.
...
{{% blocks/products/pf/agp/content h2="TABDELIMITED\'ı C#\'de PPTX ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de TABDELIMITED'ın PPTX ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TABDELIMITED'ı PPTX'e birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından PPTX dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TABDELIMITED ile PPTX'i birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de TABDELIMITED ile PPTX\'i Birleştirmek için Örnek Kod" InputFormat="tsv" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="TABDELIMITED\'ı C# ile PPTX ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TABDELIMITED'ı programlı olarak PPTX ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kütüphanesi, TABDELIMITED ile PPTX arasında birleştirilecek" %}}
