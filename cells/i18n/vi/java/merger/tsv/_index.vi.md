---
title: Hợp nhất các tệp TSV qua Java 
weight: 9260
url: /vi/java/merger/tsv/ 
description: Java mã mẫu để kết hợp các tài liệu TSV trên Java Môi trường thời gian chạy cho Ứng dụng JSP / JSF và Ứng dụng trên máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng TSV trong Java" h2="Hợp nhất tài liệu TSV gốc bằng cách sử dụng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất các tệp TSV bằng cách sử dụng Java" %}}

 Để hợp nhất tệp TSV, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Hợp nhất Tệp TSV trong Java" %}}
...
+ Tải tệp TSV đầu tiên với một thể hiện của lớp Workbook.
+ Tải tài liệu TSV thứ hai với một thể hiện của lớp Workbook.
+ Hợp nhất các tệp tin bằng phương thức kết hợp ().
+ lưu tệp TSV đã hợp nhất tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tệp TSV - Java" offSpacer="" %}}
