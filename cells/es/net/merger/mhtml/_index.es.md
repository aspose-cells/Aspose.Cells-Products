---
title: Combinar archivos MHTML a través de .NET 
weight: 2610

description: C# código fuente para combinar documentos MHTML en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos MHTML en C#" h2="Fusión de documentos MHTML nativos y de alto rendimiento utilizando API Aspose.Cells for .NET del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar un archivo MHTML usando C#" %}}
 ...
 Para fusionar un archivo MHTML, usaremos
...
+ Ahora puede abrir y usar el archivo MHTML en Microsoft Office, Adobe PDF o cualquier otro programa compatible.
