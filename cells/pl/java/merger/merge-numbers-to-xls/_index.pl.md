...
description: Aspose Excel. Java Aspose.Cells. Połącz NUMERY, aby zapisać format XLS. Java Połącz NUMERY do formatu XLS. Scal NUMBERS z XLS w Java. NUMBERS Scal.
...
{{< blocks/products/pf/i18n/upper-banner h1="Połącz NUMERY z XLS via Java" h2="Szybka biblioteka Java do łączenia NUMERÓW z XLS. Skorzystaj z naszej konwersji Excela API, aby opracować zaawansowane, niezależne od platformy oprogramowanie w Java. Jest to profesjonalne rozwiązanie do importowania i eksportowania Excel, CSV, OpenOffice, PDF, HTML, image i wielu innych formatów Excela." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="NUMBERS" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z XLS w Java" %}}

Poniższy przykład pokazuje, jak połączyć NUMBERS z XLS w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć NUMERY z numerem XLS. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku XLS. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMBERS z XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia NUMERÓW z XLS w Java" InputFormat="numbers" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć NUMERY z numerem XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć NUMERY z XLS? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do połączenia NUMERÓW z XLS" %}}
