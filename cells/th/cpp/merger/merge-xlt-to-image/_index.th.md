---
title: รวม XLT เข้ากับ IMAGE - รวม XLT เข้ากับ IMAGE ใน C++
url: /th/cpp/merger/merge-xlt-to-image/ 
description: Aspose เอ็กเซล. C++ Aspose.Cells รวม XLT เข้ากับรูปแบบการบันทึก IMAGE C++ รวม XLT เป็นรูปแบบ IMAGE รวม XLT เข้ากับ IMAGE ใน C++ XLT รวม
...
{{% blocks/products/pf/agp/content h2="รวม XLT เข้ากับ IMAGE ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLT เข้ากับ IMAGE ใน Aspose.Cells for C++
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม XLT เข้ากับ IMAGE อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine สำหรับการรวมไฟล์ จากนั้นบันทึกลงในไฟล์ IMAGE หากคุณพัฒนาโค้ดใน C++ สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C++ ที่รวม XLT เข้ากับ IMAGE
...
{{% blocks/products/pf/agp/content h2="วิธีรวม XLT เข้ากับ IMAGE ผ่าน C++" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม XLT เข้ากับ IMAGE โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="C++ ไลบรารี่เพื่อรวม XLT เข้ากับ IMAGE" %}}
