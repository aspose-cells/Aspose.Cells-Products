...
{{% blocks/products/pf/agp/content h2="Převést JPEG na HTML na Python" %}}
...
Následující příklad ukazuje, jak převést JPEG na HTML v Python via NET.
