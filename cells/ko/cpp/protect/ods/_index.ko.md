...
{{% blocks/products/pf/agp/feature-section-col title="C++를 통해 ODS 파일을 보호하는 단계" %}}
...
1. IWorkbook 클래스를 사용하여 ODS 파일 로드1. ProtectionType 및 Password와 함께 Protect(..) 메서드 사용1. Save() 메소드로 보호된 ODS 파일 저장
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="ODS를 보호하는 무료 앱" sectionDescription="라이브 데모를 확인하려면 [ODS 파일 암호화](https://products.aspose.app/cells/protect/ods) 다음과 같은 혜택이 있습니다." >}}
