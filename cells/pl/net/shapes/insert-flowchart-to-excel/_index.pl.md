...
weight: 371
description: C# Przykładowy kod umożliwiający dodanie lub wstawienie schematu blokowego do programu Excel przy użyciu biblioteki .NET. Użyj tego kodu, aby utworzyć schemat blokowy w programie MS Excel w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
keywords: [C# Aspose.Cells., c# add FlowChart., c# insert FlowChart., c# create FlowChart]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw/Utwórz schemat blokowy w programie Excel via .NET" h2="Wstaw/Utwórz schemat blokowy za pomocą Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Jak wstawić/utworzyć schemat blokowy do pliku Excel przy użyciu numeru C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić/utworzyć plik FlowChart do pliku Excel pod numerem C#" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 AutoShapeType.FlowChartData
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12">
 AutoShapeType.FlowChartPredefiniowanyProces
    </p>
   </div>
   <div class="col-lg-4">
...
AutoShapeType.FlowChartInternalStorage
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12">
 Dokument AutoShapeType.FlowChart
    </p>
   </div>
   <div class="col-lg-4">
 ...
 AutoShapeType.FlowChartManualInput
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12">
 Operacja AutoShapeType.FlowChartManual
    </p>
   </div>
   <div class="col-lg-4">
 ...
 AutoShapeType.FlowChartStoredData
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12">
 Opóźnienie AutoShapeType.FlowChart
    </p>
   </div>
   <div class="col-lg-4">
