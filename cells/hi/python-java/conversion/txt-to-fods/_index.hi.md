---
title: Python के माध्यम से TXT को FODS में बदलें
url: /hi/python-java/conversion/txt-to-fods/
description: txt से fods Python रूपांतरण के लिए नमूना कोड। बैच txt फ़ाइलों के लिए Python एप्लिकेशन के भीतर फ़ॉड रूपांतरण के लिए API उदाहरण कोड का उपयोग करें।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python के माध्यम से TXT को FODS में बदलें" h2="Excel® स्प्रेडशीट को Python APIs का उपयोग करके FODS प्रारूप में निर्यात करें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python का उपयोग करके TXT को FODS में कैसे बदलें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="TXT को Python के माध्यम से FODS में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Python डेवलपर कोड की कुछ ही पंक्तियों में आसानी से TXT फ़ाइलों को FODS में लोड और परिवर्तित कर सकते हैं।
...
{{% cells-convert title="TXT को FODS में बदलने के लिए मुफ्त ऐप और नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="fods" IsLandingPage="true" language="python" %}}
