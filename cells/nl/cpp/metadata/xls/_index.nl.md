...
weight: 2150
description: C++ voorbeeldcode om XLS bestandsmetadata te bewerken of te bekijken op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
...
{{% blocks/products/pf/agp/content h2="Hoe u XLS-metagegevens kunt krijgen met behulp van C++" %}}
...
+ Laad XLS-bestand met behulp van CreateIWorkbookMetadata
