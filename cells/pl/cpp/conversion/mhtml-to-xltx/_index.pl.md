---
title: Konwertuj MHTML na XLTX za pomocą aplikacji C++ 
weight: 6610
url: /pl/cpp/conversion/mhtml-to-xltx/ 
description: Przykładowy kod konwersji C++ dla dokumentu MHTML do formatu XLTX. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji MHTML na XLTX w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik MHTML na XLTX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik MHTML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLTX).1. Plik XLTX zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLTX w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji MHTML na XLTX C++" offSpacer="" %}}
