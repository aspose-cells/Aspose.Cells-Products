---
title: A XLTX-BMP-es számok egyesítése – a XLTX-es és a BMP-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-xltx-to-bmp/ 
description: Aspose Excel. C# Aspose.Cells. A XLTX és a BMP mentési formátum egyesítése. C# A XLTX és a BMP formátum kombinálása. Egyesítse a XLTX-BMP-et a C#-ben. XLTX Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A XLTX és a BMP egyesítése a C#-ben" %}}

A következő példa bemutatja a XLTX és a BMP egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLTX-es és a BMP-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a BMP fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a XLTX és BMP számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a XLTX és BMP közötti egyesítéshez a C#-ben" InputFormat="xltx" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLTX és a BMP egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLTX-et a BMP-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLTX és BMP egyesítéséhez" %}}
