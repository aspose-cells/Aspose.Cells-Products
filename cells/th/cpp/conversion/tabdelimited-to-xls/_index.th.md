...
ต้องการแปลงไฟล์ TABDELIMITED เป็น XLS โดยใช้โปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลง TABDELIMITED เป็น XLS ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง TABDELIMITED เป็น XLS โดยเรียกใช้เมธอด Save()
