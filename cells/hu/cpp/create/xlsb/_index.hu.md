---
title: XLSB létrehozása – XLSB fájl létrehozása a C++-ben
description: Aspose Excel. Könnyedén generálhat és kezelhet XLSB fájlokat a Aspose.Cells for C++ könyvtárral. Ez a nagy teljesítményű API leegyszerűsített és hatékony megoldást kínál a XLSB fájlok létrehozására, szerkesztésére és kezelésére közvetlenül a C++ alkalmazásokban, nagy pontossággal kielégítve a fejlesztők speciális igényeit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Hozzon létre XLSB fájlt a C++ helyen" h2="Natív és nagy teljesítményű XLSB fájl létrehozása programozottan a Micorsoft Office nélkül a C++ könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="A XLSB létrehozása a C++-ben" %}}
...
1.  Mentse el a munkafüzetet .xlsb fájlként a Save() metódussal.

{{% blocks/products/pf/agp/code-block title="A mintakód megmutatja, hogyan kell létrehozni a XLSB fájlt a C++-ben." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ könyvtárat a XLSB fájl létrehozásához" %}}
