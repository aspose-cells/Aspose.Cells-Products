...
{{% blocks/products/pf/agp/feature-section-col title="Postup přidání vodoznaku na XLSM via Java" %}}
...
1.  Uložte sešit ve formátu XLSM
...
{{% blocks/products/pf/agp/code-block title="Přidejte vodoznak na XLSM - Java" offSpacer="" %}}
