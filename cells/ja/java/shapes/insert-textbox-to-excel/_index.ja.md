...
{{% blocks/products/pf/agp/content h2="Java を使用して Excel ファイルに TextBox を挿入する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="TextBox を Excel ファイルに挿入する手順 via Java" %}}
...
+ インデックスからワークシートを選択します。
 + を使用してください[メソッドの追加](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addTextBox-int-int-int-int-int-int-)選択したワークシートに TextBox を挿入するには
...
{{% blocks/products/pf/agp/code-block title="テキストボックスの挿入 - Java" offSpacer="" %}}
