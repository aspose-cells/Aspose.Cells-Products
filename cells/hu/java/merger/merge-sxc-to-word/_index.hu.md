---
title: A SXC egyesítése a WORD-dal – a SXC egyesítése a WORD-dal a Java-ben
url: /hu/java/merger/merge-sxc-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés SXC WORD mentési formátumba. Java Kombinálja a SXC-et WORD formátumba. A SXC egyesítése a WORD-hoz a Java-ben. SXC Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a SXC-et a WORD-dal a Java-ben online" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a SXC-et a WORD-dal a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SXC és a WORD egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el WORD fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a SXC-et a WORD-ba.
...
{{% blocks/products/pf/agp/content h2="A SXC és a via Java WORD egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SXC-et a WORD-dal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a SXC és a WORD egyesítéséhez" %}}
