---
title: Dividir archivos ODS a través de Java 
weight: 1950
url: /es/java/splitter/ods/ 
description: Java código de ejemplo para dividir documentos ODS en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dividir archivos ODS a través de Java" h2="División de ODS con la ayuda de la biblioteca Java del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo dividir un archivo ODS usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para dividir archivos ODS en Java" %}}
...
+ Llame al método de guardado con la nueva ruta del archivo ODS.
...
{{% blocks/products/pf/agp/code-block title="Dividir archivo ODS - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API se puede usar para crear, editar, convertir y representar formatos de Microsoft Excel en diferentes formatos. Además, se puede usar para gráficos completos, informes escalables y cálculos confiables dentro de las aplicaciones de software. Aspose.Cells es un API independiente y no requiere ningún software como Microsoft u OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo del divisor ODS en línea" sectionDescription="Divida el documento ODS ahora mismo visitando nuestro [Sitio web de demostraciones en vivo](https://products.aspose.app/cells/splitter). La demostración en vivo tiene los siguientes beneficios" >}}
