---
title:  Combinar TSV a ODS via Java
...
El siguiente ejemplo muestra cómo combinar TSV con ODS en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar TSV a ODS en línea" InputFormat="tsv" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
