...
description: Aspose Excel. 이 포괄적인 솔루션은 C# 개발자에게 탭으로 구분된 데이터를 Excel 형식으로 변환하는 완벽하게 통합된 접근 방식을 제공하여 Aspose.Cells 라이브러리를 사용하여 효율적이고 사용자 정의 가능한 C# 코드를 통해 탭으로 구분된 데이터를 Excel 형식으로 원활하게 저장할 수 있도록 합니다.
...
{{% blocks/products/pf/agp/content h2="C#에 TABDELIMITED를 EXCEL에 저장" %}}

다음 예시는 C#에서 TABDELIMITED를 EXCEL로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="TABDELIMITED를 Excel로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="tsv" outformat="xlsx" IsLandingPage="true" %}}
...
1.  워크북의 Save 메서드를 호출하여 TABDELIMITED 형식을 Excel 형식으로 변환합니다.
1.  TABDELIMITED를 EXCEL로 변환한 결과를 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 탭으로 구분된 데이터를 엑셀 파일로 변환하는 라이브러리" %}}
