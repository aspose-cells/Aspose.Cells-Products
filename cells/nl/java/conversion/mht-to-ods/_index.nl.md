...
description: Aspose Excel. Converteer MHT snel en eenvoudig naar ODS met Aspose.Cells. Java MHT naar ODS. Java Bewaar MHT naar ODS. Sla MHT op als ODS met Java.
...
{{% blocks/products/pf/agp/content h2="Bewaar MHT op ODS in Java" %}}

In het volgende voorbeeld ziet u hoe u MHT converteert naar ODS in Java.
...
{{% blocks/products/pf/agp/content h2="MHT converteren naar ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHT-bestanden programmatisch naar ODS converteren? Java-ontwikkelaars kunnen MHT eenvoudig met slechts een paar regels code naar ODS converteren.
