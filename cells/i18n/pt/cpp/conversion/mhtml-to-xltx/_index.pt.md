---
title: Converter MHTML para XLTX por meio do aplicativo C++ 
weight: 6610
url: /pt/cpp/conversion/mhtml-to-xltx/ 
description: Exemplo de código de conversão C++ de documento MHTML para formato XLTX. Os programadores podem usar esse código-fonte para conversão em lote de MHTML para XLTX em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MHTML para XLTX via C++" h2="Conversão de MHTML para XLTX de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem facilmente converter arquivos MHTML para XLTX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo MHTML usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (XLTX).1. arquivo XLTX será salvo no caminho especificado.1. Abra o arquivo XLTX em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de MHTML para XLTX C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de MHTML para XLTX" sectionDescription="[Converter MHTML para XLTX](https://products.aspose.app/cells/conversion/mhtml-to-xltx) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo MHTML, ele será convertido instantaneamente para XLTX." >}}
