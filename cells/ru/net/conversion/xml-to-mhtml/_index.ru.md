...
{{< blocks/products/pf/i18n/upper-banner h1="Преобразовать XML в MHTML в C#" h2="Высокоскоростная библиотека C# для преобразования XML в MHTML. Это профессиональное программное решение для импорта и экспорта XML, MHTML и многих других форматов на платформах .NET Framework, .NET Core или Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
Вам нужно программно преобразовать XML-файлы в MHTML? Разработчики .NET могут легко загружать и конвертировать XML в MHTML всего за несколько строк кода.
...
1.  Преобразовать XML в формат MHTML, вызвав метод Workbook.Save.
