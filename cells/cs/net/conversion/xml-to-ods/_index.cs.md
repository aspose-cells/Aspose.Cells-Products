---
title: C# XML na ODS - Převodník XML na ODS
description: Aspose Excel. Převeďte XML na ODS rychle a snadno pomocí Aspose.Cells. C# XML na ODS. C# Uložte XML na ODS. Uložte XML jako ODS pomocí 0716183
...
{{% blocks/products/pf/agp/content h2="Uložte XML na ODS v C#" %}}

Následující příklad ukazuje, jak převést XML na ODS v C#.
...
{{% cells-convert title="Ukázkový kód pro převod XML na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na ODS přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XML na ODS programově? Vývojáři .NET mohou snadno načíst a převést XML na ODS v několika řádcích kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML na ODS" %}}
