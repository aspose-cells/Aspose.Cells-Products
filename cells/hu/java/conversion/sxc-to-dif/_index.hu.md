---
title: "SXC konvertálása DIF-re a következőn keresztül: Java "

description: Minta Java konverziós kód az SXC formátumhoz DIF fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására DIF-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása DIF-re a következőn keresztül: Java" h2="SXC-ből DIF-be Java konverzió egyetlen vagy több oldal konvertálásához DIF-be a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása DIF-re a következővel: Java" %}}

 Ahhoz, hogy az SXC-t DIF-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása DIF-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A(z) Java fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják az SXC fájlt DIF formátumba.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat DIF kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott DIF-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="SXC to DIF Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az SXC fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.sxc");
// mentse az SXC-t DIF-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC-ből DIF-be konvertáló élő bemutatók" sectionDescription="[Az SXC konvertálása DIF-re](https://products.aspose.app/cells/conversion/sxc-to-dif) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel az SXC fájlt, és azonnal DIF formátumba konvertálódik." >}}
