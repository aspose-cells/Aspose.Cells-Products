---
title: Převést NUMBERS na TIFF přes Java 
url: /cs/java/conversion/numbers-to-tiff/ 
description: Ukázka převodního kódu Java pro formát NUMBERS na soubor TIFF. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do formátu TIFF v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést NUMBERS na TIFF přes Java" h2="Převod NUMBERS na TIFF Java pro převod jedné nebo více stránek na TIFF pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ČÍSLA na TIFF pomocí Java" %}}

 K vykreslení NUMBERS na TIFF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu NUMBERS na TIFF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor NUMBERS na TIFF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst NUMBERS soubor s instancí Workbook1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Voláním metody SheetRender.toImage uložíte výsledek ve formátu TIFF
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze NUMBERS na TIFF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze NUMBERS na TIFF" sectionDescription="[Převést ČÍSLA na TIFF](https://products.aspose.app/cells/conversion/numbers-to-tiff) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor NUMBERS, bude okamžitě převeden na TIFF." >}}
