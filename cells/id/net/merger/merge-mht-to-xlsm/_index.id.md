...
description: Aspose Unggul. C# Aspose.Cells. Gabungkan MHT ke format simpan XLSM. C# Gabungkan MHT ke format XLSM. Gabungkan MHT ke XLSM di C#. Gabungkan MHT.
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHT ke XLSM di C#" %}}

Contoh berikut menunjukkan cara menggabungkan MHT ke XLSM di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan MHT ke XLSM. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file XLSM. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan MHT menjadi XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan MHT ke XLSM di C#" InputFormat="mht" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHT ke XLSM lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan MHT ke XLSM secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Library .NET untuk menggabungkan MHT menjadi XLSM" %}}
