---
title: Java EXCEL na ODS - Konwerter online EXCEL na ODS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwertuj EXCEL na format zapisu ODS. Java EXCEL do formatu ODS. Zapisz EXCEL pod numerem ODS Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL pod numerem ODS w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować EXCEL na ODS w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować plik EXCEL na ODS. Prześlij plik EXCEL, a następnie po prostu zapisz go jako plik ODS. Zarówno do odczytu EXCEL, jak i zapisu ODS można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie ODS będą identyczne z oryginalnym dokumentem EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji EXCEL na ODS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować EXCEL na ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki EXCEL na ODS? Java programiści mogą łatwo przekonwertować EXCEL na ODS w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCEL na ODS" %}}
{{% blocks/products/pf/agp/text %}}
