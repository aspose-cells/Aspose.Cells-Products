---
title: Python XLSX naar XLSB - Online XLSX naar XLSB Converter
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Gratis online Python Converteer XLSX naar XLSB saveformat. Python XLSX tot XLSB formaat. Bewaar XLSX tot XLSB Python.
...
Het volgende voorbeeld laat zien hoe u XLSX converteert naar XLSB in Python via NET.
...
{{% cells-convert title="Gratis app en voorbeeldcode om XLSX online naar XLSB te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xlsb" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSX naar XLSB te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLSX-bestanden programmatisch converteren naar XLSB? Python-ontwikkelaars kunnen eenvoudig XLSX laden en converteren naar XLSB in slechts een paar regels code.
...
1.  Verkrijg het conversieresultaat van XLSX naar XLSB.
