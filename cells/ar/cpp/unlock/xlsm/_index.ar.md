...
{{% blocks/products/pf/agp/content h2="كيفية إزالة الحماية من ملف XLSM باستخدام C++" %}}
...
1. قم بتحميل ملف مقفل بـ XLSM باستخدام CreateIWorkbook.1. استدعاء وظيفة Unprotect () لفتح.1. اضبط كلمة المرور على NULL باستخدام SetPassword.1. احفظ ملف XLSM في موقع محدد.
