...
description: Sample code for XLSB to ODS C# conversion. Use API example code for batch XLSB files to ODS conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells makes it easy for the developers to load & convert XLSB files to ODS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XLSB to ODS C# Conversion" offSpacer="" %}}
