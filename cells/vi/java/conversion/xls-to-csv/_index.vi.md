---
title: Java XLS sang CSV - XLS sang CSV Bộ chuyển đổi
description: Aspose Excel. Chuyển đổi XLS sang CSV nhanh chóng và dễ dàng với Aspose.Cells. Java XLS sang CSV. Java Lưu XLS thành CSV. Lưu XLS thành 07611134 81 sử dụng Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS thành CSV thành Java" h2="Thư viện Java tốc độ cao chuyển đổi XLS thành CSV. Đây là giải pháp phần mềm chuyên nghiệp để nhập xuất XLS, CSV và nhiều định dạng khác sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS vào CSV trong Java" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLS thành CSV trong Java.
...
{{% cells-convert title="Mã mẫu chuyển đổi XLS thành CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="csv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS thành CSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLS thành CSV theo chương trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi XLS thành CSV chỉ bằng vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java chuyển đổi XLS thành CSV" %}}
{{% blocks/products/pf/agp/text %}}
