---
title: Convertir CSV a BMP a través de Java 
weight: 3540
url: /es/java/conversion/csv-to-bmp/ 
description: Ejemplo de código de conversión Java de formato CSV a archivo BMP. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a BMP dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir CSV a BMP a través de Java" h2="Conversión de CSV a BMP Java para convertir una o varias páginas a BMP mediante la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir CSV a BMP usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir CSV a BMP a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo CSV a BMP con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo CSV con una instancia de Workbook1. Seleccione predeterminado o cualquier hoja de trabajo de la colección1. Crear y establecer el objeto de ImageOrPrintOptions1. Cree SheetRender con objetos Worksheet e ImageOrPrintOptions1. Llame al método SheetRender.toImage para guardar el resultado en formato BMP
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de CSV a BMP Java" offSpacer="" %}}

```cs
// cargue el archivo CSV para ser renderizado
