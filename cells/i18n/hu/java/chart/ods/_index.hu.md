...
{{% blocks/products/pf/agp/content h2="ODS fájldiagramok létrehozása a következővel: Java" %}}

 Az ODS fájldiagramok létrehozásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az ODS-fájlok diagramjainak létrehozásához itt: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ODS-fájlok diagram létrehozása – Java" offSpacer="" %}}
