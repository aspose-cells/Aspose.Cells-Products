...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter XLTX in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie OTS in C# in XLTX konvertiert wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in XLTX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1.  Laden Sie die OTS-Datei mit einer Instanz von Workbook
1.  Konvertieren Sie OTS in XLTX, indem Sie die Workbook.Save-Methode aufrufen

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von OTS in XLTX" %}}
