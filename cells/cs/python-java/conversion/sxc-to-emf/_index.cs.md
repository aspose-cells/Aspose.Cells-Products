---
title: Převést SXC na EMF přes Python
url: /cs/python-java/conversion/sxc-to-emf/
description: Ukázkový kód pro převod sxc na emf Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na emf v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na EMF pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod SXC na EMF prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na EMF pomocí několika řádků kódu.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="emf" IsLandingPage="true" language="python" %}}
