---
title: Microsoft Excel文件轉換使用Python via NET
...
電子表格格式的相互轉換只需要加載一個帶有實例的電子表格[工作簿](https://reference.aspose.com/cells/python-net/aspose.cells/workbook/)並以所需的格式保存回，同時從中選擇適當的值[保存格式](https://reference.aspose.com/cells/python-net/aspose.cells/saveformat/)枚舉。
...
使用時可以加載任何電子表格並將其轉換為 Word DOCX & PowerPoint PPTX 文件[DocxSave選項](https://reference.aspose.com/cells/python-net/aspose.cells/docxsaveoptions/) & [PptxSave選項](https://reference.aspose.com/cells/python-net/aspose.cells/pptxsaveoptions/)類如下所示。
