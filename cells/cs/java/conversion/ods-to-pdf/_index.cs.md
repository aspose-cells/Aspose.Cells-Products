---
title: Převést ODS na PDF prostřednictvím Java 
weight: 4170
url: /cs/java/conversion/ods-to-pdf/ 
description: Ukázkový konverzní kód Java pro formát ODS na soubor PDF. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do PDF v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODS na PDF prostřednictvím Java" h2="Převod ODS na PDF Java pro převod jedné nebo více stránek do PDF pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODS do PDF pomocí Java" %}}

 K vykreslení ODS do PDF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod ODS na PDF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS do formátu PDF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Jako parametry předejte výstupní cestu s rozšířením PDF a SaveFormat1. Zkontrolujte zadanou cestu pro výsledný soubor PDF
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu ODS na PDF Java" offSpacer="" %}}
