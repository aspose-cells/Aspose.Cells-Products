...
url: /tr/python-net/merger/merge-ots-to-pptx/ 
...
Aşağıdaki örnek, OTS'nin Aspose.Cells for Python via .NET'de PPTX ile nasıl birleştirileceğini gösterir.
...
OTS'yi programlı olarak PPTX ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
