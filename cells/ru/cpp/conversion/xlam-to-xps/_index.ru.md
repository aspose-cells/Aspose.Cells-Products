...
Нужно программно преобразовать файлы XLAM в XPS? Разработчики, работающие с файлами C++, могут легко преобразовать файлы XLAM в XPS всего несколькими строками кода.
