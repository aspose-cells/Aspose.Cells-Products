---
title:  Rechercher et remplacer du texte dans le document XLSM via C++
weight: 9570
description: Exemple de code C++ pour masquer les informations sensibles dans le fichier XLSM sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
