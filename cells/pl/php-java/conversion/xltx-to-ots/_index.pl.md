...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLTX na OTS za pomocą Aspose.Cells. PHP XLTX na OTS. PHP Zapisz XLTX w OTS. Zapisz XLTX jako OTS przy użyciu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTX na OTS przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLTX na OTS? Programiści PHP mogą łatwo załadować i przekonwertować XLTX na OTS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLTX na OTS, wywołując metodę zapisu skoroszytu.
