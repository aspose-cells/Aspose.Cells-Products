---
title: Chèn ActiveX Control vào Excel bằng Python via Java
weight: 10
description: Python via Java mã nguồn chèn ActiveX Control vào Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chèn ActiveX Control vào Excel bằng Python via java" h2="Chèn đối tượng bằng API phía máy chủ mà không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn ActiveX Control vào File Excel Bằng Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn ActiveX Control vào file Excel dùng Python via java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)) để chèn Điều khiển ActiveX vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn điều khiển ActiveX - Python via java" offSpacer="" %}}
