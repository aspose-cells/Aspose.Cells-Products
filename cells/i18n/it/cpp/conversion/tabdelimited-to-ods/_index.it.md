---
title: Converti TABDELIMITED in ODS tramite l'applicazione C++ 
url: /it/cpp/conversion/tabdelimited-to-ods/ 
description: Esempio di codice di conversione C++ per il documento TABDELIMITE in formato ODS. I programmatori possono utilizzare questo codice sorgente per la conversione batch da TABDELIMITE a ODS all'interno di qualsiasi C++ Applicazione.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti TABDELIMITED in ODS tramite C++" h2="Conversione da TABDELIMITED a ODS ad alte prestazioni utilizzando la libreria C++ senza la necessità di installare Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente il file TABDELIMITED in ODS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TABDELIMITED utilizzando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (ODS).1. Il file ODS verrà salvato nel percorso specificato.1. Apri il file ODS nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED a ODS C++ codice sorgente di conversione" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo dal vivo di conversione da TABDELIMITED a ODS" sectionDescription="[Converti TABDELIMITED in ODS](https://products.aspose.app/cells/conversion/tabdelimited-to-ods) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file TABDELIMITED, verrà convertito istantaneamente in ODS." >}}
