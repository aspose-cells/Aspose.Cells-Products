---
title: 創建HTM - 在Java中創建HTM文件
description: Aspose Excel。 Java 創建 HTM 文件。創建 HTM Java。Java HTM 創建者。在Java中創建HTM。使用Java生成HTM文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建HTM" %}}
...
1. 使用 save() 方法將工作簿保存為 HTM 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 HTM 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java 創建HTM文件的庫" %}}
{{% blocks/products/pf/agp/text %}}
