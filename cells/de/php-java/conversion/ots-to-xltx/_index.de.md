...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in XLTX mit Aspose.Cells. PHP OTS in XLTX. PHP Speichern Sie OTS in XLTX. Speichern Sie OTS mit PHP als XLTX.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in XLTX" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in XLTX konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in XLTX konvertieren.
...
1.  Konvertieren Sie OTS in XLTX, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in XLTX" %}}
