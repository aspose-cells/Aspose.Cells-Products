...
{{% blocks/products/pf/agp/text %}}
 ...
 Geliştiricilerin, yalnızca birkaç kod satırında veri işleme için çalışan raporlama uygulamaları içinde MHT dosyalarını oluşturması, yüklemesi, değiştirmesi ve dönüştürmesi kolaydır.
