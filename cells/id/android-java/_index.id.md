...
{{< blocks/products/pf/i18n/upper-banner h1="API Android untuk Memanipulasi Spreadsheet Excel" h2="Buat, baca, tulis, atau manipulasi file Excel dalam aplikasi Android tanpa ketergantungan apa pun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-android-java.svg" pfName="Aspose.Cells" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/cells/androidjava" >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Kemerdekaan" description="Aspose.Cells untuk Android melalui Java tersedia untuk Android 2.0 atau lebih tinggi." >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Spreadsheet Android API mendukung format Microsoft Excel, gambar, dan format tata letak tetap yang populer." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Android Excel Lanjutan API Fitur
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Terapkan pemformatan ke lembar kerja, baris, kolom, sel, dan rentang
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ekspor dan impor data dari ArrayList, Array, Recordset &amp; Hasilset
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Enkripsi &amp; mendekripsi file Excel
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Setel &amp; memanipulasi filter otomatis &amp; jeda halaman
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Memanipulasi sel &amp; rentang bernama
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Mengonversi lembar kerja &amp; grafik ke gambar
    </p>
   </div>
   <!--<div class="col-lg-12">
...
-->
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Mesin kalkulasi formula yang kuat
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Pustaka Android Excel menawarkan konversi spreadsheet ke XPS, PDF &amp; Format HTML menjaga kesetiaan visual tertinggi. Proses konversi yang andal menjadikan API pilihan yang sempurna bagi perusahaan untuk bertukar file dalam format standar industri.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Simpan Buku Kerja dalam berbagai format - Java
     </h3>
...
<p>Aspose.Cells for Android via Java gives you complete freedom and flexibility to furnish your spreadsheets with all kinds of visual effects. The API allows you to apply different fonts with attributes, cell styles (alignment, indentation, rotation, borders, shading and coloring, protection, text wrapping and shrinking) and all types of number formats. Similarly, charts and graphics are visually appealing and can give your spreadsheet a professional look. Aspose.Cells for Android via Java provides a comprehensive set of APIs for creating and manipulating all of the standard and custom chart types. Moreover, you may add different types of drawing objects, such as comments, pictures, OLE objects, shapes and controls to the cells.</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells untuk Android melalui Java menawarkan beberapa fitur khusus seperti lembar kerja ke gambar, bagan ke gambar &amp; Konversi format dokumen PDF dan spreadsheet ke PDF. Proses fleksibel memiliki sejumlah pilihan untuk konversi, seperti pengambilan sampel ulang gambar selama spreadsheet ke PDF atau menyetel dimensi gambar yang dihasilkan saat merender lembar kerja &amp; grafik ke format gambar.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Spreadsheet API Mesin Penghitung Rumus
    </h2>
    <p>
     Lembar Android API menyediakan Mesin Penghitung Rumus canggih yang mendukung fungsi dan rumus Microsoft Excel standar dan lanjutan. Mesin kalkulasi rumus memudahkan untuk membaca, menyetel, dan menghitung hasil tipe bawaan atau tambahan, larik, dan rumus gaya referensi R1C1.
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="Dokumentasi" href="https://docs.aspose.com/cells/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Mengapa Aspose.Cells untuk Android melalui Java?" tabId="success-stories" >}}
