---
title: Convert SPREADSHEETML to NUMBERS via Java 
url: /java/conversion/spreadsheetml-to-numbers/ 
description: Sample Java conversion code for SPREADSHEETML format to NUMBERS file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to NUMBERS within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert SPREADSHEETML to NUMBERS via Java" h2="SPREADSHEETML to NUMBERS Java conversion to convert single or multiple pages to NUMBERS using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert SPREADSHEETML to NUMBERS Using Java" %}}

 In order to render SPREADSHEETML to NUMBERS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert SPREADSHEETML to NUMBERS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells API makes it easy for the developers to convert SPREADSHEETML file to NUMBERS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML to NUMBERS Java Conversion Source Code" offSpacer="" %}}

```cs
// load the SPREADSHEETML file in an instance of Workbook
Workbook book = new Workbook("template.spreadsheetml");
// save SPREADSHEETML as NUMBERS
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML to NUMBERS Conversion Live Demos" sectionDescription="[Convert SPREADSHEETML to NUMBERS](https://products.aspose.app/cells/conversion/spreadsheetml-to-numbers) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your SPREADSHEETML file, it will be converted instantly to NUMBERS." >}}
