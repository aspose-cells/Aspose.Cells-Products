---
title:  XLSX Dosyalarını Birleştir via .NET
weight: 8290
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarındaki XLSX belgelerini birleştirmek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSX Formatlarını C#\'de Birleştir" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanılmadan, sunucu tarafı Aspose.Cells for .NET API\'lerini kullanarak yerel ve yüksek performanslı XLSX belge birleştirme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Save() yöntemini çağırın ve dosya adını (tam yol) ve biçimini (XLSX) parametre olarak iletin.
+ Artık XLSX dosyasını Microsoft Office, Adobe PDF veya başka bir uyumlu programda açıp kullanabilirsiniz.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi XLSX Birleşme Canlı Demoları" sectionDescription=" XLSX belgemizi hemen ziyaret ederek birleştirin[Canlı Demolar web sitesi](https://products.aspose.app/cells/merger). Canlı demo aşağıdaki avantajlara sahiptir" >}}
