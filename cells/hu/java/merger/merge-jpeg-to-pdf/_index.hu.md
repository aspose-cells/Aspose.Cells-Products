---
title: A JPEG-PDF-es számok egyesítése – a JPEG-es és a PDF-es számok egyesítése a Java-ben
url: /hu/java/merger/merge-jpeg-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. A JPEG és a PDF mentési formátum egyesítése. Java A JPEG és a PDF formátum kombinálása. Egyesítse a JPEG-PDF-et a Java-ben. JPEG Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A JPEG és a PDF egyesítése a Java-ben" %}}

A következő példa bemutatja a JPEG és a PDF egyesítését a Aspose.Cells for Java számban.
...
{{% cells-merger title="Mintakód a JPEG és PDF közötti egyesítéshez a Java-ben" InputFormat="jpg" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A JPEG és a PDF via Java számok egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a JPEG-et a PDF-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a JPEG és PDF egyesítéséhez" %}}
