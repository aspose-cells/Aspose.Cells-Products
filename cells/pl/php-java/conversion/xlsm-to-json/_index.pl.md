...
description: Aspose Excel. Konwertuj XLSM na JSON szybko i łatwo za pomocą Aspose.Cells. PHP XLSM na JSON. PHP Zapisz XLSM na JSON. Zapisz XLSM jako JSON używając PHP.
...
Chcesz programowo przekonwertować pliki XLSM na JSON? Programiści PHP mogą łatwo załadować i przekonwertować XLSM na JSON w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSM na numer JSON, wywołując metodę zapisu skoroszytu.
