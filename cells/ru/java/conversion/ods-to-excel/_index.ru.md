...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики Java могут легко преобразовать ODS в EXCEL, написав всего несколько строк кода.
