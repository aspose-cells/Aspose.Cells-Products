---
title: Java ods の修復 - 破損した ods ファイルを回復して修正します
url: /ja/java/recovery/repair-ods/ 
description: Java Aspose.Cells. 修理オッズ。 odsファイルを修正。 ods回復ツール。オッズの破損。 odsデータを復元します。 odsファイルのリカバリ。破損したodsファイルを回復します。
...
{{% cells-recovery title="ODSファイルを修復するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="java" %}}    
