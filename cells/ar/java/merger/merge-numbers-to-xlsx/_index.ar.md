---
title:  دمج الأرقام في XLSX via Java
...
يوضح المثال التالي كيفية دمج الأرقام مع XLSX في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج الأرقام في XLSX على الإنترنت" InputFormat="numbers" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
