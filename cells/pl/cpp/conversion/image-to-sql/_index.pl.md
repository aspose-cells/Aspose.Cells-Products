...
description: Aspose Excel. Szybko i łatwo przekonwertuj IMAGE na SQL za pomocą Aspose.Cells. C++ IMAGE na SQL. C++ Zapisz OBRAZ do SQL. Zapisz OBRAZ jako SQL, używając numeru C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj OBRAZ na SQL w C++" h2="Wysokowydajna konwersja OBRAZU do SQL przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  Konwertuj OBRAZ na SQL, wywołując metodę Save().
