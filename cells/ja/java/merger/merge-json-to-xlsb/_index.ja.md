---
title:  JSON を XLSB via Java に結合
url: /ja/java/merger/merge-json-to-xlsb/ 
description: JSON を XLSB にオンラインで無料で結合します。無料オンラインJSONからXLSB合併。 JSON を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、JSON を Java の XLSB にマージする方法を示しています。
...
{{% cells-merger title="オンラインでJSONをXLSBにマージする無料アプリ" InputFormat="json" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
