...
{{% blocks/products/pf/agp/content h2="Convert ODS to POWERPOINT in Python" %}}
...
The following example demonstrates how to convert ODS to POWERPOINT in Python via NET.
