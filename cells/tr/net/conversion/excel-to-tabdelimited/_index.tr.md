...
EXCEL dosyalarını program aracılığıyla TABDELIMITED'e dönüştürmeniz mi gerekiyor? .NET geliştiriciler yalnızca birkaç satır kodla EXCEL'i kolayca yükleyebilir ve TABDELIMITED'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını TABLOELIMITED formatına dönüştürün.
