---
title: HTM samenvoegen met DOCX - HTM samenvoegen met DOCX in Java
url: /nl/java/merger/merge-htm-to-docx/ 
description: Aspose Excel. Java Aspose.Cells. HTM samenvoegen naar DOCX opslagformaat. Java Combineer HTM met DOCX formaat. HTM samenvoegen naar DOCX in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTM samen met DOCX in Java" %}}

Het volgende voorbeeld laat zien hoe u HTM samenvoegt met DOCX in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen met DOCX. Upload uw bestanden, bel de Workbook.Combine-methode voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand DOCX. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java waarin HTM wordt samengevoegd met DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om HTM samen te voegen met DOCX in Java" InputFormat="htm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen met DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met DOCX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen met DOCX" %}}
