...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики C++ могут легко преобразовать FODS в DOCX всего за несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл FODS с помощью Factory::CreateIWorkbook.
1. Преобразуйте FODS в DOCX, вызвав метод Save().
