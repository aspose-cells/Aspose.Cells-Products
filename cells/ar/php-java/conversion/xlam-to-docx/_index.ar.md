---
title: PHP XLAM إلى DOCX - XLAM إلى DOCX محول
description: Aspose اكسل. قم بتحويل XLAM إلى DOCX بسرعة وسهولة باستخدام Aspose.Cells. PHP XLAM إلى DOCX. PHP احفظ XLAM إلى DOCX. احفظ XLAM كـ DOCX باستخدام PHP.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLAM إلى DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="docx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLAM إلى DOCX عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLAM إلى DOCX برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLAM إلى DOCX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLAM إلى DOCX عن طريق استدعاء طريقة حفظ المصنف.
