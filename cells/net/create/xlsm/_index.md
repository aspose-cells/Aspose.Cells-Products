...
url: /net/create-xlsm/ 
description: C# Sample code for generating XLSM documents. Use this code for creating MS Excel XLSM files within VB.NET, Asp.NET or any .NET based application.
---
