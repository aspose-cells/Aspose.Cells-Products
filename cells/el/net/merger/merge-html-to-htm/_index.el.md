---
title:  Συγχώνευση HTML στο HTM μέσω C#
url: /el/net/merger/merge-html-to-htm/ 
description: Συγχώνευση HTML στο HTM Online δωρεάν. Δωρεάν Online HTML to HTM Merger. Συγχώνευση HTML σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το HTML στο HTM στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση HTML σε HTM σε απευθείας σύνδεση" InputFormat="html" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
