---
title: Java Xlsm Onarımı - Bozuk xlsm Dosyasını Kurtarın ve Onarın
url: /tr/java/recovery/repair-xlsm/ 
description: Java Aspose.Cells. Xlsm'yi onarın. Xlsm dosyasını düzeltin. xlsm kurtarma aracı. xlsm bozulması. Xlsm verilerini geri yükleyin. xlsm dosya kurtarma. Bozuk xlsm dosyasını kurtarın.
...
{{% blocks/products/pf/agp/content h2="Java\'deki xlsm dosyası nasıl onarılır" %}}
...
{{% cells-recovery title="XLSM dosyasını onarmak için örnek kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsm" outformat="xlsm" IsLandingPage="true" language="java" %}}    
