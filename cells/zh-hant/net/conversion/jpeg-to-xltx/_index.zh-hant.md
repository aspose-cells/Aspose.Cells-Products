...
{{% blocks/products/pf/agp/content h2="免費在線保存JPEG至XLTX至C#" %}}

以下示例演示如何將 C# 中的 JPEG 轉換為 XLTX。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 JPEG 轉換為 XLTX。上傳您的 JPEG 文件，然後將其另存為 XLTX 文件。對於 JPEG 讀取和 XLTX 寫入，您可以使用完全限定的文件名。輸出 XLTX 內容和格式將與原始 JPEG 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="在線將 JPEG 轉換為 XLTX 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xltx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過C#將JPEG轉換為XLTX" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 JPEG 為 XLTX。

{{% /blocks/products/pf/agp/text %}}

1. 使用工作簿實例加載 JPEG 文件
1. 通過調用 Workbook.Save 方法將 JPEG 轉換為 XLTX

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 庫將 JPEG 轉換為 XLTX" %}}
