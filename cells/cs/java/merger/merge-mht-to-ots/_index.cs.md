---
title: Sloučit MHT s OTS – Zkombinujte MHT s OTS v Java
url: /cs/java/merger/merge-mht-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do OTS saveformat. Java Zkombinujte formát MHT s formátem OTS. Sloučit MHT do OTS v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT s OTS v Java" %}}

Následující příklad ukazuje, jak sloučit MHT do OTS v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT s OTS. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru OTS. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který spojuje MHT s OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT do OTS v Java" InputFormat="mht" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT s OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit MHT s OTS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna pro sloučení MHT s OTS" %}}
