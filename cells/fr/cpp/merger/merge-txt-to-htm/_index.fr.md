---
title: Fusionner TXT à HTM - Combiner TXT à HTM dans C++
url: /fr/cpp/merger/merge-txt-to-htm/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion en ligne gratuite TXT au format de sauvegarde HTM. C++ Combinez TXT au format HTM. Fusionner TXT à HTM dans C++. TXT Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner TXT à HTM en utilisant C++" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner TXT à HTM dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner TXT en HTM dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner TXT en HTM. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier HTM. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne TXT en HTM.
...
{{% blocks/products/pf/agp/content h2="Comment fusionner TXT en HTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner TXT avec HTM par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner TXT à HTM" %}}
