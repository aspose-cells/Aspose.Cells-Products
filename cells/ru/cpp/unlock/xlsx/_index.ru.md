---
title:  Разблокируйте документ XLSX через C++.
weight: 3680
description: C++ пример кода для разблокировки защищенного паролем файла XLSX в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
