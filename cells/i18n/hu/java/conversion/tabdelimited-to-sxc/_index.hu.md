---
title: "TABDELIMITED konvertálása SXC-re a következőn keresztül: Java "
url: /hu/java/conversion/tabdelimited-to-sxc/ 
description: Minta Java konverziós kód a TABDELIMITED formátumhoz SXC fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására SXC-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED konvertálása SXC-re a következőn keresztül: Java" h2="TABDELIMITED SXC Java konverzió egyetlen vagy több oldal SXC formátumba konvertálásához az On-premise Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="A TABDELIMITED konvertálása SXC-re a következővel: Java" %}}

 A TABDELIMITED megjelenítéséhez SXC-re használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TABDELIMITED konvertálásához SXC-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak TABDELIMITED fájlt SXC formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat SXC kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott SXC fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED SXC Java konverziós forráskódra" offSpacer="" %}}

```cs
// töltse be a TABDELIMITED fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tabdelimited");
// a TABDELIMITED mentése SXC-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED SXC Conversion Live Demos" sectionDescription="[A TABDELIMITED konvertálása SXC-re](https://products.aspose.app/cells/conversion/tabdelimited-to-sxc) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a TABDELIMITED fájlt, és azonnal SXC formátumba konvertálódik." >}}
