---
title: A HTML egyesítése PRN-nel - A HTML-es szám egyesítése PRN-vel a C#-ben
url: /hu/net/merger/merge-html-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés HTML PRN mentési formátumba. C# Kombinálja a HTML-et PRN formátumba. Egyesítse a HTML-et a PRN-vel a C#-es számon. HTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a HTML-es számot a PRN-hez a C#-es online számmal ingyen" %}}

A következő példa bemutatja, hogyan egyesítheti a HTML-et a PRN-vel a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML és a PRN egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el PRN fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a HTML-et a PRN-be.
...
{{% blocks/products/pf/agp/content h2="HTML és a PRN egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTML-et a PRN-nel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML és a PRN egyesítéséhez" %}}
