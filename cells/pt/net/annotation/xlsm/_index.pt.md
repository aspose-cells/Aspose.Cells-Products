---
title:  Remover XLSM Anotação via .NET
weight: 9890
description: C# código-fonte para adicionar e excluir anotações de formato XLSM em .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
