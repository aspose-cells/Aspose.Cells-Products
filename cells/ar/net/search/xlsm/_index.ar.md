---
title:  ابحث عن مستند XLSM بدون فتح via .NET
weight: 4880
description: C# الكود المصدري للبحث عن الكلمات ذات النمط في ملف XLSM على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
