...
weight: 60
description: Python via mã nguồn java để chèn RadioButton(Form control) vào Excel.
...
{{% blocks/products/pf/agp/content h2="Cách chèn RadioButton(Form control) vào tệp Excel bằng Python via java" %}}

 Để chèn RadioButton(Form control) vào tệp excel, chúng tôi sẽ sử dụng
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) để chèn RadioButton(Điều khiển biểu mẫu) vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Insert RadioButton(Form control) - Python via java" offSpacer="" %}}
