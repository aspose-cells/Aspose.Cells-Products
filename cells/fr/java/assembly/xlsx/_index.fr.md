---
title:  Générer des rapports dans les fichiers XLSX via Java
weight: 7710
description: Exemple de code Java pour créer des rapports au format XLSX sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
...
1.  Enregistrer le résultat au format XLSX via la méthode Worbook.save
...
{{% blocks/products/pf/agp/code-block title="Générer des rapports Excel au format XLSX - Java" offSpacer="" %}}
