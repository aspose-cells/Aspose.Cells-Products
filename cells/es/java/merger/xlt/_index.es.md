---
title: Combinar archivos XLT a través de Java 
weight: 9960
url: /es/java/merger/xlt/ 
description: Java código de ejemplo para combinar documentos XLT en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos XLT en Java" h2="Fusión nativa de documentos XLT mediante API Java del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar archivos XLT usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para fusionar archivos XLT en Java" %}}
...
+ Cargue el primer archivo XLT con una instancia de la clase Workbook.
+ Cargue el segundo documento XLT con una instancia de la clase Workbook.
+ Combinar archivos usando el método combine().
+ guardar el archivo XLT fusionado en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Fusionar archivos XLT - Java" offSpacer="" %}}

```cs
// Abra el primer archivo XLT.
Workbook xltFile1 = new Workbook("chartsFileWithPath.xlt");

// Defina el segundo libro fuente.
// Abra el segundo archivo XLT.
