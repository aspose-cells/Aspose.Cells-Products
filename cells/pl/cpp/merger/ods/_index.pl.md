---
title: Scal pliki ODS przez C++ 
url: /pl/cpp/merger/ods/ 
description: C++ przykładowy kod do łączenia dokumentów ODS w C++ środowisku wykonawczym dla 32-bitowego systemu Windows, 64-bitowego systemu Windows i 64-bitowego systemu Linux.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Scal formaty ODS w C++" h2="Połączenie dokumentów ODS przy użyciu interfejsów API C++ po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak połączyć plik ODS za pomocą C++" %}}

Aby połączyć plik ODS, użyjemy <a href="https://products.aspose.com/cells/cpp">Aspose.Cells dla C++</a> API, który jest bogatym w funkcje, wydajnym i łatwym w użyciu narzędziem do łączenia dokumentów API dla platformy C++. Możesz pobrać jego najnowszą wersję bezpośrednio, po prostu otwórz <a href="https://www.nuget.org/packages/aspose.cells">NuGet</a> menedżer pakietów, szukaj <b>Aspose.Cells.Cpp</b> i zainstaluj. Możesz również użyć następującego polecenia z konsoli Menedżera pakietów.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki scalania plików ODS w C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Scal pliki ODS — C++" offSpacer="" %}}
