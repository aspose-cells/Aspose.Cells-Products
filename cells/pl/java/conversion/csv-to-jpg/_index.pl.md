---
title: Konwertuj CSV na JPG przez Java 
url: /pl/java/conversion/csv-to-jpg/ 
description: Przykładowy kod konwersji Java dla formatu CSV do pliku JPG. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do formatu JPG w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj CSV na JPG przez Java" h2="Konwersja CSV do JPG Java w celu konwersji jednej lub wielu stron do formatu JPG przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik CSV na JPG za pomocą Java" %}}

 Aby wyrenderować CSV do JPG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować CSV na JPG za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik CSV na JPG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem JPG i SaveFormat jako parametrami1. Sprawdź podaną ścieżkę dla wynikowego pliku JPG
...
{{% blocks/products/pf/agp/code-block title="CSV do JPG Java Kod źródłowy konwersji" offSpacer="" %}}
