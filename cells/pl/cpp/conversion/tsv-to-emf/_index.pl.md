---
title: Konwertuj TSV na EMF za pomocą aplikacji C++ 
weight: 5870
url: /pl/cpp/conversion/tsv-to-emf/ 
description: Przykładowy kod konwersji C++ dla dokumentu TSV do formatu EMF. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TSV na EMF w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TSV na EMF w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (EMF).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik EMF w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TSV do EMF C++ Kod źródłowy konwersji" offSpacer="" %}}
