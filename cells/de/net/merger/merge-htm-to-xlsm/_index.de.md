---
title: HTM mit XLSM zusammenführen – HTM mit XLSM in C# kombinieren
url: /de/net/merger/merge-htm-to-xlsm/ 
description: Aspose Excel. C# Aspose.Cells. Kostenloses Online-Merge-HTM zum XLSM-Speicherformat. C# Kombinieren Sie HTM mit dem Format XLSM. HTM zu XLSM in C# zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie HTM kostenlos mit XLSM in C# online zusammen" %}}

Das folgende Beispiel zeigt, wie HTM mit XLSM in Aspose.Cells for .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um HTM mit XLSM zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei XLSM. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das HTM mit XLSM zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlos online, um HTM mit XLSM in C# zusammenzuführen" InputFormat="htm" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie HTM über C# mit XLSM zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM programmgesteuert mit XLSM zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von HTM mit XLSM" %}}
