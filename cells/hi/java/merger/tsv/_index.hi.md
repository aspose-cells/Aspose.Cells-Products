---
title:  मर्ज TSV फ़ाइलें via Java
weight: 9260
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरनमेंट पर TSV दस्तावेज़ों को संयोजित करने के लिए Java नमूना कोड।
---
...
{{% blocks/products/pf/agp/content h2="TSV फ़ाइलों को Java का उपयोग करके कैसे मर्ज करें" %}}
...
+ कार्यपुस्तिका वर्ग के उदाहरण के साथ दूसरा TSV दस्तावेज़ लोड करें।
...
{{% blocks/products/pf/agp/code-block title="मर्ज TSV फ़ाइलें - Java" offSpacer="" %}}
