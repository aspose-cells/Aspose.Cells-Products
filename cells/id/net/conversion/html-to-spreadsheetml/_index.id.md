---
title: Konversi HTML ke SPREADSHEETML melalui C#
url: /id/net/conversion/html-to-spreadsheetml/
description: Contoh kode untuk konversi html ke spreadsheetml C#. Gunakan API kode contoh untuk file html batch ke konversi spreadsheetml dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi HTML ke SPREADSHEETML melalui C#" h2="Ekspor spreadsheet Excel® ke format SPREADSHEETML di Platform .NET Framework, .NET Core, Mono atau Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi file HTML ke SPREADSHEETML hanya dalam beberapa baris kode.
