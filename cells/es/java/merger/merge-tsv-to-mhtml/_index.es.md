---
title:  Combinar TSV a MHTML via Java
url: /es/java/merger/merge-tsv-to-mhtml/ 
description: Combine TSV a MHTML en línea de forma gratuita. Gratis Online TSV a MHTML Fusión. Combine TSV con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar TSV con MHTML en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar TSV a MHTML en línea" InputFormat="tsv" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
