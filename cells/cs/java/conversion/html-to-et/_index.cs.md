---
title: Java HTML na ET – Online převodník HTML na ET
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Online zdarma Java Převeďte HTML do formátu uložení ET. Java HTML do formátu ET. Uložit HTML do ET Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte HTML na ET v Java" h2="Vysokorychlostní knihovna Java pro převod HTML na ET. Toto je profesionální softwarové řešení pro import a export HTML, ET a mnoha dalších formátů pomocí Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete HTML na ET v Java online zdarma" %}}

Následující příklad ukazuje, jak převést HTML na ET v Java.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod HTML na ET Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="et" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak převést HTML na ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory HTML na ET programově? Vývojáři Java mohou snadno převést HTML na ET v několika řádcích kódu.
...
1.  Převeďte HTML na ET voláním metody Workbook.save.
1.  Získejte výsledek převodu HTML na ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod HTML na ET" %}}
{{% blocks/products/pf/agp/text %}}
