...
description: Aspose Excel. Konwertuj PRN na XLS szybko i łatwo za pomocą Aspose.Cells. Java PRN na XLS. Java Zapisz PRN na XLS. Zapisz PRN jako XLS używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN pod numerem XLS w Java" %}}

Poniższy przykład ilustruje sposób konwersji PRN na XLS w Java.
...
Chcesz programowo przekonwertować pliki PRN na XLS? Programiści Java mogą łatwo przekonwertować PRN na XLS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji PRN na XLS" %}}
{{% blocks/products/pf/agp/text %}}
