---
title: Sloučit MHT s ET – Zkombinujte MHT s ET v Java
url: /cs/java/merger/merge-mht-to-et/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do ET saveformat. Java Zkombinujte formát MHT s ET. Sloučit MHT do ET v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do ET v Java" %}}

Následující příklad ukazuje, jak sloučit MHT do ET v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT s ET. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru ET. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který spojuje MHT s ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT do ET v Java" InputFormat="mht" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT s ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit MHT s ET? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna pro sloučení MHT s ET" %}}
