---
title: รวม XLSB เป็น WORD - รวม XLSB เป็น WORD ใน C#
url: /th/net/merger/merge-xlsb-to-word/ 
description: Aspose เก่ง. C# Aspose.Cells ผสานออนไลน์ฟรี XLSB เป็นรูปแบบบันทึก WORD C# รวม XLSB เป็นรูปแบบ WORD รวม XLSB เป็น WORD ใน C# XLSB ผสาน
...
{{% blocks/products/pf/agp/content h2="รวม XLSB เป็น WORD ใน C# ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLSB กับ WORD ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม XLSB เป็น WORD อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกเป็นไฟล์ WORD หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่ผสาน XLSB เป็น WORD

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ออนไลน์ฟรีเพื่อรวม XLSB เป็น WORD ใน C#" InputFormat="xlsb" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีผสาน XLSB เป็น WORD ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการผสาน XLSB กับ WORD โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี .NET เพื่อรวม XLSB เป็น WORD" %}}
