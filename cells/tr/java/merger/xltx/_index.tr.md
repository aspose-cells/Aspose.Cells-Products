---
title:  Birleştirme XLTX Dosyalar via Java
weight: 680
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment üzerinde XLTX belgelerini birleştirmek için Java örnek kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLTX Biçimlerini Java\'de birleştir" h2="Sunucu tarafı Java API\'leri kullanılarak yerel XLTX belge birleştirme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
+ İlk XLTX dosyasını bir Workbook sınıfı örneği ile yükleyin.
+ İkinci XLTX belgesini bir Workbook sınıfı örneği ile yükleyin.
+ Combine() yöntemini kullanarak dosyaları birleştirin.
+ birleştirilmiş XLTX dosyasını belirtilen yola kaydet
