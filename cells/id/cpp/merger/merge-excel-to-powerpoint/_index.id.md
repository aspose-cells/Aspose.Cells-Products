---
title: Gabungkan EXCEL ke POWERPOINT - Gabungkan EXCEL ke POWERPOINT di C++
url: /id/cpp/merger/merge-excel-to-powerpoint/ 
description: Aspose Unggul. C++ Aspose.Cells. Online Gratis Menggabungkan EXCEL ke format penyimpanan POWERPOINT. C++ Gabungkan format EXCEL ke POWERPOINT. Gabungkan EXCEL ke POWERPOINT di C++. Gabungkan EXCEL.
...
Contoh berikut menunjukkan cara menggabungkan EXCEL ke POWERPOINT di Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan EXCEL ke POWERPOINT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
