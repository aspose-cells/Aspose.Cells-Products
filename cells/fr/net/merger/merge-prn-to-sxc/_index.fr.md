---
title: Fusionner PRN à SXC - Combiner PRN à SXC dans C#
url: /fr/net/merger/merge-prn-to-sxc/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite PRN au format de sauvegarde SXC. C# Combine PRN au format SXC. Fusionner PRN à SXC dans C#. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à SXC en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN avec SXC dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN en SXC. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier SXC. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne PRN en SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner PRN à SXC en C#" InputFormat="prn" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner PRN avec SXC via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner PRN avec SXC par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
