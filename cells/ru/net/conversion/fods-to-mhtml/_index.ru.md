---
title: Преобразователь C# FODS в MHTML - FODS в MHTML
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в MHTML в C#" %}}
...
Нужно программно преобразовать файлы FODS в MHTML? Разработчики .NET могут легко загрузить и преобразовать FODS в MHTML всего за несколько строк кода.
...
1.  Преобразуйте значение FODS в MHTML, вызвав метод Workbook.Save.
