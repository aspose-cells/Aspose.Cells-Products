...
description: Aspose Excel. Converti il PRN in XLSM in modo rapido e semplice con Aspose.Cells. Java PRN in XLSM. Java Salva PRN in XLSM. Salva PRN come XLSM utilizzando Java.
...
{{% blocks/products/pf/agp/content h2="Salva il PRN allo XLSM in Java" %}}

L'esempio seguente mostra come convertire il PRN in XLSM in Java.
...
{{% blocks/products/pf/agp/content h2="Come convertire il PRN in XLSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file PRN in XLSM a livello di codice? Gli sviluppatori di Java possono convertire facilmente il PRN in XLSM in poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria Java per convertire il PRN in XLSM" %}}
{{% blocks/products/pf/agp/text %}}
