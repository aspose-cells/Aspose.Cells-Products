---
title: C# XLSX para ODS - Online XLSX para ODS Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter XLSX para ODS saveformat. C# XLSX a ODS formato. Salve XLSX a ODS C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSX para ODS em C#" h2="Biblioteca C# de alta velocidade para converter XLSX em ODS. Esta é uma solução de software profissional para importar e exportar XLSX, ODS e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a ODS em C# online gratuitamente" %}}
...
{{% blocks/products/pf/agp/content h2="Como converter XLSX para ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para ODS programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter XLSX em ODS em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para converter XLSX em ODS" %}}
