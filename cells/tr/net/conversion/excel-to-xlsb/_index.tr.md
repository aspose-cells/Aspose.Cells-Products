...
EXCEL dosyalarını programlı olarak XLSB'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip XLSB'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını XLSB formatına dönüştürün.
