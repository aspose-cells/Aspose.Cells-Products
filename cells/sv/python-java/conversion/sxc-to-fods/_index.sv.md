---
title: Konvertera SXC till FODS via Python
url: /sv/python-java/conversion/sxc-to-fods/
description: Exempelkod för konvertering från sxc till fods Python. Använd API-exempelkod för batch-sxc-filer för att ge konvertering inom Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar SXC till FODS med Python" %}}

 För att konvertera SXC till FODS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till FODS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera SXC-filer till FODS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SXC-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med FODS-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande FODS-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera SXC till FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="fods" IsLandingPage="true" language="python" %}}
