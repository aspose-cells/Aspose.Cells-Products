---
title: Creëer FODS - Creëer FODS bestand in Python
description: Aspose Excel. Python Creëer FODS-bestand. Creëer FODS Python. Python FODS Maker. Maak FODS in Python. Genereer FODS-bestand met Python.
...
1. Gebruik de methode Save om de werkmap op te slaan als FODS-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een FODS-bestand maakt in Python." offSpacer="" %}}
