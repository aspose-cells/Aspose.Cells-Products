---
title: Scal OBRAZ z TSV - Połącz OBRAZ z TSV w C#
url: /pl/net/merger/merge-image-to-tsv/ 
description: Aspose Excel. C# Aspose.Cells. Scal OBRAZ do formatu zapisu TSV. C# Połącz OBRAZ do formatu TSV. Scal OBRAZ z TSV w C#. OBRAZ Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz OBRAZ z TSV w C#" %}}

Poniższy przykład pokazuje, jak połączyć IMAGE z TSV w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić IMAGE z TSV. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku TSV. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OBRAZ z TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia OBRAZU z TSV w C#" InputFormat="png" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć OBRAZ z TSV przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić IMAGE z TSV? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka .NET do połączenia OBRAZU z TSV" %}}
