---
title: Gộp JPG sang HTM - Gộp JPG sang HTM Java
url: /vi/java/merger/merge-jpg-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. Gộp JPG vào định dạng lưu HTM. Java Kết hợp định dạng JPG sang HTM. Hợp nhất JPG thành HTM theo số Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Gộp JPG vào HTM số Java" %}}

Ví dụ sau đây minh họa cách hợp nhất JPG sang HTM trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất JPG vào HTM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp HTM. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất JPG với HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Code mẫu ghép JPG vào HTM Java" InputFormat="jpg" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép JPG vào HTM via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép JPG vào HTM" %}}
