---
title: Python SPREADSHEETML'den XLTX'e - SPREADSHEETML'den XLTX'e dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde SPREADSHEETML'i XLTX'e dönüştürün. Python SPREADSHEETML'i XLTX'e dönüştürün. Python SPREADSHEETML'i XLTX'e kaydedin. Python'i kullanarak SPREADSHEETML'i XLTX olarak kaydedin.
...
{{% cells-convert title="SPREADSHEETML\'i XLTX\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'i XLTX\'e Dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

SPREADSHEETML dosyalarını program aracılığıyla XLTX'e dönüştürmeniz mi gerekiyor? Python geliştiricileri SPREADSHEETML'i yalnızca birkaç satır kodla kolayca yükleyebilir ve XLTX'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak SPREADSHEETML'i XLTX'e dönüştürün.
1.  SPREADSHEETML'in dönüşüm sonucunu XLTX'e alın.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'i XLTX\'e dönüştürmek için Python kitaplığı" %}}
