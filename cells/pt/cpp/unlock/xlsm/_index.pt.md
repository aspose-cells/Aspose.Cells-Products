...
weight: 6070
url: /pt/cpp/unlock/xlsm/ 
description: C++ código de exemplo para desbloquear arquivo XLSM protegido por senha em C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloqueie arquivos XLSM via C++" h2="Remova a proteção de planilhas do Excel, incluindo arquivo XLSM, usando a biblioteca C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
1. Carregue o arquivo bloqueado XLSM usando CreateIWorkbook.1. Chame a função Unprotect() para desbloquear.1. Defina a senha como NULL usando SetPassword.1. Salve o arquivo XLSM em um local especificado.
