...
description: Aspose Excel. Python Aspose.Cells. Połącz program Excel z formatem zapisu OTS. Python Połącz format EXCEL z formatem OTS. Połącz EXCEL z OTS w Python. Połącz EXCEL.
...
{{% blocks/products/pf/agp/content h2="Połącz EXCEL z OTS w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia programu EXCEL z OTS w Python" InputFormat="xlsx" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć EXCEL z OTS przez Python" %}}
