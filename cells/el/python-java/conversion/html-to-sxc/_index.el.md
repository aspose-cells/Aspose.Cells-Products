---
title: Μετατροπή HTML σε SXC μέσω Python

description: Δείγμα κώδικα για μετατροπή html σε sxc Python. Χρησιμοποιήστε API παράδειγμα κώδικα για ομαδική μετατροπή αρχείων html σε sxc εντός της εφαρμογής Python.
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε HTML σε SXC χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή HTML σε SXC μέσω Python" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του Python μπορούν εύκολα να φορτώσουν και να μετατρέψουν αρχεία HTML σε SXC σε λίγες μόνο γραμμές κώδικα.
