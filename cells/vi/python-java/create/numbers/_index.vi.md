...
description: Aspose Excel. Python Tạo tệp SỐ. Tạo SỐ Python. Python Trình tạo SỐ. Tạo SỐ bằng Python. Tạo tệp SỐ bằng Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tạo tệp SỐ trong Python" h2="Thư viện Python tốc độ cao để tạo tập tin SỐ. Đây là giải pháp phần mềm chuyên nghiệp để nhập xuất XLSX, PDF và nhiều định dạng khác sử dụng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  Sử dụng phương pháp Lưu để lưu sổ làm việc dưới dạng tệp NUMBERS.

{{% blocks/products/pf/agp/code-block title="Mã mẫu cho biết cách tạo tệp NUMBERS trong Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python thư viện để tạo tập tin SỐ" %}}
