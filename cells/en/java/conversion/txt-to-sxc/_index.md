---
title: TXT to SXC - Convert TXT to SXC files Java
description: Aspose Excel. Free Online Convert TXT to SXC saveformat. Java TXT to SXC format. Save TXT as SXC in Java.
keywords: [Aspose Excel., Java Aspose.Cells., Java TXT to SXC saveformat., Free Online TXT to SXC Converter]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TXT to SXC in Java" h2="High-speed Java library for converting TXT to SXC. This is a professional software solution to import and export TXT, SXC, and many other formats using Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
How do I convert TXT to SXC? With Aspose.Cells for Java library, you can easily convert TXT to SXC programmatically with  a few lines of code. [Aspose.Cells for Java](https://products.aspose.com/cells/java) is capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. Java Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT and more, thus making it a perfect choice to exchange documents in industry-standard formats. You can download its latest version directly from [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) and install it within your Maven-based project by adding the following configurations to the pom.xml.
...
The following example demonstrates how to convert TXT to SXC in Java.
...
Need to convert TXT files to SXC programmatically? Java developers can easily convert TXT to SXC in just a few lines of code.
