---
title: Połącz CSV z XLSB - Połącz CSV z XLSB w Java
url: /pl/java/merger/merge-csv-to-xlsb/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online CSV do XLSB w formacie zapisu. Java Połącz format CSV z XLSB. Połącz CSV z XLSB w Java. CSV Połącz.
...
Poniższy przykład pokazuje, jak połączyć CSV z XLSB w Aspose.Cells for Java.
...
{{% cells-merger title="Bezpłatne połączenie online CSV z XLSB w Java" InputFormat="csv" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić CSV z XLSB programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
