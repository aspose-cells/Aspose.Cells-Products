---
title: Vytvořte MHTML Soubory via Java
description: MHTML tvůrce. Vytvořte soubory MHTML v kódu Java. Generujte soubory MHTML pomocí desktopové nebo webové aplikace založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořit MHTML Soubor via Java" h2="Nativní a vysoce výkonné vytváření MHTML programově pomocí knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit MHTML via Java" %}}
...
1.  Uložte sešit ve formátu MHTML pomocí metody save().

{{% blocks/products/pf/agp/code-block title="Následující zdrojový kód ukazuje, jak vytvořit soubor MHTML pomocí Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro vytvoření souboru MHTML" %}}
{{% blocks/products/pf/agp/text %}}
