---
title: Python via Java'i kullanarak ActiveX Denetimini Excel'e ekleyin
weight: 10
description: Python via Java ActiveX Denetimini Excel'e eklemek için kaynak kodu.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java Kullanarak ActiveX Denetimini Excel\'e Ekleme" h2="Microsoft veya Open Office, Adobe PDF vb. gibi herhangi bir yazılım olmadan sunucu tarafı API\'lerini kullanarak nesneler ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java Kullanarak Excel Dosyasına ActiveX Denetimi Nasıl Eklenir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via java kullanarak ActiveX Denetimini Excel dosyasına ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Şekil koleksiyonunu kullanın[yöntem ekle](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)) seçili çalışma sayfasına bir ActiveX Denetimi eklemek için.
...
-  Windows, Linux ve MacOS gibi Python'u Java komut dosyaları aracılığıyla çalıştırabilen herhangi bir işletim sistemi
...
{{% blocks/products/pf/agp/code-block title="ActiveX Denetimi Ekle - Python via java" offSpacer="" %}}
