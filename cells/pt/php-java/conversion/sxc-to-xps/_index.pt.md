---
title: Conversor PHP SXC para XPS - SXC para XPS
description: Aspose Excel. Converta SXC em XPS de forma rápida e fácil com Aspose.Cells. PHP SXC em XPS. PHP Salve SXC em XPS. Salve SXC como XPS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em XPS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em XPS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em XPS em apenas algumas linhas de código.
...
1.  Converta SXC em XPS chamando o método save da pasta de trabalho.
