---
title: Преобразование TXT в XPS через Python
url: /ru/python-java/conversion/txt-to-xps/
description: Пример кода для преобразования txt в xps Python. Используйте пример кода API для пакетного преобразования файлов txt в xps в приложении Python.
---
...
{{% blocks/products/pf/agp/content h2="Как преобразовать TXT в XPS с помощью Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию TXT в XPS через Python" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Python могут легко загружать и преобразовывать файлы TXT в XPS, написав всего несколько строк кода.
...
{{% cells-convert title="Бесплатное приложение и пример кода для преобразования TXT в XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="xps" IsLandingPage="true" language="python" %}}
