...
{{% blocks/products/pf/agp/content h2="JSON을 Java 온라인의 OTS에 무료로 저장" %}}

다음 예는 JSON을 Java에서 OTS로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="JSON을 OTS 온라인으로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="ots" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="JSON을 OTS via Java로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 Java 개발자는 단 몇 줄의 코드로 JSON을 OTS로 쉽게 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2="Java JSON을 OTS로 변환하는 라이브러리" %}}
{{% blocks/products/pf/agp/text %}}
