---
title: PHP XLSM から ET - XLSM から ET コンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、XLSM を ET にすばやく簡単に変換します。PHP XLSM を ET に変換します。 PHP XLSM を ET に保存します。 PHP を使用して XLSM を ET として保存します。
...
{{% cells-convert title="XLSMをETに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="et" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP 経由で XLSM を ET に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSM ファイルをプログラムで ET に変換する必要がありますか? PHP 開発者は、わずか数行のコードで XLSM を簡単にロードして ET に変換できます。
