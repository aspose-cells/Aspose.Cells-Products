---
title:  Συγχώνευση XLSX στο MHT μέσω C++
url: /el/cpp/merger/merge-xlsx-to-mht/ 
description: Συγχώνευση XLSX στο MHT Online δωρεάν. Δωρεάν Online XLSX to MHT Merger. Συγχώνευση XLSX σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLSX με το MHT στο C++.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLSX με MHT σε απευθείας σύνδεση" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
