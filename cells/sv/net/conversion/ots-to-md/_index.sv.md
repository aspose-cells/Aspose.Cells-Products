---
title: C# OTS till MD - OTS till MD-omvandlare
description: Aspose Excel. Konvertera OTS till MD snabbt och enkelt med Aspose.Cells. C# OTS till MD. C# Spara OTS till MD. Spara OTS som MD med C#.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till MD på C#" %}}

Följande exempel visar hur man konverterar OTS till MD i C#.
...
{{% cells-convert title="Exempelkod för att konvertera OTS till MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till MD programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till MD på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera OTS till MD" %}}
