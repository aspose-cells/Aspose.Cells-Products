---
title:  Gerar Relatórios em ODS Arquivos via Java
weight: 2440
description: Java código de amostra para criar relatórios no formato ODS em Java Ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Gerar ODS Relatórios via Java" %}}
...
1.  Salve o resultado no formato ODS por meio do método Worbook.save
