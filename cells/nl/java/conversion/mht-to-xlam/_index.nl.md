...
description: Aspose Excel. Converteer MHT snel en eenvoudig naar XLAM met Aspose.Cells. Java MHT naar XLAM. Java Bewaar MHT naar XLAM. Sla MHT op als XLAM met Java.
...
{{% blocks/products/pf/agp/content h2="Bewaar MHT op XLAM in Java" %}}

In het volgende voorbeeld ziet u hoe u MHT converteert naar XLAM in Java.
...
{{% blocks/products/pf/agp/content h2="MHT converteren naar XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHT-bestanden programmatisch naar XLAM converteren? Java-ontwikkelaars kunnen MHT eenvoudig met slechts een paar regels code naar XLAM converteren.
