---
title: Sloučit HTM do MD – Zkombinujte HTM s MD v C++
url: /cs/cpp/merger/merge-htm-to-md/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit HTM do formátu uložení MD. C++ Kombinujte formát HTM s MD. Sloučit HTM do MD v C++. HTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM do MD na C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit HTM s MD v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení HTM s MD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MD. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který spojuje HTM s MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení HTM do MD na čísle C++" InputFormat="htm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM do MD přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit HTM do MD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení HTM do MD" %}}
