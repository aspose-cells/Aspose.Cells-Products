---
title:  Inserir setas de bloco no Excel via C++
weight: 770
description: C++ código de exemplo para inserir Block Arrows no arquivo Excel em C++ Runtime Environment para Windows 32 bits, Windows 64 bits e Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserir setas de bloco no Excel via C++" h2="Insira objetos usando o nativo e alto desempenho do lado do servidor Aspose.Cells for C++ API sem usar nenhum software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir setas de bloco no arquivo do Excel usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir setas de bloco no arquivo Excel via C++" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o[adicionar método](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ab8156e8562724f9a597b7d2bc503cd4d) para inserir Visão geral dos tipos de seta de bloco na planilha selecionada
...
O código de exemplo abaixo demonstra como inserir uma "seta para a direita". Para mais tipos, consulte "Visão geral dos tipos de seta de bloco" abaixo.

{{% /blocks/products/pf/agp/text %}}

{{% blocks/products/pf/agp/code-block title="Inserir Setas de Bloqueio - C++" offSpacer="" %}}
