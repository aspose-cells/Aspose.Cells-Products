---
title: 在 XLSM 文件 via .NET 中產生報告
weight: 4400
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上產生 XLSM 格式報告。
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 組裝 XLSM 的步驟" %}}
...
1. 透過 WorkbookDesigner.Worbook.Save 方法將結果儲存為 XLSM 格式
...
{{% blocks/products/pf/agp/code-block title="產生 XLSM 報告" offSpacer="" %}}
