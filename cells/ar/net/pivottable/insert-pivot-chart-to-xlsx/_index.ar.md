---
title:  قم بإدراج Pivot Chart في ملفات Micorsoft Excel XLSX عبر C#
weight: 7690
description: C# نموذج كود لتكوين وثائق XLSX بالمخطط المحوري. استخدم هذا الرمز لإنشاء ملفات Micorsoft Excel XLSX باستخدام مخطط محوري ضمن VB.NET أو Asp.NET أو أي تطبيق يستند إلى .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل الرسم البياني المحوري في المستندات XLSX عبر C#" h2="جدول بيانات Microsoft أصلي وعالي الأداء في Excel XLSX مع إنشاء مخطط Pivot برمجيًا باستخدام واجهات برمجة تطبيقات .NET من جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 يعد إنشاء ملف MS Excel XLSX باستخدام Pivot Chart ديناميكيًا داخل التطبيق قيد التشغيل أمرًا سهلاً. من أجل إنشاء مستندات XLSX باستخدام Pivot Chart من البداية دون الحاجة إلى MS Office ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية إدراج Pivot Chart في XLSX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

من السهل على المطورين إدراج Pivot Chart في جدول بيانات بتنسيق XLSX أثناء تشغيل تطبيقات تقارير مختلفة لمعالجة البيانات في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="قم بإدراج مخطط محوري في XLSX-C#" offSpacer="" %}}
...
مكتبة برمجة جداول بيانات Excel قادرة على إنشاء تطبيقات عبر الأنظمة الأساسية مع القدرة على إنشاء ملفات Excel XLSX وتعديلها وتحويلها وتقديمها وطباعتها. .NET Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات ، بل يمكنه أيضًا تحويل ملفات Excel كصور ، PDF ، HTML ، ODS وأكثر ، مما يجعله خيارًا مثاليًا لتبادل المستندات بتنسيقات قياسية في الصناعة.
