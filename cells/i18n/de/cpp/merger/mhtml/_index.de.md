---
title: MHTML-Dateien über C++ zusammenführen 
url: /de/cpp/merger/mhtml/ 
description: C++ Beispielcode zum Kombinieren von MHTML-Dokumenten in C++ Runtime Environment für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="MHTML-Formate in C++ zusammenführen" h2="MHTML-Dokumentzusammenführung mit serverseitigen C++-APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="So führen Sie eine MHTML-Datei mit C++ zusammen" %}}

Um die MHTML-Datei zusammenzuführen, verwenden wir <a href="https://products.aspose.com/cells/cpp">Aspose.Cells für C++</a> API, eine funktionsreiche, leistungsstarke und benutzerfreundliche Dokumentenzusammenführung API für die C++-Plattform. Sie können die neueste Version direkt herunterladen, einfach öffnen <a href="https://www.nuget.org/packages/aspose.cells">NuGet</a> Paketmanager, suche nach <b>Aspose.Cells.Cpp</b> und installieren. Sie können auch den folgenden Befehl in der Paket-Manager-Konsole verwenden.
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zusammenführen von MHTML-Dateien in C++" %}}
...
{{% blocks/products/pf/agp/code-block title="MHTML-Dateien zusammenführen - C++" offSpacer="" %}}
...
Aspose.Cells API kann zum Erstellen, Bearbeiten, Konvertieren und Rendern von Microsoft Excel-Formaten in verschiedene Formate verwendet werden. Darüber hinaus kann es für umfassende Diagramme, skalierbare Berichte und zuverlässige Berechnungen innerhalb von Softwareanwendungen verwendet werden. Aspose.Cells ist ein eigenständiges API und erfordert keine Software wie Microsoft oder OpenOffice.    
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online-MHTML-Merger-Live-Demos" sectionDescription="Führen Sie jetzt MHTML-Dokumente zusammen, indem Sie unsere besuchen [Live-Demos-Website](https://products.aspose.app/cells/merger). Die Live-Demo hat die folgenden Vorteile" >}}
