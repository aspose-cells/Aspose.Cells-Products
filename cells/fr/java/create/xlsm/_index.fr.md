---
title: Créer XLSM - Créer un fichier XLSM dans Java
description: Aspose Excel. Générez et manipulez facilement des fichiers XLSM grâce à la bibliothèque Aspose.Cells for Java. Cette puissante bibliothèque API offre une solution simplifiée et efficace pour créer, modifier et gérer des fichiers XLSM directement dans vos applications Java, répondant ainsi avec une grande précision aux besoins spécifiques des développeurs.
keywords: [Aspose Excel., Java Aspose.Cells., Java Create XLSM file., Generate XLSM file in Java., Write data to XLSM file via Java., Java XLSM Creater., Aspose.Cells for Java is a powerful library that enables developers to programmatically create, generate, and manipulate XLSM files in Java]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier XLSM dans Java" h2="Bibliothèque Java haute vitesse pour la création de fichiers XLSM. Ce logiciel professionnel permet d\'importer et d\'exporter des fichiers aux formats XLSX, PDF et bien d\'autres, grâce à l\'interface Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer XLSM dans Java" %}}
...
1.  Enregistrez le classeur au format XLSM en utilisant la méthode save().

{{% blocks/products/pf/agp/code-block title="L\'exemple de code montre comment créer le fichier XLSM dans Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour créer le fichier XLSM" %}}
{{% blocks/products/pf/agp/text %}}
