---
title: C# XLSX a XPS - XLSX a XPS Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato XPS, permitindo o salvamento perfeito de dados XLSX no formato XPS usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a XPS em C#" %}}

exemplo a seguir demonstra como converter XLSX em XPS em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter XLSX em XPS por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX em XPS programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em XPS em apenas algumas linhas de código.
...
1.  Converta XLSX para XPS chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em XPS" %}}
