---
title:  Sloučit XLSB na ODS přes Python
...
Následující příklad ukazuje, jak sloučit XLSB až ODS v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSB až ODS online" InputFormat="xlsb" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
