---
title: ODS oluştur - C#'de ODS dosyası oluştur
description: Aspose excel. C# ODS Dosyası Oluştur. Oluştur ODS C#. C# ODS Oluşturan. C#'de ODS oluşturun. C#'i kullanarak ODS dosyasını oluşturun.
keywords: [Aspose Excel., C# Aspose.Cells., Create ODS C#., C# ODS Creater., Create ODS file in C#., Generate ODS file in C#]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#\'de ODS Dosyası Oluştur" h2="ODS oluşturmak için yüksek hızlı C# kitaplığı. Bu, XLSX, PDF ve diğer birçok formatı .NET Framework, .NET Core veya Mono Platformlarında içe ve dışa aktarmak için profesyonel bir yazılım çözümüdür." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="C#\'de ODS Nasıl Oluşturulur" %}}
...
{{% blocks/products/pf/agp/code-block title="Örnek kod, C#\'de ODS dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
