...
description: Aspose Excel. Μετατρέψτε το JSON σε ET γρήγορα και εύκολα με το Aspose.Cells. C++ JSON σε ET. C++ Αποθήκευση JSON στο ET. Αποθηκεύστε το JSON ως ET χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε JSON στο ET στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή JSON σε ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="et" IsLandingPage="true" language="cpp" %}}
