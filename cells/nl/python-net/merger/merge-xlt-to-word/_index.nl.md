...
description: Aspose Excel. Python Aspose.Cells. Gratis online Samenvoegen XLT naar WORD-opslagformaat. Python Combineer XLT naar WORD-formaat. Samenvoegen XLT naar WORD in Python. XLT Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met WORD in Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Gratis online om XLT samen te voegen met WORD in Python" InputFormat="xlt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLT samen te voegen met WORD via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen met WORD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
