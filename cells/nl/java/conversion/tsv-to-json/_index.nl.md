...
{{% blocks/products/pf/agp/content h2="Sla TSV op in JSON in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar JSON in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar JSON of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TSV programmatisch converteren naar JSON? Ontwikkelaars van Java kunnen bestanden met de extensie TSV eenvoudig converteren naar JSON met slechts een paar regels code.
