...
description: Aspose Excel. Konwertuj XLSX na FODS szybko i łatwo za pomocą Aspose.Cells. Python XLSX na FODS. Python Zapisz XLSX na FODS. Zapisz XLSX jako 0761113 481 pod numerem Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLSX na FODS w Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSX do FODS w Python" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSX na FODS w Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji XLSX na FODS" %}}
