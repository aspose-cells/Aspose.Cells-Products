...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir ScrollBar em arquivo Excel via C#" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Utilize o[adicionar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addscrollbar)para inserir um ScrollBar na planilha selecionada
...
{{% blocks/products/pf/agp/code-block title="Inserir ScrollBar - C#" offSpacer="" %}}
