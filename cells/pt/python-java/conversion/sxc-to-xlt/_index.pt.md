---
title: Converter SXC para XLT via Python
url: /pt/python-java/conversion/sxc-to-xlt/
description: Código de exemplo para conversão de sxc para xlt Python. Use API código de exemplo para arquivos sxc em lote para conversão xlt no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter SXC para XLT usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC para XLT via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para XLT em apenas algumas linhas de código.
