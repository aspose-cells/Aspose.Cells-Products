---
title: إنشاء أرقام - إنشاء ملف أرقام في C#
description: Aspose إكسل. C# إنشاء ملف أرقام. قم بإنشاء أرقام C#. C# أرقام مُعدّلة. قم بإنشاء NUMBERS في C#. قم بإنشاء ملف NUMBERS باستخدام C#.
...
{{% blocks/products/pf/agp/text %}}
 ...
 من السهل على المطورين إنشاء وتحميل وتعديل وتحويل ملفات NUMBERS ضمن تشغيل تطبيقات تقارير مختلفة لمعالجة البيانات في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لتكوين ملف NUMBERS" %}}
