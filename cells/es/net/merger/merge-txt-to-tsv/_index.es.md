---
title: Combinar TXT a TSV - Combinar TXT a TSV en C#
url: /es/net/merger/merge-txt-to-tsv/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea TXT a TSV guardar formato. C# Combina el formato TXT con el TSV. Combinar TXT a TSV en C#. TXT Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine TXT a TSV en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar TXT con TSV en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar TXT a TSV. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo TSV. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina TXT con TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar TXT a TSV en C#" InputFormat="txt" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar TXT a TSV a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar TXT con TSV mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar TXT a TSV" %}}
