---
title: MHTML mit NUMBERS zusammenführen – MHTML mit NUMBERS in C# kombinieren
url: /de/net/merger/merge-mhtml-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Kostenlose Online-Zusammenführung von MHTML in das NUMBERS-Speicherformat. C# Kombinieren Sie MHTML mit dem Zahlenformat. MHTML zu NUMBERS in C# zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie MHTML kostenlos mit NUMBERS in C# online zusammen" %}}

Das folgende Beispiel zeigt, wie MHTML mit NUMBERS in Aspose.Cells for .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um MHTML mit NUMBERS zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der NUMBERS-Datei. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das MHTML mit NUMBERS zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlos online, um MHTML mit NUMMERN in C# zusammenzuführen" InputFormat="mhtml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie MHTML über C# mit NUMBERS zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie MHTML programmgesteuert mit NUMBERS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von MHTML mit NUMBERS" %}}
