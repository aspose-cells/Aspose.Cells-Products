...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer ComboBox dans un fichier Excel via C#" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcombobox) pour insérer une ComboBox dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer une ComboBox - C#" offSpacer="" %}}
