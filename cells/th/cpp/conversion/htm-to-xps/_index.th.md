---
title: C++ HTM เป็น XPS - แปลง HTM เป็น XPS ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง HTM เป็น XPS saveformat รูปแบบ C++ HTM เป็น XPS บันทึก HTM ไปที่ XPS C++
...
{{% blocks/products/pf/agp/content h2="บันทึก HTM เป็น XPS ใน C++ ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีแปลง HTM เป็น XPS ใน C++
...
1.  แปลง HTM เป็น XPS โดยเรียกเมธอด Save()
