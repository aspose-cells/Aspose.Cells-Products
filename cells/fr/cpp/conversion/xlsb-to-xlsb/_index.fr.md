---
title: C++ XLSB à XLSB - Convertisseur en ligne XLSB à XLSB
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde XLSB. Format C++ XLSB à XLSB. Enregistrez XLSB à XLSB C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à XLSB dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en XLSB en C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLSB en XLSB. Téléchargez votre fichier XLSB, puis enregistrez-le simplement en tant que fichier XLSB. Pour la lecture XLSB et l'écriture XLSB, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie XLSB seront identiques au document XLSB d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en XLSB en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlsb" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en XLSB via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en XLSB par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en XLSB en seulement quelques lignes de code.
...
1.  Convertissez XLSB en XLSB en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de XLSB en XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir XLSB en XLSB" %}}
