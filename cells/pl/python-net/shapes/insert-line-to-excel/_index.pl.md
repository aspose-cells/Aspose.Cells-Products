...
{{% blocks/products/pf/agp/content h2="Jak wstawić linię do pliku programu Excel za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić wiersz do pliku programu Excel za pośrednictwem Python" %}}
...
+ Użyj metody dodawania kolekcji shapecollection, aby wstawić linię w wybranym arkuszu.
...
-  Dowolny system operacyjny, który może uruchamiać skrypty Pythona, taki jak Windows i Linux
...
{{% blocks/products/pf/agp/code-block title="Wstaw linię - Python" offSpacer="" %}}
