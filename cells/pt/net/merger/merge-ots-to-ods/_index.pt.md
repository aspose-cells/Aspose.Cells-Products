---
title:  Mesclar OTS para ODS via C#
url: /pt/net/merger/merge-ots-to-ods/ 
description: Mesclar OTS para ODS online gratuitamente. OTS on-line gratuito para ODS Fusão. Mesclar OTS para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar OTS para ODS em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar OTS para ODS on-line" InputFormat="ots" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
