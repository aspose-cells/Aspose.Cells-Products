---
title: Tìm kiếm tài liệu CSV mà không cần mở qua Java 
weight: 390
url: /vi/java/search/csv/ 
description: Java mã mẫu để tìm kiếm các từ có mẫu trong tệp CSV trên Java Môi trường thời gian chạy cho Ứng dụng JSP / JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm Định dạng CSV trong Java" h2="Tìm kiếm tài liệu CSV gốc và hiệu suất cao bằng cách sử dụng API Aspose.Cells for Java phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Tìm kiếm Tệp CSV trong Java" %}}
...
+ Tải tệp CSV bằng cách khởi tạo một đối tượng Workbook.
+ Truy cập trang tính đầu tiên trong tệp CSV.
...
{{% blocks/products/pf/agp/code-block title="Tìm kiếm Tệp CSV - Java" offSpacer="" %}}
