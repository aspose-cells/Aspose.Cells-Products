---
title: Crear XLSX - Crear archivo XLSX en PHP
description: Aspose Excel. Genere y manipule fácilmente archivos XLSX con la biblioteca Aspose.Cells for PHP via Java. Esta potente biblioteca API ofrece una solución optimizada y eficiente para crear, editar y administrar archivos XLSX directamente en sus aplicaciones PHP, satisfaciendo las necesidades específicas de los desarrolladores con alta precisión.
...
{{< blocks/products/pf/i18n/upper-banner h1="Crear el archivo XLSX en PHP" h2="Biblioteca PHP de alta velocidad para crear archivos XLSX. Solución de software profesional para importar y exportar archivos XLSX, PDF y muchos otros formatos mediante PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo crear XLSX en PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="El código de muestra muestra cómo crear el archivo XLSX en PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca PHP para crear el archivo XLSX" %}}
