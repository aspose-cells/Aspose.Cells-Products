---
title: C# XLSX ke SPREADSHEETML - Konverter XLSX ke SPREADSHEETML Online
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Online Gratis C# Ubah XLSX menjadi format simpan SPREADSHEETML. C# XLSX ke format SPREADSHEETML. Simpan XLSX ke SPREADSHEETML C#.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke SPREADSHEETML di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi SPREADSHEETML di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengubah XLSX menjadi SPREADSHEETML. Unggah file XLSX Anda, lalu simpan sebagai file SPREADSHEETML. Untuk pembacaan XLSX dan penulisan SPREADSHEETML, Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan pemformatan SPREADSHEETML keluaran akan identik dengan dokumen asli XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX menjadi SPREADSHEETML Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xml" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="Pustaka C# untuk mengubah XLSX menjadi SPREADSHEETML" %}}
