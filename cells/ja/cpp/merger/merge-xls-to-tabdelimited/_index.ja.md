...
url: /ja/cpp/merger/merge-xls-to-tabdelimited/ 
...
次の例は、XLS for C++ の TABDELIMITED に XLS をマージする方法を示しています。
...
XLS をプログラムで TABDELIMITED にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
