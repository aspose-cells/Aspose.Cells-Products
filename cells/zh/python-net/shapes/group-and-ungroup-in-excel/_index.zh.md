---
title: 使用 Python via 在 Excel 中对形状进行分组和取消分组 .NET
weight: 360
description: 使用 Aspose.Cells' Python via .NET API 对对象进行分组和取消分组，无需任何软件，例如 Microsoft 或 Open Office、Adobe PDF 等。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Python-Net 在 Excel 中对形状进行分组和取消分组" h2="使用 Aspose.Cells API 处理各种对象，无需任何软件，如 Microsoft 或 Open Office、Adobe PDF 等。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via 对 Excel 文件中的形状进行分组和取消分组 .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Python 在 Excel 文件中对形状进行分组和取消分组的步骤" %}}
...
+ 通过索引选择工作表。
 + 使用[组法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/group/)对所选工作表中的形状进行分组
 + 使用[解组方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/ungroup/)取消组合所选工作表中的形状
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="组合和取消组合形状 - Python via .NET" offSpacer="" %}}
