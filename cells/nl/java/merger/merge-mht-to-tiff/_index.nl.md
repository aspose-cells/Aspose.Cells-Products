---
title: Voeg MHT samen met TIFF - Combineer MHT met TIFF in Java
url: /nl/java/merger/merge-mht-to-tiff/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online MHT samenvoegen naar TIFF saveformat. Java Combineer MHT tot formaat TIFF. MHT samenvoegen naar TIFF in Java. MHT samenvoegen.
...
{{% blocks/products/pf/agp/content h2="MHT samenvoegen naar TIFF in Java Online gratis" %}}

Het volgende voorbeeld laat zien hoe u MHT kunt samenvoegen tot TIFF in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHT samen te voegen tot TIFF. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand TIFF. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat MHT samenvoegt tot TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om MHT samen te voegen tot TIFF in Java" InputFormat="mht" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe MHT samen te voegen tot TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHT programmatisch samenvoegen met TIFF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om MHT samen te voegen tot TIFF" %}}
