---
title:  C++을 통해 ODS 문서에서 텍스트 검색 및 바꾸기
weight: 1610
description: C++ 예제 코드는 Windows 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경의 ODS 파일에서 중요한 정보를 수정합니다.
---
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/redaction/xls/" name="XLS" description="엑셀 이진 형식" >}}
