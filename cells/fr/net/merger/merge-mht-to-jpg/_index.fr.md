---
title: Fusionner MHT en JPG - Combiner MHT en JPG dans C#
url: /fr/net/merger/merge-mht-to-jpg/ 
description: Aspose Exceller. C# Aspose.Cells. Fusionner le format de sauvegarde MHT au format JPG. C# Combinez le format MHT au format JPG. Fusionnez MHT en JPG dans C#. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT en JPG dans C#" %}}
...
{{% cells-merger title="Exemple de code pour fusionner MHT en JPG dans C#" InputFormat="mht" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT en JPG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner MHT en JPG par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque .NET pour fusionner MHT en JPG" %}}
