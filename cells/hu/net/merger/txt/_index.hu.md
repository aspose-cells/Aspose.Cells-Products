...
{{% blocks/products/pf/agp/feature-section-col title="A TXT-fájlok egyesítésének lépései itt: C#" %}}
...
+ Töltse be az összes TXT fájlt teljes elérési úttal.
+ Készítsen egy dokumentumot alapfájlként
+ Hívja meg a megfelelő metódust a fájlok egyenkénti összefűzésére és egyesítésére.
+ Hívja meg a Save() metódust, és adja meg a fájlnevet (teljes elérési út) és a formátumot (TXT) paraméterként.
Most már megnyithatja és használhatja a TXT fájlt Microsoft Office-ban, Adobe PDF-ben vagy bármely más kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="TXT fájlok egyesítése – C#" offSpacer="" %}}
