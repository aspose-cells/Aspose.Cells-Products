---
title:  ODS dokumentumdiagram képekhez via .NET
weight: 4360
description: C# forráskód diagramok vagy diagramok rajzolásához és konvertálásához a ODS fájlban a .NET Framework, .NET Core, Mono vagy Xamarin platformokon.
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a ODS fájl diagramok konvertálásához a C#-ben" %}}
...
{{% blocks/products/pf/agp/code-block title="Átalakítás ODS Fájlok diagramja - C#" offSpacer="" %}}
