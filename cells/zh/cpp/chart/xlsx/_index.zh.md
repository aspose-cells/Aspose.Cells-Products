---
title: 通过 C++ 的 XLSX 文档图表 
weight: 750
url: /zh/cpp/chart/xlsx/ 
description: C++ 用于在 XLSX 文件中绘制和转换图表或图表的示例代码，适用于 C++ Windows 32 位、Windows 64 位和 Linux 64 位的运行时环境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSX 格式化 C++ 中的图表" h2="使用用于 C++ API 的服务器端 Aspose.Cells 的原生高性能 XLSX 文档图表，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
