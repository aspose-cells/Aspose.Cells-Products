...
{{< blocks/products/pf/i18n/upper-banner h1="MHTML konvertálása TAB-raDELIMITED a következőn keresztül: Java" h2="MHTML-ből TABDELIMITED-té Java konverzió egyetlen vagy több oldal konvertálásához TABDELIMITED-té a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="MHTML konvertálása TAB-raDELIMITED a következővel: Java" %}}

 Ahhoz, hogy az MHTML-t TABDELIMITED-re rendereljük, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az MHTML-ből TAB-ra konvertálásáhozDELIMITED a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak MHTML fájlt TABDELIMITED formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be egy MHTML-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TABDELIMITED kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TABDELIMITED fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="MHTML-ből TABDELIMITED Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az MHTML fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.mhtml");
// MHTML mentése TABDELIMITED néven
