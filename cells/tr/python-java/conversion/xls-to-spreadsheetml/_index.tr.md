...
description: Aspose Excel'de. Aspose.Cells ile XLS'i hızlı ve kolay bir şekilde SPREADSHEETML'e dönüştürün. Python XLS'i SPREADSHEETML'e dönüştürün. Python XLS'i SPREADSHEETML'e kaydedin. Python'i kullanarak XLS'i SPREADSHEETML olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'i kullanarak XLS\'i SPREADSHEETML\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="XLS\'i Python\'deki SPREADSHEETML\'e kaydedin" %}}

Aşağıdaki örnek, XLS'in Python'de SPREADSHEETML'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="XLS\'i SPREADSHEETML\'e dönüştürmek için Python kitaplığı" %}}
