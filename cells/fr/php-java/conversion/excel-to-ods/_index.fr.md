---
title: PHP EXCEL en ODS - Convertisseur EXCEL en ODS
description: Aspose Exceller. Convertissez EXCEL en ODS rapidement et facilement avec Aspose.Cells. PHP EXCEL en ODS. PHP Enregistrez EXCEL en ODS. Enregistrez EXCEL sous ODS en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en ODS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en ODS par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en ODS en quelques lignes de code.
...
1.  Convertissez EXCEL en ODS en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en ODS" %}}
