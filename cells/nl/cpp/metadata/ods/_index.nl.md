---
title:  Bewerk of bekijk ODS Documentmetagegevens via C++
weight: 1000
description: C++ voorbeeldcode om ODS bestandsmetagegevens te bewerken of te bekijken op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
...
{{% blocks/products/pf/agp/content h2="Metagegevens van ODS verkrijgen met behulp van C++" %}}

Om de metadata van ODS te extraheren, gebruiken we
...
+ Laad het ODS-bestand met WorkbookMetadata
