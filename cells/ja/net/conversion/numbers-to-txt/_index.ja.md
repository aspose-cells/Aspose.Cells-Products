---
title: C# 番号から TXT - 番号から TXT へのコンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、NUMBERS を TXT にすばやく簡単に変換します。 C# NUMBERS を TXT に変換します。 C# NUMBERS を TXT に保存します。 C# を使用して、NUMBERS を TXT として保存します。
...
{{% blocks/products/pf/agp/content h2="番号を C# の TXT に保存" %}}

次の例は、NUMBERS を C# の TXT に変換する方法を示しています。
...
{{% cells-convert title="NUMBERSをTXTに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でNUMBERSをTXTに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS ファイルをプログラムで TXT に変換する必要がありますか? .NET 開発者は、わずか数行のコードで NUMBERS を簡単にロードして TXT に変換できます。
...
{{% blocks/products/pf/agp/content h2="C# NUMBERS を TXT に変換するライブラリ" %}}
