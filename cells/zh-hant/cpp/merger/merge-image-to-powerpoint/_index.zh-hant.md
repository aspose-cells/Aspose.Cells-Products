...
以下範例示範如何將 Aspose.Cells for C++ 中的 IMAGE 合併為 POWERPOINT。
...
需要以程式設計方式將 IMAGE 合併到 POWERPOINT 嗎？基本文檔合併和連接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++ 將影像合併到 POWERPOINT 的庫" %}}
