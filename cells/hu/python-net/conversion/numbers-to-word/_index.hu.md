...
{{% blocks/products/pf/agp/content h2="Mentse el a NUMBERS-t a WORD-ba a Python számon online ingyen" %}}

A következő példa bemutatja, hogyan lehet NUMBERS-t WORD-ra konvertálni a Python via NET-ben.
...
{{% blocks/products/pf/agp/content h2="Python könyvtár a NUMBERS WORD nyelvűvé konvertálásához" %}}
