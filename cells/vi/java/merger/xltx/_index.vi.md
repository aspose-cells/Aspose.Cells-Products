---
title:  Hợp nhất các tập tin XLTX via Java
weight: 680
description: Java mã mẫu để kết hợp các tài liệu XLTX trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng XLTX trong Java" h2="Hợp nhất tài liệu gốc XLTX bằng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
lưu tệp XLTX đã hợp nhất tại đường dẫn đã chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp XLTX - Java" offSpacer="" %}}
