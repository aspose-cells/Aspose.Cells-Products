---
title: Mesclar MHT para XPS - Combine MHT para XPS em Java
url: /pt/java/merger/merge-mht-to-xps/ 
description: Aspose Excel. Java Aspose.Cells. Free Online Mesclar MHT para XPS saveformat. Java Combine MHT para o formato XPS. Mesclar MHT para XPS em Java. Mesclar MHT.
...
O exemplo a seguir demonstra como mesclar MHT para XPS em Aspose.Cells for Java.
...
{{% cells-merger title="Online grátis para mesclar MHT para XPS em Java" InputFormat="mht" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHT para XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar MHT para XPS programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
