---
title: C++ EXCEL a XLS - Convertidor EXCEL a XLS
description: Aspose Excel. Convierta EXCEL a XLS rápida y fácilmente con Aspose.Cells. C++ EXCEL a XLS. C++ Guarde EXCEL en XLS. Guarde EXCEL como XLS usando C++.
...
{{% blocks/products/pf/agp/content h2="Guardar EXCEL al XLS en C++" %}}

El siguiente ejemplo demuestra cómo convertir EXCEL a XLS en C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir EXCEL a XLS. Cargue su archivo EXCEL y luego simplemente guárdelo como archivo XLS. Tanto para lectura EXCEL como para escritura XLS, puede utilizar nombres de archivo completos. El contenido y el formato de salida XLS serán idénticos al documento EXCEL original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir EXCEL a XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir EXCEL a XLS a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos EXCEL a XLS mediante programación? Los desarrolladores de C++ pueden convertir fácilmente EXCEL a XLS en tan solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para convertir EXCEL a XLS" %}}
