---
title: Bewerk of bekijk XLS-documentmetadata via C++ 
weight: 2150
url: /nl/cpp/metadata/xls/ 
description: C++ voorbeeldcode om metadata van XLS-bestanden te bewerken of te bekijken op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraheer XLS-metadata via C++" h2="Bouw uw eigen C++ apps om metadata uit XLS-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="XLS-metadata ophalen met C++" %}}
...
+ Laad XLS-bestand met CreateIWorkbookMetadata
