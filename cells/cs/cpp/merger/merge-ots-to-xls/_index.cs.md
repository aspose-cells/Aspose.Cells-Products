...
url: /cs/cpp/merger/merge-ots-to-xls/ 
...
Následující příklad ukazuje, jak sloučit OTS s XLS v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit OTS na XLS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení OTS s XLS" %}}
