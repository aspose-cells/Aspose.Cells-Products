---
title: C# FODS в PRN - FODS в PRN Конвертер
description: Aspose Эксель. Преобразуйте FODS в PRN быстро и легко с помощью Aspose.Cells. C# FODS в PRN. C# Сохраните FODS в PRN. Сохраните FODS как PRN, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в PRN в C#." %}}

В следующем примере показано, как преобразовать FODS в PRN в C#.
...
{{% cells-convert title="Пример кода для преобразования FODS в PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать FODS в PRN через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы FODS в PRN? Разработчики .NET могут легко загрузить и преобразовать FODS в PRN всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования FODS в PRN" %}}
