...
Poniższy przykład pokazuje, jak scalić XLTX z PRN w Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć numer XLTX z PRN? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLTX z PRN" %}}
