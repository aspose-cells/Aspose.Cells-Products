---
title:  Połącz XLSX z XLTM przez Python
url: /pl/python-net/merger/merge-xlsx-to-xltm/ 
description: Połącz XLSX z XLTM Online za darmo. Bezpłatnie online XLSX do XLTM Fuzja. Połącz XLSX z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć XLSX z XLTM w Python.
...
{{% cells-merger title="Darmowa aplikacja do łączenia XLSX z XLTM on-line" InputFormat="xlsx" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
