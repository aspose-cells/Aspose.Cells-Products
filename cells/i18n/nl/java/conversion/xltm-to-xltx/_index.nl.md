---
title: Converteer XLTM naar XLTX via Java 
weight: 5120
url: /nl/java/conversion/xltm-to-xltx/ 
description: Voorbeeld Java conversiecode voor XLTM-indeling naar XLTX-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar XLTX te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLTM naar XLTX via Java" h2="XLTM naar XLTX Java conversie om enkele of meerdere pagina\'s naar XLTX te converteren met behulp van een on-premise Java bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="XLTM naar XLTX converteren met Java" %}}

 Om XLTM naar XLTX te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLTM naar XLTX te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen XLTM-bestanden gemakkelijk converteren naar XLTX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad XLTM-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met XLTX-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende XLTX-bestand
...
{{% blocks/products/pf/agp/code-block title="XLTM naar XLTX Java Conversiebroncode" offSpacer="" %}}

```cs
// laad het XLTM-bestand in een exemplaar van Workbook
Workbook book = new Workbook("template.xltm");
// sla XLTM op als XLTX
