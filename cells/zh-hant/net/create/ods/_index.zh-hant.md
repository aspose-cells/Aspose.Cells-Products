...
description: Aspose Excel。 C# 使用 Aspose.Cells 快速輕鬆地建立 ODS 檔案。使用 C# 產生 ODS 檔案。在 C# 中建立 ODS。在 C# 中建立 ODS。
...
{{< blocks/products/pf/i18n/upper-banner h1="在C#中建立ODS文件" h2="用於建立ODS的高速C#庫。這是一個專業的軟體解決方案，可在.NET Framework、.NET Core或Mono平台上匯入和匯出XLSX、07613481和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
開發人員只需幾行程式碼即可輕鬆在執行不同的報表應用程式中建立、載入、修改和轉換 ODS 檔案以進行資料處理。
