...
url: /tr/cpp/merger/merge-excel-to-xls/ 
...
Aşağıdaki örnek, EXCEL'in Aspose.Cells for C++'de XLS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 EXCEL'i programlı olarak XLS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i XLS ile birleştirmek için C++ kitaplığı" %}}
