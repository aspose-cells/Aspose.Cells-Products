...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 CSV 轉換為 SXC。C++ CSV 為 SXC. C++ 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 C++。
...
以下範例示範如何將 C++ 中的 CSV 轉換為 SXC。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 CSV 轉換為 SXC。上傳您的 CSV 文件，然後只需將其另存為 SXC 文件。對於 CSV 讀取和 SXC 寫入，您可以使用完全限定的檔案名稱。輸出 SXC 內容和格式將與原始 CSV 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 CSV 轉換為 SXC 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="sxc" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 CSV 轉換為 SXC" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 CSV 檔案轉換為 SXC 嗎？ C++開發人員只需幾行程式碼即可輕鬆將CSV轉換為SXC。
