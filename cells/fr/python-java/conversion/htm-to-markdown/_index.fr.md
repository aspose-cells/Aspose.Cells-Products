...
description: Aspose Exceller. Convertissez HTM en MARKDOWN rapidement et facilement avec Aspose.Cells. Python HTM en MARKDOWN. Python Enregistrez HTM en MARKDOWN. Enregistrez HTM sous MARKDOWN en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au MARKDOWN dans Python" %}}
...
{{% cells-convert title="Exemple de code pour convertir HTM en MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="md" IsLandingPage="true" language="pythonjava" %}}
