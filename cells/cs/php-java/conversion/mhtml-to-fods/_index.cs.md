---
title: Převodník PHP MHTML na FODS - MHTML na FODS
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům PHP plně integrovaný přístup k převodu formátu MHTML do formátu FODS, což umožňuje bezproblémové ukládání dat MHTML do formátu FODS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na FODS pomocí PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory MHTML na FODS? Vývojáři PHP mohou snadno načíst a převést MHTML na FODS pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na FODS voláním metody save v sešitu.
1.  Získejte výsledek převodu MHTML na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP knihovna pro převod MHTML na FODS" %}}
