---
title: Mesclar XLSB para SQL - Combine XLSB para SQL em C#
url: /pt/net/merger/merge-xlsb-to-sql/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita XLSB para SQL saveformat. C# Combine XLSB para o formato SQL. Mesclar XLSB para SQL em C#. XLSB Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLSB para SQL em C# online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar XLSB para SQL em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLSB para SQL. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo SQL. Se você desenvolver código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla XLSB com SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLSB para SQL em C#" InputFormat="xlsb" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLSB para SQL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLSB para SQL programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLSB para SQL" %}}
