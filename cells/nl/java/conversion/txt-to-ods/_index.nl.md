---
title: Java TXT tot ODS - TXT tot ODS Converter
description: Aspose Excel. Converteer TXT snel en eenvoudig naar ODS met Aspose.Cells. Java TXT naar ODS. Java Bewaar TXT in ODS. Bewaar TXT als 07611134 81 via Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer TXT naar ODS in Java" h2="Snelle Java-bibliotheek voor het converteren van TXT naar ODS. Dit is een professionele softwareoplossing voor het importeren en exporteren van TXT, ODS en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Bewaar TXT t/m ODS in Java" %}}

Het volgende voorbeeld laat zien hoe u TXT converteert naar ODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe TXT naar ODS via Java te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u TXT-bestanden programmatisch naar ODS converteren? Java-ontwikkelaars kunnen TXT eenvoudig in slechts een paar regels code naar ODS converteren.
...
1.  Converteer TXT naar ODS door de Workbook.save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van TXT naar ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java bibliotheek om TXT naar ODS te converteren" %}}
{{% blocks/products/pf/agp/text %}}
