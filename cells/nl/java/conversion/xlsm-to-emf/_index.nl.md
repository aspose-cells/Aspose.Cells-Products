...
{{% blocks/products/pf/agp/content h2="Sla XLSM op in EMF in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSM omzet naar EMF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar EMF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSM programmatisch converteren naar EMF? Ontwikkelaars van Java kunnen bestanden met de extensie XLSM eenvoudig converteren naar EMF met slechts een paar regels code.
