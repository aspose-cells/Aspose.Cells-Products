...
{{< blocks/products/pf/i18n/upper-banner h1="將 EXCEL 轉換為 TABDELIMITED（C++）" h2="使用 C++ 函式庫進行高效能 EXCEL 到 TABDELIMITED 格式轉換，無需安裝 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
需要透過程式設計方式將 EXCEL 檔案轉換為 TABDELIMITED 格式嗎？ C++ 開發人員只需幾行程式碼即可輕鬆將 EXCEL 轉換為 TABDELIMITED 格式。
...
1. 使用工作簿載入 EXCEL 檔案。
1. 呼叫 Save() 方法將 EXCEL 轉換為 TABDELIMITED。
