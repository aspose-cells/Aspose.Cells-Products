---
title: Search and replace text in XLS document via C++ 
weight: 1870
url: /cpp/redaction/xls/ 
description: Try our On-Premise document redaction APIs to redact sensitive information in XLS file on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Redact XLS Formats in C++" h2="Native and high performance XLS document sensitive redaction information using server-side Aspose.Cells for C++ APIs, without the use of any software like Microsoft or Adobe PDF." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/cells/272x272/aspose_cells-for-cpp.png" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Redact XLS File Using C++" %}}
 ...
 In order to redact XLS file, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to Redact XLS Files in C++" %}}
...
{{% blocks/products/pf/agp/code-block title="RedactВ XLS Files - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSВ Redaction Live Demos" sectionDescription="Search and replace text in contents, comments or metadata in XLS documents right now by visiting our [Live Demos website](https://products.aspose.app/cells/redaction). The live demo has the following benefits" >}}
