...
Het volgende voorbeeld laat zien hoe u MHT converteert naar XLT in Python via NET.
...
{{% blocks/products/pf/agp/content h2="MHT converteren naar XLT" %}}
