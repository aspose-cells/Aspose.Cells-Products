...
url: /cs/cpp/merger/merge-jpg-to-mhtml/ 
...
Následující příklad ukazuje, jak sloučit JPG s MHTML v Aspose.Cells for C++.
...
Potřebujete sloučit JPG na MHTML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do MHTML" %}}
