---
title: A XLTX-HTML-es számok egyesítése – a XLTX-es és a HTML-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-xltx-to-html/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés XLTX HTML mentési formátumba. C# A XLTX és a HTML formátum kombinálása. Egyesítse a XLTX-HTML-et a C#-ben. XLTX Egyesítse.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLTX-es számokat a HTML-es számokhoz a C#-ben online ingyen" %}}

A következő példa bemutatja a XLTX és a HTML egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLTX-es és a HTML-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a HTML fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a XLTX és HTML számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a XLTX-HTML-es számok egyesítéséhez a C#-ben" InputFormat="xltx" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLTX és a HTML egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLTX-et a HTML-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLTX és HTML egyesítéséhez" %}}
