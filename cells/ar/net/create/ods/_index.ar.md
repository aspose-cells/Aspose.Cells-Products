---
title: إنشاء ODS - إنشاء ملف ODS في C#
description: Aspose Excel. أنشئ ملفات ODS وتعامل معها بسهولة باستخدام مكتبة Aspose.Cells for .NET. توفر هذه المكتبة القوية API حلاً مبسطًا وفعالًا لإنشاء ملفات ODS وتعديلها وإدارتها مباشرةً ضمن تطبيقاتك C#، مما يلبي احتياجات المطورين بدقة عالية.
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء ODS في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف ODS في C#." offSpacer="" %}}
