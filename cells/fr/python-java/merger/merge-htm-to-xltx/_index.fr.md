...
url: /fr/python-java/merger/merge-htm-to-xltx/ 
...
L'exemple suivant montre comment fusionner HTM avec XLTX dans Aspose.Cells for Python via Java.
...
Besoin de fusionner HTM avec XLTX par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
