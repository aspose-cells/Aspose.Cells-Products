---
title: Java XLS do ODS - Konwerter online XLS do ODS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwertuj XLS na ODS saveformat. Java XLS do ODS w formacie. Zapisz XLS do ODS Java.
...
{{% blocks/products/pf/agp/content h2="Zaoszczędź XLS do ODS w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na ODS w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na ODS. Prześlij swój plik XLS, a następnie po prostu zapisz go jako plik ODS. Zarówno do odczytu XLS, jak i zapisu ODS można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie ODS będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLS na ODS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na ODS? Java programiści mogą łatwo przekonwertować XLS na ODS w zaledwie kilku wierszach kodu.
...
1.  Konwertuj XLS na ODS, wywołując metodę Workbook.save.
