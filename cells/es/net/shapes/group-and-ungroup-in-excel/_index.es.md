...
weight: 340
description: C# código fuente para agrupar y desagrupar formas en Excel en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Cómo agrupar y desagrupar formas en un archivo de Excel usando C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[método de grupo](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/group/) para agrupar formas en la hoja de cálculo seleccionada
 + Usa el[método de desagrupar](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/) para desagrupar formas en la hoja de cálculo seleccionada
