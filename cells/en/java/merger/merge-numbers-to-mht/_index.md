...
description: Merge NUMBERS to MHT in Java. Merge NUMBERS to MHT via Java online for free. Combine NUMBERS to MHT using Java based desktop or web application.
---
...
Follow the easy steps to merge NUMBERS to MHT. Upload your files, call Workbook.Combine method for merging files, and then save it to MHT file. If you develop code in Java, this will be simpler than it sounds. See {{platform} example that merges NUMBERS to MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Free App to merge NUMBERS to MHT on line" InputFormat="numbers" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
