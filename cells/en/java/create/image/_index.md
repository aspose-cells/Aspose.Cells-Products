...
description: Java Aspose Cells. Java Create IMAGE File. Create IMAGE Java. Java IMAGE Creater. Create IMAGE in Java. Generate IMAGE file using Java.
...
{{% blocks/products/pf/agp/content h2="How to Create IMAGE in Java" %}}
...
1.  Save the workbook as IMAGE format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create IMAGE file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create IMAGE file" %}}
{{% blocks/products/pf/agp/text %}}
