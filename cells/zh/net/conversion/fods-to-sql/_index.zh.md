...
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 FODS 转换为 SQL 格式，从而能够使用 Aspose.Cells 库将 FODS 数据无缝保存为 SQL 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 FODS 转换为 C# 中的 SQL" h2="高速 C# 库，用于将 FODS 转换为 SQL。这是一个专业的软件解决方案，可在 .NET Framework、.NET Core 或 Mono 平台上导入和导出 FODS、SQL 和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="将 FODS 保存到 SQL 数据库 C#" %}}

以下示例演示了如何将 FODS 转换为 C# 中的 SQL。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 FODS 转换为 SQL。上传您的 FODS 文件，然后将其保存为 SQL 文件。对于 FODS 读取和 SQL 写入，您都可以使用完全限定的文件名。输出的 SQL 内容和格式将与原始 FODS 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 FODS 转换为 SQL 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 FODS 转换为 SQL" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 FODS 文件转换为 SQL？.NET 开发人员只需几行代码即可轻松加载 FODS 并将其转换为 SQL。
...
{{% blocks/products/pf/agp/content h2="C# 库用于将 FODS 转换为 SQL" %}}
