...
{{% blocks/products/pf/agp/content h2="Sla HTML op in Excel onder de naam C++" %}}

Het volgende voorbeeld laat zien hoe je HTML naar EXCEL kunt converteren in C++.
...
Moet u bestanden met de extensie HTML programmatisch naar Excel converteren? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig in een paar regels code naar Excel converteren.
...
1.  Converteer HTML naar een Excel-bestand door de Save()-methode aan te roepen.
