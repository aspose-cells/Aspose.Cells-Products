...
description: Aspose Exceller. Python Aspose.Cells. Fusionner HTM avec le format de sauvegarde XPS. Python Combinez HTM au format XPS. Fusionner HTM avec XPS dans Python. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec XPS en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec XPS dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner HTM avec XPS dans Python" InputFormat="htm" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec XPS via Python" %}}
