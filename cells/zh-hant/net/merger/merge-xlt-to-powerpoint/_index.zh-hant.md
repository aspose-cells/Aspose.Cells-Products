...
以下示例演示如何將 XLT 合併到 Aspose.Cells for .NET 中的 POWERPOINT。
...
需要以編程方式將 XLT 合併到 POWERPOINT 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 庫將 XLT 合併到 POWERPOINT" %}}
