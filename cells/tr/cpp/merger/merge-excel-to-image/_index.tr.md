...
url: /tr/cpp/merger/merge-excel-to-image/ 
...
Aşağıdaki örnek, Aspose.Cells for C++'de EXCEL'in IMAGE ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 EXCEL'i IMAGE ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i IMAGE ile birleştirmek için C++ kitaplığı" %}}
