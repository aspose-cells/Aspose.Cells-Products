...
description: Aspose Unggul. Ubah PRN menjadi XLS dengan cepat dan mudah menggunakan Aspose.Cells. Java PRN menjadi XLS. Java Simpan PRN ke XLS. Simpan PRN sebagai XLS menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah PRN menjadi XLS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi PRN ke XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, XLS, dan banyak format lain menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PRN menjadi XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke XLS secara terprogram? Pengembang Java dapat dengan mudah mengonversi PRN menjadi XLS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk mengonversi PRN menjadi XLS" %}}
{{% blocks/products/pf/agp/text %}}
