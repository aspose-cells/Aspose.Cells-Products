---
title: XLAM en ET - Convertir XLAM en fichiers ET Java
description: Aspose Excel. Convertir gratuitement en ligne XLAM au format de sauvegarde ET. Java XLAM au format ET. Enregistrez XLAM comme ET dans Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLAM à ET dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLAM en ET dans Java.
...
Besoin de convertir les fichiers XLAM en ET par programmation ? Les développeurs de Java peuvent facilement convertir XLAM en ET en quelques lignes de code.
