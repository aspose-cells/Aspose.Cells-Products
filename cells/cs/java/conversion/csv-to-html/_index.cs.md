...
{{< blocks/products/pf/i18n/upper-banner h1="Převést CSV na HTML pomocí Java" h2="Převod CSV na HTML Java pro převod jedné nebo více stránek do HTML pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést CSV do HTML pomocí Java" %}}

 K vykreslení CSV do HTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postup převodu CSV na HTML prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na HTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Jako parametry předejte výstupní cestu s rozšířením HTML a SaveFormat1. Zkontrolujte zadanou cestu pro výsledný soubor HTML
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na HTML Java" offSpacer="" %}}

```cs
// načíst soubor CSV v instanci sešitu
Workbook book = new Workbook("template.csv");
// uložit CSV jako HTML
