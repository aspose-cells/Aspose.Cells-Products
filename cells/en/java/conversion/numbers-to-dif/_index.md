...
description: Sample Java conversion code for NUMBERS format to DIF file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to DIF within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert NUMBERS to DIF Using Java" %}}
 ...
 In order to render NUMBERS to DIF, we’ll use
