...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení tlačítka (ovládání formuláře) do souboru aplikace Excel pomocí Python via java" %}}
...
{{% blocks/products/pf/agp/code-block title="Tlačítko Vložit (ovládání formuláře) - Python via java" offSpacer="" %}}
