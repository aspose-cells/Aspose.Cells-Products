...
{{% blocks/products/pf/agp/content h2="Sla OTS op in XLS in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar XLS converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar XLS via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar XLS? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar XLS met slechts een paar regels code.
