...
description: C# Sample code to add or insert Star/Banner into Excel using .NET Library. Use this code to create Star/Banner in MS Excel within VB.NET, Asp.NET or any .NET based application.
