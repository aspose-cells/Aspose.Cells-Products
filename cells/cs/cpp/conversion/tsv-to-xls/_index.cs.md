...
description: Aspose Excel. Převeďte TSV na XLS rychle a snadno pomocí Aspose.Cells. C++ TSV na XLS. C++ Ušetřete TSV na 197 3481761 jako 197 348161 C++ 481 pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Uložit TSV až XLS v C++" %}}

Následující příklad ukazuje, jak převést TSV na XLS v C++.
...
{{% cells-convert title="Ukázkový kód pro převod TSV na XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést TSV na XLS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory TSV na XLS programově? Vývojáři C++ mohou snadno převést TSV na XLS v několika řádcích kódu.
...
1.  Převeďte TSV na XLS voláním metody Save().
