...
description: Create XLTM files in C# code. Generate MS Excel XLTM files using VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a MS Excel XLTM file using C#." offSpacer="" %}}
