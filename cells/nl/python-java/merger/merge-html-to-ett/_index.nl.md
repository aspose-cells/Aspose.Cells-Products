...
url: /nl/python-java/merger/merge-html-to-ett/ 
...
Het volgende voorbeeld laat zien hoe u HTML samenvoegt met ETT in Aspose.Cells for Python via Java.
...
Wilt u HTML programmatisch samenvoegen met ETT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
