...
url: /pl/python-java/merger/merge-xlt-to-tsv/ 
...
Poniższy przykład pokazuje, jak połączyć XLT z TSV w Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć XLT z TSV? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
