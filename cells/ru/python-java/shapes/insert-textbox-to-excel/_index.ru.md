...
{{% blocks/products/pf/agp/content h2="Как вставить TextBox в файл Excel, используя Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке TextBox в файл Excel с использованием Python via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addTextBox(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить TextBox в выбранный рабочий лист.
