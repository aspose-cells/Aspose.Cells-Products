...
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az EXCEL TIFF formátumba konvertálásához, lehetővé téve az EXCEL adatok zökkenőmentes mentését TIFF formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="EXCEL fájl mentése a TIFF-es számra a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet az EXCEL-t TIFF-re konvertálni a C#-ben.
...
Programozottan kell konvertálnia az EXCEL fájlokat TIFF-re? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják az EXCEL-t TIFF-re.
...
1.  Alakítsd át az EXCEL-t TIFF formátumúra a Workbook.Save metódus meghívásával.
