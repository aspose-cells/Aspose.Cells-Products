...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer CheckBox dans un fichier Excel via C#" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) pour insérer un CheckBox dans la feuille de calcul sélectionnée
