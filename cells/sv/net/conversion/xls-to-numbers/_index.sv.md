---
title: C# XLS till SIFFROR - XLS till SIFFROR-omvandlare
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till NUMBERS-format, vilket möjliggör sömlös sparning av XLS-data till NUMBERS-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till NUMBERS i C#" %}}

Följande exempel visar hur man konverterar XLS till NUMMERS i C#.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att konvertera XLS till NUMBERS. Ladda upp din XLS-fil och spara den sedan som en NUMBERS-fil. För både läsning och skrivning av XLS kan du använda fullständiga filnamn. Utdatainnehållet och formateringen för NUMBERS kommer att vara identiskt med det ursprungliga XLS-dokumentet.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exempelkod för att konvertera XLS till NUMMERS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="numbers" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till NUMMERS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till NUMMERS programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till NUMMERS med bara några få rader kod.
...
1.  Konvertera XLS till NUMBERS genom att anropa Workbook.Save-metoden.
1.  Hämta konverteringsresultatet av XLS till NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-biblioteket för att konvertera XLS till NUMMERS" %}}
