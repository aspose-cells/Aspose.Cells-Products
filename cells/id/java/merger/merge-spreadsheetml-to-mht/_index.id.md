---
title: Gabungkan SPREADSHEETML ke MHT - Gabungkan SPREADSHEETML ke MHT di Java
url: /id/java/merger/merge-spreadsheetml-to-mht/ 
description: Aspose Unggul. Java Aspose.Cells. Online Gratis Menggabungkan SPREADSHEETML ke format penyimpanan MHT. Java Gabungkan format SPREADSHEETML ke MHT. Gabungkan SPREADSHEETML ke MHT di Java. Gabungkan SPREADSHEETML.
...
Contoh berikut menunjukkan cara menggabungkan SPREADSHEETML ke MHT di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan SPREADSHEETML ke MHT di Java" InputFormat="xml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SPREADSHEETML ke MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SPREADSHEETML ke MHT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
