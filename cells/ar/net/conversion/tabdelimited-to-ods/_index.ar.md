...
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل TABDELIMITED إلى ODS saveformat. C# TABDELIMITED إلى تنسيق ODS. احفظ TABDELIMITED إلى ODS C#.
...
{{% blocks/products/pf/agp/content h2="احفظ TABDELIMITED إلى ODS في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل TABDELIMITED إلى ODS في C#.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل TABDELIMITED إلى ODS. قم بتحميل ملف TABDELIMITED ثم احفظه كملف ODS. لكل من قراءة TABDELIMITED وكتابة ODS ، يمكنك استخدام أسماء ملفات مؤهلة تمامًا. سيكون المحتوى والتنسيق الناتج ODS مطابقًا لمستند TABDELIMITED الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل TABDELIMITED إلى ODS عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى ODS عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات TABDELIMITED إلى ODS برمجيًا؟ يمكن للمطورين .NET تحميل وتحويل TABDELIMITED بسهولة إلى ODS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل TABDELIMITED إلى ODS عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل TABDELIMITED إلى ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# مكتبة لتحويل TABDELIMITED إلى ODS" %}}
