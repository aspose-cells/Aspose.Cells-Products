...
{{< blocks/products/pf/i18n/upper-banner h1="XLSM-fájlok felosztása a következőn keresztül: Java" h2="XLSM felosztás a szerveroldali Java könyvtár segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="XLSM-fájl felosztása a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM-fájlok felosztásának lépései a következőben: Java" %}}
...
+ Hívja meg a mentési módszert új XLSM fájl elérési úttal.
...
{{% blocks/products/pf/agp/code-block title="XLSM-fájl felosztása – Java" offSpacer="" %}}
