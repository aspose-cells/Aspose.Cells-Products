...
url: /pl/python-java/merger/merge-xlsb-to-tiff/ 
...
Poniższy przykład pokazuje, jak połączyć XLSB z TIFF w Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć XLSB z TIFF? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
