...
{{% blocks/products/pf/agp/content h2="Sla FODS op in DOCX in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar DOCX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar DOCX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar DOCX? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar DOCX met slechts een paar regels code.
