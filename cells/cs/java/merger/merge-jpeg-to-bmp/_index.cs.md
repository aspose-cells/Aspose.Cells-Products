---
title: Sloučit JPEG až BMP - Sloučit JPEG až BMP v Java
url: /cs/java/merger/merge-jpeg-to-bmp/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma JPEG do formátu uložení BMP. Java Kombinujte formát JPEG až BMP. Sloučit JPEG až BMP v Java. JPEG Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG až BMP pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG až BMP v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JPEG až BMP v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPEG do BMP. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru BMP. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí JPEG do BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JPEG až BMP v Java" InputFormat="jpg" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPEG do BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JPEG až BMP? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení JPEG až BMP" %}}
