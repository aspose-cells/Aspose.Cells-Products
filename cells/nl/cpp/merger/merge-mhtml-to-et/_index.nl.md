---
title: Voeg MHTML samen met ET - Combineer MHTML met ET in C++
url: /nl/cpp/merger/merge-mhtml-to-et/ 
description: Aspose Excel. C++ Aspose.Cells. Voeg MHTML samen naar ET-opslagformaat. C++ Combineer MHTML naar ET-formaat. Voeg MHTML samen met ET in C++. MHTML Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg MHTML samen met ET in C++" %}}

Het volgende voorbeeld laat zien hoe u MHTML samenvoegt met ET in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHTML samen te voegen met ET. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een ET-bestand. Als u code ontwikkelt in C++, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld C++ waarin MHTML wordt samengevoegd met ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om MHTML samen te voegen met ET in C++" InputFormat="mhtml" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe u MHTML samenvoegt met ET via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHTML programmatisch samenvoegen met ET? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om MHTML samen te voegen met ET" %}}
