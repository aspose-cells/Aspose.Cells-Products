---
title: Объединить FODS в WORD - Объединить FODS в WORD в C#
url: /ru/net/merger/merge-fods-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Бесплатное онлайн-объединение FODS в формат сохранения WORD. C# Объединить FODS в формат WORD. Объединить FODS в WORD в C#. FODS Объединить.
...
В следующем примере показано, как объединить FODS в WORD в Aspose.Cells for .NET.
...
{{% cells-merger title="Бесплатно онлайн объединить FODS в WORD в C#" InputFormat="fods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Как объединить FODS в WORD через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить FODS в WORD? Базовый документ сливается и объединяется с[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API можно реализовать всего несколькими строками кода.
