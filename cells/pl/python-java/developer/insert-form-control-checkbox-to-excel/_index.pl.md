---
title:  Wstaw CheckBox (kontrolka formularza) do Excela, używając Python via Java
weight: 30
description: Python via Kod źródłowy Java umożliwiający wstawienie CheckBox (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić CheckBox (kontrolkę formularza) do pliku Excel przy użyciu Python via java" %}}

 Aby wstawić CheckBox (kontrolkę formularza) do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić CheckBox (kontrolkę formularza) do pliku Excel przy użyciu Python via Java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić CheckBox (kontrolkę formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw CheckBox (kontrolka formularza) - Python via java" offSpacer="" %}}
