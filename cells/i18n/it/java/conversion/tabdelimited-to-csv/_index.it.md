---
title: Converti TABDELIMITED in CSV tramite Java 
url: /it/java/conversion/tabdelimited-to-csv/ 
description: Esempio di codice di conversione Java per il formato TABDELIMITED in file CSV. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in CSV all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti TABDELIMITED in CSV tramite Java" h2="Conversione da TABDELIMITED a CSV Java per convertire pagine singole o multiple in CSV utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire TABDELIMITED in CSV utilizzando Java" %}}

 Per rendere TABDELIMITED in CSV, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TABDELIMITED in CSV tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente il file TABDELIMITED in CSV in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TABDELIMITED con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con estensione CSV e SaveFormat come parametri1. Controllare il percorso specificato per il file CSV risultante
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED a CSV Java codice sorgente di conversione" offSpacer="" %}}

```cs
// caricare il file TABDELIMITED in un'istanza di Workbook
Workbook book = new Workbook("template.tabdelimited");
// salva TABDELIMITED come CSV
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da TABDELIMITED a CSV" sectionDescription="[Converti TABDELIMITED in CSV](https://products.aspose.app/cells/conversion/tabdelimited-to-csv) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file TABDELIMITED, verrà convertito istantaneamente in CSV." >}}
