...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in SXC in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar SXC in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar SXC of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar SXC? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar SXC met slechts een paar regels code.
