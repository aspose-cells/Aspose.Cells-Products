...
description: Aspose Unggul. Konversikan EXCEL ke XLS dengan cepat dan mudah dengan Aspose.Cells. C++ EXCEL ke XLS. C++ Simpan EXCEL ke XLS. Simpan EXCEL sebagai XLS menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah EXCEL menjadi XLS Menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengonversi EXCEL ke XLS di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi EXCEL menjadi XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi EXCEL ke XLS melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke XLS secara terprogram? Pengembang C++ dapat dengan mudah mengonversi EXCEL menjadi XLS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah EXCEL menjadi XLS" %}}
