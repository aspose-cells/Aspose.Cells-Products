...
{{% blocks/products/pf/agp/content h2="วิธีผสานไฟล์ XLSM โดยใช้ Java" %}}

 ในการรวมไฟล์ XLSM เราจะใช้
...
+ โหลดเอกสาร XLSM ที่สองด้วยอินสแตนซ์ของคลาสสมุดงาน
+ ผสานไฟล์โดยใช้วิธีรวม ()
+ บันทึกไฟล์ XLSM ที่ผสานที่เส้นทางที่ระบุ
