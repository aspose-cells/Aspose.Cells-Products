---
title: Создать SQL — создать файл SQL по номеру C++.
description: Aspose Excel. Легко создавайте и обрабатывайте SQL-файлы с помощью библиотеки Aspose.Cells for C++. Эта мощная библиотека API предоставляет оптимизированное и эффективное решение для создания, редактирования и управления SQL-файлами непосредственно в ваших приложениях C++, удовлетворяя специфические потребности разработчиков с высокой точностью.
...
{{< blocks/products/pf/i18n/upper-banner h1="Создайте SQL-файл в C++" h2="Программное создание высокопроизводительных SQL-файлов без использования Microsoft Office с помощью библиотеки C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Как создать SQL-запрос в C++" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчикам легко создавать, загружать, изменять и преобразовывать SQL-файлы в работающих приложениях для создания отчетов и обработки данных всего несколькими строками кода.
...
1.  Сохраните рабочую книгу в виде файла .sql, используя метод Save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать SQL-файл в файле C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для создания SQL-файла" %}}
