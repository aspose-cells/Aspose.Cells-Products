---
title: HTM egyesítése az IMAGE-val – HTM egyesítése az IMAGE-val a C#-ben
url: /hu/net/merger/merge-htm-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítése a HTM-mel az IMAGE mentési formátumba. C# HTM kombinálása IMAGE formátummal. HTM egyesítése az IMAGE-val a C#-ben. HTM egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a HTM-et az IMAGE-val a C#-es online ingyenesen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a HTM-et az IMAGE-val a Aspose.Cells for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTM és az IMAGE egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el az IMAGE fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTM-et az IMAGE-val.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTM és az IMAGE egyesítéséhez a C# számon" InputFormat="htm" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTM és az IMAGE egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTM-et az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és az IMAGE egyesítéséhez" %}}
