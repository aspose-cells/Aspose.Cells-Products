---
title:  Combinar XLS a XLS via Java
url: /es/java/merger/merge-xls-to-xls/ 
description: Combine XLS a XLS en línea de forma gratuita. Gratis Online XLS a XLS Fusión. Combine XLS con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar XLS con XLS en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a XLS en línea" InputFormat="xls" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
