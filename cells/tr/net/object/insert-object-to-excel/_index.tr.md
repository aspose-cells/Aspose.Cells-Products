---
title:  OLE nesnesini Excel via .NET'e ekleyin
weight: 170
description: C# kaynak kodu, .NET Framework, .NET Core, Mono veya Xamarin Platformlarında OLE nesnesini Excel'e eklemek için.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="OLE nesnesini Excel via .NET\'e ekleyin" h2="Aspose.Cells API\'lerini kullanarak, Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım olmadan OLE nesnesini ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
