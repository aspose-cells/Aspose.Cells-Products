...
{{% blocks/products/pf/agp/content h2="Pythonを使用してOTSを数値に変換します" %}}
...
次の例は、OTS を Python の NUMBERS に変換する方法を示しています。
...
{{% blocks/products/pf/agp/content h2="Python 経由で OTS を NUMBERS に変換する方法" %}}
