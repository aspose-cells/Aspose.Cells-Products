---
title: C# XLS ถึง JSON - ออนไลน์ XLS ถึง JSON Converter
description: Aspose เก่ง. C# Aspose.Cells C# Aspose Cells ออนไลน์ฟรี C# แปลง XLS เป็น JSON บันทึกรูปแบบ รูปแบบ C# XLS ถึง JSON บันทึก XLS ถึง JSON C#
...
{{< blocks/products/pf/i18n/upper-banner h1="แปลง XLS เป็น JSON ใน C#" h2="ไลบรารี C# ความเร็วสูงสำหรับการแปลง XLS เป็น JSON นี่เป็นโซลูชันซอฟต์แวร์ระดับมืออาชีพสำหรับนำเข้าและส่งออก XLS, JSON และรูปแบบอื่นๆ อีกมากมายบน .NET Framework, .NET Core หรือ Mono Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ถึง JSON ใน C# ออนไลน์ฟรี" %}}
