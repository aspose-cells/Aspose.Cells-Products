...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke MARKDOWN menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke MARKDOWN di Java" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX menjadi MARKDOWN di Java.
...
Perlu mengkonversi file XLTX ke MARKDOWN secara terprogram? Pengembang Java dapat dengan mudah mengkonversi XLTX ke MARKDOWN hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi XLTX menjadi MARKDOWN" %}}
{{% blocks/products/pf/agp/text %}}
