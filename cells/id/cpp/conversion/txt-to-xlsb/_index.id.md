...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file TXT ke XLSB hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file TXT menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (XLSB).1. File XLSB akan disimpan di jalur yang ditentukan.1. Buka file XLSB di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="TXT ke XLSB C++ Kode Sumber Konversi" offSpacer="" %}}
