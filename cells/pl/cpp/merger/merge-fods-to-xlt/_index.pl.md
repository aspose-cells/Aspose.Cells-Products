---
title: Połącz FODS z XLT - Połącz FODS z XLT w C++
url: /pl/cpp/merger/merge-fods-to-xlt/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online FODS do XLT w formacie zapisu. C++ Połącz format FODS z XLT. Połącz FODS z XLT w C++. FODS Połącz.
...
Poniższy przykład pokazuje, jak połączyć FODS z XLT w Aspose.Cells for C++.
...
{{% cells-merger title="Bezpłatne połączenie online FODS z XLT w C++" InputFormat="fods" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć FODS z XLT za pośrednictwem C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić FODS z XLT programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
