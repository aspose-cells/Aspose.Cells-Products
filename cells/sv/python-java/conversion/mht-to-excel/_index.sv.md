...
description: Aspose Excel. Konvertera MHT till EXCEL snabbt och enkelt med Aspose.Cells. Python MHT till EXCEL. Python Spara MHT till EXCEL. Spara MHT som EXCEL med Python.
...
{{% blocks/products/pf/agp/content h2="Spara MHT till EXCEL i Python" %}}
...
{{% cells-convert title="Exempelkod för att konvertera MHT till EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}
