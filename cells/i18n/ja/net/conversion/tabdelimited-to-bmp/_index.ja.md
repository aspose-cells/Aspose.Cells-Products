...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET開発者は、わずか数行のコードでTABDELIMITEDファイルを簡単にロードしてBMPに変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookのインスタンスを含むTABDELIMITEDファイルをロードします1. Workbook.Saveメソッドを呼び出します1. パラメータとしてBMP拡張子を持つ出力パスを渡します1. 結果のBMPファイルの指定されたパスを確認してください
...
{{% cells-convert title="TABDELIMITEDをBMPに変換するための無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="bmp" IsLandingPage="true" %}}
