...
description: Aspose Excel. Python Excel. Mesclar SPREADSHEETML com DIF saveformat. Python Combine SPREADSHEETML com o formato DIF. Mesclar SPREADSHEETML com DIF na biblioteca Python do Excel. Mesclar PLANILHAML.
...
{{% cells-merger title="Código de exemplo para mesclar SPREADSHEETML com DIF na biblioteca Python do Excel" InputFormat="xml" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SPREADSHEETML com DIF por meio da biblioteca Python do Excel" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SPREADSHEETML com DIF programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs podem ser feitas com apenas algumas linhas de código.
