...
{{% cells-convert title="Ukázkový kód pro převod PNG na MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést PNG na MD přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést PNG soubory na MD programově? Vývojáři .NET mohou snadno načíst a převést PNG na MD v několika řádcích kódu.
