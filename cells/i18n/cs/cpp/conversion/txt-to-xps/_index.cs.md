---
title: Převeďte TXT na XPS pomocí aplikace C++ 
url: /cs/cpp/conversion/txt-to-xps/ 
description: Ukázkový konverzní kód C++ pro dokument TXT do formátu XPS. Programátoři mohou použít tento zdrojový kód pro dávkový převod TXT na XPS v jakékoli aplikaci C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést TXT na XPS přes C++" h2="Vysoce výkonný převod TXT na XPS pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést TXT na XPS pomocí C++" %}}
 ...
 Abychom převedli TXT na XPS, použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor TXT na XPS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XPS).1. Soubor XPS bude uložen do zadané cesty.1. Otevřete soubor XPS v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TXT na XPS C++" offSpacer="" %}}
