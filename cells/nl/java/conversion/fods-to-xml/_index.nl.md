...
description: Aspose Excel. Converteer FODS snel en eenvoudig naar XML met Aspose.Cells. Java FODS naar XML. Java Sla FODS op in XML. Sla FODS op als XML met behulp van Java.
...
{{% blocks/products/pf/agp/content h2="Sla FODS op in XML in Java" %}}

Het volgende voorbeeld laat zien hoe u FODS naar XML converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar XML via Java te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u FODS-bestanden programmatisch naar XML converteren? Java-ontwikkelaars kunnen FODS eenvoudig in slechts een paar regels code naar XML converteren.
