---
title: 通过 C# 在 Micorsoft Excel XLS 文件中插入数据透视图
weight: 7690
description: C# 生成带有数据透视图的 XLS 文档的示例代码。使用此代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中创建带有数据透视表的 Micorsoft Excel XLS 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 在 XLS 文档中插入数据透视图" h2="本机和高性能 Microsoft Excel XLS 使用服务器端 API 以编程方式创建数据透视图的电子表格 .NET。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
在运行的应用程序中动态生成带有数据透视图的 MS Excel XLS 文件很容易。为了在不需要 MS Office 的情况下从头开始使用数据透视图创建 XLS 文档，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过C#在XLS中插入数据透视图" %}}

{{% blocks/products/pf/agp/text %}}

开发人员可以很容易地在运行不同报告应用程序的 XLS 格式电子表格中插入数据透视图，只需几行代码即可进行数据处理。
...
一个 Excel 电子表格编程库，能够构建跨平台应用程序，能够生成、修改、转换、呈现和打印 Excel XLS 文件。 .NET Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件渲染为图像，PDF、HTML、ODS 等，从而使其成为交换行业标准格式文档的完美选择。
