---
title: Chuyển đổi XLTX sang ODS qua C#
url: /vi/net/conversion/xltx-to-ods/
description: Mã mẫu cho chuyển đổi xltx sang ods C#. Sử dụng API mã mẫu cho các tệp xltx hàng loạt để chuyển đổi ods trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp XLTX sang ODS chỉ trong một vài dòng mã.
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi XLTX sang ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="ods" IsLandingPage="true" %}}
