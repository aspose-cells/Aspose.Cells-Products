---
title: 合并 TSV 文件 via .NET
weight: 1360
description: C# 源代码，用于组合 .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 TSV 文档。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合并 C# 中的 TSV 格式" h2="使用服务器端 Aspose.Cells for .NET API 进行本机高性能 TSV 文档合并，无需使用 Microsoft 或 Open Office、Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
为了合并 TSV 文件，我们将使用[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API这是一个功能丰富、强大且易于使用的文档操作和合并API，适用于C#平台。打开[NuGet](https://www.nuget.org/packages/aspose.cells)包管理器，搜索**Aspose.Cells**并安装。您还可以从包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="合并 C# 中的 TSV 文件的步骤" %}}
...
+ 制作一个文档作为基础文件
调用相关方法对文件进行逐一串联和合并。
+ 调用 Save() 方法并传递文件名（完整路径）和格式（TSV）作为参数。
...
{{< blocks/products/pf/agp/demobox sectionTitle="在线 TSV 合并现场演示" sectionDescription="立即合并 TSV 文档，访问我们的[现场演示网站](https://products.aspose.app/cells/merger)。现场演示有以下好处" >}}
