---
title: C# OTS till BMP - OTS till BMP Converter
description: Aspose Excel. Konvertera OTS till BMP snabbt och enkelt med Aspose.Cells. C# OTS till BMP. C# Spara OTS till BMP. Spara OTS som BMP med 304818.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till BMP på C#" %}}

Följande exempel visar hur man konverterar OTS till BMP i C#.
...
{{% cells-convert title="Exempelkod för att konvertera OTS till BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="bmp" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till BMP programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till BMP på bara några rader kod.
...
1.  Konvertera OTS till BMP genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet från OTS till BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera OTS till BMP" %}}
