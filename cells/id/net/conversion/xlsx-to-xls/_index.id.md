---
title: C# XLSX ke XLS - Online XLSX ke XLS Konverter
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Gratis Online C# Ubah XLSX menjadi XLS saveformat. C# XLSX ke format XLS. Simpan XLSX ke XLS C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi XLS di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi XLSX menjadi XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, XLS, dan banyak format lainnya pada Kerangka .NET, .NET Inti atau Mono Platform." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke XLS di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi XLS di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi XLSX menjadi XLS. Unggah file XLSX Anda, lalu simpan sebagai file XLS. Untuk membaca XLSX dan menulis XLS Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format keluaran XLS akan identik dengan dokumen asli XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX menjadi XLS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Konversi XLSX ke XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX menjadi XLS secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX menjadi XLS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengonversi XLSX menjadi XLS" %}}
