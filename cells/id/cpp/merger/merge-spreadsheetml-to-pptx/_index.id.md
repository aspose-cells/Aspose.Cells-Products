---
title: Gabungkan SPREADSHEETML ke PPTX - Gabungkan SPREADSHEETML ke PPTX di C++
url: /id/cpp/merger/merge-spreadsheetml-to-pptx/ 
description: Aspose Unggul. C++ Aspose.Cells. Gratis Online Menggabungkan SPREADSHEETML ke PPTX saveformat. C++ Gabungkan format SPREADSHEETML ke PPTX. Gabungkan SPREADSHEETML ke PPTX di C++. Gabungkan SPREADSHEETML.
...
Contoh berikut menunjukkan cara menggabungkan SPREADSHEETML ke PPTX di Aspose.Cells for C++.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan SPREADSHEETML ke PPTX di C++" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SPREADSHEETML ke PPTX via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SPREADSHEETML ke PPTX secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
