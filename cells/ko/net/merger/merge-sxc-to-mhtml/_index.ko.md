---
title:  C#을 통해 SXC을 MHTML로 병합
url: /ko/net/merger/merge-sxc-to-mhtml/ 
description: SXC을 MHTML 온라인으로 무료로 병합합니다. 무료 온라인 SXC to MHTML 합병. SXC을 Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS 등에 병합합니다.
---
...
다음 예는 SXC을 C#에서 MHTML로 병합하는 방법을 보여줍니다.
...
{{% cells-merger title="온라인에서 SXC을 MHTML로 병합하는 무료 앱" InputFormat="sxc" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
