---
title: Unisci FODS a BMP - Combina FODS a BMP in C#
url: /it/net/merger/merge-fods-to-bmp/ 
description: Aspose Excel. C# Aspose.Cells. Unione online gratuita da FODS a BMP saveformat. C# Combina il formato FODS con BMP. Unisci FODS a BMP in C#. FODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci FODS a BMP in C# online gratuitamente" %}}

L'esempio seguente mostra come unire FODS a BMP in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire FODS a BMP. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file BMP. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce FODS a BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire FODS a BMP in C#" InputFormat="fods" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire FODS a BMP tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire FODS a BMP a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca da unire FODS a BMP" %}}
