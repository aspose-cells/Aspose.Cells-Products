...
{{% blocks/products/pf/agp/text %}}
 ...
 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják az XLTM fájlokat DIF formátumba.
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód az XLTM DIF-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="dif" IsLandingPage="true" %}}
