---
title:  Inserisci WordArt in Excel usando Python via Java
weight: 200
description: Python via Java codice sorgente per inserire WordArt in Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci WordArt in Excel usando Python via Java" h2="Inserisci WordArts usando Aspose.Cells\' API senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire WordArt in un file Excel utilizzando Python via Java" %}}
 ...
 Per inserire WordArt nel file excel, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire WordArt nel file Excel utilizzando Python via Java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa la collezione di forme[aggiungere metodo](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addWordArt(int,%20java.lang.String,%20int,%20int,%20int,%20int,%20int,%20int)) per inserire una WordArt nel foglio di lavoro selezionato.
