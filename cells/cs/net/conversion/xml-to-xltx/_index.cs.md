---
title: C# XML na XLTX - Převodník XML na XLTX
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu XML do formátu XLTX, což umožňuje bezproblémové ukládání XML dat do formátu XLTX pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Uložit XML do XLTX v C#" %}}

Následující příklad ukazuje, jak převést XML na XLTX s kódem C#.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod XML na XLTX. Nahrajte svůj soubor XML a poté jej jednoduše uložte jako soubor XLTX. Pro čtení XML i zápis XLTX můžete použít plně kvalifikované názvy souborů. Obsah a formátování výstupu XLTX budou shodné s původním dokumentem XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod XML na XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xml" outformat="xltx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na XLTX přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XML na XLTX programově? Vývojáři .NET mohou snadno načíst a převést XML na XLTX v několika řádcích kódu.
...
1.  Převeďte XML na XLTX voláním metody Workbook.Save.
1.  Získejte výsledek převodu XML na XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML na XLTX" %}}
