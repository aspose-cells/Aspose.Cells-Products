...
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng XLS trong C#" h2="Hợp nhất tài liệu XLS gốc và hiệu suất cao bằng cách sử dụng Aspose.Cells for .NET API phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
+ Tải tất cả các tệp XLS với đường dẫn đầy đủ.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tệp XLS - C#" offSpacer="" %}}
