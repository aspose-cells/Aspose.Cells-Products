...
description: Aspose Excel. C++ Aspose.Cells. Συγχώνευση PRN σε μορφή αποθήκευσης POWERPOINT. C++ Συνδυάστε τη μορφή PRN σε POWERPOINT. Συγχώνευση PRN σε POWERPOINT στο C++. Συγχώνευση PRN.
...
{{% blocks/products/pf/agp/content h2="Συγχωνεύστε το PRN στο POWERPOINT στο C++" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση PRN σε POWERPOINT στο C++" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
