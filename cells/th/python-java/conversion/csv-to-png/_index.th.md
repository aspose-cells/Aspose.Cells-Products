---
title: แปลง CSV เป็น PNG ผ่าน Python
url: /th/python-java/conversion/csv-to-png/
description: โค้ดตัวอย่างสำหรับการแปลง csv เป็น png Python ใช้โค้ดตัวอย่าง API สำหรับการแปลงไฟล์ csv แบบแบตช์เป็น png ภายในแอปพลิเคชัน Python
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง CSV เป็น PNG ผ่าน Python" h2="ส่งออกสเปรดชีต Excel® เป็นรูปแบบ PNG โดยใช้ Python APIs" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง CSV เป็น PNG โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง CSV เป็น PNG ผ่าน Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python นักพัฒนาซอฟต์แวร์สามารถโหลดและแปลงไฟล์ CSV เป็น PNG ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ CSV ด้วยอินสแตนซ์ของ Workbook1. เรียกวิธีการบันทึกสมุดงาน1. ส่งผ่านเส้นทางเอาต์พุตที่มีนามสกุล PNG เป็นพารามิเตอร์1. ตรวจสอบเส้นทางที่ระบุสำหรับไฟล์ PNG ที่เป็นผลลัพธ์
...
{{% cells-convert title="แอพฟรีและโค้ดตัวอย่างเพื่อแปลง CSV เป็น PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="png" IsLandingPage="true" language="python" %}}
