---
title: Конвертер PHP MHTML в XLTX - MHTML в XLTX
...
{{% blocks/products/pf/agp/content h2="Как преобразовать MHTML в XLTX с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы с номерами MHTML в XLTX? PHP-разработчики могут легко загрузить и преобразовать файлы с номерами MHTML в XLTX всего несколькими строками кода.
...
1.  Преобразуйте значение MHTML в XLTX, вызвав метод save объекта Workbook.
1.  Получите результат преобразования MHTML в XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-библиотека для преобразования MHTML в XLTX" %}}
