---
title: C# EXCEL à CSV - Convertisseur EXCEL à CSV
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format CSV, permettant un enregistrement transparent des données EXCEL au format CSV à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL sous CSV dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en CSV en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en CSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en CSV par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en CSV en quelques lignes de code seulement.
...
1.  Convertissez le fichier EXCEL au format CSV en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion d’EXCEL en CSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir EXCEL en CSV" %}}
