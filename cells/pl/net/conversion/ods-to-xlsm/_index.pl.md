---
title: Konwertuj ODS na XLSM przez C#
url: /pl/net/conversion/ods-to-xlsm/
description: Przykładowy kod konwersji ods do xlsm C#. Użyj przykładowego kodu API dla wsadowych plików ods do konwersji xlsm w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować ODS na XLSM za pomocą C#" %}}

 Aby przekonwertować ODS na XLSM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ODS na XLSM za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki ODS do formatu XLSM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ODS z wystąpieniem Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLSM jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku XLSM
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji ODS na XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xlsm" IsLandingPage="true" %}}
