---
title: Creëer XPS - Creëer XPS bestand in Python
description: Aspose Excel. Python Creëer XPS-bestand. Creëer XPS Python. Python XPS Maker. Maak XPS in Python. Genereer XPS-bestand met Python.
...
1. Gebruik de methode Save om de werkmap op te slaan als XPS-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een XPS-bestand maakt in Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om XPS-bestand te maken" %}}
