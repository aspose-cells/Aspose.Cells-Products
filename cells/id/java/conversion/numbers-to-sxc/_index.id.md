---
title: Konversi NUMBER ke SXC melalui Java 
url: /id/java/conversion/numbers-to-sxc/ 
description: Contoh Java kode konversi untuk format ANGKA ke file SXC. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke SXC dalam Aplikasi berbasis Java Web atau Desktop apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi NUMBER ke SXC melalui Java" h2="NUMBER ke SXC Java konversi untuk mengonversi satu atau beberapa halaman ke SXC menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ANGKA ke SXC Menggunakan Java" %}}

 Untuk merender NUMBER ke SXC, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi NUMBER ke SXC melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file NUMBERS ke SXC hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file NUMBER dengan instance kelas Buku Kerja1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi SXC & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file SXC yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="NUMBER ke SXC Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// muat file NUMBER dalam instance Workbook
Workbook book = new Workbook("template.numbers");
// simpan NUMBER sebagai SXC
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi NUMBER ke SXC" sectionDescription="[Mengonversi NUMBER ke SXC](https://products.aspose.app/cells/conversion/numbers-to-sxc) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file NUMBER Anda, itu akan langsung dikonversi ke SXC." >}}
