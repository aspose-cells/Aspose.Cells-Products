...
هل تحتاج إلى تحويل ملفات MHT إلى PRN برمجيًا؟ يمكن للمطورين C++ تحويل MHT إلى PRN بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل MHT إلى PRN باستدعاء طريقة Save ().
