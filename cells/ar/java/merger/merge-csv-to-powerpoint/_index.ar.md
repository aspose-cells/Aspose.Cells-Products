---
title:  دمج CSV إلى POWERPOINT via Java
...
يوضح المثال التالي كيفية دمج CSV مع POWERPOINT في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج CSV إلى POWERPOINT عبر الإنترنت" InputFormat="csv" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
