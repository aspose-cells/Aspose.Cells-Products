...
In het volgende voorbeeld ziet u hoe u SPREADSHEETML converteert naar XLS in Python via NET.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML converteren naar XLS" %}}
