...
url: /pl/python-java/merger/merge-numbers-to-pdf/ 
...
Poniższy przykład pokazuje, jak połączyć NUMBERS z PDF w Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć NUMERY z PDF? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
