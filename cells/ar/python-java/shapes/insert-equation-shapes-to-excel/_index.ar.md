---
title: إدراج أشكال المعادلات في برنامج Excel باستخدام Python via Java
weight: 360
description: Python via Java الكود المصدري لإدراج أشكال المعادلات في برنامج Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج أشكال المعادلات في ملف إكسل باستخدام Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج أشكال المعادلات في ملف Excel باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج أشكال المعادلات في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج أشكال المعادلات - Python via Java" offSpacer="" %}}
