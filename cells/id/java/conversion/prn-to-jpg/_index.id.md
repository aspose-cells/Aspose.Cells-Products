...
description: Aspose Unggul. Ubah PRN ke JPG dengan cepat dan mudah dengan Aspose.Cells. Java PRN ke JPG. Java Simpan PRN ke JPG. Simpan PRN sebagai JPG menggunakan Java.
...
Contoh berikut menunjukkan cara mengonversi PRN ke JPG di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah PRN ke JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke JPG secara terprogram? Pengembang Java dapat dengan mudah mengonversi PRN ke JPG hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengkonversi PRN ke JPG" %}}
{{% blocks/products/pf/agp/text %}}
