---
title: Sloučit CSV do EXCELu - Sloučit CSV do EXCELu v Java
url: /cs/java/merger/merge-csv-to-excel/ 
description: Aspose Excel. Java Aspose.Cells. Zdarma online sloučení CSV do formátu uložení EXCEL. Java Spojte CSV do formátu EXCEL. Sloučit CSV do EXCELu v Java. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV do EXCELu v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit CSV do EXCELu v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení CSV do EXCELu. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru EXCEL. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí CSV do EXCELu.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení CSV do EXCELu v Java" InputFormat="csv" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV do EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit CSV do EXCELu programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení CSV do EXCELu" %}}
