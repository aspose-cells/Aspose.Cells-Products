...
{{% blocks/products/pf/agp/content h2="Как вставить прямоугольник в файл Excel с помощью Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке файла Rectangle в Excel с использованием Python via .Net" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте добавление коллекции форм[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_rectangle/#int-int-int-int-int-int) чтобы вставить прямоугольник в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить прямоугольник — Python via .Net" offSpacer="" %}}
