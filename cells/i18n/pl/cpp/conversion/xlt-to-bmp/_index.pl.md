---
title: Konwertuj XLT na BMP za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlt-to-bmp/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLT do formatu BMP. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLT na BMP w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na BMP za pomocą C++" %}}

 Aby przekonwertować XLT na BMP, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na BMP za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLT na BMP w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (BMP).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik BMP w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLT do BMP C++ Kod źródłowy konwersji" offSpacer="" %}}
