---
title: تحويل XLTM إلى XLS عبر تطبيق C++ 
url: /ar/cpp/conversion/xltm-to-xls/ 
description: نموذج C++ رمز تحويل لمستند XLTM إلى تنسيق XLS. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLTM إلى XLS في أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTM إلى XLS عبر C++" h2="تحويل XLTM إلى XLS عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى XLS باستخدام C++" %}}
 ...
 من أجل تحويل XLTM إلى XLS ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ يمكن للمطورين بسهولة تحويل ملف XLTM إلى XLS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLTM باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLS).1. سيتم حفظ ملف XLS في المسار المحدد.1. افتح ملف XLS في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLTM إلى كود مصدر تحويل C++ XLS" offSpacer="" %}}
