---
title:  XLSB Megjegyzés hozzáadása vagy eltávolítása via .NET
weight: 6440
description: C# forráskód a XLSB formátumú megjegyzések hozzáadásához és törléséhez a .NET Framework, .NET Core, Mono vagy Xamarin platformokon.
...
{{% blocks/products/pf/agp/content h2="A XLSB fájl megjegyzéseinek készítése a C# használatával" %}}

 A XLSB fájl megjegyzéseinek rögzítéséhez a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Megjegyzés hozzáadása vagy törlése a XLSB-es számról a C#-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Megjegyzések törlése a XLSB - C# számokról" offSpacer="" %}}
