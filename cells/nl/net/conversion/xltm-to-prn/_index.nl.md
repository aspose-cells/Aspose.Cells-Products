---
title: C# XLTM naar PRN - XLTM naar PRN-converter
description: Aspose Excel. Converteer XLTM snel en eenvoudig naar PRN met Aspose.Cells. C# XLTM naar PRN. C# Bewaar XLTM in PRN. Sla XLTM op als PRN met behulp van C#.
...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in PRN in C#" %}}

Het volgende voorbeeld laat zien hoe u XLTM naar PRN converteert in C#.
...
{{% blocks/products/pf/agp/content h2="Hoe XLTM naar PRN te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLTM-bestanden programmatisch naar PRN converteren? .NET-ontwikkelaars kunnen XLTM eenvoudig in slechts een paar regels code laden en converteren naar PRN.
...
{{% blocks/products/pf/agp/content h2="C# bibliotheek om XLTM naar PRN te converteren" %}}
