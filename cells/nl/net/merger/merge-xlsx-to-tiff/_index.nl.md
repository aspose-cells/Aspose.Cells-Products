---
title: Voeg XLSX samen met TIFF - Combineer XLSX met TIFF in C#
url: /nl/net/merger/merge-xlsx-to-tiff/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen XLSX naar TIFF saveformat. C# Combineer het formaat XLSX tot TIFF. Samenvoegen XLSX tot TIFF in C#. XLSX Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSX samen met TIFF in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLSX samenvoegt met TIFF in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSX samen te voegen met TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen tot TIFF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLSX samen te voegen tot TIFF" %}}
