---
title: Fusionner MHT à MD - Combiner MHT à MD en C#
url: /fr/net/merger/merge-mht-to-md/ 
description: Aspose Excel. C# Aspose.Cells. Format de sauvegarde de fusion MHT en MD gratuit en ligne. C# Combinez le format MHT au format MD. Fusionner MHT à MD en C#. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT à MD en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT à MD dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT à MD. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier MD. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne MHT en MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner MHT à MD en C#" InputFormat="mht" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT à MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner MHT à MD par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner MHT à MD" %}}
