...
Trzeba programowo przekonwertować pliki XLSB na LICZBY? Programiści .NET mogą łatwo załadować i przekonwertować pliki XLSB na LICZBY za pomocą zaledwie kilku linijek kodu.
...
1.  Przekonwertuj XLSB na LICZBY wywołując metodę Workbook.Save.
