---
title: C# XLSX para HTM - Conversor XLSX para HTM
description: Aspose Excel. Converta XLSX em HTM de forma rápida e fácil com Aspose.Cells. C# XLSX em HTM. C# Salve XLSX em HTM. Salve XLSX como HTM usando C#.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX em HTM em C#" %}}

O exemplo a seguir demonstra como converter XLSX em HTM em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX em HTM. Carregue seu arquivo XLSX e simplesmente salve-o como arquivo HTM. Tanto para leitura XLSX quanto para gravação HTM, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação HTM de saída serão idênticos ao documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemplo de código para converter XLSX em HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para HTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para HTM programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em HTM em apenas algumas linhas de código.
...
1.  Converta XLSX em HTM chamando o método Workbook.Save.
