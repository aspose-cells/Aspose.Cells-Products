---
title: Java XLS เป็น OTS - ออนไลน์ XLS เป็น OTS Converter
description: Aspose เก่ง. Java Aspose.Cells Java Aspose Cells ออนไลน์ฟรี Java แปลง XLS เป็นรูปแบบบันทึก OTS Java XLS เป็นรูปแบบ OTS บันทึก XLS เป็น OTS Java
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS เป็น OTS ใน Java ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีแปลง XLS เป็น OTS ใน Java
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อแปลง XLS เป็น OTS อัปโหลดไฟล์ XLS ของคุณ จากนั้นบันทึกเป็นไฟล์ OTS สำหรับทั้งการอ่าน XLS และการเขียน OTS คุณสามารถใช้ชื่อไฟล์แบบเต็มได้ เนื้อหาและการจัดรูปแบบ OTS เอาต์พุตจะเหมือนกับเอกสาร XLS ต้นฉบับ
...
1.  แปลง XLS เป็น OTS โดยเรียกวิธี Workbook.save
1.  รับผลการแปลง XLS เป็น OTS
