...
以下示例演示如何將 FODS 合併到 Aspose.Cells for .NET 中的 DOCX。
...
需要以編程方式將 FODS 合併到 DOCX 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將FODS合併到DOCX" %}}
