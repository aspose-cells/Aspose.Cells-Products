---
title: كيفية رسم أو إدراج شكل سهم منحني في برنامج Excel باستخدام Python via .Net
weight: 10
description: Python via. صافي الكود المصدري لإدراج شكل السهم المنحني في برنامج Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شكل السهم المنحني في ملف Excel باستخدام Python via .Net" %}}

 من أجل إدراج شكل سهم منحني في ملف إكسل، سوف نستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج شكل السهم المنحني في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)لإدراج شكل سهم منحني في ورقة العمل المحددة.
...
-  أي نظام تشغيل يمكنه تشغيل Python via .Net scripts مثل Windows و Linux
...
{{% blocks/products/pf/agp/code-block title="إدراج شكل سهم منحني - Python via .نت" offSpacer="" %}}
