...
url: /cs/python-java/merger/merge-xlsb-to-sql/ 
...
Následující příklad ukazuje, jak sloučit XLSB do SQL v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLSB s SQL programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
