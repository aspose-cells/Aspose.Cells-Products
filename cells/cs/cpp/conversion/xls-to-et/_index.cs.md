...
description: Aspose Excel. Převeďte XLS na ET rychle a snadno pomocí Aspose.Cells. C++ XLS na ET. C++ Uložte XLS do ET. Uložte XLS jako ET pomocí C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte XLS na ET v C++" h2="Vysoce výkonný převod XLS na ET pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte XLS do ET v C++" %}}
...
{{% cells-convert title="Ukázkový kód pro převod XLS na ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="et" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLS na ET přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLS na ET programově? Vývojáři C++ mohou snadno převést XLS na ET v několika řádcích kódu.
...
1. Převeďte XLS na ET voláním metody Save().
