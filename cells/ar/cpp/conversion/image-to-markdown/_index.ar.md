...
هل تحتاج إلى تحويل ملفات IMAGE إلى MARKDOWN برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى MARKDOWN في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى MARKDOWN باستدعاء طريقة Save ().
