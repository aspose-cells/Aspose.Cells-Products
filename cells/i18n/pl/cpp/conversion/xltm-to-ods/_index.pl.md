---
title: Konwertuj XLTM na ODS za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltm-to-ods/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTM do formatu ODS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTM na ODS w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLTM na ODS przez C++" h2="Wysokowydajna konwersja XLTM do ODS przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTM na ODS za pomocą C++" %}}

 Aby przekonwertować XLTM na ODS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki konwersji XLTM na ODS za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLTM na ODS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (ODS).1. Plik ODS zostanie zapisany pod określoną ścieżką.1. Otwórz plik ODS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLTM do ODS C++ Kod źródłowy konwersji" offSpacer="" %}}
