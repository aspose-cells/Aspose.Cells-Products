...
Das folgende Beispiel zeigt, wie HTML mit JPEG in Aspose.Cells for Python via .NET zusammengeführt werden.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie HTML mit JPEG programmgesteuert zusammenführen? Ein grundlegendes Dokument, das zusammengeführt und verknüpft wird mit[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs können mit nur wenigen Codezeilen erstellt werden.
