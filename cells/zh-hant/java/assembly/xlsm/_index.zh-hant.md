---
title: 在 XLSM 文件中生成報告 via Java
weight: 270
description: Java 示例代碼，用於在 JSP/JSF 應用程序和桌面應用程序的 Java 運行時環境上創建 XLSM 格式報告。
---
...
1. 通過 Worbook.save 方法以 XLSM 格式保存結果
...
{{% blocks/products/pf/agp/code-block title="以 XLSM 格式生成 Excel 報告 - C#" offSpacer="" %}}
