...
{{% blocks/products/pf/agp/content h2="XLSM fájldiagramok létrehozása a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM-fájlok diagramok létrehozásának lépései a(z) C++ alkalmazásban" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSM-fájlok diagram létrehozása – C++" offSpacer="" %}}
