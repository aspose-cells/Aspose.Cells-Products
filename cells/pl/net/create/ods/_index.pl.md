...
description: ODS twórca. Utwórz pliki ODS w kodzie C#. Wygeneruj pliki ODS (Openoffice / Lbreoffice) za pomocą VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Utwórz plik ODS za pośrednictwem C#" h2="Natywne i wysokowydajne tworzenie arkuszy kalkulacyjnych ODS (Openoffice / Lbreoffice) programowo przy użyciu interfejsów API .NET po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod do utworzenia pliku ODS (Openoffice / Lbreoffice) przy użyciu C#." offSpacer="" %}}
