---
title: Konwertuj CSV na MD za pomocą Java 
url: /pl/java/conversion/csv-to-md/ 
description: Przykładowy kod konwersji Java dla formatu CSV do pliku MD. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do MD w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj CSV na MD za pomocą Java" h2="Konwersja CSV do MD Java w celu konwersji jednej lub wielu stron do MD przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik CSV na MD za pomocą Java" %}}

 Aby wyrenderować CSV do MD, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować CSV na MD za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik CSV na MD w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem MD i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku MD
...
{{% blocks/products/pf/agp/code-block title="CSV do MD Java Kod źródłowy konwersji" offSpacer="" %}}
