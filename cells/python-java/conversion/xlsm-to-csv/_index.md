...
url: /python/conversion/xlsm-to-csv/
...
{{% cells-convert title="Free App and Sample Code to Convert XLSM to CSV" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx InputFormat=xlsm outformat=csv IsLandingPage=true language=python %}}
