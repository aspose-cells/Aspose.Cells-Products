---
title: Μετατροπή SPREADSHEETML σε XPS μέσω της εφαρμογής C++ 
url: /el/cpp/conversion/spreadsheetml-to-xps/ 
description: Δείγμα κώδικα μετατροπής C++ για έγγραφο SPREADSHEETML σε μορφή XPS. Οι προγραμματιστές μπορούν να χρησιμοποιήσουν αυτόν τον πηγαίο κώδικα για μαζική μετατροπή SPREADSHEETML σε XPS σε οποιαδήποτε εφαρμογή C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές του C++ μπορούν εύκολα να μετατρέψουν το αρχείο SPREADSHEETML σε XPS σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φορτώστε το αρχείο SPREADSHEETML χρησιμοποιώντας το Factory::CreateIWorkbook.1. Καλέστε τη μέθοδο Save().1. Περάστε τη διαδρομή του αρχείου εξόδου με επέκταση αρχείου (XPS).1. Το αρχείο XPS θα αποθηκευτεί στην καθορισμένη διαδρομή.1. Ανοίξτε το αρχείο XPS σε συμβατό πρόγραμμα.
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής SPREADSHEETML σε XPS C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ζωντανές επιδείξεις μετατροπής SPREADSHEETML σε XPS" sectionDescription="[Μετατροπή SPREADSHEETML σε XPS](https://products.aspose.app/cells/conversion/spreadsheetml-to-xps) αυτή τη στιγμή, επισκεπτόμενοι τον ιστότοπο Live Demos. Η ζωντανή επίδειξη έχει τα ακόλουθα πλεονεκτήματα" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Δεν χρειάζεται να κάνετε λήψη του Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Δεν χρειάζεται να γράψετε κανέναν κώδικα." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλώς ανεβάστε το αρχείο SPREADSHEETML, θα μετατραπεί άμεσα σε XPS." >}}
