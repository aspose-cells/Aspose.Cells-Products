---
title: Sloučit JPG do POWERPOINT – Sloučit JPG do POWERPOINT v C++
url: /cs/cpp/merger/merge-jpg-to-powerpoint/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučení formátu JPG do formátu POWERPOINT. C++ Zkombinujte formát JPG s formátem POWERPOINT. Sloučit JPG do POWERPOINT v C++. JPG Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG do POWERPOINT v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JPG do POWERPOINT v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do POWERPOINT. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru POWERPOINT. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JPG do POWERPOINT na C++" InputFormat="jpg" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPG do POWERPOINT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JPG do POWERPOINT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení JPG do POWERPOINT" %}}
