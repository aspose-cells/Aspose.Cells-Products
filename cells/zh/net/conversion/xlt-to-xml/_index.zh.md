...
{{% cells-convert title="将 XLT 在线转换为 XML 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLT 转换为 XML" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 文件转换为 XML？ .NET 开发人员只需几行代码即可轻松加载 XLT 并将其转换为 XML。
