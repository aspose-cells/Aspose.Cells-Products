---
title: Unisci NUMBERS a OTS - Combina NUMBERS a OTS in C#
url: /it/net/merger/merge-numbers-to-ots/ 
description: Aspose Excel. C# Aspose.Cells. Unisci i NUMERI online gratuiti nel formato di salvataggio OTS. C# Combina NUMERI in formato OTS. Unisci NUMBERS a OTS in C#. NUMBERS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci NUMBERS a OTS in C# online gratuitamente" %}}

L'esempio seguente mostra come unire NUMBERS a OTS in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire NUMBERS a OTS. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file OTS. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce NUMBERS a OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire NUMBERS a OTS in C#" InputFormat="numbers" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire NUMBERS a OTS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Hai bisogno di unire NUMBERS a OTS in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria per unire NUMBERS a OTS" %}}
