...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS ke dalam format simpan SPREADSHEETML. Java Gabungkan FODS ke format SPREADSHEETML. Gabungkan FODS ke SPREADSHEETML di Java. FODS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS ke SPREADSHEETML di Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan FODS ke SPREADSHEETML secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk digabungkan FODS menjadi SPREADSHEETML" %}}
