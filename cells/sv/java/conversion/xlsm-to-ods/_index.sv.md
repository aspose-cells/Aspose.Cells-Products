---
title: Konvertera XLSM till ODS via Java 
weight: 2400
url: /sv/java/conversion/xlsm-to-ods/ 
description: Exempel på Java-konverteringskod för XLSM-format till ODS-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till ODS inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till ODS med Java" %}}

 För att rendera XLSM till ODS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLSM-filer till ODS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med ODS-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande ODS-filen
...
{{% blocks/products/pf/agp/code-block title="XLSM till ODS Java omvandlingskällkod" offSpacer="" %}}
