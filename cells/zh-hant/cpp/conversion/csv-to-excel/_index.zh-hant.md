...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 CSV 轉換為 EXCEL。C++ CSV 轉換為 EXCEL。 C++ 將 CSV 儲存到 EXCEL。使用 C++ 將 CSV 另存為 EXCEL。
...
{{% blocks/products/pf/agp/content h2="將 CSV 儲存到 EXCEL 中 C++" %}}

下面的範例示範如何將CSV轉換為EXCEL中的C++。
...
{{% cells-convert title="將 CSV 轉換為 EXCEL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="xlsx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 CSV 轉換為 EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 CSV 檔案轉換為 EXCEL？ C++開發人員只需幾行程式碼即可輕鬆將CSV轉換為EXCEL。
...
1. 使用工作簿載入 CSV 檔案。
1. 透過呼叫 Save() 方法將 CSV 轉換為 EXCEL。
1. 得到CSV到EXCEL的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++庫將CSV轉換為EXCEL" %}}
