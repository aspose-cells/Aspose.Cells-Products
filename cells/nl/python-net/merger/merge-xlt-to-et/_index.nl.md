...
url: /nl/python-net/merger/merge-xlt-to-et/ 
...
Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met ET in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLT programmatisch samenvoegen met ET? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
