---
title: Conversor de PHP SXC para XLSX - SXC para XLSX
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores PHP uma abordagem totalmente integrada para converter o formato SXC para XLSX, permitindo o salvamento perfeito de dados SXC no formato XLSX usando a biblioteca Aspose.Cells, tudo por meio de código PHP eficiente e personalizável.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter SXC para XLSX em PHP" h2="Biblioteca PHP de alta velocidade para conversão de SXC para XLSX. Esta é uma solução de software profissional para importar e exportar os formatos SXC, XLSX e muitos outros, utilizando PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for PHP" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/php-java" installationsDocsLink="https://docs.aspose.com/cells/php-java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/php/" learnAsLink="https://docs.aspose.com/cells/php-java" apiReference="" mavenRepoLink="" >}}


{{% blocks/products/pf/agp/content h2="Converter SXC para XLSX usando PHP" %}}

Como faço para converter SXC em XLSX? Com a biblioteca Aspose.Cells for PHP via Java, você pode facilmente converter SXC em XLSX programaticamente com algumas linhas de código.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) É capaz de criar aplicações multiplataforma com a capacidade de gerar, modificar, converter, renderizar e imprimir todos os arquivos do Excel. O PHP Excel API não só converte entre formatos de planilha, como também pode renderizar arquivos do Excel como imagens, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT e muito mais, tornando-se assim uma escolha perfeita para trocar documentos em formatos padrão do setor.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Salvar de SXC a XLSX em PHP" %}}

O exemplo a seguir demonstra como converter SXC em XLSX em PHP.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter SXC em XLSX. Carregue seu arquivo SXC e simplesmente salve-o como arquivo XLSX. Para leitura de SXC e gravação de XLSX, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída XLSX serão idênticos ao documento SXC original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter SXC em XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="sxc" outformat="xlsx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter SXC para XLSX via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC para XLSX programaticamente? Desenvolvedores PHP podem facilmente carregar e converter arquivos SXC para XLSX com apenas algumas linhas de código.
...
1.  Converta SXC para XLSX chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de SXC para XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter SXC em XLSX" %}}
