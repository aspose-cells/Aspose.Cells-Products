---
title:  Chèn TextBox vào Excel via Java
weight: 60
...
{{% blocks/products/pf/agp/content h2="Cách chèn TextBox vào file Excel bằng Java" %}}

 Để chèn TextBox vào file excel, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn TextBox vào file Excel via Java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addTextBox-int-int-int-int-int-int-) để chèn TextBox vào bảng tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn TextBox - Java" offSpacer="" %}}
