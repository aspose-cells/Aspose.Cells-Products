---
title: Voeg XLSX samen met BMP - Combineer XLSX met BMP in C#
url: /nl/net/merger/merge-xlsx-to-bmp/ 
description: Aspose Excel. C# Aspose.Cells. Voeg XLSX samen met het opslagformaat BMP. C# Combineer het formaat XLSX met BMP. Voeg XLSX samen met BMP in C#. XLSX Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSX samen met BMP in C#" %}}

Het volgende voorbeeld laat zien hoe u XLSX samenvoegt met BMP in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSX samen te voegen met BMP. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand BMP. Als u code ontwikkelt in C#, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C# waarin XLSX wordt samengevoegd met BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLSX samen te voegen met BMP in C#" InputFormat="xlsx" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSX samenvoegt met BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met BMP? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLSX samen te voegen met BMP" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/merger/merge-xlsx-to-mhtml/" name="Voeg XLSX samen met MHTML" description="Archiefformaat webpagina" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/merger/merge-xlsx-to-ods/" name="Voeg XLSX samen met ODS" description="OpenDocument-spreadsheetbestand" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/merger/merge-xlsx-to-tiff/" name="Voeg XLSX samen met TIFF" description="Getagd beeldformaat" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/merger/merge-xlsx-to-xltm/" name="Voeg XLSX samen met XLTM" description="Excel-sjabloon met macro\'s" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/merger/merge-xlsx-to-xml/" name="Voeg XLSX samen naar XML" description="Uitbreidbare opmaaktaal" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/merger/merge-xlsx-to-jpeg/" name="Voeg XLSX samen met JPEG" description="JPEG Afb" >}}
