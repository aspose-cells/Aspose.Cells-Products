...
description: Aspose Excel. Convierta MHTML a SXC rápida y fácilmente con Aspose.Cells. Python MHTML a SXC. Python Guarde MHTML en SXC. Guarde MHTML como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar MHTML al SXC en Python" %}}

El siguiente ejemplo demuestra cómo convertir MHTML a SXC en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir MHTML en SXC" %}}
