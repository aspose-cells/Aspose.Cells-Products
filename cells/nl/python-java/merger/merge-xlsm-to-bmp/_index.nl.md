...
url: /nl/python-java/merger/merge-xlsm-to-bmp/ 
...
Het volgende voorbeeld laat zien hoe u XLSM samenvoegt met BMP in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLSM programmatisch samenvoegen met BMP? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
