...
description: Python Exempelkod för att generera HTML-dokument. Använd den här koden för att skapa HTML-filer i programmet Python.
---
...
1. Importera asposeceller i din kodfil.1. Skapa Workbook-klassinstans.1. Öppna det första kalkylbladet i arbetsboken.1. Hämta önskad cell(er) i kalkylbladet och mata in värdet i cellen(erna).1. Använd metoden Spara för att spara arbetsboken som HTML-fil.
...
{{% blocks/products/pf/agp/code-block title="Följande källkod visar hur du skapar en HTML-fil med Python." offSpacer="" %}}
