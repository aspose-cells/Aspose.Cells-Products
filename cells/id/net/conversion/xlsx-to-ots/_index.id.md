---
title: C# XLSX ke OTS - Konverter ke OTS Online XLSX
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Gratis Online C# Ubah XLSX menjadi OTS saveformat. C# XLSX ke format OTS. Simpan XLSX ke OTS C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi OTS di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi XLSX ke OTS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, OTS, dan banyak format lainnya pada Kerangka .NET, .NET Inti atau Mono Platform." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke OTS di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengubah XLSX menjadi OTS di C#.
...
{{% blocks/products/pf/agp/content h2="Cara Konversi XLSX ke OTS melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke OTS secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX menjadi OTS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengubah XLSX menjadi OTS" %}}
