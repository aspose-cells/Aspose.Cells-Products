...
weight: 9620
description: Código de muestra Java para bloquear el archivo XLSM usando una contraseña en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{< blocks/products/pf/i18n/upper-banner h1="Cifrar XLSM archivos via Java" h2="Proteja las hojas de cálculo de Excel con contraseña, incluido el formato XLSM, utilizando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para proteger archivos XLSM via Java" %}}
...
1.  Cargue el archivo XLSM creando una instancia de la clase Workbook
