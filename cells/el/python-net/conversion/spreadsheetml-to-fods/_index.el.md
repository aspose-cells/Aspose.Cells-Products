---
title: Μετατροπή SPREADSHEETML σε FODS Python via Python
description: Μετατρέψτε το SPREADSHEETML σε FODS Online δωρεάν. Δωρεάν Online Μετατροπέας SPREADSHEETML σε FODS. Python SPREADSHEETML στο FODS. SPREADSHEETML στο FODS μέσω Python.
...
Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε SPREADSHEETML σε FODS στο Python via NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές Python μπορούν εύκολα να φορτώσουν και να μετατρέψουν το SPREADSHEETML σε FODS σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατροπή SPREADSHEETML σε FODS καλώντας τη μέθοδο Workbook.save
