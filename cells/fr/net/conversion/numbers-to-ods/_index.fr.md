---
title: C# NOMBRES en ODS - Convertisseur NOMBRES en ODS
description: Aspose Exceller. Convertissez des NUMÉROS en ODS rapidement et facilement avec Aspose.Cells. C# NUMÉROS en ODS. C# Enregistrez des NUMÉROS en ODS. Enregistrez des NUMÉROS sous ODS en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer les numéros au ODS dans C#" %}}
...
{{% cells-convert title="Exemple de code pour convertir des NUMÉROS en ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en ODS par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en ODS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir des NUMBERS en ODS" %}}
