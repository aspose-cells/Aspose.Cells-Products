...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 FODS 轉換為 POWERPOINT。C# FODS 轉換為 POWERPOINT。 C# 將 FODS 儲存到 POWERPOINT。使用 C# 將 FODS 另存為 POWERPOINT。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 C# 中的 POWERPOINT" h2="用於將 FODS 轉換為 POWERPOINT 的高速 C# 庫。這是一款專業的軟體解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 FODS、POWERPOINT 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POWERPOINT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 C# 中的 POWERPOINT" %}}

以下範例示範如何將 FODS 轉換為 C# 中的 POWERPOINT。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 轉換為 POWERPOINT。上傳 FODS 文件，然後將其儲存為 POWERPOINT 文件。對於 FODS 讀取和 POWERPOINT 寫入，您可以使用完全限定的檔案名稱。輸出的 POWERPOINT 內容和格式將與原始 FODS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 FODS 轉換為 POWERPOINT 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 POWERPOINT" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 FODS 檔案轉換為 POWERPOINT？ .NET 開發人員只需幾行程式碼即可輕鬆載入 FODS 並將其轉換為 POWERPOINT。
