---
title: Convierta TXT a JPG a través de la aplicación C++ 
url: /es/cpp/conversion/txt-to-jpg/ 
description: Ejemplo de código de conversión C++ para documento TXT a formato JPG. Los programadores pueden usar este código fuente para la conversión por lotes de TXT a JPG dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte TXT a JPG a través de C++" h2="Conversión de TXT a JPG de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir TXT a JPG usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir TXT a JPG a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de C++ pueden convertir fácilmente un archivo TXT a JPG con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo TXT usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (JPG).1. El archivo JPG se guardará en la ruta especificada.1. Abra el archivo JPG en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de TXT a JPG C++" offSpacer="" %}}
