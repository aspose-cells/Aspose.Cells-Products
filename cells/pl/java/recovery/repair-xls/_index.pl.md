...
{{% blocks/products/pf/agp/content h2="Jak naprawić plik xls za pomocą Java" %}}
...
{{% cells-recovery title="Darmowa aplikacja do naprawy pliku XLS za pomocą Java" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="java" %}}    
