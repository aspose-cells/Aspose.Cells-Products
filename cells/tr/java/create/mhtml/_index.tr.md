...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde MHTML Dosyası oluşturun. Java'i kullanarak MHTML dosyası oluşturun. Java'de MHTML oluşturun. Java MHTML Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını MHTML biçiminde kaydedin.
