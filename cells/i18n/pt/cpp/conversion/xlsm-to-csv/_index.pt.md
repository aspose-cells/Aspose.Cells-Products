---
title: Converter XLSM para CSV por meio do aplicativo C++ 
url: /pt/cpp/conversion/xlsm-to-csv/ 
description: Exemplo de código de conversão C++ de documento XLSM para formato CSV. Os programadores podem usar esse código-fonte para conversão em lote de XLSM para CSV em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSM para CSV via C++" h2="Conversão de XLSM para CSV de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter XLSM para CSV usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter XLSM para CSV via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem facilmente converter arquivos XLSM para CSV em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLSM usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (CSV).1. O arquivo CSV será salvo no caminho especificado.1. Abra o arquivo CSV em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLSM para CSV C++" offSpacer="" %}}
