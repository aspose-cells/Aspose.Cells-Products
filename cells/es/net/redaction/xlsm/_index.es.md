---
title:  Buscar y reemplazar texto en el documento XLSM via .NET
weight: 2370
description: C# código fuente para redactar información confidencial en el archivo XLSM en .NET Framework, .NET Core, Mono o plataformas Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Redactar XLSM Formatos en C#" h2="Información de redacción confidencial de documentos XLSM nativa y de alto rendimiento utilizando API Aspose.Cells for .NET del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
