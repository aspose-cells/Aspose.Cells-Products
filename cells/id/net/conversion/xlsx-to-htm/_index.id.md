...
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Gratis Online C# Ubah XLSX menjadi HTM saveformat. C# XLSX ke format HTM. Simpan XLSX ke HTM C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi HTM di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi XLSX ke HTM. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, HTM, dan banyak format lainnya pada Kerangka .NET, .NET Inti atau Mono Platform." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke HTM di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX ke HTM di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi XLSX ke HTM. Unggah file XLSX Anda, lalu simpan sebagai file HTM. Untuk pembacaan XLSX dan penulisan HTM, Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan pemformatan HTM keluaran akan identik dengan dokumen XLSX asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX ke HTM Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Konversi XLSX ke HTM melalui C#" %}}
...
1.  Ubah XLSX menjadi HTM dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi XLSX ke HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Pustaka C# untuk mengonversi XLSX menjadi HTM" %}}
