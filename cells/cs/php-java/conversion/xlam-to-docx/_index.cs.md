---
title: Konvertor PHP XLAM až DOCX - XLAM až DOCX
description: Aspose Excel. Převeďte XLAM na DOCX rychle a snadno pomocí Aspose.Cells. PHP XLAM na DOCX. PHP Uložte XLAM na DOCX. Uložte DOCX jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="docx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na DOCX přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na DOCX programově? Vývojáři PHP mohou snadno načíst a převést XLAM na DOCX v několika řádcích kódu.
...
1.  Převeďte XLAM na DOCX voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na DOCX" %}}
