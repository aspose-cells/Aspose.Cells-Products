...
description: Aspose Unggul. Ubah XLTX menjadi PNG dengan cepat dan mudah dengan Aspose.Cells. Python XLTX menjadi PNG. Python Simpan XLTX menjadi PNG. Simpan XLTX sebagai 07611134 81 menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah XLTX menjadi PNG Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX hingga PNG di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLTX menjadi PNG di Python.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLTX menjadi PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="png" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengubah XLTX menjadi PNG" %}}
