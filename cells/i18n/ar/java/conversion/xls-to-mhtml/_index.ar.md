---
title: تحويل XLS إلى MHTML عبر Java 
weight: 5430
url: /ar/java/conversion/xls-to-mhtml/ 
description: نموذج لشفرة تحويل Java لتنسيق XLS إلى ملف MHTML. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى MHTML داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLS إلى MHTML عبر Java" h2="XLS إلى MHTML Java لتحويل صفحات مفردة أو صفحات متعددة إلى MHTML باستخدام مكتبة محلية Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى MHTML باستخدام Java" %}}

 من أجل تقديم XLS إلى MHTML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLS إلى MHTML عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل ملف XLS بسهولة إلى MHTML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف XLS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد MHTML & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف MHTML الناتج
...
{{% blocks/products/pf/agp/code-block title="XLS إلى MHTML Java شفرة مصدر التحويل" offSpacer="" %}}
