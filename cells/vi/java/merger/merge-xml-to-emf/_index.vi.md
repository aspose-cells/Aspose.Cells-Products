---
title: Gộp XML thành EMF - Gộp XML thành EMF trong Java
url: /vi/java/merger/merge-xml-to-emf/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất XML thành định dạng lưu EMF. Java Kết hợp XML thành định dạng EMF. Hợp nhất XML thành EMF trong Java. Hợp nhất XML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XML thành EMF trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất XML thành EMF trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XML thành EMF. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu nó vào tệp EMF. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất XML thành EMF.
