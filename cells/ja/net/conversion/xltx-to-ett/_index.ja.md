---
title: C# XLTX から ETT - XLTX から ETT コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLTXをETTにすばやく簡単に変換します。C# XLTXをETTに変換します。 C# XLTX を ETT に保存します。 C# を使用して XLTX を ETT として保存します。
...
{{% cells-convert title="XLTXをETTに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="ett" IsLandingPage="true" %}}
