---
title:  Połącz CSV z XLSX przez C#
...
Poniższy przykład pokazuje, jak połączyć CSV z XLSX w C#.
...
{{% cells-merger title="Darmowa aplikacja do łączenia CSV z XLSX on-line" InputFormat="csv" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
