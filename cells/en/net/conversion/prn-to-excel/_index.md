---
title: C# PRN to EXCEL - PRN to EXCEL Converter
description: Aspose Excel. Convert PRN to EXCEL quickly and easily with Aspose.Cells. C# PRN to EXCEL. C# Save PRN to EXCEL. Save PRN as EXCEL using C#.
...
{{% blocks/products/pf/agp/content h2="Save PRN to EXCEL in C#" %}}

The following example demonstrates how to convert PRN to EXCEL in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert PRN to EXCEL. Upload your PRN file, then simply save it as EXCEL file. For both PRN reading and EXCEL writing you can use fully qualified filenames. The output EXCEL content and formatting will be identical to the original PRN document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Sample Code to Convert PRN to EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert PRN to EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert PRN files to EXCEL programmatically? .NET developers can easily load & convert PRN to EXCEL in just a few lines of code.
...
1.  Convert PRN to EXCEL by calling Workbook.Save method.
1.  Get the conversion result of PRN to EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# library to convert PRN to EXCEL" %}}
