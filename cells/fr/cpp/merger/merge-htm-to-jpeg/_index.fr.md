...
L'exemple suivant montre comment fusionner HTM avec JPEG dans Aspose.Cells for C++.
...
Besoin de fusionner HTM avec JPEG par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
