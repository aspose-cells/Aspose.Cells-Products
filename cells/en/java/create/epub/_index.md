---
title: Create EPUB - Create EPUB file in Java
description: Aspose Excel. Effortlessly generate and manipulate EPUB files with the Aspose.Cells for Java library. This powerful API provides a streamlined and efficient solution to create, edit, and manage EPUB files directly within your Java applications, fulfilling specific developer needs with high precision.
...
{{% blocks/products/pf/agp/content h2="How to Create EPUB in Java" %}}
...
1.  Save the workbook as EPUB format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create EPUB file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create EPUB file" %}}
{{% blocks/products/pf/agp/text %}}
