...
В следующем примере показано, как объединить XLSB с HTML в Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Нужно программно объединить XLSB с HTML? Базовый документ сливается и объединяется с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно реализовать всего несколькими строками кода.
