---
title: Merge NUMBERS to POWERPOINT - Combine NUMBERS to POWERPOINT in Python
url: /python-net/merger/merge-numbers-to-powerpoint/ 
description: Aspose Excel. Python Aspose.Cells. Merge NUMBERS to POWERPOINT saveformat. Python Combine NUMBERS to POWERPOINT format. Merge NUMBERS to POWERPOINT in Python. NUMBERS Merge.
...
{{% blocks/products/pf/agp/content h2="Merge NUMBERS to POWERPOINT in Python" %}}
...
{{% cells-merger title="Sample Code to Merge NUMBERS to POWERPOINT in Python" InputFormat="numbers" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
