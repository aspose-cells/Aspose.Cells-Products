---
title: دمج HTM في XPS - ادمج HTM مع XPS في C++
url: /ar/cpp/merger/merge-htm-to-xps/ 
description: Aspose إكسل. C++ Aspose.Cells. Free Online Merge HTM إلى XPS saveformat. C++ ادمج تنسيق HTM مع تنسيق XPS. دمج HTM إلى XPS في C++. HTM دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج HTM في XPS في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج HTM مع XPS في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج HTM في XPS. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف XPS. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج HTM إلى XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج HTM في XPS في C++" InputFormat="htm" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج HTM في XPS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج HTM في XPS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
