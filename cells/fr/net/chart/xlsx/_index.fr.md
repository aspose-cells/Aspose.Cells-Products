---
title:  XLSX document graphique vers images via .NET
weight: 2630
description: Code source C# pour dessiner et convertir un graphique ou un diagramme dans le fichier XLSX sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="XLSX Fichier de graphiques vers des images dans C#" h2="Conversion native et haute performance de graphiques de documents XLSX en images à l\'aide d\'API côté serveur, sans utiliser de logiciel tel que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir les fichiers XLSX en graphiques C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir XLSX Fichiers Graphique - C#" offSpacer="" %}}
