...
weight: 2080
description: Código de muestra Java para editar o ver metadatos del formato ODS en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{% blocks/products/pf/agp/content h2="Cómo extraer metadatos de ODS utilizando Java" %}}

 Para obtener metadatos del archivo ODS, usaremos
...
+ Guarde la información de metadatos ODS
