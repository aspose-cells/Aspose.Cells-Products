...
description: Aspose 엑셀. Aspose.Cells을 사용하여 쉽고 빠르게 EXCEL을 PNG로 변환합니다. C# EXCEL을 PNG로 변환합니다. C# EXCEL을 PNG로 저장합니다. C#을 사용하여 EXCEL을 PNG로 저장합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 EXCEL을 PNG로 변환" h2="EXCEL을 PNG로 변환하기 위한 고속 C# 라이브러리. 이는 EXCEL, PNG 및 .NET Framework, .NET Core 또는 Mono 플랫폼에서 기타 여러 형식을 가져오고 내보내는 전문 소프트웨어 솔루션입니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% blocks/products/pf/agp/content h2="C#에 EXCEL을 PNG로 저장하세요." %}}

다음 예에서는 EXCEL을 C#에서 PNG로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="EXCEL을 PNG로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="png" IsLandingPage="true" %}}
