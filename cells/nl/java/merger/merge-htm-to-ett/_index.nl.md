---
title: Voeg HTM samen met ETT - Combineer HTM met ETT in Java
url: /nl/java/merger/merge-htm-to-ett/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online HTM samenvoegen naar ETT-opslagformaat. Java Combineer HTM naar ETT formaat. Voeg HTM samen met ETT in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTM gratis samen met ETT in Java" %}}

Het volgende voorbeeld laat zien hoe u HTM kunt samenvoegen met ETT in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen met ETT. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het ETT-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat HTM samenvoegt met ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om HTM samen te voegen met ETT in Java" InputFormat="htm" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen met ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met ETT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen met ETT" %}}
