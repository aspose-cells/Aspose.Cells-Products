...
description: Aspose เอ็กเซล. แปลง NUMBERS เป็น SXC อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ NUMBERS เป็น SXC C++ บันทึก NUMBERS เป็น SXC บันทึก NUMBERS เป็น SXC โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึกหมายเลขไปที่ SXC ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง NUMBERS เป็น SXC ใน C++
...
1.  แปลง NUMBERS เป็น SXC โดยการเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลงจาก NUMBERS เป็น SXC

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ ไลบรารี่เพื่อแปลง NUMBERS เป็น SXC" %}}
