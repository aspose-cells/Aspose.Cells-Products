---
title: PHP EXCEL en WORD - Convertisseur EXCEL en WORD
description: Aspose Exceller. Convertissez EXCEL en WORD rapidement et facilement avec Aspose.Cells. PHP EXCEL en WORD. PHP Enregistrez EXCEL en WORD. Enregistrez EXCEL sous WORD en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en WORD via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en WORD par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en WORD en quelques lignes de code.
...
1.  Convertissez EXCEL en WORD en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en WORD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en WORD" %}}
