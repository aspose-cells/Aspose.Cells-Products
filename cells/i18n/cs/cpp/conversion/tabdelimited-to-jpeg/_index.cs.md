---
title: Převeďte TABDELIMITED na JPEG pomocí aplikace C++ 
url: /cs/cpp/conversion/tabdelimited-to-jpeg/ 
description: Ukázka převodního kódu C++ pro dokument TABDELIMITED do formátu JPEG. Programátoři mohou použít tento zdrojový kód pro dávkový převod TABDELIMITED na JPEG v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor TABDELIMITED na JPEG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TABDELIMITED pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavte možnosti (JPEG).1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor JPEG v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TABDELIMITED na JPEG C++" offSpacer="" %}}
