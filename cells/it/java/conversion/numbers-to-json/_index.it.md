...
{{% blocks/products/pf/agp/content h2="Come convertire NUMBERS in JSON utilizzando Java" %}}

 Per eseguire il rendering di NUMBERS in JSON, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire NUMBERS in JSON tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente i file NUMBERS in JSON in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file NUMBERS con un'istanza della classe Workbook1. Crea un intervallo di dati da esportare utilizzando il metodo Cells.createRange1. Chiama il metodo JsonUtility.exportRangeToJson con riferimenti a Range & ExportRangeToJsonOptions1. Scrivi i dati JSON della stringa su file tramite il metodo BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="NUMBERS in JSON Java codice sorgente di conversione" offSpacer="" %}}
