...
{{% blocks/products/pf/agp/content h2="Python を使用して PRN を MARKDOWN に変換します" %}}
...
次の例は、PRN を Python の MARKDOWN に変換する方法を示しています。
...
{{% blocks/products/pf/agp/content h2="Python経由でPRNをMARKDOWNに変換する方法" %}}
