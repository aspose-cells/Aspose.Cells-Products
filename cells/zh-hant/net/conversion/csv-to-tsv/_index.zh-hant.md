...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 CSV 轉換為 TSV。C# CSV 為 TSV. C# 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 C#。
...
以下範例示範如何將 C# 中的 CSV 轉換為 TSV。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 CSV 轉換為 TSV。上傳您的 CSV 文件，然後只需將其另存為 TSV 文件。對於 CSV 讀取和 TSV 寫入，您可以使用完全限定的檔案名稱。輸出 TSV 內容和格式將與原始 CSV 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 CSV 轉換為 TSV 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="tsv" IsLandingPage="true" %}}
...
1. 使用工作簿實例載入 CSV 檔案。
1. 透過呼叫Workbook.Save方法將CSV轉換為TSV。
1. 取得CSV到TSV的轉換結果。
