---
title: "TSV konvertálása XLS-re a következőn keresztül: Java "
weight: 7830
url: /hu/java/conversion/tsv-to-xls/ 
description: Minta Java konverziós kód a TSV-formátumhoz XLS-fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok XLS formátumba exportálására bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV konvertálása XLS-re a következőn keresztül: Java" h2="TSV-ből XLS-be Java konvertálva egyetlen vagy több oldalt XLS-vé konvertálva a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása XLS-re a következővel: Java" %}}

 Ahhoz, hogy a TSV-t XLS-re rendereljük, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV XLS-re konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak TSV-fájlt XLS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. TSV-fájl betöltése a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TSV-ből XLS-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TSV-fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tsv");
// mentse a TSV-t XLS-ként
