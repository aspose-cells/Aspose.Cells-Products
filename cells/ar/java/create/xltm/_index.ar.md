---
title: إنشاء ملفات MS Excel XLTM via Java
description: XLTM مبتكر. إنشاء XLTM ملفات في Java كود. قم بإنشاء ملفات MS Excel XLTM باستخدام تطبيق ويب أو سطح مكتب يستند إلى Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء XLTM ملف via Java" h2="إنشاء جداول بيانات MS Excel XLTM أصلي وعالي الأداء برمجيًا باستخدام مكتبة Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="قم بإنشاء ملف XLTM باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء XLTM via Java" %}}
