---
title:  أدخل WordArt في Excel باستخدام Python via Java
weight: 200
description: Python via Java التعليمات البرمجية المصدر لإدراج WordArt في Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل WordArt في Excel باستخدام Python via Java" h2="أدخل WordArts باستخدام Aspose.Cells \'API بدون أي برنامج مثل Microsoft أو Open Office أو Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج WordArt في ملف Excel باستخدام Python via Java" %}}

 من أجل إدراج WordArt في ملف Excel ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج WordArt في ملف Excel باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم الشكل[طريقة الإضافة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addWordArt(int,%20java.lang.String,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج WordArt في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج WordArt - Python via Java" offSpacer="" %}}
