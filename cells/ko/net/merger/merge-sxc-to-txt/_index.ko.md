---
title: SXC을 TXT로 병합 - SXC을 C#에서 TXT로 결합
url: /ko/net/merger/merge-sxc-to-txt/ 
description: Aspose 엑셀. C# Aspose.Cells. 무료 온라인 병합 SXC에서 TXT 저장 형식으로. C# SXC을 TXT 형식으로 결합합니다. SXC을 C#에서 TXT로 병합합니다. SXC 병합합니다.
...
{{% blocks/products/pf/agp/content h2="SXC을 C# 온라인에서 TXT로 무료로 병합" %}}

다음 예는 SXC을 Aspose.Cells for .NET에서 TXT로 병합하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

간단한 단계에 따라 SXC을 TXT로 병합합니다. 파일을 업로드하고 파일 병합을 위해 Workbook.Combine 메서드를 호출한 다음 TXT 파일에 저장합니다. C#에서 코드를 개발하면 생각보다 간단합니다. SXC을 TXT로 병합하는 C# 예제를 참조하십시오.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#에서 SXC을 TXT로 병합하는 무료 온라인" InputFormat="sxc" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 SXC을 TXT로 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 프로그래밍 방식으로 SXC을 TXT에 병합해야 합니까? 병합 및 연결하는 기본 문서[Aspose.Cells for .NET](https://products.aspose.com/cells/net) 몇 줄의 코드만으로 API를 수행할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2=".NET 라이브러리는 SXC을 TXT에 병합합니다." %}}
