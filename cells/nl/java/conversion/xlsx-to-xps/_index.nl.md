...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in XPS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar XPS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar XPS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar XPS? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar XPS met slechts een paar regels code.
