...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar XPS met Aspose.Cells. Python OTS naar XPS. Python Bewaar OTS naar XPS. Sla OTS op als XPS met Python.
...
{{% blocks/products/pf/agp/content h2="Bewaar OTS op XPS in Python" %}}
...
{{% cells-convert title="Voorbeeldcode om OTS naar XPS te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xps" IsLandingPage="true" language="pythonjava" %}}
