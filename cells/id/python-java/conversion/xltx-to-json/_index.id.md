...
description: Aspose Unggul. Ubah XLTX menjadi JSON dengan cepat dan mudah dengan Aspose.Cells. Python XLTX menjadi JSON. Python Simpan XLTX menjadi JSON. Simpan XLTX sebagai 07611134 81 menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah XLTX menjadi JSON Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX hingga JSON di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLTX menjadi JSON di Python.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLTX menjadi JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="json" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengubah XLTX menjadi JSON" %}}
