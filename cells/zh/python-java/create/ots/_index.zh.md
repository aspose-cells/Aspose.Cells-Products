...
{{% blocks/products/pf/agp/content h2="如何在Python中创建OTS" %}}

{{% blocks/products/pf/agp/text %}}

开发人员只需几行代码即可轻松在运行不同的报告应用程序中创建、加载、修改和转换 OTS 文件以进行数据处理。
...
1. 使用 Save 方法将工作簿另存为 OTS 文件。

{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 Python 中创建 OTS 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python 库创建OTS文件" %}}
