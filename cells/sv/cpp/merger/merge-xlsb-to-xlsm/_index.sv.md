---
title: Slå samman XLSB till XLSM - Kombinera XLSB till XLSM i C++
url: /sv/cpp/merger/merge-xlsb-to-xlsm/ 
description: Aspose Excel. C++ Aspose.Cells. Slå samman XLSB till XLSM sparaformat. C++ Kombinera XLSB till XLSM format. Slå samman XLSB till XLSM i C++. XLSB Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman XLSB till XLSM med C++" %}}

 Hur slår jag samman XLSB till XLSM? Med Aspose.Cells for C++ bibliotek kan du enkelt slå samman XLSB till XLSM programmatiskt med några rader kod.[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) kan bygga plattformsoberoende applikationer med förmågan att generera, modifiera, konvertera, rendera och skriva ut alla Excel-filer. C++ Excel API konverterar inte bara mellan kalkylarksformat, den kan också rendera Excel-filer som bilder, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT och mer, vilket gör det till ett perfekt val att utbyta dokument i industristandardformat. Du kan ladda ner den senaste versionen direkt, bara öppna[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/) pakethanteraren, sök efter Aspose.Cells.Cpp och installera. Du kan också använda följande kommando från Package Manager Console.
...
{{% blocks/products/pf/agp/content h2="Slå samman XLSB till XLSM i C++" %}}

Följande exempel visar hur man slår samman XLSB till XLSM i Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman XLSB till XLSM. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen XLSM. Om du utvecklar kod i C++ blir detta enklare än det låter. Se C++ exempel som slår samman XLSB till XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exempelkod för att slå samman XLSB till XLSM i C++" InputFormat="xlsb" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLSB till XLSM via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLSB till XLSM programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotek för att slå samman XLSB till XLSM" %}}
