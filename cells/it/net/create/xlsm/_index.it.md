---
title: Crea file MS Excel XLSM tramite C#
description: XLSM creatore. Crea file XLSM nel codice C#. Genera file MS Excel XLSM utilizzando VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crea file XLSM tramite C#" h2="Creazione di fogli di calcolo MS Excel XLSM nativa e ad alte prestazioni a livello di codice utilizzando le API .NET lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come creare XLSM tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Codice di esempio per creare un file MS Excel XLSM utilizzando C#." offSpacer="" %}}
