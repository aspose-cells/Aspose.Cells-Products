...
description: Aspose Unggul. Ubah PRN menjadi XPS dengan cepat dan mudah menggunakan Aspose.Cells. Java PRN menjadi XPS. Java Simpan PRN ke XPS. Simpan PRN sebagai XPS menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah PRN menjadi XPS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi PRN ke XPS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, XPS, dan banyak format lain menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Ubah PRN menjadi XPS Menggunakan Java" %}}
...
Contoh berikut menunjukkan cara mengonversi PRN ke XPS di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PRN menjadi XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke XPS secara terprogram? Pengembang Java dapat dengan mudah mengonversi PRN menjadi XPS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk mengonversi PRN menjadi XPS" %}}
{{% blocks/products/pf/agp/text %}}
