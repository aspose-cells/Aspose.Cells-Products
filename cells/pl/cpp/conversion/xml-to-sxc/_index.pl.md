---
title: C++ XML na SXC - Konwerter XML na SXC
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XML do formatu SXC, umożliwiając bezproblemowe zapisywanie danych XML do formatu SXC za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C++.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML do SXC w C++" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na SXC w C++.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na SXC przez C++" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XML do formatu SXC? Programiści C++ mogą łatwo przekonwertować pliki XML do formatu SXC za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XML do SXC wywołując metodę Save().
1.  Uzyskaj wynik konwersji XML na SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteka do konwersji XML do SXC" %}}
