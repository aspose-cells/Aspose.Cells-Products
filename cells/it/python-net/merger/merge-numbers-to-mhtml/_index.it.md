---
title: Unisci i NUMERI a MHTML - Combina i NUMERI a MHTML in Python
url: /it/python-net/merger/merge-numbers-to-mhtml/ 
description: Aspose Excel. Python Excel. Unisci i NUMERI al formato di salvataggio MHTML. Python Combina i NUMERI nel formato MHTML. Unisci i NUMERI a MHTML nella libreria Excel Python. NUMERI Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci i NUMERI a MHTML utilizzando la libreria Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Unisci i NUMERI a MHTML nella Libreria Excel Python" %}}

L'esempio seguente mostra come unire NUMBERS in MHTML in Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire i NUMERI a MHTML. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file MHTML. Se sviluppi il codice in Python, sarà più semplice di quanto sembri. Vedi l'esempio Python che unisce i NUMERI a MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Codice di esempio per unire i NUMERI a MHTML nella libreria Excel Python" InputFormat="numbers" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Come unire i NUMERI a MHTML tramite la Libreria Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 È necessario unire i NUMERI a MHTML a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria Python per unire i NUMERI allo MHTML" %}}
