---
title: Convertissez XLSB en XLTX via l'application C++ 
weight: 550

description: Exemple de code de conversion C++ pour le document XLSB au format XLTX. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLSB en XLTX dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en XLTX via C++" h2="Conversion XLSB vers XLTX haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir un fichier XLSB en XLTX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLSB à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (XLTX).1. Le fichier XLTX sera enregistré dans le chemin spécifié.1. Ouvrez le fichier XLTX dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="XLSB à XLTX C++ Code source de conversion" offSpacer="" %}}
