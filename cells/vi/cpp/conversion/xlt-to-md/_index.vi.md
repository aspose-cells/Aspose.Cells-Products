---
title: Chuyển đổi XLT sang MD qua ứng dụng C++ 
url: /vi/cpp/conversion/xlt-to-md/ 
description: Mã chuyển đổi C++ mẫu cho tài liệu XLT sang định dạng MD. Các lập trình viên có thể sử dụng mã nguồn này để chuyển đổi hàng loạt XLT sang MD trong bất kỳ Ứng dụng C++ nào.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp XLT sang MD chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLT bằng Factory :: CreateIWorkbook.1. Gọi phương thức Save ().1. Chuyển đường dẫn tệp đầu ra với phần mở rộng tệp (MD).1. Tập tin MD sẽ được lưu tại đường dẫn đã chỉ định.1. Mở tệp MD trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi XLT sang MD C++" offSpacer="" %}}
