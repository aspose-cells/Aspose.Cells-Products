---
title:  Insertar línea en Excel a través de Python
weight: 10
description: Python código fuente para insertar Línea en Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insertar línea en Excel a través de Python" h2="Inserte objetos utilizando las API del lado del servidor sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo insertar una línea en un archivo de Excel usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar una línea en un archivo de Excel a través de Python" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa las colecciones de formas[añadir método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) para insertar una línea en la hoja de cálculo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar Línea - Python" offSpacer="" %}}
