...
Hai bisogno di convertire i file MHT in XLTM tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in XLTM in poche righe di codice.
...
1.  Convertire MHT in XLTM chiamando il metodo Save().
