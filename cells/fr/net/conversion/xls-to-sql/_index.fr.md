---
title: C# XLS en SQL - Convertisseur XLS en SQL
description: Aspose Exceller. Convertissez XLS en SQL rapidement et facilement avec Aspose.Cells. C# XLS en SQL. C# Enregistrez XLS dans SQL. Enregistrez XLS au format SQL en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS dans SQL dans C#" %}}

L'exemple suivant montre comment convertir XLS en SQL dans C#.
...
{{% cells-convert title="Exemple de code pour convertir XLS en SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en SQL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en SQL par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en SQL en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en SQL" %}}
