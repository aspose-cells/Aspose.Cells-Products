...
url: /hu/python-java/merger/merge-xls-to-image/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a XLS-et az IMAGE-val a Aspose.Cells-es for Python-es via Java-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLS-et az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
