...
{{< blocks/products/pf/upper-banner h1="Convert SPREADSHEETML to XPS via Java" h2="Native Java library to export Excel & OpenOffice spreadsheets to XPS." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/cells/272x272/aspose_cells-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/code-block title="Convert SPREADSHEETML to XPS - Java‎" offSpacer="" %}}

```cs
// load the SPREADSHEETML file in an instance of Workbook
Workbook book = new Workbook("template.spreadsheetml");
// save SPREADSHEETML as XPS
