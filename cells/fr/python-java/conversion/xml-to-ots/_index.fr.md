...
{{% blocks/products/pf/agp/content h2="Convertir XML en OTS à l\'aide de Python" %}}
...
L'exemple suivant montre comment convertir XML en OTS dans Python.
