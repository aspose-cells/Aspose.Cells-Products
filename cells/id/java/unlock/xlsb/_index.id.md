...
{{< blocks/products/pf/i18n/upper-banner h1="Buka kunci File XLSB melalui Java" h2="Hapus perlindungan dari spreadsheet Excel termasuk file XLSB menggunakan Java Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah membuka XLSB melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Buat instance kelas Workbook dengan jalur ke file XLSB yang dilindungi1. Dapatkan default atau Lembar Kerja apa pun untuk menghapus perlindungan1. Hapus perlindungan Worksheet dengan Worksheet.Metode Unprotect1. Hapus proteksi Workbook dengan Workbook.Unprotect method1. Simpan hasil dalam format XLSB
...
{{% blocks/products/pf/agp/code-block title="Buka kunci File XLSB melalui C#" offSpacer="" %}}
