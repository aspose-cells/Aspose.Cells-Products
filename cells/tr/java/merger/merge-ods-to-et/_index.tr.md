---
title: ODS'i ET ile birleştir - ODS'i Java'de ET ile birleştir
url: /tr/java/merger/merge-ods-to-et/ 
description: Aspose Excel'de. Java Aspose.Cells. ODS'i ET kaydetme biçimiyle birleştirin. Java ODS'i ET formatıyla birleştirin. ODS'i Java'deki ET ile birleştirin. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'deki ET ile birleştir" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'deki ET ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i ET ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından ET dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. ODS'i ET ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'de ET ile Birleştirmek için Örnek Kod" InputFormat="ods" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i ET via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i programlı olarak ET ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesi, ODS\'i ET ile birleştirecek" %}}
