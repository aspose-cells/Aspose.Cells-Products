...
Besoin de convertir des fichiers HTM en SQL par programmation ? Les développeurs de C++ peuvent facilement convertir des fichiers HTM en SQL en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en SQL en appelant la méthode Save().
