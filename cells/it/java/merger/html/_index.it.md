...
{{% blocks/products/pf/agp/content h2="Come unire file HTML utilizzando Java" %}}

 Per unire il file HTML, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'unione di file HTML in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Unisci file HTML - Java" offSpacer="" %}}

```cs
// Apri il primo file HTML.
Workbook htmlFile1 = new Workbook("chartsFileWithPath.html");

// Definisci il secondo libro di origine.
// Apri il secondo file HTML.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API può essere utilizzato per creare, modificare, convertire ed eseguire il rendering di formati Microsoft Excel in formati diversi. Inoltre, può essere utilizzato per grafici completi, report scalabili e calcoli affidabili all'interno di applicazioni software. Aspose.Cells è un API autonomo e non richiede alcun software come Microsoft o OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live di fusione HTML online" sectionDescription="Unisci documenti HTML in questo momento visitando il nostro [Sito di demo dal vivo](https://products.aspose.app/cells/merger). La demo dal vivo ha i seguenti vantaggi" >}}
