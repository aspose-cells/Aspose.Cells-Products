...
El siguiente ejemplo demuestra cómo convertir JSON a POWERPOINT en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JSON a POWERPOINT" %}}
