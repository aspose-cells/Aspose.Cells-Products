---
title: HTM egyesítése SQL-be – HTM egyesítése SQL-be a Java-ben
url: /hu/java/merger/merge-htm-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése HTM SQL mentési formátumba. Java HTM és SQL formátum kombinálása. HTM egyesítése SQL-be a Java-ben. HTM egyesítése.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a HTM-et az SQL-lel a Java Online ingyenesen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a HTM-et SQL-lel a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTM és az SQL egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SQL fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely a HTM-et SQL-lel egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTM és az SQL egyesítése a Java számon" InputFormat="htm" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A HTM egyesítése az SQL via Java-gyel" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a HTM-et SQL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a HTM és az SQL egyesítéséhez" %}}
