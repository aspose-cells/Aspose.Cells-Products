---
title: Convierta XLT a SPREADSHEETML a través de Python
url: /es/python-java/conversion/xlt-to-spreadsheetml/
description: Código de muestra para la conversión de xlt a hoja de cálculo Python. Utilice el código de ejemplo API para la conversión de archivos xlt por lotes a hoja de cálculo dentro de la aplicación Python.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a SPREADSHEETML usando Python" %}}

 Para convertir XLT a SPREADSHEETML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLT a SPREADSHEETML a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden cargar y convertir fácilmente archivos XLT a SPREADSHEETML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLT con una instancia de Workbook1. Llame al método Workbook.Save1. Pase la ruta de salida con la extensión XML como parámetro1. Verifique la ruta especificada para el archivo SPREADSHEETML resultante
...
{{% cells-convert title="Aplicación gratuita y código de muestra para convertir XLT a SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xml" IsLandingPage="true" language="python" %}}
