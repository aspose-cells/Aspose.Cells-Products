---
title: Sloučit PRN s WORD – Sloučit PRN s WORD v C#
url: /cs/net/merger/merge-prn-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit PRN do formátu uložení WORD. C# Zkombinujte PRN do formátu WORD. Sloučit PRN na WORD v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na WORD v C#" %}}

Následující příklad ukazuje, jak sloučit PRN s WORD v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do WORD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí PRN do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení PRN s WORD v C#" InputFormat="prn" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na WORD přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s WORD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení PRN s WORD" %}}
