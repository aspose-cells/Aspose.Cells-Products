---
title: C# MHTML naar XPS - Online MHTML naar XPS Converter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratis online C# Converteer MHTML naar XPS saveformat. C# MHTML tot XPS formaat. Bewaar MHTML tot XPS C#.
...
{{% blocks/products/pf/agp/content h2="Converteer MHTML naar XPS met C#" %}}
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML te converteren naar XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch converteren naar XPS? .NET-ontwikkelaars kunnen eenvoudig MHTML laden en converteren naar XPS in slechts een paar regels code.
...
1.  Converteer MHTML naar XPS door de methode Workbook.Save aan te roepen.
