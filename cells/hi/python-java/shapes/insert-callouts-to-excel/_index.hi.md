---
title: Python via Java का उपयोग करके एक्सेल में कॉलआउट डालें
weight: 360
description: एक्सेल में कॉलआउट सम्मिलित करने के लिए Python via Java स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java का उपयोग करके एक्सेल में कॉलआउट डालें" h2="Microsoft या ओपन ऑफिस, एडोब PDF आदि जैसे किसी सॉफ्टवेयर के बिना Aspose.Cells\' API का उपयोग करके कॉलआउट डालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java का उपयोग करके एक्सेल फ़ाइल में कॉलआउट कैसे सम्मिलित करें" %}}

 एक्सेल फ़ाइल में कॉलआउट सम्मिलित करने के लिए, हम इसका उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java का उपयोग करके एक्सेल फ़ाइल में कॉलआउट सम्मिलित करने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से वर्कशीट का चयन करें।
 + का प्रयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) चयनित वर्कशीट में कॉलआउट सम्मिलित करने के लिए
...
नीचे दिया गया नमूना कोड दर्शाता है कि "थॉट बबल: क्लाउड" कैसे डाला जाए। अधिक प्रकारों के लिए, कृपया नीचे "कॉलआउट प्रकारों का अवलोकन" देखें।

{{% blocks/products/pf/agp/code-block title="कॉलआउट सम्मिलित करें - Python via Java" offSpacer="" %}}
