...
description: Sample Java conversion code for XLT format to DIF file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to DIF within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLT to DIF via Java" h2="XLT to DIF Java conversion to convert single or multiple pages to DIF using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/code-block title="XLT to DIF Java Conversion Source Code" offSpacer="" %}}
