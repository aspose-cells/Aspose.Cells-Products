...
description: Aspose Эксель. Быстро и легко конвертируйте JPG в XPS с помощью Aspose.Cells. Java JPG в XPS. Java Сохраните JPG в XPS. Сохраните JPG как XPS, используя Java.
...
{{% blocks/products/pf/agp/content h2="Конвертируйте JPG в XPS, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните JPG в XPS в Java." %}}

В следующем примере показано, как преобразовать JPG в XPS в Java.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать JPG в XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно конвертировать файлы JPG в XPS? Разработчики Java могут легко преобразовать JPG в XPS всего за несколько строк кода.
