...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar JPG met Aspose.Cells. PHP OTS naar JPG. PHP Bewaar OTS naar JPG. Sla OTS op als JPG met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar JPG te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar JPG converteren? PHP-ontwikkelaars kunnen OTS eenvoudig in slechts een paar regels code laden en naar JPG converteren.
...
1.  Converteer OTS naar JPG door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van OTS naar JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om OTS naar JPG te converteren" %}}
