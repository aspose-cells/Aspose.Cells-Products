---
title:  Vložte kostku do Excelu přes C++
weight: 20
description: C++ ukázkový kód pro vložení krychle do souboru aplikace Excel na C++ Runtime Environment pro Windows 32 bit, Windows 64 bit a Linux 64 bit.
keywords: [C++ Aspose.Cells., C++ add Cube shape., C++ insert Cube shape., C++ create Cube shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vložte kostku do Excelu přes C++" h2="Vkládejte objekty pomocí nativního a vysokého výkonu na straně serveru Aspose.Cells for C++ API bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit krychli do souboru aplikace Excel pomocí C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení krychle do souboru Excel přes C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Vložte kostku - C++" offSpacer="" %}}
