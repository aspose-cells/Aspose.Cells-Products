---
title: NUMBERS samenvoegen tot MD - Combineer NUMBERS tot MD in C++
url: /nl/cpp/merger/merge-numbers-to-md/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online NUMBERS samenvoegen naar MD-opslagformaat. C++ Combineer NUMMERS naar MD-formaat. NUMBERS samenvoegen tot MD in C++. NUMBERS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="NUMBERS samenvoegen naar MD met behulp van C++" %}}
...
{{% blocks/products/pf/agp/content h2="NUMBERS samenvoegen naar MD in C++ Gratis online" %}}

Het volgende voorbeeld laat zien hoe NUMBERS kan worden samengevoegd tot MD in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om NUMBERS samen te voegen met MD. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een MD-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat NUMBERS samenvoegt tot MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om NUMBERS samen te voegen tot MD in C++" InputFormat="numbers" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe NUMBERS samen te voegen tot MD via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u NUMBERS programmatisch samenvoegen met MD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om NUMBERS samen te voegen tot MD" %}}
