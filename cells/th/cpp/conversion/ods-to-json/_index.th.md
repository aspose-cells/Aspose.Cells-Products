---
title: C++ ODS ถึง JSON - ออนไลน์ ODS ถึง JSON Converter
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง ODS เป็น JSON บันทึกรูปแบบ รูปแบบ C++ ODS ถึง JSON บันทึก ODS ถึง JSON C++
...
{{% blocks/products/pf/agp/content h2="บันทึก ODS ถึง JSON ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง ODS เป็น JSON โดยเรียกเมธอด Save()
