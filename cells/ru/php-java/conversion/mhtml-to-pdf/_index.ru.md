...
Нужно программно преобразовать файлы с номерами MHTML в PDF? PHP-разработчики могут легко загрузить и преобразовать файлы с номерами MHTML в PDF всего несколькими строками кода.
...
1.  Преобразуйте значение MHTML в PDF, вызвав метод save объекта Workbook.
1.  Получите результат преобразования MHTML в PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-библиотека для преобразования MHTML в PDF" %}}
