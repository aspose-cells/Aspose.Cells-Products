---
title: C# XLAM bis XLSB - XLAM bis XLSB Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM bis XLSB in C#" %}}

Das folgende Beispiel zeigt, wie man XLAM in C# in XLSB umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLAM über C# in XLSB" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLAM-Dateien programmgesteuert in XLSB konvertieren? .NET-Entwickler können XLAM mit nur wenigen Codezeilen problemlos in XLSB laden und konvertieren.
...
1.  Konvertieren Sie XLAM in XLSB durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLAM in XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLAM in XLSB" %}}
