...
1. สร้างอินสแตนซ์ของ [คลาสเวิร์กบุค](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook).1. เข้าถึงแผ่นงานที่เกี่ยวข้องโดยใช้เมธอด getWorksheets.get()1. เลือกเซลล์ที่เกี่ยวข้อง ป้อนค่าลงในเซลล์ที่ต้องการโดยใช้ชื่อเซลล์ เช่น A1, B3 เป็นต้น1. บันทึกเวิร์กบุ๊กเป็นรูปแบบ HTML โดยใช้เมธอด save()
