...
{{% blocks/products/pf/agp/content h2="How to Search XLSM File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Search XLSM Files in Java" %}}
...
+  Load XLSM file by instantiating a Workbook object.
+  Access the first worksheet in the XLSM file.
...
{{% blocks/products/pf/agp/code-block title="Search XLSM Files - Java" offSpacer="" %}}
