---
title: C# OTS till TSV - OTS till TSV Converter
description: Aspose Excel. Konvertera OTS till TSV snabbt och enkelt med Aspose.Cells. C# OTS till TSV. C# Spara OTS till TSV. Spara OTS som TSV med 304818.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till TSV på C#" %}}

Följande exempel visar hur man konverterar OTS till TSV i C#.
...
{{% cells-convert title="Exempelkod för att konvertera OTS till TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till TSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till TSV programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till TSV på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera OTS till TSV" %}}
