---
title: Converteer SPREADSHEETML naar JSON via Python

description: Voorbeeldcode voor conversie van spreadsheetml naar json Python. Gebruik API voorbeeldcode voor batch-spreadsheetml-bestanden naar json-conversie binnen de Python-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer SPREADSHEETML naar JSON via Python" h2="Exporteer Excel®-spreadsheets naar JSON-indeling met Python API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML naar JSON te converteren met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om SPREADSHEETML naar JSON te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen eenvoudig SPREADSHEETML-bestanden laden en converteren naar JSON in slechts een paar regels code.
