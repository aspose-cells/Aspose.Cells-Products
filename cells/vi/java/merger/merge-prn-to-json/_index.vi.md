---
title: Gộp PRN thành JSON - Gộp PRN thành JSON vào Java
url: /vi/java/merger/merge-prn-to-json/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất PRN thành JSON saveformat. Java Kết hợp PRN thành định dạng JSON. Hợp nhất PRN thành JSON trong Java. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN thành JSON trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất PRN thành JSON trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất PRN thành JSON. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu vào tệp JSON. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất PRN thành JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp PRN về JSON trong Java" InputFormat="prn" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp PRN thành JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất PRN thành JSON theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép PRN thành JSON" %}}
