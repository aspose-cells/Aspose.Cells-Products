...
url: /hu/python-net/merger/merge-fods-to-spreadsheetml/ 
...
A következő példa bemutatja, hogyan egyesítheti a FODS-et a SPREADSHEETML-be a Aspose.Cells for Python via .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a FODS-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
