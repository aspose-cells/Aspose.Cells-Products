...
{{% blocks/products/pf/agp/content h2="TSV-fájl egyesítése a következővel: C#" %}}
 ...
 A TSV-fájl egyesítéséhez használjuk
...
+ Töltse be az összes TSV-fájlt teljes elérési úttal.
+ Készítsen egy dokumentumot alapfájlként
+ Hívja meg a megfelelő metódust a fájlok egyenkénti összefűzésére és egyesítésére.
+ Hívja meg a Save() metódust, és adja meg a fájlnevet (teljes elérési út) és a formátumot (TSV) paraméterként.
+ Most már megnyithatja és használhatja a TSV fájlt a Microsoft Office-ban, az Adobe PDF-ben vagy bármely más kompatibilis programban.
