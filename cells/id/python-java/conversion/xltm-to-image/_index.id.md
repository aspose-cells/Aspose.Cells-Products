...
description: Aspose Unggul. Ubah XLTM menjadi IMAGE dengan cepat dan mudah menggunakan Aspose.Cells. Python XLTM menjadi IMAGE. Python Simpan XLTM ke GAMBAR. Simpan XLTM sebagai GAMBAR menggunakan Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLTM menjadi GAMBAR di Python" h2="Pustaka Python berkecepatan tinggi untuk mengonversi XLTM menjadi IMAGE. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLTM, IMAGE, dan banyak format lainnya menggunakan Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTM ke IMAGE di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLTM menjadi IMAGE di Python.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLTM menjadi IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="png" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengonversi XLTM menjadi IMAGE" %}}
