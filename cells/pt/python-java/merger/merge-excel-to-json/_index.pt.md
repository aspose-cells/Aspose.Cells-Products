...
description: Aspose Excel. Python Aspose.Cells. Mesclar EXCEL para JSON saveformat. Python Combine EXCEL com o formato JSON. Mesclar EXCEL com JSON em Python. Mesclar EXCEL.
...
{{% blocks/products/pf/agp/content h2="Mesclar EXCEL com JSON usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar EXCEL com JSON em Python" %}}
...
{{% cells-merger title="Exemplo de código para mesclar EXCEL com JSON em Python" InputFormat="xlsx" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar EXCEL com JSON via Python" %}}
