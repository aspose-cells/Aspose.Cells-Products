---
title: C# XLSB から MD - XLSB から MD コンバーター
description: Aspose エクセル。 Aspose.Cellsを使用して、XLSBをMDにすばやく簡単に変換します。C# XLSBをMDに変換します。 C# XLSB を MD に保存します。 C# を使用して XLSB を MD として保存します。
...
{{< blocks/products/pf/i18n/upper-banner h1="XLSBをC#のMDに変換します" h2="XLSBをMDに変換するための高速C#ライブラリ。これは、XLSB フレームワーク、.NET コア、または Mono プラットフォームで XLSB、MD、およびその他の多くの形式をインポートおよびエクスポートするためのプロフェッショナル ソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB を C# の MD に保存" %}}
...
{{% cells-convert title="XLSBをMDに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="XLSB経由でXLSBをMDに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSB ファイルをプログラムで MD に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLSB を簡単にロードして MD に変換できます。
