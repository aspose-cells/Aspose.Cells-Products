...
Trzeba programowo przekonwertować pliki JPG do formatu ODS? Programiści C++ mogą łatwo przekonwertować pliki JPG do formatu ODS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JPG do ODS wywołując metodę Save().
