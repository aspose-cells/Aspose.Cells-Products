...
description: Aspose Excel. Java Aspose.Cells. Slå ihop PRN till JSON sparaformat. Java Kombinera PRN till JSON format. Slå samman PRN till JSON i Java. PRN sammanfoga.
...
{{% blocks/products/pf/agp/content h2="Slå ihop PRN till JSON i Java" %}}
...
{{% cells-merger title="Exempelkod för att slå samman PRN till JSON i Java" InputFormat="prn" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
