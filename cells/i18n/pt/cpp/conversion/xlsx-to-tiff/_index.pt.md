...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem facilmente converter arquivos XLSX para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLSX usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (TIFF).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo TIFF em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLSX para TIFF C++" offSpacer="" %}}
