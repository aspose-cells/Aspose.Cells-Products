...
description: Aspose Excel. Converta CSV em DIF de forma rápida e fácil com Aspose.Cells. C# CSV em DIF. C# Salve CSV em DIF. Salve CSV como 07611134 81 usando C#.
...
{{% blocks/products/pf/agp/content h2="Salve CSV para DIF em C#" %}}

O exemplo a seguir demonstra como converter CSV em DIF em C#.
...
{{% cells-convert title="Exemplo de código para converter CSV em DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="dif" IsLandingPage="true" %}}
...
1.  Converta CSV em DIF chamando o método Workbook.Save.
