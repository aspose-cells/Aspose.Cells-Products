---
title: C# XLT do JPEG - XLT do JPEG Konwerter
description: Aspose Excel. Konwertuj XLT na JPEG szybko i łatwo za pomocą Aspose.Cells. C# XLT na JPEG. C# Zapisz XLT na JPEG. Zapisz XLT jako 0761113 481 pod numerem C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT do JPEG w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLT na JPEG w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLT na JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na JPEG przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLT na JPEG? Programiści .NET mogą łatwo załadować i przekonwertować XLT na JPEG w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLT na JPEG, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLT na JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLT na JPEG" %}}
