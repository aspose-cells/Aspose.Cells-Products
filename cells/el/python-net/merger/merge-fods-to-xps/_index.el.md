...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση FODS σε μορφή αποθήκευσης XPS. Python Συνδυάστε τη μορφή FODS με XPS. Συγχώνευση FODS σε XPS στο Python. FODS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση FODS με XPS στο Python" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση FODS έως XPS στο Python" InputFormat="fods" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
