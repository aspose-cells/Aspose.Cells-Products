...
description: Aspose Excel. Converti OTS in FODS in modo rapido e semplice con Aspose.Cells. Python OTS in FODS. Python Salva OTS in FODS. Salva OTS come FODS utilizzando Python.
...
{{% blocks/products/pf/agp/content h2="Salva OTS allo FODS nello Python" %}}
...
{{% cells-convert title="Codice di esempio per convertire OTS in FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="fods" IsLandingPage="true" language="pythonjava" %}}
