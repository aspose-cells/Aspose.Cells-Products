---
title: Combinar TXT a XLSX - Combinar TXT a XLSX en C#
url: /es/net/merger/merge-txt-to-xlsx/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea TXT a XLSX guardar formato. C# Combina el formato TXT con el XLSX. Combinar TXT a XLSX en C#. TXT Combinar.
...
El siguiente ejemplo muestra cómo combinar TXT con XLSX en Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis en línea para fusionar TXT a XLSX en C#" InputFormat="txt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar TXT a XLSX a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar TXT con XLSX mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar TXT a XLSX" %}}
