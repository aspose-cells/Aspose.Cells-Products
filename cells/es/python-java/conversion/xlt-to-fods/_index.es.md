---
title: Convierta XLT a FODS a través de Python
url: /es/python-java/conversion/xlt-to-fods/
description: Código de muestra para la conversión de xlt a fods Python. Utilice el código de ejemplo API para la conversión de archivos xlt por lotes en la aplicación Python.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a FODS usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLT a FODS a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden cargar y convertir fácilmente archivos XLT a FODS con solo unas pocas líneas de código.
...
{{% cells-convert title="Aplicación gratuita y código de muestra para convertir XLT a FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="fods" IsLandingPage="true" language="python" %}}
