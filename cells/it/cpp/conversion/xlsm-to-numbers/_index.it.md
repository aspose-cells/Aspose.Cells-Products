...
Hai bisogno di convertire i file XLSM in NUMBERS a livello di programmazione? Gli sviluppatori di C++ possono facilmente convertire XLSM in NUMBERS in poche righe di codice.
...
1.  Converti XLSM in NUMBERS chiamando il metodo Save().
