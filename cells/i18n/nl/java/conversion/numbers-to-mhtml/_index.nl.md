...
{{% blocks/products/pf/agp/content h2="NUMMERS converteren naar MHTML met Java" %}}

 Om NUMBERS naar MHTML weer te geven, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om NUMMERS naar MHTML te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het NUMBERS-bestand gemakkelijk converteren naar MHTML in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad NUMBERS-bestand met een instantie van Workbook-klasse1. Bel de methode Workbook.save1. Geef het uitvoerpad door met de MHTML-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende MHTML-bestand
...
{{% blocks/products/pf/agp/code-block title="NUMMERS naar MHTML Java Conversiebroncode" offSpacer="" %}}

```cs
// laad het NUMBERS-bestand in een instantie van Workbook
Workbook book = new Workbook("template.numbers");
// NUMMERS opslaan als MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMMERS naar MHTML-conversie Live demo\'s" sectionDescription="[NUMMERS naar MHTML converteren](https://products.aspose.app/cells/conversion/numbers-to-mhtml) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw NUMBERS-bestand, het wordt onmiddellijk geconverteerd naar MHTML." >}}
