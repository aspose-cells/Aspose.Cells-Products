---
title:  Υδατογράφημα XLSB έγγραφο via Java
weight: 5900
description: Java δείγμα κώδικα για προσθήκη ή αφαίρεση υδατογραφήματος στο αρχείο XLSB στο Java Runtime Environment για εφαρμογές JSP/JSF και εφαρμογές επιφάνειας εργασίας.
...
{{< blocks/products/pf/i18n/upper-banner h1="Προσθέστε Υδατογράφημα κειμένου στο XLSB via Java" h2="Δημιουργήστε τις δικές σας εφαρμογές Java για να υδατογραφήσετε αρχεία XLSB χρησιμοποιώντας API από την πλευρά του διακομιστή." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να υδατογραφήσετε το αρχείο XLSB χρησιμοποιώντας το Java" %}}

 Για να υδατογραφήσουμε το αρχείο XLSB, θα χρησιμοποιήσουμε[Aspose.Cells for Java](https://products.aspose.com/cells/java) API που είναι μια πλούσια σε χαρακτηριστικά, ισχυρή και εύχρηστη πλατφόρμα υδατογραφήματος API for Java. Μπορείτε να κατεβάσετε την τελευταία του έκδοση απευθείας από[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) και εγκαταστήστε το στο έργο σας που βασίζεται στο Maven προσθέτοντας τις ακόλουθες διαμορφώσεις στο pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την προσθήκη υδατογραφήματος στο XLSB via Java" %}}
...
1.  Αποθήκευση βιβλίου εργασίας σε μορφή XLSB
...
{{% blocks/products/pf/agp/code-block title="Προσθέστε υδατογράφημα στο XLSB - Java" offSpacer="" %}}
