...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in HTM in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB naar HTM kunt converteren in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je XLSB naar HTM via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u XLSB-bestanden programmatisch naar HTML converteren? Ontwikkelaars van Java-bestanden kunnen XLSB-bestanden eenvoudig in een paar regels code naar HTML converteren.
