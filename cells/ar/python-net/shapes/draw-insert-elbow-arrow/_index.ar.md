---
title: كيفية رسم أو إدراج شكل سهم الكوع في برنامج Excel باستخدام Python via .Net
weight: 10
description: Python via. صافي الكود المصدري لإدراج شكل سهم الكوع في برنامج Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شكل سهم الكوع في ملف إكسيل باستخدام Python via.نت" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج شكل سهم المرفق في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) لإدراج شكل سهم على شكل مرفق في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج شكل سهم الكوع - Python via .نت" offSpacer="" %}}
