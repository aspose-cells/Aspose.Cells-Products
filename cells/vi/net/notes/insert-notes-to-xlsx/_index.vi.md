...
{{% blocks/products/pf/agp/content h2="Cách chèn ghi chú vào file XLSX qua C#" %}}
...
Trong Office 365, ghi chú dành cho chú thích, bạn có thể sử dụng mã C# sau để chèn và xóa ghi chú trong tệp XLSX.

{{% blocks/products/pf/agp/code-block title="Mã mẫu C# để Chèn và xóa ghi chú trong tệp XLSX" offSpacer="" %}}
