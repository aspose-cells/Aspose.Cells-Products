...
description: C# source code to combine XLS to HTM file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="How to Merge XLS to HTM File Using C#" %}}
 ...
 In order to merge XLS to HTM file, we’ll use
...
{{% blocks/products/pf/agp/code-block title="Merge XLS to HTM Files - C#" offSpacer="" %}}
