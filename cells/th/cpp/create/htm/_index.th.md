...
{{% blocks/products/pf/agp/text %}}
 ...
 นักพัฒนาสามารถสร้าง โหลด แก้ไข และแปลงไฟล์ HTM ได้อย่างง่ายดายภายในแอปพลิเคชันการรายงานที่รันสำหรับการประมวลผลข้อมูลด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  บันทึกสมุดงานเป็นไฟล์ .htm โดยใช้วิธี Save()
...
{{% blocks/products/pf/agp/content h2="ไลบรารี C++ เพื่อสร้างไฟล์ HTM" %}}
