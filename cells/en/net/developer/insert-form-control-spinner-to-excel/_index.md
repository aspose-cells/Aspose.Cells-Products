---
title: Insert spin button into Excel via .NET 
weight: 40
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert spin button to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addspinner) to insert a spin button in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert spin button - C#" offSpacer="" %}}
