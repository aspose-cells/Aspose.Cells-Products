...
<p>
 Aspose.Cells for Node.js via Java は、XLS、XLSX、ODS、SpreadsheetML、CSV、TSC、HTML を含む、最も一般的なスプレッドシート形式をサポートしています。
</p>
...
{{< blocks/products/pf/carousel-item h3="一目でわかる" description="Aspose.Cells for Node.js via Java 機能の概要。" >}}
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="Aspose.Cells for Node.js via Java は、Node.js に基づくサーバーサイド JavaScript API です。JDK 1.7 以上を搭載した Windows、Unix/Linux、Mac プラットフォームで実行できます。" >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
高度なNode.js via Java Excelスプレッドシート API 機能
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
ピボットテーブル、グラフ、スパークライン、条件付き書式を作成する
    </p>
   </div>
   <div class="col-lg-4">
...
柔軟な表示オプション
    ...
    <p>
Aspose.Cells for Node.js via Java は、ワークシートのページ設定を完全に制御し、ページの向き、区切り、サイズ、拡大縮小、ヘッダー、フッター、ズーム レベルなどのワークシートの表示オプションを操作できます。さらに、開発者は、印刷領域とペインの固定を使用して、アプリケーションの仕様に合わせてデータの表示を制御できます。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
セキュリティオプション
    ...
    <p>
Aspose.Cells for Node.js via Java は、スプレッドシートの暗号化/復号化、コンテンツ、オブジェクト、シナリオの保護、行、列、ワークシートの非表示/表示機能など、幅広いセキュリティ機能を提供します。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
行と列を操作する
    ...
    <p>
Aspose.Cells for Node.js via Java を使用すると、さまざまな方法で行と列を操作できます。行の高さと列の幅を簡単に調整したり、内容に応じてセルのサイズを自動調整したり、挿入と削除、非表示と表示、行と列のグループ化とグループ解除を行うことができます。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
ワークシートの書式設定の包括的なサポート
    ...
    <p>
Aspose.Cells for Node.js via Java は、データの表示を制御できる高度な書式設定機能を提供します。ワークシート、列、行、またはセルに書式設定を適用したり、単一のセルにリッチ テキストを追加したり、境界線を適用したり、背景パターンやフォント スタイルを設定したりできます。API では、条件付き書式設定ルールをその場で追加、操作、計算することもできます。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
チャートの作成、操作、レンダリング
    ...
    <p>
Aspose.Cells for Node.js via Java はチャート作成を完全にサポートします。API を使用すると、カスタマイズされたチャートや標準チャートを簡単に追加でき、データを動的に設定してチャートを更新できます。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="API 参照" href="https://reference.aspose.com/nodejs/cells" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="なぜ Aspose.Cells for Node.js via Java なのでしょうか?" tabId="success-stories" >}}
