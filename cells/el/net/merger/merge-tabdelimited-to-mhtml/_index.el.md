---
title: Συγχώνευση TABDELIMITED στο MHTML - Συνδυάστε το TABDELIMITED στο MHTML στο C#
url: /el/net/merger/merge-tabdelimited-to-mhtml/ 
description: Aspose Excel. C# Aspose.Cells. Δωρεάν online συγχώνευση TABDELIMITED σε MHTML saveformat. C# Συνδυάστε τη μορφή TABDELIMITED σε MHTML. Συγχώνευση TABDELIMITED στο MHTML στο C#. TABDELIMITED Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση TABDELIMITED στο MHTML στο C# Δωρεάν Online" %}}

Το παρακάτω παράδειγμα δείχνει πώς να συγχωνεύσετε το TABDELIMITED στο MHTML στο Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ακολουθήστε τα εύκολα βήματα για να συγχωνεύσετε το TABDELIMITED στο MHTML. Ανεβάστε τα αρχεία σας, καλέστε τη μέθοδο Workbook.Combine για τη συγχώνευση αρχείων και, στη συνέχεια, αποθηκεύστε το στο αρχείο MHTML. Εάν αναπτύξετε κωδικό στο C#, αυτό θα είναι πιο απλό από ό,τι ακούγεται. Δείτε το παράδειγμα C# που συγχωνεύει το TABDELIMITED στο MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Δωρεάν online για συγχώνευση TABDELIMITED στο MHTML στο C#" InputFormat="tsv" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το TABDELIMITED στο MHTML μέσω του C#" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε το TABDELIMITED στο MHTML μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2=".NET βιβλιοθήκη για συγχώνευση TABDELIMITED σε MHTML" %}}
