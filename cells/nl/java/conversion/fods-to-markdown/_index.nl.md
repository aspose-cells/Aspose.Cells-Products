---
title: Converteer FODS naar MARKDOWN via Java 
url: /nl/java/conversion/fods-to-markdown/ 
description: Voorbeeld Java conversiecode voor FODS-indeling naar MARKDOWN-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar MARKDOWN te exporteren binnen elke web- of desktoptoepassing Java.
---
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar MARKDOWN te converteren met Java" %}}

 Om FODS naar MARKDOWN te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om FODS om te zetten naar MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het FODS-bestand gemakkelijk converteren naar MARKDOWN in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad FODS-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef het uitvoerpad door met de MARKDOWN-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende MARKDOWN-bestand
...
{{% blocks/products/pf/agp/code-block title="FODS naar MARKDOWN Java conversiebroncode" offSpacer="" %}}

```cs
// laad het FODS-bestand in een exemplaar van Workbook
Workbook book = new Workbook("template.fods");
// sla FODS op als MARKDOWN
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS naar MARKDOWN Conversie Live demo\'s" sectionDescription="[Zet FODS om naar MARKDOWN](https://products.aspose.app/cells/conversion/fods-to-markdown) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw FODS-bestand, het wordt onmiddellijk geconverteerd naar MARKDOWN." >}}
