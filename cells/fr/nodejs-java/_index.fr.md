...
weight: 3120
description: Traiter les formats de fichiers Excel via la bibliothèque Node.js. Lire écrire rendre et convertir XLS XLSX XLSB XLTX XLTM XLSM XML ODS CSV et d'autres formats via Node.js sur Windows, macOS et Linux
---
...
<p>
 Aspose.Cells for Node.js via Java est un API riche en fonctionnalités et évolutif pour traiter les feuilles de calcul Excel à l'aide de Node.js. API propose la conversion du format de fichier Excel, le style des feuilles de calcul au niveau le plus granulaire, la création de graphiques et amp; rendu, moteur de calcul de formule fiable et bien plus encore.
</p>
...
{{< blocks/products/pf/carousel-item h3="En bref" description="Un aperçu des capacités Aspose.Cells for Node.js via Java." >}}
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plate-forme" description="Aspose.Cells for Node.js via Java est un JavaScript côté serveur API basé sur Node.js. Il peut fonctionner sur les plates-formes Windows, Unix/Linux et Mac avec JDK 1.7 ou supérieur." >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Formats de fichiers pris en charge" description="Aspose.Cells for Node.js via Java prend en charge les formats de fichiers de feuille de calcul populaires ainsi que les formats d\'image et de mise en page fixe les plus couramment utilisés." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 Créez des tableaux croisés dynamiques, des graphiques, des sparklines et amp ; mise en forme conditionnelle
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Actualiser les graphiques existants &amp; convertir des graphiques en images ou PDF
    </p>
   </div>
   <div class="col-lg-4">
...
Manipuler et actualiser les tableaux croisés dynamiques via API
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Convertir les feuilles de calcul en PDF, XPS &amp; SVG formats
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
Aspose.Cells for Node.js via Java fournit des fonctionnalités de formatage avancées qui vous permettent de contrôler la présentation de vos données. Vous pouvez appliquer une mise en forme à une feuille de calcul, une colonne, une ligne ou une cellule ou ajouter du texte enrichi à une seule cellule, appliquer des bordures, définir des motifs d'arrière-plan et un style de police. Le API permet également d'ajouter, de manipuler &amp; calculer les règles de mise en forme conditionnelle à la volée.
 ...
 Création de graphiques, manipulation et amp ; Le rendu
    ...
    <p>
 Aspose.Cells for Node.js via Java fournit un support complet pour la création de graphiques. On peut facilement ajouter des graphiques personnalisés ou standard à l'aide du API et définir dynamiquement les données afin de rafraîchir les graphiques.
    </p>
   </div>
  </div>
 </div>
