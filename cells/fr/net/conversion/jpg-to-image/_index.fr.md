...
Besoin de convertir des fichiers JPG en IMAGE par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en IMAGE en quelques lignes de code.
...
1.  Convertissez le fichier JPG en IMAGE en appelant la méthode Workbook.Save.
