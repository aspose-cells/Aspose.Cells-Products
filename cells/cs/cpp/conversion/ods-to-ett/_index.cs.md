...
description: Aspose Excel. Převeďte ODS na ETT rychle a snadno pomocí Aspose.Cells. C++ ODS na ETT. C++ Uložte ODS do ETT. Uložte ODS jako ETT pomocí C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte ODS na ETT v C++" h2="Vysoce výkonný převod ODS na ETT pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ETT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte ODS do ETT v C++" %}}

Následující příklad ukazuje, jak převést ODS na ETT v C++.
...
{{% cells-convert title="Ukázkový kód pro převod ODS na ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="ett" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést ODS na ETT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést ODS soubory na ETT programově? Vývojáři C++ mohou snadno převést ODS na ETT v několika řádcích kódu.
...
1.  Převeďte ODS na ETT voláním metody Save().
