---
title: Gabungkan XLSB ke POWERPOINT - Gabungkan XLSB ke POWERPOINT di C#
url: /id/net/merger/merge-xlsb-to-powerpoint/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSB ke format penyimpanan POWERPOINT. C# Gabungkan XLSB ke format POWERPOINT. Gabungkan XLSB menjadi POWERPOINT di C#. XLSB Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSB ke POWERPOINT Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSB ke POWERPOINT di C#" %}}

Contoh berikut menunjukkan cara menggabungkan XLSB ke POWERPOINT di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSB ke POWERPOINT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file POWERPOINT. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSB menjadi POWERPOINT.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLSB ke POWERPOINT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk digabungkan XLSB ke POWERPOINT" %}}
