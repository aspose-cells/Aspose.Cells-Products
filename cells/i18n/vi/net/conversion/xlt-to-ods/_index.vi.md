---
title: Chuyển đổi XLT sang ODS qua C#
url: /vi/net/conversion/xlt-to-ods/
description: Mã mẫu cho chuyển đổi xlt thành ods C#. Sử dụng API mã mẫu cho các tệp xlt hàng loạt để chuyển đổi ods trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLT sang ODS bằng cách sử dụng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLT sang ODS qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp XLT sang ODS chỉ trong một vài dòng mã.
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi XLT sang ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="ods" IsLandingPage="true" %}}
