...
{{% blocks/products/pf/agp/content h2="Сохранение XML в HTML в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в HTML в файле C#.
...
Нужно программно преобразовать XML-файлы в HTML? Разработчики, использующие код .NET, могут легко загрузить и преобразовать XML в HTML всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XML в HTML" %}}
