...
description: Aspose Unggul. Ubah PNG menjadi BMP dengan cepat dan mudah dengan Aspose.Cells. Java PNG menjadi BMP. Java Simpan PNG menjadi BMP. Simpan PNG sebagai 07611134 81 menggunakan Java.
...
{{% blocks/products/pf/agp/content h2="Ubah PNG menjadi BMP Menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan PNG hingga BMP di Java" %}}

Contoh berikut menunjukkan cara mengonversi PNG menjadi BMP di Java.
...
Perlu mengonversi file PNG ke BMP secara terprogram? Pengembang Java dapat dengan mudah mengonversi PNG menjadi BMP hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah PNG menjadi BMP" %}}
{{% blocks/products/pf/agp/text %}}
