...
description: Aspose Excel. Générez et manipulez facilement des fichiers PNG grâce à la bibliothèque Aspose.Cells for Java. Cette puissante bibliothèque API offre une solution simplifiée et efficace pour créer, modifier et gérer des fichiers PNG directement dans vos applications Java, répondant ainsi avec une grande précision aux besoins spécifiques des développeurs.
...
1.  Enregistrez le classeur au format PNG en utilisant la méthode save().

{{% blocks/products/pf/agp/code-block title="L\'exemple de code montre comment créer le fichier PNG dans Java." offSpacer="" %}}
