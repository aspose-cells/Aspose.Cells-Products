---
title:  Sloučit TXT na HTM via Java
url: /cs/java/merger/merge-txt-to-htm/ 
description: Sloučit TXT do HTM Online zdarma. Online zdarma TXT do HTM Fúze. Sloučit TXT do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit TXT do HTM v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT s HTM online" InputFormat="txt" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
