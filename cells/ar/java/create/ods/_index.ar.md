---
title: قم بإنشاء ODS (Openoffice / Lbreoffice) ملفات via Java
description: ODS مبتكر. إنشاء ODS ملفات في Java كود. قم بإنشاء ملفات ODS (Openoffice / Lbreoffice) باستخدام تطبيق ويب أو سطح مكتب يستند إلى Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء ODS ملف via Java" h2="إنشاء جداول بيانات أصلي وعالي الأداء ODS (Openoffice / Lbreoffice) برمجيًا باستخدام مكتبة Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="قم بإنشاء ملف ODS باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء ODS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح كود المصدر التالي كيفية إنشاء ملف ODS (Openoffice / Lbreoffice) باستخدام Java." offSpacer="" %}}
