---
title:  أدخل ListBox (عنصر تحكم النموذج) في Excel عبر Python
weight: 50
description: Python التعليمات البرمجية المصدر لإدراج ListBox (التحكم في النموذج) في Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل ListBox (عنصر تحكم النموذج) في Excel عبر Python" h2="أدخل كائنات باستخدام واجهات برمجة التطبيقات من جانب الخادم بدون أي برنامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج ListBox (عنصر تحكم النموذج) في ملف Excel باستخدام Python" %}}

 من أجل إدراج ListBox (عنصر تحكم النموذج) في ملف excel ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج ListBox (عنصر تحكم النموذج) في ملف Excel عبر Python" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم الشكل[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addListBox(int,%20int,%20int,%20int,%20int,%20int)) لإدراج ListBox (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج ListBox (عنصر تحكم النموذج) - Python" offSpacer="" %}}
