---
title:  Combinar TXT a XLSX vía Python
...
El siguiente ejemplo muestra cómo combinar TXT con XLSX en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar TXT a XLSX en línea" InputFormat="txt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
