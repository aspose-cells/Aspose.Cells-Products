---
title: 創建XLTX - 在Java中創建XLTX文件
description: Aspose Excel。 Java 創建 XLTX 文件。創建XLTX Java。Java XLTX創建者。在Java中創建XLTX。使用Java生成XLTX文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建XLTX" %}}

{{% blocks/products/pf/agp/text %}}

開發人員只需幾行代碼即可輕鬆在運行不同的報告應用程序中創建、加載、修改和轉換 XLTX 文件以進行數據處理。
...
1. 使用 save() 方法將工作簿保存為 XLTX 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 XLTX 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建XLTX文件" %}}
{{% blocks/products/pf/agp/text %}}
