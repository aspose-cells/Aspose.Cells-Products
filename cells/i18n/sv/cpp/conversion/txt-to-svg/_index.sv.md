---
title: Konvertera TXT till SVG via appen C++ 
url: /sv/cpp/conversion/txt-to-svg/ 
description: Exempel på C++-konverteringskod för TXT-dokument till SVG-format. Programmerare kan använda den här källkoden för batchkonvertering av TXT till SVG inom alla C++-program.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera TXT till SVG via C++" h2="Högpresterande TXT till SVG-konvertering med hjälp av C++-biblioteket utan behov av installation av Microsoft Excel, OpenOffice eller Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera TXT-fil till SVG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda TXT-fil med Factory::CreateIWorkbook.1. Välj det första kalkylbladet.1. Ställ in (SVG) alternativ.1. Iterera genom varje sida av arket och rendera.1. Öppna SVG-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="TXT till SVG C++ omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT till SVG Conversion Live Demos" sectionDescription="[Konvertera TXT till SVG](https://products.aspose.app/cells/conversion/txt-to-svg) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din TXT-fil, den konverteras omedelbart till SVG." >}}
