---
title: Java XML vers FODS - Convertisseur XML vers FODS
description: Aspose Exceller. Convertissez XML en FODS rapidement et facilement avec Aspose.Cells. Java XML en FODS. Java Enregistrez XML en FODS. Enregistrez XML sous FODS en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au FODS dans Java" %}}

L'exemple suivant montre comment convertir XML en FODS en Java.
...
{{% cells-convert title="Exemple de code pour convertir XML en FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="fods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XML en FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en FODS par programme ? Les développeurs Java peuvent facilement convertir XML en FODS en quelques lignes de code seulement.
