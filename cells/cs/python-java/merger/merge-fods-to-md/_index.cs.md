...
description: Aspose Excel. Python Aspose.Cells. Sloučit FODS do formátu uložení MD. Python Spojte FODS do formátu MD. Sloučit FODS na MD v Python. FODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit FODS na MD v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení FODS na MD v Python" InputFormat="fods" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
