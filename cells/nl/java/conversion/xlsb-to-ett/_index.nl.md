...
Het volgende voorbeeld laat zien hoe je XLSB omzet naar ETT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar ETT via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u XLSB-bestanden programmatisch naar ETT converteren? Ontwikkelaars van Java kunnen XLSB-bestanden eenvoudig in een paar regels code naar ETT converteren.
