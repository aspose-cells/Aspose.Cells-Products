...
{{% cells-convert title="Exemplo de código para converter OTS em XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter OTS para XML via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos OTS em XML programaticamente? Os desenvolvedores do C++ podem converter facilmente OTS em XML em apenas algumas linhas de código.
...
1.  Converta OTS em XML chamando o método Save().
