...
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása HTML-vé a következőn keresztül: Python" h2="Exportáljon Excel® táblázatokat HTML formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása HTML-re a következővel: Python" %}}

 Az SXC HTML-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az SXC konvertálásához HTML-vé a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen betölthetik és néhány kódsor segítségével HTML-formátumba konvertálhatják az SXC fájlokat.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Adja meg a kimeneti útvonalat HTML kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott HTML-fájl megadott elérési útját
