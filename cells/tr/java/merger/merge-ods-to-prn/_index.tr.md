---
title: ODS'i PRN ile birleştir - ODS'i Java'de PRN ile birleştir
url: /tr/java/merger/merge-ods-to-prn/ 
description: Aspose excel. Java Aspose.Cells. ODS'i PRN saveformat'a Ücretsiz Çevrimiçi Birleştirme. Java ODS'i PRN formatına birleştirin. ODS'i Java'de PRN ile birleştir. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java Online\'da PRN ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de PRN ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="ODS\'i Java\'de PRN ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS ile PRN via Java Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i programlı olarak PRN ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i PRN ile birleştirmek için Java kitaplığı" %}}
