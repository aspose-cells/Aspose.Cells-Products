---
title: C# XLS do SPREADSHEETML - Konwerter online XLS do SPREADSHEETML
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Bezpłatnie online C# Konwersja XLS do formatu zapisu SPREADSHEETML. C# XLS do formatu SPREADSHEETML. Zapisz XLS w SPREADSHEETML C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLS na SPREADSHEETML w C#" h2="Szybka biblioteka C# do konwersji XLS na SPREADSHEETML. Jest to profesjonalne oprogramowanie do importowania i eksportowania XLS, SPREADSHEETML i wielu innych formatów na platformach .NET Framework, .NET Core lub Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Zaoszczędź XLS w SPREADSHEETML w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na SPREADSHEETML w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na SPREADSHEETML. Prześlij swój plik XLS, a następnie po prostu zapisz go jako plik SPREADSHEETML. Zarówno do odczytu XLS, jak i zapisu SPREADSHEETML można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie SPREADSHEETML będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLS na SPREADSHEETML Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na SPREADSHEETML przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na SPREADSHEETML? .NET programiści mogą łatwo załadować i przekonwertować XLS na SPREADSHEETML w zaledwie kilku wierszach kodu.
...
1.  Konwertuj XLS na SPREADSHEETML, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLS na SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XLS na SPREADSHEETML" %}}
