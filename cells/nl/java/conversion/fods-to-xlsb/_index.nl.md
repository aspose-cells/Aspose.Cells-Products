...
{{% blocks/products/pf/agp/content h2="Sla FODS op in XLSB in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar XLSB in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar XLSB of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar XLSB? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar XLSB met slechts een paar regels code.
