---
title: C++ MHT إلى SXC - محول MHT عبر الإنترنت إلى SXC
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل MHT إلى SXC saveformat. C++ MHT إلى تنسيق SXC. احفظ MHT في SXC C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT في SXC في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل MHT إلى SXC في C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل MHT إلى SXC. قم بتحميل ملف MHT الخاص بك ، ثم احفظه كملف SXC. لكل من قراءة MHT والكتابة SXC ، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق SXC الناتج مطابقًا لمستند MHT الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني وعينة من التعليمات البرمجية لتحويل MHT إلى SXC عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="sxc" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى SXC عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى SXC برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى SXC في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى SXC باستدعاء طريقة Save ().
