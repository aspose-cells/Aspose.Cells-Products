---
title: NUMBERS egyesítése NUMBERS számmal – NUMBERS egyesítése NUMBERS számmal a C++-ben
url: /hu/cpp/merger/merge-numbers-to-numbers/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítése NUMBERS NUMBERS mentési formátumba. C++ Kombinálja a NUMBERS-t a NUMBERS-formátumba. NUMBERS egyesítése a NUMBERS számokkal a C++-ben. NUMBERS Egyesítés.
...
A következő példa bemutatja, hogyan egyesítheti a NUMBERS számokat a NUMBERS számokkal a Aspose.Cells for C++ számon.
...
{{% cells-merger title="Ingyenes online NUMBERS és NUMBERS egyesítése a C++ számon" InputFormat="numbers" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A NUMBERS és a NUMBERS egyesítése a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a következőt: NUMBERS és NUMBERS? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
