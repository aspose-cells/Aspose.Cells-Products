...
{{% blocks/products/pf/agp/content h2="Sla HTML op in XLTM in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar XLTM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar XLTM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar XLTM? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar XLTM met slechts een paar regels code.
