---
title: PHP OTS naar TXT - OTS naar TXT Converter
description: Aspose Excel. Converteer OTS snel en eenvoudig naar TXT met Aspose.Cells. PHP OTS naar TXT. PHP Bewaar OTS naar TXT. Sla OTS op als TXT met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar TXT te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar TXT converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar TXT in slechts een paar regels code.
...
1.  Converteer OTS naar TXT door de opslagmethode van Workbook aan te roepen.
1.  Ontvang het conversieresultaat van OTS naar TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om OTS naar TXT te converteren" %}}
