...
{{% blocks/products/pf/agp/content h2="كيفية إدراج/إنشاء مخطط انسيابي في ملف Excel باستخدام Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج/إنشاء مخطط انسيابي لملف Excel باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج/إنشاء مخطط انسيابي في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج/إنشاء مخطط انسيابي - Python via Java" offSpacer="" %}}
