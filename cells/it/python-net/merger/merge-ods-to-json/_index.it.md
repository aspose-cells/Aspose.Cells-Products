---
title:  Unisci ODS a JSON tramite Python
url: /it/python-net/merger/merge-ods-to-json/ 
description: Unisci ODS a JSON online gratuitamente. Gratuito Online ODS a JSON Fusione. Unisci ODS a Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e altro ancora.
---
...
L'esempio seguente mostra come unire ODS a JSON in Python.
...
{{% cells-merger title="App gratuita per unire on line lo ODS allo JSON" InputFormat="ods" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
