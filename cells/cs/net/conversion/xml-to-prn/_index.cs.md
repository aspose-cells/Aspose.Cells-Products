...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu XML do formátu PRN, což umožňuje bezproblémové ukládání XML dat do formátu PRN pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Uložit XML do PRN v C#" %}}

Následující příklad ukazuje, jak převést XML na PRN v kódu C#.
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML do PRN" %}}
