---
title: 创建 MS Excel XLSM 文件 via Java
description: XLSM 创建者。在 Java 代码中创建 XLSM 个文件。使用基于 Java 的桌面或 Web 应用程序生成 MS Excel XLSM 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="创建 XLSM 文件 via Java" h2="本机和高性能 MS Excel XLSM 使用 Java 库以编程方式创建电子表格。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何创建 XLSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

开发人员可以很容易地创建、加载、修改和转换 MS Excel XLSM 电子表格，只需几行代码即可运行不同的报告应用程序进行数据处理。
...
{{% blocks/products/pf/agp/code-block title="以下源代码显示了如何使用 Java 创建 MS Excel XLSM 文件。" offSpacer="" %}}
