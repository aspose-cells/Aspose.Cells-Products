...
هل تحتاج إلى تحويل ملفات MHT إلى XLSB برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى XLSB بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLSB عن طريق استدعاء دالة Save().
