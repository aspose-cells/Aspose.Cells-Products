---
title: Python PRN a MHT - Conversor de PRN a MHT en línea
description: AsposeExcel. Python Aspose.Cells. Python Aspose Cells. Gratis en línea Python Convertir PRN a MHT guardar formato. Python PRN a formato MHT. Guarde PRN en MHT Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PRN a MHT en Python" h2="Biblioteca Python de alta velocidad para convertir PRN a MHT. Esta es una solución de software profesional para importar y exportar PRN, MHT y muchos otros formatos usando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Guarde PRN a MHT en Python en línea gratis" %}}

El siguiente ejemplo muestra cómo convertir PRN a MHT en Python.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir PRN a MHT. Cargue su archivo PRN, luego simplemente guárdelo como archivo MHT. Tanto para la lectura de PRN como para la escritura de MHT, puede usar nombres de archivo completos. El contenido y el formato de la MHT de salida serán idénticos al documento PRN original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicación gratuita y código de muestra para convertir PRN a MHT en línea" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PRN a MHT a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PRN a MHT mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente PRN a MHT con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Python biblioteca para convertir PRN a MHT" %}}
