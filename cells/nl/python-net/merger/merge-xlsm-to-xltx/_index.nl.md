...
description: Aspose Excel. Python Aspose.Cells. Gratis online Samenvoegen XLSM naar XLTX saveformat. Python Combineer het formaat XLSM tot XLTX. Samenvoegen XLSM tot XLTX in Python. XLSM Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u XLSM kunt samenvoegen met XLTX in Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Gratis online om XLSM samen te voegen tot XLTX in Python" InputFormat="xlsm" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSM samen te voegen met XLTX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen tot XLTX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
