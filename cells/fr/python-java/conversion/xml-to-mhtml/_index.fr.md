---
title: Python XML vers MHTML - Convertisseur XML vers MHTML
description: Aspose Excel. Cette solution complète offre aux développeurs Python une approche entièrement intégrée pour convertir le XML au format MHTML, permettant un enregistrement transparent des données XML au format MHTML à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Python efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en MHTML à l\'aide de la bibliothèque Excel Python" %}}

 Comment convertir XML en MHTML ? Avec la bibliothèque Aspose.Cells for Python, vous pouvez facilement convertir XML en MHTML par programme avec quelques lignes de code.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer XML dans MHTML dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment convertir XML en MHTML dans la bibliothèque Excel Python.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XML en MHTML. Téléchargez votre fichier XML, puis enregistrez-le simplement sous le nom de fichier MHTML. Pour la lecture XML et l'écriture MHTML, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie MHTML seront identiques au document XML d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir XML en MHTML via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xml" outformat="mhtml" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XML en MHTML via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en MHTML par programme ? Les développeurs Python peuvent facilement charger et convertir du XML en MHTML en quelques lignes de code seulement.
...
1.  Convertissez XML en MHTML en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de XML en MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Bibliothèque Excel pour convertir XML en MHTML" %}}
