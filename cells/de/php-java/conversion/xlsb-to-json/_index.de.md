...
description: Aspose Excel. Konvertieren Sie XLSB schnell und einfach in JSON mit Aspose.Cells. PHP XLSB in JSON. PHP Speichern Sie XLSB in JSON. Speichern Sie XLSB als JSON mit PHP.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLSB über PHP in JSON" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLSB-Dateien programmgesteuert in JSON konvertieren? PHP-Entwickler können XLSB in nur wenigen Codezeilen problemlos laden und in JSON konvertieren.
...
1.  Konvertieren Sie XLSB in JSON, indem Sie die Speichermethode der Arbeitsmappe aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLSB in JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von XLSB in JSON" %}}
