---
title: Fusionner JSON à XLT - Combiner JSON à XLT dans C++
url: /fr/cpp/merger/merge-json-to-xlt/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion en ligne gratuite JSON au format de sauvegarde XLT. C++ Combinez le format JSON au format XLT. Fusionner JSON à XLT dans C++. JSON Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner JSON à XLT en C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner JSON à XLT dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner JSON à XLT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier XLT. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne JSON à XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner JSON à XLT en C++" InputFormat="json" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner JSON à XLT via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner JSON à XLT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner JSON à XLT" %}}
