...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง ODS เป็น XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xml" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง ODS เป็น XML โดยการเรียกเมธอด Save()
