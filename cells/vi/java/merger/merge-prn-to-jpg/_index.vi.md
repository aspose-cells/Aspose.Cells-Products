---
title: Gộp PRN sang JPG - Gộp PRN sang JPG theo số Java
url: /vi/java/merger/merge-prn-to-jpg/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu PRN sang JPG. Java Kết hợp định dạng PRN sang JPG. Hợp nhất PRN thành JPG theo số Java. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Gộp PRN sang JPG theo số Java" %}}

Ví dụ sau đây minh họa cách hợp nhất PRN sang JPG trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất PRN sang JPG. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu nó vào tệp JPG. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất PRN thành JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu ghép PRN sang JPG số Java" InputFormat="prn" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép PRN sang JPG via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép PRN sang JPG" %}}
