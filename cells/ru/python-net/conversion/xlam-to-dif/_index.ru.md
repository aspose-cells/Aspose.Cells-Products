---
title: XLAM в DIF - Преобразование файлов XLAM в DIF Python via Python
...
{{% blocks/products/pf/agp/content h2="Преобразовать XLAM в DIF в Python" %}}
...
В следующем примере показано, как преобразовать XLAM в DIF в Python via NET.
