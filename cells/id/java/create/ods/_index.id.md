---
title: Buat File ODS (Openoffice/Lbreoffice) via Java
description: ODS pencipta. Buat file ODS dalam kode Java. Hasilkan file ODS (Openoffice / Lbreoffice) menggunakan desktop atau aplikasi web berbasis Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Buat File ODS via Java" h2="Pembuatan spreadsheet asli dan kinerja tinggi ODS (Openoffice / Lbreoffice) secara terprogram menggunakan perpustakaan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Membuat ODS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Kode sumber berikut menunjukkan cara membuat file ODS (Openoffice / Lbreoffice) menggunakan Java." offSpacer="" %}}
