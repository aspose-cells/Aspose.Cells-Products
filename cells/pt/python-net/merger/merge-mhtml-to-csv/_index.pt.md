---
title:  Mesclar MHTML para CSV via Python
url: /pt/python-net/merger/merge-mhtml-to-csv/ 
description: Mesclar MHTML para CSV Online gratuitamente. Online Grátis MHTML a CSV Fusão. Mesclar MHTML para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar MHTML a CSV em Python.
...
{{% cells-merger title="Aplicativo gratuito para mesclar MHTML a CSV on-line" InputFormat="mhtml" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
