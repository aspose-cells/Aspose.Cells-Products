---
title: Java JSON a XLS - JSON a XLS Convertitore
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori Java un approccio completamente integrato per convertire il formato JSON nel formato XLS, consentendo il salvataggio senza interruzioni dei dati JSON nel formato XLS utilizzando la libreria Aspose.Cells, il tutto tramite codice Java efficiente e personalizzabile.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti JSON in XLS in Java" h2="Libreria Java ad alta velocità per convertire JSON in XLS. Si tratta di una soluzione software professionale per importare ed esportare JSON, XLS e molti altri formati utilizzando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salva JSON a XLS in Java" %}}

L'esempio seguente mostra come convertire JSON in XLS in Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire JSON in XLS. Carica il tuo file JSON, quindi salvalo semplicemente come file XLS. Sia per la lettura JSON che per la scrittura XLS è possibile utilizzare nomi di file completi. Il contenuto e la formattazione dell'output XLS saranno identici al documento originale JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Codice di esempio per convertire JSON in XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="json" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Come convertire JSON in XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file JSON in XLS tramite codice? Gli sviluppatori che usano Java possono facilmente convertire JSON in XLS in poche righe di codice.
...
1.  Converti JSON in XLS chiamando il metodo Workbook.save.
1.  Ottieni il risultato della conversione da JSON a XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria Java per convertire JSON in XLS" %}}
{{% blocks/products/pf/agp/text %}}
