...
{{% blocks/products/pf/agp/content h2="Convert OTS to SVG Using Python Excel Library" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTS to SVG in Python Excel Library" %}}

The following example demonstrates how to convert OTS to SVG in Python excel library.
...
{{% blocks/products/pf/agp/content h2="Python Excel Library to Convert OTS to SVG" %}}
