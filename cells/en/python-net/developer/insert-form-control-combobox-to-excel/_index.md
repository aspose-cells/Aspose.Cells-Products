---
title: Insert ComboBox(Form control) into Excel using Python via .Net
weight: 20
...
{{% blocks/products/pf/agp/content h2="How to Insert ComboBox(Form control) into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert ComboBox(Form control) to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_combo_box/#int-int-int-int-int-int) to insert a ComboBox(Form control) in the selected worksheet.
