...
description: Sample C++ conversion code for XLT document to EMF format. Programmers can use this source code for batch XLT to EMF conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLT to EMF C++ Conversion Source Code" offSpacer="" %}}
