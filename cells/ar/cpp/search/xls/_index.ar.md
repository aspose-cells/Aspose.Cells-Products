---
title:  ابحث في وثيقة XLS بدون فتح عن طريق C++
weight: 4560
description: رمز مثال C++ للبحث عن الكلمات ذات النمط في ملف XLS على C++ بيئة وقت التشغيل لـ Windows 32 بت و Windows 64 بت و Linux 64 بت.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ابحث في XLS التنسيقات في C++" h2="بحث عن المستندات XLS أصلي وعالي الأداء باستخدام واجهات برمجة تطبيقات Aspose.Cells for C++ من جانب الخادم ، دون استخدام أي برنامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية البحث عن ملف XLS باستخدام C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث عن ملفات XLS في C++" %}}
...
قم بتحميل ملف XLS عن طريق إنشاء فئة IWorkbook.
...
+ حفظ XLS ملف باستخدام IWorkbook-> طريقة حفظ (.).
...
{{% blocks/products/pf/agp/code-block title="بحث XLS الملفات - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="XLS عبر الإنترنت ابحث في العروض التوضيحية الحية" sectionDescription=" ابحث عن النص والكلمات والعبارات في وثائق XLS الآن من خلال زيارة موقعنا[موقع تجريبي مباشر](https://products.aspose.app/cells/search). يحتوي العرض التوضيحي المباشر على الفوائد التالية" >}}
