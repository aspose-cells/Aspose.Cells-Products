...
Hai bisogno di convertire i file OTS in MHTML tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire OTS in MHTML in poche righe di codice.
...
1.  Convertire OTS in MHTML chiamando il metodo Save().
