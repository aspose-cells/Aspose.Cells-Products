...
Aşağıdaki örnek, EXCEL'in Aspose.Cells for C++'de ETT ile nasıl birleştirileceğini gösterir.
...
EXCEL'i programlı olarak ETT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
