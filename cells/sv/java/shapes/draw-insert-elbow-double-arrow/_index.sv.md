---
title:  Hur man ritar eller infogar armbågsform med dubbelpil i Excel via Java
weight: 30
description: Rita eller infoga armbågsform med dubbelpil med Aspose.Cells' Java API utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Infoga armbågsform med dubbelpil i Excel via Java" h2="Sätt in armbågsdubbelpil med Aspose.Cells\' API utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Så här infogar du en armbåge med dubbelpil i Excel-fil med Java" %}}

 För att infoga armbågsformen dubbelpil i excel-filen använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga armbågsform med dubbelpil i Excel-fil via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd[lägga till metod](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) för att infoga en dubbelpilsform av en armbåge i det valda kalkylbladet
...
{{% blocks/products/pf/agp/code-block title="Sätt in armbågen med dubbelpil - Java" offSpacer="" %}}
