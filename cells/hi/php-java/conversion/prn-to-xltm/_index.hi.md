---
title: PHP PRN से XLTM - PRN से XLTM कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ PRN को जल्दी और आसानी से XLTM में बदलें। PHP PRN को XLTM पर बदलें। PHP PRN को XLTM पर सहेजें। PHP का उपयोग करके PRN को XLTM के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="PHP के माध्यम से PRN को XLTM में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

क्या आपको PRN फ़ाइलों को प्रोग्रामेटिक रूप से XLTM में कनवर्ट करने की आवश्यकता है? PHP डेवलपर्स कोड की कुछ पंक्तियों में आसानी से PRN को XLTM में लोड और परिवर्तित कर सकते हैं।
...
1.  वर्कबुक की सेव विधि को कॉल करके पीआरएन को XLTM में बदलें।
