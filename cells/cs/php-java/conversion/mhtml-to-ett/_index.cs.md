...
description: Aspose Excel. Převeďte MHTML na ETT rychle a snadno pomocí Aspose.Cells. PHP MHTML na ETT. PHP Uložit MHTML do ETT. Uložte MHTML jako ETT pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na ETT přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory na ETT programově? Vývojáři PHP mohou snadno načíst a převést MHTML na ETT v několika řádcích kódu.
...
1.  Převeďte MHTML na ETT voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na ETT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na ETT" %}}
