...
url: /nl/net/merger/merge-xlsx-to-et/ 
...
Het volgende voorbeeld laat zien hoe u XLSX samenvoegt met ET in Aspose.Cells for .NET.
...
{{% cells-merger title="Voorbeeldcode om XLSX samen te voegen met ET in C#" InputFormat="xlsx" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSX samenvoegt met ET via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met ET? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLSX samen te voegen met ET" %}}
