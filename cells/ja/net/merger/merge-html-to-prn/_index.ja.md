---
title: HTML を PRN に結合 - HTML を PRN に結合して C#
url: /ja/net/merger/merge-html-to-prn/ 
description: Aspose エクセル。 C# Aspose.Cells。HTML を PRN 保存形式にマージします。 C# HTML を PRN 形式に結合します。 HTML を C# の PRN にマージします。 HTML をマージします。
...
{{% blocks/products/pf/agp/content h2="HTML を C# の PRN にマージ" %}}

次の例は、HTML を Aspose.Cells for .NET の PRN にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、HTML を PRN にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルを結合し、PRN ファイルに保存します。 C# でコードを開発する場合、これは思っているより簡単です。 HTML を PRN にマージする C# の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="HTML を C# の PRN にマージするサンプルコード" InputFormat="html" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="HTML を経由して PRN に HTML をマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML をプログラムで PRN にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
