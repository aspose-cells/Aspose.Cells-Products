---
title: Konvertor PHP PNG až MHTML - PNG až MHTML
description: Aspose Excel. Převeďte PNG na MHTML rychle a snadno pomocí Aspose.Cells. PHP PNG na MHTML. PHP Uložte PNG na MHTML. Uložte MHTML jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na MHTML přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na MHTML programově? Vývojáři PHP mohou snadno načíst a převést PNG na MHTML v několika řádcích kódu.
...
1.  Převeďte PNG na MHTML voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na MHTML" %}}
