...
description: Aspose Excel. Μετατρέψτε το IMAGE σε POWERPOINT γρήγορα και εύκολα με το Aspose.Cells. Python IMAGE σε POWERPOINT. Python Αποθήκευση ΕΙΚΟΝΑΣ στο POWERPOINT. Αποθηκεύστε το IMAGE ως POWERPOINT χρησιμοποιώντας το Python.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το IMAGE στο POWERPOINT στο Python" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή IMAGE σε POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="pptx" IsLandingPage="true" language="pythonnet" %}}
