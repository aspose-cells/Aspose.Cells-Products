...
1. قم بتضمين مساحة الاسم في ملف الفصل الدراسي الخاص بك1. إنشاء مثيل فئة المصنف.1. قم بالوصول إلى ورقة العمل الأولى من المصنف.1. احصل على الخلية (الخلايا) المطلوبة من ورقة العمل وأدخل القيمة في الخلية (الخلايا).1. استخدم طريقة الحفظ لحفظ المصنف كملف XLTX.
