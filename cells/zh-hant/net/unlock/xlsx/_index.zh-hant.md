---
title: 通過 .NET 解鎖 XLSX 文檔 
weight: 2040
url: /zh-hant/net/unlock/xlsx/ 
description: C# 用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上解鎖受密碼保護的 XLSX 文件的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 解鎖 XLSX 電子表格" h2="使用 .NET 庫從 XLSX 中刪除保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
