...
weight: 1040
description: โค้ดตัวอย่าง Java เพื่อเพิ่มหรือลบลายน้ำไปยังไฟล์ ODS บน Java Runtime Environment สำหรับ JSP/JSF Application และ Desktop Applications
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="เพิ่มลายน้ำข้อความไปที่ ODS via Java" h2="สร้างแอป Java ของคุณเองเพื่อใส่ลายน้ำไฟล์ ODS โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการเพิ่มลายน้ำ ODS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="เพิ่มลายน้ำไปที่ ODS - Java" offSpacer="" %}}
