...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Extrahieren von Metadaten von XLSX über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Metadaten von XLSX extrahieren - Java" offSpacer="" %}}
