...
description: Aspose Excel. C++ Aspose.Cells. Sloučit HTM do formátu uložení SVG. C++ Zkombinujte HTM do formátu SVG. Sloučit HTM na SVG v C++. HTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM na SVG v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení HTM s SVG v C++" InputFormat="htm" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
