---
title: Sloučit IMAGE s NUMBERS – Sloučit IMAGE s NUMBERS v C#
url: /cs/net/merger/merge-image-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Online zdarma Sloučit IMAGE to NUMBERS saveformat. C# Zkombinujte OBRÁZEK s formátem ČÍSLA. Sloučit IMAGE s ČÍSLY v čísle C#. Sloučit IMAGE.
...
{{% blocks/products/pf/agp/content h2="Sloučit IMAGE s ČÍSLY na čísle C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit IMAGE do NUMBERS v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení IMAGE do NUMBERS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru NUMBERS. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí IMAGE do NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení IMAGE s ČÍSLY na čísle C#" InputFormat="png" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit IMAGE do NUMBERS přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit IMAGE s NUMBERS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna pro sloučení IMAGE do NUMBERS" %}}
