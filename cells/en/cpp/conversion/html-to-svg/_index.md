...
description: Sample C++ conversion code for HTML to SVG format. Programmers can use this source code for batch HTML to SVG conversion within any C++ Application.
---
