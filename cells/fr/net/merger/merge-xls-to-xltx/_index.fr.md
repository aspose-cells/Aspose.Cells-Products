...
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite XLS au format de sauvegarde XLTX. C# Combinez le format XLS au format XLTX. Fusionner XLS à XLTX dans C#. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS à XLTX en C# en ligne gratuitement" %}}
...
{{% cells-merger title="Gratuit en ligne pour fusionner XLS à XLTX en C#" InputFormat="xls" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS à XLTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLS à XLTX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner XLS à XLTX" %}}
