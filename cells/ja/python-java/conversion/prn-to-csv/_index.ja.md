...
description: Aspose エクセル。 Aspose.Cells を使用して、PRN を CSV にすばやく簡単に変換します。 Python PRN を CSV に変換します。 Python PRN を CSV に保存します。 Python を使用して、PRN を CSV として保存します。
...
{{< blocks/products/pf/i18n/upper-banner h1="PRN を Python の CSV に変換します" h2="PRN を CSV に変換するための高速 Python ライブラリ。これは、PRN、CSV、および Python を使用する他の多くの形式をインポートおよびエクスポートするためのプロフェッショナル ソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python を使用して PRN を CSV に変換します" %}}
...
{{% blocks/products/pf/agp/content h2="PRN を Python の CSV に保存" %}}

次の例は、PRN を Python の CSV に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、PRN を CSV に変換します。PRN ファイルをアップロードし、CSV ファイルとして保存するだけです。 PRN の読み取りと CSV の書き込みの両方で、完全修飾ファイル名を使用できます。出力 CSV の内容と形式は、元の PRN ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="PRNをCSVに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="csv" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でPRNをCSVに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで PRN ファイルを CSV に変換する必要がありますか? Python 開発者は、わずか数行のコードで PRN を簡単にロードして CSV に変換できます。
...
1.  PRNからCSVへの変換結果を取得します。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PRN を CSV に変換する Python ライブラリ" %}}
