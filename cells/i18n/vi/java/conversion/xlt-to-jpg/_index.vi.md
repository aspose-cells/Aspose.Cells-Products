---
title: Chuyển đổi XLT sang JPG qua Java 
url: /vi/java/conversion/xlt-to-jpg/ 
description: Mã chuyển đổi Java mẫu cho định dạng XLT thành tệp JPG. Người lập trình có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang JPG trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLT sang JPG qua Java" h2="Chuyển đổi XLT sang JPG Java để chuyển đổi một hoặc nhiều trang sang JPG bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLT sang JPG bằng Java" %}}

 Để hiển thị XLT sang JPG, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLT sang JPG qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp XLT sang JPG chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLT với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Truyền đường dẫn đầu ra với phần mở rộng JPG & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp JPG kết quả
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi XLT sang JPG Java" offSpacer="" %}}

```cs
// tải tệp XLT trong một phiên bản của Workbook
Workbook book = new Workbook("template.xlt");
// lưu XLT dưới dạng JPG
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi XLT sang JPG" sectionDescription="[Chuyển đổi XLT sang JPG](https://products.aspose.app/cells/conversion/xlt-to-jpg) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp XLT của bạn, nó sẽ được chuyển đổi ngay lập tức sang JPG." >}}
