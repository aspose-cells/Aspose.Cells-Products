---
title: 通過 C++ 應用程序將 MHTML 轉換為 JPEG 
weight: 820

description: 將 MHTML 文檔轉換為 JPEG 格式的示例 C++。程序員可以使用此源代碼在任何 C++ 應用程序中將 MHTML 批量轉換為 JPEG。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 將 MHTML 轉換為 JPEG" h2="使用 C++ 庫進行高性能 MHTML 到 JPEG 轉換，無需安裝 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 開發人員只需幾行代碼即可輕鬆地將 MHTML 文件轉換為 JPEG。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加載 MHTML 文件。1. 選擇第一個工作表。1. 設置 (JPEG) 選項。1. 遍歷工作表的每一頁並進行渲染。1. 在兼容程序中打開 JPEG 文件。
...
{{% blocks/products/pf/agp/code-block title="MHTML 到 JPEG C++ 轉換源代碼" offSpacer="" %}}
