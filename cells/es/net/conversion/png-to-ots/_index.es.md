---
title: C# PNG a OTS - Convertidor de PNG a OTS
description: Aspose Excel. Convierta PNG a OTS rápida y fácilmente con Aspose.Cells. C# PNG a OTS. C# Guardar PNG en OTS. Guarde PNG como OTS usando C#.
...
{{% blocks/products/pf/agp/content h2="Guardar PNG en OTS en C#" %}}

El siguiente ejemplo demuestra cómo convertir PNG a OTS en C#.
...
{{% cells-convert title="Código de muestra para convertir PNG a OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a OTS a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PNG a OTS mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente PNG a OTS en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para convertir PNG a OTS" %}}
