---
title: Объединить SPREADSHEETML с MHTML - Объединить SPREADSHEETML с MHTML в C++
url: /ru/cpp/merger/merge-spreadsheetml-to-mhtml/ 
description: Aspose Excel. C++ Aspose.Cells. Бесплатное онлайн-слияние SPREADSHEETML в MHTML в сохраненном формате. C++ Объедините SPREADSHEETML в формат MHTML. Объединить SPREADSHEETML с MHTML в C++. Объединить SPREADSHETML.
...
{{% blocks/products/pf/agp/content h2="Объедините SPREADSHEETML в MHTML в C++ онлайн бесплатно" %}}

В следующем примере показано, как объединить SPREADSHEETML с MHTML в Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Выполните простые шаги, чтобы объединить SPREADSHEETML с MHTML. Загрузите свои файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл MHTML. Если вы разрабатываете код в C++, это будет проще, чем кажется. См. пример C++, в котором SPREADSHEETML объединяется с MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Бесплатно онлайн объединить SPREADSHETML в MHTML в C++" InputFormat="xml" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как объединить SPREADSHETML с MHTML через C++" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить SPREADSHETML в MHTML? Базовый документ сливается и объединяется с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="библиотека C++ для слияния SPREADSHETML с MHTML" %}}
