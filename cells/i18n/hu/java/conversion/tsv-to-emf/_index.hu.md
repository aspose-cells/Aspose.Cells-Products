...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása EMF-vé a következővel: Java" %}}

 Ahhoz, hogy a TSV-t EMF-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV-ből EMF-vé konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak TSV-fájlt EMF-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="TSV EMF-re Java Konverziós forráskód" offSpacer="" %}}
