---
title: XLAM na DIF - Převést XLAM na DIF Python via Python
...
{{% blocks/products/pf/agp/content h2="Převeďte XLAM na DIF pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XLAM na DIF v Python.
