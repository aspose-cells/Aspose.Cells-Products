---
title:  Hapus XLSB Anotasi via .NET
weight: 6440
description: Kode sumber C# untuk menambah dan menghapus anotasi format XLSB pada Framework .NET, .NET Core, Mono atau Platform Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tambah atau Hapus Anotasi dari XLSB via C#" h2="Bangun aplikasi .NET Anda sendiri untuk memanipulasi komentar & penulis dalam file dokumen menggunakan API sisi server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Tambah atau Hapus Anotasi dari XLSB via C#" %}}
