...
{{< blocks/products/pf/i18n/upper-banner h1="Převést SXC na HTML pomocí Java" h2="Převod SXC na HTML Java pro převod jedné nebo více stránek do HTML pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC do HTML pomocí Java" %}}

 K vykreslení SXC do HTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na HTML prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SXC do HTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Jako parametry předejte výstupní cestu s rozšířením HTML a SaveFormat1. Zkontrolujte zadanou cestu pro výsledný soubor HTML
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu SXC na HTML Java" offSpacer="" %}}

```cs
// načtěte soubor SXC v instanci sešitu
Workbook book = new Workbook("template.sxc");
// uložit SXC jako HTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze SXC do HTML" sectionDescription="[Převést SXC do HTML](https://products.aspose.app/cells/conversion/sxc-to-html) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor SXC, bude okamžitě převeden do HTML." >}}
