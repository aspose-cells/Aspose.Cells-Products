...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS sang ET trong C++" h2="Chuyển đổi hiệu suất cao từ XLS sang ET bằng thư viện C++ mà không cần cài đặt Excel, OpenOffice hoặc Adobe Acrobat (phiên bản Microsoft)." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Bạn cần chuyển đổi các tệp XLS sang định dạng ET bằng lập trình? Các nhà phát triển C++ có thể dễ dàng chuyển đổi XLS sang ET chỉ với vài dòng mã.
...
1.  Chuyển đổi XLS sang ET bằng cách gọi phương thức Save().
