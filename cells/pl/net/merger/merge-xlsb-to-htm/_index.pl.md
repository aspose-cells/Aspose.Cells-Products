...
Poniższy przykład pokazuje, jak scalić XLSB z HTM w Aspose.Cells for .NET.
...
Chcesz programowo scalić numer XLSB z HTM? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLSB z HTM" %}}
