---
title:  Fusionner MHT avec JSON via Python
url: /fr/python-java/merger/merge-mht-to-json/ 
description: Fusionnez MHT avec JSON en ligne gratuitement. MHT en ligne gratuit à JSON Fusion. Fusionnez MHT avec Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner MHT avec JSON dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner MHT avec JSON en ligne" InputFormat="mht" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
