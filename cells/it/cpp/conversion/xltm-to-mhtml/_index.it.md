---
title: Converti XLTM in MHTML tramite l'applicazione C++ 
url: /it/cpp/conversion/xltm-to-mhtml/ 
description: Esempio di codice di conversione C++ per un documento XLTM in formato MHTML. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLTM a MHTML all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file XLTM in MHTML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLTM usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (MHTML).1. Il file MHTML verrà salvato nel percorso specificato.1. Apri il file MHTML nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLTM a MHTML C++" offSpacer="" %}}
