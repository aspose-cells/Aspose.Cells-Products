---
title: C# CSV 轉 MHT - 在線 CSV 轉 MHT 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 CSV 轉換為 MHT 保存格式。 C# CSV 為 MHT 格式。將 CSV 保存到 MHT C#。
...
{{% blocks/products/pf/agp/content h2="免費在線將 CSV 保存到 C# 中的 MHT" %}}

以下示例演示如何將 CSV 轉換為 C# 中的 MHT。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 CSV 轉換為 MHT。上傳您的 CSV 文件，然後將其保存為 MHT 文件。對於 CSV 讀取和 MHT 寫入，您可以使用完全限定的文件名。輸出的 MHT 內容和格式將與原始 CSV 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 CSV 轉換為 MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 CSV 轉換為 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 CSV 文件轉換為 MHT？ .NET 開發人員只需幾行代碼即可輕鬆加載 CSV 並將其轉換為 MHT。
...
1. 使用工作簿實例加載 CSV 文件。
1. 通過調用 Workbook.Save 方法將 CSV 轉換為 MHT。
1. 獲取CSV到MHT的轉換結果。
