---
title: Voeg XLSX samen met MHTML - Combineer XLSX met MHTML in Java
url: /nl/java/merger/merge-xlsx-to-mhtml/ 
description: Aspose Excel. Java Aspose.Cells. Voeg XLSX samen met het opslagformaat MHTML. Java Combineer het formaat XLSX met MHTML. Voeg XLSX samen met MHTML in Java. XLSX Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSX samen met MHTML in Java" %}}

Het volgende voorbeeld laat zien hoe u XLSX samenvoegt met MHTML in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSX samen te voegen met MHTML. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand MHTML. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld Java waarin XLSX wordt samengevoegd met MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLSX samen te voegen met MHTML in Java" InputFormat="xlsx" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSX samenvoegt met MHTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met MHTML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSX samen te voegen met MHTML" %}}
