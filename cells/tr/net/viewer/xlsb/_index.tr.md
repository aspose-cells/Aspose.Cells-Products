---
title:  Görüntüle XLSB Dosya Biçimleri via .NET
weight: 6260
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSB belgelerini yüklemek, işlemek ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB Dosya Görüntüleyici for .NET" h2="Microsoft Excel veya Office Automation gerektirmeden XLSB gibi Excel ve OpenOffice elektronik tablolarını görüntüleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="XLSB Dosyasını C# Kullanarak Görüntüleme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Görüntüleme Adımları XLSB aracılığıyla C#" %}}
...
1.  XLSB dosyasını Workbook.Save yöntemini kullanarak HTML formatında kaydedin.
...
{{% blocks/products/pf/agp/code-block title="C# XLSB dosyasını görüntülemek için örnek kod" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API, Microsoft Excel formatlarını oluşturmak, düzenlemek, dönüştürmek ve farklı formatlara dönüştürmek için kullanılabilir. Ayrıca, yazılım uygulamalarında kapsamlı çizelgeleme, ölçeklenebilir raporlama ve güvenilir hesaplamalar için kullanılabilir. Aspose.Cells bağımsız bir API'dir ve Microsoft veya OpenOffice gibi herhangi bir yazılım gerektirmez.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Görüntülemek İçin Ücretsiz Uygulama XLSB" sectionDescription=" için canlı demolarımızı kontrol edin[Görüntüle XLSB](https://products.aspose.app/cells/viewer/xlsb) aşağıdaki avantajlarla." >}}
