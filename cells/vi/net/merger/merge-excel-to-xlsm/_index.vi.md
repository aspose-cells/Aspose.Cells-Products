---
title: Gộp EXCEL thành XLSM - Gộp EXCEL thành XLSM vào C#
url: /vi/net/merger/merge-excel-to-xlsm/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất EXCEL thành định dạng lưu XLSM. C# Kết hợp EXCEL thành định dạng XLSM. Hợp nhất EXCEL thành XLSM trong C#. Hợp nhất EXCEL.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất EXCEL thành XLSM trong C#" %}}

Ví dụ sau đây minh họa cách hợp nhất EXCEL thành XLSM trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất EXCEL thành XLSM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu vào tệp XLSM. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất EXCEL thành XLSM.
...
{{% blocks/products/pf/agp/content h2="Cách gộp EXCEL về XLSM qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp EXCEL thành XLSM" %}}
