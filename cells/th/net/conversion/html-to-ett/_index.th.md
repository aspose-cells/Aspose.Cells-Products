...
description: Aspose เอ็กเซล. แปลง HTML เป็น ETT อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C# HTML เป็น ETT C# บันทึก HTML ไปที่ อีทีที. บันทึก HTML เป็น ETT โดยใช้ C#
...
{{% blocks/products/pf/agp/content h2="บันทึก HTML ไปที่ ETT ใน C#" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง HTML เป็น ETT ใน C#
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง HTML เป็น ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="ett" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="C# ไลบรารี่เพื่อแปลง HTML เป็น ETT" %}}
