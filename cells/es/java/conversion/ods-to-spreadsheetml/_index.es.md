---
title: Convierta ODS a SPREADSHEETML a través de Java 

description: Ejemplo de código de conversión Java para formato ODS a archivo SPREADSHEETML. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a SPREADSHEETML dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta ODS a SPREADSHEETML a través de Java" h2="Conversión de ODS a SPREADSHEETML Java para convertir una o varias páginas a SPREADSHEETML utilizando la biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir ODS a SPREADSHEETML usando Java" %}}

 Para convertir ODS en SPREADSHEETML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir ODS a SPREADSHEETML a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo ODS a SPREADSHEETML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo ODS con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión SPREADSHEETML y SaveFormat como parámetros1. Verifique la ruta especificada para el archivo SPREADSHEETML resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de ODS a SPREADSHEETML Java" offSpacer="" %}}

```cs
// cargar el archivo ODS en una instancia de Workbook
Workbook book = new Workbook("template.ods");
// guardar SAO como HOJA DE CÁLCULO ML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de ODS a SPREADSHEETML" sectionDescription="[Convertir ODS a HOJA DE CALCULO ML](https://products.aspose.app/cells/conversion/ods-to-spreadsheetml) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo ODS, se convertirá instantáneamente a SPREADSHEETML." >}}
