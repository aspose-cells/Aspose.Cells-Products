...
description: Aspose Excel。 Python Aspose.Cells。將MHT合併至TSV儲存格式。 Python 將 MHT 合併為 TSV 格式。將 MHT 合併到 Python 中的 TSV。MHT 合併。
...
{{% blocks/products/pf/agp/content h2="使用 Python 將 MHT 合併到 TSV" %}}
...
{{% blocks/products/pf/agp/content h2="將MHT合併到Python中的TSV" %}}

以下範例示範如何將 MHT 合併到 Aspose.Cells for Python via Java 中的 TSV。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 合併到 TSV。上傳文件，呼叫 Workbook.Combine 方法合併文件，然後將其儲存到 TSV 文件。如果您在 Python 中開發程式碼，這會比聽起來更簡單。請參閱 Python 將 MHT 合併為 TSV 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 MHT 合併到 Python 中的 TSV 的範例程式碼" InputFormat="mht" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python 將 MHT 合併到 TSV" %}}
