---
title: Converter JSON para TXT via C#
url: /pt/net/conversion/json-to-txt/
description: Código de exemplo para conversão de json para txt C#. Use API código de exemplo para conversão de arquivos json em lote para txt em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter arquivos JSON em TXT em apenas algumas linhas de código.
