---
title: Převodník PHP MHTML na MD – MHTML na MD
description: Aspose Excel. Převeďte MHTML na MD rychle a snadno pomocí Aspose.Cells. PHP MHTML na MD. PHP Uložit MHTML na MD. Uložte MHTML jako MD pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na MD přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory na MD programově? Vývojáři PHP mohou snadno načíst a převést MHTML na MD v několika řádcích kódu.
...
1.  Převeďte MHTML na MD voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na MD" %}}
