---
title: Voeg FODS samen met POWERPOINT - Combineer FODS met POWERPOINT in C#
url: /nl/net/merger/merge-fods-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Voeg FODS samen naar POWERPOINT-opslagformaat. C# Combineer FODS naar POWERPOINT-formaat. Voeg FODS samen met POWERPOINT in C#. FODS Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg FODS samen met POWERPOINT in C#" %}}

Het volgende voorbeeld laat zien hoe u FODS samenvoegt met POWERPOINT in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om FODS samen te voegen met POWERPOINT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een POWERPOINT-bestand. Als u code ontwikkelt in C#, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C# waarin FODS wordt samengevoegd met POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om FODS samen te voegen met POWERPOINT in C#" InputFormat="fods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u FODS samenvoegt met POWERPOINT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u FODS programmatisch samenvoegen met POWERPOINT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om FODS samen te voegen met POWERPOINT" %}}
