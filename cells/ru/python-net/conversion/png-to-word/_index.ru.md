...
description: Aspose Эксель. Преобразуйте PNG в WORD быстро и легко с помощью Aspose.Cells. Python PNG в WORD. Python Сохранить PNG в WORD. Сохранить PNG как 07611134 81, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразовать PNG в WORD в Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните с PNG по WORD в Python." %}}

В следующем примере показано, как преобразовать PNG в WORD в Python via NET.
