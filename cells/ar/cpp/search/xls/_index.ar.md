---
title:  ابحث عن مستند XLS بدون فتح عبر C++
weight: 4560
description: C++ رمز المثال للبحث عن الكلمات ذات النمط في ملف XLS على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
{{< blocks/products/pf/i18n/upper-banner h1="ابحث عن XLS التنسيقات في C++" h2="بحث أصلي وعالي الأداء في المستندات XLS باستخدام واجهات برمجة التطبيقات Aspose.Cells for C++ من جانب الخادم، دون استخدام أي برنامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث عن الملفات XLS في C++" %}}
...
+ قم بتحميل ملف XLS عن طريق إنشاء فئة Workbook.
...
+ احفظ ملف XLS باستخدام طريقة Workbook::Save(...).
...
{{% blocks/products/pf/agp/code-block title="بحث XLS ملفات - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="عبر الإنترنت XLS بحث العروض الحية" sectionDescription=" ابحث عن النصوص والكلمات والعبارات ضمن XLS مستندًا الآن من خلال زيارة موقعنا[موقع العروض الحية](https://products.aspose.app/cells/search). يتمتع العرض التجريبي المباشر بالمزايا التالية" >}}
