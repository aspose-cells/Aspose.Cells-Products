...
L'esempio seguente mostra come unire SXC in XLSB in Aspose.Cells for .NET.
...
{{% cells-merger title="Codice di esempio per unire SXC a XLSB in C#" InputFormat="sxc" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire SXC a XLSB tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 È necessario unire SXC a XLSB a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Biblioteca .NET da accorpare SXC a XLSB" %}}
