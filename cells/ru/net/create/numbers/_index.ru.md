...
{{% blocks/products/pf/agp/content h2="Как создать цифры в формате C#" %}}
...
1.  Используйте метод Save, чтобы сохранить книгу как файл NUMBERS.

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл NUMBERS в коде C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для создания файла NUMBERS" %}}
