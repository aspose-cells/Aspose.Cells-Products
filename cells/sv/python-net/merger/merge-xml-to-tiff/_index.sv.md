...
url: /sv/python-net/merger/merge-xml-to-tiff/ 
...
Följande exempel visar hur man sammanfogar XML till TIFF i Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Behöver du slå samman XML till TIFF programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API:er kan göras med bara några rader kod.
