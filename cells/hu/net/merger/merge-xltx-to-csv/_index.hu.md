---
title: A XLTX-CSV-es számok egyesítése – a XLTX-es és a CSV-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-xltx-to-csv/ 
description: Aspose Excel. C# Aspose.Cells. A XLTX és a CSV mentési formátum egyesítése. C# A XLTX és a CSV formátum kombinálása. Egyesítse a XLTX-CSV-et a C#-ben. XLTX Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A XLTX és a CSV egyesítése a C#-ben" %}}

A következő példa bemutatja a XLTX és a CSV egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLTX-es és a CSV-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a CSV fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a XLTX és CSV számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a XLTX és CSV közötti egyesítéshez a C#-ben" InputFormat="xltx" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLTX és a CSV egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLTX-et a CSV-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLTX és CSV egyesítéséhez" %}}
