...
description: Sample C++ conversion code for JSON to EMF format. Programmers can use this source code for batch JSON to EMF conversion within any C++ Application.
---
