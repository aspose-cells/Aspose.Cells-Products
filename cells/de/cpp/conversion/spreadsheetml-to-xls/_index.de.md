---
title: Wandeln Sie SPREADSHEETML in XLS über die Anwendung C++ um 

description: Beispiel-Umwandlungscode C++ für das SPREADSHEETML-Dokument in das XLS-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von SPREADSHEETML in XLS in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie SPREADSHEETML in XLS über C++" h2="Leistungsstarke SPREADSHEETML-zu-XLS-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SPREADSHEETML in XLS mit C++" %}}

 Um SPREADSHEETML in XLS zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von SPREADSHEETML in XLS über C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-Entwickler können SPREADSHEETML-Dateien in nur wenigen Codezeilen ganz einfach in XLS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die SPREADSHEETML-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (XLS).1. Die XLS-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die XLS-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML-zu-XLS-C++-Konvertierungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos für die Umwandlung von SPREADSHEETML in XLS" sectionDescription="[Wandeln Sie SPREADSHEETML in XLS um](https://products.aspose.app/cells/conversion/spreadsheetml-to-xls) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre SPREADSHEETML-Datei hoch, sie wird sofort in XLS konvertiert." >}}
