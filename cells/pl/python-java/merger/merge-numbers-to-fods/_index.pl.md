...
description: Aspose Excel. Python Aspose.Cells. Połącz NUMERY, aby zapisać format FODS. Python Połącz NUMERY do formatu FODS. Scal NUMBERS z FODS w Python. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z FODS, używając Python" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z FODS w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia NUMERÓW z FODS w Python" InputFormat="numbers" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć NUMERY z FODS przez Python" %}}
