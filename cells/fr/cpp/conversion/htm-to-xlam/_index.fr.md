---
title: C++ HTM à XLAM - Convertisseur HTM à XLAM
description: Aspose Exceller. Convertissez HTM en XLAM rapidement et facilement avec Aspose.Cells. C++ HTM en XLAM. C++ Enregistrez HTM en XLAM. Enregistrez HTM sous XLAM en utilisant C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au XLAM dans C++" %}}
...
{{% cells-convert title="Exemple de code pour convertir HTM en XLAM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlam" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en XLAM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en XLAM par programme ? Les développeurs C++ peuvent facilement convertir HTM en XLAM en quelques lignes de code seulement.
