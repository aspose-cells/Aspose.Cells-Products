---
title: Scal XLSM z MARKDOWN - Połącz XLSM z MARKDOWN w C++
url: /pl/cpp/merger/merge-xlsm-to-markdown/ 
description: Aspose Excel. C++ Aspose.Cells. Scal XLSM z MARKDOWN w formacie zapisu. C++ Połącz format XLSM z MARKDOWN. Scal XLSM z MARKDOWN w C++. XLSM Scal.
...
{{% blocks/products/pf/agp/content h2="Scal XLSM z MARKDOWN w C++" %}}

Poniższy przykład pokazuje, jak połączyć XLSM z MARKDOWN w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLSM z MARKDOWN. Prześlij swoje pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku MARKDOWN. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy XLSM z MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia XLSM z MARKDOWN w C++" InputFormat="xlsm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSM z MARKDOWN przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć XLSM z MARKDOWN? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
