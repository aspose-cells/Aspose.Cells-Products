---
title: C# XLS till MD - XLS till MD-omvandlare
description: Aspose Excel. Konvertera XLS till MD snabbt och enkelt med Aspose.Cells. C# XLS till MD. C# Spara XLS till MD. Spara XLS som MD med C#.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till MD i C#" %}}

Följande exempel visar hur man konverterar XLS till MD i C#.
...
{{% cells-convert title="Exempelkod för att konvertera XLS till MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till MD programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till MD på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera XLS till MD" %}}
