---
title: Convierta SPREADSHEETML a TXT a través de Python
url: /es/python-java/conversion/spreadsheetml-to-txt/
description: Código de muestra para la conversión de hoja de cálculo a txt Python. Use el código de ejemplo API para archivos de hoja de cálculo por lotes para la conversión de txt dentro de la aplicación Python.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SPREADSHEETML a TXT usando Python" %}}

 Para convertir SPREADSHEETML a TXT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SPREADSHEETML a TXT a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python los desarrolladores pueden cargar y convertir fácilmente archivos SPREADSHEETML a TXT con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo SPREADSHEETML con una instancia de Workbook1. Llame al método Workbook.Save1. Pase la ruta de salida con la extensión TXT como parámetro1. Compruebe la ruta especificada para el archivo TXT resultante
...
{{% cells-convert title="Aplicación gratuita y código de muestra para convertir SPREADSHEETML a TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="txt" IsLandingPage="true" language="python" %}}
