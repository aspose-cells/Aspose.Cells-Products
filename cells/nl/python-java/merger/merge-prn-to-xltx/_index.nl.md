...
description: Aspose Excel. Python Aspose.Cells. PRN samenvoegen naar XLTX opslagformaat. Python Combineer PRN met XLTX-formaat. PRN samenvoegen met XLTX in Python. PRN samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg PRN samen met XLTX in Python" %}}
...
{{% cells-merger title="Voorbeeldcode om PRN samen te voegen met XLTX in Python" InputFormat="prn" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="PRN samenvoegen met XLTX via Python" %}}
