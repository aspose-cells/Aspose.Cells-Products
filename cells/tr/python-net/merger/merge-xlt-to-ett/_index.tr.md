...
description: Aspose Excel'de. Python Aspose.Cells. XLT'i ETT kaydetme biçimiyle birleştirin. Python XLT'i ETT formatıyla birleştirin. XLT'i Python'deki ETT ile birleştirin. XLT Birleştir.
...
{{% cells-merger title="XLT\'i Python\'de ETT ile Birleştirecek Örnek Kod" InputFormat="xlt" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="XLT\'i Python aracılığıyla ETT ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

XLT'i ETT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Python kitaplığı, XLT\'i ETT ile birleştirecek" %}}
