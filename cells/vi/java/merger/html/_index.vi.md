---
title:  Hợp nhất các tập tin HTML via Java
weight: 8830
description: Java mã mẫu để kết hợp các tài liệu HTML trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng HTML trong Java" h2="Hợp nhất tài liệu gốc HTML bằng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để hợp nhất các tệp HTML trong Java" %}}
...
+ Nạp tệp HTML đầu tiên với một thể hiện của lớp Workbook.
+ Nạp tài liệu HTML thứ hai với một thể hiện của lớp Workbook.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp HTML - Java" offSpacer="" %}}
