---
title:  편집 또는 보기 XLSM C++을 통한 문서 메타데이터
weight: 1300
description: C++ Windows 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경에서 XLSM 파일 메타데이터를 편집하거나 보기 위한 예제 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++을 통해 XLSM 메타데이터 추출" h2="서버 측 API를 사용하여 XLSM 파일에서 메타데이터를 추가, 편집, 제거 또는 추출하기 위한 고유한 C++ 앱을 빌드하십시오." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLSM 파일이 수신, 처리, 타임스탬프 등을 포함한 XLSM 파일에 저장된 유용한 정보에 액세스합니다.
