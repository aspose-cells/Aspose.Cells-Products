...
{{% blocks/products/pf/agp/content h2="Как вставить TextBox в файл Excel, используя Python via .Net" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте добавление коллекции форм[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_text_box/#int-int-int-int-int-int) чтобы вставить TextBox в выбранный рабочий лист.
