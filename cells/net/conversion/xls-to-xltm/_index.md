...
description: Sample code for XLS to XLTM C# conversion. Use API example code for batch XLS files to XLTM conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert XLS files to XLTM in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XLS to XLTM C# Conversion" offSpacer="" %}}

```cs
// load the XLS file in an instance of Workbook
var book = new Workbook("template.xls");
// save XLS as XLTM
