---
title: CSV から JSON を結合 - CSV から JSON を Python に結合
url: /ja/python-java/merger/merge-csv-to-json/ 
description: Aspose エクセル。 Python Aspose.Cells。CSV を JSON の保存形式にマージします。 Python CSV と JSON の形式を結合します。 CSV から JSON を Python に結合します。CSV を結合します。
...
次の例は、CSV を Aspose.Cells for Python via Java の JSON にマージする方法を示しています。
...
{{% cells-merger title="CSV から JSON を Python にマージするサンプルコード" InputFormat="csv" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="CSV を Python 経由で JSON に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

CSV をプログラムで JSON にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実行できます。
