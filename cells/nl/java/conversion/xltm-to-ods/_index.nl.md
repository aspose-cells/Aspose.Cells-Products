...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in ODS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar ODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLTM om naar ODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLTM programmatisch converteren naar ODS? Ontwikkelaars van Java kunnen bestanden met de extensie XLTM eenvoudig converteren naar ODS met slechts een paar regels code.
