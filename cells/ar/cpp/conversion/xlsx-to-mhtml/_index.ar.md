---
title: تحويل XLSX إلى MHTML عبر تطبيق C++ 
weight: 4120
url: /ar/cpp/conversion/xlsx-to-mhtml/ 
description: نموذج C++ رمز تحويل لمستند XLSX إلى تنسيق MHTML. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLSX إلى MHTML في أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLSX إلى MHTML عبر C++" h2="تحويل XLSX إلى MHTML عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSX إلى MHTML باستخدام C++" %}}
 ...
 من أجل تحويل XLSX إلى MHTML ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ تحويل ملف XLSX بسهولة إلى MHTML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLSX باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (MHTML).1. سيتم حفظ ملف MHTML في المسار المحدد.1. افتح ملف MHTML في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLSX إلى MHTML C++ شفرة مصدر التحويل" offSpacer="" %}}
