---
title: C++ Convertisseur HTM vers MD
description: Aspose Excel. Cette solution complète offre aux développeurs C++ une approche entièrement intégrée pour convertir le format HTM au format MD, permettant un enregistrement transparent des données HTM au format MD à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C++ efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en MD dans C++" h2="Conversion HTM vers MD haute performance utilisant la bibliothèque C++ sans avoir besoin de l\'installation d\'Excel, d\'OpenOffice ou d\'Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM en MD dans C++" %}}

L'exemple suivant montre comment convertir HTM en MD dans C++.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier HTM en MD. Téléchargez votre fichier HTM, puis enregistrez-le au format MD. Vous pouvez utiliser des noms de fichiers complets pour la lecture des fichiers HTM et l'écriture des fichiers MD. Le contenu et la mise en forme du fichier MD généré seront identiques à ceux du document HTM original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir du HTM en MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="md" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir un fichier HTM en MD via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en MD par programmation ? Les développeurs de C++ peuvent facilement convertir des fichiers HTM en MD en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en MD en appelant la méthode Save().
