...
description: Aspose เอ็กเซล. Python Aspose.Cells รวม XLS ลงในเซฟฟอร์แมต JPG Python รวม XLS เป็นรูปแบบ JPG รวม XLS เป็น JPG ใน Python XLS รวม
...
{{% blocks/products/pf/agp/content h2="วิธีรวม XLS เป็น JPG ผ่าน Python" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการรวม XLS เข้ากับ JPG โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="Python ไลบรารี่เพื่อรวม XLS เป็น JPG" %}}
