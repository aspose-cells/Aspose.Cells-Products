---
title: C# OTS zu ODS - Online OTS zu ODS Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# OTS in ODS Saveformat konvertieren. C# OTS zum ODS-Format. Speichern Sie OTS unter ODS C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter ODS in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie OTS in C# in ODS konvertiert wird.
...
Müssen Sie OTS-Dateien programmgesteuert in ODS konvertieren? .NET-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in ODS konvertieren.
...
1.  Konvertieren Sie OTS in ODS, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von OTS in ODS" %}}
