...
description: Aspose Эксель. C++ Создайте файл XLAM быстро и легко с помощью Aspose.Cells. Создайте файл XLAM с помощью C++. Создайте XLAM в C++. C++ XLAM Creater.
...
1.  Сохраните книгу как файл .xlam, используя метод Save().
