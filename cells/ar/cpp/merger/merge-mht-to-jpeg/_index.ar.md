---
title: دمج MHT في JPEG - ادمج MHT مع JPEG في C++
url: /ar/cpp/merger/merge-mht-to-jpeg/ 
description: Aspose إكسل. C++ Aspose.Cells. دمج MHT عبر الإنترنت مجانًا إلى تنسيق حفظ JPEG. C++ ادمج MHT مع تنسيق JPEG. دمج MHT في JPEG في C++. MHT Merge.
...
{{% blocks/products/pf/agp/content h2="قم بدمج MHT في JPEG في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج MHT مع JPEG في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج MHT في JPEG. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف JPEG. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج MHT مع JPEG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج MHT في JPEG في C++" InputFormat="mht" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج MHT مع JPEG عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج MHT في JPEG برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج MHT إلى JPEG" %}}
