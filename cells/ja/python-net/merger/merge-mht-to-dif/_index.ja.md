...
次の例は、MHT を Aspose.Cells for Python via .NET の DIF にマージする方法を示しています。
...
プログラムで MHT を DIF にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
