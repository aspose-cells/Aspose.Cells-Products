...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 A Byte Array hasznos az adatfeldolgozáshoz vagy -tároláshoz. Az XLSX fájlokat Byte Array-vé, valamint a **Byte Array-t XLSX** dokumentummá konvertálhatja a C# nyelv használatával. Az XLSX bájttömbbé alakításához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSX konvertálása bájttömbbé a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A fejlesztők egyszerűen csak néhány sornyi kóddal tölthetik be és konvertálhatják az XLSX fájlokat bájttömbbe a további manipulációs feladatokhoz.

{{% /blocks/products/pf/agp/text %}}

1. Szerelje be a névteret az osztályfájlba1. Töltse be a bemeneti XLSX fájlt a munkafüzet segítségével1. Inicializálja a MemoryStream objektumot1. Az adatfolyamadatok konvertálása bájttömbbé1. Az adatokat igény szerint dolgozza fel
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód XLSX-ből bájttömbbe C# konverziót mutat" offSpacer="" %}}
...
Egy Excel táblázatkezelő programkönyvtár, amely képes többplatformos alkalmazások létrehozására, amelyek képesek az összes Excel fájl létrehozására, módosítására, konvertálására, renderelésére és nyomtatására. .NETAz Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat, köztük XLSX-fájlokat is képes megjeleníteni képként, PDF-ként, HTML-ként, ODS-ként stb., így tökéletes választás az iparági szabványos formátumú dokumentumok cseréjéhez.
