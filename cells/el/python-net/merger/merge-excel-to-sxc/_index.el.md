...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση του EXCEL σε SXC saveformat. Python Συνδυάστε τη μορφή EXCEL σε SXC. Συγχώνευση του EXCEL στο SXC στο Python. Συγχώνευση EXCEL.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση του EXCEL στο SXC στο Python" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση του EXCEL στο SXC στο Python" InputFormat="xlsx" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
