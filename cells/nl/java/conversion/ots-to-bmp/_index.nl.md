...
{{% blocks/products/pf/agp/content h2="Sla OTS op in BMP in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar BMP converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar BMP via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar BMP? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar BMP met slechts een paar regels code.
