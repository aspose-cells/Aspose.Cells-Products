---
title: Insérer le bouton (contrôle de formulaire) dans Excel en utilisant Python via java
weight: 200
description: Python via code source Java pour insérer le bouton (contrôle de formulaire) dans Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérer le bouton (contrôle de formulaire) dans Excel en utilisant Python via java" h2="Insérez des objets à l\'aide d\'API côté serveur sans aucun logiciel comme Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment insérer un bouton (contrôle de formulaire) dans un fichier Excel à l\'aide de Python via java" %}}
 ...
 Afin d'insérer Button (Contrôle de formulaire) dans un fichier Excel, nous utiliserons
 [Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells/) 
API qui est une manipulation de documents riche en fonctionnalités, puissante et facile à utiliser API pour python via la plate-forme Java. Le API fournit la création, la manipulation, la conversion et le rendu de fichiers Excel. Le tout sans compter sur les applications Microsoft Office ou Excel. Vous pouvez installer à partir de la console à l'aide de la commande suivante.
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)pour insérer un bouton (contrôle de formulaire) dans la feuille de calcul sélectionnée.
...
-  Tout système d'exploitation pouvant exécuter Python via des scripts Java, tels que Windows, Linux et MacOS
