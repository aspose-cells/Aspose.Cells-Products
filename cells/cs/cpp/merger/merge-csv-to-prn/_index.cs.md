...
url: /cs/cpp/merger/merge-csv-to-prn/ 
...
Následující příklad ukazuje, jak sloučit CSV do PRN v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení CSV do PRN v C++" InputFormat="csv" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV do PRN přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit CSV s PRN programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení CSV do PRN" %}}
