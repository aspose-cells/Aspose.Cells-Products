...
{{% cells-merger title="แอพฟรีที่จะรวม JSON เข้ากับ POWERPOINT ในบรรทัด" InputFormat="json" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2="ไลบรารี .NET เพื่อรวม JSON เข้ากับ POWERPOINT" %}}
