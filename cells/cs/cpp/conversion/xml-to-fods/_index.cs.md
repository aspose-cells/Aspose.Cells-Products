...
description: Aspose Excel. Převeďte XML na FODS rychle a snadno pomocí Aspose.Cells. C++ XML na FODS. C++ Uložte XML na FODS. Uložte XML jako FODS pomocí 0716183
...
{{% blocks/products/pf/agp/content h2="Převeďte XML na FODS pomocí C++" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte XML na FODS v C++" %}}

Následující příklad ukazuje, jak převést XML na FODS v C++.
...
Potřebujete převést soubory XML na FODS programově? Vývojáři C++ mohou snadno převést XML na FODS pomocí několika řádků kódu.
