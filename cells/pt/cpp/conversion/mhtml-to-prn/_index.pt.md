...
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter MHTML para o formato PRN, permitindo o salvamento perfeito de dados MHTML no formato PRN usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Converter MHTML para PRN usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve MHTML para PRN em C++" %}}
...
Precisa converter arquivos MHTML para PRN programaticamente? Desenvolvedores que trabalham com C++ podem converter facilmente arquivos MHTML para PRN com apenas algumas linhas de código.
...
1.  Converta MHTML para PRN chamando o método Save().
