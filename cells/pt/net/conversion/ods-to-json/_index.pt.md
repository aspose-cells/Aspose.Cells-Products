---
title: C# ODS a JSON - ODS a JSON Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato JSON, permitindo o salvamento perfeito de dados ODS no formato JSON usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a JSON em C#" %}}

exemplo a seguir demonstra como converter ODS em JSON em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter ODS em JSON por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em JSON programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em JSON em apenas algumas linhas de código.
...
1.  Converta ODS para JSON chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em JSON" %}}
