---
title: Tìm kiếm và thay thế văn bản trong tài liệu XLS qua .NET 
weight: 7280
url: /vi/net/redaction/xls/ 
description: C# mã nguồn để biên tập lại thông tin nhạy cảm trong tệp XLS trên Nền tảng .NET Framework, .NET Core Mono hoặc Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Redact XLS Định dạng trong C#" h2="Thông tin phản hồi nhạy cảm với tài liệu XLS gốc và hiệu suất cao bằng cách sử dụng Aspose.Cells for .NET API phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
