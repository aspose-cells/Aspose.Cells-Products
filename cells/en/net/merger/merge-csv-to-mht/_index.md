...
{{% blocks/products/pf/agp/content h2="How to Merge CSV to MHT File Using C#" %}}
 ...
 In order to merge CSV to MHT file, we will use [Aspose.Cells for .NET](https://products.aspose.com/cells/net) API which is a feature-rich, powerful and easy to use document manipulation and merging API for C# platform. 
...
{{% cells-merger title="Free App to merge Excel files on line" InputFormat="csv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
