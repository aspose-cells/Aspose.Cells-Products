---
title: XLS dokumentum keresése megnyitás nélkül a C++-en keresztül
weight: 4560
description: C++ példakód a XLS fájlban található mintával rendelkező szavak kereséséhez a C++ futási környezetében Windows 32 bites, Windows 64 bites és Linux 64 bites rendszerekhez.
...
{{% blocks/products/pf/agp/content h2="Hogyan kereshetünk XLS fájlban a C++ cím használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a XLS-es fájlok kereséséhez a C++-es mappában" %}}
...
+ Töltsd be a XLS fájlt a Workbook osztály használatával.
