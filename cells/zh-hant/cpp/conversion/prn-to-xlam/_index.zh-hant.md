...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 PRN 轉換為 XLAM。C++ PRN 為 XLAM。C++ 將 PRN 儲存為 XLAM。C++ 將 PRN 儲存為 XLAM。C++ 將 PRN 儲存為 XLAM。C++ 將 PRN 儲存為 XLAM。
...
{{% blocks/products/pf/agp/content h2="將 PRN 保存到 C++ 中的 XLAM" %}}

以下範例示範如何將 C++ 中的 PRN 轉換為 XLAM。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 PRN 轉換為 XLAM。上傳您的 PRN 文件，然後只需將其另存為 XLAM 文件。對於 PRN 讀取和 XLAM 寫入，您可以使用完全限定的檔案名稱。輸出 XLAM 內容和格式將與原始 PRN 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 PRN 轉換為 XLAM 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlam" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 PRN 轉換為 XLAM" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 PRN 檔案轉換為 XLAM？ C++ 開發人員只需幾行程式碼即可輕鬆將 PRN 轉換為 XLAM。
...
1. 使用工作簿載入 PRN 檔案。
1. 透過呼叫 Save() 方法將 PRN 轉換為 XLAM。
1. 取得PRN到XLAM的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++庫將PRN轉換為XLAM" %}}
