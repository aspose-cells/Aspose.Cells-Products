...
{{% blocks/products/pf/agp/content h2="Преобразовать SPREADSHEETML в XLAM, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните файл SPREADSHEETML в формате XLAM в переменной Java." %}}

Следующий пример демонстрирует, как преобразовать SPREADSHEETML в формат XLAM в формате Java.
...
Нужно программно преобразовать файлы SPREADSHEETML в формат XLAM? Разработчики, использующие формат Java, могут легко преобразовать SPREADSHEETML в формат XLAM всего несколькими строками кода.
