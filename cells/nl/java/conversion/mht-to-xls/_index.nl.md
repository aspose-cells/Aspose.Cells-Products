---
title: Java MHT naar XLS - MHT naar XLS Converter
description: Aspose Excel. Converteer MHT snel en eenvoudig naar XLS met Aspose.Cells. Java MHT naar XLS. Java Bewaar MHT naar XLS. Sla MHT op als XLS met Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MHT naar XLS in Java" h2="Snelle Java-bibliotheek voor het converteren van MHT naar XLS. Dit is een professionele softwareoplossing voor het importeren en exporteren van MHT, XLS en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Bewaar MHT op XLS in Java" %}}

In het volgende voorbeeld ziet u hoe u MHT converteert naar XLS in Java.
...
{{% blocks/products/pf/agp/content h2="MHT converteren naar XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHT-bestanden programmatisch naar XLS converteren? Java-ontwikkelaars kunnen MHT eenvoudig met slechts een paar regels code naar XLS converteren.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om MHT naar XLS te converteren" %}}
{{% blocks/products/pf/agp/text %}}
