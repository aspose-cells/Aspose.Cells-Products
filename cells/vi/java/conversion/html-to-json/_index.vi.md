---
title: Java HTML sang JSON - HTML sang JSON Bộ chuyển đổi
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển Java một phương pháp tích hợp đầy đủ để chuyển đổi định dạng HTML sang định dạng JSON, cho phép lưu dữ liệu HTML một cách liền mạch vào định dạng JSON bằng cách sử dụng thư viện Aspose.Cells, tất cả thông qua mã Java hiệu quả và có thể tùy chỉnh.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi HTML thành JSON trong Java" h2="Thư viện tốc độ cao Java dùng để chuyển đổi HTML sang JSON. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất HTML, JSON và nhiều định dạng khác bằng cách sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu mã số HTML vào JSON trong mã số Java." %}}

Ví dụ sau đây minh họa cách chuyển đổi HTML thành JSON trong Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để chuyển đổi HTML thành JSON. Tải lên tệp HTML của bạn, sau đó chỉ cần lưu nó dưới dạng tệp JSON. Đối với cả việc đọc HTML và ghi JSON, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng JSON đầu ra sẽ giống hệt với tài liệu HTML gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ví dụ mã để chuyển đổi HTML thành JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi HTML thành JSON hoặc via Java" %}}

{{% blocks/products/pf/agp/text %}}

Bạn cần chuyển đổi tệp HTML sang JSON bằng lập trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi HTML sang JSON chỉ với vài dòng mã.
...
1.  Chuyển đổi HTML thành JSON bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi từ HTML thành JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện Java chuyển đổi HTML thành JSON" %}}
{{% blocks/products/pf/agp/text %}}
