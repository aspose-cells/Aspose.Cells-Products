---
title: C++ IMAGE na XLSB - Online IMAGE na XLSB převodník
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Online zdarma C++ Převést OBRÁZEK do formátu uložení XLSB. C++ IMAGE do formátu XLSB. Uložit IMAGE na XLSB C++.
...
{{% blocks/products/pf/agp/content h2="Uložit IMAGE na XLSB v C++ Online zdarma" %}}

Následující příklad ukazuje, jak převést IMAGE na XLSB v C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést IMAGE na XLSB přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory IMAGE na XLSB programově? C++ vývojáři mohou snadno převést IMAGE na XLSB v několika řádcích kódu.
...
1.  Převeďte IMAGE na XLSB voláním metody Save().
1.  Získejte výsledek převodu IMAGE na XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod IMAGE na XLSB" %}}
