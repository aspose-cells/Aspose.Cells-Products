...
È necessario convertire i file PRN in TIFF a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in TIFF in poche righe di codice.
...
1.  Converti PRN in TIFF chiamando il metodo Save().
