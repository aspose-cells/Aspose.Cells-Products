---
title: Sloučit PRN do EXCELu – Sloučit PRN do EXCELu v C++
url: /cs/cpp/merger/merge-prn-to-excel/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit PRN do formátu uložení EXCEL. C++ Kombinujte PRN s formátem EXCEL. Sloučit PRN do EXCELu v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN do EXCELu v C++" %}}

Následující příklad ukazuje, jak sloučit PRN do EXCELu v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do EXCELu. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru EXCEL. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí PRN do EXCELu.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení PRN do EXCELu v C++" InputFormat="prn" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN do EXCELu přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit PRN do EXCELu? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení PRN do EXCELu" %}}
