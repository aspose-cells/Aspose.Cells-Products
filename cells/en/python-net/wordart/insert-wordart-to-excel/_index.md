...
{{% blocks/products/pf/agp/content h2="How to Insert WordArt into Excel File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert WordArt to Excel file via Python" %}}
...
+  Use the shapecollection's add method to insert a WordArt in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert WordArt - Python" offSpacer="" %}}
