---
title: Mesclar XLSB para TABDELIMITED - Combinar XLSB para TABDELIMITED em C#
url: /pt/net/merger/merge-xlsb-to-tabdelimited/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita XLSB para o formato de salvamento TABDELIMITED. C# Combine XLSB para o formato TABDELIMITED. Mesclar XLSB para TABDELIMITED em C#. XLSB Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLSB para TABDELIMITED em C# Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar XLSB com TABDELIMITED em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLSB com TABDELIMITED. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo TABDELIMITED. Se você desenvolver código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla XLSB com TABDELIMITED.
...
{{% blocks/products/pf/agp/content h2="Como mesclar XLSB para TABDELIMITED via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLSB para TABDELIMITED programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLSB para TABDELIMITED" %}}
