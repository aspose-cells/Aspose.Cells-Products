...
weight: 8210
description: Código de amostra Java para combinar documentos XLTM no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
---
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de fusão on-line XLTM" sectionDescription=" Mesclar documentos XLTM agora mesmo visitando nosso[Site de demonstrações ao vivo](https://products.aspose.app/cells/merger). A demonstração ao vivo tem os seguintes benefícios" >}}
