...
{{% blocks/products/pf/agp/content h2="Zapisz XML do JSON w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na JSON w C#.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na JSON przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować XML na JSON w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XML na JSON" %}}
