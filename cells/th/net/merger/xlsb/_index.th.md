---
title:  รวม XLSB ไฟล์ via .NET
weight: 2970
description: ซอร์สโค้ด C# เพื่อรวมเอกสาร XLSB บน .NET Framework, .NET Core, Mono หรือแพลตฟอร์ม Xamarin
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="รวมรูปแบบ XLSB ใน C#" h2="การรวมเอกสารแบบเนทีฟและประสิทธิภาพสูง XLSB โดยใช้ฝั่งเซิร์ฟเวอร์ Aspose.Cells for .NET API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการรวมไฟล์ XLSB ใน C#" %}}
...
+ โหลดไฟล์ XLSB ทั้งหมดด้วยเส้นทางแบบเต็ม
+ สร้างเอกสารหนึ่งฉบับเป็นไฟล์ฐาน
+ เรียกใช้วิธีการที่เกี่ยวข้องสำหรับการต่อและรวมไฟล์ทีละไฟล์
+ เรียกใช้เมธอด Save() และส่งชื่อไฟล์ (พาธเต็ม) และรูปแบบ (XLSB) เป็นพารามิเตอร์
...
{{% blocks/products/pf/agp/code-block title="ผสาน XLSB ไฟล์ - C#" offSpacer="" %}}
