---
title: Połącz XLSB z XLSB - Połącz XLSB z XLSB w Python
url: /pl/python-java/merger/merge-xlsb-to-xlsb/ 
description: Aspose Excel. Python Aspose.Cells. Bezpłatne scalanie online XLSB do XLSB w formacie zapisu. Python Połącz format XLSB z XLSB. Połącz XLSB z XLSB w Python. XLSB Połącz.
...
{{% cells-merger title="Bezpłatne połączenie online XLSB z XLSB w Python" InputFormat="xlsb" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSB z XLSB za pośrednictwem Python" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLSB z XLSB programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
