...
url: /es/cpp/merger/merge-jpg-to-tiff/ 
...
El siguiente ejemplo muestra cómo fusionar JPG a TIFF en Aspose.Cells for C++.
...
¿Necesita fusionar JPG con TIFF mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para fusionar JPG a TIFF" %}}
