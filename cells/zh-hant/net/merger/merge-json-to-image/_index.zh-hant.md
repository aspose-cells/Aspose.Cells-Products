...
description: Aspose Excel。 C# Aspose.Cells。免費在線合併 JSON 到 IMAGE 保存格式。 C# 將 JSON 合併為 IMAGE 格式。將 JSON 合併到 C# 中的 IMAGE。 JSON 合併。
...
{{% blocks/products/pf/agp/content h2="免費在線將 JSON 合併為 C# 中的 IMAGE" %}}

以下示例演示如何將 JSON 合併到 Aspose.Cells for .NET 中的 IMAGE。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 JSON 合併到 IMAGE。上傳文件，調用Workbook.Combine方法合併文件，然後保存為IMAGE文件。如果您在 C# 中開發代碼，這會比聽起來更簡單。請參閱 C# 將 JSON 合併到 IMAGE 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將 JSON 合併到 C# 中的 IMAGE" InputFormat="json" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 JSON 合併到 IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 JSON 合併到 IMAGE 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
