---
title: Converter XLS para XLTM por meio do aplicativo C++ 
weight: 2890
url: /pt/cpp/conversion/xls-to-xltm/ 
description: Exemplo de código de conversão C++ de documento XLS para formato XLTM. Os programadores podem usar esse código-fonte para conversão em lote de XLS para XLTM em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/content h2="Como converter XLS para XLTM usando C++" %}}

 Para converter XLS para XLTM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter XLS para XLTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem facilmente converter arquivos XLS para XLTM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLS usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (XLTM).1. O arquivo XLTM será salvo no caminho especificado.1. Abra o arquivo XLTM em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLS para XLTM C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de XLS para XLTM" sectionDescription="[Converter XLS para XLTM](https://products.aspose.app/cells/conversion/xls-to-xltm) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo XLS, ele será convertido instantaneamente para XLTM." >}}
