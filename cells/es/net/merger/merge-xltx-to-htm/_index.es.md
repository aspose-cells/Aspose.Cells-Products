---
title: Combinar XLTX a HTM - Combinar XLTX a HTM en C#
url: /es/net/merger/merge-xltx-to-htm/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea XLTX para guardar formato HTM. C# Combine XLTX en formato HTM. Combinar XLTX a HTM en C#. XLTX Combinar.
...
El siguiente ejemplo muestra cómo combinar XLTX con HTM en Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis en línea para fusionar XLTX a HTM en C#" InputFormat="xltx" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLTX a HTM a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar XLTX con HTM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
