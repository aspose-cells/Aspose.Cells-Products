...
{{% blocks/products/pf/agp/content h2="Hur man konverterar TAL till DIF med Java" %}}

 För att rendera NUMBERS till DIF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera TAL till DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera NUMBERS-filen till DIF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda NUMBERS-filen med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med DIF-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande DIF-filen
...
{{% blocks/products/pf/agp/code-block title="NUMBERS till DIF Java Källkod för omvandling" offSpacer="" %}}

```cs
// ladda NUMBERS-filen i en instans av Workbook
Workbook book = new Workbook("template.numbers");
// spara NUMBERS som DIF
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS till DIF Live Demos" sectionDescription="[Konvertera NUMBERS till DIF](https://products.aspose.app/cells/conversion/numbers-to-dif) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din NUMBERS-fil, den kommer omedelbart att konverteras till DIF." >}}
