---
title: BMP oluştur - Java'de BMP dosyası oluştur
description: Aspose excel. Java BMP Dosyası Oluştur. Oluştur BMP Java. Java BMP Oluşturan. Java'de BMP oluşturun. Java'i kullanarak BMP dosyasını oluşturun.
...
{{% blocks/products/pf/agp/content h2="Java\'de BMP Nasıl Oluşturulur" %}}
...
1.  Çalışma kitabını save() yöntemini kullanarak BMP biçiminde kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, Java\'de BMP dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="BMP dosyası oluşturmak için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
