---
title:  Συγχώνευση PRN στο XLSX μέσω C++
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN στο XLSX στο C++.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση του PRN με το XLSX σε απευθείας σύνδεση" InputFormat="prn" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
