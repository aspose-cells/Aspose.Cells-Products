...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar XLTM in Python" %}}
...
Het volgende voorbeeld laat zien hoe u OTS converteert naar XLTM in Python via NET.
...
{{% blocks/products/pf/agp/content h2="OTS converteren naar XLTM" %}}
