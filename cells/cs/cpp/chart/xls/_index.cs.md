---
title: Graf dokumentu XLS prostřednictvím C++ 
weight: 2500
url: /cs/cpp/chart/xls/ 
description: C++ ukázkový kód pro kreslení a převod grafu nebo diagramu v souboru XLS v C++ Runtime Environment pro Windows 32bit, Windows 64bit a Linux 64bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Grafy formátů XLS v C++" h2="Nativní a vysoce výkonné grafy dokumentů XLS využívající rozhraní API Aspose.Cells na straně serveru pro C++ bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit grafy souborů XLS pomocí C++" %}}
 ...
 Abychom prohledali soubor XLS, použijeme
