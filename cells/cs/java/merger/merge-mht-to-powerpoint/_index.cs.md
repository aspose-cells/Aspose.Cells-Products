---
title: Sloučit MHT s POWERPOINT – Zkombinujte MHT s POWERPOINT v Java
url: /cs/java/merger/merge-mht-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení POWERPOINT. Java Kombinujte formát MHT s formátem POWERPOINT. Sloučit MHT do POWERPOINT v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do POWERPOINT v Java" %}}

Následující příklad ukazuje, jak sloučit MHT do POWERPOINT v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT s POWERPOINT. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru POWERPOINT. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT do POWERPOINT v Java" InputFormat="mht" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT do POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit MHT do POWERPOINT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovnu pro sloučení MHT s POWERPOINT" %}}
