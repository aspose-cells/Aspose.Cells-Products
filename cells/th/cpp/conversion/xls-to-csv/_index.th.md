...
ต้องการแปลงไฟล์ XLS เป็น CSV โดยใช้โปรแกรมหรือไม่? นักพัฒนา C++ สามารถแปลง XLS เป็น CSV ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงค่า XLS เป็น CSV โดยเรียกใช้เมธอด Save()
