---
title:  Объединить SPREADSHETML в PPTX через C++
...
В следующем примере показано, как объединить SPREADSHEETML с PPTX в C++.
