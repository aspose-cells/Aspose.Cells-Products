---
title:  삽입 엑셀에 별/배너 삽입 via Java
weight: 381
description: Microsoft이나 Open Office, Adobe PDF 등의 소프트웨어 없이 Aspose.Cells' Java API을 사용하여 별/배너 삽입
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="삽입 엑셀에 별/배너 삽입 via Java" h2="Microsoft이나 Open Office, Adobe PDF 등의 소프트웨어 없이 Aspose.Cells\' API을 사용하여 별/배너 삽입" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 Excel 파일에 별/배너 삽입 방법" %}}

 별/배너 삽입을 엑셀 파일에 삽입하기 위해
...
{{% blocks/products/pf/agp/feature-section-col title="엑셀 파일에 별/배너 삽입 방법 via Java" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 + 사용[메소드 추가](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) 선택한 워크시트에 별/배너 삽입하기
...
아래 샘플 코드는 "Ribbon: Curved and Tilted Up"과 "Explosion: 8 Points"를 삽입하는 방법을 보여줍니다. 더 많은 유형은 아래의 "별 및 배너 삽입 유형 개요"를 참조하십시오.

{{% blocks/products/pf/agp/code-block title="삽입 삽입 별/배너 - Java" offSpacer="" %}}
