---
title: 創建GIF - 在Java中創建GIF文件
description: Aspose Excel。 Java 創建 GIF 文件。創建GIF Java。Java GIF創建者。在Java中創建GIF。使用Java生成GIF文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建GIF" %}}
...
1. 使用 save() 方法將工作簿保存為 GIF 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 GIF 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建GIF文件" %}}
{{% blocks/products/pf/agp/text %}}
