...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in WORD in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar WORD in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar WORD of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar WORD? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar WORD met slechts een paar regels code.
