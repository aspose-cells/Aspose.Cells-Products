...
description: Aspose اكسل. Python اكسل. قم بتحويل XLTX إلى OTS بسرعة وسهولة باستخدام Aspose.Cells. Python XLTX إلى OTS. Python احفظ XLTX إلى OTS. احفظ XLTX كـ OTS باستخدام مكتبة Excel Python.
