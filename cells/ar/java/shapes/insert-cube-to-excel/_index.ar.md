---
title:  أدخل المكعب في Excel via Java
weight: 20
...
{{< blocks/products/pf/i18n/upper-banner h1="أدخل المكعب في Excel via Java" h2="أدخل Cube باستخدام Aspose.Cells \'API دون أي برنامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج المكعب في ملف Excel باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج Cube في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) لإدراج مكعب في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل المكعب - Java" offSpacer="" %}}
