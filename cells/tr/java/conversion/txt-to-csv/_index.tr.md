---
title: Java aracılığıyla TXT'yi CSV'ye dönüştürün 
weight: 990

description: TXT biçimi için CSV dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada CSV'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla TXT\'yi CSV\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı CSV\'ye dönüştürmek için TXT\'den CSV\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TXT\'yi CSV\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla TXT\'yi CSV\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla TXT dosyasını kolayca CSV'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TXT dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. CSV uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan CSV dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java örnek kaynak kodunu kullanmadan önce aşağıdaki ön koşullara sahip olduğunuzdan emin olun.
...
{{% blocks/products/pf/agp/code-block title="TXT\'den CSV\'ye Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TXT dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.txt");
// TXT'yi CSV olarak kaydet
