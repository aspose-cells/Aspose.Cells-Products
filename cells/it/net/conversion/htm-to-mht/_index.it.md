---
title: C# HTM in MHT - Convertitore da HTM a MHT
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori C# un approccio completamente integrato per convertire il formato HTM in MHT, consentendo il salvataggio senza interruzioni dei dati HTM in formato MHT utilizzando la libreria Aspose.Cells, il tutto tramite codice C# efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva HTM in MHT in C#" %}}

L'esempio seguente mostra come convertire HTM in MHT in C#.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire HTM in MHT. Carica il tuo file HTM e salvalo come file MHT. Sia per la lettura HTM che per la scrittura MHT puoi utilizzare nomi di file completi. Il contenuto e la formattazione MHT di output saranno identici al documento HTM originale.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Codice di esempio per convertire HTM in MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Come convertire HTM in MHT tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file HTM in MHT tramite codice? Gli sviluppatori di .NET possono caricare e convertire facilmente i file HTM in MHT in poche righe di codice.
