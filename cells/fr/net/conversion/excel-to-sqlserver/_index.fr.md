---
title: C# EXCEL vers SqlServer - Convertisseur EXCEL vers SqlServer
description: Aspose Exceller. Convertissez EXCEL en SqlServer rapidement et facilement avec Aspose.Cells. C# EXCEL en SqlServer. C# Enregistrez EXCEL sur SqlServer. Enregistrez EXCEL en tant que SqlServer en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en SqlServer via C#" %}}
...
1. Exécutez des instructions pour insérer des données dans la base de données SqlServer.

{{% blocks/products/pf/agp/code-block title="Exemple de code pour convertir EXCEL en SqlServer - C#" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir EXCEL en SqlServer" %}}
