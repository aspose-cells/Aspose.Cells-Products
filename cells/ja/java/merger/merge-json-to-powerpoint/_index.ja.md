---
title: JSON を POWERPOINT via Java にマージします
url: /ja/java/merger/merge-json-to-powerpoint/ 
description: JSON を POWERPOINT Online に無料でマージします。 POWERPOINT Mergerへの無料オンラインJSON。 JSON を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
{{% blocks/products/pf/agp/content h2="JSON をオンラインで無料で Java の POWERPOINT にマージします" %}}

次の例は、JSON を Java の POWERPOINT にマージする方法を示しています。
...
{{% cells-merger title="JSONをオンラインでPOWERPOINTにマージする無料アプリ" InputFormat="json" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
