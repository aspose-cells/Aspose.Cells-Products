...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde XLSB Dosyası oluşturun. Java'i kullanarak XLSB dosyası oluşturun. Java'de XLSB oluşturun. Java XLSB Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını XLSB biçiminde kaydedin.
