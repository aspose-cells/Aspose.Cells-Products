---
title: Konvertera XLS till XPS via programmet C++ 
weight: 2830
url: /sv/cpp/conversion/xls-to-xps/ 
description: Exempel på konverteringskod för C++ för XLS-dokument till XPS-format. Programmerare kan använda den här källkoden för batchkonvertering av XLS till XPS inom alla C++-program.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLS till XPS via C++" h2="Högpresterande XLS till XPS-konvertering med hjälp av C++-biblioteket utan behov av installation av Microsoft Excel, OpenOffice eller Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera XLS-filer till XPS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLS-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (XPS) filtillägg.1. XPS-filen kommer att sparas på den angivna sökvägen.1. Öppna XPS-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="XLS till XPS C++ konverteringskällkod" offSpacer="" %}}
