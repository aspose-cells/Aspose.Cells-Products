...
description: Aspose Excel. C++ Aspose.Cells. Sloučit HTM do formátu uložení XLSM. C++ Zkombinujte HTM do formátu XLSM. Sloučit HTM na XLSM v C++. HTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM na XLSM v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení HTM s XLSM v C++" InputFormat="htm" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
