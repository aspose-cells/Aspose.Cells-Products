...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLS を XLTM にすばやく簡単に変換します。Python XLS を XLTM に変換します。Python XLS を XLTM に保存します。Python Excel ライブラリを使用して、XLS を XLTM として保存します。
