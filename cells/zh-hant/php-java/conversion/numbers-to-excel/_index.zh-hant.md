---
title: PHP NUMBERS 到 EXCEL - NUMBERS 到 EXCEL 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 NUMBERS 轉換為 EXCEL。PHP NUMBERS 到 EXCEL。 PHP 將數字儲存到 EXCEL。使用 PHP 將 NUMBERS 儲存為 EXCEL。
...
{{% blocks/products/pf/agp/content h2="如何透過 PHP 將 NUMBERS 轉換為 EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 NUMBERS 檔案轉換為 EXCEL？ PHP 開發人員只需幾行程式碼即可輕鬆載入 NUMBERS 並將其轉換為 EXCEL。
...
1. 透過呼叫Workbook的save方法將NUMBERS轉換為EXCEL。
1. 取得NUMBERS到EXCEL的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 NUMBERS 轉換為 EXCEL 的 PHP 函式庫" %}}
