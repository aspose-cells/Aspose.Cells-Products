...
{{% blocks/products/pf/agp/content h2="Sla TXT op als PRN in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar PRN in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar PRN via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u TXT-bestanden programmatisch naar PRN converteren? Ontwikkelaars van Java kunnen TXT-bestanden eenvoudig in een paar regels code naar PRN converteren.
