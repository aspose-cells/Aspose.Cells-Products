---
title: Conversor PHP XLTX para XPS - XLTX para XPS
description: Aspose Excel. Converta XLTX em XPS de forma rápida e fácil com Aspose.Cells. PHP XLTX em XPS. PHP Salve XLTX em XPS. Salve XLTX como XPS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em XPS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em XPS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em XPS em apenas algumas linhas de código.
...
1.  Converta XLTX em XPS chamando o método save da pasta de trabalho.
