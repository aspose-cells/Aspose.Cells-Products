---
title: SXC oluştur - Java'de SXC dosyası oluştur
description: Aspose excel. Java SXC Dosyası Oluştur. Oluştur SXC Java. Java SXC Oluşturan. Java'de SXC oluşturun. Java'i kullanarak SXC dosyasını oluşturun.
...
{{% blocks/products/pf/agp/content h2="Java\'de SXC Nasıl Oluşturulur" %}}
...
1.  Çalışma kitabını save() yöntemini kullanarak SXC biçiminde kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, Java\'de SXC dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="SXC dosyası oluşturmak için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
