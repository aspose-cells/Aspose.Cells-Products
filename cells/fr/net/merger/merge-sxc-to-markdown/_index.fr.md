---
title: Fusionner SXC à MARKDOWN - Combiner SXC à MARKDOWN dans C#
url: /fr/net/merger/merge-sxc-to-markdown/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite SXC au format de sauvegarde MARKDOWN. C# Combinez le format SXC au format MARKDOWN. Fusionner SXC à MARKDOWN dans C#. SXC Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner SXC à MARKDOWN en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner SXC à MARKDOWN dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner SXC à MARKDOWN. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier MARKDOWN. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne SXC à MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner SXC à MARKDOWN en C#" InputFormat="sxc" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner SXC à MARKDOWN via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner SXC à MARKDOWN par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner SXC à MARKDOWN" %}}
