...
description: Aspose اكسل. C++ أنشئ ملف TSV بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف TSV باستخدام C++. أنشئ TSV في C++. C++ TSV Creator.
...
1.  احفظ المصنف كملف .tsv باستخدام طريقة Save().
