---
title: Chuyển đổi XLS sang BMP qua ứng dụng C++ 
weight: 5750
url: /vi/cpp/conversion/xls-to-bmp/ 
description: Mã chuyển đổi C++ mẫu cho tài liệu XLS sang định dạng BMP. Lập trình viên có thể sử dụng mã nguồn này để chuyển đổi hàng loạt XLS sang BMP trong bất kỳ Ứng dụng C++ nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS sang BMP qua C++" h2="Chuyển đổi XLS sang BMP hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS sang BMP bằng cách sử dụng C++" %}}

 Để chuyển đổi XLS thành BMP, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLS sang BMP qua C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp XLS sang BMP chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLS bằng Factory :: CreateIWorkbook.1. Chọn trang tính đầu tiên.1. Đặt (BMP) tùy chọn.1. Lặp lại từng trang của trang tính và kết xuất.1. Mở tệp BMP trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi XLS sang BMP C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi XLS sang BMP" sectionDescription="[Chuyển đổi XLS sang BMP](https://products.aspose.app/cells/conversion/xls-to-bmp) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp XLS của bạn, nó sẽ được chuyển đổi ngay lập tức thành BMP." >}}
