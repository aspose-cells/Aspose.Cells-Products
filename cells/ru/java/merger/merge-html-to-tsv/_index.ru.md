---
title: Объединить HTML с TSV — объединить HTML с TSV в Java.
url: /ru/java/merger/merge-html-to-tsv/ 
description: Aspose Эксель. Java Aspose.Cells. Объедините HTML и TSV в формате сохранения. Java Объедините форматы HTML и TSV. Объедините HTML и TSV в Java. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и TSV в Java." %}}

В следующем примере показано, как объединить HTML и TSV в Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить номера HTML и TSV. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле TSV. Если вы разработаете код Java, это будет проще, чем кажется. См. пример Java, в котором HTML объединяется с TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения чисел HTML и TSV в Java" InputFormat="html" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Как объединить HTML с TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить номера HTML и TSV? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for Java](https://products.aspose.com/cells/java) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для объединения HTML и TSV." %}}
