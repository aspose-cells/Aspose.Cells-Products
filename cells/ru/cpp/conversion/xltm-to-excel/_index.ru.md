...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики C++ могут легко преобразовать XLTM в EXCEL, написав всего несколько строк кода.
