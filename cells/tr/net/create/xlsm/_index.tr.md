...
{{% blocks/products/pf/agp/content h2="XLSM aracılığıyla C# nasıl oluşturulur" %}}

{{% blocks/products/pf/agp/text %}}

 Geliştiricilerin, yalnızca birkaç kod satırında veri işleme için farklı raporlama uygulamalarını çalıştıran MS Excel XLSM elektronik tablosunu oluşturması, yüklemesi, değiştirmesi ve dönüştürmesi kolaydır.
...
{{% blocks/products/pf/agp/code-block title="C# kullanarak bir MS Excel XLSM dosyası oluşturmak için Örnek Kod." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="XLSM dosyası oluşturmak için C# kitaplığı" %}}
