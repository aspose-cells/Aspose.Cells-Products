...
description: Aspose Excel. Converteer XLTM snel en eenvoudig naar XML met Aspose.Cells. C# XLTM naar XML. C# Sla XLTM op in XML. Sla XLTM op als XML met behulp van C#.
...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in XML in C#" %}}

Het volgende voorbeeld laat zien hoe u XLTM naar XML converteert in C#.
