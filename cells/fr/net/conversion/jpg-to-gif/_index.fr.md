---
title: C# JPG en GIF - Convertisseur JPG en GIF
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG au format GIF, permettant un enregistrement transparent des données JPG au format GIF à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir JPG en GIF en C#" h2="Bibliothèque haute vitesse C# pour la conversion de JPG en GIF. Il s\'agit d\'une solution logicielle professionnelle pour importer et exporter des fichiers JPG, GIF et de nombreux autres formats sur les plateformes .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPG" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG sous GIF dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en GIF en C#.
...
{{% cells-convert title="Exemple de code pour convertir un fichier JPG en GIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="gif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en GIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en GIF par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en GIF en quelques lignes de code.
...
1.  Convertissez le JPG au format GIF en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en GIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en GIF" %}}
