---
title: PHP XLSX sang SPREADSHEETML - Công cụ chuyển đổi XLSX sang SPREADSHEETML
description: Aspose Excel. Chuyển đổi XLSX sang SPREADSHEETML nhanh chóng và dễ dàng với Aspose.Cells. PHP XLSX sang SPREADSHEETML. PHP Lưu XLSX vào SPREADSHEETML. Lưu XLSX dưới dạng SPREADSHEETML bằng PHP.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSX sang SPREADSHEETML qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tệp XLSX sang SPREADSHEETML theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi XLSX sang SPREADSHEETML chỉ bằng vài dòng mã.
...
1.  Chuyển đổi XLSX thành SPREADSHEETML bằng cách gọi phương thức lưu của Workbook.
1.  Nhận kết quả chuyển đổi XLSX sang SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện PHP để chuyển đổi XLSX sang SPREADSHEETML" %}}
