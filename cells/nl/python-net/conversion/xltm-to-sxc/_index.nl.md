...
{{% blocks/products/pf/agp/content h2="Converteer XLTM naar SXC in Python" %}}
...
Het volgende voorbeeld laat zien hoe u XLTM converteert naar SXC in Python via NET.
