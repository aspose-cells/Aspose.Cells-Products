...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке ComboBox в файл Excel по номеру C#" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcombobox) вставить ComboBox в выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставить ComboBox — C#" offSpacer="" %}}
