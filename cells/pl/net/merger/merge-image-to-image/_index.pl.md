---
title: Scal OBRAZ z OBRAZEM - Połącz OBRAZ z OBRAZEM w C#
url: /pl/net/merger/merge-image-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Połącz OBRAZ z formatem zapisu OBRAZU. C# Połącz OBRAZ z formatem OBRAZ. Połącz OBRAZ z OBRAZEM w C#. Połącz OBRAZ.
...
{{% blocks/products/pf/agp/content h2="Połącz OBRAZ z OBRAZEM w C#" %}}

Poniższy przykład pokazuje, jak połączyć OBRAZ z OBRAZEM w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć OBRAZ z OBRAZEM. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku IMAGE. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OBRAZ z OBRAZEM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia OBRAZU z OBRAZEM w C#" InputFormat="png" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć OBRAZ z OBRAZEM za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić OBRAZ z OBRAZEM? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do łączenia OBRAZU z OBRAZEM" %}}
