---
title: Konwertuj TSV na XLAM za pomocą aplikacji C++ 
url: /pl/cpp/conversion/tsv-to-xlam/ 
description: Przykładowy kod konwersji C++ dla dokumentu TSV do formatu XLAM. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TSV do XLAM w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TSV na XLAM za pomocą C++" %}}

 Aby przekonwertować TSV na XLAM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TSV na XLAM za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik TSV na XLAM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLAM).1. Plik XLAM zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLAM w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji TSV do XLAM C++" offSpacer="" %}}
