---
title: Fusionner HTML à ODS - Combiner HTML à ODS dans Java
url: /fr/java/merger/merge-html-to-ods/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite HTML au format de sauvegarde ODS. Java Combinez le format HTML au format ODS. Fusionner HTML à ODS dans Java. HTML Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTML à ODS en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner HTML à ODS dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner HTML à ODS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier ODS. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne HTML à ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner HTML à ODS en Java" InputFormat="html" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTML à ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTML à ODS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner HTML à ODS" %}}
