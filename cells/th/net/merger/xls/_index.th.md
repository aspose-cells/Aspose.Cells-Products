...
{{< blocks/products/pf/i18n/upper-banner h1="รวม XLS รูปแบบใน C#" h2="การรวมเอกสาร XLS แบบเนทีฟและประสิทธิภาพสูงโดยใช้ API ฝั่งเซิร์ฟเวอร์ Aspose.Cells for .NET โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
+ โหลดไฟล์ XLS ทั้งหมดด้วยพาธแบบเต็ม
+ สร้างเอกสารหนึ่งชุดเป็นไฟล์ฐาน
+ เรียกวิธีการที่เกี่ยวข้องในการเชื่อมและรวมไฟล์ทีละไฟล์
+ เรียกใช้เมธอด Save() และส่งชื่อไฟล์ (เส้นทางแบบเต็ม) และรูปแบบ (XLS) เป็นพารามิเตอร์
+ ตอนนี้คุณสามารถเปิดและใช้ไฟล์ XLS ใน Microsoft Office, Adobe PDF หรือโปรแกรมอื่นที่เข้ากันได้
