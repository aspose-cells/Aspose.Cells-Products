---
title: C# XLSB do SPREADSHEETML - XLSB do konwertera SPREADSHEETML
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na SPREADSHEETML w C#" h2="Szybka biblioteka C# do konwersji formatu XLSB do formatu SPREADSHEETML. Profesjonalne rozwiązanie programowe do importowania i eksportowania formatów XLSB, SPREADSHEETML i wielu innych na platformach .NET Framework, .NET Core lub Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB w SPREADSHEETML w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLSB na format SPREADSHEETML w formacie C#.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować numer XLSB na arkusz kalkulacyjny za pomocą numeru C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSB na SPREADSHEETML? Programiści .NET mogą z łatwością załadować i przekonwertować XLSB na arkusz kalkulacyjny w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLSB do formatu SPREADSHEETML, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLSB na SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLSB na SPREADSHEETML" %}}
