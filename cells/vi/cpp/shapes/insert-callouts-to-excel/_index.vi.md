---
title:  Chèn chú thích vào Excel qua số C++
weight: 810
description: Mã ví dụ C++ để chèn chú thích vào tệp Excel trên Môi trường thời gian chạy C++ cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
keywords: [C++ Aspose.Cells., C++ add Callouts shape., C++ insert Callouts shape., C++ create Callouts shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn chú thích vào Excel qua số C++" h2="Chèn các đối tượng bằng cách sử dụng hiệu năng cao và nguyên bản của máy chủ Aspose.Cells for C++ API mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chèn chú thích vào tệp Excel bằng cách sử dụng C++" %}}

 Để chèn chú thích vào tệp Excel, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để chèn chú thích vào tệp Excel qua số C++" %}}

+ Khởi tạo một đối tượng Workbook. (hoặc -> Tải tệp XLSX với đường dẫn đầy đủ.)
+ Chọn trang tính thông qua chỉ mục của nó.
 + Sử dụng[thêm phương thức](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/) Chèn chú thích vào trang tính đã chọn
...
Đoạn mã mẫu dưới đây minh họa cách chèn "Bong bóng suy nghĩ: Đám mây". Để biết thêm các loại khác, vui lòng tham khảo "Tổng quan về các loại chú thích" bên dưới.
