...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики .NET могут легко загружать и преобразовывать XML в XLSB всего за несколько строк кода.
