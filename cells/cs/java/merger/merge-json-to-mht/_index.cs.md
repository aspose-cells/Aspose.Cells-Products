---
title:  Sloučit JSON na MHT via Java
...
Následující příklad ukazuje, jak sloučit JSON do MHT v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení JSON s MHT online" InputFormat="json" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
