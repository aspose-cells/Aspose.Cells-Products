---
title: Převeďte SPREADSHEETML na XLSB pomocí aplikace C++ 
url: /cs/cpp/conversion/spreadsheetml-to-xlsb/ 
description: Ukázkový konverzní kód C++ pro dokument SPREADSHEETML do formátu XLSB. Programátoři mohou použít tento zdrojový kód pro dávkový převod SPREADSHEETML na XLSB v jakékoli aplikaci C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SPREADSHEETML na XLSB přes C++" h2="Vysoce výkonný převod SPREADSHEETML na XLSB pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor SPREADSHEETML na XLSB pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SPREADSHEETML pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu k výstupnímu souboru s příponou (XLSB).1. Soubor XLSB bude uložen do zadané cesty.1. Otevřete soubor XLSB v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SPREADSHEETML na XLSB C++" offSpacer="" %}}
