...
url: /hu/net/merger/merge-xlsb-to-md/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés XLSB MD mentési formátumba. C# A XLSB kombinálása MD formátumba. A XLSB egyesítése a C# számú MD-vel. XLSB Egyesítés.
...
következő példa bemutatja, hogyan egyesítheti a XLSB-et az MD-vel a Aspose.Cells-es for .NET-ben.
...
{{% cells-merger title="Ingyenes online a XLSB-es szám MD-vel való egyesítése a C#-ben" InputFormat="xlsb" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLSB és az MD egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLSB-et az MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB MD-vel való egyesítéséhez" %}}
