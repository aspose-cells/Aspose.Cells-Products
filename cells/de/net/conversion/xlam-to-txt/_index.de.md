---
title: C# XLAM bis TXT - XLAM bis TXT Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLAM in das Format TXT und ermöglicht das nahtlose Speichern von XLAM-Daten im Format TXT mithilfe der Aspose.Cells-Bibliothek – alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM bis TXT in C#" %}}

Das folgende Beispiel zeigt, wie man XLAM in C# in TXT umwandelt.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um XLAM in TXT zu konvertieren. Laden Sie Ihre XLAM-Datei hoch und speichern Sie sie dann einfach als TXT-Datei. Sowohl zum Lesen XLAM als auch zum Schreiben TXT können Sie vollqualifizierte Dateinamen verwenden. Der Inhalt und die Formatierung der Ausgabe TXT sind identisch mit dem Originaldokument XLAM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Beispielcode zur Umwandlung von XLAM in TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlam" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLAM über C# in TXT" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLAM-Dateien programmgesteuert in TXT konvertieren? .NET-Entwickler können XLAM mit nur wenigen Codezeilen problemlos in TXT laden und konvertieren.
...
1.  Konvertieren Sie XLAM in TXT durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLAM in TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLAM in TXT" %}}
