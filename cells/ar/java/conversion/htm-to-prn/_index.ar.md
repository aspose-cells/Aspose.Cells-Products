---
title: Java HTM إلى PRN - تحويل HTM إلى PRN
description: Aspose إكسل. يوفر هذا الحل الشامل للمطورين Java نهجًا متكاملًا تمامًا لتحويل HTM إلى تنسيق PRN، مما يتيح حفظ بيانات HTM بسلاسة في تنسيق PRN باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود Java فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل HTM إلى PRN في Java" h2="مكتبة Java عالية السرعة لتحويل ملفات HTM إلى PRN. هذا حل برمجي احترافي لاستيراد وتصدير ملفات HTM وPRN والعديد من الصيغ الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ ملف HTM في PRN على الرقم Java" %}}

يوضح المثال التالي كيفية تحويل HTM إلى PRN في Java.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل HTM إلى PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات HTM إلى PRN برمجيًا؟ يمكن للمطورين (Java) تحويل ملفات HTM إلى PRN بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
{{% blocks/products/pf/agp/content h2="مكتبة رقم Java لتحويل ملفات HTM إلى PRN" %}}
{{% blocks/products/pf/agp/text %}}
