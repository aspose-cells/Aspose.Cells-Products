...
url: /th/net/merger/merge-mht-to-numbers/ 
...
ตัวอย่างต่อไปนี้สาธิตวิธีรวม MHT เป็น NUMBERS ใน Aspose.Cells for .NET
...
{{% blocks/products/pf/agp/text %}}
 ...
 ต้องการรวม MHT เป็น NUMBERS โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี .NET เพื่อรวม MHT เป็น NUMBERS" %}}
