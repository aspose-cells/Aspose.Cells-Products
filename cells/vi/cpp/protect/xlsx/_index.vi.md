...
weight: 1140
url: /vi/cpp/protect/xlsx/ 
description: C++ mã ví dụ để khóa tệp XLSX bằng mật khẩu trên C++ Môi trường thời gian chạy cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa tệp XLSX qua C++" h2="Bảo vệ bảng tính Excel bằng mật khẩu bao gồm định dạng XLSX bằng cách sử dụng .NET Thư viện." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước bảo vệ tệp XLSX qua C++" %}}
...
1. Tải tệp XLSX bằng lớp IWorkbook1. Sử dụng phương thức Protect (..) với ProtectionType và Password1. Lưu tệp XLSX được bảo vệ bằng phương thức Save ()
