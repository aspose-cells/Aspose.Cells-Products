...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till PDF med Python" %}}

 För att konvertera SXC till PDF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till PDF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera SXC-filer till PDF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SXC-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utdatasökväg med PDF-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande PDF-filen
