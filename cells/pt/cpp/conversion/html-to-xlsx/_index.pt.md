---
title: Converter HTML para XLSX por meio do aplicativo C++ 
weight: 9770
url: /pt/cpp/conversion/html-to-xlsx/ 
description: Exemplo de código de conversão C++ de documento HTML para formato XLSX. Os programadores podem usar esse código-fonte para conversão em lote de HTML para XLSX em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter HTML para XLSX via C++" h2="Conversão de HTML para XLSX de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para XLSX usando C++" %}}

 Para converter HTML para XLSX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML em XLSX via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem facilmente converter arquivos HTML para XLSX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo HTML usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (XLSX).1. O arquivo XLSX será salvo no caminho especificado.1. Abra o arquivo XLSX em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de HTML para XLSX C++" offSpacer="" %}}
