...
url: /nl/cpp/merger/merge-mhtml-to-xlsx/ 
...
Het volgende voorbeeld laat zien hoe u MHTML samenvoegt met XLSX in Aspose.Cells for C++.
...
{{% cells-merger title="Voorbeeldcode om MHTML samen te voegen met XLSX in C++" InputFormat="mhtml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe u MHTML samenvoegt met XLSX via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHTML programmatisch samenvoegen met XLSX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om MHTML samen te voegen met XLSX" %}}
