---
title: Java를 통해 XLSX 파일 병합 
weight: 8930
url: /ko/java/merger/xlsx/ 
description: Java JSP/JSF 애플리케이션 및 데스크톱 애플리케이션을 위한 Java 런타임 환경에서 XLSX 문서를 결합하는 샘플 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java에서 XLSX 형식 병합" h2="서버측 Java API를 사용한 기본 XLSX 문서 병합." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 XLSX 파일을 병합하는 방법" %}}

 XLSX 파일을 병합하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java에서 XLSX 파일 병합 단계" %}}
...
+ Workbook 클래스의 인스턴스가 있는 첫 번째 XLSX 파일을 로드합니다.
+ Workbook 클래스의 인스턴스로 두 번째 XLSX 문서를 로드합니다.
+ Combine() 메서드를 사용하여 파일을 병합합니다.
+ 병합된 XLSX 파일을 지정된 경로에 저장
...
{{% blocks/products/pf/agp/code-block title="XLSX 파일 병합 - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API은(는) Microsoft Excel 형식을 다른 형식으로 생성, 편집, 변환 및 렌더링하는 데 사용할 수 있습니다. 또한 소프트웨어 응용 프로그램 내에서 포괄적인 차트 작성, 확장 가능한 보고 및 신뢰할 수 있는 계산에 사용할 수 있습니다. Aspose.Cells는 독립 실행형 API이며 Microsoft 또는 OpenOffice와 같은 소프트웨어가 필요하지 않습니다.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="온라인 XLSX 합병 라이브 데모" sectionDescription="당사를 방문하여 지금 XLSX 문서를 병합하십시오. [라이브 데모 웹사이트](https://products.aspose.app/cells/merger). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/merger/xls/" name="XLS" description="Excel 이진 형식" >}}
