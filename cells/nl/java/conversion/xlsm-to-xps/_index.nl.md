...
{{% blocks/products/pf/agp/content h2="Sla XLSM op in XPS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSM omzet naar XPS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar XPS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSM programmatisch converteren naar XPS? Ontwikkelaars van Java kunnen bestanden met de extensie XLSM eenvoudig converteren naar XPS met slechts een paar regels code.
