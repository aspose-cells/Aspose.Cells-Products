...
Het volgende voorbeeld laat zien hoe u XLSM converteert naar JSON in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSM naar JSON te converteren" %}}
