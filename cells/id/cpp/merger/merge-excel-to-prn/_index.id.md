---
title: Gabungkan EXCEL ke PRN - Gabungkan EXCEL ke PRN di C++
url: /id/cpp/merger/merge-excel-to-prn/ 
description: Aspose Unggul. C++ Aspose.Cells. Online Gratis Menggabungkan EXCEL ke PRN saveformat. C++ Gabungkan format EXCEL ke PRN. Gabungkan EXCEL ke PRN di C++. Gabungkan EXCEL.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan EXCEL ke PRN melalui C++" h2="Pustaka C++ berkecepatan tinggi untuk menggabungkan EXCEL ke PRN. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di C++. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="EXCEL" additionalConversionTag="PRN" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabung EXCEL ke PRN di C++ Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan EXCEL ke PRN di Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk menggabungkan EXCEL ke PRN. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file PRN. Jika Anda mengembangkan kode di C++, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C++ yang menggabungkan EXCEL ke PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis untuk Menggabungkan EXCEL ke PRN di C++" InputFormat="xlsx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan EXCEL ke PRN melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan EXCEL ke PRN secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="C++ perpustakaan untuk menggabungkan EXCEL ke PRN" %}}
