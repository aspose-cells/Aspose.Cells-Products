---
title: "XLS-fájlok felosztása a következőn keresztül: Java "
weight: 610
url: /hu/java/splitter/xls/ 
description: Java mintakód az XLS-dokumentumok felosztásához a Java Futókörnyezeten JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS-fájlok felosztása a következőn keresztül: Java" h2="XLS felosztás a szerveroldali Java könyvtár segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="XLS-fájl felosztása a következővel: Java" %}}

 Az XLS fájl felosztásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS-fájlok felosztásának lépései a következőben: Java" %}}
...
+ Hívja meg a mentési módszert új XLS fájl elérési úttal.
...
{{% blocks/products/pf/agp/code-block title="XLS-fájl felosztása – Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 A Aspose.Cells API segítségével Microsoft Excel formátumokat hozhat létre, szerkeszthet, konvertálhat és renderelhet különböző formátumokká. Ezenkívül használható átfogó diagramok készítésére, méretezhető jelentésekre és megbízható számításokra a szoftveralkalmazásokon belül. A Aspose.Cells egy önálló API, és nem igényel olyan szoftvert, mint a Microsoft vagy az OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online XLS Splitter élő demók" sectionDescription="Ossza meg az XLS-dokumentumot most, látogasson el oldalunkra [Élő bemutatók weboldala](https://products.aspose.app/cells/splitter). Az élő demónak a következő előnyei vannak" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Csak töltse fel XLS-fájlját, és azonnal feldarabolódik." >}}
