---
title: Java CSV až SVG - CSV až SVG Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu formátu CSV do formátu SVG, což umožňuje bezproblémové ukládání dat CSV do formátu SVG pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte CSV na SVG v Java" h2="Vysokorychlostní knihovna Java pro převod CSV na SVG. Toto je profesionální softwarové řešení pro import a export CSV, SVG a mnoha dalších formátů s použitím Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte CSV na SVG v Java" %}}

Následující příklad ukazuje, jak převést číslo CSV na SVG v kódu Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod CSV na SVG. Nahrajte svůj soubor CSV a poté jej jednoduše uložte jako soubor SVG. Pro čtení CSV i zápis SVG můžete použít plně kvalifikované názvy souborů. Výstupní SVG obsah a formátování bude shodné s původním dokumentem CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod čísla CSV na SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="csv" outformat="svg" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak převést CSV na SVG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory CSV na SVG? Vývojáři Java mohou snadno převést CSV na SVG pomocí několika řádků kódu.
...
1.  Převeďte CSV na SVG voláním metody Workbook.save.
1.  Získejte výsledek převodu CSV na SVG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod CSV na SVG" %}}
{{% blocks/products/pf/agp/text %}}
