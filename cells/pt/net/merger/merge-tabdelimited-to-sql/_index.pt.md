---
title: Mesclar TABDELIMITED para SQL - Combinar TABDELIMITED para SQL em C#
url: /pt/net/merger/merge-tabdelimited-to-sql/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita TABDELIMITED para SQL saveformat. C# Combine TABDELIMITED para o formato SQL. Mesclar TABDELIMITED para SQL em C#. TABDELIMITED Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar TABDELIMITED para SQL em C# online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar TABDELIMITED para SQL em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar TABDELIMITED para SQL. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo SQL. Se você desenvolver código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla TABDELIMITED com SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar TABDELIMITED para SQL em C#" InputFormat="tsv" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar TABDELIMITED para SQL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar TABDELIMITED para SQL programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar TABDELIMITED para SQL" %}}
