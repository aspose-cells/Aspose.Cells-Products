...
weight: 10
url: /python-java/shapes/insert-textbox-to-excel/ 
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addTextBox(int,%20int,%20int,%20int,%20int,%20int)) to insert a TextBox in the selected worksheet.
