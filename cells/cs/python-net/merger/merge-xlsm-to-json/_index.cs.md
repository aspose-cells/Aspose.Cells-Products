...
url: /cs/python-net/merger/merge-xlsm-to-json/ 
...
Následující příklad ukazuje, jak sloučit XLSM až JSON v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit XLSM až JSON? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
