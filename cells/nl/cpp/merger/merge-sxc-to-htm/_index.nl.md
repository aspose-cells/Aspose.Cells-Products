---
title: Voeg SXC samen met HTM - Combineer SXC met HTM in C++
url: /nl/cpp/merger/merge-sxc-to-htm/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online samenvoegen SXC naar HTM-opslagformaat. C++ Combineer SXC naar HTM-formaat. Voeg SXC samen met HTM in C++. SXC Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis SXC samen met HTM in C++ online" %}}

Het volgende voorbeeld laat zien hoe u SXC kunt samenvoegen met HTM in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om SXC samen te voegen met HTM. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een HTM-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat SXC samenvoegt met HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om SXC samen te voegen met HTM in C++" InputFormat="sxc" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe SXC samen te voegen met HTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u SXC programmatisch samenvoegen met HTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om SXC samen te voegen met HTM" %}}
