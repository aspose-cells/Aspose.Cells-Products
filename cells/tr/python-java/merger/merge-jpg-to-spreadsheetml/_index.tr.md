...
url: /tr/python-java/merger/merge-jpg-to-spreadsheetml/ 
...
Aşağıdaki örnek, Aspose.Cells for Python via Java'de JPG'nin SPREADSHEETML ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 JPG'yi SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
