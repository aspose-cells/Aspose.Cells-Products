---
title: C# PNG na ET - PNG na ET převodník
description: Aspose Excel. Převeďte PNG na ET rychle a snadno pomocí Aspose.Cells. C# PNG na ET. C# Uložte PNG do ET. Uložte PNG jako ET pomocí C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PNG na ET v C#" h2="Vysokorychlostní knihovna C# pro převod PNG na ET. Jedná se o profesionální softwarové řešení pro import a export PNG, ET a mnoha dalších formátů na platformách .NET Framework, .NET Core nebo Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte PNG do ET v C#" %}}
...
{{% cells-convert title="Ukázkový kód pro převod PNG na ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést PNG na ET přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na ET programově? Vývojáři .NET mohou snadno načíst a převést PNG na ET v několika řádcích kódu.
