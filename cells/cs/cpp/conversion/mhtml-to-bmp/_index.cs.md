...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na BMP pomocí C++" %}}
 ...
 K převodu MHTML na BMP použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor MHTML na BMP pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor MHTML pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavit (BMP) možnosti.1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor BMP v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MHTML na BMP C++" offSpacer="" %}}
