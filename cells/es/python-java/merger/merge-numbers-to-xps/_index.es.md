---
title:  Combinar NÚMEROS a XPS a través de Python
url: /es/python-java/merger/merge-numbers-to-xps/ 
description: Combine NÚMEROS al XPS en línea de forma gratuita. NÚMEROS en Línea Gratis al XPS Fusión. Combinar NÚMEROS a Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo fusionar NÚMEROS a XPS en Python.
...
{{% cells-merger title="Aplicación gratuita para unir NÚMEROS al XPS en línea" InputFormat="numbers" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
