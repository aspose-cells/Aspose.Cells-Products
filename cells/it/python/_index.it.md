---
title:  Python Foglio Excel API - Aspose
weight: 2820
description: Python libreria di fogli di calcolo per creare leggere scrivere e analizzare file Excel.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python Fogli di calcolo Excel Analisi delle API" h2="Genera, leggi, scrivi o manipola fogli di calcolo ed esporta file Excel in più formati all\'interno delle applicazioni Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-python-java.svg" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="https://releases.aspose.com/cells/python-java/" >}}
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="La libreria Excel Python supporta i popolari formati Excel Microsoft, i formati a layout fisso e le immagini." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
Funzioni avanzate Python Excel API
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
 ...
 Dividi e unisci le celle
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Aggiungi o rimuovi il raggruppamento a righe e colonne
    </p>
   </div>
   <div class="col-lg-4">
 ...
 Imposta la formattazione dei numeri
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Leggere e impostare le formule
    </p>
   </div>
   <div class="col-lg-4">
...
-->
 ...
 Conversione di più formati
    ...
    <p>
 Python La libreria Excel fornisce la conversione dei file Excel in PDF, XPS &amp; HTML formati. La conversione affidabile di API lo rende una soluzione perfetta per le aziende che richiedono lo scambio di file in formati standard del settore.
    </p>
...
<p>Aspose.Cells for Android via Java API allows you to manipulate rows and columns in many different ways. You can easily adjust row height and column width, auto size the width & height of cells according to the contents, insert or delete, hide or show and group or ungroup rows & columns.</p>
 ...
 Gestione dei dati dei fogli Excel
    ...
    <p>
 Aspose.Cells for Python API fornisce un ampio supporto per la gestione dei dati del foglio di lavoro. Si può facilmente manipolare qualsiasi cella nel foglio di lavoro in fase di esecuzione o importare dati nei fogli di lavoro da varie fonti di dati.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Personalizzazione dei grafici
    ...
    <p>
 Aspose.Cells for Python fornisce supporto completo per la creazione di grafici. È possibile aggiungere facilmente grafici standard e personalizzati o impostare dinamicamente i dati del grafico per aggiornare il grafico in questa libreria Python.
    </p>
   </div>
   <!--
