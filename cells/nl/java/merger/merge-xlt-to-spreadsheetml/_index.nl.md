...
description: Aspose Excel. Java Aspose.Cells. Voeg XLT samen naar het SPREADSHEETML-opslagformaat. Java Combineer XLT naar SPREADSHEETML-formaat. Voeg XLT samen met SPREADSHEETML in Java. XLT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen met SPREADSHEETML in Java" %}}

Het volgende voorbeeld laat zien hoe u XLT samenvoegt met SPREADSHEETML in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLT samen te voegen met SPREADSHEETML. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het SPREADSHEETML-bestand. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld Java waarin XLT wordt samengevoegd met SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLT samen te voegen met SPREADSHEETML in Java" InputFormat="xlt" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLT samenvoegt met SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen met SPREADSHEETML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLT samen te voegen met SPREADSHEETML" %}}
