---
title: PHP XLAM ila XLS - XLAM ila XLS Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde XLAM'i XLS'e dönüştürün. PHP XLAM'i XLS'e dönüştürün. PHP XLAM'i XLS'e kaydedin. PHP kullanarak XLAM'i XLS olarak kaydedin.
...
{{% cells-convert title="XLAM\'i XLS\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xls" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLAM\'i XLS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLAM dosyalarını program aracılığıyla XLS'e dönüştürmeniz mi gerekiyor? PHP geliştiricileri sadece birkaç satır kodla XLAM'i XLS'e kolayca yükleyebilir ve dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLAM'i XLS'e dönüştürün.
1.  XLAM'den XLS'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLAM\'i XLS\'e dönüştürmek için PHP kütüphanesi" %}}
