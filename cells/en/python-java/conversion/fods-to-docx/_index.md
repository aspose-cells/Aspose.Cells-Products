...
description: Sample code for fods to docx Python conversion. Use API example code for batch fods files to docx conversion within Python application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert FODS to DOCX Using Python" %}}

 In order to convert FODS to DOCX, we will use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert FODS to DOCX via Python" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert FODS to DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="docx" IsLandingPage="true" language="python" %}}
