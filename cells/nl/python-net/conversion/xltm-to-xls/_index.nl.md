...
{{% blocks/products/pf/agp/content h2="Converteer XLTM naar XLS in Python" %}}
...
Het volgende voorbeeld laat zien hoe u XLTM converteert naar XLS in Python via NET.
