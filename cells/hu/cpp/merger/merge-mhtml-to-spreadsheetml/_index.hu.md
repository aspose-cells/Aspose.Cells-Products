...
url: /hu/cpp/merger/merge-mhtml-to-spreadsheetml/ 
...
A következő példa bemutatja, hogyan egyesítheti a MHTML-et a SPREADSHEETML-be a Aspose.Cells-es for C++-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a MHTML-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a MHTML és a SPREADSHEETML egyesítéséhez" %}}
