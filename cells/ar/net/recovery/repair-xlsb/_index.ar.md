...
{{% blocks/products/pf/agp/content h2="كيفية إصلاح ملف xlsb باستخدام C#" %}}
...
{{% cells-recovery title="تطبيق مجاني لإصلاح ملف XLSB باستخدام .NET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsb" outformat="xlsb" IsLandingPage="true" language="net" %}}    
