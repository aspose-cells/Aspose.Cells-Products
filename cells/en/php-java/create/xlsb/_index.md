...
{{% blocks/products/pf/agp/content h2="How to Create XLSB in PHP" %}}
...
1.  Save the workbook as XLSB format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create XLSB file in PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PHP library to create XLSB file" %}}
