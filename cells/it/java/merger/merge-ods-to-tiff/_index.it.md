...
description: Aspose Excel. Java Aspose.Cells. Unione online gratuita da ODS a TIFF saveformat. Java Combina il formato ODS con TIFF. Unisci ODS a TIFF in Java. ODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci ODS a TIFF in Java online gratuitamente" %}}

L'esempio seguente mostra come unire ODS a TIFF in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire ODS a TIFF. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file TIFF. Se sviluppi il codice in Java, sarà più semplice di quanto sembri. Vedere l'esempio Java che unisce ODS a TIFF.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Devi unire ODS a TIFF a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca da unire ODS a TIFF" %}}
