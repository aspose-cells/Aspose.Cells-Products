...
{{% blocks/products/pf/agp/content h2="Sla FODS op in ODS in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar ODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar ODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar ODS? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar ODS met slechts een paar regels code.
