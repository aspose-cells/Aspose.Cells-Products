---
title: Java XLSB à SXC - Convertisseur en ligne XLSB à SXC
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XLSB en format de sauvegarde SXC. Format Java XLSB à SXC. Enregistrez XLSB à SXC Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à SXC dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en SXC en Java.
...
Besoin de convertir les fichiers XLSB en SXC par programmation ? Les développeurs de Java peuvent facilement convertir XLSB en SXC en seulement quelques lignes de code.
