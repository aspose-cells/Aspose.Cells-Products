...
url: /cs/net/merger/merge-image-to-ots/ 
...
Následující příklad ukazuje, jak sloučit IMAGE do OTS v Aspose.Cells for .NET.
...
Potřebujete sloučit IMAGE s OTS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna pro sloučení IMAGE do OTS" %}}
