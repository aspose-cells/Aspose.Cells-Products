...
Chcesz programowo przekonwertować pliki HTML na SQL? Programiści C++ mogą łatwo przekonwertować HTML na SQL w zaledwie kilku wierszach kodu.
...
1.  Przekonwertuj HTML na SQL, wywołując metodę Save().
