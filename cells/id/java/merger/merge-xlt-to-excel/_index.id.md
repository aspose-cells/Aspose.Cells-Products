---
title: Gabungkan XLT ke EXCEL - Gabungkan XLT ke EXCEL di Java
url: /id/java/merger/merge-xlt-to-excel/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLT ke format simpan EXCEL. Java Gabungkan XLT ke format EXCEL. Gabungkan XLT menjadi EXCEL di Java. XLT Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLT ke EXCEL di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLT ke EXCEL di Java" InputFormat="xlt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLT menjadi EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLT ke EXCEL secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
