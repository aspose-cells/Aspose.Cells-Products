---
title:  C++ 経由で開かずに TSV ドキュメントを検索
weight: 930
description: C++ 32 ビット、Windows 64 ビットおよび Linux 64 ビット用の C++ ランタイム環境上の TSV ファイル内のパターンを持つ単語を検索する C++ サンプル コード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV で TSV の形式を検索" h2="Microsoft や Adobe PDF などのソフトウェアを使用せずに、サーバー側の Aspose.Cells for C++ API を使用したネイティブで高性能の TSV ドキュメント検索。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++でTSVファイルを検索する手順" %}}
...
IWorkbook クラスをインスタンス化して TSV ファイルを読み込みます。
...
+ IWorkbook->Save(.) メソッドを使用して TSV ファイルを保存します。
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="オンライン TSV ライブデモを検索" sectionDescription="にアクセスして、TSV 文書内のテキスト、単語、フレーズを今すぐ検索してください。[ライブデモ Web サイト](https://products.aspose.app/cells/search)。ライブデモには次の利点があります" >}}
