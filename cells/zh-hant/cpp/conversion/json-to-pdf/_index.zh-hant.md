---
title: 通過 C++ 應用程序將 JSON 轉換為 PDF 
url: /zh-hant/cpp/conversion/json-to-pdf/ 
description: JSON 文檔到 PDF 格式的示例 C++ 轉換代碼。程序員可以使用此源代碼在任何 C++ 應用程序中將 JSON 批量轉換為 PDF。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 將 JSON 轉換為 PDF" h2="使用 C++ 庫的高性能 JSON 到 PDF 轉換，無需安裝 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 開發人員只需幾行代碼即可輕鬆地將 JSON 文件轉換為 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加載 JSON 文件。1. 調用 Save() 方法。1. 傳遞帶有 (PDF) 文件擴展名的輸出文件路徑。1. PDF 文件將保存在指定的路徑。1. 在兼容程序中打開 PDF 文件。
...
{{% blocks/products/pf/agp/code-block title="JSON轉PDFC++轉換源碼" offSpacer="" %}}
