---
title: Insérer des flèches de bloc dans Excel via Java
weight: 338
...
{{% blocks/products/pf/agp/content h2="Comment insérer des flèches de bloc dans un fichier Excel à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer des flèches de bloc dans le fichier Excel via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) pour insérer des flèches de bloc dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer des flèches de bloc - Java" offSpacer="" %}}
