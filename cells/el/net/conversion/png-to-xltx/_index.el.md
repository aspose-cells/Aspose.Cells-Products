...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν το PNG σε XLTX σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1.  Φορτώστε το αρχείο PNG με μια παρουσία του βιβλίου εργασίας
1.  Μετατρέψτε το PNG σε XLTX καλώντας το Βιβλίο εργασίας. Μέθοδος αποθήκευσης
