---
title: تحويل XLSX إلى JPG عبر Java 

description: نموذج رمز تحويل Java لتنسيق XLSX إلى ملف JPG. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel و OpenOffice إلى JPG من خلال أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLSX إلى JPG عبر Java" h2="XLSX إلى JPG Java لتحويل صفحات مفردة أو متعددة إلى JPG باستخدام المكتبة المحلية Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSX إلى JPG باستخدام Java" %}}

 من أجل تقديم XLSX إلى JPG ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLSX إلى JPG عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج Java تحويل ملف XLSX إلى JPG بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف XLSX مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد JPG & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف JPG الناتج
...
{{% blocks/products/pf/agp/code-block title="XLSX إلى JPG Java شفرة مصدر التحويل" offSpacer="" %}}
