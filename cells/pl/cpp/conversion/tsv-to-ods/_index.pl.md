---
title: Konwertuj TSV na ODS za pomocą aplikacji C++ 
weight: 1810
url: /pl/cpp/conversion/tsv-to-ods/ 
description: Przykładowy kod konwersji C++ dla dokumentu TSV do formatu ODS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TSV na ODS w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TSV na ODS przez C++" h2="Wysokowydajna konwersja TSV do ODS przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TSV na ODS w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (ODS).1. Plik ODS zostanie zapisany pod określoną ścieżką.1. Otwórz plik ODS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TSV do ODS C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja z TSV do ODS na żywo w wersji demonstracyjnej" sectionDescription="[Konwertuj TSV na ODS](https://products.aspose.app/cells/conversion/tsv-to-ods) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik TSV, zostanie on natychmiast przekonwertowany na ODS." >}}
