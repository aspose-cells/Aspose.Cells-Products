---
title:  Wyszukaj dokument XLSB bez otwierania za pośrednictwem C++
weight: 7020
description: C++ przykładowy kod wyszukiwania słów z wzorcem w pliku XLSB w C++ Runtime Environment dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
---
...
Załaduj plik XLSB, tworząc instancję klasy IWorkbook.
...
+ Zapisz plik XLSB przy użyciu metody IWorkbook->Save(.).
