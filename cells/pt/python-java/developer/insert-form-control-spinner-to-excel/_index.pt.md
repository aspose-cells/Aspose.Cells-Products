---
title:  Insira o botão giratório (controle de formulário) no Excel usando Python via java
weight: 40
description: Python via código-fonte java para inserir o botão Spin (controle de formulário) no Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insira o botão giratório (controle de formulário) no Excel usando Python via java" h2="Insira objetos usando APIs do lado do servidor sem qualquer software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir o botão giratório (controle de formulário) em um arquivo Excel usando Python via java" %}}

 Para inserir o botão Spin (controle de formulário) no arquivo Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir o botão Spin (controle de formulário) no arquivo Excel usando Python via java" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Use o shapecollection[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)) para inserir um botão giratório (controle de formulário) na planilha selecionada.
