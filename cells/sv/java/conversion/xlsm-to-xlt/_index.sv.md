---
title: Konvertera XLSM till XLT via Java 
weight: 3800
url: /sv/java/conversion/xlsm-to-xlt/ 
description: Exempel på Java-konverteringskod för XLSM-format till XLT-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLT inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till XLT med Java" %}}

 För att rendera XLSM till XLT kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till XLT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLSM-fil till XLT på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLT-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLT-filen
...
{{% blocks/products/pf/agp/code-block title="XLSM till XLT Java omvandlingskällkod" offSpacer="" %}}
