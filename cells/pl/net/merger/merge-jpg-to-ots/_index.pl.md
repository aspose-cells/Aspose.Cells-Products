...
Poniższy przykład pokazuje, jak scalić JPG z OTS w Aspose.Cells for .NET.
...
Chcesz programowo połączyć JPG z OTS? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET do połączenia JPG z OTS" %}}
