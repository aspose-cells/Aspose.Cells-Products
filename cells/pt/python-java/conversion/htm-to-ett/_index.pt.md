...
description: Aspose Excel. Converta HTM em ETT de forma rápida e fácil com Aspose.Cells. Python HTM em ETT. Python Salvar HTM em ETT. Salve HTM como ETT usando Python.
...
{{% blocks/products/pf/agp/content h2="Converter HTM em ETT usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Salve HTM em ETT em Python" %}}

O exemplo a seguir demonstra como converter HTM em ETT em Python.
...
{{% cells-convert title="Exemplo de código para converter HTM em ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="ett" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para converter HTM em ETT" %}}
