---
title: สร้างไฟล์ ODS (Openoffice / Lbreoffice) via Java
description: ODS ผู้สร้าง. สร้างไฟล์ ODS ในรหัส Java สร้างไฟล์ ODS (Openoffice / Lbreoffice) โดยใช้เดสก์ท็อปหรือเว็บแอปพลิเคชัน Java
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="สร้าง ODS ไฟล์ via Java" h2="การสร้างสเปรดชีตแบบเนทีฟและประสิทธิภาพสูง ODS (Openoffice / Lbreoffice) โดยทางโปรแกรมโดยใช้ไลบรารี Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีสร้าง ODS via Java" %}}
