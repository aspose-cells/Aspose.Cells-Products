---
title: أدخل عنصر تحكم ActiveX في Excel باستخدام Python via .Net
weight: 10
description: Python via .Net كود المصدر لإدراج عنصر تحكم ActiveX في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج عنصر تحكم ActiveX في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_active_x_control/#aspose.cells.drawing.activexcontrols.ControlType-int-int-int-int-int-int) لإدراج عنصر تحكم ActiveX في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل عنصر تحكم ActiveX - Python via .Net" offSpacer="" %}}
