...
description: Aspose Excel. A SXC-es számot gyorsan és egyszerűen SPREADSHEETML-re alakíthatja át a Aspose.Cells-es számmal. Python Mentse a SXC számot a SPREADSHEETML-be. Mentse el a SXC-et SPREADSHEETML-ként a Python használatával.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja a SXC-et SPREADSHEETML-re a Python-ben" h2="Nagy sebességű Python könyvtár a SXC SPREADSHEETML formátumba konvertálásához. Használja a API-es excel konverziónkat magas szintű, platformfüggetlen szoftver fejlesztéséhez a Python-ben." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertálja a SXC-et SPREADSHEETML-re a Python-ben" %}}
...
{{% blocks/products/pf/agp/content h2="Mentse a SXC-et a SPREADSHEETML-be a Python-ben" %}}

A következő példa bemutatja, hogyan lehet a SXC-et SPREADSHEETML-re konvertálni a Python via NET-ben.
