---
title: تجميع الأشكال وفك تجميعها في Excel via Java
weight: 360
description: تجميع الكائنات وفك تجميعها باستخدام Aspose.Cells 'Java API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF ، إلخ.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تجميع الأشكال وفك تجميعها في Excel via Java" h2="استخدام Aspose.Cells API للعمل مع كائنات مختلفة بدون أي برامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تجميع الأشكال وفك تجميعها في ملف Excel باستخدام sJava" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تجميع الأشكال وفك تجميعها في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة المجموعة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#group-com.aspose.cells.Shape---) لتجميع الأشكال في ورقة العمل المحددة
 + استخدم ملف[طريقة فك التجميع](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#ungroup-com.aspose.cells.GroupShape-) لفك تجميع الأشكال في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="تجميع وفك تجميع الأشكال - Java" offSpacer="" %}}
