...
weight: 360
description: Agrupar e desagrupar objetos usando Aspose.Cells' Python via .Net API sem qualquer software como Microsoft ou Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Como agrupar e desagrupar formas em arquivo Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para agrupar e desagrupar formas em arquivo Excel usando Python via .Net" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Utilize o[método de grupo](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/group/) para agrupar formas na planilha selecionada
 + Utilize o[método de desagrupar](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/ungroup/) para desagrupar formas na planilha selecionada
...
{{% blocks/products/pf/agp/code-block title="Agrupar e desagrupar formas - Python via .Net via .NET" offSpacer="" %}}
