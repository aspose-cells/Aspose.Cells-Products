...
description: Aspose Excel. Konvertálja gyorsan és egyszerűen EXCEL-t ODS-re a Aspose.Cells-es számmal. C# EXCEL ODS-re. C# Mentse az EXCEL-t ODS-re. Mentse az EXCEL-t ODS-es számra. Mentse az EXCEL-t 38123481-es számmal 07613817-ként.
...
{{< blocks/products/pf/i18n/upper-banner h1="EXCEL konvertálása ODS-re a C#-ben" h2="Nagysebességű C# könyvtár az EXCEL ODS-re konvertálásához. Ez egy professzionális szoftvermegoldás az EXCEL, ODS és sok más formátum importálásához és exportálásához a .NET Framework, .NET Core vagy 348711 Core vagy 348761 platformon." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% blocks/products/pf/agp/content h2="EXCEL mentése a ODS-es számra a C#-ben" %}}
...
{{% cells-convert title="Mintakód az EXCEL ODS-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ods" IsLandingPage="true" %}}
