---
title: Fusionner MHT en NUMBERS - Combiner MHT en NUMBERS en Java
url: /fr/java/merger/merge-mht-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde NUMBERS. Java Combinez MHT au format NUMBERS. Fusionner MHT avec NUMBERS dans Java. Fusion MHT.
...
L'exemple suivant montre comment fusionner MHT avec NUMBERS dans Aspose.Cells for Java.
...
{{% cells-merger title="Gratuit en ligne pour fusionner MHT en NUMBERS en Java" InputFormat="mht" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec NUMBERS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner MHT avec NUMBERS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
