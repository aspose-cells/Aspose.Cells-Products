---
title:  Sterren en banners invoegen in Excel Python via .NET
weight: 381
description: Python via .NET broncode om sterren en banners in Excel in te voegen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sterren en banners invoegen in Excel Python via .NET" h2="Voeg objecten in met behulp van server-side API\'s zonder enige software zoals Microsoft of Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Sterren en banners in Excel-bestand invoegen met Python via .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om sterren en banners in Excel-bestand in te voegen via Python" %}}
...
+ Selecteer werkblad via de index.
 + Gebruik de add-on van de shapecollection[methode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) om sterren en banners in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Sterren en spandoeken invoegen - Python via .NET" offSpacer="" %}}
