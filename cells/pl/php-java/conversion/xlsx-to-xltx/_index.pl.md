---
title: Konwerter PHP XLSX na XLTX - XLSX na XLTX
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom PHP w pełni zintegrowane podejście do konwersji formatu XLSX do XLTX, umożliwiając bezproblemowe zapisywanie danych XLSX do formatu XLTX za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na XLTX za pomocą PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potrzebujesz programowo przekonwertować pliki XLSX na XLTX? Programiści PHP mogą łatwo załadować i przekonwertować pliki XLSX na XLTX za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLSX na XLTX wywołując metodę save obiektu Workbook.
1.  Uzyskaj wynik konwersji XLSX na XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka PHP do konwersji XLSX na XLTX" %}}
