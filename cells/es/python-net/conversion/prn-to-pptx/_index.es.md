...
description: Aspose Excel. Convierta PRN a PPTX rápida y fácilmente con Aspose.Cells. Python PRN a PPTX. Python Guarde PRN en PPTX. Guarde PRN como PPTX usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar PRN al PPTX en Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a PPTX en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir PRN a PPTX" %}}
