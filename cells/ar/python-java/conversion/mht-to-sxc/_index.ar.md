---
title: Python MHT إلى SXC - محول MHT عبر الإنترنت إلى SXC
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل MHT إلى SXC saveformat. Python MHT إلى تنسيق SXC. احفظ MHT في SXC Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHT إلى SXC في Python" h2="مكتبة Python عالية السرعة لتحويل MHT إلى SXC. هذا حل برمجي احترافي لاستيراد وتصدير MHT ، SXC ، والعديد من التنسيقات الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
هل تحتاج إلى تحويل ملفات MHT إلى SXC برمجيًا؟ يمكن للمطورين Python تحميل وتحويل MHT إلى SXC بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى SXC عن طريق استدعاء طريقة Workbook.save.
