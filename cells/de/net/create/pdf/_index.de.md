...
{{% blocks/products/pf/agp/content h2="So erstellen Sie PDF in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Der Beispielcode zeigt, wie die Datei PDF in C# erstellt wird." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Erstellen der PDF-Datei" %}}
