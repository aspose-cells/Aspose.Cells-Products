...
description: Aspose Excel. Aspose.Cells for .NET 라이브러리를 사용하여 MHT 파일을 손쉽게 생성하고 조작하세요. 이 강력한 API 라이브러리는 C# 애플리케이션 내에서 직접 MHT 파일을 생성, 편집 및 관리할 수 있는 간소화되고 효율적인 솔루션을 제공하여 개발자의 특정 요구 사항을 높은 정확도로 충족합니다.
...
{{% blocks/products/pf/agp/content h2="C#에서 MHT를 생성하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 개발자는 단 몇 줄의 코드만으로 데이터 처리를 위해 다양한 보고 애플리케이션을 실행하면서 MHT 파일을 쉽게 생성, 로드, 수정 및 변환할 수 있습니다.
...
1. 통합 문서를 MHT 파일로 저장하려면 Save 메서드를 사용합니다.
...
{{% blocks/products/pf/agp/content h2="C# 라이브러리를 사용하여 MHT 파일을 생성합니다." %}}
