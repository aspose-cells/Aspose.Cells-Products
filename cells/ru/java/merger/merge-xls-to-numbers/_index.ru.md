---
title: Объединить XLS в NUMBERS - Объединить XLS в NUMBERS в Java
url: /ru/java/merger/merge-xls-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Бесплатное онлайн-слияние XLS в формат сохранения NUMBERS. Java Объедините XLS в формат NUMBERS. Объединить XLS с NUMBERS в Java. XLS Объединить.
...
{{% blocks/products/pf/agp/content h2="Объедините XLS в NUMBERS в Java онлайн бесплатно" %}}

В следующем примере показано, как объединить XLS с NUMBERS в Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить XLS с NUMBERS. Загрузите свои файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле NUMBERS. Если вы разрабатываете код в Java, это будет проще, чем кажется. См. пример Java, в котором XLS объединяется с NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Бесплатно онлайн объединить XLS в NUMBERS в Java" InputFormat="xls" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Как объединить XLS с НОМЕРАМИ via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить XLS в NUMBERS? Базовый документ сливается и объединяется с[Aspose.Cells for Java](https://products.aspose.com/cells/java) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="библиотека Java для объединения XLS с NUMBERS" %}}
