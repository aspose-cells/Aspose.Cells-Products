---
title: Konvertor PHP MHTML až SVG - MHTML až SVG
description: Aspose Excel. Převeďte MHTML na SVG rychle a snadno pomocí Aspose.Cells. PHP MHTML na SVG. PHP Uložte MHTML na SVG. Uložte SVG jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na SVG přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na SVG programově? Vývojáři PHP mohou snadno načíst a převést MHTML na SVG v několika řádcích kódu.
...
1.  Převeďte MHTML na SVG voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na SVG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na SVG" %}}
