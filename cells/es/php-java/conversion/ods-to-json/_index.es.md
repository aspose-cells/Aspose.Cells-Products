---
title: Convertidor PHP ODS a JSON - ODS a JSON
description: Aspose Excel. Convierta ODS a JSON rápida y fácilmente con Aspose.Cells. PHP ODS a JSON. PHP Guarde ODS a JSON. Guarde ODS como JSON usando PHP.
...
¿Necesita convertir archivos ODS a JSON mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente ODS a JSON en tan solo unas pocas líneas de código.
...
1.  Convierta ODS a JSON llamando al método guardar del libro de trabajo.
