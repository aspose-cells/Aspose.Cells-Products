---
title: C# EXCEL to CSV - EXCEL to CSV Converter
description: Aspose Excel. C# Aspose.Cells. EXCEL to CSV in C#. C# Convert EXCEL to CSV saveformat. C# EXCEL to CSV format. Save EXCEL to CSV C#.
keywords: [Aspose Excel., C# Aspose.Cells., EXCEL to CSV in C#., C# EXCEL to CSV saveformat., EXCEL to CSV C#., C# Convert EXCEL to CSV]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert EXCEL to CSV in C#" h2="High-speed C# library for converting EXCEL to CSV. This is a professional software solution to import and export EXCEL, CSV, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% blocks/products/pf/agp/content h2="Save EXCEL to CSV in C#" %}}
...
{{% cells-convert title="Sample Code to Convert EXCEL to CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="csv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert EXCEL to CSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert EXCEL files to CSV programmatically? .NET developers can easily load & convert EXCEL to CSV in just a few lines of code.
...
1.  Get the conversion result of EXCEL to CSV.
