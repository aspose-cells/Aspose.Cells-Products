...
url: /zh-hant/net/merger/merge-mht-to-sxc/ 
...
以下範例示範如何將MHT合併為Aspose.Cells for .NET中的SXC。
...
需要以程式方式將 MHT 合併到 SXC 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 庫將 MHT 合併到 SXC" %}}
