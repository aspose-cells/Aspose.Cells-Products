---
title: Konvertera SXC till JSON via appen C++ 
url: /sv/cpp/conversion/sxc-to-json/ 
description: Exempel C++-konverteringskod för SXC-dokument till JSON-format. Programmerare kan använda den här källkoden för batchkonvertering av SXC till JSON i vilken C++-applikation som helst.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera SXC till JSON via C++" h2="Högpresterande SXC till JSON-konvertering med hjälp av C++-biblioteket utan behov av installation av Microsoft Excel, OpenOffice eller Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till JSON med C++" %}}

 För att konvertera SXC till JSON kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till JSON via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-utvecklare kan enkelt konvertera SXC-fil till JSON på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SXC-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (JSON) filtillägg.1. JSON-filen kommer att sparas på den angivna sökvägen.1. Öppna JSON-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="SXC till JSON C++ konverteringskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC till JSON Conversion Live Demos" sectionDescription="[Konvertera SXC till JSON](https://products.aspose.app/cells/conversion/sxc-to-json) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din SXC-fil, den konverteras omedelbart till JSON." >}}
