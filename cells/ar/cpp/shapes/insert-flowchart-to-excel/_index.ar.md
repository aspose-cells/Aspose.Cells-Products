...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج مخطط انسيابي في ملف Excel عبر الرقم C++" %}}

+ إنشاء كائن مصنف. (أو->تحميل الملف XLSX بالمسار الكامل.)
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/) لإدراج مخطط انسيابي في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج مخطط انسيابي - C++" offSpacer="" %}}
