---
title: Konwertuj XLSB na TABDELIMITED przez C#
url: /pl/net/conversion/xlsb-to-tabdelimited/
description: Przykładowy kod konwersji xlsb do rozdzielanej tabulatorami C#. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji rozdzielanej tabulatorami w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na TABDELIMITED przez C#" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu TABDELIMITED na platformach .NET Framework, .NET Core, Mono lub Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki XLSB na TABDELIMITED w zaledwie kilku wierszach kodu.
