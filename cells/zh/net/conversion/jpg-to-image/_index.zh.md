...
{{% cells-convert title="将 JPG 转换为图像的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 JPG 转换为 IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 JPG 文件转换为 IMAGE 吗？.NET 开发人员只需几行代码即可轻松加载并将 JPG 转换为 IMAGE。
...
1. 调用 Workbook.Save 方法将 JPG 转换为 IMAGE。
1. 获取JPG到IMAGE的转换结果。
