...
{{% blocks/products/pf/agp/content h2="Hur man infogar anteckningar i XLSB-filen via C#" %}}
...
I Office 365 är anteckningar för anteckningar, du kan använda följande C#-kod för att infoga och ta bort anteckningar i XLSB-filen.

{{% blocks/products/pf/agp/code-block title="C# exempelkod för att infoga och ta bort anteckningar i filen XLSB" offSpacer="" %}}
