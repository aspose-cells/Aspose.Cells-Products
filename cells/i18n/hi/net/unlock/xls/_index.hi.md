---
title: XLS दस्तावेज़ को .NET के माध्यम से अनलॉक करें 
weight: 4260
url: /hi/net/unlock/xls/ 
description: .NET Framework, .NET Core, Mono या Xamarin Platforms पर पासवर्ड से सुरक्षित XLS फ़ाइल को अनलॉक करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS स्प्रेडशीट को C# के माध्यम से अनलॉक करें" h2=".NET लाइब्रेरी का उपयोग करके XLS से सुरक्षा निकालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
// सुरक्षित XLS फ़ाइल के साथ कार्यपुस्तिका ऑब्जेक्ट को इंस्टेंट करें
...
// परिणाम को वापस XLS प्रारूप में सहेजें
