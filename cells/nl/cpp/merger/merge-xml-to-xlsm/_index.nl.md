---
title: XML samenvoegen met XLSM - XML combineren met XLSM in C++
url: /nl/cpp/merger/merge-xml-to-xlsm/ 
description: Aspose Excel. C++ Aspose.Cells. XML samenvoegen naar XLSM opslagformaat. C++ Combineer XML naar XLSM-formaat. XML samenvoegen met XLSM in C++. XML samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XML samen met XLSM in C++" %}}

Het volgende voorbeeld laat zien hoe u XML kunt samenvoegen met XLSM in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XML samen te voegen naar XLSM. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand XLSM. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ waarin XML wordt samengevoegd tot XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XML samen te voegen met XLSM in C++" InputFormat="xml" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XML samenvoegen naar XLSM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XML programmatisch samenvoegen met XLSM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++-bibliotheek om XML samen te voegen met XLSM" %}}
