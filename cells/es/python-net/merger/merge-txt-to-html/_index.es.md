---
title:  Combinar TXT a HTML vía Python
url: /es/python-net/merger/merge-txt-to-html/ 
description: Combine TXT a HTML en línea de forma gratuita. Gratis Online TXT a HTML Fusión. Combine TXT con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar TXT con HTML en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar TXT a HTML en línea" InputFormat="txt" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
