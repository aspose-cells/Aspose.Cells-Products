---
title: SPREADSHEETML mit PRN zusammenführen – Kombinieren Sie SPREADSHEETML mit PRN in C#
url: /de/net/merger/merge-spreadsheetml-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. SPREADSHEETML in PRN-Speicherformat zusammenführen. C# Kombinieren Sie SPREADSHEETML mit dem PRN-Format. Führen Sie SPREADSHEETML mit PRN in C# zusammen. SPREADSHEETML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie SPREADSHEETML mit PRN in C# zusammen" %}}

Das folgende Beispiel zeigt, wie SPREADSHEETML mit PRN in Aspose.Cells for .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um SPREADSHEETML mit PRN zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der PRN-Datei. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das SPREADSHEETML mit PRN zusammenführt.
...
{{% blocks/products/pf/agp/content h2="So führen Sie SPREADSHEETML über C# mit PRN zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie SPREADSHEETML programmgesteuert mit PRN zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von SPREADSHEETML mit PRN" %}}
