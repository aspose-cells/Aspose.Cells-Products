---
title:  دمج XLS ملفات via Java
weight: 5140
description: نموذج التعليمات البرمجية Java لدمج XLS مستندًا في Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="دمج XLS التنسيقات في Java" h2="دمج المستندات XLS الأصلي باستخدام واجهات برمجة التطبيقات Java من جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية دمج الملفات XLS باستخدام Java" %}}

 من أجل دمج الملف XLS، سنستخدم[Aspose.Cells for Java](https://products.aspose.com/cells/java) API وهي منصة دمج غنية بالميزات وقوية وسهلة الاستخدام API for Java. يمكنك تنزيل أحدث إصدار مباشرة من[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) وقم بتثبيته ضمن مشروعك المستند إلى Maven عن طريق إضافة التكوينات التالية إلى ملف pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات دمج ملفات XLS في Java" %}}
...
+ قم بتحميل الملف XLS الأول بمثيل لفئة Workbook.
+ قم بتحميل مستند XLS الثاني بمثيل لفئة Workbook.
+ دمج الملفات باستخدام طريقة الجمع ().
+ احفظ الملف المدمج XLS في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="دمج XLS ملفات - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عبر الإنترنت XLS الاندماج العروض الحية" sectionDescription=" قم بدمج مستندات XLS الآن من خلال زيارة موقعنا[موقع العروض الحية](https://products.aspose.app/cells/merger). يتمتع العرض التجريبي المباشر بالمزايا التالية" >}}
