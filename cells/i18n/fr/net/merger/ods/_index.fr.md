---
title: Fusionner les fichiers ODS via .NET 
weight: 4330
url: /fr/net/merger/ods/ 
description: Code source C# pour combiner des documents ODS sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats ODS dans C#" h2="Fusion de documents ODS native et hautes performances à l\'aide d\'API Aspose.Cells for .NET côté serveur, sans l\'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner un fichier ODS à l\'aide de C#" %}}
 ...
 Afin de fusionner le fichier ODS, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers ODS dans C#" %}}
...
+ Chargez tous les fichiers ODS avec le chemin complet.
+ Créer un document comme fichier de base
+ Appelez la méthode appropriée pour concaténer et fusionner les fichiers un par un.
+ Appelez la méthode Save() et passez le nom du fichier (chemin complet) et le format (ODS) en paramètre.
+ Vous pouvez maintenant ouvrir et utiliser le fichier ODS dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers ODS - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API peut être utilisé pour créer, modifier, convertir et restituer des formats Microsoft Excel dans différents formats. De plus, il peut être utilisé pour des graphiques complets, des rapports évolutifs et des calculs fiables dans les applications logicielles. Aspose.Cells est un API autonome et ne nécessite aucun logiciel comme Microsoft ou OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la fusion ODS en ligne" sectionDescription="Fusionnez les documents ODS dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/cells/merger). La démo en direct présente les avantages suivants" >}}
