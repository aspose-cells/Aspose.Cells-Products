...
{{% blocks/products/pf/agp/content h2="แปลง IMAGE เป็น PDF โดยใช้ Python" %}}
...
ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง IMAGE เป็น PDF ใน Python
