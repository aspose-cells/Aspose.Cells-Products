---
title:  Gerar Relatórios em XLS Arquivos via .NET
weight: 1700
description: C# código-fonte para gerar relatórios no formato XLS em .NET Framework, .NET Core, Mono ou plataformas Xamarin.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para Montagem XLS via C#" %}}
...
1. Salve o resultado no formato XLS por meio do método WorkbookDesigner.Worbook.Save
...
{{% blocks/products/pf/agp/code-block title="Gerar XLS Relatórios" offSpacer="" %}}
