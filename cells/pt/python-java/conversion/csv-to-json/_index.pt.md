---
title: Converter CSV para JSON via Python
url: /pt/python-java/conversion/csv-to-json/
description: Código de amostra para conversão de csv para json Python. Use o código de exemplo API para arquivos csv em lote para conversão json no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter CSV para JSON usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter CSV em JSON via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos CSV em JSON em apenas algumas linhas de código.
