---
title:  Hợp nhất XLSX Tệp via Java
weight: 8930
description: Mã mẫu Java để kết hợp các tài liệu XLSX trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng XLSX trong Java" h2="Hợp nhất tài liệu gốc XLSX bằng cách sử dụng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước gộp file XLSX vào Java" %}}
...
+ Tải file XLSX đầu tiên với instance của lớp Workbook.
+ Tải tài liệu XLSX thứ hai với một thể hiện của lớp Workbook.
+ Gộp file bằng phương thức Combine().
+ lưu file XLSX đã merge vào đường dẫn xác định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tập tin XLSX - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến XLSX Sáp nhập Demo trực tiếp" sectionDescription=" Hợp nhất tài liệu XLSX ngay bây giờ bằng cách truy cập của chúng tôi[Trang web demo trực tiếp](https://products.aspose.app/cells/merger). Bản demo trực tiếp có những lợi ích sau" >}}
