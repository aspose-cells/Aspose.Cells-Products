...
{{% cells-convert title="Kostenlose App und Beispielcode zum Online-Konvertieren von ODS in FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="fods" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie ODS über Python in FODS" %}}

{{% blocks/products/pf/agp/text %}}

 Python-Entwickler können ODS in nur wenigen Codezeilen problemlos laden und in FODS konvertieren.
