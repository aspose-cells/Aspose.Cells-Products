---
title: Conversor PHP XLTX para EXCEL - XLTX para EXCEL
description: Aspose Excel. Converta XLTX para EXCEL de forma rápida e fácil com Aspose.Cells. PHP XLTX para EXCEL. PHP Salve XLTX no EXCEL. Salve XLTX como EXCEL usando PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converta XLTX para EXCEL em PHP" h2="Biblioteca PHP de alta velocidade para conversão de XLTX para EXCEL. Esta é uma solução de software profissional para importar e exportar XLTX, EXCEL e muitos outros formatos usando PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Salve XLTX no EXCEL em PHP" %}}
...
Precisa converter arquivos XLTX para EXCEL programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX para EXCEL em apenas algumas linhas de código.
...
1.  Converta XLTX em EXCEL chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de XLTX para EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter XLTX para EXCEL" %}}
