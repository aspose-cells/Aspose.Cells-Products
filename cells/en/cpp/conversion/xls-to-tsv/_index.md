...
description: Sample C++ conversion code for XLS to TSV format. Programmers can use this source code for batch XLS to TSV conversion within any C++ Application.
---
