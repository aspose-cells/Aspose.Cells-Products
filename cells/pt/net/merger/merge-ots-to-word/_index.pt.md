---
title:  Mesclar OTS para WORD via C#
url: /pt/net/merger/merge-ots-to-word/ 
description: Mesclar OTS para WORD online gratuitamente. Fusão on-line gratuita de OTS para WORD. Mesclar OTS para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar OTS para WORD em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar OTS para WORD online" InputFormat="ots" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
