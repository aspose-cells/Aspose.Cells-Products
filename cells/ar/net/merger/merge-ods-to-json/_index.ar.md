---
title: دمج ODS إلى JSON - اجمع ODS إلى JSON في C#
url: /ar/net/merger/merge-ods-to-json/ 
description: Aspose إكسل. C# Aspose.Cells. الدمج المجاني عبر الإنترنت ODS إلى JSON saveformat. C# اجمع ODS إلى تنسيق JSON. دمج ODS إلى JSON في C#. ODS دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج ODS إلى JSON في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج ODS مع JSON في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج ODS إلى JSON. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف JSON. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج ODS إلى JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني عبر الإنترنت لدمج ODS إلى JSON في C#" InputFormat="ods" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية الدمج ODS إلى JSON عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج ODS مع JSON برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة .NET لدمج ODS إلى JSON" %}}
