...
description: Aspose اكسل. قم بتحويل IMAGE إلى TXT بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى TXT. C++ احفظ IMAGE إلى TXT. احفظ IMAGE كـ TXT باستخدام C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصورة إلى TXT في C++" h2="تحويل IMAGE عالي الأداء إلى TXT باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى TXT برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى TXT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى TXT عن طريق استدعاء طريقة Save().
