...
{{% blocks/products/pf/agp/content h2="Sla FODS op in SVG in C++" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar SVG in C++.
...
Moet je bestanden met de extensie FODS programmatisch converteren naar SVG? Ontwikkelaars van C++ kunnen bestanden met de extensie FODS eenvoudig converteren naar SVG met slechts een paar regels code.
