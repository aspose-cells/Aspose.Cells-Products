...
{{% blocks/products/pf/agp/content h2="How to Create POWERPOINT in Java" %}}
...
1.  Save the workbook as POWERPOINT format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create POWERPOINT file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create POWERPOINT file" %}}
{{% blocks/products/pf/agp/text %}}
