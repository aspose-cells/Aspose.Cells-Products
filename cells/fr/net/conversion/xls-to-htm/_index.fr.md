---
title: C# XLS en HTM - Convertisseur XLS en HTM
description: Aspose Exceller. Convertissez XLS en HTM rapidement et facilement avec Aspose.Cells. C# XLS en HTM. C# Enregistrez XLS dans HTM. Enregistrez XLS en tant que HTM en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLS dans HTM au C#" %}}

L'exemple suivant montre comment convertir XLS en HTM dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en HTM. Téléchargez votre fichier XLS, puis enregistrez-le simplement en tant que fichier HTM. Pour la lecture XLS et l'écriture HTM, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage HTM de sortie seront identiques au document XLS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir XLS en HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en HTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en HTM par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en HTM en quelques lignes de code seulement.
