---
title: Converti SPREADSHEETML in JSON tramite Java 
url: /it/java/conversion/spreadsheetml-to-json/ 
description: Esempio di codice di conversione Java per il formato SPREADSHEETML in file JSON. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in JSON all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti SPREADSHEETML in JSON tramite Java" h2="Conversione da SPREADSHEETML a JSON Java per convertire pagine singole o multiple in JSON utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire SPREADSHEETML in JSON utilizzando Java" %}}

 Per eseguire il rendering di SPREADSHEETML in JSON, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire SPREADSHEETML in JSON tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente il file SPREADSHEETML in JSON in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file SPREADSHEETML con un'istanza della classe Workbook1. Crea un intervallo di dati da esportare utilizzando il metodo Cells.createRange1. Chiama il metodo JsonUtility.exportRangeToJson con riferimenti a Range & ExportRangeToJsonOptions1. Scrivi i dati JSON della stringa su file tramite il metodo BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML in JSON Java codice sorgente di conversione" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live di conversione SPREADSHEETML in JSON" sectionDescription="[Converti SPREADSHEETML in JSON](https://products.aspose.app/cells/conversion/spreadsheetml-to-json) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file SPREADSHEETML, verrà convertito istantaneamente in JSON." >}}
