---
title: Python XLSX naar CIJFERS - XLSX naar CIJFERS Omzetter
...
{{% blocks/products/pf/agp/content h2="Converteer XLSX naar getallen in de Excel-bibliotheek Python" %}}

 Hoe converteer ik XLSX naar getallen? Met behulp van de NET-bibliotheek kunt u XLSX eenvoudig programmatisch naar getallen converteren met slechts een paar regels code.[Aspose.Cells for Python via NET](https://pypi.org/project/aspose-cells-python/)is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardformaten.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Sla XLSX op in de map NUMBERS in de Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u XLSX naar getallen kunt converteren in de Excel-bibliotheek Python.
{{% blocks/products/pf/agp/text %}}

Volg deze eenvoudige stappen om XLSX naar NUMBERS te converteren. Upload uw XLSX-bestand en sla het vervolgens op als een NUMBERS-bestand. Zowel voor het lezen van XLSX als voor het schrijven naar NUMBERS kunt u volledig gekwalificeerde bestandsnamen gebruiken. De inhoud en opmaak van het NUMBERS-bestand zijn identiek aan die van het originele XLSX-document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Voorbeeldcode om XLSX naar NUMBERS te converteren met behulp van de Excel-bibliotheek Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="numbers" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar cijfers?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden van het type XLSX programmatisch converteren naar NUMBERS? Ontwikkelaars van Python kunnen bestanden van het type XLSX eenvoudig laden en converteren naar NUMBERS met slechts een paar regels code.
...
1.  Converteer XLSX naar NUMBERS door de Workbook.save-methode aan te roepen.
1.  Bereken het resultaat van de conversie van XLSX naar cijfers.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om XLSX naar getallen te converteren" %}}
