---
title: Java PRN ke ET - Konverter PRN ke ET
description: Aspose Unggul. Konversi PRN ke ET dengan cepat dan mudah dengan Aspose.Cells. Java PRN ke ET. Java Simpan PRN ke ET. Simpan PRN sebagai ET menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah PRN menjadi ET di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi PRN ke ET. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, ET, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan PRN ke ET di Java" %}}

Contoh berikut menunjukkan cara mengonversi PRN ke ET di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PRN ke ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke ET secara terprogram? Pengembang Java dapat dengan mudah mengonversi PRN ke ET hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengkonversi PRN ke ET" %}}
{{% blocks/products/pf/agp/text %}}
