...
description: Aspose Эксель. C++ Создайте файл ODS быстро и легко с помощью Aspose.Cells. Создайте файл ODS с помощью C++. Создайте ODS в C++. C++ ODS Creater.
...
1.  Сохраните книгу как файл .ods, используя метод Save().
