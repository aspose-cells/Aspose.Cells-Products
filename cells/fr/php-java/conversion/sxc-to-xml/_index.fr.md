---
title: PHP SXC en XML - Convertisseur SXC en XML
description: Aspose Exceller. Convertissez SXC en XML rapidement et facilement avec Aspose.Cells. PHP SXC en XML. PHP Enregistrez SXC au format XML. Enregistrez SXC au format XML en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Convertir SXC en XML à l\'aide de PHP" %}}
 ...
 Comment convertir SXC en XML ? Avec la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir SXC en XML par programme avec quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. PHP Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
...
Besoin de convertir les fichiers SXC en XML par programme ? Les développeurs PHP peuvent facilement charger et convertir SXC en XML en quelques lignes de code.
...
1.  Convertissez SXC en XML en appelant la méthode de sauvegarde du classeur.
