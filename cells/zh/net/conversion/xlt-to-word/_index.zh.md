---
title: C# XLT转WORD - 在线XLT转WORD转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将XLT转换为WORD保存格式。 C# XLT 为 WORD 格式。将 XLT 保存到 WORD C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 XLT 转换为 C# 中的 WORD" h2="用于将 XLT 转换为 WORD 的高速 C# 库。这是一款专业的软件解决方案，可在.NET Framework、.NET Core或Mono平台上导入和导出XLT、WORD和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="免费将XLT保存到C#在线的WORD中" %}}

下面的例子演示如何将XLT转换为C#中的WORD。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLT 转换为 WORD。上传您的 XLT 文件，然后将其保存为 WORD 文件。对于 XLT 读取和 WORD 写入，您可以使用完全限定的文件名。输出的 WORD 内容和格式将与原始 XLT 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免费应用程序和示例代码将 XLT 在线转换为 WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLT 转换为 WORD" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 文件转换为 WORD 吗？ .NET 开发人员只需几行代码即可轻松加载 XLT 并将其转换为 WORD。
