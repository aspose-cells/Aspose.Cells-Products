---
title: Voeg FODS samen met TSV - Combineer FODS met TSV in C#
url: /nl/net/merger/merge-fods-to-tsv/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen FODS naar TSV saveformat. C# Combineer het formaat FODS tot TSV. Samenvoegen FODS tot TSV in C#. FODS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg FODS samen met TSV in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u FODS samenvoegt met TSV in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om FODS samen te voegen met TSV. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand TSV. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat FODS samenvoegt met TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om FODS samen te voegen tot TSV in C#" InputFormat="fods" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe FODS samen te voegen met TSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u FODS programmatisch samenvoegen tot TSV? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om FODS samen te voegen tot TSV" %}}
