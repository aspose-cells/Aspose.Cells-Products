---
title:  Wstaw obraz do Excela, używając Python via Java
weight: 200
description: Python via Kod źródłowy Java umożliwiający wstawienie obrazu do programu Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw obraz do Excela, używając Python via Java" h2="Wstaw zdjęcia za pomocą numeru Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić obraz do pliku Excel przy użyciu Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić obraz do pliku Excel przy użyciu Python via Java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji zdjęć[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)), aby wstawić obrazek do wybranego arkusza.
...
{{% blocks/products/pf/agp/code-block title="Wstaw zdjęcie - Python via Java" offSpacer="" %}}
