---
title:  Fusionner TXT vers POWERPOINT via Java
...
L'exemple suivant montre comment fusionner TXT à POWERPOINT dans Java.
...
{{% cells-merger title="Application gratuite pour fusionner TXT vers POWERPOINT en ligne" InputFormat="txt" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
