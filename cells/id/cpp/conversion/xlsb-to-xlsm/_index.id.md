...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLSB ke XLSM hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLSB menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (XLSM).1. File XLSM akan disimpan di jalur yang ditentukan.1. Buka file XLSM di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLSB ke XLSM C++ Kode Sumber Konversi" offSpacer="" %}}
