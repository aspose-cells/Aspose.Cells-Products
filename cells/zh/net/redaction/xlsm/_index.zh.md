---
title: 搜索并替换 XLSM 文档 via .NET 中的文本
weight: 2370
...
{{< blocks/products/pf/i18n/upper-banner h1="编辑 XLSM C# 格式" h2="本机高性能 XLSM 使用服务器端 Aspose.Cells for .NET API 记录敏感的编辑信息，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
