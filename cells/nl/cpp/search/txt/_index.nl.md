...
weight: 5090
description: C++ voorbeeldcode om woorden met patroon te zoeken in bestand TXT op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Zoek TXT Formaten in C++" h2="Native en krachtige TXT documentzoekfunctie met behulp van server-side Aspose.Cells for C++ API\'s, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe TXT-bestanden te zoeken met C++" %}}
...
Laad het bestand TXT door een IWorkbook-klasse te instantiëren.
...
+ Bewaar TXT-bestand met behulp van de methode IWorkbook->Save(.).
