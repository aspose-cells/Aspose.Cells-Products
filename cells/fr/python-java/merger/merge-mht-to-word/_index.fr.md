...
url: /fr/python-java/merger/merge-mht-to-word/ 
...
L'exemple suivant montre comment fusionner MHT avec WORD dans Aspose.Cells for Python via Java.
...
Besoin de fusionner MHT avec WORD par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
