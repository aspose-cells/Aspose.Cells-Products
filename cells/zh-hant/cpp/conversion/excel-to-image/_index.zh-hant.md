...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 EXCEL 轉換為 IMAGE。C++ EXCEL 到 IMAGE。 C++ 將EXCEL儲存到影像。使用 C++ 將 EXCEL 儲存為 IMAGE。
...
{{% blocks/products/pf/agp/content h2="使用 C++ 將 EXCEL 轉換為 IMAGE" %}}
...
{{% blocks/products/pf/agp/content h2="將EXCEL儲存到IMAGE中C++" %}}

下面的範例示範如何將C++中的EXCEL轉換為IMAGE。
...
{{% cells-convert title="將 EXCEL 轉換為 IMAGE 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="png" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何將EXCEL轉換為IMAGE通過C++" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 EXCEL 檔案轉換為 IMAGE？ C++ 開發人員只需幾行程式碼即可輕鬆將 EXCEL 轉換為 IMAGE。
...
1. 使用工作簿載入 EXCEL 檔案。
1. 透過呼叫 Save() 方法將 EXCEL 轉換為 IMAGE。
1. 取得EXCEL到IMAGE的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ 將 EXCEL 轉換為 IMAGE 的函式庫" %}}
