---
title: Konvertera XLT till TIFF via applikationen C++ 

description: Exempel på C++-konverteringskod för XLT-dokument till TIFF-format. Programmerare kan använda den här källkoden för batchkonvertering av XLT till TIFF inom alla C++-program.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera XLT-fil till TIFF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLT-fil med Factory::CreateIWorkbook.1. Välj det första kalkylbladet.1. Ställ in (TIFF) alternativ.1. Iterera genom varje sida av arket och rendera.1. Öppna TIFF-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="XLT till TIFF C++ omvandlingskällkod" offSpacer="" %}}
