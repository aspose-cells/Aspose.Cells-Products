...
url: /pl/python-net/merger/merge-excel-to-spreadsheetml/ 
...
Poniższy przykład pokazuje, jak połączyć EXCEL z SPREADSHEETML w Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć EXCEL z SPREADSHEETML? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
