---
title:  Insérer l'objet OLE (Object Linking and Embedding) dans Excel via .NET
weight: 170
description: C# code source pour insérer un objet OLE (Object Linking and Embedding) dans Excel sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérer un objet OLE dans Excel via .NET" h2="Insérez des objets à l\'aide d\'API côté serveur sans aucun logiciel comme Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Comment insérer un objet OLE dans un fichier Excel à l\'aide de C#" %}}

 Afin d'insérer un objet OLE dans un fichier Excel, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer un objet OLE dans un fichier Excel via C#" %}}
...
+ Sélectionnez Feuille de travail via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addoleobject) pour insérer un objet OLE dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer un objet OLE - C#" offSpacer="" %}}
