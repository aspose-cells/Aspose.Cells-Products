---
title: Java HTM na BMP - Konwerter online HTM na BMP
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwertuj HTM na format zapisu BMP. Java HTM do formatu BMP. Zapisz HTM pod numerem BMP Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM pod numerem BMP w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować HTM na BMP w Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTM na BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki HTM na BMP? Java programiści mogą łatwo przekonwertować HTM na BMP w zaledwie kilku wierszach kodu.
...
1.  Konwertuj HTM na BMP, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji HTM na BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java do konwersji HTM na BMP" %}}
{{% blocks/products/pf/agp/text %}}
