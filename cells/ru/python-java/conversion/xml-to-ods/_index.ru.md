...
description: Aspose Эксель. Быстро и легко конвертируйте XML в ODS с помощью Aspose.Cells. Python XML в ODS. Python Сохраните XML в ODS. Сохраните XML как ODS, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразование XML в ODS с помощью Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML в ODS в Python." %}}

В следующем примере показано, как преобразовать XML в ODS в Python.
...
{{% cells-convert title="Пример кода для преобразования XML в ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="ods" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека Python для преобразования XML в ODS" %}}
