---
title: Как нарисовать или вставить форму стрелки локтя в Excel с помощью Python via.Net
weight: 10
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке формы стрелки локтя в файл Excel с помощью Python via.Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) чтобы вставить фигуру локтевой стрелки на выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка локтя в форме стрелки - Python via .Net" offSpacer="" %}}
