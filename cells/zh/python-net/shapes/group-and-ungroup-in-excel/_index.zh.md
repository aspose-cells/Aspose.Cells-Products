...
{{% blocks/products/pf/agp/content h2="如何使用 Python via .Net 对 Excel 文件中的形状进行分组和取消分组" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via .Net 在 Excel 文件中对形状进行分组和取消分组的步骤" %}}
...
+ 通过索引选择工作表。
 + 使用[分组法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/group/)对选定工作表中的形状进行分组
 + 使用[取消分组方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/ungroup/)取消选定工作表中形状的分组
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="对形状进行分组和取消分组 - Python via .Net via .NET" offSpacer="" %}}
