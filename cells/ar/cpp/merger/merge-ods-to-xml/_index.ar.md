...
url: /ar/cpp/merger/merge-ods-to-xml/ 
...
يوضح المثال التالي كيفية دمج ODS في XML في Aspose.Cells for C++.
...
{{% cells-merger title="نموذج التعليمات البرمجية لدمج ODS إلى XML في C++" InputFormat="ods" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج ODS إلى XML عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج ODS في XML برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لدمج ODS في XML" %}}
