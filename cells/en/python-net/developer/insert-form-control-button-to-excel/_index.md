...
weight: 200
url: /python-net/developer/insert-form-control-button-to-excel/ 
...
{{% blocks/products/pf/agp/content h2="How to Insert Button(Form control) into Excel File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Button(Form control) to Excel file via Python" %}}
...
+  Use the shapecollection's [add method](https://apireference.aspose.com/cells/java/com.aspose.cells/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)) to insert a Button(Form control) in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert Button(Form control) - Python" offSpacer="" %}}
