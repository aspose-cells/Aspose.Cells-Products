---
title: C# FODS в OTS - FODS в OTS Конвертер
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в OTS в C#" %}}

Следующий пример демонстрирует, как преобразовать код FODS в формат OTS в коде C#.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать FODS в OTS через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно конвертировать файлы FODS в OTS? Разработчики .NET могут легко загрузить и преобразовать FODS в OTS всего за несколько строк кода.
...
1.  Преобразуйте FODS в формат OTS, вызвав метод Workbook.Save.
1.  Получите результат преобразования FODS в OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования FODS в формат OTS" %}}
