...
{{% blocks/products/pf/agp/content h2="Převeďte XLSB na CSV pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XLSB na CSV v Python.
