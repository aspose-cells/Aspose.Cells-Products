...
description: Aspose Excel. Converta XLS em TXT de forma rápida e fácil com Aspose.Cells. C++ XLS em TXT. C++ Salve XLS em TXT. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em TXT usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para TXT em C++" %}}

O exemplo a seguir demonstra como converter XLS em TXT em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="txt" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em TXT por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em TXT programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em TXT em apenas algumas linhas de código.
...
1.  Converta XLS em TXT chamando o método Save().
