...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása TAB-raDELIMITED a következővel: Java" %}}

 Ahhoz, hogy az SXC-t TABDELIMITED-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az SXC konvertálásához TABLEDELIMITED a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak SXC fájlt TABDELIMITED formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TABDELIMITED kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TABDELIMITED fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="SXC – TABDELIMITED Java Konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az SXC fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.sxc");
// az SXC mentése TABDELIMITED néven
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC-ből TABDELIMITED konverziós élő bemutatók" sectionDescription="[Az SXC konvertálása TAB-raDELIMITED](https://products.aspose.app/cells/conversion/sxc-to-tabdelimited) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel SXC-fájlját, és azonnal TABDELIMITED-re konvertálódik." >}}
