---
title:  Sloučit XML na XPS via Java
url: /cs/java/merger/merge-xml-to-xps/ 
description: Sloučit XML na XPS Online zdarma. Bezplatná online fúze XML na XPS. Sloučit XML do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XML do XPS v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XML na XPS online" InputFormat="xml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
