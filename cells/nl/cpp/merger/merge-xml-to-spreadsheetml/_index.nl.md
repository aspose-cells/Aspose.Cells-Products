---
title: XML samenvoegen met SPREADSHEETML - Combineer XML met SPREADSHEETML in C++
url: /nl/cpp/merger/merge-xml-to-spreadsheetml/ 
description: Aspose Excel. C++ Aspose.Cells. XML samenvoegen naar SPREADSHEETML-opslagformaat. C++ Combineer XML naar SPREADSHEETML-formaat. Voeg XML samen met SPREADSHEETML in C++. XML samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XML samen met SPREADSHEETML in C++" %}}

Het volgende voorbeeld laat zien hoe u XML kunt samenvoegen met SPREADSHEETML in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XML samen te voegen met SPREADSHEETML. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het SPREADSHEETML-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ waarin XML wordt samengevoegd met SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XML samen te voegen met SPREADSHEETML in C++" InputFormat="xml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XML samenvoegen met SPREADSHEETML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XML programmatisch samenvoegen met SPREADSHEETML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
