---
title: Converter XLTM para MD através do aplicativo C++ 
url: /pt/cpp/conversion/xltm-to-md/ 
description: Exemplo de código de conversão C++ para documento XLTM para formato MD. Os programadores podem usar esse código-fonte para conversão em lote de XLTM para MD em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem facilmente converter arquivos XLTM para MD em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLTM usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com a extensão de arquivo (MD).1. arquivo MD será salvo no caminho especificado.1. Abra o arquivo MD em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLTM para MD C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de XLTM para MD" sectionDescription="[Converter XLTM para MD](https://products.aspose.app/cells/conversion/xltm-to-md) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo XLTM, ele será convertido instantaneamente para MD." >}}
