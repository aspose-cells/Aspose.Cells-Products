...
description: Aspose เอ็กเซล. C++ สร้างไฟล์ SXC อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ SXC โดยใช้ C++ สร้าง SXC ใน C++ C++ SXC Creater
...
1.  บันทึกสมุดงานเป็นไฟล์ .sxc โดยใช้เมธอด Save()
