---
title: Python PRN na SVG - PRN na SVG Konwerter
description: Aspose Excel. Konwertuj PRN na SVG szybko i łatwo za pomocą Aspose.Cells. Python PRN na SVG. Python Zapisz PRN na SVG. Zapisz PRN jako SVG używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj PRN na SVG za pomocą Python" %}}
 ...
 Jak przekonwertować PRN na SVG? Dzięki bibliotece Aspose.Cells for Python możesz łatwo programowo przekonwertować PRN na SVG za pomocą kilku linijek kodu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Zapisz PRN pod numerem SVG w Python" %}}

Poniższy przykład ilustruje sposób konwersji PRN na SVG w Python.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować PRN na SVG. Prześlij plik PRN, a następnie po prostu zapisz go jako plik SVG. Zarówno do odczytu PRN, jak i do zapisu SVG można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego numeru SVG będą identyczne z oryginalnym dokumentem PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji PRN na SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="svg" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować PRN na SVG przez Python" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki PRN na SVG? Programiści Python mogą łatwo załadować i przekonwertować PRN na SVG w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj PRN na SVG, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji PRN na SVG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji PRN na SVG" %}}
