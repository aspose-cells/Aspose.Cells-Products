...
{{% blocks/products/pf/agp/content h2="Save HTML to MARKDOWN in C#" %}}

The following example demonstrates how to convert HTML to MARKDOWN in C#.
...
{{% cells-convert title="Sample Code to Convert HTML to MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert HTML to MARKDOWN via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert HTML files to MARKDOWN programmatically? .NET developers can easily load & convert HTML to MARKDOWN in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert HTML to MARKDOWN" %}}
