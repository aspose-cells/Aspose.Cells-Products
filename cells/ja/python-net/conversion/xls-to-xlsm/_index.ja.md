...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLS を XLSM にすばやく簡単に変換します。Python XLS を XLSM に変換します。Python XLS を XLSM に保存します。Python Excel ライブラリを使用して、XLS を XLSM として保存します。
