...
{{% blocks/products/pf/agp/content h2="Hogyan készítsünk MD-t a Python-ben" %}}
...
{{% blocks/products/pf/agp/code-block title="A mintakód bemutatja, hogyan kell MD-fájlt létrehozni a Python-ben." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python könyvtár az MD fájl létrehozásához" %}}
