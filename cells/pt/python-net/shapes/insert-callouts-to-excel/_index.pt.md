---
title: Insira frases de destaque no Excel usando Python via .Net
weight: 360
description: Python via Código-fonte .Net para inserir frases de destaque no Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insira frases de destaque no Excel usando Python via .Net" h2="Insira chamadas usando Aspose.Cells\' API sem nenhum software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir frases de destaque no arquivo do Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir chamadas no arquivo Excel usando Python via .Net" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o add da coleção de formas[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) para inserir Chamadas na planilha selecionada.
...
{{% blocks/products/pf/agp/code-block title="Inserir Chamadas - Python via .Net" offSpacer="" %}}
...
Visão geral dos tipos de chamada
 ...
 AutoFormaTipo.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12" style="font-size:0.8rem !important;">
 AutoFormaTipo.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR3
    </p>
   </div>
  </div>
 </div>
