...
{{% blocks/products/pf/agp/content h2="Save XLS to NUMBERS in C#" %}}

The following example demonstrates how to convert XLS to NUMBERS in C#.
...
{{% cells-convert title="Sample Code to Convert XLS to NUMBERS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="numbers" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLS to NUMBERS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert XLS files to NUMBERS programmatically? .NET developers can easily load & convert XLS to NUMBERS in just a few lines of code.
...
1.  Convert XLS to NUMBERS by calling Workbook.Save method.
1.  Get the conversion result of XLS to NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# library to convert XLS to NUMBERS" %}}
