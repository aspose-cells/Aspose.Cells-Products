---
title:  Extrahera text och bilder från XLSB dokument via .NET
weight: 2200
description: C# källkod för att extrahera text och bilder från filen XLSB på .NET Framework, .NET Core, Mono eller Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att analysera XLSB filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Parse XLSB Filer - C#" offSpacer="" %}}
