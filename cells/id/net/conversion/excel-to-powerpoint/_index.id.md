---
title: C# EXCEL ke POWERPOINT - Konverter EXCEL ke POWERPOINT
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi EXCEL ke format POWERPOINT, memungkinkan penyimpanan data EXCEL ke format POWERPOINT dengan mudah menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversi EXCEL ke POWERPOINT di C#" h2="Pustaka berkecepatan tinggi C# untuk mengkonversi EXCEL ke POWERPOINT. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor EXCEL, POWERPOINT, dan banyak format lainnya pada Framework .NET, Core .NET, atau Platform Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POWERPOINT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan EXCEL ke POWERPOINT di C#" %}}

Contoh berikut menunjukkan cara mengkonversi EXCEL ke POWERPOINT di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengkonversi EXCEL ke POWERPOINT. Unggah file EXCEL Anda, lalu simpan saja sebagai file POWERPOINT. Baik untuk membaca EXCEL maupun menulis ke POWERPOINT, Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format POWERPOINT yang dihasilkan akan identik dengan dokumen EXCEL asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi EXCEL ke POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi EXCEL ke POWERPOINT melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file EXCEL ke POWERPOINT secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengkonversi EXCEL ke POWERPOINT hanya dalam beberapa baris kode.
...
1.  Konversikan EXCEL ke POWERPOINT dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi EXCEL ke POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# pustaka untuk mengkonversi EXCEL ke POWERPOINT" %}}
