---
title: Slå samman HTML till XLS - Kombinera HTML till XLS i C#
url: /sv/net/merger/merge-html-to-xls/ 
description: Aspose Excel. C# Aspose.Cells. Slå samman HTML till XLS sparaformat. C# Kombinera HTML till XLS format. Slå samman HTML till XLS i C#. HTML Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman HTML till XLS i C#" %}}

Följande exempel visar hur man slår samman HTML till XLS i Aspose.Cells for .NET.
...
{{% cells-merger title="Exempelkod för att slå samman HTML till XLS i C#" InputFormat="html" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman HTML till XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman HTML till XLS programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
