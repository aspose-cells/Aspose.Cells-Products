...
description: Aspose Excel. Konvertieren Sie XLS schnell und einfach in MD mit Aspose.Cells. C# XLS in MD. C# Speichern Sie XLS in MD. Speichern Sie XLS als MD unter C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bei MD in C#" %}}

Das folgende Beispiel zeigt, wie XLS in MD in C# konvertiert wird.
...
{{% cells-convert title="Beispielcode zum Konvertieren von XLS in MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in MD" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in MD konvertieren? .NET-Entwickler können XLS in nur wenigen Codezeilen problemlos laden und in MD konvertieren.
...
1.  Konvertieren Sie XLS in MD, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in MD" %}}
