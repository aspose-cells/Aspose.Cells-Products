...
{{% blocks/products/pf/agp/content h2="XLSM-fájl elemzése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM-fájlok elemzésének lépései a következőben: Java" %}}
...
+ Töltse be az XLSM-dokumentumot a Workbook osztály segítségével.
...
{{% blocks/products/pf/agp/code-block title="XLSM-fájlok elemzése – Java" offSpacer="" %}}
