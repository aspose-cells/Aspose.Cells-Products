---
title: Sloučit ODS až XLAM - Sloučit ODS až XLAM v Python
url: /cs/python-java/merger/merge-ods-to-xlam/ 
description: Aspose Excel. Python Excel. Sloučit ODS do XLAM uložit formát. Python Kombinujte formát ODS až XLAM. Sloučit ODS až XLAM v knihovně Excel Python. ODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS do XLAM pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS až XLAM v Python knihovně Excel" %}}

Následující příklad ukazuje, jak sloučit ODS až XLAM v Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení ODS do XLAM. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLAM. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí ODS do XLAM.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit ODS do XLAM přes Python Excel Library" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit ODS až XLAM? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python ke sloučení ODS až XLAM" %}}
