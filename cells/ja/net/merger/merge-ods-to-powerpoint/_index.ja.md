---
title: ODS を POWERPOINT に結合 - ODS を C# の POWERPOINT に結合
url: /ja/net/merger/merge-ods-to-powerpoint/ 
description: Aspose エクセル。 C# Aspose.Cells。ODS を POWERPOINT 保存形式にマージします。 C# ODSをPOWERPOINT形式に結合します。 ODS を C# の POWERPOINT にマージします。 ODS マージします。
...
{{% blocks/products/pf/agp/content h2="ODS を C# の POWERPOINT にマージします" %}}

次の例は、ODS を Aspose.Cells for .NET の POWERPOINT にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、ODS を POWERPOINT にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルを結合し、PowerPoint ファイルに保存します。 C# でコードを開発する場合、これは思っているより簡単です。 ODS を POWERPOINT にマージする C# の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS を C# の POWERPOINT にマージするサンプル コード" InputFormat="ods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="ODS を経由して POWERPOINT に ODS をマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

ODS をプログラムで POWERPOINT にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="ODS を POWERPOINT にマージするための .NET ライブラリ" %}}
