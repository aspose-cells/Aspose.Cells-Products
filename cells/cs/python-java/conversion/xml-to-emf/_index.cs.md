...
{{% blocks/products/pf/agp/content h2="Převeďte XML na EMF pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XML na EMF v Python.
