...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกตัวควบคุม ActiveX ในเวิร์กชีตที่เลือก
