---
title: Converti SPREADSHEETML in PDF tramite l'applicazione C++ 
url: /it/cpp/conversion/spreadsheetml-to-pdf/ 
description: Esempio di codice di conversione C++ per un documento SPREADSHEETML in formato PDF. I programmatori possono utilizzare questo codice sorgente per la conversione batch da SPREADSHEETML a PDF all'interno di qualsiasi C++ Applicazione.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti FOGLIO DI LAVORO ML in PDF tramite C++" h2="Conversione da SPREADSHEETML a PDF ad alte prestazioni utilizzando la libreria C++ senza la necessità di installare Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file SPREADSHEETML in PDF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file SPREADSHEETML utilizzando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (PDF).1. Il file PDF verrà salvato nel percorso specificato.1. Apri il file PDF in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML in PDF C++ Codice sorgente di conversione" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML in PDF Conversione demo dal vivo" sectionDescription="[Converti FOGLIO DI LAVOROML in PDF](https://products.aspose.app/cells/conversion/spreadsheetml-to-pdf) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file SPREADSHEETML, verrà convertito istantaneamente in PDF." >}}
