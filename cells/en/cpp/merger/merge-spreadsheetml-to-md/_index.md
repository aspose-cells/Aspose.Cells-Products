...
description: Aspose Excel. C++ Aspose.Cells. Merge SPREADSHEETML to MD saveformat. C++ Combine SPREADSHEETML to MD format. Merge SPREADSHEETML to MD in C++. SPREADSHEETML Merge.
...
{{% blocks/products/pf/agp/content h2="Merge SPREADSHEETML to MD in C++" %}}
...
{{% cells-merger title="Sample Code to Merge SPREADSHEETML to MD in C++" InputFormat="xml" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
