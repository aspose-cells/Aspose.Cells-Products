...
weight: 7290
description: Código de muestra Java para editar o ver metadatos del formato XLSB en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{% blocks/products/pf/agp/content h2="Cómo extraer metadatos de XLSB utilizando Java" %}}

 Para obtener metadatos del archivo XLSB, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 Acceda a información útil almacenada en el archivo XLSB, incluido cuándo se recibió, procesó, registró la fecha y hora del archivo XLSB, etc.
...
+ Guarde la información de metadatos XLSB
