---
title: C# ODS 轉 ET - 在線 ODS 轉 ET 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 ODS 轉換為 ET 保存格式。 C# ODS 為 ET 格式。將 ODS 保存到 ET C#。
...
{{% blocks/products/pf/agp/content h2="免費將 ODS 保存到 C# 中的 ET" %}}

以下示例演示如何將 ODS 轉換為 C# 中的 ET。
...
{{% cells-convert title="將 ODS 轉換為 ET 的免費應用程序和示例代碼在線" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 ODS 轉換為 ET" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 ODS 文件轉換為 ET？ .NET 開發人員只需幾行代碼即可輕鬆加載 ODS 並將其轉換為 ET。
...
{{% blocks/products/pf/agp/content h2="C#庫將ODS轉換為ET" %}}
