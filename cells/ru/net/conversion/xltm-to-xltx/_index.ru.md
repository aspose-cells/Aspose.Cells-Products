...
Нужно программно преобразовать файлы XLTM в XLTX? Разработчики .NET могут легко загрузить и преобразовать XLTM в XLTX всего за несколько строк кода.
...
1.  Преобразуйте значение XLTM в XLTX, вызвав метод Workbook.Save.
