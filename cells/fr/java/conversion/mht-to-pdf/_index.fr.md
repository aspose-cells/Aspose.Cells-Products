---
title: Java MHT en PDF - Convertisseur MHT en PDF
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le MHT au format PDF, permettant un enregistrement transparent des données MHT au format PDF à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez MHT au PDF dans Java" %}}

L'exemple suivant montre comment convertir MHT en PDF en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir MHT en PDF. Téléchargez votre fichier MHT, puis enregistrez-le simplement sous le nom de fichier PDF. Pour la lecture MHT et l'écriture PDF, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie PDF seront identiques au document MHT original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir MHT en PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="pdf" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHT en PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT au format PDF par programmation ? Les développeurs spécialisés peuvent facilement convertir les fichiers MHT au format PDF en quelques lignes de code seulement.
