---
title: HTM samenvoegen naar XLTM - HTM combineren naar XLTM in Java
url: /nl/java/merger/merge-htm-to-xltm/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online HTM samenvoegen naar XLTM opslagformaat. Java Combineer HTM naar formaat XLTM. HTM samenvoegen naar XLTM in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="HTM samenvoegen tot XLTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met XLTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen tot XLTM" %}}
