---
title: Converteer SPREADSHEETML naar TIFF via Python
url: /nl/python-java/conversion/spreadsheetml-to-tiff/
description: Voorbeeldcode voor conversie van spreadsheetml naar tiff Python. Gebruik API voorbeeldcode voor batch-spreadsheetml-bestanden naar tiff-conversie binnen de Python-toepassing.
---
...
{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML naar TIFF te converteren met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om SPREADSHEETML naar TIFF te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen eenvoudig SPREADSHEETML-bestanden laden en converteren naar TIFF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad SPREADSHEETML-bestand met een exemplaar van Workbook1. Roep de methode Workbook.Save aan1. Geef uitvoerpad door met TIFF-extensie als parameter1. Controleer het opgegeven pad voor het resulterende TIFF-bestand
...
{{% cells-convert title="Gratis app en voorbeeldcode om SPREADSHEETML naar TIFF te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="tiff" IsLandingPage="true" language="python" %}}
