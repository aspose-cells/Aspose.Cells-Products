---
title: C# HTML ila XLS - HTML ila XLS Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde HTML'i XLS'e dönüştürün. C# HTML'i XLS'e dönüştürün. C# HTML'i XLS'e kaydedin. HTML'i 07611134 olarak kaydedin 81, C#'i kullanarak.
...
{{% blocks/products/pf/agp/content h2="HTML\'i C#\'e XLS\'e kaydedin" %}}

Aşağıdaki örnek, HTML'in C#'de XLS'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="HTML\'i XLS\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML\'i C# aracılığıyla XLS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

HTML dosyalarını program aracılığıyla XLS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyebilir ve XLS'e dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="HTML\'i XLS\'e dönüştürmek için C# kitaplığı" %}}
