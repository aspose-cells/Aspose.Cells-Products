...
هل تحتاج إلى تحويل ملفات HTM إلى HTML برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى HTML في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى HTML باستدعاء طريقة Save ().
