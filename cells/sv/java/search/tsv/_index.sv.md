---
title: Sök i TSV-dokument utan att öppna via Java 
weight: 4940
url: /sv/java/search/tsv/ 
description: Java exempelkod för att söka efter ord med mönster i TSV-fil i Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sök i TSV-format i Java" h2="Inbyggd och högpresterande TSV-dokumentsökning med hjälp av API:er på serversidan Aspose.Cells for Java, utan användning av någon programvara som Microsoft eller Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Så här söker du TSV-fil med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att söka efter TSV-filer i Java" %}}
...
+ Ladda TSV-fil genom att instansiera ett arbetsboksobjekt.
+ Gå till det första kalkylbladet i TSV-filen.
...
{{% blocks/products/pf/agp/code-block title="Sök i TSV-filer - Java" offSpacer="" %}}

```cs
// Instantiera ett arbetsboksobjekt
Workbook workbook = new Workbook(dataDir + "book1.tsv");

// Åtkomst till det första kalkylbladet i TSV-filen
