---
title: Maak ODS (Openoffice / Lbreoffice) Bestanden aan via C++
description: ODS maker. Maak ODS bestanden in C++ code. Genereer ODS (Openoffice / Lbreoffice) bestanden met behulp van de C++ applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Maak ODS-bestand aan via C++" h2="Native en krachtige ODS (Openoffice / Lbreoffice) spreadsheetcreatie programmatisch zonder Micorsoft Office met behulp van de C++-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe ODS aan te maken via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Het is gemakkelijk voor de ontwikkelaars om ODS-bestanden te maken, laden, wijzigen en converteren binnen lopende rapportagetoepassingen voor gegevensverwerking in slechts enkele regels code.
...
1.  Sla de werkmap op als .ods-bestand met de methode Save().

{{% blocks/products/pf/agp/code-block title="De volgende broncode laat zien hoe u een ODS (Openoffice / Lbreoffice)-bestand kunt maken met behulp van C++." offSpacer="" %}}
