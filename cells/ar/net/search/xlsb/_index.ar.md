---
title:  ابحث عن مستند XLSB بدون فتح via .NET
weight: 8880
description: C# الكود المصدري للبحث عن الكلمات ذات النمط في ملف XLSB على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
