---
title: Převeďte XLTM na XLS pomocí aplikace C++ 

description: Ukázka převodního kódu C++ pro dokument XLTM na formát XLS. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLTM na XLS v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLTM na XLS pomocí C++" %}}

 Abychom převedli XLTM na XLS, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu XLTM na XLS prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLTM na XLS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLTM pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLS).1. Soubor XLS bude uložen do zadané cesty.1. Otevřete soubor XLS v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLTM na XLS C++" offSpacer="" %}}
