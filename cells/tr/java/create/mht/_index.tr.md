---
title: MHT Oluştur - Java'de MHT dosyası oluşturun
description: Aspose Excel. Aspose.Cells for Java kütüphanesi ile MHT dosyalarını zahmetsizce oluşturun ve işleyin. Bu güçlü API, MHT dosyalarını doğrudan Java uygulamalarınız içinde oluşturmak, düzenlemek ve yönetmek için akıcı ve verimli bir çözüm sunarak, geliştiricilerin özel ihtiyaçlarını yüksek hassasiyetle karşılar.
...
{{% blocks/products/pf/agp/content h2="Java numaralı cihazda MHT nasıl oluşturulur?" %}}
...
1.  save() yöntemini kullanarak çalışma kitabını MHT formatında kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, Java numaralı cihazda MHT dosyasının nasıl oluşturulacağını göstermektedir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesi MHT dosyası oluşturmak için" %}}
{{% blocks/products/pf/agp/text %}}
