---
title: Slå samman XML till ODS - Kombinera XML till ODS i C#
url: /sv/net/merger/merge-xml-to-ods/ 
description: Aspose Excel. C# Aspose.Cells. Free Online Merge XML to ODS saveformat. C# Kombinera XML till ODS format. Slå samman XML till ODS i C#. XML Merge.
...
{{% blocks/products/pf/agp/content h2="Slå samman XML till ODS i C# Online gratis" %}}

Följande exempel visar hur man slår samman XML till ODS i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att sammanfoga XML till ODS. Ladda upp dina filer, anrop Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen ODS. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman XML med ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman XML till ODS i C#" InputFormat="xml" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man sammanfogar XML till ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XML till ODS programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XML till ODS" %}}
