...
Вам нужно программно преобразовать XML-файлы в SXC? Разработчики C++ могут легко преобразовать XML в SXC всего за несколько строк кода.
