...
Нужно программно конвертировать файлы XLTM в XLS? Разработчики C++ могут легко преобразовать XLTM в XLS всего за несколько строк кода.
