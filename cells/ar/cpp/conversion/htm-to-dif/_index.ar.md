...
هل تحتاج إلى تحويل ملفات HTM إلى DIF برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى DIF في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى DIF باستدعاء طريقة Save ().
