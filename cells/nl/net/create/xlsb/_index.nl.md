---
title: Creëer XLSB - Creëer XLSB bestand in C#
description: Aspose Excel. C# Creëer XLSB-bestand. Creëer XLSB C#. C# XLSB Maker. Maak XLSB in C#. Genereer XLSB-bestand met C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak XLSB-bestand in C#" h2="Snelle C#-bibliotheek voor het maken van XLSB. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten op .NET Framework, .NET Core of Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe XLSB te maken in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een XLSB-bestand maakt in C#." offSpacer="" %}}
