---
title: C# XLTM tot JSON - XLTM tot JSON Converter
description: Aspose Excel. Converteer XLTM snel en eenvoudig naar JSON met Aspose.Cells. C# XLTM naar JSON. C# Bewaar XLTM in JSON. Bewaar XLTM als 07611134 81 via C#.
...
{{% blocks/products/pf/agp/content h2="Bewaar XLTM t/m JSON in C#" %}}
...
{{% blocks/products/pf/agp/content h2="Hoe u XLTM naar JSON kunt converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLTM-bestanden programmatisch naar JSON converteren? .NET-ontwikkelaars kunnen XLTM eenvoudig in slechts een paar regels code laden en converteren naar JSON.
