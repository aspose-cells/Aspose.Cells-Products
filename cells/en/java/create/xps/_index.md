...
description: Aspose Excel. Java Create XPS File quickly and easily with Aspose.Cells. Generate XPS file using Java. Create XPS in Java. Java XPS Creater. 
...
{{% blocks/products/pf/agp/content h2="How to Create XPS in Java" %}}
...
1.  Save the workbook as XPS format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create XPS file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create XPS file" %}}
{{% blocks/products/pf/agp/text %}}
