...
{{< blocks/products/pf/i18n/upper-banner h1="แปลง HTML เป็น PDF ใน C#" h2="ไลบรารีความเร็วสูง C# สำหรับแปลง HTML เป็น PDF นี่คือโซลูชันซอฟต์แวร์ระดับมืออาชีพสำหรับการนำเข้าและส่งออก HTML, PDF และรูปแบบอื่นๆ อีกมากมายบนเฟรมเวิร์ก .NET, คอร์ .NET หรือแพลตฟอร์ม Mono" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
1.  แปลง HTML เป็น PDF โดยเรียกใช้เมธอด Workbook.Save
