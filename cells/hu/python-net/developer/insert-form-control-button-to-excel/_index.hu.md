...
{{% blocks/products/pf/agp/content h2="Gomb (űrlapvezérlő) beszúrása Excel-fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A gomb (Űrlapvezérlő) beszúrásának lépései az Excel-fájlba a Python számon keresztül" %}}
...
+ Használja a shapecollection hozzáadási módszerét, hogy beszúrjon egy gombot (Űrlapvezérlőt) a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Beszúrás gomb (Űrlapvezérlő) - Python" offSpacer="" %}}
