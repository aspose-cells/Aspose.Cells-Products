...
{{% blocks/products/pf/agp/content h2="Převeďte XML na DOCX pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XML na DOCX v Python.
