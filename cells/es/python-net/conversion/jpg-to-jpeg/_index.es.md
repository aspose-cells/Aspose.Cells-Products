---
title: Python JPG a JPEG - Convertidor JPG a JPEG
description: Aspose Excel. Python Excel. Convierta JPG a JPEG rápida y fácilmente con Aspose.Cells. Python JPG a JPEG. Python Guarde JPG en JPEG. Guarde JPG como JPEG usando Python Biblioteca de Excel.
...
{{% blocks/products/pf/agp/content h2="Convierta JPG a JPEG en la biblioteca de Excel Python" %}}

 ¿Cómo convierto JPG a JPEG? Con Aspose.Cells for Python a través de la biblioteca NET, puede convertir fácilmente JPG a JPEG mediante programación con unas pocas líneas de código.[Aspose.Cells for Python vía NET](https://pypi.org/project/aspose-cells-python/)es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Guarde JPG en JPEG en Python Biblioteca de Excel" %}}

El siguiente ejemplo demuestra cómo convertir JPG a JPEG en la biblioteca de Excel Python.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir JPG a JPEG. Cargue su archivo JPG y luego simplemente guárdelo como archivo JPEG. Tanto para la lectura de JPG como para la escritura JPEG, puede utilizar nombres de archivo completos. El contenido y el formato de salida JPEG serán idénticos al documento JPG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir JPG a JPEG a través de la biblioteca de Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir JPG a JPEG" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos JPG a JPEG mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente JPG a JPEG con solo unas pocas líneas de código.
...
1.  Convierta JPG a JPEG llamando al método Workbook.save.
1.  Obtenga el resultado de la conversión de JPG a JPEG.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Biblioteca de Excel para convertir JPG a JPEG" %}}
