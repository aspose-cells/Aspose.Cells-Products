...
weight: 200
description: C# code source pour insérer une image dans Excel sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/code-block title="Insérer une image - C#" offSpacer="" %}}
