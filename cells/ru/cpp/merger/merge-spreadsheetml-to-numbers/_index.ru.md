---
title:  Объединить SPREADSHETML в NUMBERS по номеру C++
...
В следующем примере показано, как объединить SPREADSHEETML с NUMBERS в C++.
