---
title: Chuyển XLTX sang PDF qua ứng dụng C++ 
url: /vi/cpp/conversion/xltx-to-pdf/ 
description: Mã chuyển đổi C++ mẫu cho tài liệu XLTX sang định dạng PDF. Lập trình viên có thể sử dụng mã nguồn này để chuyển đổi hàng loạt XLTX sang PDF trong bất kỳ Ứng dụng C++ nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển XLTX sang PDF qua C++" h2="Chuyển đổi XLTX sang PDF hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp XLTX sang PDF chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLTX bằng Factory :: CreateIWorkbook.1. Gọi phương thức Save ().1. Chuyển đường dẫn tệp đầu ra với phần mở rộng tệp (PDF).1. Tập tin PDF sẽ được lưu theo đường dẫn đã chỉ định.1. Mở tệp PDF trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi XLTX sang PDF C++" offSpacer="" %}}
