---
title: C# NOMBRES en XML - Convertisseur de NOMBRES en XML
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les nombres au format XML, permettant un enregistrement transparent des données NUMBERS au format XML à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer les NOMBRES au format XML dans C#" %}}

L'exemple suivant montre comment convertir des NOMBRES en XML dans C#.
...
{{% cells-convert title="Exemple de code pour convertir des nombres en XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en XML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en XML par programme ? Les développeurs .NET peuvent facilement charger et convertir NUMBERS en XML en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en XML en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir des nombres en XML" %}}
