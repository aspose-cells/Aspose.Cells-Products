...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLSB を PPTX にすばやく簡単に変換します。Python XLSB を PPTX に変換します。Python XLSB を PPTX に保存します。Python Excel ライブラリを使用して、XLSB を PPTX として保存します。
