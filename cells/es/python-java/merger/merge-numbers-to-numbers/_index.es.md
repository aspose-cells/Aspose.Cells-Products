...
El siguiente ejemplo muestra cómo fusionar NÚMEROS con NÚMEROS en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar NÚMEROS a NÚMEROS en línea" InputFormat="numbers" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
