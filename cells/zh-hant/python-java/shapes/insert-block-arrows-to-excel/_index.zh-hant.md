---
title: 使用 Python via Java 將方塊箭頭插入 Excel
weight: 338
description: Python via Java 將區塊箭頭插入 Excel 的原始程式碼。
keywords: [Python Aspose.Cells., Python add block arrows., Python insert block arrows., Python create block arrows]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="使用 Python via Java 將方塊箭頭插入 Excel" h2="使用 Aspose.Cells\' API 插入塊箭頭，無需任何軟體，如 Microsoft 或 Open Office、Adobe PDF 等。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via Java 將箭頭插入 Excel 文件" %}}

為了將區塊箭頭插入 Excel 文件，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via Java 將區塊箭頭插入 Excel 檔案的步驟" %}}
...
+ 透過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)在選定的工作表中插入區塊箭頭
以 XLSX 格式儲存工作簿。
...
下面的範例程式碼示範如何插入「右箭頭」。有關更多類型，請參閱下面的“塊箭頭形狀類型概述”。

{{% blocks/products/pf/agp/code-block title="插入箭頭塊 - Python via Java" offSpacer="" %}}
