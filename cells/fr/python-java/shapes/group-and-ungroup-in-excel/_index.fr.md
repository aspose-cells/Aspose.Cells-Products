...
weight: 371
description: Regrouper et dissocier des objets en utilisant Aspose.Cells' Python via Java API sans aucun logiciel tel que Microsoft ou Open Office, Adobe PDF, etc.
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[méthode de groupe](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#group(com.aspose.cells.Shape[])) pour regrouper les formes dans la feuille de calcul sélectionnée
 + Utilisez le[méthode de dissociation](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#ungroup(com.aspose.cells.GroupShape)) pour dissocier les formes dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Regrouper et dissocier les formes - Python via Java" offSpacer="" %}}
