---
title: Fusionner XLS à PPTX - Combiner XLS à PPTX dans C#
url: /fr/net/merger/merge-xls-to-pptx/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite XLS au format de sauvegarde PPTX. C# Combinez le format XLS au format PPTX. Fusionner XLS à PPTX dans C#. XLS Fusionner.
...
L'exemple suivant montre comment fusionner XLS à PPTX dans Aspose.Cells for .NET.
...
{{% cells-merger title="Gratuit en ligne pour fusionner XLS à PPTX en C#" InputFormat="xls" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS à PPTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLS à PPTX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
