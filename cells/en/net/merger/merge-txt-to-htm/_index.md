---
title: Merge TXT to HTM - Combine TXT to HTM via C#
url: /net/merger/merge-txt-to-htm/ 
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. TXT Merge. Free Online Merge TXT to HTM C#. C# Merge TXT to HTM format. Combine TXT to HTM in C#.
keywords: [Aspose Excel., C# Aspose.Cells., C# Aspose Cells., TXT Merge., C# Merge TXT to HTM., Free Online Merge TXT to htm in C#., C# Combine TXT to HTM format Online for Free]
---
...
The following example demonstrates how to merge TXT to HTM in Aspose.Cells for .NET.
...
{{% cells-merger title="Free Online to Merge TXT to HTM in C#" InputFormat="txt" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="How to Merge TXT to HTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to merge TXT to HTM programmatically? A basic document merging and concatenating with [Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs can be done with just few lines of code.
