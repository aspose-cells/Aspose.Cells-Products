...
description: Aspose Excel. Chuyển đổi OTS sang PNG nhanh chóng và dễ dàng với Aspose.Cells. Python OTS sang PNG. Python Lưu OTS thành PNG. Lưu OTS thành PNG sử dụng Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi OTS sang PNG ở Python" h2="Thư viện Python tốc độ cao chuyển đổi OTS sang PNG. Đây là giải pháp phần mềm chuyên nghiệp để nhập xuất OTS, PNG và nhiều định dạng khác sử dụng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu OTS về PNG trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi OTS thành PNG trong Python.
...
{{% cells-convert title="Mã mẫu chuyển đổi OTS thành PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="png" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi OTS thành PNG" %}}
