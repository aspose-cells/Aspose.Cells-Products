...
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci RadioButton (controllo modulo) in Excel utilizzando Python via java" h2="Inserisci oggetti utilizzando le API lato server senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire RadioButton (controllo modulo) nel file Excel utilizzando Python via java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa la collezione di forme[aggiungere metodo](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) per inserire un RadioButton(Controllo modulo) nel foglio di lavoro selezionato.
