---
title: Voeg PRN samen met MHT - Combineer PRN met MHT in Python
url: /nl/python-net/merger/merge-prn-to-mht/ 
description: Aspose Excel. Python Aspose.Cells. Gratis online PRN samenvoegen naar MHT-opslagformaat. Python Combineer PRN naar MHT-formaat. Voeg PRN samen met MHT in Python. PRN samenvoegen.
...
Het volgende voorbeeld laat zien hoe u PRN kunt samenvoegen met MHT in Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Gratis online om PRN samen te voegen met MHT in Python" InputFormat="prn" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="PRN samenvoegen met MHT via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PRN programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
