...
Hai bisogno di convertire i file MHT in XPS a livello di programmazione? Gli sviluppatori C++ possono facilmente convertire MHT in XPS in poche righe di codice.
...
1.  Converti MHT in XPS chiamando il metodo Save().
