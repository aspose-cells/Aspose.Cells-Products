...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en MD en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en MD via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir des fichiers XLS en MD en quelques lignes de code seulement.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="md" IsLandingPage="true" language="python" %}}
