---
title:  Вставить овал в Excel via Java
weight: 40
...
{{% blocks/products/pf/agp/content h2="Как вставить овал в файл Excel с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке овала в файл Excel via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addOval-int-int-int-int-int-int-) чтобы вставить овал в выбранный рабочий лист
...
{{% blocks/products/pf/agp/code-block title="Вставка овальная - Java" offSpacer="" %}}
