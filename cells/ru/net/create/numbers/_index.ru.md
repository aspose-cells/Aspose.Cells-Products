---
title: Создать NUMBERS - Создать файл NUMBERS в C#
description: Aspose Excel. C# Создать файл NUMBERS. Создать НОМЕРА C#. C# Создатель НОМЕРОВ. Создайте NUMBERS в C#. Создайте файл NUMBERS, используя C#.
...
{{% blocks/products/pf/agp/content h2="Как создать НОМЕРА в C#" %}}
...
1.  Используйте метод Сохранить, чтобы сохранить книгу как файл NUMBERS.

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл NUMBERS в C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# библиотека для создания файла NUMBERS" %}}
