---
title: Java aracılığıyla XLS'yi SPREADSHEETML'ye dönüştürün 
url: /tr/java/conversion/xls-to-spreadsheetml/ 
description: XLS biçimi için SPREADSHEETML dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada SPREADSHEETML'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla XLS\'yi SPREADSHEETML\'ye dönüştürün" h2="Şirket içi Java kitaplığını kullanarak tek veya birden çok sayfayı SPREADSHEETML\'ye dönüştürmek için XLS\'den SPREADSHEETML\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak XLS\'yi SPREADSHETML\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla XLS\'yi SPREADSHEETML\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla XLS dosyasını SPREADSHEETML'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. XLS dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. SPREADSHEETML uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Sonuç SPREADSHEETML dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="XLS - SPREADSHETML Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// XLS dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.xls");
// XLS'yi SPREADSHETML olarak kaydet
