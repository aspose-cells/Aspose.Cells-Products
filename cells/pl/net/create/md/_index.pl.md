...
{{% blocks/products/pf/agp/content h2="Jak utworzyć MD w C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści mogą łatwo tworzyć, ładować, modyfikować i konwertować pliki MD w ramach różnych aplikacji raportujących do przetwarzania danych w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik MD w C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteka do tworzenia pliku MD" %}}
