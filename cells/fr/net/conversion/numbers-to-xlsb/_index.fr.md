---
title: C# NOMBRES en XLSB - Convertisseur NOMBRES en XLSB
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les NUMBERS au format XLSB, permettant un enregistrement transparent des données NUMBERS au format XLSB à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros XLSB dans C#" %}}

L'exemple suivant montre comment convertir les NOMBRES de XLSB en C#.
...
{{% cells-convert title="Exemple de code pour convertir des NOMBRES en XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="xlsb" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en XLSB via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en XLSB par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en XLSB en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en XLSB en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en XLSB" %}}
