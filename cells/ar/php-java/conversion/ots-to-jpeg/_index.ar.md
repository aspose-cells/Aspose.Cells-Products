---
title: PHP OTS إلى JPEG - OTS إلى JPEG محول
description: Aspose اكسل. قم بتحويل OTS إلى JPEG بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى JPEG. PHP احفظ OTS إلى JPEG. احفظ OTS كـ JPEG باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى JPEG في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى JPEG. هذا حل برمجي احترافي لاستيراد وتصدير OTS وJPEG والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى JPEG عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى JPEG برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى JPEG في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى JPEG عن طريق استدعاء طريقة حفظ المصنف.
