...
description: Aspose Excel. Python Aspose.Cells. Sloučit XLSB do FODS uložit formát. Python Kombinujte formát XLSB až FODS. Sloučit XLSB až FODS v Python. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až FODS pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až FODS v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLSB až FODS v Python" InputFormat="xlsb" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB na FODS přes Python" %}}
