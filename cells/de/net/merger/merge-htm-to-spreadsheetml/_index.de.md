---
title: HTM mit SPREADSHEETML zusammenführen – Kombinieren Sie HTM mit SPREADSHEETML in C#
url: /de/net/merger/merge-htm-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Kostenlose Online-Zusammenführung von HTM in das SPREADSHEETML-Speicherformat. C# Kombinieren Sie HTM mit dem SPREADSHEETML-Format. HTM mit SPREADSHEETML in C# zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie HTM mit SPREADSHEETML in C# kostenlos online zusammen" %}}

Das folgende Beispiel zeigt, wie HTM in Aspose.Cells for .NET mit SPREADSHEETML zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um HTM mit SPREADSHEETML zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der SPREADSHEETML-Datei. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das HTM mit SPREADSHEETML zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlos online, um HTM in SPREADSHEETML unter C# zusammenzuführen" InputFormat="htm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie HTM über C# mit SPREADSHEETML zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie HTM programmgesteuert mit SPREADSHEETML zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von HTM mit SPREADSHEETML" %}}
