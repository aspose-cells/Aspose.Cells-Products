...
description: Aspose Excel. C++ Aspose.Cells. Slå samman XLT till JSON sparaformat. C++ Kombinera XLT till JSON format. Slå samman XLT till JSON i C++. XLT Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman XLT till JSON i C++" %}}
...
{{% cells-merger title="Exempelkod för att slå samman XLT till JSON i C++" InputFormat="xlt" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
