---
title: C# XML do EXCELu – Převaděč XML do EXCELu
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu XML do formátu EXCEL, což umožňuje bezproblémové ukládání XML dat do formátu EXCEL pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Uložení XML do Excelu v C#" %}}

Následující příklad ukazuje, jak převést XML do formátu EXCEL v adresáři C#.
...
1.  Převeďte XML do formátu EXCEL voláním metody Workbook.Save.
1.  Získejte výsledek převodu XML do EXCELu.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML do formátu EXCEL" %}}
