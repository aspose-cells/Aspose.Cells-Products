...
{{% blocks/products/pf/agp/content h2="Преобразуйте XLT в XLS, используя Python." %}}
...
В следующем примере показано, как преобразовать XLT в XLS в Python.
