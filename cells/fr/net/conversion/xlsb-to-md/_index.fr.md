---
title: C# XLSB en MD - Convertisseur en ligne XLSB en MD
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir XLSB au format de sauvegarde MD. C# XLSB au format MD. Enregistrez XLSB dans MD C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à MD en C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en MD dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLSB en MD. Téléchargez votre fichier XLSB, puis enregistrez-le simplement en tant que fichier MD. Pour la lecture XLSB et l'écriture de MD, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage du MD de sortie seront identiques au document original XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en MD en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en MD par programmation ? Les développeurs de .NET peuvent facilement charger et convertir XLSB en MD en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLSB en MD" %}}
