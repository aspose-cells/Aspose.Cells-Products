---
title: دمج HTM إلى NUMBERS - ادمج HTM في أرقام في C++
url: /ar/cpp/merger/merge-htm-to-numbers/ 
description: Aspose إكسل. C++ Aspose.Cells. مجاني على الإنترنت دمج HTM إلى أرقام حفظ تنسيق. C++ دمج HTM إلى نسق أرقام. دمج HTM إلى أرقام في C++. دمج HTM.
...
{{% blocks/products/pf/agp/content h2="دمج HTM إلى أرقام في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج HTM مع أرقام في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج HTM في NUMBERS. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف NUMBERS. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يقوم بدمج HTM إلى NUMBERS.
...
{{% blocks/products/pf/agp/content h2="كيفية دمج HTM في أرقام عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج HTM في NUMBERS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج HTM إلى أرقام" %}}
