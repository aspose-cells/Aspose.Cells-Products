---
title: Merge PRN to MHT via Java 
...
keywords: [Merge PRN to MHT via Java., PRN to MHT Merger., Merge PRN to MHT Online for Free]
---
...
The following example demonstrates how to merge PRN to MHT in Java.
...
{{% cells-merger title="Free App to merge PRN to MHT on line" InputFormat="prn" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
