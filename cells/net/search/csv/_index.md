...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to SearchВ CSV Files in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="SearchВ CSV Files - C#" offSpacer="" %}}
