...
O exemplo a seguir demonstra como mesclar XLSB a XPS em Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Precisa mesclar XLSB a XPS programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para mesclar XLSB a XPS" %}}
