---
title:  Συγχώνευση FODS σε XLTM μέσω Python
url: /el/python-net/merger/merge-fods-to-xltm/ 
description: Συγχώνευση FODS σε XLTM Online δωρεάν. Δωρεάν Online FODS έως XLTM Συγχώνευση. Συγχώνευση FODS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS με το XLTM στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση FODS με XLTM σε απευθείας σύνδεση" InputFormat="fods" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
