---
title:  병합 TSV 파일 via Java
weight: 9260
description: JSP/JSF 응용 프로그램 및 데스크탑 응용 프로그램용 Java 런타임 환경에서 TSV 문서를 결합하는 Java 샘플 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV 형식을 Java에 병합" h2="서버 측 Java API를 사용하는 기본 TSV 문서 병합." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 TSV 파일을 병합하는 방법" %}}

 TSV 파일을 병합하기 위해 다음을 사용합니다.[Aspose.Cells for Java](https://products.aspose.com/cells/java) API은 기능이 풍부하고 강력하며 사용하기 쉬운 합병 API for Java 플랫폼입니다. 에서 직접 최신 버전을 다운로드할 수 있습니다.[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) pom.xml에 다음 구성을 추가하여 Maven 기반 프로젝트에 설치합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="TSV 파일을 Java에 병합하는 단계" %}}
...
+ Workbook 클래스의 인스턴스로 첫 번째 TSV 파일을 로드합니다.
+ Workbook 클래스의 인스턴스로 두 번째 TSV 문서를 로드합니다.
+ Combine() 메서드를 사용하여 파일을 병합합니다.
+ 병합된 TSV 파일을 지정된 경로에 저장
...
{{% blocks/products/pf/agp/code-block title="TSV 파일 병합 - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="온라인 TSV 합병 라이브 데모" sectionDescription=" 지금 바로 TSV 문서를 병합하세요.[라이브 데모 웹사이트](https://products.aspose.app/cells/merger). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
