...
description: Sample C++ conversion code for XLS to TXT format. Programmers can use this source code for batch XLS to TXT conversion within any C++ Application.
---
