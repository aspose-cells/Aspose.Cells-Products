...
weight: 30
url: /python-net/developer/insert-form-control-checkbox-to-excel/ 
...
+  Use the shapecollection's add method to insert a CheckBox(Form control) in the selected worksheet.
