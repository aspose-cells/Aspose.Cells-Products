...
description: C# source code to combine TSV to XLSM file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="How to Merge TSV to XLSM File Using C#" %}}
 ...
 In order to merge TSV to XLSM file, we’ll use
...
{{% blocks/products/pf/agp/code-block title="Merge TSV to XLSM Files - C#" offSpacer="" %}}
