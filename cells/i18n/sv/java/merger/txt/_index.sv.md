...
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman TXT-format i Java" h2="Native TXT-dokumentsammanslagning med hjälp av Java API:er på serversidan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Så här sammanfogar du TXT-filer med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att slå samman TXT-filer i Java" %}}
...
+ Ladda den första TXT-filen med en instans av Workbook-klassen.
+ Ladda det andra TXT-dokumentet med en instans av Workbook-klassen.
+ Slå samman filer med metoden combine().
+ spara den sammanslagna TXT-filen på angiven sökväg
...
{{% blocks/products/pf/agp/code-block title="Slå samman TXT-filer - Java" offSpacer="" %}}

```cs
// Öppna den första TXT-filen.
Workbook txtFile1 = new Workbook("chartsFileWithPath.txt");

// Definiera den andra källboken.
// Öppna den andra TXT-filen.
