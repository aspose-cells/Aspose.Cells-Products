...
description: Aspose اكسل. قم بتحويل NUMBERS إلى ETT بسرعة وسهولة باستخدام Aspose.Cells. Python NUMBERS إلى ETT. Python حفظ الأرقام في ETT. احفظ الأرقام كـ ETT باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في ETT على Python" %}}

يوضح المثال التالي كيفية تحويل NUMBERS إلى ETT في Python via NET.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل الأرقام إلى ETT" %}}
