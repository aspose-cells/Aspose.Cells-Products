...
هل تحتاج إلى تحويل ملفات MHT إلى DIF برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى DIF بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى DIF عن طريق استدعاء دالة Save().
