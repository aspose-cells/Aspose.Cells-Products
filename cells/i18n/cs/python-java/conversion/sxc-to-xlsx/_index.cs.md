---
title: Převést SXC na XLSX přes Python
url: /cs/python-java/conversion/sxc-to-xlsx/
description: Ukázkový kód pro převod sxc na xlsx Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na xlsx v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na XLSX pomocí Python" %}}

 Abychom převedli SXC na XLSX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod SXC na XLSX prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na XLSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí Workbook1. Zavolejte metodu Workbook.Save1. Jako parametr předejte výstupní cestu s rozšířením XLSX1. Zkontrolujte zadanou cestu pro výsledný soubor XLSX
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlsx" IsLandingPage="true" language="python" %}}
