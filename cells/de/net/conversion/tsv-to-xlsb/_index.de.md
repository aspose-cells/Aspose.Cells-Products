---
title: C# TSV bis XLSB - TSV bis XLSB Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie TSV bis XLSB in C#" %}}

Das folgende Beispiel zeigt, wie man TSV in C# in XLSB umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie TSV über C# in XLSB" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie TSV-Dateien programmgesteuert in XLSB konvertieren? .NET-Entwickler können TSV mit nur wenigen Codezeilen problemlos in XLSB laden und konvertieren.
...
1.  Konvertieren Sie TSV in XLSB durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von TSV in XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von TSV in XLSB" %}}
