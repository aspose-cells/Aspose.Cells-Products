...
description: C# source code to combine MHT to XLSM file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="How to Merge MHT to XLSM File Using C#" %}}
 ...
 In order to merge MHT to XLSM file, we’ll use
...
+  Load all the MHT files with full path.
...
{{% blocks/products/pf/agp/code-block title="Merge MHT to XLSM Files - C#" offSpacer="" %}}
