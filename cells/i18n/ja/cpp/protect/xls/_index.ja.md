...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してXLSファイルを保護する手順" %}}
...
1. IWorkbookクラスを使用してXLSファイルをロードします1. ProtectionTypeとPasswordでProtect（..）メソッドを使用する1. Save（）メソッドで保護されたXLSファイルを保存します
