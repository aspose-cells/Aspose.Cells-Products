---
title: C# OTS'den FODS'e - Çevrimiçi OTS'den FODS'e Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# OTS'yi FODS saveformat'a dönüştürün. C# OTS'den FODS formatına. OTS'yi FODS C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi C# içinde FODS\'e Çevrimiçi olarak Ücretsiz olarak kaydedin" %}}

Aşağıdaki örnek, OTS'nin C#'de FODS'e nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

OTS'yi FODS'e dönüştürmek için kolay adımları izleyin. OTS dosyanızı yükleyin, ardından FODS dosyası olarak kaydedin. Hem OTS okuması hem de FODS yazması için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı FODS içeriği ve biçimlendirmesi, orijinal OTS belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="OTS\'yi Çevrimiçi FODS\'e Dönüştürmek için Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi C# aracılığıyla FODS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

OTS dosyalarını programlı olarak FODS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, OTS'yi yalnızca birkaç satır kodla kolayca yükleyebilir ve FODS'e dönüştürebilir.
...
1.  OTS'nin FODS'e dönüştürme sonucunu alın.
