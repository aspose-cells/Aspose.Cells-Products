...
url: /ja/python-java/merger/merge-xlsx-to-txt/ 
...
次の例は、Aspose.Cells for Python via Java で XLSX を TXT にマージする方法を示しています。
...
XLSXをTXTにプログラムで結合する必要がありますか？基本的な文書の結合と連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
