...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Group And Ungroup Shapes in Excel file via C#" %}}
...
+  Use the [group method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/group/) to group shapes in the selected worksheet
+  Use the [ungroup method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/) to ungroup shapes in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Group And Ungroup Shapes - C#" offSpacer="" %}}
