---
title: Conversor PHP XLTX para JSON - XLTX para JSON
description: Aspose Excel. Converta XLTX em JSON de forma rápida e fácil com Aspose.Cells. PHP XLTX em JSON. PHP Salve XLTX em JSON. Salve XLTX como JSON usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em JSON via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em JSON programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em JSON em apenas algumas linhas de código.
...
1.  Converta XLTX em JSON chamando o método save da pasta de trabalho.
