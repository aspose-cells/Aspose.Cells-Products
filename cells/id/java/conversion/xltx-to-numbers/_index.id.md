---
title: Konverter Java XLTX ke ANGKA - XLTX ke ANGKA
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLTX ke ANGKA di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi XLTX ke NUMBERS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLTX, NUMBERS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke NUMBERS di Java" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX menjadi ANGKA di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLTX ke ANGKA via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file XLTX ke NUMBERS secara terprogram? Pengembang Java dapat dengan mudah mengkonversi XLTX ke NUMBERS hanya dengan beberapa baris kode.
...
1.  Konversikan XLTX ke ANGKA dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari XLTX ke ANGKA.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi XLTX menjadi ANGKA" %}}
{{% blocks/products/pf/agp/text %}}
