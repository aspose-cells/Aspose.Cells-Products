---
title: C# XLS bis XLS - XLS bis XLS Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das Format XLS und ermöglicht das nahtlose Speichern von XLS-Daten im Format XLS mithilfe der Aspose.Cells-Bibliothek – alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis XLS in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in C# in XLS umwandelt.
...
Müssen Sie XLS-Dateien programmgesteuert in XLS konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in XLS laden und konvertieren.
...
1.  Konvertieren Sie XLS in XLS durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in XLS" %}}
