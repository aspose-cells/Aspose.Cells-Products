...
{{< blocks/products/pf/i18n/upper-banner h1="Ξεκλείδωμα αρχείων ODS μέσω Java" h2="Καταργήστε την προστασία από υπολογιστικά φύλλα του Excel, συμπεριλαμβανομένου του αρχείου ODS, χρησιμοποιώντας τη Βιβλιοθήκη Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για ξεκλείδωμα ODS μέσω Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Ξεκλείδωμα αρχείων ODS μέσω C#" offSpacer="" %}}
...
// Καταργώντας την προστασία του ODS
wks.unprotect();
