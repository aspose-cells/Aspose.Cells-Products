...
description: Aspose Excel. Convierta XLT a ET rápida y fácilmente con Aspose.Cells. Python XLT a ET. Python Guardar XLT en ET. Guarde XLT como ET usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XLT en ET en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLT a ET en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLT a ET" %}}
