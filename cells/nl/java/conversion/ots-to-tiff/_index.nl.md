...
{{% blocks/products/pf/agp/content h2="Sla OTS op in TIFF in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar TIFF converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar TIFF via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar TIFF? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar TIFF met slechts een paar regels code.
