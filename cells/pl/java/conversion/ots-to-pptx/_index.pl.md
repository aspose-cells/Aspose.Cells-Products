...
description: Aspose Excel. Konwertuj OTS na PPTX szybko i łatwo za pomocą Aspose.Cells. Java OTS na PPTX. Java Zapisz OTS na PPTX. Zapisz OTS jako PPTX, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS pod numerem PPTX w Java" %}}

Poniższy przykład ilustruje sposób konwersji OTS na PPTX w Java.
...
Chcesz programowo przekonwertować pliki OTS na PPTX? Programiści Java mogą z łatwością przekonwertować OTS na PPTX w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na PPTX" %}}
{{% blocks/products/pf/agp/text %}}
