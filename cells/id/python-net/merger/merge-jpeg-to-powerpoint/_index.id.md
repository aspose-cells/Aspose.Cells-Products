...
url: /id/python-net/merger/merge-jpeg-to-powerpoint/ 
...
Contoh berikut menunjukkan cara menggabungkan JPEG ke POWERPOINT di Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan JPEG ke POWERPOINT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API dapat dilakukan hanya dengan beberapa baris kode.
