...
È necessario convertire i file OTS in TXT a livello di codice? Gli sviluppatori C++ possono convertire facilmente OTS in TXT in poche righe di codice.
...
1.  Converti OTS in TXT chiamando il metodo Save().
