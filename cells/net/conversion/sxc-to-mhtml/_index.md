...
description: Sample code for sxc to mhtml C# conversion. Use API example code for batch sxc files to mhtml conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert SXC to MHTML Using C#" %}}

 In order to convert SXC to MHTML, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert SXC to MHTML via C#" %}}
...
1.  Pass output path with MHTML extension as parameters
...
{{% blocks/products/pf/agp/code-block title="This sample code shows sxc to mhtml C# Conversion" offSpacer="" %}}

{{< gist "aspose-cells-gists" "88c9872508ec3150c552eb5155edf06e" "Convert-sxc-to-mhtml.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert SXC to MHTML" sectionDescription="Check our live demos for [SXC to MHTML conversion](https://products.aspose.app/cells/conversion/sxc-to-mhtml) with following benefits." >}}
