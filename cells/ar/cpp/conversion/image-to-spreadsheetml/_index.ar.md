...
هل تحتاج إلى تحويل ملفات IMAGE إلى SPREADSHEETML برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى SPREADSHEETML في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل IMAGE إلى SPREADSHEETML عن طريق استدعاء طريقة Save ().
