---
title: Konvertor PHP XLAM až PDF - XLAM až PDF
description: Aspose Excel. Převeďte XLAM na PDF rychle a snadno pomocí Aspose.Cells. PHP XLAM na PDF. PHP Uložte XLAM na PDF. Uložte PDF jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="pdf" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na PDF přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na PDF programově? Vývojáři PHP mohou snadno načíst a převést XLAM na PDF v několika řádcích kódu.
...
1.  Převeďte XLAM na PDF voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na PDF" %}}
