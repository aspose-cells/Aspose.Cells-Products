...
description: Aspose Excel。 Python Aspose.Cells. 將 PRN 合併為 ET 儲存格式。 Python 將 PRN 合併為 ET 格式。將 PRN 合併到 Python 中的 ET。PRN 合併。
...
{{% blocks/products/pf/agp/content h2="將 Python 中的 PRN 合併到 ET" %}}
...
{{% cells-merger title="將 PRN 合併到 ET 的範例程式碼（Python）" InputFormat="prn" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python 將 PRN 合併到 ET" %}}
