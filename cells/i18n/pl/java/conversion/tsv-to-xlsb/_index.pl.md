---
title: Konwertuj TSV na XLSB przez Java 
weight: 7570
url: /pl/java/conversion/tsv-to-xlsb/ 
description: Przykładowy kod konwersji Java dla formatu TSV do pliku XLSB. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do XLSB w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TSV na XLSB przez Java" h2="Konwersja TSV do XLSB Java w celu konwersji jednej lub wielu stron do formatu XLSB przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TSV na XLSB za pomocą Java" %}}

 Aby wyrenderować TSV do XLSB, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TSV na XLSB za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik TSV na XLSB w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLSB i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLSB
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji TSV do XLSB Java" offSpacer="" %}}

```cs
// załaduj plik TSV w instancji Workbook
Workbook book = new Workbook("template.tsv");
// zapisz TSV jako XLSB
