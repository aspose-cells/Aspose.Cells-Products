---
title:  Fusionner XLSX à CSV via Python
...
L'exemple suivant montre comment fusionner XLSX à CSV dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner XLSX à CSV en ligne" InputFormat="xlsx" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
