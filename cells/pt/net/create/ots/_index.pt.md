---
title: Criar OTS - Criar arquivo OTS em C#
description: Aspose Excel. Gere e manipule arquivos OTS sem esforço com a biblioteca Aspose.Cells for .NET. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos OTS diretamente em seus aplicativos C#, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
{{% blocks/products/pf/agp/content h2="Como criar um OTS em C#" %}}

{{% blocks/products/pf/agp/text %}}

 É fácil para os desenvolvedores criar, carregar, modificar e converter arquivos OTS na execução de diferentes aplicativos de relatórios para processamento de dados em apenas algumas linhas de código.
...
1.  Use o método Save para salvar a pasta de trabalho como arquivo OTS.

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar um arquivo OTS em C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para criar arquivo OTS" %}}
