---
title: Java XLT na OTS - XLT na konwerter OTS
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLT do formatu OTS, umożliwiając bezproblemowe zapisywanie danych XLT w formacie OTS przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT do OTS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XLT na OTS w Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLT do formatu OTS? Programiści Java mogą łatwo przekonwertować pliki XLT do formatu OTS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLT na OTS, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLT na OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XLT na OTS" %}}
{{% blocks/products/pf/agp/text %}}
