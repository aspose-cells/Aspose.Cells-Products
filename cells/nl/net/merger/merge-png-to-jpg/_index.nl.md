...
Het volgende voorbeeld laat zien hoe u PNG kunt samenvoegen met JPG in Aspose.Cells for .NET.
...
Wilt u PNG programmatisch samenvoegen met JPG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen met JPG" %}}
