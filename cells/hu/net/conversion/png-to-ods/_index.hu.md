...
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára a PNG formátum ODS formátumba konvertálásához, lehetővé téve a PNG adatok zökkenőmentes mentését ODS formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a PNG-et ODS-re a C#-ben" %}}

következő példa bemutatja, hogyan lehet a PNG számot ODS-re konvertálni a C# számrendszerben.
...
{{% cells-convert title="Mintakód a PNG szám ODS-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A PNG konvertálása ODS-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

PNG fájlt programozottan ODS-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a PNG-et ODS-re.
...
1.  Alakítsd át a PNG számot ODS-re a Workbook.Save metódus meghívásával.
1.  Szerezze meg a PNG-es konverziós eredményt ODS-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a PNG-ről ODS-re konvertáláshoz" %}}
