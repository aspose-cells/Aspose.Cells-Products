---
title: XLSX फ़ाइल via .NET में टिप्पणियाँ डालें
url: /hi/net/comments/insert-comments-to-xlsx/ 
description: C# का उपयोग करके XLSX पर टिप्पणियाँ डालें। .NET एप्लिकेशन में टिप्पणियाँ डालने के लिए API उदाहरण कोड का उपयोग करें।
...
{{% blocks/products/pf/agp/content h2="C# के माध्यम से XLSX फ़ाइल में टिप्पणियाँ कैसे सम्मिलित करें" %}}
...
Office 365 में, टिप्पणियाँ वार्तालापों के लिए हैं, आप XLSX फ़ाइल में टिप्पणियाँ सम्मिलित करने और हटाने के लिए निम्नलिखित C# कोड का उपयोग कर सकते हैं।
