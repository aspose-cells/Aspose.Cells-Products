...
url: /zh-hant/net/merger/merge-image-to-mhtml/ 
...
以下範例示範如何將 IMAGE 合併到 Aspose.Cells for .NET 中的 MHTML。
...
需要以程式設計方式將 IMAGE 合併到 MHTML 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 庫將 IMAGE 合併到 MHTML" %}}
