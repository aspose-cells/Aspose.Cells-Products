...
description: Aspose Excel. Java Aspose.Cells. Voeg TSV samen naar OTS-opslagformaat. Java Combineer TSV naar OTS-formaat. Voeg TSV samen met OTS in Java. TSV Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Hoe u TSV samenvoegt met OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TSV programmatisch samenvoegen met OTS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
