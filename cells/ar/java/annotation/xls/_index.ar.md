---
title:  إضافة أو إزالة XLS حاشية via Java
weight: 10040
description: نموذج التعليمات البرمجية Java لحذف التعليقات التوضيحية بتنسيق XLS في Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/content h2="كيفية إضافة تعليق توضيحي إلى ملف XLS باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إضافة أو حذف الحواشي من XLS via Java" %}}
