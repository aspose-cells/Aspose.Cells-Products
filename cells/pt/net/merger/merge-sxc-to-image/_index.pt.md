---
title: Mesclar SXC para IMAGE - Combine SXC para IMAGE em C#
url: /pt/net/merger/merge-sxc-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita SXC para IMAGE saveformat. C# Combine SXC para o formato IMAGEM. Mesclar SXC para IMAGEM em C#. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC para IMAGE em C# Online Gratuitamente" %}}

exemplo a seguir demonstra como mesclar SXC com IMAGE em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar SXC com IMAGE. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo IMAGE. Se você desenvolver código em C#, isso será mais simples do que parece. Veja o exemplo C# que mescla SXC com IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar SXC com IMAGEM em C#" InputFormat="sxc" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC para IMAGE via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SXC para IMAGE programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar SXC para IMAGE" %}}
