---
title: C# JPEG - JPG - JPEG - JPG konverter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára a JPEG JPG formátumba konvertálásához, lehetővé téve a JPEG adatok zökkenőmentes mentését JPG formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a JPEG-es számot JPG formátumban a C#-es fájlban" %}}

A következő példa bemutatja, hogyan konvertálhatja a JPEG fájlt JPG formátumba a C# fájlban.
...
{{% cells-convert title="Mintakód a JPEG JPG-vé konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A JPEG konvertálása JPG-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia a JPEG fájlokat JPG formátumba? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal JPG formátumba konvertálhatják a JPEG-et.
...
1.  Alakítsd át a JPEG-et JPG formátumba a Workbook.Save metódus meghívásával.
1.  Szerezze meg a JPEG konvertálási eredményt JPG-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a JPEG JPG-vé konvertálásához" %}}
