---
title: Konwertuj MHTML na TSV przez Java 
weight: 7070
url: /pl/java/conversion/mhtml-to-tsv/ 
description: Przykładowy kod konwersji Java dla formatu MHTML do pliku TSV. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do TSV w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MHTML na TSV przez Java" h2="Konwersja MHTML na TSV Java w celu konwersji jednej lub wielu stron na TSV przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na TSV za pomocą Java" %}}

 Aby wyrenderować MHTML do TSV, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MHTML na TSV za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik MHTML na TSV w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik MHTML z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem TSV i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku TSV
...
{{% blocks/products/pf/agp/code-block title="MHTML do TSV Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik MHTML w instancji Workbook
Workbook book = new Workbook("template.mhtml");
// zapisz MHTML jako TSV
