---
title: Voeg SPREADSHEETML samen met WORD - Combineer SPREADSHEETML met WORD in C#
url: /nl/net/merger/merge-spreadsheetml-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online SPREADSHEETML samenvoegen naar WORD-opslagformaat. C# Combineer SPREADSHEETML naar WORD-indeling. Voeg SPREADSHEETML samen met WORD in C#. SPREADSHEETML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg SPREADSHEETML samen met WORD in C# Gratis online" %}}

Het volgende voorbeeld laat zien hoe SPREADSHEETML kan worden samengevoegd met WORD in Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis online om SPREADSHEETML samen te voegen met WORD in C#" InputFormat="xml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML samen te voegen met WORD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SPREADSHEETML programmatisch samenvoegen met WORD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
