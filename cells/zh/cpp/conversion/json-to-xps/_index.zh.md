---
title: 通过 C++ 应用程序将 JSON 转换为 XPS 
url: /zh/cpp/conversion/json-to-xps/ 
description: JSON 文档到 XPS 格式的示例 C++ 转换代码。程序员可以在任何 C++ 应用程序中使用此源代码进行批量 JSON 到 XPS 的转换。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将 JSON 转换为 XPS" h2="使用 C++ 库的高性能 JSON 到 XPS 转换，无需安装 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 将 JSON 转换为 XPS" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C++ 将 JSON 转换为 XPS 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 C++ 开发人员只需几行代码即可轻松地将 JSON 文件转换为 XPS。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 JSON 文件。1. 调用 Save() 方法。1. 传递带有 (XPS) 文件扩展名的输出文件路径。1. XPS 文件将保存在指定路径。1. 在兼容程序中打开 XPS 文件。
...
{{% blocks/products/pf/agp/code-block title="JSON 到 XPS C++ 转换源代码" offSpacer="" %}}
