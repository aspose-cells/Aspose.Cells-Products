---
title: Hợp nhất XML thành JSON - Hợp nhất XML thành JSON trong Python
url: /vi/python-java/merger/merge-xml-to-json/ 
description: Aspose Excel. Python Aspose.Cells. Hợp nhất XML trực tuyến miễn phí thành JSON định dạng lưu. Python Kết hợp định dạng XML thành JSON. Hợp nhất XML thành JSON trong Python. Hợp nhất XML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XML thành JSON Sử dụng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XML thành JSON trong Python Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất XML thành JSON trong Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất XML thành JSON. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp, sau đó lưu vào tệp JSON. Nếu bạn phát triển mã trong Python, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Python hợp nhất XML thành JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất XML thành JSON trong Python" InputFormat="xml" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XML thành JSON qua Python" %}}
