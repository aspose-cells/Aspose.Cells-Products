---
title: TABDELIMITED'i Java aracılığıyla MHTML'ye dönüştürün 

description: TABDELIMITED biçimi için MHTML dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada MHTML'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED\'i Java aracılığıyla MHTML\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı MHTML\'ye dönüştürmek için TABDELIMITED\'den MHTML\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TABDELIMITED\'i MHTML\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden TABDELIMITED\'i MHTML\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, TABDELIMITED dosyasını yalnızca birkaç satır kodla kolayca MHTML'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. Parametre olarak MHTML uzantısı ve SaveFormat ile çıktı yolunu iletin1. Ortaya çıkan MHTML dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED - MHTML Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TABDELIMITED dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.tabdelimited");
// TABDELIMITED'i MHTML olarak kaydet
