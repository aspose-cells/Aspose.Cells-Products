...
url: /cs/python-java/merger/merge-spreadsheetml-to-svg/ 
...
Následující příklad ukazuje, jak sloučit SPREADSHEETML do SVG v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit SPREADSHEETML do SVG? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
