---
title: PHP JPG para HTML - Conversor JPG para HTML
description: Aspose Excel. Converta JPG em HTML de forma rápida e fácil com Aspose.Cells. PHP JPG em HTML. PHP Salve JPG em HTML. Salve JPG como HTML usando PHP.
...
{{% cells-convert title="Exemplo de código para converter JPG em HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="html" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter JPG para HTML via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPG para HTML programaticamente? Os desenvolvedores de PHP podem facilmente carregar e converter JPG para HTML em apenas algumas linhas de código.
...
1.  Converta JPG em HTML chamando o método save da pasta de trabalho.
