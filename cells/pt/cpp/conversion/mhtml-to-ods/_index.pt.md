...
description: Aspose Excel. Converta MHTML em ODS de forma rápida e fácil com Aspose.Cells. C++ MHTML em ODS. C++ Salve MHTML em ODS. Salve MHTML como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta MHTML em ODS usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve MHTML para ODS em C++" %}}

O exemplo a seguir demonstra como converter MHTML em ODS em C++.
...
{{% cells-convert title="Exemplo de código para converter MHTML em ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="ods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter MHTML em ODS por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos MHTML em ODS programaticamente? Os desenvolvedores do C++ podem converter facilmente MHTML em ODS em apenas algumas linhas de código.
...
1.  Converta MHTML em ODS chamando o método Save().
