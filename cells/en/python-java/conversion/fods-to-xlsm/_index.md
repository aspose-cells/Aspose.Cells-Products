...
Follow the easy steps to convert FODS into XLSM. Upload your FODS file, then simply save it as XLSM file. For both FODS reading and XLSM writing you can use fully qualified filenames. The output XLSM content and formatting will be identical to the original FODS document.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Python developers can easily load & convert FODS to XLSM in just a few lines of code.
