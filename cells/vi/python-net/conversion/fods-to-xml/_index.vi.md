...
description: Aspose Excel. Chuyển đổi FODS sang XML nhanh chóng và dễ dàng với Aspose.Cells. Python FODS sang XML. Python Lưu FODS vào XML. Lưu FODS dưới dạng XML bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi FODS sang XML trong Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu FODS vào XML trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi FODS sang XML trong Python via NET.
...
{{% cells-convert title="Mã mẫu để chuyển đổi FODS sang XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xml" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python để chuyển đổi FODS sang XML" %}}
