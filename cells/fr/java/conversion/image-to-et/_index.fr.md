---
title: Java IMAGE en ET - Convertisseur IMAGE en ET
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE dans ET dans Java" %}}

L'exemple suivant montre comment convertir une IMAGE en ET dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir une IMAGE en ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE au format ET par programmation ? Les développeurs de Java peuvent facilement convertir des fichiers IMAGE au format ET en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en ET" %}}
{{% blocks/products/pf/agp/text %}}
