...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL do ET w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować format EXCEL na ET w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu ET? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu ET za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA do ET" %}}
{{% blocks/products/pf/agp/text %}}
