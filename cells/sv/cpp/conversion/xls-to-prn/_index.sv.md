...
description: Aspose Excel. Denna omfattande lösning ger C++-utvecklare en helt integrerad metod för att konvertera XLS till PRN-format, vilket möjliggör sömlös sparning av XLS-data till PRN-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C++-kod.
...
{{% blocks/products/pf/agp/content h2="Konvertera XLS till PRN med hjälp av C++" %}}
...
{{% blocks/products/pf/agp/content h2="Spara XLS till PRN i C++" %}}
...
Behöver du konvertera XLS-filer till PRN programmatiskt? C++-utvecklare kan enkelt konvertera XLS till PRN med bara några få rader kod.
...
1.  Konvertera XLS till PRN genom att anropa Save()-metoden.
