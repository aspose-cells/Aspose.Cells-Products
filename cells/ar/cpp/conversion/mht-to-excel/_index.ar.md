---
title: C++ MHT إلى EXCEL - محول MHT عبر الإنترنت إلى EXCEL
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ قم بتحويل MHT إلى EXCEL saveformat. C++ MHT إلى تنسيق EXCEL. احفظ MHT في EXCEL C++.
...
{{% blocks/products/pf/agp/content h2="وفر MHT إلى EXCEL في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى EXCEL برمجيًا؟ يمكن للمطورين C++ تحويل MHT إلى EXCEL بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1. تحويل MHT إلى EXCEL باستدعاء طريقة Save ().
1.  احصل على نتيجة تحويل MHT إلى EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ مكتبة لتحويل MHT إلى EXCEL" %}}
