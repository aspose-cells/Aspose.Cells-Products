---
title: OTS maken - OTS-bestand maken in Java
description: Aspose Excel. Java OTS-bestand maken. Maak OTS Java. Java OTS Creator. Maak OTS in Java. Genereer OTS-bestand met Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een OTS-bestand in Java" h2="High-speed Java-bibliotheek voor het maken van een OTS-bestand. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe OTS te maken in Java" %}}
...
1.  Sla de werkmap op in OTS-indeling met behulp van de methode save().

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een OTS-bestand maakt in Java." offSpacer="" %}}
