---
title: สร้าง MHT - สร้างไฟล์ MHT ใน Java
description: Aspose เก่ง. Java สร้างไฟล์ MHT สร้าง MHT Java Java สร้าง MHT สร้าง MHT ใน Java สร้างไฟล์ MHT โดยใช้ Java
...
{{< blocks/products/pf/i18n/upper-banner h1="สร้างไฟล์ MHT ใน Java" h2="ไลบรารี Java ความเร็วสูงสำหรับสร้างไฟล์ MHT นี่เป็นโซลูชันซอฟต์แวร์ระดับมืออาชีพสำหรับนำเข้าและส่งออก XLSX, PDF และรูปแบบอื่นๆ อีกมากมายโดยใช้ Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีสร้าง MHT ใน Java" %}}
...
1.  บันทึกสมุดงานเป็นรูปแบบ MHT โดยใช้วิธีบันทึก ()

{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างแสดงวิธีสร้างไฟล์ MHT ใน Java" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="ไลบรารี Java เพื่อสร้างไฟล์ MHT" %}}
{{% blocks/products/pf/agp/text %}}
