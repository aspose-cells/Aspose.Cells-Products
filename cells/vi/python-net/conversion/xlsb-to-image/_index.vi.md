...
description: Aspose Excel. Chuyển đổi XLSB sang IMAGE nhanh chóng và dễ dàng với Aspose.Cells. Python XLSB sang IMAGE. Python Lưu XLSB vào HÌNH ẢNH. Lưu XLSB dưới dạng HÌNH ẢNH bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSB thành HÌNH ẢNH trong Python" %}}

 Làm cách nào để chuyển đổi XLSB thành HÌNH ẢNH? Với Aspose.Cells for Python qua thư viện NET, bạn có thể dễ dàng chuyển đổi XLSB sang IMAGE theo chương trình chỉ với một vài dòng mã.[Aspose.Cells for Python qua NET](https://pypi.org/project/aspose-cells-python/)có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, hiển thị và in tất cả các tệp Excel. Python Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó biến nó thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Lưu XLSB vào IMAGE trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSB thành IMAGE trong Python via NET.
...
{{% cells-convert title="Mã mẫu để chuyển đổi XLSB thành HÌNH ẢNH" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="png" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLSB thành HÌNH ẢNH" %}}
