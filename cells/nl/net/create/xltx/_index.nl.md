---
title: Maak XLTX aan - Maak XLTX-bestand aan in C#
description: Aspose Excel. C# Maak XLTX snel en eenvoudig een bestand met Aspose.Cells. Genereer een XLTX-bestand met C#. Maak XLTX aan in C#. C# XLTX Creater.
...
{{% blocks/products/pf/agp/content h2="Hoe u XLTX aanmaakt in C#" %}}
...
1.  Gebruik de Save-methode om de werkmap op te slaan als XLTX-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u het bestand XLTX maakt in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#-bibliotheek om XLTX-bestand te maken" %}}
