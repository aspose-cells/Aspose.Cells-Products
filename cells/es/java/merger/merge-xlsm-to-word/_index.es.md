---
title: Combine XLSM con WORD - Combine XLSM con WORD en Java
url: /es/java/merger/merge-xlsm-to-word/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLSM para guardar formato WORD. Java Combina XLSM en formato WORD. Combinar XLSM a WORD en Java. XLSM Combinar.
...
El siguiente ejemplo muestra cómo combinar XLSM con WORD en Aspose.Cells for Java.
...
{{% cells-merger title="Gratis en línea para fusionar XLSM a WORD en Java" InputFormat="xlsm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo combinar XLSM con WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLSM con WORD mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
