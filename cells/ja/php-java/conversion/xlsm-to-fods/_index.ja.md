---
title: PHP XLSM ～ FODS - XLSM ～ FODS コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XLSM を FODS にすばやく簡単に変換します。PHP XLSM から FODS。PHP XLSM から FODS に保存します。PHP を使用して、XLSM を FODS として保存します。
...
{{% blocks/products/pf/agp/content h2="PHP 経由で XLSM を FODS に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSM ファイルをプログラムで FODS に変換する必要がありますか? PHP 開発者は、わずか数行のコードで XLSM を簡単にロードして FODS に変換できます。
