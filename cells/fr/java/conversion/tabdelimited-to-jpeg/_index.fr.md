---
title: Convertir TABDELIMITED en JPEG via Java 
url: /fr/java/conversion/tabdelimited-to-jpeg/ 
description: Exemple de code de conversion Java pour le format TABDELIMITED en fichier JPEG. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice au format JPEG dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TABDELIMITED en JPEG via Java" h2="Conversion TABDELIMITED en JPEG Java pour convertir une ou plusieurs pages en JPEG à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TABDELIMITED en JPEG à l\'aide de Java" %}}

 Afin de rendre TABDELIMITED en JPEG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TABDELIMITED en JPEG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier TABDELIMITED en JPEG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier TABDELIMITED avec une instance de Workbook1. Sélectionnez la valeur par défaut ou n'importe quelle feuille de calcul de la collection1. Créer et définir l'objet de ImageOrPrintOptions1. Créer SheetRender avec des objets Worksheet et ImageOrPrintOptions1. Appelez la méthode SheetRender.toImage pour enregistrer le résultat au format JPEG
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED en code source de conversion JPEG Java" offSpacer="" %}}

```cs
// charger le fichier TABDELIMITED à rendre
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED aux démonstrations en direct de conversion JPEG" sectionDescription="[Convertir TABDELIMITED en JPEG](https://products.aspose.app/cells/conversion/tabdelimited-to-jpeg) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier TABDELIMITED, il sera converti instantanément en JPEG." >}}
