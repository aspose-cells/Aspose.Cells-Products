...
{{% blocks/products/pf/agp/content h2="Hoe u SVG aanmaakt in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u het bestand SVG maakt in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#-bibliotheek om SVG-bestand te maken" %}}
