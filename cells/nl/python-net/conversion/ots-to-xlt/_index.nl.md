...
Het volgende voorbeeld laat zien hoe u OTS converteert naar XLT in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar XLT te converteren" %}}
