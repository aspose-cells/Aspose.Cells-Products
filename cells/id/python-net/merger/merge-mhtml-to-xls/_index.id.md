---
title: Gabung MHTML ke XLS - Gabungkan MHTML ke XLS di Python
url: /id/python-net/merger/merge-mhtml-to-xls/ 
description: Aspose Unggul. Python Aspose.Cells. Free Online Merge MHTML to XLS saveformat. Python Gabungkan format MHTML menjadi XLS. Gabung MHTML ke XLS di Python. MHTML Gabung.
...
Contoh berikut menunjukkan cara menggabungkan MHTML ke XLS di Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan MHTML ke XLS di Python" InputFormat="mhtml" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML ke XLS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan MHTML menjadi XLS secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API dapat dilakukan hanya dengan beberapa baris kode.
