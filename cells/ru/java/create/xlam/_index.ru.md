---
title: Создать XLAM — Создать файл XLAM в Java.
description: Aspose Эксель. Java Создайте файл XLAM быстро и легко с помощью Aspose.Cells. Создайте файл XLAM с помощью Java. Создайте XLAM в Java. Java XLAM Creater.
...
{{% blocks/products/pf/agp/content h2="Как создать XLAM в Java" %}}
...
1. Сохраните книгу в формате XLAM, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл XLAM в Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для создания файла XLAM" %}}
{{% blocks/products/pf/agp/text %}}
