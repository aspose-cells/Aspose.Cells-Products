---
title: Créer PPTX - Créer un fichier PPTX dans C#
description: Aspose Excel. C# Créer un fichier PPTX. Créer PPTX C#. C# PPTX Créateur. Créez PPTX dans C#. Générez le fichier PPTX en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Comment créer PPTX dans C#" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers PPTX en exécutant différentes applications de création de rapports pour le traitement des données en quelques lignes de code seulement.
...
1. Utilisez la méthode Save pour enregistrer le classeur en tant que fichier PPTX.

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier PPTX dans C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="bibliothèque C# pour créer le fichier PPTX" %}}
