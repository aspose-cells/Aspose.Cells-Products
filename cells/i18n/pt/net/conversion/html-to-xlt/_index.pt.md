...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML em XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos HTML para XLT em apenas algumas linhas de código.
