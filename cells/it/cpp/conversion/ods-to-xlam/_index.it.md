---
title: Converti ODS in XLAM tramite l'applicazione C++ 

description: Esempio di codice di conversione C++ per documento ODS in formato XLAM. I programmatori possono utilizzare questo codice sorgente per la conversione batch da ODS a XLAM all'interno di qualsiasi applicazione C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente i file ODS in XLAM in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file ODS usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XLAM).1. Il file XLAM verrà salvato nel percorso specificato.1. Apri il file XLAM nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da ODS a XLAM C++" offSpacer="" %}}
