...
Poniższy przykład pokazuje, jak przekonwertować liczbę HTML na obraz w formacie C++.
...
Trzeba programowo przekonwertować pliki HTML na IMAGE? Programiści C++ mogą łatwo przekonwertować pliki HTML na IMAGE za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj HTML na OBRAZ wywołując metodę Save().
