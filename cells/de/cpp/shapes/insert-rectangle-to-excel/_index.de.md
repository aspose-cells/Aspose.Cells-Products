---
title:  Fügen Sie ein Rechteck über C++ in Excel ein
weight: 50
description: C++ Beispielcode zum Einfügen eines Rechtecks in eine Excel-Datei in der C++-Laufzeitumgebung für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fügen Sie ein Rechteck über C++ in Excel ein" h2="Fügen Sie Objekte mit der nativen und hohen Leistung der Serverseite Aspose.Cells for C++ API ein, ohne Software wie Microsoft oder Adobe PDF zu verwenden." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Wählen Sie Arbeitsblatt über seinen Index aus.
 + Benutzen Sie die[Methode hinzufügen](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ada0b818330196c0f026e4588801feadd) um Gleichungsformen in das ausgewählte Arbeitsblatt einzufügen
