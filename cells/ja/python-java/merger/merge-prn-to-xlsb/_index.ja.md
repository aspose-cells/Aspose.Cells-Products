...
url: /ja/python-java/merger/merge-prn-to-xlsb/ 
...
次の例は、Aspose.Cells for Python via Java の XLSB に PRN をマージする方法を示しています。
...
PRNをXLSBにプログラムでマージする必要がありますか？基本的な文書のマージと連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
