...
{{% blocks/products/pf/agp/content h2="Konwertuj PRN na FODS używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN do FODS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować PRN na FODS w Java.
...
Trzeba programowo przekonwertować pliki PRN na FODS? Programiści Java mogą łatwo przekonwertować pliki PRN na FODS za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji PRN na FODS" %}}
{{% blocks/products/pf/agp/text %}}
