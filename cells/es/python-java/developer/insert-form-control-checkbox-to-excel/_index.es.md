---
title:  Inserte CheckBox (control de formulario) en Excel usando Python via java
weight: 30
description: Python via código fuente de Java para insertar CheckBox (control de formulario) en Excel.
...
{{% blocks/products/pf/agp/content h2="Cómo insertar casilla de verificación (control de formulario) en un archivo de Excel usando Python via java" %}}

 Para insertar CheckBox (control de formulario) en un archivo de Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar CheckBox (control de formulario) en un archivo de Excel usando Python via java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa la colección de formas[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) para insertar una casilla de verificación (control de formulario) en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar casilla de verificación (control de formulario) - Python via java" offSpacer="" %}}
