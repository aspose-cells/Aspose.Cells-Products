---
title: HTM samenvoegen naar XLSB - HTM combineren naar XLSB in Java
url: /nl/java/merger/merge-htm-to-xlsb/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online HTM samenvoegen naar XLSB opslagformaat. Java Combineer HTM naar formaat XLSB. HTM samenvoegen naar XLSB in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="HTM samenvoegen naar XLSB in Java Online gratis" %}}

Het volgende voorbeeld laat zien hoe u HTM samenvoegt met XLSB in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen tot XLSB. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand XLSB. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat HTM samenvoegt tot XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om HTM samen te voegen met XLSB in Java" InputFormat="htm" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen tot XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met XLSB? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen tot XLSB" %}}
