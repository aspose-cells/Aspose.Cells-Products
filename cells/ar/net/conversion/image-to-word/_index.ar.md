---
title: تحويل C# صورة إلى WORD - صورة إلى WORD
description: Aspose اكسل. قم بتحويل IMAGE إلى WORD بسرعة وسهولة باستخدام Aspose.Cells. C# IMAGE إلى WORD. C# احفظ IMAGE إلى WORD. احفظ IMAGE كـ WORD باستخدام C#.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في WORD في C#" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى WORD في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى WORD عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى WORD برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى WORD بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى WORD" %}}
