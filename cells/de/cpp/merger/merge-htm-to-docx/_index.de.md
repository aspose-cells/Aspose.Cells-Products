---
title: HTM mit DOCX zusammenführen – HTM mit DOCX in C++ kombinieren
url: /de/cpp/merger/merge-htm-to-docx/ 
description: Aspose Excel. C++ Aspose.Cells. HTM mit dem Sicherungsformat DOCX zusammenführen. C++ Kombinieren Sie HTM mit dem Format DOCX. HTM zu DOCX in C++ zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="HTM mit DOCX in C++ zusammenführen" %}}

Das folgende Beispiel zeigt, wie HTM mit DOCX in Aspose.Cells for C++ zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von HTM mit DOCX in C++" InputFormat="htm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie HTM über C++ mit DOCX zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM programmgesteuert mit DOCX zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
