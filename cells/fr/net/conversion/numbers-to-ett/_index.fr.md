---
title: C# NOMBRES en ETT - Convertisseur NOMBRES en ETT
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les NUMBERS au format ETT, permettant un enregistrement transparent des données NUMBERS au format ETT à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros pour ETT dans le C#" %}}

L'exemple suivant montre comment convertir des NUMÉROS en ETT dans C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des NUMBERS en ETT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en ETT par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en ETT en quelques lignes de code seulement.
...
1.  Convertissez les NUMBERS en ETT en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en ETT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en ETT" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/numbers-to-pdf/" name="NUMÉROS AU PDF" description="Format de document portable" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/numbers-to-png/" name="NUMÉROS AU PNG" description="Graphiques de réseau portables" >}}
