...
description: Aspose Excel. C# Aspose.Cells. Slå samman HTML till WORD sparaformat. C# Kombinera HTML till WORD format. Slå samman HTML till WORD i C#. HTML Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman HTML till WORD i C#" %}}

Följande exempel visar hur man slår samman HTML till WORD i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman HTML till WORD. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen WORD. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman HTML till WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exempelkod för att slå samman HTML till WORD i C#" InputFormat="html" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
