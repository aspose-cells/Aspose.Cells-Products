...
description: Aspose Excel. C++ Aspose.Cells. Συγχώνευση NUMBERS σε μορφή αποθήκευσης PRN. C++ Συνδυάστε NUMBERS σε μορφή PRN. Συγχώνευση NUMBERS στο PRN στο C++. NUMBERS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση NUMBERS στο PRN στο C++" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση NUMBERS στο PRN στο C++" InputFormat="numbers" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
