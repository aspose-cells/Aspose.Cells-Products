...
Вам нужно программно преобразовать файлы FODS в TABDELIMITED? Разработчики .NET могут легко загрузить и преобразовать FODS в TABDELIMITED всего за несколько строк кода.
