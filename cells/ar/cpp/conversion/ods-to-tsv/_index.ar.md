---
title: تحويل ODS إلى TSV عبر تطبيق C++ 
weight: 1570
url: /ar/cpp/conversion/ods-to-tsv/ 
description: نموذج C++ رمز تحويل لمستند ODS إلى تنسيق TSV. يمكن للمبرمجين استخدام شفرة المصدر هذه لتحويل دفعة من ODS إلى TSV داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ODS إلى TSV عبر C++" h2="تحويل ODS إلى TSV عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل ODS إلى TSV باستخدام C++" %}}
 ...
 من أجل تحويل ODS إلى TSV ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف ODS إلى TSV في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف ODS باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد ملف (TSV).1. سيتم حفظ ملف TSV في المسار المحدد.1. افتح ملف TSV في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="ODS إلى TSV C++ شفرة مصدر التحويل" offSpacer="" %}}
