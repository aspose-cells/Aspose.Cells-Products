...
url: /id/python-net/merger/merge-mhtml-to-image/ 
...
Contoh berikut menunjukkan cara menggabungkan MHTML ke IMAGE di Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan MHTML ke IMAGE secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API dapat dilakukan hanya dengan beberapa baris kode.
