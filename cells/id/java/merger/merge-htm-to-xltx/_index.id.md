---
title: Gabungkan HTM ke XLTX - Gabungkan HTM ke XLTX di Java
url: /id/java/merger/merge-htm-to-xltx/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge HTM to XLTX saveformat. Java Gabungkan HTM ke format XLTX. Gabungkan HTM ke XLTX di Java. Gabungkan HTM.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan HTM ke XLTX via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan HTM ke XLTX. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="HTM" additionalConversionTag="XLTX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan HTM ke XLTX di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan HTM ke XLTX di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan HTM ke XLTX. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file XLTX. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan HTM ke XLTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis Menggabungkan HTM ke XLTX di Java" InputFormat="htm" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan HTM ke XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan HTM ke XLTX secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan HTM ke XLTX" %}}
