...
{{% blocks/products/pf/agp/content h2="Konvertera XLS till NUMMERS med hjälp av C++" %}}
 ...
 Hur konverterar jag XLS till NUMMERS? Med Aspose.Cells for C++-biblioteket kan du enkelt konvertera XLS till NUMMERS programmatiskt med några få rader kod.[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) kan bygga plattformsoberoende applikationer med förmågan att generera, modifiera, konvertera, rendera och skriva ut alla Excel-filer. C++ Excel API konverterar inte bara mellan kalkylarksformat, den kan också rendera Excel-filer som bilder, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT och mer, vilket gör det till ett perfekt val att utbyta dokument i industristandardformat. Du kan ladda ner den senaste versionen direkt, bara öppna[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/)pakethanteraren, sök efter Aspose.Cells.Cpp och installera. Du kan också använda följande kommando från Package Manager Console.
...
Behöver du konvertera XLS-filer till NUMMERS programmatiskt? C++-utvecklare kan enkelt konvertera XLS till NUMMERS med bara några få rader kod.
...
1.  Konvertera XLS till NUMBERS genom att anropa Save()-metoden.
