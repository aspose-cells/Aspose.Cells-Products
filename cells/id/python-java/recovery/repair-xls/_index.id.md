---
title: Perbaiki file xls melalui Python
url: /id/python-java/recovery/repair-xls/ 
description: Perbaiki file xls yang rusak menggunakan Python. Alat pemulihan untuk memperbaiki file xls yang rusak dalam aplikasi Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pulihkan file XLS melalui Python" h2="Bangun aplikasi Python Anda sendiri untuk memperbaiki file xls menggunakan Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara memperbaiki file xls menggunakan Python" %}}
...
{{% cells-recovery title="Aplikasi Gratis untuk memperbaiki file XLS menggunakan Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="pythonjava" %}}    
