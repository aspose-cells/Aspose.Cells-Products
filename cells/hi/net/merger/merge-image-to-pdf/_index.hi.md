...
description: Aspose एक्सेल। C# Aspose.Cells. इमेज को PDF सेवफॉर्मेट में मर्ज करें। C# छवि को PDF प्रारूप में संयोजित करें। C# में IMAGE को PDF में मर्ज करें। IMAGE मर्ज करें।
...
{{% blocks/products/pf/agp/content h2="C# में IMAGE को PDF पर मर्ज करें" %}}
...
{{% cells-merger title="C# में IMAGE को PDF में मर्ज करने के लिए नमूना कोड" InputFormat="png" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
