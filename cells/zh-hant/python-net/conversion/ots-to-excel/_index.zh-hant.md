...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 EXCEL。Python OTS 到 EXCEL。 Python 將OTS儲存到EXCEL。使用 Python 將 OTS 儲存為 EXCEL。
...
{{% cells-convert title="將 OTS 轉換為 EXCEL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python 將 OTS 轉換為 EXCEL 的函式庫" %}}
