---
title: Gabungkan JPEG menjadi PDF - Gabungkan JPEG menjadi PDF menjadi C#
url: /id/net/merger/merge-jpeg-to-pdf/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan JPEG menjadi PDF format simpan. C# Gabungkan format JPEG menjadi PDF. Gabungkan JPEG menjadi PDF di C#. JPEG Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPEG menjadi PDF di C#" %}}

Contoh berikut menunjukkan cara menggabungkan JPEG menjadi PDF di Aspose.Cells for .NET.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan JPEG menjadi PDF di C#" InputFormat="jpg" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JPEG menjadi PDF melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan JPEG ke PDF secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2=".NET perpustakaan untuk digabungkan JPEG menjadi PDF" %}}
