...
{{< blocks/products/pf/i18n/upper-banner h1="Excel\'de Resimlerin/Resimlerin Boyutunu Alın via .NET" h2="Aspose.Cells\' API\'i kullanarak Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan çeşitli nesnelerle çalışın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
