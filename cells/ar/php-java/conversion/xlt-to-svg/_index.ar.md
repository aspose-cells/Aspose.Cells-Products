---
title: PHP XLT إلى SVG - XLT إلى SVG محول
description: Aspose اكسل. قم بتحويل XLT إلى SVG بسرعة وسهولة باستخدام Aspose.Cells. PHP XLT إلى SVG. PHP احفظ XLT إلى SVG. احفظ XLT كـ SVG باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLT إلى SVG عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLT إلى SVG برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLT إلى SVG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLT إلى SVG عن طريق استدعاء طريقة حفظ المصنف.
