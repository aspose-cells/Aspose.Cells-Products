...
description: Aspose Excel. Converta IMAGEM em XPS de forma rápida e fácil com Aspose.Cells. Python IMAGEM em XPS. Python Salve IMAGEM em XPS. Salve IMAGEM como XPS usando Python.
...
{{% blocks/products/pf/agp/content h2="Salve IMAGEM em XPS em Python" %}}

O exemplo a seguir demonstra como converter IMAGE em XPS em Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para converter IMAGE em XPS" %}}
