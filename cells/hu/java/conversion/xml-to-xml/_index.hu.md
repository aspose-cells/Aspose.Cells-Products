...
description: Aspose Excel. A Aspose.Cells segítségével gyorsan és egyszerűen konvertálhat XML-t XML-be. Java XML-t XML-be. Java XML mentése XML-be. Mentse az XML-t XML-ként a Java használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse az XML-t XML-be a Java-ben" %}}

A következő példa bemutatja, hogyan lehet XML-t XML-re konvertálni a Java-ben.
