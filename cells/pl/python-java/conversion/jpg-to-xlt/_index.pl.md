...
description: Aspose Excel. Konwertuj JPG na XLT szybko i łatwo za pomocą Aspose.Cells. Python JPG na XLT. Python Zapisz JPG na XLT. Zapisz JPG jako XLT używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj JPG na XLT za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz JPG pod numerem XLT w Python" %}}

Poniższy przykład pokazuje, jak przekonwertować JPG na XLT w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji JPG na XLT" %}}
