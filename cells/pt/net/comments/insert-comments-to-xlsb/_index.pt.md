---
title: Insira comentários no arquivo XLSB via .NET
url: /pt/net/comments/insert-comments-to-xlsb/ 
description: Insira comentários em XLSB usando C#. Use o código de exemplo API para inserir comentários no aplicativo .NET.
...
{{% blocks/products/pf/agp/content h2="Insira comentários no arquivo XLSB usando .NET" %}}
...
{{% blocks/products/pf/agp/content h2="Como inserir comentários no arquivo XLSB via C#" %}}
...
No Office 365, os comentários são para conversas. Você pode usar o seguinte código C# para inserir e remover comentários no arquivo XLSB.

{{% blocks/products/pf/agp/code-block title="Código de exemplo C# para inserir e remover comentários no arquivo XLSB" offSpacer="" %}}
