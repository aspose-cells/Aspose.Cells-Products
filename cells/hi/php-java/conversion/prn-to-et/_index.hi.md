---
title: पीएचपी पीआरएन से ईटी - पीआरएन से ईटी कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ पीआरएन को ईटी में जल्दी और आसानी से बदलें। पीएचपी पीआरएन को ईटी में बदलें। PHP PRN को ET में सेव करें। PHP का उपयोग करके PRN को ET के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="PHP के माध्यम से PRN को ET में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

क्या आपको PRN फ़ाइलों को प्रोग्रामेटिक रूप से ET में बदलने की आवश्यकता है? PHP डेवलपर्स कोड की कुछ ही पंक्तियों में आसानी से PRN को ET में लोड और परिवर्तित कर सकते हैं।
...
1.  वर्कबुक की सेव विधि को कॉल करके पीआरएन को ईटी में बदलें।
