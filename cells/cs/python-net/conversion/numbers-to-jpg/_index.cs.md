...
{{% blocks/products/pf/agp/content h2="Převeďte ČÍSLA na JPG v Python" %}}
...
Následující příklad ukazuje, jak převést ČÍSLA na JPG v Python via NET.
