---
title: Durchsuchen Sie das XLSB-Dokument, ohne es über C++ zu öffnen 
weight: 7020

description: C++ Beispielcode zum Suchen von Wörtern mit Muster in der XLSB-Datei in der C++ Laufzeitumgebung für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Suche nach XLSB-Formaten in C++" h2="Native und leistungsstarke XLSB-Dokumentensuche mit serverseitigen Aspose.Cells für C++-APIs, ohne Verwendung von Software wie Microsoft oder Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="So suchen Sie eine XLSB-Datei mit C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Suchen von XLSB-Dateien in C++" %}}
...
+ Laden Sie die XLSB-Datei, indem Sie eine IWorkbook-Klasse instanziieren.
...
+ Speichern Sie die XLSB-Datei mit der Methode IWorkbook->Save(.).
...
{{% blocks/products/pf/agp/code-block title="XLSB-Dateien suchen - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online-XLSB-Suche Live-Demos" sectionDescription="Suchen Sie jetzt nach Text, Wörtern und Sätzen in XLSB-Dokumenten, indem Sie unsere besuchen [Live-Demos-Website](https://products.aspose.app/cells/search). Die Live-Demo hat die folgenden Vorteile" >}}
