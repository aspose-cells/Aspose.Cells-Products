---
title: C# XLSB から JPG - XLSB から JPG コンバーター
description: Aspose エクセル。 Aspose.Cellsを使用して、XLSBをJPGにすばやく簡単に変換します。C# XLSBをJPGに変換します。 C# XLSBをJPGに保存します。 C# を使用して、XLSB を JPG として保存します。
...
{{% blocks/products/pf/agp/content h2="XLSB を C# に JPG に保存" %}}

次の例は、XLSB を C# の JPG に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、XLSBをJPGに変換します。 XLSB ファイルをアップロードし、JPG ファイルとして保存します。 XLSB の読み取りと JPG の書き込みの両方で、完全修飾ファイル名を使用できます。出力 JPG コンテンツと形式は、元の XLSB ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="XLSBをJPGに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でXLSBをJPGに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSB ファイルをプログラムで JPG に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLSB を簡単にロードして JPG に変換できます。
