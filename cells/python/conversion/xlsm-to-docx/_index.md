...
url: /python/conversion/xlsm-to-docx/
description: Sample code for xlsm to docx Python conversion. Use API example code for batch xlsm files to docx conversion within Python application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows xlsm to docx Python Conversion" offSpacer="" %}}

{{< gist "aspose-cells-gists" "32e50c6aabc547111966569f3fd39694" "Convert-xlsm-to-docx.py" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XLSM to DOCX" sectionDescription="Check our live demos for [XLSM to DOCX conversion](https://products.aspose.app/cells/conversion/xlsm-to-docx) with following benefits." >}}
