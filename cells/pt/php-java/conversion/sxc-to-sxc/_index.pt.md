---
title: Conversor PHP SXC para SXC - SXC para SXC
description: Aspose Excel. Converta SXC em SXC de forma rápida e fácil com Aspose.Cells. PHP SXC em SXC. PHP Salve SXC em SXC. Salve SXC como SXC usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em SXC via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em SXC programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em SXC em apenas algumas linhas de código.
...
1.  Converta SXC em SXC chamando o método save da pasta de trabalho.
