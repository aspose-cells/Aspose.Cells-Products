---
title: Hur man ritar eller infogar en krökt form i Excel med Python via Java
weight: 10
description: Rita eller infoga krökt form med Aspose.Cells' Python via Java API utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc.
keywords: [Python Aspose.Cells., Python add curved shape., Python insert curved shape., Python create curved shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Infoga krökt form i Excel med Python via Java" h2="Infoga krökt form med Aspose.Cells\' API utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man infogar krökt form i Excel-fil med Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga krökt form i Excel-fil med Python via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) för att infoga en krökt form i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Sätt böjd form - Python via Java" offSpacer="" %}}
