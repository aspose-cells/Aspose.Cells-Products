...
url: /tr/net/merger/merge-prn-to-xps/ 
...
Aşağıdaki örnek, PRN'nin Aspose.Cells for .NET'deki XPS ile nasıl birleştirileceğini gösterir.
...
PRN'yi programlı olarak XPS ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi XPS ile birleştirmek için .NET kitaplığı" %}}
