---
title: Java Réparer xlsb - Récupérer et réparer un fichier xlsb corrompu
url: /fr/java/recovery/repair-xlsb/ 
description: Java Aspose.Cells. Réparation xlsb. Correction du fichier xlsb. outil de récupération xlsb. corruption xlsb. Restaurez les données xlsb. récupération de fichier xlsb. Récupérez le fichier xlsb corrompu.
...
Besoin de réparer le fichier xlsb par programme ? Les développeurs Java peuvent facilement charger et réparer le fichier xlsb en quelques lignes de code seulement.
...
{{% cells-recovery title="Exemple de code pour réparer le fichier XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsb" outformat="xlsb" IsLandingPage="true" language="java" %}}    
