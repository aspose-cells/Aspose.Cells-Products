---
title: Gộp PRN vào HÌNH ẢNH - Gộp PRN vào HÌNH ẢNH theo số Java
url: /vi/java/merger/merge-prn-to-image/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất PRN thành định dạng lưu HÌNH ẢNH. Java Kết hợp định dạng PRN thành HÌNH ẢNH. Hợp nhất PRN thành IMAGE theo số Java. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Gộp PRN vào IMAGE theo số Java" %}}

Ví dụ sau đây minh họa cách hợp nhất PRN với IMAGE trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất PRN vào HÌNH ẢNH. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp HÌNH ẢNH. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất PRN với IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Code mẫu gộp PRN vào IMAGE Java" InputFormat="prn" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép PRN thành HÌNH ẢNH via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép PRN vào HÌNH ẢNH" %}}
