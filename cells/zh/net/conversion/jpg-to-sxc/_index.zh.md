---
title: C# JPG 到 SXC - JPG 到 SXC 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 JPG 转换为 SXC。 C# JPG 到 SXC。 C# 将 JPG 保存到 SXC。 使用 C# 将 JPG 保存为 SXC。
...
{{% blocks/products/pf/agp/content h2="将JPG保存到C#中的SXC" %}}
...
{{% cells-convert title="将 JPG 转换为 SXC 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="sxc" IsLandingPage="true" %}}
