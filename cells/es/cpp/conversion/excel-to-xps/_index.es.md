---
title: C++ EXCEL a XPS - Convertidor EXCEL a XPS
description: Aspose Excel. Convierta EXCEL a XPS rápida y fácilmente con Aspose.Cells. C++ EXCEL a XPS. C++ Guarde EXCEL en XPS. Guarde EXCEL como XPS usando C++.
...
{{% blocks/products/pf/agp/content h2="Guardar EXCEL al XPS en C++" %}}

El siguiente ejemplo demuestra cómo convertir EXCEL a XPS en C++.
...
{{% cells-convert title="Código de muestra para convertir EXCEL a XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir EXCEL a XPS a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos EXCEL a XPS mediante programación? Los desarrolladores de C++ pueden convertir fácilmente EXCEL a XPS en tan solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para convertir EXCEL a XPS" %}}
