...
{{% blocks/products/pf/agp/content h2="Преобразовать XLAM в XML, используя C++" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XLAM в XML в C++" %}}

Следующий пример демонстрирует, как преобразовать XLAM в XML в C++.
...
Нужно программно преобразовать файлы XLAM в XML? Разработчики, работающие с файлами C++, могут легко преобразовать файлы XLAM в XML всего несколькими строками кода.
