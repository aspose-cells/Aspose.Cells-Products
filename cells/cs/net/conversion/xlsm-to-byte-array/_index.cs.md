...
weight: 7690
description: C# Ukázkový kód pro konverzi XLSM na Byte Array. Tento kód použijte pro převod Excel XLSM na Byte Array v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte XLSM na bajtové pole přes C#" h2="Nativní a vysoce výkonné Microsoft Excel XLSM na konverzi bajtového pole nebo naopak pro zpracování dat tabulkových procesorů pomocí .NET API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array je užitečné pro zpracování nebo ukládání dat. Můžete převést soubor XLSM na Byte Array, stejně jako a**Byte Array na XLSM** dokument pomocí jazyka C#. Abychom převedli XLSM na bajtové pole, použijeme
...
1.  Načíst vstup XLSM Soubor pomocí sešitu
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod XLSM na bajtové pole C#" offSpacer="" %}}
