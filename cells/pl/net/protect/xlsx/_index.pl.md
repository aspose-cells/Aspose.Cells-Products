---
title:  Chroń i zablokuj dokument XLSX via .NET
weight: 90
description: C# kod źródłowy do blokowania pliku XLSX przy użyciu hasła w platformie .NET, .NET Core, Mono lub platformach Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Chroń numer XLSX pod numerem C#" %}}
...
1.  Utwórz instancję klasy skoroszytu ze ścieżką do pliku XLSX
