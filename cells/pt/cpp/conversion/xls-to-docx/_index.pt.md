...
description: Aspose Excel. Converta XLS em DOCX de forma rápida e fácil com Aspose.Cells. C++ XLS em DOCX. C++ Salve XLS em DOCX. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em DOCX usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para DOCX em C++" %}}

O exemplo a seguir demonstra como converter XLS em DOCX em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="docx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em DOCX por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em DOCX programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em DOCX em apenas algumas linhas de código.
...
1.  Converta XLS em DOCX chamando o método Save().
