...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar TXT via PHP?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je OTS-bestanden programmatisch converteren naar TXT? PHP-ontwikkelaars kunnen OTS-bestanden eenvoudig laden en converteren naar TXT met slechts een paar regels code.
...
1.  Converteer OTS naar TXT door de save-methode van Workbook aan te roepen.
