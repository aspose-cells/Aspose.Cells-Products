...
description: Aspose Эксель. Python Aspose.Cells. Объедините HTML и XLAM в формате сохранения. Python Объедините форматы HTML и XLAM. Объедините HTML и XLAM в Python. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML с XLAM, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и XLAM в Python." %}}

В следующем примере показано, как объединить HTML и XLAM в Aspose.Cells for Python via Java.
