...
description: Aspose Excel. Konwertuj EXCEL na ODS szybko i łatwo za pomocą Aspose.Cells. Java EXCEL na ODS. Java Zapisz EXCEL na ODS. Zapisz EXCEL jako ODS używając Java.
...
{{% blocks/products/pf/agp/content h2="Konwertuj EXCEL na ODS za pomocą Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL pod numerem ODS w Java" %}}

Poniższy przykład ilustruje, jak przekonwertować program EXCEL na ODS w Java.
...
{{% cells-convert title="Przykładowy kod do konwersji programu Excel na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować EXCEL na ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki EXCEL na ODS? Programiści Java mogą łatwo przekonwertować EXCEL na ODS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji programu EXCEL na ODS" %}}
{{% blocks/products/pf/agp/text %}}
