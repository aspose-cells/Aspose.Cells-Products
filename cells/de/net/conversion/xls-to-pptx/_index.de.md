...
Das folgende Beispiel zeigt, wie man XLS in C# in PPTX umwandelt.
...
Müssen Sie XLS-Dateien programmgesteuert in PPTX konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in PPTX laden und konvertieren.
...
1.  Konvertieren Sie XLS in PPTX durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in PPTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in PPTX" %}}
