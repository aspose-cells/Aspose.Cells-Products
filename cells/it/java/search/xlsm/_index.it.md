---
title:  Cerca documento XLSM senza aprire via Java
weight: 6780
description: Java codice di esempio per cercare parole con pattern nel file XLSM su Java Runtime Environment per applicazioni JSP/JSF e applicazioni desktop.
---
...
{{% blocks/products/pf/agp/content h2="Come cercare il file XLSM utilizzando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per cercare i file XLSM in Java" %}}
...
+ Carica il file XLSM istanziando un oggetto Workbook.
