...
description: Aspose Excel. Chuyển đổi PNG sang BMP nhanh chóng và dễ dàng với Aspose.Cells. Python PNG sang BMP. Python Lưu PNG thành BMP. Lưu PNG thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi PNG thành BMP thành Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu PNG vào BMP trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi PNG thành BMP trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi PNG thành BMP" %}}
