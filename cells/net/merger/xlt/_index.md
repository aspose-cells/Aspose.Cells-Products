...
{{% blocks/products/pf/agp/content h2="How to Merge XLT File Using C#" %}}
 ...
 In order to merge XLT file, weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="MergeВ XLT Files - C#" offSpacer="" %}}

```cs
var docstomerge = 3;
    DocumentInfo[] docs = new DocumentInfo[docstomerge];
    for (var i = 0; i < docstomerge; i++)
    docs[i] = new Document(dataDir + "document"+i+".xlt").Info;
    var doc = docs[0];
