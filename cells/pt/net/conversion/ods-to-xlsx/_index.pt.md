---
title: C# ODS para XLSX - Online ODS para XLSX Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter ODS para XLSX saveformat. C# ODS a XLSX formato. Salve ODS a XLSX C#.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a XLSX em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter ODS em XLSX em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS em XLSX. Carregue seu arquivo ODS e salve-o como arquivo XLSX. Tanto para a leitura ODS quanto para a escrita XLSX, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação de saída XLSX serão idênticos ao documento ODS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter ODS em XLSX online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para XLSX programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter ODS em XLSX em apenas algumas linhas de código.
...
1.  Converta ODS em XLSX chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para converter ODS em XLSX" %}}
