---
title: Python FODS en XML - Convertisseur FODS en XML
description: Aspose Exceller. Python Exceller. Convertissez FODS en XML rapidement et facilement avec Aspose.Cells. Python FODS en XML. Python Enregistrez FODS au format XML. Enregistrez FODS au format XML à l’aide de la bibliothèque Excel Python.
...
{{% blocks/products/pf/agp/content h2="Convertir FODS en XML à l\'aide de la bibliothèque Excel Python" %}}

Comment convertir FODS en XML ? Avec la bibliothèque Aspose.Cells for Python, vous pouvez facilement convertir FODS en XML par programme avec quelques lignes de code.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer FODS au format XML dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment convertir FODS en XML dans la bibliothèque Excel Python.
...
{{% cells-convert title="Exemple de code pour convertir FODS en XML via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xml" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir FODS en XML via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers FODS en XML par programme ? Les développeurs Python peuvent facilement charger et convertir FODS en XML en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Python Bibliothèque Excel pour convertir FODS en XML" %}}
