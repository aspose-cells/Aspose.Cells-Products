---
title: Conversor PHP XLTX para HTML - XLTX para HTML
description: Aspose Excel. Converta XLTX em HTML de forma rápida e fácil com Aspose.Cells. PHP XLTX em HTML. PHP Salve XLTX em HTML. Salve XLTX como HTML usando PHP.
...
{{% cells-convert title="Exemplo de código para converter XLTX em HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="html" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLTX em HTML via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em HTML programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em HTML em apenas algumas linhas de código.
...
1.  Converta XLTX em HTML chamando o método save da pasta de trabalho.
