...
description: Aspose Excel. C++ Aspose.Cells. Συγχώνευση OTS σε DIF saveformat. C++ Συνδυάστε τη μορφή OTS σε DIF. Συγχώνευση OTS στο DIF στο C++. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="Συγχωνεύστε το OTS στο DIF στο C++" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση OTS στο DIF στο C++" InputFormat="ots" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
