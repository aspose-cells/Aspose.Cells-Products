...
{{% blocks/products/pf/agp/content h2="Merge XLTX to SQL in C# Online for Free" %}}

The following example demonstrates how to merge XLTX to SQL in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to merge XLTX to SQL. Upload your files, call Workbook.Combine method for merging files, and then save it to SQL file. If you develop code in C#, this will be simpler than it sounds. See C# example that merges XLTX to SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Free Online to Merge XLTX to SQL in C#" InputFormat="xltx" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="How to Merge XLTX to SQL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to merge XLTX to SQL programmatically? A basic document merging and concatenating with [Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs can be done with just few lines of code.
...
{{% blocks/products/pf/agp/content h2=".NET library to merge XLTX to SQL" %}}
