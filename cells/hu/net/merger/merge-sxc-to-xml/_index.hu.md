---
title: A SXC egyesítése XML-be – a SXC egyesítése XML-be a C#-ben
url: /hu/net/merger/merge-sxc-to-xml/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés SXC XML mentési formátumba. C# A SXC kombinálása XML formátumba. A SXC egyesítése XML-be a C#-ben. SXC Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a SXC-et XML-be a C#-ben online" %}}

A következő példa bemutatja, hogyan egyesítheti a SXC-et XML-be a Aspose.Cells for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SXC XML-be olvasztásához. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el XML-fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a SXC-et XML-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a SXC egyesítéséhez XML-be C#-ben" InputFormat="sxc" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A SXC egyesítése XML-be a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SXC-et XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a SXC XML-be olvasztásához" %}}
