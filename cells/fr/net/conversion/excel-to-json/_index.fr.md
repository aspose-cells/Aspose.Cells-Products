...
Besoin de convertir des fichiers EXCEL en JSON par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en JSON en quelques lignes de code seulement.
...
1.  Convertissez le fichier EXCEL au format JSON en appelant la méthode Workbook.Save.
