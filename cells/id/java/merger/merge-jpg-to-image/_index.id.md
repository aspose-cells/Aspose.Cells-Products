---
title: Gabungkan JPG ke IMAGE - Gabungkan JPG ke IMAGE di Java
url: /id/java/merger/merge-jpg-to-image/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan format penyimpanan JPG ke IMAGE. Java Gabungkan format JPG ke GAMBAR. Gabungkan JPG ke IMAGE di Java. Gabungkan JPG.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPG ke IMAGE di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan JPG ke IMAGE di Java" InputFormat="jpg" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JPG ke GAMBAR via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan JPG ke IMAGE secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk menggabungkan JPG ke IMAGE" %}}
