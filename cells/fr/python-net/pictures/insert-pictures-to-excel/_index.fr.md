...
{{% blocks/products/pf/agp/content h2="Comment insérer une image dans un fichier Excel à l\'aide de Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Insérer une image - Python via .Net" offSpacer="" %}}
