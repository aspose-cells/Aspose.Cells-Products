---
title: Fusionner MHT à SPREADSHEETML - Combiner MHT à SPREADSHEETML dans Java
url: /fr/java/merger/merge-mht-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde SPREADSHEETML. Java Associez le format MHT au format SPREADSHEETML. Fusionner MHT à SPREADSHEETML en Java. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT à SPREADSHEETML dans Java en ligne gratuitement" %}}
...
{{% cells-merger title="Gratuit en ligne pour fusionner MHT à SPREADSHEETML en Java" InputFormat="mht" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT à SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner MHT avec SPREADSHEETML par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner MHT à SPREADSHEETML" %}}
