---
title: C# XLS till OTS - XLS till OTS Converter
description: Aspose Excel. Konvertera XLS till OTS snabbt och enkelt med Aspose.Cells. C# XLS till OTS. C# Spara XLS till OTS. Spara XLS som OTS med C#.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till OTS på C#" %}}

Följande exempel visar hur man konverterar XLS till OTS i C#.
...
{{% cells-convert title="Exempelkod för att konvertera XLS till OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till OTS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till OTS programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till OTS på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera XLS till OTS" %}}
