...
{{% blocks/products/pf/agp/content h2="TXT konvertálása SPREADSHEETML-be a következővel: Java" %}}

 A TXT SPREADSHEETML formátumban való megjelenítéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="TXT konvertálása SPREADSHEETML-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a TXT fájlt SPREADSHEETML formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat SPREADSHEETML kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott SPREADSHEETML-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT SPREADSHEETML-be Java Konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése SPREADSHEETML-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT-ből SPREADSHEETML-be konvertáló élő bemutatók" sectionDescription="[A TXT konvertálása SPREADSHEETML-be](https://products.aspose.app/cells/conversion/txt-to-spreadsheetml) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel TXT fájlját, és azonnal SPREADSHEETML formátumba konvertálódik." >}}
