---
title: 創建BMP - 在Java中創建BMP文件
description: Aspose Excel。 Java 創建 BMP 文件。創建BMP Java。Java BMP創建者。在Java中創建BMP。使用Java生成BMP文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建BMP" %}}
...
1. 使用 save() 方法將工作簿保存為 BMP 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 BMP 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建BMP文件" %}}
{{% blocks/products/pf/agp/text %}}
