...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى ODS عبر Java" h2="TABDELIMITED لتحويل ODS Java لتحويل صفحات مفردة أو صفحات متعددة إلى ODS باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى ODS باستخدام Java" %}}

 من أجل تقديم TABDELIMITED إلى ODS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TABDELIMITED إلى ODS عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل ملف TABDELIMITED بسهولة إلى ODS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف TABDELIMITED مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد ODS & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف ODS الناتج
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED إلى ODS Java رمز مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف TABDELIMITED في مثيل المصنف
Workbook book = new Workbook("template.tabdelimited");
// حفظ TABDELIMITED كـ ODS
