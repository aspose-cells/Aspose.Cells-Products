---
title: أدخل وسائل الشرح في Excel باستخدام Python via .Net
weight: 360
description: Python via كود المصدر الصافي لإدراج وسائل الشرح في برنامج Excel.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج وسائل الشرح في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) لإدراج وسائل الشرح في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج وسائل الشرح - Python via .نت" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 نوع الشكل التلقائي.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12" style="font-size:0.8rem !important;">
 نوع الشكل التلقائي.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR3
    </p>
   </div>
  </div>
 </div>
