...
url: /tr/python-java/merger/merge-jpg-to-xltm/ 
...
Aşağıdaki örnek, JPG'nin Aspose.Cells for Python via Java'de XLTM ile nasıl birleştirileceğini gösterir.
...
JPG'yi programlı olarak XLTM ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
