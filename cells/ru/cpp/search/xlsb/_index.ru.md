...
weight: 7020
description: Пример кода C++ для поиска слов с шаблоном в файле XLSB в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
---
...
Загрузить файл XLSB, создав экземпляр класса IWorkbook.
...
+ Сохранить файл XLSB методом IWorkbook->Save(.).
