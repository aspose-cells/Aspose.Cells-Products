---
title: PHP XLTM إلى ODS - XLTM إلى ODS محول
description: Aspose اكسل. قم بتحويل XLTM إلى ODS بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى ODS. PHP احفظ XLTM إلى ODS. احفظ XLTM كـ ODS باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى ODS عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى ODS برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى ODS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى ODS عن طريق استدعاء طريقة حفظ المصنف.
