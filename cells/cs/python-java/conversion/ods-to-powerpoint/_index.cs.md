---
title: Python ODS na POWERPOINT - ODS na POWERPOINT Převodník
description: Aspose Excel. Převeďte ODS na POWERPOINT rychle a snadno pomocí Aspose.Cells. Python ODS na POWERPOINT. Python Uložte ODS do POWERPOINT. Uložte ODS jako POWERPOINT pomocí Python.
...
{{% blocks/products/pf/agp/content h2="Uložte ODS do POWERPOINT v Python" %}}
...
{{% cells-convert title="Ukázkový kód pro převod ODS na POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="pptx" IsLandingPage="true" language="pythonjava" %}}
