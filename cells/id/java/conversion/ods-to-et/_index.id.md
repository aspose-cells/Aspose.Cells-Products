---
title: Java ODS ke ET - ODS ke ET Konverter
description: Aspose Unggul. Ubah ODS menjadi ET dengan cepat dan mudah dengan Aspose.Cells. Java ODS menjadi ET. Java Simpan ODS ke ET. Simpan ODS sebagai ET menggunakan Java.
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke ET di Java" %}}

Contoh berikut menunjukkan cara mengonversi ODS ke ET di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengkonversi ODS ke ET. Unggah file ODS Anda, lalu simpan saja sebagai file ET. Untuk pembacaan ODS dan penulisan ET Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format ET keluaran akan sama dengan dokumen ODS asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi ODS ke ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="et" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Bagaimana Mengonversi ODS ke ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file ODS ke ET secara terprogram? Pengembang Java dapat dengan mudah mengonversi ODS ke ET hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi ODS ke ET" %}}
{{% blocks/products/pf/agp/text %}}
