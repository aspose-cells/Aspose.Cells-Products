...
{{% blocks/products/pf/agp/content h2="Sla HTML op in TIFF in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar TIFF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar TIFF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar TIFF? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar TIFF met slechts een paar regels code.
