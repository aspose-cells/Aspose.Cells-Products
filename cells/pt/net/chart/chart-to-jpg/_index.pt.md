---
title:  Converter gráfico em imagens JPG (JPEG) via .NET
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter gráficos em arquivos JPG/JPEG em C#" %}}
...
+ Criar arquivo XLSX.
+ Obtenha o gráfico.
+ Converter gráfico para imagem JPG/JPEG.
...
{{% blocks/products/pf/agp/code-block title="Converter gráfico de arquivos XLSX para imagem JPG/JPEG - C#" offSpacer="" %}}
