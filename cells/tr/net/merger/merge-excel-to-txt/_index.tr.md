...
url: /tr/net/merger/merge-excel-to-txt/ 
...
Aşağıdaki örnek, EXCEL'in Aspose.Cells for .NET'deki TXT ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 EXCEL'i programlı olarak TXT ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i TXT ile birleştirmek için .NET kitaplığı" %}}
