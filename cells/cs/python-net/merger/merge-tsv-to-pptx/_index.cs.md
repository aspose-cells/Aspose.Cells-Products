...
url: /cs/python-net/merger/merge-tsv-to-pptx/ 
...
Následující příklad ukazuje, jak sloučit TSV až PPTX v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit TSV až PPTX? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
