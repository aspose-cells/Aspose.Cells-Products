...
description: Aspose เอ็กเซล. แปลง TSV เป็น ETT อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Java TSV เป็น ETT Java บันทึก TSV ไปที่ อีทีที. บันทึก TSV เป็น ETT โดยใช้ Java
...
{{% blocks/products/pf/agp/content h2="บันทึก TSV ไปที่ ETT ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง TSV เป็น ETT ใน Java
...
{{% blocks/products/pf/agp/content h2="Java ไลบรารี่เพื่อแปลง TSV เป็น ETT" %}}
{{% blocks/products/pf/agp/text %}}
