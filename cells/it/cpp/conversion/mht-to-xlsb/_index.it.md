...
Hai bisogno di convertire i file MHT in XLSB tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in XLSB in poche righe di codice.
...
1.  Convertire MHT in XLSB chiamando il metodo Save().
