---
title: SPREADSHEETML mit XLS zusammenführen – SPREADSHEETML mit XLS in Python kombinieren
url: /de/python-java/merger/merge-spreadsheetml-to-xls/ 
description: Aspose Excel. Python Aspose.Cells. Kostenlose Online-Zusammenführung von SPREADSHEETML in das XLS-Speicherformat. Python Kombinieren Sie SPREADSHEETML mit dem Format XLS. Führen Sie SPREADSHEETML zu XLS in Python zusammen. SPREADSHEETML Zusammenführen.
...
Das folgende Beispiel zeigt, wie SPREADSHEETML mit XLS in Aspose.Cells for Python via Java zusammengeführt wird.
...
{{% cells-merger title="Kostenlos online zum Zusammenführen von SPREADSHEETML mit XLS in Python" InputFormat="xml" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie SPREADSHEETML über Python mit XLS zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie SPREADSHEETML programmgesteuert mit XLS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs können mit nur wenigen Codezeilen erstellt werden.
