...
url: /nl/cpp/merger/merge-html-to-bmp/ 
...
Het volgende voorbeeld laat zien hoe u HTML samenvoegt met BMP in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u HTML programmatisch samenvoegen met BMP? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om HTML samen te voegen met BMP" %}}
