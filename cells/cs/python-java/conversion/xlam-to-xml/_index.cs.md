---
title: XLAM do XML – Převést XLAM do XML Python via Python
...
{{% blocks/products/pf/agp/content h2="Převeďte XLAM na XML pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XLAM na XML v Python.
