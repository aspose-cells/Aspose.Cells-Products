---
title: C++ HTM เป็น MD - ตัวแปลง HTM เป็น MD ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลงรูปแบบไฟล์ HTM เป็น MD C++ รูปแบบ HTM เป็น MD บันทึก HTM ไปที่ MD C++
...
{{% blocks/products/pf/agp/content h2="บันทึก HTM เป็น MD ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง HTM เป็น MD โดยเรียกเมธอด Save()
