...
ต้องการแปลงไฟล์ HTM เป็น ODS โดยใช้โปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลง HTM เป็น ODS ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงไฟล์ HTM เป็นรหัส ODS โดยเรียกใช้เมธอด Save()
