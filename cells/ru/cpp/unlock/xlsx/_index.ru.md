...
{{% blocks/products/pf/agp/content h2="Как снять защиту с файла XLSX с помощью C++" %}}
...
1. Загрузите заблокированный файл XLSX с помощью CreateIWorkbook.1. Вызовите функцию Unprotect() для разблокировки.1. Установите пароль на NULL с помощью SetPassword.1. Сохраните файл XLSX в указанном месте.
