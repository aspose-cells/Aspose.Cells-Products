---
title: Gabung XLT ke ET - Gabungkan XLT ke ET di Java
url: /id/java/merger/merge-xlt-to-et/ 
description: Aspose Unggul. Java Aspose.Cells. Gabung Online Gratis XLT ke ET saveformat. Java Gabungkan XLT ke format ET. Gabung XLT ke ET di Java. XLT Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLT ke ET di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan XLT ke ET di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLT ke ET. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ET. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan XLT ke ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis untuk Menggabungkan XLT menjadi ET di Java" InputFormat="xlt" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLT menjadi ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLT ke ET secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan XLT ke ET" %}}
