...
url: /ja/cpp/merger/merge-xls-to-xls/ 
...
次の例は、XLS を Aspose.Cells for C++ の XLS にマージする方法を示しています。
...
XLS をプログラムで XLS にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="C++ XLS を XLS にマージするライブラリ" %}}
