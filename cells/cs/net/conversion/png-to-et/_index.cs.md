...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu PNG do formátu ET, což umožňuje bezproblémové ukládání dat PNG do formátu ET pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Ušetřete PNG na ET v C#" %}}

Následující příklad ukazuje, jak převést číslo PNG na ET v kódu C#.
...
1.  Převeďte číslo PNG na ET voláním metody Workbook.Save.
