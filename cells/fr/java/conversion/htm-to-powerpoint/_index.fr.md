---
title: Java Convertisseur HTM vers PowerPoint
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format HTM au format POWERPOINT, permettant un enregistrement transparent des données HTM au format POWERPOINT à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au format POWERPOINT (Java)" %}}

L'exemple suivant montre comment convertir du HTM en POWERPOINT dans Java.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier HTM en PowerPoint. Importez votre fichier HTM, puis enregistrez-le au format PowerPoint. Pour la lecture du fichier HTM et l'écriture dans PowerPoint, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme du fichier PowerPoint généré seront identiques à ceux du document HTM original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir du HTML en PowerPoint" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="pptx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir un fichier HTM en POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en POWERPOINT par programmation ? Les développeurs de Java peuvent facilement convertir des fichiers HTM en POWERPOINT en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en POWERPOINT en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de HTM en POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir HTM en POWERPOINT" %}}
{{% blocks/products/pf/agp/text %}}
