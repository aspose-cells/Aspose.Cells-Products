---
title:  Birleştirme XLSM Dosyalar via Java
weight: 1270
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment üzerinde XLSM belgelerini birleştirmek için Java örnek kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSM Biçimlerini Java\'de birleştir" h2="Sunucu tarafı Java API\'leri kullanılarak yerel XLSM belge birleştirme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
+ İlk XLSM dosyasını bir Workbook sınıfı örneği ile yükleyin.
+ İkinci XLSM belgesini bir Workbook sınıfı örneği ile yükleyin.
+ Combine() yöntemini kullanarak dosyaları birleştirin.
+ birleştirilmiş XLSM dosyasını belirtilen yola kaydet
