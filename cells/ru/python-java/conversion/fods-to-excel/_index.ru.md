...
{{% blocks/products/pf/agp/content h2="Преобразование FODS в EXCEL с помощью библиотеки Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в EXCEL в библиотеке Excel Python." %}}

В следующем примере показано, как преобразовать FODS в EXCEL в библиотеке Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Библиотека Excel для преобразования FODS в EXCEL" %}}
