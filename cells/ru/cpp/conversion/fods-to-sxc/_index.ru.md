...
Нужно программно конвертировать файлы FODS в SXC? Разработчики C++ могут легко преобразовать FODS в SXC всего за несколько строк кода.
