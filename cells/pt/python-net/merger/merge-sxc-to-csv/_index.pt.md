...
description: Aspose Excel. Python Aspose.Cells. Mesclar SXC com CSV salvar formato. Python Combine o formato SXC com CSV. Mesclar SXC a CSV em Python. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC com CSV usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC com CSV em Python" %}}

O exemplo a seguir demonstra como mesclar SXC com CSV em Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Exemplo de código para mesclar SXC a CSV em Python" InputFormat="sxc" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC com CSV por meio de Python" %}}
