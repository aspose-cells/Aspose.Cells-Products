---
title: C# 番号から DIF - 番号から DIF へのコンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、NUMBERS を DIF にすばやく簡単に変換します。 C# NUMBERS を DIF に変換します。 C# NUMBERS を DIF に保存します。 C# を使用して、NUMBERS を DIF として保存します。
...
{{% blocks/products/pf/agp/content h2="番号を C# の DIF に保存" %}}

次の例は、NUMBERS を C# の DIF に変換する方法を示しています。
...
{{% cells-convert title="NUMBERSをDIFに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でNUMBERSをDIFに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS ファイルをプログラムで DIF に変換する必要がありますか? .NET 開発者は、わずか数行のコードで NUMBERS を簡単にロードして DIF に変換できます。
...
{{% blocks/products/pf/agp/content h2="C# NUMBERS を DIF に変換するライブラリ" %}}
