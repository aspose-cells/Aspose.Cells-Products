...
Precisa converter arquivos OTS para SQL programaticamente? Os desenvolvedores do código C++ podem converter facilmente arquivos OTS para SQL com apenas algumas linhas de código.
...
1.  Converta OTS para SQL chamando o método Save().
