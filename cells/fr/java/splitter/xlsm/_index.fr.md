---
title: Diviser les fichiers XLSM via Java 
weight: 5670
url: /fr/java/splitter/xlsm/ 
description: Java exemple de code pour diviser les documents XLSM sur Java l'environnement d'exécution pour les applications d'application et de bureau JSP/JSF.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Diviser les fichiers XLSM via Java" h2="Fractionnement XLSM à l\'aide de la bibliothèque Java côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment diviser un fichier XLSM à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fractionner les fichiers XLSM dans Java" %}}
...
+ Appelez la méthode de sauvegarde avec le nouveau chemin de fichier XLSM.
...
{{% blocks/products/pf/agp/code-block title="Diviser le fichier XLSM - Java" offSpacer="" %}}
