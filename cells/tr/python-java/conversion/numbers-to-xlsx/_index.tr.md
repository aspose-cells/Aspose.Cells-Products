---
title: Python NUMARALAR'dan XLSX'e - NUMARALAR'dan XLSX'e Dönüştürücü
description: Aspose Excel'de. NUMBERS'ı Aspose.Cells ile hızlı ve kolay bir şekilde XLSX'e dönüştürün. Python NUMBERS'ı XLSX'e dönüştürün. Python NUMBERS'ı XLSX'e kaydedin. NUMBERS'ı Python'i kullanarak XLSX olarak kaydedin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python\'de NUMBERS\'ı XLSX\'e dönüştür" h2="NUMBERS\'ı XLSX\'e dönüştürmek için yüksek hızlı Python kitaplığı. Bu, NUMBERS\'ı, XLSX\'i ve Python\'i kullanarak diğer birçok formatı içe ve dışa aktarmak için profesyonel bir yazılım çözümüdür." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="NUMBERS\'ı XLSX\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı Python aracılığıyla XLSX\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı programlı olarak XLSX'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyip XLSX'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak NUMBERS'ı XLSX'e dönüştürün.
1.  NUMBERS'ın dönüşüm sonucunu XLSX'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı XLSX\'e dönüştürmek için Python kitaplığı" %}}
