---
title: स्प्रैडशीटएमएल को Java के माध्यम से जीआईएफ में बदलें 

description: SPREADSHEETML प्रारूप के लिए GIF फ़ाइल में नमूना Java रूपांतरण कोड। प्रोग्रामर इस उदाहरण कोड का उपयोग किसी भी वेब या डेस्कटॉप Java आधारित एप्लिकेशन के भीतर एक्सेल और ओपनऑफिस स्प्रेडशीट को जीआईएफ में निर्यात करने के लिए कर सकते हैं।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="स्प्रैडशीटएमएल को Java के माध्यम से जीआईएफ में बदलें" h2="ऑन-प्रिमाइसेस Java लाइब्रेरी का उपयोग करके एकल या एकाधिक पृष्ठों को जीआईएफ में बदलने के लिए स्प्रैडशीटएमएल से जीआईएफ Java रूपांतरण।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="SPREADSEEETML को Java का उपयोग करके GIF में कैसे बदलें" %}}

 स्प्रैडशीटएमएल को जीआईएफ में रेंडर करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="PREADSHEETML को Java के माध्यम से GIF में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Java डेवलपर स्प्रैडशीटएमएल फ़ाइल को कोड की कुछ ही पंक्तियों में आसानी से GIF में बदल सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. वर्कबुक के इंस्टेंस के साथ स्प्रैडशीटएमएल फाइल लोड करें1. संग्रह से डिफ़ॉल्ट या किसी वर्कशीट का चयन करें1. ImageOrPrintOptions का ऑब्जेक्ट बनाएं और सेट करें1. वर्कशीट और इमेजऑरप्रिंटऑप्शन ऑब्जेक्ट्स के साथ शीटरेंडर बनाएं1. GIF फॉर्मेट में रिजल्ट सेव करने के लिए SheetRender.toImage मेथड को कॉल करें
...
{{% blocks/products/pf/agp/code-block title="स्प्रैडशीटएमएल से जीआईएफ Java रूपांतरण स्रोत कोड" offSpacer="" %}}
