---
title: Fusionner IMAGE à MHT - Combiner IMAGE à MHT en C++
url: /fr/cpp/merger/merge-image-to-mht/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion en ligne gratuite IMAGE au format de sauvegarde MHT. C++ Combinez IMAGE au format MHT. Fusionner IMAGE avec MHT en C++. Fusionner IMAGE.
...
{{% blocks/products/pf/agp/content h2="Fusionner IMAGE à MHT en C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner IMAGE avec MHT dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner IMAGE en MHT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier MHT. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne IMAGE en MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner IMAGE à MHT en C++" InputFormat="png" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner IMAGE en MHT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner IMAGE avec MHT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner IMAGE en MHT" %}}
