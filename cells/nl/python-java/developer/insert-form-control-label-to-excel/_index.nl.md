---
title:  Voeg Label (formulierbesturingselement) in Excel in met Java Python via
weight: 80
description: Python via Java-broncode om Label (formulierbesturingselement) in Excel in te voegen.
...
{{% blocks/products/pf/agp/content h2="Label (formulierbesturingselement) invoegen in Excel-bestand met behulp van Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Label (formulierbesturingselement) in te voegen in een Excel-bestand met behulp van java Python via" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de vormcollecties[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLabel(int,%20int,%20int,%20int,%20int,%20int)) om een Label (formulierbesturingselement) in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Label invoegen (formulierbesturingselement) - Python via java" offSpacer="" %}}
