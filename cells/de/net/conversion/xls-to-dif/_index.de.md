---
title: C# XLS zu DIF - Online-Konverter von XLS zu DIF
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das Speicherformat DIF. C# XLS bis DIF Format. Speichern Sie XLS bis DIF C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis DIF in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLS in DIF in C# konvertiert wird.
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Online-Konvertieren von XLS in DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in DIF" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in DIF konvertieren? .NET-Entwickler können XLS problemlos in nur wenigen Codezeilen laden und in DIF konvertieren.
...
1.  Konvertieren Sie XLS in DIF, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in DIF" %}}
