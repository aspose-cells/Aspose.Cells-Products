...
url: /id/cpp/merger/merge-excel-to-image/ 
...
Contoh berikut menunjukkan cara menggabungkan EXCEL ke IMAGE di Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan EXCEL ke IMAGE secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="C++ library untuk menggabungkan EXCEL ke IMAGE" %}}
