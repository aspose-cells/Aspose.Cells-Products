---
title:  मैं Python via जावा का उपयोग करके एक्सेल में डबल स्ट्रेट एरो कैसे बनाऊं या डालूं
weight: 10
description: Python via एक्सेल में डबल सीधा तीर खींचने या डालने के लिए जावा स्रोत कोड।
...
{{% blocks/products/pf/agp/content h2="Python via जावा का उपयोग करके एक्सेल फ़ाइल में डबल स्ट्रेट एरो कैसे डालें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via जावा का उपयोग करके एक्सेल फ़ाइल में डबल स्ट्रेट एरो डालने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से वर्कशीट का चयन करें।
 + आकृति संग्रह का उपयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) चयनित वर्कशीट में एक डबल सीधा तीर डालने के लिए।
...
{{% blocks/products/pf/agp/code-block title="दोहरा सीधा तीर डालें - Python via जावा" offSpacer="" %}}
