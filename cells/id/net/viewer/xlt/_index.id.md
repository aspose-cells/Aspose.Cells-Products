---
title:  Lihat Format File XLT via .NET
weight: 3610
description: Kode sumber C# untuk memuat, merender, dan menampilkan dokumen XLT pada Framework .NET, .NET Core, Mono atau Platform Xamarin.
---
...
1.  Muat file XLT dalam contoh Workbook
