---
title: Konvertera XLS till XLTX via Java 
weight: 4100

description: Exempel Java-konverteringskod för XLS-format till XLTX-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLTX inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLS till XLTX med Java" %}}

 För att rendera XLS till XLTX kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLS till XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLS-fil till XLTX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLS-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLTX-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLTX-filen
...
{{% blocks/products/pf/agp/code-block title="XLS till XLTX Java konverteringskällkod" offSpacer="" %}}
