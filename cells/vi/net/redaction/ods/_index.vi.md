---
title:  Tìm kiếm và thay thế văn bản trong tài liệu ODS via .NET
weight: 6100
description: C# để biên tập lại thông tin nhạy cảm trong tệp ODS trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Viết lại ODS Định dạng trong C#" h2="Bản gốc và hiệu suất cao ODS ghi lại thông tin biên tập nhạy cảm bằng cách sử dụng API Aspose.Cells for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
+ Lặp qua từng ô và dùng phương thức Find.
Lưu sổ làm việc.
...
{{< blocks/products/pf/agp/other-supported-section title="Các định dạng Redaction được hỗ trợ khác" subTitle="Sử dụng C#, người ta có thể dễ dàng sắp xếp lại các định dạng khác nhau bao gồm." >}}
