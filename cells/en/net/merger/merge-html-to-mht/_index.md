...
description: C# source code to combine HTML to MHT file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="How to Merge HTML to MHT File Using C#" %}}
 ...
 In order to merge HTML to MHT file, we’ll use
...
+  Call the Save() method and pass the file name (full path) and format (MHT) as a parameter.
+  Now you can open and use the MHT file in Microsoft Office, Adobe PDF or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Merge HTML to MHT Files - C#" offSpacer="" %}}
