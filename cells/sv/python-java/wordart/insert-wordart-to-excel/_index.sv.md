---
title:  Infoga WordArt i Excel med Python via Java
weight: 200
description: Python via Java källkod för att infoga WordArt i Excel.
...
{{% blocks/products/pf/agp/content h2="Hur man infogar WordArt i Excel-fil med Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga WordArt till Excel-fil med Python via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addWordArt(int,%20java.lang.String,%20int,%20int,%20int,%20int,%20int,%20int)) för att infoga en WordArt i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga WordArt - Python via Java" offSpacer="" %}}
