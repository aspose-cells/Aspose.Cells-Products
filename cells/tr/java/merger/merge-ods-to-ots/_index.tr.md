---
title: ODS'i OTS ile birleştir - ODS'i Java'de OTS ile birleştir
url: /tr/java/merger/merge-ods-to-ots/ 
description: Aspose excel. Java Aspose.Cells. ODS'i OTS saveformat'a Ücretsiz Çevrimiçi Birleştirme. Java ODS'i OTS biçimiyle birleştirin. ODS'i Java'de OTS ile birleştir. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java Online\'da OTS ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de OTS ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i OTS ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından OTS dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. ODS'i OTS ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'de OTS ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS OTS via Java ile Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

ODS'i programlı olarak OTS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i OTS ile birleştirmek için Java kitaplığı" %}}
