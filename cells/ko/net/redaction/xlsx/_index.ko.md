---
title:  XLSX 문서 via .NET에서 텍스트 검색 및 바꾸기
weight: 2370
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼의 XLSX 파일에서 중요한 정보를 수정합니다.
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 XLSX 파일을 수정하는 방법" %}}
 ...
 XLSX 파일을 수정하기 위해 다음을 사용합니다.[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API은 기능이 풍부하고 강력하며 사용하기 쉬운 C# 플랫폼용 문서 조작 API입니다. 열려 있는[NuGet](https://www.nuget.org/packages/aspose.cells) 패키지 관리자, 검색**Aspose.Cells** 그리고 설치하세요. 패키지 관리자 콘솔에서 다음 명령을 사용할 수도 있습니다.
