---
title: C++ uygulaması aracılığıyla XLTX'i MHTML'ye dönüştürün 
url: /tr/cpp/conversion/xltx-to-mhtml/ 
description: XLTX belgesi için MHTML biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu XLTX'ten MHTML'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla XLTX\'i MHTML\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı XLTX\'ten MHTML\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak XLTX\'i MHTML\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ üzerinden XLTX\'i MHTML\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 C++ geliştiricileri, yalnızca birkaç kod satırıyla XLTX dosyasını MHTML'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak XLTX dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (MHTML) dosya uzantısıyla iletin.1. MHTML dosyası belirtilen yola kaydedilecektir.1. MHTML dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="XLTX - MHTML C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
