---
title: A MHTML egyesítése az MHT-val – a MHTML-es szám egyesítése az MHT-vel a C#-ben
url: /hu/net/merger/merge-mhtml-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés MHTML MHT mentési formátumba. C# A MHTML kombinálása MHT formátumba. A MHTML egyesítése az MHT-val a C#-es számon. MHTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a MHTML-es számot az MHT-vel a C#-es számon online" %}}

A következő példa bemutatja, hogyan egyesítheti a MHTML-et az MHT-val a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a MHTML és az MHT egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el MHT-fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a MHTML-et az MHT-val.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a MHTML-es számmal az MHT-vel a C#-ben" InputFormat="mhtml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML és az MHT egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a MHTML-et az MHT-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML és az MHT egyesítése érdekében" %}}
