---
title: MHTML mit PRN zusammenführen – MHTML mit PRN in C# kombinieren
url: /de/net/merger/merge-mhtml-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. Kostenlose Online-Zusammenführung von MHTML in das PRN-Speicherformat. C# Kombinieren Sie MHTML zum PRN-Format. MHTML mit PRN in C# zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie MHTML kostenlos online mit PRN in C# zusammen" %}}

Das folgende Beispiel zeigt, wie MHTML mit PRN in Aspose.Cells for .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um MHTML mit PRN zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der PRN-Datei. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das MHTML mit PRN zusammenführt.
...
{{% blocks/products/pf/agp/content h2="So führen Sie MHTML über C# mit PRN zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie MHTML programmgesteuert mit PRN zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von MHTML mit PRN" %}}
