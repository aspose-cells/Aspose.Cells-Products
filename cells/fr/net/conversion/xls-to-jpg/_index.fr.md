---
title: C# XLS en JPG - Convertisseur XLS en JPG
description: Aspose Exceller. Convertissez XLS en JPG rapidement et facilement avec Aspose.Cells. C# XLS en JPG. C# Enregistrez XLS au format JPG. Enregistrez XLS au format JPG en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer XLS au format JPG dans C#" %}}

L'exemple suivant montre comment convertir XLS en JPG en C#.
...
{{% cells-convert title="Exemple de code pour convertir XLS en JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en JPG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en JPG par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en JPG en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en JPG" %}}
