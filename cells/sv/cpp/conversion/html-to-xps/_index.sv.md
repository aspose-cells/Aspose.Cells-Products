...
description: Aspose Excel. Denna omfattande lösning ger C++-utvecklare en helt integrerad metod för att konvertera HTML till XPS-format, vilket möjliggör sömlös sparning av HTML-data till XPS-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C++-kod.
...
{{% blocks/products/pf/agp/content h2="Konvertera HTML till XPS med hjälp av C++" %}}
...
{{% cells-convert title="Exempelkod för att konvertera HTML till XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar HTML till XPS via C++" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera HTML-filer till XPS programmatiskt? C++-utvecklare kan enkelt konvertera HTML till XPS med bara några få rader kod.
...
1.  Konvertera HTML till XPS genom att anropa Save()-metoden.
1.  Få konverteringsresultatet från HTML till XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++-biblioteket för att konvertera HTML till XPS" %}}
