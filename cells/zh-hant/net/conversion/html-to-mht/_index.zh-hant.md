---
title: C# HTML 轉 MHT - 在線 HTML 轉 MHT 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 HTML 轉換為 MHT 保存格式。 C# HTML 為 MHT 格式。將 HTML 保存到 MHT C#。
...
{{% blocks/products/pf/agp/content h2="免費在線將 HTML 保存到 C# 中的 MHT" %}}

以下示例演示如何將 HTML 轉換為 C# 中的 MHT。
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 HTML 轉換為 MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 HTML 轉換為 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 HTML 文件轉換為 MHT？ .NET 開發人員只需幾行代碼即可輕鬆加載 HTML 並將其轉換為 MHT。
