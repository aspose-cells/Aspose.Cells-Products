---
title: Gộp OTS vào HTM - Gộp OTS vào HTM Java
url: /vi/java/merger/merge-ots-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu OTS sang HTM. Java Kết hợp định dạng OTS sang HTM. Hợp nhất OTS thành HTM theo số Java. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Gộp OTS vào HTM theo số Java" %}}

Ví dụ sau đây minh họa cách hợp nhất OTS với HTM trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất OTS với HTM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp HTM. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất OTS với HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp OTS vào HTM Java" InputFormat="ots" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp OTS vào HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất OTS với HTM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép OTS vào HTM" %}}
