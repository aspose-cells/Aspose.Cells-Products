...
{{< blocks/products/pf/i18n/upper-banner h1="TXT konvertálása SXC-vé a következőn keresztül: Java" h2="TXT SXC Java átalakítás egyetlen vagy több oldal konvertálásához SXC formátumba a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="TXT konvertálása SXC-vé a következővel: Java" %}}

 Ahhoz, hogy a TXT-t SXC-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TXT konvertálása SXC-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java fejlesztői könnyedén konvertálhatják a TXT fájlt SXC formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat SXC kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott SXC fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT SXC Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése SXC-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT-ből SXC-be konvertáló élő bemutatók" sectionDescription="[TXT konvertálása SXC-re](https://products.aspose.app/cells/conversion/txt-to-sxc) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel TXT fájlját, és azonnal SXC formátumba konvertálódik." >}}
