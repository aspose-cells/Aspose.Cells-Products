---
title: C# XLT 转 IMAGE - XLT 转 IMAGE 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLT 转换为 IMAGE。C# XLT 转换为 IMAGE。 C# 将 XLT 保存到图像。使用 C# 将 XLT 保存为 IMAGE。
...
{{% cells-convert title="将 XLT 转换为 IMAGE 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="png" IsLandingPage="true" %}}
