...
description: Aspose Эксель. Быстро и легко конвертируйте XML в TXT с помощью Aspose.Cells. Python XML в TXT. Python Сохраните XML в TXT. Сохраните XML как TXT, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразование XML в TXT с помощью Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML в TXT в Python." %}}

В следующем примере показано, как преобразовать XML в TXT в Python.
...
{{% cells-convert title="Пример кода для преобразования XML в TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="txt" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека Python для преобразования XML в TXT" %}}
