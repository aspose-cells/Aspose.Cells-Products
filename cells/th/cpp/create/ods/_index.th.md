...
description: ODS ผู้สร้าง. สร้างไฟล์ ODS ในรหัส C++ สร้างไฟล์ ODS (Openoffice / Lbreoffice) โดยใช้แอปพลิเคชัน C++
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="สร้างไฟล์ ODS ผ่าน C++" h2="การสร้างสเปรดชีตแบบเนทีฟและประสิทธิภาพสูง ODS (Openoffice / Lbreoffice) โดยทางโปรแกรมโดยไม่ต้องใช้ Micorsoft Office โดยใช้ไลบรารี่ C++" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
