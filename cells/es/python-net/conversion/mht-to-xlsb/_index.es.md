...
description: Aspose Excel. Convierta MHT a XLSB rápida y fácilmente con Aspose.Cells. Python MHT a XLSB. Python Guarde MHT en XLSB. Guarde MHT como XLSB usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde MHT en XLSB en Python" %}}

El siguiente ejemplo demuestra cómo convertir MHT a XLSB en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir MHT a XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xlsb" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir MHT a XLSB" %}}
