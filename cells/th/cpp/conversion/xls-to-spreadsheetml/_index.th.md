...
description: Aspose เอ็กเซล. แปลง XLS เป็น SPREADSHEETML อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XLS เป็น SPREADSHEETML C++ บันทึก XLS ลงใน SPREADSHEETML บันทึก XLS เป็น SPREADSHEETML โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ไปยัง SPREADSHEETML ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLS เป็น SPREADSHEETML ใน C++
...
ต้องการแปลงไฟล์ XLS เป็น SPREADSHEETML โดยทางโปรแกรมหรือไม่ นักพัฒนา C++ สามารถแปลง XLS เป็น SPREADSHEETML ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง XLS เป็น SPREADSHEETML โดยการเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลงจาก XLS เป็น SPREADSHEETML

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ไลบรารี C++ เพื่อแปลง XLS เป็น SPREADSHEETML" %}}
