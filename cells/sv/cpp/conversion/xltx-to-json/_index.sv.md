---
title: Konvertera XLTX till JSON via C++-appen 
url: /sv/cpp/conversion/xltx-to-json/ 
description: Exempel på C++-konverteringskod för XLTX-dokument till JSON-format. Programmerare kan använda den här källkoden för batchkonvertering av XLTX till JSON i alla C++-program.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLTX till JSON via C++" h2="Högpresterande XLTX till JSON-konvertering med hjälp av C++-biblioteket utan behov av Microsoft Excel, OpenOffice eller Adobe Acrobat-installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLTX till JSON med C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLTX till JSON via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-utvecklare kan enkelt konvertera XLTX-filen till JSON på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTX-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (JSON) filtillägg.1. JSON-filen kommer att sparas på den angivna sökvägen.1. Öppna JSON-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="XLTX till JSON C++ omvandlingskällkod" offSpacer="" %}}
