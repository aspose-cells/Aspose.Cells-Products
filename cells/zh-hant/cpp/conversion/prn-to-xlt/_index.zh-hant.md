...
description: Aspose Excel。此綜合解決方案為 C++ 開發人員提供了一種完全整合的方法，可將 PRN 轉換為 XLT 格式，從而能夠使用 Aspose.Cells 庫將 PRN 資料無縫保存為 XLT 格式，所有這些都透過高效能自訂的 08153481 程式碼。
...
{{% blocks/products/pf/agp/content h2="將 PRN 保存到 XLT 和 C++" %}}

以下範例示範如何將 PRN 轉換為 C++ 中的 XLT。
...
{{% cells-convert title="將 PRN 轉換為 XLT 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="prn" outformat="xlt" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 PRN 轉換為 XLT" %}}

{{% blocks/products/pf/agp/text %}}

需要透過程式將 PRN 檔案轉換為 XLT 格式嗎？ C++ 開發人員只需幾行程式碼即可輕鬆將 PRN 轉換為 XLT 格式。
...
1. 使用工作簿載入PRN檔案。
1. 呼叫 Save() 方法將 PRN 轉換為 XLT。
1. 取得PRN到XLT的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ 庫將 PRN 轉換為 XLT" %}}
