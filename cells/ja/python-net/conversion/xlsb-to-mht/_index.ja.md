---
title: Python XLSB から MHT - XLSB から MHT コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLSBをMHTにすばやく簡単に変換します。Python XLSBをMHTに変換します。 Python XLSB を MHT に保存します。 Python を使用して、XLSB を MHT として保存します。
...
{{% blocks/products/pf/agp/content h2="XLSB を Python の MHT に変換します" %}}

 XLSBをMHTに変換するにはどうすればよいですか? NET ライブラリ経由で Aspose.Cells for Python を使用すると、数行のコードでプログラム的に XLSB を MHT に簡単に変換できます。[Aspose.Cells for Python 経由 NET](https://pypi.org/project/aspose-cells-python/)すべての Excel ファイルを生成、変更、変換、レンダリング、印刷できるクロスプラットフォーム アプリケーションを構築できます。 Python Excel API は、スプレッドシート形式間で変換するだけでなく、Excel ファイルを画像 PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT などとしてレンダリングすることもできるため、業界標準形式でドキュメントを交換するのに最適です。
...
次の例は、XLSB を Python via NET の MHT に変換する方法を示しています。
...
{{% cells-convert title="XLSBをMHTに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="mht" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="XLSBをMHTに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSB ファイルをプログラムで MHT に変換する必要がありますか? Python 開発者は、わずか数行のコードで XLSB を簡単にロードして MHT に変換できます。
