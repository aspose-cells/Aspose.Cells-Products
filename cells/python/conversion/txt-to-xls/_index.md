...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to XLS Using Python" %}}
 ...
 In order to convert TXT to XLS, we will use
...
{{% cells-convert title="Free App and Sample Code to Convert TXT to XLS" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx InputFormat=txt outformat=xls IsLandingPage=true language=python %}}
