...
description: Aspose Excel. Python Aspose.Cells. NUMBERS samenvoegen naar HTM-opslagformaat. Python Combineer NUMBERS naar HTM-formaat. NUMBERS samenvoegen naar HTM in Python. NUMBERS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg NUMBERS samen naar HTM met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Voeg NUMBERS samen naar HTM in Python" %}}

Het volgende voorbeeld laat zien hoe u NUMBERS samenvoegt met HTM in Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om NUMBERS samen te voegen naar HTM. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een HTM-bestand. Als u code ontwikkelt in Python, is dit eenvoudiger dan het klinkt. Zie het voorbeeld Python waarin NUMBERS wordt samengevoegd tot HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om NUMBERS samen te voegen met HTM in Python" InputFormat="numbers" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe NUMBERS samen te voegen naar HTM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u NUMBERS programmatisch samenvoegen met HTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om NUMBERS samen te voegen met HTM" %}}
