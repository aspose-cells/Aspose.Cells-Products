---
title: Convertir TXT en JPG via l'application C++ 
url: /fr/cpp/conversion/txt-to-jpg/ 
description: Exemple de code de conversion C++ pour le document TXT au format JPG. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de TXT en JPG dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TXT en JPG via C++" h2="Conversion TXT en JPG haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TXT en JPG en utilisant C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TXT en JPG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier TXT en JPG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier TXT à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (JPG).1. Le fichier JPG sera enregistré dans le chemin spécifié.1. Ouvrez le fichier JPG dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion TXT en JPG C++" offSpacer="" %}}
