...
تحتاج إلى تحويل SXC ملفات إلى XLSX برمجيا؟ يمكن للمطورين C++ تحويل SXC إلى XLSX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول SXC إلى XLSX باستدعاء طريقة Save ().
