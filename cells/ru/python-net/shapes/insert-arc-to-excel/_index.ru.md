...
{{% blocks/products/pf/agp/content h2="Как вставить дугу в файл Excel с помощью Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке файла Arc в Excel через Python" %}}
...
+ Используйте метод add коллекции форм, чтобы вставить дугу в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить дугу - Python" offSpacer="" %}}
