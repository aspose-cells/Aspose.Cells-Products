---
title: Sloučit XLSB až MHTML - Sloučit XLSB až MHTML v Python
url: /cs/python-net/merger/merge-xlsb-to-mhtml/ 
description: Aspose Excel. Python Aspose.Cells. Online sloučení zdarma XLSB do formátu uložení MHTML. Python Kombinujte formát XLSB až MHTML. Sloučit XLSB až MHTML v Python. XLSB Sloučit.
...
Následující příklad ukazuje, jak sloučit XLSB až MHTML v Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Online zdarma ke sloučení XLSB až MHTML v Python" InputFormat="xlsb" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB na MHTML přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLSB až MHTML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
