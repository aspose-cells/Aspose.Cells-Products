---
title:  Vyhledat dokument ODS bez otevření přes C++
weight: 3300
description: Příklad kódu C++ pro vyhledávání slov se vzorem v souboru ODS v běhovém prostředí C++ pro 32bitové verze Windows, 64bitové verze Windows a 64bitové verze Linuxu.
...
{{< blocks/products/pf/i18n/upper-banner h1="Vyhledávání formátů ODS v C++" h2="Nativní a vysoce výkonné vyhledávání dokumentů ODS pomocí serverových Aspose.Cells for C++ API, bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vyhledat soubor ODS pomocí adresáře C++" %}}

 Pro vyhledání souboru ODS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vyhledávání souborů ODS v adresáři C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Vyhledávání souborů ODS - C++" offSpacer="" %}}
