---
title: Mesclar PRN para TABDELIMITED - Combine PRN para TABDELIMITED em C++
url: /pt/cpp/merger/merge-prn-to-tabdelimited/ 
description: Aspose Excel. C++ Aspose.Cells. Mesclar o PRN para o formato de salvamento TABDELIMITED online grátis. C++ Combine PRN para o formato TABDELIMITED. Mesclar PRN para TABDELIMITED em C++. Mesclar PRN.
...
{{% blocks/products/pf/agp/content h2="Mesclar PRN para TABDELIMITED em C++ online gratuitamente" %}}

exemplo a seguir demonstra como mesclar PRN com TABDELIMITED em Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar PRN com TABDELIMITED. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo TABDELIMITED. Se você desenvolver código em C++, isso será mais simples do que parece. Consulte o exemplo C++ que mescla PRN com TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar PRN para TABDELIMITED em C++" InputFormat="prn" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar PRN para TABDELIMITED via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar PRN para TABDELIMITED programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para mesclar PRN para TABDELIMITED" %}}
