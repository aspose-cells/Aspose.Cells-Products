---
title:  Mở khóa XLSB tài liệu via .NET
weight: 6410
description: Mã nguồn C# để mở khóa tệp XLSB được bảo vệ bằng mật khẩu trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
...
{{% blocks/products/pf/agp/content h2="Cách mở khóa tệp XLSB bằng C#" %}}
 ...
 Để xóa tệp bảo vệ XLSB, chúng tôi sẽ sử dụng
