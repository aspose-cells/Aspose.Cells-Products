---
title: Fusionar IMAGEN con EXCEL - Combinar IMAGEN con EXCEL en C#
url: /es/net/merger/merge-image-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Fusionar IMAGEN con el formato guardado de EXCEL. C# Combinar IMAGEN al formato EXCEL. Fusionar IMAGEN con EXCEL en C#. Fusionar IMAGEN.
...
{{% blocks/products/pf/agp/content h2="Fusionar IMAGEN con EXCEL en C#" %}}

El siguiente ejemplo demuestra cómo fusionar IMAGEN con EXCEL en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar IMAGEN con EXCEL. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo EXCEL. Si desarrolla código en C#, esto será más simple de lo que parece. Vea el ejemplo C# que combina IMAGEN con EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar IMAGEN con EXCEL en C#" InputFormat="png" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar IMAGEN con EXCEL a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar IMAGEN con EXCEL mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar IMAGEN con EXCEL" %}}
