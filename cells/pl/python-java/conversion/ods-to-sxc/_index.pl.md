---
title: Python ODS do SXC - ODS do SXC Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu ODS do SXC, umożliwiając bezproblemowe zapisywanie danych ODS do formatu SXC za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj ODS na SXC za pomocą biblioteki Excel Python" %}}

 Jak przekonwertować numer ODS na numer SXC? Dzięki bibliotece Aspose.Cells for Python możesz łatwo programowo przekonwertować ODS na SXC za pomocą kilku linijek kodu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Zapisz ODS do SXC w Python Bibliotece Excel" %}}

Poniższy przykład pokazuje, jak przekonwertować ODS na SXC w bibliotece Excel Python.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer ODS na numer SXC. Prześlij plik ODS, a następnie po prostu zapisz go jako plik SXC. Zarówno do odczytu ODS, jak i do zapisu SXC można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego SXC będą identyczne z oryginalnym dokumentem ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji ODS na SXC za pośrednictwem biblioteki Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="sxc" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować ODS na SXC przez Python" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki ODS na SXC? Programiści Python mogą łatwo załadować i przekonwertować ODS na SXC w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer ODS na numer SXC, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji ODS na SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Biblioteka Excel do konwersji ODS na SXC" %}}
