---
title: XLTM を MHT に結合 - XLTM を Java の MHT に結合
url: /ja/java/merger/merge-xltm-to-mht/ 
description: Aspose エクセル。 Java Aspose.Cells。無料オンライン XLTM を MHT 保存形式にマージします。 Java XLTM を MHT 形式に結合します。 XLTM を Java の MHT にマージします。 XLTM をマージします。
...
次の例は、XLTM を Aspose.Cells for Java の MHT にマージする方法を示しています。
...
{{% cells-merger title="XLTM をオンラインで Java の MHT に無料でマージ" InputFormat="xltm" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="XLTM を MHT via Java にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

XLTM をプログラムで MHT にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Java](https://products.aspose.com/cells/java)API はわずか数行のコードで実行できます。
