---
title: C# XLS zu PRN – Online XLS zu PRN Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das PRN-Speicherformat. C# XLS im PRN-Format. Speichern Sie XLS in PRN C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bei PRN in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLS in PRN in C# konvertiert wird.
...
Müssen Sie XLS-Dateien programmgesteuert in PRN konvertieren? .NET-Entwickler können XLS in nur wenigen Codezeilen problemlos laden und in PRN konvertieren.
...
1.  Konvertieren Sie XLS in PRN, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in PRN" %}}
