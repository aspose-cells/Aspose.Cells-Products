...
url: /fr/python-net/merger/merge-jpeg-to-htm/ 
...
L'exemple suivant montre comment fusionner JPEG avec HTM dans Aspose.Cells for Python via .NET.
...
Besoin de fusionner JPEG avec HTM par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
