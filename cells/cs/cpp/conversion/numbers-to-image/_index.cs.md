---
title: C++ NUMBERS to IMAGE – online převodník NUMBERS to IMAGE
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Online zdarma C++ Převeďte ČÍSLA do formátu uložení OBRÁZEK. C++ ČÍSLA do formátu OBRÁZEK. Uložte NUMBERS do IMAGE C++.
...
{{% blocks/products/pf/agp/content h2="Převeďte ČÍSLA na OBRÁZEK pomocí C++" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete ČÍSLA do IMAGE na čísle C++ online zdarma" %}}

Následující příklad ukazuje, jak převést ČÍSLA na IMAGE v C++.
...
Potřebujete převést NUMBERS souborů na IMAGE programově? C++ vývojáři mohou snadno převést ČÍSLA na OBRÁZEK v několika řádcích kódu.
...
1.  Převeďte ČÍSLA na OBRÁZEK voláním metody Save().
1.  Získejte výsledek převodu NUMBERS na IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ knihovna pro převod ČÍSEL na OBRÁZEK" %}}
