---
title:  Вставьте текстовое поле в Excel via Java
weight: 60
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке текстового поля в файл Excel via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addTextBox-int-int-int-int-int-int-) вставить TextBox в выбранный лист
