---
title: C# PNG에서 SQL로 - 온라인 PNG에서 SQL 변환기로
description: Aspose 엑셀. C# Aspose.Cells. C# Aspose Cells. 무료 온라인 C# PNG을 SQL 저장 형식으로 변환합니다. C# PNG을 SQL 형식으로 변환합니다. PNG을 SQL C#에 저장합니다.
...
{{% blocks/products/pf/agp/content h2="PNG을 C# 온라인의 SQL에 무료로 저장" %}}

다음 예는 PNG을 C#에서 SQL로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="PNG을 SQL Online으로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 PNG을 SQL로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 PNG 파일을 SQL로 변환해야 합니까? .NET 개발자는 단 몇 줄의 코드로 PNG을 SQL로 쉽게 로드 및 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2="C# PNG을 SQL로 변환하는 라이브러리" %}}
