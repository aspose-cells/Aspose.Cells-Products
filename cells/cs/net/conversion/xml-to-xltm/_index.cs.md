...
description: Aspose Excel. Převeďte XML na XLTM rychle a snadno pomocí Aspose.Cells. C# XML na XLTM. C# Uložte XML na XLTM. Uložte XML jako XLTM pomocí 0716183
...
{{% blocks/products/pf/agp/content h2="Uložte XML na XLTM v C#" %}}

Následující příklad ukazuje, jak převést XML na XLTM v C#.
...
{{% cells-convert title="Ukázkový kód pro převod XML na XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xltm" IsLandingPage="true" %}}
