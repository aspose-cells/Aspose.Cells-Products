---
title: Visualizza i formati di file TXT tramite .NET 
weight: 8300
url: /it/net/viewer/txt/ 
description: C# codice sorgente per caricare, eseguire il rendering e visualizzare documenti TXT su piattaforme .NET Framework, .NET Core, Mono o Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Visualizzatore file TXT for .NET" h2="Visualizza fogli di calcolo Excel e OpenOffice come TXT senza richiedere Microsoft Excel o Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
1. Carica il file TXT in un'istanza di Workbook1. Crea un'istanza di HtmlSaveOptions e imposta la proprietà ExportHeadings su true1. Salva il file TXT in formato HTML usando il metodo Workbook.Save1. Carica l'HTML risultante nel browser predefinito con Process.Start
...
// salva il file TXT in formato HTML
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API può essere utilizzato per creare, modificare, convertire ed eseguire il rendering di formati Microsoft Excel in formati diversi. Inoltre, può essere utilizzato per grafici completi, report scalabili e calcoli affidabili all'interno di applicazioni software. Aspose.Cells è un API autonomo e non richiede alcun software come Microsoft o OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per visualizzare TXT" sectionDescription="Controlla le nostre demo dal vivo su [Visualizza TXT](https://products.aspose.app/cells/viewer/txt) con i seguenti vantaggi." >}}
