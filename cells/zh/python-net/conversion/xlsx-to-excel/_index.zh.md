---
title: Python XLSX 转 EXCEL - XLSX 转 EXCEL 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLSX 转换为 EXCEL。Python XLSX 转换为 EXCEL。 Python 将 XLSX 保存到 EXCEL。使用 Python 将 XLSX 另存为 EXCEL。
...
{{% blocks/products/pf/agp/content h2="将 XLSX 保存到 EXCEL 中 Python" %}}

以下示例演示如何将Python via NET中的XLSX转换为EXCEL。
...
{{% cells-convert title="将 XLSX 转换为 EXCEL 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
