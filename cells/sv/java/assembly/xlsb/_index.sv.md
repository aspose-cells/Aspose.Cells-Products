...
{{% blocks/products/pf/agp/content h2="Hur man genererar XLSB-rapporter med Java" %}}
...
1.  Spara resultatet i formatet XLSB via metoden Worbook.save
...
{{% blocks/products/pf/agp/code-block title="Generera Excel-rapporter i XLSB-format - Java" offSpacer="" %}}
 ...
 Aspose.Cells API kan användas för att skapa, redigera, konvertera och rendera Microsoft Excel-format till olika format. Dessutom kan den användas för omfattande kartläggning, skalbar rapportering och tillförlitliga beräkningar inom mjukvaruapplikationer. Aspose.Cells är en fristående API och den kräver ingen programvara som Microsoft eller OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att montera XLSB" sectionDescription=" Kolla våra livedemos för att[skapa XLSB filer](https://products.aspose.app/cells/assembly/xlsb) med följande förmåner." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp filen XLSB och tryck på \"Sammanställ\"-knappen" >}}
