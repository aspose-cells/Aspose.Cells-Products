---
title:  XLS Megjegyzés hozzáadása vagy eltávolítása via .NET
weight: 9270
description: C# forráskód a XLS formátumú megjegyzések hozzáadásához és törléséhez a .NET Framework, .NET Core, Mono vagy Xamarin platformokon.
...
{{% blocks/products/pf/agp/feature-section-col title="Megjegyzés hozzáadása vagy törlése a XLS-es számról a C#-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Megjegyzések törlése a XLS - C# számokról" offSpacer="" %}}
