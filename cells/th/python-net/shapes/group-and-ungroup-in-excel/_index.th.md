...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการจัดกลุ่มและเลิกจัดกลุ่มรูปร่างในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="จัดกลุ่มและเลิกจัดกลุ่มรูปร่าง - Python via .Net via .NET" offSpacer="" %}}
