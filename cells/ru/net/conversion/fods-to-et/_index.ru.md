...
Вам нужно программно конвертировать файлы FODS в ET? Разработчики .NET могут легко загрузить и преобразовать FODS в ET всего за несколько строк кода.
...
1.  Преобразуйте FODS в ET, вызвав метод Workbook.Save.
