...
url: /ja/net/merger/merge-ods-to-png/ 
...
次の例は、ODS を Aspose.Cells for .NET の PNG にマージする方法を示しています。
...
ODS をプログラムで PNG にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2=".NET ODS を PNG にマージするライブラリ" %}}
