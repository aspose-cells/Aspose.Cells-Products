---
title: Gabungkan MHTML menjadi PDF - Gabungkan MHTML menjadi PDF menjadi Java
url: /id/java/merger/merge-mhtml-to-pdf/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan MHTML menjadi PDF format simpan. Java Gabungkan format MHTML menjadi PDF. Gabungkan MHTML menjadi PDF di Java. MHTML Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHTML menjadi PDF di Java" %}}

Contoh berikut menunjukkan cara menggabungkan MHTML menjadi PDF di Aspose.Cells for Java.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan MHTML menjadi PDF di Java" InputFormat="mhtml" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML menjadi PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan MHTML ke PDF secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan MHTML menjadi PDF" %}}
