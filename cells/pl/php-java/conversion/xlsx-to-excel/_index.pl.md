...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSX na EXCEL za pomocą Aspose.Cells. PHP XLSX na EXCEL. PHP Zapisz XLSX w programie EXCEL. Zapisz XLSX jako EXCEL, używając PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na EXCEL przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSX na EXCEL? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na EXCEL w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLSX na EXCEL, wywołując metodę zapisu skoroszytu.
1.  Uzyskaj wynik konwersji XLSX na EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka PHP do konwersji XLSX na EXCEL" %}}
