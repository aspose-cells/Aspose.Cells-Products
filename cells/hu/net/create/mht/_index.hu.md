...
{{% blocks/products/pf/agp/content h2="Hogyan hozhat létre MHT-t a C#-es számon" %}}
...
{{% blocks/products/pf/agp/code-block title="A mintakód bemutatja, hogyan kell MHT-fájlt létrehozni a C#-ben." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT-fájl létrehozásához" %}}
