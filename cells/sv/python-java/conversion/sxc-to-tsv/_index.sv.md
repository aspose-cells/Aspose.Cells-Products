---
title: Konvertera SXC till TSV via Python

description: Exempelkod för konvertering från sxc till tsv Python. Använd API exempelkod för batch-sxc-filer till tsv-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till TSV med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till TSV via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera SXC-filer till TSV på bara några rader kod.
...
{{% cells-convert title="Gratis app och provkod för att konvertera SXC till TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="tsv" IsLandingPage="true" language="python" %}}
