---
title: C# JPG en TXT - Convertisseur JPG en TXT
description: Aspose Exceller. C# Aspose.Cells. JPG en TXT dans C#. C# Convertissez JPG en format de sauvegarde TXT. C# JPG au format TXT. Enregistrez JPG au TXT C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer JPG au TXT dans C#" %}}
...
{{% cells-convert title="Exemple de code pour convertir JPG en TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en TXT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en TXT par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en TXT en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en TXT" %}}
