...
실행 중인 애플리케이션 내에서 거품형 차트를 동적으로 생성하는 것은 쉽습니다. MS Office 없이도 스프레드시트에 다양한 차트를 생성하기 위해 [Python에 대한 Aspose.Cells](https://pypi.org/project/aspose.cells)  API은(는) Python 플랫폼에서 스프레드시트 생성, 조작 및 변환을 위한 다양한 기능을 제공합니다. Aspose.Cells는 많은 유연한 차트 개체를 제공합니다.
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Python을(를) 통해 거품형 차트를 만드는 방법" %}}

{{% blocks/products/pf/agp/text %}}

개발자는 단 몇 줄의 코드로 데이터 처리를 위해 다양한 보고 응용 프로그램을 실행하여 거품형 차트를 쉽게 만들 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. 코드 파일에서 asposecell을 가져옵니다.1. 통합 문서 클래스 인스턴스를 만듭니다.1. 워크시트에 일부 데이터를 추가합니다.1. 워크시트에 거품형 차트 추가1. 해당 인덱스를 전달하여 Chart 컬렉션에서 새 차트 개체에 액세스합니다.1. Chart.setChartDataRange 메소드를 사용하여 차트의 데이터 소스를 설정하십시오.1. Excel 또는 ODS 파일로 저장합니다.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="다음 소스 코드는 Python을(를) 사용하여 MS Excel XLSX 파일로 거품형 차트를 만드는 방법을 보여줍니다." offSpacer="" %}}
