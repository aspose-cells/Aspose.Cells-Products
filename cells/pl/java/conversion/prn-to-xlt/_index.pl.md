---
title: Java PRN na XLT - Konwerter online PRN na XLT
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwertuj PRN na format zapisu XLT. Java PRN do formatu XLT. Zapisz PRN pod numerem XLT Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN pod numerem XLT w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować PRN na XLT w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować PRN na XLT. Prześlij swój plik PRN, a następnie po prostu zapisz go jako plik XLT. Zarówno do odczytu PRN, jak i zapisu XLT można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie XLT będą identyczne z oryginalnym dokumentem PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji PRN na XLT online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlt" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować PRN na XLT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki PRN na XLT? Programiści Java mogą łatwo przekonwertować PRN na XLT w zaledwie kilku wierszach kodu.
...
1.  Konwertuj PRN na XLT, wywołując metodę Workbook.save.
