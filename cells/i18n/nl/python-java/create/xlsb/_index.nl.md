---
title: Maak MS Excel XLSB-bestanden via Python 
url: /nl/python-java/create-xlsb/ 
description: Python Voorbeeldcode voor het genereren van XLSB-documenten. Gebruik deze code voor het maken van MS Excel XLSB-bestanden binnen de Python-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB-documenten maken via Python" h2="Systeemeigen en krachtige MS Excel XLSB-spreadsheets maken programmatisch met behulp van Python API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Het dynamisch genereren van een MS Excel XLSB-bestand binnen een actieve toepassing is eenvoudig. Om XLSB-documenten helemaal opnieuw te maken zonder dat MS Office nodig is, gebruiken we:
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB maken via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Het is gemakkelijk voor de ontwikkelaars om MS Excel XLSB-spreadsheets te creëren, laden, wijzigen en converteren binnen het draaien van verschillende rapportagetoepassingen voor gegevensverwerking in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Importeer asposecellen in uw codebestand.1. Werkmapklasse-instantie maken.1. Open het eerste werkblad van de werkmap.1. Haal de gewenste cel(len) van het werkblad op en voer de waarde in de cel(len) in.1. Gebruik de methode Opslaan om de werkmap op te slaan als XLSB-bestand.
...
{{% blocks/products/pf/agp/code-block title="De volgende broncode laat zien hoe u een MS Excel XLSB-bestand maakt met Python." offSpacer="" %}}
...
// Sla de werkmap op als XLSB-bestand.
...
<!-- aboutfile Starts -->
 ...
 Een Excel Spreadsheet Programming Library die in staat is om platformonafhankelijke applicaties te bouwen met de mogelijkheid om MS Excel XLSB-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python API converteert niet alleen tussen spreadsheetindelingen, maar kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardindelingen.
