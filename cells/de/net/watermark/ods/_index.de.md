...
{{% blocks/products/pf/agp/content h2="So versehen Sie die Datei ODS mit einem Wasserzeichen mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen eines Wasserzeichens zu ODS über C#" %}}
...
+ Arbeitsmappe im Format ODS speichern
...
{{% blocks/products/pf/agp/code-block title="Wasserzeichen zu ODS - C# hinzufügen" offSpacer="" %}}
