...
url: /ja/python-java/merger/merge-xltm-to-xml/ 
...
次の例は、XLTM を Aspose.Cells for Python via Java の XML にマージする方法を示しています。
...
XLTMをプログラム的にXMLにマージする必要がありますか？基本的な文書のマージと連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
