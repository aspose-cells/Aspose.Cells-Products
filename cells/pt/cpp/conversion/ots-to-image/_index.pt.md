...
description: Aspose Excel. Converta OTS em IMAGE de forma rápida e fácil com Aspose.Cells. C++ OTS em IMAGE. C++ Salvar OTS em IMAGEM. Salve OTS como IMAGEM usando C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter OTS para IMAGE em C++" h2="Conversão de OTS para IMAGE de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converter OTS em IMAGE usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve OTS em IMAGE em C++" %}}

O exemplo a seguir demonstra como converter OTS em IMAGE em C++.
...
{{% cells-convert title="Código de exemplo para converter OTS em IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="png" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter OTS em IMAGE via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos OTS em IMAGE programaticamente? Os desenvolvedores do C++ podem converter facilmente OTS em IMAGE em apenas algumas linhas de código.
...
1.  Converta OTS em IMAGE chamando o método Save().
1. Obtenha o resultado da conversão de OTS em IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter OTS em IMAGE" %}}
