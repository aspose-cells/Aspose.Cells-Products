---
title:  Raggruppa e separa le forme in Excel via .NET
weight: 340
description: C# codice sorgente per raggruppare e separare le forme in Excel su .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Raggruppa e separa le forme in Excel via .NET" h2="Utilizzo di Aspose.Cells\' API per lavorare con vari oggetti senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/code-block title="Raggruppa e separa le forme - C#" offSpacer="" %}}
