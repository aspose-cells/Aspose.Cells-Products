...
description: Aspose เอ็กเซล. แปลง XLTM เป็น OTS อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Java XLTM เป็น OTS Java บันทึก XLTM ไปที่ โอทีเอส. บันทึก XLTM เป็น OTS โดยใช้ Java
...
{{% blocks/products/pf/agp/content h2="บันทึก XLTM ไปที่ OTS ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLTM เป็น OTS ใน Java
