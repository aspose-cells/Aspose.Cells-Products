---
title: Converteer TXT naar MD via C++ applicatie 
url: /nl/cpp/conversion/txt-to-md/ 
description: Voorbeeld C++-conversiecode voor TXT-document naar MD-indeling. Programmeurs kunnen deze broncode gebruiken voor batchconversie van TXT naar MD binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer TXT naar MD via C++" h2="Hoogwaardige conversie van TXT naar MD met behulp van de C++-bibliotheek zonder installatie van Microsoft Excel, OpenOffice of Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe TXT naar MD te converteren met C++" %}}

 Om TXT naar MD te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TXT naar MD te converteren via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ ontwikkelaars kunnen TXT-bestanden gemakkelijk in slechts een paar regels code naar MD converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad TXT-bestand met behulp van Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (MD) bestandsextensie.1. MD-bestand wordt opgeslagen op het opgegeven pad.1. Open het MD-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="TXT naar MD C++ Conversiebroncode" offSpacer="" %}}
