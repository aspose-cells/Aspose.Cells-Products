...
description: Aspose Excel. A PNG-es számot SVG-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# PNG-SVG-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a PNG-SVG számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a PNG-et SVG-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a PNG SVG-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A PNG konvertálása SVG-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A PNG fájlt programozottan SVG-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a PNG-et SVG-re.
...
1.  Konvertálja a PNG-et SVG-re a Workbook.Save metódus meghívásával.
1.  Szerezze meg a PNG-es konverziós eredményt SVG-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a PNG konvertálásához SVG-re" %}}
