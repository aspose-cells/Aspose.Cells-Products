...
{{% blocks/products/pf/agp/content h2="C# Kullanarak HTML Dosyasını Birleştirme" %}}
 ...
 HTML dosyasını birleştirmek için kullanacağız
...
+ Artık HTML dosyasını Microsoft Office, Adobe PDF veya diğer uyumlu programlarda açıp kullanabilirsiniz.
