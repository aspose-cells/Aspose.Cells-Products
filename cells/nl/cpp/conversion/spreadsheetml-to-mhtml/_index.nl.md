...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen het SPREADSHEETML-bestand gemakkelijk converteren naar MHTML in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het SPREADSHEETML-bestand met Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (MHTML) bestandsextensie.1. MHTML-bestand wordt opgeslagen op het opgegeven pad.1. Open het MHTML-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML naar MHTML C++ Broncode voor conversie" offSpacer="" %}}
