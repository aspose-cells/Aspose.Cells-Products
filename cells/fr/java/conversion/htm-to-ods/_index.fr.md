---
title: Java HTM à ODS - Convertisseur HTM à ODS
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format HTM au format ODS, permettant un enregistrement transparent des données HTM au format ODS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM à ODS dans Java" %}}

L'exemple suivant montre comment convertir HTM en ODS en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir HTM en ODS. Téléchargez votre fichier HTM, puis enregistrez-le simplement sous le nom de fichier ODS. Pour la lecture HTM et l'écriture ODS, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie ODS seront identiques au document HTM original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir du HTM en ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir du HTM en ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM au format ODS par programmation ? Les développeurs spécialisés en Java peuvent facilement convertir des fichiers HTM au format ODS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir HTM en ODS" %}}
{{% blocks/products/pf/agp/text %}}
