...
1. Charger le fichier ODS à l'aide de la classe IWorkbook1. Utiliser la méthode Protect(..) avec ProtectionType et Password1. Enregistrez le fichier ODS protégé par la méthode Save ()
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour protéger les SAO" sectionDescription="Consultez nos démos en direct pour [chiffrer les fichiers ODS](https://products.aspose.app/cells/protect/ods) avec les avantages suivants." >}}
