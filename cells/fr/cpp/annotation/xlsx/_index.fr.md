---
title:  Ajouter ou supprimer une annotation XLSX via C++
weight: 5260
description: Exemple de code C++ pour ajouter ou supprimer des annotations au format XLSX sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter des commentaires au XLSX via C++" %}}
