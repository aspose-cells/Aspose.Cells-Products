---
title: تحويل C++ MHT إلى ODS - تحويل MHT إلى ODS
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل MHT إلى تنسيق ODS، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق ODS باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى ODS في C++" %}}

يوضح المثال التالي كيفية تحويل MHT إلى ODS في C++.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى ODS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى ODS برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى ODS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى ODS عن طريق استدعاء دالة Save().
1. احصل على نتيجة تحويل MHT إلى ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل MHT إلى ODS" %}}
