...
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do formátu uložení POWERPOINT. C++ Spojte XLTX do formátu POWERPOINT. Sloučit XLTX do POWERPOINT v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX do POWERPOINT v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX do POWERPOINT v C++" InputFormat="xltx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
