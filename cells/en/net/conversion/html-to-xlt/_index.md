...
The following example demonstrates how to convert HTML to XLT document format in C#.
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert HTML files to XLT in just a few lines of code.
