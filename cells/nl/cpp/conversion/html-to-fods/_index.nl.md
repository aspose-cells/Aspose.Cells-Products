...
{{% blocks/products/pf/agp/content h2="Sla HTML op in FODS in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar FODS in C++.
...
Moet je bestanden met de extensie HTML programmatisch converteren naar FODS? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar FODS met slechts een paar regels code.
