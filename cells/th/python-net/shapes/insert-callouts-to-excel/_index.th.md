---
title: แทรกคำบรรยายภาพลงใน Excel โดยใช้ Python via .Net
weight: 360
description: Python via .Net ซอร์สโค้ดสำหรับแทรก Callouts ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกคำบรรยายภาพลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ Shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) เพื่อแทรกคำบรรยายภาพในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่คำบรรยายภาพ - Python via .Net" offSpacer="" %}}
