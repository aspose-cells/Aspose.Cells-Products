---
title: دمج HTM إلى ET - ادمج HTM إلى ET في C++
url: /ar/cpp/merger/merge-htm-to-et/ 
description: Aspose إكسل. C++ Aspose.Cells. مجاني على الإنترنت دمج HTM إلى ET saveformat. C++ ادمج تنسيق HTM إلى ET. دمج HTM إلى ET في C++. دمج HTM.
...
{{% blocks/products/pf/agp/content h2="دمج HTM في ET في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج HTM إلى ET في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج HTM في ET. قم بتحميل الملفات الخاصة بك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف ET. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج HTM إلى ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج HTM في ET في C++" InputFormat="htm" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج HTM في ET عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج HTM في ET برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج HTM إلى ET" %}}
