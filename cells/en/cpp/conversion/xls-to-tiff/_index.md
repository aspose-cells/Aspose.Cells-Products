...
description: Sample C++ conversion code for XLS to TIFF format. Programmers can use this source code for batch XLS to TIFF conversion within any C++ Application.
---
