---
title: C# MHT 轉 BMP - 在線 MHT 轉 BMP 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 MHT 轉換為 BMP 保存格式。 C# MHT 到 BMP 格式。將 MHT 保存到 BMP C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 C# 中的 MHT 轉換為 BMP" h2="用於將 MHT 轉換為 BMP 的高速 C# 庫。這是一個專業的軟件解決方案，用於在 .NET Framework、.NET Core 或 Mono 平台上導入和導出 MHT、BMP 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線將MHT保存到C#中的BMP" %}}

下面的例子演示瞭如何將C#中的MHT轉換為BMP。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 轉換為 BMP。上傳您的 MHT 文件，然後只需將其另存為 BMP 文件。對於 MHT 讀取和 BMP 寫入，您可以使用完全限定的文件名。輸出 BMP 內容和格式將與原始 MHT 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 MHT 轉換為 BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="bmp" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 轉換為 BMP" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 BMP？ .NET 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 BMP。
...
1. 通過調用 Workbook.Save 方法將 MHT 轉換為 BMP。
1. 獲取MHT到BMP的轉換結果。
