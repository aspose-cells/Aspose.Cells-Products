---
title: PHP XLT - IMAGE - XLT - IMAGE Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile XLT'i hızlı ve kolay bir şekilde IMAGE'a dönüştürün. PHP XLT'i IMAGE'a dönüştürün. PHP XLT'i IMAGE'a kaydedin. PHP kullanarak XLT'i IMAGE olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLT\'i IMAGE\'a dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLT dosyalarını program aracılığıyla IMAGE'a dönüştürmeniz mi gerekiyor? PHP geliştiricileri yalnızca birkaç satır kodla XLT'i kolayca IMAGE'a yükleyebilir ve dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLT'i IMAGE'a dönüştürün.
1.  XLT'in IMAGE'a dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLT\'i IMAGE\'a dönüştürmek için PHP kütüphanesi" %}}
