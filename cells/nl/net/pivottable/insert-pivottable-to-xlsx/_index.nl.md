...
weight: 7690
description: C# Voorbeeldcode voor het genereren van XLSX-documenten met draaitabel. Gebruik deze code voor het maken van Micorsoft Excel XLSX-bestanden met draaitabel binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="PivotTable invoegen in XLSX Documenten via C#" h2="Native en krachtige Microsoft Excel XLSX-spreadsheet met draaitabelcreatie programmatisch met behulp van server-side .NET API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Het genereren van een MS Excel XLSX-bestand met draaitabel dynamisch binnen een actieve toepassing is eenvoudig. Om XLSX documenten met PivotTable helemaal opnieuw te maken zonder dat MS Office nodig is, gebruiken we
...
Het is gemakkelijk voor de ontwikkelaars om een draaitabel in een spreadsheet met de indeling XLSX in te voegen in verschillende rapportagetoepassingen voor gegevensverwerking in slechts een paar regels code.
