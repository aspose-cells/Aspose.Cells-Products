---
title: Fusionar XLSM con MD - Combinar XLSM con MD en Java
url: /es/java/merger/merge-xlsm-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Fusionar XLSM con el formato guardado de MD. Java Combina XLSM al formato MD. Fusionar XLSM con MD en Java. XLSM Fusionar.
...
{{% blocks/products/pf/agp/content h2="Fusionar XLSM con MD en Java" %}}

El siguiente ejemplo demuestra cómo fusionar XLSM con MD en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLSM con MD. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo MD. Si desarrolla código en Java, esto será más simple de lo que parece. Vea el ejemplo de Java que fusiona XLSM con MD.
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM con MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLSM con MD mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Java para fusionar XLSM con MD" %}}
