---
title: Merge TXT to PNG - Combine TXT to PNG in C#
url: /net/merger/merge-txt-to-png/ 
description: Aspose Excel. C# Aspose.Cells. Free Online Merge TXT to PNG saveformat. C# Combine TXT to PNG format. Merge TXT to PNG in C#. TXT Merge.
...
{{% blocks/products/pf/agp/content h2="Merge TXT to PNG in C# Online for Free" %}}

The following example demonstrates how to merge TXT to PNG in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to merge TXT to PNG. Upload your files, call Workbook.Combine method for merging files, and then save it to PNG file. If you develop code in C#, this will be simpler than it sounds. See C# example that merges TXT to PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Free Online to Merge TXT to PNG in C#" InputFormat="txt" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="How to Merge TXT to PNG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to merge TXT to PNG programmatically? A basic document merging and concatenating with [Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs can be done with just few lines of code.
...
{{% blocks/products/pf/agp/content h2=".NET library to merge TXT to PNG" %}}
