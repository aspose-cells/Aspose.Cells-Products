...
{{% blocks/products/pf/agp/content h2="Sla HTML op als PRN in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar PRN in C++.
...
Moet u HTML-bestanden programmatisch naar PRN converteren? Ontwikkelaars van C++ kunnen HTML-bestanden eenvoudig in een paar regels code naar PRN converteren.
