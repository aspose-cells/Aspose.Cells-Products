---
title: Cara menggambar atau menyisipkan bentuk melengkung ke dalam excel menggunakan Python via Java
weight: 10
description: Menggambar atau menyisipkan bentuk melengkung menggunakan Aspose.Cells' Python via Java API tanpa software apapun seperti Microsoft atau Open Office, Adobe PDF, dll.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan bentuk melengkung ke dalam Excel menggunakan Python via Java" h2="Sisipkan bentuk melengkung menggunakan Aspose.Cells\' API tanpa software seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan Bentuk Melengkung Ke File Excel Menggunakan Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah menyisipkan bentuk melengkung ke file Excel menggunakan Python via Java" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan koleksi bentuk[menambahkan metode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) untuk menyisipkan bentuk melengkung di lembar kerja yang dipilih.
...
{{% blocks/products/pf/agp/code-block title="Sisipkan bentuk melengkung - Python via Java" offSpacer="" %}}
