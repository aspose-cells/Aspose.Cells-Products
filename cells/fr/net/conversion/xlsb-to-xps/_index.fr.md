---
title: C# XLSB à XPS - Convertisseur en ligne XLSB à XPS
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir XLSB en format de sauvegarde XPS. Format C# XLSB à XPS. Enregistrez XLSB à XPS C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à XPS dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en XPS en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLSB en XPS. Téléchargez votre fichier XLSB, puis enregistrez-le simplement en tant que fichier XPS. Pour la lecture XLSB et l'écriture XPS, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie XPS seront identiques au document XLSB d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en XPS en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xps" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en XPS par programmation ? Les développeurs .NET peuvent facilement charger et convertir XLSB en XPS en quelques lignes de code.
