---
title: Utwórz MHTML - Utwórz plik MHTML w Java
description: Aspose Excel. Bezproblemowo generuj i manipuluj plikami MHTML dzięki bibliotece Aspose.Cells for Java. Ta wydajna biblioteka API zapewnia usprawnione i wydajne rozwiązanie do tworzenia, edytowania i zarządzania plikami MHTML bezpośrednio w aplikacjach Java, spełniając specyficzne potrzeby programistów z wysoką precyzją.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć MHTML w Java" %}}
...
1.  Zapisz skoroszyt w formacie MHTML, używając metody save().

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik MHTML w Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do utworzenia pliku MHTML" %}}
{{% blocks/products/pf/agp/text %}}
