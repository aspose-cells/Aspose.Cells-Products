---
title: C++ EXCEL σε TXT - EXCEL σε TXT Μετατροπέας
description: Aspose Excel. Αυτή η ολοκληρωμένη λύση παρέχει στους προγραμματιστές C++ μια πλήρως ενσωματωμένη προσέγγιση για τη μετατροπή του EXCEL σε μορφή TXT, επιτρέποντας την απρόσκοπτη αποθήκευση δεδομένων EXCEL σε μορφή TXT χρησιμοποιώντας τη βιβλιοθήκη Aspose.Cells, μέσω αποτελεσματικού και προσαρμόσιμου κώδικα C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή EXCEL σε TXT σε C++" h2="Μετατροπή υψηλής απόδοσης από EXCEL σε TXT χρησιμοποιώντας τη βιβλιοθήκη C++ χωρίς την ανάγκη εγκατάστασης του Microsoft Excel, OpenOffice ή Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση EXCEL στο TXT στο C++" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το EXCEL σε TXT σε C++.
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το EXCEL σε TXT μέσω C++" %}}

{{% blocks/products/pf/agp/text %}}

Χρειάζεται να μετατρέψετε αρχεία EXCEL σε TXT μέσω προγραμματισμού; Οι προγραμματιστές C++ μπορούν εύκολα να μετατρέψουν αρχεία EXCEL σε TXT σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατρέψτε το EXCEL σε TXT καλώντας τη μέθοδο Save().
1.  Λάβετε το αποτέλεσμα μετατροπής του EXCEL σε TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Βιβλιοθήκη C++ για μετατροπή EXCEL σε TXT" %}}
