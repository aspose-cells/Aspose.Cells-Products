...
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 NUMBERS 轉換為 PDF 格式，從而能夠使用 Aspose.Cells 庫將 NUMBERS 資料無縫保存為 PDF 格式，所有這些程式碼都透過高效且可客製化且可自訂 1538153 1538153 153。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Python Excel 庫中將 NUMBERS 轉換為 PDF" h2="高速Python excel庫，用於將數字轉換為PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將數字轉換為 PDF" %}}
...
{{% blocks/products/pf/agp/content h2="將數字儲存到 Python Excel 庫中的 PDF" %}}

以下範例示範如何將 Python excel 庫中的 NUMBERS 轉換為 PDF。
...
{{% cells-convert title="透過 Python Excel 庫將數字轉換為 PDF 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="pdf" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將數字轉換為 PDF" %}}
