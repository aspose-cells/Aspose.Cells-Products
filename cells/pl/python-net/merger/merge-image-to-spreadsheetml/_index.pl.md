...
url: /pl/python-net/merger/merge-image-to-spreadsheetml/ 
...
Poniższy przykład ilustruje, jak scalić OBRAZ z SPREADSHEETML w Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić OBRAZ z SPREADSHEETML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
