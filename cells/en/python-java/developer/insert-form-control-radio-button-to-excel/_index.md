---
title: Insert RadioButton(Form control) into Excel using Python via java 
weight: 60
...
{{% blocks/products/pf/agp/content h2="How to Insert RadioButton(Form control) into Excel File Using Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert RadioButton(Form control) to Excel file using Python via java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) to insert a RadioButton(Form control) in the selected worksheet.
