---
title: Java XLS sang MHT - XLS sang MHT Chuyển đổi
description: Aspose Excel. Chuyển đổi XLS sang MHT nhanh chóng và dễ dàng với Aspose.Cells. Java XLS sang MHT. Java Lưu XLS vào MHT. Lưu XLS là MHT sử dụng Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS sang MHT trong Java" h2="Thư viện Java tốc độ cao để chuyển đổi XLS sang MHT. Đây là giải pháp phần mềm chuyên nghiệp nhập xuất XLS, MHT và nhiều định dạng khác sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS vào MHT vào Java" %}}

Ví dụ sau minh họa cách chuyển đổi XLS sang MHT trong Java.
...
Cần chuyển đổi file XLS sang MHT theo chương trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi XLS sang MHT chỉ bằng vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java chuyển đổi XLS sang MHT" %}}
{{% blocks/products/pf/agp/text %}}
