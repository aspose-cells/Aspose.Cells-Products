---
title: C# ODS a ODS - ODS a ODS Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato ODS, permitindo o salvamento perfeito de dados ODS no formato ODS usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a ODS em C#" %}}

exemplo a seguir demonstra como converter ODS em ODS em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS em ODS. Carregue seu arquivo ODS e simplesmente salve-o como arquivo ODS. Para leitura de ODS e gravação de ODS, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída ODS serão idênticos ao documento ODS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter ODS em ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS em ODS por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em ODS programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em ODS em apenas algumas linhas de código.
...
1.  Converta ODS para ODS chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em ODS" %}}
