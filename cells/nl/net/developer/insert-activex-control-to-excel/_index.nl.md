---
title:  Voeg ActiveX-besturingselement in Excel via .NET in
weight: 10
description: C# broncode om ActiveX-besturingselement in Excel in te voegen op .NET Framework, .NET Core, Mono of Xamarin-platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg ActiveX-besturingselement in Excel via .NET in" h2="Voeg ActiveX-besturingselementen in met behulp van Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Hoe ActiveX-besturingselement in een Excel-bestand in te voegen met behulp van C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ActiveX-besturingselement in Excel-bestand in te voegen via C#" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de[methode toevoegen](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addActiveXControl) om een ActiveX-besturingselement in het geselecteerde werkblad in te voegen
...
{{% blocks/products/pf/agp/code-block title="ActiveX-besturingselement invoegen - C#" offSpacer="" %}}
