...
{{% blocks/products/pf/agp/content h2="Como converter SXC para XLTX usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC para XLTX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para XLTX em apenas algumas linhas de código.
