...
{{% blocks/products/pf/agp/content h2="Sla HTML op in SVG in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar SVG in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar SVG of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar SVG? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar SVG met slechts een paar regels code.
