...
{{% blocks/products/pf/agp/content h2="Преобразование XML в TXT с использованием C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в TXT в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат TXT в формате C#.
...
1.  Преобразовать XML в формат TXT, вызвав метод Workbook.Save.
