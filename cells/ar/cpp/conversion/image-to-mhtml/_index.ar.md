...
هل تحتاج إلى تحويل ملفات IMAGE إلى MHTML برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى MHTML في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى MHTML باستدعاء طريقة Save ().
