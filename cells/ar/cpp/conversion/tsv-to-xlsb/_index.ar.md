---
title: تحويل TSV إلى XLSB عبر تطبيق C++ 
weight: 1370
url: /ar/cpp/conversion/tsv-to-xlsb/ 
description: نموذج C++ كود التحويل لمستند TSV إلى تنسيق XLSB. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل TSV إلى XLSB الدفعي داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TSV إلى XLSB عبر C++" h2="تحويل TSV إلى XLSB عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TSV إلى XLSB باستخدام C++" %}}
 ...
 من أجل تحويل TSV إلى XLSB ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف TSV إلى XLSB في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف TSV باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLSB).1. سيتم حفظ ملف XLSB في المسار المحدد.1. افتح ملف XLSB في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="TSV إلى XLSB C++ شفرة مصدر التحويل" offSpacer="" %}}
