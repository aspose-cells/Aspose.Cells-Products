...
url: /sv/net/merger/merge-sxc-to-xps/ 
...
Följande exempel visar hur man slår samman SXC till XPS i Aspose.Cells for .NET.
...
{{% cells-merger title="Exempelkod för att slå samman SXC till XPS i C#" InputFormat="sxc" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman SXC till XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman SXC till XPS programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman SXC till XPS" %}}
