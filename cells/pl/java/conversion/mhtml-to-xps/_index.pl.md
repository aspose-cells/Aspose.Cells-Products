---
title: Konwertuj MHTML na XPS przez Java 
weight: 6220

description: Przykładowy kod konwersji Java dla formatu MHTML do pliku XPS. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do XPS w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MHTML na XPS przez Java" h2="Konwersja MHTML do XPS Java w celu konwersji jednej lub wielu stron do XPS przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na XPS za pomocą Java" %}}

 Aby wyrenderować MHTML do XPS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MHTML na XPS za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik MHTML na XPS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik MHTML z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XPS i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XPS
...
{{% blocks/products/pf/agp/code-block title="MHTML do XPS Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik MHTML w instancji Workbook
Workbook book = new Workbook("template.mhtml");
// zapisz MHTML jako XPS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z MHTML do XPS" sectionDescription="[Konwertuj MHTML na XPS](https://products.aspose.app/cells/conversion/mhtml-to-xps) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik MHTML, zostanie on natychmiast przekonwertowany do XPS." >}}
