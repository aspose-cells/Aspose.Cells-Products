...
{{% cells-convert title="Exemplo de código para converter OTS em TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="tiff" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter OTS para TIFF via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos OTS para TIFF programaticamente? Os desenvolvedores C++ podem facilmente converter OTS em TIFF em apenas algumas linhas de código.
...
1.  Converta OTS em TIFF chamando o método Save().
