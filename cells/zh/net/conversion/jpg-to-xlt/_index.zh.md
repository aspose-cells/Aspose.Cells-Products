---
title: C# JPG 到 XLT - JPG 到 XLT 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 JPG 转换为 XLT。 C# JPG 到 XLT。 C# 将 JPG 保存到 XLT。 使用 C# 将 JPG 保存为 XLT。
...
{{% blocks/products/pf/agp/content h2="将JPG保存到C#中的XLT" %}}
...
{{% cells-convert title="将 JPG 转换为 XLT 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xlt" IsLandingPage="true" %}}
