...
weight: 7010
description: C# broncode om XLS-bestand te vergrendelen met een wachtwoord op .NET Framework, .NET Core, Mono of Xamarin Platforms.
...
1.  Instantieer de werkmapklasse met het pad naar het bestand XLS
