---
title: Konverter PHP MHTML hingga PDF - MHTML hingga PDF
description: Aspose Unggul. Ubah MHTML menjadi PDF dengan cepat dan mudah dengan Aspose.Cells. PHP MHTML menjadi PDF. PHP Simpan MHTML menjadi PDF. Simpan MHTML sebagai PDF menggunakan PHP.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah MHTML menjadi PDF melalui PHP" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file MHTML ke PDF secara terprogram? Pengembang PHP dapat dengan mudah memuat & mengonversi MHTML menjadi PDF hanya dalam beberapa baris kode.
...
1.  Ubah MHTML menjadi PDF dengan memanggil metode simpan Buku Kerja.
1.  Dapatkan hasil konversi dari MHTML menjadi PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Pustaka PHP untuk mengonversi MHTML menjadi PDF" %}}
