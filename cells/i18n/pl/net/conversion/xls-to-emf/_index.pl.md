---
title: Konwertuj XLS na EMF przez C#
url: /pl/net/conversion/xls-to-emf/
description: Przykładowy kod konwersji xls na emf C#. Użyj przykładowego kodu API dla plików wsadowych xls do konwersji emf w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki XLS do formatu EMF w zaledwie kilku linijkach kodu.
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLS na EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="emf" IsLandingPage="true" %}}
