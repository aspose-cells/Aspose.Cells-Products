---
title: Python EXCEL から OTS - EXCEL から OTS コンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、EXCEL を OTS にすばやく簡単に変換します。 Python EXCEL から OTS。 Python EXCEL を OTS に保存します。 Python を使用して EXCEL を OTS として保存します。
...
{{% blocks/products/pf/agp/content h2="Python で Excel を OTS に保存" %}}
...
{{% cells-convert title="EXCELをOTSに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ots" IsLandingPage="true" language="pythonnet" %}}
