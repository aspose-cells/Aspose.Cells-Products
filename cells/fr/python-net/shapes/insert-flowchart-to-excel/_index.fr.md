...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer/créer un fichier FlowChart vers Excel à l’aide de Python via .Net" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) pour insérer un FlowChart dans la feuille de calcul sélectionnée.
