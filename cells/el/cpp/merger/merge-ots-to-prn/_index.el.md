...
description: Aspose Excel. C++ Aspose.Cells. Συγχώνευση OTS σε μορφή αποθήκευσης PRN. C++ Συνδυάστε τη μορφή OTS σε μορφή PRN. Συγχώνευση OTS σε PRN στο C++. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση OTS με PRN στο C++" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση OTS με PRN στο C++" InputFormat="ots" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
