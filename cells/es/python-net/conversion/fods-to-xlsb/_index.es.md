...
description: Aspose Excel. Convierta FODS a XLSB rápida y fácilmente con Aspose.Cells. Python FODS a XLSB. Python Guarde FODS en XLSB. Guarde FODS como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar FODS al XLSB en Python" %}}

El siguiente ejemplo demuestra cómo convertir FODS a XLSB en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir FODS a XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xlsb" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir FODS en XLSB" %}}
