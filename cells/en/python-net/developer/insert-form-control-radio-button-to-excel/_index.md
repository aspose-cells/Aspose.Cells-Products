---
title: Insert RadioButton(Form control) into Excel using Python via .Net 
weight: 60
...
{{% blocks/products/pf/agp/content h2="How to Insert RadioButton(Form control) into Excel File Using Python via .Net" %}}

 In order to insert RadioButton(Form control) into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert RadioButton(Form control) to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) to insert a RadioButton(Form control) in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert RadioButton(Form control) - Python via .Net" offSpacer="" %}}
