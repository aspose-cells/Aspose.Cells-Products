---
title: A HTML-XLT-es számok egyesítése – a HTML-es és a XLT-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-html-to-xlt/ 
description: Aspose Excel. C# Aspose.Cells. A HTML és a XLT mentési formátum egyesítése. C# A HTML és a XLT formátum kombinálása. Egyesítse a HTML-XLT-et a C#-ben. HTML Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A HTML és a XLT egyesítése a C#-ben" %}}

A következő példa bemutatja a HTML és a XLT egyesítését a Aspose.Cells for .NET számban.
...
{{% cells-merger title="Mintakód a HTML és XLT közötti egyesítéshez a C#-ben" InputFormat="html" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTML és a XLT egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTML-et a XLT-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
