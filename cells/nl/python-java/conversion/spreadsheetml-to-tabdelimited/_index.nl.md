---
title: Converteer SPREADSHEETML naar TABDELIMITED via Python

description: Voorbeeldcode voor conversie van spreadsheetml naar door tabs gescheiden Python. Gebruik API voorbeeldcode voor batch-spreadsheetml-bestanden naar door tabs gescheiden conversies binnen de Python-toepassing.
---
...
{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML naar TABDELIMITED te converteren met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om SPREADSHEETML naar TABDELIMITED te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen eenvoudig SPREADSHEETML-bestanden laden en converteren naar TABDELIMITED in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad SPREADSHEETML-bestand met een exemplaar van Workbook1. Roep de methode Workbook.Save aan1. Geef uitvoerpad door met TSV-extensie als parameter1. Controleer het opgegeven pad voor het resulterende TABDELIMITED-bestand
