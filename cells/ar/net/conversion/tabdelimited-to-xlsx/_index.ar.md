---
title: C# TABDELIMITED to XLSX - Online TABDELIMITED to XLSX Converter
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل TABDELIMITED إلى XLSX saveformat. C# TABDELIMITED إلى تنسيق XLSX. احفظ TABDELIMITED إلى XLSX C#.
...
{{% blocks/products/pf/agp/content h2="احفظ TABDELIMITED إلى XLSX في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل TABDELIMITED إلى XLSX في C#.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل TABDELIMITED إلى XLSX. قم بتحميل ملف TABDELIMITED ثم احفظه كملف XLSX. لكل من قراءة TABDELIMITED وكتابة XLSX ، يمكنك استخدام أسماء ملفات مؤهلة تمامًا. سيكون المحتوى والتنسيق الناتج XLSX مطابقًا لمستند TABDELIMITED الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل TABDELIMITED إلى XLSX عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى XLSX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات TABDELIMITED إلى XLSX برمجيًا؟ يمكن للمطورين .NET تحميل وتحويل TABDELIMITED بسهولة إلى XLSX في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل TABDELIMITED إلى XLSX عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل TABDELIMITED إلى XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# مكتبة لتحويل TABDELIMITED إلى XLSX" %}}
