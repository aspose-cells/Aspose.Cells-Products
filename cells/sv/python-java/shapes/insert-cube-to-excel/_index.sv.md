...
{{% blocks/products/pf/agp/content h2="Hur man infogar kub i Excel-fil med Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga kub till Excel-fil med Python via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) för att infoga en kub i det valda arbetsbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga kub - Python via Java" offSpacer="" %}}
