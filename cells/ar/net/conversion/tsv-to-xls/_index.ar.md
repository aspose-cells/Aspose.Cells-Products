...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل TSV إلى XLS في C#" h2="مكتبة C# عالية السرعة لتحويل TSV إلى XLS. هذا حل برمجي احترافي لاستيراد وتصدير TSV و XLS والعديد من التنسيقات الأخرى على .NET Framework أو .NET Core أو Mono الأنظمة الأساسية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
تحتاج إلى تحويل TSV ملفات إلى XLS برمجيا؟ يمكن للمطورين .NET تحميل وتحويل TSV إلى XLS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول TSV إلى XLS عن طريق استدعاء Workbook.Save method.
