---
title:  Illessze be a címkét (űrlapvezérlő) az Excelbe a Python számon keresztül
weight: 80
description: Python forráskód a Label (Űrlapvezérlő) beillesztéséhez az Excelbe.
---
...
{{% blocks/products/pf/agp/content h2="Címke (űrlapvezérlő) beszúrása Excel-fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A címke (űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python-es számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addLabel(int,%20int,%20int,%20int,%20int,%20int)), hogy beszúrjon egy címkét (Űrlapvezérlőt) a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Címke beszúrása (űrlapvezérlő) - Python" offSpacer="" %}}
