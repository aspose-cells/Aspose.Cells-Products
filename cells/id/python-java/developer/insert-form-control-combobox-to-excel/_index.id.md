---
title:  Masukkan ComboBox (Kontrol formulir) ke Excel melalui Python
weight: 20
description: Python kode sumber untuk memasukkan ComboBox(Form control) ke dalam Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan ComboBox (Kontrol formulir) ke Excel melalui Python" h2="Sisipkan objek menggunakan API sisi server tanpa perangkat lunak apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan ComboBox(Form control) ke dalam File Excel Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan ComboBox(Form control) ke file Excel melalui Python" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan koleksi bentuk[menambahkan metode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)) untuk menyisipkan ComboBox(Form control) di lembar kerja yang dipilih.
...
{{% blocks/products/pf/agp/code-block title="Sisipkan Kotak Kombo(Kontrol formulir) - Python" offSpacer="" %}}
