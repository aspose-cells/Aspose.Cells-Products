...
description: Aspose Excel. Převeďte PNG na ETT rychle a snadno pomocí Aspose.Cells. PHP PNG na ETT. PHP Uložit PNG do ETT. Uložte PNG jako ETT pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na ETT přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést PNG soubory na ETT programově? Vývojáři PHP mohou snadno načíst a převést PNG na ETT v několika řádcích kódu.
...
1.  Převeďte PNG na ETT voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na ETT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na ETT" %}}
