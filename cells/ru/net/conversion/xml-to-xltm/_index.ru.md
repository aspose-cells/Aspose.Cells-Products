---
title: C# XML в XLTM - Конвертер XML в XLTM
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в XLTM в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат XLTM в формате C#.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XML в XLTM через C#" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно преобразовать XML-файлы в XLTM? Разработчики .NET могут легко загружать и конвертировать XML в XLTM всего за несколько строк кода.
...
1.  Преобразовать XML в формат XLTM, вызвав метод Workbook.Save.
1.  Получите результат преобразования XML в XLTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XML в XLTM" %}}
