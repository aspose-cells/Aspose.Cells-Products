---
title: Conversor PHP SXC para FODS - SXC para FODS
description: Aspose Excel. Converta SXC em FODS de forma rápida e fácil com Aspose.Cells. PHP SXC em FODS. PHP Salve SXC em FODS. Salve SXC como FODS usando PHP.
...
{{% cells-convert title="Exemplo de código para converter SXC em FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="fods" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter SXC em FODS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em FODS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em FODS em apenas algumas linhas de código.
...
1.  Converta SXC em FODS chamando o método save da pasta de trabalho.
