...
Hai bisogno di convertire i file OTS in XML a livello di codice? C++ gli sviluppatori possono facilmente convertire OTS in XML in poche righe di codice.
...
1.  Converti OTS in XML chiamando il metodo Save().
