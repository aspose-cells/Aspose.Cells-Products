...
{{< blocks/products/pf/i18n/upper-banner h1="合并EXCEL为TXT via Java" h2="高速Java库，用于合并EXCEL到TXT。使用我们的excel转换API在Java开发高级、平台独立的软件。这是导入和导出Excel、CSV、OpenOffice、PDF、HTML、图像、和许多其他 excel 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="EXCEL" additionalConversionTag="TXT" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
如何将EXCEL合并到TXT？使用 Aspose.Cells for Java 库，您可以通过几行代码以编程方式轻松地将 EXCEL 合并到 TXT。[Aspose.Cells for Java](https://products.aspose.com/cells/java)能够构建跨平台应用程序，能够生成、修改、转换、呈现和打印所有 Excel 文件。 Java Excel API 不仅可以在电子表格格式之间相互转换，还可以将Excel文件渲染为图片，PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等，是行业文档交换的完美选择-标准格式。您可以直接从以下位置下载其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)并通过将以下配置添加到 pom.xml 将其安装在基于 Maven 的项目中。
...
{{% blocks/products/pf/agp/content h2="Java在线免费合并EXCEL到TXT" %}}

下面的例子演示如何将EXCEL合并到Java中的TXT。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将EXCEL合并到TXT。上传你的文件，调用Workbook.Combine方法合并文件，然后保存到TXT文件。如果您在 Java 中开发代码，这将比听起来更简单。参见将 EXCEL 合并到 TXT 的 Java 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费应用程序在线将 EXCEL 合并到 TXT" InputFormat="xlsx" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
