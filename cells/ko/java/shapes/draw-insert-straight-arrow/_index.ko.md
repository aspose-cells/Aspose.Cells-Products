---
title:  Excel via Java에 직선 화살표를 그리거나 삽입하는 방법
weight: 10
description: Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells' Java API을 사용하여 직선 화살표 개체를 그리거나 삽입합니다.
keywords: [Java Aspose.Cells., Java add straight arrow., Java insert straight arrow., Java create straight arrow]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Excel via Java에 직선 화살표 삽입" h2="Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells\' API을 사용하여 직선 화살표를 삽입합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 Excel 파일에 직선 화살표를 삽입하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Excel 파일 via Java에 직선 화살표를 삽입하는 단계" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 +[메소드 추가](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) 선택한 워크시트에 직선 화살표를 삽입하려면
...
{{% blocks/products/pf/agp/code-block title="직선 화살표 삽입 - Java" offSpacer="" %}}
