...
HTML dosyalarını programatik olarak NUMBERS'a dönüştürmeniz mi gerekiyor? .NET geliştiricileri, HTML dosyalarını birkaç satır kodla kolayca yükleyip NUMBERS'a dönüştürebilirler.
...
1.  Workbook.Save yöntemini çağırarak HTML sayısını NUMARA'ya dönüştürün.
