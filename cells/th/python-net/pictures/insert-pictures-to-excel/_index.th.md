---
title:  แทรกรูปภาพใน Excel โดยใช้ Python via .Net
weight: 200
description: Python via .Net ซอร์สโค้ดสำหรับแทรกรูปภาพลงใน Excel
...
{{< blocks/products/pf/i18n/upper-banner h1="แทรกรูปภาพใน Excel โดยใช้ Python via .Net" h2="แทรกรูปภาพโดยใช้ Aspose.Cells\' API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF เป็นต้น" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกรูปภาพในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกรูปภาพลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ picturecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/)เพื่อแทรกรูปภาพในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่รูปภาพ - Python via .Net" offSpacer="" %}}
