...
Následující příklad ukazuje, jak sloučit PRN s PDF v Aspose.Cells for .NET.
...
Potřebujete sloučit PRN s PDF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
