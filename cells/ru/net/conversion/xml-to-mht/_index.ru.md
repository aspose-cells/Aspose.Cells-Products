...
{{% blocks/products/pf/agp/content h2="Сохранение XML в MHT в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в MHT в файле C#.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XML в MHT с помощью C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать XML-файлы в MHT? Разработчики, использующие библиотеку .NET, могут легко загрузить и преобразовать XML в MHT всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XML в MHT" %}}
