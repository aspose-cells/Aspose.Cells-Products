...
{{% blocks/products/pf/agp/content h2="Sla FODS op in SXC in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar SXC in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar SXC of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar SXC? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar SXC met slechts een paar regels code.
