...
IMAGE dosyalarını programlı olarak JSON'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, IMAGE'i yalnızca birkaç satır kodla kolayca yükleyebilir ve JSON'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak IMAGE'i JSON'e dönüştürün.
