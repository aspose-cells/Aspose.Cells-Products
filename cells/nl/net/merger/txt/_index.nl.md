...
+ Laad alle TXT-bestanden met het volledige pad.
...
+ Roep de methode Save() aan en geef de bestandsnaam (volledig pad) en formaat (TXT) door als parameter.
Nu kunt u het TXT-bestand openen en gebruiken in Microsoft Office, Adobe PDF of een ander compatibel programma.
