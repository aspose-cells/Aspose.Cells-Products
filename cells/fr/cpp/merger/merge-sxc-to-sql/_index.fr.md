---
title: Fusionner SXC en SQL - Combiner SXC en SQL dans C++
url: /fr/cpp/merger/merge-sxc-to-sql/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion gratuite en ligne SXC au format de sauvegarde SQL. C++ Combinez SXC au format SQL. Fusionner SXC en SQL dans C++. SXC Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner SXC en SQL dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner SXC en SQL dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner SXC en SQL. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier SQL. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne SXC en SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner SXC en SQL dans C++" InputFormat="sxc" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner SXC en SQL via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner SXC avec SQL par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner SXC en SQL" %}}
