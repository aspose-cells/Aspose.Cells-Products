---
title:  Mesclar FODS para HTML via C#
url: /pt/net/merger/merge-fods-to-html/ 
description: Mesclar FODS para HTML Online gratuitamente. Online Grátis FODS a HTML Fusão. Mesclar FODS para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar FODS a HTML em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar FODS a HTML on-line" InputFormat="fods" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
