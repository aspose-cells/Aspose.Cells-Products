...
description: Aspose Excel. Python Aspose.Cells. Unisci FODS a MARKDOWN salvaformato. Python Combina il formato da FODS a MARKDOWN. Unisci FODS a MARKDOWN in Python. FODS Unisci.
...
{{% cells-merger title="Codice di esempio per unire FODS a MARKDOWN in Python" InputFormat="fods" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Come unire FODS a MARKDOWN tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 È necessario unire FODS a MARKDOWN a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Le API possono essere eseguite con poche righe di codice.
