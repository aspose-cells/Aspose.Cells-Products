---
title:  병합 ODS 파일 via .NET
weight: 4330
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼에서 ODS 문서를 결합합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#의 ODS 형식 병합" h2="Microsoft 또는 Open Office, Adobe PDF과 같은 소프트웨어를 사용하지 않고 서버 측 Aspose.Cells for .NET API를 사용하는 기본 및 고성능 ODS 문서 병합." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 ODS 파일을 병합하는 방법" %}}
 ...
 ODS 파일을 병합하기 위해 다음을 사용합니다.[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API은 기능이 풍부하고 강력하며 사용하기 쉬운 문서 조작 및 C# 플랫폼용 병합 API입니다. 열려 있는[NuGet](https://www.nuget.org/packages/aspose.cells) 패키지 관리자, 검색**Aspose.Cells** 그리고 설치하세요. 패키지 관리자 콘솔에서 다음 명령을 사용할 수도 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#의 ODS 파일을 병합하는 단계" %}}
...
+ 전체 경로가 포함된 모든 ODS 파일을 로드합니다.
+ 하나의 문서를 기본 파일로 만들기
+ 파일을 하나씩 연결하고 병합하는 해당 메소드를 호출합니다.
+ Save() 메서드를 호출하고 파일 이름(전체 경로)과 형식(ODS)을 매개 변수로 전달합니다.
...
{{< blocks/products/pf/agp/demobox sectionTitle="온라인 ODS 합병 라이브 데모" sectionDescription=" 지금 바로 당사를 방문하여 ODS 문서를 병합하세요.[라이브 데모 웹사이트](https://products.aspose.app/cells/merger). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
