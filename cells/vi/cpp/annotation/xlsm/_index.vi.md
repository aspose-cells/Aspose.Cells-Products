---
title:  Add XLSM Chú thích qua C++
weight: 2860
description: Mã mẫu C++ để xóa các chú thích định dạng XLSM trên C++ Môi trường thời gian chạy cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Thêm chú thích trong XLSM Tệp qua C++" h2="Xây dựng ứng dụng C++ của riêng bạn để thao tác nhận xét và tác giả trong tệp tài liệu bằng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để thêm bình luận trong XLSM qua C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Thêm Bình luận trong XLSM - C++" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API có thể được sử dụng để tạo, chỉnh sửa, chuyển đổi và hiển thị Microsoft định dạng Excel sang các định dạng khác nhau. Hơn nữa, nó có thể được sử dụng để lập biểu đồ toàn diện, báo cáo có thể mở rộng và tính toán đáng tin cậy trong các ứng dụng phần mềm. Aspose.Cells là một API độc lập và nó không yêu cầu bất kỳ phần mềm nào như Microsoft hoặc OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Thêm / Xóa chú thích từ XLSM qua Ứng dụng trực tuyến" sectionDescription=" Xóa chú thích tài liệu XLSM ngay bây giờ bằng cách truy cập[Trang web Demo trực tiếp](https://products.aspose.app/cells/annotation). Bản demo trực tiếp có những lợi ích sau" >}}
