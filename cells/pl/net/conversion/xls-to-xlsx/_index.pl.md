---
title: C# XLS do XLSX - XLS do XLSX Konwerter
description: Aspose Excel. Konwertuj XLS na XLSX szybko i łatwo za pomocą Aspose.Cells. C# XLS na XLSX. C# Zapisz XLS na XLSX. Zapisz XLS jako 0761113 481 pod numerem C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do XLSX w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na XLSX w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLS na XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na XLSX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na XLSX? Programiści .NET mogą łatwo załadować i przekonwertować XLS na XLSX w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na XLSX" %}}
