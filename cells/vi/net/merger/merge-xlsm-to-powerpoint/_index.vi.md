---
title: Gộp XLSM vào POWERPOINT - Gộp XLSM vào POWERPOINT thành C#
url: /vi/net/merger/merge-xlsm-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Ghép trực tuyến miễn phí XLSM vào định dạng lưu POWERPOINT. C# Gộp XLSM sang định dạng POWERPOINT. Hợp nhất XLSM thành POWERPOINT trong C#. XLSM Hợp nhất.
...
Ví dụ sau minh họa cách hợp nhất XLSM vào POWERPOINT trong Aspose.Cells for .NET.
...
{{% cells-merger title="Trực tuyến miễn phí để hợp nhất XLSM với POWERPOINT trong C#" InputFormat="xlsm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp XLSM vào POWERPOINT qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất XLSM với POWERPOINT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
