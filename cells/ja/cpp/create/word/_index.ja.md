...
開発者は、実行中のレポート アプリケーション内で、わずか数行のコードでデータ処理用の WORD ファイルを簡単に作成、ロード、変更、変換できます。
