---
title:  PRN zu MHTML via Java zusammenführen
url: /de/java/merger/merge-prn-to-mhtml/ 
description: Führen Sie PRN kostenlos online mit MHTML zusammen. Kostenlose Online-PRN zu MHTML Fusion. PRN mit Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS und mehr zusammenführen.
---
...
{{% blocks/products/pf/agp/content h2="PRN mit MHTML unter Verwendung von Java zusammenführen" %}}
 ...
 Wie füge ich PRN zu MHTML zusammen? Mit der Bibliothek Aspose.Cells for Java können Sie PRN ganz einfach programmgesteuert und mit wenigen Codezeilen in MHTML zusammenführen.[Aspose.Cells for Java](https://products.aspose.com/cells/java)ist in der Lage, plattformübergreifende Anwendungen zu erstellen und alle Excel-Dateien zu generieren, zu ändern, zu konvertieren, zu rendern und zu drucken. Java Excel API konvertiert nicht nur zwischen Tabellenkalkulationsformaten, sondern kann auch Excel-Dateien als Bilder rendern, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT und mehr, was es zu einer perfekten Wahl für den Austausch von Dokumenten macht Industriestandard Formate. Sie können die neueste Version direkt von herunterladen[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) und installieren Sie es in Ihrem Maven-basierten Projekt, indem Sie der pom.xml die folgenden Konfigurationen hinzufügen.
...
Das folgende Beispiel zeigt, wie PRN in Java mit MHTML zusammengeführt wird.
...
{{% cells-merger title="Kostenlose App zum Online-Zusammenführen von PRN mit MHTML" InputFormat="prn" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
