---
title: Преобразование NUMBERS в GIF с помощью Java 
url: /ru/java/conversion/numbers-to-gif/ 
description: Пример кода преобразования Java для формата NUMBERS в файл GIF. Программисты могут использовать этот пример кода для экспорта электронных таблиц Excel и OpenOffice в формат GIF в любом веб- или настольном Java приложении.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование NUMBERS в GIF с помощью Java" h2="Преобразование NUMBERS в GIF Java для преобразования одной или нескольких страниц в GIF с использованием локальной библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать NUMBERS в GIF с помощью Java" %}}

 Чтобы преобразовать NUMBERS в GIF, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию NUMBERS в GIF с помощью Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Java могут легко преобразовать файл NUMBERS в GIF, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл NUMBERS с экземпляром Workbook1. Выберите по умолчанию или любой рабочий лист из коллекции1. Создайте и установите объект ImageOrPrintOptions1. Создайте SheetRender с объектами Worksheet и ImageOrPrintOptions1. Вызов метода SheetRender.toImage для сохранения результата в формате GIF
...
{{% blocks/products/pf/agp/code-block title="NUMBERS в GIF Java Исходный код преобразования" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Демонстрации конвертации NUMBERS в GIF" sectionDescription="[Конвертировать НОМЕРА в GIF](https://products.aspose.app/cells/conversion/numbers-to-gif) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Нет необходимости загружать Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать какой-либо код." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл NUMBERS, и он будет мгновенно преобразован в GIF." >}}
