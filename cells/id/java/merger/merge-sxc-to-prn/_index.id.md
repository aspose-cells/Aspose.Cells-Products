---
title: Gabung SXC ke PRN - Gabungkan SXC ke PRN di Java
url: /id/java/merger/merge-sxc-to-prn/ 
description: Aspose Unggul. Java Aspose.Cells. Gabung Online Gratis SXC ke PRN saveformat. Java Gabungkan SXC ke format PRN. Gabung SXC ke PRN di Java. SXC Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan SXC ke PRN di Java Online Gratis" %}}
...
{{% cells-merger title="Online Gratis Menggabungkan SXC menjadi PRN di Java" InputFormat="sxc" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC menjadi PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SXC ke PRN secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
