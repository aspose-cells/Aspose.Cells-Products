...
description: Aspose Excel. Chuyển đổi XLTX sang XLT nhanh chóng và dễ dàng với Aspose.Cells. Python XLTX sang XLT. Python Lưu XLTX thành XLT. Lưu XLTX thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Lưu XLTX vào XLT trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLTX thành XLT trong Python.
...
{{% cells-convert title="Mã mẫu chuyển đổi XLTX thành XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xlt" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLTX thành XLT" %}}
