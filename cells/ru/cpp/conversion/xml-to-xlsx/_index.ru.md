...
{{% blocks/products/pf/agp/content h2="Преобразование XML в XLSX с использованием C++" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в XLSX в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат XLSX в формате C++.
...
Нужно программно преобразовать XML-файлы в формат XLSX? Разработчики, использующие формат C++, могут легко преобразовать XML в формат XLSX всего несколькими строками кода.
...
1.  Преобразовать XML в формат XLSX, вызвав метод Save().
