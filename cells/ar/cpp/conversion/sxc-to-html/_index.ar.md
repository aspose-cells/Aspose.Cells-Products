...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل SXC إلى HTML في C++" h2="تحويل عالي الأداء من SXC إلى HTML باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
تحتاج إلى تحويل SXC ملفات إلى HTML برمجيا؟ يمكن للمطورين C++ تحويل SXC إلى HTML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول SXC إلى HTML باستدعاء طريقة Save ().
