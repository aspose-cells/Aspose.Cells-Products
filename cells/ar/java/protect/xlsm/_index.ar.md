...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لحماية ملفات XLSM via Java" %}}
...
1.  قم بتحميل ملف XLSM عن طريق إنشاء فئة المصنف
1.  استخدم طريقة الحماية (..) مع نوع الحماية وكلمة المرور
1.  احفظ الملف XLSM المحمي بطريقة الحفظ ()
