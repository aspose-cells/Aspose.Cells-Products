...
description: Aspose 엑셀. Aspose.Cells을 사용하여 쉽고 빠르게 EXCEL을 XLTM로 변환합니다. C# EXCEL을 XLTM로 변환합니다. C# EXCEL을 XLTM로 저장합니다. C#을 사용하여 EXCEL을 XLTM로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="C#에 EXCEL을 XLTM로 저장하세요." %}}

다음 예에서는 EXCEL을 C#에서 XLTM로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="EXCEL을 XLTM로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xltm" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="C# EXCEL을 XLTM로 변환하는 라이브러리" %}}
