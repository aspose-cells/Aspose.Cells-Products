...
description: Sample Java conversion code for SXC format to NUMBERS file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to NUMBERS within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert SXC to NUMBERS via Java" h2="SXC to NUMBERS Java conversion to convert single or multiple pages to NUMBERS using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/code-block title="SXC to NUMBERS Java Conversion Source Code" offSpacer="" %}}
