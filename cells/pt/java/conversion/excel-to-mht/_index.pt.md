---
title: Java EXCEL para MHT - Conversor Online de EXCEL para MHT
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Free Online Java Converter EXCEL para MHT saveformat. Java EXCEL para formato MHT. Salve EXCEL em MHT Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter EXCEL para MHT em Java" h2="Biblioteca Java de alta velocidade para converter EXCEL em MHT. Esta é uma solução de software profissional para importar e exportar EXCEL, MHT e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salve EXCEL em MHT em Java online gratuitamente" %}}

exemplo a seguir demonstra como converter EXCEL para MHT em Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter EXCEL em MHT. Carregue seu arquivo EXCEL e simplesmente salve-o como arquivo MHT. Para leitura em EXCEL e escrita em MHT, você pode usar nomes de arquivos totalmente qualificados. O conteúdo MHT de saída e a formatação serão idênticos ao documento EXCEL original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter EXCEL para MHT online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="mht" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter EXCEL para MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos EXCEL para MHT programaticamente? Java desenvolvedores podem facilmente converter EXCEL para MHT em apenas algumas linhas de código.
...
1.  Converta EXCEL em MHT chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de EXCEL para MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteca para converter EXCEL para MHT" %}}
{{% blocks/products/pf/agp/text %}}
