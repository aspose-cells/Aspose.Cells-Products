---
title: Java XLS do MD - XLS do konwertera MD
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLS do formatu MD, umożliwiając bezproblemowe zapisywanie danych XLS w formacie MD przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do MD w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na MD w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować plik XLS na MD. Prześlij plik XLS, a następnie zapisz go jako plik MD. Zarówno do odczytu pliku XLS, jak i zapisu MD, możesz używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie MD będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLS na MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS do formatu MD? Programiści Java mogą łatwo przekonwertować pliki XLS do formatu MD za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLS na MD wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLS na MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XLS na MD" %}}
{{% blocks/products/pf/agp/text %}}
