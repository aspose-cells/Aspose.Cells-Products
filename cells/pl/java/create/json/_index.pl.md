---
title: Utwórz JSON - Utwórz plik JSON w Java
description: Aspose Excel. Java Utwórz plik JSON. Utwórz JSON Java. Java JSON Twórca. Utwórz JSON w Java. Wygeneruj plik JSON, używając Java.
...
{{% blocks/products/pf/agp/content h2="Utwórz plik JSON, używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć JSON w Java" %}}
...
1.  Zapisz skoroszyt w formacie JSON przy użyciu metody save().

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik JSON w Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do utworzenia pliku JSON" %}}
{{% blocks/products/pf/agp/text %}}
