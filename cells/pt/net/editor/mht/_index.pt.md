---
title:  Editar arquivos MHT via .NET
description: Código-fonte C# para editar o documento MHT nas plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/content h2="Como editar arquivo MHT usando C#" %}}
...
Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos Excel Microsoft em diferentes formatos. Além disso, pode ser usado para gráficos abrangentes, relatórios escalonáveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API independente e não requer nenhum software como Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo do editor MHT online" sectionDescription=" Edite documentos MHT agora mesmo visitando nosso[Site de demonstrações ao vivo](https://products.aspose.app/cells/editor). A demonstração ao vivo tem os seguintes benefícios" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Basta enviar seus arquivos MHT e usar o editor online para edição instantaneamente." >}}
