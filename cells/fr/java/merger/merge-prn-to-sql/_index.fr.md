---
title: Fusionner PRN vers SQL - Combiner PRN vers SQL dans Java
url: /fr/java/merger/merge-prn-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Fusion gratuite en ligne PRN au format de sauvegarde SQL. Java Combinez le format PRN au format SQL. Fusionner PRN en SQL dans Java. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN en SQL dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN avec SQL dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN avec SQL. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier SQL. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne PRN en SQL.
...
{{% blocks/products/pf/agp/content h2="Comment fusionner PRN en SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner PRN avec SQL par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner PRN en SQL" %}}
