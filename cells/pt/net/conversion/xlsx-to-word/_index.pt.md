---
title: C# XLSX a WORD - XLSX a WORD Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato WORD, permitindo o salvamento perfeito de dados XLSX no formato WORD usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a WORD em C#" %}}

exemplo a seguir demonstra como converter XLSX em WORD em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter XLSX em WORD por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX em WORD programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em WORD em apenas algumas linhas de código.
...
1.  Converta XLSX para WORD chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para WORD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em WORD" %}}
