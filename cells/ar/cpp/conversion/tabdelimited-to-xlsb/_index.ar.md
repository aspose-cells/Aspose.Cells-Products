---
title: تحويل TABDELIMITED إلى XLSB عبر تطبيق C++ 

description: نموذج C++ رمز تحويل لمستند TABDELIMITED إلى تنسيق XLSB. يمكن للمبرمجين استخدام رمز المصدر هذا للتحويل الدفعي من TABDELIMITED إلى XLSB داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى XLSB عبر C++" h2="عالية الأداء TABDELIMITED لتحويل XLSB باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى XLSB باستخدام C++" %}}
 ...
 من أجل تحويل TABDELIMITED إلى XLSB ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ تحويل ملف TABDELIMITED بسهولة إلى XLSB في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف TABDELIMITED باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLSB).1. سيتم حفظ ملف XLSB في المسار المحدد.1. افتح ملف XLSB في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED إلى XLSB C++ رمز مصدر التحويل" offSpacer="" %}}
