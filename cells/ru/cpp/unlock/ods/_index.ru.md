...
weight: 1190
description: Пример кода C++ для разблокировки защищенного паролем файла ODS в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Разблокировать файлы ODS через C++" h2="Снимите защиту с электронных таблиц Excel, включая файл ODS, используя библиотеку C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Как снять защиту файла ODS с помощью C++" %}}
...
1.  Загрузите заблокированный файл ODS с помощью CreateIWorkbook.
1.  Вызовите функцию Unprotect() для разблокировки.
1.  Установите пароль на NULL с помощью SetPassword.
1.  Сохраните файл ODS в указанном месте.
