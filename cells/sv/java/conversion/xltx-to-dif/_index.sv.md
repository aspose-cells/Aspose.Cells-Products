---
title: Konvertera XLTX till DIF via Java 
weight: 890

description: Exempel på Java-konverteringskod för XLTX-format till DIF-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till DIF inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLTX till DIF med Java" %}}

 För att rendera XLTX till DIF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLTX till DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLTX-fil till DIF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTX-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med DIF-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande DIF-filen
...
{{% blocks/products/pf/agp/code-block title="XLTX till DIF Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLTX till DIF Conversion Live Demos" sectionDescription="[Konvertera XLTX till DIF](https://products.aspose.app/cells/conversion/xltx-to-dif) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din XLTX-fil, den konverteras omedelbart till DIF." >}}
