---
title: Python NUMARALAR'dan TSV'e - NUMARALAR'dan TSV'e Dönüştürücü
description: Aspose Excel'de. NUMBERS'ı Aspose.Cells ile hızlı ve kolay bir şekilde TSV'e dönüştürün. Python NUMBERS'ı TSV'e dönüştürün. Python NUMBERS'ı TSV'e kaydedin. NUMBERS'ı Python'i kullanarak TSV olarak kaydedin.
...
{{% cells-convert title="NUMBERS\'ı TSV\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tsv" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı Python aracılığıyla TSV\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı programlı olarak TSV'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyip TSV'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak NUMBERS'ı TSV'e dönüştürün.
1.  NUMBERS'ın dönüşüm sonucunu TSV'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı TSV\'e dönüştürmek için Python kitaplığı" %}}
