---
title: 通過 C# 在 Micorsoft Excel XLS 文件中插入數據透視圖
weight: 7690
description: C# 生成帶有數據透視圖的 XLS 文檔的示例代碼。使用此代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中創建帶有數據透視表的 Micorsoft Excel XLS 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 在 XLS 文檔中插入數據透視圖" h2="本機和高性能 Microsoft Excel XLS 使用服務器端 API 以編程方式創建數據透視圖的電子表格 .NET。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
在運行的應用程序中動態生成帶有數據透視圖的 MS Excel XLS 文件很容易。為了在不需要 MS Office 的情況下從頭開始使用數據透視圖創建 XLS 文檔，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="如何通過C#在XLS中插入數據透視圖" %}}

{{% blocks/products/pf/agp/text %}}

開發人員可以很容易地在運行不同報告應用程序的 XLS 格式電子表格中插入數據透視圖，只需幾行代碼即可進行數據處理。
...
{{% blocks/products/pf/agp/code-block title="在 XLS - C# 中插入數據透視圖" offSpacer="" %}}
