---
title: "Konvertálja az XLSB-t JPG-vé a következőn keresztül: Java "
url: /hu/java/conversion/xlsb-to-jpg/ 
description: Minta Java konverziós kód az XLSB formátumhoz JPG fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok exportálására JPG formátumban bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja az XLSB-t JPG-vé a következőn keresztül: Java" h2="XLSB-ből JPG-be Java konverzió egyetlen vagy több oldal konvertálásához JPG-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB konvertálása JPG-vé a következővel: Java" %}}

 Az XLSB JPG formátumba való rendereléséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSB konvertálása JPG-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak XLSB fájlt JPG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSB-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat JPG kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott JPG fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLSB-ből JPG-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLSB fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xlsb");
// mentse az XLSB-t JPG formátumban
