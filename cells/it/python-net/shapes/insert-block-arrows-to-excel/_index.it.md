...
weight: 338
description: Python via Codice sorgente .Net per inserire le frecce di blocco in Excel.
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Utilizza l'aggiunta della shapecollection[metodo](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) per inserire le frecce di blocco nel foglio di lavoro selezionato.
...
{{% blocks/products/pf/agp/code-block title="Inserisci frecce di blocco - Python via .Net" offSpacer="" %}}
