---
title: Sloučit PRN s DIF – Sloučit PRN s DIF v C#
url: /cs/net/merger/merge-prn-to-dif/ 
description: Aspose Excel. C# Aspose.Cells. Zdarma online sloučit PRN do formátu uložení DIF. C# Zkombinujte PRN do formátu DIF. Sloučit PRN na DIF v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na DIF v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN s DIF v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do DIF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru DIF. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí PRN do DIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení PRN na DIF v C#" InputFormat="prn" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na DIF přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s DIF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení PRN s DIF" %}}
