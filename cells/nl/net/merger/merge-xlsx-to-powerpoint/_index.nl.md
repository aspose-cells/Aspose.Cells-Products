...
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen XLSX naar POWERPOINT-opslagformaat. C# Combineer XLSX tot POWERPOINT-indeling. Voeg XLSX samen met POWERPOINT in C#. XLSX Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSX samen met POWERPOINT in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLSX kunt samenvoegen met POWERPOINT in Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis online om XLSX samen te voegen met POWERPOINT in C#" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSX samen te voegen met POWERPOINT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met POWERPOINT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
