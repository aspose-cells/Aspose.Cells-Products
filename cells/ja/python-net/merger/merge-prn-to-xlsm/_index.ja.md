---
title: PRN を Python 経由で XLSM に結合
url: /ja/python-net/merger/merge-prn-to-xlsm/ 
description: PRN をオンラインで無料で XLSM に結合します。無料のオンライン PRN XLSM 合併。 PRN を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、PRN を Python の XLSM にマージする方法を示しています。
...
{{% cells-merger title="PRNをオンラインでXLSMにマージする無料アプリ" InputFormat="prn" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
