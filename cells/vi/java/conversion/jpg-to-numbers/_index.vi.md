---
title: Java JPG sang SỐ - Chuyển đổi JPG sang SỐ trực tuyến
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Trực tuyến miễn phí Java Chuyển đổi JPG sang định dạng lưu SỐ. Java JPG sang định dạng SỐ. Lưu JPG về SỐ Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi JPG sang SỐ trong Java" h2="Thư viện Java tốc độ cao để chuyển đổi JPG sang SỐ. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất JPG, SỐ và nhiều định dạng khác bằng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu JPG thành SỐ trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi JPG thành SỐ trong Java.
...
Cần chuyển đổi tệp JPG thành SỐ theo chương trình? Java nhà phát triển có thể dễ dàng chuyển đổi JPG sang SỐ chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi JPG thành SỐ bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi từ JPG sang SỐ.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java thư viện để chuyển đổi JPG sang SỐ" %}}
{{% blocks/products/pf/agp/text %}}
