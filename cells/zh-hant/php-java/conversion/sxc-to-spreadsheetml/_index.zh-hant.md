...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 SXC 轉換為 SPREADSHEETML。PHP SXC 到 SPREADSHEETML。 PHP 將 SXC 儲存到 SPREADSHEETML。使用 PHP 將 SXC 儲存為 SPREADSHEETML。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 PHP 中將 SXC 轉換為 SPREADSHEETML" h2="用於將 SXC 轉換為 SPREADSHEETML 的高速 PHP 函式庫。這是一個使用 PHP 匯入和匯出 SXC、SPREADSHEETML 和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何將 SXC 轉換為 SPREADSHEETML？使用 Aspose.Cells for PHP via Java 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 SXC 轉換為 SPREADSHEETML。[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 PHP Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，使其成為以行業標準格式交換文件的完美選擇。
...
{{% blocks/products/pf/agp/content h2="如何透過 PHP 將 SXC 轉換為 SPREADSHEETML" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 SXC 檔案轉換為 SPREADSHEETML？ PHP 開發人員只需幾行程式碼即可輕鬆載入 SXC 並將其轉換為 SPREADSHEETML。
...
1. 使用工作簿實例載入 SXC 檔案。
1. 透過呼叫Workbook的save方法將SXC轉換為SPREADSHEETML。
1. 取得 SXC 到 SPREADSHEETML 的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 SXC 轉換為 SPREADSHEETML 的 PHP 函式庫" %}}
