---
title: Java XLS έως TSV - XLS έως TSV Μετατροπέας
description: Aspose Excel. Αυτή η ολοκληρωμένη λύση παρέχει στους προγραμματιστές Java μια πλήρως ενσωματωμένη προσέγγιση για τη μετατροπή της μορφής XLS σε TSV, επιτρέποντας την απρόσκοπτη αποθήκευση δεδομένων XLS σε μορφή TSV χρησιμοποιώντας τη βιβλιοθήκη Aspose.Cells, μέσω αποτελεσματικού και προσαρμόσιμου κώδικα Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή XLS σε TSV σε Java" h2="Βιβλιοθήκη Java υψηλής ταχύτητας για τη μετατροπή του XLS σε TSV. Πρόκειται για μια επαγγελματική λύση λογισμικού για την εισαγωγή και εξαγωγή XLS, TSV και πολλών άλλων μορφών που χρησιμοποιούν το Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση XLS σε TSV στο Java" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το XLS σε TSV σε Java.
{{% blocks/products/pf/agp/text %}}

Ακολουθήστε τα εύκολα βήματα για να μετατρέψετε το XLS σε TSV. Ανεβάστε το αρχείο XLS και, στη συνέχεια, απλώς αποθηκεύστε το ως αρχείο TSV. Τόσο για την ανάγνωση XLS όσο και για τη γραφή TSV, μπορείτε να χρησιμοποιήσετε πλήρως πιστοποιημένα ονόματα αρχείων. Το περιεχόμενο και η μορφοποίηση εξόδου TSV θα είναι πανομοιότυπα με το αρχικό έγγραφο XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Δείγμα κώδικα για μετατροπή XLS σε TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το XLS σε TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

Χρειάζεται να μετατρέψετε αρχεία XLS σε TSV μέσω προγραμματισμού; Οι προγραμματιστές Java μπορούν εύκολα να μετατρέψουν αρχεία XLS σε TSV σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατρέψτε το XLS σε TSV καλώντας τη μέθοδο Workbook.save.
1.  Λάβετε το αποτέλεσμα μετατροπής XLS σε TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Βιβλιοθήκη Java για μετατροπή του XLS σε TSV" %}}
{{% blocks/products/pf/agp/text %}}
