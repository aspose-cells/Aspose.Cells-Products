...
description: Aspose Эксель. Преобразуйте MHTML в XLTX быстро и легко с помощью Aspose.Cells. PHP MHTML в XLTX. PHP Сохраните MHTML в XLTX. Сохраните MHTML как XLTX с помощью PHP.
...
{{% blocks/products/pf/agp/content h2="Сохраните от MHTML до XLTX в PHP." %}}
...
Нужно программно преобразовать файлы MHTML в XLTX? Разработчики PHP могут легко загрузить и преобразовать MHTML в XLTX всего за несколько строк кода.
...
1.  Преобразуйте MHTML в XLTX, вызвав метод сохранения книги.
1.  Получите результат преобразования MHTML в XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования MHTML в XLTX" %}}
