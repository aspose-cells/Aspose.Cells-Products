...
url: /cs/python-net/merger/merge-mht-to-image/ 
...
Následující příklad ukazuje, jak sloučit MHT do IMAGE v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit MHT s IMAGE? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
