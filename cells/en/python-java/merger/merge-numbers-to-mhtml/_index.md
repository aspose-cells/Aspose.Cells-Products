...
{{% blocks/products/pf/agp/content h2="How to Merge NUMBERS to MHTML File Using Python" %}}
 ...
 In order to merge NUMBERS to MHTML file, we’ll use
...
{{% cells-merger title="Free App to merge Excel files on line" InputFormat="numbers" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="python-java" %}}
