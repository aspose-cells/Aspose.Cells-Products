...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLSX 转换为 PDF。 Python XLSX 为 PDF。 Python 将 XLSX 保存为 PDF。 将 XLSX 另存为 07611134 81 使用 Python。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 XLSX 转换为 Python 中的 PDF" h2="高速 Python 库，用于将 XLSX 转换为 PDF。使用我们的 Excel 转换 API 在 Python 中开发高级、平台独立的软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="将 XLSX 转换为 Python 中的 PDF" %}}

如何将 XLSX 转换为 PDF？使用 Aspose.Cells for Python via NET 库，您可以通过几行代码以编程方式轻松将 XLSX 转换为 PDF。[Aspose.Cells for Python 通过 NET](https://pypi.org/project/aspose-cells-python/)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Python Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。
...
以下示例演示如何将 Python via NET 中的 XLSX 转换为 PDF。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLSX 转换为 PDF。上传您的 XLSX 文件，然后只需将其另存为 PDF 文件。对于 XLSX 读取和 PDF 写入，您可以使用完全限定的文件名。输出 PDF 内容和格式将与原始 XLSX 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 XLSX 转换为 PDF 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pdf" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLSX 转换为 PDF" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSX 文件转换为 PDF 吗？ Python 开发人员只需几行代码即可轻松加载和转换 XLSX 到 PDF。
...
1. 使用工作簿实例加载 XLSX 文件。
1. 通过调用Workbook.save方法将XLSX转换为PDF。
1. 获取XLSX到PDF的转换结果。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python库将XLSX转换为PDF" %}}
