---
title:  Inserir tabela dinâmica em arquivos do Micorsoft Excel XLS via C#
weight: 7690
description: C# Código de amostra para gerar documentos XLS com tabela dinâmica. Use este código para criar arquivos Micorsoft Excel XLS com tabela dinâmica em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserir tabela dinâmica em documentos XLS via C#" h2="Planilha Microsoft Excel XLS nativa e de alto desempenho com criação de tabela dinâmica programaticamente usando APIs .NET do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 É fácil gerar o arquivo MS Excel XLS com tabela dinâmica dinamicamente no aplicativo em execução. Para criar documentos XLS com Tabela Dinâmica do zero, sem a necessidade do MS Office, usaremos
...
É fácil para os desenvolvedores inserir a tabela dinâmica na planilha de formato XLS na execução de diferentes aplicativos de relatórios para processamento de dados em apenas algumas linhas de código.
