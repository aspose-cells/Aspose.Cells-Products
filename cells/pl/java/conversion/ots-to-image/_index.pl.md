...
{{% blocks/products/pf/agp/content h2="Konwertuj OTS na OBRAZ używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS w OBRAZIE w Java" %}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować OTS na IMAGE via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki OTS na IMAGE? Programiści Java mogą łatwo przekonwertować pliki OTS na IMAGE za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji OTS na OBRAZ" %}}
{{% blocks/products/pf/agp/text %}}
