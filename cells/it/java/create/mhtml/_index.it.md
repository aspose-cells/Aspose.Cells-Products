---
title: Crea file MHTML tramite Java 
url: /it/java/create-mhtml/ 
description: Java Codice di esempio per la generazione di documenti MHTML. Usa questo codice per creare file MHTML all'interno di un'applicazione desktop o web basata su Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crea documenti MHTML tramite Java" h2="Creazione MHTML nativa e ad alte prestazioni in modo programmatico utilizzando la libreria Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Come creare MHTML tramite Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Il codice sorgente seguente mostra come creare un file MHTML utilizzando Java." offSpacer="" %}}
