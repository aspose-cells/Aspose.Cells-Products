...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde XLTM Dosyası oluşturun. Java'i kullanarak XLTM dosyası oluşturun. Java'de XLTM oluşturun. Java XLTM Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını XLTM biçiminde kaydedin.
