---
title:  C++을 통해 XLSB 문서 보호 및 잠금
weight: 4860
description: C++ Windows 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경에서 암호를 사용하여 XLSB 파일을 잠그는 예제 코드.
---
...
1.  IWorkbook 클래스를 사용하여 XLSB 파일 로드
1.  ProtectionType 및 Password와 함께 Protect(..) 메서드 사용
1.  Save() 메서드로 보호된 XLSB 파일을 저장합니다.
