---
title: Sloučit HTM do POWERPOINT – Zkombinujte HTM do POWERPOINT v C++
url: /cs/cpp/merger/merge-htm-to-powerpoint/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit HTM do formátu pro uložení do POWERPOINT. C++ Kombinujte HTM s formátem POWERPOINT. Sloučit HTM do POWERPOINT v C++. HTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM do POWERPOINT na C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit HTM do POWERPOINT v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení HTM do POWERPOINT. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru POWERPOINT. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí HTM do POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení HTM do POWERPOINT na čísle C++" InputFormat="htm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM do POWERPOINT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit HTM do POWERPOINT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení HTM do POWERPOINT" %}}
