...
{{% blocks/products/pf/agp/content h2="Sla TXT op in XLT in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar XLT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar XLT of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar XLT? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar XLT met slechts een paar regels code.
