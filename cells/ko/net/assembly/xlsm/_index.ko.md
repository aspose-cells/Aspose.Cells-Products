---
title:  XLSM 파일 via .NET에서 보고서 생성
weight: 4400
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼에 대한 XLSM 형식 보고서를 생성합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 XLSM 형식으로 대량 보고서 생성" h2="데이터 소스 및 템플릿을 사용하여 XLSM 형식으로 보고서를 생성합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
1. WorkbookDesigner.Worbook.Save 메서드를 통해 결과를 XLSM 형식으로 저장합니다.
