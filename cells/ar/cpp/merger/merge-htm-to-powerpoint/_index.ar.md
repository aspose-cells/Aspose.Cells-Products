...
يوضح المثال التالي كيفية دمج HTM إلى POWERPOINT في Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 هل تحتاج إلى دمج HTM في POWERPOINT برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
