---
title: 将 TXT 合并到 NUMBERS - 将 TXT 合并到 Python 中的 NUMBERS
url: /zh/python-net/merger/merge-txt-to-numbers/ 
description: Aspose Excel。 Python Aspose.Cells。免费在线合并 TXT 到 NUMBERS 保存格式。 Python 将 TXT 合并为 NUMBERS 格式。将 TXT 合并到 Python 中的 NUMBERS。 TXT 合并。
...
如何将 TXT 合并到 NUMBERS 中？借助 Aspose.Cells for Python via .NET 库，您可以通过几行代码以编程方式轻松将 TXT 合并到 NUMBERS。[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Python Excel API不仅可以在电子表格格式之间进行转换，还可以将Excel文件渲染为图像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，从而使其成为行业交换文档的完美选择-标准格式。您可以安装 Aspose.Cells for Python via .NET<a href="https://pypi.org/project/aspose-cells-python/">pypi</a>，使用命令为：<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="免费在线将 TXT 合并为 Python 中的数字" %}}

以下示例演示如何将 TXT 合并到 Aspose.Cells for Python via .NET 中的 NUMBERS。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 TXT 合并到 NUMBERS。上传文件，调用 Workbook.Combine 方法合并文件，然后将其保存到 NUMBERS 文件。如果您在 Python 中开发代码，这会比听起来更简单。请参阅 Python 将 TXT 合并到 NUMBERS 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线将 TXT 合并为 Python 中的数字" InputFormat="txt" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何通过 Python 将 TXT 合并为 NUMBERS" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 TXT 合并到 NUMBERS 吗？基本文档合并和连接[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)只需几行代码即可完成 API。
