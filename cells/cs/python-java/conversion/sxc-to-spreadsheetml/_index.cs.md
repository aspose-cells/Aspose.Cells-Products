---
title: Převést SXC na SPREADSHEETML přes Python
url: /cs/python-java/conversion/sxc-to-spreadsheetml/
description: Ukázkový kód pro převod sxc na tabulkuml Python. Použijte API ukázkový kód pro dávkový převod souborů sxc do tabulkyml v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na SPREADSHEETML pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na SPREADSHEETML prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC do formátu SPREADSHEETML pomocí několika řádků kódu.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xml" IsLandingPage="true" language="python" %}}
