---
title: 創建IMAGE - 在C#中創建IMAGE文件
description: Aspose Excel。 C# 創建圖像文件。創建圖像 C#。C# 圖像創建者。在C#中創建IMAGE。使用C#生成IMAGE文件。
...
{{% blocks/products/pf/agp/content h2="如何在 C# 中創建圖像" %}}
...
{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 C# 中創建 IMAGE 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# 創建IMAGE文件的庫" %}}
