...
{{% blocks/products/pf/agp/content h2="C++を使用してHTMLをJPGに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してHTMLをJPGに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 C++開発者は、わずか数行のコードでHTMLファイルをJPGに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbookを使用してHTMLファイルをロードします。1. Save（）メソッドを呼び出します。1. 出力ファイルパスを（JPG）ファイル拡張子で渡します。1. JPGファイルは指定されたパスに保存されます。1. 互換性のあるプログラムでJPGファイルを開きます。
...
{{% blocks/products/pf/agp/code-block title="HTMLからJPGへのC++変換ソースコード" offSpacer="" %}}
