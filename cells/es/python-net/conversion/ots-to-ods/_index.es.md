...
description: Aspose Excel. Convierta OTS a ODS rápida y fácilmente con Aspose.Cells. Python OTS a ODS. Python Guarde OTS en ODS. Guarde OTS como ODS usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar OTS al ODS en Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a ODS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir OTS a ODS" %}}
