...
{{% blocks/products/pf/agp/content h2="Cara Membuat PNG di C++" %}}

{{% blocks/products/pf/agp/text %}}

 Sangat mudah bagi pengembang untuk membuat, memuat, memodifikasi, dan mengonversi file PNG dalam menjalankan aplikasi pelaporan untuk pemrosesan data hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/code-block title="Kode contoh menunjukkan cara membuat file PNG di C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk membuat file PNG" %}}
