---
title: JSON'u Java aracılığıyla BMP'ye dönüştürün 
weight: 910

description: JSON biçimi için BMP dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada BMP'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JSON\'u Java aracılığıyla BMP\'ye dönüştürün" h2="Ek araçlar veya kitaplıklar gerektirmeden JSON\'u Java aracılığıyla BMP formatına aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak JSON\'u BMP\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla JSON\'u BMP\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla JSON dosyasını BMP'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Workbook sınıfının yeni bir örneğini oluşturun1. Koleksiyondan varsayılanı veya herhangi bir Çalışma Sayfasını seçin1. JSON verilerini dosyadan yükle1. JsonLayoutOptions örneğini oluşturun ve seçenekleri ayarlayın1. JSON verilerini içe aktarmak için JsonUtility.importData yöntemini çağırın1. BMP oluşturma için ImageOrPrintOptions nesnesini oluşturun ve ayarlayın1. İşleme için SheetRender oluşturun1. Sonucu BMP formatında kaydetmek için SheetRender.toImage yöntemini çağırın
...
{{% blocks/products/pf/agp/code-block title="JSON\'dan BMP\'ye Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
