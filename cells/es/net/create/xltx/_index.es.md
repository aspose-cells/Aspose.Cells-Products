---
title: Crear XLTX - Crear archivo XLTX en C#
description: Aspose Excel. Genere y manipule fácilmente archivos XLTX con la biblioteca Aspose.Cells for .NET. Esta potente biblioteca API ofrece una solución optimizada y eficiente para crear, editar y administrar archivos XLTX directamente en sus aplicaciones C#, satisfaciendo las necesidades específicas de los desarrolladores con alta precisión.
...
{{% blocks/products/pf/agp/content h2="Cómo crear XLTX en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="El código de muestra muestra cómo crear el archivo XLTX en C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para crear el archivo XLTX" %}}
