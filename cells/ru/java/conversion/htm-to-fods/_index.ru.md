---
title: Java HTM в FODS - Конвертер HTM в FODS
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM-код в FODS в Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в FODS в Java.
...
Нужно программно преобразовать HTM-файлы в формат FODS? Разработчики, использующие формат Java, могут легко преобразовать HTM в формат FODS всего несколькими строками кода.
