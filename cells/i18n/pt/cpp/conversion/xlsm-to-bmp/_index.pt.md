---
title: Converter XLSM para BMP por meio do aplicativo C++ 
url: /pt/cpp/conversion/xlsm-to-bmp/ 
description: Exemplo de código de conversão C++ de documento XLSM para formato BMP. Os programadores podem usar esse código-fonte para conversão em lote de XLSM para BMP em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSM para BMP via C++" h2="Conversão de XLSM para BMP de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem facilmente converter arquivos XLSM em BMP em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLSM usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (BMP).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo BMP em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLSM para BMP C++" offSpacer="" %}}
