...
description: Aspose เอ็กเซล. แปลง IMAGE เป็น DIF อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Python IMAGE เป็น DIF Python บันทึก IMAGE เป็น DIF บันทึก IMAGE เป็น DIF โดยใช้ Python
...
{{% blocks/products/pf/agp/content h2="บันทึกภาพไปที่ DIF ใน Python" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง IMAGE เป็น DIF ใน Python
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง IMAGE เป็น DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="dif" IsLandingPage="true" language="pythonjava" %}}
