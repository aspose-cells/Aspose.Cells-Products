---
title: C# PRN'den BMP'e - PRN'den BMP'e dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde PRN'yi BMP'e dönüştürün. C# PRN'yi BMP'e dönüştürün. C# PRN'yi BMP'e kaydedin. C#'i kullanarak PRN'yi BMP olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi C#\'de BMP\'e kaydedin" %}}

Aşağıdaki örnek, PRN'nin C#'de BMP'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="PRN\'yi BMP\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="bmp" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla BMP\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PRN dosyalarını programlı olarak BMP'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PRN'yi kolayca yükleyebilir ve BMP'e dönüştürebilir.
