---
title:  Συγχώνευση XLT στο HTM μέσω C#
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLT στο HTM στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLT σε HTM σε απευθείας σύνδεση" InputFormat="xlt" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
