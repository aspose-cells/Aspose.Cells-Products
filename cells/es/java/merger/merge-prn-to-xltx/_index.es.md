---
title: Combinar PRN con XLTX - Combinar PRN con XLTX en Java
url: /es/java/merger/merge-prn-to-xltx/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea PRN a XLTX guardar formato. Java Combina PRN con formato XLTX. Combinar PRN a XLTX en Java. Combinar PRN.
...
El siguiente ejemplo muestra cómo combinar PRN con XLTX en Aspose.Cells for Java.
...
{{% cells-merger title="Gratis en línea para fusionar PRN a XLTX en Java" InputFormat="prn" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN a XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar PRN con XLTX mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
