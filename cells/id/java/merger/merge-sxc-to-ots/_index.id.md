...
description: Aspose Unggul. Java Aspose.Cells. Gabung Online Gratis SXC ke format simpan OTS. Java Gabungkan SXC ke format OTS. Gabung SXC menjadi OTS di Java. SXC Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan SXC menjadi OTS di Java Online Gratis" %}}
...
{{% cells-merger title="Online Gratis Menggabungkan SXC menjadi OTS di Java" InputFormat="sxc" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC ke OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan SXC ke OTS secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan SXC ke OTS" %}}
