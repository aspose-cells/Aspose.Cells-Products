---
title: A XLS egyesítése az EXCEL-lel – a XLS egyesítése az EXCEL-lel a Java-ben
url: /hu/java/merger/merge-xls-to-excel/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés XLS EXCEL mentési formátumba. Java Kombinálja a XLS-et EXCEL formátumba. A XLS egyesítése az EXCEL-lel a Java-ben. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLS-et az EXCEL-hez a Java-es online ingyen" %}}

következő példa bemutatja, hogyan lehet egyesíteni a XLS-et az EXCEL-lel a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS EXCEL-lel való egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el EXCEL fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a XLS-et az EXCEL-lel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a XLS-es EXCEL-lel a Java-ben" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLS és az EXCEL via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-et az EXCEL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a XLS EXCEL-be való egyesítéséhez" %}}
