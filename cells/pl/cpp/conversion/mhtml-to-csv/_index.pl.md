---
title: Konwertuj MHTML na CSV za pomocą aplikacji C++ 
weight: 3510
url: /pl/cpp/conversion/mhtml-to-csv/ 
description: Przykładowy kod konwersji C++ dla dokumentu MHTML do formatu CSV. Programiści mogą używać tego kodu źródłowego do zbiorczej konwersji MHTML na CSV w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MHTML na CSV przez C++" h2="Wysokowydajna konwersja MHTML do CSV przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik MHTML na CSV w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik MHTML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (CSV).1. Plik CSV zostanie zapisany pod określoną ścieżką.1. Otwórz plik CSV w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="MHTML do CSV C++ Kod źródłowy konwersji" offSpacer="" %}}
