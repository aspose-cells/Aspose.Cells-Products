...
description: Aspose Excel。 Python Aspose.Cells. 将 OTS 合并为 SQL 保存格式。 Python 将 OTS 合并为 SQL 格式。将 OTS 合并到 Python 中的 SQL。OTS 合并。
...
{{% blocks/products/pf/agp/content h2="将 OTS 合并到 Python 中的 SQL" %}}
...
{{% cells-merger title="Python 中将 OTS 合并到 SQL 的示例代码" InputFormat="ots" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
