---
title: 將 TXT 合併到 SPREADSHEETML - 將 TXT 合併到 C++ 中的 SPREADSHEETML
url: /zh-hant/cpp/merger/merge-txt-to-spreadsheetml/ 
description: Aspose Excel。 C++ Aspose.Cells。將 TXT 合併到 SPREADSHEETML 儲存格式。 C++ 將 TXT 合併為 SPREADSHEETML 格式。將 TXT 合併到 C++ 中的 SPREADSHEETML。TXT 合併。
...
{{% blocks/products/pf/agp/content h2="使用 C++ 將 TXT 合併到 SPREADSHEETML" %}}

如何將 TXT 合併到 SPREADSHEETML？使用 Aspose.Cells for C++ 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 TXT 合併到 SPREADSHEETML。[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 C++ Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。您可以直接下載最新版本，打開即可[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/)套件管理器，搜尋Aspose.Cells.cpp並安裝。您也可以從套件管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/content h2="將 TXT 合併到 C++ 中的 SPREADSHEETML" %}}

以下範例示範如何將 TXT 合併到 Aspose.Cells for C++ 中的 SPREADSHEETML。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 TXT 合併到 SPREADSHEETML。上傳文件，呼叫 Workbook.Combine 方法合併文件，然後將其儲存到 SPREADSHEETML 文件。如果您在 C++ 中開發程式碼，這會比聽起來更簡單。請參閱將 TXT 合併到 SPREADSHEETML 的 C++ 範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 TXT 合併到 C++ 中的 SPREADSHEETML 的範例程式碼" InputFormat="txt" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 TXT 合併到 SPREADSHEETML" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 TXT 合併到 SPREADSHEETML 嗎？基本文檔合併和連接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++ 庫將 TXT 合併到 SPREADSHEETML" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-bmp/" name="合併 TXT 至 BMP" description="點陣圖影像" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-emf/" name="合併 TXT 至 EMF" description="增強的圖元檔案格式" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-pdf/" name="合併 TXT 至 PDF" description="便攜式文件格式" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-png/" name="合併 TXT 至 PNG" description="手提網路圖形" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-svg/" name="合併 TXT 至 SVG" description="可縮放向量圖形" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-txt/" name="合併 TXT 至 TXT" description="文字文檔" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-xls/" name="合併 TXT 至 XLS" description="Excel 二進位格式" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-xlsb/" name="合併 TXT 至 XLSB" description="二進位 Excel 工作簿文件" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-xlsm/" name="合併 TXT 至 XLSM" description="試算表文件" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-xltm/" name="合併 TXT 至 XLTM" description="Excel 巨集啟用模板" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-txt-to-json/" name="合併 TXT 至 JSON" description="JavaScript 物件表示法" >}}
