...
Besoin de convertir des fichiers JPG en ET par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en ET en quelques lignes de code seulement.
...
1. Convertissez le format JPG en ET en appelant la méthode Workbook.Save.
