---
title: Voeg TXT samen met MARKDOWN - Combineer TXT met MARKDOWN in Java
url: /nl/java/merger/merge-txt-to-markdown/ 
description: Aspose Excel. Java Aspose.Cells. Voeg TXT samen met het opslagformaat MARKDOWN. Java Combineer het formaat TXT met MARKDOWN. Voeg TXT samen met MARKDOWN in Java. TXT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met MARKDOWN in Java" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met MARKDOWN in Aspose.Cells for Java.
...
{{% cells-merger title="Voorbeeldcode om TXT samen te voegen met MARKDOWN in Java" InputFormat="txt" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u TXT samenvoegt met MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met MARKDOWN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om TXT samen te voegen met MARKDOWN" %}}
