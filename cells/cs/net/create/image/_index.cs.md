---
title: Create IMAGE – Vytvořte IMAGE soubor v C#
description: Aspose Excel. Snadno generujte a manipulujte se soubory IMAGE pomocí knihovny Aspose.Cells for .NET. Tato výkonná knihovna API poskytuje efektivní a zjednodušené řešení pro vytváření, úpravu a správu souborů IMAGE přímo ve vašich aplikacích C# a splňuje specifické potřeby vývojářů s vysokou přesností.
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit IMAGE v C#" %}}
...
1.  Pomocí metody Uložit uložte sešit jako soubor IMAGE.

{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor IMAGE v adresáři C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro vytvoření souboru IMAGE" %}}
