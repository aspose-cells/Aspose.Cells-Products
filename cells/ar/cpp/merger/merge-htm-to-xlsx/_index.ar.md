...
يوضح المثال التالي كيفية دمج HTM مع XLSX في Aspose.Cells for C++.
...
هل تحتاج إلى دمج HTM في XLSX برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
