---
title:  Защита и замок XLSX документ via .NET
weight: 90
description: C# исходный код для блокировки файла XLSX с использованием пароля на платформах .NET Framework, .NET Core, Mono или Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Зашифровать файлы XLSX через C#" h2="Защищайте паролем электронные таблицы Excel, включая формат XLSX, используя библиотеку .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Защитить XLSX через C#" %}}
...
1.  Создать экземпляр класса Workbook с путем к файлу XLSX
