---
title:  Πώς μπορώ να σχεδιάσω ή να εισαγάγω διπλό ίσιο βέλος στο Excel via .NET
weight: 10
description: C# Δείγμα κώδικα για να προσθέσετε ή να εισαγάγετε διπλό ευθύ βέλος στο Excel χρησιμοποιώντας τη Βιβλιοθήκη .NET. Χρησιμοποιήστε αυτόν τον κώδικα για να δημιουργήσετε διπλό ίσιο βέλος στο MS Excel εντός των VB.NET, Asp.NET ή οποιασδήποτε εφαρμογής που βασίζεται στο .NET.
...
{{< blocks/products/pf/i18n/upper-banner h1="Εισαγάγετε διπλό ευθύ βέλος στο Excel via .NET" h2="Εισαγάγετε διπλό ίσιο βέλος χρησιμοποιώντας το Aspose.Cells\' API χωρίς λογισμικό όπως Microsoft ή Open Office, Adobe PDF κ.λπ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Πώς να εισαγάγετε διπλό ευθύ βέλος στο αρχείο Excel χρησιμοποιώντας το C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για να εισαγάγετε διπλό ίσιο βέλος στο αρχείο Excel μέσω C#" %}}
...
+ Επιλέξτε Φύλλο εργασίας μέσω του ευρετηρίου του.
 + Χρησιμοποιήστε το[μέθοδος προσθήκης](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline)για να εισαγάγετε ένα διπλό ίσιο βέλος στο επιλεγμένο φύλλο εργασίας
...
{{% blocks/products/pf/agp/code-block title="Εισαγάγετε διπλό ίσιο βέλος - C#" offSpacer="" %}}
