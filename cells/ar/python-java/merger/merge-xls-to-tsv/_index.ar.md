...
description: Aspose اكسل. Python Aspose.Cells. دمج XLS إلى TSV حفظ التنسيق. Python قم بدمج تنسيق XLS إلى TSV. دمج XLS إلى TSV في Python. XLS دمج.
...
{{% blocks/products/pf/agp/content h2="دمج XLS إلى TSV باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="دمج XLS إلى TSV في Python" %}}

المثال التالي يوضح كيفية دمج XLS إلى TSV في Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج XLS إلى TSV. قم بتحميل ملفاتك، واتصل بطريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف TSV. إذا قمت بتطوير التعليمات البرمجية في Python، فسيكون هذا أبسط مما يبدو. راجع مثال Python الذي يدمج XLS إلى TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج رمز لدمج XLS إلى TSV في Python" InputFormat="xls" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLS إلى TSV عبر Python" %}}
