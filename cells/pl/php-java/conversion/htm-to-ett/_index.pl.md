...
description: Aspose Excel. Szybko i łatwo przekonwertuj HTM na ETT za pomocą Aspose.Cells. PHP HTM na ETT. PHP Zapisz HTM w ETT. Zapisz HTM jako ETT przy użyciu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTM na ETT przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki HTM na ETT? Programiści PHP mogą łatwo załadować i przekonwertować HTM na ETT w zaledwie kilku linijkach kodu.
...
1.  Konwertuj HTM na ETT, wywołując metodę zapisu skoroszytu.
