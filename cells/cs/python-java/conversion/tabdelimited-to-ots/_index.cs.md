...
description: Aspose Excel. Převeďte TABDELIMITED na OTS rychle a snadno pomocí Aspose.Cells. Python TABDELIMITED na OTS. Python Uložit TABDELIMITED do OTS. Uložte TABDELIMITED jako OTS pomocí Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte TABDELIMITED na OTS pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte TABDELIMITED do OTS na Python" %}}

Následující příklad ukazuje, jak převést TABDELIMITED na OTS v Python.
