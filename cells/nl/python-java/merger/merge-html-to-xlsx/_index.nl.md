---
title:  Samenvoegen HTML naar XLSX via Python
url: /nl/python-java/merger/merge-html-to-xlsx/ 
description: Samenvoegen HTML naar XLSX Online gratis. Gratis online HTML tot XLSX Fusie. Voeg HTML samen met Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS en meer.
---
...
Het volgende voorbeeld laat zien hoe u HTML samenvoegt met XLSX in Python.
...
{{% cells-merger title="Gratis app om HTML online samen te voegen tot XLSX" InputFormat="html" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
