---
title: C# IMAGE to SQL - محول IMAGE إلى SQL عبر الإنترنت
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل IMAGE إلى SQL saveformat. C# IMAGE إلى تنسيق SQL. حفظ الصورة في SQL C#.
...
{{% blocks/products/pf/agp/content h2="احفظ IMAGE إلى SQL في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى SQL في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى SQL عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى SQL برمجيًا؟ يمكن للمطورين .NET تحميل وتحويل IMAGE إلى SQL بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى SQL عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# مكتبة لتحويل IMAGE إلى SQL" %}}
