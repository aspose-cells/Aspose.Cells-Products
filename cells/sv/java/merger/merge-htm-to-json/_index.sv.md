---
title:  Slå ihop HTM till JSON via Java
...
Följande exempel visar hur man slår samman HTM till JSON i Java.
...
{{% cells-merger title="Gratis app för att slå samman HTM till JSON online" InputFormat="htm" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
