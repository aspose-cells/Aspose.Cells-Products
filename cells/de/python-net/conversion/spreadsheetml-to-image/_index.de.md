...
Das folgende Beispiel zeigt, wie SPREADSHEETML in IMAGE in Python via NET konvertiert wird.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SPREADSHEETML in IMAGE" %}}
