...
description: Aspose Excel. Convierta XLTM a ET rápida y fácilmente con Aspose.Cells. Python XLTM a ET. Python Guardar XLTM en ET. Guarde XLTM como ET usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XLTM en ET en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLTM a ET en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLTM a ET" %}}
