---
title: OTS'yi JPEG ile birleştir - OTS'yi C++'de JPEG ile birleştir
url: /tr/cpp/merger/merge-ots-to-jpeg/ 
description: Aspose Excel'de. C++ Aspose.Cells. OTS'yi JPEG kaydetme biçimiyle birleştirin. C++ OTS'yi JPEG biçimiyle birleştirin. OTS'yi C++'de JPEG ile birleştirin. OTS Birleştirme.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi C++\'de JPEG ile birleştir" %}}

Aşağıdaki örnekte OTS'nin Aspose.Cells for C++'deki JPEG ile nasıl birleştirileceği gösterilmektedir.
{{% blocks/products/pf/agp/text %}}

OTS'yi JPEG ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından JPEG dosyasına kaydedin. C++'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. OTS'yi JPEG ile birleştiren C++ örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C++\'de OTS\'yi JPEG ile Birleştirmek için Örnek Kod" InputFormat="ots" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi C++ aracılığıyla JPEG ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 OTS'yi programlı olarak JPEG ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
