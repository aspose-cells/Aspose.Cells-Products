---
title:  HTML'i Python aracılığıyla ODS ile birleştirin
url: /tr/python-java/merger/merge-html-to-ods/ 
description: HTML'i ODS ile Çevrimiçi Ücretsiz Olarak Birleştirin. Ücretsiz Çevrimiçi HTML - ODS Birleşme. HTML'i Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS ve daha fazlasıyla birleştirin.
---
...
Aşağıdaki örnek, HTML'in Python'de ODS ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="HTML\'i hatta ODS ile birleştirmek için Ücretsiz Uygulama" InputFormat="html" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
