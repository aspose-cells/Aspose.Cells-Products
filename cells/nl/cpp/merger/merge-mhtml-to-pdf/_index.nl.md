---
title: Voeg MHTML samen met PDF - Combineer MHTML met PDF in C++
url: /nl/cpp/merger/merge-mhtml-to-pdf/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen MHTML naar PDF saveformat. C++ Combineer het formaat MHTML tot PDF. Samenvoegen MHTML tot PDF in C++. MHTML Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u MHTML samenvoegt met PDF in Aspose.Cells for C++.
...
{{% cells-merger title="Gratis online om MHTML samen te voegen tot PDF in C++" InputFormat="mhtml" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe MHTML samen te voegen met PDF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHTML programmatisch samenvoegen tot PDF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
