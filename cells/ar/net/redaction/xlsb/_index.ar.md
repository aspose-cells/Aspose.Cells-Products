---
title:  بحث واستبدال النص في XLSB مستند via .NET
weight: 3890
description: كود المصدر C# لتنقيح المعلومات الحساسة في ملف XLSB على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
