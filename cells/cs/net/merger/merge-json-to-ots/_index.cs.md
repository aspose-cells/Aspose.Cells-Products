...
url: /cs/net/merger/merge-json-to-ots/ 
...
Následující příklad ukazuje, jak sloučit JSON do OTS v Aspose.Cells for .NET.
...
Potřebujete sloučit JSON do OTS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna ke sloučení JSON do OTS" %}}
