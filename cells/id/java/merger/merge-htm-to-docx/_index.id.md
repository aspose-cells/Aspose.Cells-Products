---
title: Gabungkan HTM ke DOCX - Gabungkan HTM ke DOCX di Java
url: /id/java/merger/merge-htm-to-docx/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge HTM to DOCX saveformat. Java Gabungkan HTM ke format DOCX. Gabungkan HTM ke DOCX di Java. Gabungkan HTM.
...
Contoh berikut menunjukkan cara menggabungkan HTM ke DOCX di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis Menggabungkan HTM ke DOCX di Java" InputFormat="htm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan HTM ke DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan HTM ke DOCX secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
