...
{{% blocks/products/pf/agp/content h2="Zapisz XML do FODS w Java Online za darmo" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programiści Java mogą łatwo przekonwertować XML na FODS w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XML na FODS" %}}
{{% blocks/products/pf/agp/text %}}
