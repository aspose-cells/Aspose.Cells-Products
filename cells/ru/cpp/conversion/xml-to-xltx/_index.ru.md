...
Нужно программно преобразовать XML-файлы в формат XLTX? Разработчики, использующие формат C++, могут легко преобразовать XML в формат XLTX всего несколькими строками кода.
...
1.  Преобразовать XML в формат XLTX, вызвав метод Save().
