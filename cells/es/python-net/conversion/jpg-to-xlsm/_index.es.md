...
description: Aspose Excel. Convierta JPG a XLSM rápida y fácilmente con Aspose.Cells. Python JPG a XLSM. Python Guarde JPG en XLSM. Guarde JPG como XLSM usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde JPG en XLSM en Python" %}}

El siguiente ejemplo demuestra cómo convertir JPG a XLSM en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir JPG a XLSM" %}}
