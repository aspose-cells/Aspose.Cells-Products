---
title: 查看 TXT 檔案格式 via .NET
weight: 8300
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上載入、渲染和顯示 TXT 文件。
...
{{< blocks/products/pf/i18n/upper-banner h1="TXT 文件檢視器 for .NET" h2="查看 Excel 和 OpenOffice 電子表格，例如 TXT，無需 Microsoft Excel 或 Office Automation。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 查看 TXT 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

Aspose.Cells使得開發者只需幾行程式碼就可以輕鬆查看TXT檔案。

{{% /blocks/products/pf/agp/text %}}

1. 在 Workbook 實例中載入 TXT 文件
1. 建立 HtmlSaveOptions 的實例並將 ExportHeadings 屬性設為 true
1. 使用Workbook.Save方法將TXT檔案儲存為HTML格式
...
{{% blocks/products/pf/agp/code-block title="C# 查看TXT檔案的範例程式碼" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API 可用於建立、編輯、轉換和渲染 Microsoft Excel 格式為不同的格式。此外，它還可用於軟體應用程式中的全面圖表、可擴展報告和可靠計算。 Aspose.Cells 是一個獨立的 API，它不需要任何像 Microsoft 或 OpenOffice 這樣的軟體。
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="免費應用程式查看 TXT" sectionDescription="查看我們的現場演示[查看TXT](https://products.aspose.app/cells/viewer/txt)具有以下好處。" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="只需上傳 TXT 檔案並點擊「檢視」按鈕" >}}
