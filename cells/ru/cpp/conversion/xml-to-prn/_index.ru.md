...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ разработчики могут легко преобразовать XML в PRN, написав всего несколько строк кода.
