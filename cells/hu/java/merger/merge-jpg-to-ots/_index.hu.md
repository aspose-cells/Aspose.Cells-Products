---
title: JPG egyesítése OTS-be – JPG egyesítése OTS-be a Java-ben
url: /hu/java/merger/merge-jpg-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése JPG-ből OTS mentési formátumba. Java JPG kombinálása OTS formátumba. JPG egyesítése az OTS-hez a Java-ben. JPG Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a JPG-t az OTS-hez a Java Online ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a JPG-t az OTS-szel a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a JPG és az OTS egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el OTS-fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely a JPG-t OTS-be olvasztja.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a JPG és az OTS egyesítése a Java számon" InputFormat="jpg" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hogyan egyesíthetem a JPG-t OTS via Java-be" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a JPG-t az OTS-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a JPG és az OTS egyesítéséhez" %}}
