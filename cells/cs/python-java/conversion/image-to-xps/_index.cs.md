...
{{% blocks/products/pf/agp/content h2="Převeďte IMAGE na XPS pomocí Python" %}}
...
Následující příklad ukazuje, jak převést IMAGE na XPS v Python.
