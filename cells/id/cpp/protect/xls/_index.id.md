...
weight: 8760
url: /id/cpp/protect/xls/ 
description: C++ contoh kode untuk mengunci file XLS menggunakan sandi pada C++ Runtime Environment untuk Windows 32 bit, Windows 64 bit, dan Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Enkripsi File XLS melalui C++" h2="Spreadsheet Excel yang dilindungi sandi termasuk format XLS menggunakan .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengamankan File XLS Menggunakan C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Melindungi File XLS melalui C++" %}}
...
1. Muat file XLS menggunakan kelas IWorkbook1. Gunakan metode Protect(..) dengan ProtectionType dan Password1. Simpan file XLS yang dilindungi dengan metode Save()
