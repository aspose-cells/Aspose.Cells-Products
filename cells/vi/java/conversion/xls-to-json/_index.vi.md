---
title: Chuyển đổi XLS sang JSON qua Java 
weight: 9680

description: Mã chuyển đổi Java mẫu cho định dạng XLS thành tệp JSON. Lập trình viên có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang JSON trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS sang JSON qua Java" h2="Chuyển đổi XLS sang JSON Java để chuyển đổi một hoặc nhiều trang sang JSON bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS sang JSON bằng cách sử dụng Java" %}}

 Để hiển thị XLS thành JSON, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLS sang JSON qua Java" %}}

{{% blocks/products/pf/agp/text %}}

Các nhà phát triển có thể dễ dàng chuyển đổi tệp XLS sang JSON chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLS với một phiên bản của lớp Workbook1. Tạo Phạm vi dữ liệu để xuất bằng phương thức Cells .createRange1. Gọi phương thức JsonUtility.exportRangeToJson với các tham chiếu của Range & ExportRangeToJsonOptions1. Ghi dữ liệu chuỗi JSON vào tệp thông qua phương thức BufferedWriter.write
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi sử dụng mã mẫu, hãy đảm bảo rằng bạn có các điều kiện tiên quyết sau.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi XLS sang JSON Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi XLS sang JSON" sectionDescription="[Chuyển đổi XLS sang JSON](https://products.aspose.app/cells/conversion/xls-to-json) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp XLS của bạn, tệp sẽ được chuyển đổi ngay lập tức sang JSON." >}}
