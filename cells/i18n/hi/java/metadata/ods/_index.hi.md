...
{{% blocks/products/pf/agp/feature-section-col title="Java के माध्यम से ODS का मेटाडेटा निकालने के चरण" %}}
...
+ वर्कबुक मेटाडेटा के भीतर ओडीएस फ़ाइल लोड करें
...
{{% blocks/products/pf/agp/code-block title="ODS का मेटाडेटा निकालें - Java" offSpacer="" %}}
