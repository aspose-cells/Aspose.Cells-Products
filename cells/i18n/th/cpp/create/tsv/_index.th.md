...
{{% blocks/products/pf/agp/text %}}
 ...
 เป็นเรื่องง่ายสำหรับนักพัฒนาในการสร้าง โหลด แก้ไข และแปลงไฟล์ TSV ภายในแอปพลิเคชันการรายงานที่รันอยู่สำหรับการประมวลผลข้อมูลในโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. สร้างวัตถุของคลาส IWorkbook1. รับแผ่นงานแรกลงในวัตถุ IWorksheet1. ใช้เมธอด IWorksheet->GetICells() เพื่อรับเซลล์ของเวิร์กชีตเป็นออบเจกต์ ICElls1. ใช้วิธี ICells->GetObjectByIndex() เพื่อเข้าถึงเซลล์ที่ต้องการของเวิร์กชีตลงในออบเจกต์ ICEll1. ใช้วิธี ICell->PutValue() เพื่อป้อนค่าลงในเซลล์1. บันทึกเวิร์กบุ๊กเป็นไฟล์ .tsv โดยใช้วิธี Save()
...
ไลบรารีการเขียนโปรแกรมสเปรดชีต Excel ที่สามารถสร้างแอปพลิเคชันข้ามแพลตฟอร์มด้วยความสามารถในการสร้าง แก้ไข แปลง แสดงผล และพิมพ์ไฟล์ TSV C++ Excel API ไม่เพียงแต่แปลงระหว่างรูปแบบสเปรดชีตเท่านั้น แต่ยังสามารถแสดงไฟล์ Excel เป็นรูปภาพ, PDF, HTML, ODS และอื่นๆ ได้ จึงทำให้เป็นตัวเลือกที่สมบูรณ์แบบในการแลกเปลี่ยนเอกสารในรูปแบบมาตรฐานอุตสาหกรรม
