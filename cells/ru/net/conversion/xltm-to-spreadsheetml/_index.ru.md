...
{{% blocks/products/pf/agp/content h2="Сохраните значение XLTM в электронную таблицу C#." %}}

Следующий пример демонстрирует, как преобразовать XLTM в формат SPREADSHEETML в файле C#.
...
1.  Преобразуйте файл XLTM в формат SPREADSHEETML, вызвав метод Workbook.Save.
1.  Получите результат преобразования XLTM в SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XLTM в формат SPREADSHEETML." %}}
