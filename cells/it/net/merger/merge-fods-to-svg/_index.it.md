---
title: Unisci FODS a SVG - Combina FODS a SVG in C#
url: /it/net/merger/merge-fods-to-svg/ 
description: Aspose Excel. C# Aspose.Cells. Unione online gratuita da FODS a SVG saveformat. C# Combina il formato FODS con SVG. Unisci FODS a SVG in C#. FODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci FODS a SVG in C# online gratuitamente" %}}

L'esempio seguente mostra come unire FODS a SVG in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire FODS a SVG. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file SVG. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce FODS a SVG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire FODS a SVG in C#" InputFormat="fods" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire FODS a SVG tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire FODS a SVG a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca da unire FODS a SVG" %}}
