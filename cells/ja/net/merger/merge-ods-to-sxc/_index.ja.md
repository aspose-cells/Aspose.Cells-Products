...
description: Aspose エクセル。 C# Aspose.Cells。ODS を SXC の保存形式にマージします。 C# ODS と SXC の形式を結合します。 ODS から SXC を C# に結合します。ODS を結合します。
...
{{% cells-merger title="ODS から SXC を C# にマージするサンプルコード" InputFormat="ods" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
