---
title:  Sloučit JSON až XLTM via Java
...
Následující příklad ukazuje, jak sloučit JSON až XLTM v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení JSON až XLTM online" InputFormat="json" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
