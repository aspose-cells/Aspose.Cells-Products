---
title:  Tìm kiếm tài liệu TSV mà không cần mở via Java
weight: 4940
description: Java mã mẫu để tìm kiếm các từ có mẫu trong tệp TSV trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm TSV Các định dạng trong Java" h2="Tìm kiếm tài liệu gốc và hiệu suất cao TSV bằng API Aspose.Cells for Java phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tra cứu file TSV trong Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Tìm Hồ Sơ TSV - Java" offSpacer="" %}}
