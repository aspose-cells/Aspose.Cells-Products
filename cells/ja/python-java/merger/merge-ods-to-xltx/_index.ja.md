---
title:  ODS を Python 経由で XLTX に結合
...
次の例は、ODS を Python の XLTX にマージする方法を示しています。
...
{{% cells-merger title="オンラインでODSをXLTXにマージする無料アプリ" InputFormat="ods" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
