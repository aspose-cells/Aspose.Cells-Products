...
url: /pl/python-net/merger/merge-ods-to-pdf/ 
...
Poniższy przykład pokazuje, jak połączyć ODS z PDF w Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz scalić ODS z PDF programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
