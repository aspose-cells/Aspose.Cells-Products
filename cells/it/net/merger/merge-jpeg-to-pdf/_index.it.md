---
title: Unisci JPEG a PDF - Combina JPEG a PDF in C#
url: /it/net/merger/merge-jpeg-to-pdf/ 
description: Aspose Excel. C# Aspose.Cells. Unione online gratuita da JPEG a PDF saveformat. C# Combina il formato JPEG con PDF. Unisci JPEG a PDF in C#. JPEG Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci JPEG a PDF in C# online gratuitamente" %}}

L'esempio seguente mostra come unire JPEG a PDF in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire JPEG a PDF. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file PDF. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce JPEG a PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire JPEG a PDF in C#" InputFormat="jpg" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire JPEG a PDF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire JPEG a PDF a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca da unire JPEG a PDF" %}}
