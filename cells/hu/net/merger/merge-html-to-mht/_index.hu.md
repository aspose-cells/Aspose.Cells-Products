...
A következő példa bemutatja, hogyan egyesítheti a HTML-et az MHT-val a Aspose.Cells-es for .NET-ben.
...
Programozottan egyesítenie kell a HTML-et az MHT-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
