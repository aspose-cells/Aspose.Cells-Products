...
weight: 5580
description: C# broncode om ODS-bestand te vergrendelen met wachtwoord op .NET Framework, .NET Core, Mono of Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Hoe ODS-bestanden te beschermen met C#" %}}
...
1.  Werkboekklasse instantiëren met pad naar bestand ODS
