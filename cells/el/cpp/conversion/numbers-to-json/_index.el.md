---
title: Μετατροπή NUMBERS σε JSON μέσω της εφαρμογής C++ 
url: /el/cpp/conversion/numbers-to-json/ 
description: Δείγμα κώδικα μετατροπής C++ για έγγραφο NUMBERS σε μορφή JSON. Οι προγραμματιστές μπορούν να χρησιμοποιήσουν αυτόν τον πηγαίο κώδικα για μετατροπή δέσμης NUMBERS σε JSON σε οποιαδήποτε εφαρμογή C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή NUMBERS σε JSON μέσω C++" h2="Μετατροπή NUMBERS σε JSON υψηλής απόδοσης με χρήση βιβλιοθήκης C++ χωρίς την ανάγκη εγκατάστασης Microsoft Excel, OpenOffice ή Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε τους αριθμούς σε JSON χρησιμοποιώντας το C++" %}}
 ...
 Για να μετατρέψουμε NUMBERS σε JSON, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές του C++ μπορούν εύκολα να μετατρέψουν NUMBERS αρχείο σε JSON σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φορτώστε το αρχείο NUMBERS χρησιμοποιώντας το Factory::CreateIWorkbook.1. Καλέστε τη μέθοδο Save().1. Περάστε τη διαδρομή του αρχείου εξόδου με επέκταση αρχείου (JSON).1. Το αρχείο JSON θα αποθηκευτεί στην καθορισμένη διαδρομή.1. Ανοίξτε το αρχείο JSON σε συμβατό πρόγραμμα.
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής NUMBERS σε JSON C++" offSpacer="" %}}

```cs
// Φορτώστε τους ΑΡΙΘΜΟΥΣ.
