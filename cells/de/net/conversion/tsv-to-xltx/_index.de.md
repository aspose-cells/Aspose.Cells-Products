...
{{% blocks/products/pf/agp/content h2="Speichern Sie TSV bis XLTX in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie TSV in XLTX in C# konvertiert wird.
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Online-Konvertieren von TSV in XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xltx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie TSV über C# in XLTX" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können TSV in nur wenigen Codezeilen problemlos laden und in XLTX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1.  Laden Sie die Datei TSV mit einer Instanz von Workbook
1.  Konvertieren Sie TSV in XLTX, indem Sie die Workbook.Save-Methode aufrufen

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von TSV in XLTX" %}}
