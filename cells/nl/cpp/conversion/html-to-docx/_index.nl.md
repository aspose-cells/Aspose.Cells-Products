...
description: Aspose Excel. Deze uitgebreide oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van gegevens van het formaat HTML naar DOCX, waardoor naadloos opslaan van gegevens in het formaat HTML mogelijk is met behulp van de bibliotheek Aspose.Cells, allemaal via efficiënte en aanpasbare code C++.
...
{{% blocks/products/pf/agp/content h2="Sla HTML op in DOCX in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar DOCX in C++.
...
Moet je bestanden met de extensie HTML programmatisch converteren naar DOCX? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar DOCX met slechts een paar regels code.
