...
description: Aspose Эксель. Python Эксель. Объедините файлы FODS и JPEG в формате сохранения. Python Объедините форматы FODS и JPEG. Объедините числа FODS и JPEG в библиотеке Excel Python. FODS Слияние.
...
{{% blocks/products/pf/agp/content h2="Объедините числа FODS и JPEG с помощью библиотеки Excel Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объединить числа FODS и JPEG в библиотеке Excel Python." %}}

В следующем примере показано, как объединить FODS с JPEG в Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Пример кода для объединения чисел FODS и JPEG в библиотеке Excel Python" InputFormat="fods" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Как объединить FODS с JPEG через библиотеку Excel Python" %}}
