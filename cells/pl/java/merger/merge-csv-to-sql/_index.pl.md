---
title: Połącz CSV z SQL - Połącz CSV z SQL w Java
url: /pl/java/merger/merge-csv-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online CSV do formatu zapisu SQL. Java Połącz CSV z formatem SQL. Scal CSV do SQL w Java. CSV Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz CSV z SQL w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić CSV z SQL w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić CSV z SQL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SQL. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy CSV z SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z SQL w Java" InputFormat="csv" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić CSV z SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić CSV z SQL? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do scalania CSV z SQL" %}}
