---
title: C# FODS 转 DOCX - 在线 FODS 转 DOCX 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 FODS 转换为 DOCX 保存格式。 C# FODS 到 DOCX 格式。将 FODS 保存为 DOCX C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 FODS 转换为 C# 中的 DOCX" h2="高速C#库，用于将FODS转换为DOCX。这是一个专业的软件解决方案，可在.NET Framework、.NET Core或Mono平台上导入和导出FODS、DOCX和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="免费在线保存 FODS 至 DOCX 于 C#" %}}

以下示例演示如何将 C# 中的 FODS 转换为 DOCX。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 FODS 转换为 DOCX。上传您的 FODS 文件，然后只需将其另存为 DOCX 文件。对于 FODS 读取和 DOCX 写入，您可以使用完全限定的文件名。输出 DOCX 内容和格式将与原始 FODS 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免费应用程序和示例代码可在线将 FODS 转换为 DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 FODS 转换为 DOCX" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 FODS 文件转换为 DOCX 吗？ .NET 开发人员只需几行代码即可轻松加载和转换 FODS 到 DOCX。
...
{{% blocks/products/pf/agp/content h2="C#库将FODS转换为DOCX" %}}
