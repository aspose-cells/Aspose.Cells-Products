...
weight: 1340
description: Código-fonte C# para dividir documentos XLS em plataformas .NET Framework, .NET Core, Mono ou Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Dividir formatos XLS em C#" h2="Divisor XLS nativo e de alto desempenho usando APIs server-side, sem o uso de nenhum software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
+ Chame o método Save() e passe como parâmetro o nome do arquivo (caminho completo) e SaveFormat.Xls.
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos Excel Microsoft em diferentes formatos. Além disso, pode ser usado para gráficos abrangentes, relatórios escalonáveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API independente e não requer nenhum software como Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo online do XLS Splitter" sectionDescription=" Divida o documento XLS agora mesmo visitando nosso[Site de demonstrações ao vivo](https://products.aspose.app/cells/splitter). A demonstração ao vivo tem os seguintes benefícios" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Basta enviar seu arquivo XLS e ele será dividido instantaneamente." >}}
