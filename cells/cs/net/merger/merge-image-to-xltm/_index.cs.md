...
url: /cs/net/merger/merge-image-to-xltm/ 
...
Následující příklad ukazuje, jak sloučit IMAGE s XLTM v Aspose.Cells for .NET.
...
Potřebujete sloučit IMAGE s XLTM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení IMAGE do XLTM" %}}
