---
title: Inserisci commenti al file XLS via .NET
url: /it/net/comments/insert-comments-to-xls/ 
description: Inserisci commenti a XLS utilizzando C#. Utilizza il codice di esempio API per inserire commenti all'interno dell'applicazione .NET.
...
In Office 365, i commenti sono per le conversazioni, puoi utilizzare il seguente codice C# per inserire e rimuovere commenti nel file XLS.

{{% blocks/products/pf/agp/code-block title="Codice di esempio C# per inserire e rimuovere commenti nel file XLS" offSpacer="" %}}
