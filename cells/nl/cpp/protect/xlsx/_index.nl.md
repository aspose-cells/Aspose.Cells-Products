---
title:  Document XLSX beveiligen en vergrendelen via C++
weight: 1140
description: C++ voorbeeldcode om bestand XLSX te vergrendelen met wachtwoord op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
...
{{% blocks/products/pf/agp/content h2="Hoe u het XLSX-bestand kunt beveiligen met behulp van C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLSX-bestanden te beveiligen via C++" %}}
...
1.  Sla het beveiligde bestand XLSX op met de Save()-methode
