---
title: OTS'yi PRN'ye Birleştirme - Java'de OTS'yi PRN'ye Birleştirme
url: /tr/java/merger/merge-ots-to-prn/ 
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi OTS'yi PRN kaydetme biçimine birleştirme. Java OTS'yi PRN biçimiyle birleştirin. Java'de OTS'yi PRN ile birleştirin. OTS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="OTS ile PRN\'yi Java Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de OTS ile PRN'nin nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

OTS'yi PRN'ye birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından PRN dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. OTS'yi PRN ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java\'de OTS\'yi PRN ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="ots" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi PRN via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

OTS'yi programlı olarak PRN ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
