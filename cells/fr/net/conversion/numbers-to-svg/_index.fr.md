---
title: C# NOMBRES en SVG - Convertisseur NOMBRES en SVG
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les NUMBERS au format SVG, permettant un enregistrement transparent des données NUMBERS au format SVG à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros SVG dans C#" %}}

L'exemple suivant montre comment convertir les NOMBRES de SVG en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir NUMBERS en SVG. Téléchargez votre fichier NUMBERS, puis enregistrez-le simplement sous le nom de fichier SVG. Pour la lecture de NUMBERS et l'écriture de SVG, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie SVG seront identiques au document NUMBERS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir des NOMBRES en SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en SVG par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en SVG en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en SVG en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en SVG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en SVG" %}}
