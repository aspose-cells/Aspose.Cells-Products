...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in TXT in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar TXT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar TXT of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar TXT? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar TXT met slechts een paar regels code.
