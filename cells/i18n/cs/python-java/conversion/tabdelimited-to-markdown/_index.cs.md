...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na MARKDOWN pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na MARKDOWN prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory TABDELIMITED na MARKDOWN pomocí několika řádků kódu.
