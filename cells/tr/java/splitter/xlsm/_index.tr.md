---
title:  Böl XLSM Dosyalar via Java
weight: 5670
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment üzerinde XLSM belgesini bölmek için Java örnek kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Böl XLSM Dosyalar via Java" h2="XLSM sunucu tarafı Java kitaplığı yardımıyla bölme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM Dosyalarını Java\'de Bölme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="Böl XLSM Dosya - Java" offSpacer="" %}}
