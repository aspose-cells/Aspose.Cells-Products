...
url: /tr/python-net/merger/merge-sxc-to-xml/ 
...
Aşağıdaki örnek, SXC'in Aspose.Cells for Python via .NET'deki XML ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 SXC'i XML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
