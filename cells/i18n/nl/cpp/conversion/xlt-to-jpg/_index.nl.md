---
title: Converteer XLT naar JPG via C++ applicatie 
url: /nl/cpp/conversion/xlt-to-jpg/ 
description: Voorbeeld C++-conversiecode voor XLT-document naar JPG-indeling. Programmeurs kunnen deze broncode gebruiken voor batch-XLT-naar-JPG-conversie binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLT naar JPG via C++" h2="Hoogwaardige XLT-naar-JPG-conversie met behulp van de C++-bibliotheek zonder de noodzaak van Microsoft Excel, OpenOffice of Adobe Acrobat-installatie." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen XLT-bestanden gemakkelijk converteren naar JPG in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad XLT-bestand met behulp van Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (JPG) bestandsextensie.1. JPG-bestand wordt opgeslagen op het opgegeven pad.1. Open het JPG-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="XLT naar JPG C++ Conversiebroncode" offSpacer="" %}}
