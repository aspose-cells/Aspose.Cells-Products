---
title: PHP EXCEL en XPS - Convertisseur EXCEL en XPS
description: Aspose Exceller. Convertissez EXCEL en XPS rapidement et facilement avec Aspose.Cells. PHP EXCEL en XPS. PHP Enregistrez EXCEL en XPS. Enregistrez EXCEL sous XPS en utilisant PHP.
...
{{% cells-convert title="Exemple de code pour convertir EXCEL en XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xps" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en XPS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en XPS par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en XPS en quelques lignes de code.
...
1.  Convertissez EXCEL en XPS en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en XPS" %}}
