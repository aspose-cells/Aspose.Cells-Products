...
هل تحتاج إلى تحويل ملفات MHT إلى BMP برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى BMP بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى BMP عن طريق استدعاء دالة Save().
