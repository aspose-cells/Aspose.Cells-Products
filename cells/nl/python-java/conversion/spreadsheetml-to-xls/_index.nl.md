---
title: Python SPREADSHEETML naar XLS - Online SPREADSHEETML naar XLS Converter
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Gratis online Python Converteer SPREADSHEETML naar XLS saveformat. Python SPREADSHEETML naar XLS formaat. Sla SPREADSHEETML op in XLS Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer SPREADSHEETML naar XLS in Python" h2="High-speed Python-bibliotheek voor het converteren van SPREADSHEETML naar XLS. Dit is een professionele softwareoplossing voor het importeren en exporteren van SPREADSHEETML, XLS en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML naar XLS te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u SPREADSHEETML-bestanden programmatisch converteren naar XLS? Python-ontwikkelaars kunnen SPREADSHEETML eenvoudig laden en converteren naar XLS in slechts een paar regels code.
...
1.  Converteer SPREADSHEETML naar XLS door de methode Workbook.save aan te roepen.
1.  Verkrijg het conversieresultaat van SPREADSHEETML naar XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python bibliotheek om SPREADSHEETML naar XLS te converteren" %}}
