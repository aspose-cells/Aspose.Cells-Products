---
title: 透過 C++ 保護和鎖定 XLS 文檔
weight: 8760
description: 在 C++ 執行環境（適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元）上使用密碼鎖定 XLS 檔案的 C++ 範例程式碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 加密 XLS 文件" h2="使用 .NET 庫對 Excel 電子表格進行密碼保護，包括 XLS 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 保護 XLS 文件的步驟" %}}
