...
description: Aspose Эксель. C++ Создайте файл EMF быстро и легко с помощью Aspose.Cells. Создайте файл EMF с помощью C++. Создайте EMF в C++. C++ EMF Creater.
...
1. Сохраните книгу как файл .emf, используя метод Save().
