...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل XLSX إلى مصفوفة بايت عبر C#" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية هذا XLSX لتحويل مصفوفة البايت C#" offSpacer="" %}}
