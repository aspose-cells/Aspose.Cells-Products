---
title:  C++ numaralı belgeyi açmadan CSV numaralı belgeyi arayın.
weight: 5540
description: C++ numaralı örnek kod, CSV dosyasındaki kelimeleri C++ çalışma ortamında, Windows 32 bit, Windows 64 bit ve Linux 64 bit işletim sistemlerinde belirli bir desenle aramak için kullanılır.
...
{{< blocks/products/pf/i18n/upper-banner h1="C++ içinde CSV biçimlerini arayın" h2="Sunucu tarafı API\'lerini kullanarak, Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan, yerel ve yüksek performanslı CSV belge araması." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="C++ kullanarak CSV dosyasını nasıl arayabilirsiniz?" %}}

 CSV dosyasını aramak için şunu kullanacağız:
...
{{% blocks/products/pf/agp/feature-section-col title="C++ numaralı bölgede CSV numaralı dosyaları arama adımları" %}}
...
+ Workbook sınıfını kullanarak CSV dosyasını yükleyin.
...
{{% blocks/products/pf/agp/code-block title="CSV Dosyasını Ara - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi CSV Canlı Demoları Ara" sectionDescription=" Hemen şimdi sitemizi ziyaret ederek CSV numaralı belgeler içindeki metinleri, kelimeleri ve kelime öbeklerini arayın.[Canlı Demolar web sitesi](https://products.aspose.app/cells/search). Canlı demo aşağıdaki avantajlara sahiptir" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API\'i indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="CSV numaralı dosyalarınızı yüklemeniz yeterli." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" Arama sonucu anında görünür." >}}
    {{< /blocks/products/pf/agp/demobox >}}

    {{< blocks/products/pf/agp/i18n/about-file-text fileFormat="CSV " readMoreLink="https://docs.fileformat.com/spreadsheet/csv/" >}}
 CSV (Virgülle Ayrılmış Değerler) uzantılı dosyalar, virgülle ayrılmış değerlere sahip veri kayıtları içeren düz metin dosyalarını temsil eder. CSV dosyasındaki her satır, dosyada bulunan kayıt kümesinden yeni bir kayıttır. Bu tür dosyalar, verilerin bir depolama sisteminden diğerine aktarılması amaçlandığında oluşturulur. Tüm uygulamalar virgülle ayrılmış kayıtları tanıyabildiğinden, bu tür veri dosyalarının veritabanına aktarılması çok kolaydır. Excel veya OpenOffice Calc gibi hemen hemen tüm elektronik tablo uygulamaları, CSV dosyalarını fazla çaba harcamadan içe aktarabilir. Bu tür dosyalardan içe aktarılan veriler, kullanıcıya sunulmak üzere elektronik tablonun hücrelerine yerleştirilir.
