---
title:  Συγχώνευση XLS σε XLSX μέσω Python
url: /el/python-net/merger/merge-xls-to-xlsx/ 
description: Συγχώνευση XLS σε XLSX Online δωρεάν. Δωρεάν Online XLS έως XLSX Συγχώνευση. Συγχώνευση XLS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLS με το XLSX στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLS με XLSX σε απευθείας σύνδεση" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
