...
{{% cells-convert title="Beispielcode zum Konvertieren von HTM in PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="prn" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie HTM über C++ in PRN" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM-Dateien programmgesteuert in PRN konvertieren? C++-Entwickler können HTM in nur wenigen Codezeilen problemlos in PRN konvertieren.
...
1. Konvertieren Sie HTM in PRN, indem Sie die Save()-Methode aufrufen.
