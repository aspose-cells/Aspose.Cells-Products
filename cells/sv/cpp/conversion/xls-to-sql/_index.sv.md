...
description: Aspose Excel. Denna omfattande lösning ger C++-utvecklare en helt integrerad metod för att konvertera XLS till SQL-format, vilket möjliggör sömlös sparning av XLS-data till SQL-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C++-kod.
...
{{% blocks/products/pf/agp/content h2="Konvertera XLS till SQL med hjälp av C++" %}}
...
Behöver du konvertera XLS-filer till SQL programmatiskt? C++-utvecklare kan enkelt konvertera XLS till SQL med bara några få rader kod.
...
1.  Konvertera XLS till SQL genom att anropa Save()-metoden.
