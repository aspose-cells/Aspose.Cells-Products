---
title: Převést TSV na MHTML prostřednictvím C#
url: /cs/net/conversion/tsv-to-mhtml/
description: Ukázkový kód pro konverzi tsv na mhtml C#. Použijte API ukázkový kód pro dávkový převod souborů tsv na mhtml v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři .NET mohou snadno načíst a převést soubory TSV do MHTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí sešitu1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s příponou MHTML jako parametr1. Zkontrolujte zadanou cestu pro výsledný soubor MHTML
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod TSV na MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="mhtml" IsLandingPage="true" %}}
