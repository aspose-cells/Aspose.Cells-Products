...
Trzeba programowo przekonwertować pliki MHTML do formatu HTM? Programiści C++ mogą łatwo przekonwertować pliki MHTML do formatu HTM za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj MHTML do HTM wywołując metodę Save().
