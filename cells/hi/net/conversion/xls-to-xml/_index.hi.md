---
title: C# XLS से एक्सएमएल - XLS से एक्सएमएल कन्वर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ XLS को जल्दी और आसानी से XML में बदलें। C# XLS को XML में बदलें। C# XLS को XML में सहेजें। C# का उपयोग करके XLS को एक्सएमएल के रूप में सहेजें।
...
{{< blocks/products/pf/i18n/upper-banner h1="XLS को C# में एक्सएमएल में कनवर्ट करें" h2="XLS को XML में परिवर्तित करने के लिए हाई-स्पीड C# लाइब्रेरी। यह .NET फ्रेमवर्क, .NET कोर या Mono प्लेटफॉर्म पर XLS, एक्सएमएल और कई अन्य प्रारूपों को आयात और निर्यात करने के लिए एक पेशेवर सॉफ्टवेयर समाधान है।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
निम्नलिखित उदाहरण दर्शाता है कि C# में XLS को XML में कैसे परिवर्तित किया जाए।
{{% blocks/products/pf/agp/text %}}

XLS को XML में कनवर्ट करने के लिए आसान चरणों का पालन करें। अपनी XLS फ़ाइल अपलोड करें, फिर इसे XML फ़ाइल के रूप में सहेजें। XLS पढ़ने और एक्सएमएल लेखन दोनों के लिए आप पूरी तरह से योग्य फ़ाइल नामों का उपयोग कर सकते हैं। आउटपुट XML सामग्री और फ़ॉर्मेटिंग मूल XLS दस्तावेज़ के समान होगी।

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="XLS को एक्सएमएल में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="XLS को C# के माध्यम से एक्सएमएल में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

XLS फ़ाइलों को प्रोग्रामेटिक रूप से XML में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में XLS को आसानी से XML में लोड और परिवर्तित कर सकते हैं।
...
1.  Workbook.Save विधि को कॉल करके XLS को XML में कनवर्ट करें।
