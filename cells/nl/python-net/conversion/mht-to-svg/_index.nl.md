...
description: Aspose Excel. Converteer MHT snel en eenvoudig naar SVG met Aspose.Cells. Python MHT naar SVG. Python Bewaar MHT naar SVG. Sla MHT op als SVG met Python.
...
{{% blocks/products/pf/agp/content h2="Converteer MHT naar SVG in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar MHT op SVG in Python" %}}

Het volgende voorbeeld laat zien hoe u MHT converteert naar SVG in Python via NET.
...
{{% cells-convert title="Voorbeeldcode om MHT naar SVG te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="svg" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om MHT naar SVG te converteren" %}}
