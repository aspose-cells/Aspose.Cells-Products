...
description: Aspose Excel. C# Aspose.Cells. Voeg XLSX samen met het opslagformaat TIFF. C# Combineer het formaat XLSX met TIFF. Voeg XLSX samen met TIFF in C#. XLSX Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u XLSX samenvoegt met TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met TIFF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLSX samen te voegen met TIFF" %}}
