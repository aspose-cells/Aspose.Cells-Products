---
title:  دمج الأرقام في HTML via Java
...
يوضح المثال التالي كيفية دمج الأرقام مع HTML في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج الأرقام في HTML على الإنترنت" InputFormat="numbers" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
