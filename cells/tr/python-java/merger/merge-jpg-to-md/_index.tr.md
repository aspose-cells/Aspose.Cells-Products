...
url: /tr/python-java/merger/merge-jpg-to-md/ 
...
Aşağıdaki örnek, Aspose.Cells for Python via Java'de JPG'nin MD ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 JPG'yi programlı olarak MD ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
