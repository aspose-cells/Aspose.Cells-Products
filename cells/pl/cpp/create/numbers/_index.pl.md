---
title: Utwórz NUMERY - utwórz plik NUMBERS w C++
description:  Aspose Excel. C++ Szybko i łatwo utwórz plik NUMBERS za pomocą Aspose.Cells. Wygeneruj plik NUMBERS za pomocą C++. Utwórz NUMBERS w C++. C++ Kreator NUMBERS.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć LICZBY w C++" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści mogą z łatwością tworzyć, ładować, modyfikować i konwertować pliki NUMBERS w ramach uruchomionych aplikacji raportujących do przetwarzania danych w zaledwie kilku wierszach kodu.
...
1.  Zapisz skoroszyt jako plik .numbers, korzystając z metody Save().
