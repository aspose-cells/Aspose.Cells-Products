---
title: Gabung XLS ke MD - Gabungkan XLS ke MD di C++
url: /id/cpp/merger/merge-xls-to-md/ 
description: Aspose Unggul. C++ Aspose.Cells. Free Online Merge XLS to MD saveformat. C++ Gabungkan XLS ke format MD. Gabung XLS menjadi MD di C++. XLS Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLS ke MD di C++ Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan XLS ke MD di Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLS ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di C++, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C++ yang menggabungkan XLS ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLS ke MD secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
