---
title: Créer JPG - Créer un fichier JPG au C++
description: Aspose Excel. C++ Créer un fichier JPG. Créer JPG C++. C++ JPG Creator. Créez un JPG en C++. Générez un fichier JPG en utilisant C++.
keywords: [Aspose Excel., C++ Aspose.Cells., Create JPG C++., C++ JPG Creater., Create JPG file in C++., Generate JPG file in C++]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier JPG au C++" h2="Création de fichiers JPG natifs et hautes performances par programmation sans Micorsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer un JPG en C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers JPG dans des applications de création de rapports en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
1.  Enregistrez le classeur en tant que fichier .jpg à l'aide de la méthode Save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier JPG en C++." offSpacer="" %}}
...
wkb->Save(new String("created_one.jpg"));
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour créer un fichier JPG" %}}
