...
{{% blocks/products/pf/agp/content h2="Sla HTML op in PNG in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar PNG in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar PNG of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar PNG? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar PNG met slechts een paar regels code.
