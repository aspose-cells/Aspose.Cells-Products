---
title: Gabungkan JPG ke ET - Gabungkan JPG ke ET di Java
url: /id/java/merger/merge-jpg-to-et/ 
description: Aspose Unggul. Java Aspose.Cells. Online Gratis Menggabungkan JPG ke ET saveformat. Java Gabungkan format JPG ke ET. Gabung JPG ke ET di Java. Gabung JPG.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPG ke ET di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan JPG ke ET di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk menggabungkan JPG ke ET. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ET. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan JPG ke ET.
...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JPG ke ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan JPG ke ET secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk menggabungkan JPG ke ET" %}}
