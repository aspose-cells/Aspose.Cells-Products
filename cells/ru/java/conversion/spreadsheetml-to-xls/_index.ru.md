...
{{% blocks/products/pf/agp/content h2="Как преобразовать SPREADSHEETML в XLS с помощью Java" %}}

 Чтобы преобразовать SPREADSHETML в XLS, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию SPREADSHETML в XLS через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Java могут легко преобразовать файл SPREADSHEETML в XLS, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл SPREADSHEETML с экземпляром класса Workbook1. Вызов метода Workbook.save1. Передайте выходной путь с расширением XLS и SaveFormat в качестве параметров1. Проверить указанный путь для результирующего файла XLS
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования SPREADSHEETML в XLS Java" offSpacer="" %}}

```cs
// загрузить файл SPREADSHEETML в экземпляр Workbook
Workbook book = new Workbook("template.spreadsheetml");
// сохранить SPREADSHETML как XLS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Преобразование SPREADSHEETML в XLS в реальном времени" sectionDescription="[Конвертировать SPREADSHEETML в XLS](https://products.aspose.app/cells/conversion/spreadsheetml-to-xls) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Нет необходимости загружать Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать какой-либо код." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл SPREADSHEETML, и он будет мгновенно преобразован в XLS." >}}
