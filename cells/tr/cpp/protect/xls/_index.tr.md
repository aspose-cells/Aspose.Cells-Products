---
title: C++ aracılığıyla XLS belgesini koruyun ve kilitleyin 
weight: 8760
url: /tr/cpp/protect/xls/ 
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Runtime Environment üzerinde şifre kullanarak XLS dosyasını kilitlemek için örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS Dosyalarını C++ aracılığıyla şifreleyin" h2=".NET Kitaplığı kullanarak XLS biçimi de dahil olmak üzere Excel elektronik tablolarını parolayla koruyun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanılarak XLS Dosyasının Güvenliği Nasıl Sağlanır" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ üzerinden XLS Dosyalarını Koruma Adımları" %}}
...
1. IWorkbook sınıfını kullanarak XLS dosyasını yükleyin1. ProtectionType ve Password ile Protect(..) yöntemini kullanın1. Korumalı XLS dosyasını Save() yöntemiyle kaydedin
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="XLS\'yi Korumak için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [XLS dosyalarını şifrelemek](https://products.aspose.app/cells/protect/xls) aşağıdaki faydaları ile." >}}
