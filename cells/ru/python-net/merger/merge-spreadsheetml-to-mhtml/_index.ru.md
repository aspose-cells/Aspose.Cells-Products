---
title:  Объединить SPREADSHETML в MHTML через Python
...
В следующем примере показано, как объединить SPREADSHEETML с MHTML в Python.
