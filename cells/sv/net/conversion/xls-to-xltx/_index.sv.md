---
title: C# XLS till XLTX - XLS till XLTX Omvandlare
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till XLTX-format, vilket möjliggör sömlös sparning av XLS-data till XLTX-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till XLTX i C#" %}}

Följande exempel visar hur man konverterar XLS till XLTX i C#.
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till XLTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till XLTX programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till XLTX på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C#-biblioteket för att konvertera XLS till XLTX" %}}
