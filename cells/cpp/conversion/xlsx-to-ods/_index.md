...
description: Sample C++ conversion code for XLSX document to ODS format. Programmers can use this source code for batch XLSX to ODS conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells API makes it easy for the developers to convert XLSX file to ODS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="XLSX to ODS C++ Conversion Source Code" offSpacer="" %}}
