...
description: Aspose Excel. Java Aspose.Cells. Sloučit XML do formátu uložení XPS. Java Zkombinujte XML do formátu XPS. Sloučit XML na XPS v Java. Sloučit XML.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML na XPS v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XML do XPS v Java" InputFormat="xml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
