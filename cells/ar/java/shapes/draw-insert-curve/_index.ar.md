...
weight: 30
description: رسم أو إدراج شكل منحني باستخدام Aspose.Cells' Java API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF وغيرها.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شكل منحني في ملف إكسل باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج شكل منحني في ملف اكسيل via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) لإدراج شكل منحني في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج شكل منحني - Java" offSpacer="" %}}
