---
title: ET maken - ET-bestand maken in Python
description: Aspose Excel. Python ET-bestand maken. Maak ET Python. Python ET Creator. Maak ET in Python. Genereer ET-bestand met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een ET-bestand in Python" h2="High-speed Python-bibliotheek voor het maken van ET-bestanden. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  Gebruik de methode Save om de werkmap op te slaan als ET-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een ET-bestand maakt in Python." offSpacer="" %}}
