...
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してXLSXメタデータを抽出します" h2="サーバー側のAPIを使用して、XLSXファイルからメタデータを追加、編集、削除、または抽出するための独自のJavaアプリを作成します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してXLSXメタデータを抽出する方法" %}}

 XLSXファイルのメタデータを取得するには、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してXLSXのメタデータを抽出する手順" %}}
...
+WorkbookMetadata内にXLSXファイルをロードします
...
{{% blocks/products/pf/agp/code-block title="XLSXのメタデータを抽出する-Java" offSpacer="" %}}
