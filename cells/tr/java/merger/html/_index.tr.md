...
{{< blocks/products/pf/i18n/upper-banner h1="Java içindeki HTML Biçimlerini Birleştir" h2="Sunucu tarafı Java API\'lerini kullanan yerel HTML belgesi birleştirme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak HTML Dosyalarını Birleştirme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java İçindeki HTML Dosyalarını Birleştirme Adımları" %}}
...
+ İlk HTML dosyasını Workbook sınıfının bir örneğiyle yükleyin.
+ İkinci HTML belgesini Workbook sınıfının bir örneğiyle yükleyin.
+ Combine() yöntemini kullanarak dosyaları birleştirin.
+ birleştirilmiş HTML dosyasını belirtilen yola kaydedin
