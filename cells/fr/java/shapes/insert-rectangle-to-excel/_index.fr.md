...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer le rectangle dans le fichier Excel via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addRectangle-int-int-int-int-int-int-) pour insérer Rectangle dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer Rectangle - Java" offSpacer="" %}}
