---
title: รวม NUMBERS เป็น SXC - รวม NUMBERS เป็น SXC เป็น Java
url: /th/java/merger/merge-numbers-to-sxc/ 
description: Aspose เก่ง. Java Aspose.Cells รวมหมายเลขออนไลน์ฟรีเป็น SXC บันทึกรูปแบบ Java รวมรูปแบบ NUMBERS เป็น SXC รวม NUMBERS เป็น SXC ใน Java NUMBERS Merge
...
{{% blocks/products/pf/agp/content h2="รวม NUMBERS เป็น SXC ใน Java ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีรวม NUMBERS เป็น SXC ใน Aspose.Cells for Java
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม NUMBERS เป็น SXC อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine สำหรับการรวมไฟล์ จากนั้นบันทึกลงในไฟล์ SXC หากคุณพัฒนาโค้ดใน Java สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง Java ที่รวม NUMBERS เป็น SXC

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ออนไลน์ฟรีเพื่อรวมหมายเลขเป็น SXC ใน Java" InputFormat="numbers" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="วิธีผสานตัวเลขเป็น SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม NUMBERS เป็น SXC โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for Java](https://products.aspose.com/cells/java) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี Java เพื่อรวม NUMBERS เป็น SXC" %}}
