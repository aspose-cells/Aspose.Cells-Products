---
title: Java XLSB à JSON - Convertisseur en ligne XLSB à JSON
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XLSB en format de sauvegarde JSON. Format Java XLSB à JSON. Enregistrez XLSB à JSON Java.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en JSON en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en JSON par programmation ? Les développeurs de Java peuvent facilement convertir XLSB en JSON en seulement quelques lignes de code.
...
1.  Convertissez XLSB en JSON en appelant la méthode Workbook.save.
