...
Нужно программно преобразовать файлы XML в XLTX? Разработчики C++ могут легко преобразовать XML в XLTX всего за несколько строк кода.
...
1.  Преобразуйте XML в XLTX, вызвав метод Save().
