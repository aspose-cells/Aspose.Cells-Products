...
description: Aspose Excel. Python Criar JPEG Arquivo. Criar JPEG Python. Python JPEG Criador. Crie JPEG em Python. Gere o arquivo JPEG usando Python.
...
1. Use o método Save para salvar a pasta de trabalho como arquivo JPEG.

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo JPEG em Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python biblioteca para criar o arquivo JPEG" %}}
