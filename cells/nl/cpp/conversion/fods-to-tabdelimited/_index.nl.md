...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-ontwikkelaars kunnen FODS gemakkelijk converteren naar TABDELIMITED in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het bestand FODS met Factory::CreateIWorkbook.
1. Converteer FODS naar TABDELIMITED door de methode Save() aan te roepen.
