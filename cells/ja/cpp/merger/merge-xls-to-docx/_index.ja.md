...
次の例は、XLS を Aspose.Cells for C++ の DOCX にマージする方法を示しています。
...
XLS をプログラムで DOCX にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
