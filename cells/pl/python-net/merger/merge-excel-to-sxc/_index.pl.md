...
url: /pl/python-net/merger/merge-excel-to-sxc/ 
...
Poniższy przykład pokazuje, jak połączyć EXCEL z SXC w Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć EXCEL z SXC? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
