...
{{% blocks/products/pf/agp/content h2="Python Excel Kitaplığını Kullanarak XLTM\'i MARKDOWN\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/content h2="XLTM\'i MARKDOWN\'e Python Excel Kitaplığı\'na kaydedin" %}}

Aşağıdaki örnek, XLTM excel kitaplığında XLTM'in MARKDOWN'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="Python XLTM\'i MARKDOWN\'e Dönüştürmek için Excel Kitaplığı" %}}
