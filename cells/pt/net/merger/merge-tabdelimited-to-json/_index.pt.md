---
title: Mesclar TABDELIMITED para JSON - Combinar TABDELIMITED para JSON em C#
url: /pt/net/merger/merge-tabdelimited-to-json/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita TABDELIMITED para JSON saveformat. C# Combine TABDELIMITED para o formato JSON. Mesclar TABDELIMITED para JSON em C#. TABDELIMITED Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar TABDELIMITED para JSON em C# online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar TABDELIMITED com JSON em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar TABDELIMITED para JSON. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo JSON. Se você desenvolver o código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla TABDELIMITED com JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar TABDELIMITED para JSON em C#" InputFormat="tsv" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar TABDELIMITED para JSON via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar TABDELIMITED para JSON programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar TABDELIMITED a JSON" %}}
