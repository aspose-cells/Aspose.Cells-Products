---
title:  Samenvoegen CSV naar JSON via Python
url: /nl/python-java/merger/merge-csv-to-json/ 
description: Samenvoegen CSV naar JSON Online gratis. Gratis online CSV tot JSON Fusie. Voeg CSV samen met Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS en meer.
---
...
Het volgende voorbeeld laat zien hoe u CSV samenvoegt met JSON in Python.
...
{{% cells-merger title="Gratis app om CSV online samen te voegen tot JSON" InputFormat="csv" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
