---
title: "Konvertálja az XLSM-et XLSB-vé a következőn keresztül: Java "
weight: 8670
url: /hu/java/conversion/xlsm-to-xlsb/ 
description: Minta Java konverziós kód az XLSM formátumhoz XLSB fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok XLSB formátumba exportálására bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja az XLSM-et XLSB-vé a következőn keresztül: Java" h2="XLSM-ből XLSB-vé Java konverzió, amellyel egyetlen vagy több oldalt konvertálhat XLSB-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Az XLSM konvertálása XLSB-re a következővel: Java" %}}

 Ahhoz, hogy az XLSM-et XLSB-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM XLSB-vé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak XLSM fájlt XLSB formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSM-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLSB kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLSB fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLSM-ből XLSB-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLSM fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xlsm");
// mentse az XLSM-et XLSB-ként
