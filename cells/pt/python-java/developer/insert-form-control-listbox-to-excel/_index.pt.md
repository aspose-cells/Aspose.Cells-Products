---
title:  Inserir ListBox (controle de formulário) no Excel usando Python via java
weight: 50
description: Python via código-fonte java para inserir ListBox (controle de formulário) no Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserir ListBox (controle de formulário) no Excel usando Python via java" h2="Insira objetos usando APIs do lado do servidor sem nenhum software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir ListBox (controle de formulário) no arquivo Excel usando Python via java" %}}

 Para inserir ListBox (controle de formulário) no arquivo Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir ListBox (controle de formulário) no arquivo Excel usando Python via java" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use a coleção de formas[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addListBox(int,%20int,%20int,%20int,%20int,%20int)) para inserir um ListBox(controle de formulário) na planilha selecionada.
...
{{% blocks/products/pf/agp/code-block title="Inserir ListBox (controle de formulário) - Python via java" offSpacer="" %}}
