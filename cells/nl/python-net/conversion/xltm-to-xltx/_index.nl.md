...
description: Aspose Excel. Converteer XLTM snel en eenvoudig naar XLTX met Aspose.Cells. Python XLTM naar XLTX. Python Bewaar XLTM in XLTX. Bewaar XLTM als 07611134 81 via Python.
...
{{% blocks/products/pf/agp/content h2="Converteer XLTM naar XLTX in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLTM t/m XLTX in Python" %}}

Het volgende voorbeeld laat zien hoe u XLTM converteert naar XLTX in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLTM naar XLTX te converteren" %}}
