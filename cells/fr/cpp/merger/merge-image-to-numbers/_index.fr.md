---
title: Fusionner IMAGE avec NUMBERS - Combiner IMAGE avec NUMBERS en C++
url: /fr/cpp/merger/merge-image-to-numbers/ 
description: Aspose Excel. C++ Aspose.Cells. Format de sauvegarde IMAGE en NUMBERS en ligne gratuit. C++ Combinez le format IMAGE au format NUMBERS. Fusionner IMAGE avec NUMBERS dans C++. Fusionner IMAGE.
...
{{% blocks/products/pf/agp/content h2="Fusionner IMAGE avec NUMBERS en C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner IMAGE avec NUMBERS dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner IMAGE avec NUMBERS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier NUMBERS. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne IMAGE avec NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner IMAGE avec NUMBERS en C++" InputFormat="png" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner IMAGE avec NUMBERS via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner IMAGE avec NUMBERS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner IMAGE avec NUMBERS" %}}
