...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHT 轉換為 TABDELIMITED。C# MHT 轉換為 TABDELIMITED。 C# 將 MHT 儲存到製表符。使用 C# 將 MHT 儲存為 TABDELIMITED。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 MHT 轉換為 TABDELIMITED C#" h2="用於將 MHT 轉換為 TABDELIMITED 的高速 C# 庫。這是一款專業的軟體解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 MHT、TABDELIMITED 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="將 MHT 儲存為 TABDELIMITED 格式：C#" %}}

以下範例示範如何將 C# 中的 MHT 轉換為 TABDELIMITED。
...
{{% cells-convert title="將 MHT 轉換為 TABDELIMITED 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="tsv" IsLandingPage="true" %}}
...
1. 透過呼叫 Workbook.Save 方法將 MHT 轉換為 TABDELIMITED。
1. 取得 MHT 到 TABDELIMITED 的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 將 MHT 轉換為 TABDELIMITED 的庫" %}}
