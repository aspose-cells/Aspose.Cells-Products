---
title: إصلاح ملف xls عبر Python
url: /ar/python-net/recovery/repair-xls/ 
description: قم بإصلاح ملف xls التالف باستخدام Python. أداة الاسترداد لإصلاح ملف xls التالف داخل تطبيق Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="استرجع XLS الملف عبر Python" h2="قم ببناء تطبيق Python الخاص بك لإصلاح ملفات xls باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إصلاح ملف xls باستخدام Python" %}}
...
{{% cells-recovery title="تطبيق مجاني لإصلاح ملف XLS باستخدام Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="pythonnet" %}}    
