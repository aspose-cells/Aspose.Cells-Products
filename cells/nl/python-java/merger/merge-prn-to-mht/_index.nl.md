...
url: /nl/python-java/merger/merge-prn-to-mht/ 
...
In het volgende voorbeeld ziet u hoe u PRN kunt samenvoegen met MHT in Aspose.Cells for Python via Java.
...
Wilt u PRN programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
