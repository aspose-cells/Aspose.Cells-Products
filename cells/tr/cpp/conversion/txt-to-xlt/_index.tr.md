---
title: C++ uygulaması aracılığıyla TXT'yi XLT'ye dönüştürün 
url: /tr/cpp/conversion/txt-to-xlt/ 
description: TXT belgesi için XLT biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu TXT'den XLT'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla TXT\'yi XLT\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı TXT\'den XLT\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, yalnızca birkaç kod satırıyla TXT dosyasını XLT'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak TXT dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (XLT) dosya uzantısıyla iletin.1. XLT dosyası belirtilen yola kaydedilecektir.1. XLT dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="TXT - XLT C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT\'den XLT\'ye Dönüşüm Canlı Demoları" sectionDescription="[TXT\'den XLT\'ye dönüştürücü](https://products.aspose.app/cells/conversion/txt-to-xlt) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece TXT dosyanızı yükleyin, anında XLT\'ye dönüştürülecektir." >}}
