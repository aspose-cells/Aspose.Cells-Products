---
title: دمج XLSB إلى TSV - دمج XLSB إلى TSV في C++
url: /ar/cpp/merger/merge-xlsb-to-tsv/ 
description: Aspose اكسل. C++ Aspose.Cells. دمج XLSB إلى TSV حفظ التنسيق. C++ قم بدمج تنسيق XLSB إلى TSV. دمج XLSB إلى TSV في C++. XLSB دمج.
...
{{% blocks/products/pf/agp/content h2="دمج XLSB إلى TSV في C++" %}}

يوضح المثال التالي كيفية دمج XLSB إلى TSV في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج XLSB إلى TSV. قم بتحميل ملفاتك، واتصل بطريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف TSV. إذا قمت بتطوير التعليمات البرمجية في C++، فسيكون هذا أبسط مما يبدو. راجع مثال C++ الذي يدمج XLSB إلى TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج رمز لدمج XLSB إلى TSV في C++" InputFormat="xlsb" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLSB إلى TSV عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج XLSB إلى TSV برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ للدمج XLSB الى TSV" %}}
