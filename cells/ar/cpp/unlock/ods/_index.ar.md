...
{{< blocks/products/pf/i18n/upper-banner h1="فتح ملفات ODS عبر C++" h2="قم بإزالة الحماية من جداول بيانات Excel بما في ذلك ملف ODS باستخدام مكتبة C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إزالة الحماية من ملف ODS باستخدام C++" %}}
...
1. قم بتحميل ملف مغلق ODS باستخدام CreateIWorkbook.1. استدعاء وظيفة Unprotect () لفتح.1. اضبط كلمة المرور على NULL باستخدام SetPassword.1. حفظ ملف ODS في مكان محدد.
