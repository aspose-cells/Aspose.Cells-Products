...
{{< blocks/products/pf/i18n/upper-banner h1="Vložte hvězdičky a bannery do Excelu via Java" h2="Vkládejte objekty pomocí rozhraní API na straně serveru bez jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF atd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit hvězdičky a bannery do souboru aplikace Excel pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení Vložit hvězdičky a bannery do souboru Excel via Java" %}}
...
+ Vyberte List přes jeho index.
 + Použijte[přidat metodu](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)pro vložení Vložit hvězdičky a bannery do vybraného listu
...
Ukázkový kód níže ukazuje, jak vložit "Ribbon: Curved and Tilted Up" a "Explosion: 8 Points". Další typy naleznete v části „Přehled typů vložení hvězdy a banneru“ níže.

{{% blocks/products/pf/agp/code-block title="Vložte hvězdičky a bannery – Java" offSpacer="" %}}
