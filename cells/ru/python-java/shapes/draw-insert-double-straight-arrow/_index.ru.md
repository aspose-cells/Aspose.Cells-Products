...
{{% blocks/products/pf/agp/content h2="Как вставить двойную прямую стрелку в файл Excel с помощью Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке двойной прямой стрелки в файл Excel с использованием Python via java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить двойную прямую стрелку в выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить двойную прямую стрелку — Python via java" offSpacer="" %}}
