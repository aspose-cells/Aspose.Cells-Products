---
title: XLAM в FODS - Преобразование файлов XLAM в FODS Python via Python
...
{{% blocks/products/pf/agp/content h2="Преобразовать XLAM в FODS в Python" %}}
...
В следующем примере показано, как преобразовать XLAM в FODS в Python via NET.
