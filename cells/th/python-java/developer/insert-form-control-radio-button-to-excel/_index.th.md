---
title:  แทรก RadioButton (การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via java
weight: 60
description: Python via ซอร์สโค้ด Java เพื่อแทรก RadioButton (การควบคุมแบบฟอร์ม) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก RadioButton (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแทรก RadioButton (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้รูปทรงของคอลเลกชัน[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรก RadioButton(Form control) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก RadioButton (ตัวควบคุมฟอร์ม) - Python via java" offSpacer="" %}}
