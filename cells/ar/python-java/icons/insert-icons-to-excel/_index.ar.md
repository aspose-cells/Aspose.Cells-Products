---
title:  أدخل SVG صورة/أيقونات في Excel باستخدام Python via Java
weight: 200
description: Python via كود مصدر جافا لإدراج SVG صورة/أيقونات في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج SVG صورة/أيقونات في ملف Excel باستخدام Python via جافا" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج SVG صورة/أيقونات في ملف Excel باستخدام Python via جافا" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addIcons(int,%20int,%20int,%20int,%20int,%20int,%20byte[],%20byte[])) لإدراج رمز في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل SVG صورة/أيقونات - Python via جافا" offSpacer="" %}}
