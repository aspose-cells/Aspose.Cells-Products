...
Het volgende voorbeeld laat zien hoe u XLS converteert naar XLAM in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLS naar XLAM te converteren" %}}
