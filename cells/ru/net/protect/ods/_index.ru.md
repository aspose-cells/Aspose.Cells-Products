---
title:  Защитить и заблокировать ODS документ via .NET
weight: 5580
...
{{< blocks/products/pf/i18n/upper-banner h1="Зашифровать файлы ODS через C#" h2="Защитите паролем электронные таблицы Excel, включая формат ODS, с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Защитите ODS через C#" %}}
...
1.  Создать экземпляр класса рабочей книги с путем к файлу ODS.
