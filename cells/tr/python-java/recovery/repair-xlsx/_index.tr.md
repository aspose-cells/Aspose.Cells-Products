---
title: Python Onarım xlsx - Bozuk xlsx Dosyasını Kurtarın ve Onarın
url: /tr/python-java/recovery/repair-xlsx/ 
description: Python Aspose.Cells. XLSX'i onarın. Xlsx dosyasını düzeltin. xlsx kurtarma aracı. xlsx bozulması. Xlsx verilerini geri yükleyin. xlsx dosya kurtarma. Bozuk xlsx dosyasını kurtarın.
...
{{% cells-recovery title="XLSX dosyasını onarmak için örnek kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}    
