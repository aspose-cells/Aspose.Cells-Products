---
title: Fusionner JPEG avec POWERPOINT - Combiner JPEG avec POWERPOINT dans Python
url: /fr/python-net/merger/merge-jpeg-to-powerpoint/ 
description: Aspose Exceller. Python Aspose.Cells. Fusionner JPEG au format de sauvegarde POWERPOINT. Python Combinez JPEG au format POWERPOINT. Fusionner JPEG avec POWERPOINT dans Python. JPEG Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner JPEG avec POWERPOINT à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner JPEG avec POWERPOINT dans Python" %}}

L'exemple suivant montre comment fusionner JPEG avec POWERPOINT dans Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner JPEG avec POWERPOINT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier POWERPOINT. Si vous développez du code en Python, ce sera plus simple qu'il n'y paraît. Voir l'exemple Python qui fusionne JPEG avec POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner JPEG avec POWERPOINT dans Python" InputFormat="jpg" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner JPEG avec POWERPOINT via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner JPEG avec POWERPOINT par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner JPEG avec POWERPOINT" %}}
