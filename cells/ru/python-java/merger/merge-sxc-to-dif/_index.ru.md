...
description: Aspose Эксель. Python Aspose.Cells. Объедините SXC и DIF в формате сохранения. Python Объедините форматы SXC и DIF. Объедините SXC и DIF в Python. SXC Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините SXC с DIF, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините SXC и DIF в Python." %}}

В следующем примере показано, как объединить SXC и DIF в Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/content h2="Как объединить SXC с DIF через Python" %}}
