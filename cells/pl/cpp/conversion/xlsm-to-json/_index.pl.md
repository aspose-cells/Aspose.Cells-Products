---
title: Konwertuj XLSM na JSON za pomocą aplikacji C++ 

description: Przykładowy kod konwersji C++ dla dokumentu XLSM do formatu JSON. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSM na JSON w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSM na JSON przy użyciu C++" %}}

 Aby przekonwertować XLSM na JSON, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSM na JSON za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLSM na JSON w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (JSON).1. Plik JSON zostanie zapisany pod określoną ścieżką.1. Otwórz plik JSON w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLSM do JSON C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo konwersji XLSM do JSON" sectionDescription="[Konwertuj XLSM na JSON](https://products.aspose.app/cells/conversion/xlsm-to-json) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLSM, zostanie on natychmiast przekonwertowany do formatu JSON." >}}
