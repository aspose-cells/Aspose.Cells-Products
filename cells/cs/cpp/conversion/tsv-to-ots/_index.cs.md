...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu TSV do formátu OTS, což umožňuje bezproblémové ukládání dat TSV do formátu OTS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte TSV na OTS v kódu C++" h2="Vysoce výkonná konverze TSV na OTS s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete TSV do OTS v čísle C++" %}}

Následující příklad ukazuje, jak převést číslo TSV na OTS v kódu C++.
...
Potřebujete programově převést soubory TSV do OTS? Vývojáři C++ mohou snadno převést soubory TSV do OTS pomocí několika řádků kódu.
...
1.  Převeďte číslo TSV na OTS voláním metody Save().
1.  Získejte výsledek převodu TSV na OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod TSV do OTS" %}}
