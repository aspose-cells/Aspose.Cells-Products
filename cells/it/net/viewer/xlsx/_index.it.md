---
title:  Visualizza XLSX Formati file via .NET
weight: 2180
description: Codice sorgente C# per caricare, eseguire il rendering e visualizzare i documenti XLSX sulle piattaforme .NET Framework, .NET Core, Mono o Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="XLSX Visualizzatore File for .NET" h2="Visualizza fogli di calcolo Excel e OpenOffice come XLSX senza richiedere Microsoft Excel o Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells consente agli sviluppatori di visualizzare facilmente il file XLSX con solo poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1.  Carica il file XLSX in un'istanza di Workbook
1.  Crea un'istanza di HtmlSaveOptions e imposta la proprietà ExportHeadings su true
1. Salva il file XLSX nel formato HTML utilizzando il metodo Workbook.Save
...
{{% blocks/products/pf/agp/code-block title="Codice di esempio C# per visualizzare il file XLSX" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API può essere utilizzato per creare, modificare, convertire ed eseguire il rendering dei formati Excel Microsoft in diversi formati. Inoltre, può essere utilizzato per grafici completi, reporting scalabile e calcoli affidabili all'interno di applicazioni software. Aspose.Cells è un API autonomo e non richiede alcun software come Microsoft o OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per visualizzare XLSX" sectionDescription=" Controlla le nostre demo dal vivo per[Visualizza XLSX](https://products.aspose.app/cells/viewer/xlsx) con i seguenti vantaggi." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Scaricare il file XLSX dal collegamento, se richiesto" >}}
