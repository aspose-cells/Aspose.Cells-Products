---
title: Java XLT na PRN - XLT na konwerter PRN
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLT do formatu PRN, umożliwiając bezproblemowe zapisywanie danych XLT w formacie PRN przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT do PRN w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XLT na PRN w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer XLT na PRN. Prześlij plik XLT, a następnie po prostu zapisz go jako plik PRN. Zarówno do odczytu XLT, jak i do zapisu PRN, można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego PRN będą identyczne z oryginalnym dokumentem XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLT na PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlt" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLT na PRN? Programiści Java mogą łatwo przekonwertować pliki XLT na PRN za pomocą zaledwie kilku linijek kodu.
...
1.  Przekonwertuj numer XLT na PRN, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLT na PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XLT na PRN" %}}
{{% blocks/products/pf/agp/text %}}
