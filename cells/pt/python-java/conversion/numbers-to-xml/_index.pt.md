...
{{% cells-convert title="Aplicativo gratuito e código de amostra para converter NUMBERS em XML online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="xml" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter NÚMEROS para XML via Python" %}}

{{% blocks/products/pf/agp/text %}}

Python desenvolvedores podem facilmente carregar e converter NUMBERS para XML em apenas algumas linhas de código.
