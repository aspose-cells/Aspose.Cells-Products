---
title: Combinar TABDELIMITED con XLSX - Combinar TABDELIMITED con XLSX en C#
url: /es/net/merger/merge-tabdelimited-to-xlsx/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea TABDELIMITED a XLSX guardar formato. C# Combina TABDELIMITED con el formato XLSX. Fusionar TABDELIMITED a XLSX en C#. TABDELIMITED Fusionar.
...
{{% blocks/products/pf/agp/content h2="Combine TABDELIMITED a XLSX en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo fusionar TABDELIMITED a XLSX en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar TABDELIMITED a XLSX. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo XLSX. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina TABDELIMITED con XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar TABDELIMITED a XLSX en C#" InputFormat="tsv" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar TABDELIMITED a XLSX a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar TABDELIMITED con XLSX mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar TABDELIMITED a XLSX" %}}
