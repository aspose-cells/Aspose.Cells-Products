...
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertissez les NUMÉROS en format de sauvegarde ODS. C# NUMÉROS au format ODS. Enregistrez les NUMÉROS au ODS C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros au ODS en C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir NUMBERS en ODS en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir les NUMBERS en ODS. Téléchargez votre fichier NUMBERS, puis enregistrez-le simplement en tant que fichier ODS. Pour la lecture de NUMBERS et l'écriture de ODS, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie ODS seront identiques au document NUMBERS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir des NUMBERS en ODS en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des NUMBERS en ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers NUMBERS en ODS par programmation ? Les développeurs de .NET peuvent facilement charger et convertir des NUMBERS en ODS en quelques lignes de code.
...
1.  Convertissez NUMBERS en ODS en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliothèque pour convertir les NUMBERS en ODS" %}}
