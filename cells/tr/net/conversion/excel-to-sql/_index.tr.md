---
title: C# EXCEL'den SQL'e - EXCEL'den SQL'e Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile EXCEL'i hızlı ve kolay bir şekilde SQL'e dönüştürün. C# EXCEL'den SQL'e. C# EXCEL'i SQL'e kaydedin. C#'i kullanarak EXCEL'i SQL olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i C#\'de SQL\'e kaydedin" %}}

Aşağıdaki örnek, C#'de EXCEL'in SQL'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="EXCEL\'i SQL\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C# aracılığıyla SQL\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını programlı olarak SQL'e dönüştürmeniz mi gerekiyor? .NET geliştiriciler EXCEL'i yalnızca birkaç satır kodla kolayca yükleyebilir ve SQL'e dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i SQL\'e dönüştürmek için C# kitaplığı" %}}
