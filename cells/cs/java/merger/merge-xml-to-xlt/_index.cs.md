---
title:  Sloučit XML na XLT via Java
...
Následující příklad ukazuje, jak sloučit XML do XLT v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XML na XLT online" InputFormat="xml" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
