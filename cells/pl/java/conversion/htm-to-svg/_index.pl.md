...
{{% blocks/products/pf/agp/content h2="Zapisz HTM do SVG w Java" %}}
...
Trzeba programowo przekonwertować pliki HTM do formatu SVG? Programiści Java mogą łatwo przekonwertować pliki HTM do formatu SVG za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji HTM na SVG" %}}
{{% blocks/products/pf/agp/text %}}
