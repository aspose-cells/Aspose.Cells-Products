---
title:  Вставьте CheckBox (управление формой) в Excel через Python
weight: 30
description: Python исходный код для вставки CheckBox (элемент управления формой) в Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Вставьте CheckBox (управление формой) в Excel через Python" h2="Вставляйте объекты с помощью API на стороне сервера без какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF и т. д." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Как вставить CheckBox (управление формой) в файл Excel, используя Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке CheckBox (управление формой) в файл Excel через Python" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить CheckBox (элемент управления формой) в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить флажок (управление формой) - Python" offSpacer="" %}}
