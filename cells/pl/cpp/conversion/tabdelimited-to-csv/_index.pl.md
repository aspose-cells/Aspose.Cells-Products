---
title: Konwertuj TABDELIMITED na CSV za pomocą aplikacji C++ 
url: /pl/cpp/conversion/tabdelimited-to-csv/ 
description: Przykładowy kod konwersji C++ dla dokumentu TABDELIMITED do formatu CSV. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TABDELIMITED na CSV w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TABDELIMITED na CSV przez C++" h2="Wysokowydajna konwersja TABDELIMITED do CSV przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TABDELIMITED na CSV w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TABDELIMITED przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (CSV).1. Plik CSV zostanie zapisany pod określoną ścieżką.1. Otwórz plik CSV w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED do CSV C++ Kod źródłowy konwersji" offSpacer="" %}}
