---
title: Połącz ODS z SVG - Połącz ODS z SVG w Python
url: /pl/python-net/merger/merge-ods-to-svg/ 
description: Aspose Excel. Python Aspose.Cells. Bezpłatne scalanie online ODS do SVG w formacie zapisu. Python Połącz format ODS z SVG. Połącz ODS z SVG w Python. ODS Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz ODS z SVG za pomocą Python" %}}

 Jak scalić ODS z SVG? Dzięki bibliotece Aspose.Cells for Python via .NET możesz łatwo połączyć programowo ODS z SVG za pomocą kilku linii kodu.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)jest w stanie budować wieloplatformowe aplikacje z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje między formatami arkuszy kalkulacyjnych, ale może również renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumenty w standardzie przemysłowym formaty. Możesz zainstalować Aspose.Cells for Python via .NET z<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , użyj polecenia jako:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Połącz ODS z SVG w Python Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć ODS z SVG w Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć ODS z SVG. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku SVG. Jeśli opracujesz kod w Python, będzie to prostsze niż się wydaje. Zobacz przykład Python, który łączy numery ODS z SVG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online ODS z SVG w Python" InputFormat="ods" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć ODS z SVG za pośrednictwem Python" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić ODS z SVG programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Python biblioteka do połączenia ODS z SVG" %}}
