...
Trzeba programowo przekonwertować pliki PNG do formatu ET? Programiści C++ mogą łatwo przekonwertować pliki PNG do formatu ET za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj PNG na ET wywołując metodę Save().
