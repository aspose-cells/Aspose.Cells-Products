---
title:  Voeg GroupBox (formulierbeheer) in Excel in met behulp van Python via java
weight: 40
description: Python via Java-broncode om GroupBox (formulierbesturing) in Excel in te voegen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg GroupBox (formulierbeheer) in Excel in met behulp van Python via java" h2="Voeg objecten in met behulp van server-side API\'s zonder enige software zoals Microsoft of Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe GroupBox (formulierbesturing) in Excel-bestand in te voegen met behulp van Python via java" %}}

Om GroupBox (Formulierbeheer) in Excel-bestand in te voegen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om GroupBox (formulierbesturing) in Excel-bestand in te voegen met behulp van Python via java" %}}
...
+ Selecteer werkblad via de index.
 + Gebruik de vormverzamelingen[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addGroupBox(int,%20int,%20int,%20int,%20int,%20int)) om een GroupBox (formulierbesturingselement) in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Voeg GroupBox in (formulierbeheer) - Python via java" offSpacer="" %}}
