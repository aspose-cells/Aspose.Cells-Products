---
title: ODS'i PRN ile birleştir - ODS'i Java'deki PRN ile birleştir
url: /tr/java/merger/merge-ods-to-prn/ 
description: Aspose Excel'de. Java Aspose.Cells. ODS'i PRN kaydetme biçimiyle birleştirin. Java ODS'i PRN formatıyla birleştirin. ODS'i Java'deki PRN ile birleştirin. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'deki PRN ile birleştir" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'deki PRN ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i PRN ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından PRN dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. ODS'i PRN ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'deki PRN ile Birleştirmek için Örnek Kod" InputFormat="ods" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i PRN via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i PRN ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, ODS\'i PRN ile birleştirecek" %}}
