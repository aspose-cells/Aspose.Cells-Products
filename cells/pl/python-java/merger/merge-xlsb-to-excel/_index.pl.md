...
description: Aspose Excel. Python Aspose.Cells. Scal XLSB do formatu zapisu EXCEL. Python Połącz XLSB z formatem EXCEL. Scal XLSB z EXCEL w Python. XLSB Scal.
...
{{% cells-merger title="Przykładowy kod do połączenia XLSB z EXCEL w Python" InputFormat="xlsb" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSB z EXCELem przez Python" %}}
