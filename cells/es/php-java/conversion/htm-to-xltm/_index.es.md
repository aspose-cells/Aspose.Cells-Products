---
title: PHP HTM a XLTM - Convertidor HTM a XLTM
description: Aspose Excel. Convierta HTM a XLTM rápida y fácilmente con Aspose.Cells. PHP HTM a XLTM. PHP Guarde HTM en XLTM. Guarde HTM como XLTM usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a XLTM mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a XLTM mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a XLTM en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a XLTM llamando al método guardar del libro de trabajo.
