...
{{% blocks/products/pf/agp/content h2="Jak vložit obdélník do souboru aplikace Excel pomocí Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení obdélníku do souboru aplikace Excel pomocí Python via Java" %}}
...
+ Vyberte List přes jeho index.
 + Použijte kolekci tvarů[přidat metodu](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRectangle(int,%20int,%20int,%20int,%20int,%20int)), chcete-li do vybraného listu vložit obdélník.
...
{{% blocks/products/pf/agp/code-block title="Vložit obdélník – Python via Java" offSpacer="" %}}
