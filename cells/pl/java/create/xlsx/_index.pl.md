---
title: Utwórz pliki MS Excel XLSX via Java
description: XLSX twórca. Utwórz pliki XLSX w kodzie Java. Generuj pliki MS Excel XLSX za pomocą aplikacji komputerowej lub internetowej opartej na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Utwórz plik XLSX via Java" h2="Natywne i wydajne tworzenie arkuszy kalkulacyjnych MS Excel XLSX programowo przy użyciu biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć XLSX via Java" %}}
...
1.  Zapisz skoroszyt w formacie XLSX przy użyciu metody save().

{{% blocks/products/pf/agp/code-block title="Poniższy kod źródłowy pokazuje, jak utworzyć plik MS Excel XLSX przy użyciu Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do utworzenia pliku XLSX" %}}
{{% blocks/products/pf/agp/text %}}
