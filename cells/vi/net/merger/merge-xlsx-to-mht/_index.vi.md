---
title: Gộp XLSX vào MHT - Gộp XLSX vào MHT vào C#
url: /vi/net/merger/merge-xlsx-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất XLSX vào định dạng lưu MHT. C# Kết hợp XLSX thành định dạng MHT. Hợp nhất XLSX vào MHT vào C#. Hợp nhất XLSX.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLSX vào MHT vào C#" %}}

Ví dụ sau đây minh họa cách hợp nhất XLSX với MHT trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XLSX vào MHT. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp MHT. Nếu bạn phát triển mã theo số C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất XLSX với MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp XLSX vào MHT năm C#" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp XLSX vào MHT qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất XLSX vào MHT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET sáp nhập XLSX vào MHT" %}}
