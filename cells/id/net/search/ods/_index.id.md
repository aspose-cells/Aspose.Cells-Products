---
title:  Cari dokumen ODS tanpa membuka via .NET
weight: 160
description: Kode sumber C# untuk mencari kata dengan pola pada file ODS pada Framework .NET, .NET Core, Mono atau Platform Xamarin.
---
