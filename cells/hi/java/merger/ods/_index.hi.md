---
title:  ODS फ़ाइलें via Java मर्ज करें
weight: 6270
description: जेएसपी/जेएसएफ एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरमेंट पर ODS दस्तावेजों को संयोजित करने के लिए Java नमूना कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS प्रारूपों को Java में मर्ज करें" h2="सर्वर-साइड Java एपीआई का उपयोग करके मूल ODS दस्तावेज़ विलय।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके ODS फ़ाइलों को कैसे मर्ज करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java में ODS फ़ाइलों को मर्ज करने के चरण" %}}
...
+ वर्कबुक क्लास के उदाहरण के साथ पहली ODS फ़ाइल लोड करें।
+ वर्कबुक क्लास के उदाहरण के साथ दूसरा ODS दस्तावेज़ लोड करें।
+ कंबाइन() विधि का उपयोग करके फ़ाइलें मर्ज करें।
+ मर्ज की गई ODS फ़ाइल को निर्दिष्ट पथ पर सहेजें
...
{{% blocks/products/pf/agp/code-block title="ODS फ़ाइलें मर्ज करें - Java" offSpacer="" %}}
