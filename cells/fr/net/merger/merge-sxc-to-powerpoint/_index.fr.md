---
title: Fusionner SXC vers POWERPOINT - Combiner SXC vers POWERPOINT dans C#
url: /fr/net/merger/merge-sxc-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Fusion gratuite en ligne SXC au format de sauvegarde POWERPOINT. C# Combinez SXC au format POWERPOINT. Fusionner SXC à POWERPOINT dans C#. SXC Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner SXC à POWERPOINT en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner SXC vers POWERPOINT dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner SXC vers POWERPOINT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier POWERPOINT. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne SXC en POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner SXC vers POWERPOINT en C#" InputFormat="sxc" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner SXC vers POWERPOINT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner SXC vers POWERPOINT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque .NET pour fusionner SXC vers POWERPOINT" %}}
