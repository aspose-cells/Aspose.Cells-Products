...
{{% blocks/products/pf/agp/content h2="Konwertuj XLT do formatu EXCEL za pomocą Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT w programie EXCEL w formacie Java" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLT na format EXCEL w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na via Java w formacie EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLT do formatu EXCEL? Programiści Java mogą łatwo przekonwertować pliki XLT do formatu EXCEL za pomocą zaledwie kilku linijek kodu.
