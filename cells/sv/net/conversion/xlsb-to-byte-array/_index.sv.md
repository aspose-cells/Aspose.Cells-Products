...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array är till hjälp för databearbetning eller lagring. Du kan konvertera filen XLSB till Byte Array samt en**Byte Array till XLSB** dokument med C# språk. För att konvertera XLSB till byte array kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Hur man konverterar XLSB till Byte Array via C#" %}}
...
1.  Ladda indata XLSB Fil med arbetsbok
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar XLSB till byte array C# konvertering" offSpacer="" %}}
