---
title: Hợp nhất XML thành PRN - Hợp nhất XML thành PRN trong Java
url: /vi/java/merger/merge-xml-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất XML sang định dạng lưu PRN trực tuyến miễn phí. Java Kết hợp định dạng XML sang PRN. Hợp nhất XML thành PRN trong Java. Hợp nhất XML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XML với PRN trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất XML với PRN trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất XML với PRN. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp PRN. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất XML với PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất XML với PRN trong Java" InputFormat="xml" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XML thành PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất XML với PRN theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất XML với PRN" %}}
