...
description: Aspose Excel. Convierta OTS a HTM rápida y fácilmente con Aspose.Cells. C++ OTS a HTM. C++ Guardar OTS en HTM. Guarde OTS como HTM usando C++.
...
{{% blocks/products/pf/agp/content h2="Guarde OTS en HTM en C++" %}}

El siguiente ejemplo demuestra cómo convertir OTS a HTM en C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir OTS a HTM. Cargue su archivo OTS y luego simplemente guárdelo como archivo HTM. Tanto para la lectura OTS como para la escritura HTM, puede utilizar nombres de archivos completos. El contenido y el formato HTM de salida serán idénticos al documento OTS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir OTS a HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="htm" IsLandingPage="true" language="cpp" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para convertir OTS a HTM" %}}
