---
title: Utwórz XLAM - Utwórz plik XLAM w Java
description: Aspose Excel. Java Utwórz plik XLAM. Utwórz XLAM Java. Java XLAM Twórca. Utwórz XLAM w Java. Wygeneruj plik XLAM, używając Java.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć XLAM w Java" %}}
...
1.  Zapisz skoroszyt w formacie XLAM przy użyciu metody save().

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik XLAM w Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do utworzenia pliku XLAM" %}}
{{% blocks/products/pf/agp/text %}}
