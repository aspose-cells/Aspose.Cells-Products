...
EXCEL dosyalarını programlı olarak JSON'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip JSON'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını JSON formatına dönüştürün.
