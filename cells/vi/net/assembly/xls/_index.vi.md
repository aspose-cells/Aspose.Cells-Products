---
title:  Tạo Báo cáo trong Tệp XLS via .NET
weight: 1700
description: C# để tạo báo cáo định dạng XLS trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
...
{{% blocks/products/pf/agp/content h2="Cách tạo Báo cáo dựa trên XLS bằng C#" %}}
