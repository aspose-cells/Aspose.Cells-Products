---
title: OTS'yi DOCX'e birleştir - OTS'yi Java'de DOCX'e birleştir
url: /tr/java/merger/merge-ots-to-docx/ 
description: Aspose excel. Java Aspose.Cells. OTS'yi DOCX kaydetme biçimine Ücretsiz Çevrimiçi Birleştirme. Java OTS'yi DOCX biçiminde birleştirin. OTS'yi Java'de DOCX ile birleştirin. OTS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi Java\'de DOCX ile Çevrimiçi Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, OTS'nin Aspose.Cells for Java'de DOCX ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

OTS'yi DOCX'de birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından DOCX dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. OTS'yi DOCX ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="OTS\'yi Java\'de DOCX ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ots" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi DOCX via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

OTS'yi programlı olarak DOCX ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
