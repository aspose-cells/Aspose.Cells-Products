...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Ver XLTM vía C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells facilita a los desarrolladores ver el archivo XLTM con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Cargue el archivo XLTM en una instancia de Workbook
1.  Cree una instancia de HtmlSaveOptions y establezca la propiedad ExportHeadings en verdadero
1.  Guarde el archivo XLTM en formato HTML usando el método Workbook.Save
