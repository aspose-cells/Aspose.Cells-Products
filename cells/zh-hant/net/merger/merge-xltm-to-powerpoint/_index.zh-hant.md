...
description: Aspose Excel。 C# Aspose.Cells。免費在線合併 XLTM 到 POWERPOINT 保存格式。 C# 將 XLTM 合併為 POWERPOINT 格式。將 XLTM 合併到 C# 中的 POWERPOINT。 XLTM 合併。
...
{{% blocks/products/pf/agp/content h2="免費在線將 XLTM 合併到 C# 中的 POWERPOINT" %}}

以下示例演示如何將 XLTM 合併到 Aspose.Cells for .NET 中的 POWERPOINT。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLTM 合併到 POWERPOINT。上傳文件，調用Workbook.Combine方法合併文件，然後將其保存到POWERPOINT文件。如果您在 C# 中開發代碼，這會比聽起來更簡單。請參閱將 XLTM 合併到 POWERPOINT 的 C# 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將 XLTM 合併到 C# 中的 POWERPOINT" InputFormat="xltm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 XLTM 合併到 POWERPOINT" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 XLTM 合併到 POWERPOINT 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 庫將 XLTM 合併到 POWERPOINT" %}}
