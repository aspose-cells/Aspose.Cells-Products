...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde ODS'i JSON'e dönüştürün. C++ ODS'i JSON'e dönüştürün. C++ ODS'i JSON'e kaydedin. ODS'i 07611134 olarak kaydedin 81, C++'i kullanarak.
...
{{< blocks/products/pf/i18n/upper-banner h1="ODS\'i C++\'de JSON\'e dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna gerek kalmadan C++ kitaplığını kullanarak yüksek performanslı ODS\'den JSON\'e dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="C++\'i kullanarak ODS\'i JSON\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="ODS\'i C++\'e JSON\'e kaydedin" %}}

Aşağıdaki örnek, ODS'in C++'de JSON'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="ODS\'i JSON\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="json" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i C++ aracılığıyla JSON\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

ODS dosyalarını program aracılığıyla JSON'e dönüştürmeniz mi gerekiyor? C++ geliştiricileri, yalnızca birkaç satır kodla ODS'i JSON'e kolayca dönüştürebilir.
...
1.  Save() yöntemini çağırarak ODS'i JSON'e dönüştürün.
1.  ODS'den JSON'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ODS\'i JSON\'e dönüştürmek için C++ kitaplığı" %}}
