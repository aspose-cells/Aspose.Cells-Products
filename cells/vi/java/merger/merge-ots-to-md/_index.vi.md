---
title: Gộp OTS thành MD - Gộp OTS thành MD trong Java
url: /vi/java/merger/merge-ots-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu OTS sang MD. Java Kết hợp định dạng OTS sang MD. Hợp nhất OTS thành MD theo số Java. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS thành MD theo số Java" %}}

Ví dụ sau đây minh họa cách hợp nhất OTS với MD trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất OTS với MD. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu nó vào tệp MD. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất OTS với MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp OTS vào MD Java" InputFormat="ots" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS thành MD via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép OTS vào MD" %}}
