...
{{% blocks/products/pf/agp/content h2="Jak převést ČÍSLA na SVG pomocí Java" %}}

 K vykreslení NUMBERS do SVG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu NUMBERS na SVG prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři z Java mohou snadno převést soubor NUMBERS na SVG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst NUMBERS soubor s instancí Workbook1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Voláním metody SheetRender.toImage uložíte výsledek ve formátu SVG
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze NUMBERS na SVG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze NUMBERS na SVG" sectionDescription="[Převést NUMBERS na SVG](https://products.aspose.app/cells/conversion/numbers-to-svg) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor NUMBERS, bude okamžitě převeden na SVG." >}}
