---
title: Voeg PRN samen met HTML - Combineer PRN met HTML in Python
url: /nl/python-java/merger/merge-prn-to-html/ 
description: Aspose Excel. Python Excel. Voeg PRN samen met het opslagformaat HTML. Python Combineer PRN met HTML-formaat. Voeg PRN samen met HTML in de Excel-bibliotheek Python. PRN samenvoegen.
...
{{% blocks/products/pf/agp/content h2="PRN samenvoegen met HTML met behulp van de Excel-bibliotheek Python" %}}

 Hoe voeg ik PRN samen met HTML? Met de bibliotheek Aspose.Cells for Python via Java kunt u PRN eenvoudig programmatisch samenvoegen met HTML met een paar regels code.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells) is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardformaten. U kunt Aspose.Cells for Python via Java installeren vanaf<a href="https://pypi.org/project/aspose-cells/">pypi</a> , gebruik de opdracht als:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PRN samenvoegen met HTML in Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u PRN samenvoegt met HTML in Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PRN samen te voegen met HTML. Upload uw bestanden, bel de Workbook.Combine-methode voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand HTML. Als u code ontwikkelt in Python, is dit eenvoudiger dan het klinkt. Zie het voorbeeld Python waarin PRN wordt samengevoegd met HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om PRN samen te voegen met HTML in de Excel-bibliotheek Python" InputFormat="prn" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="PRN samenvoegen met HTML via de Excel-bibliotheek Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PRN programmatisch samenvoegen met HTML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om PRN samen te voegen met HTML" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-java/merger/merge-prn-to-txt/" name="PRN samenvoegen met TXT" description="Tekstdocument" >}}
