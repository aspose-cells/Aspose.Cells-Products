---
title: C++ JPG a DOCX - Convertidor JPG a DOCX
description: Aspose Excel. Convierta JPG a DOCX rápida y fácilmente con Aspose.Cells. C++ JPG a DOCX. C++ Guarde JPG en DOCX. Guarde JPG como DOCX usando C++.
...
{{% blocks/products/pf/agp/content h2="Guarde JPG en DOCX en C++" %}}

El siguiente ejemplo demuestra cómo convertir JPG a DOCX en C++.
...
{{% cells-convert title="Código de muestra para convertir JPG a DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="docx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir JPG a DOCX a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos JPG a DOCX mediante programación? Los desarrolladores de C++ pueden convertir fácilmente JPG a DOCX con solo unas pocas líneas de código.
...
1.  Convierta JPG a DOCX llamando al método Save().
1.  Obtenga el resultado de la conversión de JPG a DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para convertir JPG a DOCX" %}}
