---
title:  Convertir HTM en SPREADSHEETML Java
description: Convertissez HTM en SPREADSHEETML en ligne gratuitement. Convertisseur HTM en SPREADSHEETML en ligne gratuit. Java HTM à SPREADSHEETML. HTM à SPREADSHEETML via Java.
keywords: Convert HTM, HTM Converter, HTM to PDF, HTM to Word, HTM to PPT, HTM to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en SPREADSHEETML via Java" h2="Conversion HTM en SPREADSHEETML Java pour convertir une ou plusieurs pages en SPREADSHEETML à l\'aide de la bibliothèque sur site Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir HTM en SPREADSHEETML en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xml" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir HTM en SPREADSHEETML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier HTM avec une instance de la classe Workbook
1.  Convertir HTM en SPREADSHEETML en appelant la méthode Workbook.save
