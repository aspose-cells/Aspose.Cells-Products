---
title:  Gabungkan ODS File via .NET
weight: 4330
description: Kode sumber C# untuk menggabungkan dokumen ODS pada .NET Framework, .NET Core, Mono atau Platform Xamarin.
---
...
{{% blocks/products/pf/agp/code-block title="Gabungkan ODS File - C#" offSpacer="" %}}
