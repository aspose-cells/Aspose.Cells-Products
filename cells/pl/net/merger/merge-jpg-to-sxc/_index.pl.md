...
description: Aspose Excel. C# Aspose.Cells. Darmowe łączenie plików JPG online do formatu zapisu SXC. C# Połącz JPG z formatem SXC. Połącz JPG z SXC w C#. JPG Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz JPG z SXC w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć JPG z SXC w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić JPG z SXC. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku SXC. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy JPG z SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatnie online, aby połączyć JPG z SXC w C#" InputFormat="jpg" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić JPG z SXC przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić JPG z SXC? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia JPG z SXC" %}}
