---
title: Converter CSV para XLS via Python

description: Código de amostra para conversão de csv para xls Python. Use o código de exemplo API para arquivos csv em lote para conversão xls no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter CSV para XLS usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter CSV para XLS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos CSV para XLS em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo CSV com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão XLS como parâmetro1. Verifique o caminho especificado para o arquivo XLS resultante
...
{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter CSV para XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="xls" IsLandingPage="true" language="python" %}}
