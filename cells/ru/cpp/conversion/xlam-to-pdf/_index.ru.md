---
title: Преобразователь C++ XLAM в PDF - XLAM в PDF
...
{{% blocks/products/pf/agp/content h2="Сохраните XLAM в PDF в C++" %}}

В следующем примере показано, как преобразовать XLAM в PDF в C++.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XLAM в PDF через C++" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы XLAM в PDF? Разработчики, работающие с файлами C++, могут легко преобразовать файлы XLAM в PDF всего несколькими строками кода.
...
1.  Преобразуйте XLAM в PDF, вызвав метод Save().
1.  Получите результат преобразования XLAM в PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C++ для преобразования XLAM в PDF" %}}
