...
{{% blocks/products/pf/agp/content h2="Sla HTML op in DOCX in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar DOCX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar DOCX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar DOCX? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar DOCX met slechts een paar regels code.
