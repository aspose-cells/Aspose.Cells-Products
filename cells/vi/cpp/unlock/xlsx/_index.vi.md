---
title:  Unlock tài liệu XLSX qua C++
weight: 3680
...
{{< blocks/products/pf/i18n/upper-banner h1="Mở khóa các tệp XLSX qua C++" h2="Xóa bảo vệ khỏi bảng tính Excel bao gồm tệp XLSX bằng Thư viện C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  Tải tệp bị khóa XLSX bằng CreateIWorkbook.
1.  Gọi hàm Unprotect() để mở khóa.
1.  Đặt mật khẩu thành NULL bằng SetPassword.
1.  Lưu tệp XLSX tại một vị trí được chỉ định.
