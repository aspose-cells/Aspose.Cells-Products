---
title:  Sloučit XLSM na DOCX přes Python
url: /cs/python-net/merger/merge-xlsm-to-docx/ 
description: Sloučit XLSM až DOCX online zdarma. Online zdarma XLSM až DOCX Fúze. Sloučit XLSM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSM až DOCX v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až DOCX online" InputFormat="xlsm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
