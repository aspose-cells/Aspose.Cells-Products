---
title:  Pisahkan XLSX Berkas via .NET
weight: 1350
description: Kode sumber C# untuk membagi XLSX dokumen pada .NET Framework, .NET Core, Mono atau Platform Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pisahkan XLSX Format menjadi C#" h2="Splitter XLSX asli dan berkinerja tinggi menggunakan API sisi server, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Pemisahan File XLSX di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Berkas Pisah XLSX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/splitter/ods/" name="ODS" description="Buka File Spreadsheet Dokumen" >}}
