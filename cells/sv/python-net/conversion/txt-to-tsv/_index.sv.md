...
{{% blocks/products/pf/agp/content h2="Konvertera TXT till TSV till Python" %}}
...
Följande exempel visar hur man konverterar TXT till TSV i Python via NET.
