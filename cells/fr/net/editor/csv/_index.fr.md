---
title:  Modifier les fichiers CSV via .NET
description: Code source C# pour modifier le document CSV sur les plateformes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes de modification des fichiers CSV dans C#" %}}
...
Aspose.Cells API peut être utilisé pour créer, éditer, convertir et restituer Microsoft des formats Excel vers différents formats. De plus, il peut être utilisé pour des graphiques complets, des rapports évolutifs et des calculs fiables au sein d'applications logicielles. Aspose.Cells est un API autonome et ne nécessite aucun logiciel comme Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="En ligne CSV Démos en direct de l\'éditeur" sectionDescription=" Modifiez les documents CSV dès maintenant en visitant notre[Site Web de démonstrations en direct](https://products.aspose.app/cells/editor). La démo en direct présente les avantages suivants" >}}
