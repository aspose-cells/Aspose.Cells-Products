---
title: Java EXCEL إلى PRN - محول EXCEL إلى PRN
description: Aspose اكسل. تحويل EXCEL إلى PRN بسرعة وسهولة مع Aspose.Cells. Java EXCEL إلى PRN. Java حفظ EXCEL إلى PRN. احفظ EXCEL كـ PRN باستخدام Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل EXCEL إلى PRN في Java" h2="مكتبة Java عالية السرعة لتحويل EXCEL إلى PRN. يعد هذا حلاً برمجيًا احترافيًا لاستيراد وتصدير EXCEL وPRN والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ EXCEL إلى PRN في Java" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل EXCEL إلى PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل EXCEL إلى PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات EXCEL إلى PRN برمجياً؟ يمكن لمطوري Java تحويل EXCEL إلى PRN بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل EXCEL إلى PRN عن طريق استدعاء أسلوب Workbook.save.
1.  احصل على نتيجة تحويل EXCEL إلى PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل EXCEL إلى PRN" %}}
{{% blocks/products/pf/agp/text %}}
