---
title:  Sloučit XLSM na TSV přes Python
url: /cs/python-net/merger/merge-xlsm-to-tsv/ 
description: Sloučit XLSM až TSV online zdarma. Online zdarma XLSM až TSV Fúze. Sloučit XLSM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSM až TSV v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až TSV online" InputFormat="xlsm" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
