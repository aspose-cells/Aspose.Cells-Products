...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file HTML in JPG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file HTML usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (JPG).1. Il file JPG verrà salvato nel percorso specificato.1. Apri il file JPG in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da HTML a JPG C++" offSpacer="" %}}
