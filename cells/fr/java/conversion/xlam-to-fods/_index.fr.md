---
title: XLAM à FODS - Convertir XLAM à FODS fichiers Java
description: Aspose Excel. Conversion gratuite en ligne du format de sauvegarde XLAM en FODS. Format Java XLAM à FODS. Enregistrez XLAM sous FODS dans Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLAM à FODS dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLAM en FODS en Java.
...
Besoin de convertir les fichiers XLAM en FODS par programmation ? Les développeurs de Java peuvent facilement convertir XLAM en FODS en seulement quelques lignes de code.
