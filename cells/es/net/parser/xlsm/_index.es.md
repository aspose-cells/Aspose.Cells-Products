---
title:  Extraiga texto e imágenes del documento XLSM via .NET
weight: 4010
description: Código fuente C# para extraer texto e imágenes del archivo XLSM en .NET Framework, .NET Core, Mono o plataformas Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Analizar XLSM Formatos en C#" h2="Análisis de documentos XLSM nativo y de alto rendimiento utilizando API Aspose.Cells for .NET del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo analizar el archivo XLSM usando C#" %}}
 ...
 Para analizar el archivo XLSM, usaremos[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API, que es una manipulación de documentos API rica en funciones, potente y fácil de usar para la plataforma C#. Abierto[NuGet](https://www.nuget.org/packages/aspose.cells) administrador de paquetes, buscar
