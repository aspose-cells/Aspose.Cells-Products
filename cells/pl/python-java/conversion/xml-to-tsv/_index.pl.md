...
description: Aspose Excel. Konwertuj XML na TSV szybko i łatwo za pomocą Aspose.Cells. Python XML na TSV. Python Zapisz XML na TSV. Zapisz XML jako TSV używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem TSV w Python" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na TSV w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji XML na TSV" %}}
