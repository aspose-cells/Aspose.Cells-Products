---
title:  NUMBERS를 C++을 통해 XLS로 병합
url: /ko/cpp/merger/merge-numbers-to-xls/ 
description: NUMBERS를 XLS 온라인으로 무료로 병합합니다. XLS 합병에 대한 무료 온라인 번호. 숫자를 Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS 등에 병합합니다.
---
...
다음 예는 NUMBERS를 C++에서 XLS로 병합하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

간단한 단계에 따라 NUMBERS를 XLS에 병합합니다. 파일을 업로드하고 파일 병합을 위해 Workbook.Combine 메서드를 호출한 다음 XLS 파일에 저장합니다. C++에서 코드를 개발하면 생각보다 간단합니다. NUMBERS를 XLS에 병합하는 C++ 예제를 참조하십시오.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="온라인에서 NUMBERS를 XLS로 병합하는 무료 앱" InputFormat="numbers" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
