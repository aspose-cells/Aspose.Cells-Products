---
title: C# MHT - DOCX - MHT - DOCX konverter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az MHT DOCX formátumba konvertálásához, lehetővé téve az MHT adatok zökkenőmentes mentését DOCX formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentsd el az MHT-t a DOCX-es számra a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet az MHT-t DOCX-re konvertálni a C#-ben.
...
{{% blocks/products/pf/agp/content h2="Az MHT konvertálása DOCX-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Az MHT-fájlokat programozottan DOCX-re kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és konvertálhatják az MHT-t DOCX-re, mindössze néhány sornyi kóddal.
...
1.  Alakítsa át az MHT-t DOCX-re a Workbook.Save metódus meghívásával.
1. Szerezd meg az MHT DOCX számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT DOCX-re konvertálásához" %}}
