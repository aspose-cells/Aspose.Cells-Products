...
{{% blocks/products/pf/agp/content h2="Сохранить XML в NUMBERS в C++ онлайн бесплатно" %}}

В следующем примере показано, как преобразовать XML в NUMBERS в C++.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XML в NUMBERS через C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ разработчиков могут легко преобразовать XML в NUMBERS, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл XML с помощью Factory::CreateIWorkbook.
1. Преобразуйте XML в NUMBERS, вызвав метод Save().

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ библиотека для преобразования XML в NUMBERS" %}}
