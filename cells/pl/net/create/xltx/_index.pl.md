...
{{% blocks/products/pf/agp/content h2="Jak utworzyć XLTX za pośrednictwem C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod do tworzenia pliku MS Excel XLTX przy użyciu C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteka do utworzenia pliku XLTX" %}}
