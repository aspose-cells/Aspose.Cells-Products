---
title:  Chroń i blokuj dokument ODS via .NET
weight: 5580
description: C# kod źródłowy do zablokowania pliku ODS przy użyciu hasła na platformach .NET Framework, .NET Core, Mono lub Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Zaszyfruj pliki ODS przez C#" h2="Zabezpiecz hasłem arkusze kalkulacyjne programu Excel, w tym format ODS, korzystając z biblioteki .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1.  Utwórz instancję klasy Workbook ze ścieżką do pliku ODS
