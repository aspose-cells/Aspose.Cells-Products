...
{{< blocks/products/pf/i18n/upper-banner h1="XLS konvertálása ODS-re a következőn keresztül: Python" h2="Exportáljon Excel® táblázatokat ODS formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az XLS konvertálása ODS-vé a következővel: Python" %}}

 Az XLS ODS-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS-ből ODS-vé konvertálás lépései a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen betölthetnek és konvertálhatnak XLS-fájlokat ODS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal átadása ODS kiterjesztéssel, mint paraméterrel1. Ellenőrizze az eredményül kapott ODS-fájl megadott elérési útját
