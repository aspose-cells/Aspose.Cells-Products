---
title:  Tìm kiếm và thay thế văn bản trong tài liệu ODS via Java
weight: 9210
...
{{< blocks/products/pf/i18n/upper-banner h1="Viết lại ODS Định dạng trong Java" h2="Bản gốc và hiệu suất cao ODS ghi lại thông tin biên tập nhạy cảm bằng cách sử dụng API Aspose.Cells for Java phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách xác định lại tệp ODS bằng Java" %}}

 Để sắp xếp lại tệp ODS, chúng tôi sẽ sử dụng
 [Aspose.Cells for Java](https://products.aspose.com/cells/java) 
 API là một nền tảng soạn thảo nhiều tính năng, mạnh mẽ và dễ sử dụng API for Java. Bạn có thể tải xuống phiên bản mới nhất của nó trực tiếp từ
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để xác định lại tệp ODS trong Java" %}}
...
+ Tải file ODS.
+ Chọn sheet liên quan.
+ Xác định và Specity FindOptions.
+ Chỉ định phạm vi mà bạn muốn tìm kiếm
...
{{< blocks/products/pf/agp/other-supported-section title="Các tài liệu biên tập được hỗ trợ khác" subTitle="Sử dụng Java, người ta có thể dễ dàng sắp xếp lại các định dạng khác nhau bao gồm." >}}
