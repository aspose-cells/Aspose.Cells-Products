---
title: Python XLSX 에서 ET - XLSX 에서 ET 변환기
description: Aspose 엑셀. Aspose.Cells을 사용하여 XLSX을 ET로 빠르고 쉽게 변환하세요. Python XLSX을 ET로 변환하세요. Python ET에 XLSX을 저장합니다. Python을 사용하여 XLSX을 ET로 저장합니다.
...
{{% cells-convert title="XLSX을 ET로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="et" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="XLSX을 ET로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 XLSX 파일을 ET로 변환해야 합니까? Python 개발자는 단 몇 줄의 코드만으로 XLSX을 쉽게 로드하고 ET로 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2="Python 라이브러리를 사용하여 XLSX을 ET로 변환" %}}
