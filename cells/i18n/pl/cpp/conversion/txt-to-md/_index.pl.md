---
title: Konwertuj TXT na MD za pomocą aplikacji C++ 
url: /pl/cpp/conversion/txt-to-md/ 
description: Przykładowy kod konwersji C++ dla dokumentu TXT do formatu MD. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TXT na MD w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TXT na MD przez C++" h2="Wydajna konwersja TXT do MD przy użyciu biblioteki C++ bez konieczności instalowania Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TXT na MD w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TXT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (MD).1. Plik MD zostanie zapisany pod określoną ścieżką.1. Otwórz plik MD w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji TXT do MD C++" offSpacer="" %}}
