...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLTM do formátu uložení OTS. C# Zkombinujte XLTM do formátu OTS. Sloučit XLTM do OTS v C#. XLTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTM na OTS v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTM do OTS v C#" InputFormat="xltm" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
