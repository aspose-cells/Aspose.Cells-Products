---
title:  ใส่ช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 30
description: Python via ซอร์สโค้ด .Net เพื่อแทรกช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการใส่ CheckBox (Form control) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_check_box/#int-int-int-int-int-int) เพื่อแทรกช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกช่องทำเครื่องหมาย(การควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
