...
{{% blocks/products/pf/agp/content h2="Как вставить/создать блок-схему в файл Excel с помощью Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке/созданию файла блок-схемы в Excel с помощью Python via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Вставить/создать блок-схему — Python via Java" offSpacer="" %}}
