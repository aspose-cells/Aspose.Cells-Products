---
title:  Hợp nhất TXT Tệp via .NET
weight: 7350
description: Mã nguồn C# để gộp TXT tài liệu trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng TXT trong C#" h2="Hợp nhất tài liệu gốc và hiệu suất cao TXT bằng API Aspose.Cells for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước gộp file TXT vào C#" %}}
...
+ Load toàn bộ file TXT có đường dẫn đầy đủ.
+ Tạo một tài liệu làm tập tin cơ sở
+ Gọi các phương thức liên quan để nối, gộp từng file một.
+ Gọi phương thức Save() và truyền tham số tên file (đường dẫn đầy đủ) và định dạng (TXT).
+ Bây giờ bạn có thể mở và sử dụng file TXT trong Microsoft Office, Adobe PDF hoặc bất kỳ chương trình tương thích nào khác.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tập tin TXT - C#" offSpacer="" %}}
