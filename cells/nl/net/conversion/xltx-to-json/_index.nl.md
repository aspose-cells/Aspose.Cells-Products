...
description: Aspose Excel. Converteer XLTX snel en eenvoudig naar JSON met Aspose.Cells. C# XLTX naar JSON. C# Bewaar XLTX in JSON. Bewaar XLTX als 07611134 81 via C#.
...
{{% blocks/products/pf/agp/content h2="Bewaar XLTX t/m JSON in C#" %}}

Het volgende voorbeeld laat zien hoe u XLTX converteert naar JSON in C#.
