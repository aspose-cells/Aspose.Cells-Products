---
title: แทรก ActiveX Control ลงใน Excel โดยใช้ Python via Java
weight: 10
description: ซอร์สโค้ด Python via Java เพื่อแทรก ActiveX Control ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกตัวควบคุม ActiveX ลงในไฟล์ Excel โดยใช้ Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก ActiveX Control ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกตัวควบคุม ActiveX ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก ActiveX Control - Python via java" offSpacer="" %}}
