---
title: Συγχώνευση XLSM στο WORD - Συνδυάστε το XLSM στο WORD στο C#
url: /el/net/merger/merge-xlsm-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Δωρεάν online συγχώνευση XLSM σε μορφή αποθήκευσης WORD. C# Συνδυάστε το XLSM σε μορφή WORD. Συγχώνευση XLSM στο WORD στο C#. XLSM Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLSM στο WORD στο C# Δωρεάν Online" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLSM στο WORD στο Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Θέλετε να συγχωνεύσετε το XLSM στο WORD μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2=".NET βιβλιοθήκη για συγχώνευση XLSM στο WORD" %}}
