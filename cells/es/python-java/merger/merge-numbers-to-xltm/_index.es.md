---
title:  Combinar NÚMEROS a XLTM a través de Python
url: /es/python-java/merger/merge-numbers-to-xltm/ 
description: Combine NÚMEROS al XLTM en línea de forma gratuita. NÚMEROS en Línea Gratis al XLTM Fusión. Combinar NÚMEROS a Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo fusionar NÚMEROS a XLTM en Python.
...
{{% cells-merger title="Aplicación gratuita para unir NÚMEROS al XLTM en línea" InputFormat="numbers" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
