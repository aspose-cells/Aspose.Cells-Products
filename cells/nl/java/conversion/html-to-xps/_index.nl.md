...
{{% blocks/products/pf/agp/content h2="Sla HTML op in XPS in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar XPS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar XPS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar XPS? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar XPS met slechts een paar regels code.
