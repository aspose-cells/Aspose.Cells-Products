...
description: Aspose اكسل. قم بتحويل MHT إلى XLTX بسرعة وسهولة باستخدام Aspose.Cells. C++ MHT إلى XLTX. C++ احفظ MHT إلى XLTX. احفظ MHT كـ XLTX باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على XLTX في C++" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى XLTX عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى XLTX برمجياً؟ يمكن لمطوري C++ تحويل MHT بسهولة إلى XLTX في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLTX عن طريق استدعاء طريقة Save ().
