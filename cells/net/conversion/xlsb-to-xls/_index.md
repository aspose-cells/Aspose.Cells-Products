---
title: Convert XLSB to XLS via C# 
weight: 7810
url: /net/conversion/xlsb-to-xls/ 
description: Sample code for XLSB to XLS C# conversion. Use API example code for batch XLSB files to XLS conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert XLSB files to XLS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XLSB to XLS C# Conversion" offSpacer="" %}}
