---
title: C# XLSX na TABDELIMITED - XLSX na TABDELIMITED Konwerter
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSX na TABDELIMITED za pomocą Aspose.Cells. C# XLSX na TABDELIMITED. C# Zapisz XLSX w TABDELIMITED. Zapisz XLSX jako TABDELIMITED, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSX w TABDELIMITED w C#" %}}

Poniższy przykład ilustruje sposób konwersji XLSX na TABDELIMITED w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLSX na TABDELIMITED. Prześlij plik XLSX, a następnie po prostu zapisz go jako plik TABDELIMITED. Zarówno do odczytu XLSX, jak i do zapisu TABDELIMITED można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowe TABDELIMITED będą identyczne z oryginalnym dokumentem XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLSX na TABDELIMITED" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na TABDELIMITED przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSX na TABDELIMITED? Programiści .NET mogą z łatwością załadować i przekonwertować XLSX na TABDELIMITED w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLSX na TABDELIMITED" %}}
