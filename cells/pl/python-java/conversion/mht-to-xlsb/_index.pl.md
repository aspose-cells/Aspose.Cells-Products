...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na XLSB za pomocą Aspose.Cells. Python MHT na XLSB. Python Zapisz MHT na XLSB. Zapisz MHT jako XLSB, używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem XLSB w Python" %}}

Poniższy przykład ilustruje sposób konwersji MHT na XLSB w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji MHT na XLSB" %}}
