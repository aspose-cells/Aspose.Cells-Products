...
{{% blocks/products/pf/agp/content h2="Převeďte ČÍSLA na PDF pomocí Python" %}}
...
Následující příklad ukazuje, jak převést ČÍSLA na PDF v Python.
