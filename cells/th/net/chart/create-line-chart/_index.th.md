...
1. รวม Aspose.Cells เนมสเปซ1. สร้าง [**สมุดงาน**](https://apireference.aspose.com/cells/net/aspose.cells/workbook) อินสแตนซ์ของคลาส1. เพิ่มข้อมูลลงในเวิร์กชีต1. เพิ่ม [**เส้น**](https://apireference.aspose.com/cells/net/aspose.cells.charts/charttype) แผนภูมิไปยังแผ่นงาน1. เข้าถึงใหม่ [**แผนภูมิ**](https://apireference.aspose.com/cells/net/aspose.cells.charts/chart) วัตถุ.1. ระบุแหล่งข้อมูลของแผนภูมิด้วย [**Chart.SetChartDataRange**](https://https://apireference.aspose.com/cells/net/aspose.cells.charts/chart/methods/setchartdatarange) กระบวนการ.
