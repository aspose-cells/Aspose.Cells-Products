...
weight: 50
description: Kode sumber C# untuk memasukkan ListBox ke Excel pada Kerangka .NET, .NET Core, Mono atau Platform Xamarin.
keywords: [C# Aspose.Cells., c# add ListBox into Excel., c# insert ListBox into Excel., c# create ListBox in Excel]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan ListBox ke Excel via .NET" h2="Masukkan ListBox menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan ListBox ke File Excel Menggunakan C#" %}}
 ...
 Untuk memasukkan ListBox ke file excel, kami akan menggunakan
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[tambahkan metode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addlistbox) untuk menyisipkan ListBox di lembar kerja yang dipilih
...
{{% blocks/products/pf/agp/code-block title="Sisipkan Kotak Daftar - C#" offSpacer="" %}}
