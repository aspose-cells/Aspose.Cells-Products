---
title:  ป้องกันและล็อค XLSB เอกสารผ่าน C++
weight: 4860
description: รหัสตัวอย่าง C++ เพื่อล็อกไฟล์ XLSB โดยใช้รหัสผ่านบน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="เข้ารหัสไฟล์ XLSB ผ่าน C++" h2="ป้องกันด้วยรหัสผ่านสเปรดชีต Excel รวมถึงรูปแบบ XLSB โดยใช้ .NET Library" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการป้องกันไฟล์ XLSB ผ่าน C++" %}}
...
1.  โหลดไฟล์ XLSB โดยใช้คลาส IWorkbook
1.  ใช้วิธี Protect(..) กับ ProtectionType และ Password
1.  บันทึกไฟล์ XLSB ที่ได้รับการป้องกันโดยวิธี Save()
