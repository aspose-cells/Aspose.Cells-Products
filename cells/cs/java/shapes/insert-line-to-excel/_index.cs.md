---
title:  Vložit řádek do Excelu via Java
weight: 30
...
{{< blocks/products/pf/i18n/upper-banner h1="Vložit řádek do Excelu via Java" h2="Vkládejte objekty pomocí rozhraní API na straně serveru bez jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF atd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit řádek do souboru aplikace Excel pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Postup vložení řádku do souboru Excel via Java" %}}
...
+ Vyberte List přes jeho index.
 + Použijte[přidat metodu](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) pro vložení řádku do vybraného listu
...
{{% blocks/products/pf/agp/code-block title="Vložit řádek – Java" offSpacer="" %}}
