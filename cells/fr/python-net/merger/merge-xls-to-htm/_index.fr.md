---
title: Fusionner XLS avec HTM - Combiner XLS avec HTM dans Python
url: /fr/python-net/merger/merge-xls-to-htm/ 
description: Aspose Exceller. Python Aspose.Cells. Fusionner XLS au format de sauvegarde HTM. Python Combinez XLS au format HTM. Fusionner XLS avec HTM dans Python. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS avec HTM en utilisant Python" %}}

 Comment fusionner XLS avec HTM ? Avec la bibliothèque Aspose.Cells for Python via .NET, vous pouvez facilement fusionner XLS avec HTM par programme avec quelques lignes de code.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie. Vous pouvez installer Aspose.Cells for Python via .NET à partir de<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , utilisez la commande comme :<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Fusionner XLS avec HTM dans Python" %}}

L'exemple suivant montre comment fusionner XLS avec HTM dans Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLS avec HTM. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier HTM. Si vous développez du code en Python, ce sera plus simple qu'il n'y paraît. Voir l'exemple Python qui fusionne XLS avec HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner XLS avec HTM dans Python" InputFormat="xls" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS avec HTM via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner XLS avec HTM par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner XLS avec HTM" %}}
