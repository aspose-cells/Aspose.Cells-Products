---
title: Convertir XLSB en SVG C#
description: Convertissez XLSB en SVG en ligne gratuitement. Convertisseur en ligne gratuit XLSB à SVG. C# XLSB à SVG. XLSB à SVG via C#.
keywords: Convert XLSB, XLSB Converter, XLSB to PDF, XLSB to Word, XLSB to PPT, XLSB to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en SVG via C#" h2="Bibliothèque C# haute vitesse pour convertir XLSB en SVG. Exportez des feuilles de calcul Excel au format SVG sur .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à SVG dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en SVG en C#.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir XLSB en SVG en quelques lignes de code.
