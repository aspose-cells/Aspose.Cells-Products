---
title:  Samenvoegen CSV Bestanden via .NET
weight: 6450
description: C#-broncode om CSV-documenten te combineren op .NET Framework, .NET Core, Mono of Xamarin-platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg CSV-formaten samen in C#" h2="Native en krachtige CSV-documentfusie met behulp van server-side Aspose.Cells for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
+ Laad alle CSV-bestanden met volledig pad.
...
+ Roep de Save()-methode aan en geef de bestandsnaam (volledig pad) en formaat (CSV) door als parameter.
+ Nu kunt u het bestand CSV openen en gebruiken in Microsoft Office, Adobe PDF of een ander compatibel programma.
