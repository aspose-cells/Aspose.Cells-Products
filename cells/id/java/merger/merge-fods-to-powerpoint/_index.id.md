---
title: Gabung FODS ke POWERPOINT - Gabungkan FODS ke POWERPOINT di Java
url: /id/java/merger/merge-fods-to-powerpoint/ 
description: Aspose Unggul. Java Aspose.Cells. Gabung Online Gratis FODS ke saveformat POWERPOINT. Java Gabungkan FODS ke format POWERPOINT. Gabung FODS ke POWERPOINT di Java. FODS Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS ke POWERPOINT di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan FODS ke POWERPOINT di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan FODS ke POWERPOINT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file POWERPOINT. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan FODS ke POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis Menggabungkan FODS ke POWERPOINT di Java" InputFormat="fods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS ke POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke POWERPOINT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk menggabungkan FODS ke POWERPOINT" %}}
