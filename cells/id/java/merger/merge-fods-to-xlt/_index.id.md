---
title: Gabung FODS ke XLT - Gabungkan FODS ke XLT di Java
url: /id/java/merger/merge-fods-to-xlt/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge FODS to XLT saveformat. Java Gabungkan format FODS menjadi XLT. Gabung FODS ke XLT di Java. FODS Gabung.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan FODS menjadi XLT via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan FODS ke XLT. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="FODS" additionalConversionTag="XLT" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabung FODS ke XLT di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan FODS ke XLT di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan FODS ke XLT di Java" InputFormat="fods" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS ke XLT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS menjadi XLT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan FODS ke XLT" %}}
