---
title: Java من EXCEL إلى TABDELIMITED - محول من EXCEL إلى TABDELIMITED
description: Aspose اكسل. قم بتحويل EXCEL إلى TABDELIMITED بسرعة وسهولة باستخدام Aspose.Cells. Java EXCEL إلى TABDELIMITED. Java احفظ EXCEL في TABDELIMITED. احفظ EXCEL باسم TABDELIMITED باستخدام Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل EXCEL إلى TABDELIMITED في Java" h2="مكتبة Java عالية السرعة لتحويل EXCEL إلى TABDELIMITED. يعد هذا حلاً برمجيًا احترافيًا لاستيراد وتصدير EXCEL وTABDELIMITED والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ EXCEL في TABDELIMITED في Java" %}}

يوضح المثال التالي كيفية تحويل EXCEL إلى TABDELIMITED في Java.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل EXCEL إلى TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات EXCEL إلى TABDELIMITED برمجياً؟ يمكن للمطورين Java تحويل EXCEL إلى TABDELIMITED بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل EXCEL إلى TABDELIMITED" %}}
{{% blocks/products/pf/agp/text %}}
