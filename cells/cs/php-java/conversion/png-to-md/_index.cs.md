---
title: Převodník PHP PNG na MD – PNG na MD
description: Aspose Excel. Převeďte PNG na MD rychle a snadno pomocí Aspose.Cells. PHP PNG na MD. PHP Uložit PNG na MD. Uložte PNG jako MD pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na MD přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést PNG soubory na MD programově? Vývojáři PHP mohou snadno načíst a převést PNG na MD v několika řádcích kódu.
...
1.  Převeďte PNG na MD voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na MD" %}}
