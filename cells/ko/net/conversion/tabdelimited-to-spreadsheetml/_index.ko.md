...
description: Aspose Excel. 이 포괄적인 솔루션은 C# 개발자에게 탭으로 구분된 데이터를 SPREADSHEETML 형식으로 변환하는 완벽하게 통합된 접근 방식을 제공하여 Aspose.Cells 라이브러리를 사용하여 탭으로 구분된 데이터를 SPREADSHEETML 형식으로 원활하게 저장할 수 있도록 하며, 이 모든 작업은 효율적이고 사용자 정의 가능한 C# 코드를 통해 이루어집니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 TABDELIMITED를 SPREADSHEETML로 변환합니다." h2="탭 구분 형식을 SPREADSHEETML 형식으로 고속 변환하는 C# 라이브러리입니다. 이 전문 소프트웨어 솔루션은 .NET 프레임워크, .NET 코어 또는 Mono 플랫폼에서 탭 구분 형식, SPREADSHEETML 및 기타 여러 형식을 가져오고 내보낼 수 있도록 지원합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="C#을 사용하여 TABDELIMITED를 SPREADSHEETML로 변환합니다." %}}
...
{{% blocks/products/pf/agp/content h2="C#에서 TABDELIMITED를 SPREADSHEETML로 저장" %}}
...
1.  Workbook.Save 메서드를 호출하여 TABDELIMITED 형식을 SPREADSHEETML 형식으로 변환합니다.
1.  TABDELIMITED를 SPREADSHEETML로 변환한 결과를 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 라이브러리는 TABDELIMITED를 SPREADSHEETML로 변환합니다." %}}
