...
description: Aspose Excel. Convierta OTS a JPEG rápida y fácilmente con Aspose.Cells. Python OTS a JPEG. Python Guarde OTS en JPEG. Guarde OTS como JPEG usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar OTS al JPEG en Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a JPEG en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir OTS a JPEG" %}}
