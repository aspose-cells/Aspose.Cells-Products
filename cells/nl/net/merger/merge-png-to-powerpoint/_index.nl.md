...
url: /nl/net/merger/merge-png-to-powerpoint/ 
...
Het volgende voorbeeld laat zien hoe u PNG kunt samenvoegen met POWERPOINT in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u PNG programmatisch samenvoegen met POWERPOINT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen met POWERPOINT" %}}
