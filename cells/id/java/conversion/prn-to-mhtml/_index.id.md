...
description: Aspose Unggul. Ubah PRN menjadi MHTML dengan cepat dan mudah menggunakan Aspose.Cells. Java PRN menjadi MHTML. Java Simpan PRN ke MHTML. Simpan PRN sebagai MHTML menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah PRN menjadi MHTML di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi PRN ke MHTML. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, MHTML, dan banyak format lain menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Ubah PRN menjadi MHTML Menggunakan Java" %}}
...
Contoh berikut menunjukkan cara mengonversi PRN ke MHTML di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PRN menjadi MHTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke MHTML secara terprogram? Pengembang Java dapat dengan mudah mengonversi PRN menjadi MHTML hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk mengonversi PRN menjadi MHTML" %}}
{{% blocks/products/pf/agp/text %}}
