...
{{% blocks/products/pf/agp/content h2="Come convertire NUMBERS in SXC utilizzando Java" %}}

 Per rendere NUMBERS a SXC, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire NUMBERS in SXC tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente i file NUMBERS in SXC in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file NUMBERS con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione SXC e SaveFormat come parametri1. Controllare il percorso specificato per il file SXC risultante
...
{{% blocks/products/pf/agp/code-block title="NUMBERS in SXC Java codice sorgente di conversione" offSpacer="" %}}

```cs
// caricare il file NUMBERS in un'istanza di Workbook
Workbook book = new Workbook("template.numbers");
// salva NUMBERS come SXC
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS alle demo dal vivo di conversione SXC" sectionDescription="[Converti NUMBERS in SXC](https://products.aspose.app/cells/conversion/numbers-to-sxc) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file NUMBERS, verrà convertito istantaneamente in SXC." >}}
