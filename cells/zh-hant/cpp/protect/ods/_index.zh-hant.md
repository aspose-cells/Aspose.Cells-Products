...
1. 使用IWorkbook類加載ODS文件
1. 使用帶有 ProtectionType 和密碼的 Protect(..) 方法
1. 通過Save()方法保存受保護的ODS文件
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="免費保護應用程序 ODS" sectionDescription="查看我們的現場演示[加密ODS文件](https://products.aspose.app/cells/protect/ods)具有以下好處。" >}}
