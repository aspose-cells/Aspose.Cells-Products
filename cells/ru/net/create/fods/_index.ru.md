...
description: Aspose Excel. Легко создавайте и обрабатывайте файлы FODS с помощью библиотеки Aspose.Cells for .NET. Эта мощная библиотека API предоставляет оптимизированное и эффективное решение для создания, редактирования и управления файлами FODS непосредственно в ваших приложениях C#, удовлетворяя специфические потребности разработчиков с высокой точностью.
...
1.  Используйте метод Save, чтобы сохранить книгу как файл FODS.
