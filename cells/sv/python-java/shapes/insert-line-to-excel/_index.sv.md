...
{{% blocks/products/pf/agp/content h2="Hur man infogar rad i Excel-fil med Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga rad till Excel-fil med Python via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) för att infoga en rad i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga linje - Python via Java" offSpacer="" %}}
