...
description: Aspose اكسل. قم بتحويل IMAGE إلى JPEG بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى JPEG. C++ احفظ IMAGE إلى JPEG. احفظ IMAGE كـ JPEG باستخدام C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصورة إلى JPEG في C++" h2="تحويل IMAGE عالي الأداء إلى JPEG باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل الصورة إلى JPEG باستخدام C++" %}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى JPEG برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى JPEG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى JPEG عن طريق استدعاء طريقة Save().
1.  احصل على نتيجة تحويل IMAGE إلى JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل IMAGE إلى JPEG" %}}
