---
title: ODS tài liệu chart qua C++
weight: 3820
description: C++ mã ví dụ để vẽ và chuyển đổi biểu đồ hoặc sơ đồ trong tệp ODS trên Môi trường thời gian chạy C++ cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS Định dạng Biểu đồ trong C++" h2="Biểu đồ tài liệu gốc và hiệu suất cao ODS sử dụng API Aspose.Cells for C++ phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tạo biểu đồ tệp ODS bằng C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo biểu đồ tệp ODS trong C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Tạo Biểu Đồ Tệp ODS - C++" offSpacer="" %}}
