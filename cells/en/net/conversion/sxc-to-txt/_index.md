...
{{% cells-convert title="Free App and Sample Code to Convert SXC to TXT Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert SXC to TXT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert SXC to TXT in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load SXC file with an instance of Workbook
1.  Convert SXC to TXT by calling Workbook.Save method

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# library to convert SXC to TXT" %}}
