...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod HTML na XLSB online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlsb" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak převést HTML na XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést HTML na XLSB v několika řádcích kódu.
