---
title: Vložte poznámky do souboru ODS přes Python
url: /cs/python-java/notes/insert-notes-to-ods/ 
description: Vložte poznámky do ODS pomocí Python. Použijte ukázkový kód API pro vložení poznámek do aplikace Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Vložte poznámky do souboru ODS přes Python" h2="Vytvořte si vlastní aplikaci Python pro manipulaci s komentáři a autory v souborech dokumentů pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit poznámky do souboru ODS přes Python" %}}
...
V Office 365 jsou poznámky pro anotace, můžete použít následující kód Python pro vkládání a odebírání poznámek v souboru ODS.

{{% blocks/products/pf/agp/code-block title="Python ukázkový kód pro vložení a odstranění poznámek v souboru ODS" offSpacer="" %}}
