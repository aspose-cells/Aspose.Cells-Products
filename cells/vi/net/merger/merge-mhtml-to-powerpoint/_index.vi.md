---
title: Gộp MHTML vào POWERPOINT - Gộp MHTML vào POWERPOINT trong C#
url: /vi/net/merger/merge-mhtml-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất MHTML vào định dạng lưu POWERPOINT. C# Kết hợp MHTML thành định dạng POWERPOINT. Hợp nhất MHTML vào POWERPOINT trong C#. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Gộp MHTML vào POWERPOINT trong C#" %}}

Ví dụ sau đây minh họa cách hợp nhất MHTML với POWERPOINT trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất MHTML vào POWERPOINT. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp POWERPOINT. Nếu bạn phát triển mã theo số C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất MHTML với POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp MHTML vào POWERPOINT trong C#" InputFormat="mhtml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp MHTML vào POWERPOINT qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất MHTML vào POWERPOINT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp MHTML vào POWERPOINT" %}}
