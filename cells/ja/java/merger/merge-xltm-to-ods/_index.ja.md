...
description: Aspose エクセル。 Java Aspose.Cells。XLTM を ODS の保存形式にマージします。 Java XLTM と ODS の形式を結合します。 XLTM から ODS を Java に結合します。XLTM を結合します。
