---
title: تحويل JSON إلى XPS عبر Python

description: نموذج كود لتحويل json إلى xps Python. استخدم API رمز المثال لملفات json الدفعية لتحويل xps داخل تطبيق Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل JSON إلى XPS عبر Python" h2="تصدير جداول بيانات Excel® إلى تنسيق XPS باستخدام Python واجهات برمجة التطبيقات." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JSON إلى XPS باستخدام Python" %}}

 من أجل تحويل JSON إلى XPS ، سوف نستخدم ملفات
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل JSON إلى XPS عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Python تحميل ملفات JSON وتحويلها بسهولة إلى XPS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف JSON بنسخة من المصنف1. اتصل بـ Workbook.Save method1. قم بتمرير مسار الإخراج بامتداد XPS كمعامل1. تحقق من المسار المحدد لملف XPS الناتج
...
{{% cells-convert title="تطبيق مجاني ونموذج رمز لتحويل JSON إلى XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="xps" IsLandingPage="true" language="python" %}}
