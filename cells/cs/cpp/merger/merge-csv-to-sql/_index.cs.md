...
url: /cs/cpp/merger/merge-csv-to-sql/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit CSV do SQL saveformat. C++ Zkombinujte CSV do formátu SQL. Sloučit CSV do SQL v C++. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV do SQL v C++" %}}

Následující příklad ukazuje, jak sloučit CSV do SQL v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení CSV do SQL v C++" InputFormat="csv" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV do SQL přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit CSV s SQL programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení CSV do SQL" %}}
