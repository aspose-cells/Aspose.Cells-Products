...
{{% blocks/products/pf/agp/content h2="Jak vložit komentáře do souboru ODS přes C#" %}}
...
Office 365 jsou komentáře pro konverzace, můžete použít následující kód C# pro vkládání a odstraňování komentářů v souboru ODS.

{{% blocks/products/pf/agp/code-block title="C# ukázkový kód pro vložení a odstranění komentářů v souboru ODS" offSpacer="" %}}
