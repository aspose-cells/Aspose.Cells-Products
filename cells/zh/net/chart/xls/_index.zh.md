---
title:  通过 .NET 将 XLS 文档图表转换为图像 
weight: 3210
url: /zh/net/chart/xls/ 
description: C# 用于在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上绘制和转换 XLS 文件中的图表或图表的源代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS 文件图表到 C# 中的图像" h2="使用服务器端 API 将原生和高性能 XLS 文档图表转换为图像，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中转换 XLS 文件图表的步骤" %}}
