...
keywords: [Merge PRN to XPS via C#., PRN to XPS Merger., Merge PRN to XPS Online for Free]
---
...
The following example demonstrates how to merge PRN to XPS in C#.
...
{{% cells-merger title="Free App to merge PRN to XPS on line" InputFormat="prn" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
