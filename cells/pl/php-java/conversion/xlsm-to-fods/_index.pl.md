...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom PHP w pełni zintegrowane podejście do konwersji formatu XLSM do FODS, umożliwiając bezproblemowe zapisywanie danych XLSM do formatu FODS za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi PHP.
...
Potrzebujesz programowo przekonwertować pliki XLSM na FODS? Programiści PHP mogą łatwo załadować i przekonwertować pliki XLSM na FODS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLSM na FODS wywołując metodę save obiektu Workbook.
