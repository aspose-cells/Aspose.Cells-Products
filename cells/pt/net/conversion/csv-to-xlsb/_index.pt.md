---
title: C# CSV para XLSB - Online CSV para XLSB Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter CSV para XLSB saveformat. C# CSV a XLSB formato. Salve CSV a XLSB C#.
...
{{% blocks/products/pf/agp/content h2="Salve CSV a XLSB em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter CSV em XLSB em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter CSV em XLSB. Carregue seu arquivo CSV e salve-o como arquivo XLSB. Tanto para a leitura CSV quanto para a escrita XLSB, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação de saída XLSB serão idênticos ao documento CSV original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter CSV em XLSB online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="xlsb" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter CSV para XLSB via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos CSV para XLSB programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter CSV em XLSB em apenas algumas linhas de código.
...
1.  Converta CSV em XLSB chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de CSV para XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para converter CSV em XLSB" %}}
