...
{{% blocks/products/pf/agp/content h2="Så här säkrar du XLSM-fil med Java" %}}
...
1. Ladda XLSM-fil genom att instansiera Workbook-klassen1. Använd protect(..)-metoden med ProtectionType och Password1. Spara den skyddade XLSM-filen med save()-metoden
