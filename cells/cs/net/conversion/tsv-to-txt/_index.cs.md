...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TSV na TXT prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory TSV na TXT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí sešitu1. Zavolejte metodu Workbook.Save1. Jako parametr předejte výstupní cestu s příponou TXT1. Zkontrolujte zadanou cestu pro výsledný soubor TXT
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod TSV na TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="txt" IsLandingPage="true" %}}
