---
title: 通过 Java 将 XLS 转换为 XML 

description: XLS 格式到 XML 文件的示例 Java 转换代码。程序员可以使用此示例代码在任何基于 Web 或桌面 Java 的应用程序中将 Excel 和 OpenOffice 电子表格导出为 XML。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 XLS 转换为 XML" h2="XLS 到 XML Java 转换以使用内部部署 Java 库将单个或多个页面转换为 XML。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 XLS 转换为 XML" %}}

 为了将 XLS 渲染为 XML，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 XLS 转换为 XML 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Java 开发人员只需几行代码即可轻松地将 XLS 文件转换为 XML。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 类的实例加载 XLS 文件1. 调用 Workbook.save 方法1. 将带有 XML 扩展名和 SaveFormat 的输出路径作为参数传递1. 检查生成的 XML 文件的指定路径
...
{{% blocks/products/pf/agp/code-block title="XLS 到 XML Java 转换源代码" offSpacer="" %}}
