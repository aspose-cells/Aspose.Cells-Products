...
description: Sample code for TXT to XLSB C# conversion. Use API example code for batch TXT files to XLSB conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells makes it easy for the developers to load & convert TXT files to XLSB in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows TXT to XLSB C# Conversion" offSpacer="" %}}
