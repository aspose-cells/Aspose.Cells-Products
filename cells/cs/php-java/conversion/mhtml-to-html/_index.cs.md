---
title: Konvertor PHP MHTML až HTML - MHTML až HTML
description: Aspose Excel. Převeďte MHTML na HTML rychle a snadno pomocí Aspose.Cells. PHP MHTML na HTML. PHP Uložte MHTML na HTML. Uložte HTML jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na HTML přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na HTML programově? Vývojáři PHP mohou snadno načíst a převést MHTML na HTML v několika řádcích kódu.
...
1.  Převeďte MHTML na HTML voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na HTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na HTML" %}}
