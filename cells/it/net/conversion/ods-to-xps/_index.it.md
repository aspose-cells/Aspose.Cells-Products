---
title: C# ODS a XPS - ODS a XPS Convertitore
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori C# un approccio completamente integrato per convertire il formato ODS nel formato XPS, consentendo il salvataggio senza interruzioni dei dati ODS nel formato XPS utilizzando la libreria Aspose.Cells, il tutto tramite codice C# efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva ODS a XPS in C#" %}}

L'esempio seguente mostra come convertire ODS in XPS in C#.
...
{{% blocks/products/pf/agp/content h2="Come convertire ODS in XPS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file ODS in XPS a livello di codice? Gli sviluppatori .NET possono caricare e convertire facilmente ODS in XPS in poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria C# per convertire ODS in XPS" %}}
