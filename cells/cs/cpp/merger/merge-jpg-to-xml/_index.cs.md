...
url: /cs/cpp/merger/merge-jpg-to-xml/ 
...
Následující příklad ukazuje, jak sloučit JPG do XML v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit JPG do XML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení JPG do XML" %}}
