---
title: Java OTS 至 TSV - OTS 至 TSV 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 TSV。Java OTS 轉換為 TSV。Java 將 OTS 儲存為 TSV。Java 將 OTS 儲存為 TSV。Java 將 OTS 儲存為 TSV。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Java 中的 OTS 轉換為 TSV" h2="用於將 OTS 轉換為 TSV 的高速 Java 庫。這是一個使用 Java 導入和導出 OTS、TSV 和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將OTS保存到Java中的TSV" %}}

以下範例示範如何將 Java 中的 OTS 轉換為 TSV。
...
{{% cells-convert title="將 OTS 轉換為 TSV 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 OTS 轉換為 TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 OTS 檔案轉換為 TSV？ Java 開發人員只需幾行程式碼即可輕鬆將 OTS 轉換為 TSV。
