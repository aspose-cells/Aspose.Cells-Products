...
{{% blocks/products/pf/agp/code-block title="Rechercher des fichiers XLSM - Java" offSpacer="" %}}

```cs
// Instanciation d'un objet Workbook
Workbook workbook = new Workbook(dataDir + "book1.xlsm");

// Accéder à la première feuille de calcul du fichier XLSM
