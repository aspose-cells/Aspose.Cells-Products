---
title: C# XLTX MD-hez - XLTX MD konverterhez
description: Aspose Excel. A XLTX számot gyorsan és egyszerűen konvertálja MD-re a Aspose.Cells-es számmal. C# XLTX MD-vé. C# Takarítson meg XLTX-et az MD-nek. Mentse el a XLTX számot MD-ként a C# használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLTX számot az MD számára a C# számon" %}}
...
{{% cells-convert title="Mintakód a XLTX MD-vé konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="md" IsLandingPage="true" %}}
