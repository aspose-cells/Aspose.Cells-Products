---
title: Dividir archivos XLSM a través de .NET 
weight: 8890
url: /es/net/splitter/xlsm/ 
description: C# código fuente para dividir documentos XLSM en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Cómo dividir un archivo XLSM usando C#" %}}
...
+ Cargue el archivo XLSM con la ruta completa para dividir.
...
{{% blocks/products/pf/agp/code-block title="Dividir archivo XLSM - C#" offSpacer="" %}}
