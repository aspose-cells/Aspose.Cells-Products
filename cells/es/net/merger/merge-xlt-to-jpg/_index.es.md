---
title: Combinar XLT a JPG - Combinar XLT a JPG en C#
url: /es/net/merger/merge-xlt-to-jpg/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea XLT a JPG guardar formato. C# Combine XLT en formato JPG. Combinar XLT a JPG en C#. XLT Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLT a JPG en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLT con JPG en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLT a JPG. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo JPG. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que fusiona XLT con JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLT a JPG en C#" InputFormat="xlt" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLT a JPG a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar XLT con JPG mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar XLT a JPG" %}}
