---
title: Python XLS - AZW3 - XLS - AZW3 átalakító
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a Python fejlesztők számára a XLS AZW3 formátumba konvertálásához, lehetővé téve a XLS adatok zökkenőmentes mentését AZW3 formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható Python kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="Alakítsa át a XLS-et AZW3-má a Python Excel könyvtárban" h2="Nagy sebességű Python Excel könyvtár a XLS AZW3 formátumba konvertálásához. Ez egy professzionális szoftvermegoldás a XLS, AZW3 és sok más formátum importálására és exportálására a Python használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="AZW3" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="A XLS-es szám konvertálása AZW3-má a Python Excel könyvtár használatával" %}}

 Hogyan konvertálhatom a XLS-et AZW3-má? A Aspose.Cells for Python könyvtárral könnyedén konvertálhatod a XLS-et AZW3-má programozottan, néhány sornyi kóddal.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)képes többplatformos alkalmazások létrehozására, amelyek képesek az összes Excel fájl generálására, módosítására, konvertálására, renderelésére és nyomtatására. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mentse el a XLS-es kódot AZW3-ba a Python Excel könyvtárban" %}}

A következő példa bemutatja, hogyan konvertálhatja a XLS-et AZW3-má a Python Excel könyvtárban.
...
{{% cells-convert title="Mintakód a XLS AZW3-ra konvertálásához a Python Excel könyvtár segítségével" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="azw3" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hogyan lehet a XLS-et AZW3-má konvertálni a Python-en keresztül?" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell XLS fájlokat AZW3 formátumba konvertálni? A Python fejlesztők könnyedén betölthetik és konvertálhatják a XLS fájlokat AZW3 formátumba mindössze néhány sor kóddal.
...
1.  Alakítsd át a XLS-et AZW3-má a Workbook.save metódus meghívásával.
1.  Szerezd meg a XLS AZW3-ra való átváltási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel könyvtár a XLS AZW3-ra konvertálásához" %}}
