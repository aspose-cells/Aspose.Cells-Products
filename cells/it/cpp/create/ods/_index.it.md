...
url: /it/cpp/create-ods/ 
description: C++ Codice di esempio per la generazione di file ODS (Openoffice / Lbreoffice). Usa questo codice per creare file ODS (Openoffice / Lbreoffice) all'interno di un'applicazione basata su C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crea file ODS tramite C++" h2="Creazione di fogli di lavoro ODS (Openoffice / Lbreoffice) nativi e ad alte prestazioni in modo programmatico senza Micorsoft Office utilizzando la libreria C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 È facile per gli sviluppatori creare, caricare, modificare e convertire file ODS all'interno di applicazioni di reporting in esecuzione per l'elaborazione dei dati in poche righe di codice.
