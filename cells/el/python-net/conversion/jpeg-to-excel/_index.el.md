...
description: Aspose Excel. Μετατρέψτε το JPEG σε EXCEL γρήγορα και εύκολα με το Aspose.Cells. Python JPEG σε EXCEL. Python Αποθήκευση JPEG στο EXCEL. Αποθηκεύστε το JPEG ως EXCEL χρησιμοποιώντας το Python.
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση JPEG στο EXCEL στο Python" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή JPEG σε EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
