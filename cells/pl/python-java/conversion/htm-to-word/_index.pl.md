...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na WORD przy użyciu biblioteki Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM pod numerem WORD w bibliotece Excel Python" %}}

Poniższy przykład ilustruje konwersję HTM na WORD w bibliotece Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteka Excel do konwersji HTM na WORD" %}}
