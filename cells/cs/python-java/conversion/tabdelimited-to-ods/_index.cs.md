---
title: Převést TABDELIMITED na ODS přes Python
url: /cs/python-java/conversion/tabdelimited-to-ods/
description: Ukázkový kód pro konverzi tabdelimited na ods Python. Použijte API ukázkový kód pro dávkový převod souborů oddělených tabulátory na ods v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na ODS pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na ODS prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory TABDELIMITED na ODS pomocí několika řádků kódu.
