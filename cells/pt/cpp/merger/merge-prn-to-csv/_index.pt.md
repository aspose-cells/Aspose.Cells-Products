---
title: Mesclar PRN para CSV - Combine PRN para CSV em C++
url: /pt/cpp/merger/merge-prn-to-csv/ 
description: Aspose Excel. C++ Aspose.Cells. Mesclar PRN online grátis para CSV saveformat. C++ Combine PRN para o formato CSV. Mesclar PRN para CSV em C++. Mesclar PRN.
...
{{% blocks/products/pf/agp/content h2="Mesclar PRN para CSV em C++ online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar PRN para CSV em Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar o PRN em CSV. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo CSV. Se você desenvolver o código em C++, isso será mais simples do que parece. Consulte o exemplo C++ que mescla PRN com CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar PRN para CSV em C++" InputFormat="prn" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar PRN para CSV via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar PRN para CSV programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para mesclar PRN para CSV" %}}
