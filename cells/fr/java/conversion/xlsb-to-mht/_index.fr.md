---
title: Java XLSB en MHT - Convertisseur en ligne XLSB en MHT
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertissez XLSB en format de sauvegarde MHT. Java XLSB au format MHT. Enregistrez XLSB à MHT Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à MHT en Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en MHT en Java.
...
Besoin de convertir les fichiers XLSB en MHT par programmation ? Les développeurs de Java peuvent facilement convertir XLSB en MHT en quelques lignes de code seulement.
