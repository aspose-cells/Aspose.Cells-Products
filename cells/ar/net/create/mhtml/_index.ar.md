...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 يعد إنشاء ملف MHTML ديناميكيًا داخل التطبيق قيد التشغيل أمرًا سهلاً. من أجل إنشاء مستندات MHTML من البداية دون الحاجة إلى MS Office ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية إنشاء MHTML عبر C#" %}}
...
1. قم بتضمين مساحة الاسم في ملف الفصل الدراسي الخاص بك1. إنشاء مثيل فئة المصنف.1. قم بالوصول إلى ورقة العمل الأولى من المصنف.1. احصل على الخلية (الخلايا) المطلوبة من ورقة العمل وأدخل القيمة في الخلية (الخلايا).1. استخدم طريقة الحفظ لحفظ المصنف كملف MHTML.
...
{{% blocks/products/pf/agp/code-block title="يوضح رمز المصدر التالي كيفية إنشاء ملف MHTML باستخدام C#." offSpacer="" %}}
