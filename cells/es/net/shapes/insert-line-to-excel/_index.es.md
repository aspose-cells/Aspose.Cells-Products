...
weight: 101
description: C# código fuente para insertar una línea en Excel en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar un archivo Line to Excel vía C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) para insertar una línea en la hoja de cálculo seleccionada
