---
title: TXT'i XLTX'e birleştir - TXT'i Java'de XLTX'e birleştir
url: /tr/java/merger/merge-txt-to-xltx/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i XLTX kaydetme biçimiyle birleştirin. Java TXT'i XLTX biçimiyle birleştirin. Java'de TXT'i XLTX ile birleştirin. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'de XLTX ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de TXT ile XLTX'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT ile XLTX'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLTX dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT ile XLTX'i birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT ile XLTX\'i Java\'de Birleştirmek için Örnek Kod" InputFormat="txt" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT ile XLTX via Java Nasıl Birleştirilir?" %}}

{{% blocks/products/pf/agp/text %}}

 TXT ile XLTX'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, TXT ile XLTX arasında birleştirilecek" %}}
