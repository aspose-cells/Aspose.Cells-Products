---
title: Python PRN a MHT - Convertidor PRN a MHT
description: Aspose Excel. Convierta PRN a MHT rápida y fácilmente con Aspose.Cells. Python PRN a MHT. Python Guardar PRN en MHT. Guarde PRN como MHT usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PRN a MHT en Python" h2="Biblioteca Python de alta velocidad para convertir PRN a MHT. Esta es una solución de software profesional para importar y exportar PRN, MHT y muchos otros formatos utilizando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convierta PRN a MHT usando Python" %}}

 ¿Cómo convierto PRN a MHT? Con la biblioteca Aspose.Cells for Python, puede convertir fácilmente PRN a MHT mediante programación con unas pocas líneas de código.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Guardar PRN en MHT en Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a MHT en Python.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir PRN a MHT. Cargue su archivo PRN y luego simplemente guárdelo como archivo MHT. Tanto para la lectura PRN como para la escritura MHT, puede utilizar nombres de archivo completos. El contenido y el formato del MHT de salida serán idénticos al documento PRN original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir PRN a MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PRN a MHT a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PRN a MHT mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente PRN a MHT en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir PRN a MHT" %}}
