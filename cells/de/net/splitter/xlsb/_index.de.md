...
{{% blocks/products/pf/agp/content h2="So teilen Sie die Datei XLSB mit C# auf" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Aufteilen von XLSB-Dateien in C#" %}}
...
+ Laden Sie die Datei XLSB mit vollständigem Pfad zum Teilen.
...
+ Rufen Sie die Save()-Methode auf und übergeben Sie den Dateinamen (vollständiger Pfad) und SaveFormat.Xlsb als Parameter.
...
{{% blocks/products/pf/agp/code-block title="Datei XLSB aufteilen - C#" offSpacer="" %}}
