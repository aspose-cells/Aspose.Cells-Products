...
{{< blocks/products/pf/i18n/upper-banner h1="Převést NUMBERS do PDF přes Java" h2="Převod NUMBERS na PDF Java pro převod jedné nebo více stránek do PDF pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ČÍSLA do PDF pomocí Java" %}}

 vykreslení NUMBERS do PDF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu NUMBERS do PDF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři z Java mohou snadno převést NUMBERS soubor do PDF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst NUMBERS soubor s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Jako parametry předejte výstupní cestu s rozšířením PDF a SaveFormat1. Zkontrolujte zadanou cestu pro výsledný soubor PDF
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze NUMBERS do PDF Java" offSpacer="" %}}

```cs
// načtěte soubor NUMBERS do instance Workbooku
Workbook book = new Workbook("template.numbers");
// uložit NUMBERS jako PDF
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka převodu NUMBERS do PDF" sectionDescription="[Převést NUMBERS do PDF](https://products.aspose.app/cells/conversion/numbers-to-pdf) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj NUMBERS soubor, bude okamžitě převeden do PDF." >}}
