---
title: Chỉnh sửa hoặc Xem Siêu dữ liệu Tài liệu XLSX qua C++ 
weight: 8970
url: /vi/cpp/metadata/xlsx/ 
description: C++ mã ví dụ để chỉnh sửa hoặc xem siêu dữ liệu tệp XLSX trên C++ Môi trường thời gian chạy cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất Siêu dữ liệu XLSX qua C++" h2="Tạo ứng dụng C++ của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ tệp XLSX bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách lấy siêu dữ liệu XLSX bằng cách sử dụng C++" %}}
...
+ Tải tệp XLSX bằng CreateIWorkbookMetadata
