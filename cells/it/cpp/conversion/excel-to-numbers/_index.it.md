...
Hai bisogno di convertire i file EXCEL in NUMBERS a livello di programmazione? C++ gli sviluppatori possono facilmente convertire EXCEL in NUMBERS in poche righe di codice.
...
1.  Converti EXCEL in NUMBERS chiamando il metodo Save().
