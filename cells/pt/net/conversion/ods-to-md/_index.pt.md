---
title: C# ODS para MD - Online ODS para conversor de MD
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter ODS para MD saveformat. C# ODS para o formato MD. Salve ODS em MD C#.
...
{{% blocks/products/pf/agp/content h2="Salve ODS em MD em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter ODS para MD em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS em MD. Carregue seu arquivo ODS e simplesmente salve-o como arquivo MD. Para leitura de ODS e gravação de MD, você pode usar nomes de arquivo totalmente qualificados. O conteúdo e a formatação do MD de saída serão idênticos ao documento original ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter ODS em MD online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para MD programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter ODS em MD em apenas algumas linhas de código.
...
1.  Converta ODS em MD chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para converter ODS para MD" %}}
