...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 SXC 轉換為 EXCEL。PHP SXC 到 EXCEL。 PHP 將 SXC 儲存到 EXCEL。使用 PHP 將 SXC 儲存為 EXCEL。
...
{{% cells-convert title="將 SXC 轉換為 EXCEL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlsx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 PHP 將 SXC 轉換為 EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 SXC 檔案轉換為 EXCEL？ PHP 開發人員只需幾行程式碼即可輕鬆載入 SXC 並將其轉換為 EXCEL。
...
1. 使用工作簿實例載入 SXC 檔案。
1. 透過呼叫Workbook的save方法將SXC轉換為EXCEL。
1. 得到SXC到EXCEL的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP函式庫將SXC轉換為EXCEL" %}}
