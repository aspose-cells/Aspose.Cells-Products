...
description: Aspose Excel. Μετατρέψτε το HTM σε JPEG γρήγορα και εύκολα με το Aspose.Cells. C# HTM σε JPEG. C# Αποθήκευση HTM σε JPEG. Αποθηκεύστε το HTM ως 07617837481 χρησιμοποιώντας 3.
...
{{< blocks/products/pf/i18n/upper-banner h1="Μετατρέψτε το HTM σε JPEG στο C#" h2="Βιβλιοθήκη υψηλής ταχύτητας C# για μετατροπή HTM σε JPEG. Αυτή είναι μια επαγγελματική λύση λογισμικού για εισαγωγή και εξαγωγή HTM, JPEG και πολλών άλλων μορφών στο .NET Framework, .NET Core ή 0761 Platforms .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTM" >}}
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το HTM στο JPEG στο C#" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το HTM σε JPEG στο C#.
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή HTM σε JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="jpg" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="C# βιβλιοθήκη για μετατροπή HTM σε JPEG" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/htm-to-xlt/" name="HTM TO XLT" description="Microsoft Πρότυπο Excel" >}}
