---
title: تحويل C++ صورة إلى TSV - صورة إلى TSV
description: Aspose اكسل. قم بتحويل IMAGE إلى TSV بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى TSV. C++ احفظ IMAGE إلى TSV. احفظ IMAGE كـ TSV باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في TSV في C++" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى TSV في C++.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى TSV عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى TSV برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى TSV بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى TSV عن طريق استدعاء طريقة Save().
1.  احصل على نتيجة تحويل IMAGE إلى TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل IMAGE إلى TSV" %}}
