...
description: Aspose Excel. Java Aspose.Cells. Voeg XLSM samen naar PRN-opslagformaat. Java Combineer XLSM naar PRN-formaat. Voeg XLSM samen met PRN in Java. XLSM Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u XLSM samenvoegt met PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
