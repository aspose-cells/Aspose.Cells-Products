...
description: Aspose Excel'de. Aspose.Cells ile XLT'i hızlı ve kolay bir şekilde ETT'ye dönüştürün. Python XLT'i ETT'ye dönüştürün. Python XLT'i ETT'ye kaydedin. Python'i kullanarak XLT'i ETT olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="XLT\'i Python\'de ETT\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="XLT\'i Python\'de ETT\'ye kaydedin" %}}

Aşağıdaki örnekte XLT'in Python via NET'de ETT'ye nasıl dönüştürüleceği gösterilmektedir.
...
{{% blocks/products/pf/agp/content h2="XLT\'i ETT\'ye dönüştürmek için Python kitaplığı" %}}
