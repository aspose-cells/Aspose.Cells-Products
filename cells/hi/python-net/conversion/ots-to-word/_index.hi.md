---
title: Python ओटीएस से WORD - ओटीएस से WORD कन्वर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ OTS को WORD में जल्दी और आसानी से बदलें। Python OTS को WORD पर बदलें। Python OTS को WORD पर सहेजें। Python का उपयोग करके OTS को WORD के रूप में सहेजें।
...
{{< blocks/products/pf/i18n/upper-banner h1="OTS को Python में WORD में कनवर्ट करें" h2="ओटीएस को WORD में परिवर्तित करने के लिए हाई-स्पीड Python लाइब्रेरी। Python में उच्च-स्तरीय, प्लेटफ़ॉर्म स्वतंत्र सॉफ़्टवेयर विकसित करने के लिए हमारे एक्सेल रूपांतरण API का उपयोग करें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="ओटीएस को WORD में कैसे बदलें" %}}

{{% blocks/products/pf/agp/text %}}

OTS फ़ाइलों को प्रोग्रामेटिक रूप से WORD में कनवर्ट करने की आवश्यकता है? Python डेवलपर्स कोड की कुछ पंक्तियों में ओटीएस को आसानी से लोड और WORD में परिवर्तित कर सकते हैं।
...
1.  Workbook.save विधि पर कॉल करके OTS को WORD में कनवर्ट करें।
1.  ओटीएस का रूपांतरण परिणाम WORD पर प्राप्त करें।

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="ओटीएस को WORD में बदलने के लिए Python लाइब्रेरी" %}}
