...
weight: 8770
description: C++ رمز المثال لقفل ملف XLSM باستخدام كلمة المرور على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات حماية الملفات XLSM عبر C++" %}}
