...
title: XLSB 文件圖表來自 C++
weight: 5200
description: C++ 範例程式碼，用於在 C++ 運行時環境中繪製和轉換 XLSB 檔案中的圖表或圖表，適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{< blocks/products/pf/i18n/upper-banner h1="XLSB 格式化 C++ 中的圖表" h2="使用伺服器端 Aspose.Cells for C++ API 的本機高效能 XLSB 文件圖表，無需使用 Microsoft 或 Adobe PDF 等任何軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 建立 XLSB 檔案圖表" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C++ 中建立 XLSB 檔案圖表的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="建立 XLSB 檔案圖表 - C++" offSpacer="" %}}
