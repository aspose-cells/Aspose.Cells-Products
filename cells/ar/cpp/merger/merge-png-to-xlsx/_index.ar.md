---
title: دمج PNG إلى XLSX - اجمع PNG إلى XLSX في C++
url: /ar/cpp/merger/merge-png-to-xlsx/ 
description: Aspose إكسل. C++ Aspose.Cells. الدمج المجاني عبر الإنترنت PNG إلى XLSX saveformat. C++ اجمع PNG إلى تنسيق XLSX. دمج PNG إلى XLSX في C++. PNG دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج PNG إلى XLSX في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج PNG مع XLSX في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج PNG إلى XLSX. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف XLSX. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج PNG إلى XLSX.
...
{{% blocks/products/pf/agp/content h2="كيفية الدمج PNG إلى XLSX عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج PNG مع XLSX برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لدمج PNG إلى XLSX" %}}
