---
title: Java MHT na JSON - Konwerter MHT na JSON
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na JSON za pomocą Aspose.Cells. Java MHT na JSON. Java Zapisz MHT na JSON. Zapisz MHT jako JSON, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem JSON w Java" %}}

Poniższy przykład ilustruje sposób konwersji MHT na JSON w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować MHT na JSON. Prześlij plik MHT, a następnie po prostu zapisz go jako plik JSON. Zarówno do odczytu MHT, jak i zapisu JSON można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego numeru JSON będą identyczne z oryginalnym dokumentem MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji MHT na JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHT na JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki MHT na JSON? Programiści Java mogą łatwo przekonwertować MHT na JSON w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj MHT na JSON, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji MHT na JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji MHT na JSON" %}}
{{% blocks/products/pf/agp/text %}}
