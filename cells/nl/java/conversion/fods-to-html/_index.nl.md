...
{{% blocks/products/pf/agp/content h2="Sla FODS op in HTML in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar HTML in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar HTML of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar HTML? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar HTML met slechts een paar regels code.
