...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 C# 中的 MHT" h2="高速 C# 庫，用於將 FODS 轉換為 MHT。這是一個專業的軟體解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 FODS、MHT 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% cells-convert title="將 FODS 轉換為 MHT 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 FODS 檔案轉換為 MHT 格式嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入 FODS 檔案並將其轉換為 MHT 格式。
