---
title: Python MHTML az OTS-hez - MHTML az OTS átalakítóhoz
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a Python fejlesztők számára a MHTML OTS formátumba konvertálásához, lehetővé téve a MHTML adatok zökkenőmentes mentését OTS formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható Python kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="A MHTML konvertálása OTS-re a Python Excel könyvtárban" h2="Nagy sebességű Python excel könyvtár a MHTML OTS-re konvertálásához. Ez egy professzionális szoftvermegoldás a MHTML, OTS és sok más formátum importálásához és exportálásához a Python használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="A MHTML konvertálása OTS-re a Python-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

MHTML fájlokat programozottan OTS-re kell konvertálnia? A Python fejlesztők egyszerűen betölthetik és néhány sornyi kóddal OTS-re konvertálhatják a MHTML-et.
...
1.  Konvertálja a MHTML-et OTS-re a Workbook.save metódus hívásával.
1.  Szerezze meg a MHTML konverziós eredményt OTS-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel-könyvtár a MHTML OTS-re konvertálásához" %}}
