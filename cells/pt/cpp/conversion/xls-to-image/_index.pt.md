---
title: C++ XLS para IMAGEM - XLS para conversor de IMAGEM
description: Aspose Excel. Converta XLS em IMAGE de forma rápida e fácil com Aspose.Cells. C++ XLS em IMAGE. C++ Salve XLS em IMAGEM. Salve XLS como IMAGEM usando C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converta XLS para IMAGEM em C++" h2="Conversão de XLS para IMAGE de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS em IMAGEM em C++" %}}

O exemplo a seguir demonstra como converter XLS em IMAGE em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="png" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em IMAGEM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em IMAGE programaticamente? Os desenvolvedores do C++ podem facilmente converter XLS em IMAGE em apenas algumas linhas de código.
...
1.  Converta XLS em IMAGE chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em IMAGE" %}}
