---
title: Java MHT en WORD - Convertisseur MHT en WORD en ligne
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir MHT en format de sauvegarde WORD. Java MHT au format WORD. Enregistrez MHT dans WORD Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez MHT en WORD au Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir MHT en WORD en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir MHT en WORD. Téléchargez votre fichier MHT, puis enregistrez-le simplement en tant que fichier WORD. Pour la lecture MHT et l'écriture WORD, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage WORD de sortie seront identiques au document MHT d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir MHT en WORD en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="docx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHT en WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en WORD par programmation ? Les développeurs de Java peuvent facilement convertir MHT en WORD en quelques lignes de code.
