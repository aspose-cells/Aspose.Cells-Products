...
url: /zh-hant/python-java/merger/merge-mht-to-markdown/ 
...
以下示例演示如何將 MHT 合併到 Aspose.Cells for Python via Java 中的 MARKDOWN。
...
需要以編程方式將 MHT 合併到 MARKDOWN 嗎？基本文檔合併和連接[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需幾行代碼即可完成 API。
