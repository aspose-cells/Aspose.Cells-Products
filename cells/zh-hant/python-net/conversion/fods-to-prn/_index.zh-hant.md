---
title: Python FODS 轉 PRN - FODS 轉 PRN 轉換器
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 PRN 格式，從而能夠使用 Aspose.Cells 庫將 FODS 資料無縫保存為 PRN 格式，所有這些都透過高效能客製化的 081533481 1081481 0813481。
...
{{% blocks/products/pf/agp/content h2="在 Python Excel 庫中將 FODS 轉換為 PRN" %}}

如何將 FODS 轉換為 PRN？使用 Aspose.Cells for Python via NET 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 FODS 轉換為 PRN。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 Python Excel 庫中的 PRN" %}}

以下範例示範如何將 Python excel 庫中的 FODS 轉換為 PRN。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 轉換為 PRN。上傳您的 FODS 文件，然後將其儲存為 PRN 文件。對於 FODS 讀取和 PRN 寫入，您可以使用完全限定的檔案名稱。輸出的 PRN 內容和格式將與原始 FODS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="透過 Python Excel 庫將 FODS 轉換為 PRN 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="prn" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為 PRN" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 檔案轉換為 PRN？ Python 開發人員只需幾行程式碼即可輕鬆載入 FODS 並將其轉換為 PRN。
...
1. 使用工作簿實例載入 FODS 檔案。
1. 透過呼叫 Workbook.save 方法將 FODS 轉換為 PRN。
1. 取得FODS到PRN的轉換結果。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel 庫將 FODS 轉換為 PRN" %}}
