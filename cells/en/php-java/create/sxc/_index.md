...
{{% blocks/products/pf/agp/content h2="How to Create SXC in PHP" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to create, load, modify and convert SXC files within running different reporting applications for data processing in just a few lines of code.
...
1.  Save the workbook as SXC format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create SXC file in PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PHP library to create SXC file" %}}
