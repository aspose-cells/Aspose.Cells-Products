...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके एक्सेल फ़ाइल में चित्र कैसे डालें" %}}
...
+ चयनित वर्कशीट में चित्र सम्मिलित करने के दो तरीके हैं।
 ...
 + चित्र संग्रह का उपयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/net/aspose.cells.drawing/picturecollection/methods/add/index) चयनित वर्कशीट में एक चित्र सम्मिलित करने के लिए।
