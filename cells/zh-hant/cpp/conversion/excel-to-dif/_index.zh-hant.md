...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 EXCEL 轉換為 DIF。C++ EXCEL 到 DIF。C++ 將 EXCEL 儲存為 DIF。
...
{{% blocks/products/pf/agp/content h2="將EXCEL保存到C++中的DIF" %}}

下面的範例示範如何將EXCEL中的C++轉換為DIF。
...
{{% cells-convert title="將 EXCEL 轉換為 DIF 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="dif" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 EXCEL 轉換為 DIF" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 EXCEL 檔案轉換為 DIF？ C++開發人員只需幾行程式碼即可輕鬆將EXCEL轉換為DIF。
...
{{% blocks/products/pf/agp/content h2="C++ 將 EXCEL 轉換為 DIF 的庫" %}}
