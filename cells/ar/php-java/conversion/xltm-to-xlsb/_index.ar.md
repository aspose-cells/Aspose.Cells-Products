---
title: PHP XLTM إلى XLSB - XLTM إلى XLSB محول
description: Aspose اكسل. قم بتحويل XLTM إلى XLSB بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى XLSB. PHP احفظ XLTM إلى XLSB. احفظ XLTM كـ XLSB باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى XLSB عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى XLSB برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى XLSB بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى XLSB عن طريق استدعاء طريقة حفظ المصنف.
