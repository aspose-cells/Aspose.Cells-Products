...
{{% blocks/products/pf/agp/content h2="オンラインで無料で XML を C# の MD に保存します" %}}
...
{{% cells-convert title="オンラインでXMLをMDに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# 経由で XML を MD に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開発者は、わずか数行のコードで XML を簡単にロードして MD に変換できます。
...
{{% blocks/products/pf/agp/content h2="C# XML を MD に変換するライブラリ" %}}
