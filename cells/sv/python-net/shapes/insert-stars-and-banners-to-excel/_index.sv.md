...
{{% blocks/products/pf/agp/content h2="Hur man infogar stjärna/banner i Excel-fil med Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga Star/Banner till Excel-fil med Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Infoga stjärna/banner - Python via .Net" offSpacer="" %}}
