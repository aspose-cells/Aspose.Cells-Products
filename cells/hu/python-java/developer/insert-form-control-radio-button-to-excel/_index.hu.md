---
title:  Illessze be a RadioButtont (Űrlapvezérlőt) az Excelbe a Python számon keresztül
weight: 60
description: Python forráskód a RadioButton (Űrlapvezérlő) beillesztéséhez az Excelbe.
---
...
{{% blocks/products/pf/agp/content h2="RadioButton (űrlapvezérlő) beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A RadioButton (Űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python-es számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) egy RadioButton (Űrlapvezérlő) beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Rádiógomb beszúrása (Űrlapvezérlő) - Python" offSpacer="" %}}
