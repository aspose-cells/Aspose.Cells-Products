...
description: Aspose Excel. Convierta MHT a XLTX rápida y fácilmente con Aspose.Cells. Python MHT a XLTX. Python Guarde MHT en XLTX. Guarde MHT como XLTX usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MHT a XLTX en Python" h2="Biblioteca Python de alta velocidad para convertir MHT a XLTX. Utilice nuestra conversión de Excel API para desarrollar software independiente de plataforma de alto nivel en Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir MHT a XLTX en Python" %}}
...
{{% blocks/products/pf/agp/content h2="Guarde MHT en XLTX en Python" %}}

El siguiente ejemplo demuestra cómo convertir MHT a XLTX en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir MHT a XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xltx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir MHT a XLTX" %}}
