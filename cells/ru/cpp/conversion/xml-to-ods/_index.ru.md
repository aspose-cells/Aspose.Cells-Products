...
Вам нужно программно преобразовать XML-файлы в ODS? Разработчики C++ могут легко преобразовать XML в ODS всего за несколько строк кода.
