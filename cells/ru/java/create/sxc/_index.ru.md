---
title: Создать SXC — Создать файл SXC в Java.
description: Aspose Эксель. Java Создайте файл SXC быстро и легко с помощью Aspose.Cells. Создайте файл SXC с помощью Java. Создайте SXC в Java. Java SXC Creater.
...
{{% blocks/products/pf/agp/content h2="Как создать SXC в Java" %}}
...
1. Сохраните книгу в формате SXC, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл SXC в Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для создания файла SXC" %}}
{{% blocks/products/pf/agp/text %}}
