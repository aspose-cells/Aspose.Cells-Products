...
{{< blocks/products/pf/i18n/upper-banner h1="Объединить форматы XLTX в C++" h2="Объединение документов XLTX с использованием серверных C++ API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/code-block title="Объединить файлы XLTX — C++" offSpacer="" %}}
