---
title: C# SXC na SQL - SXC na konwerter SQL
description: Aspose Excel. Szybko i łatwo przekonwertuj SXC na SQL za pomocą Aspose.Cells. C# SXC na SQL. C# Zapisz SXC w SQL. Zapisz SXC jako SQL, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz SXC w SQL w C#" %}}

Poniższy przykład ilustruje sposób konwersji SXC na SQL w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji SXC na SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować SXC na SQL przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki SXC na SQL? Programiści .NET mogą łatwo załadować i przekonwertować SXC na SQL w zaledwie kilku linijkach kodu.
...
1.  Konwertuj SXC na SQL, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji SXC na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji SXC na SQL" %}}
