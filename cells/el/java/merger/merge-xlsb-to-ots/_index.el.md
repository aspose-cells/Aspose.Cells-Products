...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση XLSB σε μορφή αποθήκευσης OTS. Java Συνδυάστε το XLSB σε μορφή OTS. Συγχώνευση XLSB στο OTS στο Java. XLSB Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLSB στο OTS στο Java" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLSB στο OTS στο Java" InputFormat="xlsb" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
