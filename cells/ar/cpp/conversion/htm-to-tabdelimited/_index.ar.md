...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل HTM إلى TABDELIMITED في C++" h2="تحويل HTM إلى TABDELIMITED عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
هل تحتاج إلى تحويل ملفات HTM إلى TABDELIMITED برمجيًا؟ C++ يمكن للمطورين بسهولة تحويل HTM إلى TABDELIMITED في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل HTM إلى TABDELIMITED باستدعاء طريقة Save ().
