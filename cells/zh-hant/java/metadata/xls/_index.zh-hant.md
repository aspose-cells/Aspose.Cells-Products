...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 提取 XLS 元數據的步驟" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/metadata/ods/" name="消耗臭氧層物質" description="OpenDocument 電子表格文件" >}}
