...
{{% blocks/products/pf/agp/content h2="Τρόπος λήψης μεταδεδομένων XLS χρησιμοποιώντας το C++" %}}
...
+ Φορτώστε το αρχείο XLS χρησιμοποιώντας το CreateIWorkbookMetadata
