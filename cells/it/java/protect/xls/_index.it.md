...
weight: 5070
description: Codice di esempio Java per bloccare il file XLS utilizzando la password sull'ambiente runtime Java per applicazioni JSP/JSF e applicazioni desktop.
...
{{< blocks/products/pf/i18n/upper-banner h1="Crittografa XLS file via Java" h2="Fogli di calcolo Excel protetti da password incluso il formato XLS utilizzando la libreria .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per proteggere i file XLS via Java" %}}
...
1.  Carica il file XLS istanziando la classe Workbook
1.  Utilizzare il metodo Protect(..) con ProtectionType e Password
1.  Salvare il file protetto XLS con il metodo save()
