---
title: Wstaw notatki do pliku ODS via .NET
url: /pl/net/notes/insert-notes-to-ods/ 
description: Wstaw notatki do numeru ODS, używając numeru C#. Użyj przykładowego kodu API, aby wstawić notatki w aplikacji .NET.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić notatki do pliku ODS poprzez C#" %}}
...
W Office 365 notatki służą do adnotacji, możesz użyć następującego kodu C#, aby wstawiać i usuwać notatki w pliku ODS.

{{% blocks/products/pf/agp/code-block title="C# przykładowy kod do wstawiania i usuwania notatek w pliku ODS" offSpacer="" %}}
