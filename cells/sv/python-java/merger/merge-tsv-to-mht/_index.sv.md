...
url: /sv/python-java/merger/merge-tsv-to-mht/ 
...
Följande exempel visar hur man slår samman TSV till MHT i Aspose.Cells for Python via Java.
...
Behöver du slå samman TSV till MHT programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API:er kan göras med bara några rader kod.
