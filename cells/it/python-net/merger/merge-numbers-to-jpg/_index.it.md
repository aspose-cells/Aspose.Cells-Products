...
url: /it/python-net/merger/merge-numbers-to-jpg/ 
...
L'esempio seguente mostra come unire NUMBERS in JPG in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Hai bisogno di unire NUMBERS in JPG a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Le API possono essere eseguite con poche righe di codice.
