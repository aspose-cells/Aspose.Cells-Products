---
title: PHP PRN - JPEG - PRN - JPEG konvertáló
description: Aspose Excel. A PRN-t gyorsan és egyszerűen konvertálja JPEG-re a Aspose.Cells-gyel. PHP PRN-t JPEG-re. PHP PRN mentése JPEG-re. PRN mentése JPEG-re PHP használatával.
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet a PRN-t JPEG-re konvertálni PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A PRN-fájlokat programozottan JPEG-re kell konvertálni? A PHP fejlesztői könnyedén betölthetik és konvertálhatják a PRN-t JPEG-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a PRN-t JPEG-re a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a PRN JPEG számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a PRN JPEG-re való konvertálásához" %}}
