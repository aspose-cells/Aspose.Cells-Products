...
{{% blocks/products/pf/agp/content h2="C#を使用してodsファイルを修復する方法" %}}
...
{{% cells-recovery title=".NETを使用してODSファイルを修復する無料アプリ" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="net" %}}    
