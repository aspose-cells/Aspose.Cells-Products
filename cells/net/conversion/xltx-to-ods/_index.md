...
description: Sample code for xltx to ods C# conversion. Use API example code for batch xltx files to ods conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert XLTX files to ODS in just a few lines of code.
...
{{% cells-convert title="Free App and Sample Code to Convert XLTX to ODS" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx InputFormat=xltx outformat=ods IsLandingPage=true %}}
