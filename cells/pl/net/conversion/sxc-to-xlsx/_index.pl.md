---
title: C# SXC do XLSX - Konwerter online SXC do XLSX
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Bezpłatnie online C# Konwertuj SXC na XLSX saveformat. C# SXC do XLSX w formacie. Zapisz SXC do XLSX C#.
...
{{% blocks/products/pf/agp/content h2="Zaoszczędź SXC do XLSX w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować SXC na XLSX w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować SXC na XLSX. Prześlij swój plik SXC, a następnie po prostu zapisz go jako plik XLSX. Zarówno do odczytu SXC, jak i zapisu XLSX można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie XLSX będą identyczne z oryginalnym dokumentem SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji SXC na XLSX online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować SXC na XLSX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki SXC na XLSX? Programiści .NET mogą łatwo załadować i przekonwertować SXC na XLSX w zaledwie kilku wierszach kodu.
...
1.  Konwertuj SXC na XLSX, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji SXC na XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji SXC na XLSX" %}}
