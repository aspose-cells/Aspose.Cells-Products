...
description: Aspose Excel. Java Maak XPS snel en eenvoudig een bestand met Aspose.Cells. Genereer een XPS-bestand met Java. Maak XPS aan in Java. Java XPS Creater.
...
1. Sla de werkmap op in de indeling XPS met behulp van de methode save().
