...
description: Aspose Excel. Python Aspose.Cells. Sloučit XLSM do formátu uložení OTS. Python Zkombinujte XLSM do formátu OTS. Sloučit XLSM do OTS v Python. XLSM Sloučit.
...
{{% cells-merger title="Ukázkový kód pro sloučení XLSM do OTS v Python" InputFormat="xlsm" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
