---
title: JPG egyesítése SQL-be – JPG egyesítése SQL-be a Java-ben
url: /hu/java/merger/merge-jpg-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése JPG SQL mentési formátumba. Java JPG és SQL formátum kombinálása. JPG egyesítése SQL-be a Java-ben. JPG egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a JPG-t SQL-be a Java Online ingyenesen" %}}

A következő példa bemutatja, hogyan egyesítheti a JPG-t SQL-be a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a JPG és az SQL egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SQL fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely a JPG-t SQL-lel egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online JPG és SQL egyesítése a Java-ben" InputFormat="jpg" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="JPG egyesítése SQL via Java-be" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a JPG-t SQL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a JPG és az SQL egyesítéséhez" %}}
