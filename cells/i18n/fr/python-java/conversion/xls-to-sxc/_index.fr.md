...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en SXC en utilisant Python" %}}

 Afin de convertir XLS en SXC, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en SXC via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir des fichiers XLS en SXC en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier XLS avec une instance de Workbook1. Appelez la méthode Workbook.Save1. Passer le chemin de sortie avec l'extension SXC comme paramètre1. Vérifier le chemin spécifié pour le fichier SXC résultant
