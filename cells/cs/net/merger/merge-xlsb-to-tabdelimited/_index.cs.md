...
url: /cs/net/merger/merge-xlsb-to-tabdelimited/ 
...
Následující příklad ukazuje, jak sloučit XLSB do TABDELIMITED v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLSB do TABDELIMITED programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení XLSB do TABDELIMITED" %}}
