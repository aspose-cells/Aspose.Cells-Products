...
weight: 3250
description: Mã mẫu Java để phân chia tài liệu XLSX trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tách XLSX Tệp via Java" h2="Chia tách XLSX với sự trợ giúp của thư viện Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tách file XLSX trong Java" %}}
...
+ Gọi phương thức save với đường dẫn file mới XLSX.
...
{{% blocks/products/pf/agp/code-block title="Tách XLSX File - Java" offSpacer="" %}}
