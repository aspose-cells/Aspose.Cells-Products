---
title: C# PRN naar FODS - PRN naar FODS Converter
description: Aspose Excel. Deze complete oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van PRN-bestanden naar het FODS-formaat. Hierdoor kunnen PRN-gegevens naadloos worden opgeslagen in het FODS-formaat met behulp van de Aspose.Cells-bibliotheek, allemaal via efficiënte en aanpasbare C#-code.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zet PRN om naar FODS in C#" h2="Snelle C#-bibliotheek voor het converteren van PRN naar FODS. Dit is een professionele softwareoplossing voor het importeren en exporteren van PRN, FODS en vele andere formaten op .NET Framework, .NET Core of Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PRN" >}}
...
{{% blocks/products/pf/agp/content h2="Sla PRN op als FODS in C#" %}}

Het volgende voorbeeld laat zien hoe u PRN naar FODS kunt converteren in C#.
...
Wilt u PRN-bestanden programmatisch naar FODS converteren? .NET-ontwikkelaars kunnen PRN eenvoudig laden en converteren naar FODS in slechts een paar regels code.
...
1.  Converteer PRN naar FODS door de Workbook.Save-methode aan te roepen.
