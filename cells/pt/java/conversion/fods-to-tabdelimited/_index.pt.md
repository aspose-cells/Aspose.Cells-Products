---
title: Converter FODS para TABDELIMITED via Java 
url: /pt/java/conversion/fods-to-tabdelimited/ 
description: Exemplo de código de conversão Java para formato FODS para arquivo TABDELIMITED. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para TABDELIMITED em qualquer aplicativo baseado na Web ou Desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Como converter FODS para TABDELIMITED usando Java" %}}

 Para renderizar FODS para TABDELIMITED, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter FODS em TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente o arquivo FODS para TABDELIMITED em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo FODS com uma instância da classe Workbook1. Chame o método Workbook.save1. Passe o caminho de saída com a extensão TABDELIMITED e SaveFormat como parâmetros1. Verifique o caminho especificado para o arquivo TABDELIMITED resultante
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de FODS para TABDELIMITED Java" offSpacer="" %}}

```cs
// carregar o arquivo FODS em uma instância do Workbook
Workbook book = new Workbook("template.fods");
// salvar FODS como TABDELIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS para TABDELIMITED Demos de conversão ao vivo" sectionDescription="[Converter FODS para TABDELIMITED](https://products.aspose.app/cells/conversion/fods-to-tabdelimited) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo FODS, ele será convertido instantaneamente para TABDELIMITED." >}}
