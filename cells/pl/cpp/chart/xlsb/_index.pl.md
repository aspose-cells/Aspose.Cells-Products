---
title: XLSB wykres dokumentu za pośrednictwem C++
weight: 5200
description: C++ przykładowy kod do rysowania i konwertowania wykresu lub diagramu w pliku XLSB w C++ Runtime Environment dla Windows 32-bitowy, Windows 64-bitowy i Linux 64-bitowy.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB Formatuje wykresy w C++" h2="Natywne i wydajne wykresy dokumentów XLSB przy użyciu interfejsów API Aspose.Cells for C++ po stronie serwera, bez użycia oprogramowania, takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć wykresy plików XLSB za pomocą C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Utwórz kartę plików XLSB — C++" offSpacer="" %}}
