---
title: Convertissez XLTM en HTML via l'application C++ 
url: /fr/cpp/conversion/xltm-to-html/ 
description: Exemple de code de conversion C++ pour le document XLTM au format HTML. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLTM en HTML dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLTM en HTML via C++" h2="Conversion XLTM vers HTML haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLTM en HTML à l\'aide de C++" %}}

 Pour convertir XLTM en HTML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLTM en HTML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier XLTM en HTML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLTM à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (HTML).1. Le fichier HTML sera enregistré dans le chemin spécifié.1. Ouvrez le fichier HTML dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLTM vers HTML C++" offSpacer="" %}}
