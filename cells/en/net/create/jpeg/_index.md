...
{{% blocks/products/pf/agp/content h2="How to Create JPEG in C#" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to create, load, modify and convert JPEG files within running different reporting applications for data processing in just a few lines of code.
...
1.  Use Save method to save the workbook as JPEG file.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create JPEG file in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# library to create JPEG file" %}}
