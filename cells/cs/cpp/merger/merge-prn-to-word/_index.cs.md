...
Následující příklad ukazuje, jak sloučit PRN s WORD v Aspose.Cells for C++.
...
Potřebujete sloučit PRN s WORD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení PRN s WORD" %}}
