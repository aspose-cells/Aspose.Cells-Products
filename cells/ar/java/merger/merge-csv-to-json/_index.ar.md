---
title: دمج CSV إلى JSON - اجمع CSV إلى JSON في Java
url: /ar/java/merger/merge-csv-to-json/ 
description: Aspose إكسل. Java Aspose.Cells. الدمج المجاني عبر الإنترنت CSV إلى JSON saveformat. Java اجمع CSV إلى تنسيق JSON. دمج CSV إلى JSON في Java. CSV دمج.
...
{{< blocks/products/pf/i18n/upper-banner h1="ادمج CSV إلى JSON via Java" h2="مكتبة Java عالية السرعة لدمج CSV إلى JSON. استخدم تحويل Excel الخاص بنا API لتطوير برنامج عالي المستوى ومستقل عن المنصة في Java. هذا حل برمجي احترافي لاستيراد وتصدير Excel, CSV, OpenOffice, PDF, HTML, image ، والعديد من تنسيقات Excel الأخرى." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="CSV" additionalConversionTag="JSON" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="قم بدمج CSV إلى JSON في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج CSV مع JSON في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج CSV إلى JSON. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف JSON. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج CSV إلى JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني عبر الإنترنت لدمج CSV إلى JSON في Java" InputFormat="csv" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية الدمج CSV إلى JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج CSV مع JSON برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لدمج CSV إلى JSON" %}}
