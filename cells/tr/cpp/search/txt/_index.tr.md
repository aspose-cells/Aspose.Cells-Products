---
title:  C++ numaralı belgeyi açmadan TXT numaralı belgeyi arayın.
weight: 5090
description: C++ numaralı örnek kod, TXT dosyasındaki kelimeleri C++ çalışma ortamında, Windows 32 bit, Windows 64 bit ve Linux 64 bit işletim sistemlerinde belirli bir desenle aramak için kullanılır.
...
{{% blocks/products/pf/agp/content h2="C++ kullanarak TXT dosyasını nasıl arayabilirsiniz?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ numaralı bölgede TXT numaralı dosyaları arama adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="TXT Dosyasını Ara - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi TXT Canlı Demoları Ara" sectionDescription=" Hemen şimdi sitemizi ziyaret ederek TXT numaralı belgeler içindeki metinleri, kelimeleri ve kelime öbeklerini arayın.[Canlı Demolar web sitesi](https://products.aspose.app/cells/search). Canlı demo aşağıdaki avantajlara sahiptir" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API\'i indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="TXT numaralı dosyalarınızı yüklemeniz yeterli." >}}
...
.TXT uzantılı bir dosya, satırlar halinde düz metin içeren bir metin belgesini temsil eder. Metin belgesindeki paragraflar satır başı karakterleriyle tanınır ve dosya içeriğinin daha iyi düzenlenmesi için kullanılır. Standart bir metin belgesi, farklı işletim sistemlerinde herhangi bir metin düzenleyici veya kelime işlem uygulamasında açılabilir. Bu tür bir dosyada bulunan tüm metin, insan tarafından okunabilir biçimdedir ve karakter dizisiyle temsil edilir.
