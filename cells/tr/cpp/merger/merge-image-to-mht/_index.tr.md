---
title: IMAGE'ı MHT ile Birleştir - C++'de IMAGE'ı MHT ile Birleştir
url: /tr/cpp/merger/merge-image-to-mht/ 
description: Aspose Excel'de. C++ Aspose.Cells. IMAGE'ı MHT kaydetme biçimiyle birleştir. C++ IMAGE'ı MHT biçimiyle birleştirin. IMAGE'ı C++'deki MHT ile birleştir. IMAGE Birleştir.
...
{{% blocks/products/pf/agp/content h2="IMAGE\'ı C++\'deki MHT ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for C++'de IMAGE'ın MHT ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

IMAGE'ı MHT ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından MHT dosyasına kaydedin. C++'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. IMAGE'ı MHT ile birleştiren C++ örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C++\'de IMAGE\'ı MHT ile Birleştirmek için Örnek Kod" InputFormat="png" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="IMAGE\'ı C++ aracılığıyla MHT ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

IMAGE'ı MHT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="IMAGE\'ı MHT ile birleştirmek için C++ kitaplığı" %}}
