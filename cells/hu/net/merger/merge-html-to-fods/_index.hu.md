---
title: A HTML-FODS-es számok egyesítése – a HTML-es és a FODS-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-html-to-fods/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés HTML FODS mentési formátumba. C# A HTML és a FODS formátum kombinálása. Egyesítse a HTML-FODS-et a C#-ben. HTML Egyesítse.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a HTML-es számokat a FODS-es számokhoz a C#-ben online ingyen" %}}

A következő példa bemutatja a HTML és a FODS egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML-es és a FODS-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a FODS fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTML és FODS számokat.
...
{{% blocks/products/pf/agp/content h2="A HTML és a FODS egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTML-et a FODS-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML és FODS egyesítéséhez" %}}
