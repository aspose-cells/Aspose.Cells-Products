---
title: Voeg MHTML samen met HTM - Combineer MHTML met HTM in C++
url: /nl/cpp/merger/merge-mhtml-to-htm/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online samenvoegen MHTML naar HTM-opslagformaat. C++ Combineer MHTML naar HTM-formaat. Voeg MHTML samen met HTM in C++. MHTML Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u MHTML kunt samenvoegen met HTM in Aspose.Cells for C++.
...
{{% cells-merger title="Gratis online om MHTML samen te voegen met HTM in C++" InputFormat="mhtml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe MHTML samen te voegen met HTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML programmatisch samenvoegen met HTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
