---
title: PHP HTML ～ SXC - HTML ～ SXC コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、HTML を SXC にすばやく簡単に変換します。PHP HTML から SXC。PHP HTML から SXC に保存します。PHP を使用して、HTML を SXC として保存します。
...
{{% blocks/products/pf/agp/content h2="HTML を PHP で SXC に保存します" %}}
...
{{% cells-convert title="HTML を SXC に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="sxc" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP 経由で HTML を SXC に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで SXC に変換する必要がありますか? PHP 開発者は、わずか数行のコードで HTML を簡単にロードして SXC に変換できます。
