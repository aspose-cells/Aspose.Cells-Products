...
1. إنشاء فئة المصنف بمسار إلى ملف XLS1. احصل على ورقة العمل الافتراضية أو أي ورقة عمل لإضافة الحماية1. حماية ورقة العمل باستخدام طريقة Worksheet.Protect1. حماية المصنف باستخدام طريقة Workbook.Protect1. حفظ النتيجة بتنسيق XLS
