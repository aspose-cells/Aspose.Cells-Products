---
title: Python XLSB から画像 - XLSB から画像コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLSBをIMAGEにすばやく簡単に変換します。Python XLSBをIMAGEに変換します。 Python XLSBを画像に保存してください。 Python を使用して、XLSB を画像として保存します。
...
{{% cells-convert title="XLSBをIMAGEに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="png" IsLandingPage="true" language="pythonnet" %}}
