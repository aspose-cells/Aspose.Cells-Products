...
description: Aspose Excel. Python Aspose.Cells. Połącz NUMERY, aby zapisać format BMP. Python Połącz NUMERY do formatu BMP. Scal NUMBERS z BMP w Python. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z BMP, używając Python" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z BMP w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia NUMERÓW z BMP w Python" InputFormat="numbers" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć NUMERY z BMP przez Python" %}}
