---
title:  Wyszukaj dokument TXT bez otwierania za pomocą C++
weight: 5090
description: C++ przykładowy kod do wyszukiwania słów z wzorcem w pliku TXT w środowisku wykonawczym C++ dla Windows 32-bit, Windows 64-bit i Linux 64-bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Wyszukaj formaty TXT w C++" h2="Natywne i wydajne wyszukiwanie dokumentów TXT przy użyciu interfejsów API po stronie serwera Aspose.Cells for C++, bez użycia żadnego oprogramowania, takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online TXT Wyszukaj demonstracje na żywo" sectionDescription=" Wyszukaj tekst, słowa, frazy w dokumentach TXT już teraz, odwiedzając naszą stronę[Witryna internetowa z prezentacjami na żywo](https://products.aspose.app/cells/search). Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie trzeba pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Wystarczy, że prześlesz pliki TXT." >}}
...
Plik z rozszerzeniem .TXT reprezentuje dokument tekstowy zawierający zwykły tekst w postaci wierszy. Akapity w dokumencie tekstowym są rozpoznawane przez znaki powrotu karetki i służą do lepszego uporządkowania zawartości pliku. Standardowy dokument tekstowy można otworzyć w dowolnym edytorze tekstu lub aplikacji do przetwarzania tekstu w różnych systemach operacyjnych. Cały tekst zawarty w takim pliku jest w formacie czytelnym dla człowieka i reprezentowany przez sekwencję znaków.
