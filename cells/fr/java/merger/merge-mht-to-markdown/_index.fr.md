---
title: Fusionner MHT avec MARKDOWN - Combiner MHT avec MARKDOWN dans Java
url: /fr/java/merger/merge-mht-to-markdown/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde MARKDOWN. Java Combinez MHT au format MARKDOWN. Fusionner MHT avec MARKDOWN dans Java. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec MARKDOWN en utilisant Java" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec MARKDOWN en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT avec MARKDOWN dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT en MARKDOWN. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier MARKDOWN. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne MHT en MARKDOWN.
...
{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner MHT avec MARKDOWN par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner MHT avec MARKDOWN" %}}
