---
title: Konvertera SPREADSHEETML till HTML via Java 
url: /sv/java/conversion/spreadsheetml-to-html/ 
description: Exempel Java-konverteringskod för SPREADSHEETML-format till HTML-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till HTML inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera SPREADSHEETML till HTML via Java" h2="SPREADSHEETML till HTML Java-konvertering för att konvertera enstaka eller flera sidor till HTML med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SPREADSHEETML till HTML med Java" %}}

 För att rendera SPREADSHEETML till HTML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SPREADSHEETML till HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera SPREADSHEETML-filen till HTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SPREADSHEETML-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Skicka utdatasökväg med HTML-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande HTML-filen
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML till HTML Java konverteringskällkod" offSpacer="" %}}

```cs
// ladda SPREADSHEETML-filen i en instans av Workbook
Workbook book = new Workbook("template.spreadsheetml");
// spara SPREADSHEETML som HTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML till HTML Conversion Live Demos" sectionDescription="[Konvertera SPREADSHEETML till HTML](https://products.aspose.app/cells/conversion/spreadsheetml-to-html) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din SPREADSHEETML-fil, den konverteras omedelbart till HTML." >}}
