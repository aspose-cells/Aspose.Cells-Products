---
title: 通过 Java 将 XLSM 转换为 PDF 
weight: 9400
url: /zh/java/conversion/xlsm-to-pdf/ 
description: XLSM 格式到 PDF 文件的示例 Java 转换代码。程序员可以使用此示例代码在任何基于 Web 或桌面 Java 的应用程序中将 Excel 和 OpenOffice 电子表格导出为 PDF。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 XLSM 转换为 PDF" h2="XLSM 到 PDF Java 转换以使用内部部署 Java 库将单页或多页转换为 PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 XLSM 转换为 PDF" %}}

 为了将 XLSM 渲染为 PDF，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 XLSM 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Java 开发人员只需几行代码即可轻松地将 XLSM 文件转换为 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 类的实例加载 XLSM 文件1. 调用 Workbook.save 方法1. 将带有 PDF 扩展名和 SaveFormat 的输出路径作为参数传递1. 检查生成的 PDF 文件的指定路径
...
{{% blocks/products/pf/agp/code-block title="XLSM转PDFJava转换源码" offSpacer="" %}}
