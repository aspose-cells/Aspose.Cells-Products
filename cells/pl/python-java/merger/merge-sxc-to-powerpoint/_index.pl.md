---
title:  Połącz SXC z POWERPOINT przez Python
url: /pl/python-java/merger/merge-sxc-to-powerpoint/ 
description: Połącz numer SXC z usługą POWERPOINT Online za darmo. Bezpłatny numer online SXC do fuzji POWERPOINT. Połącz SXC z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak scalić SXC z POWERPOINT w Python.
...
{{% cells-merger title="Bezpłatna aplikacja do łączenia SXC z POWERPOINT on-line" InputFormat="sxc" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
