...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till JPG med C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till JPG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-utvecklare kan enkelt konvertera XLSM-filer till JPG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (JPG) filtillägg.1. JPG-filen kommer att sparas på den angivna sökvägen.1. Öppna JPG-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="XLSM till JPG C++ omvandlingskällkod" offSpacer="" %}}
