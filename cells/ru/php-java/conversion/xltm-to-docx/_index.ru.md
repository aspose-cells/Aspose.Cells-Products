...
description: Aspose Эксель. Преобразуйте XLTM в DOCX быстро и легко с помощью Aspose.Cells. PHP XLTM в DOCX. PHP Сохраните XLTM в DOCX. Сохраните XLTM как DOCX с помощью PHP.
...
Нужно программно преобразовать файлы XLTM в DOCX? Разработчики PHP могут легко загрузить и преобразовать XLTM в DOCX всего за несколько строк кода.
...
1.  Преобразуйте XLTM в DOCX, вызвав метод сохранения книги.
1.  Получите результат преобразования XLTM в DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования XLTM в DOCX" %}}
