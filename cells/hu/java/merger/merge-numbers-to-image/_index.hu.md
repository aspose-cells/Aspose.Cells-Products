---
title: "A NUMBERS egyesítése a következővel: IMAGE – NUMBERS egyesítése a következővel: IMAGE a Java-ben"
url: /hu/java/merger/merge-numbers-to-image/ 
description: "Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése NUMBERS IMAGE mentési formátumba. Java SZÁMOK kombinálása IMAGE formátumba. A NUMBERS egyesítése a következővel: IMAGE itt: Java. NUMBERS Egyesítés."
...
{{% blocks/products/pf/agp/content h2="Egyesítse a NUMBERS-t az IMAGE-val a Java-es online ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a NUMBERS-t az IMAGE-val a Aspose.Cells for Java számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a NUMBERS és az IMAGE egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el az IMAGE fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely a NUMBERS-t az IMAGE-ba egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online NUMBERS egyesítéséhez IMAGE a Java számon" InputFormat="numbers" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A NUMBERS egyesítése az IMAGE via Java számmal" %}}

{{% blocks/products/pf/agp/text %}}

Automatikusan egyesítenie kell NUMBERS számot a következővel: IMAGE? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a NUMBERS és az IMAGE egyesítéséhez" %}}
