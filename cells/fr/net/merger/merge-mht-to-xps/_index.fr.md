...
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde XPS. C# Combinez MHT au format XPS. Fusionner MHT avec XPS dans C#. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec XPS en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT avec XPS dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT en XPS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier XPS. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne MHT en XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner MHT avec XPS en C#" InputFormat="mht" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner MHT avec XPS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
