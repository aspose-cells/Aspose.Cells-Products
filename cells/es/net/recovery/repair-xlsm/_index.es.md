---
title: "C# Reparar xlsm: recuperar y reparar archivos xlsm dañados"
url: /es/net/recovery/repair-xlsm/ 
description: C# Aspose.Cells. Reparación xlsm. Reparar el archivo xlsm. herramienta de recuperación xlsm. corrupción xlsm. Restaurar datos xlsm. recuperación de archivos xlsm. Recuperar archivo xlsm dañado.
...
{{% blocks/products/pf/agp/content h2="Cómo reparar un archivo xlsm en C#" %}}
...
{{% cells-recovery title="Código de muestra para reparar el archivo XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsm" outformat="xlsm" IsLandingPage="true" language="net" %}}    
    
{{% blocks/products/pf/agp/content h2="Biblioteca .NET para reparar el archivo XLSM" %}}
