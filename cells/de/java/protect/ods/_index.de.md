...
{{% blocks/products/pf/agp/content h2="So sichern Sie die Datei ODS mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Schutz von ODS-Dateien via Java" %}}
...
1.  Laden Sie die Datei ODS, indem Sie die Arbeitsmappenklasse instanziieren
