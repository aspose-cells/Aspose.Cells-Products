---
title: รวม MHT กับ SQL - รวม MHT กับ SQL ใน C#
url: /th/net/merger/merge-mht-to-sql/ 
description: Aspose เก่ง. C# Aspose.Cells ผสาน MHT เป็น SQL แบบออนไลน์ฟรี C# รวมรูปแบบ MHT เป็น SQL ผสาน MHT กับ SQL ใน C# ผสาน MHT
...
{{% blocks/products/pf/agp/content h2="รวม MHT กับ SQL ใน C# ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีผสาน MHT กับ SQL ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อผสาน MHT กับ SQL อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ SQL หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่ผสาน MHT กับ SQL

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ออนไลน์ฟรีเพื่อผสาน MHT กับ SQL ใน C#" InputFormat="mht" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีผสาน MHT กับ SQL ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการรวม MHT กับ SQL โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี .NET เพื่อผสาน MHT กับ SQL" %}}
