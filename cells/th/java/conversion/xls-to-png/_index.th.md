---
title: แปลง XLS เป็น PNG ผ่าน Java 
weight: 8630
url: /th/java/conversion/xls-to-png/ 
description: ตัวอย่างโค้ดการแปลง Java สำหรับรูปแบบ XLS เป็นไฟล์ PNG โปรแกรมเมอร์สามารถใช้โค้ดตัวอย่างนี้เพื่อส่งออกสเปรดชีต Excel & OpenOffice ไปยัง PNG ภายในแอปพลิเคชันบนเว็บหรือเดสก์ท็อป Java
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง XLS เป็น PNG ผ่าน Java" h2="การแปลง XLS เป็น PNG Java เพื่อแปลงหน้าเดียวหรือหลายหน้าเป็น PNG โดยใช้ไลบรารี Java ในสถานที่" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง XLS เป็น PNG โดยใช้ Java" %}}

 เพื่อแสดง XLS เป็น PNG เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง XLS เป็น PNG ผ่าน Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java นักพัฒนาซอฟต์แวร์สามารถแปลงไฟล์ XLS เป็น PNG ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ XLS ด้วยอินสแตนซ์ของ Workbook1. เลือกค่าเริ่มต้นหรือเวิร์กชีตใดก็ได้จากคอลเล็กชัน1. สร้างและตั้งค่าวัตถุของ ImageOrPrintOptions1. สร้าง SheetRender ด้วยออบเจ็กต์ Worksheet & ImageOrPrintOptions1. วิธีการเรียก SheetRender.toImage เพื่อบันทึกผลลัพธ์ในรูปแบบ PNG
...
{{% blocks/products/pf/agp/code-block title="XLS เป็น PNG Java รหัสแหล่งที่มาของการแปลง" offSpacer="" %}}
