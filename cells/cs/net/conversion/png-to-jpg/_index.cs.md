...
description: Aspose Excel. Převeďte PNG na JPG rychle a snadno pomocí Aspose.Cells. C# PNG na JPG. C# Uložit PNG do JPG. Uložte PNG jako JPG pomocí C#.
...
{{% blocks/products/pf/agp/content h2="Uložte PNG do JPG v C#" %}}

Následující příklad ukazuje, jak převést PNG na JPG v C#.
...
{{% cells-convert title="Ukázkový kód pro převod PNG na JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="jpg" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod PNG na JPG" %}}
