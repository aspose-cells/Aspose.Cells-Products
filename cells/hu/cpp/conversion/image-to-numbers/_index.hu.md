...
{{< blocks/products/pf/i18n/upper-banner h1="KÉP konvertálása SZÁMOKKÉNT a C++-es irányítószámon" h2="Nagy teljesítményű KÉPEK SZÁMOKKÉNT történő konvertálása a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Programozottan kell IMAGE fájlokat SZÁMÚ FÁJLOKKÉNT konvertálnod? A C++ fejlesztők könnyedén konvertálhatják IMAGE fájlokat SZÁMÚ FÁJLOKKÉNT mindössze néhány sornyi kóddal.
...
1.  Alakítsd át az IMAGE objektumot SZÁMOKKÉPRE a Save() metódus meghívásával.
