...
description: Aspose Excel. Konvertieren Sie XLTX schnell und einfach in XPS mit Aspose.Cells. PHP XLTX in XPS. PHP Speichern Sie XLTX in XPS. Speichern Sie XLTX als XPS mit PHP.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLTX über PHP in XPS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLTX-Dateien programmgesteuert in XPS konvertieren? PHP-Entwickler können XLTX in nur wenigen Codezeilen problemlos laden und in XPS konvertieren.
...
1.  Konvertieren Sie XLTX in XPS, indem Sie die Speichermethode der Arbeitsmappe aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLTX in XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von XLTX in XPS" %}}
