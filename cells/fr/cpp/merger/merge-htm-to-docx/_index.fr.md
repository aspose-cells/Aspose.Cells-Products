...
url: /fr/cpp/merger/merge-htm-to-docx/ 
...
L'exemple suivant montre comment fusionner HTM avec DOCX dans Aspose.Cells for C++.
...
Besoin de fusionner HTM avec DOCX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour fusionner HTM avec DOCX" %}}
