---
title: Konvertera XLTM till SPREADSHEETML via Java 

description: Exempel på Java-konverteringskod för XLTM-format till SPREADSHEETML-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till SPREADSHEETML inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLTM till Kalkylblad med Java" %}}

 För att rendera XLTM till SPREADSHEETML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLTM till SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLTM-filen till SPREADSHEETML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTM-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med SPREADSHEETML-tillägget & SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande SPREADSHEETML-filen
...
{{% blocks/products/pf/agp/code-block title="XLTM till SPREADSHEETML Java konverteringskällkod" offSpacer="" %}}

```cs
// ladda XLTM-filen i en instans av Workbook
Workbook book = new Workbook("template.xltm");
// spara XLTM som Kalkylblad
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLTM till SPREADSHEETML Conversion Live Demos" sectionDescription="[Konvertera XLTM till SPREADSHEETML](https://products.aspose.app/cells/conversion/xltm-to-spreadsheetml) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din XLTM-fil, den konverteras omedelbart till SPREADSHEETML." >}}
