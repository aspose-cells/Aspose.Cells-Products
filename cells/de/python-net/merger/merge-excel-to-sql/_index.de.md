...
Das folgende Beispiel zeigt, wie Excel in SQL in Aspose.Cells for Python via .NET zusammengeführt wird.
...
Müssen Sie Excel programmgesteuert mit SQL zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs können mit nur wenigen Codezeilen erstellt werden.
