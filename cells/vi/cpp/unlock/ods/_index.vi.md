---
title:  Unlock tài liệu ODS qua C++
weight: 1190
...
{{< blocks/products/pf/i18n/upper-banner h1="Mở khóa các tệp ODS qua C++" h2="Xóa bảo vệ khỏi bảng tính Excel bao gồm tệp ODS bằng Thư viện C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách xóa bảo vệ tệp ODS bằng C++" %}}
...
1.  Tải tệp bị khóa ODS bằng CreateIWorkbook.
1.  Gọi hàm Unprotect() để mở khóa.
1.  Đặt mật khẩu thành NULL bằng SetPassword.
1.  Lưu tệp ODS tại một vị trí được chỉ định.
