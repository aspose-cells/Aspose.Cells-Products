...
description: C++ exempelkod för att kombinera XLTX-dokument i C++ Runtime Environment för Windows 32-bitars, Windows 64-bitars och Linux 64-bitars.
---
...
{{% blocks/products/pf/agp/content h2="Så här sammanfogar du XLTX-fil med C++" %}}

För att slå samman XLTX-filen kommer vi att använda <a href="https://products.aspose.com/cells/cpp">Aspose.Cells för C++</a> API som är en funktionsrik, kraftfull och lättanvänd dokumentsammanslagning API för plattformen C++. Du kan ladda ner den senaste versionen direkt, bara öppna <a href="https://www.nuget.org/packages/aspose.cells">NuGet</a> pakethanterare, sök efter <b>Aspose.Cells.Cpp</b> och installera. Du kan också använda följande kommando från Package Manager Console.
