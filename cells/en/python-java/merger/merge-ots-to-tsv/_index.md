...
description: Aspose Excel. Python Aspose.Cells. Merge OTS to TSV saveformat. Python Combine OTS to TSV format. Merge OTS to TSV in Python. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="Merge OTS to TSV in Python" %}}
...
{{% cells-merger title="Sample Code to Merge OTS to TSV in Python" InputFormat="ots" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
