---
title: "XLTX konvertálása JSON-ba a következőn keresztül: Java "
weight: 8100
url: /hu/java/conversion/xltx-to-json/ 
description: Minta Java konverziós kód az XLTX formátumhoz JSON-fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására JSON-ba bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLTX konvertálása JSON-ba a következőn keresztül: Java" h2="XLTX–JSON Java konverzió, amellyel egyetlen vagy több oldalt konvertálhat JSON-ba a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Az XLTX konvertálása JSON-ba a következővel: Java" %}}

 Ahhoz, hogy az XLTX-et JSON-ba rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLTX konvertálása JSON-ba a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják az XLTX fájlt JSON formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTX fájlt a Workbook osztály egy példányával1. Hozzon létre egy exportálandó adattartományt a Cells.createRange metódussal1. Hívja a JsonUtility.exportRangeToJson metódust a Range és az ExportRangeToJsonOptions hivatkozásokkal1. Írja be a karakterlánc JSON-adatait a fájlba a BufferedWriter.write metódussal
...
{{% blocks/products/pf/agp/code-block title="XLTX JSON Java konverziós forráskód" offSpacer="" %}}
