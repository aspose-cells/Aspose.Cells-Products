...
{{% blocks/products/pf/agp/content h2="Как вставить овал в файл Excel с помощью Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке овала в файл Excel с помощью Python via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте коллекцию фигур[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addOval(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить овал на выбранный лист.
