---
title: C# ODS a CSV - ODS a CSV Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato CSV, permitindo o salvamento perfeito de dados ODS no formato CSV usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a CSV em C#" %}}

exemplo a seguir demonstra como converter ODS em CSV em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter ODS em CSV por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em CSV programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em CSV em apenas algumas linhas de código.
...
1.  Converta ODS para CSV chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para CSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em CSV" %}}
