...
weight: 4260
description: 用於解鎖 .NET Framework、.NET Core、Mono 或 Xamarin 平台上受密碼保護的 XLS 檔案的 C# 原始碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C# 解鎖 XLS 電子表格" h2="使用 .NET 庫刪除 XLS 的保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
