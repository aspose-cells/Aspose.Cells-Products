---
title:  แทรก FlowChart ลงใน Excel via .NET
weight: 371
description: ซอร์สโค้ด C# เพื่อแทรก FlowChart ลงใน Excel บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
---
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) เพื่อแทรก FlowChart ในเวิร์กชีตที่เลือก
