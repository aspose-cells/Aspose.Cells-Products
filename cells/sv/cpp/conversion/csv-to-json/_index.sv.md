...
{{% blocks/products/pf/agp/content h2="Så här konverterar du CSV till JSON med C++" %}}

 För att konvertera CSV till JSON kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera CSV till JSON via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-utvecklare kan enkelt konvertera CSV-fil till JSON på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda CSV-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (JSON) filtillägg.1. JSON-filen kommer att sparas på den angivna sökvägen.1. Öppna JSON-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="CSV till JSON C++ omvandlingskällkod" offSpacer="" %}}
