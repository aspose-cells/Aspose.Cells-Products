...
description: Aspose Эксель. Python Aspose.Cells. Объедините HTML и TSV в формате сохранения. Python Объедините форматы HTML и TSV. Объедините HTML и TSV в Python. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML с TSV, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и TSV в Python." %}}

В следующем примере показано, как объединить HTML и TSV в Aspose.Cells for Python via Java.
