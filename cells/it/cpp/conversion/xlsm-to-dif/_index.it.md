---
title: Converti XLSM in DIF tramite l'applicazione C++ 
url: /it/cpp/conversion/xlsm-to-dif/ 
description: Esempio di codice di conversione C++ per il documento XLSM in formato DIF. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLSM a DIF all'interno di qualsiasi applicazione C++.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire XLSM in DIF usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire XLSM in DIF tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente file XLSM in DIF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLSM usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (DIF).1. Il file DIF verrà salvato nel percorso specificato.1. Apri il file DIF nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLSM a DIF C++" offSpacer="" %}}
