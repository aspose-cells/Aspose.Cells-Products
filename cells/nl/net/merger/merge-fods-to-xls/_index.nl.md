...
url: /nl/net/merger/merge-fods-to-xls/ 
...
Het volgende voorbeeld laat zien hoe u FODS samenvoegt met XLS in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u FODS programmatisch samenvoegen met XLS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om FODS samen te voegen met XLS" %}}
