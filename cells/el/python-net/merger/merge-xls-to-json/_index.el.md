---
title:  Συγχώνευση XLS σε JSON μέσω Python
url: /el/python-net/merger/merge-xls-to-json/ 
description: Συγχώνευση XLS σε JSON Online δωρεάν. Δωρεάν Online XLS έως JSON Συγχώνευση. Συγχώνευση XLS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLS με το JSON στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLS με JSON σε απευθείας σύνδεση" InputFormat="xls" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
