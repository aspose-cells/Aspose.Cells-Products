...
{{% blocks/products/pf/agp/content h2="MHT omzetten naar PRN met behulp van Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sla MHT op als PRN in Java" %}}

Het volgende voorbeeld laat zien hoe je MHT naar PRN converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik MHT om naar PRN via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u MHT-bestanden programmatisch naar PRN converteren? Ontwikkelaars van Java kunnen MHT-bestanden eenvoudig naar PRN converteren met slechts een paar regels code.
