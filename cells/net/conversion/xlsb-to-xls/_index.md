---
title: Convert XLSB to XLS via .NET 
weight: 7810
...
{{< blocks/products/pf/upper-banner h1="Convert XLSB to XLS via C#" h2="Export Excel® spreadsheets to XLS format on .NET Framework, .NET Core, Mono or Xamarin Platforms." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/cells/272x272/aspose_cells-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells makes it easy for the developers to load & convert XLSB files to XLS in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XLSB to XLS" sectionDescription="Check our live demos for [XLSB to XLS conversion](https://products.aspose.app/cells/conversion/xlsb-to-xls) with following benefits." >}}
