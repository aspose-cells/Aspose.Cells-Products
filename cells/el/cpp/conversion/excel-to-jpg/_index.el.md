...
description: Aspose Excel. Μετατρέψτε το EXCEL σε JPG γρήγορα και εύκολα με το Aspose.Cells. C++ EXCEL σε JPG. C++ Αποθήκευση του EXCEL σε JPG. Αποθηκεύστε το EXCEL ως JPG χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το EXCEL σε JPG στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή EXCEL σε JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="jpg" IsLandingPage="true" language="cpp" %}}
