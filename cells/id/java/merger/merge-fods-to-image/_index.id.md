---
title: Gabungkan FODS ke IMAGE - Gabungkan FODS ke IMAGE di Java
url: /id/java/merger/merge-fods-to-image/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS ke format penyimpanan GAMBAR. Java Gabungkan FODS ke format GAMBAR. Gabungkan FODS menjadi IMAGE di Java. FODS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS ke IMAGE di Java" %}}

Contoh berikut menunjukkan cara menggabungkan FODS ke IMAGE di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan FODS ke IMAGE. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file IMAGE. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan FODS ke IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan FODS ke IMAGE di Java" InputFormat="fods" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS menjadi GAMBAR via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke IMAGE secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk menggabungkan FODS ke IMAGE" %}}
