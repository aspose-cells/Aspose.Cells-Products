...
{{% cells-convert title="HTML を XLTM に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xltm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でHTMLをXLTMに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで XLTM に変換する必要がありますか? .NET 開発者は、わずか数行のコードで HTML を簡単にロードして XLTM に変換できます。
