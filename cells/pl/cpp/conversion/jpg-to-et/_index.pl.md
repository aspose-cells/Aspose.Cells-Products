...
Trzeba programowo przekonwertować pliki JPG do ET? Programiści C++ mogą łatwo przekonwertować pliki JPG do ET za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JPG do ET wywołując metodę Save().
