...
description: Aspose Exceller. Python Aspose.Cells. Fusionner JPEG au format de sauvegarde ET. Python Combinez JPEG au format ET. Fusionner JPEG avec ET dans Python. JPEG Fusionner.
...
{{% cells-merger title="Exemple de code pour fusionner JPEG avec ET dans Python" InputFormat="jpg" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner JPEG avec ET via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner JPEG avec ET par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
