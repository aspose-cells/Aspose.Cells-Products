---
title:  سبليت XLSB ملفات via Java
weight: 7880
description: نموذج التعليمات البرمجية Java لتقسيم XLSB مستندًا على Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/content h2="كيفية تقسيم الملف XLSB باستخدام Java" %}}
 ...
 من أجل تقسيم الملف XLSB، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تقسيم الملفات XLSB في Java" %}}
...
+ استدعاء طريقة الحفظ بمسار الملف الجديد XLSB.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API يمكن استخدامه لإنشاء وتحرير وتحويل وتقديم Microsoft تنسيقات Excel إلى تنسيقات مختلفة. علاوة على ذلك، يمكن استخدامه للرسوم البيانية الشاملة وإعداد التقارير القابلة للتطوير والحسابات الموثوقة داخل تطبيقات البرامج. Aspose.Cells هو API مستقل ولا يتطلب أي برامج مثل Microsoft أو OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="العروض المباشرة على الإنترنت XLSB سبليتر" sectionDescription=" قم بتقسيم مستند XLSB الآن عن طريق زيارة موقعنا[موقع العروض الحية](https://products.aspose.app/cells/splitter). يتمتع العرض التجريبي المباشر بالمزايا التالية" >}}
