...
Behöver du konvertera XLS-filer till JSON programmatiskt? C++-utvecklare kan enkelt konvertera XLS till JSON med bara några få rader kod.
...
1.  Konvertera XLS till JSON genom att anropa Save()-metoden.
