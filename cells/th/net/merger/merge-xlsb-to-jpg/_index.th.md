...
url: /th/net/merger/merge-xlsb-to-jpg/ 
...
ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLSB เข้ากับ JPG ใน Aspose.Cells for .NET
...
ต้องการรวม XLSB เข้ากับ JPG โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ไลบรารี่เพื่อรวม XLSB เป็น JPG" %}}
