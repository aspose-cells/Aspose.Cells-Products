...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 MHTML 转换为 MHT。 Python MHTML 转换为 MHT。 Python 将 MHTML 保存到 MHT。使用 Python 将 MHTML 保存为 MHT。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 MHTML 转换为 Python 中的 MHT" h2="用于将 MHTML 转换为 MHT 的高速 Python 库。使用我们的 Excel 转换 API 在 Python 中开发高级、平台独立的软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="将 MHTML 转换为 Python 中的 MHT" %}}

如何将 MHTML 转换为 MHT？使用 Aspose.Cells for Python via NET 库，您可以通过几行代码以编程方式轻松将 MHTML 转换为 MHT。[Aspose.Cells for Python 通过 NET](https://pypi.org/project/aspose-cells-python/)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Python Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="将 MHTML 保存到 Python 中的 MHT" %}}

以下示例演示如何将 MHTML 转换为 Python via NET 中的 MHT。
...
{{% cells-convert title="将 MHTML 转换为 MHT 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="mht" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何转换 MHTML 为 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 MHTML 文件转换为 MHT？ Python 开发人员只需几行代码即可轻松加载 MHTML 并将其转换为 MHT。
...
1. 通过调用 Workbook.save 方法将 MHTML 转换为 MHT。
1. 获取MHTML到MHT的转换结果。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python库将MHTML转换为MHT" %}}
