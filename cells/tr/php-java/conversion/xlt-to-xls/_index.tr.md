---
title: PHP XLT ila XLS - XLT ila XLS Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde XLT'i XLS'e dönüştürün. PHP XLT'i XLS'e dönüştürün. PHP XLT'i XLS'e kaydedin. PHP kullanarak XLT'i XLS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLT\'i XLS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLT dosyalarını program aracılığıyla XLS'e dönüştürmeniz mi gerekiyor? PHP geliştiricileri sadece birkaç satır kodla XLT'i XLS'e kolayca yükleyebilir ve dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLT'i XLS'e dönüştürün.
1.  XLT'den XLS'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLT\'i XLS\'e dönüştürmek için PHP kütüphanesi" %}}
