...
description: Aspose Excel. Konvertieren Sie PRN schnell und einfach in DIF mit Aspose.Cells. Java PRN in DIF. Java Speichern Sie PRN in DIF. Speichern Sie PRN als DIF mit Java.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie die PRN unter DIF in Java" %}}

Das folgende Beispiel zeigt, wie PRN in DIF in Java konvertiert wird.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie PRN in DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Müssen PRN-Dateien programmgesteuert in DIF konvertiert werden? Java-Entwickler können PRN in nur wenigen Codezeilen problemlos in DIF konvertieren.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Konvertieren von PRN in DIF" %}}
{{% blocks/products/pf/agp/text %}}
