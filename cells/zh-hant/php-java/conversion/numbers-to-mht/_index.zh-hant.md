---
title: PHP 數位到 MHT - 數位到 MHT 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 NUMBERS 轉換為 MHT。PHP NUMBERS 至 MHT。 PHP 將數字儲存到 MHT。使用 PHP 將 NUMBERS 儲存為 MHT。
...
{{% blocks/products/pf/agp/content h2="如何透過 PHP 將 NUMBERS 轉換為 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 NUMBERS 檔案轉換為 MHT？ PHP 開發人員只需幾行程式碼即可輕鬆載入 NUMBERS 並將其轉換為 MHT。
...
1. 透過呼叫 Workbook 的 save 方法將 NUMBERS 轉換為 MHT。
1. 取得 NUMBERS 到 MHT 的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 NUMBERS 轉換為 MHT 的 PHP 函式庫" %}}
