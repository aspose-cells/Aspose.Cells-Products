---
title:  Python via .Net を使用して ScrollBar (フォーム コントロール) を Excel に挿入します。
weight: 90
description: Python via Excel に ScrollBar(フォーム コントロール)を挿入するための .Net ソース コード。
...
{{% blocks/products/pf/agp/content h2="Python via .Netを使用してExcelファイルにScrollBar(フォームコントロール)を挿入する方法" %}}

ExcelファイルにScrollBar(フォームコントロール)を挿入するには、次を使用します。
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Netを使用してExcelファイルにScrollBar(フォームコントロール)を挿入する手順" %}}
...
+ インデックスからワークシートを選択します。
 シェイプコレクションの追加を使用します[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_scroll_bar/#int-int-int-int-int-int)選択したワークシートに ScrollBar (フォーム コントロール) を挿入します。
...
{{% blocks/products/pf/agp/code-block title="ScrollBar の挿入 (フォーム コントロール) - Python via .Net" offSpacer="" %}}
