---
title: C# XLTX - NUMBERS - Online XLTX - NUMBERS Átalakító
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Ingyenes online C# A XLTX konvertálása NUMBERS mentési formátumra. C# XLTX NUMBERS formátumba. Mentse a XLTX számot a NUMBERS C# számra.
...
{{% blocks/products/pf/agp/content h2="Takarítson meg XLTX számot NUMBERS számra a C# számon online ingyen" %}}

A következő példa bemutatja, hogyan lehet a XLTX-et NUMBERS-re konvertálni a C#-ben.
...
{{% blocks/products/pf/agp/content h2="A XLTX konvertálása NUMBERS-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Konvertálnia kell XLTX fájlt NUMBERS-re programozottan? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal SZÁMOKRA konvertálhatják a XLTX-et.
...
1.  Konvertálja a XLTX-et NUMBERS-re a Workbook.Save metódus hívásával.
1.  Szerezze meg a XLTX konverziós eredményt NUMBERS-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX számok SZÁMOKká konvertálásához" %}}
