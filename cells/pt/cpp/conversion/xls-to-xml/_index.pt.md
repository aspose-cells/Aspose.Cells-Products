---
title: C++ XLS para XML - XLS para conversor XML
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato XML, permitindo o salvamento perfeito de dados XLS em formato XML usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salvar XLS em XML em C++" %}}

O exemplo a seguir demonstra como converter XLS para XML em C++.
...
{{% blocks/products/pf/agp/content h2="Como converter XLS para XML via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para XML programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para XML com apenas algumas linhas de código.
...
1. Converta XLS para XML chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em XML" %}}
