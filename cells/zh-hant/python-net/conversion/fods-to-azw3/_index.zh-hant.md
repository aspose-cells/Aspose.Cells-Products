---
title: Python FODS 轉 AZW3 - FODS 轉 AZW3 轉換器
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 AZW3 格式，從而能夠使用 Aspose.Cells 庫將 FODS 資料無縫保存為 AZW3 格式，所有這些程式庫將 FODS 資料無縫保存為 AZW3 格式，所有這些程式碼都透過高效且可自訂的153 153 153 153 153 153。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Excel 庫中將 FODS 轉換為 AZW3" h2="高速 Python Excel 庫，用於將 FODS 轉換為 AZW3。使用我們的 Excel 轉換工具 API，以 Python 格式開發進階、與平台無關的軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AZW3" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="在 Excel 庫中將 FODS 轉換為 AZW3" %}}

如何將 FODS 轉換為 AZW3？透過 NET 函式庫，使用 Aspose.Cells 和 for Python，只需幾行程式碼即可輕鬆地以程式設計方式將 FODS 轉換為 AZW3。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 Python Excel 庫中的 AZW3。" %}}

以下範例示範如何在 Python Excel 庫中將 FODS 轉換為 AZW3。
{{% blocks/products/pf/agp/text %}}

請依照以下簡單步驟即可將 FODS 檔案轉換為 AZW3 檔案。上傳您的 FODS 文件，然後將其另存為 AZW3 文件。讀取 FODS 檔案和寫入 AZW3 檔案時，均可使用完整檔案名稱。輸出的 AZW3 檔案的內容和格式將與原始 FODS 文件完全相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 FODS 透過 Python 轉換為 AZW3 的範例程式碼（Excel 函式庫）" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="azw3" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為 AZW3" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 FODS 檔案轉換為 AZW3 格式嗎？ Python 開發人員只需幾行程式碼即可輕鬆載入 FODS 檔案並將其轉換為 AZW3 格式。
...
1. 使用工作簿實例載入 FODS 檔案。
1. 透過呼叫 Workbook.save 方法將 FODS 轉換為 AZW3。
1. 取得 FODS 到 AZW3 的轉換結果。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel 庫，用於將 FODS 轉換為 AZW3" %}}
