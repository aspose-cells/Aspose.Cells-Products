---
title: Java IMAGE en XLSB - Convertisseur IMAGE en XLSB
description: Aspose Exceller. Convertissez IMAGE en XLSB rapidement et facilement avec Aspose.Cells. Java IMAGE en XLSB. Java Enregistrez IMAGE en XLSB. Enregistrez IMAGE sous XLSB en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE au XLSB dans Java" %}}

L'exemple suivant montre comment convertir IMAGE en XLSB en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir une image en XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers IMAGE en XLSB par programme ? Les développeurs Java peuvent facilement convertir IMAGE en XLSB en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en XLSB" %}}
{{% blocks/products/pf/agp/text %}}
