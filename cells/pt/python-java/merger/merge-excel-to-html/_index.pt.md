...
url: /pt/python-java/merger/merge-excel-to-html/ 
...
O exemplo a seguir demonstra como mesclar EXCEL para HTML em Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Precisa mesclar o EXCEL para HTML programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) As APIs podem ser feitas com apenas algumas linhas de código.
