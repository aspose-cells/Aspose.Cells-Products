...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na XLAM pomocí C++" %}}

 K převodu CSV na XLAM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu CSV na XLAM prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor CSV na XLAM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLAM).1. Soubor XLAM bude uložen do zadané cesty.1. Otevřete soubor XLAM v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na XLAM C++" offSpacer="" %}}
