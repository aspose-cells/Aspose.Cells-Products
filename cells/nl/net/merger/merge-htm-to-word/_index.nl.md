---
title: Voeg HTM samen met WORD - Combineer HTM met WORD in C#
url: /nl/net/merger/merge-htm-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online HTM samenvoegen naar WORD-opslagformaat. C# Combineer HTM naar WORD formaat. Voeg HTM samen met WORD in C#. HTM samenvoegen.
...
Het volgende voorbeeld laat zien hoe u HTM kunt samenvoegen met WORD in Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis online om HTM samen te voegen met WORD in C#" InputFormat="htm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen met WORD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met WORD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
