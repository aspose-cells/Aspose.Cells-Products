...
weight: 3560
description: โค้ดตัวอย่าง Java เพื่อสร้างรายงานรูปแบบ XLSB บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
...
{{< blocks/products/pf/i18n/upper-banner h1="การสร้างรายงานจำนวนมากใน XLSB รูปแบบ via Java" h2="สร้างรายงานในรูปแบบ XLSB โดยใช้แหล่งข้อมูลและเทมเพลต" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้างรายงาน XLSB via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="สร้างรายงาน Excel ในรูปแบบ XLSB - Java" offSpacer="" %}}
