---
title:  Fusionner MHT avec XLS via Java
url: /fr/java/merger/merge-mht-to-xls/ 
description: Fusionnez MHT avec XLS en ligne gratuitement. MHT en ligne gratuit à XLS Fusion. Fusionnez MHT avec Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner MHT avec XLS dans Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT avec XLS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier XLS. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne MHT en XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Application gratuite pour fusionner MHT avec XLS en ligne" InputFormat="mht" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
