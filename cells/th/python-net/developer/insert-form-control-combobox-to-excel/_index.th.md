---
title: แทรก ComboBox(การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 20
description: Python via .Net ซอร์สโค้ดเพื่อแทรก ComboBox(Form control) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก ComboBox(Form control) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ Shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_combo_box/#int-int-int-int-int-int) เพื่อแทรก ComboBox(Form control) ในแผ่นงานที่เลือก
