...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan EXCEL ke TXT di C#" h2="Pustaka berkecepatan tinggi C# untuk mengkonversi EXCEL ke TXT. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor EXCEL, TXT, dan banyak format lainnya pada .NET Framework, .NET Core atau Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
Perlu mengonversi file EXCEL ke TXT secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi EXCEL ke TXT hanya dalam beberapa baris kode.
...
1.  Konversikan EXCEL ke TXT dengan memanggil metode Workbook.Save.
