---
title: Merge TXT to SXC - Merge TXT to SXC in Java
url: /java/merger/merge-txt-to-sxc/ 
description: Aspose Excel. Java Aspose.Cells. TXT Merge. Free Online Merge TXT to SXC in Java. Java Merge TXT to SXC format. Combine TXT to SXC in Java.
keywords: [Aspose Excel., Java Aspose.Cells., Java Merge TXT to SXC., Free Online Merge TXT to sxc in Java., Java Combine TXT to SXC Online., TXT Merge]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge TXT to SXC in Java" h2="High-speed Java library for merging TXT to SXC. Use our excel conversion API to develop high-level, platform independent software in Java. This is a professional software solution to import and export Excel, CSV, OpenOffice, PDF, HTML, image, and many other excel formats." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="TXT" additionalConversionTag="SXC" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
