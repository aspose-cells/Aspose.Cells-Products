...
description: Aspose Excel. C++ Aspose.Cells. Sloučit HTM do formátu uložení EXCEL. C++ Kombinujte formát HTM s formátem EXCEL. Sloučit HTM do EXCELu v C++. Sloučit HTM.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM do EXCELu v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení HTM do EXCELu v C++" InputFormat="htm" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
