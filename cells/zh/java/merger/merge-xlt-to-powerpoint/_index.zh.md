---
title: 将 XLT 合并到 POWERPOINT - 将 XLT 合并到 Java 中的 POWERPOINT
url: /zh/java/merger/merge-xlt-to-powerpoint/ 
description: Aspose Excel。 Java Aspose.Cells。免费在线合并 XLT 到 POWERPOINT 保存格式。 Java 将 XLT 合并为 POWERPOINT 格式。将 XLT 合并到 Java 中的 POWERPOINT。 XLT 合并。
...
{{% blocks/products/pf/agp/content h2="使用 Java 将 XLT 合并到 POWERPOINT" %}}

如何将 XLT 合并到 POWERPOINT？借助 Aspose.Cells for Java 库，您可以通过几行代码以编程方式轻松将 XLT 合并到 POWERPOINT。[Aspose.Cells for Java](https://products.aspose.com/cells/java)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Java Excel API不仅可以在电子表格格式之间进行转换，还可以将Excel文件渲染为图像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，从而使其成为行业交换文档的完美选择-标准格式。您可以直接从以下位置下载其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)并通过将以下配置添加到 pom.xml 将其安装在基于 Maven 的项目中。
...
{{% blocks/products/pf/agp/content h2="免费在线将 XLT 合并到 Java 中的 POWERPOINT" %}}

以下示例演示如何将 XLT 合并到 Aspose.Cells for Java 中的 POWERPOINT。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLT 合并到 POWERPOINT。上传文件，调用Workbook.Combine方法合并文件，然后将其保存到POWERPOINT文件。如果您在 Java 中开发代码，这会比听起来更简单。请参阅将 XLT 合并到 POWERPOINT 的 Java 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线将 XLT 合并到 Java 中的 POWERPOINT" InputFormat="xlt" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLT 合并到 POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 合并到 POWERPOINT 吗？基本文档合并和连接[Aspose.Cells for Java](https://products.aspose.com/cells/java)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Java 库将 XLT 合并到 POWERPOINT" %}}
