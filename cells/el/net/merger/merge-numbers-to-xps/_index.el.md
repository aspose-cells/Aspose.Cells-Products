---
title:  Συγχώνευση NUMBERS στο XPS μέσω C#
url: /el/net/merger/merge-numbers-to-xps/ 
description: Συγχώνευση NUMBERS στο XPS Online δωρεάν. Δωρεάν Online NUMBERS to XPS Merger. Συγχώνευση NUMBERS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το παρακάτω παράδειγμα δείχνει πώς να συγχωνεύσετε NUMBERS στο XPS στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για τη συγχώνευση των NUMBERS στο XPS σε απευθείας σύνδεση" InputFormat="numbers" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
