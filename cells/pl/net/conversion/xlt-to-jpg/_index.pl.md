---
title: C# XLT do JPG - XLT do konwertera JPG
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLT do formatu JPG, umożliwiając bezproblemowe zapisywanie danych XLT w formacie JPG za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT w formacie JPG w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLT na format JPG w formacie C#.
...
Chcesz programowo przekonwertować pliki XLT na JPG? Programiści .NET mogą łatwo załadować i przekonwertować XLT na JPG w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLT do JPG wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLT na JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLT na JPG" %}}
