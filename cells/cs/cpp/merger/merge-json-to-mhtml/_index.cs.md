...
url: /cs/cpp/merger/merge-json-to-mhtml/ 
...
Následující příklad ukazuje, jak sloučit JSON až MHTML v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení JSON až MHTML v C++" InputFormat="json" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON na MHTML přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JSON až MHTML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení JSON až MHTML" %}}
