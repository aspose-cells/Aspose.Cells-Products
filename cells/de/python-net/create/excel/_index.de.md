...
{{% blocks/products/pf/agp/content h2="So erstellen Sie Excel in Python" %}}
...
1.  Verwenden Sie die Save-Methode, um die Arbeitsmappe als EXCEL-Datei zu speichern.

{{% blocks/products/pf/agp/code-block title="Der Beispielcode zeigt, wie eine Excel-Datei in Python erstellt wird." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python-Bibliothek zum Erstellen einer Excel-Datei" %}}
