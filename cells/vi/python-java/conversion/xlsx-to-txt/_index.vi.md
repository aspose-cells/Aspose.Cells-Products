---
title: Chuyển đổi XLSX sang TXT qua Python
url: /vi/python-java/conversion/xlsx-to-txt/
description: Mã mẫu cho chuyển đổi xlsx sang txt Python. Sử dụng API mã mẫu cho hàng loạt tệp xlsx sang chuyển đổi txt trong ứng dụng Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLSX sang TXT qua Python" h2="Xuất bảng tính Excel® sang định dạng TXT bằng Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSX sang TXT bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLSX sang TXT qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp XLSX sang TXT chỉ trong một vài dòng mã.
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi XLSX sang TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="txt" IsLandingPage="true" language="python" %}}
