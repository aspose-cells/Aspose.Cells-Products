...
weight: 3050
description: ซอร์สโค้ด C# เพื่อเพิ่มหรือลบลายน้ำไปยังไฟล์ XLS บน .NET Framework, .NET Core, Mono หรือแพลตฟอร์ม Xamarin
...
{{< blocks/products/pf/i18n/upper-banner h1="เพิ่มลายน้ำข้อความไปที่ XLS ผ่าน C#" h2="สร้างแอป .NET ของคุณเองเพื่อใส่ลายน้ำให้กับไฟล์ XLS โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการเพิ่มลายน้ำให้กับ XLS ผ่าน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ใส่ลายน้ำมาที่ XLS - C#" offSpacer="" %}}
