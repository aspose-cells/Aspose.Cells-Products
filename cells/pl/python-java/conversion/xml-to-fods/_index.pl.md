...
{{% blocks/products/pf/agp/content h2="Konwertuj XML na FODS, korzystając z biblioteki Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz kod XML pod numerem FODS w bibliotece programu Excel Python" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na FODS w bibliotece Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteka Excel do konwersji XML na FODS" %}}
