...
description: Aspose اكسل. قم بتحويل ODS إلى OTS بسرعة وسهولة باستخدام Aspose.Cells. Python ODS إلى OTS. Python احفظ ODS إلى OTS. احفظ ODS كـ OTS باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="تحويل ODS إلى OTS في Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ ODS إلى OTS في Python" %}}

يوضح المثال التالي كيفية تحويل ODS إلى OTS في Python via NET.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل ODS إلى OTS" %}}
