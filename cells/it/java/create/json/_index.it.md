...
description: Aspose Excel. Java Crea il file JSON in modo semplice e veloce con Aspose.Cells. Genera il file JSON utilizzando Java. Crea JSON in Java. Java JSON Creatore.
...
1. Salva la cartella di lavoro nel formato JSON utilizzando il metodo save().
