---
title: Javaを介してODSをTABDELIMITEDに変換します 
url: /ja/java/conversion/ods-to-tabdelimited/ 
description: ODS形式からTABDELIMITEDファイルへのサンプルJava変換コード。プログラマーは、このサンプルコードを使用して、ExcelおよびOpenOfficeスプレッドシートを任意のWebまたはデスクトップJavaベースのアプリケーション内のTABDELIMITEDにエクスポートできます。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してODSをTABDELIMITEDに変換します" h2="オンプレミスJavaライブラリを使用して単一または複数のページをTABDELIMITEDに変換するためのODSからTABDELIMITEDJavaへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してODSをTABDELIMITEDに変換する方法" %}}

 ODSをTABDELIMITEDにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してODSをTABDELIMITEDに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでODSファイルをTABDELIMITEDに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookクラスのインスタンスを含むODSファイルをロードします1. Workbook.saveメソッドを呼び出す1. TABDELIMITED拡張子とSaveFormatをパラメータとして出力パスを渡します1. 結果のTABDELIMITEDファイルの指定されたパスを確認します
...
{{% blocks/products/pf/agp/code-block title="ODSからTABDELIMITEDJavaへの変換ソースコード" offSpacer="" %}}

```cs
// WorkbookのインスタンスにODSファイルをロードします
Workbook book = new Workbook("template.ods");
// ODSをTABDELIMITEDとして保存
