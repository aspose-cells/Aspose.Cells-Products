---
title: PHP XLTM إلى SXC - XLTM إلى SXC محول
description: Aspose اكسل. قم بتحويل XLTM إلى SXC بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى SXC. PHP احفظ XLTM إلى SXC. احفظ XLTM كـ SXC باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى SXC عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى SXC برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى SXC بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى SXC عن طريق استدعاء طريقة حفظ المصنف.
