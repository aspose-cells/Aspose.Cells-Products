---
title: Объединить XLS с ODS — объединить XLS с ODS в Java.
url: /ru/java/merger/merge-xls-to-ods/ 
description: Aspose Эксель. Java Aspose.Cells. Объедините XLS и ODS в формате сохранения. Java Объедините форматы XLS и ODS. Объедините XLS и ODS в Java. XLS Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините XLS и ODS в Java." %}}

В следующем примере показано, как объединить XLS и ODS в Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить номера XLS и ODS. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле ODS. Если вы разработаете код Java, это будет проще, чем кажется. См. пример Java, в котором XLS объединяется с ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения чисел XLS и ODS в Java" InputFormat="xls" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Как объединить XLS с ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить номера XLS и ODS? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for Java](https://products.aspose.com/cells/java) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для объединения XLS и ODS." %}}
