---
title: Wstaw komentarze do pliku XLSM za pośrednictwem Python
url: /pl/python-java/comments/insert-comments-to-xlsm/ 
description: Wstaw komentarze do XLSM, używając Python. Użyj przykładowego kodu API, aby wstawić komentarze w aplikacji Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak wstawić komentarze w pliku XLSM za pośrednictwem Python" %}}
...
usłudze Office 365 komentarze służą do konwersacji, możesz użyć następującego kodu Python, aby wstawiać i usuwać komentarze w pliku XLSM.
