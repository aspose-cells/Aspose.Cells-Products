...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке GroupBox в файл Excel по номеру C#" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addgroupbox) вставить GroupBox в выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставить групповой ящик — C#" offSpacer="" %}}
