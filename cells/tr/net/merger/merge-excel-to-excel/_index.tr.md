...
url: /tr/net/merger/merge-excel-to-excel/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de EXCEL'in EXCEL ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 EXCEL'i EXCEL ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET EXCEL\'i EXCEL ile birleştirmek için kütüphane" %}}
