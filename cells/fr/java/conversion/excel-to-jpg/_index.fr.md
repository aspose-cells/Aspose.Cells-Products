---
title:  Convertir EXCEL en JPG Java
description: Convertissez EXCEL en JPG en ligne gratuitement. Convertisseur EXCEL en JPG en ligne gratuit. Java EXCEL à JPG. EXCEL à JPG via Java.
keywords: Convert EXCEL, EXCEL Converter, EXCEL to PDF, EXCEL to Word, EXCEL to PPT, EXCEL to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir EXCEL en JPG via Java" h2="Conversion EXCEL en JPG Java pour convertir une ou plusieurs pages en JPG à l\'aide de la bibliothèque sur site Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir EXCEL en JPG en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="jpg" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir EXCEL en JPG en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier EXCEL avec une instance de la classe Workbook
1.  Convertir EXCEL en JPG en appelant la méthode Workbook.save
