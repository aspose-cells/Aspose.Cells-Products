...
description: Aspose Exceller. Convertissez HTM en XLS rapidement et facilement avec Aspose.Cells. Python HTM en XLS. Python Enregistrez HTM en XLS. Enregistrez HTM sous XLS en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au XLS dans Python" %}}
...
{{% cells-convert title="Exemple de code pour convertir HTM en XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xls" IsLandingPage="true" language="pythonjava" %}}
