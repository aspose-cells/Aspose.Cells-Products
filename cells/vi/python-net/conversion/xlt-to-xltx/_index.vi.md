...
description: Aspose Excel. Chuyển đổi XLT sang XLTX nhanh chóng và dễ dàng với Aspose.Cells. Python XLT sang XLTX. Python Lưu XLT thành XLTX. Lưu XLT thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLT thành XLTX thành Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLT vào XLTX trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLT thành XLTX trong Python via NET.
...
{{% cells-convert title="Mã mẫu chuyển đổi XLT thành XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xltx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLT thành XLTX" %}}
