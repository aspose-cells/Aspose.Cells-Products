---
title: Slå samman XLTM-filer via C++ 
url: /sv/cpp/merger/xltm/ 
description: C++ exempelkod för att kombinera XLTM-dokument i C++ Runtime Environment för Windows 32-bitars, Windows 64-bitars och Linux 64-bitars.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman XLTM-format i C++" h2="XLTM-dokumentsammanslagning med C++ API:er på serversidan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Så här sammanfogar du XLTM-fil med C++" %}}

För att slå samman XLTM-filen kommer vi att använda <a href="https://products.aspose.com/cells/cpp">Aspose.Cells för C++</a> API som är en funktionsrik, kraftfull och lättanvänd dokumentsammanslagning API för plattformen C++. Du kan ladda ner den senaste versionen direkt, bara öppna <a href="https://www.nuget.org/packages/aspose.cells">NuGet</a> pakethanterare, sök efter <b>Aspose.Cells.Cpp</b> och installera. Du kan också använda följande kommando från Package Manager Console.
