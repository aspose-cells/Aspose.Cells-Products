...
{{% blocks/products/pf/agp/content h2="CSV konvertálása SPREADSHEETML-re a Python Excel könyvtárban" %}}
...
{{% blocks/products/pf/agp/content h2="A CSV mentése a SPREADSHEETML-be a Python Excel könyvtárban" %}}

A következő példa bemutatja a CSV SPREADSHEETML formátumú konvertálását a Python Excel könyvtárban.
...
{{% blocks/products/pf/agp/content h2="Python Excel-könyvtár a CSV SPREADSHEETML-re konvertálásához" %}}
