---
title: C++ XLS ถึง BMP - ออนไลน์ XLS ถึง BMP Converter
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง XLS เป็น BMP บันทึกรูปแบบ รูปแบบ C++ XLS ถึง BMP บันทึก XLS ถึง BMP C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ถึง BMP ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง XLS เป็น BMP โดยเรียกเมธอด Save()
