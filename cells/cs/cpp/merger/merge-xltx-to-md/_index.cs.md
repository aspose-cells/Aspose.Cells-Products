...
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do formátu uložení MD. C++ Spojte XLTX do formátu MD. Sloučit XLTX na MD v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX na MD v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX na MD v C++" InputFormat="xltx" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
