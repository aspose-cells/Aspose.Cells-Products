---
title: Fusionner TXT à ET - Combiner TXT à ET dans C#
url: /fr/net/merger/merge-txt-to-et/ 
description: Aspose Excel. C# Aspose.Cells. Fusion gratuite en ligne TXT au format de sauvegarde ET. C# Combinez TXT au format ET. Fusionner TXT à ET dans C#. TXT Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner TXT à ET dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner TXT à ET dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes faciles pour fusionner TXT à ET. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier ET. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne TXT en ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner TXT à ET en C#" InputFormat="txt" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner TXT à ET via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner TXT à ET par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner TXT à ET" %}}
