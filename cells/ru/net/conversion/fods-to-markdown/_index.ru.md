---
title: Преобразователь C# FODS в MARKDOWN - FODS в MARKDOWN
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в MARKDOWN в C#" %}}

В следующем примере показано, как преобразовать FODS в MARKDOWN в C#.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать FODS в MARKDOWN через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы FODS в MARKDOWN? Разработчики .NET могут легко загрузить и преобразовать FODS в MARKDOWN всего за несколько строк кода.
...
1.  Преобразуйте значение FODS в MARKDOWN, вызвав метод Workbook.Save.
1.  Получите результат преобразования FODS в MARKDOWN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования FODS в MARKDOWN" %}}
