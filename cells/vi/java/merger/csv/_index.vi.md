---
title:  Hợp nhất các tập tin CSV via Java
weight: 3860
description: Java mã mẫu để kết hợp các tài liệu CSV trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng CSV trong Java" h2="Hợp nhất tài liệu gốc CSV bằng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để hợp nhất các tệp CSV trong Java" %}}
...
+ Nạp tệp CSV đầu tiên với một thể hiện của lớp Workbook.
+ Nạp tài liệu CSV thứ hai với một thể hiện của lớp Workbook.
+ Hợp nhất các tệp bằng phương thức kết hợp ().
lưu tệp CSV đã hợp nhất tại đường dẫn đã chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp CSV - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến CSV Hợp nhất Bản trình diễn trực tiếp" sectionDescription=" Hợp nhất các tài liệu CSV ngay bây giờ bằng cách truy cập của chúng tôi[Trang web Demo trực tiếp](https://products.aspose.app/cells/merger). Bản demo trực tiếp có những lợi ích sau" >}}
