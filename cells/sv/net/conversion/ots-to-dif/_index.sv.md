---
title: C# OTS till DIF - OTS till DIF Converter
description: Aspose Excel. Konvertera OTS till DIF snabbt och enkelt med Aspose.Cells. C# OTS till DIF. C# Spara OTS till DIF. Spara OTS som DIF med 304818.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till DIF på C#" %}}

Följande exempel visar hur man konverterar OTS till DIF i C#.
...
{{% cells-convert title="Exempelkod för att konvertera OTS till DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till DIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till DIF programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till DIF på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera OTS till DIF" %}}
