...
description: Aspose Excel. Genereer en bewerk moeiteloos SXC-bestanden met de Aspose.Cells for Java-bibliotheek. Deze krachtige API biedt een gestroomlijnde en efficiënte oplossing voor het maken, bewerken en beheren van SXC-bestanden rechtstreeks binnen uw Java-toepassingen, waarmee met hoge precisie aan specifieke ontwikkelaarsbehoeften wordt voldaan.
...
1.  Sla het werkblad op in het formaat SXC met behulp van de save()-methode.
