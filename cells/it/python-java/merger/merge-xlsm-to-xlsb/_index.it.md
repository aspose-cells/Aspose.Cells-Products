...
description: Aspose Excel. Python Aspose.Cells. Unione online gratuita da XLSM a XLSB saveformat. Python Combina il formato XLSM con XLSB. Unisci XLSM a XLSB in Python. XLSM Unisci.
...
L'esempio seguente mostra come unire XLSM a XLSB in Aspose.Cells for Python via Java.
...
{{% cells-merger title="Online gratuito per unire XLSM a XLSB in Python" InputFormat="xlsm" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Come unire XLSM a XLSB tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire XLSM a XLSB a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Le API possono essere eseguite con poche righe di codice.
