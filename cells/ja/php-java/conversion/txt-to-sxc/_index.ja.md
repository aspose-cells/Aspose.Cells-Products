---
title: PHP TXT ～ SXC - TXT ～ SXC コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、TXT を SXC にすばやく簡単に変換します。PHP TXT から SXC。PHP TXT から SXC に保存します。PHP を使用して、TXT を SXC として保存します。
...
{{% blocks/products/pf/agp/content h2="TXT を PHP で SXC に保存します" %}}
...
{{% cells-convert title="TXT を SXC に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="sxc" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP 経由で TXT を SXC に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

TXT ファイルをプログラムで SXC に変換する必要がありますか? PHP 開発者は、わずか数行のコードで TXT を簡単にロードして SXC に変換できます。
