...
{{% blocks/products/pf/agp/text %}}
 ...
 Нужно слить SXC в ET программно? Базовый документ сливается и объединяется с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для слияния SXC с ET" %}}
