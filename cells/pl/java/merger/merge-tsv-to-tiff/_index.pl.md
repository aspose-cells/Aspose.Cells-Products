---
title: Połącz TSV z TIFF - Połącz TSV z TIFF w Java
url: /pl/java/merger/merge-tsv-to-tiff/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online TSV do TIFF w formacie zapisu. Java Połącz format TSV z TIFF. Połącz TSV z TIFF w Java. TSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz TSV z TIFF w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć TSV z TIFF w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć TSV z TIFF. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku TIFF. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy numery TSV z TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online TSV z TIFF w Java" InputFormat="tsv" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć TSV z TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić TSV z TIFF programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
