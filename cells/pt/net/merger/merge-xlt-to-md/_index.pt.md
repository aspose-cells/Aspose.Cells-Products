---
title: Mesclar XLT para MD - Combine XLT para MD em C#
url: /pt/net/merger/merge-xlt-to-md/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita XLT para MD saveformat. C# Combine XLT para o formato MD. Mesclar XLT para MD em C#. XLT Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLT para MD em C# Online Gratuitamente" %}}

exemplo a seguir demonstra como mesclar XLT com MD em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLT para MD. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e, em seguida, salve-o no arquivo MD. Se você desenvolver código em C#, isso será mais simples do que parece. Veja o exemplo C# que mescla XLT com MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLT para MD em C#" InputFormat="xlt" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLT para MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLT para MD programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLT para MD" %}}
