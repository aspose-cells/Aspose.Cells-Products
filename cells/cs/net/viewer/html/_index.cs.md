...
{{< blocks/products/pf/i18n/upper-banner h1="Prohlížeč souborů HTML for .NET" h2="Prohlížejte si tabulky Excelu a OpenOffice, jako je HTML, aniž byste potřebovali Microsoft Excel nebo Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k zobrazení HTML prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells usnadňuje vývojářům zobrazení souboru HTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor HTML v instanci sešitu1. Vytvořte instanci HtmlSaveOptions a nastavte vlastnost ExportHeadings na true1. Uložte soubor HTML ve formátu HTML pomocí metody Workbook.Save1. Načtěte výsledný HTML ve výchozím prohlížeči pomocí Process.Start
...
{{% blocks/products/pf/agp/code-block title="C# ukázkový kód pro zobrazení souboru HTML" offSpacer="" %}}
...
// uložte soubor HTML ve formátu HTML
...
Aspose.Cells API lze použít k vytváření, úpravám, převodu a vykreslování formátů aplikace Microsoft Excel do různých formátů. Kromě toho jej lze použít pro komplexní vytváření grafů, škálovatelné výkazy a spolehlivé výpočty v rámci softwarových aplikací. Aspose.Cells je samostatný API a nevyžaduje žádný software jako Microsoft nebo OpenOffice.    
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro zobrazení HTML" sectionDescription="Podívejte se na naše živé ukázky [Zobrazit HTML](https://products.aspose.app/cells/viewer/html) s následujícími výhodami." >}}
