...
Potřebujete převést TSV soubory na TABDELIMITED programově? C++ vývojáři mohou snadno převést TSV na TABDELIMITED v několika řádcích kódu.
...
1. Převeďte TSV na TABDELIMITED voláním metody Save().
