...
{{% blocks/products/pf/agp/content h2="在C#在线免费保存JPG到XLTX" %}}

以下示例演示如何将 JPG 转换为 C# 中的 XLTX。
...
{{% cells-convert title="将 JPG 在线转换为 XLTX 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xltx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过C#将JPG转XLTX" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载 JPG 并将其转换为 XLTX。
...
{{% blocks/products/pf/agp/content h2="C# 将 JPG 转换为 XLTX 的库" %}}
