---
title: C# OTS zu DIF - Online OTS zu DIF Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# OTS in DIF Saveformat konvertieren. C# OTS zum DIF-Format. Speichern Sie OTS unter DIF C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter DIF in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie OTS in C# in DIF konvertiert wird.
...
Müssen Sie OTS-Dateien programmgesteuert in DIF konvertieren? .NET-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in DIF konvertieren.
...
1.  Konvertieren Sie OTS in DIF, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von OTS in DIF" %}}
