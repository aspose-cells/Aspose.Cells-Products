---
title:  Insira a imagem no Excel usando Python via .Net
weight: 200
description: Python via Código fonte .Net para inserir imagem no Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insira a imagem no Excel usando Python via .Net" h2="Insira imagens usando Aspose.Cells\' API sem nenhum software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir uma imagem em um arquivo Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir imagem em arquivo Excel usando Python via .Net" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Use a adição da coleção de imagens[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/)para inserir uma imagem na planilha selecionada.
...
{{% blocks/products/pf/agp/code-block title="Inserir imagem - Python via .Net" offSpacer="" %}}
