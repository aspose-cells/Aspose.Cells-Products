---
title: Python MHT إلى PDF - محول MHT عبر الإنترنت إلى PDF
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل MHT إلى PDF saveformat. Python MHT إلى تنسيق PDF. احفظ MHT في PDF Python.
...
{{% blocks/products/pf/agp/content h2="تحويل MHT إلى PDF باستخدام Python" %}}

 كيف أقوم بتحويل MHT إلى PDF؟ مع مكتبة Aspose.Cells for Python ، يمكنك بسهولة تحويل MHT إلى PDF برمجيًا باستخدام بضعة أسطر من التعليمات البرمجية.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)قادر على بناء تطبيقات عبر الأنظمة الأساسية مع القدرة على إنشاء وتعديل وتحويل وعرض وطباعة جميع ملفات Excel. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات ، بل يمكنه أيضًا عرض ملفات Excel كصور ، PDF ، HTML ، ODS ، CSV ، SVG ، JSON ، WORD ، PPT والمزيد ، مما يجعله خيارًا مثاليًا لتبادل المستندات في معايير الصناعة الأشكال.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="احفظ MHT في PDF في Python عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل MHT إلى PDF في Python.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى PDF عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى PDF برمجيًا؟ يمكن للمطورين Python تحميل وتحويل MHT إلى PDF بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل MHT إلى PDF" %}}
