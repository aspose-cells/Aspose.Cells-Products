---
title: Java MHT na PRN - Konwerter MHT na PRN
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji MHT do formatu PRN, umożliwiając bezproblemowe zapisywanie danych MHT w formacie PRN przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT do PRN w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować MHT na PRN w kodzie pocztowym Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować MHT na PRN. Prześlij plik MHT, a następnie po prostu zapisz go jako plik PRN. Zarówno do odczytu MHT, jak i zapisu PRN, można używać w pełni kwalifikowanych nazw plików. Wyjściowa treść i formatowanie PRN będą identyczne z oryginalnym dokumentem MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji MHT na PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHT na PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki MHT na PRN? Programiści Java mogą łatwo przekonwertować pliki MHT na PRN za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj MHT na PRN, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji MHT na PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji MHT na PRN" %}}
{{% blocks/products/pf/agp/text %}}
