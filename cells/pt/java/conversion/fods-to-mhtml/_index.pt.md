---
title: Converter FODS para MHTML via Java 
url: /pt/java/conversion/fods-to-mhtml/ 
description: Exemplo de código de conversão Java para formato FODS para arquivo MHTML. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para MHTML em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter FODS para MHTML via Java" h2="Conversão de FODS para MHTML Java para converter uma ou várias páginas em MHTML usando a biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter FODS para MHTML usando Java" %}}

 Para renderizar FODS para MHTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter FODS em MHTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente o arquivo FODS para MHTML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo FODS com uma instância da classe Workbook1. Chame o método Workbook.save1. Passe o caminho de saída com a extensão MHTML e SaveFormat como parâmetros1. Verifique o caminho especificado para o arquivo MHTML resultante
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de FODS para MHTML Java" offSpacer="" %}}

```cs
// carregar o arquivo FODS em uma instância do Workbook
Workbook book = new Workbook("template.fods");
// salvar FODS como MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de FODS para MHTML" sectionDescription="[Converter FODS para MHTML](https://products.aspose.app/cells/conversion/fods-to-mhtml) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo FODS, ele será convertido instantaneamente para MHTML." >}}
