---
title: PHP EXCEL en JPEG - Convertisseur EXCEL en JPEG
description: Aspose Exceller. Convertissez EXCEL en JPEG rapidement et facilement avec Aspose.Cells. PHP EXCEL en JPEG. PHP Enregistrez EXCEL en JPEG. Enregistrez EXCEL sous JPEG en utilisant PHP.
...
{{% cells-convert title="Exemple de code pour convertir EXCEL en JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="jpg" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en JPEG via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en JPEG par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en JPEG en quelques lignes de code.
...
1.  Convertissez EXCEL en JPEG en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en JPEG" %}}
