...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в XPS, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в XPS в C#" %}}
...
1.  Преобразуйте значение FODS в XPS, вызвав метод Workbook.Save.
