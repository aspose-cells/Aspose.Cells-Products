---
title: C# XLT na PRN - XLT na konwerter PRN
description: Aspose Excel. Szybko i łatwo przekonwertuj numer XLT na PRN za pomocą Aspose.Cells. C# XLT na PRN. C# Zapisz XLT w PRN. Zapisz XLT jako PRN, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT w PRN w C#" %}}

Poniższy przykład ilustruje sposób konwersji numeru XLT na PRN w formacie C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLT na PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować numer XLT na PRN poprzez numer C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLT na PRN? Programiści .NET mogą łatwo załadować i przekonwertować XLT na PRN w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLT na PRN, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLT na PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLT na PRN" %}}
