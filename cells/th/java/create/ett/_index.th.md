...
description: Aspose เอ็กเซล. Java สร้างไฟล์ ETT อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ ETT โดยใช้ Java สร้าง ETT ใน Java Java ETT Creater
...
1.  บันทึกสมุดงานเป็นรูปแบบ ETT โดยใช้เมธอด save()
...
{{% blocks/products/pf/agp/content h2="Java ไลบรารี่ เพื่อสร้างไฟล์ ETT" %}}
{{% blocks/products/pf/agp/text %}}
