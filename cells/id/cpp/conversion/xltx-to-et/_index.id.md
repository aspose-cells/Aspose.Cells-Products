...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke ET menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengkonversi XLTX ke ET di C++.
...
Perlu mengkonversi file XLTX ke ET secara terprogram? Pengembang C++ dapat dengan mudah mengkonversi XLTX ke ET hanya dengan beberapa baris kode.
...
1.  Konversikan XLTX ke ET dengan memanggil metode Save().
1.  Dapatkan hasil konversi XLTX ke ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ perpustakaan untuk mengkonversi XLTX ke ET" %}}
