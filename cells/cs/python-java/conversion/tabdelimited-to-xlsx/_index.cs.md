---
title: Převést TABDELIMITED na XLSX přes Python

description: Ukázkový kód pro převod tabdelimited na xlsx Python. Použijte API ukázkový kód pro dávkový převod souborů oddělených tabulátory na xlsx v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na XLSX pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na XLSX přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory TABDELIMITED na XLSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TABDELIMITED s instancí sešitu1. Zavolejte metodu Workbook.Save1. Jako parametr předejte výstupní cestu s rozšířením XLSX1. Zkontrolujte zadanou cestu pro výsledný soubor XLSX
