---
title: Converter ODS para JPG por meio do aplicativo C++ 
url: /pt/cpp/conversion/ods-to-jpg/ 
description: Exemplo de código de conversão C++ para documento ODS para formato JPG. Os programadores podem usar esse código-fonte para conversão de lote de ODS para JPG em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/content h2="Como converter ODS para JPG usando C++" %}}

 Para converter ODS para JPG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ODS para JPG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem converter facilmente o arquivo ODS para JPG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo ODS usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (JPG).1. O arquivo JPG será salvo no caminho especificado.1. Abra o arquivo JPG em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de ODS para JPG C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de ODS para JPG" sectionDescription="[Converter ODS para JPG](https://products.aspose.app/cells/conversion/ods-to-jpg) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo ODS, ele será convertido instantaneamente para JPG." >}}
