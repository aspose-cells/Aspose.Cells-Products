---
title: Konwertuj TSV na XLTX przez Java 
weight: 6680
url: /pl/java/conversion/tsv-to-xltx/ 
description: Przykładowy kod konwersji Java dla formatu TSV do pliku XLTX. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do formatu XLTX w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TSV na XLTX przez Java" h2="Konwersja TSV do XLTX Java w celu konwersji jednej lub wielu stron do formatu XLTX przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TSV na XLTX przy użyciu Java" %}}

 Aby wyrenderować TSV do XLTX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TSV na XLTX za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik TSV na XLTX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLTX i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLTX
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji TSV do XLTX Java" offSpacer="" %}}

```cs
// załaduj plik TSV w instancji Workbook
Workbook book = new Workbook("template.tsv");
// zapisz TSV jako XLTX
