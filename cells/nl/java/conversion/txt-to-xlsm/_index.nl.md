---
title: Converteer TXT naar XLSM via Java 
url: /nl/java/conversion/txt-to-xlsm/ 
description: Voorbeeld Java conversiecode voor TXT-indeling naar XLSM-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar XLSM te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer TXT naar XLSM via Java" h2="TXT naar XLSM Java conversie om enkele of meerdere pagina\'s naar XLSM te converteren met behulp van een on-premise Java bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe TXT naar XLSM te converteren met Java" %}}

 Om TXT naar XLSM te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TXT naar XLSM te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen TXT-bestanden gemakkelijk converteren naar XLSM in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad TXT-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met XLSM-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende XLSM-bestand
...
{{% blocks/products/pf/agp/code-block title="TXT naar XLSM Java conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT naar XLSM conversie live demo\'s" sectionDescription="[Converteer TXT naar XLSM](https://products.aspose.app/cells/conversion/txt-to-xlsm) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw TXT-bestand, het wordt direct geconverteerd naar XLSM." >}}
