...
+ تحميل جميع ملفات TXT بالمسار الكامل.
+ قم بعمل مستند واحد كملف أساسي
+ استدعاء الطريقة ذات الصلة لتسلسل ودمج الملفات واحدًا تلو الآخر.
+ استدعاء طريقة Save () وتمرير اسم الملف (المسار الكامل) والتنسيق (TXT) كمعلمة.
+ الآن يمكنك فتح واستخدام الملف TXT في Microsoft Office أو Adobe PDF أو أي برنامج آخر متوافق.
...
{{% blocks/products/pf/agp/code-block title="دمج TXT ملفات - C#" offSpacer="" %}}
