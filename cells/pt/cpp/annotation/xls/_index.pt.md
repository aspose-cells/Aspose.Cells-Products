---
title:  Adicionar ou remover anotação de arquivo Excel XLS por meio de C++
weight: 10040
description: Código de amostra C++ para adicionar e excluir anotações de formato XLS no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
...
1.  Carregue o arquivo Excel XLS usando o objeto de classe IWorkbook.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/annotation/xlsx/" name="XLSX" description="Arquivo Excel OOXML" >}}
