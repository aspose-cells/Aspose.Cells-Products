---
title: Voeg XLT samen met SPREADSHEETML - Combineer XLT met SPREADSHEETML in Java
url: /nl/java/merger/merge-xlt-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online Samenvoegen XLT naar SPREADSHEETML saveformat. Java Combineer XLT naar SPREADSHEETML-indeling. Samenvoegen XLT naar SPREADSHEETML in Java. XLT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLT samen met SPREADSHEETML in Java online" %}}

Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met SPREADSHEETML in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLT samen te voegen met SPREADSHEETML. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het SPREADSHEETML-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat XLT samenvoegt met SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om XLT samen te voegen tot SPREADSHEETML in Java" InputFormat="xlt" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLT samen te voegen tot SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen met SPREADSHEETML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLT samen te voegen tot SPREADSHEETML" %}}
