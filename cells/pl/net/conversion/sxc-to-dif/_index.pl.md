---
title: Konwertuj SXC na DIF przez C#
url: /pl/net/conversion/sxc-to-dif/
description: Przykładowy kod konwersji sxc do różnic C#. Użyj przykładowego kodu API dla wsadowych plików sxc do konwersji dif w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SXC na DIF za pomocą C#" %}}

 Aby przekonwertować SXC na DIF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować SXC na DIF za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki SXC do formatu DIF w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SXC z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem DIF jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku DIF
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji SXC na DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="dif" IsLandingPage="true" %}}
