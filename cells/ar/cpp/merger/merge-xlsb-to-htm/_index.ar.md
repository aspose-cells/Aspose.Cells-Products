...
يوضح المثال التالي كيفية دمج XLSB في HTM في Aspose.Cells for C++.
...
هل تحتاج إلى دمج XLSB في HTM برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لدمج XLSB في HTM" %}}
