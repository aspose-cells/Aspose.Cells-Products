...
description: Aspose Unggul. Ubah XLSX menjadi PNG dengan cepat dan mudah dengan Aspose.Cells. Python XLSX menjadi PNG. Python Simpan XLSX menjadi PNG. Simpan XLSX sebagai 07611134 81 menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah XLSX menjadi PNG di Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX hingga PNG di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi PNG di Python via NET.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLSX menjadi PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="png" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengubah XLSX menjadi PNG" %}}
