---
title: C# XLAM zu JPG - XLAM zu JPG Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM als JPG in C#" %}}

Das folgende Beispiel zeigt, wie man XLAM in JPG in C# konvertiert.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLAM über C# in JPG" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLAM-Dateien programmgesteuert in JPG konvertieren? .NET-Entwickler können XLAM mit nur wenigen Codezeilen problemlos in JPG laden und konvertieren.
...
1.  Konvertieren Sie XLAM in das JPG-Format, indem Sie die Methode Workbook.Save aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLAM in JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLAM in JPG" %}}
