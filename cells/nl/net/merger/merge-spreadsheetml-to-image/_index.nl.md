---
title: Voeg SPREADSHEETML samen met IMAGE - Combineer SPREADSHEETML met IMAGE in C#
url: /nl/net/merger/merge-spreadsheetml-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen SPREADSHEETML naar IMAGE saveformat. C# Combineer SPREADSHEETML naar IMAGE-formaat. Voeg SPREADSHEETML samen met IMAGE in C#. SPREADSHEETML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg SPREADSHEETML samen met IMAGE in C# Gratis online" %}}

Het volgende voorbeeld laat zien hoe SPREADSHEETML kan worden samengevoegd met IMAGE in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om SPREADSHEETML samen te voegen met IMAGE. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het IMAGE-bestand. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat SPREADSHEETML samenvoegt met IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om SPREADSHEETML samen te voegen met IMAGE in C#" InputFormat="xml" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML samen te voegen met IMAGE via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SPREADSHEETML programmatisch samenvoegen met IMAGE? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
