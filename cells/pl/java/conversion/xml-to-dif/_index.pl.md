...
description: Aspose Excel. Konwertuj XML na DIF szybko i łatwo za pomocą Aspose.Cells. Java XML na DIF. Java Zapisz XML na DIF. Zapisz XML jako DIF używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem DIF w Java" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na DIF w Java.
...
Chcesz programowo przekonwertować pliki XML na DIF? Programiści Java mogą łatwo przekonwertować XML na DIF w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji XML na DIF" %}}
{{% blocks/products/pf/agp/text %}}
