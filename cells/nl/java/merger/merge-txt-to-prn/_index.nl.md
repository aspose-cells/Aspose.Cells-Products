---
title: Voeg TXT samen met PRN - Combineer TXT met PRN in Java
url: /nl/java/merger/merge-txt-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online samenvoegen TXT naar PRN-opslagformaat. Java Combineer TXT naar PRN-formaat. Samenvoegen TXT naar PRN in Java. TXT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis TXT samen met PRN in Java online" %}}

Het volgende voorbeeld laat zien hoe u TXT kunt samenvoegen met PRN in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TXT samen te voegen met PRN. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het PRN-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat TXT samenvoegt met PRN.
...
{{% blocks/products/pf/agp/content h2="Hoe TXT samen te voegen met PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om TXT samen te voegen met PRN" %}}
