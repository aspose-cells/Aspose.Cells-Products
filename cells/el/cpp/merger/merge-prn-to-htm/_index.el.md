...
description: Aspose Excel. C++ Aspose.Cells. Συγχώνευση PRN σε μορφή αποθήκευσης HTM. C++ Συνδυάστε τη μορφή PRN σε HTM. Συγχώνευση PRN σε HTM στο C++. Συγχώνευση PRN.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση PRN σε HTM στο C++" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση PRN με HTM στο C++" InputFormat="prn" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
