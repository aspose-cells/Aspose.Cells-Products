---
title: Fusionner HTM vers MD - Combiner HTM vers MD dans C++
url: /fr/cpp/merger/merge-htm-to-md/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion gratuite en ligne du format de sauvegarde HTM vers MD. C++ Combinez le format HTM au format MD. Fusionner HTM avec MD en C++. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM en MD en C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner HTM avec MD dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner HTM avec MD. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier MD. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne HTM avec MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner HTM à MD en C++" InputFormat="htm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM vers MD via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTM vers MD par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner HTM à MD" %}}
