...
{{% cells-convert title="将 XLSM 转换为 OTS 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLSM 转换为 OTS" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 文件转换为 OTS？ .NET 开发人员只需几行代码即可轻松加载 XLSM 并将其转换为 OTS。
