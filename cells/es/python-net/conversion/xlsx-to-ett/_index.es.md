...
description: Aspose Excel. Convierta XLSX a ETT rápida y fácilmente con Aspose.Cells. Python XLSX a ETT. Python Guardar XLSX en ETT. Guarde XLSX como ETT usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XLSX en ETT en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSX a ETT en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir XLSX a ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ett" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSX a ETT" %}}
