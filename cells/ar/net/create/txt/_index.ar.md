---
title: إنشاء TXT - إنشاء ملف TXT في C#
description: Aspose Excel. أنشئ ملفات TXT وتعامل معها بسهولة باستخدام مكتبة Aspose.Cells for .NET. توفر هذه المكتبة القوية API حلاً مبسطًا وفعالًا لإنشاء ملفات TXT وتعديلها وإدارتها مباشرةً ضمن تطبيقاتك C#، مما يلبي احتياجات المطورين بدقة عالية.
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء TXT في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف TXT في C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لإنشاء ملف TXT" %}}
