---
title: C# XLSX a HTML - XLSX a HTML Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato HTML, permitindo o salvamento perfeito de dados XLSX no formato HTML usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a HTML em C#" %}}

exemplo a seguir demonstra como converter XLSX em HTML em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter XLSX em HTML por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX em HTML programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em HTML em apenas algumas linhas de código.
...
1.  Converta XLSX para HTML chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para HTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em HTML" %}}
