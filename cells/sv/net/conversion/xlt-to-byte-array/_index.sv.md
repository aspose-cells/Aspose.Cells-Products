...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array är till hjälp för databearbetning eller lagring. Du kan konvertera filen XLT till Byte Array samt en**Byte Array till XLT** dokument med C# språk. För att konvertera XLT till byte array kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Hur man konverterar XLT till Byte Array via C#" %}}
...
1.  Ladda indata XLT Fil med arbetsbok
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar XLT till byte array C# konvertering" offSpacer="" %}}
