---
title: Slå samman SXC till MARKDOWN - Kombinera SXC till MARKDOWN i C#
url: /sv/net/merger/merge-sxc-to-markdown/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge SXC till MARKDOWN sparaformat. C# Kombinera SXC till MARKDOWN format. Slå samman SXC till MARKDOWN i C#. SXC Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman SXC till MARKDOWN i C# Online gratis" %}}

Följande exempel visar hur man slår samman SXC till MARKDOWN i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman SXC till MARKDOWN. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen MARKDOWN. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman SXC till MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman SXC till MARKDOWN i C#" InputFormat="sxc" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman SXC till MARKDOWN via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman SXC till MARKDOWN programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman SXC till MARKDOWN" %}}
