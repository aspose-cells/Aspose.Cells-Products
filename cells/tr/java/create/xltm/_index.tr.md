---
title: XLTM oluştur - Java'de XLTM dosyası oluştur
description: Aspose excel. Java XLTM Dosyası Oluştur. Oluştur XLTM Java. Java XLTM Oluşturan. Java'de XLTM oluşturun. Java'i kullanarak XLTM dosyasını oluşturun.
...
{{% blocks/products/pf/agp/content h2="Java\'de XLTM Nasıl Oluşturulur" %}}
...
1.  Çalışma kitabını save() yöntemini kullanarak XLTM biçiminde kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, Java\'de XLTM dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="XLTM dosyası oluşturmak için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
