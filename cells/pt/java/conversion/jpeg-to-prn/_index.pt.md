---
title: Java JPEG para PRN - Conversor Online JPEG para PRN
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Online Grátis Java Converter JPEG para PRN saveformat. Java JPEG para o formato PRN. Salve JPEG para PRN Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter JPEG para PRN em Java" h2="Biblioteca Java de alta velocidade para converter JPEG em PRN. Esta é uma solução de software profissional para importar e exportar JPEG, PRN e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salve JPEG em PRN em Java online gratuitamente" %}}

O exemplo a seguir demonstra como converter JPEG em PRN em Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter JPEG em PRN. Carregue seu arquivo JPEG e simplesmente salve-o como arquivo PRN. Para leitura de JPEG e gravação de PRN, você pode usar nomes de arquivo totalmente qualificados. O conteúdo e a formatação do PRN de saída serão idênticos ao documento JPEG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter JPEG em PRN online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter JPEG para PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPEG para PRN programaticamente? Java desenvolvedores podem facilmente converter JPEG para PRN em apenas algumas linhas de código.
...
1.  Converta JPEG em PRN chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de JPEG para PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteca para converter JPEG para PRN" %}}
{{% blocks/products/pf/agp/text %}}
