...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLT 转换为 HTM。C# XLT 转换为 HTM。 C# 将 XLT 保存到 HTM。使用 C# 将 XLT 保存为 HTM。
...
{{% blocks/products/pf/agp/content h2="将 XLT 保存到 C# 中的 HTM" %}}

以下示例演示如何将 XLT 转换为 C# 中的 HTM。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLT 转换为 HTM。上传您的 XLT 文件，然后将其保存为 HTM 文件。对于 XLT 读取和 HTM 写入，您可以使用完全限定的文件名。输出的 HTM 内容和格式将与原始 XLT 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 XLT 转换为 HTM 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="htm" IsLandingPage="true" %}}
