---
title:  Hasilkan Laporan di File XLSX via .NET
weight: 6740
description: Kode sumber C# untuk menghasilkan laporan format XLSX pada Kerangka .NET, Inti .NET, Mono atau Platform Xamarin.
...
1. Simpan hasil dalam format XLSX melalui metode WorkbookDesigner.Worbook.Save
...
{{% blocks/products/pf/agp/code-block title="Hasilkan XLSX Laporan" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/assembly/xlsm/" name="XLSM" description="Berkas Lembar Bentang" >}}
