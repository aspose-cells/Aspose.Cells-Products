...
url: /cs/cpp/merger/merge-prn-to-jpeg/ 
...
Následující příklad ukazuje, jak sloučit PRN s JPEG v Aspose.Cells for C++.
...
Potřebujete sloučit PRN s JPEG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení PRN s JPEG" %}}
