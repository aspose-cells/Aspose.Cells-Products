...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TXT Dosyalarını Birleştirme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java içinde TXT Dosyalarını Birleştirme Adımları" %}}
...
+ İlk TXT dosyasını Workbook sınıfının bir örneğiyle yükleyin.
+ İkinci TXT belgesini Workbook sınıfının bir örneğiyle yükleyin.
+ Combine() yöntemini kullanarak dosyaları birleştirin.
+ birleştirilmiş TXT dosyasını belirtilen yola kaydedin
