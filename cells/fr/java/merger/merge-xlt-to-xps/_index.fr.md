---
title: Fusionner XLT à XPS - Combiner XLT à XPS dans Java
url: /fr/java/merger/merge-xlt-to-xps/ 
description: Aspose Exceller. Java Aspose.Cells. Fusionner le format de sauvegarde XLT à XPS. Java Combinez les formats XLT à XPS. Fusionner XLT à XPS dans Java. XLT Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLT à XPS dans Java" %}}

L'exemple suivant montre comment fusionner XLT à XPS dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLT à XPS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier XPS. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne XLT à XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner XLT à XPS dans Java" InputFormat="xlt" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLT à XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLT à XPS par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner XLT à XPS" %}}
