---
title: Search XLTM document without opening via Go via C++
weight: 9280

description: Go via C++ example code to search words with pattern in XLTM file on Go via C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Search XLTM Files in Go via C++" %}}
...
+  Load XLTM file by instantiating a Workbook class.
...
+  Save XLTM file using Workbook::Save(...) method.
...
{{% blocks/products/pf/agp/code-block title="Search XLTM Files - Go via C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLTM Search Live Demos" sectionDescription="Search text, words, phrases within XLTM documents right now by visiting our [Live Demos website](https://products.aspose.app/cells/search). The live demo has the following benefits" >}}
