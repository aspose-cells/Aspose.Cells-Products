---
title: Unisci FODS a TABDELIMITED - Combina FODS a TABDELIMITED in C#
url: /it/net/merger/merge-fods-to-tabdelimited/ 
description: Aspose Excel. C# Aspose.Cells. Unisci online gratuito FODS in TABDELIMITED saveformat. C# Combina FODS nel formato TABDELIMITED. Unisci FODS a TABDELIMITED in C#. FODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci FODS a TABDELIMITED in C# online gratuitamente" %}}

L'esempio seguente mostra come unire FODS a TABDELIMITED in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire FODS a TABDELIMITED. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file TABDELIMITED. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce FODS a TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuito online per unire FODS a TABDELIMITED in C#" InputFormat="fods" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire FODS a TABDELIMITED tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire FODS a TABDELIMITED a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria da unire FODS a TABDELIMITED" %}}
