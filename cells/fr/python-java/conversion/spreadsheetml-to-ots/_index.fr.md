...
description: Aspose Exceller. Convertissez SPREADSHEETML en OTS rapidement et facilement avec Aspose.Cells. Python SPREADSHEETML en OTS. Python Enregistrez SPREADSHEETML dans OTS. Enregistrez SPREADSHEETML sous OTS en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir SPREADSHEETML en OTS à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer SPREADSHEETML dans OTS dans Python" %}}

L'exemple suivant montre comment convertir SPREADSHEETML en OTS dans Python.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour convertir SPREADSHEETML en OTS" %}}
