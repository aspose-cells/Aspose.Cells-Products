...
1. Φορτώστε το κλειδωμένο αρχείο XLSB χρησιμοποιώντας το CreateIWorkbook.1. Καλέστε τη λειτουργία Unprotect() για ξεκλείδωμα.1. Ορίστε τον κωδικό πρόσβασης σε NULL χρησιμοποιώντας το SetPassword.1. Αποθηκεύστε το αρχείο XLSB σε μια καθορισμένη τοποθεσία.
