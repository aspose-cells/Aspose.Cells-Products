---
title: Объединить XLSM в MHTML - Объединить XLSM в MHTML в Python
url: /ru/python-net/merger/merge-xlsm-to-mhtml/ 
description: Aspose Excel. Python Aspose.Cells. Бесплатное онлайн объединение XLSM в формат сохранения MHTML. Python Объединить формат XLSM в формат MHTML. Объединить XLSM с MHTML в Python. XLSM Объединить.
...
{{% cells-merger title="Бесплатно онлайн объединить XLSM с MHTML в Python" InputFormat="xlsm" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Как объединить XLSM с MHTML через Python" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить XLSM с MHTML? Базовый документ сливается и объединяется с[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API можно реализовать всего несколькими строками кода.
