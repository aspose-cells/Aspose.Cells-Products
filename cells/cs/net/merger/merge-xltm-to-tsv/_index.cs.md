---
title: Sloučit XLTM až TSV - Sloučit XLTM až TSV v C#
url: /cs/net/merger/merge-xltm-to-tsv/ 
description: Aspose Excel. C# Aspose.Cells. Online sloučení zdarma XLTM do formátu uložení TSV. C# Kombinujte formát XLTM až TSV. Sloučit XLTM až TSV v C#. XLTM Sloučit.
...
Následující příklad ukazuje, jak sloučit XLTM až TSV v Aspose.Cells for .NET.
...
{{% cells-merger title="Online zdarma ke sloučení XLTM až TSV v C#" InputFormat="xltm" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLTM na TSV přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLTM až TSV? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
