---
title: Réparer le fichier xlsx via Java
url: /fr/java/recovery/repair-xlsx/ 
description: Réparez un fichier xlsx corrompu à l'aide de Java. Outil de récupération pour réparer le fichier xlsx corrompu dans l'application Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Récupérer le fichier XLSX via Java" h2="Créez votre propre application Java pour réparer les fichiers xlsx à l\'aide de Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment réparer le fichier xlsx en utilisant Java" %}}
...
{{% cells-recovery title="Application gratuite pour réparer le fichier XLSX en utilisant Java" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="java" %}}    
