---
title:  Редактировать или просматривать метаданные документа XLSB по номеру C++.
weight: 4820
description: C++ пример кода для редактирования или просмотра метаданных файла XLSB в среде выполнения C++ для Windows 32-разрядной версии, Windows 64-разрядной версии и 64-разрядной версии Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Извлеките метаданные XLSB через C++." h2="Создавайте свои собственные приложения C++, чтобы добавлять, редактировать, удалять или извлекать метаданные из файлов XLSB с помощью серверных API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
+ Загрузите файл XLSB с помощью WorkbookMetadata.
