---
title: Konvertor PHP XLAM až TSV - XLAM až TSV
description: Aspose Excel. Převeďte XLAM na TSV rychle a snadno pomocí Aspose.Cells. PHP XLAM na TSV. PHP Uložte XLAM na TSV. Uložte TSV jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="tsv" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na TSV přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na TSV programově? Vývojáři PHP mohou snadno načíst a převést XLAM na TSV v několika řádcích kódu.
...
1.  Převeďte XLAM na TSV voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na TSV" %}}
