...
description: Aspose Excel. Python Aspose.Cells. A FODS egyesítése SQL mentési formátumba. Python Kombinálja a FODS-et SQL formátumba. A FODS egyesítése SQL-be a Python-ben. FODS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A FODS egyesítése SQL-be a Python használatával" %}}
...
{{% blocks/products/pf/agp/content h2="A FODS egyesítése SQL-lel a Python-ben" %}}

következő példa bemutatja, hogyan egyesítheti a FODS-et az SQL-lel a Aspose.Cells for Python via .NET-ben.
...
{{% cells-merger title="Mintakód a FODS SQL-hez való egyesítéséhez a Python-ben" InputFormat="fods" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A FODS egyesítése SQL-be a Python-en keresztül" %}}
