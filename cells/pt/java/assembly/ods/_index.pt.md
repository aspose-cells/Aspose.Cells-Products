---
title:  Gerar Relatórios nos Arquivos ODS via Java
weight: 2440
description: Código de amostra Java para criar relatórios no formato ODS no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
...
{{< blocks/products/pf/i18n/upper-banner h1="Geração de relatórios em massa no formato ODS via Java" h2="Gere relatórios no formato ODS usando fonte de dados e um modelo." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Como gerar relatórios ODS usando Java" %}}

 Para criar relatórios de arquivo ODS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar relatórios ODS via Java" %}}
...
1.  Salve o resultado no formato ODS através do método Workbook.save
...
{{% blocks/products/pf/agp/code-block title="Gerar relatórios Excel no formato ODS - Java" offSpacer="" %}}
