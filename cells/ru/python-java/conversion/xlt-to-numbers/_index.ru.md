---
title: Python XLT в цифры - Конвертер XLT в цифры
...
{{% cells-convert title="Пример кода для преобразования числа XLT в число с помощью библиотеки Excel Python." formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlt" outformat="numbers" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Как преобразовать XLT в цифры с помощью Python" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы XLT в числа? Разработчики, работающие с файлами Python, могут легко загрузить и преобразовать файлы XLT в числа всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Excel Python для преобразования числа XLT в цифры." %}}
