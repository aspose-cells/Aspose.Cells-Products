---
title: C# XLS na POWERPOINT - XLS na konwerter POWERPOINT
description: Aspose Excel. Szybko i łatwo przekonwertuj XLS na POWERPOINT za pomocą Aspose.Cells. C# XLS na POWERPOINT. C# Zapisz XLS w POWERPOINT. Zapisz XLS jako POWERPOINT, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS w POWERPOINT w C#" %}}

Poniższy przykład ilustruje, jak przekonwertować XLS na POWERPOINT w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na POWERPOINT. Prześlij plik XLS, a następnie po prostu zapisz go jako plik POWERPOINT. Zarówno do odczytu XLS, jak i do zapisu w programie POWERPOINT można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie programu POWERPOINT będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLS na POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na POWERPOINT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na POWERPOINT? Programiści .NET mogą łatwo załadować i przekonwertować XLS na POWERPOINT w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj XLS na POWERPOINT, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLS na POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS do POWERPOINT" %}}
