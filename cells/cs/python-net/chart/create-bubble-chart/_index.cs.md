...
{{% blocks/products/pf/agp/feature-section-col title="Jak vytvořit bublinové grafy přes Python" %}}
...
1. Přidejte do listu bublinový graf
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Následující zdrojový kód ukazuje, jak vytvořit bublinový graf do souboru MS Excel XLSX pomocí Python." offSpacer="" %}}
