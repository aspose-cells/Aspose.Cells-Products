---
title:  دمج XLT ملفات via .NET
weight: 1820
description: كود المصدر C# لدمج XLT مستندًا على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="دمج XLT التنسيقات في C#" h2="دمج المستندات XLT أصلي وعالي الأداء باستخدام واجهات برمجة التطبيقات Aspose.Cells for .NET من جانب الخادم، دون استخدام أي برنامج مثل Microsoft أو Open Office، Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
+ تحميل جميع ملفات XLT بالمسار الكامل.
+ قم بعمل مستند واحد كملف أساسي
+ استدعاء الطريقة ذات الصلة لتسلسل ودمج الملفات واحدًا تلو الآخر.
+ استدعاء طريقة Save () وتمرير اسم الملف (المسار الكامل) والتنسيق (XLT) كمعلمة.
+ الآن يمكنك فتح واستخدام الملف XLT في Microsoft Office أو Adobe PDF أو أي برنامج آخر متوافق.
...
{{% blocks/products/pf/agp/code-block title="دمج XLT ملفات - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "d7c757e7471bd38006ac0d35d221b2e2" "merge-xlt-files.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{< blocks/products/pf/agp/demobox sectionTitle="عبر الإنترنت XLT الاندماج العروض الحية" sectionDescription=" قم بدمج مستندات XLT الآن من خلال زيارة موقعنا[موقع العروض الحية](https://products.aspose.app/cells/merger). يتمتع العرض التجريبي المباشر بالمزايا التالية" >}}
