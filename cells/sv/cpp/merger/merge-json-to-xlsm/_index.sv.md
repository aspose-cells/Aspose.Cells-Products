---
title: Slå samman JSON till XLSM - Kombinera JSON till XLSM i C++
url: /sv/cpp/merger/merge-json-to-xlsm/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis Online Merge JSON till XLSM sparaformat. C++ Kombinera JSON till XLSM format. Slå samman JSON till XLSM i C++. JSON Slå samman.
...
Följande exempel visar hur man slår samman JSON till XLSM i Aspose.Cells for C++.
...
{{% cells-merger title="Gratis online för att slå samman JSON till XLSM i C++" InputFormat="json" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman JSON till XLSM via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman JSON till XLSM programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API:er kan göras med bara några rader kod.
