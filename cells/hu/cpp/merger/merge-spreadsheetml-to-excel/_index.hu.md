---
title: SPREADSHEETML egyesítése EXCEL-lel – SPREADSHEETML egyesítése EXCEL-lel a C++-ben
url: /hu/cpp/merger/merge-spreadsheetml-to-excel/ 
description: Aspose Excel. C++ Aspose.Cells. A SPREADSHEETML egyesítése EXCEL mentési formátumba. C++ A SPREADSHEETML egyesítése EXCEL formátumba. A SPREADSHEETML egyesítése az EXCEL-lel a C++-ben. SPREADSHEETML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A SPREADSHEETML egyesítése az EXCEL-lel a C++-ben" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a SPREADSHEETML-t az EXCEL-lel a Aspose.Cells for C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SPREADSHEETML és az EXCEL egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el EXCEL fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++ példát, amely a SPREADSHEETML-t EXCEL-lel egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a SPREADSHEETML és az EXCEL egyesítéséhez a C++-ben" InputFormat="xml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML egyesítése EXCEL-lel a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SPREADSHEETML-t az EXCEL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a SPREADSHEETML és az EXCEL egyesítéséhez" %}}
