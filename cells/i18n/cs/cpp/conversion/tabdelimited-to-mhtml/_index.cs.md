...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na MHTML pomocí C++" %}}

 K převodu TABDELIMITED na MHTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na MHTML prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor TABDELIMITED na MHTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TABDELIMITED pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (MHTML).1. Soubor MHTML bude uložen do zadané cesty.1. Otevřete soubor MHTML v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze TABDELIMITED na MHTML C++" offSpacer="" %}}
