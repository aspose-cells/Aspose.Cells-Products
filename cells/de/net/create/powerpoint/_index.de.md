---
title: POWERPOINT erstellen – Erstellen Sie eine POWERPOINT-Datei in C#
description: Aspose Excel. C# POWERPOINT-Datei erstellen. Erstellen Sie POWERPOINT C#. C# POWERPOINT-Ersteller. Erstellen Sie POWERPOINT unter C#. Erstellen Sie eine POWERPOINT-Datei unter Verwendung von C#.
...
{{% blocks/products/pf/agp/content h2="So erstellen Sie POWERPOINT in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Der Beispielcode zeigt, wie eine POWERPOINT-Datei in C# erstellt wird." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Erstellen einer POWERPOINT-Datei" %}}
