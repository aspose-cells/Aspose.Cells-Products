...
{{< blocks/products/pf/i18n/upper-banner h1="TSV konvertálása MHTML-re a következőn keresztül: Java" h2="TSV-ből MHTML-be Java konverzió, amellyel egyetlen vagy több oldalt konvertálhat MHTML-re a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása MHTML-re a következővel: Java" %}}

 Ahhoz, hogy a TSV-t MHTML-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV MHTML-re konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak TSV-fájlt MHTML-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. TSV-fájl betöltése a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat MHTML kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott MHTML-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TSV-ből MHTML-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TSV-fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tsv");
// mentse a TSV-t MHTML-ként
