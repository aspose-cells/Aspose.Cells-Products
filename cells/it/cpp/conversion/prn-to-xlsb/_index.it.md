...
description: Aspose Excel. Converti il PRN in XLSB in modo rapido e semplice con Aspose.Cells. C++ PRN in XLSB. C++ Salva PRN in XLSB. Salva PRN come XLSB utilizzando C++.
...
{{% blocks/products/pf/agp/content h2="Salva il PRN allo XLSB in C++" %}}

L'esempio seguente mostra come convertire il PRN in XLSB in C++.
...
È necessario convertire i file PRN in XLSB a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in XLSB in poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria C++ per convertire il PRN in XLSB" %}}
