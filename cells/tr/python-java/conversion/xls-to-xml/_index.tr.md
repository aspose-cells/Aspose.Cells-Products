---
title: Python XLS'den XML'e - XLS'den XML'e Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile XLS'i hızlı ve kolay bir şekilde XML'e dönüştürün. Python XLS'i XML'e dönüştürün. Python XLS'i XML'e kaydedin. XLS'i Python'i kullanarak XML olarak kaydedin.
...
{{% cells-convert title="XLS\'i XML\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLS\'i Python aracılığıyla XML\'e dönüştürme" %}}
