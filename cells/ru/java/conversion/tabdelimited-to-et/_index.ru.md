...
{{% blocks/products/pf/agp/content h2="Преобразовать TABDELIMITED в ET, используя код Java." %}}
...
Следующий пример демонстрирует, как преобразовать TABDELIMITED в ET в коде Java.
...
Нужно программно преобразовать файлы с ограничением по вкладкам (TABDELIMITED) в формат ET? Разработчики, использующие код Java, могут легко преобразовать файлы TABDELIMITED в ET всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования TABDELIMITED в ET" %}}
{{% blocks/products/pf/agp/text %}}
