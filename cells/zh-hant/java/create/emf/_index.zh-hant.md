---
title: 創建EMF - 在Java中創建EMF文件
description: Aspose Excel。 Java 創建 EMF 文件。創建EMF Java。Java EMF創建者。在Java中創建EMF。使用Java生成EMF文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建EMF" %}}
...
1. 使用 save() 方法將工作簿保存為 EMF 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 EMF 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建EMF文件" %}}
{{% blocks/products/pf/agp/text %}}
