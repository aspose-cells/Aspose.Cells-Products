...
description: Aspose เอ็กเซล. Java สร้างไฟล์ BMP อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ BMP โดยใช้ Java สร้าง BMP ใน Java Java BMP Creater
...
1. บันทึกสมุดงานเป็นรูปแบบ BMP โดยใช้เมธอด save()
