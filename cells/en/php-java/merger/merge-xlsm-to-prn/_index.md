...
url: /php-java/merger/merge-xlsm-to-prn/ 
description: Aspose Excel. PHP Aspose.Cells. Merge XLSM to PRN saveformat. PHP Combine XLSM to PRN format. Merge XLSM to PRN in PHP. XLSM Merge.
...
{{% blocks/products/pf/agp/content h2="Merge XLSM to PRN Using PHP" %}}

How do I merge XLSM to PRN? With Aspose.Cells for PHP via Java library, you can easily merge XLSM to PRN programmatically with  a few lines of code. [Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) is capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. PHP Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT and more, thus making it a perfect choice to exchange documents in industry-standard formats. 

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Merge XLSM to PRN in PHP" %}}

The following example demonstrates how to merge XLSM to PRN in Aspose.Cells for PHP via Java.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to merge XLSM to PRN. Upload your files, call $Workbook->combine method for merging files, and then save it to PRN file. If you develop code in PHP, this will be simpler than it sounds. See PHP example that merges XLSM to PRN.
...
{{% blocks/products/pf/agp/content h2="How to Merge XLSM to PRN via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Need to merge XLSM to PRN programmatically? A basic document merging and concatenating with [Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java) APIs can be done with just few lines of code.
...
{{% blocks/products/pf/agp/content h2="PHP library to merge XLSM to PRN" %}}
