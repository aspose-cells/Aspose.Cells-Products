---
title: 通過 C++ 將箭頭插入 Excel 中
weight: 770
description: C++ 在 Windows 32 位、Windows 64 位和 Linux 64 位的 C++ 運行時環境中在 Excel 文件中插入塊箭頭的示例代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 將箭頭插入 Excel 中" h2="使用服務器端的本機高性能插入對象 Aspose.Cells for C++ API，無需使用任何軟件，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ 通過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ab8156e8562724f9a597b7d2bc503cd4d)在選定的工作表中插入塊箭頭類型概述
以 XLSX 格式保存工作簿。
...
下面的示例代碼演示瞭如何插入“右箭頭”。更多類型請參考下面的“方塊箭頭類型概述”。
