...
The following example demonstrates how to merge EXCEL to FODS in Aspose.Cells for .NET.
...
Need to merge EXCEL to FODS programmatically? A basic document merging and concatenating with [Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs can be done with just few lines of code.
...
{{% blocks/products/pf/agp/content h2=".NET library to merge EXCEL to FODS" %}}
