...
Siga los sencillos pasos para convertir JPEG a TIFF. Cargue su archivo JPEG y luego simplemente guárdelo como archivo TIFF. Tanto para lectura JPEG como para escritura TIFF puede utilizar nombres de archivo completos. El contenido y el formato de salida TIFF serán idénticos al documento JPEG original.
...
{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir JPEG a TIFF" %}}
