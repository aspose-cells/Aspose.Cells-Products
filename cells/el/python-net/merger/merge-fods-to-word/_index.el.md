---
title:  Συγχώνευση FODS στο WORD μέσω Python
url: /el/python-net/merger/merge-fods-to-word/ 
description: Συγχώνευση FODS στο WORD Online δωρεάν. Δωρεάν Online FODS στο WORD Merger. Συγχώνευση FODS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS στο WORD στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση FODS στο WORD σε απευθείας σύνδεση" InputFormat="fods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
