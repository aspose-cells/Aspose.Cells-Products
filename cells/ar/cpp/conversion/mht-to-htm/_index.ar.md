---
title: C++ MHT to HTM - محول MHT عبر الإنترنت إلى HTM
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل MHT إلى HTM saveformat. C++ MHT إلى تنسيق HTM. احفظ MHT في HTM C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT في HTM في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى HTM برمجيًا؟ يمكن للمطورين C++ تحويل MHT إلى HTM بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل MHT إلى HTM باستدعاء طريقة Save ().
1.  احصل على نتيجة تحويل MHT إلى HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ مكتبة لتحويل MHT إلى HTM" %}}
