---
title: Conversor C# XLSX para HTM - XLSX para HTM
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato HTM, permitindo o salvamento perfeito de dados XLSX no formato HTM usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salvar XLSX em HTM em C#" %}}

O exemplo a seguir demonstra como converter XLSX para HTM em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter XLSX para HTM usando C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para HTM programaticamente? Os desenvolvedores de .NET podem facilmente carregar e converter arquivos XLSX para HTM com apenas algumas linhas de código.
...
1.  Converta XLSX para HTM chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em HTM" %}}
