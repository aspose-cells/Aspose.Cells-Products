---
title: 在 XLSB 文件 via .NET 中生成報告
weight: 1690
description: C# 源代碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上生成 XLSB 格式報告。
---
...
1. 通過 WorkbookDesigner.Worbook.Save 方法將結果保存為 XLSB 格式
