---
title: XLTM'i XPS'e birleştir - XLTM'i C#'de XPS'e birleştir
url: /tr/net/merger/merge-xltm-to-xps/ 
description: Aspose Excel'de. C# Aspose.Cells. XLTM'i XPS kaydetme biçimiyle birleştirin. C# XLTM'i XPS biçimiyle birleştirin. C#'de XLTM'i XPS ile birleştirin. XLTM Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i C#\'de XPS ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de XLTM ile XPS'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

XLTM ile XPS'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XPS dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. XLTM ile XPS'i birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="XLTM ile XPS\'i C#\'de Birleştirmek için Örnek Kod" InputFormat="xltm" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="XLTM\'i C# aracılığıyla XPS\'e Nasıl Birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

 XLTM ile XPS'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kitaplığı, XLTM ile XPS arasında birleştirilecek" %}}
