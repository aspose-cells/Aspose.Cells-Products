...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 开发人员只需几行代码即可轻松地将 TXT 文件转换为 XLSM。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 TXT 文件。1. 调用 Save() 方法。1. 使用 (XLSM) 文件扩展名传递输出文件路径。1. XLSM 文件将保存在指定路径。1. 在兼容程序中打开 XLSM 文件。
...
{{% blocks/products/pf/agp/code-block title="TXT 到 XLSM C++ 转换源代码" offSpacer="" %}}
