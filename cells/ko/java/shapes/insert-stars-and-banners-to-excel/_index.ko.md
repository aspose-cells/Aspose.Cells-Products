---
title:  Excel via Java에 별표/배너 삽입 삽입
weight: 381
description: Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells' Java API을 사용하여 별/배너를 삽입합니다.
keywords: [Java Aspose.Cells., Java add Star/Banner., Java insert Star/Banner., Java create Star/Banner]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Excel via Java에 별표/배너 삽입 삽입" h2="Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells\' API을 사용하여 별/배너를 삽입합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 Excel 파일에 별/배너 삽입 방법을 삽입하는 방법" %}}

 별/배너 삽입을 엑셀 파일에 삽입하기 위해 다음을 사용하겠습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Excel 파일에 별/배너 삽입 방법 via Java" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 +[메소드 추가](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) 선택한 워크시트에 별/배너 삽입
...
아래 샘플 코드는 "리본: 곡선 및 위로 기울어짐" 및 "폭발: 8포인트"를 삽입하는 방법을 보여줍니다. 더 많은 유형에 대해서는 아래의 "별 및 배너 삽입 유형 개요"를 참조하세요.

{{% blocks/products/pf/agp/code-block title="삽입 별표/배너 삽입 - Java" offSpacer="" %}}
