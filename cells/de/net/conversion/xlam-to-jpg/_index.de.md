...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM kostenlos als JPG in C# online" %}}

Das folgende Beispiel zeigt, wie XLAM in JPG in C# konvertiert wird.
...
Müssen Sie XLAM-Dateien programmgesteuert in JPG konvertieren? .NET-Entwickler können XLAM in nur wenigen Codezeilen problemlos laden und in JPG konvertieren.
...
1.  Konvertieren Sie XLAM in JPG, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLAM in JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLAM in JPG" %}}
