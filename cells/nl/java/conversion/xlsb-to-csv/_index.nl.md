...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in CSV in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar CSV in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar CSV of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar CSV? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar CSV met slechts een paar regels code.
