---
title:  Generar Informes en Archivos XLS via Java
weight: 1090
description: Código de muestra Java para crear informes en formato XLS en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Generar Informes XLS via Java" %}}
...
1.  Guarde el resultado en formato XLS mediante el método Worbook.save
...
{{% blocks/products/pf/agp/code-block title="Generar Informes Excel en Formato XLS - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API se puede utilizar para crear, editar, convertir y renderizar Microsoft formatos de Excel a diferentes formatos. Además, se puede utilizar para gráficos completos, informes escalables y cálculos confiables dentro de aplicaciones de software. Aspose.Cells es un API independiente y no requiere ningún software como Microsoft u OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="App Gratuita para Montar XLS" sectionDescription=" Consulte nuestras demostraciones en vivo para[crear archivos XLS](https://products.aspose.app/cells/assembly/xls) con los siguientes beneficios." >}}
