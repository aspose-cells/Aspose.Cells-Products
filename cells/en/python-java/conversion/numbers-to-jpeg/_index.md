...
Follow the easy steps to convert NUMBERS into JPEG. Upload your NUMBERS file, then simply save it as JPEG file. For both NUMBERS reading and JPEG writing you can use fully qualified filenames. The output JPEG content and formatting will be identical to the original NUMBERS document.
