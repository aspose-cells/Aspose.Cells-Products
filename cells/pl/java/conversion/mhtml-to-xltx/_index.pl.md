---
title: Java MHTML do XLTX - MHTML do XLTX Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu MHTML do XLTX, umożliwiając bezproblemowe zapisywanie danych MHTML do formatu XLTX za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHTML do XLTX w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować MHTML na XLTX w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer MHTML na numer XLTX. Prześlij plik MHTML, a następnie po prostu zapisz go jako plik XLTX. Zarówno do odczytu MHTML, jak i do zapisu XLTX można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego XLTX będą identyczne z oryginalnym dokumentem MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji MHTML na XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mhtml" outformat="xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki MHTML na XLTX? Programiści Java mogą łatwo przekonwertować pliki MHTML na XLTX za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

1.  Zainstaluj 'Aspose.Cells for Java'.
1.  Dodaj odniesienie do biblioteki (zaimportuj bibliotekę) do swojego projektu Java.
1.  Załaduj plik MHTML z wystąpieniem klasy Workbook.
1.  Konwertuj numer MHTML na numer XLTX, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji MHTML na XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji MHTML na XLTX" %}}
{{% blocks/products/pf/agp/text %}}
