...
Вам нужно программно преобразовать XML-файлы в MARKDOWN? Разработчики .NET могут легко загружать и конвертировать XML в MARKDOWN всего за несколько строк кода.
...
1.  Преобразовать XML в формат MARKDOWN, вызвав метод Workbook.Save.
