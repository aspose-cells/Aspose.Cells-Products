...
description: Sample code for xlsb to xml C# conversion. Use API example code for batch xlsb files to xml conversion within VB.NET, Asp.NET or any .NET based application.
---
