...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET разработчиков могут легко загружать и преобразовывать XML в NUMBERS, написав всего несколько строк кода.
