...
url: /ja/net/merger/merge-ods-to-sql/ 
...
次の例は、ODS を Aspose.Cells for .NET の SQL にマージする方法を示しています。
...
ODS をプログラムで SQL にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
