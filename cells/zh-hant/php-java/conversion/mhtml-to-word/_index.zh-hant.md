---
title: PHP MHTML 至 WORD - MHTML 至 WORD 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHTML 轉換為 WORD。PHP MHTML 轉換為 WORD。PHP 將 MHTML 儲存為 07617481。PHP 將 MHTML 儲存為 0761741818317481761741818761748181761748183。
...
如何將 MHTML 轉換為 WORD？使用 Aspose.Cells for PHP via Java 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 MHTML 轉換為 WORD。[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 PHP Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 MHTML 儲存為 PHP 中的 WORD" %}}

以下範例示範如何在 PHP 中將 MHTML 轉換為 WORD。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHTML 轉換為 WORD。上傳您的 MHTML 文件，然後只需將其另存為 WORD 文件。對於 MHTML 讀取和 WORD 寫入，您可以使用完全限定的檔案名稱。輸出 WORD 內容和格式將與原始 MHTML 文件相同。
...
需要以程式方式將 MHTML 檔案轉換為 WORD 嗎？ PHP 開發人員只需幾行程式碼即可輕鬆載入 MHTML 並將其轉換為 WORD。
...
1. 透過呼叫Workbook的save方法將MHTML轉換為WORD。
1. 取得MHTML到WORD的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP函式庫將MHTML轉換為WORD" %}}
