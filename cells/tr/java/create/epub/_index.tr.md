---
title: EPUB dosyası oluştur - Java numaralı dosyada EPUB dosyası oluştur
description: Aspose Excel. Aspose.Cells for Java kütüphanesi ile EPUB dosyalarını zahmetsizce oluşturun ve düzenleyin. Bu güçlü API, EPUB dosyalarını doğrudan Java uygulamalarınız içinde oluşturmak, düzenlemek ve yönetmek için akıcı ve verimli bir çözüm sunarak, geliştiricilerin özel ihtiyaçlarını yüksek hassasiyetle karşılar.
...
{{% blocks/products/pf/agp/content h2="Java\'de EPUB Nasıl Oluşturulur?" %}}
...
1.  save() yöntemini kullanarak çalışma kitabını EPUB formatında kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, Java numaralı cihazda EPUB dosyasının nasıl oluşturulacağını göstermektedir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java EPUB dosyası oluşturmak için kullanılan kütüphane" %}}
{{% blocks/products/pf/agp/text %}}
