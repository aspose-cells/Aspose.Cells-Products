---
title: Convert JPEG to TIFF via C#
description: Convert JPEG to TIFF. Convert JPEG to TIFF online for free. Convert JPEG to Word, Excel, PPTX, PDF, JPG, HTML, ODS, BMP, PNG, SVG, XPS and more.
...
The following example demonstrates how to convert JPEG to TIFF document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert JPEG file into TIFF format. Upload your JPEG file, then simply save it as TIFF file. For both JPEG reading and TIFF writing you can use fully qualified filenames. The output TIFF content and formatting will be identical to the original JPEG document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert JPEG to TIFF Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="tiff" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert JPEG to TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert JPEG files to TIFF in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load JPEG file with an instance of Workbook
1.  Convert JPEG to TIFF by calling Workbook.Save method
