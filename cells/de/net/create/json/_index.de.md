---
title: Erstellen Sie JSON - Erstellen Sie JSON Datei in C#
description: Aspose Excel. Mit der Bibliothek Aspose.Cells for .NET lassen sich JSON-Dateien mühelos erstellen und bearbeiten. Diese leistungsstarke Bibliothek API bietet eine optimierte und effiziente Lösung zum Erstellen, Bearbeiten und Verwalten von JSON-Dateien direkt in Ihren C#-Anwendungen und erfüllt so präzise die spezifischen Anforderungen von Entwicklern.
...
{{% blocks/products/pf/agp/content h2="So erstellen Sie JSON in C#" %}}
...
1.  Verwenden Sie die Methode „Speichern“, um die Arbeitsmappe als Datei JSON zu speichern.

{{% blocks/products/pf/agp/code-block title="Der Beispielcode zeigt, wie die Datei JSON in C# erstellt wird." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# Bibliothek zum Erstellen der JSON Datei" %}}
