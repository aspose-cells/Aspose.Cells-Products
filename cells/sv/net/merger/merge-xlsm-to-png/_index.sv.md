---
title: Slå samman XLSM till PNG - Kombinera XLSM till PNG i C#
url: /sv/net/merger/merge-xlsm-to-png/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge XLSM till PNG sparaformat. C# Kombinera XLSM till PNG format. Slå samman XLSM till PNG i C#. XLSM Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman XLSM till PNG i C# Online gratis" %}}

Följande exempel visar hur man slår samman XLSM till PNG i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman XLSM till PNG. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen PNG. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman XLSM till PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman XLSM till PNG i C#" InputFormat="xlsm" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLSM till PNG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLSM till PNG programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XLSM till PNG" %}}
