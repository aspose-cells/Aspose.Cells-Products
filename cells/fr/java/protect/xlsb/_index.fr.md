...
1. Charger le fichier XLSB en instanciant la classe Workbook1. Utiliser la méthode protect(..) avec ProtectionType et Password1. Enregistrez le fichier XLSB protégé par la méthode save()
