...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Melindungi File XLSX melalui Java" %}}
...
1. Muat file XLSX dengan membuat instance kelas Workbook1. Gunakan metode protect(..) dengan ProtectionType dan Password1. Simpan file XLSX yang dilindungi dengan metode save()
