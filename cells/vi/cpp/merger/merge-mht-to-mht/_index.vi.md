...
Ví dụ sau minh họa cách hợp nhất MHT với MHT trong Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/content h2="C++ thư viện để gộp MHT vào MHT" %}}
