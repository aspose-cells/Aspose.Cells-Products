---
title: PHP HTM-XLAM - HTM-XLAM konvertáló
description: Aspose Excel. A HTM-et gyorsan és egyszerűen konvertálja XLAM-re a Aspose.Cells-gyel. PHP HTM-et XLAM-re. PHP HTM mentése XLAM-re. HTM mentése XLAM-re PHP használatával.
...
{{% cells-convert title="Mintakód a HTM konvertálásához XLAM-re" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlam" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Hogyan lehet HTM-et konvertálni XLAM-re PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A HTM-fájlokat programozottan XLAM-re kell konvertálni? A PHP fejlesztői könnyedén betölthetik és konvertálhatják a HTM-et XLAM-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a HTM-et XLAM-re a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a HTM konverziós eredményét XLAM-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a HTM konvertálásához XLAM-re" %}}
