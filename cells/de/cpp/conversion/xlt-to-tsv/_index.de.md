---
title: Konvertieren Sie XLT in TSV über die Anwendung C++ 
url: /de/cpp/conversion/xlt-to-tsv/ 
description: Beispiel-Umwandlungscode C++ für das XLT-Dokument in das TSV-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von XLT in TSV in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLT in TSV über C++" h2="Leistungsstarke XLT-zu-TSV-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können XLT-Dateien in nur wenigen Codezeilen einfach in TSV konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die XLT-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (TSV).1. Die TSV-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die TSV-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="XLT-zu-TSV-C++-Umwandlungsquellcode" offSpacer="" %}}
