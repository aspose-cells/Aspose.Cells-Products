---
title: C# XLTM ET - XLTM ET Converter
description: Aspose Excel. A XLTM-es számot gyorsan és egyszerűen konvertálja ET-re a Aspose.Cells-es számmal. C# XLTM ET-re. C# Takarítson meg XLTM-et az ET-nek. Mentse el a XLTM számot ET néven a C# használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTM számot ET-nek a C# számon" %}}

A következő példa bemutatja, hogyan lehet átalakítani a XLTM-et ET-re a C#-ben.
...
{{% cells-convert title="Mintakód a XLTM ET-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTM konvertálása ET-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia a XLTM fájlokat ET-re? A .NET fejlesztők egyszerűen betölthetik és átalakíthatják a XLTM-et ET-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a XLTM-et ET-re a Workbook.Save metódus hívásával.
1.  Szerezze meg a XLTM konverziós eredményt ET-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTM ET átalakításához" %}}
