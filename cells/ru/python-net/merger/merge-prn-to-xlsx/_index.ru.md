---
title: Объединить PRN с XLSX - Объединить PRN с XLSX в Python
url: /ru/python-net/merger/merge-prn-to-xlsx/ 
description: Aspose Excel. Python Aspose.Cells. Бесплатное онлайн объединение PRN в XLSX в сохраненном формате. Python Объедините PRN в формат XLSX. Объединить PRN с XLSX в Python. Объединить PRN.
...
В следующем примере показано, как объединить PRN с XLSX в Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Бесплатно онлайн объединить PRN с XLSX в Python" InputFormat="prn" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Как объединить PRN с XLSX через Python" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно объединить PRN с XLSX? Базовый документ сливается и объединяется с[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API можно реализовать всего несколькими строками кода.
