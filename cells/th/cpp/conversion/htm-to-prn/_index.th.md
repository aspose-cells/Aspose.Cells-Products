---
title: C++ HTM เป็น PRN - ตัวแปลง HTM เป็น PRN ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลงรูปแบบบันทึก HTM เป็น PRN C++ รูปแบบ HTM เป็น PRN บันทึก HTM ไปที่ PRN C++
...
{{% blocks/products/pf/agp/content h2="บันทึก HTM เป็น PRN ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง HTM เป็น PRN โดยเรียกเมธอด Save()
