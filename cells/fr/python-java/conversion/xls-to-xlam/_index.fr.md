---
title: Convertir XLS en XLAM via Python

description: Exemple de code pour la conversion xls vers xlam Python. Utilisez l'exemple de code API pour la conversion de fichiers xls par lots en xlam dans l'application Python.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en XLAM en utilisant Python" %}}

 Afin de convertir XLS en XLAM, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en XLAM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir des fichiers XLS en XLAM en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier XLS avec une instance de Workbook1. Appelez la méthode Workbook.Save1. Passer le chemin de sortie avec l'extension XLAM comme paramètre1. Vérifier le chemin spécifié pour le fichier XLAM résultant
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en XLAM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlam" IsLandingPage="true" language="python" %}}
