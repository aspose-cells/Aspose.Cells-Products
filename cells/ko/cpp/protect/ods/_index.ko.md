---
title:  C++을 통해 ODS 문서를 보호하고 잠급니다.
weight: 10010
description: C++ C++ 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경에서 비밀번호를 사용하여 ODS 파일을 잠그는 예제 코드입니다.
...
1.  Workbook 클래스를 사용하여 ODS 파일 로드
1.  ProtectionType 및 Password와 함께 Protect(..) 메서드 사용
1.  Save() 메소드로 보호된 ODS 파일을 저장합니다.
