---
title: Python XLS tot TSV - XLS tot TSV Converter
description: Aspose Excel. Deze uitgebreide oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van gegevens van het formaat XLS naar TSV, waardoor naadloos opslaan van gegevens in het formaat XLS mogelijk is met behulp van de bibliotheek Aspose.Cells, allemaal via efficiënte en aanpasbare code Python.
...
{{% cells-convert title="Voorbeeldcode om XLS naar TSV te converteren via de Excel-bibliotheek Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="tsv" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLS naar TSV te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLS-bestanden programmatisch naar TSV converteren? Python-ontwikkelaars kunnen XLS eenvoudig in slechts een paar regels code laden en converteren naar TSV.
...
1.  Converteer XLS naar TSV door de Workbook.save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van XLS naar TSV.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om XLS naar TSV te converteren" %}}
