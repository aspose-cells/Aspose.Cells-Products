---
title: C# XLS เป็น ET - ตัวแปลงออนไลน์ XLS เป็น ET
description: Aspose เก่ง. C# Aspose.Cells C# Aspose Cells ออนไลน์ฟรี C# แปลง XLS เป็น ET บันทึกรูปแบบ C# XLS เป็นรูปแบบ ET บันทึก XLS ไปที่ ET C#
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS เป็น ET ใน C# ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีแปลง XLS เป็น ET ใน C#
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อแปลง XLS เป็น ET อัปโหลดไฟล์ XLS ของคุณ จากนั้นบันทึกเป็นไฟล์ ET สำหรับทั้งการอ่าน XLS และการเขียน ET คุณสามารถใช้ชื่อไฟล์แบบเต็มได้ เนื้อหาและการจัดรูปแบบ ET เอาต์พุตจะเหมือนกับเอกสาร XLS ต้นฉบับ
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง XLS เป็น ET ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการแปลงไฟล์ XLS เป็น ET โดยทางโปรแกรมหรือไม่ นักพัฒนา .NET สามารถโหลดและแปลง XLS เป็น ET ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง XLS เป็น ET โดยเรียกวิธี Workbook.Save
1.  รับผลลัพธ์การแปลง XLS เป็น ET

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ไลบรารี C# เพื่อแปลง XLS เป็น ET" %}}
