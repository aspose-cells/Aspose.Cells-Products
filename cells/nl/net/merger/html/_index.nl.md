...
+ Laad alle HTML-bestanden met volledig pad.
...
+ Roep de Save()-methode aan en geef de bestandsnaam (volledig pad) en formaat (HTML) door als parameter.
+ Nu kunt u het bestand HTML openen en gebruiken in Microsoft Office, Adobe PDF of een ander compatibel programma.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online HTML Live-demo\'s van fusie" sectionDescription=" Voeg nu HTML-documenten samen door naar onze[Live demo-website](https://products.aspose.app/cells/merger). De live demo heeft de volgende voordelen" >}}
