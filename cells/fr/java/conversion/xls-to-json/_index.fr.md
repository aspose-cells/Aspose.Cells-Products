---
title: Java XLS à JSON - Convertisseur en ligne XLS à JSON
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XLS en format de sauvegarde JSON. Format Java XLS à JSON. Enregistrez XLS à JSON Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS à JSON dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLS en JSON en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en JSON. Téléchargez votre fichier XLS, puis enregistrez-le simplement en tant que fichier JSON. Pour la lecture XLS et l'écriture JSON, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie JSON seront identiques au document XLS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en JSON en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en JSON par programmation ? Les développeurs de Java peuvent facilement convertir XLS en JSON en seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir XLS en JSON" %}}
{{% blocks/products/pf/agp/text %}}
