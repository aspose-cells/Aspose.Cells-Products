...
description: Aspose Excel. Converta MHTML em DIF de forma rápida e fácil com Aspose.Cells. C++ MHTML em DIF. C++ Salve MHTML em DIF. Salve MHTML como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta MHTML em DIF usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve MHTML para DIF em C++" %}}

O exemplo a seguir demonstra como converter MHTML em DIF em C++.
...
{{% cells-convert title="Exemplo de código para converter MHTML em DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="dif" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter MHTML em DIF por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos MHTML em DIF programaticamente? Os desenvolvedores do C++ podem converter facilmente MHTML em DIF em apenas algumas linhas de código.
...
1.  Converta MHTML em DIF chamando o método Save().
