---
title: Gabungkan XLSM ke MD - Gabungkan XLSM ke MD di Java
url: /id/java/merger/merge-xlsm-to-md/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLSM ke format simpan MD. Java Gabungkan XLSM ke format MD. Gabung XLSM menjadi MD di Java. XLSM Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSM menjadi MD di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLSM ke MD di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSM ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan XLSM ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLSM ke MD secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
