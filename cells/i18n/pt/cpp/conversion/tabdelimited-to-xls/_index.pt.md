---
title: Converter TABDELIMITED para XLS por meio do aplicativo C++ 
url: /pt/cpp/conversion/tabdelimited-to-xls/ 
description: Exemplo de código de conversão C++ do documento TABDELIMITED para o formato XLS. Os programadores podem usar esse código-fonte para conversão em lote TABDELIMITED para XLS em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter TABDELIMITED para XLS via C++" h2="Conversão TABDELIMITED de alto desempenho para XLS usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem converter facilmente o arquivo TABDELIMITED para XLS em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo TABDELIMITED usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (XLS).1. O arquivo XLS será salvo no caminho especificado.1. Abra o arquivo XLS em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED para XLS C++ Código-fonte de conversão" offSpacer="" %}}
