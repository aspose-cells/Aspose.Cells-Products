...
description: Aspose Excel. Convert XLTX to OTS quickly and easily with Aspose.Cells. Python XLTX to OTS. Python Save XLTX to OTS. Save XLTX as OTS using Python.
