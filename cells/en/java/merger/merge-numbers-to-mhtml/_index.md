...
{{% blocks/products/pf/agp/content h2="How to Merge NUMBERS to MHTML File Using Java" %}}

 In order to merge NUMBERS to MHTML file, we will use [Aspose.Cells for Java](https://products.aspose.com/cells/java) API which is a feature-rich, powerful and easy to use document manipulation and merging API for Java platform. 
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Merging NUMBERS to MHTML File in Java" %}}
...
{{% cells-merger title="Free App to merge Excel files on line" InputFormat="numbers" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
