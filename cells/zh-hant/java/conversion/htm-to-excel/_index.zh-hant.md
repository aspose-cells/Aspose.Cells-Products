...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 HTM 轉換為 EXCEL。Java HTM 到 EXCEL。 Java 將 HTM 儲存到 EXCEL。使用 Java 將 HTM 儲存為 EXCEL。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Java 中的 HTM 轉換為 EXCEL" h2="用於將 HTM 轉換為 EXCEL 的高速 Java 庫。這是一個使用Java導入和匯出HTM、EXCEL和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將HTM儲存到EXCEL中Java" %}}

下面的範例示範如何將Java中的HTM轉換為EXCEL。
...
{{% cells-convert title="將 HTM 轉換為 EXCEL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 HTM 轉換為 EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 HTM 檔案轉換為 EXCEL？ Java 開發人員只需幾行程式碼即可輕鬆將HTM轉換為EXCEL。
...
{{% blocks/products/pf/agp/content h2="Java 將 HTM 轉換為 EXCEL 的庫" %}}
{{% blocks/products/pf/agp/text %}}
