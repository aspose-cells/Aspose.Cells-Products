---
title:  Fusionner MHT avec HTML via Python
url: /fr/python-java/merger/merge-mht-to-html/ 
description: Fusionnez MHT avec HTML en ligne gratuitement. MHT en ligne gratuit à HTML Fusion. Fusionnez MHT avec Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner MHT avec HTML dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner MHT avec HTML en ligne" InputFormat="mht" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
