---
title:  Szöveg keresése és cseréje a XLSM via Java dokumentumban
weight: 1590
description: Java mintakód a XLSM fájlban található érzékeny információk törléséhez a Java futásidejű környezet JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
...
{{% blocks/products/pf/agp/content h2="A XLSM fájl szerkesztése a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A XLSM-es fájlok szerkesztésének lépései a Java-ben" %}}
...
{{% blocks/products/pf/agp/code-block title="Szerkesztés XLSM Fájlok - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSM Szerkesztés élő bemutatók" sectionDescription=" Keressen és cseréljen szöveget a XLSM dokumentumok tartalmában, megjegyzéseiben vagy metaadataiban, látogassa meg[Élő bemutatók weboldala](https://products.aspose.app/cells/redaction). Az élő demónak a következő előnyei vannak" >}}
