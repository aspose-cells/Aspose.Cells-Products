...
description: Aspose Excel. Konwertuj XLAM na FODS szybko i łatwo za pomocą Aspose.Cells. C++ XLAM na FODS. C++ Zapisz XLAM na FODS. Zapisz XLAM jako 0761113 481 pod numerem C++.
...
Chcesz programowo przekonwertować pliki XLAM na FODS? Programiści C++ mogą łatwo przekonwertować XLAM na FODS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLAM na FODS, wywołując metodę Save().
