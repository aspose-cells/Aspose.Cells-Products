...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in WORD in Java" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar WORD in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLTM om naar WORD of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLTM programmatisch converteren naar WORD? Ontwikkelaars van Java kunnen bestanden met de extensie XLTM eenvoudig converteren naar WORD met slechts een paar regels code.
