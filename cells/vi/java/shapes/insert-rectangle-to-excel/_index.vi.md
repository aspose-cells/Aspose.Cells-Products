---
title:  Chèn hình chữ nhật vào Excel via Java
weight: 50
...
{{< blocks/products/pf/i18n/upper-banner h1="Chèn hình chữ nhật vào Excel via Java" h2="Chèn các đối tượng bằng API phía máy chủ mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn Hình Chữ Nhật Vào File Excel Sử Dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn Rectangle vào file Excel via Java" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng các[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addRectangle-int-int-int-int-int-int-) để chèn Hình chữ nhật vào trang tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn Hình Chữ Nhật - Java" offSpacer="" %}}
