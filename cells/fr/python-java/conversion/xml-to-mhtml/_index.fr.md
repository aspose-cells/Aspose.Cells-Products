...
description: Aspose Exceller. Convertissez XML en MHTML rapidement et facilement avec Aspose.Cells. Python XML en MHTML. Python Enregistrez XML en MHTML. Enregistrez XML sous MHTML en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en MHTML à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au MHTML dans Python" %}}

L'exemple suivant montre comment convertir XML en MHTML en Python.
...
{{% cells-convert title="Exemple de code pour convertir XML en MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="mhtml" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour convertir XML en MHTML" %}}
