...
url: /hu/net/merger/merge-mhtml-to-prn/ 
...
következő példa bemutatja, hogyan egyesítheti a MHTML-et a PRN-vel a Aspose.Cells-es for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a MHTML-et a PRN-nel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML és a PRN egyesítéséhez" %}}
