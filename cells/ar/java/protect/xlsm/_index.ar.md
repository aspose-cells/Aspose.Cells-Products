---
title: حماية وقفل مستند XLSM عبر Java 
weight: 9620
url: /ar/java/protect/xlsm/ 
description: Java نموذج رمز لقفل ملف XLSM باستخدام كلمة مرور في Java Runtime Environment for JSP / JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تشفير ملفات XLSM عبر Java" h2="حماية جداول بيانات Excel بكلمة مرور بما في ذلك تنسيق XLSM باستخدام .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات حماية ملفات XLSM عبر Java" %}}
...
1. قم بتحميل ملف XLSM عن طريق إنشاء فئة المصنف1. استخدم طريقة الحماية (..) مع نوع الحماية وكلمة المرور1. احفظ ملف XLSM المحمي بطريقة الحفظ ()
