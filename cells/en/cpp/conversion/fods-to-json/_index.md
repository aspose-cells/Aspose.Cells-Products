...
description: Sample C++ conversion code for FODS document to JSON format. Programmers can use this source code for batch FODS to JSON conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="FODS to JSON C++ Conversion Source Code" offSpacer="" %}}
