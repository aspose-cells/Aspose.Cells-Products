---
title: Python 數字到 OTS - 數位到 OTS 轉換器
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 NUMBERS 轉換為 OTS 格式，從而能夠使用 Aspose.Cells 庫將 NUMBERS 資料無縫保存為 OTS 格式，所有這些都透過高效且可自訂的 Python 程式碼實現。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Python Excel 庫中的 NUMBERS 轉換為 OTS" h2="用於將 NUMBERS 轉換為 OTS 的高速 Python Excel 函式庫。這是一個使用 Python 匯入和匯出 NUMBERS、OTS 和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將 NUMBERS 轉換為 OTS" %}}

如何將 NUMBERS 轉換為 OTS？借助 Aspose.Cells for Python 庫，您可以透過幾行程式碼以程式設計方式輕鬆將 NUMBERS 轉換為 OTS。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將數字儲存到 Python Excel 庫中的 OTS" %}}

以下範例示範如何將 Python excel 庫中的 NUMBERS 轉換為 OTS。
...
{{% cells-convert title="透過 Python Excel 函式庫將 NUMBERS 轉換為 OTS 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="ots" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python 將 NUMBERS 轉換為 OTS" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 NUMBERS 檔案轉換為 OTS？ Python 開發人員只需幾行程式碼即可輕鬆載入 NUMBERS 並將其轉換為 OTS。
...
1. 透過呼叫 Workbook.save 方法將 NUMBERS 轉換為 OTS。
1. 取得 NUMBERS 到 OTS 的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python 將數字轉換為 OTS 的 Excel 庫" %}}
