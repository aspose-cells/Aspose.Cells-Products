---
title:  Sloučit HTM na XLS přes C++
url: /cs/cpp/merger/merge-htm-to-xls/ 
description: Sloučit HTM na XLS Online zdarma. Bezplatné online spojení HTM na XLS. Sloučit HTM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit HTM s XLS v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení HTM na XLS online" InputFormat="htm" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
