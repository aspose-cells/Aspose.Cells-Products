---
title: Python XLT إلى MHT - XLT إلى MHT محول
description: Aspose اكسل. قم بتحويل XLT إلى MHT بسرعة وسهولة باستخدام Aspose.Cells. Python XLT إلى MHT. Python احفظ XLT إلى MHT. احفظ XLT كـ MHT باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="تحويل XLT إلى MHT باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ XLT إلى MHT في Python" %}}

يوضح المثال التالي كيفية تحويل XLT إلى MHT في Python.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل XLT إلى MHT. قم بتحميل ملف XLT الخاص بك، ثم احفظه كملف MHT. لكل من قراءة XLT وكتابة MHT، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق MHT الناتج مطابقًا للمستند الأصلي XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLT إلى MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLT إلى MHT عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLT إلى MHT برمجياً؟ يمكن لمطوري Python تحميل وتحويل XLT بسهولة إلى MHT في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLT إلى MHT عن طريق استدعاء طريقة Workbook.save.
1.  احصل على نتيجة التحويل من XLT إلى MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل XLT إلى MHT" %}}
