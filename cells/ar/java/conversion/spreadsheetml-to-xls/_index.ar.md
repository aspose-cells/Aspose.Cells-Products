---
title: تحويل SPREADSHEETML إلى XLS عبر Java 

description: نموذج رمز تحويل Java لتنسيق SPREADSHEETML إلى ملف XLS. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى XLS داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل SPREADSHEETML إلى XLS عبر Java" h2="تحويل SPREADSHEETML إلى XLS Java لتحويل صفحات مفردة أو متعددة إلى XLS باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل SPREADSHEETML إلى XLS باستخدام Java" %}}

 من أجل تقديم SPREADSHEETML إلى XLS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل SPREADSHEETML إلى XLS عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف SPREADSHEETML إلى XLS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف SPREADSHEETML بنسخة من فئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XLS & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XLS الناتج
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML إلى شفرة مصدر تحويل XLS Java" offSpacer="" %}}

```cs
// تحميل ملف SPREADSHEETML في مثيل مصنف
Workbook book = new Workbook("template.spreadsheetml");
// احفظ SPREADSHEETML كـ XLS
