---
title: Vytvořte soubory MS Excel XLTM via Java
description: XLTM tvůrce. Vytvořte soubory XLTM v kódu Java. Generujte soubory MS Excel XLTM pomocí desktopové nebo webové aplikace založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořit XLTM Soubor via Java" h2="Nativní a vysoce výkonné vytváření tabulek MS Excel XLTM programově pomocí knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit XLTM via Java" %}}
...
1.  Uložte sešit ve formátu XLTM pomocí metody save().

{{% blocks/products/pf/agp/code-block title="Následující zdrojový kód ukazuje, jak vytvořit soubor MS Excel XLTM pomocí Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro vytvoření souboru XLTM" %}}
{{% blocks/products/pf/agp/text %}}
