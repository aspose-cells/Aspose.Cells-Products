...
description: Aspose Excel. Szybko i łatwo przekonwertuj HTM na PRN za pomocą Aspose.Cells. Python HTM na PRN. Python Zapisz HTM w PRN. Zapisz HTM jako PRN, używając numeru Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM w PRN pod numerem Python" %}}

Poniższy przykład ilustruje konwersję HTM na PRN w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji HTM na PRN" %}}
