...
description: Aspose 엑셀. Aspose.Cells을 사용하여 빠르고 쉽게 IMAGE를 DIF로 변환합니다. Java IMAGE를 DIF로 변환합니다. Java IMAGE를 DIF로 저장합니다. Java을 사용하여 IMAGE를 DIF로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 IMAGE를 DIF로 변환" %}}
...
{{% blocks/products/pf/agp/content h2="Java의 DIF에 이미지를 저장하세요." %}}

다음 예에서는 IMAGE를 Java에서 DIF로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="IMAGE를 DIF로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="dif" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="이미지를 DIF via Java로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 IMAGE 파일을 DIF로 변환해야 합니까? Java 개발자는 단 몇 줄의 코드만으로 IMAGE를 DIF로 쉽게 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2="Java 이미지를 DIF로 변환하는 라이브러리" %}}
{{% blocks/products/pf/agp/text %}}
