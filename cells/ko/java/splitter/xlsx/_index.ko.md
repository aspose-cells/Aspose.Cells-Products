...
weight: 3250
description: JSP/JSF 응용 프로그램 및 데스크톱 응용 프로그램용 Java 런타임 환경에서 XLSX 문서를 분할하는 Java 샘플 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="분할 XLSX 파일 via Java" h2="XLSX 서버 측 Java 라이브러리의 도움으로 분할." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
