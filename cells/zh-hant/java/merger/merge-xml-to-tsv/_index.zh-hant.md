...
description: Aspose Excel。 Java Aspose.Cells。將 XML 合併為 TSV 儲存格式。 Java 將 XML 合併為 TSV 格式。將 XML 合併到 Java 中的 TSV。XML 合併。
...
{{% blocks/products/pf/agp/content h2="將XML合併到Java中的TSV" %}}

以下範例示範如何將 XML 合併到 Aspose.Cells for Java 中的 TSV。
{{% blocks/products/pf/agp/text %}}

依照簡單的步驟將 XML 合併到 TSV。上傳文件，呼叫 Workbook.Combine 方法合併文件，然後將其儲存到 TSV 文件。如果您在 Java 中開發程式碼，這會比聽起來更簡單。請參閱 Java 將 XML 合併到 TSV 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 XML 合併到 Java 中的 TSV 的範例程式碼" InputFormat="xml" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 XML 合併為 TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 XML 合併到 TSV 嗎？基本文檔合併和連接[Aspose.Cells for Java](https://products.aspose.com/cells/java)只需幾行程式碼即可完成 API。
