---
title: Convertir HTML en XLT Python via Python
description: Convertissez HTML en XLT en ligne gratuitement. Convertisseur en ligne gratuit HTML à XLT. Python HTML à XLT. HTML à XLT via Python.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir HTML en XLT en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlt" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTML en XLT via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir HTML en XLT en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier HTML avec une instance de Workbook
1.  Convertir HTML en XLT en appelant la méthode Workbook.save
