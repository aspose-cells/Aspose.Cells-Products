...
description: Aspose Excel. Java Aspose.Cells. A NUMBERS egyesítése a TABDELIMITED mentési formátumba. Java SZÁMOK kombinálása TABDELIMITED formátumba. A NUMBERS egyesítése a TABDELIMITED-hez a Java-ben. NUMBERS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A NUMBERS egyesítése a TABDELIMITED-hez a Java használatával" %}}
 ...
 Hogyan egyesíthetem a NUMBERS számot a TABDELIMITED-szel? A Aspose.Cells for Java könyvtárral egyszerűen egyesítheti a NUMBERS-t a TABDELIMITED-be programozottan néhány sor kóddal.[Aspose.Cells for Java](https://products.aspose.com/cells/java)képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Java Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez. A legújabb verziót közvetlenül a webhelyről töltheti le[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) és telepítse a Maven alapú projekten belül a következő konfigurációk hozzáadásával a pom.xml fájlhoz.
...
{{% blocks/products/pf/agp/content h2="A(z) NUMBERS egyesítése a(z) TABDELIMITED számmal a Java számon" %}}

következő példa bemutatja, hogyan lehet egyesíteni a NUMBERS-t a TABDELIMITED-szel a Aspose.Cells for Java számon.
...
{{% cells-merger title="Mintakód a NUMBERS és a TABDELIMITED egyesítéséhez a Java-ben" InputFormat="numbers" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
