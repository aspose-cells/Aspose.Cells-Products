---
title: แทรก/สร้าง FlowChart ลงใน Excel โดยใช้ Python via Java
weight: 371
description: Python via Java ซอร์สโค้ดเพื่อแทรก/สร้าง FlowChart ลงใน Excel
---
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรก/สร้าง FlowChart ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก/สร้างผังงาน - Python via Java" offSpacer="" %}}
