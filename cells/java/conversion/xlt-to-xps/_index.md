...
description: Sample Java conversion code for XLT format to XPS file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to XPS within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLT to XPS via Java" h2="XLT to XPS Java conversion to convert single or multiple pages to XPS using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert XLT to XPS Using Java" %}}

 In order to render XLT to XPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLT to XPS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XLT to XPS Java Conversion Source Code" offSpacer="" %}}
