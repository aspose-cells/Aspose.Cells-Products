...
url: /nl/net/comments/insert-comments-to-xls/ 
description: Voeg commentaar toe aan XLS met behulp van C#. Gebruik de voorbeeldcode API om commentaar in te voegen binnen de .NET-toepassing.
...
{{% blocks/products/pf/agp/content h2="Opmerkingen invoegen in bestand XLS via C#" %}}
...
In Office 365 zijn opmerkingen bedoeld voor gesprekken. U kunt de volgende C#-code gebruiken om opmerkingen in het bestand XLS in te voegen en te verwijderen.

{{% blocks/products/pf/agp/code-block title="C# voorbeeldcode om opmerkingen in het bestand XLS in te voegen en te verwijderen" offSpacer="" %}}
