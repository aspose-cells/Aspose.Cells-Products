---
title: C# XLS do DOCX - XLS do DOCX Konwerter
description: Aspose Excel. Konwertuj XLS na DOCX szybko i łatwo za pomocą Aspose.Cells. C# XLS na DOCX. C# Zapisz XLS na DOCX. Zapisz XLS jako 0761113 481 pod numerem C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do DOCX w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na DOCX w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLS na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na DOCX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na DOCX? Programiści .NET mogą łatwo załadować i przekonwertować XLS na DOCX w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na DOCX" %}}
