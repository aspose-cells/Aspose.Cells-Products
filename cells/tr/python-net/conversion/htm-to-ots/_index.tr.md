---
title: Python HTM'den OTS'ye - HTM'den OTS'ye dönüştürücü
description: Aspose Excel'de. Python Excel'de. Aspose.Cells. Python ile HTM'yi OTS'ye hızlı ve kolay bir şekilde dönüştürün. Python HTM'yi OTS'ye kaydedin. Python Excel Kitaplığını kullanarak HTM'yi OTS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python Excel Kitaplığı\'nda HTM\'yi OTS\'ye dönüştürün" %}}

HTM'yi OTS'ye nasıl dönüştürebilirim? Aspose.Cells for Python kütüphanesi aracılığıyla NET kütüphanesi ile birkaç satır kodla HTM'yi programlı olarak OTS'ye kolayca dönüştürebilirsiniz.[Aspose.Cells for Python NET aracılığıyla](https://pypi.org/project/aspose-cells-python/)tüm Excel dosyalarını oluşturma, değiştirme, dönüştürme, işleme ve yazdırma becerisine sahip çapraz platform uygulamaları oluşturma yeteneğine sahiptir. Python Excel API yalnızca elektronik tablo formatları arasında dönüştürme yapmakla kalmaz, aynı zamanda Excel dosyalarını, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT ve daha fazlasını görüntü olarak işleyebilir, böylece endüstri standardı formatlarda belge alışverişi yapmak için mükemmel bir seçim haline gelir.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="HTM\'yi Python Excel Kitaplığı\'nda OTS\'ye kaydedin" %}}

Aşağıdaki örnek, Python excel kitaplığında HTM'nin OTS'ye nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

HTM'yi OTS'ye dönüştürmek için kolay adımları izleyin. HTM dosyanızı yükleyin ve ardından OTS dosyası olarak kaydedin. Hem HTM okuma hem de OTS yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı OTS içeriği ve formatı orijinal HTM belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Python Excel Kitaplığı aracılığıyla HTM\'yi OTS\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="ots" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="HTM\'yi OTS\'ye Dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

HTM dosyalarını programlı olarak OTS'ye dönüştürmeniz mi gerekiyor? Python geliştiriciler yalnızca birkaç satır kodla HTM'yi kolayca yükleyebilir ve OTS'ye dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak HTM'yi OTS'ye dönüştürün.
1.  HTM'nin OTS'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python HTM\'yi OTS\'ye Dönüştürmek için Excel Kitaplığı" %}}
