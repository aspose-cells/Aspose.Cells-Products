...
description: Aspose اكسل. قم بتحويل XLTM إلى OTS بسرعة وسهولة باستخدام Aspose.Cells. Java XLTM إلى OTS. Java احفظ XLTM إلى OTS. احفظ XLTM كـ OTS باستخدام Java.
...
{{% blocks/products/pf/agp/content h2="تحويل XLTM إلى OTS باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ XLTM إلى OTS في Java" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLTM إلى OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="ots" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى OTS برمجياً؟ يمكن لمطوري Java تحويل XLTM بسهولة إلى OTS في بضعة أسطر من التعليمات البرمجية.
