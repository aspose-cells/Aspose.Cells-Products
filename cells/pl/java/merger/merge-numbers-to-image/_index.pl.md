---
title: Połącz NUMERY z OBRAZEM - Połącz NUMERY z OBRAZEM w Java
url: /pl/java/merger/merge-numbers-to-image/ 
description: Aspose Excel. Java Aspose.Cells. Połącz NUMERY, aby zapisać format OBRAZU. Java Połącz LICZBY do formatu OBRAZ. Połącz NUMERY z OBRAZEM w Java. NUMERY Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z OBRAZEM w Java" %}}

Poniższy przykład pokazuje, jak połączyć NUMERY z OBRAZEM w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć LICZBY z OBRAZEM. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku IMAGE. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMERY z OBRAZEM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia NUMERÓW z OBRAZEM w Java" InputFormat="numbers" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć NUMERY z OBRAZEM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć NUMERY z OBRAZEM? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do łączenia NUMERÓW z OBRAZEM" %}}
