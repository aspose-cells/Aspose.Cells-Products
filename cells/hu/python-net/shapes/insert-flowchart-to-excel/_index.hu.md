...
{{% blocks/products/pf/agp/content h2="Folyamatábra beszúrása Excel fájlba a Python via .NET használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A folyamatábra Excel-fájlba való beszúrásának lépései a Python számon keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Folyamatábra beszúrása - Python via .NET" offSpacer="" %}}
