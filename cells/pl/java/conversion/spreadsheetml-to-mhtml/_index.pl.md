---
title: Konwertuj SPREADSHEETML na MHTML przez Java 
url: /pl/java/conversion/spreadsheetml-to-mhtml/ 
description: Przykładowy kod konwersji Java dla formatu SPREADSHEETML do pliku MHTML. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do MHTML w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj SPREADSHEETML na MHTML przez Java" h2="Konwersja SPREADSHEETML do MHTML Java w celu konwersji jednej lub wielu stron do formatu MHTML przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SPREADSHEETML na MHTML za pomocą Java" %}}

 Aby renderować SPREADSHEETML do MHTML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować SPREADSHEETML na MHTML za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik SPREADSHEETML na MHTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SPREADSHEETML z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem MHTML i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę wynikowego pliku MHTML
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML do MHTML Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik SPREADSHEETML w instancji Workbook
Workbook book = new Workbook("template.spreadsheetml");
// zapisz SPREADSHEETML jako MHTML
