---
title: "SXC konvertálása XLSX-re a következőn keresztül: Python"
url: /hu/python-java/conversion/sxc-to-xlsx/
description: Mintakód az sxc–xlsx Python konverzióhoz. Használjon API példakódot az sxc fájlok kötegelt xlsx konvertálásához a Python alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása XLSX-re a következőn keresztül: Python" h2="Exportálja az Excel® táblázatokat XLSX formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása XLSX-re a következővel: Python" %}}

 Az SXC XLSX-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása XLSX-re a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen betölthetnek és konvertálhatnak SXC fájlokat XLSX-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal megadása XLSX kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott XLSX fájl megadott elérési útját
