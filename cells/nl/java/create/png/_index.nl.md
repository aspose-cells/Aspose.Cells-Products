...
description: Aspose Excel. Java Maak PNG snel en eenvoudig een bestand met Aspose.Cells. Genereer een PNG-bestand met Java. Maak PNG aan in Java. Java PNG Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak PNG-bestand aan in Java" h2="Snelle Java-bibliotheek voor het maken van PNG-bestand. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. Sla de werkmap op in de indeling PNG met behulp van de methode save().
