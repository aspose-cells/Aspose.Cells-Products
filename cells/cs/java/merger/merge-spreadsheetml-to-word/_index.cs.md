---
title:  Sloučit SPREADSHEETML do WORD via Java
...
Následující příklad ukazuje, jak sloučit SPREADSHEETML do WORD v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení SPREADSHEETML do WORD online" InputFormat="xml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
