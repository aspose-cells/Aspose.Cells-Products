---
title: Java HTM en SPREADSHEETML - Convertisseur HTM en SPREADSHEETML en ligne
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir HTM en format de sauvegarde SPREADSHEETML. Java HTM au format SPREADSHEETML. Enregistrez HTM dans SPREADSHEETML Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en SPREADSHEETML en Java" h2="Bibliothèque Java haute vitesse pour convertir HTM en SPREADSHEETML. Il s\'agit d\'une solution logicielle professionnelle pour importer et exporter HTM, SPREADSHEETML et de nombreux autres formats en utilisant Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrez HTM dans SPREADSHEETML au Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir HTM en SPREADSHEETML en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir HTM en SPREADSHEETML. Téléchargez votre fichier HTM, puis enregistrez-le simplement en tant que fichier SPREADSHEETML. Pour la lecture HTM et l'écriture SPREADSHEETML, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie SPREADSHEETML seront identiques à ceux du document HTM d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir HTM en SPREADSHEETML en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xml" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en SPREADSHEETML par programmation ? Les développeurs Java peuvent facilement convertir HTM en SPREADSHEETML en quelques lignes de code seulement.
...
1.  Convertissez HTM en SPREADSHEETML en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de HTM en SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java bibliothèque pour convertir HTM en SPREADSHEETML" %}}
{{% blocks/products/pf/agp/text %}}
