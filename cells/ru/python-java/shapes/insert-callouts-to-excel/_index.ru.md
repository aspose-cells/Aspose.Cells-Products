...
{{% blocks/products/pf/agp/content h2="Как вставить выноски в файл Excel, используя Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке выноски в файл Excel Python via Java" %}}
