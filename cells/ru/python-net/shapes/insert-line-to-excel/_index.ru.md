...
{{% blocks/products/pf/agp/content h2="Как вставить строку в файл Excel с помощью Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для вставки файла Line в Excel через Python" %}}
...
+ Используйте метод add коллекции форм, чтобы вставить строку в выбранный рабочий лист.
...
-  Любая операционная система, которая может запускать сценарии Python, например Windows и Linux.
...
{{% blocks/products/pf/agp/code-block title="Вставить линию - Python" offSpacer="" %}}
