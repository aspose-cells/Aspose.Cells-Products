...
description: Aspose Excel. Convierta OTS a TXT rápida y fácilmente con Aspose.Cells. Python OTS a TXT. Python Guarde OTS en TXT. Guarde OTS como TXT usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OTS a TXT en Python" h2="Biblioteca Python de alta velocidad para convertir OTS a TXT. Utilice nuestra conversión de Excel API para desarrollar software independiente de plataforma de alto nivel en Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir OTS a TXT en Python" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar OTS al TXT en Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a TXT en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir OTS a TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="txt" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir OTS a TXT" %}}
