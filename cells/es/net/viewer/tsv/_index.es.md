---
title:  Ver TSV Formatos de archivo via .NET
weight: 3090
description: C# código fuente para cargar, renderizar y mostrar documentos TSV en plataformas .NET Framework, .NET Core, Mono o Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Ver TSV vía C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells facilita a los desarrolladores ver el archivo TSV con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Cargue el archivo TSV en una instancia de Workbook
1.  Cree una instancia de HtmlSaveOptions y establezca la propiedad ExportHeadings en verdadero
1. Guarde el archivo TSV en formato HTML usando el método Workbook.Save
