---
title: C# XLS till POWERPOINT - XLS till POWERPOINT-konverterare
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till POWERPOINT-format, vilket möjliggör sömlös sparning av XLS-data till POWERPOINT-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till POWERPOINT i C#" %}}

Följande exempel visar hur man konverterar XLS till POWERPOINT i C#.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att konvertera XLS till POWERPOINT. Ladda upp din XLS-fil och spara den sedan som en POWERPOINT-fil. Du kan använda fullständiga filnamn för både XLS-läsning och skrivning till POWERPOINT. Innehållet och formateringen i POWERPOINT-dokumentet kommer att vara identiska med det ursprungliga XLS-dokumentet.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exempelkod för att konvertera XLS till POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till PowerPoint via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till POWERPOINT programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till POWERPOINT med bara några få rader kod.
...
1.  Konvertera XLS till POWERPOINT genom att anropa Workbook.Save-metoden.
1.  Hämta konverteringsresultatet av XLS till POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-bibliotek för att konvertera XLS till POWERPOINT" %}}
