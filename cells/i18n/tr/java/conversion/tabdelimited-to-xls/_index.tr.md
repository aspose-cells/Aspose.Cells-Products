...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TABDELIMITED\'i XLS\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden TABDELIMITED\'i XLS\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, TABDELIMITED dosyasını yalnızca birkaç satır kodla kolayca XLS'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. XLS uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan XLS dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED - XLS Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TABDELIMITED dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.tabdelimited");
// TABDELIMITED'i XLS olarak kaydet
