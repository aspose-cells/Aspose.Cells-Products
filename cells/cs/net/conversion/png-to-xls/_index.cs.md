...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu formátu PNG do formátu XLS, což umožňuje bezproblémové ukládání dat PNG do formátu XLS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PNG na XLS v C#" h2="Vysokorychlostní knihovna C# pro převod PNG na XLS. Toto je profesionální softwarové řešení pro import a export PNG, XLS a mnoha dalších formátů na platformách .NET Framework, .NET Core nebo Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte PNG na XLS v C#" %}}

Následující příklad ukazuje, jak převést číslo PNG na XLS v kódu C#.
...
1.  Převeďte číslo PNG na XLS voláním metody Workbook.Save.
