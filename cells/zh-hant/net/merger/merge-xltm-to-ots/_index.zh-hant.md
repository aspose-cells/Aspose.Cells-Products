...
url: /zh-hant/net/merger/merge-xltm-to-ots/ 
...
以下範例示範如何將 XLTM 合併到 Aspose.Cells for .NET 中的 OTS。
...
需要以程式方式將 XLTM 合併到 OTS 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將XLTM合併至OTS" %}}
