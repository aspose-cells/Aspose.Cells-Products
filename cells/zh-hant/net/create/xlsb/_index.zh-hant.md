---
title: 創建XLSB - 在C#中創建XLSB文件
description: Aspose Excel。 C# 創建 XLSB 文件。創建XLSB C#。C# XLSB創建者。在C#中創建XLSB。使用C#生成XLSB文件。
...
{{% blocks/products/pf/agp/content h2="如何在C#中創建XLSB" %}}
...
{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 C# 中創建 XLSB 文件。" offSpacer="" %}}
