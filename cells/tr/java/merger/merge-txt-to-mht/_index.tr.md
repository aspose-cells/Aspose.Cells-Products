---
title: TXT'i MHT ile birleştir - TXT'i Java'de MHT ile birleştir
url: /tr/java/merger/merge-txt-to-mht/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i MHT kaydetme biçimiyle birleştirin. Java TXT'i MHT biçimiyle birleştirin. TXT'i Java'deki MHT ile birleştirin. TXT Birleştir.
keywords: [Aspose Excel., Java Aspose.Cells., Merge TXT to MHT in Java., Java Merge TXT to mht., Java Combine TXT to MHT., TXT Merge]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TXT\'i MHT via Java ile birleştir" h2="TXT\'i MHT ile birleştirmek için yüksek hızlı Java kitaplığı. Java\'de üst düzey, platformdan bağımsız yazılım geliştirmek için API excel dönüşümümüzü kullanın. Bu, Excel, CSV, OpenOffice, PDF, HTML, image\'i ve diğer birçok excel formatını içe ve dışa aktarmak için profesyonel bir yazılım çözümüdür." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="TXT" additionalConversionTag="MHT" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'deki MHT ile birleştir" %}}

Aşağıdaki örnek, TXT'in Aspose.Cells for Java'deki MHT ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT'i MHT ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından MHT dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT'i MHT ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT\'i Java\'de MHT ile Birleştirmek için Örnek Kod" InputFormat="txt" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT\'i MHT via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

TXT'i MHT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesi, TXT\'i MHT ile birleştirecek" %}}
