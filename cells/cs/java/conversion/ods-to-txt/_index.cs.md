---
title: Převést ODS na TXT přes Java 
weight: 4320
url: /cs/java/conversion/ods-to-txt/ 
description: Ukázkový konverzní kód Java pro formát ODS na soubor TXT. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do TXT v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODS na TXT přes Java" h2="Převod ODS na TXT Java pro převod jedné nebo více stránek na TXT pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na TXT pomocí Java" %}}

 K vykreslení ODS do TXT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na TXT prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na TXT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením TXT a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor TXT
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu ODS na TXT Java" offSpacer="" %}}
