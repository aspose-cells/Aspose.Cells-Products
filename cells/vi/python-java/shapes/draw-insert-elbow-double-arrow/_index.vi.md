---
title: Cách vẽ hoặc chèn hình mũi tên đôi khuỷu tay vào Excel bằng Python via Java
weight: 10
description: Vẽ hoặc chèn hình mũi tên đôi khuỷu tay bằng Aspose.Cells' Python via Java API mà không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chèn hình mũi tên đôi khuỷu tay vào Excel bằng Python via Java" h2="Chèn mũi tên kép khuỷu tay sử dụng Aspose.Cells\' API không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chèn hình mũi tên đôi khuỷu tay vào file excel bằng Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn hình mũi tên đôi khuỷu tay vào file Excel sử dụng Python via Java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) để chèn hình mũi tên đôi khuỷu tay vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn khuỷu tay hình mũi tên đôi - Python via Java" offSpacer="" %}}
