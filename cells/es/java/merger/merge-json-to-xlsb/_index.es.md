---
title: Combinar JSON a XLSB - Combinar JSON a XLSB en Java
url: /es/java/merger/merge-json-to-xlsb/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea JSON a XLSB guardar formato. Java Combina el formato JSON con el XLSB. Combinar JSON a XLSB en Java. JSON Combinar.
...
El siguiente ejemplo muestra cómo combinar JSON con XLSB en Aspose.Cells for Java.
...
{{% cells-merger title="Gratis en línea para fusionar JSON a XLSB en Java" InputFormat="json" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar JSON a XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar JSON con XLSB mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
