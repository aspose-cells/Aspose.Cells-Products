...
description: Aspose Excel. Convierta XLSM a OTS rápida y fácilmente con Aspose.Cells. Python XLSM a OTS. Python Guardar XLSM en OTS. Guarde XLSM como OTS usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSM en OTS en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSM a OTS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSM a OTS" %}}
