...
description: Aspose Excel. Converti XLS in MD in modo rapido e semplice con Aspose.Cells. PHP XLS in MD. PHP Salva XLS su MD. Salva XLS come MD utilizzando PHP.
...
{{% blocks/products/pf/agp/content h2="Converti XLS in MD utilizzando PHP" %}}

 Come posso convertire XLS in MD? Con la libreria Aspose.Cells for PHP via Java, puoi convertire facilmente XLS in MD a livello di codice con poche righe di codice.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) è in grado di creare applicazioni multipiattaforma con la capacità di generare, modificare, convertire, eseguire il rendering e stampare tutti i file Excel. PHP Excel API non solo converte tra formati di foglio di calcolo, ma può anche eseguire il rendering di file Excel come immagini, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT e altro, rendendolo quindi una scelta perfetta per lo scambio di documenti in formati standard del settore.
...
Segui i semplici passaggi per convertire XLS in MD. Carica il tuo file XLS, quindi salvalo semplicemente come file MD. Sia per la lettura XLS che per la scrittura MD è possibile utilizzare nomi di file completi. Il contenuto e la formattazione del MD di output saranno identici al documento originale XLS.
...
È necessario convertire i file XLS in MD a livello di codice? Gli sviluppatori PHP possono caricare e convertire facilmente XLS in MD in poche righe di codice.
...
1.  Converti XLS in MD chiamando il metodo di salvataggio della cartella di lavoro.
