---
title: Converteer TABDELIMITED naar XLTM via C#
url: /nl/net/conversion/tabdelimited-to-xltm/
description: Voorbeeldcode voor door tabs gescheiden naar xltm C# conversie. Gebruik API voorbeeldcode voor batch-tabdelimited-bestanden naar xltm-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET ontwikkelaars kunnen TABDELIMITED-bestanden gemakkelijk laden en converteren naar XLTM in slechts een paar regels code.
