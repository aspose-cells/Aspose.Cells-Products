---
title:  Fusionner PRN avec HTM via Java
url: /fr/java/merger/merge-prn-to-htm/ 
description: Fusionnez PRN avec HTM en ligne gratuitement. Fusion en ligne gratuite PRN vers HTM. Fusionnez PRN vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner PRN avec HTM dans Java.
...
{{% cells-merger title="Application gratuite pour fusionner PRN à HTM en ligne" InputFormat="prn" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
