...
description: Aspose Эксель. Python Aspose.Cells. Объедините XLSM и XLAM в формате сохранения. Python Объедините форматы XLSM и XLAM. Объедините XLSM и XLAM в Python. XLSM Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM с XLAM, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM и XLAM в Python." %}}

В следующем примере показано, как объединить XLSM и XLAM в Aspose.Cells for Python via .NET.
