...
{{% blocks/products/pf/agp/content h2="Bespaar XLSB naar OTS in Python Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLSB converteert naar OTS in Python via NET.
