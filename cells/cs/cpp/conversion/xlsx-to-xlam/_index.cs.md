---
title: Převeďte XLSX na XLAM pomocí aplikace C++ 

description: Ukázkový konverzní kód C++ pro dokument XLSX na formát XLAM. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLSX na XLAM v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLSX na XLAM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLSX pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLAM).1. Soubor XLAM bude uložen do zadané cesty.1. Otevřete soubor XLAM v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLSX na XLAM C++" offSpacer="" %}}
