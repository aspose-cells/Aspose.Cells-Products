---
title: C++ IMAGE إلى TXT - محول IMAGE عبر الإنترنت إلى TXT
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل الصورة إلى TXT saveformat. C++ IMAGE إلى تنسيق TXT. احفظ الصورة في TXT C++.
...
{{% blocks/products/pf/agp/content h2="احفظ IMAGE في TXT في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى TXT في C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل IMAGE إلى TXT. قم بتحميل ملف IMAGE الخاص بك ، ثم احفظه كملف TXT. لقراءة كل من IMAGE وكتابة TXT ، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون المحتوى والتنسيق الناتج TXT مطابقين لوثيقة IMAGE الأصلية.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني ونموذج رمز لتحويل الصورة إلى TXT عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="txt" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى TXT عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى TXT برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى TXT في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى TXT باستدعاء طريقة Save ().
