---
title:  Sloučit XLSM na XLT přes Python
url: /cs/python-net/merger/merge-xlsm-to-xlt/ 
description: Sloučit XLSM až XLT online zdarma. Online zdarma XLSM až XLT Fúze. Sloučit XLSM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSM až XLT v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až XLT online" InputFormat="xlsm" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
