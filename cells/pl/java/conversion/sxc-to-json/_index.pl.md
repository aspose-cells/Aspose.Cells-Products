---
title: Konwertuj SXC na JSON przez Java 
url: /pl/java/conversion/sxc-to-json/ 
description: Przykładowy kod konwersji Java dla formatu SXC do pliku JSON. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do formatu JSON w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj SXC na JSON przez Java" h2="Konwersja SXC do JSON Java w celu konwersji jednej lub wielu stron do formatu JSON przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SXC na JSON za pomocą Java" %}}

 Aby wyrenderować SXC do JSON, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować SXC na JSON za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik SXC na JSON w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SXC z instancją klasy Workbook1. Utwórz zakres danych do wyeksportowania za pomocą Cellsmetody.createRange1. Wywołaj metodę JsonUtility.exportRangeToJson z odwołaniami do Range i ExportRangeToJsonOptions1. Zapisz dane JSON ciągu do pliku za pomocą metody BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji SXC do JSON Java" offSpacer="" %}}
