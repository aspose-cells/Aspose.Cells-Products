...
EXCEL dosyalarını programlı olarak JPEG'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip JPEG'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını JPEG formatına dönüştürün.
