---
title: C# MHT - PPTX - MHT - PPTX konverter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az MHT PPTX formátumba konvertálásához, lehetővé téve az MHT adatok zökkenőmentes mentését PPTX formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentsd el az MHT-t a PPTX-es számra a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet az MHT-t PPTX-re konvertálni a C#-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket az MHT PPTX-re konvertálásához. Töltse fel MHT-fájlját, majd egyszerűen mentse el PPTX fájlként. Mind az MHT-olvasáshoz, mind a PPTX íráshoz használhat teljesen minősített fájlneveket. A PPTX kimeneti tartalom és formázás megegyezik az eredeti MHT dokumentuméval.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mintakód az MHT PPTX-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Az MHT konvertálása PPTX-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Az MHT-fájlokat programozottan PPTX-re kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és konvertálhatják az MHT-t PPTX-re, mindössze néhány sornyi kóddal.
...
1.  Alakítsa át az MHT-t PPTX-re a Workbook.Save metódus meghívásával.
1. Szerezd meg az MHT PPTX számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT PPTX-re konvertálásához" %}}
