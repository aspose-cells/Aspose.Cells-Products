---
title: Python XLTM 转 XLSX - 在线 XLTM 转 XLSX 转换器
description: Aspose Excel。 Python Aspose.Cells。Python Aspose Cells。免费在线 Python 将 XLTM 转换为 XLSX 保存格式。 Python XLTM 到 XLSX 格式。将 XLTM 保存为 XLSX Python。
...
{{% blocks/products/pf/agp/content h2="免费在线保存 XLTM 至 XLSX 于 Python" %}}
...
{{% cells-convert title="免费应用程序和示例代码可在线将 XLTM 转换为 XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
