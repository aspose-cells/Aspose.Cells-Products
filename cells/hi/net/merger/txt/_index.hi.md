---
title:  TXT फ़ाइलें via .NET मर्ज करें
weight: 7350
description: .NET फ्रेमवर्क, .NET कोर, Mono या ज़ामरिन प्लेटफ़ॉर्म पर TXT दस्तावेज़ों को संयोजित करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TXT प्रारूपों को C# में मर्ज करें" h2="Microsoft या ओपन ऑफिस, एडोब PDF जैसे किसी भी सॉफ्टवेयर के उपयोग के बिना, सर्वर-साइड Aspose.Cells for .NET एपीआई का उपयोग करके मूल और उच्च प्रदर्शन TXT दस्तावेज़ विलय।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# में TXT फ़ाइलों को मर्ज करने के चरण" %}}
...
+ सभी TXT फ़ाइलों को पूर्ण पथ के साथ लोड करें।
+ एक दस्तावेज़ को आधार फ़ाइल बनाएं
+ फ़ाइलों को एक-एक करके जोड़ने और मर्ज करने के लिए प्रासंगिक विधि को कॉल करें।
+ सेव() विधि को कॉल करें और फ़ाइल नाम (पूर्ण पथ) और प्रारूप (TXT) को एक पैरामीटर के रूप में पास करें।
+ अब आप TXT फ़ाइल को Microsoft ऑफिस, एडोब PDF या किसी अन्य संगत प्रोग्राम में खोल और उपयोग कर सकते हैं।
...
{{< blocks/products/pf/agp/demobox sectionTitle="ऑनलाइन TXT मर्जर लाइव डेमो" sectionDescription=" अभी हमारे यहां जाकर TXT दस्तावेज़ मर्ज करें[लाइव डेमो वेबसाइट](https://products.aspose.app/cells/merger). लाइव डेमो के निम्नलिखित लाभ हैं" >}}
