...
description: Aspose Excel. Konwertuj XML na FODS szybko i łatwo za pomocą Aspose.Cells. C++ XML na FODS. C++ Zapisz XML na FODS. Zapisz XML jako FODS używając C++.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XML na FODS, używając C++" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem FODS w C++" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na FODS w C++.
...
Chcesz programowo przekonwertować pliki XML na FODS? Programiści C++ mogą łatwo przekonwertować XML na FODS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XML na FODS, wywołując metodę Save().
1.  Uzyskaj wynik konwersji XML na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C++ do konwersji XML na FODS" %}}
