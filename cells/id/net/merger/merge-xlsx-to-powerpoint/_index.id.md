---
title: Gabung XLSX ke POWERPOINT - Gabungkan XLSX ke POWERPOINT di C#
url: /id/net/merger/merge-xlsx-to-powerpoint/ 
description: Aspose Unggul. C# Aspose.Cells. Gabung Online Gratis XLSX ke saveformat POWERPOINT. C# Gabungkan XLSX ke format POWERPOINT. Gabung XLSX ke POWERPOINT di C#. XLSX Gabung.
...
{{% blocks/products/pf/agp/content h2="Menggabungkan XLSX ke POWERPOINT Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSX ke POWERPOINT di C# Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan XLSX ke POWERPOINT di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSX ke POWERPOINT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file POWERPOINT. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSX ke POWERPOINT.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLSX ke POWERPOINT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2=".NET perpustakaan untuk menggabungkan XLSX ke POWERPOINT" %}}
