---
title: Konwertuj XLTM na BMP za pomocą aplikacji C++ 

description: Przykładowy kod konwersji C++ dla dokumentu XLTM do formatu BMP. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTM na BMP w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTM na BMP za pomocą C++" %}}

 Aby przekonwertować XLTM na BMP, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLTM na BMP za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLTM na BMP w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTM przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (BMP).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik BMP w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLTM do BMP C++ Kod źródłowy konwersji" offSpacer="" %}}
