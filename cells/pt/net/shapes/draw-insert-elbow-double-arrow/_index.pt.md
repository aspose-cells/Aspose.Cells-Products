---
title:  Como desenhar ou inserir a forma de seta dupla do cotovelo no Excel via .NET
weight: 101
description: C# código-fonte para desenhar ou inserir a forma de seta dupla do cotovelo no Excel em .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Como inserir a forma de seta dupla do cotovelo no arquivo Excel usando C#" %}}

 Para inserir a forma de seta dupla do cotovelo no arquivo Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir a forma de seta dupla do cotovelo no arquivo Excel via C#" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o[adicionar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) para inserir uma forma de seta dupla de cotovelo na planilha selecionada
...
{{% blocks/products/pf/agp/code-block title="Inserir cotovelo em forma de seta dupla - C#" offSpacer="" %}}
