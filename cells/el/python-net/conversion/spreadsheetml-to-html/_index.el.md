...
{{% blocks/products/pf/agp/content h2="Μετατροπή SPREADSHEETML σε HTML στο Python" %}}
...
Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε SPREADSHEETML σε HTML στο Python via NET.
