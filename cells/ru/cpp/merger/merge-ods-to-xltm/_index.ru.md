...
В следующем примере показано, как объединить ODS с XLTM в Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Нужно программно объединить ODS с XLTM? Базовый документ сливается и объединяется с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="библиотека C++ для объединения ODS с XLTM" %}}
