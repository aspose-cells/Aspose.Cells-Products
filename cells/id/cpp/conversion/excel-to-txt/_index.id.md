...
description: Aspose Unggul. Konversikan EXCEL ke TXT dengan cepat dan mudah dengan Aspose.Cells. C++ EXCEL ke TXT. C++ Simpan EXCEL ke TXT. Simpan EXCEL sebagai TXT menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah EXCEL menjadi TXT Menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengonversi EXCEL ke TXT di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi EXCEL menjadi TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="txt" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi EXCEL ke TXT melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke TXT secara terprogram? Pengembang C++ dapat dengan mudah mengonversi EXCEL menjadi TXT hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah EXCEL menjadi TXT" %}}
