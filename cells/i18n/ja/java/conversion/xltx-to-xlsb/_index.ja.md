...
{{% blocks/products/pf/agp/content h2="Javaを使用してXLTXをXLSBに変換する方法" %}}

 XLTXをXLSBにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してXLTXをXLSBに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでXLTXファイルをXLSBに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookクラスのインスタンスを含むXLTXファイルをロードします1. Workbook.saveメソッドを呼び出す1. XLSB拡張子とSaveFormatをパラメータとして出力パスを渡します1. 結果のXLSBファイルの指定されたパスを確認します
...
{{% blocks/products/pf/agp/code-block title="XLTXからXLSBJavaへの変換ソースコード" offSpacer="" %}}
