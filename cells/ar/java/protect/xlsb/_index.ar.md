---
title:  حماية وإغلاق XLSB وثيقة via Java
weight: 6590
description: رمز عينة Java لقفل ملف XLSB باستخدام كلمة مرور على Java Runtime Environment لتطبيق JSP / JSF وتطبيقات سطح المكتب.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تشفير XLSB الملفات via Java" h2="تحمي جداول بيانات Excel بكلمة مرور بما في ذلك تنسيق XLSB باستخدام مكتبة .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لحماية ملفات XLSB via Java" %}}
...
1.  قم بتحميل ملف XLSB عن طريق إنشاء فئة المصنف
