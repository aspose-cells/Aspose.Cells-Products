---
title: Combinar XLT a MD - Combinar XLT a MD en C#
url: /es/net/merger/merge-xlt-to-md/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea XLT para guardar formato MD. C# Combine XLT en formato MD. Combinar XLT a MD en C#. XLT Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLT con MD en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLT con MD en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLT con MD. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo MD. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que fusiona XLT con MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLT a MD en C#" InputFormat="xlt" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLT a MD a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLT con MD mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar XLT a MD" %}}
