...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować SXC na PDF za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki SXC do formatu PDF w zaledwie kilku wierszach kodu.
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji SXC na PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="pdf" IsLandingPage="true" %}}
