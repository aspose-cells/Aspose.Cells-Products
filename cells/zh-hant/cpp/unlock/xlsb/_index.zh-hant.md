...
title: 透過C++解鎖XLSB文檔
weight: 7420
description: C++ 用於解鎖 C++ 運行時環境中受密碼保護的 XLSB 檔案的範例代碼，適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 刪除 XLSB 檔案的保護" %}}
