...
description: Aspose Excel. Konvertieren Sie HTM schnell und einfach in JPEG mit Aspose.Cells. C++ HTM in JPEG. C++ Speichern Sie HTM in JPEG. Speichern Sie HTM als JPEG mit C++.
...
{{% cells-convert title="Beispielcode zum Konvertieren von HTM in JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie HTM über C++ in JPEG" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM-Dateien programmgesteuert in JPEG konvertieren? C++-Entwickler können HTM in nur wenigen Codezeilen problemlos in JPEG konvertieren.
...
1.  Konvertieren Sie HTM in JPEG, indem Sie die Save()-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von HTM in JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++-Bibliothek zum Konvertieren von HTM in JPEG" %}}
