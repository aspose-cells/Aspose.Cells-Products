---
title: Conversor PHP TSV para XLAM - TSV para XLAM
description: Aspose Excel. Converta TSV em XLAM de forma rápida e fácil com Aspose.Cells. PHP TSV em XLAM. PHP Salve TSV em XLAM. Salve TSV como XLAM usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter TSV em XLAM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em XLAM programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em XLAM em apenas algumas linhas de código.
...
1.  Converta TSV em XLAM chamando o método save da pasta de trabalho.
