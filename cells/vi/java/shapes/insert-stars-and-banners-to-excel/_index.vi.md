---
title:  Chèn Insert Stars And Banners vào Excel via .NET
weight: 381
...
{{< blocks/products/pf/i18n/upper-banner h1="Chèn Insert Stars And Banners vào Excel via Java" h2="Chèn các đối tượng bằng API phía máy chủ mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn Chèn Sao Và Biểu Ngữ Vào File Excel Bằng Sử Dụng Java" %}}

 Để chèn Insert Stars And Banners vào file excel chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn Insert Stars And Banners vào file Excel via Java" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng các[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)để chèn Insert Stars And Banners trong trang tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn Chèn Sao Và Banner - Java" offSpacer="" %}}
