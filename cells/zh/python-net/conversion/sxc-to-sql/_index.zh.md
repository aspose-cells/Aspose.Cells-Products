---
title: Python SXC 到 SQL - SXC 到 SQL 转换器
description: Aspose Excel。使用 Aspose.Cells. Python SXC 到 SQL 快速轻松地将 SXC 转换为 SQL。 Python 将 SXC 保存到 SQL。使用 Python 将 SXC 保存为 SQL。
...
{{% blocks/products/pf/agp/content h2="将SXC保存到SQL中Python" %}}
...
{{% cells-convert title="将 SXC 转换为 SQL 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="sql" IsLandingPage="true" language="pythonnet" %}}
