---
title: Konvertor PHP XLAM až SXC - XLAM až SXC
description: Aspose Excel. Převeďte XLAM na SXC rychle a snadno pomocí Aspose.Cells. PHP XLAM na SXC. PHP Uložte XLAM na SXC. Uložte SXC jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="sxc" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na SXC přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na SXC programově? Vývojáři PHP mohou snadno načíst a převést XLAM na SXC v několika řádcích kódu.
...
1.  Převeďte XLAM na SXC voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na SXC" %}}
