---
title: Voeg TSV samen met OTS - Combineer TSV met OTS in Java
url: /nl/java/merger/merge-tsv-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online samenvoegen TSV naar OTS-opslagformaat. Java Combineer TSV naar OTS-formaat. Voeg TSV samen met OTS in Java. TSV Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis TSV samen met OTS in Java online" %}}

Het volgende voorbeeld laat zien hoe u TSV kunt samenvoegen met OTS in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TSV samen te voegen met OTS. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het OTS-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat TSV samenvoegt met OTS.
...
{{% blocks/products/pf/agp/content h2="Hoe TSV samen te voegen met OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u TSV programmatisch samenvoegen met OTS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om TSV samen te voegen met OTS" %}}
