---
title: Fusionner SXC dans SPREADSHEETML - Combiner SXC dans SPREADSHEETML dans C++
url: /fr/cpp/merger/merge-sxc-to-spreadsheetml/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion en ligne gratuite SXC au format de sauvegarde SPREADSHEETML. C++ Combinez SXC au format SPREADSHEETML. Fusionner SXC à SPREADSHEETML dans C++. SXC Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner SXC à SPREADSHEETML dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner SXC à SPREADSHEETML dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner SXC à SPREADSHEETML. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier SPREADSHEETML. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne SXC en SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner SXC en SPREADSHEETML en C++" InputFormat="sxc" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner SXC en SPREADSHEETML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner SXC avec SPREADSHEETML par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner SXC à SPREADSHEETML" %}}
