---
title:  Συγχώνευση XLS στο HTM μέσω C#
url: /el/net/merger/merge-xls-to-htm/ 
description: Συγχώνευση XLS στο HTM Online δωρεάν. Δωρεάν Online XLS to HTM Merger. Συγχώνευση XLS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLS στο HTM στο C# Δωρεάν Online" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLS στο HTM στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLS σε HTM σε απευθείας σύνδεση" InputFormat="xls" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
