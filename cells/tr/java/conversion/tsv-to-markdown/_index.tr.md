---
title: Java üzerinden TSV'yi MARKDOWN'a dönüştürün 

description: TSV biçimi için MARKDOWN dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada MARKDOWN'a aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java üzerinden TSV\'yi MARKDOWN\'a dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı MARKDOWN\'a dönüştürmek için TSV\'den MARKDOWN\'a Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TSV\'yi MARKDOWN\'a Dönüştürme" %}}

 TSV'yi MARKDOWN'a dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden TSV\'yi MARKDOWN\'a Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla TSV dosyasını kolayca MARKDOWN'a dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TSV dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. MARKDOWN uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan MARKDOWN dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="TSV - MARKDOWN Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TSV dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.tsv");
// TSV'yi MARKDOWN olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="TSV\'den MARKDOWN\'a Dönüşüm Canlı Demoları" sectionDescription="[TSV\'yi MARKDOWN\'e dönüştür](https://products.aspose.app/cells/conversion/tsv-to-markdown) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece TSV dosyanızı yükleyin, anında MARKDOWN\'a dönüştürülecektir." >}}
