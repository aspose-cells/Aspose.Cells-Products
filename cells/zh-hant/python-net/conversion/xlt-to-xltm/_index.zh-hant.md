...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 XLT 轉換為 XLTM。Python XLT 為 XLTM. Python 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Python。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 XLT 轉換為 Python 中的 XLTM" h2="高速 Python 庫，用於將 XLT 轉換為 XLTM。使用我們的 Excel 轉換 API 在 Python 中開發高級、平台獨立的軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將 XLT 轉換為 Python 中的 XLTM" %}}
...
以下範例示範如何將 Python via NET 中的 XLT 轉換為 XLTM。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLT 轉換為 XLTM。上傳您的 XLT 文件，然後只需將其另存為 XLTM 文件。對於 XLT 讀取和 XLTM 寫入，您可以使用完全限定的檔案名稱。輸出 XLTM 內容和格式將與原始 XLT 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 XLT 轉換為 XLTM 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xltm" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python庫將XLT轉換為XLTM" %}}
