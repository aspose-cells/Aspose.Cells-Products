...
description: Aspose Excel. Convierta XLSB a PDF rápida y fácilmente con Aspose.Cells. Python XLSB a PDF. Python Guarde XLSB en PDF. Guarde XLSB como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB al PDF en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a PDF en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB en PDF" %}}
