...
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato IMAGE, permitindo o salvamento perfeito de dados XLS no formato IMAGE usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Converter XLS para IMAGEM usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salvar XLS em IMAGEM em C++" %}}

O exemplo a seguir demonstra como converter XLS em IMAGEM em C++.
...
Precisa converter arquivos XLS para IMAGE programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para IMAGE com apenas algumas linhas de código.
...
1.  Converta XLS para IMAGEM chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em IMAGEM" %}}
