...
description: Convert FODS to XLTM. Convert FODS to XLTM online for free. Convert FODS to Word, Excel, PPTX, PDF, JPG, HTML, ODS, BMP, PNG, SVG, XPS and more.
...
Follow the easy steps to convert FODS into XLTM. Upload your FODS file, then simply save it as XLTM file. For both FODS reading and XLTM writing you can use fully qualified filenames. The output XLTM content and formatting will be identical to the original FODS document.
