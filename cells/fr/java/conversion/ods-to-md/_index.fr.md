---
title: Convertir ODS en MD via Java 

description: Exemple de code de conversion Java pour le format ODS en fichier MD. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers MD dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ODS en MD via Java" h2="Conversion ODS en MD Java pour convertir une ou plusieurs pages en MD à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir ODS en MD en utilisant Java" %}}

 Afin de rendre ODS à MD, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ODS en MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier ODS en MD en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ODS avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension MD et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier MD résultant
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion ODS en MD Java" offSpacer="" %}}

```cs
// charger le fichier ODS dans une instance de Workbook
Workbook book = new Workbook("template.ods");
// enregistrer ODS en tant que MD
