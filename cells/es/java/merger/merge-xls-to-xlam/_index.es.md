---
title: Combinar XLS a XLAM - Combinar XLS a XLAM en Java
url: /es/java/merger/merge-xls-to-xlam/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLS a XLAM guardar formato. Java Combina el formato XLS con el XLAM. Combinar XLS a XLAM en Java. XLS Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLS a XLAM en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLS con XLAM en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLS a XLAM. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo XLAM. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que combina XLS con XLAM.
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar XLS a XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLS con XLAM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar XLS a XLAM" %}}
