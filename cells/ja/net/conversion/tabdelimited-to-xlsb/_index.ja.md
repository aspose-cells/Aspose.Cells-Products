...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET開発者は、わずか数行のコードでTABDELIMITEDファイルをXLSBに簡単にロードおよび変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookのインスタンスを含むTABDELIMITEDファイルをロードします1. Workbook.Saveメソッドを呼び出します1. XLSB拡張子をパラメータとして出力パスを渡す1. 結果のXLSBファイルの指定されたパスを確認します
...
{{% cells-convert title="TABDELIMITEDをXLSBに変換するための無料のアプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlsb" IsLandingPage="true" %}}
