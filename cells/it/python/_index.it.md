...
weight: 2820
description: Python libreria di fogli di calcolo per creare file Excel letti, scritti e analizzati.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python API di analisi dei fogli di calcolo Excel" h2="Genera, leggi, scrivi o manipola fogli di calcolo nonché esporta file Excel in più formati all\'interno delle applicazioni Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-python-java.svg" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="https://releases.aspose.com/cells/python-java/" >}}
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="Aspose.Cells for Python è disponibile per." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="La libreria Excel Python supporta i popolari formati Excel Microsoft, formati a layout fisso e immagini." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Avanzate Python Excel API Funzionalità
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Leggere fogli di calcolo Excel
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Rendering di fogli di calcolo su PDF, EMF e immagini
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Modificare i fogli di lavoro all'interno delle cartelle di lavoro
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Proteggi/rimuovi la protezione dei fogli di lavoro
    </p>
   </div>
   <div class="col-lg-4">
...
Aggiungi o rimuovi il raggruppamento in righe e colonne
 ...
 Configura l'impostazione della pagina
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Regola l'orientamento della pagina, il ridimensionamento e il formato della carta
    </p>
   </div>
   <div class="col-lg-4">
...
<p>Python sheets API provides a powerful Formula Calculation Engine that supports almost all of the standard and advanced Microsoft Excel formulas and functions. Formula calculation engine makes it easy to read, set and calculate the results of the built-in or add-in type, array and R1C1 reference style formulas.</p>
 ...
 Opzioni di visualizzazione flessibili
    ...
    <p>
 Aspose.Cells for Python fornisce il controllo completo sull'impostazione della pagina consentendo di manipolare più opzioni di visualizzazione come anteprima interruzioni di pagina, impostazione del livello di zoom, impostazione dell'orientamento della pagina, controllo della visibilità dei dati con riquadri di blocco, dimensioni della carta, ridimensionamento, intestazioni e amp; piè di pagina e area di stampa.
    </p>
   </div>
   <!--<div class="col-lg-12">
...
<p>Aspose.Cells for Android via Java API allows you to manipulate rows and columns in many different ways. You can easily adjust row height and column width, auto size the width & height of cells according to the contents, insert or delete, hide or show and group or ungroup rows & columns.</p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
 Gestione dati fogli Excel
    </h2>
    <p>
 Aspose.Cells for Python API fornisce ampio supporto per la gestione dei dati del foglio di lavoro. È possibile manipolare facilmente qualsiasi cella del foglio di lavoro in fase di esecuzione o importare dati nei fogli di lavoro da varie origini dati.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
Personalizzazione dei grafici
    ...
    <p>
 Aspose.Cells for Python fornisce pieno supporto per la creazione di grafici. È possibile aggiungere facilmente grafici standard e personalizzati o impostare dinamicamente i dati del grafico per aggiornare il grafico in questa libreria Python.
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="Aspose.Cells API Riferimenti" href="https://reference.aspose.com/cells/python-java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Cells for Python?" tabId="success-stories" >}}
