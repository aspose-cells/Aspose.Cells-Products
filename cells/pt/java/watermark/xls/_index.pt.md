---
title:  Marca d'água XLS documento via Java
weight: 2210
description: Código de amostra Java para adicionar ou remover marca d’água do arquivo XLS no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
...
{{< blocks/products/pf/i18n/upper-banner h1="Adicionar marca d\'água de texto a XLS via Java" h2="Crie seus próprios aplicativos Java para marcar arquivos XLS com marca d\'água usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para adicionar marca d\'água a XLS via Java" %}}
...
1.  Salvar pasta de trabalho no formato XLS
...
{{% blocks/products/pf/agp/code-block title="Adicionar marca d\'água a XLS - Java" offSpacer="" %}}
