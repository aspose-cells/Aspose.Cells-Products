...
description: Aspose Exceller. Python Exceller. Fusionnez le format de sauvegarde JPEG vers FODS. Python Combinez les formats JPEG à FODS. Fusionnez JPEG à FODS dans la bibliothèque Excel Python. JPEG Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner JPEG à FODS à l\'aide de la bibliothèque Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner JPEG à FODS dans la bibliothèque Excel Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner JPEG à FODS dans la bibliothèque Excel Python" InputFormat="jpg" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner JPEG à FODS via la bibliothèque Excel Python" %}}
