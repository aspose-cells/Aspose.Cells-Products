---
title: Python HTM ke MHT - Konverter HTM ke MHT
description: Aspose Excel. Solusi komprehensif ini menyediakan Python pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi format HTM ke MHT, memungkinkan penyimpanan data HTM ke format MHT tanpa hambatan menggunakan pustaka Aspose.Cells, semuanya melalui kode Python yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversi HTM ke MHT di Pustaka Excel Python" h2="Pustaka Excel berkecepatan tinggi Python untuk mengkonversi HTM ke MHT. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor HTM, MHT, dan banyak format lainnya menggunakan Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konversi HTM ke MHT Menggunakan Pustaka Excel Python" %}}

 Bagaimana cara mengkonversi HTM ke MHT? Dengan pustaka Aspose.Cells for Python, Anda dapat dengan mudah mengkonversi HTM ke MHT secara terprogram hanya dengan beberapa baris kode.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)mampu membangun aplikasi lintas platform dengan kemampuan untuk menghasilkan, memodifikasi, mengkonversi, merender dan mencetak semua file Excel. Python Excel API tidak hanya mengkonversi antar format spreadsheet, tetapi juga dapat merender file Excel sebagai gambar, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT dan banyak lagi, sehingga menjadikannya pilihan sempurna untuk bertukar dokumen dalam format standar industri.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Simpan HTM ke MHT di Perpustakaan Excel Python" %}}

Contoh berikut menunjukkan cara mengkonversi HTM ke MHT di pustaka excel Python.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengkonversi HTM ke MHT. Unggah file HTM Anda, lalu simpan saja sebagai file MHT. Baik untuk membaca HTM maupun menulis MHT, Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format MHT keluaran akan identik dengan dokumen HTM asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi HTM ke MHT melalui Pustaka Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi HTM ke MHT melalui Python" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file HTM ke MHT secara terprogram? Pengembang Python dapat dengan mudah memuat & mengkonversi HTM ke MHT hanya dalam beberapa baris kode.
...
1.  Konversikan HTM ke MHT dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi HTM ke MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Pustaka Excel untuk Mengonversi HTM ke MHT" %}}
