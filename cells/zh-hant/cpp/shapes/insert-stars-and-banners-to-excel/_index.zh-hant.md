...
+ 通過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ab8156e8562724f9a597b7d2bc503cd4d)在所選工作表中插入星標和橫幅
以 XLSX 格式保存工作簿。
