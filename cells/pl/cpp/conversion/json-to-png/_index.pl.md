---
title: Konwertuj JSON na PNG za pomocą aplikacji C++ 

description: Przykładowy kod konwersji C++ dla dokumentu JSON do formatu PNG. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji formatu JSON na PNG w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować JSON na PNG za pomocą C++" %}}

 Aby przekonwertować JSON na PNG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować JSON na PNG za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik JSON na PNG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik JSON przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (PNG).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik PNG w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji JSON do PNG C++" offSpacer="" %}}
