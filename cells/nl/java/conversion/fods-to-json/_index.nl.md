...
{{% blocks/products/pf/agp/content h2="Sla FODS op in JSON in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar JSON in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar JSON of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar JSON? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar JSON met slechts een paar regels code.
