---
title: C# NUMBERS から PRN - オンライン NUMBERS から PRN コンバータ
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# NUMBERS を PRN 保存形式に変換します。 C# NUMBERS を PRN 形式に変換します。番号を PRN C# に保存します。
...
{{% blocks/products/pf/agp/content h2="C# の PRN にオンラインで無料で NUMBERS を保存" %}}

次の例は、NUMBERS を C# の PRN に変換する方法を示しています。
...
{{% cells-convert title="NUMBERSをオンラインでPRNに変換するための無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でNUMBERSをPRNに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS ファイルをプログラムで PRN に変換する必要がありますか? .NET 開発者は、わずか数行のコードで NUMBERS を簡単にロードして PRN に変換できます。
...
{{% blocks/products/pf/agp/content h2="C# NUMBERS を PRN に変換するライブラリ" %}}
