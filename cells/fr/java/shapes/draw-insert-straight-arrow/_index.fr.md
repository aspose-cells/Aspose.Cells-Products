...
{{% blocks/products/pf/agp/content h2="Comment insérer une flèche droite dans un fichier Excel à l\'aide de Java" %}}

Afin d'insérer une flèche droite dans un fichier Excel, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une flèche droite dans le fichier Excel via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) pour insérer une flèche droite dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer une flèche droite - Java" offSpacer="" %}}
