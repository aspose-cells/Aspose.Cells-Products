---
title: "HTML-fájlok egyesítése a következőn keresztül: C++ "
url: /hu/cpp/merger/html/ 
description: C++ példakód HTML-dokumentumok kombinálására a C++ Runtime Environment for Windows 32 bit, Windows 64 bit és a Linux 64 bites rendszeren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="HTML-formátumok egyesítése itt: C++" h2="HTML-dokumentumok egyesítése szerveroldali C++ API-kkal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="HTML" >}}
