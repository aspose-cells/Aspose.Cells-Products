...
url: /hu/python-net/merger/merge-jpg-to-ots/ 
description: Aspose Excel. Python Excel. JPG egyesítése OTS mentési formátumba. Python JPG kombinálása OTS formátumba. Egyesítse a JPG-t az OTS-be a Python Excel-könyvtárban. JPG összevonás.
...
{{% blocks/products/pf/agp/content h2="JPG egyesítése OTS-be a Python Excel könyvtáron keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a JPG-t az OTS-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
