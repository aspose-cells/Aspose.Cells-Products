---
title: Java HTM ke FODS - Konverter HTM ke FODS
description: Aspose Unggul. Ubah HTM menjadi FODS dengan cepat dan mudah menggunakan Aspose.Cells. Java HTM menjadi FODS. Java Simpan HTM menjadi FODS. Simpan HTM sebagai FODS menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah HTM menjadi FODS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi HTM ke FODS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor HTM, FODS, dan banyak format lain menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan HTM ke FODS di Java" %}}

Contoh berikut menunjukkan cara mengonversi HTM ke FODS di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi HTM ke FODS. Unggah file HTM Anda, lalu simpan saja sebagai file FODS. Untuk pembacaan HTM dan penulisan FODS Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran FODS akan identik dengan dokumen HTM asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi HTM ke FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="fods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi HTM ke FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file HTM ke FODS secara terprogram? Pengembang Java dapat dengan mudah mengonversi HTM menjadi FODS hanya dalam beberapa baris kode.
...
1.  Ubah HTM menjadi FODS dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi HTM ke FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah HTM menjadi FODS" %}}
{{% blocks/products/pf/agp/text %}}
