...
{{% blocks/products/pf/agp/content h2="Python を使用して JSON を PPTX に変換します" %}}
...
次の例は、JSON を Python の PPTX に変換する方法を示しています。
...
{{% blocks/products/pf/agp/content h2="Python経由でJSONをPPTXに変換する方法" %}}
