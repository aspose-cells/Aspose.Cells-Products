---
title: C# OTS से TXT - OTS से TXT कनवर्टर
description: Aspose Excel. यह पूरा सॉल्यूशन C# डेवलपर्स को OTS को TXT फ़ॉर्मेट में बदलने के लिए पूरी तरह से इंटीग्रेटेड तरीका देता है, जिससे Aspose.Cells लाइब्रेरी का इस्तेमाल करके OTS डेटा को TXT फ़ॉर्मेट में आसानी से सेव किया जा सकता है, यह सब कुशल और कस्टमाइज़ेबल C# कोड के ज़रिए होता है।
...
{{% blocks/products/pf/agp/content h2="OTS को TXT में C# में सेव करें" %}}

नीचे दिया गया उदाहरण दिखाता है कि C# में OTS को TXT में कैसे कन्वर्ट करें।
...
{{% blocks/products/pf/agp/content h2="OTS को TXT से C# में कैसे बदलें" %}}

{{% blocks/products/pf/agp/text %}}

OTS फ़ाइलों को प्रोग्रामेटिक रूप से TXT में परिवर्तित करने की आवश्यकता है? .NET डेवलपर्स आसानी से कोड की कुछ पंक्तियों में OTS को TXT में लोड और परिवर्तित कर सकते हैं।
...
1.  Workbook.Save मेथड को कॉल करके OTS को TXT में कन्वर्ट करें।
1.  OTS का TXT में रूपांतरण परिणाम प्राप्त करें।

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# लाइब्रेरी OTS को TXT में बदलने के लिए" %}}
