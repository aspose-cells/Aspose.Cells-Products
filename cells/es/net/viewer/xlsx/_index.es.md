---
title:  Ver XLSX Formatos de archivo via .NET
weight: 2180
description: C# código fuente para cargar, renderizar y mostrar documentos XLSX en plataformas .NET Framework, .NET Core, Mono o Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Ver XLSX vía C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells facilita a los desarrolladores ver el archivo XLSX con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Cargue el archivo XLSX en una instancia de Workbook
1.  Cree una instancia de HtmlSaveOptions y establezca la propiedad ExportHeadings en verdadero
1. Guarde el archivo XLSX en formato HTML usando el método Workbook.Save
