---
title: C++ ODS až XLAM - Online konvertor ODS až XLAM
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Online zdarma C++ Převést ODS na XLAM uložit formát. C++ ODS až XLAM formát. Uložte si ODS až XLAM C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODS na XLAM na C++" h2="Vysoce výkonný převod ODS na XLAM pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLAM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete ODS až XLAM v C++ online zdarma" %}}

Následující příklad ukazuje, jak převést ODS na XLAM v C++.
...
Potřebujete převést soubory ODS na XLAM programově? Vývojáři C++ mohou snadno převést ODS na XLAM v několika řádcích kódu.
...
1.  Převeďte ODS na XLAM voláním metody Save().
