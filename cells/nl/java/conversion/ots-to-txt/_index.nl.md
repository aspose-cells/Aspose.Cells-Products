---
title: Java OTS naar TXT - OTS naar TXT Converter
description: Aspose Excel. Deze complete oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van OTS-gegevens naar het TXT-formaat. Hierdoor kunnen OTS-gegevens naadloos worden opgeslagen in het TXT-formaat met behulp van de Aspose.Cells-bibliotheek, allemaal via efficiënte en aanpasbare Java-code.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer OTS naar TXT in Java" h2="Snelle Java-bibliotheek voor het converteren van OTS naar TXT. Dit is een professionele softwareoplossing voor het importeren en exporteren van OTS, TXT en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Sla OTS op in TXT in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar TXT converteert in Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om OTS naar TXT te converteren. Upload uw OTS-bestand en sla het vervolgens eenvoudig op als TXT-bestand. Voor zowel OTS-lezen als TXT-schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De inhoud en opmaak van de uitvoer TXT zullen identiek zijn aan het originele OTS-document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Voorbeeldcode om OTS naar TXT te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="txt" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar TXT via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar TXT? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar TXT met slechts een paar regels code.
...
1.  Converteer OTS naar TXT door de Workbook.save-methode aan te roepen.
1.  Ontvang het conversieresultaat van OTS naar TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java bibliotheek om OTS naar TXT te converteren" %}}
{{% blocks/products/pf/agp/text %}}
