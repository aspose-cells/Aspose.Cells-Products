...
{{% blocks/products/pf/agp/content h2="Create DOCX File Using C++" %}}
...
{{% blocks/products/pf/agp/content h2="How to Create DOCX in C++" %}}
...
1.  Save the workbook as .docx file using Save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create DOCX file in C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ library to create DOCX file" %}}
