---
title: Gộp OTS thành BMP - Gộp OTS thành BMP trong C#
url: /vi/net/merger/merge-ots-to-bmp/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí OTS thành BMP định dạng lưu. C# Kết hợp định dạng OTS thành BMP. Hợp nhất OTS thành BMP trong C#. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS với BMP trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất OTS thành BMP trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất OTS thành BMP. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp, sau đó lưu vào tệp BMP. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất OTS thành BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất OTS thành BMP trong C#" InputFormat="ots" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS thành BMP qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất OTS với BMP theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất OTS thành BMP" %}}
