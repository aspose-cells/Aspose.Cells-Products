...
{{% blocks/products/pf/agp/content h2="Jak anotovat soubor XLSM pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro přidání nebo odstranění anotace z XLSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Načtěte soubor XLSM pomocí třídy Workbook
...
{{% blocks/products/pf/agp/code-block title="Smazat anotace od XLSM - Java" offSpacer="" %}}
