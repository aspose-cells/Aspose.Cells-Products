---
title: Java XLTX から XLS - オンライン XLTX から XLS コンバータ
description: Aspose エクセル。 Java Aspose.Cells. Java Aspose Cells. 無料オンライン Java XLTX を XLS 保存形式に変換します。 Java XLTX ～ XLS の形式。 XLTX から XLS Java を保存します。
...
{{% blocks/products/pf/agp/content h2="Java に XLTX から XLS をオンラインで無料で保存" %}}

次の例は、XLTX を Java の XLS に変換する方法を示しています。
...
{{% cells-convert title="オンラインでXLTXをXLSに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="XLTX を XLS via Java に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLTX ファイルをプログラムで XLS に変換する必要がありますか? Java 開発者は、わずか数行のコードで XLTX を XLS に簡単に変換できます。
