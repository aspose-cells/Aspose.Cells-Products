---
title: "SPREADSHEETML konvertálása XPS-re a következőn keresztül: Java "
url: /hu/java/conversion/spreadsheetml-to-xps/ 
description: Minta Java konverziós kód a SPREADSHEETML formátumhoz XPS fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok XPS-re történő exportálására bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML konvertálása XPS-re a következőn keresztül: Java" h2="A SPREADSHEETML-ből XPS-re Java konvertálva egyetlen vagy több oldalt XPS-vé konvertálhat a Helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="A SPREADSHEETML konvertálása XPS-re a következővel: Java" %}}

 Ahhoz, hogy a SPREADSHEETML-t XPS-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A SPREADSHEETML konvertálása XPS-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak SPREADSHEETML fájlt XPS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a SPREADSHEETML-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XPS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XPS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML XPS Java konverziós forráskódra" offSpacer="" %}}

```cs
// töltse be a SPREADSHEETML fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.spreadsheetml");
// mentse a SPREADSHEETML-t XPS-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML-ből XPS konverziós élő bemutatók" sectionDescription="[A SPREADSHEETML konvertálása XPS-re](https://products.aspose.app/cells/conversion/spreadsheetml-to-xps) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a SPREADSHEETML-fájlt, és azonnal XPS-re konvertálódik." >}}
