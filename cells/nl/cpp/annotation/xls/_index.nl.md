...
{{% blocks/products/pf/agp/content h2="Een XLS-bestand annoteren met C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om opmerkingen in XLS toe te voegen via C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Laad het XLS Excel-bestand met behulp van het IWorkbook-klasseobject.1. Selecteer het betreffende blad1. Voeg de opmerking toe met de methode Toevoegen1. Stel de notitie van de opmerking in met behulp van de SetNote-methode.1. Sla de werkmap op met [Opslaan](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a77072cfb929787df9ad1f38b02f58349) methode
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API kan worden gebruikt voor het maken, bewerken, converteren en weergeven van Microsoft Excel-indelingen naar verschillende indelingen. Bovendien kan het worden gebruikt voor uitgebreide grafieken, schaalbare rapportage en betrouwbare berekeningen binnen softwaretoepassingen. Aspose.Cells is een zelfstandige API en vereist geen software zoals Microsoft of OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Annotatie toevoegen/verwijderen van XLS via online app" sectionDescription="Verwijder nu direct XLS-documentannotaties door naar onze [Live demo\'s website](https://products.aspose.app/cells/annotation). De live demo heeft de volgende voordelen:" >}}
