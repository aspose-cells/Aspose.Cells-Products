...
url: /tr/python-java/merger/merge-mhtml-to-ett/ 
...
Aşağıdaki örnek, MHTML'in Aspose.Cells for Python via Java'deki ETT ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 MHTML'i ETT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
