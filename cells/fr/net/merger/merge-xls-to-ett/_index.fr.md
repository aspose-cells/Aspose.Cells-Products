---
title: Fusionner XLS à ETT - Combiner XLS à ETT dans C#
url: /fr/net/merger/merge-xls-to-ett/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite XLS au format de sauvegarde ETT. C# Combinez XLS au format ETT. Fusionner XLS à ETT en C#. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS à ETT en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner XLS à ETT dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes faciles pour fusionner XLS à ETT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier ETT. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne XLS à ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner XLS à ETT en C#" InputFormat="xls" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS à ETT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner XLS à ETT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner XLS à ETT" %}}
