---
title: 透過 C++ 將方程式形狀插入 Excel
weight: 780
description: C++ 在 C++ 執行環境（適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元）上的 Excel 檔案中插入方程式形狀的範例程式碼。
keywords: [C++ Aspose.Cells., C++ add equation shapes., C++ insert equation shapes., C++ create equation shapes]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 將方程式形狀插入 Excel" h2="使用伺服器端的本機高效能插入物件 Aspose.Cells for C++ API，無需使用任何軟體，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 將方程式形狀插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 將方程式形狀插入 Excel 檔案的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="插入方程式形狀 - C++" offSpacer="" %}}
