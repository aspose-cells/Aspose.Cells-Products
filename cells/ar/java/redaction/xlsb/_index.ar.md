---
title:  بحث واستبدال النص في XLSB مستند via Java
weight: 4590
description: نموذج التعليمات البرمجية Java لتنقيح المعلومات الحساسة في ملف XLSB على Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تنقيح XLSB الملفات في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="تنقيح XLSB ملفات - Java" offSpacer="" %}}
