---
title:  संपादित करें या देखें XLS फ़ाइलें मेटाडेटा via Java
weight: 730
description: जेएसपी/जेएसएफ एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरमेंट पर XLS प्रारूप मेटाडेटा को संपादित करने या देखने के लिए Java नमूना कोड।
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके XLS मेटाडेटा कैसे निकालें" %}}
 ...
 XLS फ़ाइल मेटाडेटा प्राप्त करने के लिए, हम इसका उपयोग करेंगे
...
+ वर्कबुकमेटाडेटा के भीतर XLS फ़ाइल लोड करें
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/metadata/xlsx/" name="XLSX" description="ओओएक्सएमएल एक्सेल फ़ाइल" >}}
