---
title: OTS'yi NUMARALARLA BİRLEŞTİR - Java'de OTS'yi NUMARALARLA BİRLEŞTİRİN
url: /tr/java/merger/merge-ots-to-numbers/ 
description: Aspose excel. Java Aspose.Cells. OTS'yi NUMBERS kaydetme biçiminde Ücretsiz Çevrimiçi Birleştirme. Java OTS'yi SAYILAR biçiminde birleştirin. Java'de OTS'yi NUMBERS ile birleştirin. OTS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="Java Online\'da OTS\'yi NUMBERS ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de OTS'nin NUMBERS ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

OTS'yi SAYILAR ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından onu NUMBERS dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. OTS'yi NUMBERS ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="OTS\'yi Java\'de SAYILARLA Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ots" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="OTS via Java NUMARALARINA NASIL BİRLEŞTİRİLİR" %}}

{{% blocks/products/pf/agp/text %}}

 OTS'yi programlı olarak NUMBERS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi NUMBERS ile birleştirmek için Java kitaplığı" %}}
