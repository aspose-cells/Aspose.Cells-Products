...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики Java могут легко преобразовать ODS в JSON всего за несколько строк кода.
