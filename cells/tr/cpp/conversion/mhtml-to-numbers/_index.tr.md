---
title: C++ MHTML - MHTML - NUMARALAR Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C++ geliştiricilerine MHTML'i NUMBERS formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak MHTML verilerinin NUMBERS formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C++ kod aracılığıyla gerçekleştirilir.
...
{{< blocks/products/pf/i18n/upper-banner h1="MHTML sayısını C++ rakamına dönüştürün." h2="C++ kütüphanesini kullanarak, Excel, OpenOffice veya Adobe Acrobat kurulumuna gerek kalmadan yüksek performanslı MHTML\'den NUMBERS\'a dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="MHTML\'i C++\'deki NUMARALARA kaydedin" %}}

Aşağıdaki örnek, MHTML sayısını C++ şeklinde sayılara nasıl dönüştüreceğinizi göstermektedir.
...
{{% blocks/products/pf/agp/content h2="MHTML numarasını C++ üzerinden sayılara nasıl dönüştürebilirsiniz?" %}}

{{% blocks/products/pf/agp/text %}}

MHTML dosyalarını programatik olarak NUMBERS'a dönüştürmeniz mi gerekiyor? C++ geliştiricileri, MHTML dosyalarını birkaç satır kodla kolayca NUMBERS'a dönüştürebilir.
...
1.  Save() yöntemini çağırarak MHTML sayısını sayılara dönüştürün.
1.  MHTML sayısının rakamlara dönüştürme sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ kütüphanesi, MHTML\'i sayılara dönüştürüyor." %}}
