---
title: A XLS egyesítése az MHT-val – a XLS-es szám egyesítése az MHT-vel a Java-ben
url: /hu/java/merger/merge-xls-to-mht/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés XLS MHT mentési formátumba. Java A XLS kombinálása MHT formátumba. A XLS egyesítése az MHT-val a Java-es számon. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a XLS-es számot az MHT-vel a Java-es számon online" %}}

A következő példa bemutatja, hogyan egyesítheti a XLS-et az MHT-val a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS és az MHT egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el MHT-fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a XLS-et az MHT-val.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a XLS-es számmal az MHT-vel a Java-ben" InputFormat="xls" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLS és az MHT via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a XLS-et az MHT-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a XLS és az MHT egyesítése érdekében" %}}
