---
title: NUMBERS को Java के माध्यम से ODS में बदलें 

description: ODS फ़ाइल में NUMBERS प्रारूप के लिए नमूना Java रूपांतरण कोड। प्रोग्रामर इस उदाहरण कोड का उपयोग किसी भी वेब या डेस्कटॉप Java आधारित एप्लिकेशन के भीतर एक्सेल और ओपनऑफिस स्प्रेडशीट को ओडीएस में निर्यात करने के लिए कर सकते हैं।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="NUMBERS को Java के माध्यम से ODS में बदलें" h2="ऑन-प्रिमाइसेस Java लाइब्रेरी का उपयोग करके एकल या एकाधिक पृष्ठों को ODS में बदलने के लिए NUMBERS से ODS Java रूपांतरण।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके NUMBERS को ODS में कैसे बदलें" %}}

 NUMBERS को ODS में रेंडर करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="NUMBERS को Java के माध्यम से ODS में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Java डेवलपर NUMBERS फ़ाइल को कोड की कुछ ही पंक्तियों में आसानी से ODS में बदल सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. कार्यपुस्तिका वर्ग के उदाहरण के साथ NUMBERS फ़ाइल लोड करें1. कार्यपुस्तिका को कॉल करें। विधि सहेजें1. ODS एक्सटेंशन के साथ आउटपुट पथ पास करें और पैरामीटर के रूप में SaveFormat करें1. परिणामी ODS फ़ाइल के लिए निर्दिष्ट पथ की जाँच करें
...
{{% blocks/products/pf/agp/code-block title="NUMBERS से ODS Java रूपांतरण स्रोत कोड" offSpacer="" %}}

```cs
// कार्यपुस्तिका के उदाहरण में NUMBERS फ़ाइल लोड करें
Workbook book = new Workbook("template.numbers");
// NUMBERS को ODS . के रूप में सहेजें
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS से ODS रूपांतरण लाइव डेमो" sectionDescription="[NUMBERS को ODS में बदलें](https://products.aspose.app/cells/conversion/numbers-to-ods) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API डाउनलोड करने की आवश्यकता नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" कोई कोड लिखने की जरूरत नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी NUMBERS फ़ाइल अपलोड करें, यह तुरंत ODS में बदल जाएगी।" >}}
