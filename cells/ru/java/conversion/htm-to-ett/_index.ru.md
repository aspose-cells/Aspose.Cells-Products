...
{{% blocks/products/pf/agp/content h2="Преобразовать HTM в ETT, используя код Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM в ETT в Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в ETT в коде Java.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать HTM в ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать HTML-файлы в формат ETT? Разработчики, использующие код Java, могут легко преобразовать HTML в ETT всего за несколько строк кода.
