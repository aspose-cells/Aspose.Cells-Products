---
title: XLSX'i SPREADSHEETML ile birleştir - XLSX'i C++'deki SPREADSHEETML ile birleştir
url: /tr/cpp/merger/merge-xlsx-to-spreadsheetml/ 
description: Aspose Excel'de. C++ Aspose.Cells. XLSX'i SPREADSHEETML kaydetme biçimiyle birleştirin. C++ XLSX'i SPREADSHEETML biçimiyle birleştirin. XLSX'i C++'deki SPREADSHEETML ile birleştir. XLSX Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLSX\'i C++\'deki SPREADSHEETML ile birleştir" %}}

Aşağıdaki örnek, XLSX'in Aspose.Cells for C++'deki SPREADSHEETML ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLSX\'i C++\'deki SPREADSHEETML ile Birleştirecek Örnek Kod" InputFormat="xlsx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLSX\'i C++ aracılığıyla SPREADSHEETML ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLSX'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="C++ kitaplığı, XLSX\'i SPREADSHEETML ile birleştirecek" %}}
