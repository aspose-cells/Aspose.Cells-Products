---
title: Conversor PHP TSV para EXCEL - TSV para EXCEL
description: Aspose Excel. Converta TSV para EXCEL de forma rápida e fácil com Aspose.Cells. PHP TSV para EXCEL. PHP Salve TSV no EXCEL. Salve TSV como EXCEL usando PHP.
...
{{% blocks/products/pf/agp/content h2="Salve TSV no EXCEL em PHP" %}}
...
Precisa converter arquivos TSV para EXCEL programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV para EXCEL em apenas algumas linhas de código.
...
1.  Converta TSV em EXCEL chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TSV para EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TSV para EXCEL" %}}
