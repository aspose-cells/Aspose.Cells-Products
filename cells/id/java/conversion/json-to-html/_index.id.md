---
title: Konversi JSON ke HTML melalui Java 
weight: 9240
url: /id/java/conversion/json-to-html/ 
description: Contoh Java kode konversi untuk format JSON ke file HTML. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke HTML dalam Aplikasi berbasis Web atau Desktop Java apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi JSON ke HTML melalui Java" h2="Ekspor JSON ke format HTML melalui Java tanpa memerlukan alat atau pustaka tambahan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi JSON ke HTML Menggunakan Java" %}}

 Untuk merender JSON ke HTML, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi JSON ke HTML melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file JSON ke HTML hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Buat instance baru dari kelas Workbook1. Pilih default atau Lembar Kerja apa pun dari koleksi1. Muat data JSON dari file1. Buat instance JsonLayoutOptions & atur opsi1. Panggil metode JsonUtility.importData dengan mengacu pada Lembar Kerja & data1. Simpan Buku Kerja dalam format HTML
...
{{% blocks/products/pf/agp/code-block title="JSON ke HTML Java Kode Sumber Konversi" offSpacer="" %}}
...
// simpan file yang dihasilkan dalam format JSON-TO-HTML
