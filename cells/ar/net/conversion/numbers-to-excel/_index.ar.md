...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الأرقام إلى إكسل في C#" h2="مكتبة C# عالية السرعة لتحويل الأرقام إلى ملفات إكسل. هذا حل برمجي احترافي لاستيراد وتصدير الأرقام وملفات إكسل والعديد من التنسيقات الأخرى على منصات .NET Framework و.NET Core وMono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
هل تحتاج إلى تحويل ملفات NUMBERS إلى EXCEL برمجيًا؟ يمكن لمطوري .NET تحميل وتحويل الأرقام إلى EXCEL بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الأرقام إلى ملف إكسل عن طريق استدعاء دالة Workbook.Save.
