...
description: Aspose Excel. Szybko i łatwo przekonwertuj PRN na MHT za pomocą Aspose.Cells. Python PRN na MHT. Python Zapisz PRN w MHT. Zapisz PRN jako MHT, używając numeru Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN w MHT pod numerem Python" %}}

Poniższy przykład pokazuje, jak przekonwertować PRN na MHT w Python.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować PRN na MHT. Prześlij plik PRN, a następnie po prostu zapisz go jako plik MHT. Zarówno do odczytu PRN, jak i zapisu MHT, można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie MHT będą identyczne z oryginalnym dokumentem PRN.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować PRN na MHT poprzez Python" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki PRN na MHT? Programiści Python mogą łatwo załadować i przekonwertować PRN na MHT w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji PRN na MHT" %}}
