---
title: Converteer XLTM naar HTML via Java 
weight: 2930
url: /nl/java/conversion/xltm-to-html/ 
description: Voorbeeld Java conversiecode voor XLTM-indeling naar HTML-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar HTML te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLTM naar HTML via Java" h2="XLTM naar HTML Java-conversie om enkele of meerdere pagina\'s naar HTML te converteren met behulp van een lokale Java-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="XLTM naar HTML converteren met Java" %}}

 Om XLTM naar HTML te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLTM naar HTML te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen XLTM-bestanden eenvoudig in slechts een paar regels code naar HTML converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad XLTM-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef het uitvoerpad door met de HTML-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende HTML-bestand
...
{{% blocks/products/pf/agp/code-block title="XLTM naar HTML Java Conversiebroncode" offSpacer="" %}}

```cs
// laad het XLTM-bestand in een exemplaar van Workbook
Workbook book = new Workbook("template.xltm");
// sla XLTM op als HTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLTM naar HTML-conversie Live demo\'s" sectionDescription="[Converteer XLTM naar HTML](https://products.aspose.app/cells/conversion/xltm-to-html) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw XLTM-bestand, het wordt direct geconverteerd naar HTML." >}}
