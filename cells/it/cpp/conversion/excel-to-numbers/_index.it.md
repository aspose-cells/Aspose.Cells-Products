...
Hai bisogno di convertire i file EXCEL in NUMBERS tramite codice? Gli sviluppatori di C++ possono convertire facilmente i file EXCEL in NUMBERS in poche righe di codice.
...
1.  Converti EXCEL in NUMERI chiamando il metodo Save().
