---
title: PHP HTM-TXT - HTM-TXT konvertáló
description: Aspose Excel. A HTM-et gyorsan és egyszerűen konvertálja TXT-re a Aspose.Cells-gyel. PHP HTM-et TXT-re. PHP HTM mentése TXT-re. HTM mentése TXT-re PHP használatával.
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet HTM-et konvertálni TXT-re PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A HTM-fájlokat programozottan TXT-re kell konvertálni? A PHP fejlesztői könnyedén betölthetik és konvertálhatják a HTM-et TXT-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a HTM-et TXT-re a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a HTM konverziós eredményét TXT-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a HTM konvertálásához TXT-re" %}}
