...
L'esempio seguente illustra come unire XML in SPREADSHEETML in Aspose.Cells for C++.
...
{{% cells-merger title="Codice di esempio per unire XML in SPREADSHEETML in C++" InputFormat="xml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Come unire XML in SPREADSHEETML tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 È necessario unire XML in SPREADSHEETML a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria C++ per unire XML in SPREADSHEETML" %}}
