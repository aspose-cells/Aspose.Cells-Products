---
title: Konwertuj XLSB na XLSX przez C#
url: /pl/net/conversion/xlsb-to-xlsx/
description: Przykładowy kod konwersji xlsb do xlsx C#. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji xlsx w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na XLSX przez C#" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu XLSX na platformach .NET Framework, .NET Core, Mono lub Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki XLSB na XLSX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLSX jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku XLSX
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSB na XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlsx" IsLandingPage="true" %}}
