---
title:  ใส่ปุ่มหมุน (ตัวควบคุมฟอร์ม) ลงใน Excel ผ่าน Python
weight: 40
description: ซอร์สโค้ด Python เพื่อแทรกปุ่มหมุน (ตัวควบคุมฟอร์ม) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกปุ่มหมุน (ตัวควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการใส่ Spin Button (Form control) ลงในไฟล์ Excel ผ่าน Python" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกปุ่มหมุน (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่ปุ่มหมุน (ตัวควบคุมแบบฟอร์ม) - Python" offSpacer="" %}}
