---
title: 從XLSB文件via .NET中擷取文字與影像
weight: 2200
description: C# 原始碼，用於從 .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 XLSB 檔案中提取文字和映像。
...
{{< blocks/products/pf/i18n/upper-banner h1="解析 C# 中的 XLSB 格式" h2="使用伺服器端 Aspose.Cells for .NET API 進行本機高效能 XLSB 文件解析，無需使用 Microsoft 或 Adobe PDF 等任何軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
為了解析 XLSB 文件，我們將使用[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API這是一個功能豐富、強大且易於使用的文件操作API，適用於C#平台。打開[NuGet](https://www.nuget.org/packages/aspose.cells)套件管理器，搜尋**Aspose.Cells**並安裝。您也可以從套件管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="解析C#中的XLSB檔案的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="解析 XLSB 檔案 - C#" offSpacer="" %}}
