...
{{< blocks/products/pf/i18n/upper-banner h1="Extrahovat XLSX metadata prostřednictvím C++" h2="Sestavte si své vlastní aplikace C++ a přidávejte, upravujte, odebírejte nebo extrahujte metadata ze souborů XLSX pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak získat XLSX metadata pomocí C++" %}}
