...
weight: 1360
description: C# 源代碼結合 .NET 框架、.NET 核心、Mono 或 Xamarin 平台上的 TSV 文檔。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C# 中合併 TSV 格式" h2="本機和高性能 TSV 使用服務器端 Aspose.Cells for .NET API 的文檔合併，無需使用任何軟件，如 Microsoft 或 Open Office，Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
為了合併 TSV 文件，我們將使用[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API是一款功能豐富、功能強大且易於使用的文檔操作和合併API for C#平台。打開[NuGet](https://www.nuget.org/packages/aspose.cells)包管理器，搜索**Aspose.Cells**並安裝。您也可以從包管理器控制台使用以下命令。
...
+ 製作一個文件作為基礎文件
逐一調用拼接合併文件的相關方法。
+ 調用 Save() 方法並將文件名（完整路徑）和格式 (TSV) 作為參數傳遞。
...
{{< blocks/products/pf/agp/demobox sectionTitle="在線 TSV 合併現場演示" sectionDescription="立即訪問我們的合併 TSV 文件[現場演示網站](https://products.aspose.app/cells/merger).現場演示有以下好處" >}}
