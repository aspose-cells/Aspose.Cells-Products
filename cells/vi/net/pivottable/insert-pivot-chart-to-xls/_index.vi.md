---
title: Chèn Biểu đồ Pivot trong các tệp Micorsoft Excel XLS qua C#
weight: 7690
description: C# Mã mẫu để tạo tài liệu XLS với biểu đồ trục. Sử dụng mã này để tạo các tệp Micorsoft Excel XLS với biểu đồ trục trong VB.NET, Asp.NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn Biểu đồ Pivot vào XLS Tài liệu qua C#" h2="Bản gốc và hiệu suất cao Microsoft Bảng tính Excel XLS với tính năng tạo Biểu đồ Pivot theo chương trình bằng cách sử dụng API .NET phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Tạo tệp MS Excel XLS với Biểu đồ Pivot động trong ứng dụng đang chạy thật dễ dàng. Để tạo tài liệu XLS với Pivot Chart từ đầu mà không yêu cầu MS Office, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Cách chèn Biểu đồ Pivot vào XLS qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Các nhà phát triển có thể dễ dàng chèn Biểu đồ Pivot trong bảng tính định dạng XLS trong khi chạy các ứng dụng báo cáo khác nhau để xử lý dữ liệu chỉ trong một vài dòng mã.
...
{{% blocks/products/pf/agp/code-block title="Chèn Pivot Chart vào XLS - C#" offSpacer="" %}}
