...
{{% blocks/products/pf/agp/content h2="Convertir XML en TIFF en utilisant Python" %}}
...
L'exemple suivant montre comment convertir XML en TIFF dans Python.
