---
title:  Συγχώνευση XLS σε ODS μέσω Python
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLS με το ODS στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLS με ODS σε απευθείας σύνδεση" InputFormat="xls" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
