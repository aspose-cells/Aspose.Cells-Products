---
title: Java XLS a ET - XLS a ET Convertitore
description: Aspose Excel. Converti XLS in ET in modo rapido e semplice con Aspose.Cells. Java XLS in ET. Java Salva XLS su ET. Salva XLS come ET utilizzando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertire XLS in ET in Java" h2="Libreria Java ad alta velocità per la conversione di XLS in ET. Questa è una soluzione software professionale per importare ed esportare XLS, ET e molti altri formati utilizzando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salva XLS su ET in Java" %}}

L'esempio seguente mostra come convertire XLS in ET in Java.
...
{{% blocks/products/pf/agp/content h2="Come convertire XLS in ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file XLS in ET a livello di codice? Gli sviluppatori di Java possono convertire facilmente XLS in ET in poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria Java per convertire XLS in ET" %}}
{{% blocks/products/pf/agp/text %}}
