...
description: Aspose اكسل. C++ أنشئ ملف SXC بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف SXC باستخدام C++. أنشئ SXC في C++. C++ SXC Creator.
...
1.  احفظ المصنف كملف .sxc باستخدام طريقة Save().
