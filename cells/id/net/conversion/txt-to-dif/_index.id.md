---
title: C# TXT hingga DIF - TXT hingga DIF Konverter
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi TXT ke format DIF, memungkinkan penyimpanan data TXT ke format DIF dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{% blocks/products/pf/agp/content h2="Simpan TXT ke DIF di C#" %}}

Contoh berikut menunjukkan cara mengkonversi TXT menjadi DIF di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi TXT menjadi DIF. Unggah file TXT Anda, lalu simpan sebagai file DIF. Untuk pembacaan TXT dan penulisan DIF Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran DIF akan sama dengan dokumen TXT asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi TXT menjadi DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="txt" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah TXT menjadi DIF melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file TXT ke DIF secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi TXT menjadi DIF hanya dalam beberapa baris kode.
...
1.  Konversikan TXT menjadi DIF dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi dari TXT menjadi DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# perpustakaan untuk mengkonversi TXT menjadi DIF" %}}
