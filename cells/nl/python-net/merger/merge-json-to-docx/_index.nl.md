...
url: /nl/python-net/merger/merge-json-to-docx/ 
...
Het volgende voorbeeld laat zien hoe u JSON kunt samenvoegen met DOCX in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u JSON programmatisch samenvoegen tot DOCX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
