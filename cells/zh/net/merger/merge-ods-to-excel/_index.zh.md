---
title: 合并 ODS 到 EXCEL - 将 ODS 合并到 C# 中的 EXCEL
url: /zh/net/merger/merge-ods-to-excel/ 
description: Aspose Excel。 C# Aspose.Cells。免费在线合并ODS到EXCEL保存格式。 C# 将ODS合并为EXCEL格式。将 ODS 合并到 C# 中的 EXCEL。 ODS 合并。
...
{{% blocks/products/pf/agp/content h2="免费在线将 ODS 合并为 C# 中的 EXCEL" %}}

下面的例子演示了如何将ODS合并到EXCEL中Aspose.Cells for .NET。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 ODS 合并到 EXCEL。上传文件，调用Workbook.Combine方法合并文件，然后保存到EXCEL文件。如果您在 C# 中开发代码，这会比听起来更简单。请参阅 C# 将 ODS 合并到 EXCEL 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线将ODS合并为C#中的EXCEL" InputFormat="ods" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 ODS 合并到 EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 ODS 合并到 EXCEL 中吗？基本文档合并和连接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET库将ODS合并到EXCEL" %}}
