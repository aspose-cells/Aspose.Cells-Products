...
{{% blocks/products/pf/agp/content h2="Hoe SXC naar XPS te converteren met Java" %}}

 Om SXC naar XPS te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om SXC naar XPS te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het SXC-bestand gemakkelijk converteren naar XPS in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het SXC-bestand met een instantie van de Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met XPS-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende XPS-bestand
...
{{% blocks/products/pf/agp/code-block title="SXC naar XPS JavaConversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC naar XPS conversie live demo\'s" sectionDescription="[Converteer SXC naar XPS](https://products.aspose.app/cells/conversion/sxc-to-xps) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw SXC-bestand, het wordt onmiddellijk geconverteerd naar XPS." >}}
