---
title: C# CSV 轉 XLS - 在線 CSV 轉 XLS 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 CSV 轉換為 XLS 保存格式。 C# CSV 到 XLS 格式。將 CSV 保存為 XLS C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 CSV 轉換為 C# 中的 XLS" h2="高速C#庫，用於將CSV轉換為XLS。這是一個專業的軟件解決方案，可在.NET Framework、.NET Core或Mono平台上導入和導出CSV、XLS和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線保存 CSV 至 XLS 於 C#" %}}

以下示例演示如何將 C# 中的 CSV 轉換為 XLS。
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 CSV 轉換為 XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 CSV 轉換為 XLS" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 CSV 文件轉換為 XLS 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 CSV 到 XLS。
