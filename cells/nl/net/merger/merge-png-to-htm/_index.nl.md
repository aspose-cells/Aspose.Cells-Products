...
url: /nl/net/merger/merge-png-to-htm/ 
...
Het volgende voorbeeld laat zien hoe u PNG kunt samenvoegen met HTM in Aspose.Cells for .NET.
...
Wilt u PNG programmatisch samenvoegen met HTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen met HTM" %}}
