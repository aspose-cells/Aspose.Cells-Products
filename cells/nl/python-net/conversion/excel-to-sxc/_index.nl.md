...
Het volgende voorbeeld laat zien hoe u EXCEL converteert naar SXC in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe EXCEL naar SXC te converteren" %}}
