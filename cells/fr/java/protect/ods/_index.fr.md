---
title:  Protéger et verrouiller le document ODS via Java
weight: 6360
description: Exemple de code Java pour verrouiller le fichier ODS à l'aide d'un mot de passe sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
...
1.  Chargez le fichier ODS en instanciant la classe Workbook
