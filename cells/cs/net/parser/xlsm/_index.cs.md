...
{{% blocks/products/pf/agp/content h2="Jak analyzovat soubor XLSM pomocí C#" %}}
 ...
 Abychom mohli analyzovat soubor XLSM, použijeme[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API, což je funkčně bohatá, výkonná a snadno použitelná manipulace s dokumenty API pro platformu C#. OTEVŘENO[NuGet](https://www.nuget.org/packages/aspose.cells) správce balíčků, vyhledejte
