...
url: /ja/python-java/merger/merge-xltx-to-xlsb/ 
...
次の例は、Aspose.Cells for Python via Java で XLTX を XLSB にマージする方法を示しています。
...
XLTXをXLSBにプログラムで結合する必要がありますか？基本的な文書の結合と連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
