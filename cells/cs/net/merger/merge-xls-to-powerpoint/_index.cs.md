---
title: Sloučit XLS do POWERPOINT - Sloučit XLS do POWERPOINT v C#
url: /cs/net/merger/merge-xls-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Bezplatné online sloučení XLS do formátu uložení POWERPOINT. C# Spojte XLS do formátu POWERPOINT. Sloučit XLS do POWERPOINT v C#. XLS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLS do POWERPOINT v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLS do POWERPOINT v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLS do POWERPOINT. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru POWERPOINT. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí XLS do POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XLS do POWERPOINT v C#" InputFormat="xls" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLS do POWERPOINT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit XLS do POWERPOINT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu ke sloučení XLS do POWERPOINT" %}}
