---
title: Konwertuj XLSB na MHTML za pomocą aplikacji C++ 
weight: 1250
url: /pl/cpp/conversion/xlsb-to-mhtml/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSB do formatu MHTML. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSB na MHTML w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSB na MHTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (MHTML).1. Plik MHTML zostanie zapisany pod określoną ścieżką.1. Otwórz plik MHTML w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLSB do MHTML C++" offSpacer="" %}}
