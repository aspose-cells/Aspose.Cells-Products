...
Poniższy przykład pokazuje, jak scalić OTS z MHTML w Aspose.Cells for .NET.
...
Chcesz programowo połączyć OTS z numerem MHTML? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia OTS z MHTML" %}}
