...
weight: 5090
description: C++ 示例代码，用于在 TXT 文件中使用模式搜索单词，适用于 C++ 运行时环境，支持 Windows 32 位、Windows 64 位和 Linux 64 位。
...
{{% blocks/products/pf/agp/code-block title="搜索文件 TXT - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="在线 TXT 搜索实时演示" sectionDescription="立即访问我们的网站，搜索编号为 TXT 的文档中的文本、单词和短语。[现场演示网站](https://products.aspose.app/cells/search)现场演示有以下好处" >}}
...
扩展名为 .TXT 的文件是一个文本文件，其中包含以行形式排列的纯文本。文本文件中的段落通过回车符来识别，用于更好地组织文件内容。标准的文本文件可以在不同操作系统上的任何文本编辑器或文字处理应用程序中打开。此类文件中包含的所有文本都采用人类可读的格式，并以字符序列的形式表示。
