...
description: Aspose Excel. Převeďte MHTML na IMAGE rychle a snadno pomocí Aspose.Cells. PHP MHTML na IMAGE. PHP Uložit MHTML do IMAGE. Uložte MHTML jako IMAGE pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na IMAGE přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory na IMAGE programově? Vývojáři PHP mohou snadno načíst a převést MHTML na IMAGE v několika řádcích kódu.
...
1.  Převeďte MHTML na IMAGE voláním metody uložení sešitu.
