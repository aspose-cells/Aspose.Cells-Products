...
{{% blocks/products/pf/agp/content h2="How to Insert CheckBox(Form control) into Excel File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert CheckBox(Form control) to Excel file via Python" %}}
...
+  Use the shapecollection's [add method](https://apireference.aspose.com/cells/java/com.aspose.cells/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) to insert a CheckBox(Form control) in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert CheckBox(Form control) - Python" offSpacer="" %}}
