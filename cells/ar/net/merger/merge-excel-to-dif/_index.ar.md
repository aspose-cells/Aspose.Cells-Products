---
title: دمج EXCEL في DIF - ادمج EXCEL في DIF في C#
url: /ar/net/merger/merge-excel-to-dif/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني عبر الإنترنت EXCEL إلى تنسيق حفظ DIF. C# ادمج EXCEL بتنسيق DIF. دمج EXCEL في DIF في C#. EXCEL Merge.
...
{{% blocks/products/pf/agp/content h2="قم بدمج EXCEL في DIF في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج EXCEL مع DIF في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج EXCEL في DIF. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف DIF. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج EXCEL مع DIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج EXCEL في DIF في C#" InputFormat="xlsx" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج EXCEL في DIF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج EXCEL مع DIF برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
