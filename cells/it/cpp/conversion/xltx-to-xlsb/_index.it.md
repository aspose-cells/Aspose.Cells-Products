---
title: Converti XLTX in XLSB tramite l'applicazione C++ 
url: /it/cpp/conversion/xltx-to-xlsb/ 
description: Esempio di codice di conversione C++ per un documento XLTX in formato XLSB. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLTX a XLSB all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire XLTX in XLSB utilizzando C++" %}}

 Per convertire XLTX in XLSB, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire XLTX in XLSB tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente file XLTX in XLSB in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLTX usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XLSB).1. Il file XLSB verrà salvato nel percorso specificato.1. Apri il file XLSB in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLTX a XLSB C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live di conversione da XLTX a XLSB" sectionDescription="[Converti XLTX in XLSB](https://products.aspose.app/cells/conversion/xltx-to-xlsb) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file XLTX, verrà convertito istantaneamente in XLSB." >}}
