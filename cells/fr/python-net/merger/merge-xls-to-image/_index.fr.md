---
title: Fusionner XLS avec IMAGE - Combiner XLS avec IMAGE dans Python
url: /fr/python-net/merger/merge-xls-to-image/ 
description: Aspose Exceller. Python Aspose.Cells. Fusionner XLS au format de sauvegarde IMAGE. Python Combinez XLS au format IMAGE. Fusionner XLS avec IMAGE dans Python. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS avec IMAGE en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS avec IMAGE dans Python" %}}

L'exemple suivant montre comment fusionner XLS avec IMAGE dans Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLS avec IMAGE. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier IMAGE. Si vous développez du code en Python, ce sera plus simple qu'il n'y paraît. Voir l'exemple Python qui fusionne XLS avec IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner XLS avec IMAGE dans Python" InputFormat="xls" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS avec IMAGE via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLS avec IMAGE par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner XLS avec IMAGE" %}}
