...
description: Aspose Эксель. C++ Создайте файл GIF быстро и легко с помощью Aspose.Cells. Создайте файл GIF с помощью C++. Создайте GIF в C++. C++ GIF Creater.
...
1.  Сохраните книгу как файл .gif, используя метод Save().
