---
title: Konwertuj XLT na TABDELIMITED przez Java 
url: /pl/java/conversion/xlt-to-tabdelimited/ 
description: Przykładowy kod konwersji Java dla formatu XLT do pliku TABDELIMITED. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do TABDELIMITED w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLT na TABDELIMITED przez Java" h2="Konwersja XLT do TABDELIMITED Java w celu konwersji jednej lub wielu stron do TABDELIMITED przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na TABDELIMITED za pomocą Java" %}}

 Aby wyrenderować XLT do TABDELIMITED, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na TABDELIMITED przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik XLT na TABDELIMITED w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem TABDELIMITED i SaveFormat jako parametrami1. Sprawdź podaną ścieżkę dla wynikowego pliku TABDELIMITED
...
{{% blocks/products/pf/agp/code-block title="XLT do TABDELIMITED Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik XLT w instancji Workbook
Workbook book = new Workbook("template.xlt");
// zapisz XLT jako TABDELIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z wersji XLT na TABDELIMITED" sectionDescription="[Konwertuj XLT na TABDELIMITED](https://products.aspose.app/cells/conversion/xlt-to-tabdelimited) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLT, zostanie on natychmiast przekonwertowany na TABDELIMITED." >}}
