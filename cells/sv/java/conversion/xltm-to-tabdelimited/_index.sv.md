---
title: Konvertera XLTM till TABDELIMITED via Java 

description: Exempel på konverteringskod för Java för XLTM-format till TABBDELLIMITED-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till TABDELIMITED inom vilken webb- eller skrivbordsbaserad app som helst Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLTM till TABDELIMITED via Java" h2="XLTM till TABDELIMITED Java-konvertering för att konvertera enstaka eller flera sidor till TABDELIMITED med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLTM till TABDELIMITED med Java" %}}

 För att rendera XLTM till TABDELIMITED kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLTM till TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLTM-filen till TABDELLIMITED på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTM-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med TABBDELIMITED-tillägget & SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande TABDELIMITED-filen
...
{{% blocks/products/pf/agp/code-block title="XLTM till TABBDELIMITED Java konverteringskällkod" offSpacer="" %}}

```cs
// ladda XLTM-filen i en instans av Workbook
Workbook book = new Workbook("template.xltm");
// spara XLTM som TABDELLIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLTM till TABBDELIMITED Konvertering Live Demos" sectionDescription="[Konvertera XLTM till TABDELIMITED](https://products.aspose.app/cells/conversion/xltm-to-tabdelimited) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din XLTM-fil, den konverteras omedelbart till TABDELIMITED." >}}
