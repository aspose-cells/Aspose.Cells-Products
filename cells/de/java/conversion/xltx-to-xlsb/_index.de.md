---
title: Konvertieren Sie XLTX in XLSB über Java 
weight: 2460

description: Beispiel-Umwandlungscode Java für das XLTX-Format in die XLSB-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in XLSB innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLTX in XLSB über Java" h2="XLTX-zu-XLSB-Java-Konvertierung zum Konvertieren einzelner oder mehrerer Seiten in XLSB mithilfe der lokalen Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLTX in XLSB mit Java" %}}

 Um XLTX in XLSB zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von XLTX in XLSB über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können XLTX-Dateien in nur wenigen Codezeilen einfach in XLSB konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. XLTX-Datei mit einer Instanz der Workbook-Klasse laden1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit XLSB-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende XLSB-Datei
...
{{% blocks/products/pf/agp/code-block title="XLTX-zu-XLSB-Java-Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die XLTX-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.xltx");
// Speichern Sie XLTX als XLSB
