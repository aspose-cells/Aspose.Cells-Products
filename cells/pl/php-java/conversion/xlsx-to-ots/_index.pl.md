...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSX na OTS za pomocą Aspose.Cells. PHP XLSX na OTS. PHP Zapisz XLSX w OTS. Zapisz XLSX jako OTS przy użyciu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na OTS przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSX na OTS? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na OTS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSX na OTS, wywołując metodę zapisu skoroszytu.
