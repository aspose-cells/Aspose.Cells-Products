---
title: Konvertor PHP XLAM až TXT - XLAM až TXT
description: Aspose Excel. Převeďte XLAM na TXT rychle a snadno pomocí Aspose.Cells. PHP XLAM na TXT. PHP Uložte XLAM na TXT. Uložte TXT jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="txt" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na TXT přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na TXT programově? Vývojáři PHP mohou snadno načíst a převést XLAM na TXT v několika řádcích kódu.
...
1.  Převeďte XLAM na TXT voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na TXT" %}}
