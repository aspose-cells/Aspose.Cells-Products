---
title: Gộp OTS thành FODS - Gộp OTS thành FODS trong Java
url: /vi/java/merger/merge-ots-to-fods/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí OTS thành FODS định dạng lưu. Java Kết hợp định dạng OTS thành FODS. Hợp nhất OTS thành FODS trong Java. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS với FODS trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất OTS thành FODS trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất OTS thành FODS. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp, sau đó lưu vào tệp FODS. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất OTS thành FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất OTS thành FODS trong Java" InputFormat="ots" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS thành FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất OTS với FODS theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất OTS thành FODS" %}}
