---
title: Fusionar PRN con WORD - Combinar PRN con WORD en Java
url: /es/java/merger/merge-prn-to-word/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea de PRN a formato de guardado de WORD. Java Combina PRN con formato WORD. Combinar PRN con WORD en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN con WORD en Java en línea de forma gratuita" %}}

El siguiente ejemplo muestra cómo fusionar PRN con WORD en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar PRN con WORD. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo WORD. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona PRN con WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar PRN a WORD en Java" InputFormat="prn" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN con WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar PRN con WORD mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para combinar PRN con WORD" %}}
