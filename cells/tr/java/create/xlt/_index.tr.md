...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde XLT Dosyası oluşturun. Java'i kullanarak XLT dosyası oluşturun. Java'de XLT oluşturun. Java XLT Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını XLT biçiminde kaydedin.
