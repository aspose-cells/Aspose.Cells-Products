---
title: PHP XLTM إلى XPS - XLTM إلى XPS محول
description: Aspose اكسل. قم بتحويل XLTM إلى XPS بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى XPS. PHP احفظ XLTM إلى XPS. احفظ XLTM كـ XPS باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى XPS عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى XPS برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى XPS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى XPS عن طريق استدعاء طريقة حفظ المصنف.
