...
description: Aspose Excel. Converta XLTX em OTS de forma rápida e fácil com Aspose.Cells. PHP XLTX em OTS. PHP Salve XLTX em OTS. Salve XLTX como OTS usando PHP.
...
Precisa converter arquivos XLTX para OTS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em OTS em apenas algumas linhas de código.
...
1.  Converta XLTX em OTS chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de XLTX para OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter XLTX para OTS" %}}
