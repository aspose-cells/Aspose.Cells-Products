...
È necessario convertire i file PRN in PDF a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in PDF in poche righe di codice.
...
1.  Converti PRN in PDF chiamando il metodo Save().
