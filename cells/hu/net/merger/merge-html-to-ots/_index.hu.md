---
title: A HTML egyesítése az OTS-hez - A HTML-es szám egyesítése az OTS-hez a C#-ben
url: /hu/net/merger/merge-html-to-ots/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés HTML OTS mentési formátumba. C# A HTML kombinálása OTS formátumba. A HTML egyesítése az OTS-hez a C#-ben. HTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a HTML-es számot az OTS-hez a C#-es online ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a HTML-et az OTS-szel a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML OTS-be olvasztásához. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el OTS-fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a HTML-et az OTS-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTML egyesítéséhez az OTS-hez a C#-ben" InputFormat="html" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTML egyesítése az OTS-hez a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a HTML-et az OTS-hez? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML OTS-hez való egyesítéséhez" %}}
