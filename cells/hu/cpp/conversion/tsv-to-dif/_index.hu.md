...
{{< blocks/products/pf/i18n/upper-banner h1="TSV konvertálása DIF-re a következőn keresztül: C++" h2="Nagy teljesítményű TSV-DIF konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják a TSV-fájlt DIF-re.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a TSV-fájlt a Factory::CreateIWorkbook használatával.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (DIF) fájlkiterjesztéssel.1. A DIF fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a DIF fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="TSV a DIF C++ konverziós forráskódra" offSpacer="" %}}
