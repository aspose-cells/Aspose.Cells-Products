---
title: C# XLSX hingga PNG - XLSX hingga PNG Konverter
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi XLSX ke format PNG, memungkinkan penyimpanan data XLSX ke format PNG dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke PNG di C#" %}}

Contoh berikut menunjukkan cara mengkonversi XLSX menjadi PNG di C#.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah XLSX menjadi PNG melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke PNG secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX menjadi PNG hanya dalam beberapa baris kode.
...
1.  Konversikan XLSX menjadi PNG dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi dari XLSX menjadi PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# perpustakaan untuk mengkonversi XLSX menjadi PNG" %}}
