...
تحتاج إلى تحويل SXC ملفات إلى XLT برمجيا؟ يمكن للمطورين C++ تحويل SXC إلى XLT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول SXC إلى XLT باستدعاء طريقة Save ().
