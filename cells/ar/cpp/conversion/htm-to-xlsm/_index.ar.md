---
title: C++ HTM إلى XLSM - محول HTM عبر الإنترنت إلى XLSM
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل HTM إلى XLSM saveformat. C++ HTM إلى تنسيق XLSM. احفظ HTM في XLSM C++.
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في XLSM في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات HTM إلى XLSM برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى XLSM في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى XLSM باستدعاء طريقة Save ().
