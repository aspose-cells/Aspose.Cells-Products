---
title: Fusionner les fichiers XLTX via Java 
weight: 680
url: /fr/java/merger/xltx/ 
description: Java Exemple de code pour combiner des documents XLTX sur Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats XLTX dans Java" h2="Fusion de documents XLTX native à l\'aide d\'API Java côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner des fichiers XLTX à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers XLTX dans Java" %}}
...
+ Chargez le premier fichier XLTX avec une instance de la classe Workbook.
+ Chargez le deuxième document XLTX avec une instance de la classe Workbook.
+ Fusionner des fichiers en utilisant la méthode combine().
+ enregistrer le fichier XLTX fusionné au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers XLTX - Java" offSpacer="" %}}

```cs
// Ouvrez le premier fichier XLTX.
Workbook xltxFile1 = new Workbook("chartsFileWithPath.xltx");

// Définissez le deuxième livre source.
// Ouvrez le deuxième fichier XLTX.
