---
title: จัดกลุ่มและยกเลิกการจัดกลุ่มรูปร่างใน Excel โดยใช้ Python via .Net
weight: 360
description: จัดกลุ่มและยกเลิกการจัดกลุ่มวัตถุโดยใช้ Aspose.Cells' Python via .Net API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF เป็นต้น
...
{{% blocks/products/pf/agp/content h2="วิธีจัดกลุ่มและยกเลิกการจัดกลุ่มรูปร่างในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการจัดกลุ่มและยกเลิกการจัดกลุ่มรูปร่างในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[วิธีการแบบกลุ่ม](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/group/) เพื่อจัดกลุ่มรูปร่างในแผ่นงานที่เลือก
 + ใช้[วิธีการยกเลิกการจัดกลุ่ม](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/ungroup/) เพื่อยกเลิกการจัดกลุ่มรูปร่างในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="จัดกลุ่มและยกเลิกการจัดกลุ่มรูปร่าง - Python via .Net via .NET" offSpacer="" %}}
