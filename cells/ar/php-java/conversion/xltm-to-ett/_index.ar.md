---
title: PHP XLTM إلى ETT - XLTM إلى ETT المحول
description: Aspose اكسل. قم بتحويل XLTM إلى ETT بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى ETT. PHP احفظ XLTM في ETT. احفظ XLTM كـ ETT باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى ETT عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى ETT برمجياً؟ يمكن لمطوري PHP تحميل XLTM وتحويله بسهولة إلى ETT في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل XLTM إلى ETT عن طريق استدعاء طريقة حفظ المصنف.
