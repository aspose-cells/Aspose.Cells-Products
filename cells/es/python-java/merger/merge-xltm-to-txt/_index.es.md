---
title: Combinar XLTM a TXT - Combinar XLTM a TXT en Python
url: /es/python-java/merger/merge-xltm-to-txt/ 
description: AsposeExcel. Python Aspose.Cells. Combinar gratis en línea XLTM a TXT guardar formato. Python Combina el formato XLTM con el TXT. Combinar XLTM a TXT en Python. XLTM Combinar.
...
El siguiente ejemplo muestra cómo combinar XLTM con TXT en Aspose.Cells for Python via Java.
...
{{% cells-merger title="Gratis en línea para fusionar XLTM a TXT en Python" InputFormat="xltm" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLTM a TXT a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLTM con TXT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Las API se pueden hacer con solo unas pocas líneas de código.
