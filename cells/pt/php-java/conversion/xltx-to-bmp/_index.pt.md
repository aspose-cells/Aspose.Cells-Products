---
title: Conversor PHP XLTX para BMP - XLTX para BMP
description: Aspose Excel. Converta XLTX em BMP de forma rápida e fácil com Aspose.Cells. PHP XLTX em BMP. PHP Salve XLTX em BMP. Salve XLTX como BMP usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em BMP via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em BMP programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em BMP em apenas algumas linhas de código.
...
1.  Converta XLTX em BMP chamando o método save da pasta de trabalho.
