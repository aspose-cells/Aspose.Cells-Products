---
title:  سبليت XLS ملفات via Java
weight: 610
description: نموذج التعليمات البرمجية Java لتقسيم XLS مستندًا على Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تقسيم الملفات XLS في Java" %}}
...
+ استدعاء طريقة الحفظ بمسار الملف الجديد XLS.
