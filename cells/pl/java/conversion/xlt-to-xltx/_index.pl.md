---
title: Java XLT do XLTX - XLT do XLTX Konwerter
description: Aspose Excel. Konwertuj XLT na XLTX szybko i łatwo za pomocą Aspose.Cells. Java XLT na XLTX. Java Zapisz XLT na XLTX. Zapisz XLT jako 0761113 481 pod numerem Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT do XLTX w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XLT na XLTX w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer XLT na numer XLTX. Prześlij plik XLT, a następnie po prostu zapisz go jako plik XLTX. Zarówno do odczytu XLT, jak i do zapisu XLTX można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego XLTX będą identyczne z oryginalnym dokumentem XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLT na XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLT na XLTX? Programiści Java mogą łatwo przekonwertować XLT na XLTX w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLT na numer XLTX, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLT na XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji XLT na XLTX" %}}
{{% blocks/products/pf/agp/text %}}
