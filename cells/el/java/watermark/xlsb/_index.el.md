---
title: Υδατογράφημα εγγράφου XLSB μέσω Java 
weight: 5900
url: /el/java/watermark/xlsb/ 
description: Java δείγμα κώδικα για να προσθέσετε ή να αφαιρέσετε υδατογράφημα στο αρχείο XLSB στο Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Προσθήκη υδατογραφήματος κειμένου στο XLSB μέσω Java" h2="Δημιουργήστε τις δικές σας εφαρμογές Java για να υδατογραφήσετε αρχεία XLSB χρησιμοποιώντας API από την πλευρά του διακομιστή." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Τρόπος υδατογραφήματος αρχείου XLSB χρησιμοποιώντας το Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την προσθήκη υδατογραφήματος στο XLSB μέσω Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Δημιουργήστε ένα νέο αντικείμενο βιβλίου εργασίας1. Επιλέξτε Φύλλο εργασίας μέσω του ευρετηρίου του1. Δημιουργήστε ένα σχήμα και χρησιμοποιήστε τη λειτουργία addTextEffect1. Ορίστε χρώματα, Διαφάνεια και πολλά άλλα1. Αποθήκευση βιβλίου εργασίας σε μορφή XLSB
...
{{% blocks/products/pf/agp/code-block title="Προσθήκη υδατογραφήματος στο XLSB - Java" offSpacer="" %}}
