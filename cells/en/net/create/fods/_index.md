...
{{% blocks/products/pf/agp/text %}}
 ...
 It is easy for the developers to create, load, modify and convert FODS files within running different reporting applications for data processing in just a few lines of code.
...
1.  Use Save method to save the workbook as FODS file.
