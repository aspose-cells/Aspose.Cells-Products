---
title:  Odblokuj dokument XLSX poprzez C++
weight: 3680
description: C++ przykładowy kod do odblokowania chronionego hasłem pliku XLSX w C++ Środowisko wykonawcze dla Windows 32-bitowy, Windows 64-bitowy i Linux 64-bitowy.
...
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj pliki XLSX pod numerem C++" h2="Usuń ochronę z arkuszy kalkulacyjnych Excel, w tym pliku XLSX, korzystając z biblioteki C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak usunąć ochronę pliku XLSX przy użyciu C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Odblokuj XLSX pod numerem C++" %}}
