---
title: C# NOMBRES en PPTX - Convertisseur NOMBRES en PPTX
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les NUMBERS au format PPTX, permettant un enregistrement transparent des données NUMBERS au format PPTX à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros PPTX dans C#" %}}

L'exemple suivant montre comment convertir les NOMBRES de PPTX en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en PPTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en PPTX par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en PPTX en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en PPTX en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en PPTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en PPTX" %}}
