...
description: Aspose Unggul. Python Aspose.Cells. Gabungkan MHTML ke format penyimpanan XML. Python Gabungkan MHTML ke format XML. Gabungkan MHTML ke XML di Python. MHTML Gabungkan.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan MHTML ke XML di Python" InputFormat="mhtml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML ke XML melalui Python" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan MHTML ke XML secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API dapat dilakukan hanya dengan beberapa baris kode.
