---
title:  Tableau de documents XLSB vers images via .NET 
weight: 8560
url: /fr/net/chart/xlsb/ 
description: Code source C# pour dessiner et convertir un graphique ou un diagramme dans un fichier XLSB sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Graphiques de fichiers XLSB en images dans C#" h2="Conversion de tableaux de documents XLSB natifs et hautes performances en images à l\'aide d\'API côté serveur, sans l\'utilisation de logiciels tels que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir des graphiques XLSB en images à l\'aide de C#" %}}
 ...
 Pour convertir les cartes XLSB, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir des graphiques de fichiers XLSB dans C#" %}}
