...
description: Aspose Excel. Μετατρέψτε το XLTX σε TABDELIMITED γρήγορα και εύκολα με το Aspose.Cells. Python XLTX σε TABDELIMITED. Python Αποθήκευση XLTX στο TABDELIMITED. Αποθηκεύστε το XLTX ως TABDELIMITED χρησιμοποιώντας το Python.
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση XLTX στο TABDELIMITED στο Python" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή XLTX σε TABDELIMITED" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="tsv" IsLandingPage="true" language="pythonnet" %}}
