...
description: Aspose Эксель. Быстро и легко конвертируйте HTML в ET с помощью Aspose.Cells. Java HTML в ET. Java Сохраните HTML в ET. Сохраните HTML как ET, используя Java.
...
{{% blocks/products/pf/agp/content h2="Преобразуйте HTML в ET, используя Java" %}}
...
В следующем примере показано, как преобразовать HTML в ET в Java.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать HTML в ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно конвертировать файлы HTML в ET? Разработчики Java могут легко преобразовать HTML в ET всего за несколько строк кода.
