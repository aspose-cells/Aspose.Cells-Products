...
description: Aspose Excel。 C# Aspose.Cells。將XLT合併到EXCEL儲存格式。 C# 將XLT合併為EXCEL格式。將 XLT 合併到 C# 中的 EXCEL。XLT 合併。
...
{{% blocks/products/pf/agp/content h2="將 XLT 合併到 C# 中的 EXCEL" %}}

下面的範例示範如何將XLT合併到EXCEL中Aspose.Cells for .NET。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLT 合併到 EXCEL。上傳文件，呼叫Workbook.Combine方法合併文件，然後儲存到EXCEL文件。如果您在 C# 中開發程式碼，這會比聽起來更簡單。請參閱 C# 將 XLT 合併到 EXCEL 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 XLT 合併到 C# 中的 EXCEL 的範例程式碼" InputFormat="xlt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 XLT 合併到 EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 XLT 合併到 EXCEL 中嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
