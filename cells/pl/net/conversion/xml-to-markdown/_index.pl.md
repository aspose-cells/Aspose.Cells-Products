...
Chcesz programowo przekonwertować pliki XML na MARKDOWN? .NET programiści mogą łatwo załadować i przekonwertować XML na MARKDOWN w zaledwie kilku wierszach kodu.
...
1.  Konwertuj kod XML na MARKDOWN, wywołując metodę Workbook.Save.
