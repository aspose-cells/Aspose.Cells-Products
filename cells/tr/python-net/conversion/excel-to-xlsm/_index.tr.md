...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde EXCEL'i XLSM'e dönüştürün. Python EXCEL'i XLSM'e dönüştürün. Python EXCEL'i XLSM'e kaydedin. Python'i kullanarak EXCEL'i XLSM olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'de EXCEL\'i XLSM\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i Python\'de XLSM\'e kaydedin" %}}
...
{{% cells-convert title="EXCEL\'i XLSM\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xlsm" IsLandingPage="true" language="pythonnet" %}}
