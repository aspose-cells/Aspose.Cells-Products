---
title: Converti XLSB in XLSX tramite Java 
weight: 5700

description: Esempio di codice di conversione Java per il formato XLSB in file XLSX. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in XLSX all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLSB in XLSX tramite Java" h2="Conversione da XLSB a XLSX Java per convertire pagine singole o multiple in XLSX utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire XLSB in XLSX usando Java" %}}

 Per rendere XLSB a XLSX, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire XLSB in XLSX tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente file XLSB in XLSX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLSB con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione XLSX e SaveFormat come parametri1. Controllare il percorso specificato per il file XLSX risultante
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLSB a XLSX Java" offSpacer="" %}}

```cs
// caricare il file XLSB in un'istanza di Workbook
Workbook book = new Workbook("template.xlsb");
// salva XLSB come XLSX
