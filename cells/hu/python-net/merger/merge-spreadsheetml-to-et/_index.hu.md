...
url: /hu/python-net/merger/merge-spreadsheetml-to-et/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a SPREADSHEETML-t a Aspose.Cells for Python via .NET számú ET-vel.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a SPREADSHEETML-t az ET-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
