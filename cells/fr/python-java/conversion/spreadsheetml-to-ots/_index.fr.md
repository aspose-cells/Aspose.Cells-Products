---
title: Python SPREADSHEETML en OTS - Convertisseur SPREADSHEETML en OTS
description: Aspose Exceller. Python Exceller. Convertissez SPREADSHEETML en OTS rapidement et facilement avec Aspose.Cells. Python SPREADSHEETML en OTS. Python Enregistrez SPREADSHEETML dans OTS. Enregistrez SPREADSHEETML au format OTS à l'aide de la bibliothèque Excel Python.
...
{{% cells-convert title="Exemple de code pour convertir SPREADSHEETML en OTS via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="ots" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir SPREADSHEETML en OTS via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers SPREADSHEETML en OTS par programme ? Les développeurs Python peuvent facilement charger et convertir SPREADSHEETML en OTS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Python Bibliothèque Excel pour convertir SPREADSHEETML en OTS" %}}
