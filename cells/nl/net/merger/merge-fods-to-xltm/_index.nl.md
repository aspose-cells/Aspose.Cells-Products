...
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen FODS naar XLTM saveformat. C# Combineer het formaat FODS tot XLTM. Samenvoegen FODS tot XLTM in C#. FODS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg FODS samen met XLTM in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u FODS samenvoegt met XLTM in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om FODS samen te voegen met XLTM. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand XLTM. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat FODS samenvoegt met XLTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om FODS samen te voegen tot XLTM in C#" InputFormat="fods" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe FODS samen te voegen met XLTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u FODS programmatisch samenvoegen tot XLTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om FODS samen te voegen tot XLTM" %}}
