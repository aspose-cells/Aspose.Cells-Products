...
url: /pl/python-java/merger/merge-xlsb-to-mhtml/ 
...
Poniższy przykład pokazuje, jak połączyć XLSB z MHTML w Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć XLSB z MHTML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
