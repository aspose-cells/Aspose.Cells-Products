---
title: C# XLSM 转 FODS - 在线 XLSM 转 FODS 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 XLSM 转换为 FODS 保存格式。 C# XLSM 到 FODS 格式。将 XLSM 保存为 FODS C#。
...
{{% blocks/products/pf/agp/content h2="免费在线保存 XLSM 至 FODS 于 C#" %}}

以下示例演示如何将 C# 中的 XLSM 转换为 FODS。
...
{{% cells-convert title="免费应用程序和示例代码可在线将 XLSM 转换为 FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLSM 转换为 FODS" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 文件转换为 FODS 吗？ .NET 开发人员只需几行代码即可轻松加载和转换 XLSM 到 FODS。
...
{{% blocks/products/pf/agp/content h2="C#库将XLSM转换为FODS" %}}
