---
title: Unisci file TXT tramite Java 
weight: 4480

description: Java codice di esempio per combinare documenti TXT su Java Runtime Environment per applicazioni JSP/JSF e applicazioni desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci formati TXT in Java" h2="Fusione di documenti TXT nativi utilizzando API Java lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Come unire file TXT usando Java" %}}

 Per unire il file TXT, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'unione di file TXT in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Unisci file TXT - Java" offSpacer="" %}}

```cs
// Apri il primo file TXT.
Workbook txtFile1 = new Workbook("chartsFileWithPath.txt");

// Definisci il secondo libro di origine.
// Apri il secondo file TXT.
