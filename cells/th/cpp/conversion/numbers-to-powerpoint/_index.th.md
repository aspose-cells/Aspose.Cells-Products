...
ต้องการแปลงไฟล์ NUMBERS เป็น POWERPOINT ด้วยโปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลง NUMBERS เป็น POWERPOINT ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงตัวเลขเป็นรูปแบบ PowerPoint โดยเรียกใช้เมธอด Save()
