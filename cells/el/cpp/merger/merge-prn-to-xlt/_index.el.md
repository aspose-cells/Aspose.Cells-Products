---
title:  Συγχώνευση PRN στο XLT μέσω C++
url: /el/cpp/merger/merge-prn-to-xlt/ 
description: Συγχώνευση PRN στο XLT Online δωρεάν. Δωρεάν online PRN to XLT Merger. Συγχώνευση PRN σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN στο XLT στο C++.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση του PRN με το XLT σε απευθείας σύνδεση" InputFormat="prn" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
