---
title: PHP XLAM'den PRN'ye - XLAM'den PRN'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile XLAM'i hızlı ve kolay bir şekilde PRN'ye dönüştürün. PHP XLAM'i PRN'ye dönüştürün. PHP XLAM'i PRN'ye kaydedin. PHP kullanarak XLAM'i PRN olarak kaydedin.
...
{{% cells-convert title="XLAM\'i PRN\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="prn" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLAM\'i PRN\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLAM dosyalarını program aracılığıyla PRN'ye dönüştürmeniz mi gerekiyor? PHP geliştiricileri yalnızca birkaç satır kodla XLAM'i kolayca yükleyebilir ve PRN'ye dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLAM'i PRN'ye dönüştürün.
1.  XLAM'in PRN'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLAM\'i PRN\'ye dönüştürmek için PHP kütüphanesi" %}}
