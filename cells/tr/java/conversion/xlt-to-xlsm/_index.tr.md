---
title: Java aracılığıyla XLT'yi XLSM'ye dönüştürün 
url: /tr/java/conversion/xlt-to-xlsm/ 
description: XLT biçimi için XLSM dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada XLSM'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla XLT\'yi XLSM\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı XLSM\'ye dönüştürmek için XLT\'den XLSM\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak XLT\'yi XLSM\'ye Dönüştürme" %}}

 XLT'yi XLSM'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla XLT\'yi XLSM\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla XLT dosyasını kolayca XLSM'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. XLT dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. XLSM uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan XLSM dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="XLT\'den XLSM\'ye Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// XLT dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.xlt");
// XLT'yi XLSM olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLT\'den XLSM\'ye Dönüştürme Canlı Demoları" sectionDescription="[XLT\'yi XLSM\'ye Dönüştür](https://products.aspose.app/cells/conversion/xlt-to-xlsm) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece XLT dosyanızı yükleyin, anında XLSM\'ye dönüştürülecektir." >}}
