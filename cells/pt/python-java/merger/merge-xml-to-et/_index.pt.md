...
description: Aspose Excel. Python Aspose.Cells. Mesclar XML para saveformat ET. Python Combine XML com formato ET. Mesclar XML com ET em Python. Mesclar XML.
...
{{% blocks/products/pf/agp/content h2="Mesclar XML com ET usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar XML com ET em Python" %}}

exemplo a seguir demonstra como mesclar XML com ET em Aspose.Cells for Python via Java.
...
{{% cells-merger title="Exemplo de código para mesclar XML com ET em Python" InputFormat="xml" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XML com ET via Python" %}}
