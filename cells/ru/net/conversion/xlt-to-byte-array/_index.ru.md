...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Байтовый массив полезен для обработки или хранения данных. Вы можете преобразовать файл XLT в массив байтов, а также документ **массив байтов в документ XLT**, используя язык C#. Чтобы преобразовать XLT в массив байтов, мы будем использовать
...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчикам легко загружать и преобразовывать файлы XLT в массив байтов для дальнейших задач манипуляции всего за несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Включите пространство имен в свой файл класса1. Загрузить входной файл XLT с помощью рабочей книги1. Инициализировать объект MemoryStream1. Преобразование потоковых данных в массив байтов1. Обработка данных по вашему требованию
...
{{% blocks/products/pf/agp/code-block title="В этом примере кода показано преобразование XLT в байтовый массив C#" offSpacer="" %}}
