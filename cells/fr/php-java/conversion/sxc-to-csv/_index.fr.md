---
title: Convertisseur PHP SXC vers CSV - SXC vers CSV
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir le format SXC au format CSV, permettant ainsi un enregistrement transparent des données SXC au format CSV grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Comment convertir SXC en CSV via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers SXC en CSV par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers SXC en CSV en quelques lignes de code seulement.
...
1.  Convertissez SXC en CSV en appelant la méthode save de Workbook.
1.  Obtenez le résultat de la conversion de SXC en CSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir SXC en CSV" %}}
