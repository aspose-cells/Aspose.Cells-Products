...
description: Aspose 엑셀. Aspose.Cells을 사용하여 NUMBERS를 Aspose.Cells로 빠르고 쉽게 변환합니다. Python NUMBERS를 SVG로 변환합니다. Python NUMBERS를 SVG로 저장합니다. Python을 사용하여 NUMBERS를 SVG로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="Python에 NUMBERS를 SVG에 저장하세요." %}}

다음 예에서는 Python via NET에서 NUMBERS를 SVG로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="NUMBERS를 SVG로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="svg" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="NUMBERS를 SVG로 변환하는 Python 라이브러리" %}}
