---
title: C++ MHT إلى ET - تحويل MHT إلى ET
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل تنسيق MHT إلى تنسيق ET، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق ET باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى ET في C++" %}}

يوضح المثال التالي كيفية تحويل MHT إلى ET في C++.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى ET عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى ET برمجيًا؟ يمكن للمطورين (C++) تحويل ملفات MHT إلى ET بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل MHT إلى ET عن طريق استدعاء دالة Save().
1.  احصل على نتيجة تحويل MHT إلى ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة رقم C++ لتحويل MHT إلى ET" %}}
