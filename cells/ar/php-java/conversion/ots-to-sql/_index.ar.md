---
title: PHP OTS إلى SQL - OTS لتحويل SQL
description: Aspose اكسل. قم بتحويل OTS إلى SQL بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى SQL. PHP حفظ OTS إلى SQL. احفظ OTS بتنسيق SQL باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى SQL في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى SQL. يعد هذا حلاً برمجيًا احترافيًا لاستيراد وتصدير OTS وSQL والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى SQL عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى SQL برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى SQL في بضعة أسطر فقط من التعليمات البرمجية.
...
1. تحويل OTS إلى SQL عن طريق استدعاء طريقة حفظ المصنف.
