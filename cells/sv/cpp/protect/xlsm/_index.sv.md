...
{{% blocks/products/pf/agp/content h2="Så här säkrar du XLSM-fil med C++" %}}
...
1. Ladda XLSM-fil med IWorkbook-klassen1. Använd Protect(..)-metoden med ProtectionType och Password1. Spara den skyddade XLSM-filen med metoden Save().
