---
title: Fusionner IMAGE avec ODS - Combiner IMAGE avec ODS dans C++
url: /fr/cpp/merger/merge-image-to-ods/ 
description: Aspose Excel. C++ Aspose.Cells. IMAGE de fusion en ligne gratuite au format de sauvegarde ODS. C++ Combine IMAGE au format ODS. Fusionner IMAGE avec ODS dans C++. IMAGE Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner IMAGE avec ODS en C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner IMAGE avec ODS dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner IMAGE avec ODS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier ODS. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne IMAGE en ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner IMAGE avec ODS en C++" InputFormat="png" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner IMAGE avec ODS via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner IMAGE avec ODS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour fusionner IMAGE avec ODS" %}}
