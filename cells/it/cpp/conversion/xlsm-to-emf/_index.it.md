...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file XLSM in EMF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLSM usando Factory::CreateIWorkbook.1. Seleziona il primo foglio di lavoro.1. Impostare le opzioni (EMF).1. Scorri ogni pagina del foglio e renderizza.1. Apri il file EMF in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLSM a EMF C++" offSpacer="" %}}
