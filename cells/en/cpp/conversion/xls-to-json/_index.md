...
description: Sample C++ conversion code for XLS to JSON format. Programmers can use this source code for batch XLS to JSON conversion within any C++ Application.
---
