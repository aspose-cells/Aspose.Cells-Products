---
title: Réparer le fichier xls via C++
url: /fr/cpp/recovery/repair-xls/ 
description: Réparez un fichier xls corrompu à l'aide de C++. Outil de récupération pour réparer le fichier xls corrompu dans l'application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Récupérer le fichier XLS via C++" h2="Créez votre propre application C++ pour réparer les fichiers xls à l\'aide de C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment réparer le fichier xls en utilisant C++" %}}
...
{{% cells-recovery title="Application gratuite pour réparer le fichier XLS en utilisant C++" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="cpp" %}}    
