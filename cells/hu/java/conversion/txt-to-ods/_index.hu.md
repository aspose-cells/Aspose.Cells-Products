...
{{% blocks/products/pf/agp/content h2="TXT konvertálása ODS-vé a következővel: Java" %}}

 Ahhoz, hogy a TXT-t ODS-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TXT konvertálása ODS-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a TXT-fájlt ODS-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat ODS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott ODS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT to ODS Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése ODS-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT-ből ODS-be konvertáló élő bemutatók" sectionDescription="[Konvertálja a TXT-t ODS-vé](https://products.aspose.app/cells/conversion/txt-to-ods) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel TXT fájlját, és azonnal ODS formátumba konvertálódik." >}}
