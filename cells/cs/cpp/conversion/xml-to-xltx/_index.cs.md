...
{{% cells-convert title="Ukázkový kód pro převod XML na XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na XLTX přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XML na XLTX programově? Vývojáři C++ mohou snadno převést XML na XLTX pomocí několika řádků kódu.
...
1.  Převeďte XML na XLTX voláním metody Save().
