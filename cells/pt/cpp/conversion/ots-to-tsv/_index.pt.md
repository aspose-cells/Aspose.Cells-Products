...
description: Aspose Excel. Converta OTS para TSV de forma rápida e fácil com Aspose.Cells. C++ OTS para TSV. C++ Salve OTS em TSV. Salve OTS como TSV usando C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter OTS em TSV em C++" h2="Conversão de OTS para TSV de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converter OTS em TSV usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve OTS em TSV em C++" %}}

O exemplo a seguir demonstra como converter OTS em TSV em C++.
...
{{% cells-convert title="Exemplo de código para converter OTS em TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="tsv" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter OTS para TSV via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos OTS para TSV programaticamente? Os desenvolvedores C++ podem facilmente converter OTS em TSV em apenas algumas linhas de código.
...
1.  Converta OTS em TSV chamando o método Save().
