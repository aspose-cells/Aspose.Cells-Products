...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики C++ могут легко преобразовать XML в JSON всего за несколько строк кода.
