...
description: Aspose Excel. Konwertuj HTM na XLS szybko i łatwo za pomocą Aspose.Cells. Python HTM na XLS. Python Zapisz HTM na XLS. Zapisz HTM jako XLS, używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na XLS za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM pod numerem XLS w Python" %}}

Poniższy przykład ilustruje sposób konwersji HTM na XLS w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji HTM na XLS" %}}
