...
description: Aspose Excel'de. Python Excel'de. Aspose.Cells ile XLS'i hızlı ve kolay bir şekilde XML'e dönüştürün. Python XLS'i XML'e dönüştürün. Python XLS'i XML'e kaydedin. XLS'i Python Excel Kitaplığı'nı kullanarak XML olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="XLS\'i Python Excel Kitaplığını Kullanarak XML\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/content h2="XLS\'i Python Excel Kitaplığı\'ndaki XML\'e kaydedin" %}}

Aşağıdaki örnek, XLS excel kitaplığında XLS'in XML'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="Python XLS\'i XML\'e Dönüştürmek için Excel Kitaplığı" %}}
