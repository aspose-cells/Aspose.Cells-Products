---
title: Voeg XLSX samen met PRN - Combineer XLSX met PRN in Java
url: /nl/java/merger/merge-xlsx-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Voeg XLSX samen naar PRN-opslagformaat. Java Combineer XLSX naar PRN-formaat. Voeg XLSX samen met PRN in Java. XLSX Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u XLSX samenvoegt met PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSX samen te voegen met PRN" %}}
