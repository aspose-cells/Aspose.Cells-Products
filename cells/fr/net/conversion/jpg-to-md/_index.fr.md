---
title: C# Convertisseur JPG vers MD
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG en format MD, permettant un enregistrement transparent des données JPG au format MD à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG au format MD dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en MD en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir un fichier JPG en MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en MD par programmation ? Les développeurs de .NET peuvent facilement charger et convertir des fichiers JPG en MD en quelques lignes de code seulement.
...
1. Convertissez le format JPG en MD en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en MD" %}}
