...
description: Aspose Эксель. C++ Быстро и легко создайте файл ИЗОБРАЖЕНИЯ с помощью Aspose.Cells. Создайте файл ИЗОБРАЖЕНИЯ с помощью C++. Создайте ИЗОБРАЖЕНИЕ в C++. C++ IMAGE Creator.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчикам легко создавать, загружать, изменять и конвертировать файлы IMAGE в запущенных приложениях отчетности для обработки данных всего за несколько строк кода.
...
1.  Сохраните книгу как файл .png, используя метод Save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл IMAGE по номеру C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ библиотека для создания файла IMAGE" %}}
