...
description: Aspose एक्सेल। Aspose.Cells के साथ जल्दी और आसानी से EXCEL को GIF में बदलें। C# EXCEL को GIF में बदलें। C# EXCEL को GIF पर सेव करें। C# का उपयोग करके EXCEL को GIF के रूप में सेव करें।
...
{{% blocks/products/pf/agp/content h2="C# में EXCEL को GIF पर सेव करें" %}}
...
{{% cells-convert title="EXCEL को GIF में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="gif" IsLandingPage="true" %}}
