...
{{% blocks/products/pf/agp/content h2="보호를 제거하는 방법 XLSB Java을 사용하는 파일" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="잠금 해제 단계 XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  보호된 XLSB 파일에 대한 경로로 통합 문서 클래스 인스턴스화
...
{{% blocks/products/pf/agp/code-block title="C#을 통해 XLSB 파일 잠금 해제" offSpacer="" %}}
