...
{{% blocks/products/pf/agp/content h2="Insérer des notes dans le fichier XLSM à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python exemple de code pour insérer et supprimer des notes dans le fichier XLSM" offSpacer="" %}}
