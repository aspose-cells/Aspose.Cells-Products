...
{{% blocks/products/pf/agp/content h2="كيفية إدراج مخطط انسيابي في ملف Excel باستخدام Python via .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج مخطط انسيابي في ملف Excel عبر Python" %}}
...
{{% blocks/products/pf/agp/code-block title="أدخل مخطط التدفق - Python via .NET" offSpacer="" %}}
