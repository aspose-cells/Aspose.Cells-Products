---
title:  C++経由でODSドキュメントのロックを解除します
weight: 1190
description: C++ ランタイム環境 (Windows 32 ビット、Windows 64 ビット、および Linux 64 ビット) 上のパスワードで保護された ODS ファイルのロックを解除するための C++ サンプル コード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ 経由で ODS ファイルのロックを解除する" h2="C++ ライブラリを使用して、ODS ファイルを含む Excel スプレッドシートから保護を削除します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="C++を使用してODSファイルの保護を解除する方法" %}}
