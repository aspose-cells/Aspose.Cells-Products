...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке изображения в файл Excel с помощью Python via.Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение к коллекции изображений[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/)чтобы вставить изображение на выбранный лист.
