...
description: Aspose Excel. Converta SXC em OTS de forma rápida e fácil com Aspose.Cells. PHP SXC em OTS. PHP Salve SXC em OTS. Salve SXC como OTS usando PHP.
...
Precisa converter arquivos SXC para OTS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em OTS em apenas algumas linhas de código.
...
1.  Converta SXC em OTS chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de SXC para OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter SXC para OTS" %}}
