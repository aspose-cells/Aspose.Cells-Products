---
title: Konwertuj TXT na XLSM za pomocą aplikacji C++ 
url: /pl/cpp/conversion/txt-to-xlsm/ 
description: Przykładowy kod konwersji C++ dla dokumentu TXT do formatu XLSM. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TXT do XLSM w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TXT na XLSM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TXT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSM).1. Plik XLSM zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSM w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji TXT do XLSM C++" offSpacer="" %}}
