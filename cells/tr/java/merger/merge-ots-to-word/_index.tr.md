---
title: OTS'yi WORD'e Birleştir - Java'de OTS'yi WORD'e Birleştir
url: /tr/java/merger/merge-ots-to-word/ 
description: Aspose excel. Java Aspose.Cells. OTS'yi WORD kaydetme biçimine Ücretsiz Çevrimiçi Birleştirme. Java OTS'yi WORD biçimine birleştirin. Java'de OTS'yi WORD ile birleştirin. OTS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi WORD ile Java Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de OTS'nin WORD ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="Java\'de OTS\'yi WORD ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="ots" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi WORD via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

OTS'yi WORD ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
