---
title:  Tạo Báo cáo trong Tệp XLSX via .NET
weight: 6740
description: C# để tạo báo cáo định dạng XLSX trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
...
{{% blocks/products/pf/agp/content h2="Cách tạo Báo cáo dựa trên XLSX bằng C#" %}}
