---
title:  Slå samman ODS filer via C++
description: C++ exempelkod för att kombinera ODS dokument på C++ Runtime Environment för Windows 32 bitar, Windows 64 bitar och Linux 64 bitar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman ODS-format i C++" h2="ODS dokumentsammanslagning med C++ API:er på serversidan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man sammanfogar ODS-fil med C++" %}}

 För att slå samman ODS-filen kommer vi att använda<a href="https://products.aspose.com/cells/cpp">Aspose.Cells for C++</a> API som är en funktionsrik, kraftfull och lättanvänd dokumentsammanslagningsplattform API for C++. Du kan ladda ner den senaste versionen direkt, bara öppna<a href="https://www.nuget.org/packages/aspose.cells">NuGet</a> pakethanterare, sök efter<b>Aspose.Cells.Cpp</b> och installera. Du kan också använda följande kommando från Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att slå samman ODS filer i C++" %}}
...
{{% cells-merger title="Gratis app för att slå samman Excel-filer online" InputFormat="ods" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
