...
description: Aspose Exceller. Java Aspose.Cells. Fusionner HTML au format de sauvegarde XML. Java Combinez HTML au format XML. Fusionner HTML en XML dans Java. HTML Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTML en XML dans Java" %}}
...
{{% cells-merger title="Exemple de code pour fusionner HTML en XML dans Java" InputFormat="html" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTML en XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner HTML en XML par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner HTML en XML" %}}
