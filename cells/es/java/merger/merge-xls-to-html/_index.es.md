---
title:  Combinar XLS a HTML via Java
...
El siguiente ejemplo muestra cómo combinar XLS con HTML en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a HTML en línea" InputFormat="xls" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
