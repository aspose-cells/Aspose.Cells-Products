...
weight: 5670
description: JSP/JSF 애플리케이션 및 데스크탑 애플리케이션용 Java 런타임 환경에서 XLSM 문서를 분할하기 위한 Java 샘플 코드입니다.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API은 Microsoft Excel 형식을 다른 형식으로 생성, 편집, 변환 및 렌더링하는 데 사용할 수 있습니다. 또한 소프트웨어 애플리케이션 내에서 포괄적인 차트 작성, 확장 가능한 보고 및 신뢰할 수 있는 계산에 사용할 수 있습니다. Aspose.Cells은 독립형 API이며 Microsoft 또는 OpenOffice와 같은 소프트웨어가 필요하지 않습니다.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="온라인 XLSM 스플리터 라이브 데모" sectionDescription=" 지금 바로 당사를 방문하여 XLSM 문서를 분할하세요.[라이브 데모 웹사이트](https://products.aspose.app/cells/splitter). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
