---
title: Połącz NUMBERS z HTM - Połącz NUMBERS z HTM w Java
url: /pl/java/merger/merge-numbers-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. Scal NUMBERS do formatu zapisu HTM. Java Połącz NUMERY do formatu HTM. Scal NUMBERS z HTM w Java. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMBERS z HTM w Java" %}}

Poniższy przykład pokazuje, jak połączyć NUMBERS z HTM w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć NUMBERS z HTM. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku HTM. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMBERS z HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia NUMBERS z HTM w Java" InputFormat="numbers" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć NUMERY z HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć NUMBERS z HTM? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do scalania NUMBERS z HTM" %}}
