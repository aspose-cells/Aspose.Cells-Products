...
description: Aspose Excel. Chuyển đổi MHTML sang JPG nhanh chóng và dễ dàng với Aspose.Cells. Python MHTML sang JPG. Python Lưu MHTML sang JPG. Lưu MHTML dưới dạng JPG bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi MHTML sang JPG trong Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu MHTML sang JPG vào Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi MHTML sang JPG trong Python via NET.
...
{{% cells-convert title="Mã mẫu để chuyển đổi MHTML sang JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python để chuyển đổi MHTML sang JPG" %}}
