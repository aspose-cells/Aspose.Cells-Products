...
description: Aspose Excel. Převeďte JPEG na XLT rychle a snadno pomocí Aspose.Cells. Python JPEG na XLT. Python Ušetřete JPEG na 197 3481761 jako 197 348161 Python 481 pomocí Python.
...
{{% blocks/products/pf/agp/content h2="Převést JPEG na XLT na Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit JPEG až XLT v Python" %}}

Následující příklad ukazuje, jak převést JPEG na XLT v Python via NET.
...
{{% cells-convert title="Ukázkový kód pro převod JPEG na XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xlt" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod JPEG na XLT" %}}
