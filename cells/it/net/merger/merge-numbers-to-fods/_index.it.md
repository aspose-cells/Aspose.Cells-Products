---
title: Unisci i NUMERI a FODS - Combina i NUMERI a FODS in C#
url: /it/net/merger/merge-numbers-to-fods/ 
description: Aspose Excel. C# Aspose.Cells. Unisci i NUMERI al formato di salvataggio FODS. C# Combina i NUMERI nel formato FODS. Unisci i NUMERI a FODS in C#. NUMERI Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci i NUMERI a FODS in C#" %}}

L'esempio seguente mostra come unire NUMBERS in FODS in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire i NUMERI a FODS. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file FODS. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedi l'esempio C# che unisce i NUMERI a FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Codice di esempio per unire i NUMERI a FODS in C#" InputFormat="numbers" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire i NUMERI a FODS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 È necessario unire i NUMERI a FODS a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria .NET per unire i NUMERI allo FODS" %}}
