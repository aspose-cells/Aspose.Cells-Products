...
هل تحتاج إلى تحويل ملفات HTM إلى FODS برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى FODS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى FODS باستدعاء طريقة Save ().
