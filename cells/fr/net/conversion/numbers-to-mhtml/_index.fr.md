---
title: C# NOMBRES en MHTML - Convertisseur NOMBRES en MHTML
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les NUMBERS au format MHTML, permettant un enregistrement transparent des données NUMBERS au format MHTML à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros MHTML dans C#" %}}

L'exemple suivant montre comment convertir les NOMBRES de MHTML en C#.
...
{{% cells-convert title="Exemple de code pour convertir des NOMBRES en MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="mhtml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en MHTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en MHTML par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en MHTML en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en MHTML en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en MHTML" %}}
