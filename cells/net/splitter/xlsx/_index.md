...
{{% blocks/products/pf/agp/feature-section-col title="Steps forВ Splitting XLSX Files in C#" %}}
...
+  Call the Save() method and pass the file name (full path) and format (XLSX) as parameter.
...
{{% blocks/products/pf/agp/code-block title="SplitВ XLSX File - C#" offSpacer="" %}}
