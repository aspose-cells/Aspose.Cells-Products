...
description: Aspose 엑셀. Aspose.Cells을 사용하여 TABDELIMITED를 PRN으로 빠르고 쉽게 변환하세요. PHP TABDELIMITED를 PRN으로 변환하세요. PHP TABDELIMITED를 PRN에 저장합니다. PHP를 사용하여 TABDELIMITED를 PRN으로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="TABDELIMITED를 PHP의 PRN에 저장" %}}

다음 예에서는 PHP에서 TABDELIMITED를 PRN으로 변환하는 방법을 보여줍니다.
...
{{% blocks/products/pf/agp/content h2="PHP를 통해 TABDELIMITED를 PRN으로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 TABDELIMITED 파일을 PRN으로 변환해야 합니까? PHP 개발자는 단 몇 줄의 코드만으로 TABDELIMITED를 PRN으로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook의 save 메소드를 호출하여 TABDELIMITED를 PRN으로 변환합니다.
1.  TABDELIMITED에서 PRN으로의 변환 결과를 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="TABDELIMITED를 PRN으로 변환하는 PHP 라이브러리" %}}
