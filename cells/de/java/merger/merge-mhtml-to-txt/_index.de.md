---
title: MHTML mit TXT zusammenführen - MHTML mit TXT in Java kombinieren
url: /de/java/merger/merge-mhtml-to-txt/ 
description: Aspose Excel. Java Aspose.Cells. MHTML mit TXT Saveformat zusammenführen. Java Kombinieren Sie das Format MHTML mit dem Format TXT. MHTML zu TXT in Java zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="MHTML mit TXT in Java zusammenführen" %}}

Das folgende Beispiel zeigt, wie MHTML mit TXT in Aspose.Cells for Java zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von MHTML mit TXT in Java" InputFormat="mhtml" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie MHTML mit TXT via Java zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie MHTML programmgesteuert mit TXT zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Java](https://products.aspose.com/cells/java) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Zusammenführen von MHTML mit TXT" %}}
