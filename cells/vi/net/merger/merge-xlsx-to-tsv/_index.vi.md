---
title: Gộp XLSX vào TSV - Gộp XLSX vào TSV vào C#
url: /vi/net/merger/merge-xlsx-to-tsv/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất XLSX thành TSV saveformat. C# Kết hợp định dạng XLSX thành TSV. Hợp nhất XLSX thành TSV vào C#. XLSX Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLSX thành TSV vào C#" %}}

Ví dụ sau đây minh họa cách hợp nhất XLSX với TSV trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XLSX thành TSV. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp TSV. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất XLSX thành TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp XLSX thành TSV trong C#" InputFormat="xlsx" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp XLSX vào TSV qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất XLSX thành TSV theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp XLSX thành TSV" %}}
