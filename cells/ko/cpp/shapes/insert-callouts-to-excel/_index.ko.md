...
<div class="container-fluid features-section bg-gray">
 ...
 자동모양 유형::<br>AutoShapeType_RectangularCallout
    </p>
   </div>
   <div class="col-lg-4">
 ...
 자동모양 유형::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 자동모양 유형::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar3
    </p>
   </div>
  </div>
 </div>
