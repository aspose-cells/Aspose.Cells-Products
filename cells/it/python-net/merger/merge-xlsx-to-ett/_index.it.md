...
L'esempio seguente mostra come unire XLSX a ETT in Aspose.Cells for Python via .NET.
...
Hai bisogno di unire XLSX a ETT in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Le API possono essere eseguite con poche righe di codice.
