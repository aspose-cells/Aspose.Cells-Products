---
title: PHP OTS إلى WORD - OTS إلى WORD محول
description: Aspose اكسل. قم بتحويل OTS إلى WORD بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى WORD. PHP احفظ OTS إلى WORD. احفظ OTS كـ WORD باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى WORD في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى WORD. هذا حل برمجي احترافي لاستيراد وتصدير OTS وWORD والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل OTS إلى WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="docx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى WORD عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى WORD برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى WORD في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى WORD عن طريق استدعاء طريقة حفظ المصنف.
