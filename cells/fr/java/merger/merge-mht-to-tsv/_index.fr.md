...
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde TSV. Java Combinez MHT au format TSV. Fusionner MHT avec TSV dans Java. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec TSV en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT avec TSV dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT en TSV. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier TSV. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne MHT en TSV.
...
Besoin de fusionner MHT avec TSV par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
