...
url: /fr/net/editor/csv/ 
description: Code source C# pour modifier le document CSV sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---
...
{{% blocks/products/pf/agp/content h2="Comment modifier un fichier CSV à l\'aide de C#" %}}
...
Aspose.Cells API peut être utilisé pour créer, modifier, convertir et restituer des formats Microsoft Excel dans différents formats. De plus, il peut être utilisé pour des graphiques complets, des rapports évolutifs et des calculs fiables dans les applications logicielles. Aspose.Cells est un API autonome et ne nécessite aucun logiciel comme Microsoft ou OpenOffice.    
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Démos en direct de l\'éditeur CSV en ligne" sectionDescription="Modifiez des documents CSV dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/cells/editor). La démo en direct présente les avantages suivants" >}}
