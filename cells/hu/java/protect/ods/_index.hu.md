...
{{% blocks/products/pf/agp/content h2="A ODS fájl biztonságossá tétele a Java használatával" %}}
...
1.  Töltse be a ODS-es fájlt a munkafüzet osztály példányosításával
1.  Használja a Protect(..) metódust a ProtectionType-val és a jelszóval
1.  Mentse el a védett ODS fájlt a save() metódussal
