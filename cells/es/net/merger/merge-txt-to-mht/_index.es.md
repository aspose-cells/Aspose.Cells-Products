---
title: Combinar TXT a MHT - Combinar TXT a MHT en C#
url: /es/net/merger/merge-txt-to-mht/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea TXT para guardar formato MHT. C# Combine TXT en formato MHT. Combinar TXT a MHT en C#. TXT Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine TXT con MHT en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar TXT con MHT en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar TXT con MHT. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo MHT. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que fusiona TXT con MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar TXT a MHT en C#" InputFormat="txt" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar TXT a MHT a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar TXT con MHT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar TXT a MHT" %}}
