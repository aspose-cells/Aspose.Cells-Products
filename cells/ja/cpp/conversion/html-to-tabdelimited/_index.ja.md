...
{{< blocks/products/pf/i18n/upper-banner h1="C++を介してHTMLをTABDELIMITEDに変換します" h2="Microsoft Excel、OpenOffice、またはAdobe Acrobatをインストールすることなく、C++ライブラリを使用した高性能HTMLからTABDELIMITEDへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++開発者は、わずか数行のコードでHTMLファイルをTABDELIMITEDに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbookを使用してHTMLファイルをロードします。1. Save（）メソッドを呼び出します。1. （TABDELIMITED）ファイル拡張子を持つ出力ファイルパスを渡します。1. TABDELIMITEDファイルは指定されたパスに保存されます。1. 互換性のあるプログラムでTABDELIMITEDファイルを開きます。
...
{{% blocks/products/pf/agp/code-block title="HTMLからTABDELIMITEDC++への変換ソースコード" offSpacer="" %}}
