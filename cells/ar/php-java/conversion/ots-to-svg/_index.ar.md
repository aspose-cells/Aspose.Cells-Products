---
title: PHP OTS إلى SVG - OTS إلى SVG محول
description: Aspose اكسل. قم بتحويل OTS إلى SVG بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى SVG. PHP احفظ OTS إلى SVG. احفظ OTS كـ SVG باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى SVG في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى SVG. هذا حل برمجي احترافي لاستيراد وتصدير OTS وSVG والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى SVG عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى SVG برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى SVG في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى SVG عن طريق استدعاء طريقة حفظ المصنف.
