---
title:  ODS Dosyalarını Birleştir via Java
weight: 6270
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı'nda ODS belgelerini birleştirmek için Java örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS Formatlarını Java\'de Birleştir" h2="Sunucu tarafı Java API\'lerini kullanan yerel ODS belge birleştirme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
+ İkinci ODS belgesini Workbook sınıfının bir örneğiyle yükleyin.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi ODS Birleşme Canlı Demoları" sectionDescription=" ODS belgemizi hemen ziyaret ederek birleştirin[Canlı Demolar web sitesi](https://products.aspose.app/cells/merger). Canlı demo aşağıdaki avantajlara sahiptir" >}}
