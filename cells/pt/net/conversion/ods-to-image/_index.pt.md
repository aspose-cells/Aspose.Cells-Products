...
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converta ODS para IMAGE saveformat. C# ODS para o formato IMAGEM. Salve ODS na IMAGEM C#.
...
{{% blocks/products/pf/agp/content h2="Salve ODS na IMAGEM em C# Online Gratuitamente" %}}

O exemplo a seguir demonstra como converter ODS em IMAGEM em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS em IMAGEM. Carregue seu arquivo ODS e simplesmente salve-o como arquivo de IMAGEM. Para leitura de ODS e gravação de IMAGE, você pode usar nomes de arquivo totalmente qualificados. O conteúdo e a formatação da IMAGEM de saída serão idênticos ao documento ODS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter ODS em IMAGE Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para IMAGE via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para IMAGE programaticamente? .NET desenvolvedores podem facilmente carregar e converter ODS para IMAGE em apenas algumas linhas de código.
...
1.  Converta ODS em IMAGE chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para converter ODS em IMAGEM" %}}
