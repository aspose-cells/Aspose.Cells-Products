...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG sous DOCX dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en DOCX en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir JPG en DOCX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en DOCX par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en DOCX en quelques lignes de code.
...
1.  Convertissez le JPG au format DOCX en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en DOCX" %}}
