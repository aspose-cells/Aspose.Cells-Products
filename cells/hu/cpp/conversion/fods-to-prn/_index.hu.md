---
title: C++ FODS PRN-hez – Online FODS PRN-konverterhez
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Ingyenes online C++ A FODS konvertálása PRN mentési formátumra. C++ FODS PRN formátumba. Mentse a FODS számot a C++ PRN számra.
...
{{% blocks/products/pf/agp/content h2="Konvertálja a FODS-et PRN-re a C++ használatával" %}}
...
{{% blocks/products/pf/agp/content h2="Takarítson meg FODS-et a PRN számára a C++-es számon online ingyen" %}}

A következő példa bemutatja, hogyan lehet a FODS-et PRN-re konvertálni a C++-ben.
...
A FODS fájlokat programozottan PRN-re kell konvertálni? A C++ fejlesztők könnyedén konvertálhatják a FODS-et PRN-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a FODS-et PRN-re a Save() metódus meghívásával.
