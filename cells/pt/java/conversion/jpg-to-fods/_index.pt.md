---
title: Java JPG para FODS - Conversor JPG para FODS
description: Aspose Excel. Converta JPG em FODS de forma rápida e fácil com Aspose.Cells. Java JPG em FODS. Java Salve JPG em FODS. Salve JPG como FODS usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter JPG para FODS em Java" h2="Biblioteca Java de alta velocidade para converter JPG em FODS. Esta é uma solução de software profissional para importar e exportar JPG, FODS e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salve JPG em FODS em Java" %}}

O exemplo a seguir demonstra como converter JPG para FODS em Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter JPG em FODS. Carregue seu arquivo JPG e simplesmente salve-o como arquivo FODS. Tanto para leitura JPG quanto para gravação FODS, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída FODS serão idênticos ao documento JPG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemplo de código para converter JPG em FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="fods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter JPG para FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPG para FODS programaticamente? Os desenvolvedores do Java podem converter facilmente JPG em FODS em apenas algumas linhas de código.
...
1.  Converta JPG em FODS chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de JPG para FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca Java para converter JPG em FODS" %}}
{{% blocks/products/pf/agp/text %}}
