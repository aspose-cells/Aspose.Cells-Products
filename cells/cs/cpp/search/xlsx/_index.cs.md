---
title:  Vyhledat dokument XLSX bez otevření přes C++
weight: 9280
description: Příklad kódu C++ pro vyhledávání slov se vzorem v souboru XLSX v běhovém prostředí C++ pro 32bitové verze Windows, 64bitové verze Windows a 64bitové verze Linuxu.
...
{{< blocks/products/pf/i18n/upper-banner h1="Vyhledávání formátů XLSX v C++" h2="Nativní a vysoce výkonné vyhledávání dokumentů XLSX pomocí serverových Aspose.Cells for C++ API, bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vyhledat soubor XLSX pomocí adresáře C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vyhledávání souborů XLSX v adresáři C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Vyhledávání souborů XLSX - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSX Vyhledat Živé ukázky" sectionDescription=" Vyhledejte text, slova a fráze v dokumentech s adresou XLSX hned teď na našich stránkách[Webová stránka živé ukázky](https://products.aspose.app/cells/search). Živé demo má následující výhody" >}}
