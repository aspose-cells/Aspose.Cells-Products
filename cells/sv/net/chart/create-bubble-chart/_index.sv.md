...
{{% blocks/products/pf/agp/feature-section-col title="Hur man skapar bubbeldiagram via C#" %}}
...
1.  Använda sig av[**Chart.SetChartDataRange**](https://https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/setchartdatarange)metod för att ange diagrammets datakälla.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Följande källkod visar hur man skapar ett bubbeldiagram till MS Excel XLSX-fil med C#." offSpacer="" %}}
