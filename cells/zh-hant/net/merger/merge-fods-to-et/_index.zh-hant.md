...
以下範例示範如何將 FODS 合併到 Aspose.Cells for .NET 中的 ET。
...
{{% cells-merger title="將 FODS 合併到 C# 中的 ET 的範例程式碼" InputFormat="fods" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 合併到 ET" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 合併到 ET 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將FODS合併至ET" %}}
