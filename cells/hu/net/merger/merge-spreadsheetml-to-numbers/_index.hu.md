---
title: "SPREADSHEETML egyesítése a következővel: NUMBERS – SPREADSHEETML egyesítése a NUMBERS fájllal a C#-ben"
url: /hu/net/merger/merge-spreadsheetml-to-numbers/ 
description: "Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítése SPREADSHEETML NUMBERS mentési formátumba. C# A SPREADSHEETML egyesítése NUMBERS formátumba. SPREADSHEETML egyesítése a következővel: NUMBERS itt: C#. SPREADSHEETML Egyesítés."
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a SPREADSHEETML-t a NUMBERS számmal a C# számon" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a SPREADSHEETML fájlt a NUMBERS-szel a Aspose.Cells for .NET számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SPREADSHEETML és a NUMBERS egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el NUMBERS fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a SPREADSHEETML-t a NUMBERS-szel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online SPREADSHEETML egyesítése a NUMBERS számmal a C# számon" InputFormat="xml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A SPREADSHEETML egyesítése a NUMBERS fájllal a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SPREADSHEETML-t a NUMBERS fájllal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a SPREADSHEETML és a NUMBERS egyesítéséhez" %}}
