---
title: C# OTS till JPEG - OTS till JPEG Converter
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera OTS till JPEG-format, vilket möjliggör sömlös sparning av OTS-data i JPEG-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till JPEG i C#" %}}

Följande exempel visar hur man konverterar OTS till JPEG i C#.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att konvertera OTS till JPEG. Ladda upp din OTS-fil och spara den sedan som JPEG-fil. För både OTS-läsning och JPEG-skrivning kan du använda fullt kvalificerade filnamn. Utdata JPEG innehåll och formatering kommer att vara identisk med det ursprungliga OTS-dokumentet.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exempelkod för att konvertera OTS till JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till JPEG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till JPEG programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till JPEG på bara några rader kod.
...
1.  Konvertera OTS till JPEG genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet från OTS till JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-bibliotek för att konvertera OTS till JPEG" %}}
