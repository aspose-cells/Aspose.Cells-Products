---
title:  Sloučit XML na PPTX via Java
...
Následující příklad ukazuje, jak sloučit XML do PPTX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XML na PPTX online" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
