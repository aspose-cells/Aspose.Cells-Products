---
title: C# XLT 至 DIF - XLT 至 DIF 转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 XLT 转换为 DIF 格式，从而能够使用 Aspose.Cells 库将 XLT 数据无缝保存为 DIF 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 XLT 保存到 DIF，即 C#" %}}

以下示例演示了如何在 C# 中将 XLT 转换为 DIF。
...
{{% cells-convert title="将 XLT 转换为 DIF 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlt" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLT 通过 C# 转换为 DIF" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 文件转换为 DIF 吗？.NET 开发人员只需几行代码即可轻松加载并将 XLT 转换为 DIF。
...
1. 向您的 C# 项目添加库引用（导入库）。
1. 使用工作簿实例加载 XLT 文件。
1. 通过调用 Workbook.Save 方法将 XLT 转换为 DIF。
1. 得到XLT至DIF的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="使用 C# 库将 XLT 转换为 DIF" %}}
