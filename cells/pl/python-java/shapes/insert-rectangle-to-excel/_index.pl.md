---
title:  Wstaw prostokąt do Excela, używając Python via Java
weight: 10
description: Python via Java kod źródłowy umożliwiający wstawienie prostokąta do programu Excel.
keywords: [Python Aspose.Cells., Python add Rectangle., Python insert Rectangle., Python create Rectangle]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw prostokąt do Excela, używając Python via Java" h2="Wstaw prostokąt za pomocą Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić prostokąt do pliku Excel za pomocą Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić prostokąt do pliku Excel przy użyciu Python via Java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRectangle(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić prostokąt w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw prostokąt - Python via Java" offSpacer="" %}}
