...
{{% blocks/products/pf/agp/content h2="Como inserir cubo no arquivo do Excel usando Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir o arquivo Cube to Excel usando Python via Java" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use a coleção de formas[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) para inserir um Cubo na planilha selecionada.
