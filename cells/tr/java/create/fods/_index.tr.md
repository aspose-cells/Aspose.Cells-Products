---
title: FODS oluştur - Java'de FODS dosyası oluştur
description: Aspose excel. Java FODS Dosyası Oluştur. Oluştur FODS Java. Java FODS Oluşturan. Java'de FODS oluşturun. Java'i kullanarak FODS dosyasını oluşturun.
...
{{% blocks/products/pf/agp/content h2="Java\'de FODS Nasıl Oluşturulur" %}}
...
1.  Çalışma kitabını save() yöntemini kullanarak FODS biçiminde kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, Java\'de FODS dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="FODS dosyası oluşturmak için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
