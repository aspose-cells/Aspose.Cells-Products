---
title: PHP XLAM'den ET'ye - XLAM'den ET'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile XLAM'i hızlı ve kolay bir şekilde ET'ye dönüştürün. PHP XLAM'i ET'ye dönüştürün. PHP XLAM'i ET'ye kaydedin. PHP kullanarak XLAM'i ET olarak kaydedin.
...
{{% cells-convert title="XLAM\'i ET\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="et" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLAM\'i ET\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLAM dosyalarını program aracılığıyla ET'ye dönüştürmeniz mi gerekiyor? PHP geliştiricileri yalnızca birkaç satır kodla XLAM'i kolayca yükleyebilir ve ET'ye dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLAM'i ET'ye dönüştürün.
1.  XLAM'in ET'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLAM\'i ET\'ye dönüştürmek için PHP kütüphanesi" %}}
