...
url: /ja/net/merger/merge-ods-to-word/ 
...
次の例は、ODS を Aspose.Cells for .NET の WORD に結合する方法を示しています。
...
ODS をプログラムで WORD にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
