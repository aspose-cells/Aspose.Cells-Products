---
title: JSON'i POWERPOINT ile birleştir - JSON'i C#'de POWERPOINT ile birleştir
url: /tr/net/merger/merge-json-to-powerpoint/ 
description: Aspose Excel'de. C# Aspose.Cells. JSON'i POWERPOINT kaydetme biçimiyle birleştirin. C# JSON'i POWERPOINT biçimiyle birleştirin. JSON'i C#'deki POWERPOINT ile birleştirin. JSON Birleştirin.
...
{{% blocks/products/pf/agp/content h2="JSON\'i C#\'deki POWERPOINT ile birleştir" %}}

Aşağıdaki örnek, JSON'in Aspose.Cells for .NET'deki POWERPOINT ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

JSON'i POWERPOINT ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından POWERPOINT dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. JSON'i POWERPOINT ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="JSON\'i C#\'deki POWERPOINT ile Birleştirmek için Örnek Kod" InputFormat="json" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="JSON\'i C# aracılığıyla POWERPOINT\'e nasıl birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

 JSON'i POWERPOINT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kitaplığı, JSON\'i POWERPOINT ile birleştirecek" %}}
