---
title:  Połącz pliki XLTX via .NET
weight: 1220
description: Kod źródłowy C# do łączenia dokumentów XLTX na platformach .NET Framework, .NET Core, Mono lub platformach Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Scal formaty XLTX w C#" h2="Natywne i wydajne łączenie dokumentów XLTX przy użyciu interfejsów API Aspose.Cells for .NET po stronie serwera, bez użycia oprogramowania takiego jak Microsoft lub Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
+ Wywołaj metodę Save() i podaj nazwę pliku (pełna ścieżka) i format (XLTX) jako parametr.
+ Teraz możesz otworzyć i używać pliku XLTX w Microsoft Office, Adobe PDF lub dowolnym innym kompatybilnym programie.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online XLTX Pokazy fuzji na żywo" sectionDescription=" Połącz dokumenty XLTX już teraz, odwiedzając naszą stronę[Witryna internetowa z prezentacjami na żywo](https://products.aspose.app/cells/merger). Demo na żywo ma następujące zalety" >}}
