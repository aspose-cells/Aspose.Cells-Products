...
description: Aspose Excel. Python Aspose.Cells. Połącz NUMERY, aby zapisać format MHTML. Python Połącz NUMERY do formatu MHTML. Scal NUMBERS z MHTML w Python. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z MHTML, używając Python" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z MHTML w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia NUMERÓW z MHTML w Python" InputFormat="numbers" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
