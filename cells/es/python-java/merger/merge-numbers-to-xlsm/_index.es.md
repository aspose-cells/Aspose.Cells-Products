---
title:  Combinar NÚMEROS a XLSM a través de Python
url: /es/python-java/merger/merge-numbers-to-xlsm/ 
description: Combine NÚMEROS al XLSM en línea de forma gratuita. NÚMEROS en Línea Gratis al XLSM Fusión. Combinar NÚMEROS a Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo fusionar NÚMEROS a XLSM en Python.
...
{{% cells-merger title="Aplicación gratuita para unir NÚMEROS al XLSM en línea" InputFormat="numbers" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
