...
Poniższy przykład pokazuje, jak scalić OTS z SQL w Aspose.Cells for .NET.
...
Chcesz programowo połączyć OTS z SQL? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET do łączenia OTS z SQL" %}}
