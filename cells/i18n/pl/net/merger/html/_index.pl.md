---
title: Scal pliki HTML przez .NET 
weight: 9440
url: /pl/net/merger/html/ 
description: C# kod źródłowy do łączenia dokumentów HTML na platformach .NET Framework, .NET Core, Mono lub Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Scal formaty HTML w C#" h2="Natywne i wydajne łączenie dokumentów HTML przy użyciu interfejsów API Aspose.Cellsfor .NET po stronie serwera, bez użycia oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="HTML" >}}
...
+ Załaduj wszystkie pliki HTML z pełną ścieżką.
+ Utwórz jeden dokument jako plik podstawowy
+ Wywołaj odpowiednią metodę łączenia i scalania plików jeden po drugim.
+ Wywołaj metodę Save() i przekaż nazwę pliku (pełna ścieżka) i format (HTML) jako parametr.
+ Teraz możesz otworzyć i używać pliku HTML w Microsoft Office, Adobe PDF lub dowolnym innym kompatybilnym programie.
