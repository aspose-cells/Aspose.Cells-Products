---
title: PHP EXCEL en OTS - Convertisseur EXCEL en OTS
description: Aspose Exceller. Convertissez EXCEL en OTS rapidement et facilement avec Aspose.Cells. PHP EXCEL en OTS. PHP Enregistrez EXCEL dans OTS. Enregistrez EXCEL au format OTS en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en OTS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en OTS par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en OTS en quelques lignes de code seulement.
...
1. Convertissez EXCEL en OTS en appelant la méthode de sauvegarde du classeur.
