...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert elbow double-arrow shape to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) to insert an elbow double-arrow shape in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert elbow double-arrow shape - C#" offSpacer="" %}}
