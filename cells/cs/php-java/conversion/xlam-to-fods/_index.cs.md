---
title: Konvertor PHP XLAM až FODS - XLAM až FODS
description: Aspose Excel. Převeďte XLAM na FODS rychle a snadno pomocí Aspose.Cells. PHP XLAM na FODS. PHP Uložte XLAM na FODS. Uložte FODS jako XLAM jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést XLAM na FODS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na FODS programově? Vývojáři PHP mohou snadno načíst a převést XLAM na FODS v několika řádcích kódu.
...
1.  Převeďte XLAM na FODS voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na FODS" %}}
