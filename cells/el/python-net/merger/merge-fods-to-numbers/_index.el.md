---
title:  Συγχώνευση FODS σε NUMBERS μέσω Python
url: /el/python-net/merger/merge-fods-to-numbers/ 
description: Συγχώνευση FODS στο NUMBERS Online δωρεάν. Δωρεάν Online FODS to NUMBERS Merger. Συγχώνευση FODS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS με το NUMBERS στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση FODS με NUMBERS σε απευθείας σύνδεση" InputFormat="fods" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
