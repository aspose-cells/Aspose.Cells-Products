...
{{% blocks/products/pf/agp/content h2="Převeďte IMAGE na SXC pomocí Python" %}}
...
Následující příklad ukazuje, jak převést IMAGE na SXC v Python.
