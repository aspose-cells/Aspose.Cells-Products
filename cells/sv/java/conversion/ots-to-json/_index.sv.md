---
title: Java OTS till JSON - OTS till JSON Converter
description: Aspose Excel. Konvertera OTS till JSON snabbt och enkelt med Aspose.Cells. Java OTS till JSON. Java Spara OTS till JSON. Spara OTS som JSON med 304818.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera OTS till JSON till Java" h2="Höghastighetsbibliotek Java för konvertering av OTS till JSON. Detta är en professionell mjukvarulösning för att importera och exportera OTS, JSON och många andra format med Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Spara OTS till JSON på Java" %}}

Följande exempel visar hur man konverterar OTS till JSON i Java.
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till JSON programmatiskt? Java-utvecklare kan enkelt konvertera OTS till JSON på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="Java bibliotek för att konvertera OTS till JSON" %}}
{{% blocks/products/pf/agp/text %}}
