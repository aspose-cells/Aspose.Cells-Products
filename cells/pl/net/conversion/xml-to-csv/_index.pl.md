...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XML na CSV w C#" h2="Szybka biblioteka C# do konwersji XML do CSV. Profesjonalne rozwiązanie programowe do importowania i eksportowania plików XML, CSV i wielu innych formatów na platformach .NET Framework, .NET Core lub Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
1.  Konwertuj XML do CSV wywołując metodę Workbook.Save.
