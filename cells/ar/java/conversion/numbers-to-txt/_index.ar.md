...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل NUMBERS إلى TXT عبر Java" h2="تحويل NUMBERS إلى TXT Java لتحويل صفحات مفردة أو صفحات متعددة إلى TXT باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الأرقام إلى TXT باستخدام Java" %}}

 من أجل تقديم NUMBERS إلى TXT ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل الأرقام إلى TXT عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج Java بسهولة تحويل NUMBERS ملف إلى TXT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف NUMBERS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد TXT و SaveFormat كمعلمات1. تحقق من المسار المحدد لملف TXT الناتج
...
{{% blocks/products/pf/agp/code-block title="NUMBERS إلى TXT Java شفرة مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف NUMBERS في مثيل مصنف
Workbook book = new Workbook("template.numbers");
// احفظ الأرقام بتنسيق TXT
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS to TXT Conversion Live Demos" sectionDescription="[تحويل الأرقام إلى TXT](https://products.aspose.app/cells/conversion/numbers-to-txt) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف NUMBERS الخاص بك ، وسيتم تحويله على الفور إلى TXT." >}}
