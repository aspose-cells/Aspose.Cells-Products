...
url: /hu/python-java/merger/merge-xml-to-spreadsheetml/ 
...
A következő példa bemutatja, hogyan lehet XML-t egyesíteni a SPREADSHEETML-lel a Aspose.Cells for Python via Java-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Automatikusan egyesítenie kell az XML-t a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
