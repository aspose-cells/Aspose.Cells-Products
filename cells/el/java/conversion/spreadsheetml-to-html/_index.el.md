---
title: Μετατροπή SPREADSHEETML σε HTML μέσω Java 
url: /el/java/conversion/spreadsheetml-to-html/ 
description: Δείγμα κώδικα μετατροπής Java για μορφή SPREADSHEETML σε αρχείο HTML. Οι προγραμματιστές μπορούν να χρησιμοποιήσουν αυτό το παράδειγμα κώδικα για να εξάγουν υπολογιστικά φύλλα Excel και OpenOffice σε HTML σε οποιαδήποτε εφαρμογή που βασίζεται στον Ιστό ή στην επιφάνεια εργασίας Java.
---
...
{{% blocks/products/pf/agp/content h2="Τρόπος μετατροπής SPREADSHEETML σε HTML χρησιμοποιώντας το Java" %}}

 Για να αποδώσουμε το SPREADSHEETML σε HTML, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή SPREADSHEETML σε HTML μέσω Java" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του Java μπορούν εύκολα να μετατρέψουν το αρχείο SPREADSHEETML σε HTML σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου SPREADSHEETML με μια παρουσία της κλάσης Βιβλίο εργασίας1. Καλέστε τη μέθοδο Workbook.save1. Περάστε τη διαδρομή εξόδου με επέκταση HTML και SaveFormat ως παραμέτρους1. Ελέγξτε την καθορισμένη διαδρομή για το αρχείο HTML που προκύπτει
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML σε HTML Java Πηγαίος κώδικας μετατροπής" offSpacer="" %}}

```cs
// φορτώστε το αρχείο SPREADSHEETML σε μια παρουσία του βιβλίου εργασίας
Workbook book = new Workbook("template.spreadsheetml");
// αποθήκευση SPREADSHEETML ως HTML
