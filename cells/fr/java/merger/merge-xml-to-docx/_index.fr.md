---
title: Fusionner XML vers DOCX - Combiner XML vers DOCX dans Java
url: /fr/java/merger/merge-xml-to-docx/ 
description: Aspose Excel. Java Aspose.Cells. Fusion gratuite en ligne XML au format de sauvegarde DOCX. Java Combine XML au format DOCX. Fusionner XML vers DOCX dans Java. Fusion XML.
...
L'exemple suivant montre comment fusionner XML vers DOCX dans Aspose.Cells for Java.
...
{{% cells-merger title="Gratuit en ligne pour fusionner XML en DOCX en Java" InputFormat="xml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XML en DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XML vers DOCX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
