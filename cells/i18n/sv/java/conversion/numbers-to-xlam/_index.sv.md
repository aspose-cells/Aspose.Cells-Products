---
title: Konvertera NUMBERS till XLAM via Java 
url: /sv/java/conversion/numbers-to-xlam/ 
description: Exempel Java-konverteringskod för NUMBERS-format till XLAM-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLAM inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar TAL till XLAM med Java" %}}

 För att rendera NUMBERS till XLAM kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera NUMBERS till XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera NUMBERS-filen till XLAM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda NUMBERS-filen med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLAM-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLAM-filen
...
{{% blocks/products/pf/agp/code-block title="NUMBERS till XLAM Java omvandlingskällkod" offSpacer="" %}}

```cs
// ladda NUMBERS-filen i en instans av Workbook
Workbook book = new Workbook("template.numbers");
// spara NUMBERS som XLAM
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS till XLAM Live Demos" sectionDescription="[Konvertera NUMBERS till XLAM](https://products.aspose.app/cells/conversion/numbers-to-xlam) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din NUMBERS-fil, den konverteras omedelbart till XLAM." >}}
