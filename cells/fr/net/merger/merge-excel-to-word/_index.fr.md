...
url: /fr/net/merger/merge-excel-to-word/ 
...
{{% cells-merger title="Application gratuite pour fusionner EXCEL à WORD en ligne" InputFormat="xlsx" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner EXCEL à WORD" %}}
