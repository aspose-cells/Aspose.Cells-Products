---
title: Converteer ODS naar TABDELIMITED via Python
url: /nl/python-java/conversion/ods-to-tabdelimited/
description: Voorbeeldcode voor conversie van ods naar tabdelimited Python. Gebruik API voorbeeldcode voor batch-ods-bestanden naar door tabs gescheiden conversie binnen de Python-toepassing.
---
...
{{% blocks/products/pf/agp/content h2="Hoe ODS naar TABDELIMITED te converteren met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ODS te converteren naar TABDELIMITED via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen eenvoudig ODS-bestanden laden en converteren naar TABDELIMITED in slechts een paar regels code.
