...
Χρειάζεται να μετατρέψετε αρχεία EXCEL σε SQL μέσω προγραμματισμού; Οι προγραμματιστές C++ μπορούν εύκολα να μετατρέψουν αρχεία EXCEL σε SQL σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατρέψτε το EXCEL σε SQL καλώντας τη μέθοδο Save().
