...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в SXC, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в SXC в C#" %}}
...
1.  Преобразуйте значение FODS в SXC, вызвав метод Workbook.Save.
