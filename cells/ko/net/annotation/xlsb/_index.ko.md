---
title:  XLSB 주석 via .NET 추가 또는 제거
weight: 6440
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼에서 XLSB 형식 주석을 추가하고 삭제합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 XLSB에서 주석 추가 또는 삭제" h2="서버 측 API를 사용하여 문서 파일의 댓글 및 작성자를 조작할 수 있는 자신만의 .NET 앱을 구축하세요." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
