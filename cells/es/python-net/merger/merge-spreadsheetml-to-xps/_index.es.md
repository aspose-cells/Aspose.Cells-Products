---
title:  Combine SPREADSHEETML con XPS a través de Python
url: /es/python-net/merger/merge-spreadsheetml-to-xps/ 
description: Combine SPREADSHEETML con XPS en línea de forma gratuita. HOJA DE CÁLCULO en línea gratis al XPS Fusión. Combine SPREADSHEETML con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo fusionar SPREADSHEETML a XPS en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar SPREADSHEETML a XPS en línea" InputFormat="xml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
