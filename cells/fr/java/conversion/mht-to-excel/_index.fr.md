---
title: Java MHT en EXCEL - Convertisseur MHT en EXCEL
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format MHT au format EXCEL, permettant un enregistrement transparent des données MHT au format EXCEL à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Sauvegarder MHT dans EXCEL en Java" %}}

L'exemple suivant montre comment convertir MHT en EXCEL dans Java.
...
{{% cells-convert title="Exemple de code pour convertir un fichier MHT en Excel" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir un fichier MHT en Excel via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en EXCEL par programmation ? Les développeurs de Java peuvent facilement convertir des fichiers MHT en EXCEL en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir MHT en EXCEL" %}}
{{% blocks/products/pf/agp/text %}}
