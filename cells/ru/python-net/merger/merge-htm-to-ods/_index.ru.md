...
url: /ru/python-net/merger/merge-htm-to-ods/ 
...
В следующем примере показано, как объединить HTM с ODS в Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Нужно программно объединить HTM с ODS? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API можно создать с помощью всего нескольких строк кода.
