---
title:  Unisci PRN a CSV tramite Python
url: /it/python-net/merger/merge-prn-to-csv/ 
description: Unisci PRN a CSV online gratuitamente. Gratuito Online PRN al CSV Fusione. Unisci PRN a Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e altro ancora.
---
...
L'esempio seguente mostra come unire PRN a CSV in Python.
...
{{% cells-merger title="App gratuita per unire PRN allo CSV on line" InputFormat="prn" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
