...
{{% blocks/products/pf/agp/feature-section-col title="ODS 파일을 보호하는 단계 via Java" %}}
...
1.  통합 문서 클래스를 인스턴스화하여 ODS 파일 로드
1.  ProtectionType 및 Password와 함께 protect(..) 메서드 사용
1.  보호된 ODS 파일을 save() 메서드로 저장합니다.
