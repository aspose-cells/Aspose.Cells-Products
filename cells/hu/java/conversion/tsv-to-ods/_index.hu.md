...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása ODS-vé a következővel: Java" %}}

 Ahhoz, hogy a TSV-t ODS-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TSV-ből ODS-vé konvertálás lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják a TSV-fájlt ODS-vé.

{{% /blocks/products/pf/agp/text %}}

1. TSV-fájl betöltése a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat ODS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott ODS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TSV-től ODS-hez Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TSV-fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tsv");
// mentse a TSV-t ODS-ként
