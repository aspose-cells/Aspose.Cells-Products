...
{{% blocks/products/pf/agp/content h2="Save XLS to TSV in C#" %}}

The following example demonstrates how to convert XLS to TSV in C#.
...
{{% cells-convert title="Sample Code to Convert XLS to TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLS to TSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert XLS files to TSV programmatically? .NET developers can easily load & convert XLS to TSV in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert XLS to TSV" %}}
