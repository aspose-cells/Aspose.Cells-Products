...
description: Aspose Excel. Converteer XLTM snel en eenvoudig naar JSON met Aspose.Cells. Python XLTM naar JSON. Python Bewaar XLTM in JSON. Bewaar XLTM als 07611134 81 via Python.
...
{{% blocks/products/pf/agp/content h2="Converteer XLTM naar JSON in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLTM t/m JSON in Python" %}}

Het volgende voorbeeld laat zien hoe u XLTM converteert naar JSON in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLTM naar JSON te converteren" %}}
