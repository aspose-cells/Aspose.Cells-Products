...
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori PHP un approccio completamente integrato per convertire CSV in formato MHT, consentendo il salvataggio senza interruzioni dei dati CSV in formato MHT utilizzando la libreria Aspose.Cells, il tutto tramite codice PHP efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva CSV in MHT in PHP" %}}

L'esempio seguente mostra come convertire CSV in MHT in PHP.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire CSV in MHT. Carica il tuo file CSV e salvalo come file MHT. Sia per la lettura del file CSV che per la scrittura in MHT puoi utilizzare nomi di file completamente qualificati. Il contenuto e la formattazione del file MHT di output saranno identici al documento originale CSV.
...
Hai bisogno di convertire i file CSV in MHT tramite codice? Gli sviluppatori PHP possono caricare e convertire facilmente i file CSV in MHT in poche righe di codice.
...
1.  Converti CSV in MHT chiamando il metodo save di Workbook.
