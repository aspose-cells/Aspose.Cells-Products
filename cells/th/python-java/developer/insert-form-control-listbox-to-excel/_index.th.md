...
{{% blocks/products/pf/agp/content h2="วิธีแทรกกล่องรายการ (ตัวควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก ListBox(Form control) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addListBox(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกกล่องรายการ (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกกล่องรายการ (ตัวควบคุมฟอร์ม) - Python via java" offSpacer="" %}}
