---
title:  Dividir ODS Archivos via Java
weight: 1950
description: Java código de muestra para dividir documentos ODS en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dividir ODS Archivos via Java" h2="ODS división con la ayuda de la biblioteca Java del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo dividir el archivo ODS usando Java" %}}
...
+ Llame al método de guardado con la nueva ruta de archivo ODS.
...
{{% blocks/products/pf/agp/code-block title="Dividir ODS Archivo - Java" offSpacer="" %}}
