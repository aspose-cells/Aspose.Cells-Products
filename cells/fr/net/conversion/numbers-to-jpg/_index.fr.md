---
title: C# NUMBERS en JPG - Convertisseur en ligne de NUMBERS en JPG
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertissez les NUMÉROS en format de sauvegarde JPG. C# NUMÉROS au format JPG. Enregistrez les NUMÉROS au format JPG C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les NUMÉROS au format JPG au C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir des NUMBERS en JPG en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir des NUMBERS en JPG. Téléchargez votre fichier NUMBERS, puis enregistrez-le simplement au format JPG. Pour la lecture de NUMBERS et l'écriture JPG, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage JPG de sortie seront identiques au document NUMBERS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir des NUMBERS en JPG en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des NUMBERS en JPG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en JPG par programmation ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en JPG en quelques lignes de code.
...
1.  Convertissez NUMBERS en JPG en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliothèque pour convertir des NUMBERS en JPG" %}}
