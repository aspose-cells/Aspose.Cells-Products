...
description: Aspose Excel. C# Aspose.Cells. Συγχώνευση FODS σε μορφή αποθήκευσης EXCEL. C# Συνδυάστε το FODS σε μορφή EXCEL. Συγχώνευση FODS στο EXCEL στο C#. FODS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση FODS στο EXCEL στο C#" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση FODS στο EXCEL στο C#" InputFormat="fods" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
