...
url: /pl/python-net/merger/merge-mhtml-to-numbers/ 
...
Poniższy przykład pokazuje, jak scalić MHTML z NUMBERS w Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić numer MHTML z NUMBERS? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
