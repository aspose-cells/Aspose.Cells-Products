...
weight: 10
description: C# كود المصدر لرسم أو إدراج سهم مستقيم مزدوج في Excel على .NET Framework أو .NET Core أو Mono أو منصات Xamarin.
---
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج سهم مستقيم مزدوج في ملف Excel باستخدام C#" %}}
 ...
 من أجل إدراج سهم مزدوج مستقيم في ملف Excel ، سنستخدمه
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج سهم مستقيم مزدوج في ملف Excel عبر C#" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) لإدراج سهم مستقيم مزدوج في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل سهم مستقيم مزدوج - C#" offSpacer="" %}}
