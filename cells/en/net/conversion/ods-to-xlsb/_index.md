...
description: Sample code for ods to xlsb C# conversion. Use API example code for batch ods files to xlsb conversion within VB.NET, Asp.NET or any .NET based application.
---
