...
يوضح المثال التالي كيفية دمج XLTX مع OTS في Aspose.Cells for Python via .NET.
...
هل تحتاج إلى دمج XLTX مع OTS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
