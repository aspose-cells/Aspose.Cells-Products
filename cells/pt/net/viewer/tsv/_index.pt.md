---
title:  Ver formatos de arquivo TSV via .NET
weight: 3090
description: Código-fonte C# para carregar, renderizar e exibir documentos TSV em plataformas .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para visualizar TSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells torna mais fácil para os desenvolvedores visualizarem o arquivo TSV com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código de exemplo C# para visualizar o arquivo TSV" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos Excel Microsoft em diferentes formatos. Além disso, pode ser usado para gráficos abrangentes, relatórios escalonáveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API independente e não requer nenhum software como Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para visualizar TSV" sectionDescription=" Confira nossas demonstrações ao vivo para[Ver TSV](https://products.aspose.app/cells/viewer/tsv) com os seguintes benefícios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar ou configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever ou compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer upload do arquivo TSV e clicar no botão \"Visualizar\"" >}}
