...
{{% blocks/products/pf/agp/content h2="Преобразовать HTM в MARKDOWN, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM-код в MARKDOWN в Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в MARKDOWN в Java.
...
Нужно программно преобразовать HTM-файлы в формат MARKDOWN? Разработчики, использующие формат Java, могут легко преобразовать HTM в формат MARKDOWN всего несколькими строками кода.
