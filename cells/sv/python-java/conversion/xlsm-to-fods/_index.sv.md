---
title: Konvertera XLSM till FODS via Python
url: /sv/python-java/conversion/xlsm-to-fods/
description: Exempelkod för xlsm till fods Python-konvertering. Använd API exempelkod för batch-xlsm-filer för att konvertera i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar XLSM till FODS med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till FODS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLSM-filer till FODS på bara några rader kod.
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLSM till FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="fods" IsLandingPage="true" language="python" %}}
