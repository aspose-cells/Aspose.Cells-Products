...
description: Aspose Excel. Convierta XLSX a FODS rápida y fácilmente con Aspose.Cells. Python XLSX a FODS. Python Guarde XLSX en FODS. Guarde XLSX como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSX al FODS en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSX a FODS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSX en FODS" %}}
