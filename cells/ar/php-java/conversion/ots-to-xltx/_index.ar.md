---
title: PHP OTS إلى XLTX - OTS إلى XLTX محول
description: Aspose اكسل. قم بتحويل OTS إلى XLTX بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى XLTX. PHP احفظ OTS إلى XLTX. احفظ OTS كـ XLTX باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى XLTX في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى XLTX. هذا حل برمجي احترافي لاستيراد وتصدير OTS وXLTX والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل OTS إلى XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xltx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى XLTX عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى XLTX برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى XLTX في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى XLTX عن طريق استدعاء طريقة حفظ المصنف.
