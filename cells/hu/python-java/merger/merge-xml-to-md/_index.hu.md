...
url: /hu/python-java/merger/merge-xml-to-md/ 
...
A következő példa bemutatja, hogyan egyesítheti az XML-t MD-vel a Aspose.Cells for Python via Java számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell az XML-t MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
