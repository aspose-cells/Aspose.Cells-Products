...
{{% blocks/products/pf/agp/content h2="MHT omzetten naar SXC met behulp van Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sla MHT op in SXC in Java" %}}

Het volgende voorbeeld laat zien hoe je MHT omzet naar SXC in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik MHT om naar SXC via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u MHT-bestanden programmatisch converteren naar SXC? Ontwikkelaars van Java kunnen MHT-bestanden eenvoudig converteren naar SXC met slechts een paar regels code.
