---
title: Konversi JSON ke XPS melalui Java 
weight: 7860
url: /id/java/conversion/json-to-xps/ 
description: Contoh Java kode konversi untuk format JSON ke file XPS. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke XPS dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi JSON ke XPS melalui Java" h2="Ekspor JSON ke format XPS melalui Java tanpa memerlukan alat atau pustaka tambahan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi JSON ke XPS Menggunakan Java" %}}

 Untuk merender JSON ke XPS, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi JSON ke XPS melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file JSON ke XPS hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Buat instance baru dari kelas Workbook1. Pilih default atau Lembar Kerja apa pun dari koleksi1. Muat data JSON dari file1. Buat instance JsonLayoutOptions & atur opsi1. Panggil metode JsonUtility.importData dengan mengacu pada Lembar Kerja & data1. Simpan Buku Kerja dalam format XPS
...
{{% blocks/products/pf/agp/code-block title="JSON ke XPS Java Kode Sumber Konversi" offSpacer="" %}}
...
// simpan file yang dihasilkan dalam format JSON-TO-XPS
