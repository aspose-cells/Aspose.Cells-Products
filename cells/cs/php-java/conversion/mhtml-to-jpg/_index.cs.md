---
title: Převod PHP MHTML na JPG – MHTML na JPG
description: Aspose Excel. Převeďte MHTML na JPG rychle a snadno pomocí Aspose.Cells. PHP MHTML na JPG. PHP Uložit MHTML do JPG. Uložte MHTML jako JPG pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na JPG přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory do JPG programově? Vývojáři PHP mohou snadno načíst a převést MHTML na JPG v několika řádcích kódu.
...
1. Převeďte MHTML na JPG voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na JPG" %}}
