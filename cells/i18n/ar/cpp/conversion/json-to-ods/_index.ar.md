---
title: تحويل JSON إلى ODS عبر تطبيق C++ 
url: /ar/cpp/conversion/json-to-ods/ 
description: نموذج C++ رمز تحويل لمستند JSON إلى تنسيق ODS. يمكن للمبرمجين استخدام هذا الكود المصدري لتحويل JSON دفعة واحدة إلى ODS في أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل JSON إلى ODS عبر C++" h2="تحويل JSON عالي الأداء إلى ODS باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JSON إلى ODS باستخدام C++" %}}
 ...
 من أجل تحويل JSON إلى ODS ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف JSON إلى ODS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف JSON باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد ملف (ODS).1. سيتم حفظ ملف ODS في المسار المحدد.1. افتح ملف ODS في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="JSON إلى كود مصدر تحويل C++ ODS" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل JSON إلى ODS" sectionDescription="[تحويل JSON إلى ODS](https://products.aspose.app/cells/conversion/json-to-ods) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف JSON الخاص بك ، وسيتم تحويله على الفور إلى ODS." >}}
