---
title: تحويل C++ MHT إلى XLS - تحويل MHT إلى XLS
description: Aspose اكسل. قم بتحويل MHT إلى XLS بسرعة وسهولة باستخدام Aspose.Cells. C++ MHT إلى XLS. C++ احفظ MHT إلى XLS. احفظ MHT كـ XLS باستخدام C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHT إلى XLS في C++" h2="تحويل MHT عالي الأداء إلى XLS باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على XLS في C++" %}}

يوضح المثال التالي كيفية تحويل MHT إلى XLS في C++.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى XLS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى XLS برمجياً؟ يمكن لمطوري C++ تحويل MHT بسهولة إلى XLS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLS عن طريق استدعاء طريقة Save ().
1.  احصل على نتيجة تحويل MHT إلى XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل MHT إلى XLS" %}}
