---
title:  ODS を Python 経由で XLSX に結合
url: /ja/python-java/merger/merge-ods-to-xlsx/ 
description: ODS を XLSX にオンラインで無料で結合します。無料オンラインODSからXLSX合併。 ODS を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、ODS を Python の XLSX にマージする方法を示しています。
...
{{% cells-merger title="オンラインでODSをXLSXにマージする無料アプリ" InputFormat="ods" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
