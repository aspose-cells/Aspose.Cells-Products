...
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 XLS 轉換為 MHT 格式，從而能夠使用 Aspose.Cells 庫將 XLS 資料無縫保存為 MHT 格式，所有這些都透過高效能客製化的 08153481 2081481 2081。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Excel 庫中將 XLS 轉換為 MHT 格式（Python）。" h2="高速 Python Excel 庫，用於將 XLS 轉換為 MHT。這是一個專業的軟體解決方案，可使用 Python 匯入和匯出 XLS、MHT 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將 XLS 轉換為 MHT" %}}

如何將 XLS 轉換為 MHT？使用 Aspose.Cells for Python 函式庫，只需幾行程式碼即可輕鬆地透過程式設計方式將 XLS 轉換為 MHT。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 XLS 儲存到 Python Excel 庫中的 MHT" %}}

以下範例示範如何在 Python Excel 庫中將 XLS 轉換為 MHT。
...
需要以程式設計方式將 XLS 檔案轉換為 MHT 格式嗎？ Python 開發人員只需幾行程式碼即可輕鬆載入 XLS 檔案並將其轉換為 MHT 格式。
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫，用於將 XLS 轉換為 MHT" %}}
