---
title: C++ MHT إلى ODS - محول MHT عبر الإنترنت إلى ODS
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل MHT إلى ODS saveformat. C++ MHT إلى تنسيق ODS. احفظ MHT في ODS C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHT إلى ODS في C++" h2="تحويل MHT عالي الأداء إلى ODS باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT في ODS في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى ODS برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى ODS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى ODS باستدعاء طريقة Save ().
