...
{{% blocks/products/pf/agp/content h2="C++을 사용하여 XLSB 메타데이터를 가져오는 방법" %}}
...
+ CreateIWorkbookMetadata를 사용하여 XLSB 파일 로드
