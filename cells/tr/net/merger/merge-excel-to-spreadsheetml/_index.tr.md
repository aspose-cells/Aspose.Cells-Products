...
url: /tr/net/merger/merge-excel-to-spreadsheetml/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de EXCEL'in SPREADSHEETML ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 EXCEL'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET EXCEL\'i SPREADSHEETML ile birleştirmek için kütüphane" %}}
