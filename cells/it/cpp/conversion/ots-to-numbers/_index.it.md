...
Hai bisogno di convertire i file OTS in NUMBERS tramite codice? Gli sviluppatori di C++ possono facilmente convertire OTS in NUMBERS in poche righe di codice.
...
1.  Converti OTS in NUMERI chiamando il metodo Save().
