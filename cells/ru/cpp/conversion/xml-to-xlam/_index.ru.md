...
Вам нужно программно преобразовать XML-файлы в XLAM? Разработчики C++ могут легко преобразовать XML в XLAM всего за несколько строк кода.
