...
Нужно программно конвертировать файлы XLTM в XLT? Разработчики C++ могут легко преобразовать XLTM в XLT всего за несколько строк кода.
