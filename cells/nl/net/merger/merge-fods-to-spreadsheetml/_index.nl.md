...
description: Aspose Excel. C# Aspose.Cells. Voeg FODS samen naar het SPREADSHEETML-opslagformaat. C# Combineer FODS naar SPREADSHEETML-formaat. Voeg FODS samen met SPREADSHEETML in C#. FODS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg FODS samen met SPREADSHEETML in C#" %}}

Het volgende voorbeeld laat zien hoe u FODS samenvoegt met SPREADSHEETML in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om FODS samen te voegen met SPREADSHEETML. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het SPREADSHEETML-bestand. Als u code ontwikkelt in C#, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C# waarin FODS wordt samengevoegd met SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om FODS samen te voegen met SPREADSHEETML in C#" InputFormat="fods" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u FODS samenvoegt met SPREADSHEETML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u FODS programmatisch samenvoegen met SPREADSHEETML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om FODS samen te voegen met SPREADSHEETML" %}}
