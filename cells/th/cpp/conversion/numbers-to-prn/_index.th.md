...
description: Aspose เอ็กเซล. แปลง NUMBERS เป็น PRN อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ NUMBERS เป็น PRN C++ บันทึกตัวเลขลงใน PRN บันทึก NUMBERS เป็น PRN โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="แปลง NUMBERS เป็น PRN โดยใช้ C++" %}}
...
{{% blocks/products/pf/agp/content h2="บันทึก NUMBERS ไปยัง PRN ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง NUMBERS เป็น PRN ใน C++
...
ต้องการแปลงไฟล์ NUMBERS เป็น PRN โดยทางโปรแกรมหรือไม่ นักพัฒนา C++ สามารถแปลง NUMBERS เป็น PRN ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง NUMBERS เป็น PRN โดยการเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลงจาก NUMBERS เป็น PRN

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ไลบรารี C++ เพื่อแปลง NUMBERS เป็น PRN" %}}
