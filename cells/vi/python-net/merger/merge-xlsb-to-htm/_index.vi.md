...
Ví dụ sau minh họa cách hợp nhất XLSB thành HTM trong Aspose.Cells for Python via .NET.
...
Cần hợp nhất XLSB với HTM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API có thể được thực hiện chỉ với vài dòng mã.
