---
title: C# XLSX ke TSV - Online XLSX ke TSV Konverter
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Gratis Online C# Ubah XLSX menjadi TSV saveformat. C# XLSX ke format TSV. Simpan XLSX ke TSV C#.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke TSV di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi TSV di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi XLSX menjadi TSV. Unggah file XLSX Anda, lalu simpan sebagai file TSV. Untuk membaca XLSX dan menulis TSV Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format keluaran TSV akan identik dengan dokumen asli XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX menjadi TSV Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Konversi XLSX ke TSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX menjadi TSV secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX menjadi TSV hanya dalam beberapa baris kode.
...
1.  Ubah XLSX menjadi TSV dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi dari XLSX menjadi TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengonversi XLSX menjadi TSV" %}}
