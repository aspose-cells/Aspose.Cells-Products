...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHT 轉換為 ET。C# MHT 轉換為 ET。 C# 將 MHT 儲存到 ET。使用 C# 將 MHT 儲存為 ET。
...
{{% blocks/products/pf/agp/content h2="將MHT保存到C#中的ET" %}}

下面的範例示範如何將C#中的MHT轉換為ET。
...
{{% cells-convert title="將 MHT 轉換為 ET 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="et" IsLandingPage="true" %}}
