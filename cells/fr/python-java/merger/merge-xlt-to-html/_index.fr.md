---
title:  Fusionner XLT à HTML via Python
url: /fr/python-java/merger/merge-xlt-to-html/ 
description: Fusionnez XLT à HTML en ligne gratuitement. Gratuit en ligne XLT à HTML Fusion. Fusionnez XLT vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner XLT à HTML dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner XLT à HTML en ligne" InputFormat="xlt" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
