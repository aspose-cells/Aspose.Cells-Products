...
{{< blocks/products/pf/i18n/upper-banner h1="将 XLSM 转换为 C# 中的 POWERPOINT" h2="用于将 XLSM 转换为 POWERPOINT 的高速 C# 库。这是一款专业的软件解决方案，可在 .NET Framework、.NET Core 或 Mono 平台上导入和导出 XLSM、POWERPOINT 和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POWERPOINT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% cells-convert title="将 XLSM 在线转换为 POWERPOINT 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLSM 转换为 POWERPOINT" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 文件转换为 POWERPOINT？ .NET 开发人员只需几行代码即可轻松加载 XLSM 并将其转换为 POWERPOINT。
