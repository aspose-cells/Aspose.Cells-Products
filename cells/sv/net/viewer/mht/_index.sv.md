...
{{% blocks/products/pf/agp/content h2="Hur man visar MHT-fil med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att se MHT via C#" %}}
...
1. Ladda MHT-filen i en instans av Workbook
1. Skapa en instans av HtmlSaveOptions och ställ in ExportHeadings-egenskapen till true
1. Spara MHT-filen i HTML-format med Workbook.Save-metoden
