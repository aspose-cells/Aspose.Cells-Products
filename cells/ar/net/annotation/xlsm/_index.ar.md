---
title:  إزالة XLSM التعليق التوضيحي via .NET
weight: 9890
description: C# التعليمات البرمجية المصدر لإضافة وحذف التعليقات التوضيحية بتنسيق XLSM على .NET Framework أو .NET Core أو Mono أو الأنظمة الأساسية Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إضافة أو حذف تعليق توضيحي من XLSM عبر C#" h2="قم ببناء تطبيقات .NET الخاصة بك للتعامل مع التعليقات والمؤلفين في ملفات المستندات باستخدام واجهات برمجة التطبيقات من جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="إضافة أو حذف تعليق توضيحي من XLSM عبر C#" %}}
...
{{% blocks/products/pf/agp/code-block title="حذف التعليقات التوضيحية من XLSM-C#" offSpacer="" %}}
