---
title: Sloučit PRN s TIFF – Sloučit PRN s TIFF v C#
url: /cs/net/merger/merge-prn-to-tiff/ 
description: Aspose Excel. C# Aspose.Cells. Zdarma online sloučit PRN do formátu uložení TIFF. C# Zkombinujte PRN do formátu TIFF. Sloučit PRN na TIFF v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na TIFF v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN s TIFF v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do TIFF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru TIFF. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí PRN do TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení PRN na TIFF v C#" InputFormat="prn" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na TIFF přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s TIFF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení PRN s TIFF" %}}
