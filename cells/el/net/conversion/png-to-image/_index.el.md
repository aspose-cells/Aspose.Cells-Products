---
title: C# PNG σε IMAGE - PNG σε IMAGE Converter
description: Aspose Excel. Μετατρέψτε το PNG σε ΕΙΚΟΝΑ γρήγορα και εύκολα με το Aspose.Cells. C# PNG σε ΕΙΚΟΝΑ. C# Αποθήκευση PNG στο IMAGE. Αποθηκεύστε το PNG ως ΕΙΚΟΝΑ χρησιμοποιώντας το C#.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το PNG στο IMAGE στο C#" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το PNG σε IMAGE στο C#.
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή PNG σε ΕΙΚΟΝΑ" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το PNG σε IMAGE μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να μετατρέψετε αρχεία PNG σε IMAGE μέσω προγραμματισμού; Οι προγραμματιστές .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν το PNG σε IMAGE σε λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="C# βιβλιοθήκη για μετατροπή PNG σε IMAGE" %}}
