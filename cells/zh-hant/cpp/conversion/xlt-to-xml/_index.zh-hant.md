---
title: 通過 C++ 應用程序將 XLT 轉換為 XML 

description: XLT 文檔到 XML 格式的示例 C++ 轉換代碼。程序員可以使用此源代碼在任何 C++ 應用程序中進行批量 XLT 到 XML 的轉換。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 開發人員只需幾行代碼即可輕鬆地將 XLT 文件轉換為 XML。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加載 XLT 文件。1. 調用 Save() 方法。1. 使用 (XML) 文件擴展名傳遞輸出文件路徑。1. XML 文件將保存在指定路徑。1. 在兼容程序中打開 XML 文件。
...
{{% blocks/products/pf/agp/code-block title="XLT 到 XML C++ 轉換源代碼" offSpacer="" %}}
