---
title: PHP JSON en ET - Convertisseur JSON en ET
description: Aspose Exceller. Convertissez JSON en ET rapidement et facilement avec Aspose.Cells. PHP JSON en ET. PHP Enregistrez JSON dans ET. Enregistrez JSON sous ET en utilisant PHP.
...
Besoin de convertir les fichiers JSON en ET par programme ? Les développeurs PHP peuvent facilement charger et convertir JSON en ET en quelques lignes de code seulement.
...
1.  Convertissez JSON en ET en appelant la méthode de sauvegarde du classeur.
