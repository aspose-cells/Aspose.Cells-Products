...
description: Aspose エクセル。 C++ Aspose.Cells。XLS を PDF の保存形式にマージします。 C++ XLS と PDF の形式を結合します。 XLS から PDF を C++ に結合します。XLS を結合します。
