...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde ODS'i PDF'e dönüştürün. C++ ODS'i PDF'e dönüştürün. C++ ODS'i PDF'e kaydedin. ODS'i 07611134 olarak kaydedin 81, C++'i kullanarak.
...
{{< blocks/products/pf/i18n/upper-banner h1="ODS\'i C++\'de PDF\'e dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna gerek kalmadan C++ kitaplığını kullanarak yüksek performanslı ODS\'den PDF\'e dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="C++\'i kullanarak ODS\'i PDF\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="ODS\'i C++\'e PDF\'e kaydedin" %}}

Aşağıdaki örnek, ODS'in C++'de PDF'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="ODS\'i PDF\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="pdf" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i C++ aracılığıyla PDF\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

ODS dosyalarını program aracılığıyla PDF'e dönüştürmeniz mi gerekiyor? C++ geliştiricileri, yalnızca birkaç satır kodla ODS'i PDF'e kolayca dönüştürebilir.
...
1.  Save() yöntemini çağırarak ODS'i PDF'e dönüştürün.
1.  ODS'den PDF'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ODS\'i PDF\'e dönüştürmek için C++ kitaplığı" %}}
