---
title: Συγχώνευση CSV στο WORD via Java
url: /el/java/merger/merge-csv-to-word/ 
description: Συγχώνευση CSV στο WORD Online δωρεάν. Δωρεάν Online CSV στο WORD Merger. Συγχώνευση CSV σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το CSV στο WORD στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση CSV στο WORD σε απευθείας σύνδεση" InputFormat="csv" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
