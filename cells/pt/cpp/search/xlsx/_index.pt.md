---
title:  Procurar documento XLSX sem abrir via C++
weight: 9280
description: C++ código de exemplo para pesquisar palavras com padrão no arquivo XLSX no ambiente de tempo de execução C++ para Windows 32 bits, Windows 64 bits e Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pesquise XLSX Formatos em C++" h2="Pesquisa de documentos XLSX nativa e de alto desempenho usando APIs Aspose.Cells for C++ do lado do servidor, sem o uso de qualquer software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como pesquisar o arquivo XLSX usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para pesquisar arquivos XLSX em C++" %}}
...
Carregue o arquivo XLSX instanciando uma classe IWorkbook.
...
+ Salve o arquivo XLSX usando o método IWorkbook->Save(.).
...
{{% blocks/products/pf/agp/code-block title="Pesquisar XLSX Arquivos - C++" offSpacer="" %}}
