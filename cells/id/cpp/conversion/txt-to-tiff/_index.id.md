---
title: Konversi TXT ke TIFF melalui C++ aplikasi 
url: /id/cpp/conversion/txt-to-tiff/ 
description: Contoh C++ kode konversi untuk dokumen TXT ke format TIFF. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch TXT ke TIFF dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan TXT ke TIFF melalui C++" h2="Konversi TXT ke TIFF berperforma tinggi menggunakan pustaka C++ tanpa memerlukan penginstalan Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file TXT ke TIFF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file TXT menggunakan Factory::CreateIWorkbook.1. Pilih lembar kerja pertama.1. Setel (TIFF) opsi.1. Iterasi melalui setiap halaman lembar dan render.1. Buka file TIFF di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="TXT ke TIFF C++ Kode Sumber Konversi" offSpacer="" %}}
