...
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do XLTX uložit formát. C++ Kombinujte formát XLTX až XLTX. Sloučit XLTX až XLTX v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX až XLTX v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX až XLTX v C++" InputFormat="xltx" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
