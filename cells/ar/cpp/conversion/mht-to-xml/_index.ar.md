---
title: C++ MHT إلى XML - MHT إلى XML المحول
description: Aspose إكسل. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل MHT إلى تنسيق XML، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق XML باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ملف MHT إلى XML في C++" h2="تحويل عالي الأداء من MHT إلى XML باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="حفظ ملف MHT بصيغة XML في C++" %}}

يوضح المثال التالي كيفية تحويل MHT إلى XML في C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل MHT إلى XML. قم بتحميل ملف MHT الخاص بك، ثم احفظه كملف XML. بالنسبة لكل من قراءة MHT وكتابة XML، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق XML الناتج مطابقًا لمستند MHT الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="نموذج كود لتحويل ملف MHT إلى XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى XML عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى XML برمجيًا؟ يمكن للمطورين (C++) تحويل ملفات MHT إلى XML بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل ملف MHT إلى XML عن طريق استدعاء دالة Save().
1.  احصل على نتيجة تحويل MHT إلى XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة رقم C++ لتحويل ملفات MHT إلى XML" %}}
