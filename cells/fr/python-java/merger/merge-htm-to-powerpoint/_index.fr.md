---
title: Fusionner HTM avec POWERPOINT - Combiner HTM avec POWERPOINT dans Python
url: /fr/python-java/merger/merge-htm-to-powerpoint/ 
description: Aspose Exceller. Python Aspose.Cells. Fusionner HTM au format de sauvegarde POWERPOINT. Python Combinez le format HTM au format POWERPOINT. Fusionner HTM avec POWERPOINT dans Python. Fusion HTM.
...
{{% cells-merger title="Exemple de code pour fusionner HTM avec POWERPOINT dans Python" InputFormat="htm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec POWERPOINT via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner HTM avec POWERPOINT par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner HTM avec POWERPOINT" %}}
