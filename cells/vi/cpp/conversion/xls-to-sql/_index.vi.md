...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS thành SQL trong C++" h2="Chuyển đổi XLS sang SQL hiệu suất cao bằng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Cần chuyển đổi các tệp XLS sang SQL theo chương trình? C++ nhà phát triển có thể dễ dàng chuyển đổi XLS thành SQL chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLS thành SQL bằng cách gọi phương thức Save().
