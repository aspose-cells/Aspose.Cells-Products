---
title:  Masukkan ListBox (Kontrol formulir) ke Excel menggunakan Python via .Net
weight: 50
description: Python via .Kode sumber bersih untuk memasukkan ListBox (Kontrol formulir) ke dalam Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan ListBox (Kontrol formulir) ke Excel menggunakan Python via .Net" h2="Sisipkan objek menggunakan API sisi server tanpa perangkat lunak apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan ListBox (Kontrol formulir) ke File Excel Menggunakan Python via .Net" %}}

 Untuk memasukkan ListBox (Kontrol formulir) ke dalam file excel, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk memasukkan ListBox (Kontrol formulir) ke file Excel menggunakan Python via .Net" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan tambahan shapecollection[metode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_list_box/#int-int-int-int-int-int) untuk menyisipkan ListBox (Kontrol formulir) di lembar kerja yang dipilih.
...
{{% blocks/products/pf/agp/code-block title="Sisipkan ListBox (Kontrol formulir) - Python via .Net" offSpacer="" %}}
