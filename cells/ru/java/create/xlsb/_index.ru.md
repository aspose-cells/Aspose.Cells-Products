---
title: Создать XLSB - Создать файл XLSB в Java
description: Aspose Excel. Java Создать файл XLSB. Создать XLSB Java. Java XLSB Создатель. Создайте XLSB в Java. Создайте файл XLSB, используя Java.
...
{{% blocks/products/pf/agp/content h2="Как создать XLSB в Java" %}}
...
1.  Сохраните книгу в формате XLSB, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл XLSB в Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="библиотека Java для создания файла XLSB" %}}
{{% blocks/products/pf/agp/text %}}
