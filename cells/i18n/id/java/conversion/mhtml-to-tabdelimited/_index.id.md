---
title: Konversikan MHTML ke TABDELIMITED melalui Java 
url: /id/java/conversion/mhtml-to-tabdelimited/ 
description: Contoh Java kode konversi untuk format MHTML ke file TABDELIMITED. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke TABDELIMITED dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan MHTML ke TABDELIMITED melalui Java" h2="Konversi MHTML ke TABDELIMITED Java untuk mengonversi satu atau beberapa halaman menjadi TABDELIMITED menggunakan perpustakaan Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi MHTML ke TABDELIMITED Menggunakan Java" %}}

 Untuk merender MHTML ke TABDELIMITED, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi MHTML ke TABDELIMITED melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file MHTML ke TABDELIMITED hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file MHTML dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi TABDELIMITED & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file TABDELIMITED yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="MHTML ke TABDELIMITED Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file MHTML dalam instance Workbook
Workbook book = new Workbook("template.mhtml");
// simpan MHTML sebagai TABDELIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi MHTML ke TABDELIMITED" sectionDescription="[Konversikan MHTML ke TABDELIMITED](https://products.aspose.app/cells/conversion/mhtml-to-tabdelimited) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file MHTML Anda, itu akan langsung dikonversi ke TABDELIMITED." >}}
