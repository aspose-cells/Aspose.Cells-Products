---
title: C# OTS zu JSON - Online OTS zu JSON Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# OTS in JSON Saveformat konvertieren. C# OTS zum JSON-Format. Speichern Sie OTS unter JSON C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter JSON in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie OTS in C# in JSON konvertiert wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um OTS in JSON zu konvertieren. Laden Sie Ihre OTS-Datei hoch und speichern Sie sie dann einfach als JSON-Datei. Sowohl für das OTS-Lesen als auch für das Schreiben von JSON können Sie vollständig qualifizierte Dateinamen verwenden. Der Inhalt und die Formatierung der Ausgabe JSON sind identisch mit dem ursprünglichen OTS-Dokument.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Kostenlose App und Beispielcode zum Online-Konvertieren von OTS in JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über C# in JSON" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in JSON konvertieren? .NET-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in JSON konvertieren.
...
1.  Konvertieren Sie OTS in JSON, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von OTS in JSON" %}}
