...
url: /cs/python-net/merger/merge-xlsb-to-ett/ 
...
Následující příklad ukazuje, jak sloučit XLSB do ETT v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLSB do ETT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
