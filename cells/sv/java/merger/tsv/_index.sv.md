---
title:  Slå samman TSV filer via Java
weight: 9260
description: Java exempelkod för att kombinera TSV dokument på Java Runtime Environment för JSP/JSF Application och Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman TSV-format i Java" h2="Native TSV dokumentsammanslagning med server-side Java API:er." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man sammanfogar TSV-filer med Java" %}}

 För att slå samman TSV-filen kommer vi att använda[Aspose.Cells for Java](https://products.aspose.com/cells/java) API som är en funktionsrik, kraftfull och lättanvänd fusion API for Java plattform. Du kan ladda ner den senaste versionen direkt från[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) och installera det i ditt Maven-baserade projekt genom att lägga till följande konfigurationer till pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att slå samman TSV filer i Java" %}}
...
+ Ladda den första TSV-filen med en instans av Workbook-klassen.
+ Ladda det andra TSV-dokumentet med en instans av Workbook-klassen.
+ Slå samman filer med metoden combine().
+ spara den sammanslagna TSV-filen på angiven sökväg
...
{{% blocks/products/pf/agp/code-block title="Slå samman TSV filer - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online TSV Merger Live Demos" sectionDescription=" Slå samman TSV dokument just nu genom att besöka vår[Live Demos webbplats](https://products.aspose.app/cells/merger). Livedemon har följande fördelar" >}}
