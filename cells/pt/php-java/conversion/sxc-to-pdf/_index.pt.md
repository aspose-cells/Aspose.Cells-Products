---
title: Conversor PHP SXC para PDF - SXC para PDF
description: Aspose Excel. Converta SXC em PDF de forma rápida e fácil com Aspose.Cells. PHP SXC em PDF. PHP Salve SXC em PDF. Salve SXC como PDF usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em PDF via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em PDF programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em PDF em apenas algumas linhas de código.
...
1.  Converta SXC em PDF chamando o método save da pasta de trabalho.
