...
Poniższy przykład ilustruje sposób scalania programu EXCEL z arkuszem kalkulacyjnym w formacie Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć EXCEL z SPREADSHEETML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
