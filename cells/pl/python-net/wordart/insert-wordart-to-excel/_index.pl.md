...
{{% blocks/products/pf/agp/content h2="Jak wstawić WordArt do pliku Excel za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić plik WordArt do pliku Excel za pośrednictwem Python" %}}
...
+ Użyj metody dodawania kolekcji shapecollection, aby wstawić obiekt WordArt do wybranego arkusza roboczego.
...
-  Zainstaluj Aspose.Cells for Python via .NET z<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , użyj polecenia jako:<code>$ pip install aspose-cells-python</code>.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Wstaw WordArt - Python" offSpacer="" %}}
