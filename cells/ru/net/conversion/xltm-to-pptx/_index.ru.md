---
title: Преобразователь C# XLTM в PPTX - XLTM в PPTX
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в PPTX в C#" %}}

В следующем примере показано, как преобразовать XLTM в PPTX в C#.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XLTM в PPTX через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы XLTM в PPTX? Разработчики .NET могут легко загрузить и преобразовать XLTM в PPTX всего за несколько строк кода.
...
1.  Преобразуйте значение XLTM в PPTX, вызвав метод Workbook.Save.
1.  Получите результат преобразования XLTM в PPTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XLTM в PPTX" %}}
