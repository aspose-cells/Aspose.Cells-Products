---
title: PHP HTML から OTS - HTML から OTS コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、HTML を OTS にすばやく簡単に変換します。PHP HTML を OTS に変換します。 PHP HTML を OTS に保存します。 PHP を使用して HTML を OTS として保存します。
...
{{% cells-convert title="HTMLをOTSに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="ots" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP経由でHTMLをOTSに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで OTS に変換する必要がありますか? PHP 開発者は、わずか数行のコードで HTML を簡単にロードして OTS に変換できます。
