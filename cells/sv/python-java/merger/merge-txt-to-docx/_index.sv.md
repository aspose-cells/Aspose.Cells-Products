---
title:  Slå samman TXT till DOCX via Python
url: /sv/python-java/merger/merge-txt-to-docx/ 
description: Slå samman TXT till DOCX Online gratis. Gratis online TXT till DOCX Sammanslagning. Slå samman TXT till Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS och mer.
---
...
Följande exempel visar hur man slår samman TXT till DOCX i Python.
...
{{% cells-merger title="Gratis app för att slå samman TXT till DOCX online" InputFormat="txt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
