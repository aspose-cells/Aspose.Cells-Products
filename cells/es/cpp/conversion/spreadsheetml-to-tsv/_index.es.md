---
title: Convierta SPREADSHEETML a TSV a través de la aplicación C++ 
url: /es/cpp/conversion/spreadsheetml-to-tsv/ 
description: Ejemplo de código de conversión C++ para el documento SPREADSHEETML al formato TSV. Los programadores pueden usar este código fuente para la conversión por lotes de SPREADSHEETML a TSV dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta SPREADSHEETML a TSV a través de C++" h2="Conversión de SPREADSHEETML a TSV de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente el archivo SPREADSHEETML a TSV con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo SPREADSHEETML usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (TSV).1. El archivo TSV se guardará en la ruta especificada.1. Abra el archivo TSV en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML a TSV C++ Código fuente de conversión" offSpacer="" %}}
