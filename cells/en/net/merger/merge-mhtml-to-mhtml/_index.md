...
description: C# source code to combine MHTML to MHTML file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="How to Merge MHTML to MHTML File Using C#" %}}
 ...
 In order to merge MHTML to MHTML file, we’ll use
...
{{% blocks/products/pf/agp/code-block title="Merge MHTML to MHTML Files - C#" offSpacer="" %}}
