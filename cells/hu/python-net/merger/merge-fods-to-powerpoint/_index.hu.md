---
title: A FODS egyesítése a POWERPOINT-hoz – a FODS-es szám egyesítése a POWERPOINT-hez a Python-es helyen
url: /hu/python-net/merger/merge-fods-to-powerpoint/ 
description: Aspose Excel. Python Aspose.Cells. Ingyenes online egyesítés FODS POWERPOINT mentési formátumba. Python A FODS kombinálása POWERPOINT formátumba. A FODS egyesítése a Python-es POWERPOINT-tal. FODS Egyesítés.
...
{{% cells-merger title="Ingyenes online a FODS egyesítéséhez POWERPOINT a Python-ben" InputFormat="fods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A FODS és a POWERPOINT egyesítése a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a FODS-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Python könyvtár a FODS és a POWERPOINT egyesítéséhez" %}}
