...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 MHTML 轉換為 XLS" %}}

 為了將 MHTML 渲染為 XLS，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 MHTML 轉換為 XLS 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 MHTML 文件轉換為 XLS。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 類的實例加載 MHTML 文件1. 調用 Workbook.save 方法1. 將帶有 XLS 擴展名和 SaveFormat 的輸出路徑作為參數傳遞1. 檢查生成的 XLS 文件的指定路徑
...
{{% blocks/products/pf/agp/code-block title="MHTML 到 XLS Java 轉換源代碼" offSpacer="" %}}
