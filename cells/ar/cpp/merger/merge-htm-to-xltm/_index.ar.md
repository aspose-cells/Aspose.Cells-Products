---
title: دمج HTM في XLTM - ادمج HTM مع XLTM في C++
url: /ar/cpp/merger/merge-htm-to-xltm/ 
description: Aspose إكسل. C++ Aspose.Cells. Free Online Merge HTM إلى XLTM saveformat. C++ ادمج تنسيق HTM مع تنسيق XLTM. دمج HTM إلى XLTM في C++. HTM دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج HTM في XLTM في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج HTM مع XLTM في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج HTM في XLTM. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف XLTM. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج HTM إلى XLTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج HTM في XLTM في C++" InputFormat="htm" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج HTM في XLTM عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج HTM في XLTM برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
