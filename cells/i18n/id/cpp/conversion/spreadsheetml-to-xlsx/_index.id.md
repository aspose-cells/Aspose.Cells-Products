---
title: Konversi SPREADSHEETML ke XLSX melalui C++ aplikasi 
url: /id/cpp/conversion/spreadsheetml-to-xlsx/ 
description: Contoh C++ kode konversi untuk dokumen SPREADSHEETML ke format XLSX. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch SPREADSHEETML ke XLSX dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan SPREADSHEETML ke XLSX melalui C++" h2="Konversi SPREADSHEETML ke XLSX berperforma tinggi menggunakan pustaka C++ tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file SPREADSHEETML ke XLSX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file SPREADSHEETML menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (XLSX).1. File XLSX akan disimpan di jalur yang ditentukan.1. Buka file XLSX di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML ke XLSX C++ Kode Sumber Konversi" offSpacer="" %}}
