---
title:  Mesclar EXCEL para XLTM via Python
url: /pt/python-java/merger/merge-excel-to-xltm/ 
description: Mesclar EXCEL para XLTM Online gratuitamente. Free Online EXCEL para XLTM Fusão. Mescle EXCEL para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar EXCEL para XLTM em Python.
...
{{% cells-merger title="Aplicativo gratuito para mesclar EXCEL para XLTM online" InputFormat="xlsx" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
