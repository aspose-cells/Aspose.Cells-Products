...
{{% blocks/products/pf/agp/content h2="Python via .Net Kullanılarak Excel Dosyasına Akış Şeması nasıl eklenir/oluşturulur" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net kullanarak Excel\'e Akış Şeması ekleme/oluşturma adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Shapecollection'ın eklentisini kullanın[yöntem](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) Seçilen çalışma sayfasına Akış Şeması eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Akış Şeması Ekle/Oluştur - Python via .Net" offSpacer="" %}}
