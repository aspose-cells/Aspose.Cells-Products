---
title: Java를 통해 TXT 파일 병합 
weight: 4480
url: /ko/java/merger/txt/ 
description: Java JSP/JSF 애플리케이션 및 데스크톱 애플리케이션을 위한 Java 런타임 환경에서 TXT 문서를 결합하는 샘플 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java에서 TXT 형식 병합" h2="서버측 Java API를 사용한 기본 TXT 문서 병합." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 TXT 파일을 병합하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java에서 TXT 파일을 병합하는 단계" %}}
...
+ Workbook 클래스의 인스턴스가 있는 첫 번째 TXT 파일을 로드합니다.
...
{{% blocks/products/pf/agp/code-block title="TXT 파일 병합 - Java" offSpacer="" %}}
