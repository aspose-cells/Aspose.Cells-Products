---
title:  Hợp nhất các tập tin CSV via .NET
weight: 6450
description: C# để kết hợp các tài liệu CSV trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng CSV trong C#" h2="Hợp nhất tài liệu gốc và hiệu suất cao CSV bằng cách sử dụng API Aspose.Cells for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
+ Tải toàn bộ file CSV đầy đủ đường dẫn.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp CSV - C#" offSpacer="" %}}
