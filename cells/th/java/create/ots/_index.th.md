...
description:  Aspose เอ็กเซล. Java สร้างไฟล์ OTS อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ OTS โดยใช้ Java สร้าง OTS ใน Java Java OTS Creater
...
1.  บันทึกสมุดงานเป็นรูปแบบ OTS โดยใช้เมธอด save()
...
{{% blocks/products/pf/agp/content h2="Java ไลบรารี่ เพื่อสร้างไฟล์ OTS" %}}
{{% blocks/products/pf/agp/text %}}
