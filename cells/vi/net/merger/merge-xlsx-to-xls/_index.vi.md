...
Ví dụ sau đây minh họa cách hợp nhất XLSX với XLS trong Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp XLSX thành XLS" %}}
