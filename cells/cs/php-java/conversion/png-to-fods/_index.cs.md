---
title: Konvertor PHP PNG až FODS - PNG až FODS
description: Aspose Excel. Převeďte PNG na FODS rychle a snadno pomocí Aspose.Cells. PHP PNG na FODS. PHP Uložte PNG na FODS. Uložte FODS jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na FODS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na FODS programově? Vývojáři PHP mohou snadno načíst a převést PNG na FODS v několika řádcích kódu.
...
1.  Převeďte PNG na FODS voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na FODS" %}}
