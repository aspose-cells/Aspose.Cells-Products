---
title: Unisci FODS a XPS - Combina FODS a XPS in C#
url: /it/net/merger/merge-fods-to-xps/ 
description: Aspose Excel. C# Aspose.Cells. Unione online gratuita da FODS a XPS saveformat. C# Combina il formato FODS con XPS. Unisci FODS a XPS in C#. FODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci FODS a XPS in C# online gratuitamente" %}}

L'esempio seguente mostra come unire FODS a XPS in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire FODS a XPS. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file XPS. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce FODS a XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire FODS a XPS in C#" InputFormat="fods" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire FODS a XPS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire FODS a XPS a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca da unire FODS a XPS" %}}
