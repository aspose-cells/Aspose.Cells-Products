---
title: PHP HTM a TIFF - Convertidor HTM a TIFF
description: Aspose Excel. Convierta HTM a TIFF rápida y fácilmente con Aspose.Cells. PHP HTM a TIFF. PHP Guarde HTM en TIFF. Guarde HTM como TIFF usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a TIFF mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a TIFF mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a TIFF en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a TIFF llamando al método guardar del libro de trabajo.
