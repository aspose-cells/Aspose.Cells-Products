---
title: C++ 애플리케이션을 통해 XLSM을 PDF로 변환 
url: /ko/cpp/conversion/xlsm-to-pdf/ 
description: XLSM 문서를 PDF 형식으로 변환하는 샘플 C++ 변환 코드. 프로그래머는 모든 C++ 애플리케이션 내에서 일괄 XLSM에서 PDF로의 변환을 위해 이 소스 코드를 사용할 수 있습니다.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 개발자는 몇 줄의 코드로 XLSM 파일을 PDF로 쉽게 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook을 사용하여 XLSM 파일을 로드합니다.1. Save() 메서드를 호출합니다.1. (PDF) 파일 확장자를 가진 출력 파일 경로를 전달하십시오.1. PDF 파일은 지정된 경로에 저장됩니다.1. 호환되는 프로그램에서 PDF 파일을 엽니다.
...
{{% blocks/products/pf/agp/code-block title="XLSM에서 PDF로 C++ 변환 소스 코드" offSpacer="" %}}
