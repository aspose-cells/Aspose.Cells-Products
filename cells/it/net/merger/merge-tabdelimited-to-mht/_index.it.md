---
title: Unisci TABDELIMITED a MHT - Combina TABDELIMITED a MHT in C#
url: /it/net/merger/merge-tabdelimited-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Unisci TABDELIMITED online gratuito in formato di salvataggio MHT. C# Combina TABDELIMITED nel formato MHT. Unisci TABDELIMITED a MHT in C#. TABDELIMITED Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci TABDELIMITED a MHT in C# online gratuitamente" %}}

L'esempio seguente mostra come unire TABDELIMITED a MHT in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire TABDELIMITED a MHT. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file MHT. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce TABDELIMITED a MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire TABDELIMITED a MHT in C#" InputFormat="tsv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire TABDELIMITED a MHT tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Hai bisogno di unire TABDELIMITED a MHT a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria per unire TABDELIMITED a MHT" %}}
