---
title: Převeďte TXT na JSON pomocí aplikace C++ 
url: /cs/cpp/conversion/txt-to-json/ 
description: Ukázkový konverzní kód C++ pro dokument TXT do formátu JSON. Programátoři mohou tento zdrojový kód použít pro dávkový převod TXT na JSON v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor TXT na JSON pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou souboru (JSON).1. Soubor JSON bude uložen do zadané cesty.1. Otevřete soubor JSON v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TXT na JSON C++" offSpacer="" %}}
