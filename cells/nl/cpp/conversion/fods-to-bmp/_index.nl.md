...
{{% blocks/products/pf/agp/content h2="Sla FODS op in BMP in C++" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar BMP in C++.
...
Moet je bestanden met de extensie FODS programmatisch converteren naar BMP? Ontwikkelaars van C++ kunnen bestanden met de extensie FODS eenvoudig converteren naar BMP met slechts een paar regels code.
