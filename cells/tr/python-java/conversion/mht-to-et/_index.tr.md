...
description: Aspose Excel'de. Aspose.Cells ile MHT'yi ET'ye hızlı ve kolay bir şekilde dönüştürün. Python MHT'den ET'ye. Python MHT'yi ET'ye kaydedin. Python'i kullanarak MHT'yi ET olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'i kullanarak MHT\'yi ET\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="MHT\'yi Python\'de ET\'ye kaydedin" %}}

Aşağıdaki örnek, Python'de MHT'nin ET'ye nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi ET\'ye dönüştürmek için Python kütüphanesi" %}}
