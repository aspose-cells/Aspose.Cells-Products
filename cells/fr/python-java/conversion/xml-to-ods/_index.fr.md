...
description: Aspose Exceller. Convertissez XML en ODS rapidement et facilement avec Aspose.Cells. Python XML en ODS. Python Enregistrez XML en ODS. Enregistrez XML sous ODS en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en ODS à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au ODS dans Python" %}}

L'exemple suivant montre comment convertir XML en ODS en Python.
