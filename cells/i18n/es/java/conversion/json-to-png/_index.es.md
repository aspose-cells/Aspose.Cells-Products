---
title: Convierte JSON a PNG a través de Java 
weight: 4910
url: /es/java/conversion/json-to-png/ 
description: Ejemplo de código de conversión Java para formato JSON a archivo PNG. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a PNG dentro de cualquier aplicación basada en Web o Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte JSON a PNG a través de Java" h2="Exporte JSON a formato PNG a través de Java sin necesidad de herramientas o bibliotecas adicionales." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JSON a PNG usando Java" %}}

 Para convertir JSON a PNG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir JSON a PNG a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo JSON a PNG con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Crear una nueva instancia de la clase Workbook1. Seleccione predeterminado o cualquier hoja de trabajo de la colección1. Cargar datos JSON desde un archivo1. Crear una instancia de JsonLayoutOptions y establecer opciones1. Llame al método JsonUtility.importData para importar datos JSON1. Cree y configure el objeto de ImageOrPrintOptions para la representación PNG1. Crear SheetRender para renderizar1. Llame al método SheetRender.toImage para guardar el resultado en formato PNG
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de JSON a PNG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de JSON a PNG" sectionDescription="[Convertir JSON a PNG](https://products.aspose.app/cells/conversion/json-to-png) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo JSON, se convertirá instantáneamente a PNG." >}}
