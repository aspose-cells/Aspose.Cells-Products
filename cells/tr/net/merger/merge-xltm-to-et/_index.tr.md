---
title: XLTM'i ET ile birleştir - XLTM'i C#'de ET ile birleştir
url: /tr/net/merger/merge-xltm-to-et/ 
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme XLTM'i ET'ye kaydetme biçimi. C# XLTM'i ET biçimiyle birleştirin. XLTM'i C#'de ET ile birleştir. XLTM Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i C# Online\'da ET ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'de ET ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

XLTM'i ET ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından ET dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. XLTM'i ET ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="XLTM\'i C#\'de ET ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xltm" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="XLTM\'i C# aracılığıyla ET\'ye Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLTM'i programlı olarak ET ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i ET ile birleştirmek için .NET kitaplığı" %}}
