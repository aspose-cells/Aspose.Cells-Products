...
{{< blocks/products/pf/i18n/upper-banner h1="將 C# 中的 MHT 轉換為 PPTX" h2="用於將 MHT 轉換為 PPTX 的高速 C# 庫。這是一個專業的軟件解決方案，用於在 .NET Framework、.NET Core 或 Mono 平台上導入和導出 MHT、PPTX 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 MHT 轉換為 PPTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 轉換為 PPTX" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 PPTX？ .NET 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 PPTX。
...
1. 通過調用 Workbook.Save 方法將 MHT 轉換為 PPTX。
1. 獲取MHT到PPTX的轉換結果。
