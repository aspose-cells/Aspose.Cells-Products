...
{{% blocks/products/pf/agp/content h2="كيفية تقسيم ملف XLSM باستخدام Java" %}}
...
+ استدعاء طريقة الحفظ مع مسار ملف XLSM الجديد.
...
{{% blocks/products/pf/agp/code-block title="تقسيم ملف XLSM - Java" offSpacer="" %}}
