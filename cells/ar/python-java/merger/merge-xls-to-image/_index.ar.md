...
description: Aspose اكسل. Python Aspose.Cells. دمج XLS في صيغة حفظ الصورة. Python قم بدمج XLS إلى تنسيق IMAGE. دمج XLS في IMAGE في Python. XLS دمج.
...
{{% blocks/products/pf/agp/content h2="دمج XLS في الصورة باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="دمج XLS إلى IMAGE في Python" %}}
...
{{% cells-merger title="نموذج التعليمات البرمجية لدمج XLS إلى IMAGE في Python" InputFormat="xls" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLS في IMAGE عبر Python" %}}
