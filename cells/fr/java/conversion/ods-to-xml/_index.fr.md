---
title: Convertir ODS en XML via Java 

description: Exemple de code de conversion Java pour le format ODS en fichier XML. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers XML dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir ODS en XML à l\'aide de Java" %}}

 Afin de rendre ODS en XML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ODS en XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier ODS en XML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ODS avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension XML et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier XML résultant
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion ODS vers XML Java" offSpacer="" %}}

```cs
// charger le fichier ODS dans une instance de Workbook
Workbook book = new Workbook("template.ods");
// enregistrer ODS au format XML
