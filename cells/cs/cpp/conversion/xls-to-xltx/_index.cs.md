...
description: Aspose Excel. Převeďte XLS na XLTX rychle a snadno pomocí Aspose.Cells. C++ XLS na XLTX. C++ Ušetřete XLS na 197 3481761 jako 197 348161 C++ 481 pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Uložit XLS až XLTX v C++" %}}
...
{{% cells-convert title="Ukázkový kód pro převod XLS na XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xltx" IsLandingPage="true" language="cpp" %}}
