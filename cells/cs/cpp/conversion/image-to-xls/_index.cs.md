...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte IMAGE na XLS v C++" h2="Vysoce výkonná konverze IMAGE na XLS s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Potřebujete programově převést soubory IMAGE na XLS? Vývojáři s C++ mohou snadno převést IMAGE na XLS pomocí několika řádků kódu.
...
1.  Převeďte IMAGE na XLS voláním metody Save().
