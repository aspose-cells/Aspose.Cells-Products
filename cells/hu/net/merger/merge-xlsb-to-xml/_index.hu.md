...
url: /hu/net/merger/merge-xlsb-to-xml/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLSB-et XML-be a Aspose.Cells for .NET-ben.
...
Programozottan egyesítenie kell a XLSB-et XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB XML-be olvasztásához" %}}
