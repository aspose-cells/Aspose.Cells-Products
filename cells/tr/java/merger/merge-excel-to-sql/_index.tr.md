---
title: EXCEL'i SQL ile Birleştir - Java'de EXCEL'i SQL ile Birleştirin
url: /tr/java/merger/merge-excel-to-sql/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i SQL kaydetme biçimiyle birleştirin. Java EXCEL'i SQL biçimiyle birleştirin. Java'de EXCEL'i SQL ile birleştirin. EXCEL Birleştirin.
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i SQL ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de EXCEL'in SQL ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i SQL ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından bunu SQL dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. EXCEL'i SQL ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java\'de EXCEL\'i SQL ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i SQL via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i SQL ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i SQL ile birleştirmek için Java kitaplığı" %}}
