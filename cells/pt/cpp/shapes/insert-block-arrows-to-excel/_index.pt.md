---
title:  Insira setas de bloco no Excel via C++
weight: 770
description: C++ código de exemplo para inserir setas de bloco no arquivo Excel no C++ Runtime Environment para Windows 32 bits, Windows 64 bits e Linux 64 bits.
keywords: [C++ Aspose.Cells., C++ add block arrows., C++ insert block arrows., C++ create block arrows]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insira setas de bloco no Excel via C++" h2="Insira objetos utilizando o nativo e de alto desempenho do server-side Aspose.Cells for C++ API sem utilizar nenhum software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Selecione Planilha por meio de seu índice.
 + Utilize o[adicionar método](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/) para inserir Visão geral dos tipos de seta de bloco na planilha selecionada
...
código de exemplo abaixo demonstra como inserir uma “seta para a direita”. Para mais tipos, consulte "Visão geral dos tipos de seta de bloco" abaixo.
