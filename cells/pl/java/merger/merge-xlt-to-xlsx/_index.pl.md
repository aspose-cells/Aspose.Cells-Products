---
title: Połącz XLT z XLSX - Połącz XLT z XLSX w Java
url: /pl/java/merger/merge-xlt-to-xlsx/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online XLT do XLSX w formacie zapisu. Java Połącz format XLT z XLSX. Połącz XLT z XLSX w Java. XLT Połącz.
...
{{% cells-merger title="Bezpłatne połączenie online XLT z XLSX w Java" InputFormat="xlt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLT z XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLT z XLSX programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
