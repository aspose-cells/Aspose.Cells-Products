...
{{% blocks/products/pf/agp/content h2="Преобразование XML в ODS с использованием C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в ODS в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат ODS в формате C#.
...
1.  Преобразовать XML в формат ODS, вызвав метод Workbook.Save.
