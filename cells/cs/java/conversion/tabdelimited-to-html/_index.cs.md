...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED do HTML pomocí Java" %}}

 K vykreslení TABDELIMITED do HTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na HTML prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor TABDELIMITED do HTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TABDELIMITED s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Jako parametry předejte výstupní cestu s rozšířením HTML a SaveFormat1. Zkontrolujte zadanou cestu pro výsledný soubor HTML
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze TABDELIMITED na HTML Java" offSpacer="" %}}

```cs
// načtěte soubor TABDELIMITED v instanci sešitu
Workbook book = new Workbook("template.tabdelimited");
// uložit TABDELIMITED jako HTML
