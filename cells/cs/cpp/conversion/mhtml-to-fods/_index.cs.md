...
Potřebujete programově převést soubory MHTML na FODS? Vývojáři C++ mohou snadno převést MHTML na FODS pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na FODS voláním metody Save().
