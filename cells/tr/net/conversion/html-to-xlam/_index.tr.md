...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde HTML'i XLAM'e dönüştürün. C# HTML'i XLAM'e dönüştürün. C# HTML'i XLAM'e kaydedin. HTML'i 07611134 olarak kaydedin 81, C#'i kullanarak.
...
{{% blocks/products/pf/agp/content h2="HTML\'i C#\'e XLAM\'e kaydedin" %}}

Aşağıdaki örnek, HTML'in C#'de XLAM'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="HTML\'i XLAM\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlam" IsLandingPage="true" %}}
...
1.  Workbook.Save yöntemini çağırarak HTML'i XLAM'e dönüştürün.
