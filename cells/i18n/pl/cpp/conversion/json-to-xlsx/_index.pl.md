---
title: Konwertuj JSON na XLSX za pomocą aplikacji C++ 
url: /pl/cpp/conversion/json-to-xlsx/ 
description: Przykładowy kod konwersji C++ dla dokumentu JSON do formatu XLSX. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji JSON na XLSX w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj JSON na XLSX przez C++" h2="Wysokowydajna konwersja JSON do XLSX przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik JSON na XLSX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik JSON przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSX).1. Plik XLSX zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSX w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji JSON do XLSX C++" offSpacer="" %}}
