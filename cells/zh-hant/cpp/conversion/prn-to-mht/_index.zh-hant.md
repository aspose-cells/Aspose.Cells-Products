---
title: C++ PRN 到 MHT - PRN 到 MHT 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 PRN 轉換為 MHT。C++ PRN 到 MHT。 C++ 將 PRN 儲存到 MHT。使用 C++ 將 PRN 儲存為 MHT。
...
{{% blocks/products/pf/agp/content h2="將 PRN 儲存為 C++ 中的 MHT" %}}

以下範例示範如何將 C++ 中的 PRN 轉換為 MHT。
...
{{% cells-convert title="將 PRN 轉換為 MHT 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="mht" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 PRN 轉換為 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 PRN 檔案轉換為 MHT？ C++ 開發人員只需幾行程式碼即可輕鬆將 PRN 轉換為 MHT。
...
1. 使用工作簿載入 PRN 檔案。
1. 透過呼叫 Save() 方法將 PRN 轉換為 MHT。
1. 取得PRN到MHT的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ 將 PRN 轉換為 MHT 的函式庫" %}}
