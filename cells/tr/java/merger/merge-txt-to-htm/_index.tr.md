---
title:  TXT'i HTM via Java ile birleştirin
...
Aşağıdaki örnek, TXT'in Java'de HTM ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="TXT\'i hat üzerinde HTM ile birleştirmek için Ücretsiz Uygulama" InputFormat="txt" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
