...
Вам нужно программно преобразовать XML-файлы в FODS? Разработчики .NET могут легко загружать и конвертировать XML в FODS всего за несколько строк кода.
...
1.  Преобразовать XML в формат FODS, вызвав метод Workbook.Save.
