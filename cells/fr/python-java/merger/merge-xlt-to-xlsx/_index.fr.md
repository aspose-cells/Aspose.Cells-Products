---
title:  Fusionner XLT à XLSX via Python
url: /fr/python-java/merger/merge-xlt-to-xlsx/ 
description: Fusionnez XLT à XLSX en ligne gratuitement. Gratuit en ligne XLT à XLSX Fusion. Fusionnez XLT vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner XLT à XLSX dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner XLT à XLSX en ligne" InputFormat="xlt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
