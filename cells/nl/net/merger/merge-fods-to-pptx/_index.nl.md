...
url: /nl/net/merger/merge-fods-to-pptx/ 
...
Het volgende voorbeeld laat zien hoe u FODS samenvoegt met PPTX in Aspose.Cells for .NET.
...
{{% cells-merger title="Voorbeeldcode om FODS samen te voegen met PPTX in C#" InputFormat="fods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u FODS samenvoegt met PPTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u FODS programmatisch samenvoegen met PPTX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om FODS samen te voegen met PPTX" %}}
