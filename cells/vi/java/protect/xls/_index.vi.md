---
title:  Bảo vệ và khóa XLS tài liệu via Java
weight: 5070
description: Mã mẫu Java để khóa tệp XLS bằng mật khẩu trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa XLS Tệp via Java" h2="Bảng tính Excel được bảo vệ bằng mật khẩu bao gồm định dạng XLS sử dụng Thư viện .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước bảo vệ XLS Tệp via Java" %}}
