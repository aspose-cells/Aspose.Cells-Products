---
title: PHP XLAM en EXCEL - Convertisseur XLAM en EXCEL
description: Aspose Exceller. Convertissez XLAM en EXCEL rapidement et facilement avec Aspose.Cells. PHP XLAM en EXCEL. PHP Enregistrez XLAM dans EXCEL. Enregistrez XLAM au format EXCEL en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Enregistrer XLAM dans EXCEL en PHP" %}}
...
Besoin de convertir les fichiers XLAM en EXCEL par programme ? Les développeurs PHP peuvent facilement charger et convertir XLAM en EXCEL en quelques lignes de code.
...
1.  Convertissez XLAM en EXCEL en appelant la méthode de sauvegarde du classeur.
