...
{{% cells-convert title="Contoh Kode untuk Mengonversi XML ke XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert XML ke XLS lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XML ke XLS secara terprogram? Pengembang C++ dapat dengan mudah mengonversi XML ke XLS hanya dalam beberapa baris kode.
...
1.  Konversikan XML ke XLS dengan memanggil metode Save().
