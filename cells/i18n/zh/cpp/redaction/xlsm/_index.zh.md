---
title: 通过 C++ 搜索和替换 XLSM 文档中的文本 
weight: 9570
url: /zh/cpp/redaction/xlsm/ 
description: C++ 用于编辑 XLSM 文件中敏感信息的示例代码 C++ 适用于 Windows 32 位、Windows 64 位和 Linux 64 位的运行时环境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C++ 中编辑 XLSM 格式" h2="本机和高性能 XLSM 使用用于 C++ API 的服务器端 Aspose.Cells 记录敏感的编校信息，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
