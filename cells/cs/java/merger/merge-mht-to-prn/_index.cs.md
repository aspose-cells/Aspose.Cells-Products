...
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení PRN. Java Kombinujte formát MHT a PRN. Sloučit MHT do PRN v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do PRN v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT do PRN v Java" InputFormat="mht" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
