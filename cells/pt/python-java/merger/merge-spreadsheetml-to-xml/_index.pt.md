---
title: Mesclar SPREADSHEETML com XML - Combinar SPREADSHEETML com XML em Python
url: /pt/python-java/merger/merge-spreadsheetml-to-xml/ 
description: Aspose Excel. Python Excel. Mesclar SPREADSHEETML com formato de salvamento XML. Python Combine SPREADSHEETML com formato XML. Mesclar SPREADSHEETML com XML na Biblioteca Excel Python. Mesclar PLANILHAML.
...
{{% blocks/products/pf/agp/content h2="Mesclar SPREADSHEETML com XML usando a biblioteca Python do Excel" %}}

 Como faço para mesclar SPREADSHEETML com XML? Com a biblioteca Aspose.Cells for Python via Java, você pode facilmente mesclar SPREADSHEETML com XML programaticamente com algumas linhas de código.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells) é capaz de construir aplicativos multiplataforma com a capacidade de gerar, modificar, converter, renderizar e imprimir todos os arquivos Excel. Python Excel API não apenas converte formatos de planilha, mas também pode renderizar arquivos Excel como imagens, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT e muito mais, tornando-o a escolha perfeita para troca de documentos em formatos padrão da indústria. Você pode instalar Aspose.Cells for Python via Java de<a href="https://pypi.org/project/aspose-cells/">pypi</a> , use o comando como:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mesclar SPREADSHEETML com XML na biblioteca Python Excel" %}}

O exemplo a seguir demonstra como mesclar SPREADSHEETML com XML em Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar SPREADSHEETML com XML. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os em um arquivo XML. Se você desenvolver código em Python, será mais simples do que parece. Veja o exemplo Python que mescla SPREADSHEETML com XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de exemplo para mesclar SPREADSHEETML com XML na biblioteca Python do Excel" InputFormat="xml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SPREADSHEETML com XML por meio da biblioteca Python Excel" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SPREADSHEETML com XML programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para mesclar SPREADSHEETML com XML" %}}
