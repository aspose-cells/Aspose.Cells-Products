...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกรูปสี่เหลี่ยมผืนผ้าลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="ใส่สี่เหลี่ยมผืนผ้า - Python via .Net" offSpacer="" %}}
