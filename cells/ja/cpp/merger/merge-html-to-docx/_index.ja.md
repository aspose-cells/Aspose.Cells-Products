---
title: HTML から DOCX を結合 - HTML から DOCX を C++ に結合
url: /ja/cpp/merger/merge-html-to-docx/ 
description: Aspose エクセル。 C++ Aspose.Cells。HTML を DOCX の保存形式にマージします。 C++ HTML と DOCX の形式を結合します。 HTML から DOCX を C++ に結合します。HTML を結合します。
...
次の例は、HTML を Aspose.Cells for C++ の DOCX にマージする方法を示しています。
...
{{% cells-merger title="HTML から DOCX を C++ にマージするサンプルコード" InputFormat="html" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="HTML を C++ 経由で DOCX に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML をプログラムで DOCX にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
