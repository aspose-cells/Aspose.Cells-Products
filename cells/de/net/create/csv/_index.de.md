...
{{% blocks/products/pf/agp/content h2="So erstellen Sie CSV über C#" %}}

{{% blocks/products/pf/agp/text %}}

 Für die Entwickler ist es einfach, CSV (durch Kommas getrennte Werte) zu erstellen, zu laden, zu ändern und zu konvertieren, indem sie verschiedene Berichtsanwendungen für die Datenverarbeitung in nur wenigen Codezeilen ausführen.
...
{{% blocks/products/pf/agp/code-block title="Beispielcode zum Erstellen einer CSV-Datei mit C#." offSpacer="" %}}
