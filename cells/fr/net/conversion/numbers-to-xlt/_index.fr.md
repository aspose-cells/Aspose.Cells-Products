---
title: C# NOMBRES en XLT - Convertisseur NOMBRES en XLT
description: Aspose Exceller. Convertissez des NUMÉROS en XLT rapidement et facilement avec Aspose.Cells. C# NUMÉROS en XLT. C# Enregistrez des NUMÉROS en XLT. Enregistrez des NUMÉROS sous XLT en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer les numéros au XLT dans C#" %}}

L'exemple suivant montre comment convertir NUMBERS en XLT en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en XLT par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en XLT en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir des NUMBERS en XLT" %}}
