...
{{< blocks/products/pf/i18n/upper-banner h1="NUMBERS konvertálása PDF-be a következőn keresztül: Java" h2="NUMBERS PDF Java konvertálása egyetlen vagy több oldal PDF formátumba konvertálásához az On-premise Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="SZÁMOK konvertálása PDF-be a következővel: Java" %}}

 SZÁMOK PDF-formátumba való rendereléséhez ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a NUMBERS PDF-be konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak NUMBERS fájlt PDF-be, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. NUMBERS fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat PDF kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott PDF-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="NUMBERS PDF-be Java Konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a NUMBERS fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.numbers");
// mentse el a NUMBERS-t PDF formátumban
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS PDF konvertálás élő bemutatók" sectionDescription="[NUMBERS konvertálása PDF-be](https://products.aspose.app/cells/conversion/numbers-to-pdf) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel NUMBERS fájlját, és azonnal PDF formátumba konvertálódik." >}}
