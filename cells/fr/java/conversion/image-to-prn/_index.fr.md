---
title: Java IMAGE en PRN - Convertisseur IMAGE en PRN en ligne
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir IMAGE en format de sauvegarde PRN. Java IMAGE au format PRN. Enregistrer l'IMAGE au PRN Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez IMAGE sur PRN au Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir IMAGE en PRN en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir IMAGE en PRN. Téléchargez votre fichier IMAGE, puis enregistrez-le simplement en tant que fichier PRN. Pour la lecture IMAGE et l'écriture PRN, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage du PRN de sortie seront identiques à ceux du document IMAGE d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir IMAGE en PRN en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir une image en PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE en PRN par programmation ? Les développeurs de Java peuvent facilement convertir IMAGE en PRN en seulement quelques lignes de code.
...
1.  Convertissez IMAGE en PRN en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de IMAGE en PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java bibliothèque pour convertir IMAGE en PRN" %}}
{{% blocks/products/pf/agp/text %}}
