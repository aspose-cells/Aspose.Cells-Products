---
title: تحويل XLSM إلى XLSX عبر تطبيق C++ 
url: /ar/cpp/conversion/xlsm-to-xlsx/ 
description: نموذج رمز تحويل C++ لمستند XLSM إلى تنسيق XLSX. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLSM إلى XLSX دفعة داخل أي تطبيق C++.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSM إلى XLSX باستخدام C++" %}}

 من أجل تحويل XLSM إلى XLSX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLSM إلى XLSX عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ بسهولة تحويل ملف XLSM إلى XLSX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLSM باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLSX).1. سيتم حفظ ملف XLSX في المسار المحدد.1. افتح ملف XLSX في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLSM إلى XLSX C++ شفرة مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل XLSM إلى XLSX" sectionDescription="[تحويل XLSM إلى XLSX](https://products.aspose.app/cells/conversion/xlsm-to-xlsx) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف XLSM الخاص بك ، وسيتم تحويله على الفور إلى XLSX." >}}
