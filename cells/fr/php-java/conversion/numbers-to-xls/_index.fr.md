---
title: Convertisseur de numéros PHP vers XLS
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir les nombres au format XLS, permettant un enregistrement transparent des données numériques au format XLS grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir les nombres en XLS en PHP" h2="Bibliothèque PHP haute vitesse pour la conversion des nombres au format XLS. Solution logicielle professionnelle pour l\'importation et l\'exportation de nombres, du format XLS et de nombreux autres formats via PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for PHP" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/php-java" installationsDocsLink="https://docs.aspose.com/cells/php-java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/php/" learnAsLink="https://docs.aspose.com/cells/php-java" apiReference="" mavenRepoLink="" >}}


{{% blocks/products/pf/agp/content h2="Convertir les nombres en XLS en utilisant PHP" %}}

 Comment convertir des nombres en XLS ? Grâce à la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir des nombres en XLS par programmation en quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) PHP Excel API permet de créer des applications multiplateformes capables de générer, modifier, convertir, afficher et imprimer tous les fichiers Excel. Outre la conversion entre différents formats de tableur, il peut également afficher les fichiers Excel sous forme d'images (PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT), ce qui en fait un outil idéal pour l'échange de documents aux formats standards.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrez des numéros au XLS en PHP" %}}

L'exemple suivant montre comment convertir des NOMBRES en XLS en PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des nombres en XLS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS au format XLS par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers NUMBERS au format XLS en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en XLS en appelant la méthode save de Workbook.
1.  Obtenez le résultat de la conversion de NUMBERS en XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir les nombres en XLS" %}}
