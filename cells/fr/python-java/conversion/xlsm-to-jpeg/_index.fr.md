...
description: Aspose Exceller. Convertissez XLSM en JPEG rapidement et facilement avec Aspose.Cells. Python XLSM en JPEG. Python Enregistrez XLSM en JPEG. Enregistrez XLSM sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLSM au JPEG au Python" %}}

L'exemple suivant montre comment convertir XLSM en JPEG dans Python.
