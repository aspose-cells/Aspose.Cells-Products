...
description: Aspose Excel. Převeďte XML do SPREADSHEETML rychle a snadno pomocí Aspose.Cells. C# XML do SPREADSHEETML. C# Uložit XML do SPREADSHEETML. Uložit XML jako SPREADSHEETML pomocí C#.
...
{{% cells-convert title="Ukázkový kód pro převod XML na SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xml" IsLandingPage="true" %}}
