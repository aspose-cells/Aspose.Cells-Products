...
description:  Aspose Excel. Java Szybko i łatwo utwórz plik MHT za pomocą Aspose.Cells. Wygeneruj plik MHT za pomocą Java. Utwórz MHT w Java. Java Kreator MHT.
...
1.  Zapisz skoroszyt w formacie MHT przy użyciu metody save().
