---
title:  Cerca il documento TSV senza aprirlo tramite C++
weight: 930
description: C++ codice di esempio per cercare parole con pattern nel file TSV su C++ Runtime Environment per Windows a 32 bit, Windows a 64 bit e Linux a 64 bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Cerca TSV Formati in C++" h2="Ricerca di documenti nativa e ad alte prestazioni TSV tramite API lato server Aspose.Cells for C++, senza l\'utilizzo di software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online TSV Cerca demo dal vivo" sectionDescription=" Cerca subito testo, parole, frasi all\'interno di TSV documenti visitando il nostro[Sito web delle demo dal vivo](https://products.aspose.app/cells/search). La demo live presenta i seguenti vantaggi" >}}
 ...
 Un formato di file Tab-Separated Values (TSV) rappresenta i dati separati da tabulazioni in formato testo normale. Il formato di file, simile al formato CSV, viene utilizzato per organizzare i dati in modo strutturato, al fine di importarli ed esportarli tra diverse applicazioni. Il formato viene utilizzato principalmente per l'importazione/esportazione e lo scambio di dati in fogli di calcolo e database. Ogni record in un file TSV è contenuto in una singola riga di testo, in cui ogni valore di campo è separato da un carattere di tabulazione. Il tipo di supporto per il formato di file TSV è text/tab-separated-values.
