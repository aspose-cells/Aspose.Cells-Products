...
{{% cells-convert title="PRN\'yi XLTM\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xltm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla XLTM\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PRN dosyalarını programlı olarak XLTM'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PRN'yi kolayca yükleyebilir ve XLTM'e dönüştürebilir.
