---
title: C# PRN naar SQL - PRN naar SQL-converter
description: Aspose Excel. Converteer PRN snel en eenvoudig naar SQL met Aspose.Cells. C# PRN naar SQL. C# PRN opslaan in SQL. Sla PRN op als SQL met behulp van C#.
...
{{% blocks/products/pf/agp/content h2="Sla PRN op in SQL in C#" %}}

In het volgende voorbeeld ziet u hoe u PRN naar SQL converteert in C#.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PRN naar SQL te converteren. Upload uw PRN-bestand en sla het vervolgens eenvoudig op als SQL-bestand. Voor zowel PRN-lezen als SQL-schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De uitvoer-SQL-inhoud en opmaak zullen identiek zijn aan het originele PRN-document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Voorbeeldcode om PRN naar SQL te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN naar SQL converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u PRN-bestanden programmatisch naar SQL converteren? .NET-ontwikkelaars kunnen PRN eenvoudig in slechts een paar regels code laden en naar SQL converteren.
...
1.  Converteer PRN naar SQL door de Workbook.Save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van PRN naar SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliotheek om PRN naar SQL te converteren" %}}
