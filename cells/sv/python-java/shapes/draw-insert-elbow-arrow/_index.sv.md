---
title:  Hur man ritar eller infogar en armbågspilform i Excel med Python via Java
weight: 10
description: Rita eller infoga en armbågspil med Aspose.Cells' Python via Java API utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Hur man infogar en armbågspilform i Excel-fil med Python via Java" %}}

 För att infoga en armbågspilform i excel-filen använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga armbågspilar i Excel-fil med Python via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) för att infoga en form av en armbågspil i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Sätt in armbågspilform - Python via Java" offSpacer="" %}}
