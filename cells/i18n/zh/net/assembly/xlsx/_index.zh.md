...
1. 实例化 WorkbookDesigner 类1. 在任何工作表的任何单元格中设置标记1. 为 WorkbookDesigner 对象设置数据源1. 调用 WorkbookDesigner.Process 方法用数据填充模板1. 通过 WorkbookDesigner.Worbook.Save 方法以 XLSX 格式保存结果
