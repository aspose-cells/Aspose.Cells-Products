---
title: Convertir SXC en JSON via Java 

description: Exemple de code de conversion Java pour le format SXC en fichier JSON. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers JSON dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir SXC en JSON via Java" h2="Conversion SXC vers JSON Java pour convertir une ou plusieurs pages en JSON à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir SXC en JSON en utilisant Java" %}}

 Afin de rendre SXC en JSON, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SXC en JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier SXC en JSON en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier SXC avec une instance de la classe Workbook1. Créez une plage de données à exporter à l'aide de la méthode Cells.createRange1. Appelez la méthode JsonUtility.exportRangeToJson avec des références de Range & ExportRangeToJsonOptions1. Écrire les données String JSON dans le fichier via la méthode BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion SXC vers JSON Java" offSpacer="" %}}
