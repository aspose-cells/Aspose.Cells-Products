...
description: Sample Java conversion code for ODS format to TIFF file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to TIFF within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert ODS to TIFF Using Java" %}}
 ...
 In order to render ODS to TIFF, we’ll use
