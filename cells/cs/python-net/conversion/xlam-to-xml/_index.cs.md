...
{{% blocks/products/pf/agp/content h2="Převeďte XLAM na XML v Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit XLAM do XML v Python Online zdarma" %}}

Následující příklad ukazuje, jak převést XLAM na XML v Python via NET.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod XLAM do XML online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xml" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLAM do XML" %}}
