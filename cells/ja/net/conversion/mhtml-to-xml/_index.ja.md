...
{{% blocks/products/pf/agp/feature-section-col title="C#を介してMHTMLをXMLに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 .NET開発者は、わずか数行のコードでMHTMLファイルを簡単にロードしてXMLに変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookのインスタンスを含むMHTMLファイルをロードします1. Workbook.Saveメソッドを呼び出します1. パラメータとしてXML拡張子を持つ出力パスを渡す1. 結果のXMLファイルの指定されたパスを確認してください
...
{{% cells-convert title="MHTMLをXMLに変換するための無料のアプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="xml" IsLandingPage="true" %}}
