...
description: Aspose Unggul. Ubah XLTM menjadi TIFF dengan cepat dan mudah dengan Aspose.Cells. Python XLTM menjadi TIFF. Python Simpan XLTM menjadi TIFF. Simpan XLTM sebagai 07611134 81 menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah XLTM menjadi TIFF di Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTM hingga TIFF di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLTM menjadi TIFF di Python via NET.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLTM menjadi TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="tiff" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengubah XLTM menjadi TIFF" %}}
