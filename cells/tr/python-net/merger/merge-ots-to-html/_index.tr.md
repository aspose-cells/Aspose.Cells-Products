---
title:  OTS'yi HTML aracılığıyla Python ile birleştirin
url: /tr/python-net/merger/merge-ots-to-html/ 
description: OTS'yi HTML Online ile Ücretsiz Olarak Birleştirin. Ücretsiz Online OTS'den HTML'e Birleşme. OTS'yi Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS ve daha fazlasıyla birleştirin.
---
...
Aşağıdaki örnek, OTS'nin Python'de HTML ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="OTS\'yi hatta HTML ile birleştirmek için Ücretsiz Uygulama" InputFormat="ots" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
