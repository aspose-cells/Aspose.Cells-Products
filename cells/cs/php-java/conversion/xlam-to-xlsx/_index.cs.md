---
title: Konvertor PHP XLAM až XLSX - XLAM až XLSX
description: Aspose Excel. Převeďte XLAM na XLSX rychle a snadno pomocí Aspose.Cells. PHP XLAM na XLSX. PHP Uložte XLAM na XLSX. Uložte XLSX jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xlsx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na XLSX přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na XLSX programově? Vývojáři PHP mohou snadno načíst a převést XLAM na XLSX v několika řádcích kódu.
...
1.  Převeďte XLAM na XLSX voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na XLSX" %}}
