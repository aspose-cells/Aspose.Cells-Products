---
title: إنشاء ODS - إنشاء ملف ODS في Java
description: Aspose اكسل. Java أنشئ ملف ODS بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف ODS باستخدام Java. أنشئ ODS في Java. Java ODS Creator.
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء ODS في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف ODS في Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لإنشاء ملف ODS" %}}
{{% blocks/products/pf/agp/text %}}
