---
title: Converti CSV in XLAM tramite l'applicazione C++ 
url: /it/cpp/conversion/csv-to-xlam/ 
description: Esempio di codice di conversione C++ per un documento CSV in formato XLAM. I programmatori possono utilizzare questo codice sorgente per la conversione batch da CSV a XLAM all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire CSV in XLAM utilizzando C++" %}}

 Per convertire CSV in XLAM, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire CSV in XLAM tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente file CSV in XLAM in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file CSV utilizzando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XLAM).1. Il file XLAM verrà salvato nel percorso specificato.1. Apri il file XLAM nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da CSV a XLAM C++" offSpacer="" %}}
