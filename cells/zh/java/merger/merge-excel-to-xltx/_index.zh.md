...
{{< blocks/products/pf/i18n/upper-banner h1="合并EXCEL为XLTX via Java" h2="高速Java库，用于合并EXCEL到XLTX。使用我们的excel转换API在Java开发高级、平台独立的软件。这是导入和导出Excel、CSV、OpenOffice、PDF、HTML、图像、和许多其他 excel 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="EXCEL" additionalConversionTag="XLTX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Java在线免费合并EXCEL到XLTX" %}}

下面的例子演示如何将EXCEL合并到Java中的XLTX。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将EXCEL合并到XLTX。上传你的文件，调用Workbook.Combine方法合并文件，然后保存到XLTX文件。如果您在 Java 中开发代码，这将比听起来更简单。参见将 EXCEL 合并到 XLTX 的 Java 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费应用程序在线将 EXCEL 合并到 XLTX" InputFormat="xlsx" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
