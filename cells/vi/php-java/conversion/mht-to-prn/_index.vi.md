---
title: PHP MHT sang PRN - Công cụ chuyển đổi MHT sang PRN
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển PHP một phương pháp tích hợp đầy đủ để chuyển đổi định dạng MHT sang PRN, cho phép lưu dữ liệu MHT vào định dạng PRN một cách liền mạch bằng thư viện Aspose.Cells, tất cả đều thông qua mã PHP hiệu quả và có thể tùy chỉnh.
...
{{% cells-convert title="Ví dụ mã để chuyển đổi MHT sang PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="prn" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi MHT sang PRN bằng PHP" %}}

{{% blocks/products/pf/agp/text %}}

Bạn cần chuyển đổi các tệp MHT sang PRN bằng lập trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi MHT sang PRN chỉ với một vài dòng mã.
...
1.  Chuyển đổi MHT sang PRN bằng cách gọi phương thức save của Workbook.
1.  Nhận kết quả chuyển đổi từ MHT sang PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện PHP để chuyển đổi MHT sang PRN" %}}
