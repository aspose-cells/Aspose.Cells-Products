---
title:  Sloučit PRN na TXT přes C++
url: /cs/cpp/merger/merge-prn-to-txt/ 
description: Sloučit PRN na TXT Online zdarma. Online zdarma PRN na TXT Fúze. Sloučit PRN do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit PRN s TXT v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení PRN s číslem TXT online" InputFormat="prn" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
