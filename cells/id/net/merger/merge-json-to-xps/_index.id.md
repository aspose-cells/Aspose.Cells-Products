---
title: Gabung JSON ke XPS - Gabungkan JSON ke XPS di C#
url: /id/net/merger/merge-json-to-xps/ 
description: Aspose Unggul. C# Aspose.Cells. Free Online Merge JSON to XPS saveformat. C# Gabungkan format JSON menjadi XPS. Gabung JSON ke XPS di C#. JSON Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabung JSON ke XPS di C# Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan JSON ke XPS di Aspose.Cells for .NET.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan JSON ke XPS di C#" InputFormat="json" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JSON ke XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan JSON menjadi XPS secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan JSON ke XPS" %}}
