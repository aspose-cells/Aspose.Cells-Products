---
title: PHP JSON en SQL - Convertisseur JSON en SQL
description: Aspose Exceller. Convertissez JSON en SQL rapidement et facilement avec Aspose.Cells. PHP JSON en SQL. PHP Enregistrez JSON dans SQL. Enregistrez JSON au format SQL en utilisant PHP.
...
Besoin de convertir les fichiers JSON en SQL par programme ? Les développeurs PHP peuvent facilement charger et convertir JSON en SQL en quelques lignes de code.
...
1.  Convertissez JSON en SQL en appelant la méthode de sauvegarde du classeur.
