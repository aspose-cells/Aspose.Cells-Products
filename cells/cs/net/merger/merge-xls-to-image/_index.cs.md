...
url: /cs/net/merger/merge-xls-to-image/ 
...
Následující příklad ukazuje, jak sloučit XLS do IMAGE v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLS s IMAGE programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna ke sloučení XLS do IMAGE" %}}
