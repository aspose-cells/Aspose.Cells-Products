---
title: Создать MHT — создать файл MHT по номеру Java.
description:  Aspose Эксель. Java Быстро и легко создайте файл MHT с помощью Aspose.Cells. Создайте файл MHT с помощью Java. Создайте MHT в Java. Java MHT Creater.
...
{{% blocks/products/pf/agp/content h2="Как создать MHT в Java" %}}
...
1.  Сохраните книгу в формате MHT, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл MHT по номеру Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java библиотека для создания файла MHT" %}}
{{% blocks/products/pf/agp/text %}}
