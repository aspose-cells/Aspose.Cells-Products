...
description: Sample code for xlsm to jpg Python conversion. Use API example code for batch xlsm files to jpg conversion within Python application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert XLSM to JPG Using Python" %}}
 ...
 In order to convert XLSM to JPG, we will use
...
{{% cells-convert title="Free App and Sample Code to Convert XLSM to JPG" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx InputFormat=xlsm outformat=jpg IsLandingPage=true language=python %}}
