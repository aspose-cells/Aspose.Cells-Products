...
{{% cells-convert title="Exempelkod för att konvertera HTM till EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlsx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar HTM till EXCEL via C++" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera HTM-filer till EXCEL programmatiskt? C++-utvecklare kan enkelt konvertera HTM till EXCEL på bara några rader kod.
...
1.  Konvertera HTM till EXCEL genom att anropa metoden Save().
