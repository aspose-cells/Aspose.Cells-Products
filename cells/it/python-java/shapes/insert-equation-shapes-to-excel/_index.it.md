---
title: Inserisci forme di equazione in Excel utilizzando Python via Java
weight: 360
description: Python via Java codice sorgente per inserire forme di equazione in Excel.
...
{{% blocks/products/pf/agp/content h2="Come inserire forme di equazione in un file Excel utilizzando Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire forme di equazione nel file Excel utilizzando Python via Java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungi metodo](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) per inserire forme di equazione nel foglio di lavoro selezionato
...
{{% blocks/products/pf/agp/code-block title="Inserisci forme equazione - Python via Java" offSpacer="" %}}
