...
url: /cs/python-net/merger/merge-mht-to-fods/ 
...
Následující příklad ukazuje, jak sloučit MHT s FODS v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit MHT na FODS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
