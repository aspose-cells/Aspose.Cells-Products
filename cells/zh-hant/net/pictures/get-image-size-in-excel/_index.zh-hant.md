---
title: 在 Excel 中取得圖片/圖片大小 via .NET
weight: 10
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 Excel 中取得圖片/圖片大小。
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 取得 Excel 檔案中圖片/圖片大小的步驟" %}}
...
+ 透過工作表「圖片」屬性中的索引選擇圖片物件。
 + 有多種方法可以取得選定圖片物件的尺寸。下面列出了部分內容，更多資訊請參閱[MORE](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture/)注意：「寬度」和「高度」是Excel中顯示的尺寸，可能比原始圖片更大或更小。
    ...
    + [原始寬度](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture/originalwidth/)取得圖片的原始寬度，以像素為單位。
    + [原始高度](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture/originalheight/)取得圖片的原始高度，以像素為單位。
...
還有兩個與尺寸相關的屬性'WidthScale'和'HeightScale'，分別表示目前顯示寬度和高度與實際寬度和高度的百分比。
...
{{% blocks/products/pf/agp/code-block title="取得影像/圖片的大小 - C#" offSpacer="" %}}
