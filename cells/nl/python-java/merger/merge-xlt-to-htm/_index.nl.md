...
url: /nl/python-java/merger/merge-xlt-to-htm/ 
...
Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met HTM in Aspose.Cells for Python via Java.
...
Wilt u XLT programmatisch samenvoegen met HTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
