---
title: Gabungkan XLT menjadi XLTX - Gabungkan XLT menjadi XLTX menjadi Java
url: /id/java/merger/merge-xlt-to-xltx/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLT menjadi XLTX format simpan. Java Gabungkan format XLT menjadi XLTX. Gabungkan XLT menjadi XLTX di Java. XLT Gabungkan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan XLT menjadi XLTX via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan XLT menjadi XLTX. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="XLT" additionalConversionTag="XLTX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLT menjadi XLTX di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLT menjadi XLTX di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLT ke XLTX. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file XLTX. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan XLT menjadi XLTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLT menjadi XLTX di Java" InputFormat="xlt" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLT menjadi XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLT ke XLTX secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan XLT menjadi XLTX" %}}
