...
{{% blocks/products/pf/agp/feature-section-col title="Hur man skapar hög-låg-stäng aktiediagram via C#" %}}
...
1.  Ställ in[**Markör**](https://reference.aspose.com/cells/net/aspose.cells.charts/series/marker/) med inbyggd data.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Följande källkod visar hur man skapar en hög-låg-stäng aktiediagram till MS Excel XLSX-fil med C#." offSpacer="" %}}
