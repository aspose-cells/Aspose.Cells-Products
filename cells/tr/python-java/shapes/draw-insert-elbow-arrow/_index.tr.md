---
title:  Python via Java'i kullanarak Excel'e dirsek oku şekli nasıl çizilir veya eklenir?
weight: 10
description: Microsoft veya Open Office, Adobe PDF vb. gibi herhangi bir yazılım olmadan Aspose.Cells' Python via Java API'i kullanarak dirsek ok şeklini çizin veya ekleyin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java\'i kullanarak dirsek oku şeklini Excel\'e ekleyin" h2="Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan Aspose.Cells\' API\'i kullanarak dirsek oku şeklini ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java Kullanarak Excel Dosyasına Dirsek Ok Şekli Nasıl Eklenir?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java\'i kullanarak Excel dosyasına dirsek oku şekli ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Şekil koleksiyonunu kullanın[yöntem ekle](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) seçili çalışma sayfasına bir dirsek oku şekli eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Dirsek ok şeklini takın - Python via Java" offSpacer="" %}}
