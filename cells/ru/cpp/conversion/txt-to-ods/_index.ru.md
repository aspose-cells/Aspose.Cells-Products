---
title: Преобразование TXT в ODS через приложение C++ 

description: Пример кода преобразования C++ для документа TXT в формат ODS. Программисты могут использовать этот исходный код для пакетного преобразования TXT в ODS в любом приложении C++.
---
...
{{% blocks/products/pf/agp/content h2="Как преобразовать TXT в ODS с помощью C++" %}}

 Чтобы преобразовать TXT в ODS, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию TXT в ODS через C++" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики C++ могут легко преобразовать файл TXT в формат ODS, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл TXT с помощью Factory::CreateIWorkbook.1. Вызовите метод Сохранить().1. Передайте путь к выходному файлу с расширением (ODS).1. Файл ODS будет сохранен по указанному пути.1. Откройте файл ODS в совместимой программе.
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования TXT в ODS C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Преобразование TXT в ODS в реальном времени" sectionDescription="[Конвертировать TXT в ODS](https://products.aspose.app/cells/conversion/txt-to-ods) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Нет необходимости загружать Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать какой-либо код." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл TXT, и он будет мгновенно преобразован в формат ODS." >}}
