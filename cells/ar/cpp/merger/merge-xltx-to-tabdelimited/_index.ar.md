...
يوضح المثال التالي كيفية دمج XLTX إلى TABDELIMITED في Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 هل تحتاج إلى دمج XLTX في TABDELIMITED برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج XLTX إلى TABDELIMITED" %}}
