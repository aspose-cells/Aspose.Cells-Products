...
{{% blocks/products/pf/agp/content h2="Převést SPREADSHEETML na CSV pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit SPREADSHEETML na CSV v Python knihovně Excel" %}}

Následující příklad ukazuje, jak převést SPREADSHEETML na CSV v knihovně Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod SPREADSHEETML na CSV" %}}
