---
title:  แทรก RadioButton (การควบคุมฟอร์ม) ลงใน Excel โดยใช้ Python via java
weight: 60
description: Python via ซอร์สโค้ด java เพื่อแทรก RadioButton (การควบคุมฟอร์ม) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก RadioButton (การควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก RadioButton (การควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรก RadioButton (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก RadioButton (ตัวควบคุมแบบฟอร์ม) - Python via java" offSpacer="" %}}
