...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcombobox) to insert a ComboBox(Form control) in the selected worksheet
