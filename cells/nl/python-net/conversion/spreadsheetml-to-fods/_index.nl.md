---
title: Python SPREADSHEETML naar FODS - SPREADSHEETML naar FODS Converter
description: Aspose Excel. Python Excel. Converteer SPREADSHEETML snel en eenvoudig naar FODS met Aspose.Cells. Python SPREADSHEETML naar FODS. Python Sla SPREADSHEETML op naar FODS. Sla SPREADSHEETML op als FODS met behulp van de Excel-bibliotheek Python.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML converteren naar FODS in Python Excel-bibliotheek" %}}

Hoe converteer ik SPREADSHEETML naar FODS? Met de bibliotheek Aspose.Cells for Python via de bibliotheek NET kunt u SPREADSHEETML eenvoudig programmatisch naar FODS converteren met een paar regels code.[Aspose.Cells for Python via NET](https://pypi.org/project/aspose-cells-python/)is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardformaten.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="SPREADSHEETML opslaan in FODS in de Excel-bibliotheek Python" %}}

In het volgende voorbeeld ziet u hoe u SPREADSHEETML converteert naar FODS in de Excel-bibliotheek Python.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om SPREADSHEETML naar FODS te converteren. Upload uw SPREADSHEETML-bestand en sla het vervolgens eenvoudig op als FODS-bestand. Voor zowel het lezen van SPREADSHEETML als het schrijven van FODS kunt u volledig gekwalificeerde bestandsnamen gebruiken. De inhoud en opmaak van de uitvoer FODS zullen identiek zijn aan het originele SPREADSHEETML-document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Voorbeeldcode om SPREADSHEETML naar FODS te converteren via de Excel-bibliotheek Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="fods" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML converteren naar FODS" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u SPREADSHEETML-bestanden programmatisch naar FODS converteren? Python-ontwikkelaars kunnen SPREADSHEETML eenvoudig laden en converteren naar FODS in slechts een paar regels code.
...
1.  Converteer SPREADSHEETML naar FODS door de Workbook.save-methode aan te roepen.
1.  Haal het conversieresultaat van SPREADSHEETML op naar FODS.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om SPREADSHEETML te converteren naar FODS" %}}
