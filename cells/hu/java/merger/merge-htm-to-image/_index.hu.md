---
title: HTM egyesítése az IMAGE-val – HTM egyesítése az IMAGE-val a Java-ben
url: /hu/java/merger/merge-htm-to-image/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése a HTM-mel az IMAGE mentési formátumba. Java HTM kombinálása IMAGE formátummal. HTM egyesítése az IMAGE-val a Java-ben. HTM egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a HTM-et az IMAGE-val a Java-es online ingyenesen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a HTM-et az IMAGE-val a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTM és az IMAGE egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el az IMAGE fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely egyesíti a HTM-et az IMAGE-val.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTM és az IMAGE egyesítéséhez a Java számon" InputFormat="htm" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A HTM egyesítése az IMAGE via Java-es számmal" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTM-et az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a HTM és az IMAGE egyesítéséhez" %}}
