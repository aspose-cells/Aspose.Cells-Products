...
description: Aspose Excel. Python Aspose.Cells. Voeg XLS samen met het opslagformaat XLTX. Python Combineer het formaat XLS met XLTX. Voeg XLS samen met XLTX in Python. XLS Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met XLTX met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met XLTX in Python" %}}
...
{{% cells-merger title="Voorbeeldcode om XLS samen te voegen met XLTX in Python" InputFormat="xls" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLS samenvoegt met XLTX via Python" %}}
