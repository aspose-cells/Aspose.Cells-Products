---
title: Konwertuj SPREADSHEETML na JSON za pomocą aplikacji C++ 
url: /pl/cpp/conversion/spreadsheetml-to-json/ 
description: Przykładowy kod konwersji C++ dla dokumentu SPREADSHEETML do formatu JSON. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji SPREADSHEETML na JSON w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj SPREADSHEETML na JSON przez C++" h2="Wysokowydajna konwersja SPREADSHEETML do JSON przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SPREADSHEETML na JSON przy użyciu C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować SPREADSHEETML na JSON za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik SPREADSHEETML na JSON w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SPREADSHEETML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (JSON).1. Plik JSON zostanie zapisany pod określoną ścieżką.1. Otwórz plik JSON w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML do JSON C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja SPREADSHEETML na JSON na żywo w wersji demonstracyjnej" sectionDescription="[Konwertuj SPREADSHEETML na JSON](https://products.aspose.app/cells/conversion/spreadsheetml-to-json) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij plik SPREADSHEETML, zostanie on natychmiast przekonwertowany do formatu JSON." >}}
