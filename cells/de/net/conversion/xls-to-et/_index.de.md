---
title: C# XLS zu ET - XLS zu ET Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das ET-Format und ermöglicht das nahtlose Speichern von XLS-Daten im ET-Format mithilfe der Aspose.Cells-Bibliothek, alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS zu ET in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in ET in C# umrechnet.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um XLS in ET zu konvertieren. Laden Sie Ihre XLS-Datei hoch und speichern Sie sie dann einfach als ET-Datei. Sowohl zum Lesen von XLS als auch zum Schreiben von ET können Sie vollqualifizierte Dateinamen verwenden. Der ausgegebene ET-Inhalt und die Formatierung sind identisch mit dem ursprünglichen XLS-Dokument.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Beispielcode zur Umwandlung von XLS in ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in ET" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in ET konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in ET laden und konvertieren.
...
1.  Konvertieren Sie XLS in ET, indem Sie die Methode Workbook.Save aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# Bibliothek zur Konvertierung von XLS in ET" %}}
