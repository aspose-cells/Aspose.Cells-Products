...
{{% blocks/products/pf/agp/content h2="كيفية إدراج مستطيل في ملف Excel باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج المستطيل في ملف Excel عبر Python" %}}
...
+ استخدم طريقة إضافة Shapecollection لإدراج مستطيل في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل مستطيل - Python" offSpacer="" %}}
