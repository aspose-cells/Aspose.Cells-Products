---
title: XLSX belgesindeki metni C++ aracılığıyla arayın ve değiştirin
weight: 9570
description: Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı'ndaki XLSX dosyasındaki hassas bilgileri düzenlemek için C++ örnek kod.
