...
description: Aspose Unggul. Ubah OTS menjadi MHTML dengan cepat dan mudah menggunakan Aspose.Cells. C++ OTS menjadi MHTML. C++ Simpan OTS ke MHTML. Simpan OTS sebagai MHTML menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah OTS menjadi MHTML Menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengonversi OTS ke MHTML di C++.
...
Perlu mengonversi file OTS ke MHTML secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke MHTML hanya dalam beberapa baris kode.
...
1.  Ubah OTS menjadi MHTML dengan memanggil metode Save().
1.  Dapatkan hasil konversi OTS menjadi MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah OTS menjadi MHTML" %}}
