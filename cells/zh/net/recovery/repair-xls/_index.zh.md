...
url: /zh/net/recovery/repair-xls/ 
description: Aspose Excel。 C# Aspose.Cells。C# 修复xls文件。免费在线 xls 修复工具。修复损坏的 xls 文件。恢复 .NET 应用程序中损坏的 xls 文件。
...
{{< blocks/products/pf/i18n/upper-banner h1="修复C#中的XLS文件" h2="构建您自己的 .NET 应用程序以使用 .NET 修复 xls 文件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
需要以编程方式修复 xls 文件吗？ .NET 开发人员只需几行代码即可轻松加载和修复 xls 文件。
...
{{% cells-recovery title="免费应用程序和示例代码在线修复 XLS 文件" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="net" %}}    
    
{{% blocks/products/pf/agp/content h2=".NET库修复XLS文件" %}}
