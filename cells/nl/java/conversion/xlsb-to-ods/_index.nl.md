...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in ODS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar ODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar ODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar ODS? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar ODS met slechts een paar regels code.
