...
description: Aspose Excel. Convierta JPG a IMAGEN rápida y fácilmente con Aspose.Cells. Python JPG a IMAGEN. Python Guardar JPG en IMAGEN. Guarde JPG como IMAGEN usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde JPG en IMAGEN en Python" %}}

El siguiente ejemplo demuestra cómo convertir JPG a IMAGEN en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir JPG a IMAGEN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="png" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir JPG a IMAGEN" %}}
