...
description: Aspose エクセル。 Java Aspose.Cells。SPREADSHEETML を XLSB 保存形式にマージします。 Java SPREADSHEETML を XLSB 形式に結合します。 SPREADSHEETML を Java の XLSB にマージします。SPREADSHEETML をマージします。
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML を Java の XLSB にマージします" %}}
...
{{% cells-merger title="Java に SPREADSHEETML を XLSB にマージするサンプルコード" InputFormat="xml" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
