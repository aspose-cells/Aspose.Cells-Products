---
title: ODS dokumentum keresése megnyitás nélkül a C++-en keresztül
weight: 3300
description: C++ példakód a ODS fájlban található mintával rendelkező szavak kereséséhez a C++ futási környezetében Windows 32 bites, Windows 64 bites és Linux 64 bites rendszerekhez.
...
{{% blocks/products/pf/agp/content h2="Hogyan kereshetünk ODS fájlban a C++ cím használatával" %}}

 A ODS fájl kereséséhez a következőt fogjuk használni:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a ODS-es fájlok kereséséhez a C++-es mappában" %}}
...
+ Töltsd be a ODS fájlt a Workbook osztály használatával.
