---
title: Konwertuj XLSM na XPS za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlsm-to-xps/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSM do formatu XPS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSM do XPS w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSM na XPS przez C++" h2="Wysoce wydajna konwersja XLSM do XPS przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSM do XPS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XPS).1. Plik XPS zostanie zapisany pod określoną ścieżką.1. Otwórz plik XPS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSM do XPS C++ Kod źródłowy konwersji" offSpacer="" %}}
