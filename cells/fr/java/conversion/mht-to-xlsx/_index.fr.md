---
title: Java MHT à XLSX - Convertisseur en ligne MHT à XLSX
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertissez MHT en format de sauvegarde XLSX. Java MHT au format XLSX. Enregistrez MHT au XLSX Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez MHT au XLSX en Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir MHT en XLSX en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir MHT en XLSX. Téléchargez votre fichier MHT, puis enregistrez-le simplement en tant que fichier XLSX. Pour la lecture MHT et l'écriture XLSX, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie XLSX seront identiques au document MHT d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir MHT en XLSX en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHT en XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en XLSX par programmation ? Les développeurs Java peuvent facilement convertir MHT en XLSX en quelques lignes de code seulement.
