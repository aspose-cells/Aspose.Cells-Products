...
weight: 5410
description: C#-broncode om watermerk toe te voegen of te verwijderen aan het XLSB-bestand op .NET Framework, .NET Core, Mono of Xamarin-platforms.
...
{{% blocks/products/pf/agp/content h2="Hoe u het XLSB-bestand van een watermerk kunt voorzien met behulp van C#" %}}
...
+ Bewaar werkmap in XLSB-formaat
...
{{% blocks/products/pf/agp/code-block title="Voeg watermerk toe aan XLSB - C#" offSpacer="" %}}
