---
title: C# HTML から POWERPOINT - HTML から POWERPOINT コンバーター
description: Aspose エクセル。 Aspose.Cellsを使用して、HTMLをPOWERPOINTにすばやく簡単に変換します。C# HTMLをPOWERPOINTに変換します。 C# HTMLをパワーポイントに保存します。 C#を使用してHTMLをPOWERPOINTとして保存します。
...
{{% blocks/products/pf/agp/content h2="HTML を C# の POWERPOINT に保存します" %}}

次の例は、HTML を C# の POWERPOINT に変換する方法を示しています。
...
{{% cells-convert title="HTMLをPOWERPOINTに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTMLを経由してHTMLをPOWERPOINTに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで POWERPOINT に変換する必要がありますか? .NET 開発者は、わずか数行のコードで HTML を簡単にロードして POWERPOINT に変換できます。
