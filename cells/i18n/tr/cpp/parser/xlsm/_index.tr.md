---
title: C++ aracılığıyla XLSM belgesinden metin ve resim ayıklayın 
weight: 570
url: /tr/cpp/parser/xlsm/ 
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Runtime Environment'daki XLSM dosyasından metin ve resim ayıklamak için örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ içinde XLSM Biçimlerini Ayrıştırma" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan C++ API\'ler için sunucu tarafı Aspose.Cells kullanılarak yerel ve yüksek performanslı XLSM belge ayrıştırma." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak XLSM Dosyasını Ayrıştırma" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ içinde XLSM Dosyalarını Ayrıştırma Adımları" %}}
