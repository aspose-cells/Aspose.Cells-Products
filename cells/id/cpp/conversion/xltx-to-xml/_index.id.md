...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke XML di C++" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX ke XML di C++.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLTX ke XML melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file XLTX ke XML secara terprogram? Pengembang C++ dapat dengan mudah mengkonversi XLTX ke XML hanya dengan beberapa baris kode.
...
1. Konversikan XLTX ke XML dengan memanggil metode Save().
1.  Dapatkan hasil konversi XLTX ke XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ perpustakaan untuk mengkonversi XLTX ke XML" %}}
