---
title: Creëer SXC - Creëer SXC bestand in Python
description: Aspose Excel. Python Creëer SXC-bestand. Creëer SXC Python. Python SXC Maker. Maak SXC in Python. Genereer SXC-bestand met Python.
...
1. Gebruik de methode Save om de werkmap op te slaan als SXC-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een SXC-bestand maakt in Python." offSpacer="" %}}
