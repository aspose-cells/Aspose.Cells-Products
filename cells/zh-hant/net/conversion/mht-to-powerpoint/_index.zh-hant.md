---
title: C# MHT 到 POWERPOINT - 在線 MHT 到 POWERPOINT 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 MHT 轉換為 POWERPOINT 保存格式。 C# MHT 到 POWERPOINT 格式。將 MHT 保存到 POWERPOINT C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 C# 中的 MHT 轉換為 POWERPOINT" h2="用於將 MHT 轉換為 POWERPOINT 的高速 C# 庫。這是一款專業的軟件解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上導入和導出 MHT、POWERPOINT 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POWERPOINT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線將 MHT 保存到 C# 中的 POWERPOINT" %}}

以下示例演示如何將 C# 中的 MHT 轉換為 POWERPOINT。
...
{{% cells-convert title="將 MHT 在線轉換為 POWERPOINT 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 轉換為 POWERPOINT" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 POWERPOINT？ .NET 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 POWERPOINT。
...
{{% blocks/products/pf/agp/content h2="C# 將 MHT 轉換為 POWERPOINT 的庫" %}}
