---
title:  Fusionner TXT à JSON via Java
url: /fr/java/merger/merge-txt-to-json/ 
description: Fusionnez TXT à JSON en ligne gratuitement. Gratuit en ligne TXT à JSON Fusion. Fusionnez TXT vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner TXT à JSON dans Java.
...
{{% cells-merger title="Application gratuite pour fusionner TXT à JSON en ligne" InputFormat="txt" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
