---
title: 將方程式形狀插入 Excel via .NET
weight: 360
description: C# 使用 .NET 函式庫為 Excel 新增或插入方程式形狀的範例程式碼。使用此程式碼可在 VB.NET、Asp.NET 或任何基於 .NET 的應用程式中的 MS Excel 中建立方程式形狀。
keywords: [C# Aspose.Cells., c# add equation shapes., c# insert equation shapes., c# create equation shapes]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="將方程式形狀插入 Excel via .NET" h2="使用 Aspose.Cells\' API 插入方程式形狀，無需使用 Microsoft 或 Open Office、Adobe PDF 等任何軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ 透過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape)在選定的工作表中插入方程式形狀
以 XLSX 格式儲存工作簿。
