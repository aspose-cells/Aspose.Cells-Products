...
description: Aspose Эксель. Преобразуйте XLTM в XLTX быстро и легко с помощью Aspose.Cells. PHP XLTM в XLTX. PHP Сохраните XLTM в XLTX. Сохраните XLTM как XLTX с помощью PHP.
...
{{% blocks/products/pf/agp/content h2="Сохраните от XLTM до XLTX в PHP." %}}
...
Нужно программно преобразовать файлы XLTM в XLTX? Разработчики PHP могут легко загрузить и преобразовать XLTM в XLTX всего за несколько строк кода.
...
1.  Преобразуйте XLTM в XLTX, вызвав метод сохранения книги.
1.  Получите результат преобразования XLTM в XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования XLTM в XLTX" %}}
