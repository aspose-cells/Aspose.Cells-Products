---
title: Vytvořit ET – Vytvořte soubor ET v C++
description: Aspose Excel. Snadno generujte a manipulujte se soubory ET pomocí knihovny Aspose.Cells for C++. Tato výkonná knihovna API poskytuje efektivní a zjednodušené řešení pro vytváření, úpravu a správu souborů ET přímo ve vašich aplikacích C++ a splňuje specifické potřeby vývojářů s vysokou přesností.
...
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořit soubor ET v C++" h2="Nativní a vysoce výkonné vytváření ET souborů programově bez použití Micorsoft Office s využitím knihovny C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit ET v C++" %}}

{{% blocks/products/pf/agp/text %}}

Pro vývojáře je snadné vytvářet, načítat, upravovat a převádět soubory ET v rámci spuštěných aplikací pro tvorbu reportů pro zpracování dat pomocí několika řádků kódu.
...
1.  Uložte sešit jako soubor .et pomocí metody Save().

{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor ET v adresáři C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro vytvoření souboru ET" %}}
