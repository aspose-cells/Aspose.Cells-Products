...
{{% cells-convert title="ODS\'i MARKDOWN\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="md" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i C++ aracılığıyla MARKDOWN\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

ODS dosyalarını program aracılığıyla MARKDOWN'e dönüştürmeniz mi gerekiyor? C++ geliştiricileri, yalnızca birkaç satır kodla ODS'i MARKDOWN'e kolayca dönüştürebilir.
...
1.  Save() yöntemini çağırarak ODS'i MARKDOWN'e dönüştürün.
