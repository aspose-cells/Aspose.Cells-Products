---
title: Gộp MHTML vào EMF - Gộp MHTML vào EMF vào C#
url: /vi/net/merger/merge-mhtml-to-emf/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất MHTML thành EMF saveformat. C# Kết hợp định dạng MHTML thành EMF. Hợp nhất MHTML thành EMF vào C#. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML thành EMF vào C#" %}}

Ví dụ sau đây minh họa cách hợp nhất MHTML với EMF trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất MHTML thành EMF. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp EMF. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất MHTML thành EMF.
...
{{% blocks/products/pf/agp/content h2="Cách gộp MHTML vào EMF qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp MHTML thành EMF" %}}
