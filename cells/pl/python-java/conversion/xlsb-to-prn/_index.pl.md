...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLSB do formatu PRN, umożliwiając bezproblemowe zapisywanie danych XLSB w formacie PRN przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLSB na PRN za pomocą biblioteki Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB w PRN w Python Bibliotece Excel" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSB na PRN w bibliotece Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteka Excel do konwersji XLSB na PRN" %}}
