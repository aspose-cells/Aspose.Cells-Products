---
title: EXCEL'i SPREADSHEETML ile birleştir - Java'de EXCEL'i SPREADSHEETML ile birleştir
url: /tr/java/merger/merge-excel-to-spreadsheetml/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i SPREADSHEETML kaydetme biçimiyle birleştirin. Java EXCEL'i SPREADSHEETML biçimiyle birleştirin. Java'de EXCEL'i SREADSHEETML ile birleştir. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i SREADSHEETML ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de EXCEL'in SPREADSHEETML ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="Java\'de EXCEL\'i SPREADSHEETML ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i SPREADSHEETML via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java EXCEL\'i SPREADSHEETML ile birleştirmek için kütüphane" %}}
