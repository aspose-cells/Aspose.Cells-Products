---
title: A ODS egyesítése XML-be – a ODS egyesítése XML-be a C++-ben
url: /hu/cpp/merger/merge-ods-to-xml/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítés ODS XML mentési formátumba. C++ A ODS kombinálása XML formátumba. A ODS egyesítése XML-be a C++-ben. ODS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a ODS-et XML-be a C++-ben online" %}}

A következő példa bemutatja, hogyan egyesítheti a ODS-et XML-be a Aspose.Cells for C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a ODS XML-be olvasztásához. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el XML-fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++ példát, amely egyesíti a ODS-et XML-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a ODS egyesítéséhez XML-be C++-ben" InputFormat="ods" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A ODS egyesítése XML-be a C++-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a ODS-et XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a ODS XML-be olvasztásához" %}}
