...
description: Aspose Excel. A ODS-es számot gyorsan és egyszerűen konvertálja OTS-re a Aspose.Cells-es számmal. C++ ODS OTS-re. C++ Mentse a ODS számot az OTS-nél. Mentse el a ODS számot OTS-ként a C++ használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse el a ODS számot az OTS számára a C++ számon" %}}
...
A ODS fájlokat programozottan OTS-re kell konvertálnia? A C++ fejlesztők könnyedén konvertálhatják a ODS-et OTS-re, mindössze néhány sornyi kóddal.
