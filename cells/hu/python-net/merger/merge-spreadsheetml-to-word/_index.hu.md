---
title: SPREADSHEETML egyesítése a WORD-dal – a SPREADSHEETML egyesítése a WORD-dal a Python-ben
url: /hu/python-net/merger/merge-spreadsheetml-to-word/ 
description: Aspose Excel. Python Aspose.Cells. Ingyenes online egyesítése SPREADSHEETML WORD mentési formátumba. Python A SPREADSHEETML egyesítése WORD formátumba. A SPREADSHEETML egyesítése a WORD fájllal a Python-ben. SPREADSHEETML Egyesítés.
...
A következő példa bemutatja, hogyan lehet egyesíteni a SPREADSHEETML-t a WORD-dal a Aspose.Cells for Python via .NET-ben.
...
{{% cells-merger title="Ingyenes online a SPREADSHEETML és a WORD egyesítése a Python-es számban" InputFormat="xml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A SPREADSHEETML egyesítése a WORD-ba a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SPREADSHEETML-t a WORD-dal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
