...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إضافة علامة مائية إلى XLSB عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. قم بإنشاء كائن مصنف جديد1. حدد ورقة العمل عبر الفهرس الخاص بها1. قم بإنشاء شكل واستخدم دالة addTextEffect الخاصة به1. ضبط الألوان والشفافية والمزيد1. احفظ المصنف بتنسيق XLSB
...
{{% blocks/products/pf/agp/code-block title="إضافة علامة مائية إلى XLSB - Java" offSpacer="" %}}
