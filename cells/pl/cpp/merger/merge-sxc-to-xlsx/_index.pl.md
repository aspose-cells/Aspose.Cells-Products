---
title:  Połącz SXC z XLSX przez C++
...
Poniższy przykład pokazuje, jak połączyć SXC z XLSX w C++.
...
{{% cells-merger title="Darmowa aplikacja do łączenia SXC z XLSX on-line" InputFormat="sxc" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
