...
{{% blocks/products/pf/agp/content h2="Как вставить/создать блок-схему в файл Excel, используя Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке/созданию файла блок-схемы в Excel с использованием Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Вставка/создание блок-схемы — Python via .Net" offSpacer="" %}}
