...
{{% blocks/products/pf/agp/content h2="Τρόπος εισαγωγής TextBox σε αρχείο Excel χρησιμοποιώντας Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την εισαγωγή του TextBox στο αρχείο Excel χρησιμοποιώντας το Python via .Net" %}}
...
+ Επιλέξτε Φύλλο εργασίας μέσω του ευρετηρίου του.
 + Χρησιμοποιήστε την προσθήκη της shapecollection[μέθοδος](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_text_box/#int-int-int-int-int-int) για να εισαγάγετε ένα πλαίσιο κειμένου στο επιλεγμένο φύλλο εργασίας.
...
{{% blocks/products/pf/agp/code-block title="Εισαγωγή TextBox - Python via .Net" offSpacer="" %}}
