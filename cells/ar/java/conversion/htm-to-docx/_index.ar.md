---
title: تحويل Java HTM إلى DOCX - تحويل HTM إلى DOCX
description: Aspose اكسل. قم بتحويل HTM إلى DOCX بسرعة وسهولة باستخدام Aspose.Cells. Java HTM إلى DOCX. Java احفظ HTM إلى DOCX. احفظ HTM كـ DOCX باستخدام Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل HTM إلى DOCX في Java" h2="مكتبة Java عالية السرعة لتحويل HTM إلى DOCX. هذا حل برمجي احترافي لاستيراد وتصدير HTM وDOCX والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في DOCX في Java" %}}

يوضح المثال التالي كيفية تحويل HTM إلى DOCX في Java.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل HTM إلى DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="docx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل HTM إلى DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات HTM إلى DOCX برمجياً؟ يمكن لمطوري Java تحويل HTM بسهولة إلى DOCX في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل HTM إلى DOCX عن طريق استدعاء أسلوب Workbook.save.
1.  احصل على نتيجة تحويل HTM إلى DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل HTM إلى DOCX" %}}
{{% blocks/products/pf/agp/text %}}
