...
weight: 7690
description: C# Ukázkový kód pro generování dokumentů XLSM s kontingenčním grafem. Tento kód použijte k vytváření souborů Microsoft Excel XLSM s kontingenčním grafem v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Generování souboru MS Excel XLSM s kontingenčním grafem dynamicky v rámci běžící aplikace je snadné. Abychom mohli vytvořit XLSM dokumentů s kontingenčním grafem od nuly bez nutnosti MS Office, použijeme
