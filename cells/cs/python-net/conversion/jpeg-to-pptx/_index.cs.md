...
Následující příklad ukazuje, jak převést JPEG na PPTX v Python via NET.
...
{{% blocks/products/pf/agp/content h2="Jak převést JPEG na PPTX" %}}
