---
title: PHP OTS naar JPEG - OTS naar JPEG Converter
description: Aspose Excel. Converteer OTS snel en eenvoudig naar JPEG met Aspose.Cells. PHP OTS naar JPEG. PHP Bewaar OTS naar JPEG. Sla OTS op als JPEG met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar JPEG te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar JPEG converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar JPEG in slechts een paar regels code.
...
1.  Converteer OTS naar JPEG door de opslagmethode van Workbook aan te roepen.
1.  Ontvang het conversieresultaat van OTS naar JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om OTS naar JPEG te converteren" %}}
