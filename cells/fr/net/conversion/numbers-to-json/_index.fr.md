...
Besoin de convertir des fichiers NUMBERS en JSON par programme ? Les développeurs .NET peuvent facilement charger et convertir des NUMBERS en JSON en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en JSON en appelant la méthode Workbook.Save.
