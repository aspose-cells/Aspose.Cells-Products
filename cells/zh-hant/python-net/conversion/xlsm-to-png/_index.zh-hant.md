...
description: Aspose Excel。 Python Excel。使用 Aspose.Cells 快速輕鬆地將 XLSM 轉換為 PNG。Python XLSM 轉換為 PNG。Python 將 076193417619301 將存 076112第3481章 使用Python Excel庫。
...
{{% blocks/products/pf/agp/content h2="將 Python Excel 庫中的 XLSM 轉換為 PNG" %}}
...
{{% blocks/products/pf/agp/content h2="將 XLSM 儲存到 Python Excel 庫中 PNG" %}}

下面的範例示範如何在Python Excel庫中將XLSM轉換為PNG。
...
{{% cells-convert title="透過 Python Excel 函式庫將 XLSM 轉換為 PNG 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="png" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 XLSM 轉換為 PNG" %}}
