---
title: XLSB to MHT - Convert XLSB to MHT files Python via Python
...
{{% blocks/products/pf/agp/content h2="Convert XLSB to MHT in Python" %}}
...
The following example demonstrates how to convert XLSB to MHT in Python via NET.
