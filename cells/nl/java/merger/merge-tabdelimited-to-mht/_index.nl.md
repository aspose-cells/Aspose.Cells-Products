---
title: TABDELLIMITED samenvoegen met MHT - Combineer TABDELLIMITED met MHT in Java
url: /nl/java/merger/merge-tabdelimited-to-mht/ 
description: Aspose Excel. Java Aspose.Cells. TABDELIMITED samenvoegen naar MHT-opslagformaat. Java Combineer TABDELIMITED naar MHT-formaat. TABDELLIMITED samenvoegen met MHT in Java. TABDELLIMITED Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg TABDELIMITED samen met MHT in Java" %}}

In het volgende voorbeeld ziet u hoe u TABDELLIMITED kunt samenvoegen met MHT in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TABDELLIMITED samen te voegen met MHT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een MHT-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie het voorbeeld Java waarin TABDELLIMITED wordt samengevoegd met MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode voor het samenvoegen van TABDELIMITED naar MHT in Java" InputFormat="tsv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TABDELLIMITED samenvoegen met MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TABDELLIMITED programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java-bibliotheek om TABDELLIMITED samen te voegen met MHT" %}}
