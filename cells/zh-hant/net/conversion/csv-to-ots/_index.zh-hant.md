...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 CSV 轉換為 OTS。C# CSV 轉換為 OTS。 C# 將 CSV 儲存到 OTS。使用 C# 將 CSV 儲存為 OTS。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 CSV 轉換為 C# 中的 OTS" h2="用於將 CSV 轉換為 OTS 的高速 C# 庫。這是一款專業的軟體解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 CSV、OTS 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將 CSV 儲存到 C# 中的 OTS" %}}
...
{{% cells-convert title="將 CSV 轉換為 OTS 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="ots" IsLandingPage="true" %}}
