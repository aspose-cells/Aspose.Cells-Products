...
title: 透過C++解鎖ODS文檔
weight: 1190
description: C++ 用於解鎖 C++ 運行時環境中受密碼保護的 ODS 檔案的範例代碼，適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 解鎖 ODS 文件" h2="使用 C++ 庫刪除 Excel 電子表格（包括 ODS 檔案）的保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 刪除 ODS 檔案的保護" %}}
