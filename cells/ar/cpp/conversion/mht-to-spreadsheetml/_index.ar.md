...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ملف MHT إلى ملف SPREADSHEETML في C++" h2="تحويل عالي الأداء من MHT إلى SPREADSHEETML باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
هل تحتاج إلى تحويل ملفات MHT إلى SPREADSHEETML برمجيًا؟ يمكن للمطورين (C++) تحويل ملفات MHT إلى SPREADSHEETML بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل ملف MHT إلى ملف SPREADSHEETML عن طريق استدعاء الدالة Save().
