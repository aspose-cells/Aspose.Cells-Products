---
title: Convert XLSB to Byte Array via C# 
weight: 7690
url: /net/conversion/xlsb-to-byte-array/ 
description: C# Sample code for XLSB to Byte Array conversion. Use this code for Excel XLSB to Byte Array conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLSB to byte array via C#" h2="Native and high performance Microsoft Excel XLSB to byte array conversion or vice versa for spreadsheets data processing using server side .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert XLSB to Byte Array via C#" %}}
...
1.  Load input XLSB File using Workbook
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XLSB to byte array C# Conversion" offSpacer="" %}}
