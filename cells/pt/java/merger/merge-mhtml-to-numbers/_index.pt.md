---
title:  Mescle MHTML com os NÚMEROS via Java
url: /pt/java/merger/merge-mhtml-to-numbers/ 
description: Mesclar MHTML para NUMBERS Online gratuitamente. Online grátis MHTML para Fusão de NÚMEROS. Mesclar MHTML para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar MHTML com NUMBERS em Java.
...
{{% cells-merger title="Aplicativo gratuito para mesclar MHTML para NUMBERS online" InputFormat="mhtml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
