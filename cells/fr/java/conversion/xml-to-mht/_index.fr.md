...
{{% blocks/products/pf/agp/content h2="Enregistrer le XML au format MHT dans Java" %}}

L'exemple suivant montre comment convertir du XML en MHT en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir du XML en MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en MHT par programmation ? Les développeurs Java peuvent facilement convertir des fichiers XML en MHT en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir XML en MHT" %}}
{{% blocks/products/pf/agp/text %}}
