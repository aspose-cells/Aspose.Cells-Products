...
È necessario convertire i file PRN in XLTM a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in XLTM in poche righe di codice.
...
1.  Converti PRN in XLTM chiamando il metodo Save().
