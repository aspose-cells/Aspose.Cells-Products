---
title: Gộp XLSX vào OTS - Gộp XLSX vào OTS trong C#
url: /vi/net/merger/merge-xlsx-to-ots/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất XLSX vào định dạng lưu OTS. C# Kết hợp XLSX sang định dạng OTS. Hợp nhất XLSX thành OTS vào C#. XLSX Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLSX vào OTS vào C#" %}}

Ví dụ sau đây minh họa cách hợp nhất XLSX với OTS trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XLSX với OTS. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp OTS. Nếu bạn phát triển mã theo số C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất XLSX với OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp XLSX vào OTS năm C#" InputFormat="xlsx" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp XLSX vào OTS qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất XLSX vào OTS theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất XLSX vào OTS" %}}
