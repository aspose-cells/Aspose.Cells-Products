---
title: Voeg XLSM samen met XLS - Combineer XLSM met XLS in Python
url: /nl/python-java/merger/merge-xlsm-to-xls/ 
description: Aspose Excel. Python Excel. Voeg XLSM samen met het opslagformaat XLS. Python Combineer het formaat XLSM met XLS. Voeg XLSM samen met XLS in de Excel-bibliotheek Python. XLSM Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLSM samen te voegen met XLS" %}}
