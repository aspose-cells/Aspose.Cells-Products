---
title: Převést CSV na XLTM přes Java 
weight: 7170
url: /cs/java/conversion/csv-to-xltm/ 
description: Ukázkový konverzní kód Java pro formát CSV na soubor XLTM. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do XLTM v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést CSV na XLTM přes Java" h2="Převod CSV na XLTM Java pro převod jedné nebo více stránek na XLTM pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na XLTM pomocí Java" %}}

 K vykreslení CSV do XLTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu CSV na XLTM prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na XLTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLTM a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLTM
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na XLTM Java" offSpacer="" %}}

```cs
// načíst soubor CSV v instanci sešitu
Workbook book = new Workbook("template.csv");
// uložit CSV jako XLTM
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze CSV na XLTM" sectionDescription="[Převést CSV na XLTM](https://products.aspose.app/cells/conversion/csv-to-xltm) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor CSV, bude okamžitě převeden na XLTM." >}}
