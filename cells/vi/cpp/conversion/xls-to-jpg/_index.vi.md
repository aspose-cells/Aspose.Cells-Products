---
title: C++ XLS sang JPG - XLS sang JPG Chuyển đổi
description: Aspose Excel. Chuyển đổi XLS sang JPG nhanh chóng và dễ dàng với Aspose.Cells. C++ XLS sang JPG. C++ Lưu XLS sang JPG. Lưu XLS dưới dạng JPG bằng C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS sang JPG trong C++" h2="Chuyển đổi XLS sang JPG hiệu suất cao bằng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS sang JPG vào C++" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLS sang JPG trong C++.
...
{{% cells-convert title="Mã mẫu để chuyển đổi XLS sang JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS sang JPG qua C++" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLS sang JPG theo chương trình? Các nhà phát triển C++ có thể dễ dàng chuyển đổi XLS sang JPG chỉ bằng vài dòng mã.
...
1.  Chuyển đổi XLS sang JPG bằng cách gọi phương thức Save().
1.  Nhận kết quả chuyển đổi XLS sang JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C++ để chuyển đổi XLS sang JPG" %}}
