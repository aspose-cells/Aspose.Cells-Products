---
title:  Wyszukaj i zamień tekst w dokumencie XLSM via Java
weight: 1590
description: Java przykładowy kod służący do redagowania poufnych informacji w pliku XLSM w środowisku wykonawczym Java dla aplikacji JSP/JSF i aplikacji komputerowych.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Zredaguj XLSM Formaty w Java" h2="Natywne i wydajne XLSM dokumentują poufne informacje redakcyjne przy użyciu interfejsów API po stronie serwera Aspose.Cells for Java, bez użycia oprogramowania, takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/code-block title="Zredaguj XLSM Pliki - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSM Redakcja Prezentacje na żywo" sectionDescription=" Wyszukaj i zamień tekst w treści, komentarzach lub metadanych w dokumentach XLSM już teraz, odwiedzając naszą[Strona demonstracyjna na żywo](https://products.aspose.app/cells/redaction). Demo na żywo ma następujące zalety" >}}
