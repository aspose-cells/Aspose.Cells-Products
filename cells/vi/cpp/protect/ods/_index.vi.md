...
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa Tệp ODS qua C++" h2="Các bảng tính Excel được bảo vệ bằng mật khẩu bao gồm định dạng ODS bằng cách sử dụng .NET Thư viện." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1. Tải tệp ODS bằng lớp IWorkbook1. Sử dụng phương thức Protect (..) với ProtectionType và Password1. Lưu tệp ODS được bảo vệ bằng phương thức Save ()
