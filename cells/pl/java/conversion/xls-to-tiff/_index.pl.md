...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na TIFF za pomocą Java" %}}

 Aby wyrenderować XLS do TIFF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLS na TIFF za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik XLS na TIFF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLS z instancją Workbook1. Wybierz domyślny lub dowolny arkusz z kolekcji1. Utwórz i ustaw obiekt ImageOrPrintOptions1. Utwórz SheetRender z obiektami Worksheet i ImageOrPrintOptions1. Wywołaj metodę SheetRender.toImage, aby zapisać wynik w formacie TIFF
...
{{% blocks/products/pf/agp/code-block title="XLS do TIFF Java Kod źródłowy konwersji" offSpacer="" %}}
