...
{{% cells-convert title="Przykładowy kod do konwersji JPG na HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="html" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować JPG na HTML przez C++" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki JPG na HTML? Programiści C++ mogą z łatwością przekonwertować JPG na HTML w zaledwie kilku linijkach kodu.
...
1.  Konwertuj JPG na HTML, wywołując metodę Save().
