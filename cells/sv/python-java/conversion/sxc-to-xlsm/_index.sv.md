---
title: Konvertera SXC till XLSM via Python
url: /sv/python-java/conversion/sxc-to-xlsm/
description: Exempelkod för konvertering från sxc till xlsm Python. Använd API exempelkod för batch-sxc-filer till xlsm-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till XLSM med Python" %}}

 För att konvertera SXC till XLSM kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till XLSM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera SXC-filer till XLSM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SXC-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med XLSM-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande XLSM-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera SXC till XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlsm" IsLandingPage="true" language="python" %}}
