...
{{% blocks/products/pf/agp/content h2="So entfernen Sie die Schutz-XLSX-Datei mit Java" %}}

 Um die XLSX-Datei zu entsperren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Entsperren von XLSX über Java" %}}
