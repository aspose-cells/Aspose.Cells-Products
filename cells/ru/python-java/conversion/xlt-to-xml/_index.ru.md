...
{{% blocks/products/pf/agp/content h2="Преобразование XLT в XML с помощью Python" %}}
...
В следующем примере показано, как преобразовать XLT в XML в Python.
