---
title: Объединить HTM с SPREADSHEETML — Объединить HTM с SPREADSHEETML в Java.
url: /ru/java/merger/merge-htm-to-spreadsheetml/ 
description: Aspose Эксель. Java Aspose.Cells. Объедините HTM с форматом сохранения SPREADSHEETML. Java Объединить HTM в формат SPREADSHEETML. Объедините HTM с SPREADSHEETML в Java. HTM Merge.
...
{{% blocks/products/pf/agp/content h2="Объедините HTM с SPREADSHEETML в номере Java." %}}

В следующем примере показано, как объединить HTM с SPREADSHEETML в Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить HTM с SPREADSHEETML. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл SPREADSHEETML. Если вы разработаете код Java, это будет проще, чем кажется. См. пример Java, в котором HTM объединяется с SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения HTM и SPREADSHEETML в Java" InputFormat="htm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Как объединить HTM с SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить HTM и SPREADSHEETML? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for Java](https://products.aspose.com/cells/java) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Java библиотека для объединения HTM и SPREADSHEETML" %}}
