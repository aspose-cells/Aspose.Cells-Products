...
{{% blocks/products/pf/agp/content h2="Převeďte SPREADSHEETML na PDF pomocí Python" %}}
...
Následující příklad ukazuje, jak převést SPREADSHEETML na PDF v Python.
