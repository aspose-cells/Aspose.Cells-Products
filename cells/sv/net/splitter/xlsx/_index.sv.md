---
title:  Split XLSX Filer via .NET
weight: 1350
description: C# källkod för att dela XLSX dokument på .NET Framework, .NET Core, Mono eller Xamarin Platforms.
...
{{% blocks/products/pf/agp/content h2="Hur man delar upp XLSX-fil med C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Split XLSX Fil - C#" offSpacer="" %}}
