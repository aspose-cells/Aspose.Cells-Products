---
title: Объединить HTML в XLTM - Объединить HTML в XLTM в Python
url: /ru/python-java/merger/merge-html-to-xltm/ 
description: Aspose Excel. Python Aspose.Cells. Бесплатное онлайн объединение HTML в формат сохранения XLTM. Python Объединить формат HTML в формат XLTM. Объединить HTML с XLTM в Python. HTML Объединить.
...
В следующем примере показано, как объединить HTML с XLTM в Aspose.Cells for Python via Java.
