---
title:  Combine SPREADSHEETML con XLT a través de Python
url: /es/python-net/merger/merge-spreadsheetml-to-xlt/ 
description: Combine SPREADSHEETML con XLT en línea de forma gratuita. HOJA DE CÁLCULO en línea gratis al XLT Fusión. Combine SPREADSHEETML con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo fusionar SPREADSHEETML a XLT en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar SPREADSHEETML a XLT en línea" InputFormat="xml" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
