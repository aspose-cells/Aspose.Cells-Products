...
url: /cs/net/merger/merge-xltm-to-excel/ 
...
Následující příklad ukazuje, jak sloučit XLTM do EXCELu v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLTM do EXCELu programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna ke sloučení XLTM do EXCELu" %}}
