...
description: Aspose Unggul. Ubah XLSX menjadi ET dengan cepat dan mudah dengan Aspose.Cells. Java XLSX menjadi ET. Java Simpan XLSX ke ET. Simpan XLSX sebagai ET menggunakan Java.
...
Contoh berikut menunjukkan cara mengonversi XLSX ke ET di Java.
...
{{% blocks/products/pf/agp/content h2="Bagaimana Mengonversi XLSX ke ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke ET secara terprogram? Pengembang Java dapat dengan mudah mengonversi XLSX ke ET hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi XLSX ke ET" %}}
{{% blocks/products/pf/agp/text %}}
