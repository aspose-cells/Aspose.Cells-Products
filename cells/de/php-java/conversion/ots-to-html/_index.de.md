...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in HTML mit Aspose.Cells. PHP OTS in HTML. PHP Speichern Sie OTS in HTML. Speichern Sie OTS mit PHP als HTML.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in HTML" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in HTML konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in HTML konvertieren.
...
1.  Konvertieren Sie OTS in HTML, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in HTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in HTML" %}}
