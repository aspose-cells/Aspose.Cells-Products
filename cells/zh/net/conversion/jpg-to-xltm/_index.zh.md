---
title: C# JPG 到 XLTM - 在线 JPG 到 XLTM 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 JPG 转换为 XLTM 保存格式。 C# JPG 到 XLTM 格式。将 JPG 保存到 XLTM C#。
...
{{% blocks/products/pf/agp/content h2="免费在线将JPG保存到C#中的XLTM" %}}
...
{{% cells-convert title="将 JPG 在线转换为 XLTM 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xltm" IsLandingPage="true" %}}
