...
description: Sample C++ conversion code for HTML to XLT format. Programmers can use this source code for batch HTML to XLT conversion within any C++ Application.
---
