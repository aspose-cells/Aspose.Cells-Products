...
description: Aspose Excel'de. Aspose.Cells ile SXC'i hızlı ve kolay bir şekilde ETT'ye dönüştürün. Python SXC'i ETT'ye dönüştürün. Python SXC'i ETT'ye kaydedin. Python'i kullanarak SXC'i ETT olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="SXC\'i Python\'de ETT\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="SXC\'i Python\'de ETT\'ye kaydedin" %}}

Aşağıdaki örnekte SXC'in Python via NET'de ETT'ye nasıl dönüştürüleceği gösterilmektedir.
...
{{% cells-convert title="SXC\'i ETT\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="ett" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="SXC\'i ETT\'ye dönüştürmek için Python kitaplığı" %}}
