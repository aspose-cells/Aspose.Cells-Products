...
次の例は、MHT を Aspose.Cells for Python via Java の PRN にマージする方法を示しています。
...
MHT をプログラムで PRN にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実行できます。
