...
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển C# một phương pháp tích hợp đầy đủ để chuyển đổi JPG sang định dạng ODS, cho phép lưu dữ liệu JPG liền mạch vào định dạng ODS bằng thư viện Aspose.Cells, tất cả thông qua mã C# hiệu quả và có thể tùy chỉnh.
...
{{% blocks/products/pf/agp/content h2="Lưu ảnh JPG vào thư mục ODS trong tệp C#." %}}
...
1.  Chuyển đổi định dạng JPG thành ODS bằng cách gọi phương thức Workbook.Save.
1.  Nhận kết quả chuyển đổi JPG thành ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C# để chuyển đổi JPG sang ODS" %}}
