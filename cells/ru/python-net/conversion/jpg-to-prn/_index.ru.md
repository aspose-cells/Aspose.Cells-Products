...
{{% blocks/products/pf/agp/content h2="Конвертируйте JPG в PRN в библиотеке Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните JPG в PRN в библиотеке Excel Python." %}}

В следующем примере показано, как преобразовать JPG в PRN в библиотеке Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Библиотека Excel для преобразования JPG в PRN" %}}
