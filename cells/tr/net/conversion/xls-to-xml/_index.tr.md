...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla XLS\'yi XML\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, yalnızca birkaç kod satırıyla XLS dosyalarını kolayca yükleyebilir ve XML'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. XLS dosyasını bir Çalışma Kitabı örneğiyle yükleyin1. Workbook.Save yöntemini çağırın1. Parametre olarak XML uzantılı çıktı yolunu iletin1. Sonuç XML dosyası için belirtilen yolu kontrol edin
...
{{% cells-convert title="XLS\'yi XML\'e Dönüştürmek için Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" %}}
