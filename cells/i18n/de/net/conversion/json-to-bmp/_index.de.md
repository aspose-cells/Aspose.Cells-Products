---
title: Konvertieren Sie JSON in BMP über C#
url: /de/net/conversion/json-to-bmp/
description: Beispielcode für die Umwandlung von json in bmp C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von json-Dateien in bmp innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie JSON mit C# in BMP" %}}

 Um JSON in BMP zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von JSON in BMP über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können JSON-Dateien in nur wenigen Codezeilen einfach laden und in BMP konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die JSON-Datei mit einer Instanz von Workbook1. Rufen Sie die Workbook.Save-Methode auf1. Übergeben Sie den Ausgabepfad mit der BMP-Erweiterung als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende BMP-Datei
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von JSON in BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="bmp" IsLandingPage="true" %}}
