---
title:  ODS document graphique vers images via .NET
weight: 4360
description: Code source C# pour dessiner et convertir un graphique ou un diagramme dans le fichier ODS sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="ODS Fichier de graphiques vers des images dans C#" h2="Conversion native et haute performance de graphiques de documents ODS en images à l\'aide d\'API côté serveur, sans utiliser de logiciel tel que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir des graphiques ODS en images à l\'aide de C#" %}}
 ...
 Afin de convertir les cartes ODS, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir les fichiers ODS en graphiques C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir ODS Fichiers Graphique - C#" offSpacer="" %}}
