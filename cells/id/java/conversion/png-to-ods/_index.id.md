---
title: Java PNG ke ODS - Online PNG ke ODS Konverter
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Gratis Online Java Ubah PNG menjadi ODS saveformat. Java PNG ke format ODS. Simpan PNG ke ODS Java.
...
{{% blocks/products/pf/agp/content h2="Simpan PNG ke ODS di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi PNG menjadi ODS di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi PNG menjadi ODS. Unggah file PNG Anda, lalu simpan sebagai file ODS. Untuk membaca PNG dan menulis ODS Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format keluaran ODS akan identik dengan dokumen asli PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi PNG menjadi ODS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah PNG menjadi ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PNG menjadi ODS secara terprogram? Pengembang Java dapat dengan mudah mengonversi PNG menjadi ODS hanya dalam beberapa baris kode.
...
1.  Ubah PNG menjadi ODS dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari PNG menjadi ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi PNG menjadi ODS" %}}
{{% blocks/products/pf/agp/text %}}
