...
description: Aspose Exceller. Python Exceller. Convertissez TSV en XLT rapidement et facilement avec Aspose.Cells. Python TSV en XLT. Python Enregistrez TSV en XLT. Enregistrez TSV sous 076112. 3481 en utilisant la bibliothèque Excel Python.
...
{{% blocks/products/pf/agp/content h2="Convertir TSV en XLT à l\'aide de la bibliothèque Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer TSV à XLT dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment convertir TSV en XLT dans la bibliothèque Excel Python.
...
{{% cells-convert title="Exemple de code pour convertir TSV en XLT via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlt" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Excel Python pour convertir TSV en XLT" %}}
