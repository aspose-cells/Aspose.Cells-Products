---
title:  Вставьте выноски в Excel via Java
weight: 360
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке выносок в файл Excel via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) чтобы вставить выноски в выбранный лист
...
В приведенном ниже примере кода показано, как вставить «Мысленный пузырь: облако». Дополнительные типы см. в разделе «Обзор типов выносок блоков» ниже.
