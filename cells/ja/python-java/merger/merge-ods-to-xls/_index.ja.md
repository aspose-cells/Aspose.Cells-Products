...
description: Aspose エクセル。 Python Aspose.Cells。ODS を XLS の保存形式にマージします。 Python ODS と XLS の形式を結合します。 ODS から XLS を Python に結合します。ODS を結合します。
