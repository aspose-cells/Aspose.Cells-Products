...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera TXT-fil till MHTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda TXT-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (MHTML) filtillägg.1. MHTML-filen kommer att sparas på den angivna sökvägen.1. Öppna MHTML-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="TXT till MHTML C++ omvandlingskällkod" offSpacer="" %}}
