...
description: ODS oluşturucu. C++ kodunda ODS dosyası oluşturun. C++ uygulamasını kullanarak ODS (Openoffice / Lbreoffice) dosyaları oluşturun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla ODS Dosyası oluşturun" h2="C++ kitaplığını kullanarak Microsoft Office olmadan programlı olarak yerel ve yüksek performanslı ODS (Openoffice / Lbreoffice) elektronik tablo oluşturma." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Geliştiricilerin, veri işleme için yalnızca birkaç kod satırında çalışan raporlama uygulamaları içinde ODS dosyalarını oluşturması, yüklemesi, değiştirmesi ve dönüştürmesi kolaydır.
...
1.  Save() yöntemini kullanarak çalışma kitabını .ods dosyası olarak kaydedin.

{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kodu, C++ kullanılarak bir ODS (Openoffice / Lbreoffice) dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
