---
title: C++ XML в SVG - Конвертер XML в SVG
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в SVG в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат SVG в формате C++.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XML в SVG через C++" %}}
...
1.  Преобразовать XML в формат SVG, вызвав метод Save().
