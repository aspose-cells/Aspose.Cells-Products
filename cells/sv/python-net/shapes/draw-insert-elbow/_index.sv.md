...
{{% blocks/products/pf/agp/content h2="Hur man infogar en armbågsform i Excel-fil med Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga armbågsform till Excel-fil med Python via .Net" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens tillägg[metod](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) för att infoga en armbågsform i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Sätt armbågsform - Python via .Net" offSpacer="" %}}
