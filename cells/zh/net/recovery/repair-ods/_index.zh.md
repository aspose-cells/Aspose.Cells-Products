---
title: C# 修复 ods - 恢复并修复损坏的 ods 文件
url: /zh/net/recovery/repair-ods/ 
description: C# Aspose.Cells.修复ODS。修复 ods 文件。消耗臭氧层物质恢复工具。消耗臭氧层物质腐败。恢复ODS数据。 ods文件恢复。恢复损坏的 ods 文件。
...
{{% cells-recovery title="修复 ODS 文件的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="net" %}}    
