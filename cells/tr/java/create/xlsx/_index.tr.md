...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla XLSX Nasıl Oluşturulur" %}}
...
{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kod, Java kullanarak bir MS Excel XLSX dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
