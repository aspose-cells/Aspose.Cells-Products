---
title: Voeg XLSM samen met PDF - Combineer XLSM met PDF in Java
url: /nl/java/merger/merge-xlsm-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Voeg XLSM samen met het opslagformaat PDF. Java Combineer het formaat XLSM met PDF. Voeg XLSM samen met PDF in Java. XLSM Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSM samen met PDF in Java" %}}

Het volgende voorbeeld laat zien hoe u XLSM samenvoegt met PDF in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSM samen te voegen met PDF. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand PDF. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld Java waarin XLSM wordt samengevoegd met PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLSM samen te voegen met PDF in Java" InputFormat="xlsm" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSM samenvoegt met PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen met PDF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSM samen te voegen met PDF" %}}
