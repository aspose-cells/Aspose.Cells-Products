...
{{% blocks/products/pf/agp/content h2="How to Convert HTML to ODS Using Java" %}}

 In order to render HTML to ODS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert HTML to ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert HTML file to ODS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="HTML to ODS Java Conversion Source Code" offSpacer="" %}}
