...
{{< blocks/products/pf/i18n/upper-banner h1="MHTML\'i ET\'ye dönüştürün (C++ içinde)." h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna gerek kalmadan, C++ kütüphanesini kullanarak yüksek performanslı MHTML\'den ET\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
MHTML dosyalarını programatik olarak ET formatına dönüştürmeniz mi gerekiyor? C++ geliştiricileri, MHTML dosyalarını sadece birkaç satır kodla kolayca ET formatına dönüştürebilir.
...
1.  Save() yöntemini çağırarak MHTML'i ET'ye dönüştürün.
