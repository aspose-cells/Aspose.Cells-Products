...
description: Aspose Exceller. Python Aspose.Cells. Fusionner HTM avec le format de sauvegarde BMP. Python Combinez HTM au format BMP. Fusionner HTM avec BMP dans Python. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec BMP dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner HTM avec BMP dans Python" InputFormat="htm" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
