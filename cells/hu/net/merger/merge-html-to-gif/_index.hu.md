---
title: A HTML-GIF-es számok egyesítése – a HTML-es és a GIF-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-html-to-gif/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés HTML GIF mentési formátumba. C# A HTML és a GIF formátum kombinálása. Egyesítse a HTML-GIF-et a C#-ben. HTML Egyesítse.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a HTML-es számokat a GIF-es számokhoz a C#-ben online ingyen" %}}

A következő példa bemutatja a HTML és a GIF egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML-es és a GIF-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a GIF fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTML és GIF számokat.
...
{{% blocks/products/pf/agp/content h2="A HTML és a GIF egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTML-et a GIF-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML és GIF egyesítéséhez" %}}
