...
url: /fr/net/merger/merge-mht-to-xlsb/ 
...
L'exemple suivant montre comment fusionner MHT avec XLSB dans Aspose.Cells for .NET.
...
Besoin de fusionner MHT avec XLSB par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque .NET pour fusionner MHT avec XLSB" %}}
