---
title: Gabungkan FODS ke POWERPOINT - Gabungkan FODS ke POWERPOINT di Java
url: /id/java/merger/merge-fods-to-powerpoint/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS ke format penyimpanan POWERPOINT. Java Gabungkan FODS ke format POWERPOINT. Gabungkan FODS menjadi POWERPOINT di Java. FODS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS ke POWERPOINT Menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS menjadi POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke POWERPOINT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk digabungkan FODS ke POWERPOINT" %}}
