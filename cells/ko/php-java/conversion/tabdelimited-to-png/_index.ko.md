...
description: Aspose 엑셀. Aspose.Cells을 사용하여 TABDELIMITED를 Aspose.Cells로 빠르고 쉽게 변환합니다. PHP TABDELIMITED를 PNG로 변환합니다. PHP TABDELIMITED를 PNG로 저장합니다. PHP를 사용하여 TABDELIMITED를 PNG로 저장합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="PHP에서 TABDELIMITED를 PNG로 변환" h2="TABDELIMITED를 PNG로 변환하기 위한 고속 PHP 라이브러리입니다. 이는 PHP를 사용하여 TABDELIMITED, PNG 및 기타 여러 형식을 가져오고 내보내는 전문 소프트웨어 솔루션입니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="TABDELIMITED를 PHP로 PNG에 저장" %}}

다음 예에서는 PHP에서 TABDELIMITED를 PNG로 변환하는 방법을 보여줍니다.
...
{{% blocks/products/pf/agp/content h2="PHP를 통해 TABDELIMITED를 PNG로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 TABDELIMITED 파일을 PNG로 변환해야 합니까? PHP 개발자는 단 몇 줄의 코드만으로 TABDELIMITED를 PNG로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook의 save 메소드를 호출하여 TABDELIMITED를 PNG로 변환합니다.
1.  TABDELIMITED를 PNG로 변환한 결과를 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="TABDELIMITED를 PNG로 변환하는 PHP 라이브러리" %}}
