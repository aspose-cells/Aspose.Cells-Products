...
description: PDF مبتكر. إنشاء PDF ملفات في C++ كود. قم بإنشاء ملفات PDF باستخدام تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء PDF ملف عن طريق C++" h2="إنشاء PDF أصلي وعالي الأداء (تنسيق المستندات المحمولة) برمجيًا بدون برنامج Micorsoft Office باستخدام مكتبة C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  احفظ المصنف كملف .pdf باستخدام طريقة Save ().

{{% blocks/products/pf/agp/code-block title="يوضح كود المصدر التالي كيفية إنشاء ملف PDF باستخدام C++." offSpacer="" %}}
