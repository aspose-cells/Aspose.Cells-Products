...
{{% blocks/products/pf/agp/content h2="Преобразовать XLTM в SXC, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в SXC в C#" %}}
...
1.  Преобразуйте значение XLTM в SXC, вызвав метод Workbook.Save.
