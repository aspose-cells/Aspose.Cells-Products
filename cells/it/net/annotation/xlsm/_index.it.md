---
title:  Rimuovere l'annotazione XLSM via .NET
weight: 9890
description: C# codice sorgente per aggiungere ed eliminare le annotazioni di formato XLSM su .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API può essere utilizzato per creare, modificare, convertire e rendere Microsoft i formati Excel in diversi formati. Inoltre, può essere utilizzato per grafici completi, report scalabili e calcoli affidabili all'interno di applicazioni software. Aspose.Cells è un API autonomo e non richiede alcun software come Microsoft o OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Rimuovi l\'annotazione da XLSM tramite l\'app online" sectionDescription=" Elimina subito le annotazioni del documento XLSM visitando il nostro[Sito web di dimostrazioni dal vivo](https://products.aspose.app/cells/annotation). La demo dal vivo ha i seguenti vantaggi" >}}
