---
title:  Tìm kiếm tài liệu XLS mà không cần mở via Java
weight: 9430
...
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm XLS Các định dạng trong Java" h2="Tìm kiếm tài liệu gốc và hiệu suất cao XLS bằng API Aspose.Cells for Java phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tra cứu file XLS trong Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Tìm Hồ Sơ XLS - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến XLS Tìm kiếm Demo trực tiếp" sectionDescription=" Tìm kiếm văn bản, từ, cụm từ trong tài liệu XLS ngay bây giờ bằng cách truy cập trang web của chúng tôi[Trang web Demo trực tiếp](https://products.aspose.app/cells/search). Bản demo trực tiếp có những lợi ích sau" >}}
