...
{{% blocks/products/pf/agp/content h2="XLS dosyasına C# yoluyla nasıl yorum eklenir?" %}}
...
Office 365'te yorumlar konuşmalar içindir, XLS dosyasına yorum eklemek ve kaldırmak için aşağıdaki C# kodunu kullanabilirsiniz.

{{% blocks/products/pf/agp/code-block title="C# XLS dosyasındaki yorumları eklemek ve kaldırmak için örnek kod" offSpacer="" %}}
