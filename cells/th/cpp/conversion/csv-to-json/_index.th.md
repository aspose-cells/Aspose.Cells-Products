---
title: แปลง CSV เป็น JSON ผ่าน C++ แอปพลิเคชัน 

description: ตัวอย่างโค้ดการแปลง C++ สำหรับเอกสาร CSV เป็นรูปแบบ JSON โปรแกรมเมอร์สามารถใช้ซอร์สโค้ดนี้สำหรับการแปลงแบตช์ CSV เป็น JSON ภายในแอปพลิเคชัน C++ ใดก็ได้
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง CSV เป็น JSON ผ่าน C++" h2="การแปลง CSV เป็น JSON ประสิทธิภาพสูงโดยใช้ไลบรารี C++ โดยไม่ต้องติดตั้ง Microsoft Excel, OpenOffice หรือ Adobe Acrobat" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ นักพัฒนาซอฟต์แวร์สามารถแปลงไฟล์ CSV เป็น JSON ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ CSV โดยใช้ Factory::CreateIWorkbook1. เรียกใช้เมธอด Save()1. ส่งพาธไฟล์เอาต์พุตที่มีนามสกุลไฟล์ (JSON)1. ไฟล์ JSON จะถูกบันทึกในเส้นทางที่ระบุ1. เปิดไฟล์ JSON ในโปรแกรมที่เข้ากันได้
...
{{% blocks/products/pf/agp/code-block title="CSV เป็น JSON C++ ซอร์สโค้ดการแปลง" offSpacer="" %}}
