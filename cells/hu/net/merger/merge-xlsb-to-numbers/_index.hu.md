...
url: /hu/net/merger/merge-xlsb-to-numbers/ 
...
következő példa bemutatja, hogyan lehet egyesíteni a XLSB-et a NUMBERS-szel a Aspose.Cells-es for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLSB-es számot a NUMBERS számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB és a NUMBERS egyesítéséhez" %}}
