...
description: Aspose Exceller. Convertissez SPREADSHEETML en XLSB rapidement et facilement avec Aspose.Cells. Python SPREADSHEETML en XLSB. Python Enregistrez SPREADSHEETML en XLSB. Enregistrez SPREADSHEETML sous XLSB en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer SPREADSHEETML au XLSB dans Python" %}}

L'exemple suivant montre comment convertir SPREADSHEETML en XLSB en Python.
