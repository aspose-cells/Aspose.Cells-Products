---
title: Combine SPREADSHEETML con IMAGE - Combine SPREADSHEETML con IMAGE en C#
url: /es/net/merger/merge-spreadsheetml-to-image/ 
description: AsposeExcel. C# Aspose.Cells. Combinar en línea gratis la HOJA DE CÁLCULO para guardar el formato de IMAGEN. C# Combine SPREADSHEETML con el formato de IMAGEN. Combinar HOJA DE CALCULO con IMAGEN en C#. Combinar HOJA DE CALCULO.
...
{{% blocks/products/pf/agp/content h2="Combine SPREADSHEETML con IMAGE en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar SPREADSHEETML con IMAGE en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar SPREADSHEETML con IMAGE. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo IMAGE. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que fusiona SPREADSHEETML con IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar SPREADSHEETML a IMAGE en C#" InputFormat="xml" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar SPREADSHEETML a IMAGE a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar SPREADSHEETML con IMAGE mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar SPREADSHEETML a IMAGE" %}}
