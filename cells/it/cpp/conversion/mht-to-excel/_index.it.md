...
Hai bisogno di convertire i file MHT in EXCEL tramite codice? Gli sviluppatori C++ possono convertire facilmente i file MHT in EXCEL in poche righe di codice.
...
1.  Convertire MHT in EXCEL chiamando il metodo Save().
