---
title: Wstaw komentarze do pliku XLS za pośrednictwem Python
url: /pl/python-java/comments/insert-comments-to-xls/ 
description: Wstaw komentarze do XLS, używając Python. Użyj przykładowego kodu API, aby wstawić komentarze w aplikacji Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak wstawić komentarze w pliku XLS za pośrednictwem Python" %}}
...
usłudze Office 365 komentarze służą do konwersacji, możesz użyć następującego kodu Python, aby wstawiać i usuwać komentarze w pliku XLS.
