---
title:  Sloučit MHT do POWERPOINT přes Python
...
Následující příklad ukazuje, jak sloučit MHT do POWERPOINT v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHT do POWERPOINT online" InputFormat="mht" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
