...
{{% blocks/products/pf/agp/content h2="XLS-fájl elemzése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS-fájlok elemzésének lépései a következőben: Java" %}}
...
+ Töltse be az XLS-dokumentumot a Workbook osztály segítségével.
...
{{% blocks/products/pf/agp/code-block title="XLS-fájlok elemzése – Java" offSpacer="" %}}
