---
title: Java XLS vers POWERPOINT - Convertisseur en ligne XLS vers POWERPOINT
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertissez XLS au format de sauvegarde POWERPOINT. Java XLS au format POWERPOINT. Enregistrez XLS sur POWERPOINT Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS sur POWERPOINT en Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLS en POWERPOINT en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en POWERPOINT. Téléchargez votre fichier XLS, puis enregistrez-le simplement en tant que fichier POWERPOINT. Pour la lecture XLS et l'écriture POWERPOINT, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage POWERPOINT de sortie seront identiques au document original XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en POWERPOINT en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="pptx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en POWERPOINT par programmation ? Les développeurs Java peuvent facilement convertir XLS en POWERPOINT en quelques lignes de code.
...
1.  Convertissez XLS en POWERPOINT en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de XLS en POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir XLS en POWERPOINT" %}}
{{% blocks/products/pf/agp/text %}}
