...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM bis XLSB in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLAM in XLSB in C# konvertiert wird.
...
Müssen Sie XLAM-Dateien programmgesteuert in XLSB konvertieren? .NET-Entwickler können XLAM problemlos in nur wenigen Codezeilen laden und in XLSB konvertieren.
...
1.  Konvertieren Sie XLAM in XLSB, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLAM in XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLAM in XLSB" %}}
