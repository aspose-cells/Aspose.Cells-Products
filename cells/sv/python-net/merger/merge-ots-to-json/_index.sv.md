...
description: Aspose Excel. Python Aspose.Cells. Slå samman OTS till JSON sparaformat. Python Kombinera OTS till JSON format. Slå samman OTS till JSON i Python. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="Slå samman OTS till JSON i Python" %}}
...
{{% cells-merger title="Exempelkod för att slå samman OTS till JSON i Python" InputFormat="ots" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
