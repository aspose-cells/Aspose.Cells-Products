---
title: Combinar PRN con DOCX - Combinar PRN con DOCX en Java
url: /es/java/merger/merge-prn-to-docx/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea PRN a DOCX guardar formato. Java Combina PRN con formato DOCX. Combinar PRN a DOCX en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN a DOCX en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar PRN con DOCX en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar PRN con DOCX. Cargue sus archivos, llame al método Workbook.Combine para combinar archivos y luego guárdelo en el archivo DOCX. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona PRN con DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar PRN a DOCX en Java" InputFormat="prn" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN a DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar PRN con DOCX mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar PRN a DOCX" %}}
