---
title: Java JPEG 轉 MD - JPEG 轉 MD 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 JPEG 轉換為 MD。Java JPEG 轉換為 MD。 Java 將 JPEG 儲存到 MD。使用 Java 將 JPEG 儲存為 MD。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 JPEG 轉換為 Java 中的 MD" h2="用於將 JPEG 轉換為 MD 的高速 Java 庫。這是一個專業的軟體解決方案，可以使用Java導入和匯出JPEG、MD和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
如何將 JPEG 轉換為 MD？使用 Aspose.Cells for Java 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 JPEG 轉換為 MD。[Aspose.Cells for Java](https://products.aspose.com/cells/java)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Java Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。您可以直接從以下位置下載其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)並透過將以下配置新增至 pom.xml 將其安裝在基於 Maven 的專案中。
...
{{% blocks/products/pf/agp/content h2="將JPEG保存到Java中的MD" %}}

以下範例示範如何將 JPEG 轉換為 Java 中的 MD。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 JPEG 轉換為 MD。上傳您的 JPEG 文件，然後將其儲存為 MD 文件。對於 JPEG 讀取和 MD 寫入，您可以使用完全限定的檔案名稱。輸出的 MD 內容和格式將與原始 JPEG 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 JPEG 轉換為 MD 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 JPEG 轉換為 MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 JPEG 檔案轉換為 MD？ Java開發人員只需幾行程式碼即可輕鬆將JPEG轉換為MD。
...
1. 透過呼叫Workbook.save方法將JPEG轉換為MD。
1. 得到JPEG到MD的轉換結果。
