...
weight: 200
description: Python via Java الكود المصدري لإدراج WordArt في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج WordArt في ملف Excel باستخدام Python via Java" %}}
 ...
 لإدراج WordArt في ملف Excel، سنستخدم
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addWordArt(int,%20java.lang.String,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج WordArt في ورقة العمل المحددة.
