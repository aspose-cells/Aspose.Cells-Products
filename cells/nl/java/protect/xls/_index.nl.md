...
weight: 5070
description: Java voorbeeldcode om bestand XLS te vergrendelen met een wachtwoord op Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
...
{{% blocks/products/pf/agp/content h2="Hoe u het XLS-bestand kunt beveiligen met behulp van Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLS bestanden via Java te beschermen" %}}
...
1.  Laad het bestand XLS door de werkmapklasse te instantiëren
1.  Gebruik de methode protect(..) met ProtectionType en Wachtwoord
1.  Sla het beschermde bestand XLS op met de methode save().
