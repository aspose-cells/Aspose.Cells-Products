...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztők könnyedén konvertálhatják a XLTX-et TABDELIMITED-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a XLTX fájlt a Factory::CreateIWorkbook segítségével.
1. A XLTX konvertálása TABDELIMITED-re a Save() metódus meghívásával.
