...
description: C# källkod för att låsa XLSM-fil med lösenord på .NET Framework, .NET Core, Mono eller Xamarin-plattformar.
---
...
{{% blocks/products/pf/agp/content h2="Så här skyddar du XLSM-fil med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Skydda XLSM via C#" %}}
...
1. Instantiera Workbook-klass med sökväg till XLSM-fil1. Skaffa standard eller valfritt kalkylblad för att lägga till skydd1. Skydda kalkylblad med arbetsblad.Protect-metoden1. Skydda Workbook med Workbook.Protect-metoden1. Spara resultatet i XLSM-format
