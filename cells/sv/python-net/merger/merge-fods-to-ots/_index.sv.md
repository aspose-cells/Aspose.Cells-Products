...
url: /sv/python-net/merger/merge-fods-to-ots/ 
...
Följande exempel visar hur man slår samman FODS till OTS i Aspose.Cells for Python via .NET.
...
Behöver du slå samman FODS till OTS programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API:er kan göras med bara några rader kod.
