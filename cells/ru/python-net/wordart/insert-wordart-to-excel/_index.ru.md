...
{{% blocks/products/pf/agp/content h2="Как вставить WordArt в файл Excel с помощью Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке файла WordArt в Excel через Python" %}}
...
+ Используйте метод add коллекции фигур, чтобы вставить объект WordArt в выбранный рабочий лист.
...
-  Установите Aspose.Cells for Python via .NET из<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , используйте команду как:<code>$ pip install aspose-cells-python</code>.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Вставить WordArt — Python" offSpacer="" %}}
