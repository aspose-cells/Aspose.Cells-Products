---
title: Převést TABDELIMITED na FODS přes Python
url: /cs/python-java/conversion/tabdelimited-to-fods/
description: Ukázkový kód pro konverzi tabdelimited na fods Python. Použijte API ukázkový kód pro dávkový převod souborů oddělených tabulátory na fods v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na FODS pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na FODS prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory TABDELIMITED na FODS pomocí několika řádků kódu.
