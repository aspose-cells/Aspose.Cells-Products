...
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw tabelę przestawną do dokumentów XLS za pośrednictwem C#" h2="Natywny i wydajny arkusz kalkulacyjny Microsoft Excel XLS z programowym tworzeniem tabeli przestawnej przy użyciu interfejsów API .NET po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Dynamiczne generowanie pliku MS Excel XLS z tabelą przestawną w uruchomionej aplikacji jest łatwe. Aby utworzyć od podstaw dokumenty XLS za pomocą tabeli przestawnej bez konieczności posiadania pakietu MS Office, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Jak wstawić tabelę przestawną w XLS przez C#" %}}
