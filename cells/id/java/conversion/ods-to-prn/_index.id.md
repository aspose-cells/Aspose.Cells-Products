...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke PRN di Java" %}}

Contoh berikut menunjukkan cara mengkonversi ODS ke PRN di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODS ke PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file ODS ke PRN secara terprogram? Pengembang Java dapat dengan mudah mengkonversi ODS ke PRN hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi ODS ke PRN" %}}
{{% blocks/products/pf/agp/text %}}
