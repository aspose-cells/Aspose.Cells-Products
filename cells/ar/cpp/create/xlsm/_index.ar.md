...
description: Aspose اكسل. C++ أنشئ ملف XLSM بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف XLSM باستخدام C++. أنشئ XLSM في C++. C++ XLSM Creator.
...
1.  احفظ المصنف كملف .xlsm باستخدام طريقة Save().
