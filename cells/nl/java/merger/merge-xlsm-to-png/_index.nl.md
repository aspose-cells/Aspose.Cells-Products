---
title: Voeg XLSM samen met PNG - Combineer XLSM met PNG in Java
url: /nl/java/merger/merge-xlsm-to-png/ 
description: Aspose Excel. Java Aspose.Cells. Voeg XLSM samen met het opslagformaat PNG. Java Combineer het formaat XLSM met PNG. Voeg XLSM samen met PNG in Java. XLSM Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSM samen met PNG in Java" %}}

Het volgende voorbeeld laat zien hoe u XLSM samenvoegt met PNG in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSM samen te voegen met PNG. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand PNG. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld Java waarin XLSM wordt samengevoegd met PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLSM samen te voegen met PNG in Java" InputFormat="xlsm" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSM samenvoegt met PNG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen met PNG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSM samen te voegen met PNG" %}}
