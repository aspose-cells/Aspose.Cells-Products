---
title: Fusionar IMAGEN con OTS - Combinar IMAGEN con OTS en C#
url: /es/net/merger/merge-image-to-ots/ 
description: Aspose Excel. C# Aspose.Cells. Fusionar IMAGEN con el formato guardado OTS. C# Combina IMAGEN al formato OTS. Fusionar IMAGEN con OTS en C#. Fusionar IMAGEN.
...
{{% blocks/products/pf/agp/content h2="Fusionar IMAGEN con OTS en C#" %}}

El siguiente ejemplo demuestra cómo fusionar IMAGEN con OTS en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar IMAGEN con OTS. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo OTS. Si desarrolla código en C#, esto será más simple de lo que parece. Vea el ejemplo C# que combina IMAGEN con OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar IMAGEN con OTS en C#" InputFormat="png" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar IMAGEN con OTS a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar IMAGEN con OTS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar IMAGEN con OTS" %}}
