---
title:  Συγχωνεύστε το OTS στο XLS μέσω του C++
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το OTS στο XLS στο C++.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση OTS στο XLS σε απευθείας σύνδεση" InputFormat="ots" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
