---
title:  Добавить или удалить аннотацию XLSM через C++
weight: 2860
description: C++ пример кода для удаления аннотаций формата XLSM в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Добавить аннотацию в файл XLSM через C++" h2="Создавайте свои собственные приложения C++ для управления комментариями и авторами в файлах документов с помощью серверных API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по добавлению комментариев в номер XLSM через C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Загрузите файл Excel XLSM, используя объект класса IWorkbook.
...
{{% blocks/products/pf/agp/code-block title="Добавить комментарии в XLSM - C++" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API можно использовать для создания, редактирования, преобразования и преобразования Microsoft форматов Excel в различные форматы. Более того, его можно использовать для составления комплексных диаграмм, масштабируемых отчетов и надежных расчетов в программных приложениях. Aspose.Cells — это автономный номер API, который не требует какого-либо программного обеспечения, такого как Microsoft или OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Добавить/удалить аннотацию от XLSM через онлайн-приложение" sectionDescription=" Удалите аннотации к документу XLSM прямо сейчас, посетив наш[Веб-сайт живых демонстраций](https://products.aspose.app/cells/annotation). Живая демонстрация имеет следующие преимущества" >}}
