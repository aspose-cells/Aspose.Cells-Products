...
Poniższy przykład pokazuje, jak scalić SXC z MHT w Aspose.Cells for Python via Java.
...
Chcesz programowo połączyć numer SXC z MHT? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
