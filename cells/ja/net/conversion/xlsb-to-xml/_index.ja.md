---
title: C# XLSB から XML - オンライン XLSB から XML コンバーター
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# XLSB を XML 保存形式に変換します。 C# XLSB を XML 形式に変換します。 XLSB を XML C# に保存します。
...
{{% blocks/products/pf/agp/content h2="XLSBを無料でオンラインでXLSBのXMLに保存します" %}}
...
{{% cells-convert title="XLSBをオンラインでXMLに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xml" IsLandingPage="true" %}}
