---
title:  Insérez des étoiles et des bannières dans Excel via C++
weight: 800
description: Exemple de code C++ pour insérer des étoiles et des bannières dans un fichier Excel sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
keywords: [C++ Aspose.Cells., C++ add Star/Banner., C++ insert Star/Banner., C++ create Star/Banner]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérez des étoiles et des bannières dans Excel via C++" h2="Insérez des objets en utilisant les performances natives et hautes du côté serveur Aspose.Cells for C++ API sans utiliser de logiciel tel que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/) pour insérer des étoiles et des bannières dans la feuille de calcul sélectionnée
