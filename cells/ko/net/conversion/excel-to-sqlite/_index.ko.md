---
title: C# EXCEL에서 SQLite로 - EXCEL에서 SQLite로 변환기
description: Aspose 엑셀. Aspose.Cells을 사용하여 EXCEL을 SQLite로 빠르고 쉽게 변환하세요. C# EXCEL을 SQLite로 변환하세요. C# EXCEL을 SQLite에 저장합니다. C#을 사용하여 EXCEL을 SQLite로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="C#을 통해 EXCEL을 SQLite로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 EXCEL 파일을 SQLite로 변환해야 합니까? .NET 개발자는 단 몇 줄의 코드만으로 EXCEL을 SQLite로 쉽게 로드하고 변환할 수 있습니다.
...
1.  SQLite 데이터베이스에 데이터를 삽입하는 명령문을 실행합니다.

{{% blocks/products/pf/agp/code-block title="EXCEL을 SQLite로 변환하는 샘플 코드 - C#" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# EXCEL을 SQLite로 변환하는 라이브러리" %}}
