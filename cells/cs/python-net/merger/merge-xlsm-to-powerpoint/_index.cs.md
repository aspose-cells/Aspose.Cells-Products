---
title:  Sloučit XLSM do POWERPOINT přes Python
url: /cs/python-net/merger/merge-xlsm-to-powerpoint/ 
description: Sloučit XLSM do POWERPOINT Online zdarma. Online zdarma XLSM na sloučení POWERPOINT. Sloučit XLSM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSM do POWERPOINT v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM do POWERPOINT online" InputFormat="xlsm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
