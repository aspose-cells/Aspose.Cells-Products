...
description: Aspose Excel. Python Aspose.Cells. Scal plik EXCEL do formatu zapisu XML. Python Połącz format EXCEL z formatem XML. Scal EXCEL z XML w Python. Scal EXCEL.
...
{{% blocks/products/pf/agp/content h2="Scal EXCEL z XML przy użyciu Python" %}}
...
{{% blocks/products/pf/agp/content h2="Scal EXCEL z XML w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia programu Excel z formatem XML w Python" InputFormat="xlsx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć EXCEL z XML za pomocą Python" %}}
