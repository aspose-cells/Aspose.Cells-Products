---
title: Konwertuj HTML na XLSX za pomocą aplikacji C++ 
weight: 9770

description: Przykładowy kod konwersji C++ dla dokumentu HTML do formatu XLSX. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji HTML do XLSX w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj HTML na XLSX przez C++" h2="Wysokowydajna konwersja HTML do XLSX przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTML na XLSX za pomocą C++" %}}

 Aby przekonwertować HTML na XLSX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować HTML na XLSX za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik HTML na XLSX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik HTML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSX).1. Plik XLSX zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSX w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="HTML do XLSX C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo konwersji HTML do XLSX" sectionDescription="[Konwertuj HTML na XLSX](https://products.aspose.app/cells/conversion/html-to-xlsx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik HTML, zostanie on natychmiast przekonwertowany do formatu XLSX." >}}
