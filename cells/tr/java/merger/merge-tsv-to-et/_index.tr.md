---
title: TSV'i ET ile birleştir - TSV'i Java'de ET ile birleştir
url: /tr/java/merger/merge-tsv-to-et/ 
description: Aspose Excel'de. Java Aspose.Cells. TSV'i ET kaydetme biçimiyle birleştirin. Java TSV'i ET formatıyla birleştirin. TSV'i Java'deki ET ile birleştirin. TSV Birleştir.
...
{{% blocks/products/pf/agp/content h2="TSV\'i Java\'deki ET ile birleştir" %}}

Aşağıdaki örnek, TSV'in Aspose.Cells for Java'deki ET ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TSV'i ET ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından ET dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TSV'i ET ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TSV\'i Java\'de ET ile Birleştirmek için Örnek Kod" InputFormat="tsv" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TSV\'i ET via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TSV'i programlı olarak ET ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesi, TSV\'i ET ile birleştirecek" %}}
