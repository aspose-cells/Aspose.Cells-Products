...
description: Aspose Excel. Convierta XLT a PPTX rápida y fácilmente con Aspose.Cells. Python XLT a PPTX. Python Guarde XLT en PPTX. Guarde XLT como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLT al PPTX en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLT a PPTX en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLT en PPTX" %}}
