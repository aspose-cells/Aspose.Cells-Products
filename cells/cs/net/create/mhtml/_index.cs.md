...
{{% blocks/products/pf/agp/content h2="Jak vytvořit MHTML přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Pro vývojáře je snadné vytvářet, načítat, upravovat a konvertovat MHTML v rámci běhu různých reportovacích aplikací pro zpracování dat v několika řádcích kódu.
...
{{% blocks/products/pf/agp/code-block title="Ukázkový kód pro vytvoření souboru MHTML pomocí C#." offSpacer="" %}}
