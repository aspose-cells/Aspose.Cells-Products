...
url: /hu/net/merger/merge-jpeg-to-xml/ 
...
A következő példa bemutatja, hogyan egyesítheti a JPEG-et XML-be a Aspose.Cells for .NET-ben.
...
Programozottan egyesítenie kell a JPEG-et XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a JPEG XML-be olvasztásához" %}}
