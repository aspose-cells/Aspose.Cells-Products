---
title: Sloučit EXCEL s PDF - Kombinovat EXCEL s PDF v C#
url: /cs/net/merger/merge-excel-to-pdf/ 
description: Aspose Excel. C# Aspose.Cells. Online zdarma sloučit EXCEL do PDF saveformat. C# Kombinujte EXCEL do formátu PDF. Sloučit EXCEL na PDF v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL na PDF v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit EXCEL s PDF v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení EXCELu s PDF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PDF. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí EXCEL do PDF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL s PDF přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit EXCEL s PDF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení EXCELu s PDF" %}}
