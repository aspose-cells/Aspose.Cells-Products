...
url: /tr/cpp/merger/merge-xlsx-to-ots/ 
...
Aşağıdaki örnek, XLSX'in Aspose.Cells for C++'deki OTS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLSX'i OTS ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="C++ kütüphanesi, XLSX\'i OTS ile birleştirecek" %}}
