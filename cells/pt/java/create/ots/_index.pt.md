...
description: Aspose Excel. Java Criar arquivo OTS. Criar OTS Java. Java Criador OTS. Crie OTS em Java. Gere o arquivo OTS usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo OTS em Java" h2="Biblioteca Java de alta velocidade para criar arquivo OTS. Esta é uma solução de software profissional para importar e exportar XLSX, PDF e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como criar OTS em Java" %}}
...
1.  Salve a pasta de trabalho no formato OTS usando o método save().

{{% blocks/products/pf/agp/code-block title="O código de amostra mostra como criar o arquivo OTS em Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para criar arquivo OTS" %}}
{{% blocks/products/pf/agp/text %}}
