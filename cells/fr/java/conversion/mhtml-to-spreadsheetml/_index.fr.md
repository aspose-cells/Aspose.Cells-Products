---
title: Convertir MHTML en SPREADSHEETML via Java 
url: /fr/java/conversion/mhtml-to-spreadsheetml/ 
description: Exemple de code de conversion Java pour le format MHTML en fichier SPREADSHEETML. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers SPREADSHEETML dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MHTML en SPREADSHEETML via Java" h2="Conversion MHTML vers SPREADSHEETML Java pour convertir une ou plusieurs pages en SPREADSHEETML à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MHTML en SPREADSHEETML à l\'aide de Java" %}}

 Afin de rendre MHTML en SPREADSHEETML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir MHTML en SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier MHTML en SPREADSHEETML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier MHTML avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension SPREADSHEETML et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier SPREADSHEETML résultant
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MHTML vers SPREADSHEETML Java" offSpacer="" %}}

```cs
// charger le fichier MHTML dans une instance de Workbook
Workbook book = new Workbook("template.mhtml");
// enregistrer MHTML sous SPREADSHEETML
