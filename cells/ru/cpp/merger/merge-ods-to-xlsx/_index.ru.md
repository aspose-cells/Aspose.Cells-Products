---
title:  Объединить ODS с XLSX через C++
url: /ru/cpp/merger/merge-ods-to-xlsx/ 
description: Объедините ODS с XLSX онлайн бесплатно. Бесплатный онлайн ODS до XLSX Слияние. Объединить ODS в Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS и другие.
---
...
В следующем примере показано, как объединить ODS с XLSX в C++.
...
{{% cells-merger title="Бесплатное приложение для объединения ODS с XLSX онлайн" InputFormat="ods" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
