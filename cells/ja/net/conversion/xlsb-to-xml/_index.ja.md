---
title: C# XLSB から XML - XLSB から XML コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XLSB を XML にすばやく簡単に変換します。 C# XLSB を XML に変換します。 C# XLSB を XML に保存します。 C# を使用して XLSB を XML として保存します。
...
{{< blocks/products/pf/i18n/upper-banner h1="XLSB を C# の XML に変換する" h2="XLSB を XML に変換するための高速 C# ライブラリ。これは、XLSB フレームワーク、.NET コア、または Mono プラットフォームで XLSB、XML、およびその他の多くの形式をインポートおよびエクスポートするためのプロフェッショナル ソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB を C# の XML に保存" %}}

次の例は、XLSB を C# の XML に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、XLSB を XML に変換します。 XLSB ファイルをアップロードし、XML ファイルとして保存します。 XLSB の読み取りと XML 書き込みの両方で、完全修飾ファイル名を使用できます。出力される XML コンテンツと形式は、元の XLSB ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="XLSB を XML に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# 経由で XLSB を XML に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSB ファイルをプログラムで XML に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLSB を簡単にロードして XML に変換できます。
