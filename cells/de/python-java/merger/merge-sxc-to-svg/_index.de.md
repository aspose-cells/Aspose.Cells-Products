...
description: Aspose Excel. Python Aspose.Cells. SXC mit SVG Saveformat zusammenführen. Python Kombinieren Sie das Format SXC mit dem Format SVG. SXC zu SVG in Python zusammenführen. SXC Zusammenführen.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von SXC mit SVG in Python" InputFormat="sxc" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie SXC über Python mit SVG zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie SXC programmgesteuert mit SVG zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs können mit nur wenigen Codezeilen erstellt werden.
