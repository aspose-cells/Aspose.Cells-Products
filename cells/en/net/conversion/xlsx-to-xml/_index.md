...
description: Sample code for xlsx to xml C# conversion. Use API example code for batch xlsx files to xml conversion within VB.NET, Asp.NET or any .NET based application.
---
