...
description: Aspose Excel. Python Aspose.Cells. Sloučit MHTML do SXC uložit formát. Python Kombinujte formát MHTML až SXC. Sloučit MHTML až SXC v Python. MHTML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHTML až SXC v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHTML až SXC v Python" InputFormat="mhtml" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
