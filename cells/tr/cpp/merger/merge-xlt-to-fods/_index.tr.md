...
url: /tr/cpp/merger/merge-xlt-to-fods/ 
...
Aşağıdaki örnek, XLT'in Aspose.Cells for C++'de FODS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLT ile FODS'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLT\'i FODS ile birleştirmek için C++ kitaplığı" %}}
