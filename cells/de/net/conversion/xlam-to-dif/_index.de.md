---
title: C# XLAM bis DIF - XLAM bis DIF Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM bis DIF in C#" %}}

Das folgende Beispiel zeigt, wie man XLAM in C# in DIF umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLAM über C# in DIF" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLAM-Dateien programmgesteuert in DIF konvertieren? .NET-Entwickler können XLAM mit nur wenigen Codezeilen problemlos in DIF laden und konvertieren.
...
1.  Konvertieren Sie XLAM in DIF durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLAM in DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLAM in DIF" %}}
