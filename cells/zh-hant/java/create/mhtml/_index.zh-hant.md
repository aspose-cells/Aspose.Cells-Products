---
title: 創建MHTML - 在Java中創建MHTML文件
description: Aspose Excel。 Java 創建 MHTML 文件。創建MHTML Java。Java MHTML創建者。在Java中創建MHTML。使用Java生成MHTML文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建MHTML" %}}

{{% blocks/products/pf/agp/text %}}

開發人員只需幾行代碼即可輕鬆在運行不同的報告應用程序中創建、加載、修改和轉換 MHTML 文件以進行數據處理。
...
1. 使用 save() 方法將工作簿保存為 MHTML 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 MHTML 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建MHTML文件" %}}
{{% blocks/products/pf/agp/text %}}
