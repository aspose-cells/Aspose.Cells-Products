...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na DIF za pomocą Aspose.Cells. Python MHT na DIF. Python Zapisz MHT na DIF. Zapisz MHT jako DIF, używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem DIF w Python" %}}

Poniższy przykład ilustruje sposób konwersji MHT na DIF w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji MHT na DIF" %}}
