---
title:  Bölünmüş ODS Dosyalar via .NET
weight: 140
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında ODS belgeyi bölmek için C# kaynak kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="ODS Dosyalarını C#\'e Bölme Adımları" %}}
...
+ Bölme için ODS dosyasını tam yolla yükleyin.
...
{{% blocks/products/pf/agp/code-block title="Bölünmüş ODS Dosya - C#" offSpacer="" %}}
