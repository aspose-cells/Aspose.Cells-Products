---
title: Proteja e bloqueie o documento XLSB via .NET 
weight: 5920
url: /pt/net/protect/xlsb/ 
description: C# código-fonte para bloquear o arquivo XLSB usando senha nas plataformas .NET Framework, .NET Core, Mono ou Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Criptografar arquivos XLSB via C#" h2="Planilhas Excel protegidas por senha, incluindo formato XLSB, usando a biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Proteja XLSB via C#" %}}
...
1. Instanciar a classe Workbook com caminho para o arquivo XLSB1. Obtenha o padrão ou qualquer planilha para adicionar proteção1. Proteger planilha com o método Worksheet.Protect1. Proteger a pasta de trabalho com o método Workbook.Protect1. Salvar resultado no formato XLSB
