---
title: Conversor PHP SXC para JSON - SXC para JSON
description: Aspose Excel. Converta SXC em JSON de forma rápida e fácil com Aspose.Cells. PHP SXC em JSON. PHP Salve SXC em JSON. Salve SXC como JSON usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em JSON via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em JSON programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em JSON em apenas algumas linhas de código.
...
1.  Converta SXC em JSON chamando o método save da pasta de trabalho.
