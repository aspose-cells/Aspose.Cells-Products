...
Potřebujete převést soubory TSV na XLSM programově? Vývojáři C++ mohou snadno převést TSV na XLSM v několika řádcích kódu.
...
1.  Převeďte TSV na XLSM voláním metody Save().
