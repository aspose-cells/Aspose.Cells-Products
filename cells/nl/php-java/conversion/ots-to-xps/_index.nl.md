...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar XPS met Aspose.Cells. PHP OTS naar XPS. PHP Bewaar OTS naar XPS. Sla OTS op als XPS met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar XPS te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar XPS converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar XPS in slechts een paar regels code.
...
1.  Converteer OTS naar XPS door de opslagmethode van Workbook aan te roepen.
