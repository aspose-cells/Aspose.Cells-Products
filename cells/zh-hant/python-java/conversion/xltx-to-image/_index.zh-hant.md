---
title: Python XLTX 轉 IMAGE - 在線 XLTX 轉 IMAGE 轉換器
description: Aspose Excel。 Python Aspose.Cells。Python Aspose Cells。免費在線 Python 將 XLTX 轉換為 IMAGE 保存格式。 Python XLTX 為 IMAGE 格式。將 XLTX 保存到 IMAGE Python。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 XLTX 轉換為 Python 中的 IMAGE" h2="用於將 XLTX 轉換為 IMAGE 的高速 Python 庫。這是一個專業的軟件解決方案，可以使用Python導入和導出XLTX、IMAGE和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何將 XLTX 轉換為 IMAGE？借助 Aspose.Cells for Python 庫，您可以通過幾行代碼以編程方式輕鬆將 XLTX 轉換為 IMAGE。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能夠構建跨平台應用程序，能夠生成、修改、轉換、渲染和打印所有 Excel 文件。 Python Excel API不僅可以在電子表格格式之間進行轉換，還可以將Excel文件渲染為圖像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，從而使其成為行業交換文檔的完美選擇-標準格式。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="免費在線將 XLTX 保存到 Python 中的 IMAGE" %}}

以下示例演示如何將 XLTX 轉換為 Python 中的 IMAGE。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLTX 轉換為 IMAGE。上傳您的 XLTX 文件，然後將其保存為 IMAGE 文件。對於 XLTX 讀取和 IMAGE 寫入，您可以使用完全限定的文件名。輸出的 IMAGE 內容和格式將與原始 XLTX 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 XLTX 轉換為 IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="png" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通過 Python 將 XLTX 轉換為 IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 XLTX 文件轉換為 IMAGE？ Python 開發人員只需幾行代碼即可輕鬆加載 XLTX 並將其轉換為 IMAGE。
...
1. 使用工作簿實例加載 XLTX 文件。
1. 通過調用 Workbook.save 方法將 XLTX 轉換為 IMAGE。
1. 獲取XLTX到IMAGE的轉換結果。
