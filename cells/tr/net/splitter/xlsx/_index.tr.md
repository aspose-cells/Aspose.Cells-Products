---
title:  Bölünmüş XLSX Dosyalar via .NET
weight: 1350
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSX belgeyi bölmek için C# kaynak kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="XLSX Dosyalarını C#\'e Bölme Adımları" %}}
...
+ Bölme için XLSX dosyasını tam yolla yükleyin.
...
{{% blocks/products/pf/agp/code-block title="Bölünmüş XLSX Dosya - C#" offSpacer="" %}}
