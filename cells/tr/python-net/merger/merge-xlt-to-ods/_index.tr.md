...
url: /tr/python-net/merger/merge-xlt-to-ods/ 
...
Aşağıdaki örnek, XLT'in Aspose.Cells for Python via .NET'de ODS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLT ile ODS'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
