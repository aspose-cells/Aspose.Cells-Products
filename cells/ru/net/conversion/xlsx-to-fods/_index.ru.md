...
Нужно программно конвертировать файлы XLSX в FODS? Разработчики .NET могут легко загружать и преобразовывать XLSX в FODS всего за несколько строк кода.
