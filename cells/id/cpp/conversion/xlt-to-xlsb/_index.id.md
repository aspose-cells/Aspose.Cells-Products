---
title: Konversi XLT ke XLSB melalui C++ aplikasi 
url: /id/cpp/conversion/xlt-to-xlsb/ 
description: Contoh C++ kode konversi untuk dokumen XLT ke format XLSB. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLT ke XLSB dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLT ke XLSB melalui C++" h2="Konversi XLT ke XLSB berperforma tinggi menggunakan pustaka C++ tanpa memerlukan penginstalan Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLT ke XLSB hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLT menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (XLSB).1. File XLSB akan disimpan di jalur yang ditentukan.1. Buka file XLSB di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLT ke XLSB C++ Kode Sumber Konversi" offSpacer="" %}}
