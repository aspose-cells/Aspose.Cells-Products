---
title:  XLSX Megjegyzés hozzáadása vagy eltávolítása a C++ számon keresztül
weight: 5260
description: C++ mintakód a XLSX formátumú megjegyzések hozzáadásához vagy törléséhez a C++ Futókörnyezet Windows 32 bites, Windows 64 bites és 64 bites Linux rendszerhez.
...
{{% blocks/products/pf/agp/content h2="A XLSX fájl megjegyzéseinek készítése a C++ használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Megjegyzések hozzáadásának lépései a XLSX-es számon a C++-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Töltse be a XLSX Excel-fájlt az IWorkbook osztályobjektum használatával.
...
{{% blocks/products/pf/agp/code-block title="Megjegyzések hozzáadása a XLSX - C++ számon" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API használható Microsoft Excel formátumok létrehozására, szerkesztésére, konvertálására és renderelésére különböző formátumokba. Ezen túlmenően használható átfogó diagramok készítésére, skálázható jelentésekre és megbízható számításokra a szoftveralkalmazásokon belül. A Aspose.Cells egy önálló API, és nem igényel olyan szoftvert, mint a Microsoft vagy az OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Megjegyzés hozzáadása/eltávolítása a XLSX számról az online alkalmazáson keresztül" sectionDescription=" Törölje a XLSX dokumentumhoz fűzött megjegyzéseket most, látogassa meg webhelyünket[Élő bemutatók weboldala](https://products.aspose.app/cells/annotation). Az élő demónak a következő előnyei vannak" >}}
