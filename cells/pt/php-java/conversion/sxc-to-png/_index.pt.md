---
title: Conversor PHP SXC para PNG - SXC para PNG
description: Aspose Excel. Converta SXC em PNG de forma rápida e fácil com Aspose.Cells. PHP SXC em PNG. PHP Salve SXC em PNG. Salve SXC como PNG usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em PNG via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em PNG programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em PNG em apenas algumas linhas de código.
...
1.  Converta SXC em PNG chamando o método save da pasta de trabalho.
