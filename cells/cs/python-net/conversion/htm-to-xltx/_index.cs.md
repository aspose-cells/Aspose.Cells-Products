...
{{% blocks/products/pf/agp/content h2="Převeďte HTM na XLTX v Python" %}}
...
Následující příklad ukazuje, jak převést HTM na XLTX v Python via NET.
