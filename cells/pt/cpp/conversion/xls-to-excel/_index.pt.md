...
description: Aspose Excel. Converta XLS em EXCEL de forma rápida e fácil com Aspose.Cells. C++ XLS em EXCEL. C++ Salve XLS no EXCEL. Salve XLS como EXCEL usando C++.
...
{{% blocks/products/pf/agp/content h2="Converter XLS em EXCEL usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS no EXCEL em C++" %}}

O exemplo a seguir demonstra como converter XLS em EXCEL em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlsx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS para EXCEL via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para EXCEL programaticamente? Os desenvolvedores do C++ podem converter facilmente o XLS para EXCEL em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS para EXCEL" %}}
