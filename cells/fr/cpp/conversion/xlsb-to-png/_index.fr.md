---
title: Convertir XLSB en PNG via l'application C++ 
weight: 2800
url: /fr/cpp/conversion/xlsb-to-png/ 
description: Exemple de code de conversion C++ pour le document XLSB au format PNG. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLSB en PNG dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en PNG via C++" h2="Conversion XLSB en PNG haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en PNG en utilisant C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLSB en PNG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier XLSB en PNG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLSB à l'aide de Factory :: CreateIWorkbook.1. Sélectionnez la première feuille de calcul.1. Définir les options (PNG).1. Parcourez chaque page de la feuille et effectuez le rendu.1. Ouvrez le fichier PNG dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="XLSB en PNG C++ Code source de conversion" offSpacer="" %}}
