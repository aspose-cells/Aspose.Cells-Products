---
title: Python MHT إلى XML - محول MHT عبر الإنترنت إلى XML
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل MHT إلى تنسيق حفظ XML. Python MHT إلى تنسيق XML. احفظ MHT في XML Python.
...
هل تحتاج إلى تحويل ملفات MHT إلى XML برمجيًا؟ يمكن للمطورين Python تحميل وتحويل MHT إلى XML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XML عن طريق استدعاء طريقة Workbook.save.
1.  احصل على نتيجة تحويل MHT إلى XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python مكتبة لتحويل MHT إلى XML" %}}
