---
title: Voeg XLT samen tot JPG - Combineer XLT tot JPG in Java
url: /nl/java/merger/merge-xlt-to-jpg/ 
description: Aspose Excel. Java Aspose.Cells. Voeg XLT samen naar JPG-opslagformaat. Java Combineer XLT naar JPG-formaat. Voeg XLT samen naar JPG in Java. XLT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen naar JPG in Java" %}}

Het volgende voorbeeld laat zien hoe u XLT samenvoegt met JPG in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLT samen te voegen naar JPG. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op als JPG-bestand. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld Java waarin XLT wordt samengevoegd tot JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLT samen te voegen met JPG in Java" InputFormat="xlt" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLT samenvoegt met JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLT programmatisch samenvoegen met JPG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLT samen te voegen naar JPG" %}}
