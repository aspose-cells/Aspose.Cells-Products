---
title: Unisci NUMBERS a NUMBERS - Combina NUMBERS a NUMBERS in Python
url: /it/python-net/merger/merge-numbers-to-numbers/ 
description: Aspose Excel. Python Aspose.Cells. Unisci NUMBERS in NUMBERS online gratis in saveformat. Python Combina NUMBERS in formato NUMBERS. Unisci NUMBERS a NUMBERS in Python. NUMBERS Unisci.
...
L'esempio seguente mostra come unire NUMBERS a NUMBERS in Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Online gratuito per unire NUMBERS a NUMBERS in Python" InputFormat="numbers" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Come unire NUMBERS a NUMBERS tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di unire NUMBERS a NUMBERS in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Le API possono essere eseguite con poche righe di codice.
