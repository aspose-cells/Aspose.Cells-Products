---
title: Konvertera SXC till TIFF via Python
url: /sv/python-java/conversion/sxc-to-tiff/
description: Exempelkod för konvertering från sxc till tiff Python. Använd API exempelkod för batch-sxc-filer för att tiff-konvertera i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till TIFF med Python" %}}

 För att konvertera SXC till TIFF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till TIFF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera SXC-filer till TIFF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SXC-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med TIFF-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande TIFF-filen
