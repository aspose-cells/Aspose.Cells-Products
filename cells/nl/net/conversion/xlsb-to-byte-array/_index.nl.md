...
weight: 7690
url: /nl/net/conversion/xlsb-to-byte-array/ 
description: C# Voorbeeldcode voor conversie van XLSB naar byte-array. Gebruik deze code voor Excel XLSB naar Byte Array-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLSB naar byte-array via C#" h2="Native en krachtige Microsoft Excel XLSB naar byte-arrayconversie of vice versa voor gegevensverwerking in spreadsheets met server-side .NET API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array is handig voor het verwerken of opslaan van gegevens. U kunt een XLSB-bestand converteren naar Byte Array, evenals een **Byte Array naar XLSB**-document in de taal C#. Om XLSB naar byte-array te converteren, gebruiken we
...
{{% blocks/products/pf/agp/text %}}
 ...
 Het is gemakkelijk voor de ontwikkelaars om XLSB-bestanden te laden en te converteren naar byte-array voor verdere manipulatietaken in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Neem de naamruimte op in uw klassenbestand1. Laad invoer XLSB-bestand met behulp van werkmap1. MemoryStream-object initialiseren1. Converteer streamgegevens naar bytearray1. Verwerk gegevens vanaf uw vereiste:
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont XLSB naar bytearray C# Conversie" offSpacer="" %}}
...
Een Excel Spreadsheet Programming Library die in staat is om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. .NET Excel API converteert niet alleen tussen spreadsheet-indelingen, het kan ook Excel-bestanden, waaronder XLSB, weergeven als afbeeldingen, PDF, HTML, ODS en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardindelingen.
