---
title: تحويل XLS إلى SPREADSHEETML عبر تطبيق C++ 
url: /ar/cpp/conversion/xls-to-spreadsheetml/ 
description: نموذج رمز تحويل C++ لمستند XLS إلى تنسيق SPREADSHEETML. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLS دفعة إلى SPREADSHEETML داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLS إلى SPREADSHEETML عبر C++" h2="تحويل XLS عالي الأداء إلى SPREADSHEETML باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى SPREADSHEETML باستخدام C++" %}}

 من أجل تحويل XLS إلى SPREADSHEETML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLS إلى SPREADSHEETML عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ بسهولة تحويل ملف XLS إلى SPREADSHEETML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLS باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (SPREADSHEETML).1. سيتم حفظ ملف SPREADSHEETML في المسار المحدد.1. افتح ملف SPREADSHEETML في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLS إلى شفرة مصدر التحويل SPREADSHEETML C++" offSpacer="" %}}
