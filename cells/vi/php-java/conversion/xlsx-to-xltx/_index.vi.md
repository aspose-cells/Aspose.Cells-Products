---
title: Chuyển đổi PHP XLSX sang XLTX - XLSX sang XLTX
description: Aspose Excel. Chuyển đổi XLSX thành XLTX nhanh chóng và dễ dàng với Aspose.Cells. PHP XLSX thành XLTX. PHP Lưu XLSX thành XLTX. Lưu XLSX thành XLTX bằng PHP.
...
{{% cells-convert title="Mã mẫu chuyển đổi XLSX thành XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xltx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSX thành XLTX qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLSX thành XLTX theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi XLSX thành XLTX chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLSX thành XLTX bằng cách gọi phương thức lưu của Workbook.
