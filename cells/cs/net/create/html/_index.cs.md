...
description: HTML tvůrce. Vytvořte soubory HTML v kódu C#. Vygenerujte soubory HTML pomocí VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/code-block title="Ukázkový kód pro vytvoření souboru HTML pomocí C#." offSpacer="" %}}
