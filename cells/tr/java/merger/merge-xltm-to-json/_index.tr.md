---
title:  XLTM'i JSON via Java ile birleştir
...
Aşağıdaki örnek, XLTM'in Java'de JSON ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLTM\'i hatta JSON ile birleştirmek için Ücretsiz Uygulama" InputFormat="xltm" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
