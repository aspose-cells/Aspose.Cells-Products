---
title:  Comment dessiner ou insérer une flèche droite dans Excel en utilisant Python via Java
weight: 10
description: Python via Java code source pour dessiner ou insérer une flèche droite dans Excel.
...
{{% blocks/products/pf/agp/content h2="Comment insérer une flèche droite dans un fichier Excel à l\'aide de Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une flèche droite dans un fichier Excel en utilisant Python via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) pour insérer une flèche droite dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer une flèche droite - Python via Java" offSpacer="" %}}
