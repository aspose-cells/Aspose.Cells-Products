...
description: Aspose 엑셀. Aspose.Cells을 사용하여 PRN을 TABDELIMITED로 빠르고 쉽게 변환하세요. PHP PRN을 TABDELIMITED로 변환하세요. PHP PRN을 TABDELIMITED에 저장합니다. PHP를 사용하여 PRN을 TABDELIMITED로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="PHP에서 PRN을 TABDELIMITED에 저장" %}}

다음 예에서는 PHP에서 PRN을 TABDELIMITED로 변환하는 방법을 보여줍니다.
...
{{% blocks/products/pf/agp/content h2="PHP를 통해 PRN을 TABDELIMITED로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 PRN 파일을 TABDELIMITED로 변환해야 합니까? PHP 개발자는 단 몇 줄의 코드만으로 PRN을 TABDELIMITED로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook의 save 메소드를 호출하여 PRN을 TABDELIMITED로 변환합니다.
1.  PRN을 TABDELIMITED로 변환한 결과를 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PRN을 TABDELIMITED로 변환하는 PHP 라이브러리" %}}
