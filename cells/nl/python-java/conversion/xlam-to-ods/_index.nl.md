---
title: XLAM naar ODS - Converteer XLAM naar ODS Python via Python
...
{{% blocks/products/pf/agp/content h2="Hoe XLAM te converteren naar ODS via Python" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLAM-bestanden programmatisch converteren naar ODS? Python-ontwikkelaars kunnen eenvoudig XLAM laden en converteren naar ODS in slechts een paar regels code.
...
1.  Converteer XLAM naar ODS door de methode Workbook.save aan te roepen.
