---
title: C++ FODS naar CIJFERS - FODS naar CIJFERS Omzetter
...
{{% blocks/products/pf/agp/content h2="Sla FODS op in de lijst met nummers in C++" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar cijfers in C++.
...
{{% blocks/products/pf/agp/content h2="Hoe zet je FODS om naar cijfers via C++?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u bestanden met de extensie FODS programmatisch converteren naar NUMBERS? Ontwikkelaars van C++ kunnen bestanden met de extensie FODS eenvoudig in een paar regels code converteren naar NUMBERS.
...
1.  Converteer FODS naar NUMBERS door de Save()-methode aan te roepen.
1.  Bereken het resultaat van de conversie van FODS naar cijfers.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ bibliotheek om FODS naar getallen te converteren" %}}
