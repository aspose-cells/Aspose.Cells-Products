---
title: C# XLS do XLS - Konwerter online XLS do XLS
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Bezpłatnie online C# Konwertuj XLS na XLS saveformat. C# XLS do XLS w formacie. Zapisz XLS do XLS C#.
...
{{% blocks/products/pf/agp/content h2="Zaoszczędź XLS do XLS w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na XLS w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na XLS. Prześlij swój plik XLS, a następnie po prostu zapisz go jako plik XLS. Zarówno do odczytu XLS, jak i zapisu XLS można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie XLS będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLS na XLS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na XLS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na XLS? Programiści .NET mogą łatwo załadować i przekonwertować XLS na XLS w zaledwie kilku wierszach kodu.
