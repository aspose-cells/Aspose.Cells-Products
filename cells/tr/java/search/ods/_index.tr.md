---
title:  ODS belgesini açmadan ara via Java
weight: 8140
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı'ndaki ODS dosyasındaki desenli kelimeleri aramak için Java örnek kod.
...
{{< blocks/products/pf/i18n/upper-banner h1="ODS Formatlarını Java\'de arayın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan, sunucu tarafı Aspose.Cells for Java API\'lerini kullanarak yerel ve yüksek performanslı ODS belge arama." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak ODS Dosyası Nasıl Aranır?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODS Dosyalarını Java\'de Arama Adımları" %}}
...
+ Bir Çalışma Kitabı nesnesinin örneğini oluşturarak ODS dosyasını yükleyin.
+ ODS dosyasındaki ilk çalışma sayfasına erişin.
...
{{% blocks/products/pf/agp/code-block title="ODS Dosyalarını Ara - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi ODS Canlı Demoları Arayın" sectionDescription=" Hemen şimdi sitemizi ziyaret ederek ODS doküman içerisinde metin, kelime, kelime öbeği arayın.[Canlı Demolar web sitesi](https://products.aspose.app/cells/search). Canlı demo aşağıdaki avantajlara sahiptir" >}}
