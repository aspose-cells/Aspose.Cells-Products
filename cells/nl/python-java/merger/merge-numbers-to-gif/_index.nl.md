...
url: /nl/python-java/merger/merge-numbers-to-gif/ 
...
Het volgende voorbeeld laat zien hoe u NUMBERS kunt samenvoegen tot GIF in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u NUMBERS programmatisch samenvoegen tot GIF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
