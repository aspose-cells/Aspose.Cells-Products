---
title:  Dodaj lub usuń plik Excel XLSB Adnotacja pod numerem C++
weight: 860
description: C++ przykładowy kod do usuwania adnotacji w formacie XLSB w środowisku wykonawczym C++ dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby dodać komentarze w pliku XLSB za pośrednictwem C++" %}}
