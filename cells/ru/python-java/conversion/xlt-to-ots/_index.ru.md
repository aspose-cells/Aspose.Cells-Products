...
{{% blocks/products/pf/agp/content h2="Преобразуйте XLT в OTS, используя Python" %}}
...
В следующем примере показано, как преобразовать XLT в OTS в Python.
