---
title:  Mesclar EXCEL para NUMBERS via Python
url: /pt/python-java/merger/merge-excel-to-numbers/ 
description: Mescle EXCEL para NUMBERS Online gratuitamente. Fusão online gratuita de EXCEL para NUMBERS. Mesclar EXCEL para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar EXCEL para NUMBERS em Python.
...
{{% cells-merger title="Aplicativo gratuito para mesclar EXCEL para NUMBERS online" InputFormat="xlsx" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
