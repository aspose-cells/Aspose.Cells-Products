---
title: Sloučit PRN s FODS – Sloučit PRN s FODS v C++
url: /cs/cpp/merger/merge-prn-to-fods/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit PRN do formátu uložení FODS. C++ Zkombinujte PRN do formátu FODS. Sloučit PRN na FODS v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na FODS v C++" %}}

Následující příklad ukazuje, jak sloučit PRN s FODS v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do FODS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru FODS. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí PRN do FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení PRN s FODS v C++" InputFormat="prn" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na FODS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s FODS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení PRN s FODS" %}}
