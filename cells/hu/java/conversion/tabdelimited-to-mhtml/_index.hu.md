---
title: "TABDELIMITED konvertálása MHTML-re a következőn keresztül: Java "

description: Minta Java konverziós kód a TABDELIMITED formátumhoz MHTML fájlba. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására MHTML-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED konvertálása MHTML-re a következőn keresztül: Java" h2="TABDELIMITED MHTML Java konverzió egyetlen vagy több oldal MHTML formátumba konvertálásához a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="A TABDELIMITED konvertálása MHTML-re a következővel: Java" %}}

 A TABDELIMITED MHTML formátumban való megjelenítéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TABDELIMITED MHTML-re konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java fejlesztői könnyedén konvertálhatnak TABDELIMITED fájlt MHTML-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat MHTML kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott MHTML-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED MHTML Java konverziós forráskódra" offSpacer="" %}}

```cs
// töltse be a TABDELIMITED fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tabdelimited");
// a TABDELIMITED mentése MHTML-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED MHTML Conversion Live Demos" sectionDescription="[A TABDELIMITED konvertálása MHTML-re](https://products.aspose.app/cells/conversion/tabdelimited-to-mhtml) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel TABDELIMITED fájlját, amely azonnal MHTML formátumba konvertálódik." >}}
