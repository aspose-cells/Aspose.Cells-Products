...
description: Aspose Exceller. Convertissez XML en ET rapidement et facilement avec Aspose.Cells. Java XML en ET. Java Enregistrez XML dans ET. Enregistrez XML au format ET en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en ET à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML dans ET au Java" %}}

L'exemple suivant montre comment convertir XML en ET dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XML en ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en ET par programme ? Les développeurs Java peuvent facilement convertir XML en ET en quelques lignes de code seulement.
