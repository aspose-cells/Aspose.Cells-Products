---
title:  แทรกแถบเลื่อน (ตัวควบคุมฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 90
description: Python via ซอร์สโค้ด .Net เพื่อแทรก ScrollBar (ตัวควบคุมฟอร์ม) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกแถบเลื่อน (ตัวควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก ScrollBar (Form control) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_scroll_bar/#int-int-int-int-int-int) เพื่อแทรกแถบเลื่อน (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกแถบเลื่อน(ตัวควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
