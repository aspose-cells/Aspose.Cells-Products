...
下面的例子演示了如何将EXCEL合并到Aspose.Cells for C++中的TSV。
...
需要以编程方式将 EXCEL 合并到 TSV 吗？基本文档合并和连接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需几行代码即可完成 API。
