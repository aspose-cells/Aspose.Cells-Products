---
title: Criar BMP - Criar arquivo BMP em C#
description: Aspose Excel. Gere e manipule arquivos BMP sem esforço com a biblioteca Aspose.Cells for .NET. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos BMP diretamente em seus aplicativos C#, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
{{% blocks/products/pf/agp/content h2="Como criar BMP em C#" %}}
...
1.  Use o método Salvar para salvar a pasta de trabalho como arquivo BMP.

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo BMP em C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para criar o arquivo BMP" %}}
