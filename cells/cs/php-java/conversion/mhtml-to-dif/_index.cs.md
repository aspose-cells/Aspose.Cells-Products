---
title: Konvertor PHP MHTML až DIF - MHTML až DIF
description: Aspose Excel. Převeďte MHTML na DIF rychle a snadno pomocí Aspose.Cells. PHP MHTML na DIF. PHP Uložte MHTML na DIF. Uložte DIF jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na DIF přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na DIF programově? Vývojáři PHP mohou snadno načíst a převést MHTML na DIF v několika řádcích kódu.
...
1.  Převeďte MHTML na DIF voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na DIF" %}}
