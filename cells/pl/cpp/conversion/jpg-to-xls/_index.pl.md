...
Trzeba programowo przekonwertować pliki JPG do formatu XLS? Programiści C++ mogą łatwo przekonwertować pliki JPG do formatu XLS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JPG do XLS wywołując metodę Save().
