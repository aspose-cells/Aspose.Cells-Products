---
title: Połącz MHT z ET - Połącz MHT z ET pod numerem Java
url: /pl/java/merger/merge-mht-to-et/ 
description: Aspose Excel. Java Aspose.Cells. Połącz format zapisu MHT z formatem ET. Java Połącz format MHT z ET. Połącz MHT z ET pod numerem Java. Połącz MHT.
...
{{% blocks/products/pf/agp/content h2="Połącz MHT z ET w Java" %}}

Poniższy przykład pokazuje, jak połączyć MHT z ET w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć MHT z ET. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku ET. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy MHT z ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia MHT z ET w Java" InputFormat="mht" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć MHT z ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć MHT z ET? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do łączenia MHT z ET" %}}
