...
{{% blocks/products/pf/agp/content h2="Save XLS to MHT in C#" %}}

The following example demonstrates how to convert XLS to MHT in C#.
...
{{% cells-convert title="Sample Code to Convert XLS to MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLS to MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert XLS files to MHT programmatically? .NET developers can easily load & convert XLS to MHT in just a few lines of code.
...
1.  Convert XLS to MHT by calling Workbook.Save method.
1.  Get the conversion result of XLS to MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# library to convert XLS to MHT" %}}
