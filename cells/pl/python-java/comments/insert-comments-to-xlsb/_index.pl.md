---
title: Wstaw komentarze do pliku XLSB pod numerem Python
url: /pl/python-java/comments/insert-comments-to-xlsb/ 
description: Wstaw komentarze pod numerem XLSB, używając numeru Python. Użyj przykładowego kodu API, aby wstawić komentarze w aplikacji Python.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić komentarze w pliku XLSB poprzez Python" %}}
...
Office 365 komentarze służą do rozmów, możesz użyć następującego kodu Python, aby wstawiać i usuwać komentarze w pliku XLSB.

{{% blocks/products/pf/agp/code-block title="Python przykładowy kod do wstawiania i usuwania komentarzy w pliku XLSB" offSpacer="" %}}
