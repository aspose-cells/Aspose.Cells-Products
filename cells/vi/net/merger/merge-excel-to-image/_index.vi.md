---
title: Gộp EXCEL vào HÌNH ẢNH - Gộp EXCEL vào HÌNH ẢNH trong C#
url: /vi/net/merger/merge-excel-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất EXCEL thành định dạng lưu HÌNH ẢNH. C# Kết hợp định dạng EXCEL với HÌNH ẢNH. Hợp nhất EXCEL với HÌNH ẢNH trong C#. Hợp nhất EXCEL.
...
{{% blocks/products/pf/agp/content h2="Gộp EXCEL vào IMAGE số C#" %}}

Ví dụ sau đây minh họa cách hợp nhất EXCEL với IMAGE trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất EXCEL với HÌNH ẢNH. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp HÌNH ẢNH. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất EXCEL với HÌNH ẢNH.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Code mẫu gộp EXCEL vào IMAGE C#" InputFormat="xlsx" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp EXCEL vào HÌNH ẢNH qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất EXCEL với HÌNH ẢNH theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để ghép EXCEL vào HÌNH ẢNH" %}}
