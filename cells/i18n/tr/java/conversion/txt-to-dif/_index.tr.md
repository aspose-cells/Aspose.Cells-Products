---
title: Java aracılığıyla TXT'yi DIF'ye dönüştürün 
weight: 8220
url: /tr/java/conversion/txt-to-dif/ 
description: TXT biçimi için DIF dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada DIF'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla TXT\'yi DIF\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı DIF\'ye dönüştürmek için TXT\'den DIF\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TXT\'yi DIF\'ye Dönüştürme" %}}

 TXT'yi DIF'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla TXT\'yi DIF\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla TXT dosyasını kolayca DIF'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TXT dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. DIF uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan DIF dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="TXT - DIF Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TXT dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.txt");
// TXT'yi DIF olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT\'den DIF\'ye Dönüşüm Canlı Demoları" sectionDescription="[TXT\'yi DIF\'ye dönüştür](https://products.aspose.app/cells/conversion/txt-to-dif) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece TXT dosyanızı yükleyin, anında DIF\'ye dönüştürülecektir." >}}
