...
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till FODS-format, vilket möjliggör sömlös sparning av XLS-data till FODS-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% cells-convert title="Exempelkod för att konvertera XLS till FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till FODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till FODS programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till FODS på bara några rader kod.
...
1.  Konvertera XLS till FODS genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet från XLS till FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-biblioteket för att konvertera XLS till FODS" %}}
