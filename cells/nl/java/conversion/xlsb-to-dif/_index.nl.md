...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in DIF in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar DIF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar DIF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar DIF? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar DIF met slechts een paar regels code.
