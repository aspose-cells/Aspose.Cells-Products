---
title: Java HTM na BMP - Konwerter HTM na BMP
description: Aspose Excel. Konwertuj HTM na BMP szybko i łatwo za pomocą Aspose.Cells. Java HTM na BMP. Java Zapisz HTM na BMP. Zapisz HTM jako BMP, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM pod numerem BMP w Java" %}}

Poniższy przykład ilustruje sposób konwersji HTM na BMP w Java.
...
Chcesz programowo przekonwertować pliki HTM na BMP? Programiści Java mogą z łatwością przekonwertować HTM na BMP w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj HTM na BMP, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji HTM na BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji HTM na BMP" %}}
{{% blocks/products/pf/agp/text %}}
