...
weight: 3890
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼의 XLSB 파일에서 중요한 정보를 수정합니다.
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 XLSB 파일을 수정하는 방법" %}}
 ...
 XLSB 파일을 수정하기 위해 다음을 사용합니다.[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API은 기능이 풍부하고 강력하며 사용하기 쉬운 C# 플랫폼용 문서 조작 API입니다. 열려 있는[NuGet](https://www.nuget.org/packages/aspose.cells) 패키지 관리자, 검색**Aspose.Cells** 그리고 설치하세요. 패키지 관리자 콘솔에서 다음 명령을 사용할 수도 있습니다.
...
{{% blocks/products/pf/agp/code-block title="XLSB 파일 수정 - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API은 Microsoft Excel 형식을 다른 형식으로 생성, 편집, 변환 및 렌더링하는 데 사용할 수 있습니다. 또한 소프트웨어 애플리케이션 내에서 포괄적인 차트 작성, 확장 가능한 보고 및 신뢰할 수 있는 계산에 사용할 수 있습니다. Aspose.Cells은 독립형 API이며 Microsoft 또는 OpenOffice와 같은 소프트웨어가 필요하지 않습니다.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="온라인 XLSB 편집 라이브 데모" sectionDescription=" 지금 바로 당사를 방문하여 XLSB 문서의 내용, 댓글 또는 메타데이터의 텍스트를 검색하고 교체하세요.[라이브 데모 웹사이트](https://products.aspose.app/cells/redaction). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
