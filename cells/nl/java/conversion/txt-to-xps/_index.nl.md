...
{{% blocks/products/pf/agp/content h2="Sla TXT op in XPS in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar XPS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar XPS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar XPS? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar XPS met slechts een paar regels code.
