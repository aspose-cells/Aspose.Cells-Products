---
title: MHTML mit FODS zusammenführen - MHTML mit FODS in Java kombinieren
url: /de/java/merger/merge-mhtml-to-fods/ 
description: Aspose Excel. Java Aspose.Cells. MHTML mit FODS Saveformat zusammenführen. Java Kombinieren Sie das Format MHTML mit dem Format FODS. MHTML zu FODS in Java zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="MHTML mit FODS in Java zusammenführen" %}}

Das folgende Beispiel zeigt, wie MHTML mit FODS in Aspose.Cells for Java zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von MHTML mit FODS in Java" InputFormat="mhtml" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie MHTML mit FODS via Java zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie MHTML programmgesteuert mit FODS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Java](https://products.aspose.com/cells/java) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Zusammenführen von MHTML mit FODS" %}}
