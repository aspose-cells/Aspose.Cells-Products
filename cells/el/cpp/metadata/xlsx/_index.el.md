---
title:  Επεξεργασία ή προβολή XLSX Μεταδεδομένα εγγράφου μέσω C++
weight: 8970
...
{{% blocks/products/pf/agp/content h2="Πώς να λάβετε μεταδεδομένα XLSX χρησιμοποιώντας το C++" %}}

Για να εξαγάγουμε τα μεταδεδομένα XLSX, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την εξαγωγή μεταδεδομένων του XLSX μέσω του C++" %}}
...
+ Φόρτωση αρχείου XLSX χρησιμοποιώντας το CreateIWorkbookMetadata
