---
title: สร้างไฟล์ MS Excel XLSX via Java
description: XLSX ผู้สร้าง. สร้างไฟล์ XLSX ในรหัส Java สร้างไฟล์ MS Excel XLSX โดยใช้เดสก์ท็อปหรือเว็บแอปพลิเคชัน Java
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="สร้าง XLSX ไฟล์ via Java" h2="การสร้างสเปรดชีต MS Excel XLSX แบบเนทีฟและประสิทธิภาพสูงโดยใช้โปรแกรมโดยใช้ไลบรารี Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีสร้าง XLSX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ซอร์สโค้ดต่อไปนี้แสดงวิธีสร้างไฟล์ MS Excel XLSX โดยใช้ Java" offSpacer="" %}}
