---
title: C# SXC en SPREADSHEETML - Convertisseur en ligne SXC en SPREADSHEETML
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir SXC en format de sauvegarde SPREADSHEETML. C# SXC au format SPREADSHEETML. Enregistrez SXC dans SPREADSHEETML C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez SXC dans SPREADSHEETML dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir SXC en SPREADSHEETML dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir SXC en SPREADSHEETML. Téléchargez votre fichier SXC, puis enregistrez-le simplement en tant que fichier SPREADSHEETML. Pour la lecture SXC et l'écriture SPREADSHEETML, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie SPREADSHEETML seront identiques au document SXC d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir SXC en SPREADSHEETML en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir SXC en SPREADSHEETML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers SXC en SPREADSHEETML par programmation ? Les développeurs .NET peuvent facilement charger et convertir SXC en SPREADSHEETML en quelques lignes de code.
...
1.  Convertissez SXC en SPREADSHEETML en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de SXC en SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="bibliothèque C# pour convertir SXC en SPREADSHEETML" %}}
