...
Perlu mengonversi file EXCEL ke JSON secara terprogram? Pengembang C++ dapat dengan mudah mengubah EXCEL menjadi JSON hanya dalam beberapa baris kode.
...
1.  Ubah EXCEL menjadi JSON dengan memanggil metode Save().
