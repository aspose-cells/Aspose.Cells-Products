---
title: Python JPG إلى JPEG - محول JPG عبر الإنترنت إلى JPEG
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل JPG إلى JPEG saveformat. Python JPG إلى تنسيق JPEG. احفظ JPG في JPEG Python.
...
{{% blocks/products/pf/agp/content h2="تحويل JPG إلى JPEG باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ JPG في JPEG في Python عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل JPG إلى JPEG في Python.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل JPG إلى JPEG" %}}
