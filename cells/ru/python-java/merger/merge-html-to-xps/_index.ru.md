...
description: Aspose Эксель. Python Aspose.Cells. Объедините HTML и XPS в формате сохранения. Python Объедините форматы HTML и XPS. Объедините HTML и XPS в Python. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML с XPS, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и XPS в Python." %}}

В следующем примере показано, как объединить HTML и XPS в Aspose.Cells for Python via Java.
