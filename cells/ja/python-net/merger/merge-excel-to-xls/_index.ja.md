...
次の例は、EXCEL を Aspose.Cells for Python via .NET の XLS にマージする方法を示しています。
...
プログラムで EXCEL を XLS にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
