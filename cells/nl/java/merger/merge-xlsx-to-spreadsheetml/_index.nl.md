...
description: Aspose Excel. Java Aspose.Cells. Gratis online Samenvoegen XLSX naar SPREADSHEETML saveformat. Java Combineer XLSX naar SPREADSHEETML-indeling. Samenvoegen XLSX naar SPREADSHEETML in Java. XLSX Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLSX samen met SPREADSHEETML in Java online" %}}

Het volgende voorbeeld laat zien hoe u XLSX kunt samenvoegen met SPREADSHEETML in Aspose.Cells for Java.
...
{{% cells-merger title="Gratis online om XLSX samen te voegen tot SPREADSHEETML in Java" InputFormat="xlsx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSX samen te voegen tot SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met SPREADSHEETML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSX samen te voegen tot SPREADSHEETML" %}}
