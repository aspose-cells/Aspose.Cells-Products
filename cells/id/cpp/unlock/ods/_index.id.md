...
weight: 1190
url: /id/cpp/unlock/ods/ 
description: C++ kode contoh untuk membuka kunci file ODS yang dilindungi sandi di C++ Runtime Environment untuk Windows 32 bit, Windows 64 bit, dan Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Buka Kunci File ODS melalui C++" h2="Hapus perlindungan dari spreadsheet Excel termasuk file ODS menggunakan C++ Pustaka." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Menghapus Perlindungan File ODS Menggunakan C++" %}}
...
1. Muat file terkunci ODS menggunakan CreateIWorkbook.1. Panggil fungsi Unprotect() untuk membuka kunci.1. Setel kata sandi ke NULL menggunakan SetPassword.1. Simpan file ODS di lokasi yang ditentukan.
