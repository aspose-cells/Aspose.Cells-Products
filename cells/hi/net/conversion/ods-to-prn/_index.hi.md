---
title: C# ODS से पीआरएन - ODS से पीआरएन कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ ODS को पीआरएन में जल्दी और आसानी से बदलें। C# ODS को पीआरएन में बदलें। C# पीआरएन में ODS सहेजें। C# का उपयोग करके ODS को पीआरएन के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="C# में पीआरएन के लिए ODS सेव करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि ODS को C# में पीआरएन में कैसे परिवर्तित किया जाए।
{{% blocks/products/pf/agp/text %}}

ODS को पीआरएन में बदलने के लिए आसान चरणों का पालन करें। अपनी ODS फ़ाइल अपलोड करें, फिर इसे पीआरएन फ़ाइल के रूप में सहेजें। ODS पढ़ने और पीआरएन लेखन दोनों के लिए आप पूरी तरह से योग्य फ़ाइल नामों का उपयोग कर सकते हैं। आउटपुट पीआरएन सामग्री और स्वरूपण मूल ODS दस्तावेज़ के समान होगा।

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="ODS को पीआरएन में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="ODS को C# के माध्यम से पीआरएन में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

ODS फ़ाइलों को प्रोग्रामेटिक रूप से PRN में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में ODS को आसानी से पीआरएन में लोड और परिवर्तित कर सकते हैं।
...
1.  Workbook.Save पद्धति पर कॉल करके ODS को PRN में कनवर्ट करें।
1.  ODS का पीआरएन में रूपांतरण परिणाम प्राप्त करें।

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ODS को पीआरएन में बदलने के लिए C# लाइब्रेरी" %}}
