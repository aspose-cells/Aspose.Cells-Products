---
title:  XLSM belgesi via .NET'den metin ve resimleri ayıklayın
weight: 4010
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarındaki XLSM dosyasından metin ve görüntüleri ayıklamak için C# kaynak kodu.
---
