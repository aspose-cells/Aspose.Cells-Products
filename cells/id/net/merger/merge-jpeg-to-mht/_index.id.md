...
url: /id/net/merger/merge-jpeg-to-mht/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan JPEG ke format simpan MHT. C# Gabungkan JPEG ke format MHT. Gabung JPEG menjadi MHT di C#. JPEG Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPEG menjadi MHT di C#" %}}

Contoh berikut menunjukkan cara menggabungkan JPEG ke MHT di Aspose.Cells for .NET.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan JPEG menjadi MHT di C#" InputFormat="jpg" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JPEG ke MHT lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan JPEG ke MHT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan JPEG ke MHT" %}}
