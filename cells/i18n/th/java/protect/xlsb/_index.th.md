---
title: ป้องกันและล็อกเอกสาร XLSB ผ่าน Java 
weight: 6590
url: /th/java/protect/xlsb/ 
description: Java ตัวอย่างโค้ดสำหรับล็อกไฟล์ XLSB โดยใช้รหัสผ่านบน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="เข้ารหัสไฟล์ XLSB ผ่าน Java" h2="สเปรดชีต Excel ที่ป้องกันด้วยรหัสผ่านรวมถึงรูปแบบ XLSB โดยใช้ .NET Library" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการปกป้องไฟล์ XLSB ผ่าน Java" %}}
...
1. โหลดไฟล์ XLSB โดยสร้างอินสแตนซ์ของคลาสเวิร์กบุ๊ก1. ใช้วิธีป้องกัน (..) กับ ProtectionType และ Password1. บันทึกไฟล์ XLSB ที่ได้รับการป้องกันโดย save() method
