---
title: Fusionner MHT avec MARKDOWN - Combiner MHT avec MARKDOWN dans Python
url: /fr/python-java/merger/merge-mht-to-markdown/ 
description: Aspose Exceller. Python Aspose.Cells. Fusionner MHT avec le format de sauvegarde MARKDOWN. Python Combinez MHT au format MARKDOWN. Fusionner MHT avec MARKDOWN dans Python. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec MARKDOWN en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec MARKDOWN dans Python" %}}

L'exemple suivant montre comment fusionner MHT avec MARKDOWN dans Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT avec MARKDOWN. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-le dans le fichier MARKDOWN. Si vous développez du code en Python, ce sera plus simple qu'il n'y paraît. Voir l'exemple Python qui fusionne MHT avec MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner MHT avec MARKDOWN dans Python" InputFormat="mht" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec MARKDOWN via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner MHT avec MARKDOWN par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner MHT avec MARKDOWN" %}}
