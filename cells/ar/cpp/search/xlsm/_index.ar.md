---
title:  ابحث عن مستند XLSM بدون فتح عبر C++
weight: 9280
description: C++ رمز المثال للبحث عن الكلمات ذات النمط في ملف XLSM على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
{{< blocks/products/pf/i18n/upper-banner h1="ابحث عن XLSM التنسيقات في C++" h2="بحث أصلي وعالي الأداء في المستندات XLSM باستخدام واجهات برمجة التطبيقات Aspose.Cells for C++ من جانب الخادم، دون استخدام أي برنامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث عن الملفات XLSM في C++" %}}
...
+ قم بتحميل ملف XLSM عن طريق إنشاء فئة Workbook.
...
+ احفظ ملف XLSM باستخدام طريقة Workbook::Save(...).
...
{{% blocks/products/pf/agp/code-block title="بحث XLSM ملفات - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="عبر الإنترنت XLSM بحث العروض الحية" sectionDescription=" ابحث عن النصوص والكلمات والعبارات ضمن XLSM مستندًا الآن من خلال زيارة موقعنا[موقع العروض الحية](https://products.aspose.app/cells/search). يتمتع العرض التجريبي المباشر بالمزايا التالية" >}}
