---
title:  قم بإدراج ListBox (التحكم في النموذج) في Excel باستخدام Python via .Net
weight: 50
description: Python via. كود المصدر الصافي لإدراج ListBox (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج ListBox (التحكم في النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج ListBox (تحكم النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_list_box/#int-int-int-int-int-int) لإدراج ListBox (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج ListBox (التحكم في النموذج) - Python via .Net" offSpacer="" %}}
