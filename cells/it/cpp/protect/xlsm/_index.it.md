...
weight: 8770
url: /it/cpp/protect/xlsm/ 
description: C++ codice di esempio per bloccare il file XLSM utilizzando la password in C++ Runtime Environment per Windows a 32 bit, Windows a 64 bit e Linux a 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crittografa i file XLSM tramite C++" h2="Proteggi con password i fogli di lavoro Excel, incluso il formato XLSM, utilizzando .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
1. Carica il file XLSM usando la classe IWorkbook1. Utilizzare il metodo Protect(..) con ProtectionType e Password1. Salva il file XLSM protetto con il metodo Save()
