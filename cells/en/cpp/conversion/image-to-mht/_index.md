...
description: Aspose Excel. Convert IMAGE to MHT quickly and easily with Aspose.Cells. C++ IMAGE to MHT. C++ Save IMAGE to MHT. Save IMAGE as MHT using C++.
...
{{% cells-convert title="Sample Code to Convert IMAGE to MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="mht" IsLandingPage="true" language="cpp" %}}
