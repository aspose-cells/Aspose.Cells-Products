---
title: Mesclar SXC para WORD - Combine SXC para WORD em C#
url: /pt/net/merger/merge-sxc-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita SXC para salvar formato WORD. C# Combine SXC para o formato WORD. Mesclar SXC para WORD em C#. SXC Mesclar.
...
O exemplo a seguir demonstra como mesclar SXC com WORD em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar SXC para WORD. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo WORD. Se você desenvolver código em C#, isso será mais simples do que parece. Veja o exemplo C# que mescla SXC com WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar SXC para WORD em C#" InputFormat="sxc" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC para WORD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SXC para WORD programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
