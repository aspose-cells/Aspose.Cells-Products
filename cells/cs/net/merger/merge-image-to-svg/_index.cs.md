...
url: /cs/net/merger/merge-image-to-svg/ 
...
Následující příklad ukazuje, jak sloučit IMAGE s SVG v Aspose.Cells for .NET.
...
Potřebujete sloučit IMAGE s SVG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení IMAGE do SVG" %}}
