---
title: C# PNG až JPEG - PNG až JPEG Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu formátu PNG do formátu JPEG, což umožňuje bezproblémové ukládání dat PNG do formátu JPEG pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Uložte PNG na JPEG v C#" %}}

Následující příklad ukazuje, jak převést číslo PNG na JPEG v kódu C#.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na JPEG přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na JPEG programově? Vývojáři .NET mohou snadno načíst a převést PNG na JPEG v několika řádcích kódu.
...
1.  Převeďte číslo PNG na JPEG voláním metody Workbook.Save.
1.  Získejte výsledek převodu PNG na JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod PNG na JPEG" %}}
