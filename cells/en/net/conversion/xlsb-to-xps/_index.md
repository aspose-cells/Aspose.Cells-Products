...
description: Sample code for xlsb to xps C# conversion. Use API example code for batch xlsb files to xps conversion within VB.NET, Asp.NET or any .NET based application.
---
