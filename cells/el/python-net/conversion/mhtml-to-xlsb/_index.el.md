...
description: Aspose Excel. Αυτή η ολοκληρωμένη λύση παρέχει στους προγραμματιστές Python μια πλήρως ενσωματωμένη προσέγγιση για τη μετατροπή της μορφής MHTML σε XLSB, επιτρέποντας την απρόσκοπτη αποθήκευση δεδομένων MHTML σε μορφή XLSB χρησιμοποιώντας τη βιβλιοθήκη Aspose.Cells, μέσω αποτελεσματικού και προσαρμόσιμου κώδικα Python.
...
{{% blocks/products/pf/agp/content h2="Μετατροπή MHTML σε XLSB στο Python Excel Library" %}}
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση MHTML έως XLSB στο Python Excel Library" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το MHTML σε XLSB στη βιβλιοθήκη excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Βιβλιοθήκη Excel για μετατροπή MHTML σε XLSB" %}}
