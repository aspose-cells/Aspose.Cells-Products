---
title: Conversor PHP TSV para XLSM - TSV para XLSM
description: Aspose Excel. Converta TSV em XLSM de forma rápida e fácil com Aspose.Cells. PHP TSV em XLSM. PHP Salve TSV em XLSM. Salve TSV como XLSM usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter TSV em XLSM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em XLSM programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em XLSM em apenas algumas linhas de código.
...
1.  Converta TSV em XLSM chamando o método save da pasta de trabalho.
