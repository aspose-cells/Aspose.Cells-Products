---
title:  Слияние XML с PPTX через Python
url: /ru/python-net/merger/merge-xml-to-pptx/ 
description: Слияние XML с PPTX онлайн бесплатно. Бесплатный онлайн XML для слияния PPTX. Слияние XML с Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS и т. д.
---
...
В следующем примере показано, как объединить XML с PPTX в Python.
...
{{% cells-merger title="Бесплатное приложение для объединения XML в PPTX онлайн" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
