...
description: Aspose اكسل. C++ أنشئ ملف XLTX بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف XLTX باستخدام C++. أنشئ XLTX في C++. C++ XLTX Creator.
...
1.  احفظ المصنف كملف .xltx باستخدام أسلوب Save().
