---
title:  Sloučit XLSM na XPS přes Python
url: /cs/python-net/merger/merge-xlsm-to-xps/ 
description: Sloučit XLSM až XPS online zdarma. Online zdarma XLSM až XPS Fúze. Sloučit XLSM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSM až XPS v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až XPS online" InputFormat="xlsm" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
