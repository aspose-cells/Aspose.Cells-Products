...
description: Aspose เอ็กเซล. แปลง XLSB เป็น OTS อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Java XLSB เป็น OTS Java บันทึก XLSB ไปที่ โอทีเอส. บันทึก XLSB เป็น OTS โดยใช้ Java
...
{{% blocks/products/pf/agp/content h2="บันทึก XLSB ไปที่ OTS ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLSB เป็น OTS ใน Java
