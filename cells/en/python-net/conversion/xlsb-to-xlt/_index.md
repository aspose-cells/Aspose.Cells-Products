...
{{% blocks/products/pf/agp/content h2="Convert XLSB to XLT in Python Excel Library" %}}
...
{{% blocks/products/pf/agp/content h2="Save XLSB to XLT in Python Excel Library" %}}

The following example demonstrates how to convert XLSB to XLT in Python excel library.
...
{{% blocks/products/pf/agp/content h2="Python Excel Library to Convert XLSB to XLT" %}}
