---
title: Konvertera FODS till XPS via Java 
url: /sv/java/conversion/fods-to-xps/ 
description: Exempel Java-konverteringskod för FODS-format till XPS-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XPS inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera FODS till XPS via Java" h2="FODS till XPS Java-konvertering för att konvertera enstaka eller flera sidor till XPS med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du FODS till XPS med Java" %}}

 För att rendera FODS till XPS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera FODS till XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera FODS-fil till XPS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda FODS-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XPS-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XPS-filen
...
{{% blocks/products/pf/agp/code-block title="FODS till XPS Java konverteringskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS till XPS Conversion Live Demos" sectionDescription="[Konvertera FODS till XPS](https://products.aspose.app/cells/conversion/fods-to-xps) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din FODS-fil, den kommer omedelbart att konverteras till XPS." >}}
