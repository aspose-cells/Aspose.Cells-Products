---
title:  แทรกปุ่ม (ตัวควบคุมฟอร์ม) ลงใน Excel ผ่าน Python
weight: 200
description: ซอร์สโค้ด Python เพื่อแทรกปุ่ม (ตัวควบคุมฟอร์ม) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกปุ่ม (ตัวควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก Button (Form control) ลงในไฟล์ Excel ผ่าน Python" %}}
...
+ ใช้วิธีการเพิ่มของ shapecollection เพื่อแทรกปุ่ม (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ปุ่มแทรก(ตัวควบคุมแบบฟอร์ม) - Python" offSpacer="" %}}
