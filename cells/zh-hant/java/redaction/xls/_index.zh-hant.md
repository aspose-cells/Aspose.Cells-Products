---
title: 搜尋並取代 XLS 文件 via Java 中的文本
weight: 7900
description: Java 範例程式碼，用於編輯 JSP/JSF 應用程式和桌面應用程式的 Java 執行時間環境中的 XLS 檔案中的敏感資訊。
