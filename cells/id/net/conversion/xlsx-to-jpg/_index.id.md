...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi JPG di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi XLSX ke JPG. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, JPG, dan banyak format lainnya pada Platform .NET Framework, .NET Core, atau Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLSX ke JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert XLSX ke JPG lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke JPG secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX ke JPG hanya dalam beberapa baris kode.
...
1.  Konversikan XLSX ke JPG dengan memanggil metode Workbook.Save.
