---
title: C# EXCEL à BMP - Convertisseur EXCEL à BMP
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format BMP, permettant un enregistrement transparent des données EXCEL au format BMP à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL sous BMP dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en BMP en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en BMP par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en BMP en quelques lignes de code seulement.
...
1.  Convertissez le fichier EXCEL au format BMP en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion d’EXCEL en BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir EXCEL en BMP" %}}
