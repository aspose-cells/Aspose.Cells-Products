...
다음 예제는 XLSB을 Java의 HTM에 병합하는 방법을 보여줍니다.
...
{{% cells-merger title="XLSB을 온라인 HTM에 병합하는 무료 앱" InputFormat="xlsb" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
