---
title: JSON'u Java aracılığıyla XLTX'e dönüştürün 
weight: 1470

description: JSON biçimi için XLTX dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada XLTX'e aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JSON\'u Java aracılığıyla XLTX\'e dönüştürün" h2="Ek araçlar veya kitaplıklar gerektirmeden JSON\'u Java aracılığıyla XLTX formatına aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak JSON\'u XLTX\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/code-block title="JSON - XLTX Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
// elde edilen dosyayı JSON-TO-XLTX formatında kaydedin
