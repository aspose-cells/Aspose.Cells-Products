...
description: Aspose Excel. C++ Aspose.Cells. XLSX in das MHT-Speicherformat zusammenführen. C++ Kombinieren Sie XLSX zum MHT-Format. XLSX zu MHT in C++ zusammenführen. XLSX Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="XLSX mit MHT in C++ zusammenführen" %}}
...
{{% cells-merger title="Beispielcode zum Zusammenführen von XLSX mit MHT in C++" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
