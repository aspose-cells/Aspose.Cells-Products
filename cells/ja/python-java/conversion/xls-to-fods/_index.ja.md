---
title: Python XLS ～ FODS - XLS ～ FODS コンバータ
description: Aspose エクセル。 XLS を Aspose.Cells ですばやく簡単に FODS に変換します。 Python XLS から FODS に変換します。 Python XLS を FODS に保存します。 XLS を 07611134 として保存しますPythonを使用して81。
