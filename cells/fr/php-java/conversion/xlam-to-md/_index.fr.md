---
title: PHP XLAM en MD - Convertisseur XLAM en MD
description: Aspose Exceller. Convertissez XLAM en MD rapidement et facilement avec Aspose.Cells. PHP XLAM en MD. PHP Enregistrez XLAM dans MD. Enregistrez XLAM en tant que MD en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Convertir XLAM en MD en utilisant PHP" %}}

 Comment convertir XLAM en MD ? Avec la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir XLAM en MD par programme avec quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. PHP Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer XLAM dans MD en PHP" %}}
...
Besoin de convertir les fichiers XLAM en MD par programme ? Les développeurs PHP peuvent facilement charger et convertir XLAM en MD en quelques lignes de code seulement.
...
1.  Convertissez XLAM en MD en appelant la méthode de sauvegarde du classeur.
