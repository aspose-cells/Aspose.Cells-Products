---
title: PHP XLT ila DIF - XLT ila DIF Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde XLT'i DIF'e dönüştürün. PHP XLT'i DIF'e dönüştürün. PHP XLT'i DIF'e kaydedin. PHP kullanarak XLT'i DIF olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLT\'i DIF\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLT dosyalarını program aracılığıyla DIF'e dönüştürmeniz mi gerekiyor? PHP geliştiricileri sadece birkaç satır kodla XLT'i DIF'e kolayca yükleyebilir ve dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLT'i DIF'e dönüştürün.
1.  XLT'den DIF'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLT\'i DIF\'e dönüştürmek için PHP kütüphanesi" %}}
