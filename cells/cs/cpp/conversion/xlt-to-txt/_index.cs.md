---
title: Převeďte XLT na TXT pomocí aplikace C++ 
url: /cs/cpp/conversion/xlt-to-txt/ 
description: Ukázka převodního kódu C++ pro dokument XLT na formát TXT. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLT na TXT v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLT na TXT pomocí C++" %}}

 převodu XLT na TXT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu XLT na TXT prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLT na TXT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (TXT).1. Soubor TXT bude uložen do zadané cesty.1. Otevřete soubor TXT v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLT na TXT C++" offSpacer="" %}}
