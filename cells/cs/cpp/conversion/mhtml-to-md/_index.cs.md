---
title: C++ MHTML do MD - MHTML do MD převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu MHTML do formátu MD, což umožňuje bezproblémové ukládání dat MHTML do formátu MD pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na MD v C++" h2="Vysoce výkonná konverze MHTML na MD s využitím knihovny C++ bez nutnosti instalace Excelu Microsoft, OpenOffice nebo Adobe Acrobatu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete MHTML do MD v C++" %}}

Následující příklad ukazuje, jak převést číslo MHTML na MD v kódu C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na MD pomocí C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory MHTML do formátu MD? Vývojáři C++ mohou snadno převést soubory MHTML do formátu MD pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na MD voláním metody Save().
