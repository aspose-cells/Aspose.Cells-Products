...
description: Aspose Excel. A XLTX-es számot WORD-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# XLTX-WORD-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTX-WORD számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a XLTX-et WORD-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a XLTX WORD-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTX konvertálása WORD-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLTX fájlt programozottan WORD-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a XLTX-et WORD-re.
...
1.  Konvertálja a XLTX-et WORD-re a Workbook.Save metódus meghívásával.
1.  Szerezze meg a XLTX-es konverziós eredményt WORD-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX konvertálásához WORD-re" %}}
