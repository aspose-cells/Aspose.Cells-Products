---
title: C# XLS do XLT - XLS do XLT Konwerter
description: Aspose Excel. Konwertuj XLS na XLT szybko i łatwo za pomocą Aspose.Cells. C# XLS na XLT. C# Zapisz XLS na XLT. Zapisz XLS jako 0761113 481 pod numerem C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do XLT w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na XLT w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLS na XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na XLT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na XLT? Programiści .NET mogą łatwo załadować i przekonwertować XLS na XLT w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na XLT" %}}
