---
title:  Sisipkan objek OLE (Object Linking and Embedding) ke dalam Excel via .NET
weight: 170
description: Kode sumber C# untuk menyisipkan objek OLE(Object Linking and Embedding) ke dalam Excel pada Framework .NET, .NET Core, Mono atau Platform Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan objek OLE ke Excel via .NET" h2="Sisipkan objek menggunakan API sisi server tanpa perangkat lunak apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan objek OLE ke file Excel melalui C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Masukkan objek OLE - C#" offSpacer="" %}}
