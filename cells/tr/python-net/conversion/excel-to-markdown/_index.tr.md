...
{{% blocks/products/pf/agp/content h2="Python Excel Kütüphanesinde EXCEL\'i MARKDOWN\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i Python Excel Kütüphanesinde MARKDOWN\'e kaydedin" %}}

Aşağıdaki örnek, Python excel kitaplığında EXCEL'in MARKDOWN'e nasıl dönüştürüleceğini gösterir.
...
EXCEL dosyalarını programlı olarak MARKDOWN'e dönüştürmeniz mi gerekiyor? Python geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip MARKDOWN'e dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="Python EXCEL\'i MARKDOWN\'e Dönüştürmek için Excel Kitaplığı" %}}
