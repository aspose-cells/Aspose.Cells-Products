---
title:  Tìm kiếm và thay thế văn bản trong XLSM tài liệu via Java
weight: 1590
description: Mã mẫu Java để biên tập lại thông tin nhạy cảm trong tệp XLSM trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chỉnh sửa lại các định dạng XLSM trong Java" h2="Thông tin chỉnh sửa nhạy cảm gốc và hiệu suất cao XLSM sử dụng API Aspose.Cells for Java phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để biên tập lại các tệp XLSM trong Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Chỉnh sửa lại XLSM Tệp - Java" offSpacer="" %}}
