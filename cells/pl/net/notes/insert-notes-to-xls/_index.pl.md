...
description: Wstaw notatki do XLS, używając C#. Użyj przykładowego kodu API, aby wstawić notatki w aplikacji .NET.
---
...
{{% blocks/products/pf/agp/content h2="Wstaw notatki do XLS Plik używając .NET" %}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić notatki w pliku XLS za pośrednictwem C#" %}}
