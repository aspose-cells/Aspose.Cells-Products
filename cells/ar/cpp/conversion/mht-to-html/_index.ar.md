---
title: تحويل C++ MHT إلى HTML - تحويل MHT إلى HTML
description: Aspose اكسل. قم بتحويل MHT إلى HTML بسرعة وسهولة باستخدام Aspose.Cells. C++ MHT إلى HTML. C++ احفظ MHT إلى HTML. احفظ MHT كـ HTML باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على HTML في C++" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="html" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى HTML عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى HTML برمجياً؟ يمكن لمطوري C++ تحويل MHT بسهولة إلى HTML في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى HTML عن طريق استدعاء طريقة Save ().
