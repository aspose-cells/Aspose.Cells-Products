---
title: Převeďte TXT na XLSX pomocí aplikace C++ 
url: /cs/cpp/conversion/txt-to-xlsx/ 
description: Ukázkový konverzní kód C++ pro dokument TXT na formát XLSX. Programátoři mohou použít tento zdrojový kód pro dávkový převod TXT na XLSX v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést TXT na XLSX pomocí C++" %}}
 ...
 K převodu TXT na XLSX použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor TXT na XLSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLSX).1. Soubor XLSX bude uložen do zadané cesty.1. Otevřete soubor XLSX v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TXT na XLSX C++" offSpacer="" %}}
