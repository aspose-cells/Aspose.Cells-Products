---
title: Konwertuj TSV na JPEG za pomocą aplikacji C++ 
weight: 9870
url: /pl/cpp/conversion/tsv-to-jpeg/ 
description: Przykładowy kod konwersji C++ dla dokumentu TSV do formatu JPEG. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji plików TSV na JPEG w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TSV na JPEG przez C++" h2="Wydajna konwersja plików TSV do JPEG przy użyciu biblioteki C++ bez konieczności instalowania programu Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TSV na JPEG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (JPEG).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik JPEG w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TSV do JPEG C++ Kod źródłowy konwersji" offSpacer="" %}}
