---
title: Python OTS 轉 EXCEL - OTS 轉 EXCEL 轉換器
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 OTS 轉換為 EXCEL 格式，從而能夠使用 Aspose.Cells 庫將 OTS 資料無縫保存為 EXCEL 格式，所有這些都透過高效且可自訂的 Python 程式碼實現。
...
{{% blocks/products/pf/agp/content h2="將 Python Excel 庫中的 OTS 轉換為 EXCEL" %}}

如何將 OTS 轉換為 EXCEL？透過 Aspose.Cells for Python via NET 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 OTS 轉換為 EXCEL。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="將 OTS 儲存到 Python Excel 庫中的 EXCEL" %}}

以下範例示範如何將 Python excel 庫中的 OTS 轉換為 EXCEL。
...
1. 透過呼叫 Workbook.save 方法將 OTS 轉換為 EXCEL。
1. 取得OTS到EXCEL的轉換結果。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel 庫將 OTS 轉換為 EXCEL" %}}
