...
Bạn cần chuyển đổi các tệp HTML sang định dạng PRN bằng lập trình? Các nhà phát triển định dạng C++ có thể dễ dàng chuyển đổi HTML sang PRN chỉ với vài dòng mã.
...
1.  Chuyển đổi HTML thành PRN bằng cách gọi phương thức Save().
