...
description: Aspose Exceller. C++ Aspose.Cells. Fusionner HTM avec le format de sauvegarde MARKDOWN. C++ Combinez HTM au format MARKDOWN. Fusionner HTM avec MARKDOWN dans C++. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec MARKDOWN dans C++" %}}
...
{{% cells-merger title="Exemple de code pour fusionner HTM avec MARKDOWN dans C++" InputFormat="htm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec MARKDOWN via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner HTM avec MARKDOWN par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
