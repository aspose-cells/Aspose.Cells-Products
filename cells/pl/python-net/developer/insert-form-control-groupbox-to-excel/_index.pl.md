...
{{% blocks/products/pf/agp/content h2="Jak wstawić GroupBox (kontrolkę formularza) do pliku programu Excel za pomocą Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić GroupBox (kontrola formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj dodatku shapecollection[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_group_box/#int-int-int-int-int-int) aby wstawić GroupBox (formant kontrolny) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw GroupBox (kontrola formularza) - Python via .Net" offSpacer="" %}}
