...
{{% blocks/products/pf/agp/content h2="Sla XLSM op in XLAM in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSM omzet naar XLAM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar XLAM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSM programmatisch converteren naar XLAM? Ontwikkelaars van Java kunnen bestanden met de extensie XLSM eenvoudig converteren naar XLAM met slechts een paar regels code.
