---
title: Konversikan FODS ke XLSX melalui Java 
url: /id/java/conversion/fods-to-xlsx/ 
description: Contoh Java kode konversi untuk format FODS ke file XLSX. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke XLSX dalam Aplikasi berbasis Web atau Desktop Java apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan FODS ke XLSX melalui Java" h2="Konversi FODS ke XLSX Java untuk mengonversi satu atau beberapa halaman ke XLSX menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi FODS ke XLSX Menggunakan Java" %}}

 Untuk merender FODS ke XLSX, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi FODS ke XLSX melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file FODS ke XLSX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file FODS dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi XLSX & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file XLSX yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="FODS ke XLSX Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file FODS dalam contoh Workbook
Workbook book = new Workbook("template.fods");
// simpan FODS sebagai XLSX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi FODS ke XLSX" sectionDescription="[Mengonversi FODS ke XLSX](https://products.aspose.app/cells/conversion/fods-to-xlsx) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file FODS Anda, itu akan langsung dikonversi ke XLSX." >}}
