...
description: Aspose เอ็กเซล. แปลง IMAGE เป็น SXC อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ IMAGE เป็น SXC C++ บันทึก IMAGE เป็น SXC บันทึก IMAGE เป็น SXC โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึกภาพไปที่ SXC ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง IMAGE เป็น SXC ใน C++
...
1.  แปลง IMAGE เป็น SXC โดยการเรียกเมธอด Save()
