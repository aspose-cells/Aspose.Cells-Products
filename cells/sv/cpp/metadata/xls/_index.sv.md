...
weight: 2150
description: C++ exempelkod för att redigera eller visa XLS filmetadata på C++ Runtime Environment för Windows 32 bitar, Windows 64 bitar och Linux 64 bitar.
---
...
{{% blocks/products/pf/agp/content h2="Hur man får XLS metadata med C++" %}}
...
+ Ladda XLS-filen med CreateIWorkbookMetadata
