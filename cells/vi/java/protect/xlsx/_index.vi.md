...
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa tệp XLSX qua Java" h2="Bảo vệ bảng tính Excel bằng mật khẩu bao gồm định dạng XLSX bằng cách sử dụng .NET Thư viện." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước bảo vệ tệp XLSX qua Java" %}}
...
1. Tải tệp XLSX bằng cách khởi tạo lớp Workbook1. Sử dụng phương thức bảo vệ (..) với Loại bảo vệ và Mật khẩu1. Lưu tệp XLSX được bảo vệ bằng phương thức save ()
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Ứng dụng miễn phí để bảo vệ XLSX" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi để [mã hóa các tệp XLSX](https://products.aspose.app/cells/protect/xlsx) với những lợi ích sau đây." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/protect/xlsm/" name="XLSM" description="Tệp Spreasheet" >}}
