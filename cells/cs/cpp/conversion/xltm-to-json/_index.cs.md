---
title: Převeďte XLTM na JSON pomocí aplikace C++ 
url: /cs/cpp/conversion/xltm-to-json/ 
description: Ukázkový konverzní kód C++ pro dokument XLTM do formátu JSON. Programátoři mohou použít tento zdrojový kód pro dávkový převod XLTM na JSON v jakékoli aplikaci C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést XLTM na JSON přes C++" h2="Vysoce výkonný převod XLTM na JSON pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLTM na JSON pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLTM pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou souboru (JSON).1. Soubor JSON bude uložen do zadané cesty.1. Otevřete soubor JSON v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu XLTM na JSON C++" offSpacer="" %}}
