...
url: /cs/net/merger/merge-xltm-to-dif/ 
...
Následující příklad ukazuje, jak sloučit XLTM až DIF v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit XLTM až DIF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení XLTM až DIF" %}}
