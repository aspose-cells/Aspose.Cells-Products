...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in EMF in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar EMF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar EMF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar EMF? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar EMF met slechts een paar regels code.
