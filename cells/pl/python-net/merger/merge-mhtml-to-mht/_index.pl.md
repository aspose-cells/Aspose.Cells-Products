...
Poniższy przykład pokazuje, jak scalić MHTML z MHT w Aspose.Cells for Python via .NET.
...
Chcesz programowo połączyć numer MHTML z MHT? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
