---
title: MHTML mit PPTX zusammenführen - MHTML mit PPTX in C# kombinieren
url: /de/net/merger/merge-mhtml-to-pptx/ 
description: Aspose Excel. C# Aspose.Cells. MHTML mit PPTX Saveformat zusammenführen. C# Kombinieren Sie das Format MHTML mit dem Format PPTX. MHTML zu PPTX in C# zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="MHTML mit PPTX in C# zusammenführen" %}}

Das folgende Beispiel zeigt, wie MHTML mit PPTX in Aspose.Cells for .NET zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von MHTML mit PPTX in C#" InputFormat="mhtml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie MHTML über C# mit PPTX zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie MHTML programmgesteuert mit PPTX zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
