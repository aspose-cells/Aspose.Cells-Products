...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde XLSX'i XLS'e dönüştürün. Java XLSX'i XLS'e dönüştürün. Java XLSX'i XLS'e kaydedin. XLSX'i 07611134 olarak kaydedin 81, Java'i kullanarak.
...
{{% blocks/products/pf/agp/content h2="Java\'i kullanarak XLSX\'i XLS\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="XLSX\'i Java\'e XLS\'e kaydedin" %}}

Aşağıdaki örnek, XLSX'in Java'de XLS'e nasıl dönüştürüleceğini gösterir.
...
XLSX dosyalarını program aracılığıyla XLS'e dönüştürmeniz mi gerekiyor? Java geliştiricileri, yalnızca birkaç satır kodla XLSX'i XLS'e kolayca dönüştürebilir.
