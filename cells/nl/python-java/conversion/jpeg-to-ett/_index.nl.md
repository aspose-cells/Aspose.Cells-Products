...
description: Aspose Excel. Converteer JPEG snel en eenvoudig naar ETT met Aspose.Cells. Python JPEG naar ETT. Python Bewaar JPEG in ETT. Sla JPEG op als ETT met Python.
...
{{% blocks/products/pf/agp/content h2="Sla JPEG op in ETT in Python" %}}

Het volgende voorbeeld laat zien hoe u JPEG naar ETT converteert in Python.
