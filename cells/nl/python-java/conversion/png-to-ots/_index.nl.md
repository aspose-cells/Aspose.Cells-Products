...
description: Aspose Excel. Converteer PNG snel en eenvoudig naar OTS met Aspose.Cells. Python PNG naar OTS. Python Bewaar PNG in OTS. Sla PNG op als OTS met behulp van Python.
...
{{% blocks/products/pf/agp/content h2="Converteer PNG naar OTS met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sla PNG op in OTS in Python" %}}

Het volgende voorbeeld laat zien hoe u PNG naar OTS converteert in Python.
