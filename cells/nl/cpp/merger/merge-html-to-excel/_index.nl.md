---
title: Voeg HTML samen met EXCEL - Combineer HTML met EXCEL in C++
url: /nl/cpp/merger/merge-html-to-excel/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen HTML naar EXCEL-opslagformaat. C++ Combineer HTML naar EXCEL-formaat. Samenvoegen HTML naar EXCEL in C++. HTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Samenvoegen HTML naar EXCEL in C++ Online gratis" %}}

Het volgende voorbeeld laat zien hoe u HTML kunt samenvoegen met EXCEL in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTML samen te voegen met EXCEL. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een EXCEL-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat HTML samenvoegt met EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om HTML samen te voegen tot EXCEL in C++" InputFormat="html" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe HTML samen te voegen naar EXCEL via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u HTML programmatisch samenvoegen met EXCEL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om HTML samen te voegen tot EXCEL" %}}
