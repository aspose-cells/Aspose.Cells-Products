---
title:  Защитите и заблокируйте документ XLS через номер C++.
weight: 8760
description: C++ пример кода для блокировки файла XLS с использованием пароля в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Зашифровать файлы XLS через C++" h2="Защитите паролем электронные таблицы Excel, включая формат XLS, с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по защите файлов XLS с помощью C++" %}}
...
1.  Используйте метод Protect(..) с ProtectionType и паролем.
