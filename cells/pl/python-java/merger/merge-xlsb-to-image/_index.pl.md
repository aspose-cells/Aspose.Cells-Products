...
url: /pl/python-java/merger/merge-xlsb-to-image/ 
...
Poniższy przykład pokazuje, jak połączyć XLSB z IMAGE w Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić XLSB z IMAGE? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
