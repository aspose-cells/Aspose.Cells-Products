---
title: Sloučit XLTX až XLTX - Sloučit XLTX až XLTX v C++
url: /cs/cpp/merger/merge-xltx-to-xltx/ 
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma XLTX do formátu uložení XLTX. C++ Kombinujte formát XLTX až XLTX. Sloučit XLTX až XLTX v C++. XLTX Sloučit.
...
Následující příklad ukazuje, jak sloučit XLTX až XLTX v Aspose.Cells for C++.
...
{{% cells-merger title="Online zdarma ke sloučení XLTX až XLTX v C++" InputFormat="xltx" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLTX na XLTX přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLTX až XLTX? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
