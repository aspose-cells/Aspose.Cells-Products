...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan format penyimpanan HTM ke MD. Java Gabungkan format HTM ke MD. Gabungkan HTM ke MD di Java. Gabungkan HTM.
...
{{% blocks/products/pf/agp/content h2="Gabungkan HTM ke MD di Java" %}}

Contoh berikut menunjukkan cara menggabungkan HTM ke MD di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan HTM ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan HTM ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan HTM ke MD secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
