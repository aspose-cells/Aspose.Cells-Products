---
title: Převést ODS na XLT přes Java 
weight: 8910
url: /cs/java/conversion/ods-to-xlt/ 
description: Ukázkový konverzní kód Java pro formát ODS na soubor XLT. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLT v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODS na XLT přes Java" h2="Převod ODS na XLT Java pro převod jedné nebo více stránek na XLT pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na XLT pomocí Java" %}}

 K vykreslení ODS do XLT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na XLT prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na XLT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLT a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLT
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODS na XLT Java" offSpacer="" %}}
