...
{{% blocks/products/pf/agp/content h2="Zapisz plik EXCEL do ETT w numerze Java" %}}

Poniższy przykład pokazuje, jak przekonwertować format EXCEL na ETT w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu ETT? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu ETT za pomocą zaledwie kilku linijek kodu.
