---
title: C++ XLS a ODS - XLS a ODS Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato ODS, permitindo o salvamento perfeito de dados XLS no formato ODS usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLS a ODS em C++" %}}

exemplo a seguir demonstra como converter XLS em ODS em C++.
...
{{% blocks/products/pf/agp/content h2="Como converter XLS em ODS por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para ODS programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para ODS com apenas algumas linhas de código.
...
1.  Converta XLS para ODS chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em ODS" %}}
