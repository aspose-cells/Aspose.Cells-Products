---
title:  Konvertera XLT till JSON Java
description: Konvertera XLT till JSON online gratis. Gratis onlinekonverterare XLT till JSON. Java XLT till JSON. XLT till JSON via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera XLT till JSON på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1.  Ladda XLT-filen med en instans av Workbook-klassen
1.  Konvertera XLT till JSON genom att anropa metoden Workbook.save
