---
title: C# OTS till TXT - OTS till TXT Converter
description: Aspose Excel. Konvertera OTS till TXT snabbt och enkelt med Aspose.Cells. C# OTS till TXT. C# Spara OTS till TXT. Spara OTS som TXT med 304818.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till TXT på C#" %}}

Följande exempel visar hur man konverterar OTS till TXT i C#.
...
{{% cells-convert title="Exempelkod för att konvertera OTS till TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till TXT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till TXT programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till TXT på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera OTS till TXT" %}}
