---
title: C# IMAGE to FODS - IMAGE to FODS Converter
description: Aspose Excel. Convert IMAGE to FODS quickly and easily with Aspose.Cells. C# IMAGE to FODS. C# Save IMAGE to FODS. Save IMAGE as FODS using C#.
...
{{% blocks/products/pf/agp/content h2="Save IMAGE to FODS in C#" %}}
...
{{% cells-convert title="Sample Code to Convert IMAGE to FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert IMAGE to FODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert IMAGE files to FODS programmatically? .NET developers can easily load & convert IMAGE to FODS in just a few lines of code.
...
1.  Convert IMAGE to FODS by calling Workbook.Save method.
