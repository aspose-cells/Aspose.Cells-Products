...
description: Aspose Excel. C# Aspose.Cells. PNG a XML en C#. C# Convierta PNG a formato de guardado XML. C# PNG al formato XML. Guarde PNG en XML C#.
keywords: [Aspose Excel., C# Aspose.Cells., PNG to XML in C#., C# PNG to XML saveformat., PNG to XML C#., C# Convert PNG to XML]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PNG a XML en C#" h2="Biblioteca C# de alta velocidad para convertir PNG a XML. Esta es una solución de software profesional para importar y exportar PNG, XML y muchos otros formatos en las plataformas .NET Framework, .NET Core o Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% cells-convert title="Código de muestra para convertir PNG a XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a XML a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PNG a XML mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente PNG a XML en tan solo unas pocas líneas de código.
