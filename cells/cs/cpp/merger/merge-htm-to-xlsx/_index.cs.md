---
title:  Sloučit HTM na XLSX přes C++
url: /cs/cpp/merger/merge-htm-to-xlsx/ 
description: Sloučit HTM na XLSX Online zdarma. Bezplatné online spojení HTM na XLSX. Sloučit HTM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit HTM s XLSX v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení HTM na XLSX online" InputFormat="htm" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
