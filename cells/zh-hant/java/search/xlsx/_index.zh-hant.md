---
title: 搜索XLSX文檔，無需打開via Java
weight: 6780
description: Java 示例代碼，用於在 JSP/JSF 應用程序和桌面應用程序的 Java 運行時環境中搜索 XLSX 文件中具有模式的單詞。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="搜索 XLSX Java 中的格式" h2="使用服務器端 Aspose.Cells for Java API 進行本機高性能 XLSX 文檔搜索，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 搜索 XLSX 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="搜索 Java 中的 XLSX 文件的步驟" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="在線 XLSX 搜索現場演示" sectionDescription="立即訪問我們的 XLSX 文檔中搜索文本、單詞、短語[現場演示網站](https://products.aspose.app/cells/search)。現場演示有以下好處" >}}
