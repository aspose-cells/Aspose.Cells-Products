...
{{% blocks/products/pf/agp/content h2="Преобразуйте FODS в ODS, используя Python." %}}
...
В следующем примере показано, как преобразовать FODS в ODS в Python.
