---
title: Gộp MHT sang XML - Gộp MHT sang XML trong C#
url: /vi/net/merger/merge-mht-to-xml/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí MHT sang định dạng lưu XML. C# Gộp định dạng MHT sang XML. Hợp nhất MHT sang XML trong C#. Hợp nhất MHT.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHT sang XML trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất MHT sang XML trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất MHT sang XML. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp XML. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất MHT với XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất MHT sang XML trong C#" InputFormat="mht" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách Hợp nhất MHT sang XML qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất MHT sang XML theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất MHT sang XML" %}}
