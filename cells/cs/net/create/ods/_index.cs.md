...
description: ODS tvůrce. Vytvořte soubory ODS v kódu C#. Generujte soubory ODS (Openoffice / Lbreoffice) pomocí VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
Pro vývojáře je snadné vytvářet, načítat, upravovat a převádět tabulkový procesor ODS (Openoffice / Lbreoffice) v rámci běhu různých reportovacích aplikací pro zpracování dat v několika řádcích kódu.
...
{{% blocks/products/pf/agp/code-block title="Ukázkový kód pro vytvoření souboru ODS (Openoffice / Lbreoffice) pomocí C#." offSpacer="" %}}
