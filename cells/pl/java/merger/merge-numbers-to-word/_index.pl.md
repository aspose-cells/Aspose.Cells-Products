---
title: Połącz LICZBY w SŁOWO - Połącz LICZBY w SŁOWO w Java
url: /pl/java/merger/merge-numbers-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne połączenie online NUMERÓW z formatem zapisu WORD. Java Połącz NUMERY z formatem WORD. Scal NUMBERS do WORD w Java. NUMBERS Scal.
...
Poniższy przykład pokazuje, jak scalić NUMBERS do WORD w Aspose.Cells for Java.
...
{{% cells-merger title="Bezpłatne połączenie online NUMBERS z WORD w Java" InputFormat="numbers" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić NUMERY w WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić NUMBERS z WORD? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
