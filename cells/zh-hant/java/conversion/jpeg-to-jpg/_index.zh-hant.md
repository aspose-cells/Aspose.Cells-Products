...
description: Aspose Excel。此綜合解決方案為 Java 開發人員提供了一種完全整合的方法，可將 JPEG 轉換為 JPG 格式，從而能夠使用 Aspose.Cells 庫將 JPEG 資料無縫保存為 JPG 格式，所有這些都透過高效能客製化的 07153481 程式碼。
...
{{% blocks/products/pf/agp/content h2="將 JPEG 儲存為 JPG 文件，文件名稱為 Java" %}}

以下範例示範如何將 JPEG 轉換為 Java 中的 JPG。
...
{{% blocks/products/pf/agp/content h2="如何將 JPEG 轉換為 JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要透過程式將 JPEG 檔案轉換為 JPG 格式嗎？ Java 開發人員只需幾行程式碼即可輕鬆將 JPEG 檔案轉換為 JPG 格式。
...
{{% blocks/products/pf/agp/content h2="使用 Java 庫將 JPEG 轉換為 JPG" %}}
{{% blocks/products/pf/agp/text %}}
