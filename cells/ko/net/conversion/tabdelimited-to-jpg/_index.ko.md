...
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 탭으로 구분된 파일을 JPG로 변환합니다." h2="탭으로 구분된 파일을 JPG로 고속 변환하는 C# 라이브러리입니다. 이 전문 소프트웨어 솔루션은 .NET 프레임워크, .NET 코어 또는 Mono 플랫폼에서 탭으로 구분된 파일, JPG 및 기타 여러 형식을 가져오고 내보낼 수 있도록 지원합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
1.  워크북의 저장 메서드를 호출하여 탭으로 구분된 파일을 JPG 형식으로 변환합니다.
