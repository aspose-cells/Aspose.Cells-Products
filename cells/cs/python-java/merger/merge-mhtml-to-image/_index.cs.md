...
url: /cs/python-java/merger/merge-mhtml-to-image/ 
...
Následující příklad ukazuje, jak sloučit MHTML do IMAGE v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit MHTML s IMAGE programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
