---
title: C# PRN'den JSON'e - PRN'den JSON'e dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde PRN'yi JSON'e dönüştürün. C# PRN'yi JSON'e dönüştürün. C# PRN'yi JSON'e kaydedin. C#'i kullanarak PRN'yi JSON olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi C#\'de JSON\'e kaydedin" %}}

Aşağıdaki örnek, PRN'nin C#'de JSON'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="PRN\'yi JSON\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla JSON\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PRN dosyalarını programlı olarak JSON'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PRN'yi kolayca yükleyebilir ve JSON'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak PRN'yi JSON'e dönüştürün.
1.  PRN'nin dönüşüm sonucunu JSON'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi JSON\'e dönüştürmek için C# kitaplığı" %}}
