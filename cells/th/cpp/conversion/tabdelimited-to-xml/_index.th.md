...
ต้องการแปลงไฟล์ TABDELIMITED เป็น XML ด้วยโปรแกรมใช่ไหม? นักพัฒนาสามารถแปลงไฟล์ TABDELIMITED เป็น XML ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด (รหัส C++)
...
1.  แปลงข้อมูลแบบ TABDELIMITED เป็น XML โดยเรียกใช้เมธอด Save()
