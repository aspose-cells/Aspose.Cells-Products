...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen TXT-bestanden gemakkelijk in slechts een paar regels code naar ODS converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad TXT-bestand met behulp van Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (ODS) bestandsextensie.1. ODS-bestand wordt opgeslagen op het opgegeven pad.1. Open het ODS-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="TXT naar ODS C++ Conversiebroncode" offSpacer="" %}}
