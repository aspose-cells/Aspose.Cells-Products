---
title: Python를 통해 HTML을 XLSB로 변환
url: /ko/python-java/conversion/html-to-xlsb/
description: html에서 xlsb로의 Python 변환을 위한 샘플 코드입니다. Python 애플리케이션 내에서 배치 html 파일을 xlsb로 변환하는 API 예제 코드를 사용합니다.
---
...
{{% blocks/products/pf/agp/content h2="Python을 사용하여 HTML을 XLSB로 변환하는 방법" %}}

 HTML을 XLSB로 변환하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Python를 통해 HTML을 XLSB로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Python 개발자는 몇 줄의 코드로 HTML 파일을 쉽게 로드하고 XLSB로 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. 통합 문서의 인스턴스로 HTML 파일 로드1. Workbook.Save 메서드 호출1. XLSB 확장자를 매개변수로 사용하여 출력 경로 전달1. 결과 XLSB 파일에 대해 지정된 경로 확인
...
{{% cells-convert title="HTML을 XLSB로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlsb" IsLandingPage="true" language="python" %}}
