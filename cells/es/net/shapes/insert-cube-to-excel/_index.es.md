...
weight: 325
description: C# código fuente para insertar Cube en Excel en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar Cube en un archivo de Excel a través de C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addautoshape) para insertar un Cubo en la hoja de cálculo seleccionada
...
{{% blocks/products/pf/agp/code-block title="Cubo de inserción - C#" offSpacer="" %}}
