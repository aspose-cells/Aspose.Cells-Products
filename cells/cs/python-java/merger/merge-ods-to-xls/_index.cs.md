---
title:  Sloučit ODS na XLS přes Python
...
Následující příklad ukazuje, jak sloučit ODS až XLS v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení ODS až XLS online" InputFormat="ods" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
