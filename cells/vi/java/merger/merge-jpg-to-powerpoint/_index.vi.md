---
title: Gộp JPG vào POWERPOINT - Gộp JPG vào POWERPOINT trong Java
url: /vi/java/merger/merge-jpg-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất JPG thành định dạng lưu POWERPOINT. Java Kết hợp định dạng JPG sang POWERPOINT. Hợp nhất JPG thành POWERPOINT trong Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Gộp JPG vào POWERPOINT theo số Java" %}}

Ví dụ sau minh họa cách hợp nhất JPG thành POWERPOINT trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất JPG vào POWERPOINT. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp POWERPOINT. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất JPG với POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Code mẫu gộp JPG vào POWERPOINT trong Java" InputFormat="jpg" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép JPG vào POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất JPG vào POWERPOINT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java ghép JPG vào POWERPOINT" %}}
