---
title:  แทรก ActiveX Control ลงใน Excel ผ่าน Python
weight: 10
description: ซอร์สโค้ด Python เพื่อแทรก ActiveX Control ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกตัวควบคุม ActiveX ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก ActiveX Control ลงในไฟล์ Excel ผ่าน Python" %}}
...
+ ใช้วิธีการเพิ่มของ shapecollection เพื่อแทรกตัวควบคุม ActiveX ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกตัวควบคุม ActiveX - Python" offSpacer="" %}}
