---
title:  Débloquer le document ODS via le C++
weight: 1190
description: Exemple de code C++ pour déverrouiller le fichier ODS protégé par mot de passe sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
