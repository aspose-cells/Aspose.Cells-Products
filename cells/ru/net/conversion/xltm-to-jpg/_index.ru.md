---
title: C# XLTM в JPG - XLTM в JPG конвертер
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в формате JPG в C#" %}}

Следующий пример демонстрирует, как преобразовать XLTM в JPG в файле C#.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XLTM в JPG с помощью C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно конвертировать файлы XLTM в JPG? Разработчики .NET могут легко загрузить и преобразовать XLTM в JPG всего за несколько строк кода.
...
1.  Преобразуйте файл XLTM в формат JPG, вызвав метод Workbook.Save.
1.  Получите результат конвертации XLTM в JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XLTM в JPG." %}}
