---
title:  Chèn WordArt vào Excel bằng Python via Java
weight: 200
description: Python via Java mã nguồn chèn WordArt vào Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn WordArt vào Excel bằng Python via Java" h2="Chèn WordArts bằng Aspose.Cells\' API mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn WordArt vào File Excel Bằng Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn file WordArt vào Excel bằng Python via Java" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addWordArt(int,%20java.lang.String,%20int,%20int,%20int,%20int,%20int,%20int)) để chèn WordArt vào trang tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn WordArt - Python via Java" offSpacer="" %}}
