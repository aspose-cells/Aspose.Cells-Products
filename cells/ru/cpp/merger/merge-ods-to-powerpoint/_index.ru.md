---
title:  Объединить ODS с POWERPOINT через C++
...
В следующем примере показано, как объединить ODS с POWERPOINT в C++.
...
{{% cells-merger title="Бесплатное приложение для объединения ODS с POWERPOINT онлайн" InputFormat="ods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
