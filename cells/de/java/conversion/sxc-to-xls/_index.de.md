---
title: Konvertieren Sie SXC in XLS über Java 

description: Beispiel-Umwandlungscode Java für das SXC-Format in eine XLS-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in XLS innerhalb jeder Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie SXC in XLS über Java" h2="SXC-zu-XLS-Java-Konvertierung zum Konvertieren einzelner oder mehrerer Seiten in XLS mithilfe der lokalen Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SXC in XLS mit Java" %}}

 Um SXC in XLS zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von SXC in XLS über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können SXC-Dateien in nur wenigen Codezeilen problemlos in XLS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die SXC-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit XLS-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende XLS-Datei
...
{{% blocks/products/pf/agp/code-block title="SXC-zu-XLS-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die SXC-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.sxc");
// Speichern Sie SXC als XLS
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC-zu-XLS-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie SXC in XLS](https://products.aspose.app/cells/conversion/sxc-to-xls) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre SXC-Datei hoch, sie wird sofort in XLS konvertiert." >}}
