 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Java APIを介したPHPのAspose.Cellsは、ExcelファイルをXPS、XPS、およびHTML形式に変換できるだけでなく、最高の視覚的忠実度を維持することができます。変換プロセスは信頼性が高く、開発者はわずか数行で必要な形式を取得できます。
    </p>
...
{{< blocks/products/pf/slr-element name="API参照" href="https://reference.aspose.com/php/cells" >}}
