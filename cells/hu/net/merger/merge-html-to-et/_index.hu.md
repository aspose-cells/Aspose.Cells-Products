...
url: /hu/net/merger/merge-html-to-et/ 
...
következő példa bemutatja, hogyan lehet egyesíteni a HTML-et a Aspose.Cells-es for .NET-es ET-vel.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a HTML-et az ET-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML ET-vel való egyesítéséhez" %}}
