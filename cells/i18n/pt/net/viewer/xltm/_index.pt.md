---
title: Visualize Formatos de Arquivo XLTM via .NET 
weight: 430
url: /pt/net/viewer/xltm/ 
description: C# código-fonte para carregar, renderizar e exibir documentos XLTM nas plataformas .NET Framework, .NET Core, Mono ou Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Visualizador de arquivos XLTM for .NET" h2="Visualize planilhas do Excel e do OpenOffice, como XLTM, sem precisar do Microsoft Excel ou do Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Como visualizar o arquivo XLTM usando C#" %}}

 Para visualizar o arquivo XLTM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para visualizar XLTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells facilita para os desenvolvedores a visualização do arquivo XLTM com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo XLTM em uma instância da pasta de trabalho1. Crie uma instância de HtmlSaveOptions e defina a propriedade ExportHeadings como true1. Salve o arquivo XLTM no formato HTML usando o método Workbook.Save1. Carregar HTML resultante no navegador padrão com Process.Start
...
{{% blocks/products/pf/agp/code-block title="C# código de exemplo para visualizar o arquivo XLTM" offSpacer="" %}}
...
// salve o arquivo XLTM no formato HTML
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos do Microsoft Excel para diferentes formatos. Além disso, ele pode ser usado para gráficos abrangentes, relatórios escaláveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API autônomo e não requer nenhum software como Microsoft ou OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para visualizar XLTM" sectionDescription="Confira nossas demonstrações ao vivo para [Ver XLTM](https://products.aspose.app/cells/viewer/xltm) com os seguintes benefícios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar ou configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever ou compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do arquivo XLTM e clicar no botão \"Visualizar\"" >}}
