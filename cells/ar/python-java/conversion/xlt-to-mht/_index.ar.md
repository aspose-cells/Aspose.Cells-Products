---
title: Python XLT إلى MHT - محول XLT إلى MHT
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين Python نهجًا متكاملًا تمامًا لتحويل XLT إلى تنسيق MHT، مما يتيح حفظ البيانات بسلاسة بتنسيق MHT باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود Python فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="تحويل XLT إلى MHT باستخدام مكتبة Excel Python" %}}

 كيف يمكنني تحويل XLT إلى MHT؟ باستخدام مكتبة Aspose.Cells for Python، يمكنك بسهولة تحويل XLT إلى MHT برمجيًا ببضعة أسطر من التعليمات البرمجية.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)قادر على إنشاء تطبيقات مشتركة بين الأنظمة الأساسية مع القدرة على إنشاء جميع ملفات Excel وتعديلها وتحويلها وعرضها وطباعتها. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات، بل يمكنه أيضًا عرض ملفات Excel كصور، وPDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT والمزيد، مما يجعله خيارًا مثاليًا لتبادل المستندات بتنسيقات متوافقة مع معايير الصناعة.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="احفظ XLT في MHT في مكتبة Excel Python" %}}

يوضح المثال التالي كيفية تحويل XLT إلى MHT في مكتبة Excel Python.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات البسيطة لتحويل الملف XLT إلى MHT. حمّل ملفك XLT، ثم احفظه كملف MHT. يمكنك استخدام أسماء ملفات كاملة لكل من قراءة الملف XLT وكتابة ملف MHT. سيكون محتوى ملف MHT الناتج وتنسيقه مطابقين تمامًا للملف الأصلي XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="نموذج كود لتحويل XLT إلى MHT باستخدام مكتبة Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlt" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل الرقم XLT إلى MHT عبر الرقم Python" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLT إلى صيغة MHT برمجيًا؟ يمكن لمطوري Python تحميل وتحويل ملفات XLT إلى صيغة MHT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  احصل على نتيجة تحويل XLT إلى MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة Excel لتحويل XLT إلى MHT (Python)." %}}
