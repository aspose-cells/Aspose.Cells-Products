...
url: /hu/python-java/merger/merge-xltx-to-ots/ 
...
A következő példa bemutatja, hogyan lehet a Aspose.Cells for Python via Java számon a XLTX OTS-hez egyesíteni.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLTX-et az OTS-hez? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
