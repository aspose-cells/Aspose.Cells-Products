---
title: C# XLTM tot ODS - XLTM tot ODS Converter
description: Aspose Excel. Deze uitgebreide oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van gegevens van het formaat XLTM naar ODS, waardoor naadloos opslaan van gegevens in het formaat XLTM mogelijk is met behulp van de bibliotheek Aspose.Cells, allemaal via efficiënte en aanpasbare code C#.
...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in ODS in C#" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar ODS in C#.
...
{{% cells-convert title="Voorbeeldcode om XLTM naar ODS te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltm" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLTM naar ODS kunt converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLTM-bestanden programmatisch naar ODS converteren? .NET-ontwikkelaars kunnen XLTM eenvoudig in slechts een paar regels code laden en converteren naar ODS.
...
1.  Converteer XLTM naar ODS door de Workbook.Save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van XLTM naar ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliotheek om XLTM naar ODS te converteren" %}}
