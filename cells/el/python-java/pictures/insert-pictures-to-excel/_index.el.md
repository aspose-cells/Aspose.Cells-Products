...
+ Επιλέξτε Φύλλο εργασίας μέσω του ευρετηρίου του.
 + Χρησιμοποιήστε τη συλλογή εικόνων[μέθοδος προσθήκης](https://reference.aspose.com/cells/java/com.aspose.cells/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) για να εισαγάγετε μια εικόνα στο επιλεγμένο φύλλο εργασίας.
