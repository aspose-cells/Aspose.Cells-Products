...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke XLS menggunakan C++" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke XLS di C++" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX menjadi XLS di C++.
...
Perlu mengkonversi file XLTX ke XLS secara terprogram? Pengembang C++ dapat dengan mudah mengkonversi XLTX ke XLS hanya dengan beberapa baris kode.
...
1.  Konversikan XLTX menjadi XLS dengan memanggil metode Save().
1.  Dapatkan hasil konversi dari XLTX menjadi XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ perpustakaan untuk mengkonversi XLTX menjadi XLS" %}}
