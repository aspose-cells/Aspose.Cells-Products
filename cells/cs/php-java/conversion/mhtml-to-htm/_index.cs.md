---
title: Převodník PHP MHTML na HTM – MHTML na HTM
description: Aspose Excel. Převeďte MHTML na HTM rychle a snadno pomocí Aspose.Cells. PHP MHTML na HTM. PHP Uložit MHTML do HTM. Uložte MHTML jako HTM pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na HTM přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory na HTM programově? Vývojáři PHP mohou snadno načíst a převést MHTML na HTM v několika řádcích kódu.
...
1.  Převeďte MHTML na HTM voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na HTM" %}}
