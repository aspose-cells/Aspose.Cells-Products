...
description: Aspose Excel. Converteer XLSB snel en eenvoudig naar XLSB met Aspose.Cells. Python XLSB naar XLSB. Python Bewaar XLSB in XLSB. Bewaar XLSB als 07611134 81 via Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLSB naar XLSB in Python" h2="Snelle Python-bibliotheek voor het converteren van XLSB naar XLSB. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSB, XLSB en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer XLSB naar XLSB met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLSB t/m XLSB in Python" %}}

Het volgende voorbeeld laat zien hoe u XLSB converteert naar XLSB in Python.
...
{{% cells-convert title="Voorbeeldcode om XLSB naar XLSB te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlsb" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLSB naar XLSB te converteren" %}}
