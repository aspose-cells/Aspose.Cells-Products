...
{{% blocks/products/pf/agp/content h2="如何使用 Python via .Net 将圆弧插入 Excel 文件" %}}

为了将 Arc 插入 Excel 文件，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via .Net 将 Arc 插入 Excel 文件的步骤" %}}
...
+ 通过索引选择工作表。
使用 shapecollection 的 add 方法在选定的工作表中插入圆弧。
以 XLSX 格式保存工作簿。
