---
title: Java HTM na XLT - Konwerter online HTM na XLT
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwertuj HTM na format zapisu XLT. Java HTM do formatu XLT. Zapisz HTM pod numerem XLT Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM pod numerem XLT w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować HTM na XLT w Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTM na XLT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki HTM na XLT? Java programiści mogą łatwo przekonwertować HTM na XLT w zaledwie kilku wierszach kodu.
...
1.  Konwertuj HTM na XLT, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji HTM na XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java do konwersji HTM na XLT" %}}
{{% blocks/products/pf/agp/text %}}
