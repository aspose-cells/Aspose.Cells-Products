...
description: XLT tvůrce. Vytvořte soubory XLT v kódu C#. Generujte soubory MS Excel XLT pomocí VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/code-block title="Ukázkový kód pro vytvoření souboru MS Excel XLT pomocí C#." offSpacer="" %}}
