---
title: C# XLSB から HTM - オンライン XLSB から HTM コンバータ
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# XLSB を HTM 保存形式に変換します。 C# XLSB を HTM 形式に変換します。 XLSB を HTM C# に保存します。
...
{{% blocks/products/pf/agp/content h2="XLSBをオンラインで無料でHTMに保存します" %}}
...
{{% cells-convert title="XLSBをオンラインでHTMに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="XLSB経由でXLSBをHTMに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSB ファイルをプログラムで HTM に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLSB を簡単にロードして HTM に変換できます。
