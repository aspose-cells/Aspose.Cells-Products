---
title: Comment dessiner ou insérer une forme incurvée dans Excel en utilisant Python via Java
weight: 10
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une forme incurvée dans un fichier Excel en utilisant Python via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Insert forme incurvée - Python via Java" offSpacer="" %}}
