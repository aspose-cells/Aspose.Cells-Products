...
url: /nl/python-java/merger/merge-xlsm-to-html/ 
...
Het volgende voorbeeld laat zien hoe u XLSM kunt samenvoegen met HTML in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLSM programmatisch samenvoegen tot HTML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
