---
title: Voeg TABDELLIMITED samen met ETT - Combineer TABDELLIMITED met ETT in C++
url: /nl/cpp/merger/merge-tabdelimited-to-ett/ 
description: Aspose Excel. C++ Aspose.Cells. TABDELIMITED samenvoegen naar ETT-opslagformaat. C++ Combineer TABDELIMITED naar ETT-formaat. TABDELLIMITED samenvoegen met ETT in C++. TABDELLIMITED Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg TABDELIMITED samen met ETT in C++" %}}

In het volgende voorbeeld ziet u hoe u TABDELLIMITED kunt samenvoegen met ETT in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TABDELLIMITED samen te voegen met ETT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een ETT-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie het voorbeeld C++ waarin TABDELLIMITED wordt samengevoegd met ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om TABDELIMITED samen te voegen met ETT in C++" InputFormat="tsv" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe u TABDELLIMITED kunt samenvoegen naar ETT via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TABDELLIMITED programmatisch samenvoegen met ETT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++-bibliotheek om TABDELLIMITED samen te voegen met ETT" %}}
