---
title: Java XML vers XLSB - Convertisseur XML vers XLSB en ligne
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XML en format de sauvegarde XLSB. Java XML au format XLSB. Enregistrez XML dans XLSB Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XML au format XLSB dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XML en XLSB dans Java.
...
Besoin de convertir des fichiers XML en XLSB par programmation ? Les développeurs Java peuvent facilement convertir XML en XLSB en seulement quelques lignes de code.
