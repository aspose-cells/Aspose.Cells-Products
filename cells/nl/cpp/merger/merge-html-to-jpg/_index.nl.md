---
title: Voeg HTML samen tot JPG - Combineer HTML tot JPG in C++
url: /nl/cpp/merger/merge-html-to-jpg/ 
description: Aspose Excel. C++ Aspose.Cells. Voeg HTML samen naar JPG-opslagformaat. C++ Combineer HTML naar JPG-formaat. Voeg HTML samen naar JPG in C++. HTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTML samen naar JPG in C++" %}}

Het volgende voorbeeld laat zien hoe u HTML samenvoegt met JPG in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTML samen te voegen naar JPG. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op als JPG-bestand. Als u code ontwikkelt in C++, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld C++ waarin HTML wordt samengevoegd tot JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om HTML samen te voegen met JPG in C++" InputFormat="html" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe HTML samen te voegen naar JPG via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTML programmatisch samenvoegen met JPG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om HTML samen te voegen naar JPG" %}}
