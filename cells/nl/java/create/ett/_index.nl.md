---
title: ETT maken - ETT-bestand maken in Java
description: Aspose Excel. Java ETT-bestand maken. Maak ETT Java. Java ETT-maker. Maak ETT in Java. Genereer ETT-bestand met Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een ETT-bestand in Java" h2="High-speed Java-bibliotheek voor het maken van een ETT-bestand. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ETT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe ETT te maken in Java" %}}
...
1.  Sla de werkmap op in ETT-indeling met behulp van de methode save().

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een ETT-bestand maakt in Java." offSpacer="" %}}
