...
description:  Aspose Excel. Java Szybko i łatwo utwórz plik ET za pomocą Aspose.Cells. Wygeneruj plik ET za pomocą Java. Utwórz ET w Java. Java ET Creator.
...
1.  Zapisz skoroszyt w formacie ET przy użyciu metody save().
