...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar XLAM met behulp van Python" %}}
...
Het volgende voorbeeld laat zien hoe u OTS converteert naar XLAM in Python.
