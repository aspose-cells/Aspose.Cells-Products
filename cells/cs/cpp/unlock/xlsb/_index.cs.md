...
{{< blocks/products/pf/i18n/upper-banner h1="Odemknout soubory XLSB přes C++" h2="Odstraňte ochranu z tabulek aplikace Excel včetně souboru XLSB pomocí knihovny C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1. Načtěte zamčený soubor XLSB pomocí CreateIWorkbook.1. Pro odemknutí zavolejte funkci Unprotect().1. Nastavte heslo na NULL pomocí SetPassword.1. Uložte soubor XLSB na určené místo.
