---
title: C# EXCEL à XLSM - Convertisseur EXCEL à XLSM
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format XLSM, permettant un enregistrement transparent des données EXCEL au format XLSM à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL sous XLSM dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en XLSM en C#.
...
{{% cells-convert title="Exemple de code pour convertir un fichier Excel en XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="xlsm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en XLSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en XLSM par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en XLSM en quelques lignes de code seulement.
...
1.  Convertissez le fichier EXCEL au format XLSM en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion d’EXCEL en XLSM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir EXCEL en XLSM" %}}
