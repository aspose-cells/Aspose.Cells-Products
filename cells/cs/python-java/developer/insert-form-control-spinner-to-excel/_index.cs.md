---
title:  Vložte Spin Button (ovládací prvek formuláře) do Excelu přes Python
weight: 40
description: Python zdrojový kód pro vložení Spin Button (ovládání formuláře) do Excelu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vložte Spin Button (ovládací prvek formuláře) do Excelu přes Python" h2="Vkládejte objekty pomocí rozhraní API na straně serveru bez jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF atd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit Spin Button (ovládací prvek formuláře) do souboru aplikace Excel pomocí Python" %}}

 Abychom vložili Spin Button (ovládání formuláře) do souboru aplikace Excel, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení Spin Button (ovládání formuláře) do souboru Excel prostřednictvím Python" %}}
...
+ Vyberte List přes jeho index.
 + Použijte kolekci tvarů[přidat metodu](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)) pro vložení Spin Button (ovládací prvek formuláře) do vybraného listu.
...
{{% blocks/products/pf/agp/code-block title="Tlačítko Insert Spin (ovládání formuláře) - Python" offSpacer="" %}}
