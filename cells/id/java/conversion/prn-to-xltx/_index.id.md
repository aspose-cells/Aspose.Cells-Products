---
title: Java PRN ke XLTX - Konverter PRN ke XLTX Online
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Online Gratis Java Konversi PRN ke XLTX saveformat. Java format PRN ke XLTX. Simpan PRN ke XLTX Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah PRN menjadi XLTX di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi PRN ke XLTX. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, XLTX, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan PRN ke XLTX di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi PRN ke XLTX di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengonversi PRN ke XLTX. Unggah file PRN Anda, lalu simpan sebagai file XLTX. Untuk membaca PRN dan menulis XLTX Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format output XLTX akan identik dengan dokumen PRN asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi PRN ke XLTX Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Konversi PRN ke XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke XLTX secara terprogram? Pengembang Java dapat dengan mudah mengubah PRN menjadi XLTX hanya dalam beberapa baris kode.
...
1.  Ubah PRN menjadi XLTX dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi PRN ke XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi PRN ke XLTX" %}}
{{% blocks/products/pf/agp/text %}}
