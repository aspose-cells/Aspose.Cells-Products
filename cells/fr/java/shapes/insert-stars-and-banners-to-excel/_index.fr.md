...
{{% blocks/products/pf/agp/content h2="Comment insérer une étoile/une bannière dans un fichier Excel à l\'aide de Java" %}}

 Afin d'insérer Insérer une étoile/une bannière dans un fichier Excel, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer Insérer une étoile/bannière dans un fichier Excel via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) pour insérer Insérer une étoile/une bannière dans la feuille de calcul sélectionnée
...
L'exemple de code ci-dessous montre comment insérer « Ruban : courbé et incliné vers le haut » et « Explosion : 8 points ». Pour plus de types, veuillez vous référer à « Présentation des types d'insertion d'étoiles et de bannières » ci-dessous.
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
Présentation des types d'insertion d'étoile et de bannière
   </h2>
   <div class="col-lg-4">
