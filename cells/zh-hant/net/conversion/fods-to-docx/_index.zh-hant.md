---
title: C# FODS 至 DOCX - FODS 至 DOCX 轉換器
description: Aspose Excel。此綜合解決方案為 C# 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 DOCX 格式，從而能夠使用 Aspose.Cells 庫將 FODS 數據無縫保存為 0761533681533676136481 資料無縫代碼實現。
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 DOCX，即 C#" %}}

以下範例示範如何在 C# 中將 FODS 轉換為 DOCX。
...
{{% cells-convert title="將 FODS 轉換為 DOCX 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 DOCX" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 檔案轉換為 DOCX 嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入和轉換 FODS 到 DOCX。
...
1. 使用工作簿實例載入 FODS 檔案。
1. 透過呼叫 Workbook.Save 方法將 FODS 轉換為 DOCX。
1. 取得FODS到DOCX的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="使用 C# 庫將 FODS 轉換為 DOCX" %}}
