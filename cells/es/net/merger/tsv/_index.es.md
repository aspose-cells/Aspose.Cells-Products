...
+ Cargue todos los archivos TSV con la ruta completa.
+ Crear un documento como archivo base
+ Llame al método relevante para concatenar y fusionar archivos uno por uno.
+ Llame al método Save() y pase el nombre del archivo (ruta completa) y el formato (TSV) como parámetro.
+ Ahora puedes abrir y utilizar el archivo TSV en Microsoft Office, Adobe PDF o cualquier otro programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Fusionar archivos TSV - C#" offSpacer="" %}}
