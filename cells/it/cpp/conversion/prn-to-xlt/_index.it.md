...
description: Aspose Excel. Converti il PRN in XLT in modo rapido e semplice con Aspose.Cells. C++ PRN in XLT. C++ Salva PRN in XLT. Salva PRN come XLT utilizzando C++.
...
{{% blocks/products/pf/agp/content h2="Salva il PRN allo XLT in C++" %}}

L'esempio seguente mostra come convertire il PRN in XLT in C++.
...
È necessario convertire i file PRN in XLT a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in XLT in poche righe di codice.
...
1.  Converti PRN in XLT chiamando il metodo Save().
1.  Ottieni il risultato della conversione da PRN a XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C++ per convertire il PRN in XLT" %}}
