...
{{% blocks/products/pf/agp/content h2="Sla HTML op in XLSM in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar XLSM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar XLSM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar XLSM? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar XLSM met slechts een paar regels code.
