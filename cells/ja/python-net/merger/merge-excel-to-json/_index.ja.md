---
title: EXCEL を JSON に結合 - EXCEL を JSON に Python に結合
url: /ja/python-net/merger/merge-excel-to-json/ 
description: Aspose エクセル。 Python Aspose.Cells. 無料オンライン EXCEL を JSON 保存形式に結合します。 Python EXCEL を JSON 形式に結合します。 EXCEL を Python の JSON に結合します。EXCEL を結合します。
...
{{% blocks/products/pf/agp/content h2="Python を使用して EXCEL を JSON に結合" %}}

 EXCEL を JSON にマージするにはどうすればよいですか? Aspose.Cells for Python via .NET ライブラリを使用すると、数行のコードでプログラム的に EXCEL を JSON に簡単にマージできます。[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)すべての Excel ファイルを生成、変更、変換、レンダリング、印刷できるクロスプラットフォーム アプリケーションを構築できます。 Python Excel API は、スプレッドシート形式間の変換だけでなく、Excel ファイルを画像、PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT などとしてレンダリングすることもできるため、ドキュメントの交換に最適です。業界標準でフォーマット。 Aspose.Cells for Python via .NET を次からインストールできます。<a href="https://pypi.org/project/aspose-cells-python/">pypi</a>、次のようにコマンドを使用します。<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="オンラインで無料でEXCELをPythonのJSONにマージします" %}}

次の例は、EXCEL を Aspose.Cells for Python via .NET の JSON にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、EXCEL を JSON にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルをマージし、それを JSON ファイルに保存します。 Python でコードを開発する場合、これは思っているより簡単です。 EXCEL を JSON にマージする Python の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="EXCELをJSONにPythonにマージする無料オンライン" InputFormat="xlsx" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Python 経由で EXCEL を JSON にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで EXCEL を JSON にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="Python EXCEL を JSON にマージするライブラリ" %}}
