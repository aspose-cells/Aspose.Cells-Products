---
title: Μετατροπή TSV σε XLSM μέσω Python
url: /el/python-java/conversion/tsv-to-xlsm/
description: Δείγμα κώδικα για μετατροπή tsv σε xlsm Python. Χρησιμοποιήστε API παράδειγμα κώδικα για ομαδική μετατροπή αρχείων tsv σε xlsm εντός της εφαρμογής Python.
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε TSV σε XLSM χρησιμοποιώντας το Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή TSV σε XLSM μέσω Python" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του Python μπορούν εύκολα να φορτώσουν και να μετατρέψουν αρχεία TSV σε XLSM σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φορτώστε το αρχείο TSV με μια παρουσία του βιβλίου εργασίας1. Καλέστε τη μέθοδο Workbook.Save1. Περάστε τη διαδρομή εξόδου με την επέκταση XLSM ως παράμετρο1. Ελέγξτε την καθορισμένη διαδρομή για το αρχείο XLSM που προκύπτει
...
{{% cells-convert title="Δωρεάν εφαρμογή και δείγμα κώδικα για μετατροπή TSV σε XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlsm" IsLandingPage="true" language="python" %}}
