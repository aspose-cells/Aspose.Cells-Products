...
description: Aspose เอ็กเซล. แปลง XLS เป็น XLTX อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XLS ถึง XLTX C++ บันทึก XLS ถึง XLTX บันทึก XLS เป็น 07611134 81 ใช้ C++.
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ถึง XLTX ใน C++" %}}
...
1.  แปลง XLS เป็น XLTX โดยการเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลงจาก XLS เป็น XLTX

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ ไลบรารี่เพื่อแปลง XLS เป็น XLTX" %}}
