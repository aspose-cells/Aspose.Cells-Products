...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar CSV met Aspose.Cells. PHP OTS naar CSV. PHP Bewaar OTS naar CSV. Sla OTS op als CSV met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar CSV te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar CSV converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar CSV in slechts een paar regels code.
...
1.  Converteer OTS naar CSV door de opslagmethode van Workbook aan te roepen.
