---
title:  Chèn TextBox vào Excel via .NET
weight: 301
description: C# Mã mẫu thêm hoặc chèn TextBox vào Excel sử dụng Thư viện .NET. Sử dụng mã này để tạo TextBox trong MS Excel trong VB.NET, Asp.NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
keywords: [C# Aspose.Cells., c# add TextBox., c# insert TextBox., c# create TextBox]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn TextBox vào Excel via .NET" h2="Chèn TextBox sử dụng Aspose.Cells\' API không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[thêm phương pháp](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addtextbox)để chèn TextBox vào bảng tính đã chọn
