---
title: Gabungkan MHTML menjadi EXCEL - Gabungkan MHTML menjadi EXCEL di Java
url: /id/java/merger/merge-mhtml-to-excel/ 
description: Aspose Unggul. Java Aspose.Cells. Gabung Online Gratis MHTML ke format simpan EXCEL. Java Gabungkan MHTML menjadi format EXCEL. Gabung MHTML menjadi EXCEL di Java. MHTML Gabung.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan MHTML menjadi EXCEL via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan MHTML ke EXCEL. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="MHTML" additionalConversionTag="EXCEL" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Menggabungkan MHTML menjadi EXCEL Menggunakan Java" %}}

 Bagaimana cara menggabungkan MHTML ke EXCEL? Dengan perpustakaan Aspose.Cells for Java, Anda dapat dengan mudah menggabungkan MHTML ke EXCEL secara terprogram dengan beberapa baris kode.[Aspose.Cells for Java](https://products.aspose.com/cells/java) mampu membangun aplikasi lintas platform dengan kemampuan untuk menghasilkan, memodifikasi, mengonversi, merender, dan mencetak semua file Excel. Java Excel API tidak hanya mengkonversi antara format spreadsheet, tetapi juga dapat membuat file Excel sebagai gambar, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT dan lainnya, sehingga menjadikannya pilihan yang sempurna untuk bertukar dokumen dalam industri -standar format. Anda dapat mengunduh versi terbarunya langsung dari[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) dan instal dalam proyek berbasis Maven Anda dengan menambahkan konfigurasi berikut ke pom.xml.
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHTML menjadi EXCEL di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan MHTML ke EXCEL di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan MHTML ke EXCEL. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file EXCEL. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan MHTML ke EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis Menggabungkan MHTML menjadi EXCEL di Java" InputFormat="mhtml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML menjadi EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan MHTML ke EXCEL secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan MHTML ke EXCEL" %}}
