...
Es fácil para los desarrolladores crear, cargar, modificar y convertir archivos ET dentro de aplicaciones de informes en ejecución para el procesamiento de datos en solo unas pocas líneas de código.
...
1.  Guarde el libro de trabajo como archivo .et usando el método Save().
