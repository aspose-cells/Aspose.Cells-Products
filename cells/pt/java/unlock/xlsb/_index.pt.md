...
weight: 5860
description: Java código de amostra para desbloquear arquivo protegido por senha XLSB em Java Ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloquear XLSB Arquivos via Java" h2="Remova a proteção das planilhas do Excel, incluindo o arquivo XLSB, usando a Biblioteca Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Como remover o arquivo de proteção XLSB usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para desbloquear XLSB via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Desbloqueie os arquivos XLSB via C#" offSpacer="" %}}
