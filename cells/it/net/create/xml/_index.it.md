---
title: "Crea XML: crea un file XML in C#"
description:  Aspose Excel. C# Crea file XML in modo semplice e veloce con Aspose.Cells. Genera file XML utilizzando C#. Crea file XML in C#. C# XML Creator.
...
{{% blocks/products/pf/agp/content h2="Come creare XML in C#" %}}
...
1.  Utilizzare il metodo Salva per salvare la cartella di lavoro come file XML.

{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare un file XML in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria C# per creare file XML" %}}
