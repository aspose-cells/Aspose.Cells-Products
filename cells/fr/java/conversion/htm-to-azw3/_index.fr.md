---
title: Convertisseur HTM vers AZW3 (Java)
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format HTM au format AZW3, permettant un enregistrement transparent des données HTM au format AZW3 à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM dans AZW3 dans Java" %}}

L'exemple suivant montre comment convertir HTM en AZW3 dans Java.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier HTM en AZW3. Téléchargez votre fichier HTM, puis enregistrez-le au format AZW3. Vous pouvez utiliser des noms de fichiers complets pour la lecture des fichiers HTM et l'écriture des fichiers AZW3. Le contenu et la mise en forme du fichier AZW3 seront identiques à ceux du document HTM d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir du HTM en AZW3" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="azw3" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir un fichier HTM en AZW3 via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en AZW3 par programmation ? Les développeurs Java peuvent facilement convertir des fichiers HTM en AZW3 en quelques lignes de code seulement.
...
1.  Convertissez le fichier HTM en AZW3 en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de HTM en AZW3.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir HTM en AZW3" %}}
{{% blocks/products/pf/agp/text %}}
