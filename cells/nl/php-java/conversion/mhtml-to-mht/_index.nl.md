---
title: PHP MHTML naar MHT - MHTML naar MHT-converter
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar MHT met Aspose.Cells. PHP MHTML naar MHT. PHP Sla MHTML op in MHT. Sla MHTML op als MHT met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar MHT te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar MHT converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar MHT.
...
1.  Converteer MHTML naar MHT door de opslagmethode van Workbook aan te roepen.
