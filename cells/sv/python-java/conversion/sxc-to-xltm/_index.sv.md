---
title: Konvertera SXC till XLTM via Python
url: /sv/python-java/conversion/sxc-to-xltm/
description: Exempelkod för konvertering från sxc till xltm Python. Använd API exempelkod för batch-sxc-filer till xltm-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till XLTM med Python" %}}

 För att konvertera SXC till XLTM kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till XLTM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera SXC-filer till XLTM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SXC-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med XLTM-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande XLTM-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera SXC till XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xltm" IsLandingPage="true" language="python" %}}
