...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLT 转换为 WORD。 C# XLT 为 WORD。 C# 将 XLT 保存为 WORD。 将 XLT 另存为 07611134 81 使用 C#。
keywords: [Aspose Excel., C# Aspose.Cells., Convert XLT to WORD in C#., Save XLT to WORD using C#., C# XLT to WORD saveformat., XLT to WORD Converter., C# Save XLT as WORD]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="将 XLT 转换为 C# 中的 WORD" h2="高速C#库，用于将XLT转换为WORD。这是一个专业的软件解决方案，可在.NET Framework、.NET Core或Mono平台上导入和导出XLT、WORD和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
以下示例演示如何将 C# 中的 XLT 转换为 WORD。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLT 转换为 WORD。上传您的 XLT 文件，然后只需将其另存为 WORD 文件。对于 XLT 读取和 WORD 写入，您可以使用完全限定的文件名。输出 WORD 内容和格式将与原始 XLT 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 XLT 转换为 WORD 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLT 转换为 WORD" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 文件转换为 WORD 吗？ .NET 开发人员只需几行代码即可轻松加载和转换 XLT 到 WORD。
...
1. 使用工作簿实例加载 XLT 文件。
1. 通过调用Workbook.Save方法将XLT转换为WORD。
1. 获取XLT到WORD的转换结果。
