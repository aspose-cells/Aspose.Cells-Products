...
weight: 8410
description: Kod źródłowy C# do wyszukiwania słów ze wzorcem w pliku TXT na platformach .NET Framework, .NET Core, Mono lub platformach Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Wyszukaj formaty TXT w C#" h2="Natywne i wydajne wyszukiwanie dokumentów TXT przy użyciu interfejsów API Aspose.Cells for .NET po stronie serwera, bez użycia oprogramowania takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
