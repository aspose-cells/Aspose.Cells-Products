...
ใน Office 365 ข้อคิดเห็นสำหรับการสนทนา คุณสามารถใช้โค้ด C# ต่อไปนี้เพื่อแทรกและลบข้อคิดเห็นในไฟล์ ODS

{{% blocks/products/pf/agp/code-block title="รหัสตัวอย่าง C# เพื่อแทรกและลบความคิดเห็นในไฟล์ ODS" offSpacer="" %}}
