---
title: Java MHT na SQL - Konwerter MHT na SQL
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji MHT do formatu SQL, umożliwiając bezproblemowe zapisywanie danych MHT w formacie SQL przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT do SQL w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować MHT na SQL w Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHT na SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki MHT na SQL? Programiści Java mogą łatwo przekonwertować pliki MHT na SQL za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj MHT na SQL, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji MHT do SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji MHT na SQL" %}}
{{% blocks/products/pf/agp/text %}}
