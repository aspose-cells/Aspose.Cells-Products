...
{{% blocks/products/pf/agp/content h2="كيفية البحث في ملف TSV باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث في ملفات TSV في Java" %}}
...
+ الوصول إلى ورقة العمل الأولى في ملف TSV.
...
{{% blocks/products/pf/agp/code-block title="بحث في ملفات TSV - Java" offSpacer="" %}}
