...
description: Aspose Excel. C++ Aspose.Cells. Voeg MHTML samen naar HTM-opslagformaat. C++ Combineer MHTML naar HTM-formaat. Voeg MHTML samen met HTM in C++. MHTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg MHTML samen met HTM in C++" %}}

Het volgende voorbeeld laat zien hoe u MHTML samenvoegt met HTM in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHTML samen te voegen met HTM. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een HTM-bestand. Als u code ontwikkelt in C++, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld C++ waarin MHTML wordt samengevoegd met HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om MHTML samen te voegen met HTM in C++" InputFormat="mhtml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe MHTML samenvoegen naar HTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML programmatisch samenvoegen met HTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
