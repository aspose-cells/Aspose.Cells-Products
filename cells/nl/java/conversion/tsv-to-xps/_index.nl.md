...
{{% blocks/products/pf/agp/content h2="Sla TSV op in XPS in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar XPS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar XPS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TSV programmatisch converteren naar XPS? Ontwikkelaars van Java kunnen bestanden met de extensie TSV eenvoudig converteren naar XPS met slechts een paar regels code.
