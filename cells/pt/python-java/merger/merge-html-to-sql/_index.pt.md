...
description: Aspose Excel. Python Aspose.Cells. Mesclar HTML para SQL saveformat. Python Combine HTML com o formato SQL. Mesclar HTML com SQL em Python. HTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com SQL usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com SQL em Python" %}}

exemplo a seguir demonstra como mesclar HTML com SQL em Aspose.Cells for Python via Java.
...
{{% cells-merger title="Exemplo de código para mesclar HTML com SQL em Python" InputFormat="html" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar HTML com SQL via Python" %}}
