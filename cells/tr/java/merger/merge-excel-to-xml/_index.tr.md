---
title: EXCEL'i XML ile Birleştir - Java'de EXCEL'i XML ile Birleştir
url: /tr/java/merger/merge-excel-to-xml/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i XML kaydetme biçimiyle birleştirin. Java EXCEL'i XML biçimiyle birleştirin. Java'de EXCEL'i XML ile birleştir. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i XML ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de EXCEL'in XML ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i XML ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından bunu XML dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. EXCEL'i XML ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java\'de EXCEL\'i XML ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i XML via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i XML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
