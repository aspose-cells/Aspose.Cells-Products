---
title: C# HTML'den XML'e - HTML'den XML'e Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile HTML'i hızlı ve kolay bir şekilde XML'e dönüştürün. C# HTML'i XML'e dönüştürün. C# HTML'i XML'e kaydedin. HTML'i C#'i kullanarak XML olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="HTML\'i C#\'de XML\'e kaydedin" %}}

Aşağıdaki örnek, HTML'in C#'de XML'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="HTML\'i XML\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML\'i C# aracılığıyla XML\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

HTML dosyalarını programlı olarak XML'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyebilir ve XML'e dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="HTML\'i XML\'e dönüştürmek için C# kitaplığı" %}}
