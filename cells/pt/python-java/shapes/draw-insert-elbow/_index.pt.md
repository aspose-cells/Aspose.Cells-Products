---
title: Como desenhar ou inserir a forma do cotovelo no Excel usando Python via Java
weight: 10
...
{{% blocks/products/pf/agp/content h2="Como inserir a forma do cotovelo no arquivo do Excel usando Python via Java" %}}

 Para inserir a forma do cotovelo no arquivo Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir a forma do cotovelo no arquivo Excel usando Python via Java" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use a coleção de formas[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) para inserir uma forma de cotovelo na planilha selecionada.
...
{{% blocks/products/pf/agp/code-block title="Inserir forma de cotovelo - Python via Java" offSpacer="" %}}
