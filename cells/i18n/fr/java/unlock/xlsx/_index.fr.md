---
title: Déverrouiller le document XLSX via Java 
weight: 310
url: /fr/java/unlock/xlsx/ 
description: Java exemple de code pour déverrouiller le fichier XLSX protégé par mot de passe sur Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Déverrouiller les fichiers XLSX via Java" h2="Supprimez la protection des feuilles de calcul Excel, y compris le fichier XLSX à l\'aide de la bibliothèque Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment supprimer le fichier XLSX de protection à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour déverrouiller XLSX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Déverrouiller les fichiers XLSX via C#" offSpacer="" %}}
