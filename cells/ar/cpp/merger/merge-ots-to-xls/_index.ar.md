---
title: دمج OTS في XLS - ادمج OTS إلى XLS في C++
url: /ar/cpp/merger/merge-ots-to-xls/ 
description: Aspose إكسل. C++ Aspose.Cells. دمج OTS مجانًا عبر الإنترنت إلى تنسيق حفظ XLS. C++ ادمج OTS بتنسيق XLS. دمج OTS في XLS في C++. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="قم بدمج OTS في XLS في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج OTS مع XLS في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج OTS في XLS. قم بتحميل ملفاتك ، واتصل بطريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف XLS. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج OTS مع XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج OTS في XLS في C++" InputFormat="ots" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج OTS في XLS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج OTS في XLS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
