---
title: Konwerter PHP XLTX na DIF - XLTX na DIF
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTX na DIF za pomocą PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potrzebujesz programowo przekonwertować pliki XLTX na DIF? Programiści PHP mogą łatwo załadować i przekonwertować pliki XLTX na DIF za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLTX na DIF wywołując metodę save obiektu Workbook.
1.  Uzyskaj wynik konwersji XLTX na DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka PHP do konwersji XLTX na DIF" %}}
