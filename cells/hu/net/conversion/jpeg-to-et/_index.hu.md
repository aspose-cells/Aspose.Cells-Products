...
{{% blocks/products/pf/agp/content h2="Spóroljon a JPEG-es számlaösszeget ET-re a C#-es számlaösszegben" %}}

következő példa bemutatja, hogyan lehet a JPEG számot ET-vé alakítani a C#-ben.
...
Programozottan kell konvertálnia a JPEG fájlokat ET-re? A .NET fejlesztők egyszerűen betölthetik és átalakíthatják a JPEG-et ET-re, mindössze néhány sornyi kóddal.
...
1.  Alakítsd át a JPEG-et ET-vé a Workbook.Save metódus meghívásával.
1.  Szerezze meg a JPEG konverziós eredményt ET-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a JPEG ET-vé konvertálásához" %}}
