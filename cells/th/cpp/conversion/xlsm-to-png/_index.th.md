---
title: แปลง XLSM เป็น PNG ผ่าน C++ แอปพลิเคชัน 
url: /th/cpp/conversion/xlsm-to-png/ 
description: ตัวอย่างรหัสการแปลง C++ สำหรับเอกสาร XLSM เป็นรูปแบบ PNG โปรแกรมเมอร์สามารถใช้ซอร์สโค้ดนี้สำหรับการแปลง XLSM เป็น PNG แบบแบตช์ภายในแอปพลิเคชัน C++ ใดๆ
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ นักพัฒนาซอฟต์แวร์สามารถแปลงไฟล์ XLSM เป็น PNG ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ XLSM โดยใช้ Factory::CreateIWorkbook1. เลือกแผ่นงานแรก1. ตั้งค่าตัวเลือก (PNG)1. วนซ้ำในแต่ละหน้าของชีตและเรนเดอร์1. เปิดไฟล์ PNG ในโปรแกรมที่เข้ากันได้
...
{{% blocks/products/pf/agp/code-block title="XLSM เป็น PNG C++ รหัสแหล่งที่มาของการแปลง" offSpacer="" %}}
