...
description: Aspose Excel. Converteer EXCEL snel en eenvoudig naar PPTX met Aspose.Cells. Python EXCEL naar PPTX. Python Bewaar EXCEL naar PPTX. Sla EXCEL op als PPTX met Python.
...
{{% blocks/products/pf/agp/content h2="Bewaar EXCEL op PPTX in Python" %}}
...
{{% cells-convert title="Voorbeeldcode om EXCEL naar PPTX te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" language="pythonnet" %}}
