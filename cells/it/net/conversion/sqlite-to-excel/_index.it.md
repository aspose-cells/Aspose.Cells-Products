---
title: C# Da SQLite a EXCEL - Convertitore da SQLite a EXCEL
description: Aspose Excel. Converti SQLite in EXCEL in modo rapido e semplice con Aspose.Cells. C# SQLite in EXCEL. C# Salva SQLite in EXCEL. Salva SQLite come EXCEL utilizzando C#.
...
{{% blocks/products/pf/agp/content h2="Come convertire SQLite in EXCEL tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i dati SQLite in EXCEL a livello di codice? .NET gli sviluppatori possono caricare e convertire facilmente SQLite in EXCEL in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1.  Installa 'Aspose.Cells for .NET'.
1.  Aggiungi un riferimento di libreria (importa la libreria) al tuo progetto C#.
1.  Interrogare i dati dal database SQLite per ottenere un oggetto DataTable.
...
{{% blocks/products/pf/agp/code-block title="Codice di esempio per convertire SQLite in EXCEL - C#" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria C# per convertire SQLite in EXCEL" %}}
