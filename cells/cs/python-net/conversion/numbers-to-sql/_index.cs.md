...
{{% blocks/products/pf/agp/content h2="Převeďte NUMBERS na SQL v Python" %}}
...
Následující příklad ukazuje, jak převést ČÍSLA na SQL v Python via NET.
