...
description: Aspose Excel. Převeďte TABDELIMITED na OTS rychle a snadno pomocí Aspose.Cells. PHP TABDELIMITED na OTS. PHP Uložit TABDELIMITED do OTS. Uložit TABDELIMITED jako OTS pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na OTS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory TABDELIMITED na OTS programově? Vývojáři PHP mohou snadno načíst a převést TABDELIMITED na OTS v několika řádcích kódu.
...
1.  Převeďte TABDELIMITED na OTS voláním metody uložení sešitu.
