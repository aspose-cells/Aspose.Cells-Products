...
{{% blocks/products/pf/agp/content h2="Konvertera SXC till SQL med Python Excel-bibliotek" %}}
...
{{% blocks/products/pf/agp/content h2="Spara SXC till SQL i Python Excel-bibliotek" %}}

Följande exempel visar hur man konverterar SXC till SQL i Python excel-bibliotek.
...
{{% blocks/products/pf/agp/content h2="Python Excel-bibliotek för att konvertera SXC till SQL" %}}
