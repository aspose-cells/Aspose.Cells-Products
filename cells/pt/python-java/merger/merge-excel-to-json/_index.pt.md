---
title:  Mesclar EXCEL para JSON via Python
...
O exemplo a seguir demonstra como mesclar EXCEL para JSON em Python.
...
{{% cells-merger title="Aplicativo gratuito para mesclar EXCEL para JSON online" InputFormat="xlsx" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
