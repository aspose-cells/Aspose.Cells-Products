---
title: " Tekintse meg a XLSX fájlformátumokat: via .NET"
weight: 2180
description: C# forráskód XLSX dokumentum betöltéséhez, megjelenítéséhez és megjelenítéséhez a .NET Framework, .NET Core, Mono vagy Xamarin platformokon.
...
{{< blocks/products/pf/i18n/upper-banner h1="XLSX Fájlnézegető for .NET" h2="Tekintse meg az Excel- és OpenOffice-táblázatokat, például a XLSX-es Microsoft Excel vagy Office Automation használata nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="A XLSX fájl megtekintése a C# használatával" %}}

 A XLSX fájl megtekintéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A XLSX-es szám megtekintésének lépései a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 A Aspose.Cells egyszerűvé teszi a fejlesztők számára a XLSX fájl megtekintését néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1.  Töltse be a XLSX fájlt a munkafüzet egy példányába
1.  Hozzon létre egy HtmlSaveOptions példányt, és állítsa igazra az ExportHeadings tulajdonságot
1. Mentse a XLSX-es fájlt HTML-es formátumban a munkafüzet használatával. Mentés módszere
...
{{% blocks/products/pf/agp/code-block title="C# példakód a XLSX fájl megtekintéséhez" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API használható Microsoft Excel formátumok létrehozására, szerkesztésére, konvertálására és renderelésére különböző formátumokba. Ezen túlmenően használható átfogó diagramok készítésére, skálázható jelentésekre és megbízható számításokra a szoftveralkalmazásokon belül. A Aspose.Cells egy önálló API, és nem igényel olyan szoftvert, mint a Microsoft vagy az OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a XLSX szám megtekintéséhez" sectionDescription=" Tekintse meg élő bemutatóinkat[Tekintse meg: XLSX](https://products.aspose.app/cells/viewer/xlsx) a következő előnyökkel." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nem kell letölteni vagy beállítani semmit" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni vagy fordítani" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a XLSX fájlt, és nyomja meg a \"Nézet\" gombot" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Ha szükséges, töltse le a XLSX-es fájlt a hivatkozásról" >}}
