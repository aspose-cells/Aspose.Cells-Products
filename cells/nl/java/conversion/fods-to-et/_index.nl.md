...
{{% blocks/products/pf/agp/content h2="Sla FODS op in ET in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar ET in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je FODS naar ET via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u FODS-bestanden programmatisch naar ET converteren? Ontwikkelaars van Java kunnen FODS-bestanden eenvoudig met een paar regels code naar ET converteren.
