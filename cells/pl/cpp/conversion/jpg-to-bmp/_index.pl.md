---
title: C++ JPG do BMP - JPG do BMP Konwerter
description: Aspose Excel. Konwertuj JPG na BMP szybko i łatwo za pomocą Aspose.Cells. C++ JPG na BMP. C++ Zapisz JPG na BMP. Zapisz JPG jako BMP używając C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj JPG na BMP w C++" h2="Wysokowydajna konwersja JPG do BMP przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Zapisz JPG pod numerem BMP w C++" %}}

Poniższy przykład pokazuje, jak przekonwertować JPG na BMP w C++.
...
{{% cells-convert title="Przykładowy kod do konwersji JPG na BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="bmp" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować JPG na BMP przez C++" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki JPG na BMP? Programiści C++ mogą z łatwością przekonwertować JPG na BMP w zaledwie kilku linijkach kodu.
...
1.  Konwertuj JPG na BMP, wywołując metodę Save().
1.  Uzyskaj wynik konwersji JPG na BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C++ do konwersji JPG na BMP" %}}
