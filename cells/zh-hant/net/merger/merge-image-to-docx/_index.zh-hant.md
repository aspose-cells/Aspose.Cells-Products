...
url: /zh-hant/net/merger/merge-image-to-docx/ 
...
以下範例示範如何將 IMAGE 合併到 Aspose.Cells for .NET 中的 DOCX。
...
需要以程式設計方式將 IMAGE 合併到 DOCX 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 庫將 IMAGE 合併到 DOCX" %}}
