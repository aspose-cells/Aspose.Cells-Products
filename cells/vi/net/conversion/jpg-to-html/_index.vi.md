---
title: C# JPG sang HTML - Chuyển đổi JPG sang HTML
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển C# một phương pháp tích hợp đầy đủ để chuyển đổi JPG sang định dạng HTML, cho phép lưu dữ liệu JPG liền mạch vào định dạng HTML bằng thư viện Aspose.Cells, tất cả thông qua mã C# hiệu quả và có thể tùy chỉnh.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi JPG sang HTML trong C#" h2="Thư viện tốc độ cao C# dùng để chuyển đổi JPG sang HTML. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất JPG, HTML và nhiều định dạng khác trên nền tảng .NET Framework, .NET Core hoặc Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPG" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Chuyển đổi JPG sang HTML bằng cách sử dụng C#" %}}
 Làm cách nào để chuyển đổi JPG sang HTML? Với thư viện Aspose.Cells for .NET, bạn có thể dễ dàng chuyển đổi JPG sang HTML theo chương trình với một vài dòng mã.[Aspose.Cells for .NET](https://products.aspose.com/cells/net) có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, hiển thị và in tất cả các tệp Excel. .NET Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó biến nó thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành. Mở[NuGet](https://www.nuget.org/packages/aspose.cells)quản lý gói, tìm kiếm Aspose.Cells và cài đặt. Bạn cũng có thể sử dụng lệnh sau từ Bảng điều khiển quản lý gói.
...
{{% blocks/products/pf/agp/content h2="Lưu ảnh JPG vào thư mục HTML trong tệp C#." %}}

Ví dụ sau đây minh họa cách chuyển đổi JPG sang HTML trong C#.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để chuyển đổi JPG sang HTML. Tải tệp JPG của bạn lên, sau đó chỉ cần lưu dưới dạng tệp HTML. Đối với cả việc đọc JPG và ghi HTML, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng HTML đầu ra sẽ giống hệt với tài liệu JPG gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ví dụ mã lệnh chuyển đổi JPG sang định dạng HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="html" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển JPG sang HTML qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi file JPG sang HTML theo chương trình? Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi JPG sang HTML chỉ bằng vài dòng mã.
...
1.  Chuyển đổi định dạng JPG thành HTML bằng cách gọi phương thức Workbook.Save.
1.  Nhận kết quả chuyển đổi JPG thành HTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C# để chuyển đổi JPG sang HTML" %}}
