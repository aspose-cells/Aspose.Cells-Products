...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση SXC σε ET saveformat. Java Συνδυάστε το SXC σε μορφή ET. Συγχώνευση SXC στο ET στο Java. SXC Συγχώνευση.
keywords: [Aspose Excel., Java Aspose.Cells., Merge SXC to ET in Java., Java Merge SXC to et., Java Combine SXC to ET., SXC Merge]
---
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση SXC στο ET στο Java" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση SXC στο ET στο Java" InputFormat="sxc" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
