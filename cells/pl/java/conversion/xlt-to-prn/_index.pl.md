---
title: Java XLT do PRN - Online XLT do konwertera PRN
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwersja XLT do formatu zapisu PRN. Java XLT do formatu PRN. Zapisz XLT do PRN Java.
...
{{% blocks/products/pf/agp/content h2="Zaoszczędź XLT w PRN w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLT na PRN w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLT na PRN. Prześlij swój plik XLT, a następnie po prostu zapisz go jako plik PRN. Zarówno do odczytu XLT, jak i zapisu PRN można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość PRN i formatowanie będą identyczne z oryginalnym dokumentem XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLT na PRN Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLT na PRN? Java programiści mogą łatwo przekonwertować XLT na PRN w zaledwie kilku wierszach kodu.
...
1.  Konwertuj XLT na PRN, wywołując metodę Workbook.save.
