...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar XML met Aspose.Cells. C# MHTML naar XML. C# Sla MHTML op in XML. Sla MHTML op als XML met behulp van C#.
...
{{% blocks/products/pf/agp/content h2="Sla MHTML op in XML in C#" %}}

Het volgende voorbeeld laat zien hoe u MHTML naar XML converteert in C#.
