---
title: Python XLT 至 PPTX - XLT 至 PPTX 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 XLT 轉換為 PPTX。Python XLT 為 PPTX. Python 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Python。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 XLT 轉換為 Python 中的 PPTX" h2="高速 Python 庫，用於將 XLT 轉換為 PPTX。使用我們的 Excel 轉換 API 在 Python 中開發高級、平台獨立的軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何將 XLT 轉換為 PPTX？使用 Aspose.Cells for Python via NET 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 XLT 轉換為 PPTX。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。
...
以下範例示範如何將 Python via NET 中的 XLT 轉換為 PPTX。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLT 轉換為 PPTX。上傳您的 XLT 文件，然後只需將其另存為 PPTX 文件。對於 XLT 讀取和 PPTX 寫入，您可以使用完全限定的檔案名稱。輸出 PPTX 內容和格式將與原始 XLT 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 XLT 轉換為 PPTX 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="pptx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何將 XLT 轉換為 PPTX" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 XLT 檔案轉換為 PPTX 嗎？ Python 開發人員只需幾行程式碼即可輕鬆載入和轉換 XLT 到 PPTX。
...
1. 使用工作簿實例載入 XLT 檔案。
1. 透過呼叫Workbook.save方法將XLT轉換為PPTX。
1. 取得XLT到PPTX的轉換結果。
