...
È necessario convertire i file PRN in HTML a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in HTML in poche righe di codice.
...
1.  Converti PRN in HTML chiamando il metodo Save().
