...
weight: 5860
description: Java जेएसपी/जेएसएफ एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम पर्यावरण पर पासवर्ड संरक्षित XLSB फ़ाइल अनलॉक करने के लिए नमूना कोड।
---
...
{{% blocks/products/pf/agp/code-block title="XLSB फ़ाइलों को C# के माध्यम से अनलॉक करें" offSpacer="" %}}
