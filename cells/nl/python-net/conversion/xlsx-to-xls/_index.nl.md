---
title: Converteer XLSX naar XLS Python via Python
description: Converteer XLSX naar XLS online gratis. Gratis online XLSX naar XLS Converter. Python XLSX naar XLS. XLSX naar XLS via Python.
...
{{% cells-convert title="Gratis app en voorbeeldcode om XLSX online naar XLS te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xls" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSX naar XLS te converteren" %}}

{{% blocks/products/pf/agp/text %}}

 Python-ontwikkelaars kunnen eenvoudig XLSX laden en converteren naar XLS in slechts een paar regels code.
