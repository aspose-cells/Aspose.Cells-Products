---
title:  Wstaw CheckBox (kontrolkę formularza) do programu Excel przy użyciu Python via .Net
weight: 30
description: Python via Kod źródłowy .Net umożliwiający wstawienie CheckBox (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić CheckBox (kontrolkę formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić CheckBox (kontrolkę formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj dodatku do kolekcji kształtów[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_check_box/#int-int-int-int-int-int) aby wstawić CheckBox (kontrolkę formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw CheckBox (kontrolka formularza) - Python via .Net" offSpacer="" %}}
