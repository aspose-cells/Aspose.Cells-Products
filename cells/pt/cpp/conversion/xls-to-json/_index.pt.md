...
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato JSON, permitindo o salvamento perfeito de dados XLS no formato JSON usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Converter XLS para JSON usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS a JSON em C++" %}}

exemplo a seguir demonstra como converter XLS em JSON em C++.
...
Precisa converter arquivos XLS para JSON programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para JSON com apenas algumas linhas de código.
...
1.  Converta XLS para JSON chamando o método Save().
