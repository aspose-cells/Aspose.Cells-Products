---
title: Java FODS hingga TXT - FODS hingga TXT Konverter
description: Aspose Unggul. Ubah FODS menjadi TXT dengan cepat dan mudah dengan Aspose.Cells. Java FODS menjadi TXT. Java Simpan FODS menjadi TXT. Simpan FODS sebagai 07611134 81 menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah FODS menjadi TXT di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi FODS menjadi TXT. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor FODS, TXT, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan FODS hingga TXT di Java" %}}

Contoh berikut menunjukkan cara mengonversi FODS menjadi TXT di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi FODS menjadi TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file FODS ke TXT secara terprogram? Pengembang Java dapat dengan mudah mengonversi FODS menjadi TXT hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah FODS menjadi TXT" %}}
{{% blocks/products/pf/agp/text %}}
