---
title: Konwertuj XLTX na XLSB za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltx-to-xlsb/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTX do formatu XLSB. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTX na XLSB w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLTX na XLSB w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTX przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSB).1. Plik XLSB zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSB w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLTX do XLSB C++" offSpacer="" %}}
