...
{{% blocks/products/pf/agp/content h2="How to Create TIFF in PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create TIFF file in PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PHP library to create TIFF file" %}}
