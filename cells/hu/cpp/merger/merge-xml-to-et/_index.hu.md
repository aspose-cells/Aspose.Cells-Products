...
description: Aspose Excel. C++ Aspose.Cells. XML egyesítése ET mentési formátumba. C++ XML kombinálása ET formátumba. XML egyesítése ET-hez a C++-ben. XML-egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse az XML-t az ET-hez a C++-ben" %}}
...
{{% cells-merger title="Mintakód az XML-nek az ET-hez való egyesítéséhez a C++-ben" InputFormat="xml" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
