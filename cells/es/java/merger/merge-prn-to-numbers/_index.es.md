---
title: Combinar PRN con NÚMEROS - Combinar PRN con NÚMEROS en Java
url: /es/java/merger/merge-prn-to-numbers/ 
description: AsposeExcel. Java Aspose.Cells. Combinar en línea gratis PRN a NUMBERS saveformat. Java Combinar formato PRN a NÚMEROS. Combinar PRN con NÚMEROS en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN con NUMBERS en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar PRN con NUMBERS en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar PRN con NUMBERS. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo NUMBERS. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que combina PRN con NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar PRN a NUMBERS en Java" InputFormat="prn" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN a NUMBERS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar PRN con NUMBERS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar PRN con NUMBERS" %}}
