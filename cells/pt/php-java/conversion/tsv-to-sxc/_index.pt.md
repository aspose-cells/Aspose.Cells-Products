---
title: Conversor PHP TSV para SXC - TSV para SXC
description: Aspose Excel. Converta TSV em SXC de forma rápida e fácil com Aspose.Cells. PHP TSV em SXC. PHP Salve TSV em SXC. Salve TSV como SXC usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter TSV em SXC via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em SXC programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em SXC em apenas algumas linhas de código.
...
1.  Converta TSV em SXC chamando o método save da pasta de trabalho.
