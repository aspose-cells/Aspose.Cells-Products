...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar ODS met Aspose.Cells. PHP MHTML naar ODS. PHP Bewaar MHTML naar ODS. Sla MHTML op als ODS met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar ODS te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar ODS converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar ODS.
...
1.  Converteer MHTML naar ODS door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van MHTML naar ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om MHTML naar ODS te converteren" %}}
