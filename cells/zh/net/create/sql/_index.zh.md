---
title: 创建SQL - 在C#中创建SQL文件
description: Aspose Excel。 C# 使用 Aspose.Cells 快速轻松地创建 SQL 文件。使用 C# 生成 SQL 文件。在 C# 中创建 SQL。C# SQL 创建器。
...
{{% blocks/products/pf/agp/content h2="如何在C#中创建SQL" %}}

{{% blocks/products/pf/agp/text %}}

开发人员只需几行代码即可轻松地在运行不同的报告应用程序中创建、加载、修改和转换 SQL 文件以进行数据处理。
...
1. 使用 Save 方法将工作簿保存为 SQL 文件。

{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 C# 中创建 SQL 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#库创建SQL文件" %}}
