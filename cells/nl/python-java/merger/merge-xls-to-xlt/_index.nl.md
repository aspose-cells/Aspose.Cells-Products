...
description: Aspose Excel. Python Aspose.Cells. Voeg XLS samen met het opslagformaat XLT. Python Combineer het formaat XLS met XLT. Voeg XLS samen met XLT in Python. XLS Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met XLT met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met XLT in Python" %}}
...
{{% cells-merger title="Voorbeeldcode om XLS samen te voegen met XLT in Python" InputFormat="xls" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLS samenvoegt met XLT via Python" %}}
