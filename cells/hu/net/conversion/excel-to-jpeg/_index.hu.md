...
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az EXCEL JPEG formátumba konvertálásához, lehetővé téve az EXCEL adatok zökkenőmentes mentését JPEG formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="EXCEL fájl mentése a JPEG-es számra a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet az EXCEL-t JPEG-re konvertálni a C#-ben.
...
1.  Alakítsd át az EXCEL-t JPEG formátumúra a Workbook.Save metódus meghívásával.
