...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar XLTM met Aspose.Cells. PHP OTS naar XLTM. PHP Bewaar OTS naar XLTM. Sla OTS op als XLTM met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar XLTM te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar XLTM converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar XLTM in slechts een paar regels code.
...
1.  Converteer OTS naar XLTM door de opslagmethode van Workbook aan te roepen.
