---
title:  Hur man ritar eller infogar en armbågspilform i Excel via Java
weight: 30
description: Rita eller infoga en armbågspil med Aspose.Cells' Java API utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Hur man infogar en armbågspilform i Excel-fil med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga armbågspilar i Excel-fil via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd[lägga till metod](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) för att infoga en form av en armbågspil i det valda kalkylbladet
...
{{% blocks/products/pf/agp/code-block title="Sätt i form av en armbågspil - Java" offSpacer="" %}}
