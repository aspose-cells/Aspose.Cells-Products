...
{{% blocks/products/pf/agp/content h2="Jak převést XLS na SVG pomocí C++" %}}
 ...
 K převodu XLS na SVG použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLS na SVG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLS pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavit (SVG) možnosti.1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor SVG v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLS na SVG C++" offSpacer="" %}}
