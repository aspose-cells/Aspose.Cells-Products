---
title: PHP XLT'den PRN'ye - XLT'den PRN'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile XLT'i hızlı ve kolay bir şekilde PRN'ye dönüştürün. PHP XLT'i PRN'ye dönüştürün. PHP XLT'i PRN'ye kaydedin. PHP kullanarak XLT'i PRN olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLT\'i PRN\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLT dosyalarını program aracılığıyla PRN'ye dönüştürmeniz mi gerekiyor? PHP geliştiricileri yalnızca birkaç satır kodla XLT'i kolayca yükleyebilir ve PRN'ye dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLT'i PRN'ye dönüştürün.
1.  XLT'in PRN'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLT\'i PRN\'ye dönüştürmek için PHP kütüphanesi" %}}
