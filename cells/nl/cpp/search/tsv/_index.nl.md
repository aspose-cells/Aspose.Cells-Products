---
title:  Zoek naar document TSV zonder het te openen via C++
weight: 930
description: C++ voorbeeldcode om woorden met een patroon te zoeken in het bestand TSV in de runtimeomgeving C++ voor 32-bits, 64-bits en 64-bits Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zoek naar formaten met TSV in C++" h2="Native en krachtige documentzoekfunctie (TSV) met behulp van server-side API\'s (Aspose.Cells for C++), zonder gebruik te maken van software zoals (Microsoft) of Adobe (PDF)." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe zoek ik naar bestand TSV met behulp van C++?" %}}

 Om het bestand TSV te zoeken, gebruiken we...
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om bestanden met nummer TSV te zoeken in de map C++" %}}
...
+ Laad bestand TSV met behulp van de Workbook-klasse.
...
{{% blocks/products/pf/agp/code-block title="Zoek naar bestanden met nummer TSV - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online TSV Zoek live demo\'s" sectionDescription=" Zoek nu naar tekst, woorden en zinsdelen in documenten met referentienummer TSV door onze website te bezoeken.[Live demo-website](https://products.aspose.app/cells/search). De live demo heeft de volgende voordelen" >}}
 ...
 Een door tabs gescheiden bestandsformaat (TSV) vertegenwoordigt gegevens die door tabs zijn gescheiden in platte tekst. Dit bestandsformaat, vergelijkbaar met CSV, wordt gebruikt om gegevens op een gestructureerde manier te organiseren voor import en export tussen verschillende applicaties. Het formaat wordt voornamelijk gebruikt voor het importeren/exporteren en uitwisselen van gegevens in spreadsheetprogramma's en databases. Elk record in een TSV-bestand staat op één regel tekst, waarbij elke veldwaarde wordt gescheiden door een tabteken. Het mediatype voor het TSV-bestandsformaat is tekst/door tabs gescheiden waarden.
