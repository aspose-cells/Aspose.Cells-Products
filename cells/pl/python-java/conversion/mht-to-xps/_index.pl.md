...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na XPS za pomocą Aspose.Cells. Python MHT na XPS. Python Zapisz MHT na XPS. Zapisz MHT jako XPS, używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem XPS w Python" %}}

Poniższy przykład ilustruje sposób konwersji MHT na XPS w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji MHT na XPS" %}}
