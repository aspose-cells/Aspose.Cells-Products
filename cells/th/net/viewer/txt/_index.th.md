...
weight: 8300
description: ซอร์สโค้ด C# เพื่อโหลด เรนเดอร์ และแสดงเอกสาร TXT บน .NET Framework, .NET Core, Mono หรือแพลตฟอร์ม Xamarin
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells ทำให้นักพัฒนาสามารถดูไฟล์ TXT ได้ง่ายด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/code-block title="รหัสตัวอย่าง C# เพื่อดูไฟล์ TXT" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API สามารถใช้เพื่อสร้าง แก้ไข แปลง และแสดงรูปแบบ Microsoft Excel เป็นรูปแบบต่างๆ นอกจากนี้ยังสามารถใช้สำหรับการสร้างแผนภูมิที่ครอบคลุม การรายงานที่ปรับขนาดได้ และการคำนวณที่เชื่อถือได้ภายในแอปพลิเคชันซอฟต์แวร์ Aspose.Cells เป็น API แบบสแตนด์อโลนและไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ OpenOffice
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="แอพดูฟรี TXT" sectionDescription=" ตรวจสอบการสาธิตสดของเราไปที่[วิว TXT](https://products.aspose.app/cells/viewer/txt) ด้วยสิทธิประโยชน์ดังต่อไปนี้" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" ดาวน์โหลดไฟล์ TXT จากลิงค์ หากจำเป็น" >}}
