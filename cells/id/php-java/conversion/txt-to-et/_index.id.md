---
title: Konverter PHP TXT ke ET - TXT ke ET
description: Aspose Excel. Solusi komprehensif ini menyediakan pendekatan terintegrasi penuh bagi pengembang PHP untuk mengkonversi TXT ke format ET, memungkinkan penyimpanan data TXT ke format ET dengan mudah menggunakan pustaka Aspose.Cells, semuanya melalui kode PHP yang efisien dan dapat disesuaikan.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TXT ke ET melalui PHP" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file TXT ke ET secara terprogram? Pengembang PHP dapat dengan mudah memuat & mengkonversi TXT ke ET hanya dengan beberapa baris kode.
...
1. Konversikan TXT ke ET dengan memanggil metode save dari Workbook.
1.  Dapatkan hasil konversi TXT ke ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Pustaka PHP untuk mengkonversi TXT ke ET" %}}
