---
title: XLSX'i PRN ile birleştir - XLSX'i C++'de PRN ile birleştir
url: /tr/cpp/merger/merge-xlsx-to-prn/ 
description: Aspose excel. C++ Aspose.Cells. XLSX'i PRN saveformat'a Ücretsiz Çevrimiçi Birleştirme. C++ XLSX'i PRN formatına birleştirin. XLSX'i C++'de PRN ile birleştir. XLSX Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLSX\'i C++ Online\'da PRN ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, XLSX'in Aspose.Cells for C++'de PRN ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLSX\'i C++\'de PRN ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xlsx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLSX\'i C++ aracılığıyla PRN\'ye Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLSX'i programlı olarak PRN ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLSX\'i PRN ile birleştirmek için C++ kitaplığı" %}}
