---
title:  Συγχώνευση SXC στο HTM via Java
url: /el/java/merger/merge-sxc-to-htm/ 
description: Συγχώνευση SXC στο HTM Online δωρεάν. Δωρεάν Online SXC to HTM Merger. Συγχώνευση SXC σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SXC στο HTM στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση SXC σε HTM σε απευθείας σύνδεση" InputFormat="sxc" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
