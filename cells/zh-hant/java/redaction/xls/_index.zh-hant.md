---
title: 搜索並替換 XLS 文檔 via Java 中的文本
weight: 7900
description: Java 示例代碼，用於編輯 JSP/JSF 應用程序和桌面應用程序的 Java 運行時環境中的 XLS 文件中的敏感信息。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="編輯 XLS Java 格式" h2="本機高性能 XLS 使用服務器端 Aspose.Cells for Java API 記錄敏感的編輯信息，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
