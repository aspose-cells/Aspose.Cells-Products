...
L'esempio seguente dimostra come unire XML a PRN in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 È necessario unire XML a PRN a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria C++ per unire XML a PRN" %}}
