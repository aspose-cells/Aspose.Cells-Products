...
Följ de enkla stegen för att slå samman HTM till SVG. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan till SVG-filen. Om du utvecklar kod i C++ blir detta enklare än det låter. Se C++ exempel som slår samman HTM till SVG.
...
Behöver du slå samman HTM till SVG programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotek för att slå samman HTM till SVG" %}}
