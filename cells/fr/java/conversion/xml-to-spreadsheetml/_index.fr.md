...
{{% blocks/products/pf/agp/content h2="Enregistrer le XML au format SPREADSHEETML dans Java" %}}

L'exemple suivant montre comment convertir du XML en SPREADSHEETML dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir du XML en SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en SPREADSHEETML par programmation ? Les développeurs Java peuvent facilement effectuer cette conversion en quelques lignes de code seulement.
