...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке CheckBox в файл Excel через номер C#" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) вставить флажок в выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставить флажок — C#" offSpacer="" %}}
