...
Trong Office 365, ghi chú dành cho chú thích, bạn có thể sử dụng mã C# sau để chèn và xóa ghi chú trong tệp ODS.

{{% blocks/products/pf/agp/code-block title="C# mã mẫu để Chèn và xóa ghi chú trong tệp ODS" offSpacer="" %}}
