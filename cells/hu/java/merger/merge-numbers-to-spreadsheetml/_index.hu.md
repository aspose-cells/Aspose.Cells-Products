---
title: NUMBERS egyesítése SPREADSHEETML-be – NUMBERS egyesítése SPREADSHEETML-be a Java-ben
url: /hu/java/merger/merge-numbers-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése NUMBERS SPREADSHEETML mentési formátumba. Java A SZÁMOK kombinálása SPREADSHEETML formátumba. A NUMBERS egyesítése SPREADSHEETML-be a Java-ben. NUMBERS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a NUMBERS-t a SPREADSHEETML-be a Java-es számon" %}}

A következő példa bemutatja, hogyan egyesítheti a NUMBERS-t a SPREADSHEETML-be a Aspose.Cells for Java számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a NUMBERS és a SPREADSHEETML egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SPREADSHEETML fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely egyesíti a NUMBERS-t a SPREADSHEETML-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online NUMBERS egyesítése SPREADSHEETML-be a Java-ben" InputFormat="numbers" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A NUMBERS egyesítése a SPREADSHEETML via Java számmal" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell NUMBERS számot SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a NUMBERS és a SPREADSHEETML egyesítéséhez" %}}
