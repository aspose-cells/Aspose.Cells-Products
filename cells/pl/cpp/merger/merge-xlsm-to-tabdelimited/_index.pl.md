---
title: Scal XLSM z TABDELIMITED - Połącz XLSM z TABDELIMITED w C++
url: /pl/cpp/merger/merge-xlsm-to-tabdelimited/ 
description: Aspose Excel. C++ Aspose.Cells. Scal XLSM do formatu zapisu TABDELIMITED. C++ Połącz XLSM w formacie TABDELIMITED. Scal XLSM z TABDELIMITED w C++. XLSM Scal.
...
{{% blocks/products/pf/agp/content h2="Scal XLSM z TABDELIMITED w C++" %}}

Poniższy przykład ilustruje sposób scalania XLSM z TABDELIMITED w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLSM z TABDELIMITED. Prześlij swoje pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku TABDELIMITED. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy XLSM z TABDELIMITED.
...
{{% blocks/products/pf/agp/content h2="Jak połączyć XLSM z TABDELIMITED przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć XLSM z TABDELIMITED? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLSM z TABDELIMITED" %}}
