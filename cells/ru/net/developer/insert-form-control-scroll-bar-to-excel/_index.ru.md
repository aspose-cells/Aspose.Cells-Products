---
title:  Вставить полосу прокрутки в Excel via .NET
weight: 90
...
{{% blocks/products/pf/agp/content h2="Как вставить полосу прокрутки в файл Excel с помощью C#" %}}
 ...
 Чтобы вставить полосу прокрутки в файл Excel, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке полосы прокрутки в файл Excel через C#" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addscrollbar)чтобы вставить полосу прокрутки в выбранный рабочий лист
