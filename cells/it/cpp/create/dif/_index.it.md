...
description: Aspose Excel. C++ Crea il file DIF in modo semplice e veloce con Aspose.Cells. Genera il file DIF utilizzando C++. Crea DIF in C++. C++ DIF Creatore.
...
1.  Salva la cartella di lavoro come file .dif utilizzando il metodo Save().
