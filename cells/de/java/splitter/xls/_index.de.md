...
{{% blocks/products/pf/agp/content h2="So teilen Sie die Datei XLS mit Java auf" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Aufteilen von XLS-Dateien in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Datei XLS aufteilen - Java" offSpacer="" %}}
