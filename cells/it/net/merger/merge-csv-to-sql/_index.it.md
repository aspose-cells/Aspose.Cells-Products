---
title: Unisci CSV a SQL - Combina CSV a SQL in C#
url: /it/net/merger/merge-csv-to-sql/ 
description: Aspose Excel. C# Aspose.Cells. Unisci online gratuito CSV al formato di salvataggio SQL. C# Combina CSV nel formato SQL. Unisci CSV a SQL in C#. CSV Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci CSV a SQL in C# online gratuitamente" %}}

L'esempio seguente mostra come unire CSV a SQL in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire CSV a SQL. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file SQL. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce CSV a SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire CSV a SQL in C#" InputFormat="csv" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire CSV a SQL tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Hai bisogno di unire CSV a SQL a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET per unire CSV a SQL" %}}
