---
title: 使用 Python via .Net 將 SVG 影像/圖示插入 Excel
weight: 200
description: Python via .Net 原始碼將 SVG 圖像/圖示插入 Excel。
...
{{< blocks/products/pf/i18n/upper-banner h1="使用 Python via .Net 將 SVG 影像/圖示插入 Excel" h2="使用 Aspose.Cells\' API 插入 SVG 圖像/圖標，無需任何軟體，如 Microsoft 或 Open Office、Adobe PDF 等。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via .Net 將 SVG 圖像/圖示插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via .Net 將 SVG 影像/圖示插入 Excel 檔案的步驟" %}}
...
+ 透過索引選擇工作表。
 使用形狀集合的新增[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/)在選定的工作表中插入圖示。
以 XLSX 格式儲存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入 SVG 圖像/圖示 - Python via .Net" offSpacer="" %}}
