...
{{% blocks/products/pf/agp/content h2="Sla TXT op in SVG in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar SVG in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar SVG of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar SVG? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar SVG met slechts een paar regels code.
