---
title: PHP XML을 숫자로 변환 - XML을 숫자로 변환하는 변환기
description: Aspose Excel. 이 포괄적인 솔루션은 PHP 개발자에게 XML을 NUMBERS 형식으로 변환하는 완벽하게 통합된 방식을 제공하여, 효율적이고 사용자 정의 가능한 PHP 코드를 통해 Aspose.Cells 라이브러리를 사용하여 XML 데이터를 NUMBERS 형식으로 원활하게 저장할 수 있도록 합니다.
...
{{% blocks/products/pf/agp/content h2="PHP에서 XML을 숫자로 저장" %}}

다음 예제는 PHP에서 XML을 숫자로 변환하는 방법을 보여줍니다.
...
{{% blocks/products/pf/agp/content h2="PHP를 이용하여 XML을 숫자로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

XML 파일을 프로그램적으로 숫자로 변환해야 하시나요? PHP 개발자는 단 몇 줄의 코드로 XML을 불러와 숫자로 쉽게 변환할 수 있습니다.
...
1.  Workbook의 save 메서드를 호출하여 XML을 숫자로 변환합니다.
1.  XML을 숫자로 변환한 결과를 가져오세요.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XML을 숫자로 변환하는 PHP 라이브러리" %}}
