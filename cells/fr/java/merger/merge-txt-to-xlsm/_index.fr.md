---
title:  Fusionner TXT à XLSM via Java
...
L'exemple suivant montre comment fusionner TXT à XLSM dans Java.
...
{{% cells-merger title="Application gratuite pour fusionner TXT à XLSM en ligne" InputFormat="txt" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
