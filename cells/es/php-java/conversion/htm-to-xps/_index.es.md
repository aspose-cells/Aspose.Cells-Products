---
title: Convertidor de PHP HTM a XPS - HTM a XPS
description: Aspose Excel. Esta solución integral ofrece a los desarrolladores PHP un enfoque totalmente integrado para convertir HTM al formato XPS, lo que permite guardar datos HTM sin problemas en el formato XPS mediante la biblioteca Aspose.Cells, todo mediante código PHP eficiente y personalizable.
...
¿Necesitas convertir archivos HTM a XPS mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a XPS con solo unas pocas líneas de código.
...
1.  Convierta HTM a XPS llamando al método de guardado del libro de trabajo.
1.  Obtenga el resultado de la conversión de HTM a XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir HTM a XPS" %}}
