...
{{% blocks/products/pf/agp/content h2="วิธีแทรก RadioButton (การควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก RadioButton (การควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) เพื่อแทรก RadioButton (การควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก RadioButton(การควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
