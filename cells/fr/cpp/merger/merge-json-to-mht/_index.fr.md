---
title: Fusionner JSON à MHT - Combiner JSON à MHT dans C++
url: /fr/cpp/merger/merge-json-to-mht/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion gratuite en ligne JSON au format de sauvegarde MHT. C++ Combinez JSON au format MHT. Fusionner JSON à MHT en C++. JSON Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner JSON à MHT en C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner JSON à MHT dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner JSON à MHT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier MHT. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne JSON en MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner JSON à MHT en C++" InputFormat="json" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner JSON à MHT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner JSON avec MHT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner JSON à MHT" %}}
