---
title: Voeg SXC samen met POWERPOINT - Combineer SXC met POWERPOINT in C++
url: /nl/cpp/merger/merge-sxc-to-powerpoint/ 
description: Aspose Excel. C++ Aspose.Cells. Voeg SXC samen naar POWERPOINT-opslagformaat. C++ Combineer SXC naar POWERPOINT-formaat. Voeg SXC samen met POWERPOINT in C++. SXC Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg SXC samen met POWERPOINT in C++" %}}

Het volgende voorbeeld laat zien hoe u SXC samenvoegt met POWERPOINT in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om SXC samen te voegen met POWERPOINT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een POWERPOINT-bestand. Als u code ontwikkelt in C++, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C++ waarin SXC wordt samengevoegd met POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om SXC samen te voegen met POWERPOINT in C++" InputFormat="sxc" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe u SXC samenvoegt met POWERPOINT via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SXC programmatisch samenvoegen met POWERPOINT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om SXC samen te voegen met POWERPOINT" %}}
