---
title: Convertisseur PHP JSON à XLSX - JSON à XLSX
description: Aspose Exceller. Convertissez JSON en XLSX rapidement et facilement avec Aspose.Cells. PHP JSON en XLSX. PHP Enregistrez JSON en XLSX. Enregistrez JSON sous XLSX en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Convertir JSON en XLSX en utilisant PHP" %}}
 ...
 Comment convertir JSON en XLSX ? Avec la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir JSON en XLSX par programme avec quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. PHP Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer le JSON au XLSX en PHP" %}}
...
Besoin de convertir les fichiers JSON en XLSX par programme ? Les développeurs PHP peuvent facilement charger et convertir JSON en XLSX en quelques lignes de code.
...
1.  Convertissez JSON en XLSX en appelant la méthode de sauvegarde du classeur.
