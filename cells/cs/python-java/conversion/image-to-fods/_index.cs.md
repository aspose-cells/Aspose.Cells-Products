...
{{% blocks/products/pf/agp/content h2="Převeďte IMAGE na FODS pomocí Python" %}}
...
Následující příklad ukazuje, jak převést IMAGE na FODS v Python.
