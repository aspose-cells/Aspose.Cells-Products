...
Het volgende voorbeeld laat zien hoe u XLTM converteert naar XLT in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLTM naar XLT te converteren" %}}
