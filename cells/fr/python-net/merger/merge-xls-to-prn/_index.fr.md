...
description: Aspose Exceller. Python Aspose.Cells. Fusionner XLS au format de sauvegarde PRN. Python Combinez XLS au format PRN. Fusionner XLS avec PRN dans Python. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS avec PRN en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS avec PRN dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner XLS avec PRN dans Python" InputFormat="xls" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS avec PRN via Python" %}}
