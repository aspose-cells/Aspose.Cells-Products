...
description: Aspose เอ็กเซล. แปลง XLTM เป็น JPG อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Python XLTM เป็น JPG Python บันทึก XLTM เป็น JPG. บันทึก XLTM เป็น JPG โดยใช้ Python
...
{{% blocks/products/pf/agp/content h2="บันทึก XLTM เป็น JPG ใน Python" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLTM เป็น JPG ใน Python
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง XLTM เป็น JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="jpg" IsLandingPage="true" language="pythonjava" %}}
