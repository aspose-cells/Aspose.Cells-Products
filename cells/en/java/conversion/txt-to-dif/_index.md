...
url: /java/conversion/txt-to-dif/
...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to DIF Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TXT to DIF via Java" %}}
