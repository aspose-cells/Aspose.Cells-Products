---
title: C# XLTX a WORD-hoz – Online XLTX a WORD konverterhez
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Ingyenes online C# A XLTX konvertálása WORD mentési formátumba. C# XLTX WORD formátumba. Mentse el a XLTX számot a C# WORD-ba.
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLTX-et a WORD-ba a C#-ben online ingyen" %}}

A következő példa bemutatja, hogyan lehet a XLTX-et WORD-ra konvertálni a C#-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLTX WORD-ra konvertálásához. Töltse fel a XLTX fájlt, majd egyszerűen mentse el WORD fájlként. Mind a XLTX olvasáshoz, mind a WORD-íráshoz használhat teljesen minősített fájlneveket. A kimenet WORD tartalma és formázása megegyezik az eredeti XLTX számú dokumentuméval.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ingyenes alkalmazás és mintakód a XLTX WORD Online konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTX konvertálása WORD-ra a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLTX fájlt programozottan WORD-ba kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és konvertálhatják a XLTX-et WORD-ra, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a XLTX-et WORD-ba a Workbook.Save metódus meghívásával.
1.  Szerezze meg a XLTX konvertálási eredményt WORD-ra.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX konvertálásához WORD-ba" %}}
