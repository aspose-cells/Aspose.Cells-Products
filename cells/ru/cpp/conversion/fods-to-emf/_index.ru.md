...
Нужно программно конвертировать файлы FODS в EMF? Разработчики C++ могут легко преобразовать FODS в EMF всего за несколько строк кода.
