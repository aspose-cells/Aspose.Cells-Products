...
weight: 9030
description: Código de muestra Java para editar o ver metadatos del formato XLSM en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{% blocks/products/pf/agp/content h2="Cómo extraer metadatos de XLSM utilizando Java" %}}

 Para obtener metadatos del archivo XLSM, usaremos
...
+ Guarde la información de metadatos XLSM
