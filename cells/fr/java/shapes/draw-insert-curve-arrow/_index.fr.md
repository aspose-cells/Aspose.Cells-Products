...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une forme de flèche incurvée dans le fichier Excel via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Insérer forme de flèche courbée - Java" offSpacer="" %}}
