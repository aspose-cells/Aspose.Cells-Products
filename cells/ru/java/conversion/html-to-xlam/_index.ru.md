...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в XLAM, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTML в XLAM в Java" %}}
...
Нужно программно преобразовать файлы HTML в XLAM? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в XLAM всего несколькими строками кода.
