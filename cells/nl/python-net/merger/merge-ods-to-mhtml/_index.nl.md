...
url: /nl/python-net/merger/merge-ods-to-mhtml/ 
...
Het volgende voorbeeld laat zien hoe u ODS kunt samenvoegen met MHTML in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u ODS programmatisch samenvoegen tot MHTML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
