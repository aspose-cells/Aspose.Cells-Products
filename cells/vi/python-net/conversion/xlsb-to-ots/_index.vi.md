...
Ví dụ sau minh họa cách chuyển đổi XLSB thành OTS trong Python via NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Các nhà phát triển Python có thể dễ dàng tải và chuyển đổi XLSB thành OTS chỉ bằng một vài dòng mã.
