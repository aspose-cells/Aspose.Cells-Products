---
title:  Aggiungere l'annotazione XLSM tramite C++
weight: 2860
description: C++ codice di esempio per eliminare le annotazioni di formato XLSM su C++ Runtime Environment per Windows 32 bit, Windows 64 bit e Linux 64 bit.
---
...
Per annotare il file XLSM, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per aggiungere commenti in XLSM tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Caricare il file Excel XLSM utilizzando l'oggetto di classe IWorkbook.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API può essere utilizzato per creare, modificare, convertire e rendere Microsoft i formati Excel in diversi formati. Inoltre, può essere utilizzato per grafici completi, report scalabili e calcoli affidabili all'interno di applicazioni software. Aspose.Cells è un API autonomo e non richiede alcun software come Microsoft o OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aggiungi / rimuovi annotazione da XLSM tramite l\'app online" sectionDescription=" Elimina subito le annotazioni del documento XLSM visitando il nostro[Sito web di dimostrazioni dal vivo](https://products.aspose.app/cells/annotation). La demo dal vivo ha i seguenti vantaggi" >}}
