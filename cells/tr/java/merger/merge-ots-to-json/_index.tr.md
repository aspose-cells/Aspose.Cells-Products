---
title: OTS'yi JSON via Java ile birleştirin
...
Aşağıdaki örnek, OTS'nin Java'de JSON ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="OTS\'yi hatta JSON ile birleştirmek için Ücretsiz Uygulama" InputFormat="ots" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
