---
title: قم بتحويل الأرقام إلى DIF C++
description: قم بتحويل الأرقام إلى DIF عبر الإنترنت مجانًا. أرقام مجانية على الإنترنت لتحويل DIF. C++ أرقام إلى DIF. أرقام إلى DIF عبر C++.
keywords: Convert NUMBERS, NUMBERS Converter, NUMBERS to PDF, NUMBERS to Word, NUMBERS to PPT, NUMBERS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="حول الأرقام إلى DIF عبر C++" h2="أرقام عالية الأداء لتحويل DIF باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن للمطورين C++ بسهولة تحويل الأرقام إلى DIF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف NUMBERS باستخدام Factory :: CreateIWorkbook.
1. قم بتحويل الأرقام إلى DIF باستدعاء طريقة Save ().
