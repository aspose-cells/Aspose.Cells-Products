...
description: C# का उपयोग करके XLSM में नोट्स डालें। .NET एप्लिकेशन के भीतर नोट्स डालने के लिए API उदाहरण कोड का उपयोग करें।
...
Office 365 में, नोट्स एनोटेशन के लिए हैं, आप XLSM फ़ाइल में नोट्स डालने और हटाने के लिए निम्नलिखित C# कोड का उपयोग कर सकते हैं।
