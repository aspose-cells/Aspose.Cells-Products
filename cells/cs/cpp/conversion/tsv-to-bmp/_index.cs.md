...
description: Aspose Excel. Převeďte TSV na BMP rychle a snadno pomocí Aspose.Cells. C++ TSV na BMP. C++ Ušetřete TSV na 197 3481761 jako 197 348161 C++ 481 pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Uložit TSV až BMP v C++" %}}

Následující příklad ukazuje, jak převést TSV na BMP v C++.
...
{{% cells-convert title="Ukázkový kód pro převod TSV na BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="bmp" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést TSV na BMP přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory TSV na BMP programově? Vývojáři C++ mohou snadno převést TSV na BMP v několika řádcích kódu.
...
1.  Převeďte TSV na BMP voláním metody Save().
