---
title: Sloučit JPG s WORD - Sloučit JPG s WORD v C++
url: /cs/cpp/merger/merge-jpg-to-word/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit JPG do formátu uložení WORD. C++ Zkombinujte JPG do formátu WORD. Sloučit JPG na WORD v C++. Sloučit JPG.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG na WORD v C++" %}}

Následující příklad ukazuje, jak sloučit JPG s WORD v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do WORD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení JPG do WORD v C++" InputFormat="jpg" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPG na WORD přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit JPG na WORD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do WORD" %}}
