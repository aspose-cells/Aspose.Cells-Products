...
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format XLS au format PPTX, permettant un enregistrement transparent des données XLS au format PPTX à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS au lieu de PPTX dans C#" %}}
...
Besoin de convertir les fichiers XLS en PPTX par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en PPTX en quelques lignes de code seulement.
