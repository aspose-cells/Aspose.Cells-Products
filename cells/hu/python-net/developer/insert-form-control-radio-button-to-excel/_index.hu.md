---
title:  Illessze be a RadioButtont (Űrlapvezérlőt) az Excelbe a Python via .Net használatával
weight: 60
description: Python via .Net forráskód a RadioButton (Űrlapvezérlő) beillesztéséhez az Excelbe.
---
...
{{% blocks/products/pf/agp/content h2="RadioButton (Űrlapvezérlő) beszúrása Excel fájlba a Python via .Net használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A RadioButton (Űrlapvezérlő) beszúrásának lépései Excel-fájlba a Python via .Net használatával" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjtemény hozzáadását[módszer](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) egy RadioButton (Űrlapvezérlő) beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Rádiógomb beszúrása (Űrlapvezérlő) - Python via .Net" offSpacer="" %}}
