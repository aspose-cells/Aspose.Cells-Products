---
title: PHP OTS إلى BMP - OTS إلى BMP محول
description: Aspose اكسل. قم بتحويل OTS إلى BMP بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى BMP. PHP احفظ OTS إلى BMP. احفظ OTS كـ BMP باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى BMP في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى BMP. هذا حل برمجي احترافي لاستيراد وتصدير OTS وBMP والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى BMP عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى BMP برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى BMP في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى BMP عن طريق استدعاء طريقة حفظ المصنف.
