...
{{% blocks/products/pf/agp/text %}}
 ...
 Pengembang C++ dapat dengan mudah mengubah EXCEL menjadi XLSX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file EXCEL menggunakan Factory::CreateIWorkbook.
1. Ubah EXCEL menjadi XLSX dengan memanggil metode Save().
