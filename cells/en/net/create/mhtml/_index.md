...
{{% blocks/products/pf/agp/content h2="How to Create MHTML in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create MHTML file in C#." offSpacer="" %}}
