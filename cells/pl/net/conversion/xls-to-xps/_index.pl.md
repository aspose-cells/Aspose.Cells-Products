---
title: C# XLS do XPS - XLS do XPS Konwerter
description: Aspose Excel. Konwertuj XLS na XPS szybko i łatwo za pomocą Aspose.Cells. C# XLS na XPS. C# Zapisz XLS na XPS. Zapisz XLS jako 0761113 481 pod numerem C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do XPS w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na XPS w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLS na XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xps" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na XPS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na XPS? Programiści .NET mogą łatwo załadować i przekonwertować XLS na XPS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na XPS" %}}
