---
title: 將 MHT 合併到 XLSB - 將 MHT 合併到 C# 中的 XLSB
url: /zh-hant/net/merger/merge-mht-to-xlsb/ 
description: Aspose Excel。 C# Aspose.Cells。將MHT合併至XLSB儲存格式。 C# 將 MHT 合併為 XLSB 格式。將 MHT 合併到 C# 中的 XLSB。MHT 合併。
keywords: [Aspose Excel., C# Aspose.Cells., Merge MHT to XLSB in C#., C# Merge MHT to xlsb., C# Combine MHT to XLSB., MHT Merge]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過 C# 將 MHT 合併到 XLSB" h2="高速 C# 庫，用於將 MHT 合併到 XLSB。使用我們的 Excel 轉換 API 在 C# 中開發高級、平台獨立的軟體。這是導入和匯出 Excel, CSV, OpenOffice, PDF, HTML, image 和許多其他 Excel 的專業軟體解決方案格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="MHT" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將MHT合併到C#中的XLSB" %}}

以下範例示範如何將MHT合併為Aspose.Cells for .NET中的XLSB。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 合併到 XLSB。上傳文件，呼叫 Workbook.Combine 方法合併文件，然後將其儲存到 XLSB 文件。如果您在 C# 中開發程式碼，這會比聽起來更簡單。請參閱 C# 將 MHT 合併為 XLSB 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 MHT 合併到 C# 中的 XLSB 的範例程式碼" InputFormat="mht" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 MHT 合併到 XLSB" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 MHT 合併到 XLSB 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
