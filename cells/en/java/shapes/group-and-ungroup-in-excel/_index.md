---
title: Group And Ungroup Shapes in Excel via Java
weight: 360
...
{{% blocks/products/pf/agp/content h2="How to Group And Ungroup Shapes in Excel File Using sJava" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Group And Ungroup Shapes in Excel file via Java" %}}
...
+  Use the [group method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#group-com.aspose.cells.Shape---) to group shapes in the selected worksheet
+  Use the [ungroup method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#ungroup-com.aspose.cells.GroupShape-) to ungroup shapes in the selected worksheet
