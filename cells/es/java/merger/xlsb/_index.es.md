---
title:  Fusionar XLSB Archivos via Java
weight: 4840
description: Código de muestra Java para combinar documentos XLSB en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionar formatos XLSB en Java" h2="Fusión de documentos XLSB nativa mediante API Java del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
+ guarde el archivo XLSB combinado en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Fusionar archivos XLSB - Java" offSpacer="" %}}
