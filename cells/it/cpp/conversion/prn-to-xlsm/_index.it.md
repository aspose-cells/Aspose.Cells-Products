...
description: Aspose Excel. Converti il PRN in XLSM in modo rapido e semplice con Aspose.Cells. C++ PRN in XLSM. C++ Salva PRN in XLSM. Salva PRN come XLSM utilizzando C++.
...
{{% blocks/products/pf/agp/content h2="Salva il PRN allo XLSM in C++" %}}

L'esempio seguente mostra come convertire il PRN in XLSM in C++.
...
È necessario convertire i file PRN in XLSM a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in XLSM in poche righe di codice.
...
1.  Converti PRN in XLSM chiamando il metodo Save().
1.  Ottieni il risultato della conversione da PRN a XLSM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C++ per convertire il PRN in XLSM" %}}
