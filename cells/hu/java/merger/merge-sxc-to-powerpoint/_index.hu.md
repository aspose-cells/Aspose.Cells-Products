---
title: A SXC egyesítése a POWERPOINT-hoz – a SXC-es szám egyesítése a POWERPOINT-hez a Java-es helyen
url: /hu/java/merger/merge-sxc-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés SXC POWERPOINT mentési formátumba. Java A SXC kombinálása POWERPOINT formátumba. A SXC egyesítése a Java-es POWERPOINT-tal. SXC Egyesítés.
...
A következő példa bemutatja, hogyan egyesítheti a SXC-es számot a POWERPOINT-tal a Aspose.Cells-es for Java-ben.
...
{{% cells-merger title="Ingyenes online a SXC egyesítéséhez POWERPOINT a Java-ben" InputFormat="sxc" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A SXC és a POWERPOINT via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SXC-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
