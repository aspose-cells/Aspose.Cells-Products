...
url: /de/cpp/merger/merge-htm-to-md/ 
description: Aspose Excel. C++ Aspose.Cells. Kostenloses Online-Merge-HTM-zu-MD-Speicherformat. C++ Kombinieren Sie das HTM-Format mit dem MD-Format. HTM mit MD in C++ zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie HTM mit MD in C++ kostenlos online zusammen" %}}

Das folgende Beispiel zeigt, wie HTM in Aspose.Cells for C++ mit MD zusammengeführt wird.
...
{{% cells-merger title="Kostenlos online, um HTM in MD unter C++ zusammenzuführen" InputFormat="htm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie HTM über C++ mit MD zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie HTM programmgesteuert mit MD zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="C++-Bibliothek zum Zusammenführen von HTM mit MD" %}}
