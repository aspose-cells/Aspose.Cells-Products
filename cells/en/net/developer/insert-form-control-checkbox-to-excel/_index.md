...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) to insert a CheckBox(Form control) in the selected worksheet
