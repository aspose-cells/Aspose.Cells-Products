...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer des flèches de bloc dans un fichier Excel à l\'aide de Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Insérer des flèches de bloc - Python via .Net" offSpacer="" %}}
