...
weight: 60
description: C# исходный код для вставки RadioButton в Excel на платформах .NET Framework, .NET Core, Mono или Xamarin.
---
...
{{% blocks/products/pf/agp/content h2="Как вставить RadioButton в файл Excel, используя C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для вставки файла RadioButton в Excel через C#" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addradiobutton) чтобы вставить RadioButton в выбранный рабочий лист
