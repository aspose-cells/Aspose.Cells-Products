---
title:  JSON を PPTX via Java に結合
url: /ja/java/merger/merge-json-to-pptx/ 
description: JSON を PPTX にオンラインで無料で結合します。無料オンラインJSONからPPTX合併。 JSON を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、JSON を Java の PPTX にマージする方法を示しています。
...
{{% cells-merger title="オンラインでJSONをPPTXにマージする無料アプリ" InputFormat="json" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
