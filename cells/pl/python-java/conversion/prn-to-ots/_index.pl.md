...
description: Aspose Excel. Szybko i łatwo przekonwertuj PRN na OTS za pomocą Aspose.Cells. Python PRN na OTS. Python Zapisz PRN w OTS. Zapisz PRN jako OTS, używając numeru Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj PRN na OTS za pomocą Python" %}}
 ...
 Jak przekonwertować PRN na OTS? Dzięki bibliotece Aspose.Cells for Python możesz łatwo programowo przekonwertować PRN na OTS za pomocą kilku linijek kodu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Zapisz PRN w OTS pod numerem Python" %}}

Poniższy przykład ilustruje konwersję PRN na OTS w Python.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować PRN na OTS poprzez Python" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji PRN na OTS" %}}
