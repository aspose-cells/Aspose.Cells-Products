...
description: Sample C++ conversion code for XLS document to XLTM format. Programmers can use this source code for batch XLS to XLTM conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLS to XLTM C++ Conversion Source Code" offSpacer="" %}}
