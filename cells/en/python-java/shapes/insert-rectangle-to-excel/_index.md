...
{{% blocks/products/pf/agp/content h2="How to Insert Rectangle into Excel File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Rectangle to Excel file via Python" %}}
...
+  Use the shapecollection's [add method](https://apireference.aspose.com/cells/java/com.aspose.cells/shapecollection#addRectangle(int,%20int,%20int,%20int,%20int,%20int)) to insert a Rectangle in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert Rectangle - Python" offSpacer="" %}}
