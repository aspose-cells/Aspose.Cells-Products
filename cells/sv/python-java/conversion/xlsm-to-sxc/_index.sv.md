---
title: Konvertera XLSM till SXC via Python
url: /sv/python-java/conversion/xlsm-to-sxc/
description: Exempelkod för konvertering av xlsm till sxc Python. Använd API exempelkod för batch-xlsm-filer till sxc-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till SXC med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till SXC via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLSM-filer till SXC på bara några rader kod.
