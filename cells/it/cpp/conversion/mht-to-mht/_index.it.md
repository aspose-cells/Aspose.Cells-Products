...
{{% cells-convert title="Codice di esempio per convertire MHT in MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="mht" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Come convertire MHT in MHT tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file MHT in MHT a livello di codice? C++ gli sviluppatori possono convertire facilmente MHT in MHT in poche righe di codice.
...
1.  Converti MHT in MHT chiamando il metodo Save().
