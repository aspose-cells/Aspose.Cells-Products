...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar ScrollBar en un archivo Excel a través de C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[agregar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addscrollbar)para insertar una barra de desplazamiento en la hoja de trabajo seleccionada
