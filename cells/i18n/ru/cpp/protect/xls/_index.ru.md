---
title: Защитите и заблокируйте документ XLS через C++ 
weight: 8760
url: /ru/cpp/protect/xls/ 
description: Пример кода C++ для блокировки файла XLS с помощью пароля в C++ среде выполнения для 32-разрядной, 64-разрядной и Linux 64-разрядной версии.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Шифрование файлов XLS с помощью C++" h2="Защищайте паролем электронные таблицы Excel, включая формат XLS, с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
1. Загрузите файл XLS с помощью класса IWorkbook1. Используйте метод Protect(..) с ProtectionType и Password1. Сохраните защищенный XLS-файл методом Save().
