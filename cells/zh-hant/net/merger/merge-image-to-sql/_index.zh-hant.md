---
title: 將 IMAGE 合併到 SQL - 將 IMAGE 合併到 SQL 中 C#
url: /zh-hant/net/merger/merge-image-to-sql/ 
description: Aspose Excel。 C# Aspose.Cells。免費在線將圖像合併為 SQL 保存格式。 C# 將IMAGE 合併為SQL 格式。將 IMAGE 合併到 C# 中的 SQL。IMAGE 合併。
...
{{% blocks/products/pf/agp/content h2="在線免費將IMAGE合併為SQL C#" %}}

以下示例演示如何將 Aspose.Cells for .NET 中的 IMAGE 合併到 SQL。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 IMAGE 合併到 SQL。上傳文件，調用Workbook.Combine方法合併文件，然後保存到SQL文件。如果您在 C# 中開發代碼，這會比聽起來更簡單。請參閱 C# 將 IMAGE 合併到 SQL 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將 IMAGE 合併到 SQL 中 C#" InputFormat="png" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 IMAGE 合併到 SQL" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 IMAGE 合併到 SQL？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 將 IMAGE 合併到 SQL 的庫" %}}
