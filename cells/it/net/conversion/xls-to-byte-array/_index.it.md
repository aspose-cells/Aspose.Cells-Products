...
weight: 7690
description: C# Codice di esempio per la conversione da XLS a Byte Array. Utilizzare questo codice per la conversione da Excel XLS a Byte Array all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLS in array di byte tramite C#" h2="Conversione nativa e ad alte prestazioni Microsoft Excel XLS in array di byte o viceversa per l\'elaborazione dei dati dei fogli di calcolo utilizzando le API lato server .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array è utile per l'elaborazione o l'archiviazione dei dati. Puoi convertire il file XLS in Byte Array così come un file**Array di byte a XLS** documento utilizzando la lingua C#. Per convertire XLS in array di byte, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 È facile per gli sviluppatori caricare e convertire i file XLS in array di byte per ulteriori attività di manipolazione in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1.  Includere lo spazio dei nomi nel file di classe
1.  Carica l'input XLS File utilizzando la cartella di lavoro
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra XLS nell\'array di byte C# Conversione" offSpacer="" %}}
