...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLTM na GIF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLTM pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavit možnosti (GIF).1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor GIF v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu XLTM na GIF C++" offSpacer="" %}}
