...
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato WORD, permitindo o salvamento perfeito de dados ODS no formato WORD usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a WORD em C#" %}}

exemplo a seguir demonstra como converter ODS em WORD em C#.
...
Precisa converter arquivos ODS em WORD programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em WORD em apenas algumas linhas de código.
...
1.  Converta ODS para WORD chamando o método Workbook.Save.
