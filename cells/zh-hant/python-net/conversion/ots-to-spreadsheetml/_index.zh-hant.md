...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 SPREADSHEETML。Python OTS 到 SPREADSHEETML。 Python 將 OTS 儲存到 SPREADSHEETML。使用 Python 將 OTS 儲存為 SPREADSHEETML。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Python 中的 OTS 轉換為 SPREADSHEETML" h2="用於將 OTS 轉換為 SPREADSHEETML 的高速 Python 庫。使用我們的 Excel 轉換 API 在 Python 中開發高階、平台獨立的軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將 OTS 儲存到 SPREADSHEETML 中的 Python" %}}

以下範例示範如何將 Python via NET 中的 OTS 轉換為 SPREADSHEETML。
...
{{% blocks/products/pf/agp/content h2="Python 將 OTS 轉換為 SPREADSHEETML 的函式庫" %}}
