---
title: Inserte el control ActiveX en Excel usando Python via .Net
weight: 10
description: Python via Código fuente .Net para insertar Control ActiveX en Excel.
...
{{% blocks/products/pf/agp/content h2="Cómo insertar un control ActiveX en un archivo Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar un control ActiveX en un archivo Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el complemento de la colección de formas.[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_active_x_control/#aspose.cells.drawing.activexcontrols.ControlType-int-int-int-int-int-int) para insertar un control ActiveX en la hoja de trabajo seleccionada.
