---
title: Μετατροπή MHTML σε TSV μέσω C#

description: Δείγμα κώδικα για μετατροπή mhtml σε tsv C#. Χρησιμοποιήστε API παράδειγμα κώδικα για ομαδικά αρχεία mhtml σε μετατροπή tsv εντός VB.NET, Asp.NET ή οποιασδήποτε εφαρμογής που βασίζεται σε .NET.
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε MHTML σε TSV χρησιμοποιώντας το C#" %}}

 Για να μετατρέψουμε το MHTML σε TSV, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή MHTML σε TSV μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν αρχεία MHTML σε TSV σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου MHTML με μια παρουσία του βιβλίου εργασίας1. Καλέστε τη μέθοδο Workbook.Save1. Περάστε τη διαδρομή εξόδου με την επέκταση TSV ως παράμετρο1. Ελέγξτε την καθορισμένη διαδρομή για το αρχείο TSV που προκύπτει
...
{{% cells-convert title="Δωρεάν εφαρμογή και δείγμα κώδικα για μετατροπή MHTML σε TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="tsv" IsLandingPage="true" %}}
