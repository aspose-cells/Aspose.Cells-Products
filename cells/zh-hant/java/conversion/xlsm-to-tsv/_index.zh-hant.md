---
title: Java XLSM 至 TSV - XLSM 至 TSV 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 XLSM 轉換為 TSV。Java XLSM 為 TSV. Java 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Java。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 XLSM 轉換為 Java 中的 TSV" h2="高速Java庫，用於將XLSM轉換為TSV。這是一個專業的軟體解決方案，用於導入和導出XLSM、TSV和使用Java的許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
以下範例示範如何將 Java 中的 XLSM 轉換為 TSV。
...
{{% cells-convert title="將 XLSM 轉換為 TSV 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何轉換 XLSM 為 TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 XLSM 檔案轉換為 TSV 嗎？ Java開發人員只需幾行程式碼即可輕鬆將XLSM轉換為TSV。
