---
title: Sloučit HTM s MHTML - Sloučit HTM s MHTML v C++
url: /cs/cpp/merger/merge-htm-to-mhtml/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma sloučit HTM do MHTML saveformat. C++ Zkombinujte HTM do formátu MHTML. Sloučit HTM na MHTML v C++. HTM Sloučit.
...
Následující příklad ukazuje, jak sloučit HTM s MHTML v Aspose.Cells for C++.
...
{{% cells-merger title="Online zdarma ke sloučení HTM na MHTML v C++" InputFormat="htm" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM na MHTML přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit HTM na MHTML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
