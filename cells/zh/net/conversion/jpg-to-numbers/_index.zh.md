---
title: C# JPG 转数字 - JPG 转数字转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 JPG 转换为 NUMBERS 格式，从而能够使用 Aspose.Cells 库将 JPG 数据无缝保存为 NUMBERS 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 JPG 保存为数字 C#" %}}

以下示例演示如何将 JPG 转换为数字 C#。
{{% blocks/products/pf/agp/text %}}

按照以下简单步骤即可将 JPG 文件转换为 NUMBERS 文件。上传您的 JPG 文件，然后将其另存为 NUMBERS 文件。读取 JPG 文件和写入 NUMBERS 文件时，您都可以使用完整的文件名。输出的 NUMBERS 文件的内容和格式将与原始 JPG 文档完全相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 JPG 转换为数字的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="numbers" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 JPG 转换为数字" %}}

{{% blocks/products/pf/agp/text %}}

需要通过编程方式将 JPG 文件转换为 NUMBERS 格式吗？.NET 开发人员只需几行代码即可轻松加载 JPG 文件并将其转换为 NUMBERS 格式。
...
1. 调用 Workbook.Save 方法将 JPG 转换为 NUMBERS。
1. 获取 JPG 到 NUMBERS 的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 库用于将 JPG 转换为数字" %}}
