---
title: PHP XLSM ～ XLTX - XLSM ～ XLTX コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XLSM を XLTX にすばやく簡単に変換します。PHP XLSM から XLTX。PHP XLSM から XLTX に保存します。PHP を使用して、XLSM を XLTX として保存します。
...
{{% blocks/products/pf/agp/content h2="PHP 経由で XLSM を XLTX に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSM ファイルをプログラムで XLTX に変換する必要がありますか? PHP 開発者は、わずか数行のコードで XLSM を簡単にロードして XLTX に変換できます。
