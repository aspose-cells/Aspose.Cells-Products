...
description: Aspose Excel. C# Aspose.Cells. Sloučit PRN do formátu uložení XLSB. C# Zkombinujte PRN do formátu XLSB. Sloučit PRN na XLSB v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na XLSB v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení PRN s XLSB v C#" InputFormat="prn" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
