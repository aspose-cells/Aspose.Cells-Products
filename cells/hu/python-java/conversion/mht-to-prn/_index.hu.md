...
description: Aspose Excel. A Aspose.Cells segítségével gyorsan és egyszerűen konvertálja az MHT-t PRN-re. Python MHT-t PRN-re. Python MHT mentése PRN-be. Mentse az MHT-t PRN-ként a Python használatával.
...
{{% blocks/products/pf/agp/content h2="Konvertálja az MHT-t PRN-re a Python használatával" %}}

 Hogyan konvertálhatom az MHT-t PRN-re? A Aspose.Cells for Python könyvtárral egyszerűen konvertálhatja az MHT-t PRN-re programozottan néhány sornyi kóddal.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mentse az MHT-t a PRN-be a Python számon" %}}

A következő példa bemutatja, hogyan lehet az MHT-t PRN-re konvertálni a Python-ben.
...
{{% cells-convert title="Mintakód az MHT PRN-vé konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="prn" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Az MHT konvertálása PRN-re a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia az MHT fájlokat PRN-re? A Python fejlesztők egyszerűen betölthetik és konvertálhatják az MHT-t PRN-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja az MHT-t PRN-re a Workbook.save metódus hívásával.
1.  Szerezze meg az MHT átalakítás eredményét PRN-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python könyvtár az MHT PRN-re konvertálásához" %}}
