---
title: دمج PRN إلى ETT - ادمج PRN مع ETT في C#
url: /ar/net/merger/merge-prn-to-ett/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني عبر الإنترنت PRN إلى ETT saveformat. C# قم بدمج PRN إلى تنسيق ETT. دمج PRN إلى ETT في C#. PRN دمج.
...
{{% blocks/products/pf/agp/content h2="دمج PRN في ETT في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج PRN مع ETT في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج PRN في ETT. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف ETT. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج PRN إلى ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج PRN مع ETT في C#" InputFormat="prn" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج PRN مع ETT عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج PRN مع ETT برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج PRN إلى ETT" %}}
