...
{{% blocks/products/pf/agp/content h2="Μετατρέψτε το SPREADSHEETML σε ET στο Python" %}}
...
Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε SPREADSHEETML σε ET στο Python via NET.
