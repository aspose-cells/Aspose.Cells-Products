...
{{< blocks/products/pf/i18n/upper-banner h1="Объединить форматы TXT в Java" h2="Встроенное слияние документов TXT с использованием серверных Java API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Как объединить файлы TXT с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению файлов TXT в Java" %}}
...
+ Загрузите первый файл TXT с экземпляром класса Workbook.
+ Загрузите второй документ TXT с экземпляром класса Workbook.
+ Объединить файлы с помощью метода Combine().
+ сохранить объединенный файл TXT по указанному пути
...
{{% blocks/products/pf/agp/code-block title="Объединение файлов TXT – Java" offSpacer="" %}}

```cs
// Откройте первый TXT-файл.
Workbook txtFile1 = new Workbook("chartsFileWithPath.txt");

// Определите вторую исходную книгу.
// Откройте второй файл TXT.
