...
{{< blocks/products/pf/i18n/upper-banner h1="XLTX\'i C++ aracılığıyla PDF\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı XLTX\'ten PDF\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, XLTX dosyasını yalnızca birkaç satır kodla kolayca PDF'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak XLTX dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (PDF) dosya uzantısıyla iletin.1. PDF dosyası belirtilen yola kaydedilecektir.1. PDF dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="XLTX\'ten PDF\'ye C++ Dönüştürme Kaynak Kodu" offSpacer="" %}}
