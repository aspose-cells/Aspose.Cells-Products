---
title: Java HTML až XLTX - HTML až XLTX Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu formátu HTML do formátu XLTX, což umožňuje bezproblémové ukládání dat HTML do formátu XLTX pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte HTML na XLTX v Java" h2="Vysokorychlostní knihovna Java pro převod HTML na XLTX. Toto je profesionální softwarové řešení pro import a export HTML, XLTX a mnoha dalších formátů s použitím Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte HTML na XLTX v Java" %}}

Následující příklad ukazuje, jak převést číslo HTML na XLTX v kódu Java.
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory HTML na XLTX? Vývojáři Java mohou snadno převést HTML na XLTX pomocí několika řádků kódu.
...
1.  Převeďte HTML na XLTX voláním metody Workbook.save.
1.  Získejte výsledek převodu HTML na XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod HTML na XLTX" %}}
{{% blocks/products/pf/agp/text %}}
