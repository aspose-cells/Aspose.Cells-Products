---
title:  แทรก TextBox ลงใน Excel ผ่าน C++
weight: 60
description: โค้ดตัวอย่าง C++ เพื่อแทรก TextBox ในไฟล์ Excel บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก TextBox ลงในไฟล์ Excel โดยใช้ C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก TextBox เข้าไฟล์ Excel ผ่าน C++" %}}

การสร้างอินสแตนซ์ของวัตถุสมุดงาน (หรือ->โหลดไฟล์ XLSX พร้อมเส้นทางแบบเต็ม)
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#aabfa692515c324008ab417a43fed206c) เพื่อแทรกสมการรูปร่างในแผ่นงานที่เลือก
