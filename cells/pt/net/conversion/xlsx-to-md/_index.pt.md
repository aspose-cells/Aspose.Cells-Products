---
title: C# XLSX para MD - Online XLSX para conversor de MD
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter XLSX para MD saveformat. C# XLSX para o formato MD. Salve XLSX em MD C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSX para MD em C#" h2="Biblioteca C# de alta velocidade para converter XLSX em MD. Esta é uma solução de software profissional para importar e exportar XLSX, MD e muitos outros formatos em .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Salve XLSX em MD em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter XLSX para MD em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX em MD. Carregue seu arquivo XLSX e simplesmente salve-o como arquivo MD. Para leitura de XLSX e gravação de MD, você pode usar nomes de arquivo totalmente qualificados. O conteúdo e a formatação do MD de saída serão idênticos ao documento original XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter XLSX em MD online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para MD programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter XLSX em MD em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para converter XLSX para MD" %}}
