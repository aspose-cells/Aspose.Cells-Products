---
title: Java aracılığıyla JSON'u XPS'ye dönüştürün 
weight: 7860

description: JSON biçimi için XPS dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada XPS'e aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla JSON\'u XPS\'ye dönüştürün" h2="JSON\'u, ek araçlar veya kitaplıklar gerektirmeden Java aracılığıyla XPS formatına aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak JSON\'u XPS\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/code-block title="JSON\'dan XPS\'e Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
// elde edilen dosyayı JSON-TO-XPS formatında kaydedin
