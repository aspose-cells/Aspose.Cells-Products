---
title: Convertir XLS en JSON via Java 
weight: 9680
url: /fr/java/conversion/xls-to-json/ 
description: Exemple de code de conversion Java pour le format XLS en fichier JSON. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers JSON dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLS en JSON via Java" h2="Conversion XLS vers JSON Java pour convertir une ou plusieurs pages en JSON à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en JSON en utilisant Java" %}}

 Afin de rendre XLS en JSON, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs peuvent facilement convertir un fichier XLS en JSON en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier XLS avec une instance de la classe Workbook1. Créez une plage de données à exporter à l'aide de la méthode Cells.createRange1. Appelez la méthode JsonUtility.exportRangeToJson avec des références de Range & ExportRangeToJsonOptions1. Écrire les données String JSON dans le fichier via la méthode BufferedWriter.write
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'utiliser l'exemple de code, assurez-vous que vous disposez des prérequis suivants.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLS vers JSON Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion XLS vers JSON" sectionDescription="[Convertir XLS en JSON](https://products.aspose.app/cells/conversion/xls-to-json) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier XLS, il sera converti instantanément en JSON." >}}
