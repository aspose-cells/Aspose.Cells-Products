---
title:  Gráfico de documento XLSM para imagens via .NET 
weight: 5100

description: C# código-fonte para desenhar e converter gráfico ou diagrama em arquivo XLSM em plataformas .NET Framework, .NET Core, Mono ou Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Gráficos de arquivos XLSM para imagens em C#" h2="Gráficos de documentos XLSM nativos e de alto desempenho para conversão de imagens usando APIs do lado do servidor, sem o uso de nenhum software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter gráficos XLSM em imagens usando C#" %}}
 ...
 Para converter gráficos XLSM, usaremos
...
{{% blocks/products/pf/agp/code-block title="Gráfico de conversão de arquivos XLSM - C#" offSpacer="" %}}
