...
description: Aspose Excel. A PNG számot gyorsan és egyszerűen IMAGE-re alakíthatja át a Aspose.Cells-es számmal. Java PNG IMAGE-re. Java Mentse el a PNG számot az IMAGE-ba. Mentse el a PNG-et KÉP néven a Java használatával.
...
{{% blocks/products/pf/agp/content h2="A PNG konvertálása IMAGE-re a Java használatával" %}}
 ...
 Hogyan konvertálhatom át a PNG-et IMAGE-re? A Aspose.Cells for Java könyvtárral könnyedén konvertálhatja a PNG-et programozottan IMAGE-re néhány sor kóddal.[Aspose.Cells for Java](https://products.aspose.com/cells/java)képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Java Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez. A legújabb verziót közvetlenül a webhelyről töltheti le[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) és telepítse a Maven alapú projekten belül a következő konfigurációk hozzáadásával a pom.xml fájlhoz.
...
{{% blocks/products/pf/agp/content h2="Mentse el a PNG számot az IMAGE számára a Java címen" %}}
...
{{% cells-convert title="Mintakód a PNG IMAGE formátumú konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="png" IsLandingPage="true" language="java" %}}
