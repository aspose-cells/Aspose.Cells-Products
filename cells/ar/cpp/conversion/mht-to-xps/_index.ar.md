---
title: تحويل C++ MHT إلى XPS - تحويل MHT إلى XPS
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل MHT إلى تنسيق XPS، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق XPS باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى XPS في C++" %}}

يوضح المثال التالي كيفية تحويل MHT إلى XPS في C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل MHT إلى XPS. قم بتحميل ملف MHT الخاص بك، ثم احفظه ببساطة كملف XPS. لكل من قراءة MHT وكتابة XPS، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق الإخراج XPS مطابقًا لمستند MHT الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="نموذج كود لتحويل MHT إلى XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى XPS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى XPS برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى XPS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XPS عن طريق استدعاء دالة Save().
1. احصل على نتيجة تحويل MHT إلى XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل MHT إلى XPS" %}}
