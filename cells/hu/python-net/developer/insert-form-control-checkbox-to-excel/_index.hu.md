---
title:  Illessze be a CheckBoxot (Űrlapvezérlőt) az Excelbe a Python számon keresztül
weight: 30
description: Python forráskód a CheckBox (Űrlapvezérlő) beillesztéséhez az Excelbe.
---
...
{{% blocks/products/pf/agp/content h2="A jelölőnégyzet (űrlapvezérlő) beszúrása Excel-fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A CheckBox (Űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python-es számon keresztül" %}}
...
+ Használja a shapecollection hozzáadási módszerét egy CheckBox (Űrlapvezérlő) beillesztéséhez a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Jelölőnégyzet beszúrása (Űrlapvezérlő) - Python" offSpacer="" %}}
