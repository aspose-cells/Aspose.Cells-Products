---
title: Hợp nhất SPREADSHEETML với HTM - Hợp nhất SPREADSHEETML với HTM trong Java
url: /vi/java/merger/merge-spreadsheetml-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí SPREADSHEETML sang định dạng lưu HTM. Java Kết hợp định dạng SPREADSHEETML sang HTM. Hợp nhất SPREADSHEETML với HTM trong Java. Hợp nhất SPREADSHEETML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất SPREADSHEETML với HTM trong Java Trực tuyến miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất SPREADSHEETML với HTM trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất SPREADSHEETML với HTM. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp HTM. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất SPREADSHEETML với HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất SPREADSHEETML với HTM trong Java" InputFormat="xml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất SPREADSHEETML với HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất SPREADSHEETML với HTM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất SPREADSHEETML với HTM" %}}
