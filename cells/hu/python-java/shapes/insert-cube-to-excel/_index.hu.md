---
title:  Helyezze be a Cube-ot az Excelbe a Python számon keresztül
weight: 10
description: Python forráskód a Cube Excelbe való beillesztéséhez.
---
...
{{% blocks/products/pf/agp/content h2="Kocka beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A Cube Excel-fájlba való beszúrásának lépései a Python-es számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)Kocka beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Kocka beszúrása - Python" offSpacer="" %}}
