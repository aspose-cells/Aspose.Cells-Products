---
title:  Zoek naar document XLSX zonder het te openen via C++
weight: 9280
description: C++ voorbeeldcode om woorden met een patroon te zoeken in het bestand XLSX in de runtimeomgeving C++ voor 32-bits, 64-bits en 64-bits Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zoek naar formaten met XLSX in C++" h2="Native en krachtige documentzoekfunctie (XLSX) met behulp van server-side API\'s (Aspose.Cells for C++), zonder gebruik te maken van software zoals (Microsoft) of Adobe (PDF)." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe zoek ik naar bestand XLSX met behulp van C++?" %}}

 Om het bestand XLSX te zoeken, gebruiken we...
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om bestanden met nummer XLSX te zoeken in de map C++" %}}
...
+ Laad bestand XLSX met behulp van de Workbook-klasse.
...
{{% blocks/products/pf/agp/code-block title="Zoek naar bestanden met nummer XLSX - C++" offSpacer="" %}}
