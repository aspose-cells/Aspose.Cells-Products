---
title: Converti XLTX in XLS tramite l'applicazione C++ 
url: /it/cpp/conversion/xltx-to-xls/ 
description: Esempio di codice di conversione C++ per un documento XLTX in formato XLS. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLTX a XLS all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file XLTX in XLS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLTX usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XLS).1. Il file XLS verrà salvato nel percorso specificato.1. Apri il file XLS nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLTX a XLS C++" offSpacer="" %}}
