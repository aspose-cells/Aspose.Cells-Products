...
description: Aspose Excel. Converteer XLS snel en eenvoudig naar DOCX met Aspose.Cells. Python XLS naar DOCX. Python Bewaar XLS in DOCX. Bewaar XLS als 07611134 81 via Python.
...
{{% blocks/products/pf/agp/content h2="Converteer XLS naar DOCX in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLS t/m DOCX in Python" %}}

Het volgende voorbeeld laat zien hoe u XLS converteert naar DOCX in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLS naar DOCX te converteren" %}}
