---
title: รวม MHTML เข้ากับ OTS - รวม MHTML เข้ากับ OTS ใน Java
url: /th/java/merger/merge-mhtml-to-ots/ 
description: Aspose เอ็กเซล. Java Aspose.Cells รวม MHTML เข้าในเซฟฟอร์แมต OTS Java รวม MHTML เป็นรูปแบบ OTS รวม MHTML เข้า OTS ใน Java MHTML รวม
...
{{% blocks/products/pf/agp/content h2="รวม MHTML กับ OTS ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน MHTML เข้ากับ OTS ใน Aspose.Cells for Java
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม MHTML เข้ากับ OTS อัปโหลดไฟล์ของคุณ เรียกวิธี Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ OTS หากคุณพัฒนาโค้ดใน Java สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง Java ที่รวม MHTML เข้ากับ OTS

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="โค้ดตัวอย่างเพื่อรวม MHTML เป็น OTS ใน Java" InputFormat="mhtml" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวม MHTML เป็น OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม MHTML เข้ากับ OTS โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for Java](https://products.aspose.com/cells/java) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="Java ห้องสมุดเพื่อรวม MHTML เข้ากับ OTS" %}}
