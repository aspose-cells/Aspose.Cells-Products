---
title: XLS を SXC Python via Python に変換します
description: オンラインで無料でXLSをSXCに変換します。無料のオンラインXLSからSXCへのコンバーター。 Python XLS から SXC まで。Python 経由で XLS から SXC まで。
...
{{% cells-convert title="オンラインでXLSをSXCに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="sxc" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="XLSをSXCに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

 Python 開発者は、わずか数行のコードで XLS を簡単にロードして SXC に変換できます。
