---
title:  Pesquise o documento ODS sem abrir via .NET
weight: 160
description: Código-fonte C# para pesquisar palavras com padrão no arquivo ODS em .NET Framework, .NET Core, Mono ou plataformas Xamarin.
