...
url: /cs/cpp/merger/merge-image-to-word/ 
...
Následující příklad ukazuje, jak sloučit IMAGE do WORD v Aspose.Cells for C++.
...
Potřebujete programově sloučit IMAGE do WORD? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení IMAGE do WORD" %}}
