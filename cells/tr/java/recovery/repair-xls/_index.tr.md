---
title: Java Onarım xls - Bozuk xls Dosyasını Kurtarın ve Onarın
url: /tr/java/recovery/repair-xls/ 
description: Java Aspose.Cells. XLS'yi onarın. Xls dosyasını düzeltin. xls kurtarma aracı. xls'de bozulma. Xls verilerini geri yükleyin. xls dosya kurtarma. Bozuk xls dosyasını kurtarın.
...
{{% blocks/products/pf/agp/content h2="Java\'deki xls dosyası nasıl onarılır" %}}
...
{{% cells-recovery title="XLS dosyasını onarmak için örnek kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="java" %}}    
