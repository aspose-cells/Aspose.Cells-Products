---
title: C# JPEG - CSV - JPEG - CSV Átalakító
description: Aspose Excel. C# Aspose.Cells. JPEG-CSV C#-ben. C# A JPEG konvertálása CSV mentési formátumra. C# JPEG - CSV formátum. Mentse a JPEG számot a CSV C# számra.
...
{{% blocks/products/pf/agp/content h2="Mentse a JPEG-CSV számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a JPEG-et CSV-re konvertálni a C#-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a JPEG CSV-re konvertálásához. Töltse fel a JPEG fájlt, majd egyszerűen mentse el CSV fájlként. Mind a JPEG olvasáshoz, mind a CSV íráshoz használhat teljesen minősített fájlneveket. A CSV kimeneti tartalom és formázás megegyezik az eredeti JPEG dokumentummal.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mintakód a JPEG CSV-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="csv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A JPEG konvertálása CSV-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A JPEG fájlt programozottan CSV-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a JPEG-et CSV-re.
...
1.  Konvertálja a JPEG-et CSV-re a Workbook.Save metódus meghívásával.
1.  Szerezze meg a JPEG-es konverziós eredményt CSV-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a JPEG konvertálásához CSV-re" %}}
