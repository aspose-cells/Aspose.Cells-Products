---
title: C++ ODS เป็น PRN - ออนไลน์ ODS เป็น PRN Converter
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง ODS เป็น PRN saveformat C++ ODS เป็นรูปแบบ PRN บันทึก ODS ไปที่ PRN C++
...
{{% blocks/products/pf/agp/content h2="บันทึก ODS เป็น PRN ใน C++ ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง ODS เป็น PRN ใน C++
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อแปลง ODS เป็น PRN อัปโหลดไฟล์ ODS ของคุณ จากนั้นบันทึกเป็นไฟล์ PRN สำหรับทั้งการอ่าน ODS และการเขียน PRN คุณสามารถใช้ชื่อไฟล์แบบเต็มได้ เนื้อหาและการจัดรูปแบบ PRN เอาต์พุตจะเหมือนกับเอกสาร ODS ต้นฉบับ

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="แอพฟรีและโค้ดตัวอย่างเพื่อแปลง ODS เป็น PRN Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="prn" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง ODS เป็น PRN โดยเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลงของ ODS เป็น PRN
