...
{{% blocks/products/pf/agp/content h2="C#\'de PDF Nasıl Oluşturulur" %}}
...
{{% blocks/products/pf/agp/code-block title="Örnek kod, C#\'de PDF dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PDF dosyası oluşturmak için C# kitaplığı" %}}
