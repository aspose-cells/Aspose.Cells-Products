...
{{% blocks/products/pf/agp/content h2="Konwertuj EXCEL na XLS używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL do XLS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę z programu EXCEL na XLS w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu XLS? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu XLS za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA na XLS" %}}
{{% blocks/products/pf/agp/text %}}
