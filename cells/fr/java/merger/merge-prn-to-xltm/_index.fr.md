---
title: Fusionner PRN à XLTM - Combiner PRN à XLTM dans Java
url: /fr/java/merger/merge-prn-to-xltm/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite PRN au format de sauvegarde XLTM. Java Combine PRN au format XLTM. Fusionner PRN à XLTM dans Java. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à XLTM en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN avec XLTM dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN en XLTM. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier XLTM. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne PRN en XLTM.
...
{{% blocks/products/pf/agp/content h2="Comment fusionner PRN avec XLTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner PRN avec XLTM par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
