---
title:  Szerkessze vagy tekintse meg a XLSB dokumentum metaadatait a C++ számon keresztül
weight: 4820
description: C++ példakód a XLSB fájl metaadatainak szerkesztéséhez vagy megtekintéséhez a C++ Futókörnyezet Windows 32 bites, Windows 64 bites és 64 bites Linux számára.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="A XLSB metaadatok kibontása a C++ számon keresztül" h2="Készítse el saját C++-es alkalmazásait a XLSB fájlok metaadatok hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="A XLSB metaadatok beszerzése a C++ használatával" %}}
...
+ Töltsön be XLSB fájlt a CreateIWorkbookMetadata segítségével
