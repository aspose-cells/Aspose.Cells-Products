...
{{% blocks/products/pf/agp/content h2="在 Java 中免费在线合并 EXCEL 到 MHT" %}}

以下示例演示如何将 EXCEL 合并到 Java 中的 MHT。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 EXCEL 合并到 MHT。上传你的文件，调用Workbook.Combine方法合并文件，然后保存到MHT文件。如果您在 Java 中开发代码，这将比听起来更简单。请参阅将 EXCEL 合并到 MHT 的 Java 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="在线将 EXCEL 合并到 MHT 的免费应用程序" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
