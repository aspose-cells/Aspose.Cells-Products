...
{{% blocks/products/pf/agp/content h2="So versehen Sie ODS-Dateien mit Java mit einem Wasserzeichen" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen von Wasserzeichen zu ODS über Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Erstellen Sie ein neues Workbook-Objekt1. Wählen Sie das Arbeitsblatt über seinen Index aus1. Erstellen Sie eine Form und verwenden Sie ihre addTextEffect-Funktion1. Stellen Sie Farben, Transparenz und mehr ein1. Arbeitsmappe im ODS-Format speichern
...
{{% blocks/products/pf/agp/code-block title="ODS Wasserzeichen hinzufügen - Java" offSpacer="" %}}
