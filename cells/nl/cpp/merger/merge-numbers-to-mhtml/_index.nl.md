...
Het volgende voorbeeld laat zien hoe NUMBERS kan worden samengevoegd tot MHTML in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u NUMBERS programmatisch samenvoegen tot MHTML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
