---
title: Voeg SPREADSHEETML samen met ETT - Combineer SPREADSHEETML met ETT in C#
url: /nl/net/merger/merge-spreadsheetml-to-ett/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online SPREADSHEETML samenvoegen naar ETT-opslagformaat. C# Combineer SPREADSHEETML naar ETT-indeling. Voeg SPREADSHEETML samen met ETT in C#. SPREADSHEETML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg SPREADSHEETML samen met ETT in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u SPREADSHEETML kunt samenvoegen met ETT in Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis online om SPREADSHEETML samen te voegen met ETT in C#" InputFormat="xml" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML samen te voegen met ETT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SPREADSHEETML programmatisch samenvoegen met ETT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
