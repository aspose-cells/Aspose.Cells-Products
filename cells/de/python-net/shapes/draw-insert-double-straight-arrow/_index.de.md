---
title: Wie zeichne oder füge ich einen doppelten geraden Pfeil in Excel mit Python via .Net ein?
weight: 10
description: Python via .Net-Quellcode zum Zeichnen oder Einfügen eines doppelten geraden Pfeils in Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Fügen Sie mit Python via .Net einen doppelten geraden Pfeil in Excel ein" h2="Fügen Sie einen doppelten geraden Pfeil mit Aspose.Cells\' API ohne Software wie Microsoft oder Open Office, Adobe PDF usw. ein." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="So fügen Sie mit Python via .Net einen doppelten geraden Pfeil in eine Excel-Datei ein" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Einfügen eines doppelten geraden Pfeils in eine Excel-Datei mit Python via .Net" %}}
...
+ Wählen Sie Arbeitsblatt über seinen Index aus.
 + Verwenden Sie das Add der Shapecollection[Methode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) , um einen doppelten geraden Pfeil in das ausgewählte Arbeitsblatt einzufügen.
...
{{% blocks/products/pf/agp/code-block title="Doppelten geraden Pfeil einfügen - Python via .Net" offSpacer="" %}}
