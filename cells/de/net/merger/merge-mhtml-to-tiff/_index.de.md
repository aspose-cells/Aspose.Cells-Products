---
title: MHTML mit TIFF zusammenführen - MHTML mit TIFF in C# kombinieren
url: /de/net/merger/merge-mhtml-to-tiff/ 
description: Aspose Excel. C# Aspose.Cells. Kostenlose Online-Zusammenführung von MHTML zu TIFF im Speicherformat. C# Kombinieren Sie das Format MHTML mit dem Format TIFF. MHTML zu TIFF in C# zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie MHTML mit TIFF in C# kostenlos online zusammen" %}}

Das folgende Beispiel zeigt, wie MHTML mit TIFF in Aspose.Cells for .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um MHTML mit TIFF zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei TIFF. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das MHTML mit TIFF zusammenführt.
...
{{% blocks/products/pf/agp/content h2="So führen Sie MHTML über C# mit TIFF zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie MHTML programmgesteuert mit TIFF zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von MHTML mit TIFF" %}}
