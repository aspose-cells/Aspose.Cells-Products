...
+  Call the Save() method and pass the file name (full path) and format (ODS) as a parameter.
...
{{% blocks/products/pf/agp/code-block title="Merge CSV to ODS Files - C#" offSpacer="" %}}
