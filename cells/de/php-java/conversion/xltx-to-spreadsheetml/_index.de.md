...
description: Aspose Excel. Konvertieren Sie XLTX schnell und einfach in SPREADSHEETML mit Aspose.Cells. PHP XLTX in SPREADSHEETML. PHP Speichern Sie XLTX in SPREADSHEETML. Speichern Sie XLTX als SPREADSHEETML mit PHP.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLTX über PHP in SPREADSHEETML" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLTX-Dateien programmgesteuert in SPREADSHEETML konvertieren? PHP-Entwickler können XLTX in nur wenigen Codezeilen problemlos laden und in SPREADSHEETML konvertieren.
...
1.  Konvertieren Sie XLTX in SPREADSHEETML, indem Sie die Speichermethode der Arbeitsmappe aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLTX in SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von XLTX in SPREADSHEETML" %}}
