---
title: C++ XLT から ET - XLT から ET コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLTをETにすばやく簡単に変換します。C++ XLTをETに変換します。 C++ XLT を ET に保存します。 C++ を使用して XLT を ET として保存します。
...
{{% cells-convert title="XLTをETに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="et" IsLandingPage="true" language="cpp" %}}
