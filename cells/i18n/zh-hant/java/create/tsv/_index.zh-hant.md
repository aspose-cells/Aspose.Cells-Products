---
title: 通過 Java 創建 TSV 文件 
url: /zh-hant/java/create-tsv/ 
description: Java 用於生成 TSV 文檔的示例代碼。使用此代碼在基於 Java 的桌面或 Web 應用程序中創建 TSV 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 創建 TSV 文檔" h2="使用 Java 庫以編程方式創建本機和高性能 TSV（製表符分隔值）。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通過 Java 創建 TSV" %}}
...
1. 創建一個實例 [工作簿類](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook).1. 使用 getWorksheets.get() 方法訪問相關工作表。1. 選擇相關單元格，使用單元格名稱將值輸入所需的單元格，如 A1、B3 等。1. 使用 save() 方法將工作簿保存為 TSV 格式。
...
{{% blocks/products/pf/agp/code-block title="以下源代碼顯示瞭如何使用 Java 創建 TSV 文件。" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 一個 Excel 電子表格編程庫，能夠構建跨平台應用程序，能夠生成、修改、轉換、呈現和打印 TSV 文件。 JavaExcelAPI 不僅可以在電子表格格式之間進行轉換，它還可以將 Excel 文件呈現為圖像、PDF、HTML、ODS 等，從而使其成為以行業標準格式交換文檔的完美選擇。
