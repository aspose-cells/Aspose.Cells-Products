...
description: Aspose Excel. Convierta PRN a DIF rápida y fácilmente con Aspose.Cells. Python PRN a DIF. Python Guarde PRN en DIF. Guarde PRN como DIF usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PRN a DIF en Python" h2="Biblioteca Python de alta velocidad para convertir PRN a DIF. Esta es una solución de software profesional para importar y exportar PRN, DIF y muchos otros formatos utilizando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Guardar PRN al DIF en Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a DIF en Python.
...
{{% cells-convert title="Código de muestra para convertir PRN a DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="dif" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir PRN a DIF" %}}
