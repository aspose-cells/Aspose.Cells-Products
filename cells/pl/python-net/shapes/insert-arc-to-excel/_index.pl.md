---
title:  Wstaw Arc do programu Excel, używając Python via .Net
weight: 10
description: Python via Kod źródłowy .Net do wstawiania Arc do programu Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw Arc do programu Excel, używając Python via .Net" h2="Wstaw łuk, używając Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić łuk do pliku programu Excel za pomocą Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić Arc do pliku Excel przy użyciu Python via .Net" %}}
...
+ Użyj metody dodawania kolekcji kształtów, aby wstawić łuk w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw łuk - Python via .Net" offSpacer="" %}}
