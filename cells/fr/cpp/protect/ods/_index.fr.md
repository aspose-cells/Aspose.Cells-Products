...
weight: 10010
description: Exemple de code C++ pour verrouiller le fichier ODS à l'aide du mot de passe sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
...
1.  Charger le fichier ODS à l'aide de la classe IWorkbook
