...
description: Aspose Excel'de. Aspose.Cells ile EXCEL'i hızlı ve kolay bir şekilde MHT'ye dönüştürün. C# EXCEL'i MHT'ye dönüştürün. C# EXCEL'i MHT'ye kaydedin. C#'i kullanarak EXCEL'i MHT olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i C#\'de MHT\'ye kaydedin" %}}

Aşağıdaki örnek, C#'de EXCEL'in MHT'ye nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i MHT'ye dönüştürmek için kolay adımları izleyin. EXCEL dosyanızı yükleyin ve ardından MHT dosyası olarak kaydedin. Hem EXCEL okuma hem de MHT yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı MHT içeriği ve biçimlendirmesi orijinal EXCEL belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="EXCEL\'i MHT\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# aracılığıyla EXCEL\'i MHT\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını programlı olarak MHT'ye dönüştürmeniz mi gerekiyor? .NET geliştiriciler yalnızca birkaç satır kodla kolayca EXCEL'i MHT'ye yükleyebilir ve dönüştürebilir.
...
1. EXCEL'in MHT'ye dönüşüm sonucunu alın.
