...
url: /hu/cpp/merger/merge-mhtml-to-powerpoint/ 
...
A következő példa bemutatja, hogyan egyesítheti a MHTML-es számot a POWERPOINT-tal a Aspose.Cells-es for C++-ben.
...
{{% cells-merger title="Mintakód a MHTML egyesítéséhez a C++-es POWERPOINT-hoz" InputFormat="mhtml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="MHTML és a POWERPOINT egyesítése a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a MHTML és a POWERPOINT egyesítéséhez" %}}
