...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en XML à l\'aide de Python" %}}

 Pour convertir XLS en XML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en XML via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir des fichiers XLS en XML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier XLS avec une instance de Workbook1. Appelez la méthode Workbook.Save1. Passer le chemin de sortie avec l'extension XML comme paramètre1. Vérifier le chemin spécifié pour le fichier XML résultant
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" language="python" %}}
