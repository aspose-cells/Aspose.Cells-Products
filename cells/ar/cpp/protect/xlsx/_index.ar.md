---
title:  حماية وإغلاق XLSX المستند عبر C++
weight: 1140
description: C++ رمز مثال لقفل ملف XLSX باستخدام كلمة مرور على C++ بيئة وقت التشغيل لـ Windows 32 بت و Windows 64 بت و Linux 64 بت.
---
...
1.  قم بتحميل ملف XLSX باستخدام فئة IWorkbook
