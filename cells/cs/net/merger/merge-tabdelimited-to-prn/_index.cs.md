...
url: /cs/net/merger/merge-tabdelimited-to-prn/ 
...
Následující příklad ukazuje, jak sloučit TABDELIMITED do PRN v Aspose.Cells for .NET.
...
{{% cells-merger title="Ukázkový kód pro sloučení TABDELIMITED do PRN v C#" InputFormat="tsv" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit TABDELIMITED do PRN přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit TABDELIMITED do PRN programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu ke sloučení TABDELIMITED do PRN" %}}
