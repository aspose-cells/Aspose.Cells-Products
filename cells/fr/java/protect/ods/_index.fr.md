---
title: Protégez et verrouillez le document ODS via Java 
weight: 6360
url: /fr/java/protect/ods/ 
description: Java Exemple de code pour verrouiller le fichier ODS à l'aide d'un mot de passe sur Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crypter les fichiers ODS via Java" h2="Protégez par mot de passe les feuilles de calcul Excel, y compris le format ODS, à l\'aide de la bibliothèque .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment sécuriser le fichier ODS à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour protéger les fichiers ODS via Java" %}}
...
1. Charger le fichier ODS en instanciant la classe Workbook1. Utiliser la méthode protect(..) avec ProtectionType et Password1. Enregistrez le fichier ODS protégé par la méthode save()
