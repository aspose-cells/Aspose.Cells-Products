...
description: Aspose Excel. Μετατρέψτε το HTM σε POWERPOINT γρήγορα και εύκολα με το Aspose.Cells. C++ HTM σε POWERPOINT. C++ Αποθήκευση HTM στο POWERPOINT. Αποθηκεύστε το HTM ως POWERPOINT χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το HTM στο POWERPOINT στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή HTM σε POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="pptx" IsLandingPage="true" language="cpp" %}}
