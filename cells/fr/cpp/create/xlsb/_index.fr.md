---
title: Créer XLSB - Créer un fichier XLSB dans C++
description: Aspose Excel. C++ Créer un fichier XLSB. Créer XLSB C++. C++ XLSB Créateur. Créez XLSB dans C++. Générez le fichier XLSB en utilisant C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier XLSB dans C++" h2="Création de fichiers natifs et hautes performances XLSB par programmation sans Micorsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer XLSB dans C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers XLSB dans des applications de création de rapports en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
1.  Enregistrez le classeur en tant que fichier .xlsb à l'aide de la méthode Save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier XLSB dans C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="bibliothèque C++ pour créer le fichier XLSB" %}}
