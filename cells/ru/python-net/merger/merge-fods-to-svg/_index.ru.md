...
description: Aspose Эксель. Python Aspose.Cells. Объедините FODS и SVG в формате сохранения. Python Объедините форматы FODS и SVG. Объедините FODS и SVG в Python. FODS Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините FODS с SVG, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините FODS и SVG в Python." %}}

В следующем примере показано, как объединить FODS и SVG в Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Пример кода для объединения чисел FODS и SVG в Python" InputFormat="fods" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
