---
title: Mesclar XLT a ODS - Combinar XLT a ODS em C#
url: /pt/net/merger/merge-xlt-to-ods/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita XLT para ODS saveformat. C# Combine o formato XLT a ODS. Mesclar XLT a ODS em C#. XLT Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLT a ODS em C# Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar XLT a ODS em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLT a ODS. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo ODS. Se você desenvolver o código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla XLT a ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLT a ODS em C#" InputFormat="xlt" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLT a ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLT a ODS programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLT a ODS" %}}
