---
title:  حوّل PNG إلى JSON Java
description: قم بالتحويل من PNG إلى JSON عبر الإنترنت مجانًا. محول مجاني على الإنترنت من PNG إلى JSON. Java PNG إلى JSON. PNG إلى JSON via Java.
keywords: Convert PNG, PNG Converter, PNG to PDF, PNG to Word, PNG to PPT, PNG to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="حوّل PNG إلى JSON via Java" h2="PNG إلى JSON Java التحويل لتحويل صفحات مفردة أو متعددة إلى JSON باستخدام مكتبة Java المحلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل PNG إلى JSON عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل PNG إلى JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمطورين Java تحويل PNG إلى JSON بسهولة في بضعة أسطر من التعليمات البرمجية.
