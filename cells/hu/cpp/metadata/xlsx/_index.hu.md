...
{{< blocks/products/pf/i18n/upper-banner h1="XLSX metaadatok kibontása a következőn keresztül: C++" h2="Hozzon létre saját C++-alkalmazásokat XLSX-fájlok metaadatok hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="XLSX-metaadatok beszerzése a következővel: C++" %}}
...
+ Töltse be az XLSX fájlt a CreateIWorkbookMetadata segítségével
