---
title: Voeg XLT samen met TSV - Combineer XLT met TSV in Java
url: /nl/java/merger/merge-xlt-to-tsv/ 
description: Aspose Excel. Java Aspose.Cells. Voeg XLT samen met het opslagformaat TSV. Java Combineer het formaat XLT met TSV. Voeg XLT samen met TSV in Java. XLT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen met TSV in Java" %}}

Het volgende voorbeeld laat zien hoe u XLT samenvoegt met TSV in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLT samen te voegen met TSV. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand TSV. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld Java waarin XLT wordt samengevoegd met TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLT samen te voegen met TSV in Java" InputFormat="xlt" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLT samenvoegt met TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen met TSV? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLT samen te voegen met TSV" %}}
