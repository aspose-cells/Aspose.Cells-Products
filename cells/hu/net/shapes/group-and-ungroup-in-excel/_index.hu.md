---
title:  Alakzatok csoportosítása és csoportosítása az Excelben via .NET
weight: 340
description: C# Mintakód az alakzatok Excelben való csoportosításához és csoportosításához a .NET Library használatával. Használja ezt a kódot alakzatok csoportosításához vagy csoportosításához az MS Excelben a VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
keywords: [C# Aspose.Cells., c# group shapes., c# ungroup shapes., c# group and ungroup shapes., c# group or ungroup shapes]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Alakzatok csoportosítása és csoportosítása az Excelben via .NET" h2="Aspose.Cells\' API használatával különféle objektumokkal dolgozhat szoftver nélkül, például Microsoft vagy Open Office, Adobe PDF stb." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Alakzatok csoportosítása és csoportosítása Excel-fájlban a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az alakzatok csoportosításának és csoportosításának lépései az Excel-fájlban a C#-es számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja a[csoportos módszer](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/group/) formák csoportosításához a kiválasztott munkalapon
 + Használja a[csoportbontás módszere](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/) az alakzatok csoportosításához a kiválasztott munkalapon
...
{{% blocks/products/pf/agp/code-block title="Csoportosítási és csoportosítási formák - C#" offSpacer="" %}}
