---
title: Połącz LICZBY z EXCEL - Połącz LICZBY z EXCEL w Java
url: /pl/java/merger/merge-numbers-to-excel/ 
description: Aspose Excel. Java Aspose.Cells. Darmowe scalanie NUMERÓW online do formatu zapisu EXCEL. Java Połącz NUMERY do formatu EXCEL. Scal NUMBERS do EXCEL w Java. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z EXCEL w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić NUMBERS z EXCEL w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić NUMBERS z EXCEL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku EXCEL. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMBERS z EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online NUMBERS z EXCEL pod numerem Java" InputFormat="numbers" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić NUMERY z EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić NUMBERS z EXCEL? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do połączenia NUMBERS z EXCEL" %}}
