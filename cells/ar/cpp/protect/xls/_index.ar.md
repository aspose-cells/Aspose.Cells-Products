...
weight: 8760
description: C++ رمز المثال لقفل ملف XLS باستخدام كلمة المرور على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات حماية الملفات XLS عبر C++" %}}
...
1.  احفظ الملف XLS المحمي بطريقة Save()
