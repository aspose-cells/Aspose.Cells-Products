---
title: Sloučit HTM do EXCEL – Zkombinujte HTM do EXCELu v C++
url: /cs/cpp/merger/merge-htm-to-excel/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit HTM do formátu uložení EXCEL. C++ Kombinujte formát HTM s formátem EXCEL. Sloučit HTM do EXCELu v C++. Sloučit HTM.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM do EXCEL v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit HTM do EXCELu v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení HTM do EXCELu. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru EXCEL. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí HTM do EXCELu.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení HTM do EXCELu na čísle C++" InputFormat="htm" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM do EXCELu přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit HTM do EXCELu programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení HTM do EXCELu" %}}
