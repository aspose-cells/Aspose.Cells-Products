---
title:  Inserisci Spin Button (controllo modulo) in Excel tramite Python
weight: 40
description: Python codice sorgente per inserire Spin Button (controllo modulo) in Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci Spin Button (controllo modulo) in Excel tramite Python" h2="Inserisci oggetti utilizzando le API lato server senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire il pulsante Spin (controllo modulo) nel file Excel utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire Spin Button (controllo modulo) nel file Excel tramite Python" %}}
...
+ Usa il metodo add di shapecollection per inserire un pulsante Spin (controllo modulo) nel foglio di lavoro selezionato.
...
{{% blocks/products/pf/agp/code-block title="Inserisci il pulsante di rotazione (controllo del modulo) - Python" offSpacer="" %}}
