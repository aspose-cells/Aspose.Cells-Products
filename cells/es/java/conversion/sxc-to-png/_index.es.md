---
title: Convierte SXC a PNG a través de Java 
url: /es/java/conversion/sxc-to-png/ 
description: Ejemplo de código de conversión Java para formato SXC a archivo PNG. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a PNG dentro de cualquier aplicación basada en Web o Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte SXC a PNG a través de Java" h2="Conversión de SXC a PNG Java para convertir una o varias páginas a PNG mediante la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SXC a PNG usando Java" %}}

 Para renderizar SXC a PNG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SXC a PNG a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo SXC a PNG con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de SXC a PNG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de SXC a PNG" sectionDescription="[Convertir SXC a PNG](https://products.aspose.app/cells/conversion/sxc-to-png) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo SXC, se convertirá instantáneamente a PNG." >}}
