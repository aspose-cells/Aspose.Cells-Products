...
description: Aspose Exceller. Convertissez XML en SXC rapidement et facilement avec Aspose.Cells. Java XML en SXC. Java Enregistrez XML en SXC. Enregistrez XML sous SXC en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en SXC à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au SXC dans Java" %}}

L'exemple suivant montre comment convertir XML en SXC en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XML en SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en SXC par programme ? Les développeurs Java peuvent facilement convertir XML en SXC en quelques lignes de code seulement.
