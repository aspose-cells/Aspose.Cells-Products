---
title:  Sloučit XLSB do WORD přes Python
...
Následující příklad ukazuje, jak sloučit XLSB do WORD v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSB do WORD online" InputFormat="xlsb" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
