...
Besoin de convertir les fichiers MHTML en NUMBERS par programmation ? Les développeurs de C++ peuvent facilement convertir MHTML en NUMBERS en quelques lignes de code seulement.
...
1.  Convertissez MHTML en NUMBERS en appelant la méthode Save().
