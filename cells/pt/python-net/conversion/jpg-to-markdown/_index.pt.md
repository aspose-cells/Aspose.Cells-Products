...
O exemplo a seguir demonstra como converter JPG para MARKDOWN em Python via NET.
...
{{% blocks/products/pf/agp/content h2="Como converter JPG para MARKDOWN" %}}
