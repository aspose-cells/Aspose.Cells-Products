...
{{% blocks/products/pf/agp/content h2="Преобразование XML в XML с использованием C++" %}}
...
{{% blocks/products/pf/agp/content h2="Сохранение XML в XML в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в XML в файле C++.
...
Нужно программно преобразовать XML-файлы в XML? Разработчики, использующие код C++, могут легко преобразовать XML в XML всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для преобразования XML в XML" %}}
