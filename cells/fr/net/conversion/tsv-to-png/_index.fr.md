---
title: Convertir TSV en PNG via C#
url: /fr/net/conversion/tsv-to-png/
description: Exemple de code pour la conversion tsv en png C#. Utilisez API exemple de code pour la conversion par lots de fichiers tsv en png dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TSV en PNG via C#" h2="Exportez des feuilles de calcul Excel® au format PNG sur .NET Framework, .NET Core, Mono ou Xamarin Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TSV en PNG en utilisant C#" %}}
 ...
 Afin de convertir TSV en PNG, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers TSV au format PNG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier TSV avec une instance de Workbook1. Appelez la méthode Workbook.Save1. Passer le chemin de sortie avec l'extension PNG comme paramètre1. Vérifiez le chemin spécifié pour le fichier PNG résultant
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir TSV en PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="png" IsLandingPage="true" %}}
