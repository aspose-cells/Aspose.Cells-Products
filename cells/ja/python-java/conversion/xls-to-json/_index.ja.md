---
title: Python XLS ～ JSON - XLS ～ JSON コンバータ
description: Aspose エクセル。 XLS を Aspose.Cells ですばやく簡単に JSON に変換します。 Python XLS から JSON に変換します。 Python XLS を JSON に保存します。 XLS を 07611134 として保存しますPythonを使用して81。
