---
title: Fusionner EXCEL avec XLSX - Combiner EXCEL avec XLSX dans C#
url: /fr/net/merger/merge-excel-to-xlsx/ 
description: Aspose Excel. C# Aspose.Cells. Fusion gratuite en ligne EXCEL au format de sauvegarde XLSX. C# Combinez EXCEL au format XLSX. Fusionnez EXCEL avec XLSX dans C#. EXCEL Fusionnez.
...
{{% blocks/products/pf/agp/content h2="Fusionnez EXCEL avec XLSX en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner EXCEL avec XLSX dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner EXCEL en XLSX. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier XLSX. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne EXCEL en XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner EXCEL en XLSX en C#" InputFormat="xlsx" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner EXCEL avec XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner EXCEL avec XLSX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="bibliothèque .NET pour fusionner EXCEL avec XLSX" %}}
