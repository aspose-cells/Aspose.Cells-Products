---
title:  Sloučit MHTML Soubory via Java
weight: 4420
description: Java ukázkový kód pro spojení MHTML dokumentů na Java Runtime Environment pro JSP/JSF aplikace a desktopové aplikace.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sloučit MHTML formáty v Java" h2="Nativní slučování dokumentů MHTML pomocí rozhraní API Java na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro sloučení souborů MHTML v Java" %}}
...
+ Načtěte první soubor MHTML s instancí třídy Workbook.
+ Načtěte druhý dokument MHTML s instancí třídy Workbook.
+ Sloučit soubory pomocí metody Combined().
uložte sloučený soubor MHTML do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Sloučit soubory MHTML - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online MHTML Živá ukázka sloučení" sectionDescription=" Sloučit dokumenty MHTML právě teď návštěvou našeho[Webová stránka živé ukázky](https://products.aspose.app/cells/merger). Živé demo má následující výhody" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Stačí nahrát své soubory MHTML." >}}
