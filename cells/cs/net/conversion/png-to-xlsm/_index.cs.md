---
title: C# PNG až XLSM - PNG až XLSM Převodník
description: Aspose Excel. Převeďte PNG na XLSM rychle a snadno pomocí Aspose.Cells. C# PNG na XLSM. C# Ušetřete PNG na 197 3481761 jako 197 348161 C# 481 pomocí C#.
...
{{% blocks/products/pf/agp/content h2="Uložit PNG až XLSM v C#" %}}

Následující příklad ukazuje, jak převést PNG na XLSM v C#.
...
{{% cells-convert title="Ukázkový kód pro převod PNG na XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xlsm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést PNG na XLSM přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na XLSM programově? Vývojáři .NET mohou snadno načíst a převést PNG na XLSM v několika řádcích kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod PNG na XLSM" %}}
