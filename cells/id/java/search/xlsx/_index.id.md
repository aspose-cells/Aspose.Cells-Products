...
weight: 6780
description: Java contoh kode untuk mencari kata dengan pola di file XLSX di Java Runtime Environment untuk Aplikasi JSP/JSF dan Aplikasi Desktop.
---
...
+ Muat file XLSX dengan membuat instance objek Workbook.
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSX Cari Demo Langsung" sectionDescription=" Cari teks, kata, frase dalam dokumen XLSX sekarang dengan mengunjungi kami[Situs web Demo Langsung](https://products.aspose.app/cells/search). Demo langsung memiliki manfaat sebagai berikut" >}}
