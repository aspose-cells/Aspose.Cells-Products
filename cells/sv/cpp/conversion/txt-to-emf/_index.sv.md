...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera TXT-fil till EMF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda TXT-fil med Factory::CreateIWorkbook.1. Välj det första kalkylbladet.1. Ställ in (EMF) alternativ.1. Iterera genom varje sida av arket och rendera.1. Öppna EMF-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="TXT till EMF C++ omvandlingskälla" offSpacer="" %}}
