---
title:  XLS belgesini C++ üzerinden açmadan ara
weight: 4560
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı'ndaki XLS dosyasındaki desenli kelimeleri aramak için örnek kod.
...
+ Bir Çalışma Kitabı sınıfını başlatarak XLS dosyasını yükleyin.
...
+ Workbook::Save(...) yöntemini kullanarak XLS dosyasını kaydedin.
