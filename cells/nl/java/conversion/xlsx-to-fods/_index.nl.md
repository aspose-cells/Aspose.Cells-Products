...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in FODS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar FODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar FODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar FODS? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar FODS met slechts een paar regels code.
