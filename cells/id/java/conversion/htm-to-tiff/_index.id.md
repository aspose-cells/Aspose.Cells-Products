---
title: Java HTM ke TIFF - Konverter HTM ke TIFF
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi HTM ke format TIFF, memungkinkan penyimpanan data HTM yang lancar ke format TIFF menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan HTM ke TIFF di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi HTM ke TIFF. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor HTM, TIFF, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan HTM ke TIFF di Java" %}}

Contoh berikut menunjukkan cara mengkonversi HTM ke TIFF di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi HTM ke TIFF. Unggah file HTM Anda, lalu simpan saja sebagai file TIFF. Untuk pembacaan HTM dan penulisan TIFF Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran TIFF akan identik dengan dokumen HTM asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi HTM ke TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="tiff" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi HTM ke TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file HTM ke TIFF secara terprogram? Pengembang Java dapat dengan mudah mengkonversi HTM ke TIFF hanya dengan beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1.  Instal 'Aspose.Cells for Java'.
1.  Tambahkan referensi perpustakaan (impor perpustakaan) ke proyek Java Anda.
1.  Muat file HTM dengan instance dari kelas Workbook.
1.  Ubah HTM menjadi TIFF dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi HTM ke TIFF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi HTM ke TIFF" %}}
{{% blocks/products/pf/agp/text %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/conversion/htm-to-html/" name="HTM KE HTML" description="Bahasa Markup Teks Hiper" >}}
