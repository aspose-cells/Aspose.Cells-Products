---
title:  Объединить SPREADSHETML в XLSX через C++
...
В следующем примере показано, как объединить SPREADSHEETML с XLSX в C++.
