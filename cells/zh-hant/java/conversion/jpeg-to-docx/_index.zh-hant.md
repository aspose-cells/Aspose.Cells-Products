...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 JPEG 轉換為 DOCX。Java JPEG 為 DOCX. Java 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Java。
...
以下範例示範如何將 Java 中的 JPEG 轉換為 DOCX。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 JPEG 轉換為 DOCX。上傳您的 JPEG 文件，然後只需將其另存為 DOCX 文件。對於 JPEG 讀取和 DOCX 寫入，您可以使用完全限定的檔案名稱。輸出 DOCX 內容和格式將與原始 JPEG 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 JPEG 轉換為 DOCX 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="docx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何轉換 JPEG 為 DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 JPEG 檔案轉換為 DOCX 嗎？ Java開發人員只需幾行程式碼即可輕鬆將JPEG轉換為DOCX。
