---
title: Konversikan SXC ke XLTM melalui Java 
url: /id/java/conversion/sxc-to-xltm/ 
description: Contoh Java kode konversi untuk format SXC ke file XLTM. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke XLTM dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan SXC ke XLTM melalui Java" h2="Konversi SXC ke XLTM Java untuk mengonversi satu atau beberapa halaman ke XLTM menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi SXC ke XLTM Menggunakan Java" %}}

 Untuk merender SXC ke XLTM, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi SXC ke XLTM melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file SXC ke XLTM hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file SXC dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi XLTM & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file XLTM yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="SXC ke XLTM Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file SXC dalam contoh Workbook
Workbook book = new Workbook("template.sxc");
// simpan SXC sebagai XLTM
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi SXC ke XLTM" sectionDescription="[Konversikan SXC ke XLTM](https://products.aspose.app/cells/conversion/sxc-to-xltm) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file SXC Anda, itu akan langsung dikonversi ke XLTM." >}}
