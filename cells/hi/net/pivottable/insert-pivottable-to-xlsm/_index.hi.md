---
title:  C# के माध्यम से Microsoft Excel XLSM फ़ाइलों में PivotTable डालें
weight: 7690
description: C# .NET लाइब्रेरी का उपयोग करके XLSM में PivotTable जोड़ने के लिए नमूना कोड। VB.NET, Asp.NET या किसी भी .NET आधारित एप्लिकेशन के भीतर XLSM फ़ाइल में PivotTable डालने के लिए इस कोड का उपयोग करें।
