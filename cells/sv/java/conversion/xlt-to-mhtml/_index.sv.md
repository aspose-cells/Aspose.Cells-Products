---
title: Konvertera XLT till MHTML via Java 
weight: 7390

description: Exempel Java-konverteringskod för XLT-format till MHTML-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till MHTML inom alla webb- eller skrivbordsbaserade Javaapplikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLT till MHTML med Java" %}}

 För att rendera XLT till MHTML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLT till MHTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLT-fil till MHTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLT-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med MHTML-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande MHTML-filen
...
{{% blocks/products/pf/agp/code-block title="XLT till MHTML Java omvandlingskällkod" offSpacer="" %}}
