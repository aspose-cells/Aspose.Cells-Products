...
description: Aspose Excel. Převeďte XLS na OTS rychle a snadno pomocí Aspose.Cells. C++ XLS na OTS. C++ Uložte XLS do OTS. Uložte XLS jako OTS pomocí C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte XLS na OTS v C++" h2="Vysoce výkonný převod XLS na OTS pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte XLS do OTS v C++" %}}

Následující příklad ukazuje, jak převést XLS na OTS v C++.
...
{{% cells-convert title="Ukázkový kód pro převod XLS na OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="ots" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLS na OTS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XLS soubory na OTS programově? Vývojáři C++ mohou snadno převést XLS na OTS v několika řádcích kódu.
...
1. Převeďte XLS na OTS voláním metody Save().
1.  Získejte výsledek převodu XLS na OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod XLS na OTS" %}}
