---
title:  Lihat atau Edit XLS File Metadata via .NET
weight: 1410
description: Kode sumber C# untuk mengedit atau melihat metadata format XLS pada Kerangka .NET, Inti .NET, Mono atau Platform Xamarin.
...
+ Muat XLS dengan instance Buku Kerja
