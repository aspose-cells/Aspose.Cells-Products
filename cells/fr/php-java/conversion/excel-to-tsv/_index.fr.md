---
title: PHP EXCEL en TSV - Convertisseur EXCEL en TSV
description: Aspose Exceller. Convertissez EXCEL en TSV rapidement et facilement avec Aspose.Cells. PHP EXCEL en TSV. PHP Enregistrez EXCEL en TSV. Enregistrez EXCEL sous TSV en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en TSV via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en TSV par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en TSV en quelques lignes de code.
...
1.  Convertissez EXCEL en TSV en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en TSV" %}}
