---
title:  Вставьте RadioButton (элемент управления формой) в Excel, используя Python via java
weight: 60
description: Python via исходный код Java для вставки RadioButton (элемент управления формой) в Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Вставьте RadioButton (элемент управления формой) в Excel, используя Python via java" h2="Вставляйте объекты с помощью API на стороне сервера без какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF и т. д." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Как вставить RadioButton (элемент управления формой) в файл Excel с помощью Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке RadioButton (элемент управления формой) в файл Excel с использованием Python via java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить RadioButton (элемент управления формой) в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить RadioButton (управление формой) — Python via java" offSpacer="" %}}
