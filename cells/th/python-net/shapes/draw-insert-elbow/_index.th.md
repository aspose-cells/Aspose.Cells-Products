---
title: วิธีวาดหรือใส่รูปข้อศอกลงใน Excel โดยใช้ Python via .Net
weight: 10
description: Python via ซอร์สโค้ด .Net เพื่อแทรกรูปร่างข้อศอกลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีใส่รูปข้อศอกลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) เพื่อแทรกรูปร่างข้อศอกในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ทรงศอกสอด - Python via .Net" offSpacer="" %}}
