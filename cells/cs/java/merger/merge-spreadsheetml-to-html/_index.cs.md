---
title: Sloučit SPREADSHEETML s HTML - Sloučit SPREADSHEETML s HTML v Java
url: /cs/java/merger/merge-spreadsheetml-to-html/ 
description: Aspose Excel. Java Aspose.Cells. Zdarma online sloučit SPREADSHEETML do formátu uložení HTML. Java Zkombinujte SPREADSHEETML do formátu HTML. Sloučit SPREADSHEETML na HTML v Java. SPREADSHEETML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit SPREADSHEETML na HTML v Java online zdarma" %}}

Následující příklad ukazuje, jak sloučit SPREADSHEETML do HTML v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení SPREADSHEETML do HTML. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru HTML. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí SPREADSHEETML do HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení SPREADSHEETML na HTML v Java" InputFormat="xml" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit SPREADSHEETML do HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit SPREADSHEETML do HTML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení SPREADSHEETML do HTML" %}}
