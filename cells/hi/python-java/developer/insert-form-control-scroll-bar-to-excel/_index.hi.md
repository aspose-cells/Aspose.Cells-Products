---
title: Python via जावा का उपयोग करके एक्सेल में स्क्रॉलबार (फॉर्म नियंत्रण) डालें
weight: 90
description: एक्सेल में स्क्रॉलबार (फॉर्म कंट्रोल) डालने के लिए Python via जावा सोर्स कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via जावा का उपयोग करके एक्सेल में स्क्रॉलबार (फॉर्म नियंत्रण) डालें" h2="Microsoft या ओपन ऑफिस, एडोब PDF आदि जैसे किसी भी सॉफ्टवेयर के बिना सर्वर-साइड एपीआई का उपयोग करके ऑब्जेक्ट डालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via जावा का उपयोग करके एक्सेल फ़ाइल में स्क्रॉलबार (फ़ॉर्म नियंत्रण) कैसे डालें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via जावा का उपयोग करके एक्सेल फ़ाइल में स्क्रॉलबार (फ़ॉर्म नियंत्रण) डालने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से वर्कशीट का चयन करें।
 + आकृति संग्रह का उपयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addScrollBar(int,%20int,%20int,%20int,%20int,%20int)) चयनित वर्कशीट में स्क्रॉलबार (फॉर्म कंट्रोल) डालने के लिए।
...
{{% blocks/products/pf/agp/code-block title="स्क्रॉलबार डालें (फ़ॉर्म नियंत्रण) - Python via java" offSpacer="" %}}
