---
title:  عرض XLSM تنسيقات الملفات via .NET
weight: 9980
description: C# كود المصدر لتحميل وتقديم وعرض وثائق XLSM على .NET Framework أو .NET Core أو Mono أو منصات Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSM ملف عارض for .NET" h2="اعرض جداول بيانات Excel & OpenOffice مثل XLSM دون الحاجة إلى Microsoft Excel أو Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="كيفية عرض XLSM ملف باستخدام C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات مشاهدة XLSM عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يسهّل Aspose.Cells على المطورين عرض ملف XLSM ببضع أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1.  قم بتحميل الملف XLSM في مثيل مصنف
1.  قم بإنشاء مثيل HtmlSaveOptions & قم بتعيين خاصية ExportHeadings على true
1.  احفظ الملف XLSM بتنسيق HTML باستخدام أسلوب Workbook.Save
...
{{% blocks/products/pf/agp/code-block title="C# مثال للكود لعرض ملف XLSM" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 يمكن استخدام Aspose.Cells API لإنشاء وتنسيقات Microsoft Excel وتحريرها وتحويلها وتقديمها إلى تنسيقات مختلفة. علاوة على ذلك ، يمكن استخدامه لرسم بياني شامل ، وإعداد تقارير قابلة للتطوير وحسابات موثوقة داخل تطبيقات البرامج. Aspose.Cells هو API مستقل ولا يتطلب أي برنامج مثل Microsoft أو OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لعرض XLSM" sectionDescription=" تحقق من العروض الحية لدينا[مشاهدة XLSM](https://products.aspose.app/cells/viewer/xlsm) مع الفوائد التالية." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" قم بتنزيل الملف XLSM من الرابط ، إذا لزم الأمر" >}}
