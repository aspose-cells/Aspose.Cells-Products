---
title: Converter XLTX para SVG por meio do aplicativo C++ 
url: /pt/cpp/conversion/xltx-to-svg/ 
description: Exemplo de código de conversão C++ de documento XLTX para formato SVG. Os programadores podem usar esse código-fonte para conversão em lote de XLTX para SVG em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLTX para SVG via C++" h2="Conversão de XLTX para SVG de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX para SVG usando C++" %}}

 Para converter XLTX para SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter XLTX para SVG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem facilmente converter arquivos XLTX para SVG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLTX usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (SVG).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo SVG em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLTX para SVG C++" offSpacer="" %}}
