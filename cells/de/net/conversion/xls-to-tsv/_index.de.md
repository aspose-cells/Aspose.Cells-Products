---
title: C# XLS bis TSV - XLS bis TSV Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das Format TSV und ermöglicht das nahtlose Speichern von XLS-Daten im Format TSV mithilfe der Aspose.Cells-Bibliothek – alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis TSV in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in C# in TSV umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in TSV" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in TSV konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in TSV laden und konvertieren.
...
1.  Konvertieren Sie XLS in TSV durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in TSV" %}}
