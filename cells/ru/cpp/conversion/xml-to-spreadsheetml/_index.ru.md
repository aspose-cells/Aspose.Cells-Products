...
Нужно программно преобразовать XML-файлы в SPREADSHEETML? Разработчики, использующие код C++, могут легко преобразовать XML в SPREADSHEETML всего за несколько строк кода.
