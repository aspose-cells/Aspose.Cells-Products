---
title:  Rechercher le document CSV sans ouvrir le via .NET
weight: 7510
description: Code source C# pour rechercher des mots avec un motif dans le fichier CSV sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
+ Chargez le fichier CSV à l'aide de la classe Workbook.
