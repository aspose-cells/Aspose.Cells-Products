...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى PDF باستخدام Java" %}}

 من أجل تحويل XLS إلى PDF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLS إلى PDF عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف XLS إلى PDF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف XLS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد PDF & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف PDF الناتج
...
{{% blocks/products/pf/agp/code-block title="XLS إلى PDF Java رمز مصدر التحويل" offSpacer="" %}}
