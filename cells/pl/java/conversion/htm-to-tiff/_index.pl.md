...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na TIFF używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM do TIFF w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować HTM na TIFF w Java.
...
Trzeba programowo przekonwertować pliki HTM do formatu TIFF? Programiści Java mogą łatwo przekonwertować pliki HTM do formatu TIFF za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji HTM na TIFF" %}}
{{% blocks/products/pf/agp/text %}}
