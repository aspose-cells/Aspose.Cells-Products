...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera TXT-fil till XLSM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda TXT-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (XLSM) filtillägg.1. XLSM-filen kommer att sparas på den angivna sökvägen.1. Öppna XLSM-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="TXT till XLSM C++ omvandlingskällkod" offSpacer="" %}}
