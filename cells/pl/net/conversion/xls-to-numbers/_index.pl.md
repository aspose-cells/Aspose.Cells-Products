...
Trzeba programowo przekonwertować pliki XLS na LICZBY? Programiści .NET mogą łatwo załadować i przekonwertować pliki XLS na LICZBY za pomocą zaledwie kilku linijek kodu.
...
1.  Przekonwertuj XLS na LICZBY wywołując metodę Workbook.Save.
