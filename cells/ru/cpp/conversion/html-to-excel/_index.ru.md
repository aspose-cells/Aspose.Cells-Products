...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики C++ могут легко преобразовать HTML в EXCEL, написав всего несколько строк кода.
