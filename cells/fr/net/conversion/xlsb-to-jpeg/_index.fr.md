---
title: C# XLSB à JPEG - Convertisseur en ligne XLSB à JPEG
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir XLSB en format de sauvegarde JPEG. Format C# XLSB à JPEG. Enregistrez XLSB à JPEG C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à JPEG dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en JPEG en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLSB en JPEG. Téléchargez votre fichier XLSB, puis enregistrez-le simplement en tant que fichier JPEG. Pour la lecture XLSB et l'écriture JPEG, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie JPEG seront identiques au document XLSB d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en JPEG en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en JPEG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en JPEG par programmation ? Les développeurs .NET peuvent facilement charger et convertir XLSB en JPEG en quelques lignes de code.
...
1.  Convertissez XLSB en JPEG en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de XLSB en JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLSB en JPEG" %}}
