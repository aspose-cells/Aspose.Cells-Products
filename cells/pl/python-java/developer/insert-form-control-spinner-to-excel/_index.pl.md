---
title:  Wstaw przycisk Spin (kontrolka formularza) do Excela, używając Python via Java
weight: 40
description: Python via Kod źródłowy Java umożliwiający wstawienie przycisku Spin (kontrolka formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić przycisk Spin (kontrolka formularza) do pliku Excel przy użyciu Python via java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić przycisk obrotu (kontrolka formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw przycisk obrotu (kontrolka formularza) — Python via java" offSpacer="" %}}
