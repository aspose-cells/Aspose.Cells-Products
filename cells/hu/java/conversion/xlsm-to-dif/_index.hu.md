---
title: "XLSM konvertálása DIF-re a következőn keresztül: Java "
weight: 1940
url: /hu/java/conversion/xlsm-to-dif/ 
description: Minta Java konverziós kód az XLSM formátumhoz DIF fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására DIF-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSM konvertálása DIF-re a következőn keresztül: Java" h2="XLSM-ből DIF-be Java konverzió, amellyel egyetlen vagy több oldalt konvertálhat DIF-be a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="XLSM konvertálása DIF-re a következővel: Java" %}}

 Ahhoz, hogy az XLSM-et DIF-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM DIF-re konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják az XLSM-fájlt DIF-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSM-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat DIF kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott DIF-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLSM-ből DIF Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLSM fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xlsm");
// mentse az XLSM-et DIF-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLSM-ből DIF-be konvertáló élő bemutatók" sectionDescription="[Konvertálja az XLSM-et DIF-re](https://products.aspose.app/cells/conversion/xlsm-to-dif) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel XLSM fájlját, és azonnal DIF formátumba konvertálódik." >}}
