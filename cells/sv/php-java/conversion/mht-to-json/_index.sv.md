---
title: PHP MHT till JSON - MHT till JSON Converter
description: Aspose Excel. Konvertera MHT till JSON snabbt och enkelt med Aspose.Cells. PHP MHT till JSON. PHP Spara MHT till JSON. Spara MHT som JSON med PHP.
...
Behöver du konvertera MHT-filer till JSON programmatiskt? PHP-utvecklare kan enkelt ladda och konvertera MHT till JSON på bara några rader kod.
...
1.  Konvertera MHT till JSON genom att anropa sparmetoden för arbetsboken.
