---
title: Połącz OTS z XML - Połącz OTS z XML w C#
url: /pl/net/merger/merge-ots-to-xml/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie OTS online z formatem zapisu XML. C# Połącz OTS z formatem XML. Scal OTS do XML w C#. Scal OTS.
...
{{% blocks/products/pf/agp/content h2="Scal OTS do XML w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić OTS z XML w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić OTS z XML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją do pliku XML. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z XML.
...
{{% blocks/products/pf/agp/content h2="Jak scalić OTS do XML przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć OTS z XML? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do łączenia OTS z XML" %}}
