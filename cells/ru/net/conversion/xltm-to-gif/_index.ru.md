...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в GIF в C#" %}}
...
Нужно программно преобразовать файлы XLTM в GIF? Разработчики .NET могут легко загрузить и преобразовать XLTM в GIF всего за несколько строк кода.
...
1.  Преобразуйте значение XLTM в GIF, вызвав метод Workbook.Save.
