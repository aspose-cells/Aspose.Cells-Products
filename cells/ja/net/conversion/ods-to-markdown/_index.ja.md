...
{{% blocks/products/pf/agp/feature-section-col title="C#を介してODSをMARKDOWNに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 .NET開発者は、わずか数行のコードでODSファイルを簡単にロードしてMARKDOWNに変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookのインスタンスを含むODSファイルをロードします1. Workbook.Saveメソッドを呼び出します1. MD拡張子をパラメータとして出力パスを渡す1. 結果のMARKDOWNファイルの指定されたパスを確認します
...
{{% cells-convert title="ODSをマークダウンに変換するための無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="md" IsLandingPage="true" %}}
