---
title: Convertisseur PHP JSON vers OTS - JSON vers OTS
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir JSON au format OTS, permettant un enregistrement transparent des données JSON au format OTS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code PHP efficace et personnalisable.
...
Besoin de convertir des fichiers JSON en OTS par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers JSON en OTS en quelques lignes de code seulement.
...
1.  Convertissez JSON en OTS en appelant la méthode save de Workbook.
