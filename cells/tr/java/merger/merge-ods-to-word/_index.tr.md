---
title: ODS'i WORD ile birleştir - ODS'i Java'de WORD ile birleştir
url: /tr/java/merger/merge-ods-to-word/ 
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme ODS ile WORD saveformat. Java ODS'i WORD biçiminde birleştirin. ODS'i Java'de WORD ile birleştirin. ODS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java Online\'da WORD ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de WORD ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i WORD ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından WORD dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. ODS'i WORD ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'de WORD ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS ile WORD via Java Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i programlı olarak WORD ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i WORD ile birleştirmek için Java kitaplığı" %}}
