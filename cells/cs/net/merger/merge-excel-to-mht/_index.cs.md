...
description: Aspose Excel. C# Aspose.Cells. Sloučit EXCEL do formátu uložení MHT. C# Kombinujte EXCEL s formátem MHT. Sloučit EXCEL do MHT v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL s MHT v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení EXCEL do MHT v C#" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
