---
title: Συγχώνευση HTM στο XPS - Συνδυάστε το HTM στο XPS στο Python
url: /el/python-java/merger/merge-htm-to-xps/ 
description: Aspose Excel. Python Aspose.Cells. Δωρεάν Online Συγχώνευση HTM σε XPS saveformat. Python Συνδυάστε τη μορφή HTM σε XPS. Συγχώνευση HTM στο XPS στο Python. Συγχώνευση HTM.
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το HTM στο XPS στο Aspose.Cells for Python via Java.
...
{{% cells-merger title="Δωρεάν online για συγχώνευση HTM στο XPS στο Python" InputFormat="htm" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το HTM στο XPS μέσω του Python" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να συγχωνεύσετε το HTM στο XPS μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
