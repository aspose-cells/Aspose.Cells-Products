---
title: Konwerter C# XLSX na LICZBY - XLSX na LICZBY
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSX w NUMERACH w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSX na LICZBY w formacie C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLSX na LICZBY" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="numbers" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na LICZBY za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLSX na LICZBY? Programiści .NET mogą łatwo załadować i przekonwertować pliki XLSX na LICZBY za pomocą zaledwie kilku linijek kodu.
...
1.  Przekonwertuj XLSX na LICZBY wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLSX na LICZBY.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLSX na LICZBY" %}}
