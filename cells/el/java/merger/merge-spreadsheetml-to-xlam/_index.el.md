...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση SPREADSHEETML σε μορφή αποθήκευσης XLAM. Java Συνδυάστε το SPREADSHEETML σε μορφή XLAM. Συγχώνευση SPREADSHEETML στο XLAM στο Java. SPREADSHEETML Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση SPREADSHEETML στο XLAM στο Java" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση SPREADSHEETML στο XLAM στο Java" InputFormat="xml" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
