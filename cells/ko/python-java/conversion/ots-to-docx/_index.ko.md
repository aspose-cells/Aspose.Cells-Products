...
description: Aspose 엑셀. Aspose.Cells을 사용하여 빠르고 쉽게 OTS를 DOCX로 변환합니다. Python OTS를 DOCX로 변환합니다. Python OTS를 DOCX로 저장합니다. Python을 사용하여 OTS를 DOCX로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="Python을 사용하여 OTS를 DOCX로 변환" %}}
...
{{% blocks/products/pf/agp/content h2="Python에 OTS를 DOCX에 저장" %}}

다음 예에서는 Python에서 OTS를 DOCX로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="OTS를 DOCX로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="docx" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="OTS를 DOCX로 변환하는 Python 라이브러리" %}}
