---
title: Convierta SXC a XPS a través de Java 

description: Ejemplo de código de conversión Java para formato SXC a archivo XPS. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a XPS dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta SXC a XPS a través de Java" h2="Conversión de SXC a XPS Java para convertir una o varias páginas a XPS mediante la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SXC a XPS usando Java" %}}

 Para renderizar SXC a XPS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SXC a XPS a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo SXC a XPS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo SXC con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión XPS y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo XPS resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de SXC a XPS Java" offSpacer="" %}}

```cs
// cargue el archivo SXC en una instancia de Workbook
Workbook book = new Workbook("template.sxc");
// guardar SXC como XPS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de SXC a XPS" sectionDescription="[Convertir SXC a XPS](https://products.aspose.app/cells/conversion/sxc-to-xps) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo SXC, se convertirá instantáneamente a XPS." >}}
