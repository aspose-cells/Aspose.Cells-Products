...
{{% blocks/products/pf/agp/content h2="How to Convert XLS to SXC Using C#" %}}
 ...
 In order to convert XLS to SXC, we will use
...
{{% cells-convert title="Free App and Sample Code to Convert XLS to SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="sxc" IsLandingPage="true" %}}
