...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können JSON-Dateien in nur wenigen Codezeilen einfach laden und in DIF konvertieren.
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von JSON in DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="dif" IsLandingPage="true" %}}
