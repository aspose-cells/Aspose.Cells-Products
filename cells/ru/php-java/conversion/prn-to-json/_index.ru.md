...
{{% blocks/products/pf/agp/content h2="Как преобразовать PRN в JSON с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы PRN в формат JSON? PHP-разработчики могут легко загрузить и преобразовать файлы PRN в формат JSON всего несколькими строками кода.
...
1.  Преобразуйте PRN в JSON, вызвав метод сохранения рабочей книги.
1.  Получите результат преобразования PRN в JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-библиотека для преобразования PRN в JSON" %}}
