...
description: Aspose Excel'de. Aspose.Cells ile ODS'i hızlı ve kolay bir şekilde EXCEL'e dönüştürün. Python ODS'i EXCEL'e dönüştürün. Python ODS'i EXCEL'e kaydedin. Python'i kullanarak ODS'i EXCEL olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Python\'de EXCEL\'e kaydedin" %}}
...
{{% cells-convert title="ODS\'i EXCEL\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}
