...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie OTS online z formatem zapisu XPS. C# Połącz OTS z formatem XPS. Połącz OTS z XPS w C#. Połącz OTS.
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z XPS za pomocą C#" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z XPS w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić OTS z XPS w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić OTS z XPS. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku XPS. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z XPS.
...
{{% blocks/products/pf/agp/content h2="Jak połączyć OTS z XPS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć OTS z numerem XPS? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia OTS z XPS" %}}
