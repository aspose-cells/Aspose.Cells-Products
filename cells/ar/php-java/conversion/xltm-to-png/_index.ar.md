---
title: PHP XLTM إلى PNG - XLTM إلى PNG محول
description: Aspose اكسل. قم بتحويل XLTM إلى PNG بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى PNG. PHP احفظ XLTM إلى PNG. احفظ XLTM كـ PNG باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى PNG عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى PNG برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى PNG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى PNG عن طريق استدعاء طريقة حفظ المصنف.
