---
title:  Insérer un cube dans Excel via Java
weight: 20
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer Cube dans le fichier Excel via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) pour insérer un cube dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer un cube - Java" offSpacer="" %}}
