---
title: C# PNG a JSON - PNG a JSON Convertidor
description: Aspose Excel. C# Aspose.Cells. PNG a JSON en C#. C# Convierta PNG a JSON en formato guardado. Formato C# PNG a JSON. Guarda PNG al JSON C#.
...
{{% blocks/products/pf/agp/content h2="Guardar PNG al JSON en C#" %}}

El siguiente ejemplo demuestra cómo convertir PNG a JSON en C#.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir PNG a JSON. Cargue su archivo PNG y luego simplemente guárdelo como archivo JSON. Tanto para lectura PNG como para escritura JSON puede utilizar nombres de archivo completos. El contenido y el formato de salida JSON serán idénticos al documento PNG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir PNG a JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a JSON a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PNG a JSON mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente PNG a JSON en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para convertir PNG en JSON" %}}
