...
description: Aspose Excel. Cette solution complète offre aux développeurs C++ une approche entièrement intégrée pour convertir le format HTM au format XLT, permettant un enregistrement transparent des données HTM au format XLT à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C++ efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM à XLT dans C++" %}}
...
Besoin de convertir des fichiers HTM au format XLT par programmation ? Les développeurs spécialisés en C++ peuvent facilement convertir des fichiers HTM au format XLT en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en XLT en appelant la méthode Save().
