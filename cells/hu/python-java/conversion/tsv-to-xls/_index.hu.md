---
title: "TSV konvertálása XLS-re a következőn keresztül: Python"
url: /hu/python-java/conversion/tsv-to-xls/
description: Mintakód a tsv–xls Python konverzióhoz. Használjon API példakódot a tsv fájlok kötegelt xls formátumú konvertálásához a Python alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása XLS-re a következővel: Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV XLS-re konvertálásához a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői könnyedén betölthetnek és konvertálhatnak TSV-fájlokat XLS-re, mindössze néhány sornyi kóddal.
