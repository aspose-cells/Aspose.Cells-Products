---
title:  Połącz CSV z XLSM przez C#
url: /pl/net/merger/merge-csv-to-xlsm/ 
description: Połącz CSV z XLSM Online za darmo. Bezpłatnie online CSV do XLSM Fuzja. Połącz CSV z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć CSV z XLSM w C#.
...
{{% cells-merger title="Darmowa aplikacja do łączenia CSV z XLSM on-line" InputFormat="csv" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
