---
title: Gộp XML thành XLAM - Gộp XML thành XLAM trong Java
url: /vi/java/merger/merge-xml-to-xlam/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất XML thành định dạng lưu XLAM. Java Kết hợp XML thành định dạng XLAM. Hợp nhất XML thành XLAM trong Java. Hợp nhất XML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XML thành XLAM trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất XML thành XLAM trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XML thành XLAM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu nó vào tệp XLAM. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất XML thành XLAM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất XML thành XLAM trong Java" InputFormat="xml" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
