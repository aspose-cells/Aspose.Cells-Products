...
{{% blocks/products/pf/agp/content h2="Hoe converteer je MHTML naar MD via PHP?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie MHTML programmatisch converteren naar MD? PHP-ontwikkelaars kunnen bestanden met de extensie MHTML eenvoudig laden en converteren naar MD met slechts een paar regels code.
