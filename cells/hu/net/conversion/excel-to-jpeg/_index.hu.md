---
title: C# EXCEL - JPEG - EXCEL - JPEG konverter
description: Aspose Excel. Konvertálja gyorsan és egyszerűen EXCEL-t JPEG-re a Aspose.Cells-es számmal. C# EXCEL JPEG-re. C# Mentse az EXCEL-t JPEG-re. Mentse az EXCEL-t JPEG-es számra. Mentse az EXCEL-t 38123481-es számmal 07613817-ként.
...
{{% blocks/products/pf/agp/content h2="EXCEL mentése a JPEG-es számra a C#-ben" %}}

A következő példa bemutatja, hogyan lehet EXCEL-t JPEG-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód az EXCEL JPEG-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Az EXCEL konvertálása JPEG-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia az EXCEL fájlokat JPEG-re? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják az EXCEL-t JPEG-re.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár az EXCEL JPEG-re konvertálásához" %}}
