...
description: Aspose Excel. C++ Aspose.Cells. Fusion en ligne gratuite XLSM au format de sauvegarde WORD. C++ Combinez XLSM au format WORD. Fusionner XLSM à WORD dans C++. XLSM Fusionner.
...
L'exemple suivant montre comment fusionner XLSM en WORD dans Aspose.Cells for C++.
...
{{% cells-merger title="Gratuit en ligne pour fusionner XLSM en WORD en C++" InputFormat="xlsm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLSM en WORD via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLSM en WORD par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
