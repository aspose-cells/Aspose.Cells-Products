...
description: Aspose Excel. Python Aspose.Cells. XML egyesítése XML mentési formátumba. Python Az XML és az XML formátum kombinálása. XML egyesítése XML-lel a Python-ben. XML-egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse az XML-t XML-lel a Python-ben" %}}

A következő példa bemutatja, hogyan egyesítheti az XML-t XML-lel a Aspose.Cells for Python via Java-ben.
...
{{% cells-merger title="Mintakód az XML és az XML egyesítéséhez a Python-ben" InputFormat="xml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
