...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLSB 转换为 XLTX。 Python XLSB 为 XLTX。 Python 将 XLSB 保存为 XLTX。 将 XLSB 另存为 07611134 81 使用 Python。
...
按照简单的步骤将 XLSB 转换为 XLTX。上传您的 XLSB 文件，然后只需将其另存为 XLTX 文件。对于 XLSB 读取和 XLTX 写入，您可以使用完全限定的文件名。输出 XLTX 内容和格式将与原始 XLSB 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 XLSB 转换为 XLTX 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLSB 转换为 XLTX" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSB 文件转换为 XLTX 吗？ Python 开发人员只需几行代码即可轻松加载和转换 XLSB 到 XLTX。
...
1. 使用工作簿实例加载 XLSB 文件。
1. 通过调用Workbook.save方法将XLSB转换为XLTX。
1. 获取XLSB到XLTX的转换结果。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python库将XLSB转换为XLTX" %}}
