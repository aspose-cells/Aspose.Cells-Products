---
title: C# ODS a MHTML - ODS a MHTML Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato MHTML, permitindo o salvamento perfeito de dados ODS no formato MHTML usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a MHTML em C#" %}}

exemplo a seguir demonstra como converter ODS em MHTML em C#.
...
{{% cells-convert title="Código de exemplo para converter ODS em MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="mhtml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS em MHTML por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em MHTML programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em MHTML em apenas algumas linhas de código.
...
1.  Converta ODS para MHTML chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em MHTML" %}}
