...
{{% blocks/products/pf/agp/content h2="C#\'de PRN\'yi ET ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin ET ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi ET ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından ET dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. PRN'yi ET ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de PRN\'yi ET ile Birleştirmek için Örnek Kod" InputFormat="prn" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla ET ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 PRN'yi ET ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi ET ile birleştirmek için .NET kitaplığı" %}}
