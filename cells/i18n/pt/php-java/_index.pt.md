...
{{< blocks/products/pf/i18n/upper-banner h1="Planilha PHP Excel API" h2="Execute tarefas de manipulação de planilhas e exporte arquivos do Excel para vários formatos sem dependências do Microsoft Excel." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-php-java.svg" pfName="Aspose.Cells" subTitlepfName="for PHP via Java" downloadUrl="https://downloads.aspose.com/cells/php" >}}
...
<p>
 Aspose.Cells para PHP via Java é um gerenciamento e processamento de planilhas Excel escalonável e rico em recursos API. Os aplicativos podem realizar conversão de formato de planilha, gerenciamento e renderização de gráficos, implementação de fórmulas, estilização de planilhas no nível mais granular e muito mais. API suporta XLS, XLSX, ODS, SpreadsheetML, CSV, Tab Delimited, HTML/MHTML, PDF, XPS e outros formatos. Os desenvolvedores podem adicionar facilmente a capacidade de criar, editar, converter e renderizar arquivos Excel em seus aplicativos PHP enquanto usam o JavaBridge.
</p>
...
{{< blocks/products/pf/carousel-item h3="Num relance" description="Uma visão geral de Aspose.Cells para PHP por meio de recursos de Java." >}}
...
{{< blocks/products/pf/carousel-item h3="Independência da plataforma" description="Aspose.Cells para PHP via Java requer PHP 7.1 (ou superior) e JavaBridge. Ele pode ser executado em qualquer plataforma onde esses requisitos possam ser atendidos." >}}
<div class="diagram1 d1-php-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Formatos de arquivo suportados" description="Aspose.Cells para PHP via Java é compatível com os formatos populares de planilha, juntamente com os formatos de imagem e layout fixo mais usados." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Recursos avançados de planilha PHP API
   </h2>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Suporte para CSV, delimitado por tabulação &amp; Formatos HTML
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Criar, manipular &amp; renderizar gráficos
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Criar, manipular &amp; atualizar tabelas dinâmicas
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Converta arquivos do Excel para XPS, PDF &amp; HTML
    </h2>
    <p>
     Aspose.Cells para PHP via Java API é capaz de converter arquivos do Excel para os formatos XPS, XPS e HTML, além de manter a mais alta fidelidade visual. O processo de conversão é confiável e os desenvolvedores podem obter o formato necessário com apenas algumas linhas.
    </p>
...
$wkbk-&gt;save("output.html", SaveFormat::HTML);</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Renderizar planilhas do Excel &amp; Objetos para PDF &amp; Imagens
    </h2>
    <p>
     Aspose.Cells para PHP via Java tem seu próprio mecanismo de renderização especialmente projetado para renderização com a mais alta fidelidade ao Microsoft Excel. Ao usar Aspose.Cells para PHP via Java, você pode converter planilhas inteiras, planilhas individuais &amp; gráficos para uma série de imagens &amp; formatos de layout fixo.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Opções de exibição de planilhas flexíveis
    </h2>
    <p>
     Aspose.Cells para PHP via Java oferece controle total sobre a configuração da página da planilha, permitindo que você manipule as opções de exibição da planilha do Excel, como quebras de página, orientação de página, dimensionamento, tamanho do papel, cabeçalhos/rodapés e amp; nível de zoom. Você também pode controlar a visibilidade dos dados usando os painéis de congelamento &amp; área de impressão para atender aos requisitos de sua aplicação.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Cells para PHP via Java é equipado com um poderoso mecanismo de cálculo de fórmulas que suporta quase todas as fórmulas e funções padrão e avançadas do Microsoft Excel. Você pode ler, definir e calcular os resultados de fórmulas de estilo de referência R1C1 de tipo interno ou de suplemento, matriz e estilo de referência R1C1.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     biblioteca é tão flexível que pode fornecer planilhas com todos os tipos de efeitos visuais, bem como aplicar formatação a uma planilha, linha, coluna ou célula, definir fontes com atributos, definir o estilo da célula &amp; formatos numéricos, adicionar Rich Text e definir regras de formatação condicional.
    </p>
    <p>
     Da mesma forma, para uma aparência profissional e gráficos e gráficos de fácil compreensão são as partes integrantes. Aspose.Cells para PHP por meio de APIs Java podem criar e manipular todos os tipos de gráficos padrão e personalizados. Além disso, diferentes tipos de objetos de desenho para as células podem ser facilmente adicionados.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="API Referências" href="https://apireference.aspose.com/php/cells" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Cells para PHP via Java?" tabId="success-stories" >}}
