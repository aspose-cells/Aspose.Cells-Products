---
title: Unisci ODS a PRN - Combina ODS a PRN in Java
url: /it/java/merger/merge-ods-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Unisci online gratuito ODS al formato di salvataggio PRN. Java Combina ODS al formato PRN. Unisci ODS a PRN in Java. ODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci ODS a PRN in Java online gratuitamente" %}}

L'esempio seguente mostra come unire ODS a PRN in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire ODS a PRN. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file PRN. Se sviluppi il codice in Java, sarà più semplice di quanto sembri. Vedere l'esempio Java che unisce ODS a PRN.
...
{{% blocks/products/pf/agp/content h2="Come unire ODS a PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire ODS a PRN a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Java libreria per unire ODS a PRN" %}}
