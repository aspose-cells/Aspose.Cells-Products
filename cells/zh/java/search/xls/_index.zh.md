---
title: 无需通过 Java 打开即可搜索 XLS 文档 
weight: 9430
url: /zh/java/search/xls/ 
description: Java 示例代码，用于在 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中的 XLS 文件中搜索带有模式的单词。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Java 中搜索 XLS 格式" h2="使用服务器端 Aspose.Cells for Java API 的本地和高性能 XLS 文档搜索，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中搜索 XLS 文件的步骤" %}}
