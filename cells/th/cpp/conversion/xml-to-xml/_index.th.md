...
ต้องการแปลงไฟล์ XML เป็น XML ด้วยโปรแกรมใช่ไหม? นักพัฒนาสามารถแปลง XML เป็น XML ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด (รหัส C++)
...
1.  แปลง XML เป็น XML โดยเรียกใช้เมธอด Save()
