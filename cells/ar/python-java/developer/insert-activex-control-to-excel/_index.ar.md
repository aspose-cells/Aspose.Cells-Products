---
title: أدخل عنصر تحكم ActiveX في Excel باستخدام Python via Java
weight: 10
description: Python via Java الكود المصدري لإدراج عنصر تحكم ActiveX في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج عنصر تحكم ActiveX في ملف Excel باستخدام Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج عنصر تحكم ActiveX في ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج عنصر تحكم ActiveX في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل عنصر تحكم ActiveX - Python via java" offSpacer="" %}}
