---
title: Python aracılığıyla HTML'yi JSON'a dönüştürün
url: /tr/python-java/conversion/html-to-json/
description: Html'den json'a Python dönüştürme için örnek kod. Python uygulamasında toplu html dosyalarından json'a dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python aracılığıyla HTML\'yi JSON\'a dönüştürün" h2="Python API\'lerini kullanarak Excel® elektronik tablolarını JSON biçimine aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python Kullanarak HTML\'yi JSON\'a Dönüştürme" %}}

 HTML'yi JSON'a dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Python aracılığıyla HTML\'yi JSON\'a Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Python geliştiricileri, HTML dosyalarını yalnızca birkaç satır kodla kolayca yükleyebilir ve JSON'a dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Bir Çalışma Kitabı örneğiyle HTML dosyasını yükleyin1. Workbook.Save yöntemini çağırın1. parametre olarak JSON uzantısı ile çıkış yolunu iletin1. Ortaya çıkan JSON dosyası için belirtilen yolu kontrol edin
