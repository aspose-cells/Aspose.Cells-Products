...
description: Aspose Excel. Μετατρέψτε το JPG σε JPEG γρήγορα και εύκολα με το Aspose.Cells. C++ JPG σε JPEG. C++ Αποθήκευση JPG σε JPEG. Αποθηκεύστε το JPG ως 07617037481 χρησιμοποιώντας 38.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε JPG στο JPEG στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή JPG σε JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="jpg" IsLandingPage="true" language="cpp" %}}
