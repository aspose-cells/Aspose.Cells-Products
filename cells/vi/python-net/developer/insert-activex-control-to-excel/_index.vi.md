...
{{% blocks/products/pf/agp/content h2="Cách Chèn Điều khiển ActiveX vào Tệp Excel bằng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn ActiveX Control vào file Excel qua Python" %}}
...
+ Sử dụng phương thức thêm của bộ sưu tập hình dạng để chèn Điều khiển ActiveX vào trang tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn điều khiển ActiveX - Python" offSpacer="" %}}
