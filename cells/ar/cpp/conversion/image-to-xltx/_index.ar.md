...
هل تحتاج إلى تحويل ملفات IMAGE إلى XLTX برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى XLTX في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى XLTX باستدعاء طريقة Save ().
