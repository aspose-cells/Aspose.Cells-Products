...
url: /python-net/merger/merge-numbers-to-jpeg/ 
...
The following example demonstrates how to merge NUMBERS to JPEG in Aspose.Cells for Python via .NET.
...
Need to merge NUMBERS to JPEG programmatically? A basic document merging and concatenating with [Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs can be done with just few lines of code.
