---
title: Konvertálja a TSV-t JPG-be a(z) C++ alkalmazással 
url: /hu/cpp/conversion/tsv-to-jpg/ 
description: Minta C++ konverziós kód a TSV-dokumentumhoz JPG formátumba. A programozók ezt a forráskódot használhatják kötegelt TSV-ből JPG-vé konvertálásához bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV konvertálása JPG formátumba a következőn keresztül: C++" h2="Nagy teljesítményű TSV-ből JPG-be konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása JPG-vé a következővel: C++" %}}
 ...
 A TSV JPG-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatnak TSV fájlt JPG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a TSV-fájlt a Factory::CreateIWorkbook használatával.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (JPG) fájlkiterjesztéssel.1. A JPG fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a JPG fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="TSV-ből JPG-be C++ konverziós forráskód" offSpacer="" %}}
