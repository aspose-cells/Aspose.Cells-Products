...
description: Aspose Exceller. Convertissez HTM en XML rapidement et facilement avec Aspose.Cells. C++ HTM en XML. C++ Enregistrez HTM au format XML. Enregistrez HTM au format XML en utilisant C++.
...
{{% blocks/products/pf/agp/content h2="Convertir HTM en XML à l\'aide de C++" %}}
...
L'exemple suivant montre comment convertir HTM en XML dans C++.
...
{{% cells-convert title="Exemple de code pour convertir HTM en XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en XML via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en XML par programme ? C++ peuvent facilement convertir HTM en XML en quelques lignes de code seulement.
