---
title: C++ XLS a TXT - XLS a TXT Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato TXT, permitindo o salvamento perfeito de dados XLS no formato TXT usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLS a TXT em C++" %}}

exemplo a seguir demonstra como converter XLS em TXT em C++.
...
{{% blocks/products/pf/agp/content h2="Como converter XLS em TXT por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para TXT programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para TXT com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em TXT" %}}
