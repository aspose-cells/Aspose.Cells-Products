...
weight: 340
description: C# để nhóm và tách nhóm các hình dạng trong Excel trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để nhóm và tách nhóm các hình dạng trong tệp Excel qua C#" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng các[phương pháp nhóm](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/group/) để nhóm các hình dạng trong trang tính đã chọn
 + Sử dụng các[phương pháp tách nhóm](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/) để tách nhóm các hình trong trang tính đã chọn
