---
title: Chuyển đổi XLSX sang Mảng Byte qua C# 
weight: 7690
url: /vi/net/conversion/xlsx-to-byte-array/ 
description: C# Mã mẫu để chuyển đổi XLSX sang Mảng Byte. Sử dụng mã này để chuyển đổi Excel XLSX sang Mảng Byte trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển XLSX thành mảng byte qua C#" h2="Chuyển đổi Microsoft Excel XLSX sang mảng byte gốc và hiệu suất cao hoặc ngược lại để xử lý dữ liệu bảng tính bằng cách sử dụng API .NET phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array rất hữu ích cho việc xử lý hoặc lưu trữ dữ liệu. Bạn có thể chuyển đổi tệp XLSX thành Mảng Byte cũng như tài liệu ** Mảng Byte sang XLSX ** bằng ngôn ngữ C#. Để chuyển XLSX sang mảng byte, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Cách chuyển XLSX sang Mảng Byte qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp XLSX sang mảng byte cho các tác vụ thao tác tiếp theo chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Bao gồm không gian tên trong tệp lớp của bạn1. Tải tệp XLSX đầu vào bằng Workbook1. Khởi tạo đối tượng MemoryStream1. Chuyển đổi dữ liệu luồng thành mảng byte1. Xử lý dữ liệu theo yêu cầu của bạn
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị XLSX sang mảng byte C# Chuyển đổi" offSpacer="" %}}
