---
title: Fusionner XLT avec IMAGE - Combiner XLT avec IMAGE dans Java
url: /fr/java/merger/merge-xlt-to-image/ 
description: Aspose Exceller. Java Aspose.Cells. Fusionner XLT au format de sauvegarde IMAGE. Java Combinez XLT au format IMAGE. Fusionner XLT avec IMAGE dans Java. XLT Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLT avec IMAGE dans Java" %}}

L'exemple suivant montre comment fusionner XLT avec IMAGE dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLT avec IMAGE. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier IMAGE. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne XLT avec IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner XLT avec IMAGE dans Java" InputFormat="xlt" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLT avec IMAGE via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLT avec IMAGE par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner XLT avec IMAGE" %}}
