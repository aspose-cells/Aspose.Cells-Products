---
title: Převeďte XLS na XLTX pomocí aplikace C++ 
weight: 5210
url: /cs/cpp/conversion/xls-to-xltx/ 
description: Ukázkový konverzní kód C++ pro dokument XLS na formát XLTX. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLS na XLTX v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLS na XLTX pomocí C++" %}}
 ...
 K převodu XLS na XLTX použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLS na XLTX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLS pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLTX).1. Soubor XLTX bude uložen do zadané cesty.1. Otevřete soubor XLTX v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLS na XLTX C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze XLS na XLTX" sectionDescription="[Převést XLS na XLTX](https://products.aspose.app/cells/conversion/xls-to-xltx) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor XLS, bude okamžitě převeden na XLTX." >}}
