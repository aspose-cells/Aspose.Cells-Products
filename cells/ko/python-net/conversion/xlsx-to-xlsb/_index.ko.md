...
{{% blocks/products/pf/agp/content h2="Python에서 XLSX을 XLSB로 변환" %}}
...
다음 예에서는 Python via NET에서 XLSX을 XLSB로 변환하는 방법을 보여줍니다.
