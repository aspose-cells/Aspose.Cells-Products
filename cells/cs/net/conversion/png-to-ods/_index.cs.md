...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu formátu PNG do formátu ODS, což umožňuje bezproblémové ukládání dat PNG do formátu ODS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PNG na ODS v C#" h2="Vysokorychlostní knihovna C# pro převod PNG na ODS. Toto je profesionální softwarové řešení pro import a export PNG, ODS a mnoha dalších formátů na platformách .NET Framework, .NET Core nebo Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte PNG na ODS v C#" %}}

Následující příklad ukazuje, jak převést číslo PNG na ODS v kódu C#.
...
1.  Převeďte číslo PNG na ODS voláním metody Workbook.Save.
