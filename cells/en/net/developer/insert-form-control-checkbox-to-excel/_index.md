...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert CheckBox(Form control) to Excel file via C#" %}}
...
+  Use the [add method](https://apireference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) to insert a CheckBox(Form control) in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert CheckBox(Form control) - C#" offSpacer="" %}}
