...
{{% blocks/products/pf/agp/content h2="Como converter SXC para JPEG usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC para JPEG via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para JPEG em apenas algumas linhas de código.
