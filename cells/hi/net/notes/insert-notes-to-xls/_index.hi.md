---
title: XLS फ़ाइल via .NET में नोट्स डालें
url: /hi/net/notes/insert-notes-to-xls/ 
description: C# का उपयोग करके XLS में नोट्स डालें। .NET एप्लिकेशन के भीतर नोट्स डालने के लिए API उदाहरण कोड का उपयोग करें।
...
{{% blocks/products/pf/agp/content h2="C# के माध्यम से XLS फ़ाइल में नोट्स कैसे डालें" %}}
...
Office 365 में, नोट्स एनोटेशन के लिए हैं, आप XLS फ़ाइल में नोट्स डालने और हटाने के लिए निम्नलिखित C# कोड का उपयोग कर सकते हैं।
