---
title:  Combine SPREADSHEETML con CSV a través de Python
...
El siguiente ejemplo muestra cómo fusionar SPREADSHEETML a CSV en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar SPREADSHEETML a CSV en línea" InputFormat="xml" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
