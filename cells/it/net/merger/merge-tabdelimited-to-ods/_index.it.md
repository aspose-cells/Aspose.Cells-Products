---
title: Unisci TABDELIMITED a ODS - Combina TABDELIMITED a ODS in C#
url: /it/net/merger/merge-tabdelimited-to-ods/ 
description: Aspose Excel. C# Aspose.Cells. Fusione online gratuita TABDELIMITED in ODS saveformat. C# Combina TABDELIMITED nel formato ODS. Unisci TABDELIMITED a ODS in C#. TABDELIMITED Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci TABDELIMITED a ODS in C# online gratuitamente" %}}

L'esempio seguente mostra come unire TABDELIMITED a ODS in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire TABDELIMITED a ODS. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file ODS. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce TABDELIMITED a ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuito online per unire TABDELIMITED a ODS in C#" InputFormat="tsv" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire TABDELIMITED a ODS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire TABDELIMITED a ODS a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria da unire TABDELIMITED a ODS" %}}
