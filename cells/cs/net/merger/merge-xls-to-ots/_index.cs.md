...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLS do formátu uložení OTS. C# Zkombinujte XLS do formátu OTS. Sloučit XLS do OTS v C#. XLS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLS na OTS v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLS do OTS v C#" InputFormat="xls" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
