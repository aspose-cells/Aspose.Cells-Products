...
{{% blocks/products/pf/agp/content h2="免费在线保存XLSM至ODS至C#" %}}
...
{{% cells-convert title="在线将 XLSM 转换为 ODS 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过C#将XLSM转换为ODS" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载和转换 XLSM 为 ODS。
...
{{% blocks/products/pf/agp/content h2="C# 库将 XLSM 转换为 ODS" %}}
