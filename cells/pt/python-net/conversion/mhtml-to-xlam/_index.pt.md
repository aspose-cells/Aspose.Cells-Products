---
title: Python MHTML a XLAM - MHTML a XLAM Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores Python uma abordagem totalmente integrada para converter MHTML para o formato XLAM, permitindo o salvamento perfeito de dados MHTML no formato XLAM usando a biblioteca Aspose.Cells, tudo por meio de código Python eficiente e personalizável.
...
{{% cells-convert title="Exemplo de código para converter MHTML em XLAM por meio da biblioteca Python Excel" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mhtml" outformat="xlam" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como converter MHTML em XLAM" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos MHTML em XLAM programaticamente? Os desenvolvedores do Python podem facilmente carregar e converter MHTML em XLAM em apenas algumas linhas de código.
...
1.  Converta MHTML em XLAM chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de MHTML para XLAM.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Biblioteca Excel para converter MHTML em XLAM" %}}
