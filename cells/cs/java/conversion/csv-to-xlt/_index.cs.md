...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na XLT pomocí Java" %}}

 K vykreslení CSV do XLT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu CSV na XLT prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na XLT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLT a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLT
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na XLT Java" offSpacer="" %}}
