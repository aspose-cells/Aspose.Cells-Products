...
description: Aspose Excel. Esta solución integral ofrece a los desarrolladores de C++ un enfoque totalmente integrado para convertir JPG al formato PDF, lo que permite guardar datos JPG sin problemas en el formato PDF mediante la biblioteca Aspose.Cells, todo mediante código C++ eficiente y personalizable.
...
{{% blocks/products/pf/agp/content h2="Guardar JPG en PDF en C++" %}}
...
¿Necesitas convertir archivos JPG a PDF mediante programación? Los desarrolladores de C++ pueden convertir fácilmente JPG a PDF con solo unas pocas líneas de código.
...
1.  Convierta JPG a PDF llamando al método Save().
1.  Obtenga el resultado de la conversión de JPG a PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteca para convertir JPG a PDF" %}}
