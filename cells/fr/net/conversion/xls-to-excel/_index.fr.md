---
title: C# XLS en EXCEL - Convertisseur XLS en EXCEL
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir XLS au format EXCEL, permettant un enregistrement transparent des données XLS au format EXCEL à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS pour EXCEL dans C#" %}}

L'exemple suivant montre comment convertir XLS en EXCEL dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en EXCEL. Téléchargez votre fichier XLS, puis enregistrez-le simplement en tant que fichier EXCEL. Pour la lecture XLS et l'écriture EXCEL, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage EXCEL de sortie seront identiques au document XLS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir XLS en Excel" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en EXCEL par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en EXCEL en quelques lignes de code seulement.
...
1.  Convertissez XLS au format EXCEL en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de XLS en EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en Excel" %}}
