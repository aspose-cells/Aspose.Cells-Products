...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в EMF, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в EMF в C#" %}}
...
1.  Преобразуйте значение FODS в EMF, вызвав метод Workbook.Save.
