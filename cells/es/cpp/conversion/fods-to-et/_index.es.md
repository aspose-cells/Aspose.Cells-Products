...
{{% cells-convert title="Código de muestra para convertir FODS a ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="et" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir FODS a ET mediante C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos FODS a ET mediante programación? Los desarrolladores de C++ pueden convertir fácilmente FODS a ET en solo unas pocas líneas de código.
...
1. Convierta FODS a ET llamando al método Save().
