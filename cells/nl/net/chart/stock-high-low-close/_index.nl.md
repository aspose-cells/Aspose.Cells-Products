---
title: Maak High-Low-Close Stock Charts via C#
description: C# Voorbeeldcode voor het maken van High-Low-Close Stock-grafieken naar Excel met behulp van .NET Library. Gebruik deze code voor het maken van een High-Low-Close Stock-grafiek naar MS Excel binnen VB.NET, Asp.NET of een andere op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}

{{< blocks/products/pf/i18n/upper-banner h1="Maak High-Low-Close Stock Charts via C#" h2="Native en krachtige MS Excel Charts-creatie programmatisch met behulp van server-side .NET API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="De volgende broncode laat zien hoe u een High-Low-Close Stock Chart maakt naar MS Excel XLSX-bestand met C#." offSpacer="" %}}
