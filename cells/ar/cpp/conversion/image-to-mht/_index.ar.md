---
title: C++ صورة إلى MHT - صورة لتحويل MHT
description: Aspose اكسل. قم بتحويل IMAGE إلى MHT بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى MHT. C++ حفظ الصورة في MHT. احفظ الصورة كـ MHT باستخدام C++.
...
هل تحتاج إلى تحويل ملفات IMAGE إلى MHT برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى MHT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى MHT عن طريق استدعاء طريقة Save().
1.  احصل على نتيجة تحويل IMAGE إلى MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل IMAGE إلى MHT" %}}
