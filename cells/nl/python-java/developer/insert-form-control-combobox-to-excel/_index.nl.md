---
title:  Voeg ComboBox (formulierbeheer) in Excel in met behulp van Python via java
weight: 20
description: Python via java-broncode om ComboBox (formulierbeheer) in Excel in te voegen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg ComboBox (formulierbeheer) in Excel in met behulp van Python via java" h2="Voeg objecten in met behulp van server-side API\'s zonder enige software zoals Microsoft of Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe ComboBox (formulierbesturing) in Excel-bestand in te voegen met behulp van Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ComboBox (formulierbesturing) in Excel-bestand in te voegen met behulp van Python via java" %}}
...
+ Selecteer werkblad via de index.
 + Gebruik de vormverzamelingen[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)) om een ComboBox (formulierbesturingselement) in het geselecteerde werkblad in te voegen.
...
- Elk besturingssysteem dat Python via javascripts kan uitvoeren, zoals Windows, Linux en MacOS
...
-  Installeer Aspose.Cells for Python via java van<a href="https://pypi.org/project/aspose-cells/">pypi</a> , gebruik commando als:<code>$ pip install aspose-cells</code>.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Insert ComboBox (Form control) - Python via java" offSpacer="" %}}
