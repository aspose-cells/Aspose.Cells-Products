...
description: Aspose Excel. Konwertuj XLSX na XLSB szybko i łatwo za pomocą Aspose.Cells. PHP XLSX na XLSB. PHP Zapisz XLSX na XLSB. Zapisz XLSX jako XLSB używając PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSX na XLSB w PHP" h2="Szybka biblioteka PHP do konwersji XLSX na XLSB. Jest to profesjonalne oprogramowanie do importowania i eksportowania XLSX, XLSB i wielu innych formatów przy użyciu PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Chcesz programowo przekonwertować pliki XLSX na XLSB? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na XLSB w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSX na numer XLSB, wywołując metodę zapisu skoroszytu.
