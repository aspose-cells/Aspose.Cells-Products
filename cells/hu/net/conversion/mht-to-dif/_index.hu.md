---
title: C# MHT - DIF - MHT - DIF konverter
description: Aspose Excel. Gyorsan és egyszerűen konvertálja az MHT-t DIF-re a Aspose.Cells-es számmal. C# MHT-DIF. C# Mentse el az MHT-t DIF-re. Mentse el az MHT-t DIF néven a 348173468 használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse el az MHT-t a DIF számra a C# számon" %}}

A következő példa bemutatja, hogyan lehet az MHT-t DIF-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód az MHT DIF-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Az MHT konvertálása DIF-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Az MHT-fájlokat programozottan DIF-re kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és konvertálhatják az MHT-t DIF-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja az MHT-t DIF-re a Workbook.Save metódus hívásával.
1.  Szerezd meg az MHT DIF számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT DIF-re konvertálásához" %}}
