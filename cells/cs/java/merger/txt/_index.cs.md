---
title:  Sloučit TXT Soubory via Java
weight: 4480
description: Java ukázkový kód pro spojení TXT dokumentů na Java Runtime Environment pro JSP/JSF aplikace a desktopové aplikace.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sloučit TXT formáty v Java" h2="Nativní slučování dokumentů TXT pomocí rozhraní API Java na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro sloučení souborů TXT v Java" %}}
...
+ Načtěte první soubor TXT s instancí třídy Workbook.
+ Načtěte druhý dokument TXT s instancí třídy Workbook.
+ Sloučit soubory pomocí metody Combined().
+ uložte sloučený soubor TXT do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Sloučit soubory TXT - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online TXT Živá ukázka sloučení" sectionDescription=" Sloučit dokumenty TXT právě teď návštěvou našeho[Webová stránka živé ukázky](https://products.aspose.app/cells/merger). Živé demo má následující výhody" >}}
