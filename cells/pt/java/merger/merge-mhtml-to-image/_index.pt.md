---
title: Mesclar MHTML para IMAGE - Combine MHTML para IMAGE em Java
url: /pt/java/merger/merge-mhtml-to-image/ 
description: Aspose Excel. Java Aspose.Cells. Mesclagem online gratuita MHTML para IMAGE saveformat. Java Combine MHTML para o formato IMAGEM. Mesclar MHTML para IMAGEM em Java. MHTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHTML para IMAGE em Java Online Gratuitamente" %}}

exemplo a seguir demonstra como mesclar MHTML com IMAGE em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHTML com IMAGE. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo IMAGE. Se você desenvolver código em Java, isso será mais simples do que parece. Veja o exemplo Java que mescla MHTML com IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar MHTML com IMAGEM em Java" InputFormat="mhtml" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHTML com a IMAGEM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar MHTML para IMAGE programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHTML para IMAGE" %}}
