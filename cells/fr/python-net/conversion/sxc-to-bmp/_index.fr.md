...
{{% blocks/products/pf/agp/content h2="Enregistrez SXC à BMP dans Python en ligne gratuitement" %}}

L'exemple suivant montre comment convertir SXC en BMP en Python via NET.
