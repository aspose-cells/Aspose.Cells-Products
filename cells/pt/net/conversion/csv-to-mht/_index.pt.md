---
title: C# CSV para MHT - CSV para Conversor MHT
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter CSV para o formato MHT, permitindo o salvamento perfeito de dados CSV no formato MHT usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve CSV para MHT em C#" %}}

O exemplo a seguir demonstra como converter CSV para MHT em C#.
{{% blocks/products/pf/agp/text %}}

Siga os passos simples para converter o arquivo CSV para MHT. Carregue o seu arquivo CSV e salve-o como um arquivo MHT. Tanto para leitura do arquivo CSV quanto para gravação em MHT, você pode usar nomes de arquivo totalmente qualificados. O conteúdo e a formatação do arquivo MHT resultante serão idênticos ao documento original CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter CSV em MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="csv" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter CSV para MHT através de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos CSV para MHT programaticamente? Os desenvolvedores de .NET podem facilmente carregar e converter arquivos CSV para MHT com apenas algumas linhas de código.
...
1.  Converta CSV para MHT chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de CSV para MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter CSV em MHT" %}}
