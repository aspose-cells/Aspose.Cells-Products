...
weight: 10
description: Vẽ hoặc chèn hình khuỷu tay bằng Aspose.Cells' Python via Java API không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v.
keywords: [Python Aspose.Cells., Python add elbow shape., Python insert elbow shape., Python create elbow shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn hình khuỷu tay vào Excel bằng Python via Java" h2="Chèn hình khuỷu tay dùng Aspose.Cells\' API không cần phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chèn hình khuỷu tay vào file excel bằng Python via Java" %}}

 Để chèn hình khuỷu tay vào file excel, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn hình khuỷu tay vào file Excel dùng Python via Java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) để chèn hình khuỷu tay vào trang tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn hình khuỷu tay - Python via Java" offSpacer="" %}}
