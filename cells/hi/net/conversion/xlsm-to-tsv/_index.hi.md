---
title: XLSM को TSV में C# के माध्यम से परिवर्तित करें

description: xlsm से tsv C# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर tsv रूपांतरण में बैच xlsm फ़ाइलों के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET डेवलपर कोड की कुछ ही पंक्तियों में आसानी से XLSM फ़ाइलों को TSV में लोड और रूपांतरित कर सकते हैं।
...
{{% cells-convert title="XLSM को TSV में बदलने के लिए नि:शुल्क ऐप और नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="tsv" IsLandingPage="true" %}}
