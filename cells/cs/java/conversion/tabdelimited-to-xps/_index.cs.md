---
title: Převést TABDELIMITED na XPS přes Java 
url: /cs/java/conversion/tabdelimited-to-xps/ 
description: Ukázkový konverzní kód Java pro formát TABDELIMITED na soubor XPS. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do XPS v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést TABDELIMITED na XPS přes Java" h2="Převod TABDELIMITED na XPS Java pro převod jedné nebo více stránek na XPS pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na XPS pomocí Java" %}}

 K vykreslení TABDELIMITED na XPS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na XPS prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor TABDELIMITED na XPS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TABDELIMITED s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XPS a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XPS
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze TABDELIMITED na XPS Java" offSpacer="" %}}

```cs
// načtěte soubor TABDELIMITED v instanci sešitu
Workbook book = new Workbook("template.tabdelimited");
// uložit TABDELIMITED jako XPS
