...
{{% blocks/products/pf/agp/content h2="Jak převést SXC do PDF pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC do PDF prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC do PDF pomocí několika řádků kódu.
