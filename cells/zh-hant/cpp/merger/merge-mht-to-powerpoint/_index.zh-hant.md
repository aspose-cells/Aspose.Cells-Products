---
title: 將 MHT 合併至 POWERPOINT - 在 C++ 中將 MHT 合併為 POWERPOINT
url: /zh-hant/cpp/merger/merge-mht-to-powerpoint/ 
description: Aspose Excel。 C++ Aspose.Cells. 將 MHT 合併為 POWERPOINT 儲存格式。 C++ 將 MHT 合併為 POWERPOINT 格式。將 MHT 合併到 C++ POWERPOINT 的 POWERPOINT。MHT 合併。
...
{{% blocks/products/pf/agp/content h2="將 MHT 合併到 C++ 中的 POWERPOINT" %}}

以下範例示範如何將 MHT 合併到 Aspose.Cells for C++ 中的 POWERPOINT。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 合併到 POWERPOINT。上傳文件，呼叫Workbook.Combine方法合併文件，然後將其儲存到POWERPOINT文件。如果您在 C++ 中開發程式碼，這會比聽起來更簡單。請參閱 C++ 將 MHT 合併為 POWERPOINT 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C++ 中將 MHT 合併到 POWERPOINT 的範例程式碼" InputFormat="mht" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 MHT 合併到 POWERPOINT" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 MHT 合併到 POWERPOINT？基本文檔合併和連接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需幾行程式碼即可完成 API。
