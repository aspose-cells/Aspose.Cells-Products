...
weight: 10
description: Βιβλιοθήκες για ανάγνωση, εγγραφή και χειρισμό αρχείων Excel σε εφαρμογές Android και SharePoint. Εξαγωγή φύλλων εργασίας σε SSRS και JasperReports.
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Επεξεργασία υπολογιστικών φύλλων Excel σε πολλαπλές πλατφόρμες" h2="Εγγενή API για δημιουργία, επεξεργασία, μετατροπή και απόδοση αρχείων Excel. Εξαγωγή υπολογιστικών φύλλων σε πολλαπλές μορφές σε οποιαδήποτε πλατφόρμα." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells.svg" pfName="Aspose.Cells" downloadUrl="https://downloads.aspose.com/cells" tryOnlineUrl="" >}}

{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/product-card-row title="Aspose.Cells Περιλαμβάνονται API υψηλού κώδικα" >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" productLink="/cells/net/" >}}
Target .NET Framework, .NET Core & πλατφόρμα Xamarin για την ανάπτυξη εφαρμογών για Windows, iOS, macOS & Android.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" productLink="/cells/java/" >}}
Εγγενή API Java για επιφάνεια εργασίας, web ή οποιοδήποτε είδος εφαρμογής που βασίζεται στο Java SE ή EE.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="C++" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" productLink="/cells/cpp/" >}}
Δημιουργήστε, διαβάστε, επεξεργαστείτε, μετατρέψτε ή αποδώστε μορφές υπολογιστικών φύλλων Excel μέσα από εφαρμογές C++.
{{< /blocks/products/pf/product >}}
...
Προσθέστε δυνατότητες χειρισμού υπολογιστικών φύλλων Excel στις εφαρμογές σας για κινητά Android.
{{< /blocks/products/pf/product >}}
...
Μετατρέψτε και συνδυάστε υπολογιστικά φύλλα Excel στις Υπηρεσίες SharePoint Services ή στον SharePoint Server.
{{< /blocks/products/pf/product >}}
...
Φόρτωση, δημιουργία, χειρισμός και απόδοση εγγράφων Excel χρησιμοποιώντας το Python.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/product pfName="Aspose.Cells for" title="Node.js μέσω C++" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" productLink="/cells/nodejs-cpp/" >}}
Δημιουργήστε, χειριστείτε, μετατρέψτε και αποδώστε υπολογιστικά φύλλα Excel μέσω του Node.js.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="Πηγαίνετε στο C++" imgSrc="/cells/images/aspose_cells-for-go.svg" productLink="/cells/go-cpp/" >}}
Δημιουργήστε, χειριστείτε, μετατρέψτε και αποδώστε υπολογιστικά φύλλα Excel μέσω του Go.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="JavaScript μέσω C++" imgSrc="/cells/images/aspose_cells-for-javascript-cpp.svg" productLink="/cells/javascript-cpp/" >}}
Δημιουργήστε, χειριστείτε, μετατρέψτε και αποδώστε υπολογιστικά φύλλα Excel σε Browser ή Node.js.
{{< /blocks/products/pf/product >}}
