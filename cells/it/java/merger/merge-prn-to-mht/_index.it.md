---
title: Unisci PRN a MHT - Combina PRN a MHT in Java
url: /it/java/merger/merge-prn-to-mht/ 
description: Aspose Excel. Java Aspose.Cells. Merge PRN online gratuito in formato di salvataggio MHT. Java Combina il formato PRN con quello MHT. Unisci PRN a MHT in Java. PRN Merge.
...
{{% blocks/products/pf/agp/content h2="Unisci PRN a MHT in Java online gratuitamente" %}}

L'esempio seguente mostra come unire PRN a MHT in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire PRN a MHT. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file MHT. Se sviluppi il codice in Java, sarà più semplice di quanto sembri. Vedere l'esempio Java che unisce PRN a MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire PRN a MHT in Java" InputFormat="prn" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Come unire PRN a MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Hai bisogno di unire PRN a MHT in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Java libreria per unire PRN a MHT" %}}
