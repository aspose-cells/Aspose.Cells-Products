---
title: Konvertera SXC till MHTML via Java 

description: Exempel Java-konverteringskod för SXC-format till MHTML-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till MHTML inom alla webb- eller skrivbordsbaserade Javaapplikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera SXC till MHTML via Java" h2="SXC till MHTML Java-konvertering för att konvertera enstaka eller flera sidor till MHTML med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till MHTML med Java" %}}

 För att rendera SXC till MHTML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till MHTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera SXC-fil till MHTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SXC-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med MHTML-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande MHTML-filen
...
{{% blocks/products/pf/agp/code-block title="SXC till MHTML Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC till MHTML Conversion Live Demos" sectionDescription="[Konvertera SXC till MHTML](https://products.aspose.app/cells/conversion/sxc-to-mhtml) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din SXC-fil, den konverteras omedelbart till MHTML." >}}
