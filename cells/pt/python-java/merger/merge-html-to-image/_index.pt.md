---
title: Mesclar HTML com IMAGE - Combinar HTML com IMAGE em Python
url: /pt/python-java/merger/merge-html-to-image/ 
description: Aspose Excel. Python Excel. Mesclar HTML para salvar o formato IMAGE. Python Combine HTML para o formato IMAGEM. Mesclar HTML com IMAGE na biblioteca Python Excel. HTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com IMAGE usando a biblioteca Python do Excel" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com IMAGE na biblioteca Python Excel" %}}

O exemplo a seguir demonstra como mesclar HTML com IMAGE em Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar HTML com IMAGE. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os no arquivo IMAGE. Se você desenvolver código em Python, será mais simples do que parece. Veja o exemplo Python que mescla HTML com IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemplo de código para mesclar HTML com IMAGE na biblioteca Python Excel" InputFormat="html" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar HTML com IMAGE por meio da biblioteca Python Excel" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar HTML com IMAGE programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para mesclar HTML com IMAGE" %}}
