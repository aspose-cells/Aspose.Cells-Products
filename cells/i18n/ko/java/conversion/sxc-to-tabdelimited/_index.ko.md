---
title: Java을(를) 통해 SXC를 TABDELIMITED로 변환 
url: /ko/java/conversion/sxc-to-tabdelimited/ 
description: SXC 형식을 TABDELIMITED 파일로 변환하는 샘플 Java 변환 코드. 프로그래머는 이 예제 코드를 사용하여 웹 또는 데스크톱 Java 기반 응용 프로그램 내에서 Excel 및 OpenOffice 스프레드시트를 TABDELIMITED로 내보낼 수 있습니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java을(를) 통해 SXC를 TABDELIMITED로 변환" h2="SXC에서 TABDELIMITED Java로의 변환은 온프레미스 Java 라이브러리를 사용하여 단일 또는 여러 페이지를 TABDELIMITED로 변환합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 SXC를 TABDELIMITED로 변환하는 방법" %}}

 SXC를 TABDELIMITED로 렌더링하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java을(를) 통해 SXC를 TABDELIMITED로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Java 개발자는 몇 줄의 코드로 SXC 파일을 TABDELIMITED로 쉽게 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. Workbook 클래스의 인스턴스로 SXC 파일 로드1. Workbook.save 메서드 호출1. TABDELIMITED 확장자 및 SaveFormat을 매개변수로 사용하여 출력 경로 전달1. 결과 TABDELIMITED 파일에 대해 지정된 경로 확인
...
{{% blocks/products/pf/agp/code-block title="SXC에서 TABDELIMITED Java 변환 소스 코드" offSpacer="" %}}

```cs
// 통합 문서 인스턴스에서 SXC 파일 로드
Workbook book = new Workbook("template.sxc");
// SXC를 TABDELIMITED로 저장
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC에서 TABDELIMITED로의 변환 라이브 데모" sectionDescription="[SXC를 TABDELIMITED로 변환](https://products.aspose.app/cells/conversion/sxc-to-tabdelimited) 지금 바로 라이브 데모 웹사이트를 방문하세요. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API을(를) 다운로드할 필요가 없습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 코드를 작성할 필요가 없습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" SXC 파일을 업로드하기만 하면 즉시 TABDELIMITED로 변환됩니다." >}}
