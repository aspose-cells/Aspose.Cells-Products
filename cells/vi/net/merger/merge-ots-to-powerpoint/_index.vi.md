...
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí OTS sang định dạng lưu POWERPOINT. C# Gộp định dạng OTS sang POWERPOINT. Hợp nhất OTS vào POWERPOINT trong C#. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS với POWERPOINT trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất OTS với POWERPOINT trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất OTS với POWERPOINT. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu tệp đó vào tệp POWERPOINT. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất OTS với POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất OTS với POWERPOINT trong C#" InputFormat="ots" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp OTS vào POWERPOINT qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất OTS với POWERPOINT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để gộp OTS vào POWERPOINT" %}}
