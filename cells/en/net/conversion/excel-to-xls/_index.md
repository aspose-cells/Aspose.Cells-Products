...
description: Free Online EXCEL Converter. Convert EXCEL to XLS Online for Free. Convert EXCEL to XLS in C# code. Convert EXCEL to XLS using C#.
keywords: Convert EXCEL, EXCEL Converter, EXCEL to PDF, EXCEL to Word, EXCEL to PPT, EXCEL to Image
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert EXCEL to XLS via C#" h2="High-speed C# library for converting EXCEL to XLS. Export Excel spreadsheets to XLS format on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert EXCEL to XLS in just a few lines of code.
