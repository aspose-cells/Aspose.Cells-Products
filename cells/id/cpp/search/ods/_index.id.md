---
title:  Cari dokumen ODS tanpa membukanya melalui C++
weight: 3300
description: C++ contoh kode untuk mencari kata dengan pola dalam file ODS pada Runtime Environment C++ untuk Windows 32 bit, Windows 64 bit dan Linux 64 bit.
...
{{% blocks/products/pf/agp/content h2="Cara Mencari File ODS Menggunakan C++" %}}
 ...
 Untuk mencari file ODS, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mencari File ODS di C++" %}}
