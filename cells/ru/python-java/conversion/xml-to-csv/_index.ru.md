...
{{% blocks/products/pf/agp/content h2="Преобразование XML в CSV с использованием библиотеки Excel Python" %}}
