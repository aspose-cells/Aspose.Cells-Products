---
title: C# PNG - MHT - PNG - MHT átalakító
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára a PNG MHT formátumba konvertálásához, lehetővé téve a PNG adatok zökkenőmentes mentését MHT formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Spóroljon PNG-et MHT-re C#-ben" %}}

A következő példa bemutatja, hogyan lehet a PNG számot MHT-vé alakítani a C# számban.
...
{{% cells-convert title="Mintakód a PNG MHT-vé konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hogyan lehet a PNG-et MHT-vé konvertálni a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell MHT formátumba konvertálni a PNG fájlokat? A .NET fejlesztői könnyedén betölthetik és MHT formátumba konvertálhatják a PNG fájlokat mindössze néhány sornyi kóddal.
...
1.  Alakítsd át a PNG-et MHT-vé a Workbook.Save metódus meghívásával.
1.  Szerezd meg a PNG MHT-re való átváltási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a PNG MHT-vé konvertálásához" %}}
