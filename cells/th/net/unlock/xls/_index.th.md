...
weight: 4260
description: C# ซอร์สโค้ดเพื่อปลดล็อคไฟล์ XLS ที่ป้องกันด้วยรหัสผ่านบน .NET Framework, .NET Core, Mono หรือแพลตฟอร์ม Xamarin
...
{{< blocks/products/pf/i18n/upper-banner h1="ปลดล็อค XLS สเปรดชีต ผ่าน C#" h2="ลบการป้องกันออกจาก XLS โดยใช้ไลบรารี .NET" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีปลดล็อกไฟล์ XLS โดยใช้ C#" %}}
 ...
 เพื่อลบไฟล์การป้องกัน XLS เราจะใช้
