---
title: Mesclar XLSB para MHT - Combine XLSB para MHT em Java
url: /pt/java/merger/merge-xlsb-to-mht/ 
description: Aspose Excel. Java Aspose.Cells. Mesclagem on-line gratuita XLSB para MHT saveformat. Java Combine XLSB para o formato MHT. Mesclar XLSB para MHT em Java. XLSB Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLSB para MHT em Java Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar XLSB com MHT em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLSB com MHT. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo MHT. Se você desenvolver código em Java, isso será mais simples do que parece. Consulte o exemplo Java que mescla XLSB com MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLSB para MHT em Java" InputFormat="xlsb" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLSB para MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar XLSB para MHT programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar XLSB para MHT" %}}
