---
title:  Wstaw RadioButton (kontrolka formularza) do programu Excel przy użyciu Python via .Net
weight: 60
description: Python via Kod źródłowy .Net umożliwiający wstawienie RadioButton (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić RadioButton (kontrolka formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić RadioButton (kontrolka formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj dodatku do kolekcji kształtów[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) aby wstawić RadioButton (kontrolka formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw RadioButton (kontrolka formularza) - Python via .Net" offSpacer="" %}}
