---
title: Insérer des notes dans le fichier ODS via Python
url: /fr/python-java/notes/insert-notes-to-ods/ 
description: Insérez des notes dans ODS à l'aide de Python. Utilisez l'exemple de code API pour insérer des notes dans l'application Python.
...
{{% blocks/products/pf/agp/content h2="Insérer des notes dans le fichier ODS en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Comment insérer des notes dans le fichier ODS via Python" %}}
...
Dans Office 365, les notes sont destinées aux annotations, vous pouvez utiliser le code Python suivant pour insérer et supprimer des notes dans le fichier ODS.

{{% blocks/products/pf/agp/code-block title="Exemple de code Python pour insérer et supprimer des notes dans le fichier ODS" offSpacer="" %}}
