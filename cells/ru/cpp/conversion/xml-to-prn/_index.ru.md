...
Нужно программно преобразовать XML-файлы в PRN? Разработчики, использующие код C++, могут легко преобразовать XML в PRN всего за несколько строк кода.
...
1.  Преобразуйте XML в PRN, вызвав метод Save().
