...
url: /zh/python-net/merger/merge-jpg-to-md/ 
...
下面的例子演示了如何将Aspose.Cells for Python via .NET中的JPG合并为MD。
...
需要以编程方式将 JPG 合并到 MD 吗？基本文档合并和连接[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)只需几行代码即可完成 API。
