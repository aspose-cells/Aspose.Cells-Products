...
Behöver du konvertera HTML-filer till TIFF programmatiskt? C++-utvecklare kan enkelt konvertera HTML till TIFF på bara några rader kod.
...
1.  Konvertera HTML till TIFF genom att anropa metoden Save().
