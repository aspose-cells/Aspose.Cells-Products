---
title: "TSV konvertálása XLTX-re a következőn keresztül: C#"
url: /hu/net/conversion/tsv-to-xltx/
description: Mintakód a tsv–xltx C# konverzióhoz. Használjon API példakódot a tsv fájlok kötegelt xltx konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a TSV-fájlokat XLTX-re.
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód a TSV XLTX-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xltx" IsLandingPage="true" %}}
