...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء XLT عبر C#" %}}
...
1.  استخدم طريقة Save لحفظ المصنف كملف XLT.

{{% blocks/products/pf/agp/code-block title="نموذج التعليمات البرمجية لإنشاء ملف MS Excel XLT باستخدام C#." offSpacer="" %}}
