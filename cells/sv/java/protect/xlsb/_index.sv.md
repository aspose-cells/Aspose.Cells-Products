...
{{% blocks/products/pf/agp/content h2="Så här säkrar du XLSB-fil med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skydda XLSB-filer via Java" %}}
...
1. Ladda XLSB-fil genom att instansiera Workbook-klassen1. Använd protect(..)-metoden med ProtectionType och Password1. Spara den skyddade XLSB-filen med save()-metoden
