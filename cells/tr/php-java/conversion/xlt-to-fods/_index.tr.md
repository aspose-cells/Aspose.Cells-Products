---
title: PHP XLT ila FODS - XLT ila FODS Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde XLT'i FODS'e dönüştürün. PHP XLT'i FODS'e dönüştürün. PHP XLT'i FODS'e kaydedin. PHP kullanarak XLT'i FODS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLT\'i FODS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLT dosyalarını program aracılığıyla FODS'e dönüştürmeniz mi gerekiyor? PHP geliştiricileri sadece birkaç satır kodla XLT'i FODS'e kolayca yükleyebilir ve dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLT'i FODS'e dönüştürün.
1.  XLT'den FODS'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLT\'i FODS\'e dönüştürmek için PHP kütüphanesi" %}}
