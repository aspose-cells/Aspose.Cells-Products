...
Follow the easy steps to convert NUMBERS into HTML. Upload your NUMBERS file, then simply save it as HTML file. For both NUMBERS reading and HTML writing you can use fully qualified filenames. The output HTML content and formatting will be identical to the original NUMBERS document.
