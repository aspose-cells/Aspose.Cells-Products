...
description: Aspose เอ็กเซล. แปลง TSV เป็น OTS อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Java TSV เป็น OTS Java บันทึก TSV ไปที่ โอทีเอส. บันทึก TSV เป็น OTS โดยใช้ Java
...
{{% blocks/products/pf/agp/content h2="บันทึก TSV ไปที่ OTS ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง TSV เป็น OTS ใน Java
