---
title: C# FODS 转 HTM - FODS 转 HTM 转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 FODS 转换为 HTM 格式，从而能够使用 Aspose.Cells 库将 FODS 数据无缝保存为 HTM 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 FODS 保存到 HTM，即 C#" %}}
...
{{% cells-convert title="将 FODS 转换为 HTM 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 FODS 转换为 HTM" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 FODS 文件转换为 HTM 格式吗？.NET 开发人员只需几行代码即可轻松加载 FODS 文件并将其转换为 HTM 格式。
...
{{% blocks/products/pf/agp/content h2="使用 C# 库将 FODS 转换为 HTM" %}}
