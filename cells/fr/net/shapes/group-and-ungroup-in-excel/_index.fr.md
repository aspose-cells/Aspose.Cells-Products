...
weight: 340
description: C# code source pour regrouper et dissocier des formes dans Excel sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
...
+ Sélectionnez Feuille de calcul via son index.
 ...
 + Utilisez le[dissocier la méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/) pour dissocier des formes dans la feuille de calcul sélectionnée
