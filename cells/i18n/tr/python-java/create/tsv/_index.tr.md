...
{{% blocks/products/pf/agp/feature-section-col title="Python üzerinden TSV Nasıl Oluşturulur" %}}
...
1. Asposecell'leri kod dosyanıza aktarın.1. Workbook sınıfı örneği oluşturun.1. Çalışma kitabının ilk çalışma sayfasına erişin.1. Çalışma sayfasının istediğiniz hücresini/hücrelerini alın ve değeri hücreye/hücrelere girin.1. Çalışma kitabını TSV dosyası olarak kaydetmek için Kaydet yöntemini kullanın.
...
{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kod, Python kullanılarak bir TSV dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
