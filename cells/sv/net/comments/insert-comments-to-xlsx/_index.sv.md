---
title: Infoga kommentarer till XLSX fil via .NET
url: /sv/net/comments/insert-comments-to-xlsx/ 
description: Infoga kommentarer till XLSX med C#. Använd API exempelkod för att infoga kommentarer i .NET-applikationen.
...
{{% blocks/products/pf/agp/content h2="Hur man infogar kommentarer i XLSX-filen via C#" %}}
...
Office 365 är kommentarer för konversationer, du kan använda följande C#-kod för att infoga och ta bort kommentarer i XLSX-filen.

{{% blocks/products/pf/agp/code-block title="C# exempelkod för att infoga och ta bort kommentarer i filen XLSX" offSpacer="" %}}
