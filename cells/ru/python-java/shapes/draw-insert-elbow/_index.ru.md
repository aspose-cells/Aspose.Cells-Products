---
title: Как нарисовать или вставить форму локтя в Excel, используя Python via Java
weight: 10
...
{{% blocks/products/pf/agp/content h2="Как вставить форму локтя в файл Excel, используя Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги, чтобы вставить форму локтя в файл Excel, используя Python via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить форму локтя в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка угловая - Python via Java" offSpacer="" %}}
