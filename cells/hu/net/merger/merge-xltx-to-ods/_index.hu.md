---
title: A XLTX-ODS-es számok egyesítése – a XLTX-es és a ODS-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-xltx-to-ods/ 
description: Aspose Excel. C# Aspose.Cells. A XLTX és a ODS mentési formátum egyesítése. C# A XLTX és a ODS formátum kombinálása. Egyesítse a XLTX-ODS-et a C#-ben. XLTX Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A XLTX és a ODS egyesítése a C#-ben" %}}

A következő példa bemutatja a XLTX és a ODS egyesítését a Aspose.Cells for .NET számban.
...
{{% cells-merger title="Mintakód a XLTX és ODS közötti egyesítéshez a C#-ben" InputFormat="xltx" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLTX és a ODS egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLTX-et a ODS-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
