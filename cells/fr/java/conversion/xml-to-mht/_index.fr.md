---
title: Java XML en MHT - Convertisseur XML en MHT
description: Aspose Exceller. Convertissez XML en MHT rapidement et facilement avec Aspose.Cells. Java XML en MHT. Java Enregistrez XML dans MHT. Enregistrez XML au format MHT en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML dans MHT au Java" %}}

L'exemple suivant montre comment convertir XML en MHT dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XML en MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en MHT par programme ? Les développeurs Java peuvent facilement convertir XML en MHT en quelques lignes de code seulement.
