---
title: Python MHT - FODS - MHT - FODS konverter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a Python fejlesztők számára az MHT FODS formátumba konvertálásához, lehetővé téve az MHT adatok zökkenőmentes mentését FODS formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható Python kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="MHT konvertálása FODS-re a Python Excel könyvtárban" h2="Nagy sebességű Python excel könyvtár az MHT FODS formátummá konvertálásához. Ez egy professzionális szoftvermegoldás MHT, FODS és sok más formátum importálásához és exportálásához Python használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="MHT konvertálása FODS-re a Python Excel könyvtár használatával" %}}

Hogyan konvertálhatom át az MHT-t FODS-re? A Aspose.Cells for Python könyvtárral könnyedén konvertálhatja az MHT-t FODS-re programozottan néhány sornyi kóddal.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)képes többplatformos alkalmazások létrehozására, amelyek képesek az összes Excel fájl generálására, módosítására, konvertálására, renderelésére és nyomtatására. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="MHT mentése a FODS számra a Python Excel könyvtárban" %}}

A következő példa bemutatja, hogyan lehet az MHT-t FODS-re konvertálni a Python Excel könyvtárban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket az MHT FODS-re konvertálásához. Töltse fel MHT-fájlját, majd egyszerűen mentse el FODS fájlként. Mind az MHT-olvasáshoz, mind a FODS íráshoz használhat teljesen minősített fájlneveket. A FODS kimeneti tartalom és formázás megegyezik az eredeti MHT dokumentuméval.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mintakód az MHT konvertálásához FODS-re a Python Excel könyvtáron keresztül" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="fods" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Az MHT konvertálása FODS-re a Python-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Az MHT-fájlokat programozottan FODS-re kell konvertálni? A Python fejlesztők egyszerűen betölthetik és konvertálhatják az MHT-t FODS-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja az MHT-t FODS-re a Workbook.save metódus hívásával.
1. Szerezd meg az MHT FODS számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel-könyvtár az MHT FODS-re konvertálásához" %}}
