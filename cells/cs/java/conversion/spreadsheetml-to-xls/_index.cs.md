---
title: Java SPREADSHEETML na XLS - Online převodník SPREADSHEETML na XLS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Online zdarma Java Převeďte SPREADSHEETML na XLS saveformat. Java SPREADSHEETML do formátu XLS. Uložte SPREADSHEETML na XLS Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převést SPREADSHEETML na XLS v Java" h2="Vysokorychlostní knihovna Java pro převod SPREADSHEETML na XLS. Jedná se o profesionální softwarové řešení pro import a export SPREADSHEETML, XLS a mnoha dalších formátů pomocí Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Uložit SPREADSHEETML na XLS v Java online zdarma" %}}

Následující příklad ukazuje, jak převést SPREADSHEETML na XLS v Java.
...
{{% blocks/products/pf/agp/content h2="Jak převést SPREADSHEETML na XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory SPREADSHEETML na XLS programově? Java vývojáři mohou snadno převést SPREADSHEETML na XLS v několika řádcích kódu.
...
1.  Převeďte SPREADSHEETML na XLS voláním metody Workbook.save.
1.  Získejte výsledek převodu SPREADSHEETML na XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod SPREADSHEETML na XLS" %}}
{{% blocks/products/pf/agp/text %}}
