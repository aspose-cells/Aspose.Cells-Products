---
title: Konvertor PHP MHTML až DOCX - MHTML až DOCX
description: Aspose Excel. Převeďte MHTML na DOCX rychle a snadno pomocí Aspose.Cells. PHP MHTML na DOCX. PHP Uložte MHTML na DOCX. Uložte DOCX jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na DOCX přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na DOCX programově? Vývojáři PHP mohou snadno načíst a převést MHTML na DOCX v několika řádcích kódu.
...
1.  Převeďte MHTML na DOCX voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na DOCX" %}}
