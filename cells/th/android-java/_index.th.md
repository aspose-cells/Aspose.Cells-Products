...
weight: 6510
description: ไลบรารีสเปรดชีต Android เพื่อสร้างการอ่านเขียนและแยกวิเคราะห์ไฟล์ Excel สเปรดชีต API สำหรับการพัฒนาแอปบนมือถือ
---
...
<p>
 Aspose.Cells for Android via Java เป็น API ที่ปรับขนาดได้เพื่อสร้าง รวม แก้ไข และแยกวิเคราะห์สเปรดชีตโดยทางโปรแกรม API มีฟังก์ชันมากมาย รวมถึงการจัดรูปแบบเอกสาร Excel และงานการตั้งค่าหน้า ความสามารถในการนำเข้าและส่งออก แสดงหน้าเวิร์กชีทเป็นภาพแรสเตอร์ ตลอดจนระบุความละเอียดของภาพ คุณภาพ การบีบอัด การเพิ่มแผนภูมิต่างๆ และอื่นๆ อีกมากมาย สเปรดชีต Android API รองรับ XLS, XLSX, CSV, SpreadsheetML, ODS, Tab Delimited, HTML, PDF, XPS และรูปแบบอื่นๆ
</p>
...
{{< blocks/products/pf/carousel-item h3="ความเป็นอิสระของแพลตฟอร์ม" description="Aspose.Cells for Android via Java ได้ครับ for Android 2.0 ขึ้นไป." >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description="สเปรดชีต Android API รองรับรูปแบบ Excel รูปภาพ และรูปแบบเค้าโครงคงที่ยอดนิยม Microsoft" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 คุณสมบัติขั้นสูงของ Android Excel API
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
ใช้การจัดรูปแบบกับเวิร์กชีต แถว คอลัมน์ เซลล์ และช่วง
    </p>
   </div>
   <div class="col-lg-4">
 ...
 กำหนดค่าการตั้งค่าเพจ
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 ตั้งค่า &amp; จัดการตัวกรองอัตโนมัติ &amp; ตัวแบ่งหน้า
    </p>
   </div>
   <div class="col-lg-4">
 ...
 สร้างสำเนาของแผ่นงานที่มีอยู่
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 ตั้งค่าตัวเลือกการป้องกันที่นำมาใช้ตั้งแต่ Microsoft Excel XP
    </p>
   </div>
   <div class="col-lg-4">
...
-->
 ...
 สร้าง &amp; จัดการแผนภูมิที่กำหนดเอง
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 ติดตามแบบอย่างและผู้อยู่ในความอุปการะ
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-edit ico-blue fa-2x col-lg-2">
...
โปรแกรมคำนวณสูตรอันทรงพลัง
 ...
 การแปลงรูปแบบต่างๆ
    ...
    <p>
 ไลบรารี Android Excel เสนอการแปลงสเปรดชีตเป็น XPS, PDF &amp; HTML รักษาความคมชัดของภาพสูงสุด กระบวนการแปลงที่เชื่อถือได้ทำให้ API เป็นตัวเลือกที่สมบูรณ์แบบสำหรับบริษัทในการแลกเปลี่ยนไฟล์ในรูปแบบมาตรฐานอุตสาหกรรม
    </p>
...
<p>Aspose.Cells for Android via Java gives you complete freedom and flexibility to furnish your spreadsheets with all kinds of visual effects. The API allows you to apply different fonts with attributes, cell styles (alignment, indentation, rotation, borders, shading and coloring, protection, text wrapping and shrinking) and all types of number formats. Similarly, charts and graphics are visually appealing and can give your spreadsheet a professional look. Aspose.Cells for Android via Java provides a comprehensive set of APIs for creating and manipulating all of the standard and custom chart types. Moreover, you may add different types of drawing objects, such as comments, pictures, OLE objects, shapes and controls to the cells.</p>
 ...
 แปลงวัตถุสเปรดชีตเป็นรูปแบบต่างๆ
    ...
    <p>
 Aspose.Cells for Android via Java นำเสนอคุณสมบัติที่โดดเด่นบางอย่าง เช่น แผ่นงานไปยังรูปภาพ แผนภูมิไปยังรูปภาพ &amp; PDF และสเปรดชีตเป็น PDF การแปลงรูปแบบเอกสาร กระบวนการที่ยืดหยุ่นมีตัวเลือกมากมายสำหรับการแปลง เช่น การสุ่มตัวอย่างรูปภาพใหม่ในสเปรดชีตเป็น PDF หรือการตั้งค่าขนาดรูปภาพผลลัพธ์เมื่อเรนเดอร์เวิร์กชีต &amp; แผนภูมิเป็นรูปแบบภาพ
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
สเปรดชีต API เครื่องมือคำนวณสูตร
    ...
    <p>
 ชีต Android API มีเครื่องมือคำนวณสูตรที่มีประสิทธิภาพ ซึ่งรองรับฟังก์ชันและสูตร Excel ขั้นสูงและมาตรฐาน Microsoft โปรแกรมคำนวณสูตรทำให้ง่ายต่อการอ่าน ตั้งค่า และคำนวณผลลัพธ์ของสูตรอ้างอิงประเภทอาร์เรย์และ R1C1 ในตัวหรือเพิ่มเติม
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="เอกสารประกอบ" href="https://docs.aspose.com/cells/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="ทำไม Aspose.Cells for Android via Java?" tabId="success-stories" >}}
