---
title: 在 XLS 文件 via .NET 中產生報告
weight: 1700
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上產生 XLS 格式報告。
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 組裝 XLS 的步驟" %}}
...
1. 透過 WorkbookDesigner.Worbook.Save 方法將結果儲存為 XLS 格式
...
{{% blocks/products/pf/agp/code-block title="產生 XLS 報告" offSpacer="" %}}
