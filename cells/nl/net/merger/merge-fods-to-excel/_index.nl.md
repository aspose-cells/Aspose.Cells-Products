...
Het volgende voorbeeld laat zien hoe u FODS kunt samenvoegen met EXCEL in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u FODS programmatisch samenvoegen met EXCEL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om FODS samen te voegen tot EXCEL" %}}
