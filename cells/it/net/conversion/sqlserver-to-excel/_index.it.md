---
title: C# SqlServer in EXCEL - Convertitore SqlServer in EXCEL
description: Aspose Excel. Converti SqlServer in EXCEL in modo rapido e semplice con Aspose.Cells. C# SqlServer in EXCEL. C# Salva SqlServer in EXCEL. Salva SqlServer come EXCEL utilizzando C#.
...
{{% blocks/products/pf/agp/content h2="Come convertire SqlServer in EXCEL tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i dati SqlServer in EXCEL a livello di codice? .NET gli sviluppatori possono caricare e convertire facilmente SqlServer in EXCEL in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1.  Installa 'Aspose.Cells for .NET'.
1.  Aggiungi un riferimento di libreria (importa la libreria) al tuo progetto C#.
1.  Eseguire una query sui dati dal database SqlServer per ottenere un oggetto DataTable.
...
{{% blocks/products/pf/agp/code-block title="Codice di esempio per convertire SqlServer in EXCEL - C#" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria C# per convertire SqlServer in EXCEL" %}}
