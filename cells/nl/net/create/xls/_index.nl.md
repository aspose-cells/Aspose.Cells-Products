...
{{% blocks/products/pf/agp/content h2="Hoe XLS te maken in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Het is gemakkelijk voor de ontwikkelaars om XLS-bestanden te maken, laden, wijzigen en converteren binnen verschillende rapportagetoepassingen voor gegevensverwerking in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een XLS-bestand maakt in C#." offSpacer="" %}}
