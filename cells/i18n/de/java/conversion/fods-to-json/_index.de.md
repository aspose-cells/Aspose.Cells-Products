...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie FODS mit Java in JSON" %}}

 Um FODS in JSON zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von FODS in JSON über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können die FODS-Datei in nur wenigen Codezeilen problemlos in JSON konvertieren.
...
{{% blocks/products/pf/agp/code-block title="FODS-zu-JSON-Java-Umwandlungsquellcode" offSpacer="" %}}
