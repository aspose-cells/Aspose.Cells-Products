---
title: Convertir HTML en XPS via C#
url: /fr/net/conversion/html-to-xps/
description: Exemple de code pour la conversion html vers xps C#. Utilisez API exemple de code pour la conversion de fichiers html par lots en xps dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTML en XPS via C#" h2="Exportez des feuilles de calcul Excel® au format XPS sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers HTML en XPS en quelques lignes de code seulement.
