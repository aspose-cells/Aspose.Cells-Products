---
title: C# XLSB à OTS - Convertisseur en ligne XLSB à OTS
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir XLSB en format de sauvegarde OTS. C# XLSB au format OTS. Enregistrez XLSB à OTS C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à OTS en C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en OTS dans C#.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en OTS en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en OTS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en OTS par programmation ? Les développeurs de .NET peuvent facilement charger et convertir XLSB en OTS en quelques lignes de code.
