...
description: Sample code for html to xltx C# conversion. Use API example code for batch html files to xltx conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert HTML to XLTX Using C#" %}}
 ...
 In order to convert HTML to XLTX, we will use
