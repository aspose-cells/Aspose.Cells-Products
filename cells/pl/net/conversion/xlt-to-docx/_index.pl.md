---
title: Konwertuj XLT na DOCX przez C#
url: /pl/net/conversion/xlt-to-docx/
description: Przykładowy kod konwersji xlt do docx C#. Użyj przykładowego kodu API dla wsadowych plików xlt do konwersji docx w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na DOCX za pomocą C#" %}}

 Aby przekonwertować XLT na DOCX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na DOCX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki XLT do formatu DOCX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem DOCX jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku DOCX
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLT na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="docx" IsLandingPage="true" %}}
