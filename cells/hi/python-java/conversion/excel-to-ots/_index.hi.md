---
title: Python एक्सेल से ओटीएस - एक्सेल से ओटीएस कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ एक्सेल को ओटीएस में जल्दी और आसानी से बदलें। Python एक्सेल को ओटीएस में बदलें। Python एक्सेल को ओटीएस में सहेजें। Python का उपयोग करके एक्सेल को ओटीएस के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="Python में EXCEL को OTS में सेव करें" %}}
...
{{% cells-convert title="एक्सेल को ओटीएस में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ots" IsLandingPage="true" language="pythonjava" %}}
