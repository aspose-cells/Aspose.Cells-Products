---
title:  Python via .Net を使用して GroupBox (フォーム コントロール) を Excel に挿入します。
weight: 40
description: Python via Excel に GroupBox(フォーム コントロール)を挿入するための .Net ソース コード。
...
{{% blocks/products/pf/agp/content h2="Python via .Net を使用して Excel ファイルにグループ ボックス (フォーム コントロール) を挿入する方法" %}}

GroupBox(フォームコントロール)をExcelファイルに挿入するには、次を使用します。
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net を使用して Excel ファイルに GroupBox (フォーム コントロール) を挿入する手順" %}}
...
+ インデックスからワークシートを選択します。
 シェイプコレクションの追加を使用します[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_group_box/#int-int-int-int-int-int)選択したワークシートにグループボックス(フォームコントロール)を挿入します。
...
{{% blocks/products/pf/agp/code-block title="GroupBox (フォーム コントロール) の挿入 - Python via .Net" offSpacer="" %}}
