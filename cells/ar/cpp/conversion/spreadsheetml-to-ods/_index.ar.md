---
title: تحويل SPREADSHEETML إلى ODS عبر تطبيق C++ 
url: /ar/cpp/conversion/spreadsheetml-to-ods/ 
description: نموذج C++ كود التحويل لوثيقة SPREADSHEETML إلى تنسيق ODS. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل SPREADSHEETML دفعة واحدة إلى ODS داخل أي تطبيق C++.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل SPREADSHEETML إلى ODS باستخدام C++" %}}

 من أجل تحويل SPREADSHEETML إلى ODS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل SPREADSHEETML إلى ODS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ بسهولة تحويل ملف SPREADSHEETML إلى ODS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف SPREADSHEETML باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد ملف (ODS).1. سيتم حفظ ملف ODS في المسار المحدد.1. افتح ملف ODS في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML إلى شفرة مصدر تحويل ODS C++" offSpacer="" %}}
