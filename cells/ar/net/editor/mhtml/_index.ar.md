...
description: C# الكود المصدري لتحرير مستند MHTML على .NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحرير MHTML ملف في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="تحرير MHTML ملفات - C#" offSpacer="" %}}
...
Aspose.Cells API يمكن استخدامه لإنشاء وتحرير وتحويل وتقديم Microsoft تنسيقات Excel إلى تنسيقات مختلفة. علاوة على ذلك، يمكن استخدامه للرسوم البيانية الشاملة وإعداد التقارير القابلة للتطوير والحسابات الموثوقة داخل تطبيقات البرامج. Aspose.Cells هو API مستقل ولا يتطلب أي برامج مثل Microsoft أو OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="على الانترنت MHTML محرر العروض الحية" sectionDescription=" قم بتحرير مستندات MHTML الآن من خلال زيارة موقعنا[موقع العروض الحية](https://products.aspose.app/cells/editor). يتمتع العرض التجريبي المباشر بالمزايا التالية" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="فقط قم بتحميل ملفاتك MHTML، استخدم المحرر عبر الإنترنت للتحرير على الفور." >}}
