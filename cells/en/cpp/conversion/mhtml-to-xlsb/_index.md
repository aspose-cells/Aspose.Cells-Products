...
description: Sample C++ conversion code for MHTML document to XLSB format. Programmers can use this source code for batch MHTML to XLSB conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="MHTML to XLSB C++ Conversion Source Code" offSpacer="" %}}
