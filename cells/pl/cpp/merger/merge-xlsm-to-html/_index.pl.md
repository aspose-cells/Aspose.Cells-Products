---
title: Scal XLSM z HTML - Połącz XLSM z HTML w C++
url: /pl/cpp/merger/merge-xlsm-to-html/ 
description: Aspose Excel. C++ Aspose.Cells. Scal XLSM z HTML w formacie zapisu. C++ Połącz format XLSM z HTML. Scal XLSM z HTML w C++. XLSM Scal.
...
{{% blocks/products/pf/agp/content h2="Scal XLSM z HTML w C++" %}}

Poniższy przykład pokazuje, jak połączyć XLSM z HTML w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLSM z HTML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku HTML. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy XLSM z HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia XLSM z HTML w C++" InputFormat="xlsm" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSM z HTML przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć XLSM z HTML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
