---
title: 將 PRN 合併到 TSV - 將 PRN 合併到 Python 中的 TSV
url: /zh-hant/python-java/merger/merge-prn-to-tsv/ 
description: Aspose Excel。 Python Aspose.Cells。免費在線合併 PRN 到 TSV saveformat。 Python 將 PRN 合併為 TSV 格式。將 PRN 合併到 Python 中的 TSV。PRN 合併。
...
如何將 PRN 合併到 TSV？借助 Aspose.Cells for Python via Java 庫，您可以通過幾行代碼以編程方式輕鬆將 PRN 合併到 TSV。[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells)能夠構建跨平台應用程序，能夠生成、修改、轉換、渲染和打印所有 Excel 文件。 Python Excel API不僅可以在電子表格格式之間進行轉換，還可以將Excel文件渲染為圖像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，從而使其成為行業交換文檔的完美選擇-標準格式。您可以安裝 Aspose.Cells for Python via Java<a href="https://pypi.org/project/aspose-cells/">pypi</a>，使用命令為：<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="免費在線合併Python中的PRN到TSV" %}}

以下示例演示如何將 PRN 合併到 Aspose.Cells for Python via Java 中的 TSV。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 PRN 合併到 TSV。上傳文件，調用 Workbook.Combine 方法合併文件，然後將其保存到 TSV 文件。如果您在 Python 中開發代碼，這會比聽起來更簡單。請參閱 Python 將 PRN 合併到 TSV 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將 PRN 合併到 Python 中的 TSV" InputFormat="prn" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通過 Python 將 PRN 合併到 TSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 PRN 合併到 TSV 嗎？基本文檔合併和連接[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Python庫將PRN合併到TSV" %}}
