...
Нужно программно конвертировать файлы XLTM в XPS? Разработчики C++ могут легко преобразовать XLTM в XPS всего за несколько строк кода.
