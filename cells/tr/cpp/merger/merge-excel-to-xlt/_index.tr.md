---
title: EXCEL'i XLT ile birleştir - EXCEL'i C++'de XLT ile birleştir
url: /tr/cpp/merger/merge-excel-to-xlt/ 
description: Aspose excel. C++ Aspose.Cells. EXCEL'i XLT kaydetme biçimiyle Ücretsiz Çevrimiçi Birleştirme. C++ EXCEL'i XLT biçimiyle birleştirin. EXCEL'i C++'de XLT ile birleştirin. EXCEL Birleştirin.
...
Aşağıdaki örnek, EXCEL'in Aspose.Cells for C++'de XLT ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="EXCEL\'i C++\'de XLT ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xlsx" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C++ aracılığıyla XLT ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i programlı olarak XLT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
