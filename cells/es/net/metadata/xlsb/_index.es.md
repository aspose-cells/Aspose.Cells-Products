---
title:  Ver o editar metadatos de archivos XLSB via .NET
weight: 7890
description: Código fuente C# para editar o ver metadatos en formato XLSB en plataformas .NET Framework, .NET Core, Mono o Xamarin.
...
+ Cargue XLSB con una instancia de Workbook
