---
title: ODS'i SQL ile birleştir - ODS'i Java'de SQL ile birleştir
url: /tr/java/merger/merge-ods-to-sql/ 
description: Aspose Excel'de. Java Aspose.Cells. ODS'i SQL kaydetme biçimiyle birleştirin. Java ODS'i SQL biçimiyle birleştirin. ODS'i Java'deki SQL ile birleştirin. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'deki SQL ile birleştir" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'deki SQL ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i SQL ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından bunu SQL dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. ODS'i SQL ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'de SQL ile Birleştirmek için Örnek Kod" InputFormat="ods" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i SQL via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i programlı olarak SQL ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesini SQL ile birleştirmek için ODS kütüphanesi" %}}
