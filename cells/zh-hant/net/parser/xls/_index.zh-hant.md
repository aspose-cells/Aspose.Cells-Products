---
title: 從 XLS 文檔 via .NET 中提取文本和圖像
weight: 5600
description: C# 源代碼，用於從 .NET 框架、.NET 核心、Mono 或 Xamarin 平台上的 XLS 文件中提取文本和圖像。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="解析 XLS 中的格式 C#" h2="本機和高性能 XLS 使用服務器端 Aspose.Cells for .NET API 進行文檔解析，無需使用任何軟件，如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
