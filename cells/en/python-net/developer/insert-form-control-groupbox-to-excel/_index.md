---
title: Insert GroupBox(Form control) into Excel using Python via .Net 
weight: 40
...
{{% blocks/products/pf/agp/content h2="How to Insert GroupBox(Form control) into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert GroupBox(Form control) to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_group_box/#int-int-int-int-int-int) to insert a GroupBox(Form control) in the selected worksheet.
