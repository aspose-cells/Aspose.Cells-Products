---
title: C# XML na XLT - Převodník XML na XLT
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu XML do formátu XLT, což umožňuje bezproblémové ukládání XML dat do formátu XLT pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Uložit XML do XLT v C#" %}}

Následující příklad ukazuje, jak převést XML na XLT s kódem C#.
...
{{% blocks/products/pf/agp/content h2="Jak převést XML na XLT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XML na XLT programově? Vývojáři .NET mohou snadno načíst a převést XML na XLT v několika řádcích kódu.
...
1.  Převeďte XML na XLT voláním metody Workbook.Save.
1.  Získejte výsledek převodu XML na XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML na XLT" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/xml-to-html/" name="XML TO HTML" description="Hypertextový značkovací jazyk" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/xml-to-md/" name="XML DO MD" description="Jazyk Markdown" >}}
