---
title: C# TSV vers ET - Convertisseur en ligne TSV vers ET
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertissez TSV en format de sauvegarde ET. C# TSV au format ET. Enregistrez TSV à ET C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez TSV à ET dans C# en ligne gratuitement" %}}
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir TSV en ET en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir TSV en ET via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers TSV en ET par programmation ? Les développeurs de .NET peuvent facilement charger et convertir TSV en ET en quelques lignes de code.
