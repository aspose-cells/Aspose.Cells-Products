...
{{% blocks/products/pf/agp/content h2="Come unire file XLSX utilizzando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'unione di file XLSX in Java" %}}
...
+ Carica il primo file XLSX con un'istanza della classe Workbook.
+ Carica il secondo documento XLSX con un'istanza della classe Workbook.
+ Unisci i file usando il metodo combine().
+ salva il file XLSX unito nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Unisci file XLSX - Java" offSpacer="" %}}

```cs
// Apri il primo file XLSX.
Workbook xlsxFile1 = new Workbook("chartsFileWithPath.xlsx");

// Definisci il secondo libro di origine.
// Apri il secondo file XLSX.
