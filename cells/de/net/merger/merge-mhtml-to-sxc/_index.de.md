---
title: MHTML mit SXC zusammenführen - MHTML mit SXC in C# kombinieren
url: /de/net/merger/merge-mhtml-to-sxc/ 
description: Aspose Excel. C# Aspose.Cells. MHTML mit SXC Saveformat zusammenführen. C# Kombinieren Sie das Format MHTML mit dem Format SXC. MHTML zu SXC in C# zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="MHTML mit SXC in C# zusammenführen" %}}

Das folgende Beispiel zeigt, wie MHTML mit SXC in Aspose.Cells for .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um MHTML mit SXC zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei SXC. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das MHTML mit SXC zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Beispielcode zum Zusammenführen von MHTML mit SXC in C#" InputFormat="mhtml" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie MHTML über C# mit SXC zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie MHTML programmgesteuert mit SXC zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von MHTML mit SXC" %}}
