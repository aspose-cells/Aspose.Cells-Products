...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar DOCX in de Excel-bibliotheek Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sla OTS op in DOCX in de Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u OTS converteert naar DOCX in de Excel-bibliotheek Python.
...
{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om OTS naar DOCX te converteren" %}}
