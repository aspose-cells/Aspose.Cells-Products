---
title: Sloučit XLSB do EXCELu - Sloučit XLSB do EXCELu v C#
url: /cs/net/merger/merge-xlsb-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Zdarma online sloučení XLSB do formátu uložení EXCEL. C# Spojte XLSB do formátu EXCEL. Sloučit XLSB do EXCELu v C#. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB do EXCELu v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLSB do EXCELu v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLSB do EXCELu. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru EXCEL. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí XLSB do EXCELu.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XLSB do EXCELu v C#" InputFormat="xlsb" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB do EXCELu přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit XLSB do EXCELu programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna ke sloučení XLSB do EXCELu" %}}
