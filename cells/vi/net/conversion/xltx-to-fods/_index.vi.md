---
title: C# XLTX thành FODS - Bộ chuyển đổi XLTX thành FODS trực tuyến
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Trực tuyến miễn phí C# Chuyển đổi XLTX thành FODS định dạng lưu. C# XLTX đến FODS định dạng. Lưu XLTX thành FODS C#.
...
{{% blocks/products/pf/agp/content h2="Lưu XLTX thành FODS trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi XLTX thành FODS trong C#.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để chuyển đổi XLTX thành FODS. Tải tệp XLTX của bạn lên, sau đó chỉ cần lưu tệp thành FODS. Đối với cả XLTX đọc và FODS viết, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng FODS đầu ra sẽ giống với tài liệu gốc XLTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi XLTX thành FODS trực tuyến" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLTX thành FODS qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi các tệp XLTX thành FODS theo chương trình? .NET nhà phát triển có thể dễ dàng tải và chuyển đổi XLTX thành FODS chỉ trong một vài dòng mã.
...
1.  Chuyển đổi XLTX thành FODS bằng cách gọi phương thức Workbook.Save.
1.  Lấy kết quả chuyển đổi từ XLTX thành FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# thư viện để chuyển đổi XLTX thành FODS" %}}
