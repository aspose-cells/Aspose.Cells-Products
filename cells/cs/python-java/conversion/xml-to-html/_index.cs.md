...
{{% blocks/products/pf/agp/content h2="Převeďte XML na HTML pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XML na HTML v Python.
