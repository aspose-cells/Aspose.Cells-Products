---
title: Převést ODS na XLSX přes Java 
weight: 800

description: Ukázkový konverzní kód Java pro formát ODS na soubor XLSX. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLSX v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODS na XLSX přes Java" h2="Převod ODS na XLSX Java pro převod jedné nebo více stránek na XLSX pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na XLSX pomocí Java" %}}

 K vykreslení ODS do XLSX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod ODS na XLSX prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na XLSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLSX a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLSX
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODS na XLSX Java" offSpacer="" %}}

```cs
// načtěte soubor ODS v instanci Workbooku
Workbook book = new Workbook("template.ods");
// uložit ODS jako XLSX
