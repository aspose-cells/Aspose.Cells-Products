...
weight: 3680
description: C++ código de exemplo para desbloquear o arquivo XLSX protegido por senha no C++ Runtime Environment para Windows 32 bits, Windows 64 bits e Linux 64 bits.
...
{{< blocks/products/pf/i18n/upper-banner h1="Desbloqueie arquivos XLSX por meio de C++" h2="Remova a proteção das planilhas do Excel, incluindo o arquivo XLSX, usando a Biblioteca C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Desbloqueie XLSX através de C++" %}}
...
1.  Instancie a classe Workbook com caminho para o arquivo XLSX protegido
