...
weight: 10
url: /python-java/shapes/insert-cube-to-excel/ 
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) to insert a Cube in the selected worksheet.
