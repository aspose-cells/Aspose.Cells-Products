...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке/созданию блок-схемы в файл Excel через C#" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) вставить/создать блок-схему на выбранном рабочем листе
...
{{% blocks/products/pf/agp/code-block title="Вставка/Создание блок-схемы - C#" offSpacer="" %}}
