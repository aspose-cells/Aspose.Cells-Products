---
title: Convierte XLS a GIF a través de Java 
weight: 210
url: /es/java/conversion/xls-to-gif/ 
description: Ejemplo de código de conversión Java de formato XLS a archivo GIF. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a GIF dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte XLS a GIF a través de Java" h2="Conversión de XLS a GIF Java para convertir una o varias páginas a GIF mediante la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLS a GIF usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLS a GIF a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente archivos XLS a GIF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLS con una instancia de Workbook1. Seleccione predeterminado o cualquier hoja de trabajo de la colección1. Crear y establecer el objeto de ImageOrPrintOptions1. Cree SheetRender con objetos Worksheet e ImageOrPrintOptions1. Llame al método SheetRender.toImage para guardar el resultado en formato GIF
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLS a GIF Java" offSpacer="" %}}

```cs
// cargar el archivo XLS para ser renderizado
