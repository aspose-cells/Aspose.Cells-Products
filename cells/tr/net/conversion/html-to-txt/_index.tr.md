...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde HTML'i TXT'e dönüştürün. C# HTML'i TXT'e dönüştürün. C# HTML'i TXT'e kaydedin. HTML'i 07611134 olarak kaydedin 81, C#'i kullanarak.
...
{{% blocks/products/pf/agp/content h2="HTML\'i C#\'e TXT\'e kaydedin" %}}

Aşağıdaki örnek, HTML'in C#'de TXT'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="HTML\'i TXT\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="txt" IsLandingPage="true" %}}
...
1.  Workbook.Save yöntemini çağırarak HTML'i TXT'e dönüştürün.
1.  HTML'den TXT'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="HTML\'i TXT\'e dönüştürmek için C# kitaplığı" %}}
