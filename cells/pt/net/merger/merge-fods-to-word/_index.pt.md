---
title:  Mesclar FODS para WORD via C#
url: /pt/net/merger/merge-fods-to-word/ 
description: Mesclar FODS para WORD Online gratuitamente. Online grátis FODS para fusão de palavras. Mesclar FODS para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar FODS com WORD em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar FODS para WORD. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo WORD. Se você desenvolver código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla FODS com WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Aplicativo gratuito para mesclar FODS para WORD online" InputFormat="fods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
