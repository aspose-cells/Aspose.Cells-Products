---
title:  Insira GroupBox (controle de formulário) no Excel usando Python via java
weight: 40
description: Python via código fonte java para inserir GroupBox (controle de formulário) no Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insira GroupBox (controle de formulário) no Excel usando Python via java" h2="Insira objetos usando APIs do lado do servidor sem qualquer software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir GroupBox (controle de formulário) em arquivo Excel usando Python via java" %}}

 Para inserir GroupBox (controle de formulário) no arquivo Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir GroupBox (controle de formulário) em arquivo Excel usando Python via java" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Use o shapecollection[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addGroupBox(int,%20int,%20int,%20int,%20int,%20int)) para inserir um GroupBox (controle de formulário) na planilha selecionada.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells for Python via java é independente de plataforma API e pode ser usado em qualquer plataforma (Windows, Linux e MacOS), apenas certifique-se que o sistema tenha Java 1.8 ou superior,[Python](https://www.python.org/downloads/) 3,5 ou superior.
...
{{% blocks/products/pf/agp/code-block title="Inserir GroupBox (controle de formulário) - Python via java" offSpacer="" %}}
