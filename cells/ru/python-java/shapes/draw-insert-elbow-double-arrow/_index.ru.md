---
title: Как нарисовать или вставить фигуру двойной стрелки локтя в Excel с помощью Python via Java
weight: 10
...
{{% blocks/products/pf/agp/content h2="Как вставить форму двойной стрелки локтя в файл Excel с помощью Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке формы двойной стрелки локтя в файл Excel с помощью Python via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте коллекцию фигур[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить фигуру локтя с двойной стрелкой на выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка угловая, двойная стрелка - Python via Java" offSpacer="" %}}
