...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter JSON em XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos JSON para XLS em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo JSON com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão XLS como parâmetro1. Verifique o caminho especificado para o arquivo XLS resultante
