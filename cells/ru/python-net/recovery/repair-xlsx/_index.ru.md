---
title: Python Repair xlsx — восстановление и исправление поврежденного файла xlsx
url: /ru/python-net/recovery/repair-xlsx/ 
description: Python Aspose.Cells. Ремонт xlsx. Исправьте файл xlsx. xlsx инструмент восстановления. xlsx повреждение. Восстановите данные xlsx. xlsx восстановление файла. Восстановить поврежденный файл xlsx.
...
{{< blocks/products/pf/i18n/upper-banner h1="Восстановить файл XLSX в Python." h2="Создайте собственное приложение Python для восстановления файлов xlsx, используя Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
Нужно восстановить файл xlsx программно? Разработчики Python могут легко загрузить и восстановить файл xlsx всего за несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

+ Определить класс, который наследует Aspose.Cells.IWarningCallback.
+ Загрузите файл XLSX, создав экземпляр книги, используя указанный выше класс наследования, см. приведенный выше код.
+ Сохраните книгу, поврежденный файл xlsx будет восстановлен.

{{% /blocks/products/pf/agp/content %}}

{{% cells-recovery title="Пример кода для восстановления файла XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}    
