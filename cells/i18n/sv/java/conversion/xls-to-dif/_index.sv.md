...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLS till DIF med Java" %}}

 För att rendera XLS till DIF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLS till DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLS-fil till DIF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLS-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med DIF-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande DIF-filen
...
{{% blocks/products/pf/agp/code-block title="XLS till DIF Java omvandlingskällkod" offSpacer="" %}}
