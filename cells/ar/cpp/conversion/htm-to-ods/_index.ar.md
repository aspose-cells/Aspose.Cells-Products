---
title: C++ HTM إلى ODS - محول HTM عبر الإنترنت إلى ODS
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل HTM إلى ODS saveformat. C++ HTM إلى تنسيق ODS. احفظ HTM في ODS C++.
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في ODS في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات HTM إلى ODS برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى ODS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى ODS باستدعاء طريقة Save ().
