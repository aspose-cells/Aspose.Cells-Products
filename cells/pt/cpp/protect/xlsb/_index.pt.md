...
weight: 4860
description: C++ código de exemplo para bloquear o arquivo XLSB usando senha no C++ Runtime Environment para Windows 32 bits, Windows 64 bits e Linux 64 bits.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criptografar arquivos XLSB por meio de C++" h2="Planilhas Excel protegidas por senha, incluindo formato XLSB usando a Biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
