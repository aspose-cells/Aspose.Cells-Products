---
title:  Wstaw ScrollBar (kontrolka formularza) do programu Excel przy użyciu Python via .Net
weight: 90
description: Python via Kod źródłowy .Net umożliwiający wstawienie paska przewijania (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić pasek przewijania (kontrolka formularza) do pliku Excel przy użyciu Python via .Net" %}}

 Aby wstawić ScrollBar (kontrolkę formularza) do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić pasek przewijania (kontrolka formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj dodatku do kolekcji kształtów[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_scroll_bar/#int-int-int-int-int-int) aby wstawić ScrollBar (kontrolka formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw ScrollBar (kontrolka formularza) - Python via .Net" offSpacer="" %}}
