...
{{% blocks/products/pf/agp/content h2="TXT konvertálása XLSB-re a következővel: Java" %}}

 Ahhoz, hogy a TXT-t XLSB-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TXT XLSB-vé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java fejlesztői könnyedén konvertálhatják a TXT fájlt XLSB-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLSB kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLSB fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT-ből XLSB-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése XLSB-ként
