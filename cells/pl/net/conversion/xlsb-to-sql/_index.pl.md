...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSB na SQL za pomocą Aspose.Cells. C# XLSB na SQL. C# Zapisz XLSB w SQL. Zapisz XLSB jako SQL, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB w SQL w C#" %}}

Poniższy przykład ilustruje sposób konwersji XLSB na SQL w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLSB na SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="sql" IsLandingPage="true" %}}
