---
title:  ODS belgesini açmadan C++ üzerinden arayın
weight: 3300
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı üzerindeki ODS dosyasındaki kalıplı kelimeleri aramak için C++ örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS Biçimlerini C++\'de arayın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Cells for C++ API\'leri kullanarak yerel ve yüksek performanslı ODS belge arama." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanılarak ODS Dosyası Nasıl Aranır?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++\'de ODS Dosyalarını Arama Adımları" %}}
...
Bir IWorkbook sınıfını başlatarak ODS dosyasını yükleyin.
...
+ ODS dosyasını IWorkbook->Save(.) yöntemini kullanarak kaydedin.
...
{{% blocks/products/pf/agp/code-block title="Ara ODS Dosyalar - C++" offSpacer="" %}}
