---
title: Java PRN ke SQL - Konverter PRN ke SQL Online
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Online Gratis Java Konversi PRN ke format penyimpanan SQL. Java PRN ke format SQL. Simpan PRN ke SQL Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan PRN ke SQL di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi PRN ke SQL. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, SQL, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan PRN ke SQL di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi PRN ke SQL di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengonversi PRN ke SQL. Unggah file PRN Anda, lalu simpan sebagai file SQL. Untuk membaca PRN dan menulis SQL, Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan pemformatan SQL keluaran akan identik dengan dokumen PRN asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi PRN ke SQL Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="sql" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi PRN ke SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke SQL secara terprogram? Java pengembang dapat dengan mudah mengonversi PRN ke SQL hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengonversi PRN ke SQL" %}}
{{% blocks/products/pf/agp/text %}}
