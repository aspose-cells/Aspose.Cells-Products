...
description: Aspose Exceller. Convertissez SXC en ETT rapidement et facilement avec Aspose.Cells. PHP SXC en ETT. PHP Enregistrez SXC dans ETT. Enregistrez SXC en tant qu'ETT en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Convertir SXC en ETT en utilisant PHP" %}}
 ...
 Comment puis-je convertir SXC en ETT ? Avec la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir SXC en ETT par programme avec quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. PHP Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer SXC dans ETT en PHP" %}}
...
Besoin de convertir les fichiers SXC en ETT par programme ? Les développeurs PHP peuvent facilement charger et convertir SXC en ETT en quelques lignes de code seulement.
...
1.  Convertissez SXC en ETT en appelant la méthode de sauvegarde du classeur.
