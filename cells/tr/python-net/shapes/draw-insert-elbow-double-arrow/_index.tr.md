---
title: Python via .Net kullanarak dirsek çift ok şeklini Excel'e çizme veya ekleme
weight: 10
description: Python via .Net kaynak kodu, dirsek çift ok şeklini Excel'e eklemek için.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via .Net kullanarak dirsek çift ok şeklini Excel\'e ekleyin" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım olmadan Aspose.Cells\' API\'i kullanarak çift oklu dirsek yerleştirin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via .Net Kullanarak Excel Dosyasına Dirsek Çift Ok Şekli Nasıl Eklenir" %}}

 Excel dosyasına dirsek çift ok şeklini eklemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net kullanarak Excel dosyasına dirsek çift ok şekli ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfası'nı seçin.
 + Shapecollection'ın eklentisini kullanın[yöntem](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) seçili çalışma sayfasına bir dirsek çift ok şekli eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Dirsek çift ok şekli - Python via .Net" offSpacer="" %}}
