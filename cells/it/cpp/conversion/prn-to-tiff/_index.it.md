...
Hai bisogno di convertire i file PRN in TIFF tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in TIFF in poche righe di codice.
...
1.  Convertire PRN in TIFF chiamando il metodo Save().
