...
{{% blocks/products/pf/agp/content h2="XLTM naar ODS converteren met Java" %}}

 Om XLTM naar ODS te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLTM naar ODS te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen XLTM-bestanden gemakkelijk converteren naar ODS in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad XLTM-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met ODS-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende ODS-bestand
...
{{% blocks/products/pf/agp/code-block title="XLTM naar ODS Java Conversiebroncode" offSpacer="" %}}
