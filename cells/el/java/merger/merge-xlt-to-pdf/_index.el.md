...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση XLT σε μορφή αποθήκευσης PDF. Java Συνδυάστε τη μορφή XLT με PDF. Συγχώνευση XLT σε PDF στο Java. XLT Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLT με PDF στο Java" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLT έως PDF στο Java" InputFormat="xlt" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
