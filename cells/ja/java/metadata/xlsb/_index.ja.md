...
{{% blocks/products/pf/agp/content h2="Java を使用して XLSB メタデータを抽出する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB via Java のメタデータを抽出する手順" %}}
...
WorkbookMetadata 内に XLSB ファイルをロードします
...
{{% blocks/products/pf/agp/code-block title="XLSB - Java のメタデータを抽出" offSpacer="" %}}
