...
url: /hu/python-java/merger/merge-xml-to-excel/ 
...
A következő példa bemutatja, hogyan lehet XML-t egyesíteni az EXCEL-lel a Aspose.Cells for Python via Java-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell az XML-t az EXCEL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
