---
title: Convierta ODS a XML a través de Java 
url: /es/java/conversion/ods-to-xml/ 
description: Ejemplo de código de conversión Java para formato ODS a archivo XML. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a XML dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta ODS a XML a través de Java" h2="Conversión de ODS a XML Java para convertir una o varias páginas a XML utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir ODS a XML usando Java" %}}

 Para convertir ODS en XML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir ODS a XML a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo ODS a XML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo ODS con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con extensión XML y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo XML resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión ODS a XML Java" offSpacer="" %}}

```cs
// cargar el archivo ODS en una instancia de Workbook
Workbook book = new Workbook("template.ods");
// guardar SAO como XML
