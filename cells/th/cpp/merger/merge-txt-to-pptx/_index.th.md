---
title: รวม TXT ถึง PPTX - รวม TXT ถึง PPTX ใน C++
url: /th/cpp/merger/merge-txt-to-pptx/ 
description: Aspose เอ็กเซล. C++ Aspose.Cells รวม TXT เป็น PPTX บันทึกฟอร์แมต C++ รวมรูปแบบ TXT ถึง PPTX รวม TXT ถึง PPTX เข้า C++ TXT รวม.
...
{{% blocks/products/pf/agp/content h2="รวม TXT ถึง PPTX ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน TXT ถึง PPTX ใน Aspose.Cells for C++
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม TXT ถึง PPTX อัปโหลดไฟล์ของคุณ เรียกวิธี Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ PPTX หากคุณพัฒนาโค้ดใน C++ สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C++ ที่รวม TXT กับ PPTX
...
{{% blocks/products/pf/agp/content h2="วิธีรวม TXT ถึง PPTX ผ่าน C++" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม TXT กับ PPTX โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="C++ ห้องสมุดรวม TXT เป็น PPTX" %}}
