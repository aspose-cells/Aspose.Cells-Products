---
title:  Połącz pliki Excela pod numerem Python
description: Scal plik Excel w kodzie Python. Połącz plik Excel za pomocą Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Połącz formaty programu Excel w Python" h2="Natywne i wydajne łączenie dokumentów przy użyciu interfejsów API po stronie serwera Aspose.Cells for Python, bez użycia oprogramowania takiego jak Microsoft lub Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="XLSX" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak scalić plik programu Excel za pomocą Python" %}}

 Aby scalić plik Excel, użyjemy[Aspose.Cells for Python](https://pypi.org/project/aspose-cells-python) API, która jest bogatą w funkcje, wydajną i łatwą w użyciu platformą do manipulacji i łączenia dokumentów API for Python.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki scalania pliku Excel w Python" %}}
