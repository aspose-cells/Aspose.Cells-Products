---
title:  Hợp nhất các tập tin XLSM via Java
weight: 1270
description: Java mã mẫu để kết hợp các tài liệu XLSM trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng XLSM trong Java" h2="Hợp nhất tài liệu gốc XLSM bằng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất các tệp XLSM bằng Java" %}}

 Để hợp nhất tệp XLSM, chúng tôi sẽ sử dụng[Aspose.Cells for Java](https://products.aspose.com/cells/java) API là một nền tảng hợp nhất giàu tính năng, mạnh mẽ và dễ sử dụng API for Java. Bạn có thể tải xuống phiên bản mới nhất của nó trực tiếp từ[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) và cài đặt nó trong dự án dựa trên Maven của bạn bằng cách thêm các cấu hình sau vào tệp pom.xml.
...
+ lưu tệp XLSM đã hợp nhất tại đường dẫn đã chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp XLSM - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến XLSM Hợp nhất Bản trình diễn trực tiếp" sectionDescription=" Hợp nhất các tài liệu XLSM ngay bây giờ bằng cách truy cập của chúng tôi[Trang web Demo trực tiếp](https://products.aspose.app/cells/merger). Bản demo trực tiếp có những lợi ích sau" >}}
