---
title:  Zoek het document TXT zonder via Java te openen
weight: 1200
description: Java voorbeeldcode om woorden met patroon te zoeken in het bestand TXT op Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zoek TXT Formaten in Java" h2="Native en krachtige TXT-documentzoekopdracht met behulp van server-side Aspose.Cells for Java API\'s, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u het bestand TXT kunt zoeken met behulp van Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TXT-bestanden te zoeken in Java" %}}
...
+ Toegang tot het eerste werkblad in het TXT-bestand.
...
{{% blocks/products/pf/agp/code-block title="Zoek TXT Bestanden - Java" offSpacer="" %}}
