---
title: C# PNG a JPG - Convertidor de PNG a JPG
description: Aspose Excel. Convierta PNG a JPG rápida y fácilmente con Aspose.Cells. C# PNG a JPG. C# Guardar PNG en JPG. Guarde PNG como JPG usando C#.
...
{{% blocks/products/pf/agp/content h2="Guarde PNG en JPG en C#" %}}

El siguiente ejemplo demuestra cómo convertir PNG a JPG en C#.
...
{{% cells-convert title="Código de muestra para convertir PNG a JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a JPG mediante C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PNG a JPG mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente PNG a JPG en tan solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para convertir PNG a JPG" %}}
