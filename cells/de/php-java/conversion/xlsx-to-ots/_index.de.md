...
description: Aspose Excel. Konvertieren Sie XLSX schnell und einfach in OTS mit Aspose.Cells. PHP XLSX in OTS. PHP Speichern Sie XLSX in OTS. Speichern Sie XLSX als OTS mit PHP.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLSX über PHP in OTS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLSX-Dateien programmgesteuert in OTS konvertieren? PHP-Entwickler können XLSX in nur wenigen Codezeilen problemlos laden und in OTS konvertieren.
...
1.  Konvertieren Sie XLSX in OTS, indem Sie die Speichermethode von Workbook aufrufen.
