---
title: 创建 MHT - 在 Java 中创建 MHT 文件
description: Aspose Excel。使用 Aspose.Cells 和 for Java 库，轻松生成和操作 MHT 文件。这款功能强大的 API 库提供了一种简化高效的解决方案，可直接在您的 Java 应用程序中创建、编辑和管理 MHT 文件，从而高精度地满足开发人员的特定需求。
...
{{% blocks/products/pf/agp/content h2="如何在 Java 中创建 MHT" %}}

{{% blocks/products/pf/agp/text %}}

开发人员只需几行代码即可在运行不同的报告应用程序中轻松创建、加载、修改和转换 MHT 文件以进行数据处理。
...
1. 使用 save() 方法将工作簿保存为 MHT 格式。

{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 Java 中创建 MHT 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java 库用于创建 MHT 文件" %}}
{{% blocks/products/pf/agp/text %}}
