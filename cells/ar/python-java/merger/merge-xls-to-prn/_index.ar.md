...
description: Aspose اكسل. Python اكسل. دمج XLS إلى تنسيق حفظ PRN. Python قم بدمج XLS إلى تنسيق PRN. دمج XLS إلى PRN في مكتبة Excel Python. XLS دمج.
...
{{< blocks/products/pf/i18n/upper-banner h1="دمج XLS إلى PRN عبر مكتبة Excel Python" h2="مكتبة إكسل Python عالية السرعة لدمج XLS إلى PRN. استخدم تحويل Excel API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في Python. هذا حل برمجي احترافي لاستيراد وتصدير Excel, CSV, OpenOffice, PDF, HTML, image والعديد من تنسيقات Excel الأخرى." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="XLS" additionalConversionTag="PRN" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="دمج XLS إلى PRN باستخدام مكتبة Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="دمج XLS إلى PRN في مكتبة Excel Python" %}}
...
{{% cells-merger title="نموذج التعليمات البرمجية لدمج XLS إلى PRN في مكتبة Excel Python" InputFormat="xls" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLS إلى PRN عبر مكتبة Excel Python" %}}
