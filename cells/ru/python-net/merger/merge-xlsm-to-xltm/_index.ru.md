...
description: Aspose Эксель. Python Aspose.Cells. Объедините XLSM и XLTM в формате сохранения. Python Объедините форматы XLSM и XLTM. Объедините XLSM и XLTM в Python. XLSM Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM с XLTM, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM и XLTM в Python." %}}

В следующем примере показано, как объединить XLSM и XLTM в Aspose.Cells for Python via .NET.
