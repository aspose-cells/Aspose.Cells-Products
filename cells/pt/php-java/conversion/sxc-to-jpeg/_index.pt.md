---
title: Conversor PHP SXC para JPEG - SXC para JPEG
description: Aspose Excel. Converta SXC em JPEG de forma rápida e fácil com Aspose.Cells. PHP SXC em JPEG. PHP Salve SXC em JPEG. Salve SXC como JPEG usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em JPEG via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em JPEG programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em JPEG em apenas algumas linhas de código.
...
1.  Converta SXC em JPEG chamando o método save da pasta de trabalho.
