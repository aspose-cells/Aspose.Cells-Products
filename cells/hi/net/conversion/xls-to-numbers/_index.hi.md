...
{{< blocks/products/pf/i18n/upper-banner h1="XLS को C# में संख्या में बदलें" h2="XLS को संख्याओं में परिवर्तित करने के लिए हाई-स्पीड C# लाइब्रेरी। यह .NET फ्रेमवर्क, .NET कोर या Mono प्लेटफॉर्म पर XLS, नंबर और कई अन्य प्रारूपों को आयात और निर्यात करने के लिए एक पेशेवर सॉफ्टवेयर समाधान है।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
XLS फ़ाइलों को प्रोग्रामेटिक रूप से NUMBERS में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में XLS को आसानी से लोड और NUMBERS में बदल सकते हैं।
...
1.  Workbook.Save विधि को कॉल करके XLS को NUMBERS में कनवर्ट करें।
