---
title: Cara menggambar atau menyisipkan bentuk lengkung ke excel menggunakan Python via Java
weight: 10
description: Menggambar atau menyisipkan bentuk lengkung menggunakan Aspose.Cells' Python via Java API tanpa software apapun seperti Microsoft atau Open Office, Adobe PDF, dll.
keywords: [Python Aspose.Cells., Python add curved shape., Python insert curved shape., Python create curved shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan bentuk melengkung ke dalam Excel menggunakan Python via Java" h2="Masukkan bentuk melengkung menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Menyisipkan Bentuk Lengkung ke File Excel Menggunakan Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah menyisipkan bentuk lengkung ke file excel menggunakan Python via Java" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan koleksi bentuk[tambahkan metode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) untuk menyisipkan bentuk melengkung pada lembar kerja yang dipilih.
...
{{% blocks/products/pf/agp/code-block title="Sisipkan bentuk lengkung - Python via Java" offSpacer="" %}}
