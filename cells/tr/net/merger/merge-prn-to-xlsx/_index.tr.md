---
title: PRN'yi XLSX ile birleştir - PRN'yi C#'de XLSX ile birleştir
url: /tr/net/merger/merge-prn-to-xlsx/ 
description: Aspose Excel'de. C# Aspose.Cells. PRN'yi XLSX kaydetme biçimiyle birleştirin. C# PRN'yi XLSX biçimiyle birleştirin. PRN'yi C#'de XLSX ile birleştirin. PRN Birleştir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi C#\'de XLSX ile birleştir" %}}

Aşağıdaki örnek, PRN'nin Aspose.Cells for .NET'deki XLSX ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi XLSX'e birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLSX dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. PRN'yi XLSX ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="PRN\'yi C#\'de XLSX ile Birleştirmek için Örnek Kod" InputFormat="prn" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla XLSX ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

PRN'yi programlı olarak XLSX ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi XLSX ile birleştirmek için .NET kitaplığı" %}}
