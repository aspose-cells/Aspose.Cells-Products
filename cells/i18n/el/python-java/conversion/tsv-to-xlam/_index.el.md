---
title: Μετατροπή TSV σε XLAM μέσω Python
url: /el/python-java/conversion/tsv-to-xlam/
description: Δείγμα κώδικα για μετατροπή tsv σε xlam Python. Χρησιμοποιήστε API παράδειγμα κώδικα για ομαδική μετατροπή αρχείων tsv σε xlam εντός της εφαρμογής Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή TSV σε XLAM μέσω Python" h2="Εξαγωγή υπολογιστικών φύλλων Excel® σε μορφή XLAM χρησιμοποιώντας Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLAM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε TSV σε XLAM χρησιμοποιώντας το Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή TSV σε XLAM μέσω Python" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του Python μπορούν εύκολα να φορτώσουν και να μετατρέψουν αρχεία TSV σε XLAM σε λίγες μόνο γραμμές κώδικα.
...
{{% cells-convert title="Δωρεάν εφαρμογή και δείγμα κώδικα για μετατροπή TSV σε XLAM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlam" IsLandingPage="true" language="python" %}}
