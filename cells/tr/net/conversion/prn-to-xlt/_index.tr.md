...
{{% cells-convert title="PRN\'yi XLT\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla XLT\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PRN dosyalarını programlı olarak XLT'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PRN'yi kolayca yükleyebilir ve XLT'e dönüştürebilir.
