---
title: Converti XLTM in JSON tramite l'applicazione C++ 
url: /it/cpp/conversion/xltm-to-json/ 
description: Esempio di codice di conversione C++ per un documento XLTM in formato JSON. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLTM a JSON all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire XLTM in JSON utilizzando C++" %}}

 Per convertire XLTM in JSON, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire XLTM in JSON tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente file XLTM in JSON in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLTM usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (JSON).1. Il file JSON verrà salvato nel percorso specificato.1. Apri il file JSON nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLTM a JSON C++" offSpacer="" %}}
