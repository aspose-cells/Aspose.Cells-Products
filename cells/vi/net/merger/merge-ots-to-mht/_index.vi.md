---
title: Hợp nhất OTS thành MHT - Hợp nhất OTS thành MHT trong C#
url: /vi/net/merger/merge-ots-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí định dạng lưu OTS sang MHT. C# Gộp định dạng OTS sang MHT. Hợp nhất OTS với MHT theo số C#. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS với MHT trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất OTS với MHT trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất OTS với MHT. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp MHT. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất OTS với MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất OTS với MHT trong C#" InputFormat="ots" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS với MHT qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất OTS với MHT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất OTS với MHT" %}}
