---
title: Převodník PHP PNG na HTML - PNG na HTML
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům PHP plně integrovaný přístup k převodu formátu PNG do formátu HTML, což umožňuje bezproblémové ukládání dat PNG do formátu HTML pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu PHP.
...
{{% cells-convert title="Ukázkový kód pro převod čísla PNG na HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="html" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést PNG na HTML pomocí PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory PNG na HTML? Vývojáři PHP mohou snadno načíst a převést PNG na HTML pomocí několika řádků kódu.
...
1.  Převeďte číslo PNG na HTML voláním metody save v sešitu.
1.  Získejte výsledek převodu PNG na HTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP knihovna pro převod PNG na HTML" %}}
