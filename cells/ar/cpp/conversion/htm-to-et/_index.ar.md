...
هل تحتاج إلى تحويل ملفات HTM إلى ET برمجيًا؟ يمكن للمطورين C++ تحويل HTM إلى ET بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى ET عن طريق استدعاء طريقة Save ().
