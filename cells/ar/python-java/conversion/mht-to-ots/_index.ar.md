---
title: Python MHT إلى OTS - محول MHT عبر الإنترنت إلى OTS
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل MHT إلى OTS saveformat. Python MHT إلى تنسيق OTS. احفظ MHT في OTS Python.
...
{{% blocks/products/pf/agp/content h2="تحويل MHT إلى OTS باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="وفر MHT في OTS في Python عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل MHT إلى OTS في Python.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل MHT إلى OTS. قم بتحميل ملف MHT الخاص بك ، ثم احفظه كملف OTS. لكل من قراءة MHT وكتابة OTS ، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق OTS الناتج مطابقًا لمستند MHT الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني وعينة من التعليمات البرمجية لتحويل MHT إلى OTS عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="ots" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى OTS عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى OTS برمجيًا؟ يمكن للمطورين Python تحميل وتحويل MHT إلى OTS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Python مكتبة لتحويل MHT إلى OTS" %}}
