---
title:  Sloučit XLSB do POWERPOINT přes Python
...
Následující příklad ukazuje, jak sloučit XLSB do POWERPOINT v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSB do POWERPOINT online" InputFormat="xlsb" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
