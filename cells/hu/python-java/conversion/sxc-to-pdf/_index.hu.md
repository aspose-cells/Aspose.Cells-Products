---
title: "SXC konvertálása PDF-be a következőn keresztül: Python"
url: /hu/python-java/conversion/sxc-to-pdf/
description: Mintakód az sxc-ből pdf-be Python konvertáláshoz. Használjon API példakódot az sxc fájlok kötegelt PDF formátumú konvertálásához a Python alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása PDF-be a következőn keresztül: Python" h2="Exportáljon Excel® táblázatokat PDF formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása PDF-be a következővel: Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása PDF-be a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen betölthetnek és konvertálhatnak SXC fájlokat PDF formátumba, mindössze néhány sornyi kóddal.
