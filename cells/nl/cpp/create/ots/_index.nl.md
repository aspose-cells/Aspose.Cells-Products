---
title: OTS aanmaken - Maak een OTS-bestand in C++
description:  Aspose Excel. C++ Maak snel en eenvoudig een OTS-bestand met Aspose.Cells. Genereer een OTS-bestand met C++. Maak een OTS aan in C++. C++ OTS Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een OTS-bestand in C++" h2="Native en krachtige OTS-bestanden kunnen programmatisch worden gemaakt zonder Microsoft Office met behulp van de C++-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="OTS aanmaken in C++" %}}

{{% blocks/products/pf/agp/text %}}

 Het is voor de ontwikkelaars gemakkelijk om OTS-bestanden te maken, laden, wijzigen en converteren binnen actieve rapportageapplicaties voor gegevensverwerking in slechts enkele regels code.
...
1.  Sla de werkmap op als .ots-bestand met behulp van de Save()-methode.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een OTS-bestand maakt in C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om OTS-bestand te maken" %}}
