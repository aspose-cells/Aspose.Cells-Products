...
{{% blocks/products/pf/agp/content h2="كيفية إدراج RadioButton (عنصر تحكم النموذج) في ملف Excel باستخدام Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج RadioButton (عنصر تحكم النموذج) في ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم الشكل[طريقة الإضافة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) لإدراج RadioButton (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل RadioButton (التحكم في النموذج) - Python via java" offSpacer="" %}}
