---
title: Połącz CSV z WORD - Połącz CSV z WORD w C#
url: /pl/net/merger/merge-csv-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online CSV do formatu zapisu WORD. C# Połącz CSV do formatu WORD. Połącz CSV z WORD w C#. CSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz CSV z WORD w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić CSV z WORD w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć CSV z WORD. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku WORD. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy CSV z WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z WORD w C#" InputFormat="csv" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z WORD przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć numer CSV z programem WORD? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
