---
title: Gabungkan XLSB menjadi PDF - Gabungkan XLSB menjadi PDF menjadi C#
url: /id/net/merger/merge-xlsb-to-pdf/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSB menjadi PDF format simpan. C# Gabungkan format XLSB menjadi PDF. Gabungkan XLSB menjadi PDF di C#. XLSB Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSB menjadi PDF di C#" %}}

Contoh berikut menunjukkan cara menggabungkan XLSB menjadi PDF di Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSB menjadi PDF melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSB ke PDF secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2=".NET perpustakaan untuk digabungkan XLSB menjadi PDF" %}}
