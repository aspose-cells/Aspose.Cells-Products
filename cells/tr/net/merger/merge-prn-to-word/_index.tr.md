---
title: PRN'yi WORD ile birleştir - PRN'yi C#'de WORD ile birleştir
url: /tr/net/merger/merge-prn-to-word/ 
description: Aspose Excel'de. C# Aspose.Cells. PRN'yi WORD kaydetme biçimiyle birleştirin. C# PRN'yi WORD biçimiyle birleştirin. PRN'yi C#'de WORD ile birleştirin. PRN Birleştir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi C#\'de WORD ile birleştir" %}}

Aşağıdaki örnek, PRN'nin Aspose.Cells for .NET'deki WORD ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi WORD'e birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından WORD dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. PRN'yi WORD ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="PRN\'yi C#\'de WORD ile Birleştirmek için Örnek Kod" InputFormat="prn" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla WORD ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

PRN'yi programlı olarak WORD ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
