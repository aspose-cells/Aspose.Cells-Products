---
title: Javaを介してTSVをTABDELIMITEDに変換します 
url: /ja/java/conversion/tsv-to-tabdelimited/ 
description: TSV形式からTABDELIMITEDファイルへのサンプルJava変換コード。プログラマーは、このサンプルコードを使用して、ExcelおよびOpenOfficeスプレッドシートを任意のWebまたはデスクトップJavaベースのアプリケーション内のTABDELIMITEDにエクスポートできます。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してTSVをTABDELIMITEDに変換します" h2="オンプレミスJavaライブラリを使用して単一または複数のページをTABDELIMITEDに変換するためのTSVからTABDELIMITEDJavaへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してTSVをTABDELIMITEDに変換する方法" %}}

 TSVをTABDELIMITEDにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してTSVをTABDELIMITEDに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでTSVファイルをTABDELIMITEDに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookクラスのインスタンスを含むTSVファイルをロードします1. Workbook.saveメソッドを呼び出す1. TABDELIMITED拡張子とSaveFormatをパラメータとして出力パスを渡します1. 結果のTABDELIMITEDファイルの指定されたパスを確認します
...
{{% blocks/products/pf/agp/code-block title="TSVからTABDELIMITEDJavaへの変換ソースコード" offSpacer="" %}}

```cs
// WorkbookのインスタンスにTSVファイルをロードします
Workbook book = new Workbook("template.tsv");
// TSVをTABDELIMITEDとして保存
...
{{< blocks/products/pf/agp/demobox sectionTitle="TSVからTABDELIMITEDへの変換ライブデモ" sectionDescription="[TSVをTABDELIMITEDに変換します](https://products.aspose.app/cells/conversion/tsv-to-tabdelimited) 今すぐライブデモのウェブサイトにアクセスしてください。ライブデモには次の利点があります。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" AsposeAPIをダウンロードする必要はありません。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" コードを書く必要はありません。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" TSVファイルをアップロードするだけで、即座にTABDELIMITEDに変換されます。" >}}
