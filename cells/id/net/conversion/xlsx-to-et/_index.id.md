---
title: C# XLSX to ET - Online XLSX to ET Converter
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Online Gratis C# Ubah XLSX menjadi ET saveformat. C# XLSX ke format ET. Simpan XLSX ke ET C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi ET di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi XLSX ke ET. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, ET, dan banyak format lainnya pada Kerangka .NET, .NET Inti atau Mono Platform." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke ET di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi ET di C#.
...
{{% blocks/products/pf/agp/content h2="Cara Konversi XLSX ke ET via C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke ET secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX menjadi ET hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengonversi XLSX menjadi ET" %}}
