...
description: Aspose Exceller. Java Créez un fichier TIFF rapidement et facilement avec Aspose.Cells. Générez un fichier TIFF à l'aide de Java. Créez TIFF dans Java. Java TIFF Creater.
...
1. Enregistrez le classeur au format TIFF à l'aide de la méthode save().
