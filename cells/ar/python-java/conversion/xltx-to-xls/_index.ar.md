...
description: Aspose اكسل. تحويل XLTX إلى XLS بسرعة وسهولة مع Aspose.Cells. Python XLTX إلى XLS. Python احفظ XLTX إلى XLS. احفظ XLTX كـ 07611134 81 باستخدام Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTX إلى XLS في Python" h2="مكتبة Python عالية السرعة لتحويل XLTX إلى XLS. هذا حل برمجي احترافي لاستيراد وتصدير XLTX، XLS، والعديد من التنسيقات الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
