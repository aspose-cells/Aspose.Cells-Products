...
يوضح المثال التالي كيفية دمج OTS في ETT في Aspose.Cells for C++.
...
هل تحتاج إلى دمج OTS إلى ETT برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج OTS إلى ETT" %}}
