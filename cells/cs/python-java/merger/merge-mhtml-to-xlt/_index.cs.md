...
description: Aspose Excel. Python Aspose.Cells. Sloučit MHTML do XLT uložit formát. Python Kombinujte formát MHTML až XLT. Sloučit MHTML až XLT v Python. MHTML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHTML až XLT v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHTML až XLT v Python" InputFormat="mhtml" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
