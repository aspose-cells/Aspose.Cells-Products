...
{{% blocks/products/pf/agp/content h2="Vormen groeperen en degroeperen in Excel-bestand met behulp van Python via .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om vormen in Excel-bestand te groeperen en degroeperen via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Vormen groeperen en groeperen - Python via .NET" offSpacer="" %}}
