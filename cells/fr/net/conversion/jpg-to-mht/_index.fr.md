---
title: C# Convertisseur JPG vers MHT
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG en MHT, permettant un enregistrement transparent des données JPG au format MHT à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG au format MHT dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en MHT en C#.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier JPG en MHT. Téléchargez votre fichier JPG, puis enregistrez-le au format MHT. Pour la lecture des fichiers JPG et l'écriture des fichiers MHT, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme du fichier MHT de sortie seront identiques à ceux du document JPG d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir un JPG en MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir un fichier JPG en MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en MHT par programmation ? Les développeurs de .NET peuvent facilement charger et convertir des fichiers JPG en MHT en quelques lignes de code seulement.
...
1.  Convertissez le format JPG en MHT en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en MHT" %}}
