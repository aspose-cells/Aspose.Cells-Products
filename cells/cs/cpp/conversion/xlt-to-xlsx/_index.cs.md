---
title: Převeďte XLT na XLSX pomocí aplikace C++ 
url: /cs/cpp/conversion/xlt-to-xlsx/ 
description: Ukázka převodního kódu C++ pro dokument XLT na formát XLSX. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLT na XLSX v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLT na XLSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLSX).1. Soubor XLSX bude uložen do zadané cesty.1. Otevřete soubor XLSX v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLT na XLSX C++" offSpacer="" %}}
