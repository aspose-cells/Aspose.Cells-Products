---
title:  XLS 파일에서 보고서 생성 via Java
weight: 1090
description: JSP/JSF 응용 프로그램 및 데스크탑 응용 프로그램용 Java 런타임 환경에 대한 XLS 형식 보고서를 생성하는 Java 샘플 코드.
---
...
1.  Worbook.save 메소드를 통해 결과를 XLS 형식으로 저장
...
{{% blocks/products/pf/agp/code-block title="XLS 형식의 Excel 보고서 생성 - C#" offSpacer="" %}}
