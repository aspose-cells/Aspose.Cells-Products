---
title: Java aracılığıyla TABDELIMITED'i XPS'e dönüştürün 
url: /tr/java/conversion/tabdelimited-to-xps/ 
description: TABDELIMITED biçimi için XPS dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada XPS'e aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla TABDELIMITED\'i XPS\'e dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı XPS\'ye dönüştürmek için TABDELIMITED\'den XPS\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TABDELIMITED\'i XPS\'e Dönüştürme" %}}

 TABDELIMITED'i XPS'e dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden TABDELIMITED\'i XPS\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, TABDELIMITED dosyasını yalnızca birkaç satır kodla kolayca XPS'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. Parametre olarak XPS uzantısı ve SaveFormat ile çıktı yolunu iletin1. Ortaya çıkan XPS dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED - XPS Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TABDELIMITED dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.tabdelimited");
// TABDELIMITED'i XPS olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED - XPS Dönüşüm Canlı Demoları" sectionDescription="[TABDELIMITED\'i XPS\'ye dönüştür](https://products.aspose.app/cells/conversion/tabdelimited-to-xps) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" TABDELIMITED dosyanızı yükleyin, anında XPS\'e dönüştürülecektir." >}}
