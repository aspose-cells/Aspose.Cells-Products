---
title: PHP HTM a XLTX - Convertidor HTM a XLTX
description: Aspose Excel. Convierta HTM a XLTX rápida y fácilmente con Aspose.Cells. PHP HTM a XLTX. PHP Guarde HTM en XLTX. Guarde HTM como XLTX usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a XLTX mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a XLTX mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a XLTX en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a XLTX llamando al método guardar del libro de trabajo.
