---
title: Mesclar PRN para OTS - Combine PRN para OTS em C++
url: /pt/cpp/merger/merge-prn-to-ots/ 
description: Aspose Excel. C++ Aspose.Cells. Free Online Mesclar PRN para OTS saveformat. C++ Combine o formato PRN para OTS. Mesclar PRN para OTS em C++. Mesclar PRN.
...
{{% blocks/products/pf/agp/content h2="Mesclar PRN para OTS em C++ online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar PRN com OTS em Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar PRN com OTS. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo OTS. Se você desenvolver código em C++, isso será mais simples do que parece. Consulte o exemplo C++ que mescla PRN com OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar PRN para OTS em C++" InputFormat="prn" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar PRN para OTS via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar PRN para OTS programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para mesclar PRN para OTS" %}}
