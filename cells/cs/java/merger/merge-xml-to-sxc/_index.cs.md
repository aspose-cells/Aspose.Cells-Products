...
Postupujte podle jednoduchých kroků pro sloučení XML do SXC. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru SXC. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí XML do SXC.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro sloučení XML do SXC" %}}
