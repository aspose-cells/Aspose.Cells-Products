---
title: C# PNG - MHT - PNG - MHT Converter
description: Aspose Excel. A PNG számot gyorsan és egyszerűen konvertálja MHT-ra a Aspose.Cells-es számmal. C# PNG MHT-vá. C# Takarítson meg PNG-et az MHT-nak. Mentse el a PNG számot MHT-ként a C# használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse a PNG számot az MHT-nak a C# számon" %}}

A következő példa bemutatja, hogyan lehet átalakítani a PNG-et MHT-vé a C#-ben.
...
{{% cells-convert title="Mintakód a PNG MHT-vá alakításához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A PNG konvertálása MHT-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A PNG fájlokat programozottan MHT-vé kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal MHT-vé konvertálhatják a PNG-et.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a PNG konvertálásához MHT-vé" %}}
