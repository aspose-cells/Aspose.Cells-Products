...
{{% blocks/products/pf/agp/content h2="Jak vložit hvězdu/banner do souboru aplikace Excel pomocí Java" %}}

 Abychom vložili hvězdu/banner do excelového souboru, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení Vložit hvězdu/banner do souboru Excel via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Vložit hvězdu/banner – Java" offSpacer="" %}}
