---
title: C++ PRN a XPS - PRN a XPS Convertitore
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori C++ un approccio completamente integrato per convertire i dati PRN nel formato XPS, consentendo il salvataggio senza interruzioni dei dati PRN nel formato XPS utilizzando la libreria Aspose.Cells, il tutto tramite codice C++ efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva PRN su XPS in C++" %}}

L'esempio seguente mostra come convertire PRN in XPS in C++.
...
{{% blocks/products/pf/agp/content h2="Come convertire il PRN in XPS tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file PRN in XPS tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in XPS in poche righe di codice.
...
1.  Convertire PRN in XPS chiamando il metodo Save().
1.  Ottieni il risultato della conversione da PRN a XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C++ per convertire PRN in XPS" %}}
