---
title:  Sloučit ODS na HTML přes Python
url: /cs/python-java/merger/merge-ods-to-html/ 
description: Sloučit ODS až HTML online zdarma. Online zdarma ODS až HTML Fúze. Sloučit ODS do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit ODS až HTML v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení ODS až HTML online" InputFormat="ods" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
