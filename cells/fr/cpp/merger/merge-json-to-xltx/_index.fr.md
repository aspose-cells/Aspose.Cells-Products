---
title:  Fusionner JSON à XLTX via C++
url: /fr/cpp/merger/merge-json-to-xltx/ 
description: Fusionnez JSON à XLTX en ligne gratuitement. Gratuit en ligne JSON à XLTX Fusion. Fusionnez JSON vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner JSON à XLTX dans C++.
...
{{% cells-merger title="Application gratuite pour fusionner JSON à XLTX en ligne" InputFormat="json" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
