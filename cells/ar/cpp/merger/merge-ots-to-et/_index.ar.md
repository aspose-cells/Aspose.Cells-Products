---
title: دمج OTS إلى ET - ادمج OTS في ET في C++
url: /ar/cpp/merger/merge-ots-to-et/ 
description: Aspose إكسل. C++ Aspose.Cells. قم بدمج OTS مجانًا عبر الإنترنت إلى تنسيق حفظ ET. C++ ادمج OTS بتنسيق ET. دمج OTS إلى ET في C++. دمج OTS.
...
{{% blocks/products/pf/agp/content h2="قم بدمج OTS في ET في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج OTS في ET في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج OTS في ET. قم بتحميل الملفات الخاصة بك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف ET. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. انظر C++ المثال الذي يدمج OTS إلى ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج OTS في ET في C++" InputFormat="ots" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج OTS في ET عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج OTS إلى ET برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج OTS إلى ET" %}}
