---
title: Konvertor PHP MHTML až XLTX - MHTML až XLTX
description: Aspose Excel. Převeďte MHTML na XLTX rychle a snadno pomocí Aspose.Cells. PHP MHTML na XLTX. PHP Uložte MHTML na XLTX. Uložte XLTX jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na XLTX přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na XLTX programově? Vývojáři PHP mohou snadno načíst a převést MHTML na XLTX v několika řádcích kódu.
...
1.  Převeďte MHTML na XLTX voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na XLTX" %}}
