---
title: Konwertuj TSV na TIFF za pomocą aplikacji C++ 
weight: 5960

description: Przykładowy kod konwersji C++ dla dokumentu TSV do formatu TIFF. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TSV do TIFF w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TSV na TIFF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (TIFF).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik TIFF w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TSV do TIFF C++ Kod źródłowy konwersji" offSpacer="" %}}
