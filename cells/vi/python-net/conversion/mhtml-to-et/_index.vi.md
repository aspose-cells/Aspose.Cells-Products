---
title: Python MHTML sang ET - Bộ chuyển đổi MHTML sang ET trực tuyến
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Trực tuyến miễn phí Python Chuyển đổi MHTML sang định dạng lưu ET. Python MHTML sang định dạng ET. Lưu MHTML thành ET Python.
...
Cần chuyển đổi các tệp MHTML sang ET theo chương trình? Python nhà phát triển có thể dễ dàng tải và chuyển đổi MHTML sang ET chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi MHTML sang ET bằng cách gọi phương thức Workbook.save.
