---
title: Python MHT naar DIF - Online MHT naar DIF Converter
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Gratis online Python Converteer MHT naar DIF opslagformaat. Python MHT naar DIF formaat. Sla MHT op naar DIF Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MHT naar DIF in Python" h2="High-speed Python-bibliotheek voor het converteren van MHT naar DIF. Dit is een professionele softwareoplossing voor het importeren en exporteren van MHT, DIF en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe MHT naar DIF te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

Moet u MHT-bestanden programmatisch converteren naar DIF? Python-ontwikkelaars kunnen MHT eenvoudig laden en converteren naar DIF in slechts een paar regels code.
...
1.  Converteer MHT naar DIF door de methode Workbook.save aan te roepen.
