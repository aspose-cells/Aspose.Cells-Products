...
description: Aspose เอ็กเซล. แปลง NUMBERS เป็น XLS อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ NUMBERS เป็น XLS C++ บันทึก NUMBERS เป็น XLS บันทึก NUMBERS เป็น XLS โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึกหมายเลขไปที่ XLS ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง NUMBERS เป็น XLS ใน C++
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลงตัวเลขเป็น XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="วิธีแปลงตัวเลขเป็น XLS ผ่าน C++" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการแปลงไฟล์ NUMBERS เป็น XLS โดยทางโปรแกรมหรือไม่ นักพัฒนา C++ สามารถแปลง NUMBERS เป็น XLS ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง NUMBERS เป็น XLS โดยการเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลงจาก NUMBERS เป็น XLS

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ ไลบรารี่เพื่อแปลง NUMBERS เป็น XLS" %}}
