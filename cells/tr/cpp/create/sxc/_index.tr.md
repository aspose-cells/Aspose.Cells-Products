...
description: Aspose Excel'de. C++ Aspose.Cells ile hızlı ve kolay bir şekilde SXC Dosyası oluşturun. C++'i kullanarak SXC dosyası oluşturun. C++'de SXC oluşturun. C++ SXC Oluşturucu.
...
1.  Save() yöntemini kullanarak çalışma kitabını .sxc dosyası olarak kaydedin.
