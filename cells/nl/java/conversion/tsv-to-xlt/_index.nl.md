---
title: Converteer TSV naar XLT via Java 
weight: 6920
url: /nl/java/conversion/tsv-to-xlt/ 
description: Voorbeeld Java conversiecode voor TSV-indeling naar XLT-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar XLT te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer TSV naar XLT via Java" h2="TSV naar XLT Java-conversie om enkele of meerdere pagina\'s naar XLT te converteren met behulp van een lokale bibliotheek Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe TSV naar XLT te converteren met Java" %}}

 Om TSV naar XLT te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TSV naar XLT te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen TSV-bestanden eenvoudig in slechts een paar regels code naar XLT converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad TSV-bestand met een exemplaar van de werkmapklasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met XLT-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende XLT-bestand
...
{{% blocks/products/pf/agp/code-block title="TSV naar XLT Java conversiebroncode" offSpacer="" %}}
