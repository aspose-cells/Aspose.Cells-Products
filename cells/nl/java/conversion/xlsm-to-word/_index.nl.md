...
{{% blocks/products/pf/agp/content h2="Sla XLSM op in WORD in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSM omzet naar WORD in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar WORD of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSM programmatisch converteren naar WORD? Ontwikkelaars van Java kunnen bestanden met de extensie XLSM eenvoudig converteren naar WORD met slechts een paar regels code.
