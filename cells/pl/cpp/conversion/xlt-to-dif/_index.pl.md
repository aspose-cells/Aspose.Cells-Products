---
title: Konwertuj XLT na DIF za pomocą aplikacji C++ 

description: Przykładowy kod konwersji C++ dla dokumentu XLT do formatu DIF. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLT na DIF w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na DIF za pomocą C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na DIF za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLT na DIF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (DIF).1. Plik DIF zostanie zapisany pod określoną ścieżką.1. Otwórz plik DIF w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLT do DIF C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją XLT na DIF" sectionDescription="[Konwertuj XLT na DIF](https://products.aspose.app/cells/conversion/xlt-to-dif) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLT, zostanie on natychmiast przekonwertowany do formatu DIF." >}}
