---
title: Creëer FODS - Creëer FODS bestand in C++
description: Aspose Excel. C++ Creëer FODS-bestand. Creëer FODS C++. C++ FODS Maker. Maak FODS in C++. Genereer FODS-bestand met C++.
...
{{% blocks/products/pf/agp/content h2="Hoe FODS te maken in C++" %}}

{{% blocks/products/pf/agp/text %}}

 Het is gemakkelijk voor de ontwikkelaars om FODS-bestanden te maken, laden, wijzigen en converteren binnen lopende rapportagetoepassingen voor gegevensverwerking in slechts enkele regels code.
...
1.  Sla de werkmap op als .fods-bestand met de methode Save().

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een FODS-bestand maakt in C++." offSpacer="" %}}
