---
title: C# TSV bis XLSX - TSV bis XLSX Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie TSV bis XLSX in C#" %}}

Das folgende Beispiel zeigt, wie man TSV in C# in XLSX umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie TSV über C# in XLSX" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie TSV-Dateien programmgesteuert in XLSX konvertieren? .NET-Entwickler können TSV mit nur wenigen Codezeilen problemlos in XLSX laden und konvertieren.
...
1.  Konvertieren Sie TSV in XLSX durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von TSV in XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von TSV in XLSX" %}}
