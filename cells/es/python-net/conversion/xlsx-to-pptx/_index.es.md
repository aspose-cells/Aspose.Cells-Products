...
description: Aspose Excel. Convierta XLSX a PPTX rápida y fácilmente con Aspose.Cells. Python XLSX a PPTX. Python Guarde XLSX en PPTX. Guarde XLSX como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSX al PPTX en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSX a PPTX en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir XLSX a PPTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSX en PPTX" %}}
