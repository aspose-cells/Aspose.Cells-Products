---
title: Konversikan SXC ke GIF melalui Java 

description: Contoh Java kode konversi untuk format SXC ke file GIF. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke GIF dalam Aplikasi berbasis Web atau Desktop Java apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan SXC ke GIF melalui Java" h2="Konversi SXC ke GIF Java untuk mengonversi satu atau beberapa halaman menjadi GIF menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi SXC ke GIF Menggunakan Java" %}}

 Untuk merender SXC ke GIF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi SXC ke GIF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file SXC ke GIF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file SXC dengan instance Workbook1. Pilih default atau Lembar Kerja apa pun dari koleksi1. Buat & atur objek ImageOrPrintOptions1. Buat SheetRender dengan objek Worksheet & ImageOrPrintOptions1. Panggil metode SheetRender.toImage untuk menyimpan hasil dalam format GIF
...
{{% blocks/products/pf/agp/code-block title="SXC ke GIF Java Kode Sumber Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi SXC ke GIF" sectionDescription="[Konversikan SXC ke GIF](https://products.aspose.app/cells/conversion/sxc-to-gif) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file SXC Anda, itu akan langsung dikonversi ke GIF." >}}
