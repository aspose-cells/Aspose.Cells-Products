...
description: Aspose Excel. Konwertuj HTM na XLSB szybko i łatwo za pomocą Aspose.Cells. Python HTM na XLSB. Python Zapisz HTM na XLSB. Zapisz HTM jako XLSB, używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na XLSB za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM pod numerem XLSB w Python" %}}

Poniższy przykład ilustruje sposób konwersji HTM na XLSB w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji HTM na XLSB" %}}
