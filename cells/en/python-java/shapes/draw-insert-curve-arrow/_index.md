---
title: How to draw or insert curved arrow shape into Excel using Python via Java
weight: 10

description: Draw or insert curved arrow shape using Aspose.Cells' Python via Java API without any software such as Microsoft or Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="How to Insert curved arrow shape into Excel File Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert curved arrow shape to Excel file using Python via Java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) to insert a curved arrow shape in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert curved arrow shape - Python via Java" offSpacer="" %}}
