...
weight: 20
description: Python via mã nguồn java để chèn ComboBox(Form control) vào Excel.
...
{{% blocks/products/pf/agp/content h2="Cách chèn ComboBox (Điều khiển biểu mẫu) vào tệp Excel bằng Python via java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)) để chèn ComboBox(Điều khiển biểu mẫu) vào bảng tính đã chọn.
