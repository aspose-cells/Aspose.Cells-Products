---
title: Java PNG 至 TSV - PNG 至 TSV 转换器
description: Aspose Excel。 Java Aspose.Cells。Java中的PNG到TSV。Java将PNG转换为TSV保存格式。 Java PNG 到 TSV 格式。将 PNG 保存为 TSV Java。
...
{{% cells-convert title="将 PNG 转换为 TSV 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="tsv" IsLandingPage="true" language="java" %}}
