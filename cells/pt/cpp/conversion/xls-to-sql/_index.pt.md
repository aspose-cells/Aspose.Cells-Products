...
Precisa converter arquivos XLS para SQL programaticamente? Os desenvolvedores do C++ podem converter facilmente o XLS em SQL em apenas algumas linhas de código.
...
1.  Converta XLS em SQL chamando o método Save().
