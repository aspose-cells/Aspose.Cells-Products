...
El siguiente ejemplo muestra cómo combinar XLTM con ODS en Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 ¿Necesita fusionar XLTM con ODS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Las API se pueden hacer con solo unas pocas líneas de código.
