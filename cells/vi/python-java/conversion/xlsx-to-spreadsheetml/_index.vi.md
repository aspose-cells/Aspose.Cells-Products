---
title: Chuyển đổi XLSX thành SPREADSHEETML qua Python
url: /vi/python-java/conversion/xlsx-to-spreadsheetml/
description: Mã mẫu để chuyển đổi xlsx sang bảng tínhml Python. Sử dụng mã mẫu API cho hàng loạt tệp xlsx để chuyển đổi bảng tínhml trong ứng dụng Python.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSX thành SPREADSHEETML bằng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLSX thành SPREADSHEETML qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp XLSX sang SPREADSHEETML chỉ trong một vài dòng mã.
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi XLSX sang SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xml" IsLandingPage="true" language="python" %}}
