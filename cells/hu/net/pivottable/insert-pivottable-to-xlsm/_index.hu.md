...
{{% blocks/products/pf/agp/feature-section-col title="Kimutatás beszúrása a XLSM-be a C#-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="PivotTable beszúrása a XLSM - C# számokhoz" offSpacer="" %}}
