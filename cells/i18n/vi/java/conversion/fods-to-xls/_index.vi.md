---
title: Chuyển đổi FODS sang XLS qua Java 
url: /vi/java/conversion/fods-to-xls/ 
description: Mã chuyển đổi Java mẫu cho định dạng FODS thành tệp XLS. Lập trình viên có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang XLS trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi FODS sang XLS qua Java" h2="Chuyển đổi FODS sang XLS Java để chuyển đổi một hoặc nhiều trang sang XLS bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi FODS sang XLS bằng cách sử dụng Java" %}}

 Để hiển thị FODS thành XLS, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi FODS sang XLS qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp FODS sang XLS chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp FODS với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Truyền đường dẫn đầu ra với phần mở rộng XLS & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp XLS kết quả
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi từ FODS sang XLS Java" offSpacer="" %}}

```cs
// tải tệp FODS trong một phiên bản của Workbook
Workbook book = new Workbook("template.fods");
// lưu FODS dưới dạng XLS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi FODS sang XLS" sectionDescription="[Chuyển đổi FODS sang XLS](https://products.aspose.app/cells/conversion/fods-to-xls) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp FODS của bạn, tệp sẽ được chuyển đổi ngay lập tức sang XLS." >}}
