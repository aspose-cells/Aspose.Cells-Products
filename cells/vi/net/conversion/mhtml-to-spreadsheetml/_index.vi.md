---
title: C# MHTML sang SPREADSHEETML - MHTML sang SPREADSHEETML Chuyển đổi
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển C# một phương pháp tích hợp đầy đủ để chuyển đổi MHTML sang định dạng SPREADSHEETML, cho phép lưu dữ liệu MHTML một cách liền mạch vào định dạng SPREADSHEETML bằng cách sử dụng thư viện Aspose.Cells, tất cả thông qua mã C# hiệu quả và có thể tùy chỉnh.
...
{{% blocks/products/pf/agp/content h2="Lưu MHTML vào SPREADSHEETML trong C#" %}}

Ví dụ sau đây minh họa cách chuyển đổi MHTML sang định dạng SPREADSHEETML trong C#.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi MHTML thành SPREADSHEETML qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tệp MHTML sang SPREADSHEETML theo chương trình? Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi MHTML sang SPREADSHEETML chỉ bằng vài dòng mã.
...
1.  Chuyển đổi MHTML sang định dạng SPREADSHEETML bằng cách gọi phương thức Workbook.Save.
1.  Nhận kết quả chuyển đổi MHTML sang SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C# để chuyển đổi MHTML sang định dạng SPREADSHEETML." %}}
