---
title: Převeďte JSON na EMF prostřednictvím aplikace C++ 
url: /cs/cpp/conversion/json-to-emf/ 
description: Ukázkový konverzní kód C++ pro dokument JSON do formátu EMF. Programátoři mohou tento zdrojový kód použít pro dávkový převod JSON na EMF v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést JSON na EMF pomocí C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu JSON na EMF prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor JSON na EMF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor JSON pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavení možností (EMF).1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor EMF v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu JSON na EMF C++" offSpacer="" %}}
