...
description: Aspose Excel. Chuyển đổi XLSB sang TIFF nhanh chóng và dễ dàng với Aspose.Cells. Python XLSB sang TIFF. Python Lưu XLSB thành TIFF. Lưu XLSB thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Lưu XLSB vào TIFF trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSB thành TIFF trong Python via NET.
...
{{% cells-convert title="Mã mẫu chuyển đổi XLSB thành TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="tiff" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLSB thành TIFF" %}}
