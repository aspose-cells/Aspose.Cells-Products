---
title: Gabungkan FODS menjadi MARKDOWN - Gabungkan FODS menjadi MARKDOWN menjadi Java
url: /id/java/merger/merge-fods-to-markdown/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS menjadi MARKDOWN format simpan. Java Gabungkan format FODS menjadi MARKDOWN. Gabungkan FODS menjadi MARKDOWN di Java. FODS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS menjadi MARKDOWN di Java" %}}

Contoh berikut menunjukkan cara menggabungkan FODS menjadi MARKDOWN di Aspose.Cells for Java.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan FODS menjadi MARKDOWN di Java" InputFormat="fods" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS menjadi MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke MARKDOWN secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan FODS menjadi MARKDOWN" %}}
