---
title: Gabung XLTX ke XLSX - Gabungkan XLTX ke XLSX di Python
url: /id/python-java/merger/merge-xltx-to-xlsx/ 
description: Aspose Unggul. Python Aspose.Cells. Free Online Merge XLTX to XLSX saveformat. Python Gabungkan format XLTX menjadi XLSX. Gabung XLTX ke XLSX di Python. XLTX Gabung.
...
Contoh berikut menunjukkan cara menggabungkan XLTX ke XLSX di Aspose.Cells for Python via Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan XLTX ke XLSX di Python" InputFormat="xltx" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLTX ke XLSX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLTX menjadi XLSX secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API dapat dilakukan hanya dengan beberapa baris kode.
