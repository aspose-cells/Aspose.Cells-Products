...
description: Aspose Exceller. Convertissez XML en XLAM rapidement et facilement avec Aspose.Cells. Python XML en XLAM. Python Enregistrez XML en XLAM. Enregistrez XML sous XLAM en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en XLAM à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au XLAM dans Python" %}}

L'exemple suivant montre comment convertir XML en XLAM en Python.
...
{{% cells-convert title="Exemple de code pour convertir XML en XLAM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xlam" IsLandingPage="true" language="pythonjava" %}}
