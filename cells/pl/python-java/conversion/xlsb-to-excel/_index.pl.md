...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSB na EXCEL za pomocą Aspose.Cells. Python XLSB na EXCEL. Python Zapisz XLSB w programie EXCEL. Zapisz XLSB jako EXCEL, używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLSB na EXCEL za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB w EXCEL w Python" %}}

Poniższy przykład ilustruje, jak przekonwertować XLSB na EXCEL w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji XLSB na EXCEL" %}}
