...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLS programmatisch samenvoegen tot ODS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLS samen te voegen tot ODS" %}}
