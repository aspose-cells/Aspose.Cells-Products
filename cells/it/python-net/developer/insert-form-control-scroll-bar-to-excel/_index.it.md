...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire ScrollBar (controllo modulo) in un file Excel utilizzando Python via .Net" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Utilizza l'aggiunta della shapecollection[metodo](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_scroll_bar/#int-int-int-int-int-int) per inserire una ScrollBar (controllo modulo) nel foglio di lavoro selezionato.
...
{{% blocks/products/pf/agp/code-block title="Inserisci ScrollBar (controllo modulo) - Python via .Net" offSpacer="" %}}
