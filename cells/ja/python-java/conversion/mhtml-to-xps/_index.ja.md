---
title: Python MHTML ～ XPS - MHTML ～ XPS コンバータ
description: Aspose エクセル。 MHTML を Aspose.Cells ですばやく簡単に XPS に変換します。 Python MHTML から XPS に変換します。 Python MHTML を XPS に保存します。 MHTML を 07611134 として保存しますPythonを使用して81。
...
{{< blocks/products/pf/i18n/upper-banner h1="MHTML を Python の XPS に変換します" h2="MHTML を XPS に変換するための高速 Python ライブラリ。これは、MHTML、XPS、および Python を使用する他の多くの形式をインポートおよびエクスポートするためのプロフェッショナル ソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python を使用して MHTML を XPS に変換します" %}}

MHTML を XPS に変換するにはどうすればよいですか? Aspose.Cells for Python ライブラリを使用すると、数行のコードでプログラム的に MHTML を XPS に簡単に変換できます。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)すべての Excel ファイルを生成、変更、変換、レンダリング、印刷できるクロスプラットフォーム アプリケーションを構築できます。 Python Excel API は、スプレッドシート形式間で変換するだけでなく、Excel ファイルを画像 PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT などとしてレンダリングすることもできるため、業界標準形式でドキュメントを交換するのに最適です。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="MHTML を Python に保存" %}}

次の例は、MHTML を Python の XPS に変換する方法を示しています。
...
{{% blocks/products/pf/agp/content h2="Python経由でMHTMLをXPSに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

MHTML ファイルをプログラムで XPS に変換する必要がありますか? Python 開発者は、わずか数行のコードで MHTML を簡単にロードして XPS に変換できます。
...
1.  Workbook.save メソッドを呼び出して、MHTML を XPS に変換します。
