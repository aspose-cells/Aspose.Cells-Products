---
title: Combinar HTM con TXT - Combinar HTM con TXT en Python
url: /es/python-net/merger/merge-htm-to-txt/ 
description: AsposeExcel. Python Aspose.Cells. Combinación gratuita en línea HTM al TXT guardar formato. Python Combinar HTM al formato TXT. Combinar HTM a TXT en Python. Combinar HTM.
...
El siguiente ejemplo muestra cómo combinar HTM con TXT en Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Gratis en línea para fusionar HTM al TXT en Python" InputFormat="htm" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar HTM a TXT a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar HTM con TXT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Las API se pueden hacer con solo unas pocas líneas de código.
