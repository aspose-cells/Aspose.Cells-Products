---
title:  แทรก Arc ลงใน Excel โดยใช้ Python via java
weight: 10
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก Arc ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกไฟล์ Arc ลงใน Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addArc(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกส่วนโค้งในแผ่นงานที่เลือก
