---
title: دمج OTS في WORD - ادمج OTS to WORD في C++
url: /ar/cpp/merger/merge-ots-to-word/ 
description: Aspose إكسل. C++ Aspose.Cells. مجاني على الإنترنت لدمج OTS إلى WORD saveformat. C++ دمج OTS بتنسيق WORD. دمج OTS إلى WORD في C++. دمج OTS.
...
{{% blocks/products/pf/agp/content h2="دمج OTS في WORD باستخدام C++" %}}
...
{{% blocks/products/pf/agp/content h2="دمج OTS في WORD في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج OTS في WORD في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج OTS في WORD. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف WORD. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج OTS إلى WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج OTS في WORD في C++" InputFormat="ots" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج OTS في WORD عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج OTS في WORD برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
