---
title:  C++ numaralı belgeyi açmadan XLS numaralı belgeyi arayın.
weight: 4560
description: C++ numaralı örnek kod, XLS dosyasındaki kelimeleri C++ çalışma ortamında, Windows 32 bit, Windows 64 bit ve Linux 64 bit işletim sistemlerinde belirli bir desenle aramak için kullanılır.
...
{{% blocks/products/pf/agp/content h2="C++ kullanarak XLS dosyasını nasıl arayabilirsiniz?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ numaralı bölgede XLS numaralı dosyaları arama adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="XLS Dosyasını Ara - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi XLS Canlı Demoları Ara" sectionDescription=" Hemen şimdi sitemizi ziyaret ederek XLS numaralı belgeler içindeki metinleri, kelimeleri ve kelime öbeklerini arayın.[Canlı Demolar web sitesi](https://products.aspose.app/cells/search). Canlı demo aşağıdaki avantajlara sahiptir" >}}
