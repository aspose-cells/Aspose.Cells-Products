...
description: Aspose Excel. Konvertieren Sie HTM schnell und einfach in PPTX mit Aspose.Cells. C++ HTM in PPTX. C++ Speichern Sie HTM in PPTX. Speichern Sie HTM als PPTX mit C++.
...
{{% cells-convert title="Beispielcode zum Konvertieren von HTM in PPTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="pptx" IsLandingPage="true" language="cpp" %}}
