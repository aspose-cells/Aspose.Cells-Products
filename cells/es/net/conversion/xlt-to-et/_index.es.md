...
{{% cells-convert title="Código de muestra para convertir XLT a ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a ET mediante C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLT a ET mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente XLT a ET en solo unas pocas líneas de código.
