---
title: 創建IMAGE - 在Java中創建IMAGE文件
description: Aspose Excel。 Java 創建圖像文件。創建圖像 Java。Java 圖像創建者。在Java中創建IMAGE。使用Java生成IMAGE文件。
...
{{% blocks/products/pf/agp/content h2="如何在 Java 中創建圖像" %}}
...
1. 使用 save() 方法將工作簿保存為 IMAGE 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 IMAGE 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java 創建IMAGE文件的庫" %}}
{{% blocks/products/pf/agp/text %}}
