---
title: Gabungkan MHTML menjadi TXT - Gabungkan MHTML menjadi TXT menjadi Java
url: /id/java/merger/merge-mhtml-to-txt/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan MHTML menjadi TXT format simpan. Java Gabungkan format MHTML menjadi TXT. Gabungkan MHTML menjadi TXT di Java. MHTML Gabungkan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan MHTML menjadi TXT via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan MHTML menjadi TXT. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="MHTML" additionalConversionTag="TXT" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHTML menjadi TXT di Java" %}}

Contoh berikut menunjukkan cara menggabungkan MHTML menjadi TXT di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan MHTML ke TXT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file TXT. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan MHTML menjadi TXT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan MHTML menjadi TXT di Java" InputFormat="mhtml" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML menjadi TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan MHTML ke TXT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan MHTML menjadi TXT" %}}
