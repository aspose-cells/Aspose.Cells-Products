...
{{% blocks/products/pf/agp/content h2="Sla HTML op in TSV in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar TSV in C++.
...
Moet je bestanden met de extensie HTML programmatisch converteren naar TSV? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar TSV met slechts een paar regels code.
