...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie HTML in XLSM mit Java" %}}

 Um HTML in XLSM zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von HTML in XLSM über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können HTML-Dateien in nur wenigen Codezeilen problemlos in XLSM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie eine HTML-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit der XLSM-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende XLSM-Datei
...
{{% blocks/products/pf/agp/code-block title="Konvertierungsquellcode von HTML zu XLSM Java" offSpacer="" %}}

```cs
// Laden Sie die HTML-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.html");
// HTML als XLSM speichern
