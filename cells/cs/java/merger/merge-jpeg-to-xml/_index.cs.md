---
title: Sloučit JPEG do XML – Sloučit JPEG do XML v Java
url: /cs/java/merger/merge-jpeg-to-xml/ 
description: Aspose Excel. Java Aspose.Cells. Zdarma online sloučení JPEG do formátu uložení XML. Java Zkombinujte JPEG do formátu XML. Sloučit JPEG do XML v Java. JPEG Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG do XML pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG do XML v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JPEG do XML v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPEG do XML. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XML. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí JPEG do XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JPEG do XML v Java" InputFormat="jpg" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPEG do XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit JPEG do XML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení JPEG do XML" %}}
