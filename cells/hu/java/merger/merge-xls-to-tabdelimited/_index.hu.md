---
title: A XLS egyesítése a TABDELIMITED számmal – a XLS és a TABDELIMITED egyesítése a Java-ben
url: /hu/java/merger/merge-xls-to-tabdelimited/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés XLS TABDELIMITED mentési formátumba. Java A XLS kombinálása TABDELIMITED formátumba. A XLS egyesítése a TABDELIMITED-hez a Java-ben. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLS-et a TABDELIMITED-hez a Java-ben online ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a XLS-et a TABDELIMITED-szel a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS és a TABDELIMITED egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a TABDELIMITED fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a XLS-et a TABDELIMITED-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a XLS és a TABDELIMITED egyesítéséhez a Java-ben" InputFormat="xls" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLS és a TABDELIMITED via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-et a TABDELIMITED-el? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a XLS a TAB-ba egyesítéséhezDELIMITED" %}}
