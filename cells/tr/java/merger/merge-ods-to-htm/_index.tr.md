---
title: ODS'i HTM ile birleştir - ODS'i Java'de HTM ile birleştir
url: /tr/java/merger/merge-ods-to-htm/ 
description: Aspose excel. Java Aspose.Cells. ODS'i HTM saveformat'a Ücretsiz Çevrimiçi Birleştirme. Java ODS'i HTM biçiminde birleştirin. ODS'i Java'de HTM ile birleştirin. ODS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java Çevrimiçi HTM ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de HTM ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i HTM ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından HTM dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. ODS'i HTM ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'de HTM ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i HTM via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

ODS'i programlı olarak HTM ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i HTM ile birleştirmek için Java kitaplığı" %}}
