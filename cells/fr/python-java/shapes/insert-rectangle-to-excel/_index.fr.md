---
title:  Insérer un rectangle dans Excel en utilisant Python via Java
weight: 10
description: Python via Java code source pour insérer Rectangle dans Excel.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer un fichier Rectangle dans Excel en utilisant Python via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Insérer Rectangle - Python via Java" offSpacer="" %}}
