---
title: PHP XLAM إلى MHTML - XLAM إلى MHTML محول
description: Aspose اكسل. قم بتحويل XLAM إلى MHTML بسرعة وسهولة باستخدام Aspose.Cells. PHP XLAM إلى MHTML. PHP احفظ XLAM إلى MHTML. احفظ XLAM كـ MHTML باستخدام PHP.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLAM إلى MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="mhtml" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLAM إلى MHTML عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLAM إلى MHTML برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLAM إلى MHTML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLAM إلى MHTML عن طريق استدعاء طريقة حفظ المصنف.
