...
description: Aspose Excel. Konwertuj OTS na JSON szybko i łatwo za pomocą Aspose.Cells. Java OTS na JSON. Java Zapisz OTS na JSON. Zapisz OTS jako JSON, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS pod numerem JSON w Java" %}}

Poniższy przykład ilustruje sposób konwersji OTS na JSON w Java.
...
Chcesz programowo przekonwertować pliki OTS na JSON? Programiści Java mogą z łatwością przekonwertować OTS na JSON w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na JSON" %}}
{{% blocks/products/pf/agp/text %}}
