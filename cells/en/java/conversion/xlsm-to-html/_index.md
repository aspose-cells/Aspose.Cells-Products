...
description: Sample Java conversion code for XLSM format to HTML file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to HTML within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert XLSM to HTML Using Java" %}}
 ...
 In order to render XLSM to HTML, we’ll use
