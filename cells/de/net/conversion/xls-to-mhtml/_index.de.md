---
title: C# XLS zu MHTML - Online-Konverter von XLS zu MHTML
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das Speicherformat MHTML. C# XLS bis MHTML Format. Speichern Sie XLS bis MHTML C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis MHTML in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLS in MHTML in C# konvertiert wird.
...
Müssen Sie XLS-Dateien programmgesteuert in MHTML konvertieren? .NET-Entwickler können XLS problemlos in nur wenigen Codezeilen laden und in MHTML konvertieren.
...
1.  Konvertieren Sie XLS in MHTML, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in MHTML" %}}
