...
url: /cs/python-net/merger/merge-tsv-to-jpg/ 
...
Následující příklad ukazuje, jak sloučit TSV do JPG v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit TSV do JPG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
