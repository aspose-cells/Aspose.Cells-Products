...
url: /tr/python-java/merger/merge-mhtml-to-htm/ 
...
Aşağıdaki örnek, MHTML'in Aspose.Cells for Python via Java'deki HTM ile nasıl birleştirileceğini gösterir.
...
MHTML'i HTM ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
