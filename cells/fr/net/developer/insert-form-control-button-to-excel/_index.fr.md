---
title:  Insérer le bouton dans Excel via .NET
weight: 10
description: C# code source pour insérer le bouton dans Excel sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Comment insérer un bouton dans un fichier Excel à l\'aide de C#" %}}
 ...
 Pour insérer un bouton dans un fichier Excel, nous utiliserons
...
{{% blocks/products/pf/agp/code-block title="Bouton d\'insertion - C#" offSpacer="" %}}
