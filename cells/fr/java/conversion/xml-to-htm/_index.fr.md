...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au format HTM dans Java" %}}

L'exemple suivant montre comment convertir du XML en HTM en Java.
...
Besoin de convertir des fichiers XML en HTM par programmation ? Les développeurs Java peuvent facilement convertir des fichiers XML en HTM en quelques lignes de code seulement.
