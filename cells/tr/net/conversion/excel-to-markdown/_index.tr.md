...
EXCEL dosyalarını programlı olarak MARKDOWN'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip MARKDOWN'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını MARKDOWN formatına dönüştürün.
