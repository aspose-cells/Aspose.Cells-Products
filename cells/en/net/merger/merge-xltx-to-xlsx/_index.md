---
title: Merge XLTX to XLSX - Combine XLTX to XLSX in C#
url: /net/merger/merge-xltx-to-xlsx/ 
description: Aspose Excel. C# Aspose.Cells. Merge XLTX to XLSX saveformat. C# Combine XLTX to XLSX format. Merge XLTX to XLSX in C#. XLTX Merge.
...
{{% blocks/products/pf/agp/content h2="Merge XLTX to XLSX in C#" %}}
...
{{% cells-merger title="Sample Code to Merge XLTX to XLSX in C#" InputFormat="xltx" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
