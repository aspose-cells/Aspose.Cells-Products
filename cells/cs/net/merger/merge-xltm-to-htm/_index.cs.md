...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLTM do formátu uložení HTM. C# Zkombinujte XLTM do formátu HTM. Sloučit XLTM na HTM v C#. XLTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTM na HTM v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTM do HTM v C#" InputFormat="xltm" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
