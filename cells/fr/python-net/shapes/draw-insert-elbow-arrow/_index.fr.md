---
title: Comment dessiner ou insérer une forme de flèche coudée dans Excel à l'aide de Python via .Net
weight: 10
description: Python via Code source .Net pour insérer la forme d'une flèche coudée dans Excel.
...
{{% blocks/products/pf/agp/content h2="Comment insérer la forme d\'une flèche coudée dans un fichier Excel à l\'aide de Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer la forme de la flèche du coude dans un fichier Excel à l\'aide de Python via .Net" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) pour insérer une forme de flèche coudée dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer la forme de la flèche du coude - Python via .Net" offSpacer="" %}}
