...
description: Aspose Excel. Python Aspose.Cells. Merge HTML to SXC saveformat. Python Combine HTML to SXC format. Merge HTML to SXC in Python. HTML Merge.
...
{{% blocks/products/pf/agp/content h2="Merge HTML to SXC in Python" %}}
...
{{% cells-merger title="Sample Code to Merge HTML to SXC in Python" InputFormat="html" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
