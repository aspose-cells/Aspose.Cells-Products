---
title: Sök i XLSB-dokument utan att öppna via Java 
weight: 9420
url: /sv/java/search/xlsb/ 
description: Java exempelkod för att söka efter ord med mönster i XLSB-fil i Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sök i XLSB-format i Java" h2="Inbyggd och högpresterande XLSB-dokumentsökning med Aspose.Cells for Java API:er på serversidan, utan användning av någon programvara som Microsoft eller Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Så här söker du XLSB-fil med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att söka XLSB-filer i Java" %}}
...
+ Ladda XLSB-fil genom att instansiera ett arbetsboksobjekt.
+ Gå till det första kalkylbladet i XLSB-filen.
...
{{% blocks/products/pf/agp/code-block title="Sök XLSB-filer - Java" offSpacer="" %}}

```cs
// Instantiera ett arbetsboksobjekt
Workbook workbook = new Workbook(dataDir + "book1.xlsb");

// Åtkomst till det första kalkylbladet i XLSB-filen
