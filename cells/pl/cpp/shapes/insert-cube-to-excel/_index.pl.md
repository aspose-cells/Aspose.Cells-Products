---
title:  Wstaw kostkę do programu Excel pod numerem C++
weight: 20
description: C++ przykładowy kod do wstawienia kostki do pliku Excel w C++ Środowisko wykonawcze dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
keywords: [C++ Aspose.Cells., C++ add Cube shape., C++ insert Cube shape., C++ create Cube shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw kostkę do programu Excel pod numerem C++" h2="Wstaw obiekty, korzystając z natywnej i wysokiej wydajności po stronie serwera Aspose.Cells for C++ API bez użycia żadnego oprogramowania takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
