---
title: Wstaw komentarze do pliku XLSM pod numerem Python
url: /pl/python-java/comments/insert-comments-to-xlsm/ 
description: Wstaw komentarze pod numerem XLSM, używając numeru Python. Użyj przykładowego kodu API, aby wstawić komentarze w aplikacji Python.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić komentarze w pliku XLSM poprzez Python" %}}
...
Office 365 komentarze służą do rozmów, możesz użyć następującego kodu Python, aby wstawiać i usuwać komentarze w pliku XLSM.

{{% blocks/products/pf/agp/code-block title="Python przykładowy kod do wstawiania i usuwania komentarzy w pliku XLSM" offSpacer="" %}}
...
{{% cells-annotation title="Bezpłatna aplikacja do usuwania adnotacji z pliku XLSM" InputFormat="xlsm" IsLandingPage="true" language="python" %}}
