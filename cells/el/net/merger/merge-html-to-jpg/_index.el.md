---
title: Συγχώνευση HTML σε JPG - Συνδυάστε το HTML σε JPG στο C#
url: /el/net/merger/merge-html-to-jpg/ 
description: Aspose Excel. C# Aspose.Cells. Δωρεάν online συγχώνευση HTML σε μορφή αποθήκευσης JPG. C# Συνδυάστε το HTML σε μορφή JPG. Συγχώνευση HTML σε JPG στο C#. HTML Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση HTML σε JPG στο C# Δωρεάν Online" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το HTML σε JPG στο Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ακολουθήστε τα εύκολα βήματα για να συγχωνεύσετε το HTML σε JPG. Ανεβάστε τα αρχεία σας, καλέστε τη μέθοδο Workbook.Combine για τη συγχώνευση αρχείων και, στη συνέχεια, αποθηκεύστε τα σε αρχείο JPG. Εάν αναπτύξετε κώδικα στο C#, αυτό θα είναι πιο απλό από ό,τι ακούγεται. Δείτε το παράδειγμα C# που συγχωνεύει το HTML σε JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Δωρεάν online για συγχώνευση HTML σε JPG στο C#" InputFormat="html" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Τρόπος συγχώνευσης HTML σε JPG μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να συγχωνεύσετε το HTML σε JPG μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2=".NET βιβλιοθήκη για συγχώνευση HTML σε JPG" %}}
