---
title: PHP OTS naar MD - OTS naar MD-converter
description: Aspose Excel. Converteer OTS snel en eenvoudig naar MD met Aspose.Cells. PHP OTS naar MD. PHP Bewaar OTS naar MD. Sla OTS op als MD met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar MD te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar MD converteren? PHP-ontwikkelaars kunnen OTS eenvoudig in slechts een paar regels code laden en naar MD converteren.
...
1.  Converteer OTS naar MD door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van OTS naar MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om OTS naar MD te converteren" %}}
