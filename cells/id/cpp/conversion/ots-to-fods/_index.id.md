...
description: Aspose Unggul. Ubah OTS menjadi FODS dengan cepat dan mudah menggunakan Aspose.Cells. C++ OTS menjadi FODS. C++ Simpan OTS ke FODS. Simpan OTS sebagai FODS menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah OTS menjadi FODS Menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengonversi OTS ke FODS di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi OTS ke FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="fods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert OTS ke FODS lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file OTS ke FODS secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke FODS hanya dalam beberapa baris kode.
...
1.  Ubah OTS menjadi FODS dengan memanggil metode Save().
1.  Dapatkan hasil konversi OTS menjadi FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah OTS menjadi FODS" %}}
