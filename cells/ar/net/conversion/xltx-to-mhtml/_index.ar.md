---
title: C# XLTX إلى MHTML - عبر الإنترنت من XLTX إلى MHTML
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل XLTX إلى MHTML saveformat. C# XLTX إلى تنسيق MHTML. وفر XLTX إلى MHTML C#.
...
{{% blocks/products/pf/agp/content h2="وفر XLTX إلى MHTML في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل XLTX إلى MHTML في C#.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل XLTX إلى MHTML. قم بتحميل ملف XLTX الخاص بك ، ثم احفظه كملف MHTML. لكل من قراءة XLTX وكتابة MHTML ، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون المحتوى والتنسيق الناتج MHTML متطابقين مع المستند XLTX الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل XLTX إلى MHTML عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="mhtml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTX إلى MHTML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

تحتاج إلى تحويل XLTX ملفات إلى MHTML برمجيا؟ يمكن للمطورين .NET تحميل وتحويل XLTX إلى MHTML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول XLTX إلى MHTML عن طريق استدعاء Workbook.Save method.
1.  احصل على نتيجة التحويل من XLTX إلى MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل XLTX إلى MHTML" %}}
