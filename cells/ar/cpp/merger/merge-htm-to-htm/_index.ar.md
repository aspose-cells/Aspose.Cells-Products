---
title: دمج HTM إلى HTM - ادمج HTM إلى HTM في C++
url: /ar/cpp/merger/merge-htm-to-htm/ 
description: Aspose إكسل. C++ Aspose.Cells. مجاني على الإنترنت دمج HTM إلى HTM saveformat. C++ دمج تنسيق HTM إلى تنسيق HTM. دمج HTM إلى HTM في C++. دمج HTM.
...
{{% blocks/products/pf/agp/content h2="دمج HTM إلى HTM في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج HTM إلى HTM في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج HTM إلى HTM. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف HTM. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يقوم بدمج HTM إلى HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني على الإنترنت لدمج HTM إلى HTM في C++" InputFormat="htm" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج HTM إلى HTM عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج HTM إلى HTM برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج HTM إلى HTM" %}}
