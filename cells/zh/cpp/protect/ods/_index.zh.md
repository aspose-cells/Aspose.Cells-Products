...
1. 使用IWorkbook类加载ODS文件
1. 使用带有 ProtectionType 和密码的 Protect(..) 方法
1. 通过Save()方法保存受保护的ODS文件
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="免费保护应用程序 ODS" sectionDescription="查看我们的现场演示[加密ODS文件](https://products.aspose.app/cells/protect/ods)具有以下好处。" >}}
