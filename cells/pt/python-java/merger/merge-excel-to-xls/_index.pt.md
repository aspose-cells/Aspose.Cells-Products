---
title:  Mesclar EXCEL para XLS via Python
url: /pt/python-java/merger/merge-excel-to-xls/ 
description: Mesclar EXCEL para XLS Online gratuitamente. Free Online EXCEL para XLS Fusão. Mescle EXCEL para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar EXCEL para XLS em Python.
...
{{% cells-merger title="Aplicativo gratuito para mesclar EXCEL para XLS online" InputFormat="xlsx" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
