...
url: /ar/python-net/merger/merge-image-to-ett/ 
...
يوضح المثال التالي كيفية دمج IMAGE مع ETT في Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 هل تحتاج إلى دمج IMAGE مع ETT برمجيًا؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
