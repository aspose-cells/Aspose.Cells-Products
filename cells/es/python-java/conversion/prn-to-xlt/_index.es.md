...
description: Aspose Excel. Convierta PRN a XLT rápida y fácilmente con Aspose.Cells. Python PRN a XLT. Python Guarde PRN en XLT. Guarde PRN como XLT usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PRN a XLT en Python" h2="Biblioteca Python de alta velocidad para convertir PRN a XLT. Esta es una solución de software profesional para importar y exportar PRN, XLT y muchos otros formatos utilizando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convierta PRN a XLT usando Python" %}}

 ¿Cómo convierto PRN a XLT? Con la biblioteca Aspose.Cells for Python, puede convertir fácilmente PRN a XLT mediante programación con unas pocas líneas de código.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Guardar PRN al XLT en Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a XLT en Python.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir PRN a XLT. Cargue su archivo PRN y luego simplemente guárdelo como archivo XLT. Tanto para la lectura de PRN como para la escritura de XLT, puede utilizar nombres de archivo completos. El contenido y el formato de salida XLT serán idénticos al documento PRN original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir PRN a XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlt" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PRN a XLT a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PRN a XLT mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente PRN a XLT en tan solo unas pocas líneas de código.
...
1.  Convierta PRN a XLT llamando al método Workbook.save.
1.  Obtenga el resultado de la conversión de PRN a XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir PRN a XLT" %}}
