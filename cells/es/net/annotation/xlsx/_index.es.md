---
title:  Agregar o quitar XLSX Anotación via .NET
weight: 2010
description: Código fuente C# para agregar y eliminar anotaciones de formato XLSX en plataformas .NET Framework, .NET Core, Mono o Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Agregar o eliminar anotaciones de XLSX a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Eliminar anotaciones de XLSX - C#" offSpacer="" %}}
