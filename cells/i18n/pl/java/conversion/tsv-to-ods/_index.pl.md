---
title: Konwertuj TSV na ODS przez Java 
weight: 9340
url: /pl/java/conversion/tsv-to-ods/ 
description: Przykładowy kod konwersji Java dla formatu TSV do pliku ODS. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do ODS w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TSV na ODS przez Java" h2="Konwersja TSV do ODS Java w celu konwersji jednej lub wielu stron na ODS przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TSV na ODS za pomocą Java" %}}

 Aby wyrenderować TSV do ODS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TSV na ODS za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik TSV na ODS w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem ODS i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku ODS
...
{{% blocks/products/pf/agp/code-block title="TSV do ODS Java Kod źródłowy konwersji" offSpacer="" %}}
