...
Ví dụ sau đây minh họa cách hợp nhất EXCEL thành MARKDOWN trong Aspose.Cells for .NET.
...
{{% cells-merger title="Mã mẫu gộp EXCEL về MARKDOWN trong C#" InputFormat="xlsx" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp EXCEL thành MARKDOWN" %}}
