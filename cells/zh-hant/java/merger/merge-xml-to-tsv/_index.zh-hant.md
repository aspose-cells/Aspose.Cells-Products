---
title: 將 XML 合併到 TSV - 將 XML 合併到 Java 中的 TSV
url: /zh-hant/java/merger/merge-xml-to-tsv/ 
description: Aspose Excel。 Java Aspose.Cells。免費在線合併 XML 到 TSV 保存格式。 Java 將 XML 合併為 TSV 格式。將 XML 合併到 Java 中的 TSV。XML 合併。
...
{{% blocks/products/pf/agp/content h2="免費在線將 Java 中的 XML 合併到 TSV" %}}

以下示例演示如何將 XML 合併到 Aspose.Cells for Java 中的 TSV。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XML 合併到 TSV。上傳文件，調用 Workbook.Combine 方法合併文件，然後將其保存到 TSV 文件。如果您在 Java 中開發代碼，這會比聽起來更簡單。請參閱 Java 將 XML 合併到 TSV 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將 XML 合併到 Java 中的 TSV" InputFormat="xml" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 XML 合併為 TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 XML 合併到 TSV 嗎？基本文檔合併和連接[Aspose.Cells for Java](https://products.aspose.com/cells/java)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Java 庫將 XML 合併到 TSV" %}}
