---
title: Java aracılığıyla SXC'yi PDF'ye dönüştürün 
url: /tr/java/conversion/sxc-to-pdf/ 
description: SXC formatı için PDF dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada PDF'ye dışa aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla SXC\'yi PDF\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı PDF\'ye dönüştürmek için SXC\'den PDF\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak SXC\'yi PDF\'ye Dönüştürme" %}}

 SXC'yi PDF'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla SXC\'yi PDF\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla SXC dosyasını PDF'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. SXC dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. PDF uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan PDF dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="SXC\'den PDF\'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}

```cs
// SXC dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.sxc");
// SXC'yi PDF olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC\'den PDF\'ye Dönüştürme Canlı Demoları" sectionDescription="[SXC\'yi PDF\'ye Dönüştür](https://products.aspose.app/cells/conversion/sxc-to-pdf) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece SXC dosyanızı yükleyin, anında PDF\'ye dönüştürülecektir." >}}
