...
description: Aspose Excel. C# Aspose.Cells. Sloučit PRN do formátu uložení XLSM. C# Zkombinujte PRN do formátu XLSM. Sloučit PRN na XLSM v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na XLSM v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení PRN s XLSM v C#" InputFormat="prn" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení PRN s XLSM" %}}
