...
{{< blocks/products/pf/i18n/upper-banner h1="XLS formátumok egyesítése itt: Java" h2="Natív XLS-dokumentumok egyesítése szerveroldali Java API-kkal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="XLS-fájlok egyesítése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS-fájlok egyesítésének lépései a következőben: Java" %}}
...
+ Töltse be az első XLS-fájlt a Workbook osztály egy példányával.
+ Töltse be a második XLS-dokumentumot a Workbook osztály egy példányával.
+ Fájlok egyesítése a combin() metódussal.
mentse az egyesített XLS fájlt a megadott elérési úton
...
{{% blocks/products/pf/agp/code-block title="XLS-fájlok egyesítése – Java" offSpacer="" %}}

```cs
// Nyissa meg az első XLS fájlt.
Workbook xlsFile1 = new Workbook("chartsFileWithPath.xls");

// Határozza meg a második forráskönyvet.
// Nyissa meg a második XLS fájlt.
