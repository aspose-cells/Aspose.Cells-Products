---
title:  मर्ज HTML फ़ाइलें via Java
weight: 8830
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरनमेंट पर HTML दस्तावेज़ों को संयोजित करने के लिए Java नमूना कोड।
---
...
{{% blocks/products/pf/agp/content h2="HTML फ़ाइलों को Java का उपयोग करके कैसे मर्ज करें" %}}
...
मर्ज किए गए HTML फ़ाइल को निर्दिष्ट पथ पर सहेजें
...
{{% blocks/products/pf/agp/code-block title="मर्ज HTML फ़ाइलें - Java" offSpacer="" %}}
