---
title: Konversikan XLSX ke EMF melalui C#
url: /id/net/conversion/xlsx-to-emf/
description: Contoh kode untuk konversi xlsx ke emf C#. Gunakan API kode contoh untuk file batch xlsx ke konversi emf dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLSX ke EMF melalui C#" h2="Ekspor spreadsheet Excel® ke format EMF pada Platform .NET Framework, .NET Core, Mono atau Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi file XLSX ke EMF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLSX dengan instance Workbook1. Panggil metode Workbook.Save1. Lewati jalur keluaran dengan ekstensi EMF sebagai parameter1. Periksa jalur yang ditentukan untuk file EMF yang dihasilkan
...
{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX ke EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="emf" IsLandingPage="true" %}}
