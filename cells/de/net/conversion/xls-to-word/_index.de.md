---
title: C# XLS zu WORD - Online XLS zu WORD Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das WORD-Speicherformat. C# XLS in das WORD-Format. Speichern Sie XLS in WORD C#.
...
{{% blocks/products/pf/agp/content h2="Konvertieren Sie XLS mit C# in WORD" %}}
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS kostenlos in WORD in C# online" %}}

Das folgende Beispiel zeigt, wie XLS in C# in WORD konvertiert wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um XLS in WORD zu konvertieren. Laden Sie Ihre XLS-Datei hoch und speichern Sie sie dann einfach als WORD-Datei. Sowohl zum Lesen von XLS als auch zum Schreiben in WORD können Sie vollständig qualifizierte Dateinamen verwenden. Der Inhalt und die Formatierung der WORD-Ausgabe sind identisch mit dem Originaldokument XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von XLS in WORD Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in WORD" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in WORD konvertieren? .NET-Entwickler können XLS in nur wenigen Codezeilen problemlos laden und in WORD konvertieren.
