---
title: Fusionner SXC à MHT - Combiner SXC à MHT dans Python
url: /fr/python-java/merger/merge-sxc-to-mht/ 
description: Aspose Excel. Python Aspose.Cells. Fusion gratuite en ligne SXC au format de sauvegarde MHT. Python Combinez SXC au format MHT. Fusionner SXC à MHT en Python. SXC Fusionner.
...
L'exemple suivant montre comment fusionner SXC à MHT dans Aspose.Cells for Python via Java.
...
{{% cells-merger title="Gratuit en ligne pour fusionner SXC à MHT en Python" InputFormat="sxc" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner SXC à MHT via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner SXC avec MHT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-java/merger/merge-sxc-to-tsv/" name="Fusionner SXC à TSV" description="Valeurs séparées par des tabulations" >}}
