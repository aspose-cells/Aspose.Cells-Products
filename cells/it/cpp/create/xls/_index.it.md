...
description: Aspose Excel. C++ Crea il file XLS in modo semplice e veloce con Aspose.Cells. Genera il file XLS utilizzando C++. Crea XLS in C++. C++ XLS Creatore.
...
1.  Salva la cartella di lavoro come file .xls utilizzando il metodo Save().
