---
title: Mesclar PRN para ETT - Combine PRN para ETT em C++
url: /pt/cpp/merger/merge-prn-to-ett/ 
description: Aspose Excel. C++ Aspose.Cells. Free Online Mesclar PRN para ETT saveformat. C++ Combine o formato PRN para ETT. Mesclar PRN para ETT em C++. Mesclar PRN.
...
{{% blocks/products/pf/agp/content h2="Mesclar PRN para ETT em C++ online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar PRN com ETT em Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar PRN com ETT. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo ETT. Se você desenvolver código em C++, isso será mais simples do que parece. Consulte o exemplo C++ que mescla PRN com ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar PRN para ETT em C++" InputFormat="prn" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar PRN para ETT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar PRN para ETT programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para mesclar PRN para ETT" %}}
