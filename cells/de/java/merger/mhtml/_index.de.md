---
title: MHTML-Dateien über Java zusammenführen 
weight: 4420
url: /de/java/merger/mhtml/ 
description: Java Beispielcode zum Kombinieren von MHTML-Dokumenten in Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="MHTML-Formate in Java zusammenführen" h2="Native MHTML-Dokumentzusammenführung mit serverseitigen Java-APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="So führen Sie MHTML-Dateien mit Java zusammen" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zusammenführen von MHTML-Dateien in Java" %}}
...
+ Laden Sie das zweite MHTML-Dokument mit einer Instanz der Workbook-Klasse.
+ Dateien mit der Combine()-Methode zusammenführen.
+ Speichern Sie die zusammengeführte MHTML-Datei unter dem angegebenen Pfad
...
{{% blocks/products/pf/agp/code-block title="MHTML-Dateien zusammenführen - Java" offSpacer="" %}}

```cs
// Öffnen Sie die erste MHTML-Datei.
Workbook mhtmlFile1 = new Workbook("chartsFileWithPath.mhtml");

// Definieren Sie das zweite Quellenbuch.
// Öffnen Sie die zweite MHTML-Datei.
