---
title: C# XLSX hingga PDF - XLSX hingga PDF Konverter
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi XLSX ke format PDF, memungkinkan penyimpanan data XLSX ke format PDF dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke PDF di C#" %}}

Contoh berikut menunjukkan cara mengkonversi XLSX menjadi PDF di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi XLSX menjadi PDF. Unggah file XLSX Anda, lalu simpan sebagai file PDF. Untuk pembacaan XLSX dan penulisan PDF Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran PDF akan sama dengan dokumen XLSX asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi XLSX menjadi PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah XLSX menjadi PDF melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke PDF secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX menjadi PDF hanya dalam beberapa baris kode.
...
1.  Konversikan XLSX menjadi PDF dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi dari XLSX menjadi PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# perpustakaan untuk mengkonversi XLSX menjadi PDF" %}}
