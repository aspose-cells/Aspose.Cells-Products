...
url: /tr/python-net/merger/merge-xltx-to-md/ 
...
Aşağıdaki örnek, XLTX'in Aspose.Cells for Python via .NET'de MD ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLTX'i programlı olarak MD ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
