...
{{% blocks/products/pf/agp/feature-section-col title="C++을(를) 통해 XLSM 파일을 보호하는 단계" %}}
...
1. IWorkbook 클래스를 사용하여 XLSM 파일 로드1. ProtectionType 및 Password와 함께 Protect(..) 메서드 사용1. Save() 메서드로 보호된 XLSM 파일 저장
