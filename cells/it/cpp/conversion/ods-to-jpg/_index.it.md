---
title: Converti ODS in JPG tramite l'applicazione C++ 
url: /it/cpp/conversion/ods-to-jpg/ 
description: Esempio di codice di conversione C++ per il documento ODS in formato JPG. I programmatori possono utilizzare questo codice sorgente per la conversione batch da ODS a JPG all'interno di qualsiasi applicazione C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti ODS in JPG tramite C++" h2="Conversione da ODS a JPG ad alte prestazioni utilizzando la libreria C++ senza la necessità di installare Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente i file ODS in JPG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file ODS usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (JPG).1. Il file JPG verrà salvato nel percorso specificato.1. Apri il file JPG in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da ODS a JPG C++" offSpacer="" %}}
