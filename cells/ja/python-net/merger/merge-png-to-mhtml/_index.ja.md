...
description: Aspose エクセル。 Python Aspose.Cells。PNG を MHTML の保存形式に無料でオンライン結合します。 Python PNG と MHTML の形式を結合します。 PNG から MHTML を Python に結合します。PNG を結合します。
...
次の例は、PNG を Aspose.Cells for Python via .NET の MHTML にマージする方法を示しています。
...
PNG をプログラムで MHTML にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
