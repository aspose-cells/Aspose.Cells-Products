---
title: Python OTS a NÚMEROS - Conversor de OTS a NÚMEROS
description: Aspose Excel. Esta solución integral proporciona a los desarrolladores de Python un enfoque totalmente integrado para convertir OTS a formato NUMBERS, lo que permite guardar datos OTS en formato NUMBERS sin problemas mediante la biblioteca Aspose.Cells, todo mediante código Python eficiente y personalizable.
...
{{% blocks/products/pf/agp/content h2="Convertir OTS a NÚMEROS en la biblioteca de Excel Python" %}}

 ¿Cómo convierto OTS a NÚMEROS? Con las bibliotecas Aspose.Cells y for Python, puedes convertir fácilmente OTS a NÚMEROS programáticamente con solo unas pocas líneas de código.[Aspose.Cells for Python vía NET](https://pypi.org/project/aspose-cells-python/)es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Guardar OTS en NÚMEROS en la Biblioteca de Excel Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a NÚMEROS en la biblioteca de Excel Python.
...
{{% cells-convert title="Código de ejemplo para convertir OTS a NÚMEROS mediante la biblioteca de Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="numbers" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir OTS a NÚMEROS" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesitas convertir archivos OTS a NÚMEROS mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente archivos OTS a NÚMEROS con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca de Excel para convertir OTS a NÚMEROS" %}}
