---
title:  Protéger et verrouiller le document XLSM via le C++
weight: 8770
description: Exemple de code C++ pour verrouiller le fichier XLSM à l'aide d'un mot de passe sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
