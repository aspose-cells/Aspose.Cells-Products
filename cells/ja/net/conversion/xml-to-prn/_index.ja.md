---
title: C# XML から PRN へ - XML から PRN へのコンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XML を PRN にすばやく簡単に変換します。 C# XML から PRN。 C# XML を PRN に保存します。 C# を使用して XML を PRN として保存します。
...
{{% blocks/products/pf/agp/content h2="XML を C# の PRN に保存" %}}
...
{{% cells-convert title="XML を PRN に変換するサンプル コード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="prn" IsLandingPage="true" %}}
