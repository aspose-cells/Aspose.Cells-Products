---
title: Gộp PRN thành PDF - Gộp PRN thành PDF vào Java
url: /vi/java/merger/merge-prn-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất PRN thành PDF saveformat. Java Kết hợp PRN thành định dạng PDF. Hợp nhất PRN thành PDF trong Java. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN thành PDF trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất PRN thành PDF trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất PRN thành PDF. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu vào tệp PDF. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất PRN thành PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp PRN về PDF trong Java" InputFormat="prn" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp PRN thành PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất PRN thành PDF theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép PRN thành PDF" %}}
