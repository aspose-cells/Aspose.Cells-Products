---
title: Chuyển đổi SPREADSHEETML sang JSON qua Java 

description: Mã chuyển đổi Java mẫu cho định dạng SPREADSHEETML thành tệp JSON. Lập trình viên có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang JSON trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi SPREADSHEETML sang JSON qua Java" h2="Chuyển đổi SPREADSHEETML sang JSON Java để chuyển đổi một hoặc nhiều trang thành JSON bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi SPREADSHEETML sang JSON bằng cách sử dụng Java" %}}

 Để kết xuất SPREADSHEETML sang JSON, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi SPREADSHEETML sang JSON qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp SPREADSHEETML sang JSON chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp SPREADSHEETML với một phiên bản của lớp Workbook1. Tạo Phạm vi dữ liệu để xuất bằng phương thức Cells .createRange1. Gọi phương thức JsonUtility.exportRangeToJson với các tham chiếu của Range & ExportRangeToJsonOptions1. Ghi dữ liệu chuỗi JSON vào tệp thông qua phương thức BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi SPREADSHEETML sang JSON Java" offSpacer="" %}}
