---
title: C# JPEG - IMAGE - JPEG - IMAGE Converter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára a JPEG adatok KÉP formátumba konvertálásához, lehetővé téve a JPEG adatok zökkenőmentes mentését KÉP formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a JPEG-es számot az IMAGE-be a C#-es kódban" %}}

A következő példa bemutatja, hogyan lehet a JPEG számot IMAGE formátumba konvertálni a C#-ben.
...
{{% blocks/products/pf/agp/content h2="A JPEG konvertálása IMAGE-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A JPEG fájlt programozottan IMAGE formátumba kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal IMAGE-re konvertálhatják a JPEG-et.
...
1. Alakítsa át a JPEG-et IMAGE formátumba a Workbook.Save metódus meghívásával.
1.  Szerezze meg a JPEG konverziós eredményt IMAGE-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a JPEG IMAGE formátumra konvertálásához" %}}
