---
title: C# MHT 轉 CSV - 在線 MHT 轉 CSV 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 MHT 轉換為 CSV 保存格式。 C# MHT 到 CSV 格式。將 MHT 保存到 CSV C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 C# 中的 MHT 轉換為 CSV" h2="用於將 MHT 轉換為 CSV 的高速 C# 庫。這是一個專業的軟件解決方案，用於在 .NET Framework、.NET Core 或 Mono 平台上導入和導出 MHT、CSV 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線將MHT保存到C#中的CSV" %}}

下面的例子演示瞭如何將C#中的MHT轉換為CSV。
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 MHT 轉換為 CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="csv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 轉換為 CSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 CSV？ .NET 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 CSV。
