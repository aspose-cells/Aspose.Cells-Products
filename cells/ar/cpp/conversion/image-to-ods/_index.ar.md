...
هل تحتاج إلى تحويل ملفات IMAGE إلى ODS برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى ODS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى ODS باستدعاء طريقة Save ().
