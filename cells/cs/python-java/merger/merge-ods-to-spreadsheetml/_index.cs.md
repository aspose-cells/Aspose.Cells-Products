...
url: /cs/python-java/merger/merge-ods-to-spreadsheetml/ 
...
Následující příklad ukazuje, jak sloučit ODS do SPREADSHEETML v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit ODS do SPREADSHEETML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
