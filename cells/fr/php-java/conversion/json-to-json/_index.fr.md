---
title: Convertisseur PHP JSON vers JSON - JSON vers JSON
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir le format JSON au format JSON, permettant ainsi un enregistrement transparent des données JSON au format JSON grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Comment convertir JSON en JSON via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JSON en JSON par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers JSON en JSON en quelques lignes de code seulement.
...
1.  Convertissez JSON en JSON en appelant la méthode save de Workbook.
1.  Obtenez le résultat de la conversion de JSON en JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir JSON en JSON" %}}
