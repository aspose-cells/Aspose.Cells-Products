...
description: Aspose Excel. Převeďte TSV na XPS rychle a snadno pomocí Aspose.Cells. C++ TSV na XPS. C++ Ušetřete TSV na 197 3481761 jako 197 348161 C++ 481 pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Uložit TSV až XPS v C++" %}}

Následující příklad ukazuje, jak převést TSV na XPS v C++.
...
{{% cells-convert title="Ukázkový kód pro převod TSV na XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést TSV na XPS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory TSV na XPS programově? Vývojáři C++ mohou snadno převést TSV na XPS v několika řádcích kódu.
...
1.  Převeďte TSV na XPS voláním metody Save().
