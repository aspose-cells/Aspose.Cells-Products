...
weight: 5920
description: Código fuente C# para bloquear el archivo XLSB mediante contraseña en .NET Framework, .NET Core, Mono o plataformas Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Cifrar archivos XLSB a través de C#" h2="Proteja las hojas de cálculo de Excel con contraseña, incluido el formato XLSB, utilizando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1.  Crear una instancia de la clase Workbook con la ruta al archivo XLSB
