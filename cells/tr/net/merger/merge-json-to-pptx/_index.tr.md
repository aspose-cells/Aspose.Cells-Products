...
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme JSON ile PPTX kaydetme biçimi. C# JSON ile PPTX formatını birleştirin. C# içinde JSON'i PPTX ile birleştir. JSON Birleştir.
...
{{% blocks/products/pf/agp/content h2="JSON ile PPTX\'i C# Çevrimiçinde Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, JSON'in Aspose.Cells for .NET'de PPTX ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

JSON ile PPTX'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından PPTX dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. JSON'i PPTX ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="JSON\'i C#\'de PPTX ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="json" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="JSON\'i C# üzerinden PPTX ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 JSON ile PPTX'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="JSON\'i PPTX ile birleştirmek için .NET kitaplığı" %}}
