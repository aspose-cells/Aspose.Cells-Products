---
title: Conversor PHP SXC para XLAM - SXC para XLAM
description: Aspose Excel. Converta SXC em XLAM de forma rápida e fácil com Aspose.Cells. PHP SXC em XLAM. PHP Salve SXC em XLAM. Salve SXC como XLAM usando PHP.
...
{{% cells-convert title="Exemplo de código para converter SXC em XLAM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlam" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter SXC em XLAM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em XLAM programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em XLAM em apenas algumas linhas de código.
...
1.  Converta SXC em XLAM chamando o método save da pasta de trabalho.
