...
description: Aspose Excel. Convierta FODS a DIF rápida y fácilmente con Aspose.Cells. Python FODS a DIF. Python Guarde FODS en DIF. Guarde FODS como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar FODS al DIF en Python" %}}

El siguiente ejemplo demuestra cómo convertir FODS a DIF en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir FODS a DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="dif" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir FODS en DIF" %}}
