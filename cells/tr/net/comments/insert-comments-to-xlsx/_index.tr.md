...
{{% blocks/products/pf/agp/content h2="XLSX dosyasına C# yoluyla nasıl yorum eklenir?" %}}
...
Office 365'te yorumlar konuşmalar içindir, XLSX dosyasına yorum eklemek ve kaldırmak için aşağıdaki C# kodunu kullanabilirsiniz.

{{% blocks/products/pf/agp/code-block title="C# XLSX dosyasındaki yorumları eklemek ve kaldırmak için örnek kod" offSpacer="" %}}
