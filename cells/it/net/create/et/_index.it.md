---
title: Crea ET - Crea file ET in C#
description: Aspose Excel. C# Crea file ET. Crea ET C#. C# ET Creatore. Crea ET in C#. Genera file ET utilizzando C#.
keywords: [Aspose Excel., C# Aspose.Cells., Create ET C#., C# ET Creater., Create ET file in C#., Generate ET file in C#]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crea file ET in C#" h2="Libreria C# ad alta velocità per la creazione di ET. Questa è una soluzione software professionale per importare ed esportare XLSX, PDF e molti altri formati su .NET Framework, .NET Core o Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="C# libreria per creare file ET" %}}
