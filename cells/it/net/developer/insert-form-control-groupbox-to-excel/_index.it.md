...
weight: 40
description: C# codice sorgente per inserire GroupBox in Excel su .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Come inserire GroupBox in un file Excel utilizzando C#" %}}

 Per inserire GroupBox nel file excel, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire GroupBox nel file Excel tramite C#" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addgroupbox) per inserire un GroupBox nel foglio di lavoro selezionato
