---
title: Scal OBRAZ z EXCEL - Połącz OBRAZ z EXCEL w C#
url: /pl/net/merger/merge-image-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Scal OBRAZ do formatu zapisu EXCEL. C# Połącz OBRAZ z formatem EXCEL. Scal OBRAZ z EXCEL w C#. Scal OBRAZ.
...
{{% blocks/products/pf/agp/content h2="Scal OBRAZ z EXCEL-em w C#" %}}

Poniższy przykład pokazuje, jak połączyć OBRAZ z programem EXCEL w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć OBRAZ z programem EXCEL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku EXCEL. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy IMAGE z EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia OBRAZU z formatem EXCEL w C#" InputFormat="png" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć OBRAZ z formatem EXCEL za pomocą numeru C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić IMAGE z EXCEL? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do scalania OBRAZU z EXCEL-em" %}}
