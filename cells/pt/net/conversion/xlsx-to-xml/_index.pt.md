---
title: C# XLSX para XML - Online XLSX para conversor de XML
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converta XLSX para XML saveformat. C# XLSX para o formato XML. Salve XLSX em XML C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSX para XML em C#" h2="Biblioteca C# de alta velocidade para converter XLSX em XML. Esta é uma solução de software profissional para importar e exportar XLSX, XML e muitos outros formatos em .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Salve XLSX em XML em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter XLSX em XML em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX em XML. Carregue seu arquivo XLSX e simplesmente salve-o como arquivo XML. Para leitura XLSX e gravação XML, você pode usar nomes de arquivo totalmente qualificados. O conteúdo XML de saída e a formatação serão idênticos ao documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter XLSX em XML online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para XML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para XML programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter XLSX para XML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para converter XLSX para XML" %}}
