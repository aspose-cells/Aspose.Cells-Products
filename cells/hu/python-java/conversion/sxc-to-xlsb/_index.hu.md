...
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása XLSB-vé a következőn keresztül: Python" h2="Exportáljon Excel® táblázatokat XLSB formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása XLSB-vé a Python használatával" %}}

 Az SXC XLSB-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az SXC konvertálásához XLSB-vé a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői könnyedén betölthetnek és konvertálhatnak SXC fájlokat XLSB-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal megadása XLSB kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott XLSB fájl megadott elérési útját
