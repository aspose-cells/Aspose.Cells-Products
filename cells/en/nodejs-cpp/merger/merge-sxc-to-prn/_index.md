...
url: /nodejs-cpp/merger/merge-sxc-to-prn/ 
description: Aspose Excel. Node.js Aspose.Cells. Merge SXC to PRN saveformat. Node.js Combine SXC to PRN format. Merge SXC to PRN in Node.js. SXC Merge.
...
The following example demonstrates how to merge SXC to PRN in Aspose.Cells for Node.js via C++.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to merge SXC to PRN. Upload your files, call Workbook.Combine method for merging files, and then save it to PRN file. If you develop code in Node.js, this will be simpler than it sounds. See Node.js example that merges SXC to PRN.
...
{{% blocks/products/pf/agp/content h2="How to Merge SXC to PRN via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Need to merge SXC to PRN programmatically? A basic document merging and concatenating with [Aspose.Cells for Node.js via C++](https://products.aspose.com/cells/nodejs-cpp) APIs can be done with just few lines of code.
...
{{% blocks/products/pf/agp/content h2="Node.js via C++ library to merge SXC to PRN" %}}
