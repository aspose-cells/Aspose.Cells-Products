---
title: Konwertuj SPREADSHEETML na TXT przez Java 
url: /pl/java/conversion/spreadsheetml-to-txt/ 
description: Przykładowy kod konwersji Java dla formatu SPREADSHEETML do pliku TXT. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do formatu TXT w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj SPREADSHEETML na TXT przez Java" h2="Konwersja SPREADSHEETML do TXT Java w celu konwersji jednej lub wielu stron do formatu TXT przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować arkusz SPREADSHEETML na TXT za pomocą Java" %}}

 Aby renderować SPREADSHEETML do TXT, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować arkusz SPREADSHEETML na TXT za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik SPREADSHEETML na TXT w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SPREADSHEETML z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem TXT i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku TXT
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML na TXT Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik SPREADSHEETML w instancji Workbook
Workbook book = new Workbook("template.spreadsheetml");
// zapisz arkusz kalkulacyjny jako TXT
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja SPREADSHEETML na TXT Prezentacje na żywo" sectionDescription="[Konwertuj SPREADSHEETML na TXT](https://products.aspose.app/cells/conversion/spreadsheetml-to-txt) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij plik SPREADSHEETML, zostanie on natychmiast przekonwertowany do formatu TXT." >}}
