---
title: Csillagok és szalaghirdetések beszúrása az Excelbe Python via Java
weight: 381
description: Python via Java forráskód csillagok és szalaghirdetések beillesztéséhez az Excelbe.
---
...
{{% blocks/products/pf/agp/content h2="Csillagok és szalaghirdetések beszúrása Excel fájlba a Python via Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A csillagok és szalaghirdetések beszúrásának lépései a Python via Java számú Excel-fájlba" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja a[módszer hozzáadása](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) Csillagok és Bannerek beszúrásához a kiválasztott munkalapba
...
Az alábbi mintakód bemutatja, hogyan kell beszúrni egy „matematikai pluszt”. További típusokért tekintse meg az alábbi "Csillag- és szalaghirdetés-típusok áttekintése" című részt.

{{% blocks/products/pf/agp/code-block title="Csillagok és szalaghirdetések beszúrása - Python via Java" offSpacer="" %}}
