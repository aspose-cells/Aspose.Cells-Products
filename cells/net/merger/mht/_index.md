...
In order to merge MHT file, we’ll use <a href="https://products.aspose.com/cells/net">Aspose.Cells for .NET</a> API which is a feature-rich, powerful and easy to use document manipulation and merging API for C# platform. Open <a href="https://www.nuget.org/packages/aspose.cells">NuGet</a> package manager, search for <b>Aspose.Cells</b> and install. You may also use the following command from the Package Manager Console.
...
var docstomerge = 3;
    ...
    docs[i] = new Document(dataDir + "document"+i+".mht").Info;
    var doc = docs[0];
