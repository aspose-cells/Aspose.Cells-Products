---
title: C# XLSB à TXT - Convertisseur en ligne XLSB à TXT
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir XLSB en format de sauvegarde TXT. Format C# XLSB à TXT. Enregistrez XLSB à TXT C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à TXT dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en TXT en C#.
...
Besoin de convertir les fichiers XLSB en TXT par programmation ? Les développeurs .NET peuvent facilement charger et convertir XLSB en TXT en quelques lignes de code.
