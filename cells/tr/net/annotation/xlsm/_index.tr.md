---
title:  XLSM Ek Açıklamasını Kaldır via .NET
weight: 9890
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSM biçim notlarını eklemek ve silmek için C# kaynak kodu.
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM\'den C#\'e Açıklama Ekleyin veya Silin" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSM - C#\'den Açıklamaları Sil" offSpacer="" %}}
