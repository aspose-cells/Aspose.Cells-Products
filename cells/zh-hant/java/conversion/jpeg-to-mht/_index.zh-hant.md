---
title: Java JPEG 轉 MHT - 在線 JPEG 轉 MHT 轉換器
description: Aspose Excel。 Java Aspose.Cells。Java Aspose Cells。免費在線 Java 將 JPEG 轉換為 MHT 保存格式。 Java JPEG 為 MHT 格式。將 JPEG 保存到 MHT Java。
...
{{% blocks/products/pf/agp/content h2="免費在線將 JPEG 保存到 Java 中的 MHT" %}}

以下示例演示如何將 JPEG 轉換為 Java 中的 MHT。
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 JPEG 轉換為 MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="mht" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 JPEG 轉換為 MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 JPEG 文件轉換為 MHT？ Java開發人員只需幾行代碼即可輕鬆將JPEG轉換為MHT。
...
1. 通過調用 Workbook.save 方法將 JPEG 轉換為 MHT。
1. 獲取JPEG到MHT的轉換結果。
