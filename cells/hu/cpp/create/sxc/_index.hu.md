...
description: Aspose Excel. Könnyedén generálhat és kezelhet SXC fájlokat a Aspose.Cells for C++ könyvtárral. Ez a nagy teljesítményű API leegyszerűsített és hatékony megoldást kínál a SXC fájlok létrehozására, szerkesztésére és kezelésére közvetlenül a C++ alkalmazásokban, nagy pontossággal kielégítve a fejlesztők speciális igényeit.
...
1.  Mentse el a munkafüzetet .sxc fájlként a Save() metódussal.
