...
description: Aspose Excel. Konwertuj XML na ODS szybko i łatwo za pomocą Aspose.Cells. Java XML na ODS. Java Zapisz XML na ODS. Zapisz XML jako ODS używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem ODS w Java" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na ODS w Java.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XML na ODS? Programiści Java mogą łatwo przekonwertować XML na ODS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji XML na ODS" %}}
{{% blocks/products/pf/agp/text %}}
