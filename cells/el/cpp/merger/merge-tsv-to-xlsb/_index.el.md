...
description: Aspose Excel. C++ Aspose.Cells. Συγχώνευση TSV σε μορφή αποθήκευσης XLSB. C++ Συνδυάστε τη μορφή TSV με XLSB. Συγχώνευση TSV σε XLSB στο C++. TSV Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση TSV με XLSB στο C++" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση TSV έως XLSB στο C++" InputFormat="tsv" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
