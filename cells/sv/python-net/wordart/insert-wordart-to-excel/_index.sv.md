---
title:  Infoga WordArt i Excel med Python via .Net
weight: 200
description: Python via .Net-källkod för att infoga WordArt i Excel.
...
{{% blocks/products/pf/agp/content h2="Hur man infogar WordArt i Excel-fil med Python via .Net" %}}

 För att infoga WordArt i excel-filen kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga WordArt till Excel-fil med Python via .Net" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens tillägg[metod](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_word_art/#PresetWordArtStyle-str-int-int-int-int-int-int) för att infoga en WordArt i det valda kalkylbladet.
...
-  Installera Aspose.Cells for Python via .Net via .NET från<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , använd kommandot som:<code>$ pip install aspose-cells-python</code>.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Infoga WordArt - Python via .Net" offSpacer="" %}}
