---
title: Konvertor PHP MHTML až JSON - MHTML až JSON
description: Aspose Excel. Převeďte MHTML na JSON rychle a snadno pomocí Aspose.Cells. PHP MHTML na JSON. PHP Uložte MHTML na JSON. Uložte JSON jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na JSON přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na JSON programově? Vývojáři PHP mohou snadno načíst a převést MHTML na JSON v několika řádcích kódu.
...
1.  Převeďte MHTML na JSON voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na JSON" %}}
