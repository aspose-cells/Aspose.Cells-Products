---
title: C++ XLT do ODS - XLT do ODS Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu XLT do ODS, umożliwiając bezproblemowe zapisywanie danych XLT do formatu ODS za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLT na ODS w C++" h2="Wysokowydajna konwersja XLT do ODS przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT do ODS w C++" %}}

Poniższy przykład pokazuje, jak przekonwertować XLT na ODS w C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer XLT na numer ODS. Prześlij plik XLT, a następnie po prostu zapisz go jako plik ODS. Zarówno do odczytu XLT, jak i do zapisu ODS można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego ODS będą identyczne z oryginalnym dokumentem XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLT na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlt" outformat="ods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na ODS przez C++" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLT na ODS? Programiści C++ mogą łatwo przekonwertować pliki XLT na ODS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLT na ODS wywołując metodę Save().
1.  Uzyskaj wynik konwersji XLT na ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteka do konwersji XLT na ODS" %}}
