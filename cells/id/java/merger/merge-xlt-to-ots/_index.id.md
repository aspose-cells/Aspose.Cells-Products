...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLT ke format simpan OTS. Java Gabungkan XLT ke format OTS. Gabung XLT ke OTS di Java. XLT Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLT ke OTS di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLT ke OTS di Java" InputFormat="xlt" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLT ke OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLT ke OTS secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk menggabungkan XLT ke OTS" %}}
