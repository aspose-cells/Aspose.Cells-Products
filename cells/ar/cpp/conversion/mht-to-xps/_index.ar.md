...
description: Aspose اكسل. قم بتحويل MHT إلى XPS بسرعة وسهولة باستخدام Aspose.Cells. C++ MHT إلى XPS. C++ احفظ MHT إلى XPS. احفظ MHT كـ XPS باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على XPS في C++" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى XPS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى XPS برمجياً؟ يمكن لمطوري C++ تحويل MHT بسهولة إلى XPS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XPS عن طريق استدعاء طريقة Save ().
