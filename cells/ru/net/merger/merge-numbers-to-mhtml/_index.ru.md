---
title:  Объединить NUMBERS с MHTML через C#
...
В следующем примере показано, как объединить NUMBERS с MHTML в C#.
