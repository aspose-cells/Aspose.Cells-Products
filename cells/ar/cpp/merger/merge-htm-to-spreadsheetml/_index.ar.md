---
title: دمج HTM في SPREADSHEETML - ادمج HTM إلى SPREADSHEETML في C++
url: /ar/cpp/merger/merge-htm-to-spreadsheetml/ 
description: Aspose إكسل. C++ Aspose.Cells. دمج HTM مجانًا عبر الإنترنت إلى تنسيق حفظ SPREADSHEETML. C++ دمج HTM إلى تنسيق SPREADSHEETML. دمج HTM إلى SPREADSHEETML في C++. دمج HTM.
...
{{% blocks/products/pf/agp/content h2="دمج HTM إلى SPREADSHEETML في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج HTM في SPREADSHEETML في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج HTM في SPREADSHEETML. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف SPREADSHEETML. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يقوم بدمج HTM إلى SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج HTM في SPREADSHEETML في C++" InputFormat="htm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج HTM في SPREADSHEETML عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج HTM في SPREADSHEETML برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج HTM إلى SPREADSHEETML" %}}
