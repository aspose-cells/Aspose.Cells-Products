...
description: Aspose Excel. Konwertuj OTS na ODS szybko i łatwo za pomocą Aspose.Cells. Java OTS na ODS. Java Zapisz OTS na ODS. Zapisz OTS jako ODS, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS pod numerem ODS w Java" %}}

Poniższy przykład ilustruje sposób konwersji OTS na ODS w Java.
...
Chcesz programowo przekonwertować pliki OTS na ODS? Programiści Java mogą z łatwością przekonwertować OTS na ODS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na ODS" %}}
{{% blocks/products/pf/agp/text %}}
