---
title: Conversor PHP SXC para XLT - SXC para XLT
description: Aspose Excel. Converta SXC em XLT de forma rápida e fácil com Aspose.Cells. PHP SXC em XLT. PHP Salve SXC em XLT. Salve SXC como XLT usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em XLT via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em XLT programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em XLT em apenas algumas linhas de código.
...
1.  Converta SXC em XLT chamando o método save da pasta de trabalho.
