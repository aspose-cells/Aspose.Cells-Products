...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en JSON en utilisant C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en JSON via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier XLS en JSON en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLS à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (JSON).1. Le fichier JSON sera enregistré dans le chemin spécifié.1. Ouvrez le fichier JSON dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLS vers JSON C++" offSpacer="" %}}
