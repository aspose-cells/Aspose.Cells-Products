---
title: Conversor PHP TSV para TXT - TSV para TXT
description: Aspose Excel. Converta TSV em TXT de forma rápida e fácil com Aspose.Cells. PHP TSV em TXT. PHP Salve TSV em TXT. Salve TSV como TXT usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter TSV em TXT via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em TXT programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em TXT em apenas algumas linhas de código.
...
1.  Converta TSV em TXT chamando o método save da pasta de trabalho.
