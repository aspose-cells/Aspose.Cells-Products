---
title:  Sloučit TXT až PDF via Java
...
Následující příklad ukazuje, jak sloučit TXT až PDF v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až PDF online" InputFormat="txt" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
