...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na XLT pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na XLT přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory TABDELIMITED do XLT pomocí několika řádků kódu.
