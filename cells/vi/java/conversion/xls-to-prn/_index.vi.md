---
title: Java XLS sang PRN - Bộ chuyển đổi XLS sang PRN trực tuyến
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Trực tuyến miễn phí Java Chuyển đổi XLS sang định dạng lưu PRN. Java XLS sang định dạng PRN. Lưu XLS thành PRN Java.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLS thành PRN bằng Java" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS vào PRN trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi XLS thành PRN trong Java.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS thành PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi các tệp XLS sang PRN theo chương trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi XLS thành PRN chỉ bằng một vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Java thư viện để chuyển đổi XLS thành PRN" %}}
{{% blocks/products/pf/agp/text %}}
