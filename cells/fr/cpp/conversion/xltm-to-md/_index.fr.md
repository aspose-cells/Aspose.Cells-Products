---
title: Convertissez XLTM en MD via l'application C++ 
url: /fr/cpp/conversion/xltm-to-md/ 
description: Exemple de code de conversion C++ pour le document XLTM au format MD. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLTM en MD dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLTM en MD via C++" h2="Conversion XLTM vers MD haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir un fichier XLTM en MD en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLTM à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (MD).1. Le fichier MD sera enregistré dans le chemin spécifié.1. Ouvrez le fichier MD dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLTM vers MD C++" offSpacer="" %}}
