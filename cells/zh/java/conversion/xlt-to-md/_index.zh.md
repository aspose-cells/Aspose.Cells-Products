---
title: 通过 Java 将 XLT 转换为 MD 

description: XLT 格式到 MD 文件的示例 Java 转换代码。程序员可以使用此示例代码将 Excel 和 OpenOffice 电子表格导出到任何基于 Web 或桌面 Java 的应用程序中的 MD。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 XLT 转换为 MD" h2="XLT 到 MD Java 转换以使用内部部署 Java 库将单个或多个页面转换为 MD。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 XLT 转换为 MD" %}}

 为了将 XLT 渲染为 MD，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 XLT 转换为 MD 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Java 开发人员只需几行代码即可轻松地将 XLT 文件转换为 MD。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 类的实例加载 XLT 文件1. 调用 Workbook.save 方法1. 传递带有 MD 扩展名和 SaveFormat 的输出路径作为参数1. 检查生成的 MD 文件的指定路径
...
{{% blocks/products/pf/agp/code-block title="XLT 到 MD Java 转换源代码" offSpacer="" %}}
