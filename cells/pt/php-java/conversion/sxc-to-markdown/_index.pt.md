---
title: Conversor PHP SXC para MARKDOWN - SXC para MARKDOWN
description: Aspose Excel. Converta SXC em MARKDOWN de forma rápida e fácil com Aspose.Cells. PHP SXC em MARKDOWN. PHP Salve SXC em MARKDOWN. Salve SXC como MARKDOWN usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em MARKDOWN via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em MARKDOWN programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em MARKDOWN em apenas algumas linhas de código.
...
1.  Converta SXC em MARKDOWN chamando o método save da pasta de trabalho.
