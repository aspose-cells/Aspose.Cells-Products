...
url: /hu/python-net/merger/merge-xls-to-powerpoint/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLS-et a POWERPOINT-tal a Aspose.Cells-es for Python-es via .NET-es számban.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLS-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
