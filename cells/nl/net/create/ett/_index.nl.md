...
{{% blocks/products/pf/agp/content h2="Hoe ETT te maken in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Het is gemakkelijk voor de ontwikkelaars om ETT-bestanden te maken, laden, wijzigen en converteren binnen verschillende rapportagetoepassingen voor gegevensverwerking in slechts een paar regels code.
...
1.  Gebruik de methode Save om de werkmap op te slaan als ETT-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een ETT-bestand maakt in C#." offSpacer="" %}}
