---
title: C# JPG en XPS - Convertisseur JPG en XPS
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG au format XPS, permettant un enregistrement transparent des données JPG au format XPS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG sous XPS dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en XPS en C#.
...
{{% cells-convert title="Exemple de code pour convertir un fichier JPG en XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="xps" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en XPS par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en XPS en quelques lignes de code.
...
1.  Convertissez le JPG au format XPS en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en XPS" %}}
