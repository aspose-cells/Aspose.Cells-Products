---
title: Convert FODS to JPG via .NET 
...
{{< blocks/products/pf/upper-banner h1="Convert FODS to JPG via C#" h2="Export Excel® spreadsheets to JPG format on .NET Framework, .NET Core, Mono or Xamarin Platforms." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/cells/272x272/aspose_cells-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert FODS to JPG, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert FODS to JPG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells makes it easy for the developers to load & convert FODS files to JPG in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert FODS to JPG" sectionDescription="Check our live demos for [FODS to JPG conversion](https://products.aspose.app/cells/conversion/fods-to-jpg) with following benefits." >}}
    ...
    {{% blocks/products/pf/agp/content h2="How to Convert FODS to JPG Using C#" %}}
