---
title: EXCEL egyesítése MD-vel - EXCEL egyesítése MD-vel a C++-ben
url: /hu/cpp/merger/merge-excel-to-md/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítése EXCEL MD mentési formátumba. C++ Kombinálja az EXCEL-t MD formátumba. Egyesítse az EXCEL-t MD-vel a C++-ben. EXCEL-egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse az EXCEL-t az MD-vel a C++ Online számban" %}}

A következő példa bemutatja, hogyan egyesítheti az EXCEL-t MD-vel a Aspose.Cells for C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket az EXCEL és az MD egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el MD fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++-es példát, amely az EXCEL-t MD-vel egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online az EXCEL és az MD egyesítése a C++ számon" InputFormat="xlsx" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Az EXCEL és az MD egyesítése a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell az EXCEL-t az MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár az EXCEL és az MD egyesítéséhez" %}}
