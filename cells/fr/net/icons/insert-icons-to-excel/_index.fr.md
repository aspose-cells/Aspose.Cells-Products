...
weight: 110
description: Code source C# pour insérer des images/icônes SVG dans Excel sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer des images/icônes SVG dans un fichier Excel via C#" %}}
