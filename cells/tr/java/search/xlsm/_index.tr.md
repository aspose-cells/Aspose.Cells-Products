---
title:  XLSM belgesini açmadan ara via Java
weight: 6780
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı'ndaki XLSM dosyasındaki desenli kelimeleri aramak için Java örnek kod.
...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak XLSM Dosyası Nasıl Aranır?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM Dosyalarını Java\'de Arama Adımları" %}}
...
+ Bir Çalışma Kitabı nesnesinin örneğini oluşturarak XLSM dosyasını yükleyin.
