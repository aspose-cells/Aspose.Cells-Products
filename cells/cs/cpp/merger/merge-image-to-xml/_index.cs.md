---
title: Sloučit IMAGE do XML – Zkombinujte IMAGE do XML v C++
url: /cs/cpp/merger/merge-image-to-xml/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit IMAGE do formátu uložení XML. C++ Zkombinujte IMAGE do formátu XML. Sloučit IMAGE do XML v C++. Sloučit IMAGE.
...
{{% blocks/products/pf/agp/content h2="Sloučit IMAGE do XML v C++" %}}

Následující příklad ukazuje, jak sloučit IMAGE do XML v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení IMAGE do XML. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XML. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí IMAGE do XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení IMAGE do XML v C++" InputFormat="png" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit IMAGE do XML přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit IMAGE do XML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení IMAGE do XML" %}}
