---
title:  Объединить JSON с XLSB via Java
...
В следующем примере показано, как объединить JSON с XLSB в Java.
...
{{% cells-merger title="Бесплатное приложение для объединения JSON с XLSB онлайн" InputFormat="json" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
