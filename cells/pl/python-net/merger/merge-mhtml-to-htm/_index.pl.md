...
description: Aspose Excel. Python Aspose.Cells. Bezpłatne scalanie online MHTML do formatu zapisu HTM. Python Połącz MHTML do formatu HTM. Połącz MHTML z HTM w Python. MHTML Połącz.
...
Poniższy przykład pokazuje, jak scalić MHTML z HTM w Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Bezpłatne połączenie online MHTML z HTM w Python" InputFormat="mhtml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić MHTML z HTM przez Python" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić numer MHTML z HTM? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
