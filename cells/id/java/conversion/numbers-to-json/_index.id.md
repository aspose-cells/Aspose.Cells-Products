---
title: Konversi NUMBER ke JSON melalui Java 

description: Contoh Java kode konversi untuk format NUMBER ke file JSON. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke JSON dalam Aplikasi berbasis Java Web atau Desktop apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi NUMBER ke JSON melalui Java" h2="NUMBER ke JSON Java konversi untuk mengonversi satu atau beberapa laman ke JSON menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ANGKA ke JSON Menggunakan Java" %}}

 Untuk merender NUMBER ke JSON, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi NUMBER ke JSON melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file NUMBER ke JSON hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file NUMBER dengan instance kelas Buku Kerja1. Buat Rentang data yang akan diekspor menggunakan metode Cells.createRange1. Panggil metode JsonUtility.exportRangeToJson dengan referensi Range & ExportRangeToJsonOptions1. Tulis data String JSON ke file melalui metode BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="NUMBER ke JSON Java Kode Sumber Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi NUMBER ke JSON" sectionDescription="[Mengonversi NUMBER ke JSON](https://products.aspose.app/cells/conversion/numbers-to-json) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file NUMBER Anda, itu akan langsung dikonversi ke JSON." >}}
