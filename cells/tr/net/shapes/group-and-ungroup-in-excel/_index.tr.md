---
title:  Excel'de Şekilleri Gruplandırma ve Grubu Çözme via .NET
weight: 340
description: C# kaynak kodu, .NET Framework, .NET Core, Mono veya Xamarin Platformlarında Excel'de Şekilleri Gruplandırmak ve Grubu Çözmek için.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Excel\'de Şekilleri Gruplandırma ve Grubu Çözme via .NET" h2="Aspose.Cells API kullanarak Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım olmadan çeşitli nesnelerle çalışmak." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="C# Kullanarak Excel Dosyasındaki Şekilleri Gruplandırma ve Grubu Çözme" %}}
...
+ Dizini aracılığıyla Çalışma Sayfası'nı seçin.
 + Kullanın[grup yöntemi](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/group/) seçili çalışma sayfasındaki şekilleri gruplandırmak için
 + Kullanın[grubu çözme yöntemi](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/) seçilen çalışma sayfasındaki şekillerin grubunu çözmek için
...
{{% blocks/products/pf/agp/code-block title="Şekilleri Gruplandırma ve Grubu Çözme - C#" offSpacer="" %}}
