---
title: Créer MHT - Créer un fichier MHT dans Java
description: Aspose Excel. Générez et manipulez facilement des fichiers MHT grâce à la bibliothèque Aspose.Cells for Java. Cette puissante bibliothèque API offre une solution simplifiée et efficace pour créer, modifier et gérer des fichiers MHT directement dans vos applications Java, répondant ainsi avec une grande précision aux besoins spécifiques des développeurs.
...
{{% blocks/products/pf/agp/content h2="Comment créer un MHT en Java" %}}
...
1.  Enregistrez le classeur au format MHT à l'aide de la méthode save().

{{% blocks/products/pf/agp/code-block title="L\'exemple de code montre comment créer un fichier MHT en Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour créer un fichier MHT" %}}
{{% blocks/products/pf/agp/text %}}
