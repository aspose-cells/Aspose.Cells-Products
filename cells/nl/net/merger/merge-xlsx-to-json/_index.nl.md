---
title:  Samenvoegen XLSX naar JSON via C#
url: /nl/net/merger/merge-xlsx-to-json/ 
description: Samenvoegen XLSX naar JSON Online gratis. Gratis online XLSX tot JSON Fusie. Voeg XLSX samen met Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS en meer.
---
...
Het volgende voorbeeld laat zien hoe u XLSX samenvoegt met JSON in C#.
...
{{% cells-merger title="Gratis app om XLSX online samen te voegen tot JSON" InputFormat="xlsx" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
