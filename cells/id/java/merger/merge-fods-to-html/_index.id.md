---
title: Gabung FODS ke HTML - Gabungkan FODS ke HTML di Java
url: /id/java/merger/merge-fods-to-html/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge FODS to HTML saveformat. Java Gabungkan format FODS menjadi HTML. Gabung FODS ke HTML di Java. FODS Gabung.
...
Contoh berikut menunjukkan cara menggabungkan FODS ke HTML di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan FODS ke HTML di Java" InputFormat="fods" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS ke HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS menjadi HTML secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
