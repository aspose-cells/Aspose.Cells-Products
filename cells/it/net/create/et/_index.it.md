---
title: "Crea ET: crea il file ET in C#"
description:  Aspose Excel. C# Crea file ET in modo rapido e semplice con Aspose.Cells. Genera file ET utilizzando C#. Crea ET in C#. C# ET Creator.
...
{{% blocks/products/pf/agp/content h2="Come creare ET in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare il file ET in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria C# per creare file ET" %}}
