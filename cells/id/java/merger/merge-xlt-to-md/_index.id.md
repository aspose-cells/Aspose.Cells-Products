---
title: Gabung XLT ke MD - Gabungkan XLT ke MD di Java
url: /id/java/merger/merge-xlt-to-md/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge XLT to MD saveformat. Java Gabungkan XLT ke format MD. Gabung XLT menjadi MD di Java. XLT Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLT ke MD di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan XLT ke MD di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLT ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan XLT ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLT ke MD secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
