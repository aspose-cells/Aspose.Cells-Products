...
1. إنشاء فئة المصنف بمسار إلى ملف XLSB المحمي1. احصل على ورقة العمل الافتراضية أو أي ورقة عمل لإزالة الحماية1. قم بإزالة حماية ورقة العمل باستخدام طريقة Worksheet.Unprotect1. قم بإزالة حماية المصنف باستخدام طريقة Workbook.Unprotect1. حفظ النتيجة بتنسيق XLSB
...
// إنشاء كائن مصنف بملف XLSB محمي
...
// احفظ النتيجة مرة أخرى بتنسيق XLSB
...
<!-- aboutfile Starts -->
 ...
 يمكن استخدام Aspose.Cells API لإنشاء تنسيقات Microsoft Excel وتحريرها وتحويلها وعرضها بتنسيقات مختلفة. علاوة على ذلك ، يمكن استخدامه لرسم بياني شامل ، وإعداد تقارير قابلة للتطوير وحسابات موثوقة داخل تطبيقات البرامج. Aspose.Cells هو برنامج مستقل API ولا يتطلب أي برامج مثل Microsoft أو OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لفتح XLSB" sectionDescription="تحقق من العروض الحية لدينا ل [فتح ملفات XLSB](https://products.aspose.app/cells/unlock/xlsb) مع الفوائد التالية." >}}
