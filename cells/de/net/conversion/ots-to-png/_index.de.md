---
title: C# OTS zu PNG - OTS zu PNG Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von OTS in das Format PNG und ermöglicht das nahtlose Speichern von OTS-Daten im Format PNG mithilfe der Bibliothek Aspose.Cells – alles durch effizienten und anpassbaren Code C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter PNG in C#" %}}

Das folgende Beispiel zeigt, wie man OTS in C# umwandelt.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um OTS in PNG zu konvertieren. Laden Sie Ihre OTS-Datei hoch und speichern Sie sie dann einfach als PNG-Datei. Sowohl zum Lesen von OTS als auch zum Schreiben von PNG können Sie vollqualifizierte Dateinamen verwenden. Der Inhalt und die Formatierung der Ausgabe PNG sind mit dem ursprünglichen OTS-Dokument identisch.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Beispielcode zur Konvertierung von OTS in PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über C# in PNG" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in PNG konvertieren? .NET-Entwickler können OTS mit nur wenigen Codezeilen problemlos in PNG laden und konvertieren.
...
1.  Konvertieren Sie OTS in PNG durch Aufruf der Workbook.Save-Methode.
1.  Erhalten Sie das Konvertierungsergebnis von OTS zu PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von OTS nach PNG" %}}
