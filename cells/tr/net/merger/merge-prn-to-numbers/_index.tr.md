---
title: PRN'yi NUMARALARLA BİRLEŞTİR - C#'de PRN'yi NUMARALARLA BİRLEŞTİRİN
url: /tr/net/merger/merge-prn-to-numbers/ 
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi PRN'yi NUMBERS kaydetme biçiminde birleştirin. C# PRN'yi SAYILAR biçiminde birleştirin. C#'de PRN'yi NUMBERS ile birleştirin. PRN Birleştirin.
...
Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin SAYILAR ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi SAYILAR ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından onu NUMBERS dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. PRN'yi SAYILAR ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de PRN\'yi SAYILARA BİRLEŞTİRMEK İÇİN ÜCRETSİZ ÇEVRİMİÇİ" InputFormat="prn" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C# aracılığıyla PRN\'yi NUMBERS ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 PRN'yi programlı olarak NUMBERS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
