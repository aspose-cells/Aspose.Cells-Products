---
title: Java HTM a XLS - Convertitore online da HTM a XLS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Free Online Java Converti HTM in XLS saveformat. Java HTM al formato XLS. Salva HTM a XLS Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti HTM in XLS in Java" h2="Libreria Java ad alta velocità per convertire HTM in XLS. Questa è una soluzione software professionale per importare ed esportare HTM, XLS e molti altri formati utilizzando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salva HTM a XLS in Java online gratuitamente" %}}

L'esempio seguente mostra come convertire HTM in XLS in Java.
...
{{% cells-convert title="App gratuita e codice di esempio per convertire HTM in XLS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Come convertire HTM in XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file HTM in XLS a livello di codice? Gli sviluppatori Java possono facilmente convertire HTM in XLS in poche righe di codice.
...
1.  Converti HTM in XLS chiamando il metodo Workbook.save.
1.  Ottieni il risultato della conversione di HTM in XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java libreria per convertire HTM in XLS" %}}
{{% blocks/products/pf/agp/text %}}
