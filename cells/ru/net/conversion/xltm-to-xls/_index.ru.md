---
title: Преобразователь C# XLTM в XLS - XLTM в XLS
description: Aspose Эксель. Преобразуйте XLTM в XLS быстро и легко с помощью Aspose.Cells. C# XLTM в XLS. C# Сохранить XLTM в XLS. Сохранить XLTM как 07611134 81, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните с XLTM по XLS в C#." %}}

В следующем примере показано, как преобразовать XLTM в XLS в C#.
...
{{% cells-convert title="Пример кода для преобразования XLTM в XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как преобразовать XLTM в XLS через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы XLTM в XLS? Разработчики .NET могут легко загрузить и преобразовать XLTM в XLS всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XLTM в XLS" %}}
