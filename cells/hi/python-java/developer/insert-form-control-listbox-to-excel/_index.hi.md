...
+ इसके सूचकांक के माध्यम से कार्यपत्रक का चयन करें।
 + आकार संग्रह का प्रयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addListBox(int,%20int,%20int,%20int,%20int,%20int)) चयनित वर्कशीट में लिस्टबॉक्स (फॉर्म कंट्रोल) डालने के लिए।
