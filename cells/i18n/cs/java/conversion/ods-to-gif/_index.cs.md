...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na GIF pomocí Java" %}}

 K vykreslení ODS na GIF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na GIF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na GIF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí Workbook1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Chcete-li uložit výsledek ve formátu GIF, zavolejte metodu SheetRender.toImage
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu ODS na GIF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze ODS na GIF" sectionDescription="[Převést ODS na GIF](https://products.aspose.app/cells/conversion/ods-to-gif) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor ODS, bude okamžitě převeden na GIF." >}}
