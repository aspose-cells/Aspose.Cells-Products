...
description: Sample C++ conversion code for XLSM document to JSON format. Programmers can use this source code for batch XLSM to JSON conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLSM to JSON C++ Conversion Source Code" offSpacer="" %}}
