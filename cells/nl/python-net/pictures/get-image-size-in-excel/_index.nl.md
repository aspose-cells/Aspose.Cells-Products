...
{{% blocks/products/pf/agp/content h2="Hoe de grootte van afbeeldingen / afbeeldingen in Excel-bestand te krijgen met behulp van Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Grootte van afbeeldingen/foto\'s ophalen - Python via .Net" offSpacer="" %}}
