...
description: Aspose Excel. Převeďte TSV na JPG rychle a snadno pomocí Aspose.Cells. C++ TSV na JPG. C++ Uložit TSV do JPG. Uložte TSV jako JPG pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Převeďte TSV na JPG pomocí C++" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte TSV do JPG v C++" %}}

Následující příklad ukazuje, jak převést TSV na JPG v C++.
...
{{% cells-convert title="Ukázkový kód pro převod TSV na JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést TSV na JPG přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést TSV soubory do JPG programově? Vývojáři C++ mohou snadno převést TSV na JPG v několika řádcích kódu.
...
1.  Převeďte TSV na JPG voláním metody Save().
1.  Získejte výsledek převodu TSV na JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod TSV na JPG" %}}
