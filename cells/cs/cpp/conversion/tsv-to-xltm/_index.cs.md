...
Potřebujete převést soubory TSV na XLTM programově? Vývojáři C++ mohou snadno převést TSV na XLTM v několika řádcích kódu.
...
1.  Převeďte TSV na XLTM voláním metody Save().
