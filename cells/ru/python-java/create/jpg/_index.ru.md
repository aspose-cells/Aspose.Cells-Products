---
title: Создать JPG - Создать файл JPG в Python
description: Aspose Excel. Python Создать файл JPG. Создать JPG Python. Python Создатель JPG. Создайте JPG в Python. Создайте файл JPG, используя Python.
...
{{% blocks/products/pf/agp/content h2="Создайте файл JPG, используя Python" %}}
 ...
 Как создать файл JPG? С библиотекой Aspose.Cells for Python via Java вы можете легко создать файл JPG программно с помощью нескольких строк кода.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)способен создавать кроссплатформенные приложения с возможностью создания, изменения, преобразования, рендеринга и печати всех файлов Excel. Python Excel API не только конвертирует форматы электронных таблиц, но также может отображать файлы Excel в виде изображений, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT и т. д., что делает его идеальным выбором для обмена документы в отраслевом стандарте форматы.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчикам легко создавать, загружать, изменять и преобразовывать файлы JPG в различных приложениях для создания отчетов для обработки данных, написав всего несколько строк кода.
...
1.  Используйте метод Сохранить, чтобы сохранить книгу в виде файла JPG.

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл JPG в Python." offSpacer="" %}}
