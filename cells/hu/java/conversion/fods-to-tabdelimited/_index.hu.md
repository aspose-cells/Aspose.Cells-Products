---
title: "FODS konvertálása TAB-raDELIMITED a következőn keresztül: Java "
url: /hu/java/conversion/fods-to-tabdelimited/ 
description: Minta Java konverziós kód FODS formátumhoz TABDELIMITED fájlba. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok TABDELIMITED-re exportálásához bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="FODS konvertálása TAB-raDELIMITED a következőn keresztül: Java" h2="FODS to TABDELIMITED Java konverzió egyetlen vagy több oldal átalakítása TABDELIMITED formátumba a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="FODS konvertálása TAB-raDELIMITED a következővel: Java" %}}

 Ahhoz, hogy a FODS-t TABDELIMITED-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A FODS-ek TAB-lé konvertálásának lépéseiDELIMITED a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak FODS-fájlt TABDELIMITED-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be FODS-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TABDELIMITED kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TABDELIMITED fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="FODS to TABDELIMITED Java Konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a FODS fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.fods");
// FODS mentése TABDELIMITED néven
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS to TABDELIMITED konverziós élő bemutatók" sectionDescription="[FODS konvertálása TAB-raDELIMITED](https://products.aspose.app/cells/conversion/fods-to-tabdelimited) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel FODS-fájlját, és azonnal TABDELIMITED-re konvertálódik." >}}
