---
title: PHP EXCEL en PRN - Convertisseur EXCEL en PRN
description: Aspose Exceller. Convertissez EXCEL en PRN rapidement et facilement avec Aspose.Cells. PHP EXCEL en PRN. PHP Enregistrez EXCEL dans PRN. Enregistrez EXCEL au format PRN en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en PRN via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en PRN par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en PRN en quelques lignes de code.
...
1.  Convertissez EXCEL en PRN en appelant la méthode de sauvegarde du classeur.
