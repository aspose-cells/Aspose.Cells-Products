---
title: ODS から TXT を結合 - ODS から TXT を C# に結合
url: /ja/net/merger/merge-ods-to-txt/ 
description: Aspose エクセル。 C# Aspose.Cells。ODS を TXT の保存形式にマージします。 C# ODS と TXT の形式を結合します。 ODS から TXT を C# に結合します。ODS を結合します。
...
次の例は、ODS を Aspose.Cells for .NET の TXT にマージする方法を示しています。
...
{{% cells-merger title="ODS から TXT を C# にマージするサンプルコード" InputFormat="ods" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="ODS を C# 経由で TXT に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

ODS をプログラムで TXT にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
