---
title: Convierta XLTX a XLTM a través de la aplicación C++ 
url: /es/cpp/conversion/xltx-to-xltm/ 
description: Ejemplo de código de conversión C++ para documento XLTX a formato XLTM. Los programadores pueden usar este código fuente para la conversión por lotes de XLTX a XLTM dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo XLTX a XLTM con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLTX usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (XLTM).1. El archivo XLTM se guardará en la ruta especificada.1. Abra el archivo XLTM en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLTX a XLTM C++" offSpacer="" %}}
