---
title: Połącz CSV z SVG - Połącz CSV z SVG w Java
url: /pl/java/merger/merge-csv-to-svg/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online CSV do SVG w formacie zapisu. Java Połącz format CSV z SVG. Połącz CSV z SVG w Java. CSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz CSV z SVG w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć CSV z SVG w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć CSV z SVG. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku SVG. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy numery CSV z SVG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z SVG w Java" InputFormat="csv" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z SVG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić CSV z SVG programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
