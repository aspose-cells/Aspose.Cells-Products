...
{{% blocks/products/pf/agp/content h2="Převeďte TABDELIMITED na SPREADSHEETML pomocí Python" %}}
...
Následující příklad ukazuje, jak převést TABDELIMITED na SPREADSHEETML v Python.
