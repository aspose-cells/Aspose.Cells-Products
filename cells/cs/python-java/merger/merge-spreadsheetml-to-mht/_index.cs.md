...
Následující příklad ukazuje, jak sloučit SPREADSHEETML do MHT v Aspose.Cells for Python via Java.
...
Potřebujete programově sloučit SPREADSHEETML do MHT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
