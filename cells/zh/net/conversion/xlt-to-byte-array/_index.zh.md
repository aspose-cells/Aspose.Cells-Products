---
title: 通过 C# 将 XLT 转换为字节数组
weight: 7690
description: C# XLT 到字节数组转换的示例代码。使用此代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 Excel XLT 转换为字节数组。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 XLT 转换为字节数组" h2="本机和高性能 Microsoft Excel XLT 到字节数组转换，反之亦然，使用服务器端 .NET API 进行电子表格数据处理。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
字节数组有助于数据处理或存储。您可以将 XLT 文件转换为字节数组以及**字节数组至 XLT**文档使用 C# 语言。为了将 XLT 转换为字节数组，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 C# 将 XLT 转换为字节数组" %}}

{{% blocks/products/pf/agp/text %}}

开发人员只需几行代码即可轻松加载 XLT 文件并将其转换为字节数组，以便进行进一步的操作任务。
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 XLT 到字节数组 C# 的转换" offSpacer="" %}}
...
Excel 电子表格编程库能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 .NET Excel API不仅可以在电子表格格式之间进行转换，还可以将Excel文件（包括XLT）渲染为图像、PDF、HTML、ODS等，从而使其成为以行业标准格式交换文档的完美选择。
...
扩展名为 .xlt 的文件是使用 Microsoft Excel 创建的模板文件，Excel 是一个电子表格应用程序，作为 Microsoft Office 套件的一部分提供。 Microsoft Office 97-2003 支持创建新的 XLT 文件以及打开这些文件。最新版本的 Excel 仍然能够打开这种旧格式的模板文件。此类模板文件用于快速创建具有默认数据和设置（例如页面格式、字体大小、边距、图表等）的新 Excel 文件，这些文件可以进一步保存为新的 .xls 文件。
