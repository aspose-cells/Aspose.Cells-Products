---
title: Fusionner TXT en NUMBERS - Combiner TXT en NUMBERS dans C#
url: /fr/net/merger/merge-txt-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite TXT au format de sauvegarde NUMBERS. C# Combinez TXT au format CHIFFRES. Fusionner TXT avec NUMBERS dans C#. TXT Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner TXT aux NUMÉROS dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner TXT à NUMBERS dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner TXT avec NUMBERS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier NUMBERS. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne TXT en NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner TXT en NUMBERS en C#" InputFormat="txt" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner TXT en NUMBERS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner TXT avec NUMBERS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner TXT en NUMBERS" %}}
