---
title: Konwertuj XLTM na XLSX za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltm-to-xlsx/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTM do formatu XLSX. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTM na XLSX w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLTM na XLSX przez C++" h2="Wysokowydajna konwersja XLTM do XLSX przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLTM na XLSX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSX).1. Plik XLSX zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSX w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLTM do XLSX C++ Kod źródłowy konwersji" offSpacer="" %}}
