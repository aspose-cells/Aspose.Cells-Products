---
title: NUMBERS'ı Java aracılığıyla JSON'a dönüştürün 
url: /tr/java/conversion/numbers-to-json/ 
description: NUMBERS biçimi için JSON dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada JSON'a aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="NUMBERS\'ı Java aracılığıyla JSON\'a dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı JSON\'a dönüştürmek için NUMBERS\'ı JSON\'a Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak NUMBERS\'ı JSON\'a Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="NUMBERS\'ı Java aracılığıyla JSON\'a Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla NUMBERS dosyasını JSON'a kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. NUMBERS dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Cells.createRange yöntemini kullanarak dışa aktarılacak bir veri aralığı oluşturun1. Range & ExportRangeToJsonOptions referanslarıyla JsonUtility.exportRangeToJson yöntemini çağırın1. BufferedWriter.write yöntemi ile dosyaya String JSON verilerini yazın
...
{{% blocks/products/pf/agp/code-block title="NUMBERS - JSON Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS - JSON Dönüşüm Canlı Demoları" sectionDescription="[NUMBERS\'i JSON\'a dönüştür](https://products.aspose.app/cells/conversion/numbers-to-json) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece NUMBERS dosyanızı yükleyin, anında JSON\'a dönüştürülecektir." >}}
