...
Chcesz programowo przekonwertować pliki XML na SPREADSHEETML? Programiści .NET mogą łatwo załadować i przekonwertować XML na SPREADSHEETML w zaledwie kilku linijkach kodu.
...
1. Konwertuj XML do SPREADSHEETML wywołując metodę Workbook.Save.
