...
description: Aspose Exceller. Convertissez FODS en DIF rapidement et facilement avec Aspose.Cells. Python FODS en DIF. Python Enregistrez FODS en DIF. Enregistrez FODS sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le FODS au DIF au Python" %}}

L'exemple suivant montre comment convertir FODS en DIF dans Python.
