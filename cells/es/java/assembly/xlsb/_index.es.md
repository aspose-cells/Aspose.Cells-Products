...
{{% blocks/products/pf/agp/content h2="Cómo generar informes XLSB usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para generar informes XLSB a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Instanciar la clase WorkbookDesigner1. Agregar objetos Datasouce en un ArrayList1. Establezca la fuente de datos y el proceso para el objeto WorkbookDesigner1. Guarde el resultado en formato XLSB a través del método Worbook.save
