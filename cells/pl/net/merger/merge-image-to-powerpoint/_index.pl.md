...
Poniższy przykład ilustruje sposób scalania OBRAZU z POWERPOINT w Aspose.Cells for .NET.
...
Chcesz programowo połączyć IMAGE z POWERPOINT? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do scalania OBRAZU z POWERPOINT" %}}
