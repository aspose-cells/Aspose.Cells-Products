...
{{< blocks/products/pf/i18n/upper-banner h1="JSON\'u Java aracılığıyla JPEG\'e dönüştürün" h2="JSON\'u, ek araçlar veya kitaplıklar gerektirmeden Java aracılığıyla JPEG formatına aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak JSON\'u JPEG\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla JSON\'u JPEG\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, JSON dosyasını yalnızca birkaç kod satırıyla kolayca JPEG'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Workbook sınıfının yeni bir örneğini oluşturun1. Koleksiyondan varsayılanı veya herhangi bir Çalışma Sayfasını seçin1. JSON verilerini dosyadan yükle1. JsonLayoutOptions örneğini oluşturun ve seçenekleri ayarlayın1. JSON verilerini içe aktarmak için JsonUtility.importData yöntemini çağırın1. JPEG oluşturma için ImageOrPrintOptions nesnesini oluşturun ve ayarlayın1. İşleme için SheetRender oluşturun1. Sonucu JPEG formatında kaydetmek için SheetRender.toImage yöntemini çağırın
...
{{% blocks/products/pf/agp/code-block title="JSON\'dan JPEG\'e Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
