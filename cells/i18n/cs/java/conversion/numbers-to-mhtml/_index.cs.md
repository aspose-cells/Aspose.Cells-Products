...
{{% blocks/products/pf/agp/content h2="Jak převést ČÍSLA na MHTML pomocí Java" %}}

 K vykreslení NUMBERS do MHTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu NUMBERS na MHTML prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři z Java mohou snadno převést NUMBERS soubor do MHTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst NUMBERS soubor s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením MHTML a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor MHTML
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze NUMBERS na MHTML Java" offSpacer="" %}}

```cs
// načtěte soubor NUMBERS do instance Workbooku
Workbook book = new Workbook("template.numbers");
// uložit NUMBERS jako MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze NUMBERS na MHTML" sectionDescription="[Převést NUMBERS na MHTML](https://products.aspose.app/cells/conversion/numbers-to-mhtml) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor NUMBERS, bude okamžitě převeden do MHTML." >}}
