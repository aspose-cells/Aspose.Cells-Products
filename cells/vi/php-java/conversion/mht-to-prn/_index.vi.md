...
description: Aspose Excel. Chuyển đổi MHT sang PRN nhanh chóng và dễ dàng với Aspose.Cells. PHP MHT sang PRN. PHP Lưu MHT vào PRN. Lưu MHT dưới dạng PRN bằng PHP.
...
Ví dụ sau đây trình bày cách chuyển đổi MHT sang PRN trong PHP.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi MHT sang PRN qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin MHT sang PRN theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi MHT sang PRN chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi MHT sang PRN bằng cách gọi phương thức lưu của Workbook.
