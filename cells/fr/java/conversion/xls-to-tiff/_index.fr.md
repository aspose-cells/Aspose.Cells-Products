---
title: Java XLS à TIFF - Convertisseur en ligne XLS à TIFF
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XLS en format de sauvegarde TIFF. Format Java XLS à TIFF. Enregistrez XLS à TIFF Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS à TIFF dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLS en TIFF en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en TIFF. Téléchargez votre fichier XLS, puis enregistrez-le simplement en tant que fichier TIFF. Pour la lecture XLS et l'écriture TIFF, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie TIFF seront identiques au document XLS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en TIFF en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="tiff" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en TIFF par programmation ? Les développeurs de Java peuvent facilement convertir XLS en TIFF en seulement quelques lignes de code.
