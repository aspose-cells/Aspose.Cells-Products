...
Hai bisogno di convertire i file MHT in JPG tramite codice? Gli sviluppatori di C++ possono facilmente convertire i file MHT in JPG in poche righe di codice.
...
1.  Convertire MHT in JPG chiamando il metodo Save().
