...
description: Aspose เอ็กเซล. Java สร้างไฟล์ GIF อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ GIF โดยใช้ Java สร้าง GIF ใน Java Java GIF Creater
...
1. บันทึกสมุดงานเป็นรูปแบบ GIF โดยใช้เมธอด save()
