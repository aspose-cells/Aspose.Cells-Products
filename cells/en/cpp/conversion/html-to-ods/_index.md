...
description: Sample C++ conversion code for HTML to ODS format. Programmers can use this source code for batch HTML to ODS conversion within any C++ Application.
---
