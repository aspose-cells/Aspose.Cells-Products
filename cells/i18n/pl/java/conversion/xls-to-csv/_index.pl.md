---
title: Konwertuj XLS na CSV przez Java 
weight: 120
url: /pl/java/conversion/xls-to-csv/ 
description: Przykładowy kod konwersji Java dla formatu XLS do pliku CSV. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do CSV w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLS na CSV przez Java" h2="Konwersja XLS na CSV Java w celu przekonwertowania jednej lub wielu stron na CSV przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na CSV za pomocą Java" %}}

 Aby wyrenderować XLS do CSV, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLS na CSV za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik XLS na CSV w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLS z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem CSV i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę wynikowego pliku CSV
...
{{% blocks/products/pf/agp/code-block title="XLS do CSV Java Kod źródłowy konwersji" offSpacer="" %}}
