...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSX na MHT za pomocą Aspose.Cells. PHP XLSX na MHT. PHP Zapisz XLSX w MHT. Zapisz XLSX jako MHT przy użyciu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na MHT przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSX na MHT? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na MHT w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLSX na MHT, wywołując metodę zapisu skoroszytu.
