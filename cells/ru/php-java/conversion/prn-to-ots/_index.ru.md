---
title: PHP PRN to OTS - Конвертер PRN в OTS
...
{{% blocks/products/pf/agp/content h2="Как преобразовать PRN в OTS с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать PRN-файлы в OTS? PHP-разработчики могут легко загрузить и преобразовать PRN-файлы в OTS всего несколькими строками кода.
...
1.  Преобразуйте PRN в OTS, вызвав метод save рабочей книги.
1.  Получите результат конвертации PRN в OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-библиотека для преобразования PRN в OTS" %}}
