...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLSM 转换为 CSV。 C# XLSM 为 CSV。 C# 将 XLSM 保存为 CSV。 将 XLSM 另存为 07611134 81 使用 C#。
...
{{% cells-convert title="将 XLSM 转换为 CSV 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="csv" IsLandingPage="true" %}}
...
1. 使用工作簿实例加载 XLSM 文件。
1. 通过调用Workbook.Save方法将XLSM转换为CSV。
1. 获取XLSM到CSV的转换结果。
