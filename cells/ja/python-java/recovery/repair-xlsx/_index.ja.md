---
title: Python xlsx の修復 - 破損した xlsx ファイルを回復して修正する
url: /ja/python-java/recovery/repair-xlsx/ 
description: Python Aspose.Cells.xlsxを修復します。 xlsxファイルを修正しました。 xlsxリカバリツール。 xlsx が破損しています。 xlsxデータを復元します。 xlsxファイルのリカバリ。破損したxlsxファイルを回復します。
...
{{% cells-recovery title="XLSXファイルを修復するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}    
