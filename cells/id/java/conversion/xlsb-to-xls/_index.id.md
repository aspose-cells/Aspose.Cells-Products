---
title: Java XLSB hingga XLS - XLSB hingga XLS Konverter
description: Aspose Unggul. Ubah XLSB menjadi XLS dengan cepat dan mudah dengan Aspose.Cells. Java XLSB menjadi XLS. Java Simpan XLSB menjadi XLS. Simpan XLSB sebagai 07611134 81 menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSB menjadi XLS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi XLSB menjadi XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSB, XLS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSB hingga XLS di Java" %}}

Contoh berikut menunjukkan cara mengonversi XLSB menjadi XLS di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLSB menjadi XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSB ke XLS secara terprogram? Pengembang Java dapat dengan mudah mengonversi XLSB menjadi XLS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah XLSB menjadi XLS" %}}
{{% blocks/products/pf/agp/text %}}
