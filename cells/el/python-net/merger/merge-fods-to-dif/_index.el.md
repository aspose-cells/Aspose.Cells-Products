...
url: /el/python-net/merger/merge-fods-to-dif/ 
description: Aspose Excel. Python Excel. Συγχώνευση FODS σε μορφή αποθήκευσης DIF. Python Συνδυάστε τη μορφή FODS με DIF. Συγχώνευση FODS με DIF στη Βιβλιοθήκη Excel Python. FODS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση FODS σε DIF Χρησιμοποιώντας Python Βιβλιοθήκη Excel" %}}
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση FODS με DIF στο Python Βιβλιοθήκη Excel" %}}

Το παρακάτω παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS με το DIF στο Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση FODS έως DIF στο Python Excel Library" InputFormat="fods" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το FODS στο DIF μέσω του Python Excel Library" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε το FODS με το DIF μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
