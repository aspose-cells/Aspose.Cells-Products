---
title: C# SXC to FODS - SXC to FODS Converter
description: Aspose Excel. C# Aspose.Cells. SXC to FODS in C#. C# Convert SXC to FODS saveformat. C# SXC to FODS format. Save SXC to FODS C#.
keywords: [Aspose Excel., C# Aspose.Cells., SXC to FODS in C#., C# SXC to FODS saveformat., SXC to FODS C#., C# Convert SXC to FODS]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert SXC to FODS in C#" h2="High-speed C# library for converting SXC to FODS. This is a professional software solution to import and export SXC, FODS, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Save SXC to FODS in C#" %}}

The following example demonstrates how to convert SXC to FODS in C#.
...
{{% cells-convert title="Sample Code to Convert SXC to FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert SXC to FODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert SXC files to FODS programmatically? .NET developers can easily load & convert SXC to FODS in just a few lines of code.
