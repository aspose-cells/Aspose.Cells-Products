---
title:  Συγχώνευση SPREADSHEETML στο PDF via Java
url: /el/java/merger/merge-spreadsheetml-to-pdf/ 
description: Συγχώνευση SPREADSHEETML στο PDF Online δωρεάν. Δωρεάν Online SPREADSHEETML to PDF Merger. Συγχώνευση SPREADSHEETML σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SPREADSHEETML στο PDF στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση SPREADSHEETML στο PDF σε απευθείας σύνδεση" InputFormat="xml" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
