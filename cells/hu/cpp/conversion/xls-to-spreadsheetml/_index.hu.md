---
title: Konvertálja az XLS-t SPREADSHEETML-be a(z) C++ alkalmazással 

description: Minta C++ konverziós kód XLS dokumentumhoz SPREADSHEETML formátumba. A programozók ezt a forráskódot használhatják az XLS-ből SPREADSHEETML-be történő kötegelt konvertáláshoz bármely C++ alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja az XLS-t SPREADSHEETML-be a következőn keresztül: C++" h2="Nagy teljesítményű XLS–SPREADSHEETML konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Az XLS konvertálása SPREADSHEETML-be a következővel: C++" %}}

 Az XLS SPREADSHEETML-lé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS konvertálása SPREADSHEETML-re a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatnak XLS-fájlt SPREADSHEETML-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (SPREADSHEETML) fájlkiterjesztéssel.1. A SPREADSHEETML fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a SPREADSHEETML fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLS-ből SPREADSHEETML-be C++ konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS-ből SPREADSHEETML-be konvertáló élő bemutatók" sectionDescription="[Konvertálja az XLS-t SPREADSHEETML-be](https://products.aspose.app/cells/conversion/xls-to-spreadsheetml) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel XLS fájlját, és azonnal SPREADSHEETML formátumba konvertálódik." >}}
