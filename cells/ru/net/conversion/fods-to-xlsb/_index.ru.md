...
description: Aspose Эксель. Преобразуйте FODS в XLSB быстро и легко с помощью Aspose.Cells. C# FODS в XLSB. C# Сохранить FODS в XLSB. Сохранить FODS как 07611134 81, используя C#.
...
{{% blocks/products/pf/agp/content h2="Преобразуйте FODS в XLSB, используя C#." %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните с FODS по XLSB в C#." %}}
...
1.  Преобразуйте FODS в XLSB, вызвав метод Workbook.Save.
