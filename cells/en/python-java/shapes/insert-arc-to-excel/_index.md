...
weight: 10
url: /python-java/shapes/insert-arc-to-excel/ 
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addArc(int,%20int,%20int,%20int,%20int,%20int)) to insert a Arc in the selected worksheet.
