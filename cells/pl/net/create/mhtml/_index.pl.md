...
{{% blocks/products/pf/agp/content h2="Jak utworzyć MHTML za pośrednictwem C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod do utworzenia pliku MHTML przy użyciu C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteka do utworzenia pliku MHTML" %}}
