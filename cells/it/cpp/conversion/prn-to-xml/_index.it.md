---
title: C++ PRN in XML - Convertitore da PRN a XML
...
{{% blocks/products/pf/agp/content h2="Salva PRN in XML in C++" %}}

L'esempio seguente mostra come convertire PRN in XML in C++.
...
{{% blocks/products/pf/agp/content h2="Come convertire PRN in XML tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file PRN in XML tramite codice? Gli sviluppatori di C++ possono convertire facilmente i file PRN in XML in poche righe di codice.
...
1.  Convertire PRN in XML chiamando il metodo Save().
1.  Ottieni il risultato della conversione da PRN a XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C++ per convertire PRN in XML" %}}
