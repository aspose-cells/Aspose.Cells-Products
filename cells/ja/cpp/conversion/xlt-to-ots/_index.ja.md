---
title: C++ XLT から OTS - XLT から OTS コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLTをOTSにすばやく簡単に変換します。C++ XLTをOTSに変換します。 C++ XLT を OTS に保存します。 C++ を使用して XLT を OTS として保存します。
...
{{% blocks/products/pf/agp/content h2="XLT を C++ の OTS に保存" %}}
...
{{% cells-convert title="XLTをOTSに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="ots" IsLandingPage="true" language="cpp" %}}
