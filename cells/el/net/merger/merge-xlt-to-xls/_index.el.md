---
title:  Συγχώνευση XLT σε XLS μέσω C#
url: /el/net/merger/merge-xlt-to-xls/ 
description: Συγχώνευση XLT σε XLS Online δωρεάν. Δωρεάν Online XLT έως XLS Συγχώνευση. Συγχώνευση XLT σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLT με το XLS στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLT με XLS σε απευθείας σύνδεση" InputFormat="xlt" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
