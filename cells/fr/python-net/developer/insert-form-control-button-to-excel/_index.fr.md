...
weight: 200
description: Python via Code source .Net pour insérer un bouton (contrôle de formulaire) dans Excel.
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_button/#int-int-int-int-int-int) pour insérer un Bouton (Contrôle Formulaire) dans la feuille de calcul sélectionnée.
