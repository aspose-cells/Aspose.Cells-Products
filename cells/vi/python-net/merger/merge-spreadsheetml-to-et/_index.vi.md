---
title: Gộp SPREADSHEETML với ET - Gộp SPREADSHEETML vào ET trong Python
url: /vi/python-net/merger/merge-spreadsheetml-to-et/ 
description: Aspose Excel. Python Excel. Hợp nhất SPREADSHEETML vào định dạng lưu ET. Python Kết hợp BẢNG TÍNH sang định dạng ET. Hợp nhất SPREADSHEETML với ET trong Thư viện Excel Python. Hợp nhất BẢNG TÍNHML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất SPREADSHEETML với ET bằng Thư viện Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Hợp nhất SPREADSHEETML với ET trong Thư viện Excel Python" %}}

Ví dụ sau đây minh họa cách hợp nhất SPREADSHEETML với ET trong Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất SPREADSHEETML với ET. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp ET. Nếu bạn phát triển mã bằng Python, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Python hợp nhất SPREADSHEETML với ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất SPREADSHEETML với ET trong Thư viện Excel Python" InputFormat="xml" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất SPREADSHEETML với ET qua Python Thư viện Excel" %}}
