...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan format penyimpanan JPG ke MD. Java Gabungkan format JPG ke MD. Gabungkan JPG ke MD di Java. Gabungkan JPG.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPG ke MD di Java" %}}

Contoh berikut menunjukkan cara menggabungkan JPG ke MD di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan JPG ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan JPG ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan JPG ke MD secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk menggabungkan JPG ke MD" %}}
