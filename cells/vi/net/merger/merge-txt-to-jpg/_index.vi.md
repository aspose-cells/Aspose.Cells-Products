...
Ví dụ sau minh họa cách hợp nhất TXT thành JPG trong Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất TXT thành JPG" %}}
