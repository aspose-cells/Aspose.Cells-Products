...
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online FODS do formatu zapisu POWERPOINT. C++ Połącz FODS do formatu POWERPOINT. Połącz FODS z POWERPOINT w C++. FODS Połącz.
...
Poniższy przykład pokazuje, jak scalić FODS z POWERPOINT w Aspose.Cells for C++.
...
{{% cells-merger title="Bezpłatne połączenie online FODS z POWERPOINT w C++" InputFormat="fods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć FODS z POWERPOINT przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić FODS z POWERPOINT? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
