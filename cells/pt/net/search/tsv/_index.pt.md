---
title:  Pesquise o documento TSV sem abrir via .NET
weight: 2810
description: Código-fonte C# para pesquisar palavras com padrão no arquivo TSV em .NET Framework, .NET Core, Mono ou plataformas Xamarin.
