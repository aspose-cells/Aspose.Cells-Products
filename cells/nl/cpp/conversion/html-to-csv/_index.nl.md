...
{{% blocks/products/pf/agp/content h2="Sla HTML op in CSV in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar CSV in C++.
...
Moet je bestanden met de extensie HTML programmatisch converteren naar CSV? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar CSV met slechts een paar regels code.
