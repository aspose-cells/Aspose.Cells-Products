---
title: Konvertálja a TXT-t SVG-vé a C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/txt-to-svg/ 
description: Minta C++ konverziós kód a TXT dokumentumhoz SVG formátumba. A programozók ezt a forráskódot használhatják kötegelt TXT-SVG-konverzióhoz bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TXT konvertálása SVG-vé a következőn keresztül: C++" h2="Nagy teljesítményű TXT-SVG konvertálás a C++ könyvtár használatával Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatják a TXT fájlt SVG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT fájlt a Factory::CreateIWorkbook segítségével.1. Válassza ki az első munkalapot.1. Állítsa be az (SVG) opciókat.1. Ismételje meg a lap minden oldalát, és jelenítse meg.1. Nyissa meg az SVG fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="TXT-ből SVG-be C++ Konverziós forráskód" offSpacer="" %}}
