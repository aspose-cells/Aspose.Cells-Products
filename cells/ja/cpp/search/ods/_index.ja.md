---
title:  C++ 経由で開かずに ODS ドキュメントを検索
weight: 3300
description: C++ 32 ビット、Windows 64 ビットおよび Linux 64 ビット用の C++ ランタイム環境上の ODS ファイル内のパターンを持つ単語を検索する C++ サンプル コード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS で ODS の形式を検索" h2="Microsoft や Adobe PDF などのソフトウェアを使用せずに、サーバー側の Aspose.Cells for C++ API を使用したネイティブで高性能の ODS ドキュメント検索。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="C++を使用してODSファイルを検索する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++でODSファイルを検索する手順" %}}
...
IWorkbook クラスをインスタンス化して ODS ファイルを読み込みます。
...
+ IWorkbook->Save(.) メソッドを使用して ODS ファイルを保存します。
...
{{% blocks/products/pf/agp/code-block title="ODS ファイルを検索 - C++" offSpacer="" %}}
