---
title: SPREADSHEETML を PPTX に結合 - SPREADSHEETML を Java に PPTX に結合
url: /ja/java/merger/merge-spreadsheetml-to-pptx/ 
description: Aspose エクセル。 Java Aspose.Cells。無料オンライン SPREADSHEETML を PPTX 保存形式にマージします。 Java SPREADSHEETML を PPTX 形式に結合します。 SPREADSHEETML を Java の PPTX にマージします。SPREADSHEETML をマージします。
...
次の例は、SPREADSHEETML を Aspose.Cells for Java の PPTX にマージする方法を示しています。
...
{{% cells-merger title="SPREADSHEETML を Java にオンラインで無料でマージ" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML を PPTX via Java にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで SPREADSHEETML を PPTX にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Java](https://products.aspose.com/cells/java)API はわずか数行のコードで実行できます。
