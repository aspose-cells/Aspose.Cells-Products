---
title:  Mesclar XLSB para TXT via C#
url: /pt/net/merger/merge-xlsb-to-txt/ 
description: Mesclar XLSB para TXT Online gratuitamente. Online Grátis XLSB a TXT Fusão. Mesclar XLSB para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar XLSB a TXT em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar XLSB a TXT on-line" InputFormat="xlsb" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
