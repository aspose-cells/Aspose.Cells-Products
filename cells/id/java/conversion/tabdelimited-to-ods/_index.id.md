...
{{% blocks/products/pf/agp/content h2="Simpan TABDELIMITED ke ODS di Java" %}}

Contoh berikut menunjukkan cara mengkonversi TABDELIMITED menjadi ODS di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi TABDELIMITED menjadi ODS. Unggah file TABDELIMITED Anda, lalu simpan sebagai file ODS. Untuk pembacaan TABDELIMITED dan penulisan ODS Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran ODS akan sama dengan dokumen TABDELIMITED asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi TABDELIMITED menjadi ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="tsv" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi TABDELIMITED menjadi ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file TABDELIMITED ke ODS secara terprogram? Pengembang Java dapat dengan mudah mengkonversi TABDELIMITED ke ODS hanya dengan beberapa baris kode.
...
1.  Ubah TABDELIMITED menjadi ODS dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi TABDELIMITED menjadi ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java library untuk mengkonversi TABDELIMITED menjadi ODS" %}}
{{% blocks/products/pf/agp/text %}}
