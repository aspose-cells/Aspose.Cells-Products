...
{{% cells-convert title="将 FODS 转换为数字的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="numbers" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何将 FODS 转换为数字（通过 C#）" %}}

{{% blocks/products/pf/agp/text %}}

需要通过编程方式将 FODS 文件转换为 NUMBERS 格式吗？.NET 开发人员只需几行代码即可轻松加载 FODS 文件并将其转换为 NUMBERS 格式。
