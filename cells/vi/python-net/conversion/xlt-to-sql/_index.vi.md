...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLT sang SQL trong Python" %}}
...
Ví dụ sau đây minh họa cách chuyển đổi XLT sang SQL trong Python via NET.
