...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en XPS en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xps" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir XLSB en XPS en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier XLSB avec une instance de Workbook
1.  Convertir XLSB en XPS en appelant la méthode Workbook.Save
