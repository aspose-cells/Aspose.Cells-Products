...
{{% blocks/products/pf/agp/content h2="كيفية إدراج مستطيل في ملف إكسل باستخدام Python via.نت" %}}

 من أجل إدراج مستطيل في ملف Excel، سوف نستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج مستطيل في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_rectangle/#int-int-int-int-int-int) لإدراج مستطيل في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل المستطيل - Python via .نت" offSpacer="" %}}
