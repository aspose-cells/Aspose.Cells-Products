...
weight: 930
description: Windows 32 बिट, Windows 64 बिट और लिनक्स 64 बिट के लिए C++ रनटाइम एनवायरनमेंट पर TSV फ़ाइल में पैटर्न के साथ शब्द खोजने के लिए C++ उदाहरण कोड।
...
+ वर्कबुक क्लास को इंस्टेंटिएट करके TSV फ़ाइल लोड करें।
...
+ Workbook::Save(...) विधि का उपयोग करके TSV फ़ाइल सहेजें।
