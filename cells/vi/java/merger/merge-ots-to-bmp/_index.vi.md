---
title: Gộp OTS thành BMP - Gộp OTS thành BMP vào Java
url: /vi/java/merger/merge-ots-to-bmp/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất OTS thành BMP saveformat. Java Kết hợp OTS thành định dạng BMP. Hợp nhất OTS thành BMP trong Java. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS thành BMP trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất OTS thành BMP trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất OTS thành BMP. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu vào tệp BMP. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất OTS thành BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp OTS về BMP trong Java" InputFormat="ots" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp OTS về BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất OTS vào BMP theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java gộp OTS thành BMP" %}}
