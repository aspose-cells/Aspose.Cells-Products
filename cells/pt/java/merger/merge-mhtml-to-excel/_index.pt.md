---
title: Mesclar MHTML para EXCEL - Combinar MHTML para EXCEL em Java
url: /pt/java/merger/merge-mhtml-to-excel/ 
description: Aspose Excel. Java Aspose.Cells. Mesclagem on-line gratuita MHTML para salvar formato EXCEL. Java Combine MHTML para o formato EXCEL. Mesclar MHTML para EXCEL em Java. MHTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHTML para EXCEL em Java Online Gratuitamente" %}}

exemplo a seguir demonstra como mesclar MHTML para EXCEL em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHTML para EXCEL. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo EXCEL. Se você desenvolver código em Java, isso será mais simples do que parece. Veja o exemplo Java que mescla MHTML com o EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Grátis para Mesclar MHTML para EXCEL em Java" InputFormat="mhtml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHTML para EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar MHTML para EXCEL programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHTML para EXCEL" %}}
