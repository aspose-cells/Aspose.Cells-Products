---
title: Python OTS σε FODS - OTS σε FODS Μετατροπέας
description: Aspose Excel. Μετατρέψτε το OTS σε FODS γρήγορα και εύκολα με το Aspose.Cells. Python OTS σε FODS. Python Αποθήκευση OTS σε FODS. Αποθηκεύστε το OTS ως 07617837481 χρησιμοποιώντας 3.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το OTS στο FODS στο Python" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή OTS σε FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="fods" IsLandingPage="true" language="pythonnet" %}}
