---
title: Converter SXC para BMP via Python
url: /pt/python-java/conversion/sxc-to-bmp/
description: Código de exemplo para conversão de sxc para bmp Python. Use o código de exemplo API para arquivos sxc em lote para conversão bmp no aplicativo Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter SXC para BMP via Python" h2="Exporte planilhas do Excel® para o formato BMP usando Python APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter SXC para BMP usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC para BMP via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para BMP em apenas algumas linhas de código.
