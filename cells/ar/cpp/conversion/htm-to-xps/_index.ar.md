---
title: C++ HTM إلى XPS - محول HTM عبر الإنترنت إلى XPS
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل HTM إلى XPS saveformat. C++ HTM إلى تنسيق XPS. احفظ HTM في XPS C++.
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في XPS في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات HTM إلى XPS برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى XPS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى XPS باستدعاء طريقة Save ().
