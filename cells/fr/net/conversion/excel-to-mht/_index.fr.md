---
title: C# Convertisseur Excel vers MHT
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format MHT, permettant un enregistrement transparent des données EXCEL au format MHT à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Sauvegarder EXCEL au format MHT dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en MHT dans C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir un fichier EXCEL en MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en MHT par programmation ? Les développeurs .NET peuvent facilement charger et convertir des fichiers EXCEL en MHT en quelques lignes de code seulement.
...
1.  Convertissez un fichier EXCEL au format MHT en appelant la méthode Workbook.Save.
1. Obtenez le résultat de la conversion d'EXCEL en MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir Excel en MHT" %}}
