...
{{% blocks/products/pf/agp/content h2="How to Create BMP in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create BMP file in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# library to create BMP file" %}}
