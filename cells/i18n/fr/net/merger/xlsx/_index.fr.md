---
title: Fusionner les fichiers XLSX via .NET 
weight: 8290
url: /fr/net/merger/xlsx/ 
description: Code source C# pour combiner des documents XLSX sur des plates-formes .NET Framework, .NET Core, Mono ou Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats XLSX dans C#" h2="Fusion de documents XLSX native et hautes performances à l\'aide d\'API Aspose.Cells for .NET côté serveur, sans l\'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Chargez tous les fichiers XLSX avec le chemin complet.
+ Créer un document comme fichier de base
+ Appelez la méthode appropriée pour concaténer et fusionner les fichiers un par un.
+ Appelez la méthode Save() et passez le nom du fichier (chemin complet) et le format (XLSX) en paramètre.
Vous pouvez maintenant ouvrir et utiliser le fichier XLSX dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
