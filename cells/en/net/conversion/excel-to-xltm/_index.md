...
The following example demonstrates how to convert EXCEL to XLTM document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert EXCEL file into XLTM format. Upload your EXCEL file, then simply save it as XLTM file. For both EXCEL reading and XLTM writing you can use fully qualified filenames. The output XLTM content and formatting will be identical to the original EXCEL document.
