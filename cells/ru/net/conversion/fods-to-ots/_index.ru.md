...
description: Aspose Эксель. Преобразуйте FODS в OTS быстро и легко с помощью Aspose.Cells. C# FODS в OTS. C# Сохраните FODS в OTS. Сохраните FODS как OTS, используя C#.
...
{{% blocks/products/pf/agp/content h2="Преобразуйте FODS в OTS, используя C#" %}}
...
{{% cells-convert title="Пример кода для преобразования FODS в OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="ots" IsLandingPage="true" %}}
