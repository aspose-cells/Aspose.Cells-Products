---
title: C# OTS zu JPG - OTS zu JPG Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von OTS in das JPG-Format und ermöglicht das nahtlose Speichern von OTS-Daten im JPG-Format mithilfe der Bibliothek Aspose.Cells – alles durch effizienten und anpassbaren Code C#.
...
{{% blocks/products/pf/agp/content h2="OTS als JPG in C# speichern" %}}

Das folgende Beispiel zeigt, wie man OTS in C# in JPG konvertiert.
{{% blocks/products/pf/agp/text %}}

Folgen Sie den einfachen Schritten, um OTS in JPG zu konvertieren. Laden Sie Ihre OTS-Datei hoch und speichern Sie sie dann einfach als JPG-Datei. Sowohl zum Lesen von OTS als auch zum Schreiben von JPG können Sie vollqualifizierte Dateinamen verwenden. Der Inhalt und die Formatierung des JPG-Ausgabedokuments sind mit dem ursprünglichen OTS-Dokument identisch.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Beispielcode zur Konvertierung von OTS in JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS in JPG über C#" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in JPG konvertieren? .NET-Entwickler können OTS mit nur wenigen Codezeilen problemlos in JPG laden und konvertieren.
...
1.  Konvertieren Sie OTS in JPG, indem Sie die Methode Workbook.Save aufrufen.
1.  Holen Sie sich das Konvertierungsergebnis von OTS in JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# Bibliothek zur Konvertierung von OTS in JPG" %}}
