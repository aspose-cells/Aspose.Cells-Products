...
Trzeba programowo przekonwertować pliki JPG do ETT? Programiści C++ mogą łatwo przekonwertować pliki JPG do ETT za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JPG do ETT wywołując metodę Save().
