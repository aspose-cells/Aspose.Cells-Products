...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können JSON-Dateien in nur wenigen Codezeilen ganz einfach in MHTML konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die JSON-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (MHTML).1. Die MHTML-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die MHTML-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="Konvertierungsquellcode von JSON zu MHTML C++" offSpacer="" %}}
