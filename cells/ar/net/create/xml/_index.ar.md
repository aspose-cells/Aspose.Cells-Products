...
من السهل على المطورين إنشاء ملفات XML وتحميلها وتعديلها وتحويلها من خلال تشغيل تطبيقات تقارير مختلفة لمعالجة البيانات في بضعة أسطر من التعليمات البرمجية.
...
1.  استخدم طريقة الحفظ لحفظ المصنف كملف XML.
