...
description: Aspose Excel. A XLTX-es számot XLSX-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# XLTX-XLSX-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTX-XLSX számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a XLTX-et XLSX-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a XLTX XLSX-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTX konvertálása XLSX-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLTX fájlt programozottan XLSX-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a XLTX-et XLSX-re.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX konvertálásához XLSX-re" %}}
