...
url: /cs/net/merger/merge-xls-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit XLS do formátu uložení PRN. C# Spojte XLS do formátu PRN. Sloučit XLS na PRN v C#. XLS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLS s PRN v C#" %}}

Následující příklad ukazuje, jak sloučit XLS do PRN v Aspose.Cells for .NET.
...
{{% cells-merger title="Ukázkový kód pro sloučení XLS do PRN v C#" InputFormat="xls" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLS do PRN přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit XLS s PRN programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna ke sloučení XLS do PRN" %}}
