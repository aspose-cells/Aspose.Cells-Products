...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji MHTML do formatu OBRAZU, umożliwiając bezproblemowe zapisywanie danych MHTML w formacie OBRAZU przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C++.
...
Poniższy przykład pokazuje, jak przekonwertować liczbę MHTML na obraz w formacie C++.
...
Trzeba programowo przekonwertować pliki MHTML na IMAGE? Programiści C++ mogą łatwo przekonwertować pliki MHTML na IMAGE za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj MHTML na OBRAZ wywołując metodę Save().
