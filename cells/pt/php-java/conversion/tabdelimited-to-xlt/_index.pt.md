...
description: Aspose Excel. Converta TABDELIMITED em XLT de forma rápida e fácil com Aspose.Cells. PHP TABDELIMITED em XLT. PHP Salve TABDELIMITED em XLT. Salve TABDELIMITED como XLT usando PHP.
...
Precisa converter arquivos TABDELIMITED para XLT programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TABDELIMITED em XLT em apenas algumas linhas de código.
...
1.  Converta TABDELIMITED em XLT chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TABDELIMITED para XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED para XLT" %}}
