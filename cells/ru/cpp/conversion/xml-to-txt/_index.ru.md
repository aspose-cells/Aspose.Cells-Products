...
Вам нужно программно преобразовать XML-файлы в TXT? Разработчики C++ могут легко преобразовать XML в TXT всего за несколько строк кода.
