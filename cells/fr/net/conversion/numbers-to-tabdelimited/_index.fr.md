---
title: Convertir NUMBERS en TABDELIMITED C#
description: Convertissez des NUMBERS en TABDELIMITED en ligne gratuitement. Convertisseur en ligne gratuit de NUMBERS en TABDELIMITED. C# NUMÉROS à TABDELIMITED. NUMÉROS à TABDELIMITED via C#.
keywords: Convert NUMBERS, NUMBERS Converter, NUMBERS to PDF, NUMBERS to Word, NUMBERS to PPT, NUMBERS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertissez les NUMBERS en TABDELIMITED via C#" h2="Bibliothèque C# haute vitesse pour la conversion de NUMBERS en TABDELIMITED. Exportez des feuilles de calcul Excel au format TABDELIMITED sur .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir des NUMBERS en TABDELIMITED en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des NUMBERS en TABDELIMITED via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs de .NET peuvent facilement charger et convertir des NUMBERS en TABDELIMITED en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier NUMBERS avec une instance de Workbook
1. Convertir NUMBERS en TABDELIMITED en appelant la méthode Workbook.Save
