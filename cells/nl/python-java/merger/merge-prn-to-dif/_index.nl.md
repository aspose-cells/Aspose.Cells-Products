...
url: /nl/python-java/merger/merge-prn-to-dif/ 
...
Het volgende voorbeeld laat zien hoe u PRN samenvoegt met DIF in Aspose.Cells for Python via Java.
...
Wilt u PRN programmatisch samenvoegen met DIF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
