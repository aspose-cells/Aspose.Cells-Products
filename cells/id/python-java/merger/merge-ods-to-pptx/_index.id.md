---
title: Gabung ODS ke PPTX - Gabungkan ODS ke PPTX di Python
url: /id/python-java/merger/merge-ods-to-pptx/ 
description: Aspose Unggul. Python Aspose.Cells. Free Online Merge ODS to PPTX saveformat. Python Gabungkan format ODS menjadi PPTX. Gabung ODS ke PPTX di Python. ODS Gabung.
...
Contoh berikut menunjukkan cara menggabungkan ODS ke PPTX di Aspose.Cells for Python via Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan ODS ke PPTX di Python" InputFormat="ods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan ODS ke PPTX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan ODS menjadi PPTX secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API dapat dilakukan hanya dengan beberapa baris kode.
