---
title: C++ EXCEL ke XLS - Konverter EXCEL ke XLS
description: Aspose Excel. Solusi komprehensif ini menyediakan C++ pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi EXCEL ke format XLS, memungkinkan penyimpanan data EXCEL ke format XLS dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode C++ yang efisien dan dapat disesuaikan.
...
{{% blocks/products/pf/agp/content h2="Simpan EXCEL ke XLS di C++" %}}

Contoh berikut menunjukkan cara mengkonversi EXCEL ke XLS di C++.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi EXCEL ke XLS melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file EXCEL ke XLS secara terprogram? Pengembang C++ dapat dengan mudah mengkonversi EXCEL ke XLS hanya dengan beberapa baris kode.
...
1.  Konversikan EXCEL ke XLS dengan memanggil metode Save().
1.  Dapatkan hasil konversi EXCEL menjadi XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ pustaka untuk mengkonversi EXCEL ke XLS" %}}
