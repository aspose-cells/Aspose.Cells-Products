---
title: Konwertuj MHTML na XLTX przez Java 
weight: 9000
url: /pl/java/conversion/mhtml-to-xltx/ 
description: Przykładowy kod konwersji Java dla formatu MHTML do pliku XLTX. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do formatu XLTX w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MHTML na XLTX przez Java" h2="Konwersja MHTML do XLTX Java w celu konwersji jednej lub wielu stron do formatu XLTX przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na XLTX przy użyciu Java" %}}

 Aby wyrenderować MHTML do XLTX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MHTML na XLTX za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik MHTML na XLTX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik MHTML z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLTX i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLTX
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji MHTML na XLTX Java" offSpacer="" %}}

```cs
// załaduj plik MHTML w instancji Workbook
Workbook book = new Workbook("template.mhtml");
// zapisz MHTML jako XLTX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją MHTML na XLTX" sectionDescription="[Konwertuj MHTML na XLTX](https://products.aspose.app/cells/conversion/mhtml-to-xltx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik MHTML, zostanie on natychmiast przekonwertowany do formatu XLTX." >}}
