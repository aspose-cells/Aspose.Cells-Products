...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML converteren naar ODS in Python" %}}
...
In het volgende voorbeeld ziet u hoe u SPREADSHEETML converteert naar ODS in Python via NET.
