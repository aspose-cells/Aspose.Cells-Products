...
description: Aspose Excel. Convierta HTM a XLSM rápida y fácilmente con Aspose.Cells. Python HTM a XLSM. Python Guarde HTM en XLSM. Guarde HTM como XLSM usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde HTM en XLSM en Python" %}}

El siguiente ejemplo demuestra cómo convertir HTM a XLSM en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir HTM a XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlsm" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir HTM a XLSM" %}}
