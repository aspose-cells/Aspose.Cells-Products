---
title: Создать EMF - Создать файл EMF в Java
description: Aspose Excel. Java Создать файл EMF. Создать EMF Java. Java EMF Создатель. Создайте EMF в Java. Создайте файл EMF, используя Java.
...
{{% blocks/products/pf/agp/content h2="Как создать EMF в Java" %}}
...
1.  Сохраните книгу в формате EMF, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл EMF в Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="библиотека Java для создания файла EMF" %}}
{{% blocks/products/pf/agp/text %}}
