...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte XLS na IMAGE v C++" h2="Vysoce výkonná konverze XLS na IMAGE s využitím knihovny C++ bez nutnosti instalace Microsoft Excelu, OpenOffice nebo Adobe Acrobatu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Potřebujete programově převést soubory XLS do formátu IMAGE? Vývojáři C++ mohou snadno převést soubory XLS do formátu IMAGE pomocí několika řádků kódu.
...
1.  Převeďte číslo XLS na IMAGE voláním metody Save().
