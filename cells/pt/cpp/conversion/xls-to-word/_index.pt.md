---
title: C++ XLS a WORD - XLS a WORD Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato WORD, permitindo o salvamento perfeito de dados XLS no formato WORD usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLS a WORD em C++" %}}

exemplo a seguir demonstra como converter XLS em WORD em C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLS em WORD. Carregue seu arquivo XLS e simplesmente salve-o como arquivo WORD. Para leitura de XLS e gravação de WORD, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída WORD serão idênticos ao documento XLS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter XLS em WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="docx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em WORD por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para WORD programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para WORD com apenas algumas linhas de código.
...
1.  Converta XLS para WORD chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para WORD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em WORD" %}}
