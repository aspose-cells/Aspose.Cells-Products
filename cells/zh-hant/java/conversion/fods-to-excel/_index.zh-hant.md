---
title: Java FODS 轉 EXCEL - FODS 轉 EXCEL 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 FODS 轉換為 EXCEL。Java FODS 轉換為 EXCEL。 Java 將 FODS 儲存到 EXCEL。使用 Java 將 FODS 另存為 EXCEL。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 EXCEL Java" h2="高速Java庫，用於將FODS轉換為EXCEL。這是一個使用Java導入和匯出FODS、EXCEL和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 EXCEL 中 Java" %}}

下面的範例示範如何將FODS轉換為EXCEL中的Java。
...
{{% cells-convert title="將 FODS 轉換為 EXCEL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為 EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 檔案轉換為 EXCEL？ Java開發人員只需幾行程式碼即可輕鬆將FODS轉換為EXCEL。
