---
title: PHP JSON to NUMBERS - JSON to NUMBERS Converter
description: Aspose Excel. This comprehensive solution provides PHP developers with a fully integrated approach to convert JSON to NUMBERS format, enabling seamless saving of JSON data into NUMBERS format using the Aspose.Cells library, all through efficient and customizable PHP code.
...
{{% blocks/products/pf/agp/content h2="Convert JSON to NUMBERS Using PHP" %}}

How do I convert JSON to NUMBERS? With Aspose.Cells for PHP via Java library, you can easily convert JSON to NUMBERS programmatically with  a few lines of code. [Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) is capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. PHP Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT and more, thus making it a perfect choice to exchange documents in industry-standard formats. 
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Save JSON to NUMBERS in PHP" %}}

The following example demonstrates how to convert JSON to NUMBERS in PHP.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert JSON to NUMBERS. Upload your JSON file, then simply save it as NUMBERS file. For both JSON reading and NUMBERS writing you can use fully qualified filenames. The output NUMBERS content and formatting will be identical to the original JSON document.
...
{{% blocks/products/pf/agp/content h2="How to Convert JSON to NUMBERS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert JSON files to NUMBERS programmatically? PHP developers can easily load & convert JSON to NUMBERS in just a few lines of code.
...
1.  Convert JSON to NUMBERS by calling save method of Workbook.
1.  Get the conversion result of JSON to NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP library to convert JSON to NUMBERS" %}}
