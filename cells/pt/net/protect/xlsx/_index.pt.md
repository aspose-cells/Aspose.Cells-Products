---
title: Proteger e bloquear XLSX documento via .NET
weight: 90
description: C# código-fonte para bloquear XLSX arquivo usando senha em .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Criptografar XLSX Arquivos via C#" h2="Planilhas do Excel protegidas por senha, incluindo o formato XLSX usando a Biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Proteger XLSX via C#" %}}
...
1.  Instancie a classe Workbook com o caminho para o arquivo XLSX
...
1.  Salve o resultado no formato XLSX
