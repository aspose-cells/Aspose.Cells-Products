...
Trzeba programowo przekonwertować pliki IMAGE do formatu PDF? Programiści C++ mogą łatwo przekonwertować pliki IMAGE do formatu PDF za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj OBRAZ na PDF wywołując metodę Save().
