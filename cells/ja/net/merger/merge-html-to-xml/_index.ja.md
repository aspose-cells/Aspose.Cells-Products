...
url: /ja/net/merger/merge-html-to-xml/ 
...
次の例は、HTML を Aspose.Cells for .NET の XML にマージする方法を示しています。
...
HTML をプログラムで XML にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="HTML を XML にマージする .NET ライブラリ" %}}
