---
title: Chuyển đổi SPREADSHEETML sang ODS qua Python

description: Mã mẫu cho chuyển đổi từ bảng tínhml sang ods Python. Sử dụng mã mẫu API cho hàng loạt tệpml bảng tính để chuyển đổi ods trong ứng dụng Python.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi SPREADSHEETML sang ODS bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi SPREADSHEETML sang ODS qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp SPREADSHEETML sang ODS chỉ trong một vài dòng mã.
