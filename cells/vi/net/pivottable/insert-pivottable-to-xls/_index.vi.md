...
weight: 7690
description: C# Mã mẫu để tạo tài liệu XLS với PivotTable. Sử dụng mã này để tạo tệp Micorsoft Excel XLS với PivotTable trong VB.NET, Asp.NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn PivotTable vào XLS Tài liệu qua C#" h2="Bảng tính gốc và hiệu suất cao Microsoft Excel XLS với tính năng tạo PivotTable theo chương trình bằng cách sử dụng API .NET phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Tạo tệp MS Excel XLS với PivotTable động trong ứng dụng đang chạy thật dễ dàng. Để tạo tài liệu XLS với PivotTable từ đầu mà không yêu cầu MS Office, chúng tôi sẽ sử dụng
