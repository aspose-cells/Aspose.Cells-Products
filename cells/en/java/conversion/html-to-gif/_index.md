...
description: Sample Java conversion code for HTML format to GIF file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to GIF within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert HTML to GIF Using Java" %}}
 ...
 In order to render HTML to GIF, we’ll use
