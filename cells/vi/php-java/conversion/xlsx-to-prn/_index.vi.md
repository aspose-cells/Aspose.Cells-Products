---
title: Chuyển đổi PHP XLSX sang PRN - XLSX sang PRN Chuyển đổi
description: Aspose Excel. Chuyển đổi XLSX sang PRN nhanh chóng và dễ dàng với Aspose.Cells. PHP XLSX sang PRN. PHP Lưu XLSX vào PRN. Lưu XLSX dưới dạng PRN bằng PHP.
...
{{% cells-convert title="Mã mẫu để chuyển đổi XLSX sang PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="prn" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSX sang PRN qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLSX sang PRN theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi XLSX sang PRN chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLSX sang PRN bằng cách gọi phương thức lưu của Workbook.
