---
title:  Afficher les formats de fichiers TXT via .NET
weight: 8300
description: Code source C# pour charger, restituer et afficher les documents TXT sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/content h2="Comment afficher le fichier TXT à l\'aide de C#" %}}
 ...
 Afin de visualiser le fichier TXT, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour afficher le TXT via le C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code C# pour afficher le fichier TXT" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API peut être utilisé pour créer, éditer, convertir et restituer Microsoft des formats Excel vers différents formats. De plus, il peut être utilisé pour des graphiques complets, des rapports évolutifs et des calculs fiables au sein d'applications logicielles. Aspose.Cells est un API autonome et ne nécessite aucun logiciel comme Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour afficher le TXT" sectionDescription=" Consultez nos démos en direct pour[Voir TXT](https://products.aspose.app/cells/viewer/txt) avec les avantages suivants." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger ou de configurer quoi que ce soit" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire ou de compiler du code" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement le fichier TXT et cliquez sur le bouton \"Afficher\"." >}}
