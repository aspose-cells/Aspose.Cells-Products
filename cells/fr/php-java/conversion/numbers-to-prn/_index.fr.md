---
title: Convertisseur de numéros PHP en PRN
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir les nombres au format PRN, permettant un enregistrement transparent des données numériques au format PRN grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des nombres en PRN via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en PRN par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers NUMBERS en PRN en quelques lignes de code seulement.
...
1.  Convertissez les NUMBERS en PRN en appelant la méthode save de Workbook.
1.  Obtenez le résultat de la conversion de NUMBERS en PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir des NOMBRES en PRN" %}}
