---
title: Sloučit CSV až XLAM - Sloučit CSV až XLAM v C++
url: /cs/cpp/merger/merge-csv-to-xlam/ 
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma CSV do formátu uložení XLAM. C++ Kombinujte formát CSV až XLAM. Sloučit CSV až XLAM v C++. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV až XLAM v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit CSV až XLAM v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení CSV do XLAM. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLAM. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí CSV do XLAM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení CSV až XLAM v C++" InputFormat="csv" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV na XLAM přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit CSV až XLAM? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení CSV až XLAM" %}}
