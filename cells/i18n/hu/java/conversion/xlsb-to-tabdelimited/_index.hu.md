---
title: "XLSB konvertálása TABLEDELIMITED-re a következőn keresztül: Java "
url: /hu/java/conversion/xlsb-to-tabdelimited/ 
description: Minta Java konverziós kód XLSB formátumhoz TABDELIMITED fájlba. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok TABDELIMITED-re exportálásához bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB konvertálása TABLEDELIMITED-re a következőn keresztül: Java" h2="XLSB-ből TABDELIMITED-re Java konverzió egyetlen vagy több oldal átalakítása TABDELIMITED-té a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB konvertálása TAB-raDELIMITED a következővel: Java" %}}

 Ahhoz, hogy az XLSB-t TABDELIMITED-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az XLSB-ből TAB-ra konvertálásáhozDELIMITED a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői egyszerűen konvertálhatnak XLSB-fájlt TABDELIMITED-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSB-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TABDELIMITED kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TABDELIMITED fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLSB–TABDELIMITED Java Konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLSB fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xlsb");
// XLSB mentése TABDELIMITED néven
