---
title: Sloučit PRN s HTML – Sloučit PRN s HTML v C#
url: /cs/net/merger/merge-prn-to-html/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit PRN do formátu uložení HTML. C# Zkombinujte PRN do formátu HTML. Sloučit PRN na HTML v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na HTML v C#" %}}

Následující příklad ukazuje, jak sloučit PRN s HTML v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do HTML. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru HTML. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí PRN do HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení PRN s HTML v C#" InputFormat="prn" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na HTML přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s HTML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení PRN s HTML" %}}
