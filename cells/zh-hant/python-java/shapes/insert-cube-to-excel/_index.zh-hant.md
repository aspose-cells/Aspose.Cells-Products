...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via Java 將 Cube 插入 Excel 檔案的步驟" %}}
...
+ 透過索引選擇工作表。
 + 使用形狀集合[添加方法](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)以在選定的工作表中插入多維資料集。
以 XLSX 格式儲存工作簿。
