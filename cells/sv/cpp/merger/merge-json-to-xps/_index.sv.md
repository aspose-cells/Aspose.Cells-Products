...
description: Aspose Excel. C++ Aspose.Cells. Slå samman JSON till XPS sparaformat. C++ Kombinera JSON till XPS format. Slå samman JSON till XPS i C++. JSON Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman JSON till XPS i C++" %}}
...
{{% cells-merger title="Exempelkod för att slå samman JSON till XPS i C++" InputFormat="json" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
