---
title: Sloučit XLSB s IMAGE – Sloučit XLSB s IMAGE v C#
url: /cs/net/merger/merge-xlsb-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Zdarma online sloučení XLSB do formátu uložení OBRÁZKU. C# Zkombinujte XLSB do formátu IMAGE. Sloučit XLSB do IMAGE v C#. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB s IMAGE v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLSB do IMAGE v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLSB s IMAGE. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru IMAGE. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí XLSB do IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XLSB do IMAGE v C#" InputFormat="xlsb" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB s IMAGE přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit XLSB s IMAGE programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna ke sloučení XLSB do IMAGE" %}}
