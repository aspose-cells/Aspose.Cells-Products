...
{{% blocks/products/pf/agp/content h2="วิธีแยกข้อมูลเมตา XLSM โดยใช้ Java" %}}

 ในการรับข้อมูลเมตาของไฟล์ XLSM เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการดึงข้อมูลเมตาของ XLSM ผ่าน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="แยกข้อมูลเมตาของ XLSM - Java" offSpacer="" %}}
