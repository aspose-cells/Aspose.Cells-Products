---
title: Převést SXC na JPEG přes Java 
url: /cs/java/conversion/sxc-to-jpeg/ 
description: Ukázka převodního kódu Java pro formát SXC na soubor JPEG. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do formátu JPEG v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SXC na JPEG přes Java" h2="Převod SXC na JPEG Java pro převod jedné nebo více stránek na JPEG pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na JPEG pomocí Java" %}}

 K vykreslení SXC do JPEG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod SXC na JPEG prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SXC na JPEG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí Workbook1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Voláním metody SheetRender.toImage uložíte výsledek ve formátu JPEG
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu SXC na JPEG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka převodu SXC na JPEG" sectionDescription="[Převést SXC na JPEG](https://products.aspose.app/cells/conversion/sxc-to-jpeg) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor SXC, bude okamžitě převeden do formátu JPEG." >}}
