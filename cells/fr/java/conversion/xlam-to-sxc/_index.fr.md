---
title: XLAM à SXC - Convertir XLAM à SXC fichiers Java
description: Aspose Excel. Conversion gratuite en ligne du format de sauvegarde XLAM en SXC. Format Java XLAM à SXC. Enregistrez XLAM sous SXC dans Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLAM à SXC dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLAM en SXC en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLAM en SXC. Téléchargez votre fichier XLAM, puis enregistrez-le simplement en tant que fichier SXC. Pour la lecture XLAM et l'écriture SXC, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie SXC seront identiques au document XLAM d'origine.
...
Besoin de convertir les fichiers XLAM en SXC par programmation ? Les développeurs de Java peuvent facilement convertir XLAM en SXC en seulement quelques lignes de code.
