...
description: Aspose Excel. C++ Aspose.Cells. Sloučit PRN do formátu uložení GIF. C++ Zkombinujte PRN do formátu GIF. Sloučit PRN na GIF v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na GIF v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení PRN s GIF v C++" InputFormat="prn" InputFormat2="gif" outformat="gif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
