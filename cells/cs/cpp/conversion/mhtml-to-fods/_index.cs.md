...
Potřebujete převést soubory MHTML na FODS programově? Vývojáři C++ mohou snadno převést MHTML na FODS v několika řádcích kódu.
...
1.  Převeďte MHTML na FODS voláním metody Save().
