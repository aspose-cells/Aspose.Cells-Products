---
title: C# FODS 轉 MHTML - 在線 FODS 轉 MHTML 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 FODS 轉換為 MHTML 保存格式。 C# FODS 到 MHTML 格式。將 FODS 保存為 MHTML C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 C# 中的 MHTML" h2="高速C#庫，用於將FODS轉換為MHTML。這是一個專業的軟件解決方案，可在.NET Framework、.NET Core或Mono平台上導入和導出FODS、MHTML和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線保存 FODS 至 MHTML 於 C#" %}}

以下示例演示如何將 C# 中的 FODS 轉換為 MHTML。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 轉換為 MHTML。上傳您的 FODS 文件，然後只需將其另存為 MHTML 文件。對於 FODS 讀取和 MHTML 寫入，您可以使用完全限定的文件名。輸出 MHTML 內容和格式將與原始 FODS 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 FODS 轉換為 MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="mhtml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 FODS 轉換為 MHTML" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 FODS 文件轉換為 MHTML 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 FODS 到 MHTML。
...
1. 使用工作簿實例加載 FODS 文件。
1. 通過調用 Workbook.Save 方法將 FODS 轉換為 MHTML。
1. 獲取FODS到MHTML的轉換結果。
