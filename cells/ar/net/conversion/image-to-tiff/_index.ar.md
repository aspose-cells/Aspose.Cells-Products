---
title: تحويل C# صورة إلى TIFF - صورة إلى TIFF
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل IMAGE إلى تنسيق TIFF، مما يتيح حفظ بيانات IMAGE بسلاسة في تنسيق TIFF باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في TIFF في C#" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى TIFF في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى TIFF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى TIFF برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى TIFF بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الصورة إلى TIFF عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى TIFF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الصورة إلى TIFF" %}}
