---
title: Mesclar XML com ET - Combine XML com ET em Python
url: /pt/python-java/merger/merge-xml-to-et/ 
description: Aspose Excel. Python Excel. Mesclar XML com formato de salvamento ET. Python Combine XML com formato ET. Mesclar XML com ET na Biblioteca Excel Python. Mesclagem XML.
...
{{% blocks/products/pf/agp/content h2="Mesclar XML com ET usando a biblioteca Python Excel" %}}

 Como faço para mesclar XML com ET? Com a biblioteca Aspose.Cells for Python via Java, você pode facilmente mesclar XML com ET programaticamente com algumas linhas de código.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells) é capaz de construir aplicativos multiplataforma com a capacidade de gerar, modificar, converter, renderizar e imprimir todos os arquivos Excel. Python Excel API não apenas converte formatos de planilha, mas também pode renderizar arquivos Excel como imagens, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT e muito mais, tornando-o a escolha perfeita para troca de documentos em formatos padrão da indústria. Você pode instalar Aspose.Cells for Python via Java de<a href="https://pypi.org/project/aspose-cells/">pypi</a> , use o comando como:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mesclar XML com ET na Biblioteca Excel Python" %}}

O exemplo a seguir demonstra como mesclar XML com ET em Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XML com ET. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os no arquivo ET. Se você desenvolver código em Python, será mais simples do que parece. Veja o exemplo Python que mescla XML com ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemplo de código para mesclar XML com ET na biblioteca Python Excel" InputFormat="xml" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XML com ET por meio da biblioteca Python Excel" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XML com ET programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para mesclar XML com ET" %}}
