---
title: Java IMAGE en TXT - Convertisseur IMAGE en TXT
description: Aspose Exceller. Java Aspose.Cells. IMAGE en TXT dans Java. Java Convertir IMAGE en format de sauvegarde TXT. Java IMAGE au format TXT. Enregistrez l’IMAGE au TXT Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE au TXT dans Java" %}}

L'exemple suivant montre comment convertir IMAGE en TXT en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir IMAGE en TXT. Téléchargez votre fichier IMAGE, puis enregistrez-le simplement sous le nom de fichier TXT. Pour la lecture d'IMAGE et l'écriture de TXT, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie TXT seront identiques au document IMAGE d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir IMAGE en TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="txt" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir une image en TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers IMAGE en TXT par programme ? Les développeurs Java peuvent facilement convertir IMAGE en TXT en quelques lignes de code seulement.
