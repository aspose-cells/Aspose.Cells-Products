---
title: Gabung MHTML ke XLS - Gabungkan MHTML ke XLS di Java
url: /id/java/merger/merge-mhtml-to-xls/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge MHTML to XLS saveformat. Java Gabungkan format MHTML menjadi XLS. Gabung MHTML ke XLS di Java. MHTML Gabung.
...
Contoh berikut menunjukkan cara menggabungkan MHTML ke XLS di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan MHTML ke XLS di Java" InputFormat="mhtml" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML ke XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan MHTML menjadi XLS secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
