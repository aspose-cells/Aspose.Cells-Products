...
description: C# Przykładowy kod do tworzenia wykresów bąbelkowych w programie Excel przy użyciu biblioteki .NET. Użyj tego kodu do utworzenia wykresu {chart} w MS Excel w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
Dynamiczne tworzenie wykresów bąbelkowych w uruchomionej aplikacji jest łatwe. Aby stworzyć różnorodne wykresy do arkuszy kalkulacyjnych od podstaw bez konieczności posiadania pakietu MS Office, użyjemy[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API, który oferuje różne funkcje tworzenia arkuszy kalkulacyjnych, manipulowania nimi i konwersji za pomocą platformy .NET. Aspose.Cells udostępnia wiele elastycznych obiektów wykresów.
...
1.  Używać[**Chart.SetChartDataRange**](https://https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/setchartdatarange) metoda określania źródła danych wykresu.
