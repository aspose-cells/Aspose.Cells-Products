---
title: C++ XLT do HTM - XLT do konwertera HTM
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLT do formatu HTM, umożliwiając bezproblemowe zapisywanie danych XLT w formacie HTM za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C++.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT do HTM w C++" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLT na format HTM w formacie C++.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na HTM za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLT do formatu HTM? Programiści C++ mogą łatwo przekonwertować pliki XLT do formatu HTM za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLT do HTM wywołując metodę Save().
