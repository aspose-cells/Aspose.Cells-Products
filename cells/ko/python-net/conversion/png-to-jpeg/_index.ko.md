---
title: Python PNG ~ JPEG - 온라인 PNG ~ JPEG 변환기
description: Aspose 엑셀. Python Aspose.Cells. Python Aspose Cells. 무료 온라인 Python PNG을 JPEG saveformat으로 변환합니다. Python PNG ~ JPEG 형식. PNG을 JPEG Python로 저장합니다.
...
{{% cells-convert title="온라인에서 PNG을 JPEG로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="PNG을 JPEG로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 PNG 파일을 JPEG로 변환해야 합니까? Python 개발자는 단 몇 줄의 코드로 PNG을 JPEG로 쉽게 로드 및 변환할 수 있습니다.
