---
title: Voeg MHTML samen met PRN - Combineer MHTML met PRN in C++
url: /nl/cpp/merger/merge-mhtml-to-prn/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online samenvoegen MHTML naar PRN-opslagformaat. C++ Combineer MHTML naar PRN-formaat. Samenvoegen MHTML naar PRN in C++. MHTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis MHTML samen met PRN in C++ online" %}}

Het volgende voorbeeld laat zien hoe u MHTML kunt samenvoegen met PRN in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHTML samen te voegen met PRN. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het PRN-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat MHTML samenvoegt met PRN.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML samen te voegen met PRN via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHTML programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om MHTML samen te voegen met PRN" %}}
