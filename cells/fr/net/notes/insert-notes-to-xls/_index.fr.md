---
title: Insérer des notes dans le fichier XLS via .NET
url: /fr/net/notes/insert-notes-to-xls/ 
description: Insérez des notes dans XLS à l'aide de C#. Utilisez l'exemple de code API pour insérer des notes dans l'application .NET.
...
{{% blocks/products/pf/agp/content h2="Insérer des notes dans le fichier XLS en utilisant .NET" %}}
...
{{% blocks/products/pf/agp/content h2="Comment insérer des notes dans le fichier XLS via C#" %}}
...
Dans Office 365, les notes sont destinées aux annotations, vous pouvez utiliser le code C# suivant pour insérer et supprimer des notes dans le fichier XLS.

{{% blocks/products/pf/agp/code-block title="Exemple de code C# pour insérer et supprimer des notes dans le fichier XLS" offSpacer="" %}}
