...
+ Cargue todos los archivos ODS con la ruta completa.
+ Hacer un documento como archivo base
+ Llame al método relevante para concatenar y fusionar archivos uno por uno.
+ Llame al método Save() y pase el nombre del archivo (ruta completa) y el formato (ODS) como parámetro.
+ Ahora puede abrir y usar el archivo ODS en Office Microsoft, Adobe PDF o cualquier otro programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Combinar ODS Archivos - C#" offSpacer="" %}}
