---
title: Java ods Dosyasını Onar - Ücretsiz Online ods Dosyasını Onar
url: /tr/java/recovery/repair-ods/ 
description: Aspose excel. Java Aspose.Cells. Java ods dosyasını onarın. Ücretsiz Çevrimiçi ods onarım aracı. Bozuk bir ods dosyasını onarın. Java uygulamasında bozuk bir ods dosyasını kurtarın.
...
Ods dosyasını programlı olarak onarmanız mı gerekiyor? Java geliştiriciler, ods dosyasını yalnızca birkaç satır kodla kolayca yükleyebilir ve onarabilir.
...
{{% cells-recovery title="Çevrimiçi ODS dosyasını onarmak için Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="java" %}}    
    
{{% blocks/products/pf/agp/content h2="ODS dosyasını onarmak için Java kitaplığı" %}}
