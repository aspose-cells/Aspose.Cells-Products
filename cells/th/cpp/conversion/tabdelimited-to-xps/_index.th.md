---
title: แปลง TABDELIMITED เป็น XPS ผ่าน C++ แอปพลิเคชัน 
url: /th/cpp/conversion/tabdelimited-to-xps/ 
description: ตัวอย่างรหัสการแปลง C++ สำหรับเอกสาร TABDELIMITED เป็นรูปแบบ XPS โปรแกรมเมอร์สามารถใช้ซอร์สโค้ดนี้สำหรับการแปลงชุด TABDELIMITED เป็น XPS ภายในแอปพลิเคชัน C++ ใดๆ
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง TABDELIMITED เป็น XPS ผ่าน C++" h2="ประสิทธิภาพสูง TABDELIMITED เป็นการแปลง XPS โดยใช้ไลบรารี C++ โดยไม่ต้องติดตั้ง Microsoft Excel, OpenOffice หรือ Adobe Acrobat" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง TABDELIMITED เป็น XPS โดยใช้ C++" %}}

 ในการแปลง TABDELIMITED เป็น XPS เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง TABDELIMITED เป็น XPS ผ่าน C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ นักพัฒนาสามารถแปลงไฟล์ TABDELIMITED เป็น XPS ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ TABDELIMITED โดยใช้ Factory::CreateIWorkbook1. เรียกใช้เมธอด Save()1. ส่งพาธไฟล์เอาต์พุตที่มีนามสกุลไฟล์ (XPS)1. ไฟล์ XPS จะถูกบันทึกที่พาธที่ระบุ1. เปิดไฟล์ XPS ในโปรแกรมที่เข้ากันได้
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED เป็น XPS C++ รหัสแหล่งที่มาของการแปลง" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED เพื่อสาธิตการแปลง XPS สด" sectionDescription="[แปลง TABDELIMITED เป็น XPS](https://products.aspose.app/cells/conversion/tabdelimited-to-xps) ตอนนี้โดยไปที่เว็บไซต์ Live Demos ของเรา การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" ไม่จำเป็นต้องดาวน์โหลด Aspose API" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" ไม่ต้องเขียนโค้ดใดๆ" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" เพียงอัปโหลดไฟล์ TABDELIMITED ของคุณ ไฟล์นั้นจะถูกแปลงเป็น XPS ทันที" >}}
