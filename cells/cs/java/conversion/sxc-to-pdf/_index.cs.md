---
title: Převést SXC na PDF přes Java 

description: Ukázka převodního kódu Java pro formát SXC na soubor PDF. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do PDF v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SXC na PDF přes Java" h2="Převod SXC na PDF Java pro převod jedné nebo více stránek do PDF pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC do PDF pomocí Java" %}}

 K vykreslení SXC do PDF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC do PDF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SXC do formátu PDF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Jako parametry předejte výstupní cestu s rozšířením PDF a SaveFormat1. Zkontrolujte zadanou cestu pro výsledný soubor PDF
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu SXC na PDF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka převodu SXC do PDF" sectionDescription="[Převést SXC do PDF](https://products.aspose.app/cells/conversion/sxc-to-pdf) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor SXC, bude okamžitě převeden do PDF." >}}
