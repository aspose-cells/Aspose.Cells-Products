---
title: Scal XLSB z XLAM - Połącz XLSB z XLAM w Python
url: /pl/python-java/merger/merge-xlsb-to-xlam/ 
description: Aspose Excel. Python Excel. Scal format zapisu XLSB z XLAM. Python Połącz format XLSB z XLAM. Połącz numery XLSB z numerami XLAM w bibliotece programu Excel Python. XLSB Połącz.
...
{{% blocks/products/pf/agp/content h2="Scal XLSB z XLAM przy użyciu biblioteki Excel Python" %}}

 Jak połączyć numer XLSB z numerem XLAM? Dzięki bibliotece Aspose.Cells for Python via Java możesz łatwo programowo połączyć XLSB z XLAM za pomocą kilku linii kodu.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells) potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi. Możesz zainstalować Aspose.Cells for Python via Java z<a href="https://pypi.org/project/aspose-cells/">pypi</a> , użyj polecenia jako:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Scal XLSB z XLAM w Python Biblioteka Excel" %}}

Poniższy przykład pokazuje, jak połączyć XLSB z XLAM w Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLSB z XLAM. Prześlij swoje pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku XLAM. Jeśli opracujesz kod w Python, będzie to prostsze niż się wydaje. Zobacz przykład Python, który łączy XLSB z XLAM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia XLSB z XLAM w bibliotece Excel Python" InputFormat="xlsb" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSB z XLAM za pośrednictwem biblioteki Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć XLSB z XLAM? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Python biblioteka do połączenia XLSB z XLAM" %}}
