---
title: C++ OTS a MD - Convertidor OTS a MD
description: Aspose Excel. Convierta OTS a MD rápida y fácilmente con Aspose.Cells. C++ OTS a MD. C++ Guardar OTS en MD. Guarde OTS como MD usando C++.
...
{{% blocks/products/pf/agp/content h2="Guarde OTS en MD en C++" %}}

El siguiente ejemplo demuestra cómo convertir OTS a MD en C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir OTS a MD. Cargue su archivo OTS y luego simplemente guárdelo como archivo MD. Tanto para la lectura OTS como para la escritura MD, puede utilizar nombres de archivos completos. El contenido y el formato del MD de salida serán idénticos al documento OTS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir OTS a MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="md" IsLandingPage="true" language="cpp" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para convertir OTS a MD" %}}
