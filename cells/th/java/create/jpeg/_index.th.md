...
description: Aspose Excel สร้างและจัดการไฟล์ JPEG ได้อย่างง่ายดายด้วยไลบรารี Aspose.Cells for Java เครื่องมืออันทรงพลัง API นี้มอบโซลูชันที่คล่องตัวและมีประสิทธิภาพในการสร้าง แก้ไข และจัดการไฟล์ JPEG โดยตรงภายในแอปพลิเคชัน Java ของคุณ ตอบสนองความต้องการเฉพาะของนักพัฒนาด้วยความแม่นยำสูง
...
1.  บันทึกเวิร์กบุ๊กในรูปแบบ JPEG โดยใช้เมธอด save()
