...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PNG na SVG v C#" h2="Vysokorychlostní knihovna C# pro převod PNG na SVG. Toto je profesionální softwarové řešení pro import a export PNG, SVG a mnoha dalších formátů na platformách .NET Framework, .NET Core nebo Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
1.  Převeďte číslo PNG na SVG voláním metody Workbook.Save.
