---
title: Python XML vers SXC - Convertisseur XML vers SXC
description: Aspose Exceller. Python Exceller. Convertissez XML en SXC rapidement et facilement avec Aspose.Cells. Python XML en SXC. Python Enregistrez XML en SXC. Enregistrez XML en SXC à l'aide de la bibliothèque Excel Python.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en SXC à l\'aide de la bibliothèque Excel Python" %}}

 Comment convertir XML en SXC ? Avec la bibliothèque Aspose.Cells for Python, vous pouvez facilement convertir XML en SXC par programme avec quelques lignes de code.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer XML dans SXC dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment convertir XML en SXC dans la bibliothèque Excel Python.
...
{{% cells-convert title="Exemple de code pour convertir XML en SXC via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="sxc" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XML en SXC via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en SXC par programme ? Les développeurs Python peuvent facilement charger et convertir du XML en SXC en quelques lignes de code seulement.
...
1.  Convertissez XML en SXC en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de XML en SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Bibliothèque Excel pour convertir XML en SXC" %}}
