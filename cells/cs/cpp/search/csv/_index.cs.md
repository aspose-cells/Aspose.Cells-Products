---
title:  Vyhledat dokument CSV bez otevření přes C++
weight: 5540
description: Příklad kódu C++ pro vyhledávání slov se vzorem v souboru CSV v běhovém prostředí C++ pro 32bitové verze Windows, 64bitové verze Windows a 64bitové verze Linuxu.
...
{{< blocks/products/pf/i18n/upper-banner h1="Vyhledávání formátů CSV v C++" h2="Nativní a vysoce výkonné vyhledávání dokumentů CSV pomocí serverových Aspose.Cells for C++ API, bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vyhledat soubor CSV pomocí adresáře C++" %}}

 Pro vyhledání souboru CSV použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vyhledávání souborů CSV v adresáři C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Vyhledávání souborů CSV - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online CSV Vyhledat Živé ukázky" sectionDescription=" Vyhledejte text, slova a fráze v dokumentech s adresou CSV hned teď na našich stránkách[Webová stránka živé ukázky](https://products.aspose.app/cells/search). Živé demo má následující výhody" >}}
 ...
 Soubory s příponou CSV (hodnoty oddělené čárkou) představují soubory ve formátu prostého textu, které obsahují záznamy dat s hodnotami oddělenými čárkou. Každý řádek v souboru CSV je nový záznam ze sady záznamů obsažených v souboru. Takové soubory se generují, když je zamýšlen přenos dat z jednoho úložného systému do druhého. Protože všechny aplikace dokáží rozpoznat záznamy oddělené čárkou, import takových datových souborů do databáze se provádí velmi pohodlně. Téměř všechny tabulkové aplikace, jako například Microsoft Excel nebo OpenOffice Calc, dokáží importovat CSV bez větší námahy. Data importovaná z takových souborů jsou uspořádána do buněk tabulky pro zobrazení uživateli.
