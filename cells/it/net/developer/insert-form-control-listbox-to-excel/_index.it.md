...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire ListBox nel file Excel tramite C#" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addlistbox) per inserire un ListBox nel foglio di lavoro selezionato
