...
description: Aspose Excel. C# Aspose.Cells. JPEG to TIFF in C#. C# Convert JPEG to TIFF saveformat. C# JPEG to TIFF format. Save JPEG to TIFF C#.
keywords: [Aspose Excel., C# Aspose.Cells., JPEG to TIFF in C#., C# JPEG to TIFF saveformat., JPEG to TIFF C#., C# Convert JPEG to TIFF]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert JPEG to TIFF in C#" h2="High-speed C# library for converting JPEG to TIFF. This is a professional software solution to import and export JPEG, TIFF, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="Save JPEG to TIFF in C#" %}}
...
{{% cells-convert title="Sample Code to Convert JPEG to TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="tiff" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert JPEG to TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert JPEG files to TIFF programmatically? .NET developers can easily load & convert JPEG to TIFF in just a few lines of code.
