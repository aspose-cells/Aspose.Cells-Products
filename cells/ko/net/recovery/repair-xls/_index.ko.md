---
title: C# xls 복구 - 손상된 xls 파일 복구 및 수정
url: /ko/net/recovery/repair-xls/ 
description: C# Aspose.Cells. xls를 수리하세요. xls 파일을 수정하세요. xls 복구 도구. xls 손상. xls 데이터를 복원합니다. xls 파일 복구. 손상된 xls 파일을 복구하세요.
...
프로그래밍 방식으로 xls 파일을 복구해야 합니까? .NET 개발자는 단 몇 줄의 코드만으로 xls 파일을 쉽게 로드하고 복구할 수 있습니다.
...
{{% cells-recovery title="XLS 파일을 복구하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="net" %}}    
    
{{% blocks/products/pf/agp/content h2=".NET XLS 파일을 복구하는 라이브러리" %}}
