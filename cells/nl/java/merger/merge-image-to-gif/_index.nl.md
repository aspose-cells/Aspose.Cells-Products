---
title: Voeg AFBEELDING samen met GIF - Combineer AFBEELDING met GIF in Java
url: /nl/java/merger/merge-image-to-gif/ 
description: Aspose Excel. Java Aspose.Cells. IMAGE samenvoegen naar GIF opslagformaat. Java Combineer BEELD naar GIF-formaat. Voeg AFBEELDING samen tot GIF in Java. AFBEELDING Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg AFBEELDING samen met GIF in Java" %}}

Het volgende voorbeeld laat zien hoe u IMAGE samenvoegt met GIF in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om IMAGE samen te voegen tot GIF. Upload uw bestanden, bel de Workbook.Combine-methode voor het samenvoegen van bestanden en sla het vervolgens op in het bestand GIF. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie het voorbeeld Java waarin IMAGE wordt samengevoegd met GIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om AFBEELDING samen te voegen met GIF in Java" InputFormat="png" InputFormat2="gif" outformat="gif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u AFBEELDING samenvoegt met GIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u IMAGE programmatisch samenvoegen met GIF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om IMAGE samen te voegen met GIF" %}}
