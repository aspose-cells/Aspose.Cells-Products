...
description: Aspose Excel. Java Aspose.Cells. Połącz MHT z formatem zapisu EXCEL. Java Połącz format MHT z formatem EXCEL. Połącz MHT z EXCEL w Java. Połącz MHT.
...
{{% blocks/products/pf/agp/content h2="Połącz MHT z EXCEL w Java" %}}

Poniższy przykład pokazuje, jak połączyć MHT z EXCEL w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć MHT z EXCEL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku EXCEL. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy MHT z EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia MHT z EXCEL w Java" InputFormat="mht" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć MHT z EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć MHT z EXCEL? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do łączenia MHT z EXCEL" %}}
