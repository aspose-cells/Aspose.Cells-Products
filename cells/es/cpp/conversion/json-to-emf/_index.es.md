---
title: Convierta JSON a EMF a través de la aplicación C++ 
url: /es/cpp/conversion/json-to-emf/ 
description: Ejemplo de código de conversión C++ para documento JSON a formato EMF. Los programadores pueden usar este código fuente para la conversión por lotes de JSON a EMF dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo JSON a EMF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo JSON usando Factory::CreateIWorkbook.1. Seleccione la primera hoja de trabajo.1. Establecer opciones (EMF).1. Iterar a través de cada página de la hoja y renderizar.1. Abra el archivo EMF en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de JSON a EMF C++" offSpacer="" %}}
