...
{{% blocks/products/pf/agp/content h2="MHTML-bestanden samenvoegen met Java" %}}

 Om het MHTML-bestand samen te voegen, gebruiken we
...
+ Laad het eerste MHTML-bestand met een instantie van de Workbook-klasse.
+ Laad het tweede MHTML-document met een instantie van de Workbook-klasse.
+ Voeg bestanden samen met de combine()-methode.
+ sla het samengevoegde MHTML-bestand op het opgegeven pad op
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API kan worden gebruikt voor het maken, bewerken, converteren en weergeven van Microsoft Excel-indelingen naar verschillende indelingen. Bovendien kan het worden gebruikt voor uitgebreide grafieken, schaalbare rapportage en betrouwbare berekeningen binnen softwaretoepassingen. Aspose.Cells is een zelfstandige API en vereist geen software zoals Microsoft of OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online MHTML Fusie Live-demo\'s" sectionDescription="Voeg nu MHTML-documenten samen door naar onze [Live demo\'s website](https://products.aspose.app/cells/merger). De live demo heeft de volgende voordelen:" >}}
