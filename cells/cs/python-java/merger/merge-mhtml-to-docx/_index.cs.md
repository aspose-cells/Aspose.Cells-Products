---
title:  Sloučit MHTML na DOCX přes Python
url: /cs/python-java/merger/merge-mhtml-to-docx/ 
description: Sloučit MHTML až DOCX online zdarma. Online zdarma MHTML až DOCX Fúze. Sloučit MHTML do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit MHTML až DOCX v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHTML až DOCX online" InputFormat="mhtml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
