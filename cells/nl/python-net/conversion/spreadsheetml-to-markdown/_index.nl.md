...
In het volgende voorbeeld ziet u hoe u SPREADSHEETML converteert naar MARKDOWN in Python via NET.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML converteren naar MARKDOWN" %}}
