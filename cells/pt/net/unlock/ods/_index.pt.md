---
title:  Desbloquear documento ODS via .NET
weight: 3110
description: Código-fonte C# para desbloquear o arquivo ODS protegido por senha nas plataformas .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/content h2="Como desbloquear o arquivo ODS usando C#" %}}
 ...
 Para remover a proteção do arquivo ODS, usaremos
