...
description: Aspose Excel. Converteer XLTM snel en eenvoudig naar DIF met Aspose.Cells. Python XLTM naar DIF. Python Bewaar XLTM in DIF. Bewaar XLTM als 07611134 81 via Python.
...
{{% blocks/products/pf/agp/content h2="Converteer XLTM naar DIF in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLTM t/m DIF in Python" %}}

Het volgende voorbeeld laat zien hoe u XLTM converteert naar DIF in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLTM naar DIF te converteren" %}}
