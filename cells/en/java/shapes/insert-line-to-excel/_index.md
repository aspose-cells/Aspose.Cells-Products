---
title: Insert Line into Excel via Java 
weight: 30
...
{{% blocks/products/pf/agp/content h2="How to Insert Line into Excel File Using Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Line to Excel file via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) to insert Line in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert Line - Java" offSpacer="" %}}
