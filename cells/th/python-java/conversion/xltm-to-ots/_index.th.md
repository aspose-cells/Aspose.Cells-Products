...
description: Aspose เอ็กเซล. Python เอ็กเซล. แปลง XLTM เป็น OTS อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Python XLTM เป็น OTS Python บันทึก XLTM ไปที่ โอทีเอส. บันทึก XLTM เป็น OTS โดยใช้ Python Excel Library
