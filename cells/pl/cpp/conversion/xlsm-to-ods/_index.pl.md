---
title: Konwertuj XLSM na ODS za pomocą aplikacji C++ 

description: Przykładowy kod konwersji C++ dla dokumentu XLSM do formatu ODS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSM do ODS w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSM na ODS przez C++" h2="Wysokowydajna konwersja XLSM do ODS przy użyciu biblioteki C++ bez konieczności instalowania Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSM na ODS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (ODS).1. Plik ODS zostanie zapisany pod określoną ścieżką.1. Otwórz plik ODS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSM do ODS C++ Kod źródłowy konwersji" offSpacer="" %}}
