---
title: PHP XLSM ～ XLAM - XLSM ～ XLAM コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XLSM を XLAM にすばやく簡単に変換します。PHP XLSM から XLAM。PHP XLSM から XLAM に保存します。PHP を使用して、XLSM を XLAM として保存します。
...
{{% blocks/products/pf/agp/content h2="PHP 経由で XLSM を XLAM に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSM ファイルをプログラムで XLAM に変換する必要がありますか? PHP 開発者は、わずか数行のコードで XLSM を簡単にロードして XLAM に変換できます。
