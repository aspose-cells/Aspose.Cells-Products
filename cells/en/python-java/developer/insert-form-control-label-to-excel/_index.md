---
title: Insert Label(Form control) into Excel using Python via java 
weight: 80

description: Python via java source code to insert Label(Form control) into Excel.
...
{{% blocks/products/pf/agp/content h2="How to Insert Label(Form control) into Excel File Using Python via java" %}}

 In order to insert Label(Form control) into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Label(Form control) to Excel file using Python via java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLabel(int,%20int,%20int,%20int,%20int,%20int)) to insert a Label(Form control) in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert Label(Form control) - Python via java" offSpacer="" %}}
