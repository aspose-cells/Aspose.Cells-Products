...
description: Aspose Excel. Konwertuj XML na WORD szybko i łatwo za pomocą Aspose.Cells. C# XML na WORD. C# Zapisz XML na WORD. Zapisz XML jako WORD używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem WORD w C#" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na WORD w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="docx" IsLandingPage="true" %}}
...
1.  Konwertuj kod XML na WORD, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XML na WORD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XML na WORD" %}}
