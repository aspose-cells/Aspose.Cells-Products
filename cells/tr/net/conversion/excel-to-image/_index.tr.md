...
EXCEL dosyalarını program aracılığıyla IMAGE'a dönüştürmeniz mi gerekiyor? .NET geliştiriciler yalnızca birkaç satır kodla EXCEL'i kolayca yükleyebilir ve IMAGE'a dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını IMAGE dosyasına dönüştürün.
