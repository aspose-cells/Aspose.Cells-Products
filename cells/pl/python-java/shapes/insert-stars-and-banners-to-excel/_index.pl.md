---
title: Wstaw gwiazdkę/baner do Excela, używając Python via Java
weight: 381
description: Python via Java kod źródłowy do wstawiania gwiazdki/banera do programu Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw gwiazdkę/baner do Excela, używając Python via Java" h2="Wstaw gwiazdkę/baner za pomocą Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić gwiazdę/baner do pliku programu Excel za pomocą Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić gwiazdę/baner do pliku programu Excel przy użyciu Python via Java" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), aby wstawić gwiazdkę/sztandar w wybranym arkuszu
...
Poniższy przykładowy kod pokazuje, jak wstawić „math plus”. Więcej typów można znaleźć w sekcji „Przegląd typów gwiazd i banerów” poniżej.

{{% blocks/products/pf/agp/code-block title="Wstaw gwiazdę/baner — Python via Java" offSpacer="" %}}
