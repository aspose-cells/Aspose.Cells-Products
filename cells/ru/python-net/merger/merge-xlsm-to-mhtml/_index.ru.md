...
description: Aspose Эксель. Python Aspose.Cells. Объедините XLSM и MHTML в формате сохранения. Python Объедините форматы XLSM и MHTML. Объедините XLSM и MHTML в Python. XLSM Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM с MHTML, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM и MHTML в Python." %}}

В следующем примере показано, как объединить XLSM и MHTML в Aspose.Cells for Python via .NET.
