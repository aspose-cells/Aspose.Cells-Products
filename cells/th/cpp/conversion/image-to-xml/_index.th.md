...
description: Aspose เอ็กเซล. แปลง IMAGE เป็น XML อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ IMAGE เป็น XML C++ บันทึกภาพเป็น XML บันทึก IMAGE เป็น XML โดยใช้ C++
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง IMAGE เป็น XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xml" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง IMAGE เป็น XML โดยการเรียกเมธอด Save()
