...
Нужно программно преобразовать XML-файлы в формат XLSM? Разработчики, использующие формат C++, могут легко преобразовать XML в формат XLSM всего несколькими строками кода.
...
1.  Преобразовать XML в формат XLSM, вызвав метод Save().
