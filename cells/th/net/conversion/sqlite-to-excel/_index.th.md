---
title: C# SQLite เป็น EXCEL - ตัวแปลง SQLite เป็น EXCEL
description: Aspose เอ็กเซล. แปลง SQLite เป็น EXCEL อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C# SQLite เป็น EXCEL C# บันทึก SQLite ไปยัง EXCEL บันทึก SQLite เป็น EXCEL โดยใช้ C#
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง SQLite เป็น EXCEL ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการแปลงข้อมูล SQLite เป็น EXCEL โดยทางโปรแกรมหรือไม่ นักพัฒนา .NET สามารถโหลดและแปลง SQLite เป็น EXCEL ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1.  ติดตั้ง 'Aspose.Cells for .NET'.
1.  เพิ่มการอ้างอิงไลบรารี (นำเข้าไลบรารี) ให้กับโครงการ C# ของคุณ
1.  ค้นหาข้อมูลจากฐานข้อมูล SQLite เพื่อรับวัตถุ DataTable
1.  สร้างสมุดงานใหม่และนำเข้าข้อมูลจากวัตถุ DataTable
1. บันทึกข้อมูลในรูปแบบ xlsx โดยเรียกเมธอด Workbook.Save

{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างในการแปลง SQLite เป็น EXCEL - C#" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="ไลบรารี C# เพื่อแปลง SQLite เป็น EXCEL" %}}
