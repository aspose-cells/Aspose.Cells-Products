...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 TXT 转换为 TABDELIMITED。PHP TXT 到 TABDELIMITED。 PHP 将 TXT 保存为制表符。使用 PHP 将 TXT 保存为 TABDELIMITED。
...
{{% blocks/products/pf/agp/content h2="如何通过 PHP 将 TXT 转换为 TABDELIMITED" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 TXT 文件转换为 TABDELIMITED 吗？ PHP 开发人员只需几行代码即可轻松加载 TXT 并将其转换为 TABDELIMITED。
...
1. 使用工作簿实例加载 TXT 文件。
1. 通过调用Workbook的save方法将TXT转换为TABDELIMITED。
1. 获取 TXT 到 TABDELIMITED 的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP 库将 TXT 转换为 TABDELIMITED" %}}
