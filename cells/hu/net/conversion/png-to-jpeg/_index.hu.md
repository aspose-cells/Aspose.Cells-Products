...
description: Aspose Excel. A PNG-es számot JPEG-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# PNG-JPEG-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a PNG-JPEG számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a PNG-et JPEG-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a PNG JPEG-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A PNG konvertálása JPEG-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A PNG fájlt programozottan JPEG-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a PNG-et JPEG-re.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a PNG konvertálásához JPEG-re" %}}
