---
title:  Fusionner XLTX Fichiers via .NET
weight: 1220
description: C# code source pour combiner XLTX documents sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats XLTX dans C#" h2="Fusion de documents XLTX native et hautes performances à l\'aide d\'API côté serveur Aspose.Cells for .NET, sans l\'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="En ligne XLTX Démos en direct sur la fusion" sectionDescription=" Fusionnez XLTX documents dès maintenant en visitant notre[Site Web de démos en direct](https://products.aspose.app/cells/merger). La démo en direct présente les avantages suivants" >}}
