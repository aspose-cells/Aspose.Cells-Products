---
title: Conversor PHP TSV para FODS - TSV para FODS
description: Aspose Excel. Converta TSV em FODS de forma rápida e fácil com Aspose.Cells. PHP TSV em FODS. PHP Salve TSV em FODS. Salve TSV como FODS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter TSV em FODS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em FODS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em FODS em apenas algumas linhas de código.
...
1.  Converta TSV em FODS chamando o método save da pasta de trabalho.
