---
title: Konvertieren Sie XLT in XLS über die Anwendung C++ 
url: /de/cpp/conversion/xlt-to-xls/ 
description: Beispiel-Umwandlungscode C++ für das XLT-Dokument in das XLS-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von XLT in XLS in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLT in XLS über C++" h2="Leistungsstarke XLT-zu-XLS-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können XLT-Dateien in nur wenigen Codezeilen einfach in XLS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die XLT-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (XLS).1. Die XLS-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die XLS-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="XLT-zu-XLS-C++-Umwandlungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLT-zu-XLS-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie XLT in XLS](https://products.aspose.app/cells/conversion/xlt-to-xls) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre XLT-Datei hoch, sie wird sofort in XLS konvertiert." >}}
