...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شكل سهم منحني في ملف Excel باستخدام Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج شكل سهم منحني في ملف Excel باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم الشكل[طريقة الإضافة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج شكل سهم منحني في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل شكل سهم منحني - Python via Java" offSpacer="" %}}
