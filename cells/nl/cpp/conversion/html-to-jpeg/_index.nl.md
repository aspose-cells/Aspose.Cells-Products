...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-ontwikkelaars kunnen eenvoudig HTML converteren naar JPEG in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het bestand HTML met Factory::CreateIWorkbook.
1. Converteer HTML naar JPEG door de methode Save() aan te roepen.
