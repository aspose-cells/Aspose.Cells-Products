---
title:  Hợp nhất các tập tin MHTML via .NET
weight: 2610
description: C# để kết hợp các tài liệu MHTML trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng MHTML trong C#" h2="Hợp nhất tài liệu gốc và hiệu suất cao MHTML bằng cách sử dụng API Aspose.Cells for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để hợp nhất các tệp MHTML trong C#" %}}
...
+ Tải toàn bộ file MHTML đầy đủ đường dẫn.
+ Tạo một tài liệu làm tệp cơ sở
+ Gọi phương thức liên quan để nối và hợp nhất từng tệp một.
+ Gọi phương thức Save() và truyền tên tệp (đường dẫn đầy đủ) và định dạng (MHTML) làm tham số.
+ Bây giờ bạn có thể mở và sử dụng tệp MHTML trong Microsoft Office, Adobe PDF hoặc bất kỳ chương trình tương thích nào khác.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp MHTML - C#" offSpacer="" %}}
