---
title: TABDELIMITED को Java के ज़रिए PNG में बदलें 
url: /hi/java/conversion/tabdelimited-to-png/ 
description: TABDELIMITED प्रारूप के लिए PNG फ़ाइल में नमूना Java रूपांतरण कोड। प्रोग्रामर इस उदाहरण कोड का उपयोग किसी भी वेब या डेस्कटॉप Java आधारित एप्लिकेशन के भीतर एक्सेल और ओपनऑफिस स्प्रेडशीट को पीएनजी में निर्यात करने के लिए कर सकते हैं।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED को Java के ज़रिए PNG में बदलें" h2="ऑन-प्रिमाइसेस Java लाइब्रेरी का उपयोग करके एकल या एकाधिक पृष्ठों को पीएनजी में कनवर्ट करने के लिए TABDELIMITED से PNG Java रूपांतरण।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके TABDELIMITED को PNG में कैसे बदलें" %}}

 TABDELIMITED को PNG में रेंडर करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="TABDELIMITED को Java के माध्यम से PNG में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Java डेवलपर कोड की कुछ ही पंक्तियों में आसानी से TABDELIMITED फ़ाइल को PNG में बदल सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. कार्यपुस्तिका के उदाहरण के साथ TABDELIMITED फ़ाइल लोड करें1. संग्रह से डिफ़ॉल्ट या किसी वर्कशीट का चयन करें1. ImageOrPrintOptions का ऑब्जेक्ट बनाएं और सेट करें1. वर्कशीट और इमेजऑरप्रिंटऑप्शन ऑब्जेक्ट्स के साथ शीटरेंडर बनाएं1. PNG फॉर्मेट में रिजल्ट सेव करने के लिए SheetRender.toImage मेथड को कॉल करें
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED से PNG Java रूपांतरण स्रोत कोड" offSpacer="" %}}
