---
title: Insert ScrollBar(Form control) into Excel using Python via java 
weight: 90

description: Python via java source code to insert ScrollBar(Form control) into Excel.
...
{{% blocks/products/pf/agp/content h2="How to Insert ScrollBar(Form control) into Excel File Using Python via java" %}}

 In order to insert ScrollBar(Form control) into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert ScrollBar(Form control) to Excel file using Python via java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addScrollBar(int,%20int,%20int,%20int,%20int,%20int)) to insert a ScrollBar(Form control) in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert ScrollBar(Form control) - Python via java" offSpacer="" %}}
