...
url: /nl/python-java/merger/merge-xls-to-jpg/ 
...
Het volgende voorbeeld laat zien hoe u XLS kunt samenvoegen met JPG in Aspose.Cells for Python via Java.
...
Wilt u XLS programmatisch samenvoegen met JPG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
