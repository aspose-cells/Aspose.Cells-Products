...
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C++ fejlesztők számára a XLTX SQL formátumba konvertálásához, lehetővé téve a XLTX adatok zökkenőmentes mentését SQL formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható C++ kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLTX-et SQL-be a C++-ben" %}}

A következő példa bemutatja, hogyan lehet a XLTX-et SQL-lé konvertálni a C++-ben.
...
Programozottan kell SQL-lé konvertálni a XLTX fájlokat? A C++ fejlesztők könnyedén konvertálhatják a XLTX fájlokat SQL-lé mindössze néhány sornyi kóddal.
...
1.  Alakítsd át a XLTX-et SQL-lé a Save() metódus meghívásával.
1.  Szerezze le a XLTX konverziós eredményt SQL-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ könyvtár a XLTX SQL-re konvertálásához" %}}
