...
url: /cs/net/merger/merge-image-to-xlsx/ 
...
Následující příklad ukazuje, jak sloučit IMAGE s XLSX v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit IMAGE s XLSX programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení IMAGE do XLSX" %}}
