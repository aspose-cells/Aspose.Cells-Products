...
description: Aspose Excel. Python Aspose.Cells. Mesclar HTML para salvar o formato OTS. Python Combine HTML para o formato OTS. Mesclar HTML com OTS em Python. HTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com OTS usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com OTS em Python" %}}
...
{{% cells-merger title="Exemplo de código para mesclar HTML com OTS em Python" InputFormat="html" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar HTML com OTS via Python" %}}
