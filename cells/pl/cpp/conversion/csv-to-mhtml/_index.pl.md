---
title: Konwertuj CSV na MHTML za pomocą aplikacji C++ 
weight: 5890
url: /pl/cpp/conversion/csv-to-mhtml/ 
description: Przykładowy kod konwersji C++ dla dokumentu CSV do formatu MHTML. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji plików CSV na MHTML w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj CSV na MHTML przez C++" h2="Wydajna konwersja CSV do MHTML przy użyciu biblioteki C++ bez konieczności instalowania Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować CSV na MHTML za pomocą C++" %}}
 ...
 Aby przekonwertować CSV na MHTML, użyjemy
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik CSV na MHTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (MHTML).1. Plik MHTML zostanie zapisany pod określoną ścieżką.1. Otwórz plik MHTML w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji CSV do MHTML C++" offSpacer="" %}}
