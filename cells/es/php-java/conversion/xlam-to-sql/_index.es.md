---
title: PHP XLAM a SQL - Convertidor de XLAM a SQL
description: Aspose Excel. Convierta XLAM a SQL rápida y fácilmente con Aspose.Cells. PHP XLAM a SQL. PHP Guarde XLAM en SQL. Guarde XLAM como SQL usando PHP.
...
{{% cells-convert title="Código de muestra para convertir XLAM a SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="sql" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XLAM a SQL mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLAM a SQL mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente XLAM a SQL en tan solo unas pocas líneas de código.
...
1.  Convierta XLAM a SQL llamando al método guardar del libro de trabajo.
