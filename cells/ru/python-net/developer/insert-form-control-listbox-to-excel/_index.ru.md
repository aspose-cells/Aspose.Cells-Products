...
{{% blocks/products/pf/agp/content h2="Как вставить ListBox (элемент управления формой) в файл Excel с помощью Python via.Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_list_box/#int-int-int-int-int-int) чтобы вставить ListBox (элемент управления формой) на выбранный лист.
