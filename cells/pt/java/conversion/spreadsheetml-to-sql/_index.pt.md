---
title:  Converter PLANILHA para SQL Java
description: Converta SPREADSHEETML para SQL Online gratuitamente. Conversor de SPREADSHEETML para SQL gratuito online. Java PLANILHAML para SQL. PLANILHA para SQL via Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter PLANILHA para SQL via Java" h2="Conversão de SPREADSHEETML para SQL Java para converter uma ou várias páginas em SQL usando a biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
Siga as etapas fáceis para converter SPREADSHEETML em SQL. Carregue seu arquivo SPREADSHEETML e simplesmente salve-o como arquivo SQL. Tanto para leitura SPREADSHEETML quanto para escrita SQL, você pode usar nomes de arquivos totalmente qualificados. O conteúdo SQL de saída e a formatação serão idênticos ao documento SPREADSHEETML original.
...
Java desenvolvedores podem facilmente converter SPREADSHEETML para SQL em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Carregar arquivo SPREADSHEETML com uma instância da classe Workbook
1.  Converter SPREADSHEETML em SQL chamando o método Workbook.save
