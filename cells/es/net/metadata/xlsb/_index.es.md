---
title:  Ver o editar XLSB Metadatos de archivos via .NET
weight: 7890
description: C# código fuente para editar o ver metadatos de formato XLSB en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraer XLSB Metadatos via .NET" h2="Cree sus propias aplicaciones .NET para agregar, editar, eliminar o extraer metadatos de archivos XLSB utilizando las API del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
+ Cargar XLSB con una instancia de Workbook
