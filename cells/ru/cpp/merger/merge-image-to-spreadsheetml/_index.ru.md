---
title: Объединить IMAGE в SPREADSHEETML — объединить IMAGE в SPREADSHEETML в C++.
url: /ru/cpp/merger/merge-image-to-spreadsheetml/ 
description: Aspose Эксель. C++ Aspose.Cells. Объедините ИЗОБРАЖЕНИЕ в формат сохранения SPREADSHEETML. C++ Объедините ИЗОБРАЖЕНИЕ в формат SPREADSHEETML. Объедините IMAGE с SPREADSHEETML в C++. IMAGE Merge.
...
{{% blocks/products/pf/agp/content h2="Объедините ИЗОБРАЖЕНИЕ в SPREADSHEETML в номере C++." %}}

В следующем примере показано, как объединить IMAGE с SPREADSHEETML в Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить IMAGE с SPREADSHEETML. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл SPREADSHEETML. Если вы разработаете код C++, это будет проще, чем кажется. См. пример C++, в котором IMAGE объединяется с SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения IMAGE с SPREADSHEETML в C++" InputFormat="png" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как объединить ИЗОБРАЖЕНИЕ в SPREADSHEETML по номеру C++" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить IMAGE с SPREADSHEETML? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="C++ библиотека для объединения IMAGE с SPREADSHEETML" %}}
