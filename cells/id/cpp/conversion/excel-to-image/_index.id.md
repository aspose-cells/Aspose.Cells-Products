...
description: Aspose Unggul. Konversi EXCEL ke IMAGE dengan cepat dan mudah dengan Aspose.Cells. C++ EXCEL ke IMAGE. C++ Simpan EXCEL ke GAMBAR. Simpan EXCEL sebagai IMAGE menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah EXCEL menjadi IMAGE Menggunakan C++" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan EXCEL ke IMAGE di C++" %}}

Contoh berikut menunjukkan cara mengonversi EXCEL ke IMAGE di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi EXCEL ke IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="png" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert EXCEL ke IMAGE lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke IMAGE secara terprogram? Pengembang C++ dapat dengan mudah mengonversi EXCEL ke IMAGE hanya dalam beberapa baris kode.
...
1.  Konversikan EXCEL ke IMAGE dengan memanggil metode Save().
1.  Dapatkan hasil konversi EXCEL ke IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengkonversi EXCEL ke IMAGE" %}}
