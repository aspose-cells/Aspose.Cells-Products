...
weight: 7690
description: C# 피벗 테이블을 사용하여 XLS 문서를 생성하기 위한 샘플 코드입니다. 이 코드를 사용하여 VB.NET, Asp.NET 또는 .NET 기반 응용 프로그램 내에서 PivotTable로 Micorsoft Excel XLS 파일을 생성합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 XLS 문서에 피벗 테이블 삽입" h2="기본 및 고성능 Microsoft Excel XLS 서버 측 API를 사용하여 프로그래밍 방식으로 피벗 테이블을 생성하는 스프레드시트 .NET" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 실행 중인 응용 프로그램 내에서 동적으로 피벗 테이블을 사용하여 MS Excel XLS 파일을 생성하는 것은 쉽습니다. MS Office 없이 처음부터 피벗 테이블을 사용하여 XLS 문서를 만들기 위해 다음을 사용합니다.
...
개발자는 단 몇 줄의 코드로 데이터 처리를 위한 다양한 보고 응용 프로그램을 실행하는 동안 XLS 형식 스프레드시트에 피벗 테이블을 쉽게 삽입할 수 있습니다.
...
Excel 스프레드시트 프로그래밍 라이브러리는 Excel XLS 파일을 생성, 수정, 변환, 렌더링 및 인쇄할 수 있는 기능으로 플랫폼 간 응용 프로그램을 구축할 수 있습니다. .NET Excel API은 스프레드시트 형식 간에 변환할 뿐만 아니라 Excel 파일을 이미지, PDF, HTML, ODS 등으로 렌더링할 수 있으므로 업계 표준 형식으로 문서를 교환하는 데 완벽한 선택입니다.
