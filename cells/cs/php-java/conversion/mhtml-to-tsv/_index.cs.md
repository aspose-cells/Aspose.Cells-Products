---
title: Konvertor PHP MHTML až TSV - MHTML až TSV
description: Aspose Excel. Převeďte MHTML na TSV rychle a snadno pomocí Aspose.Cells. PHP MHTML na TSV. PHP Uložte MHTML na TSV. Uložte TSV jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na TSV přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na TSV programově? Vývojáři PHP mohou snadno načíst a převést MHTML na TSV v několika řádcích kódu.
...
1.  Převeďte MHTML na TSV voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na TSV" %}}
