---
title: Python HTML 转 ET - HTML 转 ET 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 HTML 转换为 ET。Python HTML 转换为 ET。 Python 将 HTML 保存到 ET。使用 Python 将 HTML 保存为 ET。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 HTML 转换为 Python 中的 ET" h2="用于将 HTML 转换为 ET 的高速 Python 库。这是一个专业的软件解决方案，可以使用Python导入和导出HTML、ET和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何将 HTML 转换为 ET？借助 Aspose.Cells for Python 库，您可以通过几行代码以编程方式轻松将 HTML 转换为 ET。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Python Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="将 HTML 保存到 Python 中的 ET" %}}
...
{{% cells-convert title="将 HTML 转换为 ET 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="et" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 Python 将 HTML 转换为 ET" %}}
