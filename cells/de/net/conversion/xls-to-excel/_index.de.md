---
title: Konvertieren Sie XLS in EXCEL C#
description: Konvertieren Sie XLS kostenlos online in EXCEL. Kostenloser Online-Konverter von XLS zu Excel. C# XLS bis Excel. XLS an Excel über C#.
keywords: Convert XLS, XLS Converter, XLS to PDF, XLS to Word, XLS to PPT, XLS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLS über C# in EXCEL" h2="Hochgeschwindigkeitsbibliothek C# zum Konvertieren von XLS in Excel. Exportieren Sie Excel-Tabellen in das Excel-Format auf den Plattformen .NET Framework, .NET Core oder Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können XLS in nur wenigen Codezeilen problemlos laden und in Excel konvertieren.
