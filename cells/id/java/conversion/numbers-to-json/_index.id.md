---
title: Java ANGKA ke JSON - Konverter ANGKA ke JSON
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi NUMBERS ke format JSON, memungkinkan penyimpanan data NUMBERS ke format JSON dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan ANGKA ke JSON di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi NUMBERS ke JSON. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor NUMBERS, JSON, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan NOMOR ke JSON di Java" %}}

Contoh berikut menunjukkan cara mengkonversi ANGKA menjadi JSON di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi ANGKA menjadi JSON. Unggah file ANGKA Anda, lalu simpan sebagai file JSON. Untuk pembacaan ANGKA dan penulisan JSON Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran JSON akan sama dengan dokumen NUMBER asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi ANGKA menjadi JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi Angka ke JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file NUMBERS ke JSON secara terprogram? Pengembang Java dapat dengan mudah mengkonversi NUMBERS ke JSON hanya dengan beberapa baris kode.
...
1.  Dapatkan hasil konversi ANGKA menjadi JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi ANGKA menjadi JSON" %}}
{{% blocks/products/pf/agp/text %}}
