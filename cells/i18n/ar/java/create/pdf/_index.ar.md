---
title: إنشاء ملفات PDF عبر Java 
url: /ar/java/create-pdf/ 
description: Java نموذج كود لإنشاء مستندات PDF. استخدم هذا الرمز لإنشاء ملفات PDF داخل تطبيق ويب أو سطح مكتب يستند إلى Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء مستندات PDF عبر Java" h2="إنشاء PDF أصلي وعالي الأداء (تنسيق مستند محمول) برمجيًا باستخدام مكتبة Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية إنشاء ملف PDF عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح رمز المصدر التالي كيفية إنشاء ملف PDF باستخدام Java." offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 مكتبة برمجة جداول بيانات Excel قادرة على بناء تطبيقات عبر الأنظمة الأساسية مع القدرة على إنشاء ملفات PDF وتعديلها وتحويلها وعرضها وطباعتها. لا يقوم برنامج Java Excel API بالتحويل بين تنسيقات جداول البيانات فحسب ، بل يمكنه أيضًا عرض ملفات Excel كصور و PDF و HTML و ODS والمزيد ، مما يجعله خيارًا مثاليًا لتبادل المستندات بتنسيقات متوافقة مع معايير الصناعة.
