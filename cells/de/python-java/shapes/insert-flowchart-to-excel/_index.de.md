...
{{% blocks/products/pf/agp/content h2="So fügen Sie mit Python via Java ein Flussdiagramm in eine Excel-Datei ein bzw. erstellen es" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Einfügen/Erstellen einer FlowChart-zu-Excel-Datei mit Python via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Einfügen/Erstellen eines Flussdiagramms – Python via Java" offSpacer="" %}}
