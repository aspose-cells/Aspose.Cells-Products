---
title: Konvertálja az XLT-t TXT-vé a C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/xlt-to-txt/ 
description: Minta C++ konverziós kód az XLT dokumentumhoz TXT formátumba. A programozók ezt a forráskódot használhatják az XLT-ből TXT-be kötegelt konvertáláshoz bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLT konvertálása TXT-re a következőn keresztül: C++" h2="Nagy teljesítményű XLT–TXT konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatnak XLT fájlt TXT formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLT fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (TXT) fájlkiterjesztéssel.1. A TXT fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a TXT fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLT-ből TXT-be C++ konverziós forráskód" offSpacer="" %}}
