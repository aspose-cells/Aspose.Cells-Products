---
title: Conversor de texto delimitado por tabulação (TABDELIMITED) para números em PHP - Conversor de texto delimitado por tabulação (TABDELIMITED) para números.
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores PHP uma abordagem totalmente integrada para converter dados TABDELIMITED em formato NUMBERS, permitindo o salvamento perfeito de dados TABDELIMITED em formato NUMBERS usando a biblioteca Aspose.Cells, tudo por meio de código PHP eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Como converter TABDELIMITED em NÚMEROS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TABDELIMITED em NÚMEROS programaticamente? Desenvolvedores PHP podem facilmente carregar e converter arquivos TABDELIMITED em NÚMEROS com apenas algumas linhas de código.
...
1.  Converta TABDELIMITED em NÚMEROS chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de TABDELIMITED para NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED em NÚMEROS" %}}
