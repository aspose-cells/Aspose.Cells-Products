---
title:  Buscar documento ODS sin abrir via Java
weight: 8140
description: Código de muestra Java para buscar palabras con patrón en el archivo ODS en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{% blocks/products/pf/agp/content h2="Cómo buscar el archivo ODS usando Java" %}}
...
+ Cargue el archivo ODS creando una instancia de un objeto Libro de trabajo.
+ Acceda a la primera hoja de trabajo del archivo ODS.
