---
title: Konwertuj TXT na ODS za pomocą aplikacji C++ 
url: /pl/cpp/conversion/txt-to-ods/ 
description: Przykładowy kod konwersji C++ dla dokumentu TXT do formatu ODS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TXT do ODS w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TXT na ODS za pomocą C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TXT na ODS za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik TXT na ODS w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TXT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (ODS).1. Plik ODS zostanie zapisany pod określoną ścieżką.1. Otwórz plik ODS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TXT do ODS C++ Kod źródłowy konwersji" offSpacer="" %}}
