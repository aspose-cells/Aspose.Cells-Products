...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde EXCEL'i FODS'e dönüştürün. C# EXCEL'i FODS'e dönüştürün. C# EXCEL'i FODS'e kaydedin. C#'i kullanarak EXCEL'i FODS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i C#\'de FODS\'e kaydedin" %}}

Aşağıdaki örnek, EXCEL'in C#'de FODS'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="EXCEL\'i FODS\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C# aracılığıyla FODS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını programlı olarak FODS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyebilir ve FODS'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL'i FODS'e dönüştürün.
1.  EXCEL'in FODS'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i FODS\'e dönüştürmek için C# kitaplığı" %}}
