---
title:  Tách XLSB Tệp via Java
weight: 7880
description: Mã mẫu Java để phân chia tài liệu XLSB trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tách XLSB Tệp via Java" h2="Chia tách XLSB với sự trợ giúp của thư viện Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tách tệp XLSB bằng Java" %}}

 Để chia nhỏ tệp XLSB, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tách file XLSB trong Java" %}}
...
+ Load file XLSB sử dụng lớp Workbook.
+ Lặp qua từng sheet
+ Tạo mới đối tượng lớp Workbook
Copy sheet đã chọn sang đối tượng mới
+ Gọi phương thức save với đường dẫn file mới XLSB.
...
{{% blocks/products/pf/agp/code-block title="Tách XLSB File - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API có thể được sử dụng để tạo, chỉnh sửa, chuyển đổi và hiển thị định dạng Microsoft Excel sang các định dạng khác nhau. Hơn nữa, nó có thể được sử dụng để lập biểu đồ toàn diện, báo cáo có thể mở rộng và tính toán đáng tin cậy trong các ứng dụng phần mềm. Aspose.Cells là API độc lập và không yêu cầu bất kỳ phần mềm nào như Microsoft hoặc OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến XLSB Bản demo trực tiếp của Splitter" sectionDescription=" Chia tài liệu XLSB ngay bây giờ bằng cách truy cập của chúng tôi[Trang web demo trực tiếp](https://products.aspose.app/cells/splitter). Bản demo trực tiếp có những lợi ích sau" >}}
