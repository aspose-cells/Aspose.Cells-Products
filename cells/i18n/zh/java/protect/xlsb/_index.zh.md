---
title: 通过 Java 保护和锁定 XLSB 文档 
weight: 6590
url: /zh/java/protect/xlsb/ 
description: Java 在 JSP/JSF 应用程序和桌面应用程序的 Java 运行时环境中使用密码锁定 XLSB 文件的示例代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 加密 XLSB 文件" h2="使用 .NET 库对包括 XLSB 格式的 Excel 电子表格进行密码保护。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 保护 XLSB 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 保护 XLSB 文件的步骤" %}}
...
1. 通过实例化 Workbook 类加载 XLSB 文件1. 将protect(..) 方法与ProtectionType 和Password 一起使用1. 通过 save() 方法保存受保护的 XLSB 文件
