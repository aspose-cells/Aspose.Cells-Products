...
description: Aspose Excel. Convierta MHT a XLT rápida y fácilmente con Aspose.Cells. Python MHT a XLT. Python Guarde MHT en XLT. Guarde MHT como XLT usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde MHT en XLT en Python" %}}

El siguiente ejemplo demuestra cómo convertir MHT a XLT en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir MHT a XLT" %}}
