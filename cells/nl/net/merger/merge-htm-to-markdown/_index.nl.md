---
title: HTM samenvoegen met MARKDOWN - HTM samenvoegen met MARKDOWN in C#
url: /nl/net/merger/merge-htm-to-markdown/ 
description: Aspose Excel. C# Aspose.Cells. HTM samenvoegen naar MARKDOWN opslagformaat. C# Combineer HTM met MARKDOWN formaat. HTM samenvoegen naar MARKDOWN in C#. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTM samen met MARKDOWN in C#" %}}

Het volgende voorbeeld laat zien hoe u HTM samenvoegt met MARKDOWN in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen met MARKDOWN. Upload uw bestanden, bel de Workbook.Combine-methode voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand MARKDOWN. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# waarin HTM wordt samengevoegd met MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om HTM samen te voegen met MARKDOWN in C#" InputFormat="htm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen naar MARKDOWN via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met MARKDOWN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om HTM samen te voegen met MARKDOWN" %}}
