---
title: Vytvořit OTS – Vytvořte soubor OTS v Java
description: Aspose Excel. Snadno generujte a manipulujte se soubory OTS pomocí knihovny Aspose.Cells for Java. Tato výkonná knihovna API poskytuje efektivní a zjednodušené řešení pro vytváření, úpravu a správu souborů OTS přímo ve vašich aplikacích Java a splňuje specifické potřeby vývojářů s vysokou přesností.
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit OTS v Java" %}}
...
1.  Uložte sešit ve formátu OTS pomocí metody save().

{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor OTS v adresáři Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro vytvoření souboru OTS" %}}
{{% blocks/products/pf/agp/text %}}
