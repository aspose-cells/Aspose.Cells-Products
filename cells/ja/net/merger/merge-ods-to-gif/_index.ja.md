---
title: ODS から GIF を結合 - ODS から GIF を C# に結合
url: /ja/net/merger/merge-ods-to-gif/ 
description: Aspose エクセル。 C# Aspose.Cells。ODS を GIF の保存形式に無料でオンライン結合します。 C# ODS と GIF の形式を結合します。 ODS から GIF を C# に結合します。ODS を結合します。
...
次の例は、ODS を Aspose.Cells for .NET の GIF にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、ODS を GIF にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルをマージし、それを GIF ファイルに保存します。 C# のコードを開発する場合、これは思っているより簡単です。 ODS を GIF にマージする C# の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS を C# にオンラインで無料でマージ" InputFormat="ods" InputFormat2="gif" outformat="gif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="ODS を C# 経由で GIF に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

ODS をプログラムで GIF にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2=".NET ODS を GIF にマージするライブラリ" %}}
