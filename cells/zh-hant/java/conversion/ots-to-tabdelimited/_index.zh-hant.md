...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 TABDELIMITED。Java OTS 到 TABDELIMITED。 Java 將 OTS 儲存為製表符。使用 Java 將 OTS 儲存為 TABDELIMITED。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Java 中的 OTS 轉換為 TABDELIMITED" h2="用於將 OTS 轉換為 TABDELIMITED 的高速 Java 庫。這是一個使用 Java 匯入和匯出 OTS、TABDELIMITED 和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將 OTS 儲存為 TABDELIMITED 格式的 Java" %}}

以下範例示範如何將 Java 中的 OTS 轉換為 TABDELIMITED。
...
需要以程式設計方式將 OTS 檔案轉換為 TABDELIMITED？ Java 開發人員只需幾行程式碼即可輕鬆將 OTS 轉換為 TABDELIMITED。
