...
Hai bisogno di convertire i file MHT in EMF tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in EMF in poche righe di codice.
...
1.  Convertire MHT in EMF chiamando il metodo Save().
