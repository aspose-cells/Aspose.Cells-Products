---
title: C# HTML a MARKDOWN - En línea HTML a MARKDOWN Convertidor
description: AsposeExcel. C# Aspose.Cells. C# Aspose Cells. Gratis en línea C# Convertir HTML a MARKDOWN guardar formato. Formato C# HTML al MARKDOWN. Aparta del HTML al MARKDOWN C#.
...
{{% blocks/products/pf/agp/content h2="Guarde HTML a MARKDOWN en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo convertir HTML a MARKDOWN en C#.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir HTML a MARKDOWN. Cargue su archivo HTML, luego simplemente guárdelo como archivo MARKDOWN. Tanto para la lectura HTML como para la escritura MARKDOWN, puede utilizar nombres de archivo completos. El contenido y el formato de la salida MARKDOWN serán idénticos al documento original HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicación gratuita y código de muestra para convertir HTML a MARKDOWN en línea" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir HTML a MARKDOWN a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTML a MARKDOWN mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente HTML a MARKDOWN en solo unas pocas líneas de código.
...
1.  Convierta HTML a MARKDOWN llamando al método Workbook.Save.
1.  Obtenga el resultado de la conversión de HTML a MARKDOWN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para convertir HTML a MARKDOWN" %}}
