...
description: Aspose Excel. Chuyển đổi PRN sang XPS nhanh chóng và dễ dàng với Aspose.Cells. Python PRN sang XPS. Python Lưu PRN thành XPS. Lưu PRN là XPS sử dụng Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi PRN sang XPS trong Python" h2="Thư viện Python tốc độ cao chuyển đổi PRN sang XPS. Đây là giải pháp phần mềm chuyên nghiệp xuất nhập PRN, XPS và nhiều định dạng khác sử dụng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu PRN về XPS trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi PRN thành XPS trong Python.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển PRN thành XPS" %}}
