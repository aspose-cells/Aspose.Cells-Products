...
url: /tr/net/merger/merge-prn-to-ett/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin ETT ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 PRN'yi ETT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi ETT ile birleştirmek için .NET kitaplığı" %}}
