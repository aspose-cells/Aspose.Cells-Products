...
description: Aspose Excel'de. Java Aspose.Cells. ODS'i BMP kaydetme biçimiyle birleştirin. Java ODS'i BMP biçimiyle birleştirin. Java'de ODS'i BMP ile birleştirin. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'de BMP ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de ODS ile BMP'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS ile BMP'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından BMP dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. ODS ile BMP'i birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS ile BMP\'i Java\'de Birleştirmek için Örnek Kod" InputFormat="ods" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS ile BMP via Java Nasıl Birleştirilir?" %}}

{{% blocks/products/pf/agp/text %}}

 ODS ile BMP'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, ODS ile BMP arasında birleştirilecek" %}}
