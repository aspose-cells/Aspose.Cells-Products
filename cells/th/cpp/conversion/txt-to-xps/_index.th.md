---
title: C++ TXT ถึง XPS - ออนไลน์ TXT ถึง XPS Converter
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง TXT เป็น XPS บันทึกรูปแบบ รูปแบบ C++ TXT ถึง XPS บันทึก TXT ถึง XPS C++
...
{{% blocks/products/pf/agp/content h2="บันทึก TXT ถึง XPS ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง TXT เป็น XPS โดยเรียกเมธอด Save()
