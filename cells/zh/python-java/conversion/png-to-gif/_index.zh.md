---
title: Python PNG 转 GIF - 在线 PNG 转 GIF 转换器
description: Aspose Excel。 Python Aspose.Cells。Python Aspose Cells。免费在线 Python 将 PNG 转换为 GIF 保存格式。 Python PNG 到 GIF 格式。将 PNG 保存为 GIF Python。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 PNG 转换为 Python 中的 GIF" h2="高速Python库，用于将PNG转换为GIF。这是一个专业的软件解决方案，用于导入和导出PNG、GIF和使用Python的许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python 将 PNG 转换为 GIF" %}}

如何将 PNG 转换为 GIF？使用 Aspose.Cells for Python 库，您可以通过几行代码以编程方式轻松将 PNG 转换为 GIF。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Python Excel API不仅可以在电子表格格式之间进行转换，还可以将Excel文件渲染为图像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，从而使其成为行业交换文档的完美选择-标准格式。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="免费在线保存 PNG 至 GIF 于 Python" %}}

以下示例演示如何将 Python 中的 PNG 转换为 GIF。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 PNG 转换为 GIF。上传您的 PNG 文件，然后只需将其另存为 GIF 文件。对于 PNG 读取和 GIF 写入，您可以使用完全限定的文件名。输出 GIF 内容和格式将与原始 PNG 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免费应用程序和示例代码可在线将 PNG 转换为 GIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="gif" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 Python 将 PNG 转换为 GIF" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 PNG 文件转换为 GIF 吗？ Python 开发人员只需几行代码即可轻松加载和转换 PNG 到 GIF。
...
1. 使用工作簿实例加载 PNG 文件。
1. 通过调用Workbook.save方法将PNG转换为GIF。
1. 获取PNG到GIF的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python库将PNG转换为GIF" %}}
