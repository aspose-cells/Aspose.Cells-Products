...
{{% blocks/products/pf/agp/content h2="So sichern Sie die Datei XLS mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Schutz von XLS-Dateien via Java" %}}
...
1.  Laden Sie die Datei XLS, indem Sie die Arbeitsmappenklasse instanziieren
