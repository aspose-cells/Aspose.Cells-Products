---
title: Python MHTML から MHT - MHTML から MHT コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、MHTMLをMHTにすばやく簡単に変換します。Python MHTMLをMHTに変換します。 Python MHTML を MHT に保存します。 Python を使用して、MHTML を MHT として保存します。
...
{{% blocks/products/pf/agp/content h2="MHTML の MHT に MHTML を保存" %}}
...
{{% cells-convert title="MHTMLをMHTに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="mht" IsLandingPage="true" language="pythonjava" %}}
