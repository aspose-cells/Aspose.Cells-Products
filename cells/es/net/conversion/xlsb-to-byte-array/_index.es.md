...
weight: 7690
description: C# Código de muestra para la conversión de XLSB a Byte Array. Use este código para la conversión de Excel XLSB a Byte Array dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta XLSB en una matriz de bytes a través de C#" h2="Nativo y de alto rendimiento Microsoft Excel XLSB a conversión de matriz de bytes o viceversa para el procesamiento de datos de hojas de cálculo utilizando las API del lado del servidor .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array es útil para el procesamiento o almacenamiento de datos. Puede convertir el archivo XLSB a Byte Array, así como un**Matriz de bytes a XLSB**documento utilizando el idioma C#. Para convertir XLSB en una matriz de bytes, usaremos
...
1.  Cargar entrada XLSB Archivo usando Workbook
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra XLSB a la matriz de bytes C# Conversión" offSpacer="" %}}
