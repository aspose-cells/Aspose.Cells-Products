...
{{% blocks/products/pf/agp/content h2="Átalakítsa a NUMBERS-t PPTX-re a Python-ben" %}}
...
A következő példa bemutatja, hogyan lehet a SZÁMOKAT PPTX-re konvertálni a Python via NET-ben.
