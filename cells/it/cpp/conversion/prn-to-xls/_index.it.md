...
Hai bisogno di convertire i file PRN in XLS tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in XLS in poche righe di codice.
...
1.  Convertire PRN in XLS chiamando il metodo Save().
