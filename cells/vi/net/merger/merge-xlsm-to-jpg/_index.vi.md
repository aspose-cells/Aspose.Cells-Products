---
title: Hợp nhất XLSM thành JPG - Hợp nhất XLSM thành JPG trong C#
url: /vi/net/merger/merge-xlsm-to-jpg/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí XLSM sang định dạng lưu trữ JPG. C# Gộp XLSM sang định dạng JPG. Hợp nhất XLSM thành JPG trong C#. XLSM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLSM sang JPG trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất XLSM thành JPG trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất XLSM sang JPG. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp JPG. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất XLSM thành JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất XLSM sang JPG trong C#" InputFormat="xlsm" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XLSM sang JPG qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất XLSM thành JPG" %}}
