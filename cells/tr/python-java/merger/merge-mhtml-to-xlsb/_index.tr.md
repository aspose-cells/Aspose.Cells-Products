...
url: /tr/python-java/merger/merge-mhtml-to-xlsb/ 
...
Aşağıdaki örnek, MHTML'in Aspose.Cells for Python via Java'de XLSB ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 MHTML ile XLSB'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
