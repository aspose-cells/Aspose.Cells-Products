---
title: Conversor PHP SXC para MHTML - SXC para MHTML
description: Aspose Excel. Converta SXC em MHTML de forma rápida e fácil com Aspose.Cells. PHP SXC em MHTML. PHP Salve SXC em MHTML. Salve SXC como MHTML usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em MHTML via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em MHTML programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em MHTML em apenas algumas linhas de código.
...
1.  Converta SXC em MHTML chamando o método save da pasta de trabalho.
