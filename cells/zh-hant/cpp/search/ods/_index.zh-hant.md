---
title: 透過 C++ 搜尋 ODS 文檔，無需開啟
weight: 3300
description: C++ 範例程式碼，用於在 C++ 運行時環境中搜尋 ODS 檔案中具有模式的單詞，適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{< blocks/products/pf/i18n/upper-banner h1="搜尋 ODS C++ 中的格式" h2="使用伺服器端 Aspose.Cells for C++ API 進行本機高效能 ODS 文件搜索，無需使用 Microsoft 或 Adobe PDF 等任何軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
