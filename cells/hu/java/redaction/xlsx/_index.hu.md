---
title:  Szöveg keresése és cseréje a XLSX via Java dokumentumban
weight: 1590
description: Java mintakód a XLSX fájlban található érzékeny információk törléséhez a Java futásidejű környezet JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
...
{{% blocks/products/pf/agp/content h2="A XLSX fájl szerkesztése a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A XLSX-es fájlok szerkesztésének lépései a Java-ben" %}}
...
{{% blocks/products/pf/agp/code-block title="Szerkesztés XLSX Fájlok - Java" offSpacer="" %}}
