---
title: C# EXCEL à EMF - Convertisseur EXCEL à EMF
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format EMF, permettant un enregistrement transparent des données EXCEL au format EMF à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL sous EMF dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en EMF en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir EXCEL en EMF. Téléchargez votre fichier EXCEL, puis enregistrez-le simplement sous le nom de fichier EMF. Pour la lecture EXCEL et l'écriture EMF, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie EMF seront identiques au document EXCEL original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir un fichier Excel en EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="emf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en EMF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en EMF par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en EMF en quelques lignes de code seulement.
...
1.  Convertissez le fichier EXCEL au format EMF en appelant la méthode Workbook.Save.
