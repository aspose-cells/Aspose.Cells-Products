...
{{% blocks/products/pf/agp/text %}}
 ...
 นักพัฒนา C++ สามารถแปลง EXCEL เป็น MHTML ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ EXCEL โดยใช้ Factory::CreateIWorkbook
1. แปลง EXCEL เป็น MHTML โดยเรียกเมธอด Save()
