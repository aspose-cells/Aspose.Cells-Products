...
{{% blocks/products/pf/agp/content h2="How to Merge MHTML to XLSB File Using Python" %}}
 ...
 In order to merge MHTML to XLSB file, we will use
...
{{% cells-merger title="Free App to merge Excel files on line" InputFormat="mhtml" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="python-java" %}}
