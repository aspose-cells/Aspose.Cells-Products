---
title: Fusionner HTM en JPG - Combiner HTM en JPG dans Python
url: /fr/python-java/merger/merge-htm-to-jpg/ 
description: Aspose Exceller. Python Exceller. Fusionnez le format de sauvegarde HTM au format JPG. Python Combinez le format HTM au format JPG. Fusionnez HTM en JPG dans la bibliothèque Excel Python. Fusion HTM.
...
{{% cells-merger title="Exemple de code pour fusionner HTM en JPG dans la bibliothèque Excel Python" InputFormat="htm" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM en JPG via la bibliothèque Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTM en JPG par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner HTM en JPG" %}}
