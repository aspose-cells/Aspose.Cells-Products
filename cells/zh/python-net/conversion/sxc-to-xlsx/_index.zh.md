---
title: Python SXC 至 XLSX - SXC 至 XLSX 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 SXC 转换为 XLSX。 Python SXC 为 XLSX。 Python 将 SXC 保存为 XLSX。 将 SXC 另存为 07611134 81 使用 Python。
...
{{% cells-convert title="将 SXC 转换为 XLSX 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
