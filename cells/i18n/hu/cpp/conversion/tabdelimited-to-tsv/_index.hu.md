---
title: A TABDELIMITED konvertálása TSV-re a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/tabdelimited-to-tsv/ 
description: Minta C++ konverziós kód a TABDELIMITED dokumentumhoz TSV formátumba. A programozók ezt a forráskódot használhatják a TABDELIMITED kötegelt TSV-konverzióhoz bármely C++ alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED konvertálása TSV-re a következőn keresztül: C++" h2="Nagy teljesítményű TABDELIMITED konvertálás TSV-vé a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="A TABDELIMITED átalakítása TSV-vé a következővel: C++" %}}
 ...
 A TABDELIMITED TSV-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják a TABDELIMITED fájlt TSV-vé.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED fájl betöltése a Factory::CreateIWorkbook használatával.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (TSV) fájlkiterjesztéssel.1. A TSV fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a TSV fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED TSV C++ konverziós forráskódhoz" offSpacer="" %}}
