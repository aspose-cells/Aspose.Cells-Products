...
description: Aspose Excel. Python Aspose.Cells. Scal OBRAZ do formatu zapisu PRN. Python Połącz OBRAZ z formatem PRN. Połącz OBRAZ z PRN pod numerem Python. Połącz OBRAZ.
...
{{% blocks/products/pf/agp/content h2="Scal OBRAZ z PRN za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz OBRAZ z PRN w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia IMAGE z PRN w Python" InputFormat="png" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć IMAGE z PRN pod numerem Python" %}}
