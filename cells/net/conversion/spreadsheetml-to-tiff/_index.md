...
url: /net/conversion/spreadsheetml-to-tiff/
description: Sample code for spreadsheetml to tiff C# conversion. Use API example code for batch spreadsheetml files to tiff conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert SPREADSHEETML to TIFF Using C#" %}}

 In order to convert SPREADSHEETML to TIFF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert SPREADSHEETML to TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert SPREADSHEETML files to TIFF in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load SPREADSHEETML file with an instance of Workbook
1.  Call the Workbook.Save method
1.  Pass output path with TIFF extension as parameters
...
{{% blocks/products/pf/agp/code-block title="This sample code shows spreadsheetml to tiff C# Conversion" offSpacer="" %}}

{{< gist "aspose-cells-gists" "88c9872508ec3150c552eb5155edf06e" "Convert-spreadsheetml-to-tiff.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert SPREADSHEETML to TIFF" sectionDescription="Check our live demos for [SPREADSHEETML to TIFF conversion](https://products.aspose.app/cells/conversion/spreadsheetml-to-tiff) with following benefits." >}}
