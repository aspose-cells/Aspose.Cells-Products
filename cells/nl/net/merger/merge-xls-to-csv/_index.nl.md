---
title: Voeg XLS samen met CSV - Combineer XLS met CSV in C#
url: /nl/net/merger/merge-xls-to-csv/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen XLS naar CSV saveformat. C# Combineer het formaat XLS tot CSV. Samenvoegen XLS tot CSV in C#. XLS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met CSV in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLS samenvoegt met CSV in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLS samen te voegen met CSV. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand CSV. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat XLS samenvoegt met CSV.
...
{{% blocks/products/pf/agp/content h2="Hoe XLS samen te voegen met CSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLS programmatisch samenvoegen tot CSV? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLS samen te voegen tot CSV" %}}
