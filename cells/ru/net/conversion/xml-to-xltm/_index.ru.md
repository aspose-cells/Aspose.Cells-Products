...
description: Aspose Эксель. Быстро и легко конвертируйте XML в XLTM с помощью Aspose.Cells. C# XML в XLTM. C# Сохраните XML в XLTM. Сохраните XML как XLTM, используя C#.
...
{{% blocks/products/pf/agp/content h2="Преобразование XML в XLTM с помощью C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML в XLTM в C#." %}}

В следующем примере показано, как преобразовать XML в XLTM в C#.
...
{{% cells-convert title="Пример кода для преобразования XML в XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xltm" IsLandingPage="true" %}}
