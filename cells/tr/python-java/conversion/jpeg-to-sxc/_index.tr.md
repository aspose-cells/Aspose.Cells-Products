...
{{% blocks/products/pf/agp/content h2="Python Excel Kitaplığını Kullanarak JPEG\'i SXC\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/content h2="JPEG\'i SXC\'e Python Excel Kitaplığı\'na kaydedin" %}}

Aşağıdaki örnek, JPEG excel kitaplığında JPEG'in SXC'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="Python JPEG\'i SXC\'e Dönüştürmek için Excel Kitaplığı" %}}
