...
url: /pl/cpp/merger/merge-sxc-to-svg/ 
...
Poniższy przykład pokazuje, jak połączyć SXC z SVG w Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz scalić SXC z SVG programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia SXC z SVG" %}}
