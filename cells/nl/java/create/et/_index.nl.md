---
title: ET maken - ET-bestand maken in Java
description: Aspose Excel. Java ET-bestand maken. Maak ET Java. Java ET Creator. Maak ET in Java. Genereer ET-bestand met Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een ET-bestand in Java" h2="High-speed Java-bibliotheek voor het maken van ET-bestanden. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="ET maken in Java" %}}
...
1.  Sla de werkmap op in ET-indeling met behulp van de methode save().

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een ET-bestand maakt in Java." offSpacer="" %}}
