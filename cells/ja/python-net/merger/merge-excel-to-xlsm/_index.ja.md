---
title: EXCEL を Python 経由で XLSM に結合
url: /ja/python-net/merger/merge-excel-to-xlsm/ 
description: EXCEL をオンラインで無料で XLSM に結合します。 XLSM 合併への無料オンライン EXCEL。 Excel を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、EXCEL を Python の XLSM にマージする方法を示しています。
...
{{% cells-merger title="オンラインでEXCELをXLSMにマージする無料アプリ" InputFormat="xlsx" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
