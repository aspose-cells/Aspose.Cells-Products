---
title: Gabungkan SXC ke MD - Gabungkan SXC ke MD di Java
url: /id/java/merger/merge-sxc-to-md/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan SXC ke format simpan MD. Java Gabungkan SXC ke format MD. Gabung SXC menjadi MD di Java. SXC Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan SXC menjadi MD di Java" %}}

Contoh berikut menunjukkan cara menggabungkan SXC ke MD di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan SXC ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan SXC ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan SXC ke MD secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
