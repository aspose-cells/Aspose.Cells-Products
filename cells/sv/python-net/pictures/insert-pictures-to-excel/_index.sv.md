...
{{% blocks/products/pf/agp/content h2="Hur man infogar bild i Excel-fil med Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga bild till Excel-fil med Python via .Net" %}}
...
+ Välj kalkylblad via dess index.
 + Använd bildsamlingens tillägg[metod](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/) för att infoga en bild i det valda arbetsbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga bild - Python via .Net" offSpacer="" %}}
