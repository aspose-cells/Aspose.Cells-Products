...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar ODS met Aspose.Cells. Python OTS naar ODS. Python Bewaar OTS naar ODS. Sla OTS op als ODS met Python.
...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar ODS in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar OTS op ODS in Python" %}}

Het volgende voorbeeld laat zien hoe u OTS converteert naar ODS in Python via NET.
...
{{% cells-convert title="Voorbeeldcode om OTS naar ODS te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="ods" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om OTS naar ODS te converteren" %}}
