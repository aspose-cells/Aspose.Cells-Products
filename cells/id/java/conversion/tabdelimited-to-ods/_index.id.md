...
description: Aspose Unggul. Ubah TABDELIMITED menjadi ODS dengan cepat dan mudah menggunakan Aspose.Cells. Java TABDELIMITED menjadi ODS. Java Simpan TABDELIMITED menjadi ODS. Simpan TABDELIMITED sebagai ODS menggunakan Java.
...
{{% blocks/products/pf/agp/content h2="Ubah TABDELIMITED menjadi ODS Menggunakan Java" %}}
...
Contoh berikut menunjukkan cara mengonversi TABDELIMITED menjadi ODS di Java.
...
{{% cells-convert title="Kode Contoh untuk Mengonversi TABDELIMITED menjadi ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi TABDELIMITED menjadi ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file TABDELIMITED ke ODS secara terprogram? Pengembang Java dapat dengan mudah mengonversi TABDELIMITED menjadi ODS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi TABDELIMITED menjadi ODS" %}}
{{% blocks/products/pf/agp/text %}}
