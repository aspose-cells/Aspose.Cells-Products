---
title: Konvertera XLT till HTML via Java 
weight: 2250
url: /sv/java/conversion/xlt-to-html/ 
description: Exempel Java-konverteringskod för XLT-format till HTML-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till HTML inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLT till HTML via Java" h2="XLT till HTML Java-konvertering för att konvertera enstaka eller flera sidor till HTML med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLT till HTML med Java" %}}

 För att rendera XLT till HTML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLT till HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLT-fil till HTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLT-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Skicka utdatasökväg med HTML-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande HTML-filen
...
{{% blocks/products/pf/agp/code-block title="XLT till HTML Java omvandlingskällkod" offSpacer="" %}}
