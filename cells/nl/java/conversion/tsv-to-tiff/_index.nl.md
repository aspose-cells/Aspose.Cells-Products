...
{{% blocks/products/pf/agp/content h2="Sla TSV op in TIFF in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar TIFF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar TIFF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TSV programmatisch converteren naar TIFF? Ontwikkelaars van Java kunnen bestanden met de extensie TSV eenvoudig converteren naar TIFF met slechts een paar regels code.
