---
title: Gộp OTS thành HÌNH ẢNH - Gộp OTS thành HÌNH ẢNH trong Java
url: /vi/java/merger/merge-ots-to-image/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất OTS thành định dạng lưu HÌNH ẢNH. Java Kết hợp định dạng OTS thành HÌNH ẢNH. Hợp nhất OTS thành HÌNH ẢNH trong Java. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Gộp OTS vào IMAGE Java" %}}

Ví dụ sau đây minh họa cách hợp nhất OTS thành IMAGE trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất OTS vào HÌNH ẢNH. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp HÌNH ẢNH. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất OTS với IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Code mẫu gộp OTS vào IMAGE Java" InputFormat="ots" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp OTS thành HÌNH ẢNH via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất OTS thành HÌNH ẢNH theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java ghép OTS vào HÌNH ẢNH" %}}
