...
description: C++ 从 XLSB 文件中提取文本和图像的示例代码 C++ 适用于 Windows 32 位、Windows 64 位和 Linux 64 位的运行时环境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="解析 C++ 中的 XLSB 格式" h2="使用用于 C++ API 的服务器端 Aspose.Cells 进行本机和高性能 XLSB 文档解析，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ 中解析 XLSB 文件的步骤" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="在线 XLSB 解析器现场演示" sectionDescription="立即从 XLSB 文档中提取文本和图像，请访问我们的 [现场演示网站](https://products.aspose.app/cells/parser).现场演示有以下好处" >}}
