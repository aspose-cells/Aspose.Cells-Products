...
description: Aspose Excel. Converti il PRN in XPS in modo rapido e semplice con Aspose.Cells. C++ PRN in XPS. C++ Salva PRN in XPS. Salva PRN come XPS utilizzando C++.
...
{{% blocks/products/pf/agp/content h2="Salva il PRN allo XPS in C++" %}}

L'esempio seguente mostra come convertire il PRN in XPS in C++.
...
È necessario convertire i file PRN in XPS a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in XPS in poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria C++ per convertire il PRN in XPS" %}}
