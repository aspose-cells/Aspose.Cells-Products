---
title: Chuyển MHTML sang ODS qua C#
url: /vi/net/conversion/mhtml-to-ods/
description: Mã mẫu cho chuyển đổi mhtml thành ods C#. Sử dụng API mã ví dụ cho hàng loạt tệp mhtml để chuyển đổi ods trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp MHTML sang ODS chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp MHTML bằng một phiên bản của Workbook1. Gọi phương thức Workbook.Save1. Chuyển đường dẫn đầu ra với phần mở rộng ODS làm tham số1. Kiểm tra đường dẫn được chỉ định cho tệp ODS kết quả
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi MHTML sang ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="ods" IsLandingPage="true" %}}
