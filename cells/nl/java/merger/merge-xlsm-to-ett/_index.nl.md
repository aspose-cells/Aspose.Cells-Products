...
description: Aspose Excel. Java Aspose.Cells. Voeg XLSM samen naar ETT-opslagformaat. Java Combineer XLSM naar ETT-formaat. Voeg XLSM samen met ETT in Java. XLSM Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSM samen met ETT in Java" %}}

Het volgende voorbeeld laat zien hoe u XLSM samenvoegt met ETT in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSM samen te voegen met ETT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een ETT-bestand. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld Java waarin XLSM wordt samengevoegd met ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLSM samen te voegen met ETT in Java" InputFormat="xlsm" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSM samenvoegt met ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLSM programmatisch samenvoegen met ETT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
