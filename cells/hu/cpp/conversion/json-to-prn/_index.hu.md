...
A JSON fájlokat programozottan PRN-re kell konvertálni? A C++ fejlesztők könnyedén konvertálhatják a JSON-et PRN-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a JSON-et PRN-re a Save() metódus meghívásával.
