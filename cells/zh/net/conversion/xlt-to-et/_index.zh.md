---
title: C# XLT 转 ET - 在线 XLT 转 ET 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 XLT 转换为 ET 保存格式。 C# XLT 为 ET 格式。将 XLT 保存到 ET C#。
...
{{% blocks/products/pf/agp/content h2="免费将 XLT 保存到 C# 中的 ET" %}}
...
{{% cells-convert title="将 XLT 转换为 ET 的免费应用程序和示例代码在线" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLT 转换为 ET" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 文件转换为 ET？ .NET 开发人员只需几行代码即可轻松加载 XLT 并将其转换为 ET。
...
{{% blocks/products/pf/agp/content h2="C#库将XLT转换为ET" %}}
