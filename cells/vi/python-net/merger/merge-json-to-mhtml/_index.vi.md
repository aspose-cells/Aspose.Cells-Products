...
url: /vi/python-net/merger/merge-json-to-mhtml/ 
...
Ví dụ sau đây minh họa cách hợp nhất JSON với MHTML trong Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Cần hợp nhất JSON thành MHTML theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API có thể được thực hiện chỉ với vài dòng mã.
