...
{{% blocks/products/pf/agp/content h2="Sla TXT op in BMP in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar BMP in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar BMP of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar BMP? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar BMP met slechts een paar regels code.
