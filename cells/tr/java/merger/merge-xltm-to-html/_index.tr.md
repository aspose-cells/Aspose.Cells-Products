---
title:  XLTM'i HTML via Java ile birleştir
url: /tr/java/merger/merge-xltm-to-html/ 
description: XLTM'i HTML ile Çevrimiçi Ücretsiz Olarak Birleştirin. Ücretsiz Çevrimiçi XLTM - HTML Birleşme. XLTM'i Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS ve daha fazlasıyla birleştirin.
---
...
Aşağıdaki örnek, XLTM'in Java'de HTML ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLTM\'i hatta HTML ile birleştirmek için Ücretsiz Uygulama" InputFormat="xltm" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
