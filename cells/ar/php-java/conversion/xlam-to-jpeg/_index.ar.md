---
title: PHP XLAM إلى JPEG - XLAM إلى JPEG محول
description: Aspose اكسل. قم بتحويل XLAM إلى JPEG بسرعة وسهولة باستخدام Aspose.Cells. PHP XLAM إلى JPEG. PHP احفظ XLAM إلى JPEG. احفظ XLAM كـ JPEG باستخدام PHP.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLAM إلى JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="jpg" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLAM إلى JPEG عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLAM إلى JPEG برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLAM إلى JPEG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLAM إلى JPEG عن طريق استدعاء طريقة حفظ المصنف.
