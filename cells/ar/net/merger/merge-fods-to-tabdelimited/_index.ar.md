---
title: دمج FODS في TABDELIMITED - اجمع FODS إلى TABDELIMITED في C#
url: /ar/net/merger/merge-fods-to-tabdelimited/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني على الإنترنت FODS إلى TABDELIMITED saveformat. C# اجمع FODS إلى تنسيق TABDELIMITED. دمج FODS إلى TABDELIMITED في C#. FODS دمج.
...
{{% blocks/products/pf/agp/content h2="دمج FODS في TABDELIMITED في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج FODS إلى TABDELIMITED في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج FODS في TABDELIMITED. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف TABDELIMITED. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج FODS إلى TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج FODS في TABDELIMITED في C#" InputFormat="fods" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج FODS في TABDELIMITED عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج FODS في TABDELIMITED برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج FODS إلى TABDELIMITED" %}}
