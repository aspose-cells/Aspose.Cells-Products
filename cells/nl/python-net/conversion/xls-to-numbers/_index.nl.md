---
title: Python XLS naar CIJFERS - XLS naar CIJFERS Omzetter
...
{{% blocks/products/pf/agp/content h2="Converteer XLS naar getallen in de Excel-bibliotheek Python" %}}

 Hoe converteer ik XLS naar getallen? Met behulp van de NET-bibliotheek kunt u XLS eenvoudig programmatisch naar getallen converteren met slechts een paar regels code.[Aspose.Cells for Python via NET](https://pypi.org/project/aspose-cells-python/)is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardformaten.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Sla XLS op in de map NUMBERS in de Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u XLS naar getallen kunt converteren in de Excel-bibliotheek Python.
...
{{% cells-convert title="Voorbeeldcode om XLS naar NUMBERS te converteren met behulp van de Excel-bibliotheek Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="numbers" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe zet ik XLS om naar cijfers?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden van het type XLS programmatisch converteren naar NUMBERS? Ontwikkelaars van Python kunnen bestanden van het type XLS eenvoudig laden en converteren naar NUMBERS met slechts een paar regels code.
...
{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om XLS naar getallen te converteren" %}}
