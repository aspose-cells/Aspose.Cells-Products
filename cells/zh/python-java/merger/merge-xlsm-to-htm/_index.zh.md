---
title: 将 XLSM 合并到 HTM - 将 XLSM 合并到 Python 中的 HTM
url: /zh/python-java/merger/merge-xlsm-to-htm/ 
description: Aspose Excel。 Python Aspose.Cells。免费在线合并 XLSM 到 HTM 保存格式。 Python 将 XLSM 合并为 HTM 格式。将 XLSM 合并到 Python 中的 HTM。 XLSM 合并。
...
以下示例演示如何将 XLSM 合并到 Aspose.Cells for Python via Java 中的 HTM。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLSM 合并到 HTM。上传文件，调用Workbook.Combine方法合并文件，然后保存为HTM文件。如果您在 Python 中开发代码，这会比听起来更简单。请参阅将 XLSM 合并到 HTM 的 Python 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线将 XLSM 合并到 Python 中的 HTM" InputFormat="xlsm" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 Python 将 XLSM 合并到 HTM" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 合并到 HTM 吗？基本文档合并和连接[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Python库将XLSM合并到HTM" %}}
