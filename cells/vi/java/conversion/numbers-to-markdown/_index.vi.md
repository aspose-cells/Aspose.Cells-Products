---
title: Chuyển NUMBERS thành MARKDOWN qua Java 

description: Mã chuyển đổi Java mẫu cho định dạng NUMBERS thành tệp MARKDOWN. Người lập trình có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang MARKDOWN trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn nào Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển NUMBERS thành MARKDOWN qua Java" h2="Chuyển đổi NUMBERS thành MARKDOWN Java để chuyển đổi một hoặc nhiều trang thành MARKDOWN bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi CON SỐ thành ĐÁNH DẤU bằng cách sử dụng Java" %}}

 Để hiển thị NUMBERS thành MARKDOWN, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi CON SỐ thành MARKDOWN qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp NUMBERS thành MARKDOWN chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp NUMBERS với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Chuyển đường dẫn đầu ra với phần mở rộng MARKDOWN & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp MARKDOWN kết quả
...
{{% blocks/products/pf/agp/code-block title="NUMBERS thành MARKDOWN Java Mã nguồn chuyển đổi" offSpacer="" %}}

```cs
// tải tệp NUMBERS trong một phiên bản của Workbook
Workbook book = new Workbook("template.numbers");
// lưu NUMBERS dưới dạng MARKDOWN
...
{{< blocks/products/pf/agp/demobox sectionTitle="CON SỐ để ĐÁNH DẤU Bản trình diễn trực tiếp chuyển đổi" sectionDescription="[Chuyển đổi NUMBERS thành MARKDOWN](https://products.aspose.app/cells/conversion/numbers-to-markdown) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp NUMBERS của bạn, tệp sẽ được chuyển đổi ngay lập tức thành MARKDOWN." >}}
