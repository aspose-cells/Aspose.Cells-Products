---
title: Sloučit PRN s DOCX – Sloučit PRN s DOCX v C++
url: /cs/cpp/merger/merge-prn-to-docx/ 
description: Aspose Excel. C++ Aspose.Cells. Zdarma online sloučit PRN do formátu uložení DOCX. C++ Zkombinujte PRN do formátu DOCX. Sloučit PRN na DOCX v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na DOCX v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN s DOCX v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do DOCX. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru DOCX. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí PRN do DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení PRN na DOCX v C++" InputFormat="prn" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na DOCX přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s DOCX programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení PRN s DOCX" %}}
