---
title: Sloučit JSON na MD – Sloučit JSON na MD v Java
url: /cs/java/merger/merge-json-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma JSON do formátu uložení MD. Java Spojte JSON do formátu MD. Sloučit JSON na MD v Java. JSON Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JSON na MD v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JSON do MD v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JSON s MD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MD. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí JSON do MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JSON na MD v Java" InputFormat="json" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON na MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit JSON na MD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení JSON na MD" %}}
