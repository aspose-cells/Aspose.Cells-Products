---
title: Konversikan SPREADSHEETML ke PNG melalui Java 
url: /id/java/conversion/spreadsheetml-to-png/ 
description: Contoh Java kode konversi untuk format SPREADSHEETML ke file PNG. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke PNG dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan SPREADSHEETML ke PNG melalui Java" h2="SPREADSHEETML ke PNG konversi Java untuk mengonversi satu atau beberapa halaman ke PNG menggunakan perpustakaan Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi SPREADSHEETML ke PNG Menggunakan Java" %}}

 Untuk merender SPREADSHEETML ke PNG, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi SPREADSHEETML ke PNG melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file SPREADSHEETML ke PNG hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file SPREADSHEETML dengan instance Workbook1. Pilih default atau Lembar Kerja apa pun dari koleksi1. Buat & atur objek ImageOrPrintOptions1. Buat SheetRender dengan objek Worksheet & ImageOrPrintOptions1. Panggil metode SheetRender.toImage untuk menyimpan hasil dalam format PNG
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML ke PNG Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file SPREADSHEETML yang akan di-render
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi SPREADSHEETML ke PNG" sectionDescription="[Konversikan SPREADSHEETML ke PNG](https://products.aspose.app/cells/conversion/spreadsheetml-to-png) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file SPREADSHEETML Anda, itu akan langsung dikonversi ke PNG." >}}
