---
title: Converter CSV para SXC via Python
url: /pt/python-java/conversion/csv-to-sxc/
description: Código de exemplo para conversão de csv para sxc Python. Use API código de exemplo para arquivos csv em lote para conversão sxc no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter CSV para SXC usando Python" %}}

 Para converter CSV para SXC, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter CSV para SXC via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos CSV para SXC em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo CSV com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão SXC como parâmetro1. Verifique o caminho especificado para o arquivo SXC resultante
