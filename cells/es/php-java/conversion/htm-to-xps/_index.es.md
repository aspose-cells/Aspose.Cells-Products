---
title: PHP HTM a XPS - Convertidor HTM a XPS
description: Aspose Excel. Convierta HTM a XPS rápida y fácilmente con Aspose.Cells. PHP HTM a XPS. PHP Guarde HTM en XPS. Guarde HTM como XPS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a XPS mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a XPS mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a XPS en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a XPS llamando al método guardar del libro de trabajo.
