---
title: C# JPEG - NUMBERS - Online JPEG - NUMBERS Átalakító
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Ingyenes online C# A JPEG konvertálása NUMBERS mentési formátumra. C# JPEG NUMBERS formátumba. Mentse a JPEG számot a NUMBERS C# számra.
...
{{% blocks/products/pf/agp/content h2="Takarítson meg JPEG számot NUMBERS számra a C# számon online ingyen" %}}

A következő példa bemutatja, hogyan lehet a JPEG-et NUMBERS-re konvertálni a C#-ben.
...
{{% blocks/products/pf/agp/content h2="A JPEG konvertálása NUMBERS-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Konvertálnia kell JPEG fájlt NUMBERS-re programozottan? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal SZÁMOKRA konvertálhatják a JPEG-et.
...
1.  Konvertálja a JPEG-et NUMBERS-re a Workbook.Save metódus hívásával.
1.  Szerezze meg a JPEG konverziós eredményt NUMBERS-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a JPEG számok SZÁMOKká konvertálásához" %}}
