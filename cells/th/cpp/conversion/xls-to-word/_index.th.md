...
ต้องการแปลงไฟล์ XLS เป็น WORD โดยใช้โปรแกรมหรือไม่? นักพัฒนา C++ สามารถแปลง XLS เป็น WORD ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงค่า XLS เป็น WORD โดยเรียกใช้เมธอด Save()
