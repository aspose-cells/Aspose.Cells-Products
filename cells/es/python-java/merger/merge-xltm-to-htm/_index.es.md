...
El siguiente ejemplo muestra cómo combinar XLTM con HTM en Aspose.Cells for Python via Java.
...
¿Necesita fusionar XLTM con HTM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Las API se pueden hacer con solo unas pocas líneas de código.
