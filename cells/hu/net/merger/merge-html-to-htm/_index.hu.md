...
A következő példa bemutatja, hogyan egyesítheti a HTML-es számot a HTM-mel a Aspose.Cells for .NET-ben.
...
Programozottan egyesítenie kell a HTML-et a HTM-mel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
