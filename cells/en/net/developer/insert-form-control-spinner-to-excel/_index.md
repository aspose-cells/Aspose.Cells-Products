...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Spinner(Form control) to Excel file via C#" %}}
...
+  Use the [add method](https://apireference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addspinner) to insert a Spinner(Form control) in the selected worksheet
