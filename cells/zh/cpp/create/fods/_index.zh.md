---
title: 创建FODS - 在C++中创建FODS文件
description: Aspose Excel。 C++ 使用 Aspose.Cells 快速轻松地创建 FODS 文件。使用 C++ 生成 FODS 文件。在 C++ 中创建 FODS。C++ FODS 创建者。
...
{{< blocks/products/pf/i18n/upper-banner h1="在C++中创建FODS文件" h2="使用 C++ 库以编程方式创建本机高性能 FODS 文件，无需 Microsoft Office。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何在C++中创建FODS" %}}

{{% blocks/products/pf/agp/text %}}

开发人员只需几行代码即可轻松在运行的报告应用程序中创建、加载、修改和转换 FODS 文件以进行数据处理。
...
1. 使用 Save() 方法将工作簿保存为 .fods 文件。

{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 C++ 中创建 FODS 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++库创建FODS文件" %}}
