---
title: Konvertera NUMBERS till FODS via Java 
url: /sv/java/conversion/numbers-to-fods/ 
description: Exempel Java-konverteringskod för NUMBERS-format till FODS-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till FODS inom vilken webb- eller skrivbordsbaserad applikation som helst.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera NUMBERS till FODS via Java" h2="NUMBERS till FODS Java-konvertering för att konvertera enstaka eller flera sidor till FODS med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar TAL till FODS med Java" %}}

 För att återge NUMBERS till FODS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera NUMBERS till FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera NUMBERS-filen till FODS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda NUMBERS-filen med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med FODS-tillägg & SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande FODS-filen
...
{{% blocks/products/pf/agp/code-block title="NUMBERS till FODS Java Källkod för konvertering" offSpacer="" %}}

```cs
// ladda NUMBERS-filen i en instans av Workbook
Workbook book = new Workbook("template.numbers");
// spara NUMBERS som FODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS till FODS Conversion Live Demos" sectionDescription="[Konvertera NUMBERS till FODS](https://products.aspose.app/cells/conversion/numbers-to-fods) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din NUMBERS-fil, den kommer omedelbart att konverteras till FODS." >}}
