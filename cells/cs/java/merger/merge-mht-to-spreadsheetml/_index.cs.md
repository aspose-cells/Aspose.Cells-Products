---
title: Sloučit MHT do SPREADSHEETML – Sloučit MHT do SPREADSHEETML v Java
url: /cs/java/merger/merge-mht-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení SPREADSHEETML. Java Zkombinujte formát MHT a SPREADSHEETML. Sloučit MHT do SPREADSHEETML v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do SPREADSHEETML v Java" %}}

Následující příklad ukazuje, jak sloučit MHT do SPREADSHEETML v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT do SPREADSHEETML. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru SPREADSHEETML. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT do SPREADSHEETML v Java" InputFormat="mht" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT do SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit MHT do SPREADSHEETML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení MHT do SPREADSHEETML" %}}
