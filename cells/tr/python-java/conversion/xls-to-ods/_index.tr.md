---
title: Python XLS ila ODS - XLS ila ODS Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde XLS'i ODS'e dönüştürün. Python XLS'i ODS'e dönüştürün. Python XLS'i ODS'e kaydedin. XLS'i 07611134 olarak kaydedin 81, Python'i kullanarak.
...
{{% cells-convert title="XLS\'i ODS\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="ods" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLS\'i Python aracılığıyla ODS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLS dosyalarını program aracılığıyla ODS'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla XLS'i kolayca yükleyebilir ve ODS'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak XLS'i ODS'e dönüştürün.
1.  XLS'den ODS'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLS\'i ODS\'e dönüştürmek için Python kitaplığı" %}}
