---
title: C++ OTS en JPG - Convertisseur OTS en JPG
description: Aspose Excel. Cette solution complète offre aux développeurs C++ une approche entièrement intégrée pour convertir les fichiers OTS au format JPG, permettant ainsi un enregistrement transparent des données OTS au format JPG grâce à la bibliothèque Aspose.Cells, le tout grâce à un code C++ efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OTS en JPG dans C++" h2="Conversion OTS vers JPG haute performance utilisant la bibliothèque C++ sans avoir besoin de l\'installation d\'Excel, d\'OpenOffice ou d\'Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer OTS au format JPG dans C++" %}}

L'exemple suivant montre comment convertir un fichier OTS en JPG dans C++.
...
{{% blocks/products/pf/agp/content h2="Comment convertir OTS en JPG via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers OTS en JPG par programmation ? Les développeurs de C++ peuvent facilement convertir des fichiers OTS en JPG en quelques lignes de code seulement.
...
1.  Convertissez le fichier OTS en JPG en appelant la méthode Save().
1.  Obtenez le résultat de la conversion d'OTS en JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir OTS en JPG" %}}
