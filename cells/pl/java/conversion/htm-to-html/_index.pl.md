...
{{% blocks/products/pf/agp/content h2="Zapisz HTM do HTML w Java" %}}
...
Trzeba programowo przekonwertować pliki HTM do formatu HTML? Programiści Java mogą łatwo przekonwertować pliki HTM do formatu HTML za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji HTM na HTML" %}}
{{% blocks/products/pf/agp/text %}}
