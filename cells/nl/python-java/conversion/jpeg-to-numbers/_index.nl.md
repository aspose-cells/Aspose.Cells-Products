---
title: Python JPEG naar CIJFERS - JPEG naar CIJFERS Omzetter
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer JPEG naar getallen in de Excel-bibliotheek Python" h2="Snelle Excel-bibliotheek voor het converteren van Python naar NUMBERS. Dit is een professionele softwareoplossing voor het importeren en exporteren van JPEG, NUMBERS en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer JPEG naar getallen met behulp van de Excel-bibliotheek Python" %}}

 Hoe converteer ik JPEG naar getallen? Met de Aspose.Cells for Python-bibliotheek kunt u JPEG eenvoudig programmatisch naar getallen converteren met slechts een paar regels code.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardformaten.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Sla JPEG op in de map NUMBERS in de Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u JPEG naar getallen kunt converteren in de Excel-bibliotheek Python.
...
{{% cells-convert title="Voorbeeldcode om JPEG naar NUMBERS te converteren met behulp van de Excel-bibliotheek Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="numbers" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe zet je JPEG om naar cijfers via Python?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden van het type JPEG programmatisch converteren naar NUMBERS? Ontwikkelaars van Python kunnen bestanden van het type JPEG eenvoudig laden en converteren naar NUMBERS met slechts een paar regels code.
...
{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om JPEG naar getallen te converteren" %}}
