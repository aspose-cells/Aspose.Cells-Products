...
{{% blocks/products/pf/agp/content h2="Python を使用して TXT を FODS に変換します" %}}
...
次の例は、TXT を Python の FODS に変換する方法を示しています。
...
{{% blocks/products/pf/agp/content h2="Python経由でTXTをFODSに変換する方法" %}}
