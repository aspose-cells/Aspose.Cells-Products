...
weight: 6070
description: C++ exempelkod för att låsa upp lösenordsskyddad XLSM fil på C++ Runtime Environment för Windows 32 bitar, Windows 64 bitar och Linux 64 bitar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lås upp XLSM filer via C++" h2="Ta bort skyddet från Excel-kalkylblad inklusive XLSM-filen med hjälp av C++ Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man tar bort skyddet för XLSM-filen med C++" %}}

 För att låsa upp filen XLSM kommer vi att använda
