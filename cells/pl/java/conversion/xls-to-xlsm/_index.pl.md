...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLS na XLSM przez Java" h2="Konwersja XLS do XLSM Java w celu konwersji jednej lub wielu stron do formatu XLSM przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na XLSM za pomocą Java" %}}

 Aby renderować XLS do XLSM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLS na XLSM za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik XLS na XLSM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLS z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLSM i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLSM
...
{{% blocks/products/pf/agp/code-block title="XLS do XLSM Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik XLS w instancji Workbook
Workbook book = new Workbook("template.xls");
// zapisz XLS jako XLSM
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją XLS do XLSM" sectionDescription="[Konwertuj XLS na XLSM](https://products.aspose.app/cells/conversion/xls-to-xlsm) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLS, zostanie on natychmiast przekonwertowany na XLSM." >}}
