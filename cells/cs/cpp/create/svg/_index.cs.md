---
title: Vytvořit SVG - Vytvořit soubor SVG v C++
description: Aspose Excel. Snadno generujte a manipulujte se soubory SVG pomocí knihovny Aspose.Cells for C++. Tato výkonná knihovna API poskytuje efektivní řešení pro vytváření, úpravu a správu souborů SVG přímo ve vašich aplikacích C++ a splňuje specifické potřeby vývojářů s vysokou přesností.
...
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořte soubor SVG v C++" h2="Nativní a vysoce výkonné vytváření souborů SVG programově bez aplikace Microsoft Office pomocí knihovny C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit SVG v C++" %}}

{{% blocks/products/pf/agp/text %}}

 Pro vývojáře je snadné vytvářet, načítat, upravovat a převádět soubory SVG v rámci běžících aplikací pro vytváření sestav pro zpracování dat v několika řádcích kódu.
...
1.  Uložte sešit jako soubor .svg pomocí metody Save().

{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor SVG v C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro vytvoření souboru SVG" %}}
