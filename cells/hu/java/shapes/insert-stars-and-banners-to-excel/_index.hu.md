...
{{% blocks/products/pf/agp/content h2="Csillag/szalaghirdetés beszúrása Excel fájlba a Java használatával" %}}

 Az Insert Star/Banner excel fájlba való beillesztéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A csillag/szalaghirdetés beszúrásának lépései a via Java-es Excel-fájlba" %}}
...
{{% blocks/products/pf/agp/code-block title="Csillag/szalaghirdetés beszúrása - Java" offSpacer="" %}}
