---
title:  Cara Menggambar atau Memasukkan Bentuk Siku Ke Excel via .NET
weight: 101
description: Kode sumber C# untuk menggambar atau menyisipkan bentuk siku ke dalam Excel pada Kerangka .NET, Inti .NET, Mono atau Platform Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan bentuk siku ke dalam Excel via .NET" h2="Masukkan bentuk siku menggunakan Aspose.Cells\' API tanpa software seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[menambahkan metode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) untuk menyisipkan bentuk siku di lembar kerja yang dipilih
...
{{% blocks/products/pf/agp/code-block title="Sisipkan bentuk siku - C#" offSpacer="" %}}
