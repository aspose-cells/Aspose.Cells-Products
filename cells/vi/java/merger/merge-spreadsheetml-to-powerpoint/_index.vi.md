---
title:  Hợp nhất SPREADSHEETML với POWERPOINT via Java
url: /vi/java/merger/merge-spreadsheetml-to-powerpoint/ 
description: Hợp nhất SPREADSHEETML với POWERPOINT trực tuyến miễn phí. Sáp nhập SPREADSHEETML trực tuyến miễn phí vào POWERPOINT. Hợp nhất SPREADSHEETML sang Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS và hơn thế nữa.
---
...
Ví dụ sau minh họa cách hợp nhất SPREADSHEETML với POWERPOINT trong Java.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất SPREADSHEETML với POWERPOINT trực tuyến" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
