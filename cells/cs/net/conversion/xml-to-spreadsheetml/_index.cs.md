---
title: C# XML do SPREADSHEETML – online převodník XML do SPREADSHEETML
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online zdarma C# Převést XML do formátu pro uložení SPREADSHEETML. C# XML do formátu SPREADSHEETML. Uložit XML do SPREADSHEETML C#.
...
{{% blocks/products/pf/agp/content h2="Uložit XML do SPREADSHEETML v C# Online zdarma" %}}

Následující příklad ukazuje, jak převést XML na SPREADSHEETML v C#.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod XML na SPREADSHEETML online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xml" IsLandingPage="true" %}}
...
1.  Převeďte XML na SPREADSHEETML voláním metody Workbook.Save.
1.  Získejte výsledek převodu XML na SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# knihovna pro převod XML do SPREADSHEETML" %}}
