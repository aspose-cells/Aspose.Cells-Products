---
title: Konversi JSON ke PDF melalui Java 
weight: 2950

description: Contoh Java kode konversi untuk format JSON ke file PDF. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke PDF dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi JSON ke PDF melalui Java" h2="Ekspor JSON ke format PDF melalui Java tanpa memerlukan alat atau pustaka tambahan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi JSON ke PDF Menggunakan Java" %}}

 Untuk merender JSON ke PDF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi JSON ke PDF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Pengembang dapat dengan mudah mengonversi file JSON ke PDF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Buat instance baru dari kelas Workbook1. Pilih default atau Lembar Kerja apa pun dari koleksi1. Muat data JSON dari file1. Buat instance JsonLayoutOptions & atur opsi1. Panggil metode JsonUtility.importData dengan mengacu pada Lembar Kerja & data1. Simpan Buku Kerja dalam format PDF
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum menggunakan contoh kode sumber, pastikan Anda memiliki prasyarat berikut.
...
{{% blocks/products/pf/agp/code-block title="JSON ke PDF Java Kode Sumber Konversi" offSpacer="" %}}
...
// simpan file yang dihasilkan dalam format JSON-TO-PDF
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi JSON ke PDF" sectionDescription="[Konversi JSON ke PDF](https://products.aspose.app/cells/conversion/json-to-pdf) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file JSON Anda, itu akan langsung dikonversi ke PDF." >}}
