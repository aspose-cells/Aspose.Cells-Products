---
title: Gabung SXC ke HTML - Gabungkan SXC ke HTML di Java
url: /id/java/merger/merge-sxc-to-html/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge SXC to HTML saveformat. Java Gabungkan format SXC menjadi HTML. Gabung SXC ke HTML di Java. SXC Gabung.
...
Contoh berikut menunjukkan cara menggabungkan SXC ke HTML di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan SXC ke HTML di Java" InputFormat="sxc" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC ke HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SXC menjadi HTML secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
