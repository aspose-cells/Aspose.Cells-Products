---
title: Combinar XLS a SVG - Combinar XLS a SVG en Java
url: /es/java/merger/merge-xls-to-svg/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLS a SVG guardar formato. Java Combina el formato XLS con el SVG. Combinar XLS a SVG en Java. XLS Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLS a SVG en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLS con SVG en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLS a SVG. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo SVG. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que combina XLS con SVG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLS a SVG en Java" InputFormat="xls" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLS a SVG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLS con SVG mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar XLS a SVG" %}}
