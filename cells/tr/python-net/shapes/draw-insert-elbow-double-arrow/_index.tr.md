---
title: Python via .Net kullanarak Excel'e dirsek çift ok şekli nasıl çizilir veya eklenir?
weight: 10
description: Python via .Net kaynak kodu, Excel'e dirsek çift ok şeklini eklemek için.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via .Net\'i kullanarak dirsek çift ok şeklini Excel\'e ekleyin" h2="Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan Aspose.Cells\' API\'i kullanarak çift oklu dirseği ekleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Shapecollection'ın eklentisini kullanın[yöntem](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)Seçilen çalışma sayfasına dirsek çift ok şekli eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Çift ok şekilli dirsek ekleme parçası - Python via .Net" offSpacer="" %}}
