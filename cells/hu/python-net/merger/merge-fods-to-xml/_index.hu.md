...
url: /hu/python-net/merger/merge-fods-to-xml/ 
...
A következő példa bemutatja, hogyan egyesítheti a FODS-et XML-be a Aspose.Cells for Python via .NET-ben.
...
Programozottan egyesítenie kell a FODS-et XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
