...
Trzeba programowo przekonwertować pliki PNG do formatu HTM? Programiści C++ mogą łatwo przekonwertować pliki PNG do formatu HTM za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj PNG do HTM wywołując metodę Save().
