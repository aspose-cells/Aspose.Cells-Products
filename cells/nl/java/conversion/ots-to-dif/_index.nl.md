...
{{% blocks/products/pf/agp/content h2="Sla OTS op in DIF in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar DIF converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar DIF via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar DIF? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar DIF met slechts een paar regels code.
