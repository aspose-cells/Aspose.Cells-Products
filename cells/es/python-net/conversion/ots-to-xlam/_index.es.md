...
description: Aspose Excel. Convierta OTS a XLAM rápida y fácilmente con Aspose.Cells. Python OTS a XLAM. Python Guarde OTS en XLAM. Guarde OTS como XLAM usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar OTS al XLAM en Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a XLAM en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir OTS a XLAM" %}}
