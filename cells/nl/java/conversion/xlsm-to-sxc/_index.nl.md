...
{{% blocks/products/pf/agp/content h2="Sla XLSM op in SXC in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSM omzet naar SXC in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar SXC of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSM programmatisch converteren naar SXC? Ontwikkelaars van Java kunnen bestanden met de extensie XLSM eenvoudig converteren naar SXC met slechts een paar regels code.
