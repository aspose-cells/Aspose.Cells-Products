---
title:  Συγχώνευση PRN σε HTM μέσω C++
url: /el/cpp/merger/merge-prn-to-htm/ 
description: Συγχώνευση PRN στο HTM Online δωρεάν. Δωρεάν διαδικτυακή συγχώνευση PRN σε HTM. Συγχώνευση PRN σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN με το HTM στο C++.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση PRN με HTM σε απευθείας σύνδεση" InputFormat="prn" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
