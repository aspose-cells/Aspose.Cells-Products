---
title: Convertir XLSB en ET Java
description: Convertissez XLSB en ET Online gratuitement. Convertisseur en ligne gratuit XLSB en ET. Java XLSB à ET. XLSB à ET via Java.
keywords: Convert XLSB, XLSB Converter, XLSB to PDF, XLSB to Word, XLSB to PPT, XLSB to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en ET via Java" h2="Conversion XLSB en ET Java pour convertir une ou plusieurs pages en ET à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs de Java peuvent facilement convertir XLSB en ET en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier XLSB avec une instance de la classe Workbook
1.  Convertir XLSB en ET en appelant la méthode Workbook.save
