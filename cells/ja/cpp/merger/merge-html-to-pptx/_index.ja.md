...
url: /ja/cpp/merger/merge-html-to-pptx/ 
description: Aspose エクセル。 C++ Aspose.Cells。HTML を PPTX の保存形式にマージします。 C++ HTML と PPTX の形式を結合します。 HTML から PPTX を C++ に結合します。HTML を結合します。
...
次の例は、HTML を Aspose.Cells for C++ の PPTX にマージする方法を示しています。
...
{{% blocks/products/pf/agp/content h2="C++ HTML を PPTX にマージするライブラリ" %}}
