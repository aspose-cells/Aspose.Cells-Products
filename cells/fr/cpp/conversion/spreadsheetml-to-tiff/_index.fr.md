---
title: Convertir SPREADSHEETML en TIFF via l'application C++ 
url: /fr/cpp/conversion/spreadsheetml-to-tiff/ 
description: Exemple de code de conversion C++ pour le document SPREADSHEETML au format TIFF. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de SPREADSHEETML en TIFF dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir SPREADSHEETML en TIFF via C++" h2="Conversion SPREADSHEETML vers TIFF haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir SPREADSHEETML en TIFF à l\'aide de C++" %}}

 Pour convertir SPREADSHEETML en TIFF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SPREADSHEETML en TIFF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir le fichier SPREADSHEETML en TIFF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier SPREADSHEETML à l'aide de Factory :: CreateIWorkbook.1. Sélectionnez la première feuille de calcul.1. Définir les options (TIFF).1. Parcourez chaque page de la feuille et effectuez le rendu.1. Ouvrez le fichier TIFF dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion SPREADSHEETML vers TIFF C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion SPREADSHEETML en TIFF" sectionDescription="[Convertir SPREADSHEETML en TIFF](https://products.aspose.app/cells/conversion/spreadsheetml-to-tiff) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier SPREADSHEETML, il sera converti instantanément en TIFF." >}}
