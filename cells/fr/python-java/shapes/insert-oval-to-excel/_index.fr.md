...
{{% blocks/products/pf/agp/content h2="Comment insérer un ovale dans un fichier Excel à l\'aide de Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer un fichier Oval dans Excel en utilisant Python via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addOval(int,%20int,%20int,%20int,%20int,%20int)) pour insérer un ovale dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insert Ovale - Python via Java" offSpacer="" %}}
