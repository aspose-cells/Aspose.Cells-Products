---
title:  Rechercher le document XLSM sans ouvrir via C++
weight: 9280
description: C++ exemple de code pour rechercher des mots avec le modèle dans le fichier XLSM sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Rechercher les formats XLSM dans C++" h2="Recherche de documents XLSM native et hautes performances à l\'aide d\'API côté serveur Aspose.Cells for C++, sans l\'utilisation d\'un logiciel tel que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
Charger le fichier XLSM en instanciant une classe IWorkbook.
...
+ Enregistrer le fichier XLSM en utilisant la méthode IWorkbook->Save(.).
