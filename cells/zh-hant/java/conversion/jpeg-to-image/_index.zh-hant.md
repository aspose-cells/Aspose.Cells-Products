...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 JPEG 轉換為 IMAGE。Java JPEG 轉換為 IMAGE。 Java 將 JPEG 儲存到影像。使用 Java 將 JPEG 儲存為 IMAGE。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 JPEG 轉換為 Java 中的 IMAGE" h2="用於將 JPEG 轉換為 IMAGE 的高速 Java 庫。這是一個專業的軟體解決方案，可以使用Java導入和匯出JPEG、IMAGE和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% cells-convert title="將 JPEG 轉換為 IMAGE 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="png" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 JPEG 轉換為影像 via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 JPEG 檔案轉換為 IMAGE？ Java 開發人員只需幾行程式碼即可輕鬆將 JPEG 轉換為 IMAGE。
