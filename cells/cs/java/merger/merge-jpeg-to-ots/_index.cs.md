...
description: Aspose Excel. Java Aspose.Cells. Sloučit JPEG do formátu uložení OTS. Java Zkombinujte JPEG do formátu OTS. Sloučit JPEG do OTS v Java. JPEG Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG na OTS v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení JPEG do OTS v Java" InputFormat="jpg" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
