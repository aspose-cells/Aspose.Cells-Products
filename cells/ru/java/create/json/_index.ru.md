...
description: Aspose Excel. Java Создать файл JSON. Создать JSON Java. Java JSON Создатель. Создайте JSON в Java. Создайте файл JSON, используя Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчикам легко создавать, загружать, изменять и преобразовывать файлы JSON в рамках запуска различных приложений отчетности для обработки данных всего за несколько строк кода.
...
1.  Сохраните книгу в формате JSON, используя метод save().
