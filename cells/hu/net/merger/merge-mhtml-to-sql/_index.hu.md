---
title: A MHTML egyesítése SQL-be – MHTML egyesítése SQL-be a C#-ben
url: /hu/net/merger/merge-mhtml-to-sql/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés MHTML SQL mentési formátumba. C# Kombinálja a MHTML-et SQL formátumba. A MHTML egyesítése SQL-be a C#-ben. MHTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a MHTML-et SQL-lel a C#-ben online" %}}

A következő példa bemutatja, hogyan egyesítheti a MHTML-et az SQL-lel a Aspose.Cells for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a MHTML SQL-be olvasztásához. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SQL fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a MHTML-et SQL-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a MHTML-es SQL-lel a C#-ben" InputFormat="mhtml" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML egyesítése SQL-be a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et az SQL-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML SQL-be olvasztásához" %}}
