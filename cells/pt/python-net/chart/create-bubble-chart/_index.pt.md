...
description: Python Código de exemplo para criação de gráficos de bolhas para Excel usando a Biblioteca Python. Use este código para criar um gráfico de bolhas para MS Excel no aplicativo baseado em Python.
...
1. Adicione um gráfico de bolhas à planilha
