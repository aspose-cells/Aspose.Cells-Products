---
title: Gabungkan XLSB menjadi CSV - Gabungkan XLSB menjadi CSV menjadi C#
url: /id/net/merger/merge-xlsb-to-csv/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSB menjadi CSV format simpan. C# Gabungkan format XLSB menjadi CSV. Gabungkan XLSB menjadi CSV di C#. XLSB Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSB menjadi CSV di C#" %}}

Contoh berikut menunjukkan cara menggabungkan XLSB menjadi CSV di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLSB ke CSV. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file CSV. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSB menjadi CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLSB menjadi CSV di C#" InputFormat="xlsb" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSB menjadi CSV melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSB ke CSV secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2=".NET perpustakaan untuk digabungkan XLSB menjadi CSV" %}}
