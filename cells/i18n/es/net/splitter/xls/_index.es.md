...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para dividir archivos XLS en C#" %}}
...
+ Cargue el archivo XLS con la ruta completa para dividir.
...
+ Llame al método Save() y pase el nombre del archivo (ruta completa) y SaveFormat.Xls como parámetro.
...
{{% blocks/products/pf/agp/code-block title="Dividir archivo XLS - C#" offSpacer="" %}}
