...
description: Aspose Excel'de. Aspose.Cells ile TSV'i hızlı ve kolay bir şekilde SQL'e dönüştürün. Python TSV'i SQL'e dönüştürün. Python TSV'i SQL'e kaydedin. TSV'i Python'i kullanarak SQL olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="TSV\'i Python\'i kullanarak SQL\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="TSV\'i Python\'de SQL\'e kaydedin" %}}

Aşağıdaki örnek, TSV'in Python'de SQL'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="TSV\'i SQL\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="sql" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="TSV\'i SQL\'e dönüştürmek için Python kitaplığı" %}}
