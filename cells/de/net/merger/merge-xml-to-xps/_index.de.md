...
url: /de/net/merger/merge-xml-to-xps/ 
...
Das folgende Beispiel zeigt, wie XML mit XPS in Aspose.Cells for .NET zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von XML mit XPS in C#" InputFormat="xml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie XML über C# mit XPS zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XML programmgesteuert mit XPS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von XML mit XPS" %}}
