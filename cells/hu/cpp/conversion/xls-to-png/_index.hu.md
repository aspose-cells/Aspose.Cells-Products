---
title: Konvertálja az XLS-t PNG-re a(z) C++ alkalmazással 
weight: 80

description: Minta C++ konverziós kód XLS-dokumentumhoz PNG formátumba. A programozók ezt a forráskódot használhatják kötegelt XLS-ből PNG-be konvertálásához bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS konvertálása PNG-re a következőn keresztül: C++" h2="Nagy teljesítményű XLS-ből PNG-be konvertálás a C++ könyvtár használatával Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatnak XLS-fájlt PNG-formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS fájlt a Factory::CreateIWorkbook segítségével.1. Válassza ki az első munkalapot.1. Állítsa be a (PNG) opciókat.1. Ismételje meg a lap minden oldalát, és jelenítse meg.1. Nyissa meg a PNG fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLS-ből PNG-be C++ konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS-ből PNG-be konvertáló élő bemutatók" sectionDescription="[Konvertálja az XLS-t PNG-re](https://products.aspose.app/cells/conversion/xls-to-png) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel XLS fájlját, és azonnal PNG formátumba konvertálódik." >}}
