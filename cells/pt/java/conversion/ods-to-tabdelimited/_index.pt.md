---
title: Converter ODS para TABDELIMITED via Java 

description: Exemplo de código de conversão Java para formato ODS para arquivo TABDELIMITED. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para TABDELIMITED em qualquer aplicativo baseado na Web ou Desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Como converter ODS para TABDELIMITED usando Java" %}}

 Para renderizar ODS para TABDELIMITED, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ODS em TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente o arquivo ODS para TABDELIMITED em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo ODS com uma instância da classe Workbook1. Chame o método Workbook.save1. Passe o caminho de saída com a extensão TABDELIMITED e SaveFormat como parâmetros1. Verifique o caminho especificado para o arquivo TABDELIMITED resultante
...
{{% blocks/products/pf/agp/code-block title="ODS para TABDELIMITED Java Código-fonte de conversão" offSpacer="" %}}

```cs
// carregar o arquivo ODS em uma instância do Workbook
Workbook book = new Workbook("template.ods");
// salvar ODS como TABDELIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de ODS para TABDELIMITED" sectionDescription="[Converter ODS para TABDELIMITED](https://products.aspose.app/cells/conversion/ods-to-tabdelimited) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo ODS, ele será convertido instantaneamente para TABDELIMITED." >}}
