---
title:  Combinar TXT a XLTX vía Python
url: /es/python-net/merger/merge-txt-to-xltx/ 
description: Combine TXT a XLTX en línea de forma gratuita. Gratis Online TXT a XLTX Fusión. Combine TXT con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar TXT con XLTX en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar TXT a XLTX en línea" InputFormat="txt" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
