---
title: A SXC-FODS-es számok egyesítése – a SXC-es és a FODS-es számok egyesítése a Java-ben
url: /hu/java/merger/merge-sxc-to-fods/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés SXC FODS mentési formátumba. Java A SXC és a FODS formátum kombinálása. Egyesítse a SXC-FODS-et a Java-ben. SXC Egyesítse.
...
{{< blocks/products/pf/i18n/upper-banner h1="A SXC és a FODS via Java számok egyesítése" h2="Nagysebességű Java könyvtár a SXC és FODS egyesítéséhez. Használja a API-es excel konverziónkat magas szintű, platformfüggetlen szoftver fejlesztésére a Java-ben. Ez egy professzionális szoftvermegoldás Excel, CSV, OpenOffice, PDF, HTML, image és sok más excel formátum importálásához és exportálásához." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="SXC" additionalConversionTag="FODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="A SXC és a FODS egyesítése a Java használatával" %}}

 Hogyan egyesíthetem a SXC és a FODS számokat? A Aspose.Cells for Java könyvtárral egyszerűen egyesítheti a SXC-et a FODS-es számokkal programozottan néhány sornyi kóddal.[Aspose.Cells for Java](https://products.aspose.com/cells/java) képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Java Excel API nem csak a táblázatformátumok között konvertál, hanem Excel fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, CSV, CSV, CSV, CSV, CSV, SVG, és így tovább, SVG P, 8 PT a választás,3,8 ipari szabvány szerinti dokumentumok cseréjére formátumok. A legújabb verziót közvetlenül a webhelyről töltheti le[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) és telepítse a Maven alapú projekten belül a következő konfigurációk hozzáadásával a pom.xml fájlhoz.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a SXC-es számokat a FODS-es számokhoz a Java-ben online ingyen" %}}

A következő példa bemutatja a SXC és a FODS egyesítését a Aspose.Cells for Java számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SXC-es és a FODS-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a FODS fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely egyesíti a SXC és FODS számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a SXC-FODS-es számok egyesítéséhez a Java-ben" InputFormat="sxc" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A SXC és a FODS via Java számok egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SXC-et a FODS-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a SXC és FODS egyesítéséhez" %}}
