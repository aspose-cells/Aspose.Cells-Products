---
title: C# FODS 轉 PRN - 在線 FODS 轉 PRN 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 FODS 轉換為 PRN 保存格式。 C# FODS 為 PRN 格式。將 FODS 保存至 PRN C#。
...
{{% blocks/products/pf/agp/content h2="免費在線將 FODS 保存到 C# 中的 PRN" %}}

以下示例演示如何將 FODS 轉換為 C# 中的 PRN。
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 FODS 轉換為 PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 FODS 轉換為 PRN" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 FODS 文件轉換為 PRN？ .NET 開發人員只需幾行代碼即可輕鬆加載 FODS 並將其轉換為 PRN。
