---
title: Voeg XLSM samen met XPS - Combineer XLSM met XPS in Python
url: /nl/python-java/merger/merge-xlsm-to-xps/ 
description: Aspose Excel. Python Aspose.Cells. Gratis online Samenvoegen XLSM naar XPS saveformat. Python Combineer het formaat XLSM tot XPS. Samenvoegen XLSM tot XPS in Python. XLSM Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u XLSM kunt samenvoegen met XPS in Aspose.Cells for Python via Java.
...
{{% cells-merger title="Gratis online om XLSM samen te voegen tot XPS in Python" InputFormat="xlsm" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSM samen te voegen met XPS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen tot XPS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
