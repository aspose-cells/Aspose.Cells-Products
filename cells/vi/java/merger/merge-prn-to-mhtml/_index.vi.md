---
title: Gộp PRN thành MHTML - Gộp PRN thành MHTML vào Java
url: /vi/java/merger/merge-prn-to-mhtml/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất PRN thành MHTML saveformat. Java Kết hợp PRN thành định dạng MHTML. Hợp nhất PRN thành MHTML trong Java. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN thành MHTML trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất PRN thành MHTML trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất PRN thành MHTML. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu vào tệp MHTML. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất PRN thành MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp PRN về MHTML trong Java" InputFormat="prn" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp PRN thành MHTML via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép PRN thành MHTML" %}}
