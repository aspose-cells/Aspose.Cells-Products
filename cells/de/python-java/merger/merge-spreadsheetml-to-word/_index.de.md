...
url: /de/python-java/merger/merge-spreadsheetml-to-word/ 
...
Das folgende Beispiel zeigt, wie SPREADSHEETML in Aspose.Cells for Python via Java mit WORD zusammengeführt wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie SPREADSHEETML programmgesteuert mit WORD zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs können mit nur wenigen Codezeilen erstellt werden.
