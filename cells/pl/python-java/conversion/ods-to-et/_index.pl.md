...
description: Aspose Excel. Szybko i łatwo przekonwertuj numer ODS na ET za pomocą Aspose.Cells. Python ODS na ET. Python Zapisz ODS w ET. Zapisz ODS jako ET, używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz ODS w ET w Python" %}}
...
{{% cells-convert title="Przykładowy kod do konwersji ODS na ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="et" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji ODS na ET" %}}
