---
title: Java HTM à SXC - Convertisseur HTM à SXC
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format HTM au format SXC, permettant un enregistrement transparent des données HTM au format SXC à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM à SXC dans Java" %}}

L'exemple suivant montre comment convertir HTM en SXC en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir du HTM en SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM au format SXC par programmation ? Les développeurs spécialisés en Java peuvent facilement convertir des fichiers HTM au format SXC en quelques lignes de code seulement.
...
1.  Convertissez HTM en SXC en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de HTM en SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir HTM en SXC" %}}
{{% blocks/products/pf/agp/text %}}
