---
title: Konvertálja a HTML-t JSON-ba a(z) C++ alkalmazáson keresztül 

description: Minta C++ konverziós kód HTML-dokumentumhoz JSON formátumba. A programozók ezt a forráskódot használhatják kötegelt HTML-ből JSON-ba konvertálásához bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="HTML konvertálása JSON-ba a következőn keresztül: C++" h2="Nagy teljesítményű HTML konvertálás JSON-ba a C++ könyvtár használatával Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="HTML konvertálása JSON-ba a következővel: C++" %}}

 HTML JSON-ba konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A HTML konvertálása JSON-ra a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatják a HTML-fájlt JSON-formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be HTML-fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (JSON) fájlkiterjesztéssel.1. A JSON-fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a JSON fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="HTML JSON C++ konverziós forráskód" offSpacer="" %}}
