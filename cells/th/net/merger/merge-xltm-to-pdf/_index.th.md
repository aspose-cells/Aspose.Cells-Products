---
title: รวม XLTM ถึง PDF - รวม XLTM ถึง PDF เป็น C#
url: /th/net/merger/merge-xltm-to-pdf/ 
description: Aspose เก่ง. C# Aspose.Cells. รวมออนไลน์ฟรี XLTM ถึง PDF saveformat. C# รวมรูปแบบ XLTM ถึง PDF รวม XLTM ถึง PDF ใน C# XLTM รวม
...
{{% blocks/products/pf/agp/content h2="รวม XLTM ถึง PDF ใน C# ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLTM ถึง PDF ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อผสาน XLTM ถึง PDF อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine สำหรับการผสานไฟล์ จากนั้นบันทึกลงในไฟล์ PDF หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่รวม XLTM ถึง PDF

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ออนไลน์ฟรีเพื่อรวม XLTM ถึง PDF ใน C#" InputFormat="xltm" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีผสาน XLTM ถึง PDF ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม XLTM ถึง PDF โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ห้องสมุด .NET เพื่อรวม XLTM ถึง PDF" %}}
