...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE dans PRN dans Java" %}}
...
{{% cells-convert title="Exemple de code pour convertir une IMAGE en PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir une IMAGE en PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE en PRN par programmation ? Les développeurs Java peuvent facilement convertir des fichiers IMAGE en PRN en quelques lignes de code seulement.
