...
description: Aspose Excel. Converteer XLSX snel en eenvoudig naar FODS met Aspose.Cells. Python XLSX naar FODS. Python Bewaar XLSX in FODS. Bewaar XLSX als 07611134 81 via Python.
...
{{% blocks/products/pf/agp/content h2="Bewaar XLSX t/m FODS in Python" %}}
...
{{% cells-convert title="Voorbeeldcode om XLSX naar FODS te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="fods" IsLandingPage="true" language="pythonnet" %}}
