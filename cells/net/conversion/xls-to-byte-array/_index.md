---
title: Convert XLS to Byte Array via C# 
weight: 7690
url: /net/conversion/xls-to-byte-array/ 
description: C# Sample code for XLS to Byte Array conversion. Use this code for Excel XLS to Byte Array conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLS to byte array via C#" h2="Native and high performance Microsoft Excel XLS to byte array conversion or vice versa for spreadsheets data processing using server side .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert XLS to Byte Array via C#" %}}
...
1.  Load input XLS File using Workbook
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XLS to byte array C# Conversion" offSpacer="" %}}
