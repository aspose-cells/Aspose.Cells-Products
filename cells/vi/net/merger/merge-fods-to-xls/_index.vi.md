...
url: /vi/net/merger/merge-fods-to-xls/ 
...
Ví dụ sau minh họa cách hợp nhất FODS thành XLS trong Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Cần hợp nhất FODS thành XLS theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất FODS thành XLS" %}}
