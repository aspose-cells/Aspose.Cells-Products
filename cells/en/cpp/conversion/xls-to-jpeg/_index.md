...
description: Sample C++ conversion code for XLS to JPEG format. Programmers can use this source code for batch XLS to JPEG conversion within any C++ Application.
---
