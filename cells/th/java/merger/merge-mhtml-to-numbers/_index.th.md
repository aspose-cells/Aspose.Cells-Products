---
title: รวม MHTML เป็น NUMBERS - รวม MHTML เป็น NUMBERS ใน Java
url: /th/java/merger/merge-mhtml-to-numbers/ 
description: Aspose เก่ง. Java Aspose.Cells รวมออนไลน์ฟรี MHTML เป็น NUMBERS รูปแบบการบันทึก Java รวม MHTML เป็นรูปแบบ NUMBERS รวม MHTML เป็น NUMBERS ใน Java MHTML รวม
...
{{% blocks/products/pf/agp/content h2="รวม MHTML เป็น NUMBERS ใน Java ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีรวม MHTML เป็น NUMBERS ใน Aspose.Cells for Java
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม MHTML เป็น NUMBERS อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ NUMBERS หากคุณพัฒนาโค้ดใน Java สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง Java ที่รวม MHTML เป็น NUMBERS

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ออนไลน์ฟรีเพื่อรวม MHTML เป็น NUMBERS ใน Java" InputFormat="mhtml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวม MHTML เป็น NUMBERS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม MHTML เป็น NUMBERS โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for Java](https://products.aspose.com/cells/java) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี Java เพื่อรวม MHTML เป็น NUMBERS" %}}
