...
{{% blocks/products/pf/agp/content h2="วิธีแทรกลูกศรตรงลงในไฟล์ Excel โดยใช้ Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกลูกศรตรงลงในไฟล์ Excel via Java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) เพื่อแทรกลูกศรตรงในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่ลูกศรตรง - Java" offSpacer="" %}}
