---
title: Python MHT naar PRN - Online MHT naar PRN Converter
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Gratis online Python Converteer MHT naar PRN-opslagformaat. Python MHT naar PRN-formaat. Sla MHT op naar PRN Python.
...
{{% blocks/products/pf/agp/content h2="Converteer MHT naar PRN in Python" %}}
 ...
 Hoe converteer ik MHT naar PRN? Met Aspose.Cells for Python via NET bibliotheek, kunt u eenvoudig MHT naar PRN programmatisch converteren met een paar regels code.[Aspose.Cells for Python via NET](https://pypi.org/project/aspose-cells-python/)is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaard formaten.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Sla MHT gratis op naar PRN in Python online" %}}

Het volgende voorbeeld laat zien hoe u MHT naar PRN converteert in Python via NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHT naar PRN te converteren. Upload uw MHT-bestand en sla het eenvoudig op als PRN-bestand. Voor zowel MHT-lezen als PRN-schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De uitvoer PRN-inhoud en opmaak zijn identiek aan het originele MHT-document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Gratis app en voorbeeldcode om MHT online naar PRN te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="prn" IsLandingPage="true" language="pythonnet" %}}
...
1.  Converteer MHT naar PRN door de methode Workbook.save aan te roepen.
