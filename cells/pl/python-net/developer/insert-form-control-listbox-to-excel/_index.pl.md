---
title:  Wstaw ListBox (kontrolkę formularza) do programu Excel przy użyciu Python via .Net
weight: 50
description: Python via Kod źródłowy .Net umożliwiający wstawienie ListBox (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić ListBox (kontrolkę formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić ListBox (kontrolkę formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj dodatku do kolekcji kształtów[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_list_box/#int-int-int-int-int-int) aby wstawić ListBox (kontrolkę formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw ListBox (kontrolka formularza) - Python via .Net" offSpacer="" %}}
