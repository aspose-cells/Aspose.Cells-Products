...
هل تحتاج إلى تحويل ملفات MHT إلى XLAM برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى XLAM بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLAM عن طريق استدعاء دالة Save().
