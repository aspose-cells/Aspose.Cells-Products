---
title: TSV-Dateien über Java zusammenführen 
weight: 9260
url: /de/java/merger/tsv/ 
description: Java Beispielcode zum Kombinieren von TSV-Dokumenten in Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV-Formate in Java zusammenführen" h2="Native TSV-Dokumentzusammenführung mit serverseitigen Java-APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="So führen Sie TSV-Dateien mit Java zusammen" %}}

 Um die TSV-Datei zusammenzuführen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zusammenführen von TSV-Dateien in Java" %}}
...
+ Laden Sie die erste TSV-Datei mit einer Instanz der Workbook-Klasse.
+ Laden Sie das zweite TSV-Dokument mit einer Instanz der Workbook-Klasse.
+ Dateien mit der Combine()-Methode zusammenführen.
+ Speichern Sie die zusammengeführte TSV-Datei unter dem angegebenen Pfad
...
{{% blocks/products/pf/agp/code-block title="TSV-Dateien zusammenführen - Java" offSpacer="" %}}

```cs
// Öffnen Sie die erste TSV-Datei.
Workbook tsvFile1 = new Workbook("chartsFileWithPath.tsv");

// Definieren Sie das zweite Quellenbuch.
// Öffnen Sie die zweite TSV-Datei.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API kann zum Erstellen, Bearbeiten, Konvertieren und Rendern von Microsoft Excel-Formaten in verschiedene Formate verwendet werden. Darüber hinaus kann es für umfassende Diagramme, skalierbare Berichte und zuverlässige Berechnungen innerhalb von Softwareanwendungen verwendet werden. Aspose.Cells ist ein eigenständiges API und erfordert keine Software wie Microsoft oder OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online-Live-Demos der TSV-Fusion" sectionDescription="Führen Sie jetzt TSV-Dokumente zusammen, indem Sie unsere besuchen [Live-Demos-Website](https://products.aspose.app/cells/merger). Die Live-Demo hat die folgenden Vorteile" >}}
