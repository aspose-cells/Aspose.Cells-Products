...
description: Aspose Excel'de. Java Aspose.Cells. ODS'i HTM kaydetme biçimiyle birleştirin. Java ODS'i HTM formatıyla birleştirin. ODS'i Java'deki HTM ile birleştirin. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'deki HTM ile birleştir" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'deki HTM ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="ODS\'i Java\'deki HTM ile Birleştirmek için Örnek Kod" InputFormat="ods" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i HTM via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

ODS'i HTM ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, ODS\'i HTM ile birleştirecek" %}}
