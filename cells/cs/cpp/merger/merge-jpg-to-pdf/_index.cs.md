---
title: Sloučit JPG s PDF - Sloučit JPG s PDF v C++
url: /cs/cpp/merger/merge-jpg-to-pdf/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit JPG do formátu uložení PDF. C++ Zkombinujte JPG do formátu PDF. Sloučit JPG na PDF v C++. Sloučit JPG.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG na PDF v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JPG s PDF v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do PDF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PDF. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do PDF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit JPG na PDF přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit JPG na PDF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do PDF" %}}
