...
description: Aspose Excel. Převeďte TSV na ET rychle a snadno pomocí Aspose.Cells. C++ TSV na ET. C++ Uložte TSV do ET. Uložte TSV jako ET pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Uložte TSV do ET v C++" %}}

Následující příklad ukazuje, jak převést TSV na ET v C++.
...
{{% cells-convert title="Ukázkový kód pro převod TSV na ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="et" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést TSV na ET přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory TSV na ET programově? Vývojáři C++ mohou snadno převést TSV na ET v několika řádcích kódu.
...
1. Převeďte TSV na ET voláním metody Save().
