...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde BMP Dosyası oluşturun. Java'i kullanarak BMP dosyası oluşturun. Java'de BMP oluşturun. Java BMP Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını BMP biçiminde kaydedin.
