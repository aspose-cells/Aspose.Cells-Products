---
title: C++ PRN 至 MHT - 在線 PRN 至 MHT 轉換器
description: Aspose Excel。 C++ Aspose.Cells。C++ Aspose Cells。免費在線 C++ 將 PRN 轉換為 MHT 保存格式。 C++ PRN 轉 MHT 格式。將 PRN 保存到 MHT C++。
...
{{% blocks/products/pf/agp/content h2="免費在線將 C++ 中的 PRN 保存為 MHT" %}}

以下示例演示如何將 C++ 中的 PRN 轉換為 MHT。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 PRN 轉換為 MHT。上傳您的 PRN 文件，然後將其保存為 MHT 文件。對於 PRN 讀取和 MHT 寫入，您可以使用完全限定的文件名。輸出 MHT 內容和格式將與原始 PRN 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 PRN 在線轉換為 MHT 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="mht" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C++ 將 PRN 轉換為 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 PRN 文件轉換為 MHT？ C++ 開發人員只需幾行代碼即可輕鬆將 PRN 轉換為 MHT。
...
1. 通過調用 Save() 方法將 PRN 轉換為 MHT。
1. 獲取PRN到MHT的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ 將 PRN 轉換為 MHT 的庫" %}}
