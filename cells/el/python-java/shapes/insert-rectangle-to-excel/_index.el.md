---
title:  Εισαγάγετε το Rectangle στο Excel μέσω του Python
weight: 10
description: Python πηγαίος κώδικας για εισαγωγή του Rectangle στο Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Εισαγάγετε το Rectangle στο Excel μέσω του Python" h2="Εισαγάγετε αντικείμενα χρησιμοποιώντας API από την πλευρά του διακομιστή χωρίς λογισμικό όπως Microsoft ή Open Office, Adobe PDF κ.λπ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να εισαγάγετε το ορθογώνιο σε αρχείο Excel χρησιμοποιώντας το Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την εισαγωγή του αρχείου Rectangle στο Excel μέσω του Python" %}}
...
+ Επιλέξτε Φύλλο εργασίας μέσω του ευρετηρίου του.
 + Χρησιμοποιήστε τα shapecollection's[μέθοδος προσθήκης](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addRectangle(int,%20int,%20int,%20int,%20int,%20int)) για να εισαγάγετε ένα ορθογώνιο στο επιλεγμένο φύλλο εργασίας.
...
{{% blocks/products/pf/agp/code-block title="Εισαγάγετε ορθογώνιο - Python" offSpacer="" %}}
