---
title: C# FODS 轉 PowerPoint - FODS 轉 PowerPoint 轉換器
description: Aspose Excel。此綜合解決方案為 C# 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 POWERPOINT 格式，從而能夠使用 Aspose.Cells 庫將 FODS 數據保存為 POWERPOINT 格式，所有這些庫將 FODS 數據保存為 POWERPOINT 格式，所有這些都通過高效可自訂的 7617617676176761767617676717676217676762。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 POWERPOINT 格式，格式為 C#" h2="高速 C# 庫，用於將 FODS 檔案轉換為 POWERPOINT 檔案。這是一個專業的軟體解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 FODS、POWERPOINT 和許多其他格式的檔案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POWERPOINT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 POWERPOINT 中，檔案名稱為 C#" %}}

以下範例示範如何將 FODS 轉換為 C# 中的 POWERPOINT。
{{% blocks/products/pf/agp/text %}}

請依照以下簡單步驟將 FODS 檔案轉換為 PowerPoint 檔案。上傳您的 FODS 文件，然後將其另存為 PowerPoint 文件即可。讀取 FODS 檔案和寫入 PowerPoint 檔案時，均可使用完整檔案名稱。輸出的 PowerPoint 文件的內容和格式將與原始 FODS 文件完全相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 FODS 轉換為 POWERPOINT 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 POWERPOINT" %}}

{{% blocks/products/pf/agp/text %}}

需要透過程式將 FODS 檔案轉換為 POWERPOINT 檔案嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入 FODS 檔案並將其轉換為 POWERPOINT 檔案。
...
1. 使用工作簿實例載入 FODS 檔案。
1. 透過呼叫 Workbook.Save 方法將 FODS 轉換為 POWERPOINT。
1. 將 FODS 轉換為 POWERPOINT 格式。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="使用 C# 函式庫將 FODS 轉換為 POWERPOINT" %}}
