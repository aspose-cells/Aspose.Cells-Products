...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS in SPREADSHEETML in C#" %}}

Das folgende Beispiel zeigt, wie man OTS in C# in SPREADSHEETML konvertiert.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS in SPREADSHEETML über C#" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in SPREADSHEETML konvertieren? .NET-Entwickler können OTS mit nur wenigen Codezeilen problemlos in SPREADSHEETML laden und konvertieren.
...
{{% blocks/products/pf/agp/content h2="C# Bibliothek zur Konvertierung von OTS in SPREADSHEETML" %}}
