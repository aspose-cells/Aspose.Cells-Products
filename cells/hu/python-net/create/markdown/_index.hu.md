...
{{% blocks/products/pf/agp/content h2="A MARKDOWN létrehozása a Python-ben" %}}
...
{{% blocks/products/pf/agp/content h2="Python könyvtárat a MARKDOWN fájl létrehozásához" %}}
