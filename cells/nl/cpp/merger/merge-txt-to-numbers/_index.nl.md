---
title: Voeg TXT samen met NUMBERS - Combineer TXT met NUMBERS in C++
url: /nl/cpp/merger/merge-txt-to-numbers/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen TXT naar NUMBERS opslagformaat. C++ Combineer TXT tot NUMBERS formaat. Voeg TXT samen tot NUMMERS in C++. TXT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met NUMBERS in C++ Online gratis" %}}

Het volgende voorbeeld laat zien hoe u TXT kunt samenvoegen tot NUMBERS in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TXT samen te voegen met NUMBERS. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het NUMBERS-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat TXT samenvoegt tot NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om TXT samen te voegen tot NUMMERS in C++" InputFormat="txt" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe TXT samen te voegen tot NUMMERS via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met NUMBERS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TXT samen te voegen tot NUMBERS" %}}
