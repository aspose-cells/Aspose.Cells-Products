...
{{% blocks/products/pf/agp/content h2="How to Merge MHTML to CSV File in Python" %}}
...
{{% cells-merger title="Free App to merge Excel files on line" InputFormat="mhtml" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
