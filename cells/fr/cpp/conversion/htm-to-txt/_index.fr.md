...
{{% cells-convert title="Exemple de code pour convertir HTM en TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="txt" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en TXT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en TXT par programme ? Les développeurs C++ peuvent facilement convertir HTM en TXT en quelques lignes de code seulement.
...
1.  Convertissez HTM en TXT en appelant la méthode Save().
