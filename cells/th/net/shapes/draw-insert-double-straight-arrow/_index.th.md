---
title:  ฉันจะวาดหรือแทรกลูกศรตรงคู่ลงใน Excel via .NET ได้อย่างไร
weight: 10
description: C# ตัวอย่างโค้ดเพื่อเพิ่มหรือแทรกลูกศรตรงคู่ลงใน Excel โดยใช้ .NET Library ใช้รหัสนี้เพื่อสร้างลูกศรตรงคู่ใน MS Excel ภายใน VB.NET, Asp.NET หรือแอปพลิเคชันที่ใช้ .NET ใด ๆ
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกลูกศรตรงคู่ลงในไฟล์ Excel ผ่านทาง C#" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline)เพื่อแทรกลูกศรตรงคู่ในแผ่นงานที่เลือก
