---
title:  أدخل القوس في Excel via Java
weight: 10
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج القوس في ملف Excel باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج ملف Arc to Excel via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addArc-int-int-int-int-int-int-) لإدراج قوس في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل القوس - Java" offSpacer="" %}}
