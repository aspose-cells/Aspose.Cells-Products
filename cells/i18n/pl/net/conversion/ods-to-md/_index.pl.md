---
title: Konwertuj ODS na MD przez C#
url: /pl/net/conversion/ods-to-md/
description: Przykładowy kod konwersji ods do md C#. Użyj przykładowego kodu API dla wsadowych plików ods do konwersji md w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ODS na MD przez C#" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu MD na platformach .NET Framework, .NET Core, Mono lub Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki ODS na MD w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ODS z wystąpieniem Workbook1. Wywołaj metodę Workbook.Save1. Przepuścić ścieżkę wyjściową z rozszerzeniem MD jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku MD
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji ODS na MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="md" IsLandingPage="true" %}}
