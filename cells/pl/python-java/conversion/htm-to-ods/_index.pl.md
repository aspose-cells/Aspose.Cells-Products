...
description: Aspose Excel. Konwertuj HTM na ODS szybko i łatwo za pomocą Aspose.Cells. Python HTM na ODS. Python Zapisz HTM na ODS. Zapisz HTM jako ODS, używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na ODS za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM pod numerem ODS w Python" %}}

Poniższy przykład ilustruje sposób konwersji HTM na ODS w Python.
...
{{% cells-convert title="Przykładowy kod do konwersji HTM na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="ods" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji HTM na ODS" %}}
