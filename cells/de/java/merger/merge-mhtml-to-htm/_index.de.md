---
title: MHTML mit HTM zusammenführen - MHTML mit HTM in Java kombinieren
url: /de/java/merger/merge-mhtml-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. MHTML in das HTM-Speicherformat zusammenführen. Java Kombinieren Sie MHTML zum HTM-Format. MHTML zu HTM in Java zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="MHTML mit HTM in Java zusammenführen" %}}

Das folgende Beispiel zeigt, wie MHTML mit HTM in Aspose.Cells for Java zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von MHTML mit HTM in Java" InputFormat="mhtml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie MHTML mit HTM via Java zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie MHTML programmgesteuert mit HTM zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Java](https://products.aspose.com/cells/java) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Zusammenführen von MHTML mit HTM" %}}
