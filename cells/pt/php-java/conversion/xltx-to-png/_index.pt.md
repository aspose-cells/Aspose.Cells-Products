---
title: Conversor PHP XLTX para PNG - XLTX para PNG
description: Aspose Excel. Converta XLTX em PNG de forma rápida e fácil com Aspose.Cells. PHP XLTX em PNG. PHP Salve XLTX em PNG. Salve XLTX como PNG usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em PNG via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em PNG programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em PNG em apenas algumas linhas de código.
...
1.  Converta XLTX em PNG chamando o método save da pasta de trabalho.
