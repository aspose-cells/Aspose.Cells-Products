---
title: Convierta XLSX a SPREADSHEETML a través de Java 
url: /es/java/conversion/xlsx-to-spreadsheetml/ 
description: Ejemplo de código de conversión Java de formato XLSX a archivo SPREADSHEETML. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a SPREADSHEETML dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta XLSX a SPREADSHEETML a través de Java" h2="Conversión de XLSX a SPREADSHEETML Java para convertir una o varias páginas a SPREADSHEETML mediante la biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLSX a SPREADSHEETML usando Java" %}}

 Para convertir XLSX en SPREADSHEETML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLSX a SPREADSHEETML a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente archivos XLSX a SPREADSHEETML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLSX con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión SPREADSHEETML y SaveFormat como parámetros1. Verifique la ruta especificada para el archivo SPREADSHEETML resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLSX a SPREADSHEETML Java" offSpacer="" %}}

```cs
// cargar el archivo XLSX en una instancia de Workbook
Workbook book = new Workbook("template.xlsx");
// guardar XLSX como HOJA DE CALCULO
