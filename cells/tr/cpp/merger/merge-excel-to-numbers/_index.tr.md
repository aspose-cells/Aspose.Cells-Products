...
url: /tr/cpp/merger/merge-excel-to-numbers/ 
...
Aşağıdaki örnek, EXCEL'in Aspose.Cells for C++'de SAYILAR ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 EXCEL'i programlı olarak NUMBERS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i NUMBERS ile birleştirmek için C++ kitaplığı" %}}
