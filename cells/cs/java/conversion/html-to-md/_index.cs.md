---
title: Java HTML do MD - HTML do MD převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu HTML do formátu MD, což umožňuje bezproblémové ukládání dat HTML do formátu MD pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte HTML na MD v Java" h2="Vysokorychlostní knihovna Java pro převod HTML do MD. Toto je profesionální softwarové řešení pro import a export HTML, MD a mnoha dalších formátů s použitím Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete HTML do MD v Java" %}}

Následující příklad ukazuje, jak převést číslo HTML na MD v kódu Java.
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory HTML do formátu MD? Vývojáři Java mohou snadno převést soubory HTML do formátu MD pomocí několika řádků kódu.
...
1.  Převeďte číslo HTML na MD voláním metody Workbook.save.
1.  Získejte výsledek převodu HTML na MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod HTML na MD" %}}
{{% blocks/products/pf/agp/text %}}
