...
{{% blocks/products/pf/agp/content h2="Python Excel Kitaplığını Kullanarak MHT\'yi CSV\'e Dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="MHT\'yi Python Excel Kitaplığı\'nda CSV\'e kaydedin" %}}

Aşağıdaki örnek, Python excel kitaplığında MHT'nin CSV'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="Python MHT\'yi CSV\'e Dönüştürmek için Excel Kitaplığı" %}}
