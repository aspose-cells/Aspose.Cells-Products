...
يوضح المثال التالي كيفية دمج MHT مع PPTX في Aspose.Cells for C++.
...
هل تحتاج إلى دمج MHT في PPTX برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
