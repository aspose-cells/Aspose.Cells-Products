---
title: Python OTS 至 XLSX - OTS 至 XLSX 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 XLSX。Python OTS 轉換為 XLSX。Python 將 OTS 儲存為 XLSX。Python 將 OTS 儲存為 XLSX。Python 將 OTS 儲存為 XLSX。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Python 中的 OTS 轉換為 XLSX" h2="用於將 OTS 轉換為 XLSX 的高速 Python 庫。使用我們的 Excel 轉換 API 在 Python 中開發高級、平台無關的軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將 Python 中的 OTS 轉換為 XLSX" %}}

如何將 OTS 轉換為 XLSX？透過 Aspose.Cells for Python via NET 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 OTS 轉換為 XLSX。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="將OTS保存到Python中的XLSX" %}}

以下範例示範如何將 Python via NET 中的 OTS 轉換為 XLSX。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 OTS 轉換為 XLSX。上傳您的 OTS 文件，然後只需將其另存為 XLSX 文件。對於 OTS 讀取和 XLSX 寫入，您可以使用完全限定的檔案名稱。輸出 XLSX 內容和格式將與原始 OTS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 OTS 轉換為 XLSX 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何將 OTS 轉換為 XLSX" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 OTS 檔案轉換為 XLSX？ Python 開發人員只需幾行程式碼即可輕鬆載入 OTS 並將其轉換為 XLSX。
...
1. 透過呼叫 Workbook.save 方法將 OTS 轉換為 XLSX。
1. 取得OTS到XLSX的轉換結果。
