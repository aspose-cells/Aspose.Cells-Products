...
L'esempio seguente mostra come unire SXC in WORD in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 È necessario unire SXC a WORD a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Biblioteca .NET da accorpare SXC a WORD" %}}
