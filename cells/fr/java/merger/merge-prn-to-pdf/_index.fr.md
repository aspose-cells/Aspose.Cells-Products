---
title:  Fusionner PRN avec PDF via Java
...
L'exemple suivant montre comment fusionner PRN avec PDF dans Java.
...
{{% cells-merger title="Application gratuite pour fusionner PRN au PDF en ligne" InputFormat="prn" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
