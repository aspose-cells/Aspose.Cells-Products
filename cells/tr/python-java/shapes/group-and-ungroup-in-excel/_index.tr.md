---
title: Python via Java Kullanarak Excel'de Şekilleri Gruplama ve Grubu Çözme
weight: 371
description: Microsoft veya Open Office, Adobe PDF vb. gibi herhangi bir yazılım olmadan Aspose.Cells' Python via Java API'i kullanarak nesneleri Gruplandırın ve Grubu Çözün.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java\'i kullanarak Excel\'de Şekilleri Gruplama ve Grubu Çözme" h2="Aspose.Cells\' API\'i kullanarak, Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılıma ihtiyaç duymadan çeşitli nesnelerle çalışın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java Kullanarak Excel Dosyasındaki Şekilleri Gruplandırma ve Gruplarını Çözme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java\'i kullanarak Excel dosyasındaki Şekilleri Gruplandırma ve Grubunu Çözme Adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Kullan[grup yöntemi](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#group(com.aspose.cells.Shape[])) seçili çalışma sayfasındaki şekilleri gruplandırmak için
 + Kullan[grubu çözme yöntemi](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#ungroup(com.aspose.cells.GroupShape)) seçili çalışma sayfasındaki şekillerin grubunu çözmek için
...
{{% blocks/products/pf/agp/code-block title="Şekilleri Gruplama ve Grubu Çözme - Python via Java" offSpacer="" %}}
