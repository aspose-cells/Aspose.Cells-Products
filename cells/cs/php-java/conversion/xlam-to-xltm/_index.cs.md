---
title: Konvertor PHP XLAM až XLTM - XLAM až XLTM
description: Aspose Excel. Převeďte XLAM na XLTM rychle a snadno pomocí Aspose.Cells. PHP XLAM na XLTM. PHP Uložte XLAM na XLTM. Uložte XLTM jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xltm" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na XLTM přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na XLTM programově? Vývojáři PHP mohou snadno načíst a převést XLAM na XLTM v několika řádcích kódu.
...
1.  Převeďte XLAM na XLTM voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na XLTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na XLTM" %}}
