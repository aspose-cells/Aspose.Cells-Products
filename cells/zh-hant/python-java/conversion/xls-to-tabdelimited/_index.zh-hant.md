...
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 XLS 轉換為 TABDELIMITED 格式，從而能夠使用 Aspose.Cells 庫將 XLS 數據保存為 TABDELIMITED 格式，所有這些程式庫將 XLS 資料保存為 TABDELIMITED 格式，所有這些程式碼可自訂的 07171717138171382193813939072。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Python Excel 庫中將 XLS 轉換為 TABDELIMITED" h2="用於將 XLS 轉換為 TABDELIMITED 的高速 Python Excel 函式庫。這是一個專業的軟體解決方案，用於匯入和匯出 XLS、TABDELIMITED 以及使用 Python 的許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將 XLS 轉換為 TABDELIMITED" %}}
...
{{% blocks/products/pf/agp/content h2="將 XLS 儲存到 Python Excel 庫中的 TABDELIMITED" %}}

以下範例示範如何在 Python excel 庫中將 XLS 轉換為 TABDELIMITED。
...
{{% cells-convert title="透過 Python Excel 庫將 XLS 轉換為 TABDELIMITED 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="tsv" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 XLS 轉換為 TABDELIMITED" %}}
