---
title: تحويل C# صورة إلى ODS - صورة إلى ODS
description: Aspose اكسل. قم بتحويل IMAGE إلى ODS بسرعة وسهولة باستخدام Aspose.Cells. C# IMAGE إلى ODS. C# احفظ IMAGE إلى ODS. احفظ IMAGE كـ ODS باستخدام C#.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في ODS في C#" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى ODS في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى ODS عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى ODS برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى ODS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى ODS" %}}
