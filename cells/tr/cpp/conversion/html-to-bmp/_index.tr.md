---
title: C++ uygulaması aracılığıyla HTML'yi BMP'ye dönüştürün 
weight: 9710
url: /tr/cpp/conversion/html-to-bmp/ 
description: HTML belgesinden BMP biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu HTML'den BMP'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla HTML\'yi BMP\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı HTML\'den BMP\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak HTML\'yi BMP\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ aracılığıyla HTML\'yi BMP\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 C++ geliştiricileri, HTML dosyasını yalnızca birkaç satır kodla kolayca BMP'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak HTML dosyasını yükleyin.1. İlk çalışma sayfasını seçin.1. (BMP) seçeneklerini ayarlayın.1. Sayfanın her sayfasını yineleyin ve oluşturun.1. BMP dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="HTML\'den BMP\'ye C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="HTML\'den BMP\'ye Dönüştürme Canlı Demoları" sectionDescription="[HTML\'yi BMP\'ye Dönüştür](https://products.aspose.app/cells/conversion/html-to-bmp) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece HTML dosyanızı yükleyin, anında BMP\'ye dönüştürülecektir." >}}
