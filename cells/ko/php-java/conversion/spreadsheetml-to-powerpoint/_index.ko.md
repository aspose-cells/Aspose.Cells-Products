---
title: PHP SPREADSHEETML을 POWERPOINT로 - SPREADSHEETML을 POWERPOINT로 변환기
description: Aspose 엑셀. Aspose.Cells을 사용하여 SPREADSHEETML을 POWERPOINT로 빠르고 쉽게 변환하세요. PHP SPREADSHEETML을 POWERPOINT로 변환하세요. PHP SPREADSHEETML을 POWERPOINT에 저장합니다. PHP를 사용하여 SPREADSHEETML을 POWERPOINT로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML을 PHP의 POWERPOINT에 저장" %}}

다음 예에서는 PHP에서 SPREADSHEETML을 POWERPOINT로 변환하는 방법을 보여줍니다.
...
{{% blocks/products/pf/agp/content h2="PHP를 통해 SPREADSHEETML을 POWERPOINT로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 SPREADSHEETML 파일을 POWERPOINT로 변환해야 합니까? PHP 개발자는 단 몇 줄의 코드만으로 SPREADSHEETML을 POWERPOINT로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook의 save 메소드를 호출하여 SPREADSHEETML을 POWERPOINT로 변환합니다.
1.  SPREADSHEETML을 POWERPOINT로 변환한 결과를 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML을 POWERPOINT로 변환하는 PHP 라이브러리" %}}
