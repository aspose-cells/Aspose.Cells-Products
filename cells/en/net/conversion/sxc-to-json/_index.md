...
description: Convert SXC to JSON. Convert SXC to JSON online for free. Convert SXC to Word, Excel, PPTX, PDF, JPG, HTML, ODS, BMP, PNG, SVG, XPS and more.
keywords: Convert SXC, SXC Converter, SXC to PDF, SXC to Word, SXC to PPT, SXC to Image
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert SXC to JSON via C#" h2="Export Excel spreadsheets to JSON format on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Save SXC to JSON in C# Online for Free" %}}

The following example demonstrates how to convert SXC to JSON document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert SXC file into JSON format. Upload your SXC file, then simply save it as JSON file. For both SXC reading and JSON writing you can use fully qualified filenames. The output JSON content and formatting will be identical to the original SXC document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert SXC to JSON Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert SXC to JSON via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert SXC files to JSON in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load SXC file with an instance of Workbook
1.  Convert SXC to JSON by calling Workbook.Save method
