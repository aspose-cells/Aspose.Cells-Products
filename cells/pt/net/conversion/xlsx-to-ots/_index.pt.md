---
title: C# XLSX para OTS - Conversor XLSX para OTS
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato OTS, permitindo o salvamento perfeito de dados XLSX no formato OTS usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX para OTS em C#" %}}

O exemplo a seguir demonstra como converter XLSX para OTS em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter XLSX em OTS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para OTS programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em OTS em apenas algumas linhas de código.
...
1.  Converta XLSX para OTS chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em OTS" %}}
