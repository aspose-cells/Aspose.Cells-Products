...
weight: 7010
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında parola kullanarak XLS dosyasını kilitlemek için C# kaynak kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="XLS\'i C# aracılığıyla koruyun" %}}
...
1.  XLS dosya yolunu içeren Çalışma Kitabı sınıfını örneklendirin
