---
title: C# PNG'den OTS'ye - PNG'den OTS'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile PNG'i hızlı ve kolay bir şekilde OTS'ye dönüştürün. C# PNG'i OTS'ye dönüştürün. C# PNG'i OTS'ye kaydedin. C#'i kullanarak PNG'i OTS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C#\'de OTS\'ye kaydedin" %}}

Aşağıdaki örnekte PNG'in C#'de OTS'ye nasıl dönüştürüleceği gösterilmektedir.
...
{{% cells-convert title="PNG\'i OTS\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG\'i C# aracılığıyla OTS\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını program aracılığıyla OTS'ye dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve OTS'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="PNG\'i OTS\'ye dönüştürmek için C# kitaplığı" %}}
