...
{{% blocks/products/pf/agp/content h2="Преобразовать XLTM в MARKDOWN, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в MARKDOWN в C#" %}}
...
1.  Преобразуйте значение XLTM в MARKDOWN, вызвав метод Workbook.Save.
