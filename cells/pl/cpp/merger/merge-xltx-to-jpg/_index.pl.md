...
url: /pl/cpp/merger/merge-xltx-to-jpg/ 
...
Poniższy przykład pokazuje, jak połączyć XLTX z JPG w Aspose.Cells for C++.
...
Chcesz programowo scalić XLTX z JPG? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLTX do JPG" %}}
