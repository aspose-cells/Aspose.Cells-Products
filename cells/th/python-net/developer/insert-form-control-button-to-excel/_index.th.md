...
{{% blocks/products/pf/agp/content h2="วิธีแทรกปุ่ม (ตัวควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}

 ในการแทรกปุ่ม (การควบคุมแบบฟอร์ม) ลงในไฟล์ excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก Button (Form control) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_button/#int-int-int-int-int-int) เพื่อแทรกปุ่ม (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ปุ่มแทรก(ตัวควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
