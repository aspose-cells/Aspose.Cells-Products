...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TXT إلى XLSM باستخدام C++" %}}
 ...
 من أجل تحويل TXT إلى XLSM ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف TXT إلى XLSM في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف TXT باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLSM).1. سيتم حفظ ملف XLSM في المسار المحدد.1. افتح ملف XLSM في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="TXT إلى XLSM C++ شفرة مصدر التحويل" offSpacer="" %}}
