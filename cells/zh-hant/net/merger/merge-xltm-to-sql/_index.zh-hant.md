---
title: 將 XLTM 合併到 SQL - 將 XLTM 合併到 C# 中的 SQL
url: /zh-hant/net/merger/merge-xltm-to-sql/ 
description: Aspose Excel。 C# Aspose.Cells。將 XLTM 合併到 SQL 儲存格式。 C# 將 XLTM 合併為 SQL 格式。將 XLTM 合併到 C# 中的 SQL。XLTM 合併。
...
{{% blocks/products/pf/agp/content h2="將 XLTM 合併到 C# 中的 SQL" %}}

以下範例示範如何將 XLTM 合併到 SQL 的 Aspose.Cells for .NET。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLTM 合併到 SQL。上傳文件，呼叫Workbook.Combine方法合併文件，然後儲存到SQL文件。如果您在 C# 中開發程式碼，這會比聽起來更簡單。請參閱將 XLTM 合併到 SQL 的 C# 範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 XLTM 合併到 C# 中的 SQL 的範例程式碼" InputFormat="xltm" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 XLTM 合併到 SQL" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 XLTM 合併到 SQL 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將XLTM合併到SQL" %}}
