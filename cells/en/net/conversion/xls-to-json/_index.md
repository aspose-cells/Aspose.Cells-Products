---
title: XLS to JSON - Convert XLS to JSON files C#
description: Aspose Excel. Free Online Convert XLS to JSON saveformat. C# XLS to JSON format. Save XLS as JSON in C#.
keywords: [Aspose Excel., C# Aspose.Cells., C# XLS to JSON saveformat., Free Online XLS to JSON Converter]
---
...
{{% blocks/products/pf/agp/content h2="Save XLS to JSON in C# Online for Free" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert XLS to JSON Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="json" IsLandingPage="true" %}}
