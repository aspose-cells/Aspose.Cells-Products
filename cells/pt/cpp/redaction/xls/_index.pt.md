---
title: Pesquise e substitua texto no documento XLS via C++
weight: 380
description: Código de exemplo C++ para editar informações confidenciais no arquivo XLS no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
...
{{< blocks/products/pf/i18n/upper-banner h1="Editar formatos XLS em C++" h2="Informações de redação confidenciais de documentos XLS nativos e de alto desempenho usando APIs Aspose.Cells for C++ do lado do servidor, sem o uso de qualquer software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Uma pesquisa básica de documentos e substituição de texto em conteúdos, comentários ou metadados por[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs podem ser feitas com apenas algumas linhas de código.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/redaction/xlsx/" name="XLSX" description="Arquivo Excel OOXML" >}}
