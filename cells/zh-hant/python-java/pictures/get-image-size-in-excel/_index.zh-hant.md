---
title: 使用 Python via Java 在 Excel 中取得圖片/圖片大小
weight: 10
description: 使用 Aspose.Cells' Python via Java API 取得 Excel 中的圖片/圖片大小，無需任何軟體，如 Microsoft 或 Open Office、Adobe PDF 等。
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via Java 取得 Excel 檔案中的圖片/圖片大小" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via Java 取得 Excel 檔案中圖片/圖片大小的步驟" %}}
...
+ 透過工作表「圖片」屬性中的索引選擇圖片物件。
 + 有多種方法可以取得選定圖片物件的尺寸。下面列出了部分內容，更多資訊請參閱[MORE](https://reference.aspose.com/cells/python-java/asposecells.api/Picture)注意：「寬度」和「高度」是Excel中顯示的尺寸，可能比原始圖片更大或更小。
    ...
    + [原始寬度](https://reference.aspose.com/cells/python-java/asposecells.api/picture#OriginalWidth)取得圖片的原始寬度，以像素為單位。
    + [原始高度](https://reference.aspose.com/cells/python-java/asposecells.api/picture#OriginalHeight)取得圖片的原始高度，以像素為單位。
...
{{% blocks/products/pf/agp/code-block title="取得影像/圖片的大小 - Python via Java" offSpacer="" %}}
