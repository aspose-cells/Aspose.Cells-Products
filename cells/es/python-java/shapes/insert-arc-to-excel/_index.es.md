...
weight: 10
description: Python via código fuente java para insertar Arc en Excel.
...
{{% blocks/products/pf/agp/content h2="Cómo insertar un arco en un archivo de Excel usando Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar un archivo Arc en Excel usando Python via java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa la colección de formas[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addArc(int,%20int,%20int,%20int,%20int,%20int)) para insertar un Arco en la hoja de trabajo seleccionada.
