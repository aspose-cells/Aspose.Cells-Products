...
Θέλετε να μετατρέψετε αρχεία HTM σε NUMBERS μέσω προγραμματισμού; Οι προγραμματιστές C++ μπορούν εύκολα να μετατρέψουν το HTM σε ΑΡΙΘΜΟΥΣ σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατρέψτε το HTM σε NUMBERS καλώντας τη μέθοδο Save().
