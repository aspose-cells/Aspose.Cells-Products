---
title: 新增或刪除 XLSB 註 via Java
weight: 860
description: Java 用於刪除 JSP/JSF 應用程式和桌面應用程式的 Java 執行時間環境上的 XLSB 格式註解的範例程式碼。
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 註 XLSB 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="從 XLSB via Java 新增或刪除註釋的步驟" %}}
