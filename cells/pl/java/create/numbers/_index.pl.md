...
{{% blocks/products/pf/agp/content h2="Jak tworzyć NUMERY w kodzie Java" %}}
...
1.  Zapisz skoroszyt w formacie LICZBY za pomocą metody save().

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik NUMBERS dla Java." offSpacer="" %}}
