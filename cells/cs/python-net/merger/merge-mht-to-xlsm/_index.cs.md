...
description: Aspose Excel. Python Aspose.Cells. Sloučit MHT do formátu uložení XLSM. Python Zkombinujte MHT do formátu XLSM. Sloučit MHT na XLSM v Python. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na XLSM v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT s XLSM v Python" InputFormat="mht" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
