...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar BMP met Aspose.Cells. Python OTS naar BMP. Python Bewaar OTS naar BMP. Sla OTS op als BMP met Python.
...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar BMP in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar OTS op BMP in Python" %}}

Het volgende voorbeeld laat zien hoe u OTS converteert naar BMP in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om OTS naar BMP te converteren" %}}
