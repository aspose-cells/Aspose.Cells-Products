---
title: PHP SXC en SQL - Convertisseur SXC en SQL
description: Aspose Exceller. Convertissez SXC en SQL rapidement et facilement avec Aspose.Cells. PHP SXC en SQL. PHP Enregistrez SXC dans SQL. Enregistrez SXC au format SQL en utilisant PHP.
...
Besoin de convertir les fichiers SXC en SQL par programme ? Les développeurs PHP peuvent facilement charger et convertir SXC en SQL en quelques lignes de code.
...
1.  Convertissez SXC en SQL en appelant la méthode de sauvegarde du classeur.
