---
title:  Aggiungi o rimuovi XLSB Annotazione via .NET
weight: 6440
description: Codice sorgente C# per aggiungere ed eliminare annotazioni in formato XLSB su piattaforme .NET Framework, .NET Core, Mono o Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Aggiungi o elimina annotazione da XLSB tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Elimina annotazioni da XLSB - C#" offSpacer="" %}}
