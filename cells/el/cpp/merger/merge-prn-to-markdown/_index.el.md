---
title: Συγχώνευση PRN στο MARKDOWN - Συνδυάστε το PRN στο MARKDOWN στο C++
url: /el/cpp/merger/merge-prn-to-markdown/ 
description: Aspose Excel. C++ Aspose.Cells. Δωρεάν Online Συγχώνευση PRN στο MARKDOWN saveformat. C++ Συνδυάστε τη μορφή PRN σε MARKDOWN. Συγχώνευση PRN στο MARKDOWN στο C++. PRN Merge.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση PRN στο MARKDOWN στο C++ Δωρεάν Online" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN στο MARKDOWN στο Aspose.Cells for C++.
...
{{% cells-merger title="Δωρεάν online για συγχώνευση PRN στο MARKDOWN στο C++" InputFormat="prn" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το PRN στο MARKDOWN μέσω του C++" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να συγχωνεύσετε το PRN στο MARKDOWN μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="C++ βιβλιοθήκη για συγχώνευση PRN με MARKDOWN" %}}
