...
{{% blocks/products/pf/agp/content h2="Hur man skapar XLSX via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Följande källkod visar hur man skapar en MS Excel XLSX-fil med C++." offSpacer="" %}}
