---
title: C++ أرقام إلى XLT - أرقام على الإنترنت لتحويل XLT
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ قم بتحويل الأرقام إلى XLT saveformat. C++ أرقام إلى تنسيق XLT. احفظ الأرقام في XLT C++.
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في XLT في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات NUMBERS إلى XLT برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل الأرقام إلى XLT في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الأرقام إلى XLT باستدعاء طريقة Save ().
