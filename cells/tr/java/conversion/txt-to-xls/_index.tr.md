...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TXT\'yi XLS\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden TXT\'yi XLS\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla TXT dosyasını XLS'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TXT dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. XLS uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan XLS dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="TXT - XLS Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TXT dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.txt");
// TXT'yi XLS olarak kaydet
