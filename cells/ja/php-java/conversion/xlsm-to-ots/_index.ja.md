---
title: PHP XLSM から OTS - XLSM から OTS コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XLSM を OTS にすばやく簡単に変換します。PHP XLSM を OTS に変換します。 PHP XLSM を OTS に保存します。 PHP を使用して XLSM を OTS として保存します。
...
{{% cells-convert title="XLSMをOTSに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="ots" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP経由でXLSMをOTSに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSM ファイルをプログラムで OTS に変換する必要がありますか? PHP 開発者は、わずか数行のコードで XLSM を簡単にロードして OTS に変換できます。
