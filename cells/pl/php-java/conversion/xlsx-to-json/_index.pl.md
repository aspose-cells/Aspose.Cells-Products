...
description: Aspose Excel. Konwertuj XLSX na JSON szybko i łatwo za pomocą Aspose.Cells. PHP XLSX na JSON. PHP Zapisz XLSX na JSON. Zapisz XLSX jako JSON używając PHP.
...
Chcesz programowo przekonwertować pliki XLSX na JSON? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na JSON w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSX na numer JSON, wywołując metodę zapisu skoroszytu.
