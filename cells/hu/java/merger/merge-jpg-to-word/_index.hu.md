---
title: JPG egyesítése WORD-ba – JPG egyesítése WORD-ba a Java-ben
url: /hu/java/merger/merge-jpg-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése JPG-ből WORD mentési formátumba. Java JPG kombinálása WORD formátumba. JPG egyesítése WORD-ba a Java-ben. JPG-egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a JPG-t WORD-ba a Java-es online ingyen" %}}

A következő példa bemutatja, hogyan lehet a JPG-t WORD-ba egyesíteni a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a JPG és a WORD egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el WORD fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely a JPG-t a WORD-ba egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a JPG és a WORD egyesítése a Java számon" InputFormat="jpg" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="JPG egyesítése WORD via Java-be" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a JPG-t a WORD-dal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
