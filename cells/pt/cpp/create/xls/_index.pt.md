...
url: /pt/cpp/create-xls/ 
description: C++ Código de exemplo para gerar arquivos XLS do MS Excel. Use este código para criar arquivos MS Excel XLS dentro do aplicativo baseado em C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo XLS via C++" h2="Criação de planilhas MS Excel XLS nativas e de alto desempenho programaticamente sem o Microsoft Office usando a biblioteca C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 É fácil para os desenvolvedores criar, carregar, modificar e converter arquivos XLS dentro de aplicativos de relatórios em execução para processamento de dados em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Crie um objeto da classe IWorkbook.1. Obtenha a primeira planilha em um objeto IWorksheet.1. Use o método IWorksheet->GetICells() para obter as células da planilha em um objeto ICells.1. Use o método ICells->GetObjectByIndex() para acessar a célula desejada da planilha em um objeto ICell.1. Use o método ICell->PutValue() para inserir o valor na célula.1. Salve a pasta de trabalho como arquivo .xls usando o método Save().
