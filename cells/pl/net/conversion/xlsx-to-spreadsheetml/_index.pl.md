...
Poniższy przykład pokazuje, jak przekonwertować liczbę XLSX na format SPREADSHEETML w formacie C#.
...
Chcesz programowo przekonwertować pliki XLSX na SPREADSHEETML? Programiści .NET mogą z łatwością załadować i przekonwertować XLSX na arkusz kalkulacyjny w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLSX do formatu SPREADSHEETML, wywołując metodę Workbook.Save.
