...
Aşağıdaki örnek, JPEG'in Aspose.Cells for Python via Java'de OTS ile nasıl birleştirileceğini gösterir.
...
JPEG'i programlı olarak OTS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
