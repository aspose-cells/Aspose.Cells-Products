---
title:  Sloučit XLSB na DOCX přes Python
url: /cs/python-net/merger/merge-xlsb-to-docx/ 
description: Sloučit XLSB až DOCX online zdarma. Online zdarma XLSB až DOCX Fúze. Sloučit XLSB do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSB až DOCX v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSB až DOCX online" InputFormat="xlsb" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
