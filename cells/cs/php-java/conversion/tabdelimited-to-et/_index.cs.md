...
description: Aspose Excel. Převeďte TABDELIMITED na ET rychle a snadno pomocí Aspose.Cells. PHP TABDELIMITED na ET. PHP Uložit TABDELIMITED do ET. Uložte TABDELIMITED jako ET pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na ET přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory TABDELIMITED na ET programově? Vývojáři PHP mohou snadno načíst a převést TABDELIMITED na ET v několika řádcích kódu.
...
1.  Převeďte TABDELIMITED na ET voláním metody uložení sešitu.
