---
title: Объединить ODS с DOCX — объединить ODS с DOCX в C++.
url: /ru/cpp/merger/merge-ods-to-docx/ 
description: Aspose Эксель. C++ Aspose.Cells. Объедините ODS и DOCX в формате сохранения. C++ Объедините форматы ODS и DOCX. Объедините ODS и DOCX в C++. ODS Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините ODS и DOCX в C++." %}}

В следующем примере показано, как объединить ODS и DOCX в Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить номера ODS и DOCX. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле DOCX. Если вы разработаете код C++, это будет проще, чем кажется. См. пример C++, в котором ODS объединяется с DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения чисел ODS и DOCX в C++" InputFormat="ods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как объединить ODS с DOCX через C++" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить номера ODS и DOCX? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для объединения ODS и DOCX." %}}
