---
title: Convertissez MHTML en ODS via l'application C++ 
weight: 5930
url: /fr/cpp/conversion/mhtml-to-ods/ 
description: Exemple de code de conversion C++ pour le document MHTML au format ODS. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de MHTML en ODS dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir MHTML en ODS via C++" h2="Conversion MHTML vers ODS haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir MHTML en ODS à l\'aide de C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir MHTML en ODS via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier MHTML en ODS en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier MHTML à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (ODS).1. Le fichier ODS sera enregistré dans le chemin spécifié.1. Ouvrez le fichier ODS dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion MHTML vers ODS C++" offSpacer="" %}}
