...
{{% blocks/products/pf/agp/content h2="Como obter metadados XLSM usando C++" %}}
 ...
 Para extrair metadados XLSM, usaremos
...
+ Carregar arquivo XLSM usando CreateIWorkbookMetadata
