---
title: รวม XLSX ถึง PPTX - รวม XLSX ถึง PPTX ใน Python
url: /th/python-net/merger/merge-xlsx-to-pptx/ 
description: Aspose เอ็กเซล. Python Aspose.Cells รวม XLSX เป็น PPTX บันทึกฟอร์แมต Python รวมรูปแบบ XLSX ถึง PPTX รวม XLSX ถึง PPTX เข้า Python XLSX รวม.
...
{{% blocks/products/pf/agp/content h2="วิธีรวม XLSX ถึง PPTX ผ่าน Python" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม XLSX กับ PPTX โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="Python ห้องสมุดรวม XLSX เป็น PPTX" %}}
