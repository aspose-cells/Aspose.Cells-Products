---
title: PHP XLAM en XML - Convertisseur XLAM en XML
description: Aspose Exceller. Convertissez XLAM en XML rapidement et facilement avec Aspose.Cells. PHP XLAM en XML. PHP Enregistrez XLAM au format XML. Enregistrez XLAM au format XML en utilisant PHP.
...
Besoin de convertir les fichiers XLAM en XML par programme ? Les développeurs PHP peuvent facilement charger et convertir XLAM en XML en quelques lignes de code.
...
1.  Convertissez XLAM en XML en appelant la méthode de sauvegarde du classeur.
