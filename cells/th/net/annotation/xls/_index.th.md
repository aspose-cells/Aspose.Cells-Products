---
title:  เพิ่มหรือลบ XLS คำอธิบายประกอบ via .NET
weight: 9270
...
{{% blocks/products/pf/agp/feature-section-col title="เพิ่มหรือลบคำอธิบายประกอบจาก XLS ผ่าน C#" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API สามารถใช้สร้าง แก้ไข แปลง และเรนเดอร์รูปแบบ Excel Microsoft เป็นรูปแบบต่างๆ นอกจากนี้ยังสามารถใช้สำหรับการสร้างแผนภูมิที่ครอบคลุม การรายงานที่ปรับขนาดได้ และการคำนวณที่เชื่อถือได้ภายในแอปพลิเคชันซอฟต์แวร์ Aspose.Cells เป็น API แบบสแตนด์อโลน และไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ OpenOffice
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="ลบคำอธิบายประกอบออกจาก XLS ผ่านแอปออนไลน์" sectionDescription=" ลบคำอธิบายประกอบเอกสาร XLS ทันทีโดยไปที่ของเรา[เว็บไซต์สาธิตสด](https://products.aspose.app/cells/annotation). การสาธิตสดมีข้อดีดังต่อไปนี้" >}}
