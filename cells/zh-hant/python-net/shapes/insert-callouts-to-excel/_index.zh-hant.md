---
title: 使用 Python via .Net 將標註插入 Excel
weight: 360
description: Python via 將標註插入 Excel 的 .Net 原始碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="使用 Python via .Net 將標註插入 Excel" h2="使用 Aspose.Cells\' API 插入標註，無需使用 Microsoft 或 Open Office、Adobe PDF 等任何軟體。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via .Net 將標註插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via .Net 將標註插入 Excel 檔案的步驟" %}}
...
+ 透過索引選擇工作表。
 使用形狀集合的新增[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)在選定的工作表中插入標註。
以 XLSX 格式儲存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入標註 - Python via .Net" offSpacer="" %}}
...
自選圖形類型。<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12" style="font-size:0.8rem !important;">
自選圖形類型。<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR3
    </p>
   </div>
  </div>
 </div>
