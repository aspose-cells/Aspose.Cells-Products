---
title: 透過 C# 在 Microsoft Excel XLSX 檔案中插入資料透視圖
weight: 7690
description: C# 使用 .NET 函式庫將資料透視圖新增至 XLSX 的範例程式碼。使用此程式碼將資料透視圖插入 VB.NET、Asp.NET 或任何基於 .NET 的應用程式中的 XLSX 檔案。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C# 在 XLSX 文件中插入資料透視圖" h2="本機高效能 Microsoft Excel XLSX 電子表格，使用伺服器端 .NET API 以程式設計方式建立資料透視圖。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
在運行的應用程式中動態產生帶有資料透視圖的 MS Excel XLSX 檔案非常簡單。為了從頭開始建立具有資料透視圖的 XLSX 文件而不需要 MS Office，我們將使用[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API，使用 .NET 平台提供電子表格建立、操作和轉換的不同功能。開發人員可以輕鬆增強用於寫入資料、生成圖表或圖形以及在電子表格中建立表格的程式碼。
{{% /blocks/products/pf/agp/content %}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="如何透過 C# 在 XLSX 中插入資料透視圖" %}}

{{% blocks/products/pf/agp/text %}}

開發人員可以輕鬆地在執行不同的報表應用程式中插入 XLSX 格式電子表格的資料透視圖，以進行資料處理，只需幾行程式碼。
...
{{% blocks/products/pf/agp/code-block title="在 XLSX - C# 中插入資料透視圖" offSpacer="" %}}
...
Excel 電子表格程式庫，能夠建立跨平台應用程序，能夠產生、修改、轉換、渲染和列印 Excel XLSX 檔案。 .NET Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF、HTML、ODS 等，從而使其成為以行業標準格式交換文件的完美選擇。
