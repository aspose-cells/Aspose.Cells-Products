---
title: Converter CSV para SPREADSHEETML por meio do aplicativo C++ 
url: /pt/cpp/conversion/csv-to-spreadsheetml/ 
description: Exemplo de código de conversão C++ de documento CSV para o formato SPREADSHEETML. Os programadores podem usar esse código-fonte para conversão em lote de CSV para SPREADSHEETML em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter CSV para SPREADSHEETML via C++" h2="Conversão de CSV para SPREADSHEETML de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter CSV para SPREADSHEETML usando C++" %}}

 Para converter CSV para SPREADSHEETML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter CSV em SPREADSHEETML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem converter facilmente o arquivo CSV para SPREADSHEETML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo CSV usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com a extensão de arquivo (SPREADSHEETML).1. O arquivo SPREADSHEETML será salvo no caminho especificado.1. Abra o arquivo SPREADSHEETML em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="CSV para SPREADSHEETML C++ Código-fonte de conversão" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de CSV para SPREADSHEETML" sectionDescription="[Converter CSV para SPREADSHEETML](https://products.aspose.app/cells/conversion/csv-to-spreadsheetml) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo CSV, ele será convertido instantaneamente para SPREADSHEETML." >}}
