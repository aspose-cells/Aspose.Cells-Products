---
title: C# XML na OTS - Konwerter XML na OTS
description: Aspose Excel. Konwertuj XML na OTS szybko i łatwo za pomocą Aspose.Cells. C# XML na OTS. C# Zapisz XML w OTS. Zapisz XML jako OTS, używając numeru C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML w OTS pod numerem C#" %}}

Poniższy przykład ilustruje sposób konwersji XML na OTS w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na OTS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XML na OTS? Programiści .NET mogą łatwo załadować i przekonwertować XML na OTS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XML na OTS" %}}
