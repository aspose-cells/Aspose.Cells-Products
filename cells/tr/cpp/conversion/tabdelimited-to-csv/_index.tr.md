---
title: C++ uygulaması aracılığıyla TABDELIMITED'i CSV'ye dönüştürün 
url: /tr/cpp/conversion/tabdelimited-to-csv/ 
description: TABDELIMITED belgesi için CSV biçimine örnek C++ dönüştürme kodu. Programcılar bu kaynak kodunu herhangi bir C++ Uygulamasında toplu TABDELIMITED'den CSV'ye dönüştürme için kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED\'i C++ aracılığıyla CSV\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna gerek kalmadan C++ kitaplığını kullanarak yüksek performanslı TABDELIMITED\'den CSV\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, TABDELIMITED dosyasını yalnızca birkaç satır kodla kolayca CSV'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED dosyasını Factory::CreateIWorkbook kullanarak yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (CSV) dosya uzantısıyla iletin.1. CSV dosyası belirtilen yola kaydedilecektir.1. CSV dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED - CSV C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
