...
{{% blocks/products/pf/agp/content h2="Como inserir estrela/banner em arquivo Excel usando Java" %}}

 Para inserir Insert Star/Banner em arquivo Excel, usaremos
...
+ Selecione Planilha por meio de seu índice.
 + Utilize o[adicionar método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) para inserir Inserir Estrela/Banner na planilha selecionada
...
O código de exemplo abaixo demonstra como inserir "Ribbon: Curved and Tilted Up" e "Explosion: 8 Points". Para mais tipos, consulte "Visão geral dos tipos de inserção de estrela e banner" abaixo.
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
Visão geral dos tipos de inserção de estrela e banner
   </h2>
   <div class="col-lg-4">
