...
{{% blocks/products/pf/agp/content h2="Převeďte ČÍSLA na DOCX v Python" %}}
...
Následující příklad ukazuje, jak převést ČÍSLA na DOCX v Python via NET.
