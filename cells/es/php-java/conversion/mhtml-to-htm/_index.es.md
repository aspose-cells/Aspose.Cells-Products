---
title: PHP MHTML a HTM - Convertidor de MHTML a HTM
description: Aspose Excel. Convierta MHTML a HTM rápida y fácilmente con Aspose.Cells. PHP MHTML a HTM. PHP Guarde MHTML en HTM. Guarde MHTML como HTM usando PHP.
...
{{% cells-convert title="Código de muestra para convertir MHTML a HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="htm" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir MHTML a HTM mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos MHTML a HTM mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente MHTML a HTM en tan solo unas pocas líneas de código.
...
1.  Convierta MHTML a HTM llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de MHTML a HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir MHTML a HTM" %}}
