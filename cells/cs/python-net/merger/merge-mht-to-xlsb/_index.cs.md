...
url: /cs/python-net/merger/merge-mht-to-xlsb/ 
...
Následující příklad ukazuje, jak sloučit MHT s XLSB v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit MHT na XLSB programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
