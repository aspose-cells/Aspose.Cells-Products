...
weight: 240
description: C# código fuente para insertar un rectángulo en Excel en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addrectangle) para insertar un rectángulo en la hoja de cálculo seleccionada
