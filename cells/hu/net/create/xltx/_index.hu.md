...
description: XLTX készítő. Hozzon létre XLTX fájlt a C# kódban. Hozzon létre MS Excel XLTX fájlokat VB.NET, Asp.NET vagy bármely .NET alapú alkalmazás segítségével.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hozzon létre XLTX fájlt a C# számon keresztül" h2="Natív és nagy teljesítményű MS Excel XLTX táblázatkészítés programozottan, kiszolgálóoldali .NET API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/code-block title="Mintakód egy MS Excel XLTX fájl létrehozásához a C# használatával." offSpacer="" %}}
