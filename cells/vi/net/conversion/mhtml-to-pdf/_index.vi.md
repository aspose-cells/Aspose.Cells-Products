---
title: Chuyển MHTML sang PDF qua C#

description: Mã mẫu cho chuyển đổi mhtml sang pdf C#. Sử dụng API mã ví dụ cho chuyển đổi hàng loạt tệp mhtml sang pdf trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển MHTML sang PDF qua C#" h2="Xuất bảng tính Excel® sang định dạng PDF trên Nền tảng .NET Framework, .NET Core Mono hoặc Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp MHTML sang PDF chỉ trong một vài dòng mã.
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển MHTML sang PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="pdf" IsLandingPage="true" %}}
