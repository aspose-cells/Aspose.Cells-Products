---
title: Edite ou visualize metadados de arquivos XLSM via Java 
weight: 9030
url: /pt/java/metadata/xlsm/ 
description: Java código de amostra para editar ou visualizar metadados de formato XLSM no Java ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraia metadados XLSM por meio de Java" h2="Crie seus próprios aplicativos Java para adicionar, editar, remover ou extrair metadados de arquivos XLSM usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Como extrair metadados XLSM usando Java" %}}
 ...
 Para obter metadados de arquivo XLSM, usaremos
...
+ Carregar arquivo XLSM dentro de WorkbookMetadata
...
{{% blocks/products/pf/agp/code-block title="Extrair metadados de XLSM - Java" offSpacer="" %}}
