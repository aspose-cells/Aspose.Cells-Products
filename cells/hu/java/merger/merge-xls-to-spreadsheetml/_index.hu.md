---
title: A XLS egyesítése SPREADSHEETML-be – a XLS egyesítése SPREADSHEETML-be a Java-ben
url: /hu/java/merger/merge-xls-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés XLS SPREADSHEETML mentési formátumba. Java A XLS kombinálása SPREADSHEETML formátumba. A XLS egyesítése SPREADSHEETML-be a Java-ben. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a XLS-et a SPREADSHEETML-be a Java-ben online" %}}

A következő példa bemutatja, hogyan egyesítheti a XLS-et a SPREADSHEETML-be a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS és a SPREADSHEETML egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SPREADSHEETML fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a XLS-et a SPREADSHEETML-lel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a XLS SPREADSHEETML-be a Java-ben" InputFormat="xls" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLS és a SPREADSHEETML via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a XLS és a SPREADSHEETML egyesítéséhez" %}}
