---
title: A HTML egyesítése XML-be – a HTML egyesítése XML-be a C#-ben
url: /hu/net/merger/merge-html-to-xml/ 
description: Aspose Excel. C# Aspose.Cells. A HTML egyesítése XML mentési formátumba. C# A HTML kombinálása XML formátumba. A HTML egyesítése XML-be a C#-ben. HTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a HTML-et XML-be a C#-ben" %}}

A következő példa bemutatja, hogyan egyesítheti a HTML-et XML-be a Aspose.Cells for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML XML-be olvasztásához. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el XML-fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a HTML-et XML-be.
...
{{% blocks/products/pf/agp/content h2="A HTML egyesítése XML-be a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a HTML-et XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML XML-be olvasztásához" %}}
