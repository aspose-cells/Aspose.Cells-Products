---
title: XLS から JSON を結合 - XLS から JSON を C++ に結合
url: /ja/cpp/merger/merge-xls-to-json/ 
description: Aspose エクセル。 C++ Aspose.Cells。XLS を JSON の保存形式に無料でオンライン結合します。 C++ XLS と JSON の形式を結合します。 XLS から JSON を C++ に結合します。XLS を結合します。
...
次の例は、XLS を Aspose.Cells for C++ の JSON にマージする方法を示しています。
...
{{% cells-merger title="XLS を C++ にオンラインで無料でマージ" InputFormat="xls" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLS を C++ 経由で JSON に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLS をプログラムで JSON にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
