---
title: Hợp nhất TXT thành XLS - Hợp nhất TXT thành XLS thành C#
url: /vi/net/merger/merge-txt-to-xls/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí TXT thành XLS saveformat. C# Kết hợp định dạng TXT thành XLS. Hợp nhất TXT thành XLS thành C#. TXT Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất TXT thành XLS trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất TXT thành XLS trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất TXT thành XLS. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp XLS. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất TXT thành XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Hợp nhất trực tuyến miễn phí TXT thành XLS trong C#" InputFormat="txt" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất TXT thành XLS qua C#" %}}
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất TXT thành XLS" %}}
