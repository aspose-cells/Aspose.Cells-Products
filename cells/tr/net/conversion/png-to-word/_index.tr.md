...
{{% blocks/products/pf/agp/content h2="PNG\'i WORD olarak C#\'e kaydedin." %}}

Aşağıdaki örnek, C#'de PNG'i WORD'e nasıl dönüştüreceğinizi göstermektedir.
...
PNG dosyalarını program aracılığıyla WORD'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve WORD'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak PNG değerini WORD değerine dönüştürün.
1.  PNG'den WORD'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PNG\'i WORD\'e dönüştürmek için C# kütüphanesi" %}}
