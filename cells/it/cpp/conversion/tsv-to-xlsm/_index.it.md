---
title: Converti TSV in XLSM tramite l'applicazione C++ 
weight: 4750
url: /it/cpp/conversion/tsv-to-xlsm/ 
description: Esempio di codice di conversione C++ per documento TSV in formato XLSM. I programmatori possono utilizzare questo codice sorgente per la conversione batch da TSV a XLSM all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file TSV in XLSM in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TSV usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XLSM).1. Il file XLSM verrà salvato nel percorso specificato.1. Apri il file XLSM nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da TSV a XLSM C++" offSpacer="" %}}
