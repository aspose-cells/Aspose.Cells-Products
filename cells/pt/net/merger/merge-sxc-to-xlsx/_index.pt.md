...
O exemplo a seguir demonstra como mesclar SXC a XLSX em Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Precisa mesclar SXC a XLSX programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar SXC a XLSX" %}}
