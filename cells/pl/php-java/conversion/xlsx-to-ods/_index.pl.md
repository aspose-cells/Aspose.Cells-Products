...
description: Aspose Excel. Konwertuj XLSX na ODS szybko i łatwo za pomocą Aspose.Cells. PHP XLSX na ODS. PHP Zapisz XLSX na ODS. Zapisz XLSX jako ODS używając PHP.
...
Chcesz programowo przekonwertować pliki XLSX na ODS? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na ODS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSX na numer ODS, wywołując metodę zapisu skoroszytu.
