---
title: ODS'i SPREADSHEETML ile birleştir - ODS'i Java'deki SPREADSHEETML ile birleştir
url: /tr/java/merger/merge-ods-to-spreadsheetml/ 
description: Aspose Excel'de. Java Aspose.Cells. ODS'i SPREADSHEETML kaydetme biçimiyle birleştirin. Java ODS'i SPREADSHEETML biçimiyle birleştirin. ODS'i Java'deki SPREADSHEETML ile birleştir. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'deki SPREADSHEETML ile birleştir" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'deki SPREADSHEETML ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="ODS\'i Java\'deki SPREADSHEETML ile Birleştirecek Örnek Kod" InputFormat="ods" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i SPREADSHEETML via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, ODS\'i SPREADSHEETML ile birleştirecek" %}}
