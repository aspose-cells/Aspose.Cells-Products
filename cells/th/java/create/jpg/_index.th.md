...
description: Aspose เอ็กเซล. Java สร้างไฟล์ JPG อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ JPG โดยใช้ Java สร้าง JPG ใน Java Java JPG Creater
...
1.  บันทึกสมุดงานเป็นรูปแบบ JPG โดยใช้เมธอด save()
...
{{% blocks/products/pf/agp/content h2="Java ไลบรารี่ สร้างไฟล์ JPG" %}}
{{% blocks/products/pf/agp/text %}}
