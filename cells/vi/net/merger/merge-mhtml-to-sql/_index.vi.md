---
title: Hợp nhất MHTML thành SQL - Hợp nhất MHTML thành SQL trong C#
url: /vi/net/merger/merge-mhtml-to-sql/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất MHTML thành định dạng lưu SQL. C# Kết hợp MHTML thành định dạng SQL. Hợp nhất MHTML thành SQL vào C#. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML thành SQL trong C#" %}}

Ví dụ sau đây minh họa cách hợp nhất MHTML với SQL trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất MHTML với SQL. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SQL. Nếu bạn phát triển mã theo số C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất MHTML với SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất MHTML thành SQL trong C#" InputFormat="mhtml" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất MHTML với SQL thông qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất MHTML thành SQL" %}}
