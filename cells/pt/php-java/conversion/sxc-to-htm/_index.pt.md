---
title: Conversor PHP SXC para HTM - SXC para HTM
description: Aspose Excel. Converta SXC em HTM de forma rápida e fácil com Aspose.Cells. PHP SXC em HTM. PHP Salve SXC em HTM. Salve SXC como HTM usando PHP.
...
Precisa converter arquivos SXC para HTM programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC para HTM em apenas algumas linhas de código.
...
1.  Converta SXC em HTM chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de SXC para HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter SXC para HTM" %}}
