...
url: /th/net/merger/merge-numbers-to-dif/ 
...
ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน NUMBERS กับ DIF ใน Aspose.Cells for .NET
...
{{% blocks/products/pf/agp/text %}}
 ...
 ต้องการรวม NUMBERS เข้ากับ DIF โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ห้องสมุดเพื่อรวม NUMBERS เข้ากับ DIF" %}}
