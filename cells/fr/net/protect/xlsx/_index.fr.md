---
title:  Protéger et verrouiller le document XLSX via .NET
weight: 90
description: Code source C# pour verrouiller le fichier XLSX à l’aide d’un mot de passe sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Protéger le XLSX via le C#" %}}
