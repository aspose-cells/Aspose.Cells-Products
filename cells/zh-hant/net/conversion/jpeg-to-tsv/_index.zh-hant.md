---
title: C# JPEG 至 TSV - JPEG 至 TSV 轉換器
description: Aspose Excel。 C# Aspose.Cells。C#中的JPEG到TSV。C#將JPEG轉換為TSV儲存格式。 C# JPEG 到 TSV 格式。將 JPEG 儲存為 TSV C#。
...
{{% cells-convert title="將 JPEG 轉換為 TSV 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 JPEG 轉換為 TSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 JPEG 檔案轉換為 TSV 嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入和轉換 JPEG 到 TSV。
