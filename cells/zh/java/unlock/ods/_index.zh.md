---
title: 解锁 ODS 文档 via Java
weight: 5080
description: Java 用于解锁受密码保护的 ODS 文件的示例代码 Java JSP/JSF 应用程序和桌面应用程序的运行时环境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="解锁 ODS 文件 via Java" h2="使用 Java 库从包括 ODS 文件的 Excel 电子表格中删除保护。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
API这是一个功能丰富、功能强大且易于使用的保护平台API for Java。您可以直接从以下位置下载其最新版本
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的解锁格式" subTitle="使用Java，可以轻松解除对不同格式的保护/解锁，包括。" >}}
