---
title:  Hợp nhất PRN thành CSV qua C#
...
Ví dụ sau minh họa cách hợp nhất PRN thành CSV trong C#.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất PRN thành CSV trực tuyến" InputFormat="prn" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
