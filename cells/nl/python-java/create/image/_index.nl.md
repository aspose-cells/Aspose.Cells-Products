...
description: Aspose Excel. Python IMAGE-bestand maken. Maak IMAGE Python. Python IMAGE Creator. Maak IMAGE in Python. Genereer IMAGE-bestand met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een IMAGE-bestand in Python" h2="High-speed Python-bibliotheek voor het maken van een IMAGE-bestand. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  Gebruik de methode Save om de werkmap op te slaan als IMAGE-bestand.
