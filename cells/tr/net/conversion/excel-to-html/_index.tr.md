...
EXCEL dosyalarını programlı olarak HTML'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip HTML'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını HTML formatına dönüştürün.
