---
title: Fusionner HTM avec PPTX - Combiner HTM avec PPTX dans Python
url: /fr/python-java/merger/merge-htm-to-pptx/ 
description: Aspose Excel. Python Aspose.Cells. Fusion en ligne gratuite HTM au format de sauvegarde PPTX. Python Combinez HTM au format PPTX. Fusionner HTM avec PPTX dans Python. Fusion HTM.
...
L'exemple suivant montre comment fusionner HTM avec PPTX dans Aspose.Cells for Python via Java.
...
{{% cells-merger title="Gratuit en ligne pour fusionner HTM avec PPTX en Python" InputFormat="htm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec PPTX via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner HTM avec PPTX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
