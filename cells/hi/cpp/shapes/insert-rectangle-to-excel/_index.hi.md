...
+ इसके सूचकांक के माध्यम से वर्कशीट का चयन करें।
 + का प्रयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addrectangle/) चयनित वर्कशीट में समीकरण आकृतियाँ सम्मिलित करने के लिए
