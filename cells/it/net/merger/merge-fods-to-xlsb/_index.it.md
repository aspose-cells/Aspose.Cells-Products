---
title: Unisci FODS a XLSB - Combina FODS a XLSB in C#
url: /it/net/merger/merge-fods-to-xlsb/ 
description: Aspose Excel. C# Aspose.Cells. Unione online gratuita da FODS a XLSB saveformat. C# Combina il formato FODS con XLSB. Unisci FODS a XLSB in C#. FODS Unisci.
...
L'esempio seguente mostra come unire FODS a XLSB in Aspose.Cells for .NET.
...
{{% cells-merger title="Online gratuito per unire FODS a XLSB in C#" InputFormat="fods" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire FODS a XLSB tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire FODS a XLSB a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
