...
description: Aspose Excel. A PNG-es számot gyorsan és egyszerűen konvertálja OTS-re a Aspose.Cells-es számmal. Java PNG OTS-re. Java Mentse a PNG számot az OTS-nél. Mentse el a PNG számot OTS-ként a Java használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse el a PNG számot az OTS számára a Java számon" %}}
...
A PNG fájlokat programozottan OTS-re kell konvertálnia? A Java fejlesztők könnyedén konvertálhatják a PNG-et OTS-re, mindössze néhány sornyi kóddal.
