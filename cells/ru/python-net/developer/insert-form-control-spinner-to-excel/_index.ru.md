---
title:  Вставьте кнопку Spin (элемент управления формой) в Excel, используя Python via .Net
weight: 40
description: Python via Исходный код .Net для вставки кнопки «Счетчик» (элемент управления формой) в Excel.
...
{{% blocks/products/pf/agp/content h2="Как вставить кнопку «Спин» (элемент управления формой) в файл Excel с помощью Python via.Net" %}}

 Чтобы вставить кнопку «Счетчик» (элемент управления формой) в файл Excel, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке кнопки «Счет» (элемент управления формой) в файл Excel с использованием Python via.Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_spinner/#int-int-int-int-int-int) чтобы вставить кнопку «Счетчик» (элемент управления «Форма») на выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить кнопку вращения (управление формой) — Python via.Net" offSpacer="" %}}
