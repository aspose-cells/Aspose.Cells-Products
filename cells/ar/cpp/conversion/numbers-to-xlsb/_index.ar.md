---
title: C++ أرقام إلى XLSB - أرقام على الإنترنت لتحويل XLSB
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ قم بتحويل الأرقام إلى XLSB saveformat. C++ أرقام إلى تنسيق XLSB. احفظ الأرقام في XLSB C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الأرقام إلى XLSB في C++" h2="أرقام عالية الأداء لتحويل XLSB باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في XLSB في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات NUMBERS إلى XLSB برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل الأرقام إلى XLSB في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الأرقام إلى XLSB باستدعاء طريقة Save ().
