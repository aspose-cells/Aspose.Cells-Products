---
title: Java XLSM 轉 MHT - 在線 XLSM 轉 MHT 轉換器
description: Aspose Excel。 Java Aspose.Cells。Java Aspose Cells。免費在線 Java 將 XLSM 轉換為 MHT 保存格式。 Java XLSM 為 MHT 格式。將 XLSM 保存到 MHT Java。
...
{{% blocks/products/pf/agp/content h2="免費在線將 XLSM 保存到 Java 中的 MHT" %}}

以下示例演示如何將 XLSM 轉換為 Java 中的 MHT。
...
需要以編程方式將 XLSM 文件轉換為 MHT？ Java開發人員只需幾行代碼即可輕鬆將XLSM轉換為MHT。
