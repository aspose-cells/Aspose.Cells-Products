---
title:  Sloučit XLSM na CSV přes Python
...
Následující příklad ukazuje, jak sloučit XLSM až CSV v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až CSV online" InputFormat="xlsm" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
