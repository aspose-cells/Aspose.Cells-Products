...
weight: 8760
url: /sv/cpp/protect/xls/ 
description: C++ exempelkod för att låsa XLS-fil med lösenord i C++ Runtime Environment för Windows 32-bitars, Windows 64-bitars och Linux 64-bitars.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Kryptera XLS-filer via C++" h2="Lösenordsskydda Excel-kalkylark inklusive XLS-format med hjälp av .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Så här säkrar du XLS-fil med C++" %}}
...
1. Ladda XLS-fil med IWorkbook-klassen1. Använd Protect(..)-metoden med ProtectionType och Password1. Spara den skyddade XLS-filen med metoden Save().
