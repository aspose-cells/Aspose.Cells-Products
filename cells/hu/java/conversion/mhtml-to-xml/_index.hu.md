---
title: "MHTML konvertálása XML-be a következőn keresztül: Java "
url: /hu/java/conversion/mhtml-to-xml/ 
description: Minta Java konverziós kód az MHTML formátumhoz XML fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok XML-formátumba exportálására bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="MHTML konvertálása XML-be a következőn keresztül: Java" h2="MHTML-ből XML-be Java konverzió egyetlen vagy több oldal konvertálásához XML-be a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="MHTML konvertálása XML-be a következővel: Java" %}}

 Ahhoz, hogy az MHTML-t XML-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az MHTML XML-lé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak MHTML-fájlt XML-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be egy MHTML-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XML kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XML-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="MHTML-ből XML-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az MHTML fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.mhtml");
// mentse az MHTML-t XML-ként
