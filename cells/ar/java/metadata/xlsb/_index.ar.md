...
{{% blocks/products/pf/agp/content h2="كيفية استخراج بيانات XLSB الوصفية باستخدام Java" %}}

 من أجل الحصول على البيانات الوصفية لملف XLSB ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات استخراج البيانات الوصفية لـ XLSB عبر Java" %}}
...
+ حفظ معلومات بيانات XLSB الوصفية
