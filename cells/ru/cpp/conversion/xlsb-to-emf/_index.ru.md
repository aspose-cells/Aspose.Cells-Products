---
title: Преобразование XLSB в EMF с помощью приложения C++ 
weight: 9640

description: Пример кода преобразования C++ для документа XLSB в формат EMF. Программисты могут использовать этот исходный код для пакетного преобразования XLSB в EMF в любом приложении C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики C++ могут легко преобразовать файл XLSB в EMF, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл XLSB с помощью Factory::CreateIWorkbook.1. Выберите первый рабочий лист.1. Установите (EMF) параметры.1. Итерация по каждой странице листа и визуализации.1. Откройте файл EMF в совместимой программе.
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования XLSB в EMF C++" offSpacer="" %}}
