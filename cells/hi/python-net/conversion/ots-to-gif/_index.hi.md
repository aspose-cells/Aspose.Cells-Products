---
title: Python ओटीएस से GIF - ओटीएस से GIF कन्वर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ OTS को GIF में जल्दी और आसानी से बदलें। Python OTS को GIF पर बदलें। Python OTS को GIF पर सहेजें। Python का उपयोग करके OTS को GIF के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="OTS को Python में GIF पर सेव करें" %}}
...
{{% cells-convert title="ओटीएस को GIF में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="gif" IsLandingPage="true" language="pythonnet" %}}
