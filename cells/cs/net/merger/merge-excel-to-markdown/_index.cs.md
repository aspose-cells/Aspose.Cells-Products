...
url: /cs/net/merger/merge-excel-to-markdown/ 
...
Následující příklad ukazuje, jak sloučit EXCEL s MARKDOWN v Aspose.Cells for .NET.
...
{{% cells-merger title="Ukázkový kód pro sloučení EXCELu s MARKDOWN v C#" InputFormat="xlsx" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL s MARKDOWN přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit EXCEL s MARKDOWN programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení EXCELu s MARKDOWN" %}}
