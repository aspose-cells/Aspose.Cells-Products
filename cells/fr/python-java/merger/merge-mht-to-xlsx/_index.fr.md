...
description: Aspose Exceller. Python Aspose.Cells. Fusionner MHT avec le format de sauvegarde XLSX. Python Combinez MHT au format XLSX. Fusionner MHT avec XLSX dans Python. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec XLSX dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner MHT avec XLSX dans Python" InputFormat="mht" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
