---
title: C++ uygulaması aracılığıyla XLS'yi PNG'ye dönüştürün 
weight: 80
url: /tr/cpp/conversion/xls-to-png/ 
description: XLS belgesi için PNG formatına örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu XLS'den PNG'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla XLS\'yi PNG\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı XLS\'den PNG\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, yalnızca birkaç kod satırıyla XLS dosyasını PNG'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak XLS dosyasını yükleyin.1. İlk çalışma sayfasını seçin.1. (PNG) seçeneklerini ayarlayın.1. Sayfanın her sayfasını yineleyin ve oluşturun.1. PNG dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="XLS\'den PNG\'ye C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
