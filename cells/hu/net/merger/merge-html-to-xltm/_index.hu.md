---
title: A HTML-XLTM-es számok egyesítése – a HTML-es és a XLTM-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-html-to-xltm/ 
description: Aspose Excel. C# Aspose.Cells. A HTML és a XLTM mentési formátum egyesítése. C# A HTML és a XLTM formátum kombinálása. Egyesítse a HTML-XLTM-et a C#-ben. HTML Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A HTML és a XLTM egyesítése a C#-ben" %}}

A következő példa bemutatja a HTML és a XLTM egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML-es és a XLTM-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a XLTM fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTML és XLTM számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a HTML és XLTM közötti egyesítéshez a C#-ben" InputFormat="html" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTML és a XLTM egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTML-et a XLTM-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML és XLTM egyesítéséhez" %}}
