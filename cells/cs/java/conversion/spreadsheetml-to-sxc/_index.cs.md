---
title: Převést SPREADSHEETML na SXC přes Java 
url: /cs/java/conversion/spreadsheetml-to-sxc/ 
description: Ukázkový konverzní kód Java pro formát SPREADSHEETML na soubor SXC. Programátoři mohou tento ukázkový kód použít k exportu tabulek Excelu a OpenOffice do SXC v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SPREADSHEETML na SXC přes Java" h2="Převod SPREADSHEETML na SXC Java pro převod jedné nebo více stránek na SXC pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SPREADSHEETML na SXC pomocí Java" %}}

 K vykreslení SPREADSHEETML do SXC použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SPREADSHEETML na SXC přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SPREADSHEETML na SXC pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SPREADSHEETML s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením SXC a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor SXC
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SPREADSHEETML na SXC Java" offSpacer="" %}}

```cs
// načtěte soubor SPREADSHEETML do instance Workbooku
Workbook book = new Workbook("template.spreadsheetml");
// uložit SPREADSHEETML jako SXC
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze SPREADSHEETML na SXC" sectionDescription="[Převést SPREADSHEETML na SXC](https://products.aspose.app/cells/conversion/spreadsheetml-to-sxc) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor SPREADSHEETML, bude okamžitě převeden na SXC." >}}
