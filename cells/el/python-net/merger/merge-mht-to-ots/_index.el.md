...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση MHT σε μορφή αποθήκευσης OTS. Python Συνδυάστε τη μορφή MHT σε OTS. Συγχώνευση MHT σε OTS στο Python. MHT Merge.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση MHT με OTS στο Python" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση MHT με OTS στο Python" InputFormat="mht" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
