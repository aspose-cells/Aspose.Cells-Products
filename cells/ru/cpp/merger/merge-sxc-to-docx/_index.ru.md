---
title: Объединить SXC с DOCX — объединить SXC с DOCX в C++.
url: /ru/cpp/merger/merge-sxc-to-docx/ 
description: Aspose Эксель. C++ Aspose.Cells. Объедините SXC и DOCX в формате сохранения. C++ Объедините форматы SXC и DOCX. Объедините SXC и DOCX в C++. SXC Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините SXC и DOCX в C++." %}}

В следующем примере показано, как объединить SXC и DOCX в Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить номера SXC и DOCX. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле DOCX. Если вы разработаете код C++, это будет проще, чем кажется. См. пример C++, в котором SXC объединяется с DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения чисел SXC и DOCX в C++" InputFormat="sxc" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как объединить SXC с DOCX через C++" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить номера SXC и DOCX? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для объединения SXC и DOCX." %}}
