---
title: Gộp TABDELIMITED thành XLS - Gộp TABDELIMITED thành XLS trong Java
url: /vi/java/merger/merge-tabdelimited-to-xls/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất TABDELIMITED thành XLS định dạng lưu. Java Kết hợp TABDELIMITED thành định dạng XLS. Hợp nhất TABDELIMITED thành XLS trong Java. TABDELIMITED Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất TABDELIMITED thành XLS trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất TABDELIMITED thành XLS trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất TABDELIMITED với XLS. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu vào tệp XLS. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất TABDELIMITED thành XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất TABDELIMITED thành XLS trong Java" InputFormat="tsv" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp TABDELIMITED thành XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất TABDELIMITED thành XLS theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
