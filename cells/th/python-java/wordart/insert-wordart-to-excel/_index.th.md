---
title:  แทรก WordArt ลงใน Excel ผ่าน Python
weight: 200
description: ซอร์สโค้ด Python เพื่อแทรก WordArt ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก WordArt ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก WordArt ลงไฟล์ Excel ผ่าน Python" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addWordArt(int,%20java.lang.String,%20int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกอักษรศิลป์ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกอักษรศิลป์ - Python" offSpacer="" %}}
