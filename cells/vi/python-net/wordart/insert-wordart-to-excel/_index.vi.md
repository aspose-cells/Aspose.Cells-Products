...
+ Sử dụng phương thức thêm của bộ sưu tập hình dạng để chèn WordArt vào trang tính đã chọn.
...
-  Cài đặt Aspose.Cells for Python via .NET từ<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , sử dụng lệnh như:<code>$ pip install aspose-cells-python</code>.
