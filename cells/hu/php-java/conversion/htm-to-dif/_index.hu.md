---
title: PHP HTM-DIF - HTM-DIF konvertáló
description: Aspose Excel. A HTM-et gyorsan és egyszerűen konvertálja DIF-re a Aspose.Cells-gyel. PHP HTM-et DIF-re. PHP HTM mentése DIF-re. HTM mentése DIF-re PHP használatával.
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet HTM-et konvertálni DIF-re PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A HTM-fájlokat programozottan DIF-re kell konvertálni? A PHP fejlesztői könnyedén betölthetik és konvertálhatják a HTM-et DIF-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a HTM-et DIF-re a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a HTM konverziós eredményét DIF-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a HTM konvertálásához DIF-re" %}}
