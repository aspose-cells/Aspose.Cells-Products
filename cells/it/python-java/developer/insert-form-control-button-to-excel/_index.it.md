---
title: Inserisci il pulsante (controllo modulo) in Excel utilizzando Python via java
weight: 200
description: Python via codice sorgente java per inserire Button (controllo modulo) in Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci il pulsante (controllo modulo) in Excel utilizzando Python via java" h2="Inserisci oggetti utilizzando le API lato server senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire il pulsante (controllo modulo) nel file Excel utilizzando Python via java" %}}

 Per inserire Button (controllo modulo) nel file excel, useremo
 [Aspose.Cells for Python via java](https://pypi.org/project/aspose-cells/) 
API che è una manipolazione di documenti ricca di funzionalità, potente e facile da usare API per python tramite piattaforma java. Lo API fornisce la creazione, la manipolazione, la conversione e il rendering di file Excel. Il tutto senza affidarsi alle applicazioni Office o Excel Microsoft. È possibile installare dalla console utilizzando il seguente comando.
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire il pulsante (controllo modulo) nel file Excel utilizzando Python via java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa la collezione di forme[aggiungere metodo](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)per inserire un pulsante (controllo modulo) nel foglio di lavoro selezionato.
...
-  Qualsiasi sistema operativo in grado di eseguire Python tramite script Java, come Windows, Linux e MacOS
...
{{% blocks/products/pf/agp/code-block title="Inserisci pulsante (controllo modulo) - Python via java" offSpacer="" %}}
