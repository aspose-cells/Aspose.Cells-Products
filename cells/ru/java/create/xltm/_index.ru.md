---
title: Создать файлы MS Excel XLTM via Java
description: XLTM создатель. Создайте файлы XLTM в коде Java. Создавайте файлы MS Excel XLTM с помощью настольного или веб-приложения на основе Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Создать файл XLTM via Java" h2="Нативное и высокопроизводительное создание электронных таблиц MS Excel XLTM программно с использованием библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Как создать XLTM via Java" %}}
...
1.  Сохраните книгу в формате XLTM, используя метод save().

{{% blocks/products/pf/agp/code-block title="В следующем исходном коде показано, как создать файл MS Excel XLTM, используя Java." offSpacer="" %}}
