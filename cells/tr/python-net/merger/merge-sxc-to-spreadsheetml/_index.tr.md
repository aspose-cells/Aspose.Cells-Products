...
url: /tr/python-net/merger/merge-sxc-to-spreadsheetml/ 
...
Aşağıdaki örnek, SXC'in SPREADSHEETML ile Aspose.Cells for Python via .NET'de nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 SXC'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
