...
url: /zh/cpp/merger/merge-xltx-to-image/ 
...
以下示例演示如何将 XLTX 合并到 Aspose.Cells for C++ 中的 IMAGE。
...
需要以编程方式将 XLTX 合并到 IMAGE 吗？基本文档合并和连接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++库将XLTX合并到IMAGE" %}}
