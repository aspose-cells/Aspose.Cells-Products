...
description: Aspose Excel。此綜合解決方案為 C# 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 IMAGE 格式，從而能夠使用 Aspose.Cells 庫將 FODS 資料無縫保存為 IMAGE 格式，所有這些都透過高效且可自訂的 1533816153381 1533815338 程式碼可實現。
...
{{% cells-convert title="將 FODS 轉換為影像的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 FODS 檔案轉換為 IMAGE？ .NET 開發人員只需幾行程式碼即可輕鬆載入 FODS 並將其轉換為 IMAGE。
...
1. 使用工作簿實例載入 FODS 檔案。
1. 呼叫 Workbook.Save 方法將 FODS 轉換為 IMAGE。
1. 取得FODS到IMAGE的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 庫將 FODS 轉換為 IMAGE" %}}
