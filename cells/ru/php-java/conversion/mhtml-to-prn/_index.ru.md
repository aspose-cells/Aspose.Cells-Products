...
description: Aspose Эксель. Быстро и легко конвертируйте MHTML в PRN с помощью Aspose.Cells. PHP MHTML в PRN. PHP Сохранить MHTML в PRN. Сохраните MHTML как PRN, используя PHP.
...
{{% blocks/products/pf/agp/content h2="Преобразование MHTML в PRN с помощью PHP" %}}

 Как мне преобразовать MHTML в PRN? С помощью библиотеки Aspose.Cells for PHP via Java вы можете легко преобразовать MHTML в PRN программно с помощью нескольких строк кода.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) способен создавать кроссплатформенные приложения с возможностью генерировать, изменять, конвертировать, отображать и распечатывать все файлы Excel. PHP Excel API не только конвертирует форматы электронных таблиц, но также может отображать файлы Excel в виде изображений, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT и т. д., что делает его идеальным выбором для обмена документами в стандартных отраслевых форматах.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Сохраните MHTML в PRN на PHP." %}}

В следующем примере показано, как преобразовать MHTML в PRN в PHP.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать MHTML в PRN через PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы MHTML в PRN? Разработчики PHP могут легко загрузить и преобразовать MHTML в PRN всего за несколько строк кода.
...
1.  Преобразуйте MHTML в PRN, вызвав метод сохранения книги.
1.  Получите результат преобразования MHTML в PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования MHTML в PRN" %}}
