...
description: Aspose Excel. Konvertieren Sie XLTX schnell und einfach in JPG mit Aspose.Cells. PHP XLTX in JPG. PHP Speichern Sie XLTX als JPG. Speichern Sie XLTX als JPG mit PHP.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLTX über PHP in JPG" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLTX-Dateien programmgesteuert in JPG konvertieren? PHP-Entwickler können XLTX in nur wenigen Codezeilen problemlos laden und in JPG konvertieren.
...
1. Konvertieren Sie XLTX in JPG, indem Sie die Speichermethode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLTX in JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von XLTX in JPG" %}}
