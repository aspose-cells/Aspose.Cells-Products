---
title: XLS'i WORD'e dönüştür Python via Python
description: XLS'i WORD Online'a Ücretsiz Dönüştürün. Ücretsiz Çevrimiçi XLS'den WORD'e Dönüştürücü. Python XLS'den WORD'e. XLS'den WORD'e Python aracılığıyla.
keywords: Convert XLS, XLS Converter, XLS to PDF, XLS to Word, XLS to PPT, XLS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS\'i Python aracılığıyla WORD\'e dönüştür" h2="Python API\'leri kullanarak Excel elektronik tablolarını WORD biçimine aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Python geliştiricileri, yalnızca birkaç satır kodla XLS'i kolayca yükleyebilir ve WORD'e dönüştürebilir.
