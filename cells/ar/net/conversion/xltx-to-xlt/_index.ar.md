---
title: C# XLTX إلى XLT - عبر الإنترنت من XLTX إلى XLT
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل XLTX إلى XLT saveformat. C# XLTX إلى تنسيق XLT. وفر XLTX إلى XLT C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل XLTX إلى XLT في C#" h2="مكتبة C# عالية السرعة لتحويل XLTX إلى XLT. هذا حل برمجي احترافي لاستيراد وتصدير XLTX و XLT والعديد من التنسيقات الأخرى على .NET Framework أو .NET Core أو Mono الأنظمة الأساسية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
تحتاج إلى تحويل XLTX ملفات إلى XLT برمجيا؟ يمكن للمطورين .NET تحميل وتحويل XLTX إلى XLT بسهولة في بضعة أسطر من التعليمات البرمجية.
