...
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan Info ke Excel via Java" h2="Masukkan Callouts menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan Info ke File Excel Menggunakan Java" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[tambahkan metode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) untuk menyisipkan Info di lembar kerja yang dipilih
...
Contoh kode di bawah ini menunjukkan cara menyisipkan "Gelembung Pikiran: Awan". Untuk tipe lainnya, lihat "Ikhtisar Tipe Info Blokir" di bawah.
