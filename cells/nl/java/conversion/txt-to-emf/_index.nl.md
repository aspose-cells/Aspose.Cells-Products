...
{{% blocks/products/pf/agp/content h2="Sla TXT op in EMF in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar EMF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar EMF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar EMF? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar EMF met slechts een paar regels code.
