...
description: Aspose エクセル。 C++ Aspose.Cells。XLS を HTM 保存形式にマージします。 C++ XLS を HTM 形式に結合します。 XLS を C++ の HTM にマージします。 XLS をマージします。
...
{{% blocks/products/pf/agp/content h2="XLS を C++ の HTM にマージ" %}}
...
{{% cells-merger title="XLS を C++ の HTM にマージするサンプルコード" InputFormat="xls" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
