---
title: Sloučit MHT do HTM – Zkombinujte MHT s HTM v Java
url: /cs/java/merger/merge-mht-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení HTM. Java Kombinujte formát MHT s HTM. Sloučit MHT do HTM v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do HTM v Java" %}}

Následující příklad ukazuje, jak sloučit MHT do HTM v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT do HTM. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru HTM. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT do HTM v Java" InputFormat="mht" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT do HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit MHT do HTM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna pro sloučení MHT do HTM" %}}
