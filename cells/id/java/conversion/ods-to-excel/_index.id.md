...
description: Aspose Unggul. Ubah ODS menjadi EXCEL dengan cepat dan mudah dengan Aspose.Cells. Java ODS menjadi EXCEL. Java Simpan ODS ke EXCEL. Simpan ODS sebagai EXCEL menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ODS menjadi EXCEL di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi ODS ke EXCEL. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, EXCEL, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
Contoh berikut menunjukkan cara mengonversi ODS ke EXCEL di Java.
...
Perlu mengonversi file ODS ke EXCEL secara terprogram? Pengembang Java dapat dengan mudah mengonversi ODS ke EXCEL hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengkonversi ODS ke EXCEL" %}}
{{% blocks/products/pf/agp/text %}}
