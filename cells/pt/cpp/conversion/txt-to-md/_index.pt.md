---
title: Converter TXT para MD por meio do aplicativo C++ 

description: Exemplo de código de conversão C++ de documento TXT para formato MD. Os programadores podem usar esse código-fonte para conversão em lote de TXT para MD em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/content h2="Como converter TXT para MD usando C++" %}}

 Para converter TXT para MD, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter TXT para MD via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem facilmente converter arquivos TXT para MD em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo TXT usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com a extensão de arquivo (MD).1. arquivo MD será salvo no caminho especificado.1. Abra o arquivo MD em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de TXT para MD C++" offSpacer="" %}}
