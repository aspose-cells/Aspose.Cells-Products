...
description: Aspose Excel. Python Aspose.Cells. A XLTX egyesítése SQL mentési formátumba. Python Kombinálja a XLTX-et SQL formátumba. A XLTX egyesítése SQL-be a Python-ben. XLTX Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A XLTX egyesítése SQL-be a Python használatával" %}}
...
{{% blocks/products/pf/agp/content h2="A XLTX egyesítése SQL-lel a Python-ben" %}}

következő példa bemutatja, hogyan egyesítheti a XLTX-et az SQL-lel a Aspose.Cells for Python via Java-ben.
...
{{% cells-merger title="Mintakód a XLTX SQL-hez való egyesítéséhez a Python-ben" InputFormat="xltx" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="A XLTX egyesítése SQL-be a Python-en keresztül" %}}
