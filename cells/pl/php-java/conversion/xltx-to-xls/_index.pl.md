...
description: Aspose Excel. Konwertuj XLTX na XLS szybko i łatwo za pomocą Aspose.Cells. PHP XLTX na XLS. PHP Zapisz XLTX na XLS. Zapisz XLTX jako XLS używając PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLTX na XLS w PHP" h2="Szybka biblioteka PHP do konwersji XLTX na XLS. Jest to profesjonalne oprogramowanie do importowania i eksportowania XLTX, XLS i wielu innych formatów przy użyciu PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Chcesz programowo przekonwertować pliki XLTX na XLS? Programiści PHP mogą łatwo załadować i przekonwertować XLTX na XLS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLTX na numer XLS, wywołując metodę zapisu skoroszytu.
