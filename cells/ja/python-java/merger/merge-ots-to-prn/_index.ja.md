...
次の例は、Aspose.Cells for Python via Java で OTS を PRN にマージする方法を示しています。
...
OTSをPRNにプログラムでマージする必要がありますか？基本的なドキュメントのマージと連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
