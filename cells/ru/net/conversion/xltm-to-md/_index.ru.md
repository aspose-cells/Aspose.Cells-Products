---
title: Конвертер C# XLTM в MD - XLTM в MD
description: Aspose Эксель. Преобразуйте XLTM в MD быстро и легко с помощью Aspose.Cells. C# XLTM в MD. C# Сохраните XLTM в MD. Сохраните XLTM как MD, используя C#.
...
В следующем примере показано, как преобразовать XLTM в MD в C#.
...
{{% cells-convert title="Пример кода для преобразования XLTM в MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать XLTM в MD через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно конвертировать файлы XLTM в MD? Разработчики .NET могут легко загрузить и преобразовать XLTM в MD всего за несколько строк кода.
