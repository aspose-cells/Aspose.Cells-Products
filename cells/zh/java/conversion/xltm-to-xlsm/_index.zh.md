...
{{% blocks/products/pf/agp/content h2="免费在线保存XLTM至XLSM至Java" %}}

以下示例演示如何将 Java 中的 XLTM 转换为 XLSM。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLTM 转换为 XLSM。上传您的 XLTM 文件，然后将其另存为 XLSM 文件。对于 XLTM 读取和 XLSM 写入，您可以使用完全限定的文件名。输出 XLSM 内容和格式将与原始 XLTM 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="在线将 XLTM 转换为 XLSM 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="xlsm" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLTM 转换为 XLSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java 开发人员只需几行代码就可以轻松地将 XLTM 转换为 XLSM。
...
{{% blocks/products/pf/agp/content h2="Java 库将 XLTM 转换为 XLSM" %}}
{{% blocks/products/pf/agp/text %}}
