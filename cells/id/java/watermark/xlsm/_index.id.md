...
{{% blocks/products/pf/agp/content h2="Cara Memberi Watermark pada File XLSM Menggunakan Java" %}}
 ...
 Untuk memberi watermark pada file XLSM, kami akan menggunakan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API yang merupakan platform watermarking yang kaya fitur, kuat, dan mudah digunakan API for Java. Anda dapat mendownload versi terbarunya langsung dari[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) dan instal dalam proyek berbasis Maven Anda dengan menambahkan konfigurasi berikut ke pom.xml.
