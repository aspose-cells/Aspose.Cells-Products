...
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till ET-format, vilket möjliggör sömlös sparning av XLS-data till ET-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till ET i C#" %}}
...
Behöver du konvertera XLS-filer till ET programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till ET på bara några rader kod.
