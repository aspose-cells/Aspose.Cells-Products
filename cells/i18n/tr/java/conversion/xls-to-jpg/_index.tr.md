---
title: Java aracılığıyla XLS'yi JPG'ye dönüştürün 
url: /tr/java/conversion/xls-to-jpg/ 
description: XLS biçimi için JPG dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada JPG'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla XLS\'yi JPG\'ye dönüştürün" h2="Şirket içi Java kitaplığını kullanarak tek veya birden çok sayfayı JPG\'ye dönüştürmek için XLS\'den JPG\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak XLS\'yi JPG\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla XLS\'yi JPG\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla XLS dosyasını JPG'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. XLS dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. Çıktı yolunu JPG uzantısı ve SaveFormat ile parametre olarak iletin1. Ortaya çıkan JPG dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="XLS\'den JPG\'ye Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// XLS dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.xls");
// XLS'yi JPG olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS\'den JPG\'ye Dönüştürme Canlı Demoları" sectionDescription="[XLS\'yi JPG\'ye Dönüştür](https://products.aspose.app/cells/conversion/xls-to-jpg) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece XLS dosyanızı yükleyin, anında JPG\'ye dönüştürülecektir." >}}
