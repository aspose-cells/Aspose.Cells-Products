---
title: C++ XLS เป็น MHT - ออนไลน์ XLS เป็น MHT Converter
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลงรูปแบบบันทึก XLS เป็น MHT C++ XLS เป็นรูปแบบ MHT บันทึก XLS ถึง MHT C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS เป็น MHT ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง XLS เป็น MHT โดยเรียกเมธอด Save()
