...
L'esempio seguente mostra come unire XLSM a XLSX in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Devi unire XLSM a XLSX a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Le API possono essere eseguite con poche righe di codice.
