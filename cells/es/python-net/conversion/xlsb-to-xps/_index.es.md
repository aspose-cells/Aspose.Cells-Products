...
description: Aspose Excel. Convierta XLSB a XPS rápida y fácilmente con Aspose.Cells. Python XLSB a XPS. Python Guarde XLSB en XPS. Guarde XLSB como 07611134 81 usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB a XPS en Python" h2="Biblioteca Python de alta velocidad para convertir XLSB a XPS. Utilice nuestra conversión de Excel API para desarrollar software independiente de plataforma de alto nivel en Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir XLSB a XPS en Python" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB al XPS en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a XPS en Python via NET.
...
¿Necesita convertir archivos XLSB a XPS mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente XLSB a XPS en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB en XPS" %}}
