---
title: Fusionar PRN con SPREADSHEETML - Combinar PRN con SPREADSHEETML en C++
url: /es/cpp/merger/merge-prn-to-spreadsheetml/ 
description: Aspose Excel. C++ Aspose.Cells. Fusionar PRN con el formato guardado SPREADSHEETML. C++ Combinar formato PRN a SPREADSHEETML. Fusionar PRN con SPREADSHEETML en C++. Fusionar PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionar PRN con SPREADSHEETML en C++" %}}

El siguiente ejemplo demuestra cómo fusionar PRN con SPREADSHEETML en Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar PRN con SPREADSHEETML. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo SPREADSHEETML. Si desarrolla código en C++, esto será más simple de lo que parece. Consulte el ejemplo C++ que combina PRN con SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar PRN con SPREADSHEETML en C++" InputFormat="prn" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN con SPREADSHEETML a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar PRN con SPREADSHEETML mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden crear con solo unas pocas líneas de código.
