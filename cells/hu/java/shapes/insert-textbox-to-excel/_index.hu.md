---
title:  Helyezze be a TextBoxot az Excel via Java-be
weight: 60
...
{{< blocks/products/pf/i18n/upper-banner h1="Helyezze be a TextBoxot az Excel via Java-be" h2="Szerveroldali API-k használatával szúrjon be objektumokat szoftver nélkül, például Microsoft vagy Open Office, Adobe PDF stb." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="TextBox beszúrása Excel fájlba a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A TextBox beszúrásának lépései a via Java számú Excel-fájlba" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja a[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addTextBox-int-int-int-int-int-int-) a TextBox beszúrásához a kiválasztott munkalapba
...
{{% blocks/products/pf/agp/code-block title="Szövegdoboz beszúrása - Java" offSpacer="" %}}
