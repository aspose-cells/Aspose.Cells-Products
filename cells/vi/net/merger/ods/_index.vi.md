---
title:  Hợp nhất các tập tin ODS via .NET
weight: 4330
description: C# để kết hợp các tài liệu ODS trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng ODS trong C#" h2="Hợp nhất tài liệu gốc và hiệu suất cao ODS bằng cách sử dụng API Aspose.Cells for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
+ Tải toàn bộ file ODS đầy đủ đường dẫn.
+ Tạo một tài liệu làm tệp cơ sở
+ Gọi phương thức liên quan để nối và hợp nhất từng tệp một.
+ Gọi phương thức Save() và truyền tên tệp (đường dẫn đầy đủ) và định dạng (ODS) làm tham số.
+ Bây giờ bạn có thể mở và sử dụng tệp ODS trong Microsoft Office, Adobe PDF hoặc bất kỳ chương trình tương thích nào khác.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp ODS - C#" offSpacer="" %}}
