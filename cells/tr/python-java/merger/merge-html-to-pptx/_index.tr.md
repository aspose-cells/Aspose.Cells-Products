---
title:  HTML'i Python aracılığıyla PPTX ile birleştirin
...
Aşağıdaki örnek, HTML'in Python'de PPTX ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="HTML\'i hatta PPTX ile birleştirmek için Ücretsiz Uygulama" InputFormat="html" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
