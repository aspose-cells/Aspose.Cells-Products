...
url: /ja/python-java/merger/merge-xltm-to-image/ 
...
次の例は、XLTM を Aspose.Cells for Python via Java の IMAGE に結合する方法を示しています。
...
XLTMをプログラム的にIMAGEにマージする必要がありますか？基本的な文書のマージと連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
