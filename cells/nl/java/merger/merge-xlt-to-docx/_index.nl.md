---
title: Voeg XLT samen met DOCX - Combineer XLT met DOCX in Java
url: /nl/java/merger/merge-xlt-to-docx/ 
description: Aspose Excel. Java Aspose.Cells. Voeg XLT samen met het opslagformaat DOCX. Java Combineer het formaat XLT met DOCX. Voeg XLT samen met DOCX in Java. XLT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen met DOCX in Java" %}}

Het volgende voorbeeld laat zien hoe u XLT samenvoegt met DOCX in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLT samen te voegen met DOCX. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand DOCX. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld Java waarin XLT wordt samengevoegd met DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLT samen te voegen met DOCX in Java" InputFormat="xlt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLT samenvoegt met DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen met DOCX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLT samen te voegen met DOCX" %}}
