---
title:  Tìm kiếm tài liệu XLSM mà không cần mở thông qua số C++.
weight: 9280
description: Mã ví dụ C++ để tìm kiếm các từ có mẫu trong tệp XLSM trên Môi trường thời gian chạy C++ dành cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm định dạng XLSM trong C++" h2="Tìm kiếm tài liệu gốc và hiệu suất cao XLSM bằng cách sử dụng API phía máy chủ Aspose.Cells for C++, mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tìm kiếm tệp XLSM bằng mã số C++" %}}

 Để tìm kiếm tệp XLSM, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tìm kiếm tệp XLSM trong C++" %}}
...
+ Tải tập tin XLSM bằng cách sử dụng lớp Workbook.
...
{{% blocks/products/pf/agp/code-block title="Tìm kiếm tệp XLSM - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Tìm kiếm trực tuyến XLSM Bản demo trực tiếp" sectionDescription=" Tìm kiếm văn bản, từ ngữ, cụm từ trong tài liệu XLSM ngay bây giờ bằng cách truy cập trang web của chúng tôi.[Trang web demo trực tiếp](https://products.aspose.app/cells/search). Bản demo trực tiếp có những lợi ích sau" >}}
