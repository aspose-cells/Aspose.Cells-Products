---
title: ET oluştur - C#'de ET dosyası oluşturun
description: Aspose Excel. Aspose.Cells for .NET kütüphanesi ile ET dosyalarını zahmetsizce oluşturun ve işleyin. Bu güçlü API, ET dosyalarını doğrudan C# uygulamalarınız içinde oluşturmak, düzenlemek ve yönetmek için akıcı ve verimli bir çözüm sunarak, geliştiricilerin özel ihtiyaçlarını yüksek hassasiyetle karşılar.
...
{{% blocks/products/pf/agp/content h2="C#\'de ET Nasıl Oluşturulur?" %}}
...
1.  Çalışma kitabını ET dosyası olarak kaydetmek için Kaydet yöntemini kullanın.

{{% blocks/products/pf/agp/code-block title="Örnek kod, C# numaralı cihazda ET dosyasının nasıl oluşturulacağını göstermektedir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="ET dosyası oluşturmak için C# kütüphanesi" %}}
