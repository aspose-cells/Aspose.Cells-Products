...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in JSON in Java" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar JSON in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLTM om naar JSON of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLTM programmatisch converteren naar JSON? Ontwikkelaars van Java kunnen bestanden met de extensie XLTM eenvoudig converteren naar JSON met slechts een paar regels code.
