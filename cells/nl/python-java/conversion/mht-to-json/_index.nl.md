...
description: Aspose Excel. Converteer MHT snel en eenvoudig naar JSON met Aspose.Cells. Python MHT naar JSON. Python Bewaar MHT naar JSON. Sla MHT op als JSON met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MHT naar JSON in Python" h2="Snelle Python-bibliotheek voor het converteren van MHT naar JSON. Dit is een professionele softwareoplossing voor het importeren en exporteren van MHT, JSON en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Bewaar MHT op JSON in Python" %}}

In het volgende voorbeeld ziet u hoe u MHT converteert naar JSON in Python.
...
{{% cells-convert title="Voorbeeldcode om MHT naar JSON te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="json" IsLandingPage="true" language="pythonjava" %}}
