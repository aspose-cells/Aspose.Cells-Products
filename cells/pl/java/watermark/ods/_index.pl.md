...
{{< blocks/products/pf/i18n/upper-banner h1="Dodaj tekstowy znak wodny do ODS za pomocą Java" h2="Twórz własne Java aplikacje do znakowania plików ODS przy użyciu interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak dodać znak wodny do pliku ODS za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby dodać znak wodny do ODS za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Utwórz nowy obiekt Workbook1. Wybierz arkusz roboczy za pomocą jego indeksu1. Utwórz kształt i użyj jego funkcji addTextEffect1. Ustaw kolory, przezroczystość i nie tylko1. Zapisz skoroszyt w formacie ODS
