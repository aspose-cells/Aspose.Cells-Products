...
ต้องการแปลงไฟล์ XML เป็น MD ด้วยโปรแกรมใช่ไหม? นักพัฒนาสามารถแปลง XML เป็น MD ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด (รหัส C++)
...
1.  แปลง XML เป็น MD โดยเรียกใช้เมธอด Save()
