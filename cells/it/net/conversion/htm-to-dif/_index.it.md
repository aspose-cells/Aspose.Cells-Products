---
title: C# HTM a DIF - Convertitore online da HTM a DIF
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Free Online C# Converti HTM in DIF saveformat. C# HTM al formato DIF. Salva HTM a DIF C#.
...
{{% blocks/products/pf/agp/content h2="Salva HTM a DIF in C# online gratuitamente" %}}

L'esempio seguente mostra come convertire HTM in DIF in C#.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire HTM in DIF. Carica il tuo file HTM, quindi salvalo semplicemente come file DIF. Sia per la lettura HTM che per la scrittura DIF è possibile utilizzare nomi di file completi. Il contenuto e la formattazione dell'output DIF saranno identici al documento HTM originale.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="App gratuita e codice di esempio per convertire HTM in DIF online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Come convertire HTM in DIF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file HTM in DIF a livello di codice? Gli sviluppatori .NET possono facilmente caricare e convertire HTM in DIF in poche righe di codice.
...
1.  Converti HTM in DIF chiamando il metodo Workbook.Save.
1.  Ottieni il risultato della conversione di HTM in DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# libreria per convertire HTM in DIF" %}}
