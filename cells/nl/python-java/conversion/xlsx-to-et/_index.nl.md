...
description: Aspose Excel. Converteer XLSX snel en eenvoudig naar ET met Aspose.Cells. Python XLSX naar ET. Python Bewaar XLSX naar ET. Bewaar XLSX als ET met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLSX naar ET in Python" h2="Snelle bibliotheek Python voor het converteren van XLSX naar ET. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, ET en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer XLSX naar ET met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLSX naar ET in Python" %}}

Het volgende voorbeeld laat zien hoe u XLSX naar ET in Python converteert.
...
{{% cells-convert title="Voorbeeldcode om XLSX naar ET te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="et" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLSX naar ET te converteren" %}}
