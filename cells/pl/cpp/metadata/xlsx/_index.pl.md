---
title:  Edytuj lub wyświetl metadane dokumentu XLSX pod numerem C++
weight: 8970
description: C++ przykładowy kod do edycji lub przeglądania metadanych pliku XLSX w C++ Środowisko wykonawcze dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
...
{{% blocks/products/pf/agp/content h2="Jak uzyskać metadane XLSX przy użyciu C++" %}}
...
+ Załaduj plik XLSX przy użyciu WorkbookMetadata
