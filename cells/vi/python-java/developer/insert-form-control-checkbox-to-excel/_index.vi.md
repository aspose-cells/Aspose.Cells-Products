...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) để chèn Hộp kiểm (Điều khiển biểu mẫu) vào trang tính đã chọn.
