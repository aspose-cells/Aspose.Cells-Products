---
title: Slå samman XLSM till BMP - Kombinera XLSM till BMP i C#
url: /sv/net/merger/merge-xlsm-to-bmp/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge XLSM till BMP sparaformat. C# Kombinera XLSM till BMP format. Slå samman XLSM till BMP i C#. XLSM Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman XLSM till BMP i C# Online gratis" %}}

Följande exempel visar hur man slår samman XLSM till BMP i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman XLSM till BMP. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen BMP. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman XLSM till BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman XLSM till BMP i C#" InputFormat="xlsm" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLSM till BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLSM till BMP programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XLSM till BMP" %}}
