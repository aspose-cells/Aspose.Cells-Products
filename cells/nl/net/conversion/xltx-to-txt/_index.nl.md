---
title: C# XLTX naar TXT - Online XLTX naar TXT Converter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratis online C# Converteer XLTX naar TXT saveformat. C# XLTX tot TXT formaat. Bewaar XLTX tot TXT C#.
...
{{% blocks/products/pf/agp/content h2="Converteer XLTX naar TXT met C#" %}}
...
{{% blocks/products/pf/agp/content h2="Bespaar XLTX tot TXT in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLTX converteert naar TXT in C#.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLTX naar TXT te converteren. Upload uw XLTX-bestand en sla het vervolgens eenvoudig op als TXT-bestand. Voor zowel XLTX lezen als TXT schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De uitvoer TXT inhoud en opmaak zal identiek zijn aan het originele XLTX document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Gratis app en voorbeeldcode om XLTX online naar TXT te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLTX te converteren naar TXT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLTX-bestanden programmatisch converteren naar TXT? .NET-ontwikkelaars kunnen eenvoudig XLTX laden en converteren naar TXT in slechts een paar regels code.
...
1.  Converteer XLTX naar TXT door de methode Workbook.Save aan te roepen.
