---
title: Java EXCEL para MHT - Conversor de EXCEL para MHT
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores Java uma abordagem totalmente integrada para converter EXCEL para o formato MHT, permitindo o salvamento perfeito de dados EXCEL no formato MHT usando a biblioteca Aspose.Cells, tudo por meio de código Java eficiente e personalizável.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter EXCEL para MHT em Java" h2="Biblioteca Java de alta velocidade para conversão de EXCEL para MHT. Esta é uma solução de software profissional para importar e exportar arquivos EXCEL, MHT e muitos outros formatos usando a biblioteca Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salvar EXCEL em MHT em Java" %}}

O exemplo a seguir demonstra como converter EXCEL para MHT em Java.
...
Precisa converter arquivos EXCEL para MHT programaticamente? Os desenvolvedores do programa Java podem converter facilmente arquivos EXCEL para MHT com apenas algumas linhas de código.
...
1.  Converta o formato EXCEL para MHT chamando o método Workbook.save.
1. Obtenha o resultado da conversão de EXCEL para MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca Java para converter EXCEL em MHT" %}}
{{% blocks/products/pf/agp/text %}}
