...
url: /tr/python-java/merger/merge-png-to-mht/ 
...
Aşağıdaki örnek, PNG'in Aspose.Cells for Python via Java'deki MHT ile nasıl birleştirileceğini gösterir.
...
PNG'i MHT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
