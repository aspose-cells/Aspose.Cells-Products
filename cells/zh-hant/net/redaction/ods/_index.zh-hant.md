---
title: 搜尋並取代 ODS 文件 via .NET 中的文本
weight: 6100
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上編輯 ODS 檔案中的敏感資訊。
...
為了編輯 ODS 文件，我們將使用[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API這是一個功能豐富、強大且易於使用的文件操作API，適用於C#平台。打開[NuGet](https://www.nuget.org/packages/aspose.cells)套件管理器，搜尋**Aspose.Cells**並安裝。您也可以從套件管理器控制台使用以下命令。
