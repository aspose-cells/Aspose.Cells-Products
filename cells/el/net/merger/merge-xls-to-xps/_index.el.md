...
description: Aspose Excel. C# Aspose.Cells. Συγχώνευση XLS σε μορφή αποθήκευσης XPS. C# Συνδυάστε τη μορφή XLS με XPS. Συγχώνευση XLS σε XPS στο C#. XLS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLS με XPS στο C#" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLS έως XPS στο C#" InputFormat="xls" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
