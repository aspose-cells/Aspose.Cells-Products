...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 开发人员只需几行代码即可轻松加载 JSON 文件并将其转换为 TSV。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 实例加载 JSON 文件1. 调用 Workbook.Save 方法1. 以 TSV 扩展名作为参数传递输出路径1. 检查生成的 TSV 文件的指定路径
...
{{% cells-convert title="将 JSON 转换为 TSV 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="tsv" IsLandingPage="true" %}}
