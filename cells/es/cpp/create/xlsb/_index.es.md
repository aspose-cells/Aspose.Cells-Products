...
description: Aspose Excel. Genere y manipule fácilmente archivos XLSB con la biblioteca Aspose.Cells for C++. Esta potente biblioteca API ofrece una solución optimizada y eficiente para crear, editar y administrar archivos XLSB directamente en sus aplicaciones C++, satisfaciendo las necesidades específicas de los desarrolladores con alta precisión.
...
1.  Guarde el libro de trabajo como archivo .xlsb usando el método Save().
