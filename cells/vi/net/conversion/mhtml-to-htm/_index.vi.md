---
title: Bộ chuyển đổi C# sang HTM - MHTML sang HTM
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển C# một phương pháp tích hợp đầy đủ để chuyển đổi MHTML sang định dạng HTM, cho phép lưu dữ liệu MHTML vào định dạng HTM một cách liền mạch bằng cách sử dụng thư viện Aspose.Cells, tất cả thông qua mã C# hiệu quả và có thể tùy chỉnh.
...
{{% blocks/products/pf/agp/content h2="Lưu mã MHTML vào HTM trong mã C#" %}}

Ví dụ sau đây minh họa cách chuyển đổi MHTML sang HTM trong C#.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản sau để chuyển đổi MHTML sang HTM. Tải lên tệp MHTML của bạn, sau đó chỉ cần lưu nó dưới dạng tệp HTM. Đối với cả việc đọc MHTML và ghi HTM, bạn đều có thể sử dụng tên tệp đầy đủ. Nội dung và định dạng HTM đầu ra sẽ giống hệt với tài liệu MHTML gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ví dụ mã để chuyển đổi MHTML sang HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mhtml" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi MHTML sang HTM thông qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Bạn cần chuyển đổi các tệp MHTML sang HTM bằng lập trình? Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi MHTML sang HTM chỉ với một vài dòng mã.
...
1.  Chuyển đổi MHTML sang định dạng HTM bằng cách gọi phương thức Workbook.Save.
1.  Nhận kết quả chuyển đổi từ MHTML sang HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C# để chuyển đổi MHTML sang HTM" %}}
