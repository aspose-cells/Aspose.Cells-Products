---
title: HTM mit ODS zusammenführen – HTM mit ODS in C++ kombinieren
url: /de/cpp/merger/merge-htm-to-ods/ 
description: Aspose Excel. C++ Aspose.Cells. HTM mit dem Sicherungsformat ODS zusammenführen. C++ Kombinieren Sie HTM mit dem Format ODS. HTM zu ODS in C++ zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="HTM mit ODS in C++ zusammenführen" %}}

Das folgende Beispiel zeigt, wie HTM mit ODS in Aspose.Cells for C++ zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von HTM mit ODS in C++" InputFormat="htm" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie HTM über C++ mit ODS zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM programmgesteuert mit ODS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
