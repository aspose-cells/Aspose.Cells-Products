...
url: /id/cpp/merger/merge-xls-to-powerpoint/ 
...
Contoh berikut menunjukkan cara menggabungkan XLS ke POWERPOINT di Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLS ke POWERPOINT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="C++ perpustakaan untuk menggabungkan XLS ke POWERPOINT" %}}
