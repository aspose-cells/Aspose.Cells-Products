...
description: Aspose Excel. Converteer XLS snel en eenvoudig naar XPS met Aspose.Cells. Python XLS naar XPS. Python Bewaar XLS in XPS. Bewaar XLS als 07611134 81 via Python.
...
{{% blocks/products/pf/agp/content h2="Converteer XLS naar XPS in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLS t/m XPS in Python" %}}

Het volgende voorbeeld laat zien hoe u XLS converteert naar XPS in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLS naar XPS te converteren" %}}
