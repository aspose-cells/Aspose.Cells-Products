...
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG au format DIF, permettant un enregistrement transparent des données JPG au format DIF à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG sous DIF dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en DIF en C#.
...
1.  Convertissez le JPG au format DIF en appelant la méthode Workbook.Save.
