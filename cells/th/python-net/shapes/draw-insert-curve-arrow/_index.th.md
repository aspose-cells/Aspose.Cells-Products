---
title: วิธีวาดหรือแทรกรูปลูกศรโค้งลงใน Excel ด้วย Python via .Net
weight: 10
description: Python via ซอร์สโค้ด .Net เพื่อแทรกรูปร่างลูกศรโค้งลงใน Excel
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แทรกรูปร่างลูกศรโค้งลงใน Excel โดยใช้ Python via .Net" h2="แทรกรูปร่างลูกศรโค้งโดยใช้ Aspose.Cells\' API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF เป็นต้น" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกรูปร่างลูกศรโค้งลงในไฟล์ Excel โดยใช้ Python via .Net" %}}

 ในการแทรกรูปลูกศรโค้งลงในไฟล์ excel เราจะใช้
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) เพื่อแทรกรูปร่างลูกศรโค้งในเวิร์กชีตที่เลือก
...
-  ระบบปฏิบัติการใดๆ ที่สามารถเรียกใช้สคริปต์ Python via .Net เช่น Windows และ Linux
...
{{% blocks/products/pf/agp/code-block title="ใส่รูปลูกศรโค้ง - Python via .Net" offSpacer="" %}}
