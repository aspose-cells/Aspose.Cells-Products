...
{{% blocks/products/pf/agp/content h2="Convert ODS to SXC in Python" %}}
...
The following example demonstrates how to convert ODS to SXC in Python via NET.
