---
title:  Συγχώνευση XLSM στο WORD μέσω C#
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLSM στο WORD στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLSM στο WORD σε απευθείας σύνδεση" InputFormat="xlsm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
