...
هل تحتاج إلى تحويل ملفات MHT إلى FODS برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى FODS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى FODS عن طريق استدعاء دالة Save().
