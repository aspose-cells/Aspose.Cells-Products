---
title: C# JPG en XLT - Convertisseur JPG en XLT
description: Aspose Exceller. Convertissez JPG en XLT rapidement et facilement avec Aspose.Cells. C# JPG en XLT. C# Enregistrez JPG en XLT. Enregistrez JPG sous XLT en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer JPG au XLT dans C#" %}}

L'exemple suivant montre comment convertir JPG en XLT en C#.
...
{{% cells-convert title="Exemple de code pour convertir JPG en XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en XLT par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en XLT en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en XLT" %}}
