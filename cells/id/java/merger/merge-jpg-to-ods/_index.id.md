...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan JPG ke format simpan ODS. Java Gabungkan format JPG ke ODS. Gabungkan JPG ke ODS di Java. Gabungkan JPG.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPG ke ODS di Java" %}}

Contoh berikut menunjukkan cara menggabungkan JPG ke ODS di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan JPG ke ODS. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ODS. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan JPG menjadi ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan JPG ke ODS di Java" InputFormat="jpg" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JPG ke ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan JPG ke ODS secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk menggabungkan JPG menjadi ODS" %}}
