---
title: Połącz CSV z NUMERAMI - Połącz CSV z NUMERAMI w Java
url: /pl/java/merger/merge-csv-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online CSV do formatu zapisu NUMBERS. Java Połącz CSV w formacie NUMERY. Połącz CSV z NUMBERS w Java. CSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz CSV z NUMBERS w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić CSV z NUMBERS w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić numer CSV z NUMBERS. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku NUMBERS. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy CSV z NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z NUMBERS w Java" InputFormat="csv" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z NUMERAMI via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić numer CSV z NUMBERS? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do połączenia CSV z NUMBERS" %}}
