---
title:  แทรก Cube ลงใน Excel ผ่าน Python
weight: 10
description: ซอร์สโค้ด Python เพื่อแทรก Cube ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก Cube ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกไฟล์ Cube เข้า Excel ผ่าน Python" %}}
...
+ ใช้วิธีการเพิ่มของ shapecollection เพื่อแทรก Cube ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่ลูกบาศก์ - Python" offSpacer="" %}}
