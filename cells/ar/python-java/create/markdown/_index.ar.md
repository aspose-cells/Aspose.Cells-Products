...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف MARKDOWN في مكتبة Excel Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python مكتبة إكسل لإنشاء ملف MARKDOWN" %}}
