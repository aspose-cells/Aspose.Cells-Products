---
title: Converti NUMBERS in SVG tramite Java 
url: /it/java/conversion/numbers-to-svg/ 
description: Esempio di codice di conversione Java per il formato NUMBERS in file SVG. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in SVG all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti NUMBERS in SVG tramite Java" h2="Conversione da NUMBERS a SVG Java per convertire pagine singole o multiple in SVG utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire NUMBERS in SVG utilizzando Java" %}}

 Per eseguire il rendering di NUMBERS in SVG, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire NUMBERS in SVG tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente i file NUMBERS in SVG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file NUMBERS con un'istanza di Workbook1. Seleziona l'impostazione predefinita o qualsiasi foglio di lavoro dalla raccolta1. Crea e imposta l'oggetto di ImageOrPrintOptions1. Crea SheetRender con Foglio di lavoro e oggetti ImageOrPrintOptions1. Chiama il metodo SheetRender.toImage per salvare il risultato in formato SVG
...
{{% blocks/products/pf/agp/code-block title="NUMBERS in SVG Java codice sorgente di conversione" offSpacer="" %}}

```cs
// carica il file NUMBERS da renderizzare
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS alle demo dal vivo di conversione SVG" sectionDescription="[Converti NUMERI in SVG](https://products.aspose.app/cells/conversion/numbers-to-svg) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file NUMBERS, verrà convertito istantaneamente in SVG." >}}
