...
url: /nl/python-java/merger/merge-xlsm-to-ett/ 
...
Het volgende voorbeeld laat zien hoe u XLSM kunt samenvoegen met ETT in Aspose.Cells for Python via Java.
...
Wilt u XLSM programmatisch samenvoegen met ETT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
