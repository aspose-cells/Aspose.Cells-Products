...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в JSON в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат JSON в формате C#.
...
1.  Преобразовать XML в формат JSON, вызвав метод Workbook.Save.
