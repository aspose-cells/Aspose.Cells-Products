---
title: Converteer TABDELIMITED naar JPEG via C#
url: /nl/net/conversion/tabdelimited-to-jpeg/
description: Voorbeeldcode voor door tabs gescheiden naar jpeg C#-conversie. Gebruik API voorbeeldcode voor batch-tabdelimited-bestanden naar jpeg-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
...
{{% blocks/products/pf/agp/content h2="Hoe TABDELIMITED naar JPEG te converteren met C#" %}}

 Om TABDELIMITED naar JPEG te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TABDELIMITED naar JPEG te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen TABDELIMITED-bestanden gemakkelijk laden en converteren naar JPEG in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad TABDELIMITED-bestand met een exemplaar van Workbook1. Roep de methode Workbook.Save aan1. Geef het uitvoerpad door met de JPG-extensie als parameter1. Controleer het opgegeven pad voor het resulterende JPEG-bestand
...
{{% cells-convert title="Gratis app en voorbeeldcode om TABDELIMITED naar JPEG te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="jpg" IsLandingPage="true" %}}
