---
title: PNG から XLSX を結合 - PNG から XLSX を Java に結合
url: /ja/java/merger/merge-png-to-xlsx/ 
description: Aspose エクセル。 Java Aspose.Cells。PNG を XLSX の保存形式にマージします。 Java PNG と XLSX の形式を結合します。 PNG から XLSX を Java に結合します。PNG を結合します。
...
{{< blocks/products/pf/i18n/upper-banner h1="PNG を XLSX via Java に結合" h2="PNG を XLSX にマージするための高速 Java ライブラリ。Excel 変換 API を使用して、Java で高レベルのプラットフォームに依存しないソフトウェアを開発します。これは、Excel, CSV, OpenOffice, PDF, HTML, image および他の多くの Excel 形式をインポートおよびエクスポートするためのプロフェッショナル ソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="PNG" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
次の例は、PNG を Aspose.Cells for Java の XLSX にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、PNG を XLSX にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルをマージし、それを XLSX ファイルに保存します。 Java のコードを開発する場合、これは思っているより簡単です。 PNG を XLSX にマージする Java の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="PNG から XLSX を Java にマージするサンプルコード" InputFormat="png" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="PNG を XLSX via Java に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

PNG をプログラムで XLSX にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Java](https://products.aspose.com/cells/java)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="Java PNG を XLSX にマージするライブラリ" %}}
