...
url: /hu/net/merger/merge-htm-to-xlsm/ 
...
A következő példa bemutatja, hogyan egyesítheti a HTM-et a XLSM-es számmal a Aspose.Cells for .NET-ben.
...
{{% cells-merger title="Mintakód a HTM-nek a XLSM-es számmal való egyesítéséhez a C#-ben" InputFormat="htm" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTM egyesítése a XLSM-es számmal a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a HTM-et a XLSM-es számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és a XLSM egyesítéséhez" %}}
