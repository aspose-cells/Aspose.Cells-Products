---
title:  Vyhledejte dokument ODS bez otevření přes C++
weight: 3300
description: C++ ukázkový kód pro vyhledávání slov se vzorem v souboru ODS na C++ Runtime Environment pro Windows 32 bit, Windows 64 bit a Linux 64 bit.
