...
{{% blocks/products/pf/agp/content h2="كيفية إدراج سطر في ملف إكسل باستخدام C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج السطر إلى ملف Excel عبر الرقم C++" %}}

+ إنشاء كائن مصنف. (أو->تحميل الملف XLSX بالمسار الكامل.)
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addline/) لإدراج أشكال المعادلات في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل السطر - C++" offSpacer="" %}}
