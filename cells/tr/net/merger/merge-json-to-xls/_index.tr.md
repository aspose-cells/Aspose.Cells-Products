---
title: JSON'i XLS'e birleştir - JSON'i C#'de XLS'e birleştir
url: /tr/net/merger/merge-json-to-xls/ 
description: Aspose Excel'de. C# Aspose.Cells. JSON'i XLS kaydetme biçimiyle birleştirin. C# JSON'i XLS biçimiyle birleştirin. C#'de JSON'i XLS ile birleştirin. JSON Birleştir.
...
{{% blocks/products/pf/agp/content h2="JSON\'i C#\'de XLS ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de JSON ile XLS'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

JSON ile XLS'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLS dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. JSON ile XLS'i birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="JSON ile XLS\'i C#\'de Birleştirmek için Örnek Kod" InputFormat="json" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="JSON\'i C# aracılığıyla XLS\'e Nasıl Birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

 JSON ile XLS'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kitaplığı, JSON ile XLS arasında birleştirilecek" %}}
