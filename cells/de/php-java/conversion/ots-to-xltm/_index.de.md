...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in XLTM mit Aspose.Cells. PHP OTS in XLTM. PHP Speichern Sie OTS in XLTM. Speichern Sie OTS mit PHP als XLTM.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in XLTM" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in XLTM konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in XLTM konvertieren.
...
1.  Konvertieren Sie OTS in XLTM, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in XLTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in XLTM" %}}
