...
Het volgende voorbeeld laat zien hoe u TABDELIMITED kunt samenvoegen met XLT in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u TABDELIMITED programmatisch samenvoegen met XLT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
