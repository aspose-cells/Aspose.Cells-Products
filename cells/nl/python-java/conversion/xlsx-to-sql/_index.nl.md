...
description: Aspose Excel. Converteer XLSX snel en eenvoudig naar SQL met Aspose.Cells. Python XLSX naar SQL. Python Sla XLSX op in SQL. Sla XLSX op als SQL met behulp van Python.
...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in SQL in Python" %}}

In het volgende voorbeeld ziet u hoe u XLSX naar SQL converteert in Python.
