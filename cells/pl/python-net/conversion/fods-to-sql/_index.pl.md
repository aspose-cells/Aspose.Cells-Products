...
{{% blocks/products/pf/agp/content h2="Konwertuj FODS na SQL w Python" %}}
...
Poniższy przykład ilustruje sposób konwersji FODS na SQL w Python via NET.
