...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-ontwikkelaars kunnen TABDELIMITED gemakkelijk converteren naar JPEG in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het TABDELIMITED-bestand met Factory::CreateIWorkbook.
1. Converteer TABDELIMITED naar JPEG door de methode Save() aan te roepen.
