...
description: Aspose Excel. Python Criar PNG Arquivo. Criar PNG Python. Python PNG Criador. Crie PNG em Python. Gere o arquivo PNG usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo PNG em Python" h2="Biblioteca Python de alta velocidade para criar o arquivo PNG. Esta é uma solução de software profissional para importar e exportar XLSX, PDF e muitos outros formatos usando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. Use o método Save para salvar a pasta de trabalho como arquivo PNG.

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo PNG em Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python biblioteca para criar o arquivo PNG" %}}
