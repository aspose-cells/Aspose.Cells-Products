---
title: Python MHTML إلى TSV - عبر الإنترنت من MHTML إلى TSV
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل MHTML إلى TSV saveformat. Python MHTML إلى تنسيق TSV. وفر MHTML إلى TSV Python.
...
{{% blocks/products/pf/agp/content h2="حوّل MHTML إلى TSV في Python" %}}

 كيف أقوم بتحويل MHTML إلى TSV؟ مع Aspose.Cells for Python عبر مكتبة NET ، يمكنك بسهولة تحويل MHTML إلى TSV برمجيًا باستخدام بضعة أسطر من التعليمات البرمجية.[Aspose.Cells for Python عبر NET](https://pypi.org/project/aspose-cells-python/)قادر على بناء تطبيقات عبر الأنظمة الأساسية مع القدرة على إنشاء وتعديل وتحويل وعرض وطباعة جميع ملفات Excel. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات ، بل يمكنه أيضًا عرض ملفات Excel كصور ، PDF ، HTML ، ODS ، CSV ، SVG ، JSON ، WORD ، PPT والمزيد ، مما يجعله خيارًا مثاليًا لتبادل المستندات في معايير الصناعة الأشكال.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="وفر MHTML إلى TSV في Python عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل MHTML إلى TSV في Python via NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل MHTML إلى TSV. قم بتحميل ملف MHTML الخاص بك ، ثم احفظه كملف TSV. لكل من قراءة MHTML وكتابة TSV ، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون المحتوى والتنسيق الناتج TSV متطابقين مع المستند MHTML الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل MHTML إلى TSV عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="tsv" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHTML إلى TSV" %}}

{{% blocks/products/pf/agp/text %}}

تحتاج إلى تحويل MHTML ملفات إلى TSV برمجيا؟ يمكن للمطورين Python تحميل وتحويل MHTML إلى TSV بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول MHTML إلى TSV باستدعاء طريقة Workbook.save.
