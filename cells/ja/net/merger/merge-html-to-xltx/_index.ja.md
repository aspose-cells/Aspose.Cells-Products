---
title: HTML から XLTX を結合 - HTML から XLTX を C# に結合
url: /ja/net/merger/merge-html-to-xltx/ 
description: Aspose エクセル。 C# Aspose.Cells。HTML を XLTX の保存形式にマージします。 C# HTML と XLTX の形式を結合します。 HTML から XLTX を C# に結合します。HTML を結合します。
...
次の例は、HTML を Aspose.Cells for .NET の XLTX にマージする方法を示しています。
