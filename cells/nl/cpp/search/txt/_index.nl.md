---
title:  Zoek naar document TXT zonder het te openen via C++
weight: 5090
description: C++ voorbeeldcode om woorden met een patroon te zoeken in het bestand TXT in de runtimeomgeving C++ voor 32-bits, 64-bits en 64-bits Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zoek naar formaten met TXT in C++" h2="Native en krachtige documentzoekfunctie (TXT) met behulp van server-side API\'s (Aspose.Cells for C++), zonder gebruik te maken van software zoals (Microsoft) of Adobe (PDF)." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe zoek ik naar bestand TXT met behulp van C++?" %}}

 Om het bestand TXT te zoeken, gebruiken we...
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om bestanden met nummer TXT te zoeken in de map C++" %}}
...
+ Laad bestand TXT met behulp van de Workbook-klasse.
...
{{% blocks/products/pf/agp/code-block title="Zoek naar bestanden met nummer TXT - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online TXT Zoek live demo\'s" sectionDescription=" Zoek nu naar tekst, woorden en zinsdelen in documenten met referentienummer TXT door onze website te bezoeken.[Live demo-website](https://products.aspose.app/cells/search). De live demo heeft de volgende voordelen" >}}
...
Een bestand met de extensie .TXT is een tekstbestand dat platte tekst in de vorm van regels bevat. Alinea's in een tekstbestand worden aangegeven met regeleinden en worden gebruikt voor een betere ordening van de bestandsinhoud. Een standaard tekstbestand kan worden geopend in elke teksteditor of tekstverwerkingsprogramma op verschillende besturingssystemen. Alle tekst in een dergelijk bestand is leesbaar voor mensen en wordt weergegeven als een reeks tekens.
