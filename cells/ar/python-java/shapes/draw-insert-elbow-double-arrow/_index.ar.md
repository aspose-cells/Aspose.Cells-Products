---
title: كيفية رسم أو إدراج شكل سهم مزدوج للكوع في برنامج Excel باستخدام Python via Java
weight: 10
description: ارسم أو أدخل شكل سهم مزدوج للمرفق باستخدام Aspose.Cells' Python via Java API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF وما إلى ذلك.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شكل الكوع على شكل سهم مزدوج في ملف Excel باستخدام Python via Java" %}}

 من أجل إدراج شكل الكوع على شكل سهم مزدوج في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج شكل السهم المزدوج في ملف Excel باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج شكل سهم مزدوج على شكل مرفق في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج الكوع على شكل سهم مزدوج - Python via Java" offSpacer="" %}}
