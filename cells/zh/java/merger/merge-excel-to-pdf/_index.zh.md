...
{{% blocks/products/pf/agp/content h2="Java在线免费合并EXCEL到PDF" %}}

下面的例子演示如何将EXCEL合并到Java中的PDF。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将EXCEL合并到PDF。上传你的文件，调用Workbook.Combine方法合并文件，然后保存到PDF文件。如果您在 Java 中开发代码，这将比听起来更简单。参见将 EXCEL 合并到 PDF 的 Java 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费应用程序在线将 EXCEL 合并到 PDF" InputFormat="xlsx" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
