---
title: JPG को OTS में मिलाएं - C# में JPG को OTS में मिलाएं
url: /hi/net/merger/merge-jpg-to-ots/ 
description: "Aspose एक्सेल। C# Aspose.Cells. नि:शुल्क ऑनलाइन जेपीजी को ओटीएस सेवफॉर्मेट में मर्ज करें। C# जेपीजी को ओटीएस प्रारूप में संयोजित करें। C# में JPG को OTS में मर्ज करें। JPG मर्ज।"
...
{{% blocks/products/pf/agp/content h2="C# में JPG को OTS में निःशुल्क ऑनलाइन मर्ज करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि Aspose.Cells for .NET में जेपीजी को ओटीएस में कैसे मर्ज किया जाए।
{{% blocks/products/pf/agp/text %}}

JPG को OTS में मर्ज करने के लिए आसान चरणों का पालन करें। अपनी फ़ाइलें अपलोड करें, फ़ाइलों को मर्ज करने के लिए Workbook.Combine विधि को कॉल करें और फिर इसे OTS फ़ाइल में सहेजें। यदि आप C# में कोड विकसित करते हैं, तो यह जितना लगता है उससे कहीं अधिक सरल होगा। C# उदाहरण देखें जो जेपीजी को ओटीएस में विलय करता है।

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C# में जेपीजी को ओटीएस में मर्ज करने के लिए निःशुल्क ऑनलाइन" InputFormat="jpg" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C# के माध्यम से जेपीजी को ओटीएस में कैसे मर्ज करें" %}}

{{% blocks/products/pf/agp/text %}}

प्रोग्रामेटिक रूप से JPG को OTS में मर्ज करने की आवश्यकता है? एक बुनियादी दस्तावेज़ जिसका विलय और संयोजन हो रहा है[Aspose.Cells for .NET](https://products.aspose.com/cells/net) एपीआई को कोड की कुछ पंक्तियों के साथ किया जा सकता है।
...
{{% blocks/products/pf/agp/content h2=".NET लाइब्रेरी JPG को OTS में मर्ज करने के लिए" %}}
