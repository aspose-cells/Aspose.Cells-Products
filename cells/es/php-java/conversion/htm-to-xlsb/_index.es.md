---
title: PHP HTM a XLSB - Convertidor HTM a XLSB
description: Aspose Excel. Convierta HTM a XLSB rápida y fácilmente con Aspose.Cells. PHP HTM a XLSB. PHP Guarde HTM en XLSB. Guarde HTM como XLSB usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a XLSB mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a XLSB mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a XLSB en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a XLSB llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de HTM a XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir HTM a XLSB" %}}
