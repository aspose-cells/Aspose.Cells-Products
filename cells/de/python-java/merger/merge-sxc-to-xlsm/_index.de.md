---
title:  SXC über Python mit XLSM zusammenführen
url: /de/python-java/merger/merge-sxc-to-xlsm/ 
description: Führen Sie SXC mit XLSM kostenlos online zusammen. Kostenlos online SXC bis XLSM Fusion. SXC mit Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS und mehr zusammenführen.
---
...
Das folgende Beispiel zeigt, wie SXC mit XLSM in Python zusammengeführt wird.
...
{{% cells-merger title="Kostenlose App zum Online-Zusammenführen von SXC mit XLSM" InputFormat="sxc" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
