---
title: Převést SXC na SVG přes Python
url: /cs/python-java/conversion/sxc-to-svg/
description: Ukázkový kód pro převod sxc na svg Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na svg v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na SVG pomocí Python" %}}

 K převodu SXC na SVG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na SVG prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na SVG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí Workbook1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s rozšířením SVG jako parametrem1. Zkontrolujte zadanou cestu pro výsledný soubor SVG
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="svg" IsLandingPage="true" language="python" %}}
