---
title: Chuyển đổi XLTX sang ODS qua Python

description: Mã mẫu cho chuyển đổi xltx sang ods Python. Sử dụng mã mẫu API cho các tệp xltx hàng loạt để chuyển đổi ods trong ứng dụng Python.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLTX sang ODS bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLTX sang ODS qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp XLTX sang ODS chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLTX với một phiên bản của Workbook1. Gọi phương thức Workbook.Save1. Chuyển đường dẫn đầu ra với phần mở rộng ODS làm tham số1. Kiểm tra đường dẫn được chỉ định cho tệp ODS kết quả
