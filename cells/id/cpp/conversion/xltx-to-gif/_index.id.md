---
title: Konversi XLTX ke GIF melalui C++ aplikasi 
url: /id/cpp/conversion/xltx-to-gif/ 
description: Contoh C++ kode konversi untuk dokumen XLTX ke format GIF. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLTX ke GIF dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi XLTX ke GIF melalui C++" h2="Konversi XLTX ke GIF berperforma tinggi menggunakan pustaka C++ tanpa memerlukan penginstalan Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLTX ke GIF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLTX menggunakan Factory::CreateIWorkbook.1. Pilih lembar kerja pertama.1. Setel (GIF) opsi.1. Iterasi melalui setiap halaman lembar dan render.1. Buka file GIF di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLTX ke GIF C++ Kode Sumber Konversi" offSpacer="" %}}
