---
title: Fusionner SXC en XML - Combiner SXC en XML dans C#
url: /fr/net/merger/merge-sxc-to-xml/ 
description: Aspose Excel. C# Aspose.Cells. Fusion gratuite en ligne SXC au format de sauvegarde XML. C# Combinez SXC au format XML. Fusionner SXC en XML dans C#. SXC Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner SXC en XML dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner SXC en XML dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner SXC en XML. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier XML. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne SXC en XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner SXC en XML dans C#" InputFormat="sxc" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner SXC en XML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner SXC en XML par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner SXC en XML" %}}
