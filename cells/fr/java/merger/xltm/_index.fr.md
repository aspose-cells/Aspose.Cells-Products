---
title:  Fusionner XLTM Fichiers via Java
weight: 8210
description: Exemple de code Java pour combiner les documents XLTM sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats XLTM dans Java" h2="Fusion de documents natifs XLTM à l\'aide d\'API Java côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner les fichiers XLTM dans Java" %}}
...
+ enregistrer le fichier fusionné XLTM au chemin spécifié
...
{{< blocks/products/pf/agp/demobox sectionTitle="En ligne XLTM Démos en direct sur la fusion" sectionDescription=" Fusionnez XLTM documents dès maintenant en visitant notre[Site Web de démos en direct](https://products.aspose.app/cells/merger). La démo en direct présente les avantages suivants" >}}
