...
{{% blocks/products/pf/agp/content h2="Τρόπος ομαδοποίησης και κατάργησης ομαδοποίησης σχημάτων σε αρχείο Excel χρησιμοποιώντας Python via .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για ομαδοποίηση και κατάργηση ομαδοποίησης σχημάτων στο αρχείο Excel μέσω του Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Σχήματα Ομάδας και Αποομαδοποίησης - Python via .NET" offSpacer="" %}}
