...
{{% blocks/products/pf/agp/content h2="How to Convert XLSB to JSON Using Python" %}}
 ...
 In order to convert XLSB to JSON, we will use
...
{{% cells-convert title="Free App and Sample Code to Convert XLSB to JSON" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et InputFormat=xlsb outformat=json IsLandingPage=true language=python %}}
