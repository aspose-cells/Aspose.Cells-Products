...
{{< blocks/products/pf/i18n/upper-banner h1="Cifrar XLSX Archivos via Java" h2="Proteja con contraseña las hojas de cálculo de Excel, incluido el formato XLSX, utilizando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo asegurar el archivo XLSX usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para proteger XLSX Archivos via Java" %}}
...
1.  Cargue el archivo XLSX instanciando la clase Workbook
1.  Utilice el método protect(..) con ProtectionType y Password
1.  Guarde el archivo protegido XLSX mediante el método save()
