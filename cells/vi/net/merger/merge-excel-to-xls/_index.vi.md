...
Ví dụ sau đây minh họa cách hợp nhất EXCEL thành XLS trong Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp EXCEL thành XLS" %}}
