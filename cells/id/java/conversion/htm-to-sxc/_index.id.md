...
description: Aspose Unggul. Ubah HTM menjadi SXC dengan cepat dan mudah menggunakan Aspose.Cells. Java HTM menjadi SXC. Java Simpan HTM menjadi SXC. Simpan HTM sebagai SXC menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah HTM menjadi SXC di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi HTM ke SXC. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor HTM, SXC, dan banyak format lain menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Ubah HTM menjadi SXC Menggunakan Java" %}}
...
Contoh berikut menunjukkan cara mengonversi HTM ke SXC di Java.
...
Perlu mengonversi file HTM ke SXC secara terprogram? Pengembang Java dapat dengan mudah mengonversi HTM menjadi SXC hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah HTM menjadi SXC" %}}
{{% blocks/products/pf/agp/text %}}
