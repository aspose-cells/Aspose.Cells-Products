---
title: Převeďte XLS na XLSB pomocí aplikace C++ 
weight: 9080

description: Ukázkový konverzní kód C++ pro dokument XLS na formát XLSB. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLS na XLSB v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLS na XLSB pomocí C++" %}}

 K převodu XLS na XLSB použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod XLS na XLSB prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLS na XLSB pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLS pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu k výstupnímu souboru s příponou (XLSB).1. Soubor XLSB bude uložen do zadané cesty.1. Otevřete soubor XLSB v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLS na XLSB C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze XLS na XLSB" sectionDescription="[Převést XLS na XLSB](https://products.aspose.app/cells/conversion/xls-to-xlsb) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor XLS, bude okamžitě převeden na XLSB." >}}
