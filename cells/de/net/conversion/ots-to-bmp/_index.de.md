---
title: C# OTS zu BMP - Online OTS zu BMP Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# OTS in BMP Saveformat konvertieren. C# OTS zum BMP-Format. Speichern Sie OTS unter BMP C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter BMP in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie OTS in C# in BMP konvertiert wird.
...
Müssen Sie OTS-Dateien programmgesteuert in BMP konvertieren? .NET-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in BMP konvertieren.
...
1.  Konvertieren Sie OTS in BMP, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von OTS in BMP" %}}
