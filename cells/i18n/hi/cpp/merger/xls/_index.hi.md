---
title: C++ के द्वारा XLS फ़ाइलें मर्ज करें 
url: /hi/cpp/merger/xls/ 
description: C++ एक्सएलएस दस्तावेज़ों को C++ विंडोज 32 बिट, विंडोज 64 बिट और लिनक्स 64 बिट के लिए रनटाइम एनवायरनमेंट पर संयोजित करने के लिए उदाहरण कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS फ़ॉर्मेट को C++ में मर्ज करें" h2="सर्वर-साइड C++ API का उपयोग करके XLS दस्तावेज़ विलय।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLS फ़ाइलों को C++ में मर्ज करने के चरण" %}}
