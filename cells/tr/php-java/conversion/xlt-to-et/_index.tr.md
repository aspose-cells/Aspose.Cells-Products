---
title: PHP XLT'den ET'ye - XLT'den ET'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile XLT'i hızlı ve kolay bir şekilde ET'ye dönüştürün. PHP XLT'i ET'ye dönüştürün. PHP XLT'i ET'ye kaydedin. PHP kullanarak XLT'i ET olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLT\'i ET\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLT dosyalarını program aracılığıyla ET'ye dönüştürmeniz mi gerekiyor? PHP geliştiricileri yalnızca birkaç satır kodla XLT'i kolayca yükleyebilir ve ET'ye dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLT'i ET'ye dönüştürün.
1.  XLT'in ET'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLT\'i ET\'ye dönüştürmek için PHP kütüphanesi" %}}
