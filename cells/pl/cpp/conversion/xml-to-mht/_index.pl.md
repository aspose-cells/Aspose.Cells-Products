...
Trzeba programowo przekonwertować pliki XML na MHT? Programiści C++ mogą łatwo przekonwertować pliki XML na MHT za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XML do MHT wywołując metodę Save().
