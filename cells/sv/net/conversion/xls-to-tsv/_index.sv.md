---
title: C# XLS till TSV - XLS till TSV Omvandlare
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till TSV-format, vilket möjliggör sömlös sparning av XLS-data till TSV-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till TSV i C#" %}}

Följande exempel visar hur man konverterar XLS till TSV i C#.
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till TSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till TSV programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till TSV på bara några rader kod.
...
1.  Konvertera XLS till TSV genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet från XLS till TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-biblioteket för att konvertera XLS till TSV" %}}
