---
title:  Keresés a XLSM dokumentumban megnyitás nélkül a C++ számon keresztül
weight: 9280
description: C++ példakód a XLSM fájl C++ futásidejű környezetének XLSM 32 bites, Windows 64 bites, Windows 64 bites és Linux 64 bites XLSM fájljában.
---
...
Töltse be a XLSM fájlt egy IWorkbook osztály példányosításával.
...
+ Mentse a XLSM fájlt az IWorkbook->Save(.) metódussal.
