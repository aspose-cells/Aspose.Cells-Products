---
title: Konvertieren Sie NUMBERS in XLSB über Java 
url: /de/java/conversion/numbers-to-xlsb/ 
description: Beispiel-Umwandlungscode Java für das NUMBERS-Format in eine XLSB-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in XLSB innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie NUMBERS in XLSB über Java" h2="Konvertierung von NUMBERS in XLSB Java zum Konvertieren einzelner oder mehrerer Seiten in XLSB mithilfe der lokalen Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie NUMBERS mit Java in XLSB" %}}

 Um NUMBERS in XLSB zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von NUMBERS in XLSB über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können die NUMBERS-Datei in nur wenigen Codezeilen ganz einfach in XLSB konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die NUMBERS-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit XLSB-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende XLSB-Datei
...
{{% blocks/products/pf/agp/code-block title="NUMBERS zu XLSB Java Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die NUMBERS-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.numbers");
// Speichern Sie NUMBERS als XLSB
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS-zu-XLSB-Konvertierungs-Live-Demos" sectionDescription="[Konvertieren Sie NUMBERS in XLSB](https://products.aspose.app/cells/conversion/numbers-to-xlsb) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre NUMBERS-Datei hoch, sie wird sofort in XLSB konvertiert." >}}
