---
title: C# EXCEL en EXCEL - Convertisseur EXCEL en EXCEL
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format EXCEL, permettant un enregistrement transparent des données EXCEL au format EXCEL à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL dans EXCEL dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en EXCEL en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en EXCEL par programme ? .NET peuvent facilement charger et convertir EXCEL en EXCEL en quelques lignes de code seulement.
...
1.  Convertissez un fichier EXCEL en un autre fichier EXCEL en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de EXCEL en EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir EXCEL en EXCEL" %}}
