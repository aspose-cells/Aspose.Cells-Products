---
title: Converter CSV para EXCEL C#
description: Converta CSV para EXCEL Online gratuitamente. Conversor Online Gratuito CSV para EXCEL. C# CSV para EXCEL. CSV para EXCEL via C#.
keywords: Convert CSV, CSV Converter, CSV to PDF, CSV to Word, CSV to PPT, CSV to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter CSV para EXCEL via C#" h2="Biblioteca C# de alta velocidade para converter CSV em EXCEL. Exporte planilhas do Excel para o formato EXCEL em .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET desenvolvedores podem facilmente carregar e converter CSV para EXCEL em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Carregue o arquivo CSV com uma instância da pasta de trabalho
1.  Converter CSV para EXCEL chamando o método Workbook.Save
