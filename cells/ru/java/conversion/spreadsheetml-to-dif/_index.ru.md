...
{{% blocks/products/pf/agp/content h2="Преобразовать SPREADSHEETML в DIF, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните файл SPREADSHEETML в формате DIF в переменной Java." %}}

Следующий пример демонстрирует, как преобразовать SPREADSHEETML в формат DIF в формате Java.
...
Нужно программно преобразовать файлы SPREADSHEETML в формат DIF? Разработчики, использующие формат Java, могут легко преобразовать SPREADSHEETML в формат DIF всего несколькими строками кода.
