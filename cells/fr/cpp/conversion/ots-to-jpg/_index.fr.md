...
description: Aspose Exceller. Convertissez OTS en JPG rapidement et facilement avec Aspose.Cells. C++ OTS en JPG. C++ Enregistrez OTS au format JPG. Enregistrez OTS au format JPG en utilisant C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OTS en JPG en C++" h2="Conversion OTS en JPG haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation Microsoft d\'Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir OTS en JPG en utilisant C++" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer OTS au format JPG en C++" %}}

L'exemple suivant montre comment convertir OTS en JPG en C++.
...
{{% cells-convert title="Exemple de code pour convertir OTS en JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir OTS en JPG via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers OTS en JPG par programme ? Les développeurs C++ peuvent facilement convertir OTS en JPG en quelques lignes de code seulement.
...
1.  Convertissez OTS en JPG en appelant la méthode Save().
