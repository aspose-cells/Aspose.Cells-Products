---
title: Konvertera XLS till XLTX via C++-programmet 
weight: 5210
url: /sv/cpp/conversion/xls-to-xltx/ 
description: Exempel på C++-konverteringskod för XLS-dokument till XLTX-format. Programmerare kan använda den här källkoden för batchkonvertering av XLS till XLTX inom alla C++-program.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLS till XLTX via C++" h2="Högpresterande XLS till XLTX-konvertering med hjälp av C++-biblioteket utan behov av Microsoft Excel, OpenOffice eller Adobe Acrobat-installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera XLS-fil till XLTX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLS-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (XLTX) filtillägg.1. XLTX-filen kommer att sparas på den angivna sökvägen.1. Öppna filen XLTX i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="XLS till XLTX C++ konverteringskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS till XLTX Konvertering Live Demos" sectionDescription="[Konvertera XLS till XLTX](https://products.aspose.app/cells/conversion/xls-to-xltx) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din XLS-fil, den konverteras omedelbart till XLTX." >}}
