---
title: PPTX oluştur - C#'de PPTX dosyası oluştur
description: Aspose excel. C# PPTX Dosyası Oluştur. Oluştur PPTX C#. C# PPTX Oluşturan. C#'de PPTX oluşturun. C#'i kullanarak PPTX dosyasını oluşturun.
...
{{% blocks/products/pf/agp/content h2="C#\'de PPTX Nasıl Oluşturulur" %}}
...
1. Çalışma kitabını PPTX dosyası olarak kaydetmek için Kaydet yöntemini kullanın.

{{% blocks/products/pf/agp/code-block title="Örnek kod, C#\'de PPTX dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PPTX dosyası oluşturmak için C# kitaplığı" %}}
