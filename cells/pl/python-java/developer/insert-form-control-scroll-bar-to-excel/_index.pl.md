---
title:  Wstaw ScrollBar (kontrolka formularza) do Excela, używając Python via java
weight: 90
description: Python via Kod źródłowy Java umożliwiający wstawienie paska przewijania (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić pasek przewijania (kontrolka formularza) do pliku Excel przy użyciu Python via java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addScrollBar(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić ScrollBar (kontrolkę formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw pasek przewijania (kontrolka formularza) — Python via java" offSpacer="" %}}
