---
title: Merge EXCEL to MHTML - Combine EXCEL to MHTML via C#
url: /net/merger/merge-excel-to-mhtml/ 
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. EXCEL Merge. Free Online Merge EXCEL to MHTML C#. C# Merge EXCEL to MHTML format. Combine EXCEL to MHTML in C#.
keywords: [Aspose Excel., C# Aspose.Cells., C# Aspose Cells., EXCEL Merge., C# Merge EXCEL to MHTML., Free Online Merge EXCEL to mhtml in C#., C# Combine EXCEL to MHTML format Online for Free]
---
...
The following example demonstrates how to merge EXCEL to MHTML in Aspose.Cells for .NET.
...
{{% cells-merger title="Free Online to Merge EXCEL to MHTML in C#" InputFormat="xlsx" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="How to Merge EXCEL to MHTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to merge EXCEL to MHTML programmatically? A basic document merging and concatenating with [Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs can be done with just few lines of code.
