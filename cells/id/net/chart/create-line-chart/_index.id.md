---
title:  Buat Bagan Garis melalui C#
description: C# Contoh kode untuk membuat diagram garis ke Excel menggunakan Perpustakaan .NET. Gunakan kode ini untuk membuat bagan garis ke MS Excel dalam VB.NET, Asp.NET atau aplikasi berbasis .NET.
---
...
1. Sertakan Aspose.Cells namespace
...
1.  Tentukan sumber data bagan dengan[**Chart.SetChartDataRange**](https://https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/setchartdatarange) metode.
