...
{{% blocks/products/pf/agp/content h2="How to Create SQL in PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create SQL file in PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PHP library to create SQL file" %}}
