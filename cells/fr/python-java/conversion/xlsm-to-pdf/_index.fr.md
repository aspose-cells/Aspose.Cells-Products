...
description: Aspose Exceller. Convertissez XLSM en PDF rapidement et facilement avec Aspose.Cells. Python XLSM en PDF. Python Enregistrez XLSM en PDF. Enregistrez XLSM sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLSM au PDF au Python" %}}

L'exemple suivant montre comment convertir XLSM en PDF dans Python.
