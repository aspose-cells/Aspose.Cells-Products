...
description: Aspose Excel. A XLTX számot gyorsan és egyszerűen ETT-re alakíthatja át a Aspose.Cells-es számmal. C# XLTX ETT-vé. C# Mentse a XLTX számot az ETT-nek. Mentse el a XLTX számot ETT-ként a C# használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLTX számot az ETT számára a C# számon" %}}
...
{{% cells-convert title="Mintakód a XLTX ETT-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="ett" IsLandingPage="true" %}}
