---
title:  Combinar XLS a CSV via Java
...
El siguiente ejemplo muestra cómo combinar XLS con CSV en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a CSV en línea" InputFormat="xls" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
