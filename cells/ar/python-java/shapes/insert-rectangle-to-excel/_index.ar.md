...
{{% blocks/products/pf/agp/content h2="كيفية إدراج مستطيل في ملف إكسل باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRectangle(int,%20int,%20int,%20int,%20int,%20int)) لإدراج مستطيل في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل المستطيل - Python via Java" offSpacer="" %}}
