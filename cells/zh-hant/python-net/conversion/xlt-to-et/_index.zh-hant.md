...
description: Aspose Excel。 Python Excel。使用 Aspose.Cells 快速輕鬆地將 XLT 轉換為 ET。 Python 將 XLT 儲存到 ET。使用 Python Excel 庫將 XLT 儲存為 ET。
...
{{% blocks/products/pf/agp/content h2="在 Python Excel 庫中將 XLT 轉換為 ET" %}}
...
{{% blocks/products/pf/agp/content h2="將 XLT 儲存到 Python Excel 庫中的 ET" %}}

下面的範例示範如何將Python excel庫中的XLT轉換為ET。
...
{{% cells-convert title="透過 Python Excel 庫將 XLT 轉換為 ET 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="et" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 XLT 轉換為 ET" %}}
