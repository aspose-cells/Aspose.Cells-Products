---
title: C# CSV a XLS - CSV a XLS Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter CSV para o formato XLS, permitindo o salvamento perfeito de dados CSV no formato XLS usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve CSV a XLS em C#" %}}

exemplo a seguir demonstra como converter CSV em XLS em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter CSV em XLS por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos CSV em XLS programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter CSV em XLS em apenas algumas linhas de código.
...
1.  Converta CSV para XLS chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de CSV para XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter CSV em XLS" %}}
