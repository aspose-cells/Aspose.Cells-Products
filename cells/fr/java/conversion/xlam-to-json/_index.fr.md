---
title: XLAM à JSON - Convertir XLAM à JSON fichiers Java
description: Aspose Excel. Conversion gratuite en ligne du format de sauvegarde XLAM en JSON. Format Java XLAM à JSON. Enregistrez XLAM sous JSON dans Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLAM à JSON dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLAM en JSON en Java.
...
Besoin de convertir les fichiers XLAM en JSON par programmation ? Les développeurs de Java peuvent facilement convertir XLAM en JSON en seulement quelques lignes de code.
