...
url: /th/net/merger/merge-json-to-numbers/ 
...
{{% cells-merger title="App ฟรีที่จะรวม JSON เป็น NUMBERS ในบรรทัด" InputFormat="json" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2="ไลบรารี .NET เพื่อรวม JSON เป็น NUMBERS" %}}
