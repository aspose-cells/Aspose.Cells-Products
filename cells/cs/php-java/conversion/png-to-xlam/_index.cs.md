---
title: Konvertor PHP PNG až XLAM - PNG až XLAM
description: Aspose Excel. Převeďte PNG na XLAM rychle a snadno pomocí Aspose.Cells. PHP PNG na XLAM. PHP Uložte PNG na XLAM. Uložte XLAM jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na XLAM přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na XLAM programově? Vývojáři PHP mohou snadno načíst a převést PNG na XLAM v několika řádcích kódu.
...
1.  Převeďte PNG na XLAM voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na XLAM" %}}
