---
title:  Fusionner SXC à JSON via C++
url: /fr/cpp/merger/merge-sxc-to-json/ 
description: Fusionnez SXC à JSON en ligne gratuitement. Gratuit en ligne SXC à JSON Fusion. Fusionnez SXC vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner SXC à JSON dans C++.
...
{{% cells-merger title="Application gratuite pour fusionner SXC à JSON en ligne" InputFormat="sxc" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
