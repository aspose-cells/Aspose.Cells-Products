...
description: Aspose Excel. Převeďte TABDELIMITED na ETT rychle a snadno pomocí Aspose.Cells. PHP TABDELIMITED na ETT. PHP Uložit TABDELIMITED do ETT. Uložte TABDELIMITED jako ETT pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na ETT přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory TABDELIMITED na ETT programově? Vývojáři PHP mohou snadno načíst a převést TABDELIMITED na ETT v několika řádcích kódu.
...
1.  Převeďte TABDELIMITED na ETT voláním metody uložení sešitu.
