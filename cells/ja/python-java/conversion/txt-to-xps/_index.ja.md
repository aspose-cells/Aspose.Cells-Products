---
title: Python TXT ～ XPS - TXT ～ XPS コンバータ
description: Aspose エクセル。 TXT を Aspose.Cells ですばやく簡単に XPS に変換します。 Python TXT から XPS に変換します。 Python TXT を XPS に保存します。 TXT を 07611134 として保存しますPythonを使用して81。
...
{{% blocks/products/pf/agp/content h2="Python を使用して TXT を XPS に変換します" %}}
...
次の例は、TXT を Python の XPS に変換する方法を示しています。
...
{{% cells-convert title="TXT を XPS に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="xps" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でTXTをXPSに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

TXT ファイルをプログラムで XPS に変換する必要がありますか? Python 開発者は、わずか数行のコードで TXT を簡単にロードして XPS に変換できます。
