---
title: Scal XLSB do SPREADSHEETML - Połącz XLSB do SPREADSHEETML w C#
url: /pl/net/merger/merge-xlsb-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online numeru XLSB do formatu zapisu SPREADSHEETML. C# Połącz XLSB do formatu SPREADSHEETML. Scal XLSB do SPREADSHEETML w C#. XLSB Scal.
...
{{% blocks/products/pf/agp/content h2="Scal XLSB w SPREADSHEETML w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLSB z SPREADSHEETML w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLSB z SPREADSHEETML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SPREADSHEETML. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy XLSB z SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLSB z SPREADSHEETML w C#" InputFormat="xlsb" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSB z SPREADSHEETML przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić numer XLSB ze SPREADSHEETML? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLSB z SPREADSHEETML" %}}
