---
title: Scal FODS do SPREADSHEETML - Połącz FODS do SPREADSHEETML w C++
url: /pl/cpp/merger/merge-fods-to-spreadsheetml/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online numeru FODS do formatu zapisu SPREADSHEETML. C++ Połącz FODS do formatu SPREADSHEETML. Scal FODS do SPREADSHEETML w C++. FODS Scal.
...
{{% blocks/products/pf/agp/content h2="Scal FODS w SPREADSHEETML w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć FODS z SPREADSHEETML w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć FODS z SPREADSHEETML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SPREADSHEETML. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy FODS z SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online FODS z SPREADSHEETML w C++" InputFormat="fods" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć FODS z SPREADSHEETML przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić numer FODS ze SPREADSHEETML? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia FODS z SPREADSHEETML" %}}
