---
title: Java ANGKA ke XPS - Konverter ANGKA ke XPS
description: Aspose Unggul. Ubah ANGKA menjadi XPS dengan cepat dan mudah menggunakan Aspose.Cells. Java ANGKA menjadi XPS. Java Simpan ANGKA menjadi XPS. Simpan ANGKA sebagai XPS menggunakan Java.
...
{{% blocks/products/pf/agp/content h2="Simpan NOMOR ke XPS di Java" %}}

Contoh berikut menunjukkan cara mengonversi ANGKA ke XPS di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi ANGKA menjadi XPS. Unggah file ANGKA Anda, lalu simpan sebagai file XPS. Untuk pembacaan ANGKA dan penulisan XPS Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran XPS akan sama dengan dokumen NUMBER asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi ANGKA menjadi XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="xps" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi ANGKA menjadi XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file ANGKA ke XPS secara terprogram? Pengembang Java dapat dengan mudah mengonversi ANGKA menjadi XPS hanya dalam beberapa baris kode.
