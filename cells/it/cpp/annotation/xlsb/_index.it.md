...
{{% blocks/products/pf/agp/content h2="Come annotare il file XLSB utilizzando C++" %}}
...
1.  Caricare il file Excel XLSB utilizzando l'oggetto di classe IWorkbook.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API può essere utilizzato per creare, modificare, convertire e rendere Microsoft i formati Excel in diversi formati. Inoltre, può essere utilizzato per grafici completi, report scalabili e calcoli affidabili all'interno di applicazioni software. Aspose.Cells è un API autonomo e non richiede alcun software come Microsoft o OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aggiungi / rimuovi annotazione da XLSB tramite l\'app online" sectionDescription=" Elimina subito le annotazioni del documento XLSB visitando il nostro[Sito web di dimostrazioni dal vivo](https://products.aspose.app/cells/annotation). La demo dal vivo ha i seguenti vantaggi" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/annotation/ods/" name="ODS" description="File foglio di calcolo OpenDocument" >}}
