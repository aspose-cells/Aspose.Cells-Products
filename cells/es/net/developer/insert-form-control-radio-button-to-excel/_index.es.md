---
title:  Inserte RadioButton (control de formulario) en Excel via .NET
weight: 60
description: C# código fuente para insertar RadioButton (control de formulario) en Excel en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserte RadioButton (control de formulario) en Excel via .NET" h2="Inserte objetos utilizando las API del lado del servidor sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Cómo insertar un botón de radio (control de formulario) en un archivo de Excel usando C#" %}}

 Para insertar RadioButton (control de formulario) en un archivo de Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar RadioButton (control de formulario) en un archivo de Excel a través de C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addradiobutton) para insertar un botón de radio (control de formulario) en la hoja de trabajo seleccionada
...
{{% blocks/products/pf/agp/code-block title="Insertar botón de radio (control de formulario) - C#" offSpacer="" %}}
