---
title: C# XML to SQL – převodník XML na SQL
description: Aspose Excel. Převeďte XML na SQL rychle a snadno pomocí Aspose.Cells. C# XML na SQL. C# Uložit XML do SQL. Uložit XML jako SQL pomocí C#.
...
{{% blocks/products/pf/agp/content h2="Uložit XML do SQL v C#" %}}

Následující příklad ukazuje, jak převést XML na SQL v C#.
...
{{% cells-convert title="Ukázkový kód pro převod XML na SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na SQL přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XML soubory na SQL programově? .NET vývojáři mohou snadno načíst a převést XML na SQL pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C# knihovna pro převod XML na SQL" %}}
