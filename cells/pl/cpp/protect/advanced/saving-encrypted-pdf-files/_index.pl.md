---
title: Zapisywanie zaszyfrowanych plików PDF pod numerem C++"
weight: 10010
description: C++ przykładowy kod do szyfrowania pliku przy użyciu hasła w C++ Środowisko wykonawcze dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Szyfruj pliki PDF za pomocą C++" h2="Konwertuj arkusze kalkulacyjne Excel do plików PDF i chroń je hasłem za pomocą biblioteki Aspose.Cells C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak zaszyfrować plik PDF przy użyciu C++" %}}

 Aby zaszyfrować plik PDF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby zaszyfrować pliki PDF za pośrednictwem C++" %}}
...
1.  Użyj klasy Workbook, aby załadować lub utworzyć nowy plik Excel
1.  Ustaw opcje zabezpieczeń przy użyciu klasy PdfSecurityOptions
1.  Zapisz zaszyfrowany plik PDF metodą Save().
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Bezpłatna aplikacja do ochrony PDF" sectionDescription=" Sprawdź nasze demonstracje na żywo[zaszyfruj pliki PDF](https://products.aspose.app/cells/protect/pdf) z następującymi korzyściami." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij plik PDF i naciśnij przycisk „Odblokuj”." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" Pobierz wynikowy plik PDF z łącza" >}}
