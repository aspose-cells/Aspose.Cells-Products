---
title: PHP OTS إلى ETT - محول OTS إلى ETT
description: Aspose اكسل. قم بتحويل OTS إلى ETT بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى ETT. PHP حفظ OTS إلى ETT. احفظ OTS كـ ETT باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى ETT عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى ETT برمجياً؟ يمكن لمطوري PHP تحميل وتحويل OTS إلى ETT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل OTS إلى ETT عن طريق استدعاء طريقة الحفظ الخاصة بالمصنف.
