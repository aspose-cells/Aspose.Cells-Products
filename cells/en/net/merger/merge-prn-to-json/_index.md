...
description: Aspose Excel. C# Aspose.Cells. Merge PRN to JSON saveformat. C# Combine PRN to JSON format. Merge PRN to JSON in C#. PRN Merge.
...
{{% blocks/products/pf/agp/content h2="Merge PRN to JSON in C#" %}}
...
{{% cells-merger title="Sample Code to Merge PRN to JSON in C#" InputFormat="prn" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
