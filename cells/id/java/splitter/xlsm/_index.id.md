---
title:  Pisahkan XLSM File via Java
weight: 5670
description: Kode contoh Java untuk membagi dokumen XLSM pada Lingkungan Runtime Java untuk Aplikasi JSP/JSF dan Aplikasi Desktop.
...
{{< blocks/products/pf/i18n/upper-banner h1="Pisahkan XLSM File via Java" h2="XLSM pemisahan dengan bantuan perpustakaan Java sisi server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Memisahkan File XLSM di Java" %}}
...
+ Muat file XLSM menggunakan kelas Buku Kerja.
+ Ulangi setiap lembar
+ Buat objek kelas Buku Kerja baru
Salin lembar yang dipilih ke objek baru
+ Panggil metode penyimpanan dengan jalur file XLSM yang baru.
...
{{% blocks/products/pf/agp/code-block title="Pisahkan berkas XLSM - Java" offSpacer="" %}}
