---
title:  Chèn nút xoay vào Excel via .NET
weight: 40
description: Mã nguồn C# để chèn nút quay vào Excel trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn nút xoay vào Excel via .NET" h2="Chèn các nút Spin bằng cách sử dụng Aspose.Cells\' API mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn nút xoay vào File Excel Bằng C#" %}}
 ...
 Để chèn nút xoay vào file excel, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn nút spin vào file Excel qua C#" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng các[thêm phương pháp](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addspinner) để chèn một nút xoay trong trang tính đã chọn
