---
title: Chuyển đổi PHP XLSB sang XLTX - XLSB sang XLTX
description: Aspose Excel. Chuyển đổi XLSB thành XLTX nhanh chóng và dễ dàng với Aspose.Cells. PHP XLSB thành XLTX. PHP Lưu XLSB thành XLTX. Lưu XLSB thành XLTX bằng PHP.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSB thành XLTX qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLSB thành XLTX theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi XLSB thành XLTX chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLSB thành XLTX bằng cách gọi phương thức lưu của Workbook.
