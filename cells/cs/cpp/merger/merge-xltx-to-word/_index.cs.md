---
title: Sloučit XLTX až WORD - Sloučit XLTX až WORD v C++
url: /cs/cpp/merger/merge-xltx-to-word/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do WORD uložit formát. C++ Kombinujte formát XLTX až WORD. Sloučit XLTX až WORD v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX až WORD v C++" %}}

Následující příklad ukazuje, jak sloučit XLTX až WORD v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLTX do WORD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí XLTX do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení XLTX až WORD v C++" InputFormat="xltx" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLTX na WORD přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLTX až WORD? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení XLTX až WORD" %}}
