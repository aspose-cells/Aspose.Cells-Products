...
weight: 200
description: ซอร์สโค้ด Python via .Net เพื่อแทรกรูปภาพ/ไอคอน SVG ลงใน Excel
---
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/) เพื่อแทรกไอคอนในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก SVG รูปภาพ/ไอคอน - Python via .Net" offSpacer="" %}}
