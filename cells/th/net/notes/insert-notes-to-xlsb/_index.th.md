...
{{% blocks/products/pf/agp/content h2="วิธีแทรกโน้ตในไฟล์ XLSB ผ่าน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="รหัสตัวอย่าง C# เพื่อแทรกและลบบันทึกย่อในไฟล์ XLSB" offSpacer="" %}}
