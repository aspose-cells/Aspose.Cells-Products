---
title:  Объединить XLTM с XLTM через Python
...
В следующем примере показано, как объединить XLTM с XLTM в Python.
...
{{% cells-merger title="Бесплатное приложение для объединения XLTM с XLTM онлайн" InputFormat="xltm" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
