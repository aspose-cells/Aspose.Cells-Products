...
{{% blocks/products/pf/agp/content h2="Hur man infogar bild i Excel-fil med Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga bild till Excel-fil med Python via java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd bildsamlingens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) för att infoga en bild i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga bild - Python via java" offSpacer="" %}}
