---
title: دمج الأرقام في SPREADSHEETML - ادمج الأرقام في SPREADSHEETML في Java
url: /ar/java/merger/merge-numbers-to-spreadsheetml/ 
description: Aspose إكسل. Java Aspose.Cells. دمج الأرقام مجانًا عبر الإنترنت إلى تنسيق حفظ SPREADSHEETML. Java دمج الأرقام في تنسيق SPREADSHEETML. دمج الأرقام في SPREADSHEETML في Java. دمج الأرقام.
...
{{% blocks/products/pf/agp/content h2="دمج الأرقام في SPREADSHEETML في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج الأرقام في SPREADSHEETML في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج الأرقام في SPREADSHEETML. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف SPREADSHEETML. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يقوم بدمج الأرقام في SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني على الإنترنت لدمج الأرقام في SPREADSHEETML في Java" InputFormat="numbers" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج الأرقام في SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج NUMBERS في SPREADSHEETML برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Java مكتبة لدمج الأرقام في SPREADSHEETML" %}}
