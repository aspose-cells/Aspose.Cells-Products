---
title: أدخل الخط في Excel via Java
weight: 30
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج سطر في ملف إكسل باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج السطر في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) لإدراج سطر في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل السطر - Java" offSpacer="" %}}
