---
title: Převést ODS na BMP prostřednictvím Java 
weight: 2160
url: /cs/java/conversion/ods-to-bmp/ 
description: Ukázkový konverzní kód Java pro formát ODS na soubor BMP. Programátoři mohou tento ukázkový kód použít k exportu tabulek Excelu a OpenOffice do BMP v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODS na BMP prostřednictvím Java" h2="Převod ODS na BMP Java pro převod jedné nebo více stránek na BMP pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na BMP pomocí Java" %}}

 K vykreslení ODS na BMP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na BMP prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na BMP pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí Workbook1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Voláním metody SheetRender.toImage uložíte výsledek ve formátu BMP
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODS na BMP Java" offSpacer="" %}}
