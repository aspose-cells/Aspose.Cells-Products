...
description: Sample code for xlsb to xlt C# conversion. Use API example code for batch xlsb files to xlt conversion within VB.NET, Asp.NET or any .NET based application.
---
