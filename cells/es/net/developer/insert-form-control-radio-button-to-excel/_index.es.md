---
title:  Insertar botón de radio en Excel via .NET
weight: 60
description: Código fuente C# para insertar RadioButton en Excel en .NET Framework, .NET Core, Mono o plataformas Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar RadioButton en un archivo Excel a través de C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[agregar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addradiobutton) para insertar un botón de radio en la hoja de trabajo seleccionada
...
{{% blocks/products/pf/agp/code-block title="Insertar botón de radio - C#" offSpacer="" %}}
