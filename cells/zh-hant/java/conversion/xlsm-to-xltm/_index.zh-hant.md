...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 XLSM 轉換為 XLTM。Java XLSM 為 XLTM. Java 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Java。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 XLSM 轉換為 Java 中的 XLTM" h2="高速Java庫，用於將XLSM轉換為XLTM。這是一個專業的軟體解決方案，用於導入和導出XLSM、XLTM和使用Java的許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
以下範例示範如何將 Java 中的 XLSM 轉換為 XLTM。
...
{{% cells-convert title="將 XLSM 轉換為 XLTM 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xltm" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何轉換 XLSM 為 XLTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 XLSM 檔案轉換為 XLTM 嗎？ Java開發人員只需幾行程式碼即可輕鬆將XLSM轉換為XLTM。
...
{{% blocks/products/pf/agp/content h2="Java庫將XLSM轉換為XLTM" %}}
{{% blocks/products/pf/agp/text %}}
