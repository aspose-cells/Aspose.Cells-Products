---
title: JPG oluştur - C#'de JPG dosyası oluşturun
description: Aspose Excel. Aspose.Cells for .NET kütüphanesi ile JPG dosyalarını zahmetsizce oluşturun ve düzenleyin. Bu güçlü API, JPG dosyalarını doğrudan C# uygulamalarınız içinde oluşturmak, düzenlemek ve yönetmek için akıcı ve verimli bir çözüm sunarak, geliştiricilerin özel ihtiyaçlarını yüksek hassasiyetle karşılar.
...
{{% blocks/products/pf/agp/content h2="C#\'de JPG Nasıl Oluşturulur?" %}}
...
1.  Çalışma kitabını JPG dosyası olarak kaydetmek için Kaydet yöntemini kullanın.

{{% blocks/products/pf/agp/code-block title="Örnek kod, C# numaralı cihazda JPG dosyasının nasıl oluşturulacağını göstermektedir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# JPG dosyası oluşturmak için kullanılan kütüphane" %}}
