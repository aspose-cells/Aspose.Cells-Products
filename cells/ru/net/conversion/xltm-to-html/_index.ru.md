---
title: Преобразователь C# XLTM в HTML - XLTM в HTML
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в HTML в C#" %}}
...
Нужно программно преобразовать файлы XLTM в HTML? Разработчики .NET могут легко загрузить и преобразовать XLTM в HTML всего за несколько строк кода.
...
1.  Преобразуйте значение XLTM в HTML, вызвав метод Workbook.Save.
