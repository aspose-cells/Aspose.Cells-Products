---
title: Java HTM إلى MHT - تحويل HTM إلى MHT
description: Aspose اكسل. قم بتحويل HTM إلى MHT بسرعة وسهولة باستخدام Aspose.Cells. Java HTM إلى MHT. Java حفظ HTM إلى MHT. احفظ HTM كـ MHT باستخدام Java.
...
{{% blocks/products/pf/agp/content h2="احفظ HTM إلى MHT في Java" %}}
...
هل تحتاج إلى تحويل ملفات HTM إلى MHT برمجياً؟ يمكن لمطوري Java تحويل HTM إلى MHT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل HTM إلى MHT" %}}
{{% blocks/products/pf/agp/text %}}
