---
title: 通過 C++ 解鎖 ODS 文件
weight: 1190
description: C++ 解鎖受密碼保護的 ODS 文件的示例代碼 C++ Windows 32 位、Windows 64 位和 Linux 64 位運行時環境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 解鎖 ODS 文件" h2="使用 C++ 庫從包括 ODS 文件的 Excel 電子表格中刪除保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 解除對 ODS 文件的保護" %}}
