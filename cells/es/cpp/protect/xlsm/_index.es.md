...
weight: 8770
url: /es/cpp/protect/xlsm/ 
description: C++ código de ejemplo para bloquear el archivo XLSM mediante contraseña en C++ entorno de tiempo de ejecución para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cifrar archivos XLSM a través de C++" h2="Proteja con contraseña las hojas de cálculo de Excel, incluido el formato XLSM, utilizando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
1. Cargue el archivo XLSM usando la clase IWorkbook1. Utilice el método Protect(..) con ProtectionType y Password1. Guarde el archivo XLSM protegido con el método Save()
