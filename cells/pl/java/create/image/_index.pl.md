...
description: Aspose Excel. Java Szybko i łatwo utwórz plik IMAGE za pomocą Aspose.Cells. Wygeneruj plik IMAGE za pomocą Java. Utwórz OBRAZ w Java. Java Kreator OBRAZÓW.
...
1.  Zapisz skoroszyt w formacie IMAGE, używając metody save().

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik IMAGE w Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do tworzenia pliku IMAGE" %}}
{{% blocks/products/pf/agp/text %}}
