...
Нужно программно преобразовать файлы XML в EMF? Разработчики C++ могут легко преобразовать XML в EMF всего за несколько строк кода.
