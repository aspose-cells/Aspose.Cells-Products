---
title: PHP XLTM से ODS - XLTM से ODS कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ XLTM को ODS में जल्दी और आसानी से बदलें। PHP XLTM से ODS। PHP XLTM को ODS में सहेजें। PHP का उपयोग करके XLTM को ODS के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="PHP के माध्यम से XLTM को ODS में कैसे बदलें" %}}

{{% blocks/products/pf/agp/text %}}

XLTM फ़ाइलों को प्रोग्रामेटिक रूप से ODS में कनवर्ट करने की आवश्यकता है? PHP डेवलपर्स कोड की कुछ पंक्तियों में XLTM को ODS में आसानी से लोड और परिवर्तित कर सकते हैं।
...
1.  वर्कबुक की सेव विधि को कॉल करके XLTM को ODS में बदलें।
