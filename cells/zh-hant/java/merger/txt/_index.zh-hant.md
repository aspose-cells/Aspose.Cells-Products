---
title: 通過 Java 合併 TXT 文件 
weight: 4480
url: /zh-hant/java/merger/txt/ 
description: Java 用於在 Java JSP/JSF 應用程序和桌面應用程序的運行時環境中組合 TXT 文檔的示例代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合併 Java 中的 TXT 格式" h2="使用服務器端 Java API 的本機 TXT 文檔合併。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中合併 TXT 文件的步驟" %}}
...
+ 使用 Workbook 類的實例加載第一個 TXT 文件。
+ 使用 Workbook 類的實例加載第二個 TXT 文檔。
+ 使用 combine() 方法合併文件。
+ 將合併的 TXT 文件保存在指定路徑
