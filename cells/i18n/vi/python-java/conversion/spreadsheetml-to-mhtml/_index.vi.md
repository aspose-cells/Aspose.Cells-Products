---
title: Chuyển đổi SPREADSHEETML sang MHTML qua Python
url: /vi/python-java/conversion/spreadsheetml-to-mhtml/
description: Mã mẫu cho chuyển đổi từ bảng tínhml sang mhtml Python. Sử dụng API mã mẫu cho hàng loạt tệpml bảng tính thành chuyển đổi mhtml trong ứng dụng Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi SPREADSHEETML sang MHTML qua Python" h2="Xuất bảng tính Excel® sang định dạng MHTML bằng Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi SPREADSHEETML sang MHTML bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi SPREADSHEETML sang MHTML qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp SPREADSHEETML sang MHTML chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp SPREADSHEETML bằng một phiên bản của Workbook1. Gọi phương thức Workbook.Save1. Chuyển đường dẫn đầu ra với phần mở rộng MHTML làm tham số1. Kiểm tra đường dẫn được chỉ định cho tệp MHTML kết quả
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi SPREADSHEETML sang MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="mhtml" IsLandingPage="true" language="python" %}}
