---
title: Konwertuj XLSB na DIF przez Python
url: /pl/python-java/conversion/xlsb-to-dif/
description: Przykładowy kod konwersji xlsb do różnic Python. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji dif w aplikacji Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na DIF za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSB na DIF za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki XLSB do formatu DIF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem DIF jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku DIF
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSB na DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="dif" IsLandingPage="true" language="python" %}}
