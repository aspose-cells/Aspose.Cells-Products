---
title: PHP da XLSB a DIF - da XLSB a DIF Convertitore
description: Aspose Excel. Converti XLSB in DIF in modo rapido e semplice con Aspose.Cells. PHP da XLSB a DIF. PHP Salva da XLSB a DIF. Salva XLSB come DIF utilizzando PHP.
...
{{% blocks/products/pf/agp/content h2="Come convertire XLSB in DIF tramite PHP" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file XLSB in DIF a livello di codice? Gli sviluppatori PHP possono caricare e convertire facilmente XLSB in DIF in poche righe di codice.
...
1.  Converti XLSB in DIF chiamando il metodo di salvataggio della cartella di lavoro.
1.  Ottieni il risultato della conversione da XLSB a DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria PHP per convertire XLSB in DIF" %}}
