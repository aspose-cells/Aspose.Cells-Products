...
description: Aspose Exceller. Python Exceller. Convertissez XLSM en PNG rapidement et facilement avec Aspose.Cells. Python XLSM en PNG. Python Enregistrez XLSM en PNG. Enregistrez XLSM sous 076112. 3481 en utilisant la bibliothèque Excel Python.
...
{{% blocks/products/pf/agp/content h2="Convertir XLSM en PNG à l\'aide de la bibliothèque Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XLSM à PNG dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment convertir XLSM en PNG dans la bibliothèque Excel Python.
...
{{% cells-convert title="Exemple de code pour convertir XLSM en PNG via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="png" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Excel Python pour convertir XLSM en PNG" %}}
