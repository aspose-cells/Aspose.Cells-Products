---
title: C++ XLS a DOCX - XLS a DOCX Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato DOCX, permitindo o salvamento perfeito de dados XLS no formato DOCX usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLS a DOCX em C++" %}}

exemplo a seguir demonstra como converter XLS em DOCX em C++.
...
{{% blocks/products/pf/agp/content h2="Como converter XLS em DOCX por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para DOCX programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para DOCX com apenas algumas linhas de código.
...
1.  Converta XLS para DOCX chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em DOCX" %}}
