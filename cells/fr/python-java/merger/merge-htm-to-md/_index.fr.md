---
title: Fusionner HTM avec MD - Combiner HTM avec MD dans Python
url: /fr/python-java/merger/merge-htm-to-md/ 
description: Aspose Exceller. Python Aspose.Cells. Fusionner HTM avec le format de sauvegarde MD. Python Combinez le format HTM au format MD. Fusionner HTM avec MD dans Python. Fusion HTM.
...
{{% cells-merger title="Exemple de code pour fusionner HTM avec MD dans Python" InputFormat="htm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec MD via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTM vers MD par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner HTM avec MD" %}}
