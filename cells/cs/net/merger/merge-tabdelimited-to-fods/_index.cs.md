...
url: /cs/net/merger/merge-tabdelimited-to-fods/ 
...
Následující příklad ukazuje, jak sloučit TABDELIMITED do FODS v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit TABDELIMITED na FODS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení TABDELIMITED do FODS" %}}
