---
title: Převodník PHP PNG na PRN – PNG na PRN
description: Aspose Excel. Převeďte PNG na PRN rychle a snadno pomocí Aspose.Cells. PHP PNG na PRN. PHP Uložit PNG do PRN. Uložte PNG jako PRN pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na PRN přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést PNG soubory na PRN programově? Vývojáři PHP mohou snadno načíst a převést PNG na PRN v několika řádcích kódu.
...
1.  Převeďte PNG na PRN voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na PRN" %}}
