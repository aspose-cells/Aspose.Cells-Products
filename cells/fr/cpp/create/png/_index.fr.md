...
description: Aspose Exceller. C++ Créez un fichier PNG rapidement et facilement avec Aspose.Cells. Générez un fichier PNG à l'aide de C++. Créez PNG dans C++. C++ PNG Creater.
...
1.  Enregistrez le classeur sous forme de fichier .png à l'aide de la méthode Save().
