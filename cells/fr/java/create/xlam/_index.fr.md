---
title: Créer XLAM - Créer un fichier XLAM dans Java
description: Aspose Excel. Générez et manipulez facilement des fichiers XLAM grâce à la bibliothèque Aspose.Cells for Java. Cette puissante bibliothèque API offre une solution simplifiée et efficace pour créer, modifier et gérer des fichiers XLAM directement dans vos applications Java, répondant ainsi avec une grande précision aux besoins spécifiques des développeurs.
...
{{% blocks/products/pf/agp/content h2="Comment créer XLAM dans Java" %}}
...
1.  Enregistrez le classeur au format XLAM en utilisant la méthode save().

{{% blocks/products/pf/agp/code-block title="L\'exemple de code montre comment créer le fichier XLAM dans Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour créer le fichier XLAM" %}}
{{% blocks/products/pf/agp/text %}}
