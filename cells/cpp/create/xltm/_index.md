---
title: Create XLTM Files via C++ 
weight: 7690
url: /cpp/create/xltm/ 
description: C++ Sample code for generating XLTM Microsoft Excel files. Use this code for creating MS Excel XLTM files within C++ based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Create XLTM File via C++" h2="Native and high performance Microsoft Excel XLTM Spreadsheets creation programmatically without Micorsoft Office using C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Generating MS Excel XLTM file dynamically within running application is easy. In order to create XLTM sheets from scratch having similar result as of New spreadsheet in Microsoft Excel without requiring MS Office, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="How to Create XLTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to creat, load, modify and convert XLTM files within running reporting applications for data processing in just few lines of code.
...
1.  Save the workbook as .xltm file using Save() method.
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a Word XLTM file using C++." offSpacer="" %}}
...
wkb->Save(resultPath->StringAppend(new String("created_one.xltm")));
...
A Document Processing Library to perform a wide range of document creation, management and manipulation tasks including XLTM generation, editing, conversion, rendering and printing. C++ Word library supports all of word-processing formats as well as allows exporting or converting XLTM to PDF, HTML, fixed-layout and most commonly used image & multimedia formats.
