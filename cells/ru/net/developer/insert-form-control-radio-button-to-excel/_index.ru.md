---
title:  Вставьте RadioButton в Excel via .NET.
weight: 60
description: C# исходный код для вставки RadioButton в Excel на платформах .NET Framework, .NET Core, Mono или Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке RadioButton в файл Excel через номер C#" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addradiobutton) вставить RadioButton в выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставить радиокнопку — C#" offSpacer="" %}}
