---
title: 保护锁XLSB文档via Java
weight: 6590
description: Java 示例代码，用于在 JSP/JSF 应用程序和桌面应用程序的 Java 运行时环境中使用密码锁定 XLSB 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="加密 XLSB 文件 via Java" h2="使用 .NET 库使用密码保护 Excel 电子表格，包括 XLSB 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1. 通过实例化 Workbook 类加载 XLSB 文件
1. 使用带有 ProtectionType 和 Password 的 protect(..) 方法
1. 通过save()方法保存被保护的XLSB文件
