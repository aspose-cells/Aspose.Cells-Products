---
title: Crie gráficos de linhas 3D via Python
description: Python Código de exemplo para criação de gráficos de linhas 3D para Excel usando a Biblioteca Python. Use este código para criar um gráfico de linhas 3D para MS Excel no aplicativo baseado em Python.
...
1. Adicione um gráfico de linhas 3D à planilha
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="O código-fonte a seguir mostra como criar um gráfico de linhas 3D para o arquivo MS Excel XLSX usando Python." offSpacer="" %}}
