---
title:  Excel'e Satır Ekleme via .NET
weight: 101
description: C# .NET Kütüphanesini kullanarak Excel'e Satır eklemek veya eklemek için örnek kod. VB.NET, Asp.NET veya .NET tabanlı herhangi bir uygulama içinde MS Excel'de bir Satır oluşturmak için bu kodu kullanın.
keywords: [C# Aspose.Cells., c# add a Line., c# insert a Line., c# create a Line]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Excel\'e Satır Ekleme via .NET" h2="Aspose.Cells\' API\'i kullanarak Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan bir satır ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak Excel Dosyasına Satır Nasıl Eklenir" %}}
 ...
 Excel dosyasına bir Satır eklemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla Excel\'e Satır dosyası ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Kullan[yöntem ekle](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) seçilen çalışma sayfasına bir Satır eklemek için
