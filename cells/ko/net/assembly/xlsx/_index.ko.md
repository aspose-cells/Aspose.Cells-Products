---
title:  XLSX 파일에서 보고서 생성 via .NET
weight: 6740
description: .NET 프레임워크, .NET 코어, Mono 또는 Xamarin 플랫폼에서 XLSX 형식 보고서를 생성하는 C# 소스 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통한 XLSX 형식의 대량 보고서 생성" h2="데이터 소스 및 템플릿을 사용하여 XLSX 형식으로 보고서를 생성합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. WorkbookDesigner.Worbook.Save 메서드를 통해 결과를 XLSX 형식으로 저장
