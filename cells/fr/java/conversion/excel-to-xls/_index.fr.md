---
title:  Convertir EXCEL en XLS Java
description: Convertissez EXCEL en XLS en ligne gratuitement. Convertisseur EXCEL en XLS en ligne gratuit. Java EXCEL à XLS. EXCEL à XLS via Java.
keywords: Convert EXCEL, EXCEL Converter, EXCEL to PDF, EXCEL to Word, EXCEL to PPT, EXCEL to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir EXCEL en XLS via Java" h2="Conversion EXCEL en XLS Java pour convertir une ou plusieurs pages en XLS à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir EXCEL en XLS en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier EXCEL avec une instance de la classe Workbook
1.  Convertir EXCEL en XLS en appelant la méthode Workbook.save
