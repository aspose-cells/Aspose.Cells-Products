---
title: Gộp OTS sang SQL - Gộp OTS sang SQL trong Java
url: /vi/java/merger/merge-ots-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu OTS sang SQL. Java Kết hợp định dạng OTS sang SQL. Hợp nhất OTS thành SQL theo số Java. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS sang SQL trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất OTS thành SQL trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất OTS với SQL. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SQL. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất OTS với SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất OTS sang SQL trong Java" InputFormat="ots" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS sang SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất OTS sang SQL theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất OTS sang SQL" %}}
