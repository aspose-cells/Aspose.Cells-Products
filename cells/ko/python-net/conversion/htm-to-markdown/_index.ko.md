...
description: Aspose 엑셀. Aspose.Cells을 사용하여 HTM을 MARKDOWN로 빠르고 쉽게 변환합니다. Python HTM을 MARKDOWN로 변환합니다. Python HTM을 MARKDOWN로 저장합니다. Python을 사용하여 HTM을 MARKDOWN로 저장합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python에서 HTM을 MARKDOWN로 변환" h2="HTM을 MARKDOWN로 변환하기 위한 고속 Python 라이브러리. Excel 변환 API을 사용하여 Python에서 높은 수준의 플랫폼 독립적인 소프트웨어를 개발하세요." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python에 HTM을 MARKDOWN에 저장" %}}

다음 예에서는 HTM을 Python via NET에서 MARKDOWN로 변환하는 방법을 보여줍니다.
