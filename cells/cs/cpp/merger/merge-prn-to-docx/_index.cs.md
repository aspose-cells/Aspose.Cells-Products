---
title:  Sloučit PRN na DOCX přes C++
...
Následující příklad ukazuje, jak sloučit PRN s DOCX v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení PRN s číslem DOCX online" InputFormat="prn" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
