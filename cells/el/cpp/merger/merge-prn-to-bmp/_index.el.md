...
description: Aspose Excel. C++ Aspose.Cells. Συγχώνευση PRN σε μορφή αποθήκευσης BMP. C++ Συνδυάστε τη μορφή PRN σε BMP. Συγχώνευση PRN στο BMP στο C++. PRN Merge.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση PRN στο BMP στο C++" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση PRN στο BMP στο C++" InputFormat="prn" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
