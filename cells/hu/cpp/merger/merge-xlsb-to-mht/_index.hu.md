---
title: A XLSB egyesítése az MHT-val – a XLSB-es szám egyesítése az MHT-vel a C++-ben
url: /hu/cpp/merger/merge-xlsb-to-mht/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítés XLSB MHT mentési formátumba. C++ A XLSB kombinálása MHT formátumba. A XLSB egyesítése az MHT-val a C++-es számon. XLSB Egyesítés.
...
A következő példa bemutatja, hogyan egyesítheti a XLSB-et az MHT-val a Aspose.Cells-es for C++-ben.
...
{{% cells-merger title="Ingyenes online összevonás a XLSB-es számmal az MHT-vel a C++-ben" InputFormat="xlsb" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A XLSB és az MHT egyesítése a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a XLSB-et az MHT-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
