...
{{% blocks/products/pf/agp/content h2="Jak utworzyć PNG w C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści mogą łatwo tworzyć, ładować, modyfikować i konwertować pliki PNG w ramach różnych aplikacji raportujących do przetwarzania danych w zaledwie kilku wierszach kodu.
...
1. Użyj metody Zapisz, aby zapisać skoroszyt jako plik PNG.

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik PNG w C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteka do utworzenia pliku PNG" %}}
