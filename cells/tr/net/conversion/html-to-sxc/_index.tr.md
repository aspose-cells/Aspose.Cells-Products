...
HTML dosyalarını program aracılığıyla SXC'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyebilir ve SXC'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak HTML değerini SXC değerine dönüştürün.
