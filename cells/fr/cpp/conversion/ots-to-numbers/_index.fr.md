---
title: C++ Convertisseur OTS vers NUMÉROS - Convertisseur OTS vers NUMÉROS
description: Aspose Excel. Cette solution complète offre aux développeurs C++ une approche entièrement intégrée pour convertir OTS au format NUMBERS, permettant un enregistrement transparent des données OTS au format NUMBERS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C++ efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OTS en NUMÉROS dans C++" h2="Conversion OTS vers NUMBERS haute performance utilisant la bibliothèque C++ sans avoir besoin de l\'installation d\'Excel, d\'OpenOffice ou d\'Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrez OTS vers les numéros dans C++" %}}

L'exemple suivant montre comment convertir OTS en NUMÉROS dans C++.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier OTS en NUMBERS. Téléchargez votre fichier OTS, puis enregistrez-le au format NUMBERS. Vous pouvez utiliser des noms de fichiers complets pour la lecture des fichiers OTS et l'écriture des fichiers NUMBERS. Le contenu et la mise en forme du fichier NUMBERS de sortie seront identiques à ceux du document OTS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir des OTS en NUMÉROS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="numbers" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir un numéro OTS en numéro de téléphone via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers OTS en nombres par programmation ? Les développeurs de C++ peuvent facilement convertir des fichiers OTS en nombres en quelques lignes de code seulement.
...
1.  Convertissez les OTS en NUMBERS en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de OTS en NOMBRE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir OTS en NUMÉROS" %}}
