...
{{% blocks/products/pf/agp/content h2="Ubah HTML menjadi XLT di Perpustakaan Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan HTML hingga XLT di Perpustakaan Excel Python" %}}

Contoh berikut menunjukkan cara mengonversi HTML menjadi XLT di perpustakaan excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Perpustakaan Excel untuk Mengonversi HTML menjadi XLT" %}}
