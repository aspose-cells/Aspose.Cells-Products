---
title: Créer DOCX - Créer un fichier DOCX dans C#
description: Aspose Excel. C# Créer un fichier DOCX. Créer DOCX C#. C# DOCX Créateur. Créez DOCX dans C#. Générez le fichier DOCX en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Comment créer DOCX dans C#" %}}
...
1. Utilisez la méthode Save pour enregistrer le classeur en tant que fichier DOCX.

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier DOCX dans C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="bibliothèque C# pour créer le fichier DOCX" %}}
