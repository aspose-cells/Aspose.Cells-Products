...
{{% blocks/products/pf/agp/feature-section-col title="Πώς να δημιουργήσετε γραφήματα υψηλής-χαμηλής-κλεισίματος μετοχών μέσω του C#" %}}
...
1.  Ρυθμίστε το[**Σημάδι**](https://reference.aspose.com/cells/net/aspose.cells.charts/series/marker/) με τα ενσωματωμένα δεδομένα.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Ο παρακάτω πηγαίος κώδικας δείχνει πώς μπορείτε να δημιουργήσετε ένα γράφημα μετοχών High-Low-Close στο αρχείο MS Excel XLSX χρησιμοποιώντας το C#." offSpacer="" %}}
