---
title: Mesclar EXCEL para XML - Combine EXCEL para XML em Python
url: /pt/python-java/merger/merge-excel-to-xml/ 
description: Aspose Excel. Python Excel. Mesclar EXCEL com formato de salvamento XML. Python Combine EXCEL com formato XML. Mesclar EXCEL com XML na Biblioteca Excel Python. Mesclar EXCEL.
...
{{% blocks/products/pf/agp/content h2="Mesclar EXCEL com XML usando a biblioteca Python Excel" %}}

 Como faço para mesclar EXCEL com XML? Com a biblioteca Aspose.Cells for Python via Java, você pode facilmente mesclar EXCEL com XML programaticamente com algumas linhas de código.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells) é capaz de construir aplicativos multiplataforma com a capacidade de gerar, modificar, converter, renderizar e imprimir todos os arquivos Excel. Python Excel API não apenas converte formatos de planilha, mas também pode renderizar arquivos Excel como imagens, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT e muito mais, tornando-o a escolha perfeita para troca de documentos em formatos padrão da indústria. Você pode instalar Aspose.Cells for Python via Java de<a href="https://pypi.org/project/aspose-cells/">pypi</a> , use o comando como:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mesclar EXCEL com XML na Biblioteca Excel Python" %}}

O exemplo a seguir demonstra como mesclar EXCEL com XML em Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar EXCEL com XML. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os em um arquivo XML. Se você desenvolver código em Python, será mais simples do que parece. Veja o exemplo Python que mescla EXCEL com XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de exemplo para mesclar EXCEL com XML na biblioteca Python Excel" InputFormat="xlsx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar EXCEL com XML por meio da biblioteca Python Excel" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar EXCEL com XML programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para mesclar EXCEL com XML" %}}
