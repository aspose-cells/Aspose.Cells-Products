...
Trzeba programowo przekonwertować pliki JPG do OTS? Programiści C++ mogą łatwo przekonwertować pliki JPG do OTS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JPG do OTS wywołując metodę Save().
