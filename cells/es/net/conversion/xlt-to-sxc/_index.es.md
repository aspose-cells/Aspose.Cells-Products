...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLT a SXC en C#" h2="Biblioteca C# de alta velocidad para convertir XLT a SXC. Esta es una solución de software profesional para importar y exportar XLT, SXC y muchos otros formatos en las plataformas .NET Framework, .NET Core o Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% cells-convert title="Código de muestra para convertir XLT a SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a SXC a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLT a SXC mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente XLT a SXC en solo unas pocas líneas de código.
