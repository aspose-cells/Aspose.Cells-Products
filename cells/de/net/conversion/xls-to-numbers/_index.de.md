---
title: C# XLS zu NUMBERS - XLS zu NUMBERS Umrechner
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS in NUMBERS in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in NUMBERS in C# umwandelt.
...
{{% blocks/products/pf/agp/content h2="So wandeln Sie XLS in NUMBERS um (über C#)" %}}

{{% blocks/products/pf/agp/text %}}

Müssen XLS-Dateien programmatisch in NUMBERS konvertiert werden? Entwickler können .NET-Dateien ganz einfach mit nur wenigen Codezeilen laden und in NUMBERS konvertieren.
...
{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Umwandlung von XLS in Zahlen" %}}
