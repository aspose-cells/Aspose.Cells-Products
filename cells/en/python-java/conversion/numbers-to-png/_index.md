...
Follow the easy steps to convert NUMBERS into PNG. Upload your NUMBERS file, then simply save it as PNG file. For both NUMBERS reading and PNG writing you can use fully qualified filenames. The output PNG content and formatting will be identical to the original NUMBERS document.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Python developers can easily load & convert NUMBERS to PNG in just a few lines of code.
