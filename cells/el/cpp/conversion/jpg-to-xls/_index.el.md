...
Χρειάζεται να μετατρέψετε αρχεία JPG σε XLS μέσω προγραμματισμού; Οι προγραμματιστές C++ μπορούν εύκολα να μετατρέψουν αρχεία JPG σε XLS σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατρέψτε το JPG σε XLS καλώντας τη μέθοδο Save().
