---
title: تحويل FODS إلى ODS عبر Java 
url: /ar/java/conversion/fods-to-ods/ 
description: نموذج Java رمز تحويل لتنسيق FODS إلى ملف ODS. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى ODS من خلال أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل FODS إلى ODS عبر Java" h2="تحويل FODS إلى ODS Java لتحويل صفحات مفردة أو متعددة إلى ODS باستخدام مكتبة Java داخل الشركة." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل FODS إلى ODS باستخدام Java" %}}

 من أجل تقديم FODS إلى ODS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل FODS إلى ODS عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف FODS إلى ODS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف FODS بنسخة من فئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد ODS & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف ODS الناتج
...
{{% blocks/products/pf/agp/code-block title="FODS إلى ODS Java شفرة مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف FODS في مثيل مصنف
Workbook book = new Workbook("template.fods");
// حفظ FODS على أنها مواد مستنفدة للأوزون
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل FODS إلى ODS" sectionDescription="[تحويل FODS إلى ODS](https://products.aspose.app/cells/conversion/fods-to-ods) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف FODS الخاص بك ، وسيتم تحويله على الفور إلى ODS." >}}
