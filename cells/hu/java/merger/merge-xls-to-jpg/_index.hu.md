...
url: /hu/java/merger/merge-xls-to-jpg/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés XLS JPG mentési formátumba. Java Kombinálja a XLS-et JPG formátumba. A XLS egyesítése JPG-be a Java-ben. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a XLS-et JPG-be a Java-ben" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a XLS-et JPG-vel a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS JPG formátumba egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el JPG fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a XLS-et JPG-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a XLS egyesítéséhez JPG formátumba Java-ben" InputFormat="xls" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLS és a via Java JPG fájl egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a XLS-et JPG-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a XLS JPG formátumba egyesítéséhez" %}}
