...
{{% blocks/products/pf/agp/content h2="วิธีแทรกคำบรรยายภาพลงในไฟล์ Excel โดยใช้ Java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) เพื่อแทรกคำบรรยายภาพในแผ่นงานที่เลือก
...
โค้ดตัวอย่างด้านล่างสาธิตวิธีการแทรก "Thought Bubble: Cloud" สำหรับประเภทเพิ่มเติม โปรดดูที่ "ภาพรวมประเภทคำบรรยายภาพบล็อก" ด้านล่าง

{{% blocks/products/pf/agp/code-block title="ใส่คำบรรยายภาพ - Java" offSpacer="" %}}
