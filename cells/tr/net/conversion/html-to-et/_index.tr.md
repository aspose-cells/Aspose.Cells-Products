---
title: C# HTML'den ET'ye - HTML'den ET'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile HTML'i hızlı ve kolay bir şekilde ET'ye dönüştürün. C# HTML'i ET'ye dönüştürün. C# HTML'i ET'ye kaydedin. C#'i kullanarak HTML'i ET olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="HTML\'i C#\'de ET\'ye kaydedin" %}}
...
{{% cells-convert title="HTML\'i ET\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML\'i C# aracılığıyla ET\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

HTML dosyalarını program aracılığıyla ET'ye dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyebilir ve ET'ye dönüştürebilir.
