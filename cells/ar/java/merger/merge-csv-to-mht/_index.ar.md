---
title:  ادمج CSV مع MHT via Java
...
يوضح المثال التالي كيفية دمج CSV مع MHT في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج CSV إلى MHT عبر الإنترنت" InputFormat="csv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
