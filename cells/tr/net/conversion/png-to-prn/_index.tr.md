---
title: C# PNG'den PRN'ye - Çevrimiçi PNG'den PRN'ye Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# PNG'i PRN saveformat'a dönüştürün. C# PNG'den PRN formatına. PNG'i PRN C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C#\'de PRN\'ye Kaydet Çevrimiçi Ücretsiz" %}}

Aşağıdaki örnek, PNG'in C#'de PRN'ye nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PNG'i PRN'ye dönüştürmek için kolay adımları izleyin. PNG dosyanızı yükleyin, ardından PRN dosyası olarak kaydedin. Hem PNG okuması hem de PRN yazması için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı PRN içeriği ve biçimlendirmesi orijinal PNG belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="PNG\'i Çevrimiçi PRN\'ye Dönüştürmek İçin Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG\'i C# aracılığıyla PRN\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını programlı olarak PRN'ye dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve PRN'ye dönüştürebilir.
...
1.  PNG'in PRN'ye dönüştürme sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PNG\'i PRN\'ye dönüştürmek için C# kitaplığı" %}}
