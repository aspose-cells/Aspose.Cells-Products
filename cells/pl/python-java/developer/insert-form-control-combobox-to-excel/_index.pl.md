...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić element ComboBox (formant formularza) w wybranym arkuszu.
