...
url: /pl/cpp/merger/merge-xltx-to-image/ 
...
Poniższy przykład pokazuje, jak połączyć XLTX z IMAGE w Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić XLTX z IMAGE? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLTX z IMAGE" %}}
