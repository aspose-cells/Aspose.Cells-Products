---
title:  Połącz XLSB z PDF przez C#
url: /pl/net/merger/merge-xlsb-to-pdf/ 
description: Połącz XLSB z PDF Online za darmo. Bezpłatnie online XLSB do PDF Fuzja. Połącz XLSB z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć XLSB z PDF w C#.
...
{{% cells-merger title="Darmowa aplikacja do łączenia XLSB z PDF on-line" InputFormat="xlsb" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
