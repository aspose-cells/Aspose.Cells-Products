---
title: دمج XML في POWERPOINT - دمج XML في POWERPOINT في Python
url: /ar/python-net/merger/merge-xml-to-powerpoint/ 
description: Aspose إكسل. Python Aspose.Cells. دمج XML مجانًا عبر الإنترنت إلى تنسيق حفظ POWERPOINT. Python دمج XML في تنسيق POWERPOINT. دمج XML إلى POWERPOINT في Python. دمج XML.
...
{{% cells-merger title="مجاني على الإنترنت لدمج XML في POWERPOINT في Python" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XML في POWERPOINT عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج XML في POWERPOINT برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
