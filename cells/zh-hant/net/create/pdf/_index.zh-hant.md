...
{{% blocks/products/pf/agp/content h2="如何在C#中創建PDF" %}}
...
1. 使用 Save 方法將工作簿另存為 PDF 文件。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 C# 中創建 PDF 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#庫創建PDF文件" %}}
