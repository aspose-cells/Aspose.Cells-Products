---
title:  Kiemelések beszúrása az Excelbe Python via .NET
weight: 360
description: Python via .NET forráskód a kiemelések Excelbe való beillesztéséhez.
---
...
{{% blocks/products/pf/agp/content h2="Kiemelések beszúrása Excel-fájlba a Python via .NET használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A kiemelések Excel-fájlba való beszúrásának lépései a Python-es számon keresztül" %}}
