---
title: Java HTML až XLT - HTML až XLT Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu formátu HTML do formátu XLT, což umožňuje bezproblémové ukládání dat HTML do formátu XLT pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte HTML na XLT v Java" h2="Vysokorychlostní knihovna Java pro převod HTML na XLT. Toto je profesionální softwarové řešení pro import a export HTML, XLT a mnoha dalších formátů s použitím Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte HTML na XLT v Java" %}}

Následující příklad ukazuje, jak převést číslo HTML na XLT v kódu Java.
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na XLT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory HTML na XLT? Vývojáři Java mohou snadno převést HTML na XLT pomocí několika řádků kódu.
...
1.  Převeďte HTML na XLT voláním metody Workbook.save.
1.  Získejte výsledek převodu HTML na XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod HTML na XLT" %}}
{{% blocks/products/pf/agp/text %}}
