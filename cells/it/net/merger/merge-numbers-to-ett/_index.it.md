---
title: Unisci NUMBERS a ETT - Combina NUMBERS a ETT in C#
url: /it/net/merger/merge-numbers-to-ett/ 
description: Aspose Excel. C# Aspose.Cells. Unisci NUMERI online gratuiti in formato di salvataggio ETT. C# Combina i NUMERI nel formato ETT. Unisci NUMBERS a ETT in C#. NUMBERS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci NUMBERS a ETT in C# online gratuitamente" %}}

L'esempio seguente mostra come unire NUMBERS a ETT in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire NUMBERS a ETT. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file ETT. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedi l'esempio C# che unisce NUMBERS a ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire NUMERI a ETT in C#" InputFormat="numbers" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire NUMBERS a ETT tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire NUMBERS a ETT in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria per unire NUMBERS a ETT" %}}
