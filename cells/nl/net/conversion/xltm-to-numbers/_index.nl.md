---
title: C# XLTM naar CIJFERS - XLTM naar CIJFERS Omzetter
...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in de lijst met nummers in C#" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar cijfers in C#.
...
{{% blocks/products/pf/agp/content h2="Hoe zet je XLTM om naar cijfers via C#?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden van het type XLTM programmatisch converteren naar NUMBERS? Ontwikkelaars van .NET kunnen bestanden van het type XLTM eenvoudig laden en converteren naar NUMBERS met slechts een paar regels code.
...
{{% blocks/products/pf/agp/content h2="C# bibliotheek om XLTM naar getallen te converteren" %}}
