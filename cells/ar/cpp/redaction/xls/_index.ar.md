...
weight: 380
description: C++ رمز مثال لتنقيح المعلومات الحساسة في ملف XLS على C++ Runtime Environment لـ Windows 32 بت و Windows 64 بت و Linux 64 بت.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تنقيح XLS تنسيقات في C++" h2="معلومات تنقيح حساسة للمستندات أصلية وعالية الأداء XLS باستخدام واجهات برمجة تطبيقات Aspose.Cells for C++ من جانب الخادم ، دون استخدام أي برنامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
