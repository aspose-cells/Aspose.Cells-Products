...
description: Python Python Kitaplığını kullanarak Excel'de Column3D grafikleri oluşturmak için örnek kod. Python tabanlı uygulama içinde MS Excel'e bir Column3D grafiği oluşturmak için bu kodu kullanın.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Python aracılığıyla Column3D Grafikleri Nasıl Oluşturulur" %}}
...
1. Çalışma sayfasına bir Column3D grafiği ekleyin
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kodu, Python kullanarak MS Excel XLSX dosyasına Column3D Grafiğinin nasıl oluşturulacağını gösterir." offSpacer="" %}}
