...
description: Aspose Excel. Converta MHTML em SQL de forma rápida e fácil com Aspose.Cells. C++ MHTML em SQL. C++ Salve MHTML no SQL. Salve MHTML como SQL usando C++.
...
{{% blocks/products/pf/agp/content h2="Converter MHTML em SQL usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve MHTML no SQL em C++" %}}

O exemplo a seguir demonstra como converter MHTML em SQL em C++.
...
Precisa converter arquivos MHTML para SQL programaticamente? Os desenvolvedores do C++ podem converter facilmente o MHTML em SQL em apenas algumas linhas de código.
...
1.  Converta MHTML em SQL chamando o método Save().
1.  Obtenha o resultado da conversão de MHTML para SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter MHTML para SQL" %}}
