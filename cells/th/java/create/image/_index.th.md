...
description: Aspose เอ็กเซล. Java สร้างไฟล์ IMAGE อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ IMAGE โดยใช้ Java สร้าง IMAGE ใน Java Java IMAGE Creater
...
1.  บันทึกสมุดงานเป็นรูปแบบ IMAGE โดยใช้เมธอด save()
...
{{% blocks/products/pf/agp/content h2="Java ไลบรารี่เพื่อสร้างไฟล์ IMAGE" %}}
{{% blocks/products/pf/agp/text %}}
