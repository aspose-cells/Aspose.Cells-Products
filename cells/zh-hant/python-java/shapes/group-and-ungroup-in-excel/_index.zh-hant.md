...
weight: 371
description: 使用 Aspose.Cells' Python via Java API 對物件進行分組和取消分組，無需任何軟體，例如 Microsoft 或 Open Office、Adobe PDF 等。
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via Java 對 Excel 檔案中的形狀進行分組和取消分組" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via Java 在 Excel 檔案中對形狀進行分組和取消分組的步驟" %}}
...
+ 透過索引選擇工作表。
 + 使用[分組法](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#group(com.aspose.cells.Shape[])) 將選定工作表中的形狀進行分組
...
{{% blocks/products/pf/agp/code-block title="組合與取消組合形狀 - Python via Java" offSpacer="" %}}
