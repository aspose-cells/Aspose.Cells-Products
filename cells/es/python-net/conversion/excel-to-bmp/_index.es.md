...
description: Aspose Excel. Convierta EXCEL a BMP rápida y fácilmente con Aspose.Cells. Python EXCEL a BMP. Python Guarde EXCEL en BMP. Guarde EXCEL como BMP usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar EXCEL al BMP en Python" %}}

El siguiente ejemplo demuestra cómo convertir EXCEL a BMP en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir EXCEL a BMP" %}}
