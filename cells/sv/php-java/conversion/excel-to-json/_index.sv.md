---
title: PHP EXCEL till JSON - EXCEL till JSON-omvandlare
description: Aspose Excel. Konvertera EXCEL till JSON snabbt och enkelt med Aspose.Cells. PHP EXCEL till JSON. PHP Spara EXCEL till JSON. Spara EXCEL som JSON med PHP.
...
Behöver du konvertera EXCEL-filer till JSON programmatiskt? PHP-utvecklare kan enkelt ladda och konvertera EXCEL till JSON på bara några rader kod.
...
1.  Konvertera EXCEL till JSON genom att anropa sparmetoden för arbetsboken.
