...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLSM 转换为 HTM。C# XLSM 转换为 HTM。 C# 将 XLSM 保存到 HTM。使用 C# 将 XLSM 保存为 HTM。
...
{{% blocks/products/pf/agp/content h2="将 XLSM 保存到 C# 中的 HTM" %}}
...
{{% cells-convert title="将 XLSM 转换为 HTM 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLSM 转换为 HTM" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 文件转换为 HTM？ .NET 开发人员只需几行代码即可轻松加载 XLSM 并将其转换为 HTM。
...
{{% blocks/products/pf/agp/content h2="C#库将XLSM转换为HTM" %}}
