...
The following example demonstrates how to convert CSV to HTML document format in C#.
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert CSV files to HTML in just a few lines of code.
