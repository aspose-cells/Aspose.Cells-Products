---
title: Chèn Điều khiển ActiveX vào Excel bằng Python via .Net
weight: 10
description: Python via Mã nguồn .Net để chèn ActiveX Control vào Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn Điều khiển ActiveX vào Excel bằng Python via .Net" h2="Chèn các đối tượng bằng API phía máy chủ mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn Điều khiển ActiveX vào Tệp Excel Sử dụng Python via .Net" %}}

 Để chèn ActiveX Control vào file excel, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn ActiveX Control vào file Excel bằng Python via .Net" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng add của shapecollection[phương pháp](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_active_x_control/#aspose.cells.drawing.activexcontrols.ControlType-int-int-int-int-int-int) để chèn Điều khiển ActiveX vào trang tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn ActiveX Control - Python via .Net" offSpacer="" %}}
