...
description: Aspose Excel. Python Aspose.Cells. Voeg XLS samen naar ETT-opslagformaat. Python Combineer XLS naar ETT-formaat. Voeg XLS samen met ETT in Python. XLS Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met ETT in Python" %}}
...
{{% cells-merger title="Voorbeeldcode om XLS samen te voegen met ETT in Python" InputFormat="xls" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLS samenvoegt met ETT via Python" %}}
