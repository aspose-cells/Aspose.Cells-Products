...
{{% cells-convert title="Contoh Kode untuk Mengonversi TSV menjadi TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="tiff" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah TSV menjadi TIFF melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file TSV ke TIFF secara terprogram? Pengembang C++ dapat dengan mudah mengonversi TSV menjadi TIFF hanya dalam beberapa baris kode.
...
1.  Ubah TSV menjadi TIFF dengan memanggil metode Save().
