---
title: PHP HTM a XLSM - Convertidor HTM a XLSM
description: Aspose Excel. Convierta HTM a XLSM rápida y fácilmente con Aspose.Cells. PHP HTM a XLSM. PHP Guarde HTM en XLSM. Guarde HTM como XLSM usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a XLSM mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a XLSM mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a XLSM en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a XLSM llamando al método guardar del libro de trabajo.
