---
title: Combinar TABDELIMITED con MHT - Combinar TABDELIMITED con MHT en C#
url: /es/net/merger/merge-tabdelimited-to-mht/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea TABDELIMITED para guardar formato MHT. C# Combine TABDELIMITED con el formato MHT. Combinar TABDELIMITED con MHT en C#. Combinar TABDELIMITED.
...
{{% blocks/products/pf/agp/content h2="Combine TABDELIMITED con MHT en C# en línea de forma gratuita" %}}

El siguiente ejemplo muestra cómo combinar TABDELIMITED con MHT en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar TABDELIMITED con MHT. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo MHT. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina TABDELIMITED con MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar TABDELIMITED a MHT en C#" InputFormat="tsv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar TABDELIMITED a MHT a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar TABDELIMITED con MHT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
