---
title: Połącz XLT z TABDELIMITED - Połącz XLT z TABDELIMITED w Java
url: /pl/java/merger/merge-xlt-to-tabdelimited/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online XLT do formatu zapisu TABDELIMITED. Java Połącz XLT w formacie TABDELIMITED. Połącz XLT z TABDELIMITED w Java. XLT Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLT z TABDELIMITED w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić XLT z TABDELIMITED w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLT z TABDELIMITED. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku TABDELIMITED. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy XLT z TABDELIMITED.
...
{{% blocks/products/pf/agp/content h2="Jak scalić XLT z TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić XLT z TABDELIMITED? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
