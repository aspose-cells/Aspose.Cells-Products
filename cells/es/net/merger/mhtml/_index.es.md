...
+ Cargue todos los archivos MHTML con la ruta completa.
+ Hacer un documento como archivo base
+ Llame al método relevante para concatenar y fusionar archivos uno por uno.
+ Llame al método Save() y pase el nombre del archivo (ruta completa) y el formato (MHTML) como parámetro.
+ Ahora puede abrir y usar el archivo MHTML en Office Microsoft, Adobe PDF o cualquier otro programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Combinar MHTML Archivos - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "d7c757e7471bd38006ac0d35d221b2e2" "merge-mhtml-files-using-cells-api.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{< blocks/products/pf/agp/demobox sectionTitle="En línea MHTML Fusión Demostraciones en vivo" sectionDescription=" Combine los documentos MHTML ahora mismo visitando nuestro[Sitio web de demostraciones en vivo](https://products.aspose.app/cells/merger). La demostración en vivo tiene los siguientes beneficios" >}}
