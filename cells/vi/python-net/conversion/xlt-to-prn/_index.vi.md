...
Ví dụ sau minh họa cách chuyển đổi XLT thành PRN trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLT sang PRN" %}}
