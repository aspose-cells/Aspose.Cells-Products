---
title: Merge XLTX to JSON via C# 
...
keywords: [Merge XLTX to JSON via C#., XLTX to JSON Merger., Merge XLTX to JSON Online for Free]
---
...
The following example demonstrates how to merge XLTX to JSON in C#.
...
{{% cells-merger title="Free App to merge XLTX to JSON on line" InputFormat="xltx" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
