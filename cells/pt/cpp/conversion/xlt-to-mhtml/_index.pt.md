---
title: Converter XLT para MHTML por meio do aplicativo C++ 
url: /pt/cpp/conversion/xlt-to-mhtml/ 
description: Exemplo de código de conversão C++ de documento XLT para formato MHTML. Os programadores podem usar esse código-fonte para conversão em lote de XLT para MHTML em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLT para MHTML via C++" h2="Conversão de XLT para MHTML de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem facilmente converter arquivos XLT para MHTML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLT usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (MHTML).1. O arquivo MHTML será salvo no caminho especificado.1. Abra o arquivo MHTML em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLT para MHTML C++" offSpacer="" %}}
