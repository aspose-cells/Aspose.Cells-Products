...
{{% blocks/products/pf/agp/content h2="EXCEL fájl mentése KÉP formátumban a C#-es címen" %}}

A következő példa bemutatja, hogyan konvertálhatja az EXCEL fájlt IMAGE formátumba a C#-es fájlban.
...
Programozottan kell konvertálnia az EXCEL fájlokat IMAGE formátumba? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal konvertálhatják az EXCEL-t IMAGE-re.
...
1.  Konvertálja az EXCEL-t IMAGE-be a Workbook.Save metódus meghívásával.
1.  Szerezze meg az EXCEL-ből IMAGE konvertálási eredményt.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár EXCEL fájlok IMAGE formátumba konvertálásához" %}}
