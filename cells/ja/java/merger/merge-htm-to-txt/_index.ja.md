---
title: HTM を TXT に結合 - HTM を Java に TXT に結合
url: /ja/java/merger/merge-htm-to-txt/ 
description: Aspose エクセル。 Java Aspose.Cells。無料オンライン HTM を TXT 保存形式にマージします。 Java HTM を TXT 形式に結合します。 HTM を Java の TXT にマージします。HTM をマージします。
...
次の例は、HTM を Aspose.Cells for Java の TXT にマージする方法を示しています。
...
{{% cells-merger title="オンラインで HTM を TXT に Java にマージする無料" InputFormat="htm" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM を TXT via Java にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

HTM をプログラムで TXT にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Java](https://products.aspose.com/cells/java)API はわずか数行のコードで実行できます。
