---
title: HTM を XLTM に結合 - HTM を Java に XLTM に結合
url: /ja/java/merger/merge-htm-to-xltm/ 
description: Aspose エクセル。 Java Aspose.Cells。無料オンライン HTM を XLTM 保存形式にマージします。 Java HTM を XLTM 形式に結合します。 HTM を Java の XLTM にマージします。HTM をマージします。
...
次の例は、HTM を Aspose.Cells for Java の XLTM にマージする方法を示しています。
...
{{% cells-merger title="オンラインで HTM を XLTM に Java にマージする無料" InputFormat="htm" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM を XLTM via Java にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

HTM をプログラムで XLTM にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Java](https://products.aspose.com/cells/java)API はわずか数行のコードで実行できます。
