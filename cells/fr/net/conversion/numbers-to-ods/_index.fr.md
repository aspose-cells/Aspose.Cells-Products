---
title: Convertir les NUMÉROS en ODS C#
description: Convertissez des NUMÉROS en ODS en ligne gratuitement. Convertisseur gratuit de NUMÉROS en ligne vers ODS. C# NUMÉROS à ODS. NUMÉROS à ODS via C#.
keywords: Convert NUMBERS, NUMBERS Converter, NUMBERS to PDF, NUMBERS to Word, NUMBERS to PPT, NUMBERS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir les NUMÉROS en ODS via C#" h2="Bibliothèque C# haute vitesse pour convertir des NUMÉROS en ODS. Exportez des feuilles de calcul Excel au format ODS sur .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir des NUMBERS en ODS en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir des NUMBERS en ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Les développeurs de .NET peuvent facilement charger et convertir des NUMBERS en ODS en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier NUMBERS avec une instance de Workbook
1.  Convertir NUMBERS en ODS en appelant la méthode Workbook.Save
