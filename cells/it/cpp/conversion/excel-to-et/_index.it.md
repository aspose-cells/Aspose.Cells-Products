...
Hai bisogno di convertire i file EXCEL in ET tramite codice? Gli sviluppatori di C++ possono convertire facilmente i file EXCEL in ET in poche righe di codice.
...
1.  Converti EXCEL in ET chiamando il metodo Save().
