---
title: How to insert OLE object into Excel via Python via Java
weight: 10

description: Insert OLE object using Aspose.Cells' Python via Java API without any software such as Microsoft or Open Office, Adobe PDF, etc.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Insert OLE object into Excel using Python via Java" h2="Insert objects using server-side APIs without any software like Microsoft or Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Insert OLE object into Excel File Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert OLE object to Excel file using Python via Java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addOleObject(int,%20int,%20int,%20int,%20int,%20int,%20byte[])) to insert an OLE object in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert OLE object - Python via Java" offSpacer="" %}}

{{< gist "aspose-cells-gists" "32e50c6aabc547111966569f3fd39694" "InsertOleObjectIntoWorksheet.py" >}}
