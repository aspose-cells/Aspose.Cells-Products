---
title: Convertir SXC en DIF C#
description: Convertissez SXC en DIF en ligne gratuitement. Convertisseur en ligne gratuit SXC à DIF. C# SXC à DIF. SXC à DIF via C#.
keywords: Convert SXC, SXC Converter, SXC to PDF, SXC to Word, SXC to PPT, SXC to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir SXC en DIF via C#" h2="Bibliothèque C# haute vitesse pour convertir SXC en DIF. Exportez des feuilles de calcul Excel au format DIF sur .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir SXC en DIF en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir SXC en DIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir SXC en DIF en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier SXC avec une instance de Workbook
1.  Convertir SXC en DIF en appelant la méthode Workbook.Save
