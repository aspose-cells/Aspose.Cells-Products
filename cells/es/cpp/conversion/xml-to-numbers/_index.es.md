---
title: C++ XML a NÚMEROS - Conversor de XML a NÚMEROS
description: Aspose Excel. Esta solución integral proporciona a los desarrolladores de C++ un enfoque totalmente integrado para convertir XML a formato NUMBERS, lo que permite guardar datos XML en formato NUMBERS sin problemas mediante la biblioteca Aspose.Cells, todo mediante código C++ eficiente y personalizable.
...
{{% blocks/products/pf/agp/content h2="Guardar XML en NÚMEROS en C++" %}}

El siguiente ejemplo demuestra cómo convertir XML a NÚMEROS en C++.
...
{{% cells-convert title="Código de ejemplo para convertir XML a NÚMEROS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xml" outformat="numbers" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XML a NÚMEROS mediante C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesitas convertir archivos XML a NÚMEROS mediante programación? Los desarrolladores de C++ pueden convertir XML a NÚMEROS fácilmente con solo unas pocas líneas de código.
...
1. Convierta XML en NÚMEROS llamando al método Save().
1.  Obtenga el resultado de la conversión de XML a NÚMEROS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteca para convertir XML a NÚMEROS" %}}
