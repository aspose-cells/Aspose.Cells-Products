---
title: Converteer NUMMERS naar SXC via Java 
url: /nl/java/conversion/numbers-to-sxc/ 
description: Voorbeeld Java-conversiecode voor NUMBERS-indeling naar SXC-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar SXC te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer NUMMERS naar SXC via Java" h2="NUMMERS naar SXC Java conversie om enkele of meerdere pagina\'s naar SXC te converteren met behulp van een lokale bibliotheek Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="NUMMERS converteren naar SXC met Java" %}}

 Om NUMBERS naar SXC te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om NUMMERS naar SXC te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het NUMBERS-bestand gemakkelijk converteren naar SXC in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad NUMBERS-bestand met een instantie van Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met SXC-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende SXC-bestand
...
{{% blocks/products/pf/agp/code-block title="NUMMERS naar SXC Java Conversiebroncode" offSpacer="" %}}

```cs
// laad het NUMBERS-bestand in een instantie van Workbook
Workbook book = new Workbook("template.numbers");
// sla NUMMERS op als SXC
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMMERS naar SXC-conversie Live-demo\'s" sectionDescription="[Converteer NUMMERS naar SXC](https://products.aspose.app/cells/conversion/numbers-to-sxc) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw NUMBERS-bestand, het wordt onmiddellijk geconverteerd naar SXC." >}}
