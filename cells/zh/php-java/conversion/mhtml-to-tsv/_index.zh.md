---
title: PHP MHTML 转 TSV - MHTML 转 TSV 转换器
description: Aspose Excel。此综合解决方案为 PHP 开发人员提供了一种完全集成的方法，可将 MHTML 转换为 TSV 格式，从而能够使用 Aspose.Cells 库将 MHTML 数据无缝保存为 TSV 格式，所有这些都通过高效且可定制的 PHP 代码实现。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 PHP 中将 MHTML 转换为 TSV" h2="用于将 MHTML 转换为 TSV 的高速 PHP 库。这是一个专业的软件解决方案，可使用 PHP 导入和导出 MHTML、TSV 和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
需要通过编程方式将 MHTML 文件转换为 TSV 文件吗？PHP 开发人员只需几行代码即可轻松加载 MHTML 文件并将其转换为 TSV 文件。
...
1. 通过调用工作簿的 save 方法将 MHTML 转换为 TSV。
1. 得到MHTML至TSV的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="用于将 MHTML 转换为 TSV 的 PHP 库" %}}
