---
title:  Sloučit MHT na XLSX přes Python
...
Následující příklad ukazuje, jak sloučit MHT s XLSX v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHT na XLSX online" InputFormat="mht" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
