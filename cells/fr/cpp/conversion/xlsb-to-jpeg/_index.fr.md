---
title: Convertir XLSB en JPEG via l'application C++ 
weight: 6990
url: /fr/cpp/conversion/xlsb-to-jpeg/ 
description: Exemple de code de conversion C++ pour le document XLSB au format JPEG. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLSB en JPEG dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en JPEG via C++" h2="Conversion XLSB vers JPEG haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir un fichier XLSB en JPEG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLSB à l'aide de Factory :: CreateIWorkbook.1. Sélectionnez la première feuille de calcul.1. Réglez les options (JPEG).1. Parcourez chaque page de la feuille et effectuez le rendu.1. Ouvrez le fichier JPEG dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLSB en JPEG C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion XLSB en JPEG" sectionDescription="[Convertir XLSB en JPEG](https://products.aspose.app/cells/conversion/xlsb-to-jpeg) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier XLSB, il sera converti instantanément en JPEG." >}}
