...
NUMBERS dosyasını programlı olarak ET'ye dönüştürmeniz mi gerekiyor? .NET geliştiriciler, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyebilir ve ET'ye dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak sayıları ET'ye dönüştürün.
