---
title:  .NET Java Python C++ API di analisi del foglio di calcolo Excel PHP e Android
weight: 10
description: Librerie per leggere, scrivere e manipolare Microsoft file Excel nelle app .NET Java C++ Android e SharePoint. Esporta fogli di lavoro in SSRS e JasperReports
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Elabora fogli di calcolo Excel su più piattaforme" h2="API native per creare, modificare, convertire ed eseguire il rendering di file Excel. Esporta fogli di calcolo in più formati su qualsiasi piattaforma." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells.svg" pfName="Aspose.Cells" downloadUrl="https://downloads.aspose.com/cells" tryOnlineUrl="" >}}
...
Crea, leggi, modifica, converti o esegui il rendering dei formati di fogli di calcolo Excel dalle applicazioni C++.
{{< /blocks/products/pf/product >}}
...
Esporta i report nei formati di file Excel e PDF da JasperReports o JasperServer.
{{< /blocks/products/pf/product >}}
...
Crea, manipola, converti e visualizza fogli di calcolo Excel tramite Node.js.
{{< /blocks/products/pf/product >}}
...
Crea, manipola, converti e visualizza fogli di calcolo Excel in applicazioni PHP tramite JavaBridge.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Perché la famiglia di prodotti Aspose.Cells?" tabId="success-stories" >}}
