...
description: Aspose Excel。 Python Aspose.Cells。将MHTML合并到PPTX保存格式。 Python 将 MHTML 合并为 PPTX 格式。将 MHTML 合并到 Python 中的 PPTX。 MHTML 合并。
...
{{% blocks/products/pf/agp/content h2="将 MHTML 合并到 Python 中的 PPTX" %}}
...
{{% cells-merger title="将 MHTML 合并到 Python 中的 PPTX 的示例代码" InputFormat="mhtml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
