...
{{% blocks/products/pf/agp/content h2="Csillagok és szalaghirdetések beszúrása Excel fájlba a Python via .NET használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A csillagok és szalaghirdetések Excel-fájlba való beszúrásának lépései a Python-es számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjtemény hozzáadását[módszer](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) Csillagok és Bannerek beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Csillagok és szalaghirdetések beszúrása - Python via .NET" offSpacer="" %}}
