...
description: Aspose Excel. Konwertuj XML na ET szybko i łatwo za pomocą Aspose.Cells. Python XML na ET. Python Zapisz XML w ET. Zapisz XML jako ET, używając numeru Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML w ET pod numerem Python" %}}

Poniższy przykład ilustruje sposób konwersji XML na ET w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji XML na ET" %}}
