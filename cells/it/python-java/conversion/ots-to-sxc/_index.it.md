...
description: Aspose Excel. Python Excel. Converti OTS in SXC in modo rapido e semplice con Aspose.Cells. Python OTS in SXC. Python Salva OTS in SXC. Salva OTS come SXC utilizzando la libreria Excel Python.
...
{{% blocks/products/pf/agp/content h2="Converti OTS in SXC utilizzando la libreria Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Salva OTS in SXC nella libreria Excel Python" %}}

L'esempio seguente mostra come convertire OTS in SXC nella libreria Excel Python.
...
{{% cells-convert title="Codice di esempio per convertire OTS in SXC tramite la libreria Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="sxc" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python Libreria Excel per convertire OTS in SXC" %}}
