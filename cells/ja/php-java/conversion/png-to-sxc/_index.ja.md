---
title: PHP PNG ～ SXC - PNG ～ SXC コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、PNG を SXC にすばやく簡単に変換します。PHP PNG から SXC。PHP PNG から SXC に保存します。PHP を使用して、PNG を SXC として保存します。
...
{{% blocks/products/pf/agp/content h2="PNG を PHP で SXC に保存します" %}}
...
{{% cells-convert title="PNG を SXC に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="sxc" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP 経由で PNG を SXC に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

PNG ファイルをプログラムで SXC に変換する必要がありますか? PHP 開発者は、わずか数行のコードで PNG を簡単にロードして SXC に変換できます。
