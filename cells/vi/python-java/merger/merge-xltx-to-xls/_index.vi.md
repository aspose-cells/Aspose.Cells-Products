---
title:  Ghép XLTX thành XLS qua Python
url: /vi/python-java/merger/merge-xltx-to-xls/ 
description: Hợp nhất XLTX thành XLS Trực tuyến miễn phí. Trực tuyến miễn phí XLTX đến XLS Sáp nhập. Hợp nhất XLTX thành Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS và hơn thế nữa.
---
...
Ví dụ sau minh họa cách hợp nhất XLTX thành XLS trong Python.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất XLTX thành XLS. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp rồi lưu vào tệp XLS. Nếu bạn phát triển mã trong Python, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Python hợp nhất XLTX thành XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ứng dụng miễn phí để hợp nhất XLTX thành XLS trực tuyến" InputFormat="xltx" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
