...
description: C++ रनटाइम पर्यावरण पर XLSB दस्तावेज़ों को संयोजित करने के लिए C++ उदाहरण कोड Windows 32 बिट, Windows 64 बिट और लिनक्स 64 बिट के लिए।
---
...
{{% cells-merger title="एक्सेल फाइलों को ऑनलाइन मर्ज करने के लिए फ्री ऐप" InputFormat="xlsb" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
