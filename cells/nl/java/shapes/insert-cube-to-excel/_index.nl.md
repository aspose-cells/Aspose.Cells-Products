...
{{< blocks/products/pf/i18n/upper-banner h1="Kubus invoegen in Excel via Java" h2="Plaats Cube met Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een kubus in een Excel-bestand kunt invoegen met behulp van Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Cube in Excel-bestand via Java in te voegen" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de[methode toevoegen](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) om Kubus in het geselecteerde werkblad in te voegen
...
{{% blocks/products/pf/agp/code-block title="Kubus plaatsen - Java" offSpacer="" %}}
