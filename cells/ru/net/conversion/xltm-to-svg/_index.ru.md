...
description: Aspose Эксель. Преобразуйте XLTM в SVG быстро и легко с помощью Aspose.Cells. C# XLTM в SVG. C# Сохранить XLTM в SVG. Сохранить XLTM как 07611134 81, используя C#.
...
{{% blocks/products/pf/agp/content h2="Преобразуйте XLTM в SVG, используя C#." %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните с XLTM по SVG в C#." %}}
...
{{% cells-convert title="Пример кода для преобразования XLTM в SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="svg" IsLandingPage="true" %}}
