---
title: Połącz XLTX z EMF - Połącz XLTX z EMF w C#
url: /pl/net/merger/merge-xltx-to-emf/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLTX do EMF w formacie zapisu. C# Połącz format XLTX z EMF. Połącz XLTX z EMF w C#. XLTX Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTX z EMF w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLTX z EMF w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLTX z EMF. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku EMF. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy numery XLTX z EMF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTX z EMF w C#" InputFormat="xltx" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTX z EMF za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLTX z EMF programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
