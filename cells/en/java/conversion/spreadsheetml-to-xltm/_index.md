...
{{% blocks/products/pf/agp/content h2="How to Convert SPREADSHEETML to XLTM Using Java" %}}
 ...
 In order to render SPREADSHEETML to XLTM, we’ll use
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML to XLTM Java Conversion Source Code" offSpacer="" %}}

```cs
// load the SPREADSHEETML file in an instance of Workbook
Workbook book = new Workbook("template.spreadsheetml");
// save SPREADSHEETML as XLTM
