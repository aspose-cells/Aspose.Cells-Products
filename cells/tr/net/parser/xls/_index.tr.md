---
title:  XLS belgesi via .NET'den metin ve resimleri ayıklayın
weight: 5600
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarındaki XLS dosyasından metin ve görüntüleri ayıklamak için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS Biçimlerini C#\'de ayrıştırın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan, sunucu tarafı Aspose.Cells for .NET API\'leri kullanılarak yerel ve yüksek performanslı XLS belge ayrıştırma." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
