...
weight: 800
description: C++ przykładowy kod do wstawienia gwiazdek i banerów w pliku Excel w środowisku wykonawczym C++ dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
keywords: [C++ Aspose.Cells., C++ add Star/Banner., C++ insert Star/Banner., C++ create Star/Banner]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw gwiazdki i banery do programu Excel pod numerem C++" h2="Wstaw obiekty, korzystając z natywnej i wysokiej wydajności po stronie serwera Aspose.Cells for C++ API bez użycia żadnego oprogramowania takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić gwiazdki i banery do pliku Excel przy użyciu numeru C++" %}}

 Aby wstawić gwiazdy i banery do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić gwiazdki i banery do pliku Excel pod numerem C++" %}}

+ Tworzenie instancji obiektu skoroszytu. (lub-> Załaduj plik XLSX z pełną ścieżką.)
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj[dodaj metodę](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/) , aby wstawić gwiazdki i banery w wybranym arkuszu
