...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Label to Excel file via C#" %}}
...
+  Use the [add method](https://apireference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addlabel) to insert a Label in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert Label - C#" offSpacer="" %}}

{{< gist "aspose-cells-gists" "88c9872508ec3150c552eb5155edf06e" "InsertLabelIntoWorksheet.cs" >}}
