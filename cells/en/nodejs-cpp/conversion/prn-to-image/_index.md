---
title: Node.js PRN to IMAGE - PRN to IMAGE Converter
description: Aspose Excel. Convert PRN to IMAGE quickly and easily with Aspose.Cells. Node.js PRN to IMAGE. Node.js Save PRN to IMAGE. Save PRN as IMAGE using Node.js.
keywords: [Aspose Excel., Node.js Aspose.Cells., Convert PRN to IMAGE in Node.js., Save PRN to IMAGE using Node.js., Node.js PRN to IMAGE saveformat., PRN to IMAGE Converter., Node.js Save PRN as IMAGE]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PRN to IMAGE in Node.js" h2="High-speed Node.js library for converting PRN to IMAGE. This is a professional software solution to import and export PRN, IMAGE, and many other formats using Node.js." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PRN to IMAGE Using Node.js" %}}

How do I convert PRN to IMAGE? With Aspose.Cells for Node.js via C++ library, you can easily convert PRN to IMAGE programmatically with  a few lines of code. [Aspose.Cells for Node.js via C++](https://products.aspose.com/cells/nodejs-cpp/) is capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. Node.js via C++ Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT and more, thus making it a perfect choice to exchange documents in industry-standard formats. 
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Save PRN to IMAGE in Node.js" %}}

The following example demonstrates how to convert PRN to IMAGE in Node.js.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert PRN to IMAGE. Upload your PRN file, then simply save it as IMAGE file. For both PRN reading and IMAGE writing you can use fully qualified filenames. The output IMAGE content and formatting will be identical to the original PRN document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Sample Code to Convert PRN to IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="png" IsLandingPage="true" language="nodejscpp" %}}

{{% blocks/products/pf/agp/content h2="How to Convert PRN to IMAGE via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert PRN files to IMAGE programmatically? Node.js developers can easily load & convert PRN to IMAGE in just a few lines of code.
...
1.  Convert PRN to IMAGE by calling save method of Workbook.
1.  Get the conversion result of PRN to IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Node.js library to convert PRN to IMAGE" %}}
