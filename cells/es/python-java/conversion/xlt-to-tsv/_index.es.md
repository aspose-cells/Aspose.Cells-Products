...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a TSV usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLT a TSV a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden cargar y convertir fácilmente archivos XLT a TSV con solo unas pocas líneas de código.
...
{{% cells-convert title="Aplicación gratuita y código de muestra para convertir XLT a TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="tsv" IsLandingPage="true" language="python" %}}
