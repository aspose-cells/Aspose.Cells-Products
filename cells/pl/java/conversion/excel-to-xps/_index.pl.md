...
{{% blocks/products/pf/agp/content h2="Konwertuj EXCEL na XPS używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL do XPS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę z programu EXCEL na XPS w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu XPS? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu XPS za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA na XPS" %}}
{{% blocks/products/pf/agp/text %}}
