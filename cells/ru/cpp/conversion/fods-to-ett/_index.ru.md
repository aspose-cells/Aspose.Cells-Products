...
Нужно программно преобразовать файлы FODS в ETT? Разработчики C++ могут легко преобразовать FODS в ETT всего за несколько строк кода.
