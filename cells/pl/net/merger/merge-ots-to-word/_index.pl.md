...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie online OTS z formatem zapisu WORD. C# Połącz format OTS z formatem WORD. Połącz OTS z WORD w C#. Połącz OTS.
...
Chcesz programowo połączyć OTS z WORD? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
