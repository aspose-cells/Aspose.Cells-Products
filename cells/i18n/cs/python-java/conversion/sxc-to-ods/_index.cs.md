---
title: Převést SXC na ODS přes Python
url: /cs/python-java/conversion/sxc-to-ods/
description: Ukázkový kód pro převod sxc na ods Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na ods v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na ODS pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na ODS přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na ODS pomocí několika řádků kódu.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="ods" IsLandingPage="true" language="python" %}}
