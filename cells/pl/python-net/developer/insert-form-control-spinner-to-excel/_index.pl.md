---
title:  Wstaw przycisk Spin (kontrolka formularza) do programu Excel przy użyciu Python via .Net
weight: 40
description: Python via Kod źródłowy .Net umożliwiający wstawienie przycisku Spin (kontrolka formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić przycisk Spin (kontrolka formularza) do pliku Excel przy użyciu Python via .Net" %}}

 Aby wstawić przycisk Spin (kontrolka formularza) do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić przycisk Spin (kontrolka formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj dodatku do kolekcji kształtów[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_spinner/#int-int-int-int-int-int) aby wstawić przycisk Spin (kontrolka formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw przycisk wirowania (kontrolka formularza) - Python via .Net" offSpacer="" %}}
