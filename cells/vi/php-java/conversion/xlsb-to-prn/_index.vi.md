---
title: Chuyển đổi PHP XLSB sang PRN - XLSB sang PRN Chuyển đổi
description: Aspose Excel. Chuyển đổi XLSB sang PRN nhanh chóng và dễ dàng với Aspose.Cells. PHP XLSB sang PRN. PHP Lưu XLSB vào PRN. Lưu XLSB dưới dạng PRN bằng PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLSB sang PRN trong PHP" h2="Thư viện PHP tốc độ cao để chuyển đổi XLSB sang PRN. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất XLSB, PRN và nhiều định dạng khác bằng PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for PHP" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/php-java" installationsDocsLink="https://docs.aspose.com/cells/php-java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/php/" learnAsLink="https://docs.aspose.com/cells/php-java" apiReference="" mavenRepoLink="" >}}


{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSB sang PRN bằng PHP" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLSB vào PRN bằng PHP" %}}

Ví dụ sau đây trình bày cách chuyển đổi XLSB sang PRN trong PHP.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSB sang PRN qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLSB sang PRN theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi XLSB sang PRN chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLSB sang PRN bằng cách gọi phương thức lưu của Workbook.
