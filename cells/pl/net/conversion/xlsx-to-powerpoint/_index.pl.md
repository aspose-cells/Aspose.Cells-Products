---
title: C# XLSX do POWERPOINT - Konwerter XLSX do POWERPOINT
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLSX do formatu POWERPOINT, umożliwiając bezproblemowe zapisywanie danych XLSX w formacie POWERPOINT przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSX do POWERPOINT w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLSX na prezentację PowerPoint w formacie C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować plik XLSX do formatu PowerPoint. Prześlij plik XLSX, a następnie zapisz go jako plik PowerPoint. Zarówno do odczytu pliku XLSX, jak i do zapisu pliku PowerPoint, możesz używać pełnych nazw plików. Wyjściowa zawartość i formatowanie pliku PowerPoint będą identyczne z oryginalnym dokumentem XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLSX na prezentację PowerPoint" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX do programu PowerPoint za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLSX do formatu POWERPOINT? Programiści .NET mogą z łatwością załadować i przekonwertować pliki XLSX do formatu POWERPOINT za pomocą zaledwie kilku linijek kodu.
...
1.  Przekonwertuj XLSX do formatu POWERPOINT, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLSX do formatu POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLSX na POWERPOINT" %}}
