...
{{% blocks/products/pf/agp/content h2="Hur man infogar kommentarer i ODS-filen via C#" %}}
...
Office 365 är kommentarer för konversationer, du kan använda följande C#-kod för att infoga och ta bort kommentarer i ODS-filen.

{{% blocks/products/pf/agp/code-block title="C# exempelkod för att infoga och ta bort kommentarer i filen ODS" offSpacer="" %}}
