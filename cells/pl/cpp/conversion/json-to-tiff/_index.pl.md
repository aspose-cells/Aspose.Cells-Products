---
title: Konwertuj JSON na TIFF za pomocą aplikacji C++ 
url: /pl/cpp/conversion/json-to-tiff/ 
description: Przykładowy kod konwersji C++ dla dokumentu JSON do formatu TIFF. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji JSON na TIFF w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj JSON na TIFF przez C++" h2="Wysokowydajna konwersja JSON do TIFF przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik JSON na TIFF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik JSON przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (TIFF).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik TIFF w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji JSON do TIFF C++" offSpacer="" %}}
