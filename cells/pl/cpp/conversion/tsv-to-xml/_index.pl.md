...
{{% cells-convert title="Przykładowy kod do konwersji TSV na XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować TSV na XML za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki TSV na XML? Programiści C++ mogą łatwo przekonwertować TSV na XML w zaledwie kilku linijkach kodu.
...
1.  Konwertuj TSV na XML, wywołując metodę Save().
