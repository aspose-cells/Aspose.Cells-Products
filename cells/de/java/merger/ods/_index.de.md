...
{{% blocks/products/pf/agp/content h2="So führen Sie ODS-Dateien mit Java zusammen" %}}

 Um die Datei ODS zusammenzuführen, verwenden wir[Aspose.Cells for Java](https://products.aspose.com/cells/java) API, eine funktionsreiche, leistungsstarke und benutzerfreundliche Fusionsplattform. Sie können die neueste Version direkt von herunterladen[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) und installieren Sie es in Ihrem Maven-basierten Projekt, indem Sie der pom.xml die folgenden Konfigurationen hinzufügen.
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zusammenführen von ODS-Dateien in Java" %}}
...
+ Laden Sie die erste ODS-Datei mit einer Instanz der Workbook-Klasse.
+ Laden Sie das zweite Dokument ODS mit einer Instanz der Workbook-Klasse.
+ Dateien mit der Methode combin() zusammenführen.
+ Speichern Sie die zusammengeführte Datei ODS im angegebenen Pfad
...
{{% blocks/products/pf/agp/code-block title="ODS-Dateien zusammenführen – Java" offSpacer="" %}}
