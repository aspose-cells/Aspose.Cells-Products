...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in XLT mit Aspose.Cells. PHP OTS in XLT. PHP Speichern Sie OTS in XLT. Speichern Sie OTS mit PHP als XLT.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in XLT" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in XLT konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in XLT konvertieren.
...
1.  Konvertieren Sie OTS in XLT, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in XLT" %}}
