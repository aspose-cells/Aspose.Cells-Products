---
title: 保護鎖XLSX文檔via Java
weight: 1870
description: Java 示例代碼，用於在 JSP/JSF 應用程序和桌面應用程序的 Java 運行時環境中使用密碼鎖定 XLSX 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="加密 XLSX 文件 via Java" h2="使用 .NET 庫使用密碼保護 Excel 電子表格，包括 XLSX 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. 通過實例化 Workbook 類加載 XLSX 文件
1. 使用帶有 ProtectionType 和 Password 的 protect(..) 方法
1. 通過save()方法保存被保護的XLSX文件
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="免費應用程序保護 XLSX" sectionDescription="查看我們的現場演示[加密 XLSX 個文件](https://products.aspose.app/cells/protect/xlsx)具有以下好處。" >}}
