---
title:  Разблокировать XLSM документ via .NET
weight: 9810
description: C# исходный код для разблокировки защищенного паролем файла XLSM на платформах .NET Framework, .NET Core, Mono или Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Разблокировать электронную таблицу XLSM по номеру C#" h2="Снять защиту с XLSM с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Как разблокировать файл XLSM с помощью C#" %}}
 ...
 Чтобы снять защиту с файла XLSM, мы будем использовать
