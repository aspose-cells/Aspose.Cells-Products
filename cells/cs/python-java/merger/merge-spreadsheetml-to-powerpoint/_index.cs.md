---
title: Sloučit SPREADSHEETML do POWERPOINT – Zkombinujte SPREADSHEETML do POWERPOINT v Python
url: /cs/python-java/merger/merge-spreadsheetml-to-powerpoint/ 
description: Aspose Excel. Python Aspose.Cells. Sloučte SPREADSHEETML do formátu uložení POWERPOINT. Python Zkombinujte SPREADSHEETML s formátem POWERPOINT. Sloučit SPREADSHEETML do POWERPOINT v Python. SPREADSHEETML Sloučit.
...
{{% cells-merger title="Ukázkový kód pro sloučení SPREADSHEETML do POWERPOINT v Python" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit SPREADSHEETML do POWERPOINT přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit SPREADSHEETML do POWERPOINT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
