---
title: Slå samman HTML till XLSX - Kombinera HTML till XLSX i C#
url: /sv/net/merger/merge-html-to-xlsx/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge HTML till XLSX sparaformat. C# Kombinera HTML till XLSX format. Slå samman HTML till XLSX i C#. HTML Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman HTML till XLSX i C# Online gratis" %}}

Följande exempel visar hur man slår samman HTML till XLSX i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman HTML till XLSX. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen XLSX. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman HTML till XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman HTML till XLSX i C#" InputFormat="html" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman HTML till XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman HTML till XLSX programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman HTML till XLSX" %}}
