---
title: Bộ chuyển đổi Java sang AZW3 - XLS sang AZW3
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển Java một phương pháp tích hợp đầy đủ để chuyển đổi XLS sang định dạng AZW3, cho phép lưu dữ liệu XLS vào định dạng AZW3 một cách liền mạch bằng cách sử dụng thư viện Aspose.Cells, tất cả thông qua mã Java hiệu quả và có thể tùy chỉnh.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS thành AZW3 trong Java" h2="Thư viện tốc độ cao Java dùng để chuyển đổi XLS sang AZW3. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất XLS, AZW3 và nhiều định dạng khác bằng cách sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="AZW3" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS vào AZW3 trong Java" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLS sang AZW3 trong Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản sau để chuyển đổi XLS sang AZW3. Tải lên tệp XLS của bạn, sau đó chỉ cần lưu nó dưới dạng tệp AZW3. Đối với cả việc đọc XLS và ghi AZW3, bạn đều có thể sử dụng tên tệp đầy đủ. Nội dung và định dạng đầu ra của AZW3 sẽ giống hệt với tài liệu XLS gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ví dụ mã để chuyển đổi XLS sang AZW3" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="azw3" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS sang AZW3 via Java" %}}

{{% blocks/products/pf/agp/text %}}

Bạn cần chuyển đổi các tệp XLS sang AZW3 bằng lập trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi XLS sang AZW3 chỉ với vài dòng mã.
...
1.  Chuyển đổi XLS sang AZW3 bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi từ XLS sang AZW3.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện Java để chuyển đổi XLS sang AZW3" %}}
{{% blocks/products/pf/agp/text %}}
