...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer le bouton dans le fichier Excel via C#" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addbutton) pour insérer un bouton dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer le bouton - C#" offSpacer="" %}}
