...
{{% blocks/products/pf/agp/content h2="Как вставить TextBox в файл Excel, используя Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке TextBox в файл Excel через Python" %}}
...
+ Используйте метод add коллекции фигур, чтобы вставить TextBox в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить текстовое поле — Python" offSpacer="" %}}
