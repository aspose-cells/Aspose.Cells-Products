---
title: Cree archivos ODS (Openoffice / Lbreoffice) a través de C++ 
url: /es/cpp/create-ods/ 
description: C++ Código de ejemplo para generar archivos ODS (Openoffice/Lbreoffice). Utilice este código para crear archivos ODS (Openoffice/Lbreoffice) dentro de la aplicación basada en C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crear archivo ODS a través de C++" h2="Creación de hojas de cálculo ODS (Openoffice / Lbreoffice) nativas y de alto rendimiento mediante programación sin Micorsoft Office utilizando la biblioteca C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/code-block title="El siguiente código fuente muestra cómo crear un archivo ODS (Openoffice / Lbreoffice) usando C++." offSpacer="" %}}
...
Una biblioteca de programación de hojas de cálculo de Excel capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir archivos ODS (Openoffice / Lbreoffice). C++ Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS y más, lo que lo convierte en la opción perfecta para intercambiar documentos en formatos estándar de la industria.
