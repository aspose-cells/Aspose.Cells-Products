---
title: C# XLSX to MHT - Online XLSX to MHT Converter
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Online Gratis C# Ubah XLSX menjadi format penyimpanan MHT. C# XLSX ke format MHT. Simpan XLSX ke MHT C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi MHT di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi XLSX menjadi MHT. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, MHT, dan banyak format lainnya pada Kerangka .NET, .NET Inti atau Mono Platform." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke MHT di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX ke MHT di C#.
...
{{% blocks/products/pf/agp/content h2="Cara Konversi XLSX ke MHT via C#" %}}
...
{{% blocks/products/pf/agp/content h2="Pustaka C# untuk mengonversi XLSX menjadi MHT" %}}
