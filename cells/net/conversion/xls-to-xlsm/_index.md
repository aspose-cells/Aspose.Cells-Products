...
description: Sample code for XLS to XLSM C# conversion. Use API example code for batch XLS files to XLSM conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XLS to XLSM C# Conversion" offSpacer="" %}}
