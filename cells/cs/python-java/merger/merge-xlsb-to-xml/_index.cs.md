...
url: /cs/python-java/merger/merge-xlsb-to-xml/ 
...
Následující příklad ukazuje, jak sloučit XLSB do XML v Aspose.Cells for Python via Java.
...
Potřebujete sloučit XLSB do XML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
