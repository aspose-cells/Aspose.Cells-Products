---
title: Konvertieren Sie FODS in PDF über Java 

description: Beispiel-Umwandlungscode Java für das FODS-Format in eine PDF-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in PDF innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie FODS in PDF über Java" h2="Konvertierung von FODS in PDF Java zum Konvertieren einzelner oder mehrerer Seiten in PDF mithilfe der lokalen Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie FODS in PDF mit Java" %}}

 Um FODS in PDF zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von FODS in PDF über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können FODS-Dateien in nur wenigen Codezeilen problemlos in PDF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die FODS-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit PDF-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende PDF-Datei
...
{{% blocks/products/pf/agp/code-block title="FODS-zu-PDF-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die FODS-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.fods");
// FODS als PDF speichern
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS-in-PDF-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie FODS in PDF](https://products.aspose.app/cells/conversion/fods-to-pdf) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre FODS-Datei hoch, sie wird sofort in PDF konvertiert." >}}
