...
description: Aspose Excel. Chuyển đổi PRN sang EXCEL nhanh chóng và dễ dàng với Aspose.Cells. Python PRN sang EXCEL. Python Lưu PRN vào EXCEL. Lưu PRN dưới dạng EXCEL bằng Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển PRN sang EXCEL trong Python" h2="Thư viện Python tốc độ cao để chuyển đổi PRN sang EXCEL. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất PRN, EXCEL và nhiều định dạng khác sử dụng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi PRN sang EXCEL bằng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu PRN vào EXCEL số Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi PRN sang EXCEL trong Python.
...
{{% cells-convert title="Mã mẫu để chuyển đổi PRN sang EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển PRN sang EXCEL" %}}
