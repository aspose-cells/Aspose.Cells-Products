...
{{% blocks/products/pf/agp/content h2="Преобразование XML в TIFF с использованием C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в TIFF в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат TIFF в формате C#.
...
1.  Преобразовать XML в формат TIFF, вызвав метод Workbook.Save.
