---
title: Gộp XLTM vào ETT - Gộp XLTM vào ETT vào C++
url: /vi/cpp/merger/merge-xltm-to-ett/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất XLTM thành định dạng lưu ETT. C++ Kết hợp XLTM thành định dạng ETT. Hợp nhất XLTM với ETT vào C++. XLTM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLTM vào ETT vào C++" %}}

Ví dụ sau đây minh họa cách hợp nhất XLTM với ETT trong Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XLTM với ETT. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp ETT. Nếu bạn phát triển mã theo số C++, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C++ hợp nhất XLTM với ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp XLTM vào ETT năm C++" InputFormat="xltm" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ để hợp nhất XLTM vào ETT" %}}
