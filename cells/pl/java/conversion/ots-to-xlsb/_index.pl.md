...
description: Aspose Excel. Konwertuj OTS na XLSB szybko i łatwo za pomocą Aspose.Cells. Java OTS na XLSB. Java Zapisz OTS na XLSB. Zapisz OTS jako XLSB, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS pod numerem XLSB w Java" %}}

Poniższy przykład ilustruje sposób konwersji OTS na XLSB w Java.
...
Chcesz programowo przekonwertować pliki OTS na XLSB? Programiści Java mogą z łatwością przekonwertować OTS na XLSB w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na XLSB" %}}
{{% blocks/products/pf/agp/text %}}
