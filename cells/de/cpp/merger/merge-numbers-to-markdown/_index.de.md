...
Befolgen Sie die einfachen Schritte, um NUMBERS in MARKDOWN zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei MARKDOWN. Wenn Sie Code in C++ entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C++, das NUMBERS mit MARKDOWN zusammenführt.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie NUMBERS programmgesteuert mit MARKDOWN zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="C++-Bibliothek zum Zusammenführen von NUMBERS zu MARKDOWN" %}}
