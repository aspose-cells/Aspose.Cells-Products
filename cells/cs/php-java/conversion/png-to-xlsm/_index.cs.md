---
title: Konvertor PHP PNG až XLSM - PNG až XLSM
description: Aspose Excel. Převeďte PNG na XLSM rychle a snadno pomocí Aspose.Cells. PHP PNG na XLSM. PHP Uložte PNG na XLSM. Uložte XLSM jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na XLSM přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na XLSM programově? Vývojáři PHP mohou snadno načíst a převést PNG na XLSM v několika řádcích kódu.
...
1.  Převeďte PNG na XLSM voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na XLSM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na XLSM" %}}
