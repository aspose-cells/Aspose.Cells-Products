---
title: A ODS-ODS-es számok egyesítése – a ODS-es és a ODS-es számok egyesítése a C++-ben
url: /hu/cpp/merger/merge-ods-to-ods/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítés ODS ODS mentési formátumba. C++ A ODS és a ODS formátum kombinálása. Egyesítse a ODS-ODS-et a C++-ben. ODS Egyesítse.
...
{{< blocks/products/pf/i18n/upper-banner h1="A ODS-es szám egyesítése a ODS-es számmal a C++-es számon keresztül" h2="Nagysebességű C++ könyvtár a ODS és ODS egyesítéséhez. Használja a API-es excel konverziónkat magas szintű, platformfüggetlen szoftver fejlesztésére a C++-ben. Ez egy professzionális szoftvermegoldás Excel, CSV, OpenOffice, PDF, HTML, image és sok más excel formátum importálásához és exportálásához." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="ODS" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="A ODS és a ODS egyesítése a C++ használatával" %}}
 ...
 Hogyan egyesíthetem a ODS és a ODS számokat? A Aspose.Cells for C++ könyvtárral egyszerűen egyesítheti a ODS-et a ODS-es számokkal programozottan néhány sornyi kóddal.[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. C++ Excel API nem csak a táblázatformátumok között konvertál, hanem Excel fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, CSV, CSV, CSV, CSV, CSV, SVG, és így tovább, SVG P, 8 PT a választás,3,8 ipari szabvány szerinti dokumentumok cseréjére formátumok. A legújabb verziót közvetlenül letöltheti, csak nyissa meg[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/) csomagkezelő, keresse meg a Aspose.Cells.Cpp címet, és telepítse. A következő parancsot is használhatja a Package Manager konzolból.
...
A következő példa bemutatja a ODS és a ODS egyesítését a Aspose.Cells for C++ számban.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a ODS és ODS egyesítéséhez" %}}
