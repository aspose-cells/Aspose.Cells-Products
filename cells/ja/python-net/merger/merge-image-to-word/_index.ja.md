...
url: /ja/python-net/merger/merge-image-to-word/ 
...
次の例は、Aspose.Cells for Python via .NET の IMAGE を WORD に結合する方法を示しています。
...
プログラムで IMAGE を WORD にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
