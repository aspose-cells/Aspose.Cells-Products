---
title: Java IMAGE en JSON - Convertisseur IMAGE en JSON
description: Aspose Exceller. Java Aspose.Cells. IMAGE en JSON dans Java. Java Convertir IMAGE en format de sauvegarde JSON. Java IMAGE au format JSON. Enregistrez l’IMAGE au JSON Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE au JSON dans Java" %}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir une image en JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers IMAGE en JSON par programme ? Les développeurs Java peuvent facilement convertir IMAGE en JSON en quelques lignes de code seulement.
