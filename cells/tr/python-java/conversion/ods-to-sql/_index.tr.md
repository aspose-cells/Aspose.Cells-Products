---
title: Python ODS'den SQL'e - ODS'den SQL'e Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile ODS'i hızlı ve kolay bir şekilde SQL'e dönüştürün. Python ODS'i SQL'e dönüştürün. Python ODS'i SQL'e kaydedin. ODS'i Python'i kullanarak SQL olarak kaydedin.
...
{{% cells-convert title="ODS\'i SQL\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="sql" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i Python aracılığıyla SQL\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

ODS dosyalarını programlı olarak SQL'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla ODS'i kolayca yükleyebilir ve SQL'e dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i SQL\'e dönüştürmek için Python kitaplığı" %}}
