---
title: EXCEL を Python 経由で XPS に結合
...
次の例は、EXCEL を Python の XPS にマージする方法を示しています。
...
{{% cells-merger title="オンラインでEXCELをXPSにマージする無料アプリ" InputFormat="xlsx" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
