...
EXCEL dosyalarını programlı olarak XLT'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip XLT'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını XLT formatına dönüştürün.
