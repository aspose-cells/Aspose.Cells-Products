...
description: Aspose Excel. Convierta XML a JPG rápida y fácilmente con Aspose.Cells. Python XML a JPG. Python Guardar XML en JPG. Guarde XML como JPG usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XML en JPG en Python" %}}

El siguiente ejemplo demuestra cómo convertir XML a JPG en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir XML a JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}
