...
{{% blocks/products/pf/agp/content h2="Jak wstawić owal do pliku Excel za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić plik owalny do programu Excel za pośrednictwem Python" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addOval(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić Owal w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw Owal - Python" offSpacer="" %}}
