---
title: Merge TXT to XLSM - Combine TXT to XLSM in C#
url: /net/merger/merge-txt-to-xlsm/ 
description: Aspose Excel. Free Online Merge TXT to XLSM saveformat. C# Combine TXT to XLSM format. Merge TXT to XLSM in C#. TXT Merge.
keywords: [Aspose Excel., C# Aspose.Cells., Merge TXT to XLSM saveformat via C#., Free Online Merge TXT to xlsm in C#., C# Combine TXT to XLSM Online for Free., TXT Merge]
---
...
The following example demonstrates how to merge TXT to XLSM in Aspose.Cells for .NET.
...
{{% cells-merger title="Free Online to Merge TXT to XLSM in C#" InputFormat="txt" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="How to Merge TXT to XLSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to merge TXT to XLSM programmatically? A basic document merging and concatenating with [Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs can be done with just few lines of code.
