---
title: Konwertuj XLT na FODS przez C#
url: /pl/net/conversion/xlt-to-fods/
description: Przykładowy kod konwersji xlt do fods C#. Użyj przykładowego kodu API dla plików wsadowych xlt do konwersji fods w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na FODS za pomocą C#" %}}

 Aby przekonwertować XLT na FODS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na FODS za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki XLT do FODS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem FODS jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku FODS
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLT na FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="fods" IsLandingPage="true" %}}
