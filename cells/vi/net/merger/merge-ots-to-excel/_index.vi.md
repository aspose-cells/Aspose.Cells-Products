---
title: Gộp OTS thành EXCEL - Gộp OTS thành EXCEL trong C#
url: /vi/net/merger/merge-ots-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất định dạng lưu OTS thành EXCEL. C# Kết hợp định dạng OTS sang EXCEL. Hợp nhất OTS thành EXCEL theo số C#. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS thành EXCEL theo số C#" %}}

Ví dụ sau đây minh họa cách hợp nhất OTS thành EXCEL trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất OTS thành EXCEL. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp EXCEL. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất OTS với EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp OTS thành EXCEL C#" InputFormat="ots" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp OTS thành EXCEL qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất OTS thành EXCEL theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để ghép OTS thành EXCEL" %}}
