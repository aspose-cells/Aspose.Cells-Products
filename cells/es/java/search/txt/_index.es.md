---
title:  Buscar TXT documento sin abrir via Java
weight: 1200
description: Java código de muestra para buscar palabras con patrón en el archivo TXT en Java Entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Buscar TXT Formatos en Java" h2="Búsqueda de documentos TXT nativa y de alto rendimiento utilizando las API Aspose.Cells for Java del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo buscar el archivo TXT usando Java" %}}
...
+ Acceda a la primera hoja de trabajo en el archivo TXT.
...
{{% blocks/products/pf/agp/code-block title="Buscar TXT Archivos - Java" offSpacer="" %}}
