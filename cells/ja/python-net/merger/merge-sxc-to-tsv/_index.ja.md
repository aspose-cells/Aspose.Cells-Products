---
title:  SXC を Python 経由で TSV に結合
url: /ja/python-net/merger/merge-sxc-to-tsv/ 
description: SXC を TSV にオンラインで無料で結合します。無料オンラインSXCからTSV合併。 SXC を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、SXC を Python の TSV にマージする方法を示しています。
...
{{% cells-merger title="オンラインでSXCをTSVにマージする無料アプリ" InputFormat="sxc" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
