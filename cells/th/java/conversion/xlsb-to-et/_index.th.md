...
description: Aspose เอ็กเซล. แปลง XLSB เป็น ET อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Java XLSB เป็น ET Java บันทึก XLSB ถึง ET. บันทึก XLSB เป็น ET โดยใช้ Java
...
{{% blocks/products/pf/agp/content h2="บันทึก XLSB ไปที่ ET ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLSB เป็น ET ใน Java
...
{{% blocks/products/pf/agp/content h2="วิธีการแปลง XLSB เป็น ET via Java" %}}
