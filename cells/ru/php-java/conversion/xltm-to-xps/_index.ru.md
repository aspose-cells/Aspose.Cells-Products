...
description: Aspose Эксель. Преобразуйте XLTM в XPS быстро и легко с помощью Aspose.Cells. PHP XLTM в XPS. PHP Сохраните XLTM в XPS. Сохраните XLTM как XPS с помощью PHP.
...
Нужно программно преобразовать файлы XLTM в XPS? Разработчики PHP могут легко загрузить и преобразовать XLTM в XPS всего за несколько строк кода.
...
1.  Преобразуйте XLTM в XPS, вызвав метод сохранения книги.
1.  Получите результат преобразования XLTM в XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования XLTM в XPS" %}}
