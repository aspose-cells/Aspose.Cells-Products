---
title: Python XLTM إلى PRN - عبر الإنترنت من XLTM إلى محول PRN
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل XLTM إلى PRN saveformat. Python XLTM إلى تنسيق PRN. وفر XLTM إلى PRN Python.
...
{{% blocks/products/pf/agp/content h2="حوّل XLTM إلى PRN في Python" %}}

 كيف أقوم بتحويل XLTM إلى PRN؟ مع Aspose.Cells for Python عبر مكتبة NET ، يمكنك بسهولة تحويل XLTM إلى PRN برمجيًا ببضعة سطور من التعليمات البرمجية.[Aspose.Cells for Python عبر NET](https://pypi.org/project/aspose-cells-python/)قادر على بناء تطبيقات عبر الأنظمة الأساسية مع القدرة على إنشاء وتعديل وتحويل وعرض وطباعة جميع ملفات Excel. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات ، بل يمكنه أيضًا عرض ملفات Excel كصور ، PDF ، HTML ، ODS ، CSV ، SVG ، JSON ، WORD ، PPT والمزيد ، مما يجعله خيارًا مثاليًا لتبادل المستندات في معايير الصناعة الأشكال.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="وفر XLTM إلى PRN في Python عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل XLTM إلى PRN في Python via NET.
...
هل تحتاج إلى تحويل ملفات XLTM إلى PRN برمجيًا؟ يمكن للمطورين Python تحميل وتحويل XLTM إلى PRN بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل XLTM إلى PRN باستدعاء طريقة Workbook.save.
