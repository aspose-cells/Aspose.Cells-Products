...
{{% blocks/products/pf/agp/content h2="Convertir TABDELIMITED a PPTX en Python" %}}
...
El siguiente ejemplo demuestra cómo convertir TABDELIMITED a PPTX en Python via NET.
