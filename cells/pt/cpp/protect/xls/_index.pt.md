---
title: Proteja e bloqueie o documento XLS via C++ 
weight: 8760
url: /pt/cpp/protect/xls/ 
description: C++ código de exemplo para bloquear arquivo XLS usando senha em C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Criptografar arquivos XLS via C++" h2="Planilhas Excel protegidas por senha, incluindo o formato XLS, usando a biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para proteger arquivos XLS por meio de C++" %}}
...
1. Carregar arquivo XLS usando a classe IWorkbook1. Use o método Protect(..) com ProtectionType e Password1. Salve o arquivo XLS protegido pelo método Save()
