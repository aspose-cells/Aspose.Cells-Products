---
title: Converti SPREADSHEETML in FODS tramite Java 
url: /it/java/conversion/spreadsheetml-to-fods/ 
description: Esempio di codice di conversione Java per il formato SPREADSHEETML in file FODS. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in FODS all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti SPREADSHEETML in FODS tramite Java" h2="Conversione da SPREADSHEETML a FODS Java per convertire pagine singole o multiple in FODS utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire SPREADSHEETML in FODS usando Java" %}}

 Per eseguire il rendering di SPREADSHEETML in FODS, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire SPREADSHEETML in FODS tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente file SPREADSHEETML in FODS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file SPREADSHEETML con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione FODS e SaveFormat come parametri1. Controllare il percorso specificato per il file FODS risultante
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML in FODS Java codice sorgente di conversione" offSpacer="" %}}

```cs
// caricare il file SPREADSHEETML in un'istanza di Workbook
Workbook book = new Workbook("template.spreadsheetml");
// salva SPREADSHEETML come FODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live di conversione da SPREADSHEETML a FODS" sectionDescription="[Converti SPREADSHEETML in FODS](https://products.aspose.app/cells/conversion/spreadsheetml-to-fods) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file SPREADSHEETML, verrà convertito istantaneamente in FODS." >}}
