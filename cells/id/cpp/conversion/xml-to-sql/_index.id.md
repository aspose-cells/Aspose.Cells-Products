...
Perlu mengkonversi file XML ke SQL secara terprogram? Pengembang C++ dapat dengan mudah mengkonversi XML ke SQL hanya dengan beberapa baris kode.
...
1.  Konversikan XML ke SQL dengan memanggil metode Save().
