...
description: Aspose Excel. Konwertuj XML na ETT szybko i łatwo za pomocą Aspose.Cells. Python XML na ETT. Python Zapisz XML w ETT. Zapisz XML jako ETT, używając numeru Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XML na ETT za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XML w ETT pod numerem Python" %}}

Poniższy przykład ilustruje sposób konwersji XML na ETT w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji XML na ETT" %}}
