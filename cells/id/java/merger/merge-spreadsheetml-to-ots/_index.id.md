...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan SPREADSHEETML ke format simpan OTS. Java Gabungkan SPREADSHEETML ke format OTS. Gabungkan SPREADSHEETML ke OTS di Java. Gabungkan SPREADSHEETML.
...
{{% blocks/products/pf/agp/content h2="Gabungkan SPREADSHEETML ke OTS di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan SPREADSHEETML ke OTS di Java" InputFormat="xml" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SPREADSHEETML ke OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SPREADSHEETML ke OTS secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk menggabungkan SPREADSHEETML ke OTS" %}}
