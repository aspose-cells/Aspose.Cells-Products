...
description: Aspose Excel. C# Aspose.Cells. XLS to MHTML in C#. C# Convert XLS to MHTML saveformat. C# XLS to MHTML format. Save XLS to MHTML C#.
keywords: [Aspose Excel., C# Aspose.Cells., XLS to MHTML in C#., C# XLS to MHTML saveformat., XLS to MHTML C#., C# Convert XLS to MHTML]
---
...
{{% cells-convert title="Sample Code to Convert XLS to MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="mhtml" IsLandingPage="true" %}}
