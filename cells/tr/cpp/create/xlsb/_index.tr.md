...
description: Aspose Excel. Aspose.Cells for C++ kütüphanesi ile XLSB dosyalarını zahmetsizce oluşturun ve düzenleyin. Bu güçlü API, XLSB dosyalarını doğrudan C++ uygulamalarınız içinde oluşturmak, düzenlemek ve yönetmek için akıcı ve verimli bir çözüm sunarak, geliştiricilerin özel ihtiyaçlarını yüksek hassasiyetle karşılar.
...
1.  Çalışma kitabını Save() yöntemini kullanarak .xlsb dosyası olarak kaydedin.
