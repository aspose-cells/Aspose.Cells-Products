...
{{% blocks/products/pf/agp/content h2="So versehen Sie die Datei XLS mit einem Wasserzeichen mit Java" %}}
...
1.  Speichern Sie die Arbeitsmappe im Format XLS
...
{{% blocks/products/pf/agp/code-block title="Wasserzeichen zu XLS - Java hinzufügen" offSpacer="" %}}
