---
title: Python HTML 转 JSON - 在线 HTML 转 JSON 转换器
description: Aspose Excel。 Python Aspose.Cells。Python Aspose Cells。免费在线 Python 将 HTML 转换为 JSON 保存格式。 Python HTML 到 JSON 格式。将 HTML 保存为 JSON Python。
...
如何将 HTML 转换为 JSON？使用 Aspose.Cells for Python 库，您可以通过几行代码以编程方式轻松将 HTML 转换为 JSON。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Python Excel API不仅可以在电子表格格式之间进行转换，还可以将Excel文件渲染为图像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，从而使其成为行业交换文档的完美选择-标准格式。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="免费在线保存 HTML 至 JSON 于 Python" %}}

以下示例演示如何将 Python 中的 HTML 转换为 JSON。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 HTML 转换为 JSON。上传您的 HTML 文件，然后只需将其另存为 JSON 文件。对于 HTML 读取和 JSON 写入，您可以使用完全限定的文件名。输出 JSON 内容和格式将与原始 HTML 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免费应用程序和示例代码可在线将 HTML 转换为 JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="json" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 Python 将 HTML 转换为 JSON" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 HTML 文件转换为 JSON 吗？ Python 开发人员只需几行代码即可轻松加载和转换 HTML 到 JSON。
...
1. 使用工作簿实例加载 HTML 文件。
1. 通过调用Workbook.save方法将HTML转换为JSON。
1. 获取HTML到JSON的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python库将HTML转换为JSON" %}}
