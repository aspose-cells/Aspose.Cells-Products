...
description: Aspose Excel. C++ Aspose.Cells. Merge SPREADSHEETML to HTML saveformat. C++ Combine SPREADSHEETML to HTML format. Merge SPREADSHEETML to HTML in C++. SPREADSHEETML Merge.
...
{{% blocks/products/pf/agp/content h2="Merge SPREADSHEETML to HTML in C++" %}}
...
{{% cells-merger title="Sample Code to Merge SPREADSHEETML to HTML in C++" InputFormat="xml" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
