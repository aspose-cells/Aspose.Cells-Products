...
{{% blocks/products/pf/agp/content h2="Sla OTS op in JPEG in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar JPEG converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar JPEG via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar JPEG? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar JPEG met slechts een paar regels code.
