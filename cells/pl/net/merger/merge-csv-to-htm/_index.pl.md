---
title:  Połącz CSV z HTM przez C#
url: /pl/net/merger/merge-csv-to-htm/ 
description: Połącz CSV z HTM Online za darmo. Bezpłatnie online CSV do połączenia HTM. Połącz CSV z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak scalić CSV z HTM w C#.
...
{{% cells-merger title="Darmowa aplikacja do łączenia CSV z HTM on-line" InputFormat="csv" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
