...
description: Aspose Excel. Konwertuj XLSX na JPEG szybko i łatwo za pomocą Aspose.Cells. PHP XLSX na JPEG. PHP Zapisz XLSX na JPEG. Zapisz XLSX jako JPEG używając PHP.
...
Chcesz programowo przekonwertować pliki XLSX na JPEG? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na JPEG w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSX na numer JPEG, wywołując metodę zapisu skoroszytu.
