...
L'esempio seguente mostra come unire XML a TXT in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Hai bisogno di unire XML a TXT a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Le API possono essere eseguite con poche righe di codice.
