---
title: Conversor PHP SXC para PPTX - SXC para PPTX
description: Aspose Excel. Converta SXC em PPTX de forma rápida e fácil com Aspose.Cells. PHP SXC em PPTX. PHP Salve SXC em PPTX. Salve SXC como PPTX usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em PPTX via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em PPTX programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em PPTX em apenas algumas linhas de código.
...
1.  Converta SXC em PPTX chamando o método save da pasta de trabalho.
