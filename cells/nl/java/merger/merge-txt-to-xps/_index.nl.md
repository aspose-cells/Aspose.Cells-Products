...
description: Aspose Excel. Java Aspose.Cells. Voeg TXT samen met het opslagformaat XPS. Java Combineer het formaat TXT met XPS. Voeg TXT samen met XPS in Java. TXT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met XPS in Java" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met XPS in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TXT samen te voegen met XPS. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand XPS. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld Java waarin TXT wordt samengevoegd met XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om TXT samen te voegen met XPS in Java" InputFormat="txt" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u TXT samenvoegt met XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met XPS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om TXT samen te voegen met XPS" %}}
