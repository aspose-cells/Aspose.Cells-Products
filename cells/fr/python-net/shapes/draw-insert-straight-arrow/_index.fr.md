---
title:  Comment dessiner ou insérer une flèche droite dans Excel à l'aide de Python via .Net
weight: 10
description: Python via Code source .Net pour dessiner ou insérer une flèche droite dans Excel.
...
{{% blocks/products/pf/agp/content h2="Comment insérer une flèche droite dans un fichier Excel à l\'aide de Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une flèche droite dans un fichier Excel à l\'aide de Python via .Net" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) pour insérer une flèche droite dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer une flèche droite - Python via .Net" offSpacer="" %}}
