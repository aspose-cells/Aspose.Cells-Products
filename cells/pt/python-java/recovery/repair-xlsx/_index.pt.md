---
title: Reparar arquivo xlsx via Python
url: /pt/python-java/recovery/repair-xlsx/ 
description: Repare um arquivo xlsx corrompido usando Python. Ferramenta de recuperação para reparar arquivo xlsx corrompido no aplicativo Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Recupere o arquivo XLSX via Python" h2="Crie seu próprio aplicativo Python para reparar arquivos xlsx usando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Como reparar arquivo xlsx usando Python" %}}
...
{{% cells-recovery title="Aplicativo gratuito para reparar o arquivo XLSX usando Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}    
