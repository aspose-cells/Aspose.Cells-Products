---
title: Cara menggambar atau menyisipkan bentuk siku ke excel menggunakan Python via .Net
weight: 10
description: Python via .Kode sumber bersih untuk memasukkan bentuk siku ke dalam Excel.
keywords: [Python Aspose.Cells., Python add elbow shape., Python insert elbow shape., Python create elbow shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan bentuk siku ke dalam Excel menggunakan Python via .Net" h2="Masukkan bentuk siku menggunakan Aspose.Cells\' API tanpa software apapun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Menyisipkan Bentuk Siku Ke File Excel Menggunakan Python via .Net" %}}

 Untuk memasukkan bentuk siku ke dalam file excel, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah menyisipkan bentuk siku ke file Excel menggunakan Python via .Net" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan tambahan shapecollection[metode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) untuk menyisipkan bentuk siku di lembar kerja yang dipilih.
...
{{% blocks/products/pf/agp/code-block title="Masukkan bentuk siku - Python via .Net" offSpacer="" %}}
