...
description: Aspose Excel. Converteer HTML snel en eenvoudig naar XML met Aspose.Cells. Java HTML naar XML. Java Sla HTML op in XML. Sla HTML op als XML met behulp van Java.
...
{{% blocks/products/pf/agp/content h2="Sla HTML op in XML in Java" %}}

Het volgende voorbeeld laat zien hoe u HTML naar XML converteert in Java.
...
Wilt u HTML-bestanden programmatisch naar XML converteren? Java-ontwikkelaars kunnen HTML eenvoudig in slechts een paar regels code naar XML converteren.
