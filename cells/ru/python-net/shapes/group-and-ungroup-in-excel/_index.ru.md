---
title: Группировать и разгруппировать фигуры в Excel с помощью Python via .Net
weight: 360
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по группировке и разгруппировке фигур в файле Excel с использованием Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Группировать и разгруппировать фигуры — Python via .Net via .NET" offSpacer="" %}}
