---
title: 添加或删除 XLSM 注释 via .NET
weight: 9890
description: C# 源代码，用于在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上添加和删除 XLSM 格式注释。
...
{{% blocks/products/pf/agp/code-block title="删除 XLSM - C# 中的注释" offSpacer="" %}}
