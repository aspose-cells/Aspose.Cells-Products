...
url: /it/python-java/merger/merge-xls-to-png/ 
...
L'esempio seguente mostra come unire XLS a PNG in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Devi unire XLS a PNG a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Le API possono essere eseguite con poche righe di codice.
