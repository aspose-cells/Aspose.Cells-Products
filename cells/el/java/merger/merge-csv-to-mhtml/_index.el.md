---
title:  Συγχώνευση CSV σε MHTML via Java
url: /el/java/merger/merge-csv-to-mhtml/ 
description: Συγχώνευση CSV σε MHTML Online δωρεάν. Δωρεάν Online CSV έως MHTML Συγχώνευση. Συγχώνευση CSV σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το CSV με το MHTML στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση CSV με MHTML σε απευθείας σύνδεση" InputFormat="csv" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
