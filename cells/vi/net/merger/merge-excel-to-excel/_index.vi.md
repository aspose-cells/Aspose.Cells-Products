---
title: Gộp EXCEL thành EXCEL - Gộp EXCEL thành EXCEL theo số C#
url: /vi/net/merger/merge-excel-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất định dạng lưu EXCEL thành EXCEL. C# Kết hợp định dạng EXCEL sang EXCEL. Hợp nhất EXCEL với EXCEL theo số C#. Hợp nhất EXCEL.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất EXCEL với EXCEL theo số C#" %}}

Ví dụ sau đây minh họa cách hợp nhất EXCEL với EXCEL trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất EXCEL với EXCEL. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp EXCEL. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất EXCEL với EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp EXCEL thành EXCEL trong C#" InputFormat="xlsx" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp EXCEL với EXCEL qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để gộp EXCEL vào EXCEL" %}}
