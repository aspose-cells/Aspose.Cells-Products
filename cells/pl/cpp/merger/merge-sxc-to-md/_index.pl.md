...
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online SXC do formatu zapisu MD. C++ Połącz SXC do formatu MD. Połącz SXC z MD w C++. SXC Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz SXC z MD w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć SXC z MD w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć SXC z MD. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku MD. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy SXC z MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online SXC z MD w C++" InputFormat="sxc" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć SXC z MD przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć numer SXC z MD? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia SXC z MD" %}}
