---
title: C# ODS से एसक्यूएल - ऑनलाइन ODS से एसक्यूएल कन्वर्टर
description: Aspose एक्सेल। C# Aspose.Cells. C# Aspose Cells. मुफ़्त ऑनलाइन C# ODS को एसक्यूएल सेवफॉर्मेट में कनवर्ट करें। C# ODS एसक्यूएल प्रारूप में। ODS को SQL C# में सहेजें।
...
{{% blocks/products/pf/agp/content h2="ODS को SQL में C# में निःशुल्क ऑनलाइन सहेजें" %}}

निम्नलिखित उदाहरण दर्शाता है कि C# में ODS को SQL में कैसे परिवर्तित किया जाए।
...
{{% cells-convert title="ODS को SQL ऑनलाइन में कनवर्ट करने के लिए निःशुल्क ऐप और नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="ODS को C# के माध्यम से एसक्यूएल में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

ODS फ़ाइलों को प्रोग्रामेटिक रूप से SQL में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में ODS को आसानी से एसक्यूएल में लोड और परिवर्तित कर सकते हैं।
...
{{% blocks/products/pf/agp/content h2="ODS को SQL में कनवर्ट करने के लिए C# लाइब्रेरी" %}}
