---
title: "NUMBERS konvertálása XPS-re a következőn keresztül: Java "

description: Minta Java konverziós kód NUMBERS formátumhoz XPS-fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok XPS-re történő exportálására bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="NUMBERS konvertálása XPS-re a következőn keresztül: Java" h2="NUMBERS XPS Java konverzió egyetlen vagy több oldal XPS formátumba konvertálásához a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="NUMBERS konvertálása XPS-re a következővel: Java" %}}

 Ahhoz, hogy a NUMBERS-t XPS-re rendereljük, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések NUMBERS XPS-re konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak NUMBERS fájlt XPS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. NUMBERS fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XPS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XPS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="NUMBERS–XPS Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a NUMBERS fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.numbers");
// mentse el a NUMBERS-t XPS-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS XPS konverziós élő bemutatók" sectionDescription="[NUMBERS konvertálása XPS-re](https://products.aspose.app/cells/conversion/numbers-to-xps) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel NUMBERS fájlját, és azonnal XPS-re konvertálódik." >}}
