...
description: Aspose เอ็กเซล. แปลง JPG เป็น EXCEL อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ JPG เป็น EXCEL C++ บันทึก JPG เป็น EXCEL บันทึก JPG เป็น EXCEL โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก JPG เป็น EXCEL ใน C++" %}}
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง JPG เป็น EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xlsx" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง JPG เป็น EXCEL โดยการเรียกใช้เมธอด Save()
1. รับผลการแปลงจาก JPG เป็น EXCEL

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ ไลบรารี่สำหรับแปลง JPG เป็น EXCEL" %}}
