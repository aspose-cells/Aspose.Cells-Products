---
title: C++ MHTML en MHT - Convertisseur en ligne MHTML en MHT
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertissez MHTML en format de sauvegarde MHT. C++ MHTML au format MHT. Enregistrez MHTML à MHT C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez MHTML à MHT en C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir MHTML en MHT en C++.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir MHTML en MHT en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="mht" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHTML en MHT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers MHTML en MHT par programmation ? Les développeurs de C++ peuvent facilement convertir MHTML en MHT en quelques lignes de code seulement.
...
1.  Convertissez MHTML en MHT en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de MHTML en MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="bibliothèque C++ pour convertir MHTML en MHT" %}}
