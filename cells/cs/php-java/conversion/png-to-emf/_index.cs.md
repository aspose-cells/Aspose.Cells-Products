---
title: Konvertor PHP PNG až EMF - PNG až EMF
description: Aspose Excel. Převeďte PNG na EMF rychle a snadno pomocí Aspose.Cells. PHP PNG na EMF. PHP Uložte PNG na EMF. Uložte EMF jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na EMF přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na EMF programově? Vývojáři PHP mohou snadno načíst a převést PNG na EMF v několika řádcích kódu.
...
1.  Převeďte PNG na EMF voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na EMF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na EMF" %}}
