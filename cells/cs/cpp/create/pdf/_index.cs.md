...
description: PDF tvůrce. Vytvořte soubory PDF v kódu C++. Vygenerujte soubory PDF pomocí aplikace C++.
---
...
1.  Uložte sešit jako soubor .pdf pomocí metody Save().
