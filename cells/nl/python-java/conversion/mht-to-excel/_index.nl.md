...
description: Aspose Excel. Converteer MHT snel en eenvoudig naar EXCEL met Aspose.Cells. Python MHT naar EXCEL. Python MHT opslaan in EXCEL. Sla MHT op als Excel met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MHT naar EXCEL in Python" h2="Snelle Python-bibliotheek voor het converteren van MHT naar EXCEL. Dit is een professionele softwareoplossing voor het importeren en exporteren van MHT, EXCEL en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Sla MHT op in EXCEL in Python" %}}

Het volgende voorbeeld laat zien hoe u MHT naar EXCEL converteert in Python.
