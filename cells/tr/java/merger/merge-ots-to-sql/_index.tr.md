---
title: OTS'yi SQL ile Birleştir - Java'de OTS'yi SQL ile birleştirin
url: /tr/java/merger/merge-ots-to-sql/ 
description: Aspose excel. Java Aspose.Cells. OTS'yi SQL saveformat'a Ücretsiz Çevrimiçi Birleştirme. Java OTS'yi SQL biçimiyle birleştirin. Java'de OTS'yi SQL ile birleştirin. OTS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="Java Online\'da OTS\'yi SQL ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de OTS ile SQL'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

OTS'yi SQL ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından SQL dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. OTS'yi SQL ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java\'de OTS\'yi SQL ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ots" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi SQL via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

OTS'yi programlı olarak SQL ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi SQL ile birleştirmek için Java kitaplığı" %}}
