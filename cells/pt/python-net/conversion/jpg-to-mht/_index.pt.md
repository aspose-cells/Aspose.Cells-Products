---
title: Python JPG para MHT - Conversor de JPG para MHT
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores Python uma abordagem totalmente integrada para converter JPG para o formato MHT, permitindo o salvamento perfeito de dados JPG no formato MHT usando a biblioteca Aspose.Cells, tudo por meio de código Python eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Converter JPG para MHT na biblioteca Excel Python" %}}

 Como faço para converter JPG para MHT? Com as bibliotecas Aspose.Cells, for Python e NET, você pode converter facilmente JPG para MHT programaticamente com algumas linhas de código.[Aspose.Cells for Python através de NET](https://pypi.org/project/aspose-cells-python/)é capaz de construir aplicativos multiplataforma com a capacidade de gerar, modificar, converter, renderizar e imprimir todos os arquivos Excel. Python Excel API não apenas converte formatos de planilha, mas também pode renderizar arquivos Excel como imagens, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT e muito mais, tornando-o a escolha perfeita para troca de documentos em formatos padrão da indústria.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Salvar JPG em MHT na Biblioteca do Excel Python" %}}

O exemplo a seguir demonstra como converter JPG para MHT na biblioteca do Excel Python.
{{% blocks/products/pf/agp/text %}}

Siga os passos simples para converter JPG para MHT. Carregue seu arquivo JPG e salve-o como um arquivo MHT. Tanto para leitura de JPG quanto para gravação de MHT, você pode usar nomes de arquivo totalmente qualificados. O conteúdo e a formatação do arquivo MHT resultante serão idênticos ao documento JPG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter JPG em MHT usando a biblioteca Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="mht" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como converter JPG para MHT" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPG para MHT programaticamente? Os desenvolvedores do Python podem facilmente carregar e converter JPG para MHT com apenas algumas linhas de código.
...
1.  Converta JPG para MHT chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de JPG para MHT.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Biblioteca do Excel para converter JPG em MHT" %}}
