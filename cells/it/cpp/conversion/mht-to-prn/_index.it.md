...
description: Aspose Excel. Converti MHT in PRN in modo rapido e semplice con Aspose.Cells. C++ MHT in PRN. C++ Salva MHT su PRN. Salva MHT come PRN utilizzando C++.
...
{{% blocks/products/pf/agp/content h2="Converti MHT in PRN utilizzando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salva MHT nel PRN allo C++" %}}
...
{{% cells-convert title="Codice di esempio per convertire MHT in PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="prn" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Come convertire MHT in PRN tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file MHT in PRN a livello di codice? C++ gli sviluppatori possono convertire facilmente MHT in PRN in poche righe di codice.
...
1.  Converti MHT in PRN chiamando il metodo Save().
