---
title: Python via .Net kullanarak Excel'e kavisli ok şekli nasıl çizilir veya eklenir?
weight: 10
description: Python via .Net kaynak kodu, Excel'e kavisli ok şekli eklemek için.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via .Net\'i kullanarak kavisli ok şeklini Excel\'e ekleyin" h2="Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan Aspose.Cells\' API\'i kullanarak kavisli ok şekli ekleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via .Net Kullanarak Excel Dosyasına Eğri Ok Şekli Nasıl Eklenir?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net kullanarak Excel dosyasına kavisli ok şekli ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Shapecollection'ın eklentisini kullanın[yöntem](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)Seçilen çalışma sayfasına kavisli bir ok şekli eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Kavisli ok şeklini ekleyin - Python via .Net" offSpacer="" %}}
