---
title:  Hur ritar eller infogar jag en rak pil i Excel med Python via .Net
weight: 10
description: Python via .Net-källkod för att rita eller infoga en rak pil i Excel.
...
{{% blocks/products/pf/agp/content h2="Hur man infogar en rak pil i Excel-fil med Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga en rak pil i Excel-fil med Python via .Net" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens tillägg[metod](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) för att infoga en rak pil i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Sätt in rak pil - Python via .Net" offSpacer="" %}}
