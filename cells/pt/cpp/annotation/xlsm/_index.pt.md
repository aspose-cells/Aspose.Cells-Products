---
title:  Adicionar ou remover anotação XLSM via C++
weight: 2860
description: C++ código de exemplo para excluir anotações de formato XLSM no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
...
{{% blocks/products/pf/agp/code-block title="Adicione comentários em XLSM - C++" offSpacer="" %}}
