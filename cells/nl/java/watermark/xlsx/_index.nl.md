---
title:  Watermerk XLSX document via Java
weight: 7680
description: Java voorbeeldcode voor het toevoegen of verwijderen van een watermerk aan het XLSX-bestand op Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg tekstwatermerk toe aan XLSX via Java" h2="Bouw uw eigen Java-apps om XLSX-bestanden van een watermerk te voorzien met behulp van server-side API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om watermerk toe te voegen aan XLSX via Java" %}}
...
1.  Sla de werkmap op in de indeling XLSX
...
{{% blocks/products/pf/agp/code-block title="Voeg watermerk toe aan XLSX - Java" offSpacer="" %}}
