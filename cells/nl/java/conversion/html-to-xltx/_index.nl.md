...
{{% blocks/products/pf/agp/content h2="Sla HTML op in XLTX in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar XLTX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar XLTX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar XLTX? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar XLTX met slechts een paar regels code.
