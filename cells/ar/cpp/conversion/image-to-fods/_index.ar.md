...
هل تحتاج إلى تحويل ملفات IMAGE إلى FODS برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى FODS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى FODS باستدعاء طريقة Save ().
