...
url: /cs/net/merger/merge-image-to-xlsb/ 
...
Následující příklad ukazuje, jak sloučit IMAGE s XLSB v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit IMAGE s XLSB programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení IMAGE do XLSB" %}}
