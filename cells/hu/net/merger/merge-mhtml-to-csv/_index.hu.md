---
title: A MHTML-CSV-es számok egyesítése – a MHTML-es és a CSV-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-mhtml-to-csv/ 
description: Aspose Excel. C# Aspose.Cells. A MHTML és a CSV mentési formátum egyesítése. C# A MHTML és a CSV formátum kombinálása. Egyesítse a MHTML-CSV-et a C#-ben. MHTML Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A MHTML és a CSV egyesítése a C#-ben" %}}

A következő példa bemutatja a MHTML és a CSV egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a MHTML-es és a CSV-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a CSV fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a MHTML és CSV számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a MHTML és CSV közötti egyesítéshez a C#-ben" InputFormat="mhtml" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML és a CSV egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et a CSV-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML és CSV egyesítéséhez" %}}
