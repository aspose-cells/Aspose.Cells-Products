---
title: Java aracılığıyla XLT'yi FODS'ye dönüştürün 
url: /tr/java/conversion/xlt-to-fods/ 
description: XLT biçimi için FODS dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada FODS'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla XLT\'yi FODS\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı FODS\'ye dönüştürmek için XLT\'den FODS\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak XLT\'yi FODS\'ye Dönüştürme" %}}

 XLT'yi FODS'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla XLT\'yi FODS\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla XLT dosyasını kolayca FODS'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. XLT dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. FODS uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan FODS dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="XLT - FODS Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// XLT dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.xlt");
// XLT'yi FODS olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLT\'den FODS\'ye Dönüştürme Canlı Demoları" sectionDescription="[XLT\'yi FODS\'ye Dönüştür](https://products.aspose.app/cells/conversion/xlt-to-fods) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece XLT dosyanızı yükleyin, anında FODS\'a dönüştürülecektir." >}}
