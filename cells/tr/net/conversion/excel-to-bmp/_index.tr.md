...
EXCEL dosyalarını programlı olarak BMP'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip BMP'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını BMP formatına dönüştürün.
