...
EXCEL dosyalarını programlı olarak TIFF'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip TIFF'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını TIFF formatına dönüştürün.
