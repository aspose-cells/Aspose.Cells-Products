---
title: ET erstellen – ET-Datei in C# erstellen
description:  Aspose Excel. C# Erstellen Sie schnell und einfach eine ET-Datei mit Aspose.Cells. Erstellen Sie eine ET-Datei mit C#. Erstellen Sie ET in C#. C# ET Creator.
...
{{% blocks/products/pf/agp/content h2="So erstellen Sie ET in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Für die Entwickler ist es einfach, ET-Dateien in verschiedenen Berichtsanwendungen zur Datenverarbeitung in nur wenigen Codezeilen zu erstellen, zu laden, zu ändern und zu konvertieren.
...
1.  Verwenden Sie die Save-Methode, um die Arbeitsmappe als ET-Datei zu speichern.

{{% blocks/products/pf/agp/code-block title="Der Beispielcode zeigt, wie eine ET-Datei in C# erstellt wird." offSpacer="" %}}
