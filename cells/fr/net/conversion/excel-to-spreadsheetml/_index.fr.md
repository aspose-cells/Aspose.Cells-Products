...
{{% blocks/products/pf/agp/content h2="Enregistrer un fichier Excel au format SPREADSHEETML (C#)" %}}

L'exemple suivant montre comment convertir EXCEL en SPREADSHEETML dans C#.
...
Besoin de convertir des fichiers EXCEL en SPREADSHEETML par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en SPREADSHEETML en quelques lignes de code seulement.
...
1.  Convertissez un fichier EXCEL en SPREADSHEETML en appelant la méthode Workbook.Save.
