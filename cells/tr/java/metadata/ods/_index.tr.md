---
title:  Düzenleyin veya Görüntüleyin ODS Dosya Meta Verileri via Java
weight: 2080
description: Java JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment üzerinde ODS biçim meta verilerini düzenlemek veya görüntülemek için örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Çıkarma ODS Meta veri via Java" h2="Sunucu tarafı API\'lerini kullanarak ODS dosyalarından meta veri eklemek, düzenlemek, kaldırmak veya ayıklamak için kendi Java uygulamalarınızı oluşturun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="ODS Meta Verilerini Java Kullanarak Çıkarma" %}}
...
+ WorkbookMetadata içinde ODS dosyasını yükleyin
...
{{% blocks/products/pf/agp/code-block title="ODS - Java Meta Verilerini Çıkarın" offSpacer="" %}}
