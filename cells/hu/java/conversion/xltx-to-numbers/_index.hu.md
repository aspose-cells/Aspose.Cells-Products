---
title: Java XLTX számokká alakítása - XLTX számokká alakítása
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a Java fejlesztők számára a XLTX számok NUMBERS formátumba konvertálásához, lehetővé téve a XLTX adatok zökkenőmentes mentését NUMBERS formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható Java kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="Alakítsa át a XLTX számot SZÁMOKKAL a Java-ben" h2="Nagysebességű Java könyvtár a XLTX számokká konvertálásához. Ez egy professzionális szoftvermegoldás a XLTX, SZÁMOK és sok más formátum importálására és exportálására a Java használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLTX-es számot a NUMBERS-be a Java-es számban." %}}

A következő példa bemutatja, hogyan lehet a XLTX számot SZÁMOKKÉNT alakítani a Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesd az egyszerű lépéseket a XLTX számjegyű NUMBERS formátumba konvertálásához. Töltse fel a XLTX fájlt, majd mentse el NUMBERS fájlként. Mind a XLTX olvasása, mind a NUMBERS írása során teljes fájlneveket használhatsz. A kimeneti NUMBERS tartalom és formázás megegyezik az eredeti XLTX dokumentummal.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mintakód a XLTX számokká konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltx" outformat="numbers" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hogyan lehet a XLTX számot via Java számmá alakítani?" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell XLTX fájlokat SZÁMOKKÉNT konvertálnod? A Java fejlesztők könnyedén konvertálhatják a XLTX fájlokat SZÁMOKKÉNT mindössze néhány sornyi kóddal.
...
1.  Alakítsd át a XLTX számot SZÁMOKKÉNT a Workbook.save metódus meghívásával.
1.  Szerezd meg a XLTX SZÁMOKKÉNT történő átváltási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java könyvtár a XLTX számok SZÁMOKKÉNT való konvertálásához" %}}
{{% blocks/products/pf/agp/text %}}
