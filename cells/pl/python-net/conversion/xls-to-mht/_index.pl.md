---
title: Python XLS do MHT - XLS do konwertera MHT
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLS do formatu MHT, umożliwiając bezproblemowe zapisywanie danych XLS w formacie MHT przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLS na MHT w bibliotece Excela Python" h2="Szybka biblioteka Excela Python do konwersji XLS na MHT. Skorzystaj z naszej konwersji Excela API, aby tworzyć zaawansowane, niezależne od platformy oprogramowanie w Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLS na MHT w bibliotece Excela Python" %}}

Jak przekonwertować XLS na MHT? Za pomocą biblioteki NET i Aspose.Cells można łatwo przekonwertować XLS na MHT programowo, używając kilku linijek kodu.[Aspose.Cells for Python pod numerem NET](https://pypi.org/project/aspose-cells-python/)potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Zapisz XLS w MHT w bibliotece Excel Python" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na MHT w bibliotece Excela Python.
...
{{% cells-convert title="Przykładowy kod do konwersji XLS na MHT za pomocą biblioteki Excela Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="mht" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na MHT" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS do MHT? Programiści Python mogą łatwo załadować i przekonwertować pliki XLS do MHT za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteka programu Excel do konwersji XLS na MHT" %}}
