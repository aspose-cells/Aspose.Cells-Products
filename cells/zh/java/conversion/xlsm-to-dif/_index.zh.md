---
title: 通过 Java 将 XLSM 转换为 DIF 
weight: 1940

description: XLSM 格式到 DIF 文件的示例 Java 转换代码。程序员可以使用此示例代码将 Excel 和 OpenOffice 电子表格导出到任何基于 Web 或桌面 Java 的应用程序中的 DIF。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 XLSM 转换为 DIF" h2="XLSM 到 DIF Java 转换以使用内部部署 Java 库将单个或多个页面转换为 DIF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 XLSM 转换为 DIF" %}}

 为了将 XLSM 渲染为 DIF，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 XLSM 转换为 DIF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Java 开发人员只需几行代码即可轻松地将 XLSM 文件转换为 DIF。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 类的实例加载 XLSM 文件1. 调用 Workbook.save 方法1. 使用 DIF 扩展名和 SaveFormat 作为参数传递输出路径1. 检查生成的 DIF 文件的指定路径
...
{{% blocks/products/pf/agp/code-block title="XLSM 到 DIF Java 转换源代码" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLSM 到 DIF 转换现场演示" sectionDescription="[将 XLSM 转换为 DIF](https://products.aspose.app/cells/conversion/xlsm-to-dif) 立即访问我们的现场演示网站。现场演示具有以下好处" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 无需编写任何代码。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上传您的 XLSM 文件，它将立即转换为 DIF。" >}}
