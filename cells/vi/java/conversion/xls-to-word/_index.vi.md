---
title: Java XLS sang WORD - XLS sang WORD Bộ chuyển đổi
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển Java một phương pháp tích hợp đầy đủ để chuyển đổi định dạng XLS sang định dạng WORD, cho phép lưu dữ liệu XLS một cách liền mạch vào định dạng WORD bằng cách sử dụng thư viện Aspose.Cells, tất cả thông qua mã Java hiệu quả và có thể tùy chỉnh.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS thành WORD trong Java" h2="Thư viện tốc độ cao Java dùng để chuyển đổi XLS sang WORD. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất XLS, WORD và nhiều định dạng khác bằng cách sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu mã số XLS vào WORD trong mã số Java." %}}

Ví dụ sau đây minh họa cách chuyển đổi XLS thành WORD trong Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để chuyển đổi XLS thành WORD. Tải lên tệp XLS của bạn, sau đó chỉ cần lưu nó dưới dạng tệp WORD. Đối với cả việc đọc XLS và ghi WORD, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng WORD đầu ra sẽ giống hệt với tài liệu XLS gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ví dụ mã để chuyển đổi XLS thành WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="docx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS thành WORD hoặc via Java" %}}

{{% blocks/products/pf/agp/text %}}

Bạn cần chuyển đổi tệp XLS sang WORD bằng lập trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi XLS sang WORD chỉ với vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1.  Cài đặt 'Aspose.Cells for Java'.
1.  Thêm tham chiếu thư viện (nhập thư viện) vào dự án Java của bạn.
1.  Tải tập tin XLS với một thể hiện của lớp Workbook.
1.  Chuyển đổi XLS thành WORD bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi từ XLS thành WORD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện Java chuyển đổi XLS thành WORD" %}}
{{% blocks/products/pf/agp/text %}}
