---
title: C# PNG XML-be – Online PNG XML-konverterbe
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Ingyenes online C# A PNG konvertálása XML mentési formátumba. C# PNG XML formátumba. Mentse a PNG számot XML C#-be.
...
{{% blocks/products/pf/agp/content h2="Mentse el a PNG-et XML-be a C#-ben online ingyen" %}}

A következő példa bemutatja a PNG konvertálását XML-re a C#-ben.
