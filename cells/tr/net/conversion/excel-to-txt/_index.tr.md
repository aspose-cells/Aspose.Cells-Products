...
EXCEL dosyalarını programlı olarak TXT'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip TXT'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını TXT formatına dönüştürün.
