...
Hai bisogno di convertire i file OTS in JPEG tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire OTS in JPEG in poche righe di codice.
...
1.  Convertire OTS in JPEG chiamando il metodo Save().
