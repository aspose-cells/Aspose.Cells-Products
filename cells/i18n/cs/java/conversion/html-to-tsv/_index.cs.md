---
title: Převést HTML na TSV prostřednictvím Java 
weight: 8790
url: /cs/java/conversion/html-to-tsv/ 
description: Ukázka převodního kódu Java pro formát HTML na soubor TSV. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do TSV v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést HTML na TSV prostřednictvím Java" h2="Převod HTML na TSV Java pro převod jedné nebo více stránek na TSV pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na TSV pomocí Java" %}}

 K vykreslení HTML do TSV použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu HTML na TSV prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor HTML na TSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor HTML s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením TSV a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor TSV
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze HTML na TSV Java" offSpacer="" %}}

```cs
// načíst soubor HTML v instanci sešitu
Workbook book = new Workbook("template.html");
// uložit HTML jako TSV
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze HTML na TSV" sectionDescription="[Převést HTML na TSV](https://products.aspose.app/cells/conversion/html-to-tsv) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor HTML, bude okamžitě převeden na TSV." >}}
