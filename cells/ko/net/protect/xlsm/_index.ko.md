---
title:  XLSM 문서 via .NET 보호 및 잠금
weight: 7530
description: C# 프레임워크, .NET 코어, Mono 또는 Xamarin 플랫폼에서 비밀번호를 사용하여 XLSM 파일을 잠그는 소스 코드입니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 XLSM을 보호하세요." %}}
...
1.  XLSM 파일 경로를 사용하여 통합 문서 클래스를 인스턴스화합니다.
