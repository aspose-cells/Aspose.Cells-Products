---
title:  Mesclar FODS para XLS via C#
url: /pt/net/merger/merge-fods-to-xls/ 
description: Mesclar FODS para XLS Online gratuitamente. Online Grátis FODS a XLS Fusão. Mesclar FODS para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar FODS a XLS em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar FODS a XLS on-line" InputFormat="fods" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
