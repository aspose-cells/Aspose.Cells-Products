---
title: Sloučit XML s SVG – Zkombinovat XML s SVG v Java
url: /cs/java/merger/merge-xml-to-svg/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit XML do formátu uložení SVG. Java Zkombinujte XML do formátu SVG. Sloučit XML na SVG v Java. Sloučit XML.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML na SVG v Java" %}}

Následující příklad ukazuje, jak sloučit XML do SVG v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XML do SVG. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru SVG. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí XML do SVG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení XML do SVG v Java" InputFormat="xml" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XML na SVG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit XML s SVG? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro sloučení XML do SVG" %}}
