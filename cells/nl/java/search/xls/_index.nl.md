---
title: Zoek XLS-document zonder te openen via Java 
weight: 9430
url: /nl/java/search/xls/ 
description: Java voorbeeldcode om woorden met patroon te zoeken in XLS-bestand op Java Runtime-omgeving voor JSP/JSF-applicaties en desktopapplicaties.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Zoek XLS-indelingen in Java" h2="Native en krachtige zoekfunctie voor XLS-documenten met server-side Aspose.Cells for Java API\'s, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="XLS-bestand zoeken met Java" %}}
...
+ Laad XLS-bestand door een werkmapobject te instantiëren.
Open het eerste werkblad in het XLS-bestand.
...
{{% blocks/products/pf/agp/code-block title="XLS-bestanden zoeken - Java" offSpacer="" %}}
