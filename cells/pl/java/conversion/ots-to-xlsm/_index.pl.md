...
description: Aspose Excel. Konwertuj OTS na XLSM szybko i łatwo za pomocą Aspose.Cells. Java OTS na XLSM. Java Zapisz OTS na XLSM. Zapisz OTS jako XLSM, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS pod numerem XLSM w Java" %}}

Poniższy przykład ilustruje sposób konwersji OTS na XLSM w Java.
...
Chcesz programowo przekonwertować pliki OTS na XLSM? Programiści Java mogą z łatwością przekonwertować OTS na XLSM w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na XLSM" %}}
{{% blocks/products/pf/agp/text %}}
