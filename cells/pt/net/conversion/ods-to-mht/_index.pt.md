---
title: C# ODS para MHT - Conversor ODS para MHT
description: Aspose Excel. Converta ODS em MHT de forma rápida e fácil com Aspose.Cells. C# ODS em MHT. C# Salve ODS em MHT. Salve ODS como MHT usando C#.
...
O exemplo a seguir demonstra como converter ODS em MHT em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter ODS para MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para MHT programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em MHT em apenas algumas linhas de código.
