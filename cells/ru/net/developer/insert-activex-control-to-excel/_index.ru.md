---
title:  Вставьте элемент управления ActiveX в Excel via .NET
weight: 10
description: C# исходный код для вставки элемента управления ActiveX в Excel на платформах .NET Framework, .NET Core, Mono или Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке элемента управления ActiveX в файл Excel по номеру C#" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addActiveXControl) вставить элемент управления ActiveX на выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставить элемент управления ActiveX — C#" offSpacer="" %}}
