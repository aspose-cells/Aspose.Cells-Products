...
Следующий пример демонстрирует, как преобразовать HTML в HTM в Java.
...
Нужно программно преобразовать файлы HTML в HTML? Разработчики Java могут легко преобразовать HTML в HTML всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования HTML в HTML" %}}
{{% blocks/products/pf/agp/text %}}
