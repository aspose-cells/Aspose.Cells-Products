---
title: Převést SXC na XLTX přes Java 
url: /cs/java/conversion/sxc-to-xltx/ 
description: Ukázkový konverzní kód Java pro formát SXC na soubor XLTX. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLTX v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SXC na XLTX přes Java" h2="Převod SXC na XLTX Java pro převod jedné nebo více stránek na XLTX pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na XLTX pomocí Java" %}}

 K vykreslení SXC do XLTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod SXC na XLTX prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SXC na XLTX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLTX a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLTX
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu SXC na XLTX Java" offSpacer="" %}}

```cs
// načtěte soubor SXC v instanci sešitu
Workbook book = new Workbook("template.sxc");
// uložit SXC jako XLTX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze SXC na XLTX" sectionDescription="[Převést SXC na XLTX](https://products.aspose.app/cells/conversion/sxc-to-xltx) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor SXC, bude okamžitě převeden na XLTX." >}}
