---
title: Gộp TXT thành MHT - Gộp TXT thành MHT thành C#
url: /vi/net/merger/merge-txt-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí TXT thành MHT saveformat. C# Gộp TXT sang định dạng MHT. Hợp nhất TXT thành MHT C#. TXT Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất TXT với MHT trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất TXT với MHT trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất TXT với MHT. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp MHT. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất TXT với MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất TXT với MHT trong C#" InputFormat="txt" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất TXT với MHT qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất TXT với MHT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="thư viện .NET để hợp nhất TXT với MHT" %}}
