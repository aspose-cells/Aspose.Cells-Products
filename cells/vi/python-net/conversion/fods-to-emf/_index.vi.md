...
{{% blocks/products/pf/agp/content h2="Chuyển đổi FODS thành EMF thành Python" %}}
...
Ví dụ sau đây minh họa cách chuyển đổi FODS thành EMF trong Python via NET.
