---
title: Java PNG hingga XPS - PNG hingga XPS Konverter
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi PNG ke format XPS, memungkinkan penyimpanan data PNG ke format XPS dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan PNG menjadi XPS di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi PNG ke XPS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PNG, XPS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan PNG ke XPS di Java" %}}

Contoh berikut menunjukkan cara mengkonversi PNG menjadi XPS di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PNG menjadi XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file PNG ke XPS secara terprogram? Pengembang Java dapat dengan mudah mengkonversi PNG ke XPS hanya dengan beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1.  Instal 'Aspose.Cells for Java'.
1.  Tambahkan referensi perpustakaan (impor perpustakaan) ke proyek Java Anda.
1.  Muat file PNG dengan sebuah instance dari kelas Workbook.
1.  Ubah PNG menjadi XPS dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari PNG menjadi XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi PNG menjadi XPS" %}}
{{% blocks/products/pf/agp/text %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/conversion/png-to-html/" name="PNG SAMPAI HTML" description="Bahasa Markup Teks Hiper" >}}
