---
title: Slå samman SXC till XLT - Kombinera SXC till XLT i C#
url: /sv/net/merger/merge-sxc-to-xlt/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge SXC till XLT sparaformat. C# Kombinera SXC till XLT format. Slå samman SXC till XLT i C#. SXC Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman SXC till XLT i C# Online gratis" %}}

Följande exempel visar hur man slår samman SXC till XLT i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman SXC till XLT. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen XLT. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman SXC till XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman SXC till XLT i C#" InputFormat="sxc" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman SXC till XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman SXC till XLT programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman SXC till XLT" %}}
