---
title: C# IMAGE إلى JSON - محول IMAGE عبر الإنترنت إلى JSON
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل الصورة إلى JSON saveformat. C# IMAGE إلى تنسيق JSON. احفظ الصورة في JSON C#.
...
{{% blocks/products/pf/agp/content h2="احفظ IMAGE في JSON في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى JSON في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى JSON عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى JSON برمجيًا؟ يمكن للمطورين .NET تحميل وتحويل IMAGE إلى JSON بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى JSON" %}}
