...
description: Aspose Excel. A Aspose.Cells. C# MHT-t gyorsan és egyszerűen konvertálja HTM-re. C# MHT mentése a HTM-be. Mentse az MHT-t HTM-ként a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse el az MHT-t a HTM-be a C# számon" %}}

következő példa bemutatja, hogyan lehet az MHT-t HTM-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód az MHT HTM-má konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Az MHT konvertálása HTM-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Az MHT fájlokat programozottan HTM-re kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és átalakíthatják az MHT-t HTM-re, mindössze néhány sornyi kóddal.
...
1.  Az MHT konvertálása HTM-re a Workbook.Save metódus hívásával.
1.  Szerezze meg az MHT konvertálási eredményét HTM-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT HTM-má konvertálásához" %}}
