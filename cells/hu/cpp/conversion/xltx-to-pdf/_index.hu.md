...
{{< blocks/products/pf/i18n/upper-banner h1="XLTX konvertálása PDF-be a következőn keresztül: C++" h2="Nagy teljesítményű XLTX konvertálás PDF-be a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatják az XLTX fájlt PDF-be, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTX fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (PDF) fájlkiterjesztéssel.1. A PDF fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a PDF fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLTX-ből PDF-be C++ konverziós forráskód" offSpacer="" %}}
