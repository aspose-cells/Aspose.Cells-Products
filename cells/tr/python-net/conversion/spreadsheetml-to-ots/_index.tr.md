...
description: Aspose Excel'de. Aspose.Cells ile SPREADSHEETML'i hızlı ve kolay bir şekilde OTS'ye dönüştürün. Python SPREADSHEETML'i OTS'ye dönüştürün. Python SPREADSHEETML'i OTS'ye kaydedin. SPREADSHEETML'i Python'i kullanarak OTS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'de SPREADSHEETML\'i OTS\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'i Python\'de OTS\'ye kaydedin" %}}

Aşağıdaki örnek, Python via NET'de SPREADSHEETML'in OTS'ye nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

SPREADSHEETML'i OTS'ye dönüştürmek için kolay adımları izleyin. SPREADSHEETML dosyanızı yükleyin ve ardından OTS dosyası olarak kaydedin. Hem SPREADSHEETML okuma hem de OTS yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı OTS içeriği ve formatı orijinal SPREADSHEETML belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="SPREADSHEETML\'i OTS\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="ots" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'i OTS\'ye dönüştürmek için Python kitaplığı" %}}
