---
title:  Inserisci i callout in Excel tramite C++
weight: 810
description: C++ codice di esempio per inserire Callouts nel file Excel su C++ Runtime Environment per Windows 32 bit, Windows 64 bit e Linux 64 bit.
keywords: [C++ Aspose.Cells., C++ add Callouts shape., C++ insert Callouts shape., C++ create Callouts shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci i callout in Excel tramite C++" h2="Inserisci oggetti utilizzando il server-side nativo e ad alte prestazioni Aspose.Cells for C++ API senza utilizzare alcun software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
<div class="container-fluid features-section bg-gray">
 ...
 Tipo forma automatica::<br>AutoShapeType_RectangularCallout
    </p>
   </div>
   <div class="col-lg-4">
 ...
 Tipo forma automatica::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 Tipo forma automatica::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar3
    </p>
   </div>
  </div>
 </div>
