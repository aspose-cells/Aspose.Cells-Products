---
title: Gộp PRN thành EXCEL - Gộp PRN thành EXCEL theo số C#
url: /vi/net/merger/merge-prn-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất định dạng lưu PRN thành EXCEL. C# Kết hợp định dạng PRN sang EXCEL. Hợp nhất PRN thành EXCEL theo số C#. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN thành EXCEL theo số C#" %}}

Ví dụ sau đây minh họa cách hợp nhất PRN thành EXCEL trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất PRN với EXCEL. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp EXCEL. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất PRN với EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp PRN thành EXCEL C#" InputFormat="prn" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp PRN vào EXCEL qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để gộp PRN vào EXCEL" %}}
