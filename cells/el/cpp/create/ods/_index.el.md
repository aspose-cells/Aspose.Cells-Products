---
title: Δημιουργία ODS - Δημιουργία αρχείου ODS στο C++
description: Aspose Excel. C++ Δημιουργία ODS Αρχειοθέτηση γρήγορα και εύκολα με το Aspose.Cells. Δημιουργήστε το αρχείο ODS χρησιμοποιώντας το C++. Δημιουργήστε το ODS στο C++. 0714074.
...
{{% blocks/products/pf/agp/content h2="Πώς να δημιουργήσετε το ODS στο C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Το δείγμα κώδικα δείχνει πώς να δημιουργήσετε το αρχείο ODS στο C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ βιβλιοθήκη για τη δημιουργία αρχείου ODS" %}}
