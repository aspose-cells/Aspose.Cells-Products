...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na TXT pomocí Java" %}}

 K vykreslení CSV do TXT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu CSV na TXT prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na TXT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením TXT a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor TXT
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na TXT Java" offSpacer="" %}}
