...
description: Aspose Exceller. C++ Créez un fichier XLTX rapidement et facilement avec Aspose.Cells. Générez un fichier XLTX à l'aide de C++. Créez XLTX dans C++. C++ XLTX Creater.
...
1.  Enregistrez le classeur en tant que fichier .xltx à l'aide de la méthode Save().
