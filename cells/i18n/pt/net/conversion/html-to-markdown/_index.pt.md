...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML em MARKDOWN via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos HTML para MARKDOWN em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo HTML com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passar caminho de saída com extensão MD como parâmetro1. Verifique o caminho especificado para o arquivo MARKDOWN resultante
...
{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter HTML em MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="md" IsLandingPage="true" %}}
