---
title: Create OTS - Create OTS file in Node.js
description: Aspose Excel. Node.js Create OTS File quickly and easily with Aspose.Cells. Generate OTS file using Node.js. Create OTS in Node.js. Node.js OTS Creater. 
keywords: [Aspose Excel., Node.js Aspose.Cells., Node.js Create OTS file., Generate OTS file in Node.js., Create OTS file using Node.js., Write data to OTS file via Node.js., Create a OTS file in Node.js., Node.js Generate a OTS file., Node.js OTS Creater]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Create OTS File in Node.js" h2="Native and high performance OTS file creation programmatically without Micorsoft Office using Node.js library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Create OTS in Node.js" %}}
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create OTS file in Node.js." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Node.js library to create OTS file" %}}
