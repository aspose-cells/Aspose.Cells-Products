---
title: C# JPG 到 SXC - 在线 JPG 到 SXC 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 JPG 转换为 SXC 保存格式。 C# JPG 到 SXC 格式。将 JPG 保存到 SXC C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 C# 中的 JPG 转换为 SXC" h2="用于将 JPG 转换为 SXC 的高速 C# 库。这是在 .NET Framework、.NET Core 或 Mono 平台上导入和导出 JPG、SXC 和许多其他格式的专业软件解决方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPG" >}}
...
{{% blocks/products/pf/agp/content h2="免费在线将JPG保存到C#中的SXC" %}}

下面的例子演示了如何将C#中的JPG转换为SXC。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 JPG 转换为 SXC。上传您的 JPG 文件，然后只需将其另存为 SXC 文件。对于 JPG 读取和 SXC 写入，您可以使用完全限定的文件名。输出 SXC 内容和格式将与原始 JPG 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 JPG 在线转换为 SXC 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 JPG 转换为 SXC" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 JPG 文件转换为 SXC 吗？ .NET 开发人员只需几行代码即可轻松加载 JPG 并将其转换为 SXC。
...
1. 通过调用Workbook.Save方法将JPG转换为SXC。
1. 获取JPG到SXC的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#库将JPG转换为SXC" %}}
