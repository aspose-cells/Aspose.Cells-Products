...
هل تحتاج إلى تحويل ملفات IMAGE إلى XLS برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى XLS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى XLS باستدعاء طريقة Save ().
