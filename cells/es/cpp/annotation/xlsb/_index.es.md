...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar comentarios en XLSB Archivo a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Cargue el archivo de Excel XLSB utilizando el objeto de clase IWorkbook.
...
{{% blocks/products/pf/agp/code-block title="Agregar comentarios en XLSB Archivo - C++" offSpacer="" %}}
