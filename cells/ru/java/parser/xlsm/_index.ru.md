---
title:  Извлечь текст и изображения из документа XLSM via Java.
weight: 3260
description: Java пример кода для извлечения текста и изображений из файла XLSM в среде выполнения Java для приложений JSP/JSF и настольных приложений.
...
{{< blocks/products/pf/i18n/upper-banner h1="Разобрать форматы XLSM в Java" h2="Собственный высокопроизводительный анализ документов XLSM с использованием серверных API Aspose.Cells for Java без использования какого-либо программного обеспечения, такого как Microsoft или Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
Загрузите документ XLSM, используя класс Workbook.
...
{{% blocks/products/pf/agp/code-block title="Разбор XLSM Файлов - Java" offSpacer="" %}}
