---
title: PHP HTM a XLSX - Convertidor HTM a XLSX
description: Aspose Excel. Convierta HTM a XLSX rápida y fácilmente con Aspose.Cells. PHP HTM a XLSX. PHP Guarde HTM en XLSX. Guarde HTM como XLSX usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a XLSX mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a XLSX mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a XLSX en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a XLSX llamando al método guardar del libro de trabajo.
