---
title: Java HTM إلى ET - تحويل HTM إلى ET
description: Aspose اكسل. قم بتحويل HTM إلى ET بسرعة وسهولة باستخدام Aspose.Cells. Java HTM إلى ET. Java حفظ HTM إلى ET. احفظ HTM كـ ET باستخدام Java.
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في ET في Java" %}}

يوضح المثال التالي كيفية تحويل HTM إلى ET في Java.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل HTM إلى ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات HTM إلى ET برمجياً؟ يمكن لمطوري Java تحويل HTM إلى ET بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل HTM إلى ET" %}}
{{% blocks/products/pf/agp/text %}}
