---
title:  Inserisci la riga in Excel tramite Python
weight: 10
description: Python codice sorgente per inserire Line in Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci la riga in Excel tramite Python" h2="Inserisci oggetti utilizzando le API lato server senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire una riga in un file Excel utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire Line to Excel file tramite Python" %}}
...
+ Usa il metodo add di shapecollection per inserire una linea nel foglio di lavoro selezionato.
...
-  Qualsiasi sistema operativo in grado di eseguire script Python, come Windows e Linux
...
{{% blocks/products/pf/agp/code-block title="Inserisci Linea - Python" offSpacer="" %}}
