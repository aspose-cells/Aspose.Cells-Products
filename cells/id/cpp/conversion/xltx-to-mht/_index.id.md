...
{{% cells-convert title="Kode Contoh untuk Mengonversi XLTX ke MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="mht" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert XLTX ke MHT lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLTX ke MHT secara terprogram? Pengembang C++ dapat dengan mudah mengonversi XLTX ke MHT hanya dalam beberapa baris kode.
...
1.  Ubah XLTX menjadi MHT dengan memanggil metode Save().
