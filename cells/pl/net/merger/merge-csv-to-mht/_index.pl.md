---
title:  Połącz CSV z MHT przez C#
url: /pl/net/merger/merge-csv-to-mht/ 
description: Połącz CSV z MHT Online za darmo. Bezpłatnie online CSV do fuzji MHT. Połącz CSV z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak scalić CSV z MHT w C#.
...
{{% cells-merger title="Darmowa aplikacja do łączenia CSV z MHT on-line" InputFormat="csv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
