...
description: Aspose Excel. C# Aspose.Cells. Sloučit EXCEL do JSON saveformat. C# Kombinujte EXCEL do formátu JSON. Sloučit EXCEL na JSON v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL na JSON v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení EXCELu s JSON v C#" InputFormat="xlsx" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
