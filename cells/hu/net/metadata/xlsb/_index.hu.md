...
{{% blocks/products/pf/agp/content h2="A XLSB metaadatok kinyerése a C# használatával" %}}

 XLSB metaadatok kinyeréséhez a következőket fogjuk használni
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a XLSB metaadatainak C#-en keresztül történő kinyeréséhez" %}}
...
+ A XLSB betöltése a munkafüzet egy példányával
...
{{% blocks/products/pf/agp/code-block title="A XLSB - C# metaadatainak kivonata" offSpacer="" %}}
