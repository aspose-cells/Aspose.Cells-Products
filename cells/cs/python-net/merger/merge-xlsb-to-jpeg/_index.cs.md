---
title: Sloučit XLSB až JPEG - Sloučit XLSB až JPEG v Python
url: /cs/python-net/merger/merge-xlsb-to-jpeg/ 
description: Aspose Excel. Python Excel. Sloučit XLSB do JPEG uložit formát. Python Kombinujte formát XLSB až JPEG. Sloučit XLSB až JPEG v knihovně Excel Python. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB do JPEG pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až JPEG v Python knihovně Excel" %}}

Následující příklad ukazuje, jak sloučit XLSB až JPEG v Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLSB do JPEG. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru JPEG. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí XLSB do JPEG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení XLSB až JPEG v knihovně Excel Python" InputFormat="xlsb" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB do JPEG přes Python Excel Library" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLSB až JPEG? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python ke sloučení XLSB až JPEG" %}}
