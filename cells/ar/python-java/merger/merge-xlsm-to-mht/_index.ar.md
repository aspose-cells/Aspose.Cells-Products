...
يوضح المثال التالي كيفية دمج XLSM مع MHT في Aspose.Cells for Python via Java.
...
هل تحتاج إلى دمج XLSM مع MHT برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
