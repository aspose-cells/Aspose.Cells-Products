---
title: Java XLTM الى XLTX - XLTM الى XLTX محول
description: Aspose اكسل. تحويل XLTM إلى XLTX بسرعة وسهولة مع Aspose.Cells. Java XLTM إلى XLTX. Java احفظ XLTM إلى XLTX. احفظ XLTM كـ 07611134 81 باستخدام Java.
keywords: [Aspose Excel., Java Aspose.Cells., Convert XLTM to XLTX in Java., Save XLTM to XLTX using Java., Java XLTM to XLTX saveformat., XLTM to XLTX Converter., Java Save XLTM as XLTX]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTM إلى XLTX في Java" h2="مكتبة Java عالية السرعة لتحويل XLTM إلى XLTX. هذا حل برمجي احترافي لاستيراد وتصدير XLTM، XLTX، والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="حفظ XLTM إلى XLTX في Java" %}}

يوضح المثال التالي كيفية تحويل XLTM إلى XLTX في Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل XLTM إلى XLTX. قم بتحميل ملف XLTM الخاص بك، ثم احفظه كملف XLTX. لكل من قراءة XLTM وكتابة XLTX، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق الإخراج XLTX مطابقًا للمستند الأصلي XLTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLTM إلى XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى XLTX برمجياً؟ يمكن لمطوري Java تحويل XLTM إلى XLTX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى XLTX عن طريق استدعاء طريقة Workbook.save.
