---
title: تحويل XLTX إلى XLT عبر تطبيق C++ 
url: /ar/cpp/conversion/xltx-to-xlt/ 
description: نموذج C++ رمز التحويل لمستند XLTX إلى تنسيق XLT. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLTX إلى XLT دفعة داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTX إلى XLT عبر C++" h2="تحويل XLTX إلى XLT عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTX إلى XLT باستخدام C++" %}}
 ...
 من أجل تحويل XLTX إلى XLT ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف XLTX إلى XLT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLTX باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLT).1. سيتم حفظ ملف XLT في المسار المحدد.1. افتح ملف XLT في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLTX إلى شفرة مصدر تحويل XLT C++" offSpacer="" %}}
