...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke EMF menggunakan C++" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke EMF di C++" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX menjadi EMF di C++.
...
Perlu mengkonversi file XLTX ke EMF secara terprogram? Pengembang C++ dapat dengan mudah mengkonversi XLTX ke EMF hanya dengan beberapa baris kode.
...
1.  Konversikan XLTX menjadi EMF dengan memanggil metode Save().
1.  Dapatkan hasil konversi dari XLTX menjadi EMF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ perpustakaan untuk mengkonversi XLTX menjadi EMF" %}}
