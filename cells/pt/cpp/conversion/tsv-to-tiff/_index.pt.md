---
title: Converter TSV para TIFF por meio do aplicativo C++ 
weight: 5960
url: /pt/cpp/conversion/tsv-to-tiff/ 
description: Exemplo de código de conversão C++ de documento TSV para formato TIFF. Os programadores podem usar esse código-fonte para conversão em lote de TSV para TIFF em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem facilmente converter arquivos TSV para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo TSV usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (TIFF).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo TIFF em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de TSV para TIFF C++" offSpacer="" %}}
