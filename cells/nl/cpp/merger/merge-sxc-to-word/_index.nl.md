...
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen SXC naar WORD-opslagformaat. C++ Combineer SXC naar WORD-formaat. Samenvoegen SXC naar WORD in C++. SXC Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u SXC kunt samenvoegen met WORD in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u SXC programmatisch samenvoegen met WORD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
