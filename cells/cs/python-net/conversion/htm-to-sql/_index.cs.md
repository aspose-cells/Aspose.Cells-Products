---
title: Python HTM do SQL - Převodník HTM do SQL
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Python plně integrovaný přístup k převodu HTM do formátu SQL, což umožňuje bezproblémové ukládání dat HTM do formátu SQL pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte HTM na SQL v knihovně Excel Python" %}}

 Jak převedu HTM na SQL? S Aspose.Cells for Python prostřednictvím knihovny NET můžete snadno převést HTM na SQL programově pomocí několika řádků kódu.[Aspose.Cells for Python přes NET](https://pypi.org/project/aspose-cells-python/)je schopen vytvářet multiplatformní aplikace se schopností generovat, upravovat, konvertovat, vykreslovat a tisknout všechny soubory aplikace Excel. Python Excel API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat soubory Excel jako obrázky, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT a další, takže je perfektní volbou pro výměnu dokumentů ve standardních průmyslových formátech.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Uložte HTM do SQL v knihovně Excel Python" %}}

Následující příklad ukazuje, jak převést HTM na SQL v knihovně Excel Python.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod HTM na SQL. Nahrajte svůj soubor HTM a poté jej jednoduše uložte jako soubor SQL. Pro čtení HTM i zápis SQL můžete použít plně kvalifikované názvy souborů. Výstupní SQL obsah a formátování budou identické s původním HTM dokumentem.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod HTM na SQL prostřednictvím knihovny Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="sql" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak převést HTM na SQL" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést HTM soubory na SQL programově? Python vývojáři mohou snadno načíst a převést HTM na SQL v několika řádcích kódu.
...
1.  Převeďte HTM na SQL voláním metody Workbook.save.
1.  Získejte výsledek převodu HTM na SQL.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod HTM na SQL" %}}
