...
{{% blocks/products/pf/agp/content h2="Jak převést FODS na CSV pomocí Java" %}}

 K vykreslení FODS do CSV použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu FODS na CSV prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor FODS na CSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor FODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením CSV a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor CSV
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze FODS na CSV Java" offSpacer="" %}}

```cs
// načtěte soubor FODS do instance Workbooku
Workbook book = new Workbook("template.fods");
// uložit FODS jako CSV
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze FODS na CSV" sectionDescription="[Převést FODS na CSV](https://products.aspose.app/cells/conversion/fods-to-csv) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor FODS, bude okamžitě převeden na CSV." >}}
