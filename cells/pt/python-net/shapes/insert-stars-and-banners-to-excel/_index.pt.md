...
{{% blocks/products/pf/agp/content h2="Como inserir estrela/banner no arquivo Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir estrela/banner no arquivo Excel usando Python via .Net" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o add da coleção de formas[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) para inserir Estrela/Banner na planilha selecionada.
...
{{% blocks/products/pf/agp/code-block title="Insira Estrela/Banner - Python via .Net" offSpacer="" %}}
