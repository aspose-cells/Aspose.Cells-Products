...
description: Sample code for TXT to MHTML C# conversion. Use API example code for batch TXT files to MHTML conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells makes it easy for the developers to load & convert TXT files to MHTML in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows TXT to MHTML C# Conversion" offSpacer="" %}}
