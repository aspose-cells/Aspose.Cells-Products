...
+ Sử dụng phương thức thêm của shapecollection để chèn một Dòng trong trang tính đã chọn.
...
-  Bất kỳ hệ điều hành nào có thể chạy tập lệnh python, chẳng hạn như Windows và Linux
