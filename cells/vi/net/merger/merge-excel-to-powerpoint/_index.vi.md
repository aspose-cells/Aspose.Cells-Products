---
title: Gộp EXCEL vào POWERPOINT - Gộp EXCEL vào POWERPOINT trong C#
url: /vi/net/merger/merge-excel-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất định dạng lưu EXCEL thành POWERPOINT. C# Kết hợp định dạng EXCEL với POWERPOINT. Hợp nhất EXCEL với POWERPOINT theo số C#. Hợp nhất EXCEL.
...
{{% blocks/products/pf/agp/content h2="Gộp EXCEL vào POWERPOINT số C#" %}}

Ví dụ sau đây minh họa cách hợp nhất EXCEL với POWERPOINT trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất EXCEL với POWERPOINT. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp POWERPOINT. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất EXCEL với POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp EXCEL vào POWERPOINT trong C#" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để gộp EXCEL vào POWERPOINT" %}}
