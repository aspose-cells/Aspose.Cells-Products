---
title: Java ODS sang HTM - ODS sang HTM Chuyển đổi
description: Aspose Excel. Chuyển đổi ODS sang HTM nhanh chóng và dễ dàng với Aspose.Cells. Java ODS sang HTM. Java Lưu ODS vào HTM. Lưu ODS dưới dạng HTM bằng Java.
...
{{% blocks/products/pf/agp/content h2="Lưu ODS vào HTM vào Java" %}}

Ví dụ sau đây minh họa cách chuyển đổi ODS sang HTM trong Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để chuyển đổi ODS sang HTM. Tải lên tệp ODS của bạn, sau đó chỉ cần lưu nó dưới dạng tệp HTM. Đối với cả việc đọc ODS và ghi HTM, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng HTM đầu ra sẽ giống hệt với tài liệu ODS gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mã mẫu chuyển đổi ODS sang HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="htm" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi ODS sang HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi file ODS sang HTM theo chương trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi ODS sang HTM chỉ bằng vài dòng mã.
...
1.  Chuyển đổi ODS sang HTM bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi ODS sang HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện Java chuyển đổi ODS sang HTM" %}}
{{% blocks/products/pf/agp/text %}}
