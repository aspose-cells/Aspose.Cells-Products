...
{{% blocks/products/pf/agp/content h2="Sla HTML op in BMP in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar BMP in C++.
...
Moet je bestanden met de extensie HTML programmatisch converteren naar BMP? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar BMP met slechts een paar regels code.
