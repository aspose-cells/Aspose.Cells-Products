---
title:  Masukkan PivotTable di file Micorsoft Excel XLSX melalui C#
weight: 7690
description: C# Contoh kode untuk menambahkan PivotTable ke XLSX menggunakan Perpustakaan .NET. Gunakan kode ini untuk memasukkan PivotTable ke file XLSX dalam VB.NET, Asp.NET atau aplikasi berbasis .NET.
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Menghasilkan file MS Excel XLSX dengan PivotTable secara dinamis dalam aplikasi yang sedang berjalan sangatlah mudah. Untuk membuat dokumen XLSX dengan PivotTable dari awal tanpa memerlukan MS Office, kami akan menggunakan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API yang menawarkan fitur berbeda untuk pembuatan, manipulasi, dan konversi spreadsheet menggunakan platform .NET. Pengembang dapat dengan mudah menyempurnakan kode untuk menulis data, menghasilkan bagan atau grafik, serta membuat tabel di spreadsheet.
{{% /blocks/products/pf/agp/content %}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Cara memasukkan PivotTable di XLSX melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 Mudah bagi pengembang untuk memasukkan PivotTable dalam spreadsheet berformat XLSX dalam menjalankan aplikasi pelaporan yang berbeda untuk pemrosesan data hanya dalam beberapa baris kode.
