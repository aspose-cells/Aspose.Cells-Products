...
{{% blocks/products/pf/agp/content h2="如何使用Python via .Net将图片插入Excel文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用Python via .Net将图片插入Excel文件的步骤" %}}
...
+ 通过索引选择工作表。
 使用图片集的添加[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/)在选定的工作表中插入图片。
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入图片 - Python via .Net" offSpacer="" %}}
