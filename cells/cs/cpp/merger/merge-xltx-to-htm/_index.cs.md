...
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do formátu uložení HTM. C++ Zkombinujte XLTX do formátu HTM. Sloučit XLTX na HTM v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX na HTM v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX do HTM v C++" InputFormat="xltx" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
