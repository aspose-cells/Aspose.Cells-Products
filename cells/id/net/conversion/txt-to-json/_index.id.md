...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan TXT menjadi JSON di C#" h2="Pustaka berkecepatan tinggi C# untuk mengkonversi TXT ke JSON. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor TXT, JSON, dan banyak format lainnya pada Framework .NET, Core .NET, atau Platform Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
Perlu mengonversi file TXT ke JSON secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi TXT menjadi JSON hanya dalam beberapa baris kode.
...
1.  Konversikan TXT menjadi JSON dengan memanggil metode Workbook.Save.
