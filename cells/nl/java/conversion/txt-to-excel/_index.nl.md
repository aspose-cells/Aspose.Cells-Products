---
title: Java TXT naar EXCEL - Online TXT naar EXCEL Converter
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratis online Java Converteer TXT naar EXCEL-opslagformaat. Java TXT naar EXCEL-formaat. Bewaar TXT naar EXCEL Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer TXT naar EXCEL in Java" h2="High-speed Java-bibliotheek voor het converteren van TXT naar EXCEL. Dit is een professionele softwareoplossing voor het importeren en exporteren van TXT, EXCEL en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Bespaar TXT naar EXCEL in Java Online gratis" %}}

Het volgende voorbeeld laat zien hoe u TXT converteert naar EXCEL in Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TXT naar EXCEL te converteren. Upload uw TXT-bestand en sla het vervolgens eenvoudig op als EXCEL-bestand. Voor zowel het lezen van TXT als het schrijven van EXCEL kunt u volledig gekwalificeerde bestandsnamen gebruiken. De uitvoer EXCEL inhoud en opmaak zal identiek zijn aan het originele TXT document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Gratis app en voorbeeldcode om TXT online naar EXCEL te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe TXT naar EXCEL via Java te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u TXT-bestanden programmatisch naar EXCEL converteren? Java-ontwikkelaars kunnen TXT gemakkelijk converteren naar EXCEL in slechts een paar regels code.
...
1.  Converteer TXT naar EXCEL door de methode Workbook.save aan te roepen.
