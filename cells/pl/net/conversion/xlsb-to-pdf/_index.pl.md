---
title: Konwertuj XLSB na PDF przez C#
url: /pl/net/conversion/xlsb-to-pdf/
description: Przykładowy kod konwersji xlsb do pdf C#. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji pdf w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na PDF przez C#" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu PDF na platformach .NET Framework, .NET Core, Mono lub Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki XLSB do formatu PDF w zaledwie kilku wierszach kodu.
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLSB na PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="pdf" IsLandingPage="true" %}}
