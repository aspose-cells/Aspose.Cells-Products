...
weight: 9620
description: Codice di esempio Java per bloccare il file XLSM utilizzando la password sull'ambiente runtime Java per applicazioni JSP/JSF e applicazioni desktop.
...
{{< blocks/products/pf/i18n/upper-banner h1="Crittografa XLSM file via Java" h2="Fogli di calcolo Excel protetti da password incluso il formato XLSM utilizzando la libreria .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per proteggere i file XLSM via Java" %}}
...
1.  Carica il file XLSM istanziando la classe Workbook
1.  Utilizzare il metodo Protect(..) con ProtectionType e Password
1.  Salvare il file protetto XLSM con il metodo save()
