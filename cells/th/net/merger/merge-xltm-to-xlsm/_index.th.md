---
title: รวม XLTM ถึง XLSM - รวม XLTM ถึง XLSM ใน C#
url: /th/net/merger/merge-xltm-to-xlsm/ 
description: Aspose เอ็กเซล. C# Aspose.Cells รวม XLTM เป็น XLSM บันทึกฟอร์แมต C# รวมรูปแบบ XLTM ถึง XLSM รวม XLTM ถึง XLSM เข้า C# XLTM รวม.
...
{{% blocks/products/pf/agp/content h2="รวม XLTM ถึง XLSM ใน C#" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLTM ถึง XLSM ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม XLTM ถึง XLSM อัปโหลดไฟล์ของคุณ เรียกวิธี Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ XLSM หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่รวม XLTM กับ XLSM

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="โค้ดตัวอย่างที่จะรวม XLTM ถึง XLSM ใน C#" InputFormat="xltm" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวม XLTM ถึง XLSM ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม XLTM กับ XLSM โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ห้องสมุดรวม XLTM เป็น XLSM" %}}
