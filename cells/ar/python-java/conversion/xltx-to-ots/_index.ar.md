...
description: Aspose اكسل. قم بتحويل XLTX إلى OTS بسرعة وسهولة باستخدام Aspose.Cells. Python XLTX إلى OTS. Python احفظ XLTX إلى OTS. احفظ XLTX كـ OTS باستخدام Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTX إلى OTS في Python" h2="مكتبة Python عالية السرعة لتحويل XLTX إلى OTS. يعد هذا حلاً برمجيًا احترافيًا لاستيراد وتصدير XLTX وOTS والعديد من التنسيقات الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل XLTX إلى OTS باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ XLTX إلى OTS في Python" %}}

يوضح المثال التالي كيفية تحويل XLTX إلى OTS في Python.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل XLTX إلى OTS" %}}
