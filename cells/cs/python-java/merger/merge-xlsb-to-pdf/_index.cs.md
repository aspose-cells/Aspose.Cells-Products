---
title: Sloučit XLSB až PDF - Sloučit XLSB až PDF v Python
url: /cs/python-java/merger/merge-xlsb-to-pdf/ 
description: Aspose Excel. Python Excel. Sloučit XLSB do PDF uložit formát. Python Kombinujte formát XLSB až PDF. Sloučit XLSB až PDF v knihovně Excel Python. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB do PDF pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až PDF v Python knihovně Excel" %}}

Následující příklad ukazuje, jak sloučit XLSB až PDF v Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLSB do PDF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PDF. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí XLSB do PDF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB do PDF přes Python Excel Library" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLSB až PDF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python ke sloučení XLSB až PDF" %}}
