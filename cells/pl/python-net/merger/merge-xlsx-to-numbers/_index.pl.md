---
title:  Połącz XLSX z NUMBERS przez Python
...
Poniższy przykład pokazuje, jak scalić XLSX z NUMBERS w Python.
...
{{% cells-merger title="Darmowa aplikacja do łączenia XLSX z NUMERAMI on-line" InputFormat="xlsx" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
