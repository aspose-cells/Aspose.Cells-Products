...
{{% blocks/products/pf/agp/code-block title="수정 ODS 파일 - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="온라인 ODS Redaction 라이브 데모" sectionDescription=" 지금 바로 ODS 문서의 콘텐츠, 댓글 또는 메타데이터에서 텍스트를 검색하고 교체하세요.[라이브 데모 웹사이트](https://products.aspose.app/cells/redaction). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
