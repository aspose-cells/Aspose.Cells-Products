---
title: Voeg PRN samen met HTM - Combineer PRN met HTM in Python
url: /nl/python-java/merger/merge-prn-to-htm/ 
description: Aspose Excel. Python Aspose.Cells. Gratis online PRN samenvoegen naar HTM-opslagformaat. Python Combineer PRN naar HTM formaat. Voeg PRN samen met HTM in Python. PRN samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg PRN samen met HTM met behulp van Python" %}}

 Hoe voeg ik PRN samen met HTM? Met de bibliotheek Aspose.Cells for Python via Java kunt u PRN eenvoudig programmatisch samenvoegen met HTM met een paar regels code.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells)is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaard formaten. U kunt Aspose.Cells for Python via Java installeren vanaf<a href="https://pypi.org/project/aspose-cells/">pypi</a> , gebruik commando als:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Voeg PRN gratis samen met HTM in Python" %}}

Het volgende voorbeeld laat zien hoe u PRN kunt samenvoegen met HTM in Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PRN samen te voegen met HTM. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een HTM-bestand. Als u code ontwikkelt in Python, is dit eenvoudiger dan het klinkt. Zie voorbeeld Python dat PRN samenvoegt met HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om PRN samen te voegen met HTM in Python" InputFormat="prn" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="PRN samenvoegen met HTM via Python" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u PRN programmatisch samenvoegen met HTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om PRN samen te voegen met HTM" %}}
