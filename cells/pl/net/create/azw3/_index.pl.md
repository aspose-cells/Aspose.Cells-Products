...
{{% blocks/products/pf/agp/text %}}
 ...
 Dzięki temu programiści mogą z łatwością tworzyć, ładować, modyfikować i konwertować pliki AZW3 w różnych aplikacjach do raportowania w celu przetwarzania danych, wykorzystując w tym celu zaledwie kilka linijek kodu.
...
1.  Użyj metody Save, aby zapisać skoroszyt jako plik AZW3.
