---
title: Konvertieren Sie XLS in CSV über die Anwendung C++ 
weight: 8520

description: Beispiel-Umwandlungscode C++ für das XLS-Dokument in das CSV-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von XLS in CSV in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLS in CSV über C++" h2="Leistungsstarke XLS-zu-CSV-Konvertierung mithilfe der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können XLS-Dateien in nur wenigen Codezeilen ganz einfach in CSV konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die XLS-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (CSV).1. Die CSV-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die CSV-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="XLS-zu-CSV-C++-Konvertierungsquellcode" offSpacer="" %}}
