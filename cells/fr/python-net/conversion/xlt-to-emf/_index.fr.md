...
{{% blocks/products/pf/agp/content h2="Enregistrez XLT à EMF dans Python en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLT en EMF en Python via NET.
