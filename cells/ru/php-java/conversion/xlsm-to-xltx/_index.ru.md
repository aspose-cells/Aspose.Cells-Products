---
title: Конвертер PHP XLSM в XLTX - XLSM в XLTX
description: Aspose Эксель. Преобразуйте XLSM в XLTX быстро и легко с помощью Aspose.Cells. PHP XLSM в XLTX. PHP Сохраните XLSM в XLTX. Сохраните XLSM как XLTX с помощью PHP.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XLSM в XLTX с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы XLSM в XLTX? Разработчики PHP могут легко загрузить и преобразовать XLSM в XLTX всего за несколько строк кода.
...
1.  Преобразуйте XLSM в XLTX, вызвав метод сохранения книги.
1.  Получите результат преобразования XLSM в XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования XLSM в XLTX" %}}
