---
title: دمج الأرقام في MARKDOWN - اجمع الأرقام في MARKDOWN في Java
url: /ar/java/merger/merge-numbers-to-markdown/ 
description: Aspose إكسل. Java Aspose.Cells. دمج الأرقام مجانًا عبر الإنترنت في تنسيق حفظ MARKDOWN. Java قم بدمج الأرقام بالشكل MARKDOWN. دمج الأرقام في MARKDOWN في Java. دمج الأرقام.
...
{{% blocks/products/pf/agp/content h2="دمج الأرقام مع MARKDOWN باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="قم بدمج الأرقام في MARKDOWN في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج الأرقام مع MARKDOWN في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج NUMBERS في MARKDOWN. قم بتحميل ملفاتك ، واستدع طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف MARKDOWN. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج الأرقام مع MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني عبر الإنترنت لدمج الأرقام في MARKDOWN في Java" InputFormat="numbers" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج الأرقام مع MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج الأرقام في MARKDOWN برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Java مكتبة لدمج الأرقام إلى MARKDOWN" %}}
