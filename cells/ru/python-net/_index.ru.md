---
title: Электронная таблица Excel Python API - Aspose.Cells for Python via .NET
weight: 2800
description: Библиотека Aspose.Cells for Python via .NET предназначена для создания, восстановления, объединения, анализа и преобразования файлов Excel. Эта мощная библиотека API предоставляет оптимизированное и эффективное решение для создания, восстановления, объединения, анализа и преобразования файлов Excel, удовлетворяя специфические потребности разработчиков с высокой точностью.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python API-интерфейсы анализа таблиц Excel" h2="Создавайте, читайте, записывайте и управляйте электронными таблицами, а также экспортируйте файлы Excel в различные форматы в приложениях Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/headers/aspose_cells-for-python-via-net.svg" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="https://releases.aspose.com/cells/python-net/" >}}
...
{{< blocks/products/pf/carousel-item h3="Независимость платформы" description="Aspose.Cells for Python via .NET доступен для." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<p>Python sheets API provides a powerful Formula Calculation Engine that supports almost all of the standard and advanced Microsoft Excel formulas and functions. Formula calculation engine makes it easy to read, set and calculate the results of the built-in or add-in type, array and R1C1 reference style formulas.</p>
 ...
 Гибкие параметры отображения
    ...
    <p>
 Aspose.Cells for Python via .NET обеспечивает полный контроль над настройкой страницы, позволяя управлять несколькими параметрами отображения, такими как предварительный просмотр разрывов страниц, установка уровня масштабирования, установка ориентации страницы, управление видимостью данных с помощью стоп-панелей, размер бумаги, масштабирование, заголовки и т. д. нижние колонтитулы и область печати.
    </p>
   </div>
   <!--<div class="col-lg-12">
...
<p>Aspose.Cells for Android via .NET API allows you to manipulate rows and columns in many different ways. You can easily adjust row height and column width, auto size the width & height of cells according to the contents, insert or delete, hide or show and group or ungroup rows & columns.</p>
 ...
 Управление данными в таблицах Excel
    ...
    <p>
 Aspose.Cells for Python via .NET API обеспечивает обширную поддержку управления данными рабочих листов. Можно легко манипулировать любой ячейкой на листе во время выполнения или импортировать данные на листы из различных источников данных.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Настройка графиков
    ...
    <p>
Aspose.Cells for Python via .NET обеспечивает полную поддержку построения графиков. Можно легко добавлять стандартные и настраиваемые диаграммы или динамически устанавливать данные диаграммы, чтобы обновить диаграмму с помощью этой библиотеки Python.
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/cells/python-net/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Cells for Python via .NET?" tabId="success-stories" >}}
