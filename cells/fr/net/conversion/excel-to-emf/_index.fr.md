...
description: Aspose Exceller. Convertissez EXCEL en EMF rapidement et facilement avec Aspose.Cells. C# EXCEL en EMF. C# Enregistrez EXCEL en EMF. Enregistrez EXCEL sous EMF en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL au EMF dans C#" %}}
...
{{% cells-convert title="Exemple de code pour convertir EXCEL en EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="emf" IsLandingPage="true" %}}
