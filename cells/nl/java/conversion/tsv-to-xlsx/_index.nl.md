...
{{% blocks/products/pf/agp/content h2="Sla TSV op in XLSX in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar XLSX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar XLSX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TSV programmatisch converteren naar XLSX? Ontwikkelaars van Java kunnen bestanden met de extensie TSV eenvoudig converteren naar XLSX met slechts een paar regels code.
