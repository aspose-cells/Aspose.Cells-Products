...
url: /fr/net/merger/merge-mht-to-xltx/ 
...
L'exemple suivant montre comment fusionner MHT avec XLTX dans Aspose.Cells for .NET.
...
{{% cells-merger title="Exemple de code pour fusionner MHT avec XLTX dans C#" InputFormat="mht" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec XLTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner MHT avec XLTX par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque .NET pour fusionner MHT avec XLTX" %}}
