---
title: Преобразование CSV в SPREADSHEETML через Java 
url: /ru/java/conversion/csv-to-spreadsheetml/ 
description: Пример кода преобразования Java для формата CSV в файл SPREADSHEETML. Программисты могут использовать этот пример кода для экспорта электронных таблиц Excel и OpenOffice в SPREADSHEETML в любом веб-или настольном Java приложении.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование CSV в SPREADSHEETML через Java" h2="Преобразование CSV в SPREADSHEETML Java для преобразования одной или нескольких страниц в SPREADSHEETML с использованием локальной Java библиотеки." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать CSV в SPREADSHEETML с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию CSV в SPREADSHEETML через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Java могут легко преобразовать файл CSV в SPREADSHEETML, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл CSV с экземпляром класса Workbook1. Вызов метода Workbook.save1. Передайте выходной путь с расширением SPREADSHEETML и SaveFormat в качестве параметров1. Проверить указанный путь для результирующего файла SPREADSHEETML
...
{{% blocks/products/pf/agp/code-block title="CSV в SPREADSHEETML Java Исходный код преобразования" offSpacer="" %}}

```cs
// загрузить CSV-файл в экземпляр Workbook
Workbook book = new Workbook("template.csv");
// сохранить CSV как SPREADSHETML
