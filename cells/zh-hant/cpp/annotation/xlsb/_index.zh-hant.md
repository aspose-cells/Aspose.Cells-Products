---
title: 新增或刪除 Excel 檔案 XLSB 透過 C++ 進行註釋
weight: 860
description: C++ 範例程式碼，用於在 Windows 32 位元、Windows 64 位元和 Linux 64 位元的 C++ 執行時間環境上刪除 XLSB 格式註解。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 在 XLSB 文件中加入註釋" h2="建立您自己的 C++ 應用程序，以使用伺服器端 API 操作文件檔案中的評論和作者。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 在 XLSB 文件中加入註解的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="在 XLSB 文件中新增註解 - C++" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API 可用於建立、編輯、轉換和渲染 Microsoft Excel 格式為不同的格式。此外，它還可用於軟體應用程式中的全面圖表、可擴展報告和可靠計算。 Aspose.Cells 是一個獨立的 API，它不需要任何像 Microsoft 或 OpenOffice 這樣的軟體。
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="透過線上應用程式新增/刪除 XLSB 的註釋" sectionDescription="立即刪除 XLSB 文件註釋，存取我們的[現場示範網站](https://products.aspose.app/cells/annotation)。現場演示有以下好處" >}}
