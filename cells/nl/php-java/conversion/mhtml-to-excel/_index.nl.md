...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar EXCEL met Aspose.Cells. PHP MHTML naar EXCEL. PHP Sla MHTML op in EXCEL. Sla MHTML op als EXCEL met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Sla MHTML op in Excel in PHP" %}}

Het volgende voorbeeld laat zien hoe u MHTML naar EXCEL in PHP converteert.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar EXCEL te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar EXCEL converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar EXCEL.
...
1.  Converteer MHTML naar EXCEL door de opslagmethode van Workbook aan te roepen.
