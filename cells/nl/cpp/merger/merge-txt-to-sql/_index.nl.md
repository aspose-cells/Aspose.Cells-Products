---
title: Voeg TXT samen met SQL - Combineer TXT met SQL in C++
url: /nl/cpp/merger/merge-txt-to-sql/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online samenvoegen TXT naar SQL-opslagformaat. C++ Combineer TXT naar SQL-indeling. Voeg TXT samen met SQL in C++. TXT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis TXT samen met SQL in C++ online" %}}

Het volgende voorbeeld laat zien hoe u TXT kunt samenvoegen met SQL in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TXT samen te voegen met SQL. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een SQL-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat TXT samenvoegt met SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om TXT samen te voegen met SQL in C++" InputFormat="txt" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe TXT samen te voegen met SQL via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met SQL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TXT samen te voegen met SQL" %}}
