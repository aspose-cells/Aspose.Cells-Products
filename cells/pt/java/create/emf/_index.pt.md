---
title: Criar EMF - Criar arquivo EMF em Java
description: Aspose Excel. Java Criar EMF Arquivo. Criar EMF Java. Java EMF Criador. Crie EMF em Java. Gere o arquivo EMF usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo EMF em Java" h2="Biblioteca Java de alta velocidade para criar o arquivo EMF. Esta é uma solução de software profissional para importar e exportar XLSX, PDF e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como criar EMF em Java" %}}
...
1.  Salve a pasta de trabalho no formato EMF usando o método save().

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo EMF em Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para criar o arquivo EMF" %}}
{{% blocks/products/pf/agp/text %}}
