...
Нужно программно конвертировать XML-файлы в SQL? .NET разработчики могут легко загружать и преобразовывать XML в SQL, написав всего несколько строк кода.
