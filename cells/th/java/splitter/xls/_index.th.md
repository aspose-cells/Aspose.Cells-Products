---
title:  แยก XLS ไฟล์ via Java
weight: 610
description: โค้ดตัวอย่าง Java เพื่อแยกเอกสาร XLS บน Java Runtime Environment สำหรับ JSP/JSF Application และ Desktop Applications
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แยก XLS ไฟล์ via Java" h2="XLS แยกด้วยความช่วยเหลือของห้องสมุด Java ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแยกไฟล์ XLS ใน Java" %}}
...
+ โหลดไฟล์ XLS โดยใช้คลาสสมุดงาน
+ วนซ้ำแต่ละแผ่น
+ สร้างวัตถุคลาสสมุดงานใหม่
+ คัดลอกแผ่นงานที่เลือกไปยังวัตถุใหม่
+ เรียกวิธีการบันทึกด้วยเส้นทางไฟล์ใหม่ XLS
...
{{% blocks/products/pf/agp/code-block title="แยก XLS ไฟล์ - Java" offSpacer="" %}}
