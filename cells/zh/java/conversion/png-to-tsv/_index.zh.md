---
title: Java PNG 转 TSV - 在线 PNG 转 TSV 转换器
description: Aspose Excel。 Java Aspose.Cells。Java Aspose Cells。免费在线 Java 将 PNG 转换为 TSV 保存格式。 Java PNG 到 TSV 格式。将 PNG 保存为 TSV Java。
...
{{% blocks/products/pf/agp/content h2="免费在线保存 PNG 至 TSV 于 Java" %}}

以下示例演示如何将 Java 中的 PNG 转换为 TSV。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 PNG 转换为 TSV。上传您的 PNG 文件，然后只需将其另存为 TSV 文件。对于 PNG 读取和 TSV 写入，您可以使用完全限定的文件名。输出 TSV 内容和格式将与原始 PNG 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免费应用程序和示例代码可在线将 PNG 转换为 TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何转换 PNG 为 TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 PNG 文件转换为 TSV 吗？ Java开发人员只需几行代码即可轻松将PNG转换为TSV。
...
1. 通过调用Workbook.save方法将PNG转换为TSV。
1. 获取PNG到TSV的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java库将PNG转换为TSV" %}}
{{% blocks/products/pf/agp/text %}}
