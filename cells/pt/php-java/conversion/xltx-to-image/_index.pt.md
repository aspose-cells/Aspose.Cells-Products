---
title: PHP XLTX para IMAGEM - XLTX para conversor de IMAGEM
description: Aspose Excel. Converta XLTX em IMAGE de forma rápida e fácil com Aspose.Cells. PHP XLTX em IMAGE. PHP Salve XLTX em IMAGEM. Salve XLTX como IMAGEM usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX para IMAGEM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em IMAGE programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em IMAGE em apenas algumas linhas de código.
...
1.  Converta XLTX em IMAGE chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de XLTX para IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter XLTX em IMAGE" %}}
