---
title: Převodník PHP XLAM na MD – XLAM na MD
description: Aspose Excel. Převeďte XLAM na MD rychle a snadno pomocí Aspose.Cells. PHP XLAM na MD. PHP Uložit XLAM na MD. Uložte XLAM jako MD pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést XLAM na MD přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XLAM soubory na MD programově? Vývojáři PHP mohou snadno načíst a převést XLAM na MD v několika řádcích kódu.
...
1.  Převeďte XLAM na MD voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na MD" %}}
