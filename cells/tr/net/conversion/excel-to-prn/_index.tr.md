...
EXCEL dosyalarını program aracılığıyla PRN'ye dönüştürmeniz mi gerekiyor? .NET geliştiriciler yalnızca birkaç satır kodla kolayca EXCEL'i PRN'ye yükleyebilir ve dönüştürebilir.
...
1. Workbook.Save yöntemini çağırarak EXCEL dosyasını PRN formatına dönüştürün.
