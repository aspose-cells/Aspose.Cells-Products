...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie OTS online z formatem zapisu XLS. C# Połącz OTS z formatem XLS. Połącz OTS z XLS w C#. Połącz OTS.
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z XLS za pomocą C#" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z XLS w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić OTS z XLS w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić OTS z XLS. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku XLS. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z XLS.
...
{{% blocks/products/pf/agp/content h2="Jak połączyć OTS z XLS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć OTS z numerem XLS? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia OTS z XLS" %}}
