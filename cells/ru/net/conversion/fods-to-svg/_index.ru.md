...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в SVG в C#" %}}
...
Нужно программно преобразовать файлы FODS в SVG? Разработчики .NET могут легко загрузить и преобразовать FODS в SVG всего за несколько строк кода.
...
1.  Преобразуйте значение FODS в SVG, вызвав метод Workbook.Save.
