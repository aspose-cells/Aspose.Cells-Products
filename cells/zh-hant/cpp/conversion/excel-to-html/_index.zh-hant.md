...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 EXCEL 轉換為 HTML。C++ EXCEL 到 HTML。C++ 將 EXCEL 儲存為 HTML。
...
{{< blocks/products/pf/i18n/upper-banner h1="將EXCEL中的C++轉換為HTML" h2="使用 C++ 函式庫進行高效能 EXCEL 到 HTML 轉換，無需安裝 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將EXCEL保存到C++中的HTML" %}}

下面的範例示範如何將EXCEL中的C++轉換為HTML。
...
{{% cells-convert title="將 EXCEL 轉換為 HTML 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="html" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 EXCEL 轉換為 HTML" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 EXCEL 檔案轉換為 HTML？ C++開發人員只需幾行程式碼即可輕鬆將EXCEL轉換為HTML。
