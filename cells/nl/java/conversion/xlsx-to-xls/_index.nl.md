...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in XLS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar XLS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar XLS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar XLS? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar XLS met slechts een paar regels code.
