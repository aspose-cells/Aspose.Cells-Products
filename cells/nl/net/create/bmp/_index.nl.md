...
{{% blocks/products/pf/agp/content h2="Hoe BMP te maken in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een BMP-bestand maakt in C#." offSpacer="" %}}
