...
+ Laad alle XLTX-bestanden met volledig pad.
...
+ Roep de Save()-methode aan en geef de bestandsnaam (volledig pad) en formaat (XLTX) door als parameter.
+ Nu kunt u het bestand XLTX openen en gebruiken in Microsoft Office, Adobe PDF of een ander compatibel programma.
