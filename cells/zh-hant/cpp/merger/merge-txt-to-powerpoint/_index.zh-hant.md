...
以下示例演示如何將 TXT 合併到 Aspose.Cells for C++ 中的 POWERPOINT。
...
需要以編程方式將 TXT 合併到 POWERPOINT 嗎？基本文檔合併和連接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++ 庫將 TXT 合併到 POWERPOINT" %}}
