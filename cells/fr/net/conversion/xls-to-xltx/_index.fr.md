---
title: Convertisseur C# XLS à XLTX - XLS à XLTX
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format XLS au format XLTX, permettant un enregistrement transparent des données XLS au format XLTX à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS au lieu de XLTX dans C#" %}}

L'exemple suivant montre comment convertir XLS en XLTX dans C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en XLTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en XLTX par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en XLTX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en XLTX" %}}
