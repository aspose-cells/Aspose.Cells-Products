---
title: XLSX mit WORD zusammenführen – Kombinieren Sie XLSX mit WORD in C++
url: /de/cpp/merger/merge-xlsx-to-word/ 
description: Aspose Excel. C++ Aspose.Cells. Kostenlose Online-Zusammenführung von XLSX in das WORD-Speicherformat. C++ Kombinieren Sie XLSX in das WORD-Format. XLSX mit WORD in C++ zusammenführen. XLSX Zusammenführen.
...
Das folgende Beispiel zeigt, wie XLSX mit WORD in Aspose.Cells for C++ zusammengeführt wird.
...
{{% cells-merger title="Kostenlos online zum Zusammenführen von XLSX mit WORD in C++" InputFormat="xlsx" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie XLSX über C++ mit WORD zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie XLSX programmgesteuert mit WORD zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
