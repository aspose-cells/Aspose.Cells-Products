...
description: Aspose Excel. Μετατρέψτε το OTS σε XLS γρήγορα και εύκολα με το Aspose.Cells. Python OTS σε XLS. Python Αποθήκευση OTS σε XLS. Αποθηκεύστε το OTS ως 07617837481 χρησιμοποιώντας 3.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το OTS στο XLS στο Python" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το OTS σε XLS στο Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python βιβλιοθήκη για μετατροπή OTS σε XLS" %}}
