---
title: Converteer TSV naar MHTML via Java 
weight: 4970
url: /nl/java/conversion/tsv-to-mhtml/ 
description: Voorbeeld Java conversiecode voor TSV-indeling naar MHTML-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar MHTML te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer TSV naar MHTML via Java" h2="TSV naar MHTML Java conversie om enkele of meerdere pagina\'s naar MHTML te converteren met behulp van een lokale bibliotheek Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe TSV naar MHTML te converteren met Java" %}}

 Om TSV naar MHTML te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TSV naar MHTML te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen TSV-bestanden gemakkelijk in slechts een paar regels code naar MHTML converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad TSV-bestand met een exemplaar van de werkmapklasse1. Bel de methode Workbook.save1. Geef het uitvoerpad door met de MHTML-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende MHTML-bestand
...
{{% blocks/products/pf/agp/code-block title="TSV naar MHTML Java Conversiebroncode" offSpacer="" %}}

```cs
// laad het TSV-bestand in een exemplaar van Workbook
Workbook book = new Workbook("template.tsv");
// sla TSV op als MHTML
