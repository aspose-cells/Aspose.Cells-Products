---
title: 将矩形插入Excel via .NET
weight: 240
description: C# 使用 .NET 库向 Excel 添加或插入矩形的示例代码。使用此代码可在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中的 MS Excel 中创建矩形。
keywords: [C# Aspose.Cells., c# add Rectangle., c# insert Rectangle., c# create Rectangle]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="将矩形插入Excel via .NET" h2="使用 Aspose.Cells\' API 插入矩形，无需使用 Microsoft 或 Open Office、Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过C#将矩形插入Excel文件的步骤" %}}
...
+ 通过索引选择工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addrectangle)在选定的工作表中插入一个矩形
以 XLSX 格式保存工作簿。
