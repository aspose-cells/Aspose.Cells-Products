...
{{% blocks/products/pf/agp/content h2="كيفية إدراج صورة في ملف Excel باستخدام Python" %}}

 من أجل إدراج صورة في ملف إكسل ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج الصورة في ملف اكسل عن طريق Python" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم مجموعة الصور[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) لإدراج صورة في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل الصورة - Python" offSpacer="" %}}
