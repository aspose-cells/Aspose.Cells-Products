---
title:  Επεξεργασία ή προβολή ODS Μεταδεδομένα εγγράφου μέσω C++
weight: 1000
...
{{% blocks/products/pf/agp/content h2="Πώς να λάβετε μεταδεδομένα ODS χρησιμοποιώντας το C++" %}}
...
+ Φόρτωση αρχείου ODS χρησιμοποιώντας το CreateIWorkbookMetadata
