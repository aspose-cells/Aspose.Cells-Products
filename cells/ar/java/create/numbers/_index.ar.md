---
title: إنشاء أرقام - قم بإنشاء ملف أرقام في Java
description:  Aspose اكسل. Java قم بإنشاء ملف NUMBERS بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف NUMBERS باستخدام Java. أنشئ ملف NUMBERS في Java. Java NUMBERS Creator.
...
{{< blocks/products/pf/i18n/upper-banner h1="قم بإنشاء ملف أرقام في Java" h2="مكتبة Java عالية السرعة لإنشاء ملف NUMBERS. هذا حل برمجي احترافي لاستيراد وتصدير XLSX وPDF والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء أرقام في Java" %}}
...
1.  احفظ المصنف بتنسيق NUMBERS باستخدام طريقة save().

{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف NUMBERS في Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لإنشاء ملف NUMBERS" %}}
{{% blocks/products/pf/agp/text %}}
