...
{{% blocks/products/pf/agp/content h2="Преобразовать HTM в PDF, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM-код в PDF в Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в PDF в Java.
...
Нужно программно преобразовать HTM-файлы в формат PDF? Разработчики, использующие формат Java, могут легко преобразовать HTM в формат PDF всего несколькими строками кода.
