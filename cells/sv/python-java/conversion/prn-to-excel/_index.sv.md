---
title: Python PRN till EXCEL - Online PRN till EXCEL-omvandlare
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Gratis online Python Konvertera PRN till EXCEL sparaformat. Python PRN till EXCEL-format. Spara PRN till EXCEL Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera PRN till EXCEL i Python" h2="Höghastighets Python-bibliotek för att konvertera PRN till EXCEL. Detta är en professionell mjukvarulösning för att importera och exportera PRN, EXCEL och många andra format med Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="Gratis app och provkod för att konvertera PRN till EXCEL online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar PRN till EXCEL via Python" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera PRN-filer till EXCEL programmatiskt? Python-utvecklare kan enkelt ladda och konvertera PRN till EXCEL på bara några rader kod.
...
1.  Konvertera PRN till EXCEL genom att anropa Workbook.save-metoden.
1.  Få konverteringsresultatet från PRN till EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python bibliotek för att konvertera PRN till EXCEL" %}}
