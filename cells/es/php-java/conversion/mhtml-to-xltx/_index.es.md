---
title: Convertidor PHP MHTML a XLTX - MHTML a XLTX
description: Aspose Excel. Convierta MHTML a XLTX rápida y fácilmente con Aspose.Cells. PHP MHTML a XLTX. PHP Guarde MHTML a XLTX. Guarde MHTML como XLTX usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MHTML a XLTX mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos MHTML a XLTX mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente MHTML a XLTX en tan solo unas pocas líneas de código.
...
1.  Convierta MHTML a XLTX llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de MHTML a XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir MHTML a XLTX" %}}
