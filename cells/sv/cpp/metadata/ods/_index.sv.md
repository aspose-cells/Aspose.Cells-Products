...
weight: 1000
description: C++ exempelkod för att redigera eller visa ODS filmetadata på C++ Runtime Environment för Windows 32 bitar, Windows 64 bitar och Linux 64 bitar.
---
...
{{% blocks/products/pf/agp/content h2="Hur man får ODS metadata med C++" %}}
...
+ Ladda ODS-filen med CreateIWorkbookMetadata
