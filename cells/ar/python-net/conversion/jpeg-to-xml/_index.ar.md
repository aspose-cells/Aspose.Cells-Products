---
title: Python JPEG إلى XML - JPEG إلى XML محول
description: Aspose اكسل. Python Aspose.Cells. JPEG إلى XML في Python. Python تحويل JPEG إلى تنسيق حفظ XML. Python JPEG إلى تنسيق XML. احفظ JPEG في XML Python.
...
هل تحتاج إلى تحويل ملفات JPEG إلى XML برمجياً؟ يمكن لمطوري Python تحميل وتحويل JPEG بسهولة إلى XML في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل JPEG إلى XML عن طريق استدعاء طريقة Workbook.save.
