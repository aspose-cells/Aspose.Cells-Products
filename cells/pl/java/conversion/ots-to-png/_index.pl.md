...
description: Aspose Excel. Konwertuj OTS na PNG szybko i łatwo za pomocą Aspose.Cells. Java OTS na PNG. Java Zapisz OTS na PNG. Zapisz OTS jako PNG, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS pod numerem PNG w Java" %}}

Poniższy przykład ilustruje sposób konwersji OTS na PNG w Java.
...
Chcesz programowo przekonwertować pliki OTS na PNG? Programiści Java mogą z łatwością przekonwertować OTS na PNG w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na PNG" %}}
{{% blocks/products/pf/agp/text %}}
