---
title: Fusionar XLSM con XML - Combinar XLSM con XML en Java
url: /es/java/merger/merge-xlsm-to-xml/ 
description: Aspose Excel. Java Aspose.Cells. Fusionar XLSM con el formato de guardado XML. Java Combine XLSM al formato XML. Fusionar XLSM con XML en Java. XLSM Fusionar.
...
{{% blocks/products/pf/agp/content h2="Fusionar XLSM con XML en Java" %}}

El siguiente ejemplo demuestra cómo fusionar XLSM con XML en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLSM con XML. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo XML. Si desarrolla código en Java, esto será más simple de lo que parece. Vea el ejemplo de Java que combina XLSM con XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar XLSM con XML en Java" InputFormat="xlsm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM con XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar XLSM con XML mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Java para fusionar XLSM con XML" %}}
