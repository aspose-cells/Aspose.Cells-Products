---
title:  Hợp nhất XML sang WORD qua Python
...
Ví dụ sau minh họa cách hợp nhất XML với WORD trong Python.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất XML với WORD trực tuyến" InputFormat="xml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
