...
description: Aspose Excel. Converta TABDELIMITED em XLSB de forma rápida e fácil com Aspose.Cells. PHP TABDELIMITED em XLSB. PHP Salve TABDELIMITED em XLSB. Salve TABDELIMITED como XLSB usando PHP.
...
Precisa converter arquivos TABDELIMITED para XLSB programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TABDELIMITED em XLSB em apenas algumas linhas de código.
...
1.  Converta TABDELIMITED em XLSB chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TABDELIMITED para XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED para XLSB" %}}
