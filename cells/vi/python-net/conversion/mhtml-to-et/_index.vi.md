...
description: Aspose Excel. Chuyển đổi MHTML sang ET nhanh chóng và dễ dàng với Aspose.Cells. Python MHTML sang ET. Python Lưu MHTML vào ET. Lưu MHTML dưới dạng ET bằng cách sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi MHTML sang ET trong Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu MHTML vào ET vào Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi MHTML sang ET trong Python via NET.
...
{{% cells-convert title="Mã mẫu để chuyển đổi MHTML sang ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="et" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python để chuyển đổi MHTML sang ET" %}}
