...
Hai bisogno di convertire i file MHT in POWERPOINT tramite codice? Gli sviluppatori di C++ possono convertire facilmente i file MHT in POWERPOINT in poche righe di codice.
...
1.  Convertire MHT in POWERPOINT chiamando il metodo Save().
