---
title: Converteer SPREADSHEETML naar DIF via Python
url: /nl/python-java/conversion/spreadsheetml-to-dif/
description: Voorbeeldcode voor spreadsheetml naar diff Python-conversie. Gebruik API voorbeeldcode voor batch-spreadsheetml-bestanden voor dif-conversie binnen Python-toepassing.
---
...
{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML naar DIF te converteren met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om SPREADSHEETML naar DIF te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen eenvoudig SPREADSHEETML-bestanden laden en converteren naar DIF in slechts een paar regels code.
