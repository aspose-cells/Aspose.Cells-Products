...
+ استخدم طريقة إضافة Shapecollection لإدراج WordArt في ورقة العمل المحددة.
...
-  قم بتثبيت Aspose.Cells for Python via .NET من<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> ، استخدم الأمر على النحو التالي:<code>$ pip install aspose-cells-python</code>.
