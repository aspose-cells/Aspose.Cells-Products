---
title: C# NUMBERS から PRN - NUMBERS から PRN へのコンバーター
description: Aspose エクセル。 Aspose.Cellsを使用して、NUMBERSをPRNにすばやく簡単に変換します。C# NUMBERSをPRNに変換します。 C# 番号を PRN に保存してください。 C# を使用して NUMBERS を PRN として保存します。
...
{{% blocks/products/pf/agp/content h2="番号を PRN C# に保存" %}}
...
{{% cells-convert title="NUMBERS を PRN に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="prn" IsLandingPage="true" %}}
