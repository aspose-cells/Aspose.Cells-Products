---
title: PHP XLAM إلى XLSX - XLAM إلى XLSX محول
description: Aspose اكسل. قم بتحويل XLAM إلى XLSX بسرعة وسهولة باستخدام Aspose.Cells. PHP XLAM إلى XLSX. PHP احفظ XLAM إلى XLSX. احفظ XLAM كـ XLSX باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLAM إلى XLSX عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLAM إلى XLSX برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLAM إلى XLSX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLAM إلى XLSX عن طريق استدعاء طريقة حفظ المصنف.
