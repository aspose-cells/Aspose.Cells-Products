...
description: Aspose Excel. Chuyển đổi MHTML sang SXC nhanh chóng và dễ dàng với Aspose.Cells. Python MHTML sang SXC. Python Lưu MHTML thành SXC. Lưu MHTML thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Lưu MHTML vào SXC trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi MHTML thành SXC trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi MHTML thành SXC" %}}
