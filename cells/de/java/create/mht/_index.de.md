...
{{% blocks/products/pf/agp/content h2="So erstellen Sie MHT in Java" %}}
...
1.  Speichern Sie die Arbeitsmappe mit der Methode save() im MHT-Format.

{{% blocks/products/pf/agp/code-block title="Der Beispielcode zeigt, wie eine MHT-Datei in Java erstellt wird." offSpacer="" %}}
