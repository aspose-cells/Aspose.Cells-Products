---
title: Slå samman XLTX till XLSM - Kombinera XLTX till XLSM i C#
url: /sv/net/merger/merge-xltx-to-xlsm/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge XLTX till XLSM sparaformat. C# Kombinera XLTX till XLSM format. Slå samman XLTX till XLSM i C#. XLTX Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman XLTX till XLSM i C# Online gratis" %}}

Följande exempel visar hur man slår samman XLTX till XLSM i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman XLTX till XLSM. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen XLSM. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman XLTX till XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman XLTX till XLSM i C#" InputFormat="xltx" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLTX till XLSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLTX till XLSM programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XLTX till XLSM" %}}
