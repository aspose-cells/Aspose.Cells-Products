---
title: Combinar XLSM a HTM - Combinar XLSM a HTM en Java
url: /es/java/merger/merge-xlsm-to-htm/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLSM para guardar formato HTM. Java Combine XLSM en formato HTM. Combinar XLSM a HTM en Java. XLSM Combinar.
keywords: [Aspose Excel., Java Aspose.Cells., Merge XLSM to HTM in Java., Free Online Java Merge XLSM to htm., Java Combine XLSM to HTM Online for Free., XLSM Merge]
---
...
El siguiente ejemplo muestra cómo combinar XLSM con HTM en Aspose.Cells for Java.
...
{{% cells-merger title="Gratis en línea para fusionar XLSM a HTM en Java" InputFormat="xlsm" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM a HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar XLSM con HTM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
