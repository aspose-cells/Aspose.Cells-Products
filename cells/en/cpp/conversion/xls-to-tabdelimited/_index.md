...
description: Sample C++ conversion code for XLS to TABDELIMITED format. Programmers can use this source code for batch XLS to TABDELIMITED conversion within any C++ Application.
---
