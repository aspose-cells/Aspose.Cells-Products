---
title: دمج ODS في SPREADSHEETML - دمج ODS في SPREADSHEETML في C++
url: /ar/cpp/merger/merge-ods-to-spreadsheetml/ 
description: Aspose اكسل. C++ Aspose.Cells. دمج ODS في تنسيق حفظ SPREADSHEETML. C++ قم بدمج ODS إلى تنسيق SPREADSHEETML. دمج ODS في جدول البيانات C++. ODS دمج.
...
{{% blocks/products/pf/agp/content h2="دمج ODS في جدول البيانات في C++" %}}

يوضح المثال التالي كيفية دمج ODS في SPREADSHEETML في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج ODS في SPREADSHEETML. قم بتحميل ملفاتك، واستدعاء طريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف SPREADSHEETML. إذا قمت بتطوير التعليمات البرمجية في C++، فسيكون هذا أبسط مما يبدو. راجع مثال C++ الذي يدمج ODS في SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج التعليمات البرمجية لدمج ODS في SPREADSHEETML في C++" InputFormat="ods" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج ODS في جدول البيانات عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج ODS في SPREADSHEETML برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لدمج ODS في SPREADSHEETML" %}}
