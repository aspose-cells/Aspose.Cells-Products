---
title: PHP HTM na OTS - Konwerter HTM na OTS
description: Aspose Excel. Szybko i łatwo przekonwertuj HTM na OTS za pomocą Aspose.Cells. PHP HTM na OTS. PHP Zapisz HTM w OTS. Zapisz HTM jako OTS przy użyciu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTM na OTS przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki HTM na OTS? Programiści PHP mogą łatwo załadować i przekonwertować HTM na OTS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj HTM na OTS, wywołując metodę zapisu skoroszytu.
