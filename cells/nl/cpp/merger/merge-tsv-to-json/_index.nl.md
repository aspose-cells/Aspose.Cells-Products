...
description: Aspose Excel. C++ Aspose.Cells. Voeg TSV samen met het opslagformaat JSON. C++ Combineer het formaat TSV met JSON. Voeg TSV samen met JSON in C++. TSV Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg TSV samen met JSON in C++" %}}

Het volgende voorbeeld laat zien hoe u TSV samenvoegt met JSON in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TSV samen te voegen met JSON. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand JSON. Als u code ontwikkelt in C++, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C++ waarin TSV wordt samengevoegd met JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om TSV samen te voegen met JSON in C++" InputFormat="tsv" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe u TSV samenvoegt met JSON via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TSV programmatisch samenvoegen met JSON? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TSV samen te voegen met JSON" %}}
