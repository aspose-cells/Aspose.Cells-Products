...
{{% blocks/products/pf/agp/content h2="Сохранение XML в изображение в C++" %}}

В следующем примере показано, как преобразовать XML в IMAGE в файле C++.
...
Нужно программно преобразовать XML-файлы в изображения? Разработчики, использующие код C++, могут легко преобразовать XML в изображения всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для преобразования XML в изображение." %}}
