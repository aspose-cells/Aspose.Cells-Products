...
weight: 2380
description: C++ voorbeeldcode om met een wachtwoord beveiligd bestand XLS te ontgrendelen op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ontgrendel XLS-bestanden via C++" h2="Beveiliging verwijderen van Excel-spreadsheets inclusief XLS-bestand met behulp van C++-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe de bescherming van het bestand XLS te verwijderen met behulp van C++" %}}
...
1.  Laad XLS vergrendeld bestand met behulp van CreateIWorkbook.
1.  Roep de functie Unprotect() aan om te ontgrendelen.
1.  Stel het wachtwoord in op NULL met behulp van SetPassword.
1.  Bewaar het XLS-bestand op een opgegeven locatie.
