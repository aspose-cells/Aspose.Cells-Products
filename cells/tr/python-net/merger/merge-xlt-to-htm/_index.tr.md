...
Aşağıdaki örnek, XLT'in Aspose.Cells for Python via .NET'de HTM ile nasıl birleştirileceğini gösterir.
...
XLT'i programlı olarak HTM ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
