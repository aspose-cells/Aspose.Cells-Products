---
title: Voeg PNG samen met TIFF - Combineer PNG met TIFF in C#
url: /nl/net/merger/merge-png-to-tiff/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen PNG naar TIFF saveformat. C# Combineer het formaat PNG tot TIFF. Samenvoegen PNG tot TIFF in C#. PNG Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg PNG samen met TIFF in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u PNG samenvoegt met TIFF in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PNG samen te voegen met TIFF. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand TIFF. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat PNG samenvoegt met TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om PNG samen te voegen tot TIFF in C#" InputFormat="png" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe PNG samen te voegen met TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PNG programmatisch samenvoegen tot TIFF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen tot TIFF" %}}
