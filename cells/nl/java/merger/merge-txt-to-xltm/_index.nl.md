---
title: Voeg TXT samen met XLTM - Combineer TXT met XLTM in Java
url: /nl/java/merger/merge-txt-to-xltm/ 
description: Aspose Excel. Java Aspose.Cells. Voeg TXT samen met het opslagformaat XLTM. Java Combineer het formaat TXT met XLTM. Voeg TXT samen met XLTM in Java. TXT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met XLTM in Java" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met XLTM in Aspose.Cells for Java.
...
{{% blocks/products/pf/agp/content h2="Hoe u TXT samenvoegt met XLTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met XLTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om TXT samen te voegen met XLTM" %}}
