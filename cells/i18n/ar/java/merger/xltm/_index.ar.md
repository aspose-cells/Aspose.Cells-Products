...
{{% blocks/products/pf/agp/content h2="كيفية دمج ملفات XLTM باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات دمج ملفات XLTM في Java" %}}
...
+ قم بتحميل أول ملف XLTM بنسخة من فئة المصنف.
+ قم بتحميل مستند XLTM الثاني بنسخة من فئة المصنف.
+ دمج الملفات باستخدام طريقة ().
+ احفظ ملف XLTM المدمج في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="دمج ملفات XLTM - Java" offSpacer="" %}}
