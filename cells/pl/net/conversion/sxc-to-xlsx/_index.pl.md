---
title: C# SXC do XLSX - SXC do XLSX Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu SXC do XLSX, umożliwiając bezproblemowe zapisywanie danych SXC do formatu XLSX za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz SXC do XLSX w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować SXC na XLSX w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer SXC na numer XLSX. Prześlij plik SXC, a następnie po prostu zapisz go jako plik XLSX. Zarówno do odczytu SXC, jak i do zapisu XLSX można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego XLSX będą identyczne z oryginalnym dokumentem SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji SXC na XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="sxc" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować SXC na XLSX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki SXC na XLSX? Programiści .NET mogą łatwo załadować i przekonwertować SXC na XLSX w zaledwie kilku linijkach kodu.
