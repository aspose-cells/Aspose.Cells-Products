---
title: Python via Java'i kullanarak Excel'e kavisli şekil nasıl çizilir veya eklenir?
weight: 10
description: Microsoft veya Open Office, Adobe PDF vb. gibi herhangi bir yazılım olmadan Aspose.Cells' Python via Java API'i kullanarak kavisli şekil çizin veya ekleyin.
keywords: [Python Aspose.Cells., Python add curved shape., Python insert curved shape., Python create curved shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java\'i kullanarak Excel\'e kavisli şekil ekleyin" h2="Aspose.Cells\' API\'i kullanarak, Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan kavisli şekil ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java Kullanarak Excel Dosyasına Kavisli Şekil Nasıl Eklenir?" %}}

 Excel dosyasına kavisli şekil eklemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java\'i kullanarak Excel dosyasına kavisli şekil ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Şekil koleksiyonunu kullanın[yöntem ekle](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) seçili çalışma sayfasına kavisli bir şekil eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Kavisli şekil ekleyin - Python via Java" offSpacer="" %}}
