---
title: تحويل SXC إلى TABDELIMITED عبر Java 

description: نموذج رمز تحويل Java لتنسيق SXC إلى ملف TABDELIMITED. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel و OpenOffice إلى TABDELIMITED داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل SXC إلى TABDELIMITED عبر Java" h2="تحويل SXC إلى TABDELIMITED Java لتحويل صفحة واحدة أو صفحات متعددة إلى TABDELIMITED باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل SXC إلى TABDELIMITED باستخدام Java" %}}

 من أجل تقديم SXC إلى TABDELIMITED ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل SXC إلى TABDELIMITED عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java يمكن للمطورين بسهولة تحويل ملف SXC إلى TABDELIMITED في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف SXC مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. تمرير مسار الإخراج مع امتداد TABDELIMITED & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف TABDELIMITED الناتج
...
{{% blocks/products/pf/agp/code-block title="SXC إلى TABDELIMITED Java رمز مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف SXC في مثيل مصنف
Workbook book = new Workbook("template.sxc");
// حفظ SXC كـ TABDELIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC إلى TABDELIMITED تحويل العروض الحية" sectionDescription="[تحويل SXC إلى TABDELIMITED](https://products.aspose.app/cells/conversion/sxc-to-tabdelimited) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف SXC الخاص بك ، وسيتم تحويله على الفور إلى TABDELIMITED." >}}
