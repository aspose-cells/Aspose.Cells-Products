...
以下示例演示如何将 XLTM 合并到 Aspose.Cells for Python via Java 中的 ETT。
...
需要以编程方式将 XLTM 合并到 ETT？基本文档合并和连接[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需几行代码即可完成 API。
