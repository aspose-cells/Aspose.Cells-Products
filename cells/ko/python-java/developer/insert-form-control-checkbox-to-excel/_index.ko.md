...
weight: 30
description: Python via Excel에 CheckBox(양식 컨트롤)를 삽입하는 Java 소스 코드입니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via java를 사용하여 Excel에 CheckBox(양식 컨트롤) 삽입" h2="Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 서버 측 API를 사용하여 개체를 삽입합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via을 사용하여 Excel 파일에 CheckBox(양식 컨트롤)를 삽입하는 방법 java" %}}
 ...
 CheckBox(양식 컨트롤)를 Excel 파일에 삽입하기 위해 다음을 사용합니다.
...
+ 색인을 통해 워크시트를 선택합니다.
 + Shapecollection을 사용하세요[메소드 추가](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int))을 선택하면 선택한 워크시트에 CheckBox(양식 컨트롤)를 삽입할 수 있습니다.
