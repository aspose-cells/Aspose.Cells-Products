---
title: C# JPG en MD - Convertisseur JPG en MD
description: Aspose Exceller. Convertissez JPG en MD rapidement et facilement avec Aspose.Cells. C# JPG en MD. C# Enregistrez JPG sur MD. Enregistrez JPG au format MD en utilisant le C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer JPG sur MD au C#" %}}

L'exemple suivant montre comment convertir JPG en MD en C#.
...
{{% cells-convert title="Exemple de code pour convertir JPG en MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en MD par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en MD en quelques lignes de code seulement.
...
1.  Convertissez JPG en MD en appelant la méthode Workbook.Save.
