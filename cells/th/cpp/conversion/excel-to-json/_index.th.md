---
title: C++ EXCEL เป็น JSON - ตัวแปลง EXCEL เป็น JSON ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง EXCEL เป็น JSON บันทึกรูปแบบ รูปแบบ C++ EXCEL เป็น JSON บันทึก EXCEL ไปที่ JSON C++
...
{{% blocks/products/pf/agp/content h2="บันทึก EXCEL เป็น JSON ใน C++ ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง EXCEL เป็น JSON ใน C++
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อแปลง EXCEL เป็น JSON อัปโหลดไฟล์ EXCEL ของคุณ จากนั้นบันทึกเป็นไฟล์ JSON สำหรับทั้งการอ่าน EXCEL และการเขียน JSON คุณสามารถใช้ชื่อไฟล์แบบเต็มได้ เนื้อหาและการจัดรูปแบบเอาต์พุต JSON จะเหมือนกับเอกสาร EXCEL ต้นฉบับ

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="แอพฟรีและโค้ดตัวอย่างเพื่อแปลง EXCEL เป็น JSON ออนไลน์" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="json" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง EXCEL เป็น JSON โดยเรียกเมธอด Save()
1.  รับผลการแปลงของ EXCEL เป็น JSON
