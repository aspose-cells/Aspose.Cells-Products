...
description: Aspose Excel โซลูชันที่ครอบคลุมนี้มอบแนวทางแบบบูรณาการอย่างสมบูรณ์แก่ผู้พัฒนา C++ ในการแปลง TXT เป็นรูปแบบ FODS ทำให้สามารถบันทึกข้อมูล TXT ลงในรูปแบบ FODS ได้อย่างราบรื่นโดยใช้ไลบรารี Aspose.Cells ทั้งหมดนี้ผ่านโค้ด C++ ที่มีประสิทธิภาพและปรับแต่งได้
...
{{% blocks/products/pf/agp/content h2="บันทึกหมายเลข TXT เป็น FODS ในหมายเลข C++" %}}

ตัวอย่างต่อไปนี้แสดงวิธีการแปลง TXT เป็น FODS ใน C++
...
ต้องการแปลงไฟล์ TXT เป็น FODS โดยใช้โปรแกรมหรือไม่? นักพัฒนา C++ สามารถแปลง TXT เป็น FODS ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี C++ เพื่อแปลง TXT เป็น FODS" %}}
