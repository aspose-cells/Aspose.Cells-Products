...
description: Aspose Excel. Konwertuj XML na TIFF szybko i łatwo za pomocą Aspose.Cells. C# XML na TIFF. C# Zapisz XML na TIFF. Zapisz XML jako TIFF używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem TIFF w C#" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na TIFF w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="tiff" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XML na TIFF" %}}
