...
description: Aspose Excel. A JPEG-es számot XLAM-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# JPEG-XLAM-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a JPEG-XLAM számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a JPEG-et XLAM-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a JPEG XLAM-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xlam" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A JPEG konvertálása XLAM-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A JPEG fájlt programozottan XLAM-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a JPEG-et XLAM-re.
...
1.  Konvertálja a JPEG-et XLAM-re a Workbook.Save metódus meghívásával.
1.  Szerezze meg a JPEG-es konverziós eredményt XLAM-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a JPEG konvertálásához XLAM-re" %}}
