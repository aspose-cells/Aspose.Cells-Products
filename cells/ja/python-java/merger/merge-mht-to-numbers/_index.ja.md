---
title: MHT を NUMBERS に結合 - Python で MHT を NUMBERS に結合
url: /ja/python-java/merger/merge-mht-to-numbers/ 
description: Aspose エクセル。 Python Aspose.Cells. 無料オンライン MHT を NUMBERS 保存形式にマージします。 Python MHT を NUMBERS 形式に結合します。 MHT を Python の NUMBERS にマージします。MHT をマージします。
...
次の例は、MHT を Aspose.Cells for Python via Java の NUMBERS にマージする方法を示しています。
...
{{% cells-merger title="MHT を Python の NUMBERS にオンラインで無料でマージ" InputFormat="mht" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python 経由で MHT を NUMBERS にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

MHT をプログラムで NUMBERS にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実行できます。
