...
description: Aspose إكسل. Java إنشاء ملف OTS. قم بإنشاء OTS Java. Java OTS Craduate. قم بإنشاء OTS في Java. قم بإنشاء ملف OTS باستخدام Java.
...
1.  احفظ المصنف بتنسيق OTS باستخدام طريقة الحفظ ().
