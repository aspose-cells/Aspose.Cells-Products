---
title:  Sloučit XLSM na MHTML přes Python
url: /cs/python-net/merger/merge-xlsm-to-mhtml/ 
description: Sloučit XLSM až MHTML online zdarma. Online zdarma XLSM až MHTML Fúze. Sloučit XLSM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSM až MHTML v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až MHTML online" InputFormat="xlsm" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
