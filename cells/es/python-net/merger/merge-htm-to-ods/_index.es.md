---
title: Combinar HTM con ODS - Combinar HTM con ODS en Python
url: /es/python-net/merger/merge-htm-to-ods/ 
description: AsposeExcel. Python Aspose.Cells. Combinación gratuita en línea HTM al ODS guardar formato. Python Combinar HTM al formato ODS. Combinar HTM a ODS en Python. Combinar HTM.
...
{{% blocks/products/pf/agp/content h2="Combinar HTM con ODS usando Python" %}}

 ¿Cómo combino HTM con ODS? Con la biblioteca Aspose.Cells for Python via .NET, puede fusionar fácilmente HTM con ODS mediante programación con unas pocas líneas de código.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hoja de cálculo, también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, por lo que es una opción perfecta para intercambiar documentos en estándar de la industria formatos. Puede instalar Aspose.Cells for Python via .NET desde<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , use el comando como:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Combine HTM con ODS en Python en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar HTM con ODS en Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar HTM con ODS. Cargue sus archivos, llame al método Workbook.Combine para combinar archivos y luego guárdelo en el archivo ODS. Si desarrolla código en Python, esto será más simple de lo que parece. Consulte el ejemplo Python que fusiona HTM con ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar HTM al ODS en Python" InputFormat="htm" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar HTM a ODS a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar HTM con ODS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Python biblioteca para fusionar HTM a ODS" %}}
