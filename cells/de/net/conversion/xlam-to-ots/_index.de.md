...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM bei OTS in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLAM in OTS in C# konvertiert wird.
...
Müssen Sie XLAM-Dateien programmgesteuert in OTS konvertieren? .NET-Entwickler können XLAM in nur wenigen Codezeilen problemlos laden und in OTS konvertieren.
...
1.  Konvertieren Sie XLAM in OTS, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLAM in OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLAM in OTS" %}}
