---
title: Voeg XLSX samen met WORD - Combineer XLSX met WORD in Java
url: /nl/java/merger/merge-xlsx-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online Samenvoegen XLSX naar WORD-opslagformaat. Java Combineer XLSX naar WORD-formaat. Samenvoegen XLSX naar WORD in Java. XLSX Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLSX samen met WORD in Java Online" %}}

Het volgende voorbeeld laat zien hoe u XLSX kunt samenvoegen met WORD in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSX samen te voegen met WORD. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een WORD-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat XLSX samenvoegt met WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om XLSX samen te voegen met WORD in Java" InputFormat="xlsx" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSX samen te voegen met WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met WORD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSX samen te voegen met WORD" %}}
