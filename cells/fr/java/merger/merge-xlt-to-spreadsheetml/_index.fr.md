---
title: Fusionner XLT avec SPREADSHEETML - Combiner XLT avec SPREADSHEETML dans Java
url: /fr/java/merger/merge-xlt-to-spreadsheetml/ 
description: Aspose Exceller. Java Aspose.Cells. Fusionner XLT au format de sauvegarde SPREADSHEETML. Java Combinez XLT au format SPREADSHEETML. Fusionner XLT avec SPREADSHEETML dans Java. XLT Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLT avec SPREADSHEETML dans Java" %}}

L'exemple suivant montre comment fusionner XLT avec SPREADSHEETML dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLT avec SPREADSHEETML. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier SPREADSHEETML. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne XLT avec SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner XLT avec SPREADSHEETML dans Java" InputFormat="xlt" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLT avec SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLT avec SPREADSHEETML par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner XLT avec SPREADSHEETML" %}}
