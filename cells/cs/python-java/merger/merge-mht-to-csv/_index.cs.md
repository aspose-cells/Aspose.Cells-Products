...
url: /cs/python-java/merger/merge-mht-to-csv/ 
...
Následující příklad ukazuje, jak sloučit MHT s CSV v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit MHT na CSV programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
