---
title:  เพิ่ม XLSX คำอธิบายประกอบผ่าน C++
weight: 5260
description: รหัสตัวอย่าง C++ เพื่อเพิ่มหรือลบคำอธิบายประกอบรูปแบบ XLSX บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
---
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการเพิ่มความคิดเห็นใน XLSX ผ่าน C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  โหลดไฟล์ Excel XLSX โดยใช้วัตถุคลาส IWorkbook
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API สามารถใช้เพื่อสร้าง แก้ไข แปลง และแสดงรูปแบบ Microsoft Excel เป็นรูปแบบต่างๆ นอกจากนี้ยังสามารถใช้สำหรับการสร้างแผนภูมิที่ครอบคลุม การรายงานที่ปรับขนาดได้ และการคำนวณที่เชื่อถือได้ภายในแอปพลิเคชันซอฟต์แวร์ Aspose.Cells เป็น API แบบสแตนด์อโลนและไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ OpenOffice
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="เพิ่ม / ลบคำอธิบายประกอบจาก XLSX ผ่านแอพออนไลน์" sectionDescription=" ลบคำอธิบายประกอบเอกสาร XLSX ทันทีโดยไปที่ของเรา[เว็บไซต์สาธิตสด](https://products.aspose.app/cells/annotation). การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
