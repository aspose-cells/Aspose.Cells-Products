...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET разработчики могут легко загружать и преобразовывать XML в ET, написав всего несколько строк кода.
