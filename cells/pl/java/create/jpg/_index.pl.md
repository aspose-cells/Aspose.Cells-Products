---
title: Utwórz JPG - Utwórz plik JPG pod numerem Java
description: Aspose Excel. Bezproblemowo generuj i manipuluj plikami JPG dzięki bibliotece Aspose.Cells for Java. Ta wydajna biblioteka API zapewnia usprawnione i wydajne rozwiązanie do tworzenia, edycji i zarządzania plikami JPG bezpośrednio w aplikacjach Java, spełniając specyficzne potrzeby programistów z wysoką precyzją.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć plik JPG w Java" %}}
...
1.  Zapisz skoroszyt w formacie JPG, używając metody save().

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik JPG w formacie Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do tworzenia plików JPG" %}}
{{% blocks/products/pf/agp/text %}}
