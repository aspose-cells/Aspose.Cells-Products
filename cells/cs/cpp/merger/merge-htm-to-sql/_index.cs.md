...
url: /cs/cpp/merger/merge-htm-to-sql/ 
...
Následující příklad ukazuje, jak sloučit HTM do SQL v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit HTM do SQL programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení HTM do SQL" %}}
