...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики .NET могут легко загружать и преобразовывать XML в HTML всего за несколько строк кода.
