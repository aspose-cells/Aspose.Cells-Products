...
weight: 10
description: Нарисуйте или вставьте форму локтевой стрелки, используя Aspose.Cells' Python via Java API без какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF и т. д.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги, чтобы вставить форму стрелки локтя в файл Excel, используя Python via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить форму стрелки изгиба в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка коленчатая стреловидная - Python via Java" offSpacer="" %}}
