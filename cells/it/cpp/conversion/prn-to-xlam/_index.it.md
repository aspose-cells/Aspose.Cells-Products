...
Hai bisogno di convertire i file PRN in XLAM tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in XLAM in poche righe di codice.
...
1.  Convertire PRN in XLAM chiamando il metodo Save().
