---
title: C# JPG en XLTM - Convertisseur JPG en XLTM
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG au format XLTM, permettant un enregistrement transparent des données JPG au format XLTM à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG sous XLTM dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en XLTM en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir JPG en XLTM. Téléchargez votre fichier JPG, puis enregistrez-le simplement sous le nom de fichier XLTM. Pour la lecture JPG et l'écriture XLTM, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie XLTM seront identiques au document JPG d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir un fichier JPG en XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="xltm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en XLTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en XLTM par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en XLTM en quelques lignes de code.
...
1.  Convertissez le JPG au format XLTM en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en XLTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en XLTM" %}}
