---
title: Java OTS 轉 MHT - OTS 轉 MHT 轉換器
description: Aspose Excel。此綜合解決方案為 Java 開發人員提供了一種完全整合的方法，可將 OTS 轉換為 MHT 格式，從而能夠使用 Aspose.Cells 庫將 OTS 資料無縫儲存為 MHT 格式，所有這些都透過高效且可自訂的 Java 程式碼實現。
...
{{% blocks/products/pf/agp/content h2="將 OTS 儲存到 MHT 中，編號為 Java" %}}

以下範例示範如何在 Java 中將 OTS 轉換為 MHT。
...
{{% blocks/products/pf/agp/content h2="如何將OTS轉換為MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 OTS 檔案轉換為 MHT 檔案嗎？ Java 開發人員只需幾行程式碼即可輕鬆將 OTS 檔案轉換為 MHT 檔案。
...
{{% blocks/products/pf/agp/content h2="Java 庫用於將 OTS 轉換為 MHT" %}}
{{% blocks/products/pf/agp/text %}}
