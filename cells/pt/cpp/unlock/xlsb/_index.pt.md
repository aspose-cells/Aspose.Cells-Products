...
1. Carregue o arquivo bloqueado XLSB usando CreateIWorkbook.1. Chame a função Unprotect() para desbloquear.1. Defina a senha como NULL usando SetPassword.1. Salve o arquivo XLSB em um local especificado.
