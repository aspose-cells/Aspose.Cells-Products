---
title: 合併 XLT 到 EXCEL - 將 XLT 合併到 C# 中的 EXCEL
url: /zh-hant/net/merger/merge-xlt-to-excel/ 
description: Aspose Excel。 C# Aspose.Cells。免費在線合併XLT到EXCEL保存格式。 C# 將XLT合併為EXCEL格式。將 XLT 合併到 C# 中的 EXCEL。 XLT 合併。
...
{{% blocks/products/pf/agp/content h2="免費在線將 XLT 合併為 C# 中的 EXCEL" %}}

下面的例子演示瞭如何將XLT合併到EXCEL中Aspose.Cells for .NET。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLT 合併到 EXCEL。上傳文件，調用Workbook.Combine方法合併文件，然後保存到EXCEL文件。如果您在 C# 中開發代碼，這會比聽起來更簡單。請參閱 C# 將 XLT 合併到 EXCEL 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將XLT合併為C#中的EXCEL" InputFormat="xlt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 XLT 合併到 EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 XLT 合併到 EXCEL 中嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將XLT合併到EXCEL" %}}
