---
title: C# ODS a PDF - ODS a PDF Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato PDF, permitindo o salvamento perfeito de dados ODS no formato PDF usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a PDF em C#" %}}

exemplo a seguir demonstra como converter ODS em PDF em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter ODS em PDF por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em PDF programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em PDF em apenas algumas linhas de código.
...
1.  Converta ODS para PDF chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em PDF" %}}
