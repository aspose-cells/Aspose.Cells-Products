---
title: Voeg XLT samen met PRN - Combineer XLT met PRN in Java
url: /nl/java/merger/merge-xlt-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online samenvoegen XLT naar PRN-opslagformaat. Java Combineer XLT naar PRN-formaat. Samenvoegen XLT naar PRN in Java. XLT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLT samen met PRN in Java online" %}}

Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met PRN in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLT samen te voegen met PRN. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het PRN-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat XLT samenvoegt met PRN.
...
{{% blocks/products/pf/agp/content h2="Hoe XLT samen te voegen met PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLT samen te voegen met PRN" %}}
