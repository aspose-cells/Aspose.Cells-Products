---
title: 將圖像合併到 XLTX - 將圖像合併到 XLTX 中的 C#
url: /zh-hant/net/merger/merge-image-to-xltx/ 
description: Aspose Excel。 C# Aspose.Cells。免費在線合併圖像到XLTX保存格式。 C# 將 IMAGE 合併為 XLTX 格式。將IMAGE合併到C#中的XLTX。IMAGE合併。
...
{{% blocks/products/pf/agp/content h2="免費在線將 C# 中的 IMAGE 合併到 XLTX" %}}

以下示例演示如何將 IMAGE 合併到 Aspose.Cells for .NET 中的 XLTX。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 IMAGE 合併到 XLTX。上傳文件，調用 Workbook.Combine 方法合併文件，然後將其保存到 XLTX 文件。如果您在 C# 中開發代碼，這會比聽起來更簡單。請參閱 C# 將 IMAGE 合併到 XLTX 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將圖像合併到C#中的XLTX" InputFormat="png" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 IMAGE 合併到 XLTX" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 IMAGE 合併到 XLTX 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
