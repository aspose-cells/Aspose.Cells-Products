---
title: Converti JSON in XPS tramite l'applicazione C++ 
url: /it/cpp/conversion/json-to-xps/ 
description: Esempio di codice di conversione C++ per un documento JSON in formato XPS. I programmatori possono utilizzare questo codice sorgente per la conversione batch da JSON a XPS all'interno di qualsiasi applicazione C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti JSON in XPS tramite C++" h2="Conversione da JSON a XPS ad alte prestazioni utilizzando la libreria C++ senza la necessità di installare Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file JSON in XPS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file JSON utilizzando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XPS).1. Il file XPS verrà salvato nel percorso specificato.1. Apri il file XPS nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da JSON a XPS C++" offSpacer="" %}}
