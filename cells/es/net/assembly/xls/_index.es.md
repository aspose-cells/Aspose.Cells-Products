---
title:  Generar Informes en Archivos XLS via .NET
weight: 1700
description: Código fuente C# para generar informes en formato XLS en .NET Framework, .NET Core, Mono o plataformas Xamarin.
...
{{% blocks/products/pf/agp/content h2="Cómo generar informes basados en XLS utilizando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Armar XLS vía C#" %}}
...
1. Guarde el resultado en formato XLS mediante el método WorkbookDesigner.Worbook.Save
