---
title: Merge XML to SPREADSHEETML - Gộp XML vào SPREADSHEETML trong Java
url: /vi/java/merger/merge-xml-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất XML thành định dạng lưu SPREADSHEETML. Java Kết hợp XML thành định dạng SPREADSHEETML. Hợp nhất XML thành SPREADSHEETML trong Java. Hợp nhất XML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XML thành SPREADSHEETML trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất XML thành SPREADSHEETML trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất XML vào SPREADSHEETML. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SPREADSHEETML. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất XML thành SPREADSHEETML.
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất XML thành SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất XML vào SPREADSHEETML theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
