---
title: Maak SXC aan - Maak SXC-bestand aan in C#
description: Aspose Excel. C# Maak SXC snel en eenvoudig een bestand met Aspose.Cells. Genereer een SXC-bestand met C#. Maak SXC aan in C#. C# SXC Creater.
...
{{% blocks/products/pf/agp/content h2="Hoe u SXC aanmaakt in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u het bestand SXC maakt in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#-bibliotheek om SXC-bestand te maken" %}}
