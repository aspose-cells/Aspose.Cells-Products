...
{{< blocks/products/pf/i18n/upper-banner h1="Šifrovat soubory XLSB přes Java" h2="Chraňte heslem tabulky aplikace Excel včetně formátu XLSB pomocí knihovny .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak zabezpečit soubor XLSB pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k ochraně souborů XLSB prostřednictvím Java" %}}
...
1. Načtěte soubor XLSB vytvořením instance třídy Workbook1. Použijte metodu protect(..) s ProtectionType a Password1. Uložte chráněný soubor XLSB metodou save().
