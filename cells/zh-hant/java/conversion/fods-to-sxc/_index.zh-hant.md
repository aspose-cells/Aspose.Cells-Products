---
title: 通過 Java 將 FODS 轉換為 SXC 
url: /zh-hant/java/conversion/fods-to-sxc/ 
description: FODS 格式到 SXC 文件的示例 Java 轉換代碼。程序員可以使用此示例代碼將 Excel 和 OpenOffice 電子表格導出到任何基於 Web 或桌面 Java 的應用程序中的 SXC。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 FODS 轉換為 SXC" h2="FODS 到 SXC Java 轉換，使用內部部署 Java 庫將單個或多個頁面轉換為 SXC。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 FODS 轉換為 SXC" %}}

 為了將 FODS 渲染到 SXC，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 FODS 轉換為 SXC 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 FODS 文件轉換為 SXC。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 類的實例加載 FODS 文件1. 調用 Workbook.save 方法1. 將帶有 SXC 擴展名和 SaveFormat 的輸出路徑作為參數傳遞1. 檢查生成的 SXC 文件的指定路徑
...
{{% blocks/products/pf/agp/code-block title="FODS 到 SXC Java 轉換源代碼" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS 到 SXC 轉換現場演示" sectionDescription="[將 FODS 轉換為 SXC](https://products.aspose.app/cells/conversion/fods-to-sxc) 立即訪問我們的現場演示網站。現場演示具有以下好處" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 無需下載 Aspose API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 無需編寫任何代碼。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上傳您的 FODS 文件，它將立即轉換為 SXC。" >}}
