...
Aşağıdaki örnek, Aspose.Cells for Python via Java'de MHT'nin XLSB ile nasıl birleştirileceğini gösterir.
...
MHT'yi programlı olarak XLSB ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
