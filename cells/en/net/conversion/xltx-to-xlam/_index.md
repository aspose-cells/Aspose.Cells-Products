...
description: Sample code for xltx to xlam C# conversion. Use API example code for batch xltx files to xlam conversion within VB.NET, Asp.NET or any .NET based application.
---
