---
title:  Слияние XML с CSV через Python
url: /ru/python-net/merger/merge-xml-to-csv/ 
description: Слияние XML с CSV онлайн бесплатно. Бесплатный онлайн XML для слияния CSV. Слияние XML с Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS и т. д.
---
...
В следующем примере показано, как объединить XML с CSV в Python.
...
{{% cells-merger title="Бесплатное приложение для объединения XML в CSV онлайн" InputFormat="xml" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
