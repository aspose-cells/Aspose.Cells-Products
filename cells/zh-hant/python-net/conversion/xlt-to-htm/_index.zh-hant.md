...
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 XLT 轉換為 HTM 格式，從而能夠使用 Aspose.Cells 庫將 XLT 資料無縫保存為 HTM 格式，所有這些都透過高效能客製化的 081 53481 實現程式碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Excel 庫中將 XLT 轉換為 HTM 格式（Python）。" h2="高速 Excel 庫，用於將 XLT 轉換為 HTM。使用我們的 Excel 轉換工具 API，以 Python 格式開發進階、與平台無關的軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="在 Excel 庫中將 XLT 轉換為 HTM 格式（Python）。" %}}

如何將 XLT 轉換為 HTM？透過 NET 函式庫，您可以使用 Aspose.Cells 和 for Python，只需幾行程式碼即可輕鬆地以程式設計方式將 XLT 轉換為 HTM。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="將 XLT 儲存到 Python Excel 庫中的 HTM 格式" %}}

以下範例示範如何在 Python Excel 庫中將 XLT 轉換為 HTM。
...
需要以程式設計方式將 XLT 檔案轉換為 HTM 格式嗎？ Python 開發人員只需幾行程式碼即可輕鬆載入 XLT 檔案並將其轉換為 HTM 格式。
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫，用於將 XLT 轉換為 HTM" %}}
