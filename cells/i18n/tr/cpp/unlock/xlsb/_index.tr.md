---
title: C++ üzerinden XLSB belgesinin kilidini açın 
weight: 7420
url: /tr/cpp/unlock/xlsb/ 
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Runtime Environment'da parola korumalı XLSB dosyasının kilidini açmak için örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ üzerinden XLSB Dosyalarının Kilidini Açın" h2="C++ Kitaplığı\'nı kullanarak XLSB dosyası da dahil olmak üzere Excel elektronik tablolarından korumayı kaldırın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak XLSB Dosyasının Korumasını Kaldırma" %}}
...
1. CreateIWorkbook'u kullanarak XLSB kilitli dosyasını yükleyin.1. Kilidi açmak için Unprotect() işlevini çağırın.1. SetPassword kullanarak parolayı NULL olarak ayarlayın.1. XLSB dosyasını belirtilen bir konuma kaydedin.
