---
title: Fusionner HTML à DOCX - Combiner HTML à DOCX dans Java
url: /fr/java/merger/merge-html-to-docx/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite HTML au format de sauvegarde DOCX. Java Combinez le format HTML au format DOCX. Fusionner HTML à DOCX dans Java. HTML Fusionner.
...
L'exemple suivant montre comment fusionner HTML à DOCX dans Aspose.Cells for Java.
...
{{% cells-merger title="Gratuit en ligne pour fusionner HTML à DOCX en Java" InputFormat="html" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTML à DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTML à DOCX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
