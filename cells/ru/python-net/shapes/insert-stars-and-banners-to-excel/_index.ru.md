...
weight: 381
description: Python via Исходный код .Net для вставки звезды/баннера в Excel.
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке звезды/баннера в файл Excel с использованием Python via .Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) чтобы вставить звезду/баннер в выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка Звезда/Баннер - Python via .Net" offSpacer="" %}}
