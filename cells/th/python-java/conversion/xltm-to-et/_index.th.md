...
description: Aspose เอ็กเซล. แปลง XLTM เป็น ET อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Python XLTM เป็น ET Python บันทึก XLTM ถึง ET. บันทึก XLTM เป็น ET โดยใช้ Python
...
{{% blocks/products/pf/agp/content h2="บันทึก XLTM ไปที่ ET ใน Python" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLTM เป็น ET ใน Python
