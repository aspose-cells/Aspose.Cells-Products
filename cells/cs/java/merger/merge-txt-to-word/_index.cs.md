---
title: Sloučit TXT do WORD via Java
url: /cs/java/merger/merge-txt-to-word/ 
description: Sloučit TXT do WORD Online zdarma. Online zdarma TXT sloučení WORD. Sloučit TXT do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit TXT do WORD v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT do WORD online" InputFormat="txt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
