...
ต้องการแปลงไฟล์ตัวเลขเป็น HTML ด้วยโปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลงตัวเลขเป็น HTML ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงตัวเลขเป็น HTML โดยเรียกใช้เมธอด Save()
