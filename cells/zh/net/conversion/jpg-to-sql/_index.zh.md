---
title: C# JPG 到 SQL - JPG 到 SQL 转换器
description: Aspose Excel。 C# Aspose.Cells. JPG 到 SQL C#. C# 将 JPG 转换为 SQL 保存格式。 C# JPG 转 SQL 格式。将 JPG 保存到 SQL C#。
...
{{% blocks/products/pf/agp/content h2="将JPG保存到SQL中C#" %}}
...
{{% cells-convert title="将 JPG 转换为 SQL 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="sql" IsLandingPage="true" %}}
