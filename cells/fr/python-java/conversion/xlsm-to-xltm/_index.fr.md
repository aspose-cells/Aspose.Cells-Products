...
description: Aspose Exceller. Convertissez XLSM en XLTM rapidement et facilement avec Aspose.Cells. Python XLSM en XLTM. Python Enregistrez XLSM en XLTM. Enregistrez XLSM sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLSM au XLTM au Python" %}}

L'exemple suivant montre comment convertir XLSM en XLTM dans Python.
...
{{% cells-convert title="Exemple de code pour convertir XLSM en XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xltm" IsLandingPage="true" language="pythonjava" %}}
