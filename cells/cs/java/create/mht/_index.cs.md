---
title: Vytvořit MHT – Vytvořte soubor MHT v Java
description: Aspose Excel. Snadno generujte a manipulujte se soubory MHT pomocí knihovny Aspose.Cells for Java. Tato výkonná knihovna API poskytuje efektivní a zjednodušené řešení pro vytváření, úpravu a správu souborů MHT přímo ve vašich aplikacích Java a splňuje specifické potřeby vývojářů s vysokou přesností.
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit MHT v Java" %}}
...
1.  Uložte sešit ve formátu MHT pomocí metody save().

{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor MHT v adresáři Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro vytvoření souboru MHT" %}}
{{% blocks/products/pf/agp/text %}}
