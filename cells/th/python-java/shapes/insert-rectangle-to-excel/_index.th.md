---
title:  แทรกสี่เหลี่ยมผืนผ้าลงใน Excel ผ่าน Python
weight: 10
description: รหัสแหล่งที่มา Python เพื่อแทรกสี่เหลี่ยมผืนผ้าลงใน Excel
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แทรกสี่เหลี่ยมผืนผ้าลงใน Excel ผ่าน Python" h2="แทรกวัตถุโดยใช้ API ฝั่งเซิร์ฟเวอร์โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF เป็นต้น" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกสี่เหลี่ยมผืนผ้าในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกสี่เหลี่ยมผืนผ้าลงในไฟล์ Excel ผ่าน Python" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addRectangle(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกสี่เหลี่ยมผืนผ้าในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกสี่เหลี่ยมผืนผ้า - Python" offSpacer="" %}}
