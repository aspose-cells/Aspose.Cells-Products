...
{{< blocks/products/pf/i18n/upper-banner h1="เข้ารหัส XLSX ไฟล์ via Java" h2="ป้องกันด้วยรหัสผ่านสเปรดชีต Excel รวมถึงรูปแบบ XLSX โดยใช้ .NET Library" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการป้องกัน XLSX ไฟล์ via Java" %}}
...
1.  โหลดไฟล์ XLSX โดยสร้างตัวอย่างคลาสสมุดงาน
1.  ใช้วิธีการป้องกัน (..) ด้วย ProtectionType และรหัสผ่าน
1.  บันทึกไฟล์ XLSX ที่ได้รับการป้องกันด้วยวิธี save()
