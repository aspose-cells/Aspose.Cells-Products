...
description: Aspose Excel. Chuyển đổi PNG sang XLTM nhanh chóng và dễ dàng với Aspose.Cells. Python PNG sang XLTM. Python Lưu PNG thành XLTM. Lưu PNG thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Lưu PNG vào XLTM trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi PNG thành XLTM trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi PNG thành XLTM" %}}
