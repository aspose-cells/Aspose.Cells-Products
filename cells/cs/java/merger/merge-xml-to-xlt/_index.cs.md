...
description: Aspose Excel. Java Aspose.Cells. Sloučit XML do formátu uložení XLT. Java Zkombinujte XML do formátu XLT. Sloučit XML na XLT v Java. Sloučit XML.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML na XLT v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XML do XLT v Java" InputFormat="xml" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
