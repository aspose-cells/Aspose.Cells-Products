...
url: /sv/cpp/merger/merge-xlt-to-tiff/ 
...
Följande exempel visar hur man slår samman XLT till TIFF i Aspose.Cells for C++.
...
{{% cells-merger title="Exempelkod för att slå samman XLT till TIFF i C++" InputFormat="xlt" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLT till TIFF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLT till TIFF programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotek för att slå samman XLT till TIFF" %}}
