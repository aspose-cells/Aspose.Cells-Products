...
description: Aspose Excel. Convierta EXCEL a XLSM rápida y fácilmente con Aspose.Cells. Python EXCEL a XLSM. Python Guarde EXCEL en XLSM. Guarde EXCEL como XLSM usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar EXCEL al XLSM en Python" %}}

El siguiente ejemplo demuestra cómo convertir EXCEL a XLSM en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir EXCEL a XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xlsm" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir EXCEL a XLSM" %}}
