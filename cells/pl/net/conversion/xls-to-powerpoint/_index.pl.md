---
title: C# XLS do POWERPOINT - Konwerter XLS do POWERPOINT
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLS do formatu POWERPOINT, umożliwiając bezproblemowe zapisywanie danych XLS w formacie POWERPOINT przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do POWERPOINT w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLS na prezentację PowerPoint w formacie C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować plik XLS do formatu PowerPoint. Prześlij plik XLS, a następnie zapisz go jako plik PowerPoint. Zarówno do odczytu pliku XLS, jak i do zapisu pliku PowerPoint, możesz używać pełnych nazw plików. Wyjściowa zawartość i formatowanie pliku PowerPoint będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLS na prezentację PowerPoint" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS do programu PowerPoint za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS do formatu POWERPOINT? Programiści .NET mogą z łatwością załadować i przekonwertować pliki XLS do formatu POWERPOINT za pomocą zaledwie kilku linijek kodu.
...
1.  Przekonwertuj XLS do formatu POWERPOINT, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLS do formatu POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na POWERPOINT" %}}
