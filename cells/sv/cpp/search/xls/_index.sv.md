---
title:  Sök XLS-dokumentet utan att öppna det via C++
weight: 4560
description: C++ exempelkod för att söka efter ord med mönster i XLS-filen i C++ Runtime Environment för Windows 32-bitars, Windows 64-bitars och Linux 64-bitars.
...
{{% blocks/products/pf/agp/content h2="Hur man söker efter filen XLS med hjälp av C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att söka efter XLS-filer i C++" %}}
...
+ Ladda XLS-filen med hjälp av arbetsboksklassen.
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLS Sök Live Demonstrationer" sectionDescription=" Sök text, ord, fraser i XLS-dokument just nu genom att besöka vår[Live Demos webbplats](https://products.aspose.app/cells/search). Livedemon har följande fördelar" >}}
