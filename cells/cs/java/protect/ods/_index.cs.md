...
{{< blocks/products/pf/i18n/upper-banner h1="Šifrovat soubory ODS prostřednictvím Java" h2="Chraňte heslem tabulky aplikace Excel včetně formátu ODS pomocí knihovny .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k ochraně souborů ODS prostřednictvím Java" %}}
...
1. Načtěte soubor ODS vytvořením instance třídy Workbook1. Použijte metodu protect(..) s ProtectionType a Password1. Uložte chráněný soubor ODS metodou save().
