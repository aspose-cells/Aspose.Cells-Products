---
title: C# XLT 转 BMP - 在线 XLT 转 BMP 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 XLT 转换为 BMP 保存格式。 C# XLT 到 BMP 格式。将 XLT 保存为 BMP C#。
...
{{% blocks/products/pf/agp/content h2="免费在线保存 XLT 至 BMP 于 C#" %}}

以下示例演示如何将 C# 中的 XLT 转换为 BMP。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLT 转换为 BMP。上传您的 XLT 文件，然后只需将其另存为 BMP 文件。对于 XLT 读取和 BMP 写入，您可以使用完全限定的文件名。输出 BMP 内容和格式将与原始 XLT 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免费应用程序和示例代码可在线将 XLT 转换为 BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="bmp" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLT 转换为 BMP" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 文件转换为 BMP 吗？ .NET 开发人员只需几行代码即可轻松加载和转换 XLT 到 BMP。
...
1. 使用工作簿实例加载 XLT 文件。
1. 通过调用 Workbook.Save 方法将 XLT 转换为 BMP。
1. 获取XLT到BMP的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#库将XLT转换为BMP" %}}
