---
title:  Cách vẽ hoặc chèn hình mũi tên đôi khuỷu tay vào Excel via Java
weight: 30
description: Vẽ hoặc chèn hình mũi tên đôi khuỷu tay bằng Aspose.Cells' Java API không cần phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chèn hình mũi tên đôi khuỷu tay vào Excel via Java" h2="Chèn mũi tên kép khuỷu tay sử dụng Aspose.Cells\' API không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách chèn hình mũi tên đôi khuỷu tay vào file Excel bằng Java" %}}

 Để chèn hình mũi tên đôi khuỷu tay vào tệp excel, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn hình mũi tên đôi khuỷu tay vào file Excel via Java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) để chèn hình mũi tên đôi khuỷu tay vào trang tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn khuỷu tay hình mũi tên đôi - Java" offSpacer="" %}}
