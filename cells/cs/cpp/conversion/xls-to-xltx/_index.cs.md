---
title: C++ XLS až XLTX - Online konvertor XLS až XLTX
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Online zdarma C++ Převést XLS na XLTX uložit formát. C++ XLS až XLTX formát. Uložte si XLS až XLTX C++.
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLS až XLTX v C++ online zdarma" %}}

Následující příklad ukazuje, jak převést XLS na XLTX v C++.
...
Potřebujete převést soubory XLS na XLTX programově? Vývojáři C++ mohou snadno převést XLS na XLTX v několika řádcích kódu.
...
1.  Převeďte XLS na XLTX voláním metody Save().
