---
title:  Wstaw GroupBox (kontrolkę formularza) do Excela, używając Python via Java
weight: 40
description: Python via Kod źródłowy Java umożliwiający wstawienie GroupBox (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić GroupBox (kontrolkę formularza) do pliku Excel przy użyciu Python via java" %}}

 Aby wstawić GroupBox (kontrolkę formularza) do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić GroupBox (kontrolkę formularza) do pliku Excel przy użyciu Python via Java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addGroupBox(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić GroupBox (kontrolkę formularza) do wybranego arkusza.
...
{{% blocks/products/pf/agp/code-block title="Wstaw GroupBox (kontrolka formularza) - Python via java" offSpacer="" %}}
