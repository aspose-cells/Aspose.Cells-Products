---
title:  Filigrane XLSX document via Java
weight: 7680
description: Exemple de code Java pour ajouter ou supprimer un filigrane au fichier XLSX sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ajouter un filigrane de texte au XLSX via Java" h2="Créez vos propres applications Java pour filigraner les fichiers XLSX à l\'aide d\'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment filigraner un fichier XLSX à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter un filigrane au XLSX via Java" %}}
...
1.  Enregistrer le classeur au format XLSX
...
{{% blocks/products/pf/agp/code-block title="Ajouter un filigrane à XLSX - Java" offSpacer="" %}}
