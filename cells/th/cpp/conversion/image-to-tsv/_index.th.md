...
description: Aspose เอ็กเซล. แปลง IMAGE เป็น TSV อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ IMAGE เป็น TSV C++ บันทึก IMAGE เป็น TSV บันทึก IMAGE เป็น TSV โดยใช้ C++
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง IMAGE เป็น TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="tsv" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง IMAGE เป็น TSV โดยการเรียกเมธอด Save()
