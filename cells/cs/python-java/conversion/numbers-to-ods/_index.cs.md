...
{{% blocks/products/pf/agp/content h2="Převeďte ČÍSLA na ODS pomocí Python" %}}
...
Následující příklad ukazuje, jak převést ČÍSLA na ODS v Python.
