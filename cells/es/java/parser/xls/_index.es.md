---
title:  Extraiga texto e imágenes del documento XLS via Java
weight: 3700
description: Código de muestra Java para extraer texto e imágenes del archivo XLS en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{< blocks/products/pf/i18n/upper-banner h1="Analizar XLS Formatos en Java" h2="Análisis de documentos XLS nativo y de alto rendimiento utilizando API Aspose.Cells for Java del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para analizar archivos XLS en Java" %}}
...
+ Cargue el documento XLS usando la clase Libro de trabajo.
...
{{% blocks/products/pf/agp/code-block title="Analizar archivos XLS - Java" offSpacer="" %}}
