...
url: /cs/net/merger/merge-prn-to-image/ 
...
Následující příklad ukazuje, jak sloučit PRN do IMAGE v Aspose.Cells for .NET.
...
Potřebujete programově sloučit PRN s IMAGE? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu pro sloučení PRN do IMAGE" %}}
