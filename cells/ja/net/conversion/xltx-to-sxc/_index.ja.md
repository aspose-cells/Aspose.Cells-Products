---
title: C# XLTX から SXC - オンライン XLTX から SXC コンバータ
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# XLTX を SXC 保存形式に変換します。 C# XLTX ～ SXC の形式。 XLTX から SXC C# を保存します。
...
{{% blocks/products/pf/agp/content h2="C# に XLTX から SXC をオンラインで無料で保存" %}}

次の例は、XLTX を C# の SXC に変換する方法を示しています。
...
{{% cells-convert title="オンラインでXLTXをSXCに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でXLTXをSXCに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLTX ファイルをプログラムで SXC に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLTX を簡単にロードして SXC に変換できます。
