---
title: Creëer MHTML - Creëer MHTML bestand in Python
description: Aspose Excel. Python Creëer MHTML-bestand. Creëer MHTML Python. Python MHTML Maker. Maak MHTML in Python. Genereer MHTML-bestand met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak MHTML-bestand in Python" h2="Snelle Python-bibliotheek voor het maken van een MHTML-bestand. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. Gebruik de methode Save om de werkmap op te slaan als MHTML-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een MHTML-bestand maakt in Python." offSpacer="" %}}
