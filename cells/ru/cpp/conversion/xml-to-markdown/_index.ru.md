...
{{% blocks/products/pf/agp/content h2="Преобразование XML в MARKDOWN с использованием C++" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в MARKDOWN в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат MARKDOWN в формате C++.
...
Нужно программно преобразовать XML-файлы в формат MARKDOWN? Разработчики, использующие формат C++, могут легко преобразовать XML в формат MARKDOWN всего несколькими строками кода.
...
1.  Преобразовать XML в формат MARKDOWN, вызвав метод Save().
