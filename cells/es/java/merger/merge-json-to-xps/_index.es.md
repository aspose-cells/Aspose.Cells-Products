---
title: Combinar JSON a XPS - Combinar JSON a XPS en Java
url: /es/java/merger/merge-json-to-xps/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea JSON a XPS guardar formato. Java Combina el formato JSON con el XPS. Combinar JSON a XPS en Java. JSON Combinar.
...
El siguiente ejemplo muestra cómo combinar JSON con XPS en Aspose.Cells for Java.
...
{{% cells-merger title="Gratis en línea para fusionar JSON a XPS en Java" InputFormat="json" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar JSON a XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar JSON con XPS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
