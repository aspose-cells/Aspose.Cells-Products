---
title: Python XLSB ～ CSV - XLSB ～ CSV コンバータ
description: Aspose エクセル。 XLSB を Aspose.Cells ですばやく簡単に CSV に変換します。 Python XLSB から CSV に変換します。 Python XLSB を CSV に保存します。 XLSB を 07611134 として保存しますPythonを使用して81。
...
{{% cells-convert title="XLSB を CSV に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="csv" IsLandingPage="true" language="pythonnet" %}}
