---
title: C++ XLS sang TXT - XLS sang TXT Bộ chuyển đổi
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển C++ một phương pháp tích hợp đầy đủ để chuyển đổi định dạng XLS sang định dạng TXT, cho phép lưu dữ liệu XLS một cách liền mạch vào định dạng TXT bằng cách sử dụng thư viện Aspose.Cells, tất cả thông qua mã C++ hiệu quả và có thể tùy chỉnh.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS thành TXT trong C++" h2="Chuyển đổi hiệu suất cao từ XLS sang TXT bằng thư viện C++ mà không cần cài đặt Excel, OpenOffice hoặc Adobe Acrobat (phiên bản Microsoft)." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu mã số XLS vào TXT trong mã số C++." %}}

Ví dụ sau đây minh họa cách chuyển đổi XLS thành TXT trong C++.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để chuyển đổi XLS thành TXT. Tải lên tệp XLS của bạn, sau đó chỉ cần lưu nó dưới dạng tệp TXT. Đối với cả việc đọc XLS và ghi TXT, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng TXT đầu ra sẽ giống hệt với tài liệu XLS gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ví dụ mã để chuyển đổi XLS thành TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="txt" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS thành TXT qua C++" %}}

{{% blocks/products/pf/agp/text %}}

Bạn cần chuyển đổi tệp XLS sang TXT bằng lập trình? Các nhà phát triển C++ có thể dễ dàng chuyển đổi XLS sang TXT chỉ với vài dòng mã.
...
1.  Chuyển đổi XLS thành TXT bằng cách gọi phương thức Save().
1.  Nhận kết quả chuyển đổi từ XLS thành TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C++ chuyển đổi XLS thành TXT" %}}
