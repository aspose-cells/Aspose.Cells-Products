...
url: /cs/cpp/merger/merge-json-to-sxc/ 
...
Následující příklad ukazuje, jak sloučit JSON až SXC v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit JSON až SXC? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení JSON až SXC" %}}
