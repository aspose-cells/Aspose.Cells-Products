---
title: "SXC konvertálása XLTX-re a következőn keresztül: Python"
url: /hu/python-java/conversion/sxc-to-xltx/
description: Mintakód az sxc–xltx Python konverzióhoz. Használjon API példakódot az sxc fájlok kötegelt xltx konvertálásához a Python alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása XLTX-re a következőn keresztül: Python" h2="Exportálja az Excel® táblázatokat XLTX formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása XLTX-re a következővel: Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása XLTX-re a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői könnyedén betölthetnek és konvertálhatnak SXC fájlokat XLTX-re, mindössze néhány sornyi kóddal.
