---
title: تحويل TXT إلى CSV عبر تطبيق C++ 
url: /ar/cpp/conversion/txt-to-csv/ 
description: نموذج C++ رمز التحويل لمستند TXT إلى تنسيق CSV. يمكن للمبرمجين استخدام رمز المصدر هذا لتحويل TXT إلى CSV دفعة ضمن أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TXT إلى CSV عبر C++" h2="تحويل TXT إلى CSV عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TXT إلى CSV باستخدام C++" %}}
 ...
 من أجل تحويل TXT إلى CSV ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوّري برامج C++ بسهولة تحويل ملف TXT إلى CSV في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف TXT باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (CSV).1. سيتم حفظ ملف CSV في المسار المحدد.1. افتح ملف CSV في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="TXT إلى CSV C++ شفرة مصدر التحويل" offSpacer="" %}}
