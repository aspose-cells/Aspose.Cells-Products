---
title: PHP HTM a SXC - Convertidor HTM a SXC
description: Aspose Excel. Convierta HTM a SXC rápida y fácilmente con Aspose.Cells. PHP HTM a SXC. PHP Guarde HTM en SXC. Guarde HTM como SXC usando PHP.
...
{{% cells-convert title="Código de muestra para convertir HTM a SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="sxc" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a SXC mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a SXC mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a SXC en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a SXC llamando al método guardar del libro de trabajo.
