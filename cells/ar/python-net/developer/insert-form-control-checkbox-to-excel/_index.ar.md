---
title:  أدخل CheckBox (التحكم في النموذج) في Excel باستخدام Python via .Net
weight: 30
description: Python via. صافي كود المصدر لإدراج CheckBox (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج CheckBox (التحكم في النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج CheckBox (عنصر تحكم النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_check_box/#int-int-int-int-int-int) لإدراج CheckBox (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل خانة الاختيار (التحكم في النموذج) - Python via .Net" offSpacer="" %}}
