...
url: /tr/net/merger/merge-mht-to-sql/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin SQL ile nasıl birleştirileceğini gösterir.
...
MHT'yi programlı olarak SQL ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi SQL ile birleştirmek için .NET kitaplığı" %}}
