---
title: C# PRN'den ETT'ye - PRN'den ETT'ye dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile PRN'yi hızlı ve kolay bir şekilde ETT'ye dönüştürün. C# PRN'den ETT'ye. C# PRN'yi ETT'ye kaydedin. C#'i kullanarak PRN'yi ETT olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi C#\'de ETT\'ye kaydedin" %}}

Aşağıdaki örnek, C#'de PRN'nin ETT'ye nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="PRN\'yi ETT\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="ett" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla ETT\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PRN dosyalarını program aracılığıyla ETT'ye dönüştürmeniz mi gerekiyor? .NET geliştiricileri yalnızca birkaç satır kodla kolayca PRN'yi ETT'ye yükleyebilir ve dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi ETT\'ye dönüştürmek için C# kitaplığı" %}}
