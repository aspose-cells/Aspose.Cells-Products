---
title: C# XLSX para MHT - Conversor XLSX para MHT
description: Aspose Excel. Converta XLSX em MHT de forma rápida e fácil com Aspose.Cells. C# XLSX em MHT. C# Salve XLSX em MHT. Salve XLSX como MHT usando C#.
...
O exemplo a seguir demonstra como converter XLSX em MHT em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter XLSX para MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para MHT programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em MHT em apenas algumas linhas de código.
