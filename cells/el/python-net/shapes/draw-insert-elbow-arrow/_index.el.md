---
title: Πώς να σχεδιάσετε ή να εισαγάγετε σχήμα βέλους αγκώνα στο Excel χρησιμοποιώντας Python via .Net
weight: 10
description: Python via. Καθαρός πηγαίος κώδικας για να εισαγάγετε σχήμα βέλους αγκώνα στο Excel.
...
{{% blocks/products/pf/agp/content h2="Πώς να εισαγάγετε σχήμα βέλους αγκώνα σε αρχείο Excel χρησιμοποιώντας Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την εισαγωγή σχήματος βέλους αγκώνα στο αρχείο Excel χρησιμοποιώντας Python via .Net" %}}
...
+ Επιλέξτε Φύλλο εργασίας μέσω του ευρετηρίου του.
 + Χρησιμοποιήστε την προσθήκη της shapecollection[μέθοδος](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) για να εισαγάγετε ένα σχήμα βέλους αγκώνα στο επιλεγμένο φύλλο εργασίας.
...
{{% blocks/products/pf/agp/code-block title="Εισαγάγετε σχήμα βέλους αγκώνα - Python via .Net" offSpacer="" %}}
