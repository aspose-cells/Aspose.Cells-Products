...
description: Java Aspose Cells. Java Create XLAM File. Create XLAM Java. Java XLAM Creater. Create XLAM in Java. Generate XLAM file using Java.
...
{{% blocks/products/pf/agp/content h2="How to Create XLAM in Java" %}}
...
1.  Save the workbook as XLAM format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create XLAM file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create XLAM file" %}}
{{% blocks/products/pf/agp/text %}}
