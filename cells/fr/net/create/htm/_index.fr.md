...
{{% blocks/products/pf/agp/content h2="Comment créer HTM dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier HTM dans C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# bibliothèque pour créer un fichier HTM" %}}
