---
title: Převést HTML na DIF prostřednictvím Java 
weight: 6050
url: /cs/java/conversion/html-to-dif/ 
description: Ukázka převodního kódu Java pro formát HTML na soubor DIF. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do formátu DIF v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést HTML na DIF prostřednictvím Java" h2="Převod HTML na DIF Java pro převod jedné nebo více stránek na DIF pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na DIF pomocí Java" %}}

 K vykreslení HTML do formátu DIF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu HTML na DIF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor HTML na DIF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor HTML s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením DIF a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor DIF
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze HTML na DIF Java" offSpacer="" %}}

```cs
// načíst soubor HTML v instanci sešitu
Workbook book = new Workbook("template.html");
// uložit HTML jako DIF
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze HTML na DIF" sectionDescription="[Převést HTML na DIF](https://products.aspose.app/cells/conversion/html-to-dif) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj HTML soubor, bude okamžitě převeden na DIF." >}}
