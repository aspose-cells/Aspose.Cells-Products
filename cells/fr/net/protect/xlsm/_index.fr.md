---
title:  Protéger et verrouiller le document XLSM via .NET
weight: 7530
description: Code source C# pour verrouiller le fichier XLSM à l’aide d’un mot de passe sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Protéger le XLSM via le C#" %}}
...
1.  Instancier la classe Workbook avec le chemin d'accès au fichier XLSM
