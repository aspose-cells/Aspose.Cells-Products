---
title: C++ SPREADSHEETML na FODS - Online převodník SPREADSHEETML na FODS
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Online zdarma C++ Převeďte SPREADSHEETML na FODS saveformat. C++ SPREADSHEETML do formátu FODS. Uložte SPREADSHEETML na FODS C++.
...
{{% blocks/products/pf/agp/content h2="Uložit SPREADSHEETML na FODS v C++ online zdarma" %}}

Následující příklad ukazuje, jak převést SPREADSHEETML na FODS v C++.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SPREADSHEETML na FODS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="fods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést SPREADSHEETML na FODS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory SPREADSHEETML na FODS programově? C++ vývojáři mohou snadno převést SPREADSHEETML na FODS v několika řádcích kódu.
...
1.  Převeďte SPREADSHEETML na FODS voláním metody Save().
1.  Získejte výsledek převodu SPREADSHEETML na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod SPREADSHEETML na FODS" %}}
