...
{{% blocks/products/pf/agp/content h2="Konwertuj TSV na OTS w Python" %}}
...
Poniższy przykład pokazuje, jak przekonwertować TSV na OTS w Python via NET.
