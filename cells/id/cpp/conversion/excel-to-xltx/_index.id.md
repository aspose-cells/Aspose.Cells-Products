...
description: Aspose Unggul. Konversikan EXCEL ke XLTX dengan cepat dan mudah dengan Aspose.Cells. C++ EXCEL ke XLTX. C++ Simpan EXCEL ke XLTX. Simpan EXCEL sebagai XLTX menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah EXCEL menjadi XLTX Menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengonversi EXCEL ke XLTX di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi EXCEL menjadi XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi EXCEL ke XLTX melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke XLTX secara terprogram? Pengembang C++ dapat dengan mudah mengonversi EXCEL menjadi XLTX hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah EXCEL menjadi XLTX" %}}
