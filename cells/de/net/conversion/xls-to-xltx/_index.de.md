...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLS über C# in XLTX" h2="Hochgeschwindigkeitsbibliothek C# zum Konvertieren von XLS in XLTX. Exportieren Sie Excel-Tabellen in das Format XLTX auf den Plattformen .NET Framework, .NET Core oder Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können XLS in nur wenigen Codezeilen problemlos laden und in XLTX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1.  Laden Sie die Datei XLS mit einer Instanz von Workbook
1.  Konvertieren Sie XLS in XLTX, indem Sie die Workbook.Save-Methode aufrufen
