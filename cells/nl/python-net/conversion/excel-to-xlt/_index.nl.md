...
Het volgende voorbeeld laat zien hoe u EXCEL converteert naar XLT in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Excel converteren naar XLT" %}}
