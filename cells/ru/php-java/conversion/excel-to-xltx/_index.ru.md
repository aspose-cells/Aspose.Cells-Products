---
title: PHP EXCEL в XLTX - Конвертер EXCEL в XLTX
description: Aspose Эксель. Преобразуйте EXCEL в XLTX быстро и легко с помощью Aspose.Cells. PHP EXCEL в XLTX. PHP Сохраните EXCEL в XLTX. Сохраните EXCEL как XLTX с помощью PHP.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать EXCEL в XLTX с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно конвертировать файлы EXCEL в XLTX? Разработчики PHP могут легко загрузить и преобразовать EXCEL в XLTX всего за несколько строк кода.
...
1.  Преобразуйте EXCEL в XLTX, вызвав метод сохранения книги.
1.  Получите результат преобразования EXCEL в XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования EXCEL в XLTX" %}}
