...
description: Aspose Excel. Python Aspose.Cells. A FODS egyesítése POWERPOINT mentési formátumba. Python A FODS kombinálása POWERPOINT formátumba. A FODS egyesítése a Python-es POWERPOINT-tal. FODS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A FODS egyesítése a Python-es POWERPOINT-tal" %}}
...
{{% cells-merger title="Mintakód a FODS egyesítéséhez a Python-es POWERPOINT-hoz" InputFormat="fods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="FODS és a POWERPOINT egyesítése a Python számon keresztül" %}}
