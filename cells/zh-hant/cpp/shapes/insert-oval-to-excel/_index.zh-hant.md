---
title: 通過 C++ 將橢圓插入 Excel
weight: 40
description: C++ 在 C++ 運行時環境（Windows 32 位、Windows 64 位和 Linux 64 位）上的 Excel 文件中插入 Oval 的示例代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 將橢圓插入 Excel" h2="使用服務器端的本機高性能插入對象 Aspose.Cells for C++ API，無需使用任何軟件，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ 通過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#a90bc960de1b4a6d6beaf6c7cc4651bc2)在選定的工作表中插入方程形狀
以 XLSX 格式保存工作簿。
