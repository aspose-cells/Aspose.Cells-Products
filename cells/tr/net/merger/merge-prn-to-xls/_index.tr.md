...
{{% blocks/products/pf/agp/content h2="PRN\'yi C#\'de XLS ile birleştir" %}}

Aşağıdaki örnek, PRN'nin Aspose.Cells for .NET'deki XLS ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi XLS'e birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLS dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. PRN'yi XLS ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="PRN\'yi C#\'de XLS ile Birleştirmek için Örnek Kod" InputFormat="prn" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla XLS ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

PRN'yi programlı olarak XLS ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
