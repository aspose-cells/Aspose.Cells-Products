---
title: MHTML mit SXC zusammenführen - MHTML mit SXC in Java kombinieren
url: /de/java/merger/merge-mhtml-to-sxc/ 
description: Aspose Excel. Java Aspose.Cells. MHTML mit SXC Saveformat zusammenführen. Java Kombinieren Sie das Format MHTML mit dem Format SXC. MHTML zu SXC in Java zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="MHTML mit SXC in Java zusammenführen" %}}

Das folgende Beispiel zeigt, wie MHTML mit SXC in Aspose.Cells for Java zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von MHTML mit SXC in Java" InputFormat="mhtml" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie MHTML mit SXC via Java zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie MHTML programmgesteuert mit SXC zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Java](https://products.aspose.com/cells/java) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Zusammenführen von MHTML mit SXC" %}}
