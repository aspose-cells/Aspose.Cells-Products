---
title: Converti TXT in TIFF tramite l'applicazione C++ 
url: /it/cpp/conversion/txt-to-tiff/ 
description: Esempio di codice di conversione C++ per un documento TXT in formato TIFF. I programmatori possono utilizzare questo codice sorgente per la conversione batch da TXT a TIFF all'interno di qualsiasi applicazione C++.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire TXT in TIFF usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TXT in TIFF tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente file TXT in TIFF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TXT usando Factory::CreateIWorkbook.1. Seleziona il primo foglio di lavoro.1. Imposta le opzioni (TIFF).1. Scorri ogni pagina del foglio e renderizza.1. Apri il file TIFF nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da TXT a TIFF C++" offSpacer="" %}}
