---
title: Sloučit JPG do NUMBERS – Sloučit JPG do NUMBERS v C++
url: /cs/cpp/merger/merge-jpg-to-numbers/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit JPG do NUMBERS uloženého formátu. C++ Zkombinujte JPG s formátem ČÍSLA. Sloučit JPG do ČÍSEL v C++. Sloučit JPG.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG na ČÍSLA v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JPG do NUMBERS v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do ČÍSEL. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru NUMBERS. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JPG do ČÍSEL na čísle C++" InputFormat="jpg" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPG do ČÍSEL přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JPG do NUMBERS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení JPG do NUMBERS" %}}
