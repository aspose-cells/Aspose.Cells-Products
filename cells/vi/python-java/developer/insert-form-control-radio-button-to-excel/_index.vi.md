...
{{% blocks/products/pf/agp/content h2="Cách Chèn RadioButton (Điều khiển biểu mẫu) vào Tệp Excel bằng Python" %}}

 Để chèn RadioButton (Điều khiển biểu mẫu) vào tệp excel, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn RadioButton(Form control) vào file Excel qua Python" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) để chèn một RadioButton(Điều khiển biểu mẫu) trong trang tính đã chọn.
