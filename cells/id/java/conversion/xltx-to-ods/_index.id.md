...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke ODS menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke ODS di Java" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX menjadi ODS di Java.
...
Perlu mengkonversi file XLTX ke ODS secara terprogram? Pengembang Java dapat dengan mudah mengkonversi XLTX ke ODS hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi XLTX menjadi ODS" %}}
{{% blocks/products/pf/agp/text %}}
