...
url: /zh-hant/cpp/merger/merge-spreadsheetml-to-powerpoint/ 
...
以下範例示範如何將 SPREADSHEETML 合併到 Aspose.Cells for C++ 中的 POWERPOINT。
...
{{% cells-merger title="將 SPREADSHEETML 合併到 POWERPOINT 的範例程式碼（C++）" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 SPREADSHEETML 合併到 POWERPOINT" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 SPREADSHEETML 合併到 POWERPOINT 嗎？基本文檔合併和連接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++ 將 SPREADSHEETML 合併到 POWERPOINT 的函式庫" %}}
