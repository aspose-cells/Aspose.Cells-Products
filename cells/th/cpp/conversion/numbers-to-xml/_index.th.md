...
ต้องการแปลงไฟล์ตัวเลขเป็น XML ด้วยโปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลงตัวเลขเป็น XML ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงตัวเลขเป็น XML โดยเรียกใช้เมธอด Save()
