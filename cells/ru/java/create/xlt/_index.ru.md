---
title: Создать XLT — Создать файл XLT в Java.
description: Aspose Excel. Легко создавайте и обрабатывайте файлы XLT с помощью библиотеки Aspose.Cells for Java. Эта мощная библиотека API предоставляет оптимизированное и эффективное решение для создания, редактирования и управления файлами XLT непосредственно в ваших приложениях Java, удовлетворяя специфические потребности разработчиков с высокой точностью.
...
{{% blocks/products/pf/agp/content h2="Как создать XLT в Java" %}}
...
1.  Сохраните рабочую книгу в формате XLT, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл XLT в Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для создания файла XLT" %}}
{{% blocks/products/pf/agp/text %}}
