---
title: C# XLSX do POWERPOINT - Konwerter online XLSX do POWERPOINT
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Bezpłatnie online C# Konwersja XLSX do formatu zapisu POWERPOINT. C# XLSX do formatu POWERPOINT. Zapisz XLSX do POWERPOINT C#.
...
{{% blocks/products/pf/agp/content h2="Zaoszczędź XLSX w POWERPOINT pod numerem C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSX na POWERPOINT w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLSX na POWERPOINT. Prześlij swój plik XLSX, a następnie po prostu zapisz go jako plik POWERPOINT. Zarówno do odczytu XLSX, jak i do zapisu w programie POWERPOINT można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie programu POWERPOINT będą identyczne z oryginalnym dokumentem XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLSX na POWERPOINT Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na POWERPOINT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSX na POWERPOINT? Programiści .NET mogą łatwo załadować i przekonwertować XLSX na POWERPOINT w zaledwie kilku wierszach kodu.
...
1.  Konwertuj XLSX na POWERPOINT, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLSX do POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# do konwersji biblioteki XLSX na POWERPOINT" %}}
