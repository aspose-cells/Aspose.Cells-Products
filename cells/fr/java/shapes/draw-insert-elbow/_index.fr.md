...
weight: 30
description: Dessinez ou insérez une forme de coude en utilisant Aspose.Cells' Java API sans aucun logiciel tel que Microsoft ou Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Comment insérer la forme du coude dans un fichier Excel à l\'aide de Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) pour insérer la forme du coude dans la feuille de calcul sélectionnée
