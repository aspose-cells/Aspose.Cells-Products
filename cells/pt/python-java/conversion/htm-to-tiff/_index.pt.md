---
title: Converter HTM para TIFF Python via Python
description: Converta HTM para TIFF online gratuitamente. Conversor HTM on-line gratuito para TIFF. Python HTM para TIFF. HTM para TIFF via Python.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os desenvolvedores Python podem facilmente carregar e converter HTM para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Carregar arquivo HTM com uma instância da pasta de trabalho
1.  Converter HTM para TIFF chamando o método Workbook.save
