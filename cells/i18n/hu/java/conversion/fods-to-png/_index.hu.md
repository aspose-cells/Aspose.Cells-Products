---
title: "FODS konvertálása PNG-re a következőn keresztül: Java "
url: /hu/java/conversion/fods-to-png/ 
description: Minta Java konverziós kód FODS-formátumhoz PNG-fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok PNG formátumba exportálására bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="FODS konvertálása PNG-re a következőn keresztül: Java" h2="FODS-ból PNG-be Java konverzió egyetlen vagy több oldal konvertálásához PNG-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="FODS konvertálása PNG-re a következővel: Java" %}}

 Ahhoz, hogy a FODS-t PNG-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a FODS PNG-re konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a FODS-fájlt PNG-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="FODS-ból PNG-be Java konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS-ból PNG-be konvertáló élő bemutatók" sectionDescription="[FODS konvertálása PNG-re](https://products.aspose.app/cells/conversion/fods-to-png) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a FODS fájlt, és azonnal PNG formátumba konvertálódik." >}}
