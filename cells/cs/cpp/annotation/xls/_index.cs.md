...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro přidání komentářů na XLS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Načtěte soubor XLS Excel pomocí objektu třídy IWorkbook.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API lze použít k vytváření, úpravám, převodu a vykreslování Microsoft formátů Excelu do různých formátů. Kromě toho jej lze použít pro komplexní vytváření grafů, škálovatelný reporting a spolehlivé výpočty v rámci softwarových aplikací. Aspose.Cells je samostatný API a nevyžaduje žádný software jako Microsoft nebo OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Přidat / odebrat anotaci z XLS prostřednictvím online aplikace" sectionDescription=" Smažte XLS anotace dokumentů právě teď tím, že navštívíte naše[Webová stránka živé ukázky](https://products.aspose.app/cells/annotation). Živé demo má následující výhody" >}}
