---
title: A HTML egyesítése a NUMBERS-szel – a HTML-es szám egyesítése a NUMBERS-szel a C#-ben
url: /hu/net/merger/merge-html-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés HTML NUMBERS mentési formátumba. C# Kombinálja a HTML számot NUMBERS formátumba. A HTML egyesítése a NUMBERS számmal a C#-ben. HTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a HTML-es számot a NUMBERS-hez a C#-ben online ingyen" %}}

következő példa bemutatja, hogyan lehet egyesíteni a HTML-et a NUMBERS-szel a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML és a NUMBERS számok egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el NUMBERS fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTML-et a NUMBERS-szel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a HTML számmal a NUMBERS számmal a C#-ben" InputFormat="html" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTML és a NUMBERS egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTML-es számot a NUMBERS számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML és a NUMBERS egyesítéséhez" %}}
