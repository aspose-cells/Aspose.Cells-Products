---
title: C# MHT 到 IMAGE - 在線 MHT 到 IMAGE 轉換器
description: Aspose Excel。 C# Aspose.Cells. C# Aspose Cells. 免費在線 C# 將 MHT 轉換為 IMAGE 保存格式。 C# MHT 到 IMAGE 格式。將 MHT 保存到 IMAGE C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 MHT 轉換為 C# 中的 IMAGE" h2="用於將 MHT 轉換為 IMAGE 的高速 C# 庫。這是一款專業的軟件解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上導入和導出 MHT、IMAGE 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線將 MHT 保存為 C# 中的 IMAGE" %}}

下面的例子演示瞭如何將C#中的MHT轉換為IMAGE。
...
{{% cells-convert title="將 MHT 在線轉換為 IMAGE 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 轉換為 IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 IMAGE？ .NET 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 IMAGE。
...
{{% blocks/products/pf/agp/content h2="C# 將 MHT 轉換為 IMAGE 的庫" %}}
