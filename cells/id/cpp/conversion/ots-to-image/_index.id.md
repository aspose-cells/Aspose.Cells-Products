...
{{% cells-convert title="Contoh Kode untuk Mengonversi OTS ke IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="png" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert OTS ke IMAGE lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file OTS ke IMAGE secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke IMAGE hanya dalam beberapa baris kode.
...
1.  Konversikan OTS ke IMAGE dengan memanggil metode Save().
