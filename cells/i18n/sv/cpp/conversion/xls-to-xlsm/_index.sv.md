---
title: Konvertera XLS till XLSM via appen C++ 
weight: 7180
url: /sv/cpp/conversion/xls-to-xlsm/ 
description: Exempel på C++-konverteringskod för XLS-dokument till XLSM-format. Programmerare kan använda den här källkoden för batchkonvertering av XLS till XLSM inom alla C++-program.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLS till XLSM via C++" h2="Högpresterande XLS till XLSM-konvertering med hjälp av C++-biblioteket utan behov av Microsoft Excel, OpenOffice eller Adobe Acrobat-installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera XLS-fil till XLSM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLS-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (XLSM) filtillägg.1. XLSM-filen kommer att sparas på den angivna sökvägen.1. Öppna XLSM-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="XLS till XLSM C++ omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS till XLSM Conversion Live Demos" sectionDescription="[Konvertera XLS till XLSM](https://products.aspose.app/cells/conversion/xls-to-xlsm) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din XLS-fil, den konverteras omedelbart till XLSM." >}}
