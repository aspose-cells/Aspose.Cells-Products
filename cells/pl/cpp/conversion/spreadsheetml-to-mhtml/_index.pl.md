---
title: Konwertuj SPREADSHEETML na MHTML za pomocą aplikacji C++ 
url: /pl/cpp/conversion/spreadsheetml-to-mhtml/ 
description: Przykładowy kod konwersji C++ dla dokumentu SPREADSHEETML do formatu MHTML. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji SPREADSHEETML na MHTML w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SPREADSHEETML na MHTML za pomocą C++" %}}
 ...
 Aby przekonwertować SPREADSHEETML na MHTML, użyjemy
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik SPREADSHEETML na MHTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SPREADSHEETML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (MHTML).1. Plik MHTML zostanie zapisany pod określoną ścieżką.1. Otwórz plik MHTML w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML do MHTML C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja SPREADSHEETML do MHTML Prezentacje na żywo" sectionDescription="[Konwertuj SPREADSHEETML na MHTML](https://products.aspose.app/cells/conversion/spreadsheetml-to-mhtml) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij plik SPREADSHEETML, zostanie on natychmiast przekonwertowany do formatu MHTML." >}}
