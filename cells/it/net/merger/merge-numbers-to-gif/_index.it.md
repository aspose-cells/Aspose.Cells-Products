---
title: Unisci i NUMERI a GIF - Combina i NUMERI a GIF in C#
url: /it/net/merger/merge-numbers-to-gif/ 
description: Aspose Excel. C# Aspose.Cells. Unisci i NUMERI al formato di salvataggio GIF. C# Combina i NUMERI nel formato GIF. Unisci i NUMERI a GIF in C#. NUMERI Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci i NUMERI a GIF in C#" %}}

L'esempio seguente mostra come unire NUMBERS in GIF in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire i NUMERI a GIF. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file GIF. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedi l'esempio C# che unisce i NUMERI a GIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Codice di esempio per unire i NUMERI a GIF in C#" InputFormat="numbers" InputFormat2="gif" outformat="gif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire i NUMERI a GIF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 È necessario unire i NUMERI a GIF a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria .NET per unire i NUMERI allo GIF" %}}
