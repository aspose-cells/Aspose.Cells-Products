---
title: Python XLTX sang MHT - Bộ chuyển đổi XLTX sang MHT trực tuyến
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Trực tuyến miễn phí Python Chuyển đổi XLTX sang định dạng lưu MHT. Python XLTX sang định dạng MHT. Lưu XLTX thành MHT Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLTX thành MHT trong Python" h2="Thư viện Python tốc độ cao để chuyển đổi XLTX sang MHT. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất XLTX, MHT và nhiều định dạng khác bằng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLTX sang MHT qua Python" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi các tệp XLTX sang MHT theo chương trình? Các nhà phát triển Python có thể dễ dàng tải và chuyển đổi XLTX thành MHT chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLTX thành MHT bằng cách gọi phương thức Workbook.save.
1.  Lấy kết quả chuyển đổi đầu số XLTX sang MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python thư viện để chuyển XLTX sang MHT" %}}
