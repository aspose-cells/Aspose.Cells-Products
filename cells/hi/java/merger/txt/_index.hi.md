---
title:  TXT फ़ाइलें via Java मर्ज करें
weight: 4480
description: जेएसपी/जेएसएफ एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरमेंट पर TXT दस्तावेजों को संयोजित करने के लिए Java नमूना कोड।
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java में TXT फ़ाइलों को मर्ज करने के चरण" %}}
...
+ वर्कबुक क्लास के उदाहरण के साथ पहली TXT फ़ाइल लोड करें।
+ वर्कबुक क्लास के उदाहरण के साथ दूसरा TXT दस्तावेज़ लोड करें।
+ कंबाइन() विधि का उपयोग करके फ़ाइलें मर्ज करें।
+ मर्ज की गई TXT फ़ाइल को निर्दिष्ट पथ पर सहेजें
