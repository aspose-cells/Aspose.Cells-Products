...
description: Aspose Excel. Convierta JPG a PNG rápida y fácilmente con Aspose.Cells. C++ JPG a PNG. C++ Guarde JPG en PNG. Guarde JPG como PNG usando C++.
...
{{% blocks/products/pf/agp/content h2="Convierta JPG a PNG usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Guarde JPG en PNG en C++" %}}
...
{{% cells-convert title="Código de muestra para convertir JPG a PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="png" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir JPG a PNG a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos JPG a PNG mediante programación? Los desarrolladores de C++ pueden convertir fácilmente JPG a PNG con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para convertir JPG a PNG" %}}
