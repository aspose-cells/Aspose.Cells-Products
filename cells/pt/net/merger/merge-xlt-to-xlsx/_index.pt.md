...
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita XLT para XLSX saveformat. C# Combine o formato XLT a XLSX. Mesclar XLT a XLSX em C#. XLT Mesclar.
...
O exemplo a seguir demonstra como mesclar XLT a XLSX em Aspose.Cells for .NET.
...
{{% cells-merger title="Online grátis para mesclar XLT a XLSX em C#" InputFormat="xlt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLT a XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLT a XLSX programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLT a XLSX" %}}
