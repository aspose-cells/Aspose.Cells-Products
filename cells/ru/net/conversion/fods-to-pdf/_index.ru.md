...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в PDF, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в PDF в C#" %}}
...
1.  Преобразуйте значение FODS в PDF, вызвав метод Workbook.Save.
