---
title: Convertisseur C# XLS vers AZW3 - XLS vers AZW3
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir XLS au format AZW3, permettant un enregistrement transparent des données XLS au format AZW3 à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS en AZW3 dans C#" %}}

L'exemple suivant montre comment convertir XLS en AZW3 dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier XLS en AZW3. Téléchargez votre fichier XLS, puis enregistrez-le au format AZW3. Vous pouvez utiliser des noms de fichiers complets pour la lecture du fichier XLS et l'écriture au format AZW3. Le contenu et la mise en forme du fichier AZW3 généré seront identiques à ceux du document XLS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir XLS en AZW3" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="azw3" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en AZW3 via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XLS en AZW3 par programmation ? Les développeurs peuvent facilement charger et convertir des fichiers XLS en AZW3 en quelques lignes de code seulement.
...
1.  Convertissez XLS en AZW3 en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de XLS en AZW3.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en AZW3" %}}
