...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar un archivo Oval en Excel usando Python via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa la colección de formas[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addOval(int,%20int,%20int,%20int,%20int,%20int)) para insertar un óvalo en la hoja de trabajo seleccionada.
