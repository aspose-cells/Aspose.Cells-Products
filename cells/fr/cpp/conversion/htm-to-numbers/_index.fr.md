---
title: C++ Convertisseur HTM vers NUMÉROS - HTM vers NUMÉROS
description: Aspose Excel. Cette solution complète offre aux développeurs C++ une approche entièrement intégrée pour convertir le format HTM au format NUMBERS, permettant un enregistrement transparent des données HTM au format NUMBERS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C++ efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en NUMÉROS dans C++" h2="Conversion HTM vers NUMBERS haute performance utilisant la bibliothèque C++ sans avoir besoin de l\'installation d\'Excel, d\'OpenOffice ou d\'Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM dans NUMBERS dans C++" %}}

L'exemple suivant montre comment convertir du HTM en NUMÉROS dans C++.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier HTM en NUMBERS. Téléchargez votre fichier HTM, puis enregistrez-le au format NUMBERS. Vous pouvez utiliser des noms de fichiers complets pour la lecture HTM et l'écriture NUMBERS. Le contenu et la mise en forme du fichier NUMBERS de sortie seront identiques à ceux du document HTM d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir du HTML en nombres" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="numbers" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir du HTML en NUMÉROS via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en NUMBERS par programmation ? Les développeurs de C++ peuvent facilement convertir des fichiers HTM en NUMBERS en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1.  Installer 'Aspose.Cells for C++'.
1.  Ajoutez une référence de bibliothèque (importez la bibliothèque) à votre projet C++.
1.  Charger le fichier HTM à l'aide du classeur.
1. Convertissez le HTM en NUMBERS en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de HTM en NOMBRE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir HTM en NUMBERS" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/conversion/htm-to-pdf/" name="HTM AU PDF" description="Format de document portable" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/conversion/htm-to-png/" name="HTM AU PNG" description="Graphiques de réseau portables" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/conversion/htm-to-tiff/" name="HTM AU TIFF" description="Format d\'image balisé" >}}
