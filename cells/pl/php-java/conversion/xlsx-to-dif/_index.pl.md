...
description: Aspose Excel. Konwertuj XLSX na DIF szybko i łatwo za pomocą Aspose.Cells. PHP XLSX na DIF. PHP Zapisz XLSX na DIF. Zapisz XLSX jako DIF używając PHP.
...
Chcesz programowo przekonwertować pliki XLSX na DIF? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na DIF w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSX na numer DIF, wywołując metodę zapisu skoroszytu.
