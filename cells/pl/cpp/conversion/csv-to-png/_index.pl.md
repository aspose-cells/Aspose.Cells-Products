---
title: Konwertuj CSV na PNG za pomocą aplikacji C++ 
weight: 920
url: /pl/cpp/conversion/csv-to-png/ 
description: Przykładowy kod konwersji C++ dla dokumentu CSV do formatu PNG. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji CSV do PNG w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj CSV na PNG za pomocą C++" h2="Wydajna konwersja plików CSV do PNG przy użyciu biblioteki C++ bez konieczności instalowania programów Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik CSV na PNG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (PNG).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik PNG w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="CSV do PNG C++ Kod źródłowy konwersji" offSpacer="" %}}
