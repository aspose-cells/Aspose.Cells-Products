---
title: ODS'i MD'ye birleştir - ODS'i Java'de MD'ye birleştir
url: /tr/java/merger/merge-ods-to-md/ 
description: Aspose excel. Java Aspose.Cells. ODS'i MD saveformat'a Ücretsiz Çevrimiçi Birleştirme. Java ODS'i MD formatına birleştirin. ODS'i Java'de MD ile birleştir. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i MD ile Java Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de MD ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i MD ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından MD dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. ODS'i MD ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'de MD ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS ile MD via Java Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i programlı olarak MD ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i MD ile birleştirmek için Java kitaplığı" %}}
