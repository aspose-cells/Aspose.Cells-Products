---
title:  Hình mờ XLSX tài liệu via Java
weight: 7680
description: Mã mẫu Java để thêm hoặc xóa hình mờ vào tệp XLSX trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Thêm Hình mờ văn bản vào XLSX via Java" h2="Xây dựng ứng dụng Java của riêng bạn để tạo hình mờ cho các tệp XLSX bằng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách tạo hình mờ cho tệp XLSX bằng Java" %}}

 Để tạo hình mờ cho tệp XLSX, chúng tôi sẽ sử dụng[Aspose.Cells for Java](https://products.aspose.com/cells/java) API là một nền tảng tạo hình mờ giàu tính năng, mạnh mẽ và dễ sử dụng API for Java. Bạn có thể tải xuống phiên bản mới nhất của nó trực tiếp từ[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) và cài đặt nó trong dự án dựa trên Maven của bạn bằng cách thêm các cấu hình sau vào pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Các Bước Thêm Watermark Vào XLSX via Java" %}}
...
1.  Lưu sổ làm việc ở định dạng XLSX
...
{{% blocks/products/pf/agp/code-block title="Thêm Watermark vào XLSX - Java" offSpacer="" %}}
