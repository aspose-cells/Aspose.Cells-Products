---
title:  Supprimer ODS Annotation via Java
weight: 8840
...
{{% blocks/products/pf/agp/content h2="Comment annoter un fichier ODS à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter ou supprimer une annotation de ODS via Java" %}}
