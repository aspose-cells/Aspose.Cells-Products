...
description: Aspose Excel. Genera e manipola senza sforzo i file XLS con la libreria Aspose.Cells for Java. Questa potente libreria API offre una soluzione semplificata ed efficiente per creare, modificare e gestire i file XLS direttamente all'interno delle tue applicazioni Java, soddisfacendo le esigenze specifiche degli sviluppatori con elevata precisione.
...
1.  Salvare la cartella di lavoro nel formato XLS utilizzando il metodo save().
