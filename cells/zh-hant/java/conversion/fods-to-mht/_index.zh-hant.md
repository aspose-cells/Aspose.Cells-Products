---
title: Java FODS 轉 MHT - FODS 轉 MHT 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 FODS 轉換為 MHT。Java FODS 轉換為 MHT。 Java 將 FODS 儲存到 MHT。使用 Java 將 FODS 儲存為 MHT。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 Java 中的 MHT" h2="用於將 FODS 轉換為 MHT 的高速 Java 庫。這是一個專業的軟體解決方案，可以使用Java導入和匯出FODS、MHT和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 Java 中的 MHT" %}}

以下範例示範如何將 FODS 轉換為 Java 中的 MHT。
...
{{% cells-convert title="將 FODS 轉換為 MHT 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="mht" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為 MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 檔案轉換為 MHT？ Java開發人員只需幾行程式碼即可輕鬆將FODS轉換為MHT。
...
{{% blocks/products/pf/agp/content h2="Java庫將FODS轉換為MHT" %}}
{{% blocks/products/pf/agp/text %}}
