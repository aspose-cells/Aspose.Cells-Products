...
{{% blocks/products/pf/agp/content h2="Convertir XLSM en ET en utilisant Python" %}}
...
L'exemple suivant montre comment convertir XLSM en ET dans Python.
