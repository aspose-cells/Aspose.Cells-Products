---
title: C# OTS'den TXT'e - Çevrimiçi OTS'den TXT'e Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# OTS'yi TXT saveformat'a dönüştürün. C# OTS'den TXT formatına. OTS'yi TXT C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi C# içinde TXT\'e Çevrimiçi olarak Ücretsiz olarak kaydedin" %}}

Aşağıdaki örnek, OTS'nin C#'de TXT'e nasıl dönüştürüleceğini gösterir.
...
OTS dosyalarını programlı olarak TXT'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, OTS'yi yalnızca birkaç satır kodla kolayca yükleyebilir ve TXT'e dönüştürebilir.
