...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor TSV na JPEG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavte možnosti (JPEG).1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor JPEG v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TSV na JPEG C++" offSpacer="" %}}
