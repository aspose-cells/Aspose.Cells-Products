---
title:  .NET Java Python C++ PHP és Android Excel táblázatelemző API-k
weight: 10
description: Könyvtárak olvasáshoz, íráshoz és kezeléshez Microsoft Excel-fájlok .NET Java C++ Android és SharePoint alkalmazásokban. Munkalapok exportálása SSRS-ben és JasperReports-ban
---
...
Cél: .NET Framework, .NET Core & Xamarin platform alkalmazások fejlesztéséhez Windows, iOS, macOS és Android számára.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" productLink="/cells/java/" >}}
Natív Java API-k asztali számítógéphez, webhez vagy bármilyen alkalmazáshoz a Java SE vagy EE alapján.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="C++" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" productLink="/cells/cpp/" >}}
Excel-táblázat-formátumok létrehozása, olvasása, szerkesztése, konvertálása vagy renderelése a C++ alkalmazásokból.
{{< /blocks/products/pf/product >}}
...
Exportálhatja a jelentéseket Excel fájlformátumba és PDF-re a JasperReportsból vagy a JasperServerből.
{{< /blocks/products/pf/product >}}
...
Excel dokumentumok betöltése, létrehozása, kezelése és renderelése a Python használatával.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Miért Aspose.Cells termékcsalád?" tabId="success-stories" >}}
