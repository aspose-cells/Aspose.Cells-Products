---
title: PHP XLAM'den MD'ye - XLAM'den MD'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile XLAM'i hızlı ve kolay bir şekilde MD'ye dönüştürün. PHP XLAM'i MD'ye dönüştürün. PHP XLAM'i MD'ye kaydedin. PHP kullanarak XLAM'i MD olarak kaydedin.
...
{{% cells-convert title="XLAM\'i MD\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="md" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="XLAM\'i PHP aracılığıyla MD\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLAM dosyalarını programlı olarak MD'ye dönüştürmeniz mi gerekiyor? PHP geliştiricileri XLAM'i yalnızca birkaç satır kodla kolayca yükleyebilir ve MD'ye dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLAM'i MD'ye dönüştürün.
1.  XLAM'in MD'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLAM\'i MD\'ye dönüştürmek için PHP kütüphanesi" %}}
