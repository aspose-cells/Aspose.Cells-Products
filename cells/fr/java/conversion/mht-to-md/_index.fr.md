---
title: Java MHT en MD - Convertisseur MHT en MD en ligne
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir MHT en format de sauvegarde MD. Java Format MHT vers MD. Enregistrez MHT sur MD Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez MHT en MD au Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir MHT en MD en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir MHT en MD. Téléchargez votre fichier MHT, puis enregistrez-le simplement en tant que fichier MD. Pour la lecture MHT et l'écriture MD, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage du MD de sortie seront identiques au document MHT d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir MHT en MD en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHT en MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en MD par programmation ? Les développeurs Java peuvent facilement convertir MHT en MD en quelques lignes de code.
...
1.  Convertissez MHT en MD en appelant la méthode Workbook.save.
