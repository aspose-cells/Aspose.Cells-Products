...
{{% blocks/products/pf/agp/content h2="Jak generovat sestavy XLSM pomocí Java" %}}
 ...
 K vytvoření XLSM souborových sestav použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k generování XLSM sestav via Java" %}}
...
1.  Uložte výsledek ve formátu XLSM pomocí metody Worbook.save
