---
title: Konversikan SXC ke TSV melalui Java 
url: /id/java/conversion/sxc-to-tsv/ 
description: Contoh Java kode konversi untuk format SXC ke file TSV. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke TSV dalam Aplikasi berbasis Java Web atau Desktop apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan SXC ke TSV melalui Java" h2="Konversi SXC ke TSV Java untuk mengonversi satu atau beberapa laman ke TSV menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi SXC ke TSV Menggunakan Java" %}}

 Untuk merender SXC ke TSV, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi SXC ke TSV melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file SXC ke TSV hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file SXC dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi TSV & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file TSV yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="SXC ke TSV Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file SXC dalam contoh Workbook
Workbook book = new Workbook("template.sxc");
// simpan SXC sebagai TSV
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi SXC ke TSV" sectionDescription="[Mengonversi SXC ke TSV](https://products.aspose.app/cells/conversion/sxc-to-tsv) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file SXC Anda, itu akan langsung dikonversi ke TSV." >}}
