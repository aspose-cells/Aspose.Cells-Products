...
هل تحتاج إلى تحويل ملفات MHT إلى MARKDOWN برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى MARKDOWN بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى MARKDOWN عن طريق استدعاء دالة Save().
