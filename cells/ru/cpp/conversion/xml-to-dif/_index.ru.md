...
Нужно программно преобразовать файлы XML в DIF? Разработчики C++ могут легко преобразовать XML в DIF всего за несколько строк кода.
