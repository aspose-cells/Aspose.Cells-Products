...
{{% blocks/products/pf/agp/content h2="Sla HTML op in GIF in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar GIF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar GIF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar GIF? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar GIF met slechts een paar regels code.
