---
title: Convierta XLT a SXC a través de Python
url: /es/python-java/conversion/xlt-to-sxc/
description: Ejemplo de código para la conversión de xlt a sxc Python. Use el código de ejemplo API para la conversión de archivos xlt por lotes a sxc dentro de la aplicación Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta XLT a SXC a través de Python" h2="Exporte hojas de cálculo de Excel® a formato SXC utilizando Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a SXC usando Python" %}}

 Para convertir XLT a SXC, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLT a SXC a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden cargar y convertir fácilmente archivos XLT a SXC con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLT con una instancia de Workbook1. Llame al método Workbook.Save1. Pase la ruta de salida con la extensión SXC como parámetro1. Compruebe la ruta especificada para el archivo SXC resultante
