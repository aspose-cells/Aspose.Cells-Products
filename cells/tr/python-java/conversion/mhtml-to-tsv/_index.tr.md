...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde MHTML'i TSV'e dönüştürün. Python MHTML'i TSV'e dönüştürün. Python MHTML'i TSV'e kaydedin. MHTML'i 07611134 olarak kaydedin 81, Python'i kullanarak.
...
{{% blocks/products/pf/agp/content h2="Python\'i kullanarak MHTML\'i TSV\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="MHTML\'i Python\'e TSV\'e kaydedin" %}}

Aşağıdaki örnek, MHTML'in Python'de TSV'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="MHTML\'i TSV\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="tsv" IsLandingPage="true" language="pythonjava" %}}
