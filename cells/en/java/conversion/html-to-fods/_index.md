...
description: Sample Java conversion code for HTML format to FODS file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to FODS within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert HTML to FODS Using Java" %}}

 In order to render HTML to FODS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert HTML to FODS via Java" %}}
