---
title: Konwertuj JSON na MD za pomocą aplikacji C++ 
url: /pl/cpp/conversion/json-to-md/ 
description: Przykładowy kod konwersji C++ dla dokumentu JSON do formatu MD. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji JSON na MD w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik JSON na MD w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik JSON przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (MD).1. Plik MD zostanie zapisany pod określoną ścieżką.1. Otwórz plik MD w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji JSON do MD C++" offSpacer="" %}}
