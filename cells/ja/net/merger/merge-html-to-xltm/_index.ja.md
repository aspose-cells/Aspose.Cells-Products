---
title: HTML から XLTM を結合 - HTML から XLTM を C# に結合
url: /ja/net/merger/merge-html-to-xltm/ 
description: Aspose エクセル。 C# Aspose.Cells。HTML を XLTM の保存形式にマージします。 C# HTML と XLTM の形式を結合します。 HTML から XLTM を C# に結合します。HTML を結合します。
...
次の例は、HTML を Aspose.Cells for .NET の XLTM にマージする方法を示しています。
