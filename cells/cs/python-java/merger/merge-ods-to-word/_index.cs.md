---
title: Sloučit ODS až WORD - Sloučit ODS až WORD v Python
url: /cs/python-java/merger/merge-ods-to-word/ 
description: Aspose Excel. Python Aspose.Cells. Sloučit ODS do WORD uložit formát. Python Kombinujte formát ODS až WORD. Sloučit ODS až WORD v Python. ODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS až WORD pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS až WORD v Python" %}}

Následující příklad ukazuje, jak sloučit ODS až WORD v Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení ODS do WORD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí ODS do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení ODS až WORD v Python" InputFormat="ods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit ODS na WORD přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit ODS až WORD? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python ke sloučení ODS až WORD" %}}
