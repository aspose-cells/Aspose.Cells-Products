---
title: Python OTS 轉 EXCEL - 在線 OTS 轉 EXCEL 轉換器
description: Aspose Excel。 Python Aspose.Cells. Python Aspose Cells. 免費在線 Python 將 OTS 轉換為 EXCEL 保存格式。 Python OTS 轉 EXCEL 格式。將 OTS 保存到 EXCEL Python。
...
1. 通過調用 Workbook.save 方法將 OTS 轉換為 EXCEL。
1. 獲取OTS到EXCEL的轉換結果。
