...
description: Aspose Excel. A MHTML-es számot gyorsan és egyszerűen SPREADSHEETML-re alakíthatja át a Aspose.Cells-es számmal. Python Mentse a MHTML számot a SPREADSHEETML-be. Mentse el a MHTML-et SPREADSHEETML-ként a Python használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse a MHTML-et a SPREADSHEETML-be a Python-ben" %}}
