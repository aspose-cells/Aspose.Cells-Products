...
url: /nl/python-java/merger/merge-prn-to-jpg/ 
...
Het volgende voorbeeld laat zien hoe u PRN kunt samenvoegen met JPG in Aspose.Cells for Python via Java.
...
Wilt u PRN programmatisch samenvoegen met JPG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
