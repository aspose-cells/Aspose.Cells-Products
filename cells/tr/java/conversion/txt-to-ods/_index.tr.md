---
title: Java aracılığıyla TXT'yi ODS'ye dönüştürün 
weight: 8700

description: TXT biçimi için ODS dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada ODS'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla TXT\'yi ODS\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı ODS\'ye dönüştürmek için TXT\'den ODS\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TXT\'yi ODS\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden TXT\'yi ODS\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla TXT dosyasını ODS'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TXT dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. ODS uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan ODS dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="TXT\'den ODS\'ye Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TXT dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.txt");
// TXT'yi ODS olarak kaydet
