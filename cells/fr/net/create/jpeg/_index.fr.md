...
{{% blocks/products/pf/agp/content h2="Comment créer JPEG dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="L\'exemple de code montre comment créer le fichier JPEG dans C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour créer le fichier JPEG" %}}
