...
description: Aspose एक्सेल। Aspose.Cells के साथ PNG को जल्दी और आसानी से एक्सेल में बदलें। Python PNG को एक्सेल में बदलें। Python PNG को एक्सेल में सेव करें। Python का उपयोग करके PNG को एक्सेल के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="PNG को एक्सेल में Python में सेव करें" %}}
...
{{% cells-convert title="PNG को एक्सेल में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}
