---
title: Voeg toelichtingen in Excel in met behulp van Python via .Net
weight: 360
description: Python via .Net-broncode om toelichtingen in Excel in te voegen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg toelichtingen in Excel in met behulp van Python via .Net" h2="Voeg toelichtingen in met Aspose.Cells\' API zonder enige software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Callouts in Excel-bestand invoegen met Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om toelichtingen in Excel-bestand in te voegen met behulp van Python via .Net" %}}
...
+ Selecteer werkblad via de index.
 + Gebruik de add-on van de shapecollection[methode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) om toelichtingen in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Toelichtingen invoegen - Python via .Net" offSpacer="" %}}
...
Overzicht van soorten toelichtingen
 ...
 AutoVormType.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12" style="font-size:0.8rem !important;">
 AutoVormType.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR3
    </p>
   </div>
  </div>
 </div>
