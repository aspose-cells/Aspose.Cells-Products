...
description: Aspose Excel. Converta TABDELIMITED em XLS de forma rápida e fácil com Aspose.Cells. PHP TABDELIMITED em XLS. PHP Salve TABDELIMITED em XLS. Salve TABDELIMITED como XLS usando PHP.
...
Precisa converter arquivos TABDELIMITED para XLS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TABDELIMITED em XLS em apenas algumas linhas de código.
...
1.  Converta TABDELIMITED em XLS chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TABDELIMITED para XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED para XLS" %}}
