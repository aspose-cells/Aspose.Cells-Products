...
url: /vi/python-java/merger/merge-prn-to-sql/ 
...
Ví dụ sau đây minh họa cách hợp nhất PRN với SQL theo số Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Cần hợp nhất PRN với SQL theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API có thể được thực hiện chỉ với vài dòng mã.
