...
description: C# Código de amostra para criar gráficos de pizza para Excel usando a Biblioteca .NET. Use este código para criar um gráfico de pizza para MS Excel em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
