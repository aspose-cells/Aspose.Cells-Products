---
title: Gộp XLTM vào XLSM - Gộp XLTM vào XLSM vào C++
url: /vi/cpp/merger/merge-xltm-to-xlsm/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất XLTM thành XLSM saveformat. C++ Kết hợp định dạng XLTM thành XLSM. Hợp nhất XLTM thành XLSM vào C++. XLTM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLTM thành XLSM vào C++" %}}

Ví dụ sau đây minh họa cách hợp nhất XLTM với XLSM trong Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XLTM thành XLSM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp XLSM. Nếu bạn phát triển mã bằng C++, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C++ hợp nhất XLTM thành XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp XLTM thành XLSM trong C++" InputFormat="xltm" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp XLTM vào XLSM qua C++" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ gộp XLTM thành XLSM" %}}
