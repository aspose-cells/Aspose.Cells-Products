---
title: ET aanmaken - Maak een ET-bestand aan in C++
description:  Aspose Excel. C++ Maak snel en eenvoudig een ET-bestand aan met Aspose.Cells. Genereer een ET-bestand met C++. Maak een ET aan in C++. C++ ET Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een ET-bestand aan in C++" h2="Native en krachtige ET-bestandscreatie programmatisch zonder Microsoft Office met behulp van de C++-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="ET aanmaken in C++" %}}

{{% blocks/products/pf/agp/text %}}

 Het is voor de ontwikkelaars gemakkelijk om ET-bestanden te maken, laden, wijzigen en converteren binnen actieve rapportageapplicaties voor gegevensverwerking in slechts enkele regels code.
...
1.  Sla de werkmap op als .et-bestand met behulp van de Save()-methode.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een ET-bestand kunt maken in C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om ET-bestand te maken" %}}
