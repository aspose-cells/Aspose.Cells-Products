---
title:  Połącz XLSB Pliki via .NET
weight: 2970
description: C# kod źródłowy do łączenia dokumentów XLSB na platformach .NET Framework, .NET Core, Mono lub Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Połącz formaty XLSB w C#" h2="Natywne i wydajne łączenie dokumentów XLSB przy użyciu interfejsów API Aspose.Cells for .NET po stronie serwera, bez użycia oprogramowania takiego jak Microsoft lub Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
+ Wywołaj metodę Save() i podaj nazwę pliku (pełna ścieżka) oraz format (XLSB) jako parametr.
+ Teraz możesz otworzyć i używać pliku XLSB w Microsoft Office, Adobe PDF lub innym kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Połącz pliki XLSB - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "d7c757e7471bd38006ac0d35d221b2e2" "merge-xlsb-files.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{< blocks/products/pf/agp/demobox sectionTitle="Online XLSB Fuzja Demo na żywo" sectionDescription=" Scal dokumenty XLSB już teraz, odwiedzając naszą[Strona demonstracyjna na żywo](https://products.aspose.app/cells/merger). Demo na żywo ma następujące zalety" >}}
