...
description: Aspose Excel。此综合解决方案为 PHP 开发人员提供了一种完全集成的方法，可将 MHTML 转换为 ETT 格式，从而能够使用 Aspose.Cells 库将 MHTML 数据无缝保存为 ETT 格式，所有这些都通过高效且可定制的 PHP 代码实现。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 MHTML 转换为 PHP 中的 ETT" h2="用于将 MHTML 转换为 ETT 的高速 PHP 库。这是一个专业的软件解决方案，可使用 PHP 导入和导出 MHTML、ETT 和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ETT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何将 MHTML 转换为 ETT？使用 Aspose.Cells for PHP via Java 库，只需几行代码即可轻松地通过编程方式将 MHTML 转换为 ETT。[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/)它能够构建跨平台应用程序，并具备生成、修改、转换、渲染和打印所有 Excel 文件的能力。PHP Excel API 不仅可以转换电子表格格式，还可以将 Excel 文件渲染为图像（PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT）等等，因此是交换行业标准格式文档的理想选择。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="以 PHP 格式将 MHTML 保存到 ETT" %}}

以下示例演示了如何在 PHP 中将 MHTML 转换为 ETT。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 MHTML 转换为 ETT。上传您的 MHTML 文件，然后将其保存为 ETT 文件。对于 MHTML 读取和 ETT 写入，您都可以使用完全合格的文件名。输出的 ETT 内容和格式将与原始 MHTML 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 MHTML 转换为 ETT 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mhtml" outformat="ett" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 PHP 将 MHTML 转换为 ETT" %}}

{{% blocks/products/pf/agp/text %}}

需要通过编程方式将 MHTML 文件转换为 ETT 格式吗？PHP 开发人员只需几行代码即可轻松加载 MHTML 文件并将其转换为 ETT 格式。
...
1. 调用 Workbook 的 save 方法将 MHTML 转换为 ETT。
1. 获取MHTML至ETT的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="用于将 MHTML 转换为 ETT 的 PHP 库" %}}
