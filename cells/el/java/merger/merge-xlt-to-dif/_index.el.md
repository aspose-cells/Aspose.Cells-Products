---
title: Συγχώνευση XLT σε DIF - Συνδυάστε XLT σε DIF στο Java
url: /el/java/merger/merge-xlt-to-dif/ 
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση XLT σε μορφή αποθήκευσης DIF. Java Συνδυάστε τη μορφή XLT με DIF. Συγχώνευση XLT σε DIF στο Java. XLT Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLT σε DIF χρησιμοποιώντας Java" %}}
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLT με DIF στο Java" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLT με το DIF στο Aspose.Cells for Java.
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLT έως DIF στο Java" InputFormat="xlt" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Τρόπος συγχώνευσης XLT σε DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε το XLT με το DIF μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for Java](https://products.aspose.com/cells/java) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="Java βιβλιοθήκη για συγχώνευση XLT με DIF" %}}
