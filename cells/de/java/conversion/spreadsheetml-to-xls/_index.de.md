...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SPREADSHEETML in XLS mit Java" %}}

 Um SPREADSHEETML in XLS zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von SPREADSHEETML in XLS über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können SPREADSHEETML-Dateien in nur wenigen Codezeilen ganz einfach in XLS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die SPREADSHEETML-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit XLS-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende XLS-Datei
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML-zu-XLS-Java-Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die SPREADSHEETML-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.spreadsheetml");
// SPREADSHEETML als XLS speichern
