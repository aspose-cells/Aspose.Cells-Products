---
title:  Afficher les formats de fichiers TSV via .NET
weight: 3090
description: Code source C# pour charger, restituer et afficher les documents TSV sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/content h2="Comment afficher le fichier TSV à l\'aide de C#" %}}
 ...
 Afin de visualiser le fichier TSV, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour afficher le TSV via le C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells permet aux développeurs de visualiser facilement le fichier TSV avec seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier TSV dans une instance de Workbook
1.  Créez une instance de HtmlSaveOptions et définissez la propriété ExportHeadings sur true
1. Enregistrez le fichier TSV au format HTML à l'aide de la méthode Workbook.Save
...
{{% blocks/products/pf/agp/code-block title="Exemple de code C# pour afficher le fichier TSV" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API peut être utilisé pour créer, éditer, convertir et restituer Microsoft des formats Excel vers différents formats. De plus, il peut être utilisé pour des graphiques complets, des rapports évolutifs et des calculs fiables au sein d'applications logicielles. Aspose.Cells est un API autonome et ne nécessite aucun logiciel comme Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour afficher le TSV" sectionDescription=" Consultez nos démos en direct pour[Voir TSV](https://products.aspose.app/cells/viewer/tsv) avec les avantages suivants." >}}
