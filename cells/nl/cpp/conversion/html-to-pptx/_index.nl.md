...
{{% blocks/products/pf/agp/content h2="Sla HTML op in PPTX in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar PPTX in C++.
...
Moet je bestanden met de extensie HTML programmatisch converteren naar PPTX? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar PPTX met slechts een paar regels code.
