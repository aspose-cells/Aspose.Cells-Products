---
title: Gộp JPG thành XLSB - Gộp JPG thành XLSB vào Java
url: /vi/java/merger/merge-jpg-to-xlsb/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất JPG thành XLSB saveformat. Java Kết hợp JPG thành định dạng XLSB. Hợp nhất JPG thành XLSB trong Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất JPG thành XLSB trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất JPG thành XLSB trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất JPG thành XLSB. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu vào tệp XLSB. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất JPG thành XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu ghép JPG thành XLSB trong Java" InputFormat="jpg" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép JPG thành XLSB via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java ghép JPG thành XLSB" %}}
