---
title: Creëer PNG - Creëer PNG bestand in Python
description: Aspose Excel. Python Creëer PNG-bestand. Creëer PNG Python. Python PNG Maker. Maak PNG in Python. Genereer PNG-bestand met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak PNG-bestand in Python" h2="Snelle Python-bibliotheek voor het maken van een PNG-bestand. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. Gebruik de methode Save om de werkmap op te slaan als PNG-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een PNG-bestand maakt in Python." offSpacer="" %}}
