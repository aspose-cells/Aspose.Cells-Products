---
title: Java FODS tot BMP - FODS tot BMP Converter
description: Aspose Excel. Converteer FODS snel en eenvoudig naar BMP met Aspose.Cells. Java FODS naar BMP. Java Bewaar FODS in BMP. Bewaar FODS als 07611134 81 via Java.
...
{{% blocks/products/pf/agp/content h2="Bewaar FODS t/m BMP in Java" %}}

Het volgende voorbeeld laat zien hoe u FODS converteert naar BMP in Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om FODS naar BMP te converteren. Upload uw FODS-bestand en sla het vervolgens eenvoudig op als BMP-bestand. Voor zowel FODS lezen als BMP schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De inhoud en opmaak van de uitvoer BMP zullen identiek zijn aan het originele document FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Voorbeeldcode om FODS naar BMP te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="bmp" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe FODS naar BMP via Java te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u FODS-bestanden programmatisch naar BMP converteren? Java-ontwikkelaars kunnen FODS eenvoudig in slechts een paar regels code naar BMP converteren.
...
1.  Converteer FODS naar BMP door de Workbook.save-methode aan te roepen.
