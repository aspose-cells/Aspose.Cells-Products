...
url: /nl/python-java/merger/merge-prn-to-tiff/ 
...
Het volgende voorbeeld laat zien hoe u PRN kunt samenvoegen tot TIFF in Aspose.Cells for Python via Java.
...
Wilt u PRN programmatisch samenvoegen met TIFF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
