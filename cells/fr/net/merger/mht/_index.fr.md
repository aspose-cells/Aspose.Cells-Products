...
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats MHT dans C#" h2="Fusion de documents MHT native et hautes performances à l\'aide d\'API Aspose.Cells for .NET côté serveur, sans l\'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHT" >}}
...
1. Chargez tous les fichiers MHT avec le chemin complet.1. Créer un document comme fichier de base1. Appelez la méthode appropriée pour concaténer et fusionner les fichiers un par un.1. Appelez la méthode Save() et passez le nom du fichier (chemin complet) et le format (MHT) en tant que paramètre.1. Vous pouvez maintenant ouvrir et utiliser le fichier MHT dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
