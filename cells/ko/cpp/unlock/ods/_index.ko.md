...
weight: 1190
description: C++ 예제 코드는 C++ 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경에서 암호로 보호된 ODS 파일을 잠금 해제합니다.
---
