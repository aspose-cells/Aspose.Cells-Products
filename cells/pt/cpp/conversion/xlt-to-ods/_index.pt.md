...
description: Aspose Excel. Converta XLT em ODS de forma rápida e fácil com Aspose.Cells. C++ XLT em ODS. C++ Salve XLT em ODS. Salve XLT como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLT em ODS usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLT para ODS em C++" %}}

O exemplo a seguir demonstra como converter XLT em ODS em C++.
...
{{% cells-convert title="Exemplo de código para converter XLT em ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="ods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLT em ODS por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLT em ODS programaticamente? Os desenvolvedores do C++ podem converter facilmente XLT em ODS em apenas algumas linhas de código.
...
1.  Converta XLT em ODS chamando o método Save().
