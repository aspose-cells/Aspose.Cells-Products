---
title: PHP NOMBRES en IMAGE - Convertisseur NOMBRES en IMAGE
description: Aspose Exceller. Convertissez des NOMBRES en IMAGE rapidement et facilement avec Aspose.Cells. PHP NOMBRES en IMAGE. PHP Enregistrez les NOMBRES dans l'IMAGE. Enregistrez les NUMÉROS sous forme d'IMAGE en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en IMAGE via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en IMAGE par programme ? Les développeurs PHP peuvent facilement charger et convertir des NUMBERS en IMAGE en quelques lignes de code.
...
1.  Convertissez NUMBERS en IMAGE en appelant la méthode de sauvegarde du Workbook.
1.  Obtenez le résultat de la conversion de NUMBERS en IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir des NUMBERS en IMAGE" %}}
