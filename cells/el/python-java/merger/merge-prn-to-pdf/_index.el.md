---
title:  Συγχώνευση PRN στο PDF μέσω Python
url: /el/python-java/merger/merge-prn-to-pdf/ 
description: Συγχώνευση PRN στο PDF Online δωρεάν. Δωρεάν online PRN to PDF Merger. Συγχώνευση PRN σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN στο PDF στο Python.
