---
title: Convertir HTML en XLAM Python via Python
description: Convertissez HTML en XLAM en ligne gratuitement. Convertisseur en ligne gratuit HTML à XLAM. Python HTML à XLAM. HTML à XLAM via Python.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Python peuvent facilement charger et convertir HTML en XLAM en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier HTML avec une instance de Workbook
1.  Convertir HTML en XLAM en appelant la méthode Workbook.save
