...
url: /tr/net/merger/merge-mht-to-fods/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin FODS ile nasıl birleştirileceğini gösterir.
...
MHT'yi programlı olarak FODS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi FODS ile birleştirmek için .NET kitaplığı" %}}
