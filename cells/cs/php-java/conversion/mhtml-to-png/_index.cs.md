---
title: Konvertor PHP MHTML až PNG - MHTML až PNG
description: Aspose Excel. Převeďte MHTML na PNG rychle a snadno pomocí Aspose.Cells. PHP MHTML na PNG. PHP Uložte MHTML na PNG. Uložte PNG jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na PNG přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na PNG programově? Vývojáři PHP mohou snadno načíst a převést MHTML na PNG v několika řádcích kódu.
...
1.  Převeďte MHTML na PNG voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na PNG" %}}
