---
title: C++ XLSB à XLSX - Convertisseur en ligne XLSB à XLSX
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde XLSX. Format C++ XLSB à XLSX. Enregistrez XLSB à XLSX C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à XLSX dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en XLSX en C++.
...
Besoin de convertir les fichiers XLSB en XLSX par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en XLSX en seulement quelques lignes de code.
