---
title:  Insérer des légendes dans Excel via .NET
weight: 360
...
{{< blocks/products/pf/i18n/upper-banner h1="Insérer des légendes dans Excel via Java" h2="Insérez des objets à l\'aide d\'API côté serveur sans aucun logiciel comme Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment insérer des légendes dans un fichier Excel à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer des légendes dans le fichier Excel via Java" %}}
...
+ Sélectionnez Feuille de travail via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) pour insérer des légendes dans la feuille de calcul sélectionnée
...
L'exemple de code ci-dessous montre comment insérer une "bulle de pensée : nuage". Pour plus de types, veuillez vous référer à "Aperçu des types de légendes de bloc" ci-dessous.

{{% blocks/products/pf/agp/code-block title="Insérer des légendes - Java" offSpacer="" %}}
