...
{{% blocks/products/pf/agp/text %}}
 ...
 من السهل على المطورين إنشاء ملفات HTM وتحميلها وتعديلها وتحويلها ضمن تطبيقات إعداد التقارير قيد التشغيل لمعالجة البيانات في بضعة أسطر من التعليمات البرمجية.
...
1.  احفظ المصنف كملف .htm باستخدام طريقة Save ().
