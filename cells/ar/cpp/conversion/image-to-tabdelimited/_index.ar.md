...
description: Aspose اكسل. قم بتحويل IMAGE إلى TABDELIMITED بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى TABDELIMITED. C++ حفظ الصورة في TABDELIMITED. احفظ الصورة باسم TABDELIMITED باستخدام C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصورة إلى TABDELIMITED في C++" h2="تحويل IMAGE إلى TABDELIMITED عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى TABDELIMITED برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى TABDELIMITED بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى TABDELIMITED عن طريق استدعاء أسلوب Save().
