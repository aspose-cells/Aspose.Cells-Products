...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in TSV in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar TSV in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar TSV of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar TSV? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar TSV met slechts een paar regels code.
