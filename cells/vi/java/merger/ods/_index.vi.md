---
title:  Hợp nhất ODS Tệp via Java
weight: 6270
description: Mã mẫu Java để kết hợp các tài liệu ODS trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng ODS trong Java" h2="Hợp nhất tài liệu gốc ODS bằng cách sử dụng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước gộp file ODS vào Java" %}}
...
+ Tải file ODS đầu tiên với instance của lớp Workbook.
+ Tải tài liệu ODS thứ hai với một thể hiện của lớp Workbook.
+ Gộp file bằng phương thức Combine().
+ lưu file ODS đã merge vào đường dẫn xác định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tập tin ODS - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến ODS Sáp nhập Demo trực tiếp" sectionDescription=" Hợp nhất tài liệu ODS ngay bây giờ bằng cách truy cập của chúng tôi[Trang web demo trực tiếp](https://products.aspose.app/cells/merger). Bản demo trực tiếp có những lợi ích sau" >}}
