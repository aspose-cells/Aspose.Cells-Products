...
weight: 1000
url: /fr/cpp/metadata/ods/ 
description: C++ exemple de code pour modifier ou afficher les métadonnées du fichier ODS sur C++ l'environnement d'exécution pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
...
{{% blocks/products/pf/agp/content h2="Comment obtenir des métadonnées ODS à l\'aide de C++" %}}
