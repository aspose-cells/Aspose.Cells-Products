...
{{% blocks/products/pf/agp/content h2="كيفية إدراج RadioButton (عنصر تحكم النموذج) في ملف Excel باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج RadioButton (التحكم في النموذج) في ملف Excel عبر Python" %}}
...
+ استخدم طريقة إضافة shapecollection لإدراج RadioButton (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل RadioButton (التحكم في النموذج) - Python" offSpacer="" %}}
