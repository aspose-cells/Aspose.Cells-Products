...
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل MHT إلى تنسيق XLS، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق XLS باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="حوّل MHT إلى XLS باستخدام C++" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى XLS في C++" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى XLS برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى XLS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLS عن طريق استدعاء دالة Save().
