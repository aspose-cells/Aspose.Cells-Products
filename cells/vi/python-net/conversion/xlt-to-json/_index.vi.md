...
description: Aspose Excel. Chuyển đổi XLT sang JSON nhanh chóng và dễ dàng với Aspose.Cells. Python XLT sang JSON. Python Lưu XLT thành JSON. Lưu XLT thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Lưu XLT vào JSON trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLT thành JSON trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLT thành JSON" %}}
