---
title: C# XLS till HTM - XLS till HTM-omvandlare
description: Aspose Excel. Konvertera XLS till HTM snabbt och enkelt med Aspose.Cells. C# XLS till HTM. C# Spara XLS till HTM. Spara XLS som HTM med C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLS till HTM i C#" h2="Höghastighets C#-bibliotek för att konvertera XLS till HTM. Detta är en professionell mjukvarulösning för att importera och exportera XLS, HTM och många andra format på .NET Framework, .NET Core eller Mono plattformar." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Spara XLS till HTM på C#" %}}
...
{{% cells-convert title="Exempelkod för att konvertera XLS till HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till HTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till HTM programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till HTM på bara några rader kod.
