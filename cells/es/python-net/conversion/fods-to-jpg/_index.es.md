...
description: Aspose Excel. Convierta FODS a JPG rápida y fácilmente con Aspose.Cells. Python FODS a JPG. Python Guardar FODS en JPG. Guarde FODS como JPG usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde FODS en JPG en Python" %}}

El siguiente ejemplo demuestra cómo convertir FODS a JPG en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir FODS a JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir FODS a JPG" %}}
