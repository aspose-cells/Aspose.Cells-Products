---
title:  Combinar XLS a JSON via Java
...
El siguiente ejemplo muestra cómo combinar XLS con JSON en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a JSON en línea" InputFormat="xls" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
