...
url: /ja/cpp/merger/merge-xls-to-md/ 
...
次の例は、XLS を Aspose.Cells for C++ の MD にマージする方法を示しています。
...
{{% cells-merger title="XLS を C++ の MD にマージするサンプルコード" InputFormat="xls" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLS を経由して XLS を MD にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

XLS をプログラムで MD にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="XLS を MD にマージする C++ ライブラリ" %}}
