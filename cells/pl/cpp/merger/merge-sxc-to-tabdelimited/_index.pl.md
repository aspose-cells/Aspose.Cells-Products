---
title: Połącz SXC z TABDELIMITED - Połącz SXC z TABDELIMITED w C++
url: /pl/cpp/merger/merge-sxc-to-tabdelimited/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online SXC do formatu zapisu TABDELIMITED. C++ Połącz SXC w formacie TABDELIMITED. Połącz SXC z TABDELIMITED w C++. SXC Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz SXC z TABDELIMITED w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić SXC z TABDELIMITED w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć SXC z TABDELIMITED. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku TABDELIMITED. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy SXC z TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online SXC z TABDELIMITED w C++" InputFormat="sxc" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć SXC z TABDELIMITED przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić SXC z TABDELIMITED? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
