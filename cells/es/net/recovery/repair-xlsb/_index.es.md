---
title: Reparar archivo xlsb via .NET
url: /es/net/recovery/repair-xlsb/ 
description: Repare un archivo xlsb dañado usando C#. Herramienta de recuperación para reparar un archivo xlsb dañado dentro de la aplicación .NET.
---
...
{{% cells-recovery title="Aplicación gratuita para reparar el archivo XLSB usando .NET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsb" outformat="xlsb" IsLandingPage="true" language="net" %}}    
