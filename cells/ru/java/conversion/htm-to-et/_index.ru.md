...
{{% blocks/products/pf/agp/content h2="Преобразовать HTM в ET, используя код Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM в ET в Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в ET в коде Java.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать HTM в ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать HTML-файлы в формат ET? Разработчики, использующие код Java, могут легко преобразовать HTML в ET всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования HTM в ET" %}}
{{% blocks/products/pf/agp/text %}}
