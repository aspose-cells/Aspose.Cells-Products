...
description: Aspose Excel. Python Excel. A XLS számot gyorsan és egyszerűen ETT-re alakíthatja át a Aspose.Cells-es számmal. Python XLS ETT-vé. Python Mentse a XLS-et az ETT-nek. Mentse el a XLS számot ETT-ként a Python Excel Library használatával.
