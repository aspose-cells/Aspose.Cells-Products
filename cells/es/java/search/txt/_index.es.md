---
title:  Buscar documento TXT sin abrir via Java
weight: 1200
description: Código de muestra Java para buscar palabras con patrón en el archivo TXT en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
+ Cargue el archivo TXT creando una instancia de un objeto Libro de trabajo.
+ Acceda a la primera hoja de trabajo del archivo TXT.
