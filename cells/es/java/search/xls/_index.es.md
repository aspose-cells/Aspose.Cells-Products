---
title:  Buscar documento XLS sin abrir via Java
weight: 9430
description: Código de muestra Java para buscar palabras con patrón en el archivo XLS en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
+ Cargue el archivo XLS creando una instancia de un objeto Libro de trabajo.
+ Acceda a la primera hoja de trabajo del archivo XLS.
