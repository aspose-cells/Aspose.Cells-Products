...
Precisa converter arquivos OTS para JSON programaticamente? Desenvolvedores que trabalham com C++ podem converter facilmente arquivos OTS para JSON com apenas algumas linhas de código.
...
1.  Converta OTS para JSON chamando o método Save().
