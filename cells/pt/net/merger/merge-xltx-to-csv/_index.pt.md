---
title:  Mesclar XLTX para CSV via C#
url: /pt/net/merger/merge-xltx-to-csv/ 
description: Mesclar XLTX para CSV Online gratuitamente. Online Grátis XLTX a CSV Fusão. Mesclar XLTX para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar XLTX a CSV em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar XLTX a CSV on-line" InputFormat="xltx" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
