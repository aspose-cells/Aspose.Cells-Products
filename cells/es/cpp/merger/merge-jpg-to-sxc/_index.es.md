---
title: Combinar JPG a SXC - Combinar JPG a SXC en C++
url: /es/cpp/merger/merge-jpg-to-sxc/ 
description: AsposeExcel. C++ Aspose.Cells. Combinación gratuita en línea JPG a SXC guardar formato. C++ Combinar JPG a formato SXC. Combinar JPG a SXC en C++. Combinar JPG.
...
{{% blocks/products/pf/agp/content h2="Combine JPG a SXC en C++ en línea gratis" %}}

El siguiente ejemplo muestra cómo fusionar JPG a SXC en Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar JPG a SXC. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo SXC. Si desarrolla código en C++, esto será más simple de lo que parece. Consulte el ejemplo C++ que fusiona JPG con SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar JPG a SXC en C++" InputFormat="jpg" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar JPG a SXC a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar JPG con SXC mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para fusionar JPG a SXC" %}}
