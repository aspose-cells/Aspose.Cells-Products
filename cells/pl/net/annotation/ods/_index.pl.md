---
title:  Dodaj lub usuń ODS Adnotacja via .NET
weight: 7990
description: Kod źródłowy C# do dodawania i usuwania adnotacji w formacie ODS na platformach .NET Framework, .NET Core, Mono lub platformach Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Dodaj lub usuń adnotację od ODS do C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń adnotacje z numerów ODS–C#" offSpacer="" %}}
