...
description: Aspose Эксель. Python Aspose.Cells. Объедините формат сохранения HTM и PRN. Python Объедините формат HTM в PRN. Объедините HTM и PRN по номеру Python. HTM Merge.
...
{{% blocks/products/pf/agp/content h2="Объедините HTM с PRN, используя Python" %}}
...
{{% blocks/products/pf/agp/content h2="Объединить HTM и PRN в Python" %}}
...
{{% cells-merger title="Пример кода для объединения HTM с PRN в Python" InputFormat="htm" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Как объединить HTM с PRN по номеру Python" %}}
