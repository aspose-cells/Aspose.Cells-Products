---
title: دمج TABDELIMITED إلى PDF - دمج TABDELIMITED إلى PDF في C#
url: /ar/net/merger/merge-tabdelimited-to-pdf/ 
description: Aspose اكسل. C# Aspose.Cells. قم بدمج TABDELIMITED في PDF saveformat. C# قم بدمج TABDELIMITED إلى تنسيق PDF. دمج TABDELIMITED إلى PDF في C#. TABDELIMITED دمج.
...
{{% blocks/products/pf/agp/content h2="دمج TABDELIMITED إلى PDF في C#" %}}

يوضح المثال التالي كيفية دمج TABDELIMITED إلى PDF في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج TABDELIMITED إلى PDF. قم بتحميل ملفاتك، واتصل بطريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف PDF. إذا قمت بتطوير التعليمات البرمجية في C#، فسيكون هذا أبسط مما يبدو. راجع مثال C# الذي يدمج TABDELIMITED إلى PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج التعليمات البرمجية لدمج TABDELIMITED إلى PDF في C#" InputFormat="tsv" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج TABDELIMITED إلى PDF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج TABDELIMITED مع PDF برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة .NET لدمج TABDELIMITED إلى PDF" %}}
