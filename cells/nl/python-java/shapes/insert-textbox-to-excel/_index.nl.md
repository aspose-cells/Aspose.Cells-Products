---
title:  Voeg TextBox in Excel in met Python via Java
weight: 10
description: Python via Java broncode om TextBox in Excel in te voegen.
keywords: [Python Aspose.Cells., Python add TextBox., Python insert TextBox., Python create TextBox]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg TextBox in Excel in met Python via Java" h2="Voeg TextBox in met behulp van Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u TextBox in een Excel-bestand kunt invoegen met behulp van Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TextBox in Excel-bestand in te voegen met behulp van Python via Java" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de vormcollecties[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addTextBox(int,%20int,%20int,%20int,%20int,%20int)) om een Tekstvak in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Tekstvak invoegen - Python via Java" offSpacer="" %}}
