---
title: HTML konvertálása TABLEDELIMITED-re a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/html-to-tabdelimited/ 
description: Minta C++ konverziós kód HTML-dokumentumhoz TABDELIMITED formátumba. A programozók ezt a forráskódot használhatják kötegelt HTML-ből TABDELIMITED konverzióhoz bármely C++ alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="HTML konvertálása TAB-raDELIMITED a következőn keresztül: C++" h2="Nagy teljesítményű HTML-ből TABDELIMITED-re konvertálás a C++ könyvtár használatával Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="HTML konvertálása TAB-raDELIMITED a következővel: C++" %}}

 Ahhoz, hogy a HTML-t TABDELIMITED-re konvertáljuk, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a HTML-ből TAB-ra konvertálásáhozDELIMITED a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatják a HTML-fájlt TABDELIMITED formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be HTML-fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (TABDELIMITED) fájlkiterjesztéssel.1. A TABDELIMITED fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a TABDELIMITED fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="HTML-ből TABDELIMITED C++ konverziós forráskódba" offSpacer="" %}}
