---
title: OTS को GIF C# में बदलें
description: ओटीएस को GIF में मुफ्त में ऑनलाइन बदलें। मुफ्त ऑनलाइन ओटीएस से GIF कन्वर्टर। C# ओटीएस से GIF। ओटीएस से GIF वाया C#।
keywords: Convert OTS, OTS Converter, OTS to PDF, OTS to Word, OTS to PPT, OTS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# के माध्यम से ओटीएस को GIF में बदलें" h2="ओटीएस को GIF में बदलने के लिए हाई-स्पीड C# लाइब्रेरी। एक्सेल स्प्रेडशीट को .NET फ्रेमवर्क, .NET कोर या Mono प्लेटफॉर्म पर GIF फॉर्मेट में एक्सपोर्ट करें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTS" >}}
...
{{% blocks/products/pf/agp/content h2="ओटीएस को GIF में C# पर मुफ्त में ऑनलाइन सेव करें" %}}

निम्न उदाहरण दर्शाता है कि ओटीएस को C# में GIF में कैसे परिवर्तित किया जाए।
...
{{% cells-convert title="ओटीएस को GIF ऑनलाइन में बदलने के लिए फ्री ऐप और सैंपल कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="gif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# के माध्यम से ओटीएस को GIF में कैसे बदलें" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर्स आसानी से कोड की कुछ पंक्तियों में ओटीएस को GIF में लोड और परिवर्तित कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1.  कार्यपुस्तिका के उदाहरण के साथ ओटीएस फ़ाइल लोड करें
1.  Workbook.Save विधि को कॉल करके OTS को GIF में बदलें
