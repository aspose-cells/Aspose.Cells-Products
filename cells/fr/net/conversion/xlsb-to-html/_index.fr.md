---
title: Convertir XLSB en HTML via C#
url: /fr/net/conversion/xlsb-to-html/
description: Exemple de code pour la conversion xlsb vers html C#. Utilisez l'exemple de code API pour les fichiers batch xlsb en conversion html dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en HTML via C#" h2="Exportez des feuilles de calcul Excel® au format HTML sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers XLSB en HTML en quelques lignes de code seulement.
