---
title: Sloučit CSV na MHT - Sloučit CSV na MHT v C++
url: /cs/cpp/merger/merge-csv-to-mht/ 
description: Aspose Excel. C++ Aspose.Cells. Zdarma online sloučení CSV do formátu uložení MHT. C++ Zkombinujte CSV do formátu MHT. Sloučit CSV na MHT v C++. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV na MHT v C++ online zdarma" %}}

Následující příklad ukazuje, jak sloučit CSV do MHT v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení CSV s MHT. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MHT. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí CSV do MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení CSV na MHT v C++" InputFormat="csv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV do MHT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit CSV na MHT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení CSV do MHT" %}}
