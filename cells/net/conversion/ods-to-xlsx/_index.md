...
description: Sample code for ods to xlsx C# conversion. Use API example code for batch ods files to xlsx conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert ODS to XLSX Using C#" %}}
 ...
 In order to convert ODS to XLSX, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert ODS files to XLSX in just a few lines of code.
...
{{% cells-convert title="Free App and Sample Code to Convert ODS to XLSX" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et InputFormat=ods outformat=xlsx IsLandingPage=true %}}
