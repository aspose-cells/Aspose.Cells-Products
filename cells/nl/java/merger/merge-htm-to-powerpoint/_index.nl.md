---
title: Voeg HTM samen met POWERPOINT - Combineer HTM met POWERPOINT in Java
url: /nl/java/merger/merge-htm-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. HTM samenvoegen naar POWERPOINT-opslagformaat. Java Combineer HTM naar POWERPOINT-formaat. Voeg HTM samen met POWERPOINT in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTM samen met POWERPOINT in Java" %}}

Het volgende voorbeeld laat zien hoe u HTM kunt samenvoegen met POWERPOINT in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen met POWERPOINT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een POWERPOINT-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java waarin HTM wordt samengevoegd met POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om HTM samen te voegen met POWERPOINT in Java" InputFormat="htm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen met POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met POWERPOINT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen met POWERPOINT" %}}
