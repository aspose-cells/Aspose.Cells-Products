...
description: Aspose Excel'de. C++ Aspose.Cells ile hızlı ve kolay bir şekilde BMP Dosyası oluşturun. C++'i kullanarak BMP dosyası oluşturun. C++'de BMP oluşturun. C++ BMP Oluşturucu.
...
1.  Save() yöntemini kullanarak çalışma kitabını .bmp dosyası olarak kaydedin.
