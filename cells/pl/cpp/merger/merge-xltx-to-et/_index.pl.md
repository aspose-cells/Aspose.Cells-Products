---
title: Połącz XLTX z ET - Połącz XLTX z ET w C++
url: /pl/cpp/merger/merge-xltx-to-et/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online XLTX do formatu zapisu ET. C++ Połącz XLTX do formatu ET. Połącz XLTX z ET w C++. XLTX Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTX z ET w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLTX z ET w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLTX z ET. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku ET. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy XLTX z ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTX z ET w C++" InputFormat="xltx" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTX z ET przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć numer XLTX z ET? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLTX z ET" %}}
