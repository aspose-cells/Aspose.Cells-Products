...
url: /tr/python-java/merger/merge-mhtml-to-mht/ 
...
Aşağıdaki örnek, MHTML'in Aspose.Cells for Python via Java'deki MHT ile nasıl birleştirileceğini gösterir.
...
MHTML'i MHT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
