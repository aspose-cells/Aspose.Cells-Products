...
description:  Aspose Excel. Java Szybko i łatwo utwórz plik XML za pomocą Aspose.Cells. Wygeneruj plik XML za pomocą Java. Utwórz plik XML w Java. Java Kreator XML.
...
1.  Zapisz skoroszyt w formacie XML przy użyciu metody save().
