---
title: Képek/képméretek lekérése Excelben a Python-Java számon keresztül
weight: 10
description: Lekéri a képek/képek méretét az Excelben a Python' Python-Java API számon szoftver nélkül, például Microsoft vagy Open Office, Adobe PDF stb.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Képek/képméretek lekérése Excelben a Python-Java számon keresztül" h2="Aspose.Cells API használatával különféle objektumokkal dolgozhat szoftver nélkül, például Microsoft vagy Open Office, Adobe PDF stb." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="A képek/képméretek lekérése Excel fájlban a Python-Java használatával" %}}
 ...
 API, amely funkciókban gazdag, hatékony és könnyen használható dokumentumkezelési API python-Java platformhoz. A API Excel-fájlok létrehozását, kezelését, konvertálását és megjelenítését biztosítja. Mindezt anélkül, hogy a Microsoft Office- vagy Excel-alkalmazásokra hagyatkozna. A következő paranccsal telepítheti a konzolról.
...
{{% blocks/products/pf/agp/feature-section-col title="A képek/képek méretének Excel-fájlban való megjelenítésének lépései a Python-Java számon keresztül" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells for Python-Java platformfüggetlen API, és bármilyen platformon használható (Windows, Linux és MacOS), csak győződjön meg arról, hogy a rendszer Java 1.8 vagy újabb verzióval rendelkezik,[Python](https://www.python.org/downloads/) 3,5 vagy magasabb.
...
{{% blocks/products/pf/agp/code-block title="A képek/képek méretének megtekintése - Python-Java" offSpacer="" %}}
