---
title: C++ IMAGE إلى PDF - محول IMAGE عبر الإنترنت إلى PDF
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل الصورة إلى PDF saveformat. C++ IMAGE إلى تنسيق PDF. احفظ الصورة في PDF C++.
...
{{% blocks/products/pf/agp/content h2="احفظ IMAGE في PDF في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى PDF برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى PDF في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى PDF باستدعاء طريقة Save ().
1.  احصل على نتيجة تحويل IMAGE إلى PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل IMAGE إلى PDF" %}}
