...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in WORD in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar WORD in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar WORD of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar WORD? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar WORD met slechts een paar regels code.
