...
{{% blocks/products/pf/agp/content h2="Сохранение XML в SPREADSHEETML в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в SPREADSHEETML в файле C#.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XML в SPREADSHEETML" %}}
