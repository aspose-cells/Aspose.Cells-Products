---
title: C# OTS till SXC - OTS till SXC Converter
description: Aspose Excel. Konvertera OTS till SXC snabbt och enkelt med Aspose.Cells. C# OTS till SXC. C# Spara OTS till SXC. Spara OTS som SXC med 304818.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till SXC på C#" %}}

Följande exempel visar hur man konverterar OTS till SXC i C#.
...
{{% cells-convert title="Exempelkod för att konvertera OTS till SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till SXC via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till SXC programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till SXC på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera OTS till SXC" %}}
