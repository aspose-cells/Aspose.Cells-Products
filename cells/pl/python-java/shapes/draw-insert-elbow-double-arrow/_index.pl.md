---
title: Jak narysować lub wstawić kształt podwójnej strzałki łokcia do Excela za pomocą Python via Java
weight: 10
description: Narysuj lub wstaw kształt podwójnej strzałki łokcia za pomocą Aspose.Cells' Python via Java API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp.
...
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw kształt podwójnej strzałki łokcia do Excela, używając Python via Java" h2="Wstaw podwójną strzałkę łokciową za pomocą Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić kształt podwójnej strzałki łokcia do pliku Excel za pomocą Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić kształt podwójnej strzałki łokcia do pliku Excel przy użyciu Python via Java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), aby wstawić kształt podwójnej strzałki łokcia w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wkładka kolankowa w kształcie podwójnej strzałki - Python via Java" offSpacer="" %}}
