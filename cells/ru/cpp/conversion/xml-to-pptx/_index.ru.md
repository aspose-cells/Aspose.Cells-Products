...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в PPTX в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат PPTX в формате C++.
...
1.  Преобразовать XML в формат PPTX, вызвав метод Save().
