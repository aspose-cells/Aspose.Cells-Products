---
title: Python ODS na SQL - ODS na SQL Converter
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Python plně integrovaný přístup k převodu ODS do formátu SQL, což umožňuje bezproblémové ukládání dat ODS do formátu SQL pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte ODS na SQL v knihovně Excel Python" h2="Vysokorychlostní knihovna Excel Python pro převod ODS do SQL. Toto je profesionální softwarové řešení pro import a export ODS, SQL a mnoha dalších formátů pomocí Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte ODS na SQL pomocí knihovny Excel Python" %}}

 Jak převedu ODS na SQL? S knihovnou Aspose.Cells for Python můžete snadno převést ODS na SQL programově pomocí několika řádků kódu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)je schopen vytvářet multiplatformní aplikace se schopností generovat, upravovat, konvertovat, vykreslovat a tisknout všechny soubory aplikace Excel. Python Excel API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat soubory Excel jako obrázky, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT a další, takže je perfektní volbou pro výměnu dokumentů ve standardních průmyslových formátech.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Uložte ODS do SQL v knihovně Excel Python" %}}

Následující příklad ukazuje, jak převést ODS na SQL v knihovně Excel Python.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod ODS na SQL. Nahrajte svůj soubor ODS a poté jej jednoduše uložte jako soubor SQL. Pro čtení ODS i zápis SQL můžete použít plně kvalifikované názvy souborů. Výstupní obsah SQL a formátování budou identické s původním dokumentem ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod ODS na SQL prostřednictvím knihovny Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="sql" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést ODS na SQL přes Python" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést ODS soubory na SQL programově? Python vývojáři mohou snadno načíst a převést ODS na SQL v několika řádcích kódu.
...
1.  Převeďte ODS na SQL voláním metody Workbook.save.
1.  Získejte výsledek převodu ODS na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod ODS na SQL" %}}
