---
title: Konwertuj NUMBERS na PNG za pomocą Python
url: /pl/python-java/conversion/numbers-to-png/
description: Przykładowy kod konwersji liczb do formatu png Python. Użyj przykładowego kodu API dla plików numerów partii do konwersji png w aplikacji Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj NUMBERS na PNG za pomocą Python" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu PNG przy użyciu Python interfejsów API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować NUMBERS na PNG za pomocą Python" %}}

 Aby przekonwertować NUMBERS na PNG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować NUMBERS na PNG za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki w formacie NUMBERS do formatu PNG za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik NUMBERS z wystąpieniem skoroszytu1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem PNG jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku PNG
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji NUMBERS na PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="png" IsLandingPage="true" language="python" %}}
