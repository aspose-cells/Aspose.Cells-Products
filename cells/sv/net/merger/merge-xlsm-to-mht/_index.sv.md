---
title: Slå samman XLSM till MHT - Kombinera XLSM till MHT i C#
url: /sv/net/merger/merge-xlsm-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge XLSM till MHT saveformat. C# Kombinera XLSM till MHT-format. Slå samman XLSM till MHT i C#. XLSM Slå samman.
...
Följande exempel visar hur man slår samman XLSM till MHT i Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis online för att slå samman XLSM till MHT i C#" InputFormat="xlsm" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLSM till MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du slå samman XLSM till MHT programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/merger/merge-xlsm-to-xlsx/" name="Slå samman XLSM till XLSX" description="OOXML Excel-fil" >}}
