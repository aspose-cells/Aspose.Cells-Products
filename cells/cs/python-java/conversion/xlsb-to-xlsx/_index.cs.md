---
title: Python XLSB až XLSX - Online konvertor XLSB až XLSX
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Online zdarma Python Převést XLSB na XLSX uložit formát. Python XLSB až XLSX formát. Uložte si XLSB až XLSX Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte XLSB na XLSX pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLSB až XLSX v Python online zdarma" %}}

Následující příklad ukazuje, jak převést XLSB na XLSX v Python.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod XLSB na XLSX online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLSB na XLSX" %}}
