---
title: C++를 통해 XLS 문서 보호 및 잠금 
weight: 8760

description: C++ Windows 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경에서 비밀번호를 사용하여 XLS 파일을 잠그는 예제 코드.
---
...
1. IWorkbook 클래스를 사용하여 XLS 파일 로드1. ProtectionType 및 Password와 함께 Protect(..) 메서드 사용1. Save() 메서드로 보호된 XLS 파일 저장
