---
title: C# JPG 到 MHT - 在线 JPG 到 MHT 转换器
description: Aspose Excel。 C# Aspose.Cells. C# Aspose Cells. 免费在线 C# 将 JPG 转换为 MHT 保存格式。 C# JPG 转 MHT 格式。将 JPG 保存为 MHT C#。
...
{{% blocks/products/pf/agp/content h2="免费在线将 C# 中的 JPG 保存为 MHT" %}}

下面的例子演示了如何将C#中的JPG转换为MHT。
...
{{% cells-convert title="在线将 JPG 转换为 MHT 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 JPG 转换为 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 JPG 文件转换为 MHT？ .NET 开发人员只需几行代码即可轻松加载 JPG 并将其转换为 MHT。
...
{{% blocks/products/pf/agp/content h2="C# 将 JPG 转换为 MHT 的库" %}}
