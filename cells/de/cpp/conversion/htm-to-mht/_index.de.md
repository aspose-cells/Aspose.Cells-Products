...
description: Aspose Excel. Konvertieren Sie HTM schnell und einfach in MHT mit Aspose.Cells. C++ HTM in MHT. C++ HTM in MHT speichern. Speichern Sie HTM als MHT mit C++.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie HTM in MHT unter C++" %}}
...
{{% cells-convert title="Beispielcode zum Konvertieren von HTM in MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="mht" IsLandingPage="true" language="cpp" %}}
