---
title:  แยกข้อความและรูปภาพจาก XLSB เอกสาร via Java
weight: 440
description: โค้ดตัวอย่าง Java เพื่อแยกข้อความและรูปภาพจากไฟล์ XLSB บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
...
{{< blocks/products/pf/i18n/upper-banner h1="แยกวิเคราะห์ XLSB รูปแบบใน Java" h2="การแยกวิเคราะห์เอกสาร XLSB แบบเนทีฟและประสิทธิภาพสูงโดยใช้ API ฝั่งเซิร์ฟเวอร์ Aspose.Cells for Java โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
โหลดเอกสาร XLSB โดยใช้คลาส Workbook
