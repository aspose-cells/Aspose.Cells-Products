...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům PHP plně integrovaný přístup k převodu TABDELIMITED do formátu XML, což umožňuje bezproblémové ukládání dat TABDELIMITED do formátu XML pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu PHP.
...
Potřebujete programově převést soubory TABDELIMITED do XML? Vývojáři v PHP mohou snadno načíst a převést soubory TABDELIMITED do XML pomocí několika řádků kódu.
...
1.  Převeďte TABDELIMITED na XML voláním metody save v sešitu.
