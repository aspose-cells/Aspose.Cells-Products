---
title: Insert ActiveX Control into Excel using Python via Java
weight: 10
...
{{% blocks/products/pf/agp/content h2="How to Insert ActiveX Control into Excel File Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert ActiveX Control to Excel file using Python via java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)) to insert a ActiveX Control in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert ActiveX Control - Python via java" offSpacer="" %}}
