---
title: Mesclar XLT para EXCEL - Combinar XLT para EXCEL em C#
url: /pt/net/merger/merge-xlt-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita XLT para salvar formato EXCEL. C# Combine XLT para o formato EXCEL. Mesclar XLT para EXCEL em C#. XLT Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLT para EXCEL em C# Online Gratuitamente" %}}

exemplo a seguir demonstra como mesclar XLT para EXCEL em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLT para EXCEL. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo EXCEL. Se você desenvolver código em C#, isso será mais simples do que parece. Veja o exemplo C# que mescla XLT com o EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Grátis para Mesclar XLT para EXCEL em C#" InputFormat="xlt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLT para EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLT para EXCEL programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLT para EXCEL" %}}
