...
weight: 5920
description: Código-fonte C# para bloquear o arquivo XLSB usando senha no .NET Framework, .NET Core, Mono ou plataformas Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criptografar arquivos XLSB por meio de C#" h2="Planilhas Excel protegidas por senha, incluindo formato XLSB usando a Biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1.  Instancie a classe Workbook com caminho para o arquivo XLSB
