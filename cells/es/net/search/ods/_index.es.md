---
title:  Buscar documento ODS sin abrir via .NET
weight: 160
description: Código fuente C# para buscar palabras con patrón en el archivo ODS en .NET Framework, .NET Core, Mono o plataformas Xamarin.
