---
title: C# XLS en IMAGE - Convertisseur XLS en IMAGE
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir XLS au format IMAGE, permettant un enregistrement transparent des données XLS au format IMAGE à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer XLS dans IMAGE dans C#" %}}

L'exemple suivant montre comment convertir XLS en IMAGE dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en IMAGE. Téléchargez votre fichier XLS, puis enregistrez-le simplement en tant que fichier IMAGE. Pour la lecture XLS et l'écriture IMAGE, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de l'IMAGE de sortie seront identiques au document XLS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir XLS en image" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en IMAGE via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en IMAGE par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en IMAGE en quelques lignes de code.
...
1. Convertissez XLS en IMAGE en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de XLS en IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en IMAGE" %}}
