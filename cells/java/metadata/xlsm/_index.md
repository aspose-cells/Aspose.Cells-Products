...
{{< blocks/products/pf/upper-banner h1="Extract XLSM Metadata via Java" h2="Build your own Java apps to add, edit, remove or extract metadata from XLSM files using server-side APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/cells/272x272/aspose_cells-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Extract XLSM Metadata Using Java" %}}
 ...
 In order to get XLSM file metadata, weвЂ™ll use
