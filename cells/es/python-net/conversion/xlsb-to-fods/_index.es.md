...
description: Aspose Excel. Convierta XLSB a FODS rápida y fácilmente con Aspose.Cells. Python XLSB a FODS. Python Guarde XLSB en FODS. Guarde XLSB como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB al FODS en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a FODS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB en FODS" %}}
