...
description: Aspose Exceller. Convertissez HTM en HTML rapidement et facilement avec Aspose.Cells. Python HTM en HTML. Python Enregistrez HTM en HTML. Enregistrez HTM sous HTML en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au HTML dans Python" %}}
...
{{% cells-convert title="Exemple de code pour convertir HTM en HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="html" IsLandingPage="true" language="pythonjava" %}}
