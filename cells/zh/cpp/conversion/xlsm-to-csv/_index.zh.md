---
title: 通过 C++ 应用程序将 XLSM 转换为 CSV 
url: /zh/cpp/conversion/xlsm-to-csv/ 
description: 将 XLSM 文档转换为 CSV 格式的示例 C++。程序员可以使用此源代码在任何 C++ 应用程序中将 XLSM 批量转换为 CSV。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将 XLSM 转换为 CSV" h2="使用 C++ 库进行高性能 XLSM 到 CSV 转换，无需安装 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 开发人员只需几行代码即可轻松地将 XLSM 文件转换为 CSV。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 XLSM 文件。1. 调用 Save() 方法。1. 使用 (CSV) 文件扩展名传递输出文件路径。1. CSV 文件将保存在指定路径。1. 在兼容程序中打开 CSV 文件。
...
{{% blocks/products/pf/agp/code-block title="XLSM 到 CSV C++ 转换源代码" offSpacer="" %}}
