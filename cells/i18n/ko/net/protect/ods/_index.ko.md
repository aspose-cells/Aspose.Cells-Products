---
title: .NET을(를) 통해 ODS 문서 보호 및 잠금 
weight: 5580
url: /ko/net/protect/ods/ 
description: .NET Framework, .NET Core, Mono 또는 Xamarin Platforms에서 비밀번호를 사용하여 ODS 파일을 잠그는 C# 소스 코드.
---
...
{{% blocks/products/pf/agp/feature-section-col title="C#을(를) 통해 ODS 보호" %}}
...
1. ODS 파일에 대한 경로로 통합 문서 클래스 인스턴스화1. 보호를 추가하려면 기본 또는 워크시트를 가져옵니다.1. Worksheet.Protect 메서드로 워크시트 보호1. Workbook.Protect 메서드로 통합 문서 보호1. 결과를 ODS 형식으로 저장
