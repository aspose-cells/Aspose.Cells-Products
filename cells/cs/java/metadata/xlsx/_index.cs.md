...
{{% blocks/products/pf/agp/content h2="Jak extrahovat metadata XLSX pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k extrahování metadat XLSX via Java" %}}
...
+ Načtěte soubor XLSX do WorkbookMetadata
...
{{% blocks/products/pf/agp/code-block title="Extrahujte metadata XLSX - Java" offSpacer="" %}}
