...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 FODS 轉換為 JPEG。Python FODS 為 JPEG. Python 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Python。
...
{{% blocks/products/pf/agp/content h2="將 FODS 轉換為 Python 中的 JPEG" %}}
...
以下範例示範如何將 Python via NET 中的 FODS 轉換為 JPEG。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 轉換為 JPEG。上傳您的 FODS 文件，然後只需將其另存為 JPEG 文件。對於 FODS 讀取和 JPEG 寫入，您可以使用完全限定的檔案名稱。輸出 JPEG 內容和格式將與原始 FODS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 FODS 轉換為 JPEG 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python庫將FODS轉換為JPEG" %}}
