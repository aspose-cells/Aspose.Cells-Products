...
url: /hi/net/merger/merge-numbers-to-prn/ 
...
निम्नलिखित उदाहरण दर्शाता है कि Aspose.Cells for .NET में NUMBERS को PRN में कैसे मर्ज किया जाए।
...
{{% cells-merger title="C# में नंबरों को पीआरएन में मर्ज करने के लिए नमूना कोड" InputFormat="numbers" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C# के माध्यम से नंबरों को पीआरएन में कैसे मर्ज करें" %}}

{{% blocks/products/pf/agp/text %}}

प्रोग्रामेटिक रूप से NUMBERS को PRN में मर्ज करने की आवश्यकता है? एक बुनियादी दस्तावेज़ जिसका विलय और संयोजन हो रहा है[Aspose.Cells for .NET](https://products.aspose.com/cells/net) एपीआई को कोड की कुछ पंक्तियों के साथ किया जा सकता है।
...
{{% blocks/products/pf/agp/content h2="NUMBERS को PRN में मर्ज करने के लिए .NET लाइब्रेरी" %}}
