---
title:  .NET Java Python C++ API анализа электронных таблиц PHP и Android Excel
weight: 10
description: Библиотеки для чтения, записи и управления Microsoft файлами Excel в .NET Java C++ приложениях Android и SharePoint. Экспорт рабочих листов в SSRS и JasperReports
---
...
Цель .NET Framework, .NET Core и платформа Xamarin для разработки приложений для Windows, iOS, macOS и Android.
...
{{< blocks/products/pf/product pfName="Aspose.Cells for" title="Андроид via Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-android-java.svg" productLink="/cells/android-java/" >}}
Добавьте возможности манипулирования электронными таблицами Excel в свои мобильные приложения Android.
{{< /blocks/products/pf/product >}}
...
Преобразуйте и объедините электронные таблицы Excel в SharePoint Services или SharePoint Server.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="Службы отчетов" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-reporting-services.svg" productLink="/cells/reporting-services/" >}}
Экспортируйте отчеты RDL и RDLC в форматы файлов Excel из служб отчетов SQL Server.
{{< /blocks/products/pf/product >}}
...
Создавайте, манипулируйте, конвертируйте и визуализируйте электронные таблицы Excel с помощью Node.js.
{{< /blocks/products/pf/product >}}
...
Создавайте, манипулируйте, конвертируйте и визуализируйте электронные таблицы Excel в приложениях PHP через JavaBridge.
{{< /blocks/products/pf/product >}}
...
Загружайте, создавайте, манипулируйте и визуализируйте документы Excel, используя номер Python.
{{< /blocks/products/pf/product >}}
