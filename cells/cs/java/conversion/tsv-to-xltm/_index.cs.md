...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na XLTM pomocí Java" %}}

 K vykreslení TSV do XLTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TSV na XLTM prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor TSV na XLTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLTM a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLTM
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TSV na XLTM Java" offSpacer="" %}}

```cs
// načíst soubor TSV v instanci sešitu
Workbook book = new Workbook("template.tsv");
// uložit TSV jako XLTM
