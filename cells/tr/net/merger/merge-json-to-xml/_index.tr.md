...
url: /tr/net/merger/merge-json-to-xml/ 
...
Aşağıdaki örnek, JSON'in Aspose.Cells for .NET'deki XML ile nasıl birleştirileceğini gösterir.
...
JSON'i XML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
