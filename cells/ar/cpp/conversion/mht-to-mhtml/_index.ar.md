...
description: Aspose اكسل. قم بتحويل MHT إلى MHTML بسرعة وسهولة باستخدام Aspose.Cells. C++ MHT إلى MHTML. C++ احفظ MHT إلى MHTML. احفظ MHT كـ MHTML باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على MHTML في C++" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="mhtml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى MHTML عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى MHTML برمجياً؟ يمكن لمطوري C++ تحويل MHT بسهولة إلى MHTML في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى MHTML عن طريق استدعاء طريقة Save ().
