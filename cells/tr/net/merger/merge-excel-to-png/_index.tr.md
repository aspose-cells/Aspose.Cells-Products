...
description: Aspose Excel'de. C# Aspose.Cells. EXCEL'i PNG kaydetme biçimiyle birleştirin. C# EXCEL'i PNG biçimiyle birleştirin. EXCEL'i C#'de PNG ile birleştirin. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i C#\'de PNG ile birleştir" %}}

Aşağıdaki örnek, EXCEL'in Aspose.Cells for .NET'deki PNG ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i PNG ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından PNG dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. EXCEL'i PNG ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de EXCEL\'i PNG ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C# aracılığıyla PNG ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i programlı olarak PNG ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
