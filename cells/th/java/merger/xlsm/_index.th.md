...
weight: 1270
description: โค้ดตัวอย่าง Java เพื่อรวมเอกสาร XLSM บน Java Runtime Environment สำหรับ JSP/JSF Application และ Desktop Applications
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="รวมรูปแบบ XLSM ใน Java" h2="การผสานเอกสารเนทีฟ XLSM โดยใช้ API Java ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการรวมไฟล์ XLSM ใน Java" %}}
...
+ โหลดไฟล์ XLSM แรกด้วยอินสแตนซ์ของคลาสสมุดงาน
+ โหลดเอกสาร XLSM ที่สองพร้อมอินสแตนซ์ของคลาสสมุดงาน
...
{{% blocks/products/pf/agp/code-block title="ผสาน XLSM ไฟล์ - Java" offSpacer="" %}}
