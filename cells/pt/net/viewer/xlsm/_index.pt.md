---
title:  Ver formatos de arquivo XLSM via .NET
weight: 9980
description: Código-fonte C# para carregar, renderizar e exibir documentos XLSM em plataformas .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para visualizar XLSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells torna mais fácil para os desenvolvedores visualizarem o arquivo XLSM com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código de exemplo C# para visualizar o arquivo XLSM" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos Excel Microsoft em diferentes formatos. Além disso, pode ser usado para gráficos abrangentes, relatórios escalonáveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API independente e não requer nenhum software como Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para visualizar XLSM" sectionDescription=" Confira nossas demonstrações ao vivo para[Ver XLSM](https://products.aspose.app/cells/viewer/xlsm) com os seguintes benefícios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar ou configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever ou compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer upload do arquivo XLSM e clicar no botão \"Visualizar\"" >}}
