---
title: PHP EXCEL en HTM - Convertisseur EXCEL en HTM
description: Aspose Exceller. Convertissez EXCEL en HTM rapidement et facilement avec Aspose.Cells. PHP EXCEL en HTM. PHP Enregistrez EXCEL dans HTM. Enregistrez EXCEL au format HTM en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL en HTM en PHP" %}}

L'exemple suivant montre comment convertir EXCEL en HTM en PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en HTM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en HTM par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en HTM en quelques lignes de code.
...
1.  Convertissez EXCEL en HTM en appelant la méthode de sauvegarde du classeur.
