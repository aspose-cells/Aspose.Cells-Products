---
title: C++ HTM à MARKDOWN - Convertisseur HTM à MARKDOWN
description: Aspose Exceller. Convertissez HTM en MARKDOWN rapidement et facilement avec Aspose.Cells. C++ HTM en MARKDOWN. C++ Enregistrez HTM en MARKDOWN. Enregistrez HTM sous MARKDOWN en utilisant C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au MARKDOWN dans C++" %}}

L'exemple suivant montre comment convertir HTM en MARKDOWN en C++.
...
{{% cells-convert title="Exemple de code pour convertir HTM en MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="md" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en MARKDOWN via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en MARKDOWN par programme ? Les développeurs C++ peuvent facilement convertir HTM en MARKDOWN en quelques lignes de code seulement.
...
1.  Convertissez HTM en MARKDOWN en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de HTM en MARKDOWN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir HTM en MARKDOWN" %}}
