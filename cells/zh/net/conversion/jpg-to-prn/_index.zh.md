---
title: C# JPG 转 PRN - JPG 转 PRN 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 JPG 转换为 PRN。C# JPG 到 PRN。 C# 将 JPG 保存到 PRN。使用 C# 将 JPG 保存为 PRN。
...
{{% blocks/products/pf/agp/content h2="将 JPG 保存为 C# 中的 PRN" %}}
...
{{% cells-convert title="将 JPG 转换为 PRN 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="prn" IsLandingPage="true" %}}
