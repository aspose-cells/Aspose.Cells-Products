---
title: C# XLS zu HTM - Online XLS zu HTM Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das HTM-Speicherformat. C# XLS in das HTM-Format. Speichern Sie XLS in HTM C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bei HTM in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLS in C# in HTM konvertiert wird.
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von XLS in HTM Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in HTM" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in HTM konvertieren? .NET-Entwickler können XLS in nur wenigen Codezeilen problemlos laden und in HTM konvertieren.
...
1.  Konvertieren Sie XLS in HTM, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in HTM" %}}
