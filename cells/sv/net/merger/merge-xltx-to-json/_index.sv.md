---
title: Slå samman XLTX till JSON - Kombinera XLTX till JSON i C#
url: /sv/net/merger/merge-xltx-to-json/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge XLTX till JSON sparaformat. C# Kombinera XLTX till JSON format. Slå samman XLTX till JSON i C#. XLTX Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman XLTX till JSON i C# Online gratis" %}}

Följande exempel visar hur man slår samman XLTX till JSON i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman XLTX till JSON. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen JSON. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman XLTX till JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman XLTX till JSON i C#" InputFormat="xltx" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLTX till JSON via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLTX till JSON programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XLTX till JSON" %}}
