---
title: C++ XLSM 转 XPS - 在线 XLSM 转 XPS 转换器
description: Aspose Excel。 C++ Aspose.Cells。C++ Aspose Cells。免费在线 C++ 将 XLSM 转换为 XPS 保存格式。 C++ XLSM 到 XPS 格式。将 XLSM 保存为 XPS C++。
...
如何将 XLSM 转换为 XPS？使用 Aspose.Cells for C++ 库，您可以通过几行代码以编程方式轻松将 XLSM 转换为 XPS。[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 C++ Excel API不仅可以在电子表格格式之间进行转换，还可以将Excel文件渲染为图像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，从而使其成为行业交换文档的完美选择-标准格式。您可以直接下载最新版本，打开即可[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/)包管理器，搜索Aspose.Cells.cpp并安装。您还可以从包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/content h2="免费在线保存 XLSM 至 XPS 于 C++" %}}

以下示例演示如何将 C++ 中的 XLSM 转换为 XPS。
...
{{% cells-convert title="免费应用程序和示例代码可在线将 XLSM 转换为 XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C++ 将 XLSM 转换为 XPS" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 文件转换为 XPS 吗？ C++开发人员只需几行代码即可轻松将XLSM转换为XPS。
...
1. 通过调用 Save() 方法将 XLSM 转换为 XPS。
1. 获取XLSM到XPS的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++库将XLSM转换为XPS" %}}
