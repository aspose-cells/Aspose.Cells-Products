---
title: Sloučit MHT s NUMBERS – Sloučit MHT s NUMBERS v Java
url: /cs/java/merger/merge-mht-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit MHT do NUMBERS uloženého formátu. Java Zkombinujte formát MHT s formátem ČÍSLA. Sloučit MHT na ČÍSLA v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do NUMBERS v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit MHT do NUMBERS v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT do NUMBERS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru NUMBERS. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení MHT do ČÍSEL na čísle Java" InputFormat="mht" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT s ČÍSLY via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit MHT s NUMBERS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení MHT do NUMBERS" %}}
