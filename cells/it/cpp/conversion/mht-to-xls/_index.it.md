...
Hai bisogno di convertire i file MHT in XLS tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in XLS in poche righe di codice.
...
1.  Convertire MHT in XLS chiamando il metodo Save().
