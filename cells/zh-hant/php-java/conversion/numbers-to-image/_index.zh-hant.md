---
title: PHP 數位轉影像 - 數位轉影像轉換器
description: Aspose Excel。此綜合解決方案為 PHP 開發人員提供了一種完全整合的方法，可以將數位轉換為影像格式，從而能夠使用 Aspose.Cells 庫將數位資料無縫保存為影像格式，所有這些都透過高效且可自訂的 PHP 程式碼實現。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 PHP 中將數字轉換為影像" h2="高速 PHP 函式庫，用於將數位轉換為影像。這是一個專業的軟體解決方案，可使用 PHP 匯入和匯出數字、影像以及多種其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何將數字轉換為影像？使用 Aspose.Cells for PHP via Java 函式庫，只需幾行程式碼即可輕鬆地透過程式將數位轉換為影像。[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/)它能夠建立跨平台應用程序，並具備生成、修改、轉換、渲染和列印所有 Excel 文件的能力。 PHP Excel API 不僅可以轉換電子表格格式，還可以將 Excel 文件渲染為圖像（PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT）等等，因此是交換行業標準格式文件的理想選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="在 PHP 中將數字儲存為影像" %}}

以下範例示範如何在 PHP 中將數字轉換為影像。
...
{{% blocks/products/pf/agp/content h2="如何使用 PHP 將數位轉換為影像" %}}

{{% blocks/products/pf/agp/text %}}

需要透過程式將數位檔案轉換為影像檔案嗎？ PHP 開發人員只需幾行程式碼即可輕鬆載入數位檔案並將其轉換為映像檔。
...
1. 透過呼叫工作簿的 save 方法將數字轉換為影像。
1. 取得 NUMBERS 到 IMAGE 的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="用於將數字轉換為影像的 PHP 庫" %}}
