...
url: /nl/net/merger/merge-htm-to-fods/ 
...
Het volgende voorbeeld laat zien hoe u HTM samenvoegt met FODS in Aspose.Cells for .NET.
...
Wilt u HTM programmatisch samenvoegen met FODS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om HTM samen te voegen met FODS" %}}
