---
title:  Vyhledat dokument TSV bez otevření přes C++
weight: 930
description: Příklad kódu C++ pro vyhledávání slov se vzorem v souboru TSV v běhovém prostředí C++ pro 32bitové verze Windows, 64bitové verze Windows a 64bitové verze Linuxu.
...
{{< blocks/products/pf/i18n/upper-banner h1="Vyhledávání formátů TSV v C++" h2="Nativní a vysoce výkonné vyhledávání dokumentů TSV pomocí serverových Aspose.Cells for C++ API, bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vyhledat soubor TSV pomocí adresáře C++" %}}

 Pro vyhledání souboru TSV použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vyhledávání souborů TSV v adresáři C++" %}}
...
+ Načtěte soubor TSV pomocí třídy Workbook.
...
{{% blocks/products/pf/agp/code-block title="Vyhledávání souborů TSV - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online TSV Vyhledat Živé ukázky" sectionDescription=" Vyhledejte text, slova a fráze v dokumentech s adresou TSV hned teď na našich stránkách[Webová stránka živé ukázky](https://products.aspose.app/cells/search). Živé demo má následující výhody" >}}
 ...
 Formát souboru s hodnotami oddělenými tabulací (TSV) představuje data oddělená tabulacími znaky ve formátu prostého textu. Tento formát souboru, podobný formátu CSV, se používá pro strukturovanou organizaci dat za účelem importu a exportu mezi různými aplikacemi. Formát se primárně používá pro import/export a výměnu dat v tabulkových aplikacích a databázích. Každý záznam v souboru TSV je obsažen v jednom řádku textového souboru, kde je každá hodnota pole oddělena znakem tabulátoru. Typ média pro formát souboru TSV je text/hodnoty oddělené tabulací.
