---
title: Extrahieren Sie Text und Bilder aus dem Dokument XLS über C++
weight: 7610
description: C++ Beispielcode zum Extrahieren von Text und Bildern aus XLS Datei in C++ Laufzeitumgebung für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
...
{{% blocks/products/pf/agp/content h2="So analysieren Sie die Datei XLS mit C++" %}}
 ...
 Um die Datei XLS zu analysieren, verwenden wir[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API ist eine funktionsreiche, leistungsstarke und einfach zu bedienende Plattform zur Dokumentenanalyse API for C++. Sie können die neueste Version direkt herunterladen, öffnen Sie einfach[NuGet](https://www.nuget.org/packages/aspose.cells) Paketmanager, suchen Sie nach**Aspose.Cells.Cpp** und installieren. Sie können auch den folgenden Befehl aus der Paket-Manager-Konsole verwenden.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Eine einfache Dokumentanalyse mit
