...
description: Aspose Excel'de. Aspose.Cells ile XLS'i hızlı ve kolay bir şekilde TABDELIMITED'e dönüştürün. Python XLS'i TABDELIMITED'e dönüştürün. Python XLS'i TABDELIMITED'e kaydedin. Python'i kullanarak XLS'i TABDELIMITED olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'i kullanarak XLS\'i TABDELIMITED\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="XLS\'i Python\'de TABDELIMITED\'e kaydedin" %}}
...
{{% cells-convert title="XLS\'i TABDELIMITED\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="tsv" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLS\'i Python aracılığıyla TABDELIMITED\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLS dosyasını program aracılığıyla TABDELIMITED'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla XLS'i kolayca yükleyip TABDELIMITED'e dönüştürebilir.
