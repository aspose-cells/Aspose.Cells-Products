...
{{% blocks/products/pf/agp/content h2="Comment créer du XML dans C#" %}}

{{% blocks/products/pf/agp/text %}}

Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers XML dans l'exécution de différentes applications de reporting pour le traitement des données en seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier XML dans C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# bibliothèque pour créer un fichier XML" %}}
