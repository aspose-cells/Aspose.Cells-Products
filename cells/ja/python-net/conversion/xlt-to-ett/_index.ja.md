---
title: Python XLT から ETT - XLT から ETT コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLTをETTにすばやく簡単に変換します。Python XLTをETTに変換します。 Python XLT を ETT に保存します。 Python を使用して XLT を ETT として保存します。
...
{{% cells-convert title="XLTをETTに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="ett" IsLandingPage="true" language="pythonnet" %}}
