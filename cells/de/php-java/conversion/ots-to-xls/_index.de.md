...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in XLS mit Aspose.Cells. PHP OTS in XLS. PHP Speichern Sie OTS in XLS. Speichern Sie OTS mit PHP als XLS.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in XLS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in XLS konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in XLS konvertieren.
...
1.  Konvertieren Sie OTS in XLS, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in XLS" %}}
