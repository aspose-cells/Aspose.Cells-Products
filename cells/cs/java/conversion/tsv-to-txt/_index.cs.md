---
title: Převést TSV na TXT prostřednictvím Java 
weight: 2320

description: Ukázka převodního kódu Java pro formát TSV na soubor TXT. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do TXT v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést TSV na TXT prostřednictvím Java" h2="Převod TSV na TXT Java pro převod jedné nebo více stránek na TXT pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na TXT pomocí Java" %}}

 K vykreslení TSV do TXT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TSV na TXT prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor TSV na TXT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením TXT a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor TXT
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TSV na TXT Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka převodu TSV na TXT" sectionDescription="[Převést TSV na TXT](https://products.aspose.app/cells/conversion/tsv-to-txt) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor TSV, bude okamžitě převeden na TXT." >}}
