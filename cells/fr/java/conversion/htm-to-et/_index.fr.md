---
title: Java HTM en ET - Convertisseur HTM en ET
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format HTM au format ET, permettant un enregistrement transparent des données HTM au format ET à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM dans ET dans Java" %}}

L'exemple suivant montre comment convertir HTM en ET dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir un HTM en ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en ET par programmation ? Les développeurs Java peuvent facilement convertir des fichiers HTM en ET en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir HTM en ET" %}}
{{% blocks/products/pf/agp/text %}}
