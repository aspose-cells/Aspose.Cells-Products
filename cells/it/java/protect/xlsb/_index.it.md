---
title: Proteggi e blocca il documento XLSB tramite Java 
weight: 6590
url: /it/java/protect/xlsb/ 
description: Java codice di esempio per bloccare il file XLSB utilizzando la password in Java Runtime Environment per l'applicazione JSP/JSF e le applicazioni desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crittografa i file XLSB tramite Java" h2="Proteggi con password i fogli di lavoro Excel, incluso il formato XLSB, utilizzando .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Come proteggere il file XLSB utilizzando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per proteggere i file XLSB tramite Java" %}}
...
1. Carica il file XLSB istanziando la classe Workbook1. Utilizzare il metodo protect(..) con ProtectionType e Password1. Salva il file XLSB protetto con il metodo save()
