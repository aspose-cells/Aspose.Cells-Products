...
{{% blocks/products/pf/agp/content h2="Como converter TABDELIMITED para DIF via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TABDELIMITED para DIF programaticamente? Desenvolvedores PHP podem facilmente carregar e converter arquivos TABDELIMITED para DIF com apenas algumas linhas de código.
...
1.  Converta TABDELIMITED para DIF chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de TABDELIMITED para DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED em DIF" %}}
