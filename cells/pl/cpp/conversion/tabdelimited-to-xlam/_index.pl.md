---
title: Konwertuj TABDELIMITED na XLAM za pomocą aplikacji C++ 
url: /pl/cpp/conversion/tabdelimited-to-xlam/ 
description: Przykładowy kod konwersji C++ dla dokumentu TABDELIMITED do formatu XLAM. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TABDELIMITED na XLAM w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TABDELIMITED na XLAM przez C++" h2="Wysoka wydajność konwersji TABDELIMITED do XLAM przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLAM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TABDELIMITED na XLAM przy użyciu C++" %}}

 Aby przekonwertować TABDELIMITED na XLAM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TABDELIMITED na XLAM przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik TABDELIMITED na XLAM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TABDELIMITED przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLAM).1. Plik XLAM zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLAM w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED do kodu źródłowego konwersji XLAM C++" offSpacer="" %}}

```cs
// Załaduj TABDELIMITED.
intrusive_ptr<Aspose::Cells::IWorkbook> wkb = Factory::CreateIWorkbook(u"sourceFile.tabdelimited");

// Zapisz w formacie XLAM.
