---
title:  Python을 통해 PRN을 PPTX에 병합
url: /ko/python-java/merger/merge-prn-to-pptx/ 
description: 무료로 온라인에서 PRN을 PPTX에 병합합니다. PPTX 합병에 대한 무료 온라인 PRN. PRN을 Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS 등에 병합합니다.
---
...
다음 예는 PRN을 Python의 PPTX에 병합하는 방법을 보여줍니다.
...
{{% cells-merger title="온라인에서 PRN을 PPTX에 병합하는 무료 앱" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
