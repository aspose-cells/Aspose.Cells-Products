...
{{% blocks/products/pf/agp/content h2="كيفية إدراج SVG صور / أيقونات في ملف Excel باستخدام Python via صافي" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج SVG صور / أيقونات في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم إضافة الشكل[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/) لإدراج رمز في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل SVG صور / أيقونات - Python via صافي" offSpacer="" %}}
