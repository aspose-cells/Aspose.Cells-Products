...
{{% blocks/products/pf/agp/text %}}
 ...
 A .NET fejlesztői könnyedén betölthetnek és konvertálhatnak XLTX fájlokat BMP-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTX fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal átadása BMP kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott BMP-fájl megadott elérési útját
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód az XLTX BMP-vé konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="bmp" IsLandingPage="true" %}}
