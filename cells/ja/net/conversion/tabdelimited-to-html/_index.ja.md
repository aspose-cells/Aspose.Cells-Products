---
title: C#を介してTABDELIMITEDをHTMLに変換します
url: /ja/net/conversion/tabdelimited-to-html/
description: tabdelimitedからhtmlC#への変換のサンプルコード。 VB .NET、Asp .NET、または任意の.NETベースのアプリケーション内でのバッチタブ区切りファイルからhtmlへの変換にはAPIサンプルコードを使用します。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET開発者は、わずか数行のコードでTABDELIMITEDファイルを簡単にロードしてHTMLに変換できます。
...
{{% cells-convert title="TABDELIMITEDをHTMLに変換するための無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="html" IsLandingPage="true" %}}
