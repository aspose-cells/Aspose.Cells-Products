...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde XLAM Dosyası oluşturun. Java'i kullanarak XLAM dosyası oluşturun. Java'de XLAM oluşturun. Java XLAM Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını XLAM biçiminde kaydedin.
