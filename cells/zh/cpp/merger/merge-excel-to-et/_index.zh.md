---
title: 合并 EXCEL 到 ET - 将 EXCEL 合并到 ET C++
url: /zh/cpp/merger/merge-excel-to-et/ 
description: Aspose Excel。 C++ Aspose.Cells. 将 EXCEL 合并为 ET 保存格式。 C++ 将EXCEL合并为ET格式。将EXCEL合并到C++中的ET。EXCEL合并。
...
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将 EXCEL 合并到 ET" h2="用于将 EXCEL 合并到 ET 的高速 C++ 库。使用我们的Excel转换API在C++中开发高级、平台无关的软件。这是导入和导出Excel, CSV, OpenOffice, PDF, HTML, image以及许多其他Excel格式的专业软件解决方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="EXCEL" additionalConversionTag="ET" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="使用 C++ 将 EXCEL 合并到 ET" %}}

如何将EXCEL合并到ET？借助 Aspose.Cells for C++ 库，您可以通过几行代码以编程方式轻松将 EXCEL 合并到 ET。[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 C++ Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。您可以直接下载最新版本，打开即可[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/)包管理器，搜索Aspose.Cells.cpp并安装。您还可以从包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/content h2="将EXCEL合并到C++中的ET" %}}

下面的例子演示了如何将EXCEL合并到Aspose.Cells for C++中的ET中。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 EXCEL 合并到 ET。上传文件，调用Workbook.Combine方法合并文件，然后保存到ET文件。如果您在 C++ 中开发代码，这会比听起来更简单。请参阅 C++ 将 EXCEL 合并到 ET 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C++ 中将 EXCEL 合并到 ET 的示例代码" InputFormat="xlsx" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何将EXCEL合并到ET通过C++" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 EXCEL 合并到 ET 吗？基本文档合并和连接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++ 将EXCEL合并到ET的库" %}}
