---
title: Gabungkan JPEG menjadi GAMBAR - Gabungkan JPEG menjadi GAMBAR di C#
url: /id/net/merger/merge-jpeg-to-image/ 
description: Aspose Unggul. C# Aspose.Cells. Free Online Merge JPEG to IMAGE saveformat. C# Gabungkan JPEG ke format GAMBAR. Gabung JPEG menjadi GAMBAR di C#. JPEG Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPEG menjadi GAMBAR di C# Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan JPEG ke IMAGE di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan JPEG ke IMAGE. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file IMAGE. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan JPEG ke GAMBAR.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis untuk Menggabungkan JPEG menjadi GAMBAR di C#" InputFormat="jpg" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JPEG ke GAMBAR melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan JPEG ke IMAGE secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan JPEG ke GAMBAR" %}}
