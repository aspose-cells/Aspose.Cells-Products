...
description: Aspose اكسل. قم بتحويل MHT إلى XLSX بسرعة وسهولة باستخدام Aspose.Cells. Python MHT إلى XLSX. Python احفظ MHT إلى XLSX. احفظ MHT كـ XLSX باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="تحويل MHT إلى XLSX باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على XLSX في Python" %}}

يوضح المثال التالي كيفية تحويل MHT إلى XLSX في Python.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل MHT إلى XLSX" %}}
