---
title: Создать OTS — создать файл OTS по номеру C++.
description:  Aspose Эксель. C++ Быстро и легко создайте файл OTS с помощью Aspose.Cells. Создайте файл OTS с помощью C++. Создайте файл OTS в C++. C++ OTS Creator.
...
{{% blocks/products/pf/agp/content h2="Как создать OTS в C++" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчикам легко создавать, загружать, изменять и конвертировать файлы OTS в запущенных приложениях для создания отчетов для обработки данных всего за несколько строк кода.
...
1.  Сохраните книгу как файл .ots, используя метод Save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл OTS по номеру C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ библиотека для создания файла OTS" %}}
