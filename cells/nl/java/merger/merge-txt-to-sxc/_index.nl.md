---
title: Voeg TXT samen met SXC - Combineer TXT met SXC in Java
url: /nl/java/merger/merge-txt-to-sxc/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online Samenvoegen TXT naar SXC saveformat. Java Combineer het formaat TXT tot SXC. Samenvoegen TXT tot SXC in Java. TXT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met SXC in Java Online gratis" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met SXC in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TXT samen te voegen met SXC. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand SXC. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat TXT samenvoegt met SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om TXT samen te voegen tot SXC in Java" InputFormat="txt" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe TXT samen te voegen tot SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen tot SXC? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om TXT samen te voegen tot SXC" %}}
