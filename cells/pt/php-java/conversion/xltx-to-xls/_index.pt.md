---
title: Conversor PHP XLTX para XLS - XLTX para XLS
description: Aspose Excel. Converta XLTX em XLS de forma rápida e fácil com Aspose.Cells. PHP XLTX em XLS. PHP Salve XLTX em XLS. Salve XLTX como XLS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em XLS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em XLS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em XLS em apenas algumas linhas de código.
...
1.  Converta XLTX em XLS chamando o método save da pasta de trabalho.
