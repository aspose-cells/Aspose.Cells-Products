---
title:  Pisahkan ODS File via .NET
weight: 140
description: Kode sumber C# untuk membagi dokumen ODS pada Kerangka .NET, Inti .NET, Mono atau Platform Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Memisahkan File ODS di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Pisahkan berkas ODS - C#" offSpacer="" %}}
