---
title: C# SPREADSHEETML na FODS - Konwerter online SPREADSHEETML na FODS
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Bezpłatnie online C# Konwersja SPREADSHEETML do formatu zapisu FODS. C# SPREADSHEETML do formatu FODS. Zapisz SPREADSHEETML pod numerem FODS C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz SPREADSHEETML pod numerem FODS w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować SPREADSHEETML na FODS w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować SPREADSHEETML na FODS. Prześlij swój plik SPREADSHEETML, a następnie po prostu zapisz go jako plik FODS. Zarówno do odczytu SPREADSHEETML, jak i zapisu FODS można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie FODS będą identyczne z oryginalnym dokumentem SPREADSHEETML.
...
Chcesz programowo przekonwertować pliki SPREADSHEETML na FODS? .NET programiści mogą łatwo załadować i przekonwertować SPREADSHEETML na FODS w zaledwie kilku wierszach kodu.
