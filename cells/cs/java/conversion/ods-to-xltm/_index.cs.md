---
title: Převést ODS na XLTM přes Java 
weight: 1520
url: /cs/java/conversion/ods-to-xltm/ 
description: Ukázkový konverzní kód Java pro formát ODS na soubor XLTM. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do XLTM v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODS na XLTM přes Java" h2="Převod ODS na XLTM Java pro převod jedné nebo více stránek na XLTM pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na XLTM pomocí Java" %}}

 K vykreslení ODS do XLTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na XLTM přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na XLTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLTM a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLTM
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODS na XLTM Java" offSpacer="" %}}

```cs
// načtěte soubor ODS v instanci Workbooku
Workbook book = new Workbook("template.ods");
// uložit ODS jako XLTM
