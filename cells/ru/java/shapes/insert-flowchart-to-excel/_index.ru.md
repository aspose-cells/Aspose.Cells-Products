---
title: Вставить блок-схему в Excel via Java
weight: 360
...
{{% blocks/products/pf/agp/content h2="Как вставить блок-схему в файл Excel, используя Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке блок-схемы в файл Excel via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) чтобы вставить блок-схему в выбранный рабочий лист
...
Пример кода ниже демонстрирует, как вставить «Мультидокумент». Дополнительные типы см. в разделе «Обзор типов блочных стрелок» ниже.

{{% blocks/products/pf/agp/code-block title="Вставить блок-схему - Java" offSpacer="" %}}
