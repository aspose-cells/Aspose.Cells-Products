...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod ODS na MD online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="md" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést ODS na MD přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python vývojáři mohou snadno načíst a převést ODS na MD v několika řádcích kódu.
