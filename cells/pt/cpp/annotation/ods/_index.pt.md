---
title:  Adicionar ou remover anotação ODS via C++
weight: 8840
description: C++ código de exemplo para excluir anotações de formato ODS no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
...
{{% blocks/products/pf/agp/code-block title="Adicione comentários em ODS - C++" offSpacer="" %}}
