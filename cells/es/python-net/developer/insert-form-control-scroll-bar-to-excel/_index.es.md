---
title:  Inserte ScrollBar (control de formulario) en Excel usando Python via .Net
weight: 90
description: Python via Código fuente .Net para insertar ScrollBar (control de formulario) en Excel.
...
{{% blocks/products/pf/agp/content h2="Cómo insertar una barra de desplazamiento (control de formulario) en un archivo de Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar ScrollBar (control de formulario) en un archivo Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el complemento de la colección de formas.[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_scroll_bar/#int-int-int-int-int-int) para insertar una barra de desplazamiento (control de formulario) en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar barra de desplazamiento (control de formulario) - Python via .Net" offSpacer="" %}}
