...
description: Aspose Exceller. Convertissez XLSM en JSON rapidement et facilement avec Aspose.Cells. Python XLSM en JSON. Python Enregistrez XLSM en JSON. Enregistrez XLSM sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLSM au JSON au Python" %}}

L'exemple suivant montre comment convertir XLSM en JSON dans Python.
