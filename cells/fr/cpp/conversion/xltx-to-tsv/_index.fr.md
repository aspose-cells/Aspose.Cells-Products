---
title: Convertir XLTX en TSV via l'application C++ 
url: /fr/cpp/conversion/xltx-to-tsv/ 
description: Exemple de code de conversion C++ pour le document XLTX au format TSV. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLTX en TSV dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLTX en TSV via C++" h2="Conversion XLTX vers TSV haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLTX en TSV en utilisant C++" %}}

 Afin de convertir XLTX en TSV, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLTX en TSV via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier XLTX en TSV en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLTX à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (TSV).1. Le fichier TSV sera enregistré dans le chemin spécifié.1. Ouvrez le fichier TSV dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="XLTX à TSV C++ Code source de conversion" offSpacer="" %}}
