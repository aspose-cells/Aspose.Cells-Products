...
url: /nl/cpp/merger/merge-sxc-to-pdf/ 
...
Het volgende voorbeeld laat zien hoe u SXC samenvoegt met PDF in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u SXC programmatisch samenvoegen met PDF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om SXC samen te voegen met PDF" %}}
