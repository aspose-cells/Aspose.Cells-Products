---
title: XLAM в XLSM - Преобразование файлов XLAM в XLSM Python via Python
...
В следующем примере показано, как преобразовать XLAM в XLSM в Python via NET.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XLAM в XLSM" %}}
