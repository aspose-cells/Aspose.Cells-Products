...
description: Aspose Excel. Konvertieren Sie HTM schnell und einfach in XLSX mit Aspose.Cells. C++ HTM in XLSX. C++ Speichern Sie HTM in XLSX. Speichern Sie HTM als XLSX mit C++.
...
{{% cells-convert title="Beispielcode zum Konvertieren von HTM in XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlsx" IsLandingPage="true" language="cpp" %}}
