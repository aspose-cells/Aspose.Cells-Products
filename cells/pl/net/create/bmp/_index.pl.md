---
title: Utwórz BMP - Utwórz plik BMP w C#
description: Aspose Excel. Bezproblemowo generuj i manipuluj plikami BMP dzięki bibliotece Aspose.Cells for .NET. Ta wydajna biblioteka API zapewnia usprawnione i wydajne rozwiązanie do tworzenia, edytowania i zarządzania plikami BMP bezpośrednio w aplikacjach C#, spełniając specyficzne potrzeby programistów z wysoką precyzją.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć BMP w C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści mogą łatwo tworzyć, ładować, modyfikować i konwertować pliki BMP w ramach uruchamiania różnych aplikacji raportujących do przetwarzania danych w zaledwie kilku wierszach kodu.
...
1.  Użyj metody Zapisz, aby zapisać skoroszyt jako plik BMP.

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik BMP w C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do utworzenia pliku BMP" %}}
