---
title: C# XLAM bis PDF - XLAM bis PDF Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM bis PDF in C#" %}}

Das folgende Beispiel zeigt, wie man XLAM in C# in PDF umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLAM über C# in PDF" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLAM-Dateien programmgesteuert in PDF konvertieren? .NET-Entwickler können XLAM mit nur wenigen Codezeilen problemlos in PDF laden und konvertieren.
...
1.  Konvertieren Sie XLAM in PDF durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLAM in PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLAM in PDF" %}}
