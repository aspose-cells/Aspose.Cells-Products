---
title: Python 経由で PRN を POWERPOINT にマージします
...
次の例は、PRN を Python の POWERPOINT にマージする方法を示しています。
...
{{% cells-merger title="PRN をオンラインで POWERPOINT にマージする無料アプリ" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
