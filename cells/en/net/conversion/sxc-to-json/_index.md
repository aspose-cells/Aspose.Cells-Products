---
title: SXC to JSON - Convert SXC to JSON files C#
description: Aspose Excel. Free Online Convert SXC to JSON saveformat. C# SXC to JSON format. Save SXC as JSON in C#.
keywords: [Aspose Excel., C# Aspose.Cells., C# SXC to JSON saveformat., Free Online SXC to JSON Converter]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert SXC to JSON in C#" h2="High-speed C# library for converting SXC to JSON. This is a professional software solution to import and export SXC, JSON, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% cells-convert title="Free App and Sample Code to Convert SXC to JSON Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert SXC to JSON via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert SXC files to JSON programmatically? .NET developers can easily load & convert SXC to JSON in just a few lines of code.
