...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar SQL met Aspose.Cells. PHP OTS naar SQL. PHP Bewaar OTS in SQL. Sla OTS op als SQL met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar SQL te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar SQL converteren? PHP-ontwikkelaars kunnen OTS eenvoudig in slechts een paar regels code laden en naar SQL converteren.
...
1. Converteer OTS naar SQL door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van OTS naar SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om OTS naar SQL te converteren" %}}
