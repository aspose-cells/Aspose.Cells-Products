...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TXT\'yi XPS\'ye Dönüştürme" %}}

 TXT'yi XPS'e dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden TXT\'yi XPS\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, TXT dosyasını yalnızca birkaç kod satırıyla kolayca XPS'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TXT dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. Parametre olarak XPS uzantısı ve SaveFormat ile çıktı yolunu iletin1. Ortaya çıkan XPS dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="TXT - XPS Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// TXT dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.txt");
// TXT'yi XPS olarak kaydet
