...
+ ใช้วิธีการเพิ่มของ shapecollection เพื่อแทรกอักษรศิลป์ในแผ่นงานที่เลือก
...
-  ติดตั้ง Aspose.Cells for Python via .NET จาก<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> ให้ใช้คำสั่งเป็น:<code>$ pip install aspose-cells-python</code>.
