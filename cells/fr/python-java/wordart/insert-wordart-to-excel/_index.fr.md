---
title:  Insérez WordArt dans Excel en utilisant Python via Java
weight: 200
description: Python via Java code source pour insérer WordArt dans Excel.
...
{{% blocks/products/pf/agp/content h2="Comment insérer WordArt dans un fichier Excel à l\'aide de Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer WordArt dans un fichier Excel en utilisant Python via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addWordArt(int,%20java.lang.String,%20int,%20int,%20int,%20int,%20int,%20int)) pour insérer un WordArt dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer WordArt - Python via Java" offSpacer="" %}}
