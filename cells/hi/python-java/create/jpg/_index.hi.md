...
{{% blocks/products/pf/agp/content h2="Python में JPG कैसे बनाएं" %}}
...
1.  कार्यपुस्तिका को JPG फ़ाइल के रूप में सहेजने के लिए सेव विधि का उपयोग करें।

{{% blocks/products/pf/agp/code-block title="नमूना कोड दिखाता है कि Python में JPG फ़ाइल कैसे बनाएं।" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="JPG फ़ाइल बनाने के लिए Python लाइब्रेरी" %}}
