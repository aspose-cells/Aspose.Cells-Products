---
title: C++ أرقام إلى PNG - أرقام على الإنترنت لتحويل PNG
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ قم بتحويل الأرقام إلى PNG saveformat. C++ أرقام إلى تنسيق PNG. احفظ الأرقام في PNG C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الأرقام إلى PNG في C++" h2="أرقام عالية الأداء لتحويل PNG باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في PNG في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات NUMBERS إلى PNG برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل الأرقام إلى PNG في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الأرقام إلى PNG باستدعاء طريقة Save ().
