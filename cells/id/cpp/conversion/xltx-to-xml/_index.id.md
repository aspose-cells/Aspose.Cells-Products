...
description: Aspose Unggul. Ubah XLTX menjadi XML dengan cepat dan mudah dengan Aspose.Cells. C++ XLTX menjadi XML. C++ Simpan XLTX ke XML. Simpan XLTX sebagai XML menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah XLTX menjadi XML Menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengonversi XLTX ke XML di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLTX ke XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLTX ke XML melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLTX ke XML secara terprogram? Pengembang C++ dapat dengan mudah mengonversi XLTX ke XML hanya dalam beberapa baris kode.
...
1.  Ubah XLTX menjadi XML dengan memanggil metode Save().
1.  Dapatkan hasil konversi XLTX ke XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengonversi XLTX ke XML" %}}
