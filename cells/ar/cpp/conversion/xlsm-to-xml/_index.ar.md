---
title: تحويل XLSM إلى XML عبر تطبيق C++ 
url: /ar/cpp/conversion/xlsm-to-xml/ 
description: نموذج C++ رمز التحويل لمستند XLSM إلى تنسيق XML. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLSM إلى XML في أي تطبيق C++.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSM إلى XML باستخدام C++" %}}

 من أجل تحويل XLSM إلى XML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLSM إلى XML عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ بسهولة تحويل ملف XLSM إلى XML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLSM باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد ملف (XML).1. سيتم حفظ ملف XML في المسار المحدد.1. افتح ملف XML في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLSM إلى XML C++ رمز مصدر التحويل" offSpacer="" %}}
