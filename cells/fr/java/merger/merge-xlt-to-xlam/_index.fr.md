...
description: Aspose Exceller. Java Aspose.Cells. Fusionner le format de sauvegarde XLT à XLAM. Java Combinez les formats XLT à XLAM. Fusionner XLT à XLAM dans Java. XLT Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLT à XLAM dans Java" %}}
...
{{% cells-merger title="Exemple de code pour fusionner XLT à XLAM dans Java" InputFormat="xlt" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLT à XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLT à XLAM par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner XLT à XLAM" %}}
