...
Ví dụ sau đây minh họa cách hợp nhất EXCEL thành DIF trong Aspose.Cells for .NET.
...
{{% cells-merger title="Mã mẫu gộp EXCEL về DIF trong C#" InputFormat="xlsx" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp EXCEL thành DIF" %}}
