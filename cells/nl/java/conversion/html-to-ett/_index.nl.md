...
Het volgende voorbeeld laat zien hoe je HTML omzet naar ETT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar ETT via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u HTML-bestanden programmatisch naar ETT converteren? Ontwikkelaars van Java kunnen HTML-bestanden eenvoudig in een paar regels code naar ETT converteren.
