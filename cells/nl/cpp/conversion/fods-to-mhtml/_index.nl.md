...
{{% blocks/products/pf/agp/content h2="Sla FODS op in MHTML in C++" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar MHTML in C++.
...
Moet je bestanden met de extensie FODS programmatisch converteren naar MHTML? Ontwikkelaars van C++ kunnen bestanden met de extensie FODS eenvoudig converteren naar MHTML met slechts een paar regels code.
