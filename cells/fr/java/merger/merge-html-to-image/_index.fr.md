---
title: Fusionner HTML avec IMAGE - Combiner HTML avec IMAGE dans Java
url: /fr/java/merger/merge-html-to-image/ 
description: Aspose Exceller. Java Aspose.Cells. Fusionner HTML au format de sauvegarde IMAGE. Java Combinez HTML au format IMAGE. Fusionner HTML avec IMAGE dans Java. HTML Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTML avec IMAGE en utilisant Java" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner HTML avec IMAGE dans Java" %}}

L'exemple suivant montre comment fusionner HTML avec IMAGE dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner HTML avec IMAGE. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier IMAGE. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne HTML avec IMAGE.
...
{{% blocks/products/pf/agp/content h2="Comment fusionner HTML avec IMAGE via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTML avec IMAGE par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner HTML avec IMAGE" %}}
