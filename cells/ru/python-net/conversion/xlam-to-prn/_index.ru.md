---
title: XLAM в PRN — конвертировать XLAM в файлы PRN Python via Python
...
В следующем примере показано, как преобразовать XLAM в PRN в Python via NET.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XLAM в PRN" %}}
