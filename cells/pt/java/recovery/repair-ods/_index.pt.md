---
title: Java Reparar arquivo ods - Reparar arquivo ods online gratuitamente
url: /pt/java/recovery/repair-ods/ 
description: Aspose Excel. Java Aspose.Cells. Java Reparar arquivo ods. Ferramenta on-line gratuita de reparo de ods. Repare um arquivo ods corrompido. Recupere um arquivo ods corrompido no aplicativo Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Reparar arquivo ODS em Java" h2="Crie seu próprio aplicativo Java para reparar arquivos ods usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Como reparar o arquivo ods em Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa reparar o arquivo ods programaticamente? Java os desenvolvedores podem facilmente carregar e reparar o arquivo ods em apenas algumas linhas de código.
...
{{% cells-recovery title="Aplicativo gratuito e código de amostra para reparar o arquivo ODS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="java" %}}    
    
{{% blocks/products/pf/agp/content h2="Java biblioteca para reparar o arquivo ODS" %}}
