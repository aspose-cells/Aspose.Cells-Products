---
title:  Vložte Oval do Excelu via Java
weight: 40
...
{{< blocks/products/pf/i18n/upper-banner h1="Vložte Oval do Excelu via Java" h2="Vkládejte objekty pomocí rozhraní API na straně serveru bez jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF atd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit ovál do souboru aplikace Excel pomocí Java" %}}

 Abychom vložili Oval do souboru aplikace Excel, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postup vložení oválu do souboru Excel via Java" %}}
...
+ Vyberte List přes jeho index.
 + Použijte[přidat metodu](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addOval-int-int-int-int-int-int-) pro vložení Oval do vybraného listu
...
{{% blocks/products/pf/agp/code-block title="Oválná vložka - Java" offSpacer="" %}}
