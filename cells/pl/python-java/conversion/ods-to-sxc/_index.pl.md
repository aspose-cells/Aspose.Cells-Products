...
description: Aspose Excel. Konwertuj ODS na SXC szybko i łatwo za pomocą Aspose.Cells. Python ODS na SXC. Python Zapisz ODS na SXC. Zapisz ODS jako 0761113 481 pod numerem Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj ODS na SXC za pomocą Python" %}}

Jak przekonwertować numer ODS na numer SXC? Dzięki bibliotece Aspose.Cells for Python możesz łatwo przekonwertować programowo ODS na SXC za pomocą kilku linijek kodu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Zapisz ODS do SXC w Python" %}}

Poniższy przykład pokazuje, jak przekonwertować ODS na SXC w Python.
...
{{% cells-convert title="Przykładowy kod do konwersji ODS na SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="sxc" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji ODS na SXC" %}}
