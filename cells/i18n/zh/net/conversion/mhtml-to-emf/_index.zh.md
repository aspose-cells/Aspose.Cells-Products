---
title: 通过 C# 将 MHTML 转换为 EMF
url: /zh/net/conversion/mhtml-to-emf/
description: mhtml 到 emf C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 mhtml 文件批量转换为 emf。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 开发人员只需几行代码即可轻松加载 MHTML 文件并将其转换为 EMF。
...
{{% cells-convert title="将 MHTML 转换为 EMF 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="emf" IsLandingPage="true" %}}
