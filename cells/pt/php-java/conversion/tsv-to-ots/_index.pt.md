...
description: Aspose Excel. Converta TSV em OTS de forma rápida e fácil com Aspose.Cells. PHP TSV em OTS. PHP Salve TSV em OTS. Salve TSV como OTS usando PHP.
...
Precisa converter arquivos TSV para OTS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em OTS em apenas algumas linhas de código.
...
1.  Converta TSV em OTS chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TSV para OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TSV para OTS" %}}
