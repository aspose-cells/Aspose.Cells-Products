...
{{< blocks/products/pf/i18n/upper-banner h1="Crea file NUMBERS in C++" h2="Creazione di file NUMBERS nativi e ad alte prestazioni a livello di programmazione senza Microsoft Office utilizzando la libreria C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Per gli sviluppatori è facile creare, caricare, modificare e convertire file NUMBERS all'interno di applicazioni di reporting in esecuzione per l'elaborazione dei dati, utilizzando solo poche righe di codice.
...
1.  Salvare la cartella di lavoro come file .numbers utilizzando il metodo Save().
...
{{% blocks/products/pf/agp/content h2="Libreria C++ per creare il file NUMBERS" %}}
