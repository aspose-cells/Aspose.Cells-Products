---
title: Sloučit ODS až XPS - Sloučit ODS až XPS v Python
url: /cs/python-java/merger/merge-ods-to-xps/ 
description: Aspose Excel. Python Excel. Sloučit ODS do XPS uložit formát. Python Kombinujte formát ODS až XPS. Sloučit ODS až XPS v knihovně Excel Python. ODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS do XPS pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS až XPS v Python knihovně Excel" %}}

Následující příklad ukazuje, jak sloučit ODS až XPS v Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení ODS do XPS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XPS. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí ODS do XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení ODS až XPS v knihovně Excel Python" InputFormat="ods" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit ODS do XPS přes Python Excel Library" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit ODS až XPS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python ke sloučení ODS až XPS" %}}
