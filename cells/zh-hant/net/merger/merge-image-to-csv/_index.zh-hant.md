---
title: 將影像合併到 CSV - 將影像合併到 CSV 中的 C#
url: /zh-hant/net/merger/merge-image-to-csv/ 
description: Aspose Excel。 C# Aspose.Cells。將影像合併為CSV儲存格式。 C# 將 IMAGE 合併為 CSV 格式。將IMAGE合併到C#中的CSV。IMAGE合併。
...
{{% blocks/products/pf/agp/content h2="將IMAGE合併到C#中的CSV" %}}

以下範例示範如何將 IMAGE 合併到 Aspose.Cells for .NET 中的 CSV。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 IMAGE 合併到 CSV。上傳文件，呼叫 Workbook.Combine 方法合併文件，然後將其儲存到 CSV 文件。如果您在 C# 中開發程式碼，這會比聽起來更簡單。請參閱 C# 將 IMAGE 合併到 CSV 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 IMAGE 合併到 C# 中的 CSV 的範例程式碼" InputFormat="png" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 IMAGE 合併到 CSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 IMAGE 合併到 CSV 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 庫將 IMAGE 合併到 CSV" %}}
