...
{{% blocks/products/pf/agp/content h2="如何使用C#将图片插入Excel文件" %}}

为了将图片插入到Excel文件中，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过C#将图片插入Excel文件的步骤" %}}
...
+ 通过索引选择工作表。
有两种方法可以在选定的工作表中插入图片。
 + 使用形状集合[添加方法](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addpicture/index)在选定的工作表中插入图片。
 + 使用图片集[添加方法](https://reference.aspose.com/cells/net/aspose.cells.drawing/picturecollection/methods/add/index)在选定的工作表中插入图片。
以 XLSX 格式保存工作簿。
