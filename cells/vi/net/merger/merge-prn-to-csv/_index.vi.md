---
title: Gộp PRN thành CSV - Gộp PRN thành CSV trong C#
url: /vi/net/merger/merge-prn-to-csv/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí PRN thành CSV saveformat. C# Kết hợp định dạng PRN thành CSV. Hợp nhất PRN thành CSV trong C#. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN với CSV trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất PRN thành CSV trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất PRN thành CSV. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp rồi lưu vào tệp CSV. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất PRN thành CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất PRN thành CSV trong C#" InputFormat="prn" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất PRN thành CSV qua C#" %}}
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất PRN thành CSV" %}}
