...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση SPREADSHEETML στο CSV στο C++" InputFormat="xml" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
...
{{% blocks/products/pf/agp/content h2="C++ βιβλιοθήκη για συγχώνευση SPREADSHEETML στο CSV" %}}
