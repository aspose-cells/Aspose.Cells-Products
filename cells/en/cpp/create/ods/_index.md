...
url: /cpp/create-ods/ 
description: C++ Sample code for generating ODS (Openoffice / Lbreoffice) files. Use this code for creating ODS (Openoffice / Lbreoffice) files within C++ based application.
---
...
An Excel Spreadsheet Programming Library capable of building cross-platform applications with the ability to generate, modify, convert, render and print ODS (Openoffice / Lbreoffice) files. C++ Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS and more, thus making it a perfect choice to exchange documents in industry-standard formats.
