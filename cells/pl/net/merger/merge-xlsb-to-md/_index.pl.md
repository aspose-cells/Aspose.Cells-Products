...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLSB do formatu zapisu MD. C# Połącz XLSB do formatu MD. Połącz XLSB z MD w C#. XLSB Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLSB z MD w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLSB z MD w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLSB z MD. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku MD. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy XLSB z MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLSB z MD w C#" InputFormat="xlsb" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSB z MD przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć numer XLSB z MD? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLSB z MD" %}}
