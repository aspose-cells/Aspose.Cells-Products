...
{{% cells-convert title="Gratis app en voorbeeldcode om HTML online naar XLS te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe HTML te converteren naar XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-ontwikkelaars kunnen eenvoudig HTML converteren naar XLS in slechts een paar regels code.
