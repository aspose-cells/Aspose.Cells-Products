---
title: Converti HTML in TABDELIMITED tramite l'applicazione C++ 
url: /it/cpp/conversion/html-to-tabdelimited/ 
description: Esempio di codice di conversione C++ per un documento HTML in formato TABDELIMITED. I programmatori possono utilizzare questo codice sorgente per la conversione batch da HTML a TABDELIMITED all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file HTML in TABDELIMITED in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file HTML usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (TABDELIMITED).1. Il file TABDELIMITED verrà salvato nel percorso specificato.1. Apri il file TABDELIMITED in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da HTML a TABDELIMITED C++" offSpacer="" %}}
