...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Penggabungan File XLT di Java" %}}
...
+ Muat file XLT pertama dengan instance kelas Buku Kerja.
+ Muat dokumen XLT kedua dengan instance kelas Buku Kerja.
+ Gabungkan file menggunakan metode gabungan().
+ simpan file gabungan XLT di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Gabungkan XLT File - Java" offSpacer="" %}}
