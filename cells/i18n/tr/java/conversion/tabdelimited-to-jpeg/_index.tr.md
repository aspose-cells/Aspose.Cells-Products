---
title: Java aracılığıyla TABDELIMITED'i JPEG'e dönüştürün 
url: /tr/java/conversion/tabdelimited-to-jpeg/ 
description: TABDELIMITED formatı için JPEG dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada JPEG'e aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla TABDELIMITED\'i JPEG\'e dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı JPEG\'e dönüştürmek için TABDELIMITED\'den JPEG\'e Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak TABDELIMITED\'i JPEG\'e Dönüştürme" %}}

 TABDELIMITED'i JPEG'e dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla TABDELIMITED\'i JPEG\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, TABDELIMITED dosyasını yalnızca birkaç satır kodla kolayca JPEG'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED dosyasını bir Çalışma Kitabı örneğiyle yükleyin1. Koleksiyondan varsayılanı veya herhangi bir Çalışma Sayfasını seçin1. ImageOrPrintOptions nesnesini oluşturun ve ayarlayın1. Worksheet & ImageOrPrintOptions nesneleriyle SheetRender oluşturun1. Sonucu JPEG formatında kaydetmek için SheetRender.toImage yöntemini çağırın
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED - JPEG Java Dönüştürme Kaynak Kodu" offSpacer="" %}}

```cs
// işlenecek TABDELIMITED dosyasını yükleyin
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED\'den JPEG\'e Dönüştürme Canlı Demoları" sectionDescription="[TABDELIMITED\'yi JPEG\'ye dönüştür](https://products.aspose.app/cells/conversion/tabdelimited-to-jpeg) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" TABDELIMITED dosyanızı yükleyin, anında JPEG\'e dönüştürülecektir." >}}
