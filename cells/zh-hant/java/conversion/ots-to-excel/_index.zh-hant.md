---
title: Java OTS 轉 EXCEL - OTS 轉 EXCEL 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 EXCEL。Java OTS 到 EXCEL。 Java 將OTS儲存到EXCEL。使用 Java 將 OTS 儲存為 EXCEL。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Java 中的 OTS 轉換為 EXCEL" h2="用於將 OTS 轉換為 EXCEL 的高速 Java 庫。這是一個使用 Java 匯入和匯出 OTS、EXCEL 和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將OTS保存到EXCEL中Java" %}}

下面的範例示範如何將Java中的OTS轉換為EXCEL。
...
{{% cells-convert title="將 OTS 轉換為 EXCEL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 OTS 轉換為 EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 OTS 檔案轉換為 EXCEL？ Java 開發人員只需幾行程式碼即可輕鬆將 OTS 轉換為 EXCEL。
...
{{% blocks/products/pf/agp/content h2="Java 將 OTS 轉換為 EXCEL 的函式庫" %}}
{{% blocks/products/pf/agp/text %}}
