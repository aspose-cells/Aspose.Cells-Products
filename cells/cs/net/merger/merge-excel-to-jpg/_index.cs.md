---
title: Sloučit EXCEL do JPG – Kombinujte EXCEL s JPG v C#
url: /cs/net/merger/merge-excel-to-jpg/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit EXCEL do formátu uložení JPG. C# Kombinujte EXCEL s formátem JPG. Sloučit EXCEL do JPG v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL do JPG v C#" %}}

Následující příklad ukazuje, jak sloučit EXCEL do JPG v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení EXCEL do JPG. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru JPG. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí EXCEL do JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení EXCEL do JPG v C#" InputFormat="xlsx" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL do JPG přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit EXCEL do JPG? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna pro sloučení EXCEL do JPG" %}}
