...
description: Aspose Excel. Convierta XLSB a XLAM rápida y fácilmente con Aspose.Cells. Python XLSB a XLAM. Python Guarde XLSB en XLAM. Guarde XLSB como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB al XLAM en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a XLAM en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir XLSB a XLAM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlam" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB en XLAM" %}}
