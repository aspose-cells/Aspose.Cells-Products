---
title: Mesclar MHTML para MD - Combine MHTML para MD em Java
url: /pt/java/merger/merge-mhtml-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Mesclagem on-line gratuita MHTML para MD saveformat. Java Combine MHTML para o formato MD. Mesclar MHTML para MD em Java. MHTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHTML para MD em Java Online Gratuitamente" %}}

exemplo a seguir demonstra como mesclar MHTML com MD em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHTML para MD. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e, em seguida, salve-o no arquivo MD. Se você desenvolver código em Java, isso será mais simples do que parece. Veja o exemplo Java que mescla MHTML com MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar MHTML para MD em Java" InputFormat="mhtml" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHTML para MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar MHTML para MD programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHTML para MD" %}}
