...
weight: 337
description: C# código fuente para insertar Arc en Excel en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addArc) para insertar un arco en la hoja de trabajo seleccionada
