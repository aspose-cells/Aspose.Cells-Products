...
description: Aspose Excel. Convierta OTS a BMP rápida y fácilmente con Aspose.Cells. Python OTS a BMP. Python Guarde OTS en BMP. Guarde OTS como BMP usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar OTS al BMP en Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a BMP en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir OTS a BMP" %}}
