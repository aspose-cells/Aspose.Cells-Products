---
title: Unisci NUMERI in PRN - Combina NUMERI in PRN in C#
url: /it/net/merger/merge-numbers-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. Unisci i NUMERI nel formato di salvataggio PRN. C# Combina i NUMERI nel formato PRN. Unisci i NUMERI al PRN in C#. NUMERI Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci i NUMERI al PRN in C#" %}}

L'esempio seguente dimostra come unire NUMBERS in PRN in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire i NUMERI al PRN. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file PRN. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedi l'esempio C# che unisce NUMBERS a PRN.
...
{{% blocks/products/pf/agp/content h2="Come unire i NUMERI al PRN tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

È necessario unire NUMBERS in PRN a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria .NET per unire i NUMERI al PRN" %}}
