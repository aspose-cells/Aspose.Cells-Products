---
title: Sloučit JSON na OTS - Sloučit JSON na OTS v C++
url: /cs/cpp/merger/merge-json-to-ots/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit JSON do formátu uložení OTS. C++ Zkombinujte JSON do formátu OTS. Sloučit JSON do OTS v C++. JSON Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JSON na OTS v C++" %}}

Následující příklad ukazuje, jak sloučit JSON do OTS v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JSON s OTS. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru OTS. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JSON do OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení JSON do OTS v C++" InputFormat="json" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON do OTS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit JSON do OTS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení JSON do OTS" %}}
