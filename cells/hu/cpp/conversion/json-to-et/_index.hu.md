...
Programozottan kell ET formátumba konvertálni a JSON fájlokat? A C++ fejlesztők könnyedén konvertálhatják a JSON fájlokat ET formátumba mindössze néhány sornyi kóddal.
...
1.  Alakítsd át a JSON-et ET-vé a Save() metódus meghívásával.
