...
Besoin de convertir des fichiers HTM au format XPS par programmation ? Les développeurs spécialisés en C++ peuvent facilement convertir des fichiers HTM au format XPS en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en XPS en appelant la méthode Save().
