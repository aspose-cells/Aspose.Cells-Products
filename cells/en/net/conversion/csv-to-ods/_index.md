...
{{% blocks/products/pf/agp/content h2="Save CSV to ODS in C#" %}}

The following example demonstrates how to convert CSV to ODS in C#.
...
{{% cells-convert title="Sample Code to Convert CSV to ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert CSV to ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert CSV files to ODS programmatically? .NET developers can easily load & convert CSV to ODS in just a few lines of code.
...
1.  Convert CSV to ODS by calling Workbook.Save method.
1.  Get the conversion result of CSV to ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# library to convert CSV to ODS" %}}
