---
title: PHP FODS to XLS - FODS to XLS Converter
description: PHP Aspose.Cells. FODS to XLS in PHP. PHP Convert FODS to XLS saveformat. PHP FODS to XLS Converter. Save FODS to XLS PHP.
keywords: [PHP Aspose.Cells., FODS to XLS in PHP., PHP FODS to XLS saveformat., FODS to XLS PHP., PHP Convert FODS to XLS., Save FODS to XLS PHP., FODS to XLS Converter., Save FODS as XLS]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODS to XLS in PHP" h2="High-speed PHP library for converting FODS to XLS. This is a professional software solution to import and export FODS, XLS, and many other formats using PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODS to XLS Using PHP" %}}

How do I convert FODS to XLS? With Aspose.Cells for PHP via Java library, you can easily convert FODS to XLS programmatically with  a few lines of code. [Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) is capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. PHP Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT and more, thus making it a perfect choice to exchange documents in industry-standard formats. 
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Save FODS to XLS in PHP" %}}

The following example demonstrates how to convert FODS to XLS in PHP.
...
{{% cells-convert title="Sample Code to Convert FODS to XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xls" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="How to Convert FODS to XLS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert FODS files to XLS programmatically? PHP developers can easily load & convert FODS to XLS in just a few lines of code.
...
1.  Convert FODS to XLS by calling save method of Workbook.
1.  Get the conversion result of FODS to XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP library to convert FODS to XLS" %}}
