...
url: /pl/cpp/merger/merge-xlsm-to-spreadsheetml/ 
...
Poniższy przykład ilustruje sposób scalania numeru XLSM z arkuszem SPREADSHEETML w pliku Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć numer XLSM z arkuszem SPREADSHEETML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLSM z SPREADSHEETML" %}}
