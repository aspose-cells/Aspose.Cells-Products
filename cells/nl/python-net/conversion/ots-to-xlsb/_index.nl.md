...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar XLSB in Python" %}}
...
Het volgende voorbeeld laat zien hoe u OTS converteert naar XLSB in Python via NET.
