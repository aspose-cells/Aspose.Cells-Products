---
title: Python ODS إلى PRN - ODS إلى PRN تحويل
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين Python نهجًا متكاملًا تمامًا لتحويل ODS إلى تنسيق PRN، مما يتيح حفظ بيانات ODS بسلاسة في تنسيق PRN باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود Python فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="قم بتحويل ODS إلى PRN في مكتبة Excel Python" %}}

 كيف أقوم بتحويل ODS إلى PRN؟ مع Aspose.Cells for Python عبر مكتبة NET، يمكنك بسهولة تحويل ODS إلى PRN برمجيًا ببضعة أسطر من التعليمات البرمجية.[Aspose.Cells for Python عبر NET](https://pypi.org/project/aspose-cells-python/)قادر على إنشاء تطبيقات مشتركة بين الأنظمة الأساسية مع القدرة على إنشاء جميع ملفات Excel وتعديلها وتحويلها وعرضها وطباعتها. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات، بل يمكنه أيضًا عرض ملفات Excel كصور، وPDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT والمزيد، مما يجعله خيارًا مثاليًا لتبادل المستندات بتنسيقات متوافقة مع معايير الصناعة.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="احفظ ODS في PRN في مكتبة Excel Python" %}}

يوضح المثال التالي كيفية تحويل ODS إلى PRN في مكتبة Excel Python.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل ODS إلى PRN. قم بتحميل ملف ODS الخاص بك، ثم احفظه كملف PRN. لكل من قراءة ODS وكتابة PRN، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق PRN الناتج مطابقًا لمستند ODS الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="نموذج التعليمات البرمجية لتحويل ODS إلى PRN عبر مكتبة Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="prn" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل ODS إلى PRN" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات ODS إلى PRN برمجياً؟ يمكن لمطوري Python تحميل وتحويل ODS بسهولة إلى PRN في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل ODS إلى PRN عن طريق استدعاء أسلوب Workbook.save.
1.  احصل على نتيجة التحويل من ODS إلى PRN.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python مكتبة إكسل لتحويل ODS إلى PRN" %}}
