---
title: Java XLSM hingga XLS - XLSM hingga XLS Konverter
description: Aspose Unggul. Ubah XLSM menjadi XLS dengan cepat dan mudah dengan Aspose.Cells. Java XLSM menjadi XLS. Java Simpan XLSM menjadi XLS. Simpan XLSM sebagai 07611134 81 menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSM menjadi XLS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi XLSM menjadi XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSM, XLS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSM hingga XLS di Java" %}}

Contoh berikut menunjukkan cara mengonversi XLSM menjadi XLS di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLSM menjadi XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSM ke XLS secara terprogram? Pengembang Java dapat dengan mudah mengonversi XLSM menjadi XLS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah XLSM menjadi XLS" %}}
{{% blocks/products/pf/agp/text %}}
