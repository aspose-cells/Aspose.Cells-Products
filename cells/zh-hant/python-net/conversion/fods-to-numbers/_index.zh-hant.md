---
title: 將 Python 和 FODS 轉換為數字 - 將 FODS 轉換為數位轉換器
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 NUMBERS 格式，從而能夠使用 Aspose.Cells 庫將 FODS 資料無縫保存為 NUMBERS 格式，所有這些程式庫將 FODS 資料無縫保存為 NUMBERS 格式，所有這些程式碼都透過高效且可客製化且可自訂153 15386153 1386153。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Excel 庫中將 FODS 轉換為數字 Python" h2="高速 Excel 庫 Python，用於將 FODS 轉換為 NUMBERS 格式。使用我們的 Excel 轉換工具 API，以 Python 格式開發進階、與平台無關的軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="在 Excel 庫中將 FODS 轉換為數字 Python" %}}

如何將 FODS 轉換為數字？透過 NET 函式庫，您可以使用幾行程式碼輕鬆地以程式設計方式將 FODS 轉換為數字。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 Python Excel 庫中的 NUMBERS 資料夾" %}}

以下範例示範如何在 Python Excel 庫中將 FODS 轉換為 NUMBERS。
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫，用於將 FODS 轉換為數字" %}}
