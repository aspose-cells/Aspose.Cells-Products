---
title: Mesclar PRN para PNG - Combine PRN para PNG em C++
url: /pt/cpp/merger/merge-prn-to-png/ 
description: Aspose Excel. C++ Aspose.Cells. Mesclar PRN online grátis para PNG saveformat. C++ Combine PRN para o formato PNG. Mesclar PRN para PNG em C++. Mesclar PRN.
...
{{% blocks/products/pf/agp/content h2="Mesclar PRN para PNG em C++ online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar PRN para PNG em Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar o PRN em PNG. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo PNG. Se você desenvolver o código em C++, isso será mais simples do que parece. Consulte o exemplo C++ que mescla PRN com PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar PRN para PNG em C++" InputFormat="prn" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar PRN para PNG via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar PRN para PNG programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para mesclar PRN para PNG" %}}
