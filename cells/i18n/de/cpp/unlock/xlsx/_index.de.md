...
{{% blocks/products/pf/agp/content h2="So entfernen Sie den Schutz der XLSX-Datei mit C++" %}}
...
1. Laden Sie die gesperrte XLSX-Datei mit CreateIWorkbook.1. Rufen Sie zum Entsperren die Unprotect()-Funktion auf.1. Setzen Sie das Passwort mit SetPassword auf NULL.1. Speichern Sie die XLSX-Datei an einem bestimmten Ort.
