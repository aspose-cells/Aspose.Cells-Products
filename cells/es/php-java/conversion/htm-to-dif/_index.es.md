---
title: PHP HTM a DIF - Convertidor HTM a DIF
description: Aspose Excel. Convierta HTM a DIF rápida y fácilmente con Aspose.Cells. PHP HTM a DIF. PHP Guarde HTM en DIF. Guarde HTM como DIF usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a DIF mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a DIF mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a DIF en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a DIF llamando al método guardar del libro de trabajo.
