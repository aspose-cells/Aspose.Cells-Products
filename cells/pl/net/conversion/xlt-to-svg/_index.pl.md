---
title: Konwertuj XLT na SVG za pomocą C#
url: /pl/net/conversion/xlt-to-svg/
description: Przykładowy kod konwersji xlt do svg C#. Użyj przykładowego kodu API dla plików wsadowych xlt do konwersji svg w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLT na SVG za pomocą C#" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu SVG na platformach .NET Framework, .NET Core, Mono lub Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na SVG przy użyciu C#" %}}
 ...
 Aby przekonwertować XLT do SVG, użyjemy
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki XLT do SVG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem SVG jako parametrem1. Sprawdź określoną ścieżkę wynikowego pliku SVG
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLT na SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="svg" IsLandingPage="true" %}}
