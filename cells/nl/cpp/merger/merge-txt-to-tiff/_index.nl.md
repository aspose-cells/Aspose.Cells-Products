---
title: Voeg TXT samen met TIFF - Combineer TXT met TIFF in C++
url: /nl/cpp/merger/merge-txt-to-tiff/ 
description: Aspose Excel. C++ Aspose.Cells. Voeg TXT samen met het opslagformaat TIFF. C++ Combineer het formaat TXT met TIFF. Voeg TXT samen met TIFF in C++. TXT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met TIFF in C++" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met TIFF in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/content h2="Hoe u TXT samenvoegt met TIFF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met TIFF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TXT samen te voegen met TIFF" %}}
