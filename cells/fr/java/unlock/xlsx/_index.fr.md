---
title:  Débloquer le document XLSX via Java
weight: 310
description: Exemple de code Java pour déverrouiller le fichier XLSX protégé par mot de passe sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
...
{{% blocks/products/pf/agp/content h2="Comment supprimer la protection du fichier XLSX à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour débloquer XLSX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Déverrouiller les fichiers XLSX via Java" offSpacer="" %}}
