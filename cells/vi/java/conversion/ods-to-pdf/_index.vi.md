---
title: Java ODS sang PDF - ODS sang PDF Bộ chuyển đổi
description: Aspose Excel. Chuyển đổi ODS sang PDF nhanh chóng và dễ dàng với Aspose.Cells. Java ODS sang PDF. Java Lưu ODS thành PDF. Lưu ODS thành 07611134 81 sử dụng Java.
...
{{% blocks/products/pf/agp/content h2="Lưu ODS vào PDF trong Java" %}}

Ví dụ sau đây minh họa cách chuyển đổi ODS thành PDF trong Java.
...
{{% cells-convert title="Mã mẫu chuyển đổi ODS thành PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="pdf" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi ODS thành PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin ODS thành PDF theo chương trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi ODS thành PDF chỉ bằng vài dòng mã.
...
1.  Chuyển đổi ODS thành PDF bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi từ ODS thành PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện Java chuyển đổi ODS thành PDF" %}}
{{% blocks/products/pf/agp/text %}}
