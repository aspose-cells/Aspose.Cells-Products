...
description: Aspose Эксель. Python Aspose.Cells. Объедините HTML и XLSB в формате сохранения. Python Объедините форматы HTML и XLSB. Объедините HTML и XLSB в Python. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML с XLSB, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и XLSB в Python." %}}

В следующем примере показано, как объединить HTML и XLSB в Aspose.Cells for Python via Java.
...
{{% cells-merger title="Пример кода для объединения чисел HTML и XLSB в Python" InputFormat="html" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Как объединить HTML с XLSB через Python" %}}
