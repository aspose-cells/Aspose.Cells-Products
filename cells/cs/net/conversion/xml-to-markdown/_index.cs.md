...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu XML do formátu MARKDOWN, což umožňuje bezproblémové ukládání XML dat do formátu MARKDOWN pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Uložit XML do MARKDOWN v C#" %}}

Následující příklad ukazuje, jak převést XML na MARKDOWN s kódem C#.
