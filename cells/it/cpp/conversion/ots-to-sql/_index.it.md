...
Hai bisogno di convertire i file OTS in SQL tramite codice? Gli sviluppatori C++ possono convertire facilmente OTS in SQL in poche righe di codice.
...
1.  Convertire OTS in SQL chiamando il metodo Save().
