---
title: C++ HTML tot SXC - HTML tot SXC Converter
...
{{% blocks/products/pf/agp/content h2="Sla HTML op in SXC in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar SXC in C++.
...
{{% blocks/products/pf/agp/content h2="Hoe u HTML naar SXC kunt converteren via C++" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar SXC? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar SXC met slechts een paar regels code.
...
1.  Converteer HTML naar SXC door de Save()-methode aan te roepen.
