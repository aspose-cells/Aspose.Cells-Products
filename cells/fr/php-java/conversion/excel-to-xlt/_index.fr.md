---
title: PHP EXCEL en XLT - Convertisseur EXCEL en XLT
description: Aspose Exceller. Convertissez EXCEL en XLT rapidement et facilement avec Aspose.Cells. PHP EXCEL en XLT. PHP Enregistrez EXCEL en XLT. Enregistrez EXCEL sous XLT en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en XLT via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en XLT par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en XLT en quelques lignes de code.
...
1.  Convertissez EXCEL en XLT en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en XLT" %}}
