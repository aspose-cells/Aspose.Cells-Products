...
{{% blocks/products/pf/agp/content h2="如何使用 Java 註釋 XLSB 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="從 XLSB via Java 添加或刪除註釋的步驟" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. 使用Workbook類加載XLSB文件
1. 選擇相關工作表
...
{{% blocks/products/pf/agp/code-block title="刪除 XLSB - Java 中的註釋" offSpacer="" %}}
