...
{{% blocks/products/pf/agp/content h2="Sla TXT op in XLTM in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar XLTM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar XLTM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar XLTM? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar XLTM met slechts een paar regels code.
