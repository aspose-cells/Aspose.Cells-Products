...
url: /el/python-java/merger/merge-htm-to-htm/ 
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το HTM με το HTM στο Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Χρειάζεστε συγχώνευση HTM σε HTM μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
