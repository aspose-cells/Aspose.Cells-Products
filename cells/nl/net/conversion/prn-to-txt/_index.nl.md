---
title: C# PRN naar TXT - Online PRN naar TXT Converter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratis online C# Converteer PRN naar TXT opslagformaat. C# PRN naar TXT formaat. Bewaar PRN naar TXT C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PRN naar TXT in C#" h2="Snelle C#-bibliotheek voor het converteren van PRN naar TXT. Dit is een professionele softwareoplossing voor het importeren en exporteren van PRN, TXT en vele andere formaten op .NET Framework, .NET Core of Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PRN" >}}
...
{{% blocks/products/pf/agp/content h2="Bewaar PRN naar TXT in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u PRN converteert naar TXT in C#.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PRN naar TXT te converteren. Upload uw PRN-bestand en sla het op als TXT-bestand. Voor zowel het lezen van PRN als het schrijven van TXT kunt u volledig gekwalificeerde bestandsnamen gebruiken. De uitvoer TXT inhoud en opmaak zal identiek zijn aan het originele PRN-document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Gratis app en voorbeeldcode om PRN online naar TXT te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN converteren naar TXT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u PRN-bestanden programmatisch converteren naar TXT? .NET-ontwikkelaars kunnen PRN eenvoudig laden en converteren naar TXT in slechts een paar regels code.
...
1.  Converteer PRN naar TXT door de methode Workbook.Save aan te roepen.
