...
description: Aspose Excel. Převeďte TSV na SQL rychle a snadno pomocí Aspose.Cells. C++ TSV na SQL. C++ Uložte TSV do SQL. Uložte TSV jako SQL pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Uložte TSV do SQL v C++" %}}

Následující příklad ukazuje, jak převést TSV na SQL v C++.
...
{{% cells-convert title="Ukázkový kód pro převod TSV na SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="sql" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést TSV na SQL přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést TSV soubory na SQL programově? C++ vývojáři mohou snadno převést TSV na SQL v několika řádcích kódu.
...
1.  Převeďte TSV na SQL voláním metody Save().
1.  Získejte výsledek převodu TSV na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ knihovna pro převod TSV na SQL" %}}
