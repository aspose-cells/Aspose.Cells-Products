...
description: Aspose Excel. Konwertuj JPG na JPEG szybko i łatwo za pomocą Aspose.Cells. Python JPG na JPEG. Python Zapisz JPG na JPEG. Zapisz JPG jako JPEG używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj JPG na JPEG za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz JPG pod numerem JPEG w Python" %}}

Poniższy przykład pokazuje, jak przekonwertować JPG na JPEG w Python.
...
{{% cells-convert title="Przykładowy kod do konwersji JPG na JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="jpg" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji JPG na JPEG" %}}
