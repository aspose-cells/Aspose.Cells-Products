---
title:  Rechercher et remplacer du texte dans le document XLS via C++
weight: 380
description: Exemple de code C++ pour masquer les informations sensibles dans le fichier XLS sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Caviarder XLS Formats en C++" h2="XLS natives et hautes performances documentent les informations sensibles de rédaction à l\'aide d\'API côté serveur Aspose.Cells for C++, sans l\'utilisation d\'un logiciel tel que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/code-block title="Caviarder XLS Fichiers - C++" offSpacer="" %}}
