---
title: PHP XLTM إلى DOCX - XLTM إلى DOCX محول
description: Aspose اكسل. قم بتحويل XLTM إلى DOCX بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى DOCX. PHP احفظ XLTM إلى DOCX. احفظ XLTM كـ DOCX باستخدام PHP.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLTM إلى DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="docx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى DOCX عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى DOCX برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى DOCX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى DOCX عن طريق استدعاء طريقة حفظ المصنف.
