...
url: /cs/cpp/merger/merge-jpg-to-fods/ 
...
Následující příklad ukazuje, jak sloučit JPG s FODS v Aspose.Cells for C++.
...
Potřebujete sloučit JPG na FODS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do FODS" %}}
