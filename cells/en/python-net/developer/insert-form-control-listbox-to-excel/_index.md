...
weight: 50
url: /python-net/developer/insert-form-control-listbox-to-excel/ 
...
+  Use the shapecollection's add method to insert a ListBox(Form control) in the selected worksheet.
