...
url: /ru/python-java/merger/merge-numbers-to-prn/ 
...
В следующем примере показано, как объединить ЧИСЛА с PRN в Aspose.Cells for Python via Java.
...
Нужно программно объединить NUMBERS с PRN? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API можно создать с помощью всего нескольких строк кода.
