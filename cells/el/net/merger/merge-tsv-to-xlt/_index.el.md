...
description: Aspose Excel. C# Aspose.Cells. Συγχώνευση TSV σε μορφή αποθήκευσης XLT. C# Συνδυάστε τη μορφή TSV με XLT. Συγχώνευση TSV σε XLT στο C#. TSV Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση TSV με XLT στο C#" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το TSV με το XLT στο Aspose.Cells for .NET.
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση TSV έως XLT στο C#" InputFormat="tsv" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
