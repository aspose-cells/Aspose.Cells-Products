...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une forme incurvée dans un fichier Excel via C#" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) pour insérer une forme courbe dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insert forme courbe - C#" offSpacer="" %}}
