...
{{% blocks/products/pf/agp/content h2="Comment insérer un cube dans un fichier Excel à l\'aide de Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer le fichier Cube dans Excel en utilisant Python via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) pour insérer un cube dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Cube d\'insertion - Python via Java" offSpacer="" %}}
