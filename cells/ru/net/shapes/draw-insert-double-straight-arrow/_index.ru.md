...
weight: 10
description: C# исходный код для рисования или вставки двойной прямой стрелки в Excel на платформах .NET Framework, .NET Core, Mono или Xamarin.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги, чтобы вставить двойную прямую стрелку в файл Excel через C#" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) чтобы вставить двойную прямую стрелку в выбранный рабочий лист
