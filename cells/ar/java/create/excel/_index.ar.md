...
description: Aspose اكسل. Java قم بإنشاء ملف EXCEL بسرعة وسهولة باستخدام Aspose.Cells. قم بإنشاء ملف EXCEL باستخدام Java. قم بإنشاء ملف EXCEL في Java. Java EXCEL Creator.
...
{{< blocks/products/pf/i18n/upper-banner h1="قم بإنشاء ملف EXCEL في Java" h2="مكتبة Java عالية السرعة لإنشاء ملف EXCEL. هذا حل برمجي احترافي لاستيراد وتصدير XLSX وPDF والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء EXCEL في Java" %}}
...
1.  احفظ المصنف بتنسيق EXCEL باستخدام طريقة save().

{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف EXCEL في Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لإنشاء ملف EXCEL" %}}
{{% blocks/products/pf/agp/text %}}
