...
description: Aspose เอ็กเซล. แปลง XML เป็น XLAM อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XML เป็น XLAM C++ บันทึก XML เป็น XLAM บันทึก XML เป็น XLAM โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XML เป็น XLAM ใน C++" %}}
...
1.  แปลง XML เป็น XLAM โดยการเรียกเมธอด Save()
