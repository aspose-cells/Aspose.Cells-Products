...
url: /tr/python-java/merger/merge-mhtml-to-ots/ 
...
Aşağıdaki örnek, MHTML'in Aspose.Cells for Python via Java'deki OTS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 MHTML'i OTS ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
