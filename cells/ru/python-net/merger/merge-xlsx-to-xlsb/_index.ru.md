---
title:  Объединить XLSX с XLSB через Python
...
В следующем примере показано, как объединить XLSX с XLSB в Python.
...
{{% cells-merger title="Бесплатное приложение для объединения XLSX с XLSB онлайн" InputFormat="xlsx" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
