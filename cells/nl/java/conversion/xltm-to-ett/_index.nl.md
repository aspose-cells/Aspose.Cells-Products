...
Het volgende voorbeeld laat zien hoe je XLTM omzet naar ETT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLTM om naar ETT via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u XLTM-bestanden programmatisch naar ETT converteren? Ontwikkelaars van Java kunnen XLTM-bestanden eenvoudig in een paar regels code naar ETT converteren.
