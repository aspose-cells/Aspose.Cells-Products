...
weight: 80
description: Python via Code source .Net pour insérer une étiquette (contrôle de formulaire) dans Excel.
...
{{% blocks/products/pf/agp/content h2="Comment insérer une étiquette (contrôle de formulaire) dans un fichier Excel à l\'aide de Python via .Net" %}}
 ...
 Afin d'insérer Label (Contrôle Formulaire) dans un fichier Excel, nous utiliserons
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_label/#int-int-int-int-int-int) pour insérer une étiquette (contrôle Formulaire) dans la feuille de calcul sélectionnée.
