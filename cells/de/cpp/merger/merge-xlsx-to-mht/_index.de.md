---
title: XLSX mit MHT zusammenführen – XLSX mit MHT in C++ kombinieren
url: /de/cpp/merger/merge-xlsx-to-mht/ 
description: Aspose Excel. C++ Aspose.Cells. Kostenlose Online-Zusammenführung von XLSX in das MHT-Speicherformat. C++ Kombinieren Sie XLSX zum MHT-Format. XLSX zu MHT in C++ zusammenführen. XLSX Zusammenführen.
...
Das folgende Beispiel zeigt, wie XLSX mit MHT in Aspose.Cells for C++ zusammengeführt wird.
...
{{% cells-merger title="Kostenlos online, um XLSX mit MHT in C++ zusammenzuführen" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie XLSX über C++ mit MHT zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLSX programmgesteuert mit MHT zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
