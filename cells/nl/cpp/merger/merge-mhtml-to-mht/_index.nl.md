---
title: Voeg MHTML samen met MHT - Combineer MHTML met MHT in C++
url: /nl/cpp/merger/merge-mhtml-to-mht/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online samenvoegen MHTML naar MHT-opslagformaat. C++ Combineer MHTML naar MHT-formaat. Samenvoegen MHTML naar MHT in C++. MHTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis MHTML samen met MHT in C++ Online" %}}

Het volgende voorbeeld laat zien hoe u MHTML kunt samenvoegen met MHT in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHTML samen te voegen met MHT. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het MHT-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat MHTML samenvoegt met MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om MHTML samen te voegen met MHT in C++" InputFormat="mhtml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe MHTML samen te voegen met MHT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++-bibliotheek om MHTML samen te voegen met MHT" %}}
