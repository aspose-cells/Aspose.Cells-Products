---
title: C++ XLS ถึง XLTX - ออนไลน์ XLS ถึง XLTX Converter
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง XLS เป็น XLTX บันทึกรูปแบบ รูปแบบ C++ XLS ถึง XLTX บันทึก XLS ถึง XLTX C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ถึง XLTX ใน C++ ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLS เป็น XLTX ใน C++
...
ต้องการแปลงไฟล์ XLS เป็น XLTX โดยทางโปรแกรมหรือไม่ นักพัฒนา C++ สามารถแปลง XLS เป็น XLTX ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง XLS เป็น XLTX โดยเรียกเมธอด Save()
