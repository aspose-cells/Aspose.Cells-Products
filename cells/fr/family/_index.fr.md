---
title:  .NET Java Python C++ API d'analyse de feuilles de calcul Excel PHP et Android
weight: 10
description: Bibliothèques pour lire, écrire et manipuler Microsoft fichiers Excel dans .NET Java C++ applications Android et SharePoint. Exporter des feuilles de calcul dans SSRS et JasperReports
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Traiter des feuilles de calcul Excel sur plusieurs plates-formes" h2="API natives pour créer, modifier, convertir et restituer des fichiers Excel. Exportez des feuilles de calcul vers plusieurs formats sur n’importe quelle plateforme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells.svg" pfName="Aspose.Cells" downloadUrl="https://downloads.aspose.com/cells" tryOnlineUrl="" >}}
...
Ciblez .NET Framework, .NET Core et plateforme Xamarin pour développer des applications pour Windows, iOS, macOS et Android.
...
Créez, lisez, modifiez, convertissez ou restituez des formats de feuilles de calcul Excel à partir des applications C++.
{{< /blocks/products/pf/product >}}
...
Ajoutez des capacités de manipulation de feuilles de calcul Excel dans vos applications mobiles Android.
{{< /blocks/products/pf/product >}}
...
Convertissez et combinez des feuilles de calcul Excel dans SharePoint Services ou SharePoint Server.
{{< /blocks/products/pf/product >}}
...
Exportez les rapports RDL et RDLC aux formats de fichier Excel à partir de SQL Server Reporting Services.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="JasperRapports" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-jasperreports.svg" productLink="/cells/jasperreports/" >}}
Exportez les rapports aux formats de fichiers Excel et PDF depuis JasperReports ou JasperServer.
{{< /blocks/products/pf/product >}}
...
Créez, manipulez, convertissez et restituez des feuilles de calcul Excel via Node.js.
{{< /blocks/products/pf/product >}}
...
Créez, manipulez, convertissez et restituez des feuilles de calcul Excel dans des applications PHP via JavaBridge.
{{< /blocks/products/pf/product >}}
...
Chargez, créez, manipulez et restituez des documents Excel à l'aide du Python.
{{< /blocks/products/pf/product >}}
