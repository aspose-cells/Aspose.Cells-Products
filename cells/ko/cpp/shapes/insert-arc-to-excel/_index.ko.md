...
weight: 10
description: C++ Windows 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경의 Excel 파일에 Arc를 삽입하는 예제 코드입니다.
...
+ 색인을 통해 워크시트를 선택합니다.
 +[메소드 추가](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addarc/) 선택한 워크시트에 방정식 모양을 삽입하려면
...
{{% blocks/products/pf/agp/code-block title="호 삽입 - C++" offSpacer="" %}}
