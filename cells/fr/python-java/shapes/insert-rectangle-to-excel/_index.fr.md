...
{{% blocks/products/pf/agp/content h2="Comment insérer un rectangle dans un fichier Excel à l\'aide de Python via Java" %}}

 Afin d'insérer un rectangle dans un fichier Excel, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer un rectangle dans un fichier Excel en utilisant Python via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRectangle(int,%20int,%20int,%20int,%20int,%20int)) pour insérer un rectangle dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer un rectangle - Python via Java" offSpacer="" %}}
