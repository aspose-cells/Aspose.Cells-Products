---
title: Converti XLTM in XPS tramite Python
url: /it/python-java/conversion/xltm-to-xps/
description: Codice di esempio per la conversione da xltm a xps Python. Usa API codice di esempio per la conversione batch di file xltm in xps all'interno dell'applicazione Python.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire XLTM in XPS utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire XLTM in XPS tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python gli sviluppatori possono caricare e convertire facilmente file XLTM in XPS in poche righe di codice.
