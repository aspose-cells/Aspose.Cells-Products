---
title: Crea FODS - Crea file FODS in Java
...
{{% blocks/products/pf/agp/content h2="Come creare FODS in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare il file FODS in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria Java per creare il file FODS" %}}
{{% blocks/products/pf/agp/text %}}
