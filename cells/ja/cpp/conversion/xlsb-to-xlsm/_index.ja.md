---
title: C++アプリケーションを介してXLSBをXLSMに変換する 
weight: 2360
url: /ja/cpp/conversion/xlsb-to-xlsm/ 
description: XLSBドキュメントからXLSM形式へのサンプルC++変換コード。プログラマーは、このソースコードを使用して、任意のC++アプリケーション内でXLSBからXLSMへのバッチ変換を行うことができます。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++を介してXLSBをXLSMに変換します" h2="Microsoft Excel、OpenOffice、またはAdobeAcrobatをインストールせずにC++ライブラリを使用した高性能XLSBからXLSMへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++開発者は、わずか数行のコードでXLSBファイルをXLSMに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbookを使用してXLSBファイルをロードします。1. Save（）メソッドを呼び出します。1. （XLSM）ファイル拡張子を持つ出力ファイルパスを渡します。1. XLSMファイルは指定されたパスに保存されます。1. 互換性のあるプログラムでXLSMファイルを開きます。
...
{{% blocks/products/pf/agp/code-block title="XLSBからXLSMC++への変換ソースコード" offSpacer="" %}}
