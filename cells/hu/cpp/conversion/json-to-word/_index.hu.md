...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztők könnyedén konvertálhatják a JSON-et WORD-ra, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a JSON fájlt a Factory::CreateIWorkbook segítségével.
1. Konvertálja a JSON-et WORD-ra a Save() metódus meghívásával.
