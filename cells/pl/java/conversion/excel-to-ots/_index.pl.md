...
description: Aspose Excel. Konwertuj EXCEL na OTS szybko i łatwo za pomocą Aspose.Cells. Java EXCEL na OTS. Java Zapisz EXCEL w OTS. Zapisz EXCEL jako OTS, używając numeru Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL w OTS pod numerem Java" %}}

Poniższy przykład pokazuje, jak przekonwertować program EXCEL na OTS w Java.
...
Chcesz programowo przekonwertować pliki EXCEL na OTS? Programiści Java mogą łatwo przekonwertować EXCEL na OTS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji EXCEL-a na OTS" %}}
{{% blocks/products/pf/agp/text %}}
