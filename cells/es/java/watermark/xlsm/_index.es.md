---
title:  Marca de agua XLSM documento via Java
weight: 7680
description: Java código de muestra para agregar o quitar marca de agua al archivo XLSM en Java Entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Agregar marca de agua de texto a XLSM via Java" h2="Cree sus propias aplicaciones Java para marcar con agua los archivos XLSM utilizando las API del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cómo poner una marca de agua en el archivo XLSM usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar marca de agua a XLSM via Java" %}}
