...
weight: 7690
description: C# 生成带有数据透视图的 XLSX 文档的示例代码。使用此代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中创建带有数据透视表的 Micorsoft Excel XLSX 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 在 XLSX 文档中插入数据透视图" h2="本机和高性能 Microsoft Excel XLSX 使用服务器端 API 以编程方式创建数据透视图的电子表格 .NET。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
在运行的应用程序中动态生成带有数据透视图的 MS Excel XLSX 文件很容易。为了在不需要 MS Office 的情况下从头开始使用数据透视图创建 XLSX 文档，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过C#在XLSX中插入数据透视图" %}}

{{% blocks/products/pf/agp/text %}}

开发人员可以很容易地在运行不同报告应用程序的 XLSX 格式电子表格中插入数据透视图，只需几行代码即可进行数据处理。
