---
title: XLS to XLSM - Convert XLS to XLSM files Java
description: Aspose Excel. Free Online Convert XLS to XLSM saveformat. Java XLS to XLSM format. Save XLS as XLSM in Java.
keywords: [Aspose Excel., Java Aspose.Cells., Java XLS to XLSM saveformat., Free Online XLS to XLSM Converter]
---
...
{{% blocks/products/pf/agp/content h2="Save XLS to XLSM in Java Online for Free" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert XLS to XLSM Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlsm" IsLandingPage="true" language="java" %}}
