---
title:  Fusionner MHT avec XLSX via Python
url: /fr/python-java/merger/merge-mht-to-xlsx/ 
description: Fusionnez MHT avec XLSX en ligne gratuitement. MHT en ligne gratuit à XLSX Fusion. Fusionnez MHT avec Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner MHT avec XLSX dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner MHT avec XLSX en ligne" InputFormat="mht" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
