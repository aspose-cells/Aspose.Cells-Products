---
title: Créer WORD - Créer un fichier WORD dans C++
description: Aspose Excel. C++ Créer un fichier WORD. Créer WORD C++. C++ WORD Creator. Créez WORD en C++. Générez un fichier WORD en utilisant C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier WORD en C++" h2="Création de fichiers WORD natifs et hautes performances par programmation sans Micorsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer WORD en C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers WORD dans des applications de reporting en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
1. Enregistrez le classeur en tant que fichier .docx à l'aide de la méthode Save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier WORD dans C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour créer un fichier WORD" %}}
