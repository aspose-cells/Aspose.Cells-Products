---
title:  Masukkan Bintang/Banner ke dalam Excel via .NET
weight: 381
description: Kode sumber C# untuk menyisipkan Bintang/Banner ke dalam Excel pada Kerangka Kerja .NET, Inti .NET, Mono atau Platform Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan Bintang/Banner ke dalam Excel via .NET" h2="Sisipkan Bintang/Banner menggunakan Aspose.Cells\' API tanpa software seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan Bintang/Banner ke file Excel melalui C#" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[menambahkan metode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) untuk menyisipkan Bintang/Banner di lembar kerja yang dipilih
...
{{% blocks/products/pf/agp/code-block title="Sisipkan Bintang/Banner - C#" offSpacer="" %}}
