---
title:  أدخل RadioButton (التحكم في النموذج) في Excel باستخدام Python via .Net
weight: 60
description: Python via. صافي كود المصدر لإدراج RadioButton (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج زر الراديو (التحكم في النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج RadioButton (التحكم في النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) لإدراج زر راديو (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل زر الراديو (التحكم في النموذج) - Python via .Net" offSpacer="" %}}
