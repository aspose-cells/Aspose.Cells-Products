...
{{% cells-convert title="Kostenlose App und Beispielcode zum Online-Konvertieren von NUMBERS in TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie ZAHLEN in TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können NUMBERS in nur wenigen Codezeilen problemlos in TSV konvertieren.
