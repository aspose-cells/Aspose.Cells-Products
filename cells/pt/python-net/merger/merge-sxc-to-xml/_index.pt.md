...
description: Aspose Excel. Python Aspose.Cells. Mesclar SXC para formato de salvamento XML. Python Combine SXC para o formato XML. Mesclar SXC para XML em Python. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC em XML usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC para XML em Python" %}}

O exemplo a seguir demonstra como mesclar SXC com XML em Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar SXC em XML. Faça upload de seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os em um arquivo XML. Se você desenvolver código em Python, será mais simples do que parece. Consulte o exemplo Python que mescla SXC com XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemplo de código para mesclar SXC com XML em Python" InputFormat="sxc" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC em XML via Python" %}}
