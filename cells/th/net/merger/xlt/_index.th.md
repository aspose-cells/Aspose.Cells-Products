...
+ โหลดไฟล์ XLT ทั้งหมดด้วยพาธแบบเต็ม
...
+ ตอนนี้คุณสามารถเปิดและใช้ไฟล์ XLT ใน Microsoft Office, Adobe PDF หรือโปรแกรมอื่นที่เข้ากันได้
