...
url: /hu/net/merger/merge-xltx-to-jpg/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a XLTX-et JPG-vel a Aspose.Cells for .NET-ben.
...
Programozottan egyesítenie kell a XLTX-et JPG-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLTX JPG formátumba egyesítéséhez" %}}
