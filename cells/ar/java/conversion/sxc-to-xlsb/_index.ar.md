---
title: تحويل SXC إلى XLSB عبر Java 
url: /ar/java/conversion/sxc-to-xlsb/ 
description: نموذج Java رمز تحويل لتنسيق SXC إلى ملف XLSB. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى XLSB داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل SXC إلى XLSB عبر Java" h2="تحويل SXC إلى XLSB Java لتحويل صفحة واحدة أو صفحات متعددة إلى XLSB باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل SXC إلى XLSB باستخدام Java" %}}

 من أجل تقديم SXC إلى XLSB ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل SXC إلى XLSB عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج Java بسهولة تحويل ملف SXC إلى XLSB في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف SXC مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XLSB & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XLSB الناتج
...
{{% blocks/products/pf/agp/code-block title="SXC إلى XLSB Java شفرة مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل SXC إلى XLSB" sectionDescription="[تحويل SXC إلى XLSB](https://products.aspose.app/cells/conversion/sxc-to-xlsb) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف SXC الخاص بك ، وسيتم تحويله على الفور إلى XLSB." >}}
