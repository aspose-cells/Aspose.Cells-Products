...
description: Aspose اكسل. تحويل ODS إلى TSV بسرعة وسهولة مع Aspose.Cells. Python ODS إلى TSV. Python احفظ ODS إلى TSV. احفظ ODS كـ 07611134 81 باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="تحويل ODS إلى TSV في Python" %}}
...
{{% blocks/products/pf/agp/content h2="حفظ ODS إلى TSV في Python" %}}

يوضح المثال التالي كيفية تحويل ODS إلى TSV في Python via NET.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل ODS إلى TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="tsv" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل ODS إلى TSV" %}}
