...
description: Aspose Exceller. C++ Créez un fichier TXT rapidement et facilement avec Aspose.Cells. Générez un fichier TXT à l'aide de C++. Créez TXT dans C++. C++ TXT Creater.
...
1.  Enregistrez le classeur en tant que fichier .txt à l'aide de la méthode Save().
