---
title: Python JPG na MD - konwerter JPG na MD
description: Aspose Excel. Konwertuj JPG na MD szybko i łatwo za pomocą Aspose.Cells. Python JPG na MD. Python Zapisz JPG na MD. Zapisz JPG jako MD, używając numeru Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz JPG na MD pod numerem Python" %}}

Poniższy przykład pokazuje, jak przekonwertować JPG na MD w Python.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować JPG na MD. Prześlij plik JPG, a następnie po prostu zapisz go jako plik MD. Zarówno do odczytu JPG, jak i zapisu na MD można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie MD będą identyczne z oryginalnym dokumentem JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji JPG na MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="md" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować JPG na MD poprzez Python" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki JPG na MD? Programiści Python mogą łatwo załadować i przekonwertować JPG na MD w zaledwie kilku linijkach kodu.
...
1.  Uzyskaj wynik konwersji JPG na MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji JPG na MD" %}}
