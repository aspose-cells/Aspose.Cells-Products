---
title:  Zobrazit MHTML Formáty souborů via .NET
description: C# zdrojový kód pro načtení, vykreslení a zobrazení dokumentů MHTML na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="MHTML Prohlížeč souborů for .NET" h2="Prohlížejte si tabulky Excelu a OpenOffice, jako je MHTML, aniž byste potřebovali Microsoft Excel nebo Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k zobrazení MHTML přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells umožňuje vývojářům snadno zobrazit soubor MHTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor MHTML v instanci sešitu
1. Vytvořte instanci HtmlSaveOptions a nastavte vlastnost ExportHeadings na true
1. Uložte soubor MHTML ve formátu HTML pomocí metody Workbook.Save
...
{{% blocks/products/pf/agp/code-block title="C# příklad kódu pro zobrazení souboru MHTML" offSpacer="" %}}
...
Aspose.Cells API lze použít k vytváření, úpravám, převodu a vykreslování Microsoft formátů Excelu do různých formátů. Kromě toho jej lze použít pro komplexní vytváření grafů, škálovatelný reporting a spolehlivé výpočty v rámci softwarových aplikací. Aspose.Cells je samostatný API a nevyžaduje žádný software jako Microsoft nebo OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace k zobrazení MHTML" sectionDescription=" Podívejte se na naše živé ukázky[Zobrazit MHTML](https://products.aspose.app/cells/viewer/mhtml) s následujícími výhodami." >}}
