---
title: إنشاء SPREADSHEETML - قم بإنشاء ملف SPREADSHEETML في Java
description:  Aspose اكسل. Java قم بإنشاء ملف SPREADSHEETML بسرعة وسهولة باستخدام Aspose.Cells. قم بإنشاء ملف SPREADSHEETML باستخدام Java. قم بإنشاء SPREADSHEETML في Java. Java منشئ SPREADSHEETML.
...
{{< blocks/products/pf/i18n/upper-banner h1="قم بإنشاء ملف SPREADSHEETML في Java" h2="مكتبة Java عالية السرعة لإنشاء ملف SPREADSHEETML. هذا حل برمجي احترافي لاستيراد وتصدير XLSX وPDF والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء جدول بيانات في Java" %}}
...
1.  احفظ المصنف بتنسيق SPREADSHEETML باستخدام أسلوب save().

{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف SPREADSHEETML في Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لإنشاء ملف SPREADSHEETML" %}}
{{% blocks/products/pf/agp/text %}}
