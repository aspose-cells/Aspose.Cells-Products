...
{{% cells-convert title="Free App and Sample Code to Convert PRN to ODS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert PRN to ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert PRN files to ODS programmatically? .NET developers can easily load & convert PRN to ODS in just a few lines of code.
...
1.  Convert PRN to ODS by calling Workbook.Save method.
