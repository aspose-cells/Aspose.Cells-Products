---
title:  قم بإدراج ComboBox (التحكم في النموذج) في Excel باستخدام Python via java
weight: 20
description: Python via كود مصدر جافا لإدراج ComboBox (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج ComboBox (التحكم في النموذج) في ملف Excel باستخدام جافا Python via" %}}

 من أجل إدراج ComboBox (التحكم في النموذج) في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج ComboBox (عنصر تحكم النموذج) في ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)) لإدراج ComboBox (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل ComboBox (التحكم في النموذج) - Python via java" offSpacer="" %}}
