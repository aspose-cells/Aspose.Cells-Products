---
title:  دمج الأرقام في MHT via Java
...
يوضح المثال التالي كيفية دمج الأرقام في MHT في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج الأرقام في MHT عبر الإنترنت" InputFormat="numbers" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
