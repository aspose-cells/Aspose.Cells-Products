---
title:  Sloučit XLSM na XLS přes Python
...
Následující příklad ukazuje, jak sloučit XLSM až XLS v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až XLS online" InputFormat="xlsm" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
