...
url: /cs/cpp/merger/merge-xltx-to-xps/ 
...
Následující příklad ukazuje, jak sloučit XLTX až XPS v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX až XPS v C++" InputFormat="xltx" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLTX na XPS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLTX až XPS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení XLTX až XPS" %}}
