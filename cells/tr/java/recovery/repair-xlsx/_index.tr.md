---
title: Java Onarım xlsx - Bozuk xlsx Dosyasını Kurtarın ve Onarın
url: /tr/java/recovery/repair-xlsx/ 
description: Java Aspose.Cells. XLSX'i onarın. Xlsx dosyasını düzeltin. xlsx kurtarma aracı. xlsx bozulması. Xlsx verilerini geri yükleyin. xlsx dosya kurtarma. Bozuk xlsx dosyasını kurtarın.
...
{{% blocks/products/pf/agp/content h2="Java\'deki xlsx dosyası nasıl onarılır" %}}
...
{{% cells-recovery title="XLSX dosyasını onarmak için örnek kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="java" %}}    
