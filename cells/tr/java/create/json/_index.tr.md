...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde JSON Dosyası oluşturun. Java'i kullanarak JSON dosyası oluşturun. Java'de JSON oluşturun. Java JSON Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını JSON biçiminde kaydedin.
