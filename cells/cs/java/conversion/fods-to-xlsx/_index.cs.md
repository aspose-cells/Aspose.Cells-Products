---
title: Převést FODS na XLSX přes Java 
url: /cs/java/conversion/fods-to-xlsx/ 
description: Ukázkový konverzní kód Java pro formát FODS na soubor XLSX. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLSX v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést FODS na XLSX přes Java" h2="Převod FODS na XLSX Java pro převod jedné nebo více stránek na XLSX pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést FODS na XLSX pomocí Java" %}}

 K vykreslení FODS do XLSX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu FODS na XLSX prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor FODS na XLSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor FODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLSX a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLSX
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze FODS na XLSX Java" offSpacer="" %}}

```cs
// načtěte soubor FODS do instance Workbooku
Workbook book = new Workbook("template.fods");
// uložit FODS jako XLSX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze FODS na XLSX" sectionDescription="[Převést FODS na XLSX](https://products.aspose.app/cells/conversion/fods-to-xlsx) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor FODS, bude okamžitě převeden na XLSX." >}}
