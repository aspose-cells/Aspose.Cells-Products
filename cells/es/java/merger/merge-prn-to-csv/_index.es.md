---
title: Combinar PRN con CSV - Combinar PRN con CSV en Java
url: /es/java/merger/merge-prn-to-csv/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea PRN a CSV guardar formato. Java Combina PRN con formato CSV. Combinar PRN a CSV en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN a CSV en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar PRN con CSV en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar PRN con CSV. Cargue sus archivos, llame al método Workbook.Combine para combinar archivos y luego guárdelo en el archivo CSV. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona PRN con CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar PRN a CSV en Java" InputFormat="prn" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN a CSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar PRN con CSV mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar PRN a CSV" %}}
