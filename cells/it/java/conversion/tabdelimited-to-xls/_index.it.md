---
title: Converti TABDELIMITED in XLS tramite Java 

description: Esempio di codice di conversione Java per il formato TABDELIMITED in file XLS. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in XLS all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti TABDELIMITED in XLS tramite Java" h2="Conversione da TABDELIMITED a XLS Java per convertire pagine singole o multiple in XLS utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire TABDELIMITED in XLS usando Java" %}}

 Per rendere TABDELIMITED in XLS, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TABDELIMITED in XLS tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente il file TABDELIMITED in XLS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TABDELIMITED con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione XLS e SaveFormat come parametri1. Controllare il percorso specificato per il file XLS risultante
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED a XLS Java codice sorgente di conversione" offSpacer="" %}}

```cs
// caricare il file TABDELIMITED in un'istanza di Workbook
Workbook book = new Workbook("template.tabdelimited");
// salva TABDELIMITED come XLS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da TABDELIMITED a XLS" sectionDescription="[Converti TABDELIMITED in XLS](https://products.aspose.app/cells/conversion/tabdelimited-to-xls) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file TABDELIMITED, verrà convertito istantaneamente in XLS." >}}
