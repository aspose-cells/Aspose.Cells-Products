---
title: Gabungkan XLT menjadi PDF - Gabungkan XLT menjadi PDF menjadi Java
url: /id/java/merger/merge-xlt-to-pdf/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLT menjadi PDF format simpan. Java Gabungkan format XLT menjadi PDF. Gabungkan XLT menjadi PDF di Java. XLT Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLT menjadi PDF di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLT menjadi PDF di Aspose.Cells for Java.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLT menjadi PDF di Java" InputFormat="xlt" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLT menjadi PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLT ke PDF secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan XLT menjadi PDF" %}}
