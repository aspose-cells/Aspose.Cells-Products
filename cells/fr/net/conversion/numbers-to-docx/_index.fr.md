...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros DOCX dans C#" %}}

L'exemple suivant montre comment convertir les NOMBRES de DOCX en C#.
...
1.  Convertissez les NUMÉROS en DOCX en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en DOCX" %}}
