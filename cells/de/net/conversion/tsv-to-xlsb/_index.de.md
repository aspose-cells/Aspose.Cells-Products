---
title: C# TSV zu XLSB - Online-Konverter von TSV zu XLSB
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie TSV in das Speicherformat XLSB. C# TSV bis XLSB Format. Speichern Sie TSV bis XLSB C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie TSV bis XLSB in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie TSV in XLSB in C# konvertiert wird.
...
Müssen Sie TSV-Dateien programmgesteuert in XLSB konvertieren? .NET-Entwickler können TSV problemlos in nur wenigen Codezeilen laden und in XLSB konvertieren.
...
1.  Konvertieren Sie TSV in XLSB, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von TSV in XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von TSV in XLSB" %}}
