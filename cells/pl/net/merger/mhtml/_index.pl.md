...
{{% blocks/products/pf/agp/feature-section-col title="Kroki łączenia plików MHTML w C#" %}}
...
+ Wywołaj metodę Save() i podaj nazwę pliku (pełna ścieżka) i format (MHTML) jako parametr.
+ Teraz możesz otworzyć i używać pliku MHTML w Microsoft Office, Adobe PDF lub dowolnym innym kompatybilnym programie.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online MHTML Pokazy fuzji na żywo" sectionDescription=" Połącz dokumenty MHTML już teraz, odwiedzając naszą stronę[Witryna internetowa z prezentacjami na żywo](https://products.aspose.app/cells/merger). Demo na żywo ma następujące zalety" >}}
