...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na MHTML za pomocą Aspose.Cells. Java MHT na MHTML. Java Zapisz MHT na MHTML. Zapisz MHT jako MHTML, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem MHTML w Java" %}}

Poniższy przykład ilustruje sposób konwersji MHT na MHTML w Java.
...
Chcesz programowo przekonwertować pliki MHT na MHTML? Programiści Java mogą łatwo przekonwertować MHT na MHTML w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji MHT na MHTML" %}}
{{% blocks/products/pf/agp/text %}}
