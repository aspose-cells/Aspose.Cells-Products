---
title: تحويل TXT إلى GIF عبر تطبيق C++ 

description: نموذج C++ رمز التحويل لمستند TXT إلى تنسيق GIF. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل دفعة TXT إلى GIF داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TXT إلى GIF عبر C++" h2="تحويل TXT إلى GIF عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TXT إلى GIF باستخدام C++" %}}
 ...
 من أجل تحويل TXT إلى GIF ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوّري برامج C++ بسهولة تحويل ملف TXT إلى GIF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف TXT باستخدام Factory :: CreateIWorkbook.1. حدد ورقة العمل الأولى.1. اضبط خيارات (GIF).1. كرر خلال كل صفحة من الورقة وعرضها.1. افتح ملف GIF في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="TXT إلى GIF C++ رمز مصدر التحويل" offSpacer="" %}}
