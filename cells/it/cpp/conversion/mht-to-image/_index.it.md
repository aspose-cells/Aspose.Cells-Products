...
Hai bisogno di convertire i file MHT in IMAGE tramite codice? Gli sviluppatori C++ possono convertire facilmente i file MHT in IMAGE in poche righe di codice.
...
1.  Convertire MHT in IMAGE chiamando il metodo Save().
