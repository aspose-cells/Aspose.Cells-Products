---
title: تحويل SPREADSHEETML إلى TXT عبر Java 
url: /ar/java/conversion/spreadsheetml-to-txt/ 
description: نموذج رمز تحويل Java لتنسيق SPREADSHEETML إلى ملف TXT. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى TXT داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل SPREADSHEETML إلى TXT عبر Java" h2="تحويل SPREADSHEETML إلى TXT Java لتحويل صفحة واحدة أو صفحات متعددة إلى TXT باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل SPREADSHEETML إلى TXT باستخدام Java" %}}

 من أجل تقديم SPREADSHEETML إلى TXT ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل SPREADSHEETML إلى TXT عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج Java تحويل ملف SPREADSHEETML بسهولة إلى ملف TXT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف SPREADSHEETML بنسخة من فئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد TXT و SaveFormat كمعلمات1. تحقق من المسار المحدد لملف TXT الناتج
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML إلى TXT Java شفرة مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف SPREADSHEETML في مثيل مصنف
Workbook book = new Workbook("template.spreadsheetml");
// احفظ SPREADSHEETML بتنسيق TXT
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML إلى عروض توضيحية مباشرة لتحويل TXT" sectionDescription="[تحويل SPREADSHEETML إلى TXT](https://products.aspose.app/cells/conversion/spreadsheetml-to-txt) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف SPREADSHEETML الخاص بك ، وسيتم تحويله على الفور إلى TXT." >}}
