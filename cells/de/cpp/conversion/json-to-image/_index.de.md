...
Müssen Sie JSON-Dateien programmgesteuert in IMAGE konvertieren? C++-Entwickler können JSON in nur wenigen Codezeilen problemlos in IMAGE konvertieren.
...
1.  Konvertieren Sie JSON in IMAGE, indem Sie die Save()-Methode aufrufen.
