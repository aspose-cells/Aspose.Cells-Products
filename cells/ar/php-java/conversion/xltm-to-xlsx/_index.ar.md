---
title: PHP XLTM إلى XLSX - XLTM إلى XLSX محول
description: Aspose اكسل. قم بتحويل XLTM إلى XLSX بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى XLSX. PHP احفظ XLTM إلى XLSX. احفظ XLTM كـ XLSX باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى XLSX عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى XLSX برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى XLSX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى XLSX عن طريق استدعاء طريقة حفظ المصنف.
