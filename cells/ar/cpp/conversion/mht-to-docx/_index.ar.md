...
description: Aspose اكسل. قم بتحويل MHT إلى DOCX بسرعة وسهولة باستخدام Aspose.Cells. C++ MHT إلى DOCX. C++ احفظ MHT إلى DOCX. احفظ MHT كـ DOCX باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على DOCX في C++" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="docx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى DOCX عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى DOCX برمجياً؟ يمكن لمطوري C++ تحويل MHT بسهولة إلى DOCX في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى DOCX عن طريق استدعاء طريقة Save ().
