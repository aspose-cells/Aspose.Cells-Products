---
title: 通過 C++ 解鎖 ODS 文檔 
weight: 1190
url: /zh-hant/cpp/unlock/ods/ 
description: C++ 示例代碼，用於在 Windows 32 位、Windows 64 位和 Linux 64 位的 C++ 運行時環境中解鎖密碼保護的 ODS 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 解鎖 ODS 文件" h2="使用 C++ 庫從 Excel 電子表格（包括 ODS 文件）中刪除保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1. 使用 CreateIWorkbook 加載 ODS 鎖定文件。1. 調用 Unprotect() 函數解鎖。1. 使用 SetPassword 將密碼設置為 NULL。1. 將 ODS 文件保存在指定位置。
