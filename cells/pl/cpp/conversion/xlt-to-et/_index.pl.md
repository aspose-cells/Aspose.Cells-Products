...
Trzeba programowo przekonwertować pliki XLT do formatu ET? Programiści C++ mogą łatwo przekonwertować pliki XLT do formatu ET za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLT na ET wywołując metodę Save().
