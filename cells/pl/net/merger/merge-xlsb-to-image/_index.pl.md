---
title: Połącz XLSB z IMAGE - Połącz XLSB z IMAGE w C#
url: /pl/net/merger/merge-xlsb-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLSB do formatu zapisu IMAGE. C# Połącz XLSB z formatem IMAGE. Połącz XLSB z IMAGE w C#. XLSB Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLSB z IMAGE w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLSB z IMAGE w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić XLSB z IMAGE. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku IMAGE. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy XLSB z IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLSB z IMAGE w C#" InputFormat="xlsb" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSB z IMAGE przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić XLSB z IMAGE? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLSB z IMAGE" %}}
