---
title: Python XLS ～ XLSB - XLS ～ XLSB コンバータ
description: Aspose エクセル。 XLS を Aspose.Cells ですばやく簡単に XLSB に変換します。 Python XLS から XLSB に変換します。 Python XLS を XLSB に保存します。 XLS を 07611134 として保存しますPythonを使用して81。
