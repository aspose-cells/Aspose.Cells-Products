...
url: /sv/net/merger/merge-xlsm-to-tiff/ 
...
Följande exempel visar hur man slår samman XLSM till TIFF i Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Behöver du slå samman XLSM till TIFF programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XLSM till TIFF" %}}
