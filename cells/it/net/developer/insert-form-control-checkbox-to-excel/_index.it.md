---
title:  Inserisci CheckBox (controllo modulo) in Excel via .NET
weight: 30
description: C# codice sorgente per inserire CheckBox(controllo modulo) in Excel su .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Come inserire CheckBox (controllo modulo) nel file Excel utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire CheckBox (controllo modulo) nel file Excel tramite C#" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) per inserire un CheckBox(Controllo modulo) nel foglio di lavoro selezionato
...
{{% blocks/products/pf/agp/code-block title="Inserisci CheckBox(Controllo modulo) - C#" offSpacer="" %}}
