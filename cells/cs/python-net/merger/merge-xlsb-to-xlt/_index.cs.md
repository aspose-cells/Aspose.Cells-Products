---
title:  Sloučit XLSB na XLT přes Python
...
Následující příklad ukazuje, jak sloučit XLSB až XLT v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSB až XLT online" InputFormat="xlsb" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
