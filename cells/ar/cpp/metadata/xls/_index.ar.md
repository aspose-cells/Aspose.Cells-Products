...
{{% blocks/products/pf/agp/content h2="كيفية الحصول على XLS البيانات الوصفية باستخدام C++" %}}
...
+ قم بتحميل ملف XLS باستخدام CreateIWorkbookMetadata
