---
title: Converteer JSON naar XLSB via C++ applicatie 
url: /nl/cpp/conversion/json-to-xlsb/ 
description: Voorbeeld C++-conversiecode voor JSON-document naar XLSB-indeling. Programmeurs kunnen deze broncode gebruiken voor batch-conversie van JSON naar XLSB binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer JSON naar XLSB via C++" h2="Hoogwaardige JSON-naar-XLSB-conversie met behulp van de C++-bibliotheek zonder dat Microsoft Excel, OpenOffice of Adobe Acrobat hoeft te worden geïnstalleerd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen JSON-bestanden gemakkelijk converteren naar XLSB in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het JSON-bestand met Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (XLSB) bestandsextensie.1. XLSB-bestand wordt opgeslagen op het opgegeven pad.1. Open het XLSB-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="JSON naar XLSB C++ conversiebroncode" offSpacer="" %}}
