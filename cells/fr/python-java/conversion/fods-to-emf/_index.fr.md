...
description: Aspose Exceller. Convertissez FODS en EMF rapidement et facilement avec Aspose.Cells. Python FODS en EMF. Python Enregistrez FODS en EMF. Enregistrez FODS sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le FODS au EMF au Python" %}}

L'exemple suivant montre comment convertir FODS en EMF dans Python.
