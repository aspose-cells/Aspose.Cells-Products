---
title:  Hoe u de vorm van een elleboogpijl in Excel kunt tekenen of invoegen met behulp van Python via Java
weight: 10
description: Teken of voeg de vorm van de elleboogpijl in met behulp van Aspose.Cells' Python via Java API zonder software zoals Microsoft of Open Office, Adobe PDF, enz.
...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg de vorm van de elleboogpijl in Excel in met behulp van Python via Java" h2="Voeg de vorm van de elleboogpijl in met behulp van Aspose.Cells\' API zonder enige software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u de vorm van een elleboogpijl in een Excel-bestand kunt invoegen met behulp van Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om de vorm van de elleboogpijl in te voegen in een Excel-bestand met behulp van Python via Java" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de vormcollecties[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) om een elleboogpijlvorm in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Insteekelleboog pijlvorm - Python via Java" offSpacer="" %}}
