---
title: Połącz MHT z FODS - Połącz MHT z FODS w Java
url: /pl/java/merger/merge-mht-to-fods/ 
description: Aspose Excel. Java Aspose.Cells. Połącz MHT z formatem zapisu FODS. Java Połącz format MHT z formatem FODS. Połącz MHT z FODS w Java. Połącz MHT.
...
{{< blocks/products/pf/i18n/upper-banner h1="Połącz MHT z numerem FODS via Java" h2="Szybka biblioteka Java do łączenia MHT z FODS. Skorzystaj z naszej konwersji Excela API, aby opracować zaawansowane, niezależne od platformy oprogramowanie w Java. Jest to profesjonalne rozwiązanie do importowania i eksportowania Excel, CSV, OpenOffice, PDF, HTML, image i wielu innych formatów Excela." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="MHT" additionalConversionTag="FODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Połącz MHT z FODS w Java" %}}

Poniższy przykład pokazuje, jak połączyć MHT z FODS w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć MHT z numerem FODS. Prześlij pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku FODS. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy MHT z FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia MHT z FODS w Java" InputFormat="mht" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć MHT z numerem FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć MHT z FODS? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do połączenia MHT z FODS" %}}
