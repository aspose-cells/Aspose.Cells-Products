...
description: Aspose Excel. Chuyển đổi MHT sang TABDELIMITED nhanh chóng và dễ dàng với Aspose.Cells. PHP MHT sang TABDELIMITED. PHP Lưu MHT vào TABDELIMITED. Lưu MHT dưới dạng TABDELIMITED bằng PHP.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi MHT sang TABDELIMITED bằng PHP" %}}
 ...
 Làm cách nào để chuyển đổi MHT sang TABDELIMITED? Với thư viện Aspose.Cells for PHP via Java, bạn có thể dễ dàng chuyển đổi MHT sang TABDELIMITED theo chương trình chỉ với một vài dòng mã.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, hiển thị và in tất cả các tệp Excel. PHP Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó, nó trở thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Lưu MHT vào TABDELIMITED trong PHP" %}}

Ví dụ sau đây trình bày cách chuyển đổi MHT thành TABDELIMITED trong PHP.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi MHT sang TABDELIMITED qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tệp MHT thành TABDELIMITED theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi MHT sang TABDELIMITED chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi MHT thành TABDELIMITED bằng cách gọi phương thức lưu của Workbook.
