...
description: Aspose Excel. Convierta OTS a SVG rápida y fácilmente con Aspose.Cells. Python OTS a SVG. Python Guarde OTS en SVG. Guarde OTS como SVG usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar OTS al SVG en Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a SVG en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir OTS a SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="svg" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir OTS a SVG" %}}
