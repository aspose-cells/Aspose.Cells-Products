...
description: Aspose Excel. Converta XLS em MD de forma rápida e fácil com Aspose.Cells. C++ XLS em MD. C++ Salve XLS em MD. Salve XLS como MD usando C++.
...
{{% blocks/products/pf/agp/content h2="Salve XLS no MD em C++" %}}

O exemplo a seguir demonstra como converter XLS em MD em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="md" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS para MD via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para MD programaticamente? Os desenvolvedores do C++ podem facilmente converter XLS em MD em apenas algumas linhas de código.
...
1.  Converta XLS em MD chamando o método Save().
