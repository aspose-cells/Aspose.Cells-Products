---
title: Conversor PHP TSV para XPS - TSV para XPS
description: Aspose Excel. Converta TSV em XPS de forma rápida e fácil com Aspose.Cells. PHP TSV em XPS. PHP Salve TSV em XPS. Salve TSV como XPS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter TSV em XPS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em XPS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em XPS em apenas algumas linhas de código.
...
1.  Converta TSV em XPS chamando o método save da pasta de trabalho.
