---
title: 将 XLTM 合并至 TSV - 将 XLTM 和 TSV 合并为 Python
url: /zh/python-java/merger/merge-xltm-to-tsv/ 
description: Aspose Excel。Python Excel。将 XLTM 合并为 TSV 保存格式。Python 将 XLTM 合并为 TSV 格式。将 XLTM 合并为 TSV 并入 Python Excel 库中。XLTM 合并。
...
{{% cells-merger title="在 Python Excel 库中将 XLTM 合并到 TSV 的示例代码" InputFormat="xltm" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 Python Excel 库将 XLTM 合并到 TSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLTM 合并到 TSV 吗？合并和连接的基本文档[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Python 库将 XLTM 合并至 TSV" %}}
