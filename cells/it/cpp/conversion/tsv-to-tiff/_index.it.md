---
title: Converti TSV in TIFF tramite l'applicazione C++ 
weight: 5960

description: Esempio di codice di conversione C++ per un documento TSV in formato TIFF. I programmatori possono utilizzare questo codice sorgente per la conversione batch da TSV a TIFF all'interno di qualsiasi applicazione C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file TSV in TIFF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TSV usando Factory::CreateIWorkbook.1. Seleziona il primo foglio di lavoro.1. Imposta le opzioni (TIFF).1. Scorri ogni pagina del foglio e renderizza.1. Apri il file TIFF nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da TSV a TIFF C++" offSpacer="" %}}
