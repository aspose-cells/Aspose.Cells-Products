---
title: Gabungkan FODS menjadi XPS - Gabungkan FODS menjadi XPS menjadi Java
url: /id/java/merger/merge-fods-to-xps/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS menjadi XPS format simpan. Java Gabungkan format FODS menjadi XPS. Gabungkan FODS menjadi XPS di Java. FODS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS menjadi XPS di Java" %}}

Contoh berikut menunjukkan cara menggabungkan FODS menjadi XPS di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan FODS ke XPS. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file XPS. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan FODS menjadi XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan FODS menjadi XPS di Java" InputFormat="fods" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS menjadi XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke XPS secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan FODS menjadi XPS" %}}
