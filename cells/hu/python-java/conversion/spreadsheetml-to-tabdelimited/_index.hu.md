...
{{% blocks/products/pf/agp/content h2="A SPREADSHEETML konvertálása TABDELIMITED-re a Python használatával" %}}
...
A következő példa bemutatja, hogyan lehet a SPREADSHEETML fájlt TABDELIMITED-re konvertálni a Python-ben.
