...
{{< blocks/products/pf/i18n/upper-banner h1="Scal formaty XLT w C#" h2="Natywne i wysokowydajne łączenie dokumentów XLT przy użyciu interfejsów API Aspose.Cellsfor .NET po stronie serwera, bez użycia oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
+ Załaduj wszystkie pliki XLT z pełną ścieżką.
+ Utwórz jeden dokument jako plik podstawowy
+ Wywołaj odpowiednią metodę łączenia i scalania plików jeden po drugim.
+ Wywołaj metodę Save() i przekaż nazwę pliku (pełna ścieżka) i format (XLT) jako parametr.
+ Teraz możesz otwierać i używać pliku XLT w Microsoft Office, Adobe PDF lub dowolnym innym kompatybilnym programie.
