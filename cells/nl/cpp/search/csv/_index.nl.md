---
title: Zoek CSV-document zonder te openen via C++ 
weight: 5540
url: /nl/cpp/search/csv/ 
description: C++ voorbeeldcode om woorden met patroon te zoeken in CSV-bestand op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Zoek CSV-indelingen in C++" h2="Native en high-performance CSV-document zoeken met server-side Aspose.Cells voor C++ API\'s, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="CSV-bestand zoeken met C++" %}}
...
+ Laad CSV-bestand door een IWorkbook-klasse te instantiëren.
...
+ Bewaar CSV-bestand met behulp van IWorkbook->Save(.) methode.
...
{{% blocks/products/pf/agp/code-block title="Zoek in CSV-bestanden - C++" offSpacer="" %}}
