...
weight: 60
description: .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼에서 Excel에 RadioButton을 삽입하는 C# 소스 코드.
---
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 Excel 파일에 RadioButton을 삽입하는 방법" %}}
 ...
 RadioButton을 Excel 파일에 삽입하기 위해
...
+ 색인을 통해 워크시트를 선택합니다.
 + 사용[메소드 추가](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addradiobutton) 선택한 워크시트에 RadioButton을 삽입하려면
