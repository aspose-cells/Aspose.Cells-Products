...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na XLSB za pomocą Aspose.Cells. Java MHT na XLSB. Java Zapisz MHT na XLSB. Zapisz MHT jako XLSB, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem XLSB w Java" %}}

Poniższy przykład ilustruje sposób konwersji MHT na XLSB w Java.
...
Chcesz programowo przekonwertować pliki MHT na XLSB? Programiści Java mogą łatwo przekonwertować MHT na XLSB w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji MHT na XLSB" %}}
{{% blocks/products/pf/agp/text %}}
