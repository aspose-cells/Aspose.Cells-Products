---
title: C# JPG 到 TSV - JPG 到 TSV 转换器
description: Aspose Excel。 C# Aspose.Cells.JPG 到 C#.C# 中的 TSV 将 JPG 转换为 TSV 保存格式。 C# JPG 到 TSV 格式。将 JPG 保存到 TSV C#。
...
{{% blocks/products/pf/agp/content h2="将JPG保存到C#中的TSV" %}}
...
{{% cells-convert title="将 JPG 转换为 TSV 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="tsv" IsLandingPage="true" %}}
