...
url: /tr/net/merger/merge-json-to-ett/ 
...
Aşağıdaki örnek, JSON'in Aspose.Cells for .NET'deki ETT ile nasıl birleştirileceğini gösterir.
...
JSON'i ETT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kitaplığı, JSON\'i ETT ile birleştirecek" %}}
