...
{{% blocks/products/pf/agp/content h2="Sla OTS op in XLAM in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar XLAM converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar XLAM via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar XLAM? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar XLAM met slechts een paar regels code.
