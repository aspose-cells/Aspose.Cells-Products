---
title:  Sloučit XML na XLSX via Java
...
Následující příklad ukazuje, jak sloučit XML do XLSX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XML na XLSX online" InputFormat="xml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
