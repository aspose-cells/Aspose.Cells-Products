...
weight: 4820
url: /nl/cpp/metadata/xlsb/ 
description: C++ voorbeeldcode om metadata van XLSB-bestanden te bewerken of te bekijken op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
...
{{% blocks/products/pf/agp/content h2="XLSB-metadata ophalen met C++" %}}
...
+ Laad XLSB-bestand met CreateIWorkbookMetadata
...
{{% blocks/products/pf/agp/code-block title="Metadata van XLSB extraheren - C++" offSpacer="" %}}
