---
title: A XLS egyesítése a POWERPOINT-hoz – a XLS-es szám egyesítése a POWERPOINT-hez a Java-es helyen
url: /hu/java/merger/merge-xls-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. A XLS egyesítése POWERPOINT mentési formátumba. Java A XLS kombinálása POWERPOINT formátumba. A XLS egyesítése a Java-es POWERPOINT-tal. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A XLS egyesítése a Java-es POWERPOINT-tal" %}}

A következő példa bemutatja, hogyan egyesítheti a XLS-es számot a POWERPOINT-tal a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS és a POWERPOINT egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el POWERPOINT fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a XLS-et a POWERPOINT-tal.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a XLS egyesítéséhez a Java-es POWERPOINT-hoz" InputFormat="xls" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLS és a POWERPOINT via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a XLS és a POWERPOINT egyesítéséhez" %}}
