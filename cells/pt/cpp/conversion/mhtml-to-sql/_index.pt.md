---
title: C++ MHTML para SQL - MHTML para conversor SQL
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter MHTML para o formato SQL, permitindo o salvamento perfeito de dados MHTML no formato SQL usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salvar MHTML em SQL em C++" %}}

O exemplo a seguir demonstra como converter MHTML para SQL em C++.
...
{{% blocks/products/pf/agp/content h2="Como converter MHTML para SQL via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos MHTML para SQL programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos MHTML para SQL com apenas algumas linhas de código.
...
1.  Converta MHTML para SQL chamando o método Save().
1.  Obtenha o resultado da conversão de MHTML para SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter MHTML em SQL" %}}
