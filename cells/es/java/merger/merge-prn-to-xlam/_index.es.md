---
title: Combinar PRN con XLAM - Combinar PRN con XLAM en Java
url: /es/java/merger/merge-prn-to-xlam/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea PRN a XLAM guardar formato. Java Combina PRN con formato XLAM. Combinar PRN a XLAM en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN a XLAM en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar PRN con XLAM en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar PRN con XLAM. Cargue sus archivos, llame al método Workbook.Combine para combinar archivos y luego guárdelo en el archivo XLAM. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona PRN con XLAM.
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN a XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar PRN con XLAM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar PRN a XLAM" %}}
