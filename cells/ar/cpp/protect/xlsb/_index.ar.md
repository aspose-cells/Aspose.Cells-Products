...
weight: 4860
description: C++ رمز المثال لقفل ملف XLSB باستخدام كلمة المرور على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات حماية الملفات XLSB عبر C++" %}}
...
1.  احفظ الملف XLSB المحمي بطريقة Save()
