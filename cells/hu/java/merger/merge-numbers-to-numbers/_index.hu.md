---
title: NUMBERS egyesítése NUMBERS számmal – NUMBERS egyesítése NUMBERS számmal a Java-ben
url: /hu/java/merger/merge-numbers-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése NUMBERS NUMBERS mentési formátumba. Java Kombinálja a NUMBERS-t a NUMBERS-formátumba. NUMBERS egyesítése a NUMBERS számokkal a Java-ben. NUMBERS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a NUMBERS-t a NUMBERS-szel a Java-es online számon ingyen" %}}

A következő példa bemutatja, hogyan egyesítheti a NUMBERS számokat a NUMBERS számokkal a Aspose.Cells for Java számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a NUMBERS és a NUMBERS egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el NUMBERS fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely a NUMBERS-t a NUMBERS-be egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online NUMBERS és NUMBERS egyesítése a Java számon" InputFormat="numbers" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A NUMBERS egyesítése a NUMBERS via Java számmal" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a következőt: NUMBERS és NUMBERS? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a NUMBERS és a NUMBERS egyesítéséhez" %}}
