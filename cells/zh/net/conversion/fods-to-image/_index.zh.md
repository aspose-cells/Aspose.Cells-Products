...
{{% cells-convert title="将 FODS 转换为图像的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 FODS 转换为 IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 FODS 文件转换为 IMAGE 吗？.NET 开发人员只需几行代码即可轻松加载并将 FODS 转换为 IMAGE。
...
1. 向您的 C# 项目添加库引用（导入库）。
1. 使用工作簿实例加载 FODS 文件。
1. 调用 Workbook.Save 方法将 FODS 转换为 IMAGE。
1. 获取FODS至IMAGE的转换结果。
