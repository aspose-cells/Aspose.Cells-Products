---
title: XLAM naar XLTM - Converteer XLAM naar XLTM Python via Python
...
{{% blocks/products/pf/agp/content h2="Hoe XLAM te converteren naar XLTM via Python" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLAM-bestanden programmatisch converteren naar XLTM? Python-ontwikkelaars kunnen eenvoudig XLAM laden en converteren naar XLTM in slechts een paar regels code.
...
1.  Converteer XLAM naar XLTM door de methode Workbook.save aan te roepen.
