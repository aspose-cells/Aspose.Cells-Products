---
title: SXC을 XLS로 병합 - SXC을 C#에서 XLS로 결합
url: /ko/net/merger/merge-sxc-to-xls/ 
description: Aspose 엑셀. C# Aspose.Cells. 무료 온라인 병합 SXC에서 XLS 저장 형식으로. C# SXC을 XLS 형식으로 결합합니다. SXC을 C#에서 XLS로 병합합니다. SXC 병합합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 SXC을 XLS로 병합" h2="SXC을 XLS로 병합하기 위한 고속 C# 라이브러리. 당사의 Excel 변환 API을 사용하여 C#에서 높은 수준의 플랫폼 독립적인 소프트웨어를 개발합니다. 이것은 Excel, CSV, OpenOffice, PDF, HTML, image 및 기타 여러 Excel 형식을 가져오고 내보내는 전문 소프트웨어 솔루션입니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="SXC" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="SXC을 C# 온라인에서 XLS로 무료로 병합" %}}

다음 예는 SXC을 Aspose.Cells for .NET에서 XLS로 병합하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

간단한 단계에 따라 SXC을 XLS로 병합합니다. 파일을 업로드하고 파일 병합을 위해 Workbook.Combine 메서드를 호출한 다음 XLS 파일에 저장합니다. C#에서 코드를 개발하면 생각보다 간단합니다. SXC을 XLS로 병합하는 C# 예제를 참조하십시오.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#에서 SXC을 XLS로 병합하는 무료 온라인" InputFormat="sxc" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 SXC을 XLS로 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 프로그래밍 방식으로 SXC을 XLS에 병합해야 합니까? 병합 및 연결하는 기본 문서[Aspose.Cells for .NET](https://products.aspose.com/cells/net) 몇 줄의 코드만으로 API를 수행할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2=".NET 라이브러리는 SXC을 XLS에 병합합니다." %}}
