---
title: C++ PRN a JPEG - PRN a JPEG Convertitore
description: Aspose Excel. Converti il PRN in JPEG in modo rapido e semplice con Aspose.Cells. C++ PRN in JPEG. C++ Salva PRN in JPEG. Salva PRN come JPEG utilizzando C++.
...
{{% blocks/products/pf/agp/content h2="Salva il PRN allo JPEG in C++" %}}

L'esempio seguente mostra come convertire il PRN in JPEG in C++.
...
{{% blocks/products/pf/agp/content h2="Come convertire il PRN in JPEG tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file PRN in JPEG a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in JPEG in poche righe di codice.
...
1.  Converti PRN in JPEG chiamando il metodo Save().
1.  Ottieni il risultato della conversione da PRN a JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C++ per convertire il PRN in JPEG" %}}
