...
description: Aspose Excel. Python Aspose.Cells. NUMBERS samenvoegen naar het opslagformaat XLTX. Python Combineer NUMBERS tot het formaat XLTX. Voeg NUMBERS samen tot XLTX in Python. NUMBERS Samenvoegen.
...
{{% cells-merger title="Voorbeeldcode om NUMBERS samen te voegen tot XLTX in Python" InputFormat="numbers" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="NUMMERS samenvoegen naar XLTX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u NUMBERS programmatisch samenvoegen tot XLTX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
