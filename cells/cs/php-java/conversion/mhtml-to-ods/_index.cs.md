---
title: Konvertor PHP MHTML až ODS - MHTML až ODS
description: Aspose Excel. Převeďte MHTML na ODS rychle a snadno pomocí Aspose.Cells. PHP MHTML na ODS. PHP Uložte MHTML na ODS. Uložte ODS jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na ODS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na ODS programově? Vývojáři PHP mohou snadno načíst a převést MHTML na ODS v několika řádcích kódu.
...
1.  Převeďte MHTML na ODS voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na ODS" %}}
