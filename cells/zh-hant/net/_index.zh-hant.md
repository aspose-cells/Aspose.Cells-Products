...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="API 支持 .NET 框架、.NET Core 和 Xamarin 平台。此外，它可以通過 COM Interop 與 Mono 和其他幾個平台一起使用。" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
