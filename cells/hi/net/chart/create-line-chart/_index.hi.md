...
1. Aspose.Cells नाम स्थान शामिल करें1. सृजन करना [**कार्यपुस्तिका**](https://reference.aspose.com/cells/net/aspose.cells/workbook) वर्ग उदाहरण।1. वर्कशीट में कुछ डेटा जोड़ें।1. एक जोड़ें [**रेखा**](https://reference.aspose.com/cells/net/aspose.cells.charts/charttype) वर्कशीट के लिए चार्ट।1. नए तक पहुंचें [**चार्ट**](https://reference.aspose.com/cells/net/aspose.cells.charts/chart) वस्तु।1. चार्ट के डेटा स्रोत के साथ निर्दिष्ट करें [**चार्ट.सेटचार्टडाटारेंज**](https://https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/setchartdatarange) तरीका।
