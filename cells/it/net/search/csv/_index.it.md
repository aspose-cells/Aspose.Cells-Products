---
title:  Cerca il documento CSV senza aprire via .NET
weight: 7510
description: Codice sorgente C# per cercare parole con pattern nel file CSV su .NET Framework, .NET Core, Mono o piattaforme Xamarin.
...
+ Carica il file CSV utilizzando la classe Workbook.
