...
{{% blocks/products/pf/agp/content h2="How to Create JSON in PHP" %}}
...
1.  Save the workbook as JSON format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create JSON file in PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PHP library to create JSON file" %}}
