---
title: Mesclar MHT para XLSM - Combine MHT para XLSM em Java
url: /pt/java/merger/merge-mht-to-xlsm/ 
description: Aspose Excel. Java Aspose.Cells. Free Online Mesclar MHT para XLSM saveformat. Java Combine MHT para o formato XLSM. Mesclar MHT para XLSM em Java. Mesclar MHT.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHT para XLSM em Java online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar MHT para XLSM em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHT para XLSM. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo XLSM. Se você desenvolver o código em Java, isso será mais simples do que parece. Consulte o exemplo Java que mescla MHT com XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar MHT para XLSM em Java" InputFormat="mht" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHT para XLSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar MHT para XLSM programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHT com XLSM" %}}
