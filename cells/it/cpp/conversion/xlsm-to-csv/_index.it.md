---
title: Converti XLSM in CSV tramite l'applicazione C++ 
url: /it/cpp/conversion/xlsm-to-csv/ 
description: Esempio di codice di conversione C++ per un documento XLSM in formato CSV. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLSM a CSV all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file XLSM in CSV in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLSM usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (CSV).1. Il file CSV verrà salvato nel percorso specificato.1. Apri il file CSV in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLSM a CSV C++" offSpacer="" %}}
