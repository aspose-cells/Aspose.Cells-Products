...
description: Aspose Exceller. Python Aspose.Cells. Fusionner MHT avec le format de sauvegarde ET. Python Combinez le format MHT au format ET. Fusionner MHT avec ET dans Python. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec ET en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec ET dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner MHT avec ET dans Python" InputFormat="mht" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec ET via Python" %}}
