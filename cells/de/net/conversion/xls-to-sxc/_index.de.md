...
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das Format SXC und ermöglicht das nahtlose Speichern von XLS-Daten im Format SXC mithilfe der Aspose.Cells-Bibliothek – alles durch effizienten und anpassbaren C#-Code.
...
Das folgende Beispiel zeigt, wie man XLS in C# in SXC umwandelt.
...
Müssen Sie XLS-Dateien programmgesteuert in SXC konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in SXC laden und konvertieren.
...
1.  Konvertieren Sie XLS in SXC durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in SXC" %}}
