...
{{% cells-merger title="Δωρεάν εφαρμογή για τη συγχώνευση αρχείων Excel σε απευθείας σύνδεση" InputFormat="xltx" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
