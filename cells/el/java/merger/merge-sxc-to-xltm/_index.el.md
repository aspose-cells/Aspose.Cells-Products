---
title:  Συγχώνευση SXC σε XLTM via Java
url: /el/java/merger/merge-sxc-to-xltm/ 
description: Συγχώνευση SXC σε XLTM Online δωρεάν. Δωρεάν Online SXC έως XLTM Συγχώνευση. Συγχώνευση SXC σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SXC με το XLTM στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση SXC με XLTM σε απευθείας σύνδεση" InputFormat="sxc" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
