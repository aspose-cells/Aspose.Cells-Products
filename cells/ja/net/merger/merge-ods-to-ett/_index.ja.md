...
url: /ja/net/merger/merge-ods-to-ett/ 
...
次の例は、ODS を Aspose.Cells for .NET の ETT にマージする方法を示しています。
...
{{% cells-merger title="ODS を C# の ETT にマージするサンプルコード" InputFormat="ods" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C# を経由して ODS を ETT にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

ODS をプログラムで ETT にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="ODS を ETT にマージする .NET ライブラリ" %}}
