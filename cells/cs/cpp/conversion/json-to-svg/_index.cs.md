---
title: Převeďte JSON na SVG pomocí aplikace C++ 
url: /cs/cpp/conversion/json-to-svg/ 
description: Ukázkový konverzní kód C++ pro dokument JSON do formátu SVG. Programátoři mohou tento zdrojový kód použít pro dávkový převod JSON na SVG v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor JSON na SVG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor JSON pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavit (SVG) možnosti.1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor SVG v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu JSON na SVG C++" offSpacer="" %}}
