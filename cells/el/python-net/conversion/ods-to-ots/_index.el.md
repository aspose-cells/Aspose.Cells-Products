...
description: Aspose Excel. Μετατρέψτε το ODS σε OTS γρήγορα και εύκολα με το Aspose.Cells. Python ODS σε OTS. Python Αποθήκευση ODS στο OTS. Αποθηκεύστε το ODS ως OTS χρησιμοποιώντας το Python.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το ODS στο OTS στο Python" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή ODS σε OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="ots" IsLandingPage="true" language="pythonnet" %}}
