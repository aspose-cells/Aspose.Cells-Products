...
description: Aspose Excel. A XLS gyors és egyszerű konvertálása XML-re a Aspose.Cells-gyel. Python XLS XML-re. Python Mentse a XLS-et XML-be. Mentse el a XLS-et XML-ként a Python használatával.
...
{{% blocks/products/pf/agp/content h2="A XLS konvertálása XML-re a Python használatával" %}}
 ...
 Hogyan konvertálhatom át a XLS-et XML-re? A Aspose.Cells for Python könyvtárral egyszerűen konvertálhatja a XLS-et XML-re, programozottan néhány sornyi kóddal.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mentse a XLS-et XML-be a Python-ben" %}}

következő példa bemutatja a XLS konvertálását XML-re a Python-ben.
