---
title: สร้าง POWERPOINT - สร้างไฟล์ POWERPOINT ใน Java
description: Aspose เก่ง. Java สร้างไฟล์ POWERPOINT สร้าง POWERPOINT Java Java ผู้สร้าง POWERPOINT สร้าง POWERPOINT ใน Java สร้างไฟล์ POWERPOINT โดยใช้ Java
...
{{% blocks/products/pf/agp/content h2="วิธีสร้าง POWERPOINT ใน Java" %}}
...
1.  บันทึกสมุดงานเป็นรูปแบบ POWERPOINT โดยใช้วิธี save()

{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างแสดงวิธีสร้างไฟล์ POWERPOINT ใน Java" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="ไลบรารี Java เพื่อสร้างไฟล์ POWERPOINT" %}}
{{% blocks/products/pf/agp/text %}}
