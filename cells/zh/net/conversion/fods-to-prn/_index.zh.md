---
title: C# FODS 转 PRN - 在线 FODS 转 PRN 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 FODS 转换为 PRN 保存格式。 C# FODS 为 PRN 格式。将 FODS 保存至 PRN C#。
...
{{% blocks/products/pf/agp/content h2="免费在线将 FODS 保存到 C# 中的 PRN" %}}

以下示例演示如何将 FODS 转换为 C# 中的 PRN。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 FODS 转换为 PRN。上传您的 FODS 文件，然后将其保存为 PRN 文件。对于 FODS 读取和 PRN 写入，您可以使用完全限定的文件名。输出的 PRN 内容和格式将与原始 FODS 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免费应用程序和示例代码可在线将 FODS 转换为 PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 FODS 转换为 PRN" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 FODS 文件转换为 PRN？ .NET 开发人员只需几行代码即可轻松加载 FODS 并将其转换为 PRN。
...
1. 使用工作簿实例加载 FODS 文件。
1. 通过调用 Workbook.Save 方法将 FODS 转换为 PRN。
1. 获取FODS到PRN的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#库将FODS转换为PRN" %}}
