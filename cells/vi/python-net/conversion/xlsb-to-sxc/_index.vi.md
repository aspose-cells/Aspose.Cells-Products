...
description: Aspose Excel. Chuyển đổi XLSB sang SXC nhanh chóng và dễ dàng với Aspose.Cells. Python XLSB sang SXC. Python Lưu XLSB thành SXC. Lưu XLSB thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSB thành SXC thành Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLSB vào SXC trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSB thành SXC trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLSB thành SXC" %}}
