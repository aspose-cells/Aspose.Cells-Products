---
title: Utwórz MHT — utwórz plik MHT pod numerem Java
description: Aspose Excel. Bezproblemowo generuj i manipuluj plikami MHT dzięki bibliotece Aspose.Cells for Java. Ta wydajna biblioteka API zapewnia usprawnione i wydajne rozwiązanie do tworzenia, edycji i zarządzania plikami MHT bezpośrednio w aplikacjach Java, spełniając specyficzne potrzeby programistów z wysoką precyzją.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć MHT w Java" %}}
...
1.  Zapisz skoroszyt w formacie MHT, używając metody save().

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik MHT w Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do tworzenia pliku MHT" %}}
{{% blocks/products/pf/agp/text %}}
