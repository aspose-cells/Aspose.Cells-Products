...
{{% blocks/products/pf/agp/content h2="How to Insert elbow double arrow shape into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert elbow double arrow shape to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) to insert an elbow double arrow shape in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert elbow double arrow shape - Python via .Net" offSpacer="" %}}
