...
description: Aspose Excel. Convierta TSV a XLS rápida y fácilmente con Aspose.Cells. Python TSV a XLS. Python Guarde TSV en XLS. Guarde TSV como 07611134 81 usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TSV a XLS en Python" h2="Biblioteca Python de alta velocidad para convertir TSV a XLS. Esta es una solución de software profesional para importar y exportar TSV, XLS y muchos otros formatos utilizando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Guardar TSV al XLS en Python" %}}

El siguiente ejemplo demuestra cómo convertir TSV a XLS en Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir TSV en XLS" %}}
