---
title:  Insertar cubo en Excel usando Python via Java
weight: 10
...
{{< blocks/products/pf/i18n/upper-banner h1="Insertar cubo en Excel usando Python via Java" h2="Inserte Cube usando Aspose.Cells\' API sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar un archivo Cube en Excel usando Python via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa la colección de formas[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) para insertar un Cubo en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar cubo - Python via Java" offSpacer="" %}}
