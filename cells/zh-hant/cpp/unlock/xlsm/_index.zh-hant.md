...
title: 透過C++解鎖XLSM文檔
weight: 6070
description: C++ 用於解鎖 C++ 運行時環境中受密碼保護的 XLSM 檔案的範例代碼，適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 解鎖 XLSM 文件" h2="使用 C++ 庫刪除 Excel 電子表格（包括 XLSM 檔案）的保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 刪除 XLSM 檔案的保護" %}}
