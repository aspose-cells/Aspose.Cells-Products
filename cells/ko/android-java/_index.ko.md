...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="Android 스프레드시트 API은 널리 사용되는 Microsoft Excel 형식, 이미지 및 고정 레이아웃 형식을 지원합니다." >}}
...
워크시트, 행, 열, 셀 및 범위에 서식 적용
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 ArrayList, Array, Recordset &amp;에서 데이터 내보내기 및 가져오기 결과 집합
    </p>
   </div>
   <div class="col-lg-4">
...
스프레드시트 API 수식 계산 엔진
    ...
    <p>
 Android 시트 API은 고급 및 표준 Microsoft Excel 함수 및 수식을 지원하는 강력한 수식 계산 엔진을 제공합니다. 수식 계산 엔진을 사용하면 내장 또는 추가 유형, 배열 및 R1C1 참조 스타일 수식의 결과를 쉽게 읽고 설정하고 계산할 수 있습니다.
    </p>
   </div>
   <!--
