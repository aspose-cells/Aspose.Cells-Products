---
title: Gộp PRN sang WORD - Gộp PRN sang WORD trong Java
url: /vi/java/merger/merge-prn-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí định dạng lưu PRN sang WORD. Java Gộp định dạng PRN sang WORD. Hợp nhất PRN sang WORD trong Java. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN sang WORD trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất PRN với WORD trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất PRN với WORD. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp WORD. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất PRN với WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất PRN với WORD trong Java" InputFormat="prn" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất PRN với WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất PRN với WORD theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Java thư viện để hợp nhất PRN với WORD" %}}
