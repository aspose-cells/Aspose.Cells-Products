---
title: MHT létrehozása – MHT-fájl létrehozása a C#-ben
description: Aspose Excel. MHT fájlok létrehozása és kezelése könnyedén a Aspose.Cells for .NET könyvtárral. Ez a nagy teljesítményű API leegyszerűsített és hatékony megoldást kínál MHT fájlok létrehozására, szerkesztésére és kezelésére közvetlenül a C# alkalmazásokban, nagy pontossággal kielégítve a speciális fejlesztői igényeket.
...
{{% blocks/products/pf/agp/content h2="Hogyan hozzunk létre MHT-t a C#-es irányítószámon?" %}}
...
1.  Mentés módszerrel mentheti a munkafüzetet MHT-fájlként.

{{% blocks/products/pf/agp/code-block title="A mintakód bemutatja, hogyan hozható létre MHT fájl a C#-es kódrészletben." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# könyvtár MHT fájl létrehozásához" %}}
