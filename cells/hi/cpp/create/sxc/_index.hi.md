...
description: Aspose एक्सेल। C++ SXC फ़ाइल बनाएँ। SXC C++ बनाएं। C++ SXC क्रिएटर। C++ में SXC बनाएं। C++ का उपयोग करके SXC फ़ाइल जेनरेट करें।
...
{{% blocks/products/pf/agp/text %}}
 ...
 डेवलपर्स के लिए कोड की कुछ पंक्तियों में डेटा प्रोसेसिंग के लिए चल रहे रिपोर्टिंग एप्लिकेशन के भीतर SXC फ़ाइलों को बनाना, लोड करना, संशोधित करना और परिवर्तित करना आसान है।
...
1.  Save() विधि का उपयोग करके कार्यपुस्तिका को .sxc फ़ाइल के रूप में सहेजें।

{{% blocks/products/pf/agp/code-block title="नमूना कोड दिखाता है कि C++ में SXC फ़ाइल कैसे बनाएं।" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="SXC फ़ाइल बनाने के लिए C++ लाइब्रेरी" %}}
