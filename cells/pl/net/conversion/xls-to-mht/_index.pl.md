---
title: C# XLS do MHT - Online XLS do konwertera MHT
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Bezpłatnie online C# Konwersja XLS do formatu zapisu MHT. C# XLS do formatu MHT. Zaoszczędź XLS na MHT C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do MHT w C# online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na MHT w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na MHT. Prześlij swój plik XLS, a następnie po prostu zapisz go jako plik MHT. Zarówno do odczytu XLS, jak i zapisu MHT można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie MHT będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLS na MHT Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na MHT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na MHT? Programiści .NET mogą łatwo załadować i przekonwertować XLS na MHT w zaledwie kilku wierszach kodu.
...
1.  Konwertuj XLS na MHT, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLS na MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XLS na MHT" %}}
