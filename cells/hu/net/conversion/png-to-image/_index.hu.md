---
title: C# PNG - IMAGE - PNG - IMAGE Converter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára a PNG adatok KÉP formátumba konvertálásához, lehetővé téve a PNG adatok zökkenőmentes mentését KÉP formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a PNG-es számot az IMAGE-be a C#-es kódban" %}}

A következő példa bemutatja, hogyan lehet a PNG számot IMAGE formátumba konvertálni a C#-ben.
...
{{% blocks/products/pf/agp/content h2="A PNG konvertálása IMAGE-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A PNG fájlt programozottan IMAGE formátumba kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal IMAGE-re konvertálhatják a PNG-et.
...
1. Alakítsa át a PNG-et IMAGE formátumba a Workbook.Save metódus meghívásával.
1.  Szerezze meg a PNG konverziós eredményt IMAGE-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a PNG IMAGE formátumra konvertálásához" %}}
