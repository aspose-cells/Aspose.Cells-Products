---
title: Create BMP - Create BMP file in Node.js
description: Aspose Excel. Node.js Create BMP File quickly and easily with Aspose.Cells. Generate BMP file using Node.js. Create BMP in Node.js. Node.js BMP Creater. 
keywords: [Aspose Excel., Node.js Aspose.Cells., Node.js Create BMP file., Generate BMP file in Node.js., Create BMP file using Node.js., Write data to BMP file via Node.js., Create a BMP file in Node.js., Node.js Generate a BMP file., Node.js BMP Creater]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Create BMP File in Node.js" h2="Native and high performance BMP file creation programmatically without Micorsoft Office using Node.js library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Create BMP in Node.js" %}}
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create BMP file in Node.js." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Node.js library to create BMP file" %}}
