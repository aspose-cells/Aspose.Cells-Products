---
title: C# MHT - HTML - MHT - HTML konverter
description: Aspose Excel. Gyorsan és egyszerűen konvertálja az MHT-t HTML-re a Aspose.Cells-es számmal. C# MHT-HTML. C# Mentse el az MHT-t HTML-re. Mentse el az MHT-t HTML néven a 348173468 használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse el az MHT-t a HTML számra a C# számon" %}}

A következő példa bemutatja, hogyan lehet az MHT-t HTML-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód az MHT HTML-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="html" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Az MHT konvertálása HTML-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Az MHT-fájlokat programozottan HTML-re kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és konvertálhatják az MHT-t HTML-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja az MHT-t HTML-re a Workbook.Save metódus hívásával.
1.  Szerezd meg az MHT HTML számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT HTML-re konvertálásához" %}}
