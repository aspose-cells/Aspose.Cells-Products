---
title: C++ HTM إلى MHTML - محول HTM عبر الإنترنت إلى MHTML
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل HTM إلى MHTML saveformat. C++ HTM إلى تنسيق MHTML. احفظ HTM في MHTML C++.
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في MHTML في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات HTM إلى MHTML برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى MHTML في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى MHTML باستدعاء طريقة Save ().
