---
title: C++ OBRAZ na FODS - OBRAZ na FODS Konwerter
description: Aspose Excel. Szybko i łatwo przekonwertuj OBRAZ na FODS za pomocą Aspose.Cells. C++ OBRAZ na FODS. C++ Zapisz OBRAZ pod FODS. Zapisz OBRAZ jako FODS, używając C++.
...
{{% blocks/products/pf/agp/content h2="Zapisz OBRAZ pod numerem FODS w C++" %}}

Poniższy przykład pokazuje, jak przekonwertować IMAGE na FODS w C++.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować OBRAZ na FODS przez C++" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki IMAGE na FODS? Programiści C++ mogą z łatwością przekonwertować IMAGE na FODS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj OBRAZ na FODS, wywołując metodę Save().
1.  Uzyskaj wynik konwersji OBRAZU na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C++ do konwersji OBRAZU na FODS" %}}
