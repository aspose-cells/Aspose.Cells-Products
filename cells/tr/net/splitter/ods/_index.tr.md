---
title:  Böl ODS Dosyalar via .NET
weight: 140
description: C# kaynak kodu, ODS belgesini .NET Framework, .NET Core, Mono veya Xamarin Platformlarında bölmek için.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Böl ODS Formatları C#\'de" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan, sunucu tarafı API\'lerini kullanan yerel ve yüksek performanslı ODS ayırıcı." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODS Dosyalarını C#\'de Bölme Adımları" %}}
...
+ Bölme için ODS dosyasını tam yol ile yükleyin.
...
{{% blocks/products/pf/agp/code-block title="Böl ODS Dosya - C#" offSpacer="" %}}
