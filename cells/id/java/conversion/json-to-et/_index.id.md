...
description: Aspose Unggul. Ubah JSON menjadi ET dengan cepat dan mudah dengan Aspose.Cells. Java JSON menjadi ET. Java Simpan JSON ke ET. Simpan JSON sebagai ET menggunakan Java.
...
Contoh berikut menunjukkan cara mengonversi JSON ke ET di Java.
...
{{% blocks/products/pf/agp/content h2="Bagaimana Mengonversi JSON ke ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file JSON ke ET secara terprogram? Pengembang Java dapat dengan mudah mengonversi JSON ke ET hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi JSON ke ET" %}}
{{% blocks/products/pf/agp/text %}}
