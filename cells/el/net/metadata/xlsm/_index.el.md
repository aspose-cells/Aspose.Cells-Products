...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την εξαγωγή μεταδεδομένων του XLSM μέσω C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Εξαγωγή μεταδεδομένων του XLSM - C#" offSpacer="" %}}

```cs

// φορτώστε το XLSM με μια παρουσία του βιβλίου εργασίας
