---
title: C# تحويل الأرقام إلى صورة - تحويل الأرقام إلى صورة
description: Aspose إكسل. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل الأرقام إلى تنسيق صور، مما يتيح حفظ بيانات الأرقام بسلاسة بتنسيق صور باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في صورة في C#" %}}

يوضح المثال التالي كيفية تحويل الأرقام إلى صور في C#.
...
هل تحتاج إلى تحويل ملفات NUMBERS إلى IMAGE برمجيًا؟ يمكن لمطوري .NET تحميل وتحويل NUMBERS إلى IMAGE بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1. قم بتحويل الأرقام إلى صور عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل NUMBERS إلى IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الأرقام إلى صور" %}}
