---
title: EXCEL'i POWERPOINT ile birleştir - Java'de EXCEL'i POWERPOINT ile birleştir
url: /tr/java/merger/merge-excel-to-powerpoint/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i POWERPOINT kaydetme biçimiyle birleştirin. Java EXCEL'i POWERPOINT biçimiyle birleştirin. Java'de EXCEL'i POWERPOINT ile birleştirin. EXCEL Birleştirin.
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i POWERPOINT ile birleştir" %}}
...
{{% cells-merger title="Java\'de EXCEL\'i POWERPOINT ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i POWERPOINT via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL'i POWERPOINT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
