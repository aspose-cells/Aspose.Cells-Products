...
The following example demonstrates how to convert HTML to PDF document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert HTML file into PDF format. Upload your HTML file, then simply save it as PDF file. For both HTML reading and PDF writing you can use fully qualified filenames. The output PDF content and formatting will be identical to the original HTML document.
