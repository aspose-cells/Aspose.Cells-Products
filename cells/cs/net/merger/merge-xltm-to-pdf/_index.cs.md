---
title: Sloučit XLTM až PDF - Sloučit XLTM až PDF v C#
url: /cs/net/merger/merge-xltm-to-pdf/ 
description: Aspose Excel. C# Aspose.Cells. Online sloučení zdarma XLTM do formátu uložení PDF. C# Kombinujte formát XLTM až PDF. Sloučit XLTM až PDF v C#. XLTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTM až PDF v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLTM až PDF v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLTM do PDF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PDF. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí XLTM do PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XLTM až PDF v C#" InputFormat="xltm" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLTM na PDF přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLTM až PDF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení XLTM až PDF" %}}
