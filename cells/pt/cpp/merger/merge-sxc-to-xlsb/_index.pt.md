---
title:  Mesclar SXC para XLSB via C++
url: /pt/cpp/merger/merge-sxc-to-xlsb/ 
description: Mesclar SXC para XLSB Online gratuitamente. Online Grátis SXC a XLSB Fusão. Mesclar SXC para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar SXC a XLSB em C++.
...
{{% cells-merger title="Aplicativo gratuito para mesclar SXC a XLSB on-line" InputFormat="sxc" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
