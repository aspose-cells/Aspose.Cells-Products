...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHTML 轉換為 MARKDOWN。Java MHTML 為 MARKDOWN. Java 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Java。
...
以下範例示範如何將 Java 中的 MHTML 轉換為 MARKDOWN。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHTML 轉換為 MARKDOWN。上傳您的 MHTML 文件，然後只需將其另存為 MARKDOWN 文件。對於 MHTML 讀取和 MARKDOWN 寫入，您可以使用完全限定的檔案名稱。輸出 MARKDOWN 內容和格式將與原始 MHTML 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 MHTML 轉換為 MARKDOWN 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何轉換 MHTML 為 MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 MHTML 檔案轉換為 MARKDOWN 嗎？ Java開發人員只需幾行程式碼即可輕鬆將MHTML轉換為MARKDOWN。
