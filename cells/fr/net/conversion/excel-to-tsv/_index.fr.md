...
description: Aspose Exceller. Convertissez EXCEL en TSV rapidement et facilement avec Aspose.Cells. C# EXCEL en TSV. C# Enregistrez EXCEL en TSV. Enregistrez EXCEL sous TSV en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL au TSV dans C#" %}}
...
{{% cells-convert title="Exemple de code pour convertir EXCEL en TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="tsv" IsLandingPage="true" %}}
