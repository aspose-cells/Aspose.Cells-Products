...
url: /cs/net/merger/merge-json-to-xlt/ 
...
Následující příklad ukazuje, jak sloučit JSON až XLT v Aspose.Cells for .NET.
...
{{% cells-merger title="Ukázkový kód pro sloučení JSON až XLT v C#" InputFormat="json" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON na XLT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JSON až XLT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení JSON až XLT" %}}
