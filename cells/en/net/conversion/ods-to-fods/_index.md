...
description: Sample code for ods to fods C# conversion. Use API example code for batch ods files to fods conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert ODS to FODS Using C#" %}}

 In order to convert ODS to FODS, we will use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ODS to FODS via C#" %}}
