...
weight: 40
description: Python via Code source .Net pour insérer le bouton Spin (contrôle de formulaire) dans Excel.
...
{{% blocks/products/pf/agp/content h2="Comment insérer un bouton Spin (contrôle de formulaire) dans un fichier Excel à l\'aide de Python via .Net" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_spinner/#int-int-int-int-int-int) pour insérer un bouton Spin (contrôle de formulaire) dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer un bouton de rotation (contrôle de formulaire) - Python via .Net" offSpacer="" %}}
