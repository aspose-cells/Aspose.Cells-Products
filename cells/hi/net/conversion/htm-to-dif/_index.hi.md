...
{{% blocks/products/pf/agp/content h2="C# में एचटीएम को DIF पर मुफ्त में ऑनलाइन सेव करें" %}}

निम्न उदाहरण दर्शाता है कि C# में एचटीएम को DIF में कैसे परिवर्तित किया जाए।
...
{{% blocks/products/pf/agp/content h2="C# के माध्यम से HTM को DIF में कैसे बदलें" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर्स आसानी से कोड की कुछ पंक्तियों में एचटीएम को DIF में लोड और परिवर्तित कर सकते हैं।
...
{{% blocks/products/pf/agp/content h2="HTM को DIF में बदलने के लिए C# लाइब्रेरी" %}}
