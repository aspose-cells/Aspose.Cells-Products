...
url: /cs/cpp/merger/merge-htm-to-image/ 
...
Následující příklad ukazuje, jak sloučit HTM do IMAGE v Aspose.Cells for C++.
...
Potřebujete sloučit HTM s IMAGE programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení HTM do IMAGE" %}}
