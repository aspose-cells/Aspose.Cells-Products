---
title: PHP XLTM إلى FODS - XLTM إلى FODS محول
description: Aspose اكسل. قم بتحويل XLTM إلى FODS بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى FODS. PHP احفظ XLTM إلى FODS. احفظ XLTM كـ FODS باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى FODS عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى FODS برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى FODS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى FODS عن طريق استدعاء طريقة حفظ المصنف.
