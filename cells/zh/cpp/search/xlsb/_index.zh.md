---
title: 无需通过 C++ 打开即可搜索 XLSB 文档
weight: 7020
description: C++ 示例代码，用于在 XLSB 文件中使用模式搜索单词，适用于 C++ 运行时环境，支持 Windows 32 位、Windows 64 位和 Linux 64 位。
...
{{% blocks/products/pf/agp/code-block title="搜索文件 XLSB - C++" offSpacer="" %}}
