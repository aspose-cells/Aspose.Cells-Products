---
title:  Converti TSV in array di byte tramite C#
weight: 7690
description: C# Codice di esempio per la conversione da TSV a array di byte. Utilizzare questo codice per la conversione da Excel TSV a array di byte all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti TSV in array di byte tramite C#" h2="Nativo e ad alte prestazioni Microsoft Excel TSV conversione in array di byte o viceversa per l\'elaborazione dei dati dei fogli di calcolo utilizzando le API lato server .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array è utile per l'elaborazione o l'archiviazione dei dati. È possibile convertire il file TSV in Byte Array e anche in un file**Matrice di byte a TSV** documento utilizzando la lingua C#. Per convertire TSV in un array di byte, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 È facile per gli sviluppatori caricare e convertire i file TSV in un array di byte per ulteriori attività di manipolazione in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1.  Includi lo spazio dei nomi nel file della classe
1.  Caricare il file di input TSV utilizzando la cartella di lavoro
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da TSV all\'array di byte C#" offSpacer="" %}}
