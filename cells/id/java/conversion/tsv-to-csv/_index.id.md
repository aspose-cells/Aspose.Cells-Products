---
title: Konversikan TSV ke CSV melalui Java 
weight: 1720
url: /id/java/conversion/tsv-to-csv/ 
description: Contoh Java kode konversi untuk format TSV ke file CSV. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke CSV dalam Aplikasi berbasis Java Web atau Desktop apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan TSV ke CSV melalui Java" h2="Konversi TSV ke CSV Java untuk mengonversi satu atau beberapa laman ke CSV menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TSV ke CSV Menggunakan Java" %}}

 Untuk merender TSV ke CSV, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi TSV ke CSV melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file TSV ke CSV hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file TSV dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi CSV & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file CSV yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="TSV ke CSV Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file TSV dalam contoh Workbook
Workbook book = new Workbook("template.tsv");
// simpan TSV sebagai CSV
