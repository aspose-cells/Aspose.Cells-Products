...
+ Crea il file XLSX.
Ottieni il grafico.
+ Converti il grafico in immagine JPG/JPEG.
...
{{% blocks/products/pf/agp/code-block title="Converti il grafico dei file XLSX nell\'immagine JPG/JPEG - C#" offSpacer="" %}}
