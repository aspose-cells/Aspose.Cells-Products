...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση XLS σε μορφή αποθήκευσης EMF. Java Συνδυάστε τη μορφή XLS με EMF. Συγχώνευση XLS σε EMF στο Java. XLS Συγχώνευση.
keywords: [Aspose Excel., Java Aspose.Cells., Merge XLS to EMF in Java., Java Merge XLS to emf., Java Combine XLS to EMF., XLS Merge]
---
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLS με EMF στο Java" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLS έως EMF στο Java" InputFormat="xls" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
