...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SPREADSHEETML till XLS med Java" %}}

 För att rendera SPREADSHEETML till XLS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SPREADSHEETML till XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera SPREADSHEETML-filen till XLS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SPREADSHEETML-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLS-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLS-filen
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML till XLS Java konverteringskällkod" offSpacer="" %}}

```cs
// ladda SPREADSHEETML-filen i en instans av Workbook
Workbook book = new Workbook("template.spreadsheetml");
// spara SPREADSHEETML som XLS
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML till XLS Conversion Live Demos" sectionDescription="[Konvertera SPREADSHEETML till XLS](https://products.aspose.app/cells/conversion/spreadsheetml-to-xls) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din SPREADSHEETML-fil, den konverteras omedelbart till XLS." >}}
