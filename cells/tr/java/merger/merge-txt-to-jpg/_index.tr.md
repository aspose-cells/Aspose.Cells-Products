---
title: TXT'i JPG'ye birleştir - TXT'i Java'de JPG'ye birleştir
url: /tr/java/merger/merge-txt-to-jpg/ 
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme TXT'i JPG saveformat'a. Java TXT'i JPG formatında birleştirin. TXT'i Java'de JPG olarak birleştirin. TXT Birleştirin.
...
{{% blocks/products/pf/agp/content h2="TXT\'i JPG ile Java Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de TXT'in JPG ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="TXT\'i Java\'de JPG ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="txt" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT ile JPG via Java Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

TXT'i programlı olarak JPG ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i JPG ile birleştirmek için Java kitaplığı" %}}
