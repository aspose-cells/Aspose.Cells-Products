---
title:  Desbloquee el documento XLSM a través de C++
weight: 6070
description: C++ código de ejemplo para desbloquear el archivo XLSM protegido por contraseña en C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
---
...
1.  Cargue el archivo bloqueado XLSM usando CreateIWorkbook.
1.  Llame a la función Unprotect() para desbloquear.
1.  Establezca la contraseña en NULL usando SetPassword.
1.  Guarde el archivo XLSM en una ubicación específica.
