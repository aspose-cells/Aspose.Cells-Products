...
weight: 7690
url: /cs/net/conversion/xlsb-to-byte-array/ 
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array je užitečné pro zpracování nebo ukládání dat. Soubor XLSB můžete převést na Byte Array a také dokument **Byte Array na XLSB** pomocí jazyka C#. Abychom převedli XLSB na bajtové pole, použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Pro vývojáře je snadné načíst a převést soubory XLSB do bajtového pole pro další manipulační úkoly v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Zahrňte jmenný prostor do souboru třídy1. Načtěte vstupní soubor XLSB pomocí sešitu1. Inicializujte objekt MemoryStream1. Převeďte datový proud na bajtové pole1. Zpracovávejte data dle vašeho požadavku
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod XLSB na pole bajtů C#" offSpacer="" %}}
