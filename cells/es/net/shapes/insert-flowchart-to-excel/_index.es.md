...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar/crear un diagrama de flujo en un archivo de Excel mediante C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) para insertar/crear un diagrama de flujo en la hoja de trabajo seleccionada
...
AutoShapeType.FlowChartPredefinedProcess
 ...
 AutoShapeType.FlowChartDelay
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12">
 AutoShapeType.FlowChartSequentialAccessAlmacenamiento
    </p>
   </div>
   <div class="col-lg-4">
 ...
 AutoShapeType.FlowChartMagneticDisk
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12">
AutoShapeType.FlowChartDirectAccessAlmacenamiento
    </p>
   </div>
   <div class="col-lg-4">
