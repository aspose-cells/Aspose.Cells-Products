---
title: Conversor PHP SXC para ODS - SXC para ODS
description: Aspose Excel. Converta SXC em ODS de forma rápida e fácil com Aspose.Cells. PHP SXC em ODS. PHP Salve SXC em ODS. Salve SXC como ODS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em ODS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em ODS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em ODS em apenas algumas linhas de código.
...
1.  Converta SXC em ODS chamando o método save da pasta de trabalho.
