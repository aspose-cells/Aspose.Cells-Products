...
description: Aspose Excel'de. Aspose.Cells ile XLS'i hızlı ve kolay bir şekilde JPG'ye dönüştürün. Python XLS'i JPG'ye dönüştürün. Python XLS'i JPG'ye kaydedin. XLS'i Python'i kullanarak JPG olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="XLS\'i Python\'i kullanarak JPG\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="XLS\'i Python\'de JPG\'ye kaydedin" %}}

Aşağıdaki örnek, XLS'in Python'de JPG'ye nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="XLS\'i JPG\'ye dönüştürmek için Python kütüphanesi" %}}
