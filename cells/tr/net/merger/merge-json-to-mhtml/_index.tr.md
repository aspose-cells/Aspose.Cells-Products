---
title: JSON'i MHTML'e birleştir - JSON'i C#'de MHTML'e birleştir
url: /tr/net/merger/merge-json-to-mhtml/ 
description: Aspose Excel'de. C# Aspose.Cells. JSON'i MHTML kaydetme biçimiyle birleştirin. C# JSON'i MHTML biçimiyle birleştirin. C#'de JSON'i MHTML ile birleştirin. JSON Birleştir.
...
{{% blocks/products/pf/agp/content h2="JSON\'i C#\'de MHTML ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de JSON ile MHTML'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

JSON ile MHTML'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından MHTML dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. JSON ile MHTML'i birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="JSON ile MHTML\'i C#\'de Birleştirmek için Örnek Kod" InputFormat="json" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="JSON\'i C# aracılığıyla MHTML\'e Nasıl Birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

 JSON ile MHTML'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kitaplığı, JSON ile MHTML arasında birleştirilecek" %}}
