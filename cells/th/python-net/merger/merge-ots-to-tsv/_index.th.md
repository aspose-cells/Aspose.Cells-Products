...
description: Aspose เอ็กเซล. Python Aspose.Cells รวม OTS เป็น TSV บันทึกฟอร์แมต Python รวม OTS เข้ากับรูปแบบ TSV รวม OTS ไปที่ TSV ใน Python รวม OTS
...
{{% cells-merger title="ตัวอย่างโค้ดเพื่อรวม OTS เป็น TSV ใน Python" InputFormat="ots" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวม OTS เข้ากับ TSV ผ่าน Python" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม OTS เข้ากับ TSV โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
