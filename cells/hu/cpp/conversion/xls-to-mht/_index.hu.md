...
{{% cells-convert title="Mintakód a XLS MHT-vá alakításához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="mht" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A XLS konvertálása MHT-re a C++-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLS fájlokat programozottan MHT-vé kell konvertálni? A C++ fejlesztők könnyedén konvertálhatják a XLS-et MHT-vé, mindössze néhány sornyi kóddal.
