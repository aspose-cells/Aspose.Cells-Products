---
title:  Bewerk of bekijk XLSB Bestanden Metadata via Java
weight: 7290
description: Java voorbeeldcode om metadata in XLSB-indeling te bewerken of te bekijken op Java Runtime Environment voor JSP/JSF-applicatie en desktopapplicaties.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pak XLSB Metadata via Java uit" h2="Bouw uw eigen Java-apps om metadata uit XLSB-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe XLSB-metagegevens te extraheren met behulp van Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om metadata van XLSB via Java te extraheren" %}}
...
{{% blocks/products/pf/agp/code-block title="Extraheer metadata van XLSB - Java" offSpacer="" %}}
