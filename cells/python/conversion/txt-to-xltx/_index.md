...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to XLTX Using Python" %}}
 ...
 In order to convert TXT to XLTX, we’ll use
...
{{% blocks/products/pf/agp/code-block title="This sample code shows txt to xltx Python Conversion" offSpacer="" %}}

{{< gist "aspose-cells-gists" "32e50c6aabc547111966569f3fd39694" "Convert-txt-to-xltx.py" >}}
