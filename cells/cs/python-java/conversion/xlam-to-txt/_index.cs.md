...
{{% blocks/products/pf/agp/content h2="Převeďte XLAM na TXT pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLAM až TXT v Python online zdarma" %}}

Následující příklad ukazuje, jak převést XLAM na TXT v Python.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLAM na TXT" %}}
