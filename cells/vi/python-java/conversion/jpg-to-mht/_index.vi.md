---
title: Python Chuyển đổi JPG sang MHT - Công cụ chuyển đổi JPG sang MHT
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển Python một phương pháp tích hợp đầy đủ để chuyển đổi JPG sang định dạng MHT, cho phép lưu dữ liệu JPG liền mạch vào định dạng MHT bằng thư viện Aspose.Cells, tất cả thông qua mã Python hiệu quả và có thể tùy chỉnh.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi JPG sang MHT trong thư viện Excel Python" h2="Thư viện Excel tốc độ cao Python để chuyển đổi JPG sang MHT. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất JPG, MHT và nhiều định dạng khác bằng cách sử dụng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi JPG sang MHT bằng thư viện Excel Python" %}}

 Làm thế nào để chuyển đổi JPG sang MHT? Với thư viện Aspose.Cells for Python, bạn có thể dễ dàng chuyển đổi JPG sang MHT bằng lập trình chỉ với vài dòng mã.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, hiển thị và in tất cả các tệp Excel. Python Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó biến nó thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Lưu ảnh JPG vào thư viện MHT trong Excel Library Python." %}}

Ví dụ sau đây minh họa cách chuyển đổi JPG sang MHT trong thư viện Excel Python.
...
{{% cells-convert title="Ví dụ mã để chuyển đổi JPG sang MHT thông qua thư viện Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hướng dẫn chuyển đổi JPG sang MHT qua số Python" %}}

{{% blocks/products/pf/agp/text %}}

Bạn cần chuyển đổi các tệp JPG sang MHT bằng lập trình? Các nhà phát triển của Python có thể dễ dàng tải và chuyển đổi JPG sang MHT chỉ với một vài dòng mã.
...
1.  Chuyển đổi định dạng JPG sang MHT bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi từ JPG sang MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Thư viện Excel để chuyển đổi JPG sang MHT" %}}
