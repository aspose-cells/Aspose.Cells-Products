...
{{% blocks/products/pf/agp/content h2="Convert XLSB to JSON in Python Excel Library" %}}
...
{{% blocks/products/pf/agp/content h2="Save XLSB to JSON in Python Excel Library" %}}

The following example demonstrates how to convert XLSB to JSON in Python excel library.
...
{{% blocks/products/pf/agp/content h2="Python Excel Library to Convert XLSB to JSON" %}}
