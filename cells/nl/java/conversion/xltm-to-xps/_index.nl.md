---
title: Converteer XLTM naar XPS via Java 
weight: 9700
url: /nl/java/conversion/xltm-to-xps/ 
description: Voorbeeld Java conversiecode voor XLTM-indeling naar XPS-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar XPS te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLTM naar XPS via Java" h2="XLTM naar XPS Java-conversie om enkele of meerdere pagina\'s naar XPS te converteren met behulp van een lokale Java-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="XLTM naar XPS converteren met Java" %}}

 Om XLTM naar XPS te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLTM naar XPS te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen XLTM-bestanden gemakkelijk converteren naar XPS in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad XLTM-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met XPS-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende XPS-bestand
...
{{% blocks/products/pf/agp/code-block title="XLTM naar XPS Java Conversiebroncode" offSpacer="" %}}
