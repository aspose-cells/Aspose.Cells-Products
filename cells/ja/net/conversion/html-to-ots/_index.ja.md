---
title: C# HTML から OTS - HTML から OTS コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、HTMLをOTSにすばやく簡単に変換します。C# HTMLをOTSに変換します。 C# HTML を OTS に保存します。 C# を使用して HTML を OTS として保存します。
...
{{% blocks/products/pf/agp/content h2="HTML を C# の OTS に保存" %}}
...
{{% cells-convert title="HTMLをOTSに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML経由でHTMLをOTSに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで OTS に変換する必要がありますか? .NET 開発者は、わずか数行のコードで HTML を簡単にロードして OTS に変換できます。
