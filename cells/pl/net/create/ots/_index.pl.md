---
title: Utwórz OTS — utwórz plik OTS pod numerem C#
description: Aspose Excel. Bezproblemowo generuj i manipuluj plikami OTS dzięki bibliotece Aspose.Cells for .NET. Ta wydajna biblioteka API zapewnia usprawnione i wydajne rozwiązanie do tworzenia, edycji i zarządzania plikami OTS bezpośrednio w aplikacjach C#, spełniając specyficzne potrzeby programistów z wysoką precyzją.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć OTS w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik OTS w C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteka do tworzenia pliku OTS" %}}
