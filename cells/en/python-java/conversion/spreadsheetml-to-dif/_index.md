...
{{% blocks/products/pf/agp/content h2="How to Convert SPREADSHEETML to DIF Using Python" %}}
 ...
 In order to convert SPREADSHEETML to DIF, we will use [Aspose.Cells for Python](https://pypi.org/project/aspose-cells) API which is a feature-rich, powerful and easy to use document manipulation and conversion API for Python platform. 
