---
title: C# XLS zu XLT - Online-Konverter von XLS zu XLT
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das Speicherformat XLT. C# XLS bis XLT Format. Speichern Sie XLS bis XLT C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis XLT in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLS in XLT in C# konvertiert wird.
...
Müssen Sie XLS-Dateien programmgesteuert in XLT konvertieren? .NET-Entwickler können XLS problemlos in nur wenigen Codezeilen laden und in XLT konvertieren.
...
1.  Konvertieren Sie XLS in XLT, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in XLT" %}}
