...
{{% cells-convert title="Exemplo de código para converter MHTML em ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="et" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter MHTML para ET via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos MHTML para ET programaticamente? Os desenvolvedores do C++ podem facilmente converter MHTML em ET em apenas algumas linhas de código.
...
1. Converta MHTML em ET chamando o método Save().
