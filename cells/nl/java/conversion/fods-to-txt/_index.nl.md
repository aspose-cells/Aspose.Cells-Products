...
{{% blocks/products/pf/agp/content h2="Sla FODS op in TXT in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar TXT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar TXT of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar TXT? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar TXT met slechts een paar regels code.
