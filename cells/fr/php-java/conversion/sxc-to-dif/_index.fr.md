---
title: Convertisseur PHP SXC à DIF - SXC à DIF
description: Aspose Exceller. Convertissez SXC en DIF rapidement et facilement avec Aspose.Cells. PHP SXC en DIF. PHP Enregistrez SXC en DIF. Enregistrez SXC sous DIF en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Convertir SXC en DIF en utilisant PHP" %}}
 ...
 Comment convertir SXC en DIF ? Avec la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir SXC en DIF par programme avec quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. PHP Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer le SXC au DIF en PHP" %}}
...
Besoin de convertir les fichiers SXC en DIF par programme ? Les développeurs PHP peuvent facilement charger et convertir SXC en DIF en quelques lignes de code.
...
1.  Convertissez SXC en DIF en appelant la méthode de sauvegarde du classeur.
