---
title: MHT を ODS に結合 - MHT を Python に ODS に結合
url: /ja/python-net/merger/merge-mht-to-ods/ 
description: Aspose エクセル。 Python Aspose.Cells。無料オンライン MHT を ODS 保存形式にマージします。 Python MHT を ODS 形式に結合します。 Python で MHT を ODS にマージします。MHT をマージします。
...
次の例は、MHT を Aspose.Cells for Python via .NET の ODS にマージする方法を示しています。
...
{{% cells-merger title="オンラインで MHT を Python の ODS にマージする無料" InputFormat="mht" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Python 経由で MHT を ODS にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで MHT を ODS にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
