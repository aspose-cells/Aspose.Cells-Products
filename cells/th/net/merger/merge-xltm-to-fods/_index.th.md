...
url: /th/net/merger/merge-xltm-to-fods/ 
...
ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLTM ถึง FODS ใน Aspose.Cells for .NET
...
{{% blocks/products/pf/agp/text %}}
 ...
 ต้องการรวม XLTM กับ FODS โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ห้องสมุดรวม XLTM เป็น FODS" %}}
