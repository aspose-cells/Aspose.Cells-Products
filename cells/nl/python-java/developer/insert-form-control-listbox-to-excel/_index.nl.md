---
title: Voeg ListBox (formulierbesturingselement) in Excel in met Java Python via
weight: 50
description: Python via Java-broncode om ListBox (formulierbesturingselement) in Excel in te voegen.
...
{{% blocks/products/pf/agp/content h2="Hoe ListBox (formulierbesturingselement) in een Excel-bestand in te voegen met behulp van Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ListBox (formulierbesturingselement) in te voegen in een Excel-bestand met behulp van java Python via" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de vormcollecties[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addListBox(int,%20int,%20int,%20int,%20int,%20int)) om een ListBox (formulierbesturingselement) in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="ListBox invoegen (formulierbesturingselement) - Python via java" offSpacer="" %}}
