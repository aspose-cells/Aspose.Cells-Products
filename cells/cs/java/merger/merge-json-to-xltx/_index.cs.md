---
title:  Sloučit JSON až XLTX via Java
...
Následující příklad ukazuje, jak sloučit JSON až XLTX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení JSON až XLTX online" InputFormat="json" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
