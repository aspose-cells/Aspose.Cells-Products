...
{{< blocks/products/pf/i18n/upper-banner h1="Převést XLS na DOCX na C++" h2="Vysoce výkonný převod XLS na DOCX pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="Ukázkový kód pro převod XLS na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="docx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLS na DOCX přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLS na DOCX programově? Vývojáři C++ mohou snadno převést XLS na DOCX v několika řádcích kódu.
...
1.  Převeďte XLS na DOCX voláním metody Save().
