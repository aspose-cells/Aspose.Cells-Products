...
url: /cs/python-net/merger/merge-xlsm-to-jpg/ 
...
Následující příklad ukazuje, jak sloučit XLSM do JPG v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit XLSM do JPG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
