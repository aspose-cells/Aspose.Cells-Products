---
title: Chuyển đổi SXC sang MHTML qua Java 
url: /vi/java/conversion/sxc-to-mhtml/ 
description: Mã chuyển đổi Java mẫu cho định dạng SXC thành tệp MHTML. Người lập trình có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang MHTML trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi SXC sang MHTML qua Java" h2="Chuyển đổi SXC sang MHTML Java để chuyển đổi một hoặc nhiều trang sang MHTML bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi SXC sang MHTML bằng cách sử dụng Java" %}}

 Để kết xuất SXC thành MHTML, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi SXC sang MHTML qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp SXC sang MHTML chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp SXC với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Chuyển đường dẫn đầu ra với phần mở rộng MHTML & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp MHTML kết quả
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi SXC sang MHTML Java" offSpacer="" %}}

```cs
// tải tệp SXC trong một phiên bản của Workbook
Workbook book = new Workbook("template.sxc");
// lưu SXC dưới dạng MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi SXC sang MHTML" sectionDescription="[Chuyển đổi SXC sang MHTML](https://products.aspose.app/cells/conversion/sxc-to-mhtml) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp SXC của bạn, tệp sẽ được chuyển đổi ngay lập tức sang MHTML." >}}
