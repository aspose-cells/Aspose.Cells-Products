---
title: "TABDELIMITED konvertálása TSV-re a következőn keresztül: Java "

description: Minta Java konverziós kód a TABDELIMITED formátumhoz TSV-fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok exportálására TSV-be bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED konvertálása TSV-re a következőn keresztül: Java" h2="TABDELIMITED TSV Java konverzió egyetlen vagy több oldal konvertálásához TSV-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="A TABDELIMITED átalakítása TSV-vé a következővel: Java" %}}

 A TABDELIMITED TSV-ben való megjelenítéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TABDELIMITED TSV-vé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják a TABDELIMITED fájlt TSV-vé.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TSV kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TSV-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED TSV Java konverziós forráskódhoz" offSpacer="" %}}

```cs
// töltse be a TABDELIMITED fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tabdelimited");
// TABDELIMITED mentése TSV-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED TSV Conversion Live Demos" sectionDescription="[TABDELIMITED konvertálása TSV-re](https://products.aspose.app/cells/conversion/tabdelimited-to-tsv) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a TABDELIMITED fájlt, és azonnal TSV formátumba konvertálódik." >}}
