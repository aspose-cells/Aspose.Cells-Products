---
title:  Εισαγάγετε το ListBox (Στοιχείο ελέγχου φόρμας) στο Excel μέσω του Python
weight: 50
description: Python πηγαίος κώδικας για να εισαγάγετε ListBox (Έλεγχος φόρμας) στο Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Εισαγάγετε το ListBox (Στοιχείο ελέγχου φόρμας) στο Excel μέσω του Python" h2="Εισαγάγετε αντικείμενα χρησιμοποιώντας API από την πλευρά του διακομιστή χωρίς λογισμικό όπως Microsoft ή Open Office, Adobe PDF κ.λπ." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να εισαγάγετε ListBox (Έλεγχος φόρμας) σε αρχείο Excel χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την εισαγωγή ListBox (Έλεγχος φόρμας) στο αρχείο Excel μέσω Python" %}}
...
+ Χρησιμοποιήστε τη μέθοδο προσθήκης της shapecollection για να εισαγάγετε ένα ListBox(Στοιχείο ελέγχου φόρμας) στο επιλεγμένο φύλλο εργασίας.
...
{{% blocks/products/pf/agp/code-block title="Εισαγωγή ListBox (Έλεγχος φόρμας) - Python" offSpacer="" %}}
