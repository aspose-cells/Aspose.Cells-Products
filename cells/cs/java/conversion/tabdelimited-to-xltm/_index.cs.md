...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na XLTM pomocí Java" %}}

 K vykreslení TABDELIMITED do XLTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na XLTM přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor TABDELIMITED na XLTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TABDELIMITED s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLTM a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLTM
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze TABDELIMITED na XLTM Java" offSpacer="" %}}

```cs
// načtěte soubor TABDELIMITED v instanci sešitu
Workbook book = new Workbook("template.tabdelimited");
// uložit TABDELIMITED jako XLTM
