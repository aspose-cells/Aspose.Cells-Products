---
title:  Wstaw etykietę (kontrolka formularza) do programu Excel przy użyciu Python via .Net
weight: 80
description: Python via Kod źródłowy .Net umożliwiający wstawienie etykiety (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić etykietę (kontrolkę formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki wstawiania etykiety (kontrolki formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj dodatku do kolekcji kształtów[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_label/#int-int-int-int-int-int) , aby wstawić etykietę (formant formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw etykietę (kontrolka formularza) - Python via .Net" offSpacer="" %}}
