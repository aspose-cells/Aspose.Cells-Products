...
Trzeba programowo przekonwertować pliki XML do formatu DIF? Programiści C++ mogą łatwo przekonwertować pliki XML do formatu DIF za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XML do DIF wywołując metodę Save().
