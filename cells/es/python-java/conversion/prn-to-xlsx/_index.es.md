...
description: Aspose Excel. Convierta PRN a XLSX rápida y fácilmente con Aspose.Cells. Python PRN a XLSX. Python Guarde PRN en XLSX. Guarde PRN como XLSX usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PRN a XLSX en Python" h2="Biblioteca Python de alta velocidad para convertir PRN a XLSX. Esta es una solución de software profesional para importar y exportar PRN, XLSX y muchos otros formatos utilizando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Guardar PRN al XLSX en Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a XLSX en Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir PRN a XLSX" %}}
