...
{{% blocks/products/pf/agp/content h2="Jak seskupit a oddělit tvary v souboru aplikace Excel pomocí sJava" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k seskupení a zrušení seskupení tvarů v souboru aplikace Excel via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Seskupit a oddělit tvary – Java" offSpacer="" %}}
