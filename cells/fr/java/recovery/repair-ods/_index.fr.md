---
title: Java Réparer les ods - Récupérer et réparer le fichier ods corrompu
url: /fr/java/recovery/repair-ods/ 
description: Java Aspose.Cells. Réparation des pièces. Correction du fichier OD. outil de récupération de Ods. la corruption. Restaurer les données ods. récupération de fichier ods. Récupérez le fichier ods corrompu.
...
Besoin de réparer le fichier ods par programme ? Les développeurs Java peuvent facilement charger et réparer le fichier ods en quelques lignes de code seulement.
...
{{% cells-recovery title="Exemple de code pour réparer le fichier ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="java" %}}    
