---
title: ODS dosyasına yorum ekleyin via .NET
...
{{% blocks/products/pf/agp/content h2="ODS dosyasına C# yoluyla nasıl yorum eklenir?" %}}
...
{{% blocks/products/pf/agp/code-block title="C# ODS dosyasındaki yorumları eklemek ve kaldırmak için örnek kod" offSpacer="" %}}
