...
{{% blocks/products/pf/agp/content h2="Преобразование XML в HTML с использованием C++" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в HTML в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат HTML в формате C++.
...
Нужно программно преобразовать XML-файлы в формат HTML? Разработчики, использующие формат C++, могут легко преобразовать XML в формат HTML всего несколькими строками кода.
...
1.  Преобразовать XML в формат HTML, вызвав метод Save().
