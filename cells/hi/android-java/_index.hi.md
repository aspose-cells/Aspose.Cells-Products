---
title: एंड्रॉइड एक्सेल स्प्रेडशीट API - Aspose
weight: 6510
description: एक्सेल फाइलों को पढ़ने, लिखने और पार्स करने के लिए एंड्रॉइड स्प्रेडशीट लाइब्रेरी। मोबाइल एप्लिकेशन विकास के लिए एक स्प्रेडशीट API
---
...
<p>
 Aspose.Cells for Android via Java स्प्रैडशीट्स को प्रोग्रामेटिक रूप से उत्पन्न, संयोजन, संशोधित और पार्स करने के लिए एक स्केलेबल API है। API एक्सेल दस्तावेज़ स्वरूपण और पृष्ठ सेटअप कार्यों, आयात और निर्यात क्षमताओं सहित कई कार्यों की पेशकश करता है, कार्यपत्रक पृष्ठों को रेखापुंज छवियों के साथ-साथ छवि रिज़ॉल्यूशन, गुणवत्ता, संपीड़न, विभिन्न चार्ट जोड़ने और बहुत कुछ निर्दिष्ट करता है। एंड्रॉइड स्प्रेडशीट API XLS, XLSX, CSV, SpreadsheetML, ODS, टैब सीमांकित, HTML, PDF, XPS, और अधिक प्रारूपों का समर्थन करता है।
</p>
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="Aspose.Cells for Android via Java for Android 2.0 या इसके बाद के संस्करण उपलब्ध है।" >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="एंड्रॉइड स्प्रेडशीट API लोकप्रिय Microsoft एक्सेल फॉर्मेट, इमेज और फिक्स्ड-लेआउट फॉर्मेट का समर्थन करता है।" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 उन्नत एंड्रॉइड एक्सेल API विशेषताएं
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
वर्कशीट, रो, कॉलम, सेल और रेंज में फॉर्मेटिंग लागू करें
 ...
 &amp; टिप्पणियों में हेरफेर करें
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 पढ़ें, सेट करें और; सूत्रों की गणना करें
    </p>
   </div>
   <div class="col-lg-4">
 ...
 पेज सेटअप कॉन्फ़िगर करें
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 सेट करें और ऑटो-फ़िल्टर में हेरफेर करें & amp; पेज टूट जाता है
    </p>
   </div>
   <div class="col-lg-4">
 ...
 पढ़ें & amp; सशर्त स्वरूपण लिखें
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 मौजूदा कार्यपत्रकों की प्रतियां बनाएँ
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 सेट सुरक्षा विकल्प Microsoft एक्सेल XP के बाद से पेश किए गए
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 कोशिकाओं में हेरफेर करें & amp; नामित श्रेणियां
    </p>
   </div>
   <div class="col-lg-4">
 ...
 एक्सेल फाइल को PDF में बदलें
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 कार्यपत्रक और amp; छवियों के लिए चार्ट
    </p>
   </div>
   <!--<div class="col-lg-12">
...
-->
 ...
 &amp; कस्टम चार्ट में हेरफेर करें
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 मिसालें और आश्रितों को ट्रेस करें
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-edit ico-blue fa-2x col-lg-2">
...
शक्तिशाली सूत्र गणना इंजन
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 पढ़ें & amp; लिखें TSV, CSV &amp; HTML फाइलें
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 विभिन्न प्रारूप रूपांतरण
    ...
    <p>
 Android Excel लाइब्रेरी XPS, PDF और amp; उच्चतम दृश्य निष्ठा रखते हुए HTML प्रारूप। विश्वसनीय रूपांतरण प्रक्रिया API को उद्योग-मानक प्रारूपों में फाइलों के आदान-प्रदान के लिए कंपनियों के लिए एक आदर्श विकल्प बनाती है।
    </p>
...
<p>Aspose.Cells for Android via Java gives you complete freedom and flexibility to furnish your spreadsheets with all kinds of visual effects. The API allows you to apply different fonts with attributes, cell styles (alignment, indentation, rotation, borders, shading and coloring, protection, text wrapping and shrinking) and all types of number formats. Similarly, charts and graphics are visually appealing and can give your spreadsheet a professional look. Aspose.Cells for Android via Java provides a comprehensive set of APIs for creating and manipulating all of the standard and custom chart types. Moreover, you may add different types of drawing objects, such as comments, pictures, OLE objects, shapes and controls to the cells.</p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
 स्प्रैडशीट ऑब्जेक्ट्स को विभिन्न स्वरूपों में कनवर्ट करें
    </h2>
    <p>
 Aspose.Cells for Android via Java कुछ विशिष्ट विशेषताओं की पेशकश करते हैं जैसे छवियों के लिए कार्यपत्रक, छवियों के लिए चार्ट और; PDF और PDF दस्तावेज़ स्वरूप रूपांतरण के लिए स्प्रेडशीट। लचीली प्रक्रिया में रूपांतरण के लिए कई विकल्प हैं, जैसे स्प्रैडशीट्स के दौरान PDF पर छवियों का पुन: नमूनाकरण या कार्यपत्रकों को प्रस्तुत करते समय परिणामी छवि आयामों को सेट करना; छवि प्रारूपों के लिए चार्ट।
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
स्प्रेडशीट API सूत्र गणना इंजन
    </h2>
    <p>
 एंड्रॉइड शीट API उन्नत और मानक Microsoft एक्सेल फ़ंक्शंस और फ़ार्मुलों का समर्थन करने वाला एक शक्तिशाली फ़ॉर्मूला गणना इंजन प्रदान करता है। सूत्र गणना इंजन अंतर्निर्मित या ऐड-इन प्रकार, सरणी और R1C1 संदर्भ शैली सूत्रों के परिणामों को पढ़ना, सेट करना और गणना करना आसान बनाता है।
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-tab tabTitle="Aspose.Cells for Android via Java क्यों?" tabId="success-stories" >}}
