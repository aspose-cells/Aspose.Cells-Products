...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na TABDELIMITED pomocí Python" %}}

 Abychom převedli SXC na TABDELIMITED, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na TABDELIMITED přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na TABDELIMITED pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí Workbook1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s rozšířením TSV jako parametrem1. Zkontrolujte zadanou cestu pro výsledný soubor TABDELIMITED
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na TABDELIMITED" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="tsv" IsLandingPage="true" language="python" %}}
