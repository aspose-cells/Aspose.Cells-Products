...
{{% blocks/products/pf/agp/content h2="Cómo agrupar y desagrupar formas en un archivo Excel usando Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agrupar y desagrupar formas en un archivo Excel usando Python via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 ...
 + Usa el[método de desagrupación](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#ungroup(com.aspose.cells.GroupShape)) para desagrupar formas en la hoja de trabajo seleccionada
