---
title: Gộp MHT sang XML - Gộp MHT sang XML trong Python
url: /vi/python-java/merger/merge-mht-to-xml/ 
description: Aspose Excel. Python Aspose.Cells. Hợp nhất trực tuyến miễn phí MHT sang định dạng lưu XML. Python Gộp định dạng MHT sang XML. Hợp nhất MHT sang XML trong Python. Hợp nhất MHT.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHT sang XML bằng Python" %}}

Làm cách nào để hợp nhất MHT với XML? Với thư viện Aspose.Cells for Python via Java, bạn có thể dễ dàng hợp nhất MHT với XML theo lập trình với một vài dòng mã.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells)có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, kết xuất và in tất cả các tệp Excel. Python Excel API không chỉ chuyển đổi giữa các định dạng bảng tính, nó còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT, v.v., do đó làm cho nó trở thành một lựa chọn hoàn hảo để trao đổi tài liệu trong tiêu chuẩn công nghiệp định dạng. Bạn có thể cài đặt Aspose.Cells for Python via Java từ<a href="https://pypi.org/project/aspose-cells/">pypi</a> , sử dụng lệnh như:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Hợp nhất MHT sang XML trong Python Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất MHT sang XML trong Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất MHT sang XML. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp XML. Nếu bạn phát triển mã trong Python, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Python hợp nhất MHT với XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất MHT sang XML trong Python" InputFormat="mht" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python thư viện để hợp nhất MHT sang XML" %}}
