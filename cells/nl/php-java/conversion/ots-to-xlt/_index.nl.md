...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar XLT met Aspose.Cells. PHP OTS naar XLT. PHP Bewaar OTS naar XLT. Sla OTS op als XLT met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar XLT te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar XLT converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar XLT in slechts een paar regels code.
...
1.  Converteer OTS naar XLT door de opslagmethode van Workbook aan te roepen.
