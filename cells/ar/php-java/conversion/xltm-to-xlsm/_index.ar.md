---
title: PHP XLTM إلى XLSM - XLTM إلى XLSM محول
description: Aspose اكسل. قم بتحويل XLTM إلى XLSM بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى XLSM. PHP احفظ XLTM إلى XLSM. احفظ XLTM كـ XLSM باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى XLSM عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى XLSM برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى XLSM بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى XLSM عن طريق استدعاء طريقة حفظ المصنف.
