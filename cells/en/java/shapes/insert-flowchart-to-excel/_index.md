---
title: Insert FlowChart into Excel via Java
weight: 360
...
{{% blocks/products/pf/agp/content h2="How to Insert FlowChart into Excel File Using Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert FlowChart to Excel file via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) to insert FlowChart in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert FlowChart - Java" offSpacer="" %}}
