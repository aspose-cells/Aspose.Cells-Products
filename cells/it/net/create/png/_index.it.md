---
title: Crea PNG - Crea file PNG in C#
description: Aspose Excel. Genera e manipola senza sforzo i file PNG con la libreria Aspose.Cells for .NET. Questa potente libreria API offre una soluzione semplificata ed efficiente per creare, modificare e gestire i file PNG direttamente all'interno delle tue applicazioni C#, soddisfacendo le esigenze specifiche degli sviluppatori con elevata precisione.
...
{{% blocks/products/pf/agp/content h2="Come creare PNG in C#" %}}
...
1.  Utilizzare il metodo Salva per salvare la cartella di lavoro come file PNG.

{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare il file PNG in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria C# per creare il file PNG" %}}
