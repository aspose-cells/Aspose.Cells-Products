...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie OTS online z formatem zapisu OBRAZ. C# Połącz OTS z formatem IMAGE. Połącz OTS z IMAGE w C#. Połącz OTS.
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z IMAGE w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć OTS z IMAGE w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć OTS z IMAGE. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku IMAGE. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z IMAGE.
...
{{% blocks/products/pf/agp/content h2="Jak połączyć OTS z IMAGE przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć OTS z IMAGE? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia OTS z IMAGE" %}}
