...
description: Aspose エクセル。 Java Aspose.Cells。XLTM を EMF の保存形式にマージします。 Java XLTM と EMF の形式を結合します。 XLTM から EMF を Java に結合します。XLTM を結合します。
...
{{% cells-merger title="XLTM から EMF を Java にマージするサンプルコード" InputFormat="xltm" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
