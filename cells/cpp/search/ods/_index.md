...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to SearchВ ODS Files in C++" %}}
...
+  Load ODS file by instantiating a IWorkbook class.
...
+  Save ODS file using IWorkbook->Save(.) method.
...
{{% blocks/products/pf/agp/code-block title="SearchВ ODS Files - C++" offSpacer="" %}}
