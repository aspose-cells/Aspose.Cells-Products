...
يوضح المثال التالي كيفية دمج XML مع ETT في Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 هل تحتاج إلى دمج XML في ETT برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
