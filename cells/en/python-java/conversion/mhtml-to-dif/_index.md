...
description: Sample code for mhtml to dif Python conversion. Use API example code for batch mhtml files to dif conversion within Python application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert MHTML to DIF Using Python" %}}

 In order to convert MHTML to DIF, we will use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MHTML to DIF via Python" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert MHTML to DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="dif" IsLandingPage="true" language="python" %}}
