...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in ODS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar ODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar ODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar ODS? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar ODS met slechts een paar regels code.
