...
Poniższy przykład pokazuje, jak połączyć XLT z MHT w Aspose.Cells for Python via Java.
...
Chcesz programowo połączyć numer XLT z MHT? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
