---
title: Převeďte JSON na XLSB pomocí aplikace C++ 

description: Ukázkový konverzní kód C++ pro dokument JSON na formát XLSB. Programátoři mohou tento zdrojový kód použít pro dávkový převod JSON na XLSB v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést JSON na XLSB pomocí C++" %}}

 Abychom převedli JSON na XLSB, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu JSON na XLSB přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor JSON na XLSB pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor JSON pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu k výstupnímu souboru s příponou (XLSB).1. Soubor XLSB bude uložen do zadané cesty.1. Otevřete soubor XLSB v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu JSON na XLSB C++" offSpacer="" %}}
