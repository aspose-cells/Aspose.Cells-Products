---
title:  Hợp nhất MHT thành HTML qua Python
...
Ví dụ sau minh họa cách hợp nhất MHT thành HTML trong Python.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất MHT thành HTML trực tuyến" InputFormat="mht" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
