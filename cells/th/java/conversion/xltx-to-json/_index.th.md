---
title: แปลง XLTX เป็น JSON ผ่าน Java 
weight: 8100

description: ตัวอย่างโค้ดการแปลง Java สำหรับรูปแบบ XLTX เป็นไฟล์ JSON โปรแกรมเมอร์สามารถใช้โค้ดตัวอย่างนี้เพื่อส่งออกสเปรดชีต Excel & OpenOffice ไปยัง JSON ภายในแอปพลิเคชันบนเว็บหรือเดสก์ท็อป Java
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง XLTX เป็น JSON ผ่าน Java" h2="การแปลง XLTX เป็น JSON Java เพื่อแปลงหน้าเดียวหรือหลายหน้าเป็น JSON โดยใช้ไลบรารี Java ในสถานที่" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง XLTX เป็น JSON โดยใช้ Java" %}}

 ในการแสดง XLTX เป็น JSON เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง XLTX เป็น JSON ผ่าน Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java นักพัฒนาซอฟต์แวร์สามารถแปลงไฟล์ XLTX เป็น JSON ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ XLTX ด้วยอินสแตนซ์ของ Workbook class1. สร้างช่วงของข้อมูลที่จะส่งออกโดยใช้ Cells.createRange method1. เรียกวิธี JsonUtility.exportRangeToJson พร้อมการอ้างอิงของ Range & ExportRangeToJsonOptions1. เขียนข้อมูลสตริง JSON ไปยังไฟล์โดยใช้วิธี BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="XLTX เป็น JSON Java ซอร์สโค้ดการแปลง" offSpacer="" %}}
