---
title: EXCEL を Python 経由で PDF に結合
url: /ja/python-net/merger/merge-excel-to-pdf/ 
description: EXCEL をオンラインで無料で PDF に結合します。 PDF 合併への無料オンライン EXCEL。 Excel を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、EXCEL を Python の PDF にマージする方法を示しています。
...
{{% cells-merger title="オンラインでEXCELをPDFにマージする無料アプリ" InputFormat="xlsx" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
