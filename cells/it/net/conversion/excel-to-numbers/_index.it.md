---
title: C# EXCEL in NUMERI - Convertitore da EXCEL a NUMERI
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori C# un approccio completamente integrato per convertire EXCEL nel formato NUMBERS, consentendo il salvataggio senza interruzioni dei dati EXCEL nel formato NUMBERS utilizzando la libreria Aspose.Cells, il tutto tramite codice C# efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva EXCEL in NUMBERS in C#" %}}

L'esempio seguente mostra come convertire EXCEL in NUMERI in C#.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire EXCEL in NUMBERS. Carica il tuo file EXCEL e salvalo come file NUMBERS. Sia per la lettura in EXCEL che per la scrittura in NUMBERS puoi utilizzare nomi di file completi. Il contenuto e la formattazione di NUMBERS in output saranno identici al documento EXCEL originale.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Codice di esempio per convertire EXCEL in NUMERI" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="numbers" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Come convertire EXCEL in NUMERI tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file EXCEL in NUMBERS tramite codice? Gli sviluppatori di .NET possono caricare e convertire facilmente i file EXCEL in NUMBERS in poche righe di codice.
...
1.  Converti EXCEL in NUMBERS chiamando il metodo Workbook.Save.
1.  Ottieni il risultato della conversione da EXCEL a NUMERI.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C# per convertire EXCEL in NUMERI" %}}
