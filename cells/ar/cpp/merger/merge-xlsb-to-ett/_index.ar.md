---
title: دمج XLSB إلى ETT - دمج XLSB إلى ETT في C++
url: /ar/cpp/merger/merge-xlsb-to-ett/ 
description: Aspose اكسل. C++ Aspose.Cells. ادمج XLSB في تنسيق حفظ ETT. C++ قم بدمج XLSB إلى تنسيق ETT. دمج XLSB إلى ETT في C++. XLSB دمج.
...
{{% blocks/products/pf/agp/content h2="دمج XLSB إلى ETT في C++" %}}

يوضح المثال التالي كيفية دمج XLSB مع ETT في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج XLSB مع ETT. قم بتحميل ملفاتك، واستدعاء طريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف ETT. إذا قمت بتطوير التعليمات البرمجية في C++، فسيكون هذا أبسط مما يبدو. راجع مثال C++ الذي يدمج XLSB في ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج التعليمات البرمجية لدمج XLSB إلى ETT في C++" InputFormat="xlsb" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLSB إلى ETT عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج XLSB في ETT برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لدمج XLSB في ETT" %}}
