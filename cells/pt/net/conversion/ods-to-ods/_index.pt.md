---
title: C# ODS para ODS - Online ODS para ODS Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter ODS para ODS saveformat. C# ODS a ODS formato. Salve ODS a ODS C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter ODS para ODS em C#" h2="Biblioteca C# de alta velocidade para converter ODS em ODS. Esta é uma solução de software profissional para importar e exportar ODS, ODS e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Salve ODS a ODS em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter ODS em ODS em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS em ODS. Carregue seu arquivo ODS e salve-o como arquivo ODS. Tanto para a leitura ODS quanto para a escrita ODS, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação de saída ODS serão idênticos ao documento ODS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter ODS em ODS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para ODS programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter ODS em ODS em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para converter ODS em ODS" %}}
