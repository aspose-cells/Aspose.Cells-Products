...
{{% blocks/products/pf/agp/content h2="Jak převést TXT na JPG pomocí C++" %}}

 převodu TXT na JPG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TXT na JPG prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor TXT na JPG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (JPG).1. Soubor JPG bude uložen do zadané cesty.1. Otevřete soubor JPG v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TXT na JPG C++" offSpacer="" %}}
