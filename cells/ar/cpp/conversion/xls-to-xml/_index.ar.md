---
title: تحويل XLS إلى XML عبر تطبيق C++ 
url: /ar/cpp/conversion/xls-to-xml/ 
description: نموذج C++ رمز التحويل لمستند XLS إلى تنسيق XML. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLS إلى XML في أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLS إلى XML عبر C++" h2="تحويل XLS عالي الأداء إلى XML باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى XML باستخدام C++" %}}
 ...
 من أجل تحويل XLS إلى XML ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف XLS إلى XML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLS باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد ملف (XML).1. سيتم حفظ ملف XML في المسار المحدد.1. افتح ملف XML في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLS إلى XML C++ رمز مصدر التحويل" offSpacer="" %}}
