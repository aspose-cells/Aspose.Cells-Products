---
title: Java MHTML do TXT - MHTML do TXT Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu MHTML do TXT, umożliwiając bezproblemowe zapisywanie danych MHTML do formatu TXT za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHTML do TXT w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować MHTML na TXT w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer MHTML na numer TXT. Prześlij plik MHTML, a następnie po prostu zapisz go jako plik TXT. Zarówno do odczytu MHTML, jak i do zapisu TXT można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego TXT będą identyczne z oryginalnym dokumentem MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji MHTML na TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mhtml" outformat="txt" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki MHTML na TXT? Programiści Java mogą łatwo przekonwertować pliki MHTML na TXT za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj numer MHTML na numer TXT, wywołując metodę Workbook.save.
