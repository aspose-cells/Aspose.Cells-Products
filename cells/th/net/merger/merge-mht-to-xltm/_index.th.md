---
title: รวม MHT เป็น XLTM - รวม MHT เป็น XLTM เป็น C#
url: /th/net/merger/merge-mht-to-xltm/ 
description: Aspose เก่ง. C# Aspose.Cells รวม MHT ออนไลน์ฟรีเป็น XLTM บันทึกรูปแบบ C# รวมรูปแบบ MHT เป็น XLTM รวม MHT เป็น XLTM ใน C# รวม MHT
...
{{% blocks/products/pf/agp/content h2="รวม MHT เป็น XLTM ใน C# ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน MHT กับ XLTM ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม MHT เข้ากับ XLTM อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine สำหรับการรวมไฟล์ จากนั้นบันทึกลงในไฟล์ XLTM หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่รวม MHT เป็น XLTM

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ออนไลน์ฟรีเพื่อรวม MHT เข้ากับ XLTM ใน C#" InputFormat="mht" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีผสาน MHT กับ XLTM ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการรวม MHT เป็น XLTM โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี .NET เพื่อรวม MHT เป็น XLTM" %}}
