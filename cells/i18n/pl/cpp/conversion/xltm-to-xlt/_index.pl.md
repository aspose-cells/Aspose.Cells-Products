---
title: Konwertuj XLTM na XLT za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltm-to-xlt/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTM do formatu XLT. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTM na XLT w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLTM na XLT przez C++" h2="Wysokowydajna konwersja XLTM do XLT przy użyciu biblioteki C++ bez konieczności instalowania Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTM na XLT za pomocą C++" %}}

 Aby przekonwertować XLTM na XLT, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLTM na XLT za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLTM na XLT w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLT).1. Plik XLT zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLT w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLTM do XLT C++ Kod źródłowy konwersji" offSpacer="" %}}

```cs
// Załaduj XLTM.
intrusive_ptr<Aspose::Cells::IWorkbook> wkb = Factory::CreateIWorkbook(u"sourceFile.xltm");

// Zapisz w formacie XLT.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z XLTM do XLT" sectionDescription="[Konwertuj XLTM na XLT](https://products.aspose.app/cells/conversion/xltm-to-xlt) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLTM, zostanie on natychmiast przekonwertowany na XLT." >}}
