---
title: Conversor PHP SXC para EXCEL - SXC para EXCEL
description: Aspose Excel. Converta SXC para EXCEL de forma rápida e fácil com Aspose.Cells. PHP SXC para EXCEL. PHP Salve SXC no EXCEL. Salve SXC como EXCEL usando PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converta SXC para EXCEL em PHP" h2="Biblioteca PHP de alta velocidade para conversão de SXC para EXCEL. Esta é uma solução de software profissional para importar e exportar SXC, EXCEL e muitos outros formatos usando PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Salve SXC no EXCEL em PHP" %}}
...
Precisa converter arquivos SXC para EXCEL programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC para EXCEL em apenas algumas linhas de código.
...
1.  Converta SXC em EXCEL chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de SXC para EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter SXC para EXCEL" %}}
