...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása JSON-ba a következővel: Python" %}}

 TSV JSON-ba konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TSV konvertálása JSON-ra a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői könnyedén betölthetik és konvertálhatják a TSV-fájlokat JSON-formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TSV-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Adja meg a kimeneti útvonalat JSON-kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott JSON-fájl megadott elérési útját
