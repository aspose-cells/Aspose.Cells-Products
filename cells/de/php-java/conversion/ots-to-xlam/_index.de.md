...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in XLAM mit Aspose.Cells. PHP OTS in XLAM. PHP Speichern Sie OTS in XLAM. Speichern Sie OTS mit PHP als XLAM.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in XLAM" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in XLAM konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in XLAM konvertieren.
...
1.  Konvertieren Sie OTS in XLAM, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in XLAM" %}}
