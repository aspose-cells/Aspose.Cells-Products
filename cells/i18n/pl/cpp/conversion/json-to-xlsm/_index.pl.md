---
title: Konwertuj JSON na XLSM za pomocą aplikacji C++ 
url: /pl/cpp/conversion/json-to-xlsm/ 
description: Przykładowy kod konwersji C++ dla dokumentu JSON do formatu XLSM. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji JSON na XLSM w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik JSON na XLSM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik JSON przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSM).1. Plik XLSM zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSM w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji JSON do XLSM C++" offSpacer="" %}}
