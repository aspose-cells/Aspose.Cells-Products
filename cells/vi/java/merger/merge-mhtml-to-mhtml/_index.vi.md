---
title:  Hợp nhất MHTML đến MHTML via Java
...
Ví dụ sau minh họa cách hợp nhất MHTML thành MHTML trong Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất MHTML thành MHTML. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp rồi lưu vào tệp MHTML. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất MHTML thành MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ứng dụng miễn phí để hợp nhất MHTML thành MHTML trực tuyến" InputFormat="mhtml" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
