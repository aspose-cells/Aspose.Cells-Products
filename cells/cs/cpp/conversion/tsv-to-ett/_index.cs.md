...
{{% cells-convert title="Ukázkový kód pro převod TSV na ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="ett" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést TSV na ETT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést TSV soubory na ETT programově? Vývojáři C++ mohou snadno převést TSV na ETT v několika řádcích kódu.
...
1.  Převeďte TSV na ETT voláním metody Save().
