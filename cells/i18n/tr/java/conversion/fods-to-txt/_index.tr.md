---
title: FODS'u Java üzerinden TXT'ye dönüştürün 
url: /tr/java/conversion/fods-to-txt/ 
description: FODS formatı için TXT dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada TXT'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="FODS\'u Java üzerinden TXT\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı TXT\'ye dönüştürmek için FODS\'den TXT\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak FODS\'u TXT\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla FODS\'u TXT\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla FODS dosyasını kolayca TXT'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. FODS dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. Çıktı yolunu TXT uzantısı ve SaveFormat ile parametre olarak iletin1. Ortaya çıkan TXT dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="FODS - TXT Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// FODS dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.fods");
// FODS'u TXT olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS\'den TXT\'ye Dönüştürme Canlı Demoları" sectionDescription="[FODS\'yi TXT\'ye Dönüştür](https://products.aspose.app/cells/conversion/fods-to-txt) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece FODS dosyanızı yükleyin, anında TXT\'ye dönüştürülecektir." >}}
