...
description: Aspose Excel. C# Aspose.Cells. Voeg PNG samen met het opslagformaat FODS. C# Combineer het formaat PNG met FODS. Voeg PNG samen met FODS in C#. PNG Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg PNG samen met FODS in C#" %}}

Het volgende voorbeeld laat zien hoe u PNG samenvoegt met FODS in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PNG samen te voegen met FODS. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand FODS. Als u code ontwikkelt in C#, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C# waarin PNG wordt samengevoegd met FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om PNG samen te voegen met FODS in C#" InputFormat="png" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u PNG samenvoegt met FODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PNG programmatisch samenvoegen met FODS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen met FODS" %}}
