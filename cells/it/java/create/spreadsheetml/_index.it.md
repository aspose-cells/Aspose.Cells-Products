---
title: "Crea SPREADSHEETML: crea il file SPREADSHEETML in Java"
description: Aspose Excel. Genera e manipola senza sforzo file SPREADSHEETML con la libreria Aspose.Cells for Java. Questa potente libreria API offre una soluzione semplificata ed efficiente per creare, modificare e gestire file SPREADSHEETML direttamente all'interno delle tue applicazioni Java, soddisfacendo le esigenze specifiche degli sviluppatori con elevata precisione.
...
{{< blocks/products/pf/i18n/upper-banner h1="Crea file SPREADSHEETML in Java" h2="Libreria Java ad alta velocità per la creazione di file SPREADSHEETML. Si tratta di una soluzione software professionale per importare ed esportare i formati XLSX, PDF e molti altri utilizzando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come creare SPREADSHEETML in Java" %}}
...
1.  Salvare la cartella di lavoro in formato SPREADSHEETML utilizzando il metodo save().

{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare un file SPREADSHEETML in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria Java per creare il file SPREADSHEETML" %}}
{{% blocks/products/pf/agp/text %}}
