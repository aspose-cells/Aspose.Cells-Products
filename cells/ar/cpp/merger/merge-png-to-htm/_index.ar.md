---
title: دمج PNG إلى HTM - اجمع PNG إلى HTM في C++
url: /ar/cpp/merger/merge-png-to-htm/ 
description: Aspose إكسل. C++ Aspose.Cells. الدمج المجاني عبر الإنترنت PNG إلى HTM saveformat. C++ ادمج PNG بتنسيق HTM. دمج PNG إلى HTM في C++. PNG دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج PNG إلى HTM في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج PNG إلى HTM في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج PNG في HTM. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف HTM. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج PNG إلى HTM.
...
{{% blocks/products/pf/agp/content h2="كيفية دمج PNG مع HTM عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج PNG مع HTM برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج PNG إلى HTM" %}}
