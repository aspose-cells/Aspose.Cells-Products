---
title: Konvertálja az XLTX-et XLSX-re a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/xltx-to-xlsx/ 
description: Minta C++ konverziós kód XLTX dokumentumhoz XLSX formátumba. A programozók ezt a forráskódot használhatják az XLTX-ből XLSX-be kötegelt konvertáláshoz bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLTX konvertálása XLSX-re a következőn keresztül: C++" h2="Nagy teljesítményű XLTX-XLSX konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="XLTX konvertálása XLSX-re a következővel: C++" %}}

 Az XLTX XLSX-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLTX XLSX-vé konvertálásának lépései a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatnak XLTX fájlt XLSX-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTX fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (XLSX) fájlkiterjesztéssel.1. Az XLSX fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az XLSX fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLTX–XLSX C++ konverziós forráskód" offSpacer="" %}}
