---
title: Mesclar XLT a CSV - Combinar XLT a CSV em C#
url: /pt/net/merger/merge-xlt-to-csv/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita XLT para CSV saveformat. C# Combine o formato XLT a CSV. Mesclar XLT a CSV em C#. XLT Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLT a CSV em C# Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar XLT a CSV em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLT a CSV. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo CSV. Se você desenvolver o código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla XLT a CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLT a CSV em C#" InputFormat="xlt" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLT a CSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLT a CSV programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLT a CSV" %}}
