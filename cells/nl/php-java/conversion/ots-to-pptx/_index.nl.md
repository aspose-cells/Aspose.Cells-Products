...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar PPTX met Aspose.Cells. PHP OTS naar PPTX. PHP Bewaar OTS naar PPTX. Sla OTS op als PPTX met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar PPTX te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar PPTX converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar PPTX in slechts een paar regels code.
...
1.  Converteer OTS naar PPTX door de opslagmethode van Workbook aan te roepen.
