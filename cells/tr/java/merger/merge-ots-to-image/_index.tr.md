---
title: OTS'yi IMAGE ile Birleştir - Java'de OTS'yi IMAGE ile birleştirin
url: /tr/java/merger/merge-ots-to-image/ 
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi OTS'yi IMAGE kaydetme biçimine birleştirme. Java OTS'yi IMAGE formatına birleştirin. Java'de OTS'yi IMAGE ile birleştirin. OTS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="Java\'de OTS\'yi IMAGE ile Çevrimiçi Ücretsiz Olarak Birleştirin" %}}
...
{{% cells-merger title="Java\'de OTS\'yi IMAGE ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="ots" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi GÖRÜNTÜ via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 OTS'yi IMAGE ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
