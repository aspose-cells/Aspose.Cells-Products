...
Нужно программно преобразовать файлы XML в MHTML? Разработчики .NET могут легко загружать и преобразовывать XML в MHTML всего за несколько строк кода.
