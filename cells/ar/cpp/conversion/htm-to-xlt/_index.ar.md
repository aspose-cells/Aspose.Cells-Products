...
هل تحتاج إلى تحويل ملفات HTM إلى XLT برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى XLT في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى XLT باستدعاء طريقة Save ().
