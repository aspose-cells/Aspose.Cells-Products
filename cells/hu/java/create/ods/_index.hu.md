---
title: ODS (Openoffice / Lbreoffice) fájlok létrehozása via Java
description: ODS készítő. Hozzon létre ODS fájlt a Java kódban. ODS (Openoffice / Lbreoffice) fájlok létrehozása Java alapú asztali vagy webes alkalmazással.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hozzon létre ODS fájlt: via Java" h2="Natív és nagy teljesítményű ODS (Openoffice / Lbreoffice) táblázatkészítés programozottan a Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="ODS via Java létrehozása" %}}
...
{{% blocks/products/pf/agp/code-block title="A következő forráskód bemutatja, hogyan hozhat létre ODS (Openoffice / Lbreoffice) fájlt a Java használatával." offSpacer="" %}}
