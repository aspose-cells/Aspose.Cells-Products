...
{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter HTM para GIF online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="gif" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter HTM para GIF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Python podem facilmente carregar e converter HTM para GIF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Carregar arquivo HTM com uma instância da pasta de trabalho
1.  Converter HTM para GIF chamando o método Workbook.save
