---
title: C# SXC do SPREADSHEETML - SXC do konwertera SPREADSHEETML
...
{{% blocks/products/pf/agp/content h2="Zapisz SXC w SPREADSHEETML w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę SXC na format SPREADSHEETML w formacie C#.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować numer SXC na arkusz kalkulacyjny za pomocą numeru C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki SXC na SPREADSHEETML? Programiści .NET mogą z łatwością załadować i przekonwertować SXC na arkusz kalkulacyjny w zaledwie kilku linijkach kodu.
...
1.  Konwertuj SXC do formatu SPREADSHEETML, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji SXC na SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji SXC na SPREADSHEETML" %}}
