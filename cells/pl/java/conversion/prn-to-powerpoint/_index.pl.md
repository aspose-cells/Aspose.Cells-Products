...
{{% blocks/products/pf/agp/content h2="Konwertuj PRN do PowerPointa za pomocą Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN do POWERPOINT w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować PRN na POWERPOINT w formacie Java.
...
Trzeba programowo przekonwertować pliki PRN do formatu POWERPOINT? Programiści Java mogą łatwo przekonwertować pliki PRN do formatu POWERPOINT za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji PRN na POWERPOINT" %}}
{{% blocks/products/pf/agp/text %}}
