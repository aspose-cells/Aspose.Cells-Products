---
title: Sloučit XLSB do POWERPOINT - Sloučit XLSB do POWERPOINT v C#
url: /cs/net/merger/merge-xlsb-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Bezplatné online sloučení XLSB do formátu uložení POWERPOINT. C# Spojte XLSB do formátu POWERPOINT. Sloučit XLSB do POWERPOINT v C#. XLSB Sloučit.
...
Následující příklad ukazuje, jak sloučit XLSB do POWERPOINT v Aspose.Cells for .NET.
...
{{% cells-merger title="Online zdarma ke sloučení XLSB do POWERPOINT v C#" InputFormat="xlsb" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB do POWERPOINT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit XLSB do POWERPOINT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
