---
title: Converter CSV para XPS via Python
url: /pt/python-java/conversion/csv-to-xps/
description: Código de exemplo para conversão de csv para xps Python. Use API código de exemplo para arquivos csv em lote para conversão xps no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter CSV para XPS usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter CSV em XPS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos CSV para XPS em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo CSV com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão XPS como parâmetro1. Verifique o caminho especificado para o arquivo XPS resultante
...
{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter CSV em XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="xps" IsLandingPage="true" language="python" %}}
