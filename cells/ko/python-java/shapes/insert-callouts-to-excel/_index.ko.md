---
title: Python via Java을 사용하여 Excel에 콜아웃 삽입
weight: 360
description: Python via Java 콜아웃을 Excel에 삽입하는 소스 코드입니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java을 사용하여 Excel에 콜아웃 삽입" h2="Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells\' API을 사용하여 콜아웃을 삽입합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java을 사용하여 Excel 파일에 설명선을 삽입하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java을 사용하여 Excel 파일에 콜아웃을 삽입하는 단계" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 +[메소드 추가](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) 선택한 워크시트에 콜아웃을 삽입하려면
...
{{% blocks/products/pf/agp/code-block title="설명선 삽입 - Python via Java" offSpacer="" %}}
