...
description: Aspose excel. C++ Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme XLSX ile XLSB kaydetme biçimi. C++ XLSX ile XLSB formatını birleştirin. C++ içinde XLSX'i XLSB ile birleştir. XLSX Birleştir.
...
Aşağıdaki örnek, XLSX'in Aspose.Cells for C++'de XLSB ile nasıl birleştirileceğini gösterir.
