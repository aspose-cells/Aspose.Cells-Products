---
title: Gộp EXCEL vào OTS - Gộp EXCEL vào OTS theo số C#
url: /vi/net/merger/merge-excel-to-ots/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất EXCEL sang định dạng lưu OTS. C# Kết hợp định dạng EXCEL sang OTS. Hợp nhất EXCEL với OTS theo số C#. Hợp nhất EXCEL.
...
{{% blocks/products/pf/agp/content h2="Gộp EXCEL vào OTS số C#" %}}

Ví dụ sau đây minh họa cách hợp nhất EXCEL với OTS trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất EXCEL với OTS. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp OTS. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất EXCEL với OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp EXCEL vào OTS C#" InputFormat="xlsx" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp EXCEL vào OTS qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để ghép EXCEL vào OTS" %}}
