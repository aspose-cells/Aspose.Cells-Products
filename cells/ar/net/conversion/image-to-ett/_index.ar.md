...
description: Aspose اكسل. قم بتحويل IMAGE إلى ETT بسرعة وسهولة باستخدام Aspose.Cells. C# IMAGE إلى ETT. C# حفظ الصورة في ETT. احفظ الصورة باسم ETT باستخدام C#.
...
1.  قم بتحويل IMAGE إلى ETT عن طريق استدعاء أسلوب Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى ETT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى ETT" %}}
