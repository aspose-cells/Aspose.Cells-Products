---
title: C# JPEG 轉 XPS - 在線 JPEG 轉 XPS 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 JPEG 轉換為 XPS 保存格式。 C# JPEG 到 XPS 格式。將 JPEG 保存為 XPS C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 JPEG 轉換為 C# 中的 XPS" h2="高速C#庫，用於將JPEG轉換為XPS。這是一個專業的軟件解決方案，可在.NET Framework、.NET Core或Mono平台上導入和導出JPEG、XPS和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線保存 JPEG 至 XPS 於 C#" %}}

以下示例演示如何將 C# 中的 JPEG 轉換為 XPS。
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 JPEG 轉換為 XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xps" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 JPEG 轉換為 XPS" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 JPEG 文件轉換為 XPS 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 JPEG 到 XPS。
...
1. 使用工作簿實例加載 JPEG 文件。
1. 通過調用 Workbook.Save 方法將 JPEG 轉換為 XPS。
1. 獲取JPEG到XPS的轉換結果。
