...
{{% blocks/products/pf/agp/content h2="How to Merge MHT to XLS File Using Python" %}}
 ...
 In order to merge MHT to XLS file, we will use
...
{{% cells-merger title="Free App to merge Excel files on line" InputFormat="mht" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="python-java" %}}
