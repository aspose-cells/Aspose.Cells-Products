---
title: C# صورة إلى EXCEL - محول صورة إلى EXCEL
description: Aspose إكسل. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل الصور إلى تنسيق إكسل، مما يتيح حفظ بيانات الصور بسلاسة في تنسيق إكسل باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصور إلى ملفات إكسل في C#" h2="مكتبة C# عالية السرعة لتحويل الصور إلى ملفات إكسل. هذا حل برمجي احترافي لاستيراد وتصدير الصور وملفات إكسل والعديد من الصيغ الأخرى على منصات .NET Framework و.NET Core وMono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="IMAGE" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="تحويل الصورة إلى ملف إكسل باستخدام C#" %}}
كيف أقوم بتحويل الصورة إلى EXCEL؟ مع مكتبة Aspose.Cells for .NET، يمكنك بسهولة تحويل IMAGE إلى EXCEL برمجيًا باستخدام بضعة أسطر من التعليمات البرمجية.[Aspose.Cells for .NET](https://products.aspose.com/cells/net) قادر على إنشاء تطبيقات مشتركة بين الأنظمة الأساسية مع القدرة على إنشاء جميع ملفات Excel وتعديلها وتحويلها وعرضها وطباعتها. .NET Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات، بل يمكنه أيضًا عرض ملفات Excel كصور، وPDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT والمزيد، مما يجعله خيارًا مثاليًا لتبادل المستندات بتنسيقات متوافقة مع معايير الصناعة. يفتح[NuGet](https://www.nuget.org/packages/aspose.cells)مدير الحزم، ابحث عن Aspose.Cells وقم بتثبيته. يمكنك أيضًا استخدام الأمر التالي من وحدة تحكم إدارة الحزم.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في ملف إكسل برقم C#" %}}

يوضح المثال التالي كيفية تحويل الصورة إلى ملف إكسل في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الصورة إلى EXCEL عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى EXCEL برمجياً؟ يمكن للمطورين .NET تحميل وتحويل IMAGE إلى EXCEL بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الصورة إلى ملف إكسل عن طريق استدعاء دالة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة رقم C# لتحويل الصور إلى ملفات إكسل" %}}
