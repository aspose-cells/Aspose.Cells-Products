...
{{% blocks/products/pf/agp/feature-section-col title="Προσθήκη ή διαγραφή σχολιασμού από XLSB μέσω C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Διαγραφή σχολιασμών από XLSB - C#" offSpacer="" %}}
