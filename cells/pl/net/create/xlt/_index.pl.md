...
description: XLT twórca. Utwórz pliki XLT w kodzie C#. Generuj pliki MS Excel XLT za pomocą VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programiści mogą łatwo tworzyć, ładować, modyfikować i konwertować arkusz kalkulacyjny MS Excel XLT w ramach różnych aplikacji raportujących do przetwarzania danych w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod do tworzenia pliku MS Excel XLT przy użyciu C#." offSpacer="" %}}
