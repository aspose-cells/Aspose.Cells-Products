---
title: C# JPG en SXC - Convertisseur JPG en SXC
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG au format SXC, permettant un enregistrement transparent des données JPG au format SXC à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG sous SXC dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en SXC en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir JPG en SXC via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en SXC par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en SXC en quelques lignes de code.
...
1.  Convertissez le JPG au format SXC en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en SXC" %}}
