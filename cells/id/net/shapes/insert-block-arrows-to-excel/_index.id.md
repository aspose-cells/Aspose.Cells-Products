...
weight: 338
description: C# Contoh kode untuk menambah atau menyisipkan panah blok ke Excel menggunakan Library .NET. Gunakan kode ini untuk membuat panah blok di MS Excel dalam VB.NET, Asp.NET atau aplikasi berbasis .NET.
keywords: [C# Aspose.Cells., c# add block arrows., c# insert block arrows., c# create block arrows]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan Blok Panah ke Excel via .NET" h2="Masukkan Block Arrows menggunakan Aspose.Cells\' API tanpa software apapun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[tambahkan metode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) untuk menyisipkan Block Arrows di lembar kerja yang dipilih
...
<div class="container-fluid features-section bg-gray">
 ...
 AutoShapeType.BentUpArrow
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 AutoShapeType.Panah Kanan Melengkung
    </p>
   </div>
   <div class="col-lg-4">
