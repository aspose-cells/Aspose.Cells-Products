---
title:  รวม OTS เป็น MHT ผ่าน Python
url: /th/python-net/merger/merge-ots-to-mht/ 
description: รวม OTS เป็น MHT ออนไลน์ฟรี ฟรี OTS ออนไลน์เพื่อควบรวมกิจการ MHT รวม OTS เข้ากับ Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS และอื่นๆ
---
...
ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน OTS กับ MHT ใน Python
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม OTS เป็น MHT อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ MHT หากคุณพัฒนาโค้ดใน Python สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง Python ที่รวม OTS เป็น MHT

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="แอพฟรีเพื่อรวม OTS เป็น MHT ออนไลน์" InputFormat="ots" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
