---
title: Konvertieren Sie XLS in TIFF über C#

description: Beispielcode für die Umwandlung von xls in tiff C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von XLS-Dateien in TIFF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLS in TIFF über C#" h2="Exportieren Sie Excel®-Tabellen in das TIFF-Format auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können XLS-Dateien in nur wenigen Codezeilen einfach laden und in TIFF konvertieren.
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von XLS in TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="tiff" IsLandingPage="true" %}}
