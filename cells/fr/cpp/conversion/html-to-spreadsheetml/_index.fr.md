---
title: C++ HTML en SPREADSHEETML - Convertisseur en ligne HTML en SPREADSHEETML
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir HTML en format de sauvegarde SPREADSHEETML. C++ HTML au format SPREADSHEETML. Enregistrez HTML dans SPREADSHEETML C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTML en SPREADSHEETML en C++" h2="Conversion haute performance de HTML en SPREADSHEETML à l\'aide de la bibliothèque C++ sans avoir besoin d\'installer Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrez HTML dans SPREADSHEETML dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir HTML en SPREADSHEETML dans C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir HTML en SPREADSHEETML. Téléchargez votre fichier HTML, puis enregistrez-le simplement en tant que fichier SPREADSHEETML. Pour la lecture HTML et l'écriture SPREADSHEETML, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie SPREADSHEETML seront identiques au document HTML d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir HTML en SPREADSHEETML en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTML en SPREADSHEETML via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTML en SPREADSHEETML par programmation ? Les développeurs de C++ peuvent facilement convertir HTML en SPREADSHEETML en quelques lignes de code seulement.
