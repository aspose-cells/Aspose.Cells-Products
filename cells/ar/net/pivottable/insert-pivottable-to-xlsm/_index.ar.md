---
title:  إدراج PivotTable في ملفات Micorsoft Excel XLSM عبر C#
weight: 7690
description: C# نموذج التعليمات البرمجية لإضافة PivotTable إلى XLSM باستخدام مكتبة .NET. استخدم هذا الرمز لإدراج PivotTable في ملف XLSM داخل VB.NET أو Asp.NET أو أي تطبيق يستند إلى .NET.
...
{{< blocks/products/pf/i18n/upper-banner h1="أدخل PivotTable في المستندات XLSM عبر C#" h2="أداء أصلي وعالي Microsoft جدول بيانات Excel XLSM مع إنشاء PivotTable برمجيًا باستخدام واجهات برمجة التطبيقات .NET من جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 من السهل على المطورين إدراج PivotTable في جدول بيانات بتنسيق XLSM ضمن تشغيل تطبيقات التقارير المختلفة لمعالجة البيانات في بضعة أسطر فقط من التعليمات البرمجية.
