...
Het volgende voorbeeld laat zien hoe u XLSX converteert naar XPS in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSX naar XPS te converteren" %}}
