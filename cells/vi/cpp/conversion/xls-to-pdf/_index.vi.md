...
{{% cells-convert title="Mã mẫu chuyển đổi XLS thành PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="pdf" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS thành PDF qua C++" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLS thành PDF theo chương trình? Các nhà phát triển C++ có thể dễ dàng chuyển đổi XLS thành PDF chỉ bằng vài dòng mã.
