---
title: Java PRN zu XLS - PRN zu XLS Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von PRN-Daten in das Format XLS und ermöglicht das nahtlose Speichern von PRN-Daten im Format XLS mithilfe der Bibliothek Aspose.Cells – alles durch effizienten und anpassbaren Code Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="PRN in Java umwandeln" h2="Hochgeschwindigkeitsbibliothek Java zur Konvertierung von PRN in XLS. Dies ist eine professionelle Softwarelösung zum Importieren und Exportieren von PRN, XLS und vielen anderen Formaten unter Verwendung von Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="PRN in XLS umwandeln (mit Java)" %}}

 Wie konvertiere ich PRN in XLS? Mit der Bibliothek Aspose.Cells for Java können Sie PRN mit wenigen Codezeilen problemlos programmgesteuert in XLS konvertieren.[Aspose.Cells for Java](https://products.aspose.com/cells/java)ist in der Lage, plattformübergreifende Anwendungen zu erstellen, mit denen alle Excel-Dateien generiert, geändert, konvertiert, dargestellt und gedruckt werden können. Java Excel API konvertiert nicht nur zwischen Tabellenkalkulationsformaten, sondern kann Excel-Dateien auch als Bilder darstellen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT und mehr, was es zur perfekten Wahl für den Austausch von Dokumenten in Industriestandardformaten macht. Sie können die neueste Version direkt von herunterladen[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) und installieren Sie es in Ihrem auf Maven basierenden Projekt, indem Sie die folgenden Konfigurationen zur pom.xml hinzufügen.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie PRN unter XLS in Java" %}}

Das folgende Beispiel zeigt, wie man PRN in Java in XLS umwandelt.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um PRN in XLS umzuwandeln. Laden Sie Ihre PRN-Datei hoch und speichern Sie sie dann einfach als XLS-Datei. Sowohl zum Lesen von PRN als auch zum Schreiben von XLS können Sie vollqualifizierte Dateinamen verwenden. Der Inhalt und die Formatierung der Ausgabe XLS sind identisch mit dem ursprünglichen PRN-Dokument.
...
{{% blocks/products/pf/agp/content h2="Wie wandelt man PRN in XLS via Java um?" %}}

{{% blocks/products/pf/agp/text %}}

Müssen PRN-Dateien programmatisch in XLS konvertiert werden? Entwickler können PRN-Dateien mit nur wenigen Codezeilen problemlos in XLS konvertieren.
...
1.  Konvertieren Sie PRN in XLS, indem Sie die Methode Workbook.save aufrufen.
1.  Holen Sie sich das Konvertierungsergebnis von PRN in XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek Java zur Konvertierung von PRN in XLS" %}}
{{% blocks/products/pf/agp/text %}}
