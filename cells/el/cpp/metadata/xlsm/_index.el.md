...
{{% blocks/products/pf/agp/content h2="Πώς να λάβετε μεταδεδομένα XLSM χρησιμοποιώντας το C++" %}}
...
+ Φόρτωση αρχείου XLSM χρησιμοποιώντας το CreateIWorkbookMetadata
