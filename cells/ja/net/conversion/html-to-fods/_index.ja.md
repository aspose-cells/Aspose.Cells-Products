---
title: C# HTML から FODS - オンライン HTML から FODS コンバータ
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# HTML を FODS 保存形式に変換します。 C# HTML ～ FODS の形式。 HTML から FODS C# を保存します。
...
{{% blocks/products/pf/agp/content h2="C# に HTML から FODS をオンラインで無料で保存" %}}

次の例は、HTML を C# の FODS に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、HTML を FODS に変換します。HTML ファイルをアップロードし、FODS ファイルとして保存するだけです。 HTML 読み取りと FODS 書き込みの両方で、完全修飾ファイル名を使用できます。出力 FODS のコンテンツと形式は、元の HTML ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="オンラインでHTMLをFODSに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でHTMLをFODSに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで FODS に変換する必要がありますか? .NET 開発者は、わずか数行のコードで HTML を簡単にロードして FODS に変換できます。
