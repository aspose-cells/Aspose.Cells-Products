---
title: EXCEL egyesítése MHT-val - EXCEL egyesítése MHT-vel a Python-ben
url: /hu/python-net/merger/merge-excel-to-mht/ 
description: Aspose Excel. Python Aspose.Cells. Az EXCEL egyesítése MHT mentési formátumba. Python Kombinálja az EXCEL-t MHT formátumba. Az EXCEL egyesítése az MHT-val a Python-ben. EXCEL Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse az EXCEL-t az MHT-val a Python használatával" %}}

Hogyan egyesíthetem az EXCEL-t az MHT-val? A Aspose.Cells for Python via .NET könyvtárral egyszerűen egyesítheti az EXCEL-t az MHT-val programozottan néhány sornyi kóddal.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez. Telepítheti a Aspose.Cells for Python via .NET számot innen<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , használja a parancsot a következőképpen:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Egyesítse az EXCEL-t az MHT-val a Python-ben" %}}

A következő példa bemutatja, hogyan egyesítheti az EXCEL-t az MHT-val a Aspose.Cells for Python via .NET számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket az EXCEL és az MHT egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el MHT-fájlba. Ha kódot fejleszt a Python-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Python példát, amely egyesíti az EXCEL-t az MHT-val.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód az EXCEL és az MHT egyesítéséhez a Python-ben" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Az EXCEL és az MHT egyesítése a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell az EXCEL-t az MHT-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Python könyvtár az EXCEL és az MHT egyesítéséhez" %}}
