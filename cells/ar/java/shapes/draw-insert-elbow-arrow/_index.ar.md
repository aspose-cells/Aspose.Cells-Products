...
weight: 30
description: رسم أو إدراج شكل سهم الكوع باستخدام Aspose.Cells' Java API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF إلخ.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج شكل سهم الكوع في ملف اكسيل via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) لإدراج شكل سهم الكوع في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج شكل سهم الكوع - Java" offSpacer="" %}}
