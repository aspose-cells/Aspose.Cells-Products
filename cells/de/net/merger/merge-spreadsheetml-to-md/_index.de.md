---
title: SPREADSHEETML mit MD zusammenführen – Kombinieren Sie SPREADSHEETML mit MD in C#
url: /de/net/merger/merge-spreadsheetml-to-md/ 
description: Aspose Excel. C# Aspose.Cells. SPREADSHEETML in MD-Speicherformat zusammenführen. C# Kombinieren Sie SPREADSHEETML mit dem MD-Format. SPREADSHEETML mit MD in C# zusammenführen. SPREADSHEETML zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie SPREADSHEETML in MD in C# zusammen" %}}

Das folgende Beispiel zeigt, wie SPREADSHEETML in MD in Aspose.Cells for .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um SPREADSHEETML mit MD zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in einer MD-Datei. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das SPREADSHEETML mit MD zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Beispielcode zum Zusammenführen von SPREADSHEETML in MD in C#" InputFormat="xml" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie SPREADSHEETML über C# mit MD zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie SPREADSHEETML programmgesteuert mit MD zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von SPREADSHEETML mit MD" %}}
