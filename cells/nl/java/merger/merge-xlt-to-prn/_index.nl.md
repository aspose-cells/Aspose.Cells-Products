...
description: Aspose Excel. Java Aspose.Cells. Voeg XLT samen naar PRN-opslagformaat. Java Combineer XLT naar PRN-formaat. Voeg XLT samen met PRN in Java. XLT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u XLT samenvoegt met PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
