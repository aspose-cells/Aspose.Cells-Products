---
title: แทรก/สร้าง FlowChart ใน Excel โดยใช้ Python via .Net
weight: 360
description: Python via .Net ซอร์สโค้ดสำหรับแทรก/สร้าง FlowChart ลงใน Excel
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ Shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) เพื่อแทรก FlowChart ในแผ่นงานที่เลือก
