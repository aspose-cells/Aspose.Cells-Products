---
title: Convierta TABDELIMITED a XPS a través de Java 
url: /es/java/conversion/tabdelimited-to-xps/ 
description: Ejemplo de código de conversión Java para formato TABDELIMITED a archivo XPS. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a XPS dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta TABDELIMITED a XPS a través de Java" h2="Conversión TABDELIMITED a XPS Java para convertir una o varias páginas a XPS mediante la biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir TABDELIMITED a XPS usando Java" %}}

 Para representar TABDELIMITED en XPS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir TABDELIMITED a XPS a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente el archivo TABDELIMITED a XPS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo TABDELIMITED con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión XPS y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo XPS resultante
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED a XPS Java Código fuente de conversión" offSpacer="" %}}

```cs
// cargue el archivo TABDELIMITED en una instancia de Workbook
Workbook book = new Workbook("template.tabdelimited");
// guardar TABDELIMITED como XPS
