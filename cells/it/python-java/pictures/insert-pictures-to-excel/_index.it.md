---
title:  Inserisci l'immagine in Excel utilizzando Python via java
weight: 200
description: Python via codice sorgente Java per inserire l'immagine in Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci l\'immagine in Excel utilizzando Python via java" h2="Inserisci immagini utilizzando Aspose.Cells\' API senza software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire un\'immagine in un file Excel utilizzando Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire un\'immagine in un file Excel utilizzando Python via java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa la raccolta di immagini[aggiungi metodo](https://reference.aspose.com/cells/python-java/asposecells.api/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) per inserire un'immagine nel foglio di lavoro selezionato.
...
{{% blocks/products/pf/agp/code-block title="Inserisci immagine - Python via java" offSpacer="" %}}
