---
title: Java PNG إلى BMP - عبر الإنترنت من PNG إلى BMP
description: Aspose إكسل. Java Aspose.Cells. Java Aspose Cells. مجاني على الإنترنت Java تحويل PNG إلى BMP saveformat. Java PNG إلى تنسيق BMP. وفر PNG إلى BMP Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل PNG إلى BMP في Java" h2="مكتبة Java عالية السرعة لتحويل PNG إلى BMP. هذا حل برمجي احترافي لاستيراد وتصدير PNG و BMP والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="وفر PNG إلى BMP في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل PNG إلى BMP في Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل PNG إلى BMP. قم بتحميل ملف PNG الخاص بك ، ثم احفظه كملف BMP. لكل من قراءة PNG وكتابة BMP ، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون المحتوى والتنسيق الناتج BMP متطابقين مع المستند PNG الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل PNG إلى BMP عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="bmp" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل PNG إلى BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

تحتاج إلى تحويل PNG ملفات إلى BMP برمجيا؟ يمكن للمطورين Java تحويل PNG إلى BMP بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول PNG إلى BMP باستدعاء طريقة Workbook.save.
