...
description: Aspose Excel. Converta XLT em XPS de forma rápida e fácil com Aspose.Cells. C++ XLT em XPS. C++ Salve XLT em XPS. Salve XLT como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLT em XPS usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLT para XPS em C++" %}}

O exemplo a seguir demonstra como converter XLT em XPS em C++.
...
{{% cells-convert title="Exemplo de código para converter XLT em XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLT em XPS por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLT em XPS programaticamente? Os desenvolvedores do C++ podem converter facilmente XLT em XPS em apenas algumas linhas de código.
...
1.  Converta XLT em XPS chamando o método Save().
