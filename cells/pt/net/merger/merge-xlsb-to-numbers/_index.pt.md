---
title: Mesclar XLSB para NUMBERS - Combine XLSB para NUMBERS em C#
url: /pt/net/merger/merge-xlsb-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita XLSB para NUMBERS saveformat. C# Combine XLSB para o formato NUMBERS. Mesclar XLSB para NÚMEROS em C#. XLSB Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLSB para NUMBERS em C# Online Gratuitamente" %}}

exemplo a seguir demonstra como mesclar XLSB com NUMBERS em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLSB com NUMBERS. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo NUMBERS. Se você desenvolver código em C#, isso será mais simples do que parece. Veja o exemplo C# que mescla XLSB com NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLSB com NUMBERS em C#" InputFormat="xlsb" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLSB para NUMBERS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLSB para NUMBERS programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLSB para NUMBERS" %}}
