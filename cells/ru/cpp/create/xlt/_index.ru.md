---
title: Создать файлы MS Excel XLT через C++
description: XLT создатель. Создайте файлы XLT в коде C++. Создайте файлы MS Excel XLT с помощью приложения C++.
---
...
{{% blocks/products/pf/agp/content h2="Как создать XLT через C++" %}}
...
{{% blocks/products/pf/agp/code-block title="В следующем исходном коде показано, как создать файл MS Excel XLT, используя C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="библиотека C++ для создания файла XLT" %}}
