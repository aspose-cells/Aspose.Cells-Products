...
url: /pt/python-java/merger/merge-excel-to-powerpoint/ 
...
O exemplo a seguir demonstra como mesclar EXCEL para POWERPOINT em Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Precisa mesclar EXCEL para POWERPOINT programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) As APIs podem ser feitas com apenas algumas linhas de código.
