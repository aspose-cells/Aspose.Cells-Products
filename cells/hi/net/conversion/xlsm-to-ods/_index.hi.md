---
title: XLSM को C# के माध्यम से ODS में बदलें

description: xlsm से ods C# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर बैच xlsm फ़ाइलों को ods रूपांतरण के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके XLSM को ODS में कैसे बदलें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM को C# के माध्यम से ODS में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर कोड की कुछ ही पंक्तियों में आसानी से XLSM फ़ाइलों को ODS में लोड और परिवर्तित कर सकते हैं।
...
{{% cells-convert title="XLSM को ODS में बदलने के लिए फ्री ऐप और सैंपल कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="ods" IsLandingPage="true" %}}
