---
title: C# XLS do SPREADSHEETML - XLS do konwertera SPREADSHEETML
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLS do formatu SPREADSHEETML, umożliwiając bezproblemowe zapisywanie danych XLS w formacie SPREADSHEETML za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS w SPREADSHEETML w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLS na format SPREADSHEETML w formacie C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na SPREADSHEETML. Prześlij plik XLS, a następnie po prostu zapisz go jako plik SPREADSHEETML. Zarówno do odczytu XLS, jak i do zapisu w SPREADSHEETML, można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego arkusza kalkulacyjnego będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLS na SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować numer XLS na arkusz kalkulacyjny za pomocą numeru C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na SPREADSHEETML? Programiści .NET mogą z łatwością załadować i przekonwertować XLS na arkusz kalkulacyjny w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLS do formatu SPREADSHEETML, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLS na SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na SPREADSHEETML" %}}
