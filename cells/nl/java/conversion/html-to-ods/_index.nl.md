...
{{% blocks/products/pf/agp/content h2="Sla HTML op in ODS in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar ODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar ODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar ODS? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar ODS met slechts een paar regels code.
