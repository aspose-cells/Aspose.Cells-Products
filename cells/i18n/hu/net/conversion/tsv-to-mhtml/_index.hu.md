---
title: "TSV konvertálása MHTML-re a következőn keresztül: C#"
url: /hu/net/conversion/tsv-to-mhtml/
description: Mintakód a tsv–mhtml C# konverzióhoz. Használjon API példakódot a tsv fájlok kötegelt mhtml konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 A .NET fejlesztői egyszerűen, néhány sornyi kóddal betölthetik és konvertálhatják a TSV-fájlokat MHTML-re.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TSV-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Adja meg a kimeneti útvonalat MHTML kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott MHTML-fájl megadott elérési útját
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód a TSV MHTML-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="mhtml" IsLandingPage="true" %}}
