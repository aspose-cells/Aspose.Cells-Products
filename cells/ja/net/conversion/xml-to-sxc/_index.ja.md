...
description: Aspose エクセル。 Aspose.Cells を使用して、XML を SXC にすばやく簡単に変換します。 C# XML を SXC に変換します。 C# XML を SXC に保存します。 C# を使用して、XML を SXC として保存します。
...
{{% blocks/products/pf/agp/content h2="XML を C# の SXC に保存" %}}
...
{{% cells-convert title="XMLをSXCに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="sxc" IsLandingPage="true" %}}
