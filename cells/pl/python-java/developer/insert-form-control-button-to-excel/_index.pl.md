---
title: Wstaw przycisk (kontrolka formularza) do Excela, używając Python via Java
weight: 200
description: Python via Kod źródłowy Java umożliwiający wstawienie przycisku (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić przycisk (kontrolka formularza) do pliku Excel przy użyciu Python via java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić przycisk (kontrolka formularza) w wybranym arkuszu.
...
-  Dowolny system operacyjny, na którym można uruchomić Pythona za pomocą skryptów Java, taki jak Windows, Linux i MacOS
...
{{% blocks/products/pf/agp/code-block title="Przycisk Wstaw (kontrolka formularza) — Python via java" offSpacer="" %}}
