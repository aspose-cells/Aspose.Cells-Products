...
PNG dosyalarını program aracılığıyla TIFF'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve TIFF'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak PNG değerini TIFF değerine dönüştürün.
