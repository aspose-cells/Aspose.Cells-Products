---
title: Gabungkan XLS ke MHT - Gabungkan XLS ke MHT di C++
url: /id/cpp/merger/merge-xls-to-mht/ 
description: Aspose Unggul. C++ Aspose.Cells. Gabungkan XLS ke format simpan MHT. C++ Gabungkan XLS ke format MHT. Gabung XLS menjadi MHT di C++. XLS Gabung.
keywords: [Aspose Excel., C++ Aspose.Cells., Merge XLS to MHT in C++., C++ Merge XLS to mht., C++ Combine XLS to MHT., XLS Merge]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Gabung XLS ke MHT lewat C++" h2="Perpustakaan C++ berkecepatan tinggi untuk menggabungkan XLS ke MHT. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di C++. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="XLS" additionalConversionTag="MHT" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLS menjadi MHT di C++" %}}

Contoh berikut menunjukkan cara menggabungkan XLS ke MHT di Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLS ke MHT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MHT. Jika Anda mengembangkan kode di C++, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C++ yang menggabungkan XLS ke MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLS menjadi MHT di C++" InputFormat="xls" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLS ke MHT lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan XLS ke MHT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk menggabungkan XLS ke MHT" %}}
