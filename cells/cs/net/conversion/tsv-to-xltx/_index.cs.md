...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod TSV na XLTX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory TSV na XLTX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí sešitu1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s příponou XLTX jako parametr1. Zkontrolujte zadanou cestu pro výsledný soubor XLTX
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod TSV na XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xltx" IsLandingPage="true" %}}
