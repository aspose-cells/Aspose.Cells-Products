...
description: Aspose เอ็กเซล. แปลง XLT เป็น EXCEL อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XLT เป็น EXCEL C++ บันทึก XLT ลง EXCEL. บันทึก XLT เป็น EXCEL โดยใช้ C++
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง XLT เป็น EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xlsx" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง XLT เป็น EXCEL โดยการเรียกเมธอด Save()
