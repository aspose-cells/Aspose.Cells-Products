...
url: /sv/cpp/merger/merge-png-to-tiff/ 
...
Följande exempel visar hur man slår samman PNG till TIFF i Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Behöver du slå samman PNG till TIFF programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotek för att slå samman PNG till TIFF" %}}
