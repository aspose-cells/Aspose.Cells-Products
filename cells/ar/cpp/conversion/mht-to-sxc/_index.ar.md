...
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل MHT إلى تنسيق SXC، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق SXC باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="حوّل MHT إلى SXC باستخدام C++" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى SXC في C++" %}}
...
1.  قم بتحويل MHT إلى SXC عن طريق استدعاء دالة Save().
