---
title: C# Convertisseur Excel vers nombres
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format NUMBERS, permettant un enregistrement transparent des données EXCEL au format NUMBERS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Sauvegarder Excel au format NUMBERS (C#)" %}}

L'exemple suivant montre comment convertir EXCEL en NUMBERS dans C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des nombres Excel en nombres via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en NUMBERS par programmation ? Les développeurs de .NET peuvent facilement charger et convertir des fichiers EXCEL en NUMBERS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir des données Excel en nombres" %}}
