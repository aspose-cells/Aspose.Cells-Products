...
url: /hu/cpp/merger/merge-xml-to-sql/ 
...
A következő példa bemutatja, hogyan lehet XML-t SQL-be olvasztani a Aspose.Cells for C++-ben.
...
Programozottan egyesítenie kell az XML-t SQL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár az XML és az SQL egyesítéséhez" %}}
