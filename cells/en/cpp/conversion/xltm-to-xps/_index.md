...
description: Sample C++ conversion code for XLTM document to XPS format. Programmers can use this source code for batch XLTM to XPS conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLTM to XPS C++ Conversion Source Code" offSpacer="" %}}
