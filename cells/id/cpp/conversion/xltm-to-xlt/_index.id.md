---
title: Konversi XLTM ke XLT melalui C++ aplikasi 
url: /id/cpp/conversion/xltm-to-xlt/ 
description: Contoh C++ kode konversi untuk dokumen XLTM ke format XLT. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLTM ke XLT dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLTM ke XLT melalui C++" h2="Konversi XLTM ke XLT berperforma tinggi menggunakan pustaka C++ tanpa memerlukan penginstalan Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLTM ke XLT hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLTM menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file keluaran dengan ekstensi file (XLT).1. File XLT akan disimpan di jalur yang ditentukan.1. Buka file XLT di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLTM ke XLT C++ Kode Sumber Konversi" offSpacer="" %}}
