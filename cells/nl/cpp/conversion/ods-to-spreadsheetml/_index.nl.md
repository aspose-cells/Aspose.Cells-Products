---
title: Converteer ODS naar SPREADSHEETML via C++ applicatie 
url: /nl/cpp/conversion/ods-to-spreadsheetml/ 
description: Voorbeeld C++ conversiecode voor ODS-document naar SPREADSHEETML-indeling. Programmeurs kunnen deze broncode gebruiken voor batch-ODS naar SPREADSHEETML-conversie binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer ODS naar SPREADSHEETML via C++" h2="Hoogwaardige conversie van ODS naar SPREADSHEETML met behulp van de C++-bibliotheek zonder dat Microsoft Excel, OpenOffice of Adobe Acrobat hoeft te worden geïnstalleerd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen het ODS-bestand eenvoudig in een paar regels code naar SPREADSHEETML converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad het ODS-bestand met Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (SPREADSHEETML) bestandsextensie.1. SPREADSHEETML-bestand wordt opgeslagen op het opgegeven pad.1. Open het SPREADSHEETML-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="ODS naar SPREADSHEETML C++ Broncode voor conversie" offSpacer="" %}}
