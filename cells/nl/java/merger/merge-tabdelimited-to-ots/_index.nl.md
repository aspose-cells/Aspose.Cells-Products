---
title: Voeg TABDELLIMITED samen met OTS - Combineer TABDELLIMITED met OTS in Java
url: /nl/java/merger/merge-tabdelimited-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. TABDELIMITED samenvoegen naar OTS-opslagformaat. Java Combineer TABDELIMITED naar OTS-formaat. TABDELLIMITED samenvoegen met OTS in Java. TABDELLIMITED Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg TABDELIMITED samen met OTS in Java" %}}

Het volgende voorbeeld laat zien hoe u TABDELLIMITED kunt samenvoegen met OTS in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TABDELLIMITED samen te voegen met OTS. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een OTS-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie het voorbeeld Java waarin TABDELLIMITED wordt samengevoegd met OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om TABDELIMITED samen te voegen met OTS in Java" InputFormat="tsv" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TABDELIMITED samenvoegen met OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u TABDELLIMITED programmatisch samenvoegen met OTS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java-bibliotheek om TABDELLIMITED samen te voegen met OTS" %}}
