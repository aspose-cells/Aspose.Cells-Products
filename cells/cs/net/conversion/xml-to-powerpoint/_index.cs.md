...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte XML na POWERPOINT v C#" h2="Vysokorychlostní knihovna C# pro převod XML do POWERPOINT. Jedná se o profesionální softwarové řešení pro import a export XML, POWERPOINT a mnoha dalších formátů na platformách .NET Framework, .NET Core nebo Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POWERPOINT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XML" >}}
...
{{% cells-convert title="Ukázkový kód pro převod XML do POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na POWERPOINT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XML soubory do POWERPOINT programově? .NET vývojáři mohou snadno načíst a převést XML do POWERPOINT v několika řádcích kódu.
...
1.  Převeďte XML na POWERPOINT voláním metody Workbook.Save.
