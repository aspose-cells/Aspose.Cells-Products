...
{{< blocks/products/pf/i18n/upper-banner h1="Phân tích cú pháp ODS Định dạng trong Java" h2="Phân tích cú pháp tài liệu gốc và hiệu suất cao ODS bằng API Aspose.Cells for Java phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
+ Nạp tài liệu ODS sử dụng lớp Workbook.
