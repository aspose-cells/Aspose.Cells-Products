---
title: Python MHT إلى SQL - محول MHT إلى SQL عبر الإنترنت
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل MHT إلى SQL saveformat. Python MHT إلى تنسيق SQL. احفظ MHT في SQL Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHT إلى SQL في Python" h2="مكتبة Python عالية السرعة لتحويل MHT إلى SQL. هذا حل برمجي احترافي لاستيراد وتصدير MHT و SQL والعديد من التنسيقات الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل MHT إلى SQL باستخدام Python" %}}

 كيف أقوم بتحويل MHT إلى SQL؟ مع مكتبة Aspose.Cells for Python ، يمكنك بسهولة تحويل MHT إلى SQL برمجيًا باستخدام بضعة أسطر من التعليمات البرمجية.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)قادر على بناء تطبيقات عبر الأنظمة الأساسية مع القدرة على إنشاء وتعديل وتحويل وعرض وطباعة جميع ملفات Excel. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات ، بل يمكنه أيضًا عرض ملفات Excel كصور ، PDF ، HTML ، ODS ، CSV ، SVG ، JSON ، WORD ، PPT والمزيد ، مما يجعله خيارًا مثاليًا لتبادل المستندات في معايير الصناعة الأشكال.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="احفظ MHT إلى SQL في Python عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل MHT إلى SQL في Python.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى SQL عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى SQL برمجيًا؟ يمكن للمطورين Python تحميل وتحويل MHT إلى SQL بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل MHT إلى SQL عن طريق استدعاء طريقة Workbook.save.
1.  احصل على نتيجة التحويل من MHT إلى SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python مكتبة لتحويل MHT إلى SQL" %}}
