...
url: /ru/cpp/merger/merge-spreadsheetml-to-spreadsheetml/ 
...
В следующем примере показано, как объединить SPREADSHEETML с SPREADSHEETML в Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Нужно объединить SPREADSHEETML в SPREADSHEETML программным путем? Базовый документ сливается и объединяется с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="C++ библиотека для слияния SPREADSHEETML с SPREADSHEETML" %}}
