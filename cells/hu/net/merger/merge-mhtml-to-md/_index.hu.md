---
title: A MHTML egyesítése az MD-vel – a MHTML-es szám egyesítése MD-vel a C#-ben
url: /hu/net/merger/merge-mhtml-to-md/ 
description: Aspose Excel. C# Aspose.Cells. A MHTML egyesítése MD mentési formátumba. C# A MHTML kombinálása MD formátumba. A MHTML egyesítése a C# számú MD-vel. MHTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A MHTML egyesítése a C# számú MD-vel" %}}

következő példa bemutatja, hogyan egyesítheti a MHTML-et az MD-vel a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a MHTML és az MD egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el MD fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a MHTML-et az MD-vel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a MHTML MD-vel való egyesítéséhez a C#-ben" InputFormat="mhtml" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML és az MD egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et az MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML MD-vel való egyesítéséhez" %}}
