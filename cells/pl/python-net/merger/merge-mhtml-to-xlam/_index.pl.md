---
title: Połącz MHTML z XLAM - Połącz MHTML z XLAM w Python
url: /pl/python-net/merger/merge-mhtml-to-xlam/ 
description: Aspose Excel. Python Aspose.Cells. Bezpłatne scalanie online MHTML do XLAM w formacie zapisu. Python Połącz format MHTML z XLAM. Połącz MHTML z XLAM w Python. MHTML Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz MHTML z XLAM za pomocą Python" %}}

 Jak scalić MHTML z XLAM? Dzięki bibliotece Aspose.Cells for Python via .NET możesz łatwo połączyć programowo MHTML z XLAM za pomocą kilku linii kodu.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)jest w stanie budować wieloplatformowe aplikacje z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje między formatami arkuszy kalkulacyjnych, ale może również renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumenty w standardzie przemysłowym formaty. Możesz zainstalować Aspose.Cells for Python via .NET z<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , użyj polecenia jako:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Połącz MHTML z XLAM w Python Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć MHTML z XLAM w Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć MHTML z XLAM. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku XLAM. Jeśli opracujesz kod w Python, będzie to prostsze niż się wydaje. Zobacz przykład Python, który łączy numery MHTML z XLAM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online MHTML z XLAM w Python" InputFormat="mhtml" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć MHTML z XLAM za pośrednictwem Python" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić MHTML z XLAM programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
