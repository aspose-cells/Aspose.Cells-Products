---
title: Converter CSV para HTML via Java 
weight: 6910
url: /pt/java/conversion/csv-to-html/ 
description: Exemplo de código de conversão Java para formato CSV em arquivo HTML. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para HTML em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter CSV para HTML via Java" h2="Conversão de CSV para HTML Java para converter uma ou várias páginas em HTML usando a biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter CSV para HTML usando Java" %}}

 Para renderizar CSV para HTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter CSV em HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente arquivos CSV em HTML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo CSV com uma instância da classe Workbook1. Chame o método Workbook.save1. Passe o caminho de saída com extensão HTML e SaveFormat como parâmetros1. Verifique o caminho especificado para o arquivo HTML resultante
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de CSV para HTML Java" offSpacer="" %}}

```cs
// carregar o arquivo CSV em uma instância da pasta de trabalho
Workbook book = new Workbook("template.csv");
// salvar CSV como HTML
