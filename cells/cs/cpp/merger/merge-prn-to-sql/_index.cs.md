...
url: /cs/cpp/merger/merge-prn-to-sql/ 
...
Následující příklad ukazuje, jak sloučit PRN s SQL v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit PRN s SQL programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení PRN s SQL" %}}
