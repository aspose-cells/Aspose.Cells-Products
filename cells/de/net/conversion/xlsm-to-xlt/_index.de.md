---
title: Konvertieren Sie XLSM in XLT über C#

description: Beispielcode für die Umwandlung von xlsm in xlt C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von xlsm-Dateien in xlt innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLSM in XLT über C#" h2="Exportieren Sie Excel®-Tabellen in das XLT-Format auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können XLSM-Dateien in nur wenigen Codezeilen einfach laden und in XLT konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. XLSM-Datei mit einer Instanz von Workbook laden1. Rufen Sie die Workbook.Save-Methode auf1. Übergeben Sie den Ausgabepfad mit XLT-Erweiterung als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende XLT-Datei
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von XLSM in XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xlt" IsLandingPage="true" %}}
