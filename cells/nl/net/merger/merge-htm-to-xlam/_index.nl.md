---
title: HTM samenvoegen naar XLAM - HTM combineren naar XLAM in C#
url: /nl/net/merger/merge-htm-to-xlam/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online HTM samenvoegen naar XLAM opslagformaat. C# Combineer HTM naar formaat XLAM. HTM samenvoegen naar XLAM in C#. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="HTM samenvoegen naar XLAM in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u HTM samenvoegt met XLAM in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen tot XLAM. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand XLAM. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat HTM samenvoegt tot XLAM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om HTM samen te voegen met XLAM in C#" InputFormat="htm" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen naar XLAM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met XLAM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om HTM samen te voegen tot XLAM" %}}
