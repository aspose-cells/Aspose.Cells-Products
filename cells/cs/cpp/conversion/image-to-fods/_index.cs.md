...
Potřebujete převést soubory IMAGE na FODS programově? C++ vývojáři mohou snadno převést IMAGE na FODS v několika řádcích kódu.
...
1.  Převeďte IMAGE na FODS voláním metody Save().
