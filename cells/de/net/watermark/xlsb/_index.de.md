...
{{% blocks/products/pf/agp/content h2="So versehen Sie die Datei XLSB mit einem Wasserzeichen mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen eines Wasserzeichens zu XLSB über C#" %}}
...
+ Arbeitsmappe im Format XLSB speichern
...
{{% blocks/products/pf/agp/code-block title="Wasserzeichen zu XLSB - C# hinzufügen" offSpacer="" %}}
