---
title: Hoe u een gebogen vorm in Excel tekent of invoegt met Python via Java
weight: 10
description: Teken of voeg een gebogen vorm in met Aspose.Cells' Python via Java API zonder software zoals Microsoft of Open Office, Adobe PDF, enz.
keywords: [Python Aspose.Cells., Python add curved shape., Python insert curved shape., Python create curved shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg een gebogen vorm in Excel in met behulp van Python via Java" h2="Voeg een gebogen vorm in met behulp van Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een gebogen vorm in een Excel-bestand kunt invoegen met behulp van Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om een gebogen vorm in een Excel-bestand in te voegen met behulp van Python via Java" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de vormcollecties[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) om een gebogen vorm in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Inzet gebogen vorm - Python via Java" offSpacer="" %}}
