---
title: Converter XLSM para TSV por meio do aplicativo C++ 

description: Exemplo de código de conversão C++ de documento XLSM para formato TSV. Os programadores podem usar esse código-fonte para conversão em lote de XLSM para TSV em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSM para TSV via C++" h2="Conversão de XLSM para TSV de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter XLSM para TSV usando C++" %}}

 Para converter XLSM para TSV, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter XLSM em TSV via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem converter facilmente arquivos XLSM para TSV em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLSM usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com a extensão de arquivo (TSV).1. O arquivo TSV será salvo no caminho especificado.1. Abra o arquivo TSV em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLSM para TSV C++" offSpacer="" %}}
