---
title: Создать файлы MS Excel XLSB via Java
description: XLSB создатель. Создайте файлы XLSB в коде Java. Создавайте файлы MS Excel XLSB с помощью настольного или веб-приложения на основе Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Создать файл XLSB via Java" h2="Нативное и высокопроизводительное создание электронных таблиц MS Excel XLSB программно с использованием библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Как создать XLSB via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="В следующем исходном коде показано, как создать файл MS Excel XLSB, используя Java." offSpacer="" %}}
