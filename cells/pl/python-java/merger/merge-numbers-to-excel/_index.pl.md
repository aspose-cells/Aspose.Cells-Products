...
url: /pl/python-java/merger/merge-numbers-to-excel/ 
...
Poniższy przykład pokazuje, jak scalić NUMBERS z EXCEL w Aspose.Cells for Python via Java.
...
Chcesz programowo scalić NUMBERS z EXCEL? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
