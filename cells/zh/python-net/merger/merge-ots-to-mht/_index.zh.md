...
description: Aspose Excel。 Python Aspose.Cells. 将 OTS 合并为 MHT 保存格式。 Python 将 OTS 合并为 MHT 格式。将 Python 中的 OTS 合并到 MHT。OTS 合并。
...
{{% blocks/products/pf/agp/content h2="将 Python 中的 OTS 合并为 MHT" %}}
...
{{% cells-merger title="将 OTS 合并到 MHT 的示例代码（Python）" InputFormat="ots" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
