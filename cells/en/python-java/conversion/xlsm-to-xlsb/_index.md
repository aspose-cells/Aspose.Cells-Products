...
url: /python-java/conversion/xlsm-to-xlsb/
description: Sample code for xlsm to xlsb Python conversion. Use API example code for batch xlsm files to xlsb conversion within Python application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert XLSM to XLSB Using Python" %}}

 In order to convert XLSM to XLSB, we will use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLSM to XLSB via Python" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert XLSM to XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xlsb" IsLandingPage="true" language="python" %}}
