...
ต้องการแปลงไฟล์ XML เป็น OTS ด้วยโปรแกรมใช่ไหม? นักพัฒนาสามารถแปลง XML เป็น OTS ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด (รหัส C++)
...
1.  แปลง XML เป็น OTS โดยเรียกใช้เมธอด Save()
