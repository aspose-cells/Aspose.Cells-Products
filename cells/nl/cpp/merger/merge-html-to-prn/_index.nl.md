...
description: Aspose Excel. C++ Aspose.Cells. Voeg HTML samen naar PRN-opslagformaat. C++ Combineer HTML naar PRN-formaat. Voeg HTML samen met PRN in C++. HTML Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u HTML samenvoegt met PRN via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u HTML programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
