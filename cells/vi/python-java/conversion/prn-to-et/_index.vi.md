...
description: Aspose Excel. Chuyển đổi PRN sang ET nhanh chóng và dễ dàng với Aspose.Cells. Python PRN sang ET. Python Lưu PRN vào ET. Lưu PRN dưới dạng ET bằng Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi PRN sang ET trong Python" h2="Thư viện Python tốc độ cao để chuyển đổi PRN sang ET. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất PRN, ET và nhiều định dạng khác bằng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi PRN sang ET bằng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu PRN vào ET số Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi PRN sang ET trong Python.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển PRN sang ET" %}}
