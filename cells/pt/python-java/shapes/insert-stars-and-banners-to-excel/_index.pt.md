---
title: Insira estrela/banner no Excel usando Python via Java
weight: 381
description: Python via Java código fonte para inserir Estrela/Banner no Excel.
keywords: [Python Aspose.Cells., Python add Star/Banner., Python insert Star/Banner., Python create Star/Banner]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insira estrela/banner no Excel usando Python via Java" h2="Insira estrela/banner usando Aspose.Cells\' API sem nenhum software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir estrela/banner em arquivo Excel usando Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir estrela/banner em arquivo Excel usando Python via Java" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Utilize o[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) para inserir Estrela/Banner na planilha selecionada
...
código de exemplo abaixo demonstra como inserir um "mais matemático". Para mais tipos, consulte "Visão geral dos tipos de estrelas e banners" abaixo.

{{% blocks/products/pf/agp/code-block title="Inserir Estrela/Banner - Python via Java" offSpacer="" %}}
