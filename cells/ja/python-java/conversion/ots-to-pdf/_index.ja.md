...
{{% blocks/products/pf/agp/content h2="Python を使用して OTS を PDF に変換する" %}}
...
次の例は、OTS を Python の PDF に変換する方法を示しています。
...
{{% cells-convert title="OTS を PDF に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="pdf" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でOTSをPDFに変換する方法" %}}
...
{{% blocks/products/pf/agp/content h2="OTS を PDF に変換する Python ライブラリ" %}}
