...
url: /es/cpp/merger/merge-json-to-mhtml/ 
...
El siguiente ejemplo demuestra cómo fusionar JSON con MHTML en Aspose.Cells for C++.
...
{{% cells-merger title="Código de muestra para fusionar JSON con MHTML en C++" InputFormat="json" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar JSON con MHTML a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar JSON con MHTML mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para fusionar JSON con MHTML" %}}
