---
title: "TXT konvertálása FODS-re a következőn keresztül: Java "
url: /hu/java/conversion/txt-to-fods/ 
description: Minta Java konverziós kód a TXT formátumhoz FODS fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására FODS-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TXT konvertálása FODS-re a következőn keresztül: Java" h2="TXT-ből FODS-be Java konverzió egyetlen vagy több oldal konvertálásához FODS-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="TXT konvertálása FODS-re a következővel: Java" %}}

 Ahhoz, hogy a TXT-t FODS-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TXT konvertálása FODS-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják a TXT fájlt FODS-re.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat FODS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott FODS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT to FODS Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// mentse a TXT-t FODS-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT-ből FODS-be konvertáló élő bemutatók" sectionDescription="[A TXT konvertálása FODS-re](https://products.aspose.app/cells/conversion/txt-to-fods) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a TXT fájlt, és azonnal FODS formátumba konvertálódik." >}}
