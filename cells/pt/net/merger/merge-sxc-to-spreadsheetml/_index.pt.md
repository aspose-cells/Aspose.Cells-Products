---
title: Mesclar SXC para SPREADSHEETML - Combine SXC para SPREADSHEETML em C#
url: /pt/net/merger/merge-sxc-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita SXC para o formato de salvamento SPREADSHEETML. C# Combine SXC para o formato SPREADSHEETML. Mesclar SXC para SPREADSHEETML em C#. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC para SPREADSHEETML em C# Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar SXC com SPREADSHEETML em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar SXC para SPREADSHEETML. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo SPREADSHEETML. Se você desenvolver código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla SXC com SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar SXC para SPREADSHEETML em C#" InputFormat="sxc" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC para SPREADSHEETML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SXC para SPREADSHEETML programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar SXC para SPREADSHEETML" %}}
