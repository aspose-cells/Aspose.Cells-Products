...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu čísel NUMBERS do formátu ET, což umožňuje bezproblémové ukládání dat NUMBERS do formátu ET pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte ČÍSLA na ET v C++" h2="Vysoce výkonný převod čísel na ET pomocí knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Převod ČÍSEL na ET pomocí C++" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte si ČÍSLA na ET v C++" %}}

Následující příklad ukazuje, jak převést ČÍSLA na ET v kódu C++.
...
Potřebujete programově převést soubory NUMBERS do formátu ET? Vývojáři na webu C++ mohou snadno převést soubory NUMBERS do formátu ET pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod ČÍSEL na ET" %}}
