...
weight: 50
description: Python via .Net source code untuk memasukkan ListBox(Form control) ke dalam Excel.
---
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan ListBox(Form control) ke dalam File Excel Menggunakan Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan ListBox(Form control) ke file Excel menggunakan Python via .Net" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan penambahan shapecollection[metode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_list_box/#int-int-int-int-int-int) untuk menyisipkan ListBox(Kontrol formulir) di lembar kerja yang dipilih.
