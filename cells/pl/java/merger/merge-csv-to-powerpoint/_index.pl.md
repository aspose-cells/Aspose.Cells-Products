...
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online CSV do formatu zapisu POWERPOINT. Java Połącz CSV do formatu POWERPOINT. Połącz CSV z POWERPOINT w Java. CSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz CSV z POWERPOINT w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić CSV z POWERPOINT w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć CSV z POWERPOINT. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku POWERPOINT. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy CSV z POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z POWERPOINT w Java" InputFormat="csv" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić CSV z POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić CSV z POWERPOINT? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do połączenia CSV z POWERPOINT" %}}
