...
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés XLSB POWERPOINT mentési formátumba. C# A XLSB kombinálása POWERPOINT formátumba. A XLSB egyesítése a C#-es POWERPOINT-tal. XLSB Egyesítés.
...
A következő példa bemutatja, hogyan egyesítheti a XLSB-es számot a POWERPOINT-tal a Aspose.Cells-es for .NET-ben.
...
{{% cells-merger title="Ingyenes online a XLSB egyesítéséhez POWERPOINT a C#-ben" InputFormat="xlsb" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLSB és a POWERPOINT egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLSB-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
