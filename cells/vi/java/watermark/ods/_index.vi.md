---
title:  Thủy văn ODS via Java
weight: 1040
description: Java mã mẫu để thêm hoặc xóa hình mờ vào tệp ODS trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Thêm hình mờ văn bản vào ODS via Java" h2="Xây dựng các ứng dụng Java của riêng bạn để tạo hình mờ cho các tệp ODS bằng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách tạo mờ tệp ODS bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để thêm hình mờ vào ODS via Java" %}}
...
1.  Lưu sổ làm việc ở định dạng ODS
...
{{% blocks/products/pf/agp/code-block title="Thêm Watermark vào ODS - Java" offSpacer="" %}}
