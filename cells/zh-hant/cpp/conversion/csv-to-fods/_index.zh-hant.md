...
description: Aspose Excel。此綜合解決方案為 C++ 開發人員提供了一種完全整合的方法，可將 CSV 轉換為 FODS 格式，從而能夠使用 Aspose.Cells 庫將 CSV 數據無縫保存為 0761533681533676136481 資料無縫代碼實現。
...
{{% blocks/products/pf/agp/content h2="將 CSV 儲存到 FODS，即 C++" %}}

以下範例示範如何在 C++ 中將 CSV 轉換為 FODS。
...
需要透過程式將 CSV 檔案轉換為 FODS 檔案嗎？ C++ 開發人員只需幾行程式碼即可輕鬆將 CSV 轉換為 FODS。
...
1. 使用工作簿載入 CSV 檔案。
1. 呼叫 Save() 方法將 CSV 轉換為 FODS。
1. 取得CSV到FODS的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="使用 C++ 庫將 CSV 轉換為 FODS" %}}
