...
{{% blocks/products/pf/agp/content h2="Sla FODS op in WORD in C++" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar WORD in C++.
...
Moet je bestanden met de extensie FODS programmatisch converteren naar WORD? Ontwikkelaars van C++ kunnen bestanden met de extensie FODS eenvoudig converteren naar WORD met slechts een paar regels code.
