...
url: /tr/cpp/merger/merge-excel-to-fods/ 
...
Aşağıdaki örnek, EXCEL'in Aspose.Cells for C++'de FODS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 EXCEL'i programlı olarak FODS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i FODS ile birleştirmek için C++ kitaplığı" %}}
