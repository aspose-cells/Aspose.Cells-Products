...
Нужно программно конвертировать XML-файлы в ET? .NET разработчики могут легко загружать и преобразовывать XML в ET, написав всего несколько строк кода.
