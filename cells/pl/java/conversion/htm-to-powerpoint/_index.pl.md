...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM do PowerPointa za pomocą Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM do programu POWERPOINT w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować plik HTM na plik POWERPOINT w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik HTM do formatu PowerPoint via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki HTM do formatu POWERPOINT? Programiści Java mogą łatwo przekonwertować pliki HTM do formatu POWERPOINT za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji HTM do POWERPOINT" %}}
{{% blocks/products/pf/agp/text %}}
