---
title:  Birleştirme ODS Dosyalar via Java
weight: 6270
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment üzerinde ODS belgelerini birleştirmek için Java örnek kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS Biçimlerini Java\'de birleştir" h2="Sunucu tarafı Java API\'leri kullanılarak yerel ODS belge birleştirme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODS Dosyalarını Java\'de Birleştirme Adımları" %}}
...
+ İlk ODS dosyasını bir Workbook sınıfı örneği ile yükleyin.
+ İkinci ODS belgesini bir Workbook sınıfı örneği ile yükleyin.
+ Combine() yöntemini kullanarak dosyaları birleştirin.
birleştirilmiş ODS dosyasını belirtilen yola kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi ODS Birleşme Canlı Demoları" sectionDescription=" ODS belgelerimizi hemen şimdi ziyaret ederek birleştirin[Canlı Demolar web sitesi](https://products.aspose.app/cells/merger). Canlı demo aşağıdaki avantajlara sahiptir" >}}
