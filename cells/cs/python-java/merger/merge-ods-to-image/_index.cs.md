---
title: Sloučit ODS s IMAGE – Sloučit ODS s IMAGE v Python
url: /cs/python-java/merger/merge-ods-to-image/ 
description: Aspose Excel. Python Aspose.Cells. Zdarma online sloučení ODS do formátu uložení OBRÁZKU. Python Zkombinujte ODS do formátu IMAGE. Sloučit ODS do IMAGE v Python. ODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS do IMAGE pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS s IMAGE v Python Online zdarma" %}}

Následující příklad ukazuje, jak sloučit ODS do IMAGE v Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení ODS s IMAGE. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru IMAGE. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí ODS do IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení ODS do IMAGE v Python" InputFormat="ods" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit ODS s IMAGE přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit ODS s IMAGE programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Python knihovna ke sloučení ODS do IMAGE" %}}
