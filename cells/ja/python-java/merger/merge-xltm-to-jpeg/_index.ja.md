...
url: /ja/python-java/merger/merge-xltm-to-jpeg/ 
...
次の例は、Aspose.Cells for Python via Java で XLTM を JPEG にマージする方法を示しています。
...
XLTMをJPEGにプログラムで結合する必要がありますか？基本的な文書の結合と連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
