---
title: C# XLSX a XLT - XLSX a XLT Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato XLT, permitindo o salvamento perfeito de dados XLSX no formato XLT usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a XLT em C#" %}}

exemplo a seguir demonstra como converter XLSX em XLT em C#.
...
{{% cells-convert title="Código de exemplo para converter XLSX em XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX em XLT por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX em XLT programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em XLT em apenas algumas linhas de código.
...
1.  Converta XLSX para XLT chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em XLT" %}}
