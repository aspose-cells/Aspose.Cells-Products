---
title:  Mesclar EXCEL para TSV via Python
url: /pt/python-java/merger/merge-excel-to-tsv/ 
description: Mesclar EXCEL para TSV Online gratuitamente. Free Online EXCEL para TSV Fusão. Mescle EXCEL para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar EXCEL para TSV em Python.
...
{{% cells-merger title="Aplicativo gratuito para mesclar EXCEL para TSV online" InputFormat="xlsx" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
