---
title:  Fusionner JSON à XLSX via C++
url: /fr/cpp/merger/merge-json-to-xlsx/ 
description: Fusionnez JSON à XLSX en ligne gratuitement. Gratuit en ligne JSON à XLSX Fusion. Fusionnez JSON vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner JSON à XLSX dans C++.
...
{{% cells-merger title="Application gratuite pour fusionner JSON à XLSX en ligne" InputFormat="json" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
