...
weight: 320
description: C# ซอร์สโค้ดเพื่อแก้ไขหรือดู ODS รูปแบบข้อมูลเมตาบน .NET Framework, .NET Core, Mono หรือแพลตฟอร์ม Xamarin
...
{{< blocks/products/pf/i18n/upper-banner h1="แยก ODS ข้อมูลเมตา via .NET" h2="สร้างแอป .NET ของคุณเองเพื่อเพิ่ม แก้ไข ลบ หรือแยกข้อมูลเมตาจากไฟล์ ODS โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
+ โหลด ODS พร้อมอินสแตนซ์ของสมุดงาน
