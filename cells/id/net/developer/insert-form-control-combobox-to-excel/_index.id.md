...
weight: 20
description: Kode sumber C# untuk memasukkan ComboBox ke Excel pada .NET Framework, .NET Core, Mono atau Platform Xamarin.
keywords: [C# Aspose.Cells., c# add ComboBox into Excel., c# insert ComboBox into Excel., c# create ComboBox in Excel]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan ComboBox ke Excel via .NET" h2="Masukkan ComboBox menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan ComboBox ke File Excel Menggunakan C#" %}}
 ...
 Untuk memasukkan ComboBox ke file excel, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan ComboBox ke file Excel melalui C#" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[tambahkan metode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcombobox) untuk menyisipkan ComboBox di lembar kerja yang dipilih
...
{{% blocks/products/pf/agp/code-block title="Masukkan Kotak Kombo - C#" offSpacer="" %}}
