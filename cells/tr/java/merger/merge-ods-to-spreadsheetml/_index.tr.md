---
title: ODS'i SPREADSHEETML ile birleştirin - ODS'i SPREADSHEETML ile Java'de birleştirin
url: /tr/java/merger/merge-ods-to-spreadsheetml/ 
description: Aspose excel. Java Aspose.Cells. ODS'i SPREADSHEETML kaydetme biçimiyle Ücretsiz Çevrimiçi Birleştirme. Java ODS'i SPREADSHEETML biçiminde birleştirin. ODS'i SPREADSHEETML ile Java'de birleştirin. ODS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="ODS\'i SPREADSHEETML ile Java Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in SPREADSHEETML ile Aspose.Cells for Java'de nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i SPREADSHEETML ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından SPREADSHEETML dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. ODS'i SPREADSHEETML ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i SPREADSHEETML ile Java\'de Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS SPREADSHEETML via Java ile Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i SPREADSHEETML ile birleştirmek için Java kitaplığı" %}}
