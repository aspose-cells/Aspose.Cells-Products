---
title: C# PRN naar MARKDOWN - PRN naar MARKDOWN Converter
...
{{% blocks/products/pf/agp/content h2="Sla PRN op als MARKDOWN in C#" %}}

Het volgende voorbeeld laat zien hoe u PRN naar MARKDOWN kunt converteren in C#.
...
{{% blocks/products/pf/agp/content h2="PRN converteren naar MARKDOWN via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u PRN-bestanden programmatisch naar MARKDOWN converteren? .NET-ontwikkelaars kunnen PRN eenvoudig laden en converteren naar MARKDOWN in slechts een paar regels code.
...
1.  Converteer PRN naar MARKDOWN door de Workbook.Save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van PRN naar MARKDOWN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliotheek om PRN naar MARKDOWN te converteren" %}}
