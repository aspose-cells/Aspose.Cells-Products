...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLTM を XLSB にすばやく簡単に変換します。Python XLTM を XLSB に変換します。Python XLTM を XLSB に保存します。Python Excel ライブラリを使用して、XLTM を XLSB として保存します。
