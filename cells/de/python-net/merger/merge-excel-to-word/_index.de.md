...
url: /de/python-net/merger/merge-excel-to-word/ 
...
Das folgende Beispiel zeigt, wie man EXCEL in Aspose.Cells for Python via .NET mit WORD zusammenführt.
...
Müssen Sie EXCEL programmgesteuert mit WORD zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs können mit nur wenigen Codezeilen erstellt werden.
