...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na SXC za pomocą Aspose.Cells. Python MHT na SXC. Python Zapisz MHT na SXC. Zapisz MHT jako SXC, używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj MHT na SXC za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem SXC w Python" %}}

Poniższy przykład ilustruje sposób konwersji MHT na SXC w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji MHT na SXC" %}}
