...
{{% blocks/products/pf/agp/content h2="Sla TSV op in ET in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar ET in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je TSV naar ET via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u TSV-bestanden programmatisch naar ET converteren? Ontwikkelaars van Java kunnen TSV-bestanden eenvoudig met een paar regels code naar ET converteren.
