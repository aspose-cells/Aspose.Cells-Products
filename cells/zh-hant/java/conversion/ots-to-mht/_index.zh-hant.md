---
title: Java OTS 至 MHT - OTS 至 MHT 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 MHT。Java OTS 到 MHT。 Java 將 OTS 儲存到 MHT。使用 Java 將 OTS 儲存為 MHT。
...
{{% blocks/products/pf/agp/content h2="將OTS儲存為Java中的MHT" %}}

以下範例示範如何將 Java 中的 OTS 轉換為 MHT。
...
{{% cells-convert title="將 OTS 轉換為 MHT 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="mht" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 OTS 轉換為 MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 OTS 檔案轉換為 MHT？ Java 開發人員只需幾行程式碼即可輕鬆將 OTS 轉換為 MHT。
