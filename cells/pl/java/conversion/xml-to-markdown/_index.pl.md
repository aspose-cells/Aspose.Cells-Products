...
{{% blocks/products/pf/agp/content h2="Konwertuj XML do MARKDOWN używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XML do MARKDOWN w Java" %}}
...
Trzeba programowo przekonwertować pliki XML do formatu MARKDOWN? Programiści Java mogą łatwo przekonwertować pliki XML do formatu MARKDOWN za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XML do MARKDOWN" %}}
{{% blocks/products/pf/agp/text %}}
