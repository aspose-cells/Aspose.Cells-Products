---
title: Voeg NUMBERS samen tot TXT - Combineer NUMBERS tot TXT in C++
url: /nl/cpp/merger/merge-numbers-to-txt/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online NUMMERS samenvoegen tot TXT saveformat. C++ Combineer NUMMERS tot formaat TXT. NUMBERS samenvoegen tot TXT in C++. NUMMERS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="NUMMERS samenvoegen tot TXT in C++ Online gratis" %}}

Het volgende voorbeeld laat zien hoe NUMBERS kan worden samengevoegd tot TXT in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om NUMBERS samen te voegen tot TXT. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand TXT. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat NUMBERS samenvoegt tot TXT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om NUMMERS samen te voegen tot TXT in C++" InputFormat="numbers" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="NUMMERS samenvoegen tot TXT via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u NUMBERS programmatisch samenvoegen tot TXT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om NUMBERS samen te voegen tot TXT" %}}
