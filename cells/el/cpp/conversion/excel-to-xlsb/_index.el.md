...
description: Aspose Excel. Μετατρέψτε το EXCEL σε XLSB γρήγορα και εύκολα με το Aspose.Cells. C++ EXCEL σε XLSB. C++ Αποθήκευση EXCEL σε XLSB. Αποθηκεύστε το EXCEL χρησιμοποιώντας το C++.
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή EXCEL σε XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xlsb" IsLandingPage="true" language="cpp" %}}
