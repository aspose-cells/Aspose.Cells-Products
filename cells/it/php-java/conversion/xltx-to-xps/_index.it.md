---
title: PHP da XLTX a XPS - da XLTX a XPS Convertitore
description: Aspose Excel. Converti XLTX in XPS in modo rapido e semplice con Aspose.Cells. PHP da XLTX a XPS. PHP Salva da XLTX a XPS. Salva XLTX come XPS utilizzando PHP.
...
{{% blocks/products/pf/agp/content h2="Come convertire XLTX in XPS tramite PHP" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file XLTX in XPS a livello di codice? Gli sviluppatori PHP possono caricare e convertire facilmente XLTX in XPS in poche righe di codice.
...
1.  Converti XLTX in XPS chiamando il metodo di salvataggio della cartella di lavoro.
1.  Ottieni il risultato della conversione da XLTX a XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria PHP per convertire XLTX in XPS" %}}
