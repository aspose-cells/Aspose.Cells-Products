---
title: Převodník PHP MHTML na ET – MHTML na ET
description: Aspose Excel. Převeďte MHTML na ET rychle a snadno pomocí Aspose.Cells. PHP MHTML na ET. PHP Uložit MHTML do ET. Uložte MHTML jako ET pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na ET přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na ET programově? Vývojáři PHP mohou snadno načíst a převést MHTML na ET v několika řádcích kódu.
...
1.  Převeďte MHTML na ET voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na ET" %}}
