...
{{% blocks/products/pf/agp/content h2="Jak wstawić kostkę do pliku Excel za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić Cube do pliku Excel za pośrednictwem Python" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), aby wstawić kostkę w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Włóż kostkę - Python" offSpacer="" %}}
