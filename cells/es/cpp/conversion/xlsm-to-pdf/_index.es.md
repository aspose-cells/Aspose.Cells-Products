---
title: Convierta XLSM a PDF a través de la aplicación C++ 
url: /es/cpp/conversion/xlsm-to-pdf/ 
description: Ejemplo de código de conversión C++ para documento XLSM a formato PDF. Los programadores pueden usar este código fuente para la conversión por lotes de XLSM a PDF dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente archivos XLSM a PDF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLSM usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (PDF).1. El archivo PDF se guardará en la ruta especificada.1. Abra el archivo PDF en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLSM a PDF C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de la conversión de XLSM a PDF" sectionDescription="[Convertir XLSM a PDF](https://products.aspose.app/cells/conversion/xlsm-to-pdf) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo XLSM, se convertirá instantáneamente a PDF." >}}
