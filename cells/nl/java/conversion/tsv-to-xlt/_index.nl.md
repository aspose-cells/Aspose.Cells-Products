...
{{% blocks/products/pf/agp/content h2="Sla TSV op in XLT in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar XLT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar XLT of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TSV programmatisch converteren naar XLT? Ontwikkelaars van Java kunnen bestanden met de extensie TSV eenvoudig converteren naar XLT met slechts een paar regels code.
