...
Trzeba programowo przekonwertować pliki IMAGE do OTS? Programiści C++ mogą łatwo przekonwertować pliki IMAGE do OTS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj IMAGE na OTS wywołując metodę Save().
