---
title: Convertidor PHP ODS a MHTML - ODS a MHTML
description: Aspose Excel. Convierta ODS a MHTML rápida y fácilmente con Aspose.Cells. PHP ODS a MHTML. PHP Guarde ODS a MHTML. Guarde ODS como MHTML usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir ODS a MHTML mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos ODS a MHTML mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente ODS a MHTML en tan solo unas pocas líneas de código.
...
1.  Convierta ODS a MHTML llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de ODS a MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir ODS a MHTML" %}}
