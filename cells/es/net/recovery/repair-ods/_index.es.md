---
title: "C# Reparar ods: recuperar y reparar archivos ods dañados"
url: /es/net/recovery/repair-ods/ 
description: C# Aspose.Cells. Reparación de ods. Arreglar el archivo ods. herramienta de recuperación de ods. Odds corrupción. Restaurar datos de Ods. recuperación de archivos ods. Recuperar archivos ods corruptos.
...
¿Necesita reparar el archivo ods mediante programación? Los desarrolladores de .NET pueden cargar y reparar fácilmente archivos ods con solo unas pocas líneas de código.
...
{{% cells-recovery title="Código de muestra para reparar el archivo ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="net" %}}    
    
{{% blocks/products/pf/agp/content h2="Biblioteca .NET para reparar el archivo ODS" %}}
