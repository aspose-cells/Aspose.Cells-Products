...
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi ODS ke format XLS, memungkinkan penyimpanan data ODS ke format XLS dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan ODS menjadi XLS di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi ODS ke XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, XLS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Konversikan ODS ke XLS menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke XLS di Java" %}}

Contoh berikut menunjukkan cara mengkonversi ODS menjadi XLS di Java.
...
Perlu mengkonversi file ODS ke XLS secara terprogram? Pengembang Java dapat dengan mudah mengkonversi ODS ke XLS hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi ODS menjadi XLS" %}}
{{% blocks/products/pf/agp/text %}}
