...
{{< blocks/products/pf/i18n/upper-banner h1="แปลง MHT เป็น EXCEL ใน C#" h2="ไลบรารีความเร็วสูง C# สำหรับแปลง MHT เป็น EXCEL นี่คือซอฟต์แวร์ระดับมืออาชีพสำหรับนำเข้าและส่งออก MHT, EXCEL และรูปแบบอื่นๆ อีกมากมายบนเฟรมเวิร์ก .NET, .NET Core หรือ Mono Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
ต้องการแปลงไฟล์ MHT เป็น EXCEL โดยทางโปรแกรมหรือไม่ นักพัฒนา .NET สามารถโหลดและแปลง MHT เป็น EXCEL ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงไฟล์ MHT เป็นไฟล์ EXCEL โดยเรียกใช้เมธอด Workbook.Save
