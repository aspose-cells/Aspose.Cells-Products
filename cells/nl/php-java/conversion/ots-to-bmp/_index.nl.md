...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar BMP met Aspose.Cells. PHP OTS naar BMP. PHP Bewaar OTS naar BMP. Sla OTS op als BMP met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar BMP te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar BMP converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar BMP in slechts een paar regels code.
...
1.  Converteer OTS naar BMP door de opslagmethode van Workbook aan te roepen.
