...
description: Aspose Эксель. Python Aspose.Cells. Объедините FODS и PNG в формате сохранения. Python Объедините форматы FODS и PNG. Объедините FODS и PNG в Python. FODS Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините FODS с PNG, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините FODS и PNG в Python." %}}

В следующем примере показано, как объединить FODS и PNG в Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Пример кода для объединения чисел FODS и PNG в Python" InputFormat="fods" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Как объединить FODS с PNG через Python" %}}
