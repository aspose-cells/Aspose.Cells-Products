---
title: HTML から ODS を結合 - HTML から ODS を C# に結合
url: /ja/net/merger/merge-html-to-ods/ 
description: Aspose エクセル。 C# Aspose.Cells。HTML を ODS の保存形式にマージします。 C# HTML と ODS の形式を結合します。 HTML から ODS を C# に結合します。HTML を結合します。
...
次の例は、HTML を Aspose.Cells for .NET の ODS にマージする方法を示しています。
