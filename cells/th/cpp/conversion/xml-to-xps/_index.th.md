---
title: C++ XML เป็น XPS - ตัวแปลง XML เป็น XPS ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง XML เป็น XPS saveformat C++ รูปแบบ XML เป็น XPS บันทึก XML เป็น XPS C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XML เป็น XPS ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง XML เป็น XPS โดยเรียกเมธอด Save()
