---
title: C# OTS till JSON - OTS till JSON Converter
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera OTS till JSON-format, vilket möjliggör sömlös sparning av OTS-data i JSON-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till JSON i C#" %}}

Följande exempel visar hur man konverterar OTS till JSON i C#.
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till JSON via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till JSON programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till JSON på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C#-bibliotek för att konvertera OTS till JSON" %}}
