---
title: Java MHT na XLSB - Konwerter online MHT na XLSB
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwersja MHT do formatu zapisu XLSB. Java MHT do formatu XLSB. Zapisz MHT do XLSB Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT do XLSB w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować MHT na XLSB w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować MHT na XLSB. Prześlij swój plik MHT, a następnie po prostu zapisz go jako plik XLSB. Zarówno do odczytu MHT, jak i zapisu XLSB można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie XLSB będą identyczne z oryginalnym dokumentem MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji MHT na XLSB online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xlsb" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHT na XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki MHT na XLSB? Programiści Java mogą łatwo przekonwertować MHT na XLSB w zaledwie kilku wierszach kodu.
...
1.  Konwertuj MHT na XLSB, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji MHT na XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji MHT na XLSB" %}}
{{% blocks/products/pf/agp/text %}}
