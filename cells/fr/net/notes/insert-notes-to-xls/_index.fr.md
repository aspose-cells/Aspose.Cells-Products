...
{{% blocks/products/pf/agp/content h2="Insérer des notes dans le fichier XLS à l\'aide de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C# exemple de code pour insérer et supprimer des notes dans le fichier XLS" offSpacer="" %}}
