---
title: Voeg ODS samen met PRN - Combineer ODS met PRN in Python
url: /nl/python-net/merger/merge-ods-to-prn/ 
description: Aspose Excel. Python Aspose.Cells. Gratis online samenvoegen ODS naar PRN-opslagformaat. Python Combineer ODS naar PRN-formaat. Samenvoegen ODS naar PRN in Python. ODS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg ODS samen met PRN met behulp van Python" %}}

 Hoe voeg ik ODS samen met PRN? Met de bibliotheek Aspose.Cells for Python via .NET kunt u eenvoudig ODS programmatisch samenvoegen met PRN met een paar regels code.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaard formaten. U kunt Aspose.Cells for Python via .NET installeren vanaf<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , gebruik commando als:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Voeg gratis ODS samen met PRN in Python online" %}}

Het volgende voorbeeld laat zien hoe u ODS kunt samenvoegen met PRN in Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om ODS samen te voegen met PRN. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het PRN-bestand. Als u code ontwikkelt in Python, is dit eenvoudiger dan het klinkt. Zie voorbeeld Python dat ODS samenvoegt met PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om ODS samen te voegen met PRN in Python" InputFormat="ods" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe ODS samen te voegen met PRN via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u ODS programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om ODS samen te voegen met PRN" %}}
