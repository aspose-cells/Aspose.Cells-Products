---
title: Slå samman HTML till HTM - Kombinera HTML till HTM i C#
url: /sv/net/merger/merge-html-to-htm/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge HTML till HTM saveformat. C# Kombinera HTML till HTM-format. Slå samman HTML till HTM i C#. HTML Slå samman.
...
Följande exempel visar hur man slår samman HTML till HTM i Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis online för att slå samman HTML till HTM i C#" InputFormat="html" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman HTML till HTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du slå samman HTML till HTM programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
