---
title: C++ ČÍSLA na FODS - ČÍSLA na FODS Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu čísel NUMBERS do formátu FODS, což umožňuje bezproblémové ukládání dat NUMBERS do formátu FODS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{% blocks/products/pf/agp/content h2="Uložte si ČÍSLA na FODS v C++" %}}

Následující příklad ukazuje, jak převést ČÍSLA na FODS z C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod ČÍSEL na FODS. Nahrajte svůj soubor ČÍSEL a poté jej jednoduše uložte jako soubor FODS. Jak pro čtení NUMBERS, tak pro zápis FODS můžete použít plně kvalifikované názvy souborů. Obsah a formátování výstupu FODS bude shodné s původním dokumentem NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod čísel na FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="fods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést ČÍSLA na FODS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory NUMBERS na FODS? Vývojáři s C++ mohou snadno převést soubory NUMBERS na FODS pomocí několika řádků kódu.
...
1.  Převeďte ČÍSLA na FODS voláním metody Save().
1.  Získejte výsledek převodu NUMBERS na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod ČÍSEL na FODS" %}}
