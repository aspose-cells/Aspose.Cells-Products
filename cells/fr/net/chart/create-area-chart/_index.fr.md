...
description: C# Exemple de code pour créer des graphiques en aires vers Excel à l’aide de la bibliothèque .NET. Utilisez ce code pour créer un graphique en aires dans MS Excel dans VB.NET, Asp.NET ou toute application basée sur .NET.
...
Il est facile pour les développeurs de créer un graphique en aires en exécutant différentes applications de reporting pour le traitement des données en quelques lignes de code seulement.
