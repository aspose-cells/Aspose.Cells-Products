---
title: PHP MHTML a IMAGEN - Convertidor de MHTML a IMAGEN
description: Aspose Excel. Convierta MHTML a IMAGEN rápida y fácilmente con Aspose.Cells. PHP MHTML a IMAGEN. PHP Guarde MHTML en IMAGEN. Guarde MHTML como IMAGEN usando PHP.
...
{{% cells-convert title="Código de muestra para convertir MHTML a IMAGEN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="png" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir MHTML a IMAGEN mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos MHTML a IMAGEN mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente MHTML a IMAGEN en tan solo unas pocas líneas de código.
...
1.  Convierta MHTML a IMAGEN llamando al método de guardar del Libro de trabajo.
1.  Obtenga el resultado de la conversión de MHTML a IMAGEN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir MHTML a IMAGEN" %}}
