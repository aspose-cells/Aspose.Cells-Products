...
次の例は、Aspose.Cells for Python via Java の HTML に OTS をマージする方法を示しています。
...
OTSをHTMLにプログラムでマージする必要がありますか？基本的なドキュメントのマージと連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
