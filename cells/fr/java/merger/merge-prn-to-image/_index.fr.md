---
title: Fusionner PRN à IMAGE - Combiner PRN à IMAGE dans Java
url: /fr/java/merger/merge-prn-to-image/ 
description: Aspose Excel. Java Aspose.Cells. Fusion gratuite en ligne PRN au format de sauvegarde IMAGE. Java Combinez le format PRN au format IMAGE. Fusionner PRN à IMAGE en Java. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à IMAGE dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN avec IMAGE dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN à IMAGE. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier IMAGE. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne PRN à IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner PRN à IMAGE en Java" InputFormat="prn" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner PRN à IMAGE via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner PRN à IMAGE par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner PRN à IMAGE" %}}
