...
Excel dosyalarını programatik olarak MHT'ye dönüştürmeniz mi gerekiyor? .NET geliştirici, sadece birkaç satır kodla Excel dosyalarını kolayca yükleyip MHT'ye dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını MHT formatına dönüştürün.
