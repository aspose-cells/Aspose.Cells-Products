---
title:  Объединить ODS с JSON через C++
...
В следующем примере показано, как объединить ODS с JSON в C++.
...
{{% cells-merger title="Бесплатное приложение для объединения ODS с JSON онлайн" InputFormat="ods" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
