...
weight: 6070
description: C++ código de exemplo para desbloquear arquivo XLSM protegido por senha em C++ Ambiente de tempo de execução para Windows 32 bits, Windows 64 bits e Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloqueie os arquivos XLSM via C++" h2="Remova a proteção das planilhas do Excel, incluindo o arquivo XLSM, usando a Biblioteca C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
1.  Carregue o arquivo bloqueado XLSM usando CreateIWorkbook.
1.  Chame a função Unprotect() para desbloquear.
1.  Defina a senha como NULL usando SetPassword.
1.  Salve o arquivo XLSM em um local especificado.
