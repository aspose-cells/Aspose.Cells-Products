---
title:  Połącz OTS z PPTX przez C++
...
Poniższy przykład pokazuje, jak scalić OTS z PPTX w C++.
...
{{% cells-merger title="Darmowa aplikacja do łączenia OTS z PPTX on-line" InputFormat="ots" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia OTS z PPTX" %}}
