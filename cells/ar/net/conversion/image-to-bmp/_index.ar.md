...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل الصورة إلى BMP في C#" h2="مكتبة C# عالية السرعة لتحويل الصور إلى BMP. هذا حل برمجي احترافي لاستيراد وتصدير الصور، وBMP، والعديد من التنسيقات الأخرى على منصات .NET Framework، و.NET Core، وMono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="IMAGE" >}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى BMP برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى BMP بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الصورة إلى BMP عن طريق استدعاء طريقة Workbook.Save.
