---
title: HTML を NUMBERS に結合 - HTML を C# の NUMBERS に結合
url: /ja/net/merger/merge-html-to-numbers/ 
description: Aspose エクセル。 C# Aspose.Cells。無料オンライン HTML を NUMBERS 保存形式にマージします。 C# HTML を NUMBERS 形式に結合します。 HTML を C# の NUMBERS にマージします。 HTML マージします。
...
{{% blocks/products/pf/agp/content h2="HTML をオンラインで無料で C# の番号に結合します" %}}

次の例は、HTML を Aspose.Cells for .NET の NUMBERS にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、HTML を NUMBERS にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルを結合し、それを NUMBERS ファイルに保存します。 C# でコードを開発する場合、これは思っているより簡単です。 HTML を NUMBERS にマージする C# の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="HTML をオンラインで C# の NUMBERS に無料でマージ" InputFormat="html" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="HTML を C# 経由で NUMBERS に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML をプログラムで NUMBERS にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2=".NET を NUMBERS にマージするライブラリ" %}}
