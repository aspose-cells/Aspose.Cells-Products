...
url: /es/python-java/merger/merge-numbers-to-md/ 
...
El siguiente ejemplo demuestra cómo fusionar NÚMEROS con MD en Aspose.Cells for Python via Java.
...
¿Necesita fusionar NÚMEROS con MD mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Las API se pueden crear con solo unas pocas líneas de código.
