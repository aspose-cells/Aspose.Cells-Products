...
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG au format ODS, permettant un enregistrement transparent des données JPG au format ODS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG sous ODS dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en ODS en C#.
...
1.  Convertissez le JPG au format ODS en appelant la méthode Workbook.Save.
