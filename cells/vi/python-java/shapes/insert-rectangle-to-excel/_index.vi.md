...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addRectangle(int,%20int,%20int,%20int,%20int,%20int)) để chèn một Hình chữ nhật trong trang tính đã chọn.
