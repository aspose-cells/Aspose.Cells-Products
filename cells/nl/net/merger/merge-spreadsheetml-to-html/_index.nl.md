---
title: Voeg SPREADSHEETML samen met HTML - Combineer SPREADSHEETML met HTML in C#
url: /nl/net/merger/merge-spreadsheetml-to-html/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen SPREADSHEETML naar HTML saveformat. C# Combineer SPREADSHEETML tot formaat HTML. Samenvoegen SPREADSHEETML naar HTML in C#. SPREADSHEETML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg SPREADSHEETML samen met HTML in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe SPREADSHEETML kan worden samengevoegd tot HTML in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om SPREADSHEETML samen te voegen tot HTML. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand HTML. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat SPREADSHEETML samenvoegt tot HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om SPREADSHEETML samen te voegen tot HTML in C#" InputFormat="xml" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML samen te voegen tot HTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SPREADSHEETML programmatisch samenvoegen met HTML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om SPREADSHEETML samen te voegen tot HTML" %}}
