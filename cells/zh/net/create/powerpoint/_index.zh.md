---
title: 创建 POWERPOINT - 在 C# 中创建 POWERPOINT 文件
description: Aspose Excel。 C# 创建 POWERPOINT 文件。创建 POWERPOINT C#。C# POWERPOINT 创建者。在 C# 中创建 POWERPOINT。使用 C# 生成 POWERPOINT 文件。
...
{{% blocks/products/pf/agp/content h2="如何在 C# 中创建 POWERPOINT" %}}

{{% blocks/products/pf/agp/text %}}

开发人员只需几行代码即可轻松地在运行不同的报告应用程序中创建、加载、修改和转换 POWERPOINT 文件以进行数据处理。
...
1. 使用 Save 方法将工作簿另存为 POWERPOINT 文件。

{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 C# 中创建 POWERPOINT 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# 库创建 POWERPOINT 文件" %}}
