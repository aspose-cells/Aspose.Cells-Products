---
title: Java XLTM เป็น MHT - XLTM เป็น MHT Converter
description: Aspose เอ็กเซล. แปลง XLTM เป็น MHT อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Java XLTM เป็น MHT Java บันทึก XLTM ไปที่ MHT. บันทึก XLTM เป็น MHT โดยใช้ Java
...
{{< blocks/products/pf/i18n/upper-banner h1="แปลง XLTM เป็น MHT ใน Java" h2="ไลบรารี Java ความเร็วสูงสำหรับการแปลง XLTM เป็น MHT นี่คือโซลูชันซอฟต์แวร์ระดับมืออาชีพสำหรับการนำเข้าและส่งออก XLTM, MHT และรูปแบบอื่นๆ อีกมากมายโดยใช้ Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="บันทึก XLTM ไปที่ MHT ใน Java" %}}
...
{{% blocks/products/pf/agp/content h2="วิธีการแปลง XLTM เป็น MHT via Java" %}}
...
1.  แปลง XLTM เป็น MHT โดยการเรียกเมธอด Workbook.save
