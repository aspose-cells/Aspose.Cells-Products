...
{{% blocks/products/pf/agp/content h2="Преобразовать JPG в PDF, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните JPG-файл в PDF в Java" %}}

Следующий пример демонстрирует, как преобразовать JPG в формат PDF в формате Java.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать JPG в PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы JPG в формат PDF? Разработчики, использующие формат Java, могут легко преобразовать JPG в формат PDF всего несколькими строками кода.
