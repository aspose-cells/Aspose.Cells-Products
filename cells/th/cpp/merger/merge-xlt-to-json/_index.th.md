...
ตัวอย่างต่อไปนี้สาธิตวิธีการรวม XLT ถึง JSON ใน C++
...
{{% cells-merger title="แอพฟรีที่จะรวม XLT ถึง JSON ออนไลน์" InputFormat="xlt" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
