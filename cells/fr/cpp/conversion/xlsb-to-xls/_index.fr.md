---
title: C++ XLSB à XLS - Convertisseur en ligne XLSB à XLS
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde XLS. Format C++ XLSB à XLS. Enregistrez XLSB à XLS C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à XLS dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en XLS en C++.
...
Besoin de convertir les fichiers XLSB en XLS par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en XLS en seulement quelques lignes de code.
