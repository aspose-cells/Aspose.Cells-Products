...
Precisa converter arquivos OTS para PDF programaticamente? Desenvolvedores que trabalham com C++ podem converter facilmente arquivos OTS para PDF com apenas algumas linhas de código.
...
1.  Converta OTS para PDF chamando o método Save().
