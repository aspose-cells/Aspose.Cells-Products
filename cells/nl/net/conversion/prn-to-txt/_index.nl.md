...
{{< blocks/products/pf/i18n/upper-banner h1="Zet PRN om naar TXT in C#" h2="Snelle C#-bibliotheek voor het converteren van PRN naar TXT. Dit is een professionele softwareoplossing voor het importeren en exporteren van PRN, TXT en vele andere formaten op .NET Framework, .NET Core of Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PRN" >}}
...
{{% blocks/products/pf/agp/content h2="Sla PRN op als TXT in C#" %}}

Het volgende voorbeeld laat zien hoe u PRN naar TXT kunt converteren in C#.
...
Wilt u PRN-bestanden programmatisch naar TXT converteren? .NET-ontwikkelaars kunnen PRN eenvoudig laden en converteren naar TXT in slechts een paar regels code.
...
1.  Converteer PRN naar TXT door de Workbook.Save-methode aan te roepen.
