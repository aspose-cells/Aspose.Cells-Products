...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met HTM in C++" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met HTM in Aspose.Cells for C++.
...
{{% cells-merger title="Voorbeeldcode om TXT samen te voegen met HTM in C++" InputFormat="txt" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe TXT samenvoegen naar HTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u TXT programmatisch samenvoegen met HTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
