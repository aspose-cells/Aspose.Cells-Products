---
title:  แทรกรูปภาพลงใน Excel โดยใช้ Python via .Net
weight: 200
description: Python via ซอร์สโค้ด .Net เพื่อแทรกรูปภาพลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกรูปภาพลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกรูปภาพลงในไฟล์ Excel ด้วย Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ picturecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/) เพื่อแทรกรูปภาพในเวิร์กชีตที่เลือก
