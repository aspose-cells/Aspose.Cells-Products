---
title: Unisci JPEG a JPG - Combina JPEG a JPG in C#
url: /it/net/merger/merge-jpeg-to-jpg/ 
description: Aspose Excel. C# Aspose.Cells. Unisci online gratuito JPEG al formato di salvataggio JPG. C# Combina JPEG in formato JPG. Unisci JPEG a JPG in C#. JPEG Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci JPEG a JPG in C# online gratuitamente" %}}

L'esempio seguente mostra come unire JPEG a JPG in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire JPEG a JPG. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo in un file JPG. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedi l'esempio C# che unisce JPEG a JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuito online per unire JPEG a JPG in C#" InputFormat="jpg" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire JPEG a JPG tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Devi unire JPEG a JPG a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria per unire JPEG a JPG" %}}
