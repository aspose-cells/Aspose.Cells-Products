...
{{% blocks/products/pf/agp/content h2="وفر XLTX إلى FODS في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل XLTX إلى FODS في C#.
...
{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل XLTX إلى FODS عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTX إلى FODS عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمطورين .NET تحميل وتحويل XLTX إلى FODS بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1.  قم بتحميل ملف XLTX بنسخة المصنف
1.  حول XLTX إلى FODS عن طريق استدعاء Workbook.Save method

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل XLTX إلى FODS" %}}
