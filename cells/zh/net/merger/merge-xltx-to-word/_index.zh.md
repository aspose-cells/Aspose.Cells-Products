---
title: 合并 XLTX 到 WORD - 将 XLTX 合并到 C# 中的 WORD
url: /zh/net/merger/merge-xltx-to-word/ 
description: Aspose Excel。 C# Aspose.Cells。免费在线合并XLTX到WORD保存格式。 C# 将XLTX合并为WORD格式。将 XLTX 合并到 C# 中的 WORD。 XLTX 合并。
...
{{% blocks/products/pf/agp/content h2="免费在线将XLTX合并到C#中的WORD" %}}

下面的例子演示如何将XLTX合并到WORD中Aspose.Cells for .NET。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLTX 合并到 WORD。上传文件，调用Workbook.Combine方法合并文件，然后保存为WORD文件。如果您在 C# 中开发代码，这会比听起来更简单。请参阅 C# 将 XLTX 合并到 WORD 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线将XLTX合并到C#中的WORD" InputFormat="xltx" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通过C#将XLTX合并到WORD" %}}
