---
title: Converti SPREADSHEETML in EMF tramite Java 

description: Esempio di codice di conversione Java per il formato SPREADSHEETML in file EMF. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in EMF all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti SPREADSHEETML in EMF tramite Java" h2="Conversione da SPREADSHEETML a EMF Java per convertire pagine singole o multiple in EMF utilizzando la libreria On-premise Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire SPREADSHEETML in EMF utilizzando Java" %}}

 Per eseguire il rendering di SPREADSHEETML in EMF, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire SPREADSHEETML in EMF tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente il file SPREADSHEETML in EMF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file SPREADSHEETML con un'istanza di Workbook1. Seleziona l'impostazione predefinita o qualsiasi foglio di lavoro dalla raccolta1. Crea e imposta l'oggetto di ImageOrPrintOptions1. Crea SheetRender con Foglio di lavoro e oggetti ImageOrPrintOptions1. Chiama il metodo SheetRender.toImage per salvare il risultato in formato EMF
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML a EMF Java codice sorgente di conversione" offSpacer="" %}}

```cs
// caricare il file SPREADSHEETML di cui eseguire il rendering
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML a EMF Conversione demo dal vivo" sectionDescription="[Converti SPREADSHEETML in EMF](https://products.aspose.app/cells/conversion/spreadsheetml-to-emf) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file SPREADSHEETML, verrà convertito istantaneamente in EMF." >}}
