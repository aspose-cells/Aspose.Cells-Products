---
title: 創建FODS - 在C#中創建FODS文件
description: Aspose Excel。 C# 創建 FODS 文件。創建FODS C#。C# FODS創建者。在C#中創建FODS。使用C#生成FODS文件。
...
{{% blocks/products/pf/agp/content h2="如何在C#中創建FODS" %}}
...
{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 C# 中創建 FODS 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#庫創建FODS文件" %}}
