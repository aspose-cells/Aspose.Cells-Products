...
description: Aspose Excel. Převeďte XLSB na DOCX rychle a snadno pomocí Aspose.Cells. Python XLSB na DOCX. Python Ušetřete XLSB na 197 3481761 jako 197 348161 Python 481 pomocí Python.
...
{{% blocks/products/pf/agp/content h2="Uložit XLSB až DOCX v Python" %}}
...
{{% cells-convert title="Ukázkový kód pro převod XLSB na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="docx" IsLandingPage="true" language="pythonjava" %}}
