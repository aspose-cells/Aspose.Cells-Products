---
title:  XLSX belgesini açmadan C++ üzerinden arayın
weight: 9280
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı üzerindeki XLSX dosyasındaki kalıplı kelimeleri aramak için C++ örnek kod.
---
...
Bir IWorkbook sınıfını başlatarak XLSX dosyasını yükleyin.
...
+ XLSX dosyasını IWorkbook->Save(.) yöntemini kullanarak kaydedin.
