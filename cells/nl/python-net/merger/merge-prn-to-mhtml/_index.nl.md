...
Het volgende voorbeeld laat zien hoe u PRN kunt samenvoegen tot MHTML in Aspose.Cells for Python via .NET.
...
Wilt u PRN programmatisch samenvoegen met MHTML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
