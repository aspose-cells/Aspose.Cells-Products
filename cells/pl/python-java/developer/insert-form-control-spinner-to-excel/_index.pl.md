...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić przycisk pokrętła (formant formularza) w wybranym arkuszu.
