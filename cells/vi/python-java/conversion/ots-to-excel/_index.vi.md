...
{{% blocks/products/pf/agp/content h2="Chuyển đổi OTS sang EXCEL bằng Thư viện Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu OTS vào EXCEL trong Thư viện Excel Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi OTS sang EXCEL trong thư viện excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Thư viện Excel để chuyển đổi OTS sang EXCEL" %}}
