---
title: PRN'yi DIF ile birleştir - PRN'yi DIF ile C# olarak birleştir
url: /tr/net/merger/merge-prn-to-dif/ 
description: Aspose excel. C# Aspose.Cells. PRN'yi DIF kaydetme biçimine Ücretsiz Çevrimiçi Birleştirme. C# PRN'yi DIF biçiminde birleştirin. PRN'yi C#'de DIF ile birleştirin. PRN Birleştirin.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi DIF\'de C# Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin DIF ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi DIF'de birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından DIF dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. PRN'yi DIF ile birleştiren C# örneğine bakın.
...
PRN'yi programlı olarak DIF ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
