...
url: /vi/python-net/merger/merge-json-to-mht/ 
...
Ví dụ sau đây minh họa cách hợp nhất JSON với MHT trong Aspose.Cells for Python via .NET.
...
Cần hợp nhất JSON vào MHT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API có thể được thực hiện chỉ với vài dòng mã.
