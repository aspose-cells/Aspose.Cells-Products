...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na XLS za pomocą Aspose.Cells. Java MHT na XLS. Java Zapisz MHT na XLS. Zapisz MHT jako XLS, używając Java.
...
{{% blocks/products/pf/agp/content h2="Konwertuj MHT na XLS za pomocą Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem XLS w Java" %}}

Poniższy przykład ilustruje sposób konwersji MHT na XLS w Java.
...
Chcesz programowo przekonwertować pliki MHT na XLS? Programiści Java mogą łatwo przekonwertować MHT na XLS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji MHT na XLS" %}}
{{% blocks/products/pf/agp/text %}}
