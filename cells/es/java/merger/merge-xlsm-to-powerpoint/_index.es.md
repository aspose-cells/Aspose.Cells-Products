---
title:  Combinar XLSM a POWERPOINT via Java
...
El siguiente ejemplo muestra cómo combinar XLSM con POWERPOINT en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLSM a POWERPOINT en línea" InputFormat="xlsm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
