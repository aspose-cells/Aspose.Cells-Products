---
title:  Hợp nhất PRN thành CSV via Java
url: /vi/java/merger/merge-prn-to-csv/ 
description: Hợp nhất PRN thành CSV Trực tuyến miễn phí. PRN trực tuyến miễn phí tới CSV Sáp nhập. Hợp nhất PRN thành Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS, v.v.
---
...
Ví dụ sau minh họa cách hợp nhất PRN thành CSV trong Java.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất PRN thành CSV trực tuyến" InputFormat="prn" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
