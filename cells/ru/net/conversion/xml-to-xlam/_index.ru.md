...
{{% blocks/products/pf/agp/content h2="Преобразование XML в XLAM с использованием C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в XLAM в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат XLAM в формате C#.
...
1.  Преобразовать XML в формат XLAM, вызвав метод Workbook.Save.
