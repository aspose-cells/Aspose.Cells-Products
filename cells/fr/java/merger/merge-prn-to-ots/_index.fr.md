---
title: Fusionner PRN à OTS - Combiner PRN à OTS dans Java
url: /fr/java/merger/merge-prn-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Fusion gratuite en ligne PRN au format de sauvegarde OTS. Java Combinez le format PRN au format OTS. Fusionner PRN à OTS en Java. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à OTS en utilisant Java" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à OTS en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN à OTS dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN à OTS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier OTS. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne PRN à OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner PRN à OTS en Java" InputFormat="prn" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner PRN à OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner PRN à OTS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner PRN à OTS" %}}
