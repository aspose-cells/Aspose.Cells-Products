...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para ver XLS a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells facilita a los desarrolladores la visualización del archivo XLS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLS en una instancia de Workbook1. Cree una instancia de HtmlSaveOptions y establezca la propiedad ExportHeadings en verdadero1. Guarde el archivo XLS en formato HTML usando el método Workbook.Save1. Cargue el HTML resultante en el navegador predeterminado con Process.Start
...
// guardar el archivo XLS en formato HTML
