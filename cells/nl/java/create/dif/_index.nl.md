---
title: Maak DIF aan - Maak DIF-bestand aan in Java
description: Aspose Excel. Java Maak DIF snel en eenvoudig een bestand met Aspose.Cells. Genereer een DIF-bestand met Java. Maak DIF aan in Java. Java DIF Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak DIF-bestand aan in Java" h2="Snelle Java-bibliotheek voor het maken van DIF-bestand. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u DIF aanmaakt in Java" %}}
...
1. Sla de werkmap op in de indeling DIF met behulp van de methode save().

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u het bestand DIF maakt in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java-bibliotheek om DIF-bestand te maken" %}}
{{% blocks/products/pf/agp/text %}}
