...
{{% blocks/products/pf/agp/content h2="Python を使用して XLS を GIF に変換します" %}}
...
次の例は、XLS を Python の GIF に変換する方法を示しています。
...
{{% cells-convert title="XLS を GIF に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="gif" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でXLSをGIFに変換する方法" %}}
