---
title: C++ أرقام إلى TSV - أرقام على الإنترنت لتحويل TSV
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ قم بتحويل الأرقام إلى TSV saveformat. C++ أرقام إلى تنسيق TSV. احفظ الأرقام في TSV C++.
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في TSV في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل الأرقام إلى TSV في C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل NUMBERS إلى TSV. قم بتحميل ملف NUMBERS الخاص بك ، ثم احفظه كملف TSV. لكل من قراءة الأرقام و TSV الكتابة ، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق الإخراج TSV مطابقًا لوثيقة NUMBERS الأصلية.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني ونموذج رمز لتحويل الأرقام إلى TSV عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tsv" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل الأرقام إلى TSV عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات NUMBERS إلى TSV برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل الأرقام إلى TSV في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الأرقام إلى TSV باستدعاء طريقة Save ().
