---
title: Gộp XLSX thành HTM - Gộp XLSX thành HTM thành C#
url: /vi/net/merger/merge-xlsx-to-htm/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí XLSX thành định dạng lưu HTM. C# Gộp XLSX sang định dạng HTM. Hợp nhất XLSX thành HTM trong C#. XLSX Hợp nhất.
...
Ví dụ sau minh họa cách hợp nhất XLSX thành HTM trong Aspose.Cells for .NET.
...
{{% cells-merger title="Trực tuyến miễn phí để hợp nhất XLSX với HTM trong C#" InputFormat="xlsx" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XLSX với HTM qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất XLSX với HTM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
