...
description: Sample Java conversion code for XLT format to MARKDOWN file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to MARKDOWN within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert XLT to MARKDOWN Using Java" %}}
 ...
 In order to render XLT to MARKDOWN, we’ll use
