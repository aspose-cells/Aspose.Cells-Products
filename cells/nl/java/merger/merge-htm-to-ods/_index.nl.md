---
title: HTM samenvoegen naar ODS - HTM combineren naar ODS in Java
url: /nl/java/merger/merge-htm-to-ods/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online HTM samenvoegen naar ODS opslagformaat. Java Combineer HTM naar formaat ODS. HTM samenvoegen naar ODS in Java. HTM samenvoegen.
...
Het volgende voorbeeld laat zien hoe u HTM samenvoegt met ODS in Aspose.Cells for Java.
...
{{% cells-merger title="Gratis online om HTM samen te voegen met ODS in Java" InputFormat="htm" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen tot ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met ODS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
