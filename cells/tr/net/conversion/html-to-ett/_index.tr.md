...
description: Aspose Excel'de. Aspose.Cells ile HTML'i hızlı ve kolay bir şekilde ETT'ye dönüştürün. C# HTML'i ETT'ye dönüştürün. C# HTML'i ETT'ye kaydedin. C#'i kullanarak HTML'i ETT olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="HTML\'i C#\'de ETT\'ye kaydedin" %}}

Aşağıdaki örnekte HTML'in C#'de ETT'ye nasıl dönüştürüleceği gösterilmektedir.
...
{{% cells-convert title="HTML\'i ETT\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="ett" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="HTML\'i ETT\'ye dönüştürmek için C# kitaplığı" %}}
