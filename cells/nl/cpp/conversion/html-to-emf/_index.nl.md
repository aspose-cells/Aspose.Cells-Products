---
title: C++ HTML tot EMF - HTML tot EMF Converter
...
{{% blocks/products/pf/agp/content h2="Sla HTML op in EMF in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar EMF in C++.
...
{{% blocks/products/pf/agp/content h2="Hoe u HTML naar EMF kunt converteren via C++" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar EMF? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar EMF met slechts een paar regels code.
...
1.  Converteer HTML naar EMF door de Save()-methode aan te roepen.
