---
title: A MHTML egyesítése SPREADSHEETML-be – a MHTML egyesítése SPREADSHEETML-be a C#-ben
url: /hu/net/merger/merge-mhtml-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés MHTML SPREADSHEETML mentési formátumba. C# A MHTML kombinálása SPREADSHEETML formátumba. A MHTML egyesítése SPREADSHEETML-be a C#-ben. MHTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a MHTML-et a SPREADSHEETML-be a C#-ben online" %}}

A következő példa bemutatja, hogyan egyesítheti a MHTML-et a SPREADSHEETML-be a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a MHTML és a SPREADSHEETML egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SPREADSHEETML fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a MHTML-et a SPREADSHEETML-lel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a MHTML SPREADSHEETML-be a C#-ben" InputFormat="mhtml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML egyesítése SPREADSHEETML-be a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML és a SPREADSHEETML egyesítéséhez" %}}
