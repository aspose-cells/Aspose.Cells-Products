---
title: PHP MHTML do XML – MHTML do XML Converter
description: Aspose Excel. Převeďte MHTML na XML rychle a snadno pomocí Aspose.Cells. PHP MHTML do XML. PHP Uložit MHTML do XML. Uložte MHTML jako XML pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML do XML přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory do XML programově? Vývojáři PHP mohou snadno načíst a převést MHTML do XML v několika řádcích kódu.
...
1.  Převeďte MHTML na XML voláním metody uložení sešitu.
