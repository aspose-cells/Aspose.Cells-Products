---
title:  Wstaw pole wyboru (kontrolka formularza) do programu Excel via .NET
weight: 30
description: C# kod źródłowy do wstawiania CheckBox (Form Control) do programu Excel na platformach .NET Framework, .NET Core, Mono lub Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw pole wyboru (kontrolka formularza) do programu Excel via .NET" h2="Wstawiaj obiekty za pomocą interfejsów API po stronie serwera bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Jak wstawić pole wyboru (kontrolka formularza) do pliku programu Excel przy użyciu numeru C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić CheckBox (formant kontrolny) do pliku Excel za pośrednictwem C#" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj[dodaj metodę](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) aby wstawić pole wyboru (kontrolka formularza) w wybranym arkuszu
...
{{% blocks/products/pf/agp/code-block title="Wstaw pole wyboru (kontrola formularza) — C#" offSpacer="" %}}
