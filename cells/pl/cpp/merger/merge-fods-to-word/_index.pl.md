...
url: /pl/cpp/merger/merge-fods-to-word/ 
...
Poniższy przykład pokazuje, jak scalić FODS z WORD w Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć numer FODS z programem WORD? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia FODS z WORD" %}}
