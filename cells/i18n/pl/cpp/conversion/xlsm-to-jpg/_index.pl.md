---
title: Konwertuj XLSM na JPG za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlsm-to-jpg/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSM do formatu JPG. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji plików XLSM do JPG w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSM na JPG przez C++" h2="Wydajna konwersja plików XLSM do JPG przy użyciu biblioteki C++ bez konieczności instalowania programu Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSM na JPG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (JPG).1. Plik JPG zostanie zapisany pod określoną ścieżką.1. Otwórz plik JPG w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSM do JPG C++ Kod źródłowy konwersji" offSpacer="" %}}
