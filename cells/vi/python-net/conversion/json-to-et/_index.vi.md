---
title: Python JSON sang ET - Bộ chuyển đổi JSON sang ET trực tuyến
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Trực tuyến miễn phí Python Chuyển đổi JSON sang định dạng lưu ET. Python JSON sang định dạng ET. Lưu JSON thành ET Python.
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi JSON sang ET Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="et" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi JSON sang ET" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi các tệp JSON sang ET theo chương trình? Python nhà phát triển có thể dễ dàng tải và chuyển đổi JSON sang ET chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi JSON sang ET bằng cách gọi phương thức Workbook.save.
1.  Lấy kết quả chuyển đổi từ JSON sang ET.
