...
{{% blocks/products/pf/agp/content h2="كيفية استخراج بيانات XLSX الوصفية باستخدام Java" %}}

 من أجل الحصول على البيانات الوصفية لملف XLSX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات استخراج البيانات الوصفية لـ XLSX عبر Java" %}}
...
+ احفظ معلومات بيانات XLSX الوصفية
