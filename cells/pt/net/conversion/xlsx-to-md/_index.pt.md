...
description: Aspose Excel. Converta XLSX em MD de forma rápida e fácil com Aspose.Cells. C# XLSX em MD. C# Salve XLSX em MD. Salve XLSX como MD usando C#.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX no MD em C#" %}}

O exemplo a seguir demonstra como converter XLSX em MD em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX em MD. Carregue seu arquivo XLSX e simplesmente salve-o como arquivo MD. Tanto para leitura XLSX quanto para gravação MD você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação do MD de saída serão idênticos ao documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemplo de código para converter XLSX em MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para MD programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em MD em apenas algumas linhas de código.
...
1.  Converta XLSX em MD chamando o método Workbook.Save.
