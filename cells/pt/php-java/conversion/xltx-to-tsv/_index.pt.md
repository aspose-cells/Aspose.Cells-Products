---
title: Conversor PHP XLTX para TSV - XLTX para TSV
description: Aspose Excel. Converta XLTX em TSV de forma rápida e fácil com Aspose.Cells. PHP XLTX em TSV. PHP Salve XLTX em TSV. Salve XLTX como TSV usando PHP.
...
{{% cells-convert title="Exemplo de código para converter XLTX em TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="tsv" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLTX em TSV via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em TSV programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em TSV em apenas algumas linhas de código.
...
1.  Converta XLTX em TSV chamando o método save da pasta de trabalho.
