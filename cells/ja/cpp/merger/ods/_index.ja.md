---
title:  C++ 経由で ODS ファイルを結合
description: C++ サンプルコードは、Windows 32 ビット、Windows 64 ビット、および Linux 64 ビットの C++ ランタイム環境上の ODS ドキュメントを結合します。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS 形式を C++ に結合" h2="サーバー側 C++ API を使用した ODS ドキュメントの結合。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="C++を使用してODSファイルをマージする方法" %}}
 ...
 ODS ファイルをマージするには、次を使用します。<a href="https://products.aspose.com/cells/cpp">Aspose.Cells for C++</a> API は、機能が豊富で強力で使いやすいドキュメント結合プラットフォームです。 API for C++最新バージョンを直接ダウンロードできます。開くだけです。<a href="https://www.nuget.org/packages/aspose.cells">NuGet</a>パッケージマネージャー、検索<b>Aspose.Cells.Cpp</b>そしてインストールします。パッケージ マネージャー コンソールから次のコマンドを使用することもできます。
...
{{% blocks/products/pf/agp/feature-section-col title="ODS のファイルを C++ に結合する手順" %}}
...
{{% cells-merger title="Excelファイルをオンラインで結合する無料アプリ" InputFormat="ods" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
