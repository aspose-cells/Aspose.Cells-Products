---
title: Crear SXC - Crear archivo SXC en Java
description: AsposeExcel. Java Crear archivo SXC. Crear SXC Java. Java SXC Creador. Cree SXC en Java. Genere el archivo SXC usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Crear SXC Archivo en Java" h2="Biblioteca Java de alta velocidad para crear el archivo SXC. Esta es una solución de software profesional para importar y exportar XLSX, PDF y muchos otros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo crear SXC en Java" %}}
...
1.  Guarde el libro de trabajo con el formato SXC utilizando el método save().

{{% blocks/products/pf/agp/code-block title="El código de muestra muestra cómo crear el archivo SXC en Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para crear el archivo SXC" %}}
{{% blocks/products/pf/agp/text %}}
