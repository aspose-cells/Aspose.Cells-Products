...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в XLT, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTML в XLT в Java" %}}
...
Нужно программно преобразовать файлы HTML в XLT? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в XLT всего несколькими строками кода.
