---
title: C# EXCEL à WORD - Convertisseur EXCEL à WORD
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format WORD, permettant un enregistrement transparent des données EXCEL au format WORD à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL sous WORD dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en WORD en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en WORD via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en WORD par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en WORD en quelques lignes de code seulement.
...
1.  Convertissez le fichier EXCEL au format WORD en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion d’EXCEL en WORD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir EXCEL en WORD" %}}
