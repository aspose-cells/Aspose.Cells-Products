...
Ví dụ sau minh họa cách hợp nhất PRN với IMAGE trong Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/content h2=".NET để hợp nhất PRN với IMAGE" %}}
