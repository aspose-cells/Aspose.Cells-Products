---
title: Conversor PHP SXC para SQL - SXC para SQL
description: Aspose Excel. Converta SXC para SQL de forma rápida e fácil com Aspose.Cells. PHP SXC para SQL. PHP Salve SXC no SQL. Salve SXC como SQL usando PHP.
...
Precisa converter arquivos SXC para SQL programaticamente? Os desenvolvedores de PHP podem facilmente carregar e converter SXC em SQL em apenas algumas linhas de código.
...
1.  Converta SXC em SQL chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de SXC para SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter SXC para SQL" %}}
