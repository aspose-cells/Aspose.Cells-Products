...
{{% blocks/products/pf/agp/content h2="Come convertire NUMBERS in XPS utilizzando Java" %}}

 Per eseguire il rendering di NUMBERS in XPS, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire NUMBERS in XPS tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente i file NUMBERS in XPS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file NUMBERS con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione XPS e SaveFormat come parametri1. Controllare il percorso specificato per il file XPS risultante
...
{{% blocks/products/pf/agp/code-block title="NUMBERS in XPS Java codice sorgente di conversione" offSpacer="" %}}

```cs
// caricare il file NUMBERS in un'istanza di Workbook
Workbook book = new Workbook("template.numbers");
// salva NUMERI come XPS
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS alle demo dal vivo di conversione da XPS" sectionDescription="[Converti NUMERI in XPS](https://products.aspose.app/cells/conversion/numbers-to-xps) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file NUMBERS, verrà convertito istantaneamente in XPS." >}}
