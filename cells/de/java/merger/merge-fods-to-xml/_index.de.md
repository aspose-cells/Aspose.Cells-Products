---
title: FODS zu XML zusammenführen – Kombinieren Sie FODS zu XML in Java
url: /de/java/merger/merge-fods-to-xml/ 
description: Aspose Excel. Java Aspose.Cells. Kostenlose Online-Zusammenführung von FODS in das XML-Speicherformat. Java Kombinieren Sie FODS in das XML-Format. FODS in XML in Java zusammenführen. FODS Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie FODS kostenlos online in Java in XML zusammen" %}}

Das folgende Beispiel zeigt, wie FODS in XML in Aspose.Cells for Java zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um FODS in XML zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in einer XML-Datei. Wenn Sie Code in Java entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel Java, das FODS in XML zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlos online zum Zusammenführen von FODS in XML in Java" InputFormat="fods" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie FODS mit XML via Java zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie FODS programmgesteuert in XML zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Java](https://products.aspose.com/cells/java) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Zusammenführen von FODS in XML" %}}
