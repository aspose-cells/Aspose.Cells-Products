---
title: Převeďte XLSX na TABDELIMITED pomocí aplikace C++ 
url: /cs/cpp/conversion/xlsx-to-tabdelimited/ 
description: Ukázkový konverzní kód C++ pro dokument XLSX do formátu TABDELIMITED. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLSX na TABDELIMITED v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLSX na TABDELIMITED pomocí C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu XLSX na TABDELIMITED přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLSX na TABDELIMITED pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLSX pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu k výstupnímu souboru s příponou (TABDELIMITED).1. Soubor TABDELIMITED bude uložen do zadané cesty.1. Otevřete soubor TABDELIMITED v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLSX na TABDELIMITED C++" offSpacer="" %}}
