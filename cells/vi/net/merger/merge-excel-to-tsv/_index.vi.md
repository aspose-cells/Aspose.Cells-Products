---
title: Gộp EXCEL thành TSV - Gộp EXCEL thành TSV vào C#
url: /vi/net/merger/merge-excel-to-tsv/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất EXCEL thành định dạng lưu TSV. C# Kết hợp EXCEL thành định dạng TSV. Hợp nhất EXCEL thành TSV trong C#. Hợp nhất EXCEL.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất EXCEL thành TSV trong C#" %}}

Ví dụ sau đây minh họa cách hợp nhất EXCEL thành TSV trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất EXCEL thành TSV. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu vào tệp TSV. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất EXCEL thành TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp EXCEL về TSV trong C#" InputFormat="xlsx" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp EXCEL về TSV qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp EXCEL thành TSV" %}}
