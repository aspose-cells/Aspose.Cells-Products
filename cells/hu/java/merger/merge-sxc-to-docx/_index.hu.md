---
title: A SXC-DOCX-es számok egyesítése – a SXC-es és a DOCX-es számok egyesítése a Java-ben
url: /hu/java/merger/merge-sxc-to-docx/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés SXC DOCX mentési formátumba. Java A SXC és a DOCX formátum kombinálása. Egyesítse a SXC-DOCX-et a Java-ben. SXC Egyesítse.
keywords: [Aspose Excel., Java Aspose.Cells., Merge SXC to DOCX in Java., Free Online Java Merge SXC to docx., Java Combine SXC to DOCX Online for Free., SXC Merge]
---
...
{{% blocks/products/pf/agp/content h2="A SXC és a DOCX egyesítése a Java használatával" %}}
 ...
 Hogyan egyesíthetem a SXC és a DOCX számokat? A Aspose.Cells for Java könyvtárral egyszerűen egyesítheti a SXC-et a DOCX-es számokkal programozottan néhány sornyi kóddal.[Aspose.Cells for Java](https://products.aspose.com/cells/java) képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Java Excel API nem csak a táblázatformátumok között konvertál, hanem Excel fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, CSV, CSV, CSV, CSV, CSV, SVG, és így tovább, SVG P, 8 PT a választás,3,8 ipari szabvány szerinti dokumentumok cseréjére formátumok. A legújabb verziót közvetlenül a webhelyről töltheti le[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) és telepítse a Maven alapú projekten belül a következő konfigurációk hozzáadásával a pom.xml fájlhoz.
...
A következő példa bemutatja a SXC és a DOCX egyesítését a Aspose.Cells for Java számban.
...
{{% cells-merger title="Ingyenes online a SXC-DOCX-es számok egyesítéséhez a Java-ben" InputFormat="sxc" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A SXC és a DOCX via Java számok egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SXC-et a DOCX-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
