---
title: C++ HTM إلى PDF - محول HTM عبر الإنترنت إلى PDF
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل HTM إلى PDF saveformat. C++ HTM إلى تنسيق PDF. احفظ HTM في PDF C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل HTM إلى PDF في C++" h2="تحويل HTM عالي الأداء إلى PDF باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
هل تحتاج إلى تحويل ملفات HTM إلى PDF برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى PDF في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى PDF باستدعاء طريقة Save ().
