---
title: Převeďte SPREADSHEETML na XLTM pomocí aplikace C++ 

description: Ukázka převodního kódu C++ pro dokument SPREADSHEETML do formátu XLTM. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi SPREADSHEETML na XLTM v jakékoli C++ aplikaci.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SPREADSHEETML na XLTM pomocí C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SPREADSHEETML na XLTM přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor SPREADSHEETML na XLTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SPREADSHEETML pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLTM).1. Soubor XLTM bude uložen do zadané cesty.1. Otevřete soubor XLTM v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SPREADSHEETML na XLTM C++" offSpacer="" %}}
