...
{{% blocks/products/pf/agp/content h2="So gruppieren Sie Formen in einer Excel-Datei mit Python via .Net und heben die Gruppierung auf" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Gruppieren und Aufheben der Gruppierung von Formen in einer Excel-Datei mit Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Formen gruppieren und Gruppierung aufheben – Python via .Net via .NET" offSpacer="" %}}
