---
title: A MHTML-JPEG-es számok egyesítése – a MHTML-es és a JPEG-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-mhtml-to-jpeg/ 
description: Aspose Excel. C# Aspose.Cells. A MHTML és a JPEG mentési formátum egyesítése. C# A MHTML és a JPEG formátum kombinálása. Egyesítse a MHTML-JPEG-et a C#-ben. MHTML Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A MHTML és a JPEG egyesítése a C#-ben" %}}

A következő példa bemutatja a MHTML és a JPEG egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a MHTML-es és a JPEG-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a JPEG fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a MHTML és JPEG számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a MHTML és JPEG közötti egyesítéshez a C#-ben" InputFormat="mhtml" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML és a JPEG egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et a JPEG-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML és JPEG egyesítéséhez" %}}
