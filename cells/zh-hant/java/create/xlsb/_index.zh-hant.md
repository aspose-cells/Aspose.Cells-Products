...
1. 創建一個實例 [工作簿類](https://reference.aspose.com/cells/java/com.aspose.cells/Workbook).1. 使用 getWorksheets.get() 方法訪問相關工作表。1. 選擇相關單元格，使用單元格名稱將值輸入所需的單元格，如 A1、B3 等。1. 使用 save() 方法將工作簿保存為 XLSB 格式。
