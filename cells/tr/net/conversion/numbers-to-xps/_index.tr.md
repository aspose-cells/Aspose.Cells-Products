---
title: C# NUMARALAR'dan XPS'e - NUMARALAR'dan XPS'e Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere, sayıları XPS formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak sayı verilerinin XPS formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="C# numarasına XPS olarak kaydedin." %}}

Aşağıdaki örnek, sayıları C#'den XPS'e nasıl dönüştüreceğinizi göstermektedir.
...
{{% blocks/products/pf/agp/content h2="NUMBERS\'ı C# aracılığıyla XPS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı programlı olarak XPS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyip XPS'e dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="C# kütüphanesi, sayıları XPS\'e dönüştürüyor." %}}
