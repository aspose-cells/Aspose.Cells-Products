...
{{% blocks/products/pf/agp/content h2="Převeďte HTM na TXT v Python" %}}
...
Následující příklad ukazuje, jak převést HTM na TXT v Python via NET.
