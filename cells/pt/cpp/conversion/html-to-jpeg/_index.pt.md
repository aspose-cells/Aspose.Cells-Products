---
title: Converter HTML para JPEG por meio do aplicativo C++ 
weight: 7270
url: /pt/cpp/conversion/html-to-jpeg/ 
description: Exemplo de código de conversão C++ de documento HTML para formato JPEG. Os programadores podem usar esse código-fonte para conversão em lote de HTML para JPEG em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter HTML para JPEG via C++" h2="Conversão de HTML para JPEG de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para JPEG usando C++" %}}

 Para converter HTML para JPEG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML em JPEG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem facilmente converter arquivos HTML em JPEG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo HTML usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (JPEG).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo JPEG em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de HTML para JPEG C++" offSpacer="" %}}
