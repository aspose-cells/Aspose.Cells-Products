...
هل تحتاج إلى تحويل ملفات IMAGE إلى DIF برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى DIF في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى DIF باستدعاء طريقة Save ().
