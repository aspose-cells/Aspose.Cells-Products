---
title: Konwertuj XLSB na SVG za pomocą Python
url: /pl/python-java/conversion/xlsb-to-svg/
description: Przykładowy kod konwersji xlsb do svg Python. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji SVG w aplikacji Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na SVG za pomocą Python" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu SVG przy użyciu Python interfejsów API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na SVG przy użyciu Python" %}}

 Aby przekonwertować XLSB na SVG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSB na SVG za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki XLSB do SVG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem SVG jako parametrem1. Sprawdź określoną ścieżkę wynikowego pliku SVG
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSB na SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="svg" IsLandingPage="true" language="python" %}}
