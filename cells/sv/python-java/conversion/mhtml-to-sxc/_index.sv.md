---
title: Konvertera MHTML till SXC via Python

description: Exempelkod för konvertering från mhtml till sxc Python. Använd API exempelkod för batch-mhtml-filer till sxc-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar MHTML till SXC med Python" %}}

 För att konvertera MHTML till SXC kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera MHTML till SXC via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera MHTML-filer till SXC på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda MHTML-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med SXC-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande SXC-filen
