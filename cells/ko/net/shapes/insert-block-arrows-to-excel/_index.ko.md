...
weight: 338
description: .NET 프레임워크, .NET 코어, Mono 또는 Xamarin 플랫폼에서 블록 화살표를 Excel에 삽입하는 C# 소스 코드.
---
...
+ 색인을 통해 워크시트를 선택합니다.
 + 사용[메소드 추가](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) 선택한 워크시트에 블록 화살표를 삽입하려면
