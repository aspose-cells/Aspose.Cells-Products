...
weight: 80
description: Código fuente C# para insertar etiquetas en Excel en plataformas .NET Framework, .NET Core, Mono o Xamarin.
...
Para insertar una etiqueta en un archivo de Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar etiqueta en un archivo de Excel a través de C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[agregar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addlabel) para insertar una etiqueta en la hoja de trabajo seleccionada
