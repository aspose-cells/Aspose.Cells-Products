...
description: Aspose Excel. Μετατρέψτε το EXCEL σε XML γρήγορα και εύκολα με το Aspose.Cells. C++ EXCEL σε XML. C++ Αποθήκευση του EXCEL σε XML. Αποθηκεύστε το EXCEL ως XML χρησιμοποιώντας C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το EXCEL σε XML στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή EXCEL σε XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xml" IsLandingPage="true" language="cpp" %}}
