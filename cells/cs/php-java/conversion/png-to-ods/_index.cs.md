---
title: Konvertor PHP PNG až ODS - PNG až ODS
description: Aspose Excel. Převeďte PNG na ODS rychle a snadno pomocí Aspose.Cells. PHP PNG na ODS. PHP Uložte PNG na ODS. Uložte ODS jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na ODS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na ODS programově? Vývojáři PHP mohou snadno načíst a převést PNG na ODS v několika řádcích kódu.
...
1.  Převeďte PNG na ODS voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na ODS" %}}
