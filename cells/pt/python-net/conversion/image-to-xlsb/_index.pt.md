...
description: Aspose Excel. Converta IMAGEM em XLSB de forma rápida e fácil com Aspose.Cells. Python IMAGEM em XLSB. Python Salve IMAGEM em XLSB. Salve IMAGEM como XLSB usando Python.
...
{{% blocks/products/pf/agp/content h2="Salve IMAGEM em XLSB em Python" %}}

O exemplo a seguir demonstra como converter IMAGE em XLSB em Python via NET.
...
{{% cells-convert title="Exemplo de código para converter IMAGE em XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xlsb" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para converter IMAGE em XLSB" %}}
