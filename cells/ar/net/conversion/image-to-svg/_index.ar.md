---
title: تحويل C# صورة إلى SVG - صورة إلى SVG
description: Aspose اكسل. قم بتحويل IMAGE إلى SVG بسرعة وسهولة باستخدام Aspose.Cells. C# IMAGE إلى SVG. C# احفظ IMAGE إلى SVG. احفظ IMAGE كـ SVG باستخدام C#.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في SVG في C#" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى SVG في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى SVG عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى SVG برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى SVG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى SVG" %}}
