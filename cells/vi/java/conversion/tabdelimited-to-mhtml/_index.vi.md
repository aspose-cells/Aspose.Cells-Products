---
title: Chuyển đổi TABDELIMITED thành MHTML qua Java 
url: /vi/java/conversion/tabdelimited-to-mhtml/ 
description: Mã chuyển đổi Java mẫu cho định dạng TABDELIMITED thành tệp MHTML. Người lập trình có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang MHTML trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi TABDELIMITED thành MHTML qua Java" h2="TABDELIMITED sang MHTML Java chuyển đổi để chuyển đổi một hoặc nhiều trang sang MHTML bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi TABDELIMITED sang MHTML bằng cách sử dụng Java" %}}

 Để hiển thị TABDELIMITED thành MHTML, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi TABDELIMITED sang MHTML qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java nhà phát triển có thể dễ dàng chuyển đổi tệp TABDELIMITED thành MHTML chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp TABDELIMITED với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Chuyển đường dẫn đầu ra với phần mở rộng MHTML & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp MHTML kết quả
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED thành MHTML Java Mã Nguồn Chuyển đổi" offSpacer="" %}}

```cs
// tải tệp TABDELIMITED trong một phiên bản của Workbook
Workbook book = new Workbook("template.tabdelimited");
// lưu TABDELIMITED dưới dạng MHTML
