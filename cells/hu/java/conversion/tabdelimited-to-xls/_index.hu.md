...
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED konvertálása XLS-re a következőn keresztül: Java" h2="TABDELIMITED XLS Java konverzió egyetlen vagy több oldal XLS formátumba konvertálásához az On-premise Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="A TABDELIMITED konvertálása XLS-re a következővel: Java" %}}

 A TABDELIMITED XLS formátumban való megjelenítéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TABDELIMITED XLS-re konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak TABDELIMITED fájlt XLS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED XLS Java konverziós forráskódra" offSpacer="" %}}

```cs
// töltse be a TABDELIMITED fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tabdelimited");
// a TABDELIMITED mentése XLS-ként
