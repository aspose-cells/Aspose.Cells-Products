---
title: Převodník PHP MHTML na OTS – MHTML na OTS
description: Aspose Excel. Převeďte MHTML na OTS rychle a snadno pomocí Aspose.Cells. PHP MHTML na OTS. PHP Uložit MHTML do OTS. Uložte MHTML jako OTS pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na OTS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory na OTS programově? Vývojáři PHP mohou snadno načíst a převést MHTML na OTS v několika řádcích kódu.
...
1.  Převeďte MHTML na OTS voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na OTS" %}}
