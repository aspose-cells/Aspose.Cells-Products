---
title: 通過 .NET 保護和鎖定 XLSB 文檔 
weight: 5920

description: C# 源代碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上使用密碼鎖定 XLSB 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 加密 XLSB 文件" h2="使用 .NET 庫對包括 XLSB 格式的 Excel 電子表格進行密碼保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1. 使用 XLSB 文件的路徑實例化 Workbook 類1. 獲取默認或任何工作表以添加保護1. 使用 Worksheet.Protect 方法保護工作表1. 使用 Workbook.Protect 方法保護工作簿1. 以 XLSB 格式保存結果
