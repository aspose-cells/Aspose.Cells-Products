---
title: Hoe teken of voeg ik een dubbele rechte pijl in Excel in met Python via .Net
weight: 10
description: Python via .Net-broncode om een dubbele rechte pijl in Excel te tekenen of in te voegen.
...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg een dubbele rechte pijl in Excel in met Python via .Net" h2="Voeg een dubbele rechte pijl in met Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een dubbele rechte pijl in een Excel-bestand kunt invoegen met behulp van Python via .Net" %}}

Om een dubbele rechte pijl in het Excel-bestand in te voegen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het invoegen van een dubbele rechte pijl in een Excel-bestand met behulp van Python via .Net" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de toevoeging van de vormcollectie[methode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) om een dubbele rechte pijl in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Dubbele rechte pijl invoegen - Python via .Net" offSpacer="" %}}
