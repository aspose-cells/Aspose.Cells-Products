---
title: C# ODS para XML - ODS para conversor XML
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato XML, permitindo o salvamento perfeito de dados ODS em formato XML usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter ODS para XML em C#" h2="Biblioteca de alta velocidade C# para conversão de ODS para XML. Esta é uma solução de software profissional para importar e exportar ODS, XML e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Salvar ODS em XML em C#" %}}

O exemplo a seguir demonstra como converter ODS para XML em C#.
...
{{% cells-convert title="Código de exemplo para converter ODS em XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para XML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em XML programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em XML em apenas algumas linhas de código.
...
1.  Converta ODS para XML chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em XML" %}}
