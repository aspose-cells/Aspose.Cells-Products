...
Het volgende voorbeeld laat zien hoe u PRN samenvoegt met XLS in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u PRN programmatisch samenvoegen met XLS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
