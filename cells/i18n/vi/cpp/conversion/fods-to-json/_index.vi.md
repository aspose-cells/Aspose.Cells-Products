...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp FODS sang JSON chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp FODS bằng Factory :: CreateIWorkbook.1. Gọi phương thức Save ().1. Chuyển đường dẫn tệp đầu ra với phần mở rộng tệp (JSON).1. Tệp JSON sẽ được lưu tại đường dẫn đã chỉ định.1. Mở tệp JSON trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi FODS sang JSON C++" offSpacer="" %}}
