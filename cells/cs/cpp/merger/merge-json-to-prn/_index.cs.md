---
title: Sloučit JSON na PRN – Sloučit JSON na PRN v C++
url: /cs/cpp/merger/merge-json-to-prn/ 
description: Aspose Excel. C++ Aspose.Cells. Zdarma online sloučení JSON do formátu uložení PRN. C++ Spojte JSON do formátu PRN. Sloučit JSON na PRN v C++. JSON Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JSON do PRN v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JSON do PRN v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JSON s PRN. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PRN. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JSON do PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JSON do PRN v C++" InputFormat="json" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON do PRN přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit JSON s PRN programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení JSON do PRN" %}}
