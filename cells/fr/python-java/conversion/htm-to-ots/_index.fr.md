---
title: Python HTM en OTS - Convertisseur HTM en OTS
description: Aspose Exceller. Python Exceller. Convertissez HTM en OTS rapidement et facilement avec Aspose.Cells. Python HTM en OTS. Python Enregistrez HTM dans OTS. Enregistrez HTM en tant qu'OTS à l'aide de la bibliothèque Excel Python.
...
{{% cells-convert title="Exemple de code pour convertir HTM en OTS via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="ots" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en OTS via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en OTS par programme ? Les développeurs Python peuvent facilement charger et convertir HTM en OTS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Python Bibliothèque Excel pour convertir HTM en OTS" %}}
