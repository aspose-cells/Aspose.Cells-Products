---
title: C# ODS para DOCX - Online ODS para DOCX Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter ODS para DOCX saveformat. C# ODS a DOCX formato. Salve ODS a DOCX C#.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a DOCX em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter ODS em DOCX em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS em DOCX. Carregue seu arquivo ODS e salve-o como arquivo DOCX. Tanto para a leitura ODS quanto para a escrita DOCX, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação de saída DOCX serão idênticos ao documento ODS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter ODS em DOCX online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para DOCX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para DOCX programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter ODS em DOCX em apenas algumas linhas de código.
...
1.  Converta ODS em DOCX chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para converter ODS em DOCX" %}}
