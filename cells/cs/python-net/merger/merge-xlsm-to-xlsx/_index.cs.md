---
title:  Sloučit XLSM na XLSX přes Python
url: /cs/python-net/merger/merge-xlsm-to-xlsx/ 
description: Sloučit XLSM až XLSX online zdarma. Online zdarma XLSM až XLSX Fúze. Sloučit XLSM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSM až XLSX v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až XLSX online" InputFormat="xlsm" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
