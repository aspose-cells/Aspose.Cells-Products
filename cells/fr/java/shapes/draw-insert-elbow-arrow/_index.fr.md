---
title:  Comment dessiner ou insérer une forme de flèche coudée dans Excel via Java
weight: 30
description: Dessinez ou insérez une forme de flèche coudée en utilisant Aspose.Cells' Java API sans aucun logiciel tel que Microsoft ou Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Comment insérer la forme d\'une flèche coudée dans un fichier Excel à l\'aide de Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) pour insérer la forme d'une flèche coudée dans la feuille de calcul sélectionnée
