---
title: 通过 C++ 应用程序将 XLSB 转换为 XML 
url: /zh/cpp/conversion/xlsb-to-xml/ 
description: XLSB 文档到 XML 格式的示例 C++ 转换代码。程序员可以使用此源代码在任何 C++ 应用程序中进行批量 XLSB 到 XML 的转换。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 开发人员只需几行代码即可轻松地将 XLSB 文件转换为 XML。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 XLSB 文件。1. 调用 Save() 方法。1. 使用 (XML) 文件扩展名传递输出文件路径。1. XML 文件将保存在指定路径。1. 在兼容程序中打开 XML 文件。
...
{{% blocks/products/pf/agp/code-block title="XLSB 到 XML C++ 转换源代码" offSpacer="" %}}
