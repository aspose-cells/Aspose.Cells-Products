---
title: Converter NUMBERS para TIFF via Python

description: Código de amostra para conversão de números para tiff Python. Use o código de exemplo API para arquivos de números de lote para conversão tiff no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter NUMBERS para TIFF usando Python" %}}

 Para converter NUMBERS para TIFF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter NUMBERS em TIFF por meio de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter NUMBERS arquivos para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo NUMBERS com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão TIFF como parâmetro1. Verifique o caminho especificado para o arquivo TIFF resultante
...
{{% cells-convert title="Aplicativo gratuito e código de amostra para converter NUMBERS em TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tiff" IsLandingPage="true" language="python" %}}
