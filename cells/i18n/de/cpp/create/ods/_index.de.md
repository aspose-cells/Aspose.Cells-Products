---
title: Erstellen Sie ODS-Dateien (Openoffice / Lbreoffice) über C++ 
url: /de/cpp/create-ods/ 
description: C++ Beispielcode zum Generieren von ODS-Dateien (Openoffice / Lbreoffice). Verwenden Sie diesen Code zum Erstellen von ODS-Dateien (Openoffice / Lbreoffice) in einer C++-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS-Datei erstellen über C++" h2="Programmgesteuerte Erstellung nativer und leistungsstarker ODS-Tabellen (Openoffice / Lbreoffice) ohne Microsoft Office unter Verwendung der C++-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/code-block title="Der folgende Quellcode zeigt, wie Sie mit C++ eine ODS-Datei (Openoffice / Lbreoffice) erstellen." offSpacer="" %}}
