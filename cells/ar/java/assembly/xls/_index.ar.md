---
title:  إنشاء التقارير في XLS ملفات via Java
weight: 1090
description: نموذج التعليمات البرمجية Java لإنشاء تقارير تنسيق XLS على Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء تقرير مجمع بتنسيق XLS via Java" h2="إنشاء تقارير بتنسيق XLS باستخدام مصدر البيانات والقالب." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات توليد XLS التقارير via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="إنشاء تقارير Excel بتنسيق XLS - Java" offSpacer="" %}}
