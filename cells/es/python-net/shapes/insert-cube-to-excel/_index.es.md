...
weight: 10
description: Python via Código fuente .Net para insertar Cube en Excel.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar un archivo Cube en Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el complemento de la colección de formas.[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) para insertar un cubo en la hoja de trabajo seleccionada.
