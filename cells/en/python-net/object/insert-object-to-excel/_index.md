---
title: How to insert OLE object into Excel via Python via .Net
weight: 10

description: Python via .Net source code to insert OLE object into Excel.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Insert OLE object into Excel using Python via .Net" h2="Insert objects using server-side APIs without any software like Microsoft or Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Insert OLE object into Excel File Using Python via .Net" %}}

 In order to insert OLE object into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert OLE object to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_ole_object/#int-int-int-int-int-int-bytes) to insert an OLE object in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert OLE object - Python via .Net" offSpacer="" %}}

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "InsertOleObjectIntoWorksheet.py" >}}
