...
description: Aspose Excel. Converta XLS em XML de forma rápida e fácil com Aspose.Cells. C++ XLS em XML. C++ Salve XLS em XML. Salve XLS como XML usando C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converta XLS para XML em C++" h2="Conversão de XLS para XML de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converter XLS em XML usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS em XML em C++" %}}

exemplo a seguir demonstra como converter XLS em XML em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS para XML via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em XML programaticamente? Os desenvolvedores do C++ podem converter facilmente o XLS em XML em apenas algumas linhas de código.
...
1.  Converta XLS em XML chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS para XML" %}}
