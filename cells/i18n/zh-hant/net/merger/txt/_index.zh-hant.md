...
+ 製作一份文件作為基礎文件
+ 調用相關方法一一拼接合併文件。
+ 調用 Save() 方法並將文件名（完整路徑）和格式（TXT）作為參數傳遞。
現在您可以在 Microsoft Office、Adobe PDF 或任何其他兼容程序中打開和使用 TXT 文件。
