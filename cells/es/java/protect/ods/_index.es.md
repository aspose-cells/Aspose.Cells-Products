...
weight: 6360
description: Java código de muestra para bloquear el archivo ODS usando la contraseña en Java Entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cifrar ODS Archivos via Java" h2="Proteja con contraseña las hojas de cálculo de Excel, incluido el formato ODS, utilizando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo asegurar el archivo ODS usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para proteger ODS Archivos via Java" %}}
...
1.  Cargue el archivo ODS instanciando la clase Workbook
1.  Utilice el método protect(..) con ProtectionType y Password
1.  Guarde el archivo protegido ODS mediante el método save()
