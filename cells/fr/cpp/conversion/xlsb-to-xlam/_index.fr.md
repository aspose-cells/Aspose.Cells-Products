---
title: C++ XLSB à XLAM - Convertisseur en ligne XLSB à XLAM
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde XLAM. Format C++ XLSB à XLAM. Enregistrez XLSB à XLAM C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à XLAM dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en XLAM en C++.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en XLAM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en XLAM par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en XLAM en seulement quelques lignes de code.
...
1.  Convertissez XLSB en XLAM en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de XLSB en XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir XLSB en XLAM" %}}
