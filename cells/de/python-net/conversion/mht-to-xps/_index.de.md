---
title: Python MHT zu XPS - MHT zu XPS Konverter
description: Aspose Excel. Python Excel. Konvertieren Sie MHT schnell und einfach in XPS mit Aspose.Cells. Python MHT in XPS. Python Speichern Sie MHT in XPS. Speichern Sie MHT als XPS mit der Python Excel-Bibliothek.
...
{{% cells-convert title="Beispielcode zur Konvertierung von MHT in XPS über die Excel-Bibliothek Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xps" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie MHT in XPS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie MHT-Dateien programmgesteuert in XPS konvertieren? Python-Entwickler können MHT mit nur wenigen Codezeilen problemlos in XPS laden und konvertieren.
...
1.  Konvertieren Sie MHT in XPS, indem Sie die Methode Workbook.save aufrufen.
1. Erhalten Sie das Konvertierungsergebnis von MHT in XPS.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel-Bibliothek zum Konvertieren von MHT in XPS" %}}
