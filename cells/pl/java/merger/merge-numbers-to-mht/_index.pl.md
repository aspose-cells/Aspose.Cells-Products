---
title: Połącz NUMERY z MHT - Połącz NUMERY z MHT w Java
url: /pl/java/merger/merge-numbers-to-mht/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne połączenie online NUMBERS do formatu zapisu MHT. Java Połącz NUMERY do formatu MHT. Połącz NUMBERS z MHT w Java. NUMBERS Połącz.
...
{{% cells-merger title="Bezpłatne połączenie online NUMBERS z MHT pod numerem Java" InputFormat="numbers" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić NUMERY z MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć NUMBERS z MHT? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
