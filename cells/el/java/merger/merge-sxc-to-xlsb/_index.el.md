...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση SXC σε μορφή αποθήκευσης XLSB. Java Συνδυάστε τη μορφή SXC με XLSB. Συγχώνευση SXC σε XLSB στο Java. SXC Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση SXC με XLSB στο Java" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση SXC έως XLSB στο Java" InputFormat="sxc" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
