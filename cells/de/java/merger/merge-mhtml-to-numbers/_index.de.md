---
title: MHTML mit NUMBERS zusammenführen – MHTML mit NUMBERS in Java kombinieren
url: /de/java/merger/merge-mhtml-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Kostenlose Online-Zusammenführung von MHTML in das NUMBERS-Speicherformat. Java Kombinieren Sie MHTML mit dem Zahlenformat. MHTML zu NUMBERS in Java zusammenführen. MHTML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie MHTML kostenlos mit NUMBERS in Java online zusammen" %}}

Das folgende Beispiel zeigt, wie MHTML mit NUMBERS in Aspose.Cells for Java zusammengeführt wird.
...
{{% blocks/products/pf/agp/content h2="So führen Sie MHTML mit den Nummern via Java zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie MHTML programmgesteuert mit NUMBERS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Java](https://products.aspose.com/cells/java) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Zusammenführen von MHTML mit NUMBERS" %}}
