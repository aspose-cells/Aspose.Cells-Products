---
title:  إضافة أو إزالة XLSB حاشية via .NET
weight: 6440
description: كود المصدر C# لإضافة وحذف التعليقات التوضيحية بتنسيق XLSB على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="إضافة أو حذف ملاحظة من XLSB عبر C#" %}}
