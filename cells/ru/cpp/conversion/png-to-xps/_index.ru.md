...
Нужно программно конвертировать файлы PNG в XPS? Разработчики C++ могут легко преобразовать PNG в XPS всего за несколько строк кода.
...
1.  Преобразуйте PNG в XPS, вызвав метод Save().
