...
url: /cs/python-java/merger/merge-xlsb-to-xlsx/ 
description: Aspose Excel. Python Aspose.Cells. Online sloučení zdarma XLSB do formátu uložení XLSX. Python Kombinujte formát XLSB až XLSX. Sloučit XLSB až XLSX v Python. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až XLSX pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až XLSX v Python Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLSB až XLSX v Aspose.Cells for Python via Java.
...
{{% cells-merger title="Online zdarma ke sloučení XLSB až XLSX v Python" InputFormat="xlsb" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB na XLSX přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLSB až XLSX? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
