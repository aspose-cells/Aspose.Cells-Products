---
title: Převeďte XLT na PNG pomocí aplikace C++ 
url: /cs/cpp/conversion/xlt-to-png/ 
description: Ukázka převodního kódu C++ pro dokument XLT na formát PNG. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLT na PNG v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLT na PNG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLT pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavit možnosti (PNG).1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor PNG v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLT na PNG C++" offSpacer="" %}}
