...
The following example demonstrates how to convert SPREADSHEETML to TABDELIMITED document format in C#.
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert SPREADSHEETML files to TABDELIMITED in just a few lines of code.
