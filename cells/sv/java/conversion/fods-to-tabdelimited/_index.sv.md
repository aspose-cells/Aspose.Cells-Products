---
title: Konvertera FODS till TABDELIMITED via Java 
url: /sv/java/conversion/fods-to-tabdelimited/ 
description: Exempel på Java-konverteringskod för FODS-format till TABDELLIMITED-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till TABDELIMITED inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera FODS till TABDELIMITED via Java" h2="FODS till TABDELIMITED Java-konvertering för att konvertera enstaka eller flera sidor till TABDELIMITED med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar FODS till TABDELIMITED med Java" %}}

 För att rendera FODS till TABDELIMITED kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera FODS till TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera FODS-filen till TABDELLIMITED på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda FODS-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med TABBDELIMITED-tillägget & SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande TABDELIMITED-filen
...
{{% blocks/products/pf/agp/code-block title="FODS till TABDELLIMITED Java Konverteringskällkod" offSpacer="" %}}

```cs
// ladda FODS-filen i en instans av Workbook
Workbook book = new Workbook("template.fods");
// spara FODS som TABDELLIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS till TABDELIMITED Konvertering Live Demos" sectionDescription="[Konvertera FODS till TABDELIMITED](https://products.aspose.app/cells/conversion/fods-to-tabdelimited) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din FODS-fil, den kommer omedelbart att konverteras till TABDELIMITED." >}}
