---
title:  Wstaw GroupBox (kontrolkę formularza) do programu Excel przy użyciu Python via .Net
weight: 40
description: Python via Kod źródłowy .Net umożliwiający wstawienie GroupBox (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić GroupBox (kontrolkę formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić GroupBox (kontrolkę formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj dodatku do kolekcji kształtów[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_group_box/#int-int-int-int-int-int) aby wstawić GroupBox (kontrolkę formularza) do wybranego arkusza.
...
{{% blocks/products/pf/agp/code-block title="Wstaw GroupBox (kontrolka formularza) - Python via .Net" offSpacer="" %}}
