---
title: EXCEL'i DIF ile birleştir - EXCEL'i Java'de DIF ile birleştir
url: /tr/java/merger/merge-excel-to-dif/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i DIF kaydetme biçimiyle birleştirin. Java EXCEL'i DIF biçimiyle birleştirin. EXCEL'i Java'de DIF ile birleştirin. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i Java\'de DIF ile birleştir" %}}

Aşağıdaki örnek, EXCEL'in Aspose.Cells for Java'deki DIF ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i DIF ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından DIF dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. EXCEL'i DIF ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java\'de EXCEL\'i DIF ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i DIF via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i programlı olarak DIF ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i DIF ile birleştirmek için Java kitaplığı" %}}
