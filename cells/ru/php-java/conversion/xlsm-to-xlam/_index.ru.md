---
title: Конвертер PHP XLSM в XLAM - XLSM в XLAM
description: Aspose Эксель. Преобразуйте XLSM в XLAM быстро и легко с помощью Aspose.Cells. PHP XLSM в XLAM. PHP Сохраните XLSM в XLAM. Сохраните XLSM как XLAM с помощью PHP.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XLSM в XLAM с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы XLSM в XLAM? Разработчики PHP могут легко загрузить и преобразовать XLSM в XLAM всего за несколько строк кода.
...
1.  Преобразуйте XLSM в XLAM, вызвав метод сохранения книги.
1.  Получите результат преобразования XLSM в XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования XLSM в XLAM" %}}
