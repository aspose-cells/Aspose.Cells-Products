---
title: Python SPREADSHEETML'den BMP'e - SPREADSHEETML'den BMP'e dönüştürücü
description: Aspose Excel'de. Python Excel'de. Aspose.Cells ile SPREADSHEETML'i hızlı ve kolay bir şekilde BMP'e dönüştürün. Python SPREADSHEETML'i BMP'e dönüştürün. Python SPREADSHEETML'i BMP'e kaydedin. Python Excel Kütüphanesini kullanarak SPREADSHEETML'i BMP olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python Excel Kütüphanesinde SPREADSHEETML\'i BMP\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'i Python Excel Kütüphanesinde BMP\'e kaydedin" %}}

Aşağıdaki örnek, Python excel kitaplığında SPREADSHEETML'in BMP'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'i BMP\'e Dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

SPREADSHEETML dosyalarını program aracılığıyla BMP'e dönüştürmeniz mi gerekiyor? Python geliştiricileri SPREADSHEETML'i yalnızca birkaç satır kodla kolayca yükleyebilir ve BMP'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak SPREADSHEETML'i BMP'e dönüştürün.
1.  SPREADSHEETML'in dönüşüm sonucunu BMP'e alın.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python SPREADSHEETML\'i BMP\'e Dönüştürmek için Excel Kitaplığı" %}}
