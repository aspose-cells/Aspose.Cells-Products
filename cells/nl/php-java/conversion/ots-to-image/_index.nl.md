---
title: PHP OTS naar BEELD - OTS naar BEELD Converter
description: Aspose Excel. Converteer OTS snel en eenvoudig naar IMAGE met Aspose.Cells. PHP OTS naar IMAGE. PHP Bewaar OTS in IMAGE. Sla OTS op als AFBEELDING met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar IMAGE te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar IMAGE converteren? PHP-ontwikkelaars kunnen OTS eenvoudig in slechts een paar regels code laden en naar IMAGE converteren.
...
1.  Converteer OTS naar IMAGE door de opslagmethode van Workbook aan te roepen.
