...
description: Aspose Excel. Python Excel. Mesclar SXC com XLTX salvar formato. Python Combine o formato SXC com XLTX. Mesclar SXC com XLTX na Biblioteca Excel Python. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC a XLTX usando a biblioteca Python do Excel" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC com XLTX na Biblioteca Excel Python" %}}

exemplo a seguir demonstra como mesclar SXC com XLTX em Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Exemplo de código para mesclar SXC a XLTX na biblioteca Python do Excel" InputFormat="sxc" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC a XLTX por meio da biblioteca Python Excel" %}}
