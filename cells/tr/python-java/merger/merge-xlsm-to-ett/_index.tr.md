...
url: /tr/python-java/merger/merge-xlsm-to-ett/ 
...
Aşağıdaki örnek, XLSM'in Aspose.Cells for Python via Java'de ETT ile nasıl birleştirileceğini gösterir.
...
XLSM'i programlı olarak ETT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
