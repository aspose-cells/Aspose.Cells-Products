---
title:  Sloučit XLSM do HTM přes Python
...
Následující příklad ukazuje, jak sloučit XLSM do HTM v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM s HTM online" InputFormat="xlsm" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
