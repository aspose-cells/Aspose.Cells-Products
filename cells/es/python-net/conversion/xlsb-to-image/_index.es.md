...
description: Aspose Excel. Convierta XLSB a IMAGEN rápida y fácilmente con Aspose.Cells. Python XLSB a IMAGEN. Python Guardar XLSB en IMAGEN. Guarde XLSB como IMAGEN usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB a IMAGEN en Python" h2="Biblioteca Python de alta velocidad para convertir XLSB a IMAGEN. Utilice nuestra conversión de Excel API para desarrollar software independiente de plataforma de alto nivel en Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir XLSB a IMAGEN en Python" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB en IMAGEN en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a IMAGEN en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir XLSB a IMAGEN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="png" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB a IMAGEN" %}}
