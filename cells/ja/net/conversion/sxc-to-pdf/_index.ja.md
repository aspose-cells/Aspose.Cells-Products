...
{{% blocks/products/pf/agp/feature-section-col title="C#を介してSXCをPDFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 .NET開発者は、わずか数行のコードでSXCファイルを簡単にロードしてPDFに変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookのインスタンスを含むSXCファイルをロードします1. Workbook.Saveメソッドを呼び出します1. パラメータとしてPDF拡張子を持つ出力パスを渡します1. 結果のPDFファイルの指定されたパスを確認します
...
{{% cells-convert title="SXCをPDFに変換するための無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="pdf" IsLandingPage="true" %}}
