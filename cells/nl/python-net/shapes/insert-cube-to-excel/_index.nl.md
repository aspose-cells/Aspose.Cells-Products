---
title:  Plaats Cube in Excel met Python via .Net
weight: 10
description: Python via .Net-broncode om Cube in Excel in te voegen.
keywords: [Python Aspose.Cells., Python add Cube shape., Python insert Cube shape., Python create Cube shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Plaats Cube in Excel met Python via .Net" h2="Plaats Cube met Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een kubus in een Excel-bestand kunt invoegen met behulp van Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Cube in Excel-bestand in te voegen met Python via .Net" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de toevoeging van de vormcollectie[methode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) om een kubus in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Kubus invoegen - Python via .Net" offSpacer="" %}}
