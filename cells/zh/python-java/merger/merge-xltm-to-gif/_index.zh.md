...
下面的示例说明如何将 XLTM 和 GIF 合并到 Aspose.Cells for Python via Java 中。
...
需要以编程方式将 XLTM 合并到 GIF 吗？合并和连接的基本文档[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需几行代码即可完成 API。
