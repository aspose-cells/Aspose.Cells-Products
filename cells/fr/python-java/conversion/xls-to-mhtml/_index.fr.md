---
title: Convertir XLS en MHTML Python via Python
description: Convertissez XLS en MHTML en ligne gratuitement. Convertisseur en ligne gratuit XLS à MHTML. Python XLS à MHTML. XLS à MHTML via Python.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en MHTML en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="mhtml" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en MHTML via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir XLS en MHTML en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier XLS avec une instance de Workbook
1.  Convertir XLS en MHTML en appelant la méthode Workbook.save
