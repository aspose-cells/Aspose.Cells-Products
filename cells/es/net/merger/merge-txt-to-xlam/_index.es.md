---
title: Combinar TXT a XLAM - Combinar TXT a XLAM en C#
url: /es/net/merger/merge-txt-to-xlam/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea TXT a XLAM guardar formato. C# Combina el formato TXT con el XLAM. Combinar TXT a XLAM en C#. TXT Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine TXT a XLAM en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar TXT con XLAM en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar TXT a XLAM. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo XLAM. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina TXT con XLAM.
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar TXT a XLAM a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar TXT con XLAM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar TXT a XLAM" %}}
