...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 BMP。C++ OTS 轉換為 BMP。C++ 將 OTS 儲存為 BMP。C++ 將 OTS 儲存為 BMP。C++ 將 OTS 儲存為 BMP。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 C++ 中的 OTS 轉換為 BMP" h2="使用 C++ 函式庫進行高效能 OTS 到 BMP 轉換，無需安裝 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將OTS保存到C++中的BMP" %}}

以下範例示範如何將 C++ 中的 OTS 轉換為 BMP。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 OTS 轉換為 BMP。上傳您的 OTS 文件，然後只需將其另存為 BMP 文件。對於 OTS 讀取和 BMP 寫入，您可以使用完全限定的檔案名稱。輸出 BMP 內容和格式將與原始 OTS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 OTS 轉換為 BMP 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="bmp" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 OTS 轉換為 BMP" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 OTS 檔案轉換為 BMP？ C++ 開發人員只需幾行程式碼即可輕鬆將 OTS 轉換為 BMP。
