---
title: Převodník PHP PNG na MHT – PNG na MHT
description: Aspose Excel. Převeďte PNG na MHT rychle a snadno pomocí Aspose.Cells. PHP PNG na MHT. PHP Uložit PNG do MHT. Uložte PNG jako MHT pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na MHT přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést PNG soubory na MHT programově? Vývojáři PHP mohou snadno načíst a převést PNG na MHT v několika řádcích kódu.
...
1.  Převeďte PNG na MHT voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na MHT" %}}
