...
description: Aspose Unggul. C# Aspose.Cells. Gabungkan PRN ke format simpan PPTX. C# Gabungkan PRN ke format PPTX. Gabungkan PRN ke PPTX di C#. Gabungkan PRN.
...
{{% blocks/products/pf/agp/content h2="Gabungkan PRN ke PPTX di C#" %}}

Contoh berikut menunjukkan cara menggabungkan PRN ke PPTX di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan PRN ke PPTX. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file PPTX. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan PRN ke PPTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan PRN ke PPTX di C#" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan PRN ke PPTX lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan PRN ke PPTX secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka .NET untuk menggabungkan PRN menjadi PPTX" %}}
