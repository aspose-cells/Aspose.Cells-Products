---
title: Gabung SXC ke SXC - Gabungkan SXC ke SXC di Java
url: /id/java/merger/merge-sxc-to-sxc/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge SXC to SXC saveformat. Java Gabungkan format SXC menjadi SXC. Gabung SXC ke SXC di Java. SXC Gabung.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan SXC menjadi SXC via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan SXC ke SXC. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="SXC" additionalConversionTag="SXC" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabung SXC ke SXC di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan SXC ke SXC di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan SXC ke SXC di Java" InputFormat="sxc" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC ke SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SXC menjadi SXC secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan SXC ke SXC" %}}
