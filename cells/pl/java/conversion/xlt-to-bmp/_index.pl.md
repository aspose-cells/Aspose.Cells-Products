---
title: Konwertuj XLT na BMP przez Java 
weight: 590

description: Przykładowy kod konwersji Java dla formatu XLT do pliku BMP. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do BMP w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLT na BMP przez Java" h2="Konwersja XLT do BMP Java w celu konwersji jednej lub wielu stron na BMP przy użyciu biblioteki On-premise Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na BMP za pomocą Java" %}}

 Aby wyrenderować XLT do BMP, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na BMP za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik XLT na BMP w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT z instancją Workbook1. Wybierz domyślny lub dowolny arkusz z kolekcji1. Utwórz i ustaw obiekt ImageOrPrintOptions1. Utwórz SheetRender z obiektami Worksheet i ImageOrPrintOptions1. Wywołaj metodę SheetRender.toImage, aby zapisać wynik w formacie BMP
...
{{% blocks/products/pf/agp/code-block title="XLT do BMP Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją XLT na BMP" sectionDescription="[Konwertuj XLT na BMP](https://products.aspose.app/cells/conversion/xlt-to-bmp) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLT, zostanie on natychmiast przekonwertowany do BMP." >}}
