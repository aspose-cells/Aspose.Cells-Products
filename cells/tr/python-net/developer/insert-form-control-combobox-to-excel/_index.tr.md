---
title: Python via .Net kullanarak ComboBox'u (Form kontrolü) Excel'e ekleyin
weight: 20
description: Python via .Net kaynak kodu, ComboBox'u (Form kontrolü) Excel'e eklemek için.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via .Net kullanarak ComboBox\'u (Form kontrolü) Excel\'e ekleyin" h2="Microsoft veya Open Office, Adobe PDF vb. gibi herhangi bir yazılım olmadan sunucu tarafı API\'lerini kullanarak nesneler ekleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via .Net Kullanarak ComboBox\'u (Form kontrolü) Excel Dosyasına Ekleme" %}}

 ComboBox'ı (Form kontrolü) excel dosyasına eklemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net kullanarak ComboBox\'u (Form kontrolü) Excel dosyasına ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Shapecollection'ın eklentisini kullanın[yöntem](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_combo_box/#int-int-int-int-int-int) Seçilen çalışma sayfasına bir ComboBox(Form kontrolü) eklemek için.
...
{{% blocks/products/pf/agp/code-block title="ComboBox\'u Ekle(Form kontrolü) - Python via .Net" offSpacer="" %}}
