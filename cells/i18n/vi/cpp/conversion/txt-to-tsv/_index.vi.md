---
title: Chuyển đổi TXT sang TSV qua ứng dụng C++ 
url: /vi/cpp/conversion/txt-to-tsv/ 
description: Mã chuyển đổi C++ mẫu cho tài liệu TXT sang định dạng TSV. Các lập trình viên có thể sử dụng mã nguồn này để chuyển đổi hàng loạt TXT sang TSV trong bất kỳ Ứng dụng C++ nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi TXT sang TSV qua C++" h2="Chuyển đổi TXT sang TSV hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi TXT sang TSV bằng cách sử dụng C++" %}}

 Để chuyển đổi TXT sang TSV, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi TXT sang TSV qua C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp TXT thành TSV chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp TXT bằng Factory :: CreateIWorkbook.1. Gọi phương thức Save ().1. Chuyển đường dẫn tệp đầu ra với phần mở rộng tệp (TSV).1. Tệp TSV sẽ được lưu tại đường dẫn đã chỉ định.1. Mở tệp TSV trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi TXT sang TSV C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi TXT sang TSV" sectionDescription="[Chuyển đổi TXT sang TSV](https://products.aspose.app/cells/conversion/txt-to-tsv) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp TXT của bạn, tệp sẽ được chuyển đổi ngay lập tức thành TSV." >}}
