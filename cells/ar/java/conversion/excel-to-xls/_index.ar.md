---
title: محول Java من إكسل إلى XLS - محول من إكسل إلى XLS
description: Aspose اكسل. قم بتحويل EXCEL إلى XLS بسرعة وسهولة باستخدام Aspose.Cells. Java EXCEL إلى XLS. Java احفظ EXCEL إلى XLS. احفظ EXCEL كـ XLS باستخدام Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل EXCEL إلى XLS في Java" h2="مكتبة Java عالية السرعة لتحويل EXCEL إلى XLS. هذا حل برمجي احترافي لاستيراد وتصدير EXCEL وXLS والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ EXCEL إلى XLS في Java" %}}

يوضح المثال التالي كيفية تحويل EXCEL إلى XLS في Java.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل EXCEL إلى XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات EXCEL إلى XLS برمجياً؟ يمكن لمطوري Java تحويل EXCEL بسهولة إلى XLS في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل EXCEL إلى XLS" %}}
{{% blocks/products/pf/agp/text %}}
