---
title: รวม XLSX เป็น HTM - รวม XLSX เป็น HTM ใน Python
url: /th/python-net/merger/merge-xlsx-to-htm/ 
description: Aspose เก่ง. Python Aspose.Cells รวมออนไลน์ฟรี XLSX เป็น HTM saveformat Python รวม XLSX เป็นรูปแบบ HTM รวม XLSX กับ HTM ใน Python XLSX รวม
...
ตัวอย่างต่อไปนี้สาธิตวิธีผสาน XLSX กับ HTM ใน Aspose.Cells for Python via .NET
...
{{% cells-merger title="ออนไลน์ฟรีเพื่อรวม XLSX เป็น HTM ใน Python" InputFormat="xlsx" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="วิธีผสาน XLSX เป็น HTM ผ่าน Python" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการผสาน XLSX กับ HTM โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
