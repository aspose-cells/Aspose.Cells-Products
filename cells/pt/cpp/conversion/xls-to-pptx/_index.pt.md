...
Precisa converter arquivos XLS para PPTX programaticamente? Os desenvolvedores C++ podem facilmente converter XLS em PPTX em apenas algumas linhas de código.
...
1.  Converta XLS em PPTX chamando o método Save().
