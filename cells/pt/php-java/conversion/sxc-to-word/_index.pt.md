---
title: Conversor PHP SXC para WORD - SXC para WORD
description: Aspose Excel. Converta SXC em WORD de forma rápida e fácil com Aspose.Cells. PHP SXC em WORD. PHP Salve SXC em WORD. Salve SXC como WORD usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em WORD via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em WORD programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em WORD em apenas algumas linhas de código.
...
1.  Converta SXC em WORD chamando o método save da pasta de trabalho.
