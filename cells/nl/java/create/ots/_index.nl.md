---
title: OTS aanmaken - Maak een OTS-bestand in Java
description: Aspose Excel. Genereer en bewerk OTS-bestanden moeiteloos met de Aspose.Cells for Java bibliotheek. Deze krachtige API biedt een gestroomlijnde en efficiënte oplossing voor het maken, bewerken en beheren van OTS-bestanden rechtstreeks binnen uw Java applicaties, waarmee met hoge precisie aan specifieke ontwikkelaarsbehoeften wordt voldaan.
...
{{% blocks/products/pf/agp/content h2="Hoe maak je een OTS aan in Java?" %}}
...
1.  Sla het werkblad op in OTS-formaat met behulp van de save()-methode.

{{% blocks/products/pf/agp/code-block title="De voorbeeldcode laat zien hoe je een OTS-bestand aanmaakt in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om OTS-bestand te maken" %}}
{{% blocks/products/pf/agp/text %}}
