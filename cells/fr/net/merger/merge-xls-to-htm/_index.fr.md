---
title: Fusionner XLS à HTM - Combiner XLS à HTM dans C#
url: /fr/net/merger/merge-xls-to-htm/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite XLS au format de sauvegarde HTM. C# Combinez XLS au format HTM. Fusionner XLS à HTM dans C#. XLS Fusionner.
...
L'exemple suivant montre comment fusionner XLS en HTM dans Aspose.Cells for .NET.
...
{{% cells-merger title="Gratuit en ligne pour fusionner XLS en HTM en C#" InputFormat="xls" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS en HTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner XLS avec HTM par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
