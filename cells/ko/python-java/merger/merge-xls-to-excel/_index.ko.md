...
다음 예는 XLS을 Aspose.Cells for Python via Java에서 EXCEL로 병합하는 방법을 보여줍니다.
...
{{% blocks/products/pf/agp/text %}}
 ...
 프로그래밍 방식으로 XLS을 EXCEL에 병합해야 합니까? 병합 및 연결하는 기본 문서[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) 몇 줄의 코드만으로 API를 수행할 수 있습니다.
