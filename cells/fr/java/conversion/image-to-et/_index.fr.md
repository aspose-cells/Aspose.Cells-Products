...
description: Aspose Exceller. Convertissez IMAGE en ET rapidement et facilement avec Aspose.Cells. Java IMAGE en ET. Java Enregistrez l'IMAGE sur ET. Enregistrez l'IMAGE sous ET en utilisant le Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE sur ET au Java" %}}

L'exemple suivant montre comment convertir IMAGE en ET dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir IMAGE en ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE en ET par programme ? Les développeurs Java peuvent facilement convertir IMAGE en ET en quelques lignes de code seulement.
