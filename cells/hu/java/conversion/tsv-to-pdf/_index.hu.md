---
title: "TSV konvertálása PDF-be a következőn keresztül: Java "
weight: 2470
url: /hu/java/conversion/tsv-to-pdf/ 
description: Minta Java konverziós kód TSV-formátumhoz PDF-fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok PDF-formátumba exportálására bármely web- vagy asztali Java-alapú alkalmazásban.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV konvertálása PDF-be a következőn keresztül: Java" h2="TSV-ből PDF-be Java konvertálva egyetlen vagy több oldalt PDF-be konvertálva az On-premise Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása PDF-be a következővel: Java" %}}

 Ahhoz, hogy a TSV-t PDF-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV PDF-be konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak TSV-fájlt PDF-be, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. TSV-fájl betöltése a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat PDF kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott PDF-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TSV-ből PDF-be Java Konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TSV-fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tsv");
// mentse a TSV-t PDF-ként
