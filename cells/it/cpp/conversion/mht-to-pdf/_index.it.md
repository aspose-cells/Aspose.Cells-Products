...
Hai bisogno di convertire i file MHT in PDF tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in PDF in poche righe di codice.
...
1.  Convertire MHT in PDF chiamando il metodo Save().
