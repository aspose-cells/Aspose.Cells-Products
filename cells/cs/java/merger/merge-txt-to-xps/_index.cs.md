---
title:  Sloučit TXT až XPS via Java
...
Následující příklad ukazuje, jak sloučit TXT až XPS v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až XPS online" InputFormat="txt" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
