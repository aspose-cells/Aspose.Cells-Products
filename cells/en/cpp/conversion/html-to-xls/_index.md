...
description: Aspose Excel. Convert HTML to XLS quickly and easily with Aspose.Cells. C++ HTML to XLS. C++ Save HTML to XLS. Save HTML as XLS using C++.
...
{{% cells-convert title="Sample Code to Convert HTML to XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xls" IsLandingPage="true" language="cpp" %}}
