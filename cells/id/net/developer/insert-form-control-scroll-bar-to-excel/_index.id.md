...
weight: 90
description: Kode sumber C# untuk memasukkan ScrollBar ke Excel pada Kerangka .NET, .NET Core, Mono atau Platform Xamarin.
keywords: [C# Aspose.Cells., c# add ScrollBar into Excel., c# insert ScrollBar into Excel., c# create ScrollBar in Excel]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan ScrollBar ke Excel via .NET" h2="Masukkan ScrollBars menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[tambahkan metode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addscrollbar)untuk menyisipkan ScrollBar di lembar kerja yang dipilih
