...
Potřebujete programově převést soubory PNG do formátu POWERPOINT? Vývojáři .NET mohou snadno načíst a převést soubory PNG do formátu POWERPOINT pomocí několika řádků kódu.
...
1.  Převeďte číslo PNG na formát POWERPOINT voláním metody Workbook.Save.
