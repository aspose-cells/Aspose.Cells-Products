---
title: Объединить EXCEL с HTML — Объединить EXCEL с HTML в C++
url: /ru/cpp/merger/merge-excel-to-html/ 
description: Aspose Эксель. C++ Aspose.Cells. Объедините EXCEL с форматом сохранения HTML. C++ Объедините EXCEL в формат HTML. Объедините EXCEL с HTML в C++. EXCEL Объедините.
...
{{% blocks/products/pf/agp/content h2="Объединить EXCEL с HTML в C++" %}}

В следующем примере показано, как объединить EXCEL с HTML в Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить EXCEL с номером HTML. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле HTML. Если вы разработаете код C++, это будет проще, чем кажется. См. пример C++, в котором EXCEL объединяется с HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения EXCEL с HTML в C++" InputFormat="xlsx" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как объединить EXCEL с HTML через C++" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить EXCEL с HTML? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для объединения EXCEL с HTML" %}}
