...
{{% cells-convert title="Exemple de code pour convertir HTM en WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="docx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en WORD via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en WORD par programme ? Les développeurs C++ peuvent facilement convertir HTM en WORD en quelques lignes de code seulement.
...
1.  Convertissez HTM en WORD en appelant la méthode Save().
