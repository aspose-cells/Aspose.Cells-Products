---
title:  แก้ไขหรือดู ODS เอกสาร Metadata ทาง C++
weight: 1000
description: โค้ดตัวอย่าง C++ เพื่อแก้ไขหรือดูข้อมูลเมตาของไฟล์ ODS บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิตและ Linux 64 บิต
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแยก Metadata ของ ODS ผ่าน C++" %}}
...
+ โหลดไฟล์ ODS โดยใช้ WorkbookMetadata
