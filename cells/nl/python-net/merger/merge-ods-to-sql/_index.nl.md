---
title: Voeg ODS samen met SQL - Combineer ODS met SQL in Python
url: /nl/python-net/merger/merge-ods-to-sql/ 
description: Aspose Excel. Python Excel. Voeg ODS samen naar het SQL-opslagformaat. Python Combineer ODS naar SQL-formaat. Voeg ODS samen met SQL in de Excel-bibliotheek Python. ODS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg ODS samen met SQL met behulp van de Excel-bibliotheek Python" %}}

Hoe voeg ik ODS samen met SQL? Met de bibliotheek Aspose.Cells for Python via .NET kunt u ODS eenvoudig programmatisch samenvoegen met SQL met een paar regels code.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardformaten. U kunt Aspose.Cells for Python via .NET installeren vanaf<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , gebruik de opdracht als:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Voeg ODS samen met SQL in de Excel-bibliotheek Python" %}}

In het volgende voorbeeld ziet u hoe u ODS samenvoegt met SQL in Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om ODS samen te voegen met SQL. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een SQL-bestand. Als u code ontwikkelt in Python, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld Python waarin ODS wordt samengevoegd met SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om ODS samen te voegen met SQL in de Excel-bibliotheek Python" InputFormat="ods" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe ODS samen te voegen met SQL via de Excel-bibliotheek Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u ODS programmatisch samenvoegen met SQL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om ODS samen te voegen met SQL" %}}
