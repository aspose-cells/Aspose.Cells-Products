---
title: 在不通过 C++ 打开的情况下搜索 XLSB 文档 
weight: 7020
url: /zh/cpp/search/xlsb/ 
description: C++ 用于在 XLSB 文件中搜索具有模式的单词的示例代码，位于 C++ Windows 32 位、Windows 64 位和 Linux 64 位运行时环境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C++ 中搜索 XLSB 格式" h2="使用用于 C++ API 的服务器端 Aspose.Cells 进行本机和高性能 XLSB 文档搜索，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
