---
title: Połącz OTS z SPREADSHEETML - Połącz OTS z SPREADSHEETML w C#
url: /pl/net/merger/merge-ots-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie online OTS z formatem zapisu SPREADSHEETML. C# Połącz OTS z formatem SPREADSHEETML. Połącz OTS z SPREADSHEETML w C#. Połącz OTS.
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z SPREADSHEETML w C# online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć OTS z SPREADSHEETML w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić OTS z SPREADSHEETML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SPREADSHEETML. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatnie online, aby połączyć OTS z SPREADSHEETML w C#" InputFormat="ots" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć OTS z SPREADSHEETML przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć OTS ze SPREADSHEETML? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET do połączenia OTS z SPREADSHEETML" %}}
