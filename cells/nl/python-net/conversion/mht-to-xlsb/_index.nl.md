...
{{% blocks/products/pf/agp/content h2="Converteer MHT naar XLSB in Python" %}}
...
Het volgende voorbeeld laat zien hoe u MHT converteert naar XLSB in Python via NET.
