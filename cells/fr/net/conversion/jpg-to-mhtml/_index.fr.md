...
Besoin de convertir des fichiers JPG en MHTML par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en MHTML en quelques lignes de code.
...
1.  Convertissez le JPG au format MHTML en appelant la méthode Workbook.Save.
