...
description: Aspose Exceller. Convertissez OTS en DIF rapidement et facilement avec Aspose.Cells. C++ OTS en DIF. C++ Enregistrez OTS en DIF. Enregistrez OTS sous DIF en utilisant C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez OTS au DIF dans C++" %}}
...
{{% cells-convert title="Exemple de code pour convertir OTS en DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="dif" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir OTS en DIF via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers OTS en DIF par programme ? Les développeurs C++ peuvent facilement convertir OTS en DIF en quelques lignes de code seulement.
