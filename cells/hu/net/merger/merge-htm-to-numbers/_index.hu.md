---
title: HTM egyesítése a NUMBERS számmal – HTM egyesítése a NUMBERS számmal a C#-ben
url: /hu/net/merger/merge-htm-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítése HTM NUMBERS mentési formátumba. C# HTM kombinálása NUMBERS formátummal. HTM egyesítése a NUMBERS számmal a C# számon. HTM egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a HTM-et a NUMBERS számmal a C# Online számon ingyen" %}}

A következő példa bemutatja, hogyan egyesítheti a HTM-et a NUMBERS-szel a Aspose.Cells for .NET számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTM és a NUMBERS egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el NUMBERS fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTM-et a NUMBERS-szel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTM és a NUMBERS egyesítése a C# számon" InputFormat="htm" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTM és a NUMBERS egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTM-et a következővel: NUMBERS? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és a NUMBERS egyesítéséhez" %}}
