---
title: Python HTM en MHT - Convertisseur HTM en MHT
description: Aspose Exceller. Convertissez HTM en MHT rapidement et facilement avec Aspose.Cells. Python HTM en MHT. Python Enregistrer HTM dans MHT. Enregistrez HTM en tant que MHT en utilisant le Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en MHT en Python" h2="Bibliothèque Python haute vitesse pour convertir HTM en MHT. Utilisez notre conversion Excel API pour développer un logiciel de haut niveau indépendant de la plate-forme en Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir HTM en MHT en Python" %}}

 Comment convertir HTM en MHT ? Avec la bibliothèque Aspose.Cells for Python via NET, vous pouvez facilement convertir HTM en MHT par programme avec quelques lignes de code.[Aspose.Cells for Python via NET](https://pypi.org/project/aspose-cells-python/)est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Enregistrer HTM en MHT au Python" %}}

L'exemple suivant montre comment convertir HTM en MHT dans Python via NET.
...
{{% blocks/products/pf/agp/content h2="Comment convertir HTM en MHT" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en MHT par programme ? Les développeurs Python peuvent facilement charger et convertir HTM en MHT en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour convertir HTM en MHT" %}}
