...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLS を XLSB にすばやく簡単に変換します。Python XLS を XLSB に変換します。Python XLS を XLSB に保存します。Python Excel ライブラリを使用して、XLS を XLSB として保存します。
