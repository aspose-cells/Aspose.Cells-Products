---
title: C# HTM σε MHTML - Μετατροπέας HTM σε MHTML
description: Aspose Excel. Μετατρέψτε το HTM σε MHTML γρήγορα και εύκολα με το Aspose.Cells. C# HTM σε MHTML. C# Αποθήκευση HTM σε MHTML. Αποθηκεύστε το HTM ως 07617837481 χρησιμοποιώντας 3.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το HTM στο MHTML στο C#" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το HTM σε MHTML στο C#.
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή HTM σε MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="mhtml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε HTM σε MHTML μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να μετατρέψετε αρχεία HTM σε MHTML μέσω προγραμματισμού; Οι προγραμματιστές .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν το HTM σε MHTML σε λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="C# βιβλιοθήκη για μετατροπή HTM σε MHTML" %}}
