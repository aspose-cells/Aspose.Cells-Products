---
title: Convertir TSV en ODS via C#
url: /fr/net/conversion/tsv-to-ods/
description: Exemple de code pour la conversion tsv en ods C#. Utilisez l'exemple de code API pour la conversion de fichiers tsv par lots en ods dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers TSV en ODS en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier TSV avec une instance de Workbook1. Appelez la méthode Workbook.Save1. Passer le chemin de sortie avec l'extension ODS comme paramètre1. Vérifier le chemin spécifié pour le fichier ODS résultant
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir TSV en ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="ods" IsLandingPage="true" %}}
