...
weight: 10
description: Ottiene le dimensioni delle immagini in Excel utilizzando Aspose.Cells' Python via Java API senza alcun software come Microsoft o Open Office, Adobe PDF, ecc.
...
+ Seleziona l'oggetto immagine tramite il suo indice dall'attributo 'Immagini' del foglio di lavoro.
 + Esistono vari modi per ottenere le dimensioni da un oggetto immagine selezionato. Le parti sono elencate di seguito, per ulteriori informazioni fare riferimento a[MORE](https://reference.aspose.com/cells/python-java/asposecells.api/Picture).Avviso: "Larghezza" e "Altezza" sono le dimensioni mostrate in Excel che potrebbero essere più grandi o più piccole dell'immagine originale.
...
{{% blocks/products/pf/agp/code-block title="Ottieni la dimensione delle immagini/immagini - Python via Java" offSpacer="" %}}
