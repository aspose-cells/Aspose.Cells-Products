...
{{% blocks/products/pf/agp/content h2="Spóroljon a ODS-es számlaösszeget ET-re a C++-es számlaösszegben" %}}

következő példa bemutatja, hogyan lehet a ODS számot ET-vé alakítani a C++-ben.
...
Programozottan kell ET formátumba konvertálni a ODS fájlokat? A C++ fejlesztők könnyedén konvertálhatják a ODS fájlokat ET formátumba mindössze néhány sornyi kóddal.
...
1.  Alakítsd át a ODS-et ET-vé a Save() metódus meghívásával.
1.  Szerezze meg a ODS konverziós eredményt ET-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ könyvtár a ODS ET-vé konvertálásához" %}}
