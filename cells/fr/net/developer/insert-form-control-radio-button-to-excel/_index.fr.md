---
title:  Insérer RadioButton dans Excel via .NET
weight: 60
description: Code source C# pour insérer RadioButton dans Excel sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer RadioButton dans un fichier Excel via C#" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addradiobutton) pour insérer un RadioButton dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer un bouton radio - C#" offSpacer="" %}}
