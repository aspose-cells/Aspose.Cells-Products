---
title: Java XLS sang ET - Bộ chuyển đổi XLS sang ET trực tuyến
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Trực tuyến miễn phí Java Chuyển đổi XLS sang định dạng lưu ET. Java XLS sang định dạng ET. Lưu XLS thành ET Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Đổi XLS sang ET trong Java" h2="Thư viện Java tốc độ cao để chuyển đổi XLS sang ET. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất XLS, ET và nhiều định dạng khác sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLS sang ET Sử dụng Java" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS vào ET trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi XLS thành ET trong Java.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS thành ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi các tệp XLS sang ET theo chương trình? Java nhà phát triển có thể dễ dàng chuyển đổi XLS sang ET chỉ bằng một vài dòng mã.
