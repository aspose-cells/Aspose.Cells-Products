...
هل تحتاج إلى تحويل ملفات MHT إلى XLT برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى XLT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLT عن طريق استدعاء دالة Save().
