---
title: C# HTML から HTM - HTML から HTM コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、HTMLをHTMにすばやく簡単に変換します。C# HTMLをHTMに変換します。 C# HTML を HTM に保存します。 C# を使用して HTML を HTM として保存します。
...
{{% cells-convert title="HTMLをHTMに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="htm" IsLandingPage="true" %}}
