...
description: Aspose Эксель. Преобразуйте XLSX в ETT быстро и легко с помощью Aspose.Cells. Python XLSX в ETT. Python Сохраните XLSX в ETT. Сохраните XLSX как ETT, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразование XLSX в ETT с помощью Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XLSX в ETT в Python." %}}
...
{{% cells-convert title="Пример кода для преобразования XLSX в ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ett" IsLandingPage="true" language="pythonjava" %}}
