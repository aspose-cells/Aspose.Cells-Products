...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в MARKDOWN, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTML в MARKDOWN в Java" %}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать HTML в MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы HTML в MARKDOWN? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в MARKDOWN всего несколькими строками кода.
