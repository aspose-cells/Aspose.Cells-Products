---
title: Python XLSB do PDF - XLSB do PDF Konwerter
description: Aspose Excel. Python Excel. Konwertuj numer XLSB na PDF szybko i łatwo za pomocą Aspose.Cells. Python XLSB na PDF. Python Zapisz XLSB na PDF. Zapisz XLSB jako 07611 23481 przy użyciu biblioteki programu Excel Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na PDF w Python Biblioteka Excel" h2="Szybka biblioteka Excel Python do konwersji XLSB na PDF. Jest to profesjonalne oprogramowanie do importowania i eksportowania XLSB, PDF i wielu innych formatów przy użyciu Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLSB na PDF za pomocą biblioteki Excel Python" %}}

 Jak przekonwertować numer XLSB na numer PDF? Dzięki bibliotece Aspose.Cells for Python możesz łatwo programowo przekonwertować XLSB na PDF za pomocą kilku linijek kodu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Zapisz XLSB do PDF w Python Bibliotece Excel" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSB na PDF w bibliotece Excel Python.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer XLSB na numer PDF. Prześlij plik XLSB, a następnie po prostu zapisz go jako plik PDF. Zarówno do odczytu XLSB, jak i do zapisu PDF można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego PDF będą identyczne z oryginalnym dokumentem XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLSB na PDF za pośrednictwem biblioteki Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="pdf" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na PDF przez Python" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSB na PDF? Programiści Python mogą łatwo załadować i przekonwertować XLSB na PDF w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSB na numer PDF, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLSB na PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Biblioteka Excel do konwersji XLSB na PDF" %}}
