---
title: Python XLS 轉 IMAGE - XLS 轉 IMAGE 轉換器
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 XLS 轉換為 IMAGE 格式，從而能夠使用 Aspose.Cells 庫將 XLS 資料無縫保存為 IMAGE 格式，所有這些都透過高效且可自訂的 1533816153381 1533815338 程式碼可實現。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 XLS 轉換為 Python Excel 庫中的 IMAGE" h2="用於將 XLS 轉換為 IMAGE 的高速 Python Excel 函式庫。這是一個專業的軟體解決方案，可以使用Python導入和匯出XLS、IMAGE和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將 XLS 轉換為 IMAGE" %}}

如何將 XLS 轉換為 IMAGE？使用 Aspose.Cells for Python 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 XLS 轉換為 IMAGE。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 XLS 儲存到 Python Excel 庫中的 IMAGE" %}}

以下範例示範如何將Python excel庫中的XLS轉換為IMAGE。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLS 轉換為 IMAGE。上傳您的 XLS 文件，然後將其儲存為 IMAGE 文件。對於 XLS 讀取和 IMAGE 寫入，您可以使用完全限定的檔案名稱。輸出的 IMAGE 內容和格式將與原始 XLS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="透過 Python Excel 函式庫將 XLS 轉換為 IMAGE 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="png" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python 將 XLS 轉換為 IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 XLS 檔案轉換為 IMAGE？ Python 開發人員只需幾行程式碼即可輕鬆載入 XLS 並將其轉換為 IMAGE。
...
1. 使用工作簿實例載入 XLS 檔案。
1. 透過呼叫 Workbook.save 方法將 XLS 轉換為 IMAGE。
1. 取得XLS到IMAGE的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel 庫將 XLS 轉換為影像" %}}
