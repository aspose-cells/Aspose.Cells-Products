---
title: C++ صورة إلى JPG - صورة لتحويل JPG
description: Aspose إكسل. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل الصور إلى تنسيق JPG، مما يتيح حفظ بيانات الصور بسلاسة بتنسيق JPG باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصورة إلى JPG في C++" h2="تحويل الصور إلى JPG عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة بصيغة JPG في الرقم C++" %}}

يوضح المثال التالي كيفية تحويل الصورة إلى JPG في C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل IMAGE إلى JPG. قم بتحميل ملف IMAGE الخاص بك، ثم احفظه ببساطة كملف JPG. بالنسبة لقراءة IMAGE وكتابة JPG، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق JPG الناتج مطابقًا لمستند IMAGE الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="نموذج كود لتحويل صورة إلى JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى JPG عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات الصور إلى JPG برمجيًا؟ يمكن للمطورين الذين يستخدمون C++ تحويل الصور إلى JPG بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل الصورة إلى JPG عن طريق استدعاء دالة Save().
1.  احصل على نتيجة تحويل IMAGE إلى JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة رقم C++ لتحويل الصور إلى صيغة JPG" %}}
