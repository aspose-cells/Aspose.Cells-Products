---
title: A XLTX-SXC-es számok egyesítése – a XLTX-es és a SXC-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-xltx-to-sxc/ 
description: Aspose Excel. C# Aspose.Cells. A XLTX és a SXC mentési formátum egyesítése. C# A XLTX és a SXC formátum kombinálása. Egyesítse a XLTX-SXC-et a C#-ben. XLTX Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A XLTX és a SXC egyesítése a C#-ben" %}}

A következő példa bemutatja a XLTX és a SXC egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLTX-es és a SXC-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a SXC fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a XLTX és SXC számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a XLTX és SXC közötti egyesítéshez a C#-ben" InputFormat="xltx" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLTX és a SXC egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLTX-et a SXC-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLTX és SXC egyesítéséhez" %}}
