---
title: Combinar XLS a MHT - Combinar XLS a MHT en Java
url: /es/java/merger/merge-xls-to-mht/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea XLS para guardar formato MHT. Java Combine XLS en formato MHT. Combinar XLS a MHT en Java. XLS Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLS con MHT en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLS con MHT en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLS con MHT. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo MHT. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona XLS con MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLS a MHT en Java" InputFormat="xls" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLS a MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar XLS con MHT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar XLS a MHT" %}}
