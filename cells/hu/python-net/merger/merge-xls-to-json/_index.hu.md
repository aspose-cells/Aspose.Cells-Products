---
title: A XLS-JSON-es számok egyesítése – a XLS-es és a JSON-es számok egyesítése a Python-ben
url: /hu/python-net/merger/merge-xls-to-json/ 
description: Aspose Excel. Python Aspose.Cells. Ingyenes online egyesítés XLS JSON mentési formátumba. Python A XLS és a JSON formátum kombinálása. Egyesítse a XLS-JSON-et a Python-ben. XLS Egyesítse.
keywords: [Aspose Excel., Python Aspose.Cells., Merge XLS to JSON in Python., Free Online Python Merge XLS to json., Python Combine XLS to JSON Online for Free., XLS Merge]
---
...
{{% blocks/products/pf/agp/content h2="A XLS és a JSON egyesítése a Python használatával" %}}
 ...
 Hogyan egyesíthetem a XLS és a JSON számokat? A Aspose.Cells for Python via .NET könyvtárral könnyedén egyesítheti a XLS-et a JSON-es számokkal programozottan néhány sornyi kóddal.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Python Excel API nem csak a táblázatformátumok között konvertál, hanem Excel fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, CSV, CSV, CSV, CSV, CSV, SVG, és így tovább, SVG P, 8 PT a választás,3,8 ipari szabvány szerinti dokumentumok cseréjére formátumok. A Aspose.Cells for Python via .NET számot innen telepítheti.<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , használja a parancsot a következőképpen:<code>$ pip install aspose-cells-python</code>.
...
A következő példa bemutatja a XLS és JSON egyesítését a Aspose.Cells for Python via .NET számban.
...
{{% cells-merger title="Ingyenes online a XLS-JSON-es számok egyesítéséhez a Python-ben" InputFormat="xls" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A XLS és a JSON egyesítése a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-et a JSON-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
