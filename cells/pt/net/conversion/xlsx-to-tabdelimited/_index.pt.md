...
{{% blocks/products/pf/agp/content h2="Salvar XLSX em TABDELIMITED em C#" %}}

O exemplo a seguir demonstra como converter XLSX para TABDELIMITED em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX em TABDELIMITED. Carregue seu arquivo XLSX e simplesmente salve-o como arquivo TABDELIMITED. Tanto para leitura XLSX quanto para gravação TABDELIMITED você pode usar nomes de arquivos completos. O conteúdo e a formatação de saída TABDELIMITED serão idênticos ao documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter XLSX em TABDELIMITED" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para TABDELIMITED via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para TABDELIMITED programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em TABDELIMITED em apenas algumas linhas de código.
...
1.  Converta XLSX para TABDELIMITED chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para TABDELIMITED.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em TABDELIMITED" %}}
