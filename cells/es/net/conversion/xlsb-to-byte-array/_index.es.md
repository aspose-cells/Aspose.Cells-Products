---
title: Convierta XLSB a Byte Array a través de C# 
weight: 7690
url: /es/net/conversion/xlsb-to-byte-array/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Convierta XLSB en una matriz de bytes a través de C#" h2="Conversión nativa y de alto rendimiento de Microsoft Excel XLSB a matriz de bytes o viceversa para el procesamiento de datos de hojas de cálculo utilizando las API .NET del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array es útil para el procesamiento o almacenamiento de datos. Puede convertir un archivo XLSB a Byte Array, así como un documento de **Byte Array a XLSB** utilizando el idioma C#. Para convertir XLSB a una matriz de bytes, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir XLSB a matriz de bytes a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Es fácil para los desarrolladores cargar y convertir archivos XLSB en una matriz de bytes para realizar más tareas de manipulación en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Incluya el espacio de nombres en su archivo de clase1. Cargue el archivo XLSB de entrada usando Workbook1. Inicializar objeto MemoryStream1. Convertir datos de flujo a matriz de bytes1. Procesar datos según sus requisitos
