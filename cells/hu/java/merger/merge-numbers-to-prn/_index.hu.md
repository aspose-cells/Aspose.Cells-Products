---
title: NUMBERS egyesítése PRN-nel – NUMBERS egyesítése PRN-nel a Java-ben
url: /hu/java/merger/merge-numbers-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése NUMBERS PRN mentési formátumba. Java A NUMBERS kombinálása PRN formátumba. A NUMBERS egyesítése a PRN-be a Java-ben. NUMBERS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a NUMBERS-t a PRN-vel a Java online számon" %}}

következő példa bemutatja, hogyan lehet egyesíteni a NUMBERS-t a PRN-vel a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a NUMBERS és a PRN egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el PRN fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely a NUMBERS-t a PRN-be egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a NUMBERS és a PRN egyesítéséhez a Java számon" InputFormat="numbers" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A NUMBERS egyesítése a PRN via Java számmal" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell NUMBERS számot PRN-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a NUMBERS és a PRN egyesítéséhez" %}}
