---
title: Come faccio a disegnare o inserire una doppia freccia dritta in Excel utilizzando Python via .Net
weight: 10
description: Python via Codice sorgente .Net per disegnare o inserire doppia freccia dritta in Excel.
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Utilizza l'aggiunta della shapecollection[metodo](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) per inserire una doppia freccia dritta nel foglio di lavoro selezionato.
