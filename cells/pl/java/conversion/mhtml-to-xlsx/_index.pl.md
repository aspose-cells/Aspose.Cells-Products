---
title: Konwertuj MHTML na XLSX przez Java 
weight: 650
url: /pl/java/conversion/mhtml-to-xlsx/ 
description: Przykładowy kod konwersji Java dla formatu MHTML do pliku XLSX. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do XLSX w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MHTML na XLSX przez Java" h2="Konwersja MHTML do XLSX Java w celu konwersji jednej lub wielu stron do formatu XLSX przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na XLSX za pomocą Java" %}}

 Aby wyrenderować MHTML do XLSX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MHTML na XLSX za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik MHTML na XLSX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik MHTML z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLSX i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLSX
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji MHTML do XLSX Java" offSpacer="" %}}

```cs
// załaduj plik MHTML w instancji Workbook
Workbook book = new Workbook("template.mhtml");
// zapisz MHTML jako XLSX
