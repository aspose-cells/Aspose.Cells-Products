---
title: "TSV konvertálása XLS-re a következőn keresztül: C#"
url: /hu/net/conversion/tsv-to-xls/
description: Mintakód a tsv–xls C# konverzióhoz. Használjon API példakódot a tsv fájlok kötegelt xls formátumba konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása XLS-re a következővel: C#" %}}
 ...
 TSV XLS-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/text %}}
 ...
 A .NET fejlesztői könnyedén betölthetnek és konvertálhatnak TSV-fájlokat XLS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TSV-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal megadása XLS kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott XLS-fájl megadott elérési útját
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód a TSV XLS-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xls" IsLandingPage="true" %}}
