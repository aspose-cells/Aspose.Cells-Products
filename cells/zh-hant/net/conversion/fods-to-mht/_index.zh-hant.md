...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 C# 中的 MHT" h2="用於將 FODS 轉換為 MHT 的高速 C# 庫。這是一款專業的軟件解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上導入和導出 FODS、MHT 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 FODS 轉換為 MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 FODS 轉換為 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 FODS 文件轉換為 MHT？ .NET 開發人員只需幾行代碼即可輕鬆加載 FODS 並將其轉換為 MHT。
