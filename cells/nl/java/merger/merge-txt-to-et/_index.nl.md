...
description: Aspose Excel. Java Aspose.Cells. Voeg TXT samen naar ET-opslagformaat. Java Combineer TXT naar ET-formaat. Voeg TXT samen met ET in Java. TXT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met ET in Java" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met ET in Aspose.Cells for Java.
...
{{% cells-merger title="Voorbeeldcode om TXT samen te voegen met ET in Java" InputFormat="txt" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u TXT samenvoegt met ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met ET? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
