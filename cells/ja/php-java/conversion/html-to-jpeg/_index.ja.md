---
title: PHP HTML ～ JPEG - HTML ～ JPEG コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、HTML を JPEG にすばやく簡単に変換します。PHP HTML から JPEG。PHP HTML から JPEG に保存します。PHP を使用して、HTML を JPEG として保存します。
...
{{% blocks/products/pf/agp/content h2="HTML を PHP で JPEG に保存します" %}}

次の例は、PHP で HTML を JPEG に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、HTML を JPEG に変換します。HTML ファイルをアップロードし、JPEG ファイルとして保存するだけです。 HTML 読み取りと JPEG 書き込みの両方で、完全修飾ファイル名を使用できます。出力 JPEG のコンテンツと形式は、元の HTML ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="HTML を JPEG に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="jpg" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP 経由で HTML を JPEG に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで JPEG に変換する必要がありますか? PHP 開発者は、わずか数行のコードで HTML を簡単にロードして JPEG に変換できます。
