...
description: Aspose Excel. Convierta XLT a ETT rápida y fácilmente con Aspose.Cells. Python XLT a ETT. Python Guardar XLT en ETT. Guarde XLT como ETT usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XLT en ETT en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLT a ETT en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLT a ETT" %}}
