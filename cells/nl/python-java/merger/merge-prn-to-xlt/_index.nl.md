...
description: Aspose Excel. Python Excel. Voeg PRN samen met het opslagformaat XLT. Python Combineer PRN met XLT-formaat. Voeg PRN samen met XLT in de Excel-bibliotheek Python. PRN samenvoegen.
...
{{% blocks/products/pf/agp/content h2="PRN samenvoegen met XLT met behulp van de Excel-bibliotheek Python" %}}
...
{{% blocks/products/pf/agp/content h2="PRN samenvoegen met XLT in Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u PRN samenvoegt met XLT in Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PRN samen te voegen met XLT. Upload uw bestanden, bel de Workbook.Combine-methode voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand XLT. Als u code ontwikkelt in Python, is dit eenvoudiger dan het klinkt. Zie het voorbeeld Python waarin PRN wordt samengevoegd met XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om PRN samen te voegen met XLT in de Excel-bibliotheek Python" InputFormat="prn" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="PRN samenvoegen met XLT via de Excel-bibliotheek Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PRN programmatisch samenvoegen met XLT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om PRN samen te voegen met XLT" %}}
