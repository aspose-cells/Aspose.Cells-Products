...
{{< blocks/products/pf/i18n/upper-banner h1="Java के माध्यम से XLSX फ़ाइलें एन्क्रिप्ट करें" h2=".NET लाइब्रेरी का उपयोग करके एक्सएलएसएक्स प्रारूप सहित एक्सेल स्प्रेडशीट को पासवर्ड से सुरक्षित रखें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java के माध्यम से XLSX फ़ाइलें सुरक्षित करने के चरण" %}}
...
1. वर्कबुक क्लास को इंस्टेंट करके XLSX फाइल लोड करें1. प्रोटेक्शन टाइप और पासवर्ड के साथ प्रोटेक्ट (..) मेथड का इस्तेमाल करें1. सेव () विधि द्वारा संरक्षित XLSX फाइल को सेव करें
