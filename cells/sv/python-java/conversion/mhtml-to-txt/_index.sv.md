---
title: Konvertera MHTML till TXT via Python

description: Exempelkod för konvertering från mhtml till txt Python. Använd API exempelkod för batch-mhtml-filer till txt-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du MHTML till TXT med Python" %}}

 För att konvertera MHTML till TXT kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera MHTML till TXT via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera MHTML-filer till TXT på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda MHTML-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med TXT-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande TXT-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera MHTML till TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="txt" IsLandingPage="true" language="python" %}}
