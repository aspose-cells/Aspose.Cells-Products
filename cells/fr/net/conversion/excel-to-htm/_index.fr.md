---
title: C# Convertisseur Excel vers HTM
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format HTM, permettant un enregistrement transparent des données EXCEL au format HTM à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer un fichier Excel au format HTML (C#)" %}}

L'exemple suivant montre comment convertir EXCEL en HTM dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier Excel en HTML. Importez votre fichier Excel, puis enregistrez-le au format HTML. Vous pouvez utiliser des noms de fichiers complets pour la lecture Excel et l'écriture HTML. Le contenu et la mise en forme du fichier HTML généré seront identiques à ceux du document Excel original.
...
{{% blocks/products/pf/agp/content h2="Comment convertir un fichier Excel en HTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en HTM par programmation ? Les développeurs .NET peuvent facilement charger et convertir des fichiers EXCEL en HTM en quelques lignes de code seulement.
...
1.  Convertissez le fichier EXCEL au format HTM en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion d'Excel en HTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir Excel en HTML" %}}
