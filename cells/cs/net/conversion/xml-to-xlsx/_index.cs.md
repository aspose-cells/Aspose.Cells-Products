---
title: C# XML na XLSX - Převodník XML na XLSX
description: Aspose Excel. Převeďte XML na XLSX rychle a snadno pomocí Aspose.Cells. C# XML na XLSX. C# Uložte XML na XLSX. Uložte XML jako XLSX pomocí 0716183
...
{{% blocks/products/pf/agp/content h2="Uložte XML na XLSX v C#" %}}

Následující příklad ukazuje, jak převést XML na XLSX v C#.
...
{{% cells-convert title="Ukázkový kód pro převod XML na XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na XLSX přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XML na XLSX programově? Vývojáři .NET mohou snadno načíst a převést XML na XLSX v několika řádcích kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML na XLSX" %}}
