...
description: C# Codice di esempio per la creazione di grafici a bolle in Excel utilizzando la libreria .NET. Utilizzare questo codice per creare un grafico {chart} in MS Excel all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
...
1.  Utilizzo[**Grafico.SetChartDataRange**](https://https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/setchartdatarange) metodo per specificare l'origine dati del grafico.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Il seguente codice sorgente mostra come creare un grafico a bolle in un file MS Excel XLSX utilizzando C#." offSpacer="" %}}
