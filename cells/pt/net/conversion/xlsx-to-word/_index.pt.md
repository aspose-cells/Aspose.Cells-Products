---
title: Converter XLSX para PALAVRA C#
description: Converta XLSX para WORD Online gratuitamente. Conversor Online Grátis XLSX para WORD. C# XLSX para PALAVRA. XLSX para WORD via C#.
keywords: Convert XLSX, XLSX Converter, XLSX to PDF, XLSX to Word, XLSX to PPT, XLSX to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSX para WORD via C#" h2="Biblioteca C# de alta velocidade para converter XLSX em WORD. Exporte planilhas do Excel para o formato WORD em .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET desenvolvedores podem facilmente carregar e converter XLSX para WORD em apenas algumas linhas de código.
