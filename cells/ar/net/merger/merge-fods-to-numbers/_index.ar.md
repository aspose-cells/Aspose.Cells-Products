---
title: دمج FODS في أرقام - اجمع FODS إلى أرقام في C#
url: /ar/net/merger/merge-fods-to-numbers/ 
description: Aspose إكسل. C# Aspose.Cells. الدمج المجاني عبر الإنترنت FODS إلى تنسيق حفظ الأرقام. C# اجمع FODS إلى تنسيق NUMBERS. دمج FODS إلى أرقام في C#. دمج FODS.
...
{{% blocks/products/pf/agp/content h2="قم بدمج FODS إلى أرقام في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج FODS مع أرقام في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج FODS في أرقام. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف NUMBERS. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج FODS مع أرقام.
...
{{% blocks/products/pf/agp/content h2="كيفية دمج FODS مع أرقام عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج FODS مع أرقام برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج FODS إلى أرقام" %}}
