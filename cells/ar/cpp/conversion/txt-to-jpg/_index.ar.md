---
title: تحويل TXT إلى JPG عبر تطبيق C++ 
url: /ar/cpp/conversion/txt-to-jpg/ 
description: نموذج C++ رمز التحويل لمستند TXT إلى تنسيق JPG. يمكن للمبرمجين استخدام رمز المصدر هذا لتحويل دفعة TXT إلى JPG داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TXT إلى JPG عبر C++" h2="تحويل TXT إلى JPG عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TXT إلى JPG باستخدام C++" %}}
 ...
 من أجل تحويل TXT إلى JPG ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوّري برامج C++ بسهولة تحويل ملف TXT إلى JPG في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف TXT باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد ملف (JPG).1. سيتم حفظ ملف JPG في المسار المحدد.1. افتح ملف JPG في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="TXT إلى JPG C++ شفرة مصدر التحويل" offSpacer="" %}}
