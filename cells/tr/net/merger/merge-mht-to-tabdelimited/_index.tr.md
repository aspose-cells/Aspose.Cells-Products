...
url: /tr/net/merger/merge-mht-to-tabdelimited/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin TABDELIMITED ile nasıl birleştirileceğini göstermektedir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 MHT'yi TABDELIMITED ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi TABDELIMITED ile birleştirmek için .NET kitaplığı" %}}
