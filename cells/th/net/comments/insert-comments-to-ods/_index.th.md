---
title: ใส่ความคิดเห็นไปที่ ODS ไฟล์ via .NET
url: /th/net/comments/insert-comments-to-ods/ 
description: ใส่ความคิดเห็นไปที่ ODS โดยใช้ C# ใช้โค้ดตัวอย่าง API เพื่อแทรกความคิดเห็นภายในแอปพลิเคชัน .NET
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกความคิดเห็นในไฟล์ ODS ผ่าน C#" %}}
...
ใน Office 365 ความคิดเห็นมีไว้สำหรับการสนทนา คุณสามารถใช้รหัส C# ต่อไปนี้เพื่อแทรกและลบความคิดเห็นในไฟล์ ODS

{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่าง C# เพื่อแทรกและลบความคิดเห็นในไฟล์ ODS" offSpacer="" %}}
