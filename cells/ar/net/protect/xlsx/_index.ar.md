---
title:  حماية وقفل XLSX مستند via .NET
weight: 90
description: كود المصدر C# لقفل ملف XLSX باستخدام كلمة المرور على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
1.  إنشاء مثيل لفئة المصنف مع المسار إلى الملف XLSX
