---
title: Converti ODS in XML tramite l'applicazione C++ 

description: Esempio di codice di conversione C++ per un documento ODS in formato XML. I programmatori possono utilizzare questo codice sorgente per la conversione batch da ODS a XML all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire ODS in XML utilizzando C++" %}}

 Per convertire ODS in XML, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire ODS in XML tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente i file ODS in XML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file ODS usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XML).1. Il file XML verrà salvato nel percorso specificato.1. Apri il file XML in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da ODS a XML C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da ODS a XML" sectionDescription="[Converti ODS in XML](https://products.aspose.app/cells/conversion/ods-to-xml) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file ODS, verrà convertito istantaneamente in XML." >}}
