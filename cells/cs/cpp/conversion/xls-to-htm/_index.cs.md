...
{{% cells-convert title="Ukázkový kód pro převod XLS na HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="htm" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLS na HTM přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XLS soubory na HTM programově? Vývojáři C++ mohou snadno převést XLS na HTM v několika řádcích kódu.
...
1.  Převeďte XLS na HTM voláním metody Save().
