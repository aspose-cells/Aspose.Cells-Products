...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى PNG عبر Java" h2="TABDELIMITED لتحويل PNG Java لتحويل صفحة واحدة أو صفحات متعددة إلى PNG باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى PNG باستخدام Java" %}}

 من أجل تقديم TABDELIMITED إلى PNG ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TABDELIMITED إلى PNG عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل ملف TABDELIMITED بسهولة إلى PNG في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف TABDELIMITED مع مثيل المصنف1. حدد الافتراضي أو أي ورقة عمل من المجموعة1. إنشاء وتعيين كائن ImageOrPrintOptions1. قم بإنشاء SheetRender باستخدام كائنات ورقة العمل و ImageOrPrintOptions1. طريقة Call SheetRender.toImage لحفظ النتيجة بتنسيق PNG
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED إلى PNG Java رمز مصدر التحويل" offSpacer="" %}}
