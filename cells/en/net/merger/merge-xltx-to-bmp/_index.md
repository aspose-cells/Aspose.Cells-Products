...
description: Aspose Excel. C# Aspose.Cells. Merge XLTX to BMP saveformat. C# Combine XLTX to BMP format. Merge XLTX to BMP in C#. XLTX Merge.
...
{{% blocks/products/pf/agp/content h2="Merge XLTX to BMP in C#" %}}
...
{{% cells-merger title="Sample Code to Merge XLTX to BMP in C#" InputFormat="xltx" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
