...
description: Aspose Excel. Python Aspose.Cells. Mesclar XML para XPS saveformat. Python Combine XML com o formato XPS. Mesclar XML para XPS em Python. Mesclar XML.
...
{{% blocks/products/pf/agp/content h2="Mesclar XML com XPS usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar XML para XPS em Python" %}}
...
{{% cells-merger title="Exemplo de código para mesclar XML para XPS em Python" InputFormat="xml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XML com XPS via Python" %}}
