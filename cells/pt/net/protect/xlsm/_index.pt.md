...
weight: 7530
description: Código-fonte C# para bloquear o arquivo XLSM usando senha no .NET Framework, .NET Core, Mono ou plataformas Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criptografar arquivos XLSM por meio de C#" h2="Planilhas Excel protegidas por senha, incluindo formato XLSM usando a Biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Proteja XLSM via C#" %}}
...
1.  Instancie a classe Workbook com caminho para o arquivo XLSM
