---
title: C++ MHTML na PRN - MHTML na PRN převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu MHTML do formátu PRN, což umožňuje bezproblémové ukládání dat MHTML do formátu PRN pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na PRN v kódu C++" h2="Vysoce výkonná konverze MHTML na PRN s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte si MHTML do PRN v C++" %}}

Následující příklad ukazuje, jak převést číslo MHTML na PRN v kódu C++.
...
Potřebujete programově převést soubory MHTML na PRN? Vývojáři C++ mohou snadno převést soubory MHTML na PRN pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na PRN voláním metody Save().
