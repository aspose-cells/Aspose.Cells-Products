---
title: PHP OTS إلى XPS - OTS إلى XPS محول
description: Aspose اكسل. قم بتحويل OTS إلى XPS بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى XPS. PHP احفظ OTS إلى XPS. احفظ OTS كـ XPS باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى XPS في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى XPS. هذا حل برمجي احترافي لاستيراد وتصدير OTS وXPS والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى XPS عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى XPS برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى XPS في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى XPS عن طريق استدعاء طريقة حفظ المصنف.
