---
title: Konwertuj XLT na XPS za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlt-to-xps/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLT do formatu XPS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLT na XPS w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na XPS za pomocą C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na XPS za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLT na XPS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XPS).1. Plik XPS zostanie zapisany pod określoną ścieżką.1. Otwórz plik XPS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLT do XPS C++ Kod źródłowy konwersji" offSpacer="" %}}
