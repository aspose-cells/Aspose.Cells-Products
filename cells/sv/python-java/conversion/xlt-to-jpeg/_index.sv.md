---
title: Konvertera XLT till JPEG via Python
url: /sv/python-java/conversion/xlt-to-jpeg/
description: Exempelkod för konvertering av xlt till jpeg Python. Använd API exempelkod för batch-xlt-filer till jpeg-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLT till JPEG med Python" %}}

 För att konvertera XLT till JPEG kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLT till JPEG via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLT-filer till JPEG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLT-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utdatasökväg med JPG-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande JPEG-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLT till JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="jpg" IsLandingPage="true" language="python" %}}
