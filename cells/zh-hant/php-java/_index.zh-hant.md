...
description: PHP Excel 電子表格 API 用於讀寫和轉換 XLS XLSX CSV TSV HTML ODS SpreadsheetML 和所有 Excel 97-2016 格式。將電子表格導出為多種格式
---
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="通過 Java 功能對 PHP 的 Aspose.Cells 進行概述。" >}}
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="通過 Java 的 PHP Aspose.Cells 需要 PHP 7.1（或更高版本）和 JavaBridge。它可以在可以滿足這些要求的任何平台上運行。" >}}
<div class="diagram1 d1-php-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/slr-element name="API 參考資料" href="https://apireference.aspose.com/php/cells" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼通過 Java 為 PHP 提供 Aspose.Cells？" tabId="success-stories" >}}
