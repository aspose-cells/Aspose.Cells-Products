---
title: Python NUMARALAR'dan ODS'e - NUMARALAR'dan ODS'e Dönüştürücü
description: Aspose Excel'de. Python Excel'de. NUMBERS'ı Aspose.Cells ile hızlı ve kolay bir şekilde ODS'e dönüştürün. Python NUMBERS'ı ODS'e dönüştürün. Python NUMBERS'ı ODS'e kaydedin. NUMBERS'ı Python Excel Kitaplığı'nı kullanarak ODS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="NUMBERS\'ı Python aracılığıyla ODS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı programlı olarak ODS'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyip ODS'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak NUMBERS'ı ODS'e dönüştürün.
1.  NUMBERS'ın dönüşüm sonucunu ODS'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python NUMARALARI ODS\'e Dönüştürmek için Excel Kitaplığı" %}}
