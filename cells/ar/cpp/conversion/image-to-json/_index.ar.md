...
هل تحتاج إلى تحويل ملفات IMAGE إلى JSON برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى JSON في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى JSON باستدعاء طريقة Save ().
