---
title: C# ODS 轉 XLSM - 在線 ODS 轉 XLSM 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 ODS 轉換為 XLSM 保存格式。 C# ODS 到 XLSM 格式。將 ODS 保存為 XLSM C#。
...
{{% blocks/products/pf/agp/content h2="免費在線保存 ODS 至 XLSM 於 C#" %}}

以下示例演示如何將 C# 中的 ODS 轉換為 XLSM。
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 ODS 轉換為 XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xlsm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 ODS 轉換為 XLSM" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 ODS 文件轉換為 XLSM 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 ODS 到 XLSM。
