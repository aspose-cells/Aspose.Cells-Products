---
title: C++ MHT to PRN - MHT to PRN Converter
description: Aspose Excel. Convert MHT to PRN quickly and easily with Aspose.Cells. C++ MHT to PRN. C++ Save MHT to PRN. Save MHT as PRN using C++.
...
{{% blocks/products/pf/agp/content h2="Save MHT to PRN in C++" %}}
...
{{% cells-convert title="Sample Code to Convert MHT to PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="prn" IsLandingPage="true" language="cpp" %}}
