...
{{% blocks/products/pf/agp/feature-section-col title="Megjegyzés hozzáadása vagy törlése a XLSX-es számról a C#-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Megjegyzések törlése a XLSX - C# számokról" offSpacer="" %}}
