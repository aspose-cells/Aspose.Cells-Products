---
title: Java FODS 轉 TSV - 在線 FODS 轉 TSV 轉換器
description: Aspose Excel。 Java Aspose.Cells。Java Aspose Cells。免費在線 Java 將 FODS 轉換為 TSV 保存格式。 Java FODS 到 TSV 格式。將 FODS 保存為 TSV Java。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 Java 中的 TSV" h2="高速Java庫，用於將FODS轉換為TSV。這是一個專業的軟件解決方案，用於導入和導出FODS、TSV和使用Java的許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線保存 FODS 至 TSV 於 Java" %}}

以下示例演示如何將 Java 中的 FODS 轉換為 TSV。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 轉換為 TSV。上傳您的 FODS 文件，然後只需將其另存為 TSV 文件。對於 FODS 讀取和 TSV 寫入，您可以使用完全限定的文件名。輸出 TSV 內容和格式將與原始 FODS 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 FODS 轉換為 TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何轉換 FODS 為 TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 FODS 文件轉換為 TSV 嗎？ Java開發人員只需幾行代碼即可輕鬆將FODS轉換為TSV。
...
1. 通過調用Workbook.save方法將FODS轉換為TSV。
1. 獲取FODS到TSV的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java庫將FODS轉換為TSV" %}}
{{% blocks/products/pf/agp/text %}}
