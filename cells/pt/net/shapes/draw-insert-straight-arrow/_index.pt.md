...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir seta reta no arquivo Excel via C#" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o[adicionar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) para inserir uma seta reta na planilha selecionada
