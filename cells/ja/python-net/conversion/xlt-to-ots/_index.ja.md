...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLT を OTS にすばやく簡単に変換します。Python XLT を OTS に変換します。Python XLT を OTS に保存します。Python Excel ライブラリを使用して、XLT を OTS として保存します。
