...
{{% blocks/products/pf/agp/content h2="Cách chèn TextBox vào file Excel bằng Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn TextBox vào file Excel dùng Python via Java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addTextBox(int,%20int,%20int,%20int,%20int,%20int)) để chèn TextBox vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn TextBox - Python via Java" offSpacer="" %}}
