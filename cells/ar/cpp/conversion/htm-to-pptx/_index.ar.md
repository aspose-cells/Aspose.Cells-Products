---
title: C++ HTM إلى PPTX - محول HTM عبر الإنترنت إلى PPTX
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل HTM إلى PPTX saveformat. C++ HTM إلى تنسيق PPTX. احفظ HTM في PPTX C++.
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في PPTX في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات HTM إلى PPTX برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى PPTX في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى PPTX باستدعاء طريقة Save ().
