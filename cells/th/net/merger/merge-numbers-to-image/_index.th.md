---
title: รวมตัวเลขเข้ากับ IMAGE - รวมตัวเลขเข้ากับ IMAGE ใน C#
url: /th/net/merger/merge-numbers-to-image/ 
description: Aspose เอ็กเซล. C# Aspose.Cells รวมตัวเลขเข้ากับรูปแบบการบันทึกของ IMAGE C# รวมตัวเลขเป็นรูปแบบ IMAGE รวมตัวเลขเข้ากับ IMAGE ใน C# รวมตัวเลข
...
{{% blocks/products/pf/agp/content h2="รวมตัวเลขเข้ากับ IMAGE ใน C#" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน NUMBERS เข้ากับ IMAGE ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม NUMBERS เข้ากับ IMAGE อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine สำหรับการรวมไฟล์ จากนั้นบันทึกลงในไฟล์ IMAGE หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่รวม NUMBERS เข้ากับ IMAGE

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="โค้ดตัวอย่างเพื่อรวมตัวเลขเข้ากับ IMAGE ใน C#" InputFormat="numbers" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวมตัวเลขเข้ากับ IMAGE ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการรวม NUMBERS เข้ากับ IMAGE โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ไลบรารี่เพื่อรวม NUMBERS เข้ากับ IMAGE" %}}
