...
description: Aspose Excel. Python Aspose.Cells. Sloučit FODS do formátu uložení OTS. Python Zkombinujte FODS do formátu OTS. Sloučit FODS do OTS v Python. FODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit FODS na OTS v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení FODS do OTS v Python" InputFormat="fods" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
