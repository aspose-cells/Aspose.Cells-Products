...
description: Aspose エクセル。 C++ Aspose.Cells。XLS を FODS の保存形式に無料でオンライン結合します。 C++ XLS と FODS の形式を結合します。 XLS から FODS を C++ に結合します。XLS を結合します。
...
{{% cells-merger title="XLS を C++ にオンラインで無料でマージ" InputFormat="xls" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
