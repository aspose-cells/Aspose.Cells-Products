---
title: ادمج XLTX مع OTS - اجمع XLTX إلى OTS في C++
url: /ar/cpp/merger/merge-xltx-to-ots/ 
description: Aspose إكسل. C++ Aspose.Cells. الدمج المجاني عبر الإنترنت XLTX إلى OTS saveformat. C++ اجمع XLTX إلى تنسيق OTS. دمج XLTX إلى OTS في C++. XLTX دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج XLTX إلى OTS في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج XLTX مع OTS في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج XLTX في OTS. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف OTS. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج XLTX إلى OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="عبر الإنترنت مجانًا لدمج XLTX مع OTS في C++" InputFormat="xltx" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLTX مع OTS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج XLTX مع OTS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج XLTX إلى OTS" %}}
