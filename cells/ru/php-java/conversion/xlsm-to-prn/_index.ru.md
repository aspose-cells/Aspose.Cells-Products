---
title: Конвертер PHP XLSM в PRN - XLSM в PRN
description: Aspose Эксель. Быстро и легко конвертируйте XLSM в PRN с помощью Aspose.Cells. PHP XLSM в PRN. PHP Сохранить XLSM в PRN. Сохраните XLSM как PRN, используя PHP.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XLSM в PRN через PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы XLSM в PRN? Разработчики PHP могут легко загрузить и преобразовать XLSM в PRN всего за несколько строк кода.
...
1.  Преобразуйте XLSM в PRN, вызвав метод сохранения книги.
1.  Получите результат преобразования XLSM в PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования XLSM в PRN" %}}
