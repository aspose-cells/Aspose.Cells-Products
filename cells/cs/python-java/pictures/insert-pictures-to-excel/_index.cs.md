---
title:  Vložte obrázek do Excelu přes Python
weight: 200
description: Python zdrojový kód pro vložení obrázku do Excelu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vložte obrázek do Excelu přes Python" h2="Vkládejte objekty pomocí rozhraní API na straně serveru bez jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF atd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit obrázek do souboru aplikace Excel pomocí Python" %}}

 Abychom vložili obrázek do excelového souboru, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení obrázku do souboru Excel přes Python" %}}
...
+ Vyberte List přes jeho index.
 + Použijte sbírku obrázků[přidat metodu](https://reference.aspose.com/cells/java/com.aspose.cells/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) pro vložení obrázku do vybraného listu.
...
{{% blocks/products/pf/agp/code-block title="Vložit obrázek - Python" offSpacer="" %}}
