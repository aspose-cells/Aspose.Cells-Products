---
title: A MHTML egyesítése az OTS-hez - A MHTML-es szám egyesítése az OTS-hez a C#-ben
url: /hu/net/merger/merge-mhtml-to-ots/ 
description: Aspose Excel. C# Aspose.Cells. A MHTML egyesítése OTS mentési formátumba. C# A MHTML kombinálása OTS formátumba. A MHTML egyesítése az OTS-hez a C#-ben. MHTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A MHTML egyesítése az OTS-hez a C#-ben" %}}

következő példa bemutatja, hogyan lehet egyesíteni a MHTML-et az OTS-szel a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a MHTML OTS-be olvasztásához. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el OTS-fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a MHTML-et az OTS-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a MHTML OTS-hez való egyesítéséhez a C#-ben" InputFormat="mhtml" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML egyesítése az OTS-hez a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et az OTS-hez? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML OTS-hez való egyesítéséhez" %}}
