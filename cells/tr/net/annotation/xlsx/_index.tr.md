---
title:  Ekle veya Kaldır XLSX Ek Açıklama via .NET
weight: 2010
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSX biçim ek açıklamalarını eklemek ve silmek için C# kaynak kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="XLSX\'den C#\'e Ek Açıklama Ekleme veya Silme" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSX - C#\'den Ek Açıklamaları Sil" offSpacer="" %}}
