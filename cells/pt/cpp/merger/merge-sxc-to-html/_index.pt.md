---
title:  Mesclar SXC para HTML via C++
url: /pt/cpp/merger/merge-sxc-to-html/ 
description: Mesclar SXC para HTML Online gratuitamente. Online Grátis SXC a HTML Fusão. Mesclar SXC para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar SXC a HTML em C++.
...
{{% cells-merger title="Aplicativo gratuito para mesclar SXC a HTML on-line" InputFormat="sxc" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
