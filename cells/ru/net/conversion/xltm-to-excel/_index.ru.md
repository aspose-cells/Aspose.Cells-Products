...
description: Aspose Эксель. Преобразуйте XLTM в EXCEL быстро и легко с помощью Aspose.Cells. C# XLTM в EXCEL. C# Сохраните XLTM в EXCEL. Сохраните XLTM как EXCEL, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в EXCEL в C#." %}}

В следующем примере показано, как преобразовать XLTM в EXCEL в C#.
...
{{% cells-convert title="Пример кода для преобразования XLTM в EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="xlsx" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XLTM в EXCEL" %}}
