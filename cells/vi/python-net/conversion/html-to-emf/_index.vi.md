...
{{% blocks/products/pf/agp/content h2="Chuyển đổi HTML thành EMF thành Python" %}}
...
Ví dụ sau đây minh họa cách chuyển đổi HTML thành EMF trong Python via NET.
