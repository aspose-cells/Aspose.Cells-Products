---
title: Java를 통해 XLS 파일 병합 
weight: 5140
url: /ko/java/merger/xls/ 
description: Java JSP/JSF 애플리케이션 및 데스크톱 애플리케이션을 위한 Java 런타임 환경에서 XLS 문서를 결합하는 샘플 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java에서 XLS 형식 병합" h2="서버측 Java API를 사용한 기본 XLS 문서 병합." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java에서 XLS 파일 병합 단계" %}}
...
+ Workbook 클래스의 인스턴스가 있는 첫 번째 XLS 파일을 로드합니다.
+ Workbook 클래스의 인스턴스로 두 번째 XLS 문서를 로드합니다.
+ Combine() 메서드를 사용하여 파일을 병합합니다.
지정된 경로에 병합된 XLS 파일 저장
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/merger/xlt/" name="XLT" description="마이크로소프트 엑셀 템플릿" >}}
