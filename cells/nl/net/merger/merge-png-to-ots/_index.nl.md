...
description: Aspose Excel. C# Aspose.Cells. Voeg PNG samen naar OTS-opslagformaat. C# Combineer PNG naar OTS-formaat. Voeg PNG samen met OTS in C#. PNG Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Hoe u PNG samenvoegt met OTS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PNG programmatisch samenvoegen met OTS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
