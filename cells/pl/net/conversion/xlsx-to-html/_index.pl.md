---
title: Konwertuj XLSX na HTML przez C#
url: /pl/net/conversion/xlsx-to-html/
description: Przykładowy kod konwersji xlsx na html C#. Użyj przykładowego kodu API dla plików wsadowych xlsx do konwersji html w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSX na HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="html" IsLandingPage="true" %}}
