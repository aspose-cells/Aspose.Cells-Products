...
description: Aspose Excel. Java Szybko i łatwo utwórz plik ETT za pomocą Aspose.Cells. Wygeneruj plik ETT za pomocą Java. Utwórz ETT w Java. Java Kreator ETT.
...
1.  Zapisz skoroszyt w formacie ETT przy użyciu metody save().
