---
title: Convertir XLSB en XLTX via Java 
weight: 3970
url: /fr/java/conversion/xlsb-to-xltx/ 
description: Exemple de code de conversion Java pour le format XLSB en fichier XLTX. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers XLTX dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en XLTX via Java" h2="Conversion XLSB vers XLTX Java pour convertir une ou plusieurs pages en XLTX à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en XLTX en utilisant Java" %}}

 Afin de rendre XLSB à XLTX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLSB en XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier XLSB en XLTX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier XLSB avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension XLTX et SaveFormat comme paramètres1. Vérifiez le chemin spécifié pour le fichier XLTX résultant
...
{{% blocks/products/pf/agp/code-block title="XLSB à XLTX Java Code source de conversion" offSpacer="" %}}

```cs
// charger le fichier XLSB dans une instance de Workbook
Workbook book = new Workbook("template.xlsb");
// enregistrer XLSB sous XLTX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion XLSB vers XLTX" sectionDescription="[Convertir XLSB en XLTX](https://products.aspose.app/cells/conversion/xlsb-to-xltx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier XLSB, il sera converti instantanément en XLTX." >}}
