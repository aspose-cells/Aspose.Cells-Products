---
title: Convertidor PHP XLAM a XLSB - XLAM a XLSB
description: Aspose Excel. Convierta XLAM a XLSB rápida y fácilmente con Aspose.Cells. PHP XLAM a XLSB. PHP Guarde XLAM a XLSB. Guarde XLAM como XLSB usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLAM a XLSB mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLAM a XLSB mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente XLAM a XLSB en tan solo unas pocas líneas de código.
...
1.  Convierta XLAM a XLSB llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de XLAM a XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir XLAM a XLSB" %}}
