---
title:  Sloučit TABDELIMITED na PPTX via Java
...
Následující příklad ukazuje, jak sloučit TABDELIMITED do PPTX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TABDELIMITED na PPTX online" InputFormat="tsv" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
