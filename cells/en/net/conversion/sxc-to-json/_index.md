...
description: Aspose Excel. C# Aspose.Cells. SXC to JSON in C#. C# Convert SXC to JSON saveformat. C# SXC to JSON format. Save SXC to JSON C#.
keywords: [Aspose Excel., C# Aspose.Cells., SXC to JSON in C#., C# SXC to JSON saveformat., SXC to JSON C#., C# Convert SXC to JSON]
---
...
{{% cells-convert title="Sample Code to Convert SXC to JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="json" IsLandingPage="true" %}}
