...
description: Aspose エクセル。 C++ Aspose.Cells。XLS を DIF の保存形式にマージします。 C++ XLS と DIF の形式を結合します。 XLS から DIF を C++ に結合します。XLS を結合します。
...
{{% cells-merger title="XLS から DIF を C++ にマージするサンプルコード" InputFormat="xls" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
