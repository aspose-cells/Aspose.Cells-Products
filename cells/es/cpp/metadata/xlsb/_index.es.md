---
title:  Editar o ver XLSB Metadatos del documento a través de C++
weight: 4820
description: C++ código de ejemplo para editar o ver los metadatos del archivo XLSB en el entorno de tiempo de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraer XLSB Metadatos a través de C++" h2="Cree sus propias aplicaciones C++ para agregar, editar, eliminar o extraer metadatos de archivos XLSB utilizando las API del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cómo obtener metadatos XLSB usando C++" %}}

Para extraer los metadatos XLSB, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para extraer metadatos de XLSB a través de C++" %}}
...
+ Cargue el archivo XLSB usando CreateIWorkbookMetadata
...
{{% blocks/products/pf/agp/code-block title="Extraer metadatos de XLSB - C++" offSpacer="" %}}
