---
title: IMAGE'ı JPG ile birleştir - C++'de IMAGE'ı JPG ile birleştir
url: /tr/cpp/merger/merge-image-to-jpg/ 
description: Aspose Excel'de. C++ Aspose.Cells. GÖRÜNTÜYÜ JPG kaydetme biçimiyle birleştirin. C++ IMAGE'ı JPG formatıyla birleştirin. IMAGE'ı C++'de JPG ile birleştir. IMAGE Birleştir.
...
{{% blocks/products/pf/agp/content h2="IMAGE\'ı C++\'deki JPG ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for C++'de IMAGE'ın JPG ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

IMAGE'ı JPG ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından JPG dosyasına kaydedin. C++'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. IMAGE'ı JPG ile birleştiren C++ örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C++\'de IMAGE\'ı JPG ile Birleştirmek için Örnek Kod" InputFormat="png" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="IMAGE\'ı C++ aracılığıyla JPG ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

IMAGE'ı JPG ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="IMAGE\'ı JPG ile birleştirmek için C++ kütüphane" %}}
