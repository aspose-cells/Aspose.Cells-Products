...
url: /cs/python-net/merger/merge-xlsm-to-png/ 
...
Následující příklad ukazuje, jak sloučit XLSM až PNG v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit XLSM až PNG? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
