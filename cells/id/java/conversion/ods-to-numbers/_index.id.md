...
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Online Gratis Java Ubah ODS menjadi ANGKA saveformat. Java ODS ke format ANGKA. Simpan ODS ke NOMOR Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ODS menjadi ANGKA di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi ODS menjadi ANGKA. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, ANGKA, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke ANGKA di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi ODS menjadi ANGKA di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah ODS menjadi ANGKA via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file ODS menjadi ANGKA secara terprogram? Pengembang Java dapat dengan mudah mengonversi ODS menjadi ANGKA hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi ODS menjadi ANGKA" %}}
{{% blocks/products/pf/agp/text %}}
