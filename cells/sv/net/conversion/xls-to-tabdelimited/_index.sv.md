---
title: C# XLS till TABDELIMITED - XLS till TABDELIMITED Converter
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till TABDELIMITED-format, vilket möjliggör sömlös sparning av XLS-data till TABDELIMITED-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till TABDELIMITED i C#" %}}

Följande exempel visar hur man konverterar XLS till TABDELIMITED i C#.
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till TABDELIMITED via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till TABDELIMITED programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till TABDELLIMITED på bara några rader kod.
...
1.  Konvertera XLS till TABDELIMITED genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet av XLS till TABDELIMITED.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-biblioteket för att konvertera XLS till TABDELIMITED" %}}
