...
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do XLAM uložit formát. C++ Kombinujte formát XLTX až XLAM. Sloučit XLTX až XLAM v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX až XLAM v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX až XLAM v C++" InputFormat="xltx" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
