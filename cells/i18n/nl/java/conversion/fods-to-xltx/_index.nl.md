---
title: Converteer FODS naar XLTX via Java 
url: /nl/java/conversion/fods-to-xltx/ 
description: Voorbeeld Java conversiecode voor FODS-indeling naar XLTX-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar XLTX te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer FODS naar XLTX via Java" h2="FODS naar XLTX Java-conversie om enkele of meerdere pagina\'s naar XLTX te converteren met behulp van een lokale bibliotheek Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar XLTX te converteren met Java" %}}

 Om FODS naar XLTX te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om FODS naar XLTX te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het FODS-bestand gemakkelijk converteren naar XLTX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad FODS-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met XLTX-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende XLTX-bestand
...
{{% blocks/products/pf/agp/code-block title="FODS naar XLTX Java conversiebroncode" offSpacer="" %}}

```cs
// laad het FODS-bestand in een exemplaar van Workbook
Workbook book = new Workbook("template.fods");
// sla FODS op als XLTX
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS naar XLTX Conversie Live demo\'s" sectionDescription="[Converteer FODS naar XLTX](https://products.aspose.app/cells/conversion/fods-to-xltx) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw FODS-bestand, het wordt onmiddellijk geconverteerd naar XLTX." >}}
