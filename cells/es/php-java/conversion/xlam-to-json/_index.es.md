---
title: Convertidor de PHP XLAM a JSON - XLAM a JSON
description: Aspose Excel. Esta solución integral ofrece a los desarrolladores PHP un enfoque totalmente integrado para convertir el formato XLAM al JSON, lo que permite guardar sin problemas los datos del XLAM al formato JSON mediante la biblioteca Aspose.Cells, todo mediante código PHP eficiente y personalizable.
...
¿Necesitas convertir archivos XLAM a JSON mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente archivos XLAM a JSON con solo unas pocas líneas de código.
...
1.  Convierta XLAM a JSON llamando al método de guardado del libro de trabajo.
