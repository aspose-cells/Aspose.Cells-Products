---
title:  كيف يمكنني رسم أو إدراج سهم مستقيم مزدوج في Excel via Java
weight: 20
description: قم برسم أو إدراج كائنات ذات أسهم مستقيمة مزدوجة باستخدام Aspose.Cells' Java API بدون أي برامج مثل Microsoft أو Open Office، Adobe PDF، إلخ.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج سهم مستقيم مزدوج في ملف Excel باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج سهم مستقيم مزدوج في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) لإدراج سهم مستقيم مزدوج في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل سهمًا مستقيمًا مزدوجًا - Java" offSpacer="" %}}
