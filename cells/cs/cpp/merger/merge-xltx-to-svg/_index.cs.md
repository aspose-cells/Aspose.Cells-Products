...
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do SVG uložit formát. C++ Kombinujte formát XLTX až SVG. Sloučit XLTX až SVG v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX až SVG v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX až SVG v C++" InputFormat="xltx" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
