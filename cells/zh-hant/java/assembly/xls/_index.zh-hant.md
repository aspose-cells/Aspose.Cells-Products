---
title: 通過 Java 在 XLS 文件中生成報告 
weight: 1090
url: /zh-hant/java/assembly/xls/ 
description: Java 示例代碼，用於在 Java JSP/JSF 應用程序和桌面應用程序的運行時環境中創建 XLS 格式報告。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 以 XLS 格式批量生成報告" h2="使用數據源和模板生成 XLS 格式的報告。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 生成 XLS 報告的步驟" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. 實例化 WorkbookDesigner 類1. 在 ArrayList 中添加 Datasouce 對象1. 為 WorkbookDesigner 對象設置數據源和流程1. 通過 Worbook.save 方法以 XLS 格式保存結果
