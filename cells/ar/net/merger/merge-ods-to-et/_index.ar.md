...
{{% blocks/products/pf/agp/text %}}
 ...
 هل تحتاج إلى دمج ODS مع ET برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج ODS إلى ET" %}}
