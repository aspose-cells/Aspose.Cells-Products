---
title:  मर्ज XLSB फ़ाइलें via Java
weight: 4840
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरनमेंट पर XLSB दस्तावेज़ों को संयोजित करने के लिए Java नमूना कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB प्रारूपों को Java में मर्ज करें" h2="सर्वर-साइड Java एपीआई का उपयोग करके मूल XLSB दस्तावेज़ विलय।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB फ़ाइलों को Java का उपयोग करके कैसे मर्ज करें" %}}
...
{{% blocks/products/pf/agp/code-block title="मर्ज XLSB फ़ाइलें - Java" offSpacer="" %}}
