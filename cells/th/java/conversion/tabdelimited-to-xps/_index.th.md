---
title: แปลง TABDELIMITED เป็น XPS ผ่าน Java 

description: ตัวอย่างโค้ดการแปลง Java สำหรับรูปแบบ TABDELIMITED เป็นไฟล์ XPS โปรแกรมเมอร์สามารถใช้โค้ดตัวอย่างนี้เพื่อส่งออกสเปรดชีต Excel & OpenOffice ไปยัง XPS ภายในแอปพลิเคชันบนเว็บหรือเดสก์ท็อป Java
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง TABDELIMITED เป็น XPS ผ่าน Java" h2="การแปลง TABDELIMITED เป็น XPS Java เพื่อแปลงหน้าเดียวหรือหลายหน้าเป็น XPS โดยใช้ไลบรารี Java ในสถานที่" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง TABDELIMITED เป็น XPS โดยใช้ Java" %}}

 เพื่อแสดงผล TABDELIMITED เป็น XPS เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง TABDELIMITED เป็น XPS ผ่าน Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java นักพัฒนาสามารถแปลงไฟล์ TABDELIMITED เป็น XPS ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ TABDELIMITED ด้วยอินสแตนซ์ของ Workbook class1. วิธีการโทร Workbook.save1. ส่งผ่านเส้นทางเอาต์พุตด้วยส่วนขยาย XPS & SaveFormat เป็นพารามิเตอร์1. ตรวจสอบเส้นทางที่ระบุสำหรับไฟล์ XPS ที่เป็นผลลัพธ์
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED เป็น XPS Java รหัสแหล่งที่มาของการแปลง" offSpacer="" %}}

```cs
// โหลดไฟล์ TABDELIMITED ในอินสแตนซ์ของ Workbook
Workbook book = new Workbook("template.tabdelimited");
// บันทึก TABDELIMITED เป็น XPS
