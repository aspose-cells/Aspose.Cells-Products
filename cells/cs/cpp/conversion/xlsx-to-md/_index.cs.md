...
{{% blocks/products/pf/agp/content h2="Jak převést XLSX na MD pomocí C++" %}}
 ...
 K převodu XLSX na MD použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu XLSX na MD přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLSX na MD pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLSX pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (MD).1. Soubor MD bude uložen do zadané cesty.1. Otevřete soubor MD v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu XLSX na MD C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze XLSX na MD" sectionDescription="[Převést XLSX na MD](https://products.aspose.app/cells/conversion/xlsx-to-md) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor XLSX, bude okamžitě převeden na MD." >}}
