...
{{% blocks/products/pf/agp/content h2="TXT konvertálása JPG-vé a következővel: Java" %}}

 A TXT JPG formátumba való rendereléséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TXT konvertálásához JPG-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a TXT fájlt JPG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat JPG kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott JPG fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT-ből JPG-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése JPG formátumban
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT-ből JPG-be konvertáló élő bemutatók" sectionDescription="[TXT konvertálása JPG-be](https://products.aspose.app/cells/conversion/txt-to-jpg) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel TXT fájlját, és azonnal JPG formátumba konvertálódik." >}}
