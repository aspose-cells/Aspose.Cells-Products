---
title: C# HTML から HTM - オンライン HTML から HTM コンバータ
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# HTML を HTM 保存形式に変換します。 C# HTML を HTM 形式に変換します。 HTML を HTM C# に保存します。
...
{{% cells-convert title="HTMLをオンラインでHTMに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML経由でHTMLをHTMに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで HTM に変換する必要がありますか? .NET 開発者は、わずか数行のコードで HTML を簡単にロードして HTM に変換できます。
