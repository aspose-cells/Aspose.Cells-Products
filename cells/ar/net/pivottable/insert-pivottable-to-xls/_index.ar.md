...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 يعد إنشاء ملف MS Excel XLS باستخدام PivotTable ديناميكيًا داخل التطبيق قيد التشغيل أمرًا سهلاً. من أجل إنشاء مستندات XLS باستخدام PivotTable من البداية دون الحاجة إلى MS Office ، سنستخدم
