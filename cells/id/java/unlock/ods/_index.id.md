...
weight: 5080
description: Kode sampel Java untuk membuka kunci file ODS yang dilindungi kata sandi di Lingkungan Runtime Java untuk Aplikasi JSP/JSF dan Aplikasi Desktop.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah membuka ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Instansiasi kelas Buku Kerja dengan jalur ke file ODS yang dilindungi
...
1.  Simpan hasil dalam format ODS
...
{{% blocks/products/pf/agp/code-block title="Buka File ODS melalui C#" offSpacer="" %}}
