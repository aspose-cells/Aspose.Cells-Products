...
description: XLSM 创建者。在 C# 代码中创建 XLSM 个文件。使用 VB.NET、Asp.NET 或任何基于 .NET 的应用程序生成 MS Excel XLSM 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 创建 XLSM 文件" h2="本机和高性能 MS Excel XLSM 使用服务器端 .NET API 以编程方式创建电子表格。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/code-block title="使用 C# 创建 MS Excel XLSM 文件的示例代码。" offSpacer="" %}}
