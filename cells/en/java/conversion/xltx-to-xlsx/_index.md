...
description: Sample Java conversion code for XLTX format to XLSX file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to XLSX within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert XLTX to XLSX Using Java" %}}

 In order to render XLTX to XLSX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLTX to XLSX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XLTX to XLSX Java Conversion Source Code" offSpacer="" %}}
