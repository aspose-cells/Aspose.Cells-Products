---
title: Konvertera XLT till FODS via Python

description: Exempelkod för konvertering av xlt till fods Python. Använd API-exempelkod för batch-xlt-filer för att ge konvertering inom Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar XLT till FODS med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLT till FODS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLT-filer till FODS på bara några rader kod.
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLT till FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="fods" IsLandingPage="true" language="python" %}}
