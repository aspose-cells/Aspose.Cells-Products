...
url: /nl/python-java/merger/merge-xlt-to-emf/ 
...
Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met EMF in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLT programmatisch samenvoegen tot EMF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
