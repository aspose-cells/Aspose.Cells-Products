---
title: 使用Python via java将图片插入Excel
weight: 200
description: Python via java源代码将图片插入Excel。
...
{{< blocks/products/pf/i18n/upper-banner h1="使用Python via java将图片插入Excel" h2="使用Aspose.Cells\'API插入图片，无需任何软件，如Microsoft或Open Office、Adobe PDF等。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via java 将图片插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用Python via java将图片插入Excel文件的步骤" %}}
...
+ 通过索引选择工作表。
 使用图片集[添加方法](https://reference.aspose.com/cells/python-java/asposecells.api/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)在选定的工作表中插入图片。
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入图片 - Python via java" offSpacer="" %}}
