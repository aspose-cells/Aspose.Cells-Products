---
title: Convertisseur PHP JSON vers SPREADSHEETML - JSON vers SPREADSHEETML
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir JSON au format SPREADSHEETML, permettant un enregistrement transparent des données JSON au format SPREADSHEETML à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code PHP efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir JSON en SPREADSHEETML en PHP" h2="Bibliothèque PHP haute performance pour la conversion du format JSON vers SPREADSHEETML. Solution logicielle professionnelle pour l\'importation et l\'exportation de fichiers JSON, SPREADSHEETML et de nombreux autres formats via PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for PHP" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/php-java" installationsDocsLink="https://docs.aspose.com/cells/php-java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/php/" learnAsLink="https://docs.aspose.com/cells/php-java" apiReference="" mavenRepoLink="" >}}


{{% blocks/products/pf/agp/content h2="Convertir JSON en SPREADSHEETML à l\'aide de PHP" %}}

 Comment convertir JSON en SPREADSHEETML ? Grâce à la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir JSON en SPREADSHEETML par programmation en quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) PHP Excel API permet de créer des applications multiplateformes capables de générer, modifier, convertir, afficher et imprimer tous les fichiers Excel. Outre la conversion entre différents formats de tableur, il peut également afficher les fichiers Excel sous forme d'images (PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT), ce qui en fait un outil idéal pour l'échange de documents aux formats standards.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrez JSON au format SPREADSHEETML en PHP" %}}

L'exemple suivant montre comment convertir JSON en SPREADSHEETML en PHP.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir JSON en SPREADSHEETML. Téléchargez votre fichier JSON, puis enregistrez-le simplement en tant que fichier SPREADSHEETML. Pour la lecture JSON et l'écriture SPREADSHEETML, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la SPREADSHEETML de sortie seront identiques au document JSON d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir JSON en SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="json" outformat="xml" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JSON en SPREADSHEETML via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JSON en SPREADSHEETML par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers JSON en SPREADSHEETML en quelques lignes de code seulement.
...
1.  Convertissez JSON en SPREADSHEETML en appelant la méthode save de Workbook.
1.  Obtenez le résultat de la conversion de JSON en SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir JSON en SPREADSHEETML" %}}
