...
description: Aspose Эксель. Быстро и легко конвертируйте XML в PDF с помощью Aspose.Cells. C++ XML в PDF. C++ Сохраните XML в PDF. Сохраните XML как PDF, используя C++.
...
{{% blocks/products/pf/agp/content h2="Преобразование XML в PDF с помощью C++" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML в PDF в C++." %}}

В следующем примере показано, как преобразовать XML в PDF в C++.
...
Вам нужно программно преобразовать XML-файлы в PDF? Разработчики C++ могут легко преобразовать XML в PDF всего за несколько строк кода.
...
1.  Преобразуйте XML в PDF, вызвав метод Save().
