---
title: ODS'i POWERPOINT ile birleştir - ODS'i Java'de POWERPOINT ile birleştir
url: /tr/java/merger/merge-ods-to-powerpoint/ 
description: Aspose Excel'de. Java Aspose.Cells. ODS'i POWERPOINT kaydetme biçimiyle birleştirin. Java ODS'i POWERPOINT biçimiyle birleştirin. ODS'i Java'deki POWERPOINT ile birleştirin. ODS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'deki POWERPOINT ile birleştir" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'deki POWERPOINT ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i POWERPOINT ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından POWERPOINT dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. ODS'i POWERPOINT ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'deki POWERPOINT ile Birleştirmek için Örnek Kod" InputFormat="ods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i POWERPOINT via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i POWERPOINT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, ODS\'i POWERPOINT ile birleştirecek" %}}
