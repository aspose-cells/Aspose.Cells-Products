---
title: Converteer TXT naar CSV via C++ applicatie 
url: /nl/cpp/conversion/txt-to-csv/ 
description: Voorbeeld C++ conversiecode voor TXT-document naar CSV-indeling. Programmeurs kunnen deze broncode gebruiken voor batchconversie van TXT naar CSV binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer TXT naar CSV via C++" h2="Hoogwaardige conversie van TXT naar CSV met behulp van de C++-bibliotheek zonder installatie van Microsoft Excel, OpenOffice of Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe TXT naar CSV te converteren met C++" %}}

 Om TXT naar CSV te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TXT naar CSV te converteren via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ ontwikkelaars kunnen TXT-bestanden gemakkelijk converteren naar CSV in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad TXT-bestand met behulp van Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (CSV) bestandsextensie.1. CSV-bestand wordt opgeslagen op het opgegeven pad.1. Open het CSV-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="TXT naar CSV C++ Conversiebroncode" offSpacer="" %}}
