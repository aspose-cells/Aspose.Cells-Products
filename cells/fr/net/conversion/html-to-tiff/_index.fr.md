---
title: Convertir HTML en TIFF via C#
url: /fr/net/conversion/html-to-tiff/
description: Exemple de code pour la conversion html vers tiff C#. Utilisez l'exemple de code API pour les fichiers html par lots en conversion tiff dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers HTML au format TIFF en quelques lignes de code seulement.
