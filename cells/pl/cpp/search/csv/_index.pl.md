---
title:  Wyszukaj dokument CSV bez otwierania za pomocą C++
weight: 5540
description: C++ przykładowy kod do wyszukiwania słów z wzorcem w pliku CSV w środowisku wykonawczym C++ dla Windows 32-bit, Windows 64-bit i Linux 64-bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Wyszukaj formaty CSV w C++" h2="Natywne i wydajne wyszukiwanie dokumentów CSV przy użyciu interfejsów API po stronie serwera Aspose.Cells for C++, bez użycia żadnego oprogramowania, takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online CSV Wyszukaj demonstracje na żywo" sectionDescription=" Wyszukaj tekst, słowa, frazy w dokumentach CSV już teraz, odwiedzając naszą stronę[Witryna internetowa z prezentacjami na żywo](https://products.aspose.app/cells/search). Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie trzeba pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Wystarczy, że prześlesz pliki CSV." >}}
 ...
 Pliki z rozszerzeniem CSV (Comma Separated Values) to pliki tekstowe zawierające rekordy danych rozdzielone przecinkami. Każdy wiersz w pliku CSV to nowy rekord z zestawu rekordów zawartych w pliku. Takie pliki są generowane, gdy planowany jest transfer danych z jednego systemu pamięci masowej do innego. Ponieważ wszystkie aplikacje rozpoznają rekordy rozdzielone przecinkiem, import takich plików danych do bazy danych jest bardzo wygodny. Prawie wszystkie arkusze kalkulacyjne, takie jak Microsoft Excel czy OpenOffice Calc, mogą importować CSV bez większego wysiłku. Dane importowane z takich plików są umieszczane w komórkach arkusza kalkulacyjnego w celu przedstawienia ich użytkownikowi.
