---
title: Converter JSON para XLSX via Java 
weight: 8370
url: /pt/java/conversion/json-to-xlsx/ 
description: Exemplo de código de conversão Java do formato JSON para arquivo XLSX. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para XLSX em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter JSON para XLSX via Java" h2="Exporte o formato JSON para XLSX via Java sem precisar de ferramentas ou bibliotecas adicionais." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter JSON para XLSX usando Java" %}}

 Para renderizar JSON para XLSX, usaremos
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão JSON para XLSX Java" offSpacer="" %}}
...
// salve o arquivo resultante no formato JSON-TO-XLSX
