---
title: Sloučit JSON až XLSM - Sloučit JSON až XLSM v C#
url: /cs/net/merger/merge-json-to-xlsm/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit JSON do XLSM uložit formát. C# Kombinujte formát JSON až XLSM. Sloučit JSON až XLSM v C#. JSON Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JSON až XLSM v C#" %}}

Následující příklad ukazuje, jak sloučit JSON až XLSM v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JSON do XLSM. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLSM. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí JSON do XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení JSON až XLSM v C#" InputFormat="json" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON na XLSM přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JSON až XLSM? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení JSON až XLSM" %}}
