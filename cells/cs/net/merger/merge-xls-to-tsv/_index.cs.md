...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLS do TSV uložit formát. C# Kombinujte formát XLS až TSV. Sloučit XLS až TSV v C#. XLS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLS až TSV v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLS až TSV v C#" InputFormat="xls" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
