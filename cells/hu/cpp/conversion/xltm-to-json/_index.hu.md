---
title: Konvertálja az XLTM-et JSON-ba a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/xltm-to-json/ 
description: Minta C++ konverziós kód az XLTM dokumentumhoz JSON formátumba. A programozók ezt a forráskódot használhatják XLTM-ből JSON-ba kötegelt konvertálásához bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLTM konvertálása JSON-ra a következőn keresztül: C++" h2="Nagy teljesítményű XLTM-ből JSON-ba konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="XLTM konvertálása JSON-ba a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLTM konvertálása JSON-ra a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A(z) C++ fejlesztői könnyedén konvertálhatják az XLTM fájlt JSON formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTM fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (JSON) fájlkiterjesztéssel.1. A JSON-fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a JSON fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLTM JSON C++ konverziós forráskód" offSpacer="" %}}
