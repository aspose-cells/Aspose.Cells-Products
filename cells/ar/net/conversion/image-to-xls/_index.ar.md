...
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل IMAGE إلى تنسيق XLS، مما يتيح حفظ بيانات IMAGE بسلاسة في تنسيق XLS باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
1.  قم بتحويل الصورة إلى XLS عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الصورة إلى XLS" %}}
