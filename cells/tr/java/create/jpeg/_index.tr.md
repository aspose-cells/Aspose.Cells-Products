---
title: JPEG oluştur - Java'de JPEG dosyası oluştur
description: Aspose excel. Java JPEG Dosyası Oluştur. Oluştur JPEG Java. Java JPEG Oluşturan. Java'de JPEG oluşturun. Java'i kullanarak JPEG dosyasını oluşturun.
...
{{% blocks/products/pf/agp/content h2="Java\'de JPEG Nasıl Oluşturulur" %}}
...
1.  Çalışma kitabını save() yöntemini kullanarak JPEG biçiminde kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, Java\'de JPEG dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="JPEG dosyası oluşturmak için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
