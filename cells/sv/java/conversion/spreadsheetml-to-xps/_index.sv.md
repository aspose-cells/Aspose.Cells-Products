---
title: Konvertera SPREADSHEETML till XPS via Java 
url: /sv/java/conversion/spreadsheetml-to-xps/ 
description: Exempel Java-konverteringskod för SPREADSHEETML-format till XPS-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XPS inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera SPREADSHEETML till XPS via Java" h2="SPREADSHEETML till XPS Java-konvertering för att konvertera enstaka eller flera sidor till XPS med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SPREADSHEETML till XPS med Java" %}}

 För att rendera SPREADSHEETML till XPS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SPREADSHEETML till XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera SPREADSHEETML-filen till XPS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SPREADSHEETML-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XPS-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XPS-filen
...
{{% blocks/products/pf/agp/code-block title="Källkod för omvandling av SPREADSHEETML till XPS Java" offSpacer="" %}}

```cs
// ladda SPREADSHEETML-filen i en instans av Workbook
Workbook book = new Workbook("template.spreadsheetml");
// spara SPREADSHEETML som XPS
