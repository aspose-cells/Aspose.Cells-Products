...
description: XLSM créateur. Créez des fichiers XLSM dans le code C#. Générez des fichiers MS Excel XLSM à l'aide de VB.NET, Asp.NET ou de toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier XLSM via C#" h2="Création de feuilles de calcul MS Excel XLSM natives et hautes performances par programme à l\'aide d\'API côté serveur .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer XLSM via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code pour créer un fichier MS Excel XLSM en utilisant C#." offSpacer="" %}}
