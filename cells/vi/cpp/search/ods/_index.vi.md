---
title:  Tìm kiếm tài liệu ODS mà không cần mở thông qua số C++.
weight: 3300
description: Mã ví dụ C++ để tìm kiếm các từ có mẫu trong tệp ODS trên Môi trường thời gian chạy C++ dành cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm định dạng ODS trong C++" h2="Tìm kiếm tài liệu gốc và hiệu suất cao ODS bằng cách sử dụng API phía máy chủ Aspose.Cells for C++, mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tìm kiếm tệp ODS bằng mã số C++" %}}
...
+ Tải tập tin ODS bằng cách sử dụng lớp Workbook.
