---
title: Mesclar PRN para XLSX - Combine PRN para XLSX em C++
url: /pt/cpp/merger/merge-prn-to-xlsx/ 
description: Aspose Excel. C++ Aspose.Cells. Mesclar PRN online grátis para XLSX saveformat. C++ Combine PRN para o formato XLSX. Mesclar PRN para XLSX em C++. Mesclar PRN.
...
{{% blocks/products/pf/agp/content h2="Mesclar PRN para XLSX em C++ online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar PRN para XLSX em Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar o PRN em XLSX. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo XLSX. Se você desenvolver o código em C++, isso será mais simples do que parece. Consulte o exemplo C++ que mescla PRN com XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar PRN para XLSX em C++" InputFormat="prn" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar PRN para XLSX via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar PRN para XLSX programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para mesclar PRN para XLSX" %}}
