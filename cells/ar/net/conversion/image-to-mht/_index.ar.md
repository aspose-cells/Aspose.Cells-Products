...
هل تحتاج إلى تحويل ملفات IMAGE إلى MHT برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى MHT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل IMAGE إلى MHT عن طريق استدعاء أسلوب Workbook.Save.
