...
url: /pl/net/merger/merge-jpg-to-pdf/ 
...
Poniższy przykład pokazuje, jak połączyć JPG z PDF w Aspose.Cells for .NET.
...
Chcesz programowo scalić JPG z PDF? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia JPG z PDF" %}}
