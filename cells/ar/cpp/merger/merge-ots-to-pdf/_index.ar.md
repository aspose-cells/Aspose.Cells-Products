---
title: دمج OTS في PDF - ادمج OTS إلى PDF في C++
url: /ar/cpp/merger/merge-ots-to-pdf/ 
description: Aspose إكسل. C++ Aspose.Cells. دمج OTS مجانًا عبر الإنترنت إلى تنسيق حفظ PDF. C++ ادمج OTS بتنسيق PDF. دمج OTS في PDF في C++. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="قم بدمج OTS في PDF في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج OTS مع PDF في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج OTS في PDF. قم بتحميل ملفاتك ، واتصل بطريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف PDF. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج OTS مع PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج OTS في PDF في C++" InputFormat="ots" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج OTS في PDF عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج OTS في PDF برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
