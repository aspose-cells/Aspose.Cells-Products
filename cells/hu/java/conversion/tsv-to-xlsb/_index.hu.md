---
title: "TSV konvertálása XLSB-re a következőn keresztül: Java "
weight: 7570
url: /hu/java/conversion/tsv-to-xlsb/ 
description: Minta Java konverziós kód a TSV-formátumhoz XLSB-fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok XLSB formátumba exportálására bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV konvertálása XLSB-re a következőn keresztül: Java" h2="TSV-ből XLSB-be Java konvertálva egyetlen vagy több oldalt XLSB-vé konvertálhat a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása XLSB-re a következővel: Java" %}}

 Ahhoz, hogy a TSV-t XLSB-re rendereljük, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TSV-ből XLSB-vé konvertálás lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják a TSV-fájlt XLSB-re.

{{% /blocks/products/pf/agp/text %}}

1. TSV-fájl betöltése a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLSB kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLSB fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TSV-ből XLSB-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TSV-fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tsv");
// mentse a TSV-t XLSB-ként
