---
title: C# XML в DOCX - Конвертер XML в DOCX
description: Aspose Эксель. Быстро и легко конвертируйте XML в DOCX с помощью Aspose.Cells. C# XML в DOCX. C# Сохраните XML в DOCX. Сохраните XML как DOCX, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните XML в DOCX в C#." %}}

В следующем примере показано, как преобразовать XML в DOCX в C#.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы преобразовать XML в DOCX. Загрузите XML-файл, а затем просто сохраните его как файл DOCX. Как для чтения XML, так и для записи DOCX вы можете использовать полные имена файлов. Содержимое и форматирование вывода DOCX будут идентичны исходному XML-документу.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Пример кода для преобразования XML в DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать XML в DOCX через C#" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно преобразовать XML-файлы в DOCX? Разработчики .NET могут легко загружать и конвертировать XML в DOCX всего за несколько строк кода.
...
1.  Преобразуйте XML в DOCX, вызвав метод Workbook.Save.
1.  Получите результат преобразования XML в DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XML в DOCX" %}}
