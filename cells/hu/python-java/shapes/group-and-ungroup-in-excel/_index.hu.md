---
title: Alakzatok csoportosítása és csoportosítása az Excelben a Python via Java használatával
weight: 371
description: Az objektumok csoportosítása és csoportosítása a Aspose.Cells' Python via Java API használatával szoftver nélkül, például Microsoft vagy Open Office, Adobe PDF stb.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Alakzatok csoportosítása és csoportosítása az Excelben a Python via Java használatával" h2="A Aspose.Cells\' API használatával különféle objektumokkal dolgozhat szoftver nélkül, például Microsoft vagy Open Office, Adobe PDF stb." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Alakzatok csoportosítása és csoportosítása az Excel fájlban a Python via Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az alakzatok csoportosításának és csoportosításának lépései Excel-fájlban a Python via Java használatával" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja a[csoportos módszer](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#group(com.aspose.cells.Shape[])) az alakzatok csoportosításához a kiválasztott munkalapon
 + Használja a[csoportbontás módszere](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#ungroup(com.aspose.cells.GroupShape)) az alakzatok csoportosításának megszüntetéséhez a kiválasztott munkalapon
...
{{% blocks/products/pf/agp/code-block title="Csoportosítási és csoportosítási formák - Python via Java" offSpacer="" %}}
