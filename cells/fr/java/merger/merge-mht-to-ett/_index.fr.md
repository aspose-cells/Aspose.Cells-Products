---
title: Fusionner MHT à ETT - Combiner MHT à ETT dans Java
url: /fr/java/merger/merge-mht-to-ett/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite MHT vers format de sauvegarde ETT. Java Combinez le format MHT au format ETT. Fusionner MHT à ETT en Java. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT à ETT en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT à ETT dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT à ETT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier ETT. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne MHT à ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner MHT à ETT en Java" InputFormat="mht" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT à ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner MHT à ETT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner MHT à ETT" %}}
