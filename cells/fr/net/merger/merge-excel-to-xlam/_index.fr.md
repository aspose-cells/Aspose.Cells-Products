...
url: /fr/net/merger/merge-excel-to-xlam/ 
...
L'exemple suivant montre comment fusionner EXCEL avec XLAM dans Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Besoin de fusionner EXCEL avec XLAM par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="bibliothèque .NET pour fusionner EXCEL avec XLAM" %}}
