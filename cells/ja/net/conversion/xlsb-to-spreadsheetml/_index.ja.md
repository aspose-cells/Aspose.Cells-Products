---
title: C# XLSB から SPREADSHEETML - XLSB から SPREADSHEETML コンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、XLSB を SPREADSHEETML にすばやく簡単に変換します。 C# XLSB を SPREADSHEETML に変換します。 C# XLSB を SPREADSHEETML に保存します。 C# を使用して、XLSB を SPREADSHEETML として保存します。
...
{{% blocks/products/pf/agp/content h2="XLSB を C# の SPREADSHEETML に保存" %}}
...
{{% cells-convert title="XLSBをSPREADSHEETMLに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="XLSBを経由してXLSBをSPREADSHEETMLに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSB ファイルをプログラムで SPREADSHEETML に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLSB を簡単にロードして SPREADSHEETML に変換できます。
