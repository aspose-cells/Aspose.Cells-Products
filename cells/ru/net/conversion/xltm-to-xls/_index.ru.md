...
{{% blocks/products/pf/agp/content h2="Преобразовать XLTM в XLS, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в XLS в C#" %}}
...
1.  Преобразуйте значение XLTM в XLS, вызвав метод Workbook.Save.
