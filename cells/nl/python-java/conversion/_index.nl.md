---
title: Microsoft Excel-bestandsconversie met Python via Java
description: Aspose.Cells for Python via Java bibliotheek. Converteer EXCEL, JSON, PDF, XML, HTML, TXT, TSV, CSV, SQL en meer formaten met slechts enkele regels Python-code.
...
{{% blocks/products/pf/feature-page-section h2="Converteer Excel-werkbladen naar JPG, BMP, PNG en GIF" %}}
 Elk werkblad van een Excel-bestand kan worden omgezet naar verschillende afbeeldingsformaten, bel[AfbeeldingOfAfdrukopties](https://reference.aspose.com/cells/python/asposecells.api/ImageOrPrintOptions).setImageFormat om het afbeeldingsformaat in te stellen.
...
Het is mogelijk om elk spreadsheet te laden en te converteren naar Word DOCX & PowerPoint PPTX bestanden tijdens het gebruik[DocxSaveOptions](https://reference.aspose.com/cells/python/asposecells.api/DocxSaveOptions) & [PptxSaveOpties](https://reference.aspose.com/cells/python/asposecells.api/PptxSaveOptions) klassen zoals hieronder gedemonstreerd.
