---
title:  Hợp nhất XLTX Tệp via Java
weight: 680
description: Mã mẫu Java để kết hợp các tài liệu XLTX trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng XLTX trong Java" h2="Hợp nhất tài liệu gốc XLTX bằng cách sử dụng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất các tệp XLTX bằng Java" %}}

 Để hợp nhất tệp XLTX, chúng tôi sẽ sử dụng[Aspose.Cells for Java](https://products.aspose.com/cells/java) API là một nền tảng sáp nhập giàu tính năng, mạnh mẽ và dễ sử dụng API for Java. Bạn có thể tải xuống phiên bản mới nhất của nó trực tiếp từ[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) và cài đặt nó trong dự án dựa trên Maven của bạn bằng cách thêm các cấu hình sau vào pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước gộp file XLTX vào Java" %}}
...
+ Tải file XLTX đầu tiên với instance của lớp Workbook.
+ Tải tài liệu XLTX thứ hai với một thể hiện của lớp Workbook.
+ Gộp file bằng phương thức Combine().
+ lưu file XLTX đã merge vào đường dẫn xác định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tập tin XLTX - Java" offSpacer="" %}}
