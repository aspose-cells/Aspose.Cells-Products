---
title: Hợp nhất các tệp XLT qua Java 
weight: 9960
url: /vi/java/merger/xlt/ 
description: Java mã mẫu để kết hợp tài liệu XLT trên Java Môi trường thời gian chạy cho Ứng dụng JSP / JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng XLT trong Java" h2="Hợp nhất tài liệu XLT gốc bằng cách sử dụng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất các tệp XLT bằng cách sử dụng Java" %}}

 Để hợp nhất tệp XLT, chúng tôi sẽ sử dụng
...
+ Tải tệp XLT đầu tiên với một thể hiện của lớp Workbook.
+ Tải tài liệu XLT thứ hai với một thể hiện của lớp Workbook.
+ Hợp nhất các tệp tin bằng phương thức kết hợp ().
+ lưu tệp XLT đã hợp nhất tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tệp XLT - Java" offSpacer="" %}}
