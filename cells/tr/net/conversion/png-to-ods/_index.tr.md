...
{{% blocks/products/pf/agp/content h2="PNG\'i ODS olarak C#\'e kaydedin." %}}

Aşağıdaki örnek, C#'de PNG'i ODS'e nasıl dönüştüreceğinizi göstermektedir.
...
1.  Workbook.Save yöntemini çağırarak PNG değerini ODS değerine dönüştürün.
1.  PNG'den ODS'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PNG\'i ODS\'e dönüştürmek için C# kütüphanesi" %}}
