...
{{% blocks/products/pf/agp/content h2="Převeďte ODS na EMF pomocí Python" %}}
...
Následující příklad ukazuje, jak převést ODS na EMF v Python.
