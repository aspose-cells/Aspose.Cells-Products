...
description: Aspose إكسل. Python قم بإنشاء ملف JSON. أنشئ JSON Python. Python JSON Cather. قم بإنشاء JSON في Python. قم بإنشاء ملف JSON باستخدام Python.
...
1. استخدم طريقة Save لحفظ المصنف كملف JSON.
