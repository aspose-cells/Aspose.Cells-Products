---
title: Python via Java을 사용하여 Excel에 블록 화살표 삽입
weight: 338
description: Python via Java Excel에 블록 화살표를 삽입하는 소스 코드입니다.
keywords: [Python Aspose.Cells., Python add block arrows., Python insert block arrows., Python create block arrows]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java을 사용하여 Excel에 블록 화살표 삽입" h2="Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells\' API을 사용하여 블록 화살표를 삽입합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java을 사용하여 Excel 파일에 블록 화살표를 삽입하는 방법" %}}

 Excel 파일에 블록 화살표를 삽입하기 위해 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java을 사용하여 Excel 파일에 블록 화살표를 삽입하는 단계" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 +[메소드 추가](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) 선택한 워크시트에 블록 화살표를 삽입하려면
...
아래 샘플 코드는 "오른쪽 화살표"를 삽입하는 방법을 보여줍니다. 더 많은 유형에 대해서는 아래의 "블록 화살표 모양 유형 개요"를 참조하세요.

{{% blocks/products/pf/agp/code-block title="블록 화살표 삽입 - Python via Java" offSpacer="" %}}
...
AutoShapeType.U_TURN_ARROW
 ...
 AutoShapeType.STRIPED_RIGHT_ARROW
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 AutoShapeType.NOTCED_RIGHT_ARROW
    </p>
   </div>
   <div class="col-lg-4">
