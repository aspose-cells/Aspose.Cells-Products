---
title: Sloučit MHT s GIF - Sloučit MHT s GIF v Java
url: /cs/java/merger/merge-mht-to-gif/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit MHT do GIF saveformat. Java Zkombinujte MHT do formátu GIF. Sloučit MHT na GIF v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na GIF v Java online zdarma" %}}

Následující příklad ukazuje, jak sloučit MHT s GIF v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT do GIF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru GIF. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do GIF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit MHT na GIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit MHT na GIF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro sloučení MHT s GIF" %}}
