...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na FODS pomocí Python" %}}

 Abychom převedli SXC na FODS, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na FODS prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na FODS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí Workbook1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s příponou FODS jako parametr1. Zkontrolujte zadanou cestu pro výsledný soubor FODS
