...
description: Sample code for ods to xltx C# conversion. Use API example code for batch ods files to xltx conversion within VB.NET, Asp.NET or any .NET based application.
---
