---
title: C# SQLite to EXCEL - SQLite to EXCEL Converter
description: Aspose Excel. Convert SQLite to EXCEL quickly and easily with Aspose.Cells. C# SQLite to EXCEL. C# Save SQLite to EXCEL. Save SQLite as EXCEL using C#.
...
{{% blocks/products/pf/agp/content h2="How to Convert SQLite to EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert SQLite data to EXCEL programmatically? .NET developers can easily load & convert SQLite to EXCEL in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Install 'Aspose.Cells for .NET'.
1.  Add a library reference (import the library) to your C# project.
1.  Query data from the SQLite database to obtain a DataTable object.
...
{{% blocks/products/pf/agp/code-block title="Sample Code to Convert SQLite to EXCEL - C#" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# library to convert SQLite to EXCEL" %}}
