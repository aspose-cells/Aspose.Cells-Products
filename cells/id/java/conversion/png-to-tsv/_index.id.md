---
title: Java PNG hingga TSV - PNG hingga TSV Konverter
description: Aspose Unggul. Java Aspose.Cells. PNG menjadi TSV di Java. Java Ubah PNG menjadi TSV format simpan. Format Java PNG hingga TSV. Simpan PNG hingga TSV Java.
...
{{% blocks/products/pf/agp/content h2="Simpan PNG hingga TSV di Java" %}}

Contoh berikut menunjukkan cara mengonversi PNG menjadi TSV di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi PNG menjadi TSV. Unggah file PNG Anda, lalu simpan sebagai file TSV. Untuk pembacaan PNG dan penulisan TSV Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran TSV akan sama dengan dokumen PNG asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi PNG menjadi TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi PNG menjadi TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PNG ke TSV secara terprogram? Pengembang Java dapat dengan mudah mengonversi PNG menjadi TSV hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah PNG menjadi TSV" %}}
{{% blocks/products/pf/agp/text %}}
