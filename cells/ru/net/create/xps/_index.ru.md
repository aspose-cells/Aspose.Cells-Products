...
description: Aspose Excel. C# Создать файл XPS. Создать XPS C#. C# XPS Создатель. Создайте XPS в C#. Создайте файл XPS, используя C#.
...
1. Используйте метод Сохранить, чтобы сохранить книгу как файл XPS.
