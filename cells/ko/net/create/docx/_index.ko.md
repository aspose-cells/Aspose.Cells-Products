---
title: DOCX 만들기 - C#에 DOCX 파일 만들기
description: Aspose 엑셀. C# DOCX 파일을 만듭니다. DOCX C#을 만듭니다. C# DOCX 작성자. C#에 DOCX을 생성합니다. C#을 사용하여 DOCX 파일을 생성합니다.
...
{{% blocks/products/pf/agp/content h2="C#에서 DOCX을 만드는 방법" %}}
...
1. 저장 방법을 사용하여 통합 문서를 DOCX 파일로 저장합니다.

{{% blocks/products/pf/agp/code-block title="샘플 코드는 C#에서 DOCX 파일을 생성하는 방법을 보여줍니다." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# 라이브러리는 DOCX 파일을 생성합니다." %}}
