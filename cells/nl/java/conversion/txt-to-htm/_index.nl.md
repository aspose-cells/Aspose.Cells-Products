...
{{% blocks/products/pf/agp/content h2="Sla TXT op in HTM in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT naar HTM kunt converteren in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je TXT naar HTM via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u TXT-bestanden programmatisch naar HTML converteren? Ontwikkelaars van Java-bestanden kunnen TXT-bestanden eenvoudig in een paar regels code naar HTML converteren.
