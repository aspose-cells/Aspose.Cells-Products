...
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 XLS 형식 분할" h2="Microsoft 또는 Open Office, Adobe PDF와 같은 소프트웨어를 사용하지 않고 서버 측 API를 사용하는 기본 및 고성능 XLS 스플리터." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 XLS 파일 분할 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="XLS 파일 분할 - C#" offSpacer="" %}}
