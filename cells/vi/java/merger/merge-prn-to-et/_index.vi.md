---
title: Gộp PRN vào ET - Gộp PRN vào ET số Java
url: /vi/java/merger/merge-prn-to-et/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu PRN sang ET. Java Kết hợp định dạng PRN sang ET. Hợp nhất PRN với ET theo số Java. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN với ET theo số Java" %}}

Ví dụ sau đây minh họa cách hợp nhất PRN với ET trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất PRN với ET. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp ET. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất PRN với ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp PRN vào ET số Java" InputFormat="prn" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất PRN vào ET" %}}
