...
{{% blocks/products/pf/agp/content h2="Unisci XML in MHT in C++" %}}

L'esempio seguente dimostra come unire XML a MHT in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire XML in MHT. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file MHT. Se sviluppi il codice in C++, sarà più semplice di quanto sembri. Vedi l'esempio C++ che unisce XML a MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Codice di esempio per unire XML in MHT in C++" InputFormat="xml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Come unire XML in MHT tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

È necessario unire XML a MHT a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria C++ per unire XML a MHT" %}}
