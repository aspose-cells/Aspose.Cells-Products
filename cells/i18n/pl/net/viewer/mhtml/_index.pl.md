---
title: Wyświetl formaty plików MHTML za pomocą .NET 
url: /pl/net/viewer/mhtml/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Przeglądarka plików MHTML for .NET" h2="Przeglądaj arkusze kalkulacyjne Excel i OpenOffice, takie jak MHTML, bez konieczności korzystania z programu Microsoft Excel lub automatyzacji pakietu Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOC" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wyświetlić MHTML za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells ułatwia programistom przeglądanie pliku MHTML za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik MHTML w instancji Workbook1. Utwórz instancję HtmlSaveOptions i ustaw właściwość ExportHeadings na true1. Zapisz plik MHTML w formacie HTML za pomocą metody Workbook.Save1. Załaduj wynikowy kod HTML w domyślnej przeglądarce za pomocą Process.Start
...
// zapisz plik MHTML w formacie HTML
...
Aspose.Cells API może służyć do tworzenia, edytowania, konwertowania i renderowania formatów programu Microsoft Excel do różnych formatów. Co więcej, może być używany do kompleksowych wykresów, skalowalnych raportów i niezawodnych obliczeń w aplikacjach. Aspose.Cells jest samodzielnym API i nie wymaga żadnego oprogramowania takiego jak Microsoft czy OpenOffice.    
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do przeglądania MHTML" sectionDescription="Sprawdź nasze prezentacje na żywo, aby [Wyświetl MHTML](https://products.aspose.app/cells/viewer/mhtml) z następującymi korzyściami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" W razie potrzeby pobierz plik MHTML z linku" >}}
