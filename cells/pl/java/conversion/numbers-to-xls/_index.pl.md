...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj NUMBERS na XLS przez Java" h2="Konwersja NUMBERS do XLS Java w celu konwersji jednej lub wielu stron do formatu XLS przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować NUMBERS na XLS za pomocą Java" %}}

 Aby renderować NUMBERS do XLS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować NUMBERS na XLS za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik NUMBERS na XLS w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik NUMBERS z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLS i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLS
...
{{% blocks/products/pf/agp/code-block title="NUMBERS na XLS Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik NUMBERS w instancji Workbook
Workbook book = new Workbook("template.numbers");
// zapisz NUMBERS jako XLS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją NUMBERS na XLS" sectionDescription="[Konwertuj LICZBY na XLS](https://products.aspose.app/cells/conversion/numbers-to-xls) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik NUMBERS, zostanie on natychmiast przekonwertowany na XLS." >}}
