---
title:  Hợp nhất OTS thành JSON qua C#
url: /vi/net/merger/merge-ots-to-json/ 
description: Hợp nhất OTS thành JSON Trực tuyến miễn phí. Sáp nhập OTS trực tuyến miễn phí tới JSON. Hợp nhất OTS thành Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS, v.v.
---
...
Ví dụ sau minh họa cách hợp nhất OTS thành JSON trong C#.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất OTS thành JSON trực tuyến" InputFormat="ots" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
