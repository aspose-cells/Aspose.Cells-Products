---
title:  Szúrja be a TextBoxot az Excelbe a Python számon keresztül
weight: 10
description: Python forráskód a TextBox Excelbe való beillesztéséhez.
---
...
{{% blocks/products/pf/agp/content h2="TextBox beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A TextBox Excel-fájlba való beszúrásának lépései a Python számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addTextBox(int,%20int,%20int,%20int,%20int,%20int)) szövegdoboz beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Szövegdoboz beszúrása - Python" offSpacer="" %}}
