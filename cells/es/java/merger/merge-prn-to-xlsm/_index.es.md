---
title:  Combinar PRN con XLSM via Java
url: /es/java/merger/merge-prn-to-xlsm/ 
description: Combine PRN con XLSM en línea de forma gratuita. PRN en línea gratuito al XLSM Fusión. Combine PRN con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar PRN con XLSM en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar PRN a XLSM en línea" InputFormat="prn" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
