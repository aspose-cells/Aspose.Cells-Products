...
{{% blocks/products/pf/agp/content h2="كيفية إدراج المكعب في ملف Excel باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج Cube في ملف Excel عبر Python" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم الشكل[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)لإدراج مكعب في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل المكعب - Python" offSpacer="" %}}
