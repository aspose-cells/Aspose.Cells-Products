---
title: Gabungkan JSON menjadi XLSB - Gabungkan JSON menjadi XLSB menjadi C#
url: /id/net/merger/merge-json-to-xlsb/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan JSON menjadi XLSB format simpan. C# Gabungkan format JSON menjadi XLSB. Gabungkan JSON menjadi XLSB di C#. JSON Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JSON menjadi XLSB di C#" %}}

Contoh berikut menunjukkan cara menggabungkan JSON menjadi XLSB di Aspose.Cells for .NET.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan JSON menjadi XLSB di C#" InputFormat="json" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JSON menjadi XLSB melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan JSON ke XLSB secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2=".NET perpustakaan untuk digabungkan JSON menjadi XLSB" %}}
