---
title:  แทรกช่องทำเครื่องหมาย (การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via java
weight: 30
description: Python via ซอร์สโค้ด Java เพื่อแทรกช่องทำเครื่องหมาย (การควบคุมแบบฟอร์ม) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกช่องทำเครื่องหมาย (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}

 เพื่อที่จะแทรก CheckBox(Form control) ลงในไฟล์ Excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแทรกช่องทำเครื่องหมาย (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้รูปทรงของคอลเลกชัน[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกช่องทำเครื่องหมาย (การควบคุมแบบฟอร์ม) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกช่องทำเครื่องหมาย (การควบคุมแบบฟอร์ม) - Python via java" offSpacer="" %}}
