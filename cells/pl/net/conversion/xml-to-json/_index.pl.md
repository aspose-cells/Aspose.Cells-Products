---
title: C# XML na JSON - Konwerter XML na JSON
description: Aspose Excel. Konwertuj XML na JSON szybko i łatwo za pomocą Aspose.Cells. C# XML na JSON. C# Zapisz XML na JSON. Zapisz XML jako JSON używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem JSON w C#" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na JSON w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na JSON przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XML na JSON? Programiści .NET mogą łatwo załadować i przekonwertować XML na JSON w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XML na JSON" %}}
