...
url: /cs/net/merger/merge-image-to-excel/ 
...
Následující příklad ukazuje, jak sloučit IMAGE do EXCELu v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit IMAGE do EXCELu? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu pro sloučení IMAGE do EXCELu" %}}
