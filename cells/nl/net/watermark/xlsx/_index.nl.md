...
weight: 8270
description: C#-broncode om watermerk toe te voegen of te verwijderen aan het XLSX-bestand op .NET Framework, .NET Core, Mono of Xamarin-platforms.
...
{{% blocks/products/pf/agp/content h2="Hoe u het XLSX-bestand van een watermerk kunt voorzien met behulp van C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Voeg watermerk toe aan XLSX - C#" offSpacer="" %}}
