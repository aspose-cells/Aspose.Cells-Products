...
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi XLSX ke format HTML, memungkinkan penyimpanan data XLSX ke format HTML dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLSX menjadi HTML di C#" h2="Pustaka berkecepatan tinggi C# untuk mengkonversi XLSX ke HTML. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, HTML, dan banyak format lainnya pada Framework .NET, Core .NET, atau Platform Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Konversikan XLSX ke HTML menggunakan C#" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke HTML di C#" %}}

Contoh berikut menunjukkan cara mengkonversi XLSX menjadi HTML di C#.
...
1.  Konversikan XLSX menjadi HTML dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi dari XLSX menjadi HTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# perpustakaan untuk mengkonversi XLSX menjadi HTML" %}}
