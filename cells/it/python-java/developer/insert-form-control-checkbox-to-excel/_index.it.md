...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa le collezioni di forme[aggiungi metodo](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) per inserire un CheckBox (controllo modulo) nel foglio di lavoro selezionato.
