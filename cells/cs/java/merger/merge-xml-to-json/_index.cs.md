---
title:  Sloučit XML na JSON via Java
url: /cs/java/merger/merge-xml-to-json/ 
description: Sloučit XML na JSON Online zdarma. Bezplatná online fúze XML na JSON. Sloučit XML do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XML do JSON v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XML na JSON online" InputFormat="xml" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
