---
title: Java XLS do HTM - XLS do konwertera HTM
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLS do formatu HTM, umożliwiając bezproblemowe zapisywanie danych XLS w formacie HTM za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLS na HTM w Java" h2="Szybka biblioteka Java do konwersji XLS do formatu HTM. To profesjonalne rozwiązanie programowe do importowania i eksportowania XLS, HTM i wielu innych formatów przy użyciu Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do HTM w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLS na format HTM w formacie Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować kod XLS do formatu HTM. Prześlij plik XLS, a następnie zapisz go jako plik HTM. Zarówno do odczytu kodu XLS, jak i zapisu w formacie HTM, możesz używać pełnych nazw plików. Wyjściowa zawartość i formatowanie pliku HTM będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLS na HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="htm" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS do formatu HTM? Programiści Java mogą łatwo przekonwertować pliki XLS do formatu HTM za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLS do HTM wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLS do formatu HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji XLS do HTM" %}}
{{% blocks/products/pf/agp/text %}}
