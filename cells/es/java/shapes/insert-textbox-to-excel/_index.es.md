---
title:  Insertar cuadro de texto en Excel via Java
weight: 60
...
{{% blocks/products/pf/agp/content h2="Cómo insertar un cuadro de texto en un archivo de Excel usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar TextBox en el archivo de Excel via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addTextBox-int-int-int-int-int-int-) para insertar TextBox en la hoja de trabajo seleccionada
...
{{% blocks/products/pf/agp/code-block title="Insertar cuadro de texto - Java" offSpacer="" %}}
