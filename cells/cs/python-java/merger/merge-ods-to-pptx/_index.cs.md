---
title:  Sloučit ODS na PPTX přes Python
...
Následující příklad ukazuje, jak sloučit ODS až PPTX v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení ODS až PPTX online" InputFormat="ods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
