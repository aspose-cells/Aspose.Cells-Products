...
{{% blocks/products/pf/agp/content h2="Convertir FODS en HTM en utilisant Python" %}}
...
L'exemple suivant montre comment convertir FODS en HTM dans Python.
...
{{% blocks/products/pf/agp/content h2="Comment convertir FODS en HTM via Python" %}}
