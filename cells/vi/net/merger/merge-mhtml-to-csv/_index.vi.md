...
url: /vi/net/merger/merge-mhtml-to-csv/ 
...
Ví dụ sau đây minh họa cách hợp nhất MHTML với CSV trong Aspose.Cells for .NET.
...
{{% cells-merger title="Mã mẫu gộp MHTML thành CSV trong C#" InputFormat="mhtml" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp MHTML vào CSV qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất MHTML thành CSV theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp MHTML thành CSV" %}}
