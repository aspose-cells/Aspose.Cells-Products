...
url: /fr/net/merger/merge-prn-to-gif/ 
...
L'exemple suivant montre comment fusionner PRN avec GIF dans Aspose.Cells for .NET.
...
Besoin de fusionner PRN avec GIF par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque .NET pour fusionner PRN avec GIF" %}}
