---
title: PHP MHT sang XLTX - Chuyển đổi MHT sang XLTX
description: Aspose Excel. Chuyển đổi MHT sang XLTX nhanh chóng và dễ dàng với Aspose.Cells. PHP MHT thành XLTX. PHP Lưu MHT thành XLTX. Lưu MHT thành XLTX bằng PHP.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi MHT thành XLTX qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi file MHT sang XLTX theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi MHT thành XLTX chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi MHT thành XLTX bằng cách gọi phương thức lưu của Workbook.
1.  Nhận kết quả chuyển đổi MHT thành XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện PHP để chuyển đổi MHT thành XLTX" %}}
