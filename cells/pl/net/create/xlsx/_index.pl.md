---
title: Utwórz pliki MS Excel XLSX za pośrednictwem C#
description: XLSX twórca. Utwórz pliki XLSX w kodzie C#. Generuj pliki MS Excel XLSX za pomocą VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Utwórz plik XLSX za pośrednictwem C#" h2="Natywne i wydajne tworzenie arkuszy kalkulacyjnych MS Excel XLSX programowo przy użyciu interfejsów API .NET po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć XLSX za pośrednictwem C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod do tworzenia pliku MS Excel XLSX przy użyciu C#." offSpacer="" %}}
