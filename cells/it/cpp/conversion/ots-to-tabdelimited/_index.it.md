...
Hai bisogno di convertire i file OTS in TABDELIMITED tramite codice? Gli sviluppatori C++ possono facilmente convertire OTS in TABDELIMITED in poche righe di codice.
...
1.  Convertire OTS in TABDELIMITED chiamando il metodo Save().
