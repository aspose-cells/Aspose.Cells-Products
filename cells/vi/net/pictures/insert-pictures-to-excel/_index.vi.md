...
weight: 200
description: Mã nguồn C# chèn ảnh vào Excel trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
keywords: [C# Aspose.Cells., c# add picture into Excel., c# insert picture into Excel., c# create picture in Excel]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn ảnh vào Excel via .NET" h2="Chèn ảnh dùng Aspose.Cells\' API không cần phần mềm nào như Microsoft hay Open Office, Adobe PDF..." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Có 2 cách chèn ảnh vào bảng tính đã chọn.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addpicture/index) để chèn Ảnh vào bảng tính đã chọn.
 + Sử dụng bộ sưu tập hình ảnh[thêm phương pháp](https://reference.aspose.com/cells/net/aspose.cells.drawing/picturecollection/methods/add/index) để chèn Ảnh vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn ảnh - C#" offSpacer="" %}}
