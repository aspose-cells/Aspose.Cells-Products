...
{{% blocks/products/pf/agp/content h2="Konwersja HTM do SPREADSHEETML za pomocą Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM w SPREADSHEETML w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować format HTM na SPREADSHEETML w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTM na SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki HTM na SPREADSHEETML? Programiści Java mogą łatwo przekonwertować pliki HTM na SPREADSHEETML za pomocą zaledwie kilku linijek kodu.
