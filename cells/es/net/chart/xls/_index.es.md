---
title:  XLS cuadro de documento a imágenes via .NET
weight: 3210
description: C# código fuente para dibujar y convertir gráficos o diagramas en el archivo XLS en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS Archivo de gráficos a imágenes en C#" h2="Gráficos de documentos nativos y de alto rendimiento XLS a conversión de imágenes utilizando API del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir gráficos XLS en imágenes usando C#" %}}
 ...
 Para convertir los gráficos XLS, usaremos
...
{{% blocks/products/pf/agp/code-block title="Convertir XLS Tabla de archivos - C#" offSpacer="" %}}
...
Aspose.Cells API se puede usar para crear, editar, convertir y representar Microsoft formatos de Excel a diferentes formatos. Además, se puede usar para gráficos completos, informes escalables y cálculos confiables dentro de las aplicaciones de software. Aspose.Cells es un API independiente y no requiere ningún software como Microsoft u OpenOffice. Convierta el gráfico de Excel a PDF, JPG, PNG, EMF, WMF, BMP, SVG, TIFF, XPS.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="En línea XLS Conversión de gráficos Demostraciones en vivo" sectionDescription=" Convierta XLS gráficos de documentos en imágenes ahora mismo visitando nuestro visitando nuestro[Sitio web de demostraciones en vivo](https://products.aspose.app/cells/chart). La demostración en vivo tiene los siguientes beneficios" >}}
