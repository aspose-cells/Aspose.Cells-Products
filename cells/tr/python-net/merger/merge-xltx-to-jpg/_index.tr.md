...
Aşağıdaki örnek, XLTX'in Aspose.Cells for Python via .NET'de JPG ile nasıl birleştirileceğini gösterir.
...
XLTX'i programlı olarak JPG ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
