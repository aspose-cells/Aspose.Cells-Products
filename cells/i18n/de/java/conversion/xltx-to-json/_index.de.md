---
title: Konvertieren Sie XLTX in JSON über Java 
weight: 8100
url: /de/java/conversion/xltx-to-json/ 
description: Beispiel-Umwandlungscode Java für das XLTX-Format in eine JSON-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in JSON in jeder Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLTX in JSON über Java" h2="XLTX-zu-JSON-Java-Konvertierung zum Konvertieren einzelner oder mehrerer Seiten in JSON mithilfe der lokalen Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLTX mit Java in JSON" %}}

 Um XLTX in JSON zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von XLTX in JSON über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können XLTX-Dateien in nur wenigen Codezeilen ganz einfach in JSON konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. XLTX-Datei mit einer Instanz der Workbook-Klasse laden1. Erstellen Sie mithilfe der Methode Cells.createRange einen Datenbereich, der exportiert werden soll1. Rufen Sie die JsonUtility.exportRangeToJson-Methode mit Verweisen auf Range & ExportRangeToJsonOptions auf1. Schreiben Sie String-JSON-Daten über die Methode BufferedWriter.write in eine Datei
...
{{% blocks/products/pf/agp/code-block title="XLTX-zu-JSON-Java-Konvertierungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLTX-zu-JSON-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie XLTX in JSON](https://products.aspose.app/cells/conversion/xltx-to-json) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre XLTX-Datei hoch, sie wird sofort in JSON konvertiert." >}}
