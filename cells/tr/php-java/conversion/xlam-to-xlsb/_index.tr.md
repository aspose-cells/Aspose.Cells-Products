---
title: PHP XLAM ila XLSB - XLAM ila XLSB Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde XLAM'i XLSB'e dönüştürün. PHP XLAM'i XLSB'e dönüştürün. PHP XLAM'i XLSB'e kaydedin. PHP kullanarak XLAM'i XLSB olarak kaydedin.
...
{{% cells-convert title="XLAM\'i XLSB\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xlsb" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLAM\'i XLSB\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLAM dosyalarını program aracılığıyla XLSB'e dönüştürmeniz mi gerekiyor? PHP geliştiricileri sadece birkaç satır kodla XLAM'i XLSB'e kolayca yükleyebilir ve dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLAM'i XLSB'e dönüştürün.
1.  XLAM'den XLSB'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLAM\'i XLSB\'e dönüştürmek için PHP kütüphanesi" %}}
