...
Devi convertire i file PRN in MHTML a livello di codice? Gli sviluppatori C++ possono facilmente convertire PRN in MHTML in poche righe di codice.
...
1.  Converti PRN in MHTML chiamando il metodo Save().
