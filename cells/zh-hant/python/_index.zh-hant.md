...
{{< blocks/products/pf/i18n/upper-banner h1="Python Excel 電子表格解析 API" h2="在 Python 應用程序中生成、讀取、編寫或操作電子表格以及將 Excel 文件導出為多種格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-python-java.svg" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="https://downloads.aspose.com/cells/python" >}}
...
<p>
 Python 的 Aspose.Cells 是用於電子表格處理任務的快速可靠的 API。開發人員可以創建簡單或複雜的電子表格、操作以及從 Excel 文件中提取信息。 API 可讀取多種 excel 格式，並可將工作表呈現為 XPS、PDF、MHTML、HTML、純文本、圖像等。這是使用python自動化excel報告的最佳解決方案。
</p>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Python 的 Aspose.Cells 可用。" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<p>Python sheets API provides a powerful Formula Calculation Engine that supports almost all of the standard and advanced Microsoft Excel formulas and functions. Formula calculation engine makes it easy to read, set and calculate the results of the built-in or add-in type, array and R1C1 reference style formulas.</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells for Python 提供對頁面設置的完全控制，允許操作多個顯示選項，例如預覽分頁符、設置縮放級別、設置頁面方向、使用凍結窗格控制數據可見性、紙張大小、縮放、標題和頁腳和打印區域。
    </p>
   </div>
   <!--<div class="col-lg-12">
...
<p>Aspose.Cells for Android via Java API allows you to manipulate rows and columns in many different ways. You can easily adjust row height and column width, auto size the width & height of cells according to the contents, insert or delete, hide or show and group or ungroup rows & columns.</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells for Python API 提供對工作表數據管理的廣泛支持。可以在運行時輕鬆操作工作表中的任何單元格，或從各種數據源將數據導入工作表。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Python 的 Aspose.Cells 提供對圖表的全面支持。通過這個 python 庫可以輕鬆添加標準和自定義圖表或動態設置圖表數據以刷新圖表。
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼用 Aspose.Cells 代替 Python？" tabId="success-stories" >}}
