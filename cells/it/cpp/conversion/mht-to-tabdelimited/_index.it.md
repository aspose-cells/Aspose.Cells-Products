...
Hai bisogno di convertire i file MHT in TABDELIMITED tramite codice? Gli sviluppatori C++ possono convertire facilmente i file MHT in TABDELIMITED in poche righe di codice.
...
1.  Convertire MHT in TABDELIMITED chiamando il metodo Save().
