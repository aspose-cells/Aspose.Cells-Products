---
title: Java ODS sang SQL - Chuyển đổi ODS sang SQL trực tuyến
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Trực tuyến miễn phí Java Chuyển đổi ODS sang định dạng lưu SQL. Java ODS sang định dạng SQL. Lưu ODS thành SQL Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi ODS thành SQL trong Java" h2="Thư viện Java tốc độ cao để chuyển đổi ODS sang SQL. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất ODS, SQL và nhiều định dạng khác bằng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu ODS vào SQL trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi ODS thành SQL trong Java.
...
Cần chuyển đổi các tệp ODS sang SQL theo chương trình? Java nhà phát triển có thể dễ dàng chuyển đổi ODS thành SQL chỉ bằng một vài dòng mã.
