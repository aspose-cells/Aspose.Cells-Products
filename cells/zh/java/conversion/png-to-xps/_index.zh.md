---
title: Java PNG 转 XPS - 在线 PNG 转 XPS 转换器
description: Aspose Excel。 Java Aspose.Cells。Java Aspose Cells。免费在线 Java 将 PNG 转换为 XPS 保存格式。 Java PNG 到 XPS 格式。将 PNG 保存为 XPS Java。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 PNG 转换为 Java 中的 XPS" h2="高速Java库，用于将PNG转换为XPS。这是一个专业的软件解决方案，用于导入和导出PNG、XPS和使用Java的许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
如何将 PNG 转换为 XPS？使用 Aspose.Cells for Java 库，您可以通过几行代码以编程方式轻松将 PNG 转换为 XPS。[Aspose.Cells for Java](https://products.aspose.com/cells/java)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Java Excel API不仅可以在电子表格格式之间进行转换，还可以将Excel文件渲染为图像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，从而使其成为行业交换文档的完美选择-标准格式。您可以直接从以下位置下载其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)并通过将以下配置添加到 pom.xml 将其安装在基于 Maven 的项目中。
...
{{% blocks/products/pf/agp/content h2="免费在线保存 PNG 至 XPS 于 Java" %}}
...
{{% cells-convert title="免费应用程序和示例代码可在线将 PNG 转换为 XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xps" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何转换 PNG 为 XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 PNG 文件转换为 XPS 吗？ Java开发人员只需几行代码即可轻松将PNG转换为XPS。
...
1. 通过调用Workbook.save方法将PNG转换为XPS。
1. 获取PNG到XPS的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java库将PNG转换为XPS" %}}
{{% blocks/products/pf/agp/text %}}
