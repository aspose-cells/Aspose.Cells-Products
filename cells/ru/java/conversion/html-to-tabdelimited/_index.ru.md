---
title: Преобразование HTML в TABDELIMITED через Java 
url: /ru/java/conversion/html-to-tabdelimited/ 
description: Пример кода преобразования Java для формата HTML в файл TABDELIMITED. Программисты могут использовать этот пример кода для экспорта электронных таблиц Excel и OpenOffice в TABDELIMITED в любом веб-или настольном Java приложении.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование HTML в TABDELIMITED через Java" h2="Преобразование HTML в TABDELIMITED Java для преобразования одной или нескольких страниц в TABDELIMITED с использованием локальной библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать HTML в TABDELIMITED с помощью Java" %}}

 Чтобы отобразить HTML в TABDELIMITED, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию HTML в TABDELIMITED через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Java могут легко преобразовать файл HTML в формат TABDELIMITED, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузить файл HTML с экземпляром класса Workbook1. Вызов метода Workbook.save1. Передайте выходной путь с расширением TABDELIMITED и SaveFormat в качестве параметров1. Проверить указанный путь для результирующего файла TABDELIMITED
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования HTML в TABDELIMITED Java" offSpacer="" %}}

```cs
// загрузить HTML-файл в экземпляр Workbook
Workbook book = new Workbook("template.html");
// сохранить HTML как TABDELIMITED
