...
description: Aspose Excel. Konwertuj MHT na XML szybko i łatwo za pomocą Aspose.Cells. Java MHT na XML. Java Zapisz MHT w formacie XML. Zapisz MHT jako XML, używając numeru Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT w formacie XML pod numerem Java" %}}

Poniższy przykład ilustruje, jak przekonwertować MHT na XML w Java.
...
Chcesz programowo przekonwertować pliki MHT na XML? Programiści Java mogą łatwo przekonwertować MHT na XML w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji MHT na XML" %}}
{{% blocks/products/pf/agp/text %}}
