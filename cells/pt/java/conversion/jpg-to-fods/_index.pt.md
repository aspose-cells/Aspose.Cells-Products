---
title: Java JPG para FODS - Conversor online de JPG para FODS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Online Grátis Java Converta JPG para FODS saveformat. Java JPG para o formato FODS. Salvar JPG para FODS Java.
...
{{% blocks/products/pf/agp/content h2="Salve JPG em FODS em Java online gratuitamente" %}}

O exemplo a seguir demonstra como converter JPG para FODS em Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter JPG para FODS. Carregue seu arquivo JPG e simplesmente salve-o como arquivo FODS. Para leitura de JPG e gravação de FODS, você pode usar nomes de arquivo totalmente qualificados. O conteúdo e a formatação da saída FODS serão idênticos ao documento JPG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter JPG para FODS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="fods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter JPG para FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPG para FODS programaticamente? Java desenvolvedores podem facilmente converter JPG para FODS em apenas algumas linhas de código.
...
1.  Converta JPG para FODS chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de JPG para FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteca para converter JPG para FODS" %}}
{{% blocks/products/pf/agp/text %}}
