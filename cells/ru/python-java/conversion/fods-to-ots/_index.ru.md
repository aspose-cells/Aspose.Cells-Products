...
{{% blocks/products/pf/agp/content h2="Преобразуйте FODS в OTS, используя Python" %}}
...
В следующем примере показано, как преобразовать FODS в OTS в Python.
