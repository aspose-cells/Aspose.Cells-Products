...
{{% blocks/products/pf/agp/content h2="Sla HTML op in XLSX in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar XLSX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar XLSX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar XLSX? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar XLSX met slechts een paar regels code.
