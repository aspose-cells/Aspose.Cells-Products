---
title: Converti XLTM in HTML tramite l'applicazione C++ 
url: /it/cpp/conversion/xltm-to-html/ 
description: Esempio di codice di conversione C++ per il documento XLTM in formato HTML. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLTM a HTML all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file XLTM in HTML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLTM usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (HTML).1. Il file HTML verrà salvato nel percorso specificato.1. Apri il file HTML in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLTM a HTML C++" offSpacer="" %}}
