---
title: C# SXC à SVG - Convertisseur en ligne SXC à SVG
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir SXC en format de sauvegarde SVG. Format C# SXC à SVG. Enregistrez SXC à SVG C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez SXC à SVG dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir SXC en SVG en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir SXC en SVG. Téléchargez votre fichier SXC, puis enregistrez-le simplement en tant que fichier SVG. Pour la lecture SXC et l'écriture SVG, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie SVG seront identiques au document SXC d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir SXC en SVG en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir SXC en SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers SXC en SVG par programmation ? Les développeurs .NET peuvent facilement charger et convertir SXC en SVG en quelques lignes de code.
