...
{{% blocks/products/pf/agp/content h2="Převeďte HTM na PDF v Python" %}}
...
Následující příklad ukazuje, jak převést HTM na PDF v Python via NET.
