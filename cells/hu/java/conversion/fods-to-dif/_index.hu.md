---
title: "FODS konvertálása DIF-re a következőn keresztül: Java "

description: Minta Java konverziós kód FODS formátumhoz DIF fájlba. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására DIF-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="FODS konvertálása DIF-re a következőn keresztül: Java" h2="FODS-ből DIF-be Java konverzió, amellyel egyetlen vagy több oldalt konvertálhat DIF-be a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="FODS konvertálása DIF-re a következővel: Java" %}}

 Ahhoz, hogy a FODS-t DIF-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A FODS DIF-re konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a FODS-fájlt DIF-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be FODS-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat DIF kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott DIF-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="FODS a DIF Java konverziós forráskódra" offSpacer="" %}}

```cs
// töltse be a FODS fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.fods");
// mentse a FODS-t DIF-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS-ból DIF-be konvertáló élő bemutatók" sectionDescription="[Konvertálja a FODS-t DIF-re](https://products.aspose.app/cells/conversion/fods-to-dif) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a FODS-fájlt, és azonnal DIF-re konvertálódik." >}}
