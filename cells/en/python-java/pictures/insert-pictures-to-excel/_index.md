...
weight: 200
url: /python-java/pictures/insert-pictures-to-excel/ 
...
+  Use the picturecollection's [add method](https://reference.aspose.com/cells/java/com.aspose.cells/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) to insert a Picture in the selected worksheet.
