...
url: /nl/cpp/merger/merge-numbers-to-pdf/ 
...
Het volgende voorbeeld laat zien hoe NUMBERS kan worden samengevoegd tot PDF in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u NUMBERS programmatisch samenvoegen tot PDF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om NUMBERS samen te voegen tot PDF" %}}
