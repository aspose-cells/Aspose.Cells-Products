---
title: Java PRN do EXCEL - Konwerter PRN do EXCEL
description: Aspose Excel. Szybko i łatwo przekonwertuj PRN na EXCEL za pomocą Aspose.Cells. Java PRN na EXCEL. Java Zapisz PRN w formacie EXCEL. Zapisz PRN jako EXCEL, używając numeru Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN w formacie EXCEL pod numerem Java" %}}

Poniższy przykład pokazuje, jak przekonwertować PRN na EXCEL w Java.
...
{{% cells-convert title="Przykładowy kod do konwersji PRN na EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować PRN na EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki PRN na EXCEL? Programiści Java mogą z łatwością przekonwertować PRN na EXCEL w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji PRN na EXCEL" %}}
{{% blocks/products/pf/agp/text %}}
