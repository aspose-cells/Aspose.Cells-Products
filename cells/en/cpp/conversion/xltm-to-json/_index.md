...
description: Sample C++ conversion code for XLTM document to JSON format. Programmers can use this source code for batch XLTM to JSON conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLTM to JSON C++ Conversion Source Code" offSpacer="" %}}
