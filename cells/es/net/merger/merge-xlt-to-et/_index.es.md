---
title: Combinar XLT a ET - Combinar XLT a ET en C#
url: /es/net/merger/merge-xlt-to-et/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea XLT para guardar formato ET. C# Combina XLT con formato ET. Combinar XLT a ET en C#. XLT Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLT a ET en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLT con ET en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar XLT con ET. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo ET. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que fusiona XLT con ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLT a ET en C#" InputFormat="xlt" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLT a ET a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLT con ET mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar XLT a ET" %}}
