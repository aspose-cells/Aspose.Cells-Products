---
title: C# ODS से ईटीटी - ODS से ईटीटी कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ ODS को ईटीटी में जल्दी और आसानी से बदलें। C# ODS को ईटीटी में बदलें। C# ODS को ईटीटी में सहेजें। C# का उपयोग करके ODS को ईटीटी के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="C# में ईटीटी के लिए ODS सेव करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि ODS को C# में ईटीटी में कैसे परिवर्तित किया जाए।
...
{{% cells-convert title="ODS को ईटीटी में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="ett" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="ODS को C# के माध्यम से ईटीटी में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

ODS फ़ाइलों को प्रोग्रामेटिक रूप से ETT में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में ODS को आसानी से ईटीटी में लोड और परिवर्तित कर सकते हैं।
...
1.  वर्कबुक.सेव विधि को कॉल करके ODS को ईटीटी में बदलें।
1.  ODS का ईटीटी में रूपांतरण परिणाम प्राप्त करें।

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ODS को ईटीटी में बदलने के लिए C# लाइब्रेरी" %}}
