---
title: Konvertieren Sie TXT in TIFF über die Anwendung C++ 
url: /de/cpp/conversion/txt-to-tiff/ 
description: Beispiel-Umwandlungscode C++ für ein TXT-Dokument in das TIFF-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von TXT in TIFF in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie TXT in TIFF über C++" h2="Leistungsstarke TXT-zu-TIFF-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können TXT-Dateien in nur wenigen Codezeilen ganz einfach in TIFF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die TXT-Datei mit Factory::CreateIWorkbook.1. Wählen Sie das erste Arbeitsblatt aus.1. Legen Sie (TIFF)-Optionen fest.1. Durchlaufen Sie jede Blattseite und rendern Sie.1. Öffnen Sie die TIFF-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="TXT-zu-TIFF-C++-Umwandlungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos für die TXT-zu-TIFF-Konvertierung" sectionDescription="[Konvertieren Sie TXT in TIFF](https://products.aspose.app/cells/conversion/txt-to-tiff) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre TXT-Datei hoch, sie wird sofort in TIFF konvertiert." >}}
