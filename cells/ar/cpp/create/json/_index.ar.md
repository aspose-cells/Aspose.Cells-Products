...
description: Aspose اكسل. C++ أنشئ ملف JSON بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف JSON باستخدام C++. أنشئ JSON في C++. C++ JSON Creator.
...
1.  احفظ المصنف كملف .json باستخدام طريقة Save().
