...
{{% blocks/products/pf/agp/content h2="Sla HTML op als PRN in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar PRN in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar PRN via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u HTML-bestanden programmatisch naar PRN converteren? Ontwikkelaars van Java kunnen HTML-bestanden eenvoudig in een paar regels code naar PRN converteren.
