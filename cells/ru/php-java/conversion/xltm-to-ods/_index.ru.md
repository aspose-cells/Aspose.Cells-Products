...
description: Aspose Эксель. Преобразуйте XLTM в ODS быстро и легко с помощью Aspose.Cells. PHP XLTM в ODS. PHP Сохраните XLTM в ODS. Сохраните XLTM как ODS с помощью PHP.
...
Нужно программно преобразовать файлы XLTM в ODS? Разработчики PHP могут легко загрузить и преобразовать XLTM в ODS всего за несколько строк кода.
...
1.  Преобразуйте XLTM в ODS, вызвав метод сохранения книги.
1.  Получите результат преобразования XLTM в ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования XLTM в ODS" %}}
