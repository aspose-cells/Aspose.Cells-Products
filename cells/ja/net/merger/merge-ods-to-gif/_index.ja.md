...
description: Aspose エクセル。 C# Aspose.Cells。ODS を GIF の保存形式にマージします。 C# ODS と GIF の形式を結合します。 ODS から GIF を C# に結合します。ODS を結合します。
...
{{% cells-merger title="ODS から GIF を C# にマージするサンプルコード" InputFormat="ods" InputFormat2="gif" outformat="gif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
