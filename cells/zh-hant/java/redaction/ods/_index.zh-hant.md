---
title: 通過 Java 搜索和替換 ODS 文檔中的文本 
weight: 9210
url: /zh-hant/java/redaction/ods/ 
description: Java 示例代碼，用於在 Java JSP/JSF 應用程序和桌面應用程序的運行時環境上的 ODS 文件中編輯敏感信息。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="編輯 Java 中的 ODS 格式" h2="本機和高性能 ODS 使用服務器端 Aspose.Cells for Java API 記錄敏感的修訂信息，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中編輯 ODS 文件的步驟" %}}
