---
title: Conversor PHP XLTX para SQL - XLTX para SQL
description: Aspose Excel. Converta XLTX para SQL de forma rápida e fácil com Aspose.Cells. PHP XLTX para SQL. PHP Salve XLTX no SQL. Salve XLTX como SQL usando PHP.
...
Precisa converter arquivos XLTX para SQL programaticamente? Os desenvolvedores de PHP podem facilmente carregar e converter XLTX em SQL em apenas algumas linhas de código.
...
1.  Converta XLTX em SQL chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de XLTX para SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter XLTX para SQL" %}}
