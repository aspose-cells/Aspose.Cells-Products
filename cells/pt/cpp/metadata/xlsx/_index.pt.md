---
title:  Edite ou visualize metadados do documento XLSX via C++
weight: 8970
description: Código de exemplo C++ para editar ou visualizar metadados do arquivo XLSX no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
...
+ Carregue o arquivo XLSX usando WorkbookMetadata
