---
title:  Fusionner XLT à CSV via Python
url: /fr/python-java/merger/merge-xlt-to-csv/ 
description: Fusionnez XLT à CSV en ligne gratuitement. Gratuit en ligne XLT à CSV Fusion. Fusionnez XLT vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner XLT à CSV dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner XLT à CSV en ligne" InputFormat="xlt" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
