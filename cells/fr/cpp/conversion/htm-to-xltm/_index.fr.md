...
Besoin de convertir des fichiers HTM au format XLTM par programmation ? Les développeurs spécialisés en C++ peuvent facilement convertir des fichiers HTM au format XLTM en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en XLTM en appelant la méthode Save().
