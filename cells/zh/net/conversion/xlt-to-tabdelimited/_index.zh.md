...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLT 转换为 TABDELIMITED。 C# XLT 转换为 TABDELIMITED。 C# 将 XLT 保存到制表符。使用 C# 将 XLT 保存为 TABDELIMITED。
...
{{% blocks/products/pf/agp/content h2="将 XLT 保存为 C# 中的 TABDELIMITED" %}}
...
{{% cells-convert title="将 XLT 转换为 TABDELIMITED 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="tsv" IsLandingPage="true" %}}
