---
title: Преобразователь C++ XLAM в JSON - XLAM в JSON
...
{{% blocks/products/pf/agp/content h2="Сохраните XLAM в JSON в C++" %}}
...
Нужно программно преобразовать файлы XLAM в JSON? Разработчики, работающие с файлами C++, могут легко преобразовать файлы XLAM в JSON всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для преобразования XLAM в JSON" %}}
