---
title: تحويل TSV إلى PDF عبر تطبيق C++ 
weight: 9090
url: /ar/cpp/conversion/tsv-to-pdf/ 
description: نموذج رمز تحويل C++ لمستند TSV إلى تنسيق PDF. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل TSV إلى PDF دفعة داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TSV إلى PDF عبر C++" h2="تحويل TSV إلى PDF عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوّري برامج C++ تحويل ملف TSV إلى PDF بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف TSV باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد ملف (PDF).1. سيتم حفظ ملف PDF في المسار المحدد.1. افتح ملف PDF في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="TSV إلى PDF C++ شفرة مصدر التحويل" offSpacer="" %}}
