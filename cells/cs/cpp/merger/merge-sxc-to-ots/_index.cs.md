---
title: Sloučit SXC na OTS - Sloučit SXC na OTS v C++
url: /cs/cpp/merger/merge-sxc-to-ots/ 
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma SXC do formátu OTS. C++ Zkombinujte SXC do formátu OTS. Sloučit SXC do OTS v C++. SXC Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit SXC do OTS pomocí C++" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit SXC do OTS v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit SXC do OTS v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení SXC s OTS. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru OTS. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí SXC do OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení SXC do OTS v C++" InputFormat="sxc" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit SXC do OTS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit SXC do OTS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení SXC do OTS" %}}
