---
title: Fusionner JPEG avec EXCEL - Combiner JPEG avec EXCEL dans Python
url: /fr/python-net/merger/merge-jpeg-to-excel/ 
description: Aspose Exceller. Python Exceller. Fusionnez JPEG au format de sauvegarde EXCEL. Python Combinez JPEG au format EXCEL. Fusionnez JPEG avec EXCEL dans la bibliothèque Excel Python. JPEG Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner JPEG avec EXCEL à l\'aide de la bibliothèque Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner JPEG avec EXCEL dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment fusionner JPEG vers EXCEL dans Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner JPEG avec EXCEL. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier EXCEL. Si vous développez du code en Python, ce sera plus simple qu'il n'y paraît. Voir l'exemple Python qui fusionne JPEG avec EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner JPEG avec EXCEL dans la bibliothèque Excel Python" InputFormat="jpg" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner JPEG vers EXCEL via la bibliothèque Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner JPEG avec EXCEL par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner JPEG avec EXCEL" %}}
