---
title: "MHTML konvertálása MARKDOWN-re a következőn keresztül: Java "

description: Minta Java konverziós kód MHTML formátumhoz MARKDOWN fájlba. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok MARKDOWN-ba exportálására bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="MHTML konvertálása MARKDOWN-re a következőn keresztül: Java" h2="MHTML-ből MARKDOWN-ba Java konverzió, amellyel egyetlen vagy több oldalt konvertálhat MARKDOWN-re a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Az MHTML konvertálása MARKDOWN-re a következővel: Java" %}}

 Ahhoz, hogy az MHTML-t MARKDOWN-ba rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az MHTML konvertálásához MARKDOWN formátumba a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak MHTML fájlt MARKDOWN formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be egy MHTML-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat MARKDOWN kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott MARKDOWN fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="MHTML-ből MARKDOWN Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az MHTML fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.mhtml");
// mentse az MHTML-t MARKDOWN néven
...
{{< blocks/products/pf/agp/demobox sectionTitle="MHTML-ből MARKDOWN-ba konvertáló élő bemutatók" sectionDescription="[Az MHTML konvertálása MARKDOWN formátumba](https://products.aspose.app/cells/conversion/mhtml-to-markdown) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel MHTML-fájlját, és azonnal a MARKDOWN formátumba konvertálódik." >}}
