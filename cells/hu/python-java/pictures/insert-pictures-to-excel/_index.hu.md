...
{{% blocks/products/pf/agp/content h2="Kép beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A kép beszúrásának lépései az Excel-fájlba a Python számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja a képgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) egy Kép beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Kép beszúrása - Python" offSpacer="" %}}
