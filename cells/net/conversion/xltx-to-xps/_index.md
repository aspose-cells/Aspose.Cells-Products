...
{{% blocks/products/pf/agp/content h2="How to Convert XLTX to XPS Using C#" %}}
 ...
 In order to convert XLTX to XPS, we’ll use
...
{{% cells-convert title="Free App and Sample Code to Convert XLTX to XPS" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et InputFormat=xltx outformat=xps IsLandingPage=true %}}
