---
title:  Slå samman TXT till JSON via Python
...
Följande exempel visar hur man slår samman TXT till JSON i Python.
...
{{% cells-merger title="Gratis app för att slå samman TXT till JSON online" InputFormat="txt" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
