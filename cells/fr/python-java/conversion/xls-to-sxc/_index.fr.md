---
title: Convertir XLS en SXC Python via Python
description: Convertissez XLS en SXC en ligne gratuitement. Convertisseur en ligne gratuit XLS à SXC. Python XLS à SXC. XLS à SXC via Python.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en SXC en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="sxc" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en SXC via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir XLS en SXC en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier XLS avec une instance de Workbook
1.  Convertir XLS en SXC en appelant la méthode Workbook.save
