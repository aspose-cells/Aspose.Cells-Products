...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar SXC met Aspose.Cells. PHP MHTML naar SXC. PHP Bewaar MHTML naar SXC. Sla MHTML op als SXC met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar SXC te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar SXC converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar SXC.
...
1.  Converteer MHTML naar SXC door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van MHTML naar SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om MHTML naar SXC te converteren" %}}
