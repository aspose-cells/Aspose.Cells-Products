...
{{< blocks/products/pf/i18n/upper-banner h1="TXT을 C#의 SPREADSHEETML로 변환합니다." h2="TXT 파일을 SPREADSHEETML로 고속 변환하는 C# 라이브러리입니다. 이 전문 소프트웨어 솔루션은 TXT, SPREADSHEETML 및 기타 여러 형식을 .NET 프레임워크, .NET 코어 또는 Mono 플랫폼에서 가져오고 내보낼 수 있도록 지원합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
1.  Workbook.Save 메서드를 호출하여 TXT을 SPREADSHEETML 형식으로 변환합니다.
