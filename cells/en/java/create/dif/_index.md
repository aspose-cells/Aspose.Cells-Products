...
description: Java Aspose Cells. Java Create DIF File. Create DIF Java. Java DIF Creater. Create DIF in Java. Generate DIF file using Java.
...
{{% blocks/products/pf/agp/content h2="How to Create DIF in Java" %}}
...
1.  Save the workbook as DIF format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create DIF file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create DIF file" %}}
{{% blocks/products/pf/agp/text %}}
