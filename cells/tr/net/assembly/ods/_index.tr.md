...
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla ODS Formatında Toplu Rapor Oluşturma" h2="Veri kaynağı ve bir şablon kullanarak ODS formatında raporlar oluşturun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODS\'yi C# ile Birleştirme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Örnek Çalışma KitabıDesigner sınıfı1. Herhangi bir çalışma sayfasının herhangi bir hücresine bir işaretleyici ayarlayın1. WorkbookDesigner nesnesi için veri kaynağını ayarla1. Şablonu verilerle doldurmak için WorkbookDesigner.Process yöntemini çağırın1. Sonucu WorkbookDesigner.Worbook.Save yöntemiyle ODS formatında kaydedin
