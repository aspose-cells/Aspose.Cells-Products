---
title: Python via Java を使用して Excel に曲線の矢印形状を描画または挿入する方法
weight: 10
description: Microsoft や Open Office、Adobe PDF などのソフトウェアを使用せずに、Aspose.Cells' Python via Java API を使用して、曲線の矢印形状を描画または挿入します。
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java を使用して曲線矢印形状を Excel に挿入します" h2="Microsoft や Open Office、Adobe PDF などのソフトウェアを使用せずに、Aspose.Cells\' API を使用して曲線矢印形状を挿入します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java を使用して Excel ファイルに曲線矢印形状を挿入する方法" %}}

曲線の矢印形状を Excel ファイルに挿入するには、次を使用します。
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java を使用して Excel ファイルに曲線矢印形状を挿入する手順" %}}
...
+ インデックスからワークシートを選択します。
 + シェイプコレクションの使用[メソッドの追加](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)を使用して、選択したワークシートに曲線の矢印形状を挿入します。
...
{{% blocks/products/pf/agp/code-block title="曲線矢印形状を挿入 - Python via Java" offSpacer="" %}}
