...
url: /hu/python-net/merger/merge-spreadsheetml-to-image/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a SPREADSHEETML-t az IMAGE fájllal a Aspose.Cells for Python via .NET számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a SPREADSHEETML-t az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
