...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie online OTS z formatem zapisu EXCEL. C# Połącz format OTS z formatem EXCEL. Połącz OTS z EXCEL w C#. Połącz OTS.
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z EXCEL w C# online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć OTS z EXCEL w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć OTS z EXCEL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku EXCEL. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z EXCEL.
...
{{% blocks/products/pf/agp/content h2="Jak połączyć OTS z EXCEL przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć OTS z EXCEL? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia OTS z EXCEL" %}}
