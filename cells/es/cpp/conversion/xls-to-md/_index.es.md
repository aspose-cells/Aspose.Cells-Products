---
title: Convierta XLS a MD a través de la aplicación C++ 
url: /es/cpp/conversion/xls-to-md/ 
description: Ejemplo de código de conversión C++ para documento XLS a formato MD. Los programadores pueden usar este código fuente para la conversión por lotes de XLS a MD dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLS a MD a través de C++" h2="Conversión de XLS a MD de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente archivos XLS a MD con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLS usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (MD).1. El archivo MD se guardará en la ruta especificada.1. Abra el archivo MD en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLS a MD C++" offSpacer="" %}}
