...
{{< blocks/products/pf/upper-banner h1="Split XLS Formats in C#" h2="Native and high performance XLS splitter using server-side APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
```cs
var wkb = new Workbook("D:\\book3.xls");
foreach(Worksheet sht in wkb.Worksheets)
{
    var bk = new Workbook();
    bk.Worksheets[0].Copy(sht);
    bk.Save("D:\\" + sht.Name + ".xls", SaveFormat.Xls);
}  
