---
title: Convertisseur C# XLS à SVG - XLS à SVG
description: Aspose Exceller. Convertissez XLS en SVG rapidement et facilement avec Aspose.Cells. C# XLS en SVG. C# Enregistrez XLS en SVG. Enregistrez XLS sous 07611134. 81 en utilisant le C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLS au SVG au C#" %}}

L'exemple suivant montre comment convertir XLS en SVG dans C#.
...
{{% cells-convert title="Exemple de code pour convertir XLS en SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en SVG par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en SVG en quelques lignes de code seulement.
