---
title:  Vložte GroupBox (ovládací prvek formuláře) do Excelu pomocí Python via java
weight: 40
description: Python via zdrojový kód java pro vložení GroupBox (ovládání formuláře) do aplikace Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vložte GroupBox (ovládací prvek formuláře) do Excelu pomocí Python via java" h2="Vkládejte objekty pomocí rozhraní API na straně serveru bez jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF atd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit GroupBox (ovládací prvek formuláře) do souboru aplikace Excel pomocí Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení GroupBox (ovládání formuláře) do souboru Excel pomocí Python via java" %}}
...
+ Vyberte List přes jeho index.
 + Použijte kolekci tvarů[přidat metodu](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addGroupBox(int,%20int,%20int,%20int,%20int,%20int)), chcete-li do vybraného listu vložit GroupBox (ovládací prvek formuláře).
...
{{% blocks/products/pf/agp/code-block title="Vložit GroupBox (ovládání formuláře) - Python via java" offSpacer="" %}}
