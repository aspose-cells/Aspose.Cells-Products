...
{{% blocks/products/pf/agp/content h2="A SPREADSHEETML konvertálása BMP-re a következővel: Java" %}}

 Ahhoz, hogy a SPREADSHEETML-t BMP-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a SPREADSHEETML konvertálásához BMP-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a SPREADSHEETML-fájlt BMP-vé, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML-ből BMP Java konverziós forráskód" offSpacer="" %}}
