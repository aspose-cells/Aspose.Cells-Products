---
title:  أدخل وسائل الشرح في Excel via Java
weight: 360
...
{{< blocks/products/pf/i18n/upper-banner h1="أدخل وسائل الشرح في Excel via Java" h2="أدخل وسائل الشرح باستخدام Aspose.Cells \'API دون أي برنامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج وسائل الشرح في ملف Excel باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج وسائل الشرح في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)لإدراج وسائل الشرح في ورقة العمل المحددة
...
يوضح نموذج التعليمة البرمجية أدناه كيفية إدراج "Thought Bubble: Cloud". لمزيد من الأنواع ، يرجى الرجوع إلى "نظرة عامة على حظر أنواع وسيلة شرح" أدناه.

{{% blocks/products/pf/agp/code-block title="أدخل وسائل الشرح - Java" offSpacer="" %}}
