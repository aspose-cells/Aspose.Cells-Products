---
title: Converter MHTML para TIFF por meio do aplicativo C++ 
weight: 4830
url: /pt/cpp/conversion/mhtml-to-tiff/ 
description: Exemplo de código de conversão C++ de documento MHTML para formato TIFF. Os programadores podem usar esse código-fonte para conversão em lote de MHTML para TIFF em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem facilmente converter arquivos MHTML para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo MHTML usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (TIFF).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo TIFF em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de MHTML para TIFF C++" offSpacer="" %}}
