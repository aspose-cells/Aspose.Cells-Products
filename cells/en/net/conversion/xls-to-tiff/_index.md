---
title: Convert XLS to TIFF C#
description: Free Online XLS Converter. Convert XLS to TIFF Online for Free. Convert XLS to TIFF in C# code. Convert XLS to TIFF using C#.
keywords: Convert XLS, XLS Converter, XLS to PDF, XLS to Word, XLS to PPT, XLS to Image
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLS to TIFF via C#" h2="High-speed C# library for converting XLS to TIFF. Export Excel spreadsheets to TIFF format on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Save XLS to TIFF in C# Online for Free" %}}

The following example demonstrates how to convert XLS to TIFF in C#.
...
{{% cells-convert title="Free App and Sample Code to Convert XLS to TIFF Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="tiff" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLS to TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert XLS to TIFF in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert XLS to TIFF" %}}
