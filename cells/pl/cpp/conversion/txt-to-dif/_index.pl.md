---
title: Konwertuj TXT na DIF za pomocą aplikacji C++ 
url: /pl/cpp/conversion/txt-to-dif/ 
description: Przykładowy kod konwersji C++ dla dokumentu TXT do formatu DIF. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TXT na DIF w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TXT na DIF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TXT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (DIF).1. Plik DIF zostanie zapisany pod określoną ścieżką.1. Otwórz plik DIF w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji TXT do DIF C++" offSpacer="" %}}
