---
title: Insert Insert Star/Banner into Excel via Java 
weight: 381
...
{{% blocks/products/pf/agp/content h2="How to Insert Insert Star/Banner into Excel File Using Using Java" %}}

 In order to insert Insert Star/Banner into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Insert Star/Banner to Excel file via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) to insert Insert Star/Banner in the selected worksheet
