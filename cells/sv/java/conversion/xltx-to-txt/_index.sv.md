---
title: Konvertera XLTX till TXT via Java 
weight: 7950
url: /sv/java/conversion/xltx-to-txt/ 
description: Exempel Java-konverteringskod för XLTX-format till TXT-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till TXT inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLTX till TXT med Java" %}}

 För att rendera XLTX till TXT kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLTX till TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLTX-fil till TXT på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTX-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med TXT-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande TXT-filen
...
{{% blocks/products/pf/agp/code-block title="XLTX till TXT Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Livedemonstrationer för konvertering av XLTX till TXT" sectionDescription="[Konvertera XLTX till TXT](https://products.aspose.app/cells/conversion/xltx-to-txt) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din XLTX-fil, den konverteras omedelbart till TXT." >}}
