---
title: Convierta SPREADSHEETML a TXT a través de Java 
url: /es/java/conversion/spreadsheetml-to-txt/ 
description: Ejemplo de código de conversión Java para formato SPREADSHEETML a archivo TXT. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a TXT dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta SPREADSHEETML a TXT a través de Java" h2="Conversión de SPREADSHEETML a TXT Java para convertir una o varias páginas a TXT utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SPREADSHEETML a TXT usando Java" %}}

 Para convertir SPREADSHEETML en TXT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SPREADSHEETML a TXT a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo SPREADSHEETML a TXT con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo SPREADSHEETML con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión TXT y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo TXT resultante
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML a TXT Java Código fuente de conversión" offSpacer="" %}}

```cs
// cargue el archivo SPREADSHEETML en una instancia de Workbook
Workbook book = new Workbook("template.spreadsheetml");
// guardar HOJA DE CÁLCULO como TXT
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de SPREADSHEETML a TXT" sectionDescription="[Convertir HOJA DE CALCULO a TXT](https://products.aspose.app/cells/conversion/spreadsheetml-to-txt) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo SPREADSHEETML, se convertirá instantáneamente a TXT." >}}
