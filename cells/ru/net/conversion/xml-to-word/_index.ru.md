...
{{% blocks/products/pf/agp/content h2="Преобразование XML в WORD с использованием C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в WORD в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат WORD в формате C#.
...
1.  Преобразовать XML в формат WORD, вызвав метод Workbook.Save.
