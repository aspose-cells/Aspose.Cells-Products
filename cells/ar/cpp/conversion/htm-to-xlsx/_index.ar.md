---
title: C++ HTM إلى XLSX - محول HTM عبر الإنترنت إلى XLSX
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل HTM إلى XLSX saveformat. C++ HTM إلى تنسيق XLSX. احفظ HTM في XLSX C++.
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في XLSX في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات HTM إلى XLSX برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى XLSX في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى XLSX باستدعاء طريقة Save ().
