---
title: دمج TXT إلى EXCEL - اجمع TXT إلى EXCEL في Java
url: /ar/java/merger/merge-txt-to-excel/ 
description: Aspose إكسل. Java Aspose.Cells. الدمج المجاني عبر الإنترنت TXT إلى EXCEL saveformat. Java اجمع TXT إلى تنسيق EXCEL. دمج TXT إلى EXCEL في Java. TXT دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج TXT إلى EXCEL في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج TXT إلى EXCEL في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج TXT في EXCEL. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف EXCEL. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج TXT إلى EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="عبر الإنترنت مجانًا لدمج TXT مع EXCEL في Java" InputFormat="txt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج TXT مع EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج TXT مع EXCEL برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Java مكتبة لدمج TXT إلى EXCEL" %}}
