---
title: Konwertuj XLSB na XLTM za pomocą aplikacji C++ 
weight: 8080

description: Przykładowy kod konwersji C++ dla dokumentu XLSB do formatu XLTM. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSB na XLTM w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSB na XLTM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLTM).1. Plik XLTM zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLTM w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSB do XLTM C++ Kod źródłowy konwersji" offSpacer="" %}}
