---
title: Java Convertisseur HTM vers NUMÉROS - HTM vers NUMÉROS
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format HTM au format NUMBERS, permettant un enregistrement transparent des données HTM au format NUMBERS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en NUMÉROS dans Java" h2="Bibliothèque Java haute vitesse pour la conversion de HTM en NUMBERS. Solution logicielle professionnelle pour l\'importation et l\'exportation de HTM, NUMBERS et de nombreux autres formats utilisant le chiffrement Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM dans NUMBERS dans Java" %}}

L'exemple suivant montre comment convertir du HTM en NUMÉROS dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir du HTML en NUMÉROS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en NUMBERS par programmation ? Les développeurs de Java peuvent facilement convertir des fichiers HTM en NUMBERS en quelques lignes de code seulement.
...
1.  Convertissez le HTM en NUMBERS en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de HTM en NOMBRE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir HTM en NUMBERS" %}}
{{% blocks/products/pf/agp/text %}}
