---
title:  Połącz CSV z NUMBERS przez C#
url: /pl/net/merger/merge-csv-to-numbers/ 
description: Połącz CSV z NUMBERS Online za darmo. Bezpłatnie online CSV do połączenia NUMBERS. Połącz CSV z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak scalić CSV z NUMBERS w C#.
...
{{% cells-merger title="Darmowa aplikacja do łączenia CSV z NUMERAMI on-line" InputFormat="csv" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
