---
title: C# XLTX إلى MHT - عبر الإنترنت من XLTX إلى محول MHT
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل XLTX إلى MHT saveformat. C# XLTX إلى تنسيق MHT. وفر XLTX إلى MHT C#.
...
{{% blocks/products/pf/agp/content h2="وفر XLTX إلى MHT في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل XLTX إلى MHT في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTX إلى MHT عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTX إلى MHT برمجيًا؟ يمكن للمطورين .NET تحميل وتحويل XLTX إلى MHT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C# مكتبة لتحويل XLTX إلى MHT" %}}
