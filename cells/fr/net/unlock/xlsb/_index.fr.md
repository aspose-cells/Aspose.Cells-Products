---
title:  Débloquer le document XLSB via .NET
weight: 6410
description: Code source C# pour déverrouiller le fichier XLSB protégé par mot de passe sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin.
