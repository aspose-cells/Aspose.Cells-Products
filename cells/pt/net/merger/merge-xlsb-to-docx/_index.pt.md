---
title:  Mesclar XLSB para DOCX via C#
url: /pt/net/merger/merge-xlsb-to-docx/ 
description: Mesclar XLSB para DOCX Online gratuitamente. Online Grátis XLSB a DOCX Fusão. Mesclar XLSB para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar XLSB a DOCX em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar XLSB a DOCX on-line" InputFormat="xlsb" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
