---
title: Konwertuj XLSB na XLS za pomocą aplikacji C++ 
weight: 4690
url: /pl/cpp/conversion/xlsb-to-xls/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSB do formatu XLS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSB na XLS w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSB na XLS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLS).1. Plik XLS zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLSB do XLS C++" offSpacer="" %}}
