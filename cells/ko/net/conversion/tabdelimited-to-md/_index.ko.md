---
title: C# TABDELIMITED에서 MD로 - TABDELIMITED에서 MD로 변환기
description: Aspose Excel. 이 포괄적인 솔루션은 C# 개발자에게 탭으로 구분된 데이터를 MD 형식으로 변환하는 완벽하게 통합된 접근 방식을 제공하여 Aspose.Cells 라이브러리를 사용하여 탭으로 구분된 데이터를 MD 형식으로 원활하게 저장할 수 있도록 하며, 이 모든 작업은 효율적이고 사용자 정의 가능한 C# 코드를 통해 이루어집니다.
...
{{% blocks/products/pf/agp/content h2="TABDELIMITED를 C#의 MD에 저장하세요" %}}

다음 예시는 C#에서 TABDELIMITED를 MD로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="TABDELIMITED를 MD로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="tsv" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 탭 구분 형식을 MD 형식으로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

탭으로 구분된 파일을 MD 형식으로 프로그램적으로 변환해야 하시나요? .NET 개발자는 단 몇 줄의 코드로 탭으로 구분된 파일을 MD 형식으로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook.Save 메서드를 호출하여 TABDELIMITED 형식을 MD 형식으로 변환합니다.
1.  TABDELIMITED를 MD로 변환한 결과를 확인하세요.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 라이브러리는 탭으로 구분된 데이터를 MD 형식으로 변환합니다." %}}
