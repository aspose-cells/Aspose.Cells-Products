...
description: Aspose اكسل. قم بتحويل NUMBERS إلى EMF بسرعة وسهولة باستخدام Aspose.Cells. C# NUMBERS إلى EMF. C# احفظ NUMBERS في EMF. احفظ NUMBERS كـ EMF باستخدام C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الأرقام إلى EMF في C#" h2="مكتبة C# عالية السرعة لتحويل الأرقام إلى EMF. هذا حل برمجي احترافي لاستيراد وتصدير الأرقام وEMF والعديد من التنسيقات الأخرى على منصات .NET Framework أو .NET Core أو Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام إلى EMF في C#" %}}
...
1.  تحويل الأرقام إلى EMF عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل الأرقام إلى EMF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الارقام الى EMF" %}}
