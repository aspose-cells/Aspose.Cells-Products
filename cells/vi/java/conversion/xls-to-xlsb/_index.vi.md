---
title: Chuyển đổi XLS sang XLSB qua Java 
weight: 250

description: Mã chuyển đổi Java mẫu cho định dạng XLS thành tệp XLSB. Lập trình viên có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang XLSB trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS sang XLSB qua Java" h2="Chuyển đổi XLS sang XLSB Java để chuyển đổi một hoặc nhiều trang sang XLSB bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS sang XLSB bằng cách sử dụng Java" %}}

 Để kết xuất XLS thành XLSB, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLS sang XLSB qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp XLS sang XLSB chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLS với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Truyền đường dẫn đầu ra với phần mở rộng XLSB & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp XLSB kết quả
...
{{% blocks/products/pf/agp/code-block title="XLS sang XLSB Java Mã nguồn chuyển đổi" offSpacer="" %}}

```cs
// tải tệp XLS trong một phiên bản của Workbook
Workbook book = new Workbook("template.xls");
// lưu XLS dưới dạng XLSB
