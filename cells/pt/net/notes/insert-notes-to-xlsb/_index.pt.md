...
{{% blocks/products/pf/agp/content h2="Insira notas no arquivo XLSB usando .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código de amostra C# para inserir e remover notas no arquivo XLSB" offSpacer="" %}}
