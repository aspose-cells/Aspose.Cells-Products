---
title:  Bảo vệ và khóa XLSB tài liệu via .NET
weight: 5920
description: Mã nguồn C# khóa file XLSB bằng mật khẩu trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa XLSB Tệp qua C#" h2="Bảng tính Excel được bảo vệ bằng mật khẩu bao gồm định dạng XLSB sử dụng Thư viện .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
