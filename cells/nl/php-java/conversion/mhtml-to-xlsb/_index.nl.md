...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar XLSB met Aspose.Cells. PHP MHTML naar XLSB. PHP Bewaar MHTML naar XLSB. Sla MHTML op als XLSB met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar XLSB te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar XLSB converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar XLSB.
...
1.  Converteer MHTML naar XLSB door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van MHTML naar XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om MHTML naar XLSB te converteren" %}}
