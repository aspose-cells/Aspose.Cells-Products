---
title: Mesclar EXCEL com PDF - Combinar EXCEL com PDF em Python
url: /pt/python-java/merger/merge-excel-to-pdf/ 
description: Aspose Excel. Python Aspose.Cells. Mesclar EXCEL para PDF saveformat. Python Combine EXCEL com o formato PDF. Mesclar EXCEL com PDF em Python. Mesclar EXCEL.
...
{{% blocks/products/pf/agp/content h2="Mesclar EXCEL com PDF usando Python" %}}

 Como faço para mesclar o EXCEL com PDF? Com a biblioteca Aspose.Cells for Python via Java, você pode facilmente mesclar EXCEL com PDF programaticamente com algumas linhas de código.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells) é capaz de construir aplicativos multiplataforma com a capacidade de gerar, modificar, converter, renderizar e imprimir todos os arquivos Excel. Python Excel API não apenas converte formatos de planilha, mas também pode renderizar arquivos Excel como imagens, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT e muito mais, tornando-o a escolha perfeita para troca de documentos em formatos padrão da indústria. Você pode instalar Aspose.Cells for Python via Java de<a href="https://pypi.org/project/aspose-cells/">pypi</a> , use o comando como:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mesclar EXCEL com PDF em Python" %}}

O exemplo a seguir demonstra como mesclar EXCEL com PDF em Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar o EXCEL com PDF. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo PDF. Se você desenvolver código em Python, será mais simples do que parece. Veja o exemplo Python que mescla EXCEL com PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemplo de código para mesclar EXCEL com PDF em Python" InputFormat="xlsx" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar EXCEL com PDF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar EXCEL com PDF programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para mesclar EXCEL com PDF" %}}
