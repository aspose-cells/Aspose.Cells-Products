---
title: Conversor PHP TSV para XLS - TSV para XLS
description: Aspose Excel. Converta TSV em XLS de forma rápida e fácil com Aspose.Cells. PHP TSV em XLS. PHP Salve TSV em XLS. Salve TSV como XLS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter TSV em XLS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em XLS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em XLS em apenas algumas linhas de código.
...
1.  Converta TSV em XLS chamando o método save da pasta de trabalho.
