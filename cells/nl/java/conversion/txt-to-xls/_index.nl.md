...
{{% blocks/products/pf/agp/content h2="Sla TXT op in XLS in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar XLS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar XLS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar XLS? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar XLS met slechts een paar regels code.
