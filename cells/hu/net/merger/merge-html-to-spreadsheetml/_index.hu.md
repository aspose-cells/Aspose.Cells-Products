---
title: A HTML egyesítése SPREADSHEETML-be – a HTML egyesítése SPREADSHEETML-be a C#-ben
url: /hu/net/merger/merge-html-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés HTML SPREADSHEETML mentési formátumba. C# A HTML kombinálása SPREADSHEETML formátumba. A HTML egyesítése SPREADSHEETML-be a C#-ben. HTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a HTML-et a SPREADSHEETML-be a C#-ben online" %}}

A következő példa bemutatja, hogyan egyesítheti a HTML-et a SPREADSHEETML-be a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML és a SPREADSHEETML egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SPREADSHEETML fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a HTML-et a SPREADSHEETML-lel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a HTML SPREADSHEETML-be a C#-ben" InputFormat="html" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTML egyesítése SPREADSHEETML-be a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTML-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML és a SPREADSHEETML egyesítéséhez" %}}
