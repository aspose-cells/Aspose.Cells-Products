---
title: XLT から WORD を結合 - XLT から WORD を Python に結合
url: /ja/python-java/merger/merge-xlt-to-word/ 
description: Aspose エクセル。 Python Aspose.Cells。XLT を WORD の保存形式にマージします。 Python XLT と WORD の形式を結合します。 XLT から WORD を Python に結合します。XLT を結合します。
...
次の例は、XLT を Aspose.Cells for Python via Java の WORD にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、XLT を WORD にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルをマージし、それを WORD ファイルに保存します。 Python のコードを開発する場合、これは思っているより簡単です。 XLT を WORD にマージする Python の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="XLT から WORD を Python にマージするサンプルコード" InputFormat="xlt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLT を Python 経由で WORD に結合する方法" %}}
...
{{% blocks/products/pf/agp/content h2="Python XLT を WORD にマージするライブラリ" %}}
