---
title: قم بإدراج / إنشاء مخطط انسيابي في Excel via Java
weight: 360
description: قم بإدراج / إنشاء مخطط انسيابي باستخدام Aspose.Cells 'Java API بدون أي برنامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بإدراج / إنشاء مخطط انسيابي في Excel via Java" h2="قم بإدراج / إنشاء مخطط انسيابي باستخدام Aspose.Cells \'API بدون أي برنامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج / إنشاء مخطط انسيابي في ملف Excel باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج / إنشاء مخطط انسيابي في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) لإدراج / إنشاء مخطط انسيابي في ورقة العمل المحددة
...
يوضح نموذج التعليمة البرمجية أدناه كيفية إدراج "Multidocument". لمزيد من الأنواع ، يرجى الرجوع إلى "نظرة عامة على أنواع شكل سهم الحظر" أدناه.

{{% blocks/products/pf/agp/code-block title="قم بإدراج / إنشاء مخطط انسيابي - Java" offSpacer="" %}}
