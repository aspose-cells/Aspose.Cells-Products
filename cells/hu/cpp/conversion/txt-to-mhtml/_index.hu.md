---
title: A TXT konvertálása MHTML-re a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/txt-to-mhtml/ 
description: Minta C++ konverziós kód TXT-dokumentumhoz MHTML formátumba. A programozók ezt a forráskódot használhatják kötegelt TXT-MHTML konvertáláshoz bármely C++ alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TXT konvertálása MHTML-re a következőn keresztül: C++" h2="Nagy teljesítményű TXT-MHTML konvertálás a C++ könyvtár használatával Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatják a TXT fájlt MHTML-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (MHTML) fájlkiterjesztéssel.1. Az MHTML fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az MHTML fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="TXT to MHTML C++ konverziós forráskód" offSpacer="" %}}
