---
title: Konwertuj XLSB na XLTX przez Python
url: /pl/python-java/conversion/xlsb-to-xltx/
description: Przykładowy kod konwersji xlsb do xltx Python. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji xltx w aplikacji Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na XLTX przez Python" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu XLTX przy użyciu Python interfejsów API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na XLTX za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSB na XLTX przez Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki XLSB na XLTX w zaledwie kilku wierszach kodu.
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSB na XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xltx" IsLandingPage="true" language="python" %}}
