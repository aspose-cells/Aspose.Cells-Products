---
title:  ค้นหาเอกสารหมายเลข TXT โดยไม่ต้องเปิดผ่านหมายเลข C++
weight: 5090
description: C++ ตัวอย่างโค้ดสำหรับค้นหาคำที่มีรูปแบบในไฟล์ TXT บนสภาพแวดล้อมรันไทม์ C++ สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
...
{{% blocks/products/pf/agp/content h2="วิธีการค้นหาไฟล์หมายเลข TXT โดยใช้รหัส C++" %}}

 ในการค้นหาไฟล์หมายเลข TXT เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการค้นหาไฟล์หมายเลข TXT ในรหัสไปรษณีย์ C++" %}}
...
+ โหลดไฟล์ TXT โดยใช้คลาส Workbook
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="ออนไลน์ TXT ค้นหาการสาธิตสด" sectionDescription=" ค้นหาข้อความ คำ หรือวลีภายในเอกสารหมายเลข TXT ได้ทันทีโดยเข้าไปที่เว็บไซต์ของเรา[เว็บไซต์สาธิตสด](https://products.aspose.app/cells/search)- การสาธิตสดมีข้อดีดังต่อไปนี้" >}}
...
ไฟล์ที่มีนามสกุล .TXT คือไฟล์เอกสารข้อความที่ประกอบด้วยข้อความธรรมดาในรูปแบบของบรรทัด ย่อหน้าในเอกสารข้อความจะถูกระบุด้วยการขึ้นบรรทัดใหม่ และใช้สำหรับการจัดเรียงเนื้อหาไฟล์ให้ดียิ่งขึ้น เอกสารข้อความมาตรฐานสามารถเปิดได้ในโปรแกรมแก้ไขข้อความหรือโปรแกรมประมวลผลคำใดๆ บนระบบปฏิบัติการต่างๆ ข้อความทั้งหมดที่อยู่ในไฟล์ดังกล่าวอยู่ในรูปแบบที่มนุษย์อ่านได้และแสดงด้วยลำดับของตัวอักขระ
