---
title: PHP XLAM إلى ETT - XLAM إلى ETT المحول
description: Aspose اكسل. قم بتحويل XLAM إلى ETT بسرعة وسهولة باستخدام Aspose.Cells. PHP XLAM إلى ETT. PHP احفظ XLAM في ETT. احفظ XLAM كـ ETT باستخدام PHP.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLAM إلى ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="ett" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLAM إلى ETT عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLAM إلى ETT برمجياً؟ يمكن لمطوري PHP تحميل XLAM وتحويله بسهولة إلى ETT في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل XLAM إلى ETT عن طريق استدعاء طريقة حفظ المصنف.
