...
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLTM till JPEG-format, vilket möjliggör sömlös sparning av XLTM-data till JPEG-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
Behöver du konvertera XLTM-filer till JPEG programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLTM till JPEG på bara några rader kod.
...
1.  Konvertera XLTM till JPEG genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet från XLTM till JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-biblioteket för att konvertera XLTM till JPEG" %}}
