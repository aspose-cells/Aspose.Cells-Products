...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση του EXCEL σε XPS saveformat. Python Συνδυάστε τη μορφή EXCEL σε XPS. Συγχώνευση του EXCEL στο XPS στο Python. Συγχώνευση EXCEL.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση του EXCEL στο XPS στο Python" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση του EXCEL στο XPS στο Python" InputFormat="xlsx" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
