...
description: Aspose Excel. C++ Aspose.Cells. Merge SPREADSHEETML to NUMBERS saveformat. C++ Combine SPREADSHEETML to NUMBERS format. Merge SPREADSHEETML to NUMBERS in C++. SPREADSHEETML Merge.
keywords: [Aspose Excel., C++ Aspose.Cells., Merge SPREADSHEETML to NUMBERS in C++., C++ Merge SPREADSHEETML to numbers., C++ Combine SPREADSHEETML to NUMBERS., SPREADSHEETML Merge]
---
...
{{% blocks/products/pf/agp/content h2="Merge SPREADSHEETML to NUMBERS in C++" %}}
...
{{% cells-merger title="Sample Code to Merge SPREADSHEETML to NUMBERS in C++" InputFormat="xml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
