---
title:  แทรก GroupBox (ตัวควบคุมฟอร์ม) ลงใน Excel ผ่าน Python
weight: 40
description: ซอร์สโค้ด Python เพื่อแทรก GroupBox (Form control) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก GroupBox (การควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก GroupBox(Form control) ลงในไฟล์ Excel ผ่าน Python" %}}
...
+ ใช้วิธีการเพิ่มของ shapecollection เพื่อแทรก GroupBox (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก GroupBox(ตัวควบคุมฟอร์ม) - Python" offSpacer="" %}}
