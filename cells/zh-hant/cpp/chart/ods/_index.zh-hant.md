...
title: ODS 文件圖表來自 C++
weight: 3820
description: C++ 範例程式碼，用於在 C++ 運行時環境中繪製和轉換 ODS 檔案中的圖表或圖表，適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{< blocks/products/pf/i18n/upper-banner h1="ODS 格式化 C++ 中的圖表" h2="使用伺服器端 Aspose.Cells for C++ API 的本機高效能 ODS 文件圖表，無需使用 Microsoft 或 Adobe PDF 等任何軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 建立 ODS 檔案圖表" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C++ 中建立 ODS 檔案圖表的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="建立 ODS 檔案圖表 - C++" offSpacer="" %}}
...
Aspose.Cells API 可用於建立、編輯、轉換和渲染 Microsoft Excel 格式為不同的格式。此外，它還可用於軟體應用程式中的全面圖表、可擴展報告和可靠計算。 Aspose.Cells 是一個獨立的 API，它不需要任何像 Microsoft 或 OpenOffice 這樣的軟體。將Excel圖表轉換為PDF、JPG、SVG、EMF、WMF、BMP、SVG、TIFF、XPS。
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="線上ODS圖表轉換現場演示" sectionDescription="立即將 ODS 文檔圖表轉換為圖像，方法是存取我們的[現場示範網站](https://products.aspose.app/cells/chart)。現場演示有以下好處" >}}
