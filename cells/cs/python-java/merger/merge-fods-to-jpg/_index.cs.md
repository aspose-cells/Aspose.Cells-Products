...
url: /cs/python-java/merger/merge-fods-to-jpg/ 
...
Následující příklad ukazuje, jak sloučit FODS do JPG v Aspose.Cells for Python via Java.
...
Potřebujete sloučit FODS do JPG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
