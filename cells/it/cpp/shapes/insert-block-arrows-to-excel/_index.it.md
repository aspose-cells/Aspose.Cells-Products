...
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci le frecce di blocco in Excel tramite C++" h2="Inserisci oggetti utilizzando il nativo e ad alte prestazioni del lato server Aspose.Cells for C++ API senza utilizzare alcun software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ab8156e8562724f9a597b7d2bc503cd4d) per inserire Panoramica dei tipi di freccia a blocchi nel foglio di lavoro selezionato
...
Il codice di esempio riportato di seguito illustra come inserire una "freccia destra". Per altri tipi, fare riferimento a "Panoramica dei tipi di frecce a blocco" di seguito.
