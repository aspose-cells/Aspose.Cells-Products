---
title: Create JPG - Create JPG file in Java
description: Aspose Excel. Java Create JPG File quickly and easily with Aspose.Cells. Generate JPG file using Java. Create JPG in Java. Java JPG Creater. 
...
{{% blocks/products/pf/agp/content h2="How to Create JPG in Java" %}}
...
1.  Save the workbook as JPG format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create JPG file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create JPG file" %}}
{{% blocks/products/pf/agp/text %}}
