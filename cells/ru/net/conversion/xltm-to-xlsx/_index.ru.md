...
description: Aspose Эксель. Преобразуйте XLTM в XLSX быстро и легко с помощью Aspose.Cells. C# XLTM в XLSX. C# Сохранить XLTM в XLSX. Сохранить XLTM как 07611134 81, используя C#.
...
{{% blocks/products/pf/agp/content h2="Преобразуйте XLTM в XLSX, используя C#." %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните с XLTM по XLSX в C#." %}}
