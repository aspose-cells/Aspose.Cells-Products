---
title: Converter JSON para ODS por meio do aplicativo C++ 
url: /pt/cpp/conversion/json-to-ods/ 
description: Exemplo de código de conversão C++ de documento JSON para formato ODS. Os programadores podem usar esse código-fonte para conversão em lote de JSON para ODS em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter JSON para ODS via C++" h2="Conversão de JSON para ODS de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem converter facilmente arquivos JSON em ODS em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo JSON usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (ODS).1. O arquivo ODS será salvo no caminho especificado.1. Abra o arquivo ODS em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão JSON para ODS C++" offSpacer="" %}}
