---
title: 通過 C++ 保護和鎖定 XLSM 文檔 
weight: 8770
url: /zh-hant/cpp/protect/xlsm/ 
description: C++ 在 Windows 32 位、Windows 64 位和 Linux 64 位的 C++ 運行時環境中使用密碼鎖定 XLSM 文件的示例代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 加密 XLSM 文件" h2="使用 .NET 庫對包括 XLSM 格式的 Excel 電子表格進行密碼保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C++ 保護 XLSM 文件的步驟" %}}
...
1. 使用 IWorkbook 類加載 XLSM 文件1. 將 Protect(..) 方法與 ProtectionType 和 Password 一起使用1. 通過 Save() 方法保存受保護的 XLSM 文件
