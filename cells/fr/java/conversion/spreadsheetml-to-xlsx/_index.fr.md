---
title: Convertir SPREADSHEETML en XLSX via Java 

description: Exemple de code de conversion Java pour le format SPREADSHEETML en fichier XLSX. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers XLSX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir SPREADSHEETML en XLSX à l\'aide de Java" %}}

 Afin de rendre SPREADSHEETML en XLSX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SPREADSHEETML en XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier SPREADSHEETML en XLSX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier SPREADSHEETML avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension XLSX et SaveFormat comme paramètres1. Vérifiez le chemin spécifié pour le fichier XLSX résultant
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion SPREADSHEETML vers XLSX Java" offSpacer="" %}}

```cs
// charger le fichier SPREADSHEETML dans une instance de Workbook
Workbook book = new Workbook("template.spreadsheetml");
// enregistrer SPREADSHEETML au format XLSX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion SPREADSHEETML vers XLSX" sectionDescription="[Convertir SPREADSHEETML en XLSX](https://products.aspose.app/cells/conversion/spreadsheetml-to-xlsx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier SPREADSHEETML, il sera converti instantanément en XLSX." >}}
