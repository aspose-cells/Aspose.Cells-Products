---
title: Python XLAM až JSON - XLAM až JSON Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Python plně integrovaný přístup k převodu formátu XLAM do formátu JSON, což umožňuje bezproblémové ukládání dat XLAM do formátu JSON pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte XLAM na JSON v knihovně Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit XLAM až JSON v knihovně Excel Python" %}}

Následující příklad ukazuje, jak převést XLAM na JSON v knihovně Excel Python.
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na JSON prostřednictvím knihovny Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlam" outformat="json" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod XLAM na JSON" %}}
