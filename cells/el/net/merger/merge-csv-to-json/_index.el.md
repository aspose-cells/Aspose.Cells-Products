...
description: Aspose Excel. C# Aspose.Cells. Συγχώνευση CSV σε μορφή αποθήκευσης JSON. C# Συνδυάστε τη μορφή CSV με JSON. Συγχώνευση CSV σε JSON στο C#. CSV Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση CSV με JSON στο C#" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση CSV έως JSON στο C#" InputFormat="csv" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
