---
title: Java EXCEL 到 TSV - EXCEL 到 TSV 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 EXCEL 转换为 TSV。 Java EXCEL 到 TSV。 Java 将 EXCEL 保存为 TSV。 使用 Java 将 EXCEL 保存为 TSV。
...
{{< blocks/products/pf/i18n/upper-banner h1="将EXCEL中的Java转换为TSV" h2="高速Java库，用于将EXCEL转换为TSV。这是使用Java导入和导出EXCEL、TSV和许多其他格式的专业软件解决方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="将EXCEL保存到Java中的TSV" %}}

下面的例子演示了如何将EXCEL中的Java转换为TSV。
...
{{% cells-convert title="将 EXCEL 转换为 TSV 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何将EXCEL转换为TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 EXCEL 文件转换为 TSV？ Java开发人员只需几行代码即可轻松将EXCEL转换为TSV。
...
{{% blocks/products/pf/agp/content h2="Java 将 EXCEL 转换为 TSV 的库" %}}
{{% blocks/products/pf/agp/text %}}
