---
title: Połącz XLTM z TABDELIMITED - Połącz XLTM z TABDELIMITED w C#
url: /pl/net/merger/merge-xltm-to-tabdelimited/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLTM do formatu zapisu TABDELIMITED. C# Połącz XLTM w formacie TABDELIMITED. Połącz XLTM z TABDELIMITED w C#. XLTM Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTM z TABDELIMITED w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić XLTM z TABDELIMITED w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLTM z TABDELIMITED. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku TABDELIMITED. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy XLTM z TABDELIMITED.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić XLTM z TABDELIMITED? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
