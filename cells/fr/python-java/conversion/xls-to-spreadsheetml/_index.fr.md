...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en SPREADSHEETML à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en SPREADSHEETML via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir des fichiers XLS en SPREADSHEETML en quelques lignes de code seulement.
