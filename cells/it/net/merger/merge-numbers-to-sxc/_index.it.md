---
title: Unisci NUMBERS a SXC - Combina NUMBERS a SXC in C#
url: /it/net/merger/merge-numbers-to-sxc/ 
description: Aspose Excel. C# Aspose.Cells. Unisci NUMERI online gratuiti in SXC saveformat. C# Combina i NUMERI nel formato SXC. Unisci NUMBERS a SXC in C#. NUMBERS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci i NUMERI a SXC in C# online gratuitamente" %}}

L'esempio seguente mostra come unire NUMBERS a SXC in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire NUMBERS a SXC. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file SXC. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedi l'esempio C# che unisce NUMBERS a SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire NUMERI a SXC in C#" InputFormat="numbers" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire i NUMERI a SXC tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Hai bisogno di unire NUMBERS a SXC a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="libreria .NET per unire NUMERI a SXC" %}}
