...
description: Aspose Excel. Convierta JPEG a ETT rápida y fácilmente con Aspose.Cells. Python JPEG a ETT. Python Guardar JPEG en ETT. Guarde JPEG como ETT usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde JPEG en ETT en Python" %}}

El siguiente ejemplo demuestra cómo convertir JPEG a ETT en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir JPEG a ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="ett" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir JPEG a ETT" %}}
