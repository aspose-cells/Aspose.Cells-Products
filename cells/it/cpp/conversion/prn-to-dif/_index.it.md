...
È necessario convertire i file PRN in DIF a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in DIF in poche righe di codice.
...
1.  Converti PRN in DIF chiamando il metodo Save().
