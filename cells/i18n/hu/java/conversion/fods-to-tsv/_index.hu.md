...
{{% blocks/products/pf/agp/content h2="FODS konvertálása TSV-vé a következővel: Java" %}}

 Ahhoz, hogy a FODS-t TSV-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A FODS konvertálása TSV-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a FODS-fájlt TSV-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be FODS-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TSV kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TSV-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="FODS to TSV Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a FODS fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.fods");
// mentse a FODS-t TSV-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS-ból TSV-be konvertáló élő bemutatók" sectionDescription="[Konvertálja a FODS-t TSV-vé](https://products.aspose.app/cells/conversion/fods-to-tsv) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a FODS-fájlt, és azonnal TSV-vé konvertálódik." >}}
