---
title:  Sloučit PRN na MHTML přes C++
url: /cs/cpp/merger/merge-prn-to-mhtml/ 
description: Sloučit PRN na MHTML Online zdarma. Online zdarma PRN na MHTML Fúze. Sloučit PRN do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit PRN s MHTML v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení PRN s číslem MHTML online" InputFormat="prn" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
