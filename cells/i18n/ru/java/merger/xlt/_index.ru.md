---
title: Объединить файлы XLT через Java 
weight: 9960
url: /ru/java/merger/xlt/ 
description: Пример кода Java для объединения документов XLT в Java среде выполнения для приложений JSP/JSF и настольных приложений.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Объединить форматы XLT в Java" h2="Встроенное слияние документов XLT с использованием серверных Java API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Как объединить файлы XLT с помощью Java" %}}

 Чтобы объединить файл XLT, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению файлов XLT в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Объединить файлы XLT — Java" offSpacer="" %}}

```cs
// Откройте первый файл XLT.
Workbook xltFile1 = new Workbook("chartsFileWithPath.xlt");

// Определите вторую исходную книгу.
// Откройте второй файл XLT.
