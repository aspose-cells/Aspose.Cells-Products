---
title:  Объединить SPREADSHETML в HTML через C++
...
В следующем примере показано, как объединить SPREADSHEETML с HTML в C++.
