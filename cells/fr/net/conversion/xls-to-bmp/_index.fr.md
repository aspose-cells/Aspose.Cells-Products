---
title: Convertisseur C# XLS à BMP - XLS à BMP
description: Aspose Exceller. Convertissez XLS en BMP rapidement et facilement avec Aspose.Cells. C# XLS en BMP. C# Enregistrez XLS en BMP. Enregistrez XLS sous 07611134. 81 en utilisant le C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLS au BMP au C#" %}}

L'exemple suivant montre comment convertir XLS en BMP dans C#.
...
{{% cells-convert title="Exemple de code pour convertir XLS en BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="bmp" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en BMP par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en BMP en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en BMP" %}}
