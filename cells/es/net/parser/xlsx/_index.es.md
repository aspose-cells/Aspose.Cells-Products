---
title:  Extraiga texto e imágenes del documento XLSX via .NET
weight: 4010
description: Código fuente C# para extraer texto e imágenes del archivo XLSX en .NET Framework, .NET Core, Mono o plataformas Xamarin.
...
{{% blocks/products/pf/agp/content h2="Cómo analizar el archivo XLSX usando C#" %}}
 ...
 Para analizar el archivo XLSX, usaremos[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API, que es una manipulación de documentos API rica en funciones, potente y fácil de usar para la plataforma C#. Abierto[NuGet](https://www.nuget.org/packages/aspose.cells) administrador de paquetes, buscar
