---
title:  Déverrouiller XLSM document via .NET
weight: 9810
description: C# code source pour déverrouiller le fichier XLSM protégé par mot de passe sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
