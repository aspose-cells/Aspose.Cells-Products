...
{{% blocks/products/pf/agp/content h2="Πώς να ασφαλίσετε το αρχείο XLSM χρησιμοποιώντας το C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την προστασία των αρχείων XLSM μέσω C++" %}}
...
1. Φορτώστε το αρχείο XLSM χρησιμοποιώντας την τάξη IWorkbook1. Χρησιμοποιήστε τη μέθοδο Protect(..) με ProtectionType και Password1. Αποθηκεύστε το προστατευμένο αρχείο XLSM με τη μέθοδο Save().
