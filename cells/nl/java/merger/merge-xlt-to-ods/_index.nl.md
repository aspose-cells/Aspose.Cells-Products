---
title: Voeg XLT samen met ODS - Combineer XLT met ODS in Java
url: /nl/java/merger/merge-xlt-to-ods/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online Samenvoegen XLT naar ODS saveformat. Java Combineer het formaat XLT tot ODS. Samenvoegen XLT tot ODS in Java. XLT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen met ODS in Java Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLT samenvoegt met ODS in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLT samen te voegen met ODS. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand ODS. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat XLT samenvoegt met ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om XLT samen te voegen tot ODS in Java" InputFormat="xlt" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLT samen te voegen tot ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen tot ODS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLT samen te voegen tot ODS" %}}
