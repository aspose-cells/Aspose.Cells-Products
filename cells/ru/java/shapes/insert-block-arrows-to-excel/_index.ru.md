---
title: Вставка стрелок блока в Excel via Java
weight: 338
...
{{% blocks/products/pf/agp/content h2="Как вставить блочные стрелки в файл Excel с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке блочных стрелок в файл Excel via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) вставить блок-стрелки на выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставить блок стрелок — Java" offSpacer="" %}}
