---
title:  تحرير أو عرض XLSX بيانات تعريف الوثيقة عبر C++
weight: 8970
description: رمز مثال C++ لتحرير أو عرض بيانات تعريف الملف XLSX على C++ بيئة التشغيل لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
{{% blocks/products/pf/agp/content h2="كيفية الحصول على البيانات الوصفية XLSX باستخدام C++" %}}
...
+ تحميل ملف XLSX باستخدام WorkbookMetadata
