...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in FODS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar FODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLTM om naar FODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLTM programmatisch converteren naar FODS? Ontwikkelaars van Java kunnen bestanden met de extensie XLTM eenvoudig converteren naar FODS met slechts een paar regels code.
