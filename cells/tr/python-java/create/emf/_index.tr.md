...
{{% blocks/products/pf/agp/code-block title="Örnek kod, Python excel kitaplığında EMF dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python EMF Dosyası Oluşturulacak Excel Kitaplığı" %}}
