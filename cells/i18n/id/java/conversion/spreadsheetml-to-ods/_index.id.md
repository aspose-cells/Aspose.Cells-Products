---
title: Konversikan SPREADSHEETML ke ODS melalui Java 
url: /id/java/conversion/spreadsheetml-to-ods/ 
description: Contoh Java kode konversi untuk format SPREADSHEETML ke file ODS. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke ODS dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan SPREADSHEETML ke ODS melalui Java" h2="SPREADSHEETML ke ODS Java konversi untuk mengonversi satu atau beberapa halaman ke ODS menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi SPREADSHEETML ke ODS Menggunakan Java" %}}

 Untuk merender SPREADSHEETML ke ODS, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi SPREADSHEETML ke ODS melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file SPREADSHEETML ke ODS hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file SPREADSHEETML dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi ODS & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file ODS yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML ke ODS Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file SPREADSHEETML dalam contoh Workbook
Workbook book = new Workbook("template.spreadsheetml");
// simpan SPREADSHEETML sebagai ODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi SPREADSHEETML ke ODS" sectionDescription="[Konversikan SPREADSHEETML ke ODS](https://products.aspose.app/cells/conversion/spreadsheetml-to-ods) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file SPREADSHEETML Anda, itu akan langsung dikonversi ke ODS." >}}
