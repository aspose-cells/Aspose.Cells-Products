...
{{% blocks/products/pf/agp/content h2="Como converter ODS para TABDELIMITED usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ODS em TABDELIMITED via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem converter facilmente o arquivo ODS para TABDELIMITED em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo ODS usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com a extensão de arquivo (TABDELIMITED).1. O arquivo TABDELIMITED será salvo no caminho especificado.1. Abra o arquivo TABDELIMITED em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="ODS para TABDELIMITED C++ Código-fonte de conversão" offSpacer="" %}}
