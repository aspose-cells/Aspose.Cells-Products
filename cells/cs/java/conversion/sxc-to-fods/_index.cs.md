...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na FODS pomocí Java" %}}

 K vykreslení SXC na FODS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na FODS prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SXC na FODS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením FODS a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor FODS
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SXC na FODS Java" offSpacer="" %}}

```cs
// načtěte soubor SXC v instanci sešitu
Workbook book = new Workbook("template.sxc");
// uložit SXC jako FODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze SXC na FODS" sectionDescription="[Převést SXC na FODS](https://products.aspose.app/cells/conversion/sxc-to-fods) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor SXC, bude okamžitě převeden na FODS." >}}
