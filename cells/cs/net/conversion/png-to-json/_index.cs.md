---
title: C# PNG až JSON - PNG až JSON Převodník
description: Aspose Excel. C# Aspose.Cells. PNG až JSON v C#. C# Převést PNG na JSON uložit formát. C# PNG až JSON formát. Uložte si PNG až JSON C#.
...
{{% blocks/products/pf/agp/content h2="Uložit PNG až JSON v C#" %}}

Následující příklad ukazuje, jak převést PNG na JSON v C#.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod PNG na JSON. Nahrajte svůj soubor PNG a poté jej jednoduše uložte jako soubor JSON. Pro čtení PNG i zápis JSON můžete použít plně kvalifikované názvy souborů. Výstupní JSON obsah a formátování bude shodné s původním dokumentem PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod PNG na JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést PNG na JSON přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na JSON programově? Vývojáři .NET mohou snadno načíst a převést PNG na JSON v několika řádcích kódu.
...
1.  Převeďte PNG na JSON voláním metody Workbook.Save.
1.  Získejte výsledek převodu PNG na JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod PNG na JSON" %}}
