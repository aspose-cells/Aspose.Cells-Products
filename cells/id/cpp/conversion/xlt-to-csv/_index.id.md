---
title: Konversi XLT ke CSV melalui C++ aplikasi 
url: /id/cpp/conversion/xlt-to-csv/ 
description: Contoh C++ kode konversi untuk dokumen XLT ke format CSV. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLT ke CSV dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLT ke CSV melalui C++" h2="Konversi XLT ke CSV berperforma tinggi menggunakan pustaka C++ tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLT ke CSV Menggunakan C++" %}}

 Untuk mengonversi XLT ke CSV, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi XLT ke CSV melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ pengembang dapat dengan mudah mengonversi file XLT ke CSV hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLT menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (CSV).1. File CSV akan disimpan di jalur yang ditentukan.1. Buka file CSV di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLT ke CSV C++ Kode Sumber Konversi" offSpacer="" %}}
