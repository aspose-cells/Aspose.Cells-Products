---
title: Sloučit MHT s NUMBERS – Sloučit MHT s NUMBERS v Python
url: /cs/python-net/merger/merge-mht-to-numbers/ 
description: Aspose Excel. Python Aspose.Cells. Online zdarma Sloučit MHT do NUMBERS uloženého formátu. Python Zkombinujte formát MHT s formátem ČÍSLA. Sloučit MHT na ČÍSLA v Python. MHT Sloučit.
...
Následující příklad ukazuje, jak sloučit MHT do NUMBERS v Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Online zdarma ke sloučení MHT do ČÍSEL na čísle Python" InputFormat="mht" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT do NUMBERS přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit MHT s NUMBERS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
