...
weight: 7010
url: /sv/net/protect/xls/ 
description: C# källkod för att låsa XLS-fil med lösenord på .NET Framework, .NET Core, Mono eller Xamarin-plattformar.
---
...
{{% blocks/products/pf/agp/content h2="Så här skyddar du XLS-fil med C#" %}}
...
1. Instantiera Workbook-klass med sökväg till XLS-fil1. Skaffa standard eller valfritt kalkylblad för att lägga till skydd1. Skydda kalkylblad med arbetsblad.Protect-metoden1. Skydda Workbook med Workbook.Protect-metoden1. Spara resultatet i XLS-format
