...
{{% blocks/products/pf/agp/content h2="Convert OTS to FODS in Python" %}}
...
The following example demonstrates how to convert OTS to FODS in Python via NET.
