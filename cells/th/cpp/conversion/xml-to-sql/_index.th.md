---
title: C++ XML เป็น SQL - ตัวแปลง XML เป็น SQL
description: Aspose เอ็กเซล. แปลง XML เป็น SQL อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XML เป็น SQL C++ บันทึก XML ลงใน SQL บันทึก XML เป็น SQL โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XML ลงใน SQL ใน C++" %}}
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง XML เป็น SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="sql" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง XML เป็น SQL โดยการเรียกเมธอด Save()
