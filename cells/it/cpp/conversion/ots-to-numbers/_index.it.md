...
Hai bisogno di convertire i file OTS in NUMBERS a livello di programmazione? C++ gli sviluppatori possono facilmente convertire OTS in NUMBERS in poche righe di codice.
...
1.  Converti OTS in NUMBERS chiamando il metodo Save().
