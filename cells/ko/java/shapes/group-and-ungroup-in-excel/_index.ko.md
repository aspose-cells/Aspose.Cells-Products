...
weight: 360
description: Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells' Java API을 사용하여 개체 그룹화 및 그룹 해제
...
{{% blocks/products/pf/agp/feature-section-col title="Excel 파일 via Java에서 도형을 그룹화하고 그룹 해제하는 단계" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 +[그룹 방법](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#group-com.aspose.cells.Shape---) 선택한 워크시트의 도형을 그룹화하려면
 +[그룹 해제 방법](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#ungroup-com.aspose.cells.GroupShape-) 선택한 워크시트의 도형 그룹을 해제하려면
