---
title: NUMBERS'ı Java aracılığıyla MHTML'ye dönüştürün 

description: NUMBERS biçimi için MHTML dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada MHTML'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="NUMBERS\'ı Java aracılığıyla MHTML\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı MHTML\'ye dönüştürmek için NUMBERS\'ı MHTML\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak NUMBERS\'ı MHTML\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="NUMBERS\'ı Java aracılığıyla MHTML\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla NUMBERS dosyasını MHTML'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. NUMBERS dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. Parametre olarak MHTML uzantısı ve SaveFormat ile çıktı yolunu iletin1. Ortaya çıkan MHTML dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="NUMBERS - MHTML Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// NUMBERS dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.numbers");
// NUMBERS'ı MHTML olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS - MHTML Dönüşüm Canlı Demoları" sectionDescription="[NUMBERS\'ı MHTML\'ye dönüştür](https://products.aspose.app/cells/conversion/numbers-to-mhtml) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece NUMBERS dosyanızı yükleyin, anında MHTML\'ye dönüştürülecektir." >}}
