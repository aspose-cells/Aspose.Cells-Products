...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLTM do formátu uložení EXCEL. C# Spojte XLTM do formátu EXCEL. Sloučit XLTM do EXCELu v C#. XLTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTM do EXCELu v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTM do EXCELu v C#" InputFormat="xltm" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
