...
description: Aspose Excel. A XLS-es számot gyorsan és egyszerűen SPREADSHEETML-re alakíthatja át a Aspose.Cells-es számmal. C++ Mentse a XLS számot a SPREADSHEETML-be. Mentse el a XLS-et SPREADSHEETML-ként a C++ használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLS-et a SPREADSHEETML-be a C++-ben" %}}
...
1.  A XLS konvertálása SPREADSHEETML-re a Save() metódus meghívásával.
