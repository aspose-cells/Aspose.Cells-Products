---
title: Conversor PHP SXC para TSV - SXC para TSV
description: Aspose Excel. Converta SXC em TSV de forma rápida e fácil com Aspose.Cells. PHP SXC em TSV. PHP Salve SXC em TSV. Salve SXC como TSV usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em TSV via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em TSV programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em TSV em apenas algumas linhas de código.
...
1.  Converta SXC em TSV chamando o método save da pasta de trabalho.
