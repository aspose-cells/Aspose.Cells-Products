...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке изогнутой стрелки в файл Excel по номеру C#" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) вставить изогнутую стрелку на выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставка в форме изогнутой стрелки — C#" offSpacer="" %}}
