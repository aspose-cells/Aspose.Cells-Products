---
title: Java XLS sang POWERPOINT - XLS sang Bộ chuyển đổi POWERPOINT
description: Aspose Excel. Chuyển đổi XLS sang POWERPOINT nhanh chóng và dễ dàng với Aspose.Cells. Java XLS sang POWERPOINT. Java Lưu XLS vào POWERPOINT. Lưu XLS dưới dạng POWERPOINT bằng Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Đổi XLS sang POWERPOINT trong Java" h2="Thư viện Java tốc độ cao để chuyển đổi XLS sang POWERPOINT. Đây là giải pháp phần mềm chuyên nghiệp nhập xuất XLS, POWERPOINT và nhiều định dạng khác sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POWERPOINT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS vào POWERPOINT trong Java" %}}

Ví dụ sau minh họa cách chuyển đổi XLS thành POWERPOINT trong Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để chuyển đổi XLS sang POWERPOINT. Tải lên tệp XLS của bạn, sau đó chỉ cần lưu nó dưới dạng tệp POWERPOINT. Đối với cả việc đọc XLS và ghi POWERPOINT, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng POWERPOINT đầu ra sẽ giống hệt với tài liệu XLS gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mã mẫu chuyển đổi XLS sang POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="pptx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS thành POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển file XLS sang POWERPOINT theo chương trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi XLS thành POWERPOINT chỉ bằng vài dòng mã.
...
1.  Chuyển đổi XLS thành POWERPOINT bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi XLS sang POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện Java chuyển XLS sang POWERPOINT" %}}
{{% blocks/products/pf/agp/text %}}
