---
title:  دمج الأرقام في POWERPOINT via Java
...
يوضح المثال التالي كيفية دمج الأرقام في POWERPOINT في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج الأرقام في POWERPOINT عبر الإنترنت" InputFormat="numbers" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
