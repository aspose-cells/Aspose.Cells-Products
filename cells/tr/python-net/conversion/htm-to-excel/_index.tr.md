...
description: Aspose Excel'de. Aspose.Cells ile HTM'yi hızlı ve kolay bir şekilde EXCEL'e dönüştürün. Python HTM'yi EXCEL'e dönüştürün. Python HTM'yi EXCEL'e kaydedin. Python'i kullanarak HTM'yi EXCEL olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'de HTM\'yi EXCEL\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="HTM\'yi Python\'de EXCEL\'e kaydedin" %}}

Aşağıdaki örnek, Python via NET'de HTM'nin EXCEL'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="HTM\'yi EXCEL\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="HTM\'yi EXCEL\'e dönüştürmek için Python kitaplığı" %}}
