...
ต้องการแปลงไฟล์ XML เป็น POWERPOINT ด้วยโปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลง XML เป็น POWERPOINT ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงไฟล์ XML เป็นไฟล์ POWERPOINT โดยเรียกใช้เมธอด Save()
