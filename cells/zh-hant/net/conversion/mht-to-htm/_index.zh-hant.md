---
title: C# MHT 到 HTM - MHT 到 HTM 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHT 轉換為 HTM。C# MHT 到 HTM。 C# 將 MHT 儲存到 HTM。使用 C# 將 MHT 儲存為 HTM。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 C# 中的 MHT 轉換為 HTM" h2="用於將 MHT 轉換為 HTM 的高速 C# 庫。這是一款專業的軟體解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 MHT、HTM 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="將 MHT 儲存為 C# 中的 HTM" %}}

下面的範例示範如何將C#中的MHT轉換為HTM。
...
{{% cells-convert title="將 MHT 轉換為 HTM 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 MHT 轉換為 HTM" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 MHT 檔案轉換為 HTM？ .NET 開發人員只需幾行程式碼即可輕鬆載入 MHT 並將其轉換為 HTM。
