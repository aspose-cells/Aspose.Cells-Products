...
{{% blocks/products/pf/agp/content h2="Převeďte JPEG na IMAGE v Python" %}}
...
Následující příklad ukazuje, jak převést JPEG na IMAGE v Python via NET.
