---
title: Java SPREADSHEETML para ODS - Conversor SPREADSHEETML para ODS
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores Java uma abordagem totalmente integrada para converter SPREADSHEETML para o formato ODS, permitindo o salvamento perfeito de dados SPREADSHEETML no formato ODS usando a biblioteca Aspose.Cells, tudo por meio de código Java eficiente e personalizável.
keywords: [Aspose Excel., Java Aspose.Cells., Smart SPREADSHEETML files to ODS Converter for Java., Convert SPREADSHEETML to ODS in Java., SPREADSHEETML files to ODS Conversion in Java., Leverage intelligent data processing to automatically parse and save SPREADSHEETML into ODS format with high fidelity and code efficiency]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter SPREADSHEETML para ODS em Java" h2="Biblioteca Java de alta velocidade para conversão de SPREADSHEETML para ODS. Esta é uma solução de software profissional para importar e exportar SPREADSHEETML, ODS e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salve SPREADSHEETML em ODS em Java" %}}

exemplo a seguir demonstra como converter SPREADSHEETML para ODS em Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter SPREADSHEETML em ODS. Carregue seu arquivo SPREADSHEETML e simplesmente salve-o como arquivo ODS. Para leitura de SPREADSHEETML e gravação de ODS, você pode usar nomes de arquivos completos. O conteúdo e a formatação da saída ODS serão idênticos ao documento SPREADSHEETML original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter SPREADSHEETML em ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xml" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter SPREADSHEETML para ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SPREADSHEETML para ODS programaticamente? Desenvolvedores que utilizam o formato Java podem converter facilmente arquivos SPREADSHEETML para ODS com apenas algumas linhas de código.
...
1.  Converta SPREADSHEETML em ODS chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de SPREADSHEETML para ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca Java para converter SPREADSHEETML em ODS" %}}
{{% blocks/products/pf/agp/text %}}
