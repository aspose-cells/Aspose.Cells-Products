---
title: Konvertor PHP MHTML až XLT - MHTML až XLT
description: Aspose Excel. Převeďte MHTML na XLT rychle a snadno pomocí Aspose.Cells. PHP MHTML na XLT. PHP Uložte MHTML na XLT. Uložte XLT jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na XLT přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na XLT programově? Vývojáři PHP mohou snadno načíst a převést MHTML na XLT v několika řádcích kódu.
...
1.  Převeďte MHTML na XLT voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na XLT" %}}
