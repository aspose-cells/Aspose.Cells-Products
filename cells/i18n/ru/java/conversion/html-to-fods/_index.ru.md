---
title: Преобразование HTML в FODS через Java 
url: /ru/java/conversion/html-to-fods/ 
description: Пример кода преобразования Java для формата HTML в файл FODS. Программисты могут использовать этот пример кода для экспорта электронных таблиц Excel и OpenOffice в FODS в любом веб-или настольном Java приложении.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование HTML в FODS через Java" h2="Преобразование HTML в FODS Java для преобразования одной или нескольких страниц в FODS с использованием локальной библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать HTML в FODS с помощью Java" %}}

 Чтобы отобразить HTML в FODS, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию HTML в FODS через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Java могут легко преобразовать HTML-файл в FODS, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузить файл HTML с экземпляром класса Workbook1. Вызов метода Workbook.save1. Передайте выходной путь с расширением FODS и SaveFormat в качестве параметров1. Проверить указанный путь для результирующего файла FODS
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования HTML в FODS Java" offSpacer="" %}}

```cs
// загрузить HTML-файл в экземпляр Workbook
Workbook book = new Workbook("template.html");
// сохранить HTML как FODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Преобразование HTML в FODS в реальном времени" sectionDescription="[Конвертировать HTML в FODS](https://products.aspose.app/cells/conversion/html-to-fods) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Нет необходимости загружать Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать какой-либо код." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите свой HTML-файл, и он будет мгновенно преобразован в FODS." >}}
