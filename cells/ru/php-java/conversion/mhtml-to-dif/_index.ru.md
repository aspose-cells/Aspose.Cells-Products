---
title: Конвертер PHP MHTML в DIF - MHTML в DIF
description: Aspose Эксель. Преобразуйте MHTML в DIF быстро и легко с помощью Aspose.Cells. PHP MHTML в DIF. PHP Сохраните MHTML в DIF. Сохраните MHTML как DIF с помощью PHP.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать MHTML в DIF с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы MHTML в DIF? Разработчики PHP могут легко загрузить и преобразовать MHTML в DIF всего за несколько строк кода.
...
1.  Преобразуйте MHTML в DIF, вызвав метод сохранения книги.
1.  Получите результат преобразования MHTML в DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования MHTML в DIF" %}}
