---
title: Объединить XLSM с CSV — объединить XLSM с CSV в Python.
url: /ru/python-net/merger/merge-xlsm-to-csv/ 
description: Aspose Эксель. Python Эксель. Объедините файлы XLSM и CSV в формате сохранения. Python Объедините форматы XLSM и CSV. Объедините числа XLSM и CSV в библиотеке Excel Python. XLSM Слияние.
...
{{% blocks/products/pf/agp/content h2="Объедините числа XLSM и CSV с помощью библиотеки Excel Python." %}}

 Как мне объединить XLSM с CSV? С помощью библиотеки Aspose.Cells for Python via .NET вы можете легко объединить XLSM и CSV программно с помощью нескольких строк кода.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) способен создавать кроссплатформенные приложения с возможностью генерировать, изменять, конвертировать, отображать и распечатывать все файлы Excel. Python Excel API не только конвертирует форматы электронных таблиц, но также может отображать файлы Excel в виде изображений, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT и т. д., что делает его идеальным выбором для обмена документами в стандартных отраслевых форматах. Вы можете установить Aspose.Cells for Python via .NET с<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , используйте команду как:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Объединить числа XLSM и CSV в библиотеке Excel Python." %}}

В следующем примере показано, как объединить XLSM с CSV в Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить номера XLSM и CSV. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле CSV. Если вы разработаете код Python, это будет проще, чем кажется. См. пример Python, в котором XLSM объединяется с CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения чисел XLSM и CSV в библиотеке Excel Python" InputFormat="xlsm" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Как объединить XLSM с CSV через библиотеку Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить номера XLSM и CSV? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Python для объединения XLSM и CSV" %}}
