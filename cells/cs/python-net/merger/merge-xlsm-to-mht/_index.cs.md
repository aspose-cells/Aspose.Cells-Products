---
title:  Sloučit XLSM na MHT přes Python
...
Následující příklad ukazuje, jak sloučit XLSM do MHT v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM s MHT online" InputFormat="xlsm" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
