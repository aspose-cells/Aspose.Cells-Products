---
title: 合併 XLT 至 DOCX - 將 XLT 至 DOCX 合併為 C++
url: /zh-hant/cpp/merger/merge-xlt-to-docx/ 
description: Aspose Excel。 C++ Aspose.Cells。免費在線合併XLT到DOCX保存格式。 C++ 將 XLT 合併為 DOCX 格式。將 XLT 合併到 C++ 中的 DOCX。 XLT 合併。
...
{{% blocks/products/pf/agp/content h2="使用 C++ 將 XLT 合併到 DOCX" %}}

如何將 XLT 合併到 DOCX？使用 Aspose.Cells for C++ 庫，您可以通過幾行代碼以編程方式輕鬆地將 XLT 合併到 DOCX。[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)能夠構建跨平台應用程序，能夠生成、修改、轉換、渲染和打印所有 Excel 文件。 C++ Excel API不僅可以在電子表格格式之間進行轉換，還可以將Excel文件渲染為圖像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，從而使其成為行業交換文檔的完美選擇-標準格式。您可以直接下載最新版本，打開即可[NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/)包管理器，搜索Aspose.Cells.cpp並安裝。您還可以從包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/content h2="免費在線將 XLT 合併為 C++ 中的 DOCX" %}}

以下示例演示如何將 XLT 合併到 Aspose.Cells for C++ 中的 DOCX。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLT 合併到 DOCX。上傳文件，調用 Workbook.Combine 方法合併文件，然後將其保存到 DOCX 文件。如果您在 C++ 中開發代碼，這會比聽起來更簡單。請參閱將 XLT 合併到 DOCX 的 C++ 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將 XLT 合併到 C++ 中的 DOCX" InputFormat="xlt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C++ 將 XLT 合併到 DOCX" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 XLT 合併到 DOCX 嗎？基本文檔合併和連接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++庫將XLT合併到DOCX" %}}
