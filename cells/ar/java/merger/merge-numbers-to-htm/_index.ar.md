---
title:  دمج الأرقام في HTM via Java
...
يوضح المثال التالي كيفية دمج NUMBERS مع HTM في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج الأرقام في HTM عبر الإنترنت" InputFormat="numbers" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
