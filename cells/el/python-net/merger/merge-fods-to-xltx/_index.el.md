---
title:  Συγχώνευση FODS σε XLTX μέσω Python
url: /el/python-net/merger/merge-fods-to-xltx/ 
description: Συγχώνευση FODS σε XLTX Online δωρεάν. Δωρεάν Online FODS έως XLTX Συγχώνευση. Συγχώνευση FODS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS με το XLTX στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση FODS με XLTX σε απευθείας σύνδεση" InputFormat="fods" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
