---
title: C++ XML เป็น HTM - ตัวแปลง XML เป็น HTM
description: Aspose เอ็กเซล. แปลง XML เป็น HTM อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XML เป็น HTM C++ บันทึก XML ไปยัง HTM บันทึก XML เป็น HTM โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XML เป็น HTM ใน C++" %}}
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง XML เป็น HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="htm" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="วิธีแปลง XML เป็น HTM ผ่านทาง C++" %}}
...
1.  แปลง XML เป็น HTM โดยการเรียกเมธอด Save()
