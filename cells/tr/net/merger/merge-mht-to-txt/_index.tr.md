...
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi MHT'yi TXT kaydetme biçimine birleştirme. C# MHT'yi TXT biçiminde birleştirin. MHT'yi C#'de TXT olarak birleştirin. MHT Birleştirin.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi TXT\'de C# Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin TXT ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

MHT'yi TXT'de birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından TXT dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. MHT'yi TXT ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="MHT\'yi C#\'de TXT ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="mht" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="MHT\'yi C# aracılığıyla TXT ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

MHT'yi programlı olarak TXT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi TXT ile birleştirmek için .NET kitaplığı" %}}
