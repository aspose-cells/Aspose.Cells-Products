---
title: 透過 C++ 將圓弧插入 Excel
weight: 10
description: C++ 在 Windows 32 位元、Windows 64 位元和 Linux 64 位元的 C++ 執行時間環境中將 Arc 插入 Excel 檔案的範例程式碼。
keywords: [C++ Aspose.Cells., C++ add arc shape., C++ insert arc shape., C++ create arc shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 將圓弧插入 Excel" h2="使用伺服器端的本機高效能插入物件 Aspose.Cells for C++ API，無需使用任何軟體，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ 透過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addarc/)在選定的工作表中插入方程式形狀
以 XLSX 格式儲存工作簿。
