---
title:  Cari dokumen XLSM tanpa membuka via .NET
weight: 4880
description: Kode sumber C# untuk mencari kata dengan pola pada file XLSM pada Framework .NET, .NET Core, Mono atau Platform Xamarin.
---
