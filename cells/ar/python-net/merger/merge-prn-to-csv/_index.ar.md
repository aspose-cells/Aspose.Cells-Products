---
title:  ادمج PRN في CSV عبر Python
...
يوضح المثال التالي كيفية دمج PRN مع CSV في Python.
...
{{% cells-merger title="تطبيق مجاني لدمج PRN في CSV عبر الإنترنت" InputFormat="prn" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
