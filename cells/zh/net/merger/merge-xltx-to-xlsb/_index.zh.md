---
title: 合并 XLTX 至 XLSB - 将 XLTX 至 XLSB 合并为 C#
url: /zh/net/merger/merge-xltx-to-xlsb/ 
description: Aspose Excel。 C# Aspose.Cells。将XLTX合并到XLSB保存格式。 C# 将 XLTX 合并为 XLSB 格式。将 XLTX 合并到 C# 中的 XLSB。 XLTX 合并。
...
{{% blocks/products/pf/agp/content h2="将 XLTX 合并到 C# 中的 XLSB" %}}

以下示例演示如何将 XLTX 合并到 Aspose.Cells for .NET 中的 XLSB。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLTX 合并到 XLSB。上传文件，调用 Workbook.Combine 方法合并文件，然后将其保存到 XLSB 文件。如果您在 C# 中开发代码，这会比听起来更简单。请参阅将 XLTX 合并到 XLSB 的 C# 示例。
...
{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLTX 合并到 XLSB" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLTX 合并到 XLSB 吗？基本文档合并和连接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET库将XLTX合并到XLSB" %}}
