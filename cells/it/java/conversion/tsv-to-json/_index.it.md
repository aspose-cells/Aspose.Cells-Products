---
title: Converti TSV in JSON tramite Java 
weight: 1910

description: Esempio di codice di conversione Java per il formato TSV in file JSON. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in JSON all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti TSV in JSON tramite Java" h2="Conversione da TSV a JSON Java per convertire pagine singole o multiple in JSON utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire TSV in JSON utilizzando Java" %}}

 Per rendere TSV in JSON, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TSV in JSON tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente file TSV in JSON in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TSV con un'istanza della classe Workbook1. Crea un intervallo di dati da esportare utilizzando il metodo Cells.createRange1. Chiama il metodo JsonUtility.exportRangeToJson con riferimenti a Range & ExportRangeToJsonOptions1. Scrivi i dati JSON della stringa su file tramite il metodo BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da TSV a JSON Java" offSpacer="" %}}
