---
title: Konversikan ODS ke SVG melalui Java 
weight: 5640
url: /id/java/conversion/ods-to-svg/ 
description: Contoh Java kode konversi untuk format ODS ke file SVG. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke SVG dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan ODS ke SVG melalui Java" h2="Konversi ODS ke SVG Java untuk mengonversi satu atau beberapa halaman ke SVG menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODS ke SVG Menggunakan Java" %}}

 Untuk merender ODS ke SVG, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi ODS ke SVG melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file ODS ke SVG hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file ODS dengan instance Workbook1. Pilih default atau Lembar Kerja apa pun dari koleksi1. Buat & atur objek ImageOrPrintOptions1. Buat SheetRender dengan objek Worksheet & ImageOrPrintOptions1. Panggil metode SheetRender.toImage untuk menyimpan hasil dalam format SVG
...
{{% blocks/products/pf/agp/code-block title="ODS ke SVG Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file ODS yang akan dirender
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi ODS ke SVG" sectionDescription="[Mengonversi ODS ke SVG](https://products.aspose.app/cells/conversion/ods-to-svg) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file ODS Anda, itu akan langsung dikonversi ke SVG." >}}
