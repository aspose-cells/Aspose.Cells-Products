---
title: Создать OTS — создать файл OTS по номеру Java.
description:  Aspose Эксель. Java Быстро и легко создайте файл OTS с помощью Aspose.Cells. Создайте файл OTS с помощью Java. Создайте файл OTS в Java. Java OTS Creator.
...
{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл OTS по номеру Java." offSpacer="" %}}
