---
title: Gộp TABDELIMITED thành XLSB - Gộp TABDELIMITED thành XLSB trong Java
url: /vi/java/merger/merge-tabdelimited-to-xlsb/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất TABDELIMITED thành XLSB định dạng lưu. Java Kết hợp TABDELIMITED thành định dạng XLSB. Hợp nhất TABDELIMITED thành XLSB trong Java. TABDELIMITED Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất TABDELIMITED thành XLSB trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất TABDELIMITED thành XLSB trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất TABDELIMITED với XLSB. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu vào tệp XLSB. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất TABDELIMITED thành XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất TABDELIMITED thành XLSB trong Java" InputFormat="tsv" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp TABDELIMITED thành XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất TABDELIMITED thành XLSB theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
