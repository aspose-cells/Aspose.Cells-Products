---
title: C# XML na XLSB - Převodník XML na XLSB
description: Aspose Excel. Převeďte XML na XLSB rychle a snadno pomocí Aspose.Cells. C# XML na XLSB. C# Uložte XML na XLSB. Uložte XML jako XLSB pomocí 0716183
...
{{% blocks/products/pf/agp/content h2="Uložte XML na XLSB v C#" %}}

Následující příklad ukazuje, jak převést XML na XLSB v C#.
...
{{% cells-convert title="Ukázkový kód pro převod XML na XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xlsb" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na XLSB přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XML na XLSB programově? Vývojáři .NET mohou snadno načíst a převést XML na XLSB v několika řádcích kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML na XLSB" %}}
