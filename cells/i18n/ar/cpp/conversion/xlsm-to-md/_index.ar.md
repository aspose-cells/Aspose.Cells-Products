...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSM إلى MD باستخدام C++" %}}
 ...
 من أجل تحويل XLSM إلى MD ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف XLSM إلى MD في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLSM باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (MD).1. سيتم حفظ ملف MD في المسار المحدد.1. افتح ملف MD في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLSM إلى MD C++ شفرة مصدر التحويل" offSpacer="" %}}
