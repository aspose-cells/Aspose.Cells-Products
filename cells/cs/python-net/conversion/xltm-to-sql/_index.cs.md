...
description: Aspose Excel. Převeďte XLTM na SQL rychle a snadno pomocí Aspose.Cells. Python XLTM na SQL. Python Uložte XLTM do SQL. Uložte XLTM jako SQL pomocí Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte XLTM na SQL v Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte XLTM do SQL v Python" %}}

Následující příklad ukazuje, jak převést XLTM na SQL v Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python knihovna pro převod XLTM na SQL" %}}
