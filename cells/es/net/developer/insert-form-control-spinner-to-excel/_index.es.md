---
title:  Insertar botón de giro en Excel via .NET
weight: 40
description: Código fuente C# para insertar el botón giratorio en Excel en .NET Framework, .NET Core, Mono o plataformas Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insertar botón de giro en Excel via .NET" h2="Inserte botones Girar usando Aspose.Cells\' API sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo insertar el botón giratorio en un archivo de Excel usando C#" %}}
 ...
 Para insertar el botón giratorio en un archivo de Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar el botón de giro en un archivo de Excel a través de C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[agregar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addspinner) para insertar un botón de giro en la hoja de trabajo seleccionada
...
{{% blocks/products/pf/agp/code-block title="Insertar botón de giro - C#" offSpacer="" %}}
