---
title: Scal OBRAZ z DIF - Połącz OBRAZ z DIF w C#
url: /pl/net/merger/merge-image-to-dif/ 
description: Aspose Excel. C# Aspose.Cells. Scal OBRAZ do formatu zapisu DIF. C# Połącz OBRAZ do formatu DIF. Scal OBRAZ z DIF w C#. OBRAZ Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz OBRAZ z DIF w C#" %}}

Poniższy przykład pokazuje, jak połączyć IMAGE z DIF w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić IMAGE z DIF. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku DIF. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OBRAZ z DIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia OBRAZU z DIF w C#" InputFormat="png" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć OBRAZ z DIF przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić IMAGE z DIF? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka .NET do połączenia OBRAZU z DIF" %}}
