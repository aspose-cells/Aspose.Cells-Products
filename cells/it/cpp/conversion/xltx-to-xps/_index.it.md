---
title: Converti XLTX in XPS tramite l'applicazione C++ 
url: /it/cpp/conversion/xltx-to-xps/ 
description: Esempio di codice di conversione C++ per documento XLTX in formato XPS. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLTX a XPS all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file XLTX in XPS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLTX usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XPS).1. Il file XPS verrà salvato nel percorso specificato.1. Apri il file XPS nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLTX a XPS C++" offSpacer="" %}}
