---
title:  Вставьте прямоугольник в Excel via Java
weight: 50
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addRectangle-int-int-int-int-int-int-)вставить прямоугольник на выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставка прямоугольник — Java" offSpacer="" %}}
