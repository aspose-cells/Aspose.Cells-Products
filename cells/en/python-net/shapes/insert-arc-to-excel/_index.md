...
{{% blocks/products/pf/agp/content h2="How to Insert Arc into Excel File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Arc to Excel file via Python" %}}
...
+  Use the shapecollection's [add method](https://apireference.aspose.com/cells/java/com.aspose.cells/shapecollection#addArc(int,%20int,%20int,%20int,%20int,%20int)) to insert a Arc in the selected worksheet.
