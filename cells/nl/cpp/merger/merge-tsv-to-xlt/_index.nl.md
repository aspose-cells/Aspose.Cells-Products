...
url: /nl/cpp/merger/merge-tsv-to-xlt/ 
...
Het volgende voorbeeld laat zien hoe u TSV samenvoegt met XLT in Aspose.Cells for C++.
...
{{% cells-merger title="Voorbeeldcode om TSV samen te voegen met XLT in C++" InputFormat="tsv" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe u TSV samenvoegt met XLT via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TSV programmatisch samenvoegen met XLT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TSV samen te voegen met XLT" %}}
