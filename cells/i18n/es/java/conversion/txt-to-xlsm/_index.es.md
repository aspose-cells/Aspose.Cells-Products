---
title: Convierte TXT a XLSM a través de Java 
url: /es/java/conversion/txt-to-xlsm/ 
description: Ejemplo de código de conversión Java de formato TXT a archivo XLSM. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a XLSM dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte TXT a XLSM a través de Java" h2="Conversión de TXT a XLSM Java para convertir una o varias páginas a XLSM mediante la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir TXT a XLSM usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir TXT a XLSM a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo TXT a XLSM con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo TXT con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión XLSM y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo XLSM resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de TXT a XLSM Java" offSpacer="" %}}

```cs
// cargar el archivo TXT en una instancia de Workbook
Workbook book = new Workbook("template.txt");
// guardar TXT como XLSM
