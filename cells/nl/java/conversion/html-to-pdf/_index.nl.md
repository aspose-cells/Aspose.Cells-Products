...
{{% blocks/products/pf/agp/content h2="Sla HTML op in PDF in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar PDF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar PDF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar PDF? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar PDF met slechts een paar regels code.
