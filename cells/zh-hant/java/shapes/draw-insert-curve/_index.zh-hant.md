---
title: 如何在 Excel 中繪製或插入曲線形狀 via Java
weight: 30
description: 使用 Aspose.Cells' Java API 繪製或插入曲線形狀，無需任何軟體，如 Microsoft 或 Open Office、Adobe PDF 等。
keywords: [Java Aspose.Cells., Java add curved shape., Java insert curved shape., Java create curved shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="將曲線形狀插入 Excel via Java" h2="使用 Aspose.Cells\' API 插入曲線形狀，無需使用 Microsoft 或 Open Office、Adobe PDF 等任何軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將曲線形狀插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="將曲線形狀插入 Excel 檔案的步驟 via Java" %}}
...
+ 透過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)在選定的工作表中插入曲線形狀
以 XLSX 格式儲存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入彎曲形狀 - Java" offSpacer="" %}}
