---
title: Konwertuj XLT na JPG za pomocą aplikacji C++ 

description: Przykładowy kod konwersji C++ dla dokumentu XLT do formatu JPG. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLT na JPG w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLT na JPG przez C++" h2="Wysokowydajna konwersja XLT do JPG przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLT na JPG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (JPG).1. Plik JPG zostanie zapisany pod określoną ścieżką.1. Otwórz plik JPG w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLT do JPG C++ Kod źródłowy konwersji" offSpacer="" %}}
