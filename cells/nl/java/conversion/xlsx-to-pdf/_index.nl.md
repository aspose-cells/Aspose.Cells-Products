...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in PDF in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar PDF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar PDF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar PDF? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar PDF met slechts een paar regels code.
