---
title: SPREADSHEETML'yi Java aracılığıyla MHTML'ye dönüştürün 
url: /tr/java/conversion/spreadsheetml-to-mhtml/ 
description: SPREADSHEETML biçimi için MHTML dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada MHTML'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML\'yi Java aracılığıyla MHTML\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı MHTML\'ye dönüştürmek için SPREADSHEETML\'den MHTML\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak SPREADSHEETML\'yi MHTML\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="SPREADSHEETML\'yi Java aracılığıyla MHTML\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla SPREADSHEETML dosyasını MHTML'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. SPREADSHEETML dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. Parametre olarak MHTML uzantısı ve SaveFormat ile çıktı yolunu iletin1. Ortaya çıkan MHTML dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML\'den MHTML\'ye Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// SPREADSHEETML dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.spreadsheetml");
// SPREADSHETML'yi MHTML olarak kaydet
