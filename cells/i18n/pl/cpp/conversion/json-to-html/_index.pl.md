---
title: Konwertuj JSON na HTML za pomocą aplikacji C++ 
url: /pl/cpp/conversion/json-to-html/ 
description: Przykładowy kod konwersji C++ dla dokumentu JSON na format HTML. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji JSON na HTML w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj JSON na HTML przez C++" h2="Wysokowydajna konwersja JSON do HTML przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik JSON na HTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik JSON przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (HTML).1. Plik HTML zostanie zapisany pod określoną ścieżką.1. Otwórz plik HTML w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="JSON do HTML C++ Kod źródłowy konwersji" offSpacer="" %}}
