---
title: Java IMAGE en DIF - Convertisseur IMAGE en DIF
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE à DIF dans Java" %}}

L'exemple suivant montre comment convertir IMAGE en DIF en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir une IMAGE en DIF via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en DIF" %}}
{{% blocks/products/pf/agp/text %}}
