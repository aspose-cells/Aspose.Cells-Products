...
description: Aspose Excel'de. Aspose.Cells ile HTM'yi hızlı ve kolay bir şekilde SQL'e dönüştürün. Python HTM'den SQL'e. Python HTM'yi SQL'e kaydedin. Python'i kullanarak HTM'yi SQL olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'de HTM\'yi SQL\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="HTM\'yi Python\'de SQL\'e kaydedin" %}}

Aşağıdaki örnek, Python via NET'de HTM'nin SQL'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="HTM\'yi SQL\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="sql" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="HTM\'yi SQL\'e dönüştürmek için Python kitaplığı" %}}
