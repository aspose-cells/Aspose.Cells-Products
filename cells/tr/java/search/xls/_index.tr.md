---
title:  XLS belgeyi açmadan arayın via Java
weight: 9430
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı üzerindeki XLS dosyasındaki kalıplı kelimeleri aramak için Java örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS Biçimlerini Java\'de arayın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Cells for Java API\'leri kullanarak yerel ve yüksek performanslı XLS belge arama." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java\'de XLS Dosyalarını Arama Adımları" %}}
...
+ Bir Çalışma Kitabı nesnesi oluşturarak XLS dosyasını yükleyin.
...
{{% blocks/products/pf/agp/code-block title="Ara XLS Dosyalar - Java" offSpacer="" %}}
