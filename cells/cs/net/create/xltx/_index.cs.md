...
description: XLTX tvůrce. Vytvořte soubory XLTX v kódu C#. Generujte soubory MS Excel XLTX pomocí VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Pro vývojáře je snadné vytvářet, načítat, upravovat a konvertovat tabulku MS Excel XLTX v rámci běhu různých reportovacích aplikací pro zpracování dat v několika řádcích kódu.
...
{{% blocks/products/pf/agp/code-block title="Ukázkový kód pro vytvoření souboru MS Excel XLTX pomocí C#." offSpacer="" %}}
