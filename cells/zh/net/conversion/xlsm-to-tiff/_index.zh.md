---
title: C# XLSM 至 TIFF - XLSM 至 TIFF 转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 XLSM 转换为 TIFF 格式，从而能够使用 Aspose.Cells 库将 XLSM 数据无缝保存为 TIFF 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 XLSM 保存到 TIFF，即 C#" %}}

以下示例演示了如何在 C# 中将 XLSM 转换为 TIFF。
...
{{% cells-convert title="将 XLSM 转换为 TIFF 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsm" outformat="tiff" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLSM 通过 C# 转换为 TIFF" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 文件转换为 TIFF 吗？.NET 开发人员只需几行代码即可轻松加载并将 XLSM 转换为 TIFF。
...
{{% blocks/products/pf/agp/content h2="使用 C# 库将 XLSM 转换为 TIFF" %}}
