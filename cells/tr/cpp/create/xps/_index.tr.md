...
description: Aspose Excel'de. C++ Aspose.Cells ile hızlı ve kolay bir şekilde XPS Dosyası oluşturun. C++'i kullanarak XPS dosyası oluşturun. C++'de XPS oluşturun. C++ XPS Oluşturucu.
...
1.  Save() yöntemini kullanarak çalışma kitabını .xps dosyası olarak kaydedin.
