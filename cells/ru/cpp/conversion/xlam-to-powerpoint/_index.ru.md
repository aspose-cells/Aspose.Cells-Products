...
Нужно программно преобразовать файлы XLAM в формат PowerPoint? Разработчики, работающие с файлами C++, могут легко преобразовать файлы XLAM в формат PowerPoint всего несколькими строками кода.
...
1.  Преобразуйте файл XLAM в формат POWERPOINT, вызвав метод Save().
