---
title: C# ओटीएस से HTML - ओटीएस से HTML कन्वर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ OTS को HTML में जल्दी और आसानी से बदलें। C# OTS को HTML पर बदलें। C# OTS को HTML पर सहेजें। C# का उपयोग करके OTS को HTML के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="OTS को C# में HTML पर सेव करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि OTS को C# में HTML में कैसे परिवर्तित किया जाए।
...
{{% cells-convert title="ओटीएस को HTML में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="html" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# के माध्यम से ओटीएस को HTML में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

OTS फ़ाइलों को प्रोग्रामेटिक रूप से HTML में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में ओटीएस को आसानी से लोड और HTML में परिवर्तित कर सकते हैं।
...
1.  Workbook.Save पद्धति पर कॉल करके OTS को HTML में कनवर्ट करें।
1.  ओटीएस का रूपांतरण परिणाम HTML पर प्राप्त करें।

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ओटीएस को HTML में बदलने के लिए C# लाइब्रेरी" %}}
