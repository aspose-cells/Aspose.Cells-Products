---
title: C++アプリケーションを介してMHTMLをDIFに変換する 
weight: 5470
url: /ja/cpp/conversion/mhtml-to-dif/ 
description: MHTMLドキュメントからDIF形式へのサンプルC++変換コード。プログラマーは、このソースコードを使用して、任意のC++アプリケーション内でMHTMLからDIFへのバッチ変換を行うことができます。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++を介してMHTMLをDIFに変換します" h2="Microsoft Excel、OpenOffice、またはAdobeAcrobatをインストールせずにC++ライブラリを使用した高性能MHTMLからDIFへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="C++を使用してMHTMLをDIFに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してMHTMLをDIFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 C++開発者は、わずか数行のコードでMHTMLファイルをDIFに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbookを使用してMHTMLファイルをロードします。1. Save（）メソッドを呼び出します。1. （DIF）ファイル拡張子を持つ出力ファイルパスを渡します。1. DIFファイルは指定されたパスに保存されます。1. 互換性のあるプログラムでDIFファイルを開きます。
...
{{% blocks/products/pf/agp/code-block title="MHTMLからDIFC++への変換ソースコード" offSpacer="" %}}
