---
title:  Mesclar XLSB para PPTX via C#
url: /pt/net/merger/merge-xlsb-to-pptx/ 
description: Mesclar XLSB para PPTX Online gratuitamente. Online Grátis XLSB a PPTX Fusão. Mesclar XLSB para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar XLSB a PPTX em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar XLSB a PPTX on-line" InputFormat="xlsb" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
