---
title: 通过 Java 从 XLSB 文档中提取文本和图像 
weight: 440

description: Java 示例代码，用于从 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中的 XLSB 文件中提取文本和图像。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="解析 Java 中的 XLSB 格式" h2="使用服务器端 Aspose.Cells for Java API 进行本机和高性能 XLSB 文档解析，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java 中解析 XLSB 文件的步骤" %}}
