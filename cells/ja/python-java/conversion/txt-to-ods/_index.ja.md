---
title: Python TXT ～ ODS - TXT ～ ODS コンバータ
description: Aspose エクセル。 TXT を Aspose.Cells ですばやく簡単に ODS に変換します。 Python TXT から ODS に変換します。 Python TXT を ODS に保存します。 TXT を 07611134 として保存しますPythonを使用して81。
...
{{% blocks/products/pf/agp/content h2="Python を使用して TXT を ODS に変換します" %}}
...
次の例は、TXT を Python の ODS に変換する方法を示しています。
...
{{% cells-convert title="TXT を ODS に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="ods" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でTXTをODSに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

TXT ファイルをプログラムで ODS に変換する必要がありますか? Python 開発者は、わずか数行のコードで TXT を簡単にロードして ODS に変換できます。
