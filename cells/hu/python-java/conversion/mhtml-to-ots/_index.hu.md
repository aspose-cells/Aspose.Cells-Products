...
description: Aspose Excel. Python Excel. A MHTML-es számot gyorsan és egyszerűen konvertálja OTS-re a Aspose.Cells-es számmal. Python MHTML OTS-re. Python Mentse a MHTML számot az OTS-nél. Mentse el a MHTML számot OTS-ként a Python Excel Library használatával.
