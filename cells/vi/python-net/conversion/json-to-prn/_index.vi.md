...
Ví dụ sau minh họa cách chuyển đổi JSON thành PRN trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi JSON sang PRN" %}}
