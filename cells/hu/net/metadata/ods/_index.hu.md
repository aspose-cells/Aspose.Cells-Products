...
{{% blocks/products/pf/agp/content h2="A ODS metaadatok kinyerése a C# használatával" %}}

 ODS metaadatok kinyeréséhez a következőket fogjuk használni
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a ODS metaadatainak C#-en keresztül történő kinyeréséhez" %}}
...
+ A ODS betöltése a munkafüzet egy példányával
...
{{% blocks/products/pf/agp/code-block title="A ODS - C# metaadatainak kivonata" offSpacer="" %}}
