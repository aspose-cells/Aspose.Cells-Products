...
{{% blocks/products/pf/agp/content h2="Převeďte HTM na ETT v Python" %}}
...
Následující příklad ukazuje, jak převést HTM na ETT v Python via NET.
