---
title: 如何使用 Python via .Net 在 Excel 中绘制或插入弯曲箭头形状
weight: 10
description: Python via .Net 源代码将弯曲箭头形状插入Excel。
...
{{< blocks/products/pf/i18n/upper-banner h1="使用 Python via .Net 将弯曲箭头形状插入 Excel 中" h2="使用 Aspose.Cells\' API 插入弯曲箭头形状，无需使用 Microsoft 或 Open Office、Adobe PDF 等任何软件。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via .Net 将弯曲箭头形状插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via .Net 将弯曲箭头形状插入 Excel 文件的步骤" %}}
...
+ 通过索引选择工作表。
 使用形状集合的添加[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)在选定的工作表中插入弯曲箭头形状。
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入弯曲箭头形状 - Python via .Net" offSpacer="" %}}
