...
description: Aspose Excel. Chuyển đổi XLSX sang PRN nhanh chóng và dễ dàng với Aspose.Cells. Python XLSX sang PRN. Python Lưu XLSX vào PRN. Lưu XLSX dưới dạng PRN bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSX sang PRN bằng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLSX vào PRN vào Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSX sang PRN trong Python.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python để chuyển đổi XLSX sang PRN" %}}
