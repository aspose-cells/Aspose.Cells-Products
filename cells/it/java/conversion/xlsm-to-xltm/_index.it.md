---
title: Converti XLSM in XLTM tramite Java 
weight: 4470
url: /it/java/conversion/xlsm-to-xltm/ 
description: Esempio di codice di conversione Java per il formato XLSM in file XLTM. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in XLTM all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLSM in XLTM tramite Java" h2="Conversione da XLSM a XLTM Java per convertire pagine singole o multiple in XLTM utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire XLSM in XLTM utilizzando Java" %}}

 Per rendere XLSM in XLTM, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire XLSM in XLTM tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente file XLSM in XLTM in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLSM con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione XLTM e SaveFormat come parametri1. Controllare il percorso specificato per il file XLTM risultante
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLSM a XLTM Java" offSpacer="" %}}

```cs
// caricare il file XLSM in un'istanza di Workbook
Workbook book = new Workbook("template.xlsm");
// salva XLSM come XLTM
