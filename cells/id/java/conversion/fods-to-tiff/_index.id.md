---
title: Konversikan FODS ke TIFF melalui Java 
url: /id/java/conversion/fods-to-tiff/ 
description: Contoh Java kode konversi untuk format FODS ke file TIFF. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke TIFF dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan FODS ke TIFF melalui Java" h2="FODS ke TIFF Java konversi untuk mengonversi satu atau beberapa halaman ke TIFF menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi FODS ke TIFF Menggunakan Java" %}}

 Untuk merender FODS ke TIFF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi FODS ke TIFF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file FODS ke TIFF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file FODS dengan instance Workbook1. Pilih default atau Lembar Kerja apa pun dari koleksi1. Buat & atur objek ImageOrPrintOptions1. Buat SheetRender dengan objek Worksheet & ImageOrPrintOptions1. Panggil metode SheetRender.toImage untuk menyimpan hasil dalam format TIFF
...
{{% blocks/products/pf/agp/code-block title="FODS ke TIFF Java Kode Sumber Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi FODS ke TIFF" sectionDescription="[Mengkonversi FODS ke TIFF](https://products.aspose.app/cells/conversion/fods-to-tiff) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file FODS Anda, itu akan langsung dikonversi ke TIFF." >}}
