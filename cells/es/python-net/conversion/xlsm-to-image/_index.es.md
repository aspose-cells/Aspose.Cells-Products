...
description: Aspose Excel. Convierta XLSM a IMAGEN rápida y fácilmente con Aspose.Cells. Python XLSM a IMAGEN. Python Guardar XLSM en IMAGEN. Guarde XLSM como IMAGEN usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSM a IMAGEN en Python" h2="Biblioteca Python de alta velocidad para convertir XLSM a IMAGEN. Utilice nuestra conversión de Excel API para desarrollar software independiente de plataforma de alto nivel en Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Guardar XLSM en IMAGEN en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSM a IMAGEN en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir XLSM a IMAGEN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="png" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSM a IMAGEN" %}}
