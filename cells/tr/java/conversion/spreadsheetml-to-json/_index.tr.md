---
title: SPREADSHEETML'yi Java aracılığıyla JSON'a dönüştürün 
url: /tr/java/conversion/spreadsheetml-to-json/ 
description: SPREADSHEETML biçimi için JSON dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada JSON'a aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML\'yi Java aracılığıyla JSON\'a dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı JSON\'a dönüştürmek için SPREADSHEETML\'den JSON\'a Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak SPREADSHETML\'yi JSON\'a Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="SPREADSHEETML\'yi Java aracılığıyla JSON\'a Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla SPREADSHEETML dosyasını JSON'a kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML\'den JSON\'a Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
