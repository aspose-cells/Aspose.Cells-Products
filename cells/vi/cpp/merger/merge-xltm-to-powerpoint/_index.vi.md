---
title: Gộp XLTM vào POWERPOINT - Gộp XLTM vào POWERPOINT trong C++
url: /vi/cpp/merger/merge-xltm-to-powerpoint/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất XLTM vào định dạng lưu POWERPOINT. C++ Kết hợp XLTM thành định dạng POWERPOINT. Hợp nhất XLTM vào POWERPOINT trong C++. XLTM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Gộp XLTM vào POWERPOINT trong C++" %}}

Ví dụ sau đây minh họa cách hợp nhất XLTM với POWERPOINT trong Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XLTM vào POWERPOINT. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp POWERPOINT. Nếu bạn phát triển mã theo số C++, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C++ hợp nhất XLTM với POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp XLTM vào POWERPOINT trong C++" InputFormat="xltm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp XLTM vào POWERPOINT qua C++" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất XLTM vào POWERPOINT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ gộp XLTM vào POWERPOINT" %}}
