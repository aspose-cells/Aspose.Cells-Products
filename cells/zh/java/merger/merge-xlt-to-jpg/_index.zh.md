---
title: 合并 XLT 到 JPG - 将 XLT 合并到 Java 中的 JPG
url: /zh/java/merger/merge-xlt-to-jpg/ 
description: Aspose Excel。 Java Aspose.Cells。免费在线合并XLT到JPG保存格式。 Java 将XLT合并为JPG格式。将 XLT 合并为 Java 中的 JPG。 XLT 合并。
...
{{% blocks/products/pf/agp/content h2="免费在线将 XLT 合并为 Java 中的 JPG" %}}

下面的例子演示了如何将XLT合并为JPG Aspose.Cells for Java。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLT 合并到 JPG。上传文件，调用Workbook.Combine方法合并文件，然后保存为JPG文件。如果您在 Java 中开发代码，这会比听起来更简单。请参阅 Java 将 XLT 合并到 JPG 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线将 XLT 合并为 Java 中的 JPG" InputFormat="xlt" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLT 合并为 JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 合并到 JPG 吗？基本文档合并和连接[Aspose.Cells for Java](https://products.aspose.com/cells/java)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Java库将XLT合并到JPG" %}}
