...
description: Sample C++ conversion code for XLS to BMP format. Programmers can use this source code for batch XLS to BMP conversion within any C++ Application.
---
