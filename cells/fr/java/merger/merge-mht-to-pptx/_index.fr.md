---
title: Fusionner MHT avec PPTX - Combiner MHT avec PPTX dans Java
url: /fr/java/merger/merge-mht-to-pptx/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde PPTX. Java Combinez MHT au format PPTX. Fusionner MHT avec PPTX dans Java. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec PPTX en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT avec PPTX dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT en PPTX. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier PPTX. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne MHT en PPTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner MHT avec PPTX en Java" InputFormat="mht" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner MHT avec PPTX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner MHT avec PPTX" %}}
