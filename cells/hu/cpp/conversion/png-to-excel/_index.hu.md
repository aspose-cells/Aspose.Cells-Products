...
{{% blocks/products/pf/agp/content h2="Alakítsa át a PNG-et EXCEL-lé a C++ használatával" %}}
...
{{% blocks/products/pf/agp/content h2="Mentse el a PNG-es számot EXCEL-be a C++-es számban" %}}

következő példa bemutatja, hogyan lehet a PNG számot EXCEL formátumba konvertálni a C++ függvényben.
...
Programozottan kell PNG fájlokat EXCEL formátumba konvertálni? A C++ fejlesztők könnyedén konvertálhatják a PNG fájlokat EXCEL formátumba mindössze néhány sornyi kóddal.
...
1.  Alakítsd át a PNG-et EXCEL formátumba a Save() metódus meghívásával.
1.  Szerezd meg a PNG konverziós eredményt EXCEL-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ könyvtár a PNG EXCEL-re konvertálásához" %}}
