---
title: Gộp MHT thành JSON - Gộp MHT thành JSON trong C#
url: /vi/net/merger/merge-mht-to-json/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí MHT thành JSON saveformat. C# Gộp định dạng MHT thành JSON. Hợp nhất MHT thành JSON thành C#. Hợp nhất MHT.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHT với JSON trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất MHT thành JSON trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất MHT thành JSON. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp rồi lưu vào tệp JSON. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất MHT thành JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất MHT thành JSON trong C#" InputFormat="mht" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất MHT thành JSON qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất MHT thành JSON theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2=".NET thư viện ghép MHT thành JSON" %}}
