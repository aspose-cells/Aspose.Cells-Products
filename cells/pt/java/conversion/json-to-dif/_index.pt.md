---
title: Converter JSON para DIF via Java 
weight: 5520
url: /pt/java/conversion/json-to-dif/ 
description: Exemplo de código de conversão Java para formato JSON em arquivo DIF. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para DIF em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter JSON para DIF via Java" h2="Exporte o formato JSON para DIF via Java sem precisar de ferramentas ou bibliotecas adicionais." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter JSON para DIF usando Java" %}}

 Para renderizar JSON para DIF, usaremos
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão JSON para DIF Java" offSpacer="" %}}
...
// salve o arquivo resultante no formato JSON-TO-DIF
