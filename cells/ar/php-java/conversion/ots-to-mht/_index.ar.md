---
title: PHP OTS إلى MHT - تحويل OTS إلى MHT
description: Aspose اكسل. قم بتحويل OTS إلى MHT بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى MHT. PHP حفظ OTS إلى MHT. احفظ OTS كـ MHT باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى MHT عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى MHT برمجياً؟ يمكن لمطوري PHP تحميل وتحويل OTS إلى MHT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل OTS إلى MHT عن طريق استدعاء طريقة حفظ المصنف.
