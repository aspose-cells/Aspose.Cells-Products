...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển FODS sang PDF qua Java" h2="Chuyển đổi FODS sang PDF Java để chuyển đổi một hoặc nhiều trang sang PDF bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển FODS sang PDF bằng Java" %}}

 Để hiển thị FODS sang PDF, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi FODS sang PDF qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp FODS sang PDF chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp FODS với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Chuyển đường dẫn đầu ra với phần mở rộng PDF & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp PDF kết quả
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi FODS sang PDF Java" offSpacer="" %}}

```cs
// tải tệp FODS trong một phiên bản của Workbook
Workbook book = new Workbook("template.fods");
// lưu FODS dưới dạng PDF
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi FODS sang PDF" sectionDescription="[Chuyển đổi FODS sang PDF](https://products.aspose.app/cells/conversion/fods-to-pdf) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp FODS của bạn, tệp sẽ được chuyển đổi ngay lập tức sang PDF." >}}
