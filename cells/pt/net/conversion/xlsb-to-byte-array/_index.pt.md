---
title: Converter XLSB para matriz de bytes via C# 
weight: 7690
url: /pt/net/conversion/xlsb-to-byte-array/ 
description: C# Código de amostra para conversão de XLSB para matriz de bytes. Use este código para conversão de Excel XLSB para Byte Array em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSB para matriz de bytes via C#" h2="Conversão nativa e de alto desempenho do Microsoft Excel XLSB para matriz de bytes ou vice-versa para processamento de dados de planilhas usando APIs .NET do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array é útil para processamento ou armazenamento de dados. Você pode converter um arquivo XLSB para Byte Array, bem como um documento **Byte Array para XLSB** usando a linguagem C#. Para converter XLSB em array de bytes, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter XLSB para matriz de bytes via C#" %}}

{{% blocks/products/pf/agp/text %}}

 É fácil para os desenvolvedores carregar e converter arquivos XLSB em array de bytes para outras tarefas de manipulação em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Inclua o namespace em seu arquivo de classe1. Carregar arquivo XLSB de entrada usando a pasta de trabalho1. Inicialize o objeto MemoryStream1. Converter dados de fluxo em matriz de bytes1. Processe dados conforme sua exigência
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra XLSB para matriz de bytes C# Conversão" offSpacer="" %}}
