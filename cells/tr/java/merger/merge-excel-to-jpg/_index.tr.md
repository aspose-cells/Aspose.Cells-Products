---
title: EXCEL'i JPG ile birleştir - Java'de EXCEL'i JPG ile birleştir
url: /tr/java/merger/merge-excel-to-jpg/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i JPG kaydetme biçimiyle birleştirin. Java EXCEL'i JPG formatıyla birleştirin. Java'de EXCEL'i JPG'ye birleştirin. EXCEL Birleştirin.
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i JPG ile birleştir" %}}
...
{{% cells-merger title="Java\'de EXCEL\'i JPG ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i JPG via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL'i JPG ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i JPG ile birleştirmek için Java kütüphane" %}}
