---
title: JSON'u Java aracılığıyla XLSX'e dönüştürün 
weight: 8370
url: /tr/java/conversion/json-to-xlsx/ 
description: JSON biçimi için XLSX dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada XLSX'e aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JSON\'u Java aracılığıyla XLSX\'e dönüştürün" h2="Ek araçlar veya kitaplıklar gerektirmeden JSON\'u Java aracılığıyla XLSX biçimine aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak JSON\'u XLSX\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/code-block title="JSON\'dan XLSX\'e Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
// elde edilen dosyayı JSON-TO-XLSX formatında kaydedin
