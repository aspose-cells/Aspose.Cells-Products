---
title: Convertisseur PHP Excel vers XML - Excel vers XML
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir EXCEL au format XML, permettant un enregistrement transparent des données EXCEL au format XML grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir un fichier Excel en XML en PHP" h2="Bibliothèque PHP haute performance pour la conversion d\'Excel en XML. Solution logicielle professionnelle permettant d\'importer et d\'exporter des fichiers Excel, XML et de nombreux autres formats grâce à PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for PHP" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/php-java" installationsDocsLink="https://docs.aspose.com/cells/php-java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/php/" learnAsLink="https://docs.aspose.com/cells/php-java" apiReference="" mavenRepoLink="" >}}


{{% blocks/products/pf/agp/content h2="Convertir un fichier Excel en XML à l\'aide de PHP" %}}

 Comment convertir un fichier EXCEL en XML ? Grâce à la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir un fichier EXCEL en XML par programmation en quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) PHP Excel API permet de créer des applications multiplateformes capables de générer, modifier, convertir, afficher et imprimer tous les fichiers Excel. Outre la conversion entre différents formats de tableur, il peut également afficher les fichiers Excel sous forme d'images (PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT), ce qui en fait un outil idéal pour l'échange de documents aux formats standards.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer un fichier Excel au format XML en PHP" %}}

L'exemple suivant montre comment convertir un fichier EXCEL en XML en PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir un fichier Excel en XML via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en XML par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers EXCEL en XML en quelques lignes de code seulement.
...
1.  Convertissez un fichier EXCEL en XML en appelant la méthode save du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir Excel en XML" %}}
