---
title:  Rechercher le document TXT sans ouvrir le via .NET
weight: 8410
description: Code source C# pour rechercher des mots avec un motif dans le fichier TXT sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Rechercher les formats TXT dans C#" h2="Recherche de documents TXT native et haute performance à l\'aide des API Aspose.Cells for .NET côté serveur, sans utiliser de logiciel comme Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
