...
description: Aspose Unggul. Ubah PRN menjadi TSV dengan cepat dan mudah menggunakan Aspose.Cells. Java PRN menjadi TSV. Java Simpan PRN ke TSV. Simpan PRN sebagai TSV menggunakan Java.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi PRN menjadi TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi PRN menjadi TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke TSV secara terprogram? Pengembang Java dapat dengan mudah mengonversi PRN menjadi TSV hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk mengonversi PRN menjadi TSV" %}}
{{% blocks/products/pf/agp/text %}}
