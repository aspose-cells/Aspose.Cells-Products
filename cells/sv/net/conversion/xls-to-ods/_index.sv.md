---
title: C# XLS till ODS - XLS till ODS Omvandlare
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till ODS-format, vilket möjliggör sömlös sparning av XLS-data till ODS-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till ODS i C#" %}}

Följande exempel visar hur man konverterar XLS till ODS i C#.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att konvertera XLS till ODS. Ladda upp din XLS-fil och spara den sedan som ODS-fil. För både XLS läsning och ODS skrivning kan du använda fullt kvalificerade filnamn. Utdata ODS innehåll och formatering kommer att vara identisk med originaldokumentet XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exempelkod för att konvertera XLS till ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till ODS programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till ODS på bara några rader kod.
...
1.  Konvertera XLS till ODS genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet från XLS till ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-biblioteket för att konvertera XLS till ODS" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/xls-to-html/" name="XLS TILL HTML" description="Hypertext Markup Language" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/xls-to-md/" name="XLS TILL MD" description="Markdown-språk" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/xls-to-ods/" name="XLS TILL ODS" description="OpenDocument-kalkylbladsfil" >}}
