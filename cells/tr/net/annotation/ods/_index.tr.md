---
title:  Ekle veya Kaldır ODS Ek Açıklama via .NET
weight: 7990
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında ODS biçim ek açıklamalarını eklemek ve silmek için C# kaynak kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="ODS\'den C#\'e Ek Açıklama Ekleme veya Silme" %}}
...
{{% blocks/products/pf/agp/code-block title="ODS - C#\'den Ek Açıklamaları Sil" offSpacer="" %}}
