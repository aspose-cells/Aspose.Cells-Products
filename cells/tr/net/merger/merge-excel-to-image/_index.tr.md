---
title: EXCEL'i IMAGE ile Birleştir - C#'de EXCEL'i IMAGE ile Birleştirin
url: /tr/net/merger/merge-excel-to-image/ 
description: Aspose Excel'de. C# Aspose.Cells. EXCEL'i IMAGE kaydetme biçimiyle birleştirin. C# EXCEL'i IMAGE formatıyla birleştirin. C#'de EXCEL'i IMAGE ile birleştir. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="C#\'de EXCEL\'i IMAGE ile birleştir" %}}
...
{{% cells-merger title="C#\'de EXCEL\'i IMAGE ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C# aracılığıyla EXCEL\'i IMAGE ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i IMAGE ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i IMAGE ile birleştirmek için .NET kütüphane" %}}
