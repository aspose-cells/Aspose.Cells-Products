---
title: Převést CSV na TSV prostřednictvím Java 
weight: 5500

description: Ukázkový konverzní kód Java pro formát CSV na soubor TSV. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do TSV v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést CSV na TSV prostřednictvím Java" h2="Převod CSV na TSV Java pro převod jedné nebo více stránek na TSV pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na TSV pomocí Java" %}}

 K vykreslení CSV do TSV použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu CSV na TSV prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na TSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením TSV a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor TSV
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na TSV Java" offSpacer="" %}}
