...
url: /tr/net/merger/merge-xltm-to-spreadsheetml/ 
...
Aşağıdaki örnek, XLTM'in SPREADSHEETML ile Aspose.Cells for .NET'de nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLTM'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i SPREADSHEETML ile birleştirmek için .NET kitaplığı" %}}
