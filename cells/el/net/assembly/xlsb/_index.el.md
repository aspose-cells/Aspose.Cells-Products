...
{{% blocks/products/pf/agp/content h2="Πώς να δημιουργήσετε αναφορές που βασίζονται στο XLSB χρησιμοποιώντας το C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα συναρμολόγησης XLSB μέσω C#" %}}
...
1. Αποθήκευση αποτελέσματος σε μορφή XLSB μέσω της μεθόδου WorkbookDesigner.Worbook.Save
