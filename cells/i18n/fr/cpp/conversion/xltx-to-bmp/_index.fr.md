---
title: Convertir XLTX en BMP via l'application C++ 
url: /fr/cpp/conversion/xltx-to-bmp/ 
description: Exemple de code de conversion C++ pour le document XLTX au format BMP. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLTX en BMP dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLTX en BMP via C++" h2="Conversion XLTX vers BMP haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLTX en BMP en utilisant C++" %}}

 Afin de convertir XLTX en BMP, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLTX en BMP via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier XLTX en BMP en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLTX à l'aide de Factory :: CreateIWorkbook.1. Sélectionnez la première feuille de calcul.1. Définir les options (BMP).1. Parcourez chaque page de la feuille et effectuez le rendu.1. Ouvrez le fichier BMP dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLTX vers BMP C++" offSpacer="" %}}
