...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar FODS met Aspose.Cells. PHP OTS naar FODS. PHP Bewaar OTS naar FODS. Sla OTS op als FODS met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar FODS te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar FODS converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar FODS in slechts een paar regels code.
...
1.  Converteer OTS naar FODS door de opslagmethode van Workbook aan te roepen.
