---
title: Combinar XLTX a ODS - Combinar XLTX a ODS en C#
url: /es/net/merger/merge-xltx-to-ods/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea XLTX a ODS guardar formato. C# Combina el formato XLTX con el ODS. Combinar XLTX a ODS en C#. XLTX Combinar.
...
El siguiente ejemplo muestra cómo combinar XLTX con ODS en Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis en línea para fusionar XLTX a ODS en C#" InputFormat="xltx" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLTX a ODS a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLTX con ODS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
