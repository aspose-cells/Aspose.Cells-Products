---
title: PHP EXCEL в PRN - Конвертер EXCEL в PRN
description: Aspose Эксель. Конвертируйте EXCEL в PRN быстро и легко с помощью Aspose.Cells. PHP EXCEL в PRN. PHP Сохранить EXCEL в PRN. Сохраните EXCEL как PRN, используя PHP.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать EXCEL в PRN через PHP" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно конвертировать файлы EXCEL в PRN? Разработчики PHP могут легко загрузить и преобразовать EXCEL в PRN всего за несколько строк кода.
...
1.  Преобразуйте EXCEL в PRN, вызвав метод сохранения книги.
1.  Получите результат конвертации EXCEL в PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования EXCEL в PRN" %}}
