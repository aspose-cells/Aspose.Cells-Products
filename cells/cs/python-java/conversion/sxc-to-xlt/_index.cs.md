---
title: Převést SXC na XLT přes Python

description: Ukázkový kód pro převod sxc na xlt Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na xlt v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na XLT pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod SXC na XLT přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na XLT pomocí několika řádků kódu.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlt" IsLandingPage="true" language="python" %}}
