---
title: PHP JPG إلى MHT - محول JPG إلى MHT
description: Aspose اكسل. قم بتحويل JPG إلى MHT بسرعة وسهولة باستخدام Aspose.Cells. PHP JPG إلى MHT. PHP حفظ JPG إلى MHT. احفظ JPG بتنسيق MHT باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JPG إلى MHT عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات JPG إلى MHT برمجياً؟ يمكن لمطوري PHP تحميل وتحويل JPG إلى MHT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل JPG إلى MHT عن طريق استدعاء طريقة حفظ المصنف.
1.  احصل على نتيجة تحويل JPG إلى MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة PHP لتحويل JPG إلى MHT" %}}
