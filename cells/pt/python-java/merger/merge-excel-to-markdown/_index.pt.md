...
O exemplo a seguir demonstra como mesclar EXCEL para MARKDOWN em Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Precisa mesclar o EXCEL para MARKDOWN programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) As APIs podem ser feitas com apenas algumas linhas de código.
