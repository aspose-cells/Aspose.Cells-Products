---
title: C# XLS ถึง DOCX - ออนไลน์ XLS ถึง DOCX Converter
description: Aspose เก่ง. C# Aspose.Cells C# Aspose Cells ออนไลน์ฟรี C# แปลง XLS เป็น DOCX บันทึกรูปแบบ รูปแบบ C# XLS ถึง DOCX บันทึก XLS ถึง DOCX C#
...
{{< blocks/products/pf/i18n/upper-banner h1="แปลง XLS เป็น DOCX ใน C#" h2="ไลบรารี C# ความเร็วสูงสำหรับการแปลง XLS เป็น DOCX นี่เป็นโซลูชันซอฟต์แวร์ระดับมืออาชีพสำหรับนำเข้าและส่งออก XLS, DOCX และรูปแบบอื่นๆ อีกมากมายบน .NET Framework, .NET Core หรือ Mono Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ถึง DOCX ใน C# ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLS เป็น DOCX ใน C#
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อแปลง XLS เป็น DOCX อัปโหลดไฟล์ XLS ของคุณ จากนั้นบันทึกเป็นไฟล์ DOCX สำหรับทั้งการอ่าน XLS และการเขียน DOCX คุณสามารถใช้ชื่อไฟล์แบบเต็มได้ เนื้อหาและการจัดรูปแบบเอาต์พุต DOCX จะเหมือนกับเอกสารต้นฉบับ XLS

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="แอพฟรีและโค้ดตัวอย่างเพื่อแปลง XLS เป็น DOCX ออนไลน์" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="docx" IsLandingPage="true" %}}
...
1.  แปลง XLS เป็น DOCX โดยเรียกวิธี Workbook.Save
1.  รับผลการแปลงของ XLS เป็น DOCX
