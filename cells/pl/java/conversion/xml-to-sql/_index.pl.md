---
title: Java XML na SQL - Konwerter XML na SQL
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XML do formatu SQL, umożliwiając bezproblemowe zapisywanie danych XML w formacie SQL za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML do SQL w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na SQL w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XML na SQL. Prześlij plik XML, a następnie po prostu zapisz go jako plik SQL. Zarówno do odczytu XML, jak i zapisu SQL, można używać w pełni kwalifikowanych nazw plików. Wyjściowa treść i formatowanie SQL będą identyczne z oryginalnym dokumentem XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XML na SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xml" outformat="sql" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XML na SQL? Programiści Java mogą łatwo przekonwertować pliki XML na SQL za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XML na SQL, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XML na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XML na SQL" %}}
{{% blocks/products/pf/agp/text %}}
