---
title: Java를 통해 HTML을 JSON으로 변환 
weight: 9560
url: /ko/java/conversion/html-to-json/ 
description: HTML 형식을 JSON 파일로 변환하는 샘플 Java 변환 코드. 프로그래머는 이 예제 코드를 사용하여 Excel 및 OpenOffice 스프레드시트를 웹 또는 데스크톱 Java 기반 애플리케이션 내에서 JSON으로 내보낼 수 있습니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java를 통해 HTML을 JSON으로 변환" h2="온프레미스 Java 라이브러리를 사용하여 단일 또는 여러 페이지를 JSON으로 변환하는 HTML에서 JSON Java으로 변환" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 HTML을 JSON으로 변환하는 방법" %}}

 HTML을 JSON으로 렌더링하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java을 통해 HTML을 JSON으로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Java 개발자는 몇 줄의 코드로 HTML 파일을 JSON으로 쉽게 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. Workbook 클래스의 인스턴스로 HTML 파일 로드1. Cells.createRange 메소드를 사용하여 내보낼 데이터 범위 생성1. Range 및 ExportRangeToJsonOptions에 대한 참조로 JsonUtility.exportRangeToJson 메서드를 호출합니다.1. BufferedWriter.write 메서드를 통해 문자열 JSON 데이터를 파일에 씁니다.
...
{{% blocks/products/pf/agp/text %}}
 ...
 예제 소스 코드를 실행하기 전에 다음 전제 조건이 있는지 확인하십시오.
...
{{% blocks/products/pf/agp/code-block title="HTML에서 JSON으로 Java 변환 소스 코드" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="HTML에서 JSON으로 변환 라이브 데모" sectionDescription="[HTML을 JSON으로 변환](https://products.aspose.app/cells/conversion/html-to-json) 지금 바로 라이브 데모 웹사이트를 방문하세요. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API을(를) 다운로드할 필요가 없습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 코드를 작성할 필요가 없습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" HTML 파일을 업로드하기만 하면 즉시 JSON으로 변환됩니다." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/conversion/html-to-xls/" name="HTML에서 XLS로" description="Excel 이진 형식" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/conversion/html-to-xlsb/" name="HTML에서 XLSB로" description="이진 Excel 통합 문서 파일" >}}
