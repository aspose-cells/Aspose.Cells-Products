---
title:  Inserir frases de destaque no Excel via C++
weight: 810
description: C++ código de exemplo para inserir chamadas no arquivo Excel em C++ Ambiente de tempo de execução para Windows 32 bits, Windows 64 bits e Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserir frases de destaque no Excel via C++" h2="Insira objetos usando o nativo e alto desempenho do lado do servidor Aspose.Cells for C++ API sem usar nenhum software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir frases de destaque no arquivo do Excel usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir chamadas no arquivo Excel via C++" %}}
...
Visão geral dos tipos de chamada
 ...
 AutoFormaTipo::<br>AutoShapeType_RectangularCallout
    </p>
   </div>
   <div class="col-lg-4">
 ...
 AutoFormaTipo::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 AutoFormaTipo::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar3
    </p>
   </div>
  </div>
 </div>
