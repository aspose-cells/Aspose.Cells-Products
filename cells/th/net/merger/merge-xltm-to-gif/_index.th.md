---
title: รวม XLTM ถึง GIF - รวม XLTM ถึง GIF ใน C#
url: /th/net/merger/merge-xltm-to-gif/ 
description: Aspose เอ็กเซล. C# Aspose.Cells รวม XLTM เป็น GIF บันทึกฟอร์แมต C# รวมรูปแบบ XLTM ถึง GIF รวม XLTM ถึง GIF เข้า C# XLTM รวม.
...
{{% blocks/products/pf/agp/content h2="รวม XLTM ถึง GIF ใน C#" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLTM ถึง GIF ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม XLTM ถึง GIF อัปโหลดไฟล์ของคุณ เรียกวิธี Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ GIF หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่รวม XLTM กับ GIF

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="โค้ดตัวอย่างที่จะรวม XLTM ถึง GIF ใน C#" InputFormat="xltm" InputFormat2="gif" outformat="gif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวม XLTM ถึง GIF ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม XLTM กับ GIF โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ห้องสมุดรวม XLTM เป็น GIF" %}}
