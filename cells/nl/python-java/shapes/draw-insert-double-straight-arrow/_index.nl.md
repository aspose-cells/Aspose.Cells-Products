---
title:  Hoe teken of voeg ik een dubbele rechte pijl in Excel in met Java Python via
weight: 10
...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg een dubbele rechte pijl in Excel in met Java Python via" h2="Voeg een dubbele rechte pijl in met Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een dubbele rechte pijl in een Excel-bestand kunt invoegen met Java Python via" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het invoegen van een dubbele rechte pijl in een Excel-bestand met Java Python via" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de vormcollecties[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) om een dubbele rechte pijl in het geselecteerde werkblad in te voegen.
