...
description: Aspose Excel。 Java Aspose.Cells。將 CSV 合併到 IMAGE 儲存格式。 Java 將 CSV 合併為 IMAGE 格式。將 CSV 合併到 Java 中的 IMAGE。CSV 合併。
keywords: [Aspose Excel., Java Aspose.Cells., Merge CSV to IMAGE in Java., Java Merge CSV to image., Java Combine CSV to IMAGE., CSV Merge]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合併 CSV 到 IMAGE via Java" h2="高速 Java 庫，用於將 CSV 合併到 IMAGE。使用我們的Excel轉換API在Java中開發高級、平台無關的軟體。這是導入和導出Excel, CSV, OpenOffice, PDF, HTML, image以及許多其他Excel格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="CSV" additionalConversionTag="IMAGE" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
如何將 CSV 合併到 IMAGE？使用 Aspose.Cells for Java 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 CSV 合併到 IMAGE。[Aspose.Cells for Java](https://products.aspose.com/cells/java)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Java Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。您可以直接從以下位置下載其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)並透過將以下配置新增至 pom.xml 將其安裝在基於 Maven 的專案中。
...
{{% blocks/products/pf/agp/content h2="將 CSV 合併到 Java 中的 IMAGE" %}}

以下範例示範如何將 CSV 合併到 Aspose.Cells for Java 中的 IMAGE。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 CSV 合併到 IMAGE。上傳文件，呼叫Workbook.Combine方法合併文件，然後儲存為IMAGE文件。如果您在 Java 中開發程式碼，這會比聽起來更簡單。請參閱 Java 將 CSV 合併到 IMAGE 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 CSV 合併到 Java 中的 IMAGE 的範例程式碼" InputFormat="csv" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 CSV 合併到 IMAGE via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 CSV 合併到 IMAGE 嗎？基本文檔合併和連接[Aspose.Cells for Java](https://products.aspose.com/cells/java)只需幾行程式碼即可完成 API。
