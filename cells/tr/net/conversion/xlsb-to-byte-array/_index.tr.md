---
title:  XLSB'i C# yoluyla Bayt Dizisine dönüştürün
weight: 7690
description: C# XLSB'den Byte Array'e dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulamada Excel XLSB'den Bayt Dizisine dönüştürme için bu kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB\'i C# aracılığıyla bayt dizisine dönüştürün" h2="Yerel ve yüksek performanslı Microsoft Excel XLSB\'den bayt dizisine dönüştürme veya tam tersi, sunucu tarafı .NET API\'lerini kullanarak elektronik tablo veri işleme için." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Bayt Dizisi, veri işleme veya depolama için yararlıdır. XLSB dosyasını Byte Array'e dönüştürebileceğiniz gibi,**Bayt Dizisi - XLSB**C# dilini kullanan belge. XLSB'i bayt dizisine dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB, C# aracılığıyla Bayt Dizisine Nasıl Dönüştürülür?" %}}

{{% blocks/products/pf/agp/text %}}

 Geliştiricilerin, yalnızca birkaç satır kodla daha fazla manipülasyon görevi için XLSB dosyalarını yükleyip bayt dizisine dönüştürmesi kolaydır.

{{% /blocks/products/pf/agp/text %}}

1.  Ad alanını sınıf dosyanıza dahil edin
1.  Çalışma Kitabını kullanarak XLSB Dosya girişini yükle
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, XLSB\'i bayt dizisine C# Dönüşümü olarak gösterir." offSpacer="" %}}
