---
title: Gộp JPG sang PRN - Gộp JPG sang PRN in Java
url: /vi/java/merger/merge-jpg-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí định dạng lưu JPG sang PRN. Java Gộp định dạng JPG sang PRN. Hợp nhất JPG sang PRN trong Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất JPG sang PRN trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất JPG sang PRN trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất JPG sang PRN. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp PRN. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất JPG với PRN.
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất JPG sang PRN via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Java thư viện để hợp nhất JPG sang PRN" %}}
