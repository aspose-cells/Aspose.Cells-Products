---
title: Bescherm en vergrendel ODS-document via C++ 
weight: 10010
url: /nl/cpp/protect/ods/ 
description: C++ voorbeeldcode om ODS-bestand te vergrendelen met wachtwoord op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Versleutel ODS-bestanden via C++" h2="Beveilig Excel-spreadsheets met een wachtwoord, inclusief ODS-indeling, met behulp van .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe een ODS-bestand te beveiligen met C++" %}}
...
1. Laad het ODS-bestand met de IWorkbook-klasse1. Gebruik de methode Protect(..) met ProtectionType en Password1. Sla het beveiligde ODS-bestand op met de methode Save()
