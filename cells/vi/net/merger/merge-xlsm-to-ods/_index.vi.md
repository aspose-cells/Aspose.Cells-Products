---
title: Hợp nhất XLSM thành ODS - Hợp nhất XLSM thành ODS thành C#
url: /vi/net/merger/merge-xlsm-to-ods/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí XLSM thành ODS saveformat. C# Kết hợp định dạng XLSM thành ODS. Hợp nhất XLSM thành ODS thành C#. XLSM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLSM thành ODS trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất XLSM thành ODS trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất XLSM thành ODS. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp ODS. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất XLSM thành ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Hợp nhất trực tuyến miễn phí XLSM thành ODS trong C#" InputFormat="xlsm" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XLSM thành ODS qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất XLSM thành ODS theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất XLSM thành ODS" %}}
