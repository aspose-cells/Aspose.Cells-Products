---
title: EXCEL'i EXCEL ile birleştir - Java'de EXCEL'i EXCEL ile birleştir
url: /tr/java/merger/merge-excel-to-excel/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i EXCEL kaydetme biçimiyle birleştirin. Java EXCEL'i EXCEL formatıyla birleştirin. Java'de EXCEL'i EXCEL ile birleştir. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i EXCEL ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de EXCEL'in EXCEL ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i EXCEL ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından EXCEL dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. EXCEL'i EXCEL ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java\'de EXCEL\'i EXCEL ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i EXCEL\'e Nasıl Birleştiririm via Java" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i EXCEL ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java EXCEL\'i EXCEL ile birleştirmek için kütüphane" %}}
