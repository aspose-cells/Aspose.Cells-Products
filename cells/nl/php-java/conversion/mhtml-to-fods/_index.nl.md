...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar FODS met Aspose.Cells. PHP MHTML naar FODS. PHP Bewaar MHTML naar FODS. Sla MHTML op als FODS met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar FODS te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar FODS converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar FODS.
...
1.  Converteer MHTML naar FODS door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van MHTML naar FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om MHTML naar FODS te converteren" %}}
