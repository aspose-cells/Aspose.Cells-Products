---
title: Python via Java kullanarak Denklem Şekillerini Excel'e ekleyin
weight: 360
description: Denklem Şekillerini Excel'e eklemek için Python via Java kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java kullanarak Denklem Şekillerini Excel\'e ekleyin" h2="Aspose.Cells\' API kullanarak, Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım olmadan Denklem Şekilleri ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java Kullanarak Denklem Şekillerini Excel Dosyasına Ekleme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java kullanarak Denklem Şekillerini Excel dosyasına ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfası'nı seçin.
 + Kullanın[yöntem ekle](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) seçili çalışma sayfasına Denklem Şekilleri eklemek için
