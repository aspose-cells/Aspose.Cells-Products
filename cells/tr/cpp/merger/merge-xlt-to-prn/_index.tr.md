---
title: XLT'i PRN ile birleştir - XLT'i C++'de PRN ile birleştir
url: /tr/cpp/merger/merge-xlt-to-prn/ 
description: Aspose excel. C++ Aspose.Cells. XLT'i PRN saveformat'a Ücretsiz Çevrimiçi Birleştirme. C++ XLT'i PRN formatına birleştirin. XLT'i C++'de PRN ile birleştir. XLT Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLT\'i C++ Online\'da PRN ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, XLT'in Aspose.Cells for C++'de PRN ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

XLT'i PRN ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından PRN dosyasına kaydedin. C++'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. XLT'i PRN ile birleştiren C++ örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="XLT\'i C++\'de PRN ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xlt" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLT\'i C++ aracılığıyla PRN\'ye Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLT'i programlı olarak PRN ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLT\'i PRN ile birleştirmek için C++ kitaplığı" %}}
