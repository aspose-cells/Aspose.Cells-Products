---
title: EXCEL'i POWERPOINT ile birleştir - C#'de EXCEL'i POWERPOINT ile birleştir
url: /tr/net/merger/merge-excel-to-powerpoint/ 
description: Aspose Excel'de. C# Aspose.Cells. EXCEL'i POWERPOINT kaydetme biçimiyle birleştirin. C# EXCEL'i POWERPOINT biçimiyle birleştirin. C#'de EXCEL'i POWERPOINT ile birleştirin. EXCEL Birleştirin.
...
{{% blocks/products/pf/agp/content h2="C#\'de EXCEL\'i POWERPOINT ile birleştir" %}}
...
{{% cells-merger title="C#\'de EXCEL\'i POWERPOINT ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C# aracılığıyla POWERPOINT\'e nasıl birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL'i POWERPOINT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
