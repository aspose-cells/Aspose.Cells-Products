...
description: Aspose Excel. Konvertálja gyorsan és egyszerűen EXCEL-t DIF-re a Aspose.Cells-es számmal. C# EXCEL DIF-re. C# Mentse az EXCEL-t DIF-re. Mentse az EXCEL-t DIF-es számra. Mentse az EXCEL-t 38123481-es számmal 07613817-ként.
...
{{% blocks/products/pf/agp/content h2="EXCEL mentése a DIF-es számra a C#-ben" %}}

A következő példa bemutatja, hogyan lehet EXCEL-t DIF-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód az EXCEL DIF-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="dif" IsLandingPage="true" %}}
