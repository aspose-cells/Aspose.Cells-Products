---
title: Combinar archivos TXT a través de Java 
weight: 4480
url: /es/java/merger/txt/ 
description: Java código de ejemplo para combinar documentos TXT en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos TXT en Java" h2="Fusión de documentos TXT nativos utilizando las API Java del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
+ guardar el archivo TXT fusionado en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Combinar archivos TXT - Java" offSpacer="" %}}

```cs
// Abra el primer archivo TXT.
Workbook txtFile1 = new Workbook("chartsFileWithPath.txt");

// Defina el segundo libro fuente.
// Abra el segundo archivo TXT.
