...
weight: 4010
description: Codice sorgente C# per estrarre testo e immagini dal file XLSM su piattaforme .NET Framework, .NET Core, Mono o Xamarin.
...
{{% blocks/products/pf/agp/content h2="Come analizzare il file XLSM utilizzando C#" %}}
 ...
 Per analizzare il file XLSM, utilizzeremo[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API che è una manipolazione di documenti ricca di funzionalità, potente e facile da usare API per la piattaforma C#. Aprire[NuGet](https://www.nuget.org/packages/aspose.cells) gestore pacchetti, cerca
