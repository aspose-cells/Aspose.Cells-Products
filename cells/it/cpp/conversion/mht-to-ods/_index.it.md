...
Hai bisogno di convertire i file MHT in ODS tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in ODS in poche righe di codice.
...
1.  Convertire MHT in ODS chiamando il metodo Save().
