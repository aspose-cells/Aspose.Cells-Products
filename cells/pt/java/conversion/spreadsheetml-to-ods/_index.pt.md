---
title: Java SPREADSHEETML para ODS - Conversor de PLANILHA Online para ODS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Online Grátis Java Converta SPREADSHEETML para ODS saveformat. Java SPREADSHEETML para o formato ODS. Salve SPREADSHEETML para ODS Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter SPREADSHEETML para ODS em Java" h2="Biblioteca Java de alta velocidade para converter SPREADSHEETML em ODS. Esta é uma solução de software profissional para importar e exportar SPREADSHEETML, ODS e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salve SPREADSHEETML em ODS em Java online gratuitamente" %}}

O exemplo a seguir demonstra como converter SPREADSHEETML para ODS em Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter SPREADSHEETML para ODS. Carregue seu arquivo SPREADSHEETML e simplesmente salve-o como arquivo ODS. Tanto para leitura SPREADSHEETML quanto para escrita ODS, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída ODS serão idênticos ao documento SPREADSHEETML original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter SPREADSHEETML para ODS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter SPREADSHEETML para ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SPREADSHEETML para ODS programaticamente? Java desenvolvedores podem facilmente converter SPREADSHEETML para ODS em apenas algumas linhas de código.
...
1.  Converta SPREADSHEETML para ODS chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de SPREADSHEETML para ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteca para converter SPREADSHEETML para ODS" %}}
{{% blocks/products/pf/agp/text %}}
