...
{{% blocks/products/pf/agp/content h2="Come creare XLTX tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 È facile per gli sviluppatori creare, caricare, modificare e convertire il foglio di calcolo MS Excel XLTX all'interno dell'esecuzione di diverse applicazioni di reporting per l'elaborazione dei dati in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Codice di esempio per creare un file MS Excel XLTX utilizzando C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# libreria per creare il file XLTX" %}}
