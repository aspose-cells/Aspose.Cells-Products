---
title:  أدخل المستطيل في Excel via Java
weight: 50
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج مستطيل في ملف إكسل باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج مستطيل في ملف اكسيل via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addRectangle-int-int-int-int-int-int-)لإدراج مستطيل في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل المستطيل - Java" offSpacer="" %}}
