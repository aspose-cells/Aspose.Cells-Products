...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in XLAM in Java" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar XLAM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLTM om naar XLAM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLTM programmatisch converteren naar XLAM? Ontwikkelaars van Java kunnen bestanden met de extensie XLTM eenvoudig converteren naar XLAM met slechts een paar regels code.
