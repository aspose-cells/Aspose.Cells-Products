...
url: /nl/python-java/merger/merge-xls-to-png/ 
...
Het volgende voorbeeld laat zien hoe u XLS kunt samenvoegen met PNG in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLS programmatisch samenvoegen tot PNG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
