...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj kolekcji zdjęć[dodaj metodę](https://reference.aspose.com/cells/java/com.aspose.cells/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)), aby wstawić obraz w wybranym arkuszu.
