...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLT na MHTML przez Java" h2="Konwersja XLT do MHTML Java w celu konwersji jednej lub wielu stron do MHTML przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na MHTML za pomocą Java" %}}

 Aby renderować XLT do MHTML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na MHTML za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik XLT na MHTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem MHTML i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę wynikowego pliku MHTML
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLT do MHTML Java" offSpacer="" %}}

```cs
// załaduj plik XLT w instancji Workbook
Workbook book = new Workbook("template.xlt");
// zapisz XLT jako MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją XLT do MHTML" sectionDescription="[Konwertuj XLT na MHTML](https://products.aspose.app/cells/conversion/xlt-to-mhtml) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLT, zostanie on natychmiast przekonwertowany na MHTML." >}}
