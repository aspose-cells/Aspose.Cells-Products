...
description: Aspose Exceller. Python Aspose.Cells. Fusionner XML au format de sauvegarde PRN. Python Combinez XML au format PRN. Fusionner XML avec PRN dans Python. Fusion XML.
...
{{% blocks/products/pf/agp/content h2="Fusionner XML avec PRN à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner XML avec PRN dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner XML avec PRN dans Python" InputFormat="xml" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XML avec PRN via Python" %}}
