...
{{% blocks/products/pf/agp/content h2="Converteer XLSX naar TXT in Python" %}}
...
Het volgende voorbeeld laat zien hoe u XLSX converteert naar TXT in Python via NET.
