...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке формы двойной стрелки локтя в файл Excel с помощью Python via.Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)чтобы вставить фигуру двойной стрелки локтя на выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка колена в форме двойной стрелки - Python via .Net" offSpacer="" %}}
