...
+ インデックスからワークシートを選択します。
 + シェイプコレクションの使用[メソッドの追加](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)選択したワークシートにボタン (フォーム コントロール) を挿入します。
