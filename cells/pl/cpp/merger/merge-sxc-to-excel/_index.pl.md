---
title: Połącz SXC z EXCEL - Połącz SXC z EXCEL w C++
url: /pl/cpp/merger/merge-sxc-to-excel/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online SXC do formatu zapisu EXCEL. C++ Połącz SXC do formatu EXCEL. Połącz SXC z EXCEL w C++. SXC Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz SXC z EXCEL w C++ online za darmo" %}}

Poniższy przykład pokazuje, jak scalić SXC z EXCEL w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć SXC z EXCEL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku EXCEL. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy SXC z programem EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online SXC z EXCEL w C++" InputFormat="sxc" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić SXC z EXCEL przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić numer SXC z programem EXCEL? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia SXC z programem EXCEL" %}}
