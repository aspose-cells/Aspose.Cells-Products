---
title: 無需通過 C++ 打開即可搜索 TSV 文檔 
weight: 930
url: /zh-hant/cpp/search/tsv/ 
description: C++ 示例代碼，用於在 Windows 32 位、Windows 64 位和 Linux 64 位的 C++ 運行時環境中搜索 TSV 文件中的模式。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C++ 中搜索 TSV 格式" h2="使用用於 C++ API 的服務器端 Aspose.Cells 進行本機和高性能 TSV 文檔搜索，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
