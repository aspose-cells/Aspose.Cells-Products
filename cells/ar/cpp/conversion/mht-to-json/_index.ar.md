---
title: تحويل C++ MHT إلى JSON - تحويل MHT إلى JSON
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل MHT إلى تنسيق JSON، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق JSON باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى JSON في C++" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى JSON برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى JSON بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى JSON عن طريق استدعاء دالة Save().
