...
weight: 5590
description: C# ซอร์สโค้ดเพื่อแก้ไขหรือดู XLSM รูปแบบข้อมูลเมตาบน .NET Framework, .NET Core, Mono หรือแพลตฟอร์ม Xamarin
...
+ โหลด XLSM พร้อมอินสแตนซ์ของสมุดงาน
