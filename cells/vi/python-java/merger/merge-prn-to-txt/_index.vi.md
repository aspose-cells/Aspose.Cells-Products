---
title:  Hợp nhất PRN thành TXT qua Python
...
Ví dụ sau minh họa cách hợp nhất PRN thành TXT trong Python.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất PRN thành TXT trực tuyến" InputFormat="prn" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
