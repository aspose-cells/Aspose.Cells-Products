---
title: C++ IMAGE to NUMBERS - تحويل الصورة إلى أرقام عبر الإنترنت
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل الصورة إلى أرقام حفظ تنسيق. C++ صورة إلى تنسيق أرقام. احفظ الصورة في أرقام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة إلى أرقام في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى أرقام في C++.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الصورة إلى أرقام عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى أرقام برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى أرقام في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل الصورة إلى أرقام عن طريق استدعاء طريقة Save ().
1.  احصل على نتيجة تحويل IMAGE إلى NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ مكتبة لتحويل الصورة إلى أرقام" %}}
