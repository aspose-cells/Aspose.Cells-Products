...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu HTML do formátu XML, což umožňuje bezproblémové ukládání dat HTML do formátu XML pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převést HTML na XML v Java" h2="Vysokorychlostní knihovna Java pro převod HTML do XML. Jedná se o profesionální softwarové řešení pro import a export HTML, XML a mnoha dalších formátů s použitím Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte HTML do XML pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit HTML do XML v Java" %}}

Následující příklad ukazuje, jak převést kód HTML na XML v kódu Java.
...
Potřebujete programově převést soubory HTML do XML? Vývojáři Java mohou snadno převést soubory HTML do XML pomocí několika řádků kódu.
