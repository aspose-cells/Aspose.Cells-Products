---
title: "XLTM konvertálása TIFF-re a következőn keresztül: C#"
url: /hu/net/conversion/xltm-to-tiff/
description: Mintakód az xltm–tiff C# konverzióhoz. Használjon API példakódot kötegelt xltm fájlokhoz a VB.NET, Asp.NET vagy bármely .NET alapú alkalmazás tiff konverziójához.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLTM konvertálása TIFF-re a következőn keresztül: C#" h2="Exportálja az Excel® táblázatokat TIFF formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják az XLTM fájlokat TIFF formátumba.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTM-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal átadása TIFF kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott TIFF-fájl megadott elérési útját
