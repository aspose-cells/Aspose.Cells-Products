...
description: C++ mã ví dụ để biên tập lại thông tin nhạy cảm trong tệp XLS trên C++ Môi trường thời gian chạy cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Redact XLS Định dạng trong C++" h2="Thông tin phản hồi nhạy cảm với tài liệu XLS gốc và hiệu suất cao bằng cách sử dụng Aspose.Cells phía máy chủ cho C++ API mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chỉnh sửa tệp XLS bằng cách sử dụng C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chỉnh sửa tệp XLS trong C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Redact tệp XLS - C++" offSpacer="" %}}
