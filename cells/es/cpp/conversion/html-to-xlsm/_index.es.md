---
title: Convierta HTML a XLSM a través de la aplicación C++ 
weight: 2120
url: /es/cpp/conversion/html-to-xlsm/ 
description: Ejemplo de código de conversión C++ para documento HTML a formato XLSM. Los programadores pueden usar este código fuente para la conversión por lotes de HTML a XLSM dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo HTML a XLSM con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo HTML usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (XLSM).1. El archivo XLSM se guardará en la ruta especificada.1. Abra el archivo XLSM en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de HTML a XLSM C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de HTML a XLSM" sectionDescription="[Convertir HTML a XLSM](https://products.aspose.app/cells/conversion/html-to-xlsm) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo HTML, se convertirá instantáneamente a XLSM." >}}
