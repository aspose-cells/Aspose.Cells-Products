...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Spreadsheet Android API mendukung format Excel Microsoft yang populer, gambar, dan format tata letak tetap." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Fitur Lanjutan Android Excel API
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
Terapkan pemformatan ke lembar kerja, baris, kolom, sel, dan rentang
 ...
 Konfigurasikan penyiapan halaman
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Atur &amp; memanipulasi filter otomatis &amp; jeda halaman
    </p>
   </div>
   <div class="col-lg-4">
