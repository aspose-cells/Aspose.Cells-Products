...
+ قم بتحميل جميع ملفات XLSB بالمسار الكامل.
+ اصنع مستندًا واحدًا كملف أساسي
+ استدعاء الطريقة المناسبة لدمج ودمج الملفات واحدًا تلو الآخر.
+ استدعاء طريقة Save () ومرر اسم الملف (المسار الكامل) والتنسيق (XLSB) كمعامل.
+ الآن يمكنك فتح واستخدام ملف XLSB في Microsoft Office أو Adobe PDF أو أي برنامج آخر متوافق.
...
{{% blocks/products/pf/agp/code-block title="دمج XLSB الملفات - C#" offSpacer="" %}}
