...
{{% blocks/products/pf/agp/content h2="Como criar ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

É fácil para os desenvolvedores criar, carregar, modificar e converter a planilha ODS (Openoffice / Lbreoffice) executando diferentes aplicativos de relatórios para processamento de dados em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Exemplo de código para criar um arquivo ODS (Openoffice / Lbreoffice) usando C#." offSpacer="" %}}
