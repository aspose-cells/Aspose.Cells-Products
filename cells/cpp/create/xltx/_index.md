---
title: Create XLTX Files via C++ 
weight: 7690
url: /cpp/create/xltx/ 
description: C++ Sample code for generating XLTX Microsoft Excel files. Use this code for creating MS Excel XLTX files within C++ based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Create XLTX File via C++" h2="Native and high performance Microsoft Excel XLTX Spreadsheets creation programmatically without Micorsoft Office using C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Generating MS Excel XLTX file dynamically within running application is easy. In order to create XLTX sheets from scratch having similar result as of New spreadsheet in Microsoft Excel without requiring MS Office, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 It is easy for the developers to creat, load, modify and convert XLTX files within running reporting applications for data processing in just few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a Word XLTX file using C++." offSpacer="" %}}
...
wkb->Save(resultPath->StringAppend(new String("created_one.xltx")));
...
A Document Processing Library to perform a wide range of document creation, management and manipulation tasks including XLTX generation, editing, conversion, rendering and printing. C++ Word library supports all of word-processing formats as well as allows exporting or converting XLTX to PDF, HTML, fixed-layout and most commonly used image & multimedia formats.
