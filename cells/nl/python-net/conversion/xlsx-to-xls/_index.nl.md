---
title: Python XLSX naar XLS - Online XLSX naar XLS Converter
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Gratis online Python Converteer XLSX naar XLS saveformat. Python XLSX tot XLS formaat. Bewaar XLSX tot XLS Python.
...
{{% blocks/products/pf/agp/content h2="Converteer XLSX naar XLS in Python" %}}

 Hoe converteer ik XLSX naar XLS? Met Aspose.Cells for Python via NET bibliotheek, kunt u eenvoudig XLSX converteren naar XLS programmatisch met een paar regels code.[Aspose.Cells for Python via NET](https://pypi.org/project/aspose-cells-python/)is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaard formaten.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Bespaar XLSX tot XLS in Python Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLSX converteert naar XLS in Python via NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSX naar XLS te converteren. Upload uw XLSX-bestand en sla het vervolgens eenvoudig op als XLS-bestand. Voor zowel XLSX lezen als XLS schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De uitvoer XLS inhoud en opmaak zal identiek zijn aan het originele XLSX document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Gratis app en voorbeeldcode om XLSX online naar XLS te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xls" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSX naar XLS te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLSX-bestanden programmatisch converteren naar XLS? Python-ontwikkelaars kunnen eenvoudig XLSX laden en converteren naar XLS in slechts een paar regels code.
...
1.  Converteer XLSX naar XLS door de methode Workbook.save aan te roepen.
1.  Verkrijg het conversieresultaat van XLSX naar XLS.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLSX naar XLS te converteren" %}}
