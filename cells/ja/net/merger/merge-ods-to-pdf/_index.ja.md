...
description: Aspose エクセル。 C# Aspose.Cells。ODS を PDF の保存形式にマージします。 C# ODS と PDF の形式を結合します。 ODS から PDF を C# に結合します。ODS を結合します。
...
{{% cells-merger title="ODS から PDF を C# にマージするサンプルコード" InputFormat="ods" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
