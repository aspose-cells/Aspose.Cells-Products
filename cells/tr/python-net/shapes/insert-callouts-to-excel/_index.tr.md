---
title: Python via .Net'i kullanarak Bilgileri Excel'e Ekleyin
weight: 360
description: Python via .Net kaynak kodu, Bilgileri Excel'e eklemek için.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via .Net\'i kullanarak Bilgileri Excel\'e Ekleyin" h2="Aspose.Cells\' API\'i kullanarak, Microsoft veya Open Office, Adobe PDF, vb. gibi herhangi bir yazılım olmadan Açıklamalar ekleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via .Net Kullanarak Excel Dosyasına Açıklama Metinleri Nasıl Eklenir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net kullanarak Açıklamaları Excel dosyasına ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfası'nı seçin.
 + Shapecollection'ın eklentisini kullanın[yöntem](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) Seçili çalışma sayfasına Açıklama Metinleri eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Bilgileri Ekle - Python via .Net" offSpacer="" %}}
...
Bilgi Türlerine Genel Bakış
 ...
 Otomatik Şekil Türü.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12" style="font-size:0.8rem !important;">
 Otomatik Şekil Türü.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR3
    </p>
   </div>
  </div>
 </div>
