...
Het volgende voorbeeld laat zien hoe u XLSM samenvoegt met MHT in Aspose.Cells for Python via .NET.
...
Wilt u XLSM programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
