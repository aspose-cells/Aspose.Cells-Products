...
weight: 8760
url: /fr/cpp/protect/xls/ 
description: C++ exemple de code pour verrouiller le fichier XLS à l'aide d'un mot de passe sur l'C++ environnement d'exécution pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
...
{{% blocks/products/pf/agp/content h2="Comment sécuriser un fichier XLS à l\'aide de C++" %}}
...
1. Charger le fichier XLS à l'aide de la classe IWorkbook1. Utiliser la méthode Protect(..) avec ProtectionType et Password1. Enregistrez le fichier XLS protégé par la méthode Save ()
