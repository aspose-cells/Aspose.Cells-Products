...
description: Aspose Excel. Python Aspose.Cells. A XLS egyesítése POWERPOINT mentési formátumba. Python A XLS kombinálása POWERPOINT formátumba. A XLS egyesítése a Python-es POWERPOINT-tal. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A XLS egyesítése a Python-es POWERPOINT-tal" %}}
...
{{% cells-merger title="Mintakód a XLS egyesítéséhez a Python-es POWERPOINT-hoz" InputFormat="xls" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLS és a POWERPOINT egyesítése a Python számon keresztül" %}}
