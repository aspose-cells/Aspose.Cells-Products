---
title: إنشاء أرقام - إنشاء ملف أرقام في Java
description: Aspose إكسل. Java إنشاء ملف أرقام. قم بإنشاء أرقام Java. Java أرقام مُعدّلة. قم بإنشاء NUMBERS في Java. قم بإنشاء ملف NUMBERS باستخدام Java.
...
1.  احفظ المصنف بتنسيق NUMBERS باستخدام طريقة الحفظ ().
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتكوين ملف NUMBERS" %}}
{{% blocks/products/pf/agp/text %}}
