...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer WordArt dans un fichier Excel à l\'aide de Python via .Net" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_word_art/#PresetWordArtStyle-str-int-int-int-int-int-int) pour insérer un WordArt dans la feuille de calcul sélectionnée.
