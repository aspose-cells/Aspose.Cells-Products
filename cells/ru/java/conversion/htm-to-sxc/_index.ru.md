...
{{% blocks/products/pf/agp/content h2="Преобразовать HTM в SXC, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM-код в SXC в Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в SXC в Java.
...
Нужно программно преобразовать HTM-файлы в формат SXC? Разработчики, использующие формат Java, могут легко преобразовать HTM в формат SXC всего несколькими строками кода.
