---
title: C++ XML в XPS - Конвертер XML в XPS
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в XPS в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат XPS в формате C++.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XML в XPS через C++" %}}
...
1.  Преобразовать XML в формат XPS, вызвав метод Save().
