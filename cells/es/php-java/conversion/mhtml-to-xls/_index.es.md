---
title: Convertidor de PHP MHTML a XLS - MHTML a XLS
description: Aspose Excel. Esta solución integral ofrece a los desarrolladores PHP un enfoque totalmente integrado para convertir el formato MHTML al XLS, lo que permite guardar sin problemas los datos del MHTML al formato XLS mediante la biblioteca Aspose.Cells, todo mediante código PHP eficiente y personalizable.
...
¿Necesitas convertir archivos MHTML a XLS mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente archivos MHTML a XLS con solo unas pocas líneas de código.
...
1.  Convierta MHTML a XLS llamando al método de guardado del libro de trabajo.
