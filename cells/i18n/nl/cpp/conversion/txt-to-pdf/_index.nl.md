...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer TXT naar PDF via C++" h2="Hoogwaardige conversie van TXT naar PDF met behulp van de C++-bibliotheek zonder dat Microsoft Excel, OpenOffice of Adobe Acrobat hoeft te worden geïnstalleerd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen TXT-bestanden gemakkelijk converteren naar PDF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad TXT-bestand met behulp van Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (PDF) bestandsextensie.1. PDF-bestand wordt opgeslagen op het opgegeven pad.1. Open het PDF-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="TXT naar PDF C++ Conversiebroncode" offSpacer="" %}}
