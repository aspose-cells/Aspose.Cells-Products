---
title:  Sloučit CSV na XLSB přes C++
...
Následující příklad ukazuje, jak sloučit CSV až XLSB v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení CSV až XLSB online" InputFormat="csv" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
