...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XML do formatu XLSB, umożliwiając bezproblemowe zapisywanie danych XML do formatu XLSB za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C++.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XML do XLSB używając C++" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XML do XLSB w C++" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na XLSB w C++.
...
Trzeba programowo przekonwertować pliki XML do formatu XLSB? Programiści C++ mogą łatwo przekonwertować pliki XML do formatu XLSB za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XML do XLSB wywołując metodę Save().
1.  Uzyskaj wynik konwersji XML na XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteka do konwersji XML do XLSB" %}}
