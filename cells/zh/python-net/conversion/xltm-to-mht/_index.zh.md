---
title: Python XLTM 转 MHT - XLTM 转 MHT 转换器
description: Aspose Excel。此综合解决方案为 Python 开发人员提供了一种完全集成的方法，可将 XLTM 转换为 MHT 格式，从而能够使用 Aspose.Cells 库将 XLTM 数据无缝保存为 MHT 格式，所有这些都通过高效且可定制的 Python 代码实现。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Excel 库中将 XLTM 转换为 MHT 格式（Python）。" h2="用于将 XLTM 转换为 MHT 的高速 Python Excel 库。使用我们的 Excel 转换工具 API，以 Python 格式开发高级、平台无关的软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="在 Excel 库中将 XLTM 转换为 MHT 格式（Python）。" %}}

如何将 XLTM 转换为 MHT？通过 NET 库，使用 Aspose.Cells 和 for Python，只需几行代码即可轻松地以编程方式将 XLTM 转换为 MHT。[Aspose.Cells for Python 通过 NET](https://pypi.org/project/aspose-cells-python/)能够构建跨平台应用程序，具有生成、修改、转换、呈现和打印所有 Excel 文件的能力。Python Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像 PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等等，因此使其成为交换行业标准格式文档的完美选择。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="将 XLTM 保存到 Python Excel 库中的 MHT" %}}

以下示例演示了如何在 Python Excel 库中将 XLTM 转换为 MHT。
{{% blocks/products/pf/agp/text %}}

按照以下简单步骤将 XLTM 文件转换为 MHT 文件。上传您的 XLTM 文件，然后将其另存为 MHT 文件。读取 XLTM 文件和写入 MHT 文件时，均可使用完整路径的文件名。输出的 MHT 文件内容和格式将与原始 XLTM 文档完全相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 XLTM 通过 Python 转换为 MHT 的示例代码（Excel 库）" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltm" outformat="mht" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLTM 转换为 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLTM 文件转换为 MHT 格式吗？Python 开发人员只需几行代码即可轻松加载 XLTM 文件并将其转换为 MHT 格式。
...
1. 使用工作簿实例加载 XLTM 文件。
1. 调用 Workbook.save 方法将 XLTM 转换为 MHT。
1. 获取 XLTM 到 MHT 的转换结果。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel 库，用于将 XLTM 转换为 MHT" %}}
