---
title: Convertidor PHP XLAM a JSON - XLAM a JSON
description: Aspose Excel. Convierta XLAM a JSON rápida y fácilmente con Aspose.Cells. PHP XLAM a JSON. PHP Guarde XLAM a JSON. Guarde XLAM como JSON usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLAM a JSON mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLAM a JSON mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente XLAM a JSON en tan solo unas pocas líneas de código.
...
1.  Convierta XLAM a JSON llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de XLAM a JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir XLAM a JSON" %}}
