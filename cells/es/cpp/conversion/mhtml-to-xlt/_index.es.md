---
title: Convierta MHTML a XLT a través de la aplicación C++ 

description: Ejemplo de código de conversión C++ para documento MHTML a formato XLT. Los programadores pueden usar este código fuente para la conversión por lotes de MHTML a XLT dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo MHTML a XLT con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo MHTML usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (XLT).1. El archivo XLT se guardará en la ruta especificada.1. Abra el archivo XLT en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de MHTML a XLT C++" offSpacer="" %}}
