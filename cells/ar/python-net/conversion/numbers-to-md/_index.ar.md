---
title: Python أرقام إلى MD - أرقام لتحويل MD
description: Aspose اكسل. قم بتحويل الأرقام إلى MD بسرعة وسهولة باستخدام Aspose.Cells. Python NUMBERS إلى MD. Python حفظ الأرقام في MD. احفظ الأرقام كـ MD باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="تحويل الأرقام إلى MD في Python" %}}
 ...
 كيف أقوم بتحويل NUMBERS إلى MD؟ مع Aspose.Cells for Python عبر مكتبة NET، يمكنك بسهولة تحويل NUMBERS إلى MD برمجيًا باستخدام بضعة أسطر من التعليمات البرمجية.[Aspose.Cells for Python عبر NET](https://pypi.org/project/aspose-cells-python/)قادر على إنشاء تطبيقات مشتركة بين الأنظمة الأساسية مع القدرة على إنشاء جميع ملفات Excel وتعديلها وتحويلها وعرضها وطباعتها. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات، بل يمكنه أيضًا عرض ملفات Excel كصور، وPDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT والمزيد، مما يجعله خيارًا مثاليًا لتبادل المستندات بتنسيقات متوافقة مع معايير الصناعة.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="احفظ الأرقام في MD على Python" %}}

يوضح المثال التالي كيفية تحويل NUMBERS إلى MD في Python via NET.
...
هل تحتاج إلى تحويل ملفات NUMBERS إلى MD برمجيًا؟ يمكن لمطوري Python تحميل وتحويل الأرقام إلى MD بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل NUMBERS إلى MD عن طريق استدعاء طريقة Workbook.save.
1.  احصل على نتيجة تحويل NUMBERS إلى MD.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل الارقام الى MD" %}}
