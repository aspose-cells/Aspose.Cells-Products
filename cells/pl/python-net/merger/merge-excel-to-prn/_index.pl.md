...
description: Aspose Excel. Python Aspose.Cells. Scal format zapisu EXCEL z PRN. Python Połącz format EXCEL z formatem PRN. Połącz EXCEL z PRN w Python. Połącz EXCEL.
...
{{% blocks/products/pf/agp/content h2="Połącz EXCEL z PRN w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia EXCEL z PRN w Python" InputFormat="xlsx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć EXCEL z PRN pod numerem Python" %}}
