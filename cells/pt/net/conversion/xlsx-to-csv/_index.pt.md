---
title: C# XLSX para CSV - Online XLSX para CSV Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter XLSX para CSV saveformat. C# XLSX a CSV formato. Salve XLSX a CSV C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSX para CSV em C#" h2="Biblioteca C# de alta velocidade para converter XLSX em CSV. Esta é uma solução de software profissional para importar e exportar XLSX, CSV e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a CSV em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter XLSX em CSV em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX em CSV. Carregue seu arquivo XLSX e salve-o como arquivo CSV. Tanto para a leitura XLSX quanto para a escrita CSV, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação de saída CSV serão idênticos ao documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter XLSX em CSV online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="csv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para CSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para CSV programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter XLSX em CSV em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para converter XLSX em CSV" %}}
