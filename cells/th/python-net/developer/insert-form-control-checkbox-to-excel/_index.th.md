---
title:  แทรกช่องทำเครื่องหมาย (การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 30
description: Python via .Net ซอร์สโค้ดเพื่อแทรก CheckBox(Form control) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกช่องทำเครื่องหมาย (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก CheckBox(Form control) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ Shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_check_box/#int-int-int-int-int-int) เพื่อแทรกช่องทำเครื่องหมาย (การควบคุมแบบฟอร์ม) ในแผ่นงานที่เลือก
