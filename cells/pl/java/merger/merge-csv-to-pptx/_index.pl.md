---
title: Połącz CSV z PPTX - Połącz CSV z PPTX w Java
url: /pl/java/merger/merge-csv-to-pptx/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online CSV do PPTX w formacie zapisu. Java Połącz format CSV z PPTX. Połącz CSV z PPTX w Java. CSV Połącz.
...
{{% cells-merger title="Bezpłatne połączenie online CSV z PPTX w Java" InputFormat="csv" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić CSV z PPTX programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
