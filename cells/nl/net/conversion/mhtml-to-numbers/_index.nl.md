---
title: C# MHTML naar CIJFERS - MHTML naar CIJFERS Omzetter
...
{{% blocks/products/pf/agp/content h2="Sla MHTML op in de lijst met nummers in C#" %}}

Het volgende voorbeeld laat zien hoe je MHTML omzet naar cijfers in C#.
...
{{% blocks/products/pf/agp/content h2="Hoe zet je MHTML om naar cijfers via C#?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden van het type MHTML programmatisch converteren naar NUMBERS? Ontwikkelaars van .NET kunnen bestanden van het type MHTML eenvoudig laden en converteren naar NUMBERS met slechts een paar regels code.
...
{{% blocks/products/pf/agp/content h2="C# bibliotheek om MHTML naar getallen te converteren" %}}
