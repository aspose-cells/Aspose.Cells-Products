---
title: Konwertuj JSON na GIF za pomocą aplikacji C++ 
url: /pl/cpp/conversion/json-to-gif/ 
description: Przykładowy kod konwersji C++ dla dokumentu JSON na format GIF. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji JSON na GIF w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik JSON na GIF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik JSON przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (GIF).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik GIF w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji JSON do GIF C++" offSpacer="" %}}
