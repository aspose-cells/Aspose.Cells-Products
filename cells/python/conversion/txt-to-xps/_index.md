...
{{% blocks/products/pf/agp/content h2="How to Convert TXT to XPS Using Python" %}}
 ...
 In order to convert TXT to XPS, we will use
...
{{% cells-convert title="Free App and Sample Code to Convert TXT to XPS" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et InputFormat=txt outformat=xps IsLandingPage=true language=python %}}
