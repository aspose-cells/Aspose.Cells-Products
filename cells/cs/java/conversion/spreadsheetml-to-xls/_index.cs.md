---
title: Java SPREADSHEETML na XLS - SPREADSHEETML na XLS Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu SPREADSHEETML do formátu XLS, což umožňuje bezproblémové ukládání dat SPREADSHEETML do formátu XLS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převést SPREADSHEETML na XLS v Java" h2="Vysokorychlostní knihovna Java pro převod SPREADSHEETML na XLS. Toto je profesionální softwarové řešení pro import a export SPREADSHEETML, XLS a mnoha dalších formátů používajících Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Převést SPREADSHEETML na XLS s použitím Java" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit SPREADSHEETML do adresáře XLS v adresáři Java" %}}

Následující příklad ukazuje, jak převést soubor SPREADSHEETML na hodnotu XLS v pořadí Java.
...
Potřebujete programově převést soubory SPREADSHEETML na XLS? Vývojáři s kódem Java mohou snadno převést soubory SPREADSHEETML na XLS pomocí několika řádků kódu.
