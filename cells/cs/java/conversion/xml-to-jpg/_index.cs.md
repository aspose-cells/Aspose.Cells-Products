...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod XML na JPG online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="jpg" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java vývojáři mohou snadno převést XML na JPG pomocí několika řádků kódu.
