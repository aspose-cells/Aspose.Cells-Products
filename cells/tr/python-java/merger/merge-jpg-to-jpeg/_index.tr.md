...
url: /tr/python-java/merger/merge-jpg-to-jpeg/ 
...
Aşağıdaki örnek, JPG'nin Aspose.Cells for Python via Java'de JPEG ile nasıl birleştirileceğini gösterir.
...
JPG'yi programlı olarak JPEG ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
