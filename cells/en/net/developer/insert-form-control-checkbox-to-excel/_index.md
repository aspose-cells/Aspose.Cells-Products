...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert CheckBox to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) to insert a CheckBox in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert CheckBox - C#" offSpacer="" %}}
