...
description: Aspose Excel. Převeďte TSV na MHT rychle a snadno pomocí Aspose.Cells. C++ TSV na MHT. C++ Uložte TSV na MHT. Uložte TSV jako MHT pomocí C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte TSV na MHT v C++" h2="Vysoce výkonný převod TSV na MHT pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte TSV na MHT v C++" %}}

Následující příklad ukazuje, jak převést TSV na MHT v C++.
...
{{% cells-convert title="Ukázkový kód pro převod TSV na MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="mht" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést TSV na MHT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést TSV soubory na MHT programově? Vývojáři C++ mohou snadno převést TSV na MHT v několika řádcích kódu.
...
1.  Převeďte TSV na MHT voláním metody Save().
