...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert elbow shape to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) to insert an elbow shape in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert elbow shape - C#" offSpacer="" %}}
