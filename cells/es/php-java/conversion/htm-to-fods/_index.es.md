---
title: PHP HTM a FODS - Convertidor HTM a FODS
description: Aspose Excel. Convierta HTM a FODS rápida y fácilmente con Aspose.Cells. PHP HTM a FODS. PHP Guarde HTM en FODS. Guarde HTM como FODS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a FODS mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a FODS mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a FODS en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a FODS llamando al método guardar del libro de trabajo.
