---
title: "SXC konvertálása XLT-vé a következőn keresztül: Python"
url: /hu/python-java/conversion/sxc-to-xlt/
description: Mintakód az sxc–xlt Python konverzióhoz. Használjon API példakódot az sxc fájlok kötegelt xlt konvertálásához a Python alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása XLT-vé a Python használatával" %}}

 Az SXC XLT-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az SXC konvertálásához XLT-vé a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői könnyedén betölthetnek és konvertálhatnak SXC fájlokat XLT-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Adja meg a kimeneti útvonalat XLT kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott XLT fájl megadott elérési útját
