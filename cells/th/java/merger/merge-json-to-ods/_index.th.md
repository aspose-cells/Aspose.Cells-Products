---
title: รวม JSON ถึง ODS - รวม JSON ถึง ODS ใน Java
url: /th/java/merger/merge-json-to-ods/ 
description: Aspose เอ็กเซล. Java Aspose.Cells รวม JSON เป็น ODS บันทึกฟอร์แมต Java รวมรูปแบบ JSON ถึง ODS รวม JSON ถึง ODS เข้า Java JSON รวม.
...
{{% blocks/products/pf/agp/content h2="รวม JSON ถึง ODS ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน JSON ถึง ODS ใน Aspose.Cells for Java
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม JSON ถึง ODS อัปโหลดไฟล์ของคุณ เรียกวิธี Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ ODS หากคุณพัฒนาโค้ดใน Java สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง Java ที่รวม JSON กับ ODS

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="โค้ดตัวอย่างที่จะรวม JSON ถึง ODS ใน Java" InputFormat="json" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวม JSON ถึง ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม JSON กับ ODS โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for Java](https://products.aspose.com/cells/java) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="Java ห้องสมุดรวม JSON เป็น ODS" %}}
