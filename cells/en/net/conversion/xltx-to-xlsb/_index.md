...
description: Sample code for xltx to xlsb C# conversion. Use API example code for batch xltx files to xlsb conversion within VB.NET, Asp.NET or any .NET based application.
---
