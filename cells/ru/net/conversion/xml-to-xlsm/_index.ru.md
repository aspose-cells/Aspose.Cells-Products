...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в XLSM в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат XLSM в формате C#.
...
1.  Преобразовать XML в формат XLSM, вызвав метод Workbook.Save.
