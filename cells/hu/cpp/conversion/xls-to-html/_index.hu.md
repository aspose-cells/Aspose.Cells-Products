---
title: Konvertálja az XLS-t HTML-re a(z) C++ alkalmazással 
weight: 2680
url: /hu/cpp/conversion/xls-to-html/ 
description: Minta C++ konverziós kód XLS dokumentumhoz HTML formátumba. A programozók ezt a forráskódot használhatják kötegelt XLS-HTML-konverzióhoz bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS konvertálása HTML-re a következőn keresztül: C++" h2="Nagy teljesítményű XLS-HTML konvertálás a C++ könyvtár használatával Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="XLS konvertálása HTML-re a következővel: C++" %}}

 Az XLS HTML-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az XLS-ből HTML-vé konvertálásához a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatnak XLS fájlt HTML formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (HTML) fájlkiterjesztéssel.1. HTML fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a HTML-fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLS-ből HTML-be C++ konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS-HTML konvertálás élő bemutatók" sectionDescription="[Konvertálja az XLS-t HTML-vé](https://products.aspose.app/cells/conversion/xls-to-html) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel XLS fájlját, és azonnal HTML formátumba konvertálódik." >}}
