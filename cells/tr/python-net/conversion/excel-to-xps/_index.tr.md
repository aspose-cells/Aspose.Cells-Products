...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde EXCEL'i XPS'e dönüştürün. Python EXCEL'i XPS'e dönüştürün. Python EXCEL'i XPS'e kaydedin. Python'i kullanarak EXCEL'i XPS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'de EXCEL\'i XPS\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i Python\'de XPS\'e kaydedin" %}}

Aşağıdaki örnek, EXCEL'in Python via NET'de XPS'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="EXCEL\'i XPS\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xps" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i XPS\'e Dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını programlı olarak XPS'e dönüştürmeniz mi gerekiyor? Python geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyebilir ve XPS'e dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i XPS\'e dönüştürmek için Python kitaplığı" %}}
