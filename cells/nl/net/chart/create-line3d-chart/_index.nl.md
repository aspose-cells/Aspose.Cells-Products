...
description: C# Voorbeeldcode voor het maken van 3D-lijndiagrammen naar Excel met behulp van de .NET-bibliotheek. Gebruik deze code voor het maken van een 3D-lijndiagram naar MS Excel binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
...
{{% blocks/products/pf/agp/feature-section-col title="Hoe u 3D-lijndiagrammen kunt maken via C#" %}}
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="De volgende broncode laat zien hoe u een 3D-lijndiagram naar MS Excel XLSX-bestand kunt maken met behulp van C#." offSpacer="" %}}
