---
title: C++ uygulaması aracılığıyla TXT'yi XLSM'ye dönüştürün 
url: /tr/cpp/conversion/txt-to-xlsm/ 
description: TXT belgesi için XLSM biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu TXT'den XLSM'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla TXT\'yi XLSM\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı TXT\'den XLSM\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak TXT\'yi XLSM\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ aracılığıyla TXT\'yi XLSM\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 C++ geliştiricileri, yalnızca birkaç satır kodla TXT dosyasını kolayca XLSM'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak TXT dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (XLSM) dosya uzantısıyla iletin.1. XLSM dosyası belirtilen yola kaydedilecektir.1. XLSM dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="TXT - XLSM C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
