---
title: Sloučit JPG do SPREADSHEETML – Sloučit JPG do SPREADSHEETML v C++
url: /cs/cpp/merger/merge-jpg-to-spreadsheetml/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit JPG do formátu uložení SPREADSHEETML. C++ Zkombinujte JPG s formátem SPREADSHEETML. Sloučit JPG do SPREADSHEETML v C++. JPG Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG do SPREADSHEETML v C++" %}}

Následující příklad ukazuje, jak sloučit JPG do SPREADSHEETML v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do SPREADSHEETML. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru SPREADSHEETML. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení JPG do SPREADSHEETML v C++" InputFormat="jpg" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPG do SPREADSHEETML přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JPG do SPREADSHEETML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení JPG do SPREADSHEETML" %}}
