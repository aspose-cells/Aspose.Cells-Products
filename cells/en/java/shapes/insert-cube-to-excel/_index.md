---
title: Insert Cube into Excel via Java 
weight: 20
...
{{% blocks/products/pf/agp/content h2="How to Insert Cube into Excel File Using Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Cube to Excel file via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) to insert Cube in the selected worksheet
