---
title:  Insérer Spinner (contrôle de formulaire) dans Excel via .NET
weight: 40
description: C# code source pour insérer Spinner (contrôle de formulaire) dans Excel sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Comment insérer Spinner (contrôle de formulaire) dans un fichier Excel à l\'aide de C#" %}}

 Afin d'insérer Spinner (contrôle de formulaire) dans un fichier Excel, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer Spinner (contrôle de formulaire) dans un fichier Excel via C#" %}}
...
+ Sélectionnez Feuille de travail via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addspinner) pour insérer un Spinner (contrôle de formulaire) dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer Spinner (contrôle de formulaire) - C#" offSpacer="" %}}
