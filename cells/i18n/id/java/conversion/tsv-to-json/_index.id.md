---
title: Konversikan TSV ke JSON melalui Java 
weight: 1910
url: /id/java/conversion/tsv-to-json/ 
description: Contoh Java kode konversi untuk format TSV ke file JSON. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke JSON dalam Aplikasi berbasis Java Web atau Desktop apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan TSV ke JSON melalui Java" h2="Konversi TSV ke JSON Java untuk mengonversi satu atau beberapa laman ke JSON menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TSV ke JSON Menggunakan Java" %}}

 Untuk merender TSV ke JSON, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi TSV ke JSON melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file TSV ke JSON hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file TSV dengan instance kelas Workbook1. Buat Rentang data yang akan diekspor menggunakan metode Cells.createRange1. Panggil metode JsonUtility.exportRangeToJson dengan referensi Range & ExportRangeToJsonOptions1. Tulis data String JSON ke file melalui metode BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="TSV ke JSON Java Kode Sumber Konversi" offSpacer="" %}}
