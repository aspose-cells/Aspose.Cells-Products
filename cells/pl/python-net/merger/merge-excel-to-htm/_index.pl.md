...
url: /pl/python-net/merger/merge-excel-to-htm/ 
...
Poniższy przykład pokazuje, jak scalić EXCEL z HTM w Aspose.Cells for Python via .NET.
...
Chcesz programowo połączyć program EXCEL z HTM? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
