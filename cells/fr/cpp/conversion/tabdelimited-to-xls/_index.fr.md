---
title: Convertir TABDELIMITED en XLS via l'application C++ 
url: /fr/cpp/conversion/tabdelimited-to-xls/ 
description: Exemple de code de conversion C++ pour le document TABDELIMITED au format XLS. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de TABDELIMITED en XLS dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TABDELIMITED en XLS via C++" h2="Conversion TABDELIMITED vers XLS haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir le fichier TABDELIMITED en XLS en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier TABDELIMITED à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (XLS).1. Le fichier XLS sera enregistré dans le chemin spécifié.1. Ouvrez le fichier XLS dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED à XLS C++ code source de conversion" offSpacer="" %}}
