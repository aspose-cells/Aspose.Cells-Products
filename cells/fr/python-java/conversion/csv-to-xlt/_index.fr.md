...
description: Aspose Exceller. Convertissez CSV en XLT rapidement et facilement avec Aspose.Cells. Python CSV en XLT. Python Enregistrez CSV en XLT. Enregistrez CSV sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le CSV au XLT au Python" %}}

L'exemple suivant montre comment convertir CSV en XLT dans Python.
...
{{% cells-convert title="Exemple de code pour convertir CSV en XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="xlt" IsLandingPage="true" language="pythonjava" %}}
