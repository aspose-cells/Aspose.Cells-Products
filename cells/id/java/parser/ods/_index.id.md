...
weight: 4740
description: Kode contoh Java untuk mengekstrak teks dan gambar dari file ODS di Lingkungan Runtime Java untuk Aplikasi JSP/JSF dan Aplikasi Desktop.
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Parsing File ODS di Java" %}}
...
Muat dokumen ODS menggunakan kelas Buku Kerja.
...
{{% blocks/products/pf/agp/code-block title="Parsing ODS File - Java" offSpacer="" %}}
