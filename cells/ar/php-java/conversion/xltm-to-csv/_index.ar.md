---
title: PHP XLTM إلى CSV - XLTM إلى CSV محول
description: Aspose اكسل. قم بتحويل XLTM إلى CSV بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى CSV. PHP احفظ XLTM إلى CSV. احفظ XLTM كـ CSV باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى CSV عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى CSV برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى CSV بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى CSV عن طريق استدعاء طريقة حفظ المصنف.
