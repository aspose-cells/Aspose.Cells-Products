...
{{% blocks/products/pf/agp/content h2="Convertire OTS in JSON utilizzando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salva OTS a JSON in C++" %}}
...
Hai bisogno di convertire i file OTS in JSON tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire OTS in JSON in poche righe di codice.
...
1.  Convertire OTS in JSON chiamando il metodo Save().
