---
title: C# HTM σε XML - Μετατροπέας HTM σε XML
description: Aspose Excel. Μετατρέψτε το HTM σε XML γρήγορα και εύκολα με το Aspose.Cells. C# HTM σε XML. C# Αποθήκευση HTM σε XML. Αποθηκεύστε το HTM ως XML χρησιμοποιώντας το C#.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το HTM σε XML στο C#" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το HTM σε XML στο C#.
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή HTM σε XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε HTM σε XML μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να μετατρέψετε αρχεία HTM σε XML μέσω προγραμματισμού; Οι προγραμματιστές .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν το HTM σε XML σε λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="C# βιβλιοθήκη για μετατροπή HTM σε XML" %}}
