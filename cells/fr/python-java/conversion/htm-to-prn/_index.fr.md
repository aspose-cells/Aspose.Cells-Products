...
description: Aspose Exceller. Convertissez HTM en PRN rapidement et facilement avec Aspose.Cells. Python HTM en PRN. Python Enregistrer HTM dans PRN. Enregistrez HTM en tant que PRN en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Convertir HTM en PRN en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM vers PRN au Python" %}}

L'exemple suivant montre comment convertir HTM en PRN dans Python.
...
{{% cells-convert title="Exemple de code pour convertir HTM en PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="prn" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour convertir HTM en PRN" %}}
