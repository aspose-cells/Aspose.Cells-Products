...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi EXCEL ke JPG melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file EXCEL ke JPG hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file EXCEL dengan instance Workbook1. Panggil metode Workbook.Save1. Lewati jalur keluaran dengan ekstensi JPG sebagai parameter1. Periksa jalur yang ditentukan untuk file JPG yang dihasilkan
...
{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi EXCEL ke JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="jpg" IsLandingPage="true" %}}
