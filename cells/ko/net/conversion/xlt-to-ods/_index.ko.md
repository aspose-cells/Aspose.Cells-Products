---
title: C# XLT ~ ODS - 온라인 XLT ~ ODS 변환기
description: Aspose 엑셀. C# Aspose.Cells. C# Aspose Cells. 무료 온라인 C# XLT을 ODS saveformat으로 변환합니다. C# XLT ~ ODS 형식. XLT을 ODS C#로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="XLT을 C#에서 ODS로 온라인에서 무료로 저장" %}}

다음 예는 XLT을 C#에서 ODS로 변환하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

간단한 단계에 따라 XLT을 ODS로 변환합니다. XLT 파일을 업로드한 다음 ODS 파일로 저장하기만 하면 됩니다. XLT 읽기 및 ODS 쓰기 모두에 정규화된 파일 이름을 사용할 수 있습니다. 출력 ODS 내용 및 형식은 원본 XLT 문서와 동일합니다.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="온라인에서 XLT을 ODS로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 XLT을 ODS로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 XLT 파일을 ODS로 변환해야 합니까? .NET 개발자는 단 몇 줄의 코드로 XLT을 ODS로 쉽게 로드 및 변환할 수 있습니다.
...
1.  Workbook.Save 메서드를 호출하여 XLT을 ODS로 변환합니다.
1.  XLT의 변환 결과를 ODS로 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# XLT을 ODS로 변환하는 라이브러리" %}}
