---
title: Fusionner EXCEL vers XML - Combiner EXCEL vers XML dans C#
url: /fr/net/merger/merge-excel-to-xml/ 
description: Aspose Exceller. C# Aspose.Cells. Fusionner EXCEL au format de sauvegarde XML. C# Combinez EXCEL au format XML. Fusionner EXCEL en XML dans C#. Fusion EXCEL.
...
{{% blocks/products/pf/agp/content h2="Fusionner EXCEL vers XML dans C#" %}}

L'exemple suivant montre comment fusionner EXCEL vers XML dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner EXCEL vers XML. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier XML. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne EXCEL avec XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner EXCEL vers XML dans C#" InputFormat="xlsx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner EXCEL vers XML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner EXCEL vers XML par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque .NET pour fusionner EXCEL vers XML" %}}
