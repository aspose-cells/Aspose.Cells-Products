---
title: C# HTML 轉 XLTX - 在線 HTML 轉 XLTX 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 HTML 轉換為 XLTX 保存格式。 C# HTML 到 XLTX 格式。將 HTML 保存為 XLTX C#。
...
{{% blocks/products/pf/agp/content h2="免費在線保存 HTML 至 XLTX 於 C#" %}}

以下示例演示如何將 C# 中的 HTML 轉換為 XLTX。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 HTML 轉換為 XLTX。上傳您的 HTML 文件，然後只需將其另存為 XLTX 文件。對於 HTML 讀取和 XLTX 寫入，您可以使用完全限定的文件名。輸出 XLTX 內容和格式將與原始 HTML 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 HTML 轉換為 XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xltx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 HTML 轉換為 XLTX" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 HTML 文件轉換為 XLTX 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 HTML 到 XLTX。
...
1. 使用工作簿實例加載 HTML 文件。
1. 通過調用 Workbook.Save 方法將 HTML 轉換為 XLTX。
1. 獲取HTML到XLTX的轉換結果。
