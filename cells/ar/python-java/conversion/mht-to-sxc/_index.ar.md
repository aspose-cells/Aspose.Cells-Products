...
description: Aspose اكسل. قم بتحويل MHT إلى SXC بسرعة وسهولة باستخدام Aspose.Cells. Python MHT إلى SXC. Python احفظ MHT إلى SXC. احفظ MHT كـ SXC باستخدام Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHT إلى SXC في Python" h2="مكتبة Python عالية السرعة لتحويل MHT إلى SXC. هذا حل برمجي احترافي لاستيراد وتصدير MHT وSXC والعديد من التنسيقات الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل MHT إلى SXC باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على SXC في Python" %}}

يوضح المثال التالي كيفية تحويل MHT إلى SXC في Python.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل MHT إلى SXC" %}}
