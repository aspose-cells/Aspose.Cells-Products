...
Precisa converter arquivos TABDELIMITED para ODS programaticamente? Desenvolvedores PHP podem facilmente carregar e converter arquivos TABDELIMITED para ODS com apenas algumas linhas de código.
...
1.  Converta TABDELIMITED para ODS chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de TABDELIMITED para ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED em ODS" %}}
