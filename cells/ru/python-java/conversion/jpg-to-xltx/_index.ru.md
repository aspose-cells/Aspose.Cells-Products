...
description: Aspose Эксель. Быстро и легко конвертируйте JPG в XLTX с помощью Aspose.Cells. Python JPG в XLTX. Python Сохраните JPG в XLTX. Сохраните JPG как XLTX, используя Python.
...
{{% blocks/products/pf/agp/content h2="Конвертируйте JPG в XLTX, используя Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните JPG в XLTX в Python." %}}

В следующем примере показано, как преобразовать JPG в XLTX в Python.
...
{{% blocks/products/pf/agp/content h2="Библиотека Python для преобразования JPG в XLTX" %}}
