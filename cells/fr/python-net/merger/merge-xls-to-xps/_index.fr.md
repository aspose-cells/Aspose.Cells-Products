...
description: Aspose Exceller. Python Aspose.Cells. Fusionner le format de sauvegarde XLS à XPS. Python Combinez les formats XLS à XPS. Fusionner XLS à XPS dans Python. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS à XPS en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS à XPS dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner XLS à XPS dans Python" InputFormat="xls" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS à XPS via Python" %}}
