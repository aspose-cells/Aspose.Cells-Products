---
title:  أدخل CheckBox (التحكم في النموذج) في Excel باستخدام Python via java
weight: 30
description: Python via كود مصدر جافا لإدراج CheckBox (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج CheckBox (التحكم في النموذج) في ملف Excel باستخدام Python via java" %}}

 من أجل إدراج CheckBox (التحكم في النموذج) في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج CheckBox (عنصر تحكم النموذج) في ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) لإدراج CheckBox(عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل خانة الاختيار (التحكم في النموذج) - Python via java" offSpacer="" %}}
