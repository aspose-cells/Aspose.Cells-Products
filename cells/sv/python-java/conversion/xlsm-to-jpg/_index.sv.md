---
title: Konvertera XLSM till JPG via Python

description: Exempelkod för konvertering av xlsm till jpg Python. Använd API exempelkod för batch-xlsm-filer till jpg-konvertering i Python-applikationen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLSM till JPG via Python" h2="Exportera Excel®-kalkylark till JPG-format med Python API:er." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till JPG med Python" %}}

 För att konvertera XLSM till JPG kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till JPG via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLSM-filer till JPG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utdatasökväg med JPG-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande JPG-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLSM till JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="jpg" IsLandingPage="true" language="python" %}}
