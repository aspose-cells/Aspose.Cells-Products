...
description: Aspose Exceller. Convertissez HTM en MHTML rapidement et facilement avec Aspose.Cells. Python HTM en MHTML. Python Enregistrez HTM en MHTML. Enregistrez HTM sous MHTML en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au MHTML dans Python" %}}
...
{{% cells-convert title="Exemple de code pour convertir HTM en MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="mhtml" IsLandingPage="true" language="pythonjava" %}}
