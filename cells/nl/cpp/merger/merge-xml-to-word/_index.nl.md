...
url: /nl/cpp/merger/merge-xml-to-word/ 
...
Het volgende voorbeeld laat zien hoe u XML kunt samenvoegen met WORD in Aspose.Cells for C++.
...
Wilt u XML programmatisch samenvoegen met WORD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++-bibliotheek om XML samen te voegen met WORD" %}}
