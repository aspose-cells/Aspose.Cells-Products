...
url: /it/python-java/merger/merge-xls-to-xml/ 
...
L'esempio seguente mostra come unire XLS a XML in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Hai bisogno di unire XLS a XML a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Le API possono essere eseguite con poche righe di codice.
