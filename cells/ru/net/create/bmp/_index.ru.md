...
description: Aspose Excel. C# Создать файл BMP. Создать BMP C#. C# BMP Создатель. Создайте BMP в C#. Создайте файл BMP, используя C#.
...
1. Используйте метод Сохранить, чтобы сохранить книгу как файл BMP.
