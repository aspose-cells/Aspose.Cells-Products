---
title: Convierta ODS en matriz de bytes a través de C# 
weight: 7690
url: /es/net/conversion/ods-to-byte-array/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Convierta ODS en una matriz de bytes a través de C#" h2="Conversión nativa y de alto rendimiento de Microsoft Excel ODS a matriz de bytes o viceversa para el procesamiento de datos de hojas de cálculo utilizando las API .NET del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array es útil para el procesamiento o almacenamiento de datos. Puede convertir un archivo ODS a Byte Array, así como un documento de **Byte Array a ODS** utilizando el idioma C#. Para convertir ODS en una matriz de bytes, usaremos
...
1. Incluya el espacio de nombres en su archivo de clase1. Cargue el archivo ODS de entrada usando el libro de trabajo1. Inicializar objeto MemoryStream1. Convertir datos de flujo a matriz de bytes1. Procesar datos según sus requisitos
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de ODS a matriz de bytes C#" offSpacer="" %}}
