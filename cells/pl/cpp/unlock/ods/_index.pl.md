---
title:  Odblokuj dokument ODS za pośrednictwem C++
weight: 1190
description: C++ przykładowy kod do odblokowania chronionego hasłem pliku ODS w C++ Runtime Environment dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj pliki ODS przez C++" h2="Usuń ochronę z arkuszy kalkulacyjnych Excel, w tym pliku ODS, używając biblioteki C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1.  Załaduj zablokowany plik ODS za pomocą CreateIWorkbook.
1.  Wywołaj funkcję Unprotect(), aby odblokować.
1.  Ustaw hasło na NULL za pomocą SetPassword.
1.  Zapisz plik ODS w określonej lokalizacji.
