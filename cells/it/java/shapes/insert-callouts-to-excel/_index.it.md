...
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci Callout in Excel via Java" h2="Inserisci didascalie utilizzando Aspose.Cells\' API senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire didascalie nel file Excel utilizzando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire Callout nel file Excel via Java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)per inserire Callout nel foglio di lavoro selezionato
...
Il codice di esempio riportato di seguito illustra come inserire un "Thought Bubble: Cloud". Per altri tipi, fare riferimento a "Panoramica dei tipi di callout di blocco" di seguito.

{{% blocks/products/pf/agp/code-block title="Inserisci didascalie - Java" offSpacer="" %}}
