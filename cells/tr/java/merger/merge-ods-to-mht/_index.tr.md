...
description: Aspose excel. Java Aspose.Cells. ODS'i MHT saveformat'a Ücretsiz Çevrimiçi Birleştirme. Java ODS'i MHT biçiminde birleştirin. ODS'i Java'de MHT ile birleştir. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i MHT ile Java Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de MHT ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="ODS\'i Java\'de MHT ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS MHT via Java ile Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

ODS'i programlı olarak MHT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i MHT ile birleştirmek için Java kitaplığı" %}}
