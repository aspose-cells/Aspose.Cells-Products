---
title: 創建JPEG - 在Java中創建JPEG文件
description: Aspose Excel。 Java 創建 JPEG 文件。創建JPEG Java。Java JPEG創建者。在Java中創建JPEG。使用Java生成JPEG文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建JPEG" %}}
...
1. 使用 save() 方法將工作簿保存為 JPEG 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 JPEG 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建JPEG文件" %}}
{{% blocks/products/pf/agp/text %}}
