---
title: Μετατροπή NUMBERS σε JSON μέσω Java 
url: /el/java/conversion/numbers-to-json/ 
description: Δείγμα κώδικα μετατροπής Java για μορφή NUMBERS σε αρχείο JSON. Οι προγραμματιστές μπορούν να χρησιμοποιήσουν αυτό το παράδειγμα κώδικα για να εξάγουν υπολογιστικά φύλλα Excel και OpenOffice σε JSON σε οποιαδήποτε εφαρμογή που βασίζεται στον Ιστό ή στην επιφάνεια εργασίας Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή NUMBERS σε JSON μέσω Java" h2="Μετατροπή NUMBERS σε JSON Java για μετατροπή μεμονωμένων ή πολλαπλών σελίδων σε JSON χρησιμοποιώντας εσωτερική βιβλιοθήκη Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε τους αριθμούς σε JSON χρησιμοποιώντας το Java" %}}

 Για να αποδώσουμε τα NUMBERS σε JSON, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή NUMBERS σε JSON μέσω Java" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του Java μπορούν εύκολα να μετατρέψουν NUMBERS αρχείο σε JSON σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου NUMBERS με μια παρουσία της κλάσης Βιβλίο εργασίας1. Δημιουργήστε ένα εύρος δεδομένων προς εξαγωγή χρησιμοποιώντας τη μέθοδο Cells.createRange1. Καλέστε τη μέθοδο JsonUtility.exportRangeToJson με αναφορές Range & ExportRangeToJsonOptions1. Γράψτε δεδομένα String JSON για αρχείο μέσω της μεθόδου BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής NUMBERS σε JSON Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ζωντανές επιδείξεις μετατροπής NUMBERS σε JSON" sectionDescription="[Μετατροπή NUMBERS σε JSON](https://products.aspose.app/cells/conversion/numbers-to-json) αυτή τη στιγμή, επισκεπτόμενοι τον ιστότοπο Live Demos. Η ζωντανή επίδειξη έχει τα ακόλουθα πλεονεκτήματα" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Δεν χρειάζεται να κάνετε λήψη του Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Δεν χρειάζεται να γράψετε κανέναν κώδικα." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλώς ανεβάστε το αρχείο NUMBERS, θα μετατραπεί αμέσως σε JSON." >}}
