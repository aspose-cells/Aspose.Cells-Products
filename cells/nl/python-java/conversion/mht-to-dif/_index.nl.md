...
description: Aspose Excel. Converteer MHT snel en eenvoudig naar DIF met Aspose.Cells. Python MHT naar DIF. Python Bewaar MHT naar DIF. Sla MHT op als DIF met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MHT naar DIF in Python" h2="Snelle Python-bibliotheek voor het converteren van MHT naar DIF. Dit is een professionele softwareoplossing voor het importeren en exporteren van MHT, DIF en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer MHT naar DIF met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar MHT op DIF in Python" %}}

In het volgende voorbeeld ziet u hoe u MHT converteert naar DIF in Python.
...
{{% cells-convert title="Voorbeeldcode om MHT naar DIF te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="dif" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om MHT naar DIF te converteren" %}}
