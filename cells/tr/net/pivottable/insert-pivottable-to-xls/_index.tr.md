---
title: C# yoluyla Microsoft Excel XLS dosyalarına PivotTable ekleyin
weight: 7690
description: C# PivotTable ile XLS belgeleri oluşturmak için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulamada PivotTable ile Microsoft Excel XLS dosyaları oluşturmak için bu kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="PivotTable\'ı XLS Belgelerine C# aracılığıyla ekleyin" h2="Yerel ve yüksek performanslı Microsoft Excel XLS sunucu tarafı .NET API\'lerini kullanarak programlı olarak PivotTable oluşturma içeren elektronik tablo." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Çalışan uygulama içinde dinamik olarak PivotTable ile MS Excel XLS dosyası oluşturmak kolaydır. MS Office gerektirmeden PivotTable ile sıfırdan XLS belgesi oluşturmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="XLS\'de C# aracılığıyla PivotTable nasıl eklenir" %}}

{{% blocks/products/pf/agp/text %}}

 Geliştiricilerin, yalnızca birkaç satır kodla veri işleme için farklı raporlama uygulamaları çalıştırırken XLS biçimindeki elektronik tablodaki PivotTable'ı eklemesi kolaydır.
