---
title:  Συγχώνευση XLS σε XLTX μέσω Python
url: /el/python-net/merger/merge-xls-to-xltx/ 
description: Συγχώνευση XLS σε XLTX Online δωρεάν. Δωρεάν Online XLS έως XLTX Συγχώνευση. Συγχώνευση XLS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLS με το XLTX στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLS με XLTX σε απευθείας σύνδεση" InputFormat="xls" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
