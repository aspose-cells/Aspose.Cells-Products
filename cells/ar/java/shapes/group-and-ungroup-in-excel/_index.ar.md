---
title: تجميع وفك تجميع الأشكال في Excel via Java
weight: 360
description: تجميع وفك تجميع الكائنات باستخدام Aspose.Cells' Java API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF وما إلى ذلك.
...
{{% blocks/products/pf/agp/content h2="كيفية تجميع وفك تجميع الأشكال في ملف Excel باستخدام sJava" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تجميع وفك تجميع الأشكال في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[طريقة المجموعة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#group-com.aspose.cells.Shape---) لتجميع الأشكال في ورقة العمل المحددة
 + استخدم[طريقة فك التجميع](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#ungroup-com.aspose.cells.GroupShape-) لفك تجميع الأشكال في ورقة العمل المحددة
