---
title: HTM samenvoegen naar PDF - HTM combineren naar PDF in Java
url: /nl/java/merger/merge-htm-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online HTM samenvoegen naar PDF opslagformaat. Java Combineer HTM naar formaat PDF. HTM samenvoegen naar PDF in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="HTM samenvoegen naar PDF in Java Online gratis" %}}

Het volgende voorbeeld laat zien hoe u HTM samenvoegt met PDF in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen tot PDF. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand PDF. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat HTM samenvoegt tot PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om HTM samen te voegen met PDF in Java" InputFormat="htm" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen tot PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met PDF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen tot PDF" %}}
