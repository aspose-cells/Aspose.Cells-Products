...
O exemplo a seguir demonstra como converter IMAGE para TXT em Python via NET.
...
{{% blocks/products/pf/agp/content h2="Como converter IMAGEM para TXT" %}}
