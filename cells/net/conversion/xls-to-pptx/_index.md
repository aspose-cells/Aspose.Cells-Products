...
1.  Pass output path with PPTX extension as parameters
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XLS to PPTX" sectionDescription="Check our live demos for [XLS to PPTX conversion](https://products.aspose.app/cells/conversion/xls-to-pptx) with following benefits." >}}
