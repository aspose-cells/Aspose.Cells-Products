...
Нужно программно конвертировать файлы PNG в HTML? Разработчики C++ могут легко преобразовать PNG в HTML всего за несколько строк кода.
...
1.  Преобразуйте PNG в HTML, вызвав метод Save().
