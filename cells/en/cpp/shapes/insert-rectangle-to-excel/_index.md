...
+  Use the [add method](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addrectangle/) to insert Rectangle in the selected worksheet
