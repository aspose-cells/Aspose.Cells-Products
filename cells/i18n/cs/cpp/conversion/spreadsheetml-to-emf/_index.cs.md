---
title: Převeďte SPREADSHEETML na EMF pomocí aplikace C++ 
url: /cs/cpp/conversion/spreadsheetml-to-emf/ 
description: Ukázka převodního kódu C++ pro dokument SPREADSHEETML do formátu EMF. Programátoři mohou použít tento zdrojový kód pro dávkový převod SPREADSHEETML na EMF v jakékoli aplikaci C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SPREADSHEETML na EMF prostřednictvím C++" h2="Vysoce výkonný převod SPREADSHEETML na EMF pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SPREADSHEETML na EMF pomocí C++" %}}

 K převodu SPREADSHEETML na EMF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SPREADSHEETML na EMF prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor SPREADSHEETML na EMF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SPREADSHEETML pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavení možností (EMF).1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor EMF v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SPREADSHEETML na EMF C++" offSpacer="" %}}
