---
title: Combine MHTML con EXCEL - Combine MHTML con EXCEL en C#
url: /es/net/merger/merge-mhtml-to-excel/ 
description: AsposeExcel. C# Aspose.Cells. Fusione gratis en línea MHTML para guardar formato EXCEL. C# Combine MHTML en formato EXCEL. Combinar MHTML a EXCEL en C#. MHTML Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine MHTML con EXCEL en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar MHTML con EXCEL en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar MHTML con EXCEL. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo EXCEL. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina MHTML con EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar MHTML a EXCEL en C#" InputFormat="mhtml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar MHTML a EXCEL a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar MHTML con EXCEL mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar MHTML a EXCEL" %}}
