---
title: Gabung FODS ke XPS - Gabungkan FODS ke XPS di Java
url: /id/java/merger/merge-fods-to-xps/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge FODS to XPS saveformat. Java Gabungkan format FODS menjadi XPS. Gabung FODS ke XPS di Java. FODS Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabung FODS ke XPS di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan FODS ke XPS di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan FODS ke XPS di Java" InputFormat="fods" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS ke XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS menjadi XPS secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan FODS ke XPS" %}}
