---
title: แปลง CSV เป็น EMF ผ่าน Java 
weight: 4550
url: /th/java/conversion/csv-to-emf/ 
description: ตัวอย่างโค้ดการแปลง Java สำหรับรูปแบบ CSV เป็นไฟล์ EMF โปรแกรมเมอร์สามารถใช้โค้ดตัวอย่างนี้เพื่อส่งออกสเปรดชีต Excel & OpenOffice ไปยัง EMF ภายในแอปพลิเคชันบนเว็บหรือเดสก์ท็อป Java
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง CSV เป็น EMF ผ่าน Java" h2="การแปลง CSV เป็น EMF Java เพื่อแปลงหน้าเดียวหรือหลายหน้าเป็น EMF โดยใช้ไลบรารี On-premise Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง CSV เป็น EMF โดยใช้ Java" %}}

 เพื่อแสดง CSV เป็น EMF เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง CSV เป็น EMF ผ่าน Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java นักพัฒนาซอฟต์แวร์สามารถแปลงไฟล์ CSV เป็น EMF ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ CSV ด้วยอินสแตนซ์ของ Workbook1. เลือกค่าเริ่มต้นหรือเวิร์กชีตใดก็ได้จากคอลเล็กชัน1. สร้างและตั้งค่าวัตถุของ ImageOrPrintOptions1. สร้าง SheetRender ด้วยออบเจ็กต์ Worksheet & ImageOrPrintOptions1. เรียกวิธี SheetRender.toImage เพื่อบันทึกผลลัพธ์ในรูปแบบ EMF
...
{{% blocks/products/pf/agp/code-block title="CSV เป็น EMF Java รหัสแหล่งที่มาของการแปลง" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="การสาธิตสดการแปลง CSV เป็น EMF" sectionDescription="[แปลง CSV เป็น EMF](https://products.aspose.app/cells/conversion/csv-to-emf) ตอนนี้โดยไปที่เว็บไซต์ Live Demos ของเรา การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" ไม่จำเป็นต้องดาวน์โหลด Aspose API" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" ไม่ต้องเขียนโค้ดใดๆ" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" เพียงอัปโหลดไฟล์ CSV ของคุณ ไฟล์นั้นจะถูกแปลงเป็น EMF ทันที" >}}
