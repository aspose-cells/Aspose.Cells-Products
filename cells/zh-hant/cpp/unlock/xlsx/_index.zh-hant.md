...
title: 透過C++解鎖XLSX文檔
weight: 3680
description: C++ 用於解鎖 C++ 運行時環境中受密碼保護的 XLSX 檔案的範例代碼，適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 解鎖 XLSX 文件" h2="使用 C++ 庫刪除 Excel 電子表格（包括 XLSX 檔案）的保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 刪除 XLSX 檔案的保護" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 解鎖 XLSX" %}}
...
1. 使用受保護的 XLSX 檔案的路徑實例化 Workbook 類
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API 可用於建立、編輯、轉換和渲染 Microsoft Excel 格式為不同的格式。此外，它還可用於軟體應用程式中的全面圖表、可擴展報告和可靠計算。 Aspose.Cells 是一個獨立的 API，它不需要任何像 Microsoft 或 OpenOffice 這樣的軟體。
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="免費應用程式解鎖 XLSX" sectionDescription="查看我們的現場演示[解鎖XLSX文件](https://products.aspose.app/cells/unlock/xlsx)具有以下好處。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/unlock/xls/" name="XLS" description="Excel 二進位格式" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/unlock/xlsb/" name="XLSB" description="二進位 Excel 工作簿文件" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/unlock/xlsm/" name="XLSM" description="試算表文件" >}}
