---
title: 無需透過 C++ 開啟即可搜尋 TXT 文檔
weight: 5090
description: C++ 範例程式碼，用於在 TXT 檔案中使用模式搜尋單字，適用於 C++ 運行時環境，支援 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 C++ 中搜尋 TXT 格式" h2="使用伺服器端 API 實現原生和高效能的文檔搜索，無需使用任何軟體，例如 Adobe 或 Microsoft 或 PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C++ 中搜尋 TXT 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="搜尋文件 TXT - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="線上 TXT 搜尋即時演示" sectionDescription="立即造訪我們的網站，搜尋編號為 TXT 的文件中的文字、單字和短語。[現場示範網站](https://products.aspose.app/cells/search)。現場演示有以下好處" >}}
...
副檔名為 .TXT 的文件是一個文字文件，其中包含以行形式排列的純文字。文字檔案中的段落透過回車符來識別，用於更好地組織文件內容。標準的文字檔案可以在不同作業系統上的任何文字編輯器或文字處理應用程式中開啟。此類文件中包含的所有文字都採用人類可讀的格式，並以字元序列的形式表示。
