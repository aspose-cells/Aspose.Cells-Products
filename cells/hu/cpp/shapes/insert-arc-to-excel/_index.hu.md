---
title:  Illessze be az Arc-ot az Excelbe a C++ számon keresztül
weight: 10
description: C++ példakód az Arc beszúrásához a C++ futásidejű Excel-fájlba a Windows 32 bites, Windows 64 bites és a 64 bites Linux rendszerhez.
---
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet ívet beszúrni Excel fájlba a C++ használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az Arc Excel-fájlba való beszúrásának lépései a C++ számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja a[módszer hozzáadása](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#a4942e79c088d2fd459beeda50006b4c4) az Egyenlet alakzatok beszúrásához a kiválasztott munkalapba
