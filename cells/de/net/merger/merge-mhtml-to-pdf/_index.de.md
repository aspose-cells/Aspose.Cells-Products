...
url: /de/net/merger/merge-mhtml-to-pdf/ 
...
Das folgende Beispiel zeigt, wie MHTML mit PDF in Aspose.Cells for .NET zusammengeführt wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie MHTML programmgesteuert mit PDF zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von MHTML mit PDF" %}}
