---
title: Converter XLSX para EMF por meio do aplicativo C++ 
weight: 8040
url: /pt/cpp/conversion/xlsx-to-emf/ 
description: Exemplo de código de conversão C++ para documento XLSX para o formato EMF. Os programadores podem usar esse código-fonte para conversão em lote de XLSX para EMF em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSX para EMF via C++" h2="Conversão de XLSX para EMF de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem facilmente converter arquivos XLSX para EMF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLSX usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (EMF).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo EMF em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLSX para EMF C++" offSpacer="" %}}
