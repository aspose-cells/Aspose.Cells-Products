---
title: C# JPG 到 DOCX - JPG 到 DOCX 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 JPG 转换为 DOCX。 C# JPG 到 DOCX。 C# 将 JPG 保存到 DOCX。 使用 C# 将 JPG 保存为 DOCX。
...
{{% blocks/products/pf/agp/content h2="将JPG保存到C#中的DOCX" %}}
...
{{% cells-convert title="将 JPG 转换为 DOCX 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="docx" IsLandingPage="true" %}}
