---
title: Convierta SPREADSHEETML a XLS a través de Java 
url: /es/java/conversion/spreadsheetml-to-xls/ 
description: Ejemplo de código de conversión Java para formato SPREADSHEETML a archivo XLS. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a XLS dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta SPREADSHEETML a XLS a través de Java" h2="Conversión de SPREADSHEETML a XLS Java para convertir una o varias páginas a XLS mediante la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SPREADSHEETML a XLS usando Java" %}}

 Para convertir SPREADSHEETML a XLS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SPREADSHEETML a XLS a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo SPREADSHEETML a XLS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo SPREADSHEETML con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión XLS y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo XLS resultante
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML a XLS Java Código fuente de conversión" offSpacer="" %}}

```cs
// cargue el archivo SPREADSHEETML en una instancia de Workbook
Workbook book = new Workbook("template.spreadsheetml");
// guardar HOJA DE CÁLCULO como XLS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de SPREADSHEETML a XLS" sectionDescription="[Convertir HOJA DE CALCULO a XLS](https://products.aspose.app/cells/conversion/spreadsheetml-to-xls) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo SPREADSHEETML, se convertirá instantáneamente a XLS." >}}
