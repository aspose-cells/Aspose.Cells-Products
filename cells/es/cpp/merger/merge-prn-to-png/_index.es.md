...
url: /es/cpp/merger/merge-prn-to-png/ 
...
El siguiente ejemplo demuestra cómo fusionar PRN con PNG en Aspose.Cells for C++.
...
¿Necesita fusionar PRN con PNG mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para fusionar PRN con PNG" %}}
