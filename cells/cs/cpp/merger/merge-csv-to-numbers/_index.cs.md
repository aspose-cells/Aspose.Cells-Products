---
title: Sloučit CSV na ČÍSLA – Sloučit CSV na ČÍSLA v C++
url: /cs/cpp/merger/merge-csv-to-numbers/ 
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma CSV do formátu uložení NUMBERS. C++ Spojte CSV do formátu ČÍSLA. Sloučit CSV na ČÍSLA v C++. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV na NUMBERS v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit CSV do NUMBERS v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení CSV do NUMBERS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru NUMBERS. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí CSV do NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení CSV na NUMBERS v C++" InputFormat="csv" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV do NUMBERS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit CSV do NUMBERS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení CSV do ČÍSEL" %}}
