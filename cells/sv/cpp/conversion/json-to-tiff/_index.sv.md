...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera JSON-fil till TIFF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda JSON-fil med Factory::CreateIWorkbook.1. Välj det första kalkylbladet.1. Ställ in (TIFF) alternativ.1. Iterera genom varje sida av arket och rendera.1. Öppna TIFF-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="JSON till TIFF C++ konverteringskällkod" offSpacer="" %}}
