---
title:  Proteger y bloquear documento XLSB vía C++
weight: 4860
description: Código de ejemplo C++ para bloquear el archivo XLSB usando la contraseña en el entorno de tiempo de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
---
...
{{% blocks/products/pf/agp/content h2="Cómo asegurar el archivo XLSB usando C++" %}}
...
1.  Cargue el archivo XLSB usando la clase IWorkbook
1.  Utilice el método Protect(..) con ProtectionType y Password
1.  Guarde el archivo XLSB protegido con el método Save()
