---
title: "TSV konvertálása CSV-vé a következőn keresztül: Java "
weight: 1720
url: /hu/java/conversion/tsv-to-csv/ 
description: Minta Java konverziós kód a TSV-formátumhoz CSV-fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására CSV-fájlba bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV konvertálása CSV-vé a következőn keresztül: Java" h2="TSV-ből CSV-vé Java konverzió egyetlen vagy több oldal konvertálásához CSV-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása CSV-vé a következővel: Java" %}}

 Ahhoz, hogy a TSV-t CSV-vé alakíthassuk, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TSV-ből CSV-vé konvertálás lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak TSV-fájlt CSV-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. TSV-fájl betöltése a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat CSV kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott CSV-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TSV-ből CSV-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TSV-fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tsv");
// mentse a TSV-t CSV-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TSV-ből CSV-be konvertáló élő bemutatók" sectionDescription="[Konvertálja a TSV-t CSV-vé](https://products.aspose.app/cells/conversion/tsv-to-csv) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a TSV-fájlt, és azonnal CSV-vé alakul." >}}
