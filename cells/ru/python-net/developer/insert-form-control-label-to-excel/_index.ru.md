...
{{% blocks/products/pf/agp/content h2="Как вставить метку (элемент управления формой) в файл Excel, используя Python via .Net" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте добавление коллекции форм[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_label/#int-int-int-int-int-int) чтобы вставить метку (элемент управления формой) в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить метку (управление формой) - Python via .Net" offSpacer="" %}}
