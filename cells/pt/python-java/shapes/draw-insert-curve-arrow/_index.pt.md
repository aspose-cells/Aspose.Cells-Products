---
title: Como desenhar ou inserir uma seta curva no Excel usando Python via Java
weight: 10
description: Desenhe ou insira uma seta curva usando Aspose.Cells' Python via Java API sem qualquer software como Microsoft ou Open Office, Adobe PDF, etc.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insira a forma de uma seta curva no Excel usando Python via Java" h2="Insira a forma de seta curva usando Aspose.Cells\' API sem qualquer software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir a forma de uma seta curva em um arquivo Excel usando Python via Java" %}}

 Para inserir a forma de uma seta curva em um arquivo Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir formato de seta curva em arquivo Excel usando Python via Java" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Use o shapecollection[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) para inserir uma forma de seta curva na planilha selecionada.
...
{{% blocks/products/pf/agp/code-block title="Inserir formato de seta curva - Python via Java" offSpacer="" %}}
