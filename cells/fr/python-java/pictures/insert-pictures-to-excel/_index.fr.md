...
{{% blocks/products/pf/agp/content h2="Comment insérer une image dans un fichier Excel en utilisant Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une image dans un fichier Excel en utilisant Python via java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection d'images[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) pour insérer une image dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer une image - Python via java" offSpacer="" %}}
