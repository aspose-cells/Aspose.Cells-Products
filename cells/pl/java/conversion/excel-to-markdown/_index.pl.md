...
{{% blocks/products/pf/agp/content h2="Konwertuj EXCEL na MARKDOWN używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL do MARKDOWN w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę z programu EXCEL na MARKDOWN w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu MARKDOWN? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu MARKDOWN za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA na MARKDOWN" %}}
{{% blocks/products/pf/agp/text %}}
