...
weight: 5580
description: Codice sorgente C# per bloccare il file ODS utilizzando la password su piattaforme .NET Framework, .NET Core, Mono o Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Crittografa i file ODS tramite C#" h2="Fogli di calcolo Excel protetti da password incluso il formato ODS utilizzando la libreria .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1.  Crea un'istanza della classe Workbook con il percorso del file ODS
