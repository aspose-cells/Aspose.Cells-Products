...
description: Aspose Excel. Python Aspose.Cells. Mesclar SPREADSHEETML com HTML saveformat. Python Combine SPREADSHEETML com o formato HTML. Mesclar SPREADSHEETML com HTML em Python. Mesclar SPREADSHEETML.
...
{{% blocks/products/pf/agp/content h2="Mesclar SPREADSHEETML com HTML usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar SPREADSHEETML com HTML em Python" %}}

exemplo a seguir demonstra como mesclar SPREADSHEETML com HTML em Aspose.Cells for Python via Java.
...
{{% cells-merger title="Exemplo de código para mesclar SPREADSHEETML com HTML em Python" InputFormat="xml" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SPREADSHEETML com HTML via Python" %}}
