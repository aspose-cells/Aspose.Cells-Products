---
title: Konvertera JSON till BMP via Python

description: Exempelkod för konvertering från json till bmp Python. Använd API exempelkod för batch-json-filer för att bmp-konvertera i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar JSON till BMP med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera JSON till BMP via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera JSON-filer till BMP på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda JSON-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med BMP-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande BMP-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera JSON till BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="bmp" IsLandingPage="true" language="python" %}}
