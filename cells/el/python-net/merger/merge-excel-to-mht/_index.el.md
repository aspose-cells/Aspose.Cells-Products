---
title: Συγχώνευση EXCEL σε MHT - Συνδυάστε το EXCEL σε MHT στο Python
url: /el/python-net/merger/merge-excel-to-mht/ 
description: Aspose Excel. Python Aspose.Cells. Δωρεάν Online Συγχώνευση του EXCEL σε μορφή αποθήκευσης MHT. Python Συνδυάστε το EXCEL σε μορφή MHT. Συγχώνευση EXCEL σε MHT στο Python. Συγχώνευση EXCEL.
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το EXCEL με το MHT στο Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Δωρεάν online για συγχώνευση του EXCEL με το MHT στο Python" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το EXCEL με το MHT μέσω του Python" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να συγχωνεύσετε το EXCEL με το MHT μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
