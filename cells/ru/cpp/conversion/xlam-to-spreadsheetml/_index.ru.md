...
Нужно программно преобразовать файлы XLAM в SPREADSHEETML? Разработчики, работающие с файлами C++, могут легко преобразовать файлы XLAM в SPREADSHEETML всего за несколько строк кода.
...
1.  Преобразуйте XLAM в формат SPREADSHEETML, вызвав метод Save().
