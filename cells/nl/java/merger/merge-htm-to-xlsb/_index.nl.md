---
title: HTM samenvoegen met XLSB - HTM samenvoegen met XLSB in Java
url: /nl/java/merger/merge-htm-to-xlsb/ 
description: Aspose Excel. Java Aspose.Cells. HTM samenvoegen naar XLSB opslagformaat. Java Combineer HTM met XLSB formaat. HTM samenvoegen naar XLSB in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTM samen met XLSB in Java" %}}

Het volgende voorbeeld laat zien hoe u HTM samenvoegt met XLSB in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen met XLSB. Upload uw bestanden, bel de Workbook.Combine-methode voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand XLSB. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java waarin HTM wordt samengevoegd met XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om HTM samen te voegen met XLSB in Java" InputFormat="htm" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen met XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met XLSB? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen met XLSB" %}}
