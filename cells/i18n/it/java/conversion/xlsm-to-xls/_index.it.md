---
title: Converti XLSM in XLS tramite Java 
weight: 1080
url: /it/java/conversion/xlsm-to-xls/ 
description: Esempio di codice di conversione Java per il formato XLSM in file XLS. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in XLS all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLSM in XLS tramite Java" h2="Conversione da XLSM a XLS Java per convertire pagine singole o multiple in XLS utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire XLSM in XLS usando Java" %}}

 Per rendere XLSM in XLS, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire XLSM in XLS tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente file XLSM in XLS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLSM con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione XLS e SaveFormat come parametri1. Controllare il percorso specificato per il file XLS risultante
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLSM a XLS Java" offSpacer="" %}}
