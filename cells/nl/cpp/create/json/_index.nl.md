...
{{% blocks/products/pf/agp/text %}}
 ...
 Het is gemakkelijk voor de ontwikkelaars om JSON-bestanden te maken, laden, wijzigen en converteren binnen lopende rapportagetoepassingen voor gegevensverwerking in slechts enkele regels code.
...
1.  Sla de werkmap op als .json-bestand met de methode Save().
