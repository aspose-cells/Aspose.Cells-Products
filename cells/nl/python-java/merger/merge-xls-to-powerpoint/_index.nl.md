---
title: Voeg XLS samen met POWERPOINT - Combineer XLS met POWERPOINT in Python
url: /nl/python-java/merger/merge-xls-to-powerpoint/ 
description: Aspose Excel. Python Aspose.Cells. Gratis online Samenvoegen XLS naar POWERPOINT-opslagformaat. Python Combineer XLS tot POWERPOINT-indeling. Voeg XLS samen met POWERPOINT in Python. XLS Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u XLS kunt samenvoegen met POWERPOINT in Aspose.Cells for Python via Java.
...
{{% cells-merger title="Gratis online om XLS samen te voegen met POWERPOINT in Python" InputFormat="xls" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLS samen te voegen met POWERPOINT via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLS programmatisch samenvoegen met POWERPOINT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
