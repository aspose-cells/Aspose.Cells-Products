...
url: /pl/cpp/merger/merge-fods-to-png/ 
...
Poniższy przykład pokazuje, jak połączyć FODS z PNG w Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz scalić FODS z PNG programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia FODS z PNG" %}}
