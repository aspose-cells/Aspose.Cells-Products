---
title:  Вставьте кнопку «Счетчик» (элемент управления формой) в Excel, используя Java Python via.
weight: 40
description: Python via Исходный код Java для вставки кнопки «Счетчик» (элемент управления формой) в Excel.
...
{{% blocks/products/pf/agp/content h2="Как вставить кнопку «Спин» (элемент управления формой) в файл Excel с помощью Java Python via" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке кнопки «Счет» (элемент управления формой) в файл Excel с использованием Java Python via" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте коллекцию фигур[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить кнопку «Счетчик» (элемент управления «Форма») на выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить кнопку прокрутки (управление формой) — Python via java" offSpacer="" %}}
