...
Poniższy przykład pokazuje, jak przekonwertować XML na MHT w Python.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na MHT przez Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo załadować i przekonwertować XML na MHT w zaledwie kilku wierszach kodu.
