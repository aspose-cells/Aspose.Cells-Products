...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array je užitečné pro zpracování nebo ukládání dat. Soubor XLS můžete převést na Byte Array a také dokument **Byte Array na XLS** pomocí jazyka C#. Abychom převedli XLS na bajtové pole, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Jak převést XLS na Byte Array přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Pro vývojáře je snadné načíst a převést soubory XLS do bajtového pole pro další manipulační úkoly v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Zahrňte jmenný prostor do souboru třídy1. Načtěte vstupní soubor XLS pomocí sešitu1. Inicializujte objekt MemoryStream1. Převeďte datový proud na bajtové pole1. Zpracovávejte data dle vašeho požadavku
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod XLS na pole bajtů C#" offSpacer="" %}}
