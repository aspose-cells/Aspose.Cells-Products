---
title: دمج XML في أرقام - ادمج XML في أرقام في Python
url: /ar/python-net/merger/merge-xml-to-numbers/ 
description: Aspose إكسل. Python Aspose.Cells. دمج XML مجانًا على الإنترنت إلى تنسيق حفظ الأرقام. Python دمج XML في نسق أرقام. دمج XML إلى أرقام في Python. دمج XML.
...
يوضح المثال التالي كيفية دمج XML مع أرقام في Aspose.Cells for Python via .NET.
...
{{% cells-merger title="مجاني على الإنترنت لدمج XML في أرقام في Python" InputFormat="xml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XML في أرقام عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج XML في NUMBERS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
