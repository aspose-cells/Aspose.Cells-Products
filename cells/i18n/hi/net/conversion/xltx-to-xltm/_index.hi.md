---
title: XLTX को XLTM में परिवर्तित करें C# के द्वारा
url: /hi/net/conversion/xltx-to-xltm/
description: xltx से xltm C# रूपांतरण के लिए नमूना कोड। बैच xltx फ़ाइलों के लिए VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर xltm रूपांतरण के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET डेवलपर कोड की कुछ ही पंक्तियों में आसानी से XLTX फ़ाइलों को XLTM में लोड और रूपांतरित कर सकते हैं।
...
{{% cells-convert title="XLTX को XLTM में बदलने के लिए फ्री ऐप और सैंपल कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xltm" IsLandingPage="true" %}}
