---
title:  سبليت XLSB ملفات via .NET
weight: 7370
description: كود المصدر C# لتقسيم XLSB مستندًا على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تقسيم الملفات XLSB في C#" %}}
...
+ قم بتحميل الملف XLSB بالمسار الكامل للتقسيم.
+ كرر من خلال كل ورقة
...
+ استدعاء الأسلوب Save () وتمرير اسم الملف (المسار الكامل) وSaveFormat.Xlsb كمعلمة.
