---
title: Konvertálja az XLS-t SVG-vé a C++ alkalmazással 
weight: 2060
url: /hu/cpp/conversion/xls-to-svg/ 
description: Minta C++ konverziós kód XLS dokumentumhoz SVG formátumba. A programozók ezt a forráskódot használhatják kötegelt XLS-ből SVG-vé konvertálásához bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS konvertálása SVG-vé a következőn keresztül: C++" h2="Nagy teljesítményű XLS-SVG konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ fejlesztői könnyedén konvertálhatnak XLS-fájlt SVG-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS fájlt a Factory::CreateIWorkbook segítségével.1. Válassza ki az első munkalapot.1. Állítsa be az (SVG) opciókat.1. Ismételje meg a lap minden oldalát, és jelenítse meg.1. Nyissa meg az SVG fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLS-ből SVG-be C++ konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS-ből SVG-be konvertáló élő bemutatók" sectionDescription="[Konvertálja az XLS-t SVG-vé](https://products.aspose.app/cells/conversion/xls-to-svg) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel XLS fájlját, és azonnal SVG formátumba konvertálódik." >}}
