...
description: Aspose Unggul. Ubah XLTM menjadi PNG dengan cepat dan mudah dengan Aspose.Cells. Python XLTM menjadi PNG. Python Simpan XLTM menjadi PNG. Simpan XLTM sebagai 07611134 81 menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah XLTM menjadi PNG di Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTM hingga PNG di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLTM menjadi PNG di Python via NET.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLTM menjadi PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="png" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengubah XLTM menjadi PNG" %}}
