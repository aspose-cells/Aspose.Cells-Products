...
description: Aspose Excel. Chuyển đổi OTS sang PRN nhanh chóng và dễ dàng với Aspose.Cells. Python OTS sang PRN. Python Lưu OTS vào PRN. Lưu OTS dưới dạng PRN bằng Python.
...
{{% blocks/products/pf/agp/content h2="Lưu OTS vào PRN theo số Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi OTS sang PRN trong Python.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi OTS sang PRN" %}}
