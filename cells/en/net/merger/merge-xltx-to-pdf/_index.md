---
title: Merge XLTX to PDF via C# 
url: /net/merger/merge-xltx-to-pdf/ 
description: Merge XLTX to PDF Online for Free. Free Online XLTX Merger. Merge XLTX to Word, Excel, PPTX, PDF, JPG, HTML, ODS, BMP, PNG, SVG, XPS and more.
---
...
The following example demonstrates how to merge XLTX to PDF in C#.
...
{{% cells-merger title="Free App to merge XLTX to PDF on line" InputFormat="xltx" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
