...
description: Aspose Excel. Python Excel. Mesclar SPREADSHEETML com BMP saveformat. Python Combine SPREADSHEETML com o formato BMP. Mesclar SPREADSHEETML com BMP na biblioteca Python do Excel. Mesclar PLANILHAML.
...
{{% blocks/products/pf/agp/content h2="Mesclar SPREADSHEETML com BMP usando a biblioteca Python do Excel" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar SPREADSHEETML com BMP na biblioteca Python do Excel" %}}

O exemplo a seguir demonstra como mesclar SPREADSHEETML com BMP em Aspose.Cells for Python via Java.
...
{{% cells-merger title="Código de exemplo para mesclar SPREADSHEETML com BMP na biblioteca Python do Excel" InputFormat="xml" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SPREADSHEETML com BMP por meio da biblioteca Python do Excel" %}}
