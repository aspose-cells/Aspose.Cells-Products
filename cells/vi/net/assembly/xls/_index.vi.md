---
title:  Tạo báo cáo trong XLS Tệp via .NET
weight: 1700
description: Mã nguồn C# để tạo báo cáo định dạng XLS trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Các Bước Lắp Ráp XLS qua C#" %}}
...
1. Lưu kết quả ở định dạng XLS thông qua phương thức WorkbookDesigner.Worbook.Save
