---
title: C# XLS bis XLT - XLS bis XLT Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das Format XLT und ermöglicht das nahtlose Speichern von XLS-Daten im Format XLT mithilfe der Aspose.Cells-Bibliothek – alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis XLT in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in C# in XLT umwandelt.
...
{{% cells-convert title="Beispielcode zur Umwandlung von XLS in XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in XLT" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in XLT konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in XLT laden und konvertieren.
...
1.  Konvertieren Sie XLS in XLT durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in XLT" %}}
