...
url: /nl/cpp/merger/merge-sxc-to-sql/ 
...
In het volgende voorbeeld ziet u hoe u SXC samenvoegt met SQL in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u SXC programmatisch samenvoegen met SQL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++-bibliotheek om SXC samen te voegen met SQL" %}}
