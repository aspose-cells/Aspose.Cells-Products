...
url: /fr/net/merger/merge-excel-to-ots/ 
...
L'exemple suivant montre comment fusionner EXCEL avec OTS dans Aspose.Cells for .NET.
...
Besoin de fusionner EXCEL avec OTS par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner EXCEL à OTS" %}}
