...
Ví dụ sau minh họa cách hợp nhất XLTX vào POWERPOINT trong Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Cần hợp nhất XLTX với POWERPOINT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API có thể được thực hiện chỉ với vài dòng mã.
