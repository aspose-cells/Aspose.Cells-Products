---
title: Voeg XLS samen met DOCX - Combineer XLS met DOCX in Python
url: /nl/python-java/merger/merge-xls-to-docx/ 
description: Aspose Excel. Python Aspose.Cells. Gratis online Samenvoegen XLS naar DOCX saveformat. Python Combineer het formaat XLS tot DOCX. Samenvoegen XLS tot DOCX in Python. XLS Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u XLS kunt samenvoegen met DOCX in Aspose.Cells for Python via Java.
...
{{% cells-merger title="Gratis online om XLS samen te voegen tot DOCX in Python" InputFormat="xls" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLS samen te voegen met DOCX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLS programmatisch samenvoegen tot DOCX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
