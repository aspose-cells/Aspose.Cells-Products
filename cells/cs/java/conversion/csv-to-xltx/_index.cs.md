---
title: Převést CSV na XLTX prostřednictvím Java 
weight: 4680
url: /cs/java/conversion/csv-to-xltx/ 
description: Ukázkový konverzní kód Java pro formát CSV na soubor XLTX. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLTX v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést CSV na XLTX prostřednictvím Java" h2="Převod CSV na XLTX Java pro převod jedné nebo více stránek na XLTX pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na XLTX pomocí Java" %}}

 K vykreslení CSV do XLTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod CSV na XLTX prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na XLTX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLTX a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLTX
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na XLTX Java" offSpacer="" %}}

```cs
// načíst soubor CSV v instanci sešitu
Workbook book = new Workbook("template.csv");
// uložit CSV jako XLTX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze CSV na XLTX" sectionDescription="[Převést CSV na XLTX](https://products.aspose.app/cells/conversion/csv-to-xltx) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor CSV, bude okamžitě převeden na XLTX." >}}
