---
title:  Birleştirme XLT Dosyalar via Java
weight: 9960
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment üzerinde XLT belgelerini birleştirmek için Java örnek kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLT Biçimlerini Java\'de birleştir" h2="Sunucu tarafı Java API\'leri kullanılarak yerel XLT belge birleştirme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
+ İlk XLT dosyasını bir Workbook sınıfı örneği ile yükleyin.
+ İkinci XLT belgesini bir Workbook sınıfı örneği ile yükleyin.
+ Combine() yöntemini kullanarak dosyaları birleştirin.
+ birleştirilmiş XLT dosyasını belirtilen yola kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi XLT Birleşme Canlı Demoları" sectionDescription=" XLT belgelerimizi hemen şimdi ziyaret ederek birleştirin[Canlı Demolar web sitesi](https://products.aspose.app/cells/merger). Canlı demo aşağıdaki avantajlara sahiptir" >}}
