---
title:  Mesclar MHTML para XLSB via Python
url: /pt/python-net/merger/merge-mhtml-to-xlsb/ 
description: Mesclar MHTML para XLSB Online gratuitamente. Online Grátis MHTML a XLSB Fusão. Mesclar MHTML para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar MHTML a XLSB em Python.
...
{{% cells-merger title="Aplicativo gratuito para mesclar MHTML a XLSB on-line" InputFormat="mhtml" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
