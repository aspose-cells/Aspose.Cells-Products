...
{{% blocks/products/pf/agp/text %}}
 ...
 นักพัฒนา C++ สามารถแปลง HTML เป็น XLSB ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ HTML โดยใช้ Factory::CreateIWorkbook
1. แปลง HTML เป็น XLSB โดยเรียกเมธอด Save()
