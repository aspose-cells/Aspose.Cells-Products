...
Das folgende Beispiel zeigt, wie SPREADSHEETML in POWERPOINT in Python via NET konvertiert wird.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SPREADSHEETML in POWERPOINT" %}}
