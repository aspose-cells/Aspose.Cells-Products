...
keywords: [Merge PRN to XLS via C#., PRN to XLS Merger., Merge PRN to XLS Online for Free]
---
...
The following example demonstrates how to merge PRN to XLS in C#.
...
{{% cells-merger title="Free App to merge PRN to XLS on line" InputFormat="prn" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
