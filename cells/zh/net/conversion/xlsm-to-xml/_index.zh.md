---
title: C# XLSM转XML - 在线XLSM转XML转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 XLSM 转换为 XML 保存格式。 C# XLSM 为 XML 格式。将 XLSM 保存为 XML C#。
...
{{% blocks/products/pf/agp/content h2="免费在线将 XLSM 保存为 XML C#" %}}

以下示例演示如何将 XLSM 转换为 C# 中的 XML。
...
{{% cells-convert title="将 XLSM 在线转换为 XML 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLSM 转换为 XML" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 文件转换为 XML？ .NET 开发人员只需几行代码即可轻松加载 XLSM 并将其转换为 XML。
...
{{% blocks/products/pf/agp/content h2="C# 库将 XLSM 转换为 XML" %}}
