...
description: Aspose Excel. Converta JPG em XPS de forma rápida e fácil com Aspose.Cells. Java JPG em XPS. Java Salve JPG em XPS. Salve JPG como XPS usando Java.
...
{{% blocks/products/pf/agp/content h2="Converter JPG em XPS usando Java" %}}
...
{{% blocks/products/pf/agp/content h2="Salve JPG em XPS em Java" %}}
...
{{% cells-convert title="Exemplo de código para converter JPG em XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xps" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter JPG para XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPG para XPS programaticamente? Os desenvolvedores do Java podem converter facilmente JPG em XPS em apenas algumas linhas de código.
