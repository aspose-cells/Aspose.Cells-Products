...
description: Aspose Excel. C# Aspose.Cells. Unisci SXC al formato di salvataggio TABDELIMITED. C# Combina SXC nel formato TABDELIMITED. Unisci SXC a TABDELIMITED in C#. SXC Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci SXC a TABDELIMITED in C#" %}}

Nell'esempio seguente viene illustrato come unire SXC in TABDELIMITED in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire SXC a TABDELIMITED. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file TABDELIMITED. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedi l'esempio C# che unisce SXC a TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Codice di esempio per unire SXC a TABDELIMITED in C#" InputFormat="sxc" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire SXC a TABDELIMITED tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 È necessario unire SXC a TABDELIMITED a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria .NET da unire SXC a TABDELIMITED" %}}
