---
title: PHP OTS إلى PDF - OTS إلى PDF محول
description: Aspose اكسل. قم بتحويل OTS إلى PDF بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى PDF. PHP احفظ OTS إلى PDF. احفظ OTS كـ PDF باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى PDF عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى PDF برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى PDF في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى PDF عن طريق استدعاء طريقة حفظ المصنف.
