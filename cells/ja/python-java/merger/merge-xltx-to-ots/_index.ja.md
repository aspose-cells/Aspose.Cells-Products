...
url: /ja/python-java/merger/merge-xltx-to-ots/ 
...
次の例は、Aspose.Cells for Python via Java で XLTX を OTS にマージする方法を示しています。
...
XLTXをOTSにプログラム的にマージする必要がありますか？基本的な文書のマージと連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
