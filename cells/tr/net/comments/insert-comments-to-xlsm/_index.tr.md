---
title: XLSM dosyasına yorum ekleyin via .NET
...
{{% blocks/products/pf/agp/content h2="XLSM dosyasına C# yoluyla nasıl yorum eklenir?" %}}
...
{{% blocks/products/pf/agp/code-block title="C# XLSM dosyasındaki yorumları eklemek ve kaldırmak için örnek kod" offSpacer="" %}}
