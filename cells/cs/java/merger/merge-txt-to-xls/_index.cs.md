---
title:  Sloučit TXT až XLS via Java
...
Následující příklad ukazuje, jak sloučit TXT až XLS v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až XLS online" InputFormat="txt" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
