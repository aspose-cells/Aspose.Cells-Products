---
title: إنشاء PDF ملفات via Java
description: PDF مبتكر. إنشاء PDF ملفات في Java كود. قم بإنشاء ملفات PDF باستخدام تطبيق ويب أو سطح مكتب يستند إلى Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء PDF ملف via Java" h2="إنشاء PDF أصلي وعالي الأداء (تنسيق المستند المحمول) برمجيًا باستخدام مكتبة Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء PDF via Java" %}}
...
1.  احفظ المصنف بتنسيق PDF باستخدام طريقة save ().

{{% blocks/products/pf/agp/code-block title="يوضح كود المصدر التالي كيفية إنشاء ملف PDF باستخدام Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لإنشاء ملف PDF" %}}
{{% blocks/products/pf/agp/text %}}
