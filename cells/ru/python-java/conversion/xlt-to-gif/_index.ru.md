...
{{% blocks/products/pf/agp/content h2="Преобразуйте XLT в GIF, используя Python." %}}
...
В следующем примере показано, как преобразовать XLT в GIF в Python.
