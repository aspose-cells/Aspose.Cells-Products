...
url: /tr/cpp/merger/merge-excel-to-mht/ 
...
Aşağıdaki örnek, Aspose.Cells for C++'de EXCEL'in MHT ile nasıl birleştirileceğini gösterir.
...
EXCEL'i programlı olarak MHT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i MHT ile birleştirmek için C++ kitaplığı" %}}
