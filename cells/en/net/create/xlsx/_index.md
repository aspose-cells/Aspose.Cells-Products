...
{{% blocks/products/pf/agp/content h2="How to Create XLSX in C#" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to create, load, modify and convert XLSX files within running different reporting applications for data processing in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create XLSX file in C#." offSpacer="" %}}
