---
title: 通過 C# 將 NUMBERS 轉換為 TABDELIMITED
url: /zh-hant/net/conversion/numbers-to-tabdelimited/
description: 數字到製表符分隔的 C# 轉換的示例代碼。在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中，將批號文件的 API 示例代碼用於製表符分隔的轉換。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 NUMBERS 轉換為 TABDELIMITED" h2="在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上將 Excel® 電子表格導出為 TABDELIMITED 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="如何使用 C# 將 NUMBERS 轉換為 TABDELIMITED" %}}

 為了將 NUMBERS 轉換為 TABDELIMITED，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 將 NUMBERS 轉換為 TABDELIMITED 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開發人員只需幾行代碼即可輕鬆加載 NUMBERS 文件並將其轉換為 TABDELIMITED。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 實例加載 NUMBERS 文件1. 調用 Workbook.Save 方法1. 以 TSV 擴展名作為參數傳遞輸出路徑1. 檢查生成的 TABDELIMITED 文件的指定路徑
...
{{% cells-convert title="將 NUMBERS 轉換為 TABDELIMITED 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tsv" IsLandingPage="true" %}}
