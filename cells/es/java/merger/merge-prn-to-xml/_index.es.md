---
title: Combinar PRN con XML - Combinar PRN con XML en Java
url: /es/java/merger/merge-prn-to-xml/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea de PRN a formato de guardado XML. Java Combina PRN con formato XML. Combinar PRN con XML en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN a XML en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar PRN con XML en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar PRN con XML. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo XML. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que combina PRN con XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar PRN a XML en Java" InputFormat="prn" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo combinar PRN con XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar PRN con XML mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar PRN a XML" %}}
