---
title: Połącz OBRAZ z MHT - Połącz OBRAZ z MHT w C#
url: /pl/net/merger/merge-image-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Scal OBRAZ do formatu zapisu MHT. C# Połącz OBRAZ z formatem MHT. Połącz OBRAZ z MHT w C#. Połącz OBRAZ.
...
{{% blocks/products/pf/agp/content h2="Połącz OBRAZ z MHT w C#" %}}

Poniższy przykład pokazuje, jak połączyć IMAGE z MHT w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć IMAGE z MHT. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku MHT. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy IMAGE z MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia OBRAZU z MHT w C#" InputFormat="png" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć OBRAZ z MHT poprzez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć IMAGE z MHT? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka .NET do scalania OBRAZU z MHT" %}}
