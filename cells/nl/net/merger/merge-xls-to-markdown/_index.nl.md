---
title: Voeg XLS samen met MARKDOWN - Combineer XLS met MARKDOWN in C#
url: /nl/net/merger/merge-xls-to-markdown/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen XLS naar MARKDOWN saveformat. C# Combineer het formaat XLS tot MARKDOWN. Samenvoegen XLS tot MARKDOWN in C#. XLS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met MARKDOWN in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLS samenvoegt met MARKDOWN in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLS samen te voegen met MARKDOWN. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand MARKDOWN. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat XLS samenvoegt met MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om XLS samen te voegen tot MARKDOWN in C#" InputFormat="xls" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLS samen te voegen met MARKDOWN via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLS programmatisch samenvoegen tot MARKDOWN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLS samen te voegen tot MARKDOWN" %}}
