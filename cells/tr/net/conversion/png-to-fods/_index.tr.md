---
title: C# PNG ila FODS - PNG ila FODS Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilerine PNG'i FODS formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, PNG verilerinin FODS formatına Aspose.Cells kütüphanesi kullanılarak sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="PNG\'i FODS olarak C#\'e kaydedin." %}}

Aşağıdaki örnek, C#'de PNG'i FODS'e nasıl dönüştüreceğinizi göstermektedir.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C# aracılığıyla FODS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını program aracılığıyla FODS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve FODS'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak PNG değerini FODS değerine dönüştürün.
1.  PNG'den FODS'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PNG\'i FODS\'e dönüştürmek için C# kütüphanesi" %}}
