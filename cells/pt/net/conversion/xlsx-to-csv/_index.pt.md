---
title: C# XLSX a CSV - XLSX a CSV Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato CSV, permitindo o salvamento perfeito de dados XLSX no formato CSV usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a CSV em C#" %}}

exemplo a seguir demonstra como converter XLSX em CSV em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX em CSV. Carregue seu arquivo XLSX e simplesmente salve-o como arquivo CSV. Para leitura de XLSX e gravação de CSV, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída CSV serão idênticos ao documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter XLSX em CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="csv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX em CSV por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX em CSV programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em CSV em apenas algumas linhas de código.
...
1.  Converta XLSX para CSV chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para CSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em CSV" %}}
