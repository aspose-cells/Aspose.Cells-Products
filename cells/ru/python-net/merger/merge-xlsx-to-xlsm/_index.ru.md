---
title:  Объединить XLSX с XLSM через Python
url: /ru/python-net/merger/merge-xlsx-to-xlsm/ 
description: Объедините XLSX с XLSM онлайн бесплатно. Бесплатный онлайн XLSX до XLSM Слияние. Объединить XLSX в Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS и другие.
---
...
В следующем примере показано, как объединить XLSX с XLSM в Python.
...
{{% cells-merger title="Бесплатное приложение для объединения XLSX с XLSM онлайн" InputFormat="xlsx" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
