...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLTX do formatu zapisu ETT. C# Połącz XLTX z formatem ETT. Połącz XLTX z ETT w C#. XLTX Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTX z ETT w C# online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLTX z ETT w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć numer XLTX z ETT. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku ETT. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy XLTX z ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTX z ETT w C#" InputFormat="xltx" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTX z ETT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć numer XLTX z ETT? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLTX z ETT" %}}
