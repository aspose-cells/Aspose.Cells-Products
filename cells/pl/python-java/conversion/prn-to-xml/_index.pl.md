...
{{% blocks/products/pf/agp/content h2="Konwertuj PRN na XML za pomocą biblioteki Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN w formacie XML w bibliotece Excel Python" %}}

Poniższy przykład ilustruje konwersję PRN na XML w bibliotece Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteka Excel do konwersji PRN na XML" %}}
