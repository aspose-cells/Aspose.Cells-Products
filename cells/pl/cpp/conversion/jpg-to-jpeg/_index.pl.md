...
description: Aspose Excel. Konwertuj JPG na JPEG szybko i łatwo za pomocą Aspose.Cells. C++ JPG na JPEG. C++ Zapisz JPG na JPEG. Zapisz JPG jako JPEG używając C++.
...
{{% blocks/products/pf/agp/content h2="Konwertuj JPG na JPEG za pomocą C++" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz JPG pod numerem JPEG w C++" %}}
...
{{% cells-convert title="Przykładowy kod do konwersji JPG na JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować JPG na JPEG przez C++" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki JPG na JPEG? Programiści C++ mogą z łatwością przekonwertować JPG na JPEG w zaledwie kilku linijkach kodu.
...
1.  Konwertuj JPG na JPEG, wywołując metodę Save().
1.  Uzyskaj wynik konwersji JPG na JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C++ do konwersji JPG na JPEG" %}}
