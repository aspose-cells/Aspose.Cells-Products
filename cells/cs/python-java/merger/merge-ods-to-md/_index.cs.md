...
url: /cs/python-java/merger/merge-ods-to-md/ 
...
Následující příklad ukazuje, jak sloučit ODS do MD v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit ODS na MD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
