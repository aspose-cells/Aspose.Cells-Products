---
title: 通过 Java 合并 ODS 文件 
weight: 6270
url: /zh/java/merger/ods/ 
description: Java 用于在 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中组合 ODS 文档的示例代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合并 Java 中的 ODS 格式" h2="使用服务器端 Java API 的本机 ODS 文档合并。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 合并 ODS 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中合并 ODS 文件的步骤" %}}
...
+ 使用 Workbook 类的实例加载第一个 ODS 文件。
+ 使用 Workbook 类的实例加载第二个 ODS 文档。
+ 使用 combine() 方法合并文件。
+ 将合并的 ODS 文件保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="合并 ODS 文件 - Java" offSpacer="" %}}
