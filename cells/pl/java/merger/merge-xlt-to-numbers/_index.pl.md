---
title: Połącz XLT z NUMERAMI - Połącz XLT z NUMERAMI w Java
url: /pl/java/merger/merge-xlt-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online XLT do formatu zapisu NUMBERS. Java Połącz XLT w formacie NUMERY. Połącz XLT z NUMBERS w Java. XLT Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLT z NUMBERS w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić XLT z NUMBERS w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić numer XLT z NUMBERS. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku NUMBERS. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy XLT z NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLT z NUMBERS w Java" InputFormat="xlt" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLT z NUMERAMI via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić numer XLT z NUMBERS? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do połączenia XLT z NUMBERS" %}}
