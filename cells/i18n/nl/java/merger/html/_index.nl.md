---
title: HTML-bestanden samenvoegen via Java 
weight: 8830
url: /nl/java/merger/html/ 
description: Java voorbeeldcode om HTML-documenten te combineren in Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="HTML-indelingen samenvoegen in Java" h2="Samenvoeging van native HTML-documenten met server-side Java API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="HTML-bestanden samenvoegen met Java" %}}
...
+ Laad het eerste HTML-bestand met een exemplaar van de Workbook-klasse.
+ Laad het tweede HTML-document met een instantie van de Workbook-klasse.
...
{{% blocks/products/pf/agp/code-block title="HTML-bestanden samenvoegen - Java" offSpacer="" %}}

```cs
// Open het eerste HTML-bestand.
Workbook htmlFile1 = new Workbook("chartsFileWithPath.html");

// Definieer het tweede bronboek.
// Open het tweede HTML-bestand.
