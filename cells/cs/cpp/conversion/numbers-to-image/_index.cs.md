...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu čísel (NUMBERS) do formátu IMAGE, což umožňuje bezproblémové ukládání dat čísel (NUMBERS) do formátu IMAGE pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte ČÍSLA na OBRÁZKY v kódu C++" h2="Vysoce výkonná konverze ČÍSEL na OBRÁZKY s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložit ČÍSLA do OBRÁZKU v C++" %}}

Následující příklad ukazuje, jak převést ČÍSLA na OBRÁZKY v adresáři C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést ČÍSLA na OBRÁZEK přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory NUMBERS do IMAGE? Vývojáři C++ mohou snadno převést NUMBERS do IMAGE pomocí několika řádků kódu.
...
1.  Převeďte ČÍSLA na OBRÁZKY voláním metody Save().
1.  Získejte výsledek převodu NUMBERS na IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod ČÍSEL na OBRÁZKY" %}}
