---
title: Convertisseur C# XLS à PDF - XLS à PDF
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format XLS au format PDF, permettant un enregistrement transparent des données XLS au format PDF à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS au lieu de PDF dans C#" %}}

L'exemple suivant montre comment convertir XLS en PDF dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en PDF. Téléchargez votre fichier XLS, puis enregistrez-le simplement sous le nom de fichier PDF. Pour la lecture XLS et l'écriture PDF, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie PDF seront identiques au document XLS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir XLS en PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en PDF par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en PDF en quelques lignes de code seulement.
