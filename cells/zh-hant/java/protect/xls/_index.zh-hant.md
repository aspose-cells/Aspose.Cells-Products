---
title: 通過 Java 保護和鎖定 XLS 文檔 
weight: 5070
url: /zh-hant/java/protect/xls/ 
description: Java 在 JSP/JSF 應用程序和桌面應用程序的 Java 運行時環境中使用密碼鎖定 XLS 文件的示例代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 加密 XLS 文件" h2="使用 .NET 庫對包括 XLS 格式的 Excel 電子表格進行密碼保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 保護 XLS 文件的步驟" %}}
...
1. 通過實例化 Workbook 類加載 XLS 文件1. 將protect(..) 方法與ProtectionType 和Password 一起使用1. 通過 save() 方法保存受保護的 XLS 文件
