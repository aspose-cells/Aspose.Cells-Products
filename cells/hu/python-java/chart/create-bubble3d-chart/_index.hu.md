...
{{% blocks/products/pf/agp/feature-section-col title="Bubble3D diagramok létrehozása a következőn keresztül: Python" %}}
...
1. Importálja az asposecellákat a kódfájlba.1. Munkafüzet osztálypéldány létrehozása.1. Adjon hozzá néhány adatot a munkalaphoz.1. Adjon hozzá egy Bubble3D diagramot a munkalaphoz1. Az új diagramobjektumot a Diagramok gyűjteményből az indexének átadásával érheti el.1. Állítsa be a diagram adatforrását a Chart.setChartDataRange metódussal.1. Mentés Excel fájlként.
