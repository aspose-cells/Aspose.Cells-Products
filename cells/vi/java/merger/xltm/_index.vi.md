---
title:  Hợp nhất các tập tin XLTM via Java
weight: 8210
description: Java mã mẫu để kết hợp các tài liệu XLTM trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng XLTM trong Java" h2="Hợp nhất tài liệu gốc XLTM bằng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
+ Nạp tệp XLTM đầu tiên với một thể hiện của lớp Workbook.
+ Nạp tài liệu XLTM thứ hai với một thể hiện của lớp Workbook.
+ Hợp nhất các tệp bằng phương thức kết hợp ().
lưu tệp XLTM đã hợp nhất tại đường dẫn đã chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp XLTM - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến XLTM Hợp nhất Bản trình diễn trực tiếp" sectionDescription=" Hợp nhất các tài liệu XLTM ngay bây giờ bằng cách truy cập của chúng tôi[Trang web Demo trực tiếp](https://products.aspose.app/cells/merger). Bản demo trực tiếp có những lợi ích sau" >}}
