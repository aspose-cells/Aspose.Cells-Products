---
title:  Sloučit ODS na MHTML přes Python
...
Následující příklad ukazuje, jak sloučit ODS až MHTML v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení ODS až MHTML online" InputFormat="ods" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
