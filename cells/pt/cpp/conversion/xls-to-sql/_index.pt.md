...
Precisa converter arquivos XLS para SQL programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para SQL com apenas algumas linhas de código.
...
1.  Converta XLS para SQL chamando o método Save().
