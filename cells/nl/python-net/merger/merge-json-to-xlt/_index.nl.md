---
title:  Samenvoegen JSON naar XLT via Python
url: /nl/python-net/merger/merge-json-to-xlt/ 
description: Samenvoegen JSON naar XLT Online gratis. Gratis online JSON tot XLT Fusie. Voeg JSON samen met Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS en meer.
---
...
Het volgende voorbeeld laat zien hoe u JSON samenvoegt met XLT in Python.
...
{{% cells-merger title="Gratis app om JSON online samen te voegen tot XLT" InputFormat="json" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
