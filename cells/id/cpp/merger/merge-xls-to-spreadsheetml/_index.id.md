---
title: Gabungkan XLS ke SPREADSHEETML - Gabungkan XLS ke SPREADSHEETML di C++
url: /id/cpp/merger/merge-xls-to-spreadsheetml/ 
description: Aspose Unggul. C++ Aspose.Cells. Gabungkan XLS ke dalam format simpan SPREADSHEETML. C++ Gabungkan XLS ke format SPREADSHEETML. Gabungkan XLS ke SPREADSHEETML di C++. XLS Gabungkan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan XLS ke SPREADSHEETML melalui C++" h2="Pustaka C++ berkecepatan tinggi untuk menggabungkan XLS ke SPREADSHEETML. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di C++. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="XLS" additionalConversionTag="SPREADSHEETML" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLS ke SPREADSHEETML di C++" %}}

Contoh berikut menunjukkan cara menggabungkan XLS ke SPREADSHEETML di Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLS ke SPREADSHEETML. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file SPREADSHEETML. Jika Anda mengembangkan kode di C++, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C++ yang menggabungkan XLS ke SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLS menjadi SPREADSHEETML di C++" InputFormat="xls" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLS ke SPREADSHEETML melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLS ke SPREADSHEETML secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka C++ untuk digabungkan XLS menjadi SPREADSHEETML" %}}
