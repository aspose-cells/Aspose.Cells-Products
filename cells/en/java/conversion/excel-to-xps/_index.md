---
title: EXCEL to XPS - Convert EXCEL to XPS in Java
description: Aspose Excel. Java Aspose.Cells. Free Online Convert EXCEL to XPS in Java. Java EXCEL to XPS format. Save EXCEL as XPS in Java. Java Aspose Cells.
keywords: [Aspose Excel., Java Aspose.Cells., Java EXCEL to XPS., Free Online Convert EXCEL to XPS in Java., Java Convert EXCEL to XPS., EXCEL to XPS Converter]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert EXCEL to XPS in Java" h2="High-speed Java library for converting EXCEL to XPS. This is a professional software solution to import and export EXCEL, XPS, and many other formats using Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Convert EXCEL to XPS Using Java" %}}

How do I convert EXCEL to XPS? With Aspose.Cells for Java library, you can easily convert EXCEL to XPS programmatically with  a few lines of code. [Aspose.Cells for Java](https://products.aspose.com/cells/java) is capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. Java Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT and more, thus making it a perfect choice to exchange documents in industry-standard formats. You can download its latest version directly from [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) and install it within your Maven-based project by adding the following configurations to the pom.xml.
...
{{% blocks/products/pf/agp/content h2="Save EXCEL to XPS in Java Online for Free" %}}

The following example demonstrates how to convert EXCEL to XPS in Java.
...
{{% blocks/products/pf/agp/content h2="How to Convert EXCEL to XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert EXCEL files to XPS programmatically? Java developers can easily convert EXCEL to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="Java library to convert EXCEL to XPS" %}}
{{% blocks/products/pf/agp/text %}}
