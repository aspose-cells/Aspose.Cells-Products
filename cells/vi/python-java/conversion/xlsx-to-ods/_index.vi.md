---
title: Chuyển đổi XLSX sang ODS qua Python
url: /vi/python-java/conversion/xlsx-to-ods/
description: Mã mẫu cho chuyển đổi xlsx sang ods Python. Sử dụng mã mẫu API cho hàng loạt tệp xlsx để chuyển đổi ods trong ứng dụng Python.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSX sang ODS bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLSX sang ODS qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp XLSX sang ODS chỉ trong một vài dòng mã.
