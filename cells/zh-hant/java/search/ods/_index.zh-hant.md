---
title: 搜索ODS文檔，無需打開via Java
weight: 8140
description: Java 示例代碼，用於在 JSP/JSF 應用程序和桌面應用程序的 Java 運行時環境中搜索 ODS 文件中具有模式的單詞。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="搜索 ODS Java 中的格式" h2="使用服務器端 Aspose.Cells for Java API 進行本機高性能 ODS 文檔搜索，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
為了搜索 ODS 文件，我們將使用
 ...
 API這是一個功能豐富、功能強大且易於使用的搜索API for Java平台。您可以直接從以下位置下載其最新版本
...
{{% blocks/products/pf/agp/feature-section-col title="搜索 Java 中的 ODS 文件的步驟" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的搜索文檔" subTitle="使用Java，還可以搜索其他文件，包括。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/search/txt/" name="TXT" description="文本文檔" >}}
