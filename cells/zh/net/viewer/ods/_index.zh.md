...
weight: 130
description: C# 源代码，用于在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上加载、渲染和显示 ODS 文档。
...
{{< blocks/products/pf/i18n/upper-banner h1="ODS 文件查看器 for .NET" h2="查看 Excel 和 OpenOffice 电子表格，例如 ODS，无需 Microsoft Excel 或 Office Automation。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
Aspose.Cells使得开发者只需几行代码就可以轻松查看ODS文件。

{{% /blocks/products/pf/agp/text %}}

1. 在 Workbook 实例中加载 ODS 文件
1. 创建 HtmlSaveOptions 的实例并将 ExportHeadings 属性设置为 true
1. 使用Workbook.Save方法将ODS文件保存为HTML格式
...
{{% blocks/products/pf/agp/code-block title="C# 查看ODS文件的示例代码" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API 可用于创建、编辑、转换和渲染 Microsoft Excel 格式为不同的格式。此外，它还可用于软件应用程序中的全面图表、可扩展报告和可靠计算。 Aspose.Cells 是一个独立的 API，它不需要任何像 Microsoft 或 OpenOffice 这样的软件。
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="免费应用程序查看 ODS" sectionDescription="查看我们的现场演示[查看ODS](https://products.aspose.app/cells/viewer/ods)具有以下好处。" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text="如果需要，请从链接下载 ODS 文件" >}}
