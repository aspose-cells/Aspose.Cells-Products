---
title: Conversor PHP SXC para DIF - SXC para DIF
description: Aspose Excel. Converta SXC em DIF de forma rápida e fácil com Aspose.Cells. PHP SXC em DIF. PHP Salve SXC em DIF. Salve SXC como DIF usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em DIF via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em DIF programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em DIF em apenas algumas linhas de código.
...
1.  Converta SXC em DIF chamando o método save da pasta de trabalho.
