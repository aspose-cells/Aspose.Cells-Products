---
title: تحويل Java HTM إلى PDF - تحويل HTM إلى PDF
description: Aspose إكسل. يوفر هذا الحل الشامل للمطورين Java نهجًا متكاملًا تمامًا لتحويل HTM إلى تنسيق PDF، مما يتيح حفظ بيانات HTM بسلاسة في تنسيق PDF باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود Java فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل HTM إلى PDF في Java" h2="مكتبة Java عالية السرعة لتحويل ملفات HTM إلى PDF. هذا حل برمجي احترافي لاستيراد وتصدير ملفات HTM وPDF والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ HTM إلى PDF في Java" %}}

يوضح المثال التالي كيفية تحويل HTM إلى PDF في Java.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل HTM إلى PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات HTM إلى PDF برمجيًا؟ يمكن لمطوري Java تحويل ملفات HTM إلى PDF بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل HTM إلى PDF عن طريق استدعاء أسلوب Workbook.save.
1.  احصل على نتيجة تحويل HTM إلى PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل HTM إلى PDF" %}}
{{% blocks/products/pf/agp/text %}}
