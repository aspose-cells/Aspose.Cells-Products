---
title:  XLSM 파일에서 보고서 생성 via .NET
weight: 4400
description: .NET 프레임워크, .NET 코어, Mono 또는 Xamarin 플랫폼에서 XLSM 형식 보고서를 생성하는 C# 소스 코드.
---
...
1. WorkbookDesigner.Worbook.Save 메서드를 통해 결과를 XLSM 형식으로 저장
