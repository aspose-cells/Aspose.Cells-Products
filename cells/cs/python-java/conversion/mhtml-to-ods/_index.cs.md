---
title: Python MHTML až ODS - MHTML až ODS Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Python plně integrovaný přístup k převodu formátu MHTML do formátu ODS, což umožňuje bezproblémové ukládání dat MHTML do formátu ODS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na ODS v knihovně Excel Python" h2="Vysokorychlostní knihovna excel Python pro převod MHTML na ODS. Jedná se o profesionální softwarové řešení pro import a export MHTML, ODS a mnoha dalších formátů pomocí Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Převést MHTML na ODS pomocí knihovny Excel Python" %}}

 Jak převedu MHTML na ODS? S knihovnou Aspose.Cells for Python můžete snadno převést MHTML na ODS programově pomocí několika řádků kódu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)je schopen vytvářet multiplatformní aplikace se schopností generovat, upravovat, konvertovat, vykreslovat a tisknout všechny soubory aplikace Excel. Python Excel API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat soubory Excel jako obrázky, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT a další, takže je perfektní volbou pro výměnu dokumentů ve standardních průmyslových formátech.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Uložit MHTML až ODS v knihovně Excel Python" %}}

Následující příklad ukazuje, jak převést MHTML na ODS v knihovně Excel Python.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod MHTML na ODS. Nahrajte svůj soubor MHTML a poté jej jednoduše uložte jako soubor ODS. Pro čtení MHTML i zápis ODS můžete použít plně kvalifikované názvy souborů. Výstupní ODS obsah a formátování bude shodné s původním dokumentem MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod MHTML na ODS prostřednictvím knihovny Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mhtml" outformat="ods" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést MHTML na ODS přes Python" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na ODS programově? Vývojáři Python mohou snadno načíst a převést MHTML na ODS v několika řádcích kódu.
...
1.  Převeďte MHTML na ODS voláním metody Workbook.save.
1.  Získejte výsledek převodu MHTML na ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod MHTML na ODS" %}}
