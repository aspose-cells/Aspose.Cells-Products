---
title: Créer PNG - Créer un fichier PNG dans C++
description: Aspose Excel. C++ Créer un fichier PNG. Créer PNG C++. C++ PNG Créateur. Créez PNG dans C++. Générez le fichier PNG en utilisant C++.
keywords: [Aspose Excel., C++ Aspose.Cells., Create PNG C++., C++ PNG Creater., Create PNG file in C++., Generate PNG file in C++]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier PNG dans C++" h2="Création de fichiers natifs et hautes performances PNG par programmation sans Micorsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer PNG dans C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers PNG dans des applications de création de rapports en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
1.  Enregistrez le classeur en tant que fichier .png à l'aide de la méthode Save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier PNG dans C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="bibliothèque C++ pour créer le fichier PNG" %}}
