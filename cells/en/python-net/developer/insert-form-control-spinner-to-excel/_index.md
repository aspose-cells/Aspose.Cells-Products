---
title: Insert Spin Button(Form control) into Excel using Python via .Net 
weight: 40

description: Python via .Net source code to insert Spin Button(Form control) into Excel.
...
{{% blocks/products/pf/agp/content h2="How to Insert Spin Button(Form control) into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Spin Button(Form control) to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_spinner/#int-int-int-int-int-int) to insert a Spin Button(Form control) in the selected worksheet.
