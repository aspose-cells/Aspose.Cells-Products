---
title: Konwertuj XLSB na ODS przez Python
url: /pl/python-java/conversion/xlsb-to-ods/
description: Przykładowy kod konwersji xlsb do ods Python. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji ods w aplikacji Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na ODS przez Python" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu ODS przy użyciu Python interfejsów API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na ODS za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować XLSB na ODS za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki XLSB na ODS w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem ODS jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku ODS
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLSB na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="ods" IsLandingPage="true" language="python" %}}
