...
url: /nl/net/merger/merge-png-to-sql/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online samenvoegen PNG naar SQL-opslagformaat. C# Combineer PNG naar SQL-indeling. Voeg PNG samen met SQL in C#. PNG Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis PNG samen met SQL in C# online" %}}

Het volgende voorbeeld laat zien hoe u PNG kunt samenvoegen met SQL in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PNG samen te voegen met SQL. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een SQL-bestand. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat PNG samenvoegt met SQL.
...
{{% blocks/products/pf/agp/content h2="Hoe PNG samen te voegen met SQL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PNG programmatisch samenvoegen met SQL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen met SQL" %}}
