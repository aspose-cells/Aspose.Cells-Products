...
description: Aspose Excel. Python Excel. Converti XLSM in XML in modo rapido e semplice con Aspose.Cells. Python XLSM in XML. Python Salva XLSM in XML. Salva XLSM come XML utilizzando la libreria Excel Python.
...
{{% blocks/products/pf/agp/content h2="Converti XLSM in XML nella libreria Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Salva XLSM in XML nella libreria Excel Python" %}}

L'esempio seguente dimostra come convertire XLSM in XML nella libreria Excel Python.
...
{{% cells-convert title="Codice di esempio per convertire XLSM in XML tramite la libreria Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xml" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Libreria Excel per convertire XLSM in XML" %}}
