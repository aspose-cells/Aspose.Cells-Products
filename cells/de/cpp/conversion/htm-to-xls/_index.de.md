...
description: Aspose Excel. Konvertieren Sie HTM schnell und einfach in XLS mit Aspose.Cells. C++ HTM in XLS. C++ Speichern Sie HTM in XLS. Speichern Sie HTM als XLS mit C++.
...
{{% cells-convert title="Beispielcode zum Konvertieren von HTM in XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xls" IsLandingPage="true" language="cpp" %}}
