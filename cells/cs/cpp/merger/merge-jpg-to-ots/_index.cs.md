...
url: /cs/cpp/merger/merge-jpg-to-ots/ 
...
Následující příklad ukazuje, jak sloučit JPG do OTS v Aspose.Cells for C++.
...
Potřebujete programově sloučit JPG do OTS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení JPG do OTS" %}}
