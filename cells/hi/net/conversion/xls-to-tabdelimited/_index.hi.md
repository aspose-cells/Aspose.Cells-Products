...
description: Aspose एक्सेल। Aspose.Cells के साथ XLS को TABDELIMITED में जल्दी और आसानी से बदलें। C# XLS को TABDELIMITED में बदलें। C# XLS को TABDELIMITED में सहेजें। C# का उपयोग करके XLS को TABDELIMITED के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="XLS को C# में TABDELIMITED में सहेजें" %}}
...
{{% cells-convert title="XLS को TABDELIMITED में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="tsv" IsLandingPage="true" %}}
