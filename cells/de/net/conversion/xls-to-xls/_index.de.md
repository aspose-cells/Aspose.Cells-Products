---
title: C# XLS zu XLS - Online-Konverter von XLS zu XLS
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das Speicherformat XLS. C# XLS bis XLS Format. Speichern Sie XLS bis XLS C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis XLS in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLS in XLS in C# konvertiert wird.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in XLS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in XLS konvertieren? .NET-Entwickler können XLS problemlos in nur wenigen Codezeilen laden und in XLS konvertieren.
...
1.  Konvertieren Sie XLS in XLS, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in XLS" %}}
