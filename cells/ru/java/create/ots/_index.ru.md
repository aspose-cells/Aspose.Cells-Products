---
title: Создать OTS - Создать файл OTS в Java
description: Aspose Excel. Java Создать файл OTS. Создайте OTS Java. Java Создатель OTS. Создайте OTS в Java. Создайте файл OTS, используя Java.
...
{{% blocks/products/pf/agp/content h2="Как создать OTS в Java" %}}
...
1.  Сохраните книгу в формате OTS, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл OTS в Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java библиотека для создания файла OTS" %}}
{{% blocks/products/pf/agp/text %}}
