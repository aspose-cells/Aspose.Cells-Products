...
description: Aspose Excel. Konwertuj OTS na XLSX szybko i łatwo za pomocą Aspose.Cells. Java OTS na XLSX. Java Zapisz OTS na XLSX. Zapisz OTS jako XLSX, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS pod numerem XLSX w Java" %}}

Poniższy przykład ilustruje sposób konwersji OTS na XLSX w Java.
...
Chcesz programowo przekonwertować pliki OTS na XLSX? Programiści Java mogą z łatwością przekonwertować OTS na XLSX w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na XLSX" %}}
{{% blocks/products/pf/agp/text %}}
