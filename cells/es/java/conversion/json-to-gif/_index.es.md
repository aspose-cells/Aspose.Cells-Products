---
title: Convierte JSON a GIF a través de Java 
weight: 3740

description: Ejemplo de código de conversión Java de formato JSON a archivo GIF. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a GIF dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte JSON a GIF a través de Java" h2="Exporte JSON a formato GIF a través de Java sin necesidad de herramientas o bibliotecas adicionales." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JSON a GIF usando Java" %}}

 Para convertir JSON en GIF, usaremos
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de JSON a GIF Java" offSpacer="" %}}
...
// guarde el archivo resultante en formato JSON-TO-GIF
