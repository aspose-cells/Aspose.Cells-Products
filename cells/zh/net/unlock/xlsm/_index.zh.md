---
title: 解锁 XLSM 文档 via .NET
weight: 9810
description: C# 源代码，用于解锁 .NET 框架、.NET 核心、Mono 或 Xamarin 平台上受密码保护的 XLSM 文件。
---
...
{{% blocks/products/pf/agp/content h2="如何使用C#解锁XLSM文件" %}}
