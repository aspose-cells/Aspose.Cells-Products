---
title: Python XLTM'den SQL'e - XLTM'den SQL'e Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile XLTM'i hızlı ve kolay bir şekilde SQL'e dönüştürün. Python XLTM'i SQL'e dönüştürün. Python XLTM'i SQL'e kaydedin. XLTM'i Python'i kullanarak SQL olarak kaydedin.
...
{{% cells-convert title="XLTM\'i SQL\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="sql" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLTM\'i Python aracılığıyla SQL\'e dönüştürme" %}}
