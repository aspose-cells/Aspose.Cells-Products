---
title: Konvertor PHP PNG až XLT - PNG až XLT
description: Aspose Excel. Převeďte PNG na XLT rychle a snadno pomocí Aspose.Cells. PHP PNG na XLT. PHP Uložte PNG na XLT. Uložte XLT jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na XLT přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na XLT programově? Vývojáři PHP mohou snadno načíst a převést PNG na XLT v několika řádcích kódu.
...
1.  Převeďte PNG na XLT voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na XLT" %}}
