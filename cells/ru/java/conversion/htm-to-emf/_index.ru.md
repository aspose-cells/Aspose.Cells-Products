...
{{% blocks/products/pf/agp/content h2="Преобразовать HTM в EMF, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM-код в EMF в Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в EMF в Java.
...
Нужно программно преобразовать HTM-файлы в формат EMF? Разработчики, использующие формат Java, могут легко преобразовать HTM в формат EMF всего несколькими строками кода.
