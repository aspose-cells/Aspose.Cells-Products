---
title: C# JPEG 至 ODS - JPEG 至 ODS 轉換器
description: Aspose Excel。此綜合解決方案為 C# 開發人員提供了一種完全整合的方法，可將 JPEG 轉換為 ODS 格式，從而能夠使用 Aspose.Cells 庫將 JPEG 數據無縫保存為 0761533681533676136481 資料無縫代碼實現。
...
{{% blocks/products/pf/agp/content h2="將 JPEG 儲存到 ODS，即 C#" %}}

以下範例示範如何在 C# 中將 JPEG 轉換為 ODS。
...
{{% cells-convert title="將 JPEG 轉換為 ODS 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 JPEG 轉換為 ODS" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 JPEG 檔案轉換為 ODS 嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入和轉換 JPEG 到 ODS。
...
1. 使用工作簿實例載入 JPEG 檔案。
1. 透過呼叫 Workbook.Save 方法將 JPEG 轉換為 ODS。
1. 取得JPEG到ODS的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="使用 C# 庫將 JPEG 轉換為 ODS" %}}
