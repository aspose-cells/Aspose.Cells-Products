...
url: /nl/cpp/merger/merge-tabdelimited-to-spreadsheetml/ 
...
In het volgende voorbeeld ziet u hoe u TABDELLIMITED samenvoegt met SPREADSHEETML in Aspose.Cells for C++.
...
{{% cells-merger title="Voorbeeldcode voor het samenvoegen van TABDELIMITED naar SPREADSHEETML in C++" InputFormat="tsv" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="TABDELLIMITED samenvoegen met SPREADSHEETML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TABDELLIMITED programmatisch samenvoegen met SPREADSHEETML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++-bibliotheek om TABDELLIMITED samen te voegen met SPREADSHEETML" %}}
