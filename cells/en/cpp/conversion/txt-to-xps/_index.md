...
description: Sample C++ conversion code for TXT document to XPS format. Programmers can use this source code for batch TXT to XPS conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="TXT to XPS C++ Conversion Source Code" offSpacer="" %}}
