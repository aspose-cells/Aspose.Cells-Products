---
title: Vytvořit JSON - Vytvořit soubor JSON v C#
description: Aspose Excel. Snadno generujte a manipulujte se soubory JSON pomocí knihovny Aspose.Cells for .NET. Tato výkonná knihovna API poskytuje efektivní řešení pro vytváření, úpravu a správu souborů JSON přímo ve vašich aplikacích C# a splňuje specifické potřeby vývojářů s vysokou přesností.
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit JSON v C#" %}}
...
1.  Pomocí metody Uložit uložte sešit jako soubor JSON.

{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor JSON v C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro vytvoření souboru JSON" %}}
