---
title:  Sloučit SXC do HTM přes C++
url: /cs/cpp/merger/merge-sxc-to-htm/ 
description: Sloučit SXC do HTM Online zdarma. Online zdarma SXC do HTM Fúze. Sloučit SXC do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit SXC do HTM v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení SXC s HTM online" InputFormat="sxc" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
