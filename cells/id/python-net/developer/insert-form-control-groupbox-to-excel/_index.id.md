...
weight: 40
description: Python via .Net source code untuk memasukkan GroupBox(Form control) ke dalam Excel.
---
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan GroupBox(Form control) ke dalam File Excel Menggunakan Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan GroupBox(Form control) ke file Excel menggunakan Python via .Net" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan penambahan shapecollection[metode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_group_box/#int-int-int-int-int-int) untuk menyisipkan GroupBox(Kontrol formulir) di lembar kerja yang dipilih.
...
{{% blocks/products/pf/agp/code-block title="Sisipkan GroupBox(Kontrol formulir) - Python via .Net" offSpacer="" %}}
