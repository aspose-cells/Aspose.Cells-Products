...
description: Aspose اكسل. C++ أنشئ ملف GIF بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف GIF باستخدام C++. أنشئ GIF في C++. C++ GIF Creator.
...
1.  احفظ المصنف كملف .gif باستخدام طريقة Save().
