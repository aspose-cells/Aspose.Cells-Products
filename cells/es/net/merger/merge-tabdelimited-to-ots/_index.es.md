---
title: Combinar TABDELIMITED con OTS - Combinar TABDELIMITED con OTS en C#
url: /es/net/merger/merge-tabdelimited-to-ots/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea TABDELIMITED para guardar formato OTS. C# Combine TABDELIMITED con el formato OTS. Combinar TABDELIMITED con OTS en C#. Combinar TABDELIMITED.
...
{{% blocks/products/pf/agp/content h2="Combine TABDELIMITED con OTS en C# en línea de forma gratuita" %}}

El siguiente ejemplo muestra cómo combinar TABDELIMITED con OTS en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar TABDELIMITED con OTS. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo OTS. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina TABDELIMITED con OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar TABDELIMITED con OTS en C#" InputFormat="tsv" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar TABDELIMITED con OTS a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar TABDELIMITED con OTS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar TABDELIMITED con OTS" %}}
