...
{{% blocks/products/pf/agp/content h2="Как вставить двойную прямую стрелку в файл Excel, используя Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке двойной прямой стрелки в файл Excel с использованием Python via .Net" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте добавление коллекции форм[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) чтобы вставить двойную прямую стрелку в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить двойную прямую стрелку - Python via .Net" offSpacer="" %}}
