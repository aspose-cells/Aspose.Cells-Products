...
url: /nl/python-java/merger/merge-html-to-xml/ 
...
Het volgende voorbeeld laat zien hoe u HTML kunt samenvoegen met XML in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u HTML programmatisch samenvoegen met XML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
