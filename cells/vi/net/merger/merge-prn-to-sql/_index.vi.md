...
url: /vi/net/merger/merge-prn-to-sql/ 
...
Ví dụ sau đây minh họa cách hợp nhất PRN với SQL trong Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Cần hợp nhất PRN với SQL theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất PRN với SQL" %}}
