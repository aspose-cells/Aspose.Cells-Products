...
Trzeba programowo przekonwertować pliki JPG do formatu SXC? Programiści C++ mogą łatwo przekonwertować pliki JPG do formatu SXC za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JPG do SXC wywołując metodę Save().
