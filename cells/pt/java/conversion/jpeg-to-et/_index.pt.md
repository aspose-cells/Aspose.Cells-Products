...
description: Aspose Excel. Converta JPEG em ET de forma rápida e fácil com Aspose.Cells. Java JPEG em ET. Java Salve JPEG para ET. Salve JPEG como ET usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converta JPEG para ET em Java" h2="Biblioteca Java de alta velocidade para conversão de JPEG em ET. Esta é uma solução de software profissional para importar e exportar JPEG, ET e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Converta JPEG em ET usando Java" %}}
...
O exemplo a seguir demonstra como converter JPEG em ET em Java.
...
{{% blocks/products/pf/agp/content h2="Como converter JPEG em ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPEG para ET programaticamente? Os desenvolvedores do Java podem facilmente converter JPEG em ET em apenas algumas linhas de código.
