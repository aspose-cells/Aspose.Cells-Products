---
title: Konvertieren Sie XLT in MD über die Anwendung C++ 
url: /de/cpp/conversion/xlt-to-md/ 
description: Beispiel-Umwandlungscode C++ für das XLT-Dokument in das MD-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von XLT in MD in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLT in MD über C++" h2="Leistungsstarke XLT-zu-MD-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Microsoft Excel-, OpenOffice- oder Adobe Acrobat-Installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können XLT-Dateien in nur wenigen Codezeilen einfach in MD konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die XLT-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (MD).1. Die MD-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die MD-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="Umwandlungsquellcode von XLT in MD C++" offSpacer="" %}}
