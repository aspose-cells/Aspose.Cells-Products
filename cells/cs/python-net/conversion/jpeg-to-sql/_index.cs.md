...
Postupujte podle jednoduchých kroků pro převod JPEG na SQL. Nahrajte svůj soubor JPEG a poté jej jednoduše uložte jako soubor SQL. Pro čtení JPEG i zápis SQL můžete použít plně kvalifikované názvy souborů. Výstupní obsah SQL a formátování budou identické s původním dokumentem JPEG.
...
Potřebujete převést JPEG soubory na SQL programově? Python vývojáři mohou snadno načíst a převést JPEG na SQL v několika řádcích kódu.
...
1.  Převeďte JPEG na SQL voláním metody Workbook.save.
1.  Získejte výsledek převodu JPEG na SQL.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python knihovna pro převod JPEG na SQL" %}}
