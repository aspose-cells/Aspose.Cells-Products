...
description: Aspose Excel. Python Aspose.Cells. Sloučit XLSB do SXC uložit formát. Python Kombinujte formát XLSB až SXC. Sloučit XLSB až SXC v Python. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až SXC v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLSB až SXC v Python" InputFormat="xlsb" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
