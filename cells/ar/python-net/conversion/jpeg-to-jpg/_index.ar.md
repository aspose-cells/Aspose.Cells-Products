...
description: Aspose اكسل. قم بتحويل JPEG إلى JPG بسرعة وسهولة باستخدام Aspose.Cells. Python JPEG إلى JPG. Python احفظ JPEG إلى JPG. احفظ JPEG بصيغة JPG باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="تحويل JPEG إلى JPG في Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ JPEG إلى JPG في Python" %}}

يوضح المثال التالي كيفية تحويل JPEG إلى JPG في Python via NET.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل JPEG إلى JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل JPEG إلى JPG" %}}
