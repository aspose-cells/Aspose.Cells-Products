...
{{< blocks/products/pf/i18n/upper-banner h1="IMAGE konvertálása IMAGE-re a C++-es kódban" h2="Nagy teljesítményű KÉP-KÉP konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Programozottan kell IMAGE fájlokat IMAGE formátumba konvertálni? A C++ fejlesztők könnyedén konvertálhatják az IMAGE fájlokat IMAGE formátumba mindössze néhány sornyi kóddal.
...
1.  Konvertálja az IMAGE objektumot IMAGE-re a Save() metódus meghívásával.
