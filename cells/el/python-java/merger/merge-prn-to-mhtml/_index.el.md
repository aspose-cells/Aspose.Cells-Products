---
title:  Συγχώνευση PRN στο MHTML μέσω Python
url: /el/python-java/merger/merge-prn-to-mhtml/ 
description: Συγχώνευση PRN στο MHTML Online δωρεάν. Δωρεάν online PRN to MHTML Merger. Συγχώνευση PRN σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN στο MHTML στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση του PRN με το MHTML σε απευθείας σύνδεση" InputFormat="prn" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
