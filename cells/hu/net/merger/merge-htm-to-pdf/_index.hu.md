---
title:  HTM egyesítése a PDF-gyel a C#-en keresztül
...
A következő példa bemutatja, hogyan egyesítheti a HTM-et a PDF-es számmal a C#-ben.
...
{{% cells-merger title="Ingyenes alkalmazás a HTM és a PDF online egyesítéséhez" InputFormat="htm" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="HTM egyesítése a PDF-es számmal a C#-en keresztül" %}}
