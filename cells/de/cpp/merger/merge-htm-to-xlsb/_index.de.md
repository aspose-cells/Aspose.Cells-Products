...
description: Aspose Excel. C++ Aspose.Cells. HTM mit dem Sicherungsformat XLSB zusammenführen. C++ Kombinieren Sie HTM mit dem Format XLSB. HTM zu XLSB in C++ zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="HTM mit XLSB in C++ zusammenführen" %}}
...
{{% cells-merger title="Beispielcode zum Zusammenführen von HTM mit XLSB in C++" InputFormat="htm" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
