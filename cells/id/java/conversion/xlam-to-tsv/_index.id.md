...
{{% blocks/products/pf/agp/content h2="Ubah XLAM menjadi TSV Menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLAM hingga TSV di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLAM menjadi TSV di Java.
...
Perlu mengonversi file XLAM ke TSV secara terprogram? Pengembang Java dapat dengan mudah mengonversi XLAM menjadi TSV hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah XLAM menjadi TSV" %}}
{{% blocks/products/pf/agp/text %}}
