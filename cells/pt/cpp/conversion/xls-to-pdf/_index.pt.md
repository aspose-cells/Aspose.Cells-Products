---
title: C++ XLS para PDF - Online XLS para PDF Conversor
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Online Grátis C++ Converter XLS para PDF saveformat. C++ XLS a PDF formato. Salve XLS a PDF C++.
...
{{% blocks/products/pf/agp/content h2="Salve XLS a PDF em C++ online gratuitamente" %}}

O exemplo a seguir demonstra como converter XLS em PDF em C++.
...
{{% blocks/products/pf/agp/content h2="Como converter XLS para PDF via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para PDF programaticamente? Os desenvolvedores C++ podem facilmente converter XLS em PDF em apenas algumas linhas de código.
...
1.  Converta XLS em PDF chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteca para converter XLS em PDF" %}}
