---
title: Konvertera TABDELIMITED till XLTX via Java 

description: Exempel på konverteringskod för Java för TABDELIMITED-format till XLTX-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLTX inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera TABDELIMITED till XLTX via Java" h2="TABDELLIMITED till XLTX Java-konvertering för att konvertera enstaka eller flera sidor till XLTX med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar TABDELIMITED till XLTX med Java" %}}

 För att rendera TABDELIMITED till XLTX kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera TABDELIMITED till XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera TABDELIMITED-fil till XLTX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda TABDELIMITED-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLTX-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLTX-filen
...
{{% blocks/products/pf/agp/code-block title="TABDELBEGRÄNSAD till XLTX Java omvandlingskällkod" offSpacer="" %}}

```cs
// ladda TABDELIMITED-filen i en instans av Workbook
Workbook book = new Workbook("template.tabdelimited");
// spara TABDELLIMITED som XLTX
