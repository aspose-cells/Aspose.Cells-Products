...
{{< blocks/products/pf/i18n/upper-banner h1="Объединить форматы XLTM в Java" h2="Встроенное слияние документов XLTM с использованием серверных Java API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Как объединить файлы XLTM с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению файлов XLTM в Java" %}}
...
+ Загрузите первый файл XLTM с экземпляром класса Workbook.
+ Загрузите второй документ XLTM с экземпляром класса Workbook.
+ Объединить файлы с помощью метода Combine().
+ сохранить объединенный файл XLTM по указанному пути
...
{{% blocks/products/pf/agp/code-block title="Объединить файлы XLTM – Java" offSpacer="" %}}

```cs
// Откройте первый файл XLTM.
Workbook xltmFile1 = new Workbook("chartsFileWithPath.xltm");

// Определите вторую исходную книгу.
// Откройте второй файл XLTM.
