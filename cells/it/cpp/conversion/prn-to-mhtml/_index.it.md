...
Hai bisogno di convertire i file PRN in MHTML tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in MHTML in poche righe di codice.
...
1.  Convertire PRN in MHTML chiamando il metodo Save().
