...
description: Aspose Excel. Converti SPREADSHEETML in XLS in modo rapido e semplice con Aspose.Cells. Python SPREADSHEETML in XLS. Python Salva SPREADSHEETML in XLS. Salva SPREADSHEETML come XLS utilizzando Python.
...
{{% blocks/products/pf/agp/content h2="Salva FOGLIO DI CALCOLOML su XLS in Python" %}}
...
{{% cells-convert title="Codice di esempio per convertire SPREADSHEETML in XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xls" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria Python per convertire SPREADSHEETML in XLS" %}}
