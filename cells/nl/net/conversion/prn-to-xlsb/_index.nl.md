...
description: Aspose Excel. Converteer PRN snel en eenvoudig naar XLSB met Aspose.Cells. C# PRN naar XLSB. C# Bewaar PRN naar XLSB. Sla PRN op als XLSB met behulp van C#.
...
{{% blocks/products/pf/agp/content h2="Bewaar PRN op XLSB in C#" %}}

In het volgende voorbeeld ziet u hoe u PRN converteert naar XLSB in C#.
