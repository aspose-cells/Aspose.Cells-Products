...
{{% blocks/products/pf/agp/text %}}
 ...
 Python 開発者は、わずか数行のコードで TXT を簡単にロードして TABDELIMITED に変換できます。
