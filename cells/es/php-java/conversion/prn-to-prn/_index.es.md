...
{{% blocks/products/pf/agp/content h2="Guardar PRN en PRN en PHP" %}}

El siguiente ejemplo demuestra cómo convertir PRN a PRN en PHP.
...
{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir PRN a PRN" %}}
