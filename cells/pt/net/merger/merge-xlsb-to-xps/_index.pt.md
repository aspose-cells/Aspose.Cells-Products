---
title:  Mesclar XLSB para XPS via C#
url: /pt/net/merger/merge-xlsb-to-xps/ 
description: Mesclar XLSB para XPS Online gratuitamente. Online Grátis XLSB a XPS Fusão. Mesclar XLSB para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar XLSB a XPS em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar XLSB a XPS on-line" InputFormat="xlsb" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
