...
url: /ru/cpp/merger/merge-excel-to-xml/ 
...
В следующем примере показано, как объединить EXCEL с XML в Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Вам нужно программно объединить EXCEL в XML? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="C++ библиотека для объединения EXCEL в XML" %}}
