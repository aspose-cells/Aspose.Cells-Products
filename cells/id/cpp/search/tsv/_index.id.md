...
weight: 930
description: Contoh kode C++ untuk mencari kata dengan pola pada file TSV pada Runtime Environment C++ untuk Windows 32 bit, Windows 64 bit dan Linux 64 bit.
...
+ Muat file TSV dengan membuat instance kelas Buku Kerja.
...
+ Simpan file TSV menggunakan metode Workbook::Save(...).
