...
description: Aspose Exceller. Convertissez FODS en XML rapidement et facilement avec Aspose.Cells. Python FODS en XML. Python Enregistrez FODS au format XML. Enregistrez FODS au format XML en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir FODS en XML à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer FODS au format XML dans Python" %}}
...
{{% cells-convert title="Exemple de code pour convertir FODS en XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xml" IsLandingPage="true" language="pythonjava" %}}
