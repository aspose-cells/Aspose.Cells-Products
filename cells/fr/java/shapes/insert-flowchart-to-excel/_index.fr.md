...
L'exemple de code ci-dessous montre comment insérer un "Multidocument". Pour plus de types, veuillez vous référer à "Aperçu des types de forme de flèche en bloc" ci-dessous.
