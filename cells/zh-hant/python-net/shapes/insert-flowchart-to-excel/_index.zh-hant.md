---
title: 將流程圖插入 Excel Python via .NET
weight: 360
description: Python via .NET 將流程圖插入 Excel 的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="將流程圖插入 Excel Python via .NET" h2="使用服務器端 API 插入對象，無需任何軟件，如 Microsoft 或 Open Office、Adobe PDF 等。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via 將流程圖插入 Excel 文件 .NET" %}}

為了將 FlowChart 插入到 excel 文件中，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Python 將流程圖插入 Excel 文件的步驟" %}}
...
+ 通過索引選擇工作表。
 + 使用 shapecollection 的添加[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)在選定的工作表中插入 FlowChart。
以 XLSX 格式保存工作簿。
...
下面的示例代碼演示瞭如何插入“多文檔”。更多類型請參考下文“流程圖類型概述”。

{{% blocks/products/pf/agp/code-block title="插入流程圖 - Python via .NET" offSpacer="" %}}
