...
{{% blocks/products/pf/agp/feature-section-col title="在 Excel 文件中对形状进行分组和取消分组的步骤 via Java" %}}
...
+ 通过索引选择工作表。
 + 使用[组法](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#group-com.aspose.cells.Shape---)对所选工作表中的形状进行分组
 + 使用[解组方法](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#ungroup-com.aspose.cells.GroupShape-)取消组合所选工作表中的形状
以 XLSX 格式保存工作簿。
