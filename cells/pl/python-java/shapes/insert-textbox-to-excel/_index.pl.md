...
{{% blocks/products/pf/agp/content h2="Jak wstawić pole tekstowe do pliku programu Excel za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić TextBox do pliku Excel za pośrednictwem Python" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addTextBox(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić pole tekstowe w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw pole tekstowe — Python" offSpacer="" %}}
