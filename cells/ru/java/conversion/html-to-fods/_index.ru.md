...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в FODS, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTML в FODS в Java" %}}
...
Нужно программно преобразовать файлы HTML в FODS? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в FODS всего несколькими строками кода.
