...
description: Aspose Excel. Convierta MHTML a DIF rápida y fácilmente con Aspose.Cells. Python MHTML a DIF. Python Guarde MHTML en DIF. Guarde MHTML como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar MHTML al DIF en Python" %}}

El siguiente ejemplo demuestra cómo convertir MHTML a DIF en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir MHTML en DIF" %}}
