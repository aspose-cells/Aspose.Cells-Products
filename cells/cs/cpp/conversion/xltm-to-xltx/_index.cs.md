---
title: Převeďte XLTM na XLTX pomocí aplikace C++ 
url: /cs/cpp/conversion/xltm-to-xltx/ 
description: Ukázkový konverzní kód C++ pro dokument XLTM na formát XLTX. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLTM na XLTX v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLTM na XLTX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLTM pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLTX).1. Soubor XLTX bude uložen do zadané cesty.1. Otevřete soubor XLTX v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLTM na XLTX C++" offSpacer="" %}}
