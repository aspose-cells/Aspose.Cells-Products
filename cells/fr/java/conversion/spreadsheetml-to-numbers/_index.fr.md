---
title: Java Convertisseur SPREADSHEETML vers NUMBERS
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir SPREADSHEETML au format NUMBERS, permettant un enregistrement transparent des données SPREADSHEETML au format NUMBERS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer SPREADSHEETML au format NUMBERS dans Java" %}}

L'exemple suivant montre comment convertir SPREADSHEETML en NUMBERS dans Java.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier SPREADSHEETML en NUMBERS. Importez votre fichier SPREADSHEETML, puis enregistrez-le au format NUMBERS. Vous pouvez utiliser des noms de fichiers complets, aussi bien pour la lecture de fichiers SPREADSHEETML que pour l'écriture de fichiers NUMBERS. Le contenu et la mise en forme du fichier NUMBERS généré seront identiques à ceux du document SPREADSHEETML d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir SPREADSHEETML en NUMBERS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xml" outformat="numbers" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir un fichier SPREADSHEETML en NUMBERS : via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers SPREADSHEETML en NUMBERS par programmation ? Les développeurs de Java peuvent facilement convertir des fichiers SPREADSHEETML en NUMBERS en quelques lignes de code seulement.
...
1.  Convertissez SPREADSHEETML en NUMBERS en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de SPREADSHEETML en NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir SPREADSHEETML en NUMBERS" %}}
{{% blocks/products/pf/agp/text %}}
