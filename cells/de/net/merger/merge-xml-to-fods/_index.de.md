...
url: /de/net/merger/merge-xml-to-fods/ 
...
Das folgende Beispiel zeigt, wie XML mit FODS in Aspose.Cells for .NET zusammengeführt wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie XML programmgesteuert mit FODS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von XML mit FODS" %}}
