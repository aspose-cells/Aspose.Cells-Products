...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na BMP pomocí Python" %}}

 K převodu TABDELIMITED na BMP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na BMP prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory TABDELIMITED do BMP pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TABDELIMITED s instancí sešitu1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s příponou BMP jako parametr1. Zkontrolujte zadanou cestu pro výsledný soubor BMP
