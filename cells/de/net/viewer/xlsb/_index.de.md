---
title:  Dateiformate XLSB anzeigen via .NET
weight: 6260
description: C# Quellcode zum Laden, Rendern und Anzeigen von XLSB Dokumenten auf .NET Framework, .NET Core, Mono oder Xamarin-Plattformen.
...
{{< blocks/products/pf/i18n/upper-banner h1="XLSB Dateibetrachter for .NET" h2="Zeigen Sie Excel- und OpenOffice-Tabellen wie XLSB an, ohne Microsoft Excel oder Office Automation zu benötigen." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="So zeigen Sie die Datei XLSB mit C# an" %}}

 Um die Datei XLSB anzuzeigen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Anzeigen von XLSB über C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells erleichtert Entwicklern das Anzeigen der Datei XLSB mit nur wenigen Codezeilen.

{{% /blocks/products/pf/agp/text %}}

1.  Laden Sie die Datei XLSB in eine Instanz von Workbook
1.  Erstellen Sie eine Instanz von HtmlSaveOptions und setzen Sie die ExportHeadings-Eigenschaft auf true
1. Speichern Sie die Datei XLSB im Format HTML mit der Methode Workbook.Save
...
{{% blocks/products/pf/agp/code-block title="C# Beispielcode zum Anzeigen der Datei XLSB" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API kann zum Erstellen, Bearbeiten, Konvertieren und Rendern von Microsoft Excel-Formaten in verschiedene Formate verwendet werden. Darüber hinaus kann es für umfassende Diagramme, skalierbare Berichte und zuverlässige Berechnungen innerhalb von Softwareanwendungen verwendet werden. Aspose.Cells ist ein eigenständiges API und erfordert keine Software wie Microsoft oder OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Anzeigen von XLSB" sectionDescription=" Schauen Sie sich unsere Live-Demos an[XLSB anzeigen](https://products.aspose.app/cells/viewer/xlsb) mit folgenden Vorteilen." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach die Datei XLSB hoch und klicken Sie auf die Schaltfläche „Anzeigen“." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Laden Sie bei Bedarf die Datei XLSB über den Link herunter" >}}
