...
url: /pl/net/merger/merge-image-to-xltm/ 
...
Poniższy przykład pokazuje, jak połączyć IMAGE z XLTM w Aspose.Cells for .NET.
...
Chcesz programowo scalić IMAGE z XLTM? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka .NET do połączenia OBRAZU z XLTM" %}}
