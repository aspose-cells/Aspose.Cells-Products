---
title: Java من EXCEL إلى POWERPOINT - محول من EXCEL إلى POWERPOINT
description: Aspose اكسل. قم بتحويل EXCEL إلى POWERPOINT بسرعة وسهولة باستخدام Aspose.Cells. Java EXCEL إلى POWERPOINT. Java حفظ EXCEL إلى PowerPOINT. احفظ EXCEL كـ POWERPOINT باستخدام Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل EXCEL إلى POWERPOINT في Java" h2="مكتبة Java عالية السرعة لتحويل EXCEL إلى POWERPOINT. يعد هذا حلاً برمجيًا احترافيًا لاستيراد وتصدير EXCEL وPOWERPOINT والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POWERPOINT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ EXCEL إلى POWERPOINT في Java" %}}
...
هل تحتاج إلى تحويل ملفات EXCEL إلى POWERPOINT برمجياً؟ يمكن لمطوري Java تحويل EXCEL إلى POWERPOINT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل EXCEL إلى POWERPOINT عن طريق استدعاء أسلوب Workbook.save.
