---
title: Convierta XLTM a GIF a través de la aplicación C++ 
url: /es/cpp/conversion/xltm-to-gif/ 
description: Ejemplo de código de conversión C++ para documento XLTM a formato GIF. Los programadores pueden usar este código fuente para la conversión por lotes de XLTM a GIF dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente archivos XLTM a GIF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLTM usando Factory::CreateIWorkbook.1. Seleccione la primera hoja de trabajo.1. Establecer (GIF) opciones.1. Iterar a través de cada página de la hoja y renderizar.1. Abra el archivo GIF en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLTM a GIF C++" offSpacer="" %}}
