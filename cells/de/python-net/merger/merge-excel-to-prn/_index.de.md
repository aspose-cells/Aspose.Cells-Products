...
Das folgende Beispiel zeigt, wie Excel in PRN in Aspose.Cells for Python via .NET zusammengeführt wird.
...
Müssen Sie Excel programmgesteuert mit PRN zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs können mit nur wenigen Codezeilen erstellt werden.
