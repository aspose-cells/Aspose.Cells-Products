...
description: Aspose เอ็กเซล. C++ สร้างไฟล์ XLSM อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ XLSM โดยใช้ C++ สร้าง XLSM ใน C++ C++ XLSM Creater
...
1.  บันทึกสมุดงานเป็นไฟล์ .xlsm โดยใช้เมธอด Save()
