---
title: XLSX mit XLS zusammenführen - XLSX mit XLS in C++ kombinieren
url: /de/cpp/merger/merge-xlsx-to-xls/ 
description: Aspose Excel. C++ Aspose.Cells. Kostenlose Online-Zusammenführung von XLSX zu XLS im Speicherformat. C++ Kombinieren Sie das Format XLSX mit dem Format XLS. XLSX zu XLS in C++ zusammenführen. XLSX Zusammenführen.
...
Das folgende Beispiel zeigt, wie XLSX mit XLS in Aspose.Cells for C++ zusammengeführt wird.
...
{{% cells-merger title="Kostenlos online, um XLSX mit XLS in C++ zusammenzuführen" InputFormat="xlsx" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie XLSX über C++ mit XLS zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie XLSX programmgesteuert mit XLS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
