---
title: Convierta TXT a XLS a través de la aplicación C++ 
url: /es/cpp/conversion/txt-to-xls/ 
description: Ejemplo de código de conversión C++ para documento TXT a formato XLS. Los programadores pueden usar este código fuente para la conversión por lotes de TXT a XLS dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte TXT a XLS a través de C++" h2="Conversión de TXT a XLS de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir TXT a XLS usando C++" %}}

 Para convertir TXT a XLS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir TXT a XLS a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de C++ pueden convertir fácilmente un archivo TXT a XLS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo TXT usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (XLS).1. El archivo XLS se guardará en la ruta especificada.1. Abra el archivo XLS en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de TXT a XLS C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de TXT a XLS" sectionDescription="[Convertir TXT a XLS](https://products.aspose.app/cells/conversion/txt-to-xls) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo TXT, se convertirá instantáneamente a XLS." >}}
