...
Precisa converter arquivos OTS para SQL programaticamente? Os desenvolvedores do C++ podem converter facilmente OTS em SQL em apenas algumas linhas de código.
...
1.  Converta OTS em SQL chamando o método Save().
