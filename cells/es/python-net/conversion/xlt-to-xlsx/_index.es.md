...
description: Aspose Excel. Convierta XLT a XLSX rápida y fácilmente con Aspose.Cells. Python XLT a XLSX. Python Guarde XLT en XLSX. Guarde XLT como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLT al XLSX en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLT a XLSX en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir XLT a XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLT en XLSX" %}}
