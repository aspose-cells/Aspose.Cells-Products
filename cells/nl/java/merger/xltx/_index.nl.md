...
weight: 680
description: Java voorbeeldcode om XLTX documenten te combineren op Java Runtime Environment voor JSP/JSF Application en Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg XLTX-indelingen samen in Java" h2="Native XLTX documentfusie met behulp van server-side Java API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe XLTX-bestanden samen te voegen met Java" %}}

 Om het XLTX-bestand samen te voegen, gebruiken we[Aspose.Cells for Java](https://products.aspose.com/cells/java) API, een functierijk, krachtig en gebruiksvriendelijk fusie-API for Java-platform. U kunt de nieuwste versie rechtstreeks downloaden van[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) en installeer het binnen uw op Maven gebaseerde project door de volgende configuraties toe te voegen aan pom.xml.
...
+ Laad het eerste bestand XLTX met een exemplaar van de klasse Workbook.
+ Laad het tweede XLTX-document met een exemplaar van de klasse Workbook.
...
{{% blocks/products/pf/agp/code-block title="Samenvoegen XLTX Bestanden - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online XLTX Fusie live demo\'s" sectionDescription=" Voeg nu XLTX-documenten samen door onze te bezoeken[Website met live demo\'s](https://products.aspose.app/cells/merger). De live demo heeft de volgende voordelen" >}}
