---
title: Vytvářejte soubory MHTML prostřednictvím Java 
url: /cs/java/create-mhtml/ 
description: Java Ukázkový kód pro generování dokumentů MHTML. Tento kód použijte k vytváření souborů MHTML v desktopové nebo webové aplikaci založené na Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Jak vytvořit MHTML prostřednictvím Java" %}}
...
<!-- aboutfile Starts -->
 ...
 Knihovna programování tabulkových procesorů Excel schopná vytvářet aplikace pro různé platformy se schopností generovat, upravovat, konvertovat, vykreslovat a tisknout soubory MHTML. Java Excel API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat soubory Excel jako obrázky, PDF, HTML, ODS a další, takže je perfektní volbou pro výměnu dokumentů ve standardních formátech.
