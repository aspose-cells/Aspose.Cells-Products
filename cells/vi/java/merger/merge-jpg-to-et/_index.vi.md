---
title: Gộp JPG sang ET - Gộp JPG sang ET Java
url: /vi/java/merger/merge-jpg-to-et/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu JPG sang ET. Java Kết hợp định dạng JPG sang ET. Hợp nhất JPG thành ET năm Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Gộp JPG sang ET vào Java" %}}

Ví dụ sau đây minh họa cách hợp nhất JPG với ET trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất JPG với ET. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp ET. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất JPG với ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu ghép JPG sang ET số Java" InputFormat="jpg" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép JPG vào ET via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép JPG sang ET" %}}
