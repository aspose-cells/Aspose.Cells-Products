---
title: C# XLTX ～ EMF - XLTX ～ EMF コンバータ
description: Aspose エクセル。 XLTX を Aspose.Cells ですばやく簡単に EMF に変換します。 C# XLTX から EMF に変換します。 C# XLTX を EMF に保存します。 XLTX を 07611134 として保存しますC#を使用して81。
...
{{% cells-convert title="XLTX を EMF に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="emf" IsLandingPage="true" %}}
