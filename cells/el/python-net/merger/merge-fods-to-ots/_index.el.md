...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση FODS σε μορφή αποθήκευσης OTS. Python Συνδυάστε το FODS σε μορφή OTS. Συγχώνευση FODS στο OTS στο Python. FODS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση FODS στο OTS στο Python" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση FODS στο OTS στο Python" InputFormat="fods" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
