...
weight: 800
description: C++ Windows 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경의 Excel 파일에 별과 배너를 삽입하는 예제 코드입니다.
...
{{% blocks/products/pf/agp/content h2="C++을 사용하여 Excel 파일에 별과 배너를 삽입하는 방법" %}}

 별과 배너를 Excel 파일에 삽입하기 위해 다음을 사용하겠습니다.
...
+ 색인을 통해 워크시트를 선택합니다.
 +[메소드 추가](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/) 선택한 워크시트에 별과 배너를 삽입하려면
...
아래 샘플 코드는 "리본: 곡선 및 위로 기울어짐" 및 "폭발: 8포인트"를 삽입하는 방법을 보여줍니다. 더 많은 유형은 아래 "별 및 배너 유형 개요"를 참조하세요.

{{% /blocks/products/pf/agp/text %}}

{{% blocks/products/pf/agp/code-block title="별표 및 배너 삽입 - C++" offSpacer="" %}}
