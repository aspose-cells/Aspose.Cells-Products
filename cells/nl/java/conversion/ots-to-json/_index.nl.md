---
title: Java OTS naar JSON - OTS naar JSON Converter
...
{{% blocks/products/pf/agp/content h2="Sla OTS op in JSON in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar JSON converteert in Java.
...
{{% cells-convert title="Voorbeeldcode om OTS naar JSON te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar JSON via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar JSON? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar JSON met slechts een paar regels code.
