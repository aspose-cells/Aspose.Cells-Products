...
Programozottan kell konvertálnia az OTS-fájlokat TABDELIMITED-re? A Java fejlesztők egyszerűen konvertálhatják az OTS-t TABDELIMITED-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár az OTS TAB-ra konvertálásáhozDELIMITED" %}}
{{% blocks/products/pf/agp/text %}}
