...
description:  Aspose Exceller. C++ Créez un fichier SPREADSHEETML rapidement et facilement avec Aspose.Cells. Générez un fichier SPREADSHEETML en utilisant C++. Créez SPREADSHEETML dans C++. C++ SPREADSHEETML Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier SPREADSHEETML dans C++" h2="Création de fichiers SPREADSHEETML natifs et hautes performances par programme sans Microsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers SPREADSHEETML dans des applications de reporting en cours d'exécution pour le traitement des données en seulement quelques lignes de code.
...
1.  Enregistrez le classeur sous forme de fichier .xml à l’aide de la méthode Save().
