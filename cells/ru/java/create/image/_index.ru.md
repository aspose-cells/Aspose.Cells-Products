...
description: Aspose Эксель. Java Быстро и легко создайте файл ИЗОБРАЖЕНИЯ с помощью Aspose.Cells. Создайте файл ИЗОБРАЖЕНИЯ с помощью Java. Создайте ИЗОБРАЖЕНИЕ в Java. Java IMAGE Creator.
...
1.  Сохраните книгу в формате IMAGE, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл IMAGE по номеру Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java библиотека для создания файла IMAGE" %}}
{{% blocks/products/pf/agp/text %}}
