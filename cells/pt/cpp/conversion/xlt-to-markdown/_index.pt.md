...
{{% cells-convert title="Exemplo de código para converter XLT em MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="md" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLT em MARKDOWN por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLT em MARKDOWN programaticamente? Os desenvolvedores do C++ podem converter facilmente XLT em MARKDOWN em apenas algumas linhas de código.
