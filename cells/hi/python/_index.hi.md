...
weight: 2820
description: Python एक्सेल फाइल को पढ़ने, लिखने और पार्स करने के लिए स्प्रेडशीट लाइब्रेरी।
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python एक्सेल स्प्रेडशीट पार्सिंग एपीआई" h2="Python अनुप्रयोगों के भीतर स्प्रैडशीट्स को जनरेट करें, पढ़ें, लिखें या हेरफेर करें और साथ ही एक्सेल फ़ाइलों को कई प्रारूपों में निर्यात करें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-python-java.svg" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="https://releases.aspose.com/cells/python-java/" >}}
...
<p>
 Aspose.Cells for Python स्प्रेडशीट प्रोसेसिंग कार्यों के लिए एक तेज़ और विश्वसनीय API है। डेवलपर्स सरल या जटिल स्प्रेडशीट बना सकते हैं, हेरफेर कर सकते हैं और साथ ही एक्सेल फाइलों से जानकारी निकाल सकते हैं। API कई एक्सेल प्रारूप पढ़ता है और वर्कशीट को XPS, PDF, MHTML, HTML, सादा पाठ, छवियों और अधिक में प्रस्तुत कर सकता है। यह अजगर का उपयोग करके एक्सेल रिपोर्ट को स्वचालित करने का सबसे अच्छा समाधान है।
</p>
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="Aspose.Cells for Python के लिए उपलब्ध है।" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल स्वरूप" description="Python एक्सेल लाइब्रेरी लोकप्रिय Microsoft एक्सेल फॉर्मेट, फिक्स्ड-लेआउट फॉर्मेट और छवियों का समर्थन करती है।" >}}
...
उन्नत Python एक्सेल API विशेषताएं
 ...
 एक्सेल स्प्रेडशीट पढ़ें
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 PDF, EMF और छवियों के लिए रेंडर स्प्रेडशीट्स
    </p>
   </div>
   <div class="col-lg-4">
 ...
 पेज सेटअप कॉन्फ़िगर करें
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 पेज ओरिएंटेशन, स्केलिंग, पेपर साइज एडजस्ट करें
    </p>
   </div>
   <div class="col-lg-4">
...
-->
 ...
 Python एक्सेल लाइब्रेरी एक्सेल फाइलों को PDF, XPS और amp; HTML प्रारूप। API का विश्वसनीय रूपांतरण इसे उन कंपनियों के लिए एक आदर्श समाधान बनाता है जिन्हें उद्योग-मानक प्रारूपों में फ़ाइलों का आदान-प्रदान करने की आवश्यकता होती है।
    ...
    <div class="codeblock" id="code">
     <h3>
 स्प्रेडशीट को विभिन्न स्वरूपों में सहेजें - Java
     </h3>
...
<p>Aspose.Cells for Android via Java API allows you to manipulate rows and columns in many different ways. You can easily adjust row height and column width, auto size the width & height of cells according to the contents, insert or delete, hide or show and group or ungroup rows & columns.</p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
 एक्सेल शीट डेटा प्रबंधन
    </h2>
    <p>
 Aspose.Cells for Python API वर्कशीट डेटा प्रबंधन के लिए व्यापक समर्थन प्रदान करता है। वर्कशीट में किसी भी सेल को रनटाइम पर आसानी से हेरफेर कर सकते हैं या विभिन्न डेटा स्रोतों से वर्कशीट पर डेटा आयात कर सकते हैं।
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 चार्ट अनुकूलन
    ...
    <p>
 Aspose.Cells for Python चार्टिंग के लिए पूर्ण समर्थन प्रदान करता है। इस पायथन लाइब्रेरी में चार्ट को ताज़ा करने के लिए कोई भी आसानी से मानक और अनुकूलित चार्ट जोड़ सकता है या गतिशील रूप से चार्ट डेटा सेट कर सकता है।
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="Aspose.Cells API संदर्भ" href="https://reference.aspose.com/cells/python-java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="क्यों Aspose.Cells for Python?" tabId="success-stories" >}}
