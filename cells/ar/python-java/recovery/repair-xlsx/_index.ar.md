---
title: إصلاح ملف xlsx عبر Python
url: /ar/python-java/recovery/repair-xlsx/ 
description: قم بإصلاح ملف xlsx التالف باستخدام Python. أداة الاسترداد لإصلاح ملف xlsx التالف داخل تطبيق Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="استرجع XLSX الملف عبر Python" h2="قم ببناء تطبيق Python الخاص بك لإصلاح ملفات xlsx باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إصلاح ملف xlsx باستخدام Python" %}}
...
{{% cells-recovery title="تطبيق مجاني لإصلاح ملف XLSX باستخدام Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="pythonjava" %}}    
