---
title: Gabung XLSB ke PDF - Gabungkan XLSB ke PDF di C#
url: /id/net/merger/merge-xlsb-to-pdf/ 
description: Aspose Unggul. C# Aspose.Cells. Free Online Merge XLSB to PDF saveformat. C# Gabungkan format XLSB menjadi PDF. Gabung XLSB ke PDF di C#. XLSB Gabung.
...
Contoh berikut menunjukkan cara menggabungkan XLSB ke PDF di Aspose.Cells for .NET.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan XLSB ke PDF di C#" InputFormat="xlsb" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSB ke PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSB menjadi PDF secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
