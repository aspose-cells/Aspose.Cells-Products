---
title: Merge CSV to TSV via C# 
url: /net/merger/merge-csv-to-tsv/ 
description: Merge CSV to TSV in .NET. Merge CSV to TSV via .NET online for free. Combine CSV to TSV using VB.NET, Asp.NET or any .NET based application.
---
...
The following example demonstrates how to merge CSV to TSV in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to merge CSV to TSV. Upload your files, call Workbook.Combine method for merging files, and then save it to TSV file. If you develop code in C#, this will be simpler than it sounds. See {{platform} example that merges CSV to TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Free App to merge CSV to TSV on line" InputFormat="csv" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
