...
weight: 301
description: C# .NET फ्रेमवर्क, .NET कोर, Mono या ज़मारिन प्लेटफॉर्म पर एक्सेल में टेक्स्टबॉक्स डालने के लिए स्रोत कोड।
---
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके एक्सेल फाइल में टेक्स्टबॉक्स कैसे डालें" %}}

 टेक्स्टबॉक्स को एक्सेल फाइल में डालने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से एक्सेल फ़ाइल में टेक्स्टबॉक्स डालने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से कार्यपत्रक का चयन करें।
 + का प्रयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addtextbox) चयनित वर्कशीट में टेक्स्टबॉक्स डालने के लिए
