...
description: Aspose اكسل. قم بتحويل XLT إلى OTS بسرعة وسهولة باستخدام Aspose.Cells. Python XLT إلى OTS. Python احفظ XLT إلى OTS. احفظ XLT كـ OTS باستخدام Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLT إلى OTS في Python" h2="مكتبة Python عالية السرعة لتحويل XLT إلى OTS. يعد هذا حلاً برمجيًا احترافيًا لاستيراد وتصدير XLT وOTS والعديد من التنسيقات الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل XLT إلى OTS باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ XLT إلى OTS في Python" %}}

يوضح المثال التالي كيفية تحويل XLT إلى OTS في Python.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل XLT إلى OTS" %}}
