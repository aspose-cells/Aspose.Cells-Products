---
title: Java PNG إلى XLS - عبر الإنترنت من PNG إلى XLS
description: Aspose إكسل. Java Aspose.Cells. Java Aspose Cells. مجاني على الإنترنت Java تحويل PNG إلى XLS saveformat. Java PNG إلى تنسيق XLS. وفر PNG إلى XLS Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل PNG إلى XLS في Java" h2="مكتبة Java عالية السرعة لتحويل PNG إلى XLS. هذا حل برمجي احترافي لاستيراد وتصدير PNG و XLS والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="وفر PNG إلى XLS في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل PNG إلى XLS في Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل PNG إلى XLS. قم بتحميل ملف PNG الخاص بك ، ثم احفظه كملف XLS. لكل من قراءة PNG وكتابة XLS ، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون المحتوى والتنسيق الناتج XLS متطابقين مع المستند PNG الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل PNG إلى XLS عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل PNG إلى XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

تحتاج إلى تحويل PNG ملفات إلى XLS برمجيا؟ يمكن للمطورين Java تحويل PNG إلى XLS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول PNG إلى XLS باستدعاء طريقة Workbook.save.
1.  احصل على نتيجة التحويل من PNG إلى XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل PNG إلى XLS" %}}
{{% blocks/products/pf/agp/text %}}
