---
title:  كيف أقوم برسم أو إدراج سهم مستقيم في Excel باستخدام Python via Java
weight: 10
description: Python via Java الكود المصدري لرسم أو إدراج سهم مستقيم في برنامج Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج سهم مستقيم في ملف إكسل باستخدام Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج سهم مستقيم في ملف اكسيل باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) لإدراج سهم مستقيم في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل السهم المستقيم - Python via Java" offSpacer="" %}}
