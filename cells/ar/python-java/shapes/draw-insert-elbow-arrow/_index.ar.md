---
title:  كيفية رسم أو إدراج شكل سهم الكوع في برنامج Excel باستخدام Python via Java
weight: 10
description: رسم أو إدراج شكل سهم الكوع باستخدام Aspose.Cells' Python via Java API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF إلخ.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شكل سهم الكوع في ملف إكسل باستخدام Python via Java" %}}

 من أجل إدراج شكل سهم الكوع في ملف Excel، سوف نستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج شكل سهم الكوع في ملف Excel باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج شكل سهم على شكل مرفق في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج شكل سهم الكوع - Python via Java" offSpacer="" %}}
