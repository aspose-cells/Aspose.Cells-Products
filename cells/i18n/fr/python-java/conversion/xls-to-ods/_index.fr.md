---
title: Convertir XLS en ODS via Python
url: /fr/python-java/conversion/xls-to-ods/
description: Exemple de code pour la conversion de xls en ods Python. Utilisez l'exemple de code API pour la conversion de fichiers xls par lots en ods dans l'application Python.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en ODS en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en ODS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir des fichiers XLS en ODS en quelques lignes de code seulement.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="ods" IsLandingPage="true" language="python" %}}
