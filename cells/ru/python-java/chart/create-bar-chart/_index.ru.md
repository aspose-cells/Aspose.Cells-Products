---
title: Создание гистограмм с помощью Python
url: /ru/python-java/create-bar-chart/
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="В следующем исходном коде показано, как создать гистограмму в файл MS Excel XLSX с помощью Python." offSpacer="" %}}
