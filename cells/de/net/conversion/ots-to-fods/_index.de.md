---
title: C# OTS zu FODS - OTS zu FODS Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter FODS in C#" %}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über C# in FODS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in FODS konvertieren? .NET-Entwickler können OTS mit nur wenigen Codezeilen problemlos in FODS laden und konvertieren.
...
1.  Konvertieren Sie OTS in FODS durch Aufruf der Workbook.Save-Methode.
1.  Erhalten Sie das Konvertierungsergebnis von OTS zu FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von OTS nach FODS" %}}
