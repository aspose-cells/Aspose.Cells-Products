---
title: Java XLSX ke FODS - Online XLSX ke FODS Konverter
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Gratis Online Java Ubah XLSX menjadi FODS saveformat. Java XLSX ke format FODS. Simpan XLSX ke FODS Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi FODS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi XLSX menjadi FODS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, FODS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke FODS di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi FODS di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah XLSX menjadi FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX menjadi FODS secara terprogram? Pengembang Java dapat dengan mudah mengonversi XLSX menjadi FODS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi XLSX menjadi FODS" %}}
{{% blocks/products/pf/agp/text %}}
