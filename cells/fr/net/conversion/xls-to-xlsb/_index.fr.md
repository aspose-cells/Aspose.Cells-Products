---
title: Convertisseur C# XLS à XLSB - XLS à XLSB
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format XLS au format XLSB, permettant un enregistrement transparent des données XLS au format XLSB à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS au lieu de XLSB dans C#" %}}

L'exemple suivant montre comment convertir XLS en XLSB dans C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en XLSB. Téléchargez votre fichier XLS, puis enregistrez-le simplement sous le nom de fichier XLSB. Pour la lecture XLS et l'écriture XLSB, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie XLSB seront identiques au document XLS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir XLS en XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="xlsb" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en XLSB via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en XLSB par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en XLSB en quelques lignes de code seulement.
