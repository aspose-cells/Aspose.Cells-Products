...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert TextBox to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addtextbox) to insert a TextBox in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert TextBox - C#" offSpacer="" %}}
