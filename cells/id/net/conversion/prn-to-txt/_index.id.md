---
title: C# PRN ke TXT - Konverter PRN ke TXT
description: Aspose Unggul. Ubah PRN menjadi TXT dengan cepat dan mudah menggunakan Aspose.Cells. C# PRN menjadi TXT. C# Simpan PRN ke TXT. Simpan PRN sebagai TXT menggunakan C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah PRN menjadi TXT di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi PRN ke TXT. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, TXT, dan banyak format lainnya pada Kerangka .NET, Platform Inti .NET, atau Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PRN" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan PRN ke TXT di C#" %}}
...
{{% cells-convert title="Contoh Kode untuk Mengonversi PRN menjadi TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert PRN ke TXT lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke TXT secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi PRN ke TXT hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka C# untuk mengonversi PRN menjadi TXT" %}}
