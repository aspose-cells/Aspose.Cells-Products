---
title: Konwertuj SPREADSHEETML na XLSX za pomocą aplikacji C++ 
url: /pl/cpp/conversion/spreadsheetml-to-xlsx/ 
description: Przykładowy kod konwersji C++ dla dokumentu SPREADSHEETML do formatu XLSX. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji SPREADSHEETML na XLSX w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SPREADSHEETML na XLSX za pomocą C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować SPREADSHEETML na XLSX za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik SPREADSHEETML na XLSX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SPREADSHEETML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSX).1. Plik XLSX zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSX w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML do XLSX C++ Kod źródłowy konwersji" offSpacer="" %}}
