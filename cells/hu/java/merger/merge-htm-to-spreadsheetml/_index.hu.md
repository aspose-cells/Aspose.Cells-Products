---
title: HTM egyesítése SPREADSHEETML-lel – HTM egyesítése SPREADSHEETML-lel a Java-ben
url: /hu/java/merger/merge-htm-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése HTM SPREADSHEETML mentési formátumba. Java HTM kombinálása SPREADSHEETML formátummal. HTM egyesítése SPREADSHEETML-lel a Java-ben. HTM egyesítése.
...
{{% blocks/products/pf/agp/content h2="HTM egyesítése SPREADSHEETML-lel a Java használatával" %}}

 Hogyan egyesíthetem a HTM-et SPREADSHEETML-lel? A Aspose.Cells for Java könyvtárral könnyedén egyesítheti a HTM-et a SPREADSHEETML-lel programozottan néhány sornyi kóddal.[Aspose.Cells for Java](https://products.aspose.com/cells/java) képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Java Excel API nem csak a táblázatformátumok között konvertál, hanem Excel fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, CSV, CSV, CSV, CSV, CSV, SVG, és így tovább, SVG P, 8 PT a választás,3,8 ipari szabvány szerinti dokumentumok cseréjére formátumok. A legújabb verziót közvetlenül a webhelyről töltheti le[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) és telepítse a Maven alapú projekten belül a következő konfigurációk hozzáadásával a pom.xml fájlhoz.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a HTM-et a SPREADSHEETML-lel a Java-es számon" %}}

következő példa bemutatja, hogyan egyesítheti a HTM-et a SPREADSHEETML-lel a Aspose.Cells for Java számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTM és a SPREADSHEETML egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SPREADSHEETML fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a HTM-et a SPREADSHEETML-lel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTM és a SPREADSHEETML egyesítése a Java számon" InputFormat="htm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A HTM egyesítése a SPREADSHEETML via Java-gyel" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTM-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a HTM és a SPREADSHEETML egyesítéséhez" %}}
