---
title:  Insérer des formes dans Excel via Python-Net
description:  Les codes source Python-Net expliquent comment insérer une forme dans des fichiers Excel Microsoft à l'aide de la bibliothèque Python-Net.
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/i18n/feature-page-header h1="Microsoft<sup>&reg;</sup> Insertion de formes Excel via Python-Net" h2="Créez des documents Excel et insérez des formes à l\'aide d\'API côté serveur dans des applications basées sur Python via Net." >}}
...
{{% blocks/products/pf/feature-page-code h3="Python-Net Code pour insérer une forme dans Excel" %}}
