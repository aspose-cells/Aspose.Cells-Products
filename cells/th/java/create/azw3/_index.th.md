---
title: สร้างไฟล์ AZW3 - สร้างไฟล์ AZW3 ใน Java
description: Aspose Excel สร้างและจัดการไฟล์ AZW3 ได้อย่างง่ายดายด้วยไลบรารี Aspose.Cells for Java เครื่องมืออันทรงพลัง API นี้มอบโซลูชันที่คล่องตัวและมีประสิทธิภาพในการสร้าง แก้ไข และจัดการไฟล์ AZW3 โดยตรงภายในแอปพลิเคชัน Java ของคุณ ตอบสนองความต้องการเฉพาะของนักพัฒนาด้วยความแม่นยำสูง
...
{{% blocks/products/pf/agp/content h2="วิธีการสร้างไฟล์ AZW3 ในรหัส Java" %}}
...
1.  บันทึกเวิร์กบุ๊กในรูปแบบ AZW3 โดยใช้เมธอด save()

{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดแสดงวิธีการสร้างไฟล์ AZW3 ในเวอร์ชัน Java" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java ไลบรารีสำหรับสร้างไฟล์ AZW3" %}}
{{% blocks/products/pf/agp/text %}}
