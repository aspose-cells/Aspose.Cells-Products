---
title: C# XLS zu XLTM - Online-Konverter von XLS zu XLTM
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das Speicherformat XLTM. C# XLS bis XLTM Format. Speichern Sie XLS bis XLTM C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis XLTM in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLS in XLTM in C# konvertiert wird.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in XLTM" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in XLTM konvertieren? .NET-Entwickler können XLS problemlos in nur wenigen Codezeilen laden und in XLTM konvertieren.
...
1.  Konvertieren Sie XLS in XLTM, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in XLTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in XLTM" %}}
