---
title: Sloučit CSV až XLS - Sloučit CSV až XLS v C++
url: /cs/cpp/merger/merge-csv-to-xls/ 
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma CSV do formátu uložení XLS. C++ Kombinujte formát CSV až XLS. Sloučit CSV až XLS v C++. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV až XLS v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit CSV až XLS v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení CSV do XLS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLS. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí CSV do XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení CSV až XLS v C++" InputFormat="csv" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV na XLS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit CSV až XLS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení CSV až XLS" %}}
