...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج سهم مستقيم في ملف اكسيل عبر الرقم C#" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) لإدراج سهم مستقيم في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل السهم المستقيم - C#" offSpacer="" %}}
