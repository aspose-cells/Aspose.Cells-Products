...
{{% blocks/products/pf/agp/content h2="How to Create XML in Java" %}}
...
1.  Save the workbook as XML format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create XML file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create XML file" %}}
{{% blocks/products/pf/agp/text %}}
