---
title: Converti XLSX in JSON tramite l'applicazione C++ 
url: /it/cpp/conversion/xlsx-to-json/ 
description: Esempio di codice di conversione C++ per il documento XLSX in formato JSON. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLSX a JSON all'interno di qualsiasi applicazione C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLSX in JSON tramite C++" h2="Conversione da XLSX a JSON ad alte prestazioni utilizzando la libreria C++ senza la necessità di installare Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file XLSX in JSON in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLSX usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (JSON).1. Il file JSON verrà salvato nel percorso specificato.1. Apri il file JSON nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLSX a JSON C++" offSpacer="" %}}
