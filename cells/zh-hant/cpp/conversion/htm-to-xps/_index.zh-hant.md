...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 HTM 轉換為 XPS。C++ HTM 到 XPS。C++ 將 HTM 儲存為 XPS。C++ 將 HTM 儲存為 XPS。C++ 將 HTM 儲存為 XPS。
...
{{% blocks/products/pf/agp/content h2="將 HTM 儲存到 C++ 中的 XPS" %}}

下面的範例示範如何將C++中的HTM轉換為XPS。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 HTM 轉換為 XPS。上傳您的 HTM 文件，然後只需將其另存為 XPS 文件。對於 HTM 讀取和 XPS 寫入，您可以使用完全限定的檔案名稱。輸出 XPS 內容和格式將與原始 HTM 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 HTM 轉換為 XPS 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 HTM 轉換為 XPS" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 HTM 檔案轉換為 XPS？ C++開發人員只需幾行程式碼即可輕鬆將HTM轉換為XPS。
...
1. 使用工作簿載入 HTM 檔案。
1. 透過呼叫 Save() 方法將 HTM 轉換為 XPS。
1. 取得HTM到XPS的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ 庫將 HTM 轉換為 XPS" %}}
