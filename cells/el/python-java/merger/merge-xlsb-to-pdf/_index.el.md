...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση XLSB σε μορφή αποθήκευσης PDF. Python Συνδυάστε τη μορφή XLSB με PDF. Συγχώνευση XLSB σε PDF στο Python. XLSB Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLSB με PDF στο Python" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLSB έως PDF στο Python" InputFormat="xlsb" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
