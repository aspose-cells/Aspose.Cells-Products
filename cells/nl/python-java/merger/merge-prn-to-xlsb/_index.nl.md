...
description: Aspose Excel. Python Excel. Voeg PRN samen met het opslagformaat XLSB. Python Combineer PRN met XLSB-formaat. Voeg PRN samen met XLSB in de Excel-bibliotheek Python. PRN samenvoegen.
...
{{% blocks/products/pf/agp/content h2="PRN samenvoegen met XLSB met behulp van de Excel-bibliotheek Python" %}}
...
{{% blocks/products/pf/agp/content h2="PRN samenvoegen met XLSB in Excel-bibliotheek Python" %}}
...
{{% cells-merger title="Voorbeeldcode om PRN samen te voegen met XLSB in de Excel-bibliotheek Python" InputFormat="prn" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="PRN samenvoegen met XLSB via de Excel-bibliotheek Python" %}}
