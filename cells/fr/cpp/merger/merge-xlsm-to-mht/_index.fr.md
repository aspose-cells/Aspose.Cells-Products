---
title: Fusionner XLSM à MHT - Combiner XLSM à MHT dans C++
url: /fr/cpp/merger/merge-xlsm-to-mht/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion gratuite en ligne XLSM au format de sauvegarde MHT. C++ Combinez XLSM au format MHT. Fusionner XLSM à MHT en C++. XLSM Fusionner.
...
L'exemple suivant montre comment fusionner XLSM à MHT dans Aspose.Cells for C++.
...
{{% cells-merger title="Gratuit en ligne pour fusionner XLSM à MHT en C++" InputFormat="xlsm" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLSM à MHT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner XLSM avec MHT par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
