---
title:  Объединить MHT с XLSM через Python
...
В следующем примере показано, как объединить MHT с XLSM в Python.
...
{{% cells-merger title="Бесплатное приложение для объединения MHT с номером XLSM онлайн" InputFormat="mht" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
