...
description: Aspose Excel. Convierta SXC a XLSB rápida y fácilmente con Aspose.Cells. Python SXC a XLSB. Python Guarde SXC en XLSB. Guarde SXC como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar SXC al XLSB en Python" %}}

El siguiente ejemplo demuestra cómo convertir SXC a XLSB en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir SXC a XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlsb" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir SXC en XLSB" %}}
