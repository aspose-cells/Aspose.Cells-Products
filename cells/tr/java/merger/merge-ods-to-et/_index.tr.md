...
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme ODS'i ET'ye kaydetme biçimi. Java ODS'i ET biçimiyle birleştirin. ODS'i Java'de ET ile birleştir. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java Online\'da ET ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de ET ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="ODS\'i Java\'de ET ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS ile ET via Java Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 ODS'i programlı olarak ET ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i ET ile birleştirmek için Java kitaplığı" %}}
