---
title: Gabungkan MHTML menjadi MARKDOWN - Gabungkan MHTML menjadi MARKDOWN menjadi Java
url: /id/java/merger/merge-mhtml-to-markdown/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan MHTML menjadi MARKDOWN format simpan. Java Gabungkan format MHTML menjadi MARKDOWN. Gabungkan MHTML menjadi MARKDOWN di Java. MHTML Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHTML menjadi MARKDOWN di Java" %}}

Contoh berikut menunjukkan cara menggabungkan MHTML menjadi MARKDOWN di Aspose.Cells for Java.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan MHTML menjadi MARKDOWN di Java" InputFormat="mhtml" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML menjadi MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan MHTML ke MARKDOWN secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan MHTML menjadi MARKDOWN" %}}
