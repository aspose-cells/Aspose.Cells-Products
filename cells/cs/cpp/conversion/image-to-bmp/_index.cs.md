...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte IMAGE na BMP v C++" h2="Vysoce výkonná konverze IMAGE na BMP s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Potřebujete programově převést soubory IMAGE na BMP? Vývojáři s C++ mohou snadno převést IMAGE na BMP pomocí několika řádků kódu.
...
1.  Převeďte IMAGE na BMP voláním metody Save().
