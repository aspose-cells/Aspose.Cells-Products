...
url: /nl/net/merger/merge-fods-to-jpg/ 
...
Het volgende voorbeeld laat zien hoe u FODS samenvoegt met JPG in Aspose.Cells for .NET.
...
Wilt u FODS programmatisch samenvoegen met JPG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om FODS samen te voegen naar JPG" %}}
