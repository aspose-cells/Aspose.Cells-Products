---
title: Konwertuj XLT na MHTML za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlt-to-mhtml/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLT do formatu MHTML. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLT na MHTML w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLT na MHTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (MHTML).1. Plik MHTML zostanie zapisany pod określoną ścieżką.1. Otwórz plik MHTML w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLT do MHTML C++" offSpacer="" %}}
