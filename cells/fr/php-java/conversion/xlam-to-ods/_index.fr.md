---
title: Convertisseur PHP XLAM vers ODS - XLAM vers ODS
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir le format XLAM au format ODS, permettant ainsi un enregistrement transparent des données XLAM au format ODS grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
Besoin de convertir des fichiers XLAM en ODS par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers XLAM en ODS en quelques lignes de code seulement.
...
1.  Convertissez XLAM en ODS en appelant la méthode save de Workbook.
