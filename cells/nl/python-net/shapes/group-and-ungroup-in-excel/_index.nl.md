...
weight: 360
description: Objecten groeperen en degroeperen met behulp van Aspose.Cells' Python via .Net API zonder software zoals Microsoft of Open Office, Adobe PDF, enz.
...
{{< blocks/products/pf/i18n/upper-banner h1="Vormen groeperen en degroeperen in Excel met behulp van Python via .Net" h2="Gebruik Aspose.Cells\' API om met verschillende objecten te werken zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u vormen in een Excel-bestand kunt groeperen en degroeperen met behulp van Python via .Net" %}}
...
+ Selecteer Werkblad via de index.
 ...
 + Gebruik de[methode voor het opheffen van groepen](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/ungroup/) om vormen in het geselecteerde werkblad te degroeperen
...
{{% blocks/products/pf/agp/code-block title="Vormen groeperen en degroeperen - Python via .Net via .NET" offSpacer="" %}}
