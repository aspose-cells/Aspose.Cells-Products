---
title:  Вставьте RadioButton (элемент управления формой) в Excel, используя Python via .Net.
weight: 60
description: Python via Исходный код .Net для вставки RadioButton (элемент управления формой) в Excel.
...
{{% blocks/products/pf/agp/content h2="Как вставить RadioButton (элемент управления формой) в файл Excel с помощью Python via.Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке RadioButton (элемент управления формой) в файл Excel с использованием Python via.Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) чтобы вставить RadioButton (элемент управления формой) на выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить RadioButton (управление формой) — Python via.Net" offSpacer="" %}}
