---
title:  Добавить аннотацию к файлу Excel XLS через C++
weight: 10040
description: Пример кода C++ для добавления и удаления аннотаций формата XLS в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по добавлению комментариев в XLS через C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Загрузите файл Excel XLS с помощью объекта класса IWorkbook.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API можно использовать для создания, редактирования, преобразования и рендеринга Microsoft форматов Excel в различные форматы. Кроме того, его можно использовать для комплексных графиков, масштабируемых отчетов и надежных расчетов в программных приложениях. Aspose.Cells является автономным API и не требует никакого программного обеспечения, такого как Microsoft или OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Добавить / удалить аннотацию от XLS через онлайн-приложение" sectionDescription=" Удалите аннотации к документам XLS прямо сейчас, посетив наш[Веб-сайт живых демонстраций](https://products.aspose.app/cells/annotation). Живая демонстрация имеет следующие преимущества" >}}
