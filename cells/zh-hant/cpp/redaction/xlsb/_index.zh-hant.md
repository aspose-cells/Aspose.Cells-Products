---
title: 通過 C++ 搜索並替換 XLSB 文檔中的文本
weight: 6660
description: C++ 示例代碼，用於在 C++ 運行時環境（Windows 32 位、Windows 64 位和 Linux 64 位）上編輯 XLSB 文件中的敏感信息。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="編輯 XLSB C++ 格式" h2="本機高性能 XLSB 使用服務器端 Aspose.Cells for C++ API 記錄敏感的編輯信息，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
API這是一個功能豐富、功能強大且易於使用的文檔編輯API for C++平台。您可以直接下載最新版本，打開即可
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="在線 XLSB 密文現場演示" sectionDescription="立即通過訪問我們的網站搜索並替換 XLSB 文檔中的內容、評論或元數據中的文本[現場演示網站](https://products.aspose.app/cells/redaction)。現場演示有以下好處" >}}
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的密文文檔" subTitle="使用 C++，人們可以輕鬆編輯不同的格式，包括。" >}}
