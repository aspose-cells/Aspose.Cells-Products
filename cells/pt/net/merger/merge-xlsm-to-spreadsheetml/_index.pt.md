---
title: Mesclar XLSM com SPREADSHEETML - Combinar XLSM com SPREADSHEETML em C#
url: /pt/net/merger/merge-xlsm-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Mesclar XLSM para o formato de salvamento SPREADSHEETML. C# Combine XLSM para o formato SPREADSHEETML. Mesclar XLSM com SPREADSHEETML em C#. XLSM Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLSM com SPREADSHEETML em C#" %}}

O exemplo a seguir demonstra como mesclar XLSM com SPREADSHEETML em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLSM com SPREADSHEETML. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os no arquivo SPREADSHEETML. Se você desenvolver código em C#, será mais simples do que parece. Consulte o exemplo C# que mescla XLSM com SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemplo de código para mesclar XLSM com SPREADSHEETML em C#" InputFormat="xlsm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLSM com SPREADSHEETML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLSM com SPREADSHEETML programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca .NET para mesclar XLSM com SPREADSHEETML" %}}
