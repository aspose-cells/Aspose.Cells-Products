...
description: Aspose Excel. Java Aspose.Cells. Sloučit SPREADSHEETML do formátu uložení HTM. Java Zkombinujte SPREADSHEETML s formátem HTM. Sloučit SPREADSHEETML do HTM v Java. SPREADSHEETML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit SPREADSHEETML do HTM v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení SPREADSHEETML do HTM v Java" InputFormat="xml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
