---
title:  Combinar TXT Archivos via .NET
weight: 7350
description: Código fuente C# para combinar documentos TXT en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar TXT Formatos en C#" h2="Fusión de documentos nativa y de alto rendimiento TXT utilizando las API del lado del servidor Aspose.Cells for .NET, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
+ Ahora puede abrir y usar el archivo TXT en Office Microsoft, Adobe PDF o cualquier otro programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Combinar TXT Archivos - C#" offSpacer="" %}}
