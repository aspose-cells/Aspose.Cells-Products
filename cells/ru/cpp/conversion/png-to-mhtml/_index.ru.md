...
Нужно программно конвертировать файлы PNG в MHTML? Разработчики C++ могут легко преобразовать PNG в MHTML всего за несколько строк кода.
...
1.  Преобразуйте PNG в MHTML, вызвав метод Save().
