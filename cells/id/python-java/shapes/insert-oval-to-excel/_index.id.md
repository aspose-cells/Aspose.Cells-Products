---
title:  Masukkan Oval ke Excel menggunakan Python via Java
weight: 10
description: Python via Java kode sumber untuk memasukkan Oval ke dalam Excel.
keywords: [Python Aspose.Cells., Python add Oval shape., Python insert Oval shape., Python create Oval shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan Oval ke Excel menggunakan Python via Java" h2="Masukkan oval menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan Oval ke File Excel Menggunakan Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan file Oval ke Excel menggunakan Python via Java" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan koleksi bentuk[tambahkan metode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addOval(int,%20int,%20int,%20int,%20int,%20int)) untuk menyisipkan Oval di lembar kerja yang dipilih.
...
{{% blocks/products/pf/agp/code-block title="Masukkan Oval - Python via Java" offSpacer="" %}}
