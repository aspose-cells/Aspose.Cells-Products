---
title: Converteer HTML naar MHTML via C++ applicatie 
weight: 4130
url: /nl/cpp/conversion/html-to-mhtml/ 
description: Voorbeeld C++ conversiecode voor HTML-document naar MHTML-indeling. Programmeurs kunnen deze broncode gebruiken voor batch-HTML-naar-MHTML-conversie binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer HTML naar MHTML via C++" h2="Hoogwaardige conversie van HTML naar MHTML met behulp van de C++-bibliotheek zonder installatie van Microsoft Excel, OpenOffice of Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen HTML-bestanden eenvoudig in slechts een paar regels code converteren naar MHTML.

{{% /blocks/products/pf/agp/text %}}

1. Laad HTML-bestand met behulp van Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (MHTML) bestandsextensie.1. MHTML-bestand wordt opgeslagen op het opgegeven pad.1. Open het MHTML-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="HTML naar MHTML C++ Broncode voor conversie" offSpacer="" %}}
