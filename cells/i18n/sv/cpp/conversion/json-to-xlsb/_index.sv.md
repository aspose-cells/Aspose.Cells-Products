---
title: Konvertera JSON till XLSB via appen C++ 
url: /sv/cpp/conversion/json-to-xlsb/ 
description: Exempel på konverteringskod för C++ för JSON-dokument till XLSB-format. Programmerare kan använda den här källkoden för batchkonvertering av JSON till XLSB inom alla C++-program.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera JSON till XLSB via C++" h2="Högpresterande JSON till XLSB-konvertering med hjälp av C++-biblioteket utan behov av installation av Microsoft Excel, OpenOffice eller Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera JSON-filen till XLSB på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda JSON-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (XLSB) filtillägg.1. XLSB-filen kommer att sparas på den angivna sökvägen.1. Öppna XLSB-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="JSON till XLSB C++ konverteringskällkod" offSpacer="" %}}
