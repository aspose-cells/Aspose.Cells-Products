---
title: XLTM'i HTM ile birleştir - XLTM'i C#'de HTM ile birleştir
url: /tr/net/merger/merge-xltm-to-htm/ 
description: Aspose Excel'de. C# Aspose.Cells. XLTM'i HTM kaydetme biçimiyle birleştirin. C# XLTM'i HTM formatıyla birleştirin. XLTM'i C#'deki HTM ile birleştirin. XLTM Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i C#\'deki HTM ile birleştir" %}}

Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'deki HTM ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

XLTM'i HTM ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından HTM dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. XLTM'i HTM ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="XLTM\'i C#\'deki HTM ile Birleştirmek için Örnek Kod" InputFormat="xltm" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="XLTM\'i C# aracılığıyla HTM ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

XLTM'i HTM ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kitaplığı, XLTM\'i HTM ile birleştirecek" %}}
