---
title: Chuyển đổi XLTX sang BMP qua ứng dụng C++ 
url: /vi/cpp/conversion/xltx-to-bmp/ 
description: Mã chuyển đổi C++ mẫu cho tài liệu XLTX sang định dạng BMP. Lập trình viên có thể sử dụng mã nguồn này để chuyển đổi hàng loạt XLTX sang BMP trong bất kỳ Ứng dụng C++ nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLTX sang BMP qua C++" h2="Chuyển đổi XLTX sang BMP hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLTX sang BMP bằng cách sử dụng C++" %}}
 ...
 Để chuyển đổi XLTX thành BMP, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp XLTX thành BMP chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLTX bằng Factory :: CreateIWorkbook.1. Chọn trang tính đầu tiên.1. Đặt (BMP) tùy chọn.1. Lặp lại từng trang của trang tính và kết xuất.1. Mở tệp BMP trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi XLTX sang BMP C++" offSpacer="" %}}
