---
title: Fusionar XLSM con CSV - Combinar XLSM con CSV en Java
url: /es/java/merger/merge-xlsm-to-csv/ 
description: Aspose Excel. Java Aspose.Cells. Fusionar XLSM con CSV guardar formato. Java Combina el formato XLSM con CSV. Fusionar XLSM con CSV en Java. XLSM Fusionar.
...
{{% blocks/products/pf/agp/content h2="Fusionar XLSM con CSV en Java" %}}

El siguiente ejemplo demuestra cómo fusionar XLSM con CSV en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLSM con CSV. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo CSV. Si desarrolla código en Java, esto será más simple de lo que parece. Vea el ejemplo de Java que fusiona XLSM con CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar XLSM con CSV en Java" InputFormat="xlsm" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM con CSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLSM con CSV mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Java para fusionar XLSM con CSV" %}}
