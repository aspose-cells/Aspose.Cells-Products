...
{{% cells-convert title="Free App and Sample Code to Convert XLSB to DIF" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et InputFormat=xlsb outformat=dif IsLandingPage=true language=python %}}
