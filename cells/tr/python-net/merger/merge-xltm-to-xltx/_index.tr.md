...
description: Aspose excel. Python Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme XLTM ile XLTX kaydetme biçimi. Python XLTM ile XLTX formatını birleştirin. Python içinde XLTM'i XLTX ile birleştir. XLTM Birleştir.
...
Aşağıdaki örnek, XLTM'in Aspose.Cells for Python via .NET'de XLTX ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLTM\'i Python\'de XLTX ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xltm" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="XLTM\'i Python üzerinden XLTX ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLTM ile XLTX'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
