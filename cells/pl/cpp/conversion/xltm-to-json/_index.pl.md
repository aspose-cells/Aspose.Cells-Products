---
title: Konwertuj XLTM na JSON za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltm-to-json/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTM do formatu JSON. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTM na JSON w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLTM na JSON w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (JSON).1. Plik JSON zostanie zapisany pod określoną ścieżką.1. Otwórz plik JSON w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLTM do JSON C++" offSpacer="" %}}
