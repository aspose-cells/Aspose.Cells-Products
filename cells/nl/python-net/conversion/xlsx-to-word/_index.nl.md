...
Het volgende voorbeeld laat zien hoe u XLSX converteert naar WORD in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSX naar WORD te converteren" %}}
