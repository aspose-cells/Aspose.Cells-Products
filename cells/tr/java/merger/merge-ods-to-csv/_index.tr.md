...
description: Aspose Excel'de. Java Aspose.Cells. ODS'i CSV kaydetme biçimiyle birleştirin. Java ODS'i CSV biçimiyle birleştirin. Java'de ODS'i CSV ile birleştirin. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'de CSV ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de ODS ile CSV'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS ile CSV'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından CSV dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. ODS ile CSV'i birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS ile CSV\'i Java\'de Birleştirmek için Örnek Kod" InputFormat="ods" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS ile CSV via Java Nasıl Birleştirilir?" %}}

{{% blocks/products/pf/agp/text %}}

 ODS ile CSV'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, ODS ile CSV arasında birleştirilecek" %}}
