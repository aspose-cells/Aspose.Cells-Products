---
title: Sloučit HTM do ET – Zkombinujte HTM s ET v C++
url: /cs/cpp/merger/merge-htm-to-et/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit formát uložení HTM do ET. C++ Kombinujte formát HTM s ET. Sloučit HTM do ET v C++. HTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM do ET v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit HTM do ET v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení HTM s ET. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru ET. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který spojuje HTM s ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení HTM do ET na čísle C++" InputFormat="htm" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM do ET přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit HTM do ET programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení HTM do ET" %}}
