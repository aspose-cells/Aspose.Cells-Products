---
title:  Adicionar ou remover anotação do arquivo Excel XLSB via C++
weight: 860
description: C++ código de exemplo para excluir anotações de formato XLSB no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
