---
title: Konvertor PHP XLAM až MHTML - XLAM až MHTML
description: Aspose Excel. Převeďte XLAM na MHTML rychle a snadno pomocí Aspose.Cells. PHP XLAM na MHTML. PHP Uložte XLAM na MHTML. Uložte MHTML jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="mhtml" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na MHTML přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na MHTML programově? Vývojáři PHP mohou snadno načíst a převést XLAM na MHTML v několika řádcích kódu.
...
1.  Převeďte XLAM na MHTML voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na MHTML" %}}
