...
weight: 101
description: C# исходный код для рисования или вставки формы локтя в Excel на платформах .NET Framework, .NET Core, Mono или Xamarin.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги, чтобы вставить форму локтя в файл Excel через C#" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) чтобы вставить форму локтя в выбранный рабочий лист
...
{{% blocks/products/pf/agp/code-block title="Вставка коленчатая - C#" offSpacer="" %}}
