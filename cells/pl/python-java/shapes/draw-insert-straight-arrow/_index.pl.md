---
title:  Jak narysować lub wstawić prostą strzałkę do Excela za pomocą Python via Java
weight: 10
...
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw prostą strzałkę do Excela, używając Python via Java" h2="Wstaw prostą strzałkę za pomocą Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
Aby wstawić prostą strzałkę do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić prostą strzałkę do pliku Excel przy użyciu Python via Java" %}}
