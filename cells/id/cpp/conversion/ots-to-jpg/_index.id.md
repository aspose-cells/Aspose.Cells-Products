---
title: C++ OTS ke JPG - Konverter OTS ke JPG
description: Aspose Unggul. Konversi OTS ke JPG dengan cepat dan mudah dengan Aspose.Cells. C++ OTS ke JPG. C++ Simpan OTS ke JPG. Simpan OTS sebagai JPG menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Simpan OTS ke JPG di C++" %}}

Contoh berikut menunjukkan cara mengonversi OTS ke JPG di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi OTS ke JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert OTS ke JPG lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file OTS ke JPG secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke JPG hanya dalam beberapa baris kode.
...
1.  Konversikan OTS ke JPG dengan memanggil metode Save().
1.  Dapatkan hasil konversi OTS ke JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Library C++ untuk convert OTS ke JPG" %}}
