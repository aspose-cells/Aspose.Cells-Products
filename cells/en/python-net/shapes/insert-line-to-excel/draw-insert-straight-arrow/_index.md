...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) to insert a straight arrow in the selected worksheet.
...
-  Any operating system that can run python scripts, such as Windows and Linux
