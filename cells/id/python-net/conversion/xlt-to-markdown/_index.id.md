...
Contoh berikut menunjukkan cara mengonversi XLT menjadi MARKDOWN di Python via NET.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah XLT menjadi MARKDOWN" %}}
