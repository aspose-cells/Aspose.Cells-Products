---
title:  Połącz XLSX z PDF przez Python
url: /pl/python-net/merger/merge-xlsx-to-pdf/ 
description: Połącz XLSX z PDF Online za darmo. Bezpłatnie online XLSX do PDF Fuzja. Połącz XLSX z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć XLSX z PDF w Python.
...
{{% cells-merger title="Darmowa aplikacja do łączenia XLSX z PDF on-line" InputFormat="xlsx" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
