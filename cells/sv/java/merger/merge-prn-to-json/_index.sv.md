---
title: Slå ihop PRN till JSON - Kombinera PRN till JSON i Java
url: /sv/java/merger/merge-prn-to-json/ 
description: Aspose Excel. Java Aspose.Cells. Gratis Online Merge PRN till JSON saveformat. Java Kombinera PRN till JSON format. Slå samman PRN till JSON i Java. PRN sammanfoga.
...
Följande exempel visar hur man slår ihop PRN till JSON i Aspose.Cells for Java.
...
{{% cells-merger title="Gratis online för att slå samman PRN till JSON i Java" InputFormat="prn" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår ihop PRN till JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du slå samman PRN till JSON programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for Java](https://products.aspose.com/cells/java) API:er kan göras med bara några rader kod.
