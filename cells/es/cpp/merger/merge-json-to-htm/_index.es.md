---
title: Fusionar JSON con HTM - Combinar JSON con HTM en C++
url: /es/cpp/merger/merge-json-to-htm/ 
description: Aspose Excel. C++ Aspose.Cells. Fusionar JSON con el formato guardado HTM. C++ Combina JSON al formato HTM. Fusionar JSON con HTM en C++. JSON Fusionar.
...
{{% blocks/products/pf/agp/content h2="Fusionar JSON con HTM en C++" %}}

El siguiente ejemplo demuestra cómo fusionar JSON con HTM en Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar JSON con HTM. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo HTM. Si desarrolla código en C++, esto será más simple de lo que parece. Vea el ejemplo de C++ que fusiona JSON con HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar JSON con HTM en C++" InputFormat="json" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar JSON con HTM a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar JSON con HTM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para fusionar JSON con HTM" %}}
