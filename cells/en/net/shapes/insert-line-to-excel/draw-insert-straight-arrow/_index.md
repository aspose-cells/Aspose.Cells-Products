...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert straight arrow to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) to insert a straight arrow in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert straight arrow - C#" offSpacer="" %}}
