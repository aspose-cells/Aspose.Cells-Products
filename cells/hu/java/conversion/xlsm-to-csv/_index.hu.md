---
title: "XLSM konvertálása CSV-vé a következőn keresztül: Java "
weight: 9910

description: Minta Java konverziós kód az XLSM formátumhoz CSV-fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására CSV-fájlba bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSM konvertálása CSV-vé a következőn keresztül: Java" h2="XLSM-ből CSV-vé Java konverzió egyetlen vagy több oldal konvertálásához CSV-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="XLSM konvertálása CSV-vé a következővel: Java" %}}

 Ahhoz, hogy az XLSM-et CSV formátumba rendereljük, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM CSV-vé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják az XLSM-fájlt CSV-vé.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSM-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat CSV kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott CSV-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLSM-ből CSV-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLSM fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xlsm");
// mentse az XLSM-et CSV-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLSM-ből CSV-be konvertáló élő bemutatók" sectionDescription="[Konvertálja az XLSM-et CSV-vé](https://products.aspose.app/cells/conversion/xlsm-to-csv) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel XLSM-fájlját, és azonnal CSV formátumba konvertálódik." >}}
