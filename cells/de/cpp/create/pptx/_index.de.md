---
title: Erstellen Sie PPTX – Erstellen Sie die Datei PPTX in C++
description: Aspose Excel. C++ Datei PPTX erstellen. Erstellen PPTX C++. C++ PPTX Ersteller. Erstellen Sie PPTX in C++. Generieren Sie die Datei PPTX mit C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Erstellen Sie die Datei PPTX in C++" h2="Native und leistungsstarke PPTX-Dateierstellung programmgesteuert ohne Microsoft Office unter Verwendung der C++-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="So erstellen Sie PPTX in C++" %}}

{{% blocks/products/pf/agp/text %}}

 Für die Entwickler ist es einfach, PPTX-Dateien in laufenden Berichtsanwendungen für die Datenverarbeitung in nur wenigen Codezeilen zu erstellen, zu laden, zu ändern und zu konvertieren.
...
1.  Speichern Sie die Arbeitsmappe mit der Save()-Methode als PPTX-Datei.

{{% blocks/products/pf/agp/code-block title="Der Beispielcode zeigt, wie die Datei PPTX in C++ erstellt wird." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++-Bibliothek zum Erstellen der PPTX-Datei" %}}
