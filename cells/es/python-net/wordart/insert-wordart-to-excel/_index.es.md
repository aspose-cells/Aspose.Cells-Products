...
weight: 200
description: Python via Código fuente .Net para insertar WordArt en Excel.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar un archivo de WordArt a Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el complemento de la colección de formas.[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_word_art/#PresetWordArtStyle-str-int-int-int-int-int-int) para insertar un WordArt en la hoja de trabajo seleccionada.
