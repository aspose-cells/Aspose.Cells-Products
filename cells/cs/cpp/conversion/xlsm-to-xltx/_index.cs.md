---
title: Převeďte XLSM na XLTX pomocí aplikace C++ 
url: /cs/cpp/conversion/xlsm-to-xltx/ 
description: Ukázkový konverzní kód C++ pro dokument XLSM na formát XLTX. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLSM na XLTX v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLSM na XLTX pomocí C++" %}}

 K převodu XLSM na XLTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod XLSM na XLTX prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLSM na XLTX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLSM pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLTX).1. Soubor XLTX bude uložen do zadané cesty.1. Otevřete soubor XLTX v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLSM na XLTX C++" offSpacer="" %}}
