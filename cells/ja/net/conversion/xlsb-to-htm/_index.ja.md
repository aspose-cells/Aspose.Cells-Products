---
title: C# XLSB から HTM - XLSB から HTM コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLSBをHTMにすばやく簡単に変換します。C# XLSBをHTMに変換します。 C# XLSB を HTM に保存します。 C# を使用して XLSB を HTM として保存します。
...
{{% cells-convert title="XLSBをHTMに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="htm" IsLandingPage="true" %}}
