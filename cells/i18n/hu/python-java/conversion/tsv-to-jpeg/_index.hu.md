...
{{< blocks/products/pf/i18n/upper-banner h1="TSV konvertálása JPEG formátumba a következőn keresztül: Python" h2="Exportálja az Excel® táblázatokat JPEG formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása JPEG formátumba a következővel: Python" %}}

 A TSV JPEG formátumba konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TSV konvertálása JPEG formátumba a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python fejlesztői könnyedén betölthetnek és konvertálhatnak TSV fájlokat JPEG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TSV-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal megadása JPG kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott JPEG fájl megadott elérési útját
