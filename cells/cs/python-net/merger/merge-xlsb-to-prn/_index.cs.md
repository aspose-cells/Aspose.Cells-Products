...
url: /cs/python-net/merger/merge-xlsb-to-prn/ 
...
Následující příklad ukazuje, jak sloučit XLSB do PRN v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLSB s PRN programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
