---
title: A XLSB egyesítése az EXCEL-lel – a XLSB egyesítése az EXCEL-lel a C#-ben
url: /hu/net/merger/merge-xlsb-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés XLSB EXCEL mentési formátumba. C# Kombinálja a XLSB-et EXCEL formátumba. A XLSB egyesítése az EXCEL-lel a C#-ben. XLSB Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLSB-et az EXCEL-hez a C#-es online ingyen" %}}

következő példa bemutatja, hogyan lehet egyesíteni a XLSB-et az EXCEL-lel a Aspose.Cells for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLSB EXCEL-lel való egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el EXCEL fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a XLSB-et az EXCEL-lel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a XLSB-es EXCEL-lel a C#-ben" InputFormat="xlsb" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLSB és az EXCEL egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLSB-et az EXCEL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB EXCEL-be való egyesítéséhez" %}}
