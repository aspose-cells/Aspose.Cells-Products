---
title: Python OTS naar NUMMERS - OTS naar NUMMERS-omzetter
description: Aspose Excel. Deze complete oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van OTS- naar NUMBERS-formaat, waardoor het naadloos opslaan van OTS-gegevens in NUMBERS-formaat mogelijk is met behulp van de Aspose.Cells-bibliotheek, allemaal via efficiënte en aanpasbare Python-code.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer OTS naar NUMBERS in de Excel-bibliotheek Python" h2="Snelle Excel-bibliotheek Python voor het converteren van OTS naar NUMBERS. Dit is een professionele softwareoplossing voor het importeren en exporteren van OTS, NUMBERS en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar NUMBERS met behulp van de Excel-bibliotheek Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sla OTS op als NUMBERS in de Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u OTS-waarden naar NUMBERS kunt converteren in de Excel-bibliotheek Python.
...
{{% cells-convert title="Voorbeeldcode om OTS naar NUMBERS te converteren via de Excel-bibliotheek Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="numbers" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe zet ik OTS-codes om naar NUMMERS via Python?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch naar NUMBERS converteren? Ontwikkelaars van Python kunnen OTS-bestanden eenvoudig laden en converteren naar NUMBERS met slechts een paar regels code.
...
1. Converteer OTS naar NUMBERS door de Workbook.save-methode aan te roepen.
1.  Verkrijg het resultaat van de conversie van OTS naar NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek voor het converteren van OTS naar NUMBERS" %}}
