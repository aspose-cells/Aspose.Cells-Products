---
title: Voeg MHT samen met SPREADSHEETML - Combineer MHT met SPREADSHEETML in Java
url: /nl/java/merger/merge-mht-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online MHT samenvoegen naar SPREADSHEETML-opslagindeling. Java Combineer MHT naar SPREADSHEETML-formaat. MHT samenvoegen naar SPREADSHEETML in Java. MHT samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis MHT samen met SPREADSHEETML in Java Online" %}}

Het volgende voorbeeld laat zien hoe u MHT kunt samenvoegen met SPREADSHEETML in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHT samen te voegen met SPREADSHEETML. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het SPREADSHEETML-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat MHT samenvoegt met SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om MHT samen te voegen met SPREADSHEETML in Java" InputFormat="mht" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="MHT samenvoegen met SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHT programmatisch samenvoegen met SPREADSHEETML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
