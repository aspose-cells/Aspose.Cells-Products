...
{{% blocks/products/pf/agp/content h2="C# में एचटीएम को XLAM पर मुफ्त में ऑनलाइन सेव करें" %}}

निम्न उदाहरण दर्शाता है कि C# में एचटीएम को XLAM में कैसे परिवर्तित किया जाए।
{{% blocks/products/pf/agp/text %}}

HTM को XLAM में बदलने के लिए आसान चरणों का पालन करें। अपनी HTM फ़ाइल अपलोड करें, फिर इसे XLAM फ़ाइल के रूप में सहेजें। एचटीएम पढ़ने और XLAM लिखने दोनों के लिए आप पूरी तरह योग्य फ़ाइल नामों का उपयोग कर सकते हैं। आउटपुट XLAM सामग्री और स्वरूपण मूल HTM दस्तावेज़ के समान होगा।

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="एचटीएम को ऑनलाइन XLAM में बदलने के लिए मुफ्त ऐप और नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlam" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# के माध्यम से HTM को XLAM में कैसे बदलें" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर्स आसानी से कोड की कुछ पंक्तियों में एचटीएम को XLAM में लोड और परिवर्तित कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1.  कार्यपुस्तिका के उदाहरण के साथ एचटीएम फ़ाइल लोड करें
1. Workbook.Save विधि को कॉल करके HTM को XLAM में बदलें

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="HTM को XLAM में बदलने के लिए C# लाइब्रेरी" %}}
