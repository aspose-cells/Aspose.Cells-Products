...
url: /cs/python-java/merger/merge-mht-to-spreadsheetml/ 
...
Následující příklad ukazuje, jak sloučit MHT do SPREADSHEETML v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit MHT do SPREADSHEETML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
