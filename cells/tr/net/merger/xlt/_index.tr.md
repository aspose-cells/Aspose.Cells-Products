...
{{% blocks/products/pf/agp/feature-section-col title="XLT Dosyalarını C#\'de Birleştirme Adımları" %}}
...
+ Save() yöntemini çağırın ve dosya adını (tam yol) ve biçimini (XLT) parametre olarak iletin.
+ Artık XLT dosyasını Microsoft Office, Adobe PDF veya başka bir uyumlu programda açıp kullanabilirsiniz.
