---
title:  ابحث عن مستند XLS بدون فتح via .NET
weight: 1490
description: C# الكود المصدري للبحث عن الكلمات ذات النمط في ملف XLS على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
