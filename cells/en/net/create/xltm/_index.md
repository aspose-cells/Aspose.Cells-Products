...
{{% blocks/products/pf/agp/content h2="How to Create XLTM in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create XLTM file in C#." offSpacer="" %}}
