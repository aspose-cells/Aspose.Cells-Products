---
title: Unisci TABDELIMITED a DOCX - Combina TABDELIMITED a DOCX in C#
url: /it/net/merger/merge-tabdelimited-to-docx/ 
description: Aspose Excel. C# Aspose.Cells. Fusione online gratuita TABDELIMITED in DOCX saveformat. C# Combina TABDELIMITED nel formato DOCX. Unisci TABDELIMITED a DOCX in C#. TABDELIMITED Unisci.
...
L'esempio seguente mostra come unire TABDELIMITED a DOCX in Aspose.Cells for .NET.
...
{{% cells-merger title="Gratuito online per unire TABDELIMITED a DOCX in C#" InputFormat="tsv" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire TABDELIMITED a DOCX tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire TABDELIMITED a DOCX a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
