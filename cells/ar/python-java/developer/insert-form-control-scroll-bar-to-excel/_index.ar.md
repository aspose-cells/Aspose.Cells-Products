---
title:  أدخل شريط التمرير (التحكم في النموذج) في Excel باستخدام Python via java
weight: 90
description: Python via كود مصدر جافا لإدراج شريط التمرير (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شريط التمرير (التحكم في النموذج) في ملف Excel باستخدام جافا Python via" %}}

 من أجل إدراج ScrollBar (التحكم في النموذج) في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج ScrollBar (التحكم في النموذج) إلى ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addScrollBar(int,%20int,%20int,%20int,%20int,%20int)) لإدراج شريط التمرير (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل شريط التمرير (التحكم في النموذج) - Python via java" offSpacer="" %}}
