...
È necessario convertire i file PRN in BMP a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in BMP in poche righe di codice.
...
1.  Converti PRN in BMP chiamando il metodo Save().
