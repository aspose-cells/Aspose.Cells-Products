...
description: Aspose Exceller. Python Aspose.Cells. Fusionner le format de sauvegarde XLS à JSON. Python Combinez les formats XLS à JSON. Fusionner XLS à JSON dans Python. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS à JSON dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner XLS à JSON dans Python" InputFormat="xls" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
