---
title: PHP XLSB sang HÌNH ẢNH - XLSB Chuyển đổi HÌNH ẢNH
description: Aspose Excel. Chuyển đổi XLSB sang IMAGE nhanh chóng và dễ dàng với Aspose.Cells. PHP XLSB sang IMAGE. PHP Lưu XLSB vào HÌNH ẢNH. Lưu XLSB dưới dạng HÌNH ẢNH bằng PHP.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSB thành HÌNH ẢNH bằng PHP" %}}
 ...
 Làm cách nào để chuyển đổi XLSB thành HÌNH ẢNH? Với thư viện Aspose.Cells for PHP via Java, bạn có thể dễ dàng chuyển đổi XLSB thành IMAGE theo chương trình chỉ với một vài dòng mã.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, hiển thị và in tất cả các tệp Excel. PHP Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó, nó trở thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Lưu XLSB vào HÌNH ẢNH trong PHP" %}}

Ví dụ sau đây trình bày cách chuyển đổi XLSB thành IMAGE trong PHP.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSB thành HÌNH ẢNH qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi file XLSB sang IMAGE theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi XLSB thành HÌNH ẢNH chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLSB thành IMAGE bằng cách gọi phương thức lưu của Workbook.
1.  Nhận kết quả chuyển đổi XLSB thành HÌNH ẢNH.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện PHP để chuyển đổi XLSB thành HÌNH ẢNH" %}}
