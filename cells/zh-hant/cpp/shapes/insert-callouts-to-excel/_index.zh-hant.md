...
weight: 810
description: C++ 範例程式碼，用於在 Excel 檔案中插入標註，適用於 C++ 運行時環境，支援 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
keywords: [C++ Aspose.Cells., C++ add Callouts shape., C++ insert Callouts shape., C++ create Callouts shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 將標註插入 Excel" h2="使用伺服器端 Aspose.Cells for C++ API 的原生高效能插入對象，無需使用任何軟體，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 在 Excel 檔案中插入標註" %}}

為了在 Excel 文件中插入標註，我們將使用
...
+ 透過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/)在選定的工作表中插入標註
將工作簿儲存為 XLSX 格式。
...
以下範例程式碼示範如何插入「想法氣泡：雲朵」。更多類型，請參閱下方的「標註類型概述」。
...
自旋形狀類型::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
自旋形狀類型::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar3
    </p>
   </div>
  </div>
 </div>
