---
title: Unisci ODS a IMAGE - Combina ODS a IMAGE in Java
url: /it/java/merger/merge-ods-to-image/ 
description: Aspose Excel. Java Aspose.Cells. Unisci online gratuito ODS in IMAGE saveformat. Java Combina ODS al formato IMAGE. Unisci ODS a IMAGE in Java. ODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci ODS a IMMAGINE in Java online gratuitamente" %}}

L'esempio seguente mostra come unire ODS a IMAGE in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire ODS a IMAGE. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file IMAGE. Se sviluppi il codice in Java, sarà più semplice di quanto sembri. Vedere l'esempio Java che unisce ODS a IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuito online per unire ODS a IMAGE in Java" InputFormat="ods" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Come unire ODS all\'IMMAGINE via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire ODS a IMAGE in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Java libreria per unire ODS a IMAGE" %}}
