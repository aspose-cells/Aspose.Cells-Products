...
{{% blocks/products/pf/agp/content h2="Sla OTS op in DOCX in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar DOCX converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar DOCX via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar DOCX? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar DOCX met slechts een paar regels code.
