---
title: Criar ET - Criar arquivo ET em Python
description: Aspose Excel. Gere e manipule arquivos ET sem esforço com a biblioteca Aspose.Cells for Python via .NET. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos ET diretamente em seus aplicativos Python, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar um arquivo ET na biblioteca Excel Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca Excel para criar arquivo ET" %}}
