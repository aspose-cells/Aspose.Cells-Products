---
title: Unisci CSV a ODS - Combina CSV a ODS in C#
url: /it/net/merger/merge-csv-to-ods/ 
description: Aspose Excel. C# Aspose.Cells. Unione online gratuita da CSV a ODS saveformat. C# Combina il formato CSV con ODS. Unisci CSV a ODS in C#. CSV Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci CSV a ODS in C# online gratuitamente" %}}

L'esempio seguente mostra come unire CSV a ODS in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire CSV a ODS. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file ODS. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce CSV a ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire CSV a ODS in C#" InputFormat="csv" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire CSV a ODS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire CSV a ODS a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca da unire CSV a ODS" %}}
