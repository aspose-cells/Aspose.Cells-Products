...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLS till WORD i C#" h2="Snabbt C#-bibliotek för konvertering av XLS till WORD. Detta är en professionell programvarulösning för att importera och exportera XLS, WORD och många andra format på .NET Framework, .NET Core eller Mono-plattformarna." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
Behöver du konvertera XLS-filer till WORD programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till WORD på bara några rader kod.
...
1.  Konvertera XLS till WORD genom att anropa Workbook.Save-metoden.
