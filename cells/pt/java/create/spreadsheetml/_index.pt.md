...
description: Aspose Excel. Gere e manipule arquivos SPREADSHEETML sem esforço com a biblioteca Aspose.Cells for Java. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos SPREADSHEETML diretamente em seus aplicativos Java, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo SPREADSHEETML em Java" h2="Biblioteca Java de alta velocidade para criação de arquivos SPREADSHEETML. Esta é uma solução de software profissional para importar e exportar arquivos nos formatos XLSX, PDF e muitos outros, utilizando a biblioteca Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como criar um arquivo SPREADSHEETML em Java" %}}
...
1.  Salve a planilha no formato SPREADSHEETML usando o método save().

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar um arquivo SPREADSHEETML em Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Java para criar arquivo SPREADSHEETML" %}}
{{% blocks/products/pf/agp/text %}}
