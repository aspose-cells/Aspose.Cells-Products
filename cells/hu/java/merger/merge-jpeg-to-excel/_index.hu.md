---
title: A JPEG egyesítése az EXCEL-lel – a JPEG egyesítése az EXCEL-lel a Java-ben
url: /hu/java/merger/merge-jpeg-to-excel/ 
description: Aspose Excel. Java Aspose.Cells. A JPEG egyesítése EXCEL mentési formátumba. Java Kombinálja a JPEG-et EXCEL formátumba. A JPEG egyesítése az EXCEL-lel a Java-ben. JPEG Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A JPEG egyesítése az EXCEL-lel a Java-ben" %}}

következő példa bemutatja, hogyan lehet egyesíteni a JPEG-et az EXCEL-lel a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a JPEG EXCEL-lel való egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el EXCEL fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a JPEG-et az EXCEL-lel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a JPEG egyesítéséhez az EXCEL-hez a Java-ben" InputFormat="jpg" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A JPEG és az EXCEL via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a JPEG-et az EXCEL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a JPEG EXCEL-be való egyesítéséhez" %}}
