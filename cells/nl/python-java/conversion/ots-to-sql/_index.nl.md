...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar SQL met Aspose.Cells. Python OTS naar SQL. Python OTS opslaan in SQL. Sla OTS op als SQL met behulp van Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer OTS naar SQL in Python" h2="Snelle Python-bibliotheek voor het converteren van OTS naar SQL. Dit is een professionele softwareoplossing voor het importeren en exporteren van OTS, SQL en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Sla OTS op in SQL in Python" %}}

In het volgende voorbeeld ziet u hoe u OTS naar SQL converteert in Python.
