...
description: Aspose اكسل. قم بتحويل MHT إلى ODS بسرعة وسهولة باستخدام Aspose.Cells. C++ MHT إلى ODS. C++ احفظ MHT إلى ODS. احفظ MHT كـ ODS باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على ODS في C++" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="ods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى ODS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى ODS برمجياً؟ يمكن لمطوري C++ تحويل MHT بسهولة إلى ODS في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى ODS عن طريق استدعاء طريقة Save ().
