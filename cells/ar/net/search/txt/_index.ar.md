---
title:  ابحث عن مستند TXT بدون فتح via .NET
weight: 8410
description: C# الكود المصدري للبحث عن الكلمات ذات النمط في ملف TXT على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
+ تحميل ملف TXT باستخدام فئة المصنف.
