---
title: Python PRN から JPG へ - PRN から JPG へのコンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、PRN を JPG にすばやく簡単に変換します。 Python PRN を JPG に変換します。 Python PRN を JPG に保存します。 Python を使用して PRN を JPG として保存します。
...
{{% blocks/products/pf/agp/content h2="Pythonを使用してPRNをJPGに変換" %}}
...
{{% blocks/products/pf/agp/content h2="Python で PRN を JPG に保存" %}}

次の例は、Python で PRN を JPG に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従ってPRNをJPGに変換します。 PRN ファイルをアップロードし、JPG ファイルとして保存します。 PRN の読み取りと JPG の書き込みの両方で、完全修飾ファイル名を使用できます。出力 JPG コンテンツと形式は、元の PRN ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="PRN を JPG に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="jpg" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でPRNをJPGに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで PRN ファイルを JPG に変換する必要がありますか? Python 開発者は、わずか数行のコードで PRN を簡単にロードして JPG に変換できます。
...
1.  PRNからJPGへの変換結果を取得します。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python PRN を JPG に変換するライブラリ" %}}
