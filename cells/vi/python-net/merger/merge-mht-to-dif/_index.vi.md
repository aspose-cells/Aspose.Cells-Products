...
Ví dụ sau minh họa cách hợp nhất MHT thành DIF trong Aspose.Cells for Python via .NET.
...
Cần hợp nhất MHT thành DIF theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API có thể được thực hiện chỉ với vài dòng mã.
