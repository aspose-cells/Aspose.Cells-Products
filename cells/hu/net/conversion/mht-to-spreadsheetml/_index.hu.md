---
title: C# MHT-ból SPREADSHEETML-be - MHT-ból SPREADSHEETML-be konvertáló
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az MHT SPREADSHEETML formátumba konvertálásához, lehetővé téve az MHT adatok zökkenőmentes mentését SPREADSHEETML formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="MHT mentése SPREADSHEETML-be a C#-es számmal" %}}

A következő példa bemutatja, hogyan lehet az MHT-t SPREADSHEETML-lé konvertálni a C#-es fájlban.
...
{{% cells-convert title="Mintakód az MHT SPREADSHEETML-lé konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Az MHT konvertálása SPREADSHEETML-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia az MHT fájlokat SPREADSHEETML formátumba? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják az MHT-t SPREADSHEETML-be.
...
1.  Konvertálja az MHT-t SPREADSHEETML-lé a Workbook.Save metódus meghívásával.
1. Szerezze meg az MHT SPREADSHEETML-re való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT SPREADSHEETML-lé konvertálásához" %}}
