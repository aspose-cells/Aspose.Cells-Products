---
title: Insérer un tableau croisé dynamique dans les fichiers Micorsoft Excel XLSM via C#
weight: 7690
description: C# Exemple de code pour générer des documents XLSM avec tableau croisé dynamique. Utilisez ce code pour créer des fichiers Micorsoft Excel XLSM avec tableau croisé dynamique dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérer un tableau croisé dynamique dans les documents XLSM via C#" h2="Feuille de calcul Microsoft Excel XLSM native et hautes performances avec création de tableaux croisés dynamiques par programme à l\'aide d\'API côté serveur .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 La génération dynamique du fichier MS Excel XLSM avec tableau croisé dynamique dans l'application en cours d'exécution est facile. Afin de créer des documents XLSM avec un tableau croisé dynamique à partir de zéro sans nécessiter MS Office, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Il est facile pour les développeurs d'insérer un tableau croisé dynamique dans une feuille de calcul au format XLSM dans l'exécution de différentes applications de création de rapports pour le traitement des données en quelques lignes de code seulement.
