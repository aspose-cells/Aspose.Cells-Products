---
title: FODS mit XLAM zusammenführen - FODS mit XLAM in Java kombinieren
url: /de/java/merger/merge-fods-to-xlam/ 
description: Aspose Excel. Java Aspose.Cells. Kostenlose Online-Zusammenführung von FODS zu XLAM im Speicherformat. Java Kombinieren Sie das Format FODS mit dem Format XLAM. FODS zu XLAM in Java zusammenführen. FODS Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie FODS mit XLAM in Java kostenlos online zusammen" %}}

Das folgende Beispiel zeigt, wie FODS mit XLAM in Aspose.Cells for Java zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um FODS mit XLAM zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei XLAM. Wenn Sie Code in Java entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel Java, das FODS mit XLAM zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlos online, um FODS mit XLAM in Java zusammenzuführen" InputFormat="fods" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie FODS mit XLAM via Java zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie FODS programmgesteuert mit XLAM zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Java](https://products.aspose.com/cells/java) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Zusammenführen von FODS mit XLAM" %}}
