---
title: Python PRN から MHT - PRN から MHT コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、PRNをMHTにすばやく簡単に変換します。 Python PRNをMHTに変換します。 Python PRN を MHT に保存します。 Python を使用して PRN を MHT として保存します。
...
{{< blocks/products/pf/i18n/upper-banner h1="PythonでPRNをMHTに変換します" h2="PRN を MHT に変換するための高速 Python ライブラリ。これは、Python を使用して PRN、MHT、およびその他の多くの形式をインポートおよびエクスポートするためのプロフェッショナル ソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Pythonを使用してPRNをMHTに変換します" %}}
...
{{% blocks/products/pf/agp/content h2="PRN を Python の MHT に保存" %}}

次の例は、Python で PRN を MHT に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って PRN を MHT に変換します。 PRN ファイルをアップロードし、MHT ファイルとして保存します。 PRN の読み取りと MHT の書き込みの両方で、完全修飾ファイル名を使用できます。出力される MHT コンテンツと形式は、元の PRN ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="PRN を MHT に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でPRNをMHTに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

PRN ファイルをプログラムで MHT に変換する必要がありますか? Python 開発者は、わずか数行のコードで PRN を簡単にロードして MHT に変換できます。
...
1.  PRNからMHTへの変換結果を取得します。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python PRN を MHT に変換するライブラリ" %}}
