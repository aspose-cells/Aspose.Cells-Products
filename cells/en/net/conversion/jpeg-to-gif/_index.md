...
description: Convert JPEG to GIF format in C# code. Save JPEG as GIF using VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="Save JPEG to GIF in C# Online for Free" %}}

The following example demonstrates how to convert JPEG to GIF document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert JPEG file into GIF format. Upload your JPEG file, then simply save it as GIF file. For both JPEG reading and GIF writing you can use fully qualified filenames. The output GIF content and formatting will be identical to the original JPEG document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert JPEG to GIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="gif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert JPEG to GIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert JPEG files to GIF in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert JPEG to GIF" %}}
