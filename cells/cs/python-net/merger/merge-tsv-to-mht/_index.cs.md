---
title: Sloučit TSV na MHT - Sloučit TSV na MHT v Python
url: /cs/python-net/merger/merge-tsv-to-mht/ 
description: Aspose Excel. Python Aspose.Cells. Zdarma online sloučení TSV do formátu uložení MHT. Python Zkombinujte TSV do formátu MHT. Sloučit TSV na MHT v Python. TSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TSV do MHT pomocí Python" %}}

 Jak sloučím TSV do MHT? S knihovnou Aspose.Cells for Python via .NET můžete snadno sloučit TSV do MHT programově pomocí několika řádků kódu.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)je schopen vytvářet multiplatformní aplikace se schopností generovat, upravovat, konvertovat, vykreslovat a tisknout všechny soubory aplikace Excel. Python Excel API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat soubory Excel jako obrázky, PDF, HTML, ODS, CSV, CSV, SVG, vyměňovat dokumenty, perfektní výběr WORD a další, 076PT a další 08 v průmyslovém standardu formátů. Můžete nainstalovat Aspose.Cells for Python via .NET z<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , použijte příkaz jako:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Sloučit TSV na MHT v Python online zdarma" %}}

Následující příklad ukazuje, jak sloučit TSV do MHT v Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TSV s MHT. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MHT. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí TSV do MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení TSV na MHT v Python" InputFormat="tsv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit TSV do MHT přes Python" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit TSV na MHT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Python knihovna ke sloučení TSV do MHT" %}}
