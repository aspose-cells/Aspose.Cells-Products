---
title:  CSV belgesini açmadan C++ üzerinden arayın
weight: 5540
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı üzerindeki CSV dosyasındaki kalıplı kelimeleri aramak için C++ örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="CSV Biçimlerini C++\'de arayın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Cells for C++ API\'leri kullanarak yerel ve yüksek performanslı CSV belge arama." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++\'de CSV Dosyalarını Arama Adımları" %}}
...
+ CSV dosyasını IWorkbook->Save(.) yöntemini kullanarak kaydedin.
...
{{% blocks/products/pf/agp/code-block title="Ara CSV Dosyalar - C++" offSpacer="" %}}
