...
description: Aspose เอ็กเซล. แปลง XML เป็น IMAGE อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XML เป็น IMAGE C++ บันทึก XML ลงใน IMAGE บันทึก XML เป็น IMAGE โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="แปลง XML เป็น IMAGE โดยใช้ C++" %}}
...
{{% blocks/products/pf/agp/content h2="บันทึก XML ลงใน IMAGE ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XML เป็น IMAGE ใน C++
...
ต้องการแปลงไฟล์ XML เป็น IMAGE โดยทางโปรแกรมหรือไม่ นักพัฒนา C++ สามารถแปลง XML เป็น IMAGE ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง XML เป็น IMAGE โดยการเรียกเมธอด Save()
1. รับผลลัพธ์การแปลง XML เป็น IMAGE

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ไลบรารี C++ เพื่อแปลง XML เป็น IMAGE" %}}
