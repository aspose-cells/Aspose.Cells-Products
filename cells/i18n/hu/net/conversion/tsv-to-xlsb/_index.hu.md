---
title: "TSV konvertálása XLSB-re a következőn keresztül: C#"
url: /hu/net/conversion/tsv-to-xlsb/
description: Mintakód a tsv–xlsb C# konverzióhoz. Használjon API példakódot a tsv fájlok kötegelt xlsb formátumba konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a TSV-fájlokat XLSB-re.
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód a TSV XLSB-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlsb" IsLandingPage="true" %}}
