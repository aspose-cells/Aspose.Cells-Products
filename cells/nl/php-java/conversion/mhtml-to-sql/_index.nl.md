...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar SQL met Aspose.Cells. PHP MHTML naar SQL. PHP Sla MHTML op in SQL. Sla MHTML op als SQL met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar SQL te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar SQL converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar SQL.
...
1.  Converteer MHTML naar SQL door de opslagmethode van Workbook aan te roepen.
