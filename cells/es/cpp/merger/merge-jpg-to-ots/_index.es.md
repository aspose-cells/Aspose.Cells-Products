---
title: Fusionar JPG con OTS - Combinar JPG con OTS en C++
url: /es/cpp/merger/merge-jpg-to-ots/ 
description: AsposeExcel. C++ Aspose.Cells. Combinación gratuita en línea de JPG a formato OTS. C++ Combinar formato JPG a OTS. Combinar JPG con OTS en C++. Combinar JPG.
...
{{% blocks/products/pf/agp/content h2="Combine JPG a OTS en C++ en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar JPG con OTS en Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar JPG con OTS. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo OTS. Si desarrolla código en C++, esto será más simple de lo que parece. Consulte el ejemplo C++ que combina JPG con OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar JPG a OTS en C++" InputFormat="jpg" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar JPG a OTS a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar JPG con OTS programáticamente? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para fusionar JPG a OTS" %}}
