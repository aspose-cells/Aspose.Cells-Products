...
description: Aspose Эксель. Python Aspose.Cells. Объедините HTML и JPEG в формате сохранения. Python Объедините форматы HTML и JPEG. Объедините HTML и JPEG в Python. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML с JPEG, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и JPEG в Python." %}}

В следующем примере показано, как объединить HTML и JPEG в Aspose.Cells for Python via Java.
