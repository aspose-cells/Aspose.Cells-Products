---
title: Sloučit TXT až PNG - Sloučit TXT až PNG v Java
url: /cs/java/merger/merge-txt-to-png/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma TXT do formátu uložení PNG. Java Kombinujte formát TXT až PNG. Sloučit TXT až PNG v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT až PNG v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit TXT až PNG v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TXT do PNG. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PNG. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí TXT do PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení TXT až PNG v Java" InputFormat="txt" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit TXT do PNG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit TXT až PNG? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení TXT až PNG" %}}
