...
description: Aspose Excel. Převeďte ODS na XPS rychle a snadno pomocí Aspose.Cells. C++ ODS na XPS. C++ Ušetřete ODS na 197 3481761 jako 197 348161 C++ 481 pomocí C++.
...
{{% blocks/products/pf/agp/content h2="Uložit ODS až XPS v C++" %}}
...
{{% cells-convert title="Ukázkový kód pro převod ODS na XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xps" IsLandingPage="true" language="cpp" %}}
