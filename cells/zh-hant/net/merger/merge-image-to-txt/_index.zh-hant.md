---
title: 將圖像合併到 TXT - 將圖像合併到 TXT 中的 C#
url: /zh-hant/net/merger/merge-image-to-txt/ 
description: Aspose Excel。 C# Aspose.Cells。免費在線合併圖像到TXT保存格式。 C# 將 IMAGE 合併為 TXT 格式。將IMAGE合併到C#中的TXT。IMAGE合併。
...
{{% blocks/products/pf/agp/content h2="免費在線將 C# 中的 IMAGE 合併到 TXT" %}}

以下示例演示如何將 IMAGE 合併到 Aspose.Cells for .NET 中的 TXT。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 IMAGE 合併到 TXT。上傳文件，調用 Workbook.Combine 方法合併文件，然後將其保存到 TXT 文件。如果您在 C# 中開發代碼，這會比聽起來更簡單。請參閱 C# 將 IMAGE 合併到 TXT 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將圖像合併到C#中的TXT" InputFormat="png" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 IMAGE 合併到 TXT" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 IMAGE 合併到 TXT 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
