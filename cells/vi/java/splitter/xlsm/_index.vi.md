---
title:  Tách XLSM Tệp via Java
weight: 5670
description: Mã mẫu Java để phân chia tài liệu XLSM trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tách XLSM Tệp via Java" h2="Chia tách XLSM với sự trợ giúp của thư viện Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tách tệp XLSM bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tách file XLSM trong Java" %}}
...
+ Load file XLSM sử dụng lớp Workbook.
+ Lặp qua từng sheet
+ Tạo mới đối tượng lớp Workbook
Copy sheet đã chọn sang đối tượng mới
+ Gọi phương thức save với đường dẫn file mới XLSM.
...
{{% blocks/products/pf/agp/code-block title="Tách XLSM File - Java" offSpacer="" %}}
