---
title: Συγχώνευση SPREADSHEETML στο XLSM - Συνδυάστε το SPREADSHEETML στο XLSM στο Java
url: /el/java/merger/merge-spreadsheetml-to-xlsm/ 
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση SPREADSHEETML σε μορφή αποθήκευσης XLSM. Java Συνδυάστε το SPREADSHEETML σε μορφή XLSM. Συγχώνευση SPREADSHEETML στο XLSM στο Java. SPREADSHEETML Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση SPREADSHEETML στο XLSM στο Java" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SPREADSHEETML στο XLSM στο Aspose.Cells for Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Θέλετε να συγχωνεύσετε το SPREADSHEETML στο XLSM μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for Java](https://products.aspose.com/cells/java) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
