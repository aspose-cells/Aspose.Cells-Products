---
title: Convierte CSV a HTML a través de Java 
weight: 6910
url: /es/java/conversion/csv-to-html/ 
description: Ejemplo de código de conversión Java de formato CSV a archivo HTML. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a HTML dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte CSV a HTML a través de Java" h2="Conversión de CSV a HTML Java para convertir una o varias páginas a HTML utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir CSV a HTML usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir CSV a HTML a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo CSV a HTML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo CSV con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con extensión HTML y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo HTML resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de CSV a HTML Java" offSpacer="" %}}

```cs
// cargar el archivo CSV en una instancia de Workbook
Workbook book = new Workbook("template.csv");
// guardar CSV como HTML
