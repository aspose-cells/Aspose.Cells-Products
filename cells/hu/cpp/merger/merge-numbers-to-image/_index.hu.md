---
title: "A NUMBERS egyesítése a következővel: IMAGE – NUMBERS egyesítése a következővel: IMAGE a C++-ben"
url: /hu/cpp/merger/merge-numbers-to-image/ 
description: "Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítése NUMBERS IMAGE mentési formátumba. C++ SZÁMOK kombinálása IMAGE formátumba. A NUMBERS egyesítése a következővel: IMAGE itt: C++. NUMBERS Egyesítés."
...
{{% blocks/products/pf/agp/content h2="Egyesítse a NUMBERS-t az IMAGE-val a C++-es online ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a NUMBERS-t az IMAGE-val a Aspose.Cells for C++ számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a NUMBERS és az IMAGE egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el az IMAGE fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++-es példát, amely a NUMBERS-t az IMAGE-ba egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online NUMBERS egyesítéséhez IMAGE a C++ számon" InputFormat="numbers" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A NUMBERS egyesítése az IMAGE-be a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Automatikusan egyesítenie kell NUMBERS számot a következővel: IMAGE? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a NUMBERS és az IMAGE egyesítéséhez" %}}
