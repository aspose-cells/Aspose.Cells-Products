...
The following example demonstrates how to convert SPREADSHEETML to MHTML document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert SPREADSHEETML file into MHTML format. Upload your SPREADSHEETML file, then simply save it as MHTML file. For both SPREADSHEETML reading and MHTML writing you can use fully qualified filenames. The output MHTML content and formatting will be identical to the original SPREADSHEETML document.
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert SPREADSHEETML files to MHTML in just a few lines of code.
