...
url: /cs/cpp/merger/merge-csv-to-ots/ 
...
Následující příklad ukazuje, jak sloučit CSV do OTS v Aspose.Cells for C++.
...
Potřebujete sloučit CSV do OTS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení CSV do OTS" %}}
