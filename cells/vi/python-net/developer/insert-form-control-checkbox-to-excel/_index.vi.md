---
title:  Chèn CheckBox (Điều khiển biểu mẫu) vào Excel bằng Python via .Net
weight: 30
description: Python via Mã nguồn .Net để chèn CheckBox(Form control) vào Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn CheckBox (Điều khiển biểu mẫu) vào Excel bằng Python via .Net" h2="Chèn các đối tượng bằng API phía máy chủ mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn CheckBox(Form control) Vào File Excel Bằng Python via .Net" %}}

 Để chèn CheckBox(Form control) vào file excel, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn CheckBox(Form control) vào file Excel bằng Python via .Net" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng add của shapecollection[phương pháp](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_check_box/#int-int-int-int-int-int) để chèn Hộp kiểm (Điều khiển biểu mẫu) vào trang tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn CheckBox(Form điều khiển) - Python via .Net" offSpacer="" %}}
