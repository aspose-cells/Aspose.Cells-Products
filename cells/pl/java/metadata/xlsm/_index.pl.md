---
title: Edytuj lub wyświetl metadane plików XLSM za pomocą Java 
weight: 9030
url: /pl/java/metadata/xlsm/ 
description: Java przykładowy kod do edycji lub przeglądania metadanych formatu XLSM w Java środowisku wykonawczym dla aplikacji JSP/JSF i aplikacji komputerowych.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane XLSM przez Java" h2="Twórz własne Java aplikacje, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików XLSM przy użyciu interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki wyodrębniania metadanych XLSM za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Uzyskaj dostęp do przydatnych informacji przechowywanych w pliku XLSM, w tym kiedy plik XLSM został odebrany, przetworzony, oznaczony datą i tak dalej.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API może służyć do tworzenia, edytowania, konwertowania i renderowania formatów programu Microsoft Excel do różnych formatów. Co więcej, może być używany do kompleksowych wykresów, skalowalnych raportów i niezawodnych obliczeń w aplikacjach. Aspose.Cells jest samodzielnym API i nie wymaga żadnego oprogramowania takiego jak Microsoft czy OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Wyodrębnij metadane XLSM za pośrednictwem aplikacji online" sectionDescription="Przeglądaj i edytuj Metadane do dokumentów XLSM za pomocą naszego [Prezentacje na żywo](https://products.aspose.app/cells/metadata) z następującymi korzyściami." >}}
