---
title: Convierta SPREADSHEETML a PDF a través de Python

description: Código de muestra para la conversión de hoja de cálculo ml a pdf Python. Utilice el código de ejemplo API para la conversión de archivos de hojas de cálculo por lotes a PDF dentro de la aplicación Python.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SPREADSHEETML a PDF usando Python" %}}

 Para convertir SPREADSHEETML a PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SPREADSHEETML a PDF a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python los desarrolladores pueden cargar y convertir fácilmente archivos SPREADSHEETML a PDF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo SPREADSHEETML con una instancia de Workbook1. Llame al método Workbook.Save1. Pase la ruta de salida con la extensión PDF como parámetro1. Compruebe la ruta especificada para el archivo PDF resultante
