---
title: Voeg ODS samen met DIF - Combineer ODS met DIF in Python
url: /nl/python-net/merger/merge-ods-to-dif/ 
description: Aspose Excel. Python Excel. Voeg ODS samen met het opslagformaat DIF. Python Combineer het formaat ODS met DIF. Voeg ODS samen met DIF in de Excel-bibliotheek Python. ODS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg ODS samen met DIF met behulp van de Excel-bibliotheek Python" %}}

 Hoe voeg ik ODS samen met DIF? Met de bibliotheek Aspose.Cells for Python via .NET kunt u eenvoudig ODS tot DIF programmatisch samenvoegen met een paar regels code.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardformaten. U kunt Aspose.Cells for Python via .NET installeren vanaf<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , gebruik de opdracht als:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Voeg ODS samen met DIF in de Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u ODS samenvoegt met DIF in Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om ODS samen te voegen met DIF. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand DIF. Als u code ontwikkelt in Python, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld Python waarin ODS wordt samengevoegd met DIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om ODS samen te voegen met DIF in de Excel-bibliotheek Python" InputFormat="ods" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe u ODS samenvoegt met DIF via de Excel-bibliotheek Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u ODS programmatisch samenvoegen met DIF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om ODS samen te voegen met DIF" %}}
