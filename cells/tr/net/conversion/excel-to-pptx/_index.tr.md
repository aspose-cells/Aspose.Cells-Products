...
EXCEL dosyalarını programlı olarak PPTX'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip PPTX'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını PPTX formatına dönüştürün.
