---
title: تحويل SPREADSHEETML إلى XLT عبر Java 
url: /ar/java/conversion/spreadsheetml-to-xlt/ 
description: نموذج رمز تحويل Java لتنسيق SPREADSHEETML إلى ملف XLT. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى XLT داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل SPREADSHEETML إلى XLT عبر Java" h2="تحويل SPREADSHEETML إلى XLT Java لتحويل صفحات مفردة أو صفحات متعددة إلى XLT باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل SPREADSHEETML إلى XLT باستخدام Java" %}}

 من أجل تقديم SPREADSHEETML إلى XLT ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل SPREADSHEETML إلى XLT عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف SPREADSHEETML إلى XLT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف SPREADSHEETML بنسخة من فئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XLT & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XLT الناتج
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML إلى شفرة مصدر تحويل XLT Java" offSpacer="" %}}

```cs
// تحميل ملف SPREADSHEETML في مثيل مصنف
Workbook book = new Workbook("template.spreadsheetml");
// احفظ SPREADSHEETML كـ XLT
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML إلى عروض توضيحية مباشرة لتحويل XLT" sectionDescription="[تحويل SPREADSHEETML إلى XLT](https://products.aspose.app/cells/conversion/spreadsheetml-to-xlt) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف SPREADSHEETML الخاص بك ، وسيتم تحويله على الفور إلى XLT." >}}
