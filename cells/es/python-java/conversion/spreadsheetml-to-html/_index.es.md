---
title: Convierta SPREADSHEETML a HTML a través de Python

description: Código de muestra para la conversión de hoja de cálculo a html Python. Utilice el código de ejemplo API para la conversión de archivos de hoja de cálculo ml por lotes en html dentro de la aplicación Python.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SPREADSHEETML a HTML usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SPREADSHEETML a HTML a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden cargar y convertir fácilmente archivos SPREADSHEETML a HTML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo SPREADSHEETML con una instancia de Workbook1. Llame al método Workbook.Save1. Pase la ruta de salida con la extensión HTML como parámetro1. Compruebe la ruta especificada para el archivo HTML resultante
...
{{% cells-convert title="Aplicación gratuita y código de muestra para convertir SPREADSHEETML a HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="html" IsLandingPage="true" language="python" %}}
