...
description: Aspose Excel. Converteer EXCEL snel en eenvoudig naar FODS met Aspose.Cells. Python EXCEL naar FODS. Python Bewaar EXCEL naar FODS. Sla EXCEL op als FODS met Python.
...
{{% blocks/products/pf/agp/content h2="Converteer Excel naar FODS in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar EXCEL op FODS in Python" %}}

Het volgende voorbeeld laat zien hoe u EXCEL converteert naar FODS in Python via NET.
