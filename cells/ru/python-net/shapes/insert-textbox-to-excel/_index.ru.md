...
{{% blocks/products/pf/agp/content h2="Как вставить текстовое поле в файл Excel с помощью Python via.Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке TextBox в файл Excel с использованием Python via .Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_text_box/#int-int-int-int-int-int) чтобы вставить текстовое поле на выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить текстовое поле — Python via .Net" offSpacer="" %}}
