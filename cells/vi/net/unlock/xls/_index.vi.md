---
title:  Mở khóa XLS tài liệu via .NET
weight: 4260
description: Mã nguồn C# để mở khóa tệp XLS được bảo vệ bằng mật khẩu trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
...
{{% blocks/products/pf/agp/content h2="Cách mở khóa tệp XLS bằng C#" %}}
 ...
 Để xóa tệp bảo vệ XLS, chúng tôi sẽ sử dụng
