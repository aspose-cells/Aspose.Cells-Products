...
weight: 8270
description: C#-broncode om watermerk toe te voegen of te verwijderen aan het XLSM-bestand op .NET Framework, .NET Core, Mono of Xamarin-platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om watermerk toe te voegen aan XLSM via C#" %}}
...
+ Bewaar werkmap in XLSM-formaat
...
{{% blocks/products/pf/agp/code-block title="Voeg watermerk toe aan XLSM - C#" offSpacer="" %}}
