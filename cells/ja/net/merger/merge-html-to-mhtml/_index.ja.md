...
url: /ja/net/merger/merge-html-to-mhtml/ 
...
{{% cells-merger title="オンラインでHTMLをMHTMLにマージする無料アプリ" InputFormat="html" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2=".NET HTML を MHTML にマージするライブラリ" %}}
