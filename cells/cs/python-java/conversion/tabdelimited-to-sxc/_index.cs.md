---
title: Převést TABDELIMITED na SXC přes Python

description: Ukázkový kód pro převod tabdelimited na sxc Python. Použijte API ukázkový kód pro dávkový převod souborů oddělených tabulátory na sxc v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na SXC pomocí Python" %}}

 K převodu TABDELIMITED na SXC použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na SXC přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory TABDELIMITED na SXC pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TABDELIMITED s instancí sešitu1. Zavolejte metodu Workbook.Save1. Jako parametr předejte výstupní cestu s rozšířením SXC1. Zkontrolujte zadanou cestu pro výsledný soubor SXC
