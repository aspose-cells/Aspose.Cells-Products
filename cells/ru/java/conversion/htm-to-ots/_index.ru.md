...
{{% blocks/products/pf/agp/content h2="Преобразование HTM в OTS с использованием кода Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM в OTS в Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в OTS в коде Java.
...
Нужно программно преобразовать HTML-файлы в формат OTS? Разработчики, использующие код Java, могут легко преобразовать HTML в OTS всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования HTM в OTS" %}}
{{% blocks/products/pf/agp/text %}}
