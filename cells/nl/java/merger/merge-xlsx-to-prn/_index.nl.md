...
description: Aspose Excel. Java Aspose.Cells. Gratis online samenvoegen XLSX naar PRN-opslagformaat. Java Combineer XLSX naar PRN-formaat. Samenvoegen XLSX naar PRN in Java. XLSX Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLSX samen met PRN in Java online" %}}

Het volgende voorbeeld laat zien hoe u XLSX kunt samenvoegen met PRN in Aspose.Cells for Java.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSX samen te voegen met PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
