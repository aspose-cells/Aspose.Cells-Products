...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLTM を XLSM にすばやく簡単に変換します。Python XLTM を XLSM に変換します。Python XLTM を XLSM に保存します。Python Excel ライブラリを使用して、XLTM を XLSM として保存します。
