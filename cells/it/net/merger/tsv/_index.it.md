...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per unire i file TSV in C#" %}}
...
+ Carica tutti i file TSV con percorso completo.
+ Crea un documento come file di base
+ Chiama il metodo pertinente per concatenare e unire i file uno per uno.
+ Chiama il metodo Save() e passa il nome del file (percorso completo) e il formato (TSV) come parametro.
+ Ora puoi aprire e utilizzare il file TSV in Microsoft Office, Adobe PDF o qualsiasi altro programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Unisci i file TSV - C#" offSpacer="" %}}
