---
title: Sloučit CSV do XML – Sloučit CSV do XML v C++
url: /cs/cpp/merger/merge-csv-to-xml/ 
description: Aspose Excel. C++ Aspose.Cells. Zdarma online sloučení CSV do formátu uložení XML. C++ Zkombinujte CSV do formátu XML. Sloučit CSV do XML v C++. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV do XML v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit CSV do XML v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení CSV do XML. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XML. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí CSV do XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení CSV do XML v C++" InputFormat="csv" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV do XML přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit CSV do XML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení CSV do XML" %}}
