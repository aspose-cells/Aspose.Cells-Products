...
url: /tr/cpp/merger/merge-xlsx-to-word/ 
...
Aşağıdaki örnek, XLSX'in Aspose.Cells for C++'de WORD ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLSX'i programlı olarak WORD ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLSX\'i WORD ile birleştirmek için C++ kitaplığı" %}}
