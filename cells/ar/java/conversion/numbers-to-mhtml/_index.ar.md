---
title: تحويل الأرقام إلى MHTML عبر Java 

description: نموذج Java رمز تحويل لتنسيق NUMBERS إلى ملف MHTML. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى MHTML داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الأرقام إلى MHTML عبر Java" h2="تحويل NUMBERS إلى MHTML Java لتحويل صفحة واحدة أو صفحات متعددة إلى MHTML باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الأرقام إلى MHTML باستخدام Java" %}}

 من أجل تقديم NUMBERS إلى MHTML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل الأرقام إلى MHTML عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج Java بسهولة تحويل NUMBERS ملف إلى MHTML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف NUMBERS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد MHTML & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف MHTML الناتج
...
{{% blocks/products/pf/agp/code-block title="NUMBERS إلى MHTML Java شفرة مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف NUMBERS في مثيل مصنف
Workbook book = new Workbook("template.numbers");
// احفظ الأرقام كـ MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="الأرقام التجريبية المباشرة لتحويل MHTML" sectionDescription="[تحويل الأرقام إلى MHTML](https://products.aspose.app/cells/conversion/numbers-to-mhtml) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف NUMBERS الخاص بك ، وسيتم تحويله على الفور إلى MHTML." >}}
