...
{{< blocks/products/pf/i18n/upper-banner h1="دمج تنسيقات XLSX في C#" h2="دمج مستندات XLSX الأصلية وعالية الأداء باستخدام واجهات برمجة تطبيقات Aspose.Cells for .NET من جانب الخادم ، بدون استخدام أي برامج مثل Microsoft أو Open Office أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
يمكنك الآن فتح ملف XLSX واستخدامه في Microsoft Office أو Adobe PDF أو أي برنامج آخر متوافق.
