---
title: Gabungkan FODS ke PRN - Gabungkan FODS ke PRN di Java
url: /id/java/merger/merge-fods-to-prn/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS ke format simpan PRN. Java Gabungkan FODS ke format PRN. Gabungkan FODS ke PRN di Java. FODS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS ke PRN di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan FODS ke PRN di Java" InputFormat="fods" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS menjadi PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke PRN secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
