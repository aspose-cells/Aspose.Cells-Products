---
title: PHP EXCEL en POWERPOINT - Convertisseur EXCEL en POWERPOINT
description: Aspose Exceller. Convertissez EXCEL en POWERPOINT rapidement et facilement avec Aspose.Cells. PHP EXCEL en POWERPOINT. PHP Enregistrez EXCEL dans POWERPOINT. Enregistrez EXCEL sous POWERPOINT en utilisant PHP.
...
{{% cells-convert title="Exemple de code pour convertir EXCEL en POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en POWERPOINT via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en POWERPOINT par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en POWERPOINT en quelques lignes de code seulement.
...
1.  Convertissez EXCEL en POWERPOINT en appelant la méthode de sauvegarde du classeur.
