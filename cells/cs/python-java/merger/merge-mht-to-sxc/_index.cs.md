...
description: Aspose Excel. Python Aspose.Cells. Sloučit MHT do formátu uložení SXC. Python Zkombinujte MHT do formátu SXC. Sloučit MHT na SXC v Python. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na SXC v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT s SXC v Python" InputFormat="mht" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
