---
title: Converti SPREADSHEETML in PNG tramite Python
url: /it/python-java/conversion/spreadsheetml-to-png/
description: Codice di esempio per la conversione da foglio di calcoloml a png Python. Usa il codice di esempio API per la conversione batch di file da foglio di calcolo ml in png all'interno dell'applicazione Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti SPREADSHEETML in PNG tramite Python" h2="Esporta fogli di lavoro Excel® in formato PNG utilizzando Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire SPREADSHEETML in PNG utilizzando Python" %}}

 Per convertire SPREADSHEETML in PNG, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire SPREADSHEETML in PNG tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python gli sviluppatori possono caricare e convertire facilmente file SPREADSHEETML in PNG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file SPREADSHEETML con un'istanza di Workbook1. Chiama il metodo Workbook.Save1. Passa il percorso di output con l'estensione PNG come parametro1. Controllare il percorso specificato per il file PNG risultante
