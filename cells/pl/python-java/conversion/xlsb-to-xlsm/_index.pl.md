---
title: Konwertuj XLSB na XLSM przez Python
url: /pl/python-java/conversion/xlsb-to-xlsm/
description: Przykładowy kod konwersji xlsb do xlsm Python. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji xlsm w aplikacji Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na XLSM za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSB na XLSM za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki XLSB na XLSM w zaledwie kilku wierszach kodu.
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSB na XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlsm" IsLandingPage="true" language="python" %}}
