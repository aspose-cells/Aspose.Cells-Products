...
description: Aspose एक्सेल। Aspose.Cells के साथ XLS को जल्दी और आसानी से एक्सेल में बदलें। C# XLS को एक्सेल में बदलें। C# XLS को एक्सेल में सेव करें। C# का उपयोग करके XLS को एक्सेल के रूप में सहेजें।
...
{{< blocks/products/pf/i18n/upper-banner h1="C# में XLS को एक्सेल में बदलें" h2="XLS को एक्सेल में परिवर्तित करने के लिए हाई-स्पीड C# लाइब्रेरी। यह .NET फ्रेमवर्क, .NET कोर या Mono प्लेटफॉर्म पर XLS, एक्सेल और कई अन्य प्रारूपों को आयात और निर्यात करने के लिए एक पेशेवर सॉफ्टवेयर समाधान है।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="XLS को एक्सेल में C# में सेव करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि XLS को C# में EXCEL में कैसे परिवर्तित किया जाए।
{{% blocks/products/pf/agp/text %}}

XLS को एक्सेल में बदलने के लिए आसान चरणों का पालन करें। अपनी XLS फ़ाइल अपलोड करें, फिर इसे EXCEL फ़ाइल के रूप में सहेजें। XLS पढ़ने और एक्सेल लेखन दोनों के लिए आप पूरी तरह से योग्य फ़ाइल नामों का उपयोग कर सकते हैं। आउटपुट EXCEL सामग्री और फ़ॉर्मेटिंग मूल XLS दस्तावेज़ के समान होगी।

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="XLS को एक्सेल में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="XLS को C# के माध्यम से एक्सेल में कैसे बदलें" %}}

{{% blocks/products/pf/agp/text %}}

XLS फ़ाइलों को प्रोग्रामेटिक रूप से EXCEL में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में XLS को आसानी से लोड और EXCEL में बदल सकते हैं।
...
1.  Workbook.Save विधि को कॉल करके XLS को EXCEL में कनवर्ट करें।
1.  XLS का एक्सेल में रूपांतरण परिणाम प्राप्त करें।

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLS को एक्सेल में बदलने के लिए C# लाइब्रेरी" %}}
