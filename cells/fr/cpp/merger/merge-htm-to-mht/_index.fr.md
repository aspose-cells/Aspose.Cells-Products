...
url: /fr/cpp/merger/merge-htm-to-mht/ 
...
L'exemple suivant montre comment fusionner HTM avec MHT dans Aspose.Cells for C++.
...
{{% cells-merger title="Exemple de code pour fusionner HTM avec MHT dans C++" InputFormat="htm" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec MHT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner HTM avec MHT par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour fusionner HTM avec MHT" %}}
