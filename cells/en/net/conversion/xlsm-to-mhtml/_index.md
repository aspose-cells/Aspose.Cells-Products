...
description: Sample code for xlsm to mhtml C# conversion. Use API example code for batch xlsm files to mhtml conversion within VB.NET, Asp.NET or any .NET based application.
---
