...
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman TXT-format i C#" h2="Inbyggd och högpresterande TXT-dokumentsammanslagning med Aspose.Cells for .NET API:er på serversidan, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Så här sammanfogar du TXT-fil med C#" %}}
 ...
 För att slå samman TXT-fil kommer vi att använda
...
+ Ladda alla TXT-filer med fullständig sökväg.
+ Gör ett dokument som basfil
+ Anropa den relevanta metoden för att sammanfoga och sammanfoga filer en efter en.
+ Anropa metoden Save() och skicka filnamnet (fullständig sökväg) och formatet (TXT) som en parameter.
Nu kan du öppna och använda TXT-filen i Microsoft Office, Adobe PDF eller något annat kompatibelt program.
