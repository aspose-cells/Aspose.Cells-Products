...
weight: 440
description: Kode contoh Java untuk mengekstrak teks dan gambar dari file XLSB di Lingkungan Runtime Java untuk Aplikasi JSP/JSF dan Aplikasi Desktop.
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Parsing File XLSB di Java" %}}
...
Muat dokumen XLSB menggunakan kelas Buku Kerja.
...
{{% blocks/products/pf/agp/code-block title="Parsing XLSB File - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/parser/xlsx/" name="XLSX" description="Berkas OOXML Excel" >}}
