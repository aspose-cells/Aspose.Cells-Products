...
description: Aspose Excel. Python Aspose.Cells. Merge SXC to ETT saveformat. Python Combine SXC to ETT format. Merge SXC to ETT in Python. SXC Merge.
...
{{% blocks/products/pf/agp/content h2="Merge SXC to ETT in Python" %}}
...
{{% cells-merger title="Sample Code to Merge SXC to ETT in Python" InputFormat="sxc" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
