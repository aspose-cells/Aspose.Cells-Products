---
title: Sloučit TXT do XML – Sloučit TXT do XML v Java
url: /cs/java/merger/merge-txt-to-xml/ 
description: Aspose Excel. Java Aspose.Cells. Zdarma online sloučení TXT do formátu uložení XML. Java Zkombinujte TXT do formátu XML. Sloučit TXT do XML v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT do XML v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit TXT do XML v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TXT do XML. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XML. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí TXT do XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení TXT do XML v Java" InputFormat="txt" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit TXT do XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit TXT do XML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení TXT do XML" %}}
