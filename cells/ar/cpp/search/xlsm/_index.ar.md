---
title:  ابحث عن المستند رقم XLSM دون فتحه عبر الرقم C++
weight: 9280
description: C++ مثال على التعليمات البرمجية للبحث عن الكلمات باستخدام نمط في الملف XLSM على بيئة التشغيل C++ لـ Windows 32 بت، وWindows 64 بت، ونظام التشغيل لينكس 64 بت.
...
{{< blocks/products/pf/i18n/upper-banner h1="ابحث عن تنسيقات XLSM في C++" h2="بحث أصلي وعالي الأداء عن المستندات XLSM باستخدام واجهات برمجة التطبيقات من جانب الخادم Aspose.Cells for C++، دون استخدام أي برامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية البحث عن الملف رقم XLSM باستخدام الرقم C++" %}}

 للبحث عن الملف رقم XLSM، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث عن الملفات رقم XLSM في الملف رقم C++" %}}
...
+ تحميل الملف XLSM باستخدام فئة Workbook.
+ الحصول على الخلايا في الورقة ذات الصلة.
...
{{% blocks/products/pf/agp/code-block title="ابحث عن الملفات XLSM - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="اتصل على XLSM ابحث عن عروض توضيحية مباشرة" sectionDescription=" ابحث عن النصوص والكلمات والعبارات داخل المستندات التي تحمل الرقم XLSM الآن من خلال زيارة موقعنا الإلكتروني.[موقع العروض الحية](https://products.aspose.app/cells/search). يتمتع العرض التجريبي المباشر بالمزايا التالية" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="ما عليك سوى تحميل ملفاتك التي تحمل الرقم XLSM." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="مستندات بحث أخرى مدعومة" subTitle="باستخدام الرقم C++، يمكن أيضًا البحث عن ملفات أخرى بما في ذلك." >}}
