---
title: Sloučit SXC až XLS - Sloučit SXC až XLS v C++
url: /cs/cpp/merger/merge-sxc-to-xls/ 
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma SXC do formátu uložení XLS. C++ Kombinujte formát SXC až XLS. Sloučit SXC až XLS v C++. SXC Sloučit.
...
Následující příklad ukazuje, jak sloučit SXC až XLS v Aspose.Cells for C++.
...
{{% cells-merger title="Online zdarma ke sloučení SXC až XLS v C++" InputFormat="sxc" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit SXC na XLS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit SXC až XLS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
