...
url: /cs/python-java/merger/merge-mht-to-txt/ 
...
Následující příklad ukazuje, jak sloučit MHT s TXT v Aspose.Cells for Python via Java.
...
Potřebujete sloučit MHT na TXT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
