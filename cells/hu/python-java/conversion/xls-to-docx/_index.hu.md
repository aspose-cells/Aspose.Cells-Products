...
{{< blocks/products/pf/i18n/upper-banner h1="XLS konvertálása DOCX-re a következőn keresztül: Python" h2="Exportáljon Excel® táblázatokat DOCX formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLS konvertálása DOCX-re a következővel: Python" %}}

 Az XLS DOCX-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS-ből DOCX-vé konvertálás lépései a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen betölthetnek és konvertálhatnak XLS fájlokat DOCX formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Adja meg a kimeneti útvonalat DOCX kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott DOCX fájl megadott elérési útját
