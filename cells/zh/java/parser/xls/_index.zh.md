...
weight: 3700
description: Java 用于从 Java JSP/JSF 应用程序和桌面应用程序运行时环境中的 XLS 文件中提取文本和图像的示例代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="解析 XLS 中的格式 Java" h2="本机和高性能 XLS 使用服务器端 Aspose.Cells for Java API 进行文档解析，无需使用任何软件，如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="在线 XLS 解析器现场演示" sectionDescription="访问我们的网站，立即从 XLS 文档中提取文本和图像[现场演示网站](https://products.aspose.app/cells/parser).现场演示有以下好处" >}}
