...
{{< blocks/products/pf/i18n/upper-banner h1="Sloučit formáty XLS v Java" h2="Slučování nativních dokumentů XLS pomocí rozhraní API Java na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak sloučit soubory XLS pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro sloučení souborů XLS v Java" %}}
...
+ Načtěte první soubor XLS s instancí třídy Workbook.
+ Načtěte druhý dokument XLS s instancí třídy Workbook.
+ Sloučit soubory pomocí metody Combined().
uložit sloučený soubor XLS do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Sloučit soubory XLS – Java" offSpacer="" %}}

```cs
// Otevřete první soubor XLS.
Workbook xlsFile1 = new Workbook("chartsFileWithPath.xls");

// Definujte druhou zdrojovou knihu.
// Otevřete druhý soubor XLS.
