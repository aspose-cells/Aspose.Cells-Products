---
title: قم بإنشاء ملفات MS Excel XLSB عبر Python
description: XLSB مبتكر. إنشاء XLSB ملفات في Python كود. قم بإنشاء ملفات MS Excel XLSB باستخدام تطبيق Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء XLSB ملف عن طريق Python" h2="إنشاء جداول بيانات MS Excel XLSB أصلي وعالي الأداء برمجيًا باستخدام واجهات برمجة تطبيقات Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء XLSB عبر Python" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح كود المصدر التالي كيفية إنشاء ملف MS Excel XLSB باستخدام Python." offSpacer="" %}}
