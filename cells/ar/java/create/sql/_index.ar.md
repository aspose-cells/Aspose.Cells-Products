---
title: تكوين SQL - إنشاء ملف SQL في Java
description: Aspose إكسل. Java تكوين ملف SQL. قم بإنشاء Java SQL. Java منشئ SQL. إنشاء SQL في Java. إنشاء ملف SQL باستخدام Java.
...
1.  احفظ المصنف بتنسيق SQL باستخدام طريقة الحفظ ().
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتكوين ملف SQL" %}}
{{% blocks/products/pf/agp/text %}}
