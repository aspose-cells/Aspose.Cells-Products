...
{{< blocks/products/pf/i18n/upper-banner h1="Rechercher les formats ODS dans Java" h2="Recherche de documents ODS native et hautes performances à l\'aide d\'API Aspose.Cells for Java côté serveur, sans l\'utilisation de logiciels tels que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/code-block title="Rechercher des fichiers ODS - Java" offSpacer="" %}}

```cs
// Instanciation d'un objet Workbook
Workbook workbook = new Workbook(dataDir + "book1.ods");

// Accéder à la première feuille de calcul du fichier ODS
