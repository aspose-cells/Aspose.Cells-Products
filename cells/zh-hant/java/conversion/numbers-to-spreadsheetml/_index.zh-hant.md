---
title: 將數字轉換為電子表格 Java
description: 免費在線將數字轉換為電子表格。免費在線數字到 SPREADSHEETML 轉換器。 Java 電子表格的數字。電子表格 via Java 的數字。
keywords: Convert NUMBERS, NUMBERS Converter, NUMBERS to PDF, NUMBERS to Word, NUMBERS to PPT, NUMBERS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="將數字轉換為電子表格 via Java" h2="NUMBERS 到 SPREADSHEETML Java 轉換，使用本地 Java 庫將單個或多個頁面轉換為 SPREADSHEETML。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Java 將數字轉換為電子表格" %}}

如何將 NUMBERS 轉換為 SPREADSHEETML？使用 Aspose.Cells for Java 庫，您可以使用幾行代碼以編程方式輕鬆地將 NUMBERS 轉換為 SPREADSHEETML。[Aspose.Cells for Java](https://products.aspose.com/cells/java)能夠構建跨平台應用程序，能夠生成、修改、轉換、呈現和打印所有 Excel 文件。 Java Excel API 不僅可以在電子表格格式之間相互轉換，還可以將Excel文件渲染為圖片，PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等，是行業文檔交換的完美選擇-標準格式。您可以直接從以下位置下載其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)並通過將以下配置添加到 pom.xml 將其安裝在基於 Maven 的項目中。
...
{{% blocks/products/pf/agp/content h2="在 Java 中免費在線將數字保存到 SPREADSHEETML" %}}

以下示例演示如何將 Java 中的 NUMBERS 轉換為 SPREADSHEETML。
...
{{% cells-convert title="將數字在線轉換為 SPREADSHEETML 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="xml" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將數字轉換為電子表格 via Java" %}}

{{% blocks/products/pf/agp/text %}}

Java 開發人員只需幾行代碼即可輕鬆將 NUMBERS 轉換為 SPREADSHEETML。
...
{{% blocks/products/pf/agp/content h2="Java 將 NUMBERS 轉換為 SPREADSHEETML 的庫" %}}
{{% blocks/products/pf/agp/text %}}
