---
title:  Buscar documento TSV sin abrir mediante C++
weight: 930
description: C++ código de ejemplo para buscar palabras con patrón en el archivo TSV en el entorno de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
...
{{% blocks/products/pf/agp/content h2="Cómo buscar el archivo TSV usando C++" %}}
 ...
 Para buscar el archivo TSV, utilizaremos
...
{{< blocks/products/pf/agp/about-file-section >}}
 ...
 El formato de archivo de valores separados por tabulaciones (TSV) representa datos separados por tabulaciones en texto plano. Este formato, similar al CSV, se utiliza para organizar datos de forma estructurada para su importación y exportación entre diferentes aplicaciones. Se utiliza principalmente para la importación, exportación e intercambio de datos en hojas de cálculo y bases de datos. Cada registro de un archivo TSV se encuentra en una sola línea de texto, donde cada valor de campo está separado por una tabulación. El tipo de archivo para el formato TSV es texto/valores separados por tabulaciones.
