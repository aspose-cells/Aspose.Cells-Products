...
description: C# Código de exemplo para criação de gráficos de bolhas para Excel usando a Biblioteca .NET. Use este código para criar um gráfico {chart} para MS Excel em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
...
1.  Usar[**Chart.SetChartDataRange**](https://https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/setchartdatarange)método para especificar a fonte de dados do gráfico.
