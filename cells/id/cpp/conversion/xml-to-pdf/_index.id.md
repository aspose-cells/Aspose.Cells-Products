...
Perlu mengonversi file XML ke PDF secara terprogram? Pengembang C++ dapat dengan mudah mengubah XML menjadi PDF hanya dalam beberapa baris kode.
...
1.  Konversikan XML ke PDF dengan memanggil metode Save().
