...
weight: 50
description: C++ exemple de code pour insérer Rectangle dans le fichier Excel sur C++ Runtime Environment pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer un fichier Rectangle dans Excel via C++" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ada0b818330196c0f026e4588801feadd) pour insérer des formes d'équation dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer Rectangle - C++" offSpacer="" %}}
