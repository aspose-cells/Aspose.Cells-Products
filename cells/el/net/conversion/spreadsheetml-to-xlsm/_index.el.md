---
title: Μετατροπή SPREADSHEETML σε XLSM C#
description: Μετατρέψτε το SPREADSHEETML σε XLSM Online δωρεάν. Δωρεάν Online Μετατροπέας SPREADSHEETML σε XLSM. C# SPREADSHEETML στο XLSM. SPREADSHEETML στο XLSM μέσω C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή SPREADSHEETML σε XLSM μέσω C#" h2="Βιβλιοθήκη υψηλής ταχύτητας C# για μετατροπή SPREADSHEETML σε XLSM. Εξαγωγή υπολογιστικών φύλλων Excel σε μορφή XLSM σε πλατφόρμες .NET, .NET Core ή Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση SPREADSHEETML στο XLSM στο C# Δωρεάν Online" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε SPREADSHEETML σε XLSM στο C#.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν το SPREADSHEETML σε XLSM σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1.  Φορτώστε το αρχείο SPREADSHEETML με μια παρουσία του βιβλίου εργασίας
1.  Μετατρέψτε SPREADSHEETML σε XLSM καλώντας τη μέθοδο Workbook.Save

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# βιβλιοθήκη για μετατροπή SPREADSHEETML σε XLSM" %}}
