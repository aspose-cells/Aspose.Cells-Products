...
Het volgende voorbeeld laat zien hoe u XLSX converteert naar XLTX in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSX naar XLTX te converteren" %}}
