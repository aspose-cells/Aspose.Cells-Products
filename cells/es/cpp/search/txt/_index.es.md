---
title:  Buscar documento TXT sin abrir mediante C++
weight: 5090
description: C++ código de ejemplo para buscar palabras con patrón en el archivo TXT en el entorno de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
...
{{% blocks/products/pf/agp/content h2="Cómo buscar el archivo TXT usando C++" %}}
 ...
 Para buscar el archivo TXT, utilizaremos
...
Un archivo con la extensión .TXT representa un documento de texto que contiene texto sin formato en forma de líneas. Los párrafos de un documento de texto se reconocen mediante retornos de carro y se utilizan para una mejor organización del contenido del archivo. Un documento de texto estándar puede abrirse en cualquier editor de texto o procesador de texto en diferentes sistemas operativos. Todo el texto de un archivo de este tipo está en formato legible y se representa mediante una secuencia de caracteres.
