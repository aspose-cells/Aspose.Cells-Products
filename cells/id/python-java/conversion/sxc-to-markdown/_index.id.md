...
{{% blocks/products/pf/agp/content h2="Ubah SXC menjadi MARKDOWN Menggunakan Python" %}}
...
Contoh berikut menunjukkan cara mengonversi SXC menjadi MARKDOWN di Python.
