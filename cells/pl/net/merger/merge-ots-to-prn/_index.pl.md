---
title: Połącz OTS z PRN - Połącz OTS z PRN w C#
url: /pl/net/merger/merge-ots-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie online OTS z formatem zapisu PRN. C# Połącz format OTS z PRN. Połącz OTS z PRN w C#. Połącz OTS.
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z PRN w C# online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć OTS z PRN w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć OTS z PRN. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku PRN. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatnie online, aby połączyć OTS z PRN pod numerem C#" InputFormat="ots" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć OTS z PRN przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć OTS z PRN? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia OTS z PRN" %}}
