---
title: Java ซ่อมแซม Excel - กู้คืนและแก้ไขไฟล์ Excel ที่เสียหาย
url: /th/java/recovery/repair-excel/ 
description: Java Aspose.Cells.ซ่อมเอ็กเซล. แก้ไขไฟล์ Excel เครื่องมือการกู้คืน Excel ทุจริตคอรัปชั่น กู้คืนข้อมูล Excel การกู้คืนไฟล์ Excel กู้คืนไฟล์ Excel ที่เสียหาย
...
{{% blocks/products/pf/agp/content h2="วิธีซ่อมแซมไฟล์ Excel ใน Java" %}}
...
{{% cells-recovery title="โค้ดตัวอย่างเพื่อซ่อมแซมไฟล์ EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="java" %}}    
    
{{% blocks/products/pf/agp/content h2="Java ไลบรารี่เพื่อซ่อมแซมไฟล์ EXCEL" %}}
