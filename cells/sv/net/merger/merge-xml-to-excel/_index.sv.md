---
title: Slå samman XML till EXCEL - Kombinera XML till EXCEL i C#
url: /sv/net/merger/merge-xml-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online sammanfoga XML till EXCEL sparaformat. C# Kombinera XML till EXCEL-format. Slå samman XML till EXCEL i C#. XML Merge.
...
{{% blocks/products/pf/agp/content h2="Slå samman XML till EXCEL i C# Online gratis" %}}

Följande exempel visar hur man slår samman XML till EXCEL i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman XML till EXCEL. Ladda upp dina filer, anrop Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i EXCEL-fil. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman XML till EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman XML till EXCEL i C#" InputFormat="xml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man sammanfogar XML till EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XML till EXCEL programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET-biblioteket för att slå samman XML till EXCEL" %}}
