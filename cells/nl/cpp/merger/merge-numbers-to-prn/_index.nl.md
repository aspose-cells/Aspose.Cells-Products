---
title: Voeg NUMBERS samen tot PRN - Combineer NUMBERS tot PRN in C++
url: /nl/cpp/merger/merge-numbers-to-prn/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online NUMMERS samenvoegen naar PRN-opslagformaat. C++ Combineer NUMMERS naar PRN-formaat. NUMBERS samenvoegen tot PRN in C++. NUMBERS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Hoe NUMBERS samen te voegen tot PRN via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u NUMBERS programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om NUMBERS samen te voegen tot PRN" %}}
