...
url: /cs/cpp/merger/merge-jpg-to-txt/ 
...
Následující příklad ukazuje, jak sloučit JPG s TXT v Aspose.Cells for C++.
...
Potřebujete sloučit JPG na TXT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do TXT" %}}
