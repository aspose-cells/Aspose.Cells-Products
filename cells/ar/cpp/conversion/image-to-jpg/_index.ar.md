...
description: Aspose اكسل. قم بتحويل IMAGE إلى JPG بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى JPG. C++ حفظ الصورة إلى JPG. احفظ الصورة بصيغة JPG باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة إلى JPG في C++" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى JPG في C++.
...
هل تحتاج إلى تحويل ملفات IMAGE إلى JPG برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى JPG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى JPG عن طريق استدعاء طريقة Save().
1.  احصل على نتيجة تحويل IMAGE إلى JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل IMAGE إلى JPG" %}}
