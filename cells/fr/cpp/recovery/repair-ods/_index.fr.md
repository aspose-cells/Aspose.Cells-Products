---
title: C++ Réparer les ods - Récupérer et réparer le fichier ods corrompu
url: /fr/cpp/recovery/repair-ods/ 
description: C++ Aspose.Cells. Réparation des pièces. Correction du fichier OD. outil de récupération de Ods. la corruption. Restaurer les données ods. récupération de fichier ods. Récupérez le fichier ods corrompu.
...
Besoin de réparer le fichier ods par programme ? Les développeurs C++ peuvent facilement charger et réparer le fichier ods en quelques lignes de code seulement.
...
{{% cells-recovery title="Exemple de code pour réparer le fichier ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="cpp" %}}    
    
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour réparer le fichier ODS" %}}
