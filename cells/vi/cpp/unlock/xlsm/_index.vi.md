...
{{< blocks/products/pf/i18n/upper-banner h1="Mở khóa tệp XLSM qua C++" h2="Xóa bảo vệ khỏi bảng tính Excel bao gồm cả tệp XLSM bằng cách sử dụng C++ Thư viện." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
1. Tải tệp bị khóa XLSM bằng CreateIWorkbook.1. Gọi hàm Unprotect () để mở khóa.1. Đặt mật khẩu thành NULL bằng SetPassword.1. Lưu tệp XLSM tại một vị trí được chỉ định.
