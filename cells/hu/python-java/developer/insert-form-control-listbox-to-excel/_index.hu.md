---
title:  Illessze be a ListBoxot (Űrlapvezérlőt) az Excelbe a Python számon keresztül
weight: 50
description: Python forráskód a ListBox (Űrlapvezérlő) beillesztéséhez az Excelbe.
---
...
{{% blocks/products/pf/agp/content h2="A ListBox (űrlapvezérlő) beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ListBox (Űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addListBox(int,%20int,%20int,%20int,%20int,%20int)) egy ListBox (Űrlapvezérlő) beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="ListBox beszúrása (Űrlapvezérlő) - Python" offSpacer="" %}}
