...
{{% blocks/products/pf/agp/content h2="Преобразование XML в GIF с использованием C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в GIF в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат GIF в формате C#.
...
1.  Преобразовать XML в формат GIF, вызвав метод Workbook.Save.
