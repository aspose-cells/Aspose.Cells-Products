---
title: C++ TABDELIMITED เป็น SXC - แปลง TABDELIMITED เป็น SXC ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง TABDELIMITED เป็น SXC บันทึกรูปแบบ C++ TABDELIMITED เป็นรูปแบบ SXC บันทึก TABDELIMITED เป็น SXC C++
...
{{% blocks/products/pf/agp/content h2="บันทึก TABDELIMITED เป็น SXC ใน C++ ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีแปลง TABDELIMITED เป็น SXC ใน C++
...
1.  แปลง TABDELIMITED เป็น SXC โดยเรียกเมธอด Save()
