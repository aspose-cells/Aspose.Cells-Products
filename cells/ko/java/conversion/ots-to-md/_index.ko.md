---
title:  OTS를 MD Java로 변환
description: 무료로 OTS를 MD 온라인으로 변환하세요. 무료 온라인 OTS로 MD 변환기. Java OTS에서 MD로. OTS에서 MD via Java로.
keywords: Convert OTS, OTS Converter, OTS to PDF, OTS to Word, OTS to PPT, OTS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="OTS를 MD via Java로 변환" h2="온프레미스 Java 라이브러리를 사용하여 단일 또는 여러 페이지를 MD로 변환하기 위한 OTS에서 MD Java로의 변환." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Java 온라인에서 무료로 OTS를 MD에 저장" %}}

다음 예는 Java에서 OTS를 MD로 변환하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

OTS를 MD로 변환하는 쉬운 단계를 따르십시오. OTS 파일을 업로드한 다음 간단히 MD 파일로 저장하세요. OTS 읽기 및 MD 쓰기 모두 정규화된 파일 이름을 사용할 수 있습니다. 출력된 MD 내용 및 형식은 원본 OTS 문서와 동일합니다.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="온라인에서 OTS를 MD로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="OTS를 MD via Java로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 Java 개발자는 단 몇 줄의 코드로 OTS를 MD로 쉽게 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1.  Workbook 클래스의 인스턴스로 OTS 파일 로드
1.  Workbook.save 메서드를 호출하여 OTS를 MD로 변환

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java OTS를 MD로 변환하는 라이브러리" %}}
{{% blocks/products/pf/agp/text %}}
