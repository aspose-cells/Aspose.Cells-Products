---
title:  أدخل زر الدوران في Excel via .NET
weight: 40
description: كود المصدر C# لإدراج زر الدوران في Excel على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج زر الدوران في ملف Excel عبر الرقم C#" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addspinner) لإدراج زر زيادة ونقصان في ورقة العمل المحددة
