---
title: C# XLS do JSON - XLS do JSON Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu XLS do JSON, umożliwiając bezproblemowe zapisywanie danych XLS do formatu JSON za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do JSON w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na JSON w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer XLS na numer JSON. Prześlij plik XLS, a następnie po prostu zapisz go jako plik JSON. Zarówno do odczytu XLS, jak i do zapisu JSON można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego JSON będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLS na JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na JSON przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na JSON? Programiści .NET mogą łatwo załadować i przekonwertować XLS na JSON w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLS na JSON wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLS na JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XLS na JSON" %}}
