---
title: แทรกกล่องรายการ (การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via java
weight: 50
description: Python via ซอร์สโค้ด Java เพื่อแทรกกล่องรายการ (การควบคุมแบบฟอร์ม) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกกล่องรายการ (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแทรกกล่องรายการ (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้รูปทรงของคอลเลกชัน[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addListBox(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกกล่องรายการ (ตัวควบคุมฟอร์ม) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกกล่องรายการ(การควบคุมแบบฟอร์ม) - Python via java" offSpacer="" %}}
