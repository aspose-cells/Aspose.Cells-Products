---
title: C# JPG sang PRN - Chuyển đổi JPG sang PRN
description: Aspose Excel. Chuyển đổi JPG sang PRN nhanh chóng và dễ dàng với Aspose.Cells. C# JPG sang PRN. C# Lưu JPG vào PRN. Lưu JPG dưới dạng PRN bằng C#.
...
{{% blocks/products/pf/agp/content h2="Lưu JPG vào PRN theo số C#" %}}

Ví dụ sau đây minh họa cách chuyển đổi JPG sang PRN trong C#.
...
{{% cells-convert title="Mã mẫu để chuyển đổi JPG sang PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển JPG sang PRN qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin JPG sang PRN theo chương trình? Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi JPG sang PRN chỉ bằng vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện C# chuyển JPG sang PRN" %}}
