...
description: Aspose Unggul. Konversi HTM ke MHT dengan cepat dan mudah dengan Aspose.Cells. Python HTM ke MHT. Python Simpan HTM ke MHT. Simpan HTM sebagai MHT menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah HTM menjadi MHT di Python" %}}

 Bagaimana cara mengubah HTM ke MHT? Dengan perpustakaan Aspose.Cells for Python melalui NET, Anda dapat dengan mudah mengonversi HTM ke MHT secara terprogram dengan beberapa baris kode.[Aspose.Cells for Python lewat NET](https://pypi.org/project/aspose-cells-python/)mampu membangun aplikasi lintas platform dengan kemampuan untuk menghasilkan, memodifikasi, mengkonversi, merender dan mencetak semua file Excel. Python Excel API tidak hanya mengkonversi antar format spreadsheet, tetapi juga dapat merender file Excel sebagai gambar, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT dan banyak lagi, sehingga menjadikannya pilihan sempurna untuk bertukar dokumen dalam format standar industri.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Simpan HTM ke MHT di Python" %}}

Contoh berikut menunjukkan cara mengonversi HTM ke MHT di Python via NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengubah HTM ke MHT. Unggah file HTM Anda, lalu simpan sebagai file MHT. Untuk pembacaan HTM dan penulisan MHT, Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format MHT keluaran akan sama dengan dokumen HTM asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Kode Contoh untuk Mengonversi HTM ke MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="mht" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi HTM ke MHT" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file HTM ke MHT secara terprogram? Pengembang Python dapat dengan mudah memuat & mengonversi HTM ke MHT hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengkonversi HTM ke MHT" %}}
