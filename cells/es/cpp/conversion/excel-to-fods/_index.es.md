---
title: C++ EXCEL a FODS - Convertidor EXCEL a FODS
...
{{% blocks/products/pf/agp/content h2="Guardar EXCEL en FODS en C++" %}}

El siguiente ejemplo demuestra cómo convertir EXCEL a FODS en C++.
...
{{% cells-convert title="Código de ejemplo para convertir EXCEL a FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="fods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir EXCEL a FODS a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos de Excel a FODS mediante programación? Los desarrolladores de C++ pueden convertir fácilmente Excel a FODS con solo unas pocas líneas de código.
...
1.  Convierta EXCEL a FODS llamando al método Save().
1.  Obtenga el resultado de la conversión de EXCEL a FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteca para convertir EXCEL a FODS" %}}
