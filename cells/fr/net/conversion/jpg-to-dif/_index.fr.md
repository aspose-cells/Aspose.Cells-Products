---
title: C# JPG en DIF - Convertisseur JPG en DIF
description: Aspose Exceller. Convertissez JPG en DIF rapidement et facilement avec Aspose.Cells. C# JPG en DIF. C# Enregistrez JPG en DIF. Enregistrez JPG sous DIF en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer JPG au DIF dans C#" %}}

L'exemple suivant montre comment convertir JPG en DIF en C#.
...
{{% cells-convert title="Exemple de code pour convertir JPG en DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en DIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en DIF par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en DIF en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en DIF" %}}
