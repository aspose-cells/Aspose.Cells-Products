---
title: C++을(를) 통해 열지 않고 TSV 문서 검색 
weight: 930
url: /ko/cpp/search/tsv/ 
description: C++ Windows 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경의 TSV 파일에서 패턴이 있는 단어를 검색하는 예제 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++에서 TSV 형식 검색" h2="Microsoft 또는 Adobe PDF와 같은 소프트웨어를 사용하지 않고 C++ API용 서버측 Aspose.Cells를 사용하여 기본 및 고성능 TSV 문서 검색." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="C++를 사용하여 TSV 파일을 검색하는 방법" %}}

 TSV 파일을 검색하려면 다음을 사용합니다.
...
+ IWorkbook 클래스를 인스턴스화하여 TSV 파일을 로드합니다.
...
+ IWorkbook->Save(.) 메서드를 사용하여 TSV 파일을 저장합니다.
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="온라인 TSV 검색 라이브 데모" sectionDescription="지금 바로 TSV 문서 내에서 텍스트, 단어, 구를 검색하십시오. [라이브 데모 웹사이트](https://products.aspose.app/cells/search). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
