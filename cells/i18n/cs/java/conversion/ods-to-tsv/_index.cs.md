...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na TSV pomocí Java" %}}

 K vykreslení ODS do TSV použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na TSV prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na TSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením TSV a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor TSV
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODS na TSV Java" offSpacer="" %}}
