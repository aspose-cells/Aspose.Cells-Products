---
title: Converteer ODS naar TIFF via Python
url: /nl/python-java/conversion/ods-to-tiff/
description: Voorbeeldcode voor conversie van ods naar tiff Python. Gebruik API voorbeeldcode voor batch-ods-bestanden naar tiff-conversie binnen de Python-toepassing.
---
...
{{% blocks/products/pf/agp/content h2="Hoe ODS naar TIFF te converteren met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ODS naar TIFF te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen eenvoudig ODS-bestanden laden en converteren naar TIFF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad ODS-bestand met een exemplaar van Workbook1. Roep de methode Workbook.Save aan1. Geef uitvoerpad door met TIFF-extensie als parameter1. Controleer het opgegeven pad voor het resulterende TIFF-bestand
...
{{% cells-convert title="Gratis app en voorbeeldcode om ODS naar TIFF te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="tiff" IsLandingPage="true" language="python" %}}
