...
description: Aspose เอ็กเซล. แปลง XLS เป็น EXCEL อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XLS เป็น EXCEL C++ บันทึก XLS ลง EXCEL. บันทึก XLS เป็น EXCEL โดยใช้ C++
...
1.  แปลง XLS เป็น EXCEL โดยการเรียกเมธอด Save()
