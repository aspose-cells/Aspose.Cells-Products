...
Precisa reparar o arquivo do Excel programaticamente? Os desenvolvedores do .NET podem facilmente carregar e reparar arquivos do Excel em apenas algumas linhas de código.
...
{{% cells-recovery title="Exemplo de código para reparar arquivo EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="net" %}}    
    
{{% blocks/products/pf/agp/content h2="Biblioteca .NET para reparar arquivo EXCEL" %}}
