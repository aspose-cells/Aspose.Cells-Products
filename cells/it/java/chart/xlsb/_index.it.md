---
title: Grafico del documento XLSB tramite Java 
weight: 670
url: /it/java/chart/xlsb/ 
description: Java codice di esempio per disegnare e convertire grafici o diagrammi in file XLSB su Java Runtime Environment per applicazioni JSP/JSF e applicazioni desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB Formatta Grafici in Java" h2="Grafici di documenti XLSB nativi e ad alte prestazioni che utilizzano API Aspose.Cells for Java lato server, senza l\'uso di software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Come creare grafici file XLSB utilizzando Java" %}}

 Per creare grafici di file XLSB, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per creare grafici di file XLSB in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Crea grafico file XLSB - Java" offSpacer="" %}}
