---
title: Konvertera XLS till JSON via Java 
weight: 9680
url: /sv/java/conversion/xls-to-json/ 
description: Exempel på Java-konverteringskod för XLS-format till JSON-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till JSON inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLS till JSON via Java" h2="XLS till JSON Java-konvertering för att konvertera enstaka eller flera sidor till JSON med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLS till JSON med Java" %}}

 För att rendera XLS till JSON kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLS till JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Utvecklare kan enkelt konvertera XLS-fil till JSON på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLS-fil med en instans av Workbook-klassen1. Skapa ett dataområde som ska exporteras med metoden Cells.createRange1. Anrop JsonUtility.exportRangeToJson-metoden med referenser till Range & ExportRangeToJsonOptions1. Skriv sträng JSON-data till fil via metoden BufferedWriter.write
...
{{% blocks/products/pf/agp/text %}}
 ...
 Innan du använder exempelkoden, se till att du har följande förutsättningar.
...
{{% blocks/products/pf/agp/code-block title="XLS till JSON Java omvandlingskällkod" offSpacer="" %}}
