...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar TextBox en un archivo Excel via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[agregar método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addTextBox-int-int-int-int-int-int-) para insertar TextBox en la hoja de trabajo seleccionada
