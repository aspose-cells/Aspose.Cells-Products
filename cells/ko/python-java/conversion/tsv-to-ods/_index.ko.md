---
title: Python을(를) 통해 TSV를 ODS로 변환
url: /ko/python-java/conversion/tsv-to-ods/
description: tsv에서 ods Python로의 변환을 위한 샘플 코드입니다. Python 애플리케이션 내에서 일괄 tsv 파일을 ods로 변환하기 위해 API 예제 코드를 사용합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python을(를) 통해 TSV를 ODS로 변환" h2="Python API를 사용하여 Excel® 스프레드시트를 ODS 형식으로 내보냅니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python을 사용하여 TSV를 ODS로 변환하는 방법" %}}

 TSV를 ODS로 변환하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Python를 통해 TSV를 ODS로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Python 개발자는 몇 줄의 코드로 TSV 파일을 쉽게 로드하고 ODS로 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. 통합 문서 인스턴스로 TSV 파일 로드1. Workbook.Save 메서드 호출1. 매개변수로 ODS 확장자를 사용하여 출력 경로 전달1. 결과 ODS 파일에 대해 지정된 경로 확인
...
{{% cells-convert title="TSV를 ODS로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="ods" IsLandingPage="true" language="python" %}}
