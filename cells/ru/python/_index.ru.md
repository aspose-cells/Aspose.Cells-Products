...
{{< blocks/products/pf/i18n/upper-banner h1="Python API для синтаксического анализа электронных таблиц Excel" h2="Создавайте, читайте, записывайте электронные таблицы и управляйте ими, а также экспортируйте файлы Excel в различные форматы в приложениях Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-python-java.svg" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="https://downloads.aspose.com/cells/python" >}}
...
<p>
 Aspose.Cells для Python — это быстрый и надежный API для задач обработки электронных таблиц. Разработчики могут создавать простые или сложные электронные таблицы, манипулировать ими и извлекать информацию из файлов Excel. API читает несколько форматов Excel и может преобразовывать рабочие листы в форматы XPS, PDF, MHTML, HTML, обычный текст, изображения и другие форматы. Это лучшее решение для автоматизации отчетов Excel с использованием Python.
</p>
...
{{< blocks/products/pf/carousel-item h3="Независимость от платформы" description="Aspose.Cells для Python доступно для." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые форматы файлов" description="Библиотека Python Excel поддерживает популярные форматы Microsoft Excel, форматы с фиксированным макетом и изображения." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Расширенные функции Python Excel API
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Читать электронные таблицы Excel
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Рендеринг электронных таблиц в PDF, EMF и изображения
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Настройте рабочие листы в рабочих книгах
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Защитить / снять защиту с листов
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Добавляйте изображения и создавайте диаграммы
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Добавить или удалить группировку строк и столбцов
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Читать и устанавливать формулы
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Отрегулируйте ориентацию страницы, масштабирование, размер бумаги
    </p>
   </div>
   <div class="col-lg-4">
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Python Библиотека Excel обеспечивает преобразование файлов Excel в PDF, XPS и другие форматы. форматы HTML. Надежное преобразование API делает его идеальным решением для компаний, которым требуется обмен файлами в стандартных отраслевых форматах.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Сохранить электронную таблицу в разных форматах — Java
     </h3>
...
<p>Python sheets API provides a powerful Formula Calculation Engine that supports almost all of the standard and advanced Microsoft Excel formulas and functions. Formula calculation engine makes it easy to read, set and calculate the results of the built-in or add-in type, array and R1C1 reference style formulas.</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells для Python обеспечивает полный контроль над настройкой страницы, позволяя управлять несколькими параметрами отображения, такими как предварительный просмотр разрывов страниц, установка уровня масштабирования, установка ориентации страницы, управление видимостью данных с помощью фиксированных областей, размер бумаги, масштабирование, заголовки и т.д. нижние колонтитулы и область печати.
    </p>
   </div>
   <!--<div class="col-lg-12">
...
<p>Aspose.Cells for Android via Java API allows you to manipulate rows and columns in many different ways. You can easily adjust row height and column width, auto size the width & height of cells according to the contents, insert or delete, hide or show and group or ungroup rows & columns.</p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Управление данными таблиц Excel
    </h2>
    <p>
     Aspose.Cells for Python API обеспечивает расширенную поддержку управления данными рабочего листа. Можно легко манипулировать любой ячейкой рабочего листа во время выполнения или импортировать данные на рабочие листы из различных источников данных.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Cells для Python обеспечивает полную поддержку построения диаграмм. Можно легко добавлять стандартные и настраиваемые диаграммы или динамически устанавливать данные диаграммы, чтобы обновлять диаграмму с помощью этой библиотеки Python.
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/cells/pythonjava/" >}}
{{< blocks/products/pf/slr-element name="Исходный код" href="https://github.com/aspose-cells/Aspose.Cells-for-Java" >}}
{{< blocks/products/pf/slr-element name="Aspose.Cells API ссылки" href="https://apireference.aspose.com/python/cells" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Cells для Python?" tabId="success-stories" >}}
