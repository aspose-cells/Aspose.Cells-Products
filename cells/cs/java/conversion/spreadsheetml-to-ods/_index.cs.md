---
title: Převést SPREADSHEETML na ODS prostřednictvím Java 

description: Ukázkový konverzní kód Java pro formát SPREADSHEETML na soubor ODS. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do ODS v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SPREADSHEETML na ODS prostřednictvím Java" h2="Převod SPREADSHEETML na ODS Java pro převod jedné nebo více stránek na ODS pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SPREADSHEETML na ODS pomocí Java" %}}

 K vykreslení SPREADSHEETML do ODS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SPREADSHEETML na ODS prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SPREADSHEETML na ODS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SPREADSHEETML s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením ODS a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor ODS
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SPREADSHEETML na ODS Java" offSpacer="" %}}

```cs
// načtěte soubor SPREADSHEETML do instance Workbooku
Workbook book = new Workbook("template.spreadsheetml");
// uložit SPREADSHEETML jako ODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze SPREADSHEETML na ODS" sectionDescription="[Převést SPREADSHEETML na ODS](https://products.aspose.app/cells/conversion/spreadsheetml-to-ods) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor SPREADSHEETML, bude okamžitě převeden na ODS." >}}
