---
title: Υδατογράφημα ODS έγγραφο via .NET
weight: 4190
description: C# πηγαίος κώδικας για προσθήκη ή κατάργηση υδατογραφήματος στο αρχείο ODS στο .NET Framework, .NET Core, Mono ή Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την προσθήκη υδατογραφήματος στο ODS μέσω του C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Προσθέστε υδατογράφημα στο ODS - C#" offSpacer="" %}}
