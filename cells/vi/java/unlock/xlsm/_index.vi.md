---
title:  Mở khóa XLSM tài liệu via Java
weight: 7700
description: Mã mẫu Java để mở khóa tệp XLSM được bảo vệ bằng mật khẩu trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Mở khóa XLSM Tệp via Java" h2="Xóa bảo vệ khỏi bảng tính Excel bao gồm tệp XLSM bằng Thư viện Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách xóa tệp bảo vệ XLSM bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước mở khóa XLSM via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mở khóa XLSM Tệp via Java" offSpacer="" %}}
