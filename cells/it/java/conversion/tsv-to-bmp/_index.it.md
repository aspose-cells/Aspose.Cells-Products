---
title: Converti TSV in BMP tramite Java 
weight: 4200

description: Esempio di codice di conversione Java per il formato TSV in file BMP. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in BMP all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti TSV in BMP tramite Java" h2="Conversione da TSV a BMP Java per convertire pagine singole o multiple in BMP utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire TSV in BMP utilizzando Java" %}}

 Per rendere TSV in BMP, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TSV in BMP tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente i file TSV in BMP in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TSV con un'istanza di Workbook1. Seleziona l'impostazione predefinita o qualsiasi foglio di lavoro dalla raccolta1. Crea e imposta l'oggetto di ImageOrPrintOptions1. Crea SheetRender con Foglio di lavoro e oggetti ImageOrPrintOptions1. Chiama il metodo SheetRender.toImage per salvare il risultato in formato BMP
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da TSV a BMP Java" offSpacer="" %}}

```cs
// caricare il file TSV di cui eseguire il rendering
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo dal vivo di conversione da TSV a BMP" sectionDescription="[Converti TSV in BMP](https://products.aspose.app/cells/conversion/tsv-to-bmp) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file TSV, verrà convertito istantaneamente in BMP." >}}
