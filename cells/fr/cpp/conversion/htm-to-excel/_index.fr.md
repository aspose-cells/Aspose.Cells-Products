...
description: Aspose Exceller. Convertissez HTM en EXCEL rapidement et facilement avec Aspose.Cells. C++ HTM en EXCEL. C++ Enregistrez HTM dans EXCEL. Enregistrez HTM sous EXCEL en utilisant C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM dans EXCEL en C++" %}}

L'exemple suivant montre comment convertir HTM en EXCEL en C++.
...
{{% cells-convert title="Exemple de code pour convertir HTM en EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlsx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en EXCEL via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en EXCEL par programme ? Les développeurs C++ peuvent facilement convertir HTM en EXCEL en quelques lignes de code seulement.
...
1.  Convertissez HTM en EXCEL en appelant la méthode Save().
