...
weight: 5860
description: Java пример кода для разблокировки защищенного паролем файла XLSB в Java Среда выполнения для приложений JSP/JSF и настольных приложений.
...
{{< blocks/products/pf/i18n/upper-banner h1="Разблокировать XLSB Файлы via Java" h2="Снимите защиту с электронных таблиц Excel, включая файл XLSB, с помощью библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/code-block title="Разблокировать XLSB Файлы via Java" offSpacer="" %}}
