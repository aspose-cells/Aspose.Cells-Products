...
description: Aspose เอ็กเซล. แปลง XLS เป็น XLTM อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XLS ถึง XLTM C++ บันทึก XLS ถึง XLTM บันทึก XLS เป็น 07611134 81 ใช้ C++.
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ถึง XLTM ใน C++" %}}
...
1.  แปลง XLS เป็น XLTM โดยการเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลงจาก XLS เป็น XLTM

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ ไลบรารี่เพื่อแปลง XLS เป็น XLTM" %}}
