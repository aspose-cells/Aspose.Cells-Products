---
title: C++ FODS SQL-hez - FODS SQL Converterhez
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C++ fejlesztők számára a FODS SQL formátumba konvertálásához, lehetővé téve a FODS adatok zökkenőmentes mentését SQL formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható C++ kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a FODS-et SQL-be a C++-ben" %}}

A következő példa bemutatja, hogyan lehet a FODS-et SQL-lé konvertálni a C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a FODS SQL-vé konvertálásához. Töltse fel a FODS fájlt, majd egyszerűen mentse el SQL fájlként. Mind a FODS olvasásához, mind az SQL-íráshoz használhat teljesen minősített fájlneveket. A kimeneti SQL tartalom és formázás megegyezik az eredeti FODS dokumentummal.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mintakód a FODS SQL-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="sql" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A FODS konvertálása SQL-re a C++-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell SQL-lé konvertálni a FODS fájlokat? A C++ fejlesztők könnyedén konvertálhatják a FODS fájlokat SQL-lé mindössze néhány sornyi kóddal.
...
1.  Alakítsd át a FODS-et SQL-lé a Save() metódus meghívásával.
1.  Szerezze le a FODS konverziós eredményt SQL-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ könyvtár a FODS SQL-re konvertálásához" %}}
