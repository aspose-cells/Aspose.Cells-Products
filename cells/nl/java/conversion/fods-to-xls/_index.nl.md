...
{{% blocks/products/pf/agp/content h2="Sla FODS op in XLS in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar XLS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar XLS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar XLS? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar XLS met slechts een paar regels code.
