---
title: Konwertuj FODS na HTML za pomocą Java 
url: /pl/java/conversion/fods-to-html/ 
description: Przykładowy kod konwersji Java dla formatu FODS do pliku HTML. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do HTML w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj FODS na HTML za pomocą Java" h2="Konwersja FODS na HTML Java w celu konwersji jednej lub wielu stron do formatu HTML przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować FODS na HTML za pomocą Java" %}}

 Aby wyrenderować FODS do HTML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować FODS na HTML za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik FODS na HTML za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik FODS z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem HTML i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę wynikowego pliku HTML
...
{{% blocks/products/pf/agp/code-block title="FODS do HTML Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik FODS w instancji Workbook
Workbook book = new Workbook("template.fods");
// zapisz FODS jako HTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo konwersji FODS na HTML" sectionDescription="[Konwertuj FODS na HTML](https://products.aspose.app/cells/conversion/fods-to-html) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik FODS, zostanie on natychmiast przekonwertowany do formatu HTML." >}}
