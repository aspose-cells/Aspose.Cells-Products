...
description: Aspose Excel. Java Aspose.Cells. Sloučit XML do OTS saveformat. Java Zkombinujte XML s formátem OTS. Sloučit XML do OTS v Java. XML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML do OTS v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XML do OTS v Java" InputFormat="xml" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
