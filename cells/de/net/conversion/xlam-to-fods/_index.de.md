...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM bis FODS in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLAM in FODS in C# konvertiert wird.
...
Müssen Sie XLAM-Dateien programmgesteuert in FODS konvertieren? .NET-Entwickler können XLAM problemlos in nur wenigen Codezeilen laden und in FODS konvertieren.
...
1.  Konvertieren Sie XLAM in FODS, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLAM in FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLAM in FODS" %}}
