---
title: Convertisseur PHP Excel vers TIFF - Excel vers TIFF
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir EXCEL au format TIFF, permettant un enregistrement transparent des données EXCEL au format TIFF à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code PHP efficace et personnalisable.
...
{{% cells-convert title="Exemple de code pour convertir un fichier Excel en TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="tiff" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir un nombre Excel en TIFF via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL au format TIFF par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers EXCEL au format TIFF en quelques lignes de code seulement.
...
1.  Convertissez EXCEL au format TIFF en appelant la méthode save du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en TIFF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir un fichier Excel au format TIFF" %}}
