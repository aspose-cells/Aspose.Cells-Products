---
title:  Wstaw obiekt OLE do programu Excel via .NET
weight: 170
description: C# kod źródłowy umożliwiający wstawienie obiektu OLE do programu Excel w platformie .NET Framework, .NET Core, Mono lub platformach Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw obiekt OLE do programu Excel via .NET" h2="Wstaw obiekt OLE przy użyciu interfejsów API Aspose.Cells bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Jak wstawić obiekt OLE do pliku Excel przy użyciu numeru C#" %}}

 Aby wstawić obiekt OLE do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić obiekt OLE do pliku Excel za pomocą C#" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj[dodaj metodę](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addoleobject) , aby wstawić obiekt OLE w wybranym arkuszu
...
{{% blocks/products/pf/agp/code-block title="Wstaw obiekt OLE - C#" offSpacer="" %}}
