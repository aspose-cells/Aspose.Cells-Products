---
title: Crear ET - Crear archivo ET en Python
description:  Aspose Excel. Python Excel. Python Cree un archivo ET rápida y fácilmente con Aspose.Cells. Genere un archivo ET usando la biblioteca Excel Python. Cree ET en la biblioteca de Excel Python. Python Creador ET.
...
{{% blocks/products/pf/agp/content h2="Cree un archivo ET usando la biblioteca de Excel Python" %}}

 ¿Cómo crear un archivo ET? Con Aspose.Cells for Python a través de la biblioteca de Excel NET, puede crear fácilmente un archivo ET mediante programación con unas pocas líneas de código.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells-python/)es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria.

{{% /blocks/products/pf/agp/content %}}



{{% blocks/products/pf/agp/content h2="Cómo crear ET en la biblioteca de Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Es fácil para los desarrolladores crear, cargar, modificar y convertir archivos ET ejecutando diferentes aplicaciones de informes para el procesamiento de datos en solo unas pocas líneas de código.
...
1.  Utilice el método Guardar para guardar el libro como archivo ET.

{{% blocks/products/pf/agp/code-block title="El código de muestra muestra cómo crear un archivo ET en la biblioteca de Excel Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca de Excel para crear un archivo ET" %}}
