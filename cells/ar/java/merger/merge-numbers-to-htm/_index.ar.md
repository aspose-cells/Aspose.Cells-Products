---
title: دمج الأرقام في HTM - ادمج الأرقام في HTM في Java
url: /ar/java/merger/merge-numbers-to-htm/ 
description: Aspose إكسل. Java Aspose.Cells. دمج الأرقام مجانًا عبر الإنترنت إلى تنسيق حفظ HTM. Java دمج الأرقام في نسق HTM. دمج الأرقام إلى HTM في Java. دمج الأرقام.
...
{{% blocks/products/pf/agp/content h2="دمج الأرقام في HTM في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج NUMBERS مع HTM في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج NUMBERS في HTM. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف HTM. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج NUMBERS في HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني على الإنترنت لدمج الأرقام في HTM في Java" InputFormat="numbers" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج الأرقام في HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج NUMBERS في HTM برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Java مكتبة لدمج أرقام إلى HTM" %}}
