---
title: C# PRN'den OTS'ye - PRN'den OTS'ye dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile PRN'yi hızlı ve kolay bir şekilde OTS'ye dönüştürün. C# PRN'yi OTS'ye dönüştürün. C# PRN'yi OTS'ye kaydedin. C#'i kullanarak PRN'yi OTS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi C#\'de OTS\'ye kaydedin" %}}

Aşağıdaki örnek, C#'de PRN'nin OTS'ye nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="PRN\'yi OTS\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla OTS\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PRN dosyalarını programlı olarak OTS'ye dönüştürmeniz mi gerekiyor? .NET geliştiriciler yalnızca birkaç satır kodla PRN'yi kolayca yükleyebilir ve OTS'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi OTS\'ye dönüştürmek için C# kitaplığı" %}}
