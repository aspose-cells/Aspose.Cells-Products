---
title: PHP HTM a PRN - Convertidor de HTM a PRN
description: Aspose Excel. Convierta HTM a PRN rápida y fácilmente con Aspose.Cells. PHP HTM a PRN. PHP Guarde HTM en PRN. Guarde HTM como PRN usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a PRN mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a PRN mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a PRN en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a PRN llamando al método guardar del libro de trabajo.
