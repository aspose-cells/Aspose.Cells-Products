...
url: /net/conversion/jpeg-to-json/
...
{{% blocks/products/pf/agp/content h2="How to Convert JPEG to JSON Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert JPEG to JSON via C#" %}}
