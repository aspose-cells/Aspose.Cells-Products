...
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng XLSX trong Java" h2="Hợp nhất tài liệu XLSX gốc bằng cách sử dụng Java API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất các tệp XLSX bằng cách sử dụng Java" %}}
...
+ Tải tệp XLSX đầu tiên với một thể hiện của lớp Workbook.
+ Tải tài liệu XLSX thứ hai với một thể hiện của lớp Workbook.
+ Hợp nhất các tệp tin bằng phương thức kết hợp ().
+ lưu tệp XLSX đã hợp nhất theo đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tệp XLSX - Java" offSpacer="" %}}

```cs
// Mở tệp XLSX đầu tiên.
