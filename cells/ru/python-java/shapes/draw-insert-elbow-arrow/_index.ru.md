---
title:  Как нарисовать или вставить форму стрелки локтя в Excel, используя Python via Java
weight: 10
description: Нарисуйте или вставьте форму стрелки локтя, используя Aspose.Cells' Python via Java API без какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF и т. д.
...
{{% blocks/products/pf/agp/content h2="Как вставить форму стрелки локтя в файл Excel, используя Python via Java" %}}

 Чтобы вставить форму стрелки локтя в файл Excel, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке формы стрелки локтя в файл Excel с помощью Python via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте коллекцию фигур[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить фигуру локтевой стрелки на выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка угловой формы стрелы - Python via Java" offSpacer="" %}}
