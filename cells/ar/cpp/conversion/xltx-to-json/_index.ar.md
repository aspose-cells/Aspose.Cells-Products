---
title: تحويل XLTX إلى JSON عبر تطبيق C++ 
url: /ar/cpp/conversion/xltx-to-json/ 
description: نموذج رمز تحويل C++ لمستند XLTX إلى تنسيق JSON. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLTX إلى JSON دفعة داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTX إلى JSON عبر C++" h2="تحويل XLTX إلى JSON عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTX إلى JSON باستخدام C++" %}}

 من أجل تحويل XLTX إلى JSON ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLTX إلى JSON عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ بسهولة تحويل ملف XLTX إلى JSON في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLTX باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (JSON).1. سيتم حفظ ملف JSON في المسار المحدد.1. افتح ملف JSON في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLTX إلى JSON C++ شفرة مصدر التحويل" offSpacer="" %}}
