---
title: Converter JSON para TIFF via Java 
weight: 9840
url: /pt/java/conversion/json-to-tiff/ 
description: Exemplo de código de conversão Java do formato JSON para arquivo TIFF. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para TIFF em qualquer aplicativo baseado na Web ou Desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Como converter JSON para TIFF usando Java" %}}

 Para renderizar JSON para TIFF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter JSON em TIFF por meio de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem facilmente converter arquivos JSON em TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Criar uma nova instância da classe Workbook1. Selecione o padrão ou qualquer planilha da coleção1. Carregar dados JSON do arquivo1. Crie uma instância de JsonLayoutOptions e defina opções1. Chame o método JsonUtility.importData para importar dados JSON1. Crie e defina o objeto de ImageOrPrintOptions para renderização TIFF1. Criar SheetRender para renderização1. Chame o método SheetRender.toImage para salvar o resultado no formato TIFF
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão JSON para TIFF Java" offSpacer="" %}}
