...
description: Aspose Excel. Python Aspose.Cells. Mesclar EXCEL para formato de salvamento XML. Python Combine EXCEL com formato XML. Mesclar EXCEL com XML em Python. Mesclar EXCEL.
...
{{% blocks/products/pf/agp/content h2="Mesclar EXCEL com XML usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar EXCEL com XML em Python" %}}

O exemplo a seguir demonstra como mesclar EXCEL com XML em Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar EXCEL com XML. Faça upload de seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os em um arquivo XML. Se você desenvolver código em Python, será mais simples do que parece. Veja o exemplo Python que mescla EXCEL com XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemplo de código para mesclar EXCEL com XML em Python" InputFormat="xlsx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar EXCEL com XML via Python" %}}
