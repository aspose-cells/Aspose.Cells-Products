...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в SXC, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTML в SXC в Java" %}}
...
Нужно программно преобразовать файлы HTML в SXC? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в SXC всего несколькими строками кода.
