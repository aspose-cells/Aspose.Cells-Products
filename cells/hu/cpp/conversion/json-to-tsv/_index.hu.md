---
title: Konvertálja a JSON-t TSV-vé a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/json-to-tsv/ 
description: Minta C++ konverziós kód a JSON-dokumentumhoz TSV formátumba. A programozók ezt a forráskódot használhatják a JSON-ból TSV-vé kötegelt konvertálásához bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JSON konvertálása TSV-vé a következőn keresztül: C++" h2="Nagy teljesítményű JSON konvertálás TSV-vé a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="JSON konvertálása TSV-vé a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A JSON konvertálása TSV-vé a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatnak JSON-fájlt TSV-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a JSON-fájlt a Factory::CreateIWorkbook használatával.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (TSV) fájlkiterjesztéssel.1. A TSV fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a TSV fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="JSON-tól TSV-hez C++ Konverziós forráskód" offSpacer="" %}}
