...
description: Aspose Excel. Converti PRN in PRN in modo rapido e semplice con Aspose.Cells. C++ PRN in PRN. C++ Salva PRN su PRN. Salva PRN come PRN utilizzando C++.
...
{{% blocks/products/pf/agp/content h2="Converti PRN in PRN utilizzando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salva il PRN nel PRN allo C++" %}}

L'esempio seguente dimostra come convertire PRN in PRN in C++.
...
Hai bisogno di convertire i file PRN in PRN a livello di codice? C++ gli sviluppatori possono convertire facilmente PRN in PRN in poche righe di codice.
...
1.  Converti PRN in PRN chiamando il metodo Save().
