---
title: Konvertera XLS till EMF via Java 
weight: 4350
url: /sv/java/conversion/xls-to-emf/ 
description: Exempel på Java-konverteringskod för XLS-format till EMF-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till EMF inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLS till EMF via Java" h2="XLS till EMF Java-konvertering för att konvertera enstaka eller flera sidor till EMF med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLS till EMF med Java" %}}

 För att rendera XLS till EMF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLS till EMF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLS-fil till EMF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLS-fil med en instans av Workbook1. Välj standard eller valfritt kalkylblad från samlingen1. Skapa och ställ in objektet för ImageOrPrintOptions1. Skapa SheetRender med Worksheet & ImageOrPrintOptions-objekt1. Ring SheetRender.toImage-metoden för att spara resultatet i EMF-format
...
{{% blocks/products/pf/agp/code-block title="XLS till EMF Java konverteringskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS till EMF Conversion Live Demos" sectionDescription="[Konvertera XLS till EMF](https://products.aspose.app/cells/conversion/xls-to-emf) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din XLS-fil, den konverteras omedelbart till EMF." >}}
