---
title: Java XLSX naar XLS - Online XLSX naar XLS Converter
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratis online Java Converteer XLSX naar XLS saveformat. Java XLSX tot XLS formaat. Bewaar XLSX tot XLS Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLSX naar XLS in Java" h2="Snelle Java-bibliotheek voor het converteren van XLSX naar XLS. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, XLS en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Bespaar XLSX tot XLS in Java Online gratis" %}}

Het volgende voorbeeld laat zien hoe u XLSX converteert naar XLS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSX te converteren naar XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLSX-bestanden programmatisch converteren naar XLS? Java-ontwikkelaars kunnen eenvoudig XLSX converteren naar XLS in slechts een paar regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSX naar XLS te converteren" %}}
{{% blocks/products/pf/agp/text %}}
