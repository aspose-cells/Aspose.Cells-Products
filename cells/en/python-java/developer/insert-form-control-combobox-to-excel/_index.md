---
title: Insert ComboBox(Form control) into Excel using Python via java 
weight: 20
...
{{% blocks/products/pf/agp/content h2="How to Insert ComboBox(Form control) into Excel File Using Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert ComboBox(Form control) to Excel file using Python via java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)) to insert a ComboBox(Form control) in the selected worksheet.
