---
title: Převeďte MHTML na ODS pomocí aplikace C++ 
weight: 5930

description: Ukázka převodního kódu C++ pro dokument MHTML na formát ODS. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi MHTML na ODS v jakékoli aplikaci C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést MHTML na ODS přes C++" h2="Vysoce výkonný převod MHTML na ODS pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na ODS pomocí C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu MHTML na ODS prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor MHTML na ODS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor MHTML pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu k výstupnímu souboru s příponou (ODS).1. Soubor ODS bude uložen do zadané cesty.1. Otevřete soubor ODS v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MHTML na ODS C++" offSpacer="" %}}
