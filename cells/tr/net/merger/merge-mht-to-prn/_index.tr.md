---
title: MHT'yi PRN'ye Birleştir - C#'de MHT'yi PRN'ye birleştirin
url: /tr/net/merger/merge-mht-to-prn/ 
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi MHT'yi PRN kaydetme biçimine birleştirme. C# MHT'yi PRN formatına birleştirin. C#'de MHT'yi PRN ile birleştirin. MHT Birleştirin.
...
{{% blocks/products/pf/agp/content h2="C#\'de MHT ile PRN\'yi Çevrimiçi Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin PRN ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

MHT'yi PRN'ye birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından PRN dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. MHT'yi PRN ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de MHT\'yi PRN ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="mht" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C# aracılığıyla MHT\'yi PRN\'ye Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

MHT'yi programlı olarak PRN ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi PRN ile birleştirmek için .NET kitaplığı" %}}
