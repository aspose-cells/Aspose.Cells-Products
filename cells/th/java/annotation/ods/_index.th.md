---
title:  เพิ่มหรือลบ ODS คำอธิบายประกอบ via Java
weight: 8840
description: โค้ดตัวอย่าง Java เพื่อลบคำอธิบายประกอบรูปแบบ ODS บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
...
{{% blocks/products/pf/agp/content h2="วิธีใส่คำอธิบายประกอบไฟล์ ODS โดยใช้ Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการเพิ่มหรือลบคำอธิบายประกอบจาก ODS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ลบคำอธิบายประกอบจาก ODS - Java" offSpacer="" %}}
