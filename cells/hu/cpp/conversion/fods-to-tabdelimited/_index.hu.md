...
{{% blocks/products/pf/agp/content h2="A FODS konvertálása TABLEDELIMITED-re a C++ használatával" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztők könnyedén konvertálhatják a FODS-et TABDELIMITED-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a FODS fájlt a Factory::CreateIWorkbook segítségével.
1. A FODS konvertálása TABDELIMITED-re a Save() metódus meghívásával.
