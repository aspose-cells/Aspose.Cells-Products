---
title:  HTML を C# 経由で HTML に結合
url: /ja/net/merger/merge-html-to-html/ 
description: HTML を HTML にオンラインで無料で結合します。無料オンラインHTMLからHTML合併。 HTML を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、HTML を C# の HTML にマージする方法を示しています。
...
{{% cells-merger title="オンラインでHTMLをHTMLにマージする無料アプリ" InputFormat="html" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
