...
{{% blocks/products/pf/agp/content h2="XLS konvertálása SVG-vé a Java használatával" %}}

 Az XLS SVG formátumba való rendereléséhez ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS SVG formátumú konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java fejlesztői könnyedén konvertálhatnak XLS-fájlt SVG-vé, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="XLS-ből SVG-be Java konverziós forráskód" offSpacer="" %}}
