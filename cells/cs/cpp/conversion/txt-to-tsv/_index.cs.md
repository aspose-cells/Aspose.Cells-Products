---
title: Převeďte TXT na TSV pomocí aplikace C++ 
url: /cs/cpp/conversion/txt-to-tsv/ 
description: Ukázkový konverzní kód C++ pro dokument TXT do formátu TSV. Programátoři mohou použít tento zdrojový kód pro dávkový převod TXT na TSV v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor TXT na TSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou souboru (TSV).1. Soubor TSV bude uložen do zadané cesty.1. Otevřete soubor TSV v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze TXT na TSV C++" offSpacer="" %}}
