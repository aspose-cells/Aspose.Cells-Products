...
description: Aspose Excel. Convierta XLSB a MHTML rápida y fácilmente con Aspose.Cells. Python XLSB a MHTML. Python Guarde XLSB en MHTML. Guarde XLSB como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB al MHTML en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a MHTML en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB en MHTML" %}}
