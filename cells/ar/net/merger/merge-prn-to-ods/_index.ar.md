...
يوضح المثال التالي كيفية دمج PRN مع ODS في Aspose.Cells for .NET.
...
هل تحتاج إلى دمج PRN في ODS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
