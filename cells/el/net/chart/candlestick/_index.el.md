...
Το γράφημα Open-High-Low-Close (OHLC) χρησιμοποιεί πέντε στήλες δεδομένων, με σειρά: κατηγορία, άνοιγμα, υψηλό, χαμηλό και κλείσιμο. Το εύρος τιμών σε κάθε κατηγορία υποδεικνύεται και πάλι με μια κάθετη γραμμή, ενώ το εύρος μεταξύ ανοίγματος και κλεισίματος δίνεται από μια ευρύτερη αιωρούμενη μπάρα. αν η τιμή αυξάνεται στην κατηγορία (το κλείσιμο είναι υψηλότερο από το ανοιχτό), η μπάρα γεμίζει με ένα χρώμα, ενώ εάν η τιμή μειωθεί, η μπάρα γεμίζει με άλλο. Αυτός ο τύπος γραφήματος ονομάζεται συχνά διάγραμμα κεριών.
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Πώς να δημιουργήσετε γραφήματα Candlestick (Open-High-Low-Close Stock) μέσω του C#" %}}

{{% blocks/products/pf/agp/text %}}

Είναι εύκολο για τους προγραμματιστές να δημιουργήσουν ένα γράφημα Candlestick με την εκτέλεση διαφορετικών εφαρμογών αναφοράς για επεξεργασία δεδομένων σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Συμπεριλάβετε τον χώρο ονομάτων στο αρχείο της τάξης σας
1.  Δημιουργώ[**ΤΕΤΡΑΔΙΟ ΕΡΓΑΣΙΩΝ**](https://reference.aspose.com/cells/net/aspose.cells/workbook) παράδειγμα τάξης από[δείγμα αρχείου Excel](Open-High-Low-Close.xlsx).
1.  Πρόσθεσε ένα[**Ανοιχτό-Υψηλό-Χαμηλό-Κλείσιμο Μετοχής**](https://reference.aspose.com/cells/net/aspose.cells.charts/charttype) Δημιουργήστε γράφημα στο φύλλο εργασίας καλώντας το[**Διαγράμματα**](https://reference.aspose.com/cells/net/aspose.cells.charts/chartcollection) της συλλογής[**Προσθήκη**](https://reference.aspose.com/cells/net/aspose.cells.charts/chartcollection/methods/add) μέθοδος, ενθυλακωμένη στο[**Φύλλο εργασίας**](https://reference.aspose.com/cells/net/aspose.cells/worksheet)αντικείμενο.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Ο ακόλουθος πηγαίος κώδικας δείχνει πώς να δημιουργήσετε ένα γράφημα Candlestick(Open-High-Low-Close Stock) στο αρχείο MS Excel XLSX χρησιμοποιώντας το C#." offSpacer="" %}}
