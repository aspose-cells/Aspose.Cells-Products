---
title:  Συγχώνευση XLS σε XLSB μέσω Python
url: /el/python-net/merger/merge-xls-to-xlsb/ 
description: Συγχώνευση XLS σε XLSB Online δωρεάν. Δωρεάν Online XLS έως XLSB Συγχώνευση. Συγχώνευση XLS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLS με το XLSB στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLS με XLSB σε απευθείας σύνδεση" InputFormat="xls" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
