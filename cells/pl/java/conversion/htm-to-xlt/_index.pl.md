...
{{% blocks/products/pf/agp/content h2="Zapisz HTM do XLT w Java" %}}
...
Trzeba programowo przekonwertować pliki HTM do formatu XLT? Programiści Java mogą łatwo przekonwertować pliki HTM do formatu XLT za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji HTM na XLT" %}}
{{% blocks/products/pf/agp/text %}}
