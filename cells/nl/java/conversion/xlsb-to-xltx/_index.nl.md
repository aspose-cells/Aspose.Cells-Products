...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in XLTX in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar XLTX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar XLTX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar XLTX? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar XLTX met slechts een paar regels code.
