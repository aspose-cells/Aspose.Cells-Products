---
title:  Sloučit CSV na XLS přes C++
...
Následující příklad ukazuje, jak sloučit CSV až XLS v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení CSV až XLS online" InputFormat="csv" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
