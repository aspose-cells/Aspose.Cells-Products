...
description: Aspose Excel. Konwertuj XML na FODS szybko i łatwo za pomocą Aspose.Cells. Java XML na FODS. Java Zapisz XML na FODS. Zapisz XML jako FODS używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem FODS w Java" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na FODS w Java.
...
Chcesz programowo przekonwertować pliki XML na FODS? Programiści Java mogą łatwo przekonwertować XML na FODS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji XML na FODS" %}}
{{% blocks/products/pf/agp/text %}}
