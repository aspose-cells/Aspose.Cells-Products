...
description: Aspose Excel. Konvertieren Sie HTM schnell und einfach in DIF mit Aspose.Cells. C++ HTM in DIF. C++ Speichern Sie HTM in DIF. Speichern Sie HTM als DIF mit C++.
...
{{% cells-convert title="Beispielcode zum Konvertieren von HTM in DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="dif" IsLandingPage="true" language="cpp" %}}
