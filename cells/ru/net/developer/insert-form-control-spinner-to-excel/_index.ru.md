---
title:  Вставьте кнопку прокрутки в Excel via .NET
weight: 40
description: C# исходный код для вставки кнопки прокрутки в Excel на платформах .NET Framework, .NET Core, Mono или Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке кнопки прокрутки в файл Excel через номер C#" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addspinner) вставить кнопку прокрутки на выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставить кнопку отжима — C#" offSpacer="" %}}
