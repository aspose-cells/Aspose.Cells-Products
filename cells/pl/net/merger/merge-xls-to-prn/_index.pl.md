---
title: Połącz XLS z PRN - Połącz XLS z PRN w C#
url: /pl/net/merger/merge-xls-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLS do formatu zapisu PRN. C# Połącz XLS do formatu PRN. Połącz XLS z PRN w C#. XLS Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLS z PRN w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić XLS z PRN w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLS z PRN. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku PRN. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy numer XLS z PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLS z PRN w C#" InputFormat="xls" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLS z PRN przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć numer XLS z PRN? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLS z PRN" %}}
