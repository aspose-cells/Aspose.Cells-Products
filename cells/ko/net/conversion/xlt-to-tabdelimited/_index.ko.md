...
{{< blocks/products/pf/i18n/upper-banner h1="XLT을 C#의 TABDELIMITED로 변환합니다." h2="XLT 형식을 탭 구분 형식으로 변환하는 고속 C# 라이브러리입니다. 이 전문 소프트웨어 솔루션은 XLT, 탭 구분 및 기타 여러 형식을 .NET 프레임워크, .NET 코어 또는 Mono 플랫폼으로 가져오고 내보낼 수 있습니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% cells-convert title="XLT을 탭으로 구분된 형식으로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlt" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 XLT을 TABDELIMITED로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 XLT 파일을 TABDELIMITED로 변환해야 합니까? .NET 개발자는 단 몇 줄의 코드만으로 XLT을 TABDELIMITED로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook.Save 메서드를 호출하여 XLT을 TABDELIMITED 형식으로 변환합니다.
