---
title:  Rechercher et remplacer le texte dans le document XLSB via .NET
weight: 3890
description: Code source C# pour supprimer les informations sensibles dans le fichier XLSB sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/content h2="Comment expurger le fichier XLSB à l\'aide de C#" %}}
 ...
 Afin de rédiger le fichier XLSB, nous utiliserons
