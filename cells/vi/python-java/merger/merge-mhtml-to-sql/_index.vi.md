---
title: Hợp nhất MHTML thành SQL - Hợp nhất MHTML thành SQL trong Python
url: /vi/python-java/merger/merge-mhtml-to-sql/ 
description: Aspose Excel. Python Excel. Hợp nhất MHTML thành định dạng lưu SQL. Python Kết hợp MHTML thành định dạng SQL. Hợp nhất MHTML thành SQL trong Thư viện Excel Python. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML thành SQL bằng Thư viện Excel Python" %}}

Làm cách nào để hợp nhất MHTML với SQL? Với thư viện Aspose.Cells for Python via Java, bạn có thể dễ dàng hợp nhất MHTML với SQL theo chương trình bằng một vài dòng mã.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells) có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, kết xuất và in tất cả các tệp Excel. Python Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó biến nó thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành. Bạn có thể cài đặt Aspose.Cells for Python via Java từ<a href="https://pypi.org/project/aspose-cells/">pypi</a> , sử dụng lệnh như:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML thành SQL trong Thư viện Excel Python" %}}

Ví dụ sau đây minh họa cách hợp nhất MHTML với SQL trong Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất MHTML với SQL. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SQL. Nếu bạn phát triển mã theo số Python, việc này sẽ đơn giản hơn nhiều. Xem ví dụ Python hợp nhất MHTML với SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất MHTML thành SQL trong Thư viện Excel Python" InputFormat="mhtml" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất MHTML thành SQL thông qua Thư viện Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python để hợp nhất MHTML thành SQL" %}}
