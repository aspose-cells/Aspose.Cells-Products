...
weight: 7020
description: C++ 예제 코드는 XLSB 파일에서 특정 패턴을 사용하여 단어를 검색하는 코드이며, C++ 런타임 환경(Windows 32비트, Windows 64비트 및 Linux 64비트)에서 사용 가능합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C++에서 XLSB 형식을 검색하세요" h2="어떤 소프트웨어(예: Microsoft 또는 Adobe PDF)도 사용하지 않고 서버 측 API를 이용한 네이티브 고성능 문서 검색(XLSB)이 가능합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
