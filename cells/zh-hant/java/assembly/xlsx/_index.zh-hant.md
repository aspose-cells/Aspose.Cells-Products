---
title: 在 XLSX 文件 via Java 中產生報告
weight: 7710
description: Java 用於在 JSP/JSF 應用程式和桌面應用程式的 Java 運行時環境上建立 XLSX 格式報告的範例程式碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="以 XLSX 格式產生批次報告 via Java" h2="使用資料來源和範本產生 XLSX 格式的報告。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 產生 XLSX 報告" %}}

為了建立 XLSX 文件報告，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="產生 XLSX 報告的步驟 via Java" %}}
...
1. 透過 Worbook.save 方法將結果儲存為 XLSX 格式
...
{{% blocks/products/pf/agp/code-block title="產生 XLSX 格式的 Excel 報表 - Java" offSpacer="" %}}
