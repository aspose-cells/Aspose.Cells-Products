...
{{< blocks/products/pf/i18n/upper-banner h1="Upravit formáty ODS v Java" h2="Nativní a vysoce výkonné redigování dokumentů citlivých na ODS pomocí rozhraní API Aspose.Cells for Java na straně serveru bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak upravit soubor ODS pomocí Java" %}}
 ...
 API, což je funkčně bohatá, výkonná a snadno použitelná platforma pro redigování API for Java. Jeho nejnovější verzi si můžete stáhnout přímo z
...
{{% blocks/products/pf/agp/code-block title="Redigovat soubory ODS – Java" offSpacer="" %}}
...
// Zadejte rozsah, ve kterém chcete hledat
// Zde je rozsah E3:H6
CellArea area = CellArea.createCellArea("E3", "H6");

// Zadejte možnosti Najít
...
do {
	// Prohledejte buňku s hledáním hodnot v rozsahu
	cell = worksheet.getCells().find("search", cell, opts);

	// Pokud žádná taková buňka nebyla nalezena, přerušte smyčku
	if (cell == null)
		break;

	// Nahraďte buňku hodnotou nahradit
