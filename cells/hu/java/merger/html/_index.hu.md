---
title:  A HTML via Java fájlok egyesítése
weight: 8830
description: Java mintakód a HTML dokumentumok kombinálásához a Java futásidejű környezet JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="A HTML formátumok egyesítése a Java-ben" h2="Natív HTML dokumentum-egyesítés szerveroldali Java API-kkal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="A HTML fájlok egyesítésének lépései a Java-ben" %}}
...
mentse az egyesített HTML fájlt a megadott elérési úton
...
{{% blocks/products/pf/agp/code-block title="A HTML fájlok egyesítése – Java" offSpacer="" %}}
