...
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítése HTM SQL mentési formátumba. C# HTM és SQL formátum kombinálása. HTM egyesítése SQL-be a C#-ben. HTM egyesítése.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a HTM-et az SQL-lel a C# Online ingyenesen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a HTM-et SQL-lel a Aspose.Cells for .NET-ben.
...
{{% cells-merger title="Ingyenes online a HTM és az SQL egyesítése a C# számon" InputFormat="htm" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
