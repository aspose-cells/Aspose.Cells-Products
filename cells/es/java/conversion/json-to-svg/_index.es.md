---
title: Convierte JSON a SVG a través de Java 
weight: 6900
url: /es/java/conversion/json-to-svg/ 
description: Ejemplo de código de conversión Java para formato JSON a archivo SVG. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a SVG dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte JSON a SVG a través de Java" h2="Exporte JSON a formato SVG a través de Java sin necesidad de herramientas o bibliotecas adicionales." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JSON a SVG usando Java" %}}

 Para renderizar JSON a SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir JSON a SVG a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo JSON a SVG con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Crear una nueva instancia de la clase Workbook1. Seleccione predeterminado o cualquier hoja de trabajo de la colección1. Cargar datos JSON desde un archivo1. Crear una instancia de JsonLayoutOptions y establecer opciones1. Llame al método JsonUtility.importData para importar datos JSON1. Cree y configure el objeto de ImageOrPrintOptions para la representación SVG1. Crear SheetRender para renderizar1. Llame al método SheetRender.toImage para guardar el resultado en formato SVG
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de JSON a SVG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de JSON a SVG" sectionDescription="[Convertir JSON a SVG](https://products.aspose.app/cells/conversion/json-to-svg) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo JSON, se convertirá instantáneamente a SVG." >}}
