...
description: Aspose Эксель. C++ Создайте файл HTML быстро и легко с помощью Aspose.Cells. Создайте файл HTML с помощью C++. Создайте HTML в C++. C++ HTML Creater.
...
1.  Сохраните книгу как файл .html, используя метод Save().
