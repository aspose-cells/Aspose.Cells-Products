---
title:  Agregar o quitar XLSB Anotación via .NET
weight: 6440
description: Código fuente C# para agregar y eliminar anotaciones de formato XLSB en plataformas .NET Framework, .NET Core, Mono o Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Agregar o eliminar anotaciones de XLSB a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Eliminar anotaciones de XLSB - C#" offSpacer="" %}}
