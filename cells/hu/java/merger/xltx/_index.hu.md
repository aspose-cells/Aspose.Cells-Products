...
{{< blocks/products/pf/i18n/upper-banner h1="XLTX formátumok egyesítése itt: Java" h2="Natív XLTX dokumentum-egyesítés szerveroldali Java API-kkal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="XLTX fájlok egyesítése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLTX fájlok egyesítésének lépései a következőben: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XLTX fájlok egyesítése – Java" offSpacer="" %}}

```cs
// Nyissa meg az első XLTX fájlt.
Workbook xltxFile1 = new Workbook("chartsFileWithPath.xltx");

// Határozza meg a második forráskönyvet.
// Nyissa meg a második XLTX fájlt.
