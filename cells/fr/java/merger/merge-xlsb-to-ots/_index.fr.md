---
title: Fusionner XLSB avec OTS - Combiner XLSB avec OTS dans Java
url: /fr/java/merger/merge-xlsb-to-ots/ 
description: Aspose Exceller. Java Aspose.Cells. Fusionner XLSB au format de sauvegarde OTS. Java Combinez XLSB au format OTS. Fusionner XLSB avec OTS dans Java. XLSB Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLSB avec OTS dans Java" %}}

L'exemple suivant montre comment fusionner XLSB avec OTS dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLSB avec OTS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier OTS. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne XLSB avec OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner XLSB avec OTS dans Java" InputFormat="xlsb" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLSB avec OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLSB avec OTS par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner XLSB avec OTS" %}}
