---
title: Voeg XLSX samen met SQL - Combineer XLSX met SQL in C#
url: /nl/net/merger/merge-xlsx-to-sql/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online samenvoegen XLSX naar SQL-opslagformaat. C# Combineer XLSX naar SQL-indeling. Voeg XLSX samen met SQL in C#. XLSX Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLSX samen met SQL in C# online" %}}

Het volgende voorbeeld laat zien hoe u XLSX kunt samenvoegen met SQL in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSX samen te voegen met SQL. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een SQL-bestand. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat XLSX samenvoegt met SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om XLSX samen te voegen met SQL in C#" InputFormat="xlsx" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSX samen te voegen met SQL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met SQL? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLSX samen te voegen met SQL" %}}
