---
title:  Buscar y reemplazar texto en el documento XLS via Java
weight: 7900
description: Código de muestra Java para redactar información confidencial en el archivo XLS en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{< blocks/products/pf/i18n/upper-banner h1="Redactar XLS Formatos en Java" h2="Información de redacción confidencial de documentos XLS nativa y de alto rendimiento utilizando API Aspose.Cells for Java del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para redactar archivos XLS en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Redactar archivos XLS - Java" offSpacer="" %}}
