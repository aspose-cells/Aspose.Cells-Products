---
title: Python via .Net kullanarak Excel'e eğri şekil çizme veya ekleme
weight: 10
description: Python via .Net kaynak kodu, Excel'e eğri şekil eklemek için.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via .Net kullanarak eğri şekli Excel\'e ekleyin" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım olmadan Aspose.Cells\' API\'i kullanarak eğri şekil ekleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via .Net Kullanarak Excel Dosyasına Eğri Şekil Ekleme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net kullanarak Excel dosyasına eğri şekil ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfası'nı seçin.
 + Shapecollection'ın eklentisini kullanın[yöntem](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) seçili çalışma sayfasına kavisli bir şekil eklemek için.
