...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLSX menjadi JSON di C#" h2="Pustaka berkecepatan tinggi C# untuk mengkonversi XLSX ke JSON. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, JSON, dan banyak format lainnya pada Framework .NET, Core .NET, atau Platform Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  Konversikan XLSX menjadi JSON dengan memanggil metode Workbook.Save.
