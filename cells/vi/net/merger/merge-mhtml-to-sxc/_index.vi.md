---
title: Gộp MHTML vào SXC - Gộp MHTML vào SXC vào C#
url: /vi/net/merger/merge-mhtml-to-sxc/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất MHTML thành SXC saveformat. C# Kết hợp định dạng MHTML thành SXC. Hợp nhất MHTML thành SXC vào C#. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML thành SXC vào C#" %}}

Ví dụ sau đây minh họa cách hợp nhất MHTML với SXC trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất MHTML thành SXC. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SXC. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất MHTML thành SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp MHTML thành SXC trong C#" InputFormat="mhtml" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp MHTML vào SXC qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất MHTML thành SXC theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp MHTML thành SXC" %}}
