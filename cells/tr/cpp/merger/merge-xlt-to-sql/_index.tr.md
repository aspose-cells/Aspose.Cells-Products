...
url: /tr/cpp/merger/merge-xlt-to-sql/ 
...
Aşağıdaki örnek, XLT'in Aspose.Cells for C++'deki SQL ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLT'i programlı olarak SQL ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="C++ kütüphanesini SQL ile birleştirmek için XLT kütüphanesi" %}}
