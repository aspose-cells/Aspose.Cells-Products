---
title: Konwertuj MHTML na JSON przez Java 
weight: 4770

description: Przykładowy kod konwersji Java dla formatu MHTML na plik JSON. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do formatu JSON w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MHTML na JSON przez Java" h2="Konwersja MHTML do JSON Java w celu konwersji jednej lub wielu stron do formatu JSON przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na JSON przy użyciu Java" %}}

 Aby wyrenderować MHTML do JSON, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować MHTML na JSON za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik MHTML na JSON w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik MHTML z instancją klasy Workbook1. Utwórz zakres danych do wyeksportowania za pomocą Cellsmetody.createRange1. Wywołaj metodę JsonUtility.exportRangeToJson z odwołaniami do Range i ExportRangeToJsonOptions1. Zapisz dane JSON ciągu do pliku za pomocą metody BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji MHTML do JSON Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo konwersji MHTML do JSON" sectionDescription="[Konwertuj MHTML na JSON](https://products.aspose.app/cells/conversion/mhtml-to-json) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik MHTML, zostanie on natychmiast przekonwertowany do formatu JSON." >}}
