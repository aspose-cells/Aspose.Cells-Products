---
title: Voeg PRN samen met POWERPOINT - Combineer PRN met POWERPOINT in Python
url: /nl/python-net/merger/merge-prn-to-powerpoint/ 
description: Aspose Excel. Python Aspose.Cells. Gratis online PRN samenvoegen naar POWERPOINT-opslagindeling. Python Combineer PRN naar POWERPOINT formaat. Voeg PRN samen met POWERPOINT in Python. PRN samenvoegen.
...
{{% cells-merger title="Gratis online om PRN samen te voegen met POWERPOINT in Python" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="PRN samenvoegen met POWERPOINT via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PRN programmatisch samenvoegen met POWERPOINT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
