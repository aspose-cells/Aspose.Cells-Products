...
{{% blocks/products/pf/agp/feature-section-col title="C# İçinde XLS Dosyalarını Bölme Adımları" %}}
...
+ XLS dosyasını bölme için tam yol ile yükleyin.
...
+ Save() yöntemini çağırın ve dosya adını (tam yol) ve SaveFormat.Xls parametresini iletin.
...
{{% blocks/products/pf/agp/code-block title="XLS Dosyasını Böl - C#" offSpacer="" %}}
