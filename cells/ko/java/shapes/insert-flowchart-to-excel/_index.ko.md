---
title: Excel via Java에 순서도 삽입/만들기
weight: 360
description: Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells' Java API을 사용하여 순서도를 삽입/생성합니다.
keywords: [Java Aspose.Cells., Java add FlowChart., Java insert FlowChart., Java create FlowChart]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Excel via Java에 순서도 삽입/만들기" h2="Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells\' API을 사용하여 순서도를 삽입/생성합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 Excel 파일에 순서도를 삽입/생성하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Excel 파일 via Java에 흐름도를 삽입/생성하는 단계" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 +[메소드 추가](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) 선택한 워크시트에 순서도를 삽입/생성하려면
...
아래 샘플 코드는 "다중 문서"를 삽입하는 방법을 보여줍니다. 더 많은 유형에 대해서는 아래의 "블록 화살표 모양 유형 개요"를 참조하세요.

{{% blocks/products/pf/agp/code-block title="순서도 삽입/생성 - Java" offSpacer="" %}}
