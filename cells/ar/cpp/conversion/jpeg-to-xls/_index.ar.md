...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل JPEG إلى XLS في C++" h2="تحويل عالي الأداء من JPEG إلى XLS باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
تحتاج إلى تحويل JPEG ملفات إلى XLS برمجيا؟ يمكن للمطورين C++ تحويل JPEG إلى XLS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول JPEG إلى XLS باستدعاء طريقة Save ().
