---
title:  Generar Reportes en ODS Archivos via .NET
weight: 520
...
{{% blocks/products/pf/agp/content h2="Cómo generar informes basados en ODS usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para ensamblar ODS vía C#" %}}
...
1. Guarde el resultado en formato ODS a través del método WorkbookDesigner.Worbook.Save
...
{{% blocks/products/pf/agp/code-block title="Generar ODS Informes" offSpacer="" %}}
