---
title:  Szúrja be a görgetősávot (Űrlapvezérlő) az Excelbe a Python via .Net használatával
weight: 90
description: Python via .Net forráskód a ScrollBar (Űrlapvezérlő) beillesztéséhez az Excelbe.
...
{{% blocks/products/pf/agp/content h2="Görgetősáv (űrlapvezérlő) beszúrása Excel fájlba a Python via .Net használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A görgetősáv (űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python via .Net használatával" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjtemény hozzáadását[módszer](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_scroll_bar/#int-int-int-int-int-int) egy ScrollBar (Űrlapvezérlő) beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Görgetősáv beszúrása (Űrlapvezérlő) - Python via .Net" offSpacer="" %}}
