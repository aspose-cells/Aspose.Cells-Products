...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en CSV via C#" h2="Bibliothèque C# haute vitesse pour convertir XLSB en CSV. Exportez des feuilles de calcul Excel au format CSV sur .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir XLSB en CSV en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier XLSB avec une instance de Workbook
1.  Convertir XLSB en CSV en appelant la méthode Workbook.Save
