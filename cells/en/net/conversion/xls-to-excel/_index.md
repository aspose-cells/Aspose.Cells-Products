...
{{% cells-convert title="Free App and Sample Code to Convert XLS to EXCEL Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLS to EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert XLS to EXCEL in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert XLS to EXCEL" %}}
