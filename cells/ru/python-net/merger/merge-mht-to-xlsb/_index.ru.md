...
В следующем примере показано, как объединить MHT с XLSB в Aspose.Cells for Python via .NET.
...
Нужно программно объединить MHT с XLSB? Базовый документ сливается и объединяется с[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API можно реализовать всего несколькими строками кода.
