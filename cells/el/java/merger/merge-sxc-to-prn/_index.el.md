---
title: Συγχώνευση SXC σε PRN - Συνδυάστε το SXC σε PRN στο Java
url: /el/java/merger/merge-sxc-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Δωρεάν διαδικτυακή συγχώνευση SXC σε μορφή αποθήκευσης PRN. Java Συνδυάστε το SXC σε μορφή PRN. Συγχώνευση SXC στο PRN στο Java. SXC Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση SXC στο PRN στο Java Δωρεάν Online" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SXC στο PRN στο Aspose.Cells for Java.
...
{{% cells-merger title="Δωρεάν online για συγχώνευση SXC σε PRN στο Java" InputFormat="sxc" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το SXC στο PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε το SXC στο PRN μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for Java](https://products.aspose.com/cells/java) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="Java βιβλιοθήκη για συγχώνευση SXC σε PRN" %}}
