---
title: 透過 C# 在 Microsoft Excel XLSX 檔案中插入資料透視表
weight: 7690
description: C# 使用 .NET 函式庫將資料透視表新增至 XLSX 的範例程式碼。使用此程式碼將資料透視表插入 VB.NET、Asp.NET 或任何基於 .NET 的應用程式中的 XLSX 檔案。
...
在運行的應用程式中動態產生帶有資料透視表的 MS Excel XLSX 檔案非常簡單。為了使用資料透視表從頭開始建立 XLSX 文件而不需要 MS Office，我們將使用[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API，使用 .NET 平台提供電子表格建立、操作和轉換的不同功能。開發人員可以輕鬆增強用於寫入資料、生成圖表或圖形以及在電子表格中建立表格的程式碼。
{{% /blocks/products/pf/agp/content %}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="如何透過 C# 在 XLSX 中插入資料透視表" %}}

{{% blocks/products/pf/agp/text %}}

開發人員只需幾行程式碼即可輕鬆在執行不同的報表應用程式中插入 XLSX 格式電子表格的資料透視表以進行資料處理。
...
{{% blocks/products/pf/agp/code-block title="在 XLSX - C# 中插入資料透視表" offSpacer="" %}}
