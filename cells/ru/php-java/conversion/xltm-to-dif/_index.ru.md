...
description: Aspose Эксель. Преобразуйте XLTM в DIF быстро и легко с помощью Aspose.Cells. PHP XLTM в DIF. PHP Сохраните XLTM в DIF. Сохраните XLTM как DIF с помощью PHP.
...
Нужно программно преобразовать файлы XLTM в DIF? Разработчики PHP могут легко загрузить и преобразовать XLTM в DIF всего за несколько строк кода.
...
1.  Преобразуйте XLTM в DIF, вызвав метод сохранения книги.
1.  Получите результат преобразования XLTM в DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования XLTM в DIF" %}}
