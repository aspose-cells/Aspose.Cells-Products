...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى XLSX باستخدام Java" %}}

 من أجل تقديم XLS إلى XLSX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLS إلى XLSX عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف XLS إلى XLSX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف XLS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XLSX & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XLSX الناتج
...
{{% blocks/products/pf/agp/code-block title="XLS إلى XLSX Java شفرة مصدر التحويل" offSpacer="" %}}
