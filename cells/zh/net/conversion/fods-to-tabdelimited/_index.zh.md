...
{{% blocks/products/pf/agp/content h2="免费在线保存 FODS 到 C# 中的 TABDELIMITED" %}}

以下示例演示如何将 FODS 转换为 C# 中的 TABDELIMITED。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 FODS 转换为 TABDELIMITED。上传您的 FODS 文件，然后将其保存为 TABDELIMITED 文件。对于 FODS 读取和 TABDELIMITED 写入，您可以使用完全限定的文件名。输出的 TABDELIMITED 内容和格式将与原始 FODS 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 FODS 在线转换为 TABDELIMITED 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 FODS 转换为 TABDELIMITED" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载 FODS 并将其转换为 TABDELIMITED。
