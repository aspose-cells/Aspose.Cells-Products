---
title: Converter SXC para XLAM via Python
url: /pt/python-java/conversion/sxc-to-xlam/
description: Código de exemplo para conversão de sxc para xlam Python. Use API código de exemplo para arquivos sxc em lote para conversão xlam no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter SXC para XLAM usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC para XLAM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para XLAM em apenas algumas linhas de código.
