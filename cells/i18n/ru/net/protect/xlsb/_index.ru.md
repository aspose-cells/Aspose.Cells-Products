---
title: Защитите и заблокируйте документ XLSB через .NET 
weight: 5920
url: /ru/net/protect/xlsb/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Шифровать файлы XLSB с помощью C#" h2="Защищайте паролем электронные таблицы Excel, включая формат XLSB, с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1. Создать экземпляр класса Workbook с путем к файлу XLSB1. Получите стандартный или любой рабочий лист, чтобы добавить защиту1. Защитите рабочий лист с помощью метода Worksheet.Protect1. Защитите книгу с помощью метода Workbook.Protect1. Сохранить результат в формате XLSB
