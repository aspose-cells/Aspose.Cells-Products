...
description: Aspose Excel. C# Aspose.Cells. Voeg XLSX samen naar PRN-opslagformaat. C# Combineer XLSX naar PRN-formaat. Voeg XLSX samen met PRN in C#. XLSX Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u XLSX samenvoegt met PRN via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
