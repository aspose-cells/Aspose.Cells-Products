---
title: PHP XLTM إلى TIFF - XLTM إلى TIFF محول
description: Aspose اكسل. قم بتحويل XLTM إلى TIFF بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى TIFF. PHP احفظ XLTM إلى TIFF. احفظ XLTM كـ TIFF باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى TIFF عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى TIFF برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى TIFF بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى TIFF عن طريق استدعاء طريقة حفظ المصنف.
