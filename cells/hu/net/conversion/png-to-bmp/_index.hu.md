---
title: C# PNG - BMP - PNG - BMP Átalakító
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára a PNG formátum BMP formátumba konvertálásához, lehetővé téve a PNG adatok zökkenőmentes mentését BMP formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a PNG-et BMP-re a C#-ben" %}}

következő példa bemutatja, hogyan lehet a PNG számot BMP-re konvertálni a C# számrendszerben.
...
{{% blocks/products/pf/agp/content h2="A PNG konvertálása BMP-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

PNG fájlt programozottan BMP-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a PNG-et BMP-re.
...
1.  Alakítsd át a PNG számot BMP-re a Workbook.Save metódus meghívásával.
1.  Szerezze meg a PNG-es konverziós eredményt BMP-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a PNG-ről BMP-re konvertáláshoz" %}}
