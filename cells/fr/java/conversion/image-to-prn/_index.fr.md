---
title: Java IMAGE en PRN - Convertisseur IMAGE en PRN
description: Aspose Exceller. Convertissez IMAGE en PRN rapidement et facilement avec Aspose.Cells. Java IMAGE en PRN. Java Enregistrez l’IMAGE sur PRN. Enregistrez l'IMAGE au format PRN en utilisant le Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE dans le PRN au Java" %}}

L'exemple suivant montre comment convertir IMAGE en PRN dans Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir IMAGE en PRN. Téléchargez votre fichier IMAGE, puis enregistrez-le simplement en tant que fichier PRN. Pour la lecture d'IMAGE et l'écriture PRN, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage du PRN de sortie seront identiques au document IMAGE d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir IMAGE en PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir IMAGE en PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE en PRN par programme ? Les développeurs Java peuvent facilement convertir IMAGE en PRN en quelques lignes de code seulement.
...
1. Obtenez le résultat de la conversion d'IMAGE en PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en PRN" %}}
{{% blocks/products/pf/agp/text %}}
