---
title: C++ XLS a JSON - XLS a JSON Conversor
description: Aspose Excel. Converta XLS em JSON de forma rápida e fácil com Aspose.Cells. C++ XLS em JSON. C++ Salve XLS em JSON. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Salve XLS para JSON em C++" %}}

O exemplo a seguir demonstra como converter XLS em JSON em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="json" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em JSON por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em JSON programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em JSON em apenas algumas linhas de código.
...
1.  Converta XLS em JSON chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em JSON" %}}
