...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar XLSX met Aspose.Cells. Python OTS naar XLSX. Python Bewaar OTS naar XLSX. Sla OTS op als XLSX met Python.
...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar XLSX in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar OTS op XLSX in Python" %}}

Het volgende voorbeeld laat zien hoe u OTS converteert naar XLSX in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om OTS naar XLSX te converteren" %}}
