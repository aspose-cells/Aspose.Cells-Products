---
title:  Tạo báo cáo trong ODS Tệp via .NET
weight: 520
description: Mã nguồn C# để tạo báo cáo định dạng ODS trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Các Bước Lắp Ráp ODS qua C#" %}}
...
1. Lưu kết quả ở định dạng ODS thông qua phương thức WorkbookDesigner.Worbook.Save
