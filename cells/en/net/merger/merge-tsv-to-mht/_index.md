...
description: C# source code to combine TSV to MHT file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="How to Merge TSV to MHT File Using C#" %}}
 ...
 In order to merge TSV to MHT file, we’ll use
...
{{% blocks/products/pf/agp/code-block title="Merge TSV to MHT Files - C#" offSpacer="" %}}
