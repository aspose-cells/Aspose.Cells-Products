---
title: Konwertuj NUMBERS na DIF przez Python
url: /pl/python-java/conversion/numbers-to-dif/
description: Przykładowy kod liczb do różnicowania konwersji Python. Użyj przykładowego kodu API dla plików numerów partii, aby dokonać konwersji różnic w aplikacji Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować NUMBERS na DIF za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować NUMBERS na DIF za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki NUMBERS na DIF w zaledwie kilku linijkach kodu.
