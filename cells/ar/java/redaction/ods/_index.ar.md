---
title:  بحث واستبدال النص في ODS مستند via Java
weight: 9210
description: نموذج التعليمات البرمجية Java لتنقيح المعلومات الحساسة في ملف ODS على Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تنقيح ODS الملفات في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="تنقيح ODS ملفات - Java" offSpacer="" %}}
