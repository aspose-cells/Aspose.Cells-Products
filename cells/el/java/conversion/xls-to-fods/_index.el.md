---
title: Java XLS έως FODS - XLS έως FODS Μετατροπέας
description: Aspose Excel. Μετατρέψτε το XLS στο FODS γρήγορα και εύκολα με το Aspose.Cells. Java XLS σε FODS. Java Αποθήκευση 076183419 ως 076183419 στο 076183419 στο 076183419 στο XLS. 113481 χρησιμοποιώντας Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή XLS σε FODS στο Java" h2="Βιβλιοθήκη υψηλής ταχύτητας Java για μετατροπή XLS σε FODS. Αυτή είναι μια επαγγελματική λύση λογισμικού για εισαγωγή και εξαγωγή XLS, FODS και πολλών άλλων μορφών χρησιμοποιώντας το Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση XLS έως FODS στο Java" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το XLS σε FODS στο Java.
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το XLS σε FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να μετατρέψετε αρχεία XLS σε FODS μέσω προγραμματισμού; Οι προγραμματιστές Java μπορούν εύκολα να μετατρέψουν το XLS σε FODS σε λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="Java βιβλιοθήκη για μετατροπή XLS σε FODS" %}}
{{% blocks/products/pf/agp/text %}}
