---
title: Convertir HTML en FODS Python via Python
description: Convertissez HTML en FODS en ligne gratuitement. Convertisseur en ligne gratuit HTML à FODS. Python HTML à FODS. HTML à FODS via Python.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Python peuvent facilement charger et convertir HTML en FODS en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier HTML avec une instance de Workbook
1.  Convertir HTML en FODS en appelant la méthode Workbook.save
