---
title:  ابحث عن مستند TXT بدون فتح via Java
weight: 1200
description: نموذج التعليمات البرمجية Java للبحث عن الكلمات ذات النمط في ملف TXT على Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/content h2="كيفية البحث عن ملف TXT باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث عن الملفات TXT في Java" %}}
...
+ تحميل ملف TXT عن طريق إنشاء كائن مصنف.
+ الوصول إلى ورقة العمل الأولى في الملف TXT.
...
{{% blocks/products/pf/agp/code-block title="بحث TXT ملفات - Java" offSpacer="" %}}
