...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSX na DOCX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki XLSX do formatu DOCX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSX z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem DOCX jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku DOCX
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSX na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="docx" IsLandingPage="true" %}}
