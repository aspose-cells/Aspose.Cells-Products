...
Perlu mengonversi file XML ke SQL secara terprogram? Pengembang C++ dapat dengan mudah mengonversi XML ke SQL hanya dalam beberapa baris kode.
...
1.  Konversi XML ke SQL dengan memanggil metode Save().
