---
title:  ใส่ปุ่มหมุน (ตัวควบคุมฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 40
description: Python via ซอร์สโค้ด .Net เพื่อแทรกปุ่มหมุน (ตัวควบคุมฟอร์ม) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกปุ่มหมุน (ตัวควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการใส่ Spin Button (Form control) ให้กับไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_spinner/#int-int-int-int-int-int) เพื่อแทรกปุ่มหมุน (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่ปุ่มหมุน (ตัวควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
