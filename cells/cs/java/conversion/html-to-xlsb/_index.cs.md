---
title: Převést HTML na XLSB přes Java 
weight: 30

description: Ukázkový konverzní kód Java pro formát HTML na soubor XLSB. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLSB v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést HTML na XLSB přes Java" h2="Převod HTML na XLSB Java pro převod jedné nebo více stránek na XLSB pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na XLSB pomocí Java" %}}

 K vykreslení HTML do XLSB použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu HTML na XLSB prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor HTML na XLSB pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor HTML s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLSB a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLSB
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze HTML na XLSB Java" offSpacer="" %}}

```cs
// načíst soubor HTML v instanci sešitu
Workbook book = new Workbook("template.html");
// uložit HTML jako XLSB
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze HTML na XLSB" sectionDescription="[Převést HTML na XLSB](https://products.aspose.app/cells/conversion/html-to-xlsb) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj HTML soubor, bude okamžitě převeden na XLSB." >}}
