...
Ví dụ sau minh họa cách hợp nhất MHT thành XLTM trong Aspose.Cells for Python via Java.
...
Cần hợp nhất MHT thành XLTM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API có thể được thực hiện chỉ với vài dòng mã.
