...
O gráfico Open-High-Low-Close (OHLC) usa cinco colunas de dados, em ordem: categoria, abertura, alta, baixa e fechamento. A faixa de preços em cada categoria é novamente indicada por uma linha vertical, enquanto a faixa entre abertura e fechamento é dada por uma barra flutuante mais larga; se o preço aumentar na categoria (o fechamento for maior que a abertura), a barra será preenchida com uma cor, enquanto se o preço diminuir, a barra será preenchida com outra. Esse tipo de gráfico costuma ser chamado de gráfico de velas.
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Como criar gráficos de velas (estoque aberto-alto-baixo-fechamento) via C#" %}}
...
1.  Criar[**Pasta de trabalho**](https://reference.aspose.com/cells/net/aspose.cells/workbook) instância de classe por[exemplo de arquivo Excel](Open-High-Low-Close.xlsx).
1.  Adicione um[**Estoque aberto-alto-baixo-fechamento**](https://reference.aspose.com/cells/net/aspose.cells.charts/charttype) Gráfico para a planilha chamando o[**Gráficos**](https://reference.aspose.com/cells/net/aspose.cells.charts/chartcollection) coleção[**Adicionar**](https://reference.aspose.com/cells/net/aspose.cells.charts/chartcollection/methods/add) método, encapsulado no[**Planilha**](https://reference.aspose.com/cells/net/aspose.cells/worksheet)objeto.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="O código-fonte a seguir mostra como criar um gráfico Candlestick (estoque aberto-alto-baixo-fechamento) para o arquivo MS Excel XLSX usando C#." offSpacer="" %}}
