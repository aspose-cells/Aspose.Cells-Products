---
title: Voeg XLSM samen met PRN - Combineer XLSM met PRN in Java
url: /nl/java/merger/merge-xlsm-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online samenvoegen XLSM naar PRN-opslagformaat. Java Combineer XLSM naar PRN-formaat. Samenvoegen XLSM naar PRN in Java. XLSM Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSM samen te voegen met PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSM samen te voegen met PRN" %}}
