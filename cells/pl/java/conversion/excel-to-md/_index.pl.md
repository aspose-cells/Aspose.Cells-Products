...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL do MD w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować format EXCEL na MD w formacie Java.
...
{{% cells-convert title="Przykładowy kod do konwersji pliku EXCEL na MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu MD? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu MD za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA do MD" %}}
{{% blocks/products/pf/agp/text %}}
