...
description: Aspose एक्सेल। C# Aspose.Cells. नंबरों को BMP सेवफॉर्मेट में मर्ज करें। C# संख्याओं को BMP प्रारूप में संयोजित करें। C# में नंबरों को BMP में मिलाएं। नंबरों को मिलाएं।
...
{{% blocks/products/pf/agp/content h2="C# में नंबरों को BMP में मिलाएं" %}}

निम्नलिखित उदाहरण दर्शाता है कि Aspose.Cells for .NET में NUMBERS को BMP में कैसे मर्ज किया जाए।
...
{{% cells-merger title="C# में नंबरों को BMP में मर्ज करने के लिए नमूना कोड" InputFormat="numbers" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
