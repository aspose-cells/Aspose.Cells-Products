...
description: Aspose Excel. Convierta PRN a SVG rápida y fácilmente con Aspose.Cells. Python PRN a SVG. Python Guarde PRN en SVG. Guarde PRN como SVG usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar PRN al SVG en Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a SVG en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir PRN a SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="svg" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir PRN a SVG" %}}
