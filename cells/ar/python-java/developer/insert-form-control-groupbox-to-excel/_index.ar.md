---
title:  أدخل GroupBox (التحكم في النموذج) في Excel باستخدام Python via java
weight: 40
description: Python via كود مصدر جافا لإدراج GroupBox (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج GroupBox (التحكم في النموذج) في ملف Excel باستخدام Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج GroupBox (التحكم في النموذج) إلى ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addGroupBox(int,%20int,%20int,%20int,%20int,%20int)) لإدراج GroupBox (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل GroupBox (التحكم في النموذج) - Python via java" offSpacer="" %}}
