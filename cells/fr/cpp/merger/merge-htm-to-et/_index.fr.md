---
title: Fusionner HTM à ET - Combiner HTM à ET dans C++
url: /fr/cpp/merger/merge-htm-to-et/ 
description: Aspose Excel. C++ Aspose.Cells. Format de sauvegarde de fusion HTM en ET gratuit en ligne. C++ Combinez le format HTM au format ET. Fusionner HTM à ET dans C++. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM à ET dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner HTM avec ET dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner HTM à ET. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier ET. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne HTM avec ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner HTM à ET en C++" InputFormat="htm" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM à ET via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTM à ET par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner HTM à ET" %}}
