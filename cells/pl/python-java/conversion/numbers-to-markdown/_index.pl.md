...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj NUMBERS na MARKDOWN za pomocą Python" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu MARKDOWN przy użyciu Python interfejsów API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować NUMBERS na MARKDOWN za pomocą Python" %}}

 Aby przekonwertować NUMBERS na MARKDOWN, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować NUMBERS na MARKDOWN za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki NUMBERS na MARKDOWN w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik NUMBERS z wystąpieniem skoroszytu1. Wywołaj metodę Workbook.Save1. Przepuścić ścieżkę wyjściową z rozszerzeniem MD jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku MARKDOWN
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji NUMBERS na MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="md" IsLandingPage="true" language="python" %}}
