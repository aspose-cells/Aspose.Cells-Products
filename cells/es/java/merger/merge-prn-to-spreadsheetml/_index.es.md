---
title: Combine PRN con SPREADSHEETML - Combine PRN con SPREADSHEETML en Java
url: /es/java/merger/merge-prn-to-spreadsheetml/ 
description: AsposeExcel. Java Aspose.Cells. Gratuito en línea Combinar PRN a SPREADSHEETML saveformat. Java Combine PRN con el formato SPREADSHEETML. Combinar PRN con SPREADSHEETML en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN con SPREADSHEETML en Java en línea de forma gratuita" %}}

El siguiente ejemplo muestra cómo combinar PRN con SPREADSHEETML en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar PRN con SPREADSHEETML. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo SPREADSHEETML. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona PRN con SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para combinar PRN con SPREADSHEETML en Java" InputFormat="prn" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo combinar PRN con SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar PRN con SPREADSHEETML mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar PRN con SPREADSHEETML" %}}
