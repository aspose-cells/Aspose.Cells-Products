...
url: /pl/net/merger/merge-image-to-htm/ 
...
Poniższy przykład pokazuje, jak połączyć IMAGE z HTM w Aspose.Cells for .NET.
...
Chcesz programowo scalić IMAGE z HTM? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia IMAGE z HTM" %}}
