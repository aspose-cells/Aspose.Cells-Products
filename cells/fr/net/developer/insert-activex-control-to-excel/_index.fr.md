...
weight: 10
description: Code source C# pour insérer le contrôle ActiveX dans Excel sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/content h2="Comment insérer un contrôle ActiveX dans un fichier Excel à l\'aide de C#" %}}
 ...
 Afin d'insérer le contrôle ActiveX dans un fichier Excel, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer le contrôle ActiveX dans un fichier Excel via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Insérer un contrôle ActiveX - C#" offSpacer="" %}}
