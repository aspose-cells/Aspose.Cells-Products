...
description: Aspose Exceller. Convertissez des NUMBERS en XML rapidement et facilement avec Aspose.Cells. C# NUMBERS en XML. C# Enregistrez les NUMÉROS au format XML. Enregistrez NUMBERS au format XML en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer les NUMÉROS au format XML dans C#" %}}

L'exemple suivant montre comment convertir NUMBERS en XML dans C#.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir des NUMBERS en XML" %}}
