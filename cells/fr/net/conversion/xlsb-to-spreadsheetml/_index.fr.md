---
title: C# XLSB en SPREADSHEETML - Convertisseur en ligne XLSB en SPREADSHEETML
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir XLSB en format de sauvegarde SPREADSHEETML. C# XLSB au format SPREADSHEETML. Enregistrez XLSB dans SPREADSHEETML C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB dans SPREADSHEETML dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en SPREADSHEETML dans C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en SPREADSHEETML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en SPREADSHEETML par programmation ? Les développeurs .NET peuvent facilement charger et convertir XLSB en SPREADSHEETML en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="bibliothèque C# pour convertir XLSB en SPREADSHEETML" %}}
