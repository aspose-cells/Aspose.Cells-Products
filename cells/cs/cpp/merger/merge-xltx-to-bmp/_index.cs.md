...
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma XLTX do formátu uložení BMP. C++ Kombinujte formát XLTX až BMP. Sloučit XLTX až BMP v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX až BMP v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLTX až BMP v Aspose.Cells for C++.
...
{{% cells-merger title="Online zdarma ke sloučení XLTX až BMP v C++" InputFormat="xltx" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
