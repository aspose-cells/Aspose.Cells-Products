---
title: Gộp PRN sang OTS - Gộp PRN sang OTS trong C#
url: /vi/net/merger/merge-prn-to-ots/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí PRN sang định dạng lưu OTS. C# Gộp định dạng PRN sang OTS. Hợp nhất PRN với OTS theo số C#. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN với OTS trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất PRN với OTS trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất PRN với OTS. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp OTS. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất PRN với OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất PRN với OTS trong C#" InputFormat="prn" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất PRN với OTS qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất PRN với OTS theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất PRN với OTS" %}}
