---
title: تحويل Java HTM إلى FODS - تحويل HTM إلى FODS
description: Aspose اكسل. قم بتحويل HTM إلى FODS بسرعة وسهولة باستخدام Aspose.Cells. Java HTM إلى FODS. Java احفظ HTM إلى FODS. احفظ HTM كـ FODS باستخدام Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل HTM إلى FODS في Java" h2="مكتبة Java عالية السرعة لتحويل HTM إلى FODS. هذا حل برمجي احترافي لاستيراد وتصدير HTM وFODS والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في FODS في Java" %}}

يوضح المثال التالي كيفية تحويل HTM إلى FODS في Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل HTM إلى FODS. قم بتحميل ملف HTM الخاص بك، ثم احفظه كملف FODS. لكل من قراءة HTM وكتابة FODS، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق الإخراج FODS مطابقًا لمستند HTM الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="نموذج التعليمات البرمجية لتحويل HTM إلى FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="fods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل HTM إلى FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات HTM إلى FODS برمجياً؟ يمكن لمطوري Java تحويل HTM بسهولة إلى FODS في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل HTM إلى FODS عن طريق استدعاء أسلوب Workbook.save.
1.  احصل على نتيجة تحويل HTM إلى FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل HTM إلى FODS" %}}
{{% blocks/products/pf/agp/text %}}
