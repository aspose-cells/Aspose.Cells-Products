---
title: SPREADSHEETML'yi SPREADSHEETML ile birleştirin - SPREADSHEETML'yi SPREADSHEETML ile Java'de birleştirin
url: /tr/java/merger/merge-spreadsheetml-to-spreadsheetml/ 
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi SPREADSHEETML'yi SPREADSHEETML kaydetme biçimiyle birleştirme. Java SPREADSHEETML'yi SPREADSHEETML biçimiyle birleştirin. Java'de SPREADSHEETML'yi SPREADSHEETML ile birleştirin. SPREADSHEETML Birleştir.
...
{{% blocks/products/pf/agp/content h2="Java\'de SPREADSHEETML\'yi SPREADSHEETML ile Ücretsiz Olarak Çevrimiçi Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de SPREADSHEETML'nin SPREADSHEETML ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

SPREADSHEETML'yi SPREADSHEETML ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından SPREADSHEETML dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. SPREADSHEETML ile SPREADSHEETML'yi birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java\'de SPREADSHEETML\'yi SPREADSHEETML ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'yi SPREADSHEETML via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 SPREADSHEETML'yi SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'yi SPREADSHEETML ile birleştirmek için Java kitaplığı" %}}
