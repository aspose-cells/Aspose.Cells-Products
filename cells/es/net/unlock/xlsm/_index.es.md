---
title: Desbloquear documento XLSM a través de .NET 
weight: 9810
url: /es/net/unlock/xlsm/ 
description: C# código fuente para desbloquear el archivo XLSM protegido con contraseña en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloquee la hoja de cálculo XLSM a través de C#" h2="Elimina la protección de XLSM usando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Cómo desbloquear un archivo XLSM usando C#" %}}

 Para eliminar el archivo XLSM de protección, usaremos
...
1. Instanciar la clase Workbook con la ruta al archivo XLSM protegido1. Obtenga el valor predeterminado o cualquier hoja de trabajo para eliminar la protección1. Eliminar la protección de la hoja de trabajo con el método Worksheet.Unprotect1. Eliminar la protección del libro de trabajo con el método Workbook.Unprotect1. Guardar resultado en formato XLSM
...
// crear una instancia de un objeto Workbook con un archivo XLSM protegido
...
// guardar el resultado de nuevo en formato XLSM
