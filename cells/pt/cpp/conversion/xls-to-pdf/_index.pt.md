---
title: C++ XLS a PDF - XLS a PDF Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato PDF, permitindo o salvamento perfeito de dados XLS no formato PDF usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLS a PDF em C++" %}}

exemplo a seguir demonstra como converter XLS em PDF em C++.
...
{{% blocks/products/pf/agp/content h2="Como converter XLS em PDF por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para PDF programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para PDF com apenas algumas linhas de código.
...
1.  Converta XLS para PDF chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em PDF" %}}
