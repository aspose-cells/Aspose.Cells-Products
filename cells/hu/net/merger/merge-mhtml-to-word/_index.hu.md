...
A következő példa bemutatja, hogyan lehet egyesíteni a MHTML-et a WORD-dal a Aspose.Cells-es for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a MHTML-et a WORD-dal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML és a WORD egyesítéséhez" %}}
