---
title:  Unisci CSV a JSON tramite C#
url: /it/net/merger/merge-csv-to-json/ 
description: Unisci CSV a JSON online gratuitamente. Gratuito Online CSV a JSON Fusione. Unisci CSV a Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e altro ancora.
---
...
L'esempio seguente mostra come unire CSV a JSON in C#.
...
{{% cells-merger title="App gratuita per unire on line lo CSV allo JSON" InputFormat="csv" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
