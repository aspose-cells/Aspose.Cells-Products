...
url: /cs/python-net/merger/merge-mht-to-xlsx/ 
...
Následující příklad ukazuje, jak sloučit MHT s XLSX v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit MHT na XLSX programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
