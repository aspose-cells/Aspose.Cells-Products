---
title: C# XLS bis JSON - XLS bis JSON Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis JSON in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in C# in JSON umwandelt.
...
{{% cells-convert title="Beispielcode zur Umwandlung von XLS in JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in JSON" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in JSON konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in JSON laden und konvertieren.
...
1.  Konvertieren Sie XLS in JSON durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in JSON" %}}
