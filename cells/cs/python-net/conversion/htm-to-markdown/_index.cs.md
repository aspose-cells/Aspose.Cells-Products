...
Následující příklad ukazuje, jak převést HTM na MARKDOWN v Python via NET.
...
{{% blocks/products/pf/agp/content h2="Jak převést HTM na MARKDOWN" %}}
