...
+ Laad alle XLSM-bestanden met volledig pad.
...
+ Roep de Save()-methode aan en geef de bestandsnaam (volledig pad) en formaat (XLSM) door als parameter.
...
{{% blocks/products/pf/agp/code-block title="XLSM-bestanden samenvoegen - C#" offSpacer="" %}}
