---
title: Python FODS 至 JSON - FODS 至 JSON 轉換器
description: Aspose Excel。 Python Excel。使用 Aspose.Cells 快速輕鬆地將 FODS 轉換為 JSON。Python FODS 轉換為 JSON。Python 將 076193417619301 將存 076112第3481章 使用Python Excel庫。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Python Excel 庫中的 FODS 轉換為 JSON" h2="高速 Python Excel 庫，用於將 FODS 轉換為 JSON。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將 Python Excel 庫中的 FODS 轉換為 JSON" %}}

如何將 FODS 轉換為 JSON？使用 Aspose.Cells for Python via NET 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 FODS 轉換為 JSON。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 Python Excel 庫中 JSON" %}}

下面的範例示範如何在Python Excel庫中將FODS轉換為JSON。
...
{{% cells-convert title="透過 Python Excel 函式庫將 FODS 轉換為 JSON 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="json" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為 JSON" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 檔案轉換為 JSON 嗎？ Python 開發人員只需幾行程式碼即可輕鬆載入和轉換 FODS 到 JSON。
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 FODS 轉換為 JSON" %}}
