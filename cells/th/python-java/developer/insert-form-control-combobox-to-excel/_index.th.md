---
title:  แทรก ComboBox (การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via java
weight: 20
description: Python via ซอร์สโค้ด Java เพื่อแทรก ComboBox(การควบคุมแบบฟอร์ม) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก ComboBox (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}

 เพื่อที่จะแทรก ComboBox(Form control) ลงในไฟล์ Excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแทรก ComboBox (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้รูปทรงของคอลเลกชัน[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรก ComboBox(Form control) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก ComboBox(การควบคุมแบบฟอร์ม) - Python via java" offSpacer="" %}}
