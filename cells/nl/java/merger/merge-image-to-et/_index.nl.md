---
title: Voeg IMAGE samen met ET - Combineer IMAGE met ET in Java
url: /nl/java/merger/merge-image-to-et/ 
description: Aspose Excel. Java Aspose.Cells. IMAGE samenvoegen naar ET-opslagformaat. Java Combineer IMAGE naar ET-formaat. Voeg IMAGE samen met ET in Java. IMAGE samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg AFBEELDING samen met ET in Java" %}}

Het volgende voorbeeld laat zien hoe u IMAGE kunt samenvoegen met ET in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om IMAGE samen te voegen met ET. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een ET-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java waarin IMAGE wordt samengevoegd met ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om IMAGE samen te voegen met ET in Java" InputFormat="png" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe IMAGE samen te voegen met ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u IMAGE programmatisch samenvoegen met ET? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om IMAGE samen te voegen met ET" %}}
