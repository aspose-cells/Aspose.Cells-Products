...
url: /pl/net/create-mhtml/ 
description: C# Przykładowy kod do generowania dokumentów MHTML. Użyj tego kodu do tworzenia plików MHTML w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Twórz dokumenty MHTML za pomocą C#" h2="Natywne i wysokowydajne tworzenie MHTML programistyczne przy użyciu interfejsów API .NET po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Dynamiczne generowanie pliku MHTML w uruchomionej aplikacji jest łatwe. Aby tworzyć dokumenty MHTML od podstaw bez konieczności korzystania z pakietu MS Office, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Jak utworzyć MHTML za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 Deweloperzy mogą łatwo tworzyć, ładować, modyfikować i konwertować MHTML w ramach uruchamiania różnych aplikacji do raportowania w celu przetwarzania danych w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Dołącz przestrzeń nazw do pliku klasy1. Utwórz instancję klasy Workbook.1. Uzyskaj dostęp do pierwszego arkusza roboczego skoroszytu.1. Pobierz żądane komórki arkusza roboczego i wprowadź wartość do komórki (komórek).1. Użyj metody Save, aby zapisać skoroszyt jako plik MHTML.
...
{{% blocks/products/pf/agp/code-block title="Poniższy kod źródłowy pokazuje, jak utworzyć plik MHTML przy użyciu C#." offSpacer="" %}}
...
// Zapisz skoroszyt jako plik .mhtml.
