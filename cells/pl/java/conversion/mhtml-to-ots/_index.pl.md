---
title: Java MHTML na OTS - MHTML na konwerter OTS
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji MHTML do formatu OTS, umożliwiając bezproblemowe zapisywanie danych MHTML w formacie OTS przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHTML do OTS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować MHTML na OTS w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować MHTML na OTS. Prześlij plik MHTML, a następnie po prostu zapisz go jako plik OTS. Zarówno do odczytu MHTML, jak i do zapisu OTS, możesz używać w pełni kwalifikowanych nazw plików. Wyjściowa treść i formatowanie OTS będą identyczne z oryginalnym dokumentem MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji MHTML na OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mhtml" outformat="ots" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki MHTML do formatu OTS? Programiści Java mogą łatwo przekonwertować pliki MHTML do formatu OTS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj MHTML na OTS, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji MHTML na OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji MHTML na OTS" %}}
{{% blocks/products/pf/agp/text %}}
