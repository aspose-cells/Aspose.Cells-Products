---
title: Converti XLSM in CSV tramite Java 
weight: 9910

description: Esempio di codice di conversione Java per il formato XLSM in file CSV. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in CSV all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLSM in CSV tramite Java" h2="Conversione da XLSM a CSV Java per convertire pagine singole o multiple in CSV utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire XLSM in CSV utilizzando Java" %}}

 Per rendere XLSM in CSV, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire XLSM in CSV tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente file XLSM in CSV in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLSM con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con estensione CSV e SaveFormat come parametri1. Controllare il percorso specificato per il file CSV risultante
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLSM a CSV Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live di conversione da XLSM a CSV" sectionDescription="[Converti XLSM in CSV](https://products.aspose.app/cells/conversion/xlsm-to-csv) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file XLSM, verrà convertito istantaneamente in CSV." >}}
