---
title: Python OTS sang PRN - Công cụ chuyển đổi OTS sang PRN
description: Aspose Excel. Giải pháp toàn diện này cung cấp cho các nhà phát triển Python một phương pháp tích hợp đầy đủ để chuyển đổi định dạng OTS sang định dạng PRN, cho phép lưu dữ liệu OTS vào định dạng PRN một cách liền mạch bằng thư viện Aspose.Cells, tất cả thông qua mã Python hiệu quả và có thể tùy chỉnh.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi OTS sang PRN trong Thư viện Excel Python" h2="Thư viện excel Python tốc độ cao để chuyển đổi OTS sang PRN. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất OTS, PRN và nhiều định dạng khác bằng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi OTS sang PRN bằng Thư viện Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu OTS vào PRN trong Thư viện Excel Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi OTS sang PRN trong thư viện excel Python.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để chuyển đổi OTS sang PRN. Tải lên tệp OTS của bạn, sau đó chỉ cần lưu nó dưới dạng tệp PRN. Đối với cả việc đọc OTS và ghi PRN, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng PRN đầu ra sẽ giống hệt với tài liệu OTS gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mã mẫu chuyển đổi OTS sang PRN qua Python Thư viện Excel" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="prn" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi OTS sang PRN qua Python" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tệp OTS sang PRN theo chương trình? Các nhà phát triển Python có thể dễ dàng tải và chuyển đổi OTS sang PRN chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi OTS sang PRN bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi từ OTS sang PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Thư viện Excel để chuyển đổi OTS sang PRN" %}}
