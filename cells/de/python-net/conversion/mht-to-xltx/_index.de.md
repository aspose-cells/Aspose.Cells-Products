...
description: Aspose Excel. Konvertieren Sie MHT schnell und einfach in XLTX mit Aspose.Cells. Python MHT in XLTX. Python Speichern Sie MHT in XLTX. Speichern Sie MHT als XLTX mit Python.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie MHT unter XLTX in Python" %}}
...
{{% cells-convert title="Beispielcode zum Konvertieren von MHT in XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xltx" IsLandingPage="true" language="pythonnet" %}}
