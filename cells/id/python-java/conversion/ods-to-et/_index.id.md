...
description: Aspose Unggul. Ubah ODS menjadi ET dengan cepat dan mudah dengan Aspose.Cells. Python ODS menjadi ET. Python Simpan ODS ke ET. Simpan ODS sebagai ET menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke ET di Python" %}}

Contoh berikut menunjukkan cara mengonversi ODS ke ET di Python.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengonversi ODS ke ET" %}}
