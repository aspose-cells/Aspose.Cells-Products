...
description: Sample code for xlsx to jpg C# conversion. Use API example code for batch xlsx files to jpg conversion within VB.NET, Asp.NET or any .NET based application.
---
