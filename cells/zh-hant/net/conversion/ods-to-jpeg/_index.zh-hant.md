---
title: C# ODS 轉 JPEG - 在線 ODS 轉 JPEG 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 ODS 轉換為 JPEG 保存格式。 C# ODS 到 JPEG 格式。將 ODS 保存為 JPEG C#。
...
{{% blocks/products/pf/agp/content h2="免費在線保存 ODS 至 JPEG 於 C#" %}}

以下示例演示如何將 C# 中的 ODS 轉換為 JPEG。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 ODS 轉換為 JPEG。上傳您的 ODS 文件，然後只需將其另存為 JPEG 文件。對於 ODS 讀取和 JPEG 寫入，您可以使用完全限定的文件名。輸出 JPEG 內容和格式將與原始 ODS 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 ODS 轉換為 JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 ODS 轉換為 JPEG" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 ODS 文件轉換為 JPEG 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 ODS 到 JPEG。
...
1. 使用工作簿實例加載 ODS 文件。
1. 通過調用 Workbook.Save 方法將 ODS 轉換為 JPEG。
1. 獲取ODS到JPEG的轉換結果。
