---
title: C# EXCEL-ből SQL-be - EXCEL-ből SQL-be konvertáló
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az EXCEL SQL formátumba konvertálásához, lehetővé téve az EXCEL adatok zökkenőmentes mentését SQL formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="EXCEL mentése SQL-be a C#-es címen" %}}

A következő példa bemutatja, hogyan lehet EXCEL-t SQL-lé konvertálni a C#-es verzióban.
...
{{% cells-convert title="Mintakód az EXCEL SQL-be konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hogyan lehet EXCEL-t SQL-re konvertálni a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia az EXCEL fájlokat SQL-be? .NET A fejlesztők egyszerűen betölthetik és néhány sornyi kóddal konvertálhatják az EXCEL-t SQL-be.
...
1.  EXCEL-t SQL-lé konvertálhatsz a Workbook.Save metódus meghívásával.
1.  Szerezd meg az EXCEL SQL-re való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár EXCEL SQL-be konvertálásához" %}}
