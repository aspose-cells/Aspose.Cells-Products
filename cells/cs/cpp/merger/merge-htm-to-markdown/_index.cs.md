...
url: /cs/cpp/merger/merge-htm-to-markdown/ 
...
Následující příklad ukazuje, jak sloučit HTM s MARKDOWN v Aspose.Cells for C++.
...
Potřebujete sloučit HTM na MARKDOWN programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení HTM s MARKDOWN" %}}
