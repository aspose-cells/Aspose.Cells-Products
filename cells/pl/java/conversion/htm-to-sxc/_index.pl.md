...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na SXC używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM do SXC w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować HTM na SXC w Java.
...
Trzeba programowo przekonwertować pliki HTM do formatu SXC? Programiści Java mogą łatwo przekonwertować pliki HTM do formatu SXC za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji HTM na SXC" %}}
{{% blocks/products/pf/agp/text %}}
