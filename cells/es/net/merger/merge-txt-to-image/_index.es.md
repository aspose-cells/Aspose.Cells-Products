---
title: Combinar TXT con IMAGEN - Combinar TXT con IMAGEN en C#
url: /es/net/merger/merge-txt-to-image/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea TXT para guardar formato de IMAGEN. C# Combine TXT en formato de IMAGEN. Combinar TXT a IMAGEN en C#. TXT Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine TXT con IMAGEN en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar TXT con IMAGE en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar TXT con IMAGE. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo IMAGE. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que fusiona TXT con IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar TXT a IMAGEN en C#" InputFormat="txt" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar TXT a IMAGEN a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar TXT con IMAGE mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar TXT a IMAGEN" %}}
