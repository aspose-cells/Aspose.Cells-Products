---
title: C# ODS para TXT - Online ODS para TXT Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter ODS para TXT saveformat. C# ODS a TXT formato. Salve ODS a TXT C#.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a TXT em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter ODS em TXT em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS em TXT. Carregue seu arquivo ODS e salve-o como arquivo TXT. Tanto para a leitura ODS quanto para a escrita TXT, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação de saída TXT serão idênticos ao documento ODS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter ODS em TXT online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para TXT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para TXT programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter ODS em TXT em apenas algumas linhas de código.
...
1.  Converta ODS em TXT chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para converter ODS em TXT" %}}
