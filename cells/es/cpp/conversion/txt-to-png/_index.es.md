---
title: Convierta TXT a PNG a través de la aplicación C++ 
url: /es/cpp/conversion/txt-to-png/ 
description: Ejemplo de código de conversión C++ para documento TXT a formato PNG. Los programadores pueden usar este código fuente para la conversión por lotes de TXT a PNG dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte TXT a PNG a través de C++" h2="Conversión de TXT a PNG de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo TXT a PNG con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo TXT usando Factory::CreateIWorkbook.1. Seleccione la primera hoja de trabajo.1. Establecer (PNG) opciones.1. Iterar a través de cada página de la hoja y renderizar.1. Abra el archivo PNG en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de TXT a PNG C++" offSpacer="" %}}
