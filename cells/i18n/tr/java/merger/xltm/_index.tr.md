---
title: XLTM Dosyalarını Java ile Birleştir 
weight: 8210
url: /tr/java/merger/xltm/ 
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment'da XLTM belgelerini birleştirmek için Java örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLTM Biçimlerini Java içinde Birleştir" h2="Sunucu tarafı Java API\'lerini kullanan yerel XLTM belge birleştirme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak XLTM Dosyalarını Birleştirme" %}}

 XLTM dosyasını birleştirmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java İçinde XLTM Dosyalarını Birleştirme Adımları" %}}
...
+ İlk XLTM dosyasını Workbook sınıfının bir örneğiyle yükleyin.
+ İkinci XLTM belgesini Workbook sınıfının bir örneğiyle yükleyin.
+ Combine() yöntemini kullanarak dosyaları birleştirin.
+ birleştirilmiş XLTM dosyasını belirtilen yola kaydedin
