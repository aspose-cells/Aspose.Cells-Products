---
title: Convertir HTML en DIF Python via Python
description: Convertissez HTML en DIF en ligne gratuitement. Convertisseur en ligne gratuit HTML à DIF. Python HTML à DIF. HTML à DIF via Python.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir HTML en DIF en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="dif" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTML en DIF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir HTML en DIF en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier HTML avec une instance de Workbook
1.  Convertir HTML en DIF en appelant la méthode Workbook.save
