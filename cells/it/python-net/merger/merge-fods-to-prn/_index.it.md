---
title: Unisci FODS al PRN - Combina FODS al PRN in Python
url: /it/python-net/merger/merge-fods-to-prn/ 
description: Aspose Excel. Python Excel. Unisci FODS al formato di salvataggio PRN. Python Combina FODS nel formato PRN. Unisci FODS al PRN nella libreria Excel Python. FODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci FODS a PRN utilizzando la libreria Excel Python" %}}

 Come unisco FODS al PRN? Con la libreria Aspose.Cells for Python via .NET, puoi facilmente unire FODS a PRN a livello di codice con poche righe di codice.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) è in grado di creare applicazioni multipiattaforma con la capacità di generare, modificare, convertire, eseguire il rendering e stampare tutti i file Excel. Python Excel API non solo converte tra formati di foglio di calcolo, ma può anche eseguire il rendering di file Excel come immagini, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT e altro, rendendolo quindi una scelta perfetta per scambiare documenti in formati standard del settore. È possibile installare Aspose.Cells for Python via .NET da<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , usa il comando come:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Unisci FODS al PRN nella libreria Excel Python" %}}

L'esempio seguente mostra come unire FODS al PRN in Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire FODS a PRN. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file PRN. Se sviluppi il codice in Python, sarà più semplice di quanto sembri. Vedere l'esempio Python che unisce FODS al PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Codice di esempio per unire FODS al PRN nella libreria Excel Python" InputFormat="fods" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Come unire FODS al PRN tramite la libreria Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 È necessario unire FODS al PRN a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria Python per unire FODS al PRN" %}}
