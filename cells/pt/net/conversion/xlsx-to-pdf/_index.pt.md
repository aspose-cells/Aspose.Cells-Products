---
title: C# XLSX a PDF - XLSX a PDF Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato PDF, permitindo o salvamento perfeito de dados XLSX no formato PDF usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a PDF em C#" %}}

exemplo a seguir demonstra como converter XLSX em PDF em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter XLSX em PDF por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX em PDF programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em PDF em apenas algumas linhas de código.
...
1.  Converta XLSX para PDF chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em PDF" %}}
