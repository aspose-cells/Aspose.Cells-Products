...
{{% blocks/products/pf/agp/content h2="Convertir TSV en PRN en utilisant Python" %}}
...
L'exemple suivant montre comment convertir TSV en PRN dans Python.
