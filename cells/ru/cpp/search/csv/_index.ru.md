...
weight: 5540
description: Пример кода C++ для поиска слов по шаблону в файле CSV в среде выполнения C++ для 32-битной версии Windows, 64-битной версии Windows и 64-битной версии Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Поиск форматов CSV в C++" h2="Высокопроизводительный поиск документов с использованием серверных API (CSV) без применения какого-либо программного обеспечения, такого как (Microsoft) или Adobe (PDF)." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Как выполнить поиск файла CSV, используя номер C++" %}}

 Для поиска файла CSV мы воспользуемся
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по поиску файлов CSV в C++" %}}
...
+ Загрузка файла CSV с использованием класса Workbook.
