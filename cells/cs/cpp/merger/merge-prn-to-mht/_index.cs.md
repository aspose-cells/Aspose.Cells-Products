---
title: Sloučit PRN s MHT – Zkombinujte PRN s MHT v C++
url: /cs/cpp/merger/merge-prn-to-mht/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit PRN do formátu uložení MHT. C++ Zkombinujte PRN s formátem MHT. Sloučit PRN do MHT v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN do MHT v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN s MHT v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN s MHT. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MHT. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který spojuje PRN s MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení PRN do MHT na čísle C++" InputFormat="prn" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN do MHT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit PRN s MHT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení PRN s MHT" %}}
