---
title: C# XLS zu JPG – Online XLS zu JPG Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das JPG-Speicherformat. C# XLS in das JPG-Format. Speichern Sie XLS in JPG C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS kostenlos als JPG in C# online" %}}

Das folgende Beispiel zeigt, wie XLS in JPG in C# konvertiert wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um XLS in JPG zu konvertieren. Laden Sie Ihre XLS-Datei hoch und speichern Sie sie dann einfach als JPG-Datei. Sowohl zum Lesen von XLS als auch zum Schreiben von JPGs können Sie vollständig qualifizierte Dateinamen verwenden. Der ausgegebene JPG-Inhalt und die Formatierung sind identisch mit dem Originaldokument XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Kostenlose App und Beispielcode zum Online-Konvertieren von XLS in JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in JPG" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in JPG konvertieren? .NET-Entwickler können XLS in nur wenigen Codezeilen problemlos laden und in JPG konvertieren.
...
1.  Konvertieren Sie XLS in JPG, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in JPG" %}}
