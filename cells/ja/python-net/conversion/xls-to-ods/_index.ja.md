...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLS を ODS にすばやく簡単に変換します。Python XLS を ODS に変換します。Python XLS を ODS に保存します。Python Excel ライブラリを使用して、XLS を ODS として保存します。
