---
title: Inserte formas de ecuaciones en Excel a través de C++
weight: 780
description: Código de ejemplo C++ para insertar formas de ecuaciones en un archivo Excel en el entorno de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
keywords: [C++ Aspose.Cells., C++ add equation shapes., C++ insert equation shapes., C++ create equation shapes]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserte formas de ecuaciones en Excel a través de C++" h2="Inserte objetos utilizando el rendimiento nativo y de alto rendimiento del lado del servidor Aspose.Cells for C++ API sin utilizar ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo insertar formas de ecuaciones en un archivo de Excel usando C++" %}}

 Para insertar formas de ecuaciones en un archivo de Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar formas de ecuaciones en un archivo de Excel a través de C++" %}}
...
El siguiente código de muestra demuestra cómo insertar un "más matemáticas". Para conocer más tipos, consulte "Descripción general de los tipos de formas de ecuaciones" a continuación.

{{% /blocks/products/pf/agp/text %}}

{{% blocks/products/pf/agp/code-block title="Insertar formas de ecuaciones - C++" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Descripción general de los tipos de formas de ecuaciones
   </h2>
   <div class="col-lg-4">
