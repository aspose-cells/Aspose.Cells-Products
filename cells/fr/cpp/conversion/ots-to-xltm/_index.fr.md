...
{{% cells-convert title="Exemple de code pour convertir OTS en XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xltm" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir OTS en XLTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers OTS en XLTM par programme ? Les développeurs C++ peuvent facilement convertir OTS en XLTM en quelques lignes de code seulement.
...
1.  Convertissez OTS en XLTM en appelant la méthode Save().
