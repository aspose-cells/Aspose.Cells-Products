...
{{% blocks/products/pf/agp/content h2="Преобразовать XLTM в XLSM, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в XLSM в C#" %}}
...
1.  Преобразуйте значение XLTM в XLSM, вызвав метод Workbook.Save.
