...
{{% blocks/products/pf/agp/content h2="Sla OTS op in MHTML in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar MHTML converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar MHTML via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar MHTML? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar MHTML met slechts een paar regels code.
