...
{{< blocks/products/pf/i18n/upper-banner h1="Шифровать файлы ODS через C++" h2="Защищайте паролем электронные таблицы Excel, включая формат ODS, с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1. Загрузите файл ODS с помощью класса IWorkbook1. Используйте метод Protect(..) с ProtectionType и Password1. Сохраните защищенный файл ODS методом Save().
