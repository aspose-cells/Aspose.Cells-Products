---
title: PHP HTM-MARKDOWN - HTM-MARKDOWN konvertáló
description: Aspose Excel. A HTM-et gyorsan és egyszerűen konvertálja MARKDOWN-re a Aspose.Cells-gyel. PHP HTM-et MARKDOWN-re. PHP HTM mentése MARKDOWN-re. HTM mentése MARKDOWN-re PHP használatával.
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet HTM-et konvertálni MARKDOWN-re PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A HTM-fájlokat programozottan MARKDOWN-re kell konvertálni? A PHP fejlesztői könnyedén betölthetik és konvertálhatják a HTM-et MARKDOWN-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a HTM-et MARKDOWN-re a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a HTM konverziós eredményét MARKDOWN-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a HTM konvertálásához MARKDOWN-re" %}}
