...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer Arc dans le fichier Excel via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Insérer un arc - Java" offSpacer="" %}}
