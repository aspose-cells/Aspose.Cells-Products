---
title: SPREADSHEETML mit HTM zusammenführen – Kombinieren Sie SPREADSHEETML mit HTM in C#
url: /de/net/merger/merge-spreadsheetml-to-htm/ 
description: Aspose Excel. C# Aspose.Cells. Kostenlose Online-Zusammenführung von SPREADSHEETML in das HTM-Speicherformat. C# Kombinieren Sie SPREADSHEETML mit dem HTM-Format. Führen Sie SPREADSHEETML mit HTM in C# zusammen. SPREADSHEETML Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie SPREADSHEETML mit HTM in C# kostenlos online zusammen" %}}

Das folgende Beispiel zeigt, wie SPREADSHEETML in Aspose.Cells for .NET mit HTM zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um SPREADSHEETML mit HTM zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in einer HTM-Datei. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das SPREADSHEETML mit HTM zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlos online zum Zusammenführen von SPREADSHEETML zu HTM in C#" InputFormat="xml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie SPREADSHEETML über C# mit HTM zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie SPREADSHEETML programmgesteuert mit HTM zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von SPREADSHEETML mit HTM" %}}
