...
url: /cs/cpp/merger/merge-xltx-to-csv/ 
...
Následující příklad ukazuje, jak sloučit XLTX až CSV v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX až CSV v C++" InputFormat="xltx" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLTX na CSV přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLTX až CSV? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení XLTX až CSV" %}}
