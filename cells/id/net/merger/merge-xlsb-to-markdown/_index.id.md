...
Contoh berikut menunjukkan cara menggabungkan XLSB ke MARKDOWN di Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLSB menjadi MARKDOWN secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan XLSB ke MARKDOWN" %}}
