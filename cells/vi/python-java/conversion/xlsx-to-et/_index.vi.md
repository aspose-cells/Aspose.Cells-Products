...
description: Aspose Excel. Chuyển đổi XLSX sang ET nhanh chóng và dễ dàng với Aspose.Cells. Python XLSX sang ET. Python Lưu XLSX vào ET. Lưu XLSX dưới dạng ET bằng cách sử dụng Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLSX sang ET trong Python" h2="Thư viện Python tốc độ cao để chuyển đổi XLSX sang ET. Đây là giải pháp phần mềm chuyên nghiệp nhập xuất XLSX, ET và nhiều định dạng khác sử dụng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSX sang ET bằng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLSX vào ET vào Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSX sang ET trong Python.
