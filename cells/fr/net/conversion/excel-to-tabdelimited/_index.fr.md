...
{{% blocks/products/pf/agp/content h2="Sauvegarder EXCEL chez TABDELIMITED dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en TABDELIMITED dans C#.
...
Besoin de convertir des fichiers EXCEL en TABDELIMITED par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en TABDELIMITED en quelques lignes de code seulement.
...
1.  Convertissez un fichier EXCEL au format TABDELIMITED en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de EXCEL en TABDELIMITED.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir EXCEL en TABDELIMITED" %}}
