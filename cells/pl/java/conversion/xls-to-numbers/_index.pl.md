---
title: Konwerter Java XLS na LICZBY - XLS na LICZBY
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS w NUMERACH w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na LICZBY w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na LICZBY via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS na LICZBY? Programiści Java mogą łatwo przekonwertować XLS na LICZBY za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji XLS na LICZBY" %}}
{{% blocks/products/pf/agp/text %}}
