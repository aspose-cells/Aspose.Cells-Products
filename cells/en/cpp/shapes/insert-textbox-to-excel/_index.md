---
title: Insert TextBox into Excel via C++ 
weight: 60

description: C++ example code to insert TextBox in Excel file on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
keywords: [C++ Aspose.Cells., C++ add TextBox., C++ insert TextBox., C++ create TextBox]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Insert TextBox into Excel via C++" h2="Insert objects using  the native and high performance of the server-side Aspose.Cells for C++ API without using any software such as Microsoft or Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+  Use the [add method](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#aabfa692515c324008ab417a43fed206c) to insert Equation Shapes in the selected worksheet
