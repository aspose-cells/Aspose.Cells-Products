---
title: Sloučit MHT s JPEG - Sloučit MHT s JPEG v Java
url: /cs/java/merger/merge-mht-to-jpeg/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit MHT do JPEG saveformat. Java Zkombinujte MHT do formátu JPEG. Sloučit MHT na JPEG v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na JPEG v Java online zdarma" %}}

Následující příklad ukazuje, jak sloučit MHT s JPEG v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT do JPEG. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru JPEG. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do JPEG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení MHT na JPEG v Java" InputFormat="mht" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT na JPEG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit MHT na JPEG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro sloučení MHT s JPEG" %}}
