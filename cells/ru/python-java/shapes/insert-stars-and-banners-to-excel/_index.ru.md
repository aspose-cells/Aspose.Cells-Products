...
weight: 381
description: Python via Java исходный код для вставки звезды/баннера в Excel.
...
{{% blocks/products/pf/agp/content h2="Как вставить звезду/баннер в файл Excel с помощью Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке звезды/баннера в файл Excel с помощью номера Python via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить звезду/баннер на выбранный лист
...
В приведенном ниже примере кода показано, как вставить «математический плюс». Дополнительные типы см. в разделе «Обзор типов звезд и баннеров» ниже.

{{% blocks/products/pf/agp/code-block title="Вставка Звезда/Баннер - Python via Java" offSpacer="" %}}
