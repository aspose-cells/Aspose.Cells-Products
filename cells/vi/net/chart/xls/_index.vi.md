---
title:  XLS tài liệu chart thành ảnh via .NET
weight: 3210
description: C# để vẽ và chuyển đổi biểu đồ hoặc sơ đồ trong tệp XLS trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS Tệp biểu đồ thành hình ảnh trong C#" h2="Biểu đồ tài liệu gốc và hiệu suất cao XLS thành chuyển đổi hình ảnh bằng API phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi biểu đồ XLS thành hình ảnh bằng C#" %}}
 ...
 Để chuyển đổi các biểu đồ XLS, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/code-block title="Convert XLS File Chart - C#" offSpacer="" %}}
