---
title: PHP EXCEL en SQL - Convertisseur EXCEL en SQL
description: Aspose Exceller. Convertissez EXCEL en SQL rapidement et facilement avec Aspose.Cells. PHP EXCEL en SQL. PHP Enregistrez EXCEL dans SQL. Enregistrez EXCEL au format SQL en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en SQL via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en SQL par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en SQL en quelques lignes de code.
...
1.  Convertissez EXCEL en SQL en appelant la méthode de sauvegarde du classeur.
