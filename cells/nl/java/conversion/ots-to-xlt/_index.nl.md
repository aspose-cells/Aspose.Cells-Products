...
{{% blocks/products/pf/agp/content h2="Sla OTS op in XLT in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar XLT converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar XLT via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar XLT? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar XLT met slechts een paar regels code.
