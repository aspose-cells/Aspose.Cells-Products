...
url: /cs/net/merger/merge-xltm-to-sql/ 
...
Následující příklad ukazuje, jak sloučit XLTM do SQL v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLTM s SQL programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu pro sloučení XLTM do SQL" %}}
