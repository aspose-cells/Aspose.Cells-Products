---
title: Java FODS hingga XPS - FODS hingga XPS Konverter
description: Aspose Unggul. Ubah FODS menjadi XPS dengan cepat dan mudah dengan Aspose.Cells. Java FODS menjadi XPS. Java Simpan FODS menjadi XPS. Simpan FODS sebagai 07611134 81 menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah FODS menjadi XPS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi FODS menjadi XPS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor FODS, XPS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan FODS hingga XPS di Java" %}}

Contoh berikut menunjukkan cara mengonversi FODS menjadi XPS di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi FODS menjadi XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file FODS ke XPS secara terprogram? Pengembang Java dapat dengan mudah mengonversi FODS menjadi XPS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah FODS menjadi XPS" %}}
{{% blocks/products/pf/agp/text %}}
