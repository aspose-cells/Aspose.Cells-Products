---
title:  Συγχώνευση XLSB σε MHTML μέσω Python
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLSB με το MHTML στο Python.
