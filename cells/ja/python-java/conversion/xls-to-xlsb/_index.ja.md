---
title: Python XLS から XLSB - オンライン XLS から XLSB コンバータ
description: Aspose エクセル。 Python Aspose.Cells. Python Aspose Cells. 無料オンライン Python XLS を XLSB 保存形式に変換します。 Python XLS ～ XLSB の形式。 XLS から XLSB Python を保存します。
...
{{% blocks/products/pf/agp/content h2="Python を使用して XLS を XLSB に変換します" %}}
...
{{% blocks/products/pf/agp/content h2="Python に XLS から XLSB をオンラインで無料で保存" %}}

次の例は、XLS を Python の XLSB に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、XLS を XLSB に変換します。XLS ファイルをアップロードし、XLSB ファイルとして保存するだけです。 XLS 読み取りと XLSB 書き込みの両方で、完全修飾ファイル名を使用できます。出力 XLSB のコンテンツと形式は、元の XLS ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="オンラインでXLSをXLSBに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlsb" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でXLSをXLSBに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLS ファイルをプログラムで XLSB に変換する必要がありますか? Python 開発者は、わずか数行のコードで XLS を簡単にロードして XLSB に変換できます。
