---
title: Combinar XLSM a XLAM - Combinar XLSM a XLAM en Java
url: /es/java/merger/merge-xlsm-to-xlam/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLSM a XLAM guardar formato. Java Combina el formato XLSM con el XLAM. Combinar XLSM a XLAM en Java. XLSM Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLSM a XLAM en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLSM con XLAM en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLSM a XLAM. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo XLAM. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que combina XLSM con XLAM.
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM a XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLSM con XLAM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar XLSM a XLAM" %}}
