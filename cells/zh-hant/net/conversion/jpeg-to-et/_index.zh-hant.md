---
title: C# JPEG 轉 ET - JPEG 轉 ET 轉換器
description: Aspose Excel。此綜合解決方案為 C# 開發人員提供了一種完全整合的方法，可將 JPEG 轉換為 ET 格式，從而能夠使用 Aspose.Cells 庫將 JPEG 資料無縫保存為 ET 格式，所有這些都通過高效的 JPEG 資料無縫保存為 ET 格式，所有這些都通過高效可自訂的 08153481 實現代碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 JPEG 轉換為 C# 中的 ET" h2="高速 C# 庫，用於將 JPEG 轉換為 ET 格式。這是一個專業的軟體解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 JPEG、ET 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="將 JPEG 儲存到 C# 的 ET 中" %}}

以下範例示範如何將 JPEG 轉換為 C# 中的 ET。
...
{{% cells-convert title="將 JPEG 轉換為 ET 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 JPEG 轉換為 ET" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 JPEG 檔案轉換為 ET？ .NET 開發人員只需幾行程式碼即可輕鬆載入 JPEG 並將其轉換為 ET。
...
1. 使用工作簿實例載入 JPEG 檔案。
1. 呼叫 Workbook.Save 方法將 JPEG 轉換為 ET。
1. 取得JPEG到ET的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 庫用於將 JPEG 轉換為 ET" %}}
