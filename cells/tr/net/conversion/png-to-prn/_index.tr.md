---
title: C# PNG'den PRN'ye - PNG'den PRN'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile PNG'i hızlı ve kolay bir şekilde PRN'ye dönüştürün. C# PNG'i PRN'ye dönüştürün. C# PNG'i PRN'ye kaydedin. PNG'i C#'i kullanarak PRN olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C#\'deki PRN\'ye kaydedin" %}}
...
{{% cells-convert title="PNG\'i PRN\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG\'i C# aracılığıyla PRN\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını program aracılığıyla PRN'ye dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyip PRN'ye dönüştürebilir.
