---
title: Sloučit TXT až PDF - Sloučit TXT až PDF v Java
url: /cs/java/merger/merge-txt-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma TXT do formátu uložení PDF. Java Kombinujte formát TXT až PDF. Sloučit TXT až PDF v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT až PDF v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit TXT až PDF v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TXT do PDF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PDF. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí TXT do PDF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit TXT do PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit TXT až PDF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení TXT až PDF" %}}
