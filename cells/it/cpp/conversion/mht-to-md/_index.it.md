...
Hai bisogno di convertire i file MHT in MD tramite codice? Gli sviluppatori di C++ possono facilmente convertire i file MHT in MD in poche righe di codice.
...
1.  Convertire MHT in MD chiamando il metodo Save().
