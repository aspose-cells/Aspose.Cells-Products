...
description: Aspose Unggul. Ubah XLSX menjadi ODS dengan cepat dan mudah dengan Aspose.Cells. Python XLSX menjadi ODS. Python Simpan XLSX menjadi ODS. Simpan XLSX sebagai 07611134 81 menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah XLSX menjadi ODS Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX hingga ODS di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi ODS di Python.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengubah XLSX menjadi ODS" %}}
