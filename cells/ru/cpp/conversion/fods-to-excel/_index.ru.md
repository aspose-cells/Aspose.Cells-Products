...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики C++ могут легко преобразовать FODS в EXCEL, написав всего несколько строк кода.
