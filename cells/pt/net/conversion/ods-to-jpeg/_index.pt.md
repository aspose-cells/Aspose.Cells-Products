---
title: C# ODS a JPEG - ODS a JPEG Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato JPEG, permitindo o salvamento perfeito de dados ODS no formato JPEG usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a JPEG em C#" %}}

exemplo a seguir demonstra como converter ODS em JPEG em C#.
...
{{% cells-convert title="Código de exemplo para converter ODS em JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS em JPEG por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em JPEG programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em JPEG em apenas algumas linhas de código.
...
1.  Converta ODS para JPEG chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em JPEG" %}}
