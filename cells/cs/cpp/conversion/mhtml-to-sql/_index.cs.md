---
title: C++ MHTML na SQL - MHTML na SQL Converter
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu MHTML do formátu SQL, což umožňuje bezproblémové ukládání dat MHTML do formátu SQL pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převést MHTML na SQL v kódu C++" h2="Vysoce výkonná konverze MHTML do SQL s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložit MHTML do SQL v C++" %}}

Následující příklad ukazuje, jak převést kód MHTML na kód SQL s kódem C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na SQL přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory MHTML do SQL? Vývojáři C++ mohou snadno převést MHTML do SQL pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML do SQL voláním metody Save().
1.  Získejte výsledek převodu MHTML na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod kódu MHTML do SQL" %}}
