---
title: एक्सएलएसबी फाइलों को .NET के माध्यम से विभाजित करें 
weight: 7370
url: /hi/net/splitter/xlsb/ 
description: C# XLSB दस्तावेज़ों को .NET Framework, .NET Core, Mono या Xamarin प्लेटफ़ॉर्म पर विभाजित करने के लिए स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="एक्सएलएसबी प्रारूपों को C# में विभाजित करें" h2="माइक्रोसॉफ्ट या ओपन ऑफिस, एडोब पीडीएफ जैसे किसी भी सॉफ्टवेयर के उपयोग के बिना सर्वर-साइड एपीआई का उपयोग करके मूल और उच्च प्रदर्शन एक्सएलएसबी स्प्लिटर।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/code-block title="स्प्लिट एक्सएलएसबी फ़ाइल - C#" offSpacer="" %}}
