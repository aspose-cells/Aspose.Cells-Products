---
title: PHP XLTM إلى PDF - XLTM إلى PDF محول
description: Aspose اكسل. قم بتحويل XLTM إلى PDF بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى PDF. PHP احفظ XLTM إلى PDF. احفظ XLTM كـ PDF باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى PDF عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى PDF برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى PDF بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى PDF عن طريق استدعاء طريقة حفظ المصنف.
