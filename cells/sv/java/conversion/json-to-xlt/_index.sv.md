---
title: Konvertera JSON till XLT via Java 
weight: 7430
url: /sv/java/conversion/json-to-xlt/ 
description: Exempel på Java-konverteringskod för JSON-format till XLT-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLT inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera JSON till XLT via Java" h2="Exportera JSON till XLT-format via Java utan att behöva ytterligare verktyg eller bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du JSON till XLT med Java" %}}

 För att rendera JSON till XLT kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera JSON till XLT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera JSON-filen till XLT på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Skapa en ny instans av Workbook-klassen1. Välj standard eller valfritt kalkylblad från samlingen1. Ladda JSON-data från filen1. Skapa en instans av JsonLayoutOptions och ställ in alternativ1. Anropa metoden JsonUtility.importData med hänvisning till arbetsblad och data1. Spara arbetsboken i XLT-format
...
{{% blocks/products/pf/agp/code-block title="JSON till XLT Java konverteringskällkod" offSpacer="" %}}
...
// spara den resulterande filen i JSON-TO-XLT-format
