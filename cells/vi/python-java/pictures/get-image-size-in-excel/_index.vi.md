---
title: Nhận kích thước hình ảnh/hình ảnh trong Excel qua Python-Java
weight: 10
description: Nhận kích thước Hình ảnh/Hình ảnh trong Excel bằng cách sử dụng Aspose.Cells' Python-Java API mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v.
---
...
{{% blocks/products/pf/agp/content h2="Cách lấy kích thước ảnh/ảnh trong File Excel Bằng Python-Java" %}}
 ...
 API là một thao tác tài liệu API giàu tính năng, mạnh mẽ và dễ sử dụng cho nền tảng python-Java. API cung cấp khả năng tạo, thao tác, chuyển đổi và kết xuất tệp Excel. Tất cả mà không cần dựa vào Microsoft Các ứng dụng Office hoặc Excel. Bạn có thể cài đặt từ bảng điều khiển bằng lệnh sau.
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước lấy ảnh/kích thước ảnh trong file Excel qua Python-Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells for Python-Java là API độc lập với nền tảng và có thể được sử dụng trên mọi nền tảng (Windows, Linux và MacOS), chỉ cần đảm bảo hệ thống đó có Java 1.8 trở lên,[Python](https://www.python.org/downloads/) 3.5 trở lên.
...
{{% blocks/products/pf/agp/code-block title="Lấy size ảnh/tranh - Python-Java" offSpacer="" %}}
