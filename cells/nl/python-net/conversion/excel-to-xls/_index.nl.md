...
Het volgende voorbeeld laat zien hoe u EXCEL converteert naar XLS in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Excel converteren naar XLS" %}}
