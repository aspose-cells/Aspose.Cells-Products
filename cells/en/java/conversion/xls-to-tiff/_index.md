...
The following example demonstrates how to convert XLS to TIFF document format in Java.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert XLS file into TIFF format. Upload your XLS file, then simply save it as TIFF file. For both XLS reading and TIFF writing you can use fully qualified filenames. The output TIFF content and formatting will be identical to the original XLS document.
