---
title: C# HTM σε MARKDOWN - Μετατροπέας HTM σε MARKDOWN
description: Aspose Excel. Μετατρέψτε το HTM σε MARKDOWN γρήγορα και εύκολα με το Aspose.Cells. C# HTM σε MARKDOWN. C# Αποθήκευση HTM σε MARKDOWN. Αποθηκεύστε το HTM ως 07617837481 χρησιμοποιώντας 3.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το HTM στο MARKDOWN στο C#" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το HTM σε MARKDOWN στο C#.
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή HTM σε MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε HTM σε MARKDOWN μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να μετατρέψετε αρχεία HTM σε MARKDOWN μέσω προγραμματισμού; Οι προγραμματιστές .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν το HTM σε MARKDOWN σε λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="C# βιβλιοθήκη για μετατροπή HTM σε MARKDOWN" %}}
