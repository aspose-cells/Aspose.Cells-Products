---
title: A XLS összevonása ET-vel - XLS egyesítése ET-vel a Java-ben
url: /hu/java/merger/merge-xls-to-et/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés XLS ET mentési formátumba. Java Kombinálja a XLS-et ET formátumba. Egyesítse a XLS-et ET-vel a Java-es számon. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLS-es számot ET-hez a Java-es számon online ingyen" %}}

következő példa bemutatja, hogyan lehet egyesíteni a XLS-et a Aspose.Cells-es for Java-es ET-vel.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS és az ET egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el ET fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a XLS-et az ET-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a XLS és az ET egyesítése a Java-ben" InputFormat="xls" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLS és az ET via Java számok egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-et az ET-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a XLS ET-vel való egyesítéséhez" %}}
