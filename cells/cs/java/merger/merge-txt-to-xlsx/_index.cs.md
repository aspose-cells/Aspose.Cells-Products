---
title:  Sloučit TXT až XLSX via Java
...
Následující příklad ukazuje, jak sloučit TXT až XLSX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až XLSX online" InputFormat="txt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
