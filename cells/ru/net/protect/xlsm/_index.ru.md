...
{{< blocks/products/pf/i18n/upper-banner h1="Зашифровать файлы XLSM через C#" h2="Защищайте паролем электронные таблицы Excel, включая формат XLSM, используя библиотеку .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Защитить XLSM через C#" %}}
...
1.  Создать экземпляр класса Workbook с путем к файлу XLSM
