---
title: Μετατρέψτε το TABDELIMITED σε XLS μέσω της εφαρμογής C++ 
url: /el/cpp/conversion/tabdelimited-to-xls/ 
description: Δείγμα κώδικα μετατροπής C++ για έγγραφο TABDELIMITED σε μορφή XLS. Οι προγραμματιστές μπορούν να χρησιμοποιήσουν αυτόν τον πηγαίο κώδικα για ομαδική μετατροπή TABDELIMITED σε XLS σε οποιαδήποτε εφαρμογή C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή TABDELIMITED σε XLS μέσω C++" h2="Μετατροπή TABDELIMITED σε XLS υψηλής απόδοσης με χρήση βιβλιοθήκης C++ χωρίς την ανάγκη εγκατάστασης Microsoft Excel, OpenOffice ή Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές του C++ μπορούν εύκολα να μετατρέψουν το αρχείο TABDELIMITED σε XLS σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φορτώστε το αρχείο TABDELIMITED χρησιμοποιώντας το Factory::CreateIWorkbook.1. Καλέστε τη μέθοδο Save().1. Περάστε τη διαδρομή του αρχείου εξόδου με επέκταση αρχείου (XLS).1. Το αρχείο XLS θα αποθηκευτεί στην καθορισμένη διαδρομή.1. Ανοίξτε το αρχείο XLS σε συμβατό πρόγραμμα.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED σε XLS C++ Πηγαίος κώδικας μετατροπής" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="ABDELIMITED σε Ζωντανές επιδείξεις μετατροπής XLS" sectionDescription="[Μετατρέψτε το TABDELIMITED σε XLS](https://products.aspose.app/cells/conversion/tabdelimited-to-xls) αυτή τη στιγμή, επισκεπτόμενοι τον ιστότοπο Live Demos. Η ζωντανή επίδειξη έχει τα ακόλουθα πλεονεκτήματα" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Δεν χρειάζεται να κάνετε λήψη του Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Δεν χρειάζεται να γράψετε κανέναν κώδικα." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλώς ανεβάστε το αρχείο TABDELIMITED, θα μετατραπεί αμέσως σε XLS." >}}
