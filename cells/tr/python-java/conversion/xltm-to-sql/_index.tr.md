...
description: Aspose Excel'de. Python Excel'de. Aspose.Cells ile XLTM'i hızlı ve kolay bir şekilde SQL'e dönüştürün. Python XLTM'i SQL'e dönüştürün. Python XLTM'i SQL'e kaydedin. Python Excel Kitaplığını kullanarak XLTM'i SQL olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i Python Excel Kitaplığını Kullanarak SQL\'e Dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="XLTM\'i Python Excel Kitaplığı\'nda SQL\'e kaydedin" %}}

Aşağıdaki örnek, XLTM'in Python excel kitaplığında SQL'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="Python XLTM\'i SQL\'e Dönüştürmek için Excel Kitaplığı" %}}
