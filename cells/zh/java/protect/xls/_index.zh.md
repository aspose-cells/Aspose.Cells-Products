---
title: 保护锁XLS文档via Java
weight: 5070
description: Java 示例代码，用于在 JSP/JSF 应用程序和桌面应用程序的 Java 运行时环境中使用密码锁定 XLS 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="加密 XLS 文件 via Java" h2="使用 .NET 库使用密码保护 Excel 电子表格，包括 XLS 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
1. 通过实例化 Workbook 类加载 XLS 文件
1. 使用带有 ProtectionType 和 Password 的 protect(..) 方法
1. 通过save()方法保存被保护的XLS文件
