---
title:  XLSB belgesini açmadan C++ üzerinden arayın
weight: 7020
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı üzerindeki XLSB dosyasındaki kalıplı kelimeleri aramak için C++ örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB Biçimlerini C++\'de arayın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Cells for C++ API\'leri kullanarak yerel ve yüksek performanslı XLSB belge arama." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++\'de XLSB Dosyalarını Arama Adımları" %}}
...
Bir IWorkbook sınıfını başlatarak XLSB dosyasını yükleyin.
...
+ XLSB dosyasını IWorkbook->Save(.) yöntemini kullanarak kaydedin.
...
{{% blocks/products/pf/agp/code-block title="Ara XLSB Dosyalar - C++" offSpacer="" %}}
