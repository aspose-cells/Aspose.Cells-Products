---
title: تحويل ODS إلى XLSB عبر Java 
weight: 5170
url: /ar/java/conversion/ods-to-xlsb/ 
description: نموذج Java رمز تحويل لتنسيق ODS إلى ملف XLSB. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى XLSB داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ODS إلى XLSB عبر Java" h2="ODS إلى XLSB Java لتحويل صفحات مفردة أو صفحات متعددة إلى XLSB باستخدام المكتبة المحلية Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل ODS إلى XLSB باستخدام Java" %}}

 من أجل تقديم ODS إلى XLSB ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل ODS إلى XLSB عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف ODS إلى XLSB في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف ODS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XLSB & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XLSB الناتج
...
{{% blocks/products/pf/agp/code-block title="ODS إلى XLSB Java شفرة مصدر التحويل" offSpacer="" %}}
