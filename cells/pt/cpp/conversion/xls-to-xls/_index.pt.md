...
description: Aspose Excel. Converta XLS em XLS de forma rápida e fácil com Aspose.Cells. C++ XLS em XLS. C++ Salve XLS em XLS. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em XLS usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para XLS em C++" %}}

O exemplo a seguir demonstra como converter XLS em XLS em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em XLS por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em XLS programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em XLS em apenas algumas linhas de código.
...
1.  Converta XLS em XLS chamando o método Save().
