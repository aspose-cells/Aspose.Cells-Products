---
title: Fusionar IMAGEN con XLAM - Combinar IMAGEN con XLAM en C#
url: /es/net/merger/merge-image-to-xlam/ 
description: Aspose Excel. C# Aspose.Cells. Fusionar IMAGEN con XLAM formato guardado. C# Combina IMAGEN al formato XLAM. Fusionar IMAGEN a XLAM en C#. Fusionar IMAGEN.
...
{{% blocks/products/pf/agp/content h2="Fusionar IMAGEN con XLAM en C#" %}}

El siguiente ejemplo demuestra cómo fusionar IMAGEN con XLAM en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar IMAGEN en XLAM. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo XLAM. Si desarrolla código en C#, esto será más simple de lo que parece. Vea el ejemplo de C# que combina IMAGEN con XLAM.
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar IMAGEN con XLAM a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar IMAGEN con XLAM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca .NET para fusionar IMAGEN con XLAM" %}}
