---
title: PHP PNG ～ FODS - PNG ～ FODS コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、PNG を FODS にすばやく簡単に変換します。PHP PNG から FODS。PHP PNG から FODS に保存します。PHP を使用して、PNG を FODS として保存します。
...
{{% cells-convert title="PNG を FODS に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="fods" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP 経由で PNG を FODS に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

PNG ファイルをプログラムで FODS に変換する必要がありますか? PHP 開発者は、わずか数行のコードで PNG を簡単にロードして FODS に変換できます。
