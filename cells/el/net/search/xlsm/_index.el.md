---
title:  Αναζητήστε το έγγραφο XLSM χωρίς να ανοίξετε το via .NET
weight: 4880
description: C# πηγαίος κώδικας για αναζήτηση λέξεων με μοτίβο στο αρχείο XLSM στο .NET Framework, .NET Core, Mono ή Xamarin Platforms.
---
