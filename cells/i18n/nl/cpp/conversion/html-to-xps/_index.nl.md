---
title: Converteer HTML naar XPS via C++ applicatie 
weight: 1420
url: /nl/cpp/conversion/html-to-xps/ 
description: Voorbeeld C++ conversiecode voor HTML-document naar XPS-indeling. Programmeurs kunnen deze broncode gebruiken voor batch-HTML-naar-XPS-conversie binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer HTML naar XPS via C++" h2="Hoogwaardige conversie van HTML naar XPS met behulp van de C++-bibliotheek zonder dat Microsoft Excel, OpenOffice of Adobe Acrobat hoeft te worden geïnstalleerd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen HTML-bestanden eenvoudig converteren naar XPS in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad HTML-bestand met behulp van Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (XPS) bestandsextensie.1. XPS-bestand wordt opgeslagen op het opgegeven pad.1. Open het XPS-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="HTML naar XPS C++ Broncode voor conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="HTML naar XPS conversie Live demo\'s" sectionDescription="[Converteer HTML naar XPS](https://products.aspose.app/cells/conversion/html-to-xps) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw HTML-bestand, het wordt direct geconverteerd naar XPS." >}}
