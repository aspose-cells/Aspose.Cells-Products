---
title: C# JPG sang XLS - Bộ chuyển đổi JPG sang XLS trực tuyến
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Trực tuyến miễn phí C# Chuyển đổi JPG sang định dạng lưu XLS. C# Định dạng JPG đến XLS. Lưu JPG vào XLS C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển JPG sang XLS trong C#" h2="Thư viện C# chuyển đổi JPG sang XLS tốc độ cao. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất JPG, XLS và nhiều định dạng khác trên .NET Framework, .NET Core hoặc Mono Nền tảng." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPG" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Chuyển đổi JPG sang XLS bằng C#" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu JPG vào XLS trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi JPG thành XLS trong C#.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi JPG sang XLS qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi các tệp JPG thành XLS theo chương trình? .NET nhà phát triển có thể dễ dàng tải và chuyển đổi JPG thành XLS chỉ bằng một vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="C# thư viện chuyển JPG sang XLS" %}}
