...
url: /cs/cpp/merger/merge-htm-to-spreadsheetml/ 
...
Následující příklad ukazuje, jak sloučit HTM do SPREADSHEETML v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení HTM do SPREADSHEETML v C++" InputFormat="htm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM do SPREADSHEETML přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit HTM do SPREADSHEETML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení HTM do SPREADSHEETML" %}}
