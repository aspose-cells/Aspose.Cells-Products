...
description: Aspose Excel. Konwertuj PRN na XLSM szybko i łatwo za pomocą Aspose.Cells. Python PRN na XLSM. Python Zapisz PRN na XLSM. Zapisz PRN jako XLSM używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN pod numerem XLSM w Python" %}}

Poniższy przykład ilustruje sposób konwersji PRN na XLSM w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji PRN na XLSM" %}}
