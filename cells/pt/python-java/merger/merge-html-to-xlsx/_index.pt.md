...
description: Aspose Excel. Python Aspose.Cells. Mesclar HTML com XLSX salvar formato. Python Combine o formato HTML com XLSX. Mesclar HTML a XLSX em Python. HTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com XLSX usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com XLSX em Python" %}}

O exemplo a seguir demonstra como mesclar HTML com XLSX em Aspose.Cells for Python via Java.
