---
title: XLSB को Java के माध्यम से TIFF में बदलें 
weight: 6860
url: /hi/java/conversion/xlsb-to-tiff/ 
description: XLSB प्रारूप के लिए TIFF फ़ाइल में नमूना Java रूपांतरण कोड। प्रोग्रामर इस उदाहरण कोड का उपयोग एक्सेल और ओपनऑफिस स्प्रेडशीट को किसी भी वेब या डेस्कटॉप Java आधारित एप्लिकेशन के भीतर टीआईएफएफ को निर्यात करने के लिए कर सकते हैं।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB को Java के माध्यम से TIFF में बदलें" h2="ऑन-प्रिमाइसेस Java लाइब्रेरी का उपयोग करके एकल या एकाधिक पृष्ठों को TIFF में बदलने के लिए XLSB से TIFF Java रूपांतरण।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके XLSB को TIFF में कैसे बदलें" %}}

 XLSB को TIFF में रेंडर करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB को Java के माध्यम से TIFF में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Java डेवलपर XLSB फ़ाइल को कोड की कुछ ही पंक्तियों में आसानी से TIFF में बदल सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. कार्यपुस्तिका के उदाहरण के साथ XLSB फ़ाइल लोड करें1. संग्रह से डिफ़ॉल्ट या किसी वर्कशीट का चयन करें1. ImageOrPrintOptions का ऑब्जेक्ट बनाएं और सेट करें1. वर्कशीट और इमेजऑरप्रिंटऑप्शन ऑब्जेक्ट्स के साथ शीटरेंडर बनाएं1. TIFF प्रारूप में परिणाम सहेजने के लिए SheetRender.toImage विधि को कॉल करें
...
{{% blocks/products/pf/agp/code-block title="XLSB से TIFF Java रूपांतरण स्रोत कोड" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLSB से TIFF रूपांतरण लाइव डेमो" sectionDescription="[XLSB को TIFF में बदलें](https://products.aspose.app/cells/conversion/xlsb-to-tiff) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API डाउनलोड करने की आवश्यकता नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" कोई कोड लिखने की जरूरत नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी XLSB फ़ाइल अपलोड करें, यह तुरंत TIFF में बदल जाएगी।" >}}
