---
title: Gộp OTS vào SPREADSHEETML - Gộp OTS vào SPREADSHEETML trong C#
url: /vi/net/merger/merge-ots-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất OTS thành định dạng lưu SPREADSHEETML. C# Kết hợp OTS thành định dạng SPREADSHEETML. Hợp nhất OTS thành SPREADSHEETML trong C#. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS vào SPREADSHEETML trong C#" %}}

Ví dụ sau đây minh họa cách hợp nhất OTS với SPREADSHEETML trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất OTS vào SPREADSHEETML. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SPREADSHEETML. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất OTS với SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất OTS thành SPREADSHEETML trong C#" InputFormat="ots" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS vào SPREADSHEETML qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất OTS vào SPREADSHEETML theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất OTS vào SPREADSHEETML" %}}
