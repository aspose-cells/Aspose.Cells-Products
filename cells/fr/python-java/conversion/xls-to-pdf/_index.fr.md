---
title: Convertir XLS en PDF via Python
url: /fr/python-java/conversion/xls-to-pdf/
description: Exemple de code pour la conversion xls en pdf Python. Utilisez l'exemple de code API pour la conversion de fichiers xls par lots en pdf dans l'application Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLS en PDF via Python" h2="Exportez des feuilles de calcul Excel® au format PDF à l\'aide des API Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en PDF à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en PDF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir des fichiers XLS en PDF en quelques lignes de code seulement.
