---
title: دمج PRN في MARKDOWN - ادمج PRN مع MARKDOWN في C#
url: /ar/net/merger/merge-prn-to-markdown/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني عبر الإنترنت PRN إلى MARKDOWN saveformat. C# ادمج PRN بتنسيق MARKDOWN. دمج PRN إلى MARKDOWN في C#. PRN Merge.
...
{{< blocks/products/pf/i18n/upper-banner h1="ادمج PRN في MARKDOWN عبر C#" h2="مكتبة C# عالية السرعة لدمج PRN في MARKDOWN. استخدم تحويل Excel الخاص بنا API لتطوير برامج عالية المستوى ومستقلة عن النظام الأساسي في C#. هذا حل برمجي احترافي لاستيراد وتصدير Excel, CSV, OpenOffice, PDF, HTML, image ، والعديد من تنسيقات Excel الأخرى." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="PRN" additionalConversionTag="MARKDOWN" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="قم بدمج PRN مع MARKDOWN في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج PRN مع MARKDOWN في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج PRN في MARKDOWN. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف MARKDOWN. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج PRN إلى MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج PRN في MARKDOWN في C#" InputFormat="prn" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج PRN في MARKDOWN عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج PRN في MARKDOWN برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج PRN إلى MARKDOWN" %}}
