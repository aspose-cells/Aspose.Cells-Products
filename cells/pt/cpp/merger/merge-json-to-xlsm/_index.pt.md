...
description: Aspose Excel. C++ Aspose.Cells. Mesclagem online gratuita JSON para XLSM saveformat. C++ Combine o formato JSON a XLSM. Mesclar JSON a XLSM em C++. JSON Mesclar.
...
O exemplo a seguir demonstra como mesclar JSON a XLSM em Aspose.Cells for C++.
...
{{% cells-merger title="Online grátis para mesclar JSON a XLSM em C++" InputFormat="json" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar JSON a XLSM via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar JSON a XLSM programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
