---
title:  كيف يمكنني رسم أو إدراج سهم مستقيم في Excel باستخدام Python via .Net
weight: 10
description: Python via. صافي الكود المصدري لرسم أو إدراج سهم مستقيم في برنامج Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج سهم مستقيم في ملف إكسل باستخدام Python via.نت" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج سهم مستقيم في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) لإدراج سهم مستقيم في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل السهم المستقيم - Python via .نت" offSpacer="" %}}
