---
title: Konverter Java PNG ke ANGKA - PNG ke ANGKA
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi PNG ke format NUMBERS, memungkinkan penyimpanan data PNG ke format NUMBERS dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{% blocks/products/pf/agp/content h2="Simpan PNG ke NUMBERS di Java" %}}

Contoh berikut menunjukkan cara mengkonversi PNG menjadi ANGKA di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengkonversi PNG ke NUMBERS. Unggah file PNG Anda, lalu simpan saja sebagai file NUMBERS. Untuk membaca PNG dan menulis ke NUMBERS, Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format NUMBERS yang dihasilkan akan identik dengan dokumen PNG asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi PNG ke ANGKA" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="numbers" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi PNG ke ANGKA via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file PNG ke NUMBERS secara terprogram? Pengembang Java dapat dengan mudah mengkonversi PNG ke NUMBERS hanya dengan beberapa baris kode.
...
1.  Konversikan PNG ke ANGKA dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari PNG ke ANGKA.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi PNG menjadi ANGKA" %}}
{{% blocks/products/pf/agp/text %}}
