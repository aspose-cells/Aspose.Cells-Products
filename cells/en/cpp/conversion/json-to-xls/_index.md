...
description: Sample C++ conversion code for JSON to XLS format. Programmers can use this source code for batch JSON to XLS conversion within any C++ Application.
---
