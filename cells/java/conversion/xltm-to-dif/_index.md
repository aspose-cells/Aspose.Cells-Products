...
description: Sample Java conversion code for XLTM format to DIF file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to DIF within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert XLTM to DIF Using Java" %}}

 In order to render XLTM to DIF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLTM to DIF via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XLTM to DIF Java Conversion Source Code" offSpacer="" %}}
