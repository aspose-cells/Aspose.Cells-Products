...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde FODS Dosyası oluşturun. Java'i kullanarak FODS dosyası oluşturun. Java'de FODS oluşturun. Java FODS Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını FODS biçiminde kaydedin.
