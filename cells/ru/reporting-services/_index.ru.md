...
Свернуть или развернуть поля сводной таблицы
 ...
 Экспорт отчетов в форматы электронных таблиц
    ...
    <p>
Aspose.Cells for Reporting Services поддерживает все популярные Microsoft форматы файлов Excel (97 - 2016), включая «родные» Microsoft форматы Excel, такие как XLS, XLSX, XLSM, SpreadsheetML, CSV, Tab Delimited и HTML. Aspose.Cells for Reporting Services также поддерживают формат файла ODS (OpenDocument Spreadsheet).
    </p>
    <p>
