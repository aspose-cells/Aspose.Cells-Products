---
title: Sloučit JPG s XLSX - Sloučit JPG s XLSX v C++
url: /cs/cpp/merger/merge-jpg-to-xlsx/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit JPG do formátu uložení XLSX. C++ Zkombinujte JPG do formátu XLSX. Sloučit JPG na XLSX v C++. Sloučit JPG.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG na XLSX v C++" %}}

Následující příklad ukazuje, jak sloučit JPG s XLSX v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do XLSX. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLSX. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení JPG do XLSX v C++" InputFormat="jpg" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPG na XLSX přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit JPG na XLSX programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do XLSX" %}}
