---
title: Convertitore da C# HTM a MARKDOWN - Convertitore da HTM a MARKDOWN
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori C# un approccio completamente integrato per convertire HTM nel formato MARKDOWN, consentendo il salvataggio senza interruzioni dei dati HTM nel formato MARKDOWN utilizzando la libreria Aspose.Cells, il tutto tramite codice C# efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva HTM su MARKDOWN in C#" %}}

L'esempio seguente mostra come convertire HTM in MARKDOWN in C#.
...
{{% cells-convert title="Codice di esempio per convertire HTM in MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Come convertire HTM in MARKDOWN tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file HTM in MARKDOWN a livello di codice? Gli sviluppatori di .NET possono caricare e convertire facilmente HTM in MARKDOWN in poche righe di codice.
...
1.  Convertire HTM in MARKDOWN chiamando il metodo Workbook.Save.
1.  Ottieni il risultato della conversione da HTM a MARKDOWN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C# per convertire HTM in MARKDOWN" %}}
