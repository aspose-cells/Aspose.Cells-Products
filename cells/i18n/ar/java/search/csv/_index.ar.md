...
{{% blocks/products/pf/agp/content h2="كيفية البحث في ملف CSV باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث في ملفات CSV في Java" %}}
...
+ الوصول إلى ورقة العمل الأولى في ملف CSV.
...
{{% blocks/products/pf/agp/code-block title="بحث في ملفات CSV - Java" offSpacer="" %}}
