---
title: Voeg een stroomdiagram in/maak het in Excel via Java
weight: 360
description: Voeg een stroomdiagram in/maak een stroomdiagram met behulp van Aspose.Cells' Java API zonder software zoals Microsoft of Open Office, Adobe PDF, enz.
keywords: [Java Aspose.Cells., Java add FlowChart., Java insert FlowChart., Java create FlowChart]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg een stroomdiagram in/maak het in Excel via Java" h2="Voeg een stroomdiagram in / maak het met behulp van Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de[methode toevoegen](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) om een stroomdiagram in het geselecteerde werkblad in te voegen/te maken
...
De onderstaande voorbeeldcode laat zien hoe u een "Multidocument" invoegt. Voor meer typen, zie "Overzicht van blokpijlvormtypen" hieronder.
