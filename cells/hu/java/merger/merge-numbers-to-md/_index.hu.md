---
title: NUMBERS egyesítése MD-vel - NUMBERS egyesítése MD-vel a Java-ben
url: /hu/java/merger/merge-numbers-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése NUMBERS MD mentési formátumba. Java A NUMBERS kombinálása MD formátumba. A NUMBERS egyesítése a Java számú MD-vel. NUMBERS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a NUMBERS-t az MD-vel a Java Online számon" %}}

A következő példa bemutatja, hogyan egyesítheti a NUMBERS-t az MD-vel a Aspose.Cells for Java számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a NUMBERS és az MD egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el MD fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely egyesíti a NUMBERS-t az MD-vel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online NUMBERS egyesítése MD-vel a Java számon" InputFormat="numbers" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A NUMBERS egyesítése az MD via Java számmal" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell NUMBERS-t az MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a NUMBERS MD-vel való egyesítéséhez" %}}
