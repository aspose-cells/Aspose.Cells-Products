---
title: C# TSV à XLSX - Convertisseur en ligne TSV à XLSX
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir TSV en format de sauvegarde XLSX. Format C# TSV à XLSX. Enregistrez TSV à XLSX C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez TSV à XLSX dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir TSV en XLSX en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir TSV en XLSX. Téléchargez votre fichier TSV, puis enregistrez-le simplement en tant que fichier XLSX. Pour la lecture TSV et l'écriture XLSX, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie XLSX seront identiques au document TSV d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir TSV en XLSX en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir TSV en XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers TSV en XLSX par programmation ? Les développeurs .NET peuvent facilement charger et convertir TSV en XLSX en quelques lignes de code.
