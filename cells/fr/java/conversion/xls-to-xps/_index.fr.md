---
title: Java XLS à XPS - Convertisseur en ligne XLS à XPS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XLS en format de sauvegarde XPS. Format Java XLS à XPS. Enregistrez XLS à XPS Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS à XPS dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLS en XPS en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLS en XPS. Téléchargez votre fichier XLS, puis enregistrez-le simplement en tant que fichier XPS. Pour la lecture XLS et l'écriture XPS, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie XPS seront identiques au document XLS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLS en XPS en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xps" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en XPS par programmation ? Les développeurs de Java peuvent facilement convertir XLS en XPS en seulement quelques lignes de code.
