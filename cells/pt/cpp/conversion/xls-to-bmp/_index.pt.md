...
description: Aspose Excel. Converta XLS em BMP de forma rápida e fácil com Aspose.Cells. C++ XLS em BMP. C++ Salve XLS em BMP. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em BMP usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para BMP em C++" %}}

O exemplo a seguir demonstra como converter XLS em BMP em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="bmp" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em BMP por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em BMP programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em BMP em apenas algumas linhas de código.
...
1.  Converta XLS em BMP chamando o método Save().
