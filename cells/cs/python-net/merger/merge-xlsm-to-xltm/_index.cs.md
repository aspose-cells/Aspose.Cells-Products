---
title:  Sloučit XLSM na XLTM přes Python
...
Následující příklad ukazuje, jak sloučit XLSM až XLTM v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až XLTM online" InputFormat="xlsm" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
