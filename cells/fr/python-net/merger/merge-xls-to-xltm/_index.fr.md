...
description: Aspose Exceller. Python Aspose.Cells. Fusionner le format de sauvegarde XLS à XLTM. Python Combinez les formats XLS à XLTM. Fusionner XLS à XLTM dans Python. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS à XLTM en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS à XLTM dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner XLS à XLTM dans Python" InputFormat="xls" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS à XLTM via Python" %}}
