---
title: รวมตัวเลขเป็น WORD - รวมตัวเลขเป็น WORD ใน Java
url: /th/java/merger/merge-numbers-to-word/ 
description: Aspose เก่ง. Java Aspose.Cells ผสานรูปแบบบันทึก NUMBERS เป็น WORD ออนไลน์ฟรี Java รวม NUMBERS เป็นรูปแบบ WORD รวม NUMBERS เป็น WORD ใน Java ผสาน NUMBERS
...
ตัวอย่างต่อไปนี้สาธิตวิธีการรวม NUMBERS เข้ากับ WORD ใน Aspose.Cells for Java
...
{{% cells-merger title="ออนไลน์ฟรีเพื่อรวมตัวเลขเป็น WORD ใน Java" InputFormat="numbers" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="วิธีผสานตัวเลขเป็น WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการรวม NUMBERS เป็น WORD โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for Java](https://products.aspose.com/cells/java) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
