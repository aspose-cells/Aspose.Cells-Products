...
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení PPTX. Java Zkombinujte MHT do formátu PPTX. Sloučit MHT na PPTX v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na PPTX v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT s PPTX v Java" InputFormat="mht" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
