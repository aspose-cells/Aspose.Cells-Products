...
url: /nl/python-java/merger/merge-xlt-to-dif/ 
...
Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met DIF in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLT programmatisch samenvoegen tot DIF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
