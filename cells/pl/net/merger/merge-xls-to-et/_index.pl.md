---
title: Połącz XLS z ET - Połącz XLS z ET w C#
url: /pl/net/merger/merge-xls-to-et/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLS do formatu zapisu ET. C# Połącz XLS do formatu ET. Połącz XLS z ET w C#. XLS Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLS z ET w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLS z ET w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLS z ET. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku ET. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy XLS z ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLS z ET w C#" InputFormat="xls" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLS z ET przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć numer XLS z ET? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLS z ET" %}}
