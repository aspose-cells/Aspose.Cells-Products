...
description: Aspose Excel. C++ Tạo file BMP nhanh chóng và dễ dàng với Aspose.Cells. Tạo file BMP bằng C++. Tạo BMP trong C++. C++ BMP Creator.
...
1.  Lưu sổ làm việc dưới dạng tệp .bmp bằng phương thức Save().
