---
title: Java ODS ke CSV - Online ODS ke CSV Konverter
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Gratis Online Java Ubah ODS menjadi CSV saveformat. Java ODS ke format CSV. Simpan ODS ke CSV Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ODS menjadi CSV di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi ODS menjadi CSV. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, CSV, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke CSV di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi ODS menjadi CSV di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi ODS menjadi CSV. Unggah file ODS Anda, lalu simpan sebagai file CSV. Untuk membaca ODS dan menulis CSV Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format keluaran CSV akan identik dengan dokumen asli ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi ODS menjadi CSV Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="csv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah ODS menjadi CSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file ODS menjadi CSV secara terprogram? Pengembang Java dapat dengan mudah mengonversi ODS menjadi CSV hanya dalam beberapa baris kode.
...
1.  Ubah ODS menjadi CSV dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari ODS menjadi CSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi ODS menjadi CSV" %}}
{{% blocks/products/pf/agp/text %}}
