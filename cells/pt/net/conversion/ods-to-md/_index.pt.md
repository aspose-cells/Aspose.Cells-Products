---
title: C# ODS para MD - Conversor ODS para MD
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato MD, permitindo o salvamento perfeito de dados ODS no formato MD usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter ODS para MD em C#" h2="Biblioteca de alta velocidade C# para conversão de ODS para MD. Esta é uma solução de software profissional para importar e exportar ODS, MD e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Salve ODS para MD em C#" %}}
...
{{% cells-convert title="Código de exemplo para converter ODS em MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para MD através de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para MD programaticamente? Desenvolvedores que trabalham com .NET podem facilmente carregar e converter arquivos ODS para MD com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em MD" %}}
