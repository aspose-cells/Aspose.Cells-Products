...
url: /nl/cpp/merger/merge-txt-to-ots/ 
...
Het volgende voorbeeld laat zien hoe u TXT samenvoegt met OTS in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u TXT programmatisch samenvoegen met OTS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TXT samen te voegen met OTS" %}}
