---
title: Python PRN a NÚMEROS - Conversor de PRN a NÚMEROS
description: Aspose Excel. Esta solución integral proporciona a los desarrolladores de Python un enfoque totalmente integrado para convertir PRN a formato NUMBERS, lo que permite guardar datos PRN en formato NUMBERS sin problemas mediante la biblioteca Aspose.Cells, todo mediante código Python eficiente y personalizable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PRN a NÚMEROS en la biblioteca de Excel Python" h2="Biblioteca de Excel Python de alta velocidad para convertir PRN a NÚMEROS. Esta es una solución de software profesional para importar y exportar PRN, NÚMEROS y muchos otros formatos utilizando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PRN a NÚMEROS usando la biblioteca de Excel Python" %}}

 ¿Cómo convierto PRN a NÚMEROS? Con la biblioteca Aspose.Cells for Python, puedes convertir PRN a NÚMEROS fácilmente mediante programación con solo unas pocas líneas de código.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Guardar PRN en NÚMEROS en la biblioteca de Excel Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a NÚMEROS en la biblioteca de Excel Python.
{{% blocks/products/pf/agp/text %}}

Sigue los sencillos pasos para convertir PRN a NUMBERS. Sube tu archivo PRN y guárdalo como archivo NUMBERS. Puedes usar nombres de archivo completos tanto para leer PRN como para escribir NUMBERS. El contenido y el formato de salida de NUMBERS serán idénticos al documento PRN original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de ejemplo para convertir PRN a NÚMEROS mediante la biblioteca de Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="prn" outformat="numbers" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PRN a NÚMEROS mediante Python" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesitas convertir archivos PRN a NÚMEROS mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente archivos PRN a NÚMEROS con solo unas pocas líneas de código.
...
1.  Convierta PRN en NÚMEROS llamando al método Workbook.save.
1.  Obtenga el resultado de la conversión de PRN a NÚMEROS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Biblioteca de Excel para convertir PRN a NÚMEROS" %}}
