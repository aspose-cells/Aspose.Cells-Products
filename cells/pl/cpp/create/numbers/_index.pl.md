...
{{% blocks/products/pf/agp/content h2="Jak tworzyć NUMERY w kodzie C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik NUMBERS dla C++." offSpacer="" %}}
