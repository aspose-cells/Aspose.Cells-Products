...
description: Aspose Excel. C++ Aspose.Cells. A MHTML egyesítése XML mentési formátumba. C++ A MHTML kombinálása XML formátumba. A MHTML egyesítése XML-be a C++-ben. MHTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a MHTML-et XML-be a C++-ben" %}}
...
{{% cells-merger title="Mintakód a MHTML XML-hez való egyesítéséhez a C++-ben" InputFormat="mhtml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
