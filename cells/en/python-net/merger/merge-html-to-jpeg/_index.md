...
url: /python-net/merger/merge-html-to-jpeg/ 
...
The following example demonstrates how to merge HTML to JPEG in Aspose.Cells for Python via .NET.
...
Need to merge HTML to JPEG programmatically? A basic document merging and concatenating with [Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs can be done with just few lines of code.
