---
title: Połącz XLSB z TSV - Połącz XLSB z TSV w C#
url: /pl/net/merger/merge-xlsb-to-tsv/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLSB do TSV w formacie zapisu. C# Połącz format XLSB z TSV. Połącz XLSB z TSV w C#. XLSB Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLSB z TSV w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLSB z TSV w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLSB z TSV. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku TSV. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy numery XLSB z TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLSB z TSV w C#" InputFormat="xlsb" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSB z TSV za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLSB z TSV programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
