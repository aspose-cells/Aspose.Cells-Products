...
description: Aspose エクセル。 Python Aspose.Cells。XLT を JPG 保存形式にマージします。 Python XLT を JPG 形式に結合します。 XLT を Python の JPG に結合します。 XLT 結合します。
...
{{% cells-merger title="XLT を Python の JPG にマージするサンプルコード" InputFormat="xlt" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Pythonを介してXLTをJPGに結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLT をプログラムで JPG にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実行できます。
