...
1.  save() yöntemini kullanarak çalışma kitabını MD formatında kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, Java numaralı cihazda MD dosyasının nasıl oluşturulacağını göstermektedir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="MD dosyası oluşturmak için Java kütüphanesi" %}}
{{% blocks/products/pf/agp/text %}}
