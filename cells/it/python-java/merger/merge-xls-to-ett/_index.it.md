...
url: /it/python-java/merger/merge-xls-to-ett/ 
...
L'esempio seguente mostra come unire XLS a ETT in Aspose.Cells for Python via Java.
...
Hai bisogno di unire XLS a ETT in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Le API possono essere eseguite con poche righe di codice.
