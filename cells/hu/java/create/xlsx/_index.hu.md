...
{{< blocks/products/pf/i18n/upper-banner h1="XLSX dokumentumok létrehozása a következőn keresztül: Java" h2="Natív és nagy teljesítményű MS Excel XLSX táblázatkészítés programozottan a Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Az MS Excel XLSX fájl dinamikus generálása futó alkalmazáson belül egyszerű. Annak érdekében, hogy az XLSX dokumentumokat a semmiből hozzuk létre, MS Office nélkül, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="XLSX létrehozása a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 fejlesztők könnyen létrehozhatják, betölthetik, módosíthatják és konvertálhatják az MS Excel XLSX táblázatokat a különböző adatfeldolgozási jelentéskészítő alkalmazásokon belül, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Hozzon létre egy példányt a [Munkafüzet osztály](https://reference.aspose.com/cells/java/com.aspose.cells/Workbook).1. A megfelelő munkalapot a getWorksheets.get() metódussal érheti el.1. Válassza ki a megfelelő cellát, írja be az értéket a kívánt cellába a cellanév használatával, például A1, B3 stb.1. Mentse a munkafüzetet XLSX formátumban a save() metódussal.
...
{{% blocks/products/pf/agp/code-block title="A következő forráskód bemutatja, hogyan hozhat létre MS Excel XLSX fájlt a Java használatával." offSpacer="" %}}
...
// Mentse a munkafüzetet XLSX fájlként
wkb.save("Excel.xlsx"); 
