---
title: Déverrouiller le document XLSB via Java 
weight: 5860
url: /fr/java/unlock/xlsb/ 
description: Java exemple de code pour déverrouiller le fichier XLSB protégé par mot de passe sur Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
...
{{% blocks/products/pf/agp/content h2="Comment supprimer le fichier XLSB de protection à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour déverrouiller XLSB via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Déverrouiller les fichiers XLSB via C#" offSpacer="" %}}
