...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLS do formatu zapisu HTM. C# Połącz XLS do formatu HTM. Połącz XLS z HTM w C#. XLS Połącz.
...
Poniższy przykład pokazuje, jak scalić XLS z HTM w Aspose.Cells for .NET.
...
{{% cells-merger title="Bezpłatne połączenie online XLS z HTM w C#" InputFormat="xls" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić XLS z HTM przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić numer XLS z HTM? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
