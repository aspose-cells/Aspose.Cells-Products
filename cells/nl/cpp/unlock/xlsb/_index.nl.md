...
{{% blocks/products/pf/agp/content h2="Bescherming van XLSB-bestand verwijderen met C++" %}}
...
1. Laad XLSB-vergrendeld bestand met CreateIWorkbook.1. Roep de functie Unprotect() aan om te ontgrendelen.1. Stel het wachtwoord in op NULL met behulp van SetPassword.1. Sla XLSB-bestand op een opgegeven locatie op.
