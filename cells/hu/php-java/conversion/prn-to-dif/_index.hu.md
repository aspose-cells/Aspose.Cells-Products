...
{{% blocks/products/pf/agp/content h2="Hogyan lehet PRN-t DIF-re konvertálni PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell PRN fájlokat DIF formátumba konvertálni? A PHP fejlesztők könnyedén betölthetik és konvertálhatják a PRN fájlokat DIF formátumba mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/content h2="PHP könyvtár a PRN DIF-re konvertálásához" %}}
