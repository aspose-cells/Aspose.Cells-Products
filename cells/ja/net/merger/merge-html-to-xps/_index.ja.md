...
url: /ja/net/merger/merge-html-to-xps/ 
...
{{% cells-merger title="オンラインでHTMLをXPSにマージする無料アプリ" InputFormat="html" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2=".NET HTML を XPS にマージするライブラリ" %}}
