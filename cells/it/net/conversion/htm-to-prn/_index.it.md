---
title: C# Convertitore da HTM a PRN - Convertitore da HTM a PRN
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori C# un approccio completamente integrato per convertire il formato HTM in PRN, consentendo il salvataggio senza interruzioni dei dati HTM in formato PRN utilizzando la libreria Aspose.Cells, il tutto tramite codice C# efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva HTM in PRN in C#" %}}

L'esempio seguente mostra come convertire HTM in PRN in C#.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire HTM in PRN. Carica il tuo file HTM, quindi salvalo semplicemente come file PRN. Sia per la lettura HTM che per la scrittura PRN è possibile utilizzare nomi file completi. Il contenuto e la formattazione del PRN di output saranno identici al documento HTM originale.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Codice di esempio per convertire HTM in PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Come convertire HTM in PRN tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file HTM in PRN a livello di codice? .NET gli sviluppatori possono caricare e convertire facilmente HTM in PRN in poche righe di codice.
...
1.  Convertire HTM in PRN chiamando il metodo Workbook.Save.
1.  Ottieni il risultato della conversione da HTM a PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C# per convertire HTM in PRN" %}}
