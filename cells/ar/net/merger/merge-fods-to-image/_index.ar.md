---
title: دمج FODS في IMAGE - اجمع FODS إلى IMAGE في C#
url: /ar/net/merger/merge-fods-to-image/ 
description: Aspose إكسل. C# Aspose.Cells. الدمج المجاني عبر الإنترنت FODS إلى IMAGE saveformat. C# اجمع FODS إلى تنسيق IMAGE. دمج FODS إلى IMAGE في C#. FODS دمج.
...
{{% blocks/products/pf/agp/content h2="دمج FODS في IMAGE في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج FODS في IMAGE في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج FODS في IMAGE. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف IMAGE. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج FODS إلى IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني عبر الإنترنت لدمج FODS مع IMAGE في C#" InputFormat="fods" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج FODS مع IMAGE عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج FODS في IMAGE برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة .NET لدمج FODS إلى IMAGE" %}}
