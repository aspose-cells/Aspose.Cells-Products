---
title: C# PRN'den XLS'e - PRN'den XLS'e dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere PRN'yi XLS formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak PRN verilerinin XLS formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="PRN kodunu XLS numarasına C# numarasından kaydedin." %}}

Aşağıdaki örnek, C# numaralı kodda PRN kodunun XLS koduna nasıl dönüştürüleceğini göstermektedir.
...
{{% cells-convert title="PRN\'yi XLS\'e Dönüştürmek İçin Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="prn" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla XLS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PRN dosyalarını programlı olarak XLS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PRN'yi kolayca yükleyebilir ve XLS'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak PRN'yi XLS'e dönüştürün.
1.  PRN'nin dönüşüm sonucunu XLS'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# kütüphanesi, PRN\'yi XLS\'e dönüştürüyor." %}}
