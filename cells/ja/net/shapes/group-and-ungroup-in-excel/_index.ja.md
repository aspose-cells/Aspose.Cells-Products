...
{{% blocks/products/pf/agp/content h2="C# を使用して Excel ファイル内の図形をグループ化およびグループ解除する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# 経由で Excel ファイル内の図形をグループ化およびグループ解除する手順" %}}
...
+ インデックスからワークシートを選択します。
 + を使用してください[グループメソッド](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/group/)選択したワークシート内の図形をグループ化するには
 + を使用してください[グループ解除メソッド](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/)選択したワークシート内の図形のグループ化を解除するには
...
{{% blocks/products/pf/agp/code-block title="図形のグループ化とグループ化解除 - C#" offSpacer="" %}}
