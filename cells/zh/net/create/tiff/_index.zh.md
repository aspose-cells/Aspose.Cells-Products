---
title: 创建TIFF - 在C#中创建TIFF文件
description: Aspose Excel。 C# 使用 Aspose.Cells 快速轻松地创建 TIFF 文件。使用 C# 生成 TIFF 文件。在 C# 中创建 TIFF。C# TIFF 创建者。
...
{{< blocks/products/pf/i18n/upper-banner h1="在C#中创建TIFF文件" h2="用于创建TIFF的高速C#库。这是一个专业的软件解决方案，可在.NET Framework、.NET Core或Mono平台上导入和导出XLSX、PDF和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何在C#中创建TIFF" %}}
...
{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 C# 中创建 TIFF 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#库创建TIFF文件" %}}
