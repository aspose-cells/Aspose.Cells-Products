---
title: Conversor PHP XLTX para ODS - XLTX para ODS
description: Aspose Excel. Converta XLTX em ODS de forma rápida e fácil com Aspose.Cells. PHP XLTX em ODS. PHP Salve XLTX em ODS. Salve XLTX como ODS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em ODS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em ODS programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em ODS em apenas algumas linhas de código.
...
1.  Converta XLTX em ODS chamando o método save da pasta de trabalho.
