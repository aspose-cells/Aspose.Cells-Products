...
weight: 371
description: Agrupar e desagrupar objetos usando Aspose.Cells' Python via Java API sem qualquer software como Microsoft ou Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Como agrupar e desagrupar formas em arquivo Excel usando Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para agrupar e desagrupar formas em arquivo Excel usando Python via Java" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Utilize o[método de grupo](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#group(com.aspose.cells.Shape[])) para agrupar formas na planilha selecionada
 + Utilize o[método de desagrupar](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#ungroup(com.aspose.cells.GroupShape)) para desagrupar formas na planilha selecionada
