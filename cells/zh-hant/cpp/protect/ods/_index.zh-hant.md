---
title: 透過 C++ 保護和鎖定 ODS 文檔
weight: 10010
description: 在 C++ 執行環境（適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元）上使用密碼鎖定 ODS 檔案的 C++ 範例程式碼。
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 保護 ODS 文件的步驟" %}}
...
1. 使用Workbook類別載入ODS文件
1. 使用具有 ProtectionType 和密碼的 Protect(..) 方法
1. 透過Save()方法保存受保護的ODS文件
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="免費保護應用程式 ODS" sectionDescription="查看我們的現場演示[加密ODS文件](https://products.aspose.app/cells/protect/ods)具有以下好處。" >}}
