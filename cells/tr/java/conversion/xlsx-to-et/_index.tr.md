...
description: Aspose Excel'de. Aspose.Cells ile XLSX'i hızlı ve kolay bir şekilde ET'ye dönüştürün. Java XLSX'i ET'ye dönüştürün. Java XLSX'i ET'ye kaydedin. Java'i kullanarak XLSX'i ET olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="XLSX\'i Java\'i kullanarak ET\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="XLSX\'i Java\'de ET\'ye kaydedin" %}}

Aşağıdaki örnek, XLSX'in Java'de ET'ye nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="XLSX\'i ET\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="et" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="XLSX\'i ET via Java\'e Dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLSX dosyalarını program aracılığıyla ET'ye dönüştürmeniz mi gerekiyor? Java geliştiricileri, yalnızca birkaç satır kodla XLSX'i kolayca ET'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="XLSX\'i ET\'ye dönüştürmek için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
