...
description: Aspose Exceller. Python Exceller. Fusionnez XLS au format de sauvegarde JPG. Python Combinez XLS au format JPG. Fusionnez XLS en JPG dans la bibliothèque Excel Python. XLS Fusionner.
...
{{% cells-merger title="Exemple de code pour fusionner XLS en JPG dans la bibliothèque Excel Python" InputFormat="xls" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS en JPG via la bibliothèque Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLS en JPG par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner XLS en JPG" %}}
