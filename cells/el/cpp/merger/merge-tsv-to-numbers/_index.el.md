---
title:  Συγχώνευση TSV σε NUMBERS μέσω C++
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το TSV με το NUMBERS στο C++.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση TSV με NUMBERS σε απευθείας σύνδεση" InputFormat="tsv" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
