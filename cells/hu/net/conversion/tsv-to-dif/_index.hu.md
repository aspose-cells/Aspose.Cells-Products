...
description: Aspose Excel. A TSV-es számot DIF-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# TSV-DIF-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a TSV-DIF számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a TSV-et DIF-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a TSV DIF-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A TSV konvertálása DIF-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A TSV fájlt programozottan DIF-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a TSV-et DIF-re.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a TSV konvertálásához DIF-re" %}}
