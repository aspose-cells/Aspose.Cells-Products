...
{{% blocks/products/pf/agp/content h2="Jak rozdělit soubor XLS pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro rozdělení souborů XLS v Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Rozdělit XLS Soubor - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API lze použít k vytváření, úpravám, převodu a vykreslování Microsoft formátů Excelu do různých formátů. Kromě toho jej lze použít pro komplexní vytváření grafů, škálovatelný reporting a spolehlivé výpočty v rámci softwarových aplikací. Aspose.Cells je samostatný API a nevyžaduje žádný software jako Microsoft nebo OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online živé ukázky XLS Splitter" sectionDescription=" Rozdělte dokument XLS právě teď na našem webu[Webová stránka živé ukázky](https://products.aspose.app/cells/splitter). Živé demo má následující výhody" >}}
