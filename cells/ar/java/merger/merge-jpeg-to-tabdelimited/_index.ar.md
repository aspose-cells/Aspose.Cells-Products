---
title: دمج JPEG في TABDELIMITED - اجمع JPEG إلى TABDELIMITED في Java
url: /ar/java/merger/merge-jpeg-to-tabdelimited/ 
description: Aspose إكسل. Java Aspose.Cells. دمج مجاني على الإنترنت JPEG إلى TABDELIMITED saveformat. Java اجمع JPEG إلى تنسيق TABDELIMITED. دمج JPEG إلى TABDELIMITED في Java. JPEG دمج.
...
{{% blocks/products/pf/agp/content h2="دمج JPEG في TABDELIMITED في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج JPEG إلى TABDELIMITED في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج JPEG في TABDELIMITED. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف TABDELIMITED. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج JPEG إلى TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج JPEG في TABDELIMITED في Java" InputFormat="jpg" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج JPEG في TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج JPEG في TABDELIMITED برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Java مكتبة لدمج JPEG إلى TABDELIMITED" %}}
