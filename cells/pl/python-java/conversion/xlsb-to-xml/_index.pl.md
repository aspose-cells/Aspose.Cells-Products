...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSB na XML za pomocą Aspose.Cells. Python XLSB na XML. Python Zapisz XLSB w formacie XML. Zapisz XLSB jako XML, używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLSB na XML za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB w formacie XML w Python" %}}

Poniższy przykład ilustruje, jak przekonwertować XLSB na XML w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji XLSB na XML" %}}
