---
title:  Dodaj lub usuń XLS Adnotacja via Java
weight: 10040
description: Java przykładowy kod do usuwania adnotacji w formacie XLS w środowisku wykonawczym Java dla aplikacji JSP/JSF i aplikacji komputerowych.
...
{{% blocks/products/pf/agp/content h2="Jak dodać adnotację do pliku XLS za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby dodać lub usunąć adnotację z numeru XLS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń adnotacje z numerów XLS–Java" offSpacer="" %}}
