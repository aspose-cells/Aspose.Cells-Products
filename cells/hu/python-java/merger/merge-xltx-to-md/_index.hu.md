...
url: /hu/python-java/merger/merge-xltx-to-md/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLTX-et a Aspose.Cells-es for Python-es via Java-es MD-vel.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLTX-et az MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
