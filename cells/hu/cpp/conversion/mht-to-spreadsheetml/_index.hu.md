...
description: Aspose Excel. A Aspose.Cells. C++ MHT-t SPREADSHEETML-re gyorsan és egyszerűen konvertálja SPREADSHEETML-be. C++ MHT mentése SPREADSHEETML-be. Mentse az MHT-t SPREADSHEETML-ként a C++ számon.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja az MHT-t SPREADSHEETML-be a C++-ben" h2="Nagy teljesítményű MHT konvertálás SPREADSHEETML-be a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertálja az MHT-t SPREADSHEETML-be a C++ használatával" %}}
...
{{% blocks/products/pf/agp/content h2="Mentse az MHT-t a SPREADSHEETML-be a C++ számon" %}}

A következő példa bemutatja, hogyan lehet az MHT-t SPREADSHEETML-re konvertálni a C++-ben.
...
Programozottan kell konvertálnia az MHT fájlokat SPREADSHEETML formátumba? A C++ fejlesztők könnyedén konvertálhatják az MHT-t SPREADSHEETML-be, mindössze néhány sornyi kóddal.
...
1.  Konvertálja az MHT-t SPREADSHEETML-be a Save() metódus meghívásával.
