---
title: Convertir XLS en TIFF via Python
url: /fr/python-java/conversion/xls-to-tiff/
description: Exemple de code pour la conversion xls en tiff Python. Utilisez l'exemple de code API pour les fichiers batch xls en conversion tiff dans l'application Python.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en TIFF en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en TIFF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir des fichiers XLS au format TIFF en quelques lignes de code seulement.
