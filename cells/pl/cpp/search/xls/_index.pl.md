---
title:  Wyszukaj dokument XLS bez otwierania za pośrednictwem C++
weight: 4560
description: C++ przykładowy kod wyszukiwania słów z wzorcem w pliku XLS w C++ Runtime Environment dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
---
...
Załaduj plik XLS, tworząc instancję klasy IWorkbook.
...
+ Zapisz plik XLS przy użyciu metody IWorkbook->Save(.).
