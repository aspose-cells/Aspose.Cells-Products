---
title: C# XLSB から DOCX - オンライン XLSB から DOCX コンバータ
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# XLSB を DOCX 保存形式に変換します。 C# XLSB ～ DOCX の形式。 XLSB から DOCX C# を保存します。
...
{{% blocks/products/pf/agp/content h2="C# に XLSB から DOCX をオンラインで無料で保存" %}}

次の例は、XLSB を C# の DOCX に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、XLSB を DOCX に変換します。XLSB ファイルをアップロードし、DOCX ファイルとして保存するだけです。 XLSB 読み取りと DOCX 書き込みの両方で、完全修飾ファイル名を使用できます。出力 DOCX のコンテンツと形式は、元の XLSB ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="オンラインでXLSBをDOCXに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でXLSBをDOCXに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSB ファイルをプログラムで DOCX に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLSB を簡単にロードして DOCX に変換できます。
