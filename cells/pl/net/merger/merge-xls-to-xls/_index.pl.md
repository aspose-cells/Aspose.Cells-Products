...
url: /pl/net/merger/merge-xls-to-xls/ 
...
Poniższy przykład pokazuje, jak połączyć XLS z XLS w Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz scalić XLS z XLS programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLS z XLS" %}}
