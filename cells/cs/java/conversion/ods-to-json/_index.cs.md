---
title: Převést ODS na JSON prostřednictvím Java 
weight: 4670
url: /cs/java/conversion/ods-to-json/ 
description: Ukázkový konverzní kód Java pro formát ODS na soubor JSON. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do formátu JSON v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODS na JSON prostřednictvím Java" h2="Převod ODS na JSON Java pro převod jedné nebo více stránek na JSON pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na JSON pomocí Java" %}}

 K vykreslení ODS do JSON použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na JSON prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na JSON pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Vytvořte rozsah dat k exportu pomocí metody Cells.createRange1. Volání metody JsonUtility.exportRangeToJson s odkazy na Range & ExportRangeToJsonOptions1. Zápis dat String JSON do souboru pomocí metody BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu ODS na JSON Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze ODS na JSON" sectionDescription="[Převést ODS na JSON](https://products.aspose.app/cells/conversion/ods-to-json) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor ODS, bude okamžitě převeden na JSON." >}}
