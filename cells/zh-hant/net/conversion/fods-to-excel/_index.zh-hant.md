---
title: C# FODS轉EXCEL - 在線FODS轉EXCEL轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將FODS轉換為EXCEL保存格式。 C# FODS 為 EXCEL 格式。將 FODS 保存到 EXCEL C#。
...
{{% blocks/products/pf/agp/content h2="免費將 FODS 保存到 C# 在線 EXCEL" %}}

下面的例子演示瞭如何將FODS轉換為EXCEL中的C#。
...
{{% cells-convert title="免費應用程序和示例代碼，可在線將 FODS 轉換為 EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 FODS 轉換為 EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 FODS 文件轉換為 EXCEL？ .NET 開發人員只需幾行代碼即可輕鬆加載 FODS 並將其轉換為 EXCEL。
...
{{% blocks/products/pf/agp/content h2="C#庫將FODS轉換為EXCEL" %}}
