---
title: Konvertera TABDELIMITED till ODS via C#

description: Exempelkod för tabbavgränsad till ods C#-omvandling. Använd API exempelkod för batch-tabbavgränsade filer till ods-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-utvecklare kan enkelt ladda och konvertera TABDELLIMITED-filer till ODS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda TABDELIMITED-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med ODS-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande ODS-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera TABDELIMITED till ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="ods" IsLandingPage="true" %}}
