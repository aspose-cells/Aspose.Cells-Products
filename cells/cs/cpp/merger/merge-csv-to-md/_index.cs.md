...
url: /cs/cpp/merger/merge-csv-to-md/ 
...
Následující příklad ukazuje, jak sloučit CSV do MD v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení CSV na MD v C++" InputFormat="csv" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV na MD přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit CSV na MD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna ke sloučení CSV na MD" %}}
