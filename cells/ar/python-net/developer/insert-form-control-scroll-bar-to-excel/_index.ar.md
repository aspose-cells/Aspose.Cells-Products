---
title:  أدخل شريط التمرير (التحكم في النموذج) في Excel باستخدام Python via .Net
weight: 90
description: Python via .Net كود المصدر لإدراج ScrollBar (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شريط التمرير (التحكم في النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج شريط التمرير (تحكم النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_scroll_bar/#int-int-int-int-int-int) لإدراج شريط التمرير (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل شريط التمرير (التحكم في النموذج) - Python via .Net" offSpacer="" %}}
