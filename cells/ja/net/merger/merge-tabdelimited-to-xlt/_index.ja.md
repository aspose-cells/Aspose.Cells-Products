---
title:  TABDELIMITED を C# 経由で XLT にマージします
url: /ja/net/merger/merge-tabdelimited-to-xlt/ 
description: TABDELIMITED をオンラインで無料で XLT にマージします。無料オンライン TABDELIMITED から XLT 合併。 TABDELIMITED を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、TABDELIMITED を C# の XLT にマージする方法を示しています。
...
{{% cells-merger title="TABDELIMITEDをオンラインでXLTにマージする無料アプリ" InputFormat="tsv" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
