...
description: Sample code for html to xlsb C# conversion. Use API example code for batch html files to xlsb conversion within VB.NET, Asp.NET or any .NET based application.
---
