---
title: Python XLSX do PDF - XLSX do PDF Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu XLSX do PDF, umożliwiając bezproblemowe zapisywanie danych XLSX do formatu PDF za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSX na PDF w Python Biblioteka Excel" h2="Szybka biblioteka Excel Python do konwersji XLSX na PDF. Skorzystaj z naszej konwersji Excel API, aby opracować zaawansowane, niezależne od platformy oprogramowanie w Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLSX na PDF w Python Biblioteka Excel" %}}

 Jak przekonwertować numer XLSX na numer PDF? Dzięki bibliotece Aspose.Cells for Python przez NET możesz łatwo programowo przekonwertować XLSX na PDF za pomocą kilku linijek kodu.[Aspose.Cells for Python pod numerem NET](https://pypi.org/project/aspose-cells-python/)potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Zapisz XLSX do PDF w Python Bibliotece Excel" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSX na PDF w bibliotece Excel Python.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer XLSX na numer PDF. Prześlij plik XLSX, a następnie po prostu zapisz go jako plik PDF. Zarówno do odczytu XLSX, jak i do zapisu PDF można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego PDF będą identyczne z oryginalnym dokumentem XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLSX na PDF za pośrednictwem biblioteki Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="pdf" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na PDF" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSX na PDF? Programiści Python mogą łatwo załadować i przekonwertować XLSX na PDF w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSX na numer PDF, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLSX na PDF.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Biblioteka Excel do konwersji XLSX na PDF" %}}
