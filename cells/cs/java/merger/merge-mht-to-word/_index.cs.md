---
title: Sloučit MHT do WORD - Zkombinujte MHT do WORD v Java
url: /cs/java/merger/merge-mht-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit MHT do formátu uložení WORD. Java Zkombinujte formát MHT s formátem WORD. Sloučit MHT do WORD v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do WORD v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit MHT do WORD v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT do WORD. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení MHT do WORD v Java" InputFormat="mht" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT do WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit MHT do WORDu? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna pro sloučení MHT do WORD" %}}
