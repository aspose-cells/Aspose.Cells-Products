...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke PRN menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengkonversi XLTX ke PRN di C++.
...
Perlu mengkonversi file XLTX ke PRN secara terprogram? Pengembang C++ dapat dengan mudah mengkonversi XLTX ke PRN hanya dengan beberapa baris kode.
...
1.  Konversikan XLTX ke PRN dengan memanggil metode Save().
1.  Dapatkan hasil konversi XLTX ke PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ perpustakaan untuk mengkonversi XLTX ke PRN" %}}
