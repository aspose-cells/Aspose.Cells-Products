---
title:  Toevoegen of verwijderen XLS Annotatie via .NET
weight: 9270
...
{{% blocks/products/pf/agp/text %}}
 ...
 om de code in uw omgeving uit te proberen.

{{% /blocks/products/pf/agp/text %}}

+ Laad het bestand XLS door een exemplaar van Workbook te maken
+ Voeg commentaar toe aan het werkblad in a Cell
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/annotation/ods/" name="ODS" description="OpenDocument-spreadsheetbestand" >}}
