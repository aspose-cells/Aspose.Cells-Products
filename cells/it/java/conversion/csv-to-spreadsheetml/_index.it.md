---
title: Converti CSV in SPREADSHEETML tramite Java 

description: Esempio di codice di conversione Java per il formato CSV in file SPREADSHEETML. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in SPREADSHEETML all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti CSV in SPREADSHEETML tramite Java" h2="Conversione da CSV a SPREADSHEETML Java per convertire pagine singole o multiple in SPREADSHEETML utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire CSV in SPREADSHEETML utilizzando Java" %}}

 Per eseguire il rendering di CSV in SPREADSHEETML, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire CSV in SPREADSHEETML tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente file CSV in SPREADSHEETML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file CSV con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione SPREADSHEETML e SaveFormat come parametri1. Controllare il percorso specificato per il file SPREADSHEETML risultante
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da CSV a SPREADSHEETML Java" offSpacer="" %}}

```cs
// caricare il file CSV in un'istanza di Workbook
Workbook book = new Workbook("template.csv");
// salva CSV come SPREADSHEETML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da CSV a SPREADSHEETML" sectionDescription="[Converti CSV in SPREADSHEETML](https://products.aspose.app/cells/conversion/csv-to-spreadsheetml) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file CSV, verrà convertito istantaneamente in SPREADSHEETML." >}}
