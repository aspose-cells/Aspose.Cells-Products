---
title: Mescle SXC para PRN - Combine SXC para PRN em C#
url: /pt/net/merger/merge-sxc-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita SXC para PRN saveformat. C# Combine SXC para o formato PRN. Mesclar SXC para PRN em C#. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC para PRN em C# online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar SXC com PRN em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar SXC com PRN. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo PRN. Se você desenvolver código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla SXC com PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar SXC para PRN em C#" InputFormat="sxc" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC para PRN via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SXC para PRN programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar SXC para PRN" %}}
