---
title: PHP XLAM a MHT - Convertidor de XLAM a MHT
description: Aspose Excel. Convierta XLAM a MHT rápida y fácilmente con Aspose.Cells. PHP XLAM a MHT. PHP Guarde XLAM en MHT. Guarde XLAM como MHT usando PHP.
...
{{% cells-convert title="Código de muestra para convertir XLAM a MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="mht" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XLAM a MHT mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLAM a MHT mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente XLAM a MHT en tan solo unas pocas líneas de código.
...
1.  Convierta XLAM a MHT llamando al método de guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de XLAM a MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir XLAM a MHT" %}}
