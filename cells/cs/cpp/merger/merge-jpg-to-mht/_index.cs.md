...
url: /cs/cpp/merger/merge-jpg-to-mht/ 
...
Následující příklad ukazuje, jak sloučit JPG do MHT v Aspose.Cells for C++.
...
Potřebujete sloučit JPG do MHT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení JPG do MHT" %}}
