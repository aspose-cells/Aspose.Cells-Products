---
title: Converter XLSM para XML por meio do aplicativo C++ 

description: Exemplo de código de conversão C++ para documento XLSM para formato XML. Os programadores podem usar esse código-fonte para conversão em lote de XLSM para XML em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/content h2="Como converter XLSM para XML usando C++" %}}

 Para converter XLSM para XML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter XLSM para XML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ os desenvolvedores podem facilmente converter arquivos XLSM para XML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo XLSM usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (XML).1. O arquivo XML será salvo no caminho especificado.1. Abra o arquivo XML em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLSM para XML C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de XLSM para XML" sectionDescription="[Converter XLSM para XML](https://products.aspose.app/cells/conversion/xlsm-to-xml) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo XLSM, ele será convertido instantaneamente para XML." >}}
