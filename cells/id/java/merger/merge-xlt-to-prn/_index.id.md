---
title: Gabungkan XLT ke PRN - Gabungkan XLT ke PRN di Java
url: /id/java/merger/merge-xlt-to-prn/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLT ke format simpan PRN. Java Gabungkan XLT ke format PRN. Gabungkan XLT ke PRN di Java. XLT Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLT ke PRN di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLT ke PRN di Java" InputFormat="xlt" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLT menjadi PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLT ke PRN secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
