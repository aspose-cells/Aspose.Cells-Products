---
title: Konversikan SXC ke ODS melalui Java 
url: /id/java/conversion/sxc-to-ods/ 
description: Contoh Java kode konversi untuk format SXC ke file ODS. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke ODS dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan SXC ke ODS melalui Java" h2="Konversi SXC ke ODS Java untuk mengonversi satu atau beberapa halaman ke ODS menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi SXC ke ODS Menggunakan Java" %}}

 Untuk merender SXC ke ODS, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi SXC ke ODS melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file SXC ke ODS hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file SXC dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi ODS & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file ODS yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="SXC ke ODS Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file SXC dalam contoh Workbook
Workbook book = new Workbook("template.sxc");
// simpan SXC sebagai ODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi SXC ke ODS" sectionDescription="[Konversikan SXC ke ODS](https://products.aspose.app/cells/conversion/sxc-to-ods) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file SXC Anda, itu akan langsung dikonversi ke ODS." >}}
