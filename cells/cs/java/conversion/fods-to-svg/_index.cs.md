...
{{% blocks/products/pf/agp/content h2="Jak převést FODS na SVG pomocí Java" %}}

 K vykreslení FODS do SVG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu FODS na SVG prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor FODS na SVG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor FODS s instancí Workbooku1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Voláním metody SheetRender.toImage uložíte výsledek ve formátu SVG
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze FODS na SVG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze FODS na SVG" sectionDescription="[Převést FODS na SVG](https://products.aspose.app/cells/conversion/fods-to-svg) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor FODS, bude okamžitě převeden na SVG." >}}
