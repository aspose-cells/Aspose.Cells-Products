...
{{% blocks/products/pf/agp/content h2="วิธีแทรก RadioButton ลงในไฟล์ Excel โดยใช้ C#" %}}
 ...
 ในการแทรก RadioButton ลงในไฟล์ excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก RadioButton ไปยังไฟล์ Excel ผ่าน C#" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addradiobutton) เพื่อแทรก RadioButton ในเวิร์กชีตที่เลือก
