...
url: /hu/cpp/merger/merge-mhtml-to-sql/ 
...
A következő példa bemutatja, hogyan egyesítheti a MHTML-et az SQL-lel a Aspose.Cells for C++-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a MHTML-et az SQL-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a MHTML SQL-be olvasztásához" %}}
