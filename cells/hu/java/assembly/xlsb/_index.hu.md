...
{{% blocks/products/pf/agp/content h2="XLSB-es jelentések létrehozása a Java-es szám használatával" %}}

 A XLSB fájl jelentések létrehozásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="A XLSB-es jelentések létrehozásának lépései via Java" %}}
...
1.  Az eredmény mentése XLSB formátumban a Worbook.save módszerrel
