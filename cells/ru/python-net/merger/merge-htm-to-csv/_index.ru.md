...
url: /ru/python-net/merger/merge-htm-to-csv/ 
...
В следующем примере показано, как объединить HTM с CSV в Aspose.Cells for Python via .NET.
...
Нужно программно объединить HTM с CSV? Базовый документ сливается и объединяется с[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API можно реализовать всего несколькими строками кода.
