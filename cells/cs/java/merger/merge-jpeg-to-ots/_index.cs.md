---
title: Sloučit JPEG na OTS - Sloučit JPEG na OTS v Java
url: /cs/java/merger/merge-jpeg-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma JPEG do formátu OTS. Java Zkombinujte JPEG do formátu OTS. Sloučit JPEG do OTS v Java. JPEG Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG do OTS pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG do OTS v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JPEG do OTS v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPEG s OTS. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru OTS. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí JPEG do OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JPEG do OTS v Java" InputFormat="jpg" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPEG do OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit JPEG do OTS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení JPEG do OTS" %}}
