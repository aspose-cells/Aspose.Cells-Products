---
title:  Protéger et verrouiller le document XLS via Java
weight: 5070
description: Exemple de code Java pour verrouiller le fichier XLS à l'aide d'un mot de passe sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chiffrer les fichiers XLS via Java" h2="Protégez par mot de passe les feuilles de calcul Excel, y compris le format XLS, à l\'aide de la bibliothèque .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment sécuriser le fichier XLS à l\'aide de Java" %}}
...
1.  Chargez le fichier XLS en instanciant la classe Workbook
