...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصورة إلى SXC في C++" h2="تحويل IMAGE عالي الأداء إلى SXC باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى SXC برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى SXC بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى SXC عن طريق استدعاء طريقة Save().
