...
description: Aspose Excel. Converta XLS em DIF de forma rápida e fácil com Aspose.Cells. C++ XLS em DIF. C++ Salve XLS em DIF. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em DIF usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para DIF em C++" %}}

O exemplo a seguir demonstra como converter XLS em DIF em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="dif" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em DIF por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em DIF programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em DIF em apenas algumas linhas de código.
...
1.  Converta XLS em DIF chamando o método Save().
