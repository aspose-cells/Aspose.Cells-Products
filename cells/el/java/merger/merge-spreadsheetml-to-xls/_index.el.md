---
title:  Συγχώνευση SPREADSHEETML στο XLS via Java
url: /el/java/merger/merge-spreadsheetml-to-xls/ 
description: Συγχώνευση SPREADSHEETML στο XLS Online δωρεάν. Δωρεάν Online SPREADSHEETML to XLS Merger. Συγχώνευση SPREADSHEETML σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SPREADSHEETML στο XLS στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση SPREADSHEETML στο XLS σε απευθείας σύνδεση" InputFormat="xml" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
