---
title: C# XLSX para PPTX - Online XLSX para PPTX Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter XLSX para PPTX saveformat. C# XLSX a PPTX formato. Salve XLSX a PPTX C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSX para PPTX em C#" h2="Biblioteca C# de alta velocidade para converter XLSX em PPTX. Esta é uma solução de software profissional para importar e exportar XLSX, PPTX e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="Aplicativo gratuito e código de amostra para converter XLSX em PPTX online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para PPTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para PPTX programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter XLSX em PPTX em apenas algumas linhas de código.
