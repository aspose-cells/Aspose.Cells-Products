---
title: Python NUMARALAR'dan XLS'e - NUMARALAR'dan XLS'e Dönüştürücü
description: Aspose Excel'de. Python Excel'de. NUMBERS'ı Aspose.Cells ile hızlı ve kolay bir şekilde XLS'e dönüştürün. Python NUMBERS'ı XLS'e dönüştürün. Python NUMBERS'ı XLS'e kaydedin. NUMBERS'ı Python Excel Kitaplığı'nı kullanarak XLS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="NUMBERS\'ı Python aracılığıyla XLS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı programlı olarak XLS'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyip XLS'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak NUMBERS'ı XLS'e dönüştürün.
1.  NUMBERS'ın dönüşüm sonucunu XLS'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python NUMARALARI XLS\'e Dönüştürmek için Excel Kitaplığı" %}}
