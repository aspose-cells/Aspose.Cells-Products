...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde EXCEL'i ODS'e dönüştürün. Python EXCEL'i ODS'e dönüştürün. Python EXCEL'i ODS'e kaydedin. Python'i kullanarak EXCEL'i ODS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'de EXCEL\'i ODS\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i Python\'de ODS\'e kaydedin" %}}

Aşağıdaki örnek, EXCEL'in Python via NET'de ODS'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="EXCEL\'i ODS\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ods" IsLandingPage="true" language="pythonnet" %}}
