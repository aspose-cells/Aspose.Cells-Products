...
{{% blocks/products/pf/agp/content h2="How to Create SVG in Node.js" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to create, load, modify and convert SVG files within running reporting applications for data processing in just few lines of code.
...
1.  Save the workbook as .svg file using Save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create SVG file in Node.js." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Node.js library to create SVG file" %}}
