---
title:  Sloučit ODS na XLTM přes Python
url: /cs/python-java/merger/merge-ods-to-xltm/ 
description: Sloučit ODS až XLTM online zdarma. Online zdarma ODS až XLTM Fúze. Sloučit ODS do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit ODS až XLTM v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení ODS až XLTM online" InputFormat="ods" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
