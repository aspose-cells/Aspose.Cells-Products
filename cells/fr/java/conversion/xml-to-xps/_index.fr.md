...
description: Aspose Exceller. Convertissez XML en XPS rapidement et facilement avec Aspose.Cells. Java XML en XPS. Java Enregistrez XML en XPS. Enregistrez XML sous XPS en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en XPS à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au XPS dans Java" %}}

L'exemple suivant montre comment convertir XML en XPS en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XML en XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en XPS par programme ? Les développeurs Java peuvent facilement convertir XML en XPS en quelques lignes de code seulement.
