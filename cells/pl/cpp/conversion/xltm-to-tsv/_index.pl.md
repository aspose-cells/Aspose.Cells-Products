---
title: Konwertuj XLTM na TSV za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltm-to-tsv/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTM do formatu TSV. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTM na TSV w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLTM na TSV przez C++" h2="Wysokowydajna konwersja XLTM do TSV przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLTM na TSV w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (TSV).1. Plik TSV zostanie zapisany pod określoną ścieżką.1. Otwórz plik TSV w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLTM do TSV C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z XLTM do TSV" sectionDescription="[Konwertuj XLTM na TSV](https://products.aspose.app/cells/conversion/xltm-to-tsv) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLTM, zostanie on natychmiast przekonwertowany do TSV." >}}
