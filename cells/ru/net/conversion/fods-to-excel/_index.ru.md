---
title: C# FODS в EXCEL - FODS в EXCEL Конвертер
description: Aspose Эксель. Преобразуйте FODS в EXCEL быстро и легко с помощью Aspose.Cells. C# FODS в EXCEL. C# Сохраните FODS в EXCEL. Сохраните FODS как EXCEL, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в EXCEL в C#." %}}

В следующем примере показано, как преобразовать FODS в EXCEL в C#.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы преобразовать FODS в EXCEL. Загрузите файл FODS, а затем просто сохраните его как файл EXCEL. Как для чтения FODS, так и для записи EXCEL вы можете использовать полные имена файлов. Выходное содержимое EXCEL и форматирование будут идентичны исходному документу FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Пример кода для преобразования FODS в EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать FODS в EXCEL с помощью C#" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно конвертировать файлы FODS в EXCEL? Разработчики .NET могут легко загрузить и преобразовать FODS в EXCEL всего за несколько строк кода.
...
1.  Получите результат конвертации FODS в EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования FODS в EXCEL" %}}
