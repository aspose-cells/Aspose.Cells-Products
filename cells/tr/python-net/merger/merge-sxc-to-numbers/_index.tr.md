...
url: /tr/python-net/merger/merge-sxc-to-numbers/ 
...
Aşağıdaki örnek, SXC'in Aspose.Cells for Python via .NET'de NUMBERS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 SXC'i programlı olarak NUMBERS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
