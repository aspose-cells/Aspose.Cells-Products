...
description: Aspose Excel. Konwertuj XML na SXC szybko i łatwo za pomocą Aspose.Cells. C++ XML na SXC. C++ Zapisz XML na SXC. Zapisz XML jako SXC używając C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XML na SXC w C++" h2="Wysokowydajna konwersja XML do SXC przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj XML na SXC, używając C++" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem SXC w C++" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na SXC w C++.
...
Chcesz programowo przekonwertować pliki XML na SXC? Programiści C++ mogą łatwo przekonwertować XML na SXC w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XML na SXC, wywołując metodę Save().
1.  Uzyskaj wynik konwersji XML na SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C++ do konwersji XML na SXC" %}}
