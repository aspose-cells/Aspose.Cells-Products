---
title: Java을(를) 통해 XLS 문서에서 텍스트 검색 및 바꾸기 
weight: 7900
url: /ko/java/redaction/xls/ 
description: Java JSP/JSF 애플리케이션 및 데스크톱 애플리케이션용 런타임 환경의 Java XLS 파일에서 민감한 정보를 수정하기 위한 샘플 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java의 XLS 형식 수정" h2="기본 및 고성능 XLS는 Microsoft 또는 Adobe PDF와 같은 소프트웨어를 사용하지 않고 서버측 Aspose.Cells for Java API를 사용하여 민감한 수정 정보를 문서화합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java에서 XLS 파일을 수정하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="XLS 파일 수정 - Java" offSpacer="" %}}
