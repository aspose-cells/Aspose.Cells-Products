...
description: Aspose Excel. Convierta XML a XPS rápida y fácilmente con Aspose.Cells. Python XML a XPS. Python Guarde XML en XPS. Guarde XML como XPS usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XML en XPS en Python" %}}

El siguiente ejemplo demuestra cómo convertir XML a XPS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XML a XPS" %}}
