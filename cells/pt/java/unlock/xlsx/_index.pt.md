...
weight: 310
description: Java código de amostra para desbloquear arquivo protegido por senha XLSX em Java Ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
...
{{% blocks/products/pf/agp/content h2="Como remover o arquivo de proteção XLSX usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para desbloquear XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Instancie a classe Workbook com o caminho para o arquivo XLSX protegido
...
{{% blocks/products/pf/agp/code-block title="Desbloqueie os arquivos XLSX via C#" offSpacer="" %}}
