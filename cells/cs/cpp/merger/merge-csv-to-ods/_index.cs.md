---
title:  Sloučit CSV na ODS přes C++
url: /cs/cpp/merger/merge-csv-to-ods/ 
description: Sloučit CSV až ODS online zdarma. Online zdarma CSV až ODS Fúze. Sloučit CSV do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit CSV až ODS v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení CSV až ODS online" InputFormat="csv" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
