...
url: /hu/cpp/merger/merge-xlsb-to-et/ 
...
következő példa bemutatja, hogyan lehet egyesíteni a XLSB-et a Aspose.Cells-es for C++-es ET-vel.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLSB-et az ET-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a XLSB ET-vel való egyesítéséhez" %}}
