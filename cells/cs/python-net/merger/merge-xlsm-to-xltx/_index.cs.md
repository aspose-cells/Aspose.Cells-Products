...
url: /cs/python-net/merger/merge-xlsm-to-xltx/ 
...
Následující příklad ukazuje, jak sloučit XLSM až XLTX v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit XLSM až XLTX? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
