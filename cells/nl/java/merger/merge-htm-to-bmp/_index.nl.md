---
title: HTM samenvoegen met BMP - HTM samenvoegen met BMP in Java
url: /nl/java/merger/merge-htm-to-bmp/ 
description: Aspose Excel. Java Aspose.Cells. HTM samenvoegen naar BMP opslagformaat. Java Combineer HTM met BMP formaat. HTM samenvoegen naar BMP in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTM samen met BMP in Java" %}}

Het volgende voorbeeld laat zien hoe u HTM samenvoegt met BMP in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen met BMP. Upload uw bestanden, bel de Workbook.Combine-methode voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand BMP. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java waarin HTM wordt samengevoegd met BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om HTM samen te voegen met BMP in Java" InputFormat="htm" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen met BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met BMP? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen met BMP" %}}
