---
title:  OLE nesnesini Excel'e ekleme via .NET
weight: 170
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında OLE nesnesini Excel'e eklemek için C# kaynak kodu.
...
{{< blocks/products/pf/i18n/upper-banner h1="OLE nesnesini Excel\'e ekleme via .NET" h2="Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan Aspose.Cells API\'lerini kullanarak OLE nesnesini ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Kullan[yöntem ekle](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addoleobject) seçili çalışma sayfasına bir OLE nesnesi eklemek için
