---
title:  Combine SPREADSHEETML con XLSM a través de Python
url: /es/python-net/merger/merge-spreadsheetml-to-xlsm/ 
description: Combine SPREADSHEETML con XLSM en línea de forma gratuita. HOJA DE CÁLCULO en línea gratis al XLSM Fusión. Combine SPREADSHEETML con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo fusionar SPREADSHEETML a XLSM en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar SPREADSHEETML a XLSM en línea" InputFormat="xml" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
