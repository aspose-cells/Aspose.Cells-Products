...
{{% blocks/products/pf/agp/content h2="كيفية دمج ملفات TXT باستخدام Java" %}}

 لدمج ملف TXT ، سنستخدم
...
+ قم بتحميل ملف TXT الأول مع مثيل لفئة المصنف.
+ قم بتحميل مستند TXT الثاني بنسخة من فئة المصنف.
...
{{% blocks/products/pf/agp/code-block title="دمج ملفات TXT - Java" offSpacer="" %}}
