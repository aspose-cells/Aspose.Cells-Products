---
title: PHP XLSM ～ SXC - XLSM ～ SXC コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XLSM を SXC にすばやく簡単に変換します。PHP XLSM から SXC。PHP XLSM から SXC に保存します。PHP を使用して、XLSM を SXC として保存します。
...
{{% blocks/products/pf/agp/content h2="XLSM を PHP で SXC に保存します" %}}
...
{{% cells-convert title="XLSM を SXC に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="sxc" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP 経由で XLSM を SXC に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSM ファイルをプログラムで SXC に変換する必要がありますか? PHP 開発者は、わずか数行のコードで XLSM を簡単にロードして SXC に変換できます。
