...
url: /hu/cpp/merger/merge-spreadsheetml-to-xml/ 
...
A következő példa bemutatja, hogyan egyesítheti a SPREADSHEETML-t XML-lel a Aspose.Cells for C++-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a SPREADSHEETML-t XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a SPREADSHEETML és XML egyesítéséhez" %}}
