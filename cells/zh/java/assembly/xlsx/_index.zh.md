---
title: 在 XLSX 文件中生成报告 via Java
weight: 7710
description: Java 示例代码，用于在 JSP/JSF 应用程序和桌面应用程序的 Java 运行时环境上创建 XLSX 格式报告。
---
...
{{% blocks/products/pf/agp/feature-section-col title="生成 XLSX 报告的步骤 via Java" %}}
...
1. 通过 Worbook.save 方法以 XLSX 格式保存结果
...
{{% blocks/products/pf/agp/code-block title="以 XLSX 格式生成 Excel 报告 - C#" offSpacer="" %}}
