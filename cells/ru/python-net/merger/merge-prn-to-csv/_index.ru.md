...
url: /ru/python-net/merger/merge-prn-to-csv/ 
...
В следующем примере показано, как объединить PRN с CSV в Aspose.Cells for Python via .NET.
...
Нужно программно объединить PRN с CSV? Базовый документ сливается и объединяется с[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API можно реализовать всего несколькими строками кода.
