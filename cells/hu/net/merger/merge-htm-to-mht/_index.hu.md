---
title: HTM egyesítése MHT-val – HTM egyesítése MHT-val a C# számon
url: /hu/net/merger/merge-htm-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online HTM egyesítése MHT mentési formátumba. C# HTM kombinálása MHT formátummal. HTM egyesítése az MHT-val a C# számon. HTM összevonás.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a HTM-et az MHT-val a C# online számon ingyen" %}}

A következő példa bemutatja, hogyan egyesítheti a HTM-et az MHT-val a Aspose.Cells for .NET számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTM és az MHT egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el MHT-fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a HTM-et az MHT-val.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTM és az MHT egyesítése a C# számon" InputFormat="htm" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTM és az MHT egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a HTM-et az MHT-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és az MHT egyesítéséhez" %}}
