...
{{% blocks/products/pf/agp/content h2="Převést XLAM na DIF na Python" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLAM až DIF v Python online zdarma" %}}

Následující příklad ukazuje, jak převést XLAM na DIF v Python via NET.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLAM na DIF" %}}
