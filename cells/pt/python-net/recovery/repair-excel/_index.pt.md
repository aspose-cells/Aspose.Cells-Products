---
title: Reparar arquivo excel via Python
url: /pt/python-net/recovery/repair-excel/ 
description: Repare um arquivo Excel corrompido usando Python. Ferramenta de recuperação para reparar arquivo Excel corrompido no aplicativo Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Recuperar arquivo EXCEL via Python" h2="Crie seu próprio aplicativo Python para reparar arquivos do Excel usando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Como reparar arquivo excel usando Python" %}}
...
{{% cells-recovery title="Aplicativo gratuito para reparar arquivo EXCEL usando Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}    
