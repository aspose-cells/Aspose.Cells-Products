---
title:  Eliminar XLSB Anotación via .NET
weight: 6440
description: C# código fuente para agregar y eliminar anotaciones de formato XLSB en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Agregar o eliminar anotación de XLSB a través de C#" %}}
