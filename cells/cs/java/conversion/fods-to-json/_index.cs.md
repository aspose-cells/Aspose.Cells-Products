---
title: Převést FODS na JSON přes Java 

description: Ukázkový konverzní kód Java pro formát FODS na soubor JSON. Programátoři mohou tento příklad kódu použít k exportu tabulek Excelu a OpenOffice do formátu JSON v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést FODS na JSON přes Java" h2="Převod FODS na JSON Java pro převod jedné nebo více stránek na JSON pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést FODS na JSON pomocí Java" %}}

 K vykreslení FODS do JSON použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu FODS na JSON prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor FODS na JSON pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor FODS s instancí třídy Workbook1. Vytvořte rozsah dat k exportu pomocí metody Cells.createRange1. Volání metody JsonUtility.exportRangeToJson s odkazy na Range & ExportRangeToJsonOptions1. Zápis dat String JSON do souboru pomocí metody BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze FODS na JSON Java" offSpacer="" %}}
