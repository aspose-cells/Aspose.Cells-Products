---
title: Java IMAGE en EMF - Convertisseur IMAGE en EMF
description: Aspose Exceller. Convertissez IMAGE en EMF rapidement et facilement avec Aspose.Cells. Java IMAGE en EMF. Java Enregistrez IMAGE en EMF. Enregistrez IMAGE sous EMF en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE au EMF dans Java" %}}

L'exemple suivant montre comment convertir IMAGE en EMF en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir une image en EMF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers IMAGE en EMF par programme ? Les développeurs Java peuvent facilement convertir IMAGE en EMF en quelques lignes de code seulement.
...
1.  Convertissez IMAGE en EMF en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de IMAGE en EMF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en EMF" %}}
{{% blocks/products/pf/agp/text %}}
