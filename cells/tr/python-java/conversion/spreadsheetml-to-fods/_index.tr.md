---
title: SPREADSHEETML'yi Python aracılığıyla FODS'ye dönüştürün
url: /tr/python-java/conversion/spreadsheetml-to-fods/
description: E-tabloml'den yemlere Python dönüşümü için örnek kod. Python uygulamasında toplu elektronik tabloml dosyalarından fods'a dönüşüm için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML\'yi Python aracılığıyla FODS\'ye dönüştürün" h2="Python API\'lerini kullanarak Excel® elektronik tablolarını FODS formatına aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python Kullanarak SPREADSHETML\'yi FODS\'a Dönüştürme" %}}

 SPREADSHEETML'yi FODS'a dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="SPREADSHEETML\'yi Python aracılığıyla FODS\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Python geliştiricileri, yalnızca birkaç satır kodla SPREADSHEETML dosyalarını kolayca yükleyebilir ve FODS'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. SPREADSHEETML dosyasını bir Çalışma Kitabı örneğiyle yükleyin1. Workbook.Save yöntemini çağırın1. FODS uzantılı çıktı yolunu parametre olarak iletin1. Ortaya çıkan FODS dosyası için belirtilen yolu kontrol edin
