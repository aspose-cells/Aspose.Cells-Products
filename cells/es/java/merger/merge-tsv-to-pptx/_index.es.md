---
title:  Combinar TSV a PPTX via Java
...
El siguiente ejemplo muestra cómo combinar TSV con PPTX en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar TSV a PPTX en línea" InputFormat="tsv" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
