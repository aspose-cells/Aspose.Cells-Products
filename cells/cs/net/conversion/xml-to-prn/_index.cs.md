---
title: C# XML to PRN – převodník XML na PRN
description: Aspose Excel. Převeďte XML na PRN rychle a snadno pomocí Aspose.Cells. C# XML na PRN. C# Uložit XML do PRN. Uložit XML jako PRN pomocí C#.
...
{{% blocks/products/pf/agp/content h2="Uložit XML do PRN na C#" %}}

Následující příklad ukazuje, jak převést XML na PRN v C#.
...
{{% cells-convert title="Ukázkový kód pro převod XML na PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na PRN přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XML na PRN programově? .NET vývojáři mohou snadno načíst a převést XML na PRN v několika řádcích kódu.
...
{{% blocks/products/pf/agp/content h2="C# knihovna pro převod XML na PRN" %}}
