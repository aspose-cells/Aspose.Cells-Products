---
title: Połącz XLTM z EMF - Połącz XLTM z EMF w C#
url: /pl/net/merger/merge-xltm-to-emf/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLTM do EMF w formacie zapisu. C# Połącz format XLTM z EMF. Połącz XLTM z EMF w C#. XLTM Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTM z EMF w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLTM z EMF w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLTM z EMF. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku EMF. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy numery XLTM z EMF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTM z EMF w C#" InputFormat="xltm" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTM z EMF za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLTM z EMF programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
