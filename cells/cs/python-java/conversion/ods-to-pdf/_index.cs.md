...
{{% blocks/products/pf/agp/content h2="Převeďte ODS na PDF pomocí Python" %}}
...
Následující příklad ukazuje, jak převést ODS na PDF v Python.
