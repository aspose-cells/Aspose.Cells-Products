...
1. Ad alanını sınıf dosyanıza ekleyin1. Workbook sınıfı örneği oluşturun.1. Çalışma kitabının ilk çalışma sayfasına erişin.1. Çalışma sayfasının istediğiniz hücresini/hücrelerini alın ve değeri hücreye/hücrelere girin.1. Çalışma kitabını HTML dosyası olarak kaydetmek için Kaydet yöntemini kullanın.
