---
title:  Вставьте объект OLE в Excel via .NET
weight: 170
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addoleobject) вставить объект OLE на выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставить объект OLE — C#." offSpacer="" %}}
