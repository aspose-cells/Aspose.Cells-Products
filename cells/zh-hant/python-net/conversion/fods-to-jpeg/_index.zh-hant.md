---
title: Python FODS 轉 JPEG - 在線 FODS 轉 JPEG 轉換器
description: Aspose Excel。 Python Aspose.Cells。Python Aspose Cells。免費在線 Python 將 FODS 轉換為 JPEG 保存格式。 Python FODS 到 JPEG 格式。將 FODS 保存為 JPEG Python。
...
如何將 FODS 轉換為 JPEG？使用 Aspose.Cells for Python via NET 庫，您可以通過幾行代碼以編程方式輕鬆將 FODS 轉換為 JPEG。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠構建跨平台應用程序，能夠生成、修改、轉換、渲染和打印所有 Excel 文件。 Python Excel API不僅可以在電子表格格式之間進行轉換，還可以將Excel文件渲染為圖像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，從而使其成為行業交換文檔的完美選擇-標準格式。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="免費在線保存 FODS 至 JPEG 於 Python" %}}

以下示例演示如何將 Python via NET 中的 FODS 轉換為 JPEG。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 轉換為 JPEG。上傳您的 FODS 文件，然後只需將其另存為 JPEG 文件。對於 FODS 讀取和 JPEG 寫入，您可以使用完全限定的文件名。輸出 JPEG 內容和格式將與原始 FODS 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 FODS 轉換為 JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為 JPEG" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 FODS 文件轉換為 JPEG 嗎？ Python 開發人員只需幾行代碼即可輕鬆加載和轉換 FODS 到 JPEG。
...
1. 使用工作簿實例加載 FODS 文件。
1. 通過調用Workbook.save方法將FODS轉換為JPEG。
1. 獲取FODS到JPEG的轉換結果。
