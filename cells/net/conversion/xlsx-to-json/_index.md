...
description: Sample code for XLSX to JSON C# conversion. Use API example code for batch XLSX files to JSON conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 It is easy for the developers to load & convert XLSX files to JSON in just a few lines of code.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before running the conversion source code just make sure that you have the following prerequisites.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XLSX to JSON C# Conversion" offSpacer="" %}}

```cs
// load XLSX file with an instance of Workbook
var workbook = new Workbook("J8CR782.xlsx", new LoadOptions(Cells.LoadFormat.Auto));
