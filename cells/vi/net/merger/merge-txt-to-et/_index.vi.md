---
title: Gộp TXT thành ET - Gộp TXT thành ET thành C#
url: /vi/net/merger/merge-txt-to-et/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí TXT sang định dạng lưu ET. C# Kết hợp TXT sang định dạng ET. Hợp nhất TXT thành ET vào C#. Hợp nhất TXT.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất TXT với ET trong C# Trực tuyến miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất TXT thành ET trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất TXT với ET. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp ET. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C# hợp nhất TXT thành ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Hợp nhất trực tuyến miễn phí TXT với ET vào C#" InputFormat="txt" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
