---
title: Converter JSON para SVG via C#
url: /pt/net/conversion/json-to-svg/
description: Código de exemplo para conversão de json para svg C#. Use API código de exemplo para arquivos json em lote para conversão svg em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/content h2="Como converter JSON para SVG usando C#" %}}

 Para converter JSON para SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter JSON em SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos JSON em SVG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo JSON com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão SVG como parâmetro1. Verifique o caminho especificado para o arquivo SVG resultante
...
{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter JSON em SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="svg" IsLandingPage="true" %}}
