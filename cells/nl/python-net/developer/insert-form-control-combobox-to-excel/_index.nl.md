...
{{< blocks/products/pf/i18n/upper-banner h1="Plaats ComboBox (Formulierbeheer) in Excel via Python" h2="Voeg objecten in met behulp van server-side API\'s zonder enige software zoals Microsoft of Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
Gebruik de add-methode van de shapecollection om een ComboBox (formulierbesturingselement) in het geselecteerde werkblad in te voegen.
