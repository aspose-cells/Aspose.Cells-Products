---
title: Sloučit PRN s MD – Zkombinujte PRN s MD v C++
url: /cs/cpp/merger/merge-prn-to-md/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit PRN do formátu uložení MD. C++ Zkombinujte PRN s formátem MD. Sloučit PRN na MD v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN do MD na C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN s MD v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN s MD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MD. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí PRN do MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení PRN do MD na čísle C++" InputFormat="prn" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN do MD přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit PRN s MD? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení PRN s MD" %}}
