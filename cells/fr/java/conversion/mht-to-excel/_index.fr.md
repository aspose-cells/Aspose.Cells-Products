---
title: Java MHT vers EXCEL - Convertisseur MHT vers EXCEL en ligne
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir MHT en format de sauvegarde EXCEL. Java Format MHT vers EXCEL. Enregistrez MHT dans EXCEL Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez MHT sur EXCEL au Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir MHT en EXCEL en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir MHT en EXCEL. Téléchargez votre fichier MHT, puis enregistrez-le simplement en tant que fichier EXCEL. Pour la lecture MHT et l'écriture EXCEL, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage EXCEL de sortie seront identiques au document MHT d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir MHT en EXCEL en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHT en EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en EXCEL par programme ? Les développeurs Java peuvent facilement convertir MHT en EXCEL en quelques lignes de code seulement.
