---
title: تحويل TABDELIMITED إلى XLS عبر Java 

description: نموذج Java رمز التحويل لتنسيق TABDELIMITED إلى ملف XLS. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى XLS داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى XLS عبر Java" h2="TABDELIMITED to XLS Java التحويل لتحويل صفحات مفردة أو صفحات متعددة إلى XLS باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى XLS باستخدام Java" %}}

 من أجل تقديم TABDELIMITED إلى XLS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TABDELIMITED إلى XLS عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل ملف TABDELIMITED بسهولة إلى XLS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف TABDELIMITED مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XLS & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XLS الناتج
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED إلى XLS Java رمز مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف TABDELIMITED في مثيل المصنف
Workbook book = new Workbook("template.tabdelimited");
// حفظ TABDELIMITED كـ XLS
