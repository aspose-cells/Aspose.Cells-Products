...
Befolgen Sie die einfachen Schritte, um XML in JPG zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann als JPG-Datei. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das XML in JPG zusammenführt.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von XML in JPG" %}}
