---
title: C# EXCEL - TXT - EXCEL - TXT konverter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az EXCEL TXT formátumba konvertálásához, lehetővé téve az EXCEL adatok zökkenőmentes mentését TXT formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="EXCEL fájl mentése a TXT-es számra a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet az EXCEL-t TXT-re konvertálni a C#-ben.
...
{{% blocks/products/pf/agp/content h2="Az EXCEL konvertálása TXT-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia az EXCEL fájlokat TXT-re? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják az EXCEL-t TXT-re.
...
1.  Alakítsd át az EXCEL-t TXT formátumúra a Workbook.Save metódus meghívásával.
1.  Szerezze meg az EXCEL konverziós eredményét a TXT számra.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az EXCEL TXT-re konvertálásához" %}}
