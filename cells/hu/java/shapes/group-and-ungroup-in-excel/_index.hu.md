---
title: Alakzatok csoportosítása és csoportosítása az Excelben via Java
weight: 360
description: Az objektumok csoportosítása és csoportosítása a Aspose.Cells' Java API használatával szoftver nélkül, például Microsoft vagy Open Office, Adobe PDF stb.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Alakzatok csoportosítása és csoportosítása az Excelben via Java" h2="A Aspose.Cells\' API használatával különféle objektumokkal dolgozhat szoftver nélkül, például Microsoft vagy Open Office, Adobe PDF stb." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Alakzatok csoportosítása és csoportosítása az Excel fájlban az sJava használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az alakzatok csoportosításának és lebontásának lépései a via Java-es Excel-fájlban" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja a[csoportos módszer](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#group-com.aspose.cells.Shape---) formák csoportosításához a kiválasztott munkalapon
 + Használja a[csoportbontás módszere](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#ungroup-com.aspose.cells.GroupShape-) az alakzatok csoportosításához a kiválasztott munkalapon
...
{{% blocks/products/pf/agp/code-block title="Csoportosítási és csoportosítási formák - Java" offSpacer="" %}}
