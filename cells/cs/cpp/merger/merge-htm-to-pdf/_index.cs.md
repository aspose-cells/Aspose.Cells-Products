...
Následující příklad ukazuje, jak sloučit HTM s PDF v Aspose.Cells for C++.
...
Potřebujete sloučit HTM na PDF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
