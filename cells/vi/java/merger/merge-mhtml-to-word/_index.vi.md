---
title: Hợp nhất MHTML thành WORD via Java
...
Ví dụ sau minh họa cách hợp nhất MHTML với WORD trong Java.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất MHTML với WORD trực tuyến" InputFormat="mhtml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
