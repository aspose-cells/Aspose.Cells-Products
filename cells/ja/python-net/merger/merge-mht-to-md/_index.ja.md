...
url: /ja/python-net/merger/merge-mht-to-md/ 
...
次の例は、Aspose.Cells for Python via .NET で MHT を MD にマージする方法を示しています。
...
MHT をプログラムで MD にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
