---
title:  استخراج النص والصور من XLSM وثيقة via .NET
weight: 4010
description: C# الكود المصدري لاستخراج النصوص والصور من ملف XLSM على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
{{% blocks/products/pf/agp/content h2="كيفية تحليل ملف XLSM باستخدام C#" %}}
 ...
 من أجل تحليل الملف XLSM، سنستخدم[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API وهي منصة غنية بالميزات وقوية وسهلة الاستخدام لمعالجة المستندات API لمنصة C#. يفتح[NuGet](https://www.nuget.org/packages/aspose.cells) مدير الحزم، ابحث عن
