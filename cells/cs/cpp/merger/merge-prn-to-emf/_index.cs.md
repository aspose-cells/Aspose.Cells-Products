---
title: Sloučit PRN s EMF – Sloučit PRN s EMF v C++
url: /cs/cpp/merger/merge-prn-to-emf/ 
description: Aspose Excel. C++ Aspose.Cells. Zdarma online sloučit PRN do formátu uložení EMF. C++ Zkombinujte PRN do formátu EMF. Sloučit PRN na EMF v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na EMF v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN s EMF v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do EMF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru EMF. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí PRN do EMF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení PRN na EMF v C++" InputFormat="prn" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na EMF přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s EMF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení PRN s EMF" %}}
