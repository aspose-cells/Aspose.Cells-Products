---
title: Voeg XLSX samen met MHT - Combineer XLSX met MHT in Java
url: /nl/java/merger/merge-xlsx-to-mht/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online samenvoegen XLSX naar MHT-opslagformaat. Java Combineer XLSX naar MHT-formaat. Samenvoegen XLSX naar MHT in Java. XLSX Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLSX samen met MHT in Java Online" %}}

Het volgende voorbeeld laat zien hoe u XLSX kunt samenvoegen met MHT in Aspose.Cells for Java.
...
{{% cells-merger title="Gratis online om XLSX samen te voegen met MHT in Java" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSX samen te voegen met MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLSX programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java-bibliotheek om XLSX samen te voegen met MHT" %}}
