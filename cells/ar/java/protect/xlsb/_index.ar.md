---
title:  حماية وقفل XLSB مستند via Java
weight: 6590
description: نموذج التعليمات البرمجية Java لقفل ملف XLSB باستخدام كلمة المرور في بيئة تشغيل Java لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات حماية XLSB ملفات via Java" %}}
...
1.  قم بتحميل الملف XLSB عن طريق إنشاء فئة المصنف
