...
description: Sample C++ conversion code for JSON to XLSB format. Programmers can use this source code for batch JSON to XLSB conversion within any C++ Application.
---
