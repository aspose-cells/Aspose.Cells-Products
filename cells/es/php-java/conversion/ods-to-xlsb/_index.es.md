---
title: Convertidor PHP ODS a XLSB - ODS a XLSB
description: Aspose Excel. Convierta ODS a XLSB rápida y fácilmente con Aspose.Cells. PHP ODS a XLSB. PHP Guarde ODS a XLSB. Guarde ODS como XLSB usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir ODS a XLSB mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos ODS a XLSB mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente ODS a XLSB en tan solo unas pocas líneas de código.
...
1.  Convierta ODS a XLSB llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de ODS a XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir ODS a XLSB" %}}
