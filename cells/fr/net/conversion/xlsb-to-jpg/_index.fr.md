---
title: C# XLSB en JPG - Convertisseur en ligne XLSB en JPG
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir XLSB en format de sauvegarde JPG. C# XLSB au format JPG. Enregistrez XLSB en JPG C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB au format JPG en C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en JPG en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en JPG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XLSB en JPG par programmation ? Les développeurs de .NET peuvent facilement charger et convertir XLSB en JPG en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLSB en JPG" %}}
