---
title: Java HTM в TXT - Конвертер HTM в TXT
description: Aspose Excel. Это комплексное решение предоставляет разработчикам Java полностью интегрированный подход к преобразованию HTM в формат TXT, обеспечивая беспрепятственное сохранение данных HTM в формат TXT с использованием библиотеки Aspose.Cells, и все это с помощью эффективного и настраиваемого кода Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Преобразовать HTM в TXT в Java" h2="Высокоскоростная библиотека Java для преобразования HTM в TXT. Это профессиональное программное решение для импорта и экспорта HTM, TXT и многих других форматов с использованием Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM-код в TXT в Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в TXT в Java.
...
{{% cells-convert title="Пример кода для преобразования HTM в TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="txt" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Как преобразовать HTM в TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать HTM-файлы в формат TXT? Разработчики, использующие формат Java, могут легко преобразовать HTM в формат TXT всего несколькими строками кода.
...
1.  Преобразуйте HTM в TXT, вызвав метод Workbook.save.
1.  Получите результат преобразования HTM в TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования HTM в TXT" %}}
{{% blocks/products/pf/agp/text %}}
