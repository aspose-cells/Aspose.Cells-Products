---
title: XLSM'i JSON'e birleştir - XLSM'i Python'de JSON'e birleştir
url: /tr/python-java/merger/merge-xlsm-to-json/ 
description: Aspose excel. Python Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme XLSM ile JSON kaydetme biçimi. Python XLSM ile JSON formatını birleştirin. Python içinde XLSM'i JSON ile birleştir. XLSM Birleştir.
...
Aşağıdaki örnek, XLSM'in Aspose.Cells for Python via Java'de JSON ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLSM\'i Python\'de JSON ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xlsm" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLSM\'i Python üzerinden JSON ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLSM ile JSON'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
