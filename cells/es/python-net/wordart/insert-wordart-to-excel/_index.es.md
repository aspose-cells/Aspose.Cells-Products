...
+ Use el método de agregar de la colección de formas para insertar un WordArt en la hoja de trabajo seleccionada.
...
-  Instalar Aspose.Cells for Python via .NET desde<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , use el comando como:<code>$ pip install aspose-cells-python</code>.
