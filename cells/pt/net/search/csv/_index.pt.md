---
title:  Pesquise o documento CSV sem abrir via .NET
weight: 7510
description: Código-fonte C# para pesquisar palavras com padrão no arquivo CSV em .NET Framework, .NET Core, Mono ou plataformas Xamarin.
