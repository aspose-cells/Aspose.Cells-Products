---
title: PHP KÉP SZÁMOKKÁVÁ - KÉP SZÁMOKKÁVÁ konvertáló
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a PHP fejlesztők számára az IMAGE adatok SZÁM formátumba konvertálásához, lehetővé téve a KÉPadatok zökkenőmentes mentését SZÁM formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható PHP kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="KÉP konvertálása SZÁMOKKÉNT PHP-ben" h2="Nagy sebességű PHP könyvtár KÉPEK SZÁMOKKÁ konvertálásához. Ez egy professzionális szoftvermegoldás KÉPEK, SZÁMOK és sok más formátum importálására és exportálására PHP használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for PHP" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/php-java" installationsDocsLink="https://docs.aspose.com/cells/php-java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/php/" learnAsLink="https://docs.aspose.com/cells/php-java" apiReference="" mavenRepoLink="" >}}


{{% blocks/products/pf/agp/content h2="KÉP konvertálása SZÁMOKKÉNT PHP használatával" %}}

 Hogyan konvertálhatom az IMAGE objektumot SZÁMOKKÉP formátumba? A Aspose.Cells for PHP via Java könyvtárral könnyedén konvertálhatja az IMAGE objektumot SZÁMOKKÉP formátumba programozottan, néhány sornyi kóddal.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) képes platformfüggetlen alkalmazások létrehozására, módosítására, konvertálására, renderelésére és nyomtatására, valamint az összes Excel fájl létrehozására, módosítására, konvertálására, renderelésére és nyomtatására. A PHP Excel API nemcsak táblázatkezelő formátumok közötti konvertálásra képes, hanem Excel fájlokat képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként is képes renderelni, így tökéletes választás a dokumentumok iparági szabványoknak megfelelő formátumokban történő cseréjéhez.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="KÉP mentése NUMBERS formátumban PHP-ben" %}}

A következő példa bemutatja, hogyan lehet IMAGE-t SZÁMOKKÉNT konvertálni PHP-ben.
{{% blocks/products/pf/agp/text %}}

Kövesd az egyszerű lépéseket az IMAGE fájl NUMBERS formátumba konvertálásához. Töltsd fel az IMAGE fájlt, majd mentsd el NUMBERS fájlként. Mind az IMAGE olvasásához, mind a NUMBERS írásához teljes fájlneveket használhatsz. A kimeneti NUMBERS tartalom és formázás megegyezik az eredeti IMAGE dokumentummal.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mintakód az IMAGE számokká konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="numbers" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Hogyan konvertáljunk KÉPET SZÁMOKKÁ PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell IMAGE fájlokat SZÁMÚ FÁJLOKKÉNT konvertálnod? A PHP fejlesztők könnyedén betölthetik és konvertálhatják az IMAGE fájlokat SZÁMÚ FÁJLOKKÉNT mindössze néhány sornyi kóddal.
...
1.  Alakítsd át az IMAGE objektumot SZÁMOKká a Workbook mentési metódusának meghívásával.
1.  Szerezd meg az IMAGE formátum SZÁMOKká konvertálásának eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár IMAGE fájlok számokká konvertálásához" %}}
