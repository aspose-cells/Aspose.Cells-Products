...
description: Aspose Exceller. Convertissez NUMBERS en JPG rapidement et facilement avec Aspose.Cells. C# NUMBERS en JPG. C# Enregistrez les NUMÉROS au format JPG. Enregistrez les NUMÉROS au format JPG en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer NUMBERS au format JPG en C#" %}}

L'exemple suivant montre comment convertir NUMBERS en JPG dans C#.
...
{{% cells-convert title="Exemple de code pour convertir des NUMBERS en JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="jpg" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir des NUMBERS en JPG" %}}
