...
description: Aspose Excel. Python Aspose.Cells. Scal EXCEL do formatu zapisu JSON. Python Połącz EXCEL z formatem JSON. Połącz EXCEL z JSON w Python. Połącz EXCEL.
...
{{% blocks/products/pf/agp/content h2="Połącz EXCEL z JSON, używając Python" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz EXCEL z JSON w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia EXCEL z JSON w Python" InputFormat="xlsx" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
