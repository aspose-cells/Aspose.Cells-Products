...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar XPS in Python" %}}
...
Het volgende voorbeeld laat zien hoe u OTS converteert naar XPS in Python via NET.
