...
{{% blocks/products/pf/agp/text %}}
 ...
 A .NET fejlesztői egyszerűen tölthetnek be és konvertálhatnak XLTX fájlokat GIF formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTX fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal megadása GIF kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott GIF-fájl megadott elérési útját
