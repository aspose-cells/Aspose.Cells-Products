...
description: Aspose اكسل. قم بتحويل IMAGE إلى XPS بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى XPS. C++ احفظ IMAGE إلى XPS. احفظ IMAGE كـ XPS باستخدام C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصورة إلى XPS في C++" h2="تحويل IMAGE عالي الأداء إلى XPS باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل الصورة إلى XPS باستخدام C++" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل IMAGE إلى XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xps" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى XPS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى XPS برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى XPS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى XPS عن طريق استدعاء طريقة Save().
1.  احصل على نتيجة تحويل IMAGE إلى XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل IMAGE إلى XPS" %}}
