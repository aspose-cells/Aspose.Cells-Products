---
title: Java MHT à PDF - Convertisseur en ligne MHT à PDF
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertissez MHT en format de sauvegarde PDF. Java MHT au format PDF. Enregistrez MHT au PDF Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez MHT au PDF en Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir MHT en PDF en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir MHT en PDF. Téléchargez votre fichier MHT, puis enregistrez-le simplement en tant que fichier PDF. Pour la lecture MHT et l'écriture PDF, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie PDF seront identiques au document MHT d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir MHT en PDF en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="pdf" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHT en PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en PDF par programmation ? Les développeurs Java peuvent facilement convertir MHT en PDF en quelques lignes de code seulement.
...
1.  Convertissez MHT en PDF en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de MHT en PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="bibliothèque Java pour convertir MHT en PDF" %}}
{{% blocks/products/pf/agp/text %}}
