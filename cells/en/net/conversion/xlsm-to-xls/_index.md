---
title: XLSM to XLS - Convert XLSM to XLS files C#
description: Aspose Excel. Free Online Convert XLSM to XLS saveformat. C# XLSM to XLS format. Save XLSM as XLS in C#.
keywords: [Aspose Excel., C# Aspose.Cells., C# XLSM to XLS saveformat., Free Online XLSM to XLS Converter]
---
...
{{% blocks/products/pf/agp/content h2="Save XLSM to XLS in C# Online for Free" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert XLSM to XLS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xls" IsLandingPage="true" %}}
