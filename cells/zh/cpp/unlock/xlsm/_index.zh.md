...
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 解锁 XLSM 文件" h2="使用 C++ 库从 Excel 电子表格（包括 XLSM 文件）中删除保护。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 删除 XLSM 文件的保护" %}}
...
1. 使用 CreateIWorkbook 加载 XLSM 锁定文件。1. 调用 Unprotect() 函数解锁。1. 使用 SetPassword 将密码设置为 NULL。1. 将 XLSM 文件保存在指定位置。
