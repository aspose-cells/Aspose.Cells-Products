...
weight: 1300
url: /nl/cpp/metadata/xlsm/ 
description: C++ voorbeeldcode om metadata van XLSM-bestanden te bewerken of te bekijken op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
...
{{% blocks/products/pf/agp/content h2="XLSM-metadata ophalen met C++" %}}
...
+ Laad XLSM-bestand met CreateIWorkbookMetadata
...
{{% blocks/products/pf/agp/code-block title="Metadata van XLSM extraheren - C++" offSpacer="" %}}
