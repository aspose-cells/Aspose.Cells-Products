---
title: Convertir TSV en TIFF via C#

description: Exemple de code pour la conversion tsv en tiff C#. Utilisez l'exemple de code API pour les fichiers tsv par lots en conversion tiff dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers TSV au format TIFF en quelques lignes de code seulement.
