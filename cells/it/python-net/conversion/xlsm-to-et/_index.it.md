...
description: Aspose Excel. Converti XLSM in ET in modo rapido e semplice con Aspose.Cells. Python XLSM in ET. Python Salva XLSM su ET. Salva XLSM come ET utilizzando Python.
...
{{% blocks/products/pf/agp/content h2="Convertire XLSM in ET in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Salva XLSM su ET in Python" %}}

L'esempio seguente mostra come convertire XLSM in ET in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Libreria Python per convertire XLSM in ET" %}}
