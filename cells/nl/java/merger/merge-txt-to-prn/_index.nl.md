...
description: Aspose Excel. Java Aspose.Cells. Voeg TXT samen naar PRN-opslagformaat. Java Combineer TXT naar PRN-formaat. Voeg TXT samen met PRN in Java. TXT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met PRN in Java" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met PRN in Aspose.Cells for Java.
...
{{% blocks/products/pf/agp/content h2="Hoe u TXT samenvoegt met PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
