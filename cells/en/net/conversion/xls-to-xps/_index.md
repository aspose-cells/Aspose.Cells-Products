---
title: C# XLS to XPS - XLS to XPS Converter
description: Aspose Excel. C# Aspose.Cells. XLS to XPS in C#. C# Convert XLS to XPS saveformat. C# XLS to XPS format. Save XLS to XPS C#.
keywords: [Aspose Excel., C# Aspose.Cells., XLS to XPS in C#., C# XLS to XPS saveformat., XLS to XPS C#., C# Convert XLS to XPS]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLS to XPS in C#" h2="High-speed C# library for converting XLS to XPS. This is a professional software solution to import and export XLS, XPS, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Save XLS to XPS in C#" %}}
...
{{% cells-convert title="Sample Code to Convert XLS to XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xps" IsLandingPage="true" %}}
