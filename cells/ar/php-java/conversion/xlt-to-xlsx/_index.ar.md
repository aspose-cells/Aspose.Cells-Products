---
title: PHP XLT إلى XLSX - XLT إلى XLSX محول
description: Aspose اكسل. قم بتحويل XLT إلى XLSX بسرعة وسهولة باستخدام Aspose.Cells. PHP XLT إلى XLSX. PHP احفظ XLT إلى XLSX. احفظ XLT كـ XLSX باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLT إلى XLSX عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLT إلى XLSX برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLT إلى XLSX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLT إلى XLSX عن طريق استدعاء طريقة حفظ المصنف.
