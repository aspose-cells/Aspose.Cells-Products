---
title:  Adicionar XLS anotação de arquivo do Excel via C++
weight: 10040
description: C++ código de exemplo para adicionar e excluir anotações de formato XLS em C++ Runtime Environment para Windows 32 bits, Windows 64 bits e Linux 64 bits.
---
