---
title: 建立XLT - 在Java中建立XLT文件
description: Aspose Excel。 Java 使用 Aspose.Cells 快速輕鬆地建立 XLT 檔案。使用 Java 產生 XLT 檔案。在 Java 中建立 XLT。在 Java 中建立 XLT。
keywords: [Aspose Excel., Java Aspose.Cells., Java Create XLT file., Generate XLT file in Java., Create XLT file using Java., Write data to XLT file via Java., Create a XLT file in Java., Java Generate a XLT file., Java XLT Creater]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在Java中建立XLT文件" h2="用於建立 XLT 檔案的高速 Java 庫。這是一個專業的軟體解決方案，用於導入和導出XLSX、PDF以及使用Java的許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何在Java中建立XLT" %}}
...
1. 使用 save() 方法將工作簿儲存為 XLT 格式。

{{% blocks/products/pf/agp/code-block title="範例程式碼展示如何在 Java 中建立 XLT 檔案。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫建立XLT文件" %}}
{{% blocks/products/pf/agp/text %}}
