...
如何將 XLTX 轉換為 JPEG？使用 Aspose.Cells for Python 庫，您可以通過幾行代碼以編程方式輕鬆地將 XLTX 轉換為 JPEG。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能夠構建跨平台應用程序，能夠生成、修改、轉換、呈現和打印所有 Excel 文件。 Python Excel API 不僅可以在電子表格格式之間相互轉換，還可以將Excel文件渲染為圖片，PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等，是行業文檔交換的完美選擇-標準格式。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="免費在線保存XLTX至JPEG至Python" %}}

以下示例演示如何將 Python 中的 XLTX 轉換為 JPEG。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLTX 轉換為 JPEG。上傳您的 XLTX 文件，然後將其另存為 JPEG 文件。對於 XLTX 讀取和 JPEG 寫入，您可以使用完全限定的文件名。輸出 JPEG 內容和格式將與原始 XLTX 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="在線將 XLTX 轉換為 JPEG 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="jpg" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通過Python將XLTX轉換為JPEG" %}}

{{% blocks/products/pf/agp/text %}}

 Python 開發人員只需幾行代碼即可輕鬆加載和轉換 XLTX 為 JPEG。

{{% /blocks/products/pf/agp/text %}}

1. 使用工作簿實例加載 XLTX 文件
1. 通過調用 Workbook.save 方法將 XLTX 轉換為 JPEG

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python 庫將 XLTX 轉換為 JPEG" %}}
