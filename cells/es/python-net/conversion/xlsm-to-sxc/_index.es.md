...
description: Aspose Excel. Convierta XLSM a SXC rápida y fácilmente con Aspose.Cells. Python XLSM a SXC. Python Guarde XLSM en SXC. Guarde XLSM como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSM al SXC en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSM a SXC en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSM en SXC" %}}
