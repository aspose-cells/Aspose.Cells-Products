...
description: Aspose เก่ง. Python สร้างไฟล์ XPS สร้าง XPS Python Python XPS สร้าง สร้าง XPS ใน Python สร้างไฟล์ XPS โดยใช้ Python
...
{{% blocks/products/pf/agp/text %}}
 ...
 เป็นเรื่องง่ายสำหรับนักพัฒนาในการสร้าง โหลด แก้ไข และแปลงไฟล์ XPS ภายในแอปพลิเคชันการรายงานที่แตกต่างกันสำหรับการประมวลผลข้อมูลด้วยโค้ดเพียงไม่กี่บรรทัด
...
1. ใช้วิธีบันทึกเพื่อบันทึกสมุดงานเป็นไฟล์ XPS
