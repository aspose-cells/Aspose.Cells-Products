---
title: Gabungkan JSON ke PRN - Gabungkan JSON ke PRN di C#
url: /id/net/merger/merge-json-to-prn/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan JSON ke format simpan PRN. C# Gabungkan JSON ke format PRN. Gabungkan JSON ke PRN di C#. JSON Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JSON ke PRN di C#" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan JSON ke PRN di C#" InputFormat="json" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JSON ke PRN lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan JSON ke PRN secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
