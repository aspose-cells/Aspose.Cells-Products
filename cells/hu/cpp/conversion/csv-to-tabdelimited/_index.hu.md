...
{{% blocks/products/pf/agp/content h2="Takarítson meg CSV-et a TABDELIMITED-en a C++-ben online ingyen" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztők könnyedén konvertálhatják a CSV-et TABDELIMITED-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a CSV fájlt a Factory::CreateIWorkbook segítségével.
1. A CSV konvertálása TABDELIMITED-re a Save() metódus meghívásával.
