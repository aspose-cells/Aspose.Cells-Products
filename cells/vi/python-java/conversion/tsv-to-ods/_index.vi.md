---
title: Chuyển đổi TSV sang ODS qua Python

description: Mã mẫu cho chuyển đổi tsv sang ods Python. Sử dụng mã mẫu API cho các tệp tsv hàng loạt để chuyển đổi ods trong ứng dụng Python.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi TSV sang ODS bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi TSV sang ODS qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp TSV sang ODS chỉ trong một vài dòng mã.
