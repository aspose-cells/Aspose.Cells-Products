...
{{< blocks/products/pf/i18n/upper-banner h1="Converter ODS para XLT em C#" h2="Biblioteca de alta velocidade C# para conversão de ODS para XLT. Esta é uma solução de software profissional para importar e exportar ODS, XLT e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
Precisa converter arquivos ODS em XLT programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em XLT em apenas algumas linhas de código.
...
1.  Converta ODS para XLT chamando o método Workbook.Save.
