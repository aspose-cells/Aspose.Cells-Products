...
url: /python-java/merger/merge-excel-to-ett/ 
...
The following example demonstrates how to merge EXCEL to ETT in Aspose.Cells for Python via Java.
...
Need to merge EXCEL to ETT programmatically? A basic document merging and concatenating with [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) APIs can be done with just few lines of code.
