...
description: Aspose Excel. Μετατρέψτε το HTM σε ΕΙΚΟΝΑ γρήγορα και εύκολα με το Aspose.Cells. C++ HTM σε IMAGE. C++ Αποθήκευση HTM στο IMAGE. Αποθηκεύστε το HTM ως ΕΙΚΟΝΑ χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το HTM στο IMAGE στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή HTM σε ΕΙΚΟΝΑ" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="png" IsLandingPage="true" language="cpp" %}}
