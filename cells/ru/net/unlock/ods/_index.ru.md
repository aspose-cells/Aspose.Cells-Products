...
{{< blocks/products/pf/i18n/upper-banner h1="Разблокируйте таблицу ODS с помощью C#." h2="Снимите защиту с ODS с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Как разблокировать файл ODS с помощью C#" %}}
 ...
 Чтобы удалить файл защиты ODS, воспользуемся
