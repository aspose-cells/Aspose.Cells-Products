...
description: ODS pencipta. Buat file ODS dalam kode C#. Hasilkan file ODS (Openoffice / Lbreoffice) menggunakan VB.NET, Asp.NET atau aplikasi berbasis .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Buat File ODS melalui C#" h2="Pembuatan spreadsheet asli dan berkinerja tinggi ODS (Openoffice / Lbreoffice) secara terprogram menggunakan API sisi server .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Membuat ODS melalui C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Contoh Kode untuk membuat file ODS (Openoffice / Lbreoffice) menggunakan C#." offSpacer="" %}}
