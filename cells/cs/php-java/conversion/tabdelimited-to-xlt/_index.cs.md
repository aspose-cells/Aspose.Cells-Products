---
title: Převodník PHP TABDELIMITED na XLT - TABDELIMITED na XLT
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům PHP plně integrovaný přístup k převodu dat TABDELIMITED do formátu XLT, což umožňuje bezproblémové ukládání dat TABDELIMITED do formátu XLT pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na XLT pomocí PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory TABDELIMITED na XLT? Vývojáři v PHP mohou snadno načíst a převést TABDELIMITED na XLT pomocí několika řádků kódu.
...
1.  Převeďte TABDELIMITED na XLT voláním metody save v sešitu.
1.  Získejte výsledek převodu TABDELIMITED na XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP knihovna pro převod TABDELIMITED na XLT" %}}
