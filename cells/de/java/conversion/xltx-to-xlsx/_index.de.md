---
title: Konvertieren Sie XLTX in XLSX über Java 
weight: 6210
url: /de/java/conversion/xltx-to-xlsx/ 
description: Beispiel-Umwandlungscode Java für das XLTX-Format in die XLSX-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in XLSX innerhalb jeder Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLTX in XLSX über Java" h2="XLTX-zu-XLSX-Java-Konvertierung zum Konvertieren einzelner oder mehrerer Seiten in XLSX mithilfe der lokalen Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLTX in XLSX mit Java" %}}

 Um XLTX in XLSX zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von XLTX in XLSX über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können XLTX-Dateien in nur wenigen Codezeilen einfach in XLSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. XLTX-Datei mit einer Instanz der Workbook-Klasse laden1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit XLSX-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende XLSX-Datei
...
{{% blocks/products/pf/agp/code-block title="XLTX-zu-XLSX-Java-Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die XLTX-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.xltx");
// Speichern Sie XLTX als XLSX
