...
{{% blocks/products/pf/agp/content h2="Cómo insertar CheckBox (control de formulario) en un archivo de Excel usando Python via java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa las colecciones de formas[añadir método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) para insertar una casilla de verificación (control de formulario) en la hoja de cálculo seleccionada.
