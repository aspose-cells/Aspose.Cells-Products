---
title:  Zoek document ODS zonder te openen via C++
weight: 3300
description: C++ voorbeeldcode om woorden met patroon te zoeken in het bestand ODS op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zoek ODS Formaten in C++" h2="Native en krachtige ODS-documentzoekopdracht met behulp van server-side Aspose.Cells for C++ API\'s, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u het bestand ODS kunt zoeken met behulp van C++" %}}
...
+ Laad het bestand ODS door een werkmapklasse te instantiëren.
...
+ Bewaar het ODS-bestand met de methode Workbook::Save(...).
