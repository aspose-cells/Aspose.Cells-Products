---
title: Convierte JSON a JPEG a través de Java 
weight: 5990
url: /es/java/conversion/json-to-jpeg/ 
description: Ejemplo de código de conversión Java para formato JSON a archivo JPEG. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a JPEG dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte JSON a JPEG a través de Java" h2="Exporte JSON a formato JPEG a través de Java sin necesidad de herramientas o bibliotecas adicionales." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JSON a JPEG usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir JSON a JPEG a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo JSON a JPEG con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Crear una nueva instancia de la clase Workbook1. Seleccione predeterminado o cualquier hoja de trabajo de la colección1. Cargar datos JSON desde un archivo1. Crear una instancia de JsonLayoutOptions y establecer opciones1. Llame al método JsonUtility.importData para importar datos JSON1. Cree y configure el objeto de ImageOrPrintOptions para la representación JPEG1. Crear SheetRender para renderizar1. Llame al método SheetRender.toImage para guardar el resultado en formato JPEG
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de JSON a JPEG Java" offSpacer="" %}}
