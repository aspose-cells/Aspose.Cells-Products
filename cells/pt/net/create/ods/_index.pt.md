...
description: Aspose Excel. Gere e manipule arquivos ODS sem esforço com a biblioteca Aspose.Cells for .NET. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos ODS diretamente em seus aplicativos C#, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
1.  Use o método Salvar para salvar a pasta de trabalho como arquivo ODS.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para criar o arquivo ODS" %}}
