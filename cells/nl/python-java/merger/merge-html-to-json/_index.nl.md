---
title:  Samenvoegen HTML naar JSON via Python
url: /nl/python-java/merger/merge-html-to-json/ 
description: Samenvoegen HTML naar JSON Online gratis. Gratis online HTML tot JSON Fusie. Voeg HTML samen met Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS en meer.
---
...
Het volgende voorbeeld laat zien hoe u HTML samenvoegt met JSON in Python.
...
{{% cells-merger title="Gratis app om HTML online samen te voegen tot JSON" InputFormat="html" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
