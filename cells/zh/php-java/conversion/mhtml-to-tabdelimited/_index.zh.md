...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 MHTML 转换为 TABDELIMITED。PHP MHTML 到 TABDELIMITED。 PHP 将 MHTML 保存为制表符。使用 PHP 将 MHTML 保存为 TABDELIMITED。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 PHP 中将 MHTML 转换为 TABDELIMITED" h2="用于将 MHTML 转换为 TABDELIMITED 的高速 PHP 库。这是一个使用 PHP 导入和导出 MHTML、TABDELIMITED 和许多其他格式的专业软件解决方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何通过 PHP 将 MHTML 转换为 TABDELIMITED" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 MHTML 文件转换为 TABDELIMITED 吗？ PHP 开发人员只需几行代码即可轻松加载 MHTML 并将其转换为 TABDELIMITED。
...
1. 通过调用Workbook的save方法将MHTML转换为TABDELIMITED。
1. 获取 MHTML 到 TABDELIMITED 的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP 库将 MHTML 转换为 TABDELIMITED" %}}
