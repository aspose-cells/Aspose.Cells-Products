...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHTML 轉換為 ETT。PHP MHTML 轉換為 ETT。 PHP 將 MHTML 儲存到 ETT。使用 PHP 將 MHTML 儲存為 ETT。
...
如何將 MHTML 轉換為 ETT？使用 Aspose.Cells for PHP via Java 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 MHTML 轉換為 ETT。[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 PHP Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="用 PHP 將 MHTML 儲存到 ETT" %}}
...
{{% cells-convert title="將 MHTML 轉換為 ETT 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="ett" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 PHP 將 MHTML 轉換為 ETT" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 MHTML 檔案轉換為 ETT？ PHP 開發人員只需幾行程式碼即可輕鬆載入 MHTML 並將其轉換為 ETT。
...
1. 透過呼叫Workbook的save方法將MHTML轉換為ETT。
1. 取得MHTML到ETT的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 MHTML 轉換為 ETT 的 PHP 函式庫" %}}
