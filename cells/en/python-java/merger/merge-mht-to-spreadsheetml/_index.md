...
description: Aspose Excel. Python Aspose.Cells. Merge MHT to SPREADSHEETML saveformat. Python Combine MHT to SPREADSHEETML format. Merge MHT to SPREADSHEETML in Python. MHT Merge.
...
{{% blocks/products/pf/agp/content h2="Merge MHT to SPREADSHEETML in Python" %}}
...
{{% cells-merger title="Sample Code to Merge MHT to SPREADSHEETML in Python" InputFormat="mht" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
