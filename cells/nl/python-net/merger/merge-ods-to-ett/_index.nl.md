...
description: Aspose Excel. Python Aspose.Cells. Voeg ODS samen naar ETT-opslagformaat. Python Combineer ODS naar ETT-formaat. Voeg ODS samen met ETT in Python. ODS Voeg samen.
...
{{% cells-merger title="Voorbeeldcode om ODS samen te voegen met ETT in Python" InputFormat="ods" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe u ODS samenvoegt met ETT via Python" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u ODS programmatisch samenvoegen met ETT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
