...
Potřebujete převést TSV soubory do SPREADSHEETML programově? C++ vývojáři mohou snadno převést TSV na SPREADSHEETML v několika řádcích kódu.
...
1. Převeďte TSV na SPREADSHEETML voláním metody Save().
