---
title:  Mesclar XLSB para TSV via C#
url: /pt/net/merger/merge-xlsb-to-tsv/ 
description: Mesclar XLSB para TSV Online gratuitamente. Online Grátis XLSB a TSV Fusão. Mesclar XLSB para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e mais.
---
...
O exemplo a seguir demonstra como mesclar XLSB a TSV em C#.
...
{{% cells-merger title="Aplicativo gratuito para mesclar XLSB a TSV on-line" InputFormat="xlsb" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
