---
title: Gabungkan HTM ke POWERPOINT - Gabungkan HTM ke POWERPOINT di Java
url: /id/java/merger/merge-htm-to-powerpoint/ 
description: Aspose Unggul. Java Aspose.Cells. Online Gratis Merge HTM to POWERPOINT saveformat. Java Gabungkan format HTM ke POWERPOINT. Gabungkan HTM ke POWERPOINT di Java. Gabungkan HTM.
...
{{% blocks/products/pf/agp/content h2="Gabungkan HTM ke POWERPOINT di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan HTM ke POWERPOINT di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk menggabungkan HTM ke POWERPOINT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file POWERPOINT. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan HTM ke POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis untuk Menggabungkan HTM ke POWERPOINT di Java" InputFormat="htm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan HTM ke POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan HTM ke POWERPOINT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk menggabungkan HTM ke POWERPOINT" %}}
