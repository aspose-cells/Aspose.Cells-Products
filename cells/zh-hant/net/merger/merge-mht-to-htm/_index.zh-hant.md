---
title: 將 MHT 合併到 HTM - 在 C# 中將 MHT 合併到 HTM
url: /zh-hant/net/merger/merge-mht-to-htm/ 
description: Aspose Excel。 C# Aspose.Cells。免費在線將 MHT 合併為 HTM 保存格式。 C# 將MHT合併為HTM格式。將 C# 中的 MHT 合併到 HTM。MHT 合併。
...
{{% blocks/products/pf/agp/content h2="在線免費將 C# 中的 MHT 合併為 HTM" %}}

以下示例演示如何將 Aspose.Cells for .NET 中的 MHT 合併為 HTM。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 合併到 HTM。上傳文件，調用Workbook.Combine方法合併文件，然後保存為HTM文件。如果您在 C# 中開發代碼，這會比聽起來更簡單。請參閱 C# 將 MHT 合併到 HTM 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將 MHT 合併為 HTM C#" InputFormat="mht" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 合併到 HTM" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 合併到 HTM？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 庫將 MHT 合併到 HTM" %}}
