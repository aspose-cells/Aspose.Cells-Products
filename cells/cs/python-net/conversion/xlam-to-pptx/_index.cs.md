---
title: XLAM až PPTX - Převést soubory XLAM na PPTX Python via Python
...
Následující příklad ukazuje, jak převést XLAM na PPTX v Python via NET.
...
{{% blocks/products/pf/agp/content h2="Jak převést XLAM na PPTX" %}}
