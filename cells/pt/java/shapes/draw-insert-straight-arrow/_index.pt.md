...
{{% blocks/products/pf/agp/content h2="Como inserir uma seta reta em um arquivo Excel usando Java" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Utilize o[adicionar método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) para inserir uma seta reta na planilha selecionada
