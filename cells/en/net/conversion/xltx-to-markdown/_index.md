...
description: Sample code for xltx to markdown C# conversion. Use API example code for batch xltx files to markdown conversion within VB.NET, Asp.NET or any .NET based application.
---
