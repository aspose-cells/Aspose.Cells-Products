---
title: Slå samman XLTX till CSV - Kombinera XLTX till CSV i C#
url: /sv/net/merger/merge-xltx-to-csv/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge XLTX till CSV sparaformat. C# Kombinera XLTX till CSV format. Slå samman XLTX till CSV i C#. XLTX Slå samman.
...
Följande exempel visar hur man slår samman XLTX till CSV i Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis online för att slå samman XLTX till CSV i C#" InputFormat="xltx" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLTX till CSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLTX till CSV programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
