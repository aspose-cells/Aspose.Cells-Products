---
title: C# EXCEL'den OTS'ye - EXCEL'den OTS'ye dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere EXCEL'i OTS formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak EXCEL verilerinin OTS formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i C#\'de OTS\'ye kaydedin" %}}

Aşağıdaki örnek, C# numaralı kodda EXCEL'i OTS'ye nasıl dönüştüreceğinizi göstermektedir.
...
EXCEL dosyalarını program aracılığıyla OTS'ye dönüştürmeniz mi gerekiyor? .NET geliştiriciler yalnızca birkaç satır kodla EXCEL'i kolayca yükleyebilir ve OTS'ye dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını OTS formatına dönüştürün.
1.  EXCEL'in OTS'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# EXCEL\'i OTS\'ye dönüştürmek için kullanılan kütüphane" %}}
