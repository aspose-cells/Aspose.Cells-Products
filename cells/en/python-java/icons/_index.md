...
{{% blocks/products/pf/agp/content h2="How to Insert Icons into Excel File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Icons to Excel file via Python" %}}
...
+  Use the shapecollection's [add method](https://apireference.aspose.com/cells/java/com.aspose.cells/shapecollection#addIcons(int,%20int,%20int,%20int,%20int,%20int,%20byte[],%20byte[])) to insert a Picture in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert Icons - Python" offSpacer="" %}}
