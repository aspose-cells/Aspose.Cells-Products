...
description: Aspose اكسل. قم بتحويل EXCEL إلى ETT بسرعة وسهولة باستخدام Aspose.Cells. Java EXCEL إلى ETT. Java حفظ EXCEL إلى ETT. احفظ EXCEL باسم ETT باستخدام Java.
...
{{% blocks/products/pf/agp/content h2="تحويل EXCEL إلى ETT باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ EXCEL إلى ETT في Java" %}}

يوضح المثال التالي كيفية تحويل EXCEL إلى ETT في Java.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل EXCEL إلى ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ett" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل EXCEL إلى ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات EXCEL إلى ETT برمجياً؟ يمكن لمطوري Java تحويل EXCEL إلى ETT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل EXCEL إلى ETT" %}}
{{% blocks/products/pf/agp/text %}}
