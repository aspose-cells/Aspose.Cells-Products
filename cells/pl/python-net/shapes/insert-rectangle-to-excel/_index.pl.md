...
{{% blocks/products/pf/agp/content h2="Jak wstawić prostokąt do pliku Excel za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić prostokąt do pliku Excel za pośrednictwem Python" %}}
...
+ Użyj metody dodawania kolekcji shapecollection, aby wstawić prostokąt w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw prostokąt - Python" offSpacer="" %}}
