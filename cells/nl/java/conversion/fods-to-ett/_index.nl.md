...
Het volgende voorbeeld laat zien hoe je FODS omzet naar ETT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar ETT via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u FODS-bestanden programmatisch naar ETT converteren? Ontwikkelaars van Java kunnen FODS-bestanden eenvoudig in een paar regels code naar ETT converteren.
