---
title: Sloučit EXCEL s XPS - Kombinovat EXCEL s XPS v C++
url: /cs/cpp/merger/merge-excel-to-xps/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma sloučit EXCEL do XPS saveformat. C++ Kombinujte EXCEL do formátu XPS. Sloučit EXCEL na XPS v C++. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL na XPS v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit EXCEL s XPS v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení EXCELu s XPS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XPS. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí EXCEL do XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení EXCELu s XPS v C++" InputFormat="xlsx" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL s XPS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit EXCEL s XPS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení EXCELu s XPS" %}}
