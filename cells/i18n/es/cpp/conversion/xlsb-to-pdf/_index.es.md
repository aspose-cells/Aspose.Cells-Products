---
title: Convierta XLSB a PDF a través de la aplicación C++ 
weight: 5360
url: /es/cpp/conversion/xlsb-to-pdf/ 
description: Ejemplo de código de conversión C++ para documento XLSB a formato PDF. Los programadores pueden usar este código fuente para la conversión por lotes de XLSB a PDF dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta XLSB a PDF a través de C++" h2="Conversión de XLSB a PDF de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLSB a PDF usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLSB a PDF a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de C++ pueden convertir fácilmente un archivo XLSB a PDF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLSB usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (PDF).1. El archivo PDF se guardará en la ruta especificada.1. Abra el archivo PDF en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLSB a PDF C++" offSpacer="" %}}
