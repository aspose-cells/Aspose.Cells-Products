...
url: /ar/net/merger/merge-prn-to-word/ 
...
يوضح المثال التالي كيفية دمج PRN إلى WORD في Aspose.Cells for .NET.
...
هل تحتاج إلى دمج PRN في WORD برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج PRN إلى WORD" %}}
