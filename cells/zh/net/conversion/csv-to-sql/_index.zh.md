---
title: C# CSV 到 SQL - CSV 到 SQL 转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 CSV 转换为 SQL 格式，从而能够使用 Aspose.Cells 库将 CSV 数据无缝保存为 SQL 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 CSV 保存到 SQL 数据库 C#" %}}

以下示例演示了如何将 CSV 转换为 C# 中的 SQL。
...
{{% cells-convert title="将 CSV 转换为 SQL 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="csv" outformat="sql" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="C# 库用于将 CSV 转换为 SQL" %}}
