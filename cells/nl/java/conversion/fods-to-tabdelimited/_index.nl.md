---
title: Converteer FODS naar TABDELIMITED via Java 

description: Voorbeeld Java conversiecode voor FODS-indeling naar TABDELIMITED-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets te exporteren naar TABDELIMITED binnen elke web- of desktoptoepassing Java.
---
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar TABDELIMITED te converteren met Java" %}}

 Om FODS naar TABDELIMITED weer te geven, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om FODS om te zetten naar TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het FODS-bestand gemakkelijk converteren naar TABDELIMITED in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad FODS-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef het uitvoerpad door met de TABDELIMITED-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende TABDELIMITED-bestand
...
{{% blocks/products/pf/agp/code-block title="FODS naar TABDELIMITED Java Broncode voor conversie" offSpacer="" %}}

```cs
// laad het FODS-bestand in een exemplaar van Workbook
Workbook book = new Workbook("template.fods");
// sla FODS op als TABDELIMITED
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS naar TABDELIMITED Conversie Live demo\'s" sectionDescription="[Converteer FODS naar TABDELIMITED](https://products.aspose.app/cells/conversion/fods-to-tabdelimited) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw FODS-bestand, het wordt onmiddellijk geconverteerd naar TABDELIMITED." >}}
