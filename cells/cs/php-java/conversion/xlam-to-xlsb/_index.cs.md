---
title: Konvertor PHP XLAM až XLSB - XLAM až XLSB
description: Aspose Excel. Převeďte XLAM na XLSB rychle a snadno pomocí Aspose.Cells. PHP XLAM na XLSB. PHP Uložte XLAM na XLSB. Uložte XLSB jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xlsb" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na XLSB přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na XLSB programově? Vývojáři PHP mohou snadno načíst a převést XLAM na XLSB v několika řádcích kódu.
...
1.  Převeďte XLAM na XLSB voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na XLSB" %}}
