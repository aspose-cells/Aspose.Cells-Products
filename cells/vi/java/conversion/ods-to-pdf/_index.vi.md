---
title: Java ODS thành PDF - Bộ chuyển đổi ODS thành PDF trực tuyến
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Trực tuyến miễn phí Java Chuyển đổi ODS thành PDF định dạng lưu. Java ODS đến PDF định dạng. Lưu ODS thành PDF Java.
...
{{% blocks/products/pf/agp/content h2="Lưu ODS thành PDF trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi ODS thành PDF trong Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để chuyển đổi ODS thành PDF. Tải tệp ODS của bạn lên, sau đó chỉ cần lưu tệp thành PDF. Đối với cả ODS đọc và PDF viết, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng PDF đầu ra sẽ giống với tài liệu gốc ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi ODS thành PDF trực tuyến" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="pdf" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi ODS thành PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi các tệp ODS thành PDF theo chương trình? Java nhà phát triển có thể dễ dàng chuyển đổi ODS thành PDF chỉ bằng một vài dòng mã.
...
1.  Lấy kết quả chuyển đổi từ ODS thành PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java thư viện để chuyển đổi ODS thành PDF" %}}
{{% blocks/products/pf/agp/text %}}
