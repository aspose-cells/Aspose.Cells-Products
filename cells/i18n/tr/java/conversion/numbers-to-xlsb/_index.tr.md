---
title: NUMBERS'ı Java aracılığıyla XLSB'ye dönüştürün 
url: /tr/java/conversion/numbers-to-xlsb/ 
description: NUMBERS biçimi için XLSB dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada XLSB'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="NUMBERS\'ı Java aracılığıyla XLSB\'ye dönüştürün" h2="Şirket İçi Java kitaplığını kullanarak tek veya birden çok sayfayı XLSB\'ye dönüştürmek için NUMBERS\'ı XLSB\'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak NUMBERS\'ı XLSB\'ye Dönüştürme" %}}

 NUMBERS'ı XLSB'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="NUMBERS\'ı Java aracılığıyla XLSB\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, NUMBERS dosyasını yalnızca birkaç kod satırıyla kolayca XLSB'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. NUMBERS dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. XLSB uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan XLSB dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="NUMBERS - XLSB Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// NUMBERS dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.numbers");
// NUMBERS'i XLSB olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS - XLSB Dönüşüm Canlı Demoları" sectionDescription="[NUMBERS\'i XLSB\'ye dönüştür](https://products.aspose.app/cells/conversion/numbers-to-xlsb) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece NUMBERS dosyanızı yükleyin, anında XLSB\'ye dönüştürülecektir." >}}
