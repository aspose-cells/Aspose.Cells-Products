---
title:  Voeg ListBox (formulierbesturingselement) in Excel in met behulp van Python via .Net
weight: 50
description: Python via .Net-broncode om ListBox (formulierbesturingselement) in Excel in te voegen.
...
{{% blocks/products/pf/agp/content h2="Hoe ListBox (formulierbesturingselement) in Excel-bestand in te voegen met behulp van Python via .Net" %}}

 Om ListBox (formulierbesturingselement) in het Excel-bestand in te voegen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ListBox (formulierbesturingselement) in te voegen in een Excel-bestand met behulp van Python via .Net" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de toevoeging van de vormcollectie[methode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_list_box/#int-int-int-int-int-int) om een ListBox (formulierbesturingselement) in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="ListBox invoegen (formulierbeheer) - Python via .Net" offSpacer="" %}}
