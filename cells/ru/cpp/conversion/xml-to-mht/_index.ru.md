...
Нужно программно преобразовать XML-файлы в MHT? Разработчики, использующие код C++, могут легко преобразовать XML в MHT всего за несколько строк кода.
