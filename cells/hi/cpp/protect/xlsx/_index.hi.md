...
weight: 1140
description: C++ पर पासवर्ड का उपयोग करके XLSX फ़ाइल को लॉक करने के लिए C++ उदाहरण कोड Windows 32 बिट, Windows 64 बिट और लिनक्स 64 बिट के लिए रनटाइम पर्यावरण।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSX फ़ाइलों को C++ के माध्यम से एन्क्रिप्ट करें" h2=".NET लाइब्रेरी का उपयोग करके XLSX प्रारूप सहित एक्सेल स्प्रेडशीट को पासवर्ड से सुरक्षित रखें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSX फ़ाइलों को C++ के माध्यम से सुरक्षित करने के चरण" %}}
...
1.  सुरक्षित XLSX फ़ाइल को सहेजें () विधि से सहेजें
