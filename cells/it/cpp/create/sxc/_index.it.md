---
title: Crea SXC - Crea file SXC in C++
description: Aspose Excel. C++ Crea SXC File. Crea SXC C++. C++ SXC Creatore. Crea SXC in C++. Genera il file SXC utilizzando C++.
keywords: [Aspose Excel., C++ Aspose.Cells., Create SXC C++., C++ SXC Creater., Create SXC file in C++., Generate SXC file in C++]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crea il file SXC in C++" h2="Creazione di file SXC nativa e ad alte prestazioni a livello di programmazione senza Micorsoft Office utilizzando la libreria C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come creare SXC in C++" %}}

{{% blocks/products/pf/agp/text %}}

 È facile per gli sviluppatori creare, caricare, modificare e convertire i file SXC all'interno delle applicazioni di reporting in esecuzione per l'elaborazione dei dati in poche righe di codice.
...
1.  Salva la cartella di lavoro come file .sxc utilizzando il metodo Save().

{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare il file SXC in C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ libreria per creare il file SXC" %}}
