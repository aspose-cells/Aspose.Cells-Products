---
title: Java aracılığıyla XLS'yi TABDELIMITED'e dönüştürün 

description: XLS biçimi için TABDELIMITED dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada TABDELIMITED'e aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla XLS\'yi TABDELIMITED\'e dönüştürün" h2="Şirket içi Java kitaplığını kullanarak tek veya birden çok sayfayı TABDELIMITED\'e dönüştürmek için XLS\'den TABDELIMITED\'e Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak XLS\'yi TABDELIMITED\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla XLS\'yi TABDELIMITED\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla XLS dosyasını kolayca TABDELIMITED'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. XLS dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. TABDELIMITED uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan TABDELIMITED dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="XLS - TABDELIMITED Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// XLS dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.xls");
// XLS'yi TABDELIMITED olarak kaydet
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS\'den TABDELIMITED\'e Dönüşüm Canlı Demoları" sectionDescription="[XLS\'yi TABDELIMITED\'ye dönüştür](https://products.aspose.app/cells/conversion/xls-to-tabdelimited) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece XLS dosyanızı yükleyin, anında TABDELIMITED\'e dönüştürülecektir." >}}
