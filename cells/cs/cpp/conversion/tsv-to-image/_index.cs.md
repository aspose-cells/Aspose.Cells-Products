...
Potřebujete převést TSV soubory na IMAGE programově? C++ vývojáři mohou snadno převést TSV na IMAGE v několika řádcích kódu.
...
1.  Převeďte TSV na IMAGE voláním metody Save().
