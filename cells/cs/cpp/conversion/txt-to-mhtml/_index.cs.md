...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor TXT na MHTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (MHTML).1. Soubor MHTML bude uložen do zadané cesty.1. Otevřete soubor MHTML v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze TXT na MHTML C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze TXT na MHTML" sectionDescription="[Převést TXT na MHTML](https://products.aspose.app/cells/conversion/txt-to-mhtml) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj TXT soubor, bude okamžitě převeden do MHTML." >}}
