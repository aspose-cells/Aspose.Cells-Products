...
url: /ja/python-java/merger/merge-prn-to-jpg/ 
...
次の例は、Aspose.Cells for Python via Java で PRN を JPG に結合する方法を示しています。
...
PRNをJPGにプログラムで結合する必要がありますか？基本的な文書の結合と連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
