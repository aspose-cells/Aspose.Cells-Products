---
title: ใส่หมายเหตุไปที่ XLSM ไฟล์ via .NET
url: /th/net/notes/insert-notes-to-xlsm/ 
description: ใส่บันทึกไปที่ XLSM โดยใช้ C# ใช้โค้ดตัวอย่าง API เพื่อแทรกบันทึกภายในแอปพลิเคชัน .NET
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกบันทึกย่อในไฟล์ XLSM ผ่าน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่าง C# สำหรับแทรกและลบบันทึกย่อในไฟล์ XLSM" offSpacer="" %}}
