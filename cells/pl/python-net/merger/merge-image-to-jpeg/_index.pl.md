...
url: /pl/python-net/merger/merge-image-to-jpeg/ 
...
Poniższy przykład pokazuje, jak połączyć IMAGE z JPEG w Aspose.Cells for Python via .NET.
...
Chcesz programowo scalić IMAGE z JPEG? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
