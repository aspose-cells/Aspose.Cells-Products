...
url: /hu/net/merger/merge-spreadsheetml-to-excel/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a SPREADSHEETML-t az EXCEL-lel a Aspose.Cells for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a SPREADSHEETML-t az EXCEL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a SPREADSHEETML és az EXCEL egyesítéséhez" %}}
