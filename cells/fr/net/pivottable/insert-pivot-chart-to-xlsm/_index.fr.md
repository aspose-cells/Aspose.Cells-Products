...
weight: 7690
description: C# Exemple de code pour générer des documents XLSM avec tableau croisé dynamique. Utilisez ce code pour créer des fichiers Micorsoft Excel XLSM avec un tableau croisé dynamique dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérer un tableau croisé dynamique dans les documents XLSM via C#" h2="Feuille de calcul Microsoft Excel XLSM native et hautes performances avec création de tableau croisé dynamique par programmation à l\'aide des API côté serveur .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Il est facile de générer dynamiquement un fichier MS Excel XLSM avec un graphique croisé dynamique dans l'application en cours d'exécution. Afin de créer des documents XLSM avec un tableau croisé dynamique à partir de zéro sans nécessiter MS Office, nous utiliserons
