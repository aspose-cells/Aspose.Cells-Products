---
title: Agrupar e desagrupar formas no Excel via Java
weight: 360
description: Agrupar e desagrupar objetos usando Aspose.Cells' Java API sem qualquer software como Microsoft ou Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Como agrupar e desagrupar formas em arquivo Excel usando sJava" %}}

 Para agrupar e desagrupar formas em um arquivo Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para agrupar e desagrupar formas no arquivo Excel via Java" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Utilize o[método de grupo](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#group-com.aspose.cells.Shape---) para agrupar formas na planilha selecionada
 + Utilize o[método de desagrupar](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#ungroup-com.aspose.cells.GroupShape-) para desagrupar formas na planilha selecionada
...
{{% blocks/products/pf/agp/code-block title="Agrupar e desagrupar formas - Java" offSpacer="" %}}
