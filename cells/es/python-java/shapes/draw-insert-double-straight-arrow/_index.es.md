---
title:  ¿Cómo dibujo o inserto una flecha recta doble en Excel usando Python via java?
weight: 10
description: Python via código fuente java para dibujar o insertar flecha doble recta en Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Inserte una flecha doble recta en Excel usando Python via java" h2="Inserte una flecha recta doble usando Aspose.Cells\' API sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo insertar una doble flecha recta en un archivo de Excel usando Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar una doble flecha recta en un archivo de Excel usando Python via java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa la colección de formas[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) para insertar una doble flecha recta en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar doble flecha recta - Python via java" offSpacer="" %}}
