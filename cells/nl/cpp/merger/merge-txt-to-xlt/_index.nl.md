---
title: Voeg TXT samen met XLT - Combineer TXT met XLT in C++
url: /nl/cpp/merger/merge-txt-to-xlt/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen TXT naar XLT saveformat. C++ Combineer het formaat TXT tot XLT. Samenvoegen TXT tot XLT in C++. TXT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met XLT in C++ Online gratis" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met XLT in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TXT samen te voegen met XLT. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand XLT. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat TXT samenvoegt met XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om TXT samen te voegen tot XLT in C++" InputFormat="txt" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe TXT samen te voegen met XLT via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen tot XLT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TXT samen te voegen tot XLT" %}}
