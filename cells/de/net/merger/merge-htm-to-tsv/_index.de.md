---
title: HTM mit TSV zusammenführen – HTM mit TSV in C# kombinieren
url: /de/net/merger/merge-htm-to-tsv/ 
description: Aspose Excel. C# Aspose.Cells. HTM mit dem Sicherungsformat TSV zusammenführen. C# Kombinieren Sie HTM mit dem Format TSV. HTM zu TSV in C# zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="HTM mit TSV in C# zusammenführen" %}}

Das folgende Beispiel zeigt, wie HTM mit TSV in Aspose.Cells for .NET zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von HTM mit TSV in C#" InputFormat="htm" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie HTM über C# mit TSV zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM programmgesteuert mit TSV zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
