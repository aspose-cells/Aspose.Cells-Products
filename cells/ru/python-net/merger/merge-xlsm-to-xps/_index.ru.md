...
description: Aspose Эксель. Python Aspose.Cells. Объедините XLSM и XPS в формате сохранения. Python Объедините форматы XLSM и XPS. Объедините XLSM и XPS в Python. XLSM Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM с XPS, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM и XPS в Python." %}}

В следующем примере показано, как объединить XLSM и XPS в Aspose.Cells for Python via .NET.
