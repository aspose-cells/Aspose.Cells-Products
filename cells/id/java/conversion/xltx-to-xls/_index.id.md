...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLTX menjadi XLS di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi XLTX ke XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLTX, XLS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke XLS menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke XLS di Java" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX menjadi XLS di Java.
...
Perlu mengkonversi file XLTX ke XLS secara terprogram? Pengembang Java dapat dengan mudah mengkonversi XLTX ke XLS hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi XLTX menjadi XLS" %}}
{{% blocks/products/pf/agp/text %}}
