...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση SXC σε μορφή αποθήκευσης SPREADSHEETML. Java Συνδυάστε το SXC σε μορφή SPREADSHEETML. Συγχώνευση SXC στο SPREADSHEETML στο Java. SXC Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση SXC στο SPREADSHEETML στο Java" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση SXC στο SPREADSHEETML στο Java" InputFormat="sxc" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
