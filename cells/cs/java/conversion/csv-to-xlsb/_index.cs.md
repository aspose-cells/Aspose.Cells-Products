...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na XLSB pomocí Java" %}}

 K vykreslení CSV do XLSB použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu CSV na XLSB prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na XLSB pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLSB a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLSB
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na XLSB Java" offSpacer="" %}}

```cs
// načíst soubor CSV v instanci sešitu
Workbook book = new Workbook("template.csv");
// uložit CSV jako XLSB
