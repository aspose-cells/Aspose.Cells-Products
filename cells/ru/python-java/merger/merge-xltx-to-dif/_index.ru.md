...
description: Aspose Эксель. Python Aspose.Cells. Объедините XLTX и DIF в формате сохранения. Python Объедините форматы XLTX и DIF. Объедините XLTX и DIF в Python. XLTX Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините XLTX с DIF, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините XLTX и DIF в Python." %}}

В следующем примере показано, как объединить XLTX и DIF в Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/content h2="Как объединить XLTX с DIF через Python" %}}
