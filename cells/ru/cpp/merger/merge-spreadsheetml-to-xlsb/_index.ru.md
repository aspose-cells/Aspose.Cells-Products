---
title:  Объединить SPREADSHETML в XLSB через C++
...
В следующем примере показано, как объединить SPREADSHEETML с XLSB в C++.
