---
title: Hợp nhất XLSM thành XLSB - Hợp nhất XLSM thành XLSB thành C#
url: /vi/net/merger/merge-xlsm-to-xlsb/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí XLSM thành XLSB saveformat. C# Kết hợp định dạng XLSM thành XLSB. Hợp nhất XLSM thành XLSB thành C#. XLSM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLSM thành XLSB trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất XLSM thành XLSB trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất XLSM thành XLSB. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp XLSB. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất XLSM thành XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Hợp nhất trực tuyến miễn phí XLSM thành XLSB trong C#" InputFormat="xlsm" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XLSM thành XLSB qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất XLSM thành XLSB theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất XLSM thành XLSB" %}}
