...
url: /nl/python-net/merger/merge-ods-to-jpg/ 
...
Het volgende voorbeeld laat zien hoe u ODS kunt samenvoegen met JPG in Aspose.Cells for Python via .NET.
...
Wilt u ODS programmatisch samenvoegen met JPG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
