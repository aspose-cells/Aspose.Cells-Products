...
description: Aspose Эксель. Преобразуйте XLT в XLTM быстро и легко с помощью Aspose.Cells. Python XLT в XLTM. Python Сохранить XLT в XLTM. Сохранить XLT как 07611134 81, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразуйте XLT в XLTM, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните с XLT по XLTM в Python." %}}
...
{{% cells-convert title="Пример кода для преобразования XLT в XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xltm" IsLandingPage="true" language="pythonjava" %}}
