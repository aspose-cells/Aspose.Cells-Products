---
title:  XLSB फाइलों में रिपोर्ट तैयार करें via Java
weight: 3560
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम पर्यावरण पर XLSB प्रारूप रिपोर्ट बनाने के लिए Java नमूना कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB प्रारूप via Java में बल्क रिपोर्ट जनरेशन" h2="डेटा स्रोत और एक टेम्पलेट का उपयोग करके XLSB प्रारूप में रिपोर्ट तैयार करें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके XLSB रिपोर्ट कैसे जनरेट करें" %}}
...
1.  परिणाम को XLSB प्रारूप में Worbook.save विधि के माध्यम से सहेजें
...
{{% blocks/products/pf/agp/code-block title="XLSB प्रारूप में एक्सेल रिपोर्ट उत्पन्न करें - C#" offSpacer="" %}}
