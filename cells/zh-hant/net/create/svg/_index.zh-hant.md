...
{{% blocks/products/pf/agp/content h2="如何在C#中創建SVG" %}}

{{% blocks/products/pf/agp/text %}}

開發人員只需幾行代碼即可輕鬆在運行不同的報告應用程序中創建、加載、修改和轉換 SVG 文件以進行數據處理。
...
1. 使用 Save 方法將工作簿另存為 SVG 文件。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 C# 中創建 SVG 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#庫創建SVG文件" %}}
