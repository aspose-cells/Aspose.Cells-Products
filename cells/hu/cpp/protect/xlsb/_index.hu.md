---
title:  A XLSB dokumentum védelme és zárolása a C++ számon keresztül
weight: 4860
description: C++ példakód a XLSB fájl zárolásához jelszóval a C++ futásidejű környezet Windows 32 bites, Windows 64 bites és 64 bites Linux esetén.
...
{{< blocks/products/pf/i18n/upper-banner h1="XLSB fájlok titkosítása a C++ számon keresztül" h2="Jelszóvédett Excel-táblázatok, beleértve a XLSB formátumot a .NET könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="A XLSB fájl biztonságossá tétele a C++ használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A XLSB fájlok védelmének lépései a C++ számon keresztül" %}}
...
1.  Töltse be a XLSB fájlt a munkafüzet osztály használatával
1.  Használja a Protect(..) metódust a ProtectionType-val és a jelszóval
1.  Mentse a védett XLSB fájlt a Mentés() metódussal
