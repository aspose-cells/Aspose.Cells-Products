---
title:  Zoek en vervang tekst in XLSX document via .NET
weight: 2370
description: C#-broncode om gevoelige informatie te redigeren in het XLSX-bestand op .NET Framework, .NET Core, Mono of Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLSX-bestanden in C# te redigeren" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSX-bestanden redigeren - C#" offSpacer="" %}}
