...
{{% blocks/products/pf/agp/content h2="كيفية دمج ملفات TSV باستخدام Java" %}}
...
+ قم بتحميل ملف TSV الأول بنسخة من فئة المصنف.
+ قم بتحميل مستند TSV الثاني بنسخة من فئة المصنف.
...
{{% blocks/products/pf/agp/code-block title="دمج ملفات TSV - Java" offSpacer="" %}}
