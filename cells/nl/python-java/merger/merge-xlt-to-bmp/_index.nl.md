...
description: Aspose Excel. Python Aspose.Cells. Voeg XLT samen met het opslagformaat BMP. Python Combineer het formaat XLT met BMP. Voeg XLT samen met BMP in Python. XLT Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen met BMP met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen met BMP in Python" %}}
...
{{% cells-merger title="Voorbeeldcode om XLT samen te voegen met BMP in Python" InputFormat="xlt" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLT samenvoegt met BMP via Python" %}}
