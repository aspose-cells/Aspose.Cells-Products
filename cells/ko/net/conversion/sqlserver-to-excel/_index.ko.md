---
title: C# SqlServer에서 EXCEL로 - SqlServer에서 EXCEL로 변환기
description: Aspose 엑셀. Aspose.Cells을 사용하여 SqlServer를 EXCEL로 빠르고 쉽게 변환하세요. C# SqlServer를 EXCEL로 변환하세요. C# SqlServer를 EXCEL에 저장합니다. C#을 사용하여 SqlServer를 EXCEL로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="C#을 통해 SqlServer를 EXCEL로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 SqlServer 데이터를 EXCEL로 변환해야 합니까? .NET 개발자는 단 몇 줄의 코드만으로 SqlServer를 쉽게 로드하고 EXCEL로 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1.  'Aspose.Cells for .NET'을 설치합니다.
1.  C# 프로젝트에 라이브러리 참조를 추가합니다(라이브러리 가져오기).
1.  SqlServer 데이터베이스에서 데이터를 쿼리하여 DataTable 개체를 얻습니다.
1.  새 통합 문서를 만들고 DataTable 개체에서 데이터를 가져옵니다.
1. Workbook.Save 메서드를 호출하여 데이터를 xlsx 형식으로 저장합니다.

{{% blocks/products/pf/agp/code-block title="SqlServer를 EXCEL로 변환하는 샘플 코드 - C#" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="SqlServer를 EXCEL로 변환하는 C# 라이브러리" %}}
