---
title: Convertir TABDELIMITED en XLT via Java 
url: /fr/java/conversion/tabdelimited-to-xlt/ 
description: Exemple de code de conversion Java pour le format TABDELIMITED en fichier XLT. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers XLT dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TABDELIMITED en XLT via Java" h2="Conversion TABDELIMITED vers XLT Java pour convertir une ou plusieurs pages en XLT à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TABDELIMITED en XLT en utilisant Java" %}}

 Afin de rendre TABDELIMITED en XLT, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TABDELIMITED en XLT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier TABDELIMITED en XLT en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier TABDELIMITED avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension XLT et SaveFormat comme paramètres1. Vérifiez le chemin spécifié pour le fichier XLT résultant
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED à XLT Java code source de conversion" offSpacer="" %}}

```cs
// charger le fichier TABDELIMITED dans une instance de Workbook
Workbook book = new Workbook("template.tabdelimited");
// enregistrer TABDELIMITED en tant que XLT
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion TABDELIMITED vers XLT" sectionDescription="[Convertir TABDELIMITED en XLT](https://products.aspose.app/cells/conversion/tabdelimited-to-xlt) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier TABDELIMITED, il sera converti instantanément en XLT." >}}
