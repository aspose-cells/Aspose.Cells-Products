...
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 MHT 轉換為 DIF 格式，從而能夠使用 Aspose.Cells 庫將 MHT 資料無縫保存為 DIF 格式，所有這些程式都透過高效能客製化的 08153481 1081348133。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Python Excel 庫中的 MHT 轉換為 DIF" h2="高速 Python Excel 函式庫，用於將 MHT 轉換為 DIF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將 Python Excel 庫中的 MHT 轉換為 DIF" %}}
...
{{% blocks/products/pf/agp/content h2="將 MHT 儲存到 Python Excel 庫中的 DIF" %}}

以下範例示範如何將 Python excel 庫中的 MHT 轉換為 DIF。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 轉換為 DIF。對於 MHT 讀取和 DIF 寫入，您可以使用完全限定的檔案名稱。輸出 DIF 內容和格式將與原始 MHT 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="透過 Python Excel 庫將 MHT 轉換為 DIF 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="dif" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 MHT 轉換為 DIF" %}}
