---
title:  Editar ou visualizar metadados de arquivos XLSM via Java
weight: 9030
description: Código de amostra Java para editar ou visualizar metadados do formato XLSM no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
...
{{< blocks/products/pf/i18n/upper-banner h1="Extraia XLSM Metadados via Java" h2="Crie seus próprios aplicativos Java para adicionar, editar, remover ou extrair metadados de arquivos XLSM usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Como extrair metadados XLSM usando Java" %}}

 Para obter metadados do arquivo XLSM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para extrair metadados de XLSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Acesse informações úteis armazenadas no arquivo XLSM, incluindo quando o arquivo XLSM foi recebido, processado, marcado com data e hora e assim por diante.

{{% /blocks/products/pf/agp/text %}}

+ Carregue o arquivo XLSM em WorkbookMetadata
+ Crie objeto MetadataOptions com opções relevantes
+ Defina as propriedades relevantes
+ Salve as informações de metadados XLSM
...
{{% blocks/products/pf/agp/code-block title="Extraia metadados de XLSM - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos Excel Microsoft em diferentes formatos. Além disso, pode ser usado para gráficos abrangentes, relatórios escalonáveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API independente e não requer nenhum software como Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Extraia metadados de XLSM via aplicativo online" sectionDescription=" Visualize e edite metadados para documentos XLSM usando nosso[Demonstrações ao vivo](https://products.aspose.app/cells/metadata) com os seguintes benefícios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar ou configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta enviar seu arquivo XLSM e editar as propriedades do documento" >}}
