---
title: Java ODS na MHT - ODS na konwerter MHT
description: Aspose Excel. Szybko i łatwo przekonwertuj ODS na MHT za pomocą Aspose.Cells. Java ODS na MHT. Java Zapisz ODS w MHT. Zapisz ODS jako MHT, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz ODS w MHT w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować ODS na MHT w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować ODS na MHT. Prześlij plik ODS, a następnie po prostu zapisz go jako plik MHT. Zarówno do odczytu ODS, jak i do zapisu MHT, można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie MHT będą identyczne z oryginalnym dokumentem ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji ODS na MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="mht" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować ODS na MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki ODS na MHT? Programiści Java mogą z łatwością przekonwertować ODS na MHT w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji ODS na MHT" %}}
{{% blocks/products/pf/agp/text %}}
