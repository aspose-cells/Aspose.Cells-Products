---
title: Sloučit JSON až ODS - Sloučit JSON až ODS v C++
url: /cs/cpp/merger/merge-json-to-ods/ 
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma JSON do formátu uložení ODS. C++ Kombinujte formát JSON až ODS. Sloučit JSON až ODS v C++. JSON Sloučit.
...
Následující příklad ukazuje, jak sloučit JSON až ODS v Aspose.Cells for C++.
...
{{% cells-merger title="Online zdarma ke sloučení JSON až ODS v C++" InputFormat="json" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON na ODS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JSON až ODS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení JSON až ODS" %}}
