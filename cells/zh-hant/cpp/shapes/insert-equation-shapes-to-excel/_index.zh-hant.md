---
title: 通過 C++ 將方程形狀插入 Excel
weight: 780
description: C++ 在 C++ 運行時環境（適用於 Windows 32 位、Windows 64 位和 Linux 64 位）上的 Excel 文件中插入方程形狀的示例代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 將方程形狀插入 Excel" h2="使用服務器端的本機高性能插入對象 Aspose.Cells for C++ API，無需使用任何軟件，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 將方程形狀插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C++ 將方程形狀插入 Excel 文件的步驟" %}}

實例化一個 Workbook 對象。（或者->加載 XLSX 文件的完整路徑。）
+ 通過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ab8156e8562724f9a597b7d2bc503cd4d)在選定的工作表中插入方程形狀
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入方程形狀 - C++" offSpacer="" %}}
