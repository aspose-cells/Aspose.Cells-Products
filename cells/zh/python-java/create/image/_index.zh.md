---
title: 创建图像 - 在 Python 中创建图像文件
description: Aspose Excel。Python Excel。Python 使用 Aspose.Cells 快速轻松地创建 IMAGE 文件。使用 Python Excel 库生成 IMAGE 文件。在 Python Excel 库中创建 IMAGE。Python IMAGE Creater。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Python Excel 库中创建图像文件" h2="用于创建 IMAGE 文件的高速 Python Excel 库。这是一个专业的软件解决方案，可使用 Python 导入和导出 XLSX、PDF 以及许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. 使用保存方法将工作簿保存为 IMAGE 文件。

{{% blocks/products/pf/agp/code-block title="示例代码显示如何在 Python excel 库中创建 IMAGE 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 库创建图像文件" %}}
