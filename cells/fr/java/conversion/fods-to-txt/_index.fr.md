---
title: Convertir FODS en TXT via Java 
url: /fr/java/conversion/fods-to-txt/ 
description: Exemple de code de conversion Java pour le format FODS en fichier TXT. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers TXT dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir FODS en TXT via Java" h2="Conversion FODS en TXT Java pour convertir une ou plusieurs pages en TXT à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir FODS en TXT en utilisant Java" %}}

 Afin de rendre FODS en TXT, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir FODS en TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier FODS en TXT en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier FODS avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension TXT et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier TXT résultant
...
{{% blocks/products/pf/agp/code-block title="FODS à TXT Java Code source de conversion" offSpacer="" %}}

```cs
// charger le fichier FODS dans une instance de Workbook
Workbook book = new Workbook("template.fods");
// enregistrer FODS en tant que TXT
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion FODS en TXT" sectionDescription="[Convertir FODS en TXT](https://products.aspose.app/cells/conversion/fods-to-txt) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier FODS, il sera converti instantanément en TXT." >}}
