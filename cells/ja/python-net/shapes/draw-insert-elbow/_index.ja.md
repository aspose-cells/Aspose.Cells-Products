---
title: Python via .Net を使用して Excel に肘の形状を描画または挿入する方法
weight: 10
description: Python via Excel に肘の形状を挿入するための .Net ソース コード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via .Net を使用して肘の形状を Excel に挿入します" h2="Microsoft や Open Office、Adobe PDF などのソフトウェアを使用せずに、Aspose.Cells\' API を使用して肘の形状を挿入します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via .Net を使用して肘の形状を Excel ファイルに挿入する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net を使用してエルボ形状を Excel ファイルに挿入する手順" %}}
...
+ インデックスからワークシートを選択します。
 シェイプコレクションの追加を使用します[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)選択したワークシートに肘の形状を挿入します。
...
{{% blocks/products/pf/agp/code-block title="エルボ形状を挿入 - Python via .Net" offSpacer="" %}}
