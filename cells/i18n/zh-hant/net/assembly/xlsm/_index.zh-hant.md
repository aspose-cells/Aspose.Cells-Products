...
{{% blocks/products/pf/agp/content h2="如何使用 C# 生成基於 XLSM 的報告" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 組裝 XLSM 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. 實例化 WorkbookDesigner 類1. 在任何工作表的任何單元格中設置標記1. 為 WorkbookDesigner 對象設置數據源1. 調用 WorkbookDesigner.Process 方法用數據填充模板1. 通過 WorkbookDesigner.Worbook.Save 方法以 XLSM 格式保存結果
...
{{% blocks/products/pf/agp/code-block title="生成 XLSM 報告" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/assembly/xlsb/" name="XLSB" description="二進制 Excel 工作簿文件" >}}
