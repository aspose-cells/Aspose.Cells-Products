---
title: Voeg XLS samen met MHT - Combineer XLS met MHT in C#
url: /nl/net/merger/merge-xls-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online samenvoegen XLS naar MHT-opslagformaat. C# Combineer XLS naar MHT-formaat. Samenvoegen XLS naar MHT in C#. XLS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLS samen met MHT in C# Online" %}}

Het volgende voorbeeld laat zien hoe u XLS kunt samenvoegen met MHT in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLS samen te voegen met MHT. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het MHT-bestand. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat XLS samenvoegt met MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om XLS samen te voegen met MHT in C#" InputFormat="xls" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLS samen te voegen met MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLS programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET-bibliotheek om XLS samen te voegen met MHT" %}}
