...
url: /python-net/merger/merge-xlsb-to-ett/ 
...
The following example demonstrates how to merge XLSB to ETT in Aspose.Cells for Python via .NET.
...
Need to merge XLSB to ETT programmatically? A basic document merging and concatenating with [Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs can be done with just few lines of code.
