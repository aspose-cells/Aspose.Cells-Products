...
description: Aspose Excel. Java Maak snel en eenvoudig een JPG-bestand met Aspose.Cells. Genereer een JPG-bestand met Java. Maak een JPG-bestand in Java. Java JPG Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een JPG-bestand in Java" h2="Snelle Java-bibliotheek voor het maken van JPG-bestanden. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe JPG te maken in Java" %}}
...
1.  Sla de werkmap op als JPG-indeling met behulp van de methode save().

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een JPG-bestand maakt in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om JPG-bestand te maken" %}}
{{% blocks/products/pf/agp/text %}}
