...
description: Aspose Эксель. Python Эксель. Объедините HTM с форматом сохранения XLSB. Python Объединить HTM в формат XLSB. Объедините HTM с XLSB в библиотеке Excel Python. HTM-слияние.
...
{{% blocks/products/pf/agp/content h2="Объединить HTM с XLSB с помощью библиотеки Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Объединить HTM с XLSB в библиотеке Excel Python" %}}
...
{{% cells-merger title="Пример кода для объединения HTM с XLSB в библиотеке Excel Python" InputFormat="htm" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Как объединить HTM с XLSB через библиотеку Excel Python" %}}
