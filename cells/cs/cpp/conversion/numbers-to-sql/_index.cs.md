...
{{< blocks/products/pf/i18n/upper-banner h1="Převod ČÍSEL na SQL v C++" h2="Vysoce výkonný převod čísel do SQL pomocí knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Potřebujete programově převést soubory NUMBERS do SQL? Vývojáři na C++ mohou snadno převést soubory NUMBERS do SQL pomocí několika řádků kódu.
...
1.  Převeďte ČÍSLA do SQL voláním metody Save().
