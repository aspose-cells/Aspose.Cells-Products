...
url: /es/python-net/merger/merge-htm-to-xlsb/ 
...
El siguiente ejemplo muestra cómo combinar HTM con XLSB en Aspose.Cells for Python via .NET.
...
¿Necesita fusionar HTM con XLSB mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Las API se pueden hacer con solo unas pocas líneas de código.
