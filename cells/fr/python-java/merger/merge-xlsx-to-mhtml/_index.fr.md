---
title:  Fusionner XLSX à MHTML via Python
url: /fr/python-java/merger/merge-xlsx-to-mhtml/ 
description: Fusionnez XLSX à MHTML en ligne gratuitement. Gratuit en ligne XLSX à MHTML Fusion. Fusionnez XLSX vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner XLSX à MHTML dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner XLSX à MHTML en ligne" InputFormat="xlsx" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
