---
title: PHP XLSB 至 XLTX - XLSB 至 XLTX 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 XLSB 转换为 XLTX。PHP XLSB 转换为 XLTX。PHP 将 XLSB 保存为 XLTX。使用 PHP 将 XLSB 保存为 XLTX。
...
{{% cells-convert title="将 XLSB 转换为 XLTX 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xltx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 PHP 将 XLSB 转换为 XLTX" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSB 文件转换为 XLTX 吗？ PHP 开发人员只需几行代码即可轻松加载 XLSB 并将其转换为 XLTX。
...
1. 使用工作簿实例加载 XLSB 文件。
1. 通过调用Workbook的save方法将XLSB转换为XLTX。
1. 获取XLSB到XLTX的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP库将XLSB转换为XLTX" %}}
