...
以下示例演示如何將 Aspose.Cells for Python via .NET 中的 TXT 合併到 MHTML。
...
需要以編程方式將 TXT 合併到 MHTML 嗎？基本文檔合併和連接[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)只需幾行代碼即可完成 API。
