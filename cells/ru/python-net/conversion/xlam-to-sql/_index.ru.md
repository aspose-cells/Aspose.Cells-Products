...
{{% blocks/products/pf/agp/content h2="Преобразовать XLAM в SQL в Python" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека Python для преобразования XLAM в SQL" %}}
