...
Нужно программно конвертировать XML-файлы в ETT? C++ разработчики могут легко преобразовать XML в ETT, написав всего несколько строк кода.
