...
description: Sample C++ conversion code for XLS to XLTX format. Programmers can use this source code for batch XLS to XLTX conversion within any C++ Application.
---
