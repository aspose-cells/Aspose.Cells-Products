---
title: Převaděč PHP TABDELIMITED na SPREADSHEETML – TABDELIMITED na SPREADSHEETML
description: Aspose Excel. Převeďte TABDELIMITED na SPREADSHEETML rychle a snadno pomocí Aspose.Cells. PHP TABDELIMITED na SPREADSHEETML. PHP Uložit TABDELIMITED do SPREADSHEETML. Uložte TABDELIMITED jako SPREADSHEETML pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na SPREADSHEETML přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory TABDELIMITED na SPREADSHEETML programově? Vývojáři PHP mohou snadno načíst a převést TABDELIMITED na SPREADSHEETML v několika řádcích kódu.
...
1.  Převeďte TABDELIMITED na SPREADSHEETML voláním metody uložení sešitu.
