...
هل تحتاج إلى تحويل ملفات MHT إلى TABDELIMITED برمجيًا؟ يمكن للمطورين (C++) تحويل ملفات MHT إلى TABDELIMITED بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل MHT إلى TABDELIMITED عن طريق استدعاء دالة Save().
