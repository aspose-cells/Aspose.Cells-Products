---
title:  Вставьте кнопку (элемент управления формой) в Excel, используя Python via .Net
weight: 200
...
{{% blocks/products/pf/agp/content h2="Как вставить кнопку (элемент управления формой) в файл Excel с помощью Python via.Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_button/#int-int-int-int-int-int) чтобы вставить кнопку (элемент управления формой) на выбранный лист.
