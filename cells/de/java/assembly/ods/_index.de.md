---
title:  Generieren Sie Berichte in ODS-Dateien via Java
weight: 2440
description: Java Beispielcode zum Erstellen von Berichten im ODS-Format zur Java-Laufzeitumgebung für JSP/JSF-Anwendungen und Desktop-Anwendungen.
...
{{% blocks/products/pf/agp/content h2="So erstellen Sie ODS-Berichte mit Java" %}}

 Um ODS-Dateiberichte zu erstellen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren von ODS-Berichten via Java" %}}
...
1.  Speichern Sie das Ergebnis im Format ODS über die Methode Worbook.save
...
{{% blocks/products/pf/agp/code-block title="Generieren Sie Excel-Berichte im Format ODS – Java" offSpacer="" %}}
