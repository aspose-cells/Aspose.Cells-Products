...
+ Crie o arquivo XLSX.
Obtenha o gráfico.
+ Converta gráfico em imagem JPG/JPEG.
...
{{% blocks/products/pf/agp/code-block title="Converter gráfico de arquivos XLSX em imagem JPG / JPEG - C#" offSpacer="" %}}
