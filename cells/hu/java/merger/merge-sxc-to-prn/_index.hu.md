---
title: A SXC egyesítése PRN-nel - A SXC-es szám egyesítése PRN-vel a Java-ben
url: /hu/java/merger/merge-sxc-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés SXC PRN mentési formátumba. Java Kombinálja a SXC-et PRN formátumba. Egyesítse a SXC-et a PRN-vel a Java-es számon. SXC Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a SXC-es számot a PRN-hez a Java-es online számmal ingyen" %}}

A következő példa bemutatja, hogyan egyesítheti a SXC-et a PRN-vel a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SXC és a PRN egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el PRN fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a SXC-et a PRN-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a SXC és a PRN egyesítéséhez a Java-ben" InputFormat="sxc" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A SXC és a via Java PRN egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SXC-et a PRN-nel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a SXC és a PRN egyesítéséhez" %}}
