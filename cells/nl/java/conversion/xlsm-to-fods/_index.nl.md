...
{{% blocks/products/pf/agp/content h2="Sla XLSM op in FODS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSM omzet naar FODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar FODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSM programmatisch converteren naar FODS? Ontwikkelaars van Java kunnen bestanden met de extensie XLSM eenvoudig converteren naar FODS met slechts een paar regels code.
