...
description: Aspose Excel. Genereer en bewerk HTML-bestanden moeiteloos met de Aspose.Cells for C++ bibliotheek. Deze krachtige API biedt een gestroomlijnde en efficiënte oplossing voor het maken, bewerken en beheren van HTML-bestanden rechtstreeks binnen uw C++ toepassingen, waarmee met hoge precisie aan specifieke ontwikkelaarsbehoeften wordt voldaan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een HTML-bestand aan in C++" h2="Programmatisch aanmaken van native en hoogwaardige HTML-bestanden zonder Microsoft Office met behulp van de C++-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Ontwikkelaars kunnen binnen draaiende rapportageapplicaties eenvoudig HTML-bestanden aanmaken, laden, wijzigen en converteren voor gegevensverwerking, en dat met slechts een paar regels code.
...
1.  Sla het werkblad op als een .htm-bestand met behulp van de Save()-methode.
