---
title: Konversi XLTM ke HTML melalui C++ aplikasi 
url: /id/cpp/conversion/xltm-to-html/ 
description: Contoh C++ kode konversi untuk dokumen XLTM ke format HTML. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLTM ke HTML dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi XLTM ke HTML melalui C++" h2="Konversi XLTM ke HTML berperforma tinggi menggunakan pustaka C++ tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLTM ke HTML hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLTM menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (HTML).1. File HTML akan disimpan di jalur yang ditentukan.1. Buka file HTML di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLTM ke HTML C++ Kode Sumber Konversi" offSpacer="" %}}
