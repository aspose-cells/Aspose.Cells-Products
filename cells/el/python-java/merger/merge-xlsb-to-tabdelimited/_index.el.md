...
url: /el/python-java/merger/merge-xlsb-to-tabdelimited/ 
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLSB στο TABDELIMITED στο Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Θέλετε να συγχωνεύσετε το XLSB στο TABDELIMITED μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
