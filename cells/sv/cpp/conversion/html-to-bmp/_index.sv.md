...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera HTML-fil till BMP på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda HTML-fil med Factory::CreateIWorkbook.1. Välj det första kalkylbladet.1. Ställ in (BMP) alternativ.1. Iterera genom varje sida av arket och rendera.1. Öppna BMP-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="HTML till BMP C++ omvandlingskällkod" offSpacer="" %}}
