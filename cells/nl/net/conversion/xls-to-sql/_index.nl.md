...
description: Aspose Excel. Converteer XLS snel en eenvoudig naar SQL met Aspose.Cells. C# XLS naar SQL. C# Sla XLS op in SQL. Sla XLS op als SQL met behulp van C#.
...
In het volgende voorbeeld ziet u hoe u XLS naar SQL converteert in C#.
