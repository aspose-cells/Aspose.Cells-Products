---
title: MHTML 만들기 - C#에 MHTML 파일 만들기
description: Aspose 엑셀. C# MHTML 파일을 만듭니다. MHTML C#을 만듭니다. C# MHTML 작성자. C#에 MHTML을 생성합니다. C#을 사용하여 MHTML 파일을 생성합니다.
...
{{% blocks/products/pf/agp/content h2="C#에서 MHTML을 만드는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 개발자는 단 몇 줄의 코드로 데이터 처리를 위해 다양한 보고 응용 프로그램을 실행하면서 MHTML 파일을 쉽게 생성, 로드, 수정 및 변환할 수 있습니다.
...
1. 저장 방법을 사용하여 통합 문서를 MHTML 파일로 저장합니다.

{{% blocks/products/pf/agp/code-block title="샘플 코드는 C#에서 MHTML 파일을 생성하는 방법을 보여줍니다." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# 라이브러리는 MHTML 파일을 생성합니다." %}}
