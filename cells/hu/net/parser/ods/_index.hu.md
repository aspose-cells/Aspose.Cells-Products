---
title:  Szöveg és képek kibontása a ODS via .NET számú dokumentumból
weight: 6970
description: C# forráskód a ODS fájlból a .NET Framework, .NET Core, Mono vagy Xamarin Platforms ODS fájlból.
