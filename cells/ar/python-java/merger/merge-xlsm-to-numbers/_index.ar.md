...
url: /ar/python-java/merger/merge-xlsm-to-numbers/ 
...
يوضح المثال التالي كيفية دمج XLSM مع أرقام في Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 هل تحتاج إلى دمج XLSM مع أرقام برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
