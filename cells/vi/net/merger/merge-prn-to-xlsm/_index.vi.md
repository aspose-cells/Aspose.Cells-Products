...
Ví dụ sau minh họa cách hợp nhất PRN thành XLSM trong Aspose.Cells for .NET.
...
Cần hợp nhất PRN thành XLSM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
