...
description: Essayez nos API de fusion de messages sur site pour combiner des documents MHT sur les plateformes .NET Framework, .NET Core et Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats MHT dans C#" h2="Fusion de documents MHT native et haute performance à l\'aide des API Aspose.Cells for .NET côté serveur, sans utiliser de logiciel comme Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner un fichier MHT à l\'aide de C#" %}}
 ...
 Afin de fusionner le fichier MHT, nous utiliserons<a href="https://products.aspose.com/cells/net">Aspose.Cells for .NET</a> API qui est une manipulation et une fusion de documents riche en fonctionnalités, puissante et facile à utiliser API pour la plate-forme C#. Ouvrir<a href="https://www.nuget.org/packages/aspose.cells">NuGet</a> gestionnaire de paquets, recherchez<b>Aspose.Cells</b> et installer. Vous pouvez également utiliser la commande suivante à partir de la console Package Manager.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes de fusion des fichiers MHT dans C#" %}}
...
1. Appelez la méthode Save() et transmettez le nom du fichier (chemin complet) et le format (MHT) en paramètre.
1. Vous pouvez maintenant ouvrir et utiliser le fichier MHT dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de fusion MHT en ligne" sectionDescription=" Fusionnez les documents MHT dès maintenant en visitant notre[Site Web de démonstrations en direct](https://products.aspose.app/cells/merger). La démo en direct présente les avantages suivants" >}}
