---
title: C#을(를) 통해 XLT를 XLSB로 변환
url: /ko/net/conversion/xlt-to-xlsb/
description: xlt에서 xlsb로의 C# 변환을 위한 샘플 코드입니다. VB.NET, Asp.NET 또는 모든 .NET 기반 애플리케이션 내에서 xlt 파일을 xlsb로 일괄 변환하는 API 예제 코드를 사용합니다.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 개발자는 몇 줄의 코드로 XLT 파일을 쉽게 로드하고 XLSB로 변환할 수 있습니다.
...
{{% cells-convert title="XLT를 XLSB로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xlsb" IsLandingPage="true" %}}
