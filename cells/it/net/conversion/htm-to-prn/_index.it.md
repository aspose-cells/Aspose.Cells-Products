---
title: C# HTM a PRN - Convertitore online da HTM a PRN
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Free Online C# Converti HTM in PRN saveformat. C# Formato da HTM a PRN. Salva HTM su PRN C#.
...
{{% blocks/products/pf/agp/content h2="Salva HTM in PRN in C# online gratuitamente" %}}

L'esempio seguente mostra come convertire HTM in PRN in C#.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire HTM in PRN. Carica il tuo file HTM, quindi salvalo semplicemente come file PRN. Sia per la lettura HTM che per la scrittura PRN è possibile utilizzare nomi di file completi. Il contenuto e la formattazione del PRN di output saranno identici al documento HTM originale.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="App gratuita e codice di esempio per convertire HTM in PRN online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Come convertire HTM in PRN tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file HTM in PRN a livello di programmazione? .NET gli sviluppatori possono facilmente caricare e convertire HTM in PRN in poche righe di codice.
...
1.  Converti HTM in PRN chiamando il metodo Workbook.Save.
1.  Ottieni il risultato della conversione di HTM in PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# libreria per convertire HTM in PRN" %}}
