---
title:  Fusionner PRN avec DOCX via Java
...
L'exemple suivant montre comment fusionner PRN avec DOCX dans Java.
...
{{% cells-merger title="Application gratuite pour fusionner PRN au DOCX en ligne" InputFormat="prn" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
