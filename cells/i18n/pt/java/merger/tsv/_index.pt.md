...
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar formatos TSV em Java" h2="Fusão de documentos TSV nativos usando APIs Java do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar arquivos TSV usando Java" %}}
 ...
 Para mesclar o arquivo TSV, usaremos
...
{{% blocks/products/pf/agp/code-block title="Mesclar arquivos TSV - Java" offSpacer="" %}}

```cs
// Abra o primeiro arquivo TSV.
Workbook tsvFile1 = new Workbook("chartsFileWithPath.tsv");

// Defina o segundo livro de origem.
// Abra o segundo arquivo TSV.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos do Microsoft Excel para diferentes formatos. Além disso, ele pode ser usado para gráficos abrangentes, relatórios escaláveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API autônomo e não requer nenhum software como Microsoft ou OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo da fusão de TSV on-line" sectionDescription="Mescle documentos TSV agora mesmo visitando nosso [Site de demonstrações ao vivo](https://products.aspose.app/cells/merger). A demonstração ao vivo tem os seguintes benefícios" >}}
