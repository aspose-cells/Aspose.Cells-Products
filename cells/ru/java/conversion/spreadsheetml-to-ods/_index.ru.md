...
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование SPREADSHETML в ODS через Java" h2="Преобразование SPREADSHEETML в ODS Java для преобразования одной или нескольких страниц в ODS с использованием локальной библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать SPREADSHEETML в ODS с помощью Java" %}}

 Чтобы отобразить SPREADSHETML в ODS, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию SPREADSHETML в ODS через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Java могут легко преобразовать файл SPREADSHEETML в формат ODS, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл SPREADSHEETML с экземпляром класса Workbook1. Вызов метода Workbook.save1. Передайте выходной путь с расширением ODS и SaveFormat в качестве параметров1. Проверить указанный путь для результирующего файла ODS
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования SPREADSHEETML в ODS Java" offSpacer="" %}}

```cs
// загрузить файл SPREADSHEETML в экземпляр Workbook
Workbook book = new Workbook("template.spreadsheetml");
// сохранить SPREADSHETML как ODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Преобразование SPREADSHEETML в ODS в режиме реального времени" sectionDescription="[Конвертировать SPREADSHEETML в ODS](https://products.aspose.app/cells/conversion/spreadsheetml-to-ods) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Нет необходимости загружать Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать какой-либо код." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл SPREADSHEETML, и он будет мгновенно преобразован в формат ODS." >}}
