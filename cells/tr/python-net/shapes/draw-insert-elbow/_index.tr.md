---
title: Python via .Net kullanarak Excel'e dirsek şekli nasıl çizilir veya eklenir?
weight: 10
description: Python via .Net kaynak kodu, Excel'e dirsek şekli eklemek için.
keywords: [Python Aspose.Cells., Python add elbow shape., Python insert elbow shape., Python create elbow shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via .Net\'i kullanarak dirsek şeklini Excel\'e ekleyin" h2="Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan Aspose.Cells\' API\'i kullanarak dirsek şeklini ekleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via .Net Kullanılarak Excel Dosyasına Dirsek Şekli Nasıl Eklenir?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net kullanarak Excel dosyasına dirsek şekli ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Shapecollection'ın eklentisini kullanın[yöntem](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) Seçilen çalışma sayfasına bir dirsek şekli eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Dirsek şekli ekleme - Python via .Net" offSpacer="" %}}
