---
title: Python HTML إلى MHT - محول HTML إلى MHT
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين Python نهجًا متكاملًا تمامًا لتحويل HTML إلى تنسيق MHT، مما يتيح حفظ البيانات بسلاسة بتنسيق MHT باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود Python فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="تحويل HTML إلى MHT في مكتبة Excel الخاصة بـ Python" %}}

كيف يمكنني تحويل HTML إلى MHT؟ باستخدام Aspose.Cells وfor Python عبر مكتبة NET، يمكنك بسهولة تحويل HTML إلى MHT برمجيًا ببضعة أسطر من التعليمات البرمجية.[Aspose.Cells for Python عبر NET](https://pypi.org/project/aspose-cells-python/)قادر على إنشاء تطبيقات مشتركة بين الأنظمة الأساسية مع القدرة على إنشاء جميع ملفات Excel وتعديلها وتحويلها وعرضها وطباعتها. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات، بل يمكنه أيضًا عرض ملفات Excel كصور، وPDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT والمزيد، مما يجعله خيارًا مثاليًا لتبادل المستندات بتنسيقات متوافقة مع معايير الصناعة.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="احفظ HTML في MHT في مكتبة Excel Python" %}}

يوضح المثال التالي كيفية تحويل HTML إلى MHT في مكتبة Excel Python.
...
{{% cells-convert title="نموذج كود لتحويل HTML إلى MHT باستخدام مكتبة Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="mht" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل HTML إلى MHT" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات HTML إلى صيغة MHT برمجيًا؟ يمكن لمطوري Python تحميل وتحويل ملفات HTML إلى صيغة MHT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Excel لتحويل HTML إلى MHT (Python)." %}}
