---
title: Créer SPREADSHEETML - Créer un fichier SPREADSHEETML dans C++
description: Aspose Excel. C++ Créer un fichier SPREADSHEETML. Créer SPREADSHEETML C++. C++ SPREADSHEETML Creator. Créez SPREADSHEETML en C++. Générez le fichier SPREADSHEETML en utilisant C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier SPREADSHEETML dans C++" h2="Création de fichiers SPREADSHEETML natifs et hautes performances par programmation sans Micorsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Créer un fichier SPREADSHEETML à l\'aide de C++" %}}
...
{{% blocks/products/pf/agp/content h2="Comment créer SPREADSHEETML dans C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers SPREADSHEETML dans des applications de création de rapports en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
1.  Enregistrez le classeur en tant que fichier .xml à l'aide de la méthode Save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier SPREADSHEETML dans C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="bibliothèque C++ pour créer un fichier SPREADSHEETML" %}}
