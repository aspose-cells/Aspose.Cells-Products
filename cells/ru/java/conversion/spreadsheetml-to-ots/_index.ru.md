...
{{% blocks/products/pf/agp/content h2="Преобразование электронных таблиц в формат OTS с использованием кода Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните файл SPREADSHEETML в OTS в файле Java." %}}

В следующем примере показано, как преобразовать SPREADSHEETML в OTS в файле Java.
...
Нужно программно преобразовать файлы SPREADSHEETML в формат OTS? Разработчики, использующие код Java, могут легко преобразовать SPREADSHEETML в OTS всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования SPREADSHEETML в OTS" %}}
{{% blocks/products/pf/agp/text %}}
