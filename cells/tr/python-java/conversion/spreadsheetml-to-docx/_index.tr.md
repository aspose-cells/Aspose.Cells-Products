---
title: Python aracılığıyla SPREADSHEETML'yi DOCX'e dönüştürün

description: E-tablo ml'den docx'e Python dönüştürme için örnek kod. Python uygulamasında toplu e-tablo ml dosyalarından docx'e dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python aracılığıyla SPREADSHEETML\'yi DOCX\'e dönüştürün" h2="Python API\'lerini kullanarak Excel® elektronik tablolarını DOCX biçimine aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python Kullanarak SPREADSHEETML\'yi DOCX\'e Dönüştürme" %}}

 SPREADSHEETML'yi DOCX'e dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Python aracılığıyla SPREADSHEETML\'yi DOCX\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Python geliştiricileri, yalnızca birkaç satır kodla SPREADSHEETML dosyalarını kolayca yükleyebilir ve DOCX'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. SPREADSHEETML dosyasını bir Çalışma Kitabı örneğiyle yükleyin1. Workbook.Save yöntemini çağırın1. Parametre olarak DOCX uzantılı çıktı yolunu iletin1. Ortaya çıkan DOCX dosyası için belirtilen yolu kontrol edin
