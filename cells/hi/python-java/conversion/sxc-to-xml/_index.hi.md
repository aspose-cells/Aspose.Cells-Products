---
title: SXC को Python के माध्यम से XML में बदलें

description: sxc से xml Python रूपांतरण के लिए नमूना कोड। Python एप्लिकेशन में बैच sxc फ़ाइलों से xml रूपांतरण के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/content h2="Python का उपयोग करके SXC को XML में कैसे बदलें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="SXC को Python के माध्यम से XML में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Python डेवलपर कोड की कुछ ही पंक्तियों में आसानी से SXC फ़ाइलों को XML में लोड और कनवर्ट कर सकते हैं।
...
{{% cells-convert title="SXC को XML में बदलने के लिए फ्री ऐप और सैंपल कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xml" IsLandingPage="true" language="python" %}}
