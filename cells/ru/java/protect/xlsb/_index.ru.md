---
title:  Защитить и заблокировать XLSB документ via Java
weight: 6590
description: Java пример кода для блокировки файла XLSB с помощью пароля в среде выполнения Java для приложений JSP/JSF и настольных приложений.
...
{{< blocks/products/pf/i18n/upper-banner h1="Зашифровать XLSB Файлы via Java" h2="Защитите паролем электронные таблицы Excel, включая формат XLSB, с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по защите файлов XLSB via Java" %}}
...
1.  Загрузите файл XLSB, создав экземпляр класса Workbook.
1.  Используйте метод protected(..) с ProtectionType и паролем.
1.  Сохраните защищенный файл XLSB методом save().
