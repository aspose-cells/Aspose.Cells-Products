---
title: Convierta XLT a ODS a través de Python

description: Código de muestra para la conversión de xlt a ods Python. Use el código de ejemplo API para la conversión de archivos xlt por lotes a ods dentro de la aplicación Python.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a ODS usando Python" %}}

 Para convertir XLT a ODS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLT a ODS a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden cargar y convertir fácilmente archivos XLT a ODS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLT con una instancia de Workbook1. Llame al método Workbook.Save1. Pase la ruta de salida con la extensión ODS como parámetro1. Compruebe la ruta especificada para el archivo ODS resultante
...
{{% cells-convert title="Aplicación gratuita y código de muestra para convertir XLT a ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="ods" IsLandingPage="true" language="python" %}}
