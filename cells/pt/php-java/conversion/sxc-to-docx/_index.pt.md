---
title: Conversor PHP SXC para DOCX - SXC para DOCX
description: Aspose Excel. Converta SXC em DOCX de forma rápida e fácil com Aspose.Cells. PHP SXC em DOCX. PHP Salve SXC em DOCX. Salve SXC como DOCX usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em DOCX via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em DOCX programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em DOCX em apenas algumas linhas de código.
...
1.  Converta SXC em DOCX chamando o método save da pasta de trabalho.
