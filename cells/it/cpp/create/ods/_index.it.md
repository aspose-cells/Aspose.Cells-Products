...
description: Aspose Excel. C++ Crea il file ODS in modo semplice e veloce con Aspose.Cells. Genera il file ODS utilizzando C++. Crea ODS in C++. C++ ODS Creatore.
...
1.  Salva la cartella di lavoro come file .ods utilizzando il metodo Save().
