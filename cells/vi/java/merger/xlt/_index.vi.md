---
title:  Hợp nhất các tập tin XLT via Java
weight: 9960
description: Java mã mẫu để kết hợp các tài liệu XLT trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng XLT trong Java" h2="Hợp nhất tài liệu gốc XLT bằng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để hợp nhất các tệp XLT trong Java" %}}
...
+ Nạp tệp XLT đầu tiên với một thể hiện của lớp Workbook.
+ Nạp tài liệu XLT thứ hai với một thể hiện của lớp Workbook.
+ Hợp nhất các tệp bằng phương thức kết hợp ().
lưu tệp XLT đã hợp nhất tại đường dẫn đã chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp XLT - Java" offSpacer="" %}}
