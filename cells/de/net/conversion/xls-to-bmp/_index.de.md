---
title: C# XLS bis BMP - XLS bis BMP Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das Format BMP und ermöglicht das nahtlose Speichern von XLS-Daten im Format BMP mithilfe der Aspose.Cells-Bibliothek – alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis BMP in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in C# in BMP umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in BMP" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in BMP konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in BMP laden und konvertieren.
...
1.  Konvertieren Sie XLS in BMP durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in BMP" %}}
