...
description: Aspose Excel。此综合解决方案为 C++ 开发人员提供了一种完全集成的方法，可将 MHTML 转换为 TSV 格式，从而能够使用 Aspose.Cells 库将 MHTML 数据无缝保存为 TSV 格式，所有这些都通过高效且可定制的 C++ 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 MHTML 保存到 TSV，即 C++" %}}

以下示例演示了如何在 C++ 中将 MHTML 转换为 TSV。
...
{{% blocks/products/pf/agp/content h2="如何将 MHTML 通过 C++ 转换为 TSV" %}}

{{% blocks/products/pf/agp/text %}}

需要通过编程方式将 MHTML 文件转换为 TSV 文件吗？C++ 开发人员只需几行代码即可轻松将 MHTML 转换为 TSV。
...
1. 向您的 C++ 项目添加库引用（导入库）。
1. 使用工作簿加载 MHTML 文件。
1. 调用 Save() 方法将 MHTML 转换为 TSV。
1. 得到MHTML至TSV的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="使用 C++ 库将 MHTML 转换为 TSV" %}}
