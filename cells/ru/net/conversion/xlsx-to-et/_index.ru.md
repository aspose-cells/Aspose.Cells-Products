---
title: C# XLSX в ET - онлайн XLSX в ET Конвертер
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Бесплатно онлайн C# Конвертировать XLSX в формат сохранения ET. C# XLSX в формате ET. Сохраните XLSX в ET C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните XLSX в ET в C# Онлайн бесплатно" %}}

В следующем примере показано, как преобразовать XLSX в ET в C#.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XLSX в ET через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы XLSX в ET? Разработчики .NET могут легко загрузить и преобразовать XLSX в ET всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="C# библиотека для преобразования XLSX в ET" %}}
