---
title: SXC 만들기 - C#에 SXC 파일 만들기
description: Aspose 엑셀. C# SXC 파일을 만듭니다. SXC C#을 만듭니다. C# SXC 작성자. C#에 SXC을 생성합니다. C#을 사용하여 SXC 파일을 생성합니다.
keywords: [Aspose Excel., C# Aspose.Cells., Create SXC C#., C# SXC Creater., Create SXC file in C#., Generate SXC file in C#]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#에 SXC 파일 생성" h2="SXC 생성을 위한 고속 C# 라이브러리. 이것은 XLSX, PDF 및 .NET 프레임워크, .NET 코어 또는 Mono 플랫폼에서 기타 여러 형식을 가져오고 내보내는 전문 소프트웨어 솔루션입니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 개발자는 단 몇 줄의 코드로 데이터 처리를 위해 다양한 보고 응용 프로그램을 실행하면서 SXC 파일을 쉽게 생성, 로드, 수정 및 변환할 수 있습니다.
...
1. 저장 방법을 사용하여 통합 문서를 SXC 파일로 저장합니다.
...
{{% blocks/products/pf/agp/content h2="C# 라이브러리는 SXC 파일을 생성합니다." %}}
