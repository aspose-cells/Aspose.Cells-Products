---
title: ODS'i ETT ile birleştir - ODS'i Java'de ETT ile birleştir
url: /tr/java/merger/merge-ods-to-ett/ 
description: Aspose excel. Java Aspose.Cells. ODS'i ETT saveformat'a Ücretsiz Çevrimiçi Birleştirme. Java ODS'i ETT formatına birleştirin. ODS'i Java'de ETT ile birleştirin. ODS Birleştirin.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java Online\'da ETT ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de ETT ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS'i ETT ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından ETT dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. ODS'i ETT ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="ODS\'i Java\'de ETT ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="ods" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="ODS ile ETT via Java nasıl birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

ODS'i programlı olarak ETT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i ETT ile birleştirmek için Java kitaplığı" %}}
