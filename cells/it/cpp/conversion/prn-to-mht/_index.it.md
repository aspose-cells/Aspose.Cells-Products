...
Hai bisogno di convertire i file PRN in MHT tramite codice? Gli sviluppatori di C++ possono convertire facilmente i file PRN in MHT in poche righe di codice.
...
1.  Convertire PRN in MHT chiamando il metodo Save().
