---
title: Fusionner PRN à MD - Combiner PRN à MD dans C#
url: /fr/net/merger/merge-prn-to-md/ 
description: Aspose Excel. C# Aspose.Cells. Fusion gratuite en ligne PRN au format de sauvegarde MD. C# Combine le format PRN au format MD. Fusionner PRN à MD en C#. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à MD en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN à MD dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN à MD. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier MD. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne PRN à MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner PRN à MD en C#" InputFormat="prn" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner PRN à MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner PRN à MD par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner PRN à MD" %}}
