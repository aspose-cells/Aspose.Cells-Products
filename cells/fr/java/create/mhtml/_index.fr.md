...
url: /fr/java/create-mhtml/ 
description: Java Exemple de code pour générer des documents MHTML. Utilisez ce code pour créer des fichiers MHTML dans une application Web ou de bureau basée sur Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer des documents MHTML via Java" h2="Création MHTML native et hautes performances par programmation à l\'aide de la bibliothèque Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 La génération dynamique de fichiers MHTML dans l'application en cours d'exécution est facile. Afin de créer des documents MHTML à partir de zéro sans nécessiter MS Office, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Comment créer du MHTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir MHTML dans l'exécution de différentes applications de reporting pour le traitement des données en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Créer une instance de [Classe de classeur](https://reference.aspose.com/cells/java/com.aspose.cells/Workbook).1. Accédez à la feuille de calcul appropriée à l'aide de la méthode getWorksheets.get().1. Sélectionnez la cellule appropriée, entrez la valeur dans la cellule souhaitée en utilisant le nom de la cellule, comme A1, B3, etc.1. Enregistrez le classeur au format MHTML à l'aide de la méthode save().
...
// Enregistrez le classeur en tant que fichier MHTML
