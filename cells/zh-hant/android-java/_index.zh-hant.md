...
<p>
 Aspose.Cells for Android via Java 是一個可擴展的 API，以編程方式生成、組合、修改和解析電子表格。 API 提供許多功能，包括 excel 文檔格式和頁面設置任務、導入和導出功能、將工作表頁面渲染為光柵圖像以及指定圖像分辨率、質量、壓縮、添加不同的圖表等等。 Android 電子表格 API 支持 XLS、XLSX、CSV、SpreadsheetML、ODS、製表符分隔、HTML、PDF、XPS 等格式。
</p>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="通過 Java 用於 Android 的 Aspose.Cells 適用於 Android 2.0 或更高版本。" >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Android 電子表格API支持流行的 Microsoft Excel 格式、圖像和固定佈局格式。" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     從 ArrayList、Array、Recordset &amp; 中導出和導入數據結果集
    </p>
   </div>
   <div class="col-lg-4">
...
-->
   ...
   <div class="col-lg-12">
    ...
    <p>
     Android Excel 庫提供將電子表格轉換為 XPS、PDF 和保持最高視覺保真度的 HTML 格式。可靠的轉換過程使 API 成為公司交換行業標準格式文件的完美選擇。
    </p>
...
<p>Aspose.Cells for Android via Java gives you complete freedom and flexibility to furnish your spreadsheets with all kinds of visual effects. The API allows you to apply different fonts with attributes, cell styles (alignment, indentation, rotation, borders, shading and coloring, protection, text wrapping and shrinking) and all types of number formats. Similarly, charts and graphics are visually appealing and can give your spreadsheet a professional look. Aspose.Cells for Android via Java provides a comprehensive set of APIs for creating and manipulating all of the standard and custom chart types. Moreover, you may add different types of drawing objects, such as comments, pictures, OLE objects, shapes and controls to the cells.</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells for Android 通過 Java 提供了一些獨特的功能，例如工作表到圖像、圖表到圖像和PDF 和電子表格到 PDF 文檔格式的轉換。靈活的過程具有多種轉換選擇，例如在電子表格到 PDF 期間重新採樣圖像或在渲染工作表時設置生成的圖像尺寸和圖表到圖像格式。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Android 表格 API 提供了一個強大的公式計算引擎，支持高級和標準的 Microsoft Excel 函數和公式。公式計算引擎可以輕鬆讀取、設置和計算內置或外接類型、數組和 R1C1 引用樣式公式的結果。
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼通過 Java 為 Android 提供 Aspose.Cells？" tabId="success-stories" >}}
