---
title:  Zoek naar document XLSB zonder het te openen via C++
weight: 7020
description: C++ voorbeeldcode om woorden met een patroon te zoeken in het bestand XLSB in de runtimeomgeving C++ voor 32-bits, 64-bits en 64-bits Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zoek naar formaten met XLSB in C++" h2="Native en krachtige documentzoekfunctie (XLSB) met behulp van server-side API\'s (Aspose.Cells for C++), zonder gebruik te maken van software zoals (Microsoft) of Adobe (PDF)." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe zoek ik naar bestand XLSB met behulp van C++?" %}}

 Om het bestand XLSB te zoeken, gebruiken we...
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om bestanden met nummer XLSB te zoeken in de map C++" %}}
...
+ Laad bestand XLSB met behulp van de Workbook-klasse.
...
{{% blocks/products/pf/agp/code-block title="Zoek naar bestanden met nummer XLSB - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSB Zoek live demo\'s" sectionDescription=" Zoek nu naar tekst, woorden en zinsdelen in documenten met referentienummer XLSB door onze website te bezoeken.[Live demo-website](https://products.aspose.app/cells/search). De live demo heeft de volgende voordelen" >}}
