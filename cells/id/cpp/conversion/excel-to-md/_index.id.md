...
{{% cells-convert title="Contoh Kode untuk Mengonversi EXCEL ke MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="md" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert EXCEL ke MD lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke MD secara terprogram? Pengembang C++ dapat dengan mudah mengonversi EXCEL ke MD hanya dalam beberapa baris kode.
...
1.  Konversikan EXCEL ke MD dengan memanggil metode Save().
