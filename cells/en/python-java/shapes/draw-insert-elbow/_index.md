...
{{% blocks/products/pf/agp/content h2="How to Insert elbow shape into Excel File Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert elbow shape to Excel file using Python via Java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) to insert an elbow shape in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert elbow shape - Python via Java" offSpacer="" %}}
