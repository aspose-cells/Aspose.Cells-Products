---
title: "SPREADSHEETML konvertálása CSV-vé a következőn keresztül: Java "
url: /hu/java/conversion/spreadsheetml-to-csv/ 
description: Minta Java konverziós kód a SPREADSHEETML formátumhoz CSV-fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására CSV-fájlba bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML konvertálása CSV-vé a következőn keresztül: Java" h2="SPREADSHEETML-ből CSV-vé Java konverzió egyetlen vagy több oldal konvertálásához CSV-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML konvertálása CSV-vé a következővel: Java" %}}

 A SPREADSHEETML CSV formátumban való megjelenítéséhez a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="A SPREADSHEETML konvertálása CSV-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a SPREADSHEETML-fájlt CSV-fájlba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a SPREADSHEETML-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat CSV kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott CSV-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML-ből CSV-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a SPREADSHEETML fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.spreadsheetml");
// SPREADSHEETML mentése CSV-ként
