---
title: मैं Python via .नेट का उपयोग करके एक्सेल में डबल स्ट्रेट एरो कैसे बनाऊं या डालूं
weight: 10
description: Python via .एक्सेल में डबल स्ट्रेट एरो खींचने या डालने के लिए नेट सोर्स कोड।
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via .नेट का उपयोग करके एक्सेल में दोहरा सीधा तीर डालें" h2="Microsoft या ओपन ऑफिस, एडोब PDF आदि जैसे किसी सॉफ्टवेयर के बिना Aspose.Cells\' API का उपयोग करके डबल सीधा तीर डालें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via .नेट का उपयोग करके एक्सेल फ़ाइल में डबल स्ट्रेट एरो कैसे डालें" %}}

एक्सेल फ़ाइल में डबल स्ट्रेट एरो डालने के लिए, हम इसका उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .नेट का उपयोग करके एक्सेल फ़ाइल में डबल स्ट्रेट एरो डालने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से वर्कशीट का चयन करें।
 + शेपकलेक्शन के ऐड का उपयोग करें[तरीका](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) चयनित वर्कशीट में दोहरा सीधा तीर डालने के लिए।
...
{{% blocks/products/pf/agp/code-block title="दोहरा सीधा तीर डालें - Python via .नेट" offSpacer="" %}}
