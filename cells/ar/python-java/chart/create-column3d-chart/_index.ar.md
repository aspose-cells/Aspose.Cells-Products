---
title: إنشاء مخططات عمودية ثلاثية الأبعاد عبر Python
description: Python نموذج التعليمات البرمجية لإنشاء مخططات Column3D لبرنامج Excel باستخدام مكتبة Python. استخدم هذا الرمز لإنشاء مخطط Column3D لبرنامج MS Excel ضمن التطبيق المستند إلى Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء مخططات عمودية ثلاثية الأبعاد عبر Python" h2="إنشاء مخططات MS Excel الأصلية وعالية الأداء برمجيًا باستخدام واجهات برمجة التطبيقات Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
من السهل على المطورين إنشاء مخطط Column3D أثناء تشغيل تطبيقات التقارير المختلفة لمعالجة البيانات في بضعة أسطر فقط من التعليمات البرمجية.
...
1. إضافة مخطط Column3D إلى ورقة العمل
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="يوضح الكود المصدري التالي كيفية إنشاء مخطط Column3D لملف MS Excel XLSX باستخدام Python." offSpacer="" %}}
