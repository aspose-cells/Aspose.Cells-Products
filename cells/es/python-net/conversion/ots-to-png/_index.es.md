...
description: Aspose Excel. Convierta OTS a PNG rápida y fácilmente con Aspose.Cells. Python OTS a PNG. Python Guarde OTS en PNG. Guarde OTS como PNG usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar OTS al PNG en Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a PNG en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir OTS a PNG" %}}
