...
{{< blocks/products/pf/i18n/upper-banner h1="Analyzovat formáty XLS v C++" h2="Nativní a vysoce výkonná analýza dokumentů XLS pomocí rozhraní API Aspose.Cells na straně serveru pro C++ bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/code-block title="Analyzovat soubory XLS – C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online ukázky XLS Parser Live Demo" sectionDescription="Extrahujte text a obrázky z dokumentů XLS právě teď na našem webu [Web živé ukázky](https://products.aspose.app/cells/parser). Živé demo má následující výhody" >}}
