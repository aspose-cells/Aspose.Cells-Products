...
description: Aspose Excel. C++ Tạo file TXT nhanh chóng và dễ dàng với Aspose.Cells. Tạo file TXT bằng C++. Tạo TXT trong C++. C++ TXT Creator.
...
1.  Lưu sổ làm việc dưới dạng tệp .txt bằng phương thức Save().
