...
description: Aspose Excel. Convert PRN to FODS quickly and easily with Aspose.Cells. C++ PRN to FODS. C++ Save PRN to FODS. Save PRN as FODS using C++.
...
{{% blocks/products/pf/agp/content h2="Save PRN to FODS in C++" %}}
...
{{% cells-convert title="Sample Code to Convert PRN to FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="fods" IsLandingPage="true" language="cpp" %}}
