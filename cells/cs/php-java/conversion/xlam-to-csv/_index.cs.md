---
title: Konvertor PHP XLAM až CSV - XLAM až CSV
description: Aspose Excel. Převeďte XLAM na CSV rychle a snadno pomocí Aspose.Cells. PHP XLAM na CSV. PHP Uložte XLAM na CSV. Uložte CSV jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="csv" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na CSV přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na CSV programově? Vývojáři PHP mohou snadno načíst a převést XLAM na CSV v několika řádcích kódu.
...
1.  Převeďte XLAM na CSV voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na CSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na CSV" %}}
