...
description: Aspose Excel. Chuyển đổi FODS sang SPREADSHEETML nhanh chóng và dễ dàng với Aspose.Cells. Python FODS sang SPREADSHEETML. Python Lưu FODS vào BẢNG TÍNH. Lưu FODS dưới dạng SPREADSHEETML bằng cách sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Lưu FODS vào SPREADSHEETML trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi FODS thành SPREADSHEETML trong Python via NET.
...
{{% cells-convert title="Mã mẫu để chuyển đổi FODS sang SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xml" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python để chuyển đổi FODS sang SPREADSHEETML" %}}
