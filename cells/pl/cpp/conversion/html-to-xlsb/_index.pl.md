---
title: Konwertuj HTML na XLSB za pomocą aplikacji C++ 
weight: 4050
url: /pl/cpp/conversion/html-to-xlsb/ 
description: Przykładowy kod konwersji C++ dla dokumentu HTML do formatu XLSB. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji HTML do XLSB w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik HTML na XLSB w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik HTML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSB).1. Plik XLSB zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSB w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji HTML do XLSB C++" offSpacer="" %}}
