---
title:  Połącz pliki XLTM via .NET
weight: 9010
description: Kod źródłowy C# do łączenia dokumentów XLTM na platformach .NET Framework, .NET Core, Mono lub platformach Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Scal formaty XLTM w C#" h2="Natywne i wydajne łączenie dokumentów XLTM przy użyciu interfejsów API Aspose.Cells for .NET po stronie serwera, bez użycia oprogramowania takiego jak Microsoft lub Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
+ Wywołaj metodę Save() i podaj nazwę pliku (pełna ścieżka) i format (XLTM) jako parametr.
