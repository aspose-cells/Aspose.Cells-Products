...
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 解鎖 XLS 文件" h2="使用 C++ 庫從 Excel 電子表格（包括 XLS 文件）中刪除保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 刪除對 XLS 文件的保護" %}}
...
1. 使用 CreateIWorkbook 加載 XLS 鎖定文件。1. 調用 Unprotect() 函數解鎖。1. 使用 SetPassword 將密碼設置為 NULL。1. 將 XLS 文件保存在指定位置。
