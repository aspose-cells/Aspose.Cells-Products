---
title:  ODS을 XLSM로 병합 via Java
url: /ko/java/merger/merge-ods-to-xlsm/ 
description: ODS을 XLSM 온라인으로 무료로 병합합니다. 무료 온라인 ODS to XLSM 합병. ODS을 Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS 등에 병합합니다.
---
...
다음 예는 ODS을 Java에서 XLSM로 병합하는 방법을 보여줍니다.
...
{{% cells-merger title="온라인에서 ODS을 XLSM로 병합하는 무료 앱" InputFormat="ods" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
