...
Besoin de convertir les fichiers XLS en DOCX par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en DOCX en quelques lignes de code seulement.
...
1.  Convertissez XLS en DOCX en appelant la méthode Workbook.Save.
