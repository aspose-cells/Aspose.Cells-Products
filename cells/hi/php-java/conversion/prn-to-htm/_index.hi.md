---
title: PHP PRN से HTM - PRN से HTM कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ पीआरएन को एचटीएम में जल्दी और आसानी से बदलें। पीएचपी पीआरएन को एचटीएम में बदलें। PHP PRN को HTM में सेव करें। PHP का उपयोग करके PRN को HTM के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="PHP के माध्यम से PRN को HTM में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

क्या आपको PRN फ़ाइलों को प्रोग्रामेटिक रूप से HTM में कनवर्ट करने की आवश्यकता है? PHP डेवलपर्स कोड की कुछ पंक्तियों में आसानी से PRN को HTM में लोड और परिवर्तित कर सकते हैं।
...
1.  वर्कबुक की सेव विधि को कॉल करके पीआरएन को एचटीएम में बदलें।
