---
title: Extraiga texto e imágenes del documento XLS a través de Java 
weight: 3700
url: /es/java/parser/xls/ 
description: Java código de ejemplo para extraer texto e imágenes del archivo XLS en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Analizar formatos XLS en Java" h2="Análisis de documentos XLS nativos y de alto rendimiento mediante API Aspose.Cells for Java del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo analizar un archivo XLS usando Java" %}}
...
+ Cargue el documento XLS usando la clase Workbook.
