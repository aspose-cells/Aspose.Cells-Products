---
title: C# XLSX para MHT - XLSX para Conversor MHT
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato MHT, permitindo o salvamento perfeito de dados XLSX no formato MHT usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX para MHT em C#" %}}

O exemplo a seguir demonstra como converter XLSX para MHT em C#.
...
{{% cells-convert title="Código de exemplo para converter XLSX em MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para MHT através de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para MHT programaticamente? Os desenvolvedores de .NET podem facilmente carregar e converter arquivos XLSX para MHT com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em MHT" %}}
