...
{{% blocks/products/pf/agp/content h2="Python Excel ライブラリを使用して XLTM を JSON に変換する" %}}
...
{{% blocks/products/pf/agp/content h2="XLTM から JSON を Python Excel ライブラリに保存します" %}}

次の例は、Python Excel ライブラリで XLTM を JSON に変換する方法を示しています。
...
{{% blocks/products/pf/agp/content h2="Python 経由で XLTM を JSON に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで XLTM ファイルを JSON に変換する必要がありますか? Python 開発者は、わずか数行のコードで XLTM を簡単にロードして JSON に変換できます。
