---
title: C# XLTX tot SXC - XLTX tot SXC Converter
description: Aspose Excel. Deze uitgebreide oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van gegevens van het formaat XLTX naar SXC, waardoor naadloos opslaan van gegevens in het formaat XLTX mogelijk is met behulp van de bibliotheek Aspose.Cells, allemaal via efficiënte en aanpasbare code C#.
...
{{% blocks/products/pf/agp/content h2="Sla XLTX op in SXC in C#" %}}

Het volgende voorbeeld laat zien hoe je XLTX omzet naar SXC in C#.
...
{{% blocks/products/pf/agp/content h2="Hoe u XLTX naar SXC kunt converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLTX-bestanden programmatisch naar SXC converteren? .NET-ontwikkelaars kunnen XLTX eenvoudig in slechts een paar regels code laden en converteren naar SXC.
...
1.  Converteer XLTX naar SXC door de Workbook.Save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van XLTX naar SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliotheek om XLTX naar SXC te converteren" %}}
