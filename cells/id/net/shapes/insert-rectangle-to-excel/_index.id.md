...
weight: 240
description: C# Contoh kode untuk menambah atau menyisipkan Rectangle ke Excel menggunakan Library .NET. Gunakan kode ini untuk membuat Rectangle di MS Excel dalam VB.NET, Asp.NET atau aplikasi berbasis .NET.
keywords: [C# Aspose.Cells., c# add Rectangle., c# insert Rectangle., c# create Rectangle]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan persegi panjang ke dalam Excel via .NET" h2="Masukkan persegi panjang menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[tambahkan metode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addrectangle) untuk menyisipkan persegi panjang di lembar kerja yang dipilih
