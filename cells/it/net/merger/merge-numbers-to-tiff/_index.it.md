---
title: Unisci i NUMERI a TIFF - Combina i NUMERI a TIFF in C#
url: /it/net/merger/merge-numbers-to-tiff/ 
description: Aspose Excel. C# Aspose.Cells. Unisci i NUMERI al formato di salvataggio TIFF. C# Combina i NUMERI nel formato TIFF. Unisci i NUMERI a TIFF in C#. NUMERI Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci i NUMERI a TIFF in C#" %}}

L'esempio seguente mostra come unire NUMBERS in TIFF in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire i NUMERI a TIFF. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file TIFF. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedi l'esempio C# che unisce i NUMERI a TIFF.
...
{{% blocks/products/pf/agp/content h2="Come unire i NUMERI a TIFF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 È necessario unire i NUMERI a TIFF a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria .NET per unire i NUMERI allo TIFF" %}}
