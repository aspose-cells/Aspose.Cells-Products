...
description: Aspose Excel. A XLTX gyors és egyszerű konvertálása PRN-re a Aspose.Cells-es számmal. C++ XLTX PRN-re. C++ Mentse a XLTX-et a PRN-be. Mentse el a XLTX számot PRN-ként a C++ használatával.
...
{{% blocks/products/pf/agp/content h2="Konvertálja a XLTX-et PRN-re a C++ használatával" %}}
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTX számot a PRN számára a C++ számon" %}}

A következő példa bemutatja, hogyan lehet a XLTX-et PRN-re konvertálni a C++-ben.
...
A XLTX fájlokat programozottan PRN-re kell konvertálni? A C++ fejlesztők könnyedén konvertálhatják a XLTX-et PRN-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a XLTX-et PRN-re a Save() metódus meghívásával.
