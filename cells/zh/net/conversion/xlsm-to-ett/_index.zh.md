---
title: C# XLSM 转 ETT - 在线 XLSM 转 ETT 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 XLSM 转换为 ETT 保存格式。 C# XLSM 为 ETT 格式。将 XLSM 保存至 ETT C#。
...
{{% blocks/products/pf/agp/content h2="免费在线保存 XLSM 至 ETT C#" %}}
...
{{% cells-convert title="将 XLSM 在线转换为 ETT 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="ett" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLSM 转换为 ETT" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 文件转换为 ETT？ .NET 开发人员只需几行代码即可轻松加载 XLSM 并将其转换为 ETT。
