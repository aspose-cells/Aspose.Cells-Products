---
title:  Insérer un ovale dans Excel via Java
weight: 40
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer Oval dans le fichier Excel via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addOval-int-int-int-int-int-int-) pour insérer un ovale dans la feuille de calcul sélectionnée
