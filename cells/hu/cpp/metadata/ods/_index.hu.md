...
{{< blocks/products/pf/i18n/upper-banner h1="ODS-metaadatok kinyerése a következőn keresztül: C++" h2="Készítse el saját C++-alkalmazásait, amellyel metaadatokat adhat hozzá, szerkeszthet, távolíthat el vagy bonthat ki ODS-fájlokból szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="ODS-metaadatok beszerzése a következővel: C++" %}}
...
+ ODS-fájl betöltése a CreateIWorkbookMetadata segítségével
