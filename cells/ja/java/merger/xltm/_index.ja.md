...
{{% blocks/products/pf/agp/content h2="Javaを使用してXLTMファイルをマージする方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaでXLTMファイルをマージする手順" %}}
...
+Workbookクラスのインスタンスを含む最初のXLTMファイルをロードします。
+Workbookクラスのインスタンスを含む2番目のXLTMドキュメントをロードします。
+ Combine（）メソッドを使用してファイルをマージします。
+マージされたXLTMファイルを指定されたパスに保存します
...
{{% blocks/products/pf/agp/code-block title="XLTMファイルをマージする-Java" offSpacer="" %}}
