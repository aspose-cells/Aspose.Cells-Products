...
description: Aspose Excel. Python Excel. Converta HTM em ODS de forma rápida e fácil com Aspose.Cells. Python HTM em ODS. Python Salve HTM em ODS. Salve HTM como ODS usando Python Excel Library.
...
{{% cells-convert title="Exemplo de código para converter HTM em ODS por meio da biblioteca Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="ods" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca Excel para converter HTM em ODS" %}}
