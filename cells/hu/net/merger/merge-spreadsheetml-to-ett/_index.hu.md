...
url: /hu/net/merger/merge-spreadsheetml-to-ett/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a SPREADSHEETML-t az ETT-vel a Aspose.Cells for .NET számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a SPREADSHEETML-t az ETT-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a SPREADSHEETML és az ETT egyesítéséhez" %}}
