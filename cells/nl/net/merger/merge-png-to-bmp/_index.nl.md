---
title: Voeg PNG samen met BMP - Combineer PNG met BMP in C#
url: /nl/net/merger/merge-png-to-bmp/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen PNG naar BMP saveformat. C# Combineer het formaat PNG tot BMP. Samenvoegen PNG tot BMP in C#. PNG Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg PNG samen met BMP in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u PNG samenvoegt met BMP in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PNG samen te voegen met BMP. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand BMP. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat PNG samenvoegt met BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om PNG samen te voegen tot BMP in C#" InputFormat="png" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe PNG samen te voegen met BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PNG programmatisch samenvoegen tot BMP? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen tot BMP" %}}
