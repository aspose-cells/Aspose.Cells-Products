---
title: Voeg TSV samen met SXC - Combineer TSV met SXC in Java
url: /nl/java/merger/merge-tsv-to-sxc/ 
description: Aspose Excel. Java Aspose.Cells. Voeg TSV samen met het opslagformaat SXC. Java Combineer het formaat TSV met SXC. Voeg TSV samen met SXC in Java. TSV Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u TSV samenvoegt met SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TSV programmatisch samenvoegen met SXC? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om TSV samen te voegen met SXC" %}}
