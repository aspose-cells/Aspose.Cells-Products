---
title: รวมตัวเลขเข้ากับ ETT - รวมตัวเลขเข้ากับ ETT ใน C#
url: /th/net/merger/merge-numbers-to-ett/ 
description: Aspose เอ็กเซล. C# Aspose.Cells รวมตัวเลขเข้ากับรูปแบบการบันทึกของ ETT C# รวม NUMBERS เป็นรูปแบบ ETT รวม NUMBERS เข้ากับ ETT ใน C# ผสาน NUMBERS
...
{{% blocks/products/pf/agp/content h2="รวม NUMBERS เข้ากับ ETT ใน C#" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน NUMBERS เข้ากับ ETT ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม NUMBERS เข้ากับ ETT อัปโหลดไฟล์ของคุณ เรียกวิธี Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ ETT หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่รวม NUMBERS เข้ากับ ETT

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="โค้ดตัวอย่างเพื่อรวม NUMBERS เข้ากับ ETT ใน C#" InputFormat="numbers" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวมตัวเลขเข้ากับ ETT ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม NUMBERS เข้ากับ ETT โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ห้องสมุดเพื่อรวม NUMBERS เข้ากับ ETT" %}}
