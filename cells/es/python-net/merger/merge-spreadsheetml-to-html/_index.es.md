---
title:  Combine SPREADSHEETML con HTML a través de Python
url: /es/python-net/merger/merge-spreadsheetml-to-html/ 
description: Combine SPREADSHEETML con HTML en línea de forma gratuita. HOJA DE CÁLCULO en línea gratis al HTML Fusión. Combine SPREADSHEETML con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo fusionar SPREADSHEETML a HTML en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar SPREADSHEETML a HTML en línea" InputFormat="xml" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
