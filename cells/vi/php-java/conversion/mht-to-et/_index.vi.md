---
title: PHP MHT sang ET - Chuyển đổi MHT sang ET
description: Aspose Excel. Chuyển đổi MHT sang ET nhanh chóng và dễ dàng với Aspose.Cells. PHP MHT sang ET. PHP Lưu MHT vào ET. Lưu MHT dưới dạng ET bằng PHP.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi MHT sang ET qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin MHT sang ET theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi MHT sang ET chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi MHT sang ET bằng cách gọi phương thức lưu của Workbook.
