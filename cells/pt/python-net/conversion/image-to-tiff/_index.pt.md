---
title: Python IMAGEM para TIFF - Conversor IMAGEM para TIFF
description: Aspose Excel. Python Excel. Converta IMAGEM em TIFF de forma rápida e fácil com Aspose.Cells. Python IMAGEM em TIFF. Python Salve IMAGEM em TIFF. Salve IMAGEM como TIFF usando a Biblioteca Excel Python.
...
{{% cells-convert title="Exemplo de código para converter IMAGEM em TIFF por meio da biblioteca Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="tiff" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como converter IMAGEM para TIFF" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos IMAGE para TIFF programaticamente? Os desenvolvedores Python podem facilmente carregar e converter IMAGE em TIFF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca Excel para converter IMAGEM em TIFF" %}}
