---
title:  แทรก TextBox ลงใน Excel ผ่าน Python
weight: 10
description: ซอร์สโค้ด Python เพื่อแทรก TextBox ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก TextBox ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก TextBox เข้าไฟล์ Excel ผ่าน Python" %}}
...
+ ใช้วิธีการเพิ่มของ shapecollection เพื่อแทรก TextBox ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกกล่องข้อความ - Python" offSpacer="" %}}
