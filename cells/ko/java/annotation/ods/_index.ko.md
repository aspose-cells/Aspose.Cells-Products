---
title:  ODS 주석 via Java 추가 또는 제거
weight: 8840
description: Java JSP/JSF 애플리케이션 및 데스크탑 애플리케이션용 Java 런타임 환경에서 ODS 형식 주석을 삭제하는 샘플 코드입니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="ODS via Java에서 주석 추가 또는 삭제" h2="서버 측 API를 사용하여 문서 파일의 댓글 및 작성자를 조작할 수 있는 자신만의 Java 앱을 구축하세요." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 ODS 파일에 주석을 추가하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODS via Java에서 주석을 추가하거나 삭제하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="ODS - Java에서 주석 삭제" offSpacer="" %}}
