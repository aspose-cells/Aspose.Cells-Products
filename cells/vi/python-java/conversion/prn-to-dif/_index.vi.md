...
description: Aspose Excel. Chuyển đổi PRN sang DIF nhanh chóng và dễ dàng với Aspose.Cells. Python PRN sang DIF. Python Lưu PRN thành DIF. Lưu PRN là DIF sử dụng Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi PRN sang DIF trong Python" h2="Thư viện Python tốc độ cao chuyển đổi PRN sang DIF. Đây là giải pháp phần mềm chuyên nghiệp xuất nhập PRN, DIF và nhiều định dạng khác sử dụng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi PRN thành DIF Sử dụng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu PRN về DIF trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi PRN thành DIF trong Python.
...
{{% cells-convert title="Mã mẫu chuyển PRN thành DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="dif" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển PRN thành DIF" %}}
