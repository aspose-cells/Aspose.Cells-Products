---
title: C++ EXCEL ke JPEG - Konverter EXCEL ke JPEG
description: Aspose Unggul. Konversikan EXCEL ke JPEG dengan cepat dan mudah dengan Aspose.Cells. C++ EXCEL ke JPEG. C++ Simpan EXCEL ke JPEG. Simpan EXCEL sebagai JPEG menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Simpan EXCEL ke JPEG di C++" %}}

Contoh berikut menunjukkan cara mengonversi EXCEL ke JPEG di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi EXCEL menjadi JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi EXCEL ke JPEG melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke JPEG secara terprogram? Pengembang C++ dapat dengan mudah mengonversi EXCEL menjadi JPEG hanya dalam beberapa baris kode.
...
1.  Konversikan EXCEL ke JPEG dengan memanggil metode Save().
1.  Dapatkan hasil konversi EXCEL menjadi JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah EXCEL menjadi JPEG" %}}
