---
title:  سبليت ODS ملفات via .NET
weight: 140
description: كود المصدر C# لتقسيم ODS مستندًا على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تقسيم الملفات ODS في C#" %}}
...
+ قم بتحميل الملف ODS بالمسار الكامل للتقسيم.
+ كرر من خلال كل ورقة
+ إنشاء كائن فئة مصنف جديد
 ...
 استدعاء الأسلوب Save () وتمرير اسم الملف (المسار الكامل) وSaveFormat.Ods كمعلمة.
