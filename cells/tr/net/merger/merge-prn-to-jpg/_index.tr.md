...
url: /tr/net/merger/merge-prn-to-jpg/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin JPG ile nasıl birleştirileceğini gösterir.
...
Programlı olarak PRN'yi JPG ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi JPG ile birleştirmek için .NET kitaplığı" %}}
