...
description: Aspose اكسل. قم بتحويل XLTM إلى PRN بسرعة وسهولة باستخدام Aspose.Cells. Java XLTM إلى PRN. Java احفظ XLTM في PRN. احفظ XLTM كـ PRN باستخدام Java.
...
{{% blocks/products/pf/agp/content h2="تحويل XLTM إلى PRN باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ XLTM إلى PRN في Java" %}}
...
هل تحتاج إلى تحويل ملفات XLTM إلى PRN برمجياً؟ يمكن لمطوري Java تحويل XLTM بسهولة إلى PRN في بضعة أسطر من التعليمات البرمجية.
