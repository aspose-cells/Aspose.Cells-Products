...
weight: 4860
description: Exemple de code C++ pour verrouiller le fichier XLSB à l'aide du mot de passe sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
...
1.  Charger le fichier XLSB à l'aide de la classe IWorkbook
