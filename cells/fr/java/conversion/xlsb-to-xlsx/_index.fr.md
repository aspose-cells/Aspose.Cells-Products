---
title: Java XLSB à XLSX - Convertisseur en ligne XLSB à XLSX
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XLSB en format de sauvegarde XLSX. Format Java XLSB à XLSX. Enregistrez XLSB à XLSX Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à XLSX dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en XLSX en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLSB en XLSX. Téléchargez votre fichier XLSB, puis enregistrez-le simplement en tant que fichier XLSX. Pour la lecture XLSB et l'écriture XLSX, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie XLSX seront identiques au document XLSB d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en XLSX en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en XLSX par programmation ? Les développeurs de Java peuvent facilement convertir XLSB en XLSX en seulement quelques lignes de code.
...
1.  Convertissez XLSB en XLSX en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de XLSB en XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir XLSB en XLSX" %}}
{{% blocks/products/pf/agp/text %}}
