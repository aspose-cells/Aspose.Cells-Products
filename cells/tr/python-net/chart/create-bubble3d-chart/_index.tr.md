...
description: Python Python Kitaplığını kullanarak Excel'de Bubble3D grafikleri oluşturmak için örnek kod. Python tabanlı uygulama içinde MS Excel'de Bubble3D grafiği oluşturmak için bu kodu kullanın.
...
Geliştiricilerin, veri işleme için farklı raporlama uygulamalarını yalnızca birkaç satır kodla çalıştırarak Bubble3D grafiği oluşturması kolaydır.
...
1. Çalışma sayfasına Bubble3D grafiği ekleme
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kodu, Python\'i kullanarak MS Excel XLSX dosyasına Bubble3D Grafiğinin nasıl oluşturulacağını gösterir." offSpacer="" %}}
