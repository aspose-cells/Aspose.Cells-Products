---
title: XLS을 HTM에 병합 - XLS을 Python의 HTM에 결합
url: /ko/python-java/merger/merge-xls-to-htm/ 
description: Aspose 엑셀. Python Aspose.Cells. 무료 온라인 병합 XLS을 HTM 저장 형식으로. Python XLS을 HTM 형식으로 결합합니다. XLS을 Python의 HTM에 병합합니다. XLS 병합합니다.
...
다음 예제는 XLS을 Aspose.Cells for Python via Java에서 HTM으로 병합하는 방법을 보여줍니다.
