---
title:  Tìm kiếm và thay thế văn bản trong XLSB tài liệu via .NET
weight: 3890
description: Mã nguồn C# để biên tập lại thông tin nhạy cảm trong tệp XLSB trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chỉnh sửa lại các định dạng XLSB trong C#" h2="Thông tin chỉnh sửa nhạy cảm gốc và hiệu suất cao XLSB sử dụng API Aspose.Cells for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
