---
title: C# TXT to IMAGE - TXT to IMAGE Converter
description: Aspose Excel. Convert TXT to IMAGE quickly and easily with Aspose.Cells. C# TXT to IMAGE. C# Save TXT to IMAGE. Save TXT as IMAGE using C#.
...
{{% blocks/products/pf/agp/content h2="Save TXT to IMAGE in C#" %}}

The following example demonstrates how to convert TXT to IMAGE in C#.
...
{{% cells-convert title="Sample Code to Convert TXT to IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert TXT to IMAGE via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert TXT files to IMAGE programmatically? .NET developers can easily load & convert TXT to IMAGE in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert TXT to IMAGE" %}}
