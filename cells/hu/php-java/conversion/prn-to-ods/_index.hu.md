---
title: PHP PRN - ODS - PRN - ODS konvertáló
description: Aspose Excel. A PRN-t gyorsan és egyszerűen konvertálja ODS-re a Aspose.Cells-gyel. PHP PRN-t ODS-re. PHP PRN mentése ODS-re. PRN mentése ODS-re PHP használatával.
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet a PRN-t ODS-re konvertálni PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A PRN-fájlokat programozottan ODS-re kell konvertálni? A PHP fejlesztői könnyedén betölthetik és konvertálhatják a PRN-t ODS-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a PRN-t ODS-re a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a PRN ODS számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a PRN ODS-re való konvertálásához" %}}
