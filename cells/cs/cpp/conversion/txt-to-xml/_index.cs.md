...
{{% blocks/products/pf/agp/content h2="Jak převést TXT na XML pomocí C++" %}}

 K převodu TXT na XML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TXT na XML prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor TXT na XML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XML).1. Soubor XML bude uložen do zadané cesty.1. Otevřete soubor XML v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TXT na XML C++" offSpacer="" %}}
