...
{{< blocks/products/pf/carousel-item h3="ความเป็นอิสระของแพลตฟอร์ม" description="API รองรับแอปพลิเคชัน C++ อย่างเต็มรูปแบบบนแพลตฟอร์มต่อไปนี้ด้วย [ความต้องการของระบบ](https://docs.aspose.com/cells/cpp/system-requirements/)." >}}
<div class="diagram1 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description="Aspose.Cells สำหรับ C++ รองรับสเปรดชีตที่ใช้บ่อยที่สุด [รูปแบบไฟล์](https://docs.aspose.com/cells/cpp/supported-file-formats/)." >}}
...
{{< blocks/products/pf/slr-element name="API ข้อมูลอ้างอิง" href="https://reference.aspose.com/cpp/cells" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="ทำไมต้อง Aspose.Cells สำหรับ C++" tabId="success-stories" >}}
