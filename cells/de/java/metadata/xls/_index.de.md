...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Extrahieren von Metadaten von XLS über Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Metadaten von XLS extrahieren - Java" offSpacer="" %}}
