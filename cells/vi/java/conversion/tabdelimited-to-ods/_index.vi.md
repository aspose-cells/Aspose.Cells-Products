...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi TABDELIMITED sang ODS bằng cách sử dụng Java" %}}

 Để hiển thị TABDELIMITED thành ODS, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi TABDELIMITED sang ODS qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp TABDELIMITED thành ODS chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp TABDELIMITED với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Truyền đường dẫn đầu ra với phần mở rộng ODS & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp ODS kết quả
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED thành ODS Java Mã nguồn chuyển đổi" offSpacer="" %}}

```cs
// tải tệp TABDELIMITED trong một phiên bản của Workbook
Workbook book = new Workbook("template.tabdelimited");
// lưu TABDELIMITED dưới dạng ODS
