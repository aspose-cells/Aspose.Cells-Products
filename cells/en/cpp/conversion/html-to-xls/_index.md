...
description: Sample C++ conversion code for HTML to XLS format. Programmers can use this source code for batch HTML to XLS conversion within any C++ Application.
---
