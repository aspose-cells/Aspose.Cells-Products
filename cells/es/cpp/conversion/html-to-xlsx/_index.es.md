---
title: Convierta HTML a XLSX a través de la aplicación C++ 
weight: 9770

description: Ejemplo de código de conversión C++ para documento HTML a formato XLSX. Los programadores pueden usar este código fuente para la conversión por lotes de HTML a XLSX dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTML a XLSX usando C++" %}}

 Para convertir HTML a XLSX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir HTML a XLSX a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de C++ pueden convertir fácilmente un archivo HTML a XLSX con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo HTML usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (XLSX).1. El archivo XLSX se guardará en la ruta especificada.1. Abra el archivo XLSX en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de HTML a XLSX C++" offSpacer="" %}}
