---
title: JPG egyesítése ET-be – JPG egyesítése ET-be a Java-ben
url: /hu/java/merger/merge-jpg-to-et/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése JPG ET mentési formátumba. Java JPG kombinálása ET formátumba. JPG egyesítése ET-be a Java-ben. JPG egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenes JPG és ET egyesítése a Java Online számon" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a JPG-t az ET-vel a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a JPG és az ET egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el ET fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a JPG-t az ET-vel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a JPG és az ET egyesítése a Java számon" InputFormat="jpg" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hogyan lehet JPG-t egyesíteni ET via Java-be" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a JPG-t az ET-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a JPG és az ET egyesítéséhez" %}}
