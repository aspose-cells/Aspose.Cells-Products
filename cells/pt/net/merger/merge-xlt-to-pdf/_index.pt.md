---
title: Mesclar XLT a PDF - Combinar XLT a PDF em C#
url: /pt/net/merger/merge-xlt-to-pdf/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita XLT para PDF saveformat. C# Combine o formato XLT a PDF. Mesclar XLT a PDF em C#. XLT Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLT a PDF em C# Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar XLT a PDF em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLT a PDF. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo PDF. Se você desenvolver o código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla XLT a PDF.
...
{{% blocks/products/pf/agp/content h2="Como mesclar XLT a PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLT a PDF programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLT a PDF" %}}
