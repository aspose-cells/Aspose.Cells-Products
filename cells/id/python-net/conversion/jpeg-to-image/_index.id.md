...
description: Aspose Unggul. Ubah JPEG menjadi IMAGE dengan cepat dan mudah menggunakan Aspose.Cells. Python JPEG menjadi IMAGE. Python Simpan JPEG ke GAMBAR. Simpan JPEG sebagai GAMBAR menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Simpan JPEG ke IMAGE di Python" %}}

Contoh berikut menunjukkan cara mengonversi JPEG menjadi IMAGE di Python via NET.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengonversi JPEG menjadi IMAGE" %}}
