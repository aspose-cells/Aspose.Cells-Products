...
description: Aspose Excel. C++ Aspose.Cells. Συγχώνευση OTS σε μορφή αποθήκευσης ET. C++ Συνδυάστε τη μορφή OTS σε ET. Συγχώνευση OTS σε ET στο C++. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση OTS με ET στο C++" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση OTS με ET στο C++" InputFormat="ots" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
