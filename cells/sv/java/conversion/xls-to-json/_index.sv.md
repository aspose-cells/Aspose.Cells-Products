---
title:  Konvertera XLS till JSON Java
description: Konvertera XLS till JSON online gratis. Gratis onlinekonverterare XLS till JSON. Java XLS till JSON. XLS till JSON via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera XLS till JSON på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1.  Ladda XLS-filen med en instans av Workbook-klassen
1.  Konvertera XLS till JSON genom att anropa metoden Workbook.save
