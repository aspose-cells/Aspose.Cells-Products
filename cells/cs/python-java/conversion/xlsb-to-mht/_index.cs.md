...
description: Aspose Excel. Převeďte XLSB na MHT rychle a snadno pomocí Aspose.Cells. Python XLSB na MHT. Python Uložte XLSB na MHT. Uložte XLSB jako MHT pomocí Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte XLSB na MHT pomocí Python" %}}

Jak převedu XLSB na MHT? S knihovnou Aspose.Cells for Python můžete snadno převést XLSB na MHT programově pomocí několika řádků kódu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)je schopen vytvářet multiplatformní aplikace se schopností generovat, upravovat, konvertovat, vykreslovat a tisknout všechny soubory aplikace Excel. Python Excel API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat soubory Excel jako obrázky, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT a další, takže je perfektní volbou pro výměnu dokumentů ve standardních průmyslových formátech.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Uložte XLSB na MHT v Python" %}}

Následující příklad ukazuje, jak převést XLSB na MHT v Python.
...
{{% blocks/products/pf/agp/content h2="Jak převést XLSB na MHT přes Python" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XLSB soubory na MHT programově? Python vývojáři mohou snadno načíst a převést XLSB na MHT v několika řádcích kódu.
...
1.  Převeďte XLSB na MHT voláním metody Workbook.save.
1.  Získejte výsledek převodu XLSB na MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLSB na MHT" %}}
