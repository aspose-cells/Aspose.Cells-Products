...
description: Aspose Excel. Converta TABDELIMITED em XLAM de forma rápida e fácil com Aspose.Cells. PHP TABDELIMITED em XLAM. PHP Salve TABDELIMITED em XLAM. Salve TABDELIMITED como XLAM usando PHP.
...
Precisa converter arquivos TABDELIMITED para XLAM programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TABDELIMITED em XLAM em apenas algumas linhas de código.
...
1.  Converta TABDELIMITED em XLAM chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TABDELIMITED para XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED para XLAM" %}}
