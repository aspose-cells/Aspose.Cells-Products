---
title: HTML から JPEG を結合 - HTML から JPEG を C# に結合
url: /ja/net/merger/merge-html-to-jpeg/ 
description: Aspose エクセル。 C# Aspose.Cells。HTML を JPEG の保存形式にマージします。 C# HTML と JPEG の形式を結合します。 HTML から JPEG を C# に結合します。HTML を結合します。
...
次の例は、HTML を Aspose.Cells for .NET の JPEG にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、HTML を JPEG にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルをマージし、それを JPEG ファイルに保存します。 C# のコードを開発する場合、これは思っているより簡単です。 HTML を JPEG にマージする C# の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="HTML から JPEG を C# にマージするサンプルコード" InputFormat="html" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="HTML を C# 経由で JPEG に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML をプログラムで JPEG にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2=".NET HTML を JPEG にマージするライブラリ" %}}
