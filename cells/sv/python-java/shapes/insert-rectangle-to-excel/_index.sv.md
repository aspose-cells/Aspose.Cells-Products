...
{{% blocks/products/pf/agp/content h2="Hur man infogar rektangel i Excel-fil med Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga rektangel till Excel-fil med Python via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRectangle(int,%20int,%20int,%20int,%20int,%20int)) för att infoga en rektangel i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga rektangel - Python via Java" offSpacer="" %}}
