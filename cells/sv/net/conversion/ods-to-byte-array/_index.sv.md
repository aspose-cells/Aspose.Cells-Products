---
title: Konvertera ODS till Byte Array via C# 
weight: 7690

description: C# Exempelkod för ODS till Byte Array-konvertering. Använd den här koden för konvertering av Excel ODS till Byte Array inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera ODS till byte array via C#" h2="Inbyggd och högpresterande Microsoft Excel ODS till byte array-konvertering eller vice versa för databearbetning av kalkylark med hjälp av serversidans .NET API:er." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array är användbart för databearbetning eller lagring. Du kan konvertera ODS-fil till Byte Array samt ett **Byte Array till ODS**-dokument med hjälp av språket C#. För att konvertera ODS till byte array kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Så här konverterar du ODS till Byte Array via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Det är lätt för utvecklarna att ladda och konvertera ODS-filer till byte-array för ytterligare manipulationsuppgifter på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Inkludera namnområdet i din klassfil1. Ladda indata ODS-fil med arbetsbok1. Initiera MemoryStream-objekt1. Konvertera strömdata till byte-array1. Bearbeta data enligt ditt krav
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar ODS till byte array C#-konvertering" offSpacer="" %}}
...
Ett Excel-kalkylbladsprogrammeringsbibliotek som kan bygga plattformsoberoende applikationer med förmågan att generera, modifiera, konvertera, rendera och skriva ut alla Excel-filer. .NET Excel API konverterar inte bara mellan kalkylarksformat, det kan också rendera Excel-filer inklusive ODS som bilder, PDF, HTML, ODS och mer, vilket gör det till ett perfekt val för att utbyta dokument i industristandardformat.
