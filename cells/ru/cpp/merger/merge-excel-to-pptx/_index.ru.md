---
title: Объединить EXCEL с PPTX — Объединить EXCEL с PPTX в C++
url: /ru/cpp/merger/merge-excel-to-pptx/ 
description: Aspose Эксель. C++ Aspose.Cells. Объедините EXCEL с форматом сохранения PPTX. C++ Объедините EXCEL в формат PPTX. Объедините EXCEL с PPTX в C++. EXCEL Объедините.
...
{{% blocks/products/pf/agp/content h2="Объединить EXCEL с PPTX в C++" %}}

В следующем примере показано, как объединить EXCEL с PPTX в Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить EXCEL с номером PPTX. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле PPTX. Если вы разработаете код C++, это будет проще, чем кажется. См. пример C++, в котором EXCEL объединяется с PPTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения EXCEL с PPTX в C++" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как объединить EXCEL с PPTX через C++" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить EXCEL с PPTX? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для объединения EXCEL с PPTX" %}}
