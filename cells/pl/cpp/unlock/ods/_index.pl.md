---
title:  Odblokuj dokument ODS poprzez C++
weight: 1190
description: C++ przykładowy kod do odblokowania chronionego hasłem pliku ODS w C++ Środowisko wykonawcze dla Windows 32-bitowy, Windows 64-bitowy i Linux 64-bitowy.
...
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj pliki ODS pod numerem C++" h2="Usuń ochronę z arkuszy kalkulacyjnych Excel, w tym pliku ODS, korzystając z biblioteki C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak usunąć ochronę pliku ODS przy użyciu C++" %}}
