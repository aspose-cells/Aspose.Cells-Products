---
title: A XLTX egyesítése a POWERPOINT-hoz – a XLTX-es szám egyesítése a POWERPOINT-hez a C#-es helyen
url: /hu/net/merger/merge-xltx-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés XLTX POWERPOINT mentési formátumba. C# A XLTX kombinálása POWERPOINT formátumba. A XLTX egyesítése a C#-es POWERPOINT-tal. XLTX Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLTX-es számot a POWERPOINT-hoz a C#-es online ingyen" %}}

A következő példa bemutatja, hogyan egyesítheti a XLTX-es számot a POWERPOINT-tal a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLTX és a POWERPOINT egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el POWERPOINT fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a XLTX-et a POWERPOINT-tal.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a XLTX egyesítéséhez POWERPOINT a C#-ben" InputFormat="xltx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLTX és a POWERPOINT egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLTX-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLTX és a POWERPOINT egyesítéséhez" %}}
