---
title: C# XLTXからPRN - オンラインXLTXからPRNコンバータ
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# XLTX を PRN 保存形式に変換します。 C# XLTX を PRN 形式に変換します。 XLTX を PRN C# に保存します。
...
{{% blocks/products/pf/agp/content h2="XLTXをオンラインで無料でPRNに保存します" %}}
...
{{% cells-convert title="XLTXをオンラインでPRNに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="XLTX経由でXLTXをPRNに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLTX ファイルをプログラムで PRN に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLTX を簡単にロードして PRN に変換できます。
