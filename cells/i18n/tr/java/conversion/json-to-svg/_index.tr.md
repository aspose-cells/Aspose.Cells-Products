---
title: JSON'u Java aracılığıyla SVG'ye dönüştürün 
weight: 6900
url: /tr/java/conversion/json-to-svg/ 
description: JSON biçimi için SVG dosyasına örnek Java dönüştürme kodu. Programcılar, Excel ve OpenOffice elektronik tablolarını herhangi bir Web veya Masaüstü Java tabanlı Uygulamada SVG'ye aktarmak için bu örnek kodu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JSON\'u Java aracılığıyla SVG\'ye dönüştürün" h2="Ek araçlar veya kitaplıklar gerektirmeden JSON\'u Java aracılığıyla SVG formatına aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak JSON\'u SVG\'ye Dönüştürme" %}}

 JSON'u SVG'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla JSON\'u SVG\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla JSON dosyasını kolayca SVG'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Workbook sınıfının yeni bir örneğini oluşturun1. Koleksiyondan varsayılanı veya herhangi bir Çalışma Sayfasını seçin1. JSON verilerini dosyadan yükle1. JsonLayoutOptions örneğini oluşturun ve seçenekleri ayarlayın1. JSON verilerini içe aktarmak için JsonUtility.importData yöntemini çağırın1. SVG oluşturma için ImageOrPrintOptions nesnesini oluşturun ve ayarlayın1. İşleme için SheetRender oluşturun1. Sonucu SVG biçiminde kaydetmek için SheetRender.toImage yöntemini çağırın
...
{{% blocks/products/pf/agp/code-block title="JSON\'dan SVG\'ye Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// JSON veri dosyasını dize olarak oku
...
{{< blocks/products/pf/agp/demobox sectionTitle="JSON\'dan SVG\'ye Dönüştürme Canlı Demoları" sectionDescription="[JSON\'u SVG\'ye Dönüştür](https://products.aspose.app/cells/conversion/json-to-svg) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece JSON dosyanızı yükleyin, anında SVG\'ye dönüştürülecektir." >}}
