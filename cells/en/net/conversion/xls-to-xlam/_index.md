...
description: Sample code for xls to xlam C# conversion. Use API example code for batch xls files to xlam conversion within VB.NET, Asp.NET or any .NET based application.
---
