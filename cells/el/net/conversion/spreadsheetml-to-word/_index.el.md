---
title: C# SPREADSHEETML σε WORD - Online Μετατροπέας SPREADSHEETML σε WORD
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Δωρεάν Online C# Μετατροπή SPREADSHEETML σε μορφή αποθήκευσης WORD. C# SPREADSHEETML σε μορφή WORD. Αποθήκευση SPREADSHEETML στο WORD C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Μετατρέψτε το SPREADSHEETML σε WORD στο C#" h2="Βιβλιοθήκη υψηλής ταχύτητας C# για μετατροπή SPREADSHEETML σε WORD. Αυτή είναι μια επαγγελματική λύση λογισμικού για εισαγωγή και εξαγωγή SPREADSHEETML, WORD και πολλών άλλων μορφών σε πλατφόρμες .NET Framework, .NET Core ή Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το SPREADSHEETML στο WORD στο C# Online δωρεάν" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε SPREADSHEETML σε WORD στο C#.
...
{{% cells-convert title="Δωρεάν εφαρμογή και δείγμα κώδικα για μετατροπή SPREADSHEETML σε WORD Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε SPREADSHEETML σε WORD μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να μετατρέψετε αρχεία SPREADSHEETML σε WORD μέσω προγραμματισμού; .NET οι προγραμματιστές μπορούν εύκολα να φορτώσουν και να μετατρέψουν SPREADSHEETML σε WORD σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατρέψτε το SPREADSHEETML σε WORD καλώντας τη μέθοδο Workbook.Save.
1.  Λάβετε το αποτέλεσμα μετατροπής του SPREADSHEETML σε WORD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# βιβλιοθήκη για μετατροπή SPREADSHEETML σε WORD" %}}
