---
title: Python XLSB až XLTM - Online konvertor XLSB až XLTM
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Online zdarma Python Převést XLSB na XLTM uložit formát. Python XLSB až XLTM formát. Uložte si XLSB až XLTM Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte XLSB na XLTM pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLSB až XLTM v Python online zdarma" %}}

Následující příklad ukazuje, jak převést XLSB na XLTM v Python.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLSB na XLTM" %}}
