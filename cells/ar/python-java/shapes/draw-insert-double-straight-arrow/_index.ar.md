---
title:  كيف يمكنني رسم أو إدراج سهم مستقيم مزدوج في Excel باستخدام Python via java
weight: 10
description: Python via كود مصدر جافا لرسم أو إدراج سهم مزدوج مستقيم في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج سهم مستقيم مزدوج في ملف Excel باستخدام Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج سهم مستقيم مزدوج في ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) لإدراج سهم مستقيم مزدوج في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل سهمًا مستقيمًا مزدوجًا - Python via java" offSpacer="" %}}
