---
title: Gabung MHTML ke XLSB - Gabungkan MHTML ke XLSB di Java
url: /id/java/merger/merge-mhtml-to-xlsb/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge MHTML to XLSB saveformat. Java Gabungkan format MHTML menjadi XLSB. Gabung MHTML ke XLSB di Java. MHTML Gabung.
...
Contoh berikut menunjukkan cara menggabungkan MHTML ke XLSB di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan MHTML ke XLSB di Java" InputFormat="mhtml" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML ke XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan MHTML menjadi XLSB secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
