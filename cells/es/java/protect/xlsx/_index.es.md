---
title: Proteja y bloquee el documento XLSX a través de Java 
weight: 1870

description: Java código de ejemplo para bloquear el archivo XLSX mediante contraseña en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cifrar archivos XLSX a través de Java" h2="Proteja con contraseña las hojas de cálculo de Excel, incluido el formato XLSX, utilizando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para proteger archivos XLSX a través de Java" %}}
...
1. Cargue el archivo XLSX instanciando la clase Workbook1. Utilice el método protect(..) con ProtectionType y Password1. Guarde el archivo XLSX protegido con el método save()
