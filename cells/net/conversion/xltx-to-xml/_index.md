...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert XLTX files to XML in just a few lines of code.
...
{{% cells-convert title="Free App and Sample Code to Convert XLTX to XML" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et InputFormat=xltx outformat=xml IsLandingPage=true %}}
