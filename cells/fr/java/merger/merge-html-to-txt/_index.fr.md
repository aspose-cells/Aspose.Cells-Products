...
description: Aspose Exceller. Java Aspose.Cells. Fusionner le format de sauvegarde HTML à TXT. Java Combinez les formats HTML à TXT. Fusionner HTML à TXT dans Java. HTML Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTML à TXT dans Java" %}}
...
{{% cells-merger title="Exemple de code pour fusionner HTML à TXT dans Java" InputFormat="html" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTML à TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTML à TXT par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner HTML à TXT" %}}
