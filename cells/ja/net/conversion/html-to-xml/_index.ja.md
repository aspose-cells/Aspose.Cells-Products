---
title: C# HTML から XML - HTML から XML コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、HTML を XML にすばやく簡単に変換します。 C# HTML を XML に変換します。 C# HTML を XML に保存します。 C# を使用して HTML を XML として保存します。
...
{{< blocks/products/pf/i18n/upper-banner h1="HTML を C# の XML に変換する" h2="HTML を XML に変換するための高速 C# ライブラリ。これは、HTML フレームワーク、.NET コア、または Mono プラットフォームで HTML、XML、およびその他の多くの形式をインポートおよびエクスポートするためのプロフェッショナル ソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="HTML を C# の XML に保存" %}}
...
{{% cells-convert title="HTML を XML に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# 経由で HTML を XML に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで XML に変換する必要がありますか? .NET 開発者は、わずか数行のコードで HTML を簡単にロードして XML に変換できます。
