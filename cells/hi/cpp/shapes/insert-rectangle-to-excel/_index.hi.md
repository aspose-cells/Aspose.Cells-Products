---
title:  एक्सेल में C++ के माध्यम से आयत डालें
weight: 50
description: Windows 32 बिट, Windows 64 बिट और लिनक्स 64 बिट के लिए C++ रनटाइम पर्यावरण पर एक्सेल फ़ाइल में आयत सम्मिलित करने के लिए C++ उदाहरण कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="एक्सेल में C++ के माध्यम से आयत डालें" h2="किसी भी सॉफ़्टवेयर जैसे Microsoft या Adobe PDF का उपयोग किए बिना सर्वर-साइड Aspose.Cells for C++ API के मूल और उच्च प्रदर्शन का उपयोग करके ऑब्जेक्ट डालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ के माध्यम से आयत को एक्सेल फ़ाइल में सम्मिलित करने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से कार्यपत्रक का चयन करें।
 + का प्रयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ada0b818330196c0f026e4588801feadd) चयनित वर्कशीट में समीकरण आकृतियों को सम्मिलित करने के लिए
