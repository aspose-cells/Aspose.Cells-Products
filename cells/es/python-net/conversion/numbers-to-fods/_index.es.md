...
{{% blocks/products/pf/agp/content h2="Convierta NÚMEROS a FODS en la biblioteca de Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Guarde NÚMEROS en FODS en Python Biblioteca de Excel" %}}

El siguiente ejemplo demuestra cómo convertir NÚMEROS a FODS en la biblioteca de Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca de Excel para convertir NÚMEROS a FODS" %}}
