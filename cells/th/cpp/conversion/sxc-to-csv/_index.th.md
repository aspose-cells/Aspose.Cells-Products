...
ต้องการแปลงไฟล์ SXC เป็น CSV โดยใช้โปรแกรมหรือไม่? นักพัฒนา C++ สามารถแปลง SXC เป็น CSV ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงค่า SXC เป็น CSV โดยเรียกใช้เมธอด Save()
