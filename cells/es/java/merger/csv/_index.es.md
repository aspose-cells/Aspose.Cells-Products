...
{{% blocks/products/pf/agp/content h2="Cómo fusionar archivos CSV usando Java" %}}
 ...
 Para combinar el archivo CSV, usaremos
...
+ guardar el archivo CSV fusionado en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Combinar archivos CSV - Java" offSpacer="" %}}

```cs
// Abra el primer archivo CSV.
Workbook csvFile1 = new Workbook("chartsFileWithPath.csv");

// Defina el segundo libro fuente.
// Abra el segundo archivo CSV.
