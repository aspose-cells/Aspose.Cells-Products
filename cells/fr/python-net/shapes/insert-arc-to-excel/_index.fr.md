...
{{% blocks/products/pf/agp/content h2="Comment insérer un arc dans un fichier Excel à l\'aide de Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer un fichier Arc dans Excel à l\'aide de Python via .Net" %}}
...
+ Utilisez la méthode add de shapecollection pour insérer un arc dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer un arc - Python via .Net" offSpacer="" %}}
