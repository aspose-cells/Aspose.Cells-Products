...
{{< blocks/products/pf/i18n/upper-banner h1="قم بإنشاء ملف أرقام في C++" h2="إنشاء ملفات NUMBERS أصلية وعالية الأداء برمجيًا بدون استخدام Micorsoft Office باستخدام مكتبة C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 من السهل على المطورين إنشاء ملفات NUMBERS وتحميلها وتعديلها وتحويلها ضمن تشغيل تطبيقات التقارير لمعالجة البيانات في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  احفظ المصنف كملف .numbers باستخدام طريقة Save().
