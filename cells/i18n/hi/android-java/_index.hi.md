...
{{< blocks/products/pf/i18n/upper-banner h1="एक्सेल स्प्रेडशीट में हेरफेर करने के लिए एंड्रॉइड एपीआई" h2="बिना किसी निर्भरता के एंड्रॉइड ऐप के भीतर एक्सेल फाइल बनाएं, पढ़ें, लिखें या हेरफेर करें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-android-java.svg" pfName="Aspose.Cells" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/cells/androidjava" >}}
...
<p>
 Java के माध्यम से Android के लिए Aspose.Cells प्रोग्रामेटिक रूप से स्प्रैडशीट जेनरेट करने, संयोजित करने, संशोधित करने और पार्स करने के लिए एक स्केलेबल API है। API एक्सेल दस्तावेज़ स्वरूपण और पृष्ठ सेटअप कार्यों, आयात और निर्यात क्षमताओं सहित कई कार्य प्रदान करता है, कार्यपत्रक पृष्ठों को रेखापुंज छवियों के साथ-साथ छवि रिज़ॉल्यूशन, गुणवत्ता, संपीड़न, विभिन्न चार्ट जोड़ने और बहुत कुछ निर्दिष्ट करता है। एंड्रॉइड स्प्रेडशीट API एक्सएलएस, एक्सएलएसएक्स, सीएसवी, स्प्रेडशीटएमएल, ओडीएस, टैब सीमांकित, एचटीएमएल, पीडीएफ, एक्सपीएस, और अधिक प्रारूपों का समर्थन करता है।
</p>
...
{{< blocks/products/pf/carousel-item h3="प्लेटफार्म स्वतंत्रता" description="Aspose.Cells Android के लिए Java के माध्यम से Android 2.0 या इसके बाद के संस्करण के लिए उपलब्ध है।" >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल प्रारूप" description="Android स्प्रैडशीट API लोकप्रिय Microsoft Excel स्वरूपों, छवियों और फ़िक्स्ड-लेआउट स्वरूपों का समर्थन करता है।" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    उन्नत Android Excel API सुविधाएँ
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     वर्कशीट, रो, कॉलम, सेल और रेंज में फॉर्मेटिंग लागू करें
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ArrayList, Array, Recordset &amp से डेटा निर्यात और आयात करें; परिणाम सेट
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     एन्क्रिप्ट करें &amp; एक्सेल फाइलों को डिक्रिप्ट करें
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     पढ़ें, सेट करें &amp; सूत्रों की गणना करें
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     सेट करें और ऑटो-फ़िल्टर में हेरफेर करें &amp; पृष्ठ विराम
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     मौजूदा कार्यपत्रकों की प्रतियां बनाएं
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Microsoft Excel XP के बाद से पेश किए गए सुरक्षा विकल्प सेट करें
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     कोशिकाओं में हेरफेर करें &amp; नामित पर्वतमाला
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     एक्सेल फाइलों को पीडीएफ में बदलें
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     कार्यपत्रकों को रूपांतरित करें &amp; छवियों के लिए चार्ट
    </p>
   </div>
   <!--<div class="col-lg-12">
...
-->
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     बनाएं &amp; कस्टम चार्ट में हेरफेर करें
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     पढ़ें &amp; टीएसवी, सीएसवी और लिखें; एचटीएमएल फ़ाइलें
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     विभिन्न प्रारूप रूपांतरण
    </h2>
    <p>
     एंड्रॉइड एक्सेल लाइब्रेरी स्प्रैडशीट्स को एक्सपीएस, पीडीएफ और amp में बदलने की पेशकश करती है; उच्चतम दृश्य निष्ठा रखते हुए HTML प्रारूप। विश्वसनीय रूपांतरण प्रक्रिया कंपनियों के लिए उद्योग-मानक प्रारूपों में फ़ाइलों के आदान-प्रदान के लिए API को एक आदर्श विकल्प बनाती है।
    </p>
    <div class="codeblock" id="code">
     <h3>
      कार्यपुस्तिका को विभिन्न स्वरूपों में सहेजें - Java
     </h3>
...
<p>Aspose.Cells for Android via Java gives you complete freedom and flexibility to furnish your spreadsheets with all kinds of visual effects. The API allows you to apply different fonts with attributes, cell styles (alignment, indentation, rotation, borders, shading and coloring, protection, text wrapping and shrinking) and all types of number formats. Similarly, charts and graphics are visually appealing and can give your spreadsheet a professional look. Aspose.Cells for Android via Java provides a comprehensive set of APIs for creating and manipulating all of the standard and custom chart types. Moreover, you may add different types of drawing objects, such as comments, pictures, OLE objects, shapes and controls to the cells.</p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     स्प्रेडशीट ऑब्जेक्ट्स को विभिन्न स्वरूपों में कनवर्ट करें
    </h2>
    <p>
     Aspose.Cells Android के लिए Java के माध्यम से कुछ विशिष्ट सुविधाएं प्रदान करता है जैसे छवियों के लिए कार्यपत्रक, छवियों के लिए चार्ट &amp; पीडीएफ और स्प्रेडशीट से पीडीएफ दस्तावेज़ प्रारूप रूपांतरण। लचीली प्रक्रिया में रूपांतरण के लिए कई विकल्प होते हैं, जैसे स्प्रैडशीट्स के दौरान पीडीएफ में छवियों का पुन: नमूनाकरण या कार्यपत्रकों को प्रस्तुत करते समय परिणामी छवि आयाम सेट करना &amp; छवि प्रारूपों के लिए चार्ट।
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     स्प्रैडशीट API सूत्र गणना इंजन
    </h2>
    <p>
     Android शीट API उन्नत और मानक Microsoft Excel फ़ंक्शंस और फ़ार्मुलों का समर्थन करने वाला एक शक्तिशाली फ़ॉर्मूला गणना इंजन प्रदान करता है। सूत्र गणना इंजन बिल्ट-इन या ऐड-इन प्रकार, सरणी और R1C1 संदर्भ शैली सूत्रों के परिणामों को पढ़ना, सेट करना और गणना करना आसान बनाता है।
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="प्रलेखन" href="https://docs.aspose.com/cells/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Android के लिए Java के माध्यम से Aspose.Cells क्यों?" tabId="success-stories" >}}
