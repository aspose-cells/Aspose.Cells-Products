---
title: Unisci NUMBERS a PRN - Combina NUMBERS a PRN in C#
url: /it/net/merger/merge-numbers-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. Unisci i NUMERI online gratuiti nel formato di salvataggio PRN. C# Combina NUMBERS in formato PRN. Unisci NUMBERS a PRN in C#. NUMBERS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci NUMBERS a PRN in C# online gratuitamente" %}}

L'esempio seguente mostra come unire NUMBERS a PRN in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire NUMBERS a PRN. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file PRN. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce NUMBERS a PRN.
...
{{% blocks/products/pf/agp/content h2="Come unire NUMBERS a PRN tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire NUMBERS a PRN in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria per unire NUMBERS a PRN" %}}
