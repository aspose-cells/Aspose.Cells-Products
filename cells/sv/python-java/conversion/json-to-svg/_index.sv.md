---
title: Konvertera JSON till SVG via Python
url: /sv/python-java/conversion/json-to-svg/
description: Exempelkod för konvertering från json till svg Python. Använd API exempelkod för batch-json-filer till svg-konvertering i Python-applikationen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera JSON till SVG via Python" h2="Exportera Excel®-kalkylark till SVG-format med Python API:er." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du JSON till SVG med Python" %}}

 För att konvertera JSON till SVG kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera JSON till SVG via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera JSON-filer till SVG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda JSON-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utdatasökväg med SVG-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande SVG-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera JSON till SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="svg" IsLandingPage="true" language="python" %}}
