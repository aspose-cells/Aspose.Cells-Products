---
title: C# OTS till PNG - OTS till PNG Converter
description: Aspose Excel. Konvertera OTS till PNG snabbt och enkelt med Aspose.Cells. C# OTS till PNG. C# Spara OTS till PNG. Spara OTS som PNG med 304818.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till PNG på C#" %}}

Följande exempel visar hur man konverterar OTS till PNG i C#.
...
{{% cells-convert title="Exempelkod för att konvertera OTS till PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till PNG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till PNG programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till PNG på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera OTS till PNG" %}}
