---
title: Editar archivos TSV a través de .NET 
url: /es/net/editor/tsv/ 
description: C# código fuente para editar documentos TSV en .NET Framework, .NET Core, Windows Azure, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Cómo editar un archivo TSV usando C#" %}}
...
Aspose.Cells API se puede usar para crear, editar, convertir y representar formatos de Microsoft Excel en diferentes formatos. Además, se puede usar para gráficos completos, informes escalables y cálculos confiables dentro de las aplicaciones de software. Aspose.Cells es un API independiente y no requiere ningún software como Microsoft u OpenOffice.    
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo del editor de TSV en línea" sectionDescription="Edite documentos TSV ahora mismo visitando nuestro [Sitio web de demostraciones en vivo](https://products.aspose.app/cells/editor). La demostración en vivo tiene los siguientes beneficios" >}}
