...
{{% blocks/products/pf/agp/content h2="Jak wstawić notatki w pliku XLSB za pośrednictwem Python" %}}
...
{{% cells-annotation title="Darmowa aplikacja do usuwania adnotacji z pliku XLSB" InputFormat="xlsb" IsLandingPage="true" language="python" %}}
