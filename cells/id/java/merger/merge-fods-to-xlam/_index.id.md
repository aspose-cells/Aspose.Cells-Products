---
title: Gabungkan FODS menjadi XLAM - Gabungkan FODS menjadi XLAM menjadi Java
url: /id/java/merger/merge-fods-to-xlam/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS menjadi XLAM format simpan. Java Gabungkan format FODS menjadi XLAM. Gabungkan FODS menjadi XLAM di Java. FODS Gabungkan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan FODS menjadi XLAM via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan FODS menjadi XLAM. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="FODS" additionalConversionTag="XLAM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS menjadi XLAM di Java" %}}

Contoh berikut menunjukkan cara menggabungkan FODS menjadi XLAM di Aspose.Cells for Java.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan FODS menjadi XLAM di Java" InputFormat="fods" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS menjadi XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke XLAM secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan FODS menjadi XLAM" %}}
