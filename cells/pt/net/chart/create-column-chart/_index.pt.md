...
description: C# Código de amostra para criar gráficos de colunas para o Excel usando a Biblioteca .NET. Use este código para criar um gráfico de colunas para MS Excel em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
É fácil criar gráficos de colunas dinamicamente no aplicativo em execução. Para criar uma variedade de gráficos para planilhas do zero sem a necessidade do MS Office, usaremos[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API que oferece diversas funcionalidades para criação, manipulação e conversão de planilhas na plataforma .NET. Aspose.Cells fornece muitos objetos de gráfico flexíveis.
