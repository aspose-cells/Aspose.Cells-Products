---
title: MHT를 TIFF에 병합 - MHT를 C++의 TIFF에 결합
url: /ko/cpp/merger/merge-mht-to-tiff/ 
description: Aspose 엑셀. C++ Aspose.Cells. 무료 온라인 MHT를 TIFF 저장 형식으로 병합합니다. C++ MHT를 TIFF 형식으로 결합합니다. MHT를 C++에서 TIFF로 병합합니다. MHT 병합.
...
{{% blocks/products/pf/agp/content h2="C++ 온라인에서 무료로 MHT를 TIFF에 병합" %}}

다음 예는 MHT를 Aspose.Cells for C++에서 TIFF로 병합하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

간단한 단계에 따라 MHT를 TIFF에 병합합니다. 파일을 업로드하고 파일 병합을 위해 Workbook.Combine 메서드를 호출한 다음 TIFF 파일에 저장합니다. C++에서 코드를 개발하면 생각보다 간단합니다. MHT를 TIFF에 병합하는 C++ 예제를 참조하십시오.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="MHT를 C++에서 TIFF로 병합하는 무료 온라인" InputFormat="mht" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="C++을 통해 MHT를 TIFF에 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 MHT를 TIFF에 병합해야 합니까? 병합 및 연결하는 기본 문서[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) 몇 줄의 코드만으로 API를 수행할 수 있습니다.
