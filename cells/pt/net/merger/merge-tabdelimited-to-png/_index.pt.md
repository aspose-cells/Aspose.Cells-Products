---
title: Mesclar TABDELIMITED para PNG - Combinar TABDELIMITED para PNG em C#
url: /pt/net/merger/merge-tabdelimited-to-png/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita TABDELIMITED para PNG saveformat. C# Combine TABDELIMITED para o formato PNG. Mesclar TABDELIMITED para PNG em C#. TABDELIMITED Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar TABDELIMITED para PNG em C# online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar TABDELIMITED com PNG em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar TABDELIMITED para PNG. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo PNG. Se você desenvolver o código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla TABDELIMITED com PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar TABDELIMITED para PNG em C#" InputFormat="tsv" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar TABDELIMITED para PNG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar TABDELIMITED para PNG programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar TABDELIMITED a PNG" %}}
