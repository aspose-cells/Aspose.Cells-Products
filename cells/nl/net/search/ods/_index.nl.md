---
title:  Zoek het document ODS zonder via .NET te openen
weight: 160
description: C# broncode om woorden met patroon te zoeken in het ODS-bestand op .NET Framework, .NET Core, Mono of Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zoek ODS Formaten in C#" h2="Native en krachtige ODS-documentzoekopdracht met behulp van server-side Aspose.Cells for .NET API\'s, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
