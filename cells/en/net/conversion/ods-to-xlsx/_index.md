...
{{< blocks/products/pf/upper-banner h1="Convert ODS to XLSX via C#" h2="Export Excel spreadsheets to XLSX format on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
The following example demonstrates how to convert ODS to XLSX document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert ODS file into XLSX format. Upload your ODS file, then simply save it as XLSX file. For both ODS reading and XLSX writing you can use fully qualified filenames. The output XLSX content and formatting will be identical to the original ODS document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert ODS to XLSX Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xlsx" IsLandingPage="true" %}}
