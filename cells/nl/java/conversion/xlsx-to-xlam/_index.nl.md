...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in XLAM in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar XLAM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar XLAM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar XLAM? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar XLAM met slechts een paar regels code.
