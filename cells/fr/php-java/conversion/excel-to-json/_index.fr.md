---
title: PHP EXCEL en JSON - Convertisseur EXCEL en JSON
description: Aspose Exceller. Convertissez EXCEL en JSON rapidement et facilement avec Aspose.Cells. PHP EXCEL en JSON. PHP Enregistrez EXCEL en JSON. Enregistrez EXCEL sous JSON en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en JSON via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en JSON par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en JSON en quelques lignes de code.
...
1.  Convertissez EXCEL en JSON en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en JSON" %}}
