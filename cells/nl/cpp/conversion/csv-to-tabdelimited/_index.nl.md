...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen CSV-bestanden gemakkelijk converteren naar TABDELIMITED in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad CSV-bestand met behulp van Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (TABDELIMITED) bestandsextensie.1. TABDELIMITED-bestand wordt opgeslagen op het opgegeven pad.1. Open het TABDELIMITED-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="CSV naar TABDELIMITED C++ Conversiebroncode" offSpacer="" %}}
