---
title:  Połącz ODS z XLTX przez Python
url: /pl/python-net/merger/merge-ods-to-xltx/ 
description: Połącz ODS z XLTX Online za darmo. Bezpłatnie online ODS do XLTX Fuzja. Połącz ODS z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć ODS z XLTX w Python.
...
{{% cells-merger title="Darmowa aplikacja do łączenia ODS z XLTX on-line" InputFormat="ods" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
