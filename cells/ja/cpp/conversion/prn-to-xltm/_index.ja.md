---
title: C++ PRN から XLTM - PRN から XLTM へのコンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、PRN を XLTM にすばやく簡単に変換します。 C++ PRN を XLTM に変換します。 C++ PRN を XLTM に保存します。 C++ を使用して、PRN を XLTM として保存します。
...
{{% blocks/products/pf/agp/content h2="PRN を C++ の XLTM に保存" %}}
...
{{% cells-convert title="PRNをXLTMに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xltm" IsLandingPage="true" language="cpp" %}}
