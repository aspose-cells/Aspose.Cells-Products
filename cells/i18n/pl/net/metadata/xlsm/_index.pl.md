---
title: Przeglądaj lub edytuj metadane plików XLSM za pomocą .NET 
weight: 5590
url: /pl/net/metadata/xlsm/ 
description: C# kod źródłowy do edycji lub wyświetlania metadanych formatu XLSM na platformach .NET Framework, .NET Core, Mono lub Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane XLSM przez .NET" h2="Twórz własne .NET aplikacje, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików XLSM przy użyciu interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki wyodrębniania metadanych XLSM za pomocą C#" %}}
...
+ Załaduj XLSM z instancją Workbook
