...
url: /zh-hant/net/merger/merge-mht-to-xml/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 MHT 合併為 XML" h2="用於將 MHT 合併到 XML 的高速 C# 庫。使用我們的Excel轉換API在C#中開發高級、平台無關的軟件。這是導入和導出Excel, CSV, OpenOffice, PDF, HTML, image以及許多其他Excel格式的專業軟件解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="MHT" additionalConversionTag="XML" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
以下示例演示如何將 Aspose.Cells for .NET 中的 MHT 合併為 XML。
...
需要以編程方式將 MHT 合併到 XML？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 將 MHT 合併到 XML 的庫" %}}
