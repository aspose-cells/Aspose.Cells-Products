---
title: C# XLSX ke PDF - Online XLSX ke PDF Konverter
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Gratis Online C# Ubah XLSX menjadi PDF saveformat. C# XLSX ke format PDF. Simpan XLSX ke PDF C#.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke PDF di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi PDF di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi XLSX menjadi PDF. Unggah file XLSX Anda, lalu simpan sebagai file PDF. Untuk membaca XLSX dan menulis PDF Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format keluaran PDF akan identik dengan dokumen asli XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX menjadi PDF Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Konversi XLSX ke PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX menjadi PDF secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX menjadi PDF hanya dalam beberapa baris kode.
...
1.  Ubah XLSX menjadi PDF dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi dari XLSX menjadi PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengonversi XLSX menjadi PDF" %}}
