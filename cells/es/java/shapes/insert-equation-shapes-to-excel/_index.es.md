---
title:  Insertar formas de ecuaciones en Excel via Java
weight: 360
...
{{< blocks/products/pf/i18n/upper-banner h1="Insertar formas de ecuaciones en Excel via Java" h2="Inserte formas de ecuaciones usando Aspose.Cells\' API sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cómo insertar formas de ecuaciones en un archivo de Excel usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar formas de ecuaciones en el archivo Excel via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[agregar método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) para insertar formas de ecuaciones en la hoja de trabajo seleccionada
...
{{% blocks/products/pf/agp/code-block title="Insertar formas de ecuaciones - Java" offSpacer="" %}}
