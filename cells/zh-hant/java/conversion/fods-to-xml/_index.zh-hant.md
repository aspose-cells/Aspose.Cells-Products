...
description: Aspose Excel。使用 Aspose.Cells. Java FODS 到 XML 快速輕鬆地將 FODS 轉換為 XML。 Java 將 FODS 儲存到 XML。使用 Java 將 FODS 儲存為 XML。
...
{{% cells-convert title="將 FODS 轉換為 XML 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xml" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為 XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 FODS 檔案轉換為 XML？ Java 開發人員只需幾行程式碼即可輕鬆將 FODS 轉換為 XML。
...
{{% blocks/products/pf/agp/content h2="Java 庫將 FODS 轉換為 XML" %}}
{{% blocks/products/pf/agp/text %}}
