---
title:  أدخل زر Spin (التحكم في النموذج) في Excel باستخدام Python via java
weight: 40
description: Python via كود مصدر جافا لإدراج زر Spin (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج زر الدوران (التحكم في النموذج) في ملف Excel باستخدام Python via java" %}}

 من أجل إدراج Spin Button (التحكم في النموذج) في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج زر Spin (التحكم في النموذج) إلى ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)) لإدراج زر Spin (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج زر الدوران (التحكم في النموذج) - Python via java" offSpacer="" %}}
