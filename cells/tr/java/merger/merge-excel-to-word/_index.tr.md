---
title: EXCEL'i WORD ile birleştir - EXCEL'i Java'de WORD ile birleştir
url: /tr/java/merger/merge-excel-to-word/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i WORD kaydetme biçimiyle birleştirin. Java EXCEL'i WORD biçimiyle birleştirin. EXCEL'i Java'de WORD ile birleştirin. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i Java\'de WORD ile birleştir" %}}

Aşağıdaki örnek, EXCEL'in Aspose.Cells for Java'deki WORD ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="Java\'de EXCEL\'i WORD ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i WORD via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i programlı olarak WORD ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
