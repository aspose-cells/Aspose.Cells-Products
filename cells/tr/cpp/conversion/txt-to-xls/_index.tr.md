...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, yalnızca birkaç kod satırıyla TXT dosyasını XLS'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak TXT dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (XLS) dosya uzantısıyla iletin.1. XLS dosyası belirtilen yola kaydedilecektir.1. XLS dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="TXT - XLS C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT\'den XLS\'ye Dönüşüm Canlı Demoları" sectionDescription="[TXT\'yi XLS\'ye dönüştür](https://products.aspose.app/cells/conversion/txt-to-xls) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece TXT dosyanızı yükleyin, anında XLS\'ye dönüştürülecektir." >}}
