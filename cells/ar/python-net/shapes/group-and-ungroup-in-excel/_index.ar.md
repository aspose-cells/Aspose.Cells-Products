---
title: تجميع وفك تجميع الأشكال في برنامج Excel باستخدام Python via .Net
weight: 360
description: تجميع وفك تجميع الكائنات باستخدام Aspose.Cells' Python via .Net API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF وما إلى ذلك.
...
{{% blocks/products/pf/agp/content h2="كيفية تجميع وفك تجميع الأشكال في ملف Excel باستخدام Python via .Net" %}}

 لتجميع وفك تجميع الأشكال في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تجميع وفك تجميع الأشكال في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[طريقة المجموعة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/group/) لتجميع الأشكال في ورقة العمل المحددة
 + استخدم[طريقة فك التجميع](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/ungroup/) لفك تجميع الأشكال في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="تجميع وفك تجميع الأشكال - Python via نت via .NET" offSpacer="" %}}
