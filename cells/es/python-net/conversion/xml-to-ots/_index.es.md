...
description: Aspose Excel. Convierta XML a OTS rápida y fácilmente con Aspose.Cells. Python XML a OTS. Python Guardar XML en OTS. Guarde XML como OTS usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XML en OTS en Python" %}}

El siguiente ejemplo demuestra cómo convertir XML a OTS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XML a OTS" %}}
