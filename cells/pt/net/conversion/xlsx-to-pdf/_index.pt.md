---
title: C# XLSX para PDF - Online XLSX para PDF Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter XLSX para PDF saveformat. C# XLSX a PDF formato. Salve XLSX a PDF C#.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a PDF em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter XLSX em PDF em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX em PDF. Carregue seu arquivo XLSX e salve-o como arquivo PDF. Tanto para a leitura XLSX quanto para a escrita PDF, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação de saída PDF serão idênticos ao documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter XLSX em PDF online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX para PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX para PDF programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter XLSX em PDF em apenas algumas linhas de código.
...
1.  Converta XLSX em PDF chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para converter XLSX em PDF" %}}
