---
title: Konvertieren Sie HTML in SPREADSHEETML über Java 
url: /de/java/conversion/html-to-spreadsheetml/ 
description: Beispiel-Umwandlungscode Java für das HTML-Format in eine SPREADSHEETML-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in SPREADSHEETML innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie HTML in SPREADSHEETML über Java" h2="Konvertierung von HTML in SPREADSHEETML Java zum Konvertieren einzelner oder mehrerer Seiten in SPREADSHEETML mithilfe der lokalen Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie HTML in SPREADSHEETML mit Java" %}}

 Um HTML in SPREADSHEETML zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von HTML in SPREADSHEETML über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können HTML-Dateien mit nur wenigen Codezeilen problemlos in SPREADSHEETML konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie eine HTML-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit der SPREADSHEETML-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende SPREADSHEETML-Datei
...
{{% blocks/products/pf/agp/code-block title="Konvertierungsquellcode von HTML zu SPREADSHEETML Java" offSpacer="" %}}

```cs
// Laden Sie die HTML-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.html");
// Speichern Sie HTML als SPREADSHEETML
