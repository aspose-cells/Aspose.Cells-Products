...
url: /nl/python-net/merger/merge-xlsm-to-ots/ 
description: Aspose Excel. Python Excel. Voeg XLSM samen naar OTS-opslagformaat. Python Combineer XLSM naar OTS-formaat. Voeg XLSM samen met OTS in de Excel-bibliotheek Python. XLSM Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSM samen met OTS met behulp van de Excel-bibliotheek Python" %}}

Hoe voeg ik XLSM samen met OTS? Met de bibliotheek Aspose.Cells for Python via .NET kunt u XLSM eenvoudig programmatisch samenvoegen met OTS met een paar regels code.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) is in staat om platformonafhankelijke applicaties te bouwen met de mogelijkheid om alle Excel-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. Python Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardformaten. U kunt Aspose.Cells for Python via .NET installeren vanaf<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , gebruik de opdracht als:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Voeg XLSM samen met OTS in de Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u XLSM samenvoegt met OTS in Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSM samen te voegen met OTS. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een OTS-bestand. Als u code ontwikkelt in Python, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld Python waarin XLSM wordt samengevoegd met OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLSM samen te voegen met OTS in de Excel-bibliotheek Python" InputFormat="xlsm" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSM samenvoegt met OTS via de Excel-bibliotheek Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen met OTS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
