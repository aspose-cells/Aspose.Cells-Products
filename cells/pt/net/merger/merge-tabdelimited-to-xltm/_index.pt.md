---
title: Mesclar TABDELIMITED para XLTM - Combinar TABDELIMITED para XLTM em C#
url: /pt/net/merger/merge-tabdelimited-to-xltm/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita TABDELIMITED para XLTM saveformat. C# Combine TABDELIMITED para o formato XLTM. Mesclar TABDELIMITED para XLTM em C#. TABDELIMITED Mesclar.
...
O exemplo a seguir demonstra como mesclar TABDELIMITED com XLTM em Aspose.Cells for .NET.
...
{{% cells-merger title="Online grátis para mesclar TABDELIMITED para XLTM em C#" InputFormat="tsv" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar TABDELIMITED para XLTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar TABDELIMITED para XLTM programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
