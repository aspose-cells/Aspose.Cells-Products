---
title: 在 Excel 中插入/創建流程圖 via Java
weight: 360
description: 使用 Aspose.Cells' Java API 插入/創建流程圖，無需任何軟件，如 Microsoft 或 Open Office、Adobe PDF 等。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Excel 中插入/創建流程圖 via Java" h2="使用 Aspose.Cells\' API 插入/創建流程圖，無需使用 Microsoft 或 Open Office、Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將流程圖插入/創建到 Excel 文件中" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="將流程圖插入/創建到 Excel 文件的步驟 via Java" %}}
...
+ 通過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)在選定的工作表中插入/創建流程圖
以 XLSX 格式保存工作簿。
...
下面的示例代碼演示瞭如何插入“多文檔”。有關更多類型，請參閱下面的“塊箭頭形狀類型概述”。

{{% blocks/products/pf/agp/code-block title="插入/創建流程圖 - Java" offSpacer="" %}}
