---
title: 如何使用 Python via Java 在 Excel 中绘制或插入肘部形状
weight: 10
description: 使用 Aspose.Cells' Python via Java API 绘制或插入弯头形状，无需任何软件，如 Microsoft 或 Open Office、Adobe PDF 等。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="使用 Python via Java 将弯头形状插入 Excel 中" h2="使用 Aspose.Cells\' API 插入弯头形状，无需使用 Microsoft 或 Open Office、Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via Java 将弯头形状插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用 Python via Java 将弯头形状插入 Excel 文件的步骤" %}}
...
+ 通过索引选择工作表。
 + 使用形状集合[添加方法](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)以在选定的工作表中插入弯头形状。
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入弯头形状 - Python via Java" offSpacer="" %}}
