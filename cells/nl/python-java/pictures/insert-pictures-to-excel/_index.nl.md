---
title:  Voeg een afbeelding in Excel in met Java Python via
weight: 200
...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg een afbeelding in Excel in met Java Python via" h2="Voeg afbeeldingen in met Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een afbeelding in een Excel-bestand kunt invoegen met Java Python via" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om een afbeelding in een Excel-bestand in te voegen met behulp van Java Python via" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de fotocollectie[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) om een afbeelding in het geselecteerde werkblad in te voegen.
