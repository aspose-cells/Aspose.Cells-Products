...
description: Aspose Excel. Chuyển đổi XLSB sang OTS nhanh chóng và dễ dàng với Aspose.Cells. Python XLSB sang OTS. Python Lưu XLSB vào OTS. Lưu XLSB dưới dạng OTS bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSB sang OTS trong Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLSB vào OTS ở Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSB sang OTS trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLSB sang OTS" %}}
