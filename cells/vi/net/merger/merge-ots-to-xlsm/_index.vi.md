---
title: Gộp OTS thành XLSM - Gộp OTS thành XLSM vào C#
url: /vi/net/merger/merge-ots-to-xlsm/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất OTS thành XLSM saveformat. C# Kết hợp OTS thành định dạng XLSM. Hợp nhất OTS thành XLSM trong C#. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS thành XLSM trong C#" %}}

Ví dụ sau đây minh họa cách hợp nhất OTS thành XLSM trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất OTS thành XLSM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu vào tệp XLSM. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất OTS thành XLSM.
...
{{% blocks/products/pf/agp/content h2="Cách gộp OTS về XLSM qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất OTS vào XLSM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp OTS thành XLSM" %}}
