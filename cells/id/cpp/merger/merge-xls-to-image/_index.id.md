---
title: Gabungkan XLS menjadi GAMBAR - Gabungkan XLS menjadi GAMBAR di C++
url: /id/cpp/merger/merge-xls-to-image/ 
description: Aspose Unggul. C++ Aspose.Cells. Free Online Merge XLS to IMAGE saveformat. C++ Gabungkan XLS ke format GAMBAR. Gabung XLS menjadi GAMBAR di C++. XLS Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLS menjadi GAMBAR di C++ Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan XLS ke IMAGE di Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLS ke IMAGE. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file IMAGE. Jika Anda mengembangkan kode di C++, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C++ yang menggabungkan XLS ke GAMBAR.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis untuk Menggabungkan XLS menjadi GAMBAR di C++" InputFormat="xls" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLS ke GAMBAR melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLS ke IMAGE secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk menggabungkan XLS ke GAMBAR" %}}
