---
title: XLSM'i SPREADSHEETML ile birleştir - XLSM'i Python'deki SPREADSHEETML ile birleştir
url: /tr/python-java/merger/merge-xlsm-to-spreadsheetml/ 
description: Aspose Excel'de. Python Excel'de. XLSM'i SPREADSHEETML kaydetme biçimiyle birleştirin. Python XLSM'i SPREADSHEETML biçimiyle birleştirin. XLSM'i Python Excel Kitaplığı'ndaki SPREADSHEETML ile birleştirin. XLSM Birleştir.
...
{{% cells-merger title="XLSM Excel Kitaplığı\'ndaki XLSM\'i SPREADSHEETML ile Birleştirecek Örnek Kod" InputFormat="xlsm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLSM\'i Python Excel Kitaplığı aracılığıyla SPREADSHEETML ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLSM'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Python kitaplığı, XLSM\'i SPREADSHEETML ile birleştirecek" %}}
