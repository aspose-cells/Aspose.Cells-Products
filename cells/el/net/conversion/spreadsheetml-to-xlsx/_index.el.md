...
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή SPREADSHEETML σε XLSX σε C#" h2="Βιβλιοθήκη υψηλής ταχύτητας C# για τη μετατροπή SPREADSHEETML σε XLSX. Πρόκειται για μια επαγγελματική λύση λογισμικού για την εισαγωγή και εξαγωγή SPREADSHEETML, XLSX και πολλών άλλων μορφών σε πλατφόρμες .NET Framework, .NET Core ή Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
Θέλετε να μετατρέψετε αρχεία SPREADSHEETML σε XLSX μέσω προγραμματισμού; Οι προγραμματιστές .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν το SPREADSHEETML σε XLSX σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατρέψτε το αρχείο SPREADSHEETML σε XLSX καλώντας τη μέθοδο Workbook.Save.
