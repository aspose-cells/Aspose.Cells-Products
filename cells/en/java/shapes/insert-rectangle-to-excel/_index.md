---
title: Insert Rectangle into Excel via Java 
weight: 50
...
{{% blocks/products/pf/agp/content h2="How to Insert Rectangle into Excel File Using Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Rectangle to Excel file via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addRectangle-int-int-int-int-int-int-) to insert Rectangle in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert Rectangle - Java" offSpacer="" %}}
