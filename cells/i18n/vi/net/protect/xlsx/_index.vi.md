---
title: Bảo vệ và khóa tài liệu XLSX qua .NET 
weight: 90
url: /vi/net/protect/xlsx/ 
description: C# mã nguồn để khóa tệp XLSX bằng mật khẩu trên Nền tảng .NET Framework, .NET Core Mono hoặc Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa tệp XLSX qua C#" h2="Bảo vệ bảng tính Excel bằng mật khẩu bao gồm định dạng XLSX bằng cách sử dụng .NET Thư viện." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. Khởi tạo lớp Workbook với đường dẫn đến tệp XLSX1. Lấy trang tính mặc định hoặc bất kỳ Trang tính nào để thêm bảo vệ1. Bảo vệ trang tính bằng phương pháp Worksheet.Protect1. Bảo vệ Workbook với Workbook.Protect method1. Lưu kết quả ở định dạng XLSX
