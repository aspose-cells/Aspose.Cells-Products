---
title: C++ OTS ke TIFF - Konverter OTS ke TIFF
description: Aspose Unggul. Ubah OTS menjadi TIFF dengan cepat dan mudah menggunakan Aspose.Cells. C++ OTS menjadi TIFF. C++ Simpan OTS ke TIFF. Simpan OTS sebagai TIFF menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Simpan OTS ke TIFF di C++" %}}

Contoh berikut menunjukkan cara mengonversi OTS ke TIFF di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi OTS ke TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="tiff" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert OTS ke TIFF lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file OTS ke TIFF secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke TIFF hanya dalam beberapa baris kode.
...
1.  Ubah OTS menjadi TIFF dengan memanggil metode Save().
1.  Dapatkan hasil konversi OTS menjadi TIFF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah OTS menjadi TIFF" %}}
