...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLS do formatu OTS, umożliwiając bezproblemowe zapisywanie danych XLS w formacie OTS przy użyciu biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do OTS w C#" %}}
...
1.  Przekonwertuj XLS na OTS wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLS na OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XLS na OTS" %}}
