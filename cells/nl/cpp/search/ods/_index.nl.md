---
title:  Zoek naar document ODS zonder het te openen via C++
weight: 3300
description: C++ voorbeeldcode om woorden met een patroon te zoeken in het bestand ODS in de runtimeomgeving C++ voor 32-bits, 64-bits en 64-bits Linux.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zoek naar formaten met ODS in C++" h2="Native en krachtige documentzoekfunctie (ODS) met behulp van server-side API\'s (Aspose.Cells for C++), zonder gebruik te maken van software zoals (Microsoft) of Adobe (PDF)." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe zoek ik naar bestand ODS met behulp van C++?" %}}

 Om het bestand ODS te zoeken, gebruiken we...
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om bestanden met nummer ODS te zoeken in de map C++" %}}
...
+ Laad bestand ODS met behulp van de Workbook-klasse.
...
{{% blocks/products/pf/agp/code-block title="Zoek naar bestanden met nummer ODS - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online ODS Zoek live demo\'s" sectionDescription=" Zoek nu naar tekst, woorden en zinsdelen in documenten met referentienummer ODS door onze website te bezoeken.[Live demo-website](https://products.aspose.app/cells/search). De live demo heeft de volgende voordelen" >}}
