...
هل تحتاج إلى تحويل ملفات IMAGE إلى BMP برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى BMP في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى BMP باستدعاء طريقة Save ().
