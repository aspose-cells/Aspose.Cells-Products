...
url: /fr/cpp/merger/merge-xlsm-to-csv/ 
...
L'exemple suivant montre comment fusionner XLSM à CSV dans Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Besoin de fusionner XLSM à CSV par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner XLSM à CSV" %}}
