---
title: C# XLSB do XLS - XLSB do XLS Konwerter
description: Aspose Excel. Konwertuj XLSB na XLS szybko i łatwo za pomocą Aspose.Cells. C# XLSB na XLS. C# Zapisz XLSB na XLS. Zapisz XLSB jako 0761113 481 pod numerem C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB do XLS w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSB na XLS w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLSB na XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na XLS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSB na XLS? Programiści .NET mogą łatwo załadować i przekonwertować XLSB na XLS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLSB na XLS" %}}
