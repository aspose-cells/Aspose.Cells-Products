...
description: Aspose एक्सेल। C++ Aspose.Cells के साथ जल्दी और आसानी से ODS फ़ाइल बनाएं। C++ का उपयोग करके ODS फ़ाइल बनाएं। C++ में ODS बनाएं। C++ ODS क्रिएटर।
...
1.  Save() विधि का उपयोग करके कार्यपुस्तिका को .ods फ़ाइल के रूप में सहेजें।

{{% blocks/products/pf/agp/code-block title="नमूना कोड दिखाता है कि C++ में ODS फ़ाइल कैसे बनाएं।" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="ODS फ़ाइल बनाने के लिए C++ लाइब्रेरी" %}}
