---
title: PHP XLTM إلى XLT - XLTM إلى XLT محول
description: Aspose اكسل. قم بتحويل XLTM إلى XLT بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى XLT. PHP احفظ XLTM إلى XLT. احفظ XLTM كـ XLT باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى XLT عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى XLT برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى XLT بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى XLT عن طريق استدعاء طريقة حفظ المصنف.
