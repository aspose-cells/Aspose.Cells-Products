---
title: Java FODS hingga TSV - FODS hingga TSV Konverter
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi FODS ke format TSV, memungkinkan penyimpanan data FODS ke format TSV dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan FODS menjadi TSV di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi FODS ke TSV. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor FODS, TSV, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan FODS ke TSV di Java" %}}

Contoh berikut menunjukkan cara mengkonversi FODS menjadi TSV di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi FODS menjadi TSV. Unggah file FODS Anda, lalu simpan sebagai file TSV. Untuk pembacaan FODS dan penulisan TSV Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran TSV akan sama dengan dokumen FODS asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi FODS menjadi TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi FODS menjadi TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file FODS ke TSV secara terprogram? Pengembang Java dapat dengan mudah mengkonversi FODS ke TSV hanya dengan beberapa baris kode.
...
1.  Ubah FODS menjadi TSV dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari FODS menjadi TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi FODS menjadi TSV" %}}
{{% blocks/products/pf/agp/text %}}
