---
title: C# XLTX sang POWERPOINT - XLTX sang Bộ chuyển đổi POWERPOINT
description: Aspose Excel. Chuyển đổi XLTX sang POWERPOINT nhanh chóng và dễ dàng với Aspose.Cells. C# XLTX sang POWERPOINT. C# Lưu XLTX vào POWERPOINT. Lưu XLTX dưới dạng POWERPOINT bằng C#.
...
Ví dụ sau minh họa cách chuyển đổi XLTX thành POWERPOINT trong C#.
...
{{% cells-convert title="Mã mẫu chuyển đổi XLTX sang POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLTX sang POWERPOINT qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển file XLTX sang POWERPOINT theo chương trình? Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi XLTX sang POWERPOINT chỉ bằng vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện C# chuyển XLTX sang POWERPOINT" %}}
