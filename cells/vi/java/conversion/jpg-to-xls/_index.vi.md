---
title: Java JPG sang XLS - Chuyển đổi JPG sang XLS
description: Aspose Excel. Chuyển đổi JPG sang XLS nhanh chóng và dễ dàng với Aspose.Cells. Java JPG sang XLS. Java Lưu JPG thành XLS. Lưu JPG dưới dạng XLS sử dụng Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển JPG sang XLS ở Java" h2="Thư viện Java tốc độ cao để chuyển đổi JPG sang XLS. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất JPG, XLS và nhiều định dạng khác sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi JPG sang XLS Sử dụng Java" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu JPG vào XLS trong Java" %}}

Ví dụ sau đây minh họa cách chuyển đổi JPG sang XLS trong Java.
...
{{% cells-convert title="Mã mẫu chuyển đổi JPG sang XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi JPG sang XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi file JPG sang XLS theo chương trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi JPG thành XLS chỉ bằng vài dòng mã.
...
1.  Chuyển đổi JPG sang XLS bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi JPG thành XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện Java chuyển JPG sang XLS" %}}
{{% blocks/products/pf/agp/text %}}
