...
{{% cells-recovery title="App sửa file EXCEL miễn phí sử dụng .NET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" language="net" %}}
...
Aspose.Cells hoàn toàn đa nền tảng và hỗ trợ tất cả các triển khai .NET chính theo thông số kỹ thuật .NET Tiêu chuẩn 2.0:
-  .NET Framework, bắt đầu từ phiên bản 2.0 sớm nhất và kết thúc bằng .NET Framework 4.8 mới nhất.
-  .NET Core, bắt đầu từ phiên bản 2.0 sớm nhất và kết thúc bằng .NET mới nhất 6.

Theo mã .NET không phụ thuộc vào phần cứng hoặc hệ điều hành cơ bản mà chỉ phụ thuộc vào Máy ảo, bạn có thể tự do phát triển bất kỳ loại phần mềm nào cho Windows, Linux, macOS, Android và iOS. Azure và AWS Lambda cũng được hỗ trợ. Chỉ cần đảm bảo rằng bạn đã cài đặt phiên bản tương ứng của .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin.
