---
title: C# XML в PRN - Конвертер XML в PRN
description: Aspose Эксель. Преобразуйте XML в PRN быстро и легко с помощью Aspose.Cells. C# XML в PRN. C# Сохраните XML в PRN. Сохраните XML как PRN, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните XML в PRN по номеру C#." %}}

В следующем примере показано, как преобразовать XML в PRN в C#.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы преобразовать XML в PRN. Загрузите свой XML-файл, а затем просто сохраните его как файл PRN. Как для чтения XML, так и для записи PRN вы можете использовать полные имена файлов. Содержимое и форматирование выходного PRN будут идентичны исходному XML-документу.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Пример кода для преобразования XML в PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать XML в PRN по номеру C#" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно конвертировать XML-файлы в PRN? Разработчики .NET могут легко загружать и конвертировать XML в PRN всего за несколько строк кода.
...
1.  Преобразуйте XML в PRN, вызвав метод Workbook.Save.
1.  Получите результат преобразования XML в PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# библиотека для преобразования XML в PRN" %}}
