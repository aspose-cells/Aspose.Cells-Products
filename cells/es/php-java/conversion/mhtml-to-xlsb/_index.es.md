---
title: Convertidor PHP MHTML a XLSB - MHTML a XLSB
description: Aspose Excel. Convierta MHTML a XLSB rápida y fácilmente con Aspose.Cells. PHP MHTML a XLSB. PHP Guarde MHTML a XLSB. Guarde MHTML como XLSB usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MHTML a XLSB mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos MHTML a XLSB mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente MHTML a XLSB en tan solo unas pocas líneas de código.
...
1.  Convierta MHTML a XLSB llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de MHTML a XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir MHTML a XLSB" %}}
