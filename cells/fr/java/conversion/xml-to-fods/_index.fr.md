...
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le XML au format FODS, permettant un enregistrement transparent des données XML au format FODS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XML sous FODS dans Java" %}}

L'exemple suivant montre comment convertir du XML en FODS en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir du XML en FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML au format FODS par programmation ? Les développeurs Java peuvent facilement convertir un fichier XML au format FODS en quelques lignes de code seulement.
