---
title: Java PNG hingga JSON - PNG hingga JSON Konverter
description: Aspose Unggul. Java Aspose.Cells. PNG menjadi JSON di Java. Java Ubah PNG menjadi JSON format simpan. Format Java PNG hingga JSON. Simpan PNG hingga JSON Java.
...
{{% blocks/products/pf/agp/content h2="Simpan PNG hingga JSON di Java" %}}

Contoh berikut menunjukkan cara mengonversi PNG menjadi JSON di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi PNG menjadi JSON. Unggah file PNG Anda, lalu simpan sebagai file JSON. Untuk pembacaan PNG dan penulisan JSON Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran JSON akan sama dengan dokumen PNG asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi PNG menjadi JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi PNG menjadi JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PNG ke JSON secara terprogram? Pengembang Java dapat dengan mudah mengonversi PNG menjadi JSON hanya dalam beberapa baris kode.
...
1.  Dapatkan hasil konversi dari PNG menjadi JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah PNG menjadi JSON" %}}
{{% blocks/products/pf/agp/text %}}
