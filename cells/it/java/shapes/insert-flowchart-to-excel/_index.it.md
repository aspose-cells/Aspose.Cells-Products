...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire/creare un diagramma di flusso nel file Excel via Java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) per inserire/creare un diagramma di flusso nel foglio di lavoro selezionato
...
Il seguente codice di esempio illustra come inserire un "Multidocument". Per altri tipi, fare riferimento a "Panoramica dei tipi di forma di freccia a blocco" di seguito.
