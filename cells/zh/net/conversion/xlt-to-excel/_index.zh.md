---
title: C# XLT转EXCEL - 在线XLT转EXCEL转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将XLT转换为EXCEL保存格式。 C# XLT 为 EXCEL 格式。将 XLT 保存到 EXCEL C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 XLT 转换为 EXCEL C#" h2="高速C#库，用于将XLT转换为EXCEL。这是一个专业的软件解决方案，可在.NET Framework、.NET Core或Mono平台上导入和导出XLT、EXCEL和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="免费将 XLT 保存到 C# 在线 EXCEL" %}}

下面的例子演示了如何将XLT转换为EXCEL中的C#。
...
{{% cells-convert title="免费应用程序和示例代码，可在线将 XLT 转换为 EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLT 转换为 EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 文件转换为 EXCEL？ .NET 开发人员只需几行代码即可轻松加载 XLT 并将其转换为 EXCEL。
...
{{% blocks/products/pf/agp/content h2="C#库将XLT转换为EXCEL" %}}
