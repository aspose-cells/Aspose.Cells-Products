---
title: Convierta JSON a XLSM a través de la aplicación C++ 

description: Ejemplo de código de conversión C++ para documento JSON a formato XLSM. Los programadores pueden usar este código fuente para la conversión por lotes de JSON a XLSM dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JSON a XLSM usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir JSON a XLSM a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de C++ pueden convertir fácilmente un archivo JSON a XLSM con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo JSON usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (XLSM).1. El archivo XLSM se guardará en la ruta especificada.1. Abra el archivo XLSM en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de JSON a XLSM C++" offSpacer="" %}}
