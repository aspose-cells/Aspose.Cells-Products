...
{{% blocks/products/pf/agp/content h2="Konwertuj XML na TIFF, używając Python" %}}
...
Poniższy przykład ilustruje, jak przekonwertować kod XML na TIFF w Python.
