...
weight: 20
description: C# code source pour insérer ComboBox dans Excel sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Comment insérer ComboBox dans un fichier Excel à l\'aide de C#" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcombobox) pour insérer un ComboBox dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer ComboBox - C#" offSpacer="" %}}
