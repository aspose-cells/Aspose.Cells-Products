---
title: Konvertálja a SPREADSHEETML-t XLSB-re a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/spreadsheetml-to-xlsb/ 
description: Minta C++ konverziós kód a SPREADSHEETML dokumentumhoz XLSB formátumba. A programozók ezt a forráskódot használhatják a SPREADSHEETML-ből XLSB-be kötegelt konvertáláshoz bármely C++ alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML konvertálása XLSB-re a következőn keresztül: C++" h2="Nagy teljesítményű SPREADSHEETML–XLSB konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="A SPREADSHEETML konvertálása XLSB-re a következővel: C++" %}}

 A SPREADSHEETML XLSB-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A SPREADSHEETML konvertálása XLSB-re a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ fejlesztői könnyedén konvertálhatják a SPREADSHEETML-fájlt XLSB-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a SPREADSHEETML fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (XLSB) fájlkiterjesztéssel.1. Az XLSB fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az XLSB fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML-ből XLSB C++ konverziós forráskód" offSpacer="" %}}
