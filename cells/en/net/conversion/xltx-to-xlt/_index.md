...
description: Sample code for xltx to xlt C# conversion. Use API example code for batch xltx files to xlt conversion within VB.NET, Asp.NET or any .NET based application.
---
