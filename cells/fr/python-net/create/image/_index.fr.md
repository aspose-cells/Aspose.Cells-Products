---
title: Créer IMAGE - Créer un fichier IMAGE au Python
description: Aspose Excel. Python Créer un fichier IMAGE. Créer IMAGE Python. Python IMAGE Creator. Créez IMAGE en Python. Générez un fichier IMAGE en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Créer un fichier IMAGE à l\'aide de Python" %}}
 ...
 Comment créer un fichier IMAGE ? Avec Aspose.Cells for Python via la bibliothèque NET, vous pouvez facilement créer un fichier IMAGE par programmation avec quelques lignes de code.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells-python/)est capable de créer des applications multiplateformes avec la capacité de générer, modifier, convertir, rendre et imprimer tous les fichiers Excel. Python Excel API non seulement convertir entre les formats de feuille de calcul, il peut également rendre les fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans standard de l'industrie formats.
...
1.  Utilisez la méthode Enregistrer pour enregistrer le classeur en tant que fichier IMAGE.
...
{{% blocks/products/pf/agp/content h2="Python bibliothèque pour créer un fichier IMAGE" %}}
