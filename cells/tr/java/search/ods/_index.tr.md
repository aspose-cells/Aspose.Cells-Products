---
title:  ODS belgeyi açmadan arayın via Java
weight: 8140
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı üzerindeki ODS dosyasındaki kalıplı kelimeleri aramak için Java örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS Biçimlerini Java\'de arayın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Cells for Java API\'leri kullanarak yerel ve yüksek performanslı ODS belge arama." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java\'de ODS Dosyalarını Arama Adımları" %}}
...
+ Bir Çalışma Kitabı nesnesi oluşturarak ODS dosyasını yükleyin.
...
{{% blocks/products/pf/agp/code-block title="Ara ODS Dosyalar - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi ODS Canlı Demoları Arayın" sectionDescription=" ODS belgede metin, kelime, deyimleri hemen şimdi ziyaret ederek arayın.[Canlı Demolar web sitesi](https://products.aspose.app/cells/search). Canlı demo aşağıdaki avantajlara sahiptir" >}}
