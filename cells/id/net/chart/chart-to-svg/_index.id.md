---
title:  Ubah bagan menjadi SVG gambar via .NET
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi Bagan ke File SVG di C#" %}}
...
+ Buat berkas XLSX.
Dapatkan grafiknya.
+ Konversi grafik menjadi gambar SVG.
...
{{% blocks/products/pf/agp/code-block title="Ubah Bagan File XLSX menjadi gambar SVG - C#" offSpacer="" %}}
