...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 FODS 轉換為 JSON。Python FODS 為 JSON. Python 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Python。
...
以下範例示範如何將 Python via NET 中的 FODS 轉換為 JSON。
...
{{% cells-convert title="將 FODS 轉換為 JSON 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="json" IsLandingPage="true" language="pythonnet" %}}
