---
title: تحويل ODS إلى GIF عبر Java 
weight: 4810
url: /ar/java/conversion/ods-to-gif/ 
description: نموذج Java رمز تحويل لتنسيق ODS إلى ملف GIF. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel و OpenOffice إلى GIF داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ODS إلى GIF عبر Java" h2="تحويل ODS إلى GIF Java لتحويل صفحة واحدة أو عدة صفحات إلى GIF باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل ODS إلى GIF باستخدام Java" %}}

 من أجل تحويل ODS إلى GIF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل ODS إلى GIF عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف ODS إلى GIF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف ODS بنسخة من المصنف1. حدد الافتراضي أو أي ورقة عمل من المجموعة1. إنشاء وتعيين كائن ImageOrPrintOptions1. قم بإنشاء SheetRender باستخدام كائنات ورقة العمل و ImageOrPrintOptions1. طريقة Call SheetRender.toImage لحفظ النتيجة بتنسيق GIF
...
{{% blocks/products/pf/agp/code-block title="ODS إلى GIF Java رمز مصدر التحويل" offSpacer="" %}}
