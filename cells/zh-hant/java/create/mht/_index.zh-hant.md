---
title: 創建MHT - 在Java中創建MHT文件
description: Aspose Excel。 Java 創建 MHT 文件。創建 MHT Java。Java MHT 創建者。在Java中創建MHT。使用Java生成MHT文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建MHT" %}}
...
1. 使用 save() 方法將工作簿保存為 MHT 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 MHT 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java 庫創建MHT文件" %}}
{{% blocks/products/pf/agp/text %}}
