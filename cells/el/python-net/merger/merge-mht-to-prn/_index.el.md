...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση MHT σε μορφή αποθήκευσης PRN. Python Συνδυάστε τη μορφή MHT σε PRN. Συγχώνευση MHT σε PRN στο Python. MHT Merge.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση MHT με PRN στο Python" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση MHT με PRN στο Python" InputFormat="mht" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
