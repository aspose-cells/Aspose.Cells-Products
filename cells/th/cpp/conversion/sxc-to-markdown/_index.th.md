...
{{% blocks/products/pf/agp/text %}}
 ...
 นักพัฒนา C++ สามารถแปลง SXC เป็น MARKDOWN ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ SXC โดยใช้ Factory::CreateIWorkbook
1. แปลง SXC เป็น MARKDOWN โดยเรียกเมธอด Save()
