---
title: Java XLS do JSON - XLS do JSON Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu XLS do JSON, umożliwiając bezproblemowe zapisywanie danych XLS do formatu JSON za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do JSON w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na JSON w Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS na JSON? Programiści Java mogą łatwo przekonwertować pliki XLS na JSON za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj numer XLS na numer JSON, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLS na JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XLS na JSON" %}}
{{% blocks/products/pf/agp/text %}}
