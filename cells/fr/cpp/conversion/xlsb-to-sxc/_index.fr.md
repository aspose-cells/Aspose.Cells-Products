---
title: C++ XLSB à SXC - Convertisseur en ligne XLSB à SXC
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde SXC. Format C++ XLSB à SXC. Enregistrez XLSB à SXC C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à SXC dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en SXC en C++.
...
Besoin de convertir les fichiers XLSB en SXC par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en SXC en seulement quelques lignes de code.
