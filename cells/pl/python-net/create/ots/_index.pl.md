---
title: Utwórz OTS - Utwórz plik OTS w Python
description: Aspose Excel. Python Utwórz plik OTS. Utwórz OTS Python. Python Kreator OTS. Utwórz OTS w Python. Wygeneruj plik OTS, używając Python.
...
{{% blocks/products/pf/agp/content h2="Utwórz plik OTS za pomocą Python" %}}

 Jak utworzyć plik OTS? Dzięki bibliotece Aspose.Cells for Python za pośrednictwem biblioteki NET możesz łatwo programowo utworzyć plik OTS za pomocą kilku linii kodu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells-python/)jest w stanie budować wieloplatformowe aplikacje z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje między formatami arkuszy kalkulacyjnych, ale może również renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumenty w standardzie przemysłowym formaty.
