...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в формате JPG в C#" %}}

Следующий пример демонстрирует, как преобразовать FODS в JPG в файле C#.
...
1.  Преобразуйте файл FODS в формат JPG, вызвав метод Workbook.Save.
