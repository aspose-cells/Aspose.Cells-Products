---
title: Converter TABDELIMITED para TSV via Java 

description: Exemplo de código de conversão Java para o formato TABDELIMITED para arquivo TSV. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para TSV em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter TABDELIMITED para TSV via Java" h2="TABDELIMITED para conversão de TSV Java para converter uma ou várias páginas em TSV usando a biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter TABDELIMITED para TSV usando Java" %}}

 Para renderizar TABDELIMITED para TSV, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter TABDELIMITED em TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente o arquivo TABDELIMITED para TSV em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo TABDELIMITED com uma instância da classe Workbook1. Chame o método Workbook.save1. Passe o caminho de saída com a extensão TSV e SaveFormat como parâmetros1. Verifique o caminho especificado para o arquivo TSV resultante
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED para TSV Java Código-fonte de conversão" offSpacer="" %}}

```cs
// carregar o arquivo TABDELIMITED em uma instância do Workbook
Workbook book = new Workbook("template.tabdelimited");
// salvar TABDELIMITED como TSV
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED para demonstrações ao vivo de conversão de TSV" sectionDescription="[Converter TABDELIMITED para TSV](https://products.aspose.app/cells/conversion/tabdelimited-to-tsv) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo TABDELIMITED, ele será convertido instantaneamente para TSV." >}}
