---
title: รวม XLS เป็น XML - รวม XLS เป็น XML ใน C#
url: /th/net/merger/merge-xls-to-xml/ 
description: Aspose เก่ง. C# Aspose.Cells ผสานออนไลน์ฟรี XLS เป็น XML ที่บันทึกรูปแบบ C# รวม XLS เป็นรูปแบบ XML รวม XLS เป็น XML ใน C# XLS ผสาน
...
{{% blocks/products/pf/agp/content h2="รวม XLS เป็น XML ใน C# ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีผสาน XLS กับ XML ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม XLS เป็น XML อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ XML หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่รวม XLS เป็น XML
...
{{% blocks/products/pf/agp/content h2="วิธีผสาน XLS เป็น XML ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม XLS เป็น XML โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี .NET เพื่อรวม XLS เป็น XML" %}}
