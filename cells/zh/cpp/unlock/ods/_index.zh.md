...
weight: 1190
url: /zh/cpp/unlock/ods/ 
description: C++ 示例代码，用于在 Windows 32 位、Windows 64 位和 Linux 64 位的 C++ 运行时环境中解锁密码保护的 ODS 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 解锁 ODS 文件" h2="使用 C++ 库从 Excel 电子表格（包括 ODS 文件）中删除保护。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1. 使用 CreateIWorkbook 加载 ODS 锁定文件。1. 调用 Unprotect() 函数解锁。1. 使用 SetPassword 将密码设置为 NULL。1. 将 ODS 文件保存在指定位置。
