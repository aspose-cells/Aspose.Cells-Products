---
title: Mesclar MHTML para SPREADSHEETML - Combine MHTML para SPREADSHEETML em Java
url: /pt/java/merger/merge-mhtml-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Mesclagem on-line gratuita MHTML para o formato de salvamento SPREADSHEETML. Java Combine MHTML para o formato SPREADSHEETML. Mesclar MHTML para SPREADSHEETML em Java. MHTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHTML para SPREADSHEETML em Java Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar MHTML com SPREADSHEETML em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHTML para SPREADSHEETML. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo SPREADSHEETML. Se você desenvolver código em Java, isso será mais simples do que parece. Consulte o exemplo Java que mescla MHTML com SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar MHTML para SPREADSHEETML em Java" InputFormat="mhtml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHTML para SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar MHTML para SPREADSHEETML programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHTML para SPREADSHEETML" %}}
