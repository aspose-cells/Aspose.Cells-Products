...
次の例は、ODS を Aspose.Cells for .NET の XLS にマージする方法を示しています。
...
ODS をプログラムで XLS にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
