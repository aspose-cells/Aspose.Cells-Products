...
È necessario convertire i file OTS in SXC a livello di codice? Gli sviluppatori C++ possono convertire facilmente OTS in SXC in poche righe di codice.
...
1.  Converti OTS in SXC chiamando il metodo Save().
