---
title: C# EXCEL'den FODS'e - EXCEL'den FODS'e dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere EXCEL'i FODS formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak EXCEL verilerinin FODS formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL dosyasını FODS adresine C# olarak kaydedin." %}}

Aşağıdaki örnek, EXCEL dosyasını C# formatında FODS formatına nasıl dönüştüreceğinizi göstermektedir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i FODS'e dönüştürmek için kolay adımları izleyin. EXCEL dosyanızı yükleyin ve ardından FODS dosyası olarak kaydedin. Hem EXCEL okuma hem de FODS yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı FODS içeriği ve formatı orijinal EXCEL belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Excel dosyasını FODS\'e dönüştürmek için örnek kod." formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C# aracılığıyla FODS\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını programlı olarak FODS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip FODS'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını FODS formatına dönüştürün.
1.  EXCEL'in FODS'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i FODS\'e dönüştürmek için C# kütüphanesi" %}}
