---
title:  Водяной знак ODS документ via Java
weight: 1040
description: Пример кода Java для добавления или удаления водяного знака в файле ODS в среде выполнения Java для приложений JSP/JSF и настольных приложений.
...
{{< blocks/products/pf/i18n/upper-banner h1="Добавьте текстовый водяной знак на номер ODS via Java." h2="Создавайте свои собственные приложения Java, добавляя водяные знаки в файлы ODS, используя серверные API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по добавлению водяного знака на номер ODS via Java" %}}
...
1.  Сохраните книгу в формате ODS.
...
{{% blocks/products/pf/agp/code-block title="Добавьте водяной знак к номерам ODS - Java." offSpacer="" %}}
