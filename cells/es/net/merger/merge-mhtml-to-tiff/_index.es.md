---
title: Combinar MHTML a TIFF - Combinar MHTML a TIFF en C#
url: /es/net/merger/merge-mhtml-to-tiff/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea MHTML a TIFF guardar formato. C# Combina el formato MHTML con el TIFF. Combinar MHTML a TIFF en C#. MHTML Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine MHTML a TIFF en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar MHTML con TIFF en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar MHTML a TIFF. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo TIFF. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina MHTML con TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar MHTML a TIFF en C#" InputFormat="mhtml" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar MHTML a TIFF a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar MHTML con TIFF mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar MHTML a TIFF" %}}
