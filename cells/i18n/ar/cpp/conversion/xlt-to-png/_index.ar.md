---
title: قم بتحويل XLT إلى PNG عبر تطبيق C++ 
url: /ar/cpp/conversion/xlt-to-png/ 
description: نموذج C++ كود التحويل لمستند XLT إلى تنسيق PNG. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLT إلى PNG دفعة داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLT إلى PNG عبر C++" h2="تحويل XLT إلى PNG عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLT إلى PNG باستخدام C++" %}}

 من أجل تحويل XLT إلى PNG ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLT إلى PNG عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ بسهولة تحويل ملف XLT إلى PNG في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLT باستخدام Factory :: CreateIWorkbook.1. حدد ورقة العمل الأولى.1. اضبط خيارات (PNG).1. كرر خلال كل صفحة من الورقة وعرضها.1. افتح ملف PNG في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLT إلى PNG C++ شفرة مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل XLT إلى PNG" sectionDescription="[تحويل XLT إلى PNG](https://products.aspose.app/cells/conversion/xlt-to-png) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف XLT الخاص بك ، وسيتم تحويله على الفور إلى PNG." >}}
