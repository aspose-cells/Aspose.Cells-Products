...
{{< blocks/products/pf/i18n/upper-banner h1="Шифровать файлы XLSM с помощью Java" h2="Защищайте паролем электронные таблицы Excel, включая формат XLSM, с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по защите файлов XLSM с помощью Java" %}}
...
1. Загрузите файл XLSM, создав экземпляр класса Workbook1. Используйте метод Protect(..) с ProtectionType и Password1. Сохраните защищенный файл XLSM с помощью метода save().
