---
title: 通过 C++ 应用程序将 CSV 转换为 TABDELIMITED 
url: /zh/cpp/conversion/csv-to-tabdelimited/ 
description: CSV 文档到 TABDELIMITED 格式的示例 C++ 转换代码。程序员可以在任何 C++ 应用程序中使用此源代码进行批量 CSV 到 TABDELIMITED 的转换。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将 CSV 转换为 TABDELIMITED" h2="使用 C++ 库的高性能 CSV 到 TABDELIMITED 转换，无需安装 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 开发人员只需几行代码即可轻松地将 CSV 文件转换为 TABDELIMITED。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 CSV 文件。1. 调用 Save() 方法。1. 传递带有 (TABDELIMITED) 文件扩展名的输出文件路径。1. TABDELIMITED 文件将保存在指定路径。1. 在兼容程序中打开 TABDELIMITED 文件。
...
{{% blocks/products/pf/agp/code-block title="CSV 到 TABDELIMITED C++ 转换源代码" offSpacer="" %}}
