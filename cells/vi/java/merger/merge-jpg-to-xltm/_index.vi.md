---
title: Gộp JPG thành XLTM - Gộp JPG thành XLTM vào Java
url: /vi/java/merger/merge-jpg-to-xltm/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất JPG thành XLTM saveformat. Java Kết hợp JPG thành định dạng XLTM. Hợp nhất JPG thành XLTM trong Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất JPG thành XLTM trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất JPG thành XLTM trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất JPG thành XLTM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu vào tệp XLTM. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất JPG thành XLTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu ghép JPG thành XLTM trong Java" InputFormat="jpg" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép JPG thành XLTM via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java ghép JPG thành XLTM" %}}
