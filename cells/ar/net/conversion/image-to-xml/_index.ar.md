---
title: C# صورة إلى XML - صورة لتحويل XML
description: Aspose اكسل. C# Aspose.Cells. IMAGE إلى XML في C#. C# تحويل IMAGE إلى تنسيق حفظ XML. C# صورة إلى تنسيق XML. احفظ الصورة في XML C#.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في XML في C#" %}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الصورة إلى XML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى XML برمجياً؟ يمكن للمطورين .NET تحميل وتحويل IMAGE إلى XML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل IMAGE إلى XML عن طريق استدعاء أسلوب Workbook.Save.
1. احصل على نتيجة تحويل IMAGE إلى XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى XML" %}}
