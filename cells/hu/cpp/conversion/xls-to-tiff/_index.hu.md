---
title: Konvertálja az XLS-t TIFF-re a(z) C++ alkalmazással 
weight: 3550
url: /hu/cpp/conversion/xls-to-tiff/ 
description: Minta C++ konverziós kód XLS-dokumentumhoz TIFF formátumba. A programozók ezt a forráskódot használhatják kötegelt XLS-TIFF konvertáláshoz bármely C++ alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS konvertálása TIFF-re a következőn keresztül: C++" h2="Nagy teljesítményű XLS-TIFF konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatnak XLS-fájlt TIFF-formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS fájlt a Factory::CreateIWorkbook segítségével.1. Válassza ki az első munkalapot.1. Állítsa be a (TIFF) opciókat.1. Ismételje meg a lap minden oldalát, és jelenítse meg.1. Nyissa meg a TIFF fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLS-ből TIFF-be C++ konverziós forráskód" offSpacer="" %}}
