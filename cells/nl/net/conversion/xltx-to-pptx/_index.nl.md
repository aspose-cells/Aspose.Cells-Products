---
title: C# XLTX tot PPTX - XLTX tot PPTX Converter
description: Aspose Excel. Deze uitgebreide oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van gegevens van het formaat XLTX naar PPTX, waardoor naadloos opslaan van gegevens in het formaat XLTX mogelijk is met behulp van de bibliotheek Aspose.Cells, allemaal via efficiënte en aanpasbare code C#.
...
{{% blocks/products/pf/agp/content h2="Sla XLTX op in PPTX in C#" %}}

Het volgende voorbeeld laat zien hoe je XLTX omzet naar PPTX in C#.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLTX naar PPTX te converteren. Upload uw XLTX-bestand en sla het vervolgens eenvoudig op als PPTX-bestand. Voor zowel XLTX lezen als PPTX schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De inhoud en opmaak van de uitvoer PPTX zullen identiek zijn aan het originele document XLTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Voorbeeldcode om XLTX naar PPTX te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltx" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLTX naar PPTX kunt converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLTX-bestanden programmatisch naar PPTX converteren? .NET-ontwikkelaars kunnen XLTX eenvoudig in slechts een paar regels code laden en converteren naar PPTX.
...
1.  Converteer XLTX naar PPTX door de Workbook.Save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van XLTX naar PPTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliotheek om XLTX naar PPTX te converteren" %}}
