...
description: Aspose Excel'de. C++ Aspose.Cells ile hızlı ve kolay bir şekilde SVG Dosyası oluşturun. C++'i kullanarak SVG dosyası oluşturun. C++'de SVG oluşturun. C++ SVG Oluşturucu.
...
1.  Save() yöntemini kullanarak çalışma kitabını .svg dosyası olarak kaydedin.
