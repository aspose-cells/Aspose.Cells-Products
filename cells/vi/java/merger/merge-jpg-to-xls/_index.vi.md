---
title: Hợp nhất JPG thành XLS - Hợp nhất JPG thành XLS trong Java
url: /vi/java/merger/merge-jpg-to-xls/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí JPG thành XLS định dạng lưu. Java Gộp định dạng JPG thành XLS. Hợp nhất JPG thành XLS trong Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất JPG với XLS trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất JPG thành XLS trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất JPG thành XLS. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp, sau đó lưu vào tệp XLS. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất JPG thành XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất JPG thành XLS trong Java" InputFormat="jpg" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất JPG thành XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất JPG thành XLS theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất JPG thành XLS" %}}
