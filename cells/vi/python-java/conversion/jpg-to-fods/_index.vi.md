---
title: Python JPG sang FODS - Bộ chuyển đổi JPG sang FODS trực tuyến
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Trực tuyến miễn phí Python Chuyển đổi JPG sang định dạng lưu FODS. Python Định dạng JPG đến FODS. Lưu JPG vào FODS Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển JPG sang FODS trong Python" h2="Thư viện Python chuyển đổi JPG sang FODS tốc độ cao. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất JPG, FODS và nhiều định dạng khác sử dụng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi JPG sang FODS bằng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu JPG vào FODS trong Python Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi JPG thành FODS trong Python.
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi JPG sang FODS qua Python" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi các tệp JPG thành FODS theo chương trình? Python nhà phát triển có thể dễ dàng tải và chuyển đổi JPG thành FODS chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi JPG thành FODS bằng cách gọi phương thức Workbook.save.
1.  Lấy kết quả chuyển đổi từ JPG sang FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python thư viện chuyển JPG sang FODS" %}}
