---
title: "TXT-dokumentum keresése megnyitás nélkül a következőn keresztül: C++ "
weight: 5090
url: /hu/cpp/search/txt/ 
description: C++ példakód a TXT-fájl mintájú szavak kereséséhez a C++ Runtime Environment for Windows 32 bit, Windows 64 bit és a Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TXT formátumok keresése itt: C++" h2="Natív és nagy teljesítményű TXT-dokumentumkeresés a szerveroldali Aspose.Cells használatával C++ API-khoz, bármilyen szoftver, például Microsoft vagy Adobe PDF használata nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
+ TXT fájl betöltése egy IWorkbook osztály példányosításával.
...
+ TXT fájl mentése az IWorkbook->Save(.) metódussal.
