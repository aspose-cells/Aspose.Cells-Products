---
title: Java FODS naar MD - FODS naar MD-converter
description: Aspose Excel. Converteer FODS snel en eenvoudig naar MD met Aspose.Cells. Java FODS naar MD. Java Bewaar FODS op MD. Sla FODS op als MD met behulp van Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer FODS naar MD in Java" h2="Snelle bibliotheek Java voor het converteren van FODS naar MD. Dit is een professionele softwareoplossing voor het importeren en exporteren van FODS, MD en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Sla FODS op in MD in Java" %}}

Het volgende voorbeeld laat zien hoe u FODS naar MD converteert in Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om FODS naar MD te converteren. Upload uw FODS-bestand en sla het vervolgens eenvoudig op als MD-bestand. Voor zowel FODS lezen als MD schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De inhoud en opmaak van de uitvoer-MD zullen identiek zijn aan het originele FODS-document.
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar MD via Java te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u FODS-bestanden programmatisch naar MD converteren? Java-ontwikkelaars kunnen FODS eenvoudig met slechts een paar regels code naar MD converteren.
...
1.  Converteer FODS naar MD door de Workbook.save-methode aan te roepen.
