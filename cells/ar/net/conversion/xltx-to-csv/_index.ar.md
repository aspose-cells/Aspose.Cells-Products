---
title: C# XLTX إلى CSV - عبر الإنترنت من XLTX إلى CSV
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل XLTX إلى CSV saveformat. C# XLTX إلى تنسيق CSV. وفر XLTX إلى CSV C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل XLTX إلى CSV في C#" h2="مكتبة C# عالية السرعة لتحويل XLTX إلى CSV. هذا حل برمجي احترافي لاستيراد وتصدير XLTX و CSV والعديد من التنسيقات الأخرى على .NET Framework أو .NET Core أو Mono الأنظمة الأساسية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
تحتاج إلى تحويل XLTX ملفات إلى CSV برمجيا؟ يمكن للمطورين .NET تحميل وتحويل XLTX إلى CSV بسهولة في بضعة أسطر من التعليمات البرمجية.
