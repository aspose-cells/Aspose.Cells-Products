...
description: Sample code for ods to xlam C# conversion. Use API example code for batch ods files to xlam conversion within VB.NET, Asp.NET or any .NET based application.
---
