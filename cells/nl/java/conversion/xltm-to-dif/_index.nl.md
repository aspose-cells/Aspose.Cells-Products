---
title: Converteer XLTM naar DIF via Java 
weight: 6620

description: Voorbeeld Java conversiecode voor XLTM-indeling naar DIF-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar DIF te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLTM naar DIF via Java" h2="XLTM naar DIF Java-conversie om enkele of meerdere pagina\'s naar DIF te converteren met behulp van een lokale bibliotheek Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe XLTM naar DIF te converteren met Java" %}}

 Om XLTM naar DIF te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLTM naar DIF te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen XLTM-bestanden gemakkelijk converteren naar DIF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad XLTM-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met DIF-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende DIF-bestand
...
{{% blocks/products/pf/agp/code-block title="XLTM naar DIF Java Conversiebroncode" offSpacer="" %}}
