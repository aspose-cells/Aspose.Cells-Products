...
description: Sample C++ conversion code for HTML to SPREADSHEETML format. Programmers can use this source code for batch HTML to SPREADSHEETML conversion within any C++ Application.
---
