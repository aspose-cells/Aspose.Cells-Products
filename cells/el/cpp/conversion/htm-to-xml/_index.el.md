...
C++ οι προγραμματιστές μπορούν εύκολα να μετατρέψουν το HTM σε XML σε λίγες μόνο γραμμές κώδικα.
