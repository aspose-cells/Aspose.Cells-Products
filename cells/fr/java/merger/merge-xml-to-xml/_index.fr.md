---
title: Fusionner XML vers XML - Combiner XML vers XML dans Java
url: /fr/java/merger/merge-xml-to-xml/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite XML au format de sauvegarde XML. Java Combinez le format XML au format XML. Fusionner XML en XML dans Java. Fusion XML.
...
{{% blocks/products/pf/agp/content h2="Fusionner XML à XML dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner XML vers XML dans Aspose.Cells for Java.
...
{{% cells-merger title="Gratuit en ligne pour fusionner XML en XML en Java" InputFormat="xml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XML en XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XML à XML par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner XML en XML" %}}
