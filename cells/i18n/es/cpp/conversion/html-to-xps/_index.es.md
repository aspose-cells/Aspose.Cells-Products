---
title: Convierta HTML a XPS a través de la aplicación C++ 
weight: 1420
url: /es/cpp/conversion/html-to-xps/ 
description: Ejemplo de código de conversión C++ para documento HTML a formato XPS. Los programadores pueden usar este código fuente para la conversión por lotes de HTML a XPS dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta HTML a XPS a través de C++" h2="Conversión de HTML a XPS de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo HTML a XPS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo HTML usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (XPS).1. El archivo XPS se guardará en la ruta especificada.1. Abra el archivo XPS en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de HTML a XPS C++" offSpacer="" %}}
