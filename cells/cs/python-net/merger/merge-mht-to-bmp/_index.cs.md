...
url: /cs/python-net/merger/merge-mht-to-bmp/ 
...
Následující příklad ukazuje, jak sloučit MHT s BMP v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit MHT na BMP programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
