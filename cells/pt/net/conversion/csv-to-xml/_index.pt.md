---
title: C# CSV para XML - CSV para conversor XML
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter CSV para o formato XML, permitindo o salvamento perfeito de dados CSV em formato XML usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salvar CSV em XML em C#" %}}

O exemplo a seguir demonstra como converter CSV para XML em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter CSV em XML. Carregue seu arquivo CSV e simplesmente salve-o como arquivo XML. Para leitura de CSV e gravação de XML, você pode usar nomes de arquivos completos. O conteúdo e a formatação XML de saída serão idênticos ao documento CSV original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter CSV em XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="csv" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter CSV para XML via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos CSV em XML programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter CSV em XML em apenas algumas linhas de código.
...
1.  Converta CSV para XML chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de CSV para XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter CSV em XML" %}}
