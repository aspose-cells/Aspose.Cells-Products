---
title:  Sloučit HTM na DOCX přes C++
url: /cs/cpp/merger/merge-htm-to-docx/ 
description: Sloučit HTM na DOCX Online zdarma. Bezplatné online spojení HTM na DOCX. Sloučit HTM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit HTM s DOCX v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení HTM na DOCX online" InputFormat="htm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
