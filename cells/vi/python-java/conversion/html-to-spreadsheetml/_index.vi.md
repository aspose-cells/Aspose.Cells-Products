...
{{% blocks/products/pf/agp/content h2="Chuyển đổi HTML thành SPREADSHEETML bằng cách sử dụng Python" %}}
...
Ví dụ sau đây minh họa cách chuyển đổi HTML thành SPREADSHEETML trong Python.
