---
title: Java ODS na HTM - ODS na konwerter HTM
description: Aspose Excel. Szybko i łatwo przekonwertuj ODS na HTM za pomocą Aspose.Cells. Java ODS na HTM. Java Zapisz ODS w HTM. Zapisz ODS jako HTM, używając Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ODS na HTM w Java" h2="Szybka biblioteka Java do konwersji ODS do HTM. Jest to profesjonalne oprogramowanie do importowania i eksportowania ODS, HTM i wielu innych formatów przy użyciu Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Zapisz ODS w HTM w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować ODS na HTM w Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować ODS na HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki ODS na HTM? Programiści Java mogą z łatwością przekonwertować ODS na HTM w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj ODS na HTM, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji ODS na HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji ODS do HTM" %}}
{{% blocks/products/pf/agp/text %}}
