...
weight: 10
description: C# codice sorgente per inserire il controllo ActiveX in Excel su .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Come inserire un controllo ActiveX in un file Excel utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire il controllo ActiveX nel file Excel tramite C#" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addActiveXControl) per inserire un controllo ActiveX nel foglio di lavoro selezionato
