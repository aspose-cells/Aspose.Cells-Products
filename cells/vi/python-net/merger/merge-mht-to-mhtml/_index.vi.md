---
title: Gộp MHT thành MHTML - Gộp MHT thành MHTML trong Python
url: /vi/python-net/merger/merge-mht-to-mhtml/ 
description: Aspose Excel. Python Aspose.Cells. Hợp nhất trực tuyến miễn phí MHT thành MHTML saveformat. Python Gộp định dạng MHT thành MHTML. Hợp nhất MHT thành MHTML thành Python. Hợp nhất MHT.
...
Ví dụ sau minh họa cách hợp nhất MHT thành MHTML trong Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Trực tuyến miễn phí để hợp nhất MHT thành MHTML trong Python" InputFormat="mht" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất MHT thành MHTML qua Python" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất MHT thành MHTML theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API có thể được thực hiện chỉ với vài dòng mã.
