...
{{% blocks/products/pf/agp/content h2="Como inserir comentários no arquivo XLSX via C#" %}}
...
No Office 365, os comentários são para conversas, você pode usar o seguinte código C# para inserir e remover comentários no arquivo XLSX.

{{% blocks/products/pf/agp/code-block title="C# código de amostra para inserir e remover comentários no arquivo XLSX" offSpacer="" %}}
