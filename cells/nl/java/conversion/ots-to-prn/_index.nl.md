---
title: Java OTS naar PRN - OTS naar PRN-converter
description: Aspose Excel. Converteer OTS snel en eenvoudig naar PRN met Aspose.Cells. Java OTS naar PRN. Java OTS opslaan in PRN. Sla OTS op als PRN met Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer OTS naar PRN in Java" h2="Snelle Java-bibliotheek voor het converteren van OTS naar PRN. Dit is een professionele softwareoplossing voor het importeren en exporteren van OTS, PRN en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Sla OTS op in PRN in Java" %}}

Het volgende voorbeeld laat zien hoe u OTS naar PRN converteert in Java.
...
Wilt u OTS-bestanden programmatisch naar PRN converteren? Java-ontwikkelaars kunnen OTS eenvoudig in slechts een paar regels code naar PRN converteren.
