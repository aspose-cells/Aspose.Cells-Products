...
description: Aspose Unggul. C# Aspose.Cells. Gabungkan MHT ke format penyimpanan POWERPOINT. C# Gabungkan format MHT ke POWERPOINT. Gabungkan MHT ke POWERPOINT di C#. Gabungkan MHT.
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHT ke POWERPOINT Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHT ke POWERPOINT di C#" %}}

Contoh berikut menunjukkan cara menggabungkan MHT ke POWERPOINT di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan MHT ke POWERPOINT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file POWERPOINT. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan MHT ke POWERPOINT.
...
Perlu menggabungkan MHT ke POWERPOINT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan MHT ke POWERPOINT" %}}
