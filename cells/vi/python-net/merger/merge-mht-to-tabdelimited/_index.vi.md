...
url: /vi/python-net/merger/merge-mht-to-tabdelimited/ 
...
Ví dụ sau minh họa cách hợp nhất MHT với TABDELIMITED trong Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Cần hợp nhất MHT với TABDELIMITED theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API có thể được thực hiện chỉ với vài dòng mã.
