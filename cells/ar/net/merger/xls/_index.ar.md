---
title:  دمج XLS الملفات via .NET
weight: 3000
description: C# كود المصدر لدمج وثائق XLS على .NET Framework أو .NET Core أو Mono أو منصات Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="دمج XLS تنسيقات في C#" h2="دمج مستندات XLS أصلي وعالي الأداء باستخدام واجهات برمجة تطبيقات Aspose.Cells for .NET من جانب الخادم ، دون استخدام أي برنامج مثل Microsoft أو Open Office ، Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
+ قم بتحميل جميع ملفات XLS بالمسار الكامل.
+ اصنع مستندًا واحدًا كملف أساسي
+ استدعاء الطريقة المناسبة لدمج ودمج الملفات واحدًا تلو الآخر.
+ استدعاء طريقة Save () ومرر اسم الملف (المسار الكامل) والتنسيق (XLS) كمعامل.
+ الآن يمكنك فتح واستخدام ملف XLS في Microsoft Office أو Adobe PDF أو أي برنامج آخر متوافق.
...
{{% blocks/products/pf/agp/code-block title="دمج XLS الملفات - C#" offSpacer="" %}}
