---
title: C# IMAGE to ET - محول IMAGE إلى ET
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل IMAGE إلى تنسيق ET، مما يتيح حفظ بيانات IMAGE بسلاسة بتنسيق ET باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في ET في C#" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى ET في C#.
...
{{% cells-convert title="نموذج كود لتحويل الصورة إلى ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى ET عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى ET برمجياً؟ يمكن للمطورين .NET تحميل وتحويل IMAGE إلى ET بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الصورة إلى ET عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الصور إلى ET" %}}
