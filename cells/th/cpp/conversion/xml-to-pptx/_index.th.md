...
description: Aspose เอ็กเซล. แปลง XML เป็น PPTX อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XML เป็น PPTX C++ บันทึก XML เป็น PPTX บันทึก XML เป็น PPTX โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XML เป็น PPTX ใน C++" %}}
...
1.  แปลง XML เป็น PPTX โดยการเรียกเมธอด Save()
