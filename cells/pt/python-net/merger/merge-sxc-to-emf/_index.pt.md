...
description: Aspose Excel. Python Excel. Mesclar SXC com EMF salvar formato. Python Combine o formato SXC com EMF. Mesclar SXC com EMF na Biblioteca Excel Python. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC a EMF usando a biblioteca Python do Excel" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC com EMF na Biblioteca Excel Python" %}}

exemplo a seguir demonstra como mesclar SXC com EMF em Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Exemplo de código para mesclar SXC a EMF na biblioteca Python do Excel" InputFormat="sxc" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC a EMF por meio da biblioteca Python Excel" %}}
