---
title: 創建DIF - 在Java中創建DIF文件
description: Aspose Excel。 Java 創建 DIF 文件。創建DIF Java。Java DIF創建者。在Java中創建DIF。使用Java生成DIF文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建DIF" %}}
...
1. 使用 save() 方法將工作簿保存為 DIF 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 DIF 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建DIF文件" %}}
{{% blocks/products/pf/agp/text %}}
