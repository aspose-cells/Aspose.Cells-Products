---
title: PHP PRN - SXC - PRN - SXC konvertáló
description: Aspose Excel. A PRN-t gyorsan és egyszerűen konvertálja SXC-re a Aspose.Cells-gyel. PHP PRN-t SXC-re. PHP PRN mentése SXC-re. PRN mentése SXC-re PHP használatával.
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet a PRN-t SXC-re konvertálni PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A PRN-fájlokat programozottan SXC-re kell konvertálni? A PHP fejlesztői könnyedén betölthetik és konvertálhatják a PRN-t SXC-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a PRN-t SXC-re a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a PRN SXC számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a PRN SXC-re való konvertálásához" %}}
