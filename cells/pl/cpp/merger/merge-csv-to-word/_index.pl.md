...
Poniższy przykład pokazuje, jak połączyć CSV z WORD w Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć CSV z WORD? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
