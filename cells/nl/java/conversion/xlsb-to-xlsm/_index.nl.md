...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in XLSM in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar XLSM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar XLSM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar XLSM? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar XLSM met slechts een paar regels code.
