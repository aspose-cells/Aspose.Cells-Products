...
description:  C# códigos-fonte que ensinam a inserir uma forma em Microsoft arquivos do Excel usando a biblioteca .NET.
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/i18n/feature-page-header h1="Microsoft<sup>&reg;</sup> Inserção de formas do Excel via .NET" h2="Crie documentos do Excel e insira formas usando APIs do lado do servidor em aplicativos baseados em .NET." >}}
