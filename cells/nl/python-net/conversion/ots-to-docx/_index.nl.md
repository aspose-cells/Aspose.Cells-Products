...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar DOCX met Aspose.Cells. Python OTS naar DOCX. Python Bewaar OTS naar DOCX. Sla OTS op als DOCX met Python.
...
{{% blocks/products/pf/agp/content h2="OTS converteren naar DOCX" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar DOCX converteren? Python-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar DOCX in slechts een paar regels code.
...
1.  Converteer OTS naar DOCX door de Workbook.save-methode aan te roepen.
