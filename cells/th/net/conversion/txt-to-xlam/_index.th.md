---
title: C# TXT ถึง XLAM - ออนไลน์ TXT ถึง XLAM Converter
description: Aspose เก่ง. C# Aspose.Cells C# Aspose Cells ออนไลน์ฟรี C# แปลง TXT เป็น XLAM บันทึกรูปแบบ รูปแบบ C# TXT ถึง XLAM บันทึก TXT ถึง XLAM C#
...
{{% blocks/products/pf/agp/content h2="บันทึก TXT ถึง XLAM ใน C# ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง TXT เป็น XLAM ใน C#
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อแปลง TXT เป็น XLAM อัปโหลดไฟล์ TXT ของคุณ จากนั้นบันทึกเป็นไฟล์ XLAM สำหรับทั้งการอ่าน TXT และการเขียน XLAM คุณสามารถใช้ชื่อไฟล์แบบเต็มได้ เนื้อหาและการจัดรูปแบบเอาต์พุต XLAM จะเหมือนกับเอกสารต้นฉบับ TXT

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="แอพฟรีและโค้ดตัวอย่างเพื่อแปลง TXT เป็น XLAM ออนไลน์" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="xlam" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="วิธีแปลง TXT เป็น XLAM ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการแปลงไฟล์ TXT เป็น XLAM โดยทางโปรแกรมหรือไม่ นักพัฒนา .NET สามารถโหลดและแปลง TXT เป็น XLAM ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง TXT เป็น XLAM โดยเรียกวิธี Workbook.Save
1.  รับผลการแปลงของ TXT เป็น XLAM

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ไลบรารี C# เพื่อแปลง TXT เป็น XLAM" %}}
