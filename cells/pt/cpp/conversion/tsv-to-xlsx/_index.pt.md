---
title: Converter TSV para XLSX por meio do aplicativo C++ 
weight: 7330
url: /pt/cpp/conversion/tsv-to-xlsx/ 
description: Exemplo de código de conversão C++ de documento TSV para formato XLSX. Os programadores podem usar esse código-fonte para conversão em lote de TSV para XLSX em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter TSV para XLSX via C++" h2="Conversão de TSV para XLSX de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem converter facilmente arquivos TSV para XLSX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo TSV usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (XLSX).1. O arquivo XLSX será salvo no caminho especificado.1. Abra o arquivo XLSX em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de TSV para XLSX C++" offSpacer="" %}}
