---
title: C# IMAGE إلى PNG - محول IMAGE عبر الإنترنت إلى PNG
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل الصورة إلى PNG saveformat. C# IMAGE إلى تنسيق PNG. احفظ الصورة في PNG C#.
...
{{% blocks/products/pf/agp/content h2="احفظ IMAGE في PNG في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى PNG في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى PNG عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى PNG برمجيًا؟ يمكن للمطورين .NET تحميل وتحويل IMAGE إلى PNG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى PNG" %}}
