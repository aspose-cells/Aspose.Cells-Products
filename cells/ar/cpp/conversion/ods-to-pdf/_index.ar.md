...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ODS إلى PDF عبر C++" h2="تحويل ODS إلى PDF عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل ODS إلى PDF باستخدام C++" %}}

 من أجل تحويل ODS إلى PDF ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل ODS إلى PDF عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ بسهولة تحويل ملف ODS إلى PDF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف ODS باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد ملف (PDF).1. سيتم حفظ ملف PDF في المسار المحدد.1. افتح ملف PDF في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="ODS to PDF C++ كود مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل ODS إلى PDF" sectionDescription="[تحويل ODS إلى PDF](https://products.aspose.app/cells/conversion/ods-to-pdf) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف ODS الخاص بك ، وسيتم تحويله على الفور إلى PDF." >}}
