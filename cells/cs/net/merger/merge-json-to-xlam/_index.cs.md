...
url: /cs/net/merger/merge-json-to-xlam/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit JSON do XLAM uložit formát. C# Kombinujte formát JSON až XLAM. Sloučit JSON až XLAM v C#. JSON Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JSON až XLAM v C#" %}}

Následující příklad ukazuje, jak sloučit JSON až XLAM v Aspose.Cells for .NET.
...
{{% cells-merger title="Ukázkový kód pro sloučení JSON až XLAM v C#" InputFormat="json" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON na XLAM přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JSON až XLAM? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení JSON až XLAM" %}}
