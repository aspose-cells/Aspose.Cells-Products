---
title: Konversi XLSM ke ODS melalui C++ aplikasi 
url: /id/cpp/conversion/xlsm-to-ods/ 
description: Contoh C++ kode konversi untuk dokumen XLSM ke format ODS. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLSM ke ODS dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi XLSM ke ODS melalui C++" h2="Konversi XLSM ke ODS berperforma tinggi menggunakan pustaka C++ tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLSM ke ODS hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLSM menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (ODS).1. File ODS akan disimpan di jalur yang ditentukan.1. Buka file ODS di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLSM ke ODS C++ Kode Sumber Konversi" offSpacer="" %}}
