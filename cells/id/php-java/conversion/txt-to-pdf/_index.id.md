---
title: Konverter PHP TXT hingga PDF - TXT hingga PDF
description: Aspose Unggul. Ubah TXT menjadi PDF dengan cepat dan mudah dengan Aspose.Cells. PHP TXT menjadi PDF. PHP Simpan TXT menjadi PDF. Simpan TXT sebagai PDF menggunakan PHP.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah TXT menjadi PDF melalui PHP" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file TXT ke PDF secara terprogram? Pengembang PHP dapat dengan mudah memuat & mengonversi TXT menjadi PDF hanya dalam beberapa baris kode.
...
1.  Ubah TXT menjadi PDF dengan memanggil metode simpan Buku Kerja.
1.  Dapatkan hasil konversi dari TXT menjadi PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Pustaka PHP untuk mengonversi TXT menjadi PDF" %}}
