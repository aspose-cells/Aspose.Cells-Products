---
title: تحويل SPREADSHEETML إلى MHTML عبر تطبيق C++ 
url: /ar/cpp/conversion/spreadsheetml-to-mhtml/ 
description: نموذج رمز تحويل C++ لمستند SPREADSHEETML إلى تنسيق MHTML. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل SPREADSHEETML دفعة واحدة إلى MHTML داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل SPREADSHEETML إلى MHTML عبر C++" h2="SPREADSHEETML عالي الأداء لتحويل MHTML باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل SPREADSHEETML إلى MHTML باستخدام C++" %}}
 ...
 من أجل تحويل SPREADSHEETML إلى MHTML ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوّري برامج C++ تحويل ملف SPREADSHEETML بسهولة إلى MHTML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف SPREADSHEETML باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (MHTML).1. سيتم حفظ ملف MHTML في المسار المحدد.1. افتح ملف MHTML في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML إلى شفرة مصدر تحويل MHTML C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML إلى عروض توضيحية مباشرة لتحويل MHTML" sectionDescription="[تحويل SPREADSHEETML إلى MHTML](https://products.aspose.app/cells/conversion/spreadsheetml-to-mhtml) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف SPREADSHEETML الخاص بك ، وسيتم تحويله على الفور إلى MHTML." >}}
