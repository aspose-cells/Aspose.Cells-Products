---
title:  Ekle veya Kaldır XLSM Ek Açıklama via .NET
weight: 9890
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSM biçim ek açıklamalarını eklemek ve silmek için C# kaynak kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM\'den C#\'e Ek Açıklama Ekleme veya Silme" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSM - C#\'den Ek Açıklamaları Sil" offSpacer="" %}}
