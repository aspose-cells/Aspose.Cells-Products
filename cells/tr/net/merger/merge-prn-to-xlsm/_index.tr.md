...
url: /tr/net/merger/merge-prn-to-xlsm/ 
...
Aşağıdaki örnek, PRN'nin Aspose.Cells for .NET'deki XLSM ile nasıl birleştirileceğini gösterir.
...
PRN'yi programlı olarak XLSM ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi XLSM ile birleştirmek için .NET kitaplığı" %}}
