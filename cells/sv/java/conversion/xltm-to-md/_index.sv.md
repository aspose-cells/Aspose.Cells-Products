---
title: Konvertera XLTM till MD via Java 
url: /sv/java/conversion/xltm-to-md/ 
description: Exempel på Java-konverteringskod för XLTM-format till MD-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till MD inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLTM till MD med Java" %}}

 För att rendera XLTM till MD kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLTM till MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLTM-fil till MD på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTM-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med MD-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande MD-filen
...
{{% blocks/products/pf/agp/code-block title="XLTM till MD Java omvandlingskällkod" offSpacer="" %}}
