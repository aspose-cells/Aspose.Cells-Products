...
description: Aspose Excel โซลูชันที่ครอบคลุมนี้มอบแนวทางแบบบูรณาการอย่างสมบูรณ์แก่ผู้พัฒนา C# ในการแปลง XLS เป็นรูปแบบ XLSX ทำให้สามารถบันทึกข้อมูล XLS ลงในรูปแบบ XLSX ได้อย่างราบรื่นโดยใช้ไลบรารี Aspose.Cells ทั้งหมดนี้ผ่านโค้ด C# ที่มีประสิทธิภาพและปรับแต่งได้
...
{{< blocks/products/pf/i18n/upper-banner h1="แปลง XLS เป็น XLSX ใน C#" h2="ไลบรารีความเร็วสูง C# สำหรับแปลง XLS เป็น XLSX นี่คือโซลูชันซอฟต์แวร์ระดับมืออาชีพสำหรับการนำเข้าและส่งออก XLS, XLSX และรูปแบบอื่นๆ อีกมากมายบนเฟรมเวิร์ก .NET, คอร์ .NET หรือแพลตฟอร์ม Mono" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="บันทึกหมายเลข XLS เป็น XLSX ในหมายเลข C#" %}}

ตัวอย่างต่อไปนี้แสดงวิธีการแปลง XLS เป็น XLSX ใน C#
...
1.  แปลง XLS เป็น XLSX โดยเรียกใช้เมธอด Workbook.Save
1.  รับผลลัพธ์การแปลงจาก XLS เป็น XLSX

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ไลบรารี C# เพื่อแปลง XLS เป็น XLSX" %}}
