---
title:  Fügen Sie die Schaltfläche (Formularsteuerung) mit Python via .Net in Excel ein
weight: 200
description: Python via .Net-Quellcode zum Einfügen von Button (Formularsteuerung) in Excel.
---
...
{{% blocks/products/pf/agp/content h2="So fügen Sie eine Schaltfläche (Formularsteuerung) mit Python via .Net in eine Excel-Datei ein" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Einfügen einer Schaltfläche (Formularsteuerung) in eine Excel-Datei mit Python via .Net" %}}
...
+ Wählen Sie Arbeitsblatt über seinen Index aus.
 + Verwenden Sie das Add der Shapecollection[Methode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_button/#int-int-int-int-int-int) um eine Schaltfläche (Formularsteuerelement) in das ausgewählte Arbeitsblatt einzufügen.
...
{{% blocks/products/pf/agp/code-block title="Schaltfläche „Einfügen“ (Formularsteuerung) – Python via .Net" offSpacer="" %}}
