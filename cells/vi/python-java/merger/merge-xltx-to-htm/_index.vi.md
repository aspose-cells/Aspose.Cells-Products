...
Ví dụ sau minh họa cách hợp nhất XLTX thành HTM trong Aspose.Cells for Python via Java.
...
Cần hợp nhất XLTX với HTM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API có thể được thực hiện chỉ với vài dòng mã.
