---
title: Konvertieren Sie JSON über C# in XLSX
url: /de/net/conversion/json-to-xlsx/
description: Beispielcode für die Umwandlung von json in xlsx C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von json-Dateien in xlsx innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie JSON über C# in XLSX" h2="Exportieren Sie Excel®-Tabellen in das XLSX-Format auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET Entwickler können JSON-Dateien in nur wenigen Codezeilen einfach laden und in XLSX konvertieren.
