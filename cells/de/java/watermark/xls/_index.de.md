...
{{% blocks/products/pf/agp/content h2="So versehen Sie eine XLS-Datei mit einem Wasserzeichen unter Verwendung von Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen von Wasserzeichen zu XLS über Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Erstellen Sie ein neues Workbook-Objekt1. Wählen Sie das Arbeitsblatt über seinen Index aus1. Erstellen Sie eine Form und verwenden Sie ihre addTextEffect-Funktion1. Stellen Sie Farben, Transparenz und mehr ein1. Arbeitsmappe im XLS-Format speichern
...
{{% blocks/products/pf/agp/code-block title="Wasserzeichen zu XLS hinzufügen - Java" offSpacer="" %}}
