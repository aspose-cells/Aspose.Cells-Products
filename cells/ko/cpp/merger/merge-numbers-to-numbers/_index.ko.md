---
title: C++을 통해 NUMBERS를 NUMBERS로 병합
url: /ko/cpp/merger/merge-numbers-to-numbers/ 
description: 온라인에서 무료로 NUMBERS를 NUMBERS로 병합합니다. 무료 온라인 NUMBERS to NUMBERS 합병. 숫자를 Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS 등에 병합합니다.
---
...
다음 예는 C++에서 NUMBERS를 NUMBERS로 병합하는 방법을 보여줍니다.
...
{{% cells-merger title="온라인에서 NUMBERS를 NUMBERS로 병합하는 무료 앱" InputFormat="numbers" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
