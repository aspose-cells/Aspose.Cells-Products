...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل NUMBERS إلى XLS عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج .NET تحميل وتحويل NUMBERS من الملفات إلى XLS بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف NUMBERS مع مثيل من المصنف1. اتصل بـ Workbook.Save method1. قم بتمرير مسار الإخراج بامتداد XLS كمعامل1. تحقق من المسار المحدد لملف XLS الناتج
...
{{% cells-convert title="تطبيق مجاني ورمز نموذج لتحويل الأرقام إلى XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="xls" IsLandingPage="true" %}}
