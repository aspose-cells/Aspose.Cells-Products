...
{{% blocks/products/pf/agp/content h2="Python via Java을 사용하여 WordArt를 Excel 파일에 삽입하는 방법" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 + shapecollection의 사용[메소드 추가](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addWordArt(int,%20java.lang.String,%20int,%20int,%20int,%20int,%20int,%20int)) 선택한 워크시트에 WordArt를 삽입합니다.
