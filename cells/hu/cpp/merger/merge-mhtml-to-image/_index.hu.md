...
url: /hu/cpp/merger/merge-mhtml-to-image/ 
...
következő példa bemutatja, hogyan lehet egyesíteni a MHTML-et az IMAGE-val a Aspose.Cells-es for C++-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a MHTML-et az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a MHTML és az IMAGE egyesítéséhez" %}}
