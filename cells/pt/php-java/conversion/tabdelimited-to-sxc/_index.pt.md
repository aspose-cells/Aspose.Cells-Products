...
description: Aspose Excel. Converta TABDELIMITED em SXC de forma rápida e fácil com Aspose.Cells. PHP TABDELIMITED em SXC. PHP Salve TABDELIMITED em SXC. Salve TABDELIMITED como SXC usando PHP.
...
Precisa converter arquivos TABDELIMITED para SXC programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TABDELIMITED em SXC em apenas algumas linhas de código.
...
1.  Converta TABDELIMITED em SXC chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TABDELIMITED para SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED para SXC" %}}
