---
title: 将 CSV 转换为 XML C#
description: 免费将 CSV 转换为 XML。免费在线 CSV 到 XML 转换器。 C# CSV 到 XML。 CSV 通过 C# 到 XML。
keywords: Convert CSV, CSV Converter, CSV to PDF, CSV to Word, CSV to PPT, CSV to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 CSV 转换为 XML" h2="用于将 CSV 转换为 XML 的高速 C# 库。在 .NET 框架、.NET 核心或 Mono 平台上将 Excel 电子表格导出为 XML 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="免费在线将 CSV 保存到 C# 中的 XML" %}}

以下示例演示如何将 CSV 转换为 C# 中的 XML。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 CSV 转换为 XML。上传您的 CSV 文件，然后将其保存为 XML 文件。对于 CSV 读取和 XML 写入，您可以使用完全限定的文件名。输出的 XML 内容和格式将与原始 CSV 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 CSV 在线转换为 XML 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 CSV 转换为 XML" %}}

{{% blocks/products/pf/agp/text %}}

.NET 开发人员只需几行代码即可轻松加载 CSV 并将其转换为 XML。
...
{{% blocks/products/pf/agp/content h2="C# 将 CSV 转换为 XML 的库" %}}
