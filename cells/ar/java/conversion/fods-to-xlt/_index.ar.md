---
title: تحويل FODS إلى XLT عبر Java 

description: نموذج Java رمز تحويل لتنسيق FODS إلى ملف XLT. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى XLT داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل FODS إلى XLT عبر Java" h2="تحويل FODS إلى XLT Java لتحويل صفحات مفردة أو صفحات متعددة إلى XLT باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل FODS إلى XLT باستخدام Java" %}}

 من أجل تقديم FODS إلى XLT ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل FODS إلى XLT عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف FODS إلى XLT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف FODS بنسخة من فئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XLT & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XLT الناتج
...
{{% blocks/products/pf/agp/code-block title="FODS إلى XLT Java شفرة مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل FODS إلى XLT" sectionDescription="[تحويل FODS إلى XLT](https://products.aspose.app/cells/conversion/fods-to-xlt) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف FODS الخاص بك ، وسيتم تحويله على الفور إلى XLT." >}}
