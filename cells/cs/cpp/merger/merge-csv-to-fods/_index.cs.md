---
title: Sloučit CSV až FODS - Sloučit CSV až FODS v C++
url: /cs/cpp/merger/merge-csv-to-fods/ 
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma CSV do formátu uložení FODS. C++ Kombinujte formát CSV až FODS. Sloučit CSV až FODS v C++. CSV Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit CSV až FODS v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit CSV až FODS v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení CSV do FODS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru FODS. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí CSV do FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení CSV až FODS v C++" InputFormat="csv" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV na FODS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit CSV až FODS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení CSV až FODS" %}}
