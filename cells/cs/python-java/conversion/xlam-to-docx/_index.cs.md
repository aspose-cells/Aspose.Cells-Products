...
{{% blocks/products/pf/agp/content h2="Převeďte XLAM na DOCX pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLAM až DOCX v Python online zdarma" %}}

Následující příklad ukazuje, jak převést XLAM na DOCX v Python.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLAM na DOCX" %}}
