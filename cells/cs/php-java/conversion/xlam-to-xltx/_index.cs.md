---
title: Konvertor PHP XLAM až XLTX - XLAM až XLTX
description: Aspose Excel. Převeďte XLAM na XLTX rychle a snadno pomocí Aspose.Cells. PHP XLAM na XLTX. PHP Uložte XLAM na XLTX. Uložte XLTX jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xltx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na XLTX přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na XLTX programově? Vývojáři PHP mohou snadno načíst a převést XLAM na XLTX v několika řádcích kódu.
...
1.  Převeďte XLAM na XLTX voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na XLTX" %}}
