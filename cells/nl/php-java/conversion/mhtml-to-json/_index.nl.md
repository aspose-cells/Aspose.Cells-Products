...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar JSON met Aspose.Cells. PHP MHTML naar JSON. PHP Bewaar MHTML naar JSON. Sla MHTML op als JSON met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar JSON te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar JSON converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar JSON.
...
1.  Converteer MHTML naar JSON door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van MHTML naar JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om MHTML naar JSON te converteren" %}}
