...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ разработчики могут легко преобразовать XML в SPREADSHEETML, написав всего несколько строк кода.
