---
title:  Illessze be a Csillagok és szalaghirdetések beszúrását az Excel via .NET-be
weight: 381
...
{{< blocks/products/pf/i18n/upper-banner h1="Illessze be a Csillagok és szalaghirdetések beszúrását az Excel via Java-be" h2="Szerveroldali API-k használatával szúrjon be objektumokat szoftver nélkül, például Microsoft vagy Open Office, Adobe PDF stb." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Csillagok és szalaghirdetések beszúrása Excel fájlba a Java használatával" %}}

 Csillagok és szalagcímek beszúrásához excel fájlba a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="A csillagok és szalaghirdetések beszúrásának lépései a via Java-es Excel-fájlba" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja a[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) Csillagok és szalagcímek beszúrása a kiválasztott munkalapba
...
Az alábbi mintakód bemutatja, hogyan kell beilleszteni a „szalag: ívelt és felfelé dőlt” és a „robbanás: 8 pont” szöveget. További típusokért tekintse meg az alábbi "A csillag- és szalaghirdetés-típusok áttekintése" című részt.

{{% blocks/products/pf/agp/code-block title="Csillagok és szalaghirdetések beszúrása - Java" offSpacer="" %}}
