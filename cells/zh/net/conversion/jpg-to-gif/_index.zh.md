---
title: 将 JPG 转换为 GIF C#
description: 免费在线将JPG 转换成GIF。免费在线 JPG 到 GIF 转换器。 C# JPG 到 GIF。JPG 通过 C# 到 GIF。
keywords: Convert JPG, JPG Converter, JPG to PDF, JPG to Word, JPG to PPT, JPG to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 JPG 转换为 GIF" h2="用于将 JPG 转换为 GIF 的高速 C# 库。在 .NET 框架、.NET 核心或 Mono 平台上将 Excel 电子表格导出为 GIF 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPG" >}}
...
{{% blocks/products/pf/agp/content h2="在C#在线免费保存JPG到GIF" %}}

以下示例演示如何将 JPG 转换为 C# 中的 GIF。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 JPG 转换为 GIF。上传您的 JPG 文件，然后将其另存为 GIF 文件。对于 JPG 阅读和 GIF 写作，您可以使用完全限定的文件名。输出 GIF 内容和格式将与原始 JPG 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 JPG 在线转换为 GIF 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="gif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过C#将JPG转GIF" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载 JPG 并将其转换为 GIF。
...
{{% blocks/products/pf/agp/content h2="C# 将 JPG 转换为 GIF 的库" %}}
