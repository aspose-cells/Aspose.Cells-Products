...
Následující příklad ukazuje, jak sloučit PRN s XLS v Aspose.Cells for C++.
...
Potřebujete sloučit PRN s XLS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
