---
title:  Illessze be a GroupBoxot (Űrlapvezérlőt) az Excelbe a Python számon keresztül
weight: 40
description: Python forráskód a GroupBox (Űrlapvezérlő) Excelbe való beillesztéséhez.
---
...
{{% blocks/products/pf/agp/content h2="GroupBox (Űrlapvezérlő) beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A GroupBox (Űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python számon keresztül" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addGroupBox(int,%20int,%20int,%20int,%20int,%20int)) egy GroupBox (Űrlapvezérlő) beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="GroupBox beszúrása (Űrlapvezérlő) - Python" offSpacer="" %}}
