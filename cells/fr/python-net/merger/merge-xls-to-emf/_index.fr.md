...
url: /fr/python-net/merger/merge-xls-to-emf/ 
...
L'exemple suivant montre comment fusionner XLS à EMF dans Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Besoin de fusionner XLS à EMF par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
