...
In het volgende voorbeeld ziet u hoe u SPREADSHEETML converteert naar XLSB in Python via NET.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML converteren naar XLSB" %}}
