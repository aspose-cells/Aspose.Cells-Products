...
{{% cells-convert title="将 XLT 转换为 XLTX 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlt" outformat="xltx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何将 XLT 通过 C# 转换为 XLTX" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLT 文件转换为 XLTX 吗？.NET 开发人员只需几行代码即可轻松加载并将 XLT 转换为 XLTX。
