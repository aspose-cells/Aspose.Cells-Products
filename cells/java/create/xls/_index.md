---
title: Create XLS MS Excel Files via Java 
weight: 7690
url: /java/create/xls/ 
description: Java Sample code for generating XLS documents. Use this code for creating sheets in XLS Excel file within Java based desktop or web application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Create XLS Documents via Java" h2="Native and high performance Microsoft Excel XLS spreadsheet creation programmatically using Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Create XLS via Java" %}}
...
1.  Save the workbook as XLS format using the save() method.
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a MS Excel XLS file using Java." offSpacer="" %}}
