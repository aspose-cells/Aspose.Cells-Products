---
title:  Converter gráfico para BMP imagens via .NET
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter gráficos em arquivos BMP em C#" %}}
...
+ Criar arquivo XLSX.
+ Obtenha o gráfico.
+ Converter gráfico para imagem BMP.
...
{{% blocks/products/pf/agp/code-block title="Converter gráfico de arquivos XLSX para imagem BMP - C#" offSpacer="" %}}
