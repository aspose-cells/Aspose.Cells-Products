---
title: Voeg NUMBERS samen tot ET - Combineer NUMBERS tot ET in C++
url: /nl/cpp/merger/merge-numbers-to-et/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online NUMBERS samenvoegen naar ET-opslagformaat. C++ Combineer NUMMERS naar ET formaat. NUMBERS samenvoegen tot ET in C++. NUMBERS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="NUMBERS samenvoegen tot ET met behulp van C++" %}}
...
{{% blocks/products/pf/agp/content h2="Voeg NUMBERS samen met ET in C++ Online gratis" %}}

Het volgende voorbeeld laat zien hoe u NUMBERS samenvoegt met ET in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om NUMBERS samen te voegen tot ET. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het ET-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat NUMBERS samenvoegt met ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om NUMBERS samen te voegen tot ET in C++" InputFormat="numbers" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe NUMBERS samen te voegen met ET via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u NUMBERS programmatisch samenvoegen met ET? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
