---
title: Konwertuj XLT na XML za pomocą Java 

description: Przykładowy kod konwersji Java dla formatu XLT do pliku XML. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do XML w dowolnej aplikacji opartej na sieci Web lub Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLT na XML za pomocą Java" h2="Konwersja XLT do XML Java w celu konwersji jednej lub wielu stron na XML przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na XML za pomocą Java" %}}

 Aby wyrenderować XLT do XML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na XML za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik XLT na XML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XML i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XML
...
{{% blocks/products/pf/agp/code-block title="XLT do XML Java Kod źródłowy konwersji" offSpacer="" %}}
