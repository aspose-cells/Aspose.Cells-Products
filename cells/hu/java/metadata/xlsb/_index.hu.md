---
title:  Szerkesztés vagy megtekintése XLSB Fájlok metaadatai via Java
weight: 7290
description: Java mintakód a XLSB formátumú metaadatok szerkesztéséhez vagy megtekintéséhez a Java Futókörnyezet JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
...
{{< blocks/products/pf/i18n/upper-banner h1="Kivonat XLSB Metaadatok via Java" h2="Készítse el saját Java-es alkalmazásait a XLSB fájlok metaadatok hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="A XLSB metaadatok kinyerése a Java használatával" %}}

 A XLSB fájl metaadatainak lekéréséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A XLSB via Java metaadatainak kinyerésének lépései" %}}

{{% blocks/products/pf/agp/text %}}

 Hozzáférhet a XLSB-es fájlban tárolt hasznos információkhoz, beleértve a XLSB-es fájl fogadásának, feldolgozásának, időbélyegzésének és így tovább.

{{% /blocks/products/pf/agp/text %}}

+ Töltsön be XLSB fájlt a WorkbookMetadata-ba
+ Hozzon létre MetadataOptions objektumot a megfelelő beállításokkal
+ Állítsa be a megfelelő tulajdonságokat
+ Mentse el a XLSB metaadatokat
...
{{% blocks/products/pf/agp/code-block title="A XLSB - Java metaadatainak kivonata" offSpacer="" %}}
