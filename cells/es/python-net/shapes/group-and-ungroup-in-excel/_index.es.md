...
{{% blocks/products/pf/agp/content h2="Cómo agrupar y desagrupar formas en un archivo Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agrupar y desagrupar formas en un archivo Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[método de grupo](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/group/) para agrupar formas en la hoja de trabajo seleccionada
 + Usa el[método de desagrupación](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/ungroup/) para desagrupar formas en la hoja de trabajo seleccionada
