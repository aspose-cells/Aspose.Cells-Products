...
description: Aspose Excel. C++ Aspose.Cells. Voeg MHTML samen naar MHT-opslagformaat. C++ Combineer MHTML naar MHT-formaat. Voeg MHTML samen met MHT in C++. MHTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg MHTML samen met MHT in C++" %}}

Het volgende voorbeeld laat zien hoe u MHTML samenvoegt met MHT in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHTML samen te voegen met MHT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een MHT-bestand. Als u code ontwikkelt in C++, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld C++ waarin MHTML wordt samengevoegd met MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om MHTML samen te voegen met MHT in C++" InputFormat="mhtml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe u MHTML samenvoegt met MHT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
