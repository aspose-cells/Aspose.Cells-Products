---
title:  Exibir XLT Formatos de arquivo via .NET
weight: 3610
description: C# código-fonte para carregar, renderizar e exibir documentos XLT em .NET Framework, .NET Core, Mono ou plataformas Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLT Visualizador de arquivos for .NET" h2="Visualize planilhas do Excel e do OpenOffice, como XLT, sem a necessidade de Microsoft Excel ou Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para ver XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells torna mais fácil para os desenvolvedores visualizar o arquivo XLT com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Carregue o arquivo XLT em uma instância do Workbook
1.  Crie uma instância de HtmlSaveOptions e defina a propriedade ExportHeadings como true
1.  Salve o arquivo XLT no formato HTML usando o método Workbook.Save
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar Microsoft formatos Excel em diferentes formatos. Além disso, pode ser usado para gráficos abrangentes, relatórios escaláveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API autônomo e não requer nenhum software como Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo Gratuito para Ver XLT" sectionDescription=" Confira nossas demonstrações ao vivo para[Ver XLT](https://products.aspose.app/cells/viewer/xlt) com os seguintes benefícios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar ou configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever ou compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta carregar o arquivo XLT e clicar no botão \"Visualizar\"" >}}
