---
title: Java MHTML 轉 MHT - 在線 MHTML 轉 MHT 轉換器
description: Aspose Excel。 Java Aspose.Cells。Java Aspose Cells。免費在線 Java 將 MHTML 轉換為 MHT 保存格式。 Java MHTML 為 MHT 格式。將 MHTML 保存到 MHT Java。
...
{{% blocks/products/pf/agp/content h2="免費在線將 MHTML 保存到 Java 中的 MHT" %}}

以下示例演示如何將 MHTML 轉換為 Java 中的 MHT。
...
{{% blocks/products/pf/agp/content h2="如何將 MHTML 轉換為 MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHTML 文件轉換為 MHT？ Java開發人員只需幾行代碼即可輕鬆將MHTML轉換為MHT。
...
{{% blocks/products/pf/agp/content h2="Java庫將MHTML轉換為MHT" %}}
{{% blocks/products/pf/agp/text %}}
