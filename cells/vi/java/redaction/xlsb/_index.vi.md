---
title: Tìm kiếm và thay thế văn bản trong tài liệu XLSB qua Java 
weight: 4590
url: /vi/java/redaction/xlsb/ 
description: Java mã mẫu để biên tập lại thông tin nhạy cảm trong tệp XLSB trên Java Môi trường thời gian chạy cho Ứng dụng JSP / JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Redact XLSB Định dạng trong Java" h2="Thông tin phản hồi nhạy cảm về tài liệu XLSB gốc và hiệu suất cao bằng cách sử dụng Aspose.Cells for Java API phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chỉnh sửa tệp XLSB bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chỉnh sửa tệp XLSB trong Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Redact tệp XLSB - Java" offSpacer="" %}}
