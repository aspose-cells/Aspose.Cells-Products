---
title: A XLTX egyesítése az IMAGE-val – a XLTX-es szám egyesítése az IMAGE-val a C#-ben
url: /hu/net/merger/merge-xltx-to-image/ 
description: Aspose Excel. C# Aspose.Cells. A XLTX egyesítése az IMAGE mentési formátumba. C# A XLTX kombinálása IMAGE formátumba. A XLTX egyesítése a C#-es számú IMAGE-val. XLTX Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A XLTX egyesítése az IMAGE-val a C#-ben" %}}

következő példa bemutatja, hogyan lehet egyesíteni a XLTX-et az IMAGE-val a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLTX és az IMAGE egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el az IMAGE fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a XLTX-et az IMAGE-be.
...
{{% blocks/products/pf/agp/content h2="A XLTX és az IMAGE egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLTX-et az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLTX és az IMAGE egyesítéséhez" %}}
