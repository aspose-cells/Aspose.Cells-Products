---
title:  ใส่ Arc ใน Excel ได้ทาง C++
weight: 10
description: โค้ดตัวอย่าง C++ เพื่อแทรก Arc ในไฟล์ Excel บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
keywords: [C++ Aspose.Cells., C++ add arc shape., C++ insert arc shape., C++ create arc shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ใส่ Arc ใน Excel ได้ทาง C++" h2="แทรกออบเจ็กต์โดยใช้เนทีฟและประสิทธิภาพสูงของฝั่งเซิร์ฟเวอร์ Aspose.Cells for C++ API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addarc/) เพื่อแทรกรูปร่างสมการลงในแผ่นงานที่เลือก
