---
title: Hoe u de vorm van een elleboogpijl in Excel kunt tekenen of invoegen met behulp van Python via .Net
weight: 10
description: Python via .Net-broncode om de vorm van een elleboogpijl in Excel in te voegen.
...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg de vorm van de elleboogpijl in Excel in met behulp van Python via .Net" h2="Voeg de vorm van de elleboogpijl in met behulp van Aspose.Cells\' API zonder enige software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u de vorm van een elleboogpijl in een Excel-bestand kunt invoegen met behulp van Python via .Net" %}}

 Om de vorm van de elleboogpijl in het Excel-bestand in te voegen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om de vorm van de elleboogpijl in te voegen in een Excel-bestand met behulp van Python via .Net" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de toevoeging van de vormcollectie[methode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) om een elleboogpijlvorm in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Insteekelleboog pijlvorm - Python via .Net" offSpacer="" %}}
