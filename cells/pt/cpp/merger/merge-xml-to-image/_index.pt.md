---
title: Mesclar XML com IMAGE - Combine XML com IMAGE em C++
url: /pt/cpp/merger/merge-xml-to-image/ 
description: Aspose Excel. C++ Aspose.Cells. Mesclar XML para salvar formato IMAGE. C++ Combine XML com formato IMAGE. Mesclar XML com IMAGE em C++. Mesclar XML.
...
{{% blocks/products/pf/agp/content h2="Mesclar XML com IMAGE em C++" %}}

O exemplo a seguir demonstra como mesclar XML com IMAGE em Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XML com IMAGE. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os no arquivo IMAGE. Se você desenvolver código em C++, será mais simples do que parece. Veja o exemplo C++ que mescla XML com IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemplo de código para mesclar XML com IMAGE em C++" InputFormat="xml" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XML com IMAGE via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar XML com IMAGE programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para mesclar XML com IMAGE" %}}
