...
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Online Gratis Java Ubah FODS menjadi format penyimpanan GAMBAR. Java FODS ke format GAMBAR. Simpan FODS ke GAMBAR Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah FODS menjadi GAMBAR di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi FODS menjadi GAMBAR. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor FODS, IMAGE, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan FODS ke GAMBAR di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi FODS menjadi GAMBAR di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah FODS menjadi GAMBAR via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file FODS ke IMAGE secara terprogram? Pengembang Java dapat dengan mudah mengonversi FODS menjadi GAMBAR hanya dalam beberapa baris kode.
...
1.  Ubah FODS menjadi GAMBAR dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi FODS ke IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi FODS menjadi GAMBAR" %}}
{{% blocks/products/pf/agp/text %}}
