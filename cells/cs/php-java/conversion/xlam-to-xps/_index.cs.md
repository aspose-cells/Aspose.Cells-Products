---
title: Konvertor PHP XLAM až XPS - XLAM až XPS
description: Aspose Excel. Převeďte XLAM na XPS rychle a snadno pomocí Aspose.Cells. PHP XLAM na XPS. PHP Uložte XLAM na XPS. Uložte XPS jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xps" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na XPS přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na XPS programově? Vývojáři PHP mohou snadno načíst a převést XLAM na XPS v několika řádcích kódu.
...
1.  Převeďte XLAM na XPS voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na XPS" %}}
