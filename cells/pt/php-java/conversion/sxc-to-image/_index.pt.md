---
title: PHP SXC para IMAGEM - SXC para conversor de IMAGEM
description: Aspose Excel. Converta SXC em IMAGE de forma rápida e fácil com Aspose.Cells. PHP SXC em IMAGE. PHP Salve SXC em IMAGEM. Salve SXC como IMAGEM usando PHP.
...
{{% cells-convert title="Exemplo de código para converter SXC em IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="png" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter SXC para IMAGEM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em IMAGE programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em IMAGE em apenas algumas linhas de código.
...
1.  Converta SXC em IMAGE chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de SXC para IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter SXC em IMAGE" %}}
