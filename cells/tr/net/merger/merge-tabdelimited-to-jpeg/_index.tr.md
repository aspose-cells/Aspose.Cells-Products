---
title: TABDELIMITED'ı JPEG ile birleştir - TABDELIMITED'ı C#'de JPEG ile birleştir
url: /tr/net/merger/merge-tabdelimited-to-jpeg/ 
description: Aspose Excel'de. C# Aspose.Cells. TABDELIMITED'ı JPEG kaydetme biçimiyle birleştir. C# TABDELIMITED'ı JPEG biçimiyle birleştirin. TABDELIMITED'ı C#'de JPEG ile birleştir. TABDELIMITED Birleştir.
...
{{% blocks/products/pf/agp/content h2="TABDELIMITED\'ı C#\'de JPEG ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de TABDELIMITED'ın JPEG ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TABDELIMITED'ı JPEG'e birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından JPEG dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TABDELIMITED ile JPEG'i birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de TABDELIMITED ile JPEG\'i Birleştirmek için Örnek Kod" InputFormat="tsv" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="TABDELIMITED\'ı C# ile JPEG ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TABDELIMITED'ı programlı olarak JPEG ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kütüphanesi, TABDELIMITED ile JPEG arasında birleştirilecek" %}}
