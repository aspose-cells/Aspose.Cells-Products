...
{{% blocks/products/pf/agp/content h2="Konwertuj PRN na XLSB przy użyciu biblioteki Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz numer PRN pod numerem XLSB w bibliotece programu Excel Python" %}}

Poniższy przykład ilustruje konwersję PRN na XLSB w bibliotece Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteka Excel do konwersji PRN na XLSB" %}}
