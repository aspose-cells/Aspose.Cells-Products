...
{{% blocks/products/pf/agp/content h2="Save SXC to JPEG in C#" %}}

The following example demonstrates how to convert SXC to JPEG in C#.
...
{{% cells-convert title="Sample Code to Convert SXC to JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert SXC to JPEG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert SXC files to JPEG programmatically? .NET developers can easily load & convert SXC to JPEG in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert SXC to JPEG" %}}
