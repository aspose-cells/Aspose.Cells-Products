---
title: Convertir XLT en BMP via l'application C++ 
url: /fr/cpp/conversion/xlt-to-bmp/ 
description: Exemple de code de conversion C++ pour le document XLT au format BMP. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLT en BMP dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLT en BMP via C++" h2="Conversion XLT vers BMP haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLT en BMP en utilisant C++" %}}

 Pour convertir XLT en BMP, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLT en BMP via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier XLT en BMP en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLT à l'aide de Factory :: CreateIWorkbook.1. Sélectionnez la première feuille de calcul.1. Définir les options (BMP).1. Parcourez chaque page de la feuille et effectuez le rendu.1. Ouvrez le fichier BMP dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLT vers BMP C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démos en direct sur la conversion de XLT en BMP" sectionDescription="[Convertir XLT en BMP](https://products.aspose.app/cells/conversion/xlt-to-bmp) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier XLT, il sera converti instantanément en BMP." >}}
