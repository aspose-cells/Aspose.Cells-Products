...
Het volgende voorbeeld laat zien hoe u XLTM converteert naar WORD in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLTM naar WORD te converteren" %}}
