---
title: Java HTM إلى MHT - محول HTM إلى MHT
description: Aspose إكسل. يوفر هذا الحل الشامل للمطورين Java نهجًا متكاملًا تمامًا لتحويل تنسيق HTM إلى تنسيق MHT، مما يتيح حفظ بيانات HTM بسلاسة في تنسيق MHT باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود Java فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ ملف HTM إلى MHT في Java" %}}

يوضح المثال التالي كيفية تحويل HTM إلى MHT في Java.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل HTM إلى MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات HTM إلى MHT برمجيًا؟ يمكن للمطورين (Java) تحويل ملفات HTM إلى MHT بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل ملف HTM إلى ملف MHT عن طريق استدعاء دالة Workbook.save.
1.  احصل على نتيجة تحويل HTM إلى MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة رقم Java لتحويل ملفات HTML إلى ملفات MHT" %}}
{{% blocks/products/pf/agp/text %}}
