---
title: Chuyển đổi TXT sang SVG qua ứng dụng C++ 

description: Mã chuyển đổi C++ mẫu cho tài liệu TXT sang định dạng SVG. Người lập trình có thể sử dụng mã nguồn này để chuyển đổi hàng loạt TXT sang SVG trong bất kỳ Ứng dụng C++ nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi TXT sang SVG qua C++" h2="Chuyển đổi TXT sang SVG hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp TXT thành SVG chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp TXT bằng Factory :: CreateIWorkbook.1. Chọn trang tính đầu tiên.1. Đặt (SVG) tùy chọn.1. Lặp lại từng trang của trang tính và kết xuất.1. Mở tệp SVG trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi TXT sang SVG C++" offSpacer="" %}}
