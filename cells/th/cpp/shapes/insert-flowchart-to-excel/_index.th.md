---
title:  แทรก FlowChart ลงใน Excel ผ่าน C++
weight: 790
description: รหัสตัวอย่าง C++ เพื่อแทรก FlowChart ในไฟล์ Excel บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
---
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก FlowChart เข้าไฟล์ Excel ผ่าน C++" %}}

การสร้างอินสแตนซ์ของวัตถุสมุดงาน (หรือ->โหลดไฟล์ XLSX พร้อมเส้นทางแบบเต็ม)
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ab8156e8562724f9a597b7d2bc503cd4d) เพื่อแทรก FlowChart ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกผังงาน - C++" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChartData
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChartPredefinedProcess
    </p>
   </div>
   <div class="col-lg-4">
 ...
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChartInternalStorage
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChartเอกสาร
    </p>
   </div>
   <div class="col-lg-4">
    <img src="/cells/net/shapes/insert-flowchart-to-excel/multidocument.png" align="left" width="28" height="28">
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChart เอกสารหลายรายการ
    </p>
   </div>
   <div class="col-lg-4">
 ...
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChartTerminator
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChartการเตรียมการ
    </p>
   </div>
   <div class="col-lg-4">
    <img src="/cells/net/shapes/insert-flowchart-to-excel/manual_input.png" align="left" width="28" height="28">
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChart การป้อนข้อมูลด้วยตนเอง
    </p>
   </div>
   <div class="col-lg-4">
    <img src="/cells/net/shapes/insert-flowchart-to-excel/manual_operation.png" align="left" width="28" height="28">
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChartการดำเนินการด้วยตนเอง
    </p>
   </div>
   <div class="col-lg-4">
 ...
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChartSummingJunction
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
 ประเภทรูปร่างอัตโนมัติ::<br>AutoShapeType_FlowChartหรือ
    </p>
   </div>
   <div class="col-lg-4">
