...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 XLS 轉換為 MHTML。Python XLS 為 MHTML. Python 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Python。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 XLS 轉換為 Python 中的 MHTML" h2="高速Python庫，用於將XLS轉換為MHTML。這是一個專業的軟體解決方案，用於導入和導出XLS、MHTML和使用Python的許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
以下範例示範如何將 Python 中的 XLS 轉換為 MHTML。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLS 轉換為 MHTML。上傳您的 XLS 文件，然後只需將其另存為 MHTML 文件。對於 XLS 讀取和 MHTML 寫入，您可以使用完全限定的檔案名稱。輸出 MHTML 內容和格式將與原始 XLS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 XLS 轉換為 MHTML 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="mhtml" IsLandingPage="true" language="pythonjava" %}}
