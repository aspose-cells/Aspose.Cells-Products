...
url: /tr/cpp/merger/merge-xlsx-to-sql/ 
description: Aspose Excel'de. C++ Aspose.Cells. XLSX'i SQL kaydetme biçimiyle birleştirin. C++ XLSX'i SQL biçimiyle birleştirin. XLSX'i C++'deki SQL ile birleştirin. XLSX Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLSX\'i C++\'deki SQL ile birleştir" %}}

Aşağıdaki örnek, XLSX'in Aspose.Cells for C++'deki SQL ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

XLSX'i SQL ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından bunu SQL dosyasına kaydedin. C++'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. XLSX'i SQL ile birleştiren C++ örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="XLSX\'i C++\'de SQL ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLSX\'i C++ aracılığıyla SQL ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLSX'i programlı olarak SQL ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="C++ kütüphanesini SQL ile birleştirmek için XLSX kütüphanesi" %}}
