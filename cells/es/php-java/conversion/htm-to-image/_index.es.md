---
title: PHP HTM a IMAGEN - Convertidor de HTM a IMAGEN
description: Aspose Excel. Convierta HTM a IMAGEN rápida y fácilmente con Aspose.Cells. PHP HTM a IMAGEN. PHP Guarde HTM en IMAGEN. Guarde HTM como IMAGEN usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a IMAGEN mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a IMAGEN mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a IMAGEN en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a IMAGEN llamando al método guardar del Libro de trabajo.
1.  Obtenga el resultado de la conversión de HTM a IMAGEN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir HTM a IMAGEN" %}}
