---
title: 通過 C++ 搜索並替換 ODS 文檔中的文本
weight: 1610
description: C++ 示例代碼，用於在 C++ 運行時環境（Windows 32 位、Windows 64 位和 Linux 64 位）上編輯 ODS 文件中的敏感信息。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="編輯 ODS C++ 格式" h2="本機高性能 ODS 使用服務器端 Aspose.Cells for C++ API 記錄敏感的編輯信息，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
