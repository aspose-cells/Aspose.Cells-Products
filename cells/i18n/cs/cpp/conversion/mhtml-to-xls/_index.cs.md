---
title: Převeďte MHTML na XLS pomocí aplikace C++ 
weight: 7320
url: /cs/cpp/conversion/mhtml-to-xls/ 
description: Ukázka převodního kódu C++ pro dokument MHTML na formát XLS. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi MHTML na XLS v jakékoli aplikaci C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést MHTML na XLS přes C++" h2="Vysoce výkonný převod MHTML na XLS pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor MHTML na XLS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor MHTML pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLS).1. Soubor XLS bude uložen do zadané cesty.1. Otevřete soubor XLS v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MHTML na XLS C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze MHTML na XLS" sectionDescription="[Převést MHTML na XLS](https://products.aspose.app/cells/conversion/mhtml-to-xls) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj MHTML soubor, bude okamžitě převeden na XLS." >}}
