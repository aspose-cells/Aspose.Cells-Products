---
title: Konvertieren Sie TXT in PNG über die Anwendung C++ 
url: /de/cpp/conversion/txt-to-png/ 
description: Beispiel-Umwandlungscode C++ für ein TXT-Dokument in das PNG-Format. Programmierer können diesen Quellcode für die Batch-Konvertierung von TXT in PNG in jeder C++-Anwendung verwenden.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie TXT in PNG über C++" h2="Leistungsstarke TXT-zu-PNG-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie TXT in PNG mit C++" %}}

 Um TXT in PNG zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von TXT in PNG über C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-Entwickler können TXT-Dateien in nur wenigen Codezeilen ganz einfach in PNG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die TXT-Datei mit Factory::CreateIWorkbook.1. Wählen Sie das erste Arbeitsblatt aus.1. Legen Sie (PNG)-Optionen fest.1. Durchlaufen Sie jede Blattseite und rendern Sie.1. Öffnen Sie die PNG-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="TXT-zu-PNG-C++-Konvertierungsquellcode" offSpacer="" %}}
