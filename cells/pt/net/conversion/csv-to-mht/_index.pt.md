---
title: C# CSV para MHT - Conversor CSV para MHT
description: Aspose Excel. Converta CSV em MHT de forma rápida e fácil com Aspose.Cells. C# CSV em MHT. C# Salve CSV em MHT. Salve CSV como MHT usando C#.
...
O exemplo a seguir demonstra como converter CSV em MHT em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter CSV em MHT. Carregue seu arquivo CSV e simplesmente salve-o como arquivo MHT. Tanto para leitura CSV quanto para gravação MHT, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação do MHT de saída serão idênticos ao documento CSV original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemplo de código para converter CSV em MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter CSV para MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos CSV para MHT programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter CSV em MHT em apenas algumas linhas de código.
...
1.  Converta CSV em MHT chamando o método Workbook.Save.
