...
{{% blocks/products/pf/agp/content h2="Jak naprawić plik xlsm za pomocą Java" %}}
...
{{% cells-recovery title="Darmowa aplikacja do naprawy pliku XLSM za pomocą Java" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsm" outformat="xlsm" IsLandingPage="true" language="java" %}}    
