...
description: Sample C++ conversion code for HTML to MHTML format. Programmers can use this source code for batch HTML to MHTML conversion within any C++ Application.
---
