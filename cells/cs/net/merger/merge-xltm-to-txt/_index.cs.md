...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLTM do TXT uložit formát. C# Kombinujte formát XLTM až TXT. Sloučit XLTM až TXT v C#. XLTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTM až TXT v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTM až TXT v C#" InputFormat="xltm" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
