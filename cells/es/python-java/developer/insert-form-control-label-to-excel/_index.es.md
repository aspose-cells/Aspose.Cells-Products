---
title:  Inserte la etiqueta (control de formulario) en Excel usando Python via java
weight: 80
description: Python via código fuente de Java para insertar la etiqueta (control de formulario) en Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserte la etiqueta (control de formulario) en Excel usando Python via java" h2="Inserte objetos utilizando las API del lado del servidor sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo insertar una etiqueta (control de formulario) en un archivo de Excel usando Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar la etiqueta (control de formulario) en un archivo de Excel usando Python via java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa las colecciones de formas[añadir método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLabel(int,%20int,%20int,%20int,%20int,%20int)) para insertar una etiqueta (control de formulario) en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar etiqueta (control de formulario) - Python via java" offSpacer="" %}}
