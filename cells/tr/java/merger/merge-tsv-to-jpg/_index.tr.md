---
title: TSV'i JPG ile birleştir - TSV'i Java'de JPG ile birleştir
url: /tr/java/merger/merge-tsv-to-jpg/ 
description: Aspose Excel'de. Java Aspose.Cells. TSV'i JPG kaydetme biçimiyle birleştirin. Java TSV'i JPG formatında birleştirin. TSV'i Java'deki JPG ile birleştirin. TSV Birleştir.
...
{{% blocks/products/pf/agp/content h2="TSV\'i Java\'deki JPG ile birleştir" %}}

Aşağıdaki örnek, TSV'in Aspose.Cells for Java'deki JPG ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TSV'i JPG ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından JPG dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TSV'i JPG ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TSV\'i Java\'de JPG ile Birleştirmek için Örnek Kod" InputFormat="tsv" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TSV\'i JPG via Java\'e Nasıl Birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

TSV'i JPG ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesi, TSV\'i JPG ile birleştirmek için" %}}
