---
title:  Hợp nhất EXCEL thành PDF qua C#
url: /vi/net/merger/merge-excel-to-pdf/ 
description: Hợp nhất EXCEL thành PDF trực tuyến miễn phí. Sáp nhập EXCEL trực tuyến miễn phí tới PDF. Hợp nhất EXCEL sang Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS và hơn thế nữa.
---
...
Ví dụ sau minh họa cách hợp nhất EXCEL thành PDF trong C#.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất EXCEL thành PDF trực tuyến" InputFormat="xlsx" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
