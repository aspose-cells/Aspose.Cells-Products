---
title: รวม NUMBERS เป็น NUMBERS - รวม NUMBERS เป็น NUMBERS ใน Java
url: /th/java/merger/merge-numbers-to-numbers/ 
description: Aspose เก่ง. Java Aspose.Cells รวมรูปแบบบันทึก NUMBERS เป็น NUMBERS ออนไลน์ฟรี Java รวมรูปแบบ NUMBERS เป็น NUMBERS รวม NUMBERS เป็น NUMBERS ใน Java NUMBERS Merge
...
ตัวอย่างต่อไปนี้สาธิตวิธีรวม NUMBERS เป็น NUMBERS ใน Aspose.Cells for Java
...
{{% cells-merger title="ออนไลน์ฟรีเพื่อรวม NUMBERS เป็น NUMBERS ใน Java" InputFormat="numbers" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวม NUMBERS เป็น NUMBERS via Java" %}}

{{% blocks/products/pf/agp/text %}}

ต้องการรวม NUMBERS เป็น NUMBERS โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for Java](https://products.aspose.com/cells/java) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
