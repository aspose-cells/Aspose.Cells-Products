---
title: Создать FODS - Создать файл FODS в Java
description: Aspose Excel. Java Создать файл FODS. Создать FODS Java. Java FODS Создатель. Создайте FODS в Java. Создайте файл FODS, используя Java.
...
{{% blocks/products/pf/agp/content h2="Как создать FODS в Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчикам легко создавать, загружать, изменять и преобразовывать файлы FODS в рамках запуска различных приложений отчетности для обработки данных всего за несколько строк кода.
...
1.  Сохраните книгу в формате FODS, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл FODS в Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="библиотека Java для создания файла FODS" %}}
{{% blocks/products/pf/agp/text %}}
