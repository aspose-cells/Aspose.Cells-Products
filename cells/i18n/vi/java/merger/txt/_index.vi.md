---
title: Hợp nhất các tệp TXT qua Java 
weight: 4480
url: /vi/java/merger/txt/ 
description: Java mã mẫu để kết hợp các tài liệu TXT trên Java Môi trường thời gian chạy cho Ứng dụng JSP / JSF và Ứng dụng trên máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng TXT trong Java" h2="Hợp nhất tài liệu TXT gốc bằng cách sử dụng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất các tệp TXT bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để hợp nhất các tệp TXT trong Java" %}}
...
+ Tải tệp TXT đầu tiên với một thể hiện của lớp Workbook.
+ Tải tài liệu TXT thứ hai với một thể hiện của lớp Workbook.
+ Hợp nhất các tệp tin bằng phương thức kết hợp ().
+ lưu tệp TXT đã hợp nhất tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tệp TXT - Java" offSpacer="" %}}
