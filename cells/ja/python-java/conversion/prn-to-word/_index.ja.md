---
title: Python PRN から WORD - オンライン PRN から WORD コンバーター
description: Aspose エクセル。 Python Aspose.Cells. Python Aspose Cells. 無料オンライン Python PRN を WORD 保存形式に変換します。 Python PRN から WORD 形式へ。 PRN を WORD Python に保存します。
...
{{% blocks/products/pf/agp/content h2="Pythonを使用してPRNをWORDに変換" %}}
...
{{% blocks/products/pf/agp/content h2="無料でオンラインでPRNをPythonのWORDに保存します" %}}

次の例は、Python で PRN を WORD に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って PRN を WORD に変換します。 PRN ファイルをアップロードし、WORD ファイルとして保存するだけです。 PRN の読み取りと WORD の書き込みの両方で、完全修飾ファイル名を使用できます。出力される WORD の内容と形式は、元の PRN ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="オンラインでPRNをWORDに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="docx" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python PRN を WORD に変換するライブラリ" %}}
