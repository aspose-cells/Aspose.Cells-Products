---
title: Voeg MHT samen met DOCX - Combineer MHT met DOCX in Java
url: /nl/java/merger/merge-mht-to-docx/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online MHT samenvoegen naar DOCX saveformat. Java Combineer MHT tot formaat DOCX. MHT samenvoegen naar DOCX in Java. MHT samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Hoe MHT samen te voegen tot DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHT programmatisch samenvoegen met DOCX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om MHT samen te voegen tot DOCX" %}}
