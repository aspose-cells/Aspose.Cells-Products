---
title: "TSV konvertálása XLT-vé a következőn keresztül: C#"
url: /hu/net/conversion/tsv-to-xlt/
description: Mintakód a tsv–xlt C# konverzióhoz. Használjon API példakódot a kötegelt tsv-fájlok xlt-konverziójához VB.NET-on, Asp-n.NET vagy bármely .NET-alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása XLT-vé a következővel: C#" %}}

 A TSV XLT-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TSV XLT-vé konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a TSV-fájlokat XLT-vé.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TSV-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Adja meg a kimeneti útvonalat XLT kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott XLT fájl megadott elérési útját
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód a TSV XLT-vé konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xlt" IsLandingPage="true" %}}
