...
{{% blocks/products/pf/agp/content h2="Sla HTML op in SXC in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar SXC in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar SXC of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar SXC? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar SXC met slechts een paar regels code.
