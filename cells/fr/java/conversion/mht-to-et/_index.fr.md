---
title: Java MHT en ET - Convertisseur MHT en ET
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format MHT au format ET, permettant un enregistrement transparent des données MHT au format ET à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Sauvegarder MHT vers ET dans Java" %}}

L'exemple suivant montre comment convertir MHT en ET dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir MHT en ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en ET par programmation ? Les développeurs de Java peuvent facilement convertir des fichiers MHT en ET en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir MHT en ET" %}}
{{% blocks/products/pf/agp/text %}}
