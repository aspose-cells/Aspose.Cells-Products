---
title: PHP OTS naar ODS - OTS naar ODS Converter
description: Aspose Excel. Converteer OTS snel en eenvoudig naar ODS met Aspose.Cells. PHP OTS naar ODS. PHP Bewaar OTS naar ODS. Sla OTS op als ODS met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar ODS te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar ODS converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar ODS in slechts een paar regels code.
...
1.  Converteer OTS naar ODS door de opslagmethode van Workbook aan te roepen.
1.  Ontvang het conversieresultaat van OTS naar ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om OTS naar ODS te converteren" %}}
