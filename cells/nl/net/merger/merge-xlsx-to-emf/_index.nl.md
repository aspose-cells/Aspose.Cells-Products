...
description: Aspose Excel. C# Aspose.Cells. Voeg XLSX samen met het opslagformaat EMF. C# Combineer het formaat XLSX met EMF. Voeg XLSX samen met EMF in C#. XLSX Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSX samen met EMF in C#" %}}

Het volgende voorbeeld laat zien hoe u XLSX samenvoegt met EMF in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSX samen te voegen met EMF. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand EMF. Als u code ontwikkelt in C#, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C# waarin XLSX wordt samengevoegd met EMF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLSX samen te voegen met EMF in C#" InputFormat="xlsx" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSX samenvoegt met EMF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSX programmatisch samenvoegen met EMF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLSX samen te voegen met EMF" %}}
