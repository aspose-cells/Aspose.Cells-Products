---
title: C# SqlServer в EXCEL - Конвертер SqlServer в EXCEL
description: Aspose Эксель. Быстро и легко конвертируйте SqlServer в EXCEL с помощью Aspose.Cells. C# SqlServer в EXCEL. C# Сохраните SqlServer в EXCEL. Сохраните SqlServer как EXCEL, используя C#.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать SqlServer в EXCEL через C#" %}}
...
1.  Запросите данные из базы данных SqlServer, чтобы получить объект DataTable.
...
{{% blocks/products/pf/agp/code-block title="Пример кода для преобразования SqlServer в EXCEL — C#" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# библиотека для преобразования SqlServer в EXCEL" %}}
