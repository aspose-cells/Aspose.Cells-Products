...
{{% blocks/products/pf/agp/content h2="Convertir JSON a XLAM en Python" %}}
...
El siguiente ejemplo demuestra cómo convertir JSON a XLAM en Python via NET.
