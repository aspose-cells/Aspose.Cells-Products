...
{{< blocks/products/pf/i18n/upper-banner h1="XLSM-Dateien über C++ verschlüsseln" h2="Schützen Sie Excel-Tabellen einschließlich des XLSM-Formats mit der .NET-Bibliothek durch ein Kennwort." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="So sichern Sie eine XLSM-Datei mit C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Schützen von XLSM-Dateien über C++" %}}
...
1. Laden Sie die XLSM-Datei mit der IWorkbook-Klasse1. Verwenden Sie die Protect(..)-Methode mit ProtectionType und Password1. Speichern Sie die geschützte XLSM-Datei mit der Methode Save()
