---
title: Genera rapporti nei file ODS tramite Java 
weight: 2440
...
{{% blocks/products/pf/agp/content h2="Come generare rapporti ODS utilizzando Java" %}}
 ...
 Per creare rapporti sui file ODS, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per generare rapporti ODS tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Istanziare la classe WorkbookDesigner1. Aggiungi oggetti Datasouce in un ArrayList1. Impostare l'origine dati e il processo per l'oggetto WorkbookDesigner1. Salva il risultato in formato ODS tramite il metodo Worbook.save
...
{{% blocks/products/pf/agp/code-block title="Genera report Excel in formato ODS - C#" offSpacer="" %}}
