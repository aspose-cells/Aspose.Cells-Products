---
title:  Lägg till eller ta bort XLS Excel-filanteckning via C++
weight: 10040
description: C++ exempelkod för att lägga till och ta bort XLS formatkommentarer på C++ Runtime Environment för Windows 32 bitar, Windows 64 bitar och Linux 64 bitar.
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att lägga till kommentarer i XLS via C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Ladda XLS Excel-filen med IWorkbook-klassobjektet.
...
{{% blocks/products/pf/agp/code-block title="Lägg till kommentarer i XLS fil - C++" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API kan användas för att skapa, redigera, konvertera och rendera Microsoft Excel-format till olika format. Dessutom kan den användas för omfattande kartläggning, skalbar rapportering och tillförlitliga beräkningar inom mjukvaruapplikationer. Aspose.Cells är en fristående API och den kräver ingen programvara som Microsoft eller OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Lägg till / ta bort anteckning från XLS via onlineappen" sectionDescription=" Ta bort XLS dokumentkommentarer just nu genom att besöka vår[Live Demos webbplats](https://products.aspose.app/cells/annotation). Livedemon har följande fördelar" >}}
