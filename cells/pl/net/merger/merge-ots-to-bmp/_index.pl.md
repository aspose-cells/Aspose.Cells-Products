...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne połączenie OTS online z formatem zapisu BMP. C# Połącz OTS z formatem BMP. Połącz OTS z BMP w C#. Połącz OTS.
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z BMP za pomocą C#" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz OTS z BMP w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić OTS z BMP w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić OTS z BMP. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku BMP. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OTS z BMP.
...
{{% blocks/products/pf/agp/content h2="Jak połączyć OTS z BMP przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć OTS z numerem BMP? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia OTS z BMP" %}}
