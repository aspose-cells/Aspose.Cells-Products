...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla XLS Nasıl Oluşturulur" %}}
...
{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kod, Java kullanarak bir MS Excel XLS dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
