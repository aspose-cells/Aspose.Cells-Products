---
title: Konvertor PHP MHTML až SXC - MHTML až SXC
description: Aspose Excel. Převeďte MHTML na SXC rychle a snadno pomocí Aspose.Cells. PHP MHTML na SXC. PHP Uložte MHTML na SXC. Uložte SXC jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na SXC přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na SXC programově? Vývojáři PHP mohou snadno načíst a převést MHTML na SXC v několika řádcích kódu.
...
1.  Převeďte MHTML na SXC voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na SXC" %}}
