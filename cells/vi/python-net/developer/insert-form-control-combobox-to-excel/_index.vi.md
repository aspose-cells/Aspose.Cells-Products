---
title: Chèn ComboBox(Form control) vào Excel bằng Python via .Net
weight: 20
description: Python via Mã nguồn .Net chèn ComboBox(Form control) vào Excel.
...
{{% blocks/products/pf/agp/content h2="Cách chèn ComboBox (Điều khiển biểu mẫu) vào tệp Excel bằng Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn ComboBox(Form control) vào file Excel sử dụng Python via .Net" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng phần bổ sung của bộ sưu tập hình dạng[phương pháp](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_combo_box/#int-int-int-int-int-int) để chèn ComboBox(Điều khiển biểu mẫu) vào trang tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Insert ComboBox(Form control) - Python via .Net" offSpacer="" %}}
