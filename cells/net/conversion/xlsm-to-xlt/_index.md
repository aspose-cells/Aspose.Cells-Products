...
description: Sample code for XLSM to XLT C# conversion. Use API example code for batch XLSM files to XLT conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLSM to XLT via C#" h2="Export Excel® spreadsheets to XLT format on .NET Framework, .NET Core, Mono or Xamarin Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="How to Convert XLSM to XLT Using C#" %}}

 In order to convert XLSM to XLT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLSM to XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert XLSM files to XLT in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XLSM to XLT C# Conversion" offSpacer="" %}}

```cs
// load the XLSM file in an instance of Workbook
var book = new Workbook("template.xlsm");
// save XLSM as XLT
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XLSM to XLT" sectionDescription="Check our live demos for [XLSM to XLT conversion](https://products.aspose.app/cells/conversion/xlsm-to-xlt) with following benefits." >}}
