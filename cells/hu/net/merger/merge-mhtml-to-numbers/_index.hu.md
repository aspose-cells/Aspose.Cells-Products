...
url: /hu/net/merger/merge-mhtml-to-numbers/ 
...
következő példa bemutatja, hogyan lehet egyesíteni a MHTML-et a NUMBERS-szel a Aspose.Cells-es for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a MHTML-es számot a NUMBERS számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML és a NUMBERS egyesítéséhez" %}}
