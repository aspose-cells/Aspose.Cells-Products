---
title: Gộp XLTX thành HTM - Gộp XLTX thành HTM thành C++
url: /vi/cpp/merger/merge-xltx-to-htm/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất trực tuyến miễn phí XLTX thành định dạng lưu HTM. C++ Gộp XLTX sang định dạng HTM. Hợp nhất XLTX thành HTM trong C++. XLTX Hợp nhất.
...
Ví dụ sau minh họa cách hợp nhất XLTX thành HTM trong Aspose.Cells for C++.
...
{{% cells-merger title="Trực tuyến miễn phí để hợp nhất XLTX với HTM trong C++" InputFormat="xltx" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XLTX với HTM qua C++" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất XLTX với HTM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API có thể được thực hiện chỉ với vài dòng mã.
