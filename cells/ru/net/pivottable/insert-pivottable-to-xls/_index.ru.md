---
title:  Вставьте сводную таблицу в файлы Micorsoft Excel XLS через C#.
weight: 7690
description: C# Пример кода для добавления сводной таблицы в XLS с использованием библиотеки .NET. Используйте этот код для вставки сводной таблицы в файл XLS в VB.NET, Asp.NET или любое приложение на основе .NET.
...
{{< blocks/products/pf/i18n/upper-banner h1="Вставьте сводную таблицу в документы XLS через C#." h2="Встроенная и высокопроизводительная Microsoft электронная таблица Excel XLS со сводной таблицей, созданная программно с использованием серверных API .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Создать файл MS Excel XLS со сводной таблицей динамически в работающем приложении очень просто. Чтобы создать документы XLS с помощью сводной таблицы с нуля, не используя MS Office, мы будем использовать[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API, который предлагает различные функции для создания, обработки и преобразования электронных таблиц с использованием платформы .NET. Разработчики могут легко улучшить код для записи данных, создания диаграмм или графиков, а также создания таблиц в электронных таблицах.
{{% /blocks/products/pf/agp/content %}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Как вставить сводную таблицу в XLS через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчикам легко вставить сводную таблицу в формате XLS в различные приложения для создания отчетов для обработки данных всего за несколько строк кода.
...
{{% blocks/products/pf/agp/code-block title="Вставьте сводную таблицу в XLS–C#." offSpacer="" %}}
