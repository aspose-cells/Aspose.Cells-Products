...
description: Aspose Excel. Konwertuj XLSX na DOCX szybko i łatwo za pomocą Aspose.Cells. PHP XLSX na DOCX. PHP Zapisz XLSX na DOCX. Zapisz XLSX jako DOCX używając PHP.
...
Chcesz programowo przekonwertować pliki XLSX na DOCX? Programiści PHP mogą łatwo załadować i przekonwertować XLSX na DOCX w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSX na numer DOCX, wywołując metodę zapisu skoroszytu.
