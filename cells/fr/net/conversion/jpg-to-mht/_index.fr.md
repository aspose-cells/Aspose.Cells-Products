---
title: C# JPG en MHT - Convertisseur JPG en MHT en ligne
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir JPG en format de sauvegarde MHT. C# Format JPG vers MHT. Enregistrez JPG sur MHT C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez JPG en MHT au C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir JPG en MHT en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir JPG en MHT. Téléchargez votre fichier JPG, puis enregistrez-le simplement en tant que fichier MHT. Pour la lecture JPG et l'écriture MHT, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage MHT de sortie seront identiques au document JPG d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir JPG en MHT en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en MHT par programmation ? Les développeurs .NET peuvent facilement charger et convertir JPG en MHT en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C# bibliothèque pour convertir JPG en MHT" %}}
