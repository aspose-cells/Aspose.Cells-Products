---
title: A XLSB egyesítése az IMAGE-val – a XLSB-es szám egyesítése az IMAGE-val a C++-ben
url: /hu/cpp/merger/merge-xlsb-to-image/ 
description: Aspose Excel. C++ Aspose.Cells. A XLSB egyesítése az IMAGE mentési formátumba. C++ A XLSB kombinálása IMAGE formátumba. A XLSB egyesítése a C++-es számú IMAGE-val. XLSB Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A XLSB egyesítése az IMAGE-val a C++-ben" %}}

következő példa bemutatja, hogyan lehet egyesíteni a XLSB-et az IMAGE-val a Aspose.Cells-es for C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLSB és az IMAGE egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el az IMAGE fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++ példát, amely egyesíti a XLSB-et az IMAGE-be.
...
{{% blocks/products/pf/agp/content h2="A XLSB és az IMAGE egyesítése a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLSB-et az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a XLSB és az IMAGE egyesítéséhez" %}}
