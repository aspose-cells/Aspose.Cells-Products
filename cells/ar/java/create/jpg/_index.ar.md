...
description: Aspose اكسل. Java قم بإنشاء ملف JPG بسرعة وسهولة باستخدام Aspose.Cells. قم بإنشاء ملف JPG باستخدام Java. قم بإنشاء ملف JPG في Java. Java JPG Creator.
...
{{< blocks/products/pf/i18n/upper-banner h1="قم بإنشاء ملف JPG في Java" h2="مكتبة Java عالية السرعة لإنشاء ملف JPG. هذا حل برمجي احترافي لاستيراد وتصدير XLSX وPDF والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء JPG في Java" %}}
...
1.  احفظ المصنف بتنسيق JPG باستخدام طريقة save().
