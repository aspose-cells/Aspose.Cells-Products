...
Poniższy przykład pokazuje, jak przekonwertować XLTM na DOCX w Python via NET.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTM na DOCX" %}}
