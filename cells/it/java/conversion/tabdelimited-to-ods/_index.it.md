---
title: Converti TABDELIMITED in ODS tramite Java 
url: /it/java/conversion/tabdelimited-to-ods/ 
description: Esempio di codice di conversione Java per il formato TABDELIMITED in file ODS. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in ODS all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti TABDELIMITED in ODS tramite Java" h2="Conversione da TABDELIMITED a ODS Java per convertire pagine singole o multiple in ODS utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire TABDELIMITED in ODS utilizzando Java" %}}

 Per rendere TABDELIMITED a ODS, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TABDELIMITED in ODS tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente il file TABDELIMITED in ODS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TABDELIMITED con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione ODS e SaveFormat come parametri1. Controllare il percorso specificato per il file ODS risultante
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED a ODS Java codice sorgente di conversione" offSpacer="" %}}

```cs
// caricare il file TABDELIMITED in un'istanza di Workbook
Workbook book = new Workbook("template.tabdelimited");
// salva TABDELIMITED come ODS
