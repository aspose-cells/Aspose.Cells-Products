---
title:  Combinar XLS a XLSX via Java
...
El siguiente ejemplo muestra cómo combinar XLS con XLSX en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a XLSX en línea" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
