...
url: /th/net/merger/merge-xltm-to-prn/ 
...
ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLTM กับ PRN ใน Aspose.Cells for .NET
...
{{% blocks/products/pf/agp/text %}}
 ...
 ต้องการผสาน XLTM กับ PRN โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ห้องสมุด .NET เพื่อผสาน XLTM กับ PRN" %}}
