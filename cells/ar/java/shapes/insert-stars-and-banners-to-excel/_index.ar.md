...
{{% blocks/products/pf/agp/content h2="كيفية إدراج النجوم واللافتات في ملف Excel باستخدام Java" %}}

 من أجل إدراج Insert Stars And Banners في ملف Excel ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج النجوم واللافتات في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)لإدراج إدراج نجوم وشعارات في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج النجوم والرايات - Java" offSpacer="" %}}
