...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in IMAGE mit Aspose.Cells. PHP OTS in IMAGE. PHP OTS im IMAGE speichern. Speichern Sie OTS als IMAGE mit PHP.
...
{{% cells-convert title="Beispielcode zum Konvertieren von OTS in IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="png" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in IMAGE konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in IMAGE konvertieren.
...
1.  Konvertieren Sie OTS in IMAGE, indem Sie die Speichermethode der Arbeitsmappe aufrufen.
1. Erhalten Sie das Konvertierungsergebnis von OTS in IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in IMAGE" %}}
