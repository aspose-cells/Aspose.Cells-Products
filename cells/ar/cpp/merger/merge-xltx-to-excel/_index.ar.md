...
يوضح المثال التالي كيفية دمج XLTX إلى EXCEL في Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 هل تحتاج إلى دمج XLTX مع EXCEL برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج XLTX إلى EXCEL" %}}
