...
description: Sample C++ conversion code for HTML to XLTX format. Programmers can use this source code for batch HTML to XLTX conversion within any C++ Application.
---
