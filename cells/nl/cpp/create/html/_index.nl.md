...
description: HTML maker. Maak HTML bestanden in C++ code. Genereer HTML-bestanden met behulp van de C++-applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Maak HTML-bestand aan via C++" h2="Native en krachtige HTML (Hyper Text Markup Language) creatie programmatisch zonder Micorsoft Office met behulp van de C++-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Het is gemakkelijk voor de ontwikkelaars om HTML-bestanden te maken, laden, wijzigen en converteren binnen lopende rapportagetoepassingen voor gegevensverwerking in slechts enkele regels code.
...
1.  Sla de werkmap op als .html-bestand met de methode Save().
