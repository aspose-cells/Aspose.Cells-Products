...
description: Aspose Эксель. Преобразуйте PNG в XLSB быстро и легко с помощью Aspose.Cells. Python PNG в XLSB. Python Сохранить PNG в XLSB. Сохранить PNG как 07611134 81, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразовать PNG в XLSB в Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните с PNG по XLSB в Python." %}}

В следующем примере показано, как преобразовать PNG в XLSB в Python via NET.
...
{{% cells-convert title="Пример кода для преобразования PNG в XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xlsb" IsLandingPage="true" language="pythonnet" %}}
