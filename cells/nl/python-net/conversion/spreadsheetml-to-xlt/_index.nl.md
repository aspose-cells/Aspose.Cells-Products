...
Het volgende voorbeeld laat zien hoe u SPREADSHEETML converteert naar XLT in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML naar XLT te converteren" %}}
