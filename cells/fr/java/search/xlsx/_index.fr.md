---
title:  Rechercher XLSX document sans ouvrir via Java
weight: 6780
...
{{% blocks/products/pf/agp/content h2="Comment rechercher un fichier XLSX à l\'aide de Java" %}}
...
+ Charger le fichier XLSX en instanciant un objet Workbook.
