...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLSB do formátu uložení OTS. C# Zkombinujte XLSB do formátu OTS. Sloučit XLSB do OTS v C#. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB na OTS v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLSB do OTS v C#" InputFormat="xlsb" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
