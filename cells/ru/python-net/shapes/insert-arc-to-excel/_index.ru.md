...
{{% blocks/products/pf/agp/content h2="Как вставить дугу в файл Excel с помощью Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке файла Arc в Excel с использованием Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Вставить дугу — Python via .Net" offSpacer="" %}}
