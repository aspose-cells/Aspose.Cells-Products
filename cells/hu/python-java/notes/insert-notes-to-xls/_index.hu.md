...
{{% blocks/products/pf/agp/content h2="Jegyzetek beszúrása a XLS fájlba a Python számon keresztül" %}}
...
Az Office 365-ben a megjegyzések megjegyzések, a következő Python kód segítségével jegyzeteket szúrhat be és távolíthat el a XLS fájlból.
