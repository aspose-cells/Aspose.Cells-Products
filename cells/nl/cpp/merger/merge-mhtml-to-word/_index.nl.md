---
title: Voeg MHTML samen met WORD - Combineer MHTML met WORD in C++
url: /nl/cpp/merger/merge-mhtml-to-word/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen MHTML naar WORD-opslagformaat. C++ Combineer MHTML naar WORD-formaat. Samenvoegen MHTML naar WORD in C++. MHTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis MHTML samen met WORD in C++ Online" %}}

Het volgende voorbeeld laat zien hoe u MHTML kunt samenvoegen met WORD in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHTML samen te voegen met WORD. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een WORD-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat MHTML samenvoegt met WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om MHTML samen te voegen met WORD in C++" InputFormat="mhtml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe MHTML samen te voegen met WORD via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHTML programmatisch samenvoegen met WORD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om MHTML samen te voegen met WORD" %}}
