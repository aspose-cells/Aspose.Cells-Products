...
{{% blocks/products/pf/agp/content h2="Sla TXT op in JSON in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar JSON in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar JSON of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar JSON? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar JSON met slechts een paar regels code.
