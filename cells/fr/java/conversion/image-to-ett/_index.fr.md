---
title: Java IMAGE en ETT - Convertisseur IMAGE en ETT
description: Aspose Exceller. Convertissez IMAGE en ETT rapidement et facilement avec Aspose.Cells. Java IMAGE en ETT. Java Enregistrez l'IMAGE dans ETT. Enregistrez l'IMAGE sous ETT en utilisant le Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE dans ETT au Java" %}}

L'exemple suivant montre comment convertir IMAGE en ETT dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir IMAGE en ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE en ETT par programme ? Les développeurs Java peuvent facilement convertir IMAGE en ETT en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en ETT" %}}
{{% blocks/products/pf/agp/text %}}
