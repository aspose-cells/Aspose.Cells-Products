---
title: ODS を JPG に結合 - ODS を JPG に結合して C#
url: /ja/net/merger/merge-ods-to-jpg/ 
description: Aspose エクセル。 C# Aspose.Cells。無料オンライン ODS を JPG 保存形式にマージします。 C# ODS を JPG 形式に結合します。 ODS を C# の JPG に結合します。 ODS 結合します。
...
{{% blocks/products/pf/agp/content h2="ODSをオンラインで無料でODSのJPGに結合します" %}}

次の例は、ODS を Aspose.Cells for .NET の JPG にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、ODS を JPG に結合します。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルを結合し、JPG ファイルに保存します。 C# でコードを開発する場合、これは思っているより簡単です。 ODS を JPG にマージする C# の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="オンラインでODSをC#のJPGにマージする無料" InputFormat="ods" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C#を介してODSをJPGに結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

ODS をプログラムで JPG にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
