---
title: C# XLS zu HTM - XLS zu HTM Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das HTM-Format und ermöglicht das nahtlose Speichern von XLS-Daten im HTM-Format mithilfe der Aspose.Cells-Bibliothek, alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS in HTM in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in HTM in C# umwandelt.
...
{{% blocks/products/pf/agp/content h2="Wie man XLS über C# in HTM umwandelt" %}}

{{% blocks/products/pf/agp/text %}}

Müssen XLS-Dateien programmatisch in HTM konvertiert werden? Entwickler können .NET-Dateien problemlos mit nur wenigen Codezeilen laden und in HTM konvertieren.
...
1.  Konvertieren Sie XLS in HTM, indem Sie die Methode Workbook.Save aufrufen.
1.  Ermitteln Sie das Umrechnungsergebnis von XLS in HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in HTM" %}}
