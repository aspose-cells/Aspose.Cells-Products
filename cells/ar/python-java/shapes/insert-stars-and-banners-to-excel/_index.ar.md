...
{{% blocks/products/pf/agp/content h2="كيفية إدراج نجمة/شعار في ملف Excel باستخدام Python via Java" %}}

 من أجل إدراج النجمة/الشعار في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج نجمة/شعار في ملف Excel باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج نجمة/شعار في ورقة العمل المحددة
...
يوضح نموذج التعليمات البرمجية أدناه كيفية إدراج "math plus". لمزيد من الأنواع، يرجى الرجوع إلى "نظرة عامة على أنواع النجوم والشعارات" أدناه.

{{% blocks/products/pf/agp/code-block title="أدخل نجمة/شعار - Python via Java" offSpacer="" %}}
