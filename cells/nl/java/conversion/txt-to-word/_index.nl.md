...
{{% blocks/products/pf/agp/content h2="Sla TXT op in WORD in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar WORD in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar WORD of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar WORD? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar WORD met slechts een paar regels code.
