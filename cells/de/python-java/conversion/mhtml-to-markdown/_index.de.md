---
title: Konvertieren Sie MHTML in MARKDOWN über Python
url: /de/python-java/conversion/mhtml-to-markdown/
description: Beispielcode für die Umwandlung von MHTML zu Markdown Python. Verwenden Sie API Beispielcode für Batch-MHTML-Dateien zur Markdown-Konvertierung in der Anwendung Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie MHTML in MARKDOWN über Python" h2="Exportieren Sie Excel®-Tabellen mithilfe von Python-APIs in das MARKDOWN-Format." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie MHTML in MARKDOWN mit Python" %}}

 Um MHTML in MARKDOWN zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von MHTML in MARKDOWN über Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-Entwickler können MHTML-Dateien in nur wenigen Codezeilen einfach laden und in MARKDOWN konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die MHTML-Datei mit einer Instanz von Workbook1. Rufen Sie die Workbook.Save-Methode auf1. Übergeben Sie den Ausgabepfad mit der Erweiterung MD als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende MARKDOWN-Datei
