---
title: Sloučit EXCEL do WORD - Kombinujte EXCEL s WORD v C#
url: /cs/net/merger/merge-excel-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Online zdarma sloučit formát uložení EXCEL do WORDu. C# Kombinujte formát EXCEL a WORD. Sloučit EXCEL do WORD v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL do WORD v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit EXCEL do WORD v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení EXCELu s WORDem. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí EXCEL do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení EXCEL do WORD v C#" InputFormat="xlsx" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL do WORD přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit EXCEL s WORDem? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu ke sloučení EXCELu s WORDem" %}}
