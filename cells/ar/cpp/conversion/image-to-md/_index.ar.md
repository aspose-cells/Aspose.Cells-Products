...
هل تحتاج إلى تحويل ملفات IMAGE إلى MD برمجياً؟ يمكن للمطورين C++ تحويل IMAGE إلى MD بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى MD عن طريق استدعاء طريقة Save().
