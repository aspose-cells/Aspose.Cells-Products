---
title: Convertir TSV en XLSB via C#
url: /fr/net/conversion/tsv-to-xlsb/
description: Exemple de code pour la conversion tsv vers xlsb C#. Utilisez l'exemple de code API pour la conversion par lots de fichiers tsv en xlsb dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TSV en XLSB via C#" h2="Exportez des feuilles de calcul Excel® au format XLSB sur .NET Framework, .NET Core, Mono ou Xamarin Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers TSV en XLSB en quelques lignes de code seulement.
