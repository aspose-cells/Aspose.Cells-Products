...
{{% blocks/products/pf/agp/code-block title="Örnek kod, C#\'de JPG dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="JPG dosyası oluşturmak için C# kitaplığı" %}}
