---
title: Comment dessiner ou insérer une forme de flèche incurvée dans Excel à l'aide de Python via .Net
weight: 10
description: Python via Code source .Net pour insérer une forme de flèche incurvée dans Excel.
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)pour insérer une forme de flèche incurvée dans la feuille de calcul sélectionnée.
