---
title: Konversi XLSB ke XLSX melalui C++ aplikasi 
weight: 10130
url: /id/cpp/conversion/xlsb-to-xlsx/ 
description: Contoh C++ kode konversi untuk dokumen XLSB ke format XLSX. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLSB ke XLSX dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLSB ke XLSX melalui C++" h2="Konversi XLSB ke XLSX berperforma tinggi menggunakan pustaka C++ tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLSB ke XLSX Menggunakan C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi XLSB ke XLSX melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ pengembang dapat dengan mudah mengonversi file XLSB ke XLSX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLSB menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (XLSX).1. File XLSX akan disimpan di jalur yang ditentukan.1. Buka file XLSX di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLSB ke XLSX C++ Kode Sumber Konversi" offSpacer="" %}}
