...
url: /python-java/conversion/fods-to-svg/
description: Sample code for fods to svg Python conversion. Use API example code for batch fods files to svg conversion within Python application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert FODS to SVG Using Python" %}}

 In order to convert FODS to SVG, we will use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert FODS to SVG via Python" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert FODS to SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="svg" IsLandingPage="true" language="python" %}}
