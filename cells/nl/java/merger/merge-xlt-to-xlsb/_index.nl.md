---
title: Voeg XLT samen met XLSB - Combineer XLT met XLSB in Java
url: /nl/java/merger/merge-xlt-to-xlsb/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online Samenvoegen XLT naar XLSB saveformat. Java Combineer het formaat XLT tot XLSB. Samenvoegen XLT tot XLSB in Java. XLT Samenvoegen.
keywords: [Aspose Excel., Java Aspose.Cells., Merge XLT to XLSB in Java., Free Online Java Merge XLT to xlsb., Java Combine XLT to XLSB Online for Free., XLT Merge]
---
...
Het volgende voorbeeld laat zien hoe u XLT samenvoegt met XLSB in Aspose.Cells for Java.
...
{{% cells-merger title="Gratis online om XLT samen te voegen tot XLSB in Java" InputFormat="xlt" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLT samen te voegen tot XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen tot XLSB? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
