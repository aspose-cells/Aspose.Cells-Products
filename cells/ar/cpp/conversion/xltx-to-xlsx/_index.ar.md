...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTX إلى XLSX باستخدام C++" %}}
 ...
 من أجل تحويل XLTX إلى XLSX ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يستطيع مطورو برامج C++ تحويل ملف XLTX بسهولة إلى XLSX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLTX باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLSX).1. سيتم حفظ ملف XLSX في المسار المحدد.1. افتح ملف XLSX في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLTX إلى XLSX C++ شفرة مصدر التحويل" offSpacer="" %}}
