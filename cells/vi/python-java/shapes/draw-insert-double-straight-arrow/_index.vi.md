---
title:  Làm cách nào để vẽ hoặc chèn mũi tên thẳng kép vào Excel bằng Python via java
weight: 10
description: Python via mã nguồn java vẽ hoặc chèn mũi tên thẳng kép vào Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chèn mũi tên thẳng kép vào Excel bằng Python via java" h2="Chèn mũi tên thẳng kép dùng Aspose.Cells\' API không cần phần mềm nào như Microsoft hay Open Office, Adobe PDF..." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chèn mũi tên thẳng kép vào file Excel bằng Python via java" %}}

Để chèn mũi tên thẳng kép vào file excel, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn mũi tên thẳng kép vào file Excel dùng Python via java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) để chèn một mũi tên thẳng kép vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn mũi tên thẳng kép - Python via java" offSpacer="" %}}
