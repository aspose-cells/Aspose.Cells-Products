---
title: Sloučit MHT s IMAGE – Sloučit MHT s IMAGE v Java
url: /cs/java/merger/merge-mht-to-image/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení IMAGE. Java Zkombinujte formát MHT s formátem IMAGE. Sloučit MHT do IMAGE v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do IMAGE v Java" %}}

Následující příklad ukazuje, jak sloučit MHT do IMAGE v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT s IMAGE. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru IMAGE. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT do IMAGE v Java" InputFormat="mht" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT s IMAGE via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit MHT s IMAGE? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení MHT do IMAGE" %}}
