---
title: Chèn/Tạo sơ đồ vào Excel via Java
weight: 360
description: Chèn/Tạo FlowChart bằng Aspose.Cells' Java API không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v.
keywords: [Java Aspose.Cells., Java add FlowChart., Java insert FlowChart., Java create FlowChart]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn/Tạo sơ đồ vào Excel via Java" h2="Chèn/Tạo FlowChart bằng Aspose.Cells\' API không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách chèn/tạo FlowChart vào tệp Excel bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn/tạo FlowChart vào file Excel via Java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) để chèn/tạo FlowChart trong bảng tính đã chọn
...
Mã mẫu bên dưới minh họa cách chèn "Đa tài liệu". Để biết thêm các loại, vui lòng tham khảo "Tổng quan về các loại hình dạng mũi tên khối" bên dưới.

{{% blocks/products/pf/agp/code-block title="Chèn/Tạo sơ đồ - Java" offSpacer="" %}}
