...
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori C++ un approccio completamente integrato per convertire MHT nel formato SXC, consentendo il salvataggio senza interruzioni dei dati MHT nel formato SXC utilizzando la libreria Aspose.Cells, il tutto tramite codice C++ efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva MHT a SXC in C++" %}}
...
Hai bisogno di convertire i file MHT in SXC tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in SXC in poche righe di codice.
...
1.  Convertire MHT in SXC chiamando il metodo Save().
