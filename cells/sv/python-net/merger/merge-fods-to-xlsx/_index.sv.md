---
title: Slå samman FODS till XLSX - Kombinera FODS till XLSX i Python
url: /sv/python-net/merger/merge-fods-to-xlsx/ 
description: Aspose Excel. Python Aspose.Cells. Slå samman FODS till XLSX sparaformat. Python Kombinera FODS till XLSX format. Slå samman FODS till XLSX i Python. FODS Slå samman.
...
{{% cells-merger title="Exempelkod för att slå samman FODS till XLSX i Python" InputFormat="fods" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman FODS till XLSX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman FODS till XLSX programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API:er kan göras med bara några rader kod.
