---
title: Java OTS 轉 EXCEL - 在線 OTS 轉 EXCEL 轉換器
description: Aspose Excel。 Java Aspose.Cells. Java Aspose Cells. 免費在線 Java 將 OTS 轉換為 EXCEL 保存格式。 Java OTS 轉 EXCEL 格式。將 OTS 保存到 EXCEL Java。
...
{{% blocks/products/pf/agp/content h2="Java在線免費將OTS保存為EXCEL" %}}

下面的例子演示瞭如何將Java中的OTS轉換為EXCEL。
...
需要以編程方式將 OTS 文件轉換為 EXCEL？ Java 開發人員只需幾行代碼即可輕鬆將 OTS 轉換為 EXCEL。
