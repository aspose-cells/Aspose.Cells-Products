---
title: Conversor PHP TSV para TSV - TSV para TSV
description: Aspose Excel. Converta TSV em TSV de forma rápida e fácil com Aspose.Cells. PHP TSV em TSV. PHP Salve TSV em TSV. Salve TSV como TSV usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter TSV em TSV via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em TSV programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em TSV em apenas algumas linhas de código.
...
1.  Converta TSV em TSV chamando o método save da pasta de trabalho.
