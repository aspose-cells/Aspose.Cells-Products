---
title: XLAM PRN-re – XLAM konvertálása PRN-fájlokká C++
description: Aspose Excel. Ingyenes online konvertálása XLAM PRN mentési formátumba. C++ XLAM PRN formátumba. Mentse el a XLAM-et PRN-ként a C++-ben.
keywords: [Aspose Excel., C++ Aspose.Cells., C++ XLAM to PRN saveformat., Free Online XLAM to PRN Converter]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja a XLAM-et PRN-re a C++-ben" h2="Nagy teljesítményű XLAM konvertálás PRN-re a C++ könyvtár használatával, anélkül, hogy szükség lenne a Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítésére." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertálja a XLAM-et PRN-re a C++ használatával" %}}
...
{{% blocks/products/pf/agp/content h2="Takarítson meg XLAM-et a PRN számára a C++-es számon online ingyen" %}}

A következő példa bemutatja, hogyan lehet a XLAM-et PRN-re konvertálni a C++-ben.
...
A XLAM fájlokat programozottan PRN-re kell konvertálni? A C++ fejlesztők könnyedén konvertálhatják a XLAM-et PRN-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a XLAM-et PRN-re a Save() metódus meghívásával.
