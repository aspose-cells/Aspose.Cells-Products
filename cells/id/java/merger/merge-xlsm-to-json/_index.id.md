---
title: Gabungkan XLSM menjadi JSON - Gabungkan XLSM menjadi JSON menjadi Java
url: /id/java/merger/merge-xlsm-to-json/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLSM menjadi JSON format simpan. Java Gabungkan format XLSM menjadi JSON. Gabungkan XLSM menjadi JSON di Java. XLSM Gabungkan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan XLSM menjadi JSON via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan XLSM menjadi JSON. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="XLSM" additionalConversionTag="JSON" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSM menjadi JSON di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLSM menjadi JSON di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLSM ke JSON. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file JSON. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan XLSM menjadi JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLSM menjadi JSON di Java" InputFormat="xlsm" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSM menjadi JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSM ke JSON secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan XLSM menjadi JSON" %}}
