...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLT ke TIFF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLT menggunakan Factory::CreateIWorkbook.1. Pilih lembar kerja pertama.1. Setel (TIFF) opsi.1. Iterasi melalui setiap halaman lembar dan render.1. Buka file TIFF di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLT ke TIFF C++ Kode Sumber Konversi" offSpacer="" %}}
