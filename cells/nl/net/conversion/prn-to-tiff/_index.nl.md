...
description: Aspose Excel. Deze complete oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van PRN-bestanden naar het TIFF-formaat. Hierdoor kunnen PRN-gegevens naadloos worden opgeslagen in het TIFF-formaat met behulp van de Aspose.Cells-bibliotheek, allemaal via efficiënte en aanpasbare C#-code.
...
{{% blocks/products/pf/agp/content h2="Sla PRN op als TIFF in C#" %}}

Het volgende voorbeeld laat zien hoe u PRN naar TIFF kunt converteren in C#.
...
{{% cells-convert title="Voorbeeldcode om PRN om te zetten naar TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="prn" outformat="tiff" IsLandingPage="true" %}}
