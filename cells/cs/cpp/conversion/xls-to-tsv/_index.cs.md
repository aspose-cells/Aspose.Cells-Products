---
title: Převeďte XLS na TSV pomocí aplikace C++ 
weight: 3190
url: /cs/cpp/conversion/xls-to-tsv/ 
description: Ukázkový konverzní kód C++ pro dokument XLS na formát TSV. Programátoři mohou tento zdrojový kód použít pro dávkový převod XLS na TSV v jakékoli aplikaci C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést XLS na TSV přes C++" h2="Vysoce výkonný převod XLS na TSV pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést XLS na TSV pomocí C++" %}}
 ...
 K převodu XLS na TSV použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLS na TSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLS pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou souboru (TSV).1. Soubor TSV bude uložen do zadané cesty.1. Otevřete soubor TSV v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLS na TSV C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze XLS na TSV" sectionDescription="[Převést XLS na TSV](https://products.aspose.app/cells/conversion/xls-to-tsv) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor XLS, bude okamžitě převeden na TSV." >}}
