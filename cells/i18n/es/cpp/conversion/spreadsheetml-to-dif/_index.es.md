---
title: Convierta SPREADSHEETML a DIF a través de la aplicación C++ 
url: /es/cpp/conversion/spreadsheetml-to-dif/ 
description: Ejemplo de código de conversión C++ para documento SPREADSHEETML a formato DIF. Los programadores pueden usar este código fuente para la conversión por lotes de SPREADSHEETML a DIF dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo SPREADSHEETML a DIF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo SPREADSHEETML usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (DIF).1. El archivo DIF se guardará en la ruta especificada.1. Abra el archivo DIF en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML a DIF C++ Código fuente de conversión" offSpacer="" %}}
