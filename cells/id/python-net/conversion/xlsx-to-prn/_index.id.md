...
description: Aspose Unggul. Ubah XLSX menjadi PRN dengan cepat dan mudah dengan Aspose.Cells. Python XLSX menjadi PRN. Python Simpan XLSX ke PRN. Simpan XLSX sebagai PRN menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke PRN di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLSX ke PRN di Python via NET.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLSX ke PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="prn" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengonversi XLSX ke PRN" %}}
