---
title: C++ XML в ET - Конвертер XML в ET
...
{{% blocks/products/pf/agp/content h2="Сохранение XML в ET в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в ET в файле C++.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать XML в ET по номеру C++" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать XML-файлы в формат ET? Разработчики, использующие код C++, могут легко преобразовать XML в ET всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для преобразования XML в ET" %}}
