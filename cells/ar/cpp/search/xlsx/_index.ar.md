---
title:  ابحث عن مستند XLSX بدون فتح عبر C++
weight: 9280
description: C++ رمز المثال للبحث عن الكلمات ذات النمط في ملف XLSX على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث عن الملفات XLSX في C++" %}}
...
+ قم بتحميل ملف XLSX عن طريق إنشاء فئة Workbook.
...
+ احفظ ملف XLSX باستخدام طريقة Workbook::Save(...).
...
{{% blocks/products/pf/agp/code-block title="بحث XLSX ملفات - C++" offSpacer="" %}}
