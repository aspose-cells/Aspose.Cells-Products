---
title: Převést ODS na HTML prostřednictvím Java 
weight: 1560
url: /cs/java/conversion/ods-to-html/ 
description: Ukázkový konverzní kód Java pro formát ODS na soubor HTML. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do HTML v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODS na HTML prostřednictvím Java" h2="Převod ODS na HTML Java pro převod jedné nebo více stránek do HTML pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na HTML pomocí Java" %}}

 K vykreslení ODS do HTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na HTML prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS do HTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Jako parametry předejte výstupní cestu s rozšířením HTML a SaveFormat1. Zkontrolujte zadanou cestu pro výsledný soubor HTML
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODS na HTML Java" offSpacer="" %}}

```cs
// načtěte soubor ODS v instanci Workbooku
Workbook book = new Workbook("template.ods");
// uložit ODS jako HTML
