...
description: Aspose Excel. Java Aspose.Cells. Sloučit SPREADSHEETML do PPTX saveformat. Java Zkombinujte SPREADSHEETML do formátu PPTX. Sloučit SPREADSHEETML na PPTX v Java. SPREADSHEETML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit SPREADSHEETML na PPTX v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení SPREADSHEETML do PPTX v Java" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
