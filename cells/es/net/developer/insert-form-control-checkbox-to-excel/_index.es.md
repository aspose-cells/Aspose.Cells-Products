...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar CheckBox en un archivo de Excel a través de C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) para insertar un CheckBox en la hoja de trabajo seleccionada
