...
{{% blocks/products/pf/agp/content h2="Convert OTS to BMP Using Python Excel Library" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTS to BMP in Python Excel Library" %}}

The following example demonstrates how to convert OTS to BMP in Python excel library.
...
{{% blocks/products/pf/agp/content h2="Python Excel Library to Convert OTS to BMP" %}}
