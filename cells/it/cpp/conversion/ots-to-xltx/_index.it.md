...
Hai bisogno di convertire i file OTS in XLTX tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire OTS in XLTX in poche righe di codice.
...
1.  Convertire OTS in XLTX chiamando il metodo Save().
