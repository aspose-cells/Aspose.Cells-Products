---
title: Объединить ЧИСЛА в SPREADSHEETML — Объединить ЧИСЛА в SPREADSHEETML в Python.
url: /ru/python-java/merger/merge-numbers-to-spreadsheetml/ 
description: Aspose Эксель. Python Aspose.Cells. Объедините ЧИСЛА в формат сохранения SPREADSHEETML. Python Объедините ЧИСЛА в формат SPREADSHEETML. Объедините NUMBERS с SPREADSHEETML в Python. NUMBERS Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините ЧИСЛА в SPREADSHEETML, используя Python" %}}
...
{{% blocks/products/pf/agp/content h2="Объединить NUMBERS с SPREADSHEETML в Python" %}}
...
{{% cells-merger title="Пример кода для объединения NUMBERS с SPREADSHEETML в Python" InputFormat="numbers" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Как объединить ЧИСЛА в SPREADSHEETML через Python" %}}
