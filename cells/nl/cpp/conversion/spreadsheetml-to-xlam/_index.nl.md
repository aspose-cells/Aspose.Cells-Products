...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen het SPREADSHEETML-bestand gemakkelijk converteren naar XLAM in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het SPREADSHEETML-bestand met Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (XLAM) bestandsextensie.1. XLAM-bestand wordt opgeslagen op het opgegeven pad.1. Open XLAM-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML naar XLAM C++ conversiebroncode" offSpacer="" %}}
