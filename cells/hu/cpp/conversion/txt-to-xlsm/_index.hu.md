---
title: A TXT konvertálása XLSM-re a C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/txt-to-xlsm/ 
description: Minta C++ konverziós kód TXT dokumentumhoz XLSM formátumba. A programozók ezt a forráskódot használhatják a kötegelt TXT-ből XLSM-be konvertálásához bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TXT konvertálása XLSM-re a következőn keresztül: C++" h2="Nagy teljesítményű TXT-XLSM konvertálás a C++ könyvtár használatával Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="TXT konvertálása XLSM-re a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A TXT XLSM-re konvertálásának lépései a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatják a TXT fájlt XLSM-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (XLSM) fájlkiterjesztéssel.1. Az XLSM fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az XLSM fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="TXT-ből XLSM-be C++ konverziós forráskód" offSpacer="" %}}
