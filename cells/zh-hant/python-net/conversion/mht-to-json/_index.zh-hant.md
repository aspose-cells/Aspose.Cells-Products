...
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 MHT 轉換為 JSON 格式，從而能夠使用 Aspose.Cells 庫將 MHT 資料無縫保存為 JSON 格式，所有這些程式都透過高效能客製化的 08153481 1081348133。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Python Excel 庫中的 MHT 轉換為 JSON" h2="高速 Python Excel 函式庫，用於將 MHT 轉換為 JSON。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將 Python Excel 庫中的 MHT 轉換為 JSON" %}}
...
{{% blocks/products/pf/agp/content h2="將 MHT 儲存到 Python Excel 庫中的 JSON" %}}

以下範例示範如何將 Python excel 庫中的 MHT 轉換為 JSON。
...
{{% cells-convert title="透過 Python Excel 庫將 MHT 轉換為 JSON 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="json" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 MHT 轉換為 JSON" %}}
