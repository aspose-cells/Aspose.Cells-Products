...
{{% blocks/products/pf/agp/content h2="Comment insérer une image dans un fichier Excel à l\'aide de Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une image dans un fichier Excel à l\'aide de Python via Java" %}}
