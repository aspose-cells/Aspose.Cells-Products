---
title: Python PRN zu XPS - PRN zu XPS Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von PRN-Daten in das Format XPS und ermöglicht das nahtlose Speichern von PRN-Daten im Format XPS mithilfe der Bibliothek Aspose.Cells – alles durch effizienten und anpassbaren Code Python.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie PRN in XPS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie PRN-Dateien programmgesteuert in XPS konvertieren? Python-Entwickler können PRN mit nur wenigen Codezeilen problemlos in XPS laden und konvertieren.
...
1.  Konvertieren Sie PRN in XPS, indem Sie die Methode Workbook.save aufrufen.
1.  Holen Sie sich das Konvertierungsergebnis von PRN in XPS.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel-Bibliothek zum Konvertieren von PRN in XPS" %}}
