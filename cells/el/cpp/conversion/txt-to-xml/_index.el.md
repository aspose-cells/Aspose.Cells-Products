---
title: Μετατροπή TXT σε XML μέσω της εφαρμογής C++ 
url: /el/cpp/conversion/txt-to-xml/ 
description: Δείγμα κώδικα μετατροπής C++ για έγγραφο TXT σε μορφή XML. Οι προγραμματιστές μπορούν να χρησιμοποιήσουν αυτόν τον πηγαίο κώδικα για ομαδική μετατροπή TXT σε XML σε οποιαδήποτε εφαρμογή C++.
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το TXT σε XML χρησιμοποιώντας το C++" %}}

 Για να μετατρέψουμε το TXT σε XML, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή TXT σε XML μέσω C++" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του C++ μπορούν εύκολα να μετατρέψουν το αρχείο TXT σε XML σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φορτώστε το αρχείο TXT χρησιμοποιώντας το Factory::CreateIWorkbook.1. Καλέστε τη μέθοδο Save().1. Περάστε τη διαδρομή του αρχείου εξόδου με επέκταση αρχείου (XML).1. Το αρχείο XML θα αποθηκευτεί στην καθορισμένη διαδρομή.1. Ανοίξτε το αρχείο XML σε συμβατό πρόγραμμα.
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής TXT σε XML C++" offSpacer="" %}}
