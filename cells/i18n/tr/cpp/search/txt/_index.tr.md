...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak TXT Dosyasını Arama" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ İçinde TXT Dosyalarını Arama Adımları" %}}
...
+ Bir IWorkbook sınıfını başlatarak TXT dosyasını yükleyin.
...
+ TXT dosyasını IWorkbook->Save(.) yöntemini kullanarak kaydedin.
