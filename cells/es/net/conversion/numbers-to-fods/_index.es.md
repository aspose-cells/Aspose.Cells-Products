...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir NUMBERS a FODS a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos NUMBERS a FODS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo NUMBERS con una instancia de Workbook1. Llame al método Workbook.Save1. Pase la ruta de salida con la extensión FODS como parámetro1. Compruebe la ruta especificada para el archivo FODS resultante
...
{{% cells-convert title="Aplicación gratuita y código de muestra para convertir NÚMEROS a FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="fods" IsLandingPage="true" %}}
