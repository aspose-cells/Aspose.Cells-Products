---
title: تقسيم ملفات XLSB عبر Java 
weight: 7880
url: /ar/java/splitter/xlsb/ 
description: Java نموذج كود لتقسيم مستندات XLSB على Java Runtime Environment لتطبيق JSP / JSF وتطبيقات سطح المكتب.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تقسيم ملفات XLSB عبر Java" h2="تقسيم XLSB بمساعدة مكتبة Java جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تقسيم ملف XLSB باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تقسيم ملفات XLSB بتنسيق Java" %}}
...
+ استدعاء طريقة الحفظ مع مسار ملف XLSB الجديد.
...
{{% blocks/products/pf/agp/code-block title="تقسيم ملف XLSB - Java" offSpacer="" %}}
