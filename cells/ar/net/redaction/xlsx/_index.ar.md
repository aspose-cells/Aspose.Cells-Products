---
title:  بحث واستبدال النص في XLSX مستند via .NET
weight: 2370
description: كود المصدر C# لتنقيح المعلومات الحساسة في ملف XLSX على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
