...
{{< blocks/products/pf/i18n/upper-banner h1="Analyzovat formáty ODS v Java" h2="Nativní a vysoce výkonná analýza dokumentů ODS pomocí rozhraní API Aspose.Cells for Java na straně serveru bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak analyzovat soubor ODS pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k analýze souborů ODS v Java" %}}
...
+ Načíst dokument ODS pomocí třídy Workbook.
...
{{% blocks/products/pf/agp/code-block title="Analýza souborů ODS – Java" offSpacer="" %}}
