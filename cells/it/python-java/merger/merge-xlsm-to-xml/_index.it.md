...
url: /it/python-java/merger/merge-xlsm-to-xml/ 
...
L'esempio seguente mostra come unire XLSM a XML in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Hai bisogno di unire XLSM a XML a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Le API possono essere eseguite con poche righe di codice.
