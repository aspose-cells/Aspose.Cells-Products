---
title: دمج TXT إلى HTM - اجمع TXT إلى HTM في Java
url: /ar/java/merger/merge-txt-to-htm/ 
description: Aspose إكسل. Java Aspose.Cells. الدمج المجاني عبر الإنترنت TXT إلى HTM saveformat. Java ادمج TXT بتنسيق HTM. دمج TXT إلى HTM في Java. TXT دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج TXT إلى HTM في Java عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج TXT إلى HTM في Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج TXT في HTM. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف HTM. إذا قمت بتطوير رمز في Java ، فسيكون هذا أبسط مما يبدو. راجع Java المثال الذي يدمج TXT إلى HTM.
...
{{% blocks/products/pf/agp/content h2="كيفية دمج TXT مع HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج TXT مع HTM برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for Java](https://products.aspose.com/cells/java) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="Java مكتبة لدمج TXT إلى HTM" %}}
