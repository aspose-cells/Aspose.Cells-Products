...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση μορφής αποθήκευσης HTM σε XML. Python Συνδυάστε μορφή HTM σε XML. Συγχώνευση HTM σε XML στο Python. Συγχώνευση HTM.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση HTM σε XML στο Python" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση HTM σε XML στο Python" InputFormat="htm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
