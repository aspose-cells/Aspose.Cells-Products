...
{{% blocks/products/pf/agp/content h2="Как вставить блок-стрелки в файл Excel, используя Python via .Net" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте добавление коллекции форм[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) чтобы вставить блок-стрелки в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставить стрелки блока — Python via .Net" offSpacer="" %}}
