...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XML do formatu XLTX, umożliwiając bezproblemowe zapisywanie danych XML do formatu XLTX za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML do XLTX w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na XLTX w C#.
...
1.  Konwertuj XML do XLTX wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XML na XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XML do XLTX" %}}
