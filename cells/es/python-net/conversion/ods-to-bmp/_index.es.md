...
description: Aspose Excel. Convierta ODS a BMP rápida y fácilmente con Aspose.Cells. Python ODS a BMP. Python Guarde ODS en BMP. Guarde ODS como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar ODS al BMP en Python" %}}

El siguiente ejemplo demuestra cómo convertir ODS a BMP en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir ODS a BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="bmp" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir ODS en BMP" %}}
