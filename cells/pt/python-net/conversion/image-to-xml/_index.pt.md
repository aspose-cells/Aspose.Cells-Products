...
O exemplo a seguir demonstra como converter IMAGE para XML em Python via NET.
...
{{% blocks/products/pf/agp/content h2="Como converter IMAGE para XML" %}}
