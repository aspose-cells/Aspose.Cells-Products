---
title: Połącz OBRAZ z ETT - Połącz OBRAZ z ETT pod numerem C#
url: /pl/net/merger/merge-image-to-ett/ 
description: Aspose Excel. C# Aspose.Cells. Scal OBRAZ do formatu zapisu ETT. C# Połącz OBRAZ z formatem ETT. Połącz OBRAZ z ETT pod numerem C#. Połącz OBRAZ.
...
{{% blocks/products/pf/agp/content h2="Połącz OBRAZ z ETT w C#" %}}

Poniższy przykład pokazuje, jak połączyć IMAGE z ETT w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć IMAGE z ETT. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku ETT. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy IMAGE z ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia OBRAZU z ETT w C#" InputFormat="png" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć OBRAZ z ETT pod numerem C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć IMAGE z ETT? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka .NET do scalania OBRAZU z ETT" %}}
