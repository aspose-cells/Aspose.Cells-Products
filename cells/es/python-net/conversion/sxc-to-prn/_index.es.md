...
description: Aspose Excel. Convierta SXC a PRN rápida y fácilmente con Aspose.Cells. Python SXC a PRN. Python Guardar SXC en PRN. Guarde SXC como PRN usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar SXC en PRN en Python" %}}

El siguiente ejemplo demuestra cómo convertir SXC a PRN en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir SXC a PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="prn" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir SXC a PRN" %}}
