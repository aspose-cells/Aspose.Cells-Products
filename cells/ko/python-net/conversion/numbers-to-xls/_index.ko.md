---
title: 숫자를 XLS Python via Python로 변환
description: 온라인에서 NUMBERS를 XLS로 무료로 변환하세요. 무료 온라인 NUMBERS to XLS 변환기. Python NUMBERS에서 XLS로. NUMBERS에서 XLS로 Python을 통해.
...
{{% cells-convert title="온라인에서 NUMBERS를 XLS로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="xls" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="NUMBERS를 XLS로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

Python 개발자는 단 몇 줄의 코드로 NUMBERS를 XLS로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook.save 메서드를 호출하여 NUMBERS를 XLS로 변환
