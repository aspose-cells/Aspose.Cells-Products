...
هل تحتاج إلى تحويل ملفات IMAGE إلى TIFF برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى TIFF في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى TIFF باستدعاء طريقة Save ().
