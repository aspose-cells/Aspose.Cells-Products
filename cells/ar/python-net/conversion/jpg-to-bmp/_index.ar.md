---
title: Python JPG إلى BMP - محول JPG عبر الإنترنت إلى BMP
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل JPG إلى BMP saveformat. Python JPG إلى تنسيق BMP. احفظ JPG في BMP Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل JPG إلى BMP في Python" h2="مكتبة Python عالية السرعة لتحويل JPG إلى BMP. استخدم تحويل Excel الخاص بنا API لتطوير برنامج عالي المستوى ومستقل عن النظام الأساسي في Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل JPG إلى BMP في Python" %}}

 كيف أقوم بتحويل JPG إلى BMP؟ مع Aspose.Cells for Python عبر مكتبة NET ، يمكنك بسهولة تحويل JPG إلى BMP برمجيًا باستخدام بضعة أسطر من التعليمات البرمجية.[Aspose.Cells for Python عبر NET](https://pypi.org/project/aspose-cells-python/)قادر على بناء تطبيقات عبر الأنظمة الأساسية مع القدرة على إنشاء وتعديل وتحويل وعرض وطباعة جميع ملفات Excel. Python Excel API لا يقوم فقط بالتحويل بين تنسيقات جداول البيانات ، بل يمكنه أيضًا عرض ملفات Excel كصور ، PDF ، HTML ، ODS ، CSV ، SVG ، JSON ، WORD ، PPT والمزيد ، مما يجعله خيارًا مثاليًا لتبادل المستندات في معايير الصناعة الأشكال.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="احفظ JPG في BMP في Python عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية تحويل JPG إلى BMP في Python via NET.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JPG إلى BMP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات JPG إلى BMP برمجيًا؟ يمكن للمطورين Python تحميل وتحويل JPG بسهولة إلى BMP في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل JPG إلى BMP عن طريق استدعاء طريقة Workbook.save.
1.  احصل على نتيجة تحويل JPG إلى BMP.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل JPG إلى BMP" %}}
