---
title: Java HTM à PPTX - Convertisseur HTM à PPTX
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format HTM au format PPTX, permettant un enregistrement transparent des données HTM au format PPTX à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM à PPTX dans Java" %}}

L'exemple suivant montre comment convertir HTM en PPTX en Java.
...
{{% cells-convert title="Exemple de code pour convertir du HTM en PPTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="pptx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir du HTM en PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM au format PPTX par programmation ? Les développeurs spécialisés en Java peuvent facilement convertir des fichiers HTM au format PPTX en quelques lignes de code seulement.
...
1.  Convertissez HTM en PPTX en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de HTM en PPTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir HTM en PPTX" %}}
{{% blocks/products/pf/agp/text %}}
