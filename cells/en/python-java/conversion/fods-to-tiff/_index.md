...
Follow the easy steps to convert FODS into TIFF. Upload your FODS file, then simply save it as TIFF file. For both FODS reading and TIFF writing you can use fully qualified filenames. The output TIFF content and formatting will be identical to the original FODS document.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Python developers can easily load & convert FODS to TIFF in just a few lines of code.
