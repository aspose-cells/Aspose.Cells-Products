...
url: /zh-hant/python-java/merger/merge-numbers-to-prn/ 
...
以下示例演示如何將 NUMBERS 合併到 Aspose.Cells for Python via Java 中的 PRN。
...
需要以編程方式將 NUMBERS 合併到 PRN？基本文檔合併和連接[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需幾行代碼即可完成 API。
