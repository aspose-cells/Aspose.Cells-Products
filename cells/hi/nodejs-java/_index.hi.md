...
<p>
 Aspose.Cells for Node.js via Java सबसे लोकप्रिय स्प्रेडशीट प्रारूपों का समर्थन करता है जिनमें XLS, XLSX, ODS, SpreadsheetML, CSV, TSC और HTML शामिल हैं।
</p>
...
{{< blocks/products/pf/carousel-item h3="प्लेटफ़ॉर्म स्वतंत्रता" description="Aspose.Cells for Node.js via Java Node.js पर आधारित सर्वर-साइड जावास्क्रिप्ट API है। यह JDK 1.7 या उससे ऊपर के साथ Windows, Unix/Linux और Mac प्लेटफ़ॉर्म पर चल सकता है।" >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="समर्थित फ़ाइल प्रारूप" description="Aspose.Cells for Node.js via Java लोकप्रिय स्प्रेडशीट फ़ाइल प्रारूपों के साथ-साथ सबसे अधिक उपयोग किए जाने वाले छवि और निश्चित-लेआउट प्रारूपों का समर्थन करता है।" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 एडवांस्ड Node.js via Java एक्सेल स्प्रेडशीट API फीचर्स
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 पिवट टेबल, चार्ट, स्पार्कलाइन और सशर्त स्वरूपण बनाएँ
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 मौजूदा चार्ट को ताज़ा करें और चार्ट को छवियों में बदलें या PDF
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 टिप्पणियाँ और हाइपरलिंक बनाएँ और उनमें बदलाव करें
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 जटिल सूत्र सेट करें और API के माध्यम से परिणामों की गणना करें
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 कार्यपुस्तिका, कार्यपत्रक, सेल, स्तंभ या पंक्ति पर सुरक्षा सेट करें
    </p>
   </div>
   <div class="col-lg-4">
 ...
 नामित श्रेणियाँ बनाएँ और उनमें बदलाव करें
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 स्मार्ट मार्कर का उपयोग करके वर्कशीट भरें
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 API के माध्यम से पिवट टेबल्स में हेरफेर और रिफ्रेश करें
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 कार्यपत्रकों को PDF, XPS और SVG स्वरूपों में परिवर्तित करें
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 ...
 लचीले प्रदर्शन विकल्प
    ...
    <p>
 Aspose.Cells for Node.js via Java वर्कशीट के पेज सेटअप का पूरा नियंत्रण प्रदान करता है, कोई भी वर्कशीट के डिस्प्ले विकल्पों जैसे पेज ओरिएंटेशन, ब्रेक, आकार, स्केलिंग, हेडर, फ़ुटर और ज़ूम लेवल में हेरफेर कर सकता है। इसके अलावा, डेवलपर्स प्रिंट एरिया और फ़्रीज़ पैन की मदद से डेटा विज़िबिलिटी को नियंत्रित कर सकते हैं ताकि एप्लिकेशन विनिर्देशों के अनुरूप हो सके।
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 सुरक्षा विकल्प
    ...
    <p>
 Aspose.Cells for Node.js via Java स्प्रेडशीट एन्क्रिप्शन/डिक्रिप्शन, सामग्री, ऑब्जेक्ट और परिदृश्य सुरक्षा के साथ-साथ पंक्तियों, स्तंभों और कार्यपत्रकों को छिपाने और दिखाने की क्षमता सहित सुरक्षा सुविधाओं की एक विस्तृत श्रृंखला प्रदान करता है।
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 पंक्तियों और स्तंभों में हेरफेर करें
    </h2>
    <p>
Aspose.Cells for Node.js via Java आपको कई अलग-अलग तरीकों से पंक्तियों और स्तंभों में हेरफेर करने की अनुमति देता है। आप आसानी से पंक्ति की ऊंचाई और स्तंभ की चौड़ाई को समायोजित कर सकते हैं, सामग्री के अनुसार कोशिकाओं को स्वचालित रूप से आकार दे सकते हैं, सम्मिलित कर सकते हैं और हटा सकते हैं, छिपा सकते हैं और छिपा सकते हैं और साथ ही पंक्तियों और स्तंभों को समूहीकृत और असमूहीकृत कर सकते हैं।
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 वर्कशीट फ़ॉर्मेटिंग के लिए व्यापक समर्थन
    ...
    <p>
 Aspose.Cells for Node.js via Java उन्नत स्वरूपण सुविधाएँ प्रदान करता है जो आपको अपने डेटा की प्रस्तुति को नियंत्रित करने की अनुमति देता है। आप वर्कशीट, कॉलम, पंक्ति या सेल पर स्वरूपण लागू कर सकते हैं या किसी एकल सेल में रिच टेक्स्ट जोड़ सकते हैं, बॉर्डर लगा सकते हैं, बैकग्राउंड पैटर्न और फ़ॉन्ट स्टाइलिंग सेट कर सकते हैं। API आपको तुरंत सशर्त स्वरूपण नियमों को जोड़ने, हेरफेर करने और गणना करने की भी अनुमति देता है।
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 चार्ट निर्माण, हेरफेर और रेंडरिंग
    </h2>
    <p>
Aspose.Cells for Node.js via Java चार्टिंग के लिए पूर्ण सहायता प्रदान करता है। API का उपयोग करके कोई भी व्यक्ति आसानी से कस्टमाइज़ या मानक चार्ट जोड़ सकता है, और चार्ट को रीफ़्रेश करने के लिए डेटा को गतिशील रूप से सेट कर सकता है।
    </p>
   </div>
  </div>
 </div>
