---
title:  แทรกป้ายกำกับ(การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 80
description: Python via .Net ซอร์สโค้ดเพื่อแทรก Label(Form control) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกป้ายกำกับ (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก Label(Form control) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ Shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_label/#int-int-int-int-int-int) เพื่อแทรกป้ายกำกับ (ตัวควบคุมแบบฟอร์ม) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่ป้ายกำกับ(การควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
