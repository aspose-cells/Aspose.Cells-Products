...
url: /zh-hant/python-java/merger/merge-numbers-to-tsv/ 
...
以下範例示範如何將 Aspose.Cells for Python via Java 中的 NUMBERS 合併為 TSV。
...
需要以程式方式將 NUMBERS 合併到 TSV 嗎？基本文檔合併和連接[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需幾行程式碼即可完成 API。
