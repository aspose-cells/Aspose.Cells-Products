...
Besoin de convertir les fichiers XLSB en CSV par programmation ? Les développeurs .NET peuvent facilement charger et convertir XLSB en CSV en quelques lignes de code.
...
1.  Convertissez XLSB en CSV en appelant la méthode Workbook.Save.
