---
title:  XLS documento grafico alle immagini via .NET
weight: 3210
description: C# codice sorgente per disegnare e convertire grafici o diagrammi nel file XLS su .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS Grafici di file alle immagini in C#" h2="Conversione da grafici di documenti XLS nativi e ad alte prestazioni a immagini utilizzando API lato server, senza l\'uso di software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire i grafici XLS in immagini utilizzando C#" %}}
 ...
 Per convertire i grafici XLS, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire i grafici dei file XLS in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Converti XLS Grafico file - C#" offSpacer="" %}}
