...
weight: 6660
description: Exemple de code C++ pour masquer les informations sensibles dans le fichier XLSB sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
