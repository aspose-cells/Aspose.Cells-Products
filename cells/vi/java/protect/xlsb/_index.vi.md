...
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa tệp XLSB qua Java" h2="Bảo vệ bảng tính Excel bằng mật khẩu bao gồm định dạng XLSB bằng cách sử dụng .NET Thư viện." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước bảo vệ tệp XLSB qua Java" %}}
...
1. Tải tệp XLSB bằng cách khởi tạo lớp Workbook1. Sử dụng phương thức bảo vệ (..) với Loại bảo vệ và Mật khẩu1. Lưu tệp XLSB được bảo vệ bằng phương thức save ()
