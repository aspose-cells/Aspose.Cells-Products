---
title: Μετατροπή SPREADSHEETML σε JSON μέσω της εφαρμογής C++ 
url: /el/cpp/conversion/spreadsheetml-to-json/ 
description: Δείγμα κώδικα μετατροπής C++ για έγγραφο SPREADSHEETML σε μορφή JSON. Οι προγραμματιστές μπορούν να χρησιμοποιήσουν αυτόν τον πηγαίο κώδικα για μαζική μετατροπή SPREADSHEETML σε JSON σε οποιαδήποτε εφαρμογή C++.
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε SPREADSHEETML σε JSON χρησιμοποιώντας το C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή SPREADSHEETML σε JSON μέσω C++" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του C++ μπορούν εύκολα να μετατρέψουν το αρχείο SPREADSHEETML σε JSON σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φορτώστε το αρχείο SPREADSHEETML χρησιμοποιώντας το Factory::CreateIWorkbook.1. Καλέστε τη μέθοδο Save().1. Περάστε τη διαδρομή του αρχείου εξόδου με επέκταση αρχείου (JSON).1. Το αρχείο JSON θα αποθηκευτεί στην καθορισμένη διαδρομή.1. Ανοίξτε το αρχείο JSON σε συμβατό πρόγραμμα.
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής SPREADSHEETML σε JSON C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ζωντανές επιδείξεις μετατροπής SPREADSHEETML σε JSON" sectionDescription="[Μετατροπή SPREADSHEETML σε JSON](https://products.aspose.app/cells/conversion/spreadsheetml-to-json) αυτή τη στιγμή, επισκεπτόμενοι τον ιστότοπο Live Demos. Η ζωντανή επίδειξη έχει τα ακόλουθα πλεονεκτήματα" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Δεν χρειάζεται να κάνετε λήψη του Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Δεν χρειάζεται να γράψετε κανέναν κώδικα." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλώς ανεβάστε το αρχείο SPREADSHEETML, θα μετατραπεί άμεσα σε JSON." >}}
