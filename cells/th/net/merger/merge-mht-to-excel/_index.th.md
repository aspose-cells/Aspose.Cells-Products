---
title: รวม MHT เป็น EXCEL - รวม MHT เป็น EXCEL ใน C#
url: /th/net/merger/merge-mht-to-excel/ 
description: Aspose เก่ง. C# Aspose.Cells ผสานรูปแบบบันทึก MHT เป็น EXCEL ออนไลน์ฟรี C# รวมรูปแบบ MHT เป็น EXCEL ผสาน MHT เป็น EXCEL ใน C# ผสาน MHT
...
{{% blocks/products/pf/agp/content h2="รวม MHT เป็น EXCEL ใน C# ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน MHT กับ EXCEL ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม MHT เป็น EXCEL อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกเป็นไฟล์ EXCEL หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่ผสาน MHT เป็น EXCEL
...
{{% blocks/products/pf/agp/content h2="วิธีผสาน MHT เป็น EXCEL ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม MHT เป็น EXCEL โดยทางโปรแกรมหรือไม่ การรวมและเชื่อมเอกสารพื้นฐานเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้ด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="ไลบรารี .NET เพื่อรวม MHT เป็น EXCEL" %}}
