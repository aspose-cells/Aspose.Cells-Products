...
description: Aspose エクセル。 Java Aspose.Cells。EXCEL を DIF 保存形式にマージします。 Java EXCEL を DIF 形式に結合します。 EXCEL を Java の DIF に結合します。EXCEL を結合します。
...
{{% blocks/products/pf/agp/content h2="EXCEL を DIF に Java に結合" %}}
...
{{% cells-merger title="EXCELをDIFにJavaにマージするサンプルコード" InputFormat="xlsx" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
