---
title: C# EXCEL en OTS - Convertisseur EXCEL en OTS
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format OTS, permettant un enregistrement transparent des données EXCEL au format OTS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Sauvegarder EXCEL au format OTS dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en OTS dans C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en OTS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en OTS par programme ? .NET peuvent facilement charger et convertir EXCEL en OTS en quelques lignes de code seulement.
...
1.  Convertissez un fichier EXCEL au format OTS en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion d'EXCEL en OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir EXCEL en OTS" %}}
