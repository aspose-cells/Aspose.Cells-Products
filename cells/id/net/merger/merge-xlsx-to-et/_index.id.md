---
title: Gabung XLSX ke ET - Gabungkan XLSX ke ET di C#
url: /id/net/merger/merge-xlsx-to-et/ 
description: Aspose Unggul. C# Aspose.Cells. Gabung Online Gratis XLSX ke ET saveformat. C# Gabungkan XLSX ke format ET. Gabung XLSX ke ET di C#. XLSX Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSX ke ET di C# Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan XLSX ke ET di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLSX ke ET. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ET. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSX ke ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis untuk Menggabungkan XLSX menjadi ET di C#" InputFormat="xlsx" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSX ke ET melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSX ke ET secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
