---
title:  संपादित करें या XLS फ़ाइलें मेटाडेटा via Java देखें
weight: 730
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरनमेंट पर XLS प्रारूप मेटाडेटा को संपादित करने या देखने के लिए Java नमूना कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS मेटाडेटा via Java निकालें" h2="सर्वर-साइड API का उपयोग करके XLS फ़ाइलों से मेटाडेटा जोड़ने, संपादित करने, निकालने या निकालने के लिए अपना स्वयं का Java ऐप्स बनाएं।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLS via Java का मेटाडेटा निकालने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="XLS - Java का मेटाडेटा निकालें" offSpacer="" %}}
