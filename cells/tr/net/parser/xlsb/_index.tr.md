---
title:  XLSB belgesi via .NET'den metin ve resimleri ayıklayın
weight: 2200
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarındaki XLSB dosyasından metin ve görüntüleri ayıklamak için C# kaynak kodu.
---
