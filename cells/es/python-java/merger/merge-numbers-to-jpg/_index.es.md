---
title: Fusionar NÚMEROS con JPG - Combinar NÚMEROS con JPG en Python
url: /es/python-java/merger/merge-numbers-to-jpg/ 
description: Aspose Excel. Python Aspose.Cells. Fusionar NÚMEROS en formato guardado JPG. Python Combina NÚMEROS al formato JPG. Fusionar NÚMEROS a JPG en Python. Fusionar NÚMEROS.
...
{{% blocks/products/pf/agp/content h2="Fusionar NÚMEROS a JPG usando Python" %}}

 ¿Cómo fusiono NÚMEROS con JPG? Con la biblioteca Aspose.Cells for Python via Java, puede fusionar fácilmente NÚMEROS en JPG mediante programación con unas pocas líneas de código.[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells) es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria. Puede instalar Aspose.Cells for Python via Java desde<a href="https://pypi.org/project/aspose-cells/">pypi</a> , use el comando como:<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Fusionar NÚMEROS a JPG en Python" %}}

El siguiente ejemplo demuestra cómo fusionar NÚMEROS con JPG en Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar NÚMEROS en JPG. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo JPG. Si desarrolla código en Python, esto será más simple de lo que parece. Vea el ejemplo Python que combina NÚMEROS con JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar NÚMEROS con JPG en Python" InputFormat="numbers" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar NÚMEROS a JPG a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar NÚMEROS con JPG mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Python biblioteca para fusionar NÚMEROS a JPG" %}}
