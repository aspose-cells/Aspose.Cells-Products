...
url: /hu/cpp/merger/merge-xltm-to-xml/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLTM-et XML-be a Aspose.Cells for C++-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLTM-et XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a XLTM XML-be olvasztásához" %}}
