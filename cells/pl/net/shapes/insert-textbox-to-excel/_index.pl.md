...
weight: 301
description: C# Przykładowy kod umożliwiający dodanie lub wstawienie pola tekstowego do programu Excel przy użyciu biblioteki .NET. Użyj tego kodu, aby utworzyć TextBox w MS Excel w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
