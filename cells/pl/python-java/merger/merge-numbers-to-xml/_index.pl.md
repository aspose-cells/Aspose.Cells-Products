...
Poniższy przykład ilustruje sposób scalania NUMERÓW z formatem XML w formacie Aspose.Cells for Python via Java.
...
Chcesz programowo scalić NUMERY z XML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
