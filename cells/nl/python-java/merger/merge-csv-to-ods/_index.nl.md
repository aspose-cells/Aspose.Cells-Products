---
title:  Samenvoegen CSV naar ODS via Python
url: /nl/python-java/merger/merge-csv-to-ods/ 
description: Samenvoegen CSV naar ODS Online gratis. Gratis online CSV tot ODS Fusie. Voeg CSV samen met Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS en meer.
---
...
Het volgende voorbeeld laat zien hoe u CSV samenvoegt met ODS in Python.
...
{{% cells-merger title="Gratis app om CSV online samen te voegen tot ODS" InputFormat="csv" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
