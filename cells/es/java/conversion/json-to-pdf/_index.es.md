---
title: Convierta JSON a PDF a través de Java 
weight: 2950
url: /es/java/conversion/json-to-pdf/ 
description: Ejemplo de código de conversión Java de formato JSON a archivo PDF. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a PDF dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta JSON a PDF a través de Java" h2="Exporte JSON a formato PDF a través de Java sin necesidad de herramientas o bibliotecas adicionales." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JSON a PDF usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir JSON a PDF a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores pueden convertir fácilmente un archivo JSON a PDF con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de JSON a PDF Java" offSpacer="" %}}
...
// guarde el archivo resultante en formato JSON-TO-PDF
