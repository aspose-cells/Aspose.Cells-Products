---
title: C++ MHTML až XLSX - MHTML až XLSX Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu formátu MHTML do formátu XLSX, což umožňuje bezproblémové ukládání dat MHTML do formátu XLSX pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na XLSX v C++" h2="Vysoce výkonná konverze z MHTML na XLSX s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte MHTML na XLSX v C++" %}}

Následující příklad ukazuje, jak převést číslo MHTML na XLSX v kódu C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na XLSX přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory MHTML na XLSX? Vývojáři C++ mohou snadno převést MHTML na XLSX pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na XLSX voláním metody Save().
1.  Získejte výsledek převodu MHTML na XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod MHTML na XLSX" %}}
