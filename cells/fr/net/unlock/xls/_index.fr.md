---
title: Déverrouiller le document XLS via .NET 
weight: 4260

description: Code source C# pour déverrouiller le fichier XLS protégé par mot de passe sur .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Comment débloquer un fichier XLS à l\'aide de C#" %}}

 Afin de supprimer le fichier XLS de protection, nous utiliserons
...
// instancier un objet Workbook avec un fichier XLS protégé
