---
title: TABDELIMITED를 ET로 병합 - Java에서 TABDELIMITED를 ET로 결합
url: /ko/java/merger/merge-tabdelimited-to-et/ 
description: Aspose 엑셀. Java Aspose.Cells. TABDELIMITED를 ET 저장 형식에 병합합니다. Java TABDELIMITED를 ET 형식으로 결합합니다. Java에서 TABDELIMITED를 ET로 병합합니다. TABDELIMITED 병합.
...
{{% blocks/products/pf/agp/content h2="Java에서 TABDELIMITED를 ET로 병합" %}}

다음 예에서는 Aspose.Cells for Java에서 TABDELIMITED를 ET로 병합하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

TABDELIMITED를 ET에 병합하려면 쉬운 단계를 따르세요. 파일을 업로드하고 파일 병합을 위해 Workbook.Combine 메서드를 호출한 다음 ET 파일에 저장합니다. Java에서 코드를 개발하면 생각보다 간단해질 것입니다. TABDELIMITED를 ET에 병합하는 Java 예를 참조하세요.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java에서 TABDELIMITED를 ET로 병합하는 샘플 코드" InputFormat="tsv" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TABDELIMITED를 ET via Java로 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 TABDELIMITED를 ET에 병합해야 합니까? 병합하고 연결하는 기본 문서[Aspose.Cells for Java](https://products.aspose.com/cells/java) 단 몇 줄의 코드만으로 API를 구현할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2="TABDELIMITED를 ET로 병합하는 Java 라이브러리" %}}
