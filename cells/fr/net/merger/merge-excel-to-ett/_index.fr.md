---
title: Fusionner EXCEL avec ETT - Combiner EXCEL avec ETT dans C#
url: /fr/net/merger/merge-excel-to-ett/ 
description: Aspose Exceller. C# Aspose.Cells. Fusionner EXCEL avec le format de sauvegarde ETT. C# Combinez EXCEL au format ETT. Fusionner EXCEL avec ETT dans C#. Fusionner EXCEL.
...
{{% blocks/products/pf/agp/content h2="Fusionner EXCEL avec ETT dans C#" %}}

L'exemple suivant montre comment fusionner EXCEL avec ETT dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner EXCEL avec ETT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier ETT. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne EXCEL avec ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner EXCEL avec ETT dans C#" InputFormat="xlsx" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner EXCEL avec ETT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner EXCEL avec ETT par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque .NET pour fusionner EXCEL avec ETT" %}}
