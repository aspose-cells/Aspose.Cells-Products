---
title: تحويل C++ MHT إلى CSV - تحويل MHT إلى CSV
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل MHT إلى تنسيق CSV، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق CSV باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل MHT إلى CSV في C++" h2="تحويل عالي الأداء من MHT إلى CSV باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى CSV في C++" %}}

يوضح المثال التالي كيفية تحويل MHT إلى CSV في C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لتحويل MHT إلى CSV. قم بتحميل ملف MHT الخاص بك، ثم احفظه ببساطة كملف CSV. لكل من قراءة MHT وكتابة CSV، يمكنك استخدام أسماء ملفات مؤهلة بالكامل. سيكون محتوى وتنسيق الإخراج CSV مطابقًا لمستند MHT الأصلي.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="نموذج كود لتحويل MHT إلى CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="csv" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى CSV عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى CSV برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى CSV بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى CSV عن طريق استدعاء دالة Save().
1. احصل على نتيجة تحويل MHT إلى CSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C++ لتحويل MHT إلى CSV" %}}
