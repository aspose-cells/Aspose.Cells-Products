---
title:  Sloučit SPREADSHEETML na XLSB via Java
...
Následující příklad ukazuje, jak sloučit SPREADSHEETML do XLSB v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení SPREADSHEETML na XLSB online" InputFormat="xml" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
