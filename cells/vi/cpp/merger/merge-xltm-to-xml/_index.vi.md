---
title: Hợp nhất XLTM thành XML - Hợp nhất XLTM thành XML trong C++
url: /vi/cpp/merger/merge-xltm-to-xml/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất XLTM thành định dạng lưu XML. C++ Kết hợp XLTM thành định dạng XML. Hợp nhất XLTM thành XML trong C++. XLTM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLTM thành XML trong C++" %}}

Ví dụ sau đây minh họa cách hợp nhất XLTM thành XML trong Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất XLTM với XML. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp XML. Nếu bạn phát triển mã theo số C++, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C++ hợp nhất XLTM với XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất XLTM thành XML trong C++" InputFormat="xltm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
