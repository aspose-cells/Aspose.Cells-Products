...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM bis XLTM in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLAM in XLTM in C# konvertiert wird.
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Online-Konvertieren von XLAM in XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xltm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLAM über C# in XLTM" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLAM-Dateien programmgesteuert in XLTM konvertieren? .NET-Entwickler können XLAM problemlos in nur wenigen Codezeilen laden und in XLTM konvertieren.
...
1.  Konvertieren Sie XLAM in XLTM, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLAM in XLTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLAM in XLTM" %}}
