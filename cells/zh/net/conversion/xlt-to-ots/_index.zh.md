---
title: 将 XLT 转换为 OTS C#
description: 免费将 XLT 转换为 OTS Online。免费在线 XLT 到 OTS 转换器。 C# XLT 至 OTS。 XLT 通过 C# 到 OTS。
keywords: Convert XLT, XLT Converter, XLT to PDF, XLT to Word, XLT to PPT, XLT to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 XLT 转换为 OTS" h2="用于将 XLT 转换为 OTS 的高速 C# 库。在 .NET 框架、.NET 核心或 Mono 平台上将 Excel 电子表格导出为 OTS 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="免费在线将 XLT 保存到 C# 中的 OTS" %}}

以下示例演示如何将 XLT 转换为 C# 中的 OTS。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLT 转换为 OTS。上传您的 XLT 文件，然后将其保存为 OTS 文件。对于 XLT 读取和 OTS 写入，您可以使用完全限定的文件名。输出的 OTS 内容和格式将与原始 XLT 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 XLT 在线转换为 OTS 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 XLT 转换为 OTS" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载 XLT 并将其转换为 OTS。

{{% /blocks/products/pf/agp/text %}}

1. 使用工作簿实例加载 XLT 文件
1. 通过调用 Workbook.Save 方法将 XLT 转换为 OTS

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 库将 XLT 转换为 OTS" %}}
