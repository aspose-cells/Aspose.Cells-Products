---
title: Mesclar arquivos XLT via Java 
weight: 9960
url: /pt/java/merger/xlt/ 
description: Java código de amostra para combinar documentos XLT no Java ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar formatos XLT em Java" h2="Fusão de documentos XLT nativos usando APIs Java do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar arquivos XLT usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para mesclar arquivos XLT em Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mesclar arquivos XLT - Java" offSpacer="" %}}

```cs
// Abra o primeiro arquivo XLT.
Workbook xltFile1 = new Workbook("chartsFileWithPath.xlt");

// Defina o segundo livro de origem.
// Abra o segundo arquivo XLT.
