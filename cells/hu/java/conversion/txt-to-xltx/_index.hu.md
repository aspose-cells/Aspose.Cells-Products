...
{{% blocks/products/pf/agp/content h2="TXT konvertálása XLTX-be a következővel: Java" %}}

 Ahhoz, hogy a TXT-t XLTX-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TXT XLTX-re konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a TXT fájlt XLTX-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLTX kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLTX fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT-ből XLTX-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése XLTX-ként
