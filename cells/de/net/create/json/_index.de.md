---
title: Erstellen Sie JSON – Erstellen Sie die Datei JSON in C#
description: Aspose Excel. C# Erstellen Sie schnell und einfach eine JSON-Datei mit Aspose.Cells. Erstellen Sie eine JSON-Datei mit C#. Erstellen Sie JSON in C#. C# JSON Creater.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Für die Entwickler ist es einfach, JSON-Dateien in verschiedenen Berichtsanwendungen zur Datenverarbeitung in nur wenigen Codezeilen zu erstellen, zu laden, zu ändern und zu konvertieren.
...
1.  Verwenden Sie die Save-Methode, um die Arbeitsmappe als JSON-Datei zu speichern.
