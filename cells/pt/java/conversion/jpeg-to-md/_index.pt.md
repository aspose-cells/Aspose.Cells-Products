...
description: Aspose Excel. Converta JPEG em MD de forma rápida e fácil com Aspose.Cells. Java JPEG em MD. Java Salve JPEG em MD. Salve JPEG como MD usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter JPEG para MD em Java" h2="Biblioteca Java de alta velocidade para conversão de JPEG em MD. Esta é uma solução de software profissional para importar e exportar JPEG, MD e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salve JPEG no MD em Java" %}}

O exemplo a seguir demonstra como converter JPEG em MD em Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter JPEG em MD. Carregue seu arquivo JPEG e simplesmente salve-o como arquivo MD. Tanto para leitura JPEG quanto para gravação MD você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação do MD de saída serão idênticos ao documento JPEG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemplo de código para converter JPEG em MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter JPEG para MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPEG para MD programaticamente? Os desenvolvedores do Java podem facilmente converter JPEG em MD em apenas algumas linhas de código.
