---
title: Fusionar JPG a PRN - Combinar JPG a PRN en C++
url: /es/cpp/merger/merge-jpg-to-prn/ 
description: AsposeExcel. C++ Aspose.Cells. Gratuito en línea Combinar JPG a PRN guardar formato. C++ Combinar formato JPG a PRN. Combinar JPG con PRN en C++. Combinar JPG.
...
{{% blocks/products/pf/agp/content h2="Combine JPG a PRN en C++ en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar JPG con PRN en Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar JPG a PRN. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo PRN. Si desarrolla código en C++, esto será más simple de lo que parece. Consulte el ejemplo C++ que combina JPG con PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar JPG a PRN en C++" InputFormat="jpg" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar JPG a PRN a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar JPG con PRN programáticamente? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para fusionar JPG a PRN" %}}
