...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке метки в файл Excel по номеру C#" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addlabel) вставить метку в выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставьте этикетку — C#" offSpacer="" %}}
