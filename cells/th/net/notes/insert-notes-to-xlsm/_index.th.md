...
{{% blocks/products/pf/agp/content h2="วิธีแทรกโน้ตในไฟล์ XLSM ผ่าน C#" %}}
...
ใน Office 365 บันทึกย่อมีไว้สำหรับคำอธิบายประกอบ คุณสามารถใช้รหัส C# ต่อไปนี้เพื่อแทรกและลบบันทึกย่อในไฟล์ XLSM

{{% blocks/products/pf/agp/code-block title="รหัสตัวอย่าง C# เพื่อแทรกและลบบันทึกย่อในไฟล์ XLSM" offSpacer="" %}}
