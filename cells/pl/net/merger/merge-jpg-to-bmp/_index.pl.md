...
url: /pl/net/merger/merge-jpg-to-bmp/ 
...
Poniższy przykład pokazuje, jak połączyć JPG z BMP w Aspose.Cells for .NET.
...
Chcesz programowo scalić JPG z BMP? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia JPG z BMP" %}}
