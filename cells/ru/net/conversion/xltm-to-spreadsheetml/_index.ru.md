---
title: C# XLTM в SPREADSHEETML - Конвертер XLTM в SPREADSHEETML
description: Aspose Эксель. Преобразуйте XLTM в SPREADSHEETML быстро и легко с помощью Aspose.Cells. C# XLTM в SPREADSHEETML. C# Сохранить XLTM в SPREADSHEETML. Сохраните XLTM как SPREADSHEETML, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в SPREADSHEETML в C#." %}}

В следующем примере показано, как преобразовать XLTM в SPREADSHEETML в C#.
...
{{% cells-convert title="Пример кода для преобразования XLTM в SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как преобразовать XLTM в SPREADSHEETML с помощью C#" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно преобразовать файлы XLTM в SPREADSHEETML? Разработчики .NET могут легко загрузить и преобразовать XLTM в SPREADSHEETML всего за несколько строк кода.
