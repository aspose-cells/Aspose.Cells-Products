...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan MHTML ke format penyimpanan XML. Java Gabungkan MHTML ke format XML. Gabungkan MHTML ke XML di Java. MHTML Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHTML ke XML di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan MHTML ke XML di Java" InputFormat="mhtml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML ke XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan MHTML ke XML secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan MHTML ke XML" %}}
