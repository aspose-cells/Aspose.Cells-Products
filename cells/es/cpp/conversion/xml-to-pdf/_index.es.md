---
title: C++ XML a PDF - Convertidor de XML a PDF
description: Aspose Excel. Esta solución integral proporciona a los desarrolladores de C++ un enfoque totalmente integrado para convertir XML al formato PDF, lo que permite guardar datos XML sin problemas en formato PDF mediante la biblioteca Aspose.Cells, todo mediante código C++ eficiente y personalizable.
...
{{% blocks/products/pf/agp/content h2="Guardar XML en PDF en C++" %}}

El siguiente ejemplo demuestra cómo convertir XML a PDF en C++.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XML a PDF a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XML a PDF mediante programación? Los desarrolladores de C++ pueden convertir fácilmente XML a PDF con solo unas pocas líneas de código.
...
1.  Convierta XML a PDF llamando al método Save().
1.  Obtenga el resultado de la conversión de XML a PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteca para convertir XML a PDF" %}}
