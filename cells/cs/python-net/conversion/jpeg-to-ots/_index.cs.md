...
{{% blocks/products/pf/agp/content h2="Převeďte JPEG na OTS v Python" %}}
...
Následující příklad ukazuje, jak převést JPEG na OTS v Python via NET.
