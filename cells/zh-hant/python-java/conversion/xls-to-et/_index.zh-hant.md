...
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 XLS 轉換為 ET 格式，從而能夠使用 Aspose.Cells 庫將 XLS 資料無縫保存為 ET 格式，所有這些都通過高效的 XLS 資料無縫保存為 ET 格式，所有這些都通過高效可自訂的 08153481 實現代碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Python Excel 庫中將 XLS 轉換為 ET" h2="高速 Python excel 庫，用於將 XLS 轉換為 ET。這是一個專業的軟體解決方案，可以使用Python導入和匯出XLS、ET和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將 XLS 轉換為 ET" %}}
...
{{% blocks/products/pf/agp/content h2="將 XLS 儲存到 Python Excel 庫中的 ET" %}}

下面的範例示範如何將Python excel庫中的XLS轉換為ET。
...
{{% cells-convert title="透過 Python Excel 庫將 XLS 轉換為 ET 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="et" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 XLS 轉換為 ET" %}}
