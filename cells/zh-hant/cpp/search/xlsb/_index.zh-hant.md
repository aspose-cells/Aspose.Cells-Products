---
title: 在不通過 C++ 打開的情況下搜索 XLSB 文檔 
weight: 7020
url: /zh-hant/cpp/search/xlsb/ 
description: C++ 用於在 XLSB 文件中搜索具有模式的單詞的示例代碼，位於 C++ Windows 32 位、Windows 64 位和 Linux 64 位運行時環境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C++ 中搜索 XLSB 格式" h2="使用用於 C++ API 的服務器端 Aspose.Cells 進行本機和高性能 XLSB 文檔搜索，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C++ 中搜索 XLSB 文件的步驟" %}}
