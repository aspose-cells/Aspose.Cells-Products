---
title: Gabungkan XLTM menjadi XPS - Gabungkan XLTM menjadi XPS menjadi Java
url: /id/java/merger/merge-xltm-to-xps/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLTM menjadi XPS format simpan. Java Gabungkan format XLTM menjadi XPS. Gabungkan XLTM menjadi XPS di Java. XLTM Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLTM menjadi XPS di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLTM menjadi XPS di Aspose.Cells for Java.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLTM menjadi XPS di Java" InputFormat="xltm" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLTM menjadi XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLTM ke XPS secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan XLTM menjadi XPS" %}}
