...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj CSV na XML za pomocą Java" h2="Konwersja CSV do XML Java w celu konwersji jednej lub wielu stron do formatu XML przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować CSV na XML za pomocą Java" %}}

 Aby wyrenderować CSV do XML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować CSV na XML za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik CSV na XML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XML i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XML
...
{{% blocks/products/pf/agp/code-block title="CSV do XML Java Kod źródłowy konwersji" offSpacer="" %}}
