...
{{% blocks/products/pf/agp/content h2="Sla TSV op in XLS in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar XLS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar XLS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TSV programmatisch converteren naar XLS? Ontwikkelaars van Java kunnen bestanden met de extensie TSV eenvoudig converteren naar XLS met slechts een paar regels code.
