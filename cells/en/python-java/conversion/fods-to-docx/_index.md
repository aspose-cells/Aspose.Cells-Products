...
{{% blocks/products/pf/agp/content h2="How to Convert FODS to DOCX Using Python" %}}
 ...
 In order to convert FODS to DOCX, we will use [Aspose.Cells for Python](https://pypi.org/project/aspose-cells) API which is a feature-rich, powerful and easy to use document manipulation and conversion API for Python platform. 
