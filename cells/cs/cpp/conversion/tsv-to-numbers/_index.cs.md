---
title: C++ TSV na ČÍSLA – Online převodník TSV na ČÍSLA
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Online zdarma C++ Převeďte TSV na uložený formát ČÍSLA. C++ TSV do formátu ČÍSLA. Uložte TSV na ČÍSLA C++.
...
{{% blocks/products/pf/agp/content h2="Ušetřete TSV na NUMBERS v C++ Online zdarma" %}}

Následující příklad ukazuje, jak převést TSV na ČÍSLA v C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod TSV na ČÍSLA. Nahrajte svůj soubor TSV a poté jej jednoduše uložte jako soubor NUMBERS. Jak pro čtení TSV, tak pro zápis NUMBERS můžete použít plně kvalifikované názvy souborů. Výstupní NUMBERS obsah a formátování budou identické s původním dokumentem TSV.
...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na ČÍSLA přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést TSV soubory na NUMBERS programově? Vývojáři C++ mohou snadno převést TSV na ČÍSLA v několika řádcích kódu.
...
1.  Převeďte TSV na NUMBERS voláním metody Save().
1.  Získejte výsledek převodu TSV na NUMBERS.
