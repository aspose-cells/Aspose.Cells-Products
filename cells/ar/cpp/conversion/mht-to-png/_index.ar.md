...
هل تحتاج إلى تحويل ملفات MHT إلى PNG برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى PNG في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى PNG باستدعاء طريقة Save ().
