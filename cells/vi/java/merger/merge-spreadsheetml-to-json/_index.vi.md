---
title:  Hợp nhất SPREADSHEETML thành JSON via Java
url: /vi/java/merger/merge-spreadsheetml-to-json/ 
description: Hợp nhất SPREADSHEETML thành JSON Trực tuyến miễn phí. Sáp nhập SPREADSHEETML trực tuyến miễn phí tới JSON. Hợp nhất SPREADSHEETML sang Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS và hơn thế nữa.
---
...
Ví dụ sau minh họa cách hợp nhất SPREADSHEETML thành JSON trong Java.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất SPREADSHEETML thành JSON trực tuyến" InputFormat="xml" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
