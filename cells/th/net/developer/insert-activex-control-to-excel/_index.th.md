...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก ActiveX Control ลงในไฟล์ Excel ผ่าน C#" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addActiveXControl) เพื่อแทรกตัวควบคุม ActiveX ในเวิร์กชีตที่เลือก
