---
title: Gabungkan XLS ke EXCEL - Gabungkan XLS ke EXCEL di C++
url: /id/cpp/merger/merge-xls-to-excel/ 
description: Aspose Unggul. C++ Aspose.Cells. Gabungkan XLS ke format simpan EXCEL. C++ Gabungkan XLS ke format EXCEL. Gabungkan XLS menjadi EXCEL di C++. XLS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLS ke EXCEL di C++" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLS ke EXCEL di C++" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLS ke EXCEL lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLS ke EXCEL secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
