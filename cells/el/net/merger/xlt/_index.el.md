...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη συγχώνευση αρχείων XLT στο C#" %}}
...
+ Καλέστε τη μέθοδο Save() και μεταβιβάστε το όνομα του αρχείου (πλήρης διαδρομή) και τη μορφή (XLT) ως παράμετρο.
