...
{{% blocks/products/pf/agp/content h2="Cách nhóm và tách nhóm các hình dạng trong tệp Excel bằng cách sử dụng Python via .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để nhóm và tách nhóm các hình dạng trong tệp Excel qua Python" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng các[phương pháp nhóm](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/group/) để nhóm các hình dạng trong trang tính đã chọn
 + Sử dụng các[phương pháp tách nhóm](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/ungroup/) để tách nhóm các hình trong trang tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Group And Ungroup Shapes - Python via .NET" offSpacer="" %}}
