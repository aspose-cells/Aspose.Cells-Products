---
title: Converter CSV para ODS via Python

description: Código de amostra para conversão de csv para ods Python. Use o código de exemplo API para arquivos csv em lote para conversão de ods no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter CSV para ODS usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter CSV em ODS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos CSV em ODS em apenas algumas linhas de código.
...
{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter CSV em ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="ods" IsLandingPage="true" language="python" %}}
