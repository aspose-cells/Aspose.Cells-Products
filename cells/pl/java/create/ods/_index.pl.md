---
title: Twórz pliki ODS (Openoffice / Lbreoffice) za pomocą Java 
url: /pl/java/create-ods/ 
description: Java Przykładowy kod do generowania dokumentów ODS. Użyj tego kodu do tworzenia plików ODS (Openoffice / Lbreoffice) w aplikacji komputerowej lub internetowej opartej na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Twórz dokumenty ODS za pomocą Java" h2="Natywne i wysokowydajne tworzenie arkuszy kalkulacyjnych ODS (Openoffice / Lbreoffice) programowo przy użyciu biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Jak tworzyć SZWO za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Deweloperzy mogą łatwo tworzyć, ładować, modyfikować i konwertować arkusze kalkulacyjne ODS (Openoffice / Lbreoffice) w ramach uruchamiania różnych aplikacji raportowania do przetwarzania danych w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Utwórz instancję [Zajęcia ze skoroszytu](https://reference.aspose.com/cells/java/com.aspose.cells/Workbook).1. Uzyskaj dostęp do odpowiedniego arkusza za pomocą metody getWorksheets.get().1. Wybierz odpowiednią komórkę, wprowadź wartość do żądanej komórki, używając nazwy komórki, np. A1, B3 itp.1. Zapisz skoroszyt w formacie ODS za pomocą metody save().
