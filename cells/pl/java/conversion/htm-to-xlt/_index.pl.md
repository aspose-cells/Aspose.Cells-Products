---
title: Java HTM na XLT - Konwerter HTM na XLT
description: Aspose Excel. Konwertuj HTM na XLT szybko i łatwo za pomocą Aspose.Cells. Java HTM na XLT. Java Zapisz HTM na XLT. Zapisz HTM jako XLT, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM pod numerem XLT w Java" %}}

Poniższy przykład ilustruje sposób konwersji HTM na XLT w Java.
...
Chcesz programowo przekonwertować pliki HTM na XLT? Programiści Java mogą z łatwością przekonwertować HTM na XLT w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj HTM na XLT, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji HTM na XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji HTM na XLT" %}}
{{% blocks/products/pf/agp/text %}}
