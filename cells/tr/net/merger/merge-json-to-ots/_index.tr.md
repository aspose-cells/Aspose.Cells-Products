...
url: /tr/net/merger/merge-json-to-ots/ 
...
Aşağıdaki örnek, JSON'in Aspose.Cells for .NET'deki OTS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 JSON'i OTS ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kütüphanesi, JSON\'i OTS ile birleştirecek" %}}
