...
url: /ru/cpp/merger/merge-excel-to-tabdelimited/ 
...
В следующем примере показано, как объединить EXCEL с TABDELIMITED в Aspose.Cells for C++.
...
{{% cells-merger title="Пример кода для объединения EXCEL с TABDELIMITED в C++" InputFormat="xlsx" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как объединить EXCEL с TABDELIMITED через C++" %}}

{{% blocks/products/pf/agp/text %}}

 Хотите программно объединить EXCEL и TABDELIMITED? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="C++ библиотека для объединения EXCEL с TABDELIMITED" %}}
