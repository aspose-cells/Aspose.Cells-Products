...
description: Sample Java conversion code for XLT format to PDF file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to PDF within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLT to PDF via Java" h2="XLT to PDF Java conversion to convert single or multiple pages to PDF using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert XLT to PDF Using Java" %}}

 In order to render XLT to PDF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLT to PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells API makes it easy for the developers to convert XLT file to PDF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="XLT to PDF Java Conversion Source Code" offSpacer="" %}}
