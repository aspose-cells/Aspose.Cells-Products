...
是否需要以编程方式将 XLSM 文件转换为 TABDELIMITED？.NET 开发人员只需几行代码即可轻松加载并将 XLSM 转换为 TABDELIMITED。
...
1. 向您的 C# 项目添加库引用（导入库）。
1. 使用工作簿实例加载 XLSM 文件。
1. 调用 Workbook.Save 方法将 XLSM 转换为 TABDELIMITED。
