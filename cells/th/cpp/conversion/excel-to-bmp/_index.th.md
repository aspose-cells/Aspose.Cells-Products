---
title: C++ EXCEL เป็น BMP - ตัวแปลง EXCEL เป็น BMP ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง EXCEL เป็น BMP บันทึกรูปแบบ รูปแบบ C++ EXCEL เป็น BMP บันทึก EXCEL ไปที่ BMP C++
...
{{% blocks/products/pf/agp/content h2="บันทึก EXCEL เป็น BMP ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง EXCEL เป็น BMP โดยเรียกเมธอด Save()
