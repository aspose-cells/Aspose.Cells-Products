...
url: /de/cpp/merger/merge-html-to-xml/ 
...
Das folgende Beispiel zeigt, wie HTML in XML in Aspose.Cells for C++ zusammengeführt wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie HTML programmgesteuert in XML zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="C++-Bibliothek zum Zusammenführen von HTML in XML" %}}
