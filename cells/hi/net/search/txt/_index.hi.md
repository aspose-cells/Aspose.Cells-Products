...
weight: 8410
description: .NET फ्रेमवर्क, .NET कोर, Mono या ज़ामरिन प्लेटफ़ॉर्म पर TXT फ़ाइल में पैटर्न वाले शब्दों को खोजने के लिए C# स्रोत कोड।
...
+ वर्कबुक क्लास का उपयोग करके TXT फ़ाइल लोड करें।
