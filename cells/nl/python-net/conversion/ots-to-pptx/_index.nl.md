...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar PPTX met Aspose.Cells. Python OTS naar PPTX. Python Bewaar OTS naar PPTX. Sla OTS op als PPTX met Python.
...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar PPTX in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar OTS op PPTX in Python" %}}

Het volgende voorbeeld laat zien hoe u OTS converteert naar PPTX in Python via NET.
...
{{% cells-convert title="Voorbeeldcode om OTS naar PPTX te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="pptx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om OTS naar PPTX te converteren" %}}
