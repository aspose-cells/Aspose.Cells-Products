---
title:  Συγχώνευση FODS στο POWERPOINT μέσω Python
url: /el/python-net/merger/merge-fods-to-powerpoint/ 
description: Συγχώνευση FODS στο POWERPOINT Online δωρεάν. Δωρεάν Online FODS to POWERPOINT Merger. Συγχώνευση FODS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS στο POWERPOINT στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση FODS στο POWERPOINT σε απευθείας σύνδεση" InputFormat="fods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
