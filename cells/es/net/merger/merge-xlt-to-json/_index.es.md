---
title: Combinar XLT a JSON - Combinar XLT a JSON en C#
url: /es/net/merger/merge-xlt-to-json/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea XLT a JSON guardar formato. C# Combina el formato XLT con el JSON. Combinar XLT a JSON en C#. XLT Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLT a JSON en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLT con JSON en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLT a JSON. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo JSON. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina XLT con JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLT a JSON en C#" InputFormat="xlt" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLT a JSON a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLT con JSON mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar XLT a JSON" %}}
