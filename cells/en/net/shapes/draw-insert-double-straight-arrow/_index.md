---
title: How do I draw or insert double straight arrow into Excel via .NET 
weight: 10

description: C# Sample code to add or insert double straight arrow into Excel using .NET Library. Use this code to create double straight arrow in MS Excel within VB.NET, Asp.NET or any .NET based application.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert double straight arrow to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) to insert a double straight arrow in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert double straight arrow - C#" offSpacer="" %}}
