...
{{% blocks/products/pf/agp/content h2="Convertir XML en DIF à l\'aide de Python" %}}
...
L'exemple suivant montre comment convertir XML en DIF en Python.
