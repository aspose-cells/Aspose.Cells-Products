---
title: C# JPG 至 ODS - JPG 至 ODS 转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 JPG 转换为 ODS 格式，从而能够使用 Aspose.Cells 库将 JPG 数据无缝保存为 ODS 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 JPG 保存到 ODS 和 C#" %}}

以下示例演示如何将 JPG 转换为 C# 格式。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 JPG 转换为 ODS。上传您的 JPG 文件，然后将其保存为 ODS 文件。对于 JPG 读取和 ODS 写入，您都可以使用完全合格的文件名。输出 ODS 内容和格式将与原始 JPG 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 JPG 转换为 ODS 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 JPG 转换为 ODS" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 JPG 文件转换为 ODS 吗？.NET 开发人员只需几行代码即可轻松加载并将 JPG 转换为 ODS。
...
1. 调用 Workbook.Save 方法将 JPG 转换为 ODS。
1. 获取JPG到ODS的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 库用于将 JPG 转换为 ODS" %}}
