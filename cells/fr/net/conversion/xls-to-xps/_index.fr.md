---
title: Convertisseur C# XLS à XPS - XLS à XPS
description: Aspose Exceller. Convertissez XLS en XPS rapidement et facilement avec Aspose.Cells. C# XLS en XPS. C# Enregistrez XLS en XPS. Enregistrez XLS sous 07611134. 81 en utilisant le C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLS au XPS au C#" %}}

L'exemple suivant montre comment convertir XLS en XPS dans C#.
...
{{% cells-convert title="Exemple de code pour convertir XLS en XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xps" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en XPS par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en XPS en quelques lignes de code seulement.
