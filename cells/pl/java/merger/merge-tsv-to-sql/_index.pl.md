---
title: Połącz TSV z SQL - Połącz TSV z SQL w Java
url: /pl/java/merger/merge-tsv-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online TSV do formatu zapisu SQL. Java Połącz TSV z formatem SQL. Scal TSV do SQL w Java. TSV Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz TSV z SQL w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić TSV z SQL w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić TSV z SQL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SQL. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy TSV z SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online TSV z SQL w Java" InputFormat="tsv" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić TSV z SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić TSV z SQL? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do scalania TSV z SQL" %}}
