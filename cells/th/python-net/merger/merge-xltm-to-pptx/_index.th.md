...
description: Aspose เอ็กเซล. Python เอ็กเซล. รวม XLTM เป็น PPTX บันทึกรูปแบบ Python รวมรูปแบบ XLTM ถึง PPTX รวม XLTM ถึง PPTX ใน Python Excel Library XLTM เมิร์จ.
...
{{% blocks/products/pf/agp/content h2="วิธีผสาน XLTM ถึง PPTX ผ่าน Python Excel Library" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม XLTM กับ PPTX โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
