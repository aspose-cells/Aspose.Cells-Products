---
title: Converter ODS para SPREADSHEETML por meio do aplicativo C++ 
url: /pt/cpp/conversion/ods-to-spreadsheetml/ 
description: Exemplo de código de conversão C++ de documento ODS para o formato SPREADSHEETML. Os programadores podem usar esse código-fonte para conversão de ODS em lote para SPREADSHEETML em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ODS para SPREADSHEETML via C++" h2="Conversão de ODS para SPREADSHEETML de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter ODS para SPREADSHEETML usando C++" %}}
 ...
 Para converter ODS em SPREADSHEETML, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem converter facilmente o arquivo ODS para SPREADSHEETML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo ODS usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com a extensão de arquivo (SPREADSHEETML).1. O arquivo SPREADSHEETML será salvo no caminho especificado.1. Abra o arquivo SPREADSHEETML em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de ODS para SPREADSHEETML C++" offSpacer="" %}}
