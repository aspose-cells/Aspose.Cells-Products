...
url: /cs/python-java/merger/merge-fods-to-tabdelimited/ 
...
Následující příklad ukazuje, jak sloučit FODS do TABDELIMITED v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit FODS do TABDELIMITED programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
