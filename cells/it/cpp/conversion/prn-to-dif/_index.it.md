...
Hai bisogno di convertire i file PRN in DIF tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in DIF in poche righe di codice.
...
1.  Convertire PRN in DIF chiamando il metodo Save().
