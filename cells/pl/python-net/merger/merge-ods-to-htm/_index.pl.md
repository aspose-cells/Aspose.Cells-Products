---
title:  Połącz ODS z HTM przez Python
url: /pl/python-net/merger/merge-ods-to-htm/ 
description: Połącz ODS z HTM Online za darmo. Bezpłatnie online ODS do połączenia HTM. Połącz ODS z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak scalić ODS z HTM w Python.
...
{{% cells-merger title="Darmowa aplikacja do łączenia ODS z HTM on-line" InputFormat="ods" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
