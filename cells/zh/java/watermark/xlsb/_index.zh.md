---
title: 通过 Java 给 XLSB 文档添加水印 
weight: 5900
url: /zh/java/watermark/xlsb/ 
description: Java 用于在 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中向 XLSB 文件添加或删除水印的示例代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将文本水印添加到 XLSB" h2="使用服务器端 API 构建您自己的 Java 应用来为 XLSB 文件添加水印。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将水印添加到 XLSB 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. 创建一个新的工作簿对象1. 通过其索引选择工作表1. 创建一个 Shape 并使用它的 addTextEffect 函数1. 设置颜色、透明度等1. 以 XLSB 格式保存工作簿
