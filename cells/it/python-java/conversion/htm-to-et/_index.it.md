...
description: Aspose Excel. Converti HTM in ET in modo rapido e semplice con Aspose.Cells. Python HTM in ET. Python Salva HTM su ET. Salva HTM come ET utilizzando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti HTM in ET in Python" h2="Libreria Python ad alta velocità per la conversione da HTM a ET. Questa è una soluzione software professionale per importare ed esportare HTM, ET e molti altri formati utilizzando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converti HTM in ET utilizzando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Salva HTM su ET in Python" %}}

L'esempio seguente mostra come convertire HTM in ET in Python.
...
{{% blocks/products/pf/agp/content h2="Libreria Python per convertire HTM in ET" %}}
