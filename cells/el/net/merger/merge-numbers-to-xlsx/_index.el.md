---
title: Συγχώνευση NUMBERS στο XLSX - Συνδυάστε NUMBERS στο XLSX στο C#
url: /el/net/merger/merge-numbers-to-xlsx/ 
description: Aspose Excel. C# Aspose.Cells. Δωρεάν Online Merge NUMBERS to XLSX saveformat. C# Συνδυάστε τα NUMBERS σε μορφή XLSX. Συγχώνευση NUMBERS στο XLSX στο C#. NUMBERS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση NUMBERS στο XLSX στο C# Δωρεάν Online" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε τους αριθμούς με το XLSX στο Aspose.Cells for .NET.
...
{{% cells-merger title="Δωρεάν online για συγχώνευση NUMBERS στο XLSX στο C#" InputFormat="numbers" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε τους αριθμούς στο XLSX μέσω του C#" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε τα NUMBERS στο XLSX μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2=".NET βιβλιοθήκη για συγχώνευση NUMBERS με XLSX" %}}
