---
title: Reparar arquivo ods via .NET
url: /pt/net/recovery/repair-ods/ 
description: Repare um arquivo ods corrompido usando C#. Ferramenta de recuperação para reparar o arquivo ods corrompido no aplicativo .NET.
---
...
{{% cells-recovery title="Aplicativo gratuito para reparar o arquivo ODS usando .NET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="ods" outformat="ods" IsLandingPage="true" language="net" %}}    
