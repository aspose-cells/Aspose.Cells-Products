...
url: /net/conversion/xlsx-to-sql/
description: Sample code for xlsx to sql C# conversion. Use API example code for batch xlsx files to sql conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLSX to SQL via C#" h2="Export Excel® spreadsheets to SQL format on .NET Framework, .NET Core, Mono or Xamarin Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="How to Convert XLSX to SQL Using C#" %}}

 In order to convert XLSX to SQL, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLSX to SQL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert XLSX files to SQL in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load XLSX file with an instance of Workbook
1.  Call the Workbook.Save method
1.  Pass output path with SQL extension as parameters
...
{{% blocks/products/pf/agp/code-block title="This sample code shows xlsx to sql C# Conversion" offSpacer="" %}}

{{< gist "aspose-cells-gists" "88c9872508ec3150c552eb5155edf06e" "Convert-xlsx-to-sql.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XLSX to SQL" sectionDescription="Check our live demos for [XLSX to SQL conversion](https://products.aspose.app/cells/conversion/xlsx-to-sql) with following benefits." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will instantly get the download link for resultant SQL file." >}}
 ...
 An Excel Spreadsheet Programming Library capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. .NET Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS and more, thus making it a perfect choice to exchange documents in industry-standard formats.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/about-file-text fileFormat="SQL" readMoreLink="https://docs.fileformat.com/spreadsheet/sql/" >}}
