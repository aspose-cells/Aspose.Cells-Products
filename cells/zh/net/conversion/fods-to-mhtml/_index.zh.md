---
title: C# FODS 转 MHTML - 在线 FODS 转 MHTML 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 FODS 转换为 MHTML 保存格式。 C# FODS 到 MHTML 格式。将 FODS 保存为 MHTML C#。
...
{{% blocks/products/pf/agp/content h2="免费在线保存 FODS 至 MHTML 于 C#" %}}

以下示例演示如何将 C# 中的 FODS 转换为 MHTML。
...
{{% cells-convert title="免费应用程序和示例代码可在线将 FODS 转换为 MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="mhtml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 FODS 转换为 MHTML" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 FODS 文件转换为 MHTML 吗？ .NET 开发人员只需几行代码即可轻松加载和转换 FODS 到 MHTML。
...
{{% blocks/products/pf/agp/content h2="C#库将FODS转换为MHTML" %}}
