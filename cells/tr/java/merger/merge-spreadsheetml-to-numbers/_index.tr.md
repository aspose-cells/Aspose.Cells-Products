---
title: SPREADSHEETML'yi NUMBERS ile birleştir - SPREADSHEETML'yi Java'de NUMBERS ile birleştir
url: /tr/java/merger/merge-spreadsheetml-to-numbers/ 
description: Aspose excel. Java Aspose.Cells. SPREADSHEETML'yi NUMBERS kaydetme biçimine Ücretsiz Çevrimiçi Birleştirme. Java SPREADSHEETML'yi SAYILAR biçiminde birleştirin. SPREADSHEETML'yi Java'de NUMBERS ile birleştirin. SPREADSHEETML Birleştirin.
...
Aşağıdaki örnek, SPREADSHEETML'in Aspose.Cells for Java'de NUMBERS ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="SPREADSHEETML\'yi Java\'de NUMBERS ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'yi NUMBERS via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 SPREADSHEETML'yi programlı olarak NUMBERS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
