---
title: PHP XLTM إلى PRN - XLTM إلى PRN المحول
description: Aspose اكسل. تحويل XLTM إلى PRN بسرعة وسهولة مع Aspose.Cells. PHP XLTM إلى PRN. PHP احفظ XLTM في PRN. احفظ XLTM كـ PRN باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى PRN عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى PRN برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى PRN بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى PRN عن طريق استدعاء طريقة حفظ المصنف.
