---
title: Python 経由で EXCEL を POWERPOINT にマージ
...
次の例は、EXCEL を Python の POWERPOINT にマージする方法を示しています。
...
{{% cells-merger title="オンラインでEXCELをPOWERPOINTにマージする無料アプリ" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
