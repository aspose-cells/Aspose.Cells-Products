...
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED konvertálása XPS-re a következőn keresztül: Java" h2="TABDELIMITED XPS Java konverzió egyetlen vagy több oldal XPS formátumba konvertálásához az On-premise Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="A TABDELIMITED konvertálása XPS-re a következővel: Java" %}}

 A TABDELIMITED megjelenítéséhez XPS-re használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TABDELIMITED konvertálása XPS-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői egyszerűen konvertálhatnak TABDELIMITED fájlt XPS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. TABDELIMITED fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XPS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XPS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED XPS Java konverziós forráskódra" offSpacer="" %}}

```cs
// töltse be a TABDELIMITED fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tabdelimited");
// a TABDELIMITED mentése XPS-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED XPS Conversion Live Demos" sectionDescription="[TABDELIMITED konvertálása XPS-re](https://products.aspose.app/cells/conversion/tabdelimited-to-xps) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a TABDELIMITED fájlt, és azonnal XPS-re konvertálódik." >}}
