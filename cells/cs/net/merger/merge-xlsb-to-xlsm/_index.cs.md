---
title: Sloučit XLSB až XLSM - Sloučit XLSB až XLSM v C#
url: /cs/net/merger/merge-xlsb-to-xlsm/ 
description: Aspose Excel. C# Aspose.Cells. Online sloučení zdarma XLSB do formátu uložení XLSM. C# Kombinujte formát XLSB až XLSM. Sloučit XLSB až XLSM v C#. XLSB Sloučit.
...
Následující příklad ukazuje, jak sloučit XLSB až XLSM v Aspose.Cells for .NET.
...
{{% cells-merger title="Online zdarma ke sloučení XLSB až XLSM v C#" InputFormat="xlsb" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB na XLSM přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLSB až XLSM? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
