---
title: Convierta NÚMEROS a HTML a través de Java 
url: /es/java/conversion/numbers-to-html/ 
description: Ejemplo de código de conversión Java para formato NUMBERS a archivo HTML. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a HTML dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta NÚMEROS a HTML a través de Java" h2="Conversión de NUMBERS a HTML Java para convertir una o varias páginas a HTML utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir NÚMEROS a HTML usando Java" %}}

 Para convertir NÚMEROS en HTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir NÚMEROS a HTML a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente el archivo NUMBERS a HTML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo NUMBERS con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con extensión HTML y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo HTML resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de NUMBERS a HTML Java" offSpacer="" %}}

```cs
// cargue el archivo NUMBERS en una instancia de Workbook
Workbook book = new Workbook("template.numbers");
// guardar NÚMEROS como HTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de NUMBERS a HTML" sectionDescription="[Convertir NÚMEROS a HTML](https://products.aspose.app/cells/conversion/numbers-to-html) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo NUMBERS, se convertirá instantáneamente a HTML." >}}
