...
{{% blocks/products/pf/agp/content h2="วิธีแทรก GroupBox (การควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก GroupBox(Form control) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addGroupBox(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรก GroupBox (การควบคุมฟอร์ม) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก GroupBox(ตัวควบคุมฟอร์ม) - Python via java" offSpacer="" %}}
