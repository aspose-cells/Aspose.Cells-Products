---
title: Sloučit EXCEL s XLSB - Kombinovat EXCEL s XLSB v C#
url: /cs/net/merger/merge-excel-to-xlsb/ 
description: Aspose Excel. C# Aspose.Cells. Online zdarma sloučit EXCEL do XLSB saveformat. C# Kombinujte EXCEL do formátu XLSB. Sloučit EXCEL na XLSB v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL na XLSB v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit EXCEL s XLSB v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení EXCELu s XLSB. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLSB. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí EXCEL do XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení EXCELu s XLSB v C#" InputFormat="xlsx" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL s XLSB přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit EXCEL s XLSB programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení EXCELu s XLSB" %}}
