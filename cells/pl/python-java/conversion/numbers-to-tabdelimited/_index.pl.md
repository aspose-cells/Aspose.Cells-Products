---
title: Konwertuj NUMBERS na TABDELIMITED przez Python
url: /pl/python-java/conversion/numbers-to-tabdelimited/
description: Przykładowy kod do konwersji liczb do rozdzielanej tabulatorami Python. Użyj przykładowego kodu API dla plików z numerami partii do konwersji rozdzielanej tabulatorami w aplikacji Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj NUMBERS na TABDELIMITED przez Python" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu TABDELIMITED przy użyciu Python interfejsów API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować NUMBERS na TABDELIMITED za pomocą Python" %}}

 Aby przekonwertować NUMBERS na TABDELIMITED, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować NUMBERS na TABDELIMITED przez Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki NUMBERS na TABDELIMITED w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik NUMBERS z wystąpieniem skoroszytu1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem TSV jako parametrem1. Sprawdź podaną ścieżkę dla wynikowego pliku TABDELIMITED
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji NUMBERS na TABDELIMITED" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tsv" IsLandingPage="true" language="python" %}}
