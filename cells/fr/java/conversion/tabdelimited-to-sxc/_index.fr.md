---
title: Convertir TABDELIMITED en SXC via Java 
url: /fr/java/conversion/tabdelimited-to-sxc/ 
description: Exemple de code de conversion Java pour le format TABDELIMITED en fichier SXC. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers SXC dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TABDELIMITED en SXC via Java" h2="Conversion TABDELIMITED en SXC Java pour convertir une ou plusieurs pages en SXC à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TABDELIMITED en SXC en utilisant Java" %}}

 Afin de rendre TABDELIMITED à SXC, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TABDELIMITED en SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier TABDELIMITED en SXC en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier TABDELIMITED avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension SXC et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier SXC résultant
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED à SXC Java code source de conversion" offSpacer="" %}}

```cs
// charger le fichier TABDELIMITED dans une instance de Workbook
Workbook book = new Workbook("template.tabdelimited");
// enregistrer TABDELIMITED en tant que SXC
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED aux démonstrations en direct de conversion SXC" sectionDescription="[Convertir TABDELIMITED en SXC](https://products.aspose.app/cells/conversion/tabdelimited-to-sxc) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier TABDELIMITED, il sera converti instantanément en SXC." >}}
