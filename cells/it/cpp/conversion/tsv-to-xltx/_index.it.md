---
title: Converti TSV in XLTX tramite l'applicazione C++ 
weight: 3100
url: /it/cpp/conversion/tsv-to-xltx/ 
description: Esempio di codice di conversione C++ per un documento TSV in formato XLTX. I programmatori possono utilizzare questo codice sorgente per la conversione batch da TSV a XLTX all'interno di qualsiasi C++ Applicazione.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire TSV in XLTX utilizzando C++" %}}

 Per convertire TSV in XLTX, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TSV in XLTX tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente file TSV in XLTX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TSV usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XLTX).1. Il file XLTX verrà salvato nel percorso specificato.1. Apri il file XLTX nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da TSV a XLTX C++" offSpacer="" %}}
