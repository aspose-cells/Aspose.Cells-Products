...
url: /ja/python-java/merger/merge-ots-to-markdown/ 
...
次の例は、Aspose.Cells for Python via Java の MARKDOWN に OTS をマージする方法を示しています。
...
OTSをMARKDOWNにプログラムでマージする必要がありますか？基本的なドキュメントのマージと連結[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実現できます。
