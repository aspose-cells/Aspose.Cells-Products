...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в ODS, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в ODS в C#" %}}
...
{{% cells-convert title="Пример кода для преобразования FODS в ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="ods" IsLandingPage="true" %}}
...
1.  Преобразуйте значение FODS в ODS, вызвав метод Workbook.Save.
