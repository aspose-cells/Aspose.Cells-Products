...
description: Aspose Excel. Python Excel. Convert FODS to XPS quickly and easily with Aspose.Cells. Python FODS to XPS. Python Save FODS to XPS. Save FODS as XPS using Python Excel Library.
...
{{% blocks/products/pf/agp/content h2="Convert FODS to XPS Using Python Excel Library" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODS to XPS in Python Excel Library" %}}

The following example demonstrates how to convert FODS to XPS in Python excel library.
...
{{% blocks/products/pf/agp/content h2="Python Excel Library to Convert FODS to XPS" %}}
