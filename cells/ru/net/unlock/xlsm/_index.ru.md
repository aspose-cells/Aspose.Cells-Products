...
{{< blocks/products/pf/i18n/upper-banner h1="Разблокируйте таблицу XLSM с помощью C#." h2="Снимите защиту с XLSM с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Как разблокировать файл XLSM с помощью C#" %}}
 ...
 Чтобы удалить файл защиты XLSM, воспользуемся
