...
{{% blocks/products/pf/agp/content h2="Преобразовать JPG в PRN, используя код Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохранить JPG в PRN в Java" %}}

Следующий пример демонстрирует, как преобразовать JPG в PRN в файле Java.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать JPG в PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы JPG в PRN? Разработчики Java могут легко преобразовать JPG в PRN всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования JPG в PRN" %}}
{{% blocks/products/pf/agp/text %}}
