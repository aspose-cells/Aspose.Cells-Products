...
url: /de/net/merger/merge-htm-to-xltx/ 
description: Aspose Excel. C# Aspose.Cells. Kostenloses Online-Merge-HTM zum XLTX-Speicherformat. C# Kombinieren Sie HTM mit dem Format XLTX. HTM zu XLTX in C# zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie HTM kostenlos mit XLTX in C# online zusammen" %}}

Das folgende Beispiel zeigt, wie HTM mit XLTX in Aspose.Cells for .NET zusammengeführt wird.
...
{{% cells-merger title="Kostenlos online, um HTM mit XLTX in C# zusammenzuführen" InputFormat="htm" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie HTM über C# mit XLTX zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM programmgesteuert mit XLTX zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von HTM mit XLTX" %}}
