---
title:  Inserir controle ActiveX no Excel via .NET
weight: 10
description: C# código-fonte para inserir o controle ActiveX no Excel em .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Como inserir o controle ActiveX no arquivo do Excel usando C#" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o[adicionar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addActiveXControl) para inserir um controle ActiveX na planilha selecionada
