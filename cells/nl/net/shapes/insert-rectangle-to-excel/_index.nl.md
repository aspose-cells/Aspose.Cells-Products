---
title:  Rechthoek invoegen in Excel via .NET
weight: 240
description: C# Voorbeeldcode om rechthoek toe te voegen of in te voegen in Excel met behulp van bibliotheek .NET. Gebruik deze code om rechthoek te maken in MS Excel binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
keywords: [C# Aspose.Cells., c# add Rectangle., c# insert Rectangle., c# create Rectangle]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Rechthoek invoegen in Excel via .NET" h2="Voeg een rechthoek in met Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een rechthoek in een Excel-bestand kunt invoegen met behulp van C#" %}}
 ...
 Om een rechthoek in een Excel-bestand in te voegen, gebruiken we
...
+ Selecteer Werkblad via de index.
 + Gebruik de[methode toevoegen](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addrectangle) om een rechthoek in het geselecteerde werkblad in te voegen
