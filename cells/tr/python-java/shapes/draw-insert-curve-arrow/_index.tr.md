---
title: Python via Java'i kullanarak Excel'e kavisli ok şekli nasıl çizilir veya eklenir?
weight: 10
description: Microsoft veya Open Office, Adobe PDF vb. gibi herhangi bir yazılım olmadan Aspose.Cells' Python via Java API'i kullanarak kavisli ok şekli çizin veya ekleyin.
...
{{% blocks/products/pf/agp/content h2="Python via Java Kullanarak Excel Dosyasına Eğri Ok Şekli Nasıl Eklenir?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java\'i kullanarak Excel dosyasına kavisli ok şekli ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Şekil koleksiyonunu kullanın[yöntem ekle](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) seçili çalışma sayfasına kavisli bir ok şekli eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Kavisli ok şeklini ekleyin - Python via Java" offSpacer="" %}}
