---
title: Gabungkan XLSM ke ETT - Gabungkan XLSM ke ETT di Java
url: /id/java/merger/merge-xlsm-to-ett/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLSM ke format simpan ETT. Java Gabungkan XLSM ke format ETT. Gabung XLSM ke ETT di Java. XLSM Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSM ke ETT di Java" %}}

Contoh berikut menunjukkan cara menggabungkan XLSM ke ETT di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSM ke ETT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ETT. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan XLSM ke ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLSM ke ETT di Java" InputFormat="xlsm" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSM menjadi ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan XLSM ke ETT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
