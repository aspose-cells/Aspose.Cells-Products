---
title: Combinar XLSM a XLSX - Combinar XLSM a XLSX en Java
url: /es/java/merger/merge-xlsm-to-xlsx/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLSM a XLSX guardar formato. Java Combina el formato XLSM con el XLSX. Combinar XLSM a XLSX en Java. XLSM Combinar.
keywords: [Aspose Excel., Java Aspose.Cells., Merge XLSM to XLSX in Java., Free Online Java Merge XLSM to xlsx., Java Combine XLSM to XLSX Online for Free., XLSM Merge]
---
...
El siguiente ejemplo muestra cómo combinar XLSM con XLSX en Aspose.Cells for Java.
...
{{% cells-merger title="Gratis en línea para fusionar XLSM a XLSX en Java" InputFormat="xlsm" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM a XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLSM con XLSX mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
