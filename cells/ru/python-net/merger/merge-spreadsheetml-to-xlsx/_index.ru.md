---
title:  Объединить SPREADSHETML в XLSX через Python
...
В следующем примере показано, как объединить SPREADSHEETML с XLSX в Python.
