...
Precisa converter arquivos XLS para NUMBERS programaticamente? C++ desenvolvedores podem facilmente converter XLS para NUMBERS em apenas algumas linhas de código.
...
1.  Converta XLS em NÚMEROS chamando o método Save().
