...
description: Aspose Excel. C# Создать файл PNG. Создать PNG C#. C# PNG Создатель. Создайте PNG в C#. Создайте файл PNG, используя C#.
...
1. Используйте метод Сохранить, чтобы сохранить книгу как файл PNG.
