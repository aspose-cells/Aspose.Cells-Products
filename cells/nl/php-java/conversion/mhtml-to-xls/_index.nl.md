...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar XLS met Aspose.Cells. PHP MHTML naar XLS. PHP Bewaar MHTML naar XLS. Sla MHTML op als XLS met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar XLS te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar XLS converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar XLS.
...
1.  Converteer MHTML naar XLS door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van MHTML naar XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om MHTML naar XLS te converteren" %}}
