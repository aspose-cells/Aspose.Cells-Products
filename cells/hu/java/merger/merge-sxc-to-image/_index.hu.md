---
title: A SXC egyesítése az IMAGE-val – a SXC-es szám egyesítése az IMAGE-val a Java-ben
url: /hu/java/merger/merge-sxc-to-image/ 
description: Aspose Excel. Java Aspose.Cells. A SXC egyesítése az IMAGE mentési formátumba. Java A SXC kombinálása IMAGE formátumba. A SXC egyesítése a Java-es számú IMAGE-val. SXC Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A SXC egyesítése az IMAGE-val a Java-ben" %}}

következő példa bemutatja, hogyan lehet egyesíteni a SXC-et az IMAGE-val a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SXC és az IMAGE egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el az IMAGE fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a SXC-et az IMAGE-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a SXC és az IMAGE egyesítéséhez a Java-ben" InputFormat="sxc" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A SXC és az IMAGE via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SXC-et az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a SXC és az IMAGE egyesítéséhez" %}}
