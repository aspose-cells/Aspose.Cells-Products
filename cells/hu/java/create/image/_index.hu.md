...
{{% blocks/products/pf/agp/content h2="Hogyan készítsünk KÉPET a Java számon" %}}
...
1.  Mentse el a munkafüzetet IMAGE formátumban a save() metódussal.

{{% blocks/products/pf/agp/code-block title="A mintakód bemutatja, hogyan kell IMAGE fájlt létrehozni a Java-ben." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java könyvtár az IMAGE fájl létrehozásához" %}}
{{% blocks/products/pf/agp/text %}}
