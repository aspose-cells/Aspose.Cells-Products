---
title: PHP SXC - MD - SXC - MD Converter
description: Aspose Excel. A SXC-et gyorsan és egyszerűen konvertálja MD-re a Aspose.Cells-el. PHP SXC-et MD-re. PHP Mentés SXC MD. Mentse el a SXC számot MD-ként PHP használatával.
...
{{% blocks/products/pf/agp/content h2="A SXC konvertálása MD-re PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

SXC fájlokat programozottan MD-re kell konvertálnia? A PHP-fejlesztők egyszerűen betölthetik és néhány sornyi kóddal MD-re konvertálhatják a SXC-et.
...
1.  Konvertálja a SXC-et MD-vé a munkafüzet mentési módszerének meghívásával.
1.  Szerezze meg a SXC konverziós eredményt MD-vé.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP könyvtár a SXC MD-re konvertálásához" %}}
