---
title: "XLSX fájlok egyesítése a következőn keresztül: Java "
weight: 8930

description: Java mintakód az XLSX dokumentumok kombinálásához a Java Runtime Environment for JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSX formátumok egyesítése itt: Java" h2="Natív XLSX-dokumentumok egyesítése szerveroldali Java API-kkal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLSX fájlok egyesítése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSX fájlok egyesítésének lépései a következőben: Java" %}}
...
+ mentse az egyesített XLSX fájlt a megadott elérési útra
...
{{% blocks/products/pf/agp/code-block title="XLSX fájlok egyesítése – Java" offSpacer="" %}}

```cs
// Nyissa meg az első XLSX fájlt.
Workbook xlsxFile1 = new Workbook("chartsFileWithPath.xlsx");

// Határozza meg a második forráskönyvet.
// Nyissa meg a második XLSX fájlt.
