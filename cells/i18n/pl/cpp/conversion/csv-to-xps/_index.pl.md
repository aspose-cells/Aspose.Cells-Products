---
title: Konwertuj CSV na XPS za pomocą aplikacji C++ 
weight: 3170
url: /pl/cpp/conversion/csv-to-xps/ 
description: Przykładowy kod konwersji C++ dla dokumentu CSV do formatu XPS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji plików CSV do XPS w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj CSV na XPS za pomocą C++" h2="Wydajna konwersja plików CSV do XPS przy użyciu biblioteki C++ bez konieczności instalowania programu Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik CSV na XPS za pomocą C++" %}}

 Aby przekonwertować plik CSV na XPS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować plik CSV na XPS za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik CSV na XPS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XPS).1. Plik XPS zostanie zapisany pod określoną ścieżką.1. Otwórz plik XPS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="CSV do XPS C++ Kod źródłowy konwersji" offSpacer="" %}}
