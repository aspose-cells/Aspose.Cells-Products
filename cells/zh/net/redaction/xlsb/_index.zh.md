---
title: 通过 .NET 搜索和替换 XLSB 文档中的文本 
weight: 3890
url: /zh/net/redaction/xlsb/ 
description: C# 源代码，用于在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上编辑 XLSB 文件中的敏感信息。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="编辑 C# 中的 XLSB 格式" h2="使用服务器端 Aspose.Cells for .NET API 的本机和高性能 XLSB 文档敏感编校信息，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
