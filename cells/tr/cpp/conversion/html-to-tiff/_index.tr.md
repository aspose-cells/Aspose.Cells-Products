...
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla HTML\'yi TIFF\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı HTML\'den TIFF\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, HTML dosyasını yalnızca birkaç satır kodla kolayca TIFF'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak HTML dosyasını yükleyin.1. İlk çalışma sayfasını seçin.1. (TIFF) seçeneklerini ayarlayın.1. Sayfanın her sayfasını yineleyin ve oluşturun.1. TIFF dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="HTML\'den TIFF\'e C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
