---
title: Hur man ritar eller infogar en böjd pilform i Excel med Python via Java
weight: 10
description: Rita eller infoga en krökt pilform med Aspose.Cells' Python via Java API utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Hur man infogar en krökt pilform i Excel-fil med Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga en krökt pilform i Excel-fil med Python via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) för att infoga en krökt pilform i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga krökt pilform - Python via Java" offSpacer="" %}}
