...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar TIFF met Aspose.Cells. PHP OTS naar TIFF. PHP Bewaar OTS naar TIFF. Sla OTS op als TIFF met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar TIFF te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar TIFF converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar TIFF in slechts een paar regels code.
...
1.  Converteer OTS naar TIFF door de opslagmethode van Workbook aan te roepen.
