...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar XPS met Aspose.Cells. Java OTS naar XPS. Java Bewaar OTS naar XPS. Sla OTS op als XPS met Java.
...
{{% blocks/products/pf/agp/content h2="Bewaar OTS op XPS in Java" %}}
...
{{% blocks/products/pf/agp/content h2="OTS converteren naar XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar XPS converteren? Java-ontwikkelaars kunnen OTS eenvoudig met slechts een paar regels code naar XPS converteren.
