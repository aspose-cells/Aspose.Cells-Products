---
title: Gabungkan XLSB ke ETT - Gabungkan XLSB ke ETT di C#
url: /id/net/merger/merge-xlsb-to-ett/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSB ke format simpan ETT. C# Gabungkan XLSB ke format ETT. Gabung XLSB ke ETT di C#. XLSB Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSB ke ETT di C#" %}}

Contoh berikut menunjukkan cara menggabungkan XLSB ke ETT di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSB ke ETT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ETT. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSB ke ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLSB ke ETT di C#" InputFormat="xlsb" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSB ke ETT lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan XLSB ke ETT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
