...
Hai bisogno di convertire i file OTS in IMAGE tramite codice? Gli sviluppatori C++ possono facilmente convertire OTS in IMAGE in poche righe di codice.
...
1.  Convertire OTS in IMAGE chiamando il metodo Save().
