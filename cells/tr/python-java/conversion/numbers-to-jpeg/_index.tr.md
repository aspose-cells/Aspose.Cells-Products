---
title: Python NUMARALAR'dan JPEG'e - NUMARALAR'dan JPEG'e Dönüştürücü
description: Aspose Excel'de. NUMBERS'ı Aspose.Cells ile hızlı ve kolay bir şekilde JPEG'e dönüştürün. Python NUMBERS'ı JPEG'e dönüştürün. Python NUMBERS'ı JPEG'e kaydedin. NUMBERS'ı Python'i kullanarak JPEG olarak kaydedin.
...
{{% cells-convert title="NUMBERS\'ı JPEG\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="jpg" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı Python aracılığıyla JPEG\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı programlı olarak JPEG'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyip JPEG'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak NUMBERS'ı JPEG'e dönüştürün.
1.  NUMBERS'ın dönüşüm sonucunu JPEG'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı JPEG\'e dönüştürmek için Python kitaplığı" %}}
