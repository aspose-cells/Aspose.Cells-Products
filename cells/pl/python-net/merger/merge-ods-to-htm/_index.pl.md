...
Poniższy przykład pokazuje, jak scalić ODS z HTM w Aspose.Cells for Python via .NET.
...
Chcesz programowo scalić numer ODS z HTM? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
