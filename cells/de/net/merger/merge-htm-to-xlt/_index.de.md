---
title: HTM mit XLT zusammenführen – HTM mit XLT in C# kombinieren
url: /de/net/merger/merge-htm-to-xlt/ 
description: Aspose Excel. C# Aspose.Cells. HTM mit dem Sicherungsformat XLT zusammenführen. C# Kombinieren Sie HTM mit dem Format XLT. HTM zu XLT in C# zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="HTM mit XLT in C# zusammenführen" %}}

Das folgende Beispiel zeigt, wie HTM mit XLT in Aspose.Cells for .NET zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von HTM mit XLT in C#" InputFormat="htm" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie HTM über C# mit XLT zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM programmgesteuert mit XLT zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
