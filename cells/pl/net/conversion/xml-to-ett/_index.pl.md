...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XML do formatu ETT, umożliwiając bezproblemowe zapisywanie danych XML w formacie ETT za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML do ETT w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na ETT w formacie C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xml" outformat="ett" IsLandingPage="true" %}}
...
1.  Konwertuj XML do ETT wywołując metodę Workbook.Save.
