...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Python plně integrovaný přístup k převodu formátu XLSB do formátu DIF, což umožňuje bezproblémové ukládání dat XLSB do formátu DIF pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Python.
...
{{% blocks/products/pf/agp/content h2="Převést XLSB na DIF pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit XLSB až DIF v knihovně Excel Python" %}}

Následující příklad ukazuje, jak převést XLSB na DIF v knihovně Excel Python.
...
{{% cells-convert title="Ukázkový kód pro převod XLSB na DIF prostřednictvím knihovny Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsb" outformat="dif" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod XLSB na DIF" %}}
