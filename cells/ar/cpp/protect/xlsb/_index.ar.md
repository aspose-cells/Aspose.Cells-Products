---
title:  حماية وإغلاق XLSB المستند عبر C++
weight: 4860
description: C++ رمز مثال لقفل ملف XLSB باستخدام كلمة مرور على C++ بيئة وقت التشغيل لـ Windows 32 بت و Windows 64 بت و Linux 64 بت.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تشفير XLSB الملفات عبر C++" h2="تحمي جداول بيانات Excel بكلمة مرور بما في ذلك تنسيق XLSB باستخدام مكتبة .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1.  قم بتحميل ملف XLSB باستخدام فئة IWorkbook
1.  استخدم طريقة حماية (..) مع نوع الحماية وكلمة المرور
1.  احفظ الملف XLSB المحمي بطريقة الحفظ ()
