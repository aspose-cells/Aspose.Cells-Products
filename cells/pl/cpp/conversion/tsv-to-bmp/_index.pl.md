---
title: Konwertuj TSV na BMP za pomocą aplikacji C++ 
weight: 7000

description: Przykładowy kod konwersji C++ dla dokumentu TSV do formatu BMP. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TSV na BMP w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TSV na BMP przez C++" h2="Wysokowydajna konwersja TSV do BMP przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TSV na BMP w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (BMP).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik BMP w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TSV do BMP C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z TSV do BMP" sectionDescription="[Konwertuj TSV na BMP](https://products.aspose.app/cells/conversion/tsv-to-bmp) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik TSV, zostanie on natychmiast przekonwertowany na BMP." >}}
