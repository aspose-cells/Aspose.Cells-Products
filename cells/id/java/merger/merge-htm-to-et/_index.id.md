---
title: Gabungkan HTM ke ET - Gabungkan HTM ke ET di Java
url: /id/java/merger/merge-htm-to-et/ 
description: Aspose Unggul. Java Aspose.Cells. Online Gratis Menggabungkan HTM ke ET saveformat. Java Gabungkan format HTM ke ET. Gabungkan HTM ke ET di Java. Gabungkan HTM.
...
{{% blocks/products/pf/agp/content h2="Gabungkan HTM ke ET di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan HTM ke ET di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan HTM ke ET. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ET. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan HTM ke ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis untuk Menggabungkan HTM ke ET di Java" InputFormat="htm" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan HTM ke ET via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan HTM ke ET secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan HTM ke ET" %}}
