---
title:  A Spin Button (Űrlapvezérlő) beszúrása az Excelbe a Python via .Net használatával
weight: 40
description: Python via .Net forráskód a Spin Button (Űrlapvezérlő) beillesztéséhez az Excelbe.
...
{{% blocks/products/pf/agp/content h2="A Spin gomb (űrlapvezérlő) beszúrása Excel fájlba a Python via .Net használatával" %}}

 A Spin Button (Űrlapvezérlő) excel fájlba való beillesztéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A Spin Button (Űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python via .Net használatával" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjtemény hozzáadását[módszer](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_spinner/#int-int-int-int-int-int) egy Spin Button (Űrlapvezérlő) beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Centrifugálás gomb beszúrása (Űrlapvezérlő) - Python via .Net" offSpacer="" %}}
