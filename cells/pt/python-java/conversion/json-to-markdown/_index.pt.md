...
{{% blocks/products/pf/agp/content h2="Converta JSON em MARKDOWN usando a biblioteca Python do Excel" %}}
...
{{% blocks/products/pf/agp/content h2="Salve JSON em MARKDOWN na Biblioteca Excel Python" %}}

O exemplo a seguir demonstra como converter JSON em MARKDOWN na biblioteca Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca Excel para converter JSON em MARKDOWN" %}}
