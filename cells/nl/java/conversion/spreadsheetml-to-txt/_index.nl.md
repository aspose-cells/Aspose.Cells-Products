---
title: Converteer SPREADSHEETML naar TXT via Java 

description: Voorbeeld Java conversiecode voor SPREADSHEETML-indeling naar TXT-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar TXT te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer SPREADSHEETML naar TXT via Java" h2="SPREADSHEETML naar TXT Java conversie om enkele of meerdere pagina\'s naar TXT te converteren met behulp van een lokale bibliotheek Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML naar TXT te converteren met Java" %}}

 Om SPREADSHEETML naar TXT te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om SPREADSHEETML naar TXT te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het SPREADSHEETML-bestand gemakkelijk converteren naar TXT in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad SPREADSHEETML-bestand met een exemplaar van de werkmapklasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met TXT-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende TXT-bestand
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML naar TXT Java Conversiebroncode" offSpacer="" %}}

```cs
// laad het SPREADSHEETML-bestand in een instantie van Workbook
Workbook book = new Workbook("template.spreadsheetml");
// sla SPREADSHEETML op als TXT
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML naar TXT Conversie Live demo\'s" sectionDescription="[Converteer SPREADSHEETML naar TXT](https://products.aspose.app/cells/conversion/spreadsheetml-to-txt) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw SPREADSHEETML-bestand, het wordt onmiddellijk geconverteerd naar TXT." >}}
