...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in MD mit Aspose.Cells. PHP OTS in MD. PHP OTS auf MD speichern. Speichern Sie OTS als MD mit PHP.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in MD" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in MD konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in MD konvertieren.
...
1.  Konvertieren Sie OTS in MD, indem Sie die Speichermethode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in MD" %}}
