...
L'esempio seguente mostra come unire PNG in XLSB in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 È necessario unire PNG a XLSB a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Le API possono essere eseguite con poche righe di codice.
