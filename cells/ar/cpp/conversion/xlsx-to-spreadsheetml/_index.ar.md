---
title: تحويل XLSX إلى SPREADSHEETML عبر تطبيق C++ 
url: /ar/cpp/conversion/xlsx-to-spreadsheetml/ 
description: نموذج رمز تحويل C++ لمستند XLSX إلى تنسيق SPREADSHEETML. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLSX دفعة إلى SPREADSHEETML داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLSX إلى SPREADSHEETML عبر C++" h2="تحويل XLSX عالي الأداء إلى SPREADSHEETML باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLSX إلى SPREADSHEETML باستخدام C++" %}}
 ...
 من أجل تحويل XLSX إلى SPREADSHEETML ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف XLSX إلى SPREADSHEETML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLSX باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (SPREADSHEETML).1. سيتم حفظ ملف SPREADSHEETML في المسار المحدد.1. افتح ملف SPREADSHEETML في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLSX إلى شفرة مصدر التحويل SPREADSHEETML C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLSX إلى SPREADSHEETML عروض مباشرة للتحويل" sectionDescription="[تحويل XLSX إلى SPREADSHEETML](https://products.aspose.app/cells/conversion/xlsx-to-spreadsheetml) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف XLSX الخاص بك ، وسيتم تحويله على الفور إلى SPREADSHEETML." >}}
