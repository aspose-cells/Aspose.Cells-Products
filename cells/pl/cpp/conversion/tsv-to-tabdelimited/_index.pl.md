---
title: Konwertuj TSV na TABDELIMITED za pomocą aplikacji C++ 
url: /pl/cpp/conversion/tsv-to-tabdelimited/ 
description: Przykładowy kod konwersji C++ dla dokumentu TSV do formatu TABDELIMITED. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TSV do TABDELIMITED w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TSV na TABDELIMITED przez C++" h2="Wysokowydajna konwersja TSV do TABDELIMITED przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TSV na TABDELIMITED w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (TABDELIMITED).1. Plik TABDELIMITED zostanie zapisany pod określoną ścieżką.1. Otwórz plik TABDELIMITED w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TSV do TABDELIMITED C++ Kod źródłowy konwersji" offSpacer="" %}}
