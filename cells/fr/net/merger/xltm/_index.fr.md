---
title:  Fusionner les fichiers XLTM via .NET
weight: 9010
description: Code source C# pour combiner les documents XLTM sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats XLTM dans C#" h2="Fusion de documents XLTM native et haute performance à l\'aide d\'API Aspose.Cells for .NET côté serveur, sans utilisation de logiciels comme Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
+ Chargez tous les fichiers XLTM avec le chemin complet.
+ Créer un document comme fichier de base
+ Appelez la méthode appropriée pour concaténer et fusionner les fichiers un par un.
+ Appelez la méthode Save() et passez le nom du fichier (chemin complet) et le format (XLTM) en paramètre.
+ Vous pouvez désormais ouvrir et utiliser le fichier XLTM dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
