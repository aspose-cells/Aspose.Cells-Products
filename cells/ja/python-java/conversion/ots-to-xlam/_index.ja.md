...
{{% blocks/products/pf/agp/content h2="Python を使用して OTS を XLAM に変換する" %}}
...
次の例は、OTS を Python の XLAM に変換する方法を示しています。
...
{{% blocks/products/pf/agp/content h2="Python経由でOTSをXLAMに変換する方法" %}}
