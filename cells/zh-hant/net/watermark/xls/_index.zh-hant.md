---
title: 水印XLS文件via .NET
weight: 3050
description: C# 原始程式碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上向 XLS 檔案新增或刪除浮水印。
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 加水印到 XLS 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="加入浮水印到XLS - C#" offSpacer="" %}}
