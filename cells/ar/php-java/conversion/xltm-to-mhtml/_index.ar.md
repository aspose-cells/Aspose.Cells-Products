---
title: PHP XLTM إلى MHTML - XLTM إلى MHTML محول
description: Aspose اكسل. قم بتحويل XLTM إلى MHTML بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى MHTML. PHP احفظ XLTM إلى MHTML. احفظ XLTM كـ MHTML باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى MHTML عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى MHTML برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى MHTML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى MHTML عن طريق استدعاء طريقة حفظ المصنف.
