---
title: PHP TXT ～ JSON - TXT ～ JSON コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、TXT を JSON にすばやく簡単に変換します。PHP TXT から JSON。PHP TXT から JSON に保存します。PHP を使用して、TXT を JSON として保存します。
...
{{% cells-convert title="TXT を JSON に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="json" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP 経由で TXT を JSON に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

TXT ファイルをプログラムで JSON に変換する必要がありますか? PHP 開発者は、わずか数行のコードで TXT を簡単にロードして JSON に変換できます。
