---
title: Sloučit XLSB až BMP - Sloučit XLSB až BMP v C#
url: /cs/net/merger/merge-xlsb-to-bmp/ 
description: Aspose Excel. C# Aspose.Cells. Online sloučení zdarma XLSB do formátu uložení BMP. C# Kombinujte formát XLSB až BMP. Sloučit XLSB až BMP v C#. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až BMP v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLSB až BMP v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLSB do BMP. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru BMP. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí XLSB do BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XLSB až BMP v C#" InputFormat="xlsb" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB na BMP přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLSB až BMP? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení XLSB až BMP" %}}
