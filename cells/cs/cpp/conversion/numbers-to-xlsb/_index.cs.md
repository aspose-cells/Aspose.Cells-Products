...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte ČÍSLA na XLSB v C++" h2="Vysoce výkonný převod ČÍSEL na XLSB pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="Ukázkový kód pro převod ČÍSEL na XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="xlsb" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést ČÍSLA na XLSB přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory NUMBERS na XLSB programově? Vývojáři C++ mohou snadno převést ČÍSLA na XLSB v několika řádcích kódu.
...
1.  Převeďte ČÍSLA na XLSB voláním metody Save().
