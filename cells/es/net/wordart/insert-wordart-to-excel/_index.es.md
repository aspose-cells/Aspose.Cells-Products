...
weight: 370
description: C# código fuente para insertar WordArt en Excel en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar WordArt en un archivo de Excel a través de C#" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addwordart) para insertar un WordArt en la hoja de trabajo seleccionada
