...
Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin HTM ile nasıl birleştirileceğini gösterir.
...
MHT'yi programlı olarak HTM ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
