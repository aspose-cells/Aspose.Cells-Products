...
description: Aspose Excel'de. Aspose.Cells ile EXCEL'i hızlı ve kolay bir şekilde OTS'ye dönüştürün. Python EXCEL'i OTS'ye dönüştürün. Python EXCEL'i OTS'ye kaydedin. Python'i kullanarak EXCEL'i OTS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'de EXCEL\'i OTS\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i Python\'de OTS\'ye kaydedin" %}}

Aşağıdaki örnek, Python via NET'de EXCEL'in OTS'ye nasıl dönüştürüleceğini gösterir.
