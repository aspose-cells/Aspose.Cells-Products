...
url: /nl/python-net/merger/merge-json-to-html/ 
...
Het volgende voorbeeld laat zien hoe u JSON samenvoegt met HTML in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u JSON programmatisch samenvoegen met HTML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
