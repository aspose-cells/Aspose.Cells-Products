---
title:  Wstaw przycisk Spin (formant kontrolny) do programu Excel, używając Python via .Net
weight: 40
description: Python via .Net kod źródłowy, aby wstawić przycisk Spin (kontrola formularza) do programu Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw przycisk Spin (formant kontrolny) do programu Excel, używając Python via .Net" h2="Wstawiaj obiekty za pomocą interfejsów API po stronie serwera bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić przycisk wirowania (kontrola formularza) do pliku programu Excel za pomocą Python via .Net" %}}

 Aby wstawić przycisk Spin (kontrolka formularza) do pliku Excela, użyjemy
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj dodatku shapecollection[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_spinner/#int-int-int-int-int-int) aby wstawić przycisk pokrętła (formant formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw przycisk wirowania (kontrola formularza) - Python via .Net" offSpacer="" %}}
