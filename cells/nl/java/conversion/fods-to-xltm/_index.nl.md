...
{{% blocks/products/pf/agp/content h2="Sla FODS op in XLTM in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar XLTM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar XLTM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar XLTM? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar XLTM met slechts een paar regels code.
