---
title: Объединить OTS с TABDELIMITED — Объединить OTS с TABDELIMITED в Java.
url: /ru/java/merger/merge-ots-to-tabdelimited/ 
description: Aspose Эксель. Java Aspose.Cells. Объедините OTS с форматом сохранения TABDELIMITED. Java Объединить OTS в формат TABDELIMITED. Объедините OTS с TABDELIMITED в Java. Объедините OTS.
...
{{% blocks/products/pf/agp/content h2="Объединить OTS с TABDELIMITED в Java" %}}

В следующем примере показано, как объединить OTS с TABDELIMITED в Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить OTS с TABDELIMITED. Загрузите файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл TABDELIMITED. Если вы разработаете код Java, это будет проще, чем кажется. См. пример Java, в котором OTS объединяется с TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения OTS с TABDELIMITED в Java" InputFormat="ots" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Как объединить OTS с TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно объединить OTS с TABDELIMITED? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for Java](https://products.aspose.com/cells/java) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Java библиотека для объединения OTS с TABDELIMITED" %}}
