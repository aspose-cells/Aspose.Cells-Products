...
url: /hu/net/merger/merge-htm-to-xls/ 
...
A következő példa bemutatja, hogyan egyesítheti a HTM-et a XLS-es számmal a Aspose.Cells for .NET-ben.
...
Programozottan egyesítenie kell a HTM-et a XLS-es számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és a XLS egyesítéséhez" %}}
