---
title: Gộp TABDELIMITED thành HTM - Gộp TABDELIMITED thành HTM trong Java
url: /vi/java/merger/merge-tabdelimited-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất TABDELIMITED vào định dạng lưu HTM. Java Kết hợp TABDELIMITED thành định dạng HTM. Hợp nhất TABDELIMITED với HTM trong Java. Hợp nhất TABDELIMITED.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất TABDELIMITED vào HTM trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất TABDELIMITED với HTM trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất TABDELIMITED vào HTM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp HTM. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất TABDELIMITED với HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp TABDELIMITED vào HTM số Java" InputFormat="tsv" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất TABDELIMITED vào HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất TABDELIMITED với HTM theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất TABDELIMITED vào HTM" %}}
