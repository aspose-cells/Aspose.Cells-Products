...
{{% cells-convert title="Contoh Kode untuk Mengonversi OTS ke XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xlsb" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert OTS ke XLSB lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file OTS ke XLSB secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke XLSB hanya dalam beberapa baris kode.
...
1.  Ubah OTS menjadi XLSB dengan memanggil metode Save().
