...
以下示例演示如何將 JSON 合併到 Aspose.Cells for .NET 中的 XLT。
...
需要以編程方式將 JSON 合併到 XLT 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將JSON合併到XLT" %}}
