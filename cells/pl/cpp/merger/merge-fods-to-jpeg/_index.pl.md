...
url: /pl/cpp/merger/merge-fods-to-jpeg/ 
...
Poniższy przykład pokazuje, jak połączyć FODS z JPEG w Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz scalić FODS z JPEG programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia FODS z JPEG" %}}
