...
weight: 101
description: C# الكود المصدري لرسم أو إدخال شكل سهم الكوع في Excel على .NET Framework أو .NET Core أو Mono أو منصات Xamarin.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج شكل سهم الكوع في ملف Excel عبر C#" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) لإدراج شكل سهم كوع في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل شكل سهم الكوع - C#" offSpacer="" %}}
