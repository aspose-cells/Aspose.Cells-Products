---
title:  Insérer un rectangle dans Excel via Java
weight: 50
...
{{% blocks/products/pf/agp/content h2="Comment insérer un rectangle dans un fichier Excel à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer un rectangle dans un fichier Excel via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addRectangle-int-int-int-int-int-int-)pour insérer un rectangle dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer un rectangle - Java" offSpacer="" %}}
