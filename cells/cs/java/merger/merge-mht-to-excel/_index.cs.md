---
title: Sloučit MHT do EXCELu – Sloučit MHT do EXCELu v Java
url: /cs/java/merger/merge-mht-to-excel/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení EXCEL. Java Kombinujte formát MHT s formátem EXCEL. Sloučit MHT do EXCELu v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do EXCELu v Java" %}}

Následující příklad ukazuje, jak sloučit MHT do EXCELu v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT s EXCELem. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru EXCEL. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do EXCELu.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT do EXCELu v Java" InputFormat="mht" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT do EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit MHT do EXCELu? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení MHT do EXCELu" %}}
