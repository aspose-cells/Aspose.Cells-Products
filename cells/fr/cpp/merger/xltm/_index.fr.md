...
url: /fr/cpp/merger/xltm/ 
description: C++ Exemple de code pour combiner des documents XLTM sur C++ Runtime Environment pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats XLTM dans C++" h2="Fusion de documents XLTM à l\'aide d\'API C++ côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers XLTM dans C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers XLTM - C++" offSpacer="" %}}
