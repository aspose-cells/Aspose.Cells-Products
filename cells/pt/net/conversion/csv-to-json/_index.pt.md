---
title: C# CSV a JSON - CSV a JSON Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter CSV para o formato JSON, permitindo o salvamento perfeito de dados CSV no formato JSON usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve CSV a JSON em C#" %}}

exemplo a seguir demonstra como converter CSV em JSON em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter CSV em JSON por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos CSV em JSON programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter CSV em JSON em apenas algumas linhas de código.
...
1.  Converta CSV para JSON chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de CSV para JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter CSV em JSON" %}}
