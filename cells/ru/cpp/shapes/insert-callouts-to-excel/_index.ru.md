...
{{% blocks/products/pf/agp/content h2="Как вставить выноски в файл Excel с помощью C++" %}}
 ...
 Для вставки выносок в файл Excel мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Пошаговая инструкция по вставке выносок в файл Excel с помощью C++" %}}

+ Создание объекта Workbook. (или -> Загрузка файла XLSX с указанием полного пути.)
+ Выберите лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/) вставить выноски на выбранный лист
...
Приведённый ниже пример кода демонстрирует, как вставить «Облако мыслей». Для получения информации о других типах см. раздел «Обзор типов выносок» ниже.

{{% /blocks/products/pf/agp/text %}}

{{% blocks/products/pf/agp/code-block title="Вставьте выноску - C++" offSpacer="" %}}
