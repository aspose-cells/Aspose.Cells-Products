...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array je užitečné pro zpracování nebo ukládání dat. Soubor XLSX můžete převést na Byte Array a také dokument **Byte Array na XLSX** pomocí jazyka C#. Abychom převedli XLSX na bajtové pole, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Jak převést XLSX na Byte Array přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Pro vývojáře je snadné načíst a převést soubory XLSX do bajtového pole pro další manipulační úkoly v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Zahrňte jmenný prostor do souboru třídy1. Načtěte vstupní soubor XLSX pomocí sešitu1. Inicializujte objekt MemoryStream1. Převeďte datový proud na bajtové pole1. Zpracovávejte data dle vašeho požadavku
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod XLSX na pole bajtů C#" offSpacer="" %}}
