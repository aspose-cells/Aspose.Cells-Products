---
title:  C++ aracılığıyla ODS belgesinin kilidini aç
weight: 1190
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Runtime Environment üzerindeki parola korumalı ODS dosyasının kilidini açmak için örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla ODS Dosyalarının Kilidini Açın" h2="C++ Kitaplığı\'nı kullanarak ODS dosyası dahil olmak üzere Excel elektronik tablolarından korumayı kaldırın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanılarak ODS Dosyasının Koruması Nasıl Kaldırılır" %}}
...
1.  CreateIWorkbook'u kullanarak ODS kilitli dosyayı yükleyin.
1.  Kilidi açmak için Unprotect() işlevini çağırın.
1.  SetPassword kullanarak parolayı NULL olarak ayarlayın.
1.  ODS dosyasını belirtilen bir konuma kaydedin.
