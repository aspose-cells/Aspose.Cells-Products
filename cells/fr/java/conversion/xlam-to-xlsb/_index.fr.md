---
title: XLAM à XLSB - Convertir XLAM à XLSB fichiers Java
description: Aspose Excel. Conversion gratuite en ligne du format de sauvegarde XLAM en XLSB. Format Java XLAM à XLSB. Enregistrez XLAM sous XLSB dans Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLAM à XLSB dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLAM en XLSB en Java.
...
Besoin de convertir les fichiers XLAM en XLSB par programmation ? Les développeurs de Java peuvent facilement convertir XLAM en XLSB en seulement quelques lignes de code.
