...
description: Aspose Excel. C++ Utwórz plik GIF szybko i łatwo za pomocą Aspose.Cells. Wygeneruj plik GIF za pomocą C++. Utwórz GIF w C++. C++ GIF Kreator.
...
1.  Zapisz skoroszyt jako plik .gif, korzystając z metody Save().
