...
description: Aspose Excel. Converteer PNG snel en eenvoudig naar ETT met Aspose.Cells. Python PNG naar ETT. Python Bewaar PNG in ETT. Sla PNG op als ETT met Python.
...
{{% blocks/products/pf/agp/content h2="Sla PNG op in ETT in Python" %}}

Het volgende voorbeeld laat zien hoe u PNG naar ETT converteert in Python.
