---
title: C# OTS till OTS - OTS till OTS-omvandlare
description: Aspose Excel. Konvertera OTS till OTS snabbt och enkelt med Aspose.Cells. C# OTS till OTS. C# Spara OTS till OTS. Spara OTS som OTS med C#.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till OTS på C#" %}}

Följande exempel visar hur man konverterar OTS till OTS i C#.
...
{{% cells-convert title="Exempelkod för att konvertera OTS till OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till OTS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till OTS programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till OTS på bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera OTS till OTS" %}}
