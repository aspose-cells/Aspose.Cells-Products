...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása MARKDOWN-re a következővel: C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV MARKDOWN formátummá konvertálásához a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a TSV-fájlokat MARKDOWN formátumba.
