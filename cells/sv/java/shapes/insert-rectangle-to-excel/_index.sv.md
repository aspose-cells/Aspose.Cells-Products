...
{{< blocks/products/pf/i18n/upper-banner h1="Infoga rektangel i Excel via Java" h2="Infoga objekt med hjälp av API:er på serversidan utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hur man infogar rektangel i Excel-fil med hjälp av Java" %}}

 För att infoga rektangel i excel-filen använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga rektangel till Excel-fil via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Infoga rektangel - Java" offSpacer="" %}}
