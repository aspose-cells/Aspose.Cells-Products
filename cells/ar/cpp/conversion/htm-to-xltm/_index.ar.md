...
هل تحتاج إلى تحويل ملفات HTM إلى XLTM برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى XLTM في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى XLTM باستدعاء طريقة Save ().
