---
title: Sloučit PRN do WORD – Zkombinujte PRN do WORD v C#
url: /cs/net/merger/merge-prn-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Online zdarma Sloučit PRN do formátu uložení WORD. C# Kombinujte PRN s formátem WORD. Sloučit PRN do WORD v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN do WORD v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN do WORD v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do WORD. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí PRN do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení PRN do WORD v C#" InputFormat="prn" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN do WORD přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN do WORD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna pro sloučení PRN do WORD" %}}
