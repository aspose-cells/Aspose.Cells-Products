...
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj pliki XLSB przez C++" h2="Usuń ochronę z arkuszy kalkulacyjnych Excel, w tym z pliku XLSB, korzystając z C++Biblioteki." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1. Załaduj zablokowany plik XLSB za pomocą CreateIWorkbook.1. Wywołaj funkcję Unprotect(), aby odblokować.1. Ustaw hasło na NULL za pomocą SetPassword.1. Zapisz plik XLSB w określonej lokalizacji.
