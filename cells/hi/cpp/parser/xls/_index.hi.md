---
title: XLS दस्तावेज़ से C++ के माध्यम से टेक्स्ट और चित्र निकालें 
weight: 7610
url: /hi/cpp/parser/xls/ 
description: C++ विंडोज 32 बिट, विंडोज 64 बिट और लिनक्स 64 बिट के लिए रनटाइम एनवायरनमेंट पर एक्सएलएस फ़ाइल से टेक्स्ट और छवियों को निकालने के लिए C++ उदाहरण कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS प्रारूपों को C++ में पार्स करें" h2="Microsoft या Adobe PDF जैसे किसी सॉफ़्टवेयर के उपयोग के बिना, C++ API के लिए सर्वर-साइड Aspose.Cells का उपयोग करके मूल और उच्च प्रदर्शन XLS दस्तावेज़ पार्स करना।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/parser/xlsm/" name="एक्सएलएसएम" description="स्प्रेडशीट फ़ाइल" >}}
