---
title: Merge PRN to MHTML via Java 
url: /java/merger/merge-prn-to-mhtml/ 
description: Merge PRN to MHTML Online for Free. Free Online PRN to MHTML Merger. Merge PRN to Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS and more.
keywords: [Merge PRN to MHTML via Java., PRN to MHTML Merger., Merge PRN to MHTML Online for Free]
---
...
How to merge PRN to MHTML? With Aspose.Cells for Java library, you can easily merge PRN to MHTML programmatically with  a few lines of code. [Aspose.Cells for Java](https://products.aspose.com/cells/java) is capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. Java Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT and more, thus making it a perfect choice to exchange documents in industry-standard formats. You can download its latest version directly from [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) and install it within your Maven-based project by adding the following configurations to the pom.xml.
...
The following example demonstrates how to merge PRN to MHTML in Java.
...
{{% cells-merger title="Free App to merge PRN to MHTML on line" InputFormat="prn" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
