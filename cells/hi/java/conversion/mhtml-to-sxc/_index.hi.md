---
title: MHTML को SXC में Java के माध्यम से कनवर्ट करें 

description: नमूना Java एमएचटीएमएल प्रारूप के लिए एसएक्ससी फ़ाइल में रूपांतरण कोड। प्रोग्रामर इस उदाहरण कोड का उपयोग किसी भी वेब या डेस्कटॉप Java आधारित एप्लिकेशन के भीतर एक्सेल और ओपनऑफिस स्प्रेडशीट को एसएक्ससी में निर्यात करने के लिए कर सकते हैं।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="MHTML को SXC में Java के माध्यम से कनवर्ट करें" h2="ऑन-प्रिमाइसेस Java लाइब्रेरी का उपयोग करके एकल या एकाधिक पृष्ठों को SXC में बदलने के लिए MHTML से SXC Java रूपांतरण।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके MHTML को SXC में कैसे बदलें" %}}

 MHTML को SXC में रेंडर करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="एमएचटीएमएल को एसएक्ससी में बदलने के लिए कदम Java के माध्यम से" %}}

{{% blocks/products/pf/agp/text %}}

 Java डेवलपर कोड की कुछ ही पंक्तियों में आसानी से MHTML फ़ाइल को SXC में बदल सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. वर्कबुक क्लास के इंस्टेंस के साथ एमएचटीएमएल फाइल लोड करें1. कार्यपुस्तिका को कॉल करें। विधि सहेजें1. पैरामीटर के रूप में SXC एक्सटेंशन और SaveFormat के साथ आउटपुट पथ पास करें1. परिणामी SXC फ़ाइल के लिए निर्दिष्ट पथ की जाँच करें
...
{{% blocks/products/pf/agp/code-block title="MHTML से SXC Java रूपांतरण स्रोत कोड" offSpacer="" %}}

```cs
// कार्यपुस्तिका के उदाहरण में एमएचटीएमएल फ़ाइल लोड करें
Workbook book = new Workbook("template.mhtml");
// MHTML को SXC के रूप में सहेजें
...
{{< blocks/products/pf/agp/demobox sectionTitle="एमएचटीएमएल से एसएक्ससी रूपांतरण लाइव डेमो" sectionDescription="[MHTML को SXC में बदलें](https://products.aspose.app/cells/conversion/mhtml-to-sxc) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API डाउनलोड करने की आवश्यकता नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" कोई कोड लिखने की जरूरत नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी एमएचटीएमएल फाइल अपलोड करें, यह तुरंत एसएक्ससी में बदल जाएगी।" >}}
