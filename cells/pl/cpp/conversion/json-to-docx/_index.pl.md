---
title: Konwertuj JSON na DOCX za pomocą aplikacji C++ 
url: /pl/cpp/conversion/json-to-docx/ 
description: Przykładowy kod konwersji C++ dla dokumentu JSON do formatu DOCX. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji JSON na DOCX w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować JSON na DOCX przy użyciu C++" %}}

 Aby przekonwertować JSON na DOCX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować JSON na DOCX przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik JSON na DOCX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik JSON przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (DOCX).1. Plik DOCX zostanie zapisany pod określoną ścieżką.1. Otwórz plik DOCX w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="JSON na DOCX C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo konwersji JSON na DOCX" sectionDescription="[Konwertuj JSON na DOCX](https://products.aspose.app/cells/conversion/json-to-docx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik JSON, zostanie on natychmiast przekonwertowany do formatu DOCX." >}}
