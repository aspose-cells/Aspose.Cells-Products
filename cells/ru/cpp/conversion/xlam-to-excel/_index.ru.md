...
Нужно программно преобразовать файлы XLAM в Excel? Разработчики, работающие с файлами C++, могут легко преобразовать файлы XLAM в Excel всего несколькими строками кода.
...
1.  Преобразуйте значение XLAM в формат EXCEL, вызвав метод Save().
