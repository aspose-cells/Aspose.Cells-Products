...
weight: 1950
description: Java δείγμα κώδικα για διαχωρισμό εγγράφων ODS στο Java Runtime Environment για εφαρμογές JSP/JSF και εφαρμογές επιφάνειας εργασίας.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Split ODS Files via Java" h2="ODS διαχωρισμός με τη βοήθεια της βιβλιοθήκης Java από την πλευρά του διακομιστή." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για διαχωρισμό αρχείων ODS στο Java" %}}
...
+ Καλέστε τη μέθοδο αποθήκευσης με τη νέα διαδρομή αρχείου ODS.
