---
title: Gộp OTS thành ETT - Gộp OTS thành ETT theo số Java
url: /vi/java/merger/merge-ots-to-ett/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu OTS sang ETT. Java Kết hợp định dạng OTS sang ETT. Hợp nhất OTS với ETT theo số Java. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS vào ETT theo số Java" %}}

Ví dụ sau đây minh họa cách hợp nhất OTS với ETT trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất OTS với ETT. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp ETT. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất OTS với ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp OTS vào ETT Java" InputFormat="ots" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS thành ETT via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép OTS vào ETT" %}}
