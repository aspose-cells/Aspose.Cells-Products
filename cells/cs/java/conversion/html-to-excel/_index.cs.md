---
title: Java HTML do EXCEL - HTML do EXCEL Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu HTML do formátu EXCEL, což umožňuje bezproblémové ukládání dat HTML do formátu EXCEL pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte HTML na EXCEL v kódu Java" h2="Vysokorychlostní knihovna Java pro převod HTML do EXCELu. Jedná se o profesionální softwarové řešení pro import a export HTML, EXCELu a mnoha dalších formátů s použitím Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Uložit HTML do EXCELU v Java" %}}

Následující příklad ukazuje, jak převést číslo HTML na formát EXCEL s kódem Java.
...
{{% cells-convert title="Ukázkový kód pro převod čísla HTML do formátu EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak převést HTML na EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory HTML do formátu EXCEL? Vývojáři Java mohou snadno převést soubory HTML do formátu EXCEL pomocí několika řádků kódu.
...
1.  Získejte výsledek převodu HTML na EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod souboru HTML do formátu EXCEL" %}}
{{% blocks/products/pf/agp/text %}}
