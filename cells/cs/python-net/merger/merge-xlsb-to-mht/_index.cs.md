...
url: /cs/python-net/merger/merge-xlsb-to-mht/ 
...
Následující příklad ukazuje, jak sloučit XLSB do MHT v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit XLSB na MHT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
