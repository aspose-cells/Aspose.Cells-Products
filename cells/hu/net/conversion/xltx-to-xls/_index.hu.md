---
title: C# XLTX - XLS - XLTX - XLS Átalakító
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára a XLTX formátum XLS formátumba konvertálásához, lehetővé téve a XLTX adatok zökkenőmentes mentését XLS formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLTX-et XLS-re a C#-ben" %}}

következő példa bemutatja, hogyan lehet a XLTX számot XLS-re konvertálni a C# számrendszerben.
...
{{% blocks/products/pf/agp/content h2="A XLTX konvertálása XLS-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

XLTX fájlt programozottan XLS-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a XLTX-et XLS-re.
...
1.  Alakítsd át a XLTX számot XLS-re a Workbook.Save metódus meghívásával.
1.  Szerezze meg a XLTX-es konverziós eredményt XLS-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX-ről XLS-re konvertáláshoz" %}}
