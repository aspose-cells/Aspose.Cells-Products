---
title: Połącz XLTX z SXC - Połącz XLTX z SXC w C++
url: /pl/cpp/merger/merge-xltx-to-sxc/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online XLTX do SXC w formacie zapisu. C++ Połącz format XLTX z SXC. Połącz XLTX z SXC w C++. XLTX Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTX z SXC w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLTX z SXC w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLTX z SXC. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku SXC. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy numery XLTX z SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTX z SXC w C++" InputFormat="xltx" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTX z SXC za pośrednictwem C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLTX z SXC programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLTX z SXC" %}}
