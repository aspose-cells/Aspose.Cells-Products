---
title: C++ XLSB à FODS - Convertisseur en ligne XLSB à FODS
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde FODS. Format C++ XLSB à FODS. Enregistrez XLSB à FODS C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à FODS dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en FODS en C++.
...
Besoin de convertir les fichiers XLSB en FODS par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en FODS en seulement quelques lignes de code.
