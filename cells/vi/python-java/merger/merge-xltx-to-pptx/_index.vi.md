...
url: /vi/python-java/merger/merge-xltx-to-pptx/ 
...
Ví dụ sau minh họa cách hợp nhất XLTX thành PPTX trong Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Cần hợp nhất XLTX thành PPTX theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API có thể được thực hiện chỉ với vài dòng mã.
