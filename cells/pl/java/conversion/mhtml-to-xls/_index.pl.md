---
title: Java MHTML do XLS - MHTML do XLS Konwerter
...
{{% blocks/products/pf/agp/content h2="Zapisz MHTML do XLS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować MHTML na XLS w Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki MHTML na XLS? Programiści Java mogą łatwo przekonwertować pliki MHTML na XLS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj numer MHTML na numer XLS, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji MHTML na XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji MHTML na XLS" %}}
{{% blocks/products/pf/agp/text %}}
