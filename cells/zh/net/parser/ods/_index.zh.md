---
title: 从 ODS 文档 via .NET 中提取文本和图像
weight: 6970
description: C# 源代码用于从 .NET 框架、.NET 核心、Mono 或 Xamarin 平台上的 ODS 文件中提取文本和图像。
...
为了解析 ODS 文件，我们将使用[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API 是一款功能丰富、功能强大且易于使用的文档操作 API，适用于 C# 平台。打开[NuGet](https://www.nuget.org/packages/aspose.cells)包管理器，搜索**Aspose.Cells**并安装。您也可以从程序包管理器控制台使用以下命令。
