...
description: Aspose Exceller. C++ Aspose.Cells. Fusionner HTM avec le format de sauvegarde XLT. C++ Combinez HTM au format XLT. Fusionner HTM avec XLT dans C++. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec XLT dans C++" %}}

L'exemple suivant montre comment fusionner HTM avec XLT dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner HTM avec XLT. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-le dans le fichier XLT. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne HTM avec XLT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner HTM avec XLT dans C++" InputFormat="htm" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec XLT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner HTM avec XLT par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
