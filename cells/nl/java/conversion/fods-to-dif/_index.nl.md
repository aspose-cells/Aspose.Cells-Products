...
{{% blocks/products/pf/agp/content h2="Sla FODS op in DIF in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar DIF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar DIF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar DIF? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar DIF met slechts een paar regels code.
