...
url: /cs/python-net/merger/merge-mht-to-sxc/ 
...
Následující příklad ukazuje, jak sloučit MHT s SXC v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit MHT na SXC programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
