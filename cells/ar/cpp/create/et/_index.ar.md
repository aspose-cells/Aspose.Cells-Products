---
title: إنشاء ET - إنشاء ملف ET في C++
description:  Aspose اكسل. C++ أنشئ ملف ET بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف ET باستخدام C++. أنشئ ملف ET في C++. C++ ET Creator.
...
{{< blocks/products/pf/i18n/upper-banner h1="قم بإنشاء ملف ET في C++" h2="إنشاء ملفات ET أصلية وعالية الأداء برمجيًا بدون استخدام Micorsoft Office باستخدام مكتبة C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء ET في C++" %}}

{{% blocks/products/pf/agp/text %}}

 من السهل على المطورين إنشاء ملفات ET وتحميلها وتعديلها وتحويلها ضمن تشغيل تطبيقات التقارير لمعالجة البيانات في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  احفظ المصنف كملف .et باستخدام طريقة Save().

{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف ET في C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لإنشاء ملف ET" %}}
