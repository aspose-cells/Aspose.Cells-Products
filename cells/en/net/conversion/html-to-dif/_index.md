...
{{% blocks/products/pf/agp/content h2="Save HTML to DIF in C# Online for Free" %}}

The following example demonstrates how to convert HTML to DIF document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert HTML file into DIF format. Upload your HTML file, then simply save it as DIF file. For both HTML reading and DIF writing you can use fully qualified filenames. The output DIF content and formatting will be identical to the original HTML document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert HTML to DIF Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert HTML to DIF via C#" %}}
...
{{% blocks/products/pf/agp/content h2="C# library to convert HTML to DIF" %}}
