...
description: Aspose エクセル。 Java Aspose.Cells。PNG を OTS 保存形式にマージします。 Java PNG を OTS 形式に結合します。 PNG を Java の OTS にマージします。 PNG をマージします。
...
{{% blocks/products/pf/agp/content h2="PNG を Java の OTS にマージします" %}}
...
{{% cells-merger title="PNG を Java の OTS にマージするサンプルコード" InputFormat="png" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
