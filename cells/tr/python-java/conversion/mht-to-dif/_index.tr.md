---
title: Python MHT'den DIF'e - MHT'den DIF'e dönüştürücü
description: Aspose Excel'de. Python Excel'de. Aspose.Cells ile MHT'yi hızlı ve kolay bir şekilde DIF'e dönüştürün. Python MHT'yi DIF'e dönüştürün. Python MHT'yi DIF'e kaydedin. Python Excel Kütüphanesini kullanarak MHT'yi DIF olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi Python aracılığıyla DIF\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

MHT dosyalarını programlı olarak DIF'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla MHT'yi kolayca yükleyip DIF'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak MHT'yi DIF'e dönüştürün.
1. MHT'nin dönüşüm sonucunu DIF'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python MHT\'yi DIF\'e Dönüştürmek için Excel Kitaplığı" %}}
