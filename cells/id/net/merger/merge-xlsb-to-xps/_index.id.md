---
title: Gabung XLSB ke XPS - Gabungkan XLSB ke XPS di C#
url: /id/net/merger/merge-xlsb-to-xps/ 
description: Aspose Unggul. C# Aspose.Cells. Free Online Merge XLSB to XPS saveformat. C# Gabungkan format XLSB menjadi XPS. Gabung XLSB ke XPS di C#. XLSB Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabung XLSB ke XPS di C# Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan XLSB ke XPS di Aspose.Cells for .NET.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan XLSB ke XPS di C#" InputFormat="xlsb" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSB ke XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSB menjadi XPS secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan XLSB ke XPS" %}}
