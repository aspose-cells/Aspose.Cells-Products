...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 EXCEL 轉換為 SQL。C++ EXCEL 到 SQL。 C++ 將 EXCEL 儲存到 SQL。使用 C++ 將 EXCEL 儲存為 SQL。
...
{{% blocks/products/pf/agp/content h2="將EXCEL儲存到SQL中C++" %}}

下面的範例示範如何將C++中的EXCEL轉換為SQL。
...
{{% cells-convert title="將 EXCEL 轉換為 SQL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="sql" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 EXCEL 轉換為 SQL" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 EXCEL 檔案轉換為 SQL？ C++ 開發人員只需幾行程式碼即可輕鬆將 EXCEL 轉換為 SQL。
...
{{% blocks/products/pf/agp/content h2="C++ 將 EXCEL 轉換為 SQL 的函式庫" %}}
