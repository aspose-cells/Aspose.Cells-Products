...
description: Aspose Excel. A JPEG-es számot SXC-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# JPEG-SXC-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a JPEG-SXC számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a JPEG-et SXC-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a JPEG SXC-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A JPEG konvertálása SXC-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A JPEG fájlt programozottan SXC-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a JPEG-et SXC-re.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a JPEG konvertálásához SXC-re" %}}
