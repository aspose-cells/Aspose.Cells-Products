---
title: PHP XLT إلى DOCX - XLT إلى DOCX محول
description: Aspose اكسل. قم بتحويل XLT إلى DOCX بسرعة وسهولة باستخدام Aspose.Cells. PHP XLT إلى DOCX. PHP احفظ XLT إلى DOCX. احفظ XLT كـ DOCX باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLT إلى DOCX عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLT إلى DOCX برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLT إلى DOCX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLT إلى DOCX عن طريق استدعاء طريقة حفظ المصنف.
