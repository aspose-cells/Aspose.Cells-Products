---
title:  मर्ज ODS फ़ाइलें via Java
weight: 6270
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए Java रनटाइम एनवायरनमेंट पर ODS दस्तावेज़ों को संयोजित करने के लिए Java नमूना कोड।
---
...
{{% blocks/products/pf/agp/content h2="ODS फ़ाइलों को Java का उपयोग करके कैसे मर्ज करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODS फ़ाइलों को Java में मर्ज करने के चरण" %}}
...
+ कार्यपुस्तिका वर्ग के उदाहरण के साथ पहली ODS फ़ाइल लोड करें।
+ कार्यपुस्तिका वर्ग के उदाहरण के साथ दूसरा ODS दस्तावेज़ लोड करें।
+ कंबाइन () विधि का उपयोग करके फ़ाइलों को मर्ज करें।
मर्ज किए गए ODS फ़ाइल को निर्दिष्ट पथ पर सहेजें
...
{{% blocks/products/pf/agp/code-block title="मर्ज ODS फ़ाइलें - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="ऑनलाइन ODS मर्जर लाइव डेमो" sectionDescription=" हमारी वेबसाइट पर जाकर ODS दस्तावेज़ अभी मर्ज करें[लाइव डेमो वेबसाइट](https://products.aspose.app/cells/merger). लाइव डेमो के निम्नलिखित लाभ हैं" >}}
