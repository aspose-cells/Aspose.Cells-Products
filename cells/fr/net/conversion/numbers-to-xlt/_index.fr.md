...
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les NUMBERS au format XLT, permettant un enregistrement transparent des données NUMBERS au format XLT à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros XLT dans C#" %}}

L'exemple suivant montre comment convertir les NOMBRES de XLT en C#.
...
1.  Convertissez les NUMÉROS en XLT en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en XLT" %}}
