...
description: Aspose Excel. C++ Aspose.Cells. Voeg SXC samen naar OTS-opslagformaat. C++ Combineer SXC naar OTS-formaat. Voeg SXC samen met OTS in C++. SXC Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Hoe u SXC samenvoegt met OTS via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SXC programmatisch samenvoegen met OTS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
