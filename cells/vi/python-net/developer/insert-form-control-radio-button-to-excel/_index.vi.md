---
title:  Chèn RadioButton (Điều khiển biểu mẫu) vào Excel bằng Python via .Net
weight: 60
description: Python via Mã nguồn .Net để chèn RadioButton (Điều khiển biểu mẫu) vào Excel.
---
...
{{% blocks/products/pf/agp/content h2="Cách Chèn RadioButton (Điều khiển biểu mẫu) vào Tệp Excel bằng Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn RadioButton(Form control) vào file Excel bằng Python via .Net" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng add của shapecollection[phương pháp](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) để chèn một RadioButton (Điều khiển biểu mẫu) trong trang tính đã chọn.
