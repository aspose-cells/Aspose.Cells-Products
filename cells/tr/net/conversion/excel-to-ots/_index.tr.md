...
description: Aspose Excel'de. Aspose.Cells ile EXCEL'i hızlı ve kolay bir şekilde OTS'ye dönüştürün. C# EXCEL'i OTS'ye dönüştürün. C# EXCEL'i OTS'ye kaydedin. C#'i kullanarak EXCEL'i OTS olarak kaydedin.
...
Aşağıdaki örnek, C#'de EXCEL'in OTS'ye nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="EXCEL\'i OTS\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ots" IsLandingPage="true" %}}
