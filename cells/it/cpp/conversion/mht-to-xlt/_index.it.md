...
Hai bisogno di convertire i file MHT in XLT tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in XLT in poche righe di codice.
...
1.  Convertire MHT in XLT chiamando il metodo Save().
