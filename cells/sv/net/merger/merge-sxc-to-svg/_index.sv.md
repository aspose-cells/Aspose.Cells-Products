---
title: Slå samman SXC till SVG - Kombinera SXC till SVG i C#
url: /sv/net/merger/merge-sxc-to-svg/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge SXC till SVG sparaformat. C# Kombinera SXC till SVG format. Slå samman SXC till SVG i C#. SXC Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman SXC till SVG i C# Online gratis" %}}

Följande exempel visar hur man slår samman SXC till SVG i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman SXC till SVG. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen SVG. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman SXC till SVG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman SXC till SVG i C#" InputFormat="sxc" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman SXC till SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman SXC till SVG programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman SXC till SVG" %}}
