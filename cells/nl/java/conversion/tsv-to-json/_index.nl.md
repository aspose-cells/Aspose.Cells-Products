---
title: Converteer TSV naar JSON via Java 
weight: 1910

description: Voorbeeld Java conversiecode voor TSV-indeling naar JSON-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar JSON te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer TSV naar JSON via Java" h2="TSV naar JSON Java-conversie om enkele of meerdere pagina\'s naar JSON te converteren met behulp van een lokale bibliotheek Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe TSV naar JSON te converteren met Java" %}}

 Om TSV naar JSON te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TSV naar JSON te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen TSV-bestanden gemakkelijk converteren naar JSON in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="TSV naar JSON Java Conversiebroncode" offSpacer="" %}}
