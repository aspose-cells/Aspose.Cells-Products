---
title:  Ubah bagan menjadi BMP gambar via .NET
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi Bagan ke File BMP di C#" %}}
...
+ Buat berkas XLSX.
Dapatkan grafiknya.
+ Konversi grafik menjadi gambar BMP.
...
{{% blocks/products/pf/agp/code-block title="Ubah Bagan File XLSX menjadi gambar BMP - C#" offSpacer="" %}}
