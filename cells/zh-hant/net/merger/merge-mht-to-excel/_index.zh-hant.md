...
下面的範例示範如何將Aspose.Cells for .NET中的MHT合併到EXCEL。
...
{{% cells-merger title="C# 中將 MHT 合併到 EXCEL 的範例程式碼" InputFormat="mht" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過C#將MHT合併到EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 MHT 合併到 EXCEL 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
