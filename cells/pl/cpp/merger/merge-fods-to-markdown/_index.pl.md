---
title: Połącz FODS z MARKDOWN - Połącz FODS z MARKDOWN w C++
url: /pl/cpp/merger/merge-fods-to-markdown/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online FODS do MARKDOWN w formacie zapisu. C++ Połącz format FODS z MARKDOWN. Połącz FODS z MARKDOWN w C++. FODS Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz FODS z MARKDOWN w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć FODS z MARKDOWN w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć FODS z MARKDOWN. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku MARKDOWN. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy numery FODS z MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online FODS z MARKDOWN w C++" InputFormat="fods" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć FODS z MARKDOWN za pośrednictwem C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić FODS z MARKDOWN programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
