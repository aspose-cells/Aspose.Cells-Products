...
Hai bisogno di convertire i file CSV in ET tramite codice? Gli sviluppatori C++ possono facilmente convertire CSV in ET in poche righe di codice.
...
1.  Converti CSV in ET chiamando il metodo Save().
