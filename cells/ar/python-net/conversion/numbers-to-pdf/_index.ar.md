...
description: Aspose اكسل. قم بتحويل NUMBERS إلى PDF بسرعة وسهولة باستخدام Aspose.Cells. Python NUMBERS إلى PDF. Python احفظ NUMBERS في PDF. احفظ NUMBERS كـ PDF باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="تحويل الأرقام إلى PDF في Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام إلى PDF في Python" %}}

يوضح المثال التالي كيفية تحويل الأرقام إلى PDF في Python via NET.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل الارقام الى PDF" %}}
