...
Нужно программно конвертировать XML-файлы в SPREADSHEETML? C++ разработчики могут легко преобразовать XML в SPREADSHEETML, написав всего несколько строк кода.
