...
url: /sv/cpp/merger/merge-json-to-xlam/ 
...
Följande exempel visar hur man slår samman JSON till XLAM i Aspose.Cells for C++.
...
{{% cells-merger title="Exempelkod för att slå samman JSON till XLAM i C++" InputFormat="json" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman JSON till XLAM via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman JSON till XLAM programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotek för att slå samman JSON till XLAM" %}}
