...
Hai bisogno di convertire i file PRN in BMP tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in BMP in poche righe di codice.
...
1.  Convertire PRN in BMP chiamando il metodo Save().
