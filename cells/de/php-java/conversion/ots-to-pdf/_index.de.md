...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in PDF mit Aspose.Cells. PHP OTS in PDF. PHP Speichern Sie OTS in PDF. Speichern Sie OTS mit PHP als PDF.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in PDF" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in PDF konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in PDF konvertieren.
...
1.  Konvertieren Sie OTS in PDF, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in PDF" %}}
