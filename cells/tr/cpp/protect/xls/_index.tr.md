---
title:  XLS belgesini C++ aracılığıyla koruyun ve kilitleyin
weight: 8760
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Runtime Environment üzerinde parola kullanarak XLS dosyasını kilitlemek için örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS Dosyalarını C++ aracılığıyla şifrele" h2=".NET Kitaplığı kullanılarak XLS formatı dahil olmak üzere Excel elektronik tablolarını parolayla koruyun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="XLS Dosyasını C++ Kullanarak Nasıl Güvenli Hale Getirirsiniz?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLS Dosyalarını C++ Yoluyla Koruma Adımları" %}}
...
1.  IWorkbook sınıfını kullanarak XLS dosyasını yükleyin
