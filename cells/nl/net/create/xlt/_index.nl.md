...
{{% blocks/products/pf/agp/content h2="Hoe XLT te maken in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Het is gemakkelijk voor de ontwikkelaars om XLT-bestanden te maken, laden, wijzigen en converteren binnen verschillende rapportagetoepassingen voor gegevensverwerking in slechts een paar regels code.
...
1. Gebruik de methode Save om de werkmap op te slaan als XLT-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een XLT-bestand maakt in C#." offSpacer="" %}}
