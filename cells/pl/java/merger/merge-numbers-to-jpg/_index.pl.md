---
title: Połącz NUMERY do JPG - Połącz NUMERY do JPG w Java
url: /pl/java/merger/merge-numbers-to-jpg/ 
description: Aspose Excel. Java Aspose.Cells. Scal NUMERY do formatu zapisu JPG. Java Połącz NUMERY do formatu JPG. Scal NUMBERS do JPG w Java. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z JPG w Java" %}}

Poniższy przykład pokazuje, jak połączyć NUMBERS z JPG w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć NUMERY z JPG. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku JPG. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMBERS z JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia NUMERÓW z JPG w Java" InputFormat="numbers" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć NUMERY z JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć NUMERY z JPG? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do łączenia NUMERÓW z JPG" %}}
