---
title: EXCEL を WORD に結合 - EXCEL を WORD に結合 (Java)
url: /ja/java/merger/merge-excel-to-word/ 
description: Aspose エクセル。 Java Aspose.Cells. 無料オンラインでEXCELをWORD保存形式に結合します。 Java EXCELをWORD形式に結合します。 Java で EXCEL を WORD にマージします。EXCEL マージ。
...
{{% blocks/products/pf/agp/content h2="Java を使用して EXCEL を WORD に結合する" %}}
...
{{% blocks/products/pf/agp/content h2="Java オンラインで無料で EXCEL を WORD に結合" %}}

次の例は、Aspose.Cells for Java で EXCEL を WORD に結合する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、EXCEL を WORD にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルを結合し、WORD ファイルに保存します。 Java でコードを開発する場合、これは思っているより簡単です。 EXCEL を WORD にマージする Java の例を参照してください。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java で EXCEL を WORD にオンラインで無料でマージできます" InputFormat="xlsx" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Excel を WORD に結合する方法 via Java" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL をプログラムで WORD にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Java](https://products.aspose.com/cells/java)API はわずか数行のコードで実行できます。
