---
title: PHP CSV 至 TSV - CSV 至 TSV 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 CSV 转换为 TSV。PHP CSV 转换为 TSV。PHP 将 CSV 保存为 TSV。使用 PHP 将 CSV 保存为 TSV。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 PHP 中将 CSV 转换为 TSV" h2="用于将 CSV 转换为 TSV 的高速 PHP 库。这是使用 PHP 导入和导出 CSV、TSV 和许多其他格式的专业软件解决方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="将 CSV 转换为 TSV 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="tsv" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 PHP 将 CSV 转换为 TSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 CSV 文件转换为 TSV 吗？ PHP 开发人员只需几行代码即可轻松加载 CSV 并将其转换为 TSV。
...
1. 使用工作簿实例加载 CSV 文件。
1. 通过调用Workbook的save方法将CSV转换为TSV。
1. 获取CSV到TSV的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP库将CSV转换为TSV" %}}
