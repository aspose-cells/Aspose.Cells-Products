...
url: /de/python-net/merger/merge-excel-to-sql/ 
...
Das folgende Beispiel zeigt, wie EXCEL in Aspose.Cells for Python via .NET mit SQL zusammengeführt wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie EXCEL programmgesteuert in SQL zusammenführen? Ein grundlegendes Dokument, das zusammengeführt und verknüpft wird mit[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs können mit nur wenigen Codezeilen erstellt werden.
