...
description: Aspose Excel. A JSON számot gyorsan és egyszerűen ETT-re alakíthatja át a Aspose.Cells-es számmal. C++ JSON ETT-vé. C++ Mentse a JSON számot az ETT-nek. Mentse el a JSON számot ETT-ként a C++ használatával.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja a JSON-et ETT-re a C++-ben" h2="Nagy teljesítményű JSON konvertálás ETT-vé a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítés nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ETT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertálja a JSON-et ETT-re a C++ használatával" %}}
...
{{% blocks/products/pf/agp/content h2="Mentse el a JSON számot az ETT számára a C++ számon" %}}

A következő példa bemutatja, hogyan lehet C++-ben a JSON-et ETT-vé alakítani.
...
1.  Konvertálja a JSON-et ETT-vé a Save() metódus meghívásával.
1.  Szerezze meg a JSON konverziós eredményt ETT-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ könyvtár a JSON ETT-re konvertálásához" %}}
