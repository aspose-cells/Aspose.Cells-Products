...
Hai bisogno di convertire i file MHT in XLSM tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in XLSM in poche righe di codice.
...
1.  Convertire MHT in XLSM chiamando il metodo Save().
