...
{{% cells-convert title="Código de muestra para convertir XLT a SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a SQL a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLT a SQL mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente XLT a SQL en solo unas pocas líneas de código.
