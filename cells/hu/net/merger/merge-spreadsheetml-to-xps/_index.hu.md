...
url: /hu/net/merger/merge-spreadsheetml-to-xps/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a SPREADSHEETML-t a XPS-gyel a Aspose.Cells-es for .NET-ben.
...
{{% cells-merger title="Mintakód a SPREADSHEETML egyesítéséhez a XPS-es számmal a C#-ben" InputFormat="xml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A SPREADSHEETML egyesítése a XPS-es számmal a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SPREADSHEETML-t a XPS-es számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a SPREADSHEETML és a XPS egyesítéséhez" %}}
