...
هل تحتاج إلى تحويل ملفات MHT إلى JSON برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى JSON في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى JSON باستدعاء طريقة Save ().
