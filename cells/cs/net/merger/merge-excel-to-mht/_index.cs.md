---
title:  Sloučit EXCEL do MHT přes C#
url: /cs/net/merger/merge-excel-to-mht/ 
description: Sloučit EXCEL do MHT Online zdarma. Bezplatné online spojení EXCEL do MHT. Sloučit EXCEL do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit EXCEL s MHT v C#.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení EXCEL do MHT online" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
