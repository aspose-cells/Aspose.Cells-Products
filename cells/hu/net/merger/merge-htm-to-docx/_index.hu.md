...
url: /hu/net/merger/merge-htm-to-docx/ 
...
A következő példa bemutatja, hogyan egyesítheti a HTM-et a DOCX-es számmal a Aspose.Cells for .NET-ben.
...
Programozottan egyesítenie kell a HTM-et a DOCX-es számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTM és a DOCX egyesítéséhez" %}}
