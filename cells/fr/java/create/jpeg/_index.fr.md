...
description: Aspose Excel. Java Créer un fichier JPEG. Créer JPEG Java. Java JPEG Créateur. Créez JPEG dans Java. Générez le fichier JPEG en utilisant Java.
...
1.  Enregistrez le classeur au format JPEG à l'aide de la méthode save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier JPEG dans Java." offSpacer="" %}}
