...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 JPEG 轉換為 EMF。Java JPEG 為 EMF. Java 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Java。
...
以下範例示範如何將 Java 中的 JPEG 轉換為 EMF。
...
{{% cells-convert title="將 JPEG 轉換為 EMF 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="emf" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何轉換 JPEG 為 EMF via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 JPEG 檔案轉換為 EMF 嗎？ Java開發人員只需幾行程式碼即可輕鬆將JPEG轉換為EMF。
