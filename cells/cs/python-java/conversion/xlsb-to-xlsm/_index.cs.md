---
title: Python XLSB až XLSM - Online konvertor XLSB až XLSM
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Online zdarma Python Převést XLSB na XLSM uložit formát. Python XLSB až XLSM formát. Uložte si XLSB až XLSM Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte XLSB na XLSM pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLSB až XLSM v Python online zdarma" %}}

Následující příklad ukazuje, jak převést XLSB na XLSM v Python.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod XLSB na XLSM online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlsm" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLSB na XLSM" %}}
