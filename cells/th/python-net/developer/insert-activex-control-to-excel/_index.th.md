...
weight: 10
description: Python via .Net ซอร์สโค้ดเพื่อแทรก ActiveX Control ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก ActiveX Control ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ Shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_active_x_control/#aspose.cells.drawing.activexcontrols.ControlType-int-int-int-int-int-int) เพื่อแทรกตัวควบคุม ActiveX ในแผ่นงานที่เลือก
