...
url: /cs/python-java/merger/merge-xlsb-to-jpg/ 
...
Následující příklad ukazuje, jak sloučit XLSB do JPG v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLSB do JPG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
