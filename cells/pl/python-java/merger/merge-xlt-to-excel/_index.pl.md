...
description: Aspose Excel. Python Aspose.Cells. Scal XLT do formatu zapisu EXCEL. Python Połącz XLT z formatem EXCEL. Scal XLT z EXCEL w Python. XLT Scal.
...
{{% cells-merger title="Przykładowy kod do połączenia XLT z EXCEL w Python" InputFormat="xlt" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLT z EXCELem przez Python" %}}
