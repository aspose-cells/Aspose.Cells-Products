---
title: C++ HTM إلى JSON - محول HTM عبر الإنترنت إلى JSON
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل HTM إلى JSON saveformat. C++ HTM إلى تنسيق JSON. احفظ HTM في JSON C++.
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في JSON في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات HTM إلى JSON برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى JSON في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى JSON باستدعاء طريقة Save ().
