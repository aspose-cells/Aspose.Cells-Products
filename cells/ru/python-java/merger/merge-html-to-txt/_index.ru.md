...
description: Aspose Эксель. Python Aspose.Cells. Объедините HTML и TXT в формате сохранения. Python Объедините форматы HTML и TXT. Объедините HTML и TXT в Python. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML с TXT, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и TXT в Python." %}}

В следующем примере показано, как объединить HTML и TXT в Aspose.Cells for Python via Java.
