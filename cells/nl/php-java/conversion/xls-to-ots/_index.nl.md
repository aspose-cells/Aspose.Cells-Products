---
title: PHP XLS naar OTS - XLS naar OTS-converter
description: Aspose Excel. Converteer XLS snel en eenvoudig naar OTS met Aspose.Cells. PHP XLS naar OTS. PHP Sla XLS op in OTS. Sla XLS op als OTS met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe XLS naar OTS te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLS-bestanden programmatisch naar OTS converteren? PHP-ontwikkelaars kunnen XLS eenvoudig in slechts een paar regels code laden en converteren naar OTS.
...
1.  Converteer XLS naar OTS door de opslagmethode van Workbook aan te roepen.
