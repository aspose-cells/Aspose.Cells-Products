---
title: Python XLSX a XLS - En línea XLSX a XLS Convertidor
description: AsposeExcel. Python Aspose.Cells. Python Aspose Cells. Gratis en línea Python Convertir XLSX a XLS guardar formato. Formato Python XLSX al XLS. Aparta del XLSX al XLS Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XLSX a XLS en Python en línea gratis" %}}

El siguiente ejemplo muestra cómo convertir XLSX a XLS en Python via NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir XLSX a XLS. Cargue su archivo XLSX, luego simplemente guárdelo como archivo XLS. Tanto para la lectura XLSX como para la escritura XLS, puede utilizar nombres de archivo completos. El contenido y el formato de la salida XLS serán idénticos al documento original XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicación gratuita y código de muestra para convertir XLSX a XLS en línea" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xls" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python biblioteca para convertir XLSX a XLS" %}}
