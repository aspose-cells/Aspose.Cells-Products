---
title:  Cerca il documento TXT senza aprire via .NET
weight: 8410
description: Codice sorgente C# per cercare parole con pattern nel file TXT su .NET Framework, .NET Core, Mono o piattaforme Xamarin.
