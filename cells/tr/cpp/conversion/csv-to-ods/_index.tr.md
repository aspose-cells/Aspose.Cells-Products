---
title: C++ uygulaması aracılığıyla CSV'yi ODS'ye dönüştürün 
weight: 340
url: /tr/cpp/conversion/csv-to-ods/ 
description: CSV belgesi için ODS biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu CSV'den ODS'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ aracılığıyla CSV\'yi ODS\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı CSV\'den ODS\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak CSV\'yi ODS\'ye Dönüştürme" %}}

 CSV'yi ODS'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C++ aracılığıyla CSV\'yi ODS\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 C++ geliştiricileri, yalnızca birkaç satır kodla CSV dosyasını ODS'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook'u kullanarak CSV dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (ODS) dosya uzantısıyla iletin.1. ODS dosyası belirtilen yola kaydedilecektir.1. ODS dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="CSV\'den ODS\'ye C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV\'den ODS\'ye Dönüşüm Canlı Demoları" sectionDescription="[CSV\'yi ODS\'ye Dönüştür](https://products.aspose.app/cells/conversion/csv-to-ods) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece CSV dosyanızı yükleyin, anında ODS\'ye dönüştürülecektir." >}}
