...
description: Aspose Excel. Convierta FODS a XLS rápida y fácilmente con Aspose.Cells. Python FODS a XLS. Python Guarde FODS en XLS. Guarde FODS como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar FODS al XLS en Python" %}}

El siguiente ejemplo demuestra cómo convertir FODS a XLS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir FODS en XLS" %}}
