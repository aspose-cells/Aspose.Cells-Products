---
title: PHP XLAM'den HTM'ye - XLAM'den HTM'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile XLAM'i hızlı ve kolay bir şekilde HTM'ye dönüştürün. PHP XLAM'i HTM'ye dönüştürün. PHP XLAM'i HTM'ye kaydedin. PHP kullanarak XLAM'i HTM olarak kaydedin.
...
{{% cells-convert title="XLAM\'i HTM\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="htm" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLAM\'i HTM\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLAM dosyalarını programlı olarak HTM'ye dönüştürmeniz mi gerekiyor? PHP geliştiricileri yalnızca birkaç satır kodla XLAM'i kolayca yükleyebilir ve HTM'ye dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLAM'i HTM'ye dönüştürün.
1.  XLAM'in HTM'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLAM\'i HTM\'ye dönüştürmek için PHP kütüphanesi" %}}
