...
description: Aspose Exceller. Convertissez HTM en JPG rapidement et facilement avec Aspose.Cells. C++ HTM en JPG. C++ Enregistrez HTM au format JPG. Enregistrez HTM au format JPG en utilisant C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au format JPG en C++" %}}

L'exemple suivant montre comment convertir HTM en JPG en C++.
...
{{% cells-convert title="Exemple de code pour convertir HTM en JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en JPG via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en JPG par programme ? Les développeurs C++ peuvent facilement convertir HTM en JPG en quelques lignes de code seulement.
...
1.  Convertissez HTM en JPG en appelant la méthode Save().
