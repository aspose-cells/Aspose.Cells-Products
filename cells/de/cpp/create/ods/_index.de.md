...
description: ODS Ersteller. Erstellen Sie ODS-Dateien im C++-Code. Generieren Sie ODS-Dateien (Openoffice/Lbreoffice) mit der Anwendung C++.
---
...
{{% blocks/products/pf/agp/code-block title="Der folgende Quellcode zeigt, wie man mit C++ eine ODS-Datei (Openoffice / Lbreoffice) erstellt." offSpacer="" %}}
