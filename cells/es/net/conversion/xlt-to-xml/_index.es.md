---
title: C# XLT a XML - Convertidor de XLT a XML
description: Aspose Excel. Convierta XLT a XML rápida y fácilmente con Aspose.Cells. C# XLT a XML. C# Guarde XLT en XML. Guarde XLT como XML usando C#.
...
{{% blocks/products/pf/agp/content h2="Guarde XLT en XML en C#" %}}

El siguiente ejemplo demuestra cómo convertir XLT a XML en C#.
...
{{% cells-convert title="Código de muestra para convertir XLT a XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a XML a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLT a XML mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente XLT a XML en tan solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para convertir XLT a XML" %}}
