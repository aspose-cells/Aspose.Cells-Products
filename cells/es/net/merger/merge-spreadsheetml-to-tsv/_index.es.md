---
title: Combine SPREADSHEETML con TSV - Combine SPREADSHEETML con TSV en C#
url: /es/net/merger/merge-spreadsheetml-to-tsv/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea SPREADSHEETML a TSV guardar formato. C# Combine SPREADSHEETML al formato TSV. Combinar HOJA DE CALCULO a TSV en C#. Combinar HOJA DE CALCULO.
...
{{% blocks/products/pf/agp/content h2="Combine SPREADSHEETML a TSV en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo fusionar SPREADSHEETML a TSV en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar SPREADSHEETML con TSV. Cargue sus archivos, llame al método Workbook.Combine para combinar archivos y luego guárdelo en el archivo TSV. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que fusiona SPREADSHEETML con TSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar SPREADSHEETML a TSV en C#" InputFormat="xml" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar SPREADSHEETML a TSV a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar SPREADSHEETML con TSV mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar SPREADSHEETML a TSV" %}}
