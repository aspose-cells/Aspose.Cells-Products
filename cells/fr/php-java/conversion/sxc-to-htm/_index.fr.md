---
title: PHP SXC en HTM - Convertisseur SXC en HTM
description: Aspose Exceller. Convertissez SXC en HTM rapidement et facilement avec Aspose.Cells. PHP SXC en HTM. PHP Enregistrez SXC sur HTM. Enregistrez SXC en tant que HTM en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Enregistrer SXC en HTM en PHP" %}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir SXC en HTM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers SXC en HTM par programme ? Les développeurs PHP peuvent facilement charger et convertir SXC en HTM en quelques lignes de code.
...
1.  Convertissez SXC en HTM en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion de SXC en HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir SXC en HTM" %}}
