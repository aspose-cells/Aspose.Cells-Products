...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση HTM σε μορφή αποθήκευσης ET. Python Συνδυάστε τη μορφή HTM σε ET. Συγχώνευση HTM σε ET στο Python. Συγχώνευση HTM.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση HTM με ET στο Python" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση HTM με ET στο Python" InputFormat="htm" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
