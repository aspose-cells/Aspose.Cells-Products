---
title: Konversi XLSB ke MHTML melalui C++ aplikasi 
weight: 1250

description: Contoh C++ kode konversi untuk dokumen XLSB ke format MHTML. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLSB ke MHTML dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi XLSB ke MHTML melalui C++" h2="Konversi XLSB ke MHTML berperforma tinggi menggunakan pustaka C++ tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLSB ke MHTML Menggunakan C++" %}}

 Untuk mengonversi XLSB ke MHTML, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi XLSB ke MHTML melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ pengembang dapat dengan mudah mengonversi file XLSB ke MHTML hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLSB menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (MHTML).1. File MHTML akan disimpan di jalur yang ditentukan.1. Buka file MHTML di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLSB ke MHTML C++ Kode Sumber Konversi" offSpacer="" %}}
