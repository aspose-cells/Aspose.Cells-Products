---
title: TSV'i PRN ile birleştir - TSV'i Java'deki PRN ile birleştir
url: /tr/java/merger/merge-tsv-to-prn/ 
description: Aspose Excel'de. Java Aspose.Cells. TSV'i PRN kaydetme biçimiyle birleştirin. Java TSV'i PRN formatıyla birleştirin. TSV'i Java'deki PRN ile birleştirin. TSV Birleştir.
...
{{% blocks/products/pf/agp/content h2="TSV\'i Java\'deki PRN ile birleştir" %}}

Aşağıdaki örnek, TSV'in Aspose.Cells for Java'deki PRN ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TSV'i PRN ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından PRN dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TSV'i PRN ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TSV\'i Java\'deki PRN ile Birleştirmek için Örnek Kod" InputFormat="tsv" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TSV\'i PRN via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TSV'i PRN ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, TSV\'i PRN ile birleştirecek" %}}
