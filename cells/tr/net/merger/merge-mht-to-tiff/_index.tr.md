---
title: MHT'yi TIFF ile birleştir - MHT'yi C#'de TIFF ile birleştir
url: /tr/net/merger/merge-mht-to-tiff/ 
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi MHT'yi TIFF kaydetme biçimine birleştirme. C# MHT'yi TIFF biçiminde birleştirin. MHT'yi C#'de TIFF olarak birleştirin. MHT Birleştirin.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi TIFF\'de C# Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin TIFF ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

MHT'yi TIFF'de birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından TIFF dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. MHT'yi TIFF ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="MHT\'yi C#\'de TIFF ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="mht" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="MHT\'yi C# aracılığıyla TIFF ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

MHT'yi programlı olarak TIFF ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi TIFF ile birleştirmek için .NET kitaplığı" %}}
