...
url: /tr/python-java/merger/merge-html-to-jpg/ 
...
Aşağıdaki örnek, HTML'in Aspose.Cells for Python via Java'deki JPG ile nasıl birleştirileceğini gösterir.
...
HTML'i JPG ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
