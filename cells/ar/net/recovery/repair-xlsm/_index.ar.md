---
title: C# Repair xlsm - استعادة وإصلاح ملف xlsm التالف
url: /ar/net/recovery/repair-xlsm/ 
description: C# Aspose.Cells. اصلاح xlsm. إصلاح ملف xlsm. أداة استرداد XLSM. الفساد XLSM. استعادة بيانات XLSM. استعادة ملف xlsm. استعادة ملف xlsm التالف.
...
{{< blocks/products/pf/i18n/upper-banner h1="إصلاح ملف XLSM في C#" h2="أنشئ تطبيق .NET الخاص بك لإصلاح ملفات xlsm باستخدام .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
هل تحتاج إلى إصلاح ملف xlsm برمجياً؟ يمكن للمطورين .NET تحميل وإصلاح ملف xlsm بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% cells-recovery title="نموذج التعليمات البرمجية لإصلاح ملف XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsm" outformat="xlsm" IsLandingPage="true" language="net" %}}    
