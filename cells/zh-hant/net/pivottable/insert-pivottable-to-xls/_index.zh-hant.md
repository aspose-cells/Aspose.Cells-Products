---
title: 通過 C# 在 Microsoft Excel XLS 文件中插入數據透視表
weight: 7690
description: C# 使用數據透視表生成 XLS 文檔的示例代碼。使用此代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中使用數據透視表創建 Microsoft Excel XLS 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 在 XLS 文檔中插入數據透視表" h2="本機高性能 Microsoft Excel XLS 電子表格，使用服務器端 .NET API 以編程方式創建數據透視表。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
在運行的應用程序中動態生成帶有數據透視表的 MS Excel XLS 文件非常簡單。為了使用數據透視表從頭開始創建 XLS 文檔而不需要 MS Office，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="如何通過 C# 在 XLS 中插入數據透視表" %}}

{{% blocks/products/pf/agp/text %}}

開發人員只需幾行代碼即可輕鬆在運行不同的報告應用程序中插入 XLS 格式電子表格的數據透視表以進行數據處理。
...
{{% blocks/products/pf/agp/code-block title="在 XLS - C# 中插入數據透視表" offSpacer="" %}}
...
Excel 電子表格編程庫，能夠構建跨平台應用程序，能夠生成、修改、轉換、渲染和打印 Excel XLS 文件。 .NET Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF、HTML、ODS 等，從而使其成為以行業標準格式交換文檔的完美選擇。
