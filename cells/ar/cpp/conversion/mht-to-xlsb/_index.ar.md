...
هل تحتاج إلى تحويل ملفات MHT إلى XLSB برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى XLSB في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLSB باستدعاء طريقة Save ().
