...
Programozottan kell XML fájlokat PDF formátumúra konvertálni? A C++ fejlesztők könnyedén konvertálhatják az XML fájlokat PDF formátumúra mindössze néhány sornyi kóddal.
...
1.  XML konvertálása PDF formátumra a Save() metódus meghívásával.
