---
title: 创建XLTX - 在C#中创建XLTX文件
description: Aspose Excel。 C# 使用 Aspose.Cells 快速轻松地创建 XLTX 文件。使用 C# 生成 XLTX 文件。在 C# 中创建 XLTX。C# XLTX 创建者。
...
{{< blocks/products/pf/i18n/upper-banner h1="在C#中创建XLTX文件" h2="用于创建XLTX的高速C#库。这是一个专业的软件解决方案，可在.NET Framework、.NET Core或Mono平台上导入和导出XLSX、PDF和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何在C#中创建XLTX" %}}
...
{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 C# 中创建 XLTX 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#库创建XLTX文件" %}}
