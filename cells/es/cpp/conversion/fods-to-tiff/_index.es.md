...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente FODS a TIFF en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo FODS usando Factory::CreateIWorkbook.
1. Convierta FODS a TIFF llamando al método Save().
