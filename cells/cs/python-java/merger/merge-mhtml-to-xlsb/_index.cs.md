---
title:  Sloučit MHTML na XLSB přes Python
url: /cs/python-java/merger/merge-mhtml-to-xlsb/ 
description: Sloučit MHTML až XLSB online zdarma. Online zdarma MHTML až XLSB Fúze. Sloučit MHTML do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit MHTML až XLSB v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHTML až XLSB online" InputFormat="mhtml" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
