---
title: C++ ODS až FODS - Online konvertor ODS až FODS
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Online zdarma C++ Převést ODS na FODS uložit formát. C++ ODS až FODS formát. Uložte si ODS až FODS C++.
...
{{% blocks/products/pf/agp/content h2="Ušetřete ODS až FODS v C++ online zdarma" %}}

Následující příklad ukazuje, jak převést ODS na FODS v C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na FODS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory ODS na FODS programově? Vývojáři C++ mohou snadno převést ODS na FODS v několika řádcích kódu.
...
1.  Převeďte ODS na FODS voláním metody Save().
1.  Získejte výsledek převodu ODS na FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod ODS na FODS" %}}
