---
title: ادمج XLTX مع MHT - اجمع XLTX إلى MHT في C++
url: /ar/cpp/merger/merge-xltx-to-mht/ 
description: Aspose إكسل. C++ Aspose.Cells. الدمج المجاني عبر الإنترنت XLTX إلى تنسيق حفظ MHT. C++ اجمع XLTX إلى تنسيق MHT. دمج XLTX إلى MHT في C++. XLTX دمج.
...
{{% blocks/products/pf/agp/content h2="ادمج XLTX مع MHT في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج XLTX مع MHT في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج XLTX في MHT. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف MHT. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج XLTX إلى MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج XLTX مع MHT في C++" InputFormat="xltx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLTX مع MHT عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج XLTX مع MHT برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="C++ مكتبة لدمج XLTX مع MHT" %}}
