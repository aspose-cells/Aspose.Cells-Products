---
title: Convertisseur Python FODS vers MD - FODS vers MD
description: Aspose Excel. Cette solution complète offre aux développeurs Python une approche entièrement intégrée pour convertir FODS au format MD, permettant un enregistrement transparent des données FODS au format MD à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Python efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir FODS en MD dans la bibliothèque Excel Python" h2="Bibliothèque Excel haute vitesse Python pour la conversion de FODS en MD. Solution logicielle professionnelle pour importer et exporter les formats FODS, MD et bien d\'autres à partir du format Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir FODS en MD à l\'aide de la bibliothèque Excel Python" %}}

 Comment convertir FODS en MD ? Grâce à la bibliothèque Aspose.Cells for Python, vous pouvez facilement convertir FODS en MD par programmation en quelques lignes de code.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer FODS dans MD dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment convertir FODS en MD dans la bibliothèque Excel Python.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir le fichier FODS au format MD. Téléchargez votre fichier FODS, puis enregistrez-le au format MD. Pour la lecture du fichier FODS et l'écriture au format MD, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme du fichier MD de sortie seront identiques à ceux du document FODS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir FODS en MD via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="md" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir FODS en MD via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers FODS en MD par programmation ? Les développeurs Python peuvent facilement charger et convertir des fichiers FODS en MD en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Excel Python pour convertir FODS en MD" %}}
