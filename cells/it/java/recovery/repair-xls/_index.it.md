---
title: Ripara il file xls via Java
url: /it/java/recovery/repair-xls/ 
description: Ripara un file xls corrotto usando Java. Strumento di recupero per riparare il file xls corrotto all'interno dell'applicazione Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Recupera file XLS via Java" h2="Crea la tua applicazione Java per riparare i file xls usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Come riparare file xls usando Java" %}}
...
{{% cells-recovery title="App gratuita per riparare il file XLS utilizzando Java" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="java" %}}    
