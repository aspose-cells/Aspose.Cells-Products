---
title: تحويل الأرقام إلى TIFF عبر C#
url: /ar/net/conversion/numbers-to-tiff/
description: نموذج رمز للأرقام لمزج التحويل C#. استخدم API مثال الكود لملفات أرقام الدُفعات لإجراء تحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الأرقام إلى TIFF باستخدام C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل الأرقام إلى TIFF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج .NET تحميل وتحويل NUMBERS من الملفات بسهولة إلى TIFF في بضعة أسطر من التعليمات البرمجية.
...
{{% cells-convert title="تطبيق مجاني ونموذج كود لتحويل الأرقام إلى TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tiff" IsLandingPage="true" %}}
