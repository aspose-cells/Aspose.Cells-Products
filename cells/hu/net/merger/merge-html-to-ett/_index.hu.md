---
title: A HTML egyesítése az ETT-vel – a HTML-es szám egyesítése az ETT-vel a C#-ben
url: /hu/net/merger/merge-html-to-ett/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés HTML ETT mentési formátumba. C# A HTML kombinálása ETT formátumba. A HTML egyesítése az ETT-vel a C#-es számon. HTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a HTML-es számot az ETT-hez a C#-es online ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a HTML-es számot az ETT-vel a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTML és az ETT egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el ETT fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a HTML-et az ETT-vel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a HTML egyesítéséhez az ETT-hez a C#-ben" InputFormat="html" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A HTML egyesítése az ETT-vel a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a HTML-et az ETT-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML ETT-vel való egyesítéséhez" %}}
