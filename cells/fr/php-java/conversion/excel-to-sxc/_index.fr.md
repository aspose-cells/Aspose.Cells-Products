---
title: PHP EXCEL en SXC - Convertisseur EXCEL en SXC
description: Aspose Exceller. Convertissez EXCEL en SXC rapidement et facilement avec Aspose.Cells. PHP EXCEL en SXC. PHP Enregistrez EXCEL en SXC. Enregistrez EXCEL sous SXC en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en SXC via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en SXC par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en SXC en quelques lignes de code.
...
1.  Convertissez EXCEL en SXC en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en SXC" %}}
