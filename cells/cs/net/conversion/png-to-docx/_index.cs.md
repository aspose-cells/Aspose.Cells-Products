---
title: C# PNG až DOCX - PNG až DOCX Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu formátu PNG do formátu DOCX, což umožňuje bezproblémové ukládání dat PNG do formátu DOCX pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PNG na DOCX v C#" h2="Vysokorychlostní knihovna C# pro převod PNG na DOCX. Toto je profesionální softwarové řešení pro import a export PNG, DOCX a mnoha dalších formátů na platformách .NET Framework, .NET Core nebo Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte PNG na DOCX v C#" %}}

Následující příklad ukazuje, jak převést číslo PNG na DOCX v kódu C#.
...
1.  Převeďte číslo PNG na DOCX voláním metody Workbook.Save.
