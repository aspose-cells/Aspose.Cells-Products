...
Нужно программно конвертировать файлы FODS в XLT? Разработчики C++ могут легко преобразовать FODS в XLT всего за несколько строк кода.
