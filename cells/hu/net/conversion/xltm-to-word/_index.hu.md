---
title: C# XLTM a WORD-hoz – Online XLTM a WORD konverterhez
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Ingyenes online C# A XLTM konvertálása WORD mentési formátumba. C# XLTM WORD formátumba. Mentse el a XLTM számot a C# WORD-ba.
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLTM-et a WORD-ba a C#-ben online ingyen" %}}

A következő példa bemutatja, hogyan lehet a XLTM-et WORD-ra konvertálni a C#-ben.
...
{{% blocks/products/pf/agp/content h2="A XLTM konvertálása WORD-ra a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLTM fájlt programozottan WORD-ba kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és konvertálhatják a XLTM-et WORD-ra, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a XLTM-et WORD-ba a Workbook.Save metódus meghívásával.
1.  Szerezze meg a XLTM konvertálási eredményt WORD-ra.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTM konvertálásához WORD-ba" %}}
