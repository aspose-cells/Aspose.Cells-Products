...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση SXC σε μορφή αποθήκευσης XPS. Java Συνδυάστε τη μορφή SXC με XPS. Συγχώνευση SXC σε XPS στο Java. SXC Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση SXC με XPS στο Java" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση SXC έως XPS στο Java" InputFormat="sxc" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
