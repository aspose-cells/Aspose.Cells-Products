...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na TXT pomocí Python" %}}

 K převodu TABDELIMITED na TXT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TABDELIMITED na TXT přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory TABDELIMITED na TXT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TABDELIMITED s instancí sešitu1. Zavolejte metodu Workbook.Save1. Jako parametr předejte výstupní cestu s příponou TXT1. Zkontrolujte zadanou cestu pro výsledný soubor TXT
