---
title: Java MHTML do ODS - MHTML do ODS Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu MHTML do ODS, umożliwiając bezproblemowe zapisywanie danych MHTML do formatu ODS za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHTML do ODS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować MHTML na ODS w Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHTML na ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki MHTML na ODS? Programiści Java mogą łatwo przekonwertować pliki MHTML na ODS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj numer MHTML na numer ODS, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji MHTML na ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji MHTML na ODS" %}}
{{% blocks/products/pf/agp/text %}}
