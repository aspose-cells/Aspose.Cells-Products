...
url: /vi/python-java/merger/merge-xml-to-mht/ 
...
Ví dụ sau đây minh họa cách hợp nhất XML thành MHT trong Aspose.Cells for Python via Java.
...
Cần hợp nhất XML vào MHT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API có thể được thực hiện chỉ với vài dòng mã.
