---
title: C# MHT 至 ET - 在線 MHT 至 ET 轉換器
description: Aspose Excel。 C# Aspose.Cells. C# Aspose Cells. 免費在線 C# 將 MHT 轉換為 ET 保存格式。 C# MHT 轉 ET 格式。將 MHT 保存到 ET C#。
...
{{% blocks/products/pf/agp/content h2="免費在線將MHT保存到C#中的ET" %}}

下面的例子演示瞭如何將C#中的MHT轉換為ET。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 轉換為 ET。上傳您的 MHT 文件，然後將其保存為 ET 文件。對於 MHT 讀取和 ET 寫入，您可以使用完全限定的文件名。輸出的 ET 內容和格式將與原始 MHT 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 MHT 在線轉換為 ET 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 轉換為 ET" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 ET？ .NET 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 ET。
...
1. 通過調用 Workbook.Save 方法將 MHT 轉換為 ET。
1. 獲取MHT到ET的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 將 MHT 轉換為 ET 的庫" %}}
