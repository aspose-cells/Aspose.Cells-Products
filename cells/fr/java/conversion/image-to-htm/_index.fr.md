...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE au format HTM dans Java" %}}

L'exemple suivant montre comment convertir une IMAGE en HTM dans Java.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir une image en HTML. Téléchargez votre fichier image, puis enregistrez-le au format HTML. Pour la lecture des images et l'écriture au format HTML, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme du fichier HTML généré seront identiques à ceux du document image d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir une image en HTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="htm" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir une IMAGE en HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE en HTM par programmation ? Les développeurs Java peuvent facilement convertir des fichiers IMAGE en HTM en quelques lignes de code seulement.
...
1.  Convertissez l'IMAGE en HTM en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion d'une IMAGE en HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir une image en HTML" %}}
{{% blocks/products/pf/agp/text %}}
