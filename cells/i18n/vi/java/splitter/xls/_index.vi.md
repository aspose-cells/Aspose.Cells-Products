---
title: Tách tệp XLS qua Java 
weight: 610
url: /vi/java/splitter/xls/ 
description: Java mã mẫu để tách tài liệu XLS trên Java Môi trường thời gian chạy cho Ứng dụng JSP / JSF và Ứng dụng trên máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tách tệp XLS qua Java" h2="Tách XLS với sự trợ giúp của thư viện Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tách tệp XLS bằng Java" %}}
 ...
 API là một nền tảng API for Java bộ tách nhiều tính năng, mạnh mẽ và dễ sử dụng. Bạn có thể tải xuống phiên bản mới nhất của nó trực tiếp từ
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Tách tệp XLS trong Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Tách tệp XLS - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/splitter/xlsm/" name="XLSM" description="Tệp Spreasheet" >}}
