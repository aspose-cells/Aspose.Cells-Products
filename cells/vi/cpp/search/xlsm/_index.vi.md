...
weight: 9280
url: /vi/cpp/search/xlsm/ 
description: C++ mã ví dụ để tìm kiếm các từ có mẫu trong tệp XLSM trên C++ Môi trường thời gian chạy cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm Định dạng XLSM trong C++" h2="Tìm kiếm tài liệu XLSM tự nhiên và hiệu suất cao bằng cách sử dụng API Aspose.Cells phía máy chủ cho C++ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
+ Tải tệp XLSM bằng cách khởi tạo một lớp IWorkbook.
