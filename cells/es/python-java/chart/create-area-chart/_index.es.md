...
description: Python Código de muestra para crear gráficos de áreas en Excel usando la biblioteca Python. Use este código para crear un gráfico de área para MS Excel dentro de la aplicación basada en Python.
---
...
1. Agregar un gráfico de área a la hoja de cálculo
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="El siguiente código fuente muestra cómo crear un gráfico de área en un archivo MS Excel XLSX usando Python." offSpacer="" %}}
