---
title:  Combinar XLSM Archivos via .NET
weight: 660
description: Código fuente C# para combinar documentos XLSM en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar XLSM Formatos en C#" h2="Fusión de documentos nativa y de alto rendimiento XLSM utilizando las API del lado del servidor Aspose.Cells for .NET, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
+ Ahora puede abrir y usar el archivo XLSM en Office Microsoft, Adobe PDF o cualquier otro programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Combinar XLSM Archivos - C#" offSpacer="" %}}
