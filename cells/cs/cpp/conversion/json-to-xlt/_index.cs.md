---
title: Převeďte JSON na XLT pomocí aplikace C++ 

description: Ukázkový konverzní kód C++ pro dokument JSON na formát XLT. Programátoři mohou tento zdrojový kód použít pro dávkový převod JSON na XLT v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést JSON na XLT pomocí C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu JSON na XLT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor JSON na XLT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor JSON pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLT).1. Soubor XLT bude uložen do zadané cesty.1. Otevřete soubor XLT v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu JSON na XLT C++" offSpacer="" %}}
