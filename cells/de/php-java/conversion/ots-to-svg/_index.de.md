...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in SVG mit Aspose.Cells. PHP OTS in SVG. PHP Speichern Sie OTS in SVG. Speichern Sie OTS mit PHP als SVG.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in SVG" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in SVG konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in SVG konvertieren.
...
1.  Konvertieren Sie OTS in SVG, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in SVG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in SVG" %}}
