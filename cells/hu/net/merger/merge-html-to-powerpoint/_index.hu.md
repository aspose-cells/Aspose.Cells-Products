...
url: /hu/net/merger/merge-html-to-powerpoint/ 
...
A következő példa bemutatja, hogyan egyesítheti a HTML-es számot a POWERPOINT-tal a Aspose.Cells-es for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a HTML-et a POWERPOINT-tal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a HTML és a POWERPOINT egyesítéséhez" %}}
