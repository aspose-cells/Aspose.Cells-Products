---
title: Python via Java을 사용하여 Excel에 별/배너 삽입
weight: 381
description: Python via Java 엑셀에 별/배너를 삽입하는 소스코드입니다.
keywords: [Python Aspose.Cells., Python add Star/Banner., Python insert Star/Banner., Python create Star/Banner]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java을 사용하여 Excel에 별/배너 삽입" h2="Microsoft 또는 Open Office, Adobe PDF 등과 같은 소프트웨어 없이 Aspose.Cells\' API을 사용하여 별/배너를 삽입합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java을 사용하여 Excel 파일에 별/배너를 삽입하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java을 사용하여 Excel 파일에 별/배너를 삽입하는 단계" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 +[메소드 추가](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) 선택한 워크시트에 별/배너를 삽입하려면
...
아래 샘플 코드는 "수학 플러스"를 삽입하는 방법을 보여줍니다. 더 많은 유형에 대해서는 아래 "별 및 배너 유형 개요"를 참조하세요.

{{% blocks/products/pf/agp/code-block title="별/배너 삽입 - Python via Java" offSpacer="" %}}
