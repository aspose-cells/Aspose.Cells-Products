...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar PRN met Aspose.Cells. PHP OTS naar PRN. PHP Bewaar OTS in PRN. Sla OTS op als PRN met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar PRN te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar PRN converteren? PHP-ontwikkelaars kunnen OTS eenvoudig in slechts een paar regels code laden en naar PRN converteren.
...
1.  Converteer OTS naar PRN door de opslagmethode van Workbook aan te roepen.
1.  Ontvang het conversieresultaat van OTS naar PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om OTS naar PRN te converteren" %}}
