---
title: PHP HTM a TXT - Convertidor HTM a TXT
description: Aspose Excel. Convierta HTM a TXT rápida y fácilmente con Aspose.Cells. PHP HTM a TXT. PHP Guarde HTM en TXT. Guarde HTM como TXT usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a TXT mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a TXT mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a TXT en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a TXT llamando al método guardar del libro de trabajo.
