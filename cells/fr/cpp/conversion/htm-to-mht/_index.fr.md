...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en MHT dans C++" h2="Conversion HTM vers MHT haute performance utilisant la bibliothèque C++ sans avoir besoin de l\'installation d\'Excel, d\'OpenOffice ou d\'Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Sauvegarder HTM en MHT dans C++" %}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir un fichier HTM en MHT via le code C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM en MHT par programmation ? Les développeurs de C++ peuvent facilement convertir des fichiers HTM en MHT en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en MHT en appelant la méthode Save().
