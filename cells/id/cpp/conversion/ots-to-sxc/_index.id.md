...
description: Aspose Unggul. Ubah OTS menjadi SXC dengan cepat dan mudah menggunakan Aspose.Cells. C++ OTS menjadi SXC. C++ Simpan OTS ke SXC. Simpan OTS sebagai SXC menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah OTS menjadi SXC Menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengonversi OTS ke SXC di C++.
...
Perlu mengonversi file OTS ke SXC secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke SXC hanya dalam beberapa baris kode.
...
1.  Ubah OTS menjadi SXC dengan memanggil metode Save().
1.  Dapatkan hasil konversi OTS menjadi SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah OTS menjadi SXC" %}}
