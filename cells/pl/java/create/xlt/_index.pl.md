...
description: Aspose Excel. Java Utwórz plik XLT. Utwórz XLT Java. Java XLT Twórca. Utwórz XLT w Java. Wygeneruj plik XLT, używając Java.
...
1.  Zapisz skoroszyt w formacie XLT przy użyciu metody save().
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do utworzenia pliku XLT" %}}
{{% blocks/products/pf/agp/text %}}
