...
description: Aspose エクセル。 Java Aspose.Cells。SPREADSHEETML を XPS 保存形式にマージします。 Java SPREADSHEETML を XPS 形式に結合します。 SPREADSHEETML を Java の XPS にマージします。SPREADSHEETML をマージします。
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML を Java の XPS にマージします" %}}
...
{{% cells-merger title="Java に SPREADSHEETML を XPS にマージするサンプルコード" InputFormat="xml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
