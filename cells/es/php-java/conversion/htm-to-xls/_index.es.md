---
title: PHP HTM a XLS - Convertidor HTM a XLS
description: Aspose Excel. Convierta HTM a XLS rápida y fácilmente con Aspose.Cells. PHP HTM a XLS. PHP Guarde HTM en XLS. Guarde HTM como XLS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a XLS mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a XLS mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a XLS en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a XLS llamando al método guardar del libro de trabajo.
