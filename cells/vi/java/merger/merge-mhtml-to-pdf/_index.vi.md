---
title: Hợp nhất MHTML thành PDF - Hợp nhất MHTML thành PDF thành Java
url: /vi/java/merger/merge-mhtml-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí MHTML thành PDF saveformat. Java Kết hợp định dạng MHTML thành PDF. Hợp nhất MHTML thành PDF thành Java. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML thành PDF trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất MHTML thành PDF trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất MHTML thành PDF. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp PDF. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất MHTML thành PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Hợp nhất trực tuyến miễn phí MHTML thành PDF trong Java" InputFormat="mhtml" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất MHTML thành PDF via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Java thư viện để hợp nhất MHTML thành PDF" %}}
