...
+ Utilice el método de adición de la colección de formas para insertar una casilla de verificación (control de formulario) en la hoja de trabajo seleccionada.
