---
title: Преобразователь C# FODS в XLSX - FODS в XLSX
description: Aspose Эксель. Преобразуйте FODS в XLSX быстро и легко с помощью Aspose.Cells. C# FODS в XLSX. C# Сохранить FODS в XLSX. Сохранить FODS как 07611134 81, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните с FODS по XLSX в C#." %}}
...
Нужно программно преобразовать файлы FODS в XLSX? Разработчики .NET могут легко загрузить и преобразовать FODS в XLSX всего за несколько строк кода.
