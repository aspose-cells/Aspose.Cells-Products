---
title:  Sloučit PRN na HTML přes C#
url: /cs/net/merger/merge-prn-to-html/ 
description: Sloučit PRN na HTML Online zdarma. Online zdarma PRN na HTML Fúze. Sloučit PRN do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit PRN s HTML v C#.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení PRN s číslem HTML online" InputFormat="prn" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
