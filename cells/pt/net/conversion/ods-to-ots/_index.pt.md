---
title: C# ODS para OTS - Conversor ODS para OTS
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato OTS, permitindo o salvamento perfeito de dados ODS no formato OTS usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS para OTS em C#" %}}

O exemplo a seguir demonstra como converter ODS para OTS em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter ODS em OTS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para OTS programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em OTS em apenas algumas linhas de código.
...
1.  Converta ODS para OTS chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em OTS" %}}
