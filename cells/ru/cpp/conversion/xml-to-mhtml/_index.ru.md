...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в MHTML в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат MHTML в формате C++.
...
Нужно программно преобразовать XML-файлы в формат MHTML? Разработчики, использующие формат C++, могут легко преобразовать XML в формат MHTML всего несколькими строками кода.
...
1.  Преобразовать XML в формат MHTML, вызвав метод Save().
