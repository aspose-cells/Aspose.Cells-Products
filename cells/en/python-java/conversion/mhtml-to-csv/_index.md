...
description: Sample code for mhtml to csv Python conversion. Use API example code for batch mhtml files to csv conversion within Python application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert MHTML to CSV Using Python" %}}
 ...
 In order to convert MHTML to CSV, we will use
...
{{% cells-convert title="Free App and Sample Code to Convert MHTML to CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="csv" IsLandingPage="true" language="python" %}}
