---
title:  Chèn ComboBox (Điều khiển biểu mẫu) vào Excel bằng Python via java
weight: 20
description: Python via mã nguồn java để chèn ComboBox (Điều khiển biểu mẫu) vào Excel.
---
...
{{% blocks/products/pf/agp/content h2="Cách Chèn ComboBox(Form control) vào File Excel Bằng Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn ComboBox(Form control) vào file Excel sử dụng Python via java" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng bộ sưu tập hình dạng[thêm phương pháp](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)) để chèn ComboBox (Điều khiển biểu mẫu) vào trang tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn ComboBox(Điều khiển biểu mẫu) - Python via java" offSpacer="" %}}
