...
description: Aspose एक्सेल। Aspose.Cells के साथ जल्दी और आसानी से EXCEL को ODS में बदलें। C# EXCEL को ODS में बदलें। C# EXCEL को ODS पर सेव करें। C# का उपयोग करके EXCEL को ODS के रूप में सेव करें।
...
{{% blocks/products/pf/agp/content h2="C# में EXCEL को ODS पर सेव करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि C# में EXCEL को ODS में कैसे परिवर्तित किया जाए।
...
{{% cells-convert title="EXCEL को ODS में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# के माध्यम से EXCEL को ODS में कैसे बदलें" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL फ़ाइलों को प्रोग्रामेटिक रूप से ODS में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में आसानी से EXCEL को ODS में लोड और परिवर्तित कर सकते हैं।
...
1.  Workbook.Save पद्धति पर कॉल करके EXCEL को ODS में बदलें।
1.  EXCEL का रूपांतरण परिणाम ODS पर प्राप्त करें।

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="EXCEL को ODS में बदलने के लिए C# लाइब्रेरी" %}}
