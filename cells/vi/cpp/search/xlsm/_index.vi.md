---
title:  Tìm kiếm tài liệu XLSM mà không cần mở qua C++
weight: 9280
description: C++ mã ví dụ để tìm kiếm các từ có mẫu trong tệp XLSM trên Môi trường thời gian chạy C++ cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm XLSM Các định dạng trong C++" h2="Tìm kiếm tài liệu gốc và hiệu suất cao XLSM bằng API Aspose.Cells for C++ phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tra cứu file XLSM trong C++" %}}
...
Tải tệp XLSM bằng cách khởi tạo lớp IWorkbook.
...
+ Lưu tệp XLSM bằng phương thức IWorkbook->Save(.).
...
{{% blocks/products/pf/agp/code-block title="Tìm Hồ Sơ XLSM - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến XLSM Tìm kiếm Demo trực tiếp" sectionDescription=" Tìm kiếm văn bản, từ, cụm từ trong tài liệu XLSM ngay bây giờ bằng cách truy cập trang web của chúng tôi[Trang web Demo trực tiếp](https://products.aspose.app/cells/search). Bản demo trực tiếp có những lợi ích sau" >}}
