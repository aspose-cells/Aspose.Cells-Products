...
以下範例示範如何將 XLT 合併到 Aspose.Cells for .NET 中的 OTS。
...
需要以程式方式將 XLT 合併到 OTS 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將XLT合併至OTS" %}}
