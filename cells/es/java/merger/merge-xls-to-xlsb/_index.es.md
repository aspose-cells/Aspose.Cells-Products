---
title: Combinar XLS a XLSB - Combinar XLS a XLSB en Java
url: /es/java/merger/merge-xls-to-xlsb/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLS a XLSB guardar formato. Java Combina el formato XLS con el XLSB. Combinar XLS a XLSB en Java. XLS Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLS a XLSB en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLS con XLSB en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLS a XLSB. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo XLSB. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que combina XLS con XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLS a XLSB en Java" InputFormat="xls" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLS a XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLS con XLSB mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar XLS a XLSB" %}}
