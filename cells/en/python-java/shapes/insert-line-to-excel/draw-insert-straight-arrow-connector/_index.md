---
title: How do I draw or insert straight arrow connector into Excel via Python 
weight: 10

description: Python source code to draw or insert straight arrow connector into Excel.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Insert straight arrow connector into Excel via Python" h2="Insert objects using server-side APIs without any software like Microsoft or Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Insert straight arrow connector into Excel File Using Python" %}}

 In order to insert straight arrow connector into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert straight arrow connector to Excel file via Python" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) to insert a straight arrow connector in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert straight arrow connector - Python" offSpacer="" %}}

{{< gist "aspose-cells-gists" "32e50c6aabc547111966569f3fd39694" "InsertArrowConnector.py" >}}
