---
title: Fusionner TXT à PDF - Combiner TXT à PDF dans C++
url: /fr/cpp/merger/merge-txt-to-pdf/ 
description: Aspose Excel. C++ Aspose.Cells. Fusion en ligne gratuite TXT au format de sauvegarde PDF. C++ Combinez le format TXT au format PDF. Fusionner TXT à PDF dans C++. TXT Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner TXT à PDF en C++ en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner TXT à PDF dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner TXT à PDF. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier PDF. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne TXT à PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner TXT à PDF en C++" InputFormat="txt" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner TXT à PDF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner TXT à PDF par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour fusionner TXT à PDF" %}}
