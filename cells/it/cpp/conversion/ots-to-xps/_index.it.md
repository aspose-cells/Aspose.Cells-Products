...
Hai bisogno di convertire i file OTS in XPS tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire OTS in XPS in poche righe di codice.
...
1.  Convertire OTS in XPS chiamando il metodo Save().
