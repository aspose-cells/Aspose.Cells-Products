...
description: Aspose Эксель. C++ Создайте файл FODS быстро и легко с помощью Aspose.Cells. Создайте файл FODS с помощью C++. Создайте FODS в C++. C++ FODS Creater.
...
1.  Сохраните книгу как файл .fods, используя метод Save().
