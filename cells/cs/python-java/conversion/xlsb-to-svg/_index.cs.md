...
{{% blocks/products/pf/agp/content h2="Převeďte XLSB na SVG pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XLSB na SVG v Python.
