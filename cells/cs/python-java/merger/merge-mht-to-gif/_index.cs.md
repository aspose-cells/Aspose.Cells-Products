...
url: /cs/python-java/merger/merge-mht-to-gif/ 
...
Následující příklad ukazuje, jak sloučit MHT s GIF v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit MHT na GIF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
