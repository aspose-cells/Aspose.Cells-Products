...
description: Aspose اكسل. Python Aspose.Cells. ادمج XLS في تنسيق الحفظ ET. Python قم بدمج XLS إلى تنسيق ET. دمج XLS إلى ET في Python. XLS دمج.
...
{{% blocks/products/pf/agp/content h2="دمج XLS إلى ET باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="دمج XLS إلى ET في Python" %}}
...
{{% cells-merger title="نموذج التعليمات البرمجية لدمج XLS إلى ET في Python" InputFormat="xls" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLS إلى ET عبر Python" %}}
