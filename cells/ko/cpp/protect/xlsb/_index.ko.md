---
title:  C++을 통해 XLSB 문서를 보호하고 잠급니다.
weight: 4860
description: C++ C++ 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경에서 비밀번호를 사용하여 XLSB 파일을 잠그는 예제 코드입니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C++을 통해 XLSB 파일을 보호하는 단계" %}}
...
1.  Save() 메소드로 보호된 XLSB 파일을 저장합니다.
