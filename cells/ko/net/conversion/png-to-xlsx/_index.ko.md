...
{{< blocks/products/pf/i18n/upper-banner h1="PNG을 XLSX로, 그리고 C#로 변환합니다." h2="PNG 형식을 XLSX 형식으로 고속 변환하는 라이브러리입니다. 이 전문 소프트웨어 솔루션은 PNG, XLSX 및 기타 여러 형식을 .NET 프레임워크, .NET 코어 또는 Mono 플랫폼으로 가져오고 내보낼 수 있도록 지원합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% cells-convert title="PNG을 XLSX로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 PNG을 XLSX로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 PNG 파일을 XLSX로 변환해야 합니까? .NET 개발자는 단 몇 줄의 코드만으로 PNG을 XLSX로 쉽게 로드하고 변환할 수 있습니다.
