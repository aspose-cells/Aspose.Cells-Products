---
title: Unisci PRN a EXCEL - Combina PRN a EXCEL in Java
url: /it/java/merger/merge-prn-to-excel/ 
description: Aspose Excel. Java Aspose.Cells. Unisci PRN online gratuito in formato di salvataggio EXCEL. Java Combina PRN in formato EXCEL. Unisci PRN a EXCEL in Java. Unisci PRN.
...
{{% blocks/products/pf/agp/content h2="Unisci PRN a EXCEL in Java online gratuitamente" %}}

L'esempio seguente mostra come unire PRN a EXCEL in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire PRN a EXCEL. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file EXCEL. Se sviluppi il codice in Java, sarà più semplice di quanto sembri. Vedere l'esempio Java che unisce PRN a EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire PRN a EXCEL in Java" InputFormat="prn" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Come unire PRN a EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Hai bisogno di unire PRN a EXCEL a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Java libreria per unire PRN a EXCEL" %}}
