---
title:  Extrahujte text a obrázky z dokumentu XLSX via .NET
weight: 4010
description: C# zdrojový kód pro extrahování textu a obrázků ze souboru XLSX na platformách .NET, .NET Core, Mono nebo Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Parse XLSX Formáty v C#" h2="Nativní a vysoce výkonné XLSX analyzování dokumentů pomocí Aspose.Cells for .NET API na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak analyzovat soubor XLSX pomocí C#" %}}
 ...
 Abychom mohli analyzovat soubor XLSX, použijeme[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API, což je funkčně bohatá, výkonná a snadno použitelná manipulace s dokumenty API pro platformu C#. OTEVŘENO[NuGet](https://www.nuget.org/packages/aspose.cells) správce balíčků, vyhledejte
