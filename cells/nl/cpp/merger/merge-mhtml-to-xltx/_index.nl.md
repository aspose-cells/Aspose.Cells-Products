---
title: Voeg MHTML samen met XLTX - Combineer MHTML met XLTX in C++
url: /nl/cpp/merger/merge-mhtml-to-xltx/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen MHTML naar XLTX saveformat. C++ Combineer het formaat MHTML tot XLTX. Samenvoegen MHTML tot XLTX in C++. MHTML Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u MHTML samenvoegt met XLTX in Aspose.Cells for C++.
...
{{% cells-merger title="Gratis online om MHTML samen te voegen tot XLTX in C++" InputFormat="mhtml" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe MHTML samen te voegen met XLTX via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHTML programmatisch samenvoegen tot XLTX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
