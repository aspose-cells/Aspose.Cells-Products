---
title: C# 数字からタブ区切り文字へ - 数字からタブ区切り文字へのコンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、NUMBERS を TABDELIMITED にすばやく簡単に変換します。 C# NUMBERS を TABDELIMITED に変換します。 C# 番号を TABDELIMITED に保存してください。 C# を使用して、NUMBERS を TABDELIMITED として保存します。
...
{{% blocks/products/pf/agp/content h2="番号を C# の TABDELIMITED に保存" %}}

次の例は、C# の NUMBERS を TABDELIMITED に変換する方法を示しています。
...
{{% cells-convert title="NUMBERS を TABDELIMITED に変換するサンプル コード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# を介して NUMBERS を TABDELIMITED に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS ファイルをプログラムで TABDELIMITED に変換する必要がありますか? .NET 開発者は、わずか数行のコードで NUMBERS を簡単にロードして TABDELIMITED に変換できます。
...
{{% blocks/products/pf/agp/content h2="C# NUMBERS を TABDELIMITED に変換するライブラリ" %}}
