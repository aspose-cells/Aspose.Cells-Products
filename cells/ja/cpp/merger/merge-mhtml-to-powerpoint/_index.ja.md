---
title: MHTML を C++ 経由で POWERPOINT にマージします
url: /ja/cpp/merger/merge-mhtml-to-powerpoint/ 
description: MHTML を POWERPOINT Online に無料でマージします。 POWERPOINT Mergerへの無料オンラインMHTML。 MHTML を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、MHTML を C++ の POWERPOINT にマージする方法を示しています。
...
{{% cells-merger title="MHTMLをオンラインでPOWERPOINTにマージする無料アプリ" InputFormat="mhtml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
