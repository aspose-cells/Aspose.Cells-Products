...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi JPG sang GIF trong C#" h2="Thư viện tốc độ cao C# dùng để chuyển đổi JPG sang GIF. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất JPG, GIF và nhiều định dạng khác trên nền tảng .NET Framework, .NET Core hoặc Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPG" >}}
...
Cần chuyển đổi file JPG sang GIF theo chương trình? Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi JPG sang GIF chỉ bằng vài dòng mã.
...
1.  Chuyển đổi định dạng JPG thành GIF bằng cách gọi phương thức Workbook.Save.
