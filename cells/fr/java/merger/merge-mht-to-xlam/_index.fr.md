---
title: Fusionner MHT avec XLAM - Combiner MHT avec XLAM dans Java
url: /fr/java/merger/merge-mht-to-xlam/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde XLAM. Java Combinez MHT au format XLAM. Fusionner MHT avec XLAM dans Java. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec XLAM en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT avec XLAM dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT en XLAM. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier XLAM. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne MHT en XLAM.
...
{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner MHT avec XLAM par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner MHT avec XLAM" %}}
