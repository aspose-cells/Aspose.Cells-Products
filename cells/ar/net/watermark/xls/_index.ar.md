---
title: العلامة المائية XLS الوثيقة via .NET
weight: 3050
description: كود المصدر C# لإضافة أو إزالة العلامة المائية إلى ملف XLS على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
{{% blocks/products/pf/agp/code-block title="إضافة العلامة المائية إلى XLS - C#" offSpacer="" %}}
