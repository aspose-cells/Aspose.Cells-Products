...
{{% blocks/products/pf/agp/content h2="Comment insérer un arc dans un fichier Excel à l\'aide de Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer un fichier Arc dans Excel en utilisant Python via java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addArc(int,%20int,%20int,%20int,%20int,%20int)) pour insérer un Arc dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer un arc - Python via java" offSpacer="" %}}
