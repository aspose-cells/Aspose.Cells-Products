---
title: Sloučit PRN s ET – Zkombinujte PRN s ET v C++
url: /cs/cpp/merger/merge-prn-to-et/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit PRN do formátu uložení ET. C++ Kombinujte PRN s formátem ET. Sloučit PRN do ET v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN do ET v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN do ET v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN s ET. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru ET. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí PRN do ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení PRN do ET na čísle C++" InputFormat="prn" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN do ET přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit PRN s ET programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení PRN do ET" %}}
