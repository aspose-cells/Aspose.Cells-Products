...
weight: 30
description: C++ código de exemplo para inserir linha no arquivo Excel em C++ Ambiente de tempo de execução para Windows 32 bits, Windows 64 bits e Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserir linha no Excel via C++" h2="Insira objetos usando o nativo e alto desempenho do lado do servidor Aspose.Cells for C++ API sem usar nenhum software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o[adicionar método](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#af316525bc065d011552514e73f3d5682) para inserir Formas de Equação na planilha selecionada
