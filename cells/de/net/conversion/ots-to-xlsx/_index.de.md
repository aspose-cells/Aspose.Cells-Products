...
Müssen Sie OTS-Dateien programmgesteuert in XLSX konvertieren? .NET-Entwickler können OTS mit nur wenigen Codezeilen problemlos in XLSX laden und konvertieren.
...
1.  Konvertieren Sie OTS in XLSX durch Aufruf der Workbook.Save-Methode.
1.  Erhalten Sie das Konvertierungsergebnis von OTS zu XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von OTS nach XLSX" %}}
