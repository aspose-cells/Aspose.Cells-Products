---
title: EXCEL'i PRN ile birleştir - Java'de EXCEL'i PRN ile birleştir
url: /tr/java/merger/merge-excel-to-prn/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i PRN kaydetme biçimiyle birleştirin. Java EXCEL'i PRN formatıyla birleştirin. Java'de EXCEL'i PRN ile birleştir. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i PRN ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de EXCEL'in PRN ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="Java\'de EXCEL\'i PRN ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i PRN via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i PRN ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
