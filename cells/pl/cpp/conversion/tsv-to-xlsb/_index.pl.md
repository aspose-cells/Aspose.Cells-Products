---
title: Konwertuj TSV na XLSB za pomocą aplikacji C++ 
weight: 1370
url: /pl/cpp/conversion/tsv-to-xlsb/ 
description: Przykładowy kod konwersji C++ dla dokumentu TSV do formatu XLSB. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji TSV na XLSB w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TSV na XLSB w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSB).1. Plik XLSB zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSB w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji TSV do XLSB C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją TSV do XLSB" sectionDescription="[Konwertuj TSV na XLSB](https://products.aspose.app/cells/conversion/tsv-to-xlsb) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik TSV, zostanie on natychmiast przekonwertowany na XLSB." >}}
