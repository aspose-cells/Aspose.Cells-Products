...
{{< blocks/products/pf/i18n/upper-banner h1="Zet PRN om naar DIF in C#" h2="Snelle C#-bibliotheek voor het converteren van PRN naar DIF. Dit is een professionele softwareoplossing voor het importeren en exporteren van PRN, DIF en vele andere formaten op .NET Framework, .NET Core of Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PRN" >}}
...
{{% blocks/products/pf/agp/content h2="Sla PRN op als DIF in C#" %}}

Het volgende voorbeeld laat zien hoe u PRN naar DIF kunt converteren in C#.
