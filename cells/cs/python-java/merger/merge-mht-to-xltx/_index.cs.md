...
description: Aspose Excel. Python Aspose.Cells. Sloučit MHT do formátu uložení XLTX. Python Zkombinujte MHT do formátu XLTX. Sloučit MHT na XLTX v Python. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na XLTX v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT s XLTX v Python" InputFormat="mht" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
