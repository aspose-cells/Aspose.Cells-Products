---
title: C# XML в SXC - Конвертер XML в SXC
description: Aspose Эксель. Быстро и легко конвертируйте XML в SXC с помощью Aspose.Cells. C# XML в SXC. C# Сохраните XML в SXC. Сохраните XML как SXC, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните XML в SXC в C#." %}}
...
{{% cells-convert title="Пример кода для преобразования XML в SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать XML в SXC через C#" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно преобразовать XML-файлы в SXC? Разработчики .NET могут легко загружать и конвертировать XML в SXC всего за несколько строк кода.
