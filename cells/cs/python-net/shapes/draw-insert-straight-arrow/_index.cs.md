...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení přímé šipky do souboru aplikace Excel pomocí Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Vložte rovnou šipku - Python via .Net" offSpacer="" %}}
