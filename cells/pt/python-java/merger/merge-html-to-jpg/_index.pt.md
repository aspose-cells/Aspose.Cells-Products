...
description: Aspose Excel. Python Aspose.Cells. Mesclar HTML para salvar o formato JPG. Python Combine HTML para o formato JPG. Mesclar HTML para JPG em Python. HTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML em JPG usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML para JPG em Python" %}}

exemplo a seguir demonstra como mesclar HTML com JPG em Aspose.Cells for Python via Java.
