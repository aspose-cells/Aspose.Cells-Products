---
title: OTS'yi IMAGE ile Birleştir - C++'de OTS'yi IMAGE ile Birleştir
url: /tr/cpp/merger/merge-ots-to-image/ 
description: Aspose Excel'de. C++ Aspose.Cells. OTS'yi IMAGE kaydetme biçimiyle birleştirin. C++ OTS'yi IMAGE formatıyla birleştirin. C++'de OTS'yi IMAGE ile birleştir. OTS Birleştir.
...
{{% blocks/products/pf/agp/content h2="C++\'de OTS\'yi IMAGE ile birleştir" %}}
...
{{% cells-merger title="C++\'de OTS\'yi IMAGE ile Birleştirmek için Örnek Kod" InputFormat="ots" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi C++ aracılığıyla IMAGE ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 OTS'yi IMAGE ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
