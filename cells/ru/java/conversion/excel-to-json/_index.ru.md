...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики Java могут легко преобразовать EXCEL в JSON всего за несколько строк кода.
