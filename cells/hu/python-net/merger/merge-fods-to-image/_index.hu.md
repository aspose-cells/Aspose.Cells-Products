---
title: A FODS egyesítése az IMAGE-val – a FODS-es szám egyesítése az IMAGE-val a Python-ben
url: /hu/python-net/merger/merge-fods-to-image/ 
description: Aspose Excel. Python Aspose.Cells. Ingyenes online egyesítés FODS IMAGE mentési formátumba. Python A FODS kombinálása IMAGE formátumba. A FODS egyesítése a Python-es számú IMAGE-val. FODS Egyesítés.
...
következő példa bemutatja, hogyan lehet egyesíteni a FODS-et az IMAGE-val a Aspose.Cells-es for Python-es via .NET-ben.
...
{{% cells-merger title="Ingyenes online a FODS egyesítéséhez az IMAGE-hez a Python-ben" InputFormat="fods" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A FODS és az IMAGE egyesítése a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a FODS-et az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Python könyvtár a FODS és az IMAGE egyesítéséhez" %}}
