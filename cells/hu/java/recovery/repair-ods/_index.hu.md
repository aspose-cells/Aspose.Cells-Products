...
{{% blocks/products/pf/agp/content h2="A Java-es számú ods fájl javítása" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell javítania az ods fájlt? A Java fejlesztők könnyedén betölthetik és javíthatják az ods fájlt néhány sornyi kóddal.
