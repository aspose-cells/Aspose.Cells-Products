---
title: Fusionner MHT avec BMP - Combiner MHT avec BMP dans C#
url: /fr/net/merger/merge-mht-to-bmp/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite MHT au format de sauvegarde BMP. C# Combinez MHT au format BMP. Fusionner MHT avec BMP dans C#. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec BMP en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT avec BMP dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT en BMP. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier BMP. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne MHT en BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner MHT avec BMP en C#" InputFormat="mht" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner MHT avec BMP par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque .NET pour fusionner MHT avec BMP" %}}
