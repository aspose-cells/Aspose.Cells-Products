...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в OTS, используя Java" %}}
...
Следующий пример демонстрирует, как преобразовать код HTML в формат OTS в коде Java.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать код HTML в код OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы HTML в формат OTS? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в формат OTS всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования HTML в формат OTS" %}}
{{% blocks/products/pf/agp/text %}}
