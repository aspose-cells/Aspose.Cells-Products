---
title: Convertir SPREADSHEETML en JPEG via Java 
url: /fr/java/conversion/spreadsheetml-to-jpeg/ 
description: Exemple de code de conversion Java pour le format SPREADSHEETML en fichier JPEG. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice au format JPEG dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir SPREADSHEETML en JPEG via Java" h2="Conversion SPREADSHEETML en JPEG Java pour convertir une ou plusieurs pages en JPEG à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir SPREADSHEETML en JPEG à l\'aide de Java" %}}

 Afin de rendre SPREADSHEETML en JPEG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SPREADSHEETML en JPEG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier SPREADSHEETML en JPEG en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion SPREADSHEETML vers JPEG Java" offSpacer="" %}}
