...
description: Aspose Excel. Konwertuj EXCEL na XLSB szybko i łatwo za pomocą Aspose.Cells. Java EXCEL na XLSB. Java Zapisz EXCEL na XLSB. Zapisz EXCEL jako XLSB używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL pod numerem XLSB w Java" %}}

Poniższy przykład ilustruje, jak przekonwertować program EXCEL na XLSB w Java.
...
Chcesz programowo przekonwertować pliki EXCEL na XLSB? Programiści Java mogą łatwo przekonwertować EXCEL na XLSB w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji programu EXCEL na XLSB" %}}
{{% blocks/products/pf/agp/text %}}
