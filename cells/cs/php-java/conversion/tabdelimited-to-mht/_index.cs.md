...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům PHP plně integrovaný přístup k převodu dat TABDELIMITED do formátu MHT, což umožňuje bezproblémové ukládání dat TABDELIMITED do formátu MHT pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na MHT pomocí PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory TABDELIMITED do formátu MHT? Vývojáři v PHP mohou snadno načíst a převést soubory TABDELIMITED do formátu MHT pomocí několika řádků kódu.
...
1.  Převeďte TABDELIMITED na MHT voláním metody save v sešitu.
