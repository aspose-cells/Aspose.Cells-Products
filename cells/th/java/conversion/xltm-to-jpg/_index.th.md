...
description: Aspose เอ็กเซล. แปลง XLTM เป็น JPG อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Java XLTM เป็น JPG Java บันทึก XLTM เป็น JPG. บันทึก XLTM เป็น JPG โดยใช้ Java
...
{{% blocks/products/pf/agp/content h2="บันทึก XLTM เป็น JPG ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLTM เป็น JPG ใน Java
