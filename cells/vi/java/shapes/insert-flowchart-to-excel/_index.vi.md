...
{{% blocks/products/pf/agp/content h2="Cách chèn/tạo Lưu đồ vào File Excel Sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn/tạo Lưu đồ vào file Excel via Java" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng các[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) để chèn/tạo Lưu đồ trong trang tính đã chọn
...
Mã mẫu bên dưới trình bày cách chèn "Đa tài liệu". Để biết thêm các loại khác, vui lòng tham khảo "Tổng quan về các loại hình dạng mũi tên khối" bên dưới.

{{% blocks/products/pf/agp/code-block title="Chèn/Tạo lưu đồ - Java" offSpacer="" %}}
