---
title: Převeďte TXT na XLSB pomocí aplikace C++ 
url: /cs/cpp/conversion/txt-to-xlsb/ 
description: Ukázkový konverzní kód C++ pro dokument TXT na formát XLSB. Programátoři mohou použít tento zdrojový kód pro dávkový převod TXT na XLSB v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést TXT na XLSB pomocí C++" %}}

 K převodu TXT na XLSB použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod TXT na XLSB přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor TXT na XLSB pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu k výstupnímu souboru s příponou (XLSB).1. Soubor XLSB bude uložen do zadané cesty.1. Otevřete soubor XLSB v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TXT na XLSB C++" offSpacer="" %}}
