...
description: Aspose Excel'de. Java Aspose.Cells. ODS'i XLTM kaydetme biçimiyle birleştirin. Java ODS'i XLTM biçimiyle birleştirin. Java'de ODS'i XLTM ile birleştirin. ODS Birleştir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Java\'de XLTM ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de ODS ile XLTM'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

ODS ile XLTM'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLTM dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. ODS ile XLTM'i birleştiren Java örneğine bakın.
...
{{% blocks/products/pf/agp/text %}}
 ...
 ODS ile XLTM'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, ODS ile XLTM arasında birleştirilecek" %}}
