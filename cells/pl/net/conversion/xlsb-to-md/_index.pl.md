---
title: C# XLSB na MD - XLSB na konwerter MD
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSB na MD za pomocą Aspose.Cells. C# XLSB na MD. C# Zapisz XLSB w MD. Zapisz XLSB jako MD, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB na MD w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSB na MD w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLSB na MD. Prześlij plik XLSB, a następnie po prostu zapisz go jako plik MD. Zarówno do odczytu XLSB, jak i zapisu na MD można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie MD będą identyczne z oryginalnym dokumentem XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLSB na MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na MD przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSB na MD? Programiści .NET mogą z łatwością załadować i przekonwertować XLSB na MD w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLSB na MD" %}}
