...
Potřebujete převést soubory TSV na XLSB programově? Vývojáři C++ mohou snadno převést TSV na XLSB v několika řádcích kódu.
...
1.  Převeďte TSV na XLSB voláním metody Save().
