...
description: Aspose Excel. Převeďte IMAGE na SQL rychle a snadno pomocí Aspose.Cells. C++ IMAGE na SQL. C++ Uložte IMAGE do SQL. Uložte IMAGE jako SQL pomocí C++.
...
Potřebujete převést IMAGE soubory na SQL programově? C++ vývojáři mohou snadno převést IMAGE na SQL pomocí několika řádků kódu.
...
1.  Převeďte IMAGE na SQL voláním metody Save().
