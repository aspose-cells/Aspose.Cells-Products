...
description: Aspose Exceller. C++ Aspose.Cells. Fusionner HTM au format de sauvegarde SPREADSHEETML. C++ Combinez le format HTM au format SPREADSHEETML. Fusionner HTM avec SPREADSHEETML dans C++. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec SPREADSHEETML dans C++" %}}
...
{{% cells-merger title="Exemple de code pour fusionner HTM avec SPREADSHEETML dans C++" InputFormat="htm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec SPREADSHEETML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTM avec SPREADSHEETML par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour fusionner HTM avec SPREADSHEETML" %}}
