---
title: Chuyển đổi SPREADSHEETML sang PNG thông qua ứng dụng C++ 
url: /vi/cpp/conversion/spreadsheetml-to-png/ 
description: Mã chuyển đổi C++ mẫu cho tài liệu SPREADSHEETML sang định dạng PNG. Các lập trình viên có thể sử dụng mã nguồn này để chuyển đổi hàng loạt SPREADSHEETML sang PNG trong bất kỳ Ứng dụng C++ nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi SPREADSHEETML sang PNG qua C++" h2="Chuyển đổi SPREADSHEETML sang PNG hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp SPREADSHEETML sang PNG chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp SPREADSHEETML bằng Factory :: CreateIWorkbook.1. Chọn trang tính đầu tiên.1. Đặt tùy chọn (PNG).1. Lặp lại từng trang của trang tính và kết xuất.1. Mở tệp PNG trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi SPREADSHEETML sang PNG C++" offSpacer="" %}}
