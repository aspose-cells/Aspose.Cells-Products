...
{{% blocks/products/pf/agp/content h2="Convert XLSB to NUMBERS in Python" %}}
...
The following example demonstrates how to convert XLSB to NUMBERS in Python via NET.
