---
title:  Converter XLT em matriz de bytes via C#
weight: 7690
description: C# Código de exemplo para conversão de XLT para matriz de bytes. Use este código para conversão do Excel XLT em Byte Array em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta XLT em matriz de bytes via C#" h2="Nativo e de alto desempenho Microsoft Excel XLT para conversão de matriz de bytes ou vice-versa para processamento de dados de planilhas usando APIs .NET do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array é útil para processamento ou armazenamento de dados. Você pode converter o arquivo XLT em Byte Array, bem como um**Matriz de bytes para XLT** documento usando o idioma C#. Para converter XLT em array de bytes, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter XLT em matriz de bytes via C#" %}}

{{% blocks/products/pf/agp/text %}}

 É fácil para os desenvolvedores carregar e converter arquivos XLT em matriz de bytes para tarefas de manipulação adicionais em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra XLT para matriz de bytes C# Conversão" offSpacer="" %}}
