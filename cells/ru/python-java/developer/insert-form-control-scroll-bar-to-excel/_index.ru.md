---
title:  Вставьте ScrollBar (элемент управления формой) в Excel, используя Java Python via.
weight: 90
description: Python via Исходный код Java для вставки ScrollBar (элемент управления формой) в Excel.
...
{{% blocks/products/pf/agp/content h2="Как вставить полосу прокрутки (элемент управления формой) в файл Excel с помощью Java Python via" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке ScrollBar (элемент управления формой) в файл Excel с использованием Java Python via" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте коллекцию фигур[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addScrollBar(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить ScrollBar (элемент управления формой) на выбранный лист.
