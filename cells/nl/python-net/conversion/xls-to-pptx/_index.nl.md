...
Het volgende voorbeeld laat zien hoe u XLS converteert naar PPTX in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLS naar PPTX te converteren" %}}
