---
title: Sloučit PRN s TSV – Sloučit PRN s TSV v C++
url: /cs/cpp/merger/merge-prn-to-tsv/ 
description: Aspose Excel. C++ Aspose.Cells. Zdarma online sloučit PRN do formátu uložení TSV. C++ Zkombinujte PRN do formátu TSV. Sloučit PRN na TSV v C++. PRN Sloučit.
...
Následující příklad ukazuje, jak sloučit PRN s TSV v Aspose.Cells for C++.
...
{{% cells-merger title="Online zdarma ke sloučení PRN na TSV v C++" InputFormat="prn" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na TSV přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s TSV programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
