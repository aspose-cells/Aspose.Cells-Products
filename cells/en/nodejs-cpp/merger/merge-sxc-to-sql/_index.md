...
url: /nodejs-cpp/merger/merge-sxc-to-sql/ 
description: Aspose Excel. Node.js Aspose.Cells. Merge SXC to SQL saveformat. Node.js Combine SXC to SQL format. Merge SXC to SQL in Node.js. SXC Merge.
...
The following example demonstrates how to merge SXC to SQL in Aspose.Cells for Node.js via C++.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to merge SXC to SQL. Upload your files, call Workbook.Combine method for merging files, and then save it to SQL file. If you develop code in Node.js, this will be simpler than it sounds. See Node.js example that merges SXC to SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Sample Code to Merge SXC to SQL in Node.js" InputFormat="sxc" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="nodejscpp" %}}

{{% blocks/products/pf/agp/content h2="How to Merge SXC to SQL via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

Need to merge SXC to SQL programmatically? A basic document merging and concatenating with [Aspose.Cells for Node.js via C++](https://products.aspose.com/cells/nodejs-cpp) APIs can be done with just few lines of code.
...
{{% blocks/products/pf/agp/content h2="Node.js via C++ library to merge SXC to SQL" %}}
