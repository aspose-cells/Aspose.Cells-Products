...
url: /ja/net/merger/merge-html-to-fods/ 
...
次の例は、HTML を Aspose.Cells for .NET の FODS にマージする方法を示しています。
...
HTML をプログラムで FODS にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2=".NET HTML を FODS にマージするライブラリ" %}}
