---
title:  Inserte etiqueta (control de formulario) en Excel usando Python via java
weight: 80
description: Python via código fuente de Java para insertar etiqueta (control de formulario) en Excel.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar una etiqueta (control de formulario) en un archivo de Excel usando Python via java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa la colección de formas[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLabel(int,%20int,%20int,%20int,%20int,%20int)) para insertar una etiqueta (control de formulario) en la hoja de trabajo seleccionada.
