...
description: Aspose Excel. Převeďte MHTML na XPS rychle a snadno pomocí Aspose.Cells. Python MHTML na XPS. Python Ušetřete MHTML na 197 3481761 jako 197 348161 Python 481 pomocí Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte MHTML na XPS pomocí Python" %}}

Jak převedu MHTML na XPS? S knihovnou Aspose.Cells for Python můžete snadno převést MHTML na XPS programově pomocí několika řádků kódu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)je schopen vytvářet multiplatformní aplikace se schopností generovat, upravovat, konvertovat, vykreslovat a tisknout všechny soubory aplikace Excel. Python Excel API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat soubory Excel jako obrázky, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT a další, takže je perfektní volbou pro výměnu dokumentů ve standardních průmyslových formátech.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Uložit MHTML až XPS v Python" %}}

Následující příklad ukazuje, jak převést MHTML na XPS v Python.
