---
title: C# CSV 轉 MHT - CSV 轉 MHT 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 CSV 轉換為 MHT。C# CSV 轉換為 MHT。 C# 將 CSV 儲存到 MHT。使用 C# 將 CSV 儲存為 MHT。
...
{{% blocks/products/pf/agp/content h2="將 CSV 儲存到 C# 中的 MHT" %}}

以下範例示範如何將 CSV 轉換為 C# 中的 MHT。
...
{{% cells-convert title="將 CSV 轉換為 MHT 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 CSV 轉換為 MHT" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 CSV 檔案轉換為 MHT？ .NET 開發人員只需幾行程式碼即可輕鬆載入 CSV 並將其轉換為 MHT。
...
1. 使用工作簿實例載入 CSV 檔案。
1. 透過呼叫 Workbook.Save 方法將 CSV 轉換為 MHT。
1. 取得CSV到MHT的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#庫將CSV轉換為MHT" %}}
