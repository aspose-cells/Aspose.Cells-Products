...
{{% blocks/products/pf/agp/content h2="Save EXCEL to SXC in C#" %}}

The following example demonstrates how to convert EXCEL to SXC in C#.
...
{{% cells-convert title="Sample Code to Convert EXCEL to SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert EXCEL to SXC via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert EXCEL files to SXC programmatically? .NET developers can easily load & convert EXCEL to SXC in just a few lines of code.
...
1.  Convert EXCEL to SXC by calling Workbook.Save method.
1.  Get the conversion result of EXCEL to SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# library to convert EXCEL to SXC" %}}
