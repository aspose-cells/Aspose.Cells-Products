---
title: Java PNG إلى MHTML - عبر الإنترنت من PNG إلى MHTML
description: Aspose إكسل. Java Aspose.Cells. Java Aspose Cells. مجاني على الإنترنت Java تحويل PNG إلى MHTML saveformat. Java PNG إلى تنسيق MHTML. وفر PNG إلى MHTML Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل PNG إلى MHTML في Java" h2="مكتبة Java عالية السرعة لتحويل PNG إلى MHTML. هذا حل برمجي احترافي لاستيراد وتصدير PNG و MHTML والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="وفر PNG إلى MHTML في Java عبر الإنترنت مجانًا" %}}
...
تحتاج إلى تحويل PNG ملفات إلى MHTML برمجيا؟ يمكن للمطورين Java تحويل PNG إلى MHTML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول PNG إلى MHTML باستدعاء طريقة Workbook.save.
