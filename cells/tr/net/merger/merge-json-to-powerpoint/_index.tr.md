---
title:  JSON'i C# aracılığıyla POWERPOINT ile birleştirin
url: /tr/net/merger/merge-json-to-powerpoint/ 
description: JSON numaralı telefonu POWERPOINT Online ile Ücretsiz olarak birleştirin. Ücretsiz Online JSON'den POWERPOINT'e Birleşme. JSON'i Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS ve daha fazlasıyla birleştirin.
---
...
Aşağıdaki örnek, JSON'in C#'de POWERPOINT ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="JSON\'i hatta POWERPOINT ile birleştirmek için Ücretsiz Uygulama" InputFormat="json" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
