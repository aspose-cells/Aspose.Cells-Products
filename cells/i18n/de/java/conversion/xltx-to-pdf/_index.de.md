---
title: Konvertieren Sie XLTX in PDF über Java 
weight: 8110
url: /de/java/conversion/xltx-to-pdf/ 
description: Beispiel-Umwandlungscode Java für das XLTX-Format in eine PDF-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in PDF innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLTX in PDF über Java" h2="XLTX-zu-PDF-Java-Konvertierung zum Konvertieren einzelner oder mehrerer Seiten in PDF mithilfe der lokalen Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLTX in PDF mit Java" %}}

 Um XLTX in PDF zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von XLTX in PDF über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können XLTX-Dateien in nur wenigen Codezeilen ganz einfach in PDF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. XLTX-Datei mit einer Instanz der Workbook-Klasse laden1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit PDF-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende PDF-Datei
...
{{% blocks/products/pf/agp/code-block title="XLTX-zu-PDF-Java-Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die XLTX-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.xltx");
// XLTX als PDF speichern
