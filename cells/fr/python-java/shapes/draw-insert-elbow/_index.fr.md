---
title: Comment dessiner ou insérer une forme de coude dans Excel en utilisant Python via Java
weight: 10
description: Dessinez ou insérez une forme de coude en utilisant Aspose.Cells' Python via Java API sans aucun logiciel tel que Microsoft ou Open Office, Adobe PDF, etc.
keywords: [Python Aspose.Cells., Python add elbow shape., Python insert elbow shape., Python create elbow shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérez la forme du coude dans Excel en utilisant Python via Java" h2="Insérez la forme du coude en utilisant Aspose.Cells\' API sans aucun logiciel comme Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment insérer la forme du coude dans un fichier Excel à l\'aide de Python via Java" %}}

 Afin d'insérer la forme du coude dans un fichier Excel, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer la forme du coude dans un fichier Excel à l\'aide du Python via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) pour insérer une forme de coude dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insert forme coude - Python via Java" offSpacer="" %}}
