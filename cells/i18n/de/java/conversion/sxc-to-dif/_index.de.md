---
title: Konvertieren Sie SXC in DIF über Java 
url: /de/java/conversion/sxc-to-dif/ 
description: Beispiel-Umwandlungscode Java für das SXC-Format in eine DIF-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in DIF innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie SXC in DIF über Java" h2="SXC-zu-DIF-Java-Konvertierung zum Konvertieren einzelner oder mehrerer Seiten in DIF mithilfe der On-Premise-Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SXC in DIF mit Java" %}}

 Um SXC in DIF zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von SXC in DIF über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können SXC-Dateien in nur wenigen Codezeilen problemlos in DIF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die SXC-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit DIF-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende DIF-Datei
...
{{% blocks/products/pf/agp/code-block title="SXC-zu-DIF-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die SXC-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.sxc");
// SXC als DIF speichern
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC-zu-DIF-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie SXC in DIF](https://products.aspose.app/cells/conversion/sxc-to-dif) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre SXC-Datei hoch, sie wird sofort in DIF konvertiert." >}}
