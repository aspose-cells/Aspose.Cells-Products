---
title: تحويل XLSX إلى TABDELIMITED عبر تطبيق C++ 
url: /ar/cpp/conversion/xlsx-to-tabdelimited/ 
description: نموذج رمز تحويل C++ لمستند XLSX إلى تنسيق TABDELIMITED. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLSX دفعة واحدة إلى TABDELIMITED داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLSX إلى TABDELIMITED عبر C++" h2="تحويل XLSX عالي الأداء إلى TABDELIMITED باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ تحويل ملف XLSX بسهولة إلى TABDELIMITED في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLSX باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (TABDELIMITED).1. سيتم حفظ ملف TABDELIMITED في المسار المحدد.1. افتح ملف TABDELIMITED في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLSX إلى TABDELIMITED C++ رمز مصدر التحويل" offSpacer="" %}}
