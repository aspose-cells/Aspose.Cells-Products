...
description: Aspose Excel. C# Aspose.Cells. Voeg XLS samen naar MHT-opslagformaat. C# Combineer XLS naar MHT-formaat. Voeg XLS samen met MHT in C#. XLS Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLS samen met MHT in C#" %}}

Het volgende voorbeeld laat zien hoe u XLS samenvoegt met MHT in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLS samen te voegen met MHT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een MHT-bestand. Als u code ontwikkelt in C#, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld C# waarin XLS wordt samengevoegd met MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLS samen te voegen met MHT in C#" InputFormat="xls" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLS samenvoegt met MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLS programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
