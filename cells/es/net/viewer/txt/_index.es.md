...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para ver TXT a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells facilita a los desarrolladores la visualización del archivo TXT con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo TXT en una instancia de Workbook1. Cree una instancia de HtmlSaveOptions y establezca la propiedad ExportHeadings en verdadero1. Guarde el archivo TXT en formato HTML utilizando el método Workbook.Save1. Cargue el HTML resultante en el navegador predeterminado con Process.Start
...
// guardar el archivo TXT en formato HTML
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API se puede usar para crear, editar, convertir y representar formatos de Microsoft Excel en diferentes formatos. Además, se puede usar para gráficos completos, informes escalables y cálculos confiables dentro de las aplicaciones de software. Aspose.Cells es un API independiente y no requiere ningún software como Microsoft u OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para ver TXT" sectionDescription="Consulte nuestras demostraciones en vivo para [Ver texto](https://products.aspose.app/cells/viewer/txt) con los siguientes beneficios." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Descargue el archivo TXT del enlace, si es necesario" >}}
