...
{{% blocks/products/pf/agp/content h2="Javaを使用してXLSをMDに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してXLSをMDに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでXLSファイルをMDに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookクラスのインスタンスを含むXLSファイルをロードします1. Workbook.saveメソッドを呼び出す1. MD拡張子とSaveFormatをパラメーターとして使用して出力パスを渡します1. 結果のMDファイルの指定されたパスを確認します
...
{{% blocks/products/pf/agp/code-block title="XLSからMDJavaへの変換ソースコード" offSpacer="" %}}
