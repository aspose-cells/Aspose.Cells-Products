...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar MARKDOWN via PHP?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je OTS-bestanden programmatisch converteren naar MARKDOWN? PHP-ontwikkelaars kunnen OTS-bestanden eenvoudig laden en converteren naar MARKDOWN met slechts een paar regels code.
...
1.  Converteer OTS naar MARKDOWN door de save-methode van Workbook aan te roepen.
