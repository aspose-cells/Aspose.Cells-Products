---
title: Java XML vers PDF - Convertisseur XML vers PDF
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le XML au format PDF, permettant un enregistrement transparent des données XML au format PDF à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XML sous PDF dans Java" %}}

L'exemple suivant montre comment convertir du XML en PDF en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XML en PDF. Téléchargez votre fichier XML, puis enregistrez-le simplement sous le nom de fichier PDF. Pour la lecture XML et l'écriture PDF, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie PDF seront identiques au document XML d'origine.
...
{{% blocks/products/pf/agp/content h2="Comment convertir du XML en PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML au format PDF par programmation ? Les développeurs Java peuvent facilement convertir un fichier XML au format PDF en quelques lignes de code seulement.
...
1.  Convertissez XML en PDF en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de XML en PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir XML en PDF" %}}
{{% blocks/products/pf/agp/text %}}
