---
title: دمج EXCEL في XLTM - ادمج EXCEL في XLTM في C#
url: /ar/net/merger/merge-excel-to-xltm/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني عبر الإنترنت EXCEL إلى تنسيق حفظ XLTM. C# ادمج EXCEL بتنسيق XLTM. دمج EXCEL في XLTM في C#. EXCEL Merge.
...
{{% blocks/products/pf/agp/content h2="قم بدمج EXCEL في XLTM في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج EXCEL مع XLTM في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج EXCEL في XLTM. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف XLTM. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج EXCEL مع XLTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج EXCEL في XLTM في C#" InputFormat="xlsx" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج EXCEL في XLTM عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج EXCEL مع XLTM برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
