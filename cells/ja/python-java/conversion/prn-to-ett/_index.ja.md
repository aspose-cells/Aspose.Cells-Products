---
title: Python PRN から ETT - PRN から ETT コンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、PRN を ETT にすばやく簡単に変換します。 Python PRN を ETT に変換します。 Python PRN を ETT に保存します。 Python を使用して PRN を ETT として保存します。
...
{{% blocks/products/pf/agp/content h2="PRN を Python の ETT に保存" %}}
...
{{% cells-convert title="PRN を ETT に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="ett" IsLandingPage="true" language="pythonjava" %}}
