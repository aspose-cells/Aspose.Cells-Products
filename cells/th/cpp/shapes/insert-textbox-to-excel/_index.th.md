---
title:  ใส่กล่องข้อความใน Excel ผ่านทาง C++
weight: 60
description: โค้ดตัวอย่าง C++ เพื่อแทรกกล่องข้อความในไฟล์ Excel บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
keywords: [C++ Aspose.Cells., C++ add TextBox., C++ insert TextBox., C++ create TextBox]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ใส่กล่องข้อความใน Excel ผ่านทาง C++" h2="แทรกออบเจ็กต์โดยใช้เนทีฟและประสิทธิภาพสูงของฝั่งเซิร์ฟเวอร์ Aspose.Cells for C++ API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกกล่องข้อความลงในไฟล์ Excel โดยใช้ C++" %}}

 ในการแทรกกล่องข้อความลงในไฟล์ Excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก TextBox ลงในไฟล์ Excel ผ่านทาง C++" %}}

+ การสร้างอินสแตนซ์ของวัตถุสมุดงาน (หรือ->โหลดไฟล์ XLSX ด้วยเส้นทางแบบเต็ม)
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addtextbox/) เพื่อแทรกรูปร่างสมการลงในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่กล่องข้อความ - C++" offSpacer="" %}}
