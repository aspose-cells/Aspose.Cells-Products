...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in XLSB in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar XLSB in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar XLSB of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar XLSB? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar XLSB met slechts een paar regels code.
