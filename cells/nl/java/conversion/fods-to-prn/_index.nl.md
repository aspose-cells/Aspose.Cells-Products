...
{{% blocks/products/pf/agp/content h2="Sla FODS op als PRN in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar PRN in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar PRN via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u FODS-bestanden programmatisch naar PRN converteren? Ontwikkelaars van Java kunnen FODS-bestanden eenvoudig in een paar regels code naar PRN converteren.
