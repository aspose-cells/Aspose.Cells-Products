---
title: Voeg HTML samen met PRN - Combineer HTML met PRN in C++
url: /nl/cpp/merger/merge-html-to-prn/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online samenvoegen HTML naar PRN-opslagformaat. C++ Combineer HTML naar PRN-formaat. Samenvoegen HTML naar PRN in C++. HTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis HTML samen met PRN in C++ online" %}}

Het volgende voorbeeld laat zien hoe u HTML kunt samenvoegen met PRN in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTML samen te voegen met PRN. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het PRN-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat HTML samenvoegt met PRN.
...
{{% blocks/products/pf/agp/content h2="Hoe HTML samen te voegen met PRN via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u HTML programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om HTML samen te voegen met PRN" %}}
