...
{{% blocks/products/pf/agp/content h2="Cách chuyển MHTML thành MARKDOWN bằng cách sử dụng Java" %}}

 Để hiển thị MHTML thành MARKDOWN, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi MHTML thành MARKDOWN qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp MHTML thành MARKDOWN chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp MHTML với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Chuyển đường dẫn đầu ra với phần mở rộng MARKDOWN & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp MARKDOWN kết quả
...
{{% blocks/products/pf/agp/code-block title="MHTML thành MARKDOWN Java Mã nguồn Chuyển đổi" offSpacer="" %}}

```cs
// tải tệp MHTML trong một phiên bản của Workbook
Workbook book = new Workbook("template.mhtml");
// lưu MHTML dưới dạng MARKDOWN
...
{{< blocks/products/pf/agp/demobox sectionTitle="MHTML thành MARKDOWN Bản trình diễn Trực tiếp Chuyển đổi" sectionDescription="[Chuyển MHTML thành MARKDOWN](https://products.aspose.app/cells/conversion/mhtml-to-markdown) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp MHTML của bạn, tệp sẽ được chuyển đổi ngay lập tức thành MARKDOWN." >}}
