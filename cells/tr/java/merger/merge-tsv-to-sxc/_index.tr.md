...
description: Aspose Excel'de. Java Aspose.Cells. TSV'i SXC kaydetme biçimiyle birleştirin. Java TSV'i SXC biçimiyle birleştirin. Java'de TSV'i SXC ile birleştirin. TSV Birleştir.
...
{{% blocks/products/pf/agp/content h2="TSV\'i Java\'de SXC ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de TSV ile SXC'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TSV ile SXC'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından SXC dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TSV ile SXC'i birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TSV ile SXC\'i Java\'de Birleştirmek için Örnek Kod" InputFormat="tsv" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TSV ile SXC via Java Nasıl Birleştirilir?" %}}

{{% blocks/products/pf/agp/text %}}

 TSV ile SXC'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, TSV ile SXC arasında birleştirilecek" %}}
