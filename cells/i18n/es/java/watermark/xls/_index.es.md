...
{{% blocks/products/pf/agp/content h2="Cómo poner una marca de agua en un archivo XLS usando Java" %}}

 Para agregar una marca de agua al archivo XLS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar una marca de agua a XLS a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Crear un nuevo objeto de libro de trabajo1. Seleccione la hoja de trabajo a través de su índice1. Cree una forma y use su función addTextEffect1. Establecer colores, Transparencia y más1. Guardar libro de trabajo en formato XLS
