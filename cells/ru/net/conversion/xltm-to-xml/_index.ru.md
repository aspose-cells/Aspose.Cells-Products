...
{{% blocks/products/pf/agp/content h2="Преобразовать XLTM в XML, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в XML в C#" %}}

Следующий пример демонстрирует, как преобразовать XLTM в XML в C#.
