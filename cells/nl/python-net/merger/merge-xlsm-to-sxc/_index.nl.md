...
url: /nl/python-net/merger/merge-xlsm-to-sxc/ 
...
Het volgende voorbeeld laat zien hoe u XLSM kunt samenvoegen met SXC in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLSM programmatisch samenvoegen tot SXC? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
