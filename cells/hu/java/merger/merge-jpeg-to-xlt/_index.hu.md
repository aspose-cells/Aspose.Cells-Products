---
title: A JPEG-XLT-es számok egyesítése – a JPEG-es és a XLT-es számok egyesítése a Java-ben
url: /hu/java/merger/merge-jpeg-to-xlt/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés JPEG XLT mentési formátumba. Java A JPEG és a XLT formátum kombinálása. Egyesítse a JPEG-XLT-et a Java-ben. JPEG Egyesítse.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a JPEG-es számokat a XLT-es számokhoz a Java-ben online ingyen" %}}

A következő példa bemutatja a JPEG és a XLT egyesítését a Aspose.Cells for Java számban.
...
{{% cells-merger title="Ingyenes online a JPEG-XLT-es számok egyesítéséhez a Java-ben" InputFormat="jpg" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A JPEG és a XLT via Java számok egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a JPEG-et a XLT-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a JPEG és XLT egyesítéséhez" %}}
