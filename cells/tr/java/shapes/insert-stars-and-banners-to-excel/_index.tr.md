---
title:  Excel'e Yıldız ve Afiş Ekleme via .NET
weight: 381
...
{{< blocks/products/pf/i18n/upper-banner h1="Excel\'e Yıldız ve Afiş Ekleme via Java" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım olmadan sunucu tarafı API\'lerini kullanarak nesneler ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak Excel Dosyasına Yıldız ve Afiş Ekleme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Excel dosyasına Yıldız ve Afiş Ekleme adımları via Java" %}}
...
+ Dizini aracılığıyla Çalışma Sayfası'nı seçin.
 + Kullanın[yöntem ekle](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)seçilen çalışma sayfasına Yıldız ve Başlık Ekleme eklemek için
...
{{% blocks/products/pf/agp/code-block title="Yıldız ve Afiş Ekleme - Java" offSpacer="" %}}
