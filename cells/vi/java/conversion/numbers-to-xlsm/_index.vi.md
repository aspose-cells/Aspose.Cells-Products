---
title: Chuyển đổi NUMBERS thành XLSM qua Java 
url: /vi/java/conversion/numbers-to-xlsm/ 
description: Mã chuyển đổi Java mẫu cho định dạng NUMBERS thành tệp XLSM. Lập trình viên có thể sử dụng mã mẫu này để xuất bảng tính Excel & OpenOffice sang XLSM trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi NUMBERS thành XLSM qua Java" h2="Chuyển đổi NUMBERS sang XLSM Java để chuyển đổi một hoặc nhiều trang sang XLSM bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi NUMBERS thành XLSM bằng cách sử dụng Java" %}}

 Để hiển thị NUMBERS thành XLSM, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi NUMBERS thành XLSM qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp NUMBERS thành XLSM chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp NUMBERS với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Truyền đường dẫn đầu ra với phần mở rộng XLSM & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp XLSM kết quả
...
{{% blocks/products/pf/agp/code-block title="NUMBERS thành XLSM Java Mã nguồn chuyển đổi" offSpacer="" %}}

```cs
// tải tệp NUMBERS trong một phiên bản của Workbook
Workbook book = new Workbook("template.numbers");
// lưu NUMBERS dưới dạng XLSM
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS bản trình diễn trực tiếp chuyển đổi XLSM" sectionDescription="[Chuyển đổi NUMBERS thành XLSM](https://products.aspose.app/cells/conversion/numbers-to-xlsm) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp NUMBERS của bạn, tệp sẽ được chuyển đổi ngay lập tức thành XLSM." >}}
