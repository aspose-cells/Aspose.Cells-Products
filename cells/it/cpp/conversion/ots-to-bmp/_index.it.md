...
Hai bisogno di convertire i file OTS in BMP tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire OTS in BMP in poche righe di codice.
...
1.  Convertire OTS in BMP chiamando il metodo Save().
