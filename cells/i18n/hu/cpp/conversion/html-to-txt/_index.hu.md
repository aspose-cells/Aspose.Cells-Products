---
title: Konvertálja a HTML-t TXT-re a(z) C++ alkalmazással 
url: /hu/cpp/conversion/html-to-txt/ 
description: Minta C++ konverziós kód HTML-dokumentumhoz TXT formátumba. A programozók ezt a forráskódot használhatják HTML-ből TXT-be kötegelt konvertálásához bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="HTML konvertálása TXT-re a következőn keresztül: C++" h2="Nagy teljesítményű HTML konvertálás TXT-be a C++ könyvtár használatával Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="HTML konvertálása TXT-re a következővel: C++" %}}

 A HTML TXT formátumba konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A HTML konvertálása TXT-re a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatják a HTML-fájlt TXT-formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be HTML-fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (TXT) fájlkiterjesztéssel.1. A TXT fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a TXT fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="HTML-ből TXT-be C++ konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="HTML-ből TXT-be konvertáló élő bemutatók" sectionDescription="[Konvertálja a HTML-t TXT-re](https://products.aspose.app/cells/conversion/html-to-txt) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel HTML-fájlját, és azonnal TXT formátumba konvertálódik." >}}
