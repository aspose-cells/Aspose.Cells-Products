---
title: Połącz XLTX z CSV - Połącz XLTX z CSV w C#
url: /pl/net/merger/merge-xltx-to-csv/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLTX do CSV w formacie zapisu. C# Połącz format XLTX z CSV. Połącz XLTX z CSV w C#. XLTX Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTX z CSV w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLTX z CSV w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLTX z CSV. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku CSV. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy numery XLTX z CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTX z CSV w C#" InputFormat="xltx" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTX z CSV za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLTX z CSV programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
