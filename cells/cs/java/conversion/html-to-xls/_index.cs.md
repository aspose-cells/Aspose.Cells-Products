---
title: Převést HTML na XLS pomocí Java 
weight: 6700

description: Ukázkový konverzní kód Java pro formát HTML na soubor XLS. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLS v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést HTML na XLS pomocí Java" h2="Převod HTML na XLS Java pro převod jedné nebo více stránek na XLS pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na XLS pomocí Java" %}}

 K vykreslení HTML do XLS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu HTML na XLS prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor HTML na XLS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor HTML s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLS a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLS
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze HTML na XLS Java" offSpacer="" %}}

```cs
// načíst soubor HTML v instanci sešitu
Workbook book = new Workbook("template.html");
// uložit HTML jako XLS
