...
{{% blocks/products/pf/agp/content h2="Převeďte XML na GIF pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XML na GIF v Python.
