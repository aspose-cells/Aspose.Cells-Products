---
title: Java MHT en OTS - Convertisseur MHT en OTS
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format MHT au format OTS, permettant un enregistrement transparent des données MHT au format OTS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Sauvegarder MHT vers OTS dans Java" %}}

L'exemple suivant montre comment convertir MHT en OTS dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir un MHT en OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en OTS par programmation ? Les développeurs de Java peuvent facilement convertir des fichiers MHT en OTS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir MHT en OTS" %}}
{{% blocks/products/pf/agp/text %}}
