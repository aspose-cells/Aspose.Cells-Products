...
description: Aspose Excel. 이 포괄적인 솔루션은 C# 개발자에게 Excel을 SPREADSHEETML 형식으로 변환하는 완벽하게 통합된 접근 방식을 제공하여 Aspose.Cells 라이브러리를 사용하여 Excel 데이터를 SPREADSHEETML 형식으로 원활하게 저장할 수 있도록 하며, 이 모든 작업은 효율적이고 사용자 정의 가능한 C# 코드를 통해 이루어집니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 EXCEL을 SPREADSHEETML로 변환" h2="엑셀 파일을 SPREADSHEETML로 고속 변환하는 C# 라이브러리입니다. 이 전문 소프트웨어 솔루션은 .NET 프레임워크, .NET 코어 또는 Mono 플랫폼에서 엑셀, SPREADSHEETML 및 기타 여러 형식을 가져오고 내보낼 수 있습니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% blocks/products/pf/agp/content h2="C#에 EXCEL 파일을 SPREADSHEETML 형식으로 저장하세요." %}}

다음 예시는 C#에서 EXCEL을 SPREADSHEETML로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="Excel 파일을 SPREADSHEETML 파일로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="xml" IsLandingPage="true" %}}
...
1.  Workbook.Save 메서드를 호출하여 Excel 파일을 SPREADSHEETML 형식으로 변환합니다.
1.  EXCEL에서 SPREADSHEETML로의 변환 결과를 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 라이브러리는 EXCEL을 SPREADSHEETML로 변환합니다." %}}
