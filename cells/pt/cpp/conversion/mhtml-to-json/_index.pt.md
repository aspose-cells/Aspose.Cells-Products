...
description: Aspose Excel. Converta MHTML em JSON de forma rápida e fácil com Aspose.Cells. C++ MHTML em JSON. C++ Salve MHTML em JSON. Salve MHTML como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta MHTML em JSON usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve MHTML para JSON em C++" %}}

O exemplo a seguir demonstra como converter MHTML em JSON em C++.
...
{{% cells-convert title="Exemplo de código para converter MHTML em JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="json" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter MHTML em JSON por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos MHTML em JSON programaticamente? Os desenvolvedores do C++ podem converter facilmente MHTML em JSON em apenas algumas linhas de código.
...
1.  Converta MHTML em JSON chamando o método Save().
