...
url: /cs/cpp/merger/merge-excel-to-ots/ 
...
Následující příklad ukazuje, jak sloučit EXCEL s OTS v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit EXCEL s OTS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení EXCELu s OTS" %}}
