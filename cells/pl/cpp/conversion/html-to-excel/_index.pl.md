...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj HTML do formatu EXCEL w C++" h2="Wysokowydajna konwersja z formatu HTML do EXCEL przy użyciu biblioteki C++ bez konieczności instalacji pakietu Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Trzeba programowo przekonwertować pliki HTML do formatu EXCEL? Programiści C++ mogą łatwo przekonwertować pliki HTML do formatu EXCEL za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj HTML do formatu EXCEL, wywołując metodę Save().
