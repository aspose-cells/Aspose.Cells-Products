---
title: A JPEG-XLT-es számok egyesítése – a JPEG-es és a XLT-es számok egyesítése a Python-ben
url: /hu/python-java/merger/merge-jpeg-to-xlt/ 
description: Aspose Excel. Python Aspose.Cells. A JPEG és a XLT mentési formátum egyesítése. Python A JPEG és a XLT formátum kombinálása. Egyesítse a JPEG-XLT-et a Python-ben. JPEG Egyesítse.
...
{{% cells-merger title="Mintakód a JPEG és XLT közötti egyesítéshez a Python-ben" InputFormat="jpg" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="A JPEG és a XLT egyesítése a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a JPEG-et a XLT-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Python könyvtár a JPEG és XLT egyesítéséhez" %}}
