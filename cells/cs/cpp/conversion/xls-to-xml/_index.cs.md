...
description: Aspose Excel. Převeďte XLS na XML rychle a snadno pomocí Aspose.Cells. C++ XLS do XML. C++ Uložit XLS do XML. Uložte XLS jako XML pomocí C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte XLS na XML v C++" h2="Vysoce výkonný převod XLS do XML pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte XLS na XML pomocí C++" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte XLS do XML v C++" %}}

Následující příklad ukazuje, jak převést XLS na XML v C++.
...
{{% cells-convert title="Ukázkový kód pro převod XLS na XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLS na XML přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XLS soubory do XML programově? C++ vývojáři mohou snadno převést XLS do XML pomocí několika řádků kódu.
...
1.  Převeďte XLS na XML voláním metody Save().
