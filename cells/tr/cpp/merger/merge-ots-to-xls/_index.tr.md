...
Aşağıdaki örnekte OTS'nin Aspose.Cells for C++'deki XLS ile nasıl birleştirileceği gösterilmektedir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 OTS'yi programlı olarak XLS ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
