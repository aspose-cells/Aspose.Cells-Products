...
Hai bisogno di convertire i file MHT in PDF a livello di programmazione? Gli sviluppatori C++ possono facilmente convertire MHT in PDF in poche righe di codice.
...
1.  Converti MHT in PDF chiamando il metodo Save().
