...
هل تحتاج إلى تحويل ملفات NUMBERS إلى JPEG برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل الأرقام إلى JPEG في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الأرقام إلى JPEG باستدعاء طريقة Save ().
