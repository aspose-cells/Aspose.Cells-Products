...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg XLSX-formaten samen in C#" h2="Native en krachtige XLSX-documentfusie met behulp van server-side Aspose.Cells for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Laad alle XLSX-bestanden met volledig pad.
...
+ Roep de Save()-methode aan en geef de bestandsnaam (volledig pad) en formaat (XLSX) door als parameter.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online XLSX Live-demo\'s van fusie" sectionDescription=" Voeg nu XLSX-documenten samen door naar onze[Live demo-website](https://products.aspose.app/cells/merger). De live demo heeft de volgende voordelen" >}}
