---
title: Python ODS hingga JPEG - ODS hingga JPEG Konverter
description: Aspose Unggul. Python Unggul. Ubah ODS menjadi JPEG dengan cepat dan mudah dengan Aspose.Cells. Python ODS menjadi JPEG. Python Simpan ODS menjadi JPEG. Simpan ODS sebagai 076112 3481 menggunakan Perpustakaan Excel Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ODS menjadi JPEG di Perpustakaan Excel Python" h2="Pustaka excel Python berkecepatan tinggi untuk mengonversi ODS menjadi JPEG. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, JPEG, dan banyak format lainnya menggunakan Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Ubah ODS menjadi JPEG Menggunakan Perpustakaan Excel Python" %}}

 Bagaimana cara mengubah ODS menjadi JPEG? Dengan pustaka Aspose.Cells for Python, Anda dapat dengan mudah mengonversi ODS menjadi JPEG secara terprogram dengan beberapa baris kode.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)mampu membangun aplikasi lintas platform dengan kemampuan untuk menghasilkan, memodifikasi, mengkonversi, merender dan mencetak semua file Excel. Python Excel API tidak hanya mengkonversi antar format spreadsheet, tetapi juga dapat merender file Excel sebagai gambar, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT dan banyak lagi, sehingga menjadikannya pilihan sempurna untuk bertukar dokumen dalam format standar industri.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Simpan ODS hingga JPEG di Perpustakaan Excel Python" %}}

Contoh berikut menunjukkan cara mengonversi ODS menjadi JPEG di perpustakaan excel Python.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi ODS menjadi JPEG. Unggah file ODS Anda, lalu simpan sebagai file JPEG. Untuk pembacaan ODS dan penulisan JPEG Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran JPEG akan sama dengan dokumen ODS asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi ODS menjadi JPEG melalui Perpustakaan Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="jpg" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah ODS menjadi JPEG melalui Python" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file ODS ke JPEG secara terprogram? Pengembang Python dapat dengan mudah memuat & mengonversi ODS menjadi JPEG hanya dalam beberapa baris kode.
...
1.  Ubah ODS menjadi JPEG dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari ODS menjadi JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Perpustakaan Excel untuk Mengonversi ODS menjadi JPEG" %}}
