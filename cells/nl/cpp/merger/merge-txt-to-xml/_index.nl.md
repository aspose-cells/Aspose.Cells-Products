...
Het volgende voorbeeld laat zien hoe u TXT kunt samenvoegen met XML in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u TXT programmatisch samenvoegen met XML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
