---
title: Konversikan FODS ke XLSB melalui Java 
url: /id/java/conversion/fods-to-xlsb/ 
description: Contoh Java kode konversi untuk format FODS ke file XLSB. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke XLSB dalam Aplikasi berbasis Java Web atau Desktop apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan FODS ke XLSB melalui Java" h2="Konversi FODS ke XLSB Java untuk mengonversi satu atau beberapa halaman ke XLSB menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi FODS ke XLSB Menggunakan Java" %}}

 Untuk merender FODS ke XLSB, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi FODS ke XLSB melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file FODS ke XLSB hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file FODS dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi XLSB & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file XLSB yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="FODS ke XLSB Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file FODS dalam contoh Workbook
Workbook book = new Workbook("template.fods");
// simpan FODS sebagai XLSB
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi FODS ke XLSB" sectionDescription="[Mengkonversi FODS ke XLSB](https://products.aspose.app/cells/conversion/fods-to-xlsb) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file FODS Anda, itu akan langsung dikonversi ke XLSB." >}}
