---
title: Sloučit JSON s IMAGE – Sloučit JSON s IMAGE v C#
url: /cs/net/merger/merge-json-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Zdarma online sloučení JSON do formátu uložení OBRÁZKU. C# Zkombinujte JSON do formátu IMAGE. Sloučit JSON do IMAGE v C#. JSON Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JSON s IMAGE v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JSON do IMAGE v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JSON s IMAGE. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru IMAGE. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí JSON do IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JSON do IMAGE v C#" InputFormat="json" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON s IMAGE přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit JSON s IMAGE programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna ke sloučení JSON do IMAGE" %}}
