...
description: Convert HTML to ODS format in C# code. Save HTML as ODS using VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="Save HTML to ODS in C# Online for Free" %}}

The following example demonstrates how to convert HTML to ODS document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert HTML file into ODS format. Upload your HTML file, then simply save it as ODS file. For both HTML reading and ODS writing you can use fully qualified filenames. The output ODS content and formatting will be identical to the original HTML document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert HTML to ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert HTML to ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert HTML files to ODS in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert HTML to ODS" %}}
