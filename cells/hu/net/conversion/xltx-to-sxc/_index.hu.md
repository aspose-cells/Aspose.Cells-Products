...
description: Aspose Excel. A XLTX-es számot SXC-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# XLTX-SXC-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTX-SXC számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a XLTX-et SXC-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a XLTX SXC-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTX konvertálása SXC-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLTX fájlt programozottan SXC-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a XLTX-et SXC-re.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX konvertálásához SXC-re" %}}
