---
title: วิธีวาดหรือแทรกรูปศอกลูกศรคู่ใน Excel โดยใช้ Python via Java
weight: 10
description: วาดหรือใส่ข้อศอกรูปลูกศรคู่โดยใช้ Aspose.Cells' Python via Java API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF เป็นต้น
...
{{< blocks/products/pf/i18n/upper-banner h1="แทรกรูปลูกศรคู่ข้อศอกลงใน Excel โดยใช้ Python via Java" h2="ใส่ข้อศอกลูกศรคู่โดยใช้ Aspose.Cells\' API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF เป็นต้น" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกรูปลูกศรคู่ข้อศอกลงในไฟล์ Excel โดยใช้ Python via Java" %}}
 ...
 เราจะใช้รูปลูกศรคู่ข้อศอกลงในไฟล์ Excel
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกรูปลูกศรคู่ข้อศอกลงในไฟล์ Excel โดยใช้ Python via Java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้รูปทรงของคอลเลกชัน[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกรูปร่างลูกศรคู่ข้อศอกในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่ศอกทรงลูกศรคู่ - Python via Java" offSpacer="" %}}
