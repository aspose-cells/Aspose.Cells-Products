...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells permet aux développeurs d'afficher facilement le fichier TXT avec seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier TXT dans une instance de Workbook1. Créez une instance de HtmlSaveOptions et définissez la propriété ExportHeadings sur true1. Enregistrez le fichier TXT au format HTML à l'aide de la méthode Workbook.Save1. Charger le HTML résultant dans le navigateur par défaut avec Process.Start
...
// enregistrer le fichier TXT au format HTML
