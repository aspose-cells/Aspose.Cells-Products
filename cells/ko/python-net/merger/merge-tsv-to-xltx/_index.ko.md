---
title: TSV을 XLTX로 병합 - TSV을 Python에서 XLTX로 결합
url: /ko/python-net/merger/merge-tsv-to-xltx/ 
description: Aspose 엑셀. Python Aspose.Cells. 무료 온라인 병합 TSV에서 XLTX 저장 형식으로. Python TSV을 XLTX 형식으로 결합합니다. TSV을 Python에서 XLTX로 병합합니다. TSV 병합합니다.
...
다음 예는 Aspose.Cells for Python via .NET에서 TSV을 XLTX로 병합하는 방법을 보여줍니다.
...
{{% cells-merger title="Python에서 TSV을 XLTX로 병합하는 무료 온라인" InputFormat="tsv" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Python을 통해 TSV을 XLTX로 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 프로그래밍 방식으로 TSV을 XLTX에 병합해야 합니까? 병합 및 연결하는 기본 문서[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) 몇 줄의 코드만으로 API를 수행할 수 있습니다.
