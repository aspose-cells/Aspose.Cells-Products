...
description: Aspose Эксель. Преобразуйте XLAM в ODS быстро и легко с помощью Aspose.Cells. C++ XLAM в ODS. C++ Сохранить XLAM в ODS. Сохранить XLAM как 07611134 81, используя C++.
...
{{% blocks/products/pf/agp/content h2="Сохраните с XLAM по ODS в C++." %}}
...
{{% cells-convert title="Пример кода для преобразования XLAM в ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="ods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как преобразовать XLAM в ODS через C++" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы XLAM в ODS? Разработчики C++ могут легко преобразовать XLAM в ODS всего за несколько строк кода.
...
1.  Преобразуйте XLAM в ODS, вызвав метод Save().
