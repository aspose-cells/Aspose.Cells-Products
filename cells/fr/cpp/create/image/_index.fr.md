---
title: Créer IMAGE - Créer un fichier IMAGE au C++
description: Aspose Excel. C++ Créer un fichier IMAGE. Créer IMAGE C++. C++ IMAGE Creator. Créez IMAGE en C++. Générez un fichier IMAGE en utilisant C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier IMAGE dans C++" h2="Création de fichiers IMAGE natifs et hautes performances par programmation sans Micorsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer une image dans C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers IMAGE dans des applications de création de rapports en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier IMAGE dans C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour créer un fichier IMAGE" %}}
