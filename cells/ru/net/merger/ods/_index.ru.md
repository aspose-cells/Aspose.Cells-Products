---
title:  Объединить ODS Файлы via .NET
weight: 4330
description: Исходный код C# для объединения документов ODS на платформах .NET Framework, .NET Core, Mono или Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Объединить форматы ODS в C#" h2="Нативное и высокопроизводительное объединение документов ODS с использованием серверных API Aspose.Cells for .NET без использования какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
+ Загрузите все файлы ODS с полным путем.
+ Сделать один документ базовым файлом
+ Вызов соответствующего метода для объединения и слияния файлов один за другим.
+ Вызовите метод Save() и передайте имя файла (полный путь) и формат (ODS) в качестве параметра.
+ Теперь вы можете открыть и использовать файл ODS в Office Microsoft, Adobe PDF или любой другой совместимой программе.
...
{{% blocks/products/pf/agp/code-block title="Объединить файлы ODS — C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "d7c757e7471bd38006ac0d35d221b2e2" "merge-ods-files.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{< blocks/products/pf/agp/demobox sectionTitle="Онлайн ODS Слияние живых демонстраций" sectionDescription=" Объедините документы ODS прямо сейчас, посетив наш[Веб-сайт живых демонстраций](https://products.aspose.app/cells/merger). Живая демонстрация имеет следующие преимущества" >}}
