...
{{% blocks/products/pf/agp/content h2="Sla TXT op in TIFF in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar TIFF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar TIFF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar TIFF? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar TIFF met slechts een paar regels code.
