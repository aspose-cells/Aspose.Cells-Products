---
title: Konwertuj XLSM na XLTM za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlsm-to-xltm/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSM do formatu XLTM. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSM do XLTM w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSM na XLTM przez C++" h2="Wysokowydajna konwersja XLSM do XLTM przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSM na XLTM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLTM).1. Plik XLTM zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLTM w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSM do XLTM C++ Kod źródłowy konwersji" offSpacer="" %}}
