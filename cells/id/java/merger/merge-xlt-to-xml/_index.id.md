...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLT ke format penyimpanan XML. Java Gabungkan XLT ke format XML. Gabungkan XLT ke XML di Java. XLT Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLT ke XML di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLT ke XML di Java" InputFormat="xlt" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLT ke XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan XLT ke XML secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan XLT ke XML" %}}
