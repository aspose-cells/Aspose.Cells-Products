...
Trzeba programowo przekonwertować pliki XLTM na LICZBY? Programiści C++ mogą łatwo przekonwertować XLTM na LICZBY za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLTM na LICZBY wywołując metodę Save().
