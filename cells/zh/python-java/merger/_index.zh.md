...
{{< blocks/products/pf/i18n/upper-banner h1="合并Python中的Excel格式" h2="使用服务器端 Aspose.Cells for Python API 进行本机高性能文档合并，无需使用 Microsoft 或 Open Office、Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="XLSX" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
为了合并 Excel 文件，我们将使用[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)API 这是一个功能丰富、强大且易于使用的文档操作和合并API for Python 平台。
 
您可以安装 Aspose.Cells for Python<a href="https://pypi.org/project/aspose-cells/">pypi</a>，使用命令为：<code>$ pip install aspose-cells</code>.
...
{{% cells-merger title="免费应用程序在线合并 Excel 文件" InputFormat="xlsx" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-java/merger/merge-xlsx-to-xltm/" name="XLTM" description="Excel 宏启用模板" >}}
