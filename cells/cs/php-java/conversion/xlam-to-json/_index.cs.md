---
title: Konvertor PHP XLAM až JSON - XLAM až JSON
description: Aspose Excel. Převeďte XLAM na JSON rychle a snadno pomocí Aspose.Cells. PHP XLAM na JSON. PHP Uložte XLAM na JSON. Uložte JSON jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="json" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na JSON přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na JSON programově? Vývojáři PHP mohou snadno načíst a převést XLAM na JSON v několika řádcích kódu.
...
1.  Převeďte XLAM na JSON voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na JSON" %}}
