...
url: /cs/cpp/merger/merge-htm-to-txt/ 
...
Následující příklad ukazuje, jak sloučit HTM s TXT v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení HTM s TXT v C++" InputFormat="htm" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM na TXT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit HTM na TXT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení HTM s TXT" %}}
