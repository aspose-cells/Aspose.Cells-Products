---
title: C# ओटीएस से DIF - ओटीएस से DIF कन्वर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ OTS को DIF में जल्दी और आसानी से बदलें। C# OTS को DIF पर बदलें। C# OTS को DIF पर सहेजें। C# का उपयोग करके OTS को DIF के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="OTS को C# में DIF पर सेव करें" %}}
...
{{% cells-convert title="ओटीएस को DIF में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="dif" IsLandingPage="true" %}}
