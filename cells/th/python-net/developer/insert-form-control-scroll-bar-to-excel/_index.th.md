---
title:  แทรก ScrollBar(การควบคุมฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 90
description: Python via .Net ซอร์สโค้ดเพื่อแทรก ScrollBar(Form control) ลงใน Excel
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ Shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_scroll_bar/#int-int-int-int-int-int) เพื่อแทรก ScrollBar (ตัวควบคุมฟอร์ม) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก ScrollBar(การควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
