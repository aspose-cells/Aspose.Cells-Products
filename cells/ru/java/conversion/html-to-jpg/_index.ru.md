...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в JPG, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTML в формате JPG в Java" %}}

Следующий пример демонстрирует, как преобразовать HTML в JPG в файле Java.
...
Нужно программно преобразовать файлы HTML в JPG? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в JPG всего несколькими строками кода.
