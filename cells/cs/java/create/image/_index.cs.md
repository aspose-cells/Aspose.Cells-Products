...
{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor IMAGE v Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java pro vytvoření souboru IMAGE" %}}
{{% blocks/products/pf/agp/text %}}
