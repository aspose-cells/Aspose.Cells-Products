---
title: Java MHT en SXC - Convertisseur MHT en SXC
description: Aspose Exceller. Convertissez MHT en SXC rapidement et facilement avec Aspose.Cells. Java MHT en SXC. Java Enregistrez MHT en SXC. Enregistrez MHT sous SXC en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer MHT au SXC au Java" %}}

L'exemple suivant montre comment convertir MHT en SXC en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir MHT en SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers MHT en SXC par programme ? Les développeurs Java peuvent facilement convertir MHT en SXC en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir MHT en SXC" %}}
{{% blocks/products/pf/agp/text %}}
