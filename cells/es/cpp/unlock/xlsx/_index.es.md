---
title:  Desbloquee el documento XLSX a través de C++
weight: 3680
description: C++ código de ejemplo para desbloquear el archivo XLSX protegido por contraseña en C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
---
...
1.  Cargue el archivo bloqueado XLSX usando CreateIWorkbook.
1.  Llame a la función Unprotect() para desbloquear.
1.  Establezca la contraseña en NULL usando SetPassword.
1.  Guarde el archivo XLSX en una ubicación específica.
