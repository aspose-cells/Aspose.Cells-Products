---
title: Konwertuj XLTM na XPS za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltm-to-xps/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTM do formatu XPS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTM na XPS w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTM na XPS za pomocą C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować XLTM na XPS za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLTM na XPS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XPS).1. Plik XPS zostanie zapisany pod określoną ścieżką.1. Otwórz plik XPS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLTM do XPS C++ Kod źródłowy konwersji" offSpacer="" %}}
