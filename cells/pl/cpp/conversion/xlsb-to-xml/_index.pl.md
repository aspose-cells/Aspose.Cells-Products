...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLSB do formatu XML, umożliwiając bezproblemowe zapisywanie XLSB danych w formacie XML za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C++.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLSB do XML przy użyciu C++" %}}
...
Poniższy przykład pokazuje, jak przekonwertować liczbę XLSB na format XML w formacie C++.
...
Trzeba programowo przekonwertować pliki XLSB do XML? Programiści C++ mogą łatwo przekonwertować pliki XLSB do XML za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do konwersji XLSB na XML" %}}
