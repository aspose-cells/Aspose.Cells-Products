...
Ví dụ sau minh họa cách hợp nhất MHT sang XML trong Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/content h2="C++ thư viện để hợp nhất MHT sang XML" %}}
