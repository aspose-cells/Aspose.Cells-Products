---
title: Konwertuj TSV na DIF przez Java 
weight: 9110

description: Przykładowy kod konwersji Java dla formatu TSV do pliku DIF. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do DIF w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TSV na DIF przez Java" h2="Konwersja TSV do DIF Java w celu konwersji jednej lub wielu stron do formatu DIF przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TSV na DIF za pomocą Java" %}}

 Aby wyrenderować TSV do DIF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TSV na DIF za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik TSV na DIF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem DIF i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku DIF
...
{{% blocks/products/pf/agp/code-block title="TSV do DIF Java Kod źródłowy konwersji" offSpacer="" %}}
