...
Moet je bestanden met de extensie HTML programmatisch converteren naar JSON? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar JSON met slechts een paar regels code.
