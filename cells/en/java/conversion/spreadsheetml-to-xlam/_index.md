...
description: Sample Java conversion code for SPREADSHEETML format to XLAM file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to XLAM within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert SPREADSHEETML to XLAM Using Java" %}}

 In order to render SPREADSHEETML to XLAM, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert SPREADSHEETML to XLAM via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML to XLAM Java Conversion Source Code" offSpacer="" %}}

```cs
// load the SPREADSHEETML file in an instance of Workbook
Workbook book = new Workbook("template.spreadsheetml");
// save SPREADSHEETML as XLAM
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML to XLAM Conversion Live Demos" sectionDescription="[Convert SPREADSHEETML to XLAM](https://products.aspose.app/cells/conversion/spreadsheetml-to-xlam) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your SPREADSHEETML file, it will be converted instantly to XLAM." >}}
