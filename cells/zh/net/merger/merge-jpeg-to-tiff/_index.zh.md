...
url: /zh/net/merger/merge-jpeg-to-tiff/ 
description: Aspose Excel。 C# Aspose.Cells。免费在线合并JPEG到TIFF保存格式。 C# 将 JPEG 合并为 TIFF 格式。将 JPEG 合并到 C# 中的 TIFF。 JPEG 合并。
...
{{% blocks/products/pf/agp/content h2="免费在线将 JPEG 合并为 C# 中的 TIFF" %}}

以下示例演示如何将 JPEG 合并到 Aspose.Cells for .NET 中的 TIFF。
...
{{% blocks/products/pf/agp/content h2=".NET库将JPEG合并到TIFF" %}}
