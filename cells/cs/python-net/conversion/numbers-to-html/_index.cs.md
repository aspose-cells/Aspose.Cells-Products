...
{{% blocks/products/pf/agp/content h2="Převeďte ČÍSLA na HTML v Python" %}}
...
Následující příklad ukazuje, jak převést ČÍSLA na HTML v Python via NET.
