---
title: C# XLTX naar ET - XLTX naar ET-converter
description: Aspose Excel. Converteer XLTX snel en eenvoudig naar ET met Aspose.Cells. C# XLTX naar ET. C# Bewaar XLTX naar ET. Bewaar XLTX als ET met C#.
...
{{% blocks/products/pf/agp/content h2="Bewaar XLTX naar ET in C#" %}}

Het volgende voorbeeld laat zien hoe u XLTX naar ET in C# converteert.
...
{{% blocks/products/pf/agp/content h2="Hoe u XLTX naar ET kunt converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLTX-bestanden programmatisch naar ET converteren? .NET-ontwikkelaars kunnen XLTX eenvoudig in slechts een paar regels code laden en converteren naar ET.
...
{{% blocks/products/pf/agp/content h2="C# bibliotheek om XLTX naar ET te converteren" %}}
