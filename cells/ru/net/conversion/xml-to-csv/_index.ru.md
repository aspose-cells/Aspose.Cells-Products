---
title: C# XML в CSV - Конвертер XML в CSV
description: Aspose Эксель. Быстро и легко конвертируйте XML в CSV с помощью Aspose.Cells. C# XML в CSV. C# Сохраните XML в CSV. Сохраните XML как CSV, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните XML в CSV в C#." %}}

В следующем примере показано, как преобразовать XML в CSV в C#.
...
{{% cells-convert title="Пример кода для преобразования XML в CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="csv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать XML в CSV через C#" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно преобразовать XML-файлы в CSV? Разработчики .NET могут легко загружать и конвертировать XML в CSV всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XML в CSV" %}}
