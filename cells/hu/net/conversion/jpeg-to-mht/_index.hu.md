---
title: C# JPEG - MHT - JPEG - MHT Converter
description: Aspose Excel. A JPEG számot gyorsan és egyszerűen konvertálja MHT-ra a Aspose.Cells-es számmal. C# JPEG MHT-vá. C# Takarítson meg JPEG-et az MHT-nak. Mentse el a JPEG számot MHT-ként a C# használatával.
...
{{% blocks/products/pf/agp/content h2="Mentse a JPEG számot az MHT-nak a C# számon" %}}
...
{{% cells-convert title="Mintakód a JPEG MHT-vá alakításához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="mht" IsLandingPage="true" %}}
