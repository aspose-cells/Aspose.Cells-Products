...
url: /ja/python-java/merger/merge-mht-to-word/ 
...
次の例は、Aspose.Cells for Python via Java の MHT を WORD にマージする方法を示しています。
...
MHT をプログラムで WORD にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実行できます。
