...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHT 轉換為 BMP。C# MHT 到 BMP。C# 將 MHT 儲存到 BMP。C# 將 MHT 儲存到 BMP。C# 將 MHT 儲存到 BMP。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 C# 中的 MHT 轉換為 BMP" h2="用於將 MHT 轉換為 BMP 的高速 C# 庫。這是一個專業的軟體解決方案，用於在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 MHT、07612381 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="將MHT保存到C#中的BMP" %}}

下面的範例示範如何將C#中的MHT轉換為BMP。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 轉換為 BMP。上傳您的 MHT 文件，然後只需將其另存為 BMP 文件。對於 MHT 讀取和 BMP 寫入，您可以使用完全限定的檔案名稱。輸出 BMP 內容和格式將與原始 MHT 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 MHT 轉換為 BMP 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="bmp" IsLandingPage="true" %}}
...
1. 透過呼叫 Workbook.Save 方法將 MHT 轉換為 BMP。
1. 取得MHT到BMP的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 庫將 MHT 轉換為 BMP" %}}
