...
{{< blocks/products/pf/i18n/upper-banner h1="Konversi EXCEL ke GAMBAR di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi EXCEL ke GAMBAR. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor EXCEL, GAMBAR, dan banyak format lainnya pada .NET Framework, .NET Core atau Mono Platform." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
Perlu mengonversi file EXCEL ke IMAGE secara terprogram? .NET pengembang dapat dengan mudah memuat & mengubah EXCEL menjadi GAMBAR hanya dalam beberapa baris kode.
...
1.  Ubah EXCEL menjadi IMAGE dengan memanggil metode Workbook.Save.
