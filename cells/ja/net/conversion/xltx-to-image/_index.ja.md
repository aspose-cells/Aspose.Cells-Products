---
title: C# XLTX から画像 - XLTX から画像コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLTXをIMAGEにすばやく簡単に変換します。C# XLTXをIMAGEに変換します。 C# XLTXを画像に保存してください。 C# を使用して、XLTX を画像として保存します。
...
{{% cells-convert title="XLTXをIMAGEに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="png" IsLandingPage="true" %}}
