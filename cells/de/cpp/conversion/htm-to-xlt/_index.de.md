...
description: Aspose Excel. Konvertieren Sie HTM schnell und einfach in XLT mit Aspose.Cells. C++ HTM in XLT. C++ Speichern Sie HTM in XLT. Speichern Sie HTM als XLT mit C++.
...
{{% cells-convert title="Beispielcode zum Konvertieren von HTM in XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xlt" IsLandingPage="true" language="cpp" %}}
