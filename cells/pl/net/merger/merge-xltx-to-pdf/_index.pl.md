...
url: /pl/net/merger/merge-xltx-to-pdf/ 
...
Poniższy przykład pokazuje, jak połączyć XLTX z PDF w Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz scalić XLTX z PDF programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLTX z PDF" %}}
