---
title: C# HTML ila TXT - HTML ila TXT Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilerine HTML'i TXT formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, HTML verilerinin TXT formatına Aspose.Cells kütüphanesi kullanılarak sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="HTML\'i TXT olarak C#\'e kaydedin." %}}

Aşağıdaki örnek, C#'de HTML'i TXT'e nasıl dönüştüreceğinizi göstermektedir.
{{% blocks/products/pf/agp/text %}}

HTML'i TXT'e dönüştürmek için kolay adımları izleyin. HTML dosyanızı yükleyin, ardından TXT dosyası olarak kaydedin. Hem HTML okuma hem de TXT yazma için tam nitelikli dosya adlarını kullanabilirsiniz. TXT çıktısının içeriği ve biçimlendirmesi, orijinal HTML belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="HTML sayısını TXT sayısına dönüştürmek için örnek kod." formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML\'i C# aracılığıyla TXT\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

HTML dosyalarını program aracılığıyla TXT'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyebilir ve TXT'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak HTML değerini TXT değerine dönüştürün.
1.  HTML'den TXT'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="HTML\'i TXT\'e dönüştürmek için C# kütüphanesi" %}}
