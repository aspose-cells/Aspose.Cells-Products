---
title:  Συγχώνευση HTML στο WORD μέσω C#
url: /el/net/merger/merge-html-to-word/ 
description: Συγχώνευση HTML στο WORD Online δωρεάν. Δωρεάν Online HTML στο WORD Merger. Συγχώνευση HTML σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το HTML στο WORD στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση HTML στο WORD σε απευθείας σύνδεση" InputFormat="html" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
