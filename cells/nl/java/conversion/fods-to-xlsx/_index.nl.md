...
{{% blocks/products/pf/agp/content h2="Sla FODS op in XLSX in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar XLSX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar XLSX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar XLSX? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar XLSX met slechts een paar regels code.
