---
title: Voeg HTM samen met MHT - Combineer HTM met MHT in C#
url: /nl/net/merger/merge-htm-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online HTM samenvoegen naar MHT-opslagformaat. C# Combineer HTM naar MHT formaat. Voeg HTM samen met MHT in C#. HTM samenvoegen.
...
Het volgende voorbeeld laat zien hoe u HTM kunt samenvoegen met MHT in Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis online om HTM samen te voegen met MHT in C#" InputFormat="htm" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen met MHT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u HTM programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
