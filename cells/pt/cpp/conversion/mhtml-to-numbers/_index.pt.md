...
Precisa converter arquivos MHTML para NUMBERS programaticamente? C++ desenvolvedores podem facilmente converter MHTML para NUMBERS em apenas algumas linhas de código.
...
1.  Converta MHTML em NÚMEROS chamando o método Save().
