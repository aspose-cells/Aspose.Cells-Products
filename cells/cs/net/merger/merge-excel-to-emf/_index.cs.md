...
description: Aspose Excel. C# Aspose.Cells. Sloučit EXCEL do EMF saveformat. C# Kombinujte EXCEL do formátu EMF. Sloučit EXCEL na EMF v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL na EMF v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení EXCELu s EMF v C#" InputFormat="xlsx" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
