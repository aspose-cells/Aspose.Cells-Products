---
title: XLAM à XLSX - Convertir XLAM à XLSX fichiers Java
description: Aspose Excel. Conversion gratuite en ligne du format de sauvegarde XLAM en XLSX. Format Java XLAM à XLSX. Enregistrez XLAM sous XLSX dans Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLAM à XLSX dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLAM en XLSX en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLAM en XLSX. Téléchargez votre fichier XLAM, puis enregistrez-le simplement en tant que fichier XLSX. Pour la lecture XLAM et l'écriture XLSX, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie XLSX seront identiques au document XLAM d'origine.
...
Besoin de convertir les fichiers XLAM en XLSX par programmation ? Les développeurs de Java peuvent facilement convertir XLAM en XLSX en seulement quelques lignes de code.
