...
{{% blocks/products/pf/agp/content h2="Hur man infogar rad i Excel-fil med Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga rad till Excel-fil med Python via .Net" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens tillägg[metod](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) för att infoga en rad i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Insert Line - Python via .Net" offSpacer="" %}}
