---
title: C++ XLSM से PDF - XLSM से PDF कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ XLSM को PDF में जल्दी और आसानी से बदलें। 81 C++ का उपयोग करते हुए।
...
{{% blocks/products/pf/agp/content h2="C++ में XLSM से PDF सेव करें" %}}
...
{{% cells-convert title="XLSM को PDF में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="pdf" IsLandingPage="true" language="cpp" %}}
