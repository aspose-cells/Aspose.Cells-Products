...
{{% blocks/products/pf/agp/content h2="EXCEL fájl mentése ET-be a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet EXCEL-t ET-vé konvertálni a C#-es kódrészletben.
...
{{% blocks/products/pf/agp/content h2="Az EXCEL konvertálása ET-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia az EXCEL fájlokat ET-re? .NET A fejlesztők egyszerűen betölthetik és átalakíthatják az EXCEL-t ET-re, mindössze néhány sornyi kóddal.
...
1.  Konvertálja az EXCEL-t ET-vé a Workbook.Save metódus meghívásával.
1.  Szerezd meg az EXCEL konvertálási eredményét ET-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár EXCEL ET-vé konvertálásához" %}}
