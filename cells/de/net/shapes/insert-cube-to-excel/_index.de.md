---
title:  Cube in Excel via .NET einfügen
weight: 325
description: C# Beispielcode zum Hinzufügen oder Einfügen einer Würfelform in Excel mithilfe der Bibliothek .NET. Verwenden Sie diesen Code, um eine Würfelform in MS Excel in VB.NET, Asp.NET oder einer anderen .NET-basierten Anwendung zu erstellen.
keywords: [C# Aspose.Cells., c# add Cube shape., c# insert Cube shape., c# create Cube shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cube in Excel via .NET einfügen" h2="Fügen Sie Cube mit Aspose.Cells\' API ohne Software wie Microsoft oder Open Office, Adobe PDF usw. ein." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Wählen Sie Arbeitsblatt über seinen Index aus.
 + Benutzen Sie die[Methode hinzufügen](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addautoshape) , um einen Würfel in das ausgewählte Arbeitsblatt einzufügen
