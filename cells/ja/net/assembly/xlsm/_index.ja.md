...
{{% blocks/products/pf/agp/content h2="C# を使用して XLSM ベースのレポートを生成する方法" %}}

XLSM レポートを作成するには、次を使用します。
...
{{% blocks/products/pf/agp/feature-section-col title="C# 経由で XLSM を組み立てる手順" %}}
...
1. WorkbookDesigner.Worbook.Save メソッド経由で結果を XLSM 形式で保存します
...
{{% blocks/products/pf/agp/code-block title="XLSM レポートの生成" offSpacer="" %}}
