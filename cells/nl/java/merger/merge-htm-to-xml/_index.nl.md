---
title: HTM naar XML samenvoegen - Combineer HTM naar XML in Java
url: /nl/java/merger/merge-htm-to-xml/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online HTM samenvoegen naar XML-opslagformaat. Java Combineer HTM naar XML formaat. Voeg HTM samen naar XML in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTM gratis samen naar XML in Java Online" %}}

Het volgende voorbeeld laat zien hoe u HTM kunt samenvoegen met XML in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM naar XML samen te voegen. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een XML-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat HTM samenvoegt met XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om HTM naar XML samen te voegen in Java" InputFormat="htm" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen naar XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Moet u HTM programmatisch naar XML samenvoegen? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM naar XML samen te voegen" %}}
