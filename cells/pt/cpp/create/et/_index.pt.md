...
description: Aspose Excel. Gere e manipule arquivos ET sem esforço com a biblioteca Aspose.Cells for C++. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos ET diretamente em seus aplicativos C++, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo ET em C++" h2="Criação programática de arquivos ET nativos e de alto desempenho sem o Microsoft Office, utilizando a biblioteca C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Para os desenvolvedores, é fácil criar, carregar, modificar e converter arquivos ET em aplicativos de geração de relatórios em execução para processamento de dados com apenas algumas linhas de código.
...
1.  Salve a planilha como um arquivo .et usando o método Save().
