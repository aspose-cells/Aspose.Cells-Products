---
title: Sloučit FODS až XLS - Sloučit FODS až XLS v Python
url: /cs/python-java/merger/merge-fods-to-xls/ 
description: Aspose Excel. Python Aspose.Cells. Online sloučení zdarma FODS do formátu uložení XLS. Python Kombinujte formát FODS až XLS. Sloučit FODS až XLS v Python. FODS Sloučit.
...
Následující příklad ukazuje, jak sloučit FODS až XLS v Aspose.Cells for Python via Java.
...
{{% cells-merger title="Online zdarma ke sloučení FODS až XLS v Python" InputFormat="fods" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit FODS na XLS přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit FODS až XLS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
