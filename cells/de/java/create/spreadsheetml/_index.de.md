...
{{% blocks/products/pf/agp/content h2="So erstellen Sie SPREADSHEETML in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Der Beispielcode zeigt, wie eine SPREADSHEETML-Datei in Java erstellt wird." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Erstellen einer SPREADSHEETML-Datei" %}}
{{% blocks/products/pf/agp/text %}}
