...
{{% blocks/products/pf/agp/content h2="So gruppieren Sie Formen in einer Excel-Datei mit sJava und heben die Gruppierung auf" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Gruppieren und Aufheben der Gruppierung von Formen in der Excel-Datei via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Formen gruppieren und Gruppierung aufheben – Java" offSpacer="" %}}
