...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells makes it easy for the developers to load & convert SXC files to JSON in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Create instance of Workbook class & load SXC file
...
{{% blocks/products/pf/agp/code-block title="This sample code shows SXC to JSON C# Conversion" offSpacer="" %}}

```cs
// load SXC file with an instance of Workbook
var workbook = new Cells.Workbook("J8CR782.sxc", new Cells.LoadOptions(Cells.LoadFormat.Auto));
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert SXC to JSON" sectionDescription="Check our live demos for [SXC to JSON conversion](https://products.aspose.app/cells/conversion/sxc-to-json) with following benefits." >}}
