---
title: Gabungkan HTM ke JSON - Gabungkan HTM ke JSON di Java
url: /id/java/merger/merge-htm-to-json/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge HTM to JSON saveformat. Java Gabungkan HTM ke format JSON. Gabungkan HTM ke JSON di Java. Gabungkan HTM.
...
Contoh berikut menunjukkan cara menggabungkan HTM ke JSON di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis Menggabungkan HTM ke JSON di Java" InputFormat="htm" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan HTM ke JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan HTM ke JSON secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
