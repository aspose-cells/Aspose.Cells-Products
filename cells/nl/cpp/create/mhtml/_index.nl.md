...
{{< blocks/products/pf/i18n/upper-banner h1="MHTML-bestand maken via C++" h2="Systeemeigen en krachtige MHTML-creatie programmatisch zonder dat Microsoft Office de C++-bibliotheek gebruikt." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Het is gemakkelijk voor de ontwikkelaars om MHTML-bestanden te creëren, laden, wijzigen en converteren binnen actieve rapportagetoepassingen voor gegevensverwerking in slechts enkele regels code.

{{% /blocks/products/pf/agp/text %}}

1. Maak een object van de klasse IWorkbook.1. Zet het eerste blad in een IWorksheet-object.1. Gebruik de methode IWorksheet->GetICells() om de cellen van het werkblad in een ICells-object te krijgen.1. Gebruik de methode ICells->GetObjectByIndex() om toegang te krijgen tot de gewenste cel van het werkblad in een ICell-object.1. Gebruik de methode ICell->PutValue() om een waarde in de cel in te voeren.1. Sla de werkmap op als .mhtml-bestand met de Save()-methode.
...
Een Excel Spreadsheet Programming Library die in staat is om platformonafhankelijke applicaties te bouwen met de mogelijkheid om MHTML-bestanden te genereren, wijzigen, converteren, renderen en afdrukken. C++ Excel API converteert niet alleen tussen spreadsheetformaten, het kan ook Excel-bestanden weergeven als afbeeldingen, PDF, HTML, ODS en meer, waardoor het een perfecte keuze is om documenten uit te wisselen in industriestandaardformaten.
