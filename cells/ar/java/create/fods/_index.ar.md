---
title: إنشاء FODS - إنشاء ملف FODS في Java
description: Aspose اكسل. Java أنشئ ملف FODS بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف FODS باستخدام Java. أنشئ FODS في Java. Java FODS Creator.
...
{{< blocks/products/pf/i18n/upper-banner h1="قم بإنشاء ملف FODS في Java" h2="مكتبة Java عالية السرعة لإنشاء ملف FODS. هذا حل برمجي احترافي لاستيراد وتصدير XLSX وPDF والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء FODS في Java" %}}
...
1. احفظ المصنف بتنسيق FODS باستخدام طريقة save().

{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف FODS في Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لإنشاء ملف FODS" %}}
{{% blocks/products/pf/agp/text %}}
