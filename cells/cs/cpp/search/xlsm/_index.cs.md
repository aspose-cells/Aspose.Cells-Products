---
title:  Vyhledejte dokument XLSM bez otevření přes C++
weight: 9280
description: C++ ukázkový kód pro vyhledávání slov se vzorem v souboru XLSM na C++ Runtime Environment pro Windows 32 bit, Windows 64 bit a Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hledejte XLSM Formáty v C++" h2="Nativní a vysoce výkonné XLSM prohledávání dokumentů pomocí serverových Aspose.Cells for C++ API, bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
Načtěte soubor XLSM vytvořením instance třídy IWorkbook.
...
+ Uložte soubor XLSM pomocí metody IWorkbook->Save(.).
