...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in TXT mit Aspose.Cells. PHP OTS in TXT. PHP Speichern Sie OTS in TXT. Speichern Sie OTS mit PHP als TXT.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in TXT" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in TXT konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in TXT konvertieren.
...
1.  Konvertieren Sie OTS in TXT, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in TXT" %}}
