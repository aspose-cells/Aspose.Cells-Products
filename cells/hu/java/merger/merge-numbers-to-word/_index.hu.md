---
title: A NUMBERS egyesítése a WORD-hoz – a NUMBERS egyesítése a WORD-hoz a Java-ben
url: /hu/java/merger/merge-numbers-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítése NUMBERS WORD mentési formátumba. Java SZÁMOK kombinálása WORD formátumba. A NUMBERS egyesítése a WORD-hoz a Java-ben. NUMBERS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a NUMBERS-t a WORD-dal a Java-es számban" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a NUMBERS-t a WORD-dal a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a NUMBERS és a WORD egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el WORD fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely a NUMBERS-t a WORD-ba egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a NUMBERS és a WORD egyesítéséhez a Java számon" InputFormat="numbers" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A NUMBERS egyesítése a WORD via Java számmal" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell NUMBERS-t a WORD-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
