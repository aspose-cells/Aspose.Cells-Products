---
title: PHP HTM a MHTML - Convertidor HTM a MHTML
description: Aspose Excel. Convierta HTM a MHTML rápida y fácilmente con Aspose.Cells. PHP HTM a MHTML. PHP Guarde HTM en MHTML. Guarde HTM como MHTML usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a MHTML mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a MHTML mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a MHTML en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a MHTML llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de HTM a MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir HTM a MHTML" %}}
