---
title: Συγχώνευση NUMBERS σε MD - Συνδυάστε NUMBERS σε MD στο C#
url: /el/net/merger/merge-numbers-to-md/ 
description: Aspose Excel. C# Aspose.Cells. Δωρεάν Online Merge NUMBERS σε MD saveformat. C# Συνδυάστε NUMBER σε μορφή MD. Συγχώνευση NUMBERS σε MD στο C#. NUMBERS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση NUMBERS στο MD στο C# Online δωρεάν" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε NUMBERS στο MD στο Aspose.Cells for .NET.
...
{{% cells-merger title="Δωρεάν Online για Συγχώνευση NUMBERS στο MD στο C#" InputFormat="numbers" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε NUMBERS στο MD μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να συγχωνεύσετε τα NUMBERS στο MD μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2=".NET βιβλιοθήκη για συγχώνευση NUMBERS με MD" %}}
