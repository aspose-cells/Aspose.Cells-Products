---
title: Conversor PHP XLTX para DIF - XLTX para DIF
description: Aspose Excel. Converta XLTX em DIF de forma rápida e fácil com Aspose.Cells. PHP XLTX em DIF. PHP Salve XLTX em DIF. Salve XLTX como DIF usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em DIF via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em DIF programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em DIF em apenas algumas linhas de código.
...
1.  Converta XLTX em DIF chamando o método save da pasta de trabalho.
