...
weight: 7690
description: C# Przykładowy kod dodawania wykresu przestawnego do XLS przy użyciu biblioteki .NET. Użyj tego kodu, aby wstawić wykres przestawny do pliku XLS w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
