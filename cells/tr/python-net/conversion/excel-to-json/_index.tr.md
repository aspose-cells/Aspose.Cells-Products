---
title: Python EXCEL'den JSON'e - EXCEL'den JSON'e dönüştürücü
description: Aspose Excel'de. Python Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde EXCEL'i JSON'e dönüştürün. Python EXCEL'i JSON'e dönüştürün. Python EXCEL'i JSON'e kaydedin. Python Excel Kitaplığını kullanarak EXCEL'i JSON olarak kaydedin.
...
{{% cells-convert title="Excel Kitaplığı aracılığıyla EXCEL\'i JSON\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="json" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i JSON\'e Dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını programlı olarak JSON'e dönüştürmeniz mi gerekiyor? Python geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip JSON'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak EXCEL'i JSON'e dönüştürün.
1.  EXCEL'in JSON'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python EXCEL\'i JSON\'e Dönüştürmek için Excel Kitaplığı" %}}
