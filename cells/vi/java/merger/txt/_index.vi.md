---
title:  Hợp nhất các tập tin TXT via Java
weight: 4480
description: Java mã mẫu để kết hợp các tài liệu TXT trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
...
+ Nạp tệp TXT đầu tiên với một thể hiện của lớp Workbook.
+ Nạp tài liệu TXT thứ hai với một thể hiện của lớp Workbook.
+ Hợp nhất các tệp bằng phương thức kết hợp ().
lưu tệp TXT đã hợp nhất tại đường dẫn đã chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất tệp TXT - Java" offSpacer="" %}}
