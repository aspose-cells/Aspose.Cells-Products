...
description: Aspose Excel。 Python Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 PDF。Python OTS 為 PDF。Python 將 OTS 儲存為 PDF。Python 將 OTS 儲存為 PDF。Python 將 OTS 儲存為 PDF。
...
{{% blocks/products/pf/agp/content h2="將 Python Excel 庫中的 OTS 轉換為 PDF" %}}
...
{{% blocks/products/pf/agp/content h2="將 OTS 儲存到 Python Excel 庫中的 PDF" %}}

以下範例示範如何將 Python excel 庫中的 OTS 轉換為 PDF。
...
{{% cells-convert title="透過 Python Excel 庫將 OTS 轉換為 PDF 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="pdf" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 OTS 轉換為 PDF" %}}
