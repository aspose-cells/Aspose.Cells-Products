...
{{% blocks/products/pf/agp/content h2="Repair XLS File Using .NET" %}}
 ...
 In order to repair XLS file, we will use [Aspose.Cells for .NET](https://products.aspose.com/cells/net) API which is a feature-rich, powerful and easy to use document manipulation API for C# platform. 
