...
url: /zh/cpp/merger/merge-xltx-to-jpg/ 
...
下面的例子演示了如何将XLTX合并为JPG Aspose.Cells for C++。
...
需要以编程方式将 XLTX 合并到 JPG 吗？基本文档合并和连接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++库将XLTX合并到JPG" %}}
