...
description: Sample C++ conversion code for MHTML document to DIF format. Programmers can use this source code for batch MHTML to DIF conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="MHTML to DIF C++ Conversion Source Code" offSpacer="" %}}
