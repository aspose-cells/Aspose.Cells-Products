---
title:  Inserte el botón Girar (control de formulario) en Excel usando Python via .Net
weight: 40
description: Python via Código fuente .Net para insertar el botón Girar (control de formulario) en Excel.
...
{{% blocks/products/pf/agp/content h2="Cómo insertar el botón Girar (control de formulario) en un archivo de Excel usando Python via .Net" %}}

 Para insertar el botón Girar (control de formulario) en un archivo de Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar el botón Girar (control de formulario) en un archivo de Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el complemento de la colección de formas.[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_spinner/#int-int-int-int-int-int) para insertar un botón Girar (control de formulario) en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar botón Girar (control de formulario) - Python via .Net" offSpacer="" %}}
