---
title: Chuyển đổi HTML sang TIFF qua ứng dụng C++ 
weight: 8480
url: /vi/cpp/conversion/html-to-tiff/ 
description: Mã chuyển đổi C++ mẫu cho tài liệu HTML sang định dạng TIFF. Các lập trình viên có thể sử dụng mã nguồn này để chuyển đổi hàng loạt HTML sang TIFF trong bất kỳ Ứng dụng C++ nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi HTML sang TIFF qua C++" h2="Chuyển đổi HTML sang TIFF hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp HTML sang TIFF chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp HTML bằng Factory :: CreateIWorkbook.1. Chọn trang tính đầu tiên.1. Đặt tùy chọn (TIFF).1. Lặp lại từng trang của trang tính và kết xuất.1. Mở tệp TIFF trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi HTML sang TIFF C++" offSpacer="" %}}
