...
description: Aspose Unggul. Ubah OTS menjadi XLS dengan cepat dan mudah menggunakan Aspose.Cells. C++ OTS menjadi XLS. C++ Simpan OTS ke XLS. Simpan OTS sebagai XLS menggunakan C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi OTS ke XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xls" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert OTS ke XLS lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file OTS ke XLS secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke XLS hanya dalam beberapa baris kode.
...
1.  Ubah OTS menjadi XLS dengan memanggil metode Save().
