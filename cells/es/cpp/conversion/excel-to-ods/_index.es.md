---
title: C++ EXCEL a ODS - Convertidor EXCEL a ODS
description: Aspose Excel. Convierta EXCEL a ODS rápida y fácilmente con Aspose.Cells. C++ EXCEL a ODS. C++ Guarde EXCEL en ODS. Guarde EXCEL como ODS usando C++.
...
{{% blocks/products/pf/agp/content h2="Guardar EXCEL al ODS en C++" %}}

El siguiente ejemplo demuestra cómo convertir EXCEL a ODS en C++.
...
{{% cells-convert title="Código de muestra para convertir EXCEL a ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir EXCEL a ODS a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos EXCEL a ODS mediante programación? Los desarrolladores de C++ pueden convertir fácilmente EXCEL a ODS en tan solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C++ para convertir EXCEL a ODS" %}}
