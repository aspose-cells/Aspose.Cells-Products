...
{{% blocks/products/pf/agp/content h2="Sla FODS op in XPS in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar XPS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar XPS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar XPS? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar XPS met slechts een paar regels code.
