...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells makes it easy for the developers to load & convert NUMBERS files to JSON in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Create instance of Workbook class & load NUMBERS file
...
{{% blocks/products/pf/agp/code-block title="This sample code shows NUMBERS to JSON C# Conversion" offSpacer="" %}}

```cs
// load NUMBERS file with an instance of Workbook
var workbook = new Cells.Workbook("J8CR782.numbers", new Cells.LoadOptions(Cells.LoadFormat.Auto));
