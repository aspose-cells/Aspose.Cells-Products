...
description: Aspose Excel. Konwertuj OTS na XLS szybko i łatwo za pomocą Aspose.Cells. Java OTS na XLS. Java Zapisz OTS na XLS. Zapisz OTS jako XLS, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS pod numerem XLS w Java" %}}

Poniższy przykład ilustruje sposób konwersji OTS na XLS w Java.
...
Chcesz programowo przekonwertować pliki OTS na XLS? Programiści Java mogą z łatwością przekonwertować OTS na XLS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na XLS" %}}
{{% blocks/products/pf/agp/text %}}
