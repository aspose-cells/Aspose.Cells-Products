---
title: C# JPG en JSON - Convertisseur JPG en JSON
description: Aspose Exceller. C# Aspose.Cells. JPG en JSON dans C#. C# Convertissez JPG en format de sauvegarde JSON. C# JPG au format JSON. Enregistrez JPG au JSON C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer JPG au JSON dans C#" %}}

L'exemple suivant montre comment convertir JPG en JSON en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir JPG en JSON via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en JSON par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en JSON en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en JSON" %}}
