...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML converteren naar JSON met behulp van de Excel-bibliotheek Python" %}}
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML opslaan in JSON in de Excel-bibliotheek Python" %}}

In het volgende voorbeeld ziet u hoe u SPREADSHEETML converteert naar JSON in de Excel-bibliotheek Python.
...
{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om SPREADSHEETML te converteren naar JSON" %}}
