...
description: Aspose Exceller. Convertissez XLSM en SXC rapidement et facilement avec Aspose.Cells. Python XLSM en SXC. Python Enregistrez XLSM en SXC. Enregistrez XLSM sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLSM au SXC au Python" %}}

L'exemple suivant montre comment convertir XLSM en SXC dans Python.
