...
description: Aspose Excel. C++ Aspose.Cells. A XLSB egyesítése XML mentési formátumba. C++ A XLSB kombinálása XML formátumba. A XLSB egyesítése XML-be a C++-ben. XLSB Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a XLSB-et XML-be a C++-ben" %}}

A következő példa bemutatja, hogyan egyesítheti a XLSB-et XML-be a Aspose.Cells for C++-ben.
