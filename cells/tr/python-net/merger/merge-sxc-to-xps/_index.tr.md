...
url: /tr/python-net/merger/merge-sxc-to-xps/ 
...
Aşağıdaki örnek, Aspose.Cells for Python via .NET'de SXC ile XPS'in nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 SXC ile XPS'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
