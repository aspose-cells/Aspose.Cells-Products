---
title: 通过 C++ 将块箭头插入 Excel
weight: 770
description: C++ 用于在 C++ 运行时环境 Windows 32 位、Windows 64 位和 Linux 64 位的 Excel 文件中插入块箭头的示例代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将块箭头插入 Excel" h2="使用服务器端 Aspose.Cells for C++ API 的本机和高性能插入对象，而无需使用任何软件，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 将箭头块插入 Excel 文件" %}}
...
+ 通过索引选择工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ab8156e8562724f9a597b7d2bc503cd4d)在所选工作表中插入块箭头类型概述
以 XLSX 格式保存工作簿。
...
下面的示例代码演示了如何插入“右箭头”。更多类型请参考下文“方块箭头类型概述”。

{{% /blocks/products/pf/agp/text %}}

{{% blocks/products/pf/agp/code-block title="插入块箭头 - C++" offSpacer="" %}}
