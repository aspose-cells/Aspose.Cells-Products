...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση HTM σε XLT saveformat. Python Συνδυάστε τη μορφή HTM σε XLT. Συγχώνευση HTM στο XLT στο Python. Συγχώνευση HTM.
...
{{% blocks/products/pf/agp/content h2="Συγχωνεύστε το HTM στο XLT στο Python" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση HTM στο XLT στο Python" InputFormat="htm" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
