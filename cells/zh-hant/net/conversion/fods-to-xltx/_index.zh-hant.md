---
title: C# FODS 至 XLTX - FODS 至 XLTX 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 FODS 轉換為 XLTX。C# FODS 為 XLTX. C# 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 C#。
...
{{% cells-convert title="將 FODS 轉換為 XLTX 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xltx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 XLTX" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 檔案轉換為 XLTX 嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入和轉換 FODS 到 XLTX。
...
{{% blocks/products/pf/agp/content h2="C#庫將FODS轉換為XLTX" %}}
