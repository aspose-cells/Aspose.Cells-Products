---
title: Combine SPREADSHEETML con POWERPOINT - Combine SPREADSHEETML con POWERPOINT en C#
url: /es/net/merger/merge-spreadsheetml-to-powerpoint/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea de SPREADSHEETML a formato de guardado de POWERPOINT. C# Combine SPREADSHEETML con el formato POWERPOINT. Combinar HOJA DE CALCULO con POWERPOINT en C#. Combinar HOJA DE CALCULO.
...
El siguiente ejemplo muestra cómo combinar SPREADSHEETML con POWERPOINT en Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis en línea para fusionar SPREADSHEETML a POWERPOINT en C#" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar SPREADSHEETML a POWERPOINT a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar SPREADSHEETML con POWERPOINT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
