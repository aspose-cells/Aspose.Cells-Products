...
{{% blocks/products/pf/agp/content h2="Jak utworzyć ETT w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik ETT w C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteka do tworzenia pliku ETT" %}}
