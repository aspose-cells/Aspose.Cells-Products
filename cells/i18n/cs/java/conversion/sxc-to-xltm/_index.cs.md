...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na XLTM pomocí Java" %}}

 K vykreslení SXC do XLTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod SXC na XLTM přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SXC na XLTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLTM a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLTM
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu SXC na XLTM Java" offSpacer="" %}}

```cs
// načtěte soubor SXC v instanci sešitu
Workbook book = new Workbook("template.sxc");
// uložit SXC jako XLTM
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze SXC na XLTM" sectionDescription="[Převést SXC na XLTM](https://products.aspose.app/cells/conversion/sxc-to-xltm) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor SXC, bude okamžitě převeden na XLTM." >}}
