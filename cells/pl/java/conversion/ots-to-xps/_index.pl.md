...
description: Aspose Excel. Konwertuj OTS na XPS szybko i łatwo za pomocą Aspose.Cells. Java OTS na XPS. Java Zapisz OTS na XPS. Zapisz OTS jako XPS, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS pod numerem XPS w Java" %}}

Poniższy przykład ilustruje sposób konwersji OTS na XPS w Java.
...
Chcesz programowo przekonwertować pliki OTS na XPS? Programiści Java mogą z łatwością przekonwertować OTS na XPS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na XPS" %}}
{{% blocks/products/pf/agp/text %}}
