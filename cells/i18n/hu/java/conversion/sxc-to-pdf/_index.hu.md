...
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása PDF-be a következőn keresztül: Java" h2="SXC-ből PDF-be Java konvertálva egyetlen vagy több oldalt PDF-formátumba a Helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása PDF-be a következővel: Java" %}}

 Ahhoz, hogy az SXC-t PDF-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása PDF-be a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak SXC fájlt PDF-be, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat PDF kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott PDF-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="SXC-ből PDF-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az SXC fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.sxc");
// mentse az SXC-t PDF-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC-ből PDF-be konvertáló élő bemutatók" sectionDescription="[Az SXC konvertálása PDF-be](https://products.aspose.app/cells/conversion/sxc-to-pdf) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel az SXC fájlt, és azonnal PDF formátumba konvertálódik." >}}
