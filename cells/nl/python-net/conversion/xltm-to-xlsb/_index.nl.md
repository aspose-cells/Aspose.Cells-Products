...
description: Aspose Excel. Converteer XLTM snel en eenvoudig naar XLSB met Aspose.Cells. Python XLTM naar XLSB. Python Bewaar XLTM in XLSB. Bewaar XLTM als 07611134 81 via Python.
...
{{% blocks/products/pf/agp/content h2="Converteer XLTM naar XLSB in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLTM t/m XLSB in Python" %}}

Het volgende voorbeeld laat zien hoe u XLTM converteert naar XLSB in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLTM naar XLSB te converteren" %}}
