---
title: Python PRN a MHT - Conversor de PRN a MHT
description: Aspose Excel. Esta solución integral proporciona a los desarrolladores de Python un enfoque totalmente integrado para convertir PRN a formato MHT, lo que permite guardar datos PRN en formato MHT sin problemas mediante la biblioteca Aspose.Cells, todo mediante código Python eficiente y personalizable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PRN a MHT en la biblioteca de Excel Python" h2="Biblioteca de Excel Python de alta velocidad para convertir PRN a MHT. Esta es una solución de software profesional para importar y exportar PRN, MHT y muchos otros formatos utilizando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PRN a MHT usando la biblioteca de Excel Python" %}}

 ¿Cómo convierto PRN a MHT? Con la biblioteca Aspose.Cells for Python, puedes convertir PRN a MHT fácilmente mediante programación con solo unas pocas líneas de código.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Guardar PRN en MHT en la biblioteca de Excel Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a MHT en la biblioteca de Excel Python.
{{% blocks/products/pf/agp/text %}}

Sigue estos sencillos pasos para convertir PRN a MHT. Sube tu archivo PRN y guárdalo como archivo MHT. Puedes usar nombres de archivo completos tanto para leer PRN como para escribir MHT. El contenido y el formato MHT de salida serán idénticos al documento PRN original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de ejemplo para convertir PRN a MHT mediante la biblioteca de Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="prn" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PRN a MHT mediante Python" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesitas convertir archivos PRN a MHT mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente archivos PRN a MHT con solo unas pocas líneas de código.
...
1.  Convierta PRN a MHT llamando al método Workbook.save.
1.  Obtenga el resultado de la conversión de PRN a MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Biblioteca de Excel para convertir PRN a MHT" %}}
