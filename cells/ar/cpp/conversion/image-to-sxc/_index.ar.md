...
هل تحتاج إلى تحويل ملفات IMAGE إلى SXC برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل IMAGE إلى SXC في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى SXC باستدعاء طريقة Save ().
