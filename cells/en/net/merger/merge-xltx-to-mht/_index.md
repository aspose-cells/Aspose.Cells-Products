...
description: Merge XLTX to MHT in .NET. Merge XLTX to MHT via .NET online for free. Combine XLTX to MHT using VB.NET, Asp.NET or any .NET based application.
---
...
{{% cells-merger title="Free App to merge XLTX to MHT on line" InputFormat="xltx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
