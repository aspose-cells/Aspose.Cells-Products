...
weight: 930
description: C++ voorbeeldcode om woorden met patroon te zoeken in bestand TSV op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Zoek TSV Formaten in C++" h2="Native en krachtige TSV documentzoekfunctie met behulp van server-side Aspose.Cells for C++ API\'s, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
Laad het bestand TSV door een IWorkbook-klasse te instantiëren.
...
+ Bewaar TSV-bestand met behulp van de methode IWorkbook->Save(.).
