...
{{% blocks/products/pf/agp/feature-section-col title="通過 C++ 在 XLSX 添加評論的步驟" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. 使用 IWorkbook 類對象加載 XLSX Excel 文件。
1. 選擇相關工作表
1. 使用 Add 方法添加評論
...
{{% blocks/products/pf/agp/code-block title="添加評論 XLSX - C++" offSpacer="" %}}
