---
title: "TSV-dokumentum keresése megnyitás nélkül a következőn keresztül: C++ "
weight: 930
url: /hu/cpp/search/tsv/ 
description: C++ példakód a szavak mintájának keresésére a TSV-fájlban C++ Runtime Environment for Windows 32 bit, Windows 64 bit és Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV-formátumok keresése itt: C++" h2="Natív és nagy teljesítményű TSV-dokumentumkeresés a szerveroldali Aspose.Cells használatával C++ API-khoz, bármilyen szoftver, például Microsoft vagy Adobe PDF használata nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan kereshet a TSV-fájlban a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV-fájlok kereséséhez itt: C++" %}}
...
+ TSV-fájl betöltése egy IWorkbook osztály példányosításával.
...
+ Mentse el a TSV fájlt az IWorkbook->Save(.) metódussal.
