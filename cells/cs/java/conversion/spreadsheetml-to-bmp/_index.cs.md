...
{{% blocks/products/pf/agp/content h2="Jak převést SPREADSHEETML na BMP pomocí Java" %}}

 K vykreslení SPREADSHEETML do BMP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SPREADSHEETML na BMP prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SPREADSHEETML na BMP pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SPREADSHEETML s instancí sešitu1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Voláním metody SheetRender.toImage uložíte výsledek ve formátu BMP
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SPREADSHEETML na BMP Java" offSpacer="" %}}
