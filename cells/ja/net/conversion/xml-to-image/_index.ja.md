---
title: C# XML から IMAGE - XML から IMAGE コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XML を IMAGE にすばやく簡単に変換します。 C# XML から IMAGE。 C# XML を画像に保存します。 C# を使用して XML を IMAGE として保存します。
...
{{% blocks/products/pf/agp/content h2="XMLをC#のIMAGEに保存" %}}
...
{{% cells-convert title="XML を IMAGE に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="png" IsLandingPage="true" %}}
