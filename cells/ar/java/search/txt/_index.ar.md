...
{{% blocks/products/pf/agp/content h2="كيفية البحث في ملف TXT باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث في ملفات TXT في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="بحث في ملفات TXT - Java" offSpacer="" %}}

```cs
// إنشاء كائن مصنف
Workbook workbook = new Workbook(dataDir + "book1.txt");

// الوصول إلى ورقة العمل الأولى في ملف TXT
