...
+ Καλέστε τη μέθοδο Save() και μεταβιβάστε το όνομα του αρχείου (πλήρης διαδρομή) και τη μορφή (HTML) ως παράμετρο.
