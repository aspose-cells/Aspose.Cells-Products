---
title: Konvertera XLT till XPS via Java 
weight: 7470
url: /sv/java/conversion/xlt-to-xps/ 
description: Exempel Java-konverteringskod för XLT-format till XPS-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XPS inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLT till XPS med Java" %}}

 För att rendera XLT till XPS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLT till XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLT-fil till XPS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLT-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XPS-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XPS-filen
...
{{% blocks/products/pf/agp/code-block title="XLT till XPS Java konverteringskällkod" offSpacer="" %}}
