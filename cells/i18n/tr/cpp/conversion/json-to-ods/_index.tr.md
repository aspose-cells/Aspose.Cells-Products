---
title: C++ uygulaması aracılığıyla JSON'u ODS'ye dönüştürün 
url: /tr/cpp/conversion/json-to-ods/ 
description: JSON belgesi için ODS biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu JSON'dan ODS'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JSON\'u C++ aracılığıyla ODS\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı JSON\'dan ODS\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, yalnızca birkaç kod satırıyla JSON dosyasını ODS'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak JSON dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (ODS) dosya uzantısıyla iletin.1. ODS dosyası belirtilen yola kaydedilecektir.1. ODS dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="JSON\'dan ODS\'ye C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="JSON\'dan ODS\'ye Dönüşüm Canlı Demoları" sectionDescription="[JSON\'u ODS\'ye dönüştür](https://products.aspose.app/cells/conversion/json-to-ods) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece JSON dosyanızı yükleyin, anında ODS\'ye dönüştürülecektir." >}}
