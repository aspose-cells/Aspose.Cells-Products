---
title: XLT'i TSV'e birleştir - XLT'i C++'de TSV'e birleştir
url: /tr/cpp/merger/merge-xlt-to-tsv/ 
description: Aspose excel. C++ Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme XLT ile TSV kaydetme biçimi. C++ XLT ile TSV formatını birleştirin. C++ içinde XLT'i TSV ile birleştir. XLT Birleştir.
...
Aşağıdaki örnek, XLT'in Aspose.Cells for C++'de TSV ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLT\'i C++\'de TSV ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xlt" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLT\'i C++ üzerinden TSV ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLT ile TSV'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
