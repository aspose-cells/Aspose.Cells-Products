...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก ListBox(Form control) ลงในไฟล์ Excel ผ่าน C#" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addlistbox) เพื่อแทรกกล่องรายการ (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกกล่องรายการ(ตัวควบคุมแบบฟอร์ม) - C#" offSpacer="" %}}
