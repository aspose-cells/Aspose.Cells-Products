...
description: Aspose Excel. Cette solution complète offre aux développeurs C++ une approche entièrement intégrée pour convertir le format HTM au format PRN, permettant un enregistrement transparent des données HTM au format PRN à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C++ efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en PRN dans C++" h2="Conversion HTM vers PRN haute performance utilisant la bibliothèque C++ sans avoir besoin de l\'installation d\'Excel, d\'OpenOffice ou d\'Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM dans PRN dans C++" %}}
...
Besoin de convertir des fichiers HTM en PRN par programmation ? Les développeurs de C++ peuvent facilement convertir des fichiers HTM en PRN en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en PRN en appelant la méthode Save().
