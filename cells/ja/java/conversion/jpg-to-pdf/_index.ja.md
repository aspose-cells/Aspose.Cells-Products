---
title: Java JPG から PDF - JPG から PDF コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、JPG を PDF にすばやく簡単に変換します。 Java JPG を PDF に変換します。 Java JPG を PDF に保存します。 Java を使用して、JPG を PDF として保存します。
...
{{< blocks/products/pf/i18n/upper-banner h1="JPGをJavaのPDFに変換します" h2="JPGをPDFに変換するための高速Javaライブラリ。これは、JPG、PDF、およびJavaを使用する他の多くの形式をインポートおよびエクスポートするためのプロフェッショナルなソフトウェアソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="JPGをJavaのPDFに保存" %}}

次の例は、JPG を Java の PDF に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、JPG を PDF に変換します。JPG ファイルをアップロードし、PDF ファイルとして保存するだけです。 JPG の読み取りと PDF の書き込みの両方で、完全修飾ファイル名を使用できます。出力 PDF のコンテンツと形式は、元の JPG ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="JPGをPDFに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="pdf" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="JPGをPDF via Javaに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで JPG ファイルを PDF に変換する必要がありますか? Java 開発者は、わずか数行のコードで JPG を PDF に簡単に変換できます。
...
1.  JPGからPDFへの変換結果を取得します。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java JPG を PDF に変換するライブラリ" %}}
{{% blocks/products/pf/agp/text %}}
