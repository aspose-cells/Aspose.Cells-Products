---
title:  Sloučit PRN na CSV přes C++
...
Následující příklad ukazuje, jak sloučit PRN s CSV v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení PRN s číslem CSV online" InputFormat="prn" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
