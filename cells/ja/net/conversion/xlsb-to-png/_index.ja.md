---
title: C# XLSB ～ PNG - XLSB ～ PNG コンバータ
description: Aspose エクセル。 XLSB を Aspose.Cells ですばやく簡単に PNG に変換します。 C# XLSB から PNG に変換します。 C# XLSB を PNG に保存します。 XLSB を 07611134 として保存しますC#を使用して81。
...
{{% cells-convert title="XLSB を PNG に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="png" IsLandingPage="true" %}}
