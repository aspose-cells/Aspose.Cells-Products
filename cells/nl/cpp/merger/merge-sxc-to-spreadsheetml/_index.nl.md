---
title: Voeg SXC samen met SPREADSHEETML - Combineer SXC met SPREADSHEETML in C++
url: /nl/cpp/merger/merge-sxc-to-spreadsheetml/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen SXC naar SPREADSHEETML saveformat. C++ Combineer SXC naar SPREADSHEETML-indeling. Samenvoegen SXC naar SPREADSHEETML in C++. SXC Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis SXC samen met SPREADSHEETML in C++ online" %}}

Het volgende voorbeeld laat zien hoe u SXC kunt samenvoegen met SPREADSHEETML in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om SXC samen te voegen met SPREADSHEETML. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het SPREADSHEETML-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat SXC samenvoegt met SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om SXC samen te voegen tot SPREADSHEETML in C++" InputFormat="sxc" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe SXC samen te voegen met SPREADSHEETML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SXC programmatisch samenvoegen met SPREADSHEETML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om SXC samen te voegen tot SPREADSHEETML" %}}
