...
{{% cells-convert title="Пример кода для преобразования XML в HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="htm" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать XML в HTM по номеру C++" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно конвертировать XML-файлы в HTM? Разработчики C++ могут легко преобразовать XML в HTM всего за несколько строк кода.
...
1.  Преобразуйте XML в HTM, вызвав метод Save().
