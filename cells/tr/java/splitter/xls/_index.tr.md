---
title:  Bölünmüş XLS Dosyalar via Java
weight: 610
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı'ndaki XLS belgeyi bölmek için Java örnek kod.
...
{{< blocks/products/pf/i18n/upper-banner h1="Bölünmüş XLS Dosyalar via Java" h2="XLS, sunucu tarafı Java kitaplığı yardımıyla bölünüyor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLS Dosyalarını Java\'e Bölme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="Bölünmüş XLS Dosya - Java" offSpacer="" %}}
