...
description: Aspose Excel. C# Criar arquivo OTS. Criar OTS C#. C# Criador OTS. Crie OTS em C#. Gere o arquivo OTS usando C#.
keywords: [Aspose Excel., C# Aspose.Cells., Create OTS C#., C# OTS Creater., Create OTS file in C#., Generate OTS file in C#]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo OTS em C#" h2="Biblioteca C# de alta velocidade para criar OTS. Esta é uma solução de software profissional para importar e exportar XLSX, PDF e muitos outros formatos em .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 É fácil para os desenvolvedores criar, carregar, modificar e converter arquivos OTS em execução em diferentes aplicativos de relatórios para processamento de dados em apenas algumas linhas de código.
...
1.  Use o método Salvar para salvar a pasta de trabalho como arquivo OTS.

{{% blocks/products/pf/agp/code-block title="O código de amostra mostra como criar o arquivo OTS em C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para criar arquivo OTS" %}}
