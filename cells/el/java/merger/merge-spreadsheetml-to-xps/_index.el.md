---
title:  Συγχώνευση SPREADSHEETML στο XPS via Java
url: /el/java/merger/merge-spreadsheetml-to-xps/ 
description: Συγχώνευση SPREADSHEETML στο XPS Online δωρεάν. Δωρεάν Online SPREADSHEETML to XPS Merger. Συγχώνευση SPREADSHEETML σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SPREADSHEETML στο XPS στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση SPREADSHEETML στο XPS σε απευθείας σύνδεση" InputFormat="xml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
