---
title: Python XLSB na MHT - XLSB na MHT převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Python plně integrovaný přístup k převodu XLSB do formátu MHT, což umožňuje bezproblémové ukládání dat XLSB do formátu MHT pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte kód XLSB na MHT v knihovně Excelu s kódem Python" h2="Vysokorychlostní excelovská knihovna Python pro převod XLSB do MHT. Jedná se o profesionální softwarové řešení pro import a export XLSB, MHT a mnoha dalších formátů pomocí Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Převod čísla XLSB na MHT pomocí knihovny Excelu Python" %}}

 Jak převedu číslo XLSB na MHT? S knihovnou Aspose.Cells a for Python můžete snadno programově převést číslo XLSB na MHT pomocí několika řádků kódu.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)je schopen vytvářet multiplatformní aplikace se schopností generovat, upravovat, konvertovat, vykreslovat a tisknout všechny soubory aplikace Excel. Python Excel API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat soubory Excel jako obrázky, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT a další, takže je perfektní volbou pro výměnu dokumentů ve standardních průmyslových formátech.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Uložit XLSB do MHT v knihovně Excelu Python" %}}

Následující příklad ukazuje, jak převést kód XLSB na MHT v knihovně Excelu s kódem Python.
...
{{% cells-convert title="Ukázkový kód pro převod čísla XLSB na MHT pomocí knihovny Excelu Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsb" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLSB na MHT pomocí Python" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory XLSB do formátu MHT? Vývojáři Python mohou snadno načíst a převést soubory XLSB do formátu MHT pomocí několika řádků kódu.
...
1. Převeďte číslo XLSB na MHT voláním metody Workbook.save.
1.  Získejte výsledek převodu XLSB na MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Knihovna Excelu pro převod XLSB na MHT" %}}
