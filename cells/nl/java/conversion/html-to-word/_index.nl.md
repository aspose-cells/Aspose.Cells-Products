...
{{% blocks/products/pf/agp/content h2="Sla HTML op in WORD in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar WORD in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar WORD of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar WORD? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar WORD met slechts een paar regels code.
