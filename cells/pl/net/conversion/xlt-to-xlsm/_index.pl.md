---
title: Konwertuj XLT na XLSM przez C#
url: /pl/net/conversion/xlt-to-xlsm/
description: Przykładowy kod konwersji xlt do xlsm C#. Użyj przykładowego kodu API dla plików wsadowych xlt do konwersji xlsm w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na XLSM za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na XLSM za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki XLT do XLSM w zaledwie kilku wierszach kodu.
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLT na XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xlsm" IsLandingPage="true" %}}
