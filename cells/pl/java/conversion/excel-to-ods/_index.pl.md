---
title: Java EXCEL do ODS - Konwerter EXCEL do ODS
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji plików EXCEL do formatu ODS, umożliwiając bezproblemowe zapisywanie danych EXCEL do formatu ODS za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL do ODS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę z programu EXCEL na ODS w formacie Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować plik EXCEL na ODS. Prześlij plik EXCEL, a następnie po prostu zapisz go jako plik ODS. Zarówno do odczytu w formacie EXCEL, jak i do zapisu ODS można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego ODS będą identyczne z oryginalnym dokumentem EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji kodu EXCEL na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu ODS? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu ODS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj EXCEL na ODS, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji EXCEL na ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA na ODS" %}}
{{% blocks/products/pf/agp/text %}}
