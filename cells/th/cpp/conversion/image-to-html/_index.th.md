...
ต้องการแปลงไฟล์ IMAGE เป็น HTML โดยใช้โปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลง IMAGE เป็น HTML ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง IMAGE เป็น HTML โดยเรียกใช้เมธอด Save()
