...
description: Aspose Excel. Konvertieren Sie XLS schnell und einfach in TSV mit Aspose.Cells 81 unter C#.
...
Das folgende Beispiel zeigt, wie XLS in TSV in C# konvertiert wird.
...
Müssen Sie XLS-Dateien programmgesteuert in TSV konvertieren? .NET-Entwickler können XLS problemlos in nur wenigen Codezeilen laden und in TSV konvertieren.
...
1.  Konvertieren Sie XLS in TSV, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in TSV" %}}
