---
title:  Połącz XLTX z XLSB przez C++
url: /pl/cpp/merger/merge-xltx-to-xlsb/ 
description: Połącz XLTX z XLSB Online za darmo. Bezpłatnie online XLTX do XLSB Fuzja. Połącz XLTX z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć XLTX z XLSB w C++.
...
{{% cells-merger title="Darmowa aplikacja do łączenia XLTX z XLSB on-line" InputFormat="xltx" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
