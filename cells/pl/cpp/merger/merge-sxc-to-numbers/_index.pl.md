...
Poniższy przykład pokazuje, jak scalić SXC z NUMBERS w Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić numer SXC z NUMBERS? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
