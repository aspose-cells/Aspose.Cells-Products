...
{{% blocks/products/pf/agp/content h2="Save PRN to DIF in C#" %}}

The following example demonstrates how to convert PRN to DIF in C#.
...
{{% cells-convert title="Sample Code to Convert PRN to DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert PRN to DIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert PRN files to DIF programmatically? .NET developers can easily load & convert PRN to DIF in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert PRN to DIF" %}}
