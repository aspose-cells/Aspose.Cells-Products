...
url: /cs/python-java/merger/merge-mht-to-markdown/ 
...
Následující příklad ukazuje, jak sloučit MHT s MARKDOWN v Aspose.Cells for Python via Java.
...
Potřebujete sloučit MHT na MARKDOWN programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
