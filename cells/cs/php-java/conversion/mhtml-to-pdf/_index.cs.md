---
title: Konvertor PHP MHTML až PDF - MHTML až PDF
description: Aspose Excel. Převeďte MHTML na PDF rychle a snadno pomocí Aspose.Cells. PHP MHTML na PDF. PHP Uložte MHTML na PDF. Uložte PDF jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na PDF přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na PDF programově? Vývojáři PHP mohou snadno načíst a převést MHTML na PDF v několika řádcích kódu.
...
1.  Převeďte MHTML na PDF voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na PDF" %}}
