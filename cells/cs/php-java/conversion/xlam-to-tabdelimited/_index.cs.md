...
description: Aspose Excel. Převeďte XLAM na TABDELIMITED rychle a snadno pomocí Aspose.Cells. PHP XLAM na TABDELIMITED. PHP Uložit XLAM do TABDELIMITED. Uložit XLAM jako TABDELIMITED pomocí PHP.
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na TABDELIMITED" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="tsv" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na TABDELIMITED přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XLAM soubory na TABDELIMITED programově? Vývojáři PHP mohou snadno načíst a převést XLAM na TABDELIMITED v několika řádcích kódu.
...
1.  Převeďte XLAM na TABDELIMITED voláním metody uložení sešitu.
