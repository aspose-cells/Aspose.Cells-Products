---
title: Mesclar XLSB para IMAGE - Combine XLSB para IMAGE em C#
url: /pt/net/merger/merge-xlsb-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita XLSB para IMAGE saveformat. C# Combine XLSB para o formato IMAGEM. Mesclar XLSB para IMAGEM em C#. XLSB Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLSB para IMAGE em C# Online Gratuitamente" %}}

exemplo a seguir demonstra como mesclar XLSB com IMAGE em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLSB com IMAGE. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo IMAGE. Se você desenvolver código em C#, isso será mais simples do que parece. Veja o exemplo C# que mescla XLSB com IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLSB com IMAGEM em C#" InputFormat="xlsb" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLSB para IMAGE via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLSB para IMAGE programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLSB para IMAGE" %}}
