---
title:  Ontgrendel document XLSM via C++
weight: 6070
description: C++ voorbeeldcode om met een wachtwoord beveiligd bestand XLSM te ontgrendelen op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ontgrendel XLSM-bestanden via C++" h2="Beveiliging verwijderen van Excel-spreadsheets inclusief XLSM-bestand met behulp van C++-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe de bescherming van het bestand XLSM te verwijderen met behulp van C++" %}}
...
1.  Laad XLSM vergrendeld bestand met behulp van CreateIWorkbook.
1.  Roep de functie Unprotect() aan om te ontgrendelen.
1.  Stel het wachtwoord in op NULL met behulp van SetPassword.
1.  Bewaar het XLSM-bestand op een opgegeven locatie.
