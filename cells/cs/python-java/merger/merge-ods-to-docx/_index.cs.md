---
title:  Sloučit ODS na DOCX přes Python
...
Následující příklad ukazuje, jak sloučit ODS až DOCX v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení ODS až DOCX online" InputFormat="ods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
