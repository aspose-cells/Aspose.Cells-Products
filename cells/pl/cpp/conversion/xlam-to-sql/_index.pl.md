---
title: XLAM na SQL - Konwertuj XLAM na pliki SQL C++
description: Aspose Excel. Bezpłatna konwersja online XLAM do formatu zapisu SQL. C++ XLAM do formatu SQL. Zapisz XLAM jako SQL w C++.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLAM do SQL w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLAM na SQL w C++.
...
Chcesz programowo przekonwertować pliki XLAM na SQL? Programiści C++ mogą łatwo przekonwertować XLAM na SQL w zaledwie kilku wierszach kodu.
...
1.  Przekonwertuj XLAM na SQL, wywołując metodę Save().
1.  Uzyskaj wynik konwersji XLAM na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteka do konwersji XLAM na SQL" %}}
