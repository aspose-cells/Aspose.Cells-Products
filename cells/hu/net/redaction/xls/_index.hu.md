---
title:  Szöveg keresése és cseréje a XLS via .NET dokumentumban
weight: 7280
description: C# forráskód a XLS fájl érzékeny információinak törléséhez a .NET Framework, .NET Core, Mono vagy a Xamarin platformokon.
