---
title:  Wstaw linię do Excela przez C++
weight: 30
description: C++ przykładowy kod do wstawienia linii w pliku Excel w C++ Środowisko wykonawcze dla Windows 32-bitowego, Windows 64-bitowego i 64-bitowego systemu Linux.
keywords: [C++ Aspose.Cells., C++ add a Line., C++ insert a Line., C++ create a Line]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw linię do Excela przez C++" h2="Wstaw obiekty, korzystając z natywnej i wysokiej wydajności po stronie serwera Aspose.Cells for C++ API bez użycia żadnego oprogramowania takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić linię do pliku Excel przy użyciu numeru C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić plik Line do pliku Excel przez C++" %}}

+ Tworzenie instancji obiektu skoroszytu. (lub-> Załaduj plik XLSX z pełną ścieżką.)
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj[dodaj metodę](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addline/) , aby wstawić kształty równań w wybranym arkuszu
...
{{% blocks/products/pf/agp/code-block title="Wstaw wiersz — C++" offSpacer="" %}}
