...
description: Aspose Excel. C++ Aspose.Cells. Voeg MHTML samen met het opslagformaat WORD. C++ Combineer het formaat MHTML met WORD. Voeg MHTML samen met WORD in C++. MHTML Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg MHTML samen met WORD met behulp van C++" %}}
...
{{% blocks/products/pf/agp/content h2="Hoe u MHTML samenvoegt met WORD via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHTML programmatisch samenvoegen met WORD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
