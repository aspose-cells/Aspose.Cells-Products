...
url: /cs/python-net/merger/merge-mht-to-powerpoint/ 
...
Následující příklad ukazuje, jak sloučit MHT do POWERPOINT v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit MHT do POWERPOINT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
