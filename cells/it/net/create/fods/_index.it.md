---
title: Crea FODS - Crea file FODS in C#
description: Aspose Excel. C# Crea il file FODS in modo semplice e veloce con Aspose.Cells. Genera il file FODS utilizzando C#. Crea FODS in C#. C# FODS Creatore.
...
{{% blocks/products/pf/agp/content h2="Come creare FODS in C#" %}}

{{% blocks/products/pf/agp/text %}}

 È facile per gli sviluppatori creare, caricare, modificare e convertire i file FODS eseguendo diverse applicazioni di reporting per l'elaborazione dei dati in poche righe di codice.
...
1.  Utilizzare il metodo Salva per salvare la cartella di lavoro come file FODS.

{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare il file FODS in C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria C# per creare il file FODS" %}}
