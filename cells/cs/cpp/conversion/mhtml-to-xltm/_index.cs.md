---
title: Převeďte MHTML na XLTM pomocí aplikace C++ 
weight: 4310
url: /cs/cpp/conversion/mhtml-to-xltm/ 
description: Ukázka převodního kódu C++ pro dokument MHTML na formát XLTM. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi MHTML na XLTM v jakékoli C++ aplikaci.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor MHTML na XLTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor MHTML pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLTM).1. Soubor XLTM bude uložen do zadané cesty.1. Otevřete soubor XLTM v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MHTML na XLTM C++" offSpacer="" %}}
