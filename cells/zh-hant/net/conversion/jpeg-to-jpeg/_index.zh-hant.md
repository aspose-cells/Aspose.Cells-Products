---
title: C# JPEG 轉 JPEG - 在線 JPEG 轉 JPEG 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 JPEG 轉換為 JPEG 保存格式。 C# JPEG 到 JPEG 格式。將 JPEG 保存為 JPEG C#。
...
{{% blocks/products/pf/agp/content h2="免費在線保存 JPEG 至 JPEG 於 C#" %}}

以下示例演示如何將 C# 中的 JPEG 轉換為 JPEG。
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 JPEG 轉換為 JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 JPEG 轉換為 JPEG" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 JPEG 文件轉換為 JPEG 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 JPEG 到 JPEG。
...
1. 使用工作簿實例加載 JPEG 文件。
1. 通過調用 Workbook.Save 方法將 JPEG 轉換為 JPEG。
1. 獲取JPEG到JPEG的轉換結果。
