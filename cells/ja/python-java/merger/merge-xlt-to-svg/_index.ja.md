...
description: Aspose エクセル。 Python Aspose.Cells。XLT を SVG の保存形式にマージします。 Python XLT と SVG の形式を結合します。 XLT から SVG を Python に結合します。XLT を結合します。
...
次の例は、XLT を Aspose.Cells for Python via Java の SVG にマージする方法を示しています。
...
{{% cells-merger title="XLT から SVG を Python にマージするサンプルコード" InputFormat="xlt" InputFormat2="svg" outformat="svg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLT を Python 経由で SVG に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLT をプログラムで SVG にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実行できます。
