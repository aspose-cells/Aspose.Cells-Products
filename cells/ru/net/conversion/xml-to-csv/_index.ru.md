...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в CSV в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат CSV в формате C#.
...
1.  Преобразовать XML в формат CSV, вызвав метод Workbook.Save.
