...
Poniższy przykład pokazuje, jak połączyć EXCEL z HTM w Aspose.Cells for Python via .NET.
...
Chcesz programowo połączyć EXCEL z HTM? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
