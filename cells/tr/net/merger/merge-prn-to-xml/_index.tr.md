...
url: /tr/net/merger/merge-prn-to-xml/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin XML ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 PRN'yi XML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi XML ile birleştirmek için .NET kitaplığı" %}}
