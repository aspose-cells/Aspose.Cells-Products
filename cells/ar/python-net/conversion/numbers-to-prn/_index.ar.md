...
description: Aspose اكسل. قم بتحويل NUMBERS إلى PRN بسرعة وسهولة باستخدام Aspose.Cells. Python NUMBERS إلى PRN. Python حفظ الأرقام في PRN. احفظ الأرقام كـ PRN باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في PRN على الرقم Python" %}}

يوضح المثال التالي كيفية تحويل NUMBERS إلى PRN في Python via NET.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل الارقام الى PRN" %}}
