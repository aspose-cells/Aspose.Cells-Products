...
{{% blocks/products/pf/agp/content h2="Pythonを使用してExcelファイルにScrollBar(フォームコントロール)を挿入する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python経由でExcelファイルにScrollBar(フォームコントロール)を挿入する手順" %}}
...
+ シェイプコレクションの add メソッドを使用して、選択したワークシートに ScrollBar (フォーム コントロール) を挿入します。
...
{{% blocks/products/pf/agp/code-block title="スクロールバーの挿入(フォーム コントロール) - Python" offSpacer="" %}}
