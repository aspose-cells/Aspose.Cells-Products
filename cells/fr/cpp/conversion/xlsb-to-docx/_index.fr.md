---
title: C++ XLSB à DOCX - Convertisseur en ligne XLSB à DOCX
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde DOCX. Format C++ XLSB à DOCX. Enregistrez XLSB à DOCX C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à DOCX dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en DOCX en C++.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en DOCX via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en DOCX par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en DOCX en seulement quelques lignes de code.
...
1.  Convertissez XLSB en DOCX en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de XLSB en DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir XLSB en DOCX" %}}
