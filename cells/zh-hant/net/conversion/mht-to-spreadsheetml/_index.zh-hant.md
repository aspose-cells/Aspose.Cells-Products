---
title: C# MHT 到 SPREADSHEETML - 在線 MHT 到 SPREADSHEETML 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 MHT 轉換為 SPREADSHEETML 保存格式。 C# MHT 到 SPREADSHEETML 格式。將 MHT 保存到電子表格ML C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 MHT 轉換為 C# 中的 SPREADSHEETML" h2="用於將 MHT 轉換為 SPREADSHEETML 的高速 C# 庫。這是一款專業的軟件解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上導入和導出 MHT、SPREADSHEETML 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線將 MHT 保存到 C# 中的 SPREADSHEETML" %}}

以下示例演示如何將 C# 中的 MHT 轉換為 SPREADSHEETML。
...
{{% cells-convert title="將 MHT 在線轉換為 SPREADSHEETML 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 MHT 轉換為 SPREADSHEETML" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 SPREADSHEETML？ .NET 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 SPREADSHEETML。
