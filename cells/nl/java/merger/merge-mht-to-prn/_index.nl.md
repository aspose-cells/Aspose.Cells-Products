---
title: Voeg MHT samen met PRN - Combineer MHT met PRN in Java
url: /nl/java/merger/merge-mht-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online MHT samenvoegen naar PRN-opslagformaat. Java Combineer MHT naar PRN-formaat. Voeg MHT samen met PRN in Java. MHT samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis MHT samen met PRN in Java online" %}}

Het volgende voorbeeld laat zien hoe u MHT kunt samenvoegen met PRN in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHT samen te voegen met PRN. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het PRN-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat MHT samenvoegt met PRN.
...
{{% blocks/products/pf/agp/content h2="MHT samenvoegen met PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHT programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om MHT samen te voegen met PRN" %}}
