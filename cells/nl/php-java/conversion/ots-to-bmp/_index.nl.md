---
title: PHP OTS naar BMP - OTS naar BMP Converter
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar BMP via PHP?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je OTS-bestanden programmatisch converteren naar BMP? PHP-ontwikkelaars kunnen OTS-bestanden eenvoudig laden en converteren naar BMP met slechts een paar regels code.
...
1.  Converteer OTS naar BMP door de save-methode van Workbook aan te roepen.
1.  Ontvang het conversieresultaat van OTS naar BMP.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om OTS naar BMP te converteren." %}}
