...
{{% blocks/products/pf/agp/content h2="Ubah HTML menjadi SPREADSHEETML di Python" %}}
...
Contoh berikut menunjukkan cara mengonversi HTML menjadi SPREADSHEETML di Python via NET.
