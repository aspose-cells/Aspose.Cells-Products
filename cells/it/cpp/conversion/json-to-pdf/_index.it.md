---
title: Converti JSON in PDF tramite l'applicazione C++ 

description: Esempio di codice di conversione C++ per un documento JSON in formato PDF. I programmatori possono utilizzare questo codice sorgente per la conversione batch da JSON a PDF all'interno di qualsiasi C++ Applicazione.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti JSON in PDF tramite C++" h2="Conversione da JSON a PDF ad alte prestazioni utilizzando la libreria C++ senza la necessità di installare Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire JSON in PDF utilizzando C++" %}}

 Per convertire JSON in PDF, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire JSON in PDF tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente file JSON in PDF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file JSON utilizzando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (PDF).1. Il file PDF verrà salvato nel percorso specificato.1. Apri il file PDF in un programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da JSON a PDF C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live di conversione da JSON a PDF" sectionDescription="[Converti JSON in PDF](https://products.aspose.app/cells/conversion/json-to-pdf) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file JSON, verrà convertito istantaneamente in PDF." >}}
