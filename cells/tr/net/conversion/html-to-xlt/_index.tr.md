---
title: C# HTML ila XLT - HTML ila XLT Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde HTML'i XLT'e dönüştürün. C# HTML'i XLT'e dönüştürün. C# HTML'i XLT'e kaydedin. HTML'i 07611134 olarak kaydedin 81, C#'i kullanarak.
...
{{% blocks/products/pf/agp/content h2="HTML\'i C#\'e XLT\'e kaydedin" %}}

Aşağıdaki örnek, HTML'in C#'de XLT'e nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="HTML\'i XLT\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML\'i C# aracılığıyla XLT\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

HTML dosyalarını program aracılığıyla XLT'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyebilir ve XLT'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak HTML'i XLT'e dönüştürün.
1.  HTML'den XLT'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="HTML\'i XLT\'e dönüştürmek için C# kitaplığı" %}}
