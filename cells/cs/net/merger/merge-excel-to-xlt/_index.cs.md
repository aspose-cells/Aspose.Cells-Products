...
description: Aspose Excel. C# Aspose.Cells. Sloučit EXCEL do XLT saveformat. C# Kombinujte EXCEL do formátu XLT. Sloučit EXCEL na XLT v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL na XLT v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení EXCELu s XLT v C#" InputFormat="xlsx" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
