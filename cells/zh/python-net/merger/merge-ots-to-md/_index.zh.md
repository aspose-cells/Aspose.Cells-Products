...
url: /zh/python-net/merger/merge-ots-to-md/ 
...
以下示例演示如何将 Aspose.Cells for Python via .NET 中的 OTS 合并到 MD。
...
需要以编程方式将 OTS 合并到 MD？基本文档合并和连接[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)只需几行代码即可完成 API。
