...
url: /de/cpp/merger/merge-tsv-to-numbers/ 
...
Das folgende Beispiel zeigt, wie TSV mit NUMBERS in Aspose.Cells for C++ zusammengeführt wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie TSV programmgesteuert mit NUMBERS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="C++-Bibliothek zum Zusammenführen von TSV mit NUMBERS" %}}
