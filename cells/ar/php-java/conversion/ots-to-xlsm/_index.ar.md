---
title: PHP OTS إلى XLSM - OTS إلى XLSM محول
description: Aspose اكسل. قم بتحويل OTS إلى XLSM بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى XLSM. PHP احفظ OTS إلى XLSM. احفظ OTS كـ XLSM باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى XLSM عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى XLSM برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى XLSM في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى XLSM عن طريق استدعاء طريقة حفظ المصنف.
