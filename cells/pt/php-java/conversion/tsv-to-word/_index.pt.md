---
title: Conversor PHP TSV para WORD - TSV para WORD
description: Aspose Excel. Converta TSV em WORD de forma rápida e fácil com Aspose.Cells. PHP TSV em WORD. PHP Salve TSV em WORD. Salve TSV como WORD usando PHP.
...
{{% cells-convert title="Exemplo de código para converter TSV em WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="docx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter TSV em WORD via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em WORD programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em WORD em apenas algumas linhas de código.
...
1.  Converta TSV em WORD chamando o método save da pasta de trabalho.
