...
weight: 4480
description: Java voorbeeldcode om TXT documenten te combineren op Java Runtime Environment voor JSP/JSF Application en Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg TXT-indelingen samen in Java" h2="Native TXT documentfusie met behulp van server-side Java API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe TXT-bestanden samen te voegen met Java" %}}

 Om het TXT-bestand samen te voegen, gebruiken we[Aspose.Cells for Java](https://products.aspose.com/cells/java) API, een functierijk, krachtig en gebruiksvriendelijk fusie-API for Java-platform. U kunt de nieuwste versie rechtstreeks downloaden van[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) en installeer het binnen uw op Maven gebaseerde project door de volgende configuraties toe te voegen aan pom.xml.
...
+ Laad het eerste bestand TXT met een exemplaar van de klasse Workbook.
+ Laad het tweede TXT-document met een exemplaar van de klasse Workbook.
+ Bestanden samenvoegen met behulp van de methode combine().
sla het samengevoegde TXT-bestand op het opgegeven pad op
...
{{% blocks/products/pf/agp/code-block title="Samenvoegen TXT Bestanden - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online TXT Fusie live demo\'s" sectionDescription=" Voeg nu TXT-documenten samen door onze te bezoeken[Website met live demo\'s](https://products.aspose.app/cells/merger). De live demo heeft de volgende voordelen" >}}
