...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS ke format simpan HTM. Java Gabungkan FODS ke format HTM. Gabung FODS ke HTM di Java. FODS Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS ke HTM di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan FODS ke HTM di Java" InputFormat="fods" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS ke HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan FODS ke HTM secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
