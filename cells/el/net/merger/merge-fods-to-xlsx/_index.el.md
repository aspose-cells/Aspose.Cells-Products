...
url: /el/net/merger/merge-fods-to-xlsx/ 
description: Aspose Excel. C# Aspose.Cells. Συγχώνευση FODS σε μορφή αποθήκευσης XLSX. C# Συνδυάστε τη μορφή FODS με XLSX. Συγχώνευση FODS σε XLSX στο C#. FODS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση FODS με XLSX στο C#" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS με το XLSX στο Aspose.Cells for .NET.
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση FODS έως XLSX στο C#" InputFormat="fods" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το FODS στο XLSX μέσω του C#" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε το FODS με το XLSX μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2=".NET βιβλιοθήκη για συγχώνευση FODS με XLSX" %}}
