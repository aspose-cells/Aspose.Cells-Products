---
title: 透過 C++ 將星星和橫幅插入 Excel
weight: 800
description: C++ 在 C++ 執行環境（Windows 32 位元、Windows 64 位元和 Linux 64 位元）上的 Excel 檔案中插入星星和橫幅的範例程式碼。
keywords: [C++ Aspose.Cells., C++ add Star/Banner., C++ insert Star/Banner., C++ create Star/Banner]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 將星星和橫幅插入 Excel" h2="使用伺服器端的本機高效能插入物件 Aspose.Cells for C++ API，無需使用任何軟體，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 將星星和橫幅插入 Excel 檔案的步驟" %}}

實例化一個 Workbook 物件。（或->載入 XLSX 檔案的完整路徑。）
+ 透過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/)在選定的工作表中插入星星和橫幅
以 XLSX 格式儲存工作簿。
...
下面的範例程式碼示範如何插入「絲帶：彎曲和向上傾斜」和「爆炸：8 點」。更多類型請參閱下面的「星標和橫幅類型概述」。
