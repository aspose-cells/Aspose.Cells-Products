...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHTML 轉換為 TABDELIMITED。PHP MHTML 到 TABDELIMITED。 PHP 將 MHTML 儲存為製表符。使用 PHP 將 MHTML 儲存為 TABDELIMITED。
...
如何將 MHTML 轉換為 TABDELIMITED？使用 Aspose.Cells for PHP via Java 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 MHTML 轉換為 TABDELIMITED。[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 PHP Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="在 PHP 中將 MHTML 儲存為 TABDELIMITED" %}}
...
{{% blocks/products/pf/agp/content h2="如何透過 PHP 將 MHTML 轉換為 TABDELIMITED" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 MHTML 檔案轉換為 TABDELIMITED 嗎？ PHP 開發人員只需幾行程式碼即可輕鬆載入 MHTML 並將其轉換為 TABDELIMITED。
...
1. 透過呼叫Workbook的save方法將MHTML轉換為TABDELIMITED。
1. 取得 MHTML 到 TABDELIMITED 的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP 函式庫將 MHTML 轉換為 TABDELIMITED" %}}
