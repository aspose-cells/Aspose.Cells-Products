...
{{< blocks/products/pf/i18n/upper-banner h1="Шифровать файлы XLSM с помощью C++" h2="Защищайте паролем электронные таблицы Excel, включая формат XLSM, с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
1. Загрузите файл XLSM, используя класс IWorkbook1. Используйте метод Protect(..) с ProtectionType и Password1. Сохраните защищенный XLSM-файл методом Save().
