...
description: Aspose Excel. Chuyển đổi XLS sang XML nhanh chóng và dễ dàng với Aspose.Cells. C++ XLS sang XML. C++ Lưu XLS vào XML. Lưu XLS dưới dạng XML bằng C++.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLS sang XML bằng C++" %}}
...
Ví dụ sau đây minh hoạ cách chuyển đổi XLS sang XML trong C++.
...
{{% cells-convert title="Mã mẫu để chuyển đổi XLS sang XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS sang XML qua C++" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tệp XLS sang XML theo chương trình? Các nhà phát triển C++ có thể dễ dàng chuyển đổi XLS sang XML chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLS thành XML bằng cách gọi phương thức Save().
