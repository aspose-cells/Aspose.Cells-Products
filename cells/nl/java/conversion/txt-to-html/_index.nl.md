...
{{% blocks/products/pf/agp/content h2="Sla TXT op in HTML in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar HTML in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar HTML of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar HTML? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar HTML met slechts een paar regels code.
