...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 XLT를 BMP로 변환하는 방법" %}}

 XLT를 BMP로 렌더링하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 XLT를 BMP로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Java 개발자는 몇 줄의 코드로 XLT 파일을 BMP로 쉽게 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. 통합 문서의 인스턴스와 함께 XLT 파일 로드1. 컬렉션에서 기본 또는 워크시트 선택1. ImageOrPrintOptions 개체 생성 및 설정1. Worksheet 및 ImageOrPrintOptions 개체로 SheetRender 만들기1. SheetRender.toImage 메서드를 호출하여 결과를 BMP 형식으로 저장
...
{{% blocks/products/pf/agp/code-block title="XLT에서 BMP로의 Java 변환 소스 코드" offSpacer="" %}}
