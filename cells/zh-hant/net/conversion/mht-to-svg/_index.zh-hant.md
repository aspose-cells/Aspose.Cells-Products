...
{{< blocks/products/pf/i18n/upper-banner h1="將 C# 中的 MHT 轉換為 SVG" h2="用於將 MHT 轉換為 SVG 的高速 C# 庫。這是一個專業的軟體解決方案，用於在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 MHT、07612381 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% cells-convert title="將 MHT 轉換為 SVG 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 MHT 轉換為 SVG" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 MHT 檔案轉換為 SVG？ .NET 開發人員只需幾行程式碼即可輕鬆載入 MHT 並將其轉換為 SVG。
...
1. 透過呼叫 Workbook.Save 方法將 MHT 轉換為 SVG。
1. 取得MHT到SVG的轉換結果。
