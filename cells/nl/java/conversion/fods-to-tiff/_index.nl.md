...
{{% blocks/products/pf/agp/content h2="Sla FODS op in TIFF in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar TIFF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar TIFF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar TIFF? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar TIFF met slechts een paar regels code.
