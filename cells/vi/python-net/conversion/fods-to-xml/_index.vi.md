---
title: Python FODS sang XML - Chuyển đổi FODS sang XML trực tuyến
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Trực tuyến miễn phí Python Chuyển đổi FODS sang định dạng lưu XML. Python FODS sang định dạng XML. Lưu FODS thành XML Python.
...
1.  Chuyển đổi FODS thành XML bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi của FODS sang XML.
