---
title: TXT'i SPREADSHEETML ile birleştir - TXT'i Java'deki SPREADSHEETML ile birleştir
url: /tr/java/merger/merge-txt-to-spreadsheetml/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i SPREADSHEETML kaydetme biçimiyle birleştirin. Java TXT'i SPREADSHEETML biçimiyle birleştirin. TXT'i Java'deki SPREADSHEETML ile birleştir. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'deki SPREADSHEETML ile birleştir" %}}

Aşağıdaki örnek, TXT'in Aspose.Cells for Java'deki SPREADSHEETML ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT'i SPREADSHEETML ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından bunu SPREADSHEETML dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT'i SPREADSHEETML ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT\'i Java\'deki SPREADSHEETML ile Birleştirecek Örnek Kod" InputFormat="txt" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT\'i SPREADSHEETML via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TXT'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, TXT\'i SPREADSHEETML ile birleştirecek" %}}
