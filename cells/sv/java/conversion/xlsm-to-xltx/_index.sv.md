---
title: Konvertera XLSM till XLTX via Java 
weight: 7030
url: /sv/java/conversion/xlsm-to-xltx/ 
description: Exempel på Java-konverteringskod för XLSM-format till XLTX-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLTX inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till XLTX med Java" %}}

 För att rendera XLSM till XLTX kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLSM-fil till XLTX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLTX-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLTX-filen
...
{{% blocks/products/pf/agp/code-block title="XLSM till XLTX Java konverteringskällkod" offSpacer="" %}}
