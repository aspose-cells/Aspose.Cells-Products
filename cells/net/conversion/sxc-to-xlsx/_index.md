...
description: Sample code for SXC to XLSX C# conversion. Use API example code for batch SXC files to XLSX conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells makes it easy for the developers to load & convert SXC files to XLSX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows SXC to XLSX C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert SXC to XLSX" sectionDescription="Check our live demos for [SXC to XLSX conversion](https://products.aspose.app/cells/conversion/sxc-to-xlsx) with following benefits." >}}
