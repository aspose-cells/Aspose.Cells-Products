---
title:  Sloučit JSON do POWERPOINT via Java
...
Následující příklad ukazuje, jak sloučit JSON do POWERPOINT v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení JSON do POWERPOINT online" InputFormat="json" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
