...
{{% cells-convert title="HTML\'i MHT\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML\'i C# aracılığıyla MHT\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

HTML dosyalarını programlı olarak MHT'ye dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyip MHT'ye dönüştürebilir.
