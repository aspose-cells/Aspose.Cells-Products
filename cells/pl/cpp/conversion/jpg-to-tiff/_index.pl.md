...
Trzeba programowo przekonwertować pliki JPG do formatu TIFF? Programiści C++ mogą łatwo przekonwertować pliki JPG do formatu TIFF za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JPG do TIFF wywołując metodę Save().
