...
url: /cs/python-java/merger/merge-fods-to-ett/ 
...
Následující příklad ukazuje, jak sloučit FODS do ETT v Aspose.Cells for Python via Java.
...
Potřebujete sloučit FODS do ETT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
