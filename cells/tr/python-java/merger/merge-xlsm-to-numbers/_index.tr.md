---
title: XLSM'i SAYILAR ile birleştir - XLSM'i Python'deki SAYILAR ile birleştir
url: /tr/python-java/merger/merge-xlsm-to-numbers/ 
description: Aspose excel. Python Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme XLSM ile NUMBERS kaydetme biçimi. Python XLSM'i SAYILAR biçiminde birleştirin. XLSM'i Python'deki NUMBERS ile birleştir. XLSM Birleştir.
...
Aşağıdaki örnek, XLSM'in Aspose.Cells for Python via Java'de NUMBERS ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLSM\'i Python\'deki SAYILARA Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xlsm" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLSM\'i Python aracılığıyla SAYILAR\'a Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLSM'i programlı olarak NUMBERS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
