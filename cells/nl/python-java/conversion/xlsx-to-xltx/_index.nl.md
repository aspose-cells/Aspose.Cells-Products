...
description: Aspose Excel. Converteer XLSX snel en eenvoudig naar XLTX met Aspose.Cells. Python XLSX naar XLTX. Python Bewaar XLSX in XLTX. Bewaar XLSX als 07611134 81 via Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLSX naar XLTX in Python" h2="Snelle Python-bibliotheek voor het converteren van XLSX naar XLTX. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, XLTX en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer XLSX naar XLTX met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLSX t/m XLTX in Python" %}}

Het volgende voorbeeld laat zien hoe u XLSX converteert naar XLTX in Python.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLSX naar XLTX te converteren" %}}
