---
title: Sloučit JPEG až GIF - Sloučit JPEG až GIF v Java
url: /cs/java/merger/merge-jpeg-to-gif/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma JPEG do formátu uložení GIF. Java Kombinujte formát JPEG až GIF. Sloučit JPEG až GIF v Java. JPEG Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG až GIF pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG až GIF v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JPEG až GIF v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPEG do GIF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru GIF. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí JPEG do GIF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit JPEG do GIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JPEG až GIF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení JPEG až GIF" %}}
