...
{{% cells-convert title="Gratis app och provkod för att konvertera PNG till DOCX online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="docx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar PNG till DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera PNG till DOCX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1.  Ladda PNG-filen med en instans av Workbook-klassen
1.  Konvertera PNG till DOCX genom att anropa metoden Workbook.save
