---
title: C# ODS a XLAM - ODS a XLAM Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato XLAM, permitindo o salvamento perfeito de dados ODS no formato XLAM usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a XLAM em C#" %}}

exemplo a seguir demonstra como converter ODS em XLAM em C#.
...
{{% cells-convert title="Código de exemplo para converter ODS em XLAM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="xlam" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS em XLAM por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em XLAM programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em XLAM em apenas algumas linhas de código.
...
1.  Converta ODS para XLAM chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em XLAM" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/conversion/ods-to-xml/" name="ODS PARA XML" description="Linguagem de Marcação Extensível" >}}
