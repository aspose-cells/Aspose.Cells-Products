...
{{% blocks/products/pf/agp/content h2="Comment insérer une forme de flèche incurvée dans un fichier Excel à l\'aide de Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une forme de flèche incurvée dans un fichier Excel à l\'aide de Python via .Net" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de la collection de formes[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) pour insérer une forme de flèche incurvée dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer une forme de flèche incurvée - Python via .Net" offSpacer="" %}}
