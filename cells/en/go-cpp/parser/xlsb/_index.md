...
description: Go via C++ example code to extract text and images from XLSB file on Go via C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
