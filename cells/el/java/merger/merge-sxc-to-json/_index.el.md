---
title:  Συγχώνευση SXC σε JSON via Java
url: /el/java/merger/merge-sxc-to-json/ 
description: Συγχώνευση SXC σε JSON Online δωρεάν. Δωρεάν Online SXC έως JSON Συγχώνευση. Συγχώνευση SXC σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το SXC με το JSON στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση SXC με JSON σε απευθείας σύνδεση" InputFormat="sxc" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
