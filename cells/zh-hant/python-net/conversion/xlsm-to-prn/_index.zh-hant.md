...
description: Aspose Excel。此綜合解決方案為 Python 開發人員提供了一種完全整合的方法，可將 XLSM 轉換為 PRN 格式，從而能夠使用 Aspose.Cells 庫將 XLSM 資料無縫保存為 PRN 格式，所有這些都透過高效能客製化的 081533481 1081481 0813481。
...
{{% blocks/products/pf/agp/content h2="在 Python Excel 庫中將 XLSM 轉換為 PRN" %}}
...
{{% blocks/products/pf/agp/content h2="將 XLSM 儲存到 Python Excel 庫中的 PRN" %}}

以下範例示範如何將 Python excel 庫中的 XLSM 轉換為 PRN。
...
{{% cells-convert title="透過 Python Excel 庫將 XLSM 轉換為 PRN 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsm" outformat="prn" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 XLSM 轉換為 PRN" %}}
