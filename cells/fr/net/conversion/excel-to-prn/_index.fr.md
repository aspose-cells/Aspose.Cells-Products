...
Besoin de convertir des fichiers EXCEL en PRN par programme ? .NET peuvent facilement charger et convertir EXCEL en PRN en quelques lignes de code seulement.
...
1. Convertissez le fichier EXCEL au format PRN en appelant la méthode Workbook.Save.
