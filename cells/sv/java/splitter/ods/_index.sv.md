---
title:  Split ODS Filer via Java
weight: 1950
description: Java exempelkod för att dela ODS dokument på Java Runtime Environment för JSP/JSF Application och Desktop Applications.
...
{{% blocks/products/pf/agp/content h2="Hur man delar upp ODS-fil med Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Split ODS Fil - Java" offSpacer="" %}}
