...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 CSV 转换为 TABDELIMITED。 C# CSV 转换为 TABDELIMITED。 C# 将 CSV 保存到制表符。使用 C# 将 CSV 保存为 TABDELIMITED。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 CSV 转换为 C# 中的 TABDELIMITED" h2="用于将 CSV 转换为 TABDELIMITED 的高速 C# 库。这是一个专业的软件解决方案，可在 .NET Framework、.NET Core 或 Mono 平台上导入和导出 CSV、TABDELIMITED 和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="将 CSV 保存为 C# 中的 TABDELIMITED" %}}

以下示例演示如何将 CSV 转换为 C# 中的 TABDELIMITED。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 CSV 转换为 TABDELIMITED。上传 CSV 文件，然后将其保存为 TABDELIMITED 文件。对于 CSV 读取和 TABDELIMITED 写入，您可以使用完全限定的文件名。输出 TABDELIMITED 内容和格式将与原始 CSV 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="将 CSV 转换为 TABDELIMITED 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 CSV 转换为 TABDELIMITED" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 CSV 文件转换为 TABDELIMITED 吗？ .NET 开发人员只需几行代码即可轻松加载 CSV 并将其转换为 TABDELIMITED。
