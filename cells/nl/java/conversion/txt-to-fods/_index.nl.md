...
{{% blocks/products/pf/agp/content h2="Sla TXT op in FODS in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar FODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar FODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar FODS? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar FODS met slechts een paar regels code.
