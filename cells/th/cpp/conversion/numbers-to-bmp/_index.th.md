---
title: C++ NUMBERS เป็น BMP - ตัวแปลง NUMBERS เป็น BMP ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง NUMBERS เป็น BMP saveformat รูปแบบ C++ NUMBERS ถึง BMP บันทึกหมายเลขไปที่ BMP C++
...
{{% blocks/products/pf/agp/content h2="บันทึก NUMBERS ไปที่ BMP ใน C++ ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีแปลง NUMBERS เป็น BMP ใน C++
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง NUMBERS เป็น BMP ผ่าน C++" %}}
...
1.  แปลง NUMBERS เป็น BMP โดยเรียกเมธอด Save()
1.  รับผลการแปลง NUMBERS เป็น BMP

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ไลบรารี C++ เพื่อแปลง NUMBERS เป็น BMP" %}}
