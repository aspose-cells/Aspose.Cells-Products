---
title: Combinar PRN con TIFF - Combinar PRN con TIFF en Java
url: /es/java/merger/merge-prn-to-tiff/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea PRN a TIFF guardar formato. Java Combina PRN con formato TIFF. Combinar PRN a TIFF en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN a TIFF en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar PRN con TIFF en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar PRN con TIFF. Cargue sus archivos, llame al método Workbook.Combine para combinar archivos y luego guárdelo en el archivo TIFF. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona PRN con TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar PRN a TIFF en Java" InputFormat="prn" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN a TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar PRN con TIFF mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar PRN a TIFF" %}}
