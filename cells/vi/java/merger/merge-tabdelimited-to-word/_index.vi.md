---
title: Gộp TABDELIMITED thành WORD - Gộp TABDELIMITED thành WORD trong Java
url: /vi/java/merger/merge-tabdelimited-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất TABDELIMITED thành WORD định dạng lưu. Java Kết hợp TABDELIMITED thành định dạng WORD. Hợp nhất TABDELIMITED thành WORD trong Java. TABDELIMITED Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất TABDELIMITED thành WORD trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất TABDELIMITED thành WORD trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất TABDELIMITED với WORD. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu vào tệp WORD. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất TABDELIMITED thành WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất TABDELIMITED thành WORD trong Java" InputFormat="tsv" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp TABDELIMITED thành WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất TABDELIMITED thành WORD theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất TABDELIMITED thành WORD" %}}
