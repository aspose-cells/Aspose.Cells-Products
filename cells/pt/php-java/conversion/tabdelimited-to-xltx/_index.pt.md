...
description: Aspose Excel. Converta TABDELIMITED em XLTX de forma rápida e fácil com Aspose.Cells. PHP TABDELIMITED em XLTX. PHP Salve TABDELIMITED em XLTX. Salve TABDELIMITED como XLTX usando PHP.
...
Precisa converter arquivos TABDELIMITED para XLTX programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TABDELIMITED em XLTX em apenas algumas linhas de código.
...
1.  Converta TABDELIMITED em XLTX chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TABDELIMITED para XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED para XLTX" %}}
