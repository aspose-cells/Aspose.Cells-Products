...
description: Aspose اكسل. قم بتحويل MHT إلى XLTM بسرعة وسهولة باستخدام Aspose.Cells. C++ MHT إلى XLTM. C++ احفظ MHT إلى XLTM. احفظ MHT كـ XLTM باستخدام C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT على XLTM في C++" %}}
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xltm" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى XLTM عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى XLTM برمجياً؟ يمكن لمطوري C++ تحويل MHT بسهولة إلى XLTM في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLTM عن طريق استدعاء طريقة Save ().
