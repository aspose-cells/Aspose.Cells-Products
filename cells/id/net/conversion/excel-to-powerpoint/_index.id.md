---
title: C# EXCEL ke POWERPOINT - Konverter EXCEL ke POWERPOINT Online
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Online Gratis C# Convert EXCEL to POWERPOINT saveformat. C# EXCEL ke format POWERPOINT. Simpan EXCEL ke POWERPOINT C#.
...
{{% blocks/products/pf/agp/content h2="Simpan EXCEL ke POWERPOINT di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi EXCEL ke POWERPOINT di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengonversi EXCEL ke POWERPOINT. Unggah file EXCEL Anda, lalu simpan sebagai file POWERPOINT. Untuk pembacaan EXCEL dan penulisan POWERPOINT, Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format output POWERPOINT akan identik dengan dokumen EXCEL asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi EXCEL ke POWERPOINT Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Konversi EXCEL ke POWERPOINT melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke POWERPOINT secara terprogram? .NET pengembang dapat dengan mudah memuat & mengonversi EXCEL ke POWERPOINT hanya dalam beberapa baris kode.
...
1.  Ubah EXCEL menjadi POWERPOINT dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi EXCEL ke POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# perpustakaan untuk mengonversi EXCEL ke POWERPOINT" %}}
