---
title: Преобразователь C# XLTM в JSON - XLTM в JSON
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в JSON в C#" %}}
...
Нужно программно преобразовать файлы XLTM в JSON? Разработчики .NET могут легко загрузить и преобразовать XLTM в JSON всего за несколько строк кода.
...
1.  Преобразуйте значение XLTM в JSON, вызвав метод Workbook.Save.
1.  Получите результат преобразования XLTM в JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XLTM в JSON" %}}
