---
title:  Buscar y reemplazar texto en XLSM documento via Java
weight: 1590
description: Java código de muestra para redactar información confidencial en el archivo XLSM en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Redactar XLSM Formatos en Java" h2="Nativo y de alto rendimiento XLSM información confidencial de redacción de documentos utilizando API Aspose.Cells for Java del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/code-block title="Redactar XLSM Archivos - Java" offSpacer="" %}}
