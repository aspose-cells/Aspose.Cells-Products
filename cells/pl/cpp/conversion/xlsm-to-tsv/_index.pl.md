---
title: Konwertuj XLSM na TSV za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlsm-to-tsv/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSM do formatu TSV. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSM do TSV w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSM na TSV w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (TSV).1. Plik TSV zostanie zapisany pod określoną ścieżką.1. Otwórz plik TSV w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSM do TSV C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo konwersji XLSM na TSV" sectionDescription="[Konwertuj XLSM na TSV](https://products.aspose.app/cells/conversion/xlsm-to-tsv) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLSM, zostanie on natychmiast przekonwertowany do TSV." >}}
