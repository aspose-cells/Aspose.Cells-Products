---
title: C++ 修复 xlsm - 恢复并修复损坏的 xlsm 文件
url: /zh/cpp/recovery/repair-xlsm/ 
description: C++ Aspose.Cells.修复xlsm。修复 xlsm 文件。 xlsm恢复工具。 xlsm 腐败。恢复 xlsm 数据。 xlsm 文件恢复。恢复损坏的 xlsm 文件。
...
{{% cells-recovery title="修复 XLSM 文件的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xlsm" outformat="xlsm" IsLandingPage="true" language="cpp" %}}    
