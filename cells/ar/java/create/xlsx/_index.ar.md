---
title: إنشاء ملفات MS Excel XLSX via Java
description: XLSX مبتكر. إنشاء XLSX ملفات في Java كود. قم بإنشاء ملفات MS Excel XLSX باستخدام تطبيق ويب أو سطح مكتب يستند إلى Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء XLSX ملف via Java" h2="إنشاء جداول بيانات MS Excel XLSX أصلي وعالي الأداء برمجيًا باستخدام مكتبة Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="قم بإنشاء ملف XLSX باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء XLSX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح كود المصدر التالي كيفية إنشاء ملف MS Excel XLSX باستخدام Java." offSpacer="" %}}
