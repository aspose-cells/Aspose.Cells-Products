...
description: Aspose エクセル。 C++ Aspose.Cells。HTML を MHTML の保存形式にマージします。 C++ HTML と MHTML の形式を結合します。 HTML から MHTML を C++ に結合します。HTML を結合します。
