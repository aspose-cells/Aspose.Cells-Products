---
title:  Inserisci CheckBox (controllo modulo) in Excel utilizzando Python via java
weight: 30
description: Python via codice sorgente java per inserire CheckBox (controllo modulo) in Excel.
---
...
{{% blocks/products/pf/agp/content h2="Come inserire CheckBox (controllo modulo) nel file Excel utilizzando Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire CheckBox (controllo modulo) nel file Excel utilizzando Python via java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa la collezione di forme[aggiungere metodo](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) per inserire un CheckBox(Controllo modulo) nel foglio di lavoro selezionato.
...
{{% blocks/products/pf/agp/code-block title="Inserisci CheckBox(Controllo modulo) - Python via java" offSpacer="" %}}
