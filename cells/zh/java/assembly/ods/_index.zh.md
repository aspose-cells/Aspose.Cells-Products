---
title: 通过 Java 在 ODS 文件中生成报告 
weight: 2440

description: Java 示例代码，用于在 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中创建 ODS 格式报告。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 以 ODS 格式批量生成报告" h2="使用数据源和模板生成 ODS 格式的报告。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 生成 ODS 报告" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 生成 ODS 报告的步骤" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. 实例化 WorkbookDesigner 类1. 在 ArrayList 中添加 Datasouce 对象1. 为 WorkbookDesigner 对象设置数据源和流程1. 通过 Worbook.save 方法以 ODS 格式保存结果
...
{{% blocks/products/pf/agp/code-block title="生成 ODS 格式的 Excel 报告 - C#" offSpacer="" %}}
