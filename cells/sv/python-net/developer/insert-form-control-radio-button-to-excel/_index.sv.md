---
title:  Infoga RadioButton (formulärkontroll) i Excel med Python via .Net
weight: 60
description: Python via .Net-källkod för att infoga RadioButton (formulärkontroll) i Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Infoga RadioButton (formulärkontroll) i Excel med Python via .Net" h2="Infoga objekt med hjälp av API:er på serversidan utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man infogar RadioButton (formulärkontroll) i Excel-fil med Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga RadioButton (formulärkontroll) till Excel-fil med Python via .Net" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens tillägg[metod](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_radio_button/#int-int-int-int-int-int) för att infoga en RadioButton (formulärkontroll) i det valda arbetsbladet.
...
{{% blocks/products/pf/agp/code-block title="Sätt in RadioButton (formulärkontroll) - Python via .Net" offSpacer="" %}}
