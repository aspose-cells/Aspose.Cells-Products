...
description: Aspose Exceller. Python Exceller. Fusionnez XLS au format de sauvegarde EXCEL. Python Combinez XLS au format EXCEL. Fusionnez XLS avec EXCEL dans la bibliothèque Excel Python. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS avec EXCEL à l\'aide de la bibliothèque Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS avec EXCEL dans la bibliothèque Excel Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner XLS avec EXCEL dans la bibliothèque Excel Python" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS vers EXCEL via la bibliothèque Excel Python" %}}
