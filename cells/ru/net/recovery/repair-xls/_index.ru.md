...
{{< blocks/products/pf/i18n/upper-banner h1="Восстановить файл XLS в C#." h2="Создайте собственное приложение .NET для восстановления файлов xls, используя .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLS" fileiconsmall2="XLSB" fileiconsmall3="XLSX" fileiconsmall4="XLSM" fileiconsmall5="ODS" >}}
...
Нужно восстановить файл xls программным способом? Разработчики .NET могут легко загрузить и восстановить файл xls всего за несколько строк кода.
...
{{% cells-recovery title="Пример кода для восстановления файла XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="net" %}}    
