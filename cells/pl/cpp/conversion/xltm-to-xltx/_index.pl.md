---
title: Konwertuj XLTM na XLTX za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xltm-to-xltx/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLTM do formatu XLTX. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLTM na XLTX w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLTM na XLTX przez C++" h2="Wysokowydajna konwersja XLTM do XLTX przy użyciu biblioteki C++ bez konieczności instalowania Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLTM na XLTX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLTX).1. Plik XLTX zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLTX w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji XLTM na XLTX C++" offSpacer="" %}}
