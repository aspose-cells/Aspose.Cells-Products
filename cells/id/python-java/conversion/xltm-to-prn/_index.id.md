...
description: Aspose Unggul. Ubah XLTM menjadi PRN dengan cepat dan mudah dengan Aspose.Cells. Python XLTM menjadi PRN. Python Simpan XLTM ke PRN. Simpan XLTM sebagai PRN menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Simpan XLTM ke PRN di Python" %}}
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLTM ke PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="prn" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengonversi XLTM ke PRN" %}}
