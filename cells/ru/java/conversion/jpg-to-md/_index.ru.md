...
description: Aspose Эксель. Конвертируйте JPG в MD быстро и легко с помощью Aspose.Cells. Java JPG в MD. Java Сохранить JPG на MD. Сохраните JPG как MD, используя Java.
...
{{% blocks/products/pf/agp/content h2="Сохранить JPG в MD по номеру Java." %}}

В следующем примере показано, как преобразовать JPG в MD по номеру Java.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы преобразовать JPG в MD. Загрузите свой файл JPG, а затем просто сохраните его как файл MD. Как для чтения JPG, так и для записи MD вы можете использовать полные имена файлов. Содержимое и форматирование выходного мини-диска будут идентичны исходному документу JPG.
...
Вам нужно программно конвертировать файлы JPG в MD? Разработчики Java могут легко конвертировать JPG в MD всего за несколько строк кода.
...
1.  Получите результат конвертации JPG в MD.
