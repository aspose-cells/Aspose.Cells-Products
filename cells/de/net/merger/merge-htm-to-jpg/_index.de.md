---
title: HTM zu JPG zusammenführen – Kombinieren Sie HTM zu JPG in C#
url: /de/net/merger/merge-htm-to-jpg/ 
description: Aspose Excel. C# Aspose.Cells. Kostenlose Online-Zusammenführung von HTM in das JPG-Speicherformat. C# Kombinieren Sie HTM mit dem JPG-Format. HTM in JPG in C# zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie HTM in JPG in C# kostenlos online zusammen" %}}

Das folgende Beispiel zeigt, wie HTM in JPG in Aspose.Cells for .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um HTM in JPG zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann als JPG-Datei. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das HTM in JPG zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlos online zum Zusammenführen von HTM zu JPG in C#" InputFormat="htm" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie HTM mit JPG über C# zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM programmgesteuert in JPG zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von HTM in JPG" %}}
