...
description: Aspose Excel โซลูชันที่ครอบคลุมนี้มอบแนวทางแบบบูรณาการอย่างสมบูรณ์แก่ผู้พัฒนา C# ในการแปลง XLSB เป็นรูปแบบ XLSB ทำให้สามารถบันทึกข้อมูล XLSB ลงในรูปแบบ XLSB ได้อย่างราบรื่นโดยใช้ไลบรารี Aspose.Cells ทั้งหมดนี้ผ่านโค้ด C# ที่มีประสิทธิภาพและปรับแต่งได้
...
{{% blocks/products/pf/agp/content h2="บันทึกหมายเลข XLSB เป็น XLSB ในหมายเลข C#" %}}

ตัวอย่างต่อไปนี้แสดงวิธีการแปลง XLSB เป็น XLSB ใน C#
...
1.  แปลง XLSB เป็น XLSB โดยเรียกใช้เมธอด Workbook.Save
1.  รับผลลัพธ์การแปลงจาก XLSB เป็น XLSB

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ไลบรารี C# เพื่อแปลง XLSB เป็น XLSB" %}}
