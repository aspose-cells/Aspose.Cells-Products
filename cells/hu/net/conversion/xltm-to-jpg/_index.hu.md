---
title: C# XLTM - JPG - XLTM - JPG konverter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára a XLTM JPG formátumba konvertálásához, lehetővé téve a XLTM adatok zökkenőmentes mentését JPG formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentse el a XLTM-es számot JPG formátumban a C#-es fájlban" %}}

A következő példa bemutatja, hogyan konvertálhatja a XLTM fájlt JPG formátumba a C# fájlban.
...
{{% blocks/products/pf/agp/content h2="A XLTM konvertálása JPG-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell konvertálnia a XLTM fájlokat JPG formátumba? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal JPG formátumba konvertálhatják a XLTM-et.
...
1.  Alakítsd át a XLTM-et JPG formátumba a Workbook.Save metódus meghívásával.
1.  Szerezze meg a XLTM konvertálási eredményt JPG-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTM JPG-vé konvertálásához" %}}
