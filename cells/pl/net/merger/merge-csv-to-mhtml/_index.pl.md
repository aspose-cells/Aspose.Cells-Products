---
title: Połącz CSV z MHTML - Połącz CSV z MHTML w C#
url: /pl/net/merger/merge-csv-to-mhtml/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online CSV do MHTML w formacie zapisu. C# Połącz format CSV z MHTML. Połącz CSV z MHTML w C#. CSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz CSV z MHTML w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć CSV z MHTML w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć CSV z MHTML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku MHTML. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy numery CSV z MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z MHTML w C#" InputFormat="csv" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z MHTML za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić CSV z MHTML programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
