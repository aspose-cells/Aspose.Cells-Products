---
title: PHP XLT إلى JPEG - XLT إلى JPEG محول
description: Aspose اكسل. قم بتحويل XLT إلى JPEG بسرعة وسهولة باستخدام Aspose.Cells. PHP XLT إلى JPEG. PHP احفظ XLT إلى JPEG. احفظ XLT كـ JPEG باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLT إلى JPEG عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLT إلى JPEG برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLT إلى JPEG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLT إلى JPEG عن طريق استدعاء طريقة حفظ المصنف.
