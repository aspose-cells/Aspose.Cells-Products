---
title: Scal NUMBERS do SPREADSHEETML - Połącz NUMBERS do SPREADSHEETML w Java
url: /pl/java/merger/merge-numbers-to-spreadsheetml/ 
description: Aspose Excel. Java Aspose.Cells. Scal NUMBERS, aby zapisać format SPREADSHEETML. Java Połącz NUMERY w formacie SPREADSHEETML. Scal NUMBERS z SPREADSHEETML w Java. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMBERS z arkuszem kalkulacyjnym w Java" %}}

Poniższy przykład ilustruje sposób scalania NUMBERS z SPREADSHEETML w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć NUMERY z arkuszem kalkulacyjnym. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku SPREADSHEETML. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMBERS z SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod umożliwiający połączenie NUMBERS z arkuszem kalkulacyjnym w Java" InputFormat="numbers" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć NUMERY z arkuszem kalkulacyjnym via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić NUMBERS z SPREADSHEETML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do scalania NUMBERS z arkuszem kalkulacyjnym" %}}
