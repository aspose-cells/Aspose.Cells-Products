---
title: C# XLS bis DIF - XLS bis DIF Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das Format DIF und ermöglicht das nahtlose Speichern von XLS-Daten im Format DIF mithilfe der Aspose.Cells-Bibliothek – alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis DIF in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in C# in DIF umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in DIF" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in DIF konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in DIF laden und konvertieren.
...
1.  Konvertieren Sie XLS in DIF durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in DIF" %}}
