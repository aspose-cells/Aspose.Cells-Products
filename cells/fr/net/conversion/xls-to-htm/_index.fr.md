---
title: Convertisseur C# XLS vers HTM - XLS vers HTM
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir XLS au format HTM, permettant un enregistrement transparent des données XLS au format HTM à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS dans HTM en C#" %}}

L'exemple suivant montre comment convertir XLS en HTM en C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en HTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XLS en HTM par programmation ? Les développeurs .NET peuvent facilement charger et convertir des fichiers XLS en HTM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en HTM" %}}
