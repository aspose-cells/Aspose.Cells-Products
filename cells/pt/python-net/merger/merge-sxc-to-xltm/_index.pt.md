...
description: Aspose Excel. Python Excel. Mesclar SXC com XLTM salvar formato. Python Combine o formato SXC com XLTM. Mesclar SXC com XLTM na Biblioteca Excel Python. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC a XLTM usando a biblioteca Python do Excel" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC com XLTM na Biblioteca Excel Python" %}}

exemplo a seguir demonstra como mesclar SXC com XLTM em Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Exemplo de código para mesclar SXC a XLTM na biblioteca Python do Excel" InputFormat="sxc" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC a XLTM por meio da biblioteca Python Excel" %}}
