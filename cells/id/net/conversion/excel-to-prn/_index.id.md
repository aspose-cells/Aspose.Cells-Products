---
title: C# EXCEL ke PRN - Konverter EXCEL ke PRN
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi EXCEL ke format PRN, memungkinkan penyimpanan data EXCEL ke format PRN dengan mudah menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversi EXCEL ke PRN di C#" h2="Pustaka berkecepatan tinggi C# untuk mengkonversi EXCEL ke PRN. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor EXCEL, PRN, dan banyak format lainnya pada Framework .NET, Core .NET, atau Platform Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan EXCEL ke PRN di C#" %}}

Contoh berikut menunjukkan cara mengkonversi EXCEL ke PRN di C#.
...
{{% blocks/products/pf/agp/content h2="Cara Convert EXCEL ke PRN lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke PRN secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi EXCEL ke PRN hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="C# pustaka untuk mengkonversi EXCEL ke PRN" %}}
