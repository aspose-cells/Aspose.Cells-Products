---
title: EXCEL'i PDF ile birleştir - EXCEL'i C++'de PDF ile birleştir
url: /tr/cpp/merger/merge-excel-to-pdf/ 
description: Aspose excel. C++ Aspose.Cells. EXCEL'i PDF kaydetme biçimiyle Ücretsiz Çevrimiçi Birleştirme. C++ EXCEL'i PDF biçimiyle birleştirin. EXCEL'i C++'de PDF ile birleştirin. EXCEL Birleştirin.
...
Aşağıdaki örnek, EXCEL'in Aspose.Cells for C++'de PDF ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="EXCEL\'i C++\'de PDF ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xlsx" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C++ aracılığıyla PDF ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i programlı olarak PDF ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
