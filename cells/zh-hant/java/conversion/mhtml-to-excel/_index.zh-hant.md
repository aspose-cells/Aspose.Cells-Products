...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHTML 轉換為 EXCEL。Java MHTML 轉換為 EXCEL。 Java 將 MHTML 儲存到 EXCEL。使用 Java 將 MHTML 另存為 EXCEL。
...
{{% blocks/products/pf/agp/content h2="將 MHTML 儲存到 EXCEL 中 Java" %}}

下面的範例示範如何將MHTML轉換為EXCEL中的Java。
...
{{% cells-convert title="將 MHTML 轉換為 EXCEL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 MHTML 轉換為 EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 MHTML 檔案轉換為 EXCEL？ Java開發人員只需幾行程式碼即可輕鬆將MHTML轉換為EXCEL。
...
{{% blocks/products/pf/agp/content h2="Java庫將MHTML轉換為EXCEL" %}}
{{% blocks/products/pf/agp/text %}}
