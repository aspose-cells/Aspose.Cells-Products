...
weight: 800
description: C++ codice di esempio per inserire Stars And Banners nel file Excel su C++ Runtime Environment per Windows 32 bit, Windows 64 bit e Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci stelle e banner in Excel tramite C++" h2="Inserisci oggetti utilizzando il nativo e ad alte prestazioni del lato server Aspose.Cells for C++ API senza utilizzare alcun software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire stelle e banner in un file Excel utilizzando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire Stars And Banners nel file Excel tramite C++" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ab8156e8562724f9a597b7d2bc503cd4d) per inserire Stars And Banners nel foglio di lavoro selezionato
