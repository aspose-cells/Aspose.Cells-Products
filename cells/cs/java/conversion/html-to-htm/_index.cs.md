---
title: Java HTML do HTM - HTML do HTM převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu HTML do formátu HTM, což umožňuje bezproblémové ukládání dat HTML do formátu HTM pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte HTML na HTM v kódu Java" h2="Vysokorychlostní knihovna Java pro převod HTML do HTM. Jedná se o profesionální softwarové řešení pro import a export HTML, HTM a mnoha dalších formátů pomocí Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Uložit HTML do HTM v Java" %}}

Následující příklad ukazuje, jak převést číslo HTML na HTM v kódu Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod souboru HTML do formátu HTM. Nahrajte soubor HTML a poté jej jednoduše uložte jako soubor HTM. Pro čtení i zápis souboru HTML v souboru HTM můžete použít plně kvalifikované názvy souborů. Výstupní obsah a formátování HTM bude identické s původním dokumentem HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod HTML na HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="htm" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak převést HTML na HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory HTML do formátu HTM? Vývojáři Java mohou snadno převést soubory HTML do formátu HTM pomocí několika řádků kódu.
...
1.  Převeďte číslo HTML na HTM voláním metody Workbook.save.
1.  Získejte výsledek převodu HTML na HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod HTML do HTM" %}}
{{% blocks/products/pf/agp/text %}}
