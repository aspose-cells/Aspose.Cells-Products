...
url: /hu/python-java/merger/merge-xls-to-pdf/ 
...
A következő példa bemutatja a XLS és PDF egyesítését a Aspose.Cells for Python via Java számban.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLS-et a PDF-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
