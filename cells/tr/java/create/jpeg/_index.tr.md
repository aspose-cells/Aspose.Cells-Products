...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde JPEG Dosyası oluşturun. Java'i kullanarak JPEG dosyası oluşturun. Java'de JPEG oluşturun. Java JPEG Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını JPEG biçiminde kaydedin.
