---
title: تحويل XLS إلى EMF عبر Java 
weight: 4350
url: /ar/java/conversion/xls-to-emf/ 
description: نموذج رمز تحويل Java لتنسيق XLS إلى ملف EMF. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى EMF داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLS إلى EMF عبر Java" h2="XLS إلى EMF Java لتحويل صفحات مفردة أو متعددة إلى EMF باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى EMF باستخدام Java" %}}

 من أجل تقديم XLS إلى EMF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLS إلى EMF عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف XLS إلى EMF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLS بمثيل مصنف1. حدد الافتراضي أو أي ورقة عمل من المجموعة1. إنشاء وتعيين كائن ImageOrPrintOptions1. قم بإنشاء SheetRender باستخدام كائنات ورقة العمل و ImageOrPrintOptions1. طريقة Call SheetRender.toImage لحفظ النتيجة بتنسيق EMF
...
{{% blocks/products/pf/agp/code-block title="XLS إلى EMF Java شفرة مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل XLS إلى EMF" sectionDescription="[تحويل XLS إلى EMF](https://products.aspose.app/cells/conversion/xls-to-emf) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف XLS الخاص بك ، وسيتم تحويله على الفور إلى EMF." >}}
