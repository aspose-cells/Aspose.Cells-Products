---
title: Insert Star/Banner into Excel using Python via Java
weight: 381
...
{{% blocks/products/pf/agp/content h2="How to Insert Star/Banner into Excel File Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Star/Banner to Excel file using Python via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) to insert Star/Banner in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert Star/Banner - Python via Java" offSpacer="" %}}
