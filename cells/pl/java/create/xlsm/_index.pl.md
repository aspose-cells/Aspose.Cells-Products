---
title: Utwórz pliki MS Excel XLSM via Java
description: XLSM twórca. Utwórz pliki XLSM w kodzie Java. Generuj pliki MS Excel XLSM za pomocą aplikacji komputerowej lub internetowej opartej na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Utwórz plik XLSM via Java" h2="Natywne i wydajne tworzenie arkuszy kalkulacyjnych MS Excel XLSM programowo przy użyciu biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć XLSM via Java" %}}
...
1.  Zapisz skoroszyt w formacie XLSM przy użyciu metody save().

{{% blocks/products/pf/agp/code-block title="Poniższy kod źródłowy pokazuje, jak utworzyć plik MS Excel XLSM przy użyciu Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do utworzenia pliku XLSM" %}}
{{% blocks/products/pf/agp/text %}}
