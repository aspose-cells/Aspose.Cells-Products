...
weight: 101
description: C# نموذج التعليمات البرمجية لإضافة أو إدراج شكل منحني في Excel باستخدام مكتبة .NET. استخدم هذا الرمز لإنشاء شكل منحني في MS Excel ضمن VB.NET أو Asp.NET أو أي تطبيق يستند إلى .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج شكل منحني في ملف اكسيل عبر الرقم C#" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) لإدراج شكل منحني في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج شكل منحني - C#" offSpacer="" %}}
