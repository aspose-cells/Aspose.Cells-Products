---
title: Sloučit SPREADSHEETML do POWERPOINT – Zkombinujte SPREADSHEETML do POWERPOINT v Java
url: /cs/java/merger/merge-spreadsheetml-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. Sloučte SPREADSHEETML do formátu uložení POWERPOINT. Java Zkombinujte SPREADSHEETML s formátem POWERPOINT. Sloučit SPREADSHEETML do POWERPOINT v Java. SPREADSHEETML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit SPREADSHEETML do POWERPOINT v Java" %}}

Následující příklad ukazuje, jak sloučit SPREADSHEETML do POWERPOINT v Aspose.Cells for Java.
...
{{% cells-merger title="Ukázkový kód pro sloučení SPREADSHEETML do POWERPOINT v Java" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit SPREADSHEETML do POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit SPREADSHEETML do POWERPOINT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovnu pro sloučení SPREADSHEETML do POWERPOINT" %}}
