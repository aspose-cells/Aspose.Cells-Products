---
title: Conversor PHP XLTX para TXT - XLTX para TXT
description: Aspose Excel. Converta XLTX em TXT de forma rápida e fácil com Aspose.Cells. PHP XLTX em TXT. PHP Salve XLTX em TXT. Salve XLTX como TXT usando PHP.
...
{{% cells-convert title="Exemplo de código para converter XLTX em TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="txt" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLTX em TXT via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em TXT programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em TXT em apenas algumas linhas de código.
...
1.  Converta XLTX em TXT chamando o método save da pasta de trabalho.
