...
url: /nl/python-net/merger/merge-xlt-to-markdown/ 
...
Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met MARKDOWN in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLT programmatisch samenvoegen tot MARKDOWN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
