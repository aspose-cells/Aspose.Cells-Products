...
description: Sample Java conversion code for EXCEL format to WORD file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to WORD within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert EXCEL to WORD Using Java" %}}
 ...
 In order to render EXCEL to WORD, we’ll use
