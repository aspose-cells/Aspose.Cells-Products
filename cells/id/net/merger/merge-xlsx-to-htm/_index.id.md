...
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSX ke format simpan HTM. C# Gabungkan XLSX ke format HTM. Gabung XLSX ke HTM di C#. XLSX Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSX ke HTM di C#" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLSX ke HTM di C#" InputFormat="xlsx" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSX ke HTM melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan XLSX ke HTM secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
