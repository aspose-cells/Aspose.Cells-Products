...
url: /de/net/merger/merge-htm-to-numbers/ 
...
Das folgende Beispiel zeigt, wie HTM mit NUMBERS in Aspose.Cells for .NET zusammengeführt wird.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Müssen Sie HTM programmgesteuert mit NUMBERS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von HTM mit NUMBERS" %}}
