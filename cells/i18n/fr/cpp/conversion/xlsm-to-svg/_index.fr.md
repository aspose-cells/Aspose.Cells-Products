---
title: Convertissez XLSM en SVG via l'application C++ 
url: /fr/cpp/conversion/xlsm-to-svg/ 
description: Exemple de code de conversion C++ pour le document XLSM au format SVG. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLSM en SVG dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSM en SVG via C++" h2="Conversion XLSM vers SVG haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSM en SVG en utilisant C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLSM en SVG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier XLSM en SVG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLSM à l'aide de Factory :: CreateIWorkbook.1. Sélectionnez la première feuille de calcul.1. Définir les options (SVG).1. Parcourez chaque page de la feuille et effectuez le rendu.1. Ouvrez le fichier SVG dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLSM vers SVG C++" offSpacer="" %}}
