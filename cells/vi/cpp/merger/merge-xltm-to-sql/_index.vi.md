---
title: Hợp nhất XLTM thành SQL - Hợp nhất XLTM thành SQL trong C++
url: /vi/cpp/merger/merge-xltm-to-sql/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất XLTM thành định dạng lưu SQL. C++ Kết hợp XLTM thành định dạng SQL. Hợp nhất XLTM thành SQL vào C++. XLTM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLTM thành SQL trong C++" %}}

Ví dụ sau đây minh họa cách hợp nhất XLTM với SQL trong Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất XLTM với SQL. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SQL. Nếu bạn phát triển mã theo số C++, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C++ hợp nhất XLTM với SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu để hợp nhất XLTM thành SQL trong C++" InputFormat="xltm" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất XLTM với SQL thông qua C++" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ để hợp nhất XLTM thành SQL" %}}
