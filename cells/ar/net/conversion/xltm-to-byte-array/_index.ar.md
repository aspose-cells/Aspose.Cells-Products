...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل XLTM إلى صفيف بايت عبر C#" %}}
...
{{% blocks/products/pf/agp/code-block title="يظهر رمز العينة هذا XLTM لتحويل مصفوفة البايت C#" offSpacer="" %}}
