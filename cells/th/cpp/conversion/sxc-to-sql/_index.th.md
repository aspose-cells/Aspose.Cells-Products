...
ต้องการแปลงไฟล์ SXC เป็น SQL โดยใช้โปรแกรมใช่หรือไม่? นักพัฒนา C++ สามารถแปลง SXC เป็น SQL ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง SXC เป็น SQL โดยเรียกใช้เมธอด Save()
