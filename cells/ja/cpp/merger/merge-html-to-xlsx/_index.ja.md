...
次の例は、HTML を Aspose.Cells for C++ の XLSX にマージする方法を示しています。
...
HTML をプログラムで XLSX にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
