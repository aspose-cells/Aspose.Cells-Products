...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="API podporuje framework .NET, .NET platformu Core & Xamarin. Navíc jej lze použít s Mono a několika dalšími platformami prostřednictvím COM Interop." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
