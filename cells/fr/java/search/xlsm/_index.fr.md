---
title:  Rechercher XLSM document sans ouvrir via Java
weight: 6780
description: Exemple de code Java pour rechercher des mots avec un modèle dans le fichier XLSM sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Rechercher les formats XLSM dans Java" h2="Recherche de documents XLSM native et hautes performances à l\'aide d\'API côté serveur Aspose.Cells for Java, sans l\'utilisation d\'un logiciel tel que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment rechercher un fichier XLSM à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour rechercher des fichiers XLSM dans Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Rechercher XLSM Fichiers - Java" offSpacer="" %}}
