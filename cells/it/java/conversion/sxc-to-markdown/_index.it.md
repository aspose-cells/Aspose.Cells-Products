---
title: Converti SXC in MARKDOWN tramite Java 
url: /it/java/conversion/sxc-to-markdown/ 
description: Esempio di codice di conversione Java per il formato SXC in file MARKDOWN. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in MARKDOWN all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti SXC in MARKDOWN tramite Java" h2="Conversione da SXC a MARKDOWN Java per convertire pagine singole o multiple in MARKDOWN utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire SXC in MARKDOWN usando Java" %}}

 Per rendere SXC a MARKDOWN, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire SXC in MARKDOWN tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente il file SXC in MARKDOWN in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file SXC con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione MARKDOWN e SaveFormat come parametri1. Controllare il percorso specificato per il file MARKDOWN risultante
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da SXC a MARKDOWN Java" offSpacer="" %}}

```cs
// carica il file SXC in un'istanza di Workbook
Workbook book = new Workbook("template.sxc");
// salva SXC come MARKDOWN
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da SXC a MARKDOWN" sectionDescription="[Converti SXC in MARKDOWN](https://products.aspose.app/cells/conversion/sxc-to-markdown) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file SXC, verrà convertito istantaneamente in MARKDOWN." >}}
