...
{{% blocks/products/pf/agp/content h2="Jak převést SPREADSHEETML na JPEG pomocí Java" %}}

 K vykreslení SPREADSHEETML do JPEG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SPREADSHEETML na JPEG prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SPREADSHEETML na JPEG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SPREADSHEETML s instancí sešitu1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Voláním metody SheetRender.toImage uložíte výsledek ve formátu JPEG
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu SPREADSHEETML na JPEG Java" offSpacer="" %}}
