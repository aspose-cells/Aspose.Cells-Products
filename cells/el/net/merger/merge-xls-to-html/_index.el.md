...
description: Aspose Excel. C# Aspose.Cells. Συγχώνευση XLS σε μορφή αποθήκευσης HTML. C# Συνδυάστε τη μορφή XLS με HTML. Συγχώνευση XLS σε HTML στο C#. XLS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLS με HTML στο C#" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLS έως HTML στο C#" InputFormat="xls" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
