...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Label(Form control) to Excel file via C#" %}}
...
+  Use the [add method](https://apireference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addlabel) to insert a Label(Form control) in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert Label(Form control) - C#" offSpacer="" %}}
