---
title:  Thêm hoặc xóa XLSB Chú thích via .NET
weight: 6440
description: Mã nguồn C# để thêm và xóa chú thích định dạng XLSB trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
