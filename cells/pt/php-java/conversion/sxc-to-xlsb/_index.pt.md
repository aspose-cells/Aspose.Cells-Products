---
title: Conversor PHP SXC para XLSB - SXC para XLSB
description: Aspose Excel. Converta SXC em XLSB de forma rápida e fácil com Aspose.Cells. PHP SXC em XLSB. PHP Salve SXC em XLSB. Salve SXC como XLSB usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em XLSB via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em XLSB programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em XLSB em apenas algumas linhas de código.
...
1.  Converta SXC em XLSB chamando o método save da pasta de trabalho.
