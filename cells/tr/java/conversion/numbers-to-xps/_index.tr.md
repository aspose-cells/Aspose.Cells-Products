---
title: Java NUMARALARI XPS'e - Çevrimiçi NUMARALARI XPS'e Dönüştürücü
description: Aspose excel. Java Aspose.Cells. Java Aspose Cells. Ücretsiz Çevrimiçi Java SAYILARI XPS kaydetme biçimine dönüştürün. Java SAYILAR'dan XPS biçimine. NUMARALARI XPS Java'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="NUMARALARI Java\'de XPS\'e Çevrimiçi olarak Ücretsiz Kaydet" %}}

Aşağıdaki örnek, NUMBERS'in Java'de XPS'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="SAYILARI XPS via Java\'e Dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyalarını programlı olarak XPS'e dönüştürmeniz mi gerekiyor? Java geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca XPS'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak SAYILARI XPS'e dönüştürün.
1.  NUMBERS'in XPS'e dönüştürme sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="SAYILARI XPS\'e dönüştürmek için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
