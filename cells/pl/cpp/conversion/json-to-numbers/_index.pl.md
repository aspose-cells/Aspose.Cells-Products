...
Trzeba programowo przekonwertować pliki JSON na LICZBY? Programiści C++ mogą łatwo przekonwertować JSON na LICZBY za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JSON na LICZBY wywołując metodę Save().
