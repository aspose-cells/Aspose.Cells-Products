...
description: Aspose Unggul. Ubah XLTX menjadi SXC dengan cepat dan mudah dengan Aspose.Cells. C++ XLTX menjadi SXC. C++ Simpan XLTX menjadi SXC. Simpan XLTX sebagai 07611134 81 menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah XLTX menjadi SXC Menggunakan C++" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX hingga SXC di C++" %}}

Contoh berikut menunjukkan cara mengonversi XLTX menjadi SXC di C++.
...
Perlu mengonversi file XLTX ke SXC secara terprogram? Pengembang C++ dapat dengan mudah mengonversi XLTX menjadi SXC hanya dalam beberapa baris kode.
...
1.  Ubah XLTX menjadi SXC dengan memanggil metode Save().
1.  Dapatkan hasil konversi dari XLTX menjadi SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah XLTX menjadi SXC" %}}
