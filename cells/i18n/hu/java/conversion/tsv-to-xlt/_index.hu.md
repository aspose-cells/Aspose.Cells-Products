...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása XLT-vé a következővel: Java" %}}

 Ahhoz, hogy a TSV-t XLT-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TSV XLT-vé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják a TSV-fájlt XLT-vé.

{{% /blocks/products/pf/agp/text %}}

1. TSV-fájl betöltése a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLT kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLT fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TSV-ből XLT-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TSV-fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.tsv");
// mentse a TSV-t XLT-ként
