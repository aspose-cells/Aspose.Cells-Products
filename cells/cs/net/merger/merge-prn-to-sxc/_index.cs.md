...
url: /cs/net/merger/merge-prn-to-sxc/ 
...
Následující příklad ukazuje, jak sloučit PRN s SXC v Aspose.Cells for .NET.
...
Potřebujete sloučit PRN s SXC programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení PRN s SXC" %}}
