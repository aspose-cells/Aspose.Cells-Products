---
title: Java ODS ke PNG - Online ODS ke PNG Konverter
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Gratis Online Java Ubah ODS menjadi PNG saveformat. Java ODS ke format PNG. Simpan ODS ke PNG Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ODS menjadi PNG di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi ODS menjadi PNG. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, PNG, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke PNG di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi ODS menjadi PNG di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi ODS menjadi PNG. Unggah file ODS Anda, lalu simpan sebagai file PNG. Untuk membaca ODS dan menulis PNG Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan format keluaran PNG akan identik dengan dokumen asli ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi ODS menjadi PNG Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="png" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah ODS menjadi PNG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file ODS menjadi PNG secara terprogram? Pengembang Java dapat dengan mudah mengonversi ODS menjadi PNG hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi ODS menjadi PNG" %}}
{{% blocks/products/pf/agp/text %}}
