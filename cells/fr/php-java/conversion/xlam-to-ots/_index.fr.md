---
title: PHP XLAM en OTS - Convertisseur XLAM en OTS
description: Aspose Exceller. Convertissez XLAM en OTS rapidement et facilement avec Aspose.Cells. PHP XLAM en OTS. PHP Enregistrez XLAM dans OTS. Enregistrez XLAM en tant qu'OTS en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Convertir XLAM en OTS en utilisant PHP" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XLAM dans OTS en PHP" %}}
...
Besoin de convertir les fichiers XLAM en OTS par programme ? Les développeurs PHP peuvent facilement charger et convertir XLAM en OTS en quelques lignes de code seulement.
...
1.  Convertissez XLAM en OTS en appelant la méthode de sauvegarde du classeur.
