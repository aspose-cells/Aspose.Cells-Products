...
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 以 XLSB 格式批量生成報告" h2="使用數據源和模板生成 XLSB 格式的報告。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 生成 XLSB 報告" %}}

 為了創建 XLSB 文件報告，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 生成 XLSB 報告的步驟" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. 實例化 WorkbookDesigner 類1. 在 ArrayList 中添加 Datasouce 對象1. 為 WorkbookDesigner 對象設置數據源和流程1. 通過 Worbook.save 方法以 XLSB 格式保存結果
...
{{% blocks/products/pf/agp/code-block title="生成 XLSB 格式的 Excel 報告 - C#" offSpacer="" %}}
