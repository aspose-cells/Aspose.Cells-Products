...
description: Aspose Excel。 Python Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 GIF。Python OTS 為 GIF。Python 將 OTS 儲存為 GIF。Python 將 OTS 儲存為 GIF。Python 將 OTS 儲存為 GIF。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Python Excel 庫中的 OTS 轉換為 GIF" h2="高速 Python Excel 函式庫，用於將 OTS 轉換為 GIF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將 Python Excel 庫中的 OTS 轉換為 GIF" %}}
...
{{% blocks/products/pf/agp/content h2="將 OTS 儲存到 Python Excel 庫中的 GIF" %}}

以下範例示範如何將 Python excel 庫中的 OTS 轉換為 GIF。
...
{{% cells-convert title="透過 Python Excel 庫將 OTS 轉換為 GIF 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="gif" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 OTS 轉換為 GIF" %}}
