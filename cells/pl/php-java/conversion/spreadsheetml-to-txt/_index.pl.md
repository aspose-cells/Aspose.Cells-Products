---
title: PHP SPREADSHEETML na TXT - Konwerter SPREADSHEETML na TXT
description: Aspose Excel. Szybko i łatwo przekonwertuj SPREADSHEETML na TXT za pomocą Aspose.Cells. PHP SPREADSHEETML na TXT. PHP Zapisz SPREADSHEETML na TXT. Zapisz SPREADSHEETML jako TXT używając PHP.
...
{{% blocks/products/pf/agp/content h2="Konwertuj SPREADSHEETML na TXT za pomocą PHP" %}}
 ...
 Jak przekonwertować SPREADSHEETML na TXT? Dzięki bibliotece Aspose.Cells for PHP via Java możesz łatwo przekonwertować programowo SPREADSHEETML na TXT za pomocą kilku linijek kodu.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. PHP Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Zapisz SPREADSHEETML pod numerem TXT w PHP" %}}

Poniższy przykład ilustruje sposób konwersji SPREADSHEETML na TXT w PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SPREADSHEETML na TXT za pomocą PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki SPREADSHEETML na TXT? Programiści PHP mogą łatwo załadować i przekonwertować SPREADSHEETML na TXT w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj SPREADSHEETML na TXT, wywołując metodę zapisu skoroszytu.
