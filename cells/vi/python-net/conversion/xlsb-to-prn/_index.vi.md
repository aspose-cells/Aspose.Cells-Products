...
description: Aspose Excel. Chuyển đổi XLSB sang PRN nhanh chóng và dễ dàng với Aspose.Cells. Python XLSB sang PRN. Python Lưu XLSB vào PRN. Lưu XLSB dưới dạng PRN bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSB sang PRN trong Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLSB vào PRN vào Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSB sang PRN trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python để chuyển đổi XLSB sang PRN" %}}
