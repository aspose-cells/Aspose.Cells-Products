---
title: Mesclar SXC a PNG - Combinar SXC a PNG em C#
url: /pt/net/merger/merge-sxc-to-png/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita SXC para PNG saveformat. C# Combine o formato SXC a PNG. Mesclar SXC a PNG em C#. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC a PNG em C# Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar SXC a PNG em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar SXC a PNG. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo PNG. Se você desenvolver o código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla SXC a PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar SXC a PNG em C#" InputFormat="sxc" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC a PNG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SXC a PNG programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar SXC a PNG" %}}
