---
title:  Cách vẽ hoặc chèn hình mũi tên kép khuỷu tay vào Excel via Java
weight: 30
description: Vẽ hoặc chèn hình mũi tên kép khuỷu tay bằng Aspose.Cells' Java API mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn hình mũi tên kép khuỷu tay vào Excel via Java" h2="Chèn mũi tên kép khuỷu tay bằng cách sử dụng Aspose.Cells\' API mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn hình mũi tên kép khuỷu tay vào File Excel Bằng Java" %}}

 Để chèn hình mũi tên kép khuỷu tay vào file excel, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn hình mũi tên kép khuỷu tay vào file Excel via Java" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng các[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) để chèn hình mũi tên kép khuỷu tay vào trang tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn khuỷu tay hình mũi tên kép - Java" offSpacer="" %}}
