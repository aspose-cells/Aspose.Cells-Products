---
title: HTML から HTML を結合 - HTML から HTML を C# に結合
url: /ja/net/merger/merge-html-to-html/ 
description: Aspose エクセル。 C# Aspose.Cells。HTML を HTML の保存形式に無料でオンライン結合します。 C# HTML と HTML の形式を結合します。 HTML から HTML を C# に結合します。HTML を結合します。
...
次の例は、HTML を Aspose.Cells for .NET の HTML にマージする方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、HTML を HTML にマージします。ファイルをアップロードし、Workbook.Combine メソッドを呼び出してファイルをマージし、それを HTML ファイルに保存します。 C# のコードを開発する場合、これは思っているより簡単です。 HTML を HTML にマージする C# の例を参照してください。
...
{{% blocks/products/pf/agp/content h2="HTML を C# 経由で HTML に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML をプログラムで HTML にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2=".NET HTML を HTML にマージするライブラリ" %}}
