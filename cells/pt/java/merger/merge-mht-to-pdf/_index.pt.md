---
title: Mesclar MHT para PDF - Combine MHT para PDF em Java
url: /pt/java/merger/merge-mht-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Free Online Mesclar MHT para PDF saveformat. Java Combine MHT para o formato PDF. Mesclar MHT para PDF em Java. Mesclar MHT.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHT para PDF em Java online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar MHT para PDF em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHT para PDF. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo PDF. Se você desenvolver o código em Java, isso será mais simples do que parece. Consulte o exemplo Java que mescla MHT com PDF.
...
{{% blocks/products/pf/agp/content h2="Como mesclar MHT para PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar MHT para PDF programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHT com PDF" %}}
