---
title: Převaděč PHP MHTML do SPREADSHEETML - MHTML do SPREADSHEETML
description: Aspose Excel. Převeďte MHTML na SPREADSHEETML rychle a snadno pomocí Aspose.Cells. PHP MHTML na SPREADSHEETML. PHP Uložit MHTML do SPREADSHEETML. Uložte MHTML jako SPREADSHEETML pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na SPREADSHEETML přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory do SPREADSHEETML programově? Vývojáři PHP mohou snadno načíst a převést MHTML do SPREADSHEETML v několika řádcích kódu.
...
1.  Převeďte MHTML na SPREADSHEETML voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na SPREADSHEETML" %}}
