...
description: Aspose Excel. MHT konvertálása XML-re gyorsan és egyszerűen a Aspose.Cells. Python MHT-ból XML-be. Python MHT mentése XML-be. Mentse az MHT-t XML-ként a Python használatával.
...
{{% blocks/products/pf/agp/content h2="Konvertálja az MHT-t XML-re a Python-ben" %}}
 ...
 Hogyan konvertálhatom az MHT-t XML-be? A Aspose.Cells for Python számmal a NET könyvtáron keresztül könnyedén konvertálhatja az MHT-t XML-re programozottan néhány sornyi kóddal.[Aspose.Cells for Python a NET számon keresztül](https://pypi.org/project/aspose-cells-python/)képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Mentse az MHT-t XML-be a Python számon" %}}
