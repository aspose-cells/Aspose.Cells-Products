---
title:  ป้องกันและล็อค XLS เอกสาร via Java
weight: 5070
description: โค้ดตัวอย่าง Java เพื่อล็อคไฟล์ XLS โดยใช้รหัสผ่านบน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
...
{{< blocks/products/pf/i18n/upper-banner h1="เข้ารหัสไฟล์ XLS via Java" h2="สเปรดชีต Excel ที่ป้องกันด้วยรหัสผ่านรวมถึงรูปแบบ XLS โดยใช้ไลบรารี .NET" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีรักษาความปลอดภัยไฟล์ XLS โดยใช้ Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการป้องกันไฟล์ XLS via Java" %}}
...
1.  โหลดไฟล์ XLS โดยการสร้างอินสแตนซ์คลาส Workbook
1.  ใช้วิธีป้องกัน (..) ด้วย ProtectionType และรหัสผ่าน
1.  บันทึกไฟล์ XLS ที่มีการป้องกันโดยเมธอด save()
