---
title: A XLS egyesítése PRN-nel - A XLS-es szám egyesítése PRN-vel a Java-ben
url: /hu/java/merger/merge-xls-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés XLS PRN mentési formátumba. Java Kombinálja a XLS-et PRN formátumba. Egyesítse a XLS-et a PRN-vel a Java-es számon. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLS-es számot a PRN-hez a Java-es online számmal ingyen" %}}

A következő példa bemutatja, hogyan egyesítheti a XLS-et a PRN-vel a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS és a PRN egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el PRN fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a XLS-et a PRN-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a XLS és a PRN egyesítéséhez a Java-ben" InputFormat="xls" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLS és a via Java PRN egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-et a PRN-nel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a XLS és a PRN egyesítéséhez" %}}
