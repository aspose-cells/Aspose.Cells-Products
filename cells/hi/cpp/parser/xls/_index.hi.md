---
title: XLS दस्तावेज़ से C++ के माध्यम से पाठ और छवियाँ निकालें
weight: 7610
description: C++ उदाहरण कोड Windows 32 बिट, Windows 64 बिट और लिनक्स 64 बिट के लिए C++ रनटाइम वातावरण पर XLS फ़ाइल से पाठ और छवियों को निकालने के लिए।
...
{{< blocks/products/pf/i18n/upper-banner h1="XLS प्रारूपों को C++ में पार्स करें" h2="Microsoft या Adobe PDF जैसे किसी भी सॉफ्टवेयर के उपयोग के बिना, सर्वर-साइड Aspose.Cells for C++ API का उपयोग करके मूल और उच्च प्रदर्शन XLS दस्तावेज़ पार्सिंग।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
API को कोड की कुछ ही पंक्तियों के साथ बनाया जा सकता है। Microsoft Excel XLS, XLSX, XLSM, XLSB और OpenDocument ODS फ़ाइलों से टेक्स्ट और छवियों को पार्स करें।
