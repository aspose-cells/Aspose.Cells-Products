---
title: A XLS egyesítése az MD-vel – a XLS-es szám egyesítése MD-vel a Java-ben
url: /hu/java/merger/merge-xls-to-md/ 
description: Aspose Excel. Java Aspose.Cells. A XLS egyesítése MD mentési formátumba. Java A XLS kombinálása MD formátumba. A XLS egyesítése a Java számú MD-vel. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A XLS egyesítése a Java számú MD-vel" %}}

következő példa bemutatja, hogyan egyesítheti a XLS-et az MD-vel a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS és az MD egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el MD fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a XLS-et az MD-vel.
...
{{% blocks/products/pf/agp/content h2="A XLS és az MD via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-et az MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a XLS MD-vel való egyesítéséhez" %}}
