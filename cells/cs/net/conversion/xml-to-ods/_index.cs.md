...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu XML do formátu ODS, což umožňuje bezproblémové ukládání XML dat do formátu ODS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Uložit XML do ODS v C#" %}}

Následující příklad ukazuje, jak převést XML na ODS s kódem C#.
