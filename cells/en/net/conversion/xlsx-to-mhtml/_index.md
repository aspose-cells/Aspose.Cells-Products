...
description: Sample code for xlsx to mhtml C# conversion. Use API example code for batch xlsx files to mhtml conversion within VB.NET, Asp.NET or any .NET based application.
---
