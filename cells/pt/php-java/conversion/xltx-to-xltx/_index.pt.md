---
title: Conversor PHP XLTX para XLTX - XLTX para XLTX
description: Aspose Excel. Converta XLTX em XLTX de forma rápida e fácil com Aspose.Cells. PHP XLTX em XLTX. PHP Salve XLTX em XLTX. Salve XLTX como XLTX usando PHP.
...
{{% cells-convert title="Exemplo de código para converter XLTX em XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xltx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLTX em XLTX via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em XLTX programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em XLTX em apenas algumas linhas de código.
...
1.  Converta XLTX em XLTX chamando o método save da pasta de trabalho.
