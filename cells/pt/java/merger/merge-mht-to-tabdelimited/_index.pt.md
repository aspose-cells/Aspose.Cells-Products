---
title: Mesclar MHT para TABDELIMITED - Combine MHT para TABDELIMITED em Java
url: /pt/java/merger/merge-mht-to-tabdelimited/ 
description: Aspose Excel. Java Aspose.Cells. Free Online Mesclar MHT para formato de salvamento TABDELIMITED. Java Combine MHT para o formato TABDELIMITED. Mesclar MHT para TABDELIMITED em Java. Mesclar MHT.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHT para TABDELIMITED em Java online gratuitamente" %}}

exemplo a seguir demonstra como mesclar MHT com TABDELIMITED em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHT com TABDELIMITED. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo TABDELIMITED. Se você desenvolver código em Java, isso será mais simples do que parece. Consulte o exemplo Java que mescla MHT com TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar MHT para TABDELIMITED em Java" InputFormat="mht" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHT para TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar MHT para TABDELIMITED programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHT para TABDELIMITED" %}}
