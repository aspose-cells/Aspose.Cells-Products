...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в PNG в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат PNG в формате C++.
...
1.  Преобразовать XML в формат PNG, вызвав метод Save().
