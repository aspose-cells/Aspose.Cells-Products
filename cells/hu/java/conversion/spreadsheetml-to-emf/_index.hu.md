...
{{% blocks/products/pf/agp/content h2="A SPREADSHEETML konvertálása EMF-re a következővel: Java" %}}

 Ahhoz, hogy a SPREADSHEETML-t EMF-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A SPREADSHEETML EMF-re konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak SPREADSHEETML fájlt EMF-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML EMF Java konverziós forráskód" offSpacer="" %}}
