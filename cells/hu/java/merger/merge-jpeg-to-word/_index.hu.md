---
title: A JPEG egyesítése a WORD-dal – a JPEG egyesítése a WORD-dal a Java-ben
url: /hu/java/merger/merge-jpeg-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés JPEG WORD mentési formátumba. Java Kombinálja a JPEG-et WORD formátumba. A JPEG egyesítése a WORD-hoz a Java-ben. JPEG Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a JPEG-et a WORD-dal a Java-ben online" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a JPEG-et a WORD-dal a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a JPEG és a WORD egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el WORD fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a JPEG-et a WORD-ba.
...
{{% blocks/products/pf/agp/content h2="A JPEG és a via Java WORD egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a JPEG-et a WORD-dal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a JPEG és a WORD egyesítéséhez" %}}
