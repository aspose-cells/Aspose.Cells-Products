---
title: Konvertera XLT till XLSM via Python
url: /sv/python-java/conversion/xlt-to-xlsm/
description: Exempelkod för konvertering av xlt till xlsm Python. Använd API exempelkod för batch-xlt-filer till xlsm-konvertering i Python-applikationen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLT till XLSM via Python" h2="Exportera Excel®-kalkylblad till XLSM-format med Python API:er." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLT till XLSM med Python" %}}

 För att konvertera XLT till XLSM kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLT till XLSM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLT-filer till XLSM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLT-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med XLSM-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande XLSM-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLT till XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xlsm" IsLandingPage="true" language="python" %}}
