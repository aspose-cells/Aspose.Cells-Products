...
{{% blocks/products/pf/agp/content h2="Python Excel Kitaplığını Kullanarak XML\'i TIFF\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/content h2="XML\'i Python Excel Kitaplığı\'ndaki TIFF\'e kaydedin" %}}

Aşağıdaki örnek, Python excel kitaplığında XML'in TIFF'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="Python XML\'i TIFF\'e Dönüştürmek için Excel Kitaplığı" %}}
