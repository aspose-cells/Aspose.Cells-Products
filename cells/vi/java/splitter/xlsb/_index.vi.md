...
weight: 7880
description: Java mã mẫu để tách các tài liệu XLSB trên Java Môi trường thời gian chạy cho Ứng dụng JSP/JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tách XLSB Tệp via Java" h2="XLSB tách với sự trợ giúp của thư viện Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tách tệp XLSB trong Java" %}}
...
+ Gọi phương thức lưu với đường dẫn tệp XLSB mới.
...
{{% blocks/products/pf/agp/code-block title="Tách File XLSB - Java" offSpacer="" %}}
