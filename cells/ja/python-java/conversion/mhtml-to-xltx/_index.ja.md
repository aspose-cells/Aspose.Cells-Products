---
title: Python MHTML から XLTX - MHTML から XLTX へのコンバータ
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、MHTML を XLTX にすばやく簡単に変換します。Python MHTML を XLTX に変換します。Python MHTML を XLTX に保存します。Python Excel ライブラリを使用して、MHTML を XLTX として保存します。
...
{{% blocks/products/pf/agp/content h2="Python Excel ライブラリを使用して MHTML を XLTX に変換する" %}}
...
{{% blocks/products/pf/agp/content h2="MHTML から XLTX を Python Excel ライブラリに保存します" %}}

次の例は、Python Excel ライブラリで MHTML を XLTX に変換する方法を示しています。
...
{{% cells-convert title="Python Excel ライブラリを使用して MHTML を XLTX に変換するサンプル コード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python 経由で MHTML を XLTX に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで MHTML ファイルを XLTX に変換する必要がありますか? Python 開発者は、わずか数行のコードで MHTML を簡単にロードして XLTX に変換できます。
