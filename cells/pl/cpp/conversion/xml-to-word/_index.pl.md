...
Trzeba programowo przekonwertować pliki XML do formatu WORD? Programiści C++ mogą łatwo przekonwertować pliki XML do formatu WORD za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XML do WORD wywołując metodę Save().
