...
description: Aspose Excel. C# Aspose.Cells. Συγχώνευση XLS σε μορφή αποθήκευσης BMP. C# Συνδυάστε τη μορφή XLS με BMP. Συγχώνευση XLS σε BMP στο C#. XLS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLS με BMP στο C#" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLS έως BMP στο C#" InputFormat="xls" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
