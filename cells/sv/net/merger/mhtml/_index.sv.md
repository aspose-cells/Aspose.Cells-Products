...
weight: 2610
description: C# källkod för att kombinera MHTML dokument på .NET Framework, .NET Core, Mono eller Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman MHTML-format i C#" h2="Inbyggd och högpresterande MHTML dokumentsammanslagning med server-side Aspose.Cells for .NET API:er, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHTML" >}}
...
+ Ladda alla MHTML-filer med fullständig sökväg.
+ Gör ett dokument som basfil
+ Anropa den relevanta metoden för att sammanfoga och sammanfoga filer en efter en.
+ Anropa metoden Save() och skicka filnamnet (fullständig sökväg) och formatet (MHTML) som en parameter.
+ Nu kan du öppna och använda filen MHTML i Microsoft Office, Adobe PDF eller något annat kompatibelt program.
