---
title: Převeďte XLSM na XLS pomocí aplikace C++ 
url: /cs/cpp/conversion/xlsm-to-xls/ 
description: Ukázka převodního kódu C++ pro dokument XLSM na formát XLS. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLSM na XLS v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLSM na XLS pomocí C++" %}}

 K převodu XLSM na XLS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu XLSM na XLS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLSM na XLS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLSM pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLS).1. Soubor XLS bude uložen do zadané cesty.1. Otevřete soubor XLS v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLSM na XLS C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze XLSM na XLS" sectionDescription="[Převést XLSM na XLS](https://products.aspose.app/cells/conversion/xlsm-to-xls) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor XLSM, bude okamžitě převeden na XLS." >}}
