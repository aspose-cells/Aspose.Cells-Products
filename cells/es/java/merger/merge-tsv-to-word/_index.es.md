---
title: Combinar TSV con WORD via Java
...
El siguiente ejemplo muestra cómo combinar TSV con WORD en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar TSV con WORD en línea" InputFormat="tsv" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
