---
title:  ใส่ช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ลงใน Excel ผ่าน Python
weight: 30
description: ซอร์สโค้ด Python เพื่อแทรก CheckBox (Form control) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก CheckBox (Form control) ลงในไฟล์ Excel ผ่าน Python" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกช่องทำเครื่องหมาย (ตัวควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกช่องทำเครื่องหมาย(ตัวควบคุมแบบฟอร์ม) - Python" offSpacer="" %}}
