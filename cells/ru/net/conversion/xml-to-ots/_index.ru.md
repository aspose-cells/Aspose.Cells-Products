...
Нужно программно конвертировать файлы XML в OTS? .NET разработчики могут легко загружать и преобразовывать XML в OTS, написав всего несколько строк кода.
