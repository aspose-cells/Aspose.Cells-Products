...
weight: 90
description: C# التعليمات البرمجية المصدر لإدراج شريط التمرير في Excel على .NET Framework أو .NET Core أو Mono أو الأنظمة الأساسية Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل شريط التمرير في Excel via .NET" h2="أدخل أشرطة التمرير باستخدام Aspose.Cells \'API دون أي برامج مثل Microsoft أو Open Office أو Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج شريط التمرير في ملف Excel عبر C#" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addscrollbar)لإدراج شريط تمرير في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج شريط التمرير - C#" offSpacer="" %}}
