...
description: Aspose Exceller. C++ Créez un fichier XLTM rapidement et facilement avec Aspose.Cells. Générez un fichier XLTM à l'aide de C++. Créez XLTM dans C++. C++ XLTM Creater.
...
1.  Enregistrez le classeur en tant que fichier .xltm à l'aide de la méthode Save().
