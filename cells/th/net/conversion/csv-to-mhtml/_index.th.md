...
description: Aspose Excel โซลูชันที่ครอบคลุมนี้มอบแนวทางแบบบูรณาการอย่างสมบูรณ์แก่ผู้พัฒนา C# ในการแปลง CSV เป็นรูปแบบ MHTML ทำให้สามารถบันทึกข้อมูล CSV ลงในรูปแบบ MHTML ได้อย่างราบรื่นโดยใช้ไลบรารี Aspose.Cells ทั้งหมดนี้ผ่านโค้ด C# ที่มีประสิทธิภาพและปรับแต่งได้
...
{{% blocks/products/pf/agp/content h2="บันทึกหมายเลข CSV เป็น MHTML ในหมายเลข C#" %}}

ตัวอย่างต่อไปนี้แสดงวิธีการแปลง CSV เป็น MHTML ใน C#
...
1.  แปลง CSV เป็น MHTML โดยเรียกใช้เมธอด Workbook.Save
