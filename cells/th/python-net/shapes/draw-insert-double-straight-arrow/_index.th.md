---
title: ฉันจะวาดหรือแทรกลูกศรคู่ตรงลงใน Excel โดยใช้ Python via .Net ได้อย่างไร
weight: 10
description: Python via ซอร์สโค้ด .Net เพื่อวาดหรือแทรกลูกศรคู่ตรงลงใน Excel
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แทรกลูกศรคู่ตรงลงใน Excel โดยใช้ Python via .Net" h2="ใส่ลูกศรตรงคู่โดยใช้ Aspose.Cells\' API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF เป็นต้น" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกลูกศรคู่ตรงลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกลูกศรคู่ตรงไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) เพื่อแทรกลูกศรตรงคู่ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่ลูกศรคู่ตรง - Python via .Net" offSpacer="" %}}
