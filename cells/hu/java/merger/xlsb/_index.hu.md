---
title:  A XLSB via Java fájlok egyesítése
weight: 4840
description: Java mintakód a XLSB dokumentumok kombinálásához a Java futásidejű környezet JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="A XLSB formátumok egyesítése a Java-ben" h2="Natív XLSB dokumentum-egyesítés szerveroldali Java API-kkal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB fájlok egyesítése a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A XLSB fájlok egyesítésének lépései a Java-ben" %}}
...
+ Töltse be az első XLSB fájlt a Workbook osztály egy példányával.
+ Töltse be a második XLSB dokumentumot a Workbook osztály egy példányával.
+ Fájlok egyesítése a combin() metódussal.
mentse az egyesített XLSB fájlt a megadott elérési úton
...
{{% blocks/products/pf/agp/code-block title="A XLSB fájlok egyesítése – Java" offSpacer="" %}}
