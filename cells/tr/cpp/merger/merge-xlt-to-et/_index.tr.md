...
url: /tr/cpp/merger/merge-xlt-to-et/ 
...
Aşağıdaki örnek, XLT'in Aspose.Cells for C++'deki ET ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLT\'i C++\'de ET ile Birleştirmek için Örnek Kod" InputFormat="xlt" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLT\'i C++ aracılığıyla ET\'ye nasıl birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

 XLT'i programlı olarak ET ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="C++ kütüphanesi, XLT\'i ET ile birleştirecek" %}}
