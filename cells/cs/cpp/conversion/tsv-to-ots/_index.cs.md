...
{{% blocks/products/pf/agp/content h2="Ušetřete TSV na OTS v C++ Online zdarma" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést TSV na OTS v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV pomocí Factory::CreateIWorkbook.
1. Převeďte TSV na OTS voláním metody Save().
