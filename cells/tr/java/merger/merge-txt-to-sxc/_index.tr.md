...
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme TXT ile SXC kaydetme biçimi. Java TXT ile SXC formatını birleştirin. Java içinde TXT'i SXC ile birleştir. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT ile SXC\'i Java Çevrimiçinde Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, TXT'in Aspose.Cells for Java'de SXC ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT ile SXC'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından SXC dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. TXT'i SXC ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT\'i Java\'de SXC ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="txt" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT ile SXC via Java Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 TXT ile SXC'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i SXC ile birleştirmek için Java kitaplığı" %}}
