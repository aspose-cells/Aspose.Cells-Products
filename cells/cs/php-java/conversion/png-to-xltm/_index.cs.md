---
title: Konvertor PHP PNG až XLTM - PNG až XLTM
description: Aspose Excel. Převeďte PNG na XLTM rychle a snadno pomocí Aspose.Cells. PHP PNG na XLTM. PHP Uložte PNG na XLTM. Uložte XLTM jako PNG jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na XLTM přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na XLTM programově? Vývojáři PHP mohou snadno načíst a převést PNG na XLTM v několika řádcích kódu.
...
1.  Převeďte PNG na XLTM voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na XLTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na XLTM" %}}
