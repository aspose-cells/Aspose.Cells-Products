...
{{< blocks/products/pf/i18n/upper-banner h1="Szyfruj pliki ODS przez Java" h2="Chronione hasłem arkusze kalkulacyjne Excel, w tym format ODS, przy użyciu .NETBiblioteki." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki ochrony plików ODS za pośrednictwem Java" %}}
...
1. Załaduj plik ODS, tworząc instancję klasy Workbook1. Użyj metody protect(..) z ProtectionType i Password1. Zapisz chroniony plik ODS za pomocą metody save()
