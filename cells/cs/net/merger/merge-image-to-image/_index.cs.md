---
title: Sloučit IMAGE s IMAGE – Sloučit IMAGE s IMAGE v C#
url: /cs/net/merger/merge-image-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit IMAGE do IMAGE uloženého formátu. C# Zkombinujte formát IMAGE do IMAGE. Sloučit IMAGE do IMAGE v C#. IMAGE Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit IMAGE do IMAGE v C#" %}}

Následující příklad ukazuje, jak sloučit IMAGE do IMAGE v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení IMAGE do IMAGE. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru IMAGE. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí IMAGE do IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení IMAGE do IMAGE v C#" InputFormat="png" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit IMAGE do IMAGE přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit IMAGE s IMAGE programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna pro sloučení IMAGE do IMAGE" %}}
