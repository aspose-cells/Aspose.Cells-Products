---
title: 合并 EXCEL 到 XLTM - 将 EXCEL 合并到 XLTM 中的 C++
url: /zh/cpp/merger/merge-excel-to-xltm/ 
description: Aspose Excel。 C++ Aspose.Cells。免费在线合并EXCEL到XLTM保存格式。 C++ 将EXCEL合并为XLTM格式。将EXCEL合并到C++中的XLTM。EXCEL合并。
...
{{% blocks/products/pf/agp/content h2="免费在线将C++中的EXCEL合并为XLTM" %}}

下面的例子演示了如何将EXCEL合并到Aspose.Cells for C++中的XLTM。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将EXCEL合并到XLTM。上传文件，调用Workbook.Combine方法合并文件，然后将其保存到XLTM文件。如果您在 C++ 中开发代码，这会比听起来更简单。请参阅 C++ 将 EXCEL 合并到 XLTM 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线合并EXCEL到C++中的XLTM" InputFormat="xlsx" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何通过C++合并EXCEL到XLTM" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 EXCEL 合并到 XLTM 吗？基本文档合并和连接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++库合并EXCEL到XLTM" %}}
