...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в TSV в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат TSV в формате C++.
...
1.  Преобразовать XML в формат TSV, вызвав метод Save().
