---
title: Crea file XLSB di MS Excel tramite Java 
url: /it/java/create-xlsb/ 
description: Java Codice di esempio per la generazione di documenti XLSB. Utilizzare questo codice per creare file XLSB di MS Excel all'interno di un'applicazione desktop o Web basata su Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crea documenti XLSB tramite Java" h2="Creazione di fogli di lavoro MS Excel XLSB nativi e ad alte prestazioni in modo programmatico utilizzando la libreria Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Come creare XLSB tramite Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Il codice sorgente seguente mostra come creare un file XLSB di MS Excel utilizzando Java." offSpacer="" %}}
