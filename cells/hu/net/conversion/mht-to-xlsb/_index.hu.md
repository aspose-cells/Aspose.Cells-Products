---
title: C# MHT - XLSB - MHT - XLSB konverter
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az MHT XLSB formátumba konvertálásához, lehetővé téve az MHT adatok zökkenőmentes mentését XLSB formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{% blocks/products/pf/agp/content h2="Mentsd el az MHT-t a XLSB-es számra a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet az MHT-t XLSB-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód az MHT XLSB-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="xlsb" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Az MHT konvertálása XLSB-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Az MHT-fájlokat programozottan XLSB-re kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és konvertálhatják az MHT-t XLSB-re, mindössze néhány sornyi kóddal.
...
1.  Alakítsa át az MHT-t XLSB-re a Workbook.Save metódus meghívásával.
1. Szerezd meg az MHT XLSB számra való átalakítási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT XLSB-re konvertálásához" %}}
