...
以下示例演示如何將MHT合併到Aspose.Cells for .NET中的TSV。
...
需要以編程方式將 MHT 合併到 TSV 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行代碼即可完成 API。
