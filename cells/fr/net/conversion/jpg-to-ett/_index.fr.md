---
title: C# JPG en ETT - Convertisseur JPG en ETT
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG au format ETT, permettant un enregistrement transparent des données JPG au format ETT à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG au format ETT dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en ETT en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir JPG en ETT. Téléchargez votre fichier JPG, puis enregistrez-le simplement en tant que fichier ETT. Pour la lecture JPG et l'écriture ETT, vous pouvez utiliser des noms de fichiers complets. Le contenu ETT de sortie et le formatage seront identiques au document JPG d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir un JPG en ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="ett" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en ETT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en ETT par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en ETT en quelques lignes de code seulement.
...
1.  Convertissez le format JPG en ETT en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en ETT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en ETT" %}}
