...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчикам легко создавать, загружать, изменять и преобразовывать файлы BMP в запущенных приложениях отчетности для обработки данных, написав всего несколько строк кода.
...
1.  Сохраните книгу как файл .bmp, используя метод Save().
