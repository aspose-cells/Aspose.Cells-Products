...
description: C# source code to combine MHT to HTM file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="How to Merge MHT to HTM File Using C#" %}}
 ...
 In order to merge MHT to HTM file, we’ll use
...
{{% blocks/products/pf/agp/code-block title="Merge MHT to HTM Files - C#" offSpacer="" %}}
