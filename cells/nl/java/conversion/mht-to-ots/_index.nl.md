...
{{% blocks/products/pf/agp/content h2="MHT omzetten naar OTS met behulp van Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sla MHT op bij OTS in Java" %}}

Het volgende voorbeeld laat zien hoe je MHT naar OTS converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe MHT naar OTS via Java om te zetten" %}}

{{% blocks/products/pf/agp/text %}}

Moet u MHT-bestanden programmatisch naar OTS converteren? Ontwikkelaars van Java kunnen MHT-bestanden eenvoudig naar OTS converteren met slechts een paar regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek voor het converteren van MHT naar OTS" %}}
{{% blocks/products/pf/agp/text %}}
