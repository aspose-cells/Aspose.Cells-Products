---
title: تحويل TABDELIMITED إلى SXC عبر Java 
url: /ar/java/conversion/tabdelimited-to-sxc/ 
description: نموذج Java رمز التحويل لتنسيق TABDELIMITED إلى ملف SXC. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى SXC من خلال أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى SXC عبر Java" h2="TABDELIMITED لتحويل SXC Java لتحويل صفحة واحدة أو صفحات متعددة إلى SXC باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى SXC باستخدام Java" %}}

 من أجل تقديم TABDELIMITED إلى SXC ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TABDELIMITED إلى SXC عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل ملف TABDELIMITED بسهولة إلى SXC في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف TABDELIMITED مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد SXC & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف SXC الناتج
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED إلى SXC Java رمز مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف TABDELIMITED في مثيل المصنف
Workbook book = new Workbook("template.tabdelimited");
// حفظ TABDELIMITED كـ SXC
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED إلى SXC Conversion Live Demos" sectionDescription="[تحويل TABDELIMITED إلى SXC](https://products.aspose.app/cells/conversion/tabdelimited-to-sxc) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف TABDELIMITED الخاص بك ، وسيتم تحويله على الفور إلى SXC." >}}
