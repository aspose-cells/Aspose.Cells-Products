---
title: Chèn bình luận vào file ODS via .NET
url: /vi/net/comments/insert-comments-to-ods/ 
description: Chèn bình luận vào ODS sử dụng C#. Sử dụng mã ví dụ API để chèn bình luận trong ứng dụng .NET.
...
{{% blocks/products/pf/agp/content h2="Cách chèn bình luận vào file ODS qua C#" %}}
...
Trong Office 365, bình luận dành cho các cuộc hội thoại, bạn có thể sử dụng mã C# sau để chèn và xóa bình luận trong tệp ODS.

{{% blocks/products/pf/agp/code-block title="Mã mẫu C# Chèn và xóa bình luận trong file ODS" offSpacer="" %}}
