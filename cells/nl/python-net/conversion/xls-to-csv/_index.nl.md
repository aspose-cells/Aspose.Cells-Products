---
title: Python XLS tot CSV - XLS tot CSV Converter
description: Aspose Excel. Python Excel. Converteer XLS snel en eenvoudig naar CSV met Aspose.Cells. Python XLS naar CSV. Python Bewaar XLS naar CSV. Bewaar XLS als 076112 3481 met behulp van de Excel-bibliotheek Python.
...
{{% cells-convert title="Voorbeeldcode om XLS naar CSV te converteren via de Excel-bibliotheek Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="csv" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLS naar CSV te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLS-bestanden programmatisch naar CSV converteren? Python-ontwikkelaars kunnen XLS eenvoudig in slechts een paar regels code laden en converteren naar CSV.
...
1.  Converteer XLS naar CSV door de Workbook.save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van XLS naar CSV.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om XLS naar CSV te converteren" %}}
