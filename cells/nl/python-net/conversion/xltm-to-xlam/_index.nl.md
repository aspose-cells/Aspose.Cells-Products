...
Het volgende voorbeeld laat zien hoe u XLTM converteert naar XLAM in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLTM naar XLAM te converteren" %}}
