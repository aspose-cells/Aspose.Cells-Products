---
title: PHP OTS إلى PNG - OTS إلى PNG محول
description: Aspose اكسل. قم بتحويل OTS إلى PNG بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى PNG. PHP احفظ OTS إلى PNG. احفظ OTS كـ PNG باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى PNG في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى PNG. هذا حل برمجي احترافي لاستيراد وتصدير OTS وPNG والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى PNG عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى PNG برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى PNG في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى PNG عن طريق استدعاء طريقة حفظ المصنف.
