---
title: PHP EXCEL en XLAM - Convertisseur EXCEL en XLAM
description: Aspose Exceller. Convertissez EXCEL en XLAM rapidement et facilement avec Aspose.Cells. PHP EXCEL en XLAM. PHP Enregistrez EXCEL en XLAM. Enregistrez EXCEL sous XLAM en utilisant PHP.
...
{{% cells-convert title="Exemple de code pour convertir EXCEL en XLAM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xlam" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en XLAM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en XLAM par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en XLAM en quelques lignes de code.
...
1.  Convertissez EXCEL en XLAM en appelant la méthode de sauvegarde du classeur.
1.  Obtenez le résultat de la conversion d’EXCEL en XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en XLAM" %}}
