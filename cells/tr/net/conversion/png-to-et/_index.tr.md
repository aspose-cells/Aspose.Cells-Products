---
title: C# PNG'den ET'ye - PNG'den ET'ye Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile PNG'i hızlı ve kolay bir şekilde ET'ye dönüştürün. C# PNG'i ET'ye dönüştürün. C# PNG'i ET'ye kaydedin. C#'i kullanarak PNG'i ET olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C#\'de ET\'ye kaydedin" %}}

Aşağıdaki örnek, PNG'in C#'de ET'ye nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="PNG\'i ET\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG\'i C# aracılığıyla ET\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını program aracılığıyla ET'ye dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve ET'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="PNG\'i ET\'ye dönüştürmek için C# kitaplığı" %}}
