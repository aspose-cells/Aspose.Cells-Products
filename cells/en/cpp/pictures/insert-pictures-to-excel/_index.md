...
+  There are two ways to insert a picture in the selected worksheet.
    + Use the shapecollection's [add method](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addpicture/) to insert a Picture in the selected worksheet.
    + Use the picturecollection's [add method](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/picturecollection/add/) to insert a Picture in the selected worksheet.
...
{{< gist "aspose-cells-gists" "6f7d9819d85793c3a3b5d040af42e1a9" "InsertPictureIntoWorksheet.cpp" >}}
