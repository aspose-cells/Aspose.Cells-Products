---
title: Gabungkan XLSB ke ET - Gabungkan XLSB ke ET di C#
url: /id/net/merger/merge-xlsb-to-et/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSB ke format penyimpanan ET. C# Gabungkan XLSB ke format ET. Gabung XLSB ke ET di C#. XLSB Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSB ke ET di C#" %}}

Contoh berikut menunjukkan cara menggabungkan XLSB ke ET di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLSB ke ET. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ET. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSB dengan ET.
...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSB ke ET lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSB ke ET secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan XLSB ke ET" %}}
