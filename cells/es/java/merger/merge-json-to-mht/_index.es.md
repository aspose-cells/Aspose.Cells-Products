---
title: Combinar JSON a MHT - Combinar JSON a MHT en Java
url: /es/java/merger/merge-json-to-mht/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea JSON para guardar formato MHT. Java Combine JSON en formato MHT. Combinar JSON a MHT en Java. JSON Combinar.
...
El siguiente ejemplo muestra cómo combinar JSON con MHT en Aspose.Cells for Java.
...
{{% cells-merger title="Gratis en línea para fusionar JSON a MHT en Java" InputFormat="json" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar JSON a MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar JSON con MHT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
