...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 MHTML 轉換為 SPREADSHEETML。Java MHTML 到 SPREADSHEETML。 Java 將 MHTML 儲存到 SPREADSHEETML。使用 Java 將 MHTML 儲存為 SPREADSHEETML。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 MHTML 轉換為 Java 中的 SPREADSHEETML" h2="用於將 MHTML 轉換為 SPREADSHEETML 的高速 Java 庫。這是一個專業的軟體解決方案，可以使用 Java 匯入和匯出 MHTML、SPREADSHEETML 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="將 MHTML 儲存到 Java 中的 SPREADSHEETML" %}}

以下範例示範如何將 MHTML 轉換為 Java 中的 SPREADSHEETML。
...
需要以程式設計方式將 MHTML 檔案轉換為 SPREADSHEETML？ Java 開發人員只需幾行程式碼即可輕鬆將 MHTML 轉換為 SPREADSHEETML。
