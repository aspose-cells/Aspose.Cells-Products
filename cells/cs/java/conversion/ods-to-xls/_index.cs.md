...
{{% blocks/products/pf/agp/content h2="Jak převést ODS na XLS pomocí Java" %}}

 K vykreslení ODS na XLS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu ODS na XLS prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODS na XLS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLS a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLS
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODS na XLS Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze ODS na XLS" sectionDescription="[Převést ODS na XLS](https://products.aspose.app/cells/conversion/ods-to-xls) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor ODS, bude okamžitě převeden na XLS." >}}
