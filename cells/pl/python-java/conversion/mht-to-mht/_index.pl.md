...
{{% blocks/products/pf/agp/content h2="Konwertuj MHT na MHT za pomocą Python" %}}
...
Poniższy przykład pokazuje, jak przekonwertować MHT na MHT w Python.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHT na MHT przez Python" %}}
