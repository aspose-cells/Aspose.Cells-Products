---
title:  Excel'e kavisli şekil nasıl çizilir veya eklenir via Java
weight: 30
description: Microsoft veya Open Office, Adobe PDF vb. gibi herhangi bir yazılım olmadan Aspose.Cells' Java API'i kullanarak kavisli şekil çizin veya ekleyin.
keywords: [Java Aspose.Cells., Java add curved shape., Java insert curved shape., Java create curved shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Eğri şekli Excel\'e ekleme via Java" h2="Aspose.Cells\' API\'i kullanarak, Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan kavisli şekil ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak Excel Dosyasına Kavisli Şekil Nasıl Eklenir?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="via Java Excel dosyasına kavisli şekil ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Kullan[yöntem ekle](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) seçilen çalışma sayfasına kavisli şekil eklemek için
...
{{% blocks/products/pf/agp/code-block title="Kavisli şekil ekleyin - Java" offSpacer="" %}}
