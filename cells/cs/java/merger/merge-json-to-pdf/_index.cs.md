---
title: Sloučit JSON až PDF - Sloučit JSON až PDF v Java
url: /cs/java/merger/merge-json-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit JSON do PDF uložit formát. Java Kombinujte formát JSON až PDF. Sloučit JSON až PDF v Java. JSON Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JSON až PDF v Java" %}}

Následující příklad ukazuje, jak sloučit JSON až PDF v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JSON do PDF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PDF. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí JSON do PDF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit JSON do PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JSON až PDF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení JSON až PDF" %}}
