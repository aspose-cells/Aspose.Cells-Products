---
title: 创建 ET - 在 C# 中创建 ET 文件
description: Aspose Excel。 C# 使用 Aspose.Cells 快速轻松地创建 ET 文件。使用 C# 生成 ET 文件。在 C# 中创建 ET。C# ET 创建器。
...
{{% blocks/products/pf/agp/content h2="如何在C#中创建ET" %}}
...
{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在C#中创建ET文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#库创建ET文件" %}}
