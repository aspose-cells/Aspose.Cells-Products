---
title: 使用Python via java將圖片插入Excel
weight: 200
description: Python via java原始碼將圖片插入Excel。
...
{{% blocks/products/pf/agp/content h2="如何使用 Python via java 將圖片插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="使用Python via java將圖片插入Excel檔案的步驟" %}}
...
+ 透過索引選擇工作表。
 使用圖片集[添加方法](https://reference.aspose.com/cells/python-java/asposecells.api/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)在選定的工作表中插入圖片。
以 XLSX 格式儲存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入圖片 - Python via java" offSpacer="" %}}
