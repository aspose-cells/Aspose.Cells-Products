---
title: Java MHT na XLS - Konwerter online MHT na XLS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwersja MHT do formatu zapisu XLS. Java MHT do formatu XLS. Zapisz MHT do XLS Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT do XLS w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować MHT na XLS w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować MHT na XLS. Prześlij swój plik MHT, a następnie po prostu zapisz go jako plik XLS. Zarówno do odczytu MHT, jak i zapisu XLS można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie XLS będą identyczne z oryginalnym dokumentem MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji MHT na XLS online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHT na XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki MHT na XLS? Programiści Java mogą łatwo przekonwertować MHT na XLS w zaledwie kilku wierszach kodu.
...
1.  Konwertuj MHT na XLS, wywołując metodę Workbook.save.
