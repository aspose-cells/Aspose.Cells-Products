---
title: Como desenhar ou inserir a forma do cotovelo no Excel usando Python via .Net
weight: 10
description: Python via Código-fonte .Net para inserir a forma do cotovelo no Excel.
---
...
{{% blocks/products/pf/agp/content h2="Como inserir a forma do cotovelo no arquivo Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir a forma do cotovelo no arquivo Excel usando Python via .Net" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o add da coleção de formas[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) para inserir uma forma de cotovelo na planilha selecionada.
...
{{% blocks/products/pf/agp/code-block title="Inserir forma de cotovelo - Python via .Net" offSpacer="" %}}
