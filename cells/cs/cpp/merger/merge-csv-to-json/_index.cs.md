...
url: /cs/cpp/merger/merge-csv-to-json/ 
...
Následující příklad ukazuje, jak sloučit CSV až JSON v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení CSV až JSON v C++" InputFormat="csv" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit CSV na JSON přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit CSV až JSON? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení CSV až JSON" %}}
