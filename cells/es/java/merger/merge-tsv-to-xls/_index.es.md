---
title:  Combinar TSV a XLS via Java
...
El siguiente ejemplo muestra cómo combinar TSV con XLS en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar TSV a XLS en línea" InputFormat="tsv" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
