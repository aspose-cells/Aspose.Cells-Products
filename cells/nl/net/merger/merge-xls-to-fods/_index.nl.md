...
url: /nl/net/merger/merge-xls-to-fods/ 
...
Het volgende voorbeeld laat zien hoe u XLS samenvoegt met FODS in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLS programmatisch samenvoegen met FODS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om XLS samen te voegen met FODS" %}}
