---
title: Convertir XLSB en HTML via Java 
weight: 6480

description: Exemple de code de conversion Java pour le format XLSB en fichier HTML. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice au format HTML dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en HTML via Java" h2="Conversion XLSB en HTML Java pour convertir une ou plusieurs pages en HTML à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en HTML à l\'aide de Java" %}}

 Afin de rendre XLSB en HTML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLSB en HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier XLSB en HTML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier XLSB avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension HTML et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier HTML résultant
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLSB vers HTML Java" offSpacer="" %}}

```cs
// charger le fichier XLSB dans une instance de Workbook
Workbook book = new Workbook("template.xlsb");
// enregistrer XLSB au format HTML
