...
description: Aspose เอ็กเซล. แปลง XLTM เป็น ETT อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells Java XLTM เป็น ETT Java บันทึก XLTM ไปที่ อีทีที. บันทึก XLTM เป็น ETT โดยใช้ Java
...
{{% blocks/products/pf/agp/content h2="บันทึก XLTM ไปที่ ETT ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLTM เป็น ETT ใน Java
...
{{% blocks/products/pf/agp/content h2="Java ไลบรารี่เพื่อแปลง XLTM เป็น ETT" %}}
{{% blocks/products/pf/agp/text %}}
