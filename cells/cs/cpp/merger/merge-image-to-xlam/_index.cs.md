...
url: /cs/cpp/merger/merge-image-to-xlam/ 
...
Následující příklad ukazuje, jak sloučit IMAGE s XLAM v Aspose.Cells for C++.
...
Potřebujete sloučit IMAGE s XLAM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení IMAGE do XLAM" %}}
