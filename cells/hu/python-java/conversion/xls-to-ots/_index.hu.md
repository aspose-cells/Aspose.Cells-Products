...
description: Aspose Excel. Python Excel. A XLS-es számot gyorsan és egyszerűen konvertálja OTS-re a Aspose.Cells-es számmal. Python XLS OTS-re. Python Mentse a XLS számot az OTS-nél. Mentse el a XLS számot OTS-ként a Python Excel Library használatával.
