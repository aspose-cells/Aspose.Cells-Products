---
title: PHP SXC en JPG - Convertisseur SXC en JPG
description: Aspose Exceller. Convertissez SXC en JPG rapidement et facilement avec Aspose.Cells. PHP SXC en JPG. PHP Enregistrez SXC au format JPG. Enregistrez SXC au format JPG en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir SXC en JPG via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers SXC en JPG par programme ? Les développeurs PHP peuvent facilement charger et convertir SXC en JPG en quelques lignes de code.
...
1. Convertissez SXC en JPG en appelant la méthode de sauvegarde du classeur.
