...
Besoin de convertir des fichiers OTS en SQL par programmation ? Les développeurs C++ peuvent facilement convertir des fichiers OTS en SQL en quelques lignes de code seulement.
...
1.  Convertissez le fichier OTS en SQL en appelant la méthode Save().
