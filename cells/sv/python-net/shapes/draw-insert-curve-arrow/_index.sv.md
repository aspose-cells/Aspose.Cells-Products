---
title: Hur man ritar eller infogar en krökt pilform i Excel med Python via .Net
weight: 10
description: Python via .Net-källkod för att infoga en böjd pilform i Excel.
...
{{% blocks/products/pf/agp/content h2="Hur man infogar en krökt pilform i Excel-fil med Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga en krökt pilform i Excel-fil med Python via .Net" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens tillägg[metod](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)för att infoga en krökt pilform i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Sätt in böjd pilform - Python via .Net" offSpacer="" %}}
