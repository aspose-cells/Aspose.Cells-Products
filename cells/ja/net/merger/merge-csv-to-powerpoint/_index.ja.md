---
title: CSV を C# 経由で POWERPOINT にマージします
url: /ja/net/merger/merge-csv-to-powerpoint/ 
description: CSV を POWERPOINT Online に無料でマージします。 POWERPOINT Mergerへの無料オンラインCSV。 CSV を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、CSV を C# の POWERPOINT にマージする方法を示しています。
...
{{% cells-merger title="CSVをオンラインでPOWERPOINTにマージする無料アプリ" InputFormat="csv" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
