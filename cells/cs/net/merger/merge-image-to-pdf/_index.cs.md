---
title: Sloučit IMAGE s PDF – Sloučit IMAGE s PDF v C#
url: /cs/net/merger/merge-image-to-pdf/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit IMAGE do formátu uložení PDF. C# Zkombinujte IMAGE do formátu PDF. Sloučit IMAGE na PDF v C#. IMAGE Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit IMAGE na PDF v C#" %}}

Následující příklad ukazuje, jak sloučit IMAGE s PDF v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení IMAGE do PDF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté jej uložte do souboru PDF. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí IMAGE do PDF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit IMAGE na PDF přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit IMAGE s PDF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení IMAGE do PDF" %}}
