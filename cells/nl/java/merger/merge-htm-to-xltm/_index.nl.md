---
title: HTM samenvoegen met XLTM - HTM samenvoegen met XLTM in Java
url: /nl/java/merger/merge-htm-to-xltm/ 
description: Aspose Excel. Java Aspose.Cells. HTM samenvoegen naar XLTM opslagformaat. Java Combineer HTM met XLTM formaat. HTM samenvoegen naar XLTM in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="HTM samenvoegen met XLTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met XLTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen met XLTM" %}}
