---
title: Protect and lock XLSM document via C++ 
weight: 1810
url: /cpp/protect/xlsm/ 
description: Try our On-Premise document APIs to lock XLSM file using password on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Encrypt XLSM Files via C++" h2="Password-protect Excel spreadsheets including XLSM format using .NET Library." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/cells/272x272/aspose_cells-for-cpp.png" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="How to Secure XLSM File Using C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps toВ Protect XLSM Files via C++" %}}
...
1.  Load XLSM file using IWorkbook class
