---
title: Utwórz pliki TSV za pomocą Python 
url: /pl/python-java/create-tsv/ 
description: Python Przykładowy kod do generowania dokumentów TSV. Użyj tego kodu do tworzenia plików TSV w aplikacji Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Utwórz dokumenty TSV za pomocą Python" h2="Natywne i wydajne tworzenie wartości TSV (wartości rozdzielanych tabulatorami) programistyczne przy użyciu Python interfejsów API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Jak utworzyć TSV za pomocą Python" %}}
...
1. Zaimportuj asposecells do pliku kodu.1. Utwórz instancję klasy Workbook.1. Uzyskaj dostęp do pierwszego arkusza roboczego skoroszytu.1. Pobierz żądane komórki arkusza roboczego i wprowadź wartość do komórki (komórek).1. Użyj metody Zapisz, aby zapisać skoroszyt jako plik TSV.
...
{{% blocks/products/pf/agp/code-block title="Poniższy kod źródłowy pokazuje, jak utworzyć plik TSV za pomocą Python." offSpacer="" %}}
