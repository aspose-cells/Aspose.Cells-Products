...
{{< blocks/products/pf/i18n/upper-banner h1="Hledat ve formátech XLS v C++" h2="Nativní a vysoce výkonné vyhledávání dokumentů XLS pomocí rozhraní API Aspose.Cells na straně serveru pro C++ bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vyhledávat v souboru XLS pomocí C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Postup vyhledávání souborů XLS v C++" %}}
...
+ Načtěte soubor XLS vytvořením instance třídy IWorkbook.
...
+ Uložte soubor XLS pomocí metody IWorkbook->Save(.).
...
{{% blocks/products/pf/agp/code-block title="Prohledat soubory XLS – C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLS vyhledávání živých ukázek" sectionDescription="Hledejte text, slova, fráze v dokumentech XLS právě teď na našem webu [Web živé ukázky](https://products.aspose.app/cells/search). Živé demo má následující výhody" >}}
