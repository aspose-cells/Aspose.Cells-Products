...
weight: 200
description: Python via ซอร์สโค้ด Java สำหรับแทรกรูปภาพลงใน Excel
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปภาพของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) เพื่อแทรกรูปภาพในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่รูปภาพ - Python via ชวา" offSpacer="" %}}
