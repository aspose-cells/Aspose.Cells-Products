---
title:  Combinar XLS a XLSB via Java
url: /es/java/merger/merge-xls-to-xlsb/ 
description: Combine XLS a XLSB en línea de forma gratuita. Gratis Online XLS a XLSB Fusión. Combine XLS con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar XLS con XLSB en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a XLSB en línea" InputFormat="xls" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
