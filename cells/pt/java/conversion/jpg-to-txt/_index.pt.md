---
title: Java JPG para TXT - Conversor JPG para TXT
description: Aspose Excel. Java Aspose.Cells. JPG para TXT em Java. Java Converta JPG para TXT saveformat. Formato Java JPG para TXT. Salve JPG em TXT Java.
...
{{% blocks/products/pf/agp/content h2="Salve JPG em TXT em Java" %}}

O exemplo a seguir demonstra como converter JPG para TXT em Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter JPG em TXT. Carregue seu arquivo JPG e simplesmente salve-o como arquivo TXT. Tanto para leitura JPG quanto para gravação TXT, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída TXT serão idênticos ao documento JPG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemplo de código para converter JPG em TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="txt" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter JPG para TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPG para TXT programaticamente? Os desenvolvedores do Java podem converter facilmente JPG em TXT em apenas algumas linhas de código.
...
1.  Converta JPG em TXT chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de JPG para TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca Java para converter JPG em TXT" %}}
{{% blocks/products/pf/agp/text %}}
