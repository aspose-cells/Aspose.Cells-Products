---
title: 將 FODS 轉換為 EXCEL Java
description: 免費將 FODS 轉換為 EXCEL Online。免費在線 FODS 到 EXCEL 轉換器。 Java FODS 到 EXCEL。 FODS 到 EXCEL via Java。
...
{{% blocks/products/pf/agp/content h2="免費在線保存FODS到Java中的EXCEL" %}}

以下示例演示如何將FODS轉換為Java中的EXCEL。
...
{{% cells-convert title="將 FODS 在線轉換為 EXCEL 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將FODS轉換成EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java開發人員只需幾行代碼就可以輕鬆將FODS轉換成EXCEL。
...
{{% blocks/products/pf/agp/content h2="Java庫將FODS轉EXCEL" %}}
{{% blocks/products/pf/agp/text %}}
