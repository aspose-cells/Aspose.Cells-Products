---
title: Converter NUMBERS para PDF via Java 
url: /pt/java/conversion/numbers-to-pdf/ 
description: Exemplo de código de conversão Java para o formato NUMBERS para arquivo PDF. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para PDF em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter NUMBERS para PDF via Java" h2="Conversão de NUMBERS para PDF Java para converter uma ou várias páginas em PDF usando a biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter NUMBERS para PDF usando Java" %}}

 Para renderizar NUMBERS em PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter NUMBERS em PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente o arquivo NUMBERS em PDF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo NUMBERS com uma instância da classe Workbook1. Chame o método Workbook.save1. Passe o caminho de saída com extensão PDF e SaveFormat como parâmetros1. Verifique o caminho especificado para o arquivo PDF resultante
...
{{% blocks/products/pf/agp/code-block title="NUMBERS to PDF Java Código-fonte de conversão" offSpacer="" %}}

```cs
// carregar o arquivo NUMBERS em uma instância do Workbook
Workbook book = new Workbook("template.numbers");
// salvar NUMBERS como PDF
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de NUMBERS para PDF" sectionDescription="[Converter NÚMEROS para PDF](https://products.aspose.app/cells/conversion/numbers-to-pdf) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo NUMBERS, ele será convertido instantaneamente para PDF." >}}
