---
title: 在 ODS 文件 via .NET 中生成報告
weight: 520
description: C# 源代碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上生成 ODS 格式報告。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 生成 ODS 格式的批量報告" h2="使用數據源和模板生成 ODS 格式的報告。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1. 通過 WorkbookDesigner.Worbook.Save 方法將結果保存為 ODS 格式
...
{{% blocks/products/pf/agp/code-block title="生成 ODS 報告" offSpacer="" %}}
