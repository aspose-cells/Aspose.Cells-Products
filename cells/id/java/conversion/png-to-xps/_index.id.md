...
description: Aspose Unggul. Ubah PNG menjadi XPS dengan cepat dan mudah dengan Aspose.Cells. Java PNG menjadi XPS. Java Simpan PNG menjadi XPS. Simpan PNG sebagai 07611134 81 menggunakan Java.
...
{{% blocks/products/pf/agp/content h2="Ubah PNG menjadi XPS Menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan PNG hingga XPS di Java" %}}

Contoh berikut menunjukkan cara mengonversi PNG menjadi XPS di Java.
...
Perlu mengonversi file PNG ke XPS secara terprogram? Pengembang Java dapat dengan mudah mengonversi PNG menjadi XPS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah PNG menjadi XPS" %}}
{{% blocks/products/pf/agp/text %}}
