---
title:  ابحث عن المستند رقم XLSB دون فتحه عبر الرقم C++
weight: 7020
description: C++ مثال على التعليمات البرمجية للبحث عن الكلمات باستخدام نمط في الملف XLSB على بيئة التشغيل C++ لـ Windows 32 بت، وWindows 64 بت، ونظام التشغيل لينكس 64 بت.
...
{{< blocks/products/pf/i18n/upper-banner h1="ابحث عن تنسيقات XLSB في C++" h2="بحث أصلي وعالي الأداء عن المستندات XLSB باستخدام واجهات برمجة التطبيقات من جانب الخادم Aspose.Cells for C++، دون استخدام أي برامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية البحث عن الملف رقم XLSB باستخدام الرقم C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث عن الملفات رقم XLSB في الملف رقم C++" %}}
...
+ تحميل الملف XLSB باستخدام فئة Workbook.
...
{{% blocks/products/pf/agp/code-block title="ابحث عن الملفات XLSB - C++" offSpacer="" %}}
