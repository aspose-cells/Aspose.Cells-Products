...
{{% blocks/products/pf/agp/content h2="C#を使用してxlsファイルを修復する方法" %}}
...
{{% cells-recovery title=".NETを使用してXLSファイルを修復する無料アプリ" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="net" %}}    
