...
{{% blocks/products/pf/agp/content h2="免費在線保存HTML至XLAM至C#" %}}

以下示例演示如何將 C# 中的 HTML 轉換為 XLAM。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 HTML 轉換為 XLAM。上傳您的 HTML 文件，然後將其另存為 XLAM 文件。對於 HTML 讀取和 XLAM 寫入，您可以使用完全限定的文件名。輸出 XLAM 內容和格式將與原始 HTML 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="在線將 HTML 轉換為 XLAM 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlam" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過C#將HTML轉換為XLAM" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 HTML 為 XLAM。

{{% /blocks/products/pf/agp/text %}}

1. 使用工作簿實例加載 HTML 文件
1. 通過調用 Workbook.Save 方法將 HTML 轉換為 XLAM

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 庫將 HTML 轉換為 XLAM" %}}
