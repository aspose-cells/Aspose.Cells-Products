---
title: CSV to JSON - Convert CSV to JSON files C#
description: Aspose Excel. Free Online Convert CSV to JSON saveformat. C# CSV to JSON format. Save CSV as JSON in C#.
keywords: [Aspose Excel., C# Aspose.Cells., C# CSV to JSON saveformat., Free Online CSV to JSON Converter]
---
...
{{% blocks/products/pf/agp/content h2="Save CSV to JSON in C# Online for Free" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert CSV to JSON Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="json" IsLandingPage="true" %}}
