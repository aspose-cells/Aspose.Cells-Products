...
url: /es/net/merger/merge-image-to-fods/ 
...
El siguiente ejemplo demuestra cómo fusionar IMAGEN con FODS en Aspose.Cells for .NET.
...
¿Necesita fusionar IMAGEN con FODS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca .NET para fusionar IMAGEN con FODS" %}}
