---
title:  إنشاء التقارير في XLSM ملفات via Java
weight: 270
description: نموذج التعليمات البرمجية Java لإنشاء تقارير تنسيق XLSM على Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء تقرير مجمع بتنسيق XLSM via Java" h2="إنشاء تقارير بتنسيق XLSM باستخدام مصدر البيانات والقالب." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات توليد XLSM التقارير via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="إنشاء تقارير Excel بتنسيق XLSM - Java" offSpacer="" %}}
