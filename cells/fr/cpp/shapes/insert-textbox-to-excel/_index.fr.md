---
title:  Insérer TextBox dans Excel via C++
weight: 60
description: C++ exemple de code pour insérer TextBox dans le fichier Excel sur C++ Runtime Environment pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérer TextBox dans Excel via C++" h2="Insérez des objets en utilisant les performances natives et élevées du côté serveur Aspose.Cells for C++ API sans utiliser de logiciel tel que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#aabfa692515c324008ab417a43fed206c) pour insérer des formes d'équation dans la feuille de calcul sélectionnée
