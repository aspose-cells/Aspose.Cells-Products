---
title: كيف يمكنني رسم أو إدراج سهم مستقيم مزدوج في Excel باستخدام Python via .Net
weight: 10
description: Python via. صافي كود المصدر لرسم أو إدراج سهم مستقيم مزدوج في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج سهم مستقيم مزدوج في ملف Excel باستخدام Python via.Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) لإدراج سهم مستقيم مزدوج في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل سهمًا مستقيمًا مزدوجًا - Python via .نت" offSpacer="" %}}
