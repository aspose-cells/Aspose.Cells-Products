---
title:  Editar o ver metadatos del documento XLSX a través de C++
weight: 8970
description: Código de ejemplo C++ para editar o ver metadatos del archivo XLSX en el entorno de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
...
{{% blocks/products/pf/agp/content h2="Cómo obtener metadatos de XLSX utilizando C++" %}}
...
+ Cargue el archivo XLSX usando WorkbookMetadata
