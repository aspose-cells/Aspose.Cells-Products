...
description: Aspose Excel. Μετατρέψτε το XLS στο MHTML γρήγορα και εύκολα με το Aspose.Cells. Java XLS σε MHTML. Java Αποθήκευση 076183419 ως 076183419 στο 076183419 στο 076183419 στο XLS. 113481 χρησιμοποιώντας Java.
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση XLS έως MHTML στο Java" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το XLS σε MHTML στο Java.
...
Θέλετε να μετατρέψετε αρχεία XLS σε MHTML μέσω προγραμματισμού; Οι προγραμματιστές Java μπορούν εύκολα να μετατρέψουν το XLS σε MHTML σε λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="Java βιβλιοθήκη για μετατροπή XLS σε MHTML" %}}
{{% blocks/products/pf/agp/text %}}
