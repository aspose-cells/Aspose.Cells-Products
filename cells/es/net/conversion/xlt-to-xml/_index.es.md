---
title: C# XLT a XML - Convertidor en línea XLT a XML
description: AsposeExcel. C# Aspose.Cells. C# Aspose Cells. Gratis en línea C# Convierta XLT a formato de guardado XML. C# XLT en formato XML. Guarde XLT en XML C#.
...
{{% blocks/products/pf/agp/content h2="Guarde XLT en XML en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo convertir XLT a XML en C#.
...
¿Necesita convertir archivos XLT a XML mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente XLT a XML con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para convertir XLT a XML" %}}
