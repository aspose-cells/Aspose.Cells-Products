---
title: C# XLT إلى JSON - عبر الإنترنت من XLT إلى JSON
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل XLT إلى JSON saveformat. C# XLT إلى تنسيق JSON. وفر XLT إلى JSON C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل XLT إلى JSON في C#" h2="مكتبة C# عالية السرعة لتحويل XLT إلى JSON. هذا حل برمجي احترافي لاستيراد وتصدير XLT و JSON والعديد من التنسيقات الأخرى على .NET Framework أو .NET Core أو Mono الأنظمة الأساسية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
تحتاج إلى تحويل XLT ملفات إلى JSON برمجيا؟ يمكن للمطورين .NET تحميل وتحويل XLT إلى JSON بسهولة في بضعة أسطر من التعليمات البرمجية.
