---
title: Gabungkan PRN ke MHT - Gabungkan PRN ke MHT di Python
url: /id/python-java/merger/merge-prn-to-mht/ 
description: Aspose Unggul. Python Aspose.Cells. Online Gratis Merge PRN ke format penyimpanan MHT. Python Gabungkan format PRN ke MHT. Gabungkan PRN ke MHT di Python. Gabungkan PRN.
...
Contoh berikut menunjukkan cara menggabungkan PRN ke MHT di Aspose.Cells for Python via Java.
...
{{% cells-merger title="Online Gratis Menggabungkan PRN ke MHT di Python" InputFormat="prn" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan PRN ke MHT melalui Python" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan PRN ke MHT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API dapat dilakukan hanya dengan beberapa baris kode.
