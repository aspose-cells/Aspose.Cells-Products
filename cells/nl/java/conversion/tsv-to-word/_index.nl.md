...
{{% blocks/products/pf/agp/content h2="Sla TSV op in WORD in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar WORD in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar WORD of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TSV programmatisch converteren naar WORD? Ontwikkelaars van Java kunnen bestanden met de extensie TSV eenvoudig converteren naar WORD met slechts een paar regels code.
