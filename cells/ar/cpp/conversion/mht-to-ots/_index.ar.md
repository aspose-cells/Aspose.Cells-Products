...
هل تحتاج إلى تحويل ملفات MHT إلى OTS برمجيًا؟ يمكن للمطورين C++ تحويل MHT إلى OTS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل MHT إلى OTS باستدعاء طريقة Save ().
