---
title: Konvertieren Sie XLSM in TIFF über C#

description: Beispielcode für die Umwandlung von xlsm in tiff C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von xlsm-Dateien in tiff innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLSM in TIFF über C#" h2="Exportieren Sie Excel®-Tabellen in das TIFF-Format auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können XLSM-Dateien in nur wenigen Codezeilen einfach laden und in TIFF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. XLSM-Datei mit einer Instanz von Workbook laden1. Rufen Sie die Workbook.Save-Methode auf1. Übergeben Sie den Ausgabepfad mit der TIFF-Erweiterung als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende TIFF-Datei
