---
title:  Ver o editar metadatos de archivos ODS via .NET
weight: 320
description: Código fuente C# para editar o ver metadatos en formato ODS en plataformas .NET Framework, .NET Core, Mono o Xamarin.
