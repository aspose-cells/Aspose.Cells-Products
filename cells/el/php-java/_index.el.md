...
Υποστήριξη για CSV, οριοθετημένη με Tab &amp; HTML μορφές
 ...
 Μετατροπή αρχείων Excel σε XPS, PDF &amp; HTML
    ...
    <p>
 Το Aspose.Cells for PHP via Java API έχει τη δυνατότητα μετατροπής αρχείων Excel σε μορφές XPS, XPS και HTML, καθώς και να διατηρεί την υψηλότερη οπτική πιστότητα. Η διαδικασία μετατροπής είναι αξιόπιστη και οι προγραμματιστές μπορούν να λάβουν την απαιτούμενη μορφή με λίγες μόνο γραμμές.
    </p>
