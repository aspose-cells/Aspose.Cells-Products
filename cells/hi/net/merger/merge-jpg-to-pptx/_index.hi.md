...
url: /hi/net/merger/merge-jpg-to-pptx/ 
...
निम्नलिखित उदाहरण दर्शाता है कि Aspose.Cells for .NET में JPG को PPTX में कैसे मर्ज किया जाए।
...
JPG को प्रोग्रामेटिक रूप से PPTX में मर्ज करने की आवश्यकता है? एक बुनियादी दस्तावेज़ जिसका विलय और संयोजन हो रहा है[Aspose.Cells for .NET](https://products.aspose.com/cells/net) एपीआई को कोड की कुछ पंक्तियों के साथ किया जा सकता है।
...
{{% blocks/products/pf/agp/content h2=".NET लाइब्रेरी को जेपीजी को PPTX में मर्ज करने के लिए" %}}
