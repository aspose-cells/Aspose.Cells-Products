---
title: Java XLSX'den MD'ye - Çevrimiçi XLSX'den MD'ye Dönüştürücü
description: Aspose excel. Java Aspose.Cells. Java Aspose Cells. Ücretsiz Çevrimiçi Java XLSX'i MD saveformat'a dönüştürün. Java XLSX'den MD formatına. XLSX'i MD Java'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="XLSX\'i Java\'de MD\'ye Kaydet Çevrimiçi Ücretsiz" %}}

Aşağıdaki örnek, Java'de XLSX'in MD'ye nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

XLSX'i MD'ye dönüştürmek için kolay adımları izleyin. XLSX dosyanızı yükleyin, ardından MD dosyası olarak kaydedin. Hem XLSX okuması hem de MD yazması için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı MD içeriği ve biçimlendirmesi orijinal XLSX belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="XLSX\'i Çevrimiçi MD\'ye Dönüştürmek İçin Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="md" IsLandingPage="true" language="java" %}}
...
1.  XLSX'in MD'ye dönüştürme sonucunu alın.
