...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une image dans un fichier Excel via C#" %}}
...
+ Il existe deux façons d'insérer une image dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer une photo - C#" offSpacer="" %}}
