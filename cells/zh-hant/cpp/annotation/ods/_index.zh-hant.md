...
{{% blocks/products/pf/agp/feature-section-col title="通過C++在ODS中添加註釋的步驟" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. 使用 IWorkbook 類對象加載 ODS Excel 文件。
1. 選擇相關工作表
1. 使用 Add 方法添加評論
1. 使用 SetNote 方法設置評論的註釋。
...
{{% blocks/products/pf/agp/code-block title="添加評論 ODS - C++" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API 可用於創建、編輯、轉換和呈現 Microsoft Excel 格式為不同的格式。此外，它還可用於軟件應用程序中的綜合圖表、可擴展報告和可靠計算。 Aspose.Cells 是一個獨立的 API，它不需要像 Microsoft 或 OpenOffice 這樣的任何軟件。
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="通過在線應用程序從 ODS 添加/刪除註釋" sectionDescription="立即訪問我們的刪除 ODS 文檔註釋[現場演示網站](https://products.aspose.app/cells/annotation).現場演示有以下好處" >}}
