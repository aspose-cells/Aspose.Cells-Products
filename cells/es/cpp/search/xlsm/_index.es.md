---
title:  Buscar documento XLSM sin abrir vía C++
weight: 9280
description: Código de ejemplo C++ para buscar palabras con patrón en el archivo XLSM en el entorno de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
...
{{< blocks/products/pf/i18n/upper-banner h1="Buscar XLSM Formatos en C++" h2="Búsqueda de documentos XLSM nativa y de alto rendimiento utilizando API Aspose.Cells for C++ del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
+ Cargue el archivo XLSM creando una instancia de una clase de Libro de trabajo.
...
+ Guarde el archivo XLSM usando el método Workbook::Save(...).
