...
Het volgende voorbeeld laat zien hoe u MHT converteert naar JSON in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe MHT naar JSON te converteren" %}}
