...
weight: 6410
description: Kode sumber C# untuk membuka kunci file XLSB yang dilindungi kata sandi di .NET Framework, .NET Core, Mono atau Platform Xamarin.
...
{{% blocks/products/pf/agp/content h2="Cara Membuka Kunci File XLSB Menggunakan C#" %}}
 ...
 Untuk menghapus file proteksi XLSB, kami akan menggunakan
