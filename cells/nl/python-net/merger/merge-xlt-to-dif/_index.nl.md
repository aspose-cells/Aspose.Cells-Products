...
description: Aspose Excel. Python Excel. Voeg XLT samen met het opslagformaat DIF. Python Combineer het formaat XLT met DIF. Voeg XLT samen met DIF in de Excel-bibliotheek Python. XLT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen met DIF met behulp van de Excel-bibliotheek Python" %}}
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen met DIF in de Excel-bibliotheek Python" %}}

Het volgende voorbeeld laat zien hoe u XLT samenvoegt met DIF in Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLT samen te voegen met DIF. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand DIF. Als u code ontwikkelt in Python, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld Python waarin XLT wordt samengevoegd met DIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLT samen te voegen met DIF in de Excel-bibliotheek Python" InputFormat="xlt" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLT samenvoegt met DIF via de Excel-bibliotheek Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen met DIF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLT samen te voegen met DIF" %}}
