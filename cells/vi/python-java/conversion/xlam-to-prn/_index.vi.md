...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLAM sang PRN bằng Python" %}}
...
Ví dụ sau đây minh họa cách chuyển đổi XLAM sang PRN trong Python.
