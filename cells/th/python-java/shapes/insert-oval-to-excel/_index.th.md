---
title:  ใส่ Oval ลงใน Excel ผ่าน Python
weight: 10
description: ซอร์สโค้ด Python เพื่อแทรก Oval ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกวงรีลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกไฟล์ Oval เข้า Excel ผ่าน Python" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addOval(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกวงรีในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่วงรี - Python" offSpacer="" %}}
