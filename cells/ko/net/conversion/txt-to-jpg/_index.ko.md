---
title: C# TXT 로 JPG - TXT 로 JPG 변환기
description: Aspose Excel. 이 포괄적인 솔루션은 C# 개발자에게 TXT 파일을 JPG 형식으로 변환하는 완벽하게 통합된 접근 방식을 제공하여 Aspose.Cells 라이브러리를 사용하여 TXT 데이터를 JPG 형식으로 원활하게 저장할 수 있도록 하며, 이 모든 작업은 효율적이고 사용자 정의 가능한 C# 코드를 통해 이루어집니다.
...
{{% blocks/products/pf/agp/content h2="TXT을 C# 형식의 JPG 파일로 저장하세요." %}}

다음 예시는 TXT을 JPG 형식인 C#로 변환하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

TXT을 JPG로 변환하는 쉬운 단계를 따르세요. TXT 파일을 업로드한 후 JPG 파일로 저장하세요. TXT 읽기 및 JPG 쓰기 모두에 대해 정규화된 파일 이름을 사용할 수 있습니다. 출력 JPG 내용과 형식은 원본 TXT 문서와 동일합니다.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="TXT을 JPG로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="txt" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 TXT을 JPG로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 TXT 파일을 JPG로 변환해야 합니까? .NET 개발자는 단 몇 줄의 코드만으로 TXT을 쉽게 로드하고 JPG로 변환할 수 있습니다.
...
1.  Workbook.Save 메서드를 호출하여 TXT을 JPG 형식으로 변환합니다.
1.  TXT의 변환 결과를 JPG로 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 라이브러리를 사용하여 TXT을 JPG로 변환합니다." %}}
