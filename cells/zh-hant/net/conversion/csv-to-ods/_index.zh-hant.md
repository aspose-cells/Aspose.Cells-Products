---
title: C# CSV 轉 ODS - 在線 CSV 轉 ODS 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 CSV 轉換為 ODS 保存格式。 C# CSV 到 ODS 格式。將 CSV 保存為 ODS C#。
...
{{% blocks/products/pf/agp/content h2="免費在線保存 CSV 至 ODS 於 C#" %}}

以下示例演示如何將 C# 中的 CSV 轉換為 ODS。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 CSV 轉換為 ODS。上傳您的 CSV 文件，然後只需將其另存為 ODS 文件。對於 CSV 讀取和 ODS 寫入，您可以使用完全限定的文件名。輸出 ODS 內容和格式將與原始 CSV 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 CSV 轉換為 ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 CSV 轉換為 ODS" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 CSV 文件轉換為 ODS 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 CSV 到 ODS。
...
1. 使用工作簿實例加載 CSV 文件。
1. 通過調用 Workbook.Save 方法將 CSV 轉換為 ODS。
1. 獲取CSV到ODS的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#庫將CSV轉換為ODS" %}}
