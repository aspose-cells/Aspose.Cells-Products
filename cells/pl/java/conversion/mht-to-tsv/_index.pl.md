---
title: Java MHT na TSV - Konwerter online MHT na TSV
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwersja MHT do formatu zapisu TSV. Java MHT do formatu TSV. Zapisz MHT do TSV Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT do TSV w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować MHT na TSV w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować MHT na TSV. Prześlij swój plik MHT, a następnie po prostu zapisz go jako plik TSV. Zarówno do odczytu MHT, jak i zapisu TSV można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie TSV będą identyczne z oryginalnym dokumentem MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji MHT na TSV online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować MHT na TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki MHT na TSV? Programiści Java mogą łatwo przekonwertować MHT na TSV w zaledwie kilku wierszach kodu.
...
1.  Konwertuj MHT na TSV, wywołując metodę Workbook.save.
