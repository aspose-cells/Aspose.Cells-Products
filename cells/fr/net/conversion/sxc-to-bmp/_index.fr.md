...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SXC en BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers SXC en BMP en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier SXC avec une instance de Workbook1. Appelez la méthode Workbook.Save1. Passer le chemin de sortie avec l'extension BMP comme paramètre1. Vérifier le chemin spécifié pour le fichier BMP résultant
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir SXC en BMP" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="bmp" IsLandingPage="true" %}}
