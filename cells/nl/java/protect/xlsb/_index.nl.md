...
weight: 6590
description: Java voorbeeldcode om bestand XLSB te vergrendelen met een wachtwoord op Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
...
{{% blocks/products/pf/agp/content h2="Hoe u het XLSB-bestand kunt beveiligen met behulp van Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLSB bestanden via Java te beschermen" %}}
...
1.  Laad het bestand XLSB door de werkmapklasse te instantiëren
1.  Gebruik de methode protect(..) met ProtectionType en Wachtwoord
1.  Sla het beschermde bestand XLSB op met de methode save().
