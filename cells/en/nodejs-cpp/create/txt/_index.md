...
{{% blocks/products/pf/agp/content h2="How to Create TXT in Node.js" %}}
...
1.  Save the workbook as .txt file using Save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create TXT file in Node.js." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Node.js library to create TXT file" %}}
