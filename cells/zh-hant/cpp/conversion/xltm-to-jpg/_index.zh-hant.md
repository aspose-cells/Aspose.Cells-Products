...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 開發人員只需幾行代碼即可輕鬆地將 XLTM 文件轉換為 JPG。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加載 XLTM 文件。1. 調用 Save() 方法。1. 使用 (JPG) 文件擴展名傳遞輸出文件路徑。1. JPG 文件將保存在指定路徑。1. 在兼容程序中打開 JPG 文件。
...
{{% blocks/products/pf/agp/code-block title="XLTM轉JPGC++轉換源碼" offSpacer="" %}}
