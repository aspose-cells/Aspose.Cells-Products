...
{{< blocks/products/pf/i18n/upper-banner h1="استخراج البيانات الوصفية لـ ODS عبر Java" h2="أنشئ تطبيقاتك البالغ عددها Java لإضافة البيانات الوصفية أو تعديلها أو إزالتها أو استخراجها من ملفات ODS باستخدام واجهات برمجة التطبيقات من جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="كيفية استخراج البيانات الوصفية لـ ODS باستخدام Java" %}}

 من أجل الحصول على البيانات الوصفية لملف ODS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات استخراج البيانات الوصفية لمواد ODS عبر Java" %}}
...
+ حفظ معلومات البيانات الوصفية لنظام الوثائق الرسمية
...
{{% blocks/products/pf/agp/code-block title="استخراج البيانات الوصفية لمواد ODS - Java" offSpacer="" %}}
