---
title: حماية وقفل مستند ODS عبر .NET 
weight: 5580
url: /ar/net/protect/ods/ 
description: C# شفرة المصدر لقفل ملف ODS باستخدام كلمة المرور في .NET Framework أو .NET Core أو Mono أو أنظمة Xamarin الأساسية.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تشفير ملفات ODS عبر C#" h2="حماية جداول بيانات Excel بكلمة مرور بما في ذلك تنسيق ODS باستخدام .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1. إنشاء فئة المصنف بالمسار إلى ملف ODS1. احصل على ورقة العمل الافتراضية أو أي ورقة عمل لإضافة الحماية1. حماية ورقة العمل باستخدام طريقة Worksheet.Protect1. حماية المصنف باستخدام طريقة Workbook.Protect1. حفظ النتيجة في شكل ODS
