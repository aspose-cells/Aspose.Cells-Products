...
weight: 7710
description: Java voorbeeldcode om rapporten in de XLSX-indeling te maken op Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
...
{{< blocks/products/pf/i18n/upper-banner h1="Bulkrapport genereren in XLSX-indeling via Java" h2="Genereer rapporten in XLSX-indeling met behulp van een gegevensbron en een sjabloon." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u XLSX-rapporten kunt genereren met behulp van Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het genereren van XLSX-rapporten via Java" %}}
...
1.  Bewaar het resultaat in XLSX-formaat via de Worbook.save-methode
...
{{% blocks/products/pf/agp/code-block title="Genereer Excel-rapporten in XLSX-formaat - Java" offSpacer="" %}}
