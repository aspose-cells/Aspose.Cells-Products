...
description: Aspose excel. C++ Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme XLT ile XLT kaydetme biçimi. C++ XLT ile XLT formatını birleştirin. C++ içinde XLT'i XLT ile birleştir. XLT Birleştir.
...
Aşağıdaki örnek, XLT'in Aspose.Cells for C++'de XLT ile nasıl birleştirileceğini gösterir.
