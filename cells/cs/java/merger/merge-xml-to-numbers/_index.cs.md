---
title: Sloučit XML do ČÍSEL – Zkombinujte XML s ČÍSLY v Java
url: /cs/java/merger/merge-xml-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit XML do formátu uložení NUMBERS. Java Zkombinujte XML do formátu ČÍSLA. Sloučit XML do NUMBERS v Java. Sloučit XML.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML do NUMBERS v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XML do NUMBERS v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XML do NUMBERS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru NUMBERS. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí XML do NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XML do ČÍSEL na čísle Java" InputFormat="xml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XML s ČÍSLY via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XML do NUMBERS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení XML do NUMBERS" %}}
