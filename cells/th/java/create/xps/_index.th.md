---
title: สร้าง XPS - สร้างไฟล์ XPS ใน Java
description: Aspose เอ็กเซล. Java สร้างไฟล์ XPS อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ XPS โดยใช้ Java สร้าง XPS ใน Java Java XPS Creater
...
{{% blocks/products/pf/agp/content h2="วิธีสร้าง XPS ใน Java" %}}
...
1. บันทึกสมุดงานเป็นรูปแบบ XPS โดยใช้เมธอด save()

{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างแสดงวิธีสร้างไฟล์ XPS ใน Java" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="ไลบรารี Java เพื่อสร้างไฟล์ XPS" %}}
{{% blocks/products/pf/agp/text %}}
