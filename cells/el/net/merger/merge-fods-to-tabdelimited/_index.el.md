---
title: Συγχώνευση FODS σε TABDELIMITED - Συνδυάστε FODS σε TABDELIMITED στο C#
url: /el/net/merger/merge-fods-to-tabdelimited/ 
description: Aspose Excel. C# Aspose.Cells. Δωρεάν online συγχώνευση FODS σε μορφή αποθήκευσης TABDELIMITED. C# Συνδυάστε το FODS σε μορφή TABDELIMITED. Συγχώνευση FODS σε TABDELIMITED στο C#. FODS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση FODS σε TABDELIMITED στο C# Δωρεάν Online" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS στο TABDELIMITED στο Aspose.Cells for .NET.
...
{{% cells-merger title="Δωρεάν online για συγχώνευση FODS σε TABDELIMITED στο C#" InputFormat="fods" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Τρόπος συγχώνευσης FODS σε TABDELIMITED μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε το FODS στο TABDELIMITED μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2=".NET βιβλιοθήκη για συγχώνευση FODS σε TABDELIMITED" %}}
