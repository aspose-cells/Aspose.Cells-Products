---
title: Python XLS ~ PNG - 온라인 XLS ~ PNG 변환기
description: Aspose 엑셀. Python Aspose.Cells. Python Aspose Cells. 무료 온라인 Python XLS을 PNG saveformat으로 변환합니다. Python XLS ~ PNG 형식. XLS을 PNG Python로 저장합니다.
...
{{% cells-convert title="온라인에서 XLS을 PNG로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="png" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="XLS을 PNG로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 XLS 파일을 PNG로 변환해야 합니까? Python 개발자는 단 몇 줄의 코드로 XLS을 PNG로 쉽게 로드 및 변환할 수 있습니다.
...
1.  Workbook.save 메서드를 호출하여 XLS을 PNG로 변환합니다.
1.  XLS의 변환 결과를 PNG로 가져옵니다.
