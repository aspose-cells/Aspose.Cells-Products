---
title: JSON'i MHT ile birleştir - JSON'i C#'de MHT ile birleştir
url: /tr/net/merger/merge-json-to-mht/ 
description: Aspose excel. C# Aspose.Cells. JSON'i MHT saveformat'a Ücretsiz Çevrimiçi Birleştirme. C# JSON'i MHT biçiminde birleştirin. JSON'i C#'de MHT ile birleştir. JSON Birleştir.
...
{{% blocks/products/pf/agp/content h2="JSON\'i MHT ile C# Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, JSON'in Aspose.Cells for .NET'de MHT ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

JSON'i MHT ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından MHT dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. JSON'i MHT ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="JSON\'i C#\'de MHT ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="json" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="JSON\'i C# aracılığıyla MHT ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

JSON'i programlı olarak MHT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="JSON\'i MHT ile birleştirmek için .NET kitaplığı" %}}
