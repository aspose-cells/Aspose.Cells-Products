---
title: "Crea IMMAGINE: crea il file IMMAGINE in C++"
description: Aspose Excel. C++ Crea file IMMAGINE in modo rapido e semplice con Aspose.Cells. Genera file IMMAGINE utilizzando C++. Crea IMMAGINE in C++. C++ IMAGE Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Crea file IMMAGINE in C++" h2="Creazione di file IMMAGINE nativa e ad alte prestazioni a livello di codice senza Micorsoft Office utilizzando la libreria C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come creare IMMAGINE in C++" %}}

{{% blocks/products/pf/agp/text %}}

 È facile per gli sviluppatori creare, caricare, modificare e convertire file IMMAGINE all'interno dell'esecuzione di applicazioni di reporting per l'elaborazione dei dati in poche righe di codice.
...
1.  Salva la cartella di lavoro come file .png utilizzando il metodo Save().

{{% blocks/products/pf/agp/code-block title="Il codice di esempio mostra come creare un file IMMAGINE in C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Libreria C++ per creare file IMMAGINE" %}}
