---
title:  Συγχώνευση αρχείων HTML μέσω C++
description: C++ παράδειγμα κώδικα για συνδυασμό εγγράφων HTML στο C++ Runtime Environment για Windows 32 bit, Windows 64 bit και Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Συγχώνευση μορφών HTML στο C++" h2="HTML συγχώνευση εγγράφων με χρήση API από την πλευρά του διακομιστή C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το αρχείο HTML χρησιμοποιώντας το C++" %}}
 ...
 Για να συγχωνεύσουμε το αρχείο HTML, θα χρησιμοποιήσουμε<a href="https://products.aspose.com/cells/cpp">Aspose.Cells for C++</a> API που είναι μια πλούσια σε χαρακτηριστικά, ισχυρή και εύχρηστη πλατφόρμα συγχώνευσης εγγράφων API for C++. Μπορείτε να κατεβάσετε την τελευταία του έκδοση απευθείας, απλά ανοίξτε<a href="https://www.nuget.org/packages/aspose.cells">NuGet</a> διαχειριστής πακέτων, αναζητήστε<b>Aspose.Cells.Cpp</b> και εγκαταστήστε. Μπορείτε επίσης να χρησιμοποιήσετε την ακόλουθη εντολή από την Κονσόλα Package Manager.
...
{{% cells-merger title="Δωρεάν εφαρμογή για τη συγχώνευση αρχείων Excel σε απευθείας σύνδεση" InputFormat="html" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
