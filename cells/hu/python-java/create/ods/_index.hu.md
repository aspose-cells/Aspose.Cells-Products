...
{{< blocks/products/pf/i18n/upper-banner h1="ODS-dokumentumok létrehozása a következőn keresztül: Python" h2="Natív és nagy teljesítményű ODS (Openoffice / Lbreoffice) táblázatkészítés programozottan a Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Az ODS (Openoffice / Lbreoffice) fájl dinamikus generálása futó alkalmazáson belül egyszerű. Annak érdekében, hogy az ODS dokumentumokat a semmiből hozzuk létre, MS Office nélkül, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="ODS létrehozása a következőn keresztül: Python" %}}
...
1. Importálja az asposecellákat a kódfájlba.1. Munkafüzet osztálypéldány létrehozása.1. Nyissa meg a munkafüzet első munkalapját.1. Szerezze meg a munkalap kívánt celláit, és írja be az értéket a cellákba.1. A Mentés módszerrel mentheti a munkafüzetet ODS-fájlként.
...
{{% blocks/products/pf/agp/code-block title="A következő forráskód bemutatja, hogyan hozhat létre ODS (Openoffice / Lbreoffice) fájlt a Python használatával." offSpacer="" %}}
...
// Mentse el a munkafüzetet ODS-fájlként.
