...
{{% blocks/products/pf/agp/content h2="Ubah XLSM menjadi MARKDOWN di Python" %}}
...
Contoh berikut menunjukkan cara mengonversi XLSM menjadi MARKDOWN di Python via NET.
