...
{{< blocks/products/pf/i18n/upper-banner h1="Przeglądarka plików TSV for .NET" h2="Przeglądaj arkusze kalkulacyjne Excel i OpenOffice, takie jak TSV, bez konieczności korzystania z programu Microsoft Excel lub automatyzacji pakietu Office." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Jak wyświetlić plik TSV za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wyświetlić TSV za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells ułatwia programistom przeglądanie pliku TSV za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV w instancji Workbook1. Utwórz instancję HtmlSaveOptions i ustaw właściwość ExportHeadings na true1. Zapisz plik TSV w formacie HTML za pomocą metody Workbook.Save1. Załaduj wynikowy kod HTML w domyślnej przeglądarce za pomocą Process.Start
...
// zapisz plik TSV w formacie HTML
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API może służyć do tworzenia, edytowania, konwertowania i renderowania formatów programu Microsoft Excel do różnych formatów. Co więcej, może być używany do kompleksowych wykresów, skalowalnych raportów i niezawodnych obliczeń w aplikacjach. Aspose.Cells jest samodzielnym API i nie wymaga żadnego oprogramowania takiego jak Microsoft czy OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do przeglądania TSV" sectionDescription="Sprawdź nasze prezentacje na żywo, aby [Zobacz TSV](https://products.aspose.app/cells/viewer/tsv) z następującymi korzyściami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" razie potrzeby pobierz plik TSV z linku" >}}
