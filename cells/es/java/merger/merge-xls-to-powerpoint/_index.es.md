---
title: Combine XLS con POWERPOINT - Combine XLS con POWERPOINT en Java
url: /es/java/merger/merge-xls-to-powerpoint/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLS a formato de guardado de POWERPOINT. Java Combine XLS en formato POWERPOINT. Combinar XLS a POWERPOINT en Java. XLS Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLS con POWERPOINT en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLS con POWERPOINT en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar XLS con POWERPOINT. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo POWERPOINT. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona XLS con POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLS a POWERPOINT en Java" InputFormat="xls" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLS a POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLS con POWERPOINT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar XLS a POWERPOINT" %}}
