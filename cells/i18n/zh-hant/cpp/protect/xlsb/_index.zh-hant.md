...
weight: 4860
url: /zh-hant/cpp/protect/xlsb/ 
description: C++ 在 Windows 32 位、Windows 64 位和 Linux 64 位的 C++ 運行時環境中使用密碼鎖定 XLSB 文件的示例代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 加密 XLSB 文件" h2="使用 .NET 庫對包括 XLSB 格式的 Excel 電子表格進行密碼保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1. 使用 IWorkbook 類加載 XLSB 文件1. 將 Protect(..) 方法與 ProtectionType 和 Password 一起使用1. 通過 Save() 方法保存受保護的 XLSB 文件
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="保護 XLSB 的免費應用程序" sectionDescription="查看我們的現場演示 [加密 XLSB 文件](https://products.aspose.app/cells/protect/xlsb) 具有以下好處。" >}}
