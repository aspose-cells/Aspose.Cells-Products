...
{{% cells-convert title="將 FODS 轉換為 ET 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="et" IsLandingPage="true" %}}
...
1. 使用工作簿實例載入 FODS 檔案。
1. 呼叫 Workbook.Save 方法將 FODS 轉換為 ET。
1. 取得FODS到ET的轉換結果。
