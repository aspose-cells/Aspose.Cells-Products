---
title: C# XLTX إلى TXT - عبر الإنترنت من XLTX إلى TXT
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل XLTX إلى TXT saveformat. C# XLTX إلى تنسيق TXT. وفر XLTX إلى TXT C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل XLTX إلى TXT في C#" h2="مكتبة C# عالية السرعة لتحويل XLTX إلى TXT. هذا حل برمجي احترافي لاستيراد وتصدير XLTX و TXT والعديد من التنسيقات الأخرى على .NET Framework أو .NET Core أو Mono الأنظمة الأساسية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
تحتاج إلى تحويل XLTX ملفات إلى TXT برمجيا؟ يمكن للمطورين .NET تحميل وتحويل XLTX إلى TXT بسهولة في بضعة أسطر من التعليمات البرمجية.
