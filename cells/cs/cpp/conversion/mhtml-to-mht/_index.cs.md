...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na MHT v C++" h2="Vysoce výkonná konverze MHTML na MHT s využitím knihovny C++ bez nutnosti instalace Microsoft Excelu, OpenOffice nebo Adobe Acrobatu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Potřebujete programově převést soubory MHTML do formátu MHT? Vývojáři C++ mohou snadno převést soubory MHTML do formátu MHT pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na MHT voláním metody Save().
