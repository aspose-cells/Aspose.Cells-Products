...
description: Aspose Excel. C++ Aspose.Cells. Voeg SXC samen met het opslagformaat MHTML. C++ Combineer het formaat SXC met MHTML. Voeg SXC samen met MHTML in C++. SXC Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Voeg SXC samen met MHTML in C++" %}}

Het volgende voorbeeld laat zien hoe u SXC samenvoegt met MHTML in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om SXC samen te voegen met MHTML. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het bestand MHTML. Als u code ontwikkelt in C++, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C++ waarin SXC wordt samengevoegd met MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om SXC samen te voegen met MHTML in C++" InputFormat="sxc" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe u SXC samenvoegt met MHTML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SXC programmatisch samenvoegen met MHTML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om SXC samen te voegen met MHTML" %}}
