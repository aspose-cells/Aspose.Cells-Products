---
title:  Συγχώνευση FODS σε XPS μέσω C#
url: /el/net/merger/merge-fods-to-xps/ 
description: Συγχώνευση FODS σε XPS Online δωρεάν. Δωρεάν Online FODS έως XPS Συγχώνευση. Συγχώνευση FODS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS με το XPS στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση FODS με XPS σε απευθείας σύνδεση" InputFormat="fods" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
