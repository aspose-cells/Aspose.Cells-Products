---
title: XLAM naar ET - Converteer XLAM naar ET Python via Python
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLAM naar ET in Python" h2="High-speed Python-bibliotheek voor het converteren van XLAM naar ET. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLAM, ET en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe XLAM naar ET te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLAM-bestanden programmatisch naar ET converteren? Python-ontwikkelaars kunnen eenvoudig XLAM laden en converteren naar ET in slechts een paar regels code.
...
1.  Converteer XLAM naar ET door de methode Workbook.save aan te roepen.
