...
{{< blocks/products/pf/i18n/upper-banner h1="Converter ODS para ET em C#" h2="Biblioteca de alta velocidade C# para conversão de ODS para ET. Esta é uma solução de software profissional para importar e exportar ODS, ET e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
1.  Converta ODS para ET chamando o método Workbook.Save.
