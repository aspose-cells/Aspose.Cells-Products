...
{{< blocks/products/pf/i18n/upper-banner h1="Bảng tính PHP Excel API" h2="Thực hiện các tác vụ thao tác trên bảng tính cũng như xuất tệp Excel sang nhiều định dạng mà không cần bất kỳ phụ thuộc Microsoft Excel nào." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-php-java.svg" pfName="Aspose.Cells" subTitlepfName="for PHP via Java" downloadUrl="https://downloads.aspose.com/cells/php" >}}
...
{{< blocks/products/pf/carousel-item h3="Nhìn thoáng qua" description="Tổng quan về khả năng của Aspose.Cells for PHP via Java." >}}
...
{{< blocks/products/pf/carousel-item h3="Nền tảng độc lập" description="Aspose.Cells for PHP via Java yêu cầu PHP 7.1 (trở lên) và JavaBridge. Nó có thể chạy trên bất kỳ nền tảng nào có thể đáp ứng được các yêu cầu này." >}}
<div class="diagram1 d1-php-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 Tính năng bảng tính PHP nâng cao API
   </h2>
 ...
 Điền bảng tính thông qua Điểm đánh dấu thông minh
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Tạo, thao tác &amp; làm mới Bảng tổng hợp
    </p>
   </div>
   <div class="col-lg-4">
...
{{< blocks/products/pf/slr-element name="API Tài liệu tham khảo" href="https://reference.aspose.com/php/cells" >}}
