---
title:  TXT'i CSV via Java ile birleştir
...
Aşağıdaki örnek, TXT'in Java'de CSV ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="TXT\'i hatta CSV ile birleştirmek için Ücretsiz Uygulama" InputFormat="txt" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
