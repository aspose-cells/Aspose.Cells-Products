...
{{% blocks/products/pf/agp/content h2="Python Excel Kitaplığını Kullanarak MHT\'yi HTML\'e Dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="MHT\'yi Python Excel Kitaplığı\'nda HTML\'e kaydedin" %}}

Aşağıdaki örnek, Python excel kitaplığında MHT'nin HTML'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="Python MHT\'yi HTML\'e Dönüştürmek için Excel Kitaplığı" %}}
