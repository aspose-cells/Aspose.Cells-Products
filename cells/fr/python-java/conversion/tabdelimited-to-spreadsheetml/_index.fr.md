---
title: Convertir TABDELIMITED en SPREADSHEETML Python via Python
description: Convertissez TABDELIMITED en SPREADSHEETML en ligne gratuitement. Convertisseur TABDELIMITED en SPREADSHEETML en ligne gratuit. Python TABDELIMITED à SPREADSHEETML. TABDELIMITED à SPREADSHEETML via Python.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir TABDELIMITED en SPREADSHEETML en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="xml" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir TABDELIMITED en SPREADSHEETML via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir TABDELIMITED en SPREADSHEETML en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier TABDELIMITED avec une instance de Workbook
1.  Convertir TABDELIMITED en SPREADSHEETML en appelant la méthode Workbook.save
