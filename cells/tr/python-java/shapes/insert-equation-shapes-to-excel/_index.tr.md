---
title: Python via Java'i kullanarak Denklem Şekillerini Excel'e ekleyin
weight: 360
description: Python via Java Denklem Şekillerini Excel'e eklemek için kaynak kodu.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via Java\'i kullanarak Denklem Şekillerini Excel\'e ekleyin" h2="Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan Aspose.Cells\' API\'i kullanarak Denklem Şekillerini ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via Java Kullanarak Excel Dosyasına Denklem Şekilleri Nasıl Eklenir?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via Java\'i kullanarak Denklem Şekillerini Excel dosyasına ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Kullan[yöntem ekle](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) seçili çalışma sayfasına Denklem Şekilleri eklemek için
...
{{% blocks/products/pf/agp/code-block title="Denklem Şekillerini Ekle - Python via Java" offSpacer="" %}}
