...
description: Aspose Excel. C# Aspose.Cells. PRN to IMAGE in C#. C# Convert PRN to IMAGE saveformat. C# PRN to IMAGE format. Save PRN to IMAGE C#.
keywords: [Aspose Excel., C# Aspose.Cells., PRN to IMAGE in C#., C# PRN to IMAGE saveformat., PRN to IMAGE C#., C# Convert PRN to IMAGE]
---
...
{{% blocks/products/pf/agp/content h2="Save PRN to IMAGE in C#" %}}
...
{{% cells-convert title="Sample Code to Convert PRN to IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="png" IsLandingPage="true" %}}
