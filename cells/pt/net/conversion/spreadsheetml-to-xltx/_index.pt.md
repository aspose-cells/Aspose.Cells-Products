...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter arquivos SPREADSHEETML para XLTX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo SPREADSHEETML com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão XLTX como parâmetro1. Verifique o caminho especificado para o arquivo XLTX resultante
...
{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter SPREADSHEETML em XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xltx" IsLandingPage="true" %}}
