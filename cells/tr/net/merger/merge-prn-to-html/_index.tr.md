...
url: /tr/net/merger/merge-prn-to-html/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin HTML ile nasıl birleştirileceğini gösterir.
...
PRN'yi programlı olarak HTML ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi HTML ile birleştirmek için .NET kitaplığı" %}}
