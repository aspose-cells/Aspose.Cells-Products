...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn ComboBox vào file Excel qua C#" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[thêm phương pháp](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcombobox) để chèn ComboBox vào bảng tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn ComboBox - C#" offSpacer="" %}}
