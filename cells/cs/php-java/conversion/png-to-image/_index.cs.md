...
description: Aspose Excel. Převeďte PNG na IMAGE rychle a snadno pomocí Aspose.Cells. PHP PNG na IMAGE. PHP Uložit PNG do IMAGE. Uložte PNG jako IMAGE pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na IMAGE přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést PNG soubory na IMAGE programově? Vývojáři PHP mohou snadno načíst a převést PNG na IMAGE v několika řádcích kódu.
...
1.  Převeďte PNG na IMAGE voláním metody uložení sešitu.
