---
title: Java HTML až PNG - HTML až PNG Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu formátu HTML do formátu PNG, což umožňuje bezproblémové ukládání dat HTML do formátu PNG pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte HTML na PNG v Java" h2="Vysokorychlostní knihovna Java pro převod HTML na PNG. Toto je profesionální softwarové řešení pro import a export HTML, PNG a mnoha dalších formátů s použitím Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte HTML na PNG v Java" %}}

Následující příklad ukazuje, jak převést číslo HTML na PNG v kódu Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod HTML na PNG. Nahrajte svůj soubor HTML a poté jej jednoduše uložte jako soubor PNG. Pro čtení HTML i zápis PNG můžete použít plně kvalifikované názvy souborů. Výstupní PNG obsah a formátování bude shodné s původním dokumentem HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod čísla HTML na PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="png" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak převést HTML na PNG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory HTML na PNG? Vývojáři Java mohou snadno převést HTML na PNG pomocí několika řádků kódu.
...
1.  Převeďte HTML na PNG voláním metody Workbook.save.
1.  Získejte výsledek převodu HTML na PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod HTML na PNG" %}}
{{% blocks/products/pf/agp/text %}}
