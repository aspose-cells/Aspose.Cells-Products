---
title: A JPEG egyesítése az ETT-vel – a JPEG-es szám egyesítése az ETT-vel a Java-ben
url: /hu/java/merger/merge-jpeg-to-ett/ 
description: Aspose Excel. Java Aspose.Cells. Ingyenes online egyesítés JPEG ETT mentési formátumba. Java A JPEG kombinálása ETT formátumba. A JPEG egyesítése az ETT-vel a Java-es számon. JPEG Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a JPEG-es számot az ETT-hez a Java-es online ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a JPEG-es számot az ETT-vel a Aspose.Cells-es for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a JPEG és az ETT egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el ETT fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java példát, amely egyesíti a JPEG-et az ETT-vel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a JPEG egyesítéséhez az ETT-hez a Java-ben" InputFormat="jpg" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A JPEG és az ETT via Java egyesítése" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a JPEG-et az ETT-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a JPEG ETT-vel való egyesítéséhez" %}}
