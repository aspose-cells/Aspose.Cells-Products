---
title: Converter SXC para TSV via Python

description: Código de exemplo para conversão de sxc para tsv Python. Use API código de exemplo para arquivos sxc em lote para conversão tsv no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter SXC para TSV usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC para TSV via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para TSV em apenas algumas linhas de código.
