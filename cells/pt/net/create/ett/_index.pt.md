---
title: Criar ETT - Criar arquivo ETT em C#
description: Aspose Excel. Gere e manipule arquivos ETT sem esforço com a biblioteca Aspose.Cells for .NET. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos ETT diretamente em seus aplicativos C#, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
{{% blocks/products/pf/agp/content h2="Como criar um ETT em C#" %}}
...
1.  Use o método Save para salvar a pasta de trabalho como arquivo ETT.

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar um arquivo ETT em C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para criar arquivo ETT" %}}
