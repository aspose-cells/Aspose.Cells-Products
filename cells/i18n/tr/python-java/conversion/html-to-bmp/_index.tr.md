---
title: Python aracılığıyla HTML'yi BMP'ye dönüştürün
url: /tr/python-java/conversion/html-to-bmp/
description: Html'den bmp'ye Python dönüştürme için örnek kod. Python uygulamasında toplu html dosyalarının bmp dönüştürmeye dönüştürülmesi için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python aracılığıyla HTML\'yi BMP\'ye dönüştürün" h2="Python API\'lerini kullanarak Excel® elektronik tablolarını BMP formatına aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python Kullanarak HTML\'yi BMP\'ye Dönüştürme" %}}

 HTML'yi BMP'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Python aracılığıyla HTML\'yi BMP\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Python geliştiricileri, HTML dosyalarını yalnızca birkaç satır kodla kolayca yükleyebilir ve BMP'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Bir Çalışma Kitabı örneğiyle HTML dosyasını yükleyin1. Workbook.Save yöntemini çağırın1. Parametre olarak BMP uzantılı çıktı yolunu iletin1. Ortaya çıkan BMP dosyası için belirtilen yolu kontrol edin
