---
title: Insert Label(Form control) into Excel using Python via .Net 
weight: 80
...
{{% blocks/products/pf/agp/content h2="How to Insert Label(Form control) into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Label(Form control) to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_label/#int-int-int-int-int-int) to insert a Label(Form control) in the selected worksheet.
