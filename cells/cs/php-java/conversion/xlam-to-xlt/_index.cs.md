---
title: Konvertor PHP XLAM až XLT - XLAM až XLT
description: Aspose Excel. Převeďte XLAM na XLT rychle a snadno pomocí Aspose.Cells. PHP XLAM na XLT. PHP Uložte XLAM na XLT. Uložte XLT jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xlt" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na XLT přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na XLT programově? Vývojáři PHP mohou snadno načíst a převést XLAM na XLT v několika řádcích kódu.
...
1.  Převeďte XLAM na XLT voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na XLT" %}}
