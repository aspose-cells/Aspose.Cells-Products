...
{{< blocks/products/pf/i18n/upper-banner h1="การสร้างรายงานจำนวนมากในรูปแบบ XLS ผ่าน Java" h2="สร้างรายงานในรูปแบบ XLS โดยใช้แหล่งข้อมูลและเทมเพลต" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้างรายงาน XLS ผ่าน Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. สร้างอินสแตนซ์ WorkbookDesigner class1. เพิ่มวัตถุ Datasouce ใน ArrayList1. ตั้งค่าแหล่งข้อมูลและกระบวนการสำหรับออบเจกต์ WorkbookDesigner1. บันทึกผลลัพธ์ในรูปแบบ XLS ด้วยวิธี Worbook.save
