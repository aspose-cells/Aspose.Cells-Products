...
{{% blocks/products/pf/agp/content h2="Java Kullanarak XLSM Dosyasını Filigran Etme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden XLSM\'ye Filigran Ekleme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Yeni bir Çalışma Kitabı nesnesi oluşturun1. Dizini aracılığıyla Çalışma Sayfasını seçin1. Bir Şekil oluşturun ve onun addTextEffect işlevini kullanın1. Renkleri, Şeffaflığı ve daha fazlasını ayarlayın1. Çalışma kitabını XLSM formatında kaydedin
...
{{% blocks/products/pf/agp/code-block title="XLSM\'ye Filigran Ekle - Java" offSpacer="" %}}
