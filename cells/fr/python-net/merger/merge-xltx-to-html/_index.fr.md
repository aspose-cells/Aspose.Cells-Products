---
title:  Fusionner XLTX à HTML via Python
url: /fr/python-net/merger/merge-xltx-to-html/ 
description: Fusionnez XLTX à HTML en ligne gratuitement. Gratuit en ligne XLTX à HTML Fusion. Fusionnez XLTX vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner XLTX à HTML dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner XLTX à HTML en ligne" InputFormat="xltx" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
