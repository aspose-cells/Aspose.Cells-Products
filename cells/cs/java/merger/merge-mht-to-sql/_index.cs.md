---
title: Sloučit MHT do SQL – Kombinujte MHT s SQL v Java
url: /cs/java/merger/merge-mht-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do SQL saveformat. Java Zkombinujte formát MHT s formátem SQL. Sloučit MHT do SQL v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do SQL v Java" %}}

Následující příklad ukazuje, jak sloučit MHT s SQL v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT s SQL. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru SQL. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který spojuje MHT s SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT do SQL v Java" InputFormat="mht" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT do SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit MHT s SQL? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovnu pro sloučení MHT s SQL" %}}
