...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte TSV na SXC v C++" h2="Vysoce výkonná konverze z TSV na SXC s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Potřebujete programově převést soubory TSV na SXC? Vývojáři C++ mohou snadno převést TSV na SXC pomocí několika řádků kódu.
...
1.  Převeďte číslo TSV na SXC voláním metody Save().
