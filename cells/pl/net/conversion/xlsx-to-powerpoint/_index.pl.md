---
title: C# XLSX na POWERPOINT - XLSX na konwerter POWERPOINT
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSX na POWERPOINT za pomocą Aspose.Cells. C# XLSX na POWERPOINT. C# Zapisz XLSX w POWERPOINT. Zapisz XLSX jako POWERPOINT, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSX w POWERPOINT w C#" %}}

Poniższy przykład ilustruje, jak przekonwertować XLSX na POWERPOINT w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLSX na POWERPOINT. Prześlij plik XLSX, a następnie po prostu zapisz go jako plik POWERPOINT. Zarówno do odczytu XLSX, jak i do zapisu w programie POWERPOINT można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie programu POWERPOINT będą identyczne z oryginalnym dokumentem XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLSX na POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na POWERPOINT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSX na POWERPOINT? Programiści .NET mogą łatwo załadować i przekonwertować XLSX na POWERPOINT w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj XLSX na POWERPOINT, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLSX na POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLSX do POWERPOINT" %}}
