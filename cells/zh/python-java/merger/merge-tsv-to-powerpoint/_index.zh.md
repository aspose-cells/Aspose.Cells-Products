---
title: 通过 Python 将 TSV 合并到 POWERPOINT
...
以下示例演示如何将 TSV 合并到 Python 中的 POWERPOINT。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 TSV 合并到 POWERPOINT。上传你的文件，调用Workbook.Combine方法合并文件，然后保存到POWERPOINT文件。如果您在 Python 中开发代码，这将比听起来更简单。请参阅将 TSV 合并到 POWERPOINT 的 Python 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费应用程序将 TSV 在线合并到 POWERPOINT" InputFormat="tsv" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python库合并TSV到POWERPOINT" %}}
