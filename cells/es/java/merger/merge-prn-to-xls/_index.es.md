---
title: Combinar PRN con XLS - Combinar PRN con XLS en Java
url: /es/java/merger/merge-prn-to-xls/ 
description: AsposeExcel. Java Aspose.Cells. Combinación gratuita en línea PRN a XLS guardar formato. Java Combina PRN con formato XLS. Combinar PRN a XLS en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN a XLS en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar PRN con XLS en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar PRN con XLS. Cargue sus archivos, llame al método Workbook.Combine para combinar archivos y luego guárdelo en el archivo XLS. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que fusiona PRN con XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar PRN a XLS en Java" InputFormat="prn" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN a XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita fusionar PRN con XLS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar PRN a XLS" %}}
