...
次の例は、ODS を Aspose.Cells for Python via Java の JPEG にマージする方法を示しています。
...
ODS をプログラムで JPEG にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)API はわずか数行のコードで実行できます。
