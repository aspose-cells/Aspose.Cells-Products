---
title: Convierta TABDELIMITED a MHTML a través de Java 
url: /es/java/conversion/tabdelimited-to-mhtml/ 
description: Ejemplo de código de conversión Java para formato TABDELIMITED a archivo MHTML. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a MHTML dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta TABDELIMITED a MHTML a través de Java" h2="Conversión TABDELIMITED a MHTML Java para convertir una o varias páginas a MHTML utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir TABDELIMITED a MHTML usando Java" %}}

 Para convertir TABDELIMITED en MHTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir TABDELIMITED a MHTML a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente archivos TABDELIMITED a MHTML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo TABDELIMITED con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión MHTML y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo MHTML resultante
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED a MHTML Java código fuente de conversión" offSpacer="" %}}

```cs
// cargue el archivo TABDELIMITED en una instancia de Workbook
Workbook book = new Workbook("template.tabdelimited");
// guardar TABDELIMITED como MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED a Demostraciones en vivo de conversión MHTML" sectionDescription="[Convertir TABDELIMITED a MHTML](https://products.aspose.app/cells/conversion/tabdelimited-to-mhtml) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo TABDELIMITED, se convertirá instantáneamente a MHTML." >}}
