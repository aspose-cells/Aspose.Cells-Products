...
ต้องการแปลงไฟล์ HTM เป็น TABDELIMITED ด้วยโปรแกรมใช่ไหม? นักพัฒนาสามารถแปลง HTM เป็น TABDELIMITED ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด (รหัส C++)
...
1.  แปลง HTM เป็น TABDELIMITED โดยเรียกใช้เมธอด Save()
