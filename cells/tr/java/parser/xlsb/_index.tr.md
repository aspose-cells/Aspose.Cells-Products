---
title:  XLSB belgesi via Java'den metin ve resimleri ayıklayın
weight: 440
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı üzerindeki XLSB dosyasından metin ve görüntüleri ayıklamak için Java örnek kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB Biçimlerini Java\'de ayrıştırın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan, sunucu tarafı Aspose.Cells for Java API\'leri kullanılarak yerel ve yüksek performanslı XLSB belge ayrıştırma." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB Dosyasını Java Kullanarak Ayrıştırma" %}}
...
{{% blocks/products/pf/agp/code-block title="Ayrıştırma XLSB Dosyalar - Java" offSpacer="" %}}
