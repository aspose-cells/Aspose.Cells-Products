---
title: Konverter PHP MHTML hingga DIF - MHTML hingga DIF
description: Aspose Unggul. Ubah MHTML menjadi DIF dengan cepat dan mudah dengan Aspose.Cells. PHP MHTML menjadi DIF. PHP Simpan MHTML menjadi DIF. Simpan MHTML sebagai DIF menggunakan PHP.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah MHTML menjadi DIF melalui PHP" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file MHTML ke DIF secara terprogram? Pengembang PHP dapat dengan mudah memuat & mengonversi MHTML menjadi DIF hanya dalam beberapa baris kode.
...
1.  Ubah MHTML menjadi DIF dengan memanggil metode simpan Buku Kerja.
1.  Dapatkan hasil konversi dari MHTML menjadi DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Pustaka PHP untuk mengonversi MHTML menjadi DIF" %}}
