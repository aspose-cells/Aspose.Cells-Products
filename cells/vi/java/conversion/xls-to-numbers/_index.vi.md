---
title: Java XLS sang SỐ - Bộ chuyển đổi XLS sang SỐ trực tuyến
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Trực tuyến miễn phí Java Chuyển đổi XLS sang định dạng lưu trữ SỐ. Java XLS sang định dạng SỐ. Lưu XLS thành SỐ Java .
...
{{< blocks/products/pf/i18n/upper-banner h1="Đổi XLS thành SỐ trong Java" h2="Thư viện Java tốc độ cao để chuyển đổi XLS thành SỐ. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất XLS, SỐ và nhiều định dạng khác bằng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS thành SỐ trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi XLS thành SỐ trong Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để chuyển đổi XLS thành SỐ. Tải lên tệp XLS của bạn, sau đó chỉ cần lưu tệp dưới dạng tệp NUMBERS. Đối với cả cách đọc XLS và cách viết SỐ, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng SỐ đầu ra sẽ giống với tài liệu gốc XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi XLS thành SỐ trực tuyến" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="numbers" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách Đổi Đầu Số XLS Thành Đầu Số via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi các tệp XLS thành SỐ theo chương trình? Java nhà phát triển có thể dễ dàng chuyển đổi XLS thành SỐ chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLS thành SỐ bằng cách gọi phương thức Workbook.save.
1.  Lấy kết quả chuyển đổi XLS sang SỐ.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="thư viện Java để chuyển đổi XLS thành SỐ" %}}
{{% blocks/products/pf/agp/text %}}
