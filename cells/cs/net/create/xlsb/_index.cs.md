...
description: Aspose Excel. Snadno generujte a manipulujte se soubory XLSB pomocí knihovny Aspose.Cells for .NET. Tato výkonná knihovna API poskytuje efektivní řešení pro vytváření, úpravu a správu souborů XLSB přímo ve vašich aplikacích C# a splňuje specifické potřeby vývojářů s vysokou přesností.
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit XLSB v C#" %}}

{{% blocks/products/pf/agp/text %}}

 Pro vývojáře je snadné vytvářet, načítat, upravovat a převádět soubory XLSB v rámci různých aplikací pro vytváření sestav pro zpracování dat v několika řádcích kódu.
...
{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor XLSB v C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro vytvoření souboru XLSB" %}}
