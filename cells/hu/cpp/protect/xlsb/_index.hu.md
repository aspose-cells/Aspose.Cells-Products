...
{{< blocks/products/pf/i18n/upper-banner h1="XLSB-fájlok titkosítása a következőn keresztül: C++" h2="Jelszóval védheti az Excel-táblázatokat, beleértve az XLSB formátumot is a .NET Library használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB fájlok biztonságossá tétele a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSB-fájlok védelmének lépései a következőn keresztül: C++" %}}
...
1. Töltse be az XLSB fájlt az IWorkbook osztály segítségével1. Használja a Protect(..) metódust a ProtectionType-val és a jelszóval1. Mentse a védett XLSB fájlt a Save() metódussal
