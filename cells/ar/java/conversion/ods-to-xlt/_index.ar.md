---
title: تحويل ODS إلى XLT عبر Java 
weight: 8910
url: /ar/java/conversion/ods-to-xlt/ 
description: نموذج Java رمز تحويل لتنسيق ODS إلى ملف XLT. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى XLT داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ODS إلى XLT عبر Java" h2="ODS إلى XLT Java لتحويل صفحات مفردة أو صفحات متعددة إلى XLT باستخدام مكتبة محلية Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل ODS إلى XLT باستخدام Java" %}}

 من أجل تقديم ODS إلى XLT ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل ODS إلى XLT عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف ODS إلى XLT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف ODS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XLT & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XLT الناتج
...
{{% blocks/products/pf/agp/code-block title="ODS إلى XLT Java شفرة مصدر التحويل" offSpacer="" %}}
