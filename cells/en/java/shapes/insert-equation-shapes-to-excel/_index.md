---
title: Insert Equation Shapes into Excel via Java 
weight: 360
...
{{% blocks/products/pf/agp/content h2="How to Insert Equation Shapes into Excel File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Equation Shapes to Excel file via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) to insert Equation Shapes in the selected worksheet
