...
description: Aspose Excel. Převeďte XML na ET rychle a snadno pomocí Aspose.Cells. C++ XML na ET. C++ Uložit XML do ET. Uložit XML jako ET pomocí C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte XML na ET v C++" h2="Vysoce výkonný převod XML na ET pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložit XML do ET na C++" %}}
...
{{% cells-convert title="Ukázkový kód pro převod XML na ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="et" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XML na ET přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XML soubory na ET programově? C++ vývojáři mohou snadno převést XML na ET pomocí několika řádků kódu.
...
1.  Převeďte XML na ET voláním metody Save().
