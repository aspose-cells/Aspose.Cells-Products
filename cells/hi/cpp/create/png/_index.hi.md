...
description: Aspose एक्सेल। C++ PNG फ़ाइल बनाएँ। PNG C++ बनाएं। C++ PNG क्रिएटर। C++ में PNG बनाएं। C++ का उपयोग करके PNG फ़ाइल जेनरेट करें।
...
{{% blocks/products/pf/agp/text %}}
 ...
 डेवलपर्स के लिए कोड की कुछ पंक्तियों में डेटा प्रोसेसिंग के लिए चल रहे रिपोर्टिंग एप्लिकेशन के भीतर PNG फ़ाइलों को बनाना, लोड करना, संशोधित करना और परिवर्तित करना आसान है।
...
1.  Save() विधि का उपयोग करके कार्यपुस्तिका को .png फ़ाइल के रूप में सहेजें।
