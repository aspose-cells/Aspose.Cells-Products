...
description: Aspose Excel. Convierta JPG a MHT rápida y fácilmente con Aspose.Cells. Python JPG a MHT. Python Guardar JPG en MHT. Guarde JPG como MHT usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde JPG en MHT en Python" %}}

El siguiente ejemplo demuestra cómo convertir JPG a MHT en Python via NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir JPG a MHT. Cargue su archivo JPG y luego simplemente guárdelo como archivo MHT. Tanto para lectura JPG como para escritura MHT, puede utilizar nombres de archivo completos. El contenido y el formato MHT de salida serán idénticos al documento JPG original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir JPG a MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="mht" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir JPG a MHT" %}}
