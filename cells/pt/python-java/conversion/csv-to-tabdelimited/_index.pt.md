---
title: Converter CSV para TABDELIMITED via Python
url: /pt/python-java/conversion/csv-to-tabdelimited/
description: Código de amostra para conversão de csv para Python delimitado por tabulação. Use API código de exemplo para arquivos csv em lote para conversão delimitada por tabulação no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter CSV para TABDELIMITED usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter CSV em TABDELIMITED via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos CSV para TABDELIMITED em apenas algumas linhas de código.
