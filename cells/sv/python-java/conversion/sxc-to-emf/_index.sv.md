---
title: Konvertera SXC till EMF via Python
url: /sv/python-java/conversion/sxc-to-emf/
description: Exempelkod för konvertering från sxc till emf Python. Använd API exempelkod för batch-sxc-filer för att emf-konvertera i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till EMF med Python" %}}

 För att konvertera SXC till EMF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till EMF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera SXC-filer till EMF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SXC-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med EMF-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande EMF-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera SXC till EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="emf" IsLandingPage="true" language="python" %}}
