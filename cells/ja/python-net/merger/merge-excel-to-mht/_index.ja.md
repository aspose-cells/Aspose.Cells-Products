---
title: Python 経由で EXCEL を MHT にマージ
url: /ja/python-net/merger/merge-excel-to-mht/ 
description: EXCEL をオンラインで無料で MHT にマージします。無料のオンライン EXCEL から MHT へのマージ。 Excel を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、EXCEL を Python の MHT にマージする方法を示しています。
...
{{% cells-merger title="オンラインでEXCELをMHTにマージする無料アプリ" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
