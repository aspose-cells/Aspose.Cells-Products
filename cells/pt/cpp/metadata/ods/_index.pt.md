---
title:  Edite ou visualize metadados do documento ODS via C++
weight: 1000
description: Código de exemplo C++ para editar ou visualizar metadados do arquivo ODS no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
...
+ Carregue o arquivo ODS usando WorkbookMetadata
