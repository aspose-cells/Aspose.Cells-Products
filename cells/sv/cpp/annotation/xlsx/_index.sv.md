---
title:  Lägg till eller ta bort XLSX Anteckning via C++
weight: 5260
description: C++ exempelkod för att lägga till eller ta bort XLSX formatkommentarer på C++ Runtime Environment för Windows 32 bitar, Windows 64 bitar och Linux 64 bitar.
...
1.  Ladda XLSX Excel-filen med IWorkbook-klassobjektet.
...
{{% blocks/products/pf/agp/code-block title="Lägg till kommentarer på XLSX - C++" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API kan användas för att skapa, redigera, konvertera och rendera Microsoft Excel-format till olika format. Dessutom kan den användas för omfattande kartläggning, skalbar rapportering och tillförlitliga beräkningar inom mjukvaruapplikationer. Aspose.Cells är en fristående API och den kräver ingen programvara som Microsoft eller OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Lägg till / ta bort anteckning från XLSX via onlineappen" sectionDescription=" Ta bort XLSX dokumentkommentarer just nu genom att besöka vår[Live Demos webbplats](https://products.aspose.app/cells/annotation). Livedemon har följande fördelar" >}}
