---
title: Sloučit TXT na OTS - Sloučit TXT na OTS v Java
url: /cs/java/merger/merge-txt-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma TXT do formátu OTS. Java Zkombinujte TXT do formátu OTS. Sloučit TXT do OTS v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT do OTS pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT do OTS v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit TXT do OTS v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TXT s OTS. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru OTS. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí TXT do OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení TXT do OTS v Java" InputFormat="txt" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit TXT do OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit TXT do OTS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení TXT do OTS" %}}
