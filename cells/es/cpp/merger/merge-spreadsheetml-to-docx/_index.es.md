---
title: Combine SPREADSHEETML con DOCX - Combine SPREADSHEETML con DOCX en C++
url: /es/cpp/merger/merge-spreadsheetml-to-docx/ 
description: AsposeExcel. C++ Aspose.Cells. Combinación gratuita en línea SPREADSHEETML a DOCX guardar formato. C++ Combine SPREADSHEETML al formato DOCX. Combinar HOJA DE CALCULO a DOCX en C++. Combinar HOJA DE CALCULO.
...
El siguiente ejemplo muestra cómo fusionar SPREADSHEETML a DOCX en Aspose.Cells for C++.
...
{{% cells-merger title="Gratis en línea para fusionar SPREADSHEETML a DOCX en C++" InputFormat="xml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar SPREADSHEETML a DOCX a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar SPREADSHEETML con DOCX mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden hacer con solo unas pocas líneas de código.
