...
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format XLS au format EMF, permettant un enregistrement transparent des données XLS au format EMF à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS au lieu de EMF dans C#" %}}
...
{{% cells-convert title="Exemple de code pour convertir XLS en EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="emf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en EMF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en EMF par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en EMF en quelques lignes de code seulement.
...
1.  Convertissez XLS en EMF en appelant la méthode Workbook.Save.
