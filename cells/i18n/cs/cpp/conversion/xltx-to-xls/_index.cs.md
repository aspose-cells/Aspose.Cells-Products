---
title: Převeďte XLTX na XLS pomocí aplikace C++ 
url: /cs/cpp/conversion/xltx-to-xls/ 
description: Ukázkový konverzní kód C++ pro dokument XLTX na formát XLS. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLTX na XLS v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLTX na XLS pomocí C++" %}}

 K převodu XLTX na XLS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod XLTX na XLS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLTX na XLS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLTX pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (XLS).1. Soubor XLS bude uložen do zadané cesty.1. Otevřete soubor XLS v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLTX na XLS C++" offSpacer="" %}}
