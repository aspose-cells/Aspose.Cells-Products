---
title: C# ODS से एमएचटी - ODS से एमएचटी कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ ODS को एमएचटी में जल्दी और आसानी से बदलें। C# ODS को एमएचटी में बदलें। C# ODS को एमएचटी में सहेजें। C# का उपयोग करके ODS को एमएचटी के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="ODS को एमएचटी में C# में सेव करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि ODS को C# में एमएचटी में कैसे परिवर्तित किया जाए।
...
{{% cells-convert title="ODS को एमएचटी में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="ODS को C# के माध्यम से एमएचटी में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

ODS फ़ाइलों को प्रोग्रामेटिक रूप से एमएचटी में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में ODS को आसानी से एमएचटी में लोड और परिवर्तित कर सकते हैं।
...
1.  वर्कबुक.सेव विधि को कॉल करके ODS को एमएचटी में बदलें।
1.  ODS का एमएचटी में रूपांतरण परिणाम प्राप्त करें।

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ODS को एमएचटी में बदलने के लिए C# लाइब्रेरी" %}}
