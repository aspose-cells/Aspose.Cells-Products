---
title: Comment dessiner ou insérer une forme de double flèche de coude dans Excel à l'aide de Python via Java
weight: 10
description: Dessinez ou insérez une forme de double flèche de coude en utilisant Aspose.Cells' Python via Java API sans aucun logiciel tel que Microsoft ou Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Comment insérer la forme d\'un coude à double flèche dans un fichier Excel à l\'aide de Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer la forme du coude à double flèche dans un fichier Excel à l\'aide du Python via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez la collection de formes[ajouter une méthode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) pour insérer une forme de coude à double flèche dans la feuille de calcul sélectionnée.
