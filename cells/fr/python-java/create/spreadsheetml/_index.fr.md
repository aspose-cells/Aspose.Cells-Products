...
{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier SPREADSHEETML dans la bibliothèque Excel Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python Bibliothèque Excel pour créer un fichier SPREADSHEETML" %}}
