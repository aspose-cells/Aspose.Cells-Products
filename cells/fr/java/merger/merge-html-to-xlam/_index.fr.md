---
title: Fusionner HTML à XLAM - Combiner HTML à XLAM dans Java
url: /fr/java/merger/merge-html-to-xlam/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite HTML au format de sauvegarde XLAM. Java Combinez le format HTML au format XLAM. Fusionner HTML à XLAM dans Java. HTML Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTML à XLAM en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner HTML à XLAM dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner HTML à XLAM. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier XLAM. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne HTML à XLAM.
...
{{% blocks/products/pf/agp/content h2="Comment fusionner HTML à XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner HTML à XLAM par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner HTML à XLAM" %}}
