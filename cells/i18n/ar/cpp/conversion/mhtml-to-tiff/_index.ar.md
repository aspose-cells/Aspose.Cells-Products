---
title: تحويل MHTML إلى TIFF عبر تطبيق C++ 
weight: 4830
url: /ar/cpp/conversion/mhtml-to-tiff/ 
description: نموذج لشفرة تحويل C++ لمستند MHTML إلى تنسيق TIFF. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل MHTML إلى TIFF الدفعي في أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHTML إلى TIFF عبر C++" h2="تحويل MHTML إلى TIFF عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MHTML إلى TIFF باستخدام C++" %}}

 من أجل تحويل MHTML إلى TIFF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل MHTML إلى TIFF عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ تحويل ملف MHTML إلى TIFF بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف MHTML باستخدام Factory :: CreateIWorkbook.1. حدد ورقة العمل الأولى.1. اضبط خيارات (TIFF).1. كرر خلال كل صفحة من الورقة وعرضها.1. افتح ملف TIFF في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="MHTML إلى TIFF C++ شفرة مصدر التحويل" offSpacer="" %}}
