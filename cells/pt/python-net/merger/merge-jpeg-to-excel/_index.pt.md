...
url: /pt/python-net/merger/merge-jpeg-to-excel/ 
...
O exemplo a seguir demonstra como mesclar JPEG para EXCEL em Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Precisa mesclar JPEG para EXCEL programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) As APIs podem ser feitas com apenas algumas linhas de código.
