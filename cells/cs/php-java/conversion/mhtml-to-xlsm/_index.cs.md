---
title: Konvertor PHP MHTML až XLSM - MHTML až XLSM
description: Aspose Excel. Převeďte MHTML na XLSM rychle a snadno pomocí Aspose.Cells. PHP MHTML na XLSM. PHP Uložte MHTML na XLSM. Uložte XLSM jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na XLSM přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na XLSM programově? Vývojáři PHP mohou snadno načíst a převést MHTML na XLSM v několika řádcích kódu.
...
1.  Převeďte MHTML na XLSM voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na XLSM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na XLSM" %}}
