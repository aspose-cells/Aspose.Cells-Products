...
{{% blocks/products/pf/agp/content h2="How to Insert Insert Stars And Banners into Excel File Using Using Java" %}}

 In order to insert Insert Stars And Banners into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Insert Stars And Banners to Excel file via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) to insert Insert Stars And Banners in the selected worksheet
...
The sample code below demonstrates how to insert "Ribbon: Curved and Tilted Up" and "Explosion: 8 Points". For more types, please refer to "Overview of Insert Star And Banner Types" below.

{{% blocks/products/pf/agp/code-block title="Insert Insert Stars And Banners - Java" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Overview of Insert Star And Banner Types
   </h2>
   <div class="col-lg-4">
