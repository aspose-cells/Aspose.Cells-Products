---
title: تحويل XLS إلى ODS عبر Java 
weight: 7650
url: /ar/java/conversion/xls-to-ods/ 
description: نموذج Java كود التحويل لتنسيق XLS إلى ملف ODS. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى ODS من خلال أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLS إلى ODS عبر Java" h2="XLS إلى ODS Java لتحويل صفحات مفردة أو متعددة إلى ODS باستخدام المكتبة المحلية Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى ODS باستخدام Java" %}}

 من أجل تقديم XLS إلى ODS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLS إلى ODS عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف XLS إلى ODS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف XLS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد ODS & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف ODS الناتج
...
{{% blocks/products/pf/agp/code-block title="XLS إلى كود مصدر تحويل Java ODS" offSpacer="" %}}
