...
Trzeba programowo przekonwertować pliki XLTM do formatu HTM? Programiści C++ mogą łatwo przekonwertować pliki XLTM do formatu HTM za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XLTM do HTM wywołując metodę Save().
