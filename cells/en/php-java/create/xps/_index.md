...
{{% blocks/products/pf/agp/content h2="How to Create XPS in PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="Sample code shows how to create XPS file in PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PHP library to create XPS file" %}}
