...
description: Aspose Excel。 C# Aspose.Cells。將MHT合併至HTML儲存格式。 C# 將 MHT 合併為 HTML 格式。將 MHT 合併到 C# 中的 HTML。MHT 合併。
...
{{% blocks/products/pf/agp/content h2="將MHT合併到C#中的HTML" %}}

以下範例示範如何將MHT合併為Aspose.Cells for .NET中的HTML。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 合併到 HTML。上傳文件，呼叫 Workbook.Combine 方法合併文件，然後將其儲存到 HTML 文件。如果您在 C# 中開發程式碼，這會比聽起來更簡單。請參閱 C# 將 MHT 合併為 HTML 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 MHT 合併到 C# 中的 HTML 的範例程式碼" InputFormat="mht" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 MHT 合併到 HTML" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 MHT 合併到 HTML 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
