...
weight: 10
description: Python via Java исходный код для вставки Line в Excel.
---
...
{{% blocks/products/pf/agp/content h2="Как вставить строку в файл Excel, используя Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке строки в файл Excel с использованием Python via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить строку в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Линия вставки - Python via Java" offSpacer="" %}}
