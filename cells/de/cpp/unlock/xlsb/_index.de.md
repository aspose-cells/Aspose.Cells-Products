...
{{% blocks/products/pf/agp/content h2="So entfernen Sie den Schutz der XLSB-Datei mit C++" %}}

 Um die XLSB-Datei zu entsperren, verwenden wir
...
1. Laden Sie die gesperrte XLSB-Datei mit CreateIWorkbook.1. Rufen Sie zum Entsperren die Unprotect()-Funktion auf.1. Setzen Sie das Passwort mit SetPassword auf NULL.1. Speichern Sie die XLSB-Datei an einem bestimmten Ort.
