...
description: Aspose Excel. Python Aspose.Cells. Συγχώνευση MHT σε μορφή αποθήκευσης SPREADSHEETML. Python Συνδυάστε τη μορφή MHT σε SPREADSHEETML. Συγχώνευση MHT στο SPREADSHEETML στο Python. Συγχώνευση MHT.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση του MHT στο SPREADSHEETML στο Python" %}}
...
{{% cells-merger title="Δείγμα κώδικα για συγχώνευση MHT με SPREADSHEETML στο Python" InputFormat="mht" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
