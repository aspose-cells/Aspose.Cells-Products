---
title: C++ XML เป็น XLS - ตัวแปลง XML เป็น XLS ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง XML เป็น XLS saveformat C++ รูปแบบ XML เป็น XLS บันทึก XML เป็น XLS C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XML เป็น XLS ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง XML เป็น XLS โดยเรียกเมธอด Save()
