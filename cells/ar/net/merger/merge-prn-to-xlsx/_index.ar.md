...
يوضح المثال التالي كيفية دمج PRN مع XLSX في Aspose.Cells for .NET.
...
هل تحتاج إلى دمج PRN في XLSX برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
