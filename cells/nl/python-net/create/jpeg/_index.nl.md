---
title: Creëer JPEG - Creëer JPEG bestand in Python
description: Aspose Excel. Python Creëer JPEG-bestand. Creëer JPEG Python. Python JPEG Maker. Maak JPEG in Python. Genereer JPEG-bestand met Python.
...
1. Gebruik de methode Save om de werkmap op te slaan als JPEG-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een JPEG-bestand maakt in Python." offSpacer="" %}}
