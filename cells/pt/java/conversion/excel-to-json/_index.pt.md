---
title: Java EXCEL para JSON - Conversor EXCEL para JSON
description: Aspose Excel. Converta EXCEL em JSON de forma rápida e fácil com Aspose.Cells. Java EXCEL em JSON. Java Salve EXCEL em JSON. Salve EXCEL como JSON usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter EXCEL para JSON em Java" h2="Biblioteca Java de alta velocidade para converter EXCEL em JSON. Esta é uma solução de software profissional para importar e exportar EXCEL, JSON e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salve EXCEL em JSON em Java" %}}

O exemplo a seguir demonstra como converter EXCEL em JSON em Java.
...
{{% blocks/products/pf/agp/content h2="Como converter EXCEL para JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos EXCEL para JSON programaticamente? Os desenvolvedores Java podem facilmente converter EXCEL em JSON em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Java para converter EXCEL para JSON" %}}
{{% blocks/products/pf/agp/text %}}
