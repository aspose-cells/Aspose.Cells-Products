...
url: /nl/cpp/merger/merge-html-to-jpeg/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen HTML naar JPEG saveformat. C++ Combineer het formaat HTML tot JPEG. Samenvoegen HTML tot JPEG in C++. HTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTML samen met JPEG in C++ Online gratis" %}}

Het volgende voorbeeld laat zien hoe u HTML samenvoegt met JPEG in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTML samen te voegen met JPEG. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand JPEG. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat HTML samenvoegt met JPEG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om HTML samen te voegen tot JPEG in C++" InputFormat="html" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe HTML samen te voegen met JPEG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u HTML programmatisch samenvoegen tot JPEG? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om HTML samen te voegen tot JPEG" %}}
