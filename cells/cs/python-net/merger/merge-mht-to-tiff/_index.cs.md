...
url: /cs/python-net/merger/merge-mht-to-tiff/ 
...
Následující příklad ukazuje, jak sloučit MHT s TIFF v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit MHT na TIFF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
