---
title:  أدخل التسمية (التحكم في النموذج) في Excel باستخدام Python via .Net
weight: 80
description: Python via. صافي كود المصدر لإدراج التسمية (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج التسمية (التحكم في النموذج) في ملف Excel باستخدام Python via .Net" %}}

 من أجل إدراج التسمية (التحكم في النموذج) في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج التسمية (التحكم في النموذج) في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_label/#int-int-int-int-int-int) لإدراج تسمية (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج تسمية (التحكم في النموذج) - Python via .Net" offSpacer="" %}}
