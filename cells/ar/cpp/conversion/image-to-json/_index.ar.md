...
description: Aspose اكسل. قم بتحويل IMAGE إلى JSON بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى JSON. C++ احفظ IMAGE إلى JSON. احفظ IMAGE كـ JSON باستخدام C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصورة إلى JSON في C++" h2="تحويل IMAGE عالي الأداء إلى JSON باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى JSON برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى JSON بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى JSON عن طريق استدعاء طريقة Save().
