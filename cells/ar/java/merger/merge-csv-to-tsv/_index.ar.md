---
title:  ادمج CSV إلى TSV via Java
...
يوضح المثال التالي كيفية دمج CSV مع TSV في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج CSV إلى TSV عبر الإنترنت" InputFormat="csv" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
