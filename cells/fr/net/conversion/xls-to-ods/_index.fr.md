...
Besoin de convertir les fichiers XLS en ODS par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en ODS en quelques lignes de code seulement.
...
1.  Convertissez XLS en ODS en appelant la méthode Workbook.Save.
