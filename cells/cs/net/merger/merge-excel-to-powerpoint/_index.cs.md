---
title: Sloučit EXCEL s POWERPOINT - Kombinujte EXCEL s POWERPOINT v C#
url: /cs/net/merger/merge-excel-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit EXCEL do formátu uložení POWERPOINT. C# Kombinujte formát EXCEL a POWERPOINT. Sloučit EXCEL do POWERPOINT v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL s POWERPOINT v C#" %}}

Následující příklad ukazuje, jak sloučit EXCEL do POWERPOINT v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení EXCELu s POWERPOINT. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru POWERPOINT. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí EXCEL do POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení EXCEL do POWERPOINT v C#" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL do POWERPOINT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit EXCEL do POWERPOINT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu ke sloučení EXCELu s POWERPOINT" %}}
