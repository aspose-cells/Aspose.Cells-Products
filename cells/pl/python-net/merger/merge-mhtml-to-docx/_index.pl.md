---
title: Połącz MHTML z DOCX - Połącz MHTML z DOCX w Python
url: /pl/python-net/merger/merge-mhtml-to-docx/ 
description: Aspose Excel. Python Aspose.Cells. Bezpłatne scalanie online MHTML do DOCX w formacie zapisu. Python Połącz format MHTML z DOCX. Połącz MHTML z DOCX w Python. MHTML Połącz.
...
{{% cells-merger title="Bezpłatne połączenie online MHTML z DOCX w Python" InputFormat="mhtml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć MHTML z DOCX za pośrednictwem Python" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić MHTML z DOCX programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
