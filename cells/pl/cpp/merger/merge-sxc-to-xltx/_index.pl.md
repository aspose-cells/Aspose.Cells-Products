---
title: Połącz SXC z XLTX - Połącz SXC z XLTX w C++
url: /pl/cpp/merger/merge-sxc-to-xltx/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online SXC do XLTX w formacie zapisu. C++ Połącz format SXC z XLTX. Połącz SXC z XLTX w C++. SXC Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz SXC z XLTX w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć SXC z XLTX w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć SXC z XLTX. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku XLTX. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy numery SXC z XLTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online SXC z XLTX w C++" InputFormat="sxc" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć SXC z XLTX za pośrednictwem C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić SXC z XLTX programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
