---
title: C++ XLS sang MD - XLS sang MD Bộ chuyển đổi
description: Aspose Excel. Chuyển đổi XLS sang MD nhanh chóng và dễ dàng với Aspose.Cells. C++ XLS sang MD. C++ Lưu XLS vào MD. Lưu XLS dưới dạng MD bằng C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS sang MD trong C++" h2="Chuyển đổi XLS sang MD hiệu suất cao bằng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS vào MD trong C++" %}}
...
{{% cells-convert title="Mã mẫu để chuyển đổi XLS sang MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="md" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLS sang MD qua C++" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLS sang MD theo chương trình? Các nhà phát triển C++ có thể dễ dàng chuyển đổi XLS thành MD chỉ bằng một vài dòng mã.
