...
url: /tr/python-net/merger/merge-ots-to-gif/ 
...
Aşağıdaki örnek, OTS'nin Aspose.Cells for Python via .NET'de GIF ile nasıl birleştirileceğini gösterir.
...
OTS'yi programlı olarak GIF ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
