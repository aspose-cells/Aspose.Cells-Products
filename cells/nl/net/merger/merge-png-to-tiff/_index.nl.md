...
description: Aspose Excel. C# Aspose.Cells. Voeg PNG samen met het opslagformaat TIFF. C# Combineer het formaat PNG met TIFF. Voeg PNG samen met TIFF in C#. PNG Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u PNG samenvoegt met TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PNG programmatisch samenvoegen met TIFF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen met TIFF" %}}
