...
{{% blocks/products/pf/agp/content h2="Convertir SPREADSHEETML en IMAGE à l\'aide de Python" %}}
...
L'exemple suivant montre comment convertir SPREADSHEETML en IMAGE dans Python.
