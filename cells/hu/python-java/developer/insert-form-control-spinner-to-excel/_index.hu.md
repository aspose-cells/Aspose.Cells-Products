...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)) egy Spin Button (Űrlapvezérlő) beszúrásához a kiválasztott munkalapba.
