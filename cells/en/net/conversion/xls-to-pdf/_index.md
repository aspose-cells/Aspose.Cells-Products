---
title: C# XLS to PDF - XLS to PDF Converter
description: Aspose Excel. Convert XLS to PDF quickly and easily with Aspose.Cells. C# XLS to PDF. C# Save XLS to PDF. Save XLS as PDF using C#.
...
{{< blocks/products/pf/upper-banner h1="Convert XLS to PDF in C#" h2="High-speed C# library for converting XLS to PDF. This is a professional software solution to import and export XLS, PDF, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Save XLS to PDF in C#" %}}

The following example demonstrates how to convert XLS to PDF in C#.
...
{{% cells-convert title="Sample Code to Convert XLS to PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLS to PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert XLS files to PDF programmatically? .NET developers can easily load & convert XLS to PDF in just a few lines of code.
