...
url: /hi/cpp/merger/merge-jpg-to-md/ 
description: Aspose एक्सेल। C++ Aspose.Cells. जेपीजी को एमडी सेवफॉर्मेट में मर्ज करें। C++ जेपीजी को एमडी प्रारूप में संयोजित करें। C++ में JPG को MD में मर्ज करें। JPG मर्ज।
...
{{% blocks/products/pf/agp/content h2="C++ में JPG को MD में मर्ज करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि Aspose.Cells for C++ में जेपीजी को एमडी में कैसे मर्ज किया जाए।
...
{{% cells-merger title="C++ में जेपीजी को एमडी में मर्ज करने के लिए नमूना कोड" InputFormat="jpg" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="C++ के माध्यम से जेपीजी को एमडी में कैसे मर्ज करें" %}}

{{% blocks/products/pf/agp/text %}}

 प्रोग्रामेटिक रूप से JPG को MD में मर्ज करने की आवश्यकता है? एक बुनियादी दस्तावेज़ जिसका विलय और संयोजन हो रहा है[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) एपीआई को कोड की कुछ पंक्तियों के साथ किया जा सकता है।
...
{{% blocks/products/pf/agp/content h2="C++ लाइब्रेरी जेपीजी को एमडी में मर्ज करने के लिए" %}}
