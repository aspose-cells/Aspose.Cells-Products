...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLTM ke format simpan MHT. Java Gabungkan XLTM ke format MHT. Gabung XLTM menjadi MHT di Java. XLTM Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLTM menjadi MHT di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLTM menjadi MHT di Java" InputFormat="xltm" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLTM menjadi MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan XLTM ke MHT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
