---
title: دمج TABDELIMITED إلى NUMBERS - دمج TABDELIMITED إلى NUMBERS في C#
url: /ar/net/merger/merge-tabdelimited-to-numbers/ 
description: Aspose إكسل. C# Aspose.Cells. Free Online Merge TABDELIMITED to NUMBERS saveformat. C# دمج TABDELIMITED إلى تنسيق NUMBERS. دمج TABDELIMITED إلى NUMBERS في C#. TABDELIMITED Merge.
...
{{% blocks/products/pf/agp/content h2="دمج TABDELIMITED إلى NUMBERS في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج TABDELIMITED إلى NUMBERS في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج TABDELIMITED إلى NUMBERS. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف NUMBERS. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج TABDELIMITED إلى NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني على الإنترنت لدمج TABDELIMITED إلى NUMBERS في C#" InputFormat="tsv" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج TABDELIMITED إلى NUMBERS عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج TABDELIMITED إلى NUMBERS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج TABDELIMITED إلى NUMBERS" %}}
