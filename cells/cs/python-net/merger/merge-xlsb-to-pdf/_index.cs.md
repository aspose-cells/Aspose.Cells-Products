...
url: /cs/python-net/merger/merge-xlsb-to-pdf/ 
...
Následující příklad ukazuje, jak sloučit XLSB až PDF v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit XLSB až PDF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
