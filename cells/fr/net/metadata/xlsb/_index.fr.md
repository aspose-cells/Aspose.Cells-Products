...
weight: 7890
description: Code source C# pour modifier ou afficher les métadonnées au format XLSB sur les plateformes .NET Framework, .NET Core, Mono ou Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Extraire XLSB Métadonnées via .NET" h2="Créez vos propres applications .NET pour ajouter, modifier, supprimer ou extraire des métadonnées des fichiers XLSB à l\'aide d\'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
Afin d'extraire les métadonnées XLSB, nous utiliserons
 ...
 API qui est une métadonnée de document API riche en fonctionnalités, puissante et facile à utiliser pour la plate-forme C#. Ouvrir
...
+ Chargez XLSB avec une instance de Workbook
+ Obtenez la collection BuiltInDocumentProperties de l'objet Workbook
