...
weight: 1220
description: C# källkod för att kombinera XLTX dokument på .NET Framework, .NET Core, Mono eller Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman XLTX-format i C#" h2="Inbyggd och högpresterande XLTX dokumentsammanslagning med server-side Aspose.Cells for .NET API:er, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
+ Ladda alla XLTX-filer med fullständig sökväg.
+ Gör ett dokument som basfil
+ Anropa den relevanta metoden för att sammanfoga och sammanfoga filer en efter en.
+ Anropa metoden Save() och skicka filnamnet (fullständig sökväg) och formatet (XLTX) som en parameter.
+ Nu kan du öppna och använda filen XLTX i Microsoft Office, Adobe PDF eller något annat kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="Slå samman XLTX filer - C#" offSpacer="" %}}
