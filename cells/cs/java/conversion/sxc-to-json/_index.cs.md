...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na JSON pomocí Java" %}}

 K vykreslení SXC do JSON použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na JSON prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SXC na JSON pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí třídy Workbook1. Vytvořte rozsah dat k exportu pomocí metody Cells.createRange1. Volání metody JsonUtility.exportRangeToJson s odkazy na Range & ExportRangeToJsonOptions1. Zápis dat String JSON do souboru pomocí metody BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu SXC na JSON Java" offSpacer="" %}}
