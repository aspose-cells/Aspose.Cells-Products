...
description: Aspose Excel. Chuyển EXCEL sang TXT nhanh chóng và dễ dàng với Aspose.Cells. C++ EXCEL sang TXT. C++ Lưu EXCEL thành TXT. Lưu EXCEL thành TXT sử dụng C++.
keywords: [Aspose Excel., C++ Aspose.Cells., Convert EXCEL to TXT in C++., Save EXCEL to TXT using C++., C++ EXCEL to TXT saveformat., EXCEL to TXT Converter., C++ Save EXCEL as TXT]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển EXCEL thành TXT trong C++" h2="Chuyển đổi EXCEL sang TXT hiệu suất cao bằng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi EXCEL thành TXT Sử dụng C++" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu EXCEL vào TXT trong C++" %}}

Ví dụ sau đây minh họa cách chuyển đổi EXCEL thành TXT trong C++.
...
{{% cells-convert title="Code mẫu chuyển EXCEL thành TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="txt" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi EXCEL sang TXT qua C++" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển file EXCEL sang TXT theo chương trình? Các nhà phát triển C++ có thể dễ dàng chuyển đổi EXCEL thành TXT chỉ bằng vài dòng mã.
...
1.  Chuyển đổi EXCEL thành TXT bằng cách gọi phương thức Save().
1.  Nhận kết quả chuyển đổi EXCEL thành TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Thư viện C++ chuyển EXCEL thành TXT" %}}
