---
title: C++ HTM เป็น DIF - แปลง HTM เป็น DIF ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง HTM เป็น DIF saveformat รูปแบบ C++ HTM เป็น DIF บันทึก HTM ไปที่ DIF C++
...
{{% blocks/products/pf/agp/content h2="บันทึก HTM เป็น DIF ใน C++ ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีแปลง HTM เป็น DIF ใน C++
...
1.  แปลง HTM เป็น DIF โดยเรียกเมธอด Save()
