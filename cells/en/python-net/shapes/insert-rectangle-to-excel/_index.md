...
{{% blocks/products/pf/agp/content h2="How to Insert Rectangle into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Rectangle to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_rectangle/#int-int-int-int-int-int) to insert a Rectangle in the selected worksheet.
