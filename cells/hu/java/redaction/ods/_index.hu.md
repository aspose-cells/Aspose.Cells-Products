---
title: "Szöveg keresése és cseréje az ODS-dokumentumban a következőn keresztül: Java "
weight: 9210
url: /hu/java/redaction/ods/ 
description: Java mintakód az ODS-fájl érzékeny információinak törléséhez a Java Runtime Environment for JSP/JSF Applications and Desktop Applications webhelyen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS-formátumok szerkesztése itt: Java" h2="A natív és nagy teljesítményű ODS érzékeny szerkesztési információkat dokumentál szerveroldali Aspose.Cells for Java API-k segítségével, bármilyen szoftver, például Microsoft vagy Adobe PDF használata nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Az ODS-fájl szerkesztése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az ODS-fájlok törléséhez itt: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ODS-fájlok szerkesztése – Java" offSpacer="" %}}
