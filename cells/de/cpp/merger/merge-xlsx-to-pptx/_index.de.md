---
title: XLSX mit PPTX zusammenführen - XLSX mit PPTX in C++ kombinieren
url: /de/cpp/merger/merge-xlsx-to-pptx/ 
description: Aspose Excel. C++ Aspose.Cells. XLSX mit PPTX Saveformat zusammenführen. C++ Kombinieren Sie das Format XLSX mit dem Format PPTX. XLSX zu PPTX in C++ zusammenführen. XLSX Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="XLSX mit PPTX in C++ zusammenführen" %}}

Das folgende Beispiel zeigt, wie XLSX mit PPTX in Aspose.Cells for C++ zusammengeführt wird.
...
{{% cells-merger title="Beispielcode zum Zusammenführen von XLSX mit PPTX in C++" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie XLSX über C++ mit PPTX zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie XLSX programmgesteuert mit PPTX zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs können mit nur wenigen Codezeilen erstellt werden.
