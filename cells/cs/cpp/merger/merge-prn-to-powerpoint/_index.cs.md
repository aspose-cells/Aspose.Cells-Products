---
title: Sloučit PRN do POWERPOINT přes C++
url: /cs/cpp/merger/merge-prn-to-powerpoint/ 
description: Sloučit PRN do POWERPOINT Online zdarma. Bezplatné online spojení PRN do POWERPOINT. Sloučit PRN do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit PRN do POWERPOINT v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení PRN do POWERPOINT online" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
