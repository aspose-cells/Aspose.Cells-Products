...
El siguiente ejemplo muestra cómo fusionar SPREADSHEETML a FODS en Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 ¿Necesita fusionar SPREADSHEETML con FODS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Las API se pueden hacer con solo unas pocas líneas de código.
