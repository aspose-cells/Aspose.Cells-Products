...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке/созданию файла блок-схемы в Excel via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) вставить/создать блок-схему на выбранном листе
...
В приведенном ниже примере кода показано, как вставить «Мультидокумент». Дополнительные типы см. в разделе «Обзор типов фигур стрелок блока» ниже.

{{% blocks/products/pf/agp/code-block title="Вставить/создать блок-схему — Java" offSpacer="" %}}
