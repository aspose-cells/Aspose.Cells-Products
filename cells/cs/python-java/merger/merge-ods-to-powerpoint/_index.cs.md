---
title:  Sloučit ODS do POWERPOINT přes Python
url: /cs/python-java/merger/merge-ods-to-powerpoint/ 
description: Sloučit ODS do POWERPOINT Online zdarma. Online zdarma ODS na sloučení POWERPOINT. Sloučit ODS do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit ODS do POWERPOINT v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení ODS do POWERPOINT online" InputFormat="ods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
