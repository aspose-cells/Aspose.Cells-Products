...
description: Aspose Exceller. Convertissez FODS en XLSM rapidement et facilement avec Aspose.Cells. Python FODS en XLSM. Python Enregistrez FODS en XLSM. Enregistrez FODS sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le FODS au XLSM au Python" %}}

L'exemple suivant montre comment convertir FODS en XLSM dans Python.
