...
description: Aspose Unggul. Ubah ODS menjadi OTS dengan cepat dan mudah dengan Aspose.Cells. Python ODS menjadi OTS. Python Simpan ODS ke OTS. Simpan ODS sebagai OTS menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah ODS menjadi OTS Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke OTS di Python" %}}

Contoh berikut menunjukkan cara mengonversi ODS ke OTS di Python.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi ODS ke OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="ots" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengkonversi ODS ke OTS" %}}
