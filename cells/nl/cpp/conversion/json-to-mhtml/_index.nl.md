---
title: Converteer JSON naar MHTML via C++ applicatie 
url: /nl/cpp/conversion/json-to-mhtml/ 
description: Voorbeeld C++-conversiecode voor JSON-document naar MHTML-indeling. Programmeurs kunnen deze broncode gebruiken voor batch-conversie van JSON naar MHTML binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer JSON naar MHTML via C++" h2="Krachtige JSON-naar-MHTML-conversie met behulp van de C++-bibliotheek zonder de noodzaak van Microsoft Excel, OpenOffice of Adobe Acrobat-installatie." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen JSON-bestanden eenvoudig in slechts een paar regels code naar MHTML converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad het JSON-bestand met Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (MHTML) bestandsextensie.1. MHTML-bestand wordt opgeslagen op het opgegeven pad.1. Open het MHTML-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="JSON naar MHTML C++ Conversiebroncode" offSpacer="" %}}
