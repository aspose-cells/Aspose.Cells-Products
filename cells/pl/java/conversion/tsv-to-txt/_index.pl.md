---
title: Konwertuj TSV na TXT przez Java 
weight: 2320
url: /pl/java/conversion/tsv-to-txt/ 
description: Przykładowy kod konwersji Java dla formatu TSV do pliku TXT. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do formatu TXT w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj TSV na TXT przez Java" h2="Konwersja TSV do TXT Java w celu konwersji jednej lub wielu stron do formatu TXT przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować TSV na TXT za pomocą Java" %}}

 Aby wyrenderować TSV do TXT, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TSV na TXT za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik TSV na TXT w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TSV z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem TXT i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku TXT
...
{{% blocks/products/pf/agp/code-block title="TSV do TXT Java Kod źródłowy konwersji" offSpacer="" %}}
