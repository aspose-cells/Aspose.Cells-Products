---
title: C# JPG 至 HTML - JPG 至 HTML 转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 JPG 转换为 HTML 格式，从而能够使用 Aspose.Cells 库将 JPG 数据无缝保存为 HTML 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 JPG 转换为 HTML 格式（C#）。" h2="高速 C# 库，用于将 JPG 转换为 HTML 格式。这是一个专业的软件解决方案，可在 .NET 框架、.NET 核心或 Mono 平台上导入和导出 JPG、HTML 和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPG" >}}
...
{{% blocks/products/pf/agp/content h2="将 JPG 保存到 HTML 和 C#" %}}
...
{{% cells-convert title="将 JPG 转换为 HTML 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="html" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 JPG 转换为 HTML" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 JPG 文件转换为 HTML 吗？.NET 开发人员只需几行代码即可轻松加载并将 JPG 转换为 HTML。
...
1. 调用 Workbook.Save 方法将 JPG 转换为 HTML。
1. 获取JPG到HTML的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 库用于将 JPG 转换为 HTML" %}}
