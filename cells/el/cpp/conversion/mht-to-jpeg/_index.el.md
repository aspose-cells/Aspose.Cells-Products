...
description: Aspose Excel. Μετατρέψτε το MHT σε JPEG γρήγορα και εύκολα με το Aspose.Cells. C++ MHT σε JPEG. C++ Αποθήκευση MHT σε JPEG. Αποθηκεύστε το MHT ως 0816173.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το MHT στο JPEG στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή MHT σε JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="jpg" IsLandingPage="true" language="cpp" %}}
