...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в Excel, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните значение FODS в Excel в файле C#." %}}

Следующий пример демонстрирует, как преобразовать значение FODS в формат EXCEL в файле C#.
...
1.  Преобразуйте файл FODS в формат EXCEL, вызвав метод Workbook.Save.
1.  Получите результат конвертации FODS в EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования файла FODS в Excel." %}}
