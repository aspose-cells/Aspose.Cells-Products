---
title:  Remover XLS Anotação via .NET
weight: 9270
description: C# código-fonte para adicionar e excluir anotações de formato XLS em .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
