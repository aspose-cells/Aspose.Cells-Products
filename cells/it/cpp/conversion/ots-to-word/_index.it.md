...
Hai bisogno di convertire i file OTS in WORD tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire OTS in WORD in poche righe di codice.
...
1.  Convertire OTS in WORD chiamando il metodo Save().
