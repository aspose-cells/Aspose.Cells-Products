---
title: XLTM'i SQL ile birleştir - XLTM'i C#'de SQL ile birleştir
url: /tr/net/merger/merge-xltm-to-sql/ 
description: Aspose Excel'de. C# Aspose.Cells. XLTM'i SQL kaydetme biçimiyle birleştirin. C# XLTM'i SQL biçimiyle birleştirin. XLTM'i C#'deki SQL ile birleştirin. XLTM Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i C#\'deki SQL ile birleştir" %}}

Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'deki SQL ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

XLTM'i SQL ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından bunu SQL dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. XLTM'i SQL ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="XLTM\'i C#\'de SQL ile Birleştirmek için Örnek Kod" InputFormat="xltm" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="XLTM\'i C# aracılığıyla SQL ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLTM'i programlı olarak SQL ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kütüphanesini SQL ile birleştirmek için XLTM kütüphanesi" %}}
