...
Hai bisogno di convertire i file PRN in ODS tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire i file PRN in ODS in poche righe di codice.
...
1.  Convertire PRN in ODS chiamando il metodo Save().
