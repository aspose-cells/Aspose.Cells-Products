---
title:  Dodaj lub usuń ODS Adnotacja via Java
weight: 8840
description: Java przykładowy kod do usuwania adnotacji w formacie ODS w środowisku wykonawczym Java dla aplikacji JSP/JSF i aplikacji komputerowych.
...
{{% blocks/products/pf/agp/content h2="Jak dodać adnotację do pliku ODS za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby dodać lub usunąć adnotację z numeru ODS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń adnotacje z numerów ODS–Java" offSpacer="" %}}
