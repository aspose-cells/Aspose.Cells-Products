---
title: C# FODS 轉 MD - FODS 轉 MD 轉換器
description: Aspose Excel。此綜合解決方案為 C# 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 MD 格式，從而能夠使用 Aspose.Cells 庫將 FODS 資料無縫保存為 MD 格式，所有這些都透過高效且可自訂程式碼。
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 MD，位址為 C#" %}}

以下範例示範如何將 FODS 轉換為 C# 中的 MD。
...
{{% cells-convert title="將 FODS 轉換為 MD 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 MD" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 FODS 檔案轉換為 MD 格式嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入 FODS 檔案並將其轉換為 MD 格式。
...
1. 使用工作簿實例載入 FODS 檔案。
1. 呼叫 Workbook.Save 方法將 FODS 轉換為 MD。
1. 將 FODS 轉換為 MD。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="使用 C# 庫將 FODS 轉換為 MD" %}}
