---
title: Převaděč PHP XLAM do SPREADSHEETML - XLAM do SPREADSHEETML
description: Aspose Excel. Převeďte XLAM na SPREADSHEETML rychle a snadno pomocí Aspose.Cells. PHP XLAM na SPREADSHEETML. PHP Uložit XLAM do SPREADSHEETML. Uložte XLAM jako SPREADSHEETML pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést XLAM na SPREADSHEETML přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XLAM soubory do SPREADSHEETML programově? Vývojáři PHP mohou snadno načíst a převést XLAM do SPREADSHEETML v několika řádcích kódu.
...
1.  Převeďte XLAM na SPREADSHEETML voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na SPREADSHEETML" %}}
