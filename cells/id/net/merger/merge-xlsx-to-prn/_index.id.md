---
title: Gabungkan XLSX ke PRN - Gabungkan XLSX ke PRN di C#
url: /id/net/merger/merge-xlsx-to-prn/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSX ke format simpan PRN. C# Gabungkan XLSX ke format PRN. Gabungkan XLSX ke PRN di C#. XLSX Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSX ke PRN di C#" %}}

Contoh berikut menunjukkan cara menggabungkan XLSX ke PRN di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSX ke PRN. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file PRN. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSX ke PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLSX ke PRN di C#" InputFormat="xlsx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSX ke PRN lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSX ke PRN secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan XLSX ke PRN" %}}
