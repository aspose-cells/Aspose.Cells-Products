...
url: /nl/python-java/merger/merge-prn-to-powerpoint/ 
...
Het volgende voorbeeld laat zien hoe u PRN kunt samenvoegen met POWERPOINT in Aspose.Cells for Python via Java.
...
Wilt u PRN programmatisch samenvoegen met POWERPOINT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
