---
title: PHP HTM a EXCEL - Convertidor HTM a EXCEL
description: Aspose Excel. Convierta HTM a EXCEL rápida y fácilmente con Aspose.Cells. PHP HTM a EXCEL. PHP Guarde HTM en EXCEL. Guarde HTM como EXCEL usando PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM a EXCEL en PHP" h2="Biblioteca PHP de alta velocidad para convertir HTM a EXCEL. Esta es una solución de software profesional para importar y exportar HTM, EXCEL y muchos otros formatos usando PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTM a EXCEL mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTM a EXCEL mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente HTM a EXCEL en tan solo unas pocas líneas de código.
...
1.  Convierta HTM a EXCEL llamando al método guardar del libro de trabajo.
