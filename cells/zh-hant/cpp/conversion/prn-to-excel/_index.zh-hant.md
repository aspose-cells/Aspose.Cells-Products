...
{{% cells-convert title="將 PRN 轉換為 EXCEL 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlsx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C++ 將 PRN 轉換為 EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 PRN 檔案轉換為 EXCEL？ C++ 開發人員只需幾行程式碼即可輕鬆將PRN轉換為EXCEL。
