...
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman XLT-format i C#" h2="Inbyggd och högpresterande XLT-dokumentsammanslagning med Aspose.Cells for .NET-API:er på serversidan, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
+ Ladda alla XLT-filer med fullständig sökväg.
+ Gör ett dokument som basfil
+ Anropa den relevanta metoden för att sammanfoga och sammanfoga filer en efter en.
+ Anropa metoden Save() och skicka filnamnet (fullständig sökväg) och formatet (XLT) som en parameter.
+ Nu kan du öppna och använda XLT-filen i Microsoft Office, Adobe PDF eller något annat kompatibelt program.
