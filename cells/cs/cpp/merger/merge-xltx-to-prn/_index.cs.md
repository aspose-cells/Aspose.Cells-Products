...
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do formátu uložení PRN. C++ Spojte XLTX do formátu PRN. Sloučit XLTX na PRN v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX s PRN v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX do PRN v C++" InputFormat="xltx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
