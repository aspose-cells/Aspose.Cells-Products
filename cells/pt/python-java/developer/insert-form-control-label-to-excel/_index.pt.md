---
title:  Insira Label (controle de formulário) no Excel usando Python via java
weight: 80
description: Python via código fonte java para inserir Label (controle de formulário) no Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insira Label (controle de formulário) no Excel usando Python via java" h2="Insira objetos usando APIs do lado do servidor sem qualquer software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir rótulo (controle de formulário) em arquivo Excel usando Python via java" %}}

 Para inserir Label (controle de formulário) no arquivo Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir Label (controle de formulário) em arquivo Excel usando Python via java" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Use o shapecollection[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLabel(int,%20int,%20int,%20int,%20int,%20int)) para inserir um rótulo (controle de formulário) na planilha selecionada.
...
{{% blocks/products/pf/agp/code-block title="Inserir rótulo (controle de formulário) - Python via java" offSpacer="" %}}
