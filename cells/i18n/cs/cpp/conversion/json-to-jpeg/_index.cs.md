...
{{% blocks/products/pf/agp/content h2="Jak převést JSON na JPEG pomocí C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Postup převodu JSON na JPEG prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor JSON na JPEG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor JSON pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavte možnosti (JPEG).1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor JPEG v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu JSON na JPEG C++" offSpacer="" %}}
