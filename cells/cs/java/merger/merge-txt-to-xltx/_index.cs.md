---
title:  Sloučit TXT až XLTX via Java
url: /cs/java/merger/merge-txt-to-xltx/ 
description: Sloučit TXT až XLTX online zdarma. Online zdarma TXT až XLTX Fúze. Sloučit TXT do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit TXT až XLTX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až XLTX online" InputFormat="txt" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
