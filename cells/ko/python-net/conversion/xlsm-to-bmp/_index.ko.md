...
description: Aspose 엑셀. Aspose.Cells을 사용하여 XLSM을 BMP로 빠르고 쉽게 변환합니다. Python XLSM을 BMP로 변환합니다. Python XLSM을 BMP로 저장합니다. XLSM을 07611134로 저장합니다. Python을 사용하여 81.
...
{{% blocks/products/pf/agp/content h2="Python에서 XLSM을 BMP로 변환" %}}
...
{{% blocks/products/pf/agp/content h2="Python에 XLSM을 BMP로 저장" %}}

다음 예에서는 Python via NET에서 XLSM을 BMP로 변환하는 방법을 보여줍니다.
...
{{% cells-convert title="XLSM을 BMP로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="bmp" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python 라이브러리를 사용하여 XLSM을 BMP로 변환" %}}
