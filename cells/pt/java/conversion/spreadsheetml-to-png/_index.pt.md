---
title: Java SPREADSHEETML para PNG - Conversor de PLANILHA Online para PNG
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Online Grátis Java Converta SPREADSHEETML para PNG saveformat. Java SPREADSHEETML para o formato PNG. Salve SPREADSHEETML para PNG Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter SPREADSHEETML para PNG em Java" h2="Biblioteca Java de alta velocidade para converter SPREADSHEETML em PNG. Esta é uma solução de software profissional para importar e exportar SPREADSHEETML, PNG e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salve SPREADSHEETML em PNG em Java online gratuitamente" %}}

O exemplo a seguir demonstra como converter SPREADSHEETML para PNG em Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter SPREADSHEETML para PNG. Carregue seu arquivo SPREADSHEETML e simplesmente salve-o como arquivo PNG. Tanto para leitura SPREADSHEETML quanto para escrita PNG, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída PNG serão idênticos ao documento SPREADSHEETML original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter SPREADSHEETML para PNG online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="png" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como converter SPREADSHEETML para PNG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SPREADSHEETML para PNG programaticamente? Java desenvolvedores podem facilmente converter SPREADSHEETML para PNG em apenas algumas linhas de código.
...
1.  Converta SPREADSHEETML para PNG chamando o método Workbook.save.
1.  Obtenha o resultado da conversão de SPREADSHEETML para PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteca para converter SPREADSHEETML para PNG" %}}
{{% blocks/products/pf/agp/text %}}
