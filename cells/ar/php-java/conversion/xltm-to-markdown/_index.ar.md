---
title: PHP XLTM إلى MARKDOWN - XLTM إلى MARKDOWN محول
description: Aspose اكسل. قم بتحويل XLTM إلى MARKDOWN بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى MARKDOWN. PHP احفظ XLTM إلى MARKDOWN. احفظ XLTM كـ MARKDOWN باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى MARKDOWN عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى MARKDOWN برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى MARKDOWN بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى MARKDOWN عن طريق استدعاء طريقة حفظ المصنف.
