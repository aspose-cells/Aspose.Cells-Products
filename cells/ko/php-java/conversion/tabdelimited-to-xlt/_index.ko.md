...
description: Aspose Excel. 이 포괄적인 솔루션은 PHP 개발자에게 탭으로 구분된 데이터를 XLT 형식으로 변환하는 완벽하게 통합된 방식을 제공하며, 효율적이고 사용자 정의 가능한 PHP 코드를 통해 Aspose.Cells 라이브러리를 사용하여 탭으로 구분된 데이터를 XLT 형식으로 원활하게 저장할 수 있도록 지원합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="TABDELIMITED를 PHP에서 XLT로 변환" h2="탭으로 구분된 데이터를 XLT 형식으로 고속 변환하는 PHP 라이브러리입니다. PHP를 사용하여 탭으로 구분된 데이터, XLT 형식 및 기타 여러 형식을 가져오고 내보낼 수 있는 전문 소프트웨어 솔루션입니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="PHP를 사용하여 TABDELIMITED를 XLT로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

탭으로 구분된 파일을 XLT 형식으로 프로그램적으로 변환해야 하시나요? PHP 개발자는 단 몇 줄의 코드로 탭으로 구분된 파일을 쉽게 불러와 XLT 형식으로 변환할 수 있습니다.
...
1.  워크북의 save 메서드를 호출하여 TABDELIMITED 형식을 XLT 형식으로 변환합니다.
1.  TABDELIMITED를 XLT로 변환한 결과를 가져옵니다.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="탭으로 구분된 데이터를 XLT로 변환하는 PHP 라이브러리" %}}
