---
title:  แทรก ComboBox (การควบคุมฟอร์ม) ลงใน Excel ผ่าน Python
weight: 20
description: ซอร์สโค้ด Python เพื่อแทรก ComboBox (Form control) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรก ComboBox (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก ComboBox (Form control) ลงในไฟล์ Excel ผ่าน Python" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรก ComboBox (การควบคุมฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรก ComboBox(ตัวควบคุมฟอร์ม) - Python" offSpacer="" %}}
