---
title: Java XLSB à XLSB - Convertisseur en ligne XLSB à XLSB
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XLSB en format de sauvegarde XLSB. Format Java XLSB à XLSB. Enregistrez XLSB à XLSB Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à XLSB dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en XLSB en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en XLSB par programmation ? Les développeurs de Java peuvent facilement convertir XLSB en XLSB en seulement quelques lignes de code.
