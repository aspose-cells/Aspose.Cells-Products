---
title: Slå samman XLTX till EXCEL - Kombinera XLTX till EXCEL i C#
url: /sv/net/merger/merge-xltx-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge XLTX till EXCEL sparaformat. C# Kombinera XLTX till EXCEL-format. Slå samman XLTX till EXCEL i C#. XLTX Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman XLTX till EXCEL i C# Online gratis" %}}

Följande exempel visar hur man slår samman XLTX till EXCEL i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman XLTX till EXCEL. Ladda upp dina filer, anrop Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i EXCEL-fil. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman XLTX till EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman XLTX till EXCEL i C#" InputFormat="xltx" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår ihop XLTX till EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLTX till EXCEL programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XLTX till EXCEL" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/merger/merge-xltx-to-xlsx/" name="Slå samman XLTX till XLSX" description="OOXML Excel-fil" >}}
