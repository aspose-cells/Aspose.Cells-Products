---
title: PHP EXCEL в XLAM - Конвертер EXCEL в XLAM
description: Aspose Эксель. Преобразуйте EXCEL в XLAM быстро и легко с помощью Aspose.Cells. PHP EXCEL в XLAM. PHP Сохраните EXCEL в XLAM. Сохраните EXCEL как XLAM с помощью PHP.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать EXCEL в XLAM с помощью PHP" %}}

{{% blocks/products/pf/agp/text %}}

Вам нужно программно конвертировать файлы EXCEL в XLAM? Разработчики PHP могут легко загрузить и преобразовать EXCEL в XLAM всего за несколько строк кода.
...
1.  Преобразуйте EXCEL в XLAM, вызвав метод сохранения книги.
1.  Получите результат преобразования EXCEL в XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека PHP для преобразования EXCEL в XLAM" %}}
