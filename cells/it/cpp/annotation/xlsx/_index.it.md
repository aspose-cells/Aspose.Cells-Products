---
title:  Aggiungi o rimuovi annotazione XLSX tramite C++
weight: 5260
description: Codice di esempio C++ per aggiungere o eliminare annotazioni in formato XLSX su C++ Runtime Environment per Windows 32 bit, Windows 64 bit e Linux 64 bit.
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per aggiungere commenti allo XLSX tramite C++" %}}
