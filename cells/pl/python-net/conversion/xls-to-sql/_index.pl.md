...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLS na SQL za pomocą Aspose.Cells. Python XLS na SQL. Python Zapisz XLS w SQL. Zapisz XLS jako SQL, używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS w SQL w Python" %}}

Poniższy przykład ilustruje sposób konwersji XLS na SQL w Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji XLS na SQL" %}}
