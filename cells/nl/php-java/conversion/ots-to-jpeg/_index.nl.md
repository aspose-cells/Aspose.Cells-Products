...
description: Aspose Excel. Deze complete oplossing biedt PHP-ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van OTS-bestanden naar het JPEG-formaat. Hierdoor kunnen OTS-gegevens naadloos worden opgeslagen in het JPEG-formaat met behulp van de Aspose.Cells-bibliotheek, en dat alles via efficiënte en aanpasbare PHP-code.
...
{{% blocks/products/pf/agp/content h2="Sla OTS op als JPEG in PHP" %}}

Het volgende voorbeeld laat zien hoe je OTS naar JPEG converteert in PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar JPEG via PHP?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je OTS-bestanden programmatisch converteren naar JPEG? PHP-ontwikkelaars kunnen OTS-bestanden eenvoudig laden en converteren naar JPEG met slechts een paar regels code.
...
1.  Converteer OTS naar JPEG door de save-methode van Workbook aan te roepen.
