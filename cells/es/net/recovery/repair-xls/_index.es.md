---
title: Reparar archivo xls via .NET
url: /es/net/recovery/repair-xls/ 
description: Repare un archivo xls dañado usando C#. Herramienta de recuperación para reparar un archivo xls dañado dentro de la aplicación .NET.
---
...
{{% cells-recovery title="Aplicación gratuita para reparar el archivo XLS usando .NET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="net" %}}    
