...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan MHTML ke format simpan MHT. Java Gabungkan MHTML ke format MHT. Gabung MHTML menjadi MHT di Java. MHTML Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan MHTML menjadi MHT di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan MHTML menjadi MHT di Java" InputFormat="mhtml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan MHTML menjadi MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan MHTML ke MHT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
