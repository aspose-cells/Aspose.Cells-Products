...
Нужно программно конвертировать файлы FODS в ODS? Разработчики C++ могут легко преобразовать FODS в ODS всего за несколько строк кода.
