...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Java plně integrovaný přístup k převodu formátu HTML do formátu XLSB, což umožňuje bezproblémové ukládání dat HTML do formátu XLSB pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte HTML na XLSB v Java" h2="Vysokorychlostní knihovna Java pro převod HTML na XLSB. Toto je profesionální softwarové řešení pro import a export HTML, XLSB a mnoha dalších formátů s použitím Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte HTML na XLSB v Java" %}}

Následující příklad ukazuje, jak převést číslo HTML na XLSB v kódu Java.
...
Potřebujete programově převést soubory HTML na XLSB? Vývojáři Java mohou snadno převést HTML na XLSB pomocí několika řádků kódu.
