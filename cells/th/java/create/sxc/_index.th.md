...
description: Aspose เอ็กเซล. Java สร้างไฟล์ SXC อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ SXC โดยใช้ Java สร้าง SXC ใน Java Java SXC Creater
...
1. บันทึกสมุดงานเป็นรูปแบบ SXC โดยใช้เมธอด save()
