...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in XLTX in Java" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar XLTX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLTM om naar XLTX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLTM programmatisch converteren naar XLTX? Ontwikkelaars van Java kunnen bestanden met de extensie XLTM eenvoudig converteren naar XLTX met slechts een paar regels code.
