---
title: 水印XLSX文件via .NET
weight: 8270
description: C# 原始程式碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上向 XLSX 檔案新增或刪除浮水印。
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 加水印到 XLSX 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="加入浮水印到XLSX - C#" offSpacer="" %}}
