...
{{< blocks/products/pf/i18n/upper-banner h1="合併 Java 中的 ODS 格式" h2="使用服務器端 Java API 的本機 ODS 文檔合併。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中合併 ODS 文件的步驟" %}}
...
+ 使用 Workbook 類的實例加載第一個 ODS 文件。
+ 使用 Workbook 類的實例加載第二個 ODS 文檔。
+ 使用 combine() 方法合併文件。
+ 將合併的 ODS 文件保存在指定路徑
