---
title: Hoe u een gebogen pijlvorm in Excel tekent of invoegt met behulp van Python via Java
weight: 10
description: Teken of voeg een gebogen pijlvorm in met Aspose.Cells' Python via Java API zonder software zoals Microsoft of Open Office, Adobe PDF, enz.
...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg de gebogen pijlvorm in Excel in met behulp van Python via Java" h2="Voeg een gebogen pijlvorm in met behulp van Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een gebogen pijlvorm in een Excel-bestand kunt invoegen met behulp van Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het invoegen van een gebogen pijlvorm in een Excel-bestand met behulp van Python via Java" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de vormcollecties[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) om een gebogen pijlvorm in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Inzet gebogen pijlvorm - Python via Java" offSpacer="" %}}
