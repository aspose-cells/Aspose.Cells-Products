...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Agregar Anotación en ODS vía C++" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Cargue el archivo de Excel ODS utilizando el objeto de clase IWorkbook.
...
{{% blocks/products/pf/agp/code-block title="Agregar Comentarios en ODS - C++" offSpacer="" %}}
