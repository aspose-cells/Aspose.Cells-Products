...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera XLS-fil till TIFF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLS-fil med Factory::CreateIWorkbook.1. Välj det första kalkylbladet.1. Ställ in (TIFF) alternativ.1. Iterera genom varje sida av arket och rendera.1. Öppna TIFF-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="XLS till TIFF C++ omvandlingskällkod" offSpacer="" %}}
