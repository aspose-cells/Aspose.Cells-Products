---
title: Converter NUMBERS para XLSX via Python
url: /pt/python-java/conversion/numbers-to-xlsx/
description: Código de amostra para conversão de números para xlsx Python. Use o código de exemplo API para arquivos de números de lote para conversão xlsx no aplicativo Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter NUMBERS para XLSX via Python" h2="Exporte planilhas do Excel® para o formato XLSX usando APIs Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter NUMBERS para XLSX usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter NUMBERS em XLSX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter NUMBERS arquivos para XLSX em apenas algumas linhas de código.
