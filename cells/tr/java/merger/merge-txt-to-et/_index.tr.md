---
title: TXT'i ET ile birleştir - TXT'i Java'de ET ile birleştir
url: /tr/java/merger/merge-txt-to-et/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i ET kaydetme biçimiyle birleştirin. Java TXT'i ET formatıyla birleştirin. TXT'i Java'deki ET ile birleştirin. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'deki ET ile birleştir" %}}

Aşağıdaki örnek, TXT'in Aspose.Cells for Java'deki ET ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT'i ET ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından ET dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT'i ET ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT\'i Java\'de ET ile Birleştirmek için Örnek Kod" InputFormat="txt" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT\'i ET via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TXT'i programlı olarak ET ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesi, TXT\'i ET ile birleştirecek" %}}
