...
以下示例演示如何将 TXT 合并到 Aspose.Cells for Python via .NET 中的 PRN。
...
需要以编程方式将 TXT 合并到 PRN 吗？基本文档合并和连接[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)只需几行代码即可完成 API。
