---
title:  تحرير أو عرض XLSB بيانات تعريف الملفات via Java
weight: 7290
description: نموذج التعليمات البرمجية Java لتحرير أو عرض بيانات التعريف بتنسيق XLSB على بيئة تشغيل Java لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{< blocks/products/pf/i18n/upper-banner h1="استخراج XLSB البيانات الوصفية via Java" h2="أنشئ تطبيقات Java الخاصة بك لإضافة البيانات التعريفية أو تحريرها أو إزالتها أو استخراجها من ملفات XLSB باستخدام واجهات برمجة التطبيقات من جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="كيفية استخراج البيانات الوصفية XLSB باستخدام Java" %}}

 من أجل الحصول على البيانات الوصفية للملف XLSB، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات استخراج البيانات الوصفية لـ XLSB via Java" %}}
...
+ احفظ معلومات البيانات الوصفية XLSB
...
{{% blocks/products/pf/agp/code-block title="استخراج البيانات الوصفية لـ XLSB - Java" offSpacer="" %}}
