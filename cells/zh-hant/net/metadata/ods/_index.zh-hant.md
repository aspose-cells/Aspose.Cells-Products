---
title: 檢視或編輯 ODS 檔案元資料 via .NET
weight: 320
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上編輯或檢視 ODS 格式元資料。
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/metadata/xlsm/" name="XLSM" description="試算表文件" >}}
