---
title: ODS दस्तावेज़ को .NET के माध्यम से अनलॉक करें 
weight: 3110
url: /hi/net/unlock/ods/ 
description: पासवर्ड से सुरक्षित ODS फ़ाइल को .NET Framework, .NET Core, Mono या Xamarin Platforms पर अनलॉक करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ODS स्प्रेडशीट को C# के माध्यम से अनलॉक करें" h2=".NET लाइब्रेरी का उपयोग करके ODS से सुरक्षा निकालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके ODS फ़ाइल को कैसे अनलॉक करें" %}}
 ...
 सुरक्षा ODS फ़ाइल को हटाने के लिए, हम उपयोग करेंगे
...
// सुरक्षित ODS फ़ाइल के साथ कार्यपुस्तिका ऑब्जेक्ट को तुरंत चालू करें
...
// परिणाम वापस ODS प्रारूप में सहेजें
