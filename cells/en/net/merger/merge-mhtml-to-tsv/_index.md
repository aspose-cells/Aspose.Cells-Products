...
description: C# source code to combine MHTML to TSV file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/code-block title="Merge MHTML to TSV Files - C#" offSpacer="" %}}
