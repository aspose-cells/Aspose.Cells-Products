...
url: /cs/python-java/merger/merge-mhtml-to-dif/ 
...
Následující příklad ukazuje, jak sloučit MHTML až DIF v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit MHTML až DIF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
