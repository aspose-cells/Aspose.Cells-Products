---
title: Python XLTX sang XLS - XLTX sang XLS Bộ chuyển đổi
description: Aspose Excel. Python Excel. Chuyển đổi XLTX sang XLS nhanh chóng và dễ dàng với Aspose.Cells. Python XLTX sang XLS. Python Lưu XLTX thành XLS. Lưu XLTX thành 076112 3481 sử dụng Thư viện Excel Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLTX thành XLS trong Python Thư viện Excel" h2="Thư viện excel Python tốc độ cao chuyển đổi XLTX sang XLS. Đây là giải pháp phần mềm chuyên nghiệp để nhập xuất XLTX, XLS và nhiều định dạng khác sử dụng Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLTX thành XLS Sử dụng Thư viện Excel Python" %}}

 Làm cách nào để chuyển đổi XLTX thành XLS? Với thư viện Aspose.Cells for Python, bạn có thể dễ dàng chuyển đổi XLTX thành XLS theo chương trình với một vài dòng mã.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, hiển thị và in tất cả các tệp Excel. Python Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó biến nó thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Lưu XLTX vào XLS trong Python Thư viện Excel" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLTX thành XLS trong thư viện excel Python.
...
{{% cells-convert title="Mã mẫu chuyển đổi XLTX thành XLS qua Python Thư viện Excel" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xls" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLTX thành XLS qua Python" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLTX thành XLS theo chương trình? Các nhà phát triển Python có thể dễ dàng tải và chuyển đổi XLTX thành XLS chỉ bằng một vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Python Thư viện Excel để chuyển đổi XLTX thành XLS" %}}
