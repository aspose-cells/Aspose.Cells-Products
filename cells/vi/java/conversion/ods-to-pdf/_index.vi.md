---
title:  Chuyển đổi ODS thành PDF Java
description: Chuyển đổi ODS thành PDF Trực tuyến Miễn phí. Bộ chuyển đổi ODS sang PDF trực tuyến miễn phí. Java ODS đến PDF. ODS đến PDF via Java.
keywords: Convert ODS, ODS Converter, ODS to PDF, ODS to Word, ODS to PPT, ODS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi ODS thành PDF via Java" h2="Chuyển đổi ODS sang PDF Java để chuyển đổi một trang hoặc nhiều trang thành PDF bằng thư viện Java tại chỗ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi ODS thành PDF trực tuyến" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="pdf" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi ODS thành PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java nhà phát triển có thể dễ dàng chuyển đổi ODS thành PDF chỉ bằng một vài dòng mã.
