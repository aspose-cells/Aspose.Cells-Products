...
weight: 10010
description: C++ codice di esempio per bloccare il file ODS utilizzando la password su C++ Runtime Environment per Windows 32 bit, Windows 64 bit e Linux 64 bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Crittografa i file ODS tramite C++" h2="Fogli di calcolo Excel protetti da password incluso il formato ODS utilizzando la libreria .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Come proteggere il file ODS utilizzando C++" %}}
 ...
 Per proteggere il file ODS, utilizzeremo
...
1.  Salvare il file ODS protetto con il metodo Save()
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per proteggere ODS" sectionDescription=" Controlla le nostre demo dal vivo per[crittografare i file ODS](https://products.aspose.app/cells/protect/ods) con i seguenti vantaggi." >}}
