...
{{% blocks/products/pf/agp/content h2="So fügen Sie mit Java eine gekrümmte Form in eine Excel-Datei ein" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Einfügen einer gekrümmten Form in die Excel-Datei via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Gebogene Form einsetzen – Java" offSpacer="" %}}
