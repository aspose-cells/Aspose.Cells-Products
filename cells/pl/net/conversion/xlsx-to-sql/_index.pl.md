...
{{% cells-convert title="Przykładowy kod do konwersji XLSX na SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na SQL przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSX na SQL? Programiści .NET mogą łatwo załadować i przekonwertować XLSX na SQL w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLSX na SQL, wywołując metodę Workbook.Save.
