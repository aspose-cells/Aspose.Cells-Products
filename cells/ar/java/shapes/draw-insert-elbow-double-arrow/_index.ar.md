---
title:  كيفية رسم أو إدراج شكل سهم مزدوج للكوع في Excel via Java
weight: 30
description: ارسم أو أدخل شكل سهم مزدوج للمرفق باستخدام Aspose.Cells' Java API بدون أي برامج مثل Microsoft أو Open Office أو Adobe PDF وما إلى ذلك.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج شكل السهم المزدوج للكوع في ملف Excel باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج شكل الكوع والسهم المزدوج في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) لإدراج شكل سهم مزدوج على شكل مرفق في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج الكوع على شكل سهم مزدوج - Java" offSpacer="" %}}
