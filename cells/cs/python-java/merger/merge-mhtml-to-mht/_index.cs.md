---
title:  Sloučit MHTML na MHT přes Python
url: /cs/python-java/merger/merge-mhtml-to-mht/ 
description: Sloučit MHTML do MHT Online zdarma. Online zdarma MHTML do MHT Fúze. Sloučit MHTML do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit MHTML do MHT v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHTML s MHT online" InputFormat="mhtml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
