...
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 CSV 转换为 FODS。 C# CSV 为 FODS。 C# 将 CSV 保存为 FODS。 将 CSV 另存为 07611134 81 使用 C#。
...
{{% cells-convert title="将 CSV 转换为 FODS 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="fods" IsLandingPage="true" %}}
...
1. 使用工作簿实例加载 CSV 文件。
1. 通过调用Workbook.Save方法将CSV转换为FODS。
1. 获取CSV到FODS的转换结果。
