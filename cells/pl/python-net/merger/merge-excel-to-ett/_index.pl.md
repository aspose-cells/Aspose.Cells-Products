...
url: /pl/python-net/merger/merge-excel-to-ett/ 
...
Poniższy przykład pokazuje, jak scalić EXCEL z ETT w Aspose.Cells for Python via .NET.
...
Chcesz programowo połączyć EXCEL z ETT? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
