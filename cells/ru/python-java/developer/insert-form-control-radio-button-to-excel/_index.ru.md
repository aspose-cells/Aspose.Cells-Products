...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить RadioButton (элемент управления формой) в выбранный рабочий лист.
