...
{{% blocks/products/pf/agp/content h2="Sla HTML op in XLSM in C++" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar XLSM in C++.
...
Moet je bestanden met de extensie HTML programmatisch converteren naar XLSM? Ontwikkelaars van C++ kunnen bestanden met de extensie HTML eenvoudig converteren naar XLSM met slechts een paar regels code.
