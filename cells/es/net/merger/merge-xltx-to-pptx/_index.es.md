---
title: Combinar XLTX a PPTX - Combinar XLTX a PPTX en C#
url: /es/net/merger/merge-xltx-to-pptx/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea XLTX a PPTX guardar formato. C# Combina el formato XLTX con el PPTX. Combinar XLTX a PPTX en C#. XLTX Combinar.
...
El siguiente ejemplo muestra cómo combinar XLTX con PPTX en Aspose.Cells for .NET.
...
{{% cells-merger title="Gratis en línea para fusionar XLTX a PPTX en C#" InputFormat="xltx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLTX a PPTX a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLTX con PPTX mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
