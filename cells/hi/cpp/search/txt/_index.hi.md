---
title:  C++ के ज़रिए TXT डॉक्यूमेंट को बिना खोले सर्च करें
weight: 5090
description: C++ उदाहरण कोड Windows 32 बिट, Windows 64 बिट और लिनक्स 64 बिट के लिए C++ रनटाइम एनवायरनमेंट पर TXT फ़ाइल में पैटर्न वाले शब्दों को खोजने के लिए।
...
{{% blocks/products/pf/agp/content h2="C++ का इस्तेमाल करके TXT फ़ाइल कैसे खोजें" %}}

 TXT फ़ाइल को खोजने के लिए, हम इसका इस्तेमाल करेंगे
...
+ वर्कबुक क्लास का इस्तेमाल करके TXT फ़ाइल लोड करें।
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="ऑनलाइन TXT लाइव डेमो खोजें" sectionDescription=" हमारे पेज पर जाकर अभी TXT डॉक्यूमेंट्स में टेक्स्ट, शब्द, फ्रेज़ खोजें[लाइव डेमोस वेबसाइट](https://products.aspose.app/cells/search)लाइव डेमो के निम्नलिखित लाभ हैं" >}}
...
.TXT एक्सटेंशन वाली फ़ाइल एक टेक्स्ट डॉक्यूमेंट दिखाती है जिसमें लाइनों के रूप में प्लेन टेक्स्ट होता है। टेक्स्ट डॉक्यूमेंट में पैराग्राफ़ को कैरिज रिटर्न से पहचाना जाता है और फ़ाइल कंटेंट को बेहतर तरीके से अरेंज करने के लिए इस्तेमाल किया जाता है। एक स्टैंडर्ड टेक्स्ट डॉक्यूमेंट को अलग-अलग ऑपरेटिंग सिस्टम पर किसी भी टेक्स्ट एडिटर या वर्ड प्रोसेसिंग एप्लीकेशन में खोला जा सकता है। ऐसी फ़ाइल में मौजूद सारा टेक्स्ट ह्यूमन-रीडेबल फ़ॉर्मेट में होता है और कैरेक्टर के सीक्वेंस से दिखाया जाता है।
