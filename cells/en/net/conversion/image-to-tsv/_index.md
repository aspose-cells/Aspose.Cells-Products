---
title: C# IMAGE to TSV - IMAGE to TSV Converter
description: Aspose Excel. C# Aspose.Cells. IMAGE to TSV in C#. C# Convert IMAGE to TSV saveformat. C# IMAGE to TSV format. Save IMAGE to TSV C#.
...
{{% blocks/products/pf/agp/content h2="Save IMAGE to TSV in C#" %}}

The following example demonstrates how to convert IMAGE to TSV in C#.
...
{{% cells-convert title="Sample Code to Convert IMAGE to TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert IMAGE to TSV via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert IMAGE files to TSV programmatically? .NET developers can easily load & convert IMAGE to TSV in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert IMAGE to TSV" %}}
