---
title: Fusionner les fichiers XLTM via Java 
weight: 8210

description: Java Exemple de code pour combiner des documents XLTM sur Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats XLTM dans Java" h2="Fusion de documents native XLTM à l\'aide d\'API Java côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner des fichiers XLTM à l\'aide de Java" %}}

 Afin de fusionner le fichier XLTM, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers XLTM dans Java" %}}
...
+ Chargez le premier fichier XLTM avec une instance de la classe Workbook.
+ Chargez le deuxième document XLTM avec une instance de la classe Workbook.
+ Fusionner des fichiers en utilisant la méthode combine().
+ enregistrer le fichier XLTM fusionné au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers XLTM - Java" offSpacer="" %}}

```cs
// Ouvrez le premier fichier XLTM.
Workbook xltmFile1 = new Workbook("chartsFileWithPath.xltm");

// Définissez le deuxième livre source.
// Ouvrez le deuxième fichier XLTM.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API peut être utilisé pour créer, modifier, convertir et restituer des formats Microsoft Excel dans différents formats. De plus, il peut être utilisé pour des graphiques complets, des rapports évolutifs et des calculs fiables dans les applications logicielles. Aspose.Cells est un API autonome et ne nécessite aucun logiciel comme Microsoft ou OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la fusion XLTM en ligne" sectionDescription="Fusionnez des documents XLTM dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/cells/merger). La démo en direct présente les avantages suivants" >}}
