---
title: Konversi XLSX ke ODS melalui C#
url: /id/net/conversion/xlsx-to-ods/
description: Contoh kode untuk konversi xlsx ke ods C#. Gunakan API kode contoh untuk file batch xlsx ke konversi ods dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi XLSX ke ODS melalui C#" h2="Ekspor spreadsheet Excel® ke format ODS di Platform .NET Framework, .NET Core, Mono atau Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi file XLSX ke ODS hanya dalam beberapa baris kode.
...
{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX ke ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ods" IsLandingPage="true" %}}
