---
title: Insert OLE object into Excel via .NET 
weight: 170
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert OLE object to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addoleobject) to insert a OLE object in the selected worksheet
