...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке Arc в файл Excel с использованием Python via .Net" %}}
...
+ Используйте метод добавления коллекции фигур, чтобы вставить дугу в выбранный лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка Arc — Python via.Net" offSpacer="" %}}
