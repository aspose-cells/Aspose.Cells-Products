---
title: C# XLSX a JPEG - XLSX a JPEG Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato JPEG, permitindo o salvamento perfeito de dados XLSX no formato JPEG usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a JPEG em C#" %}}

exemplo a seguir demonstra como converter XLSX em JPEG em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter XLSX em JPEG por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX em JPEG programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em JPEG em apenas algumas linhas de código.
...
1.  Converta XLSX para JPEG chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para JPEG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em JPEG" %}}
