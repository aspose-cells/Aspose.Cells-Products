---
title: รวม JSON ถึง PPTX - รวม JSON ถึง PPTX ใน Java
url: /th/java/merger/merge-json-to-pptx/ 
description: Aspose เอ็กเซล. Java Aspose.Cells รวม JSON เป็น PPTX บันทึกฟอร์แมต Java รวมรูปแบบ JSON ถึง PPTX รวม JSON ถึง PPTX เข้า Java JSON รวม.
...
{{% blocks/products/pf/agp/content h2="รวม JSON ถึง PPTX ใน Java" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน JSON ถึง PPTX ใน Aspose.Cells for Java
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม JSON ถึง PPTX อัปโหลดไฟล์ของคุณ เรียกวิธี Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ PPTX หากคุณพัฒนาโค้ดใน Java สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง Java ที่รวม JSON กับ PPTX
...
{{% blocks/products/pf/agp/content h2="วิธีรวม JSON ถึง PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม JSON กับ PPTX โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for Java](https://products.aspose.com/cells/java) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2="Java ห้องสมุดรวม JSON เป็น PPTX" %}}
