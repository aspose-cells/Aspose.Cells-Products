---
title: Come disegnare o inserire la forma del gomito in Excel utilizzando Python via .Net
weight: 10
description: Python via Codice sorgente .Net per inserire la forma del gomito in Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci la forma del gomito in Excel usando Python via .Net" h2="Inserisci la forma del gomito usando Aspose.Cells\' API senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire la forma del gomito nel file Excel utilizzando Python via .Net" %}}

 Per inserire la forma del gomito nel file excel, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire la forma del gomito nel file Excel utilizzando Python via .Net" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa l'aggiunta di shapecollection[metodo](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) per inserire una forma a gomito nel foglio di lavoro selezionato.
...
{{% blocks/products/pf/agp/code-block title="Inserto a gomito - Python via .Net" offSpacer="" %}}
