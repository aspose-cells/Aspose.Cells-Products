---
title: Gabungkan SXC ke IMAGE - Gabungkan SXC ke IMAGE di Java
url: /id/java/merger/merge-sxc-to-image/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan SXC ke format penyimpanan GAMBAR. Java Gabungkan SXC ke format GAMBAR. Gabungkan SXC menjadi IMAGE di Java. SXC Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan SXC ke IMAGE di Java" %}}

Contoh berikut menunjukkan cara menggabungkan SXC ke IMAGE di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan SXC ke IMAGE. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file IMAGE. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan SXC ke IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan SXC ke IMAGE di Java" InputFormat="sxc" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC menjadi GAMBAR via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SXC ke IMAGE secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk menggabungkan SXC ke IMAGE" %}}
