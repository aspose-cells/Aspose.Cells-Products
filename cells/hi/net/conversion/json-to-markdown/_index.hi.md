...
JSON फ़ाइलों को प्रोग्रामेटिक रूप से MARKDOWN में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में JSON को MARKDOWN में आसानी से लोड और परिवर्तित कर सकते हैं।
...
1.  Workbook.Save पद्धति पर कॉल करके JSON को MARKDOWN में कनवर्ट करें।
