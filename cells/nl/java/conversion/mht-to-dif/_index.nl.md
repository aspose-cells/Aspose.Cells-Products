...
{{% blocks/products/pf/agp/content h2="MHT omzetten naar DIF met behulp van Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sla MHT op in DIF in Java" %}}

Het volgende voorbeeld laat zien hoe je MHT omzet naar DIF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik MHT om naar DIF via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u MHT-bestanden programmatisch converteren naar DIF? Ontwikkelaars van Java kunnen MHT-bestanden eenvoudig converteren naar DIF met slechts een paar regels code.
