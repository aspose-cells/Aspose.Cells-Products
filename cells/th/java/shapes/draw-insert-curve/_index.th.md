...
{{% blocks/products/pf/agp/content h2="วิธีแทรกรูปทรงโค้งลงในไฟล์ Excel โดยใช้ Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกรูปทรงโค้งลงในไฟล์ Excel via Java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) เพื่อแทรกรูปร่างโค้งในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="เม็ดมีดทรงโค้ง - Java" offSpacer="" %}}
