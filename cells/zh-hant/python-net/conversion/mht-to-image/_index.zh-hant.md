---
title: Python MHT 到 IMAGE - 在線 MHT 到 IMAGE 轉換器
description: Aspose Excel。 Python Aspose.Cells. Python Aspose Cells. 免費在線 Python 將 MHT 轉換為 IMAGE 保存格式。 Python MHT 到 IMAGE 格式。將 MHT 保存到 IMAGE Python。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 MHT 轉換為 Python 中的 IMAGE" h2="用於將 MHT 轉換為 IMAGE 的高速 Python 庫。使用我們的 Excel 轉換 API 在 Python 中開發高級、平台獨立的軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何將 MHT 轉換為 IMAGE？使用 Aspose.Cells for Python via NET 庫，您可以通過幾行代碼以編程方式輕鬆將 MHT 轉換為 IMAGE。[Aspose.Cells for Python 通過 NET](https://pypi.org/project/aspose-cells-python/)能夠構建跨平台應用程序，能夠生成、修改、轉換、渲染和打印所有 Excel 文件。 Python Excel API不僅可以在電子表格格式之間進行轉換，還可以將Excel文件渲染為圖像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，從而使其成為行業交換文檔的完美選擇-標準格式。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="免費在線將 MHT 保存為 Python 中的 IMAGE" %}}

以下示例演示如何將 Python via NET 中的 MHT 轉換為 IMAGE。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 MHT 轉換為 IMAGE。上傳您的 MHT 文件，然後將其保存為 IMAGE 文件。對於 MHT 讀取和 IMAGE 寫入，您可以使用完全限定的文件名。輸出的 IMAGE 內容和格式將與原始 MHT 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 MHT 在線轉換為 IMAGE 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="png" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何將 MHT 轉換為 IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 MHT 文件轉換為 IMAGE？ Python 開發人員只需幾行代碼即可輕鬆加載 MHT 並將其轉換為 IMAGE。
...
1. 通過調用 Workbook.save 方法將 MHT 轉換為 IMAGE。
1. 獲取MHT到IMAGE的轉換結果。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python 將 MHT 轉換為 IMAGE 的庫" %}}
