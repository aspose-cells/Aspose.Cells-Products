---
title:  Combinar XLS a DOCX via Java
...
El siguiente ejemplo muestra cómo combinar XLS con DOCX en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a DOCX en línea" InputFormat="xls" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
