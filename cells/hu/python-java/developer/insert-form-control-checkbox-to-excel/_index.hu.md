...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjteményt[módszer hozzáadása](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) egy CheckBox (Űrlapvezérlő) beillesztéséhez a kiválasztott munkalapba.
