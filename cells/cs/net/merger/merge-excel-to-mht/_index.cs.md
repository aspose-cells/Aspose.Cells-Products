---
title: Sloučit EXCEL s MHT – Kombinujte EXCEL s MHT v C#
url: /cs/net/merger/merge-excel-to-mht/ 
description: Aspose Excel. C# Aspose.Cells. Online zdarma Sloučit EXCEL do formátu MHT. C# Kombinujte EXCEL s formátem MHT. Sloučit EXCEL do MHT v C#. EXCEL Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit EXCEL do MHT v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit EXCEL s MHT v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení EXCELu s MHT. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MHT. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který spojuje EXCEL s MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení EXCEL do MHT v C#" InputFormat="xlsx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit EXCEL do MHT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit EXCEL s MHT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu pro sloučení EXCELu s MHT" %}}
