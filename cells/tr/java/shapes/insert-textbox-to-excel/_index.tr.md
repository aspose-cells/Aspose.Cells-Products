---
title:  TextBox'ı Excel via Java'e ekleyin
weight: 60
...
{{< blocks/products/pf/i18n/upper-banner h1="TextBox\'ı Excel via Java\'e ekleyin" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım olmadan sunucu tarafı API\'lerini kullanarak nesneler ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak Metin Kutusunu Excel Dosyasına Ekleme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="TextBox\'ı Excel dosyasına ekleme adımları via Java" %}}
...
+ Dizini aracılığıyla Çalışma Sayfası'nı seçin.
 + Kullanın[yöntem ekle](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addTextBox-int-int-int-int-int-int-) seçili çalışma sayfasına TextBox eklemek için
...
{{% blocks/products/pf/agp/code-block title="Metin Kutusu Ekle - Java" offSpacer="" %}}
