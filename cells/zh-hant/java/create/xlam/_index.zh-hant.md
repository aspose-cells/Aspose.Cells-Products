---
title: 創建XLAM - 在Java中創建XLAM文件
description: Aspose Excel。 Java 創建 XLAM 文件。創建XLAM Java。Java XLAM創建者。在Java中創建XLAM。使用Java生成XLAM文件。
...
{{% blocks/products/pf/agp/content h2="如何在Java中創建XLAM" %}}
...
1. 使用 save() 方法將工作簿保存為 XLAM 格式。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 Java 中創建 XLAM 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫創建XLAM文件" %}}
{{% blocks/products/pf/agp/text %}}
