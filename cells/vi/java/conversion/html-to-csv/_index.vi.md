---
title: Chuyển đổi HTML sang CSV qua Java 
weight: 3290
url: /vi/java/conversion/html-to-csv/ 
description: Mã chuyển đổi Java mẫu cho định dạng HTML sang tệp CSV. Người lập trình có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang CSV trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi HTML sang CSV qua Java" h2="Chuyển đổi HTML sang CSV Java để chuyển đổi một hoặc nhiều trang thành CSV bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi HTML sang CSV bằng cách sử dụng Java" %}}

 Để hiển thị HTML thành CSV, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi HTML sang CSV qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp HTML sang CSV chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp HTML với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Chuyển đường dẫn đầu ra với phần mở rộng CSV & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp CSV kết quả
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi HTML sang CSV Java" offSpacer="" %}}

```cs
// tải tệp HTML trong một phiên bản của Workbook
Workbook book = new Workbook("template.html");
// lưu HTML dưới dạng CSV
