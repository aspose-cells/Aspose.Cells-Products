---
title: XLS を PRN Python via Python に変換します
description: 無料でXLSをオンラインでPRNに変換します。無料のオンラインXLSからPRNコンバーター。 Python XLS から PRN まで。 Python経由でPRNにXLS。
...
{{% cells-convert title="XLSをオンラインでPRNに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="prn" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="XLSをPRNに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

 Python 開発者は、わずか数行のコードで XLS を簡単にロードして PRN に変換できます。
