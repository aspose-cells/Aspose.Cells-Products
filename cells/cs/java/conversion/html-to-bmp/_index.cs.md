---
title: Převést HTML na BMP prostřednictvím Java 
weight: 740
url: /cs/java/conversion/html-to-bmp/ 
description: Ukázka převodního kódu Java pro formát HTML na soubor BMP. Programátoři mohou tento ukázkový kód použít k exportu tabulek Excelu a OpenOffice do BMP v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést HTML na BMP prostřednictvím Java" h2="Převod HTML na BMP Java pro převod jedné nebo více stránek na BMP pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na BMP pomocí Java" %}}

 K vykreslení HTML do BMP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu HTML na BMP prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor HTML na BMP pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor HTML s instancí sešitu1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Voláním metody SheetRender.toImage uložíte výsledek ve formátu BMP
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze HTML na BMP Java" offSpacer="" %}}
