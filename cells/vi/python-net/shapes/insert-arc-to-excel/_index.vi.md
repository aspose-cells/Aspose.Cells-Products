...
{{% blocks/products/pf/agp/content h2="Cách Chèn Arc vào File Excel Dùng Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn file Arc vào Excel dùng Python via .Net" %}}
...
+ Sử dụng phương thức add của bộ sưu tập hình dạng để chèn một hình cung vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn Arc - Python via .Net" offSpacer="" %}}
