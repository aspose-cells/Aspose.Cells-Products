...
{{% blocks/products/pf/agp/feature-section-col title="Jak utworzyć XLT za pomocą Python" %}}
...
1. Zaimportuj asposecells do pliku kodu.1. Utwórz instancję klasy Workbook.1. Uzyskaj dostęp do pierwszego arkusza roboczego skoroszytu.1. Pobierz żądane komórki arkusza roboczego i wprowadź wartość do komórki (komórek).1. Użyj metody Save, aby zapisać skoroszyt jako plik XLT.
