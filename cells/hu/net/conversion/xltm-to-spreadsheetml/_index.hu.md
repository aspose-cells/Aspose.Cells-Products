---
title: "XLTM konvertálása SPREADSHEETML-re a következőn keresztül: C#"

description: Mintakód az xltm-ből táblázattáblázatba C# konverzióhoz. Használjon API példakódot kötegelt xltm-fájlokhoz a VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belüli táblázatkezelő konvertálásához.
---
...
{{% blocks/products/pf/agp/content h2="Az XLTM konvertálása SPREADSHEETML-re a következővel: C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLTM SPREADSHEETML-lé konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják az XLTM fájlokat SPREADSHEETML formátumba.
