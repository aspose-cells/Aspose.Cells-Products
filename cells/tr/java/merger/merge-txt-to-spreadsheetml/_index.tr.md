---
title: TXT'i SPREADSHEETML ile birleştirin - TXT'i SPREADSHEETML ile Java'de birleştirin
url: /tr/java/merger/merge-txt-to-spreadsheetml/ 
description: Aspose excel. Java Aspose.Cells. TXT'i SPREADSHEETML kaydetme biçimiyle Ücretsiz Çevrimiçi Birleştirme. Java TXT'i SPREADSHEETML biçiminde birleştirin. TXT'i SPREADSHEETML ile Java'de birleştirin. TXT Birleştirin.
...
{{% blocks/products/pf/agp/content h2="TXT\'i SPREADSHEETML ile Java Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, TXT'in SPREADSHEETML ile Aspose.Cells for Java'de nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="TXT\'i SPREADSHEETML ile Java\'de Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="txt" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT SPREADSHEETML via Java ile Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 TXT'i SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i SPREADSHEETML ile birleştirmek için Java kitaplığı" %}}
