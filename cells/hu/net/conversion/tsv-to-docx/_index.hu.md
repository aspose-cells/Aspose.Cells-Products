...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV DOCX formátummá konvertálásához a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a TSV fájlokat DOCX formátumba.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TSV-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Adja meg a kimeneti útvonalat DOCX kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott DOCX fájl megadott elérési útját
