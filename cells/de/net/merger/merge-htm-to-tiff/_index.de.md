---
title: HTM mit TIFF zusammenführen – HTM mit TIFF in C# kombinieren
url: /de/net/merger/merge-htm-to-tiff/ 
description: Aspose Excel. C# Aspose.Cells. Kostenloses Online-Merge-HTM zum TIFF-Speicherformat. C# Kombinieren Sie HTM mit dem Format TIFF. HTM zu TIFF in C# zusammenführen. HTM zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie HTM kostenlos mit TIFF in C# online zusammen" %}}

Das folgende Beispiel zeigt, wie HTM mit TIFF in Aspose.Cells for .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um HTM mit TIFF zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei TIFF. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das HTM mit TIFF zusammenführt.
...
{{% blocks/products/pf/agp/content h2="So führen Sie HTM über C# mit TIFF zusammen" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie HTM programmgesteuert mit TIFF zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von HTM mit TIFF" %}}
