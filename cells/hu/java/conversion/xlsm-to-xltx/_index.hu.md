---
title: "XLSM konvertálása XLTX-re a következőn keresztül: Java "
weight: 7030
url: /hu/java/conversion/xlsm-to-xltx/ 
description: Minta Java konverziós kód az XLSM formátumhoz XLTX fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok XLTX formátumba exportálására bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSM konvertálása XLTX-re a következőn keresztül: Java" h2="XLSM-ből XLTX-be Java konvertálhat egyetlen vagy több oldalt XLTX-vé a Helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="XLSM konvertálása XLTX-re a következővel: Java" %}}

 Ahhoz, hogy az XLSM-et XLTX-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM XLTX-re konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak XLSM fájlt XLTX-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSM-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLTX kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLTX fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLSM–XLTX Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLSM fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xlsm");
// mentse az XLSM-et XLTX-ként
