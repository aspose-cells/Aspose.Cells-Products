---
title: Konvertera XLSM till CSV via Java 
weight: 9910

description: Exempel Java-konverteringskod för XLSM-format till CSV-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till CSV inom alla webb- eller skrivbordsbaserade Javaapplikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till CSV med Java" %}}

 För att rendera XLSM till CSV kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till CSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLSM-fil till CSV på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med CSV-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande CSV-filen
...
{{% blocks/products/pf/agp/code-block title="XLSM till CSV Java omvandlingskällkod" offSpacer="" %}}
