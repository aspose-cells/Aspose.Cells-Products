---
title: 將方程形狀插入 Excel via .NET
weight: 360
description: C# 用於將方程形狀插入 .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 Excel 的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="將方程形狀插入 Excel via .NET" h2="使用 Aspose.Cells\' API 插入方程形狀，無需使用 Microsoft 或 Open Office、Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ 通過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape)在選定的工作表中插入方程形狀
以 XLSX 格式保存工作簿。
