...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na XPS za pomocą Aspose.Cells. Java MHT na XPS. Java Zapisz MHT na XPS. Zapisz MHT jako XPS, używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem XPS w Java" %}}

Poniższy przykład ilustruje sposób konwersji MHT na XPS w Java.
...
Chcesz programowo przekonwertować pliki MHT na XPS? Programiści Java mogą łatwo przekonwertować MHT na XPS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji MHT na XPS" %}}
{{% blocks/products/pf/agp/text %}}
