---
title: C# OTS zu TXT - Online OTS zu TXT Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# OTS in TXT Saveformat konvertieren. C# OTS zum TXT-Format. Speichern Sie OTS unter TXT C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter TXT in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie OTS in C# in TXT konvertiert wird.
...
Müssen Sie OTS-Dateien programmgesteuert in TXT konvertieren? .NET-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in TXT konvertieren.
...
1.  Konvertieren Sie OTS in TXT, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von OTS in TXT" %}}
