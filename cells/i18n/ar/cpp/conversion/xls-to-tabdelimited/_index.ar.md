---
title: تحويل XLS إلى TABDELIMITED عبر تطبيق C++ 
url: /ar/cpp/conversion/xls-to-tabdelimited/ 
description: نموذج رمز تحويل C++ لمستند XLS إلى تنسيق TABDELIMITED. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLS إلى TABDELIMITED دفعة داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLS إلى TABDELIMITED عبر C++" h2="تحويل XLS عالي الأداء إلى TABDELIMITED باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى TABDELIMITED باستخدام C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLS إلى TABDELIMITED عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ تحويل ملف XLS بسهولة إلى TABDELIMITED في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLS باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (TABDELIMITED).1. سيتم حفظ ملف TABDELIMITED في المسار المحدد.1. افتح ملف TABDELIMITED في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLS إلى TABDELIMITED C++ رمز مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLS إلى TABDELIMITED تحويل العروض الحية" sectionDescription="[تحويل XLS إلى TABDELIMITED](https://products.aspose.app/cells/conversion/xls-to-tabdelimited) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف XLS الخاص بك ، وسيتم تحويله على الفور إلى TABDELIMITED." >}}
