...
{{% blocks/products/pf/agp/text %}}
 ...
 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják az XLTX fájlokat TSV formátumba.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTX fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal átadása TSV kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott TSV-fájl megadott elérési útját
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód az XLTX TSV-vé konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="tsv" IsLandingPage="true" %}}
