...
Нужно программно преобразовать файлы FODS в HTML? Разработчики .NET могут легко загрузить и преобразовать FODS в HTML всего за несколько строк кода.
...
1.  Преобразуйте значение FODS в HTML, вызвав метод Workbook.Save.
