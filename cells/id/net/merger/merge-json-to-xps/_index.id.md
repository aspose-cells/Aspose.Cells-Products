---
title: Gabungkan JSON menjadi XPS - Gabungkan JSON menjadi XPS menjadi C#
url: /id/net/merger/merge-json-to-xps/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan JSON menjadi XPS format simpan. C# Gabungkan format JSON menjadi XPS. Gabungkan JSON menjadi XPS di C#. JSON Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JSON menjadi XPS di C#" %}}

Contoh berikut menunjukkan cara menggabungkan JSON menjadi XPS di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan JSON ke XPS. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file XPS. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan JSON menjadi XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan JSON menjadi XPS di C#" InputFormat="json" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JSON menjadi XPS melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan JSON ke XPS secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2=".NET perpustakaan untuk digabungkan JSON menjadi XPS" %}}
