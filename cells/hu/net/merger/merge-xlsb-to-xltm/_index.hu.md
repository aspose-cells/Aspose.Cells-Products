---
title: A XLSB-XLTM-es számok egyesítése – a XLSB-es és a XLTM-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-xlsb-to-xltm/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés XLSB XLTM mentési formátumba. C# A XLSB és a XLTM formátum kombinálása. Egyesítse a XLSB-XLTM-et a C#-ben. XLSB Egyesítse.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLSB-es számokat a XLTM-es számokhoz a C#-ben online ingyen" %}}

A következő példa bemutatja a XLSB és a XLTM egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLSB-es és a XLTM-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a XLTM fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a XLSB és XLTM számokat.
...
{{% blocks/products/pf/agp/content h2="A XLSB és a XLTM egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLSB-et a XLTM-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB és XLTM egyesítéséhez" %}}
