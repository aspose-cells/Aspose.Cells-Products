...
Besoin de convertir des fichiers JPG en HTML par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en HTML en quelques lignes de code.
...
1.  Convertissez le JPG au format HTML en appelant la méthode Workbook.Save.
