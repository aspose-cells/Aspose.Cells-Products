...
{{% cells-convert title="Exemple de code pour convertir XLS en ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en ET via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en ET par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en ET en quelques lignes de code seulement.
