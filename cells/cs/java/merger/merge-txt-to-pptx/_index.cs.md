---
title:  Sloučit TXT až PPTX via Java
...
Následující příklad ukazuje, jak sloučit TXT až PPTX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až PPTX online" InputFormat="txt" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
