...
description: Aspose Excel. Python Excel. Python Create OTS File quickly and easily with Aspose.Cells. Generate OTS file using Python Excel Library. Create OTS in Python Excel Library. Python OTS Creater. 
...
1.  Use Save method to save the workbook as OTS file.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create OTS file in Python excel library." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel Library to Create OTS File" %}}
