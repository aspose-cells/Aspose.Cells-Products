---
title: Java XLS till EXCEL - XLS till EXCEL-omvandlare
description: Aspose Excel. Denna omfattande lösning ger Java-utvecklare en helt integrerad metod för att konvertera XLS till EXCEL-format, vilket möjliggör sömlös sparning av XLS-data till EXCEL-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar Java-kod.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLS till EXCEL i Java" h2="Snabbt Java-bibliotek för konvertering av XLS till EXCEL. Detta är en professionell programvarulösning för att importera och exportera XLS, EXCEL och många andra format med hjälp av Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Spara XLS till EXCEL i Java" %}}

Följande exempel visar hur man konverterar XLS till EXCEL i Java.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att konvertera XLS till EXCEL. Ladda upp din XLS-fil och spara den sedan helt enkelt som EXCEL-fil. För både XLS-läsning och EXCEL-skrivning kan du använda fullt kvalificerade filnamn. Utdata EXCEL-innehåll och formatering kommer att vara identisk med originaldokumentet XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exempelkod för att konvertera XLS till EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till EXCEL programmatiskt? Java-utvecklare kan enkelt konvertera XLS till EXCEL med bara några få rader kod.
...
1.  Konvertera XLS till EXCEL genom att anropa Workbook.save-metoden.
1.  Få konverteringsresultatet från XLS till EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java-bibliotek för att konvertera XLS till EXCEL" %}}
{{% blocks/products/pf/agp/text %}}
