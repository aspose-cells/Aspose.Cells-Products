---
title: 通過 C++ 應用程序將 XLT 轉換為 XLSX 
url: /zh-hant/cpp/conversion/xlt-to-xlsx/ 
description: XLT 文檔到 XLSX 格式的示例 C++ 轉換代碼。程序員可以使用此源代碼在任何 C++ 應用程序中進行批量 XLT 到 XLSX 的轉換。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 將 XLT 轉換為 XLSX" h2="使用 C++ 庫的高性能 XLT 到 XLSX 轉換，無需安裝 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 開發人員只需幾行代碼即可輕鬆地將 XLT 文件轉換為 XLSX。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加載 XLT 文件。1. 調用 Save() 方法。1. 使用 (XLSX) 文件擴展名傳遞輸出文件路徑。1. XLSX 文件將保存在指定路徑。1. 在兼容程序中打開 XLSX 文件。
...
{{% blocks/products/pf/agp/code-block title="XLT 到 XLSX C++ 轉換源代碼" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLT 到 XLSX 轉換現場演示" sectionDescription="[將 XLT 轉換為 XLSX](https://products.aspose.app/cells/conversion/xlt-to-xlsx) 立即訪問我們的現場演示網站。現場演示具有以下好處" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 無需下載 Aspose API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 無需編寫任何代碼。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上傳您的 XLT 文件，它將立即轉換為 XLSX。" >}}
