---
title: Sloučit MHT s PDF - Sloučit MHT s PDF v Java
url: /cs/java/merger/merge-mht-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit MHT do PDF saveformat. Java Zkombinujte MHT do formátu PDF. Sloučit MHT na PDF v Java. MHT Sloučit.
...
Následující příklad ukazuje, jak sloučit MHT s PDF v Aspose.Cells for Java.
...
{{% cells-merger title="Online zdarma ke sloučení MHT na PDF v Java" InputFormat="mht" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT na PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit MHT na PDF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
