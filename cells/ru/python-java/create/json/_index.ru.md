---
title: Создать JSON — Создать файл JSON в Python.
description: Aspose Эксель. Python Эксель. Python Создайте файл JSON быстро и легко с помощью Aspose.Cells. Создайте файл JSON с помощью библиотеки Excel Python. Создайте JSON в библиотеке Excel Python. Python JSON Создатель.
...
{{% blocks/products/pf/agp/content h2="Создайте файл JSON, используя библиотеку Excel Python." %}}

 Как создать файл JSON? С помощью библиотеки Excel Aspose.Cells for Python via Java вы можете легко создать файл JSON программно с помощью нескольких строк кода.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)способен создавать кроссплатформенные приложения с возможностью генерировать, изменять, конвертировать, отображать и распечатывать все файлы Excel. Python Excel API не только конвертирует форматы электронных таблиц, но также может отображать файлы Excel в виде изображений, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT и т. д., что делает его идеальным выбором для обмена документами в стандартных отраслевых форматах.

{{% /blocks/products/pf/agp/content %}}



{{% blocks/products/pf/agp/content h2="Как создать JSON в библиотеке Excel Python" %}}
...
1.  Используйте метод Save, чтобы сохранить книгу как файл JSON.

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл JSON в библиотеке Excel Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python Библиотека Excel для создания файла JSON" %}}
