...
description: Aspose Exceller. Convertissez IMAGE en EXCEL rapidement et facilement avec Aspose.Cells. Java IMAGE en EXCEL. Java Enregistrez l’IMAGE dans EXCEL. Enregistrez l'IMAGE au format EXCEL en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Convertir IMAGE en EXCEL à l’aide de Java" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE dans EXCEL en Java" %}}

L'exemple suivant montre comment convertir IMAGE en EXCEL en Java.
...
{{% cells-convert title="Exemple de code pour convertir IMAGE en EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xlsx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir une image en EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE en EXCEL par programme ? Java peuvent facilement convertir IMAGE en EXCEL en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en EXCEL" %}}
{{% blocks/products/pf/agp/text %}}
