---
title:  Ekle veya Kaldır XLSB Ek Açıklama via .NET
weight: 6440
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSB biçim ek açıklamalarını eklemek ve silmek için C# kaynak kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB\'den C#\'e Ek Açıklama Ekleme veya Silme" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSB - C#\'den Ek Açıklamaları Sil" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API, Microsoft Excel formatlarını oluşturmak, düzenlemek, dönüştürmek ve farklı formatlara dönüştürmek için kullanılabilir. Ayrıca yazılım uygulamalarında kapsamlı grafik oluşturma, ölçeklenebilir raporlama ve güvenilir hesaplamalar için de kullanılabilir. Aspose.Cells bağımsız bir API'dir ve Microsoft veya OpenOffice gibi herhangi bir yazılım gerektirmez.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi Uygulama aracılığıyla XLSB\'den Ek Açıklamayı Kaldır" sectionDescription=" XLSB belge ek açıklamasını hemen şimdi ziyaret ederek silin.[Canlı Demolar web sitesi](https://products.aspose.app/cells/annotation). Canlı demo aşağıdaki avantajlara sahiptir" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/net/annotation/xls/" name="XLS" description="Excel İkili Formatı" >}}
