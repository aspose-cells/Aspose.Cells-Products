...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Melihat XLTX melalui C#" %}}
...
1. Muat file XLTX dalam instance Workbook1. Buat instance HtmlSaveOptions & setel properti ExportHeadings ke true1. Simpan file XLTX dalam format HTML menggunakan metode Workbook.Save1. Muat HTML yang dihasilkan di browser default dengan Process.Start
...
// simpan file XLTX dalam format HTML
