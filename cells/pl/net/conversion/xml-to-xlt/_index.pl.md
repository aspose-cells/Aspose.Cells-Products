---
title: C# XML na XLT - Konwerter XML na XLT
description: Aspose Excel. Konwertuj XML na XLT szybko i łatwo za pomocą Aspose.Cells. C# XML na XLT. C# Zapisz XML na XLT. Zapisz XML jako XLT używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem XLT w C#" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na XLT w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na XLT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XML na XLT? Programiści .NET mogą łatwo załadować i przekonwertować XML na XLT w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XML na XLT" %}}
