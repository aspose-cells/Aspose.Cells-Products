...
description: Sample Java conversion code for XLS format to XLSM file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to XLSM within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert XLS to XLSM Using Java" %}}
 ...
 In order to render XLS to XLSM, we’ll use
