---
title: PRN to XPS - Convert PRN to XPS in Java
description: Aspose Excel. Java Aspose.Cells. Free Online Convert PRN to XPS in Java. Java PRN to XPS format. Save PRN as XPS in Java. Java Aspose Cells.
keywords: [Aspose Excel., Java Aspose.Cells., Java PRN to XPS., Free Online Convert PRN to XPS in Java., Java Convert PRN to XPS., PRN to XPS Converter]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PRN to XPS in Java" h2="High-speed Java library for converting PRN to XPS. This is a professional software solution to import and export PRN, XPS, and many other formats using Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PRN to XPS Using Java" %}}

How do I convert PRN to XPS? With Aspose.Cells for Java library, you can easily convert PRN to XPS programmatically with  a few lines of code. [Aspose.Cells for Java](https://products.aspose.com/cells/java) is capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. Java Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT and more, thus making it a perfect choice to exchange documents in industry-standard formats. You can download its latest version directly from [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) and install it within your Maven-based project by adding the following configurations to the pom.xml.
...
{{% blocks/products/pf/agp/content h2="Save PRN to XPS in Java Online for Free" %}}

The following example demonstrates how to convert PRN to XPS in Java.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert PRN to XPS. Upload your PRN file, then simply save it as XPS file. For both PRN reading and XPS writing you can use fully qualified filenames. The output XPS content and formatting will be identical to the original PRN document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert PRN to XPS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xps" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="How to Convert PRN to XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert PRN files to XPS programmatically? Java developers can easily convert PRN to XPS in just a few lines of code.
...
1.  Convert PRN to XPS by calling Workbook.save method.
1.  Get the conversion result of PRN to XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java library to convert PRN to XPS" %}}
{{% blocks/products/pf/agp/text %}}
