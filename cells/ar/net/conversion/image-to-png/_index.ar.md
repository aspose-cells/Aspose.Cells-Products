---
title: تحويل C# صورة إلى PNG - صورة إلى PNG
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل IMAGE إلى تنسيق PNG، مما يتيح حفظ بيانات IMAGE بسلاسة في تنسيق PNG باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في PNG في C#" %}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى PNG برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى PNG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الصورة إلى PNG عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الصورة إلى PNG" %}}
