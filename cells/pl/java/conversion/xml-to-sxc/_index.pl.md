...
description: Aspose Excel. Konwertuj XML na SXC szybko i łatwo za pomocą Aspose.Cells. Java XML na SXC. Java Zapisz XML na SXC. Zapisz XML jako SXC używając Java.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XML na SXC, używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem SXC w Java" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na SXC w Java.
...
Chcesz programowo przekonwertować pliki XML na SXC? Programiści Java mogą łatwo przekonwertować XML na SXC w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji XML na SXC" %}}
{{% blocks/products/pf/agp/text %}}
