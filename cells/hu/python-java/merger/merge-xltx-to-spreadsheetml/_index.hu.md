...
url: /hu/python-java/merger/merge-xltx-to-spreadsheetml/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLTX-et a SPREADSHEETML-be a Aspose.Cells for Python via Java-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLTX-et a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
