...
{{% blocks/products/pf/agp/content h2="Как преобразовать NUMBERS в XLTX с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию NUMBERS в XLTX через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Java могут легко преобразовать файл NUMBERS в XLTX, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл NUMBERS с экземпляром класса Workbook1. Вызов метода Workbook.save1. Передайте выходной путь с расширением XLTX и SaveFormat в качестве параметров1. Проверить указанный путь для результирующего файла XLTX
...
{{% blocks/products/pf/agp/code-block title="NUMBERS в XLTX Java Исходный код преобразования" offSpacer="" %}}

```cs
// загрузить файл NUMBERS в экземпляр Workbook
Workbook book = new Workbook("template.numbers");
// сохранить NUMBERS как XLTX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Преобразование NUMBERS в XLTX в режиме реального времени" sectionDescription="[Конвертировать NUMBERS в XLTX](https://products.aspose.app/cells/conversion/numbers-to-xltx) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Нет необходимости загружать Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать какой-либо код." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл NUMBERS, и он будет мгновенно преобразован в XLTX." >}}
