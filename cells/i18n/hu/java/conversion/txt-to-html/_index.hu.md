...
{{< blocks/products/pf/i18n/upper-banner h1="TXT konvertálása HTML-vé a következőn keresztül: Java" h2="TXT-ből HTML-be Java konvertálva egyetlen vagy több oldalt konvertálhat HTML-be a Helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="TXT konvertálása HTML-be a következővel: Java" %}}

 Ahhoz, hogy a TXT-t HTML-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TXT HTML formátumba konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a TXT fájlt HTML formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat HTML kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott HTML-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT-ből HTML-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése HTML-ként
