---
title: XLSM'i MHT ile birleştir - XLSM'i Python'de MHT ile birleştir
url: /tr/python-java/merger/merge-xlsm-to-mht/ 
description: Aspose excel. Python Aspose.Cells. XLSM'i MHT saveformat'a Ücretsiz Çevrimiçi Birleştirme. Python XLSM'i MHT biçiminde birleştirin. XLSM'i Python'de MHT ile birleştir. XLSM Birleştir.
...
Aşağıdaki örnek, XLSM'in Aspose.Cells for Python via Java'de MHT ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLSM\'i Python\'de MHT ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xlsm" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="XLSM\'i Python aracılığıyla MHT ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

XLSM'i programlı olarak MHT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
