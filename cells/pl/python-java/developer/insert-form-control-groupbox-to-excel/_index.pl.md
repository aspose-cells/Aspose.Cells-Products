...
{{% blocks/products/pf/agp/content h2="Jak wstawić GroupBox (kontrolkę formularza) do pliku Excel przy użyciu Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić GroupBox (kontrola formularza) do pliku Excel za pośrednictwem Python" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addGroupBox(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić pole GroupBox (formant formularza) do wybranego arkusza.
...
{{% blocks/products/pf/agp/code-block title="Wstaw pole grupy (kontrola formularza) — Python" offSpacer="" %}}
