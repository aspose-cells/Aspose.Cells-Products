---
title: Fusionner XML vers SQL - Combiner XML vers SQL dans Java
url: /fr/java/merger/merge-xml-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite XML au format de sauvegarde SQL. Java Combinez le format XML au format SQL. Fusionner XML vers SQL dans Java. Fusion XML.
...
{{% blocks/products/pf/agp/content h2="Fusionner XML en SQL dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner XML en SQL dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XML en SQL. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier SQL. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne XML en SQL.
...
{{% blocks/products/pf/agp/content h2="Comment fusionner XML en SQL via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner XML en SQL" %}}
