...
weight: 381
description: Python via Java ซอร์สโค้ดสำหรับใส่ดาว/แบนเนอร์ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกดาว/แบนเนอร์ลงในไฟล์ Excel โดยใช้ Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกดาว/แบนเนอร์ลงในไฟล์ Excel โดยใช้ Python via Java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกดาว/แบนเนอร์ลงในแผ่นงานที่เลือก
...
โค้ดตัวอย่างด้านล่างสาธิตวิธีการแทรก "คณิตศาสตร์บวก" สำหรับประเภทเพิ่มเติม โปรดดูที่ "ภาพรวมของประเภทดาวและแบนเนอร์" ด้านล่าง
