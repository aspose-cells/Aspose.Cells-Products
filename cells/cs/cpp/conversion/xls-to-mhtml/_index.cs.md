---
title: Převeďte XLS na MHTML pomocí aplikace C++ 
weight: 9180

description: Ukázka převodního kódu C++ pro dokument XLS do formátu MHTML. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLS na MHTML v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLS na MHTML pomocí C++" %}}

 Abychom převedli XLS na MHTML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu XLS na MHTML prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLS na MHTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLS pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (MHTML).1. Soubor MHTML bude uložen do zadané cesty.1. Otevřete soubor MHTML v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLS na MHTML C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze XLS na MHTML" sectionDescription="[Převést XLS na MHTML](https://products.aspose.app/cells/conversion/xls-to-mhtml) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor XLS, bude okamžitě převeden na MHTML." >}}
