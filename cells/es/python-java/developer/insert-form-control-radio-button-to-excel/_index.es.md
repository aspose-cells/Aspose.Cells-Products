---
title:  Inserte RadioButton (control de formulario) en Excel usando Python via java
weight: 60
description: Python via código fuente de Java para insertar RadioButton (control de formulario) en Excel.
...
{{% blocks/products/pf/agp/content h2="Cómo insertar RadioButton (control de formulario) en un archivo de Excel usando Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar RadioButton (control de formulario) en un archivo de Excel usando Python via java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa la colección de formas[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) para insertar un RadioButton (control de formulario) en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar botón de radio (control de formulario) - Python via java" offSpacer="" %}}
