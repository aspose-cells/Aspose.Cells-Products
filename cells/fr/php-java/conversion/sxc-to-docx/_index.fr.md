---
title: Convertisseur PHP SXC vers DOCX - SXC vers DOCX
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir le format SXC au format DOCX, permettant ainsi un enregistrement transparent des données SXC au format DOCX grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{% cells-convert title="Exemple de code pour convertir SXC en DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="sxc" outformat="docx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir SXC en DOCX via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers SXC en DOCX par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers SXC en DOCX en quelques lignes de code seulement.
...
1.  Convertissez SXC en DOCX en appelant la méthode save de Workbook.
1.  Obtenez le résultat de la conversion de SXC en DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir SXC en DOCX" %}}
