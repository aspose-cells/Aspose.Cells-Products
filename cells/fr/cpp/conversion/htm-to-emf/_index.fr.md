...
{{% cells-convert title="Exemple de code pour convertir HTM en EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="emf" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en EMF via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en EMF par programme ? Les développeurs C++ peuvent facilement convertir HTM en EMF en quelques lignes de code seulement.
...
1.  Convertissez HTM en EMF en appelant la méthode Save().
