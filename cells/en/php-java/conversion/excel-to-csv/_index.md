...
description: Aspose Excel. Convert EXCEL to CSV quickly and easily with Aspose.Cells. PHP EXCEL to CSV. PHP Save EXCEL to CSV. Save EXCEL as CSV using PHP.
...
{{% blocks/products/pf/agp/content h2="Convert EXCEL to CSV Using PHP" %}}

How do I convert EXCEL to CSV? With Aspose.Cells for PHP via Java library, you can easily convert EXCEL to CSV programmatically with  a few lines of code. [Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) is capable of building cross-platform applications with the ability to generate, modify, convert, render and print all Excel files. PHP Excel API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT and more, thus making it a perfect choice to exchange documents in industry-standard formats. 
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Save EXCEL to CSV in PHP" %}}

The following example demonstrates how to convert EXCEL to CSV in PHP.
...
{{% blocks/products/pf/agp/content h2="How to Convert EXCEL to CSV via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert EXCEL files to CSV programmatically? PHP developers can easily load & convert EXCEL to CSV in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="PHP library to convert EXCEL to CSV" %}}
