...
description: Aspose Excel。 Python Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 XLSX。Python OTS 為 XLSX。Python 將 OTS 儲存為 XLSX。Python 將 OTS 儲存為 XLSX。Python 將 OTS 儲存為 XLSX。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Python Excel 庫中的 OTS 轉換為 XLSX" h2="高速 Python Excel 函式庫，用於將 OTS 轉換為 XLSX。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將 Python Excel 庫中的 OTS 轉換為 XLSX" %}}
...
{{% blocks/products/pf/agp/content h2="將 OTS 儲存到 Python Excel 庫中的 XLSX" %}}

以下範例示範如何將 Python excel 庫中的 OTS 轉換為 XLSX。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 OTS 轉換為 XLSX。對於 OTS 讀取和 XLSX 寫入，您可以使用完全限定的檔案名稱。輸出 XLSX 內容和格式將與原始 OTS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="透過 Python Excel 庫將 OTS 轉換為 XLSX 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 OTS 轉換為 XLSX" %}}
