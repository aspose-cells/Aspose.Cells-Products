---
title: Java XLS do JPG - Online XLS do konwertera JPG
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Bezpłatnie online Java Konwersja XLS do formatu zapisu JPG. Java XLS do formatu JPG. Zapisz XLS do JPG Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS w JPG w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na JPG w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na JPG. Prześlij swój plik XLS, a następnie po prostu zapisz go jako plik JPG. Zarówno do odczytu XLS, jak i zapisu JPG można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość JPG i formatowanie będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XLS na JPG online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="jpg" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na JPG? Programiści Java mogą łatwo przekonwertować XLS na JPG w zaledwie kilku wierszach kodu.
...
1.  Konwertuj XLS na JPG, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLS do JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XLS na JPG" %}}
{{% blocks/products/pf/agp/text %}}
