...
description: Aspose Excel. Szybko i łatwo przekonwertuj PNG na IMAGE za pomocą Aspose.Cells. Python PNG na IMAGE. Python Zapisz PNG w OBRAZIE. Zapisz PNG jako OBRAZ, używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj PNG na OBRAZ w Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz PNG w OBRAZIE w Python" %}}

Poniższy przykład pokazuje, jak przekonwertować PNG na IMAGE w Python via NET.
...
{{% cells-convert title="Przykładowy kod do konwersji PNG na OBRAZ" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="png" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować PNG na OBRAZ" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki PNG na IMAGE? Programiści Python mogą z łatwością załadować i przekonwertować PNG na IMAGE w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji PNG na OBRAZ" %}}
