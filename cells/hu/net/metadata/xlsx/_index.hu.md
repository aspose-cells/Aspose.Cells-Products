---
title:  XLSX Fájlok metaadatainak megtekintése vagy szerkesztése via .NET
weight: 3430
description: C# forráskód a XLSX formátumú metaadatok szerkesztéséhez vagy megtekintéséhez a .NET Framework, .NET Core, Mono vagy Xamarin platformokon.
...
{{< blocks/products/pf/i18n/upper-banner h1="Kivonat XLSX Metaadatok via .NET" h2="Készítse el saját .NET-es alkalmazásait a XLSX fájlok metaadatok hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="A XLSX metaadatok kinyerése a C# használatával" %}}

 XLSX metaadatok kinyeréséhez a következőket fogjuk használni
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a XLSX metaadatainak C#-en keresztül történő kinyeréséhez" %}}
...
+ A XLSX betöltése a munkafüzet egy példányával
...
{{% blocks/products/pf/agp/code-block title="A XLSX - C# metaadatainak kivonata" offSpacer="" %}}
