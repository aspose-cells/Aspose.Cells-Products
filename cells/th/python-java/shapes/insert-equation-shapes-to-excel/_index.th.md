---
title: แทรกรูปร่างสมการลงใน Excel โดยใช้ Python via Java
weight: 360
description: Python via Java ซอร์สโค้ดสำหรับแทรกรูปร่างสมการลงใน Excel
...
{{< blocks/products/pf/i18n/upper-banner h1="แทรกรูปร่างสมการลงใน Excel โดยใช้ Python via Java" h2="แทรกรูปร่างสมการโดยใช้ Aspose.Cells\' API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF เป็นต้น" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกรูปร่างสมการลงในไฟล์ Excel โดยใช้ Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกรูปร่างสมการลงในไฟล์ Excel โดยใช้ Python via Java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกรูปร่างสมการลงในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกรูปร่างสมการ - Python via Java" offSpacer="" %}}
