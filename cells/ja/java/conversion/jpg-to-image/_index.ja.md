---
title: Java JPG から画像へ - JPG から画像へのコンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、JPG を IMAGE にすばやく簡単に変換します。 Java JPG を IMAGE に変換します。 Java JPG を画像に保存します。 Java を使用して JPG を IMAGE として保存します。
...
{{% blocks/products/pf/agp/content h2="JPGをJavaのIMAGEに保存" %}}
...
{{% cells-convert title="JPGをIMAGEに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="png" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="JPGを画像に変換する方法via Java" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで JPG ファイルを IMAGE に変換する必要がありますか? Java 開発者は、わずか数行のコードで JPG を IMAGE に簡単に変換できます。
...
{{% blocks/products/pf/agp/content h2="Java JPG を IMAGE に変換するライブラリ" %}}
{{% blocks/products/pf/agp/text %}}
