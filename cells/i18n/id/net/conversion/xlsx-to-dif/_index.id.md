---
title: Konversikan XLSX ke DIF melalui C#
url: /id/net/conversion/xlsx-to-dif/
description: Contoh kode untuk xlsx ke dif C# konversi. Gunakan API kode contoh untuk file batch xlsx untuk mengubah konversi dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLSX ke DIF Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi XLSX ke DIF melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file XLSX ke DIF hanya dalam beberapa baris kode.
...
{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX ke DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="dif" IsLandingPage="true" %}}
