---
title: Knop (formulierbesturingselement) invoegen in Excel met Java Python via
weight: 200
description: Python via Java-broncode om knop (formulierbesturingselement) in Excel in te voegen.
...
{{< blocks/products/pf/i18n/upper-banner h1="Knop (formulierbesturingselement) invoegen in Excel met Java Python via" h2="Voeg objecten in met behulp van server-side API\'s zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een knop (formulierbesturingselement) in een Excel-bestand kunt invoegen met behulp van Python via java" %}}

Om Button (Formulierbesturingselement) in het Excel-bestand in te voegen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om knop (formulierbesturingselement) in te voegen in Excel-bestand met behulp van java Python via" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de vormcollecties[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)) om een knop (formulierbesturingselement) in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Knop invoegen (formulierbesturingselement) - Python via java" offSpacer="" %}}
