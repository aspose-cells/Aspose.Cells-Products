...
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere, sayıları resim formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak sayı verilerinin resim formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="C# numaralı telefonu GÖRÜNTÜ olarak kaydet" %}}

Aşağıdaki örnek, C#'de sayıların resme nasıl dönüştürüleceğini göstermektedir.
...
{{% cells-convert title="Sayıları Görüntüye Dönüştürmek İçin Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="png" IsLandingPage="true" %}}
...
1. Workbook.Save yöntemini çağırarak sayıları resme dönüştürün.
1.  NUMBERS'ın IMAGE'a dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# numaralı kütüphane, sayıları görüntülere dönüştürmek için kullanılır." %}}
