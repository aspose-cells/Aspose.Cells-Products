---
title: Convierta JSON a PDF a través de la aplicación C++ 
url: /es/cpp/conversion/json-to-pdf/ 
description: Ejemplo de código de conversión C++ para documento JSON a formato PDF. Los programadores pueden usar este código fuente para la conversión por lotes de JSON a PDF dentro de cualquier aplicación C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta JSON a PDF a través de C++" h2="Conversión de JSON a PDF de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JSON a PDF usando C++" %}}

 Para convertir JSON a PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir JSON a PDF a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de C++ pueden convertir fácilmente archivos JSON a PDF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo JSON usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (PDF).1. El archivo PDF se guardará en la ruta especificada.1. Abra el archivo PDF en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de JSON a PDF C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de JSON a PDF" sectionDescription="[Convertir JSON a PDF](https://products.aspose.app/cells/conversion/json-to-pdf) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo JSON, se convertirá instantáneamente a PDF." >}}
