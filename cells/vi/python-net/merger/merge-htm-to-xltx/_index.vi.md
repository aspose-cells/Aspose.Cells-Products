...
url: /vi/python-net/merger/merge-htm-to-xltx/ 
...
Ví dụ sau đây minh họa cách hợp nhất HTM thành XLTX trong Aspose.Cells for Python via .NET.
...
Cần hợp nhất HTM vào XLTX theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API có thể được thực hiện chỉ với vài dòng mã.
