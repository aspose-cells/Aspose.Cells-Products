...
weight: 40
description: Python via Mã nguồn .Net để chèn Spin Button(Form control) vào Excel.
---
...
{{% blocks/products/pf/agp/content h2="Cách Chèn Nút Quay (Form control) Vào File Excel Bằng Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn Spin Button (Form control) vào file Excel bằng Python via .Net" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng add của shapecollection[phương pháp](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_spinner/#int-int-int-int-int-int) để chèn Nút xoay (Điều khiển biểu mẫu) trong trang tính đã chọn.
