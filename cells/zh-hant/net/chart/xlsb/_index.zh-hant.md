---
title:  XLSB 文件圖表到圖像 via .NET
weight: 8560
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上繪製和轉換 XLSB 檔案中的圖表或圖表。
