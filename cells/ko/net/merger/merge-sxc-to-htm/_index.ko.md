...
{{% blocks/products/pf/agp/content h2="C#에서 SXC을 HTM에 병합" %}}

다음 예에서는 SXC을 Aspose.Cells for .NET의 HTM에 병합하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

SXC을 HTM에 병합하는 쉬운 단계를 따르세요. 파일을 업로드하고 파일 병합을 위해 Workbook.Combine 메서드를 호출한 다음 HTM 파일에 저장합니다. C#에서 코드를 개발하면 생각보다 간단해질 것입니다. SXC을 HTM에 병합하는 C# 예제를 참조하세요.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="SXC을 C#의 HTM에 병합하는 샘플 코드" InputFormat="sxc" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 SXC을 HTM에 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 SXC을 HTM에 병합해야 합니까? 병합하고 연결하는 기본 문서[Aspose.Cells for .NET](https://products.aspose.com/cells/net) 단 몇 줄의 코드만으로 API를 구현할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2=".NET 라이브러리를 HTM에 병합하기 위한 SXC" %}}
