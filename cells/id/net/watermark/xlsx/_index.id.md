---
title: Tanda air XLSX dokumen via .NET
weight: 8270
description: Kode sumber C# untuk menambah atau menghapus tanda air ke file XLSX di Kerangka .NET, .NET Core, Mono atau Platform Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Menambahkan Watermark ke XLSX melalui C#" %}}
