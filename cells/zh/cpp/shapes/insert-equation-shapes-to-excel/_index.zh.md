---
title: 通过 C++ 将方程形状插入 Excel
weight: 780
description: C++ 在 C++ 运行时环境（适用于 Windows 32 位、Windows 64 位和 Linux 64 位）上的 Excel 文件中插入方程形状的示例代码。
keywords: [C++ Aspose.Cells., C++ add equation shapes., C++ insert equation shapes., C++ create equation shapes]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将方程形状插入 Excel" h2="使用服务器端的本机高性能插入对象 Aspose.Cells for C++ API，无需使用任何软件，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 将方程形状插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C++ 将方程形状插入 Excel 文件的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="插入方程形状 - C++" offSpacer="" %}}
