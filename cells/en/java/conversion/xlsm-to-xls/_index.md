---
title: XLSM to XLS - Convert XLSM to XLS in Java
description: Aspose Excel. Java Aspose.Cells. Free Online Convert XLSM to XLS in Java. Java XLSM to XLS format. Save XLSM as XLS in Java. Java Aspose Cells.
keywords: [Aspose Excel., Java Aspose.Cells., Java XLSM to XLS., Free Online Convert XLSM to XLS in Java., Java Convert XLSM to XLS., XLSM to XLS Converter]
---
...
{{% blocks/products/pf/agp/content h2="Save XLSM to XLS in Java Online for Free" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert XLSM to XLS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xls" IsLandingPage="true" language="java" %}}
