---
title: Konvertera JSON till BMP via Java 
weight: 910
url: /sv/java/conversion/json-to-bmp/ 
description: Exempel Java-konverteringskod för JSON-format till BMP-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till BMP inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera JSON till BMP via Java" h2="Exportera JSON till BMP-format via Java utan att behöva ytterligare verktyg eller bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar JSON till BMP med Java" %}}

 För att rendera JSON till BMP kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera JSON till BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera JSON-fil till BMP på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Skapa en ny instans av Workbook-klassen1. Välj standard eller valfritt kalkylblad från samlingen1. Ladda JSON-data från filen1. Skapa en instans av JsonLayoutOptions och ställ in alternativ1. Anrop metoden JsonUtility.importData för att importera JSON-data1. Skapa och ställ in objektet för ImageOrPrintOptions för BMP-rendering1. Skapa SheetRender för rendering1. Ring SheetRender.toImage-metoden för att spara resultatet i BMP-format
...
{{% blocks/products/pf/agp/code-block title="JSON till BMP Java omvandlingskällkod" offSpacer="" %}}
