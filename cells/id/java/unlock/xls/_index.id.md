...
weight: 6390
description: Kode sampel Java untuk membuka kunci file XLS yang dilindungi kata sandi di Lingkungan Runtime Java untuk Aplikasi JSP/JSF dan Aplikasi Desktop.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah membuka XLS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Buka File XLS melalui C#" offSpacer="" %}}
