---
title: Konwertuj CSV na XLS za pomocą aplikacji C++ 
weight: 1460
url: /pl/cpp/conversion/csv-to-xls/ 
description: Przykładowy kod konwersji C++ dla dokumentu CSV do formatu XLS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji CSV do XLS w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik CSV na XLS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLS).1. Plik XLS zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji CSV do XLS C++" offSpacer="" %}}
