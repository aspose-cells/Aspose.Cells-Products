...
description: C# .NET Kitaplığını kullanarak Excel'de Dağılım grafikleri oluşturmak için örnek kod. VB.NET, Asp.NET veya .NET tabanlı herhangi bir uygulama içinde MS Excel'e yönelik bir Dağılım grafiği oluşturmak için bu kodu kullanın.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kodu, C#\'i kullanarak MS Excel XLSX dosyasına Dağılım Grafiğinin nasıl oluşturulacağını gösterir." offSpacer="" %}}
