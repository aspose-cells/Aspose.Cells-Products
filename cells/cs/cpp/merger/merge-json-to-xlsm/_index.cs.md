---
title:  Sloučit JSON na XLSM přes C++
url: /cs/cpp/merger/merge-json-to-xlsm/ 
description: Sloučit JSON až XLSM online zdarma. Online zdarma JSON až XLSM Fúze. Sloučit JSON do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit JSON až XLSM v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení JSON až XLSM online" InputFormat="json" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
