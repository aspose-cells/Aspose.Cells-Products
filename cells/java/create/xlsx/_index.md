---
title: Create XLSX MS Excel Files via Java 
weight: 7690
url: /java/create/xlsx/ 
description: Java Sample code for generating XLSX documents. Use this code for creating sheets in XLSX Excel file within Java based desktop or web application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Create XLSX Documents via Java" h2="Native and high performance Microsoft Excel XLSX spreadsheet creation programmatically using Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Create XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 It is easy for the developers to creat, load, modify and convert XLSX format spreadsheet within running different reporting applications for data processing in just a few lines of code.
...
1.  Save the workbook as XLSX format using the save() method.
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a MS Excel XLSX file using Java." offSpacer="" %}}
