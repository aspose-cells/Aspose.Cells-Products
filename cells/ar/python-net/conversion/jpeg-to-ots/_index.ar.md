...
description: Aspose اكسل. قم بتحويل JPEG إلى OTS بسرعة وسهولة باستخدام Aspose.Cells. Python JPEG إلى OTS. Python احفظ JPEG إلى OTS. احفظ JPEG كـ OTS باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="تحويل JPEG إلى OTS في Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ JPEG إلى OTS في Python" %}}

يوضح المثال التالي كيفية تحويل JPEG إلى OTS في Python via NET.
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل JPEG إلى OTS" %}}
