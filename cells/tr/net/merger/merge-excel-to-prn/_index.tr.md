---
title: EXCEL'i PRN ile birleştir - C#'de EXCEL'i PRN ile birleştir
url: /tr/net/merger/merge-excel-to-prn/ 
description: Aspose Excel'de. C# Aspose.Cells. EXCEL'i PRN kaydetme biçimiyle birleştirin. C# EXCEL'i PRN formatıyla birleştirin. C#'de EXCEL'i PRN ile birleştir. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="C#\'de EXCEL\'i PRN ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de EXCEL'in PRN ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="C#\'de EXCEL\'i PRN ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C# aracılığıyla PRN ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i PRN ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
