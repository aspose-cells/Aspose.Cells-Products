...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в DOCX в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат DOCX в формате C#.
...
1.  Преобразовать XML в формат DOCX, вызвав метод Workbook.Save.
